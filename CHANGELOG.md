...
- added `pausesUpdatesAutomatically` option to automatically pause background location updates based on the `activityType` ([#4167](https://github.com/expo/expo/pull/4167) by [@tsapeta](https://github.com/tsapeta))
