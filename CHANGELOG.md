...
- Added second method to `Location.getCurrentPositionAsync`, which is able to calculate current position faster. ([#4953](https://github.com/expo/expo/pull/4953) by [@lukmccall](https://github.com/lukmccall))
