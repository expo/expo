...
- [iOS] Adopt the UIKit scene-based life cycle in the prebuild template so apps launch on the Xcode 27 / iOS 27 SDK. ([#46681](https://github.com/expo/expo/pull/46681) by [@tsapeta](https://github.com/tsapeta))
