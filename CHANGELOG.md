...
- Updated `@react-native-community/react-native-datetimepicker` from `4.0.0` to `6.1.1` ([#16951](https://github.com/expo/expo/pull/16951) by [@brentvatne](https://github.com/brentvatne))
