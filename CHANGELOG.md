...
- Updated `@react-native-community/slider` from `4.2.4` to `4.4.0`. ([#20903](https://github.com/expo/expo/pull/20903) by [@gabrieldonadel](https://github.com/gabrieldonadel))
