 ...
 */
function generateCommentBody(entries: CommentRowObject[], tag: string | null): string {
...
Some changes in the following packages that may fix this issue have just been published to npm${tag ? ` under \`${tag}\` tag` : ''} 🚀
