...
ndkVersion = "27.1.12297006"
  ...
  it('maps Gradle compile SDK versions to installable platform package ids', () => {
    assert.equal(getAndroidPlatformPackageId('36'), 'platforms;android-36');
    assert.equal(getAndroidPlatformPackageId('36.1'), 'platforms;android-36.1');
    assert.equal(getAndroidPlatformPackageId('37'), 'platforms;android-37.0');
    assert.equal(getAndroidPlatformPackageId('37.1'), 'platforms;android-37.1');
  });
