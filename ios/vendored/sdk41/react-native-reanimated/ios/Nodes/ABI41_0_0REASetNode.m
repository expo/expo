...
@implementation ABI41_0_0REASetNode {
...
- (instancetype)initWithID:(ABI41_0_0REANodeID)nodeID config:(NSDictionary<NSString *,id> *)config
{
  if ((self = [super initWithID:nodeID config:config])) {
    ...
    ABI41_0_0REA_LOG_ERROR_IF_NIL(_whatNodeID, @"Reanimated: First argument passed to set node is either of wrong type or is missing.");
    _valueNodeID = [ABI41_0_0RCTConvert NSNumber:config[@"value"]];
    ABI41_0_0REA_LOG_ERROR_IF_NIL(_valueNodeID, @"Reanimated: Second argument passed to set node is either of wrong type or is missing.");
  }
  return self;
}
...
- (id)evaluate
{
  ...
  ABI41_0_0REAValueNode *what = (ABI41_0_0REAValueNode *)[self.nodesManager findNodeByID:_whatNodeID];
