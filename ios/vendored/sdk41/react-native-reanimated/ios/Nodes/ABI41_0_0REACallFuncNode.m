...
#import "ABI41_0_0REACallFuncNode.h"
#import "ABI41_0_0REAFunctionNode.h"
#import "ABI41_0_0REAUtils.h"
#import "ABI41_0_0REAParamNode.h"
#import "ABI41_0_0REANodesManager.h"

@implementation ABI41_0_0REACallFuncNode {
...
- (instancetype)initWithID:(ABI41_0_0REANodeID)nodeID config:(NSDictionary<NSString *,id> *)config
{
  if ((self = [super initWithID:nodeID config:config])) {
    ...
    ABI41_0_0REA_LOG_ERROR_IF_NIL(_whatNodeID, @"Reanimated: First argument passed to callFunc node is either of wrong type or is missing.");
    _args = config[@"args"];
...
- (void)beginContext
{
  ...
  for (NSUInteger i = 0; i < _params.count; i++) {
    ...
    ABI41_0_0REAParamNode *param = (ABI41_0_0REAParamNode *)[self.nodesManager findNodeByID:paramID];
...
{
  [self beginContext];
  ABI41_0_0REAFunctionNode *what = (ABI41_0_0REAFunctionNode *)[self.nodesManager findNodeByID:_whatNodeID];
