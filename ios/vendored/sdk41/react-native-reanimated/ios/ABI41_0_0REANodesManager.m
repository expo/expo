...
#import "Nodes/ABI41_0_0REANode.h"
#import "Nodes/ABI41_0_0REAPropsNode.h"
#import "Nodes/ABI41_0_0REAStyleNode.h"
#import "Nodes/ABI41_0_0REATransformNode.h"
#import "Nodes/ABI41_0_0REAValueNode.h"
#import "Nodes/ABI41_0_0REABlockNode.h"
#import "Nodes/ABI41_0_0REACondNode.h"
#import "Nodes/ABI41_0_0REAOperatorNode.h"
#import "Nodes/ABI41_0_0REASetNode.h"
#import "Nodes/ABI41_0_0READebugNode.h"
#import "Nodes/ABI41_0_0REAClockNodes.h"
#import "Nodes/ABI41_0_0REAJSCallNode.h"
#import "Nodes/ABI41_0_0REABezierNode.h"
#import "Nodes/ABI41_0_0REAEventNode.h"
#import "ABI41_0_0REAModule.h"
#import "Nodes/ABI41_0_0REAAlwaysNode.h"
#import "Nodes/ABI41_0_0REAConcatNode.h"
#import "Nodes/ABI41_0_0REAParamNode.h"
#import "Nodes/ABI41_0_0REAFunctionNode.h"
#import "Nodes/ABI41_0_0REACallFuncNode.h"
...
- (void)updateView:(nonnull NSNumber *)ABI41_0_0ReactTag
...
@interface ABI41_0_0REANodesManager() <ABI41_0_0RCTUIManagerObserver>

@end


@implementation ABI41_0_0REANodesManager
{
  NSMutableDictionary<ABI41_0_0REANodeID, ABI41_0_0REANode *> *_nodes;
  NSMapTable<NSString *, ABI41_0_0REANode *> *_eventMapping;
  NSMutableArray<id<ABI41_0_0RCTEvent>> *_eventQueue;
  CADisplayLink *_displayLink;
  ABI41_0_0REAUpdateContext *_updateContext;
  BOOL _wantRunUpdates;
  BOOL _processingDirectEvent;
  NSMutableArray<ABI41_0_0REAOnAnimationCallback> *_onAnimationCallbacks;
  NSMutableArray<ABI41_0_0REANativeAnimationOp> *_operationsInBatch;
  BOOL _tryRunBatchUpdatesSynchronously;
  ABI41_0_0REAEventHandler _eventHandler;
  volatile void (^_mounting)(void);
}

- (instancetype)initWithModule:(ABI41_0_0REAModule *)reanimatedModule
                     uiManager:(ABI41_0_0RCTUIManager *)uiManager
{
  if ((self = [super init])) {
    ...
    _updateContext = [ABI41_0_0REAUpdateContext new];
    _wantRunUpdates = NO;
...
- (ABI41_0_0REANode *)findNodeByID:(ABI41_0_0REANodeID)nodeID
{
...
- (void)onAnimationFrame:(CADisplayLink *)displayLink
{
  ...
  NSArray<ABI41_0_0REAOnAnimationCallback> *callbacks = _onAnimationCallbacks;
  _onAnimationCallbacks = [NSMutableArray new];
  ...
  // we iterate over it
  for (ABI41_0_0REAOnAnimationCallback block in callbacks) {
    block(displayLink);
  }
...
{
  if (_wantRunUpdates) {
    [ABI41_0_0REANode runPropUpdates:_updateContext];
  }
  if (_operationsInBatch.count != 0) {
    NSMutableArray<ABI41_0_0REANativeAnimationOp> *copiedOperationsQueue = _operationsInBatch;
    _operationsInBatch = [NSMutableArray new];
...
- (void)enqueueUpdateViewOnNativeThread:(nonnull NSNumber *)ABI41_0_0ReactTag
  ...
  [_operationsInBatch addObject:^(ABI41_0_0RCTUIManager *uiManager) {
    [uiManager updateView:ABI41_0_0ReactTag viewName:viewName props:nativeProps];
  }];
}
...
- (void)createNode:(ABI41_0_0REANodeID)nodeID
            config:(NSDictionary<NSString *, id> *)config
{
  static NSDictionary *map;
  static dispatch_once_t mapToken;
  dispatch_once(&mapToken, ^{
    map = @{@"props": [ABI41_0_0REAPropsNode class],
            @"style": [ABI41_0_0REAStyleNode class],
            @"transform": [ABI41_0_0REATransformNode class],
            @"value": [ABI41_0_0REAValueNode class],
            @"block": [ABI41_0_0REABlockNode class],
            @"cond": [ABI41_0_0REACondNode class],
            @"op": [ABI41_0_0REAOperatorNode class],
            @"set": [ABI41_0_0REASetNode class],
            @"debug": [ABI41_0_0READebugNode class],
            @"clock": [ABI41_0_0REAClockNode class],
            @"clockStart": [ABI41_0_0REAClockStartNode class],
            @"clockStop": [ABI41_0_0REAClockStopNode class],
            @"clockTest": [ABI41_0_0REAClockTestNode class],
            @"call": [ABI41_0_0REAJSCallNode class],
            @"bezier": [ABI41_0_0REABezierNode class],
            @"event": [ABI41_0_0REAEventNode class],
            @"always": [ABI41_0_0REAAlwaysNode class],
            @"concat": [ABI41_0_0REAConcatNode class],
            @"param": [ABI41_0_0REAParamNode class],
            @"func": [ABI41_0_0REAFunctionNode class],
            @"callfunc": [ABI41_0_0REACallFuncNode class]
//            @"listener": nil,
            };
  });
  ...
  ABI41_0_0REANode *node = [[nodeClass alloc] initWithID:nodeID config:config];
  node.nodesManager = self;
  node.updateContext = _updateContext;
  _nodes[nodeID] = node;
}

- (void)dropNode:(ABI41_0_0REANodeID)nodeID
{
  ABI41_0_0REANode *node = _nodes[nodeID];
  if (node) {
    [node onDrop];
...
- (void)connectNodes:(nonnull NSNumber *)parentID childID:(nonnull ABI41_0_0REANodeID)childID
{
  ABI41_0_0RCTAssertParam(parentID);
  ABI41_0_0RCTAssertParam(childID);

  ABI41_0_0REANode *parentNode = _nodes[parentID];
  ABI41_0_0REANode *childNode = _nodes[childID];
...
- (void)disconnectNodes:(ABI41_0_0REANodeID)parentID childID:(ABI41_0_0REANodeID)childID
{
  ABI41_0_0RCTAssertParam(parentID);
  ABI41_0_0RCTAssertParam(childID);
...
- (void)connectNodeToView:(ABI41_0_0REANodeID)nodeID
                 ...
                 viewName:(NSString *)viewName
{
  ...
  if ([node isKindOfClass:[ABI41_0_0REAPropsNode class]]) {
    [(ABI41_0_0REAPropsNode *)node connectToView:viewTag viewName:viewName];
  }
}

- (void)disconnectNodeFromView:(ABI41_0_0REANodeID)nodeID
                       viewTag:(NSNumber *)viewTag
{
  ABI41_0_0RCTAssertParam(nodeID);
  ABI41_0_0REANode *node = _nodes[nodeID];
  ...
  if ([node isKindOfClass:[ABI41_0_0REAPropsNode class]]) {
    [(ABI41_0_0REAPropsNode *)node disconnectFromView:viewTag];
  }
}

- (void)attachEvent:(NSNumber *)viewTag
          eventName:(NSString *)eventName
        eventNodeID:(ABI41_0_0REANodeID)eventNodeID
{
  ABI41_0_0RCTAssertParam(eventNodeID);
  ABI41_0_0REANode *eventNode = _nodes[eventNodeID];
  ABI41_0_0RCTAssert([eventNode isKindOfClass:[ABI41_0_0REAEventNode class]], @"Event node is of an invalid type");
...
- (void)processEvent:(id<ABI41_0_0RCTEvent>)event
{
  ...
  ABI41_0_0REAEventNode *eventNode = [_eventMapping objectForKey:key];
...
- (void)dispatchEvent:(id<ABI41_0_0RCTEvent>)event
{
  ...
  if (_eventHandler != nil) {
    __weak ABI41_0_0REAEventHandler eventHandler = _eventHandler;
    __weak typeof(self) weakSelf = self;
  ...
  ABI41_0_0REANode *eventNode = [_eventMapping objectForKey:key];
...
- (void)setValueForNodeID:(nonnull NSNumber *)nodeID value:(nonnull NSNumber *)newValue
{
  ...
  ABI41_0_0REAValueNode *valueNode = (ABI41_0_0REAValueNode *)node;
...
{
    UIView* view = [self.uiManager viewForABI41_0_0ReactTag:viewTag];
    ...
    if ([propName isEqualToString:@"opacity"]) {
        ...
        NSInteger zIndex = view.ABI41_0_0ReactZIndex;
