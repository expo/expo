...
#import "ABI41_0_0REAAllTransitions.h"
#import "ABI41_0_0RCTConvert+REATransition.h"

@interface ABI41_0_0REASnapshotRemover : NSObject <CAAnimationDelegate>
@end

@implementation ABI41_0_0REASnapshotRemover {
  UIView *_view;
}
...
@implementation ABI41_0_0REATransitionGroup
...
- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
    ...
    NSMutableArray<ABI41_0_0REATransition*> *inflated = [NSMutableArray new];
    for (NSDictionary *transitionConfig in transitions) {
      [inflated addObject:[ABI41_0_0REATransition inflate:transitionConfig]];
                                                             ...
                                                             forRoot:(UIView *)root
{
  ...
  for (ABI41_0_0REATransition *transition in _transitions) {
    ...
    for (ABI41_0_0REATransitionAnimation *anim in subanims) {
      [anim delayBy:delay];
...
@implementation ABI41_0_0REAVisibilityTransition

- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
    _animationType = [ABI41_0_0RCTConvert ABI41_0_0REATransitionAnimationType:config[@"animation"]];
  }
  return self;
}

- (ABI41_0_0REATransitionAnimation *)appearView:(UIView *)view
...
- (ABI41_0_0REATransitionAnimation *)disappearView:(UIView *)view
                                                 ...
                                                 forRoot:(UIView *)root
{
  ...
  if (isViewAppearing && !IS_LAYOUT_ONLY(endValues.view)) {
    NSNumber *parentKey = endValues.reactParent.ABI41_0_0ReactTag;
    ABI41_0_0REATransitionValues *parentStartValues = [self findStartValuesForKey:parentKey];
    ABI41_0_0REATransitionValues *parentEndValues = [self findEndValuesForKey:parentKey];
...
@implementation ABI41_0_0REAInTransition
- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
  }
                                  ...
                                  forRoot:(UIView *)root
{
  ...
  switch (self.animationType) {
    case ABI41_0_0REATransitionAnimationTypeNone:
      return nil;
    case ABI41_0_0REATransitionAnimationTypeFade: {
    ...
    case ABI41_0_0REATransitionAnimationTypeScale: {
    ...
    case ABI41_0_0REATransitionAnimationTypeSlideTop:
    case ABI41_0_0REATransitionAnimationTypeSlideBottom:
    case ABI41_0_0REATransitionAnimationTypeSlideLeft:
    case ABI41_0_0REATransitionAnimationTypeSlideRight: {
  ...
  return [ABI41_0_0REATransitionAnimation transitionWithAnimation:animation layer:view.layer andKeyPath:animation.keyPath];
}
@end


@implementation ABI41_0_0REAOutTransition
- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
  }
...
- (ABI41_0_0REATransitionAnimation *)disappearView:(UIView *)view
                               fromParent:(UIView *)parent
                                  forRoot:(UIView *)root
{
  if (self.animationType == ABI41_0_0REATransitionAnimationTypeNone) {
    return nil;
  }
  ...
  animation.fillMode = kCAFillModeBackwards;
  animation.delegate = [[ABI41_0_0REASnapshotRemover alloc] initWithView:snapshotView];

  return [ABI41_0_0REATransitionAnimation transitionWithAnimation:animation layer:snapshot andKeyPath:animation.keyPath];
}
@end


@implementation ABI41_0_0REAChangeTransition
                                                 ...
                                                 forRoot:(UIView *)root
{
  ...
  return [ABI41_0_0REATransitionAnimation transitionWithAnimation:group layer:layer andKeyPath:nil];
}
@end
