...
class Mappers {
    ...
    class func mapToBillingDetails(billingDetails: NSDictionary?) -> STPPaymentMethodBillingDetails? {
        ...
        billing.email = ABI41_0_0RCTConvert.nsString(billingDetails["email"])
        billing.phone = ABI41_0_0RCTConvert.nsString(billingDetails["phone"])
        billing.name = ABI41_0_0RCTConvert.nsString(billingDetails["name"])
        
        let billingAddres = STPPaymentMethodAddress()
        
        billingAddres.city = ABI41_0_0RCTConvert.nsString(billingDetails["addressCity"])
        billingAddres.postalCode = ABI41_0_0RCTConvert.nsString(billingDetails["addressPostalCode"])
        billingAddres.country = ABI41_0_0RCTConvert.nsString(billingDetails["addressCountry"])
        billingAddres.line1 = ABI41_0_0RCTConvert.nsString(billingDetails["addressLine1"])
        billingAddres.line2 = ABI41_0_0RCTConvert.nsString(billingDetails["addressLine2"])
        billingAddres.state = ABI41_0_0RCTConvert.nsString(billingDetails["addressState"])
