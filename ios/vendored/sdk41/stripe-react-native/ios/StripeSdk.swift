...
@objc(ABI41_0_0StripeSdk)
class StripeSdk: ABI41_0_0RCTEventEmitter, STPApplePayContextDelegate, STPBankSelectionViewControllerDelegate, UIAdaptivePresentationControllerDelegate {
    ...
    var applePayRequestResolver: ABI41_0_0RCTPromiseResolveBlock? = nil
    var applePayRequestRejecter: ABI41_0_0RCTPromiseRejectBlock? = nil
    var applePayCompletionRejecter: ABI41_0_0RCTPromiseRejectBlock? = nil
    var confirmApplePayPaymentResolver: ABI41_0_0RCTPromiseResolveBlock? = nil
    var confirmPaymentResolver: ABI41_0_0RCTPromiseResolveBlock? = nil
    var confirmPaymentRejecter: ABI41_0_0RCTPromiseRejectBlock? = nil
    ...
    func initialise(params: NSDictionary, resolver resolve: @escaping ABI41_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI41_0_0RCTPromiseRejectBlock) -> Void {
        ...
        let name = ABI41_0_0RCTConvert.nsString(appInfo["name"]) ?? ""
        let partnerId = ABI41_0_0RCTConvert.nsString(appInfo["partnerId"]) ?? ""
        let version = ABI41_0_0RCTConvert.nsString(appInfo["version"]) ?? ""
        let url = ABI41_0_0RCTConvert.nsString(appInfo["url"]) ?? ""
    ...
    func initPaymentSheet(params: NSDictionary, resolver resolve: @escaping ABI41_0_0RCTPromiseResolveBlock,
                          rejecter reject: @escaping ABI41_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func confirmPaymentSheetPayment(resolver resolve: @escaping ABI41_0_0RCTPromiseResolveBlock,
                                    rejecter reject: @escaping ABI41_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func presentPaymentSheet(params: NSDictionary, resolver resolve: @escaping ABI41_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI41_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func createTokenForCVCUpdate(cvc: String?, resolver resolve: @escaping ABI41_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI41_0_0RCTPromiseRejectBlock) {
    ...
    func confirmSetupIntent (setupIntentClientSecret: String, params: NSDictionary,
                             options: NSDictionary, resolver resolve: @escaping ABI41_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI41_0_0RCTPromiseRejectBlock) {
    ...
    func updateApplePaySummaryItems(summaryItems: NSArray, resolver resolve: @escaping ABI41_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI41_0_0RCTPromiseRejectBlock) {
    ...
    func confirmApplePayPayment(clientSecret: String, resolver resolve: @escaping ABI41_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI41_0_0RCTPromiseRejectBlock) {
    ...
    func isApplePaySupported(resolver resolve: @escaping ABI41_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI41_0_0RCTPromiseRejectBlock) {
    ...
    func handleURLCallback(url: String?, resolver resolve: @escaping ABI41_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI41_0_0RCTPromiseRejectBlock) {
    ...
    func presentApplePay(params: NSDictionary,
                         resolver resolve: @escaping ABI41_0_0RCTPromiseResolveBlock,
                         rejecter reject: @escaping ABI41_0_0RCTPromiseRejectBlock) {
