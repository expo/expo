...
class Mappers {
    ...
    class func mapToBillingDetails(billingDetails: NSDictionary?) -> STPPaymentMethodBillingDetails? {
        ...
        billing.email = ABI43_0_0RCTConvert.nsString(billingDetails["email"])
        billing.phone = ABI43_0_0RCTConvert.nsString(billingDetails["phone"])
        billing.name = ABI43_0_0RCTConvert.nsString(billingDetails["name"])
        
        let billingAddres = STPPaymentMethodAddress()
        
        billingAddres.city = ABI43_0_0RCTConvert.nsString(billingDetails["addressCity"])
        billingAddres.postalCode = ABI43_0_0RCTConvert.nsString(billingDetails["addressPostalCode"])
        billingAddres.country = ABI43_0_0RCTConvert.nsString(billingDetails["addressCountry"])
        billingAddres.line1 = ABI43_0_0RCTConvert.nsString(billingDetails["addressLine1"])
        billingAddres.line2 = ABI43_0_0RCTConvert.nsString(billingDetails["addressLine2"])
        billingAddres.state = ABI43_0_0RCTConvert.nsString(billingDetails["addressState"])
