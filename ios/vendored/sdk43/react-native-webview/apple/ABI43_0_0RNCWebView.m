...
static NSString *const HistoryShimName = @"ABI43_0_0ReactNativeHistoryShim";
...
@interface ABI43_0_0_SwizzleHelperWK : UIView
@property (nonatomic, copy) WKWebView *webView;
@end
@implementation ABI43_0_0_SwizzleHelperWK
...
#if TARGET_OS_OSX
@interface ABI43_0_0RNCWKWebView : WKWebView
@end
@implementation ABI43_0_0RNCWKWebView
- (void)scrollWheel:(NSEvent *)theEvent {
  ABI43_0_0RNCWebView *rncWebView = (ABI43_0_0RNCWebView *)[self superview];
  ABI43_0_0RCTAssert([rncWebView isKindOfClass:[rncWebView class]], @"superview must be an ABI43_0_0RNCWebView");
...
@interface ABI43_0_0RNCWebView () <WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler,
#if !TARGET_OS_OSX
    UIScrollViewDelegate,
#endif // !TARGET_OS_OSX
    ABI43_0_0RCTAutoInsetsProtocol>

@property (nonatomic, copy) ABI43_0_0RCTDirectEventBlock onFileDownload;
@property (nonatomic, copy) ABI43_0_0RCTDirectEventBlock onLoadingStart;
@property (nonatomic, copy) ABI43_0_0RCTDirectEventBlock onLoadingFinish;
@property (nonatomic, copy) ABI43_0_0RCTDirectEventBlock onLoadingError;
@property (nonatomic, copy) ABI43_0_0RCTDirectEventBlock onLoadingProgress;
@property (nonatomic, copy) ABI43_0_0RCTDirectEventBlock onShouldStartLoadWithRequest;
@property (nonatomic, copy) ABI43_0_0RCTDirectEventBlock onHttpError;
@property (nonatomic, copy) ABI43_0_0RCTDirectEventBlock onMessage;
@property (nonatomic, copy) ABI43_0_0RCTDirectEventBlock onScroll;
@property (nonatomic, copy) ABI43_0_0RCTDirectEventBlock onContentProcessDidTerminate;
#if !TARGET_OS_OSX
@property (nonatomic, copy) WKWebView *webView;
#else
@property (nonatomic, copy) ABI43_0_0RNCWKWebView *webView;
#endif // !TARGET_OS_OSX
...
@implementation ABI43_0_0RNCWebView
{
#if !TARGET_OS_OSX
  UIColor * _savedBackgroundColor;
#else
  ABI43_0_0RCTUIColor * _savedBackgroundColor;
#endif // !TARGET_OS_OSX
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if ((self = [super initWithFrame:frame])) {
    ...
    #else
    super.backgroundColor = [ABI43_0_0RCTUIColor clearColor];
    #endif // !TARGET_OS_OSX
    _bounces = YES;
    _scrollEnabled = YES;
    ...
    #if !TARGET_OS_OSX
    _savedStatusBarStyle = ABI43_0_0RCTSharedApplication().statusBarStyle;
    _savedStatusBarHidden = ABI43_0_0RCTSharedApplication().statusBarHidden;
    #endif // !TARGET_OS_OSX
...
- (WKWebViewConfiguration *)setUpWkWebViewConfig
{
  ...
  if(self.useSharedProcessPool) {
    wkWebViewConfig.processPool = [[ABI43_0_0RNCWKProcessPoolManager sharedManager] sharedProcessPoolForScopeKey:self.scopeKey];
  }
  ...
  [wkWebViewConfig.userContentController addScriptMessageHandler:[[ABI43_0_0RNCWeakScriptMessageDelegate alloc] initWithDelegate:self]
...
#else
    _webView = [[ABI43_0_0RNCWKWebView alloc] initWithFrame:self.bounds configuration: wkWebViewConfig];
#endif // !TARGET_OS_OSX
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    ...
    ABI43_0_0RCTUnsafeExecuteOnMainQueueSync(^{
      [ABI43_0_0RCTSharedApplication() setStatusBarStyle:self->_savedStatusBarStyle animated:YES];
    });
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    ...
    ABI43_0_0RCTUnsafeExecuteOnMainQueueSync(^{
      [ABI43_0_0RCTSharedApplication() setStatusBarHidden:self->_savedStatusBarHidden animated:YES];
      [ABI43_0_0RCTSharedApplication() setStatusBarStyle:self->_savedStatusBarStyle animated:YES];
    });
#pragma clang diagnostic pop
}
...
#else
- (void)setBackgroundColor:(ABI43_0_0RCTUIColor *)backgroundColor
#endif // !TARGET_OS_OSX
{
...
- (void)setContentInset:(UIEdgeInsets)contentInset
{
  ...
  [ABI43_0_0RCTView autoAdjustInsetsForView:self
...
- (void)visitSource
{
    ...
    NSString *html = [ABI43_0_0RCTConvert NSString:_source[@"html"]];
    if (html) {
        NSURL *baseURL = [ABI43_0_0RCTConvert NSURL:_source[@"baseUrl"]];
        if (!baseURL) {
    ...
    NSString *headerCookie = [ABI43_0_0RCTConvert NSString:_source[@"headers"][@"cookie"]]; 
    if(headerCookie) {
    ...
    // Because of the way ABI43_0_0React works, as pages redirect, we actually end up
    ...
    if (request.URL.host) {
        ...
        NSURL* readAccessUrl = _allowingReadAccessToURL ? [ABI43_0_0RCTConvert NSURL:_allowingReadAccessToURL] : request.URL;
...
-(void)setHideKeyboardAccessoryView:(BOOL)hideKeyboardAccessoryView
{
    ...
    NSString* name = [NSString stringWithFormat:@"%@ABI43_0_0_SwizzleHelperWK", subview.class.superclass];
    ...
    if(newClass == nil)
    {
        ...
        Method method = class_getInstanceMethod([ABI43_0_0_SwizzleHelperWK class], @selector(inputAccessoryView));
...
- (void)postMessage:(NSString *)message
{
  ...
  NSString *source = [NSString
    ...
    ABI43_0_0RCTJSONStringify(eventInitDict, NULL)
  ];
...
- (void)layoutSubviews
{
  ...
  // Ensure webview takes the position and dimensions of ABI43_0_0RNCWebView
...
- (void)webView:(WKWebView *)webView runJavaScriptTextInputPanelWithPrompt:(NSString *)prompt defaultText:(NSString *)defaultText initiatedByFrame:(WKFrameInfo *)frame completionHandler:(void (^)(NSString *))completionHandler{
  ...
  const NSRect ABI43_0_0RCTSingleTextFieldFrame = NSMakeRect(0.0, 0.0, 275.0, 22.0);
  NSTextField *textField = [[NSTextField alloc] initWithFrame:ABI43_0_0RCTSingleTextFieldFrame];
...
-(UIViewController *)topViewController{
    return ABI43_0_0RCTPresentedViewController();
}
...
{
  ABI43_0_0RCTLogWarn(@"Webview Process Terminated");
  if (_onContentProcessDidTerminate) {
    NSMutableDictionary<NSString *, id> *event = [self baseEvent];
    _onContentProcessDidTerminate(event);
  }
          ...
          thenCall: (void (^)(NSString*)) callback
{
  if (self.enableApplePay) {
    ABI43_0_0RCTLogWarn(@"Cannot run javascript when apple pay is enabled");
    return;
  }
  [self.webView evaluateJavaScript: js completionHandler: ^(id result, NSError *error) {
    ...
    if (error != nil) {
      ABI43_0_0RCTLogWarn(@"%@", [NSString stringWithFormat:@"Error evaluating injectedJavaScript: This is possibly due to an unsupported return type. Try adding true to the end of your injectedJavaScript string. %@", error]);
    }
  }];
}
      ...
      */
      ...
      for (NSHTTPCookie *cookie in [[NSHTTPCookieStorage sharedHTTPCookieStorage] cookies]) {
        [script appendFormat:@"document.cookie = %@ + '=' + %@",
          ABI43_0_0RCTJSONStringify(cookie.name, NULL),
          ABI43_0_0RCTJSONStringify(cookie.value, NULL)];
        if (cookie.path) {
          [script appendFormat:@" + '; Path=' + %@", ABI43_0_0RCTJSONStringify(cookie.path, NULL)];
        }
...
- (NSURLRequest *)requestForSource:(id)json {
  NSURLRequest *request = [ABI43_0_0RCTConvert NSURLRequest:self.source];
...
@implementation ABI43_0_0RNCWeakScriptMessageDelegate
