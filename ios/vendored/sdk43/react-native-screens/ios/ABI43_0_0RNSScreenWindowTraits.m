...
// method to be used in Expo for checking if ABI43_0_0RNScreens have trait set
                ...
                inViewController:(UIViewController *)vc
{
  ...
  if ([lastViewController conformsToProtocol:@protocol(ABI43_0_0RNScreensViewControllerDelegate)]) {
    ...
    if ([lastViewController isKindOfClass:[ABI43_0_0RNScreensViewController class]]) {
      vc = [(ABI43_0_0RNScreensViewController *)lastViewController findActiveChildVC];
    } else if ([lastViewController isKindOfClass:[ABI43_0_0RNScreensNavigationController class]]) {
      vc = [(ABI43_0_0RNScreensNavigationController *)lastViewController topViewController];
    }
    return [vc isKindOfClass:[ABI43_0_0RNSScreen class]] &&
        [(ABI43_0_0RNSScreen *)vc findChildVCForConfigAndTrait:trait includingModals:includingModals] != nil;
  }
  return NO;
}
...
{
  return [ABI43_0_0RNSScreenWindowTraits shouldAskScreensForTrait:ABI43_0_0RNSWindowTraitOrientation
                                         includingModals:YES
                                        inViewController:vc];
}
