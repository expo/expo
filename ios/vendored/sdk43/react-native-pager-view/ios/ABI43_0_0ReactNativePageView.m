...
#import "ABI43_0_0ReactNativePageView.h"
...
@interface ABI43_0_0ReactNativePageView () <UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate>

@property(nonatomic, strong) UIPageViewController *reactPageViewController;
@property(nonatomic, strong) UIPageControl *reactPageIndicatorView;
@property(nonatomic, strong) ABI43_0_0RCTEventDispatcher *eventDispatcher;
...
@implementation ABI43_0_0ReactNativePageView {
    uint16_t _coalescingKey;
}

- (instancetype)initWithEventDispatcher:(ABI43_0_0RCTEventDispatcher *)eventDispatcher {
    if (self = [super init]) {
        _scrollEnabled = YES;
        _pageMargin = 0;
...
- (void)didUpdateABI43_0_0ReactSubviews {
    if (!self.reactPageViewController && self.ABI43_0_0ReactViewController != nil) {
        [self embed];
...
- (void)embed {
    ...
    pageIndicatorView.numberOfPages = self.ABI43_0_0ReactSubviews.count;
    ...
    [self ABI43_0_0ReactAddControllerToClosestParent:pageViewController];
...
- (void)setupInitialController {
    UIView *initialView = self.ABI43_0_0ReactSubviews[self.initialPage];
    if (initialView) {
        UIViewController *initialController = nil;
        if (initialView.ABI43_0_0ReactViewController) {
            initialController = initialView.ABI43_0_0ReactViewController;
        } else {
        ...
        [self setABI43_0_0ReactViewControllers:self.initialPage
...
- (void)setABI43_0_0ReactViewControllers:(NSInteger)index
    ...
    __weak ABI43_0_0ReactNativePageView *weakSelf = self;
        ...
        if (strongSelf.eventDispatcher) {
            if (strongSelf.lastReportedIndex != strongSelf.currentIndex) {
                if (shouldCallOnPageSelected) {
                    [strongSelf.eventDispatcher sendEvent:[[ABI43_0_0RCTOnPageSelected alloc] initWithABI43_0_0ReactTag:strongSelf.ABI43_0_0ReactTag position:@(index) coalescingKey:coalescingKey]];
                }
...
- (UIViewController *)findCachedControllerForView:(UIView *)view {
    for (UIViewController *controller in self.cachedControllers) {
        if (controller.view.ABI43_0_0ReactTag == view.ABI43_0_0ReactTag) {
            return controller;
        }
    }
    return nil;
...
- (void)updateDataSource {
    if (!self.currentView && self.ABI43_0_0ReactSubviews.count == 0) {
        return;
    }
    
    NSInteger newIndex = self.currentView ? [self.ABI43_0_0ReactSubviews indexOfObject:self.currentView] : 0;
    
    if (newIndex == NSNotFound) {
        // Current view was removed
        NSInteger maxPage = self.ABI43_0_0ReactSubviews.count - 1;
...
- (void)goTo:(NSInteger)index animated:(BOOL)animated {
    NSInteger numberOfPages = self.ABI43_0_0ReactSubviews.count;
...
- (void)goToViewController:(NSInteger)index
                            ...
                            animated:(BOOL)animated
                            shouldCallOnPageSelected:(BOOL)shouldCallOnPageSelected {
    UIView *viewToDisplay = self.ABI43_0_0ReactSubviews[index];
    UIViewController *controllerToDisplay = [self findAndCacheControllerForView:viewToDisplay];
    [self setABI43_0_0ReactViewControllers:index
...
- (UIViewController *)findAndCacheControllerForView:(UIView *)viewToDisplay {
    ...
    if (!controllerToDisplay && current.view.ABI43_0_0ReactTag == viewToDisplay.ABI43_0_0ReactTag) {
        controllerToDisplay = current;
    }
    if (!controllerToDisplay) {
        if (viewToDisplay.ABI43_0_0ReactViewController) {
            controllerToDisplay = viewToDisplay.ABI43_0_0ReactViewController;
        } else {
...
- (UIViewController *)nextControllerForController:(UIViewController *)controller
    ...
    NSUInteger numberOfPages = self.ABI43_0_0ReactSubviews.count;
    NSInteger index = [self.ABI43_0_0ReactSubviews indexOfObject:controller.view];
...
- (void)pageViewController:(UIPageViewController *)pageViewController
   ...
   previousViewControllers:(nonnull NSArray<UIViewController *> *)previousViewControllers
    ...
    if (completed) {
        ...
        NSUInteger currentIndex = [self.ABI43_0_0ReactSubviews indexOfObject:currentVC.view];
        
        self.currentIndex = currentIndex;
        self.currentView = currentVC.view;
        self.reactPageIndicatorView.currentPage = currentIndex;
        [self.eventDispatcher sendEvent:[[ABI43_0_0RCTOnPageSelected alloc] initWithABI43_0_0ReactTag:self.ABI43_0_0ReactTag position:@(currentIndex) coalescingKey:_coalescingKey++]];
        [self.eventDispatcher sendEvent:[[ABI43_0_0RCTOnPageScrollEvent alloc] initWithABI43_0_0ReactTag:self.ABI43_0_0ReactTag position:@(currentIndex) offset:@(0.0)]];
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView {
    [self.eventDispatcher sendEvent:[[ABI43_0_0RCTOnPageScrollStateChanged alloc] initWithABI43_0_0ReactTag:self.ABI43_0_0ReactTag state:@"dragging" coalescingKey:_coalescingKey++]];
}

- (void)scrollViewWillEndDragging:(UIScrollView *)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(inout CGPoint *)targetContentOffset {
    [self.eventDispatcher sendEvent:[[ABI43_0_0RCTOnPageScrollStateChanged alloc] initWithABI43_0_0ReactTag:self.ABI43_0_0ReactTag state:@"settling" coalescingKey:_coalescingKey++]];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    [self.eventDispatcher sendEvent:[[ABI43_0_0RCTOnPageScrollStateChanged alloc] initWithABI43_0_0ReactTag:self.ABI43_0_0ReactTag state:@"idle" coalescingKey:_coalescingKey++]];
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    [self.eventDispatcher sendEvent:[[ABI43_0_0RCTOnPageScrollEvent alloc] initWithABI43_0_0ReactTag:self.ABI43_0_0ReactTag position:@(position) offset:@(absoluteOffset)]];
}
