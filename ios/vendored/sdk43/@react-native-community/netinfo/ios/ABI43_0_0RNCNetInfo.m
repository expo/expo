...
@interface ABI43_0_0RNCNetInfo () <ABI43_0_0RNCConnectionStateWatcherDelegate>

@property (nonatomic, strong) ABI43_0_0RNCConnectionStateWatcher *connectionStateWatcher;
@property (nonatomic) BOOL isObserving;

@end

@implementation ABI43_0_0RNCNetInfo

#pragma mark - Module setup

ABI43_0_0RCT_EXPORT_MODULE()

// We need ABI43_0_0RNCReachabilityCallback's and module methods to be called on the same thread so that we can have
...
- (instancetype)init
{
  self = [super init];
  if (self) {
    _connectionStateWatcher = [[ABI43_0_0RNCConnectionStateWatcher alloc] initWithDelegate:self];
  }
  return self;
}
...
#pragma mark - ABI43_0_0RNCConnectionStateWatcherDelegate
...
ABI43_0_0RCT_EXPORT_METHOD(getCurrentState:(nullable NSString *)requestedInterface resolve:(ABI43_0_0RCTPromiseResolveBlock)resolve
                  reject:(__unused ABI43_0_0RCTPromiseRejectBlock)reject)
{
  ABI43_0_0RNCConnectionState *state = [self.connectionStateWatcher currentState];
...
- (NSDictionary *)currentDictionaryFromUpdateState:(ABI43_0_0RNCConnectionState *)state withInterface:(nullable NSString *)requestedInterface
{
...
- (NSMutableDictionary *)detailsFromInterface:(nonnull NSString *)requestedInterface withState:(ABI43_0_0RNCConnectionState *)state
{
  NSMutableDictionary *details = [NSMutableDictionary new];
  if ([requestedInterface isEqualToString: ABI43_0_0RNCConnectionTypeCellular]) {
    details[@"cellularGeneration"] = state.cellularGeneration ?: NSNull.null;
    details[@"carrier"] = [self carrier] ?: NSNull.null;
  } else if ([requestedInterface isEqualToString: ABI43_0_0RNCConnectionTypeWifi] || [requestedInterface isEqualToString: ABI43_0_0RNCConnectionTypeEthernet]) {
