...
#import "ABI43_0_0REABezierNode.h"
...
@implementation ABI43_0_0REABezierNode {
...
- (instancetype)initWithID:(ABI43_0_0REANodeID)nodeID config:(NSDictionary<NSString *,id> *)config
{
  if ((self = [super initWithID:nodeID config:config])) {
    _inputNodeID = [ABI43_0_0RCTConvert NSNumber:config[@"input"]];
    ABI43_0_0REA_LOG_ERROR_IF_NIL(_inputNodeID, @"Reanimated: First argument passed to bezier node is either of wrong type or is missing.");
