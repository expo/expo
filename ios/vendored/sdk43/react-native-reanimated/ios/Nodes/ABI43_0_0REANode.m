...
@interface ABI43_0_0REAUpdateContext ()

@property (nonatomic, nonnull) NSMutableArray<ABI43_0_0REANode *> *updatedNodes;
@property (nonatomic) NSNumber* loopID;

@end

@implementation ABI43_0_0REAUpdateContext
...
@interface ABI43_0_0REANode ()

@property (nonatomic) NSMutableDictionary<ABI43_0_0REANodeID, NSNumber*>* lastLoopID;
@property (nonatomic) NSMutableDictionary<ABI43_0_0REANodeID, id>* memoizedValue;
@property (nonatomic, nullable) NSMutableArray<ABI43_0_0REANode *> *childNodes;

@end

@implementation ABI43_0_0REANode
...
- (void)addChild:(ABI43_0_0REANode *)child
{
  if (!_childNodes) {
...
- (void)removeChild:(ABI43_0_0REANode *)child
{
  if (child) {
...
+ (NSMutableArray<ABI43_0_0REANode *> *)updatedNodes
{
  static NSMutableArray<ABI43_0_0REANode *> *updatedNodes;
...
+ (void)findAndUpdateNodes:(nonnull ABI43_0_0REANode *)node
            withVisitedSet:(NSMutableSet<ABI43_0_0REANode *> *)visitedNodes
            withFinalNodes:(NSMutableArray<id<ABI43_0_0REAFinalNode>> *)finalNodes
{
  ...
  for (ABI43_0_0REANode *child in node.childNodes) {
    [self findAndUpdateNodes:child withVisitedSet:visitedNodes withFinalNodes:finalNodes];
  }
  if ([node conformsToProtocol:@protocol(ABI43_0_0REAFinalNode)]) {
    [finalNodes addObject:(id<ABI43_0_0REAFinalNode>)node];
  }
}

+ (void)runPropUpdates:(ABI43_0_0REAUpdateContext *)context
{
  NSMutableSet<ABI43_0_0REANode *> *visitedNodes = [NSMutableSet new];
  NSMutableArray<id<ABI43_0_0REAFinalNode>> *finalNodes = [NSMutableArray new];
