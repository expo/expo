...
CGFloat ABI43_0_0SimAnimationDragCoefficient()
{
#if TARGET_IPHONE_SIMULATOR
...
@implementation ABI43_0_0REATransitionAnimation {
...
{
  ABI43_0_0REATransitionAnimation *anim = [ABI43_0_0REATransitionAnimation new];
...
- (void)play
{
  ...
  */
  if (_delay > 0){
    _animation.beginTime = CACurrentMediaTime() + _delay * ABI43_0_0SimAnimationDragCoefficient();
  }
  _animation.duration = self.duration * ABI43_0_0SimAnimationDragCoefficient();
