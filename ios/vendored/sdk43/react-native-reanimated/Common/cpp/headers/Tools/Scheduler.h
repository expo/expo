...
class Scheduler {
  public:
    ...
    void setJSCallInvoker(std::shared_ptr<ABI43_0_0facebook::ABI43_0_0React::CallInvoker> jsCallInvoker);
  ...
  protected:
    ...
    std::shared_ptr<ABI43_0_0facebook::ABI43_0_0React::CallInvoker> jsCallInvoker_;
