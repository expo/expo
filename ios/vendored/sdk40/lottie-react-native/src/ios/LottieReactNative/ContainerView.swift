#if canImport(ABI40_0_0React)
import ABI40_0_0React
#endif

import Lottie

class ContainerView: ABI40_0_0RCTView {
    ...
    @objc var onAnimationFinish: ABI40_0_0RCTBubblingEventBlock?
    ...
    override func abi40_0_0ReactSetFrame(_ frame: CGRect) {
        super.abi40_0_0ReactSetFrame(frame)
        animationView?.abi40_0_0ReactSetFrame(frame)
    }
