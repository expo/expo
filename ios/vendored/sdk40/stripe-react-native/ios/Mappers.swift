...
class Mappers {
    ...
    class func mapToPaymentMethodCardParams(params: NSDictionary) -> STPPaymentMethodCardParams {
        ...
        cardSourceParams.number = ABI40_0_0RCTConvert.nsString(params["number"])
        cardSourceParams.cvc = ABI40_0_0RCTConvert.nsString(params["cvc"])
        cardSourceParams.expMonth = ABI40_0_0RCTConvert.nsuInteger(params["expiryMonth"])
        cardSourceParams.expYear = ABI40_0_0RCTConvert.nsuInteger(params["expiryYear"])
    ...
    class func mapToBillingDetails(billingDetails: NSDictionary?) -> STPPaymentMethodBillingDetails? {
        ...
        billing.email = ABI40_0_0RCTConvert.nsString(billingDetails["email"])
        billing.phone = ABI40_0_0RCTConvert.nsString(billingDetails["phone"])
        billing.name = ABI40_0_0RCTConvert.nsString(billingDetails["name"])
        
        let billingAddres = STPPaymentMethodAddress()
        
        billingAddres.city = ABI40_0_0RCTConvert.nsString(billingDetails["addressCity"])
        billingAddres.postalCode = ABI40_0_0RCTConvert.nsString(billingDetails["addressPostalCode"])
        billingAddres.country = ABI40_0_0RCTConvert.nsString(billingDetails["addressCountry"])
        billingAddres.line1 = ABI40_0_0RCTConvert.nsString(billingDetails["addressLine1"])
        billingAddres.line2 = ABI40_0_0RCTConvert.nsString(billingDetails["addressLine2"])
        billingAddres.state = ABI40_0_0RCTConvert.nsString(billingDetails["addressState"])
