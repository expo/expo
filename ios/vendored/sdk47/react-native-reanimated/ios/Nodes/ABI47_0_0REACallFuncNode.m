...
@implementation ABI47_0_0REACallFuncNode {
...
- (void)beginContext
{
  ...
  for (NSUInteger i = 0; i < _params.count; i++) {
    ...
    ABI47_0_0REAParamNode *param = (ABI47_0_0REAParamNode *)[self.nodesManager findNodeByID:paramID];
...
{
  [self beginContext];
  ABI47_0_0REAFunctionNode *what = (ABI47_0_0REAFunctionNode *)[self.nodesManager findNodeByID:_whatNodeID];
