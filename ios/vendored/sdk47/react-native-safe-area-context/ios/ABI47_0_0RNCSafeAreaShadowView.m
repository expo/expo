...
@implementation ABI47_0_0RNCSafeAreaShadowView {
  ABI47_0_0RNCSafeAreaViewLocalData *_localData;
  bool _needsUpdate;
...
- (void)extractEdges:(ABI47_0_0YGValue[])_metaProps
                 top:(CGFloat *)top
               right:(CGFloat *)right
              bottom:(CGFloat *)bottom
                left:(CGFloat *)left
{
  if (_metaProps[META_PROP_ALL].unit == ABI47_0_0YGUnitPoint) {
  ...
  if (_metaProps[META_PROP_HORIZONTAL].unit == ABI47_0_0YGUnitPoint) {
    *right = _metaProps[META_PROP_HORIZONTAL].value;
    *left = _metaProps[META_PROP_HORIZONTAL].value;
  }

  if (_metaProps[META_PROP_VERTICAL].unit == ABI47_0_0YGUnitPoint) {
    *top = _metaProps[META_PROP_VERTICAL].value;
    *bottom = _metaProps[META_PROP_VERTICAL].value;
  }

  if (_metaProps[META_PROP_TOP].unit == ABI47_0_0YGUnitPoint) {
    *top = _metaProps[META_PROP_TOP].value;
  }

  if (_metaProps[META_PROP_RIGHT].unit == ABI47_0_0YGUnitPoint) {
    *right = _metaProps[META_PROP_RIGHT].value;
  }

  if (_metaProps[META_PROP_BOTTOM].unit == ABI47_0_0YGUnitPoint) {
    *bottom = _metaProps[META_PROP_BOTTOM].value;
  }

  if (_metaProps[META_PROP_LEFT].unit == ABI47_0_0YGUnitPoint) {
    *left = _metaProps[META_PROP_LEFT].value;
  }
}

- (void)resetInsetsForMode:(ABI47_0_0RNCSafeAreaViewMode)mode
{
  if (mode == ABI47_0_0RNCSafeAreaViewModePadding) {
  ...
  } else if (mode == ABI47_0_0RNCSafeAreaViewModeMargin) {
...
- (void)updateInsets
{
  ...
  ABI47_0_0RNCSafeAreaViewMode mode = _localData.mode;
  ABI47_0_0RNCSafeAreaViewEdges edges = _localData.edges;
  ...
  CGFloat insetTop = (edges & ABI47_0_0RNCSafeAreaViewEdgesTop) ? insets.top : 0;
  CGFloat insetRight = (edges & ABI47_0_0RNCSafeAreaViewEdgesRight) ? insets.right : 0;
  CGFloat insetBottom = (edges & ABI47_0_0RNCSafeAreaViewEdgesBottom) ? insets.bottom : 0;
  CGFloat insetLeft = (edges & ABI47_0_0RNCSafeAreaViewEdgesLeft) ? insets.left : 0;

  if (mode == ABI47_0_0RNCSafeAreaViewModePadding) {
    [self extractEdges:_paddingMetaProps top:&top right:&right bottom:&bottom left:&left];
    super.paddingTop = (ABI47_0_0YGValue){insetTop + top, ABI47_0_0YGUnitPoint};
    super.paddingRight = (ABI47_0_0YGValue){insetRight + right, ABI47_0_0YGUnitPoint};
    super.paddingBottom = (ABI47_0_0YGValue){insetBottom + bottom, ABI47_0_0YGUnitPoint};
    super.paddingLeft = (ABI47_0_0YGValue){insetLeft + left, ABI47_0_0YGUnitPoint};
  } else if (mode == ABI47_0_0RNCSafeAreaViewModeMargin) {
    [self extractEdges:_marginMetaProps top:&top right:&right bottom:&bottom left:&left];
    super.marginTop = (ABI47_0_0YGValue){insetTop + top, ABI47_0_0YGUnitPoint};
    super.marginRight = (ABI47_0_0YGValue){insetRight + right, ABI47_0_0YGUnitPoint};
    super.marginBottom = (ABI47_0_0YGValue){insetBottom + bottom, ABI47_0_0YGUnitPoint};
    super.marginLeft = (ABI47_0_0YGValue){insetLeft + left, ABI47_0_0YGUnitPoint};
  }
}
...
- (void)setLocalData:(ABI47_0_0RNCSafeAreaViewLocalData *)localData
{
  ABI47_0_0RCTAssert(
      [localData isKindOfClass:[ABI47_0_0RNCSafeAreaViewLocalData class]],
      @"Local data object for `ABI47_0_0RCTRNCSafeAreaShadowView` must be `ABI47_0_0RCTRNCSafeAreaViewLocalData` instance.");
  ...
  if (_localData.mode == ABI47_0_0RNCSafeAreaViewModePadding) {
...
#define SHADOW_VIEW_MARGIN_PADDING_PROP(edge, metaProp) \
  -(void)setPadding##edge : (ABI47_0_0YGValue)value              \
  {                                                     \
    [super setPadding##edge:value];                     \
    _needsUpdate = true;                                \
    _paddingMetaProps[META_PROP_##metaProp] = value;    \
  }                                                     \
  -(void)setMargin##edge : (ABI47_0_0YGValue)value               \
  {                                                     \
