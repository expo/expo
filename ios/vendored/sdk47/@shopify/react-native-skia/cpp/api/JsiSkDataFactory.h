...
namespace ABI47_0_0RNSkia {
    ...
    public:
        JSI_HOST_FUNCTION(fromURI) {
            ...
            return ABI47_0_0React::createPromiseAsJSIValue(
                    runtime,
                    [context = std::move(context), localUri = std::move(localUri)](jsi::Runtime &runtime,
                                        std::shared_ptr<ABI47_0_0React::Promise> promise) -> void {
        ...
        JsiSkDataFactory(std::shared_ptr<ABI47_0_0RNSkPlatformContext> context)
