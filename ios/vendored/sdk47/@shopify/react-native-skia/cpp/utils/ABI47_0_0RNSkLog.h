...
public:
...
#ifdef ANDROID
    __android_log_write(ANDROID_LOG_INFO, "ABI47_0_0RNSkia", message.c_str());
#endif
...
#ifdef ANDROID
    __android_log_write(ANDROID_LOG_INFO, "ABI47_0_0RNSkia", buffer);
#endif
#ifdef TARGET_OS_IPHONE
    syslog(LOG_ERR, "%s\n", buffer);
#endif
  ...
  static void logToJavascriptConsole(jsi::Runtime& runtime, const std::string& message) {
    auto console = ABI47_0_0RNSkLogger::getJavascriptConsole(runtime).asObject(runtime);
