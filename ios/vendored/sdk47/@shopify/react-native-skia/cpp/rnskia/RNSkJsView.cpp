...
ABI47_0_0RNSkJsRenderer::ABI47_0_0RNSkJsRenderer(std::function<void()> requestRedraw,
  ...
  _infoObject(std::make_shared<ABI47_0_0RNSkInfoObject>()),
...
bool ABI47_0_0RNSkJsRenderer::tryRender(std::shared_ptr<ABI47_0_0RNSkCanvasProvider> canvasProvider) {
...
void ABI47_0_0RNSkJsRenderer::renderImmediate(std::shared_ptr<ABI47_0_0RNSkCanvasProvider> canvasProvider) {
...
void ABI47_0_0RNSkJsRenderer::setDrawCallback(std::shared_ptr<jsi::Function> drawCallback) {
  _drawCallback = drawCallback;
}

std::shared_ptr<ABI47_0_0RNSkInfoObject> ABI47_0_0RNSkJsRenderer::getInfoObject() {
  return _infoObject;
}
  
void ABI47_0_0RNSkJsRenderer::performDraw(std::shared_ptr<ABI47_0_0RNSkCanvasProvider> canvasProvider) {
  // Start timing
...
void ABI47_0_0RNSkJsRenderer::callJsDrawCallback(std::shared_ptr<JsiSkCanvas> jsiCanvas,
                        int width,
                        int height,
                        double timestamp) {
...
void ABI47_0_0RNSkJsRenderer::drawInJsiCanvas(std::shared_ptr<JsiSkCanvas> jsiCanvas,
                     int width,
                     int height,
                     double time) {
