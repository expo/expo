...
class ABI47_0_0RNSkPlatformContext {
public:
  /**
   * Constructor
   */
  ABI47_0_0RNSkPlatformContext(
      jsi::Runtime *runtime, std::shared_ptr<ABI47_0_0React::CallInvoker> callInvoker,
      float pixelDensity)
      : _pixelDensity(pixelDensity), _jsRuntime(runtime),
        _callInvoker(callInvoker),
        _dispatchQueue(std::make_unique<ABI47_0_0RNSkDispatchQueue>("skia-render-thread")) {
   ...
   * Destructor
   */
  virtual ~ABI47_0_0RNSkPlatformContext() {
    invalidate();
  }
...
private:
  ...
  std::shared_ptr<ABI47_0_0React::CallInvoker> _callInvoker;
  std::unique_ptr<ABI47_0_0RNSkDispatchQueue> _dispatchQueue;
