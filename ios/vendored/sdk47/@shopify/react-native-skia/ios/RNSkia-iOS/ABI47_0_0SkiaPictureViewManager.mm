...
@implementation ABI47_0_0SkiaPictureViewManager

ABI47_0_0RCT_EXPORT_MODULE(SkiaPictureView)
...
- (UIView *)view
{
  ...
  return [[ABI47_0_0SkiaUIView alloc] initWithManager: skManager.get()
    ...
    return std::make_shared<ABI47_0_0RNSkiOSView<ABI47_0_0RNSkia::ABI47_0_0RNSkPictureView>>(context);
  }];
}
