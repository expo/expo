...
@implementation ABI47_0_0SkiaUIView {
  std::shared_ptr<ABI47_0_0RNSkBaseiOSView> _impl;
  ABI47_0_0RNSkia::ABI47_0_0RNSkManager* _manager;
  ABI47_0_0RNSkia::ABI47_0_0RNSkDrawingMode _drawingMode;
  std::function<std::shared_ptr<ABI47_0_0RNSkBaseiOSView>(std::shared_ptr<ABI47_0_0RNSkia::ABI47_0_0RNSkPlatformContext>)> _factory;
  bool _debugMode;
  size_t _nativeId;
}
                                     ...
                                     std::shared_ptr<ABI47_0_0RNSkia::ABI47_0_0RNSkPlatformContext>)>)factory
{
  ...
  if (self) {
    ...
    _nativeId = 0;
    _debugMode = false;
    _drawingMode = ABI47_0_0RNSkia::ABI47_0_0RNSkDrawingMode::Default;
    _factory = factory;
    
    // Listen to notifications about module invalidation
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(willInvalidateModules)
                                                 name:ABI47_0_0RCTBridgeWillInvalidateModulesNotification
                                               object:nil];
  }
  return self;
}
...
- (void) dealloc {
  ...
  [[NSNotificationCenter defaultCenter] removeObserver:self name:ABI47_0_0RCTBridgeWillInvalidateModulesNotification object:nil];
...
-(void) setDrawingMode:(std::string) mode {
  _drawingMode = mode.compare("continuous") == 0 ? ABI47_0_0RNSkia::ABI47_0_0RNSkDrawingMode::Continuous : ABI47_0_0RNSkia::ABI47_0_0RNSkDrawingMode::Default;
...
- (void) handleTouches:(NSSet<UITouch*>*) touches withEvent:(UIEvent*) event {
  if (event.type == UIEventTypeTouches) {
    std::vector<ABI47_0_0RNSkia::ABI47_0_0RNSkTouchInfo> nextTouches;
    for (UITouch *touch in touches) {
      auto position = [touch preciseLocationInView:self];
      ABI47_0_0RNSkia::ABI47_0_0RNSkTouchInfo nextTouch;
      ...
      switch(phase) {
        case UITouchPhaseBegan:
          nextTouch.type = ABI47_0_0RNSkia::ABI47_0_0RNSkTouchInfo::TouchType::Start;
          break;
        case UITouchPhaseMoved:
          nextTouch.type = ABI47_0_0RNSkia::ABI47_0_0RNSkTouchInfo::TouchType::Active;
          break;
        case UITouchPhaseEnded:
          nextTouch.type = ABI47_0_0RNSkia::ABI47_0_0RNSkTouchInfo::TouchType::End;
          break;
        case UITouchPhaseCancelled:
          nextTouch.type = ABI47_0_0RNSkia::ABI47_0_0RNSkTouchInfo::TouchType::Cancelled;
          break;
        default:
          nextTouch.type = ABI47_0_0RNSkia::ABI47_0_0RNSkTouchInfo::TouchType::Active;
          break;
