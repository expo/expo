...
class StripeSdk: ABI47_0_0RCTEventEmitter, STPApplePayContextDelegate, STPBankSelectionViewControllerDelegate, UIAdaptivePresentationControllerDelegate {
    ...
    var applePayRequestResolver: ABI47_0_0RCTPromiseResolveBlock? = nil
    var applePayRequestRejecter: ABI47_0_0RCTPromiseRejectBlock? = nil
    var applePayCompletionRejecter: ABI47_0_0RCTPromiseRejectBlock? = nil
    var confirmApplePayPaymentResolver: ABI47_0_0RCTPromiseResolveBlock? = nil
    var confirmPaymentResolver: ABI47_0_0RCTPromiseResolveBlock? = nil
    ...
    func initialise(params: NSDictionary, resolver resolve: @escaping ABI47_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI47_0_0RCTPromiseRejectBlock) -> Void {
        ...
        let name = ABI47_0_0RCTConvert.nsString(appInfo["name"]) ?? ""
        let partnerId = ABI47_0_0RCTConvert.nsString(appInfo["partnerId"]) ?? ""
        let version = ABI47_0_0RCTConvert.nsString(appInfo["version"]) ?? ""
        let url = ABI47_0_0RCTConvert.nsString(appInfo["url"]) ?? ""
    ...
    func initPaymentSheet(params: NSDictionary, resolver resolve: @escaping ABI47_0_0RCTPromiseResolveBlock,
                          rejecter reject: @escaping ABI47_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func confirmPaymentSheetPayment(resolver resolve: @escaping ABI47_0_0RCTPromiseResolveBlock,
                                    rejecter reject: @escaping ABI47_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func presentPaymentSheet(resolver resolve: @escaping ABI47_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI47_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func createTokenForCVCUpdate(cvc: String?, resolver resolve: @escaping ABI47_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI47_0_0RCTPromiseRejectBlock) {
    ...
    func confirmSetupIntent (setupIntentClientSecret: String, params: NSDictionary,
                             options: NSDictionary, resolver resolve: @escaping ABI47_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI47_0_0RCTPromiseRejectBlock) {
    ...
    func updateApplePaySummaryItems(summaryItems: NSArray, errorAddressFields: [NSDictionary], resolver resolve: @escaping ABI47_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI47_0_0RCTPromiseRejectBlock) {
    ...
    func openApplePaySetup(resolver resolve: @escaping ABI47_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI47_0_0RCTPromiseRejectBlock) -> Void {
    ...
    func confirmApplePayPayment(clientSecret: String, resolver resolve: @escaping ABI47_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI47_0_0RCTPromiseRejectBlock) {
    ...
    func isApplePaySupported(resolver resolve: @escaping ABI47_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI47_0_0RCTPromiseRejectBlock) {
    ...
    func handleURLCallback(url: String?, resolver resolve: @escaping ABI47_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI47_0_0RCTPromiseRejectBlock) {
    ...
    func presentApplePay(params: NSDictionary,
                         resolver resolve: @escaping ABI47_0_0RCTPromiseResolveBlock,
                         rejecter reject: @escaping ABI47_0_0RCTPromiseRejectBlock) {
