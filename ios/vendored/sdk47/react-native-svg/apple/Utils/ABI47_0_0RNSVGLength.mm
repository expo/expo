...
@implementation ABI47_0_0RNSVGLength
...
{
  ABI47_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype)lengthWithString:(NSString *)lengthString
{
  ...
  ABI47_0_0RNSVGLength *output = [ABI47_0_0RNSVGLength alloc];
  if (stringLength == 0) {
    ...
    ABI47_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
