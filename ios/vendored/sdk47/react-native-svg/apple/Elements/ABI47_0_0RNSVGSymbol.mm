...
@implementation ABI47_0_0RNSVGSymbol
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI47_0_0RNSVGSymbolProps>();
    _props = defaultProps;
  }
  return self;
}
...
{
  return concreteComponentDescriptorProvider<ABI47_0_0RNSVGSymbolComponentDescriptor>();
}

- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  const auto &newProps = *std::static_pointer_cast<const ABI47_0_0RNSVGSymbolProps>(props);
  ...
  _props = std::static_pointer_cast<ABI47_0_0RNSVGSymbolProps const>(props);
}
...
#ifdef RN_FABRIC_ENABLED
Class<ABI47_0_0RCTComponentViewProtocol> ABI47_0_0RNSVGSymbolCls(void)
{
  return ABI47_0_0RNSVGSymbol.class;
}
#endif // RN_FABRIC_ENABLED
