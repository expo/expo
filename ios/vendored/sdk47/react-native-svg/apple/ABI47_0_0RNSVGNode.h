...
#import <ABI47_0_0React/ABI47_0_0RCTPointerEvents.h>
...
/**
 * ABI47_0_0RNSVG nodes are implemented as base NSViews/UIViews. They should be implementation for all basic
 ＊interfaces for all non-definition nodes.
 */

@interface ABI47_0_0RNSVGNode :
#ifdef RN_FABRIC_ENABLED
 ...
 */
extern CGFloat const ABI47_0_0RNSVG_M_SQRT1_2l;
extern CGFloat const ABI47_0_0RNSVG_DEFAULT_FONT_SIZE;

@property (nonatomic, strong) NSString *name;
@property (nonatomic, strong) NSString *display;
@property (nonatomic, assign) CGFloat opacity;
@property (nonatomic, assign) ABI47_0_0RNSVGCGFCRule clipRule;
...
@property (nonatomic, strong) ABI47_0_0RNSVGPlatformView *parentComponentView;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI47_0_0RCTPointerEvents pointerEvents;
...
/**
 * ABI47_0_0RNSVGSvgView which ownes current ABI47_0_0RNSVGNode
 */
@property (nonatomic, readonly, weak) ABI47_0_0RNSVGSvgView *svgView;
@property (nonatomic, readonly, weak) ABI47_0_0RNSVGGroup *textRoot;

- (void)invalidate;

- (ABI47_0_0RNSVGGroup *)getParentTextRoot;
...
- (CGFloat)relativeOn:(ABI47_0_0RNSVGLength *)length relative:(CGFloat)relative;

- (CGFloat)relativeOnWidth:(ABI47_0_0RNSVGLength *)length;

- (CGFloat)relativeOnHeight:(ABI47_0_0RNSVGLength *)length;

- (CGFloat)relativeOnOther:(ABI47_0_0RNSVGLength *)length;
...
- (void)traverseSubviews:(BOOL (^)(__kindof ABI47_0_0RNSVGView *node))block;
