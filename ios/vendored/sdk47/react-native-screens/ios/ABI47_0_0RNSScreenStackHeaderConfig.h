...
@interface ABI47_0_0RNSScreenStackHeaderConfig :
#ifdef RN_FABRIC_ENABLED
...
@property (nonatomic, weak) ABI47_0_0RNSScreenView *screenView;
...
@interface ABI47_0_0RNSScreenStackHeaderConfigManager : ABI47_0_0RCTViewManager

@end

@interface ABI47_0_0RCTConvert (ABI47_0_0RNSScreenStackHeader)
