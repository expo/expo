...
typedef enum ABI47_0_0RNCWebViewPermissionGrantType : NSUInteger {
  ABI47_0_0RNCWebViewPermissionGrantType_GrantIfSameHost_ElsePrompt,
  ABI47_0_0RNCWebViewPermissionGrantType_GrantIfSameHost_ElseDeny,
  ABI47_0_0RNCWebViewPermissionGrantType_Deny,
  ABI47_0_0RNCWebViewPermissionGrantType_Grant,
  ABI47_0_0RNCWebViewPermissionGrantType_Prompt
} ABI47_0_0RNCWebViewPermissionGrantType;

@class ABI47_0_0RNCWebView;

@protocol ABI47_0_0RNCWebViewDelegate <NSObject>

- (BOOL)webView:(ABI47_0_0RNCWebView *_Nonnull)webView
shouldStartLoadForRequest:(NSMutableDictionary<NSString *, id> *_Nonnull)request
   withCallback:(ABI47_0_0RCTDirectEventBlock _Nonnull)callback;

@end

@interface ABI47_0_0RNCWeakScriptMessageDelegate : NSObject<WKScriptMessageHandler>
...
@interface ABI47_0_0RNCWebView : ABI47_0_0RCTView
@property (nonatomic, strong) NSString *scopeKey;

@property (nonatomic, weak) id<ABI47_0_0RNCWebViewDelegate> _Nullable delegate;
...
@property (nonatomic, assign) ABI47_0_0RNCWebViewPermissionGrantType mediaCapturePermissionGrantType;
#endif
