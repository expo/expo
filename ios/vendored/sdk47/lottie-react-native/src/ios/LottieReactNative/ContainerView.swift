...
class ContainerView: ABI47_0_0RCTView {
    ...
    @objc var onAnimationFinish: ABI47_0_0RCTBubblingEventBlock?
    ...
    override func abi47_0_0ReactSetFrame(_ frame: CGRect) {
        super.abi47_0_0ReactSetFrame(frame)
        animationView?.abi47_0_0ReactSetFrame(frame)
    }
