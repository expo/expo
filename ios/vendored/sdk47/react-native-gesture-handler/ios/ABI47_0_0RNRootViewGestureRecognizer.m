//
//  ABI47_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI47_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI47_0_0RNGestureHandler *otherHandler = [ABI47_0_0RNGestureHandler
...
#ifdef ABI47_0_0RN_FABRIC_ENABLED
        ABI47_0_0RCTSurfaceTouchHandler
#else
        ABI47_0_0RCTTouchHandler
#endif
        class]];
}
