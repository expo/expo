...
@implementation ABI47_0_0RNGestureHandlerEventExtraData
...
{
    return [[ABI47_0_0RNGestureHandlerEventExtraData alloc]
            initWithData:@{
                           @"x": @(position.x),
                           @"y": @(position.y),
                             ...
                             withNumberOfTouches:(NSUInteger)numberOfTouches
{
    if (changedPointers == nil || allPointers == nil) {
        changedPointers = @[];
        allPointers = @[];
        eventType = ABI47_0_0RNGHTouchEventTypeUndetermined;
    }
...
@implementation ABI47_0_0RNGestureHandlerEvent
{
    NSNumber *_handlerTag;
    ABI47_0_0RNGestureHandlerState _state;
    ABI47_0_0RNGestureHandlerEventExtraData *_extraData;
}
...
@implementation ABI47_0_0RNGestureHandlerStateChange
{
    NSNumber *_handlerTag;
    ABI47_0_0RNGestureHandlerState _state;
    ABI47_0_0RNGestureHandlerState _prevState;
    ABI47_0_0RNGestureHandlerEventExtraData *_extraData;
}
