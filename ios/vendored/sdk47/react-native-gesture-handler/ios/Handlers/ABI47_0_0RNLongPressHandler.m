...
#import "ABI47_0_0RNLongPressHandler.h"
...
@interface ABI47_0_0RNBetterLongPressGestureRecognizer : UILongPressGestureRecognizer {
  uint64_t startTime;
...
@implementation ABI47_0_0RNBetterLongPressGestureRecognizer {
...
@implementation ABI47_0_0RNLongPressGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI47_0_0RNBetterLongPressGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.minimumPressDuration = [ABI47_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDist"];
  if (prop != nil) {
    recognizer.allowableMovement = [ABI47_0_0RCTConvert CGFloat:prop];
  }
}
...
- (ABI47_0_0RNGestureHandlerEventExtraData *)eventExtraData:(UIGestureRecognizer *)recognizer
{
    return [ABI47_0_0RNGestureHandlerEventExtraData
            ...
            withDuration:[(ABI47_0_0RNBetterLongPressGestureRecognizer*)recognizer getDuration]];
}
@end
