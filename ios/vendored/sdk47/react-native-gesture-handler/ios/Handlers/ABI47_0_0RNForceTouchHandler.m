#import "ABI47_0_0RNForceTouchHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI47_0_0React/ABI47_0_0RCTConvert.h>

@interface ABI47_0_0RNForceTouchGestureRecognizer : UIGestureRecognizer
...
@implementation ABI47_0_0RNForceTouchGestureRecognizer {
...
@implementation ABI47_0_0RNForceTouchHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI47_0_0RNForceTouchGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
{
  [super resetConfig];
  ABI47_0_0RNForceTouchGestureRecognizer *recognizer = (ABI47_0_0RNForceTouchGestureRecognizer *)_recognizer;
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.feedbackOnActivation = [ABI47_0_0RCTConvert BOOL:prop];
  }
}

- (ABI47_0_0RNGestureHandlerEventExtraData *)eventExtraData:(ABI47_0_0RNForceTouchGestureRecognizer *)recognizer
{
