...
#import "ABI47_0_0RNTapHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI47_0_0React/ABI47_0_0RCTConvert.h>

// ABI47_0_0RNBetterTapGestureRecognizer extends UIGestureRecognizer instead of UITapGestureRecognizer 
...
@interface ABI47_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
@implementation ABI47_0_0RNBetterTapGestureRecognizer {
...
@implementation ABI47_0_0RNTapGestureHandler {
    ABI47_0_0RNGestureHandlerEventExtraData * _lastData;
}

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI47_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
{
  [super resetConfig];
  ABI47_0_0RNBetterTapGestureRecognizer *recognizer = (ABI47_0_0RNBetterTapGestureRecognizer *)_recognizer;
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.maxDelay = [ABI47_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDurationMs"];
  if (prop != nil) {
    recognizer.maxDuration = [ABI47_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
  ...
  // in ABI47_0_0RNGestureHandler it resets _lastSatate variable, making is seem like handler
