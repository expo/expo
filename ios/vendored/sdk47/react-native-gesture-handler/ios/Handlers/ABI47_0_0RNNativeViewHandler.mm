//
//  ABI47_0_0RNNativeViewHandler.m
...
#import "ABI47_0_0RNNativeViewHandler.h"
...
#else
#import <ABI47_0_0React/ABI47_0_0RCTScrollView.h>
#endif // ABI47_0_0RN_FABRIC_ENABLED

#pragma mark ABI47_0_0RNDummyGestureRecognizer

@implementation ABI47_0_0RNDummyGestureRecognizer {
...
#pragma mark ABI47_0_0RNNativeViewgestureHandler

@implementation ABI47_0_0RNNativeViewGestureHandler {
...
- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI47_0_0RNDummyGestureRecognizer alloc] initWithGestureHandler:self];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    _shouldActivateOnStart = [ABI47_0_0RCTConvert BOOL:config[@"shouldActivateOnStart"]];
    _disallowInterruption = [ABI47_0_0RCTConvert BOOL:config[@"disallowInterruption"]];
}
...
- (void)bindToView:(UIView *)view
{
    ...
    // is set
#ifdef ABI47_0_0RN_FABRIC_ENABLED
    if ([view isKindOfClass:[ABI47_0_0RCTScrollViewComponentView class]]) {
        UIScrollView *scrollView = ((ABI47_0_0RCTScrollViewComponentView *)view).scrollView;
        scrollView.delaysContentTouches = YES;
    }
#else
    if ([view isKindOfClass:[ABI47_0_0RCTScrollView class]]) {
        // This part of the code is coupled with RN implementation of ScrollView native wrapper and
        // we expect for ABI47_0_0RCTScrollView component to contain a subclass of UIScrollview as the only
        // subview
...
- (void)handleTouchDown:(UIView *)sender forEvent:(UIEvent *)event
{
    ...
    [self sendEventsInState:ABI47_0_0RNGestureHandlerStateActive
             forViewWithTag:sender.ABI47_0_0ReactTag
              withExtraData:[ABI47_0_0RNGestureHandlerEventExtraData forPointerInside:YES]];
}

- (void)handleTouchUpOutside:(UIView *)sender forEvent:(UIEvent *)event
{
    [self sendEventsInState:ABI47_0_0RNGestureHandlerStateEnd
             forViewWithTag:sender.ABI47_0_0ReactTag
              withExtraData:[ABI47_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
...
{
    [self sendEventsInState:ABI47_0_0RNGestureHandlerStateCancelled
             forViewWithTag:sender.ABI47_0_0ReactTag
              withExtraData:[ABI47_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
