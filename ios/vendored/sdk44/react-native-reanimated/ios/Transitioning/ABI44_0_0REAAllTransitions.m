...
@implementation ABI44_0_0REASnapshotRemover {
  UIView *_view;
}
...
@implementation ABI44_0_0REATransitionGroup
                                                             ...
                                                             forRoot:(UIView *)root
{
  ...
  for (ABI44_0_0REATransition *transition in _transitions) {
    ...
    for (ABI44_0_0REATransitionAnimation *anim in subanims) {
      [anim delayBy:delay];
...
{
  if (self = [super initWithConfig:config]) {
    _animationType = [ABI44_0_0RCTConvert ABI44_0_0REATransitionAnimationType:config[@"animation"]];
  }
  return self;
}
                                                 ...
                                                 forRoot:(UIView *)root
{
  ...
  if (isViewAppearing && !IS_LAYOUT_ONLY(endValues.view)) {
    NSNumber *parentKey = endValues.reactParent.ABI44_0_0ReactTag;
    ABI44_0_0REATransitionValues *parentStartValues = [self findStartValuesForKey:parentKey];
    ABI44_0_0REATransitionValues *parentEndValues = [self findEndValuesForKey:parentKey];
                                  ...
                                  forRoot:(UIView *)root
{
  ...
  switch (self.animationType) {
    case ABI44_0_0REATransitionAnimationTypeNone:
      return nil;
    case ABI44_0_0REATransitionAnimationTypeFade: {
    ...
    case ABI44_0_0REATransitionAnimationTypeScale: {
    ...
    case ABI44_0_0REATransitionAnimationTypeSlideTop:
    case ABI44_0_0REATransitionAnimationTypeSlideBottom:
    case ABI44_0_0REATransitionAnimationTypeSlideLeft:
    case ABI44_0_0REATransitionAnimationTypeSlideRight: {
  ...
  return [ABI44_0_0REATransitionAnimation transitionWithAnimation:animation layer:view.layer andKeyPath:animation.keyPath];
}
@end
                                  ...
                                  forRoot:(UIView *)root
{
  ...
  animation.fillMode = kCAFillModeBackwards;
  animation.delegate = [[ABI44_0_0REASnapshotRemover alloc] initWithView:snapshotView];

  return [ABI44_0_0REATransitionAnimation transitionWithAnimation:animation layer:snapshot andKeyPath:animation.keyPath];
}
@end
                                                 ...
                                                 forRoot:(UIView *)root
{
  ...
  return [ABI44_0_0REATransitionAnimation transitionWithAnimation:group layer:layer andKeyPath:nil];
}
@end
