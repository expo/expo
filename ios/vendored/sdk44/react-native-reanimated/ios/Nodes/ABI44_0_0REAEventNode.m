#import "ABI44_0_0REAEventNode.h"
#import "ABI44_0_0REANodesManager.h"
#import "ABI44_0_0REAValueNode.h"

@implementation ABI44_0_0REAEventNode {
  NSArray *_argMapping;
}
  ...
  for (NSArray *eventPath in _argMapping) {
    ...
    for (NSUInteger i = 0; i < eventPath.count; i++) {
      if (i < eventPath.count - 1) {
        ...
        ABI44_0_0REAValueNode *node = (ABI44_0_0REAValueNode *)[self.nodesManager findNodeByID:eventPath[i]];
        [node setValue:value];
      }
    }
  }
