...
typedef enum ABI44_0_0RNCWebViewPermissionGrantType : NSUInteger {
    ABI44_0_0RNCWebViewPermissionGrantType_GrantIfSameHost_ElsePrompt,
    ABI44_0_0RNCWebViewPermissionGrantType_GrantIfSameHost_ElseDeny,
    ABI44_0_0RNCWebViewPermissionGrantType_Deny,
    ABI44_0_0RNCWebViewPermissionGrantType_Grant,
    ABI44_0_0RNCWebViewPermissionGrantType_Prompt
} ABI44_0_0RNCWebViewPermissionGrantType;

@class ABI44_0_0RNCWebView;

@protocol ABI44_0_0RNCWebViewDelegate <NSObject>

- (BOOL)webView:(ABI44_0_0RNCWebView *_Nonnull)webView
   shouldStartLoadForRequest:(NSMutableDictionary<NSString *, id> *_Nonnull)request
   withCallback:(ABI44_0_0RCTDirectEventBlock _Nonnull)callback;

@end

@interface ABI44_0_0RNCWeakScriptMessageDelegate : NSObject<WKScriptMessageHandler>
...
@interface ABI44_0_0RNCWebView : ABI44_0_0RCTView
@property (nonatomic, strong) NSString *scopeKey;

@property (nonatomic, weak) id<ABI44_0_0RNCWebViewDelegate> _Nullable delegate;
...
@property (nonatomic, assign) ABI44_0_0RNCWebViewPermissionGrantType mediaCapturePermissionGrantType;
#endif
