//
//  ABI44_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI44_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI44_0_0RNGestureHandler *otherHandler = [ABI44_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI44_0_0RCTTouchHandler class]];
}
