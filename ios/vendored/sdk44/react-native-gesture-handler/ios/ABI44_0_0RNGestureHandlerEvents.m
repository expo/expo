...
@implementation ABI44_0_0RNGestureHandlerEventExtraData
...
{
    return [[ABI44_0_0RNGestureHandlerEventExtraData alloc]
            initWithData:@{
                           @"x": @(position.x),
                           @"y": @(position.y),
                             ...
                             withNumberOfTouches:(NSUInteger)numberOfTouches
{
    if (changedPointers == nil || allPointers == nil) {
        changedPointers = @[];
        allPointers = @[];
        eventType = ABI44_0_0RNTouchEventTypeUndetermined;
    }
...
@implementation ABI44_0_0RNGestureHandlerEvent
{
    NSNumber *_handlerTag;
    ABI44_0_0RNGestureHandlerState _state;
    ABI44_0_0RNGestureHandlerEventExtraData *_extraData;
}
...
@implementation ABI44_0_0RNGestureHandlerStateChange
{
    NSNumber *_handlerTag;
    ABI44_0_0RNGestureHandlerState _state;
    ABI44_0_0RNGestureHandlerState _prevState;
    ABI44_0_0RNGestureHandlerEventExtraData *_extraData;
}
