#import "ABI44_0_0RNForceTouchHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI44_0_0React/ABI44_0_0RCTConvert.h>

@interface ABI44_0_0RNForceTouchGestureRecognizer : UIGestureRecognizer
...
@implementation ABI44_0_0RNForceTouchGestureRecognizer {
...
@implementation ABI44_0_0RNForceTouchHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI44_0_0RNForceTouchGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
{
  [super resetConfig];
  ABI44_0_0RNForceTouchGestureRecognizer *recognizer = (ABI44_0_0RNForceTouchGestureRecognizer *)_recognizer;
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.feedbackOnActivation = [ABI44_0_0RCTConvert BOOL:prop];
  }
}

- (ABI44_0_0RNGestureHandlerEventExtraData *)eventExtraData:(ABI44_0_0RNForceTouchGestureRecognizer *)recognizer
{
