...
class ContainerView: ABI44_0_0RCTView {
    ...
    @objc var onAnimationFinish: ABI44_0_0RCTBubblingEventBlock?
    ...
    override func abi44_0_0ReactSetFrame(_ frame: CGRect) {
        super.abi44_0_0ReactSetFrame(frame)
        animationView?.abi44_0_0ReactSetFrame(frame)
    }
