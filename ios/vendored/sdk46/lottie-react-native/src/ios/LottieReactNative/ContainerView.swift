...
class ContainerView: ABI46_0_0RCTView {
    ...
    @objc var onAnimationFinish: ABI46_0_0RCTBubblingEventBlock?
    ...
    override func abi46_0_0ReactSetFrame(_ frame: CGRect) {
        super.abi46_0_0ReactSetFrame(frame)
        animationView?.abi46_0_0ReactSetFrame(frame)
    }
