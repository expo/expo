...
typedef enum ABI46_0_0RNCWebViewPermissionGrantType : NSUInteger {
...
@class ABI46_0_0RNCWebView;

@protocol ABI46_0_0RNCWebViewDelegate <NSObject>

- (BOOL)webView:(ABI46_0_0RNCWebView *_Nonnull)webView
shouldStartLoadForRequest:(NSMutableDictionary<NSString *, id> *_Nonnull)request
   withCallback:(ABI46_0_0RCTDirectEventBlock _Nonnull)callback;

@end

@interface ABI46_0_0RNCWeakScriptMessageDelegate : NSObject<WKScriptMessageHandler>
...
@interface ABI46_0_0RNCWebView : ABI46_0_0RCTView
@property (nonatomic, strong) NSString *scopeKey;

@property (nonatomic, weak) id<ABI46_0_0RNCWebViewDelegate> _Nullable delegate;
...
@property (nonatomic, assign) ABI46_0_0RNCWebViewPermissionGrantType mediaCapturePermissionGrantType;
#endif
