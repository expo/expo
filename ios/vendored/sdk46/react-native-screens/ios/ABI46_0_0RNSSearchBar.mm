...
@implementation ABI46_0_0RNSSearchBar {
...
{
  if (self = [super init]) {
    static const auto defaultProps = std::make_shared<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSSearchBarProps>();
    _props = defaultProps;
    [self initCommonProps];
  }
  return self;
...
- (void)emitOnFocusEvent
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSSearchBarEventEmitter>(_eventEmitter)
        ->onFocus(ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSSearchBarEventEmitter::OnFocus{});
  }
#else
  if (self.onFocus) {
    self.onFocus(@{});
...
- (void)emitOnBlurEvent
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSSearchBarEventEmitter>(_eventEmitter)
        ->onBlur(ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSSearchBarEventEmitter::OnBlur{});
  }
#else
  if (self.onBlur) {
    self.onBlur(@{});
...
- (void)emitOnSearchButtonPressEventWithText:(NSString *)text
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSSearchBarEventEmitter>(_eventEmitter)
        ->onSearchButtonPress(
            ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSSearchBarEventEmitter::OnSearchButtonPress{.text = ABI46_0_0RCTStringFromNSString(text)});
  }
#else
...
- (void)emitOnCancelButtonPressEvent
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSSearchBarEventEmitter>(_eventEmitter)
        ->onCancelButtonPress(ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSSearchBarEventEmitter::OnCancelButtonPress{});
  }
#else
...
- (void)emitOnChangeTextEventWithText:(NSString *)text
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSSearchBarEventEmitter>(_eventEmitter)
        ->onChangeText(ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSSearchBarEventEmitter::OnChangeText{.text = ABI46_0_0RCTStringFromNSString(text)});
  }
#else
...
{
  const auto &oldScreenProps = *std::static_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSSearchBarProps>(_props);
  const auto &newScreenProps = *std::static_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSSearchBarProps>(props);
  ...
  if (oldScreenProps.cancelButtonText != newScreenProps.cancelButtonText) {
    [self setCancelButtonText:ABI46_0_0RCTNSStringFromStringNilIfEmpty(newScreenProps.cancelButtonText)];
  }
  ...
  if (oldScreenProps.placeholder != newScreenProps.placeholder) {
    [self setPlaceholder:ABI46_0_0RCTNSStringFromStringNilIfEmpty(newScreenProps.placeholder)];
  }

  if (oldScreenProps.autoCapitalize != newScreenProps.autoCapitalize) {
    [self setAutoCapitalize:[ABI46_0_0RNSConvert UITextAutocapitalizationTypeFromCppEquivalent:newScreenProps.autoCapitalize]];
  }

  if (oldScreenProps.tintColor != newScreenProps.tintColor) {
    [self setTintColor:ABI46_0_0RCTUIColorFromSharedColor(newScreenProps.tintColor)];
  }

  if (oldScreenProps.barTintColor != newScreenProps.barTintColor) {
    [self setBarTintColor:ABI46_0_0RCTUIColorFromSharedColor(newScreenProps.barTintColor)];
  }
...
{
  return ABI46_0_0facebook::ABI46_0_0React::concreteComponentDescriptorProvider<ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSSearchBarComponentDescriptor>();
}
...
#ifdef RN_FABRIC_ENABLED
Class<ABI46_0_0RCTComponentViewProtocol> ABI46_0_0RNSSearchBarCls(void)
{
  return ABI46_0_0RNSSearchBar.class;
}
#endif

@implementation ABI46_0_0RNSSearchBarManager
...
- (UIView *)view
{
  return [[ABI46_0_0RNSSearchBar alloc] initWithBridge:self.bridge];
}
#endif

ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(obscureBackground, BOOL)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(hideNavigationBar, BOOL)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(hideWhenScrolling, BOOL)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(autoCapitalize, UITextAutocapitalizationType)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(placeholder, NSString)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(barTintColor, UIColor)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(tintColor, UIColor)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(textColor, UIColor)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(cancelButtonText, NSString)

ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onChangeText, ABI46_0_0RCTBubblingEventBlock)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onCancelButtonPress, ABI46_0_0RCTBubblingEventBlock)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onSearchButtonPress, ABI46_0_0RCTBubblingEventBlock)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onFocus, ABI46_0_0RCTBubblingEventBlock)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onBlur, ABI46_0_0RCTBubblingEventBlock)
