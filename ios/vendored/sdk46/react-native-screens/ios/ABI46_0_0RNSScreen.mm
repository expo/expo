...
#import <ABI46_0_0React/ABI46_0_0RCTRootComponentView.h>
...
#import <rnscreens/ABI46_0_0RNSScreenComponentDescriptor.h>
...
#ifdef RN_FABRIC_ENABLED
    <ABI46_0_0RCTRNSScreenViewProtocol, UIAdaptivePresentationControllerDelegate>
#else
    <UIAdaptivePresentationControllerDelegate, ABI46_0_0RCTInvalidating>
#endif
@end

@implementation ABI46_0_0RNSScreenView {
  __weak ABI46_0_0RCTBridge *_bridge;
#ifdef RN_FABRIC_ENABLED
  ABI46_0_0RCTSurfaceTouchHandler *_touchHandler;
  ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenShadowNode::ConcreteState::Shared _state;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenProps>();
    _props = defaultProps;
...
{
  _controller = [[ABI46_0_0RNSScreen alloc] initWithView:self];
  _stackPresentation = ABI46_0_0RNSScreenStackPresentationPush;
  _stackAnimation = ABI46_0_0RNSScreenStackAnimationDefault;
  _gestureEnabled = YES;
  _replaceAnimation = ABI46_0_0RNSScreenReplaceAnimationPop;
  _dismissed = NO;
...
#ifdef RN_FABRIC_ENABLED
  if (_state != nullptr) {
    auto newState = ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenState{ABI46_0_0RCTSizeFromCGSize(self.bounds.size)};
...
- (void)setStackPresentation:(ABI46_0_0RNSScreenStackPresentation)stackPresentation
{
  switch (stackPresentation) {
    case ABI46_0_0RNSScreenStackPresentationModal:
...
#endif
      break;
    case ABI46_0_0RNSScreenStackPresentationFullScreenModal:
      _controller.modalPresentationStyle = UIModalPresentationFullScreen;
      break;
#if !TARGET_OS_TV
    case ABI46_0_0RNSScreenStackPresentationFormSheet:
      _controller.modalPresentationStyle = UIModalPresentationFormSheet;
      break;
#endif
    case ABI46_0_0RNSScreenStackPresentationTransparentModal:
      _controller.modalPresentationStyle = UIModalPresentationOverFullScreen;
      break;
    case ABI46_0_0RNSScreenStackPresentationContainedModal:
      _controller.modalPresentationStyle = UIModalPresentationCurrentContext;
      break;
    case ABI46_0_0RNSScreenStackPresentationContainedTransparentModal:
      _controller.modalPresentationStyle = UIModalPresentationOverCurrentContext;
      break;
    case ABI46_0_0RNSScreenStackPresentationPush:
  ...
  if (stackPresentation != ABI46_0_0RNSScreenStackPresentationPush) {
  ...
  } else if (_stackPresentation != ABI46_0_0RNSScreenStackPresentationPush) {
#ifdef RN_FABRIC_ENABLED
...
- (void)setStackAnimation:(ABI46_0_0RNSScreenStackAnimation)stackAnimation
{
  _stackAnimation = stackAnimation;

  switch (stackAnimation) {
    case ABI46_0_0RNSScreenStackAnimationFade:
      _controller.modalTransitionStyle = UIModalTransitionStyleCrossDissolve;
      break;
#if !TARGET_OS_TV
    case ABI46_0_0RNSScreenStackAnimationFlip:
      _controller.modalTransitionStyle = UIModalTransitionStyleFlipHorizontal;
      break;
#endif
    case ABI46_0_0RNSScreenStackAnimationNone:
    case ABI46_0_0RNSScreenStackAnimationDefault:
    case ABI46_0_0RNSScreenStackAnimationSimplePush:
    case ABI46_0_0RNSScreenStackAnimationSlideFromBottom:
...
- (void)setReplaceAnimation:(ABI46_0_0RNSScreenReplaceAnimation)replaceAnimation
{
...
- (void)setActivityStateOrNil:(NSNumber *)activityStateOrNil
{
  ...
  if (activityStateOrNil != nil && activityState != -1 && activityState != _activityState) {
    ...
    [_ABI46_0_0ReactSuperview markChildUpdated];
  }
}

#if !TARGET_OS_TV
- (void)setStatusBarStyle:(ABI46_0_0RNSStatusBarStyle)statusBarStyle
{
  _hasStatusBarStyleSet = YES;
  _statusBarStyle = statusBarStyle;
  [ABI46_0_0RNSScreenWindowTraits assertViewControllerBasedStatusBarAppearenceSet];
...
{
  return _ABI46_0_0ReactSuperview;
}

- (void)addSubview:(UIView *)view
{
  if (![view isKindOfClass:[ABI46_0_0RNSScreenStackHeaderConfig class]]) {
    [super addSubview:view];
  } else {
    ((ABI46_0_0RNSScreenStackHeaderConfig *)view).screenView = self;
  }
}
...
- (void)notifyDismissedWithCount:(int)dismissCount
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenEventEmitter>(_eventEmitter)
        ->onDismissed(ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenEventEmitter::OnDismissed{.dismissCount = dismissCount});
  }
#else
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenEventEmitter>(_eventEmitter)
        ->onNativeDismissCancelled(
            ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenEventEmitter::OnNativeDismissCancelled{.dismissCount = dismissCount});
  }
#else
...
- (void)notifyWillAppear
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenEventEmitter>(_eventEmitter)
        ->onWillAppear(ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenEventEmitter::OnWillAppear{});
  }
  ...
  [self ABI46_0_0ReactSetFrame:_reactFrame];
#endif
}
...
- (void)notifyWillDisappear
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenEventEmitter>(_eventEmitter)
        ->onWillDisappear(ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenEventEmitter::OnWillDisappear{});
  }
#else
...
- (void)notifyAppear
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenEventEmitter>(_eventEmitter)
        ->onAppear(ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenEventEmitter::OnAppear{});
  }
#else
  if (self.onAppear) {
    dispatch_async(dispatch_get_main_queue(), ^{
...
- (void)notifyDisappear
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenEventEmitter>(_eventEmitter)
        ->onDisappear(ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenEventEmitter::OnDisappear{});
  }
#else
  if (self.onDisappear) {
...
{
#ifdef RN_FABRIC_ENABLED
#define ABI46_0_0RNS_EXPECTED_VIEW ABI46_0_0RCTRootComponentView
#else
#define ABI46_0_0RNS_EXPECTED_VIEW ABI46_0_0RCTRootView
#endif
  for (UIView *parent = self.superview; parent != nil; parent = parent.superview) {
    if ([parent isKindOfClass:[ABI46_0_0RNS_EXPECTED_VIEW class]] || [parent isKindOfClass:[ABI46_0_0RNSScreenView class]]) {
      return YES;
    }
  }
  return NO;
#undef ABI46_0_0RNS_EXPECTED_VIEW
}

- (void)didMoveToWindow
{
  // For RN touches to work we need to instantiate and connect ABI46_0_0RCTTouchHandler. This only applies
  // for screens that aren't mounted under ABI46_0_0RCTRootView e.g., modals that are mounted directly to
...
#ifdef RN_FABRIC_ENABLED
- (ABI46_0_0RCTSurfaceTouchHandler *)touchHandler
#else
- (ABI46_0_0RCTTouchHandler *)touchHandler
#endif
{
  if (_touchHandler != nil) {
...
- (void)notifyTransitionProgress:(double)progress closing:(BOOL)closing goingForward:(BOOL)goingForward
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenEventEmitter>(_eventEmitter)
        ->onTransitionProgress(ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenEventEmitter::OnTransitionProgress{
            .progress = progress, .closing = closing ? 1 : 0, .goingForward = goingForward ? 1 : 0});
  }
  ABI46_0_0RNSScreenViewEvent *event = [[ABI46_0_0RNSScreenViewEvent alloc] initWithEventName:@"onTransitionProgress"
                                                                   ABI46_0_0ReactTag:[NSNumber numberWithInt:self.tag]
                                                                   progress:progress
                                                                    closing:closing
                                                               goingForward:goingForward];
  [[ABI46_0_0RCTBridge currentBridge].eventDispatcher sendEvent:event];
#else
...
- (void)presentationControllerWillDismiss:(UIPresentationController *)presentationController
{
  ...
  // Because of that, at the moment when this method gets called the ABI46_0_0React's
  // gesture recognizer is already in FAILED state but cancel events never gets
  // send to JS. Calling "reset" forces ABI46_0_0RCTTouchHanler to dispatch cancel event.
...
{
  if ([_ABI46_0_0ReactSuperview respondsToSelector:@selector(presentationControllerDidDismiss:)]) {
    [_ABI46_0_0ReactSuperview performSelector:@selector(presentationControllerDidDismiss:) withObject:presentationController];
  }
}
...
{
  return ABI46_0_0facebook::ABI46_0_0React::concreteComponentDescriptorProvider<ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenComponentDescriptor>();
}
...
- (void)mountChildComponentView:(UIView<ABI46_0_0RCTComponentViewProtocol> *)childComponentView index:(NSInteger)index
{
  ...
  if ([childComponentView isKindOfClass:[ABI46_0_0RNSScreenStackHeaderConfig class]]) {
    _config = childComponentView;
    ((ABI46_0_0RNSScreenStackHeaderConfig *)childComponentView).screenView = self;
  }
  [_ABI46_0_0ReactSubviews insertObject:childComponentView atIndex:index];
}
...
{
  const auto &oldScreenProps = *std::static_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenProps>(_props);
  const auto &newScreenProps = *std::static_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenProps>(props);
  ...
  [self
      setGestureResponseDistance:[ABI46_0_0RNSConvert
  ...
  [self setSwipeDirection:[ABI46_0_0RNSConvert ABI46_0_0RNSScreenSwipeDirectionFromCppEquivalent:newScreenProps.swipeDirection]];
  ...
  if (newScreenProps.statusBarStyle != oldScreenProps.statusBarStyle) {
    [self setStatusBarStyle:[ABI46_0_0RCTConvert
                                ABI46_0_0RNSStatusBarStyle:ABI46_0_0RCTNSStringFromStringNilIfEmpty(newScreenProps.statusBarStyle)]];
  }

  if (newScreenProps.statusBarAnimation != oldScreenProps.statusBarAnimation) {
    [self setStatusBarAnimation:[ABI46_0_0RCTConvert UIStatusBarAnimation:ABI46_0_0RCTNSStringFromStringNilIfEmpty(
                                                                     newScreenProps.statusBarAnimation)]];
  }

  if (newScreenProps.screenOrientation != oldScreenProps.screenOrientation) {
    [self setScreenOrientation:[ABI46_0_0RCTConvert UIInterfaceOrientationMask:ABI46_0_0RCTNSStringFromStringNilIfEmpty(
  ...
  if (newScreenProps.stackPresentation != oldScreenProps.stackPresentation) {
    [self
        setStackPresentation:[ABI46_0_0RNSConvert ABI46_0_0RNSScreenStackPresentationFromCppEquivalent:newScreenProps.stackPresentation]];
  }

  if (newScreenProps.stackAnimation != oldScreenProps.stackAnimation) {
    [self setStackAnimation:[ABI46_0_0RNSConvert ABI46_0_0RNSScreenStackAnimationFromCppEquivalent:newScreenProps.stackAnimation]];
  }

  if (newScreenProps.replaceAnimation != oldScreenProps.replaceAnimation) {
    [self setReplaceAnimation:[ABI46_0_0RNSConvert ABI46_0_0RNSScreenReplaceAnimationFromCppEquivalent:newScreenProps.replaceAnimation]];
  }
...
{
  _state = std::static_pointer_cast<const ABI46_0_0facebook::ABI46_0_0React::ABI46_0_0RNSScreenShadowNode::ConcreteState>(state);
}
           ...
           oldLayoutMetrics:(const ABI46_0_0facebook::ABI46_0_0React::LayoutMetrics &)oldLayoutMetrics
{
  ...
  UIViewController *parentVC = self.ABI46_0_0ReactViewController.parentViewController;
  if (parentVC != nil && ![parentVC isKindOfClass:[ABI46_0_0RNScreensNavigationController class]]) {
    [super updateLayoutMetrics:layoutMetrics oldLayoutMetrics:oldLayoutMetrics];
  }
  // when screen is mounted under ABI46_0_0RNScreensNavigationController it's size is controller
  ...
  // subviews
  // Explanation taken from `ABI46_0_0ReactSetFrame`, which is old arch equivalent of this code.
}

#pragma mark - Paper specific
#else

- (void)setPointerEvents:(ABI46_0_0RCTPointerEvents)pointerEvents
{
  // pointer events settings are managed by the parent screen container, we ignore
  // any attempt of setting that via ABI46_0_0React props
}
...
#ifdef RN_FABRIC_ENABLED
Class<ABI46_0_0RCTComponentViewProtocol> ABI46_0_0RNSScreenCls(void)
{
  return ABI46_0_0RNSScreenView.class;
}
#endif

#pragma mark - ABI46_0_0RNSScreen

@implementation ABI46_0_0RNSScreen {
  __weak id _previousFirstResponder;
  CGRect _lastViewFrame;
  ABI46_0_0RNSScreenView *_initialView;
  UIView *_fakeView;
...
- (instancetype)initWithView:(UIView *)view
{
  if (self = [super init]) {
    ...
    _shouldNotify = YES;
#ifdef RN_FABRIC_ENABLED
    _initialView = (ABI46_0_0RNSScreenView *)view;
#endif
  }
  return self;
}
...
- (void)viewWillAppear:(BOOL)animated
{
  ...
  [ABI46_0_0RNSScreenWindowTraits updateWindowTraits];
  if (_shouldNotify) {
    _closing = NO;
...
- (void)viewDidDisappear:(BOOL)animated
{
  ...
  if (self.parentViewController == nil && self.presentingViewController == nil) {
    if (self.screenView.preventNativeDismiss) {
      ...
      [self.screenView.ABI46_0_0ReactSuperview updateContainer];
...
- (void)viewDidLayoutSubviews
{
  ...
  // into account only when the view is mounted under ABI46_0_0RNScreensNavigationController in which case system
  ...
  BOOL isDisplayedWithinUINavController =
      [self.parentViewController isKindOfClass:[ABI46_0_0RNScreensNavigationController class]];
  ...
  if (isDisplayedWithinUINavController || isPresentedAsNativeModal) {
    ...
    if (!CGRectEqualToRect(_lastViewFrame, self.screenView.frame)) {
      ...
      [((ABI46_0_0RNSScreenView *)self.viewIfLoaded) updateBounds];
    }
#endif
  }
}
...
- (void)notifyTransitionProgress:(double)progress closing:(BOOL)closing goingForward:(BOOL)goingForward
{
  if ([self.view isKindOfClass:[ABI46_0_0RNSScreenView class]]) {
    ...
    [(ABI46_0_0RNSScreenView *)self.view notifyTransitionProgress:progress closing:closing goingForward:goingForward];
  }
}
...
- (UIViewController *)findChildVCForConfigAndTrait:(ABI46_0_0RNSWindowTrait)trait includingModals:(BOOL)includingModals
{
  ...
  if ([self.presentedViewController isKindOfClass:[ABI46_0_0RNSScreen class]]) {
    ...
    return !includingModals
        ? nil
        : [(ABI46_0_0RNSScreen *)lastViewController findChildVCForConfigAndTrait:trait includingModals:includingModals]
            ?: lastViewController;
  }
  ...
  if (lastViewController == nil) {
    ...
    if ([lastViewController conformsToProtocol:@protocol(ABI46_0_0RNScreensViewControllerDelegate)]) {
      ...
      if ([childScreen isKindOfClass:[ABI46_0_0RNSScreen class]]) {
        return [(ABI46_0_0RNSScreen *)childScreen findChildVCForConfigAndTrait:trait includingModals:includingModals]
            ?: selfOrNil;
      } else {
        return selfOrNil;
      }
...
- (BOOL)hasTraitSet:(ABI46_0_0RNSWindowTrait)trait
{
  switch (trait) {
    case ABI46_0_0RNSWindowTraitStyle: {
      return self.screenView.hasStatusBarStyleSet;
    }
    case ABI46_0_0RNSWindowTraitAnimation: {
    ...
    case ABI46_0_0RNSWindowTraitOrientation: {
      return self.screenView.hasOrientationSet;
    }
    case ABI46_0_0RNSWindowTraitHomeIndicatorHidden: {
      return self.screenView.hasHomeIndicatorHiddenSet;
    }
    default: {
      ABI46_0_0RCTLogError(@"Unknown trait passed: %d", (int)trait);
    }
  }
  return NO;
}
...
{
  UIViewController *vc = [self findChildVCForConfigAndTrait:ABI46_0_0RNSWindowTraitHidden includingModals:NO];
...
{
  UIViewController *vc = [self findChildVCForConfigAndTrait:ABI46_0_0RNSWindowTraitStyle includingModals:NO];
  return vc == self ? nil : vc;
}

- (UIStatusBarStyle)preferredStatusBarStyle
{
  return [ABI46_0_0RNSScreenWindowTraits statusBarStyleForRNSStatusBarStyle:self.screenView.statusBarStyle];
}

- (UIStatusBarAnimation)preferredStatusBarUpdateAnimation
{
  UIViewController *vc = [self findChildVCForConfigAndTrait:ABI46_0_0RNSWindowTraitAnimation includingModals:NO];

  if ([vc isKindOfClass:[ABI46_0_0RNSScreen class]]) {
    return ((ABI46_0_0RNSScreen *)vc).screenView.statusBarAnimation;
  }
...
{
  UIViewController *vc = [self findChildVCForConfigAndTrait:ABI46_0_0RNSWindowTraitOrientation includingModals:YES];

  if ([vc isKindOfClass:[ABI46_0_0RNSScreen class]]) {
    return ((ABI46_0_0RNSScreen *)vc).screenView.screenOrientation;
  }
...
{
  UIViewController *vc = [self findChildVCForConfigAndTrait:ABI46_0_0RNSWindowTraitHomeIndicatorHidden includingModals:YES];
  return vc == self ? nil : vc;
}
...
{
  return (int)[[self.screenView.ABI46_0_0ReactSuperview ABI46_0_0ReactSubviews] count];
}
#endif

- (int)getIndexOfView:(UIView *)view
{
  return (int)[[self.screenView.ABI46_0_0ReactSuperview ABI46_0_0ReactSubviews] indexOfObject:view];
}
...
- (ABI46_0_0RNSScreenView *)screenView
{
  ...
  return _initialView;
#else
  return (ABI46_0_0RNSScreenView *)self.view;
#endif
}
...
- (void)hideHeaderIfNecessary
{
  ...
  if (@available(iOS 13.0, *)) {
    ...
    // we need to check whether ABI46_0_0ReactSubviews array is empty, because on Fabric child nodes are unmounted first ->
    // ABI46_0_0ReactSubviews array may be empty
    if (currentIndex > 0 && [self.screenView.ABI46_0_0ReactSubviews count] > 0 &&
        [self.screenView.ABI46_0_0ReactSubviews[0] isKindOfClass:[ABI46_0_0RNSScreenStackHeaderConfig class]]) {
      UINavigationItem *prevNavigationItem =
          [self.navigationController.viewControllers objectAtIndex:currentIndex - 1].navigationItem;
      ABI46_0_0RNSScreenStackHeaderConfig *config = ((ABI46_0_0RNSScreenStackHeaderConfig *)self.screenView.ABI46_0_0ReactSubviews[0]);
...
- (void)setViewToSnapshot:(UIView *)snapshot
{
  ...
  if (_initialView.stackPresentation != ABI46_0_0RNSScreenStackPresentationPush) {
...
@implementation ABI46_0_0RNSScreenManager

ABI46_0_0RCT_EXPORT_MODULE()

// we want to handle the case when activityState is nil
ABI46_0_0RCT_REMAP_VIEW_PROPERTY(activityState, activityStateOrNil, NSNumber)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(customAnimationOnSwipe, BOOL);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(fullScreenSwipeEnabled, BOOL);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(gestureEnabled, BOOL)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(gestureResponseDistance, NSDictionary)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(hideKeyboardOnSwipe, BOOL)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(preventNativeDismiss, BOOL)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(replaceAnimation, ABI46_0_0RNSScreenReplaceAnimation)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(stackPresentation, ABI46_0_0RNSScreenStackPresentation)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(stackAnimation, ABI46_0_0RNSScreenStackAnimation)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(swipeDirection, ABI46_0_0RNSScreenSwipeDirection)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(transitionDuration, NSNumber)

ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onAppear, ABI46_0_0RCTDirectEventBlock);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onDisappear, ABI46_0_0RCTDirectEventBlock);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onDismissed, ABI46_0_0RCTDirectEventBlock);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onNativeDismissCancelled, ABI46_0_0RCTDirectEventBlock);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onTransitionProgress, ABI46_0_0RCTDirectEventBlock);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onWillAppear, ABI46_0_0RCTDirectEventBlock);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onWillDisappear, ABI46_0_0RCTDirectEventBlock);

#if !TARGET_OS_TV
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(screenOrientation, UIInterfaceOrientationMask)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(statusBarAnimation, UIStatusBarAnimation)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(statusBarHidden, BOOL)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(statusBarStyle, ABI46_0_0RNSStatusBarStyle)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(homeIndicatorHidden, BOOL)
#endif

- (UIView *)view
{
  return [[ABI46_0_0RNSScreenView alloc] initWithBridge:self.bridge];
}

@end

@implementation ABI46_0_0RCTConvert (ABI46_0_0RNSScreen)

ABI46_0_0RCT_ENUM_CONVERTER(
    ABI46_0_0RNSScreenStackPresentation,
    (@{
      @"push" : @(ABI46_0_0RNSScreenStackPresentationPush),
      @"modal" : @(ABI46_0_0RNSScreenStackPresentationModal),
      @"fullScreenModal" : @(ABI46_0_0RNSScreenStackPresentationFullScreenModal),
      @"formSheet" : @(ABI46_0_0RNSScreenStackPresentationFormSheet),
      @"containedModal" : @(ABI46_0_0RNSScreenStackPresentationContainedModal),
      @"transparentModal" : @(ABI46_0_0RNSScreenStackPresentationTransparentModal),
      @"containedTransparentModal" : @(ABI46_0_0RNSScreenStackPresentationContainedTransparentModal)
    }),
    ABI46_0_0RNSScreenStackPresentationPush,
    integerValue)

ABI46_0_0RCT_ENUM_CONVERTER(
    ABI46_0_0RNSScreenStackAnimation,
    (@{
      @"default" : @(ABI46_0_0RNSScreenStackAnimationDefault),
      @"none" : @(ABI46_0_0RNSScreenStackAnimationNone),
      @"fade" : @(ABI46_0_0RNSScreenStackAnimationFade),
      @"fade_from_bottom" : @(ABI46_0_0RNSScreenStackAnimationFadeFromBottom),
      @"flip" : @(ABI46_0_0RNSScreenStackAnimationFlip),
      @"simple_push" : @(ABI46_0_0RNSScreenStackAnimationSimplePush),
      @"slide_from_bottom" : @(ABI46_0_0RNSScreenStackAnimationSlideFromBottom),
      @"slide_from_right" : @(ABI46_0_0RNSScreenStackAnimationDefault),
      @"slide_from_left" : @(ABI46_0_0RNSScreenStackAnimationDefault),
    }),
    ABI46_0_0RNSScreenStackAnimationDefault,
    integerValue)

ABI46_0_0RCT_ENUM_CONVERTER(
    ABI46_0_0RNSScreenReplaceAnimation,
    (@{
      @"push" : @(ABI46_0_0RNSScreenReplaceAnimationPush),
      @"pop" : @(ABI46_0_0RNSScreenReplaceAnimationPop),
    }),
    ABI46_0_0RNSScreenReplaceAnimationPop,
    integerValue)

ABI46_0_0RCT_ENUM_CONVERTER(
    ABI46_0_0RNSScreenSwipeDirection,
    (@{
      @"vertical" : @(ABI46_0_0RNSScreenSwipeDirectionVertical),
      @"horizontal" : @(ABI46_0_0RNSScreenSwipeDirectionHorizontal),
    }),
...
ABI46_0_0RCT_ENUM_CONVERTER(
    ...
    (@{
      @"auto" : @(ABI46_0_0RNSStatusBarStyleAuto),
      @"inverted" : @(ABI46_0_0RNSStatusBarStyleInverted),
      @"light" : @(ABI46_0_0RNSStatusBarStyleLight),
      @"dark" : @(ABI46_0_0RNSStatusBarStyleDark),
    }),
