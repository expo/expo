...
@interface ABI46_0_0RNSScreenStackHeaderConfig :
#ifdef RN_FABRIC_ENABLED
...
@property (nonatomic, weak) ABI46_0_0RNSScreenView *screenView;
...
@interface ABI46_0_0RNSScreenStackHeaderConfigManager : ABI46_0_0RCTViewManager

@end

@interface ABI46_0_0RCTConvert (ABI46_0_0RNSScreenStackHeader)
