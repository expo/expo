...
public:
  ...
  void stopTiming() {
    ...
    if(_didSkip) {
      _didSkip = false;
      ABI46_0_0RNSkLogger::logToConsole("%s: Skipped frame. Previous frame time: %lldms", _name.c_str(), _lastDuration);
    }
  }
