...
namespace ABI46_0_0RNSkia
{
    ...
    public:
        ...
        {
            ABI46_0_0RNSkLogger::warnToJavascriptConsole(runtime, "measureText() is deprecated.  Clients should use 'Font.getGlyphWidths' instead (the latter does no shaping)");
        ...
        JsiSkFont(std::shared_ptr<ABI46_0_0RNSkPlatformContext> context, const SkFont &font)
