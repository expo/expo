...
namespace ABI46_0_0RNSkia {
    ...
    public:
        ...
        /**
         Constructor
         */
        JsiSkRuntimeShaderBuilder(std::shared_ptr<ABI46_0_0RNSkPlatformContext> context, const SkRuntimeShaderBuilder &rt)
        ...
        createCtor(std::shared_ptr<ABI46_0_0RNSkPlatformContext> context) {
