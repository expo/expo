...
public:
  JSI_PROPERTY_GET(bold) {
    ABI46_0_0RNSkLogger::warnToJavascriptConsole(runtime, "Typeface.bold is deprecated and will be removed in a future release.");
    return jsi::Value(getObject()->isBold());
  }
  
  JSI_PROPERTY_GET(italic) {
    ABI46_0_0RNSkLogger::warnToJavascriptConsole(runtime, "Typeface.italic is deprecated and will be removed in a future release.");
  ...
  JsiSkTypeface(std::shared_ptr<ABI46_0_0RNSkPlatformContext> context,
