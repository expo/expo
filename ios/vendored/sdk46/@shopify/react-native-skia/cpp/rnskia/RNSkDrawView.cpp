...
ABI46_0_0RNSkDrawView::ABI46_0_0RNSkDrawView(std::shared_ptr<ABI46_0_0RNSkPlatformContext> context)
    : _jsiCanvas(std::make_shared<JsiSkCanvas>(context)),
      _platformContext(std::move(context)),
      _infoObject(std::make_shared<ABI46_0_0RNSkInfoObject>()),
...
ABI46_0_0RNSkDrawView::~ABI46_0_0RNSkDrawView() {
  endDrawingLoop();
}

void ABI46_0_0RNSkDrawView::setNativeId(size_t nativeId) {
  _nativeId = nativeId;
  beginDrawingLoop();
}

void ABI46_0_0RNSkDrawView::setDrawCallback(std::shared_ptr<jsi::Function> callback) {
  ...
  _drawCallback = std::make_shared<ABI46_0_0RNSkDrawCallback>(
...
void ABI46_0_0RNSkDrawView::drawInCanvas(std::shared_ptr<JsiSkCanvas> canvas,
                                int width,
                                int height,
                                double time) {
...
sk_sp<SkImage> ABI46_0_0RNSkDrawView::makeImageSnapshot(std::shared_ptr<SkRect> bounds) {
  // Assert width/height
...
void ABI46_0_0RNSkDrawView::updateTouchState(std::vector<ABI46_0_0RNSkTouchPoint>&& points) {
  _infoObject->updateTouches(std::move(points));
  requestRedraw();
}

void ABI46_0_0RNSkDrawView::performDraw() {
  // Start timing
...
void ABI46_0_0RNSkDrawView::requestRedraw() {
  _redrawRequestCounter++;
}

void ABI46_0_0RNSkDrawView::beginDrawingLoop() {
...
void ABI46_0_0RNSkDrawView::drawLoopCallback(bool invalidated) {
  if(_redrawRequestCounter > 0 || _drawingMode == ABI46_0_0RNSkDrawingMode::Continuous) {
...
void ABI46_0_0RNSkDrawView::endDrawingLoop() {
  if(_drawingLoopId != 0) {
    _drawingLoopId = 0;
...
void ABI46_0_0RNSkDrawView::setDrawingMode(ABI46_0_0RNSkDrawingMode mode) {
