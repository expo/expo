//
//  ABI46_0_0RNNativeViewHandler.m
...
#import "ABI46_0_0RNNativeViewHandler.h"
...
#pragma mark ABI46_0_0RNDummyGestureRecognizer

@implementation ABI46_0_0RNDummyGestureRecognizer {
...
#pragma mark ABI46_0_0RNNativeViewgestureHandler

@implementation ABI46_0_0RNNativeViewGestureHandler {
...
- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI46_0_0RNDummyGestureRecognizer alloc] initWithGestureHandler:self];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    _shouldActivateOnStart = [ABI46_0_0RCTConvert BOOL:config[@"shouldActivateOnStart"]];
    _disallowInterruption = [ABI46_0_0RCTConvert BOOL:config[@"disallowInterruption"]];
}
...
- (void)bindToView:(UIView *)view
{
    ...
    // is set
#ifdef ABI46_0_0RN_FABRIC_ENABLED
    if ([view isKindOfClass:[ABI46_0_0RCTScrollViewComponentView class]]) {
        UIScrollView *scrollView = ((ABI46_0_0RCTScrollViewComponentView *)view).scrollView;
    ...
    if ([view isKindOfClass:[ABI46_0_0RCTScrollView class]]) {
        ...
        // we expect for ABI46_0_0RCTScrollView component to contain a subclass of UIScrollview as the only
        // subview
...
- (void)handleTouchDown:(UIView *)sender forEvent:(UIEvent *)event
{
    ...
    [self sendEventsInState:ABI46_0_0RNGestureHandlerStateActive
             forViewWithTag:sender.ABI46_0_0ReactTag
              withExtraData:[ABI46_0_0RNGestureHandlerEventExtraData forPointerInside:YES]];
}

- (void)handleTouchUpOutside:(UIView *)sender forEvent:(UIEvent *)event
{
    [self sendEventsInState:ABI46_0_0RNGestureHandlerStateEnd
             forViewWithTag:sender.ABI46_0_0ReactTag
              withExtraData:[ABI46_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
...
{
    [self sendEventsInState:ABI46_0_0RNGestureHandlerStateCancelled
             forViewWithTag:sender.ABI46_0_0ReactTag
              withExtraData:[ABI46_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
