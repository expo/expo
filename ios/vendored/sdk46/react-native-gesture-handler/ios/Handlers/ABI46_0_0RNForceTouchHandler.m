#import "ABI46_0_0RNForceTouchHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI46_0_0React/ABI46_0_0RCTConvert.h>

@interface ABI46_0_0RNForceTouchGestureRecognizer : UIGestureRecognizer
...
@implementation ABI46_0_0RNForceTouchGestureRecognizer {
...
@implementation ABI46_0_0RNForceTouchHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI46_0_0RNForceTouchGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
{
  [super resetConfig];
  ABI46_0_0RNForceTouchGestureRecognizer *recognizer = (ABI46_0_0RNForceTouchGestureRecognizer *)_recognizer;
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.feedbackOnActivation = [ABI46_0_0RCTConvert BOOL:prop];
  }
}

- (ABI46_0_0RNGestureHandlerEventExtraData *)eventExtraData:(ABI46_0_0RNForceTouchGestureRecognizer *)recognizer
{
