...
#import "ABI46_0_0RNLongPressHandler.h"
...
@interface ABI46_0_0RNBetterLongPressGestureRecognizer : UILongPressGestureRecognizer {
  uint64_t startTime;
...
@implementation ABI46_0_0RNBetterLongPressGestureRecognizer {
...
@implementation ABI46_0_0RNLongPressGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI46_0_0RNBetterLongPressGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.minimumPressDuration = [ABI46_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
...
- (ABI46_0_0RNGestureHandlerEventExtraData *)eventExtraData:(UIGestureRecognizer *)recognizer
{
    return [ABI46_0_0RNGestureHandlerEventExtraData
            ...
            withDuration:[(ABI46_0_0RNBetterLongPressGestureRecognizer*)recognizer getDuration]];
}
@end
