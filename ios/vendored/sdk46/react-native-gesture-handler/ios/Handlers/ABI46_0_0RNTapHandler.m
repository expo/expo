...
#import "ABI46_0_0RNTapHandler.h"
...
@interface ABI46_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
@implementation ABI46_0_0RNBetterTapGestureRecognizer {
...
@implementation ABI46_0_0RNTapGestureHandler {
    ABI46_0_0RNGestureHandlerEventExtraData * _lastData;
}

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI46_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
{
  [super resetConfig];
  ABI46_0_0RNBetterTapGestureRecognizer *recognizer = (ABI46_0_0RNBetterTapGestureRecognizer *)_recognizer;
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.maxDelay = [ABI46_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDurationMs"];
  if (prop != nil) {
    recognizer.maxDuration = [ABI46_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
  ...
  // in ABI46_0_0RNGestureHandler it resets _lastSatate variable, making is seem like handler
