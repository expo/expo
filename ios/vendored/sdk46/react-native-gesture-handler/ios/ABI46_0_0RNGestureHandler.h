...
#import "ABI46_0_0RNGestureHandlerEvents.h"
#import "ABI46_0_0RNGestureHandlerPointerTracker.h"
...
if (value != nil) { recognizer.prop = [ABI46_0_0RCTConvert type:value]; }\
} while(0)
...
@protocol ABI46_0_0RNGestureHandlerEventEmitter

- (void)sendEvent:(nonnull ABI46_0_0RNGestureHandlerStateChange *)event withActionType:(ABI46_0_0RNGestureHandlerActionType)actionType;

@end


@protocol ABI46_0_0RNRootViewGestureRecognizerDelegate <UIGestureRecognizerDelegate>
...
@interface ABI46_0_0RNGestureHandler : NSObject <UIGestureRecognizerDelegate> {

@protected UIGestureRecognizer *_recognizer;
@protected ABI46_0_0RNGestureHandlerState _lastState;

}

+ (nullable ABI46_0_0RNGestureHandler *)findGestureHandlerByRecognizer:(nonnull UIGestureRecognizer *)recognizer;

- (nonnull instancetype)initWithTag:(nonnull NSNumber *)tag;

@property (nonatomic, readonly, nonnull) NSNumber *tag;
@property (nonatomic, weak, nullable) id<ABI46_0_0RNGestureHandlerEventEmitter> emitter;
@property (nonatomic, readonly, nullable) UIGestureRecognizer *recognizer;
@property (nonatomic, readonly, nullable) ABI46_0_0RNGestureHandlerPointerTracker *pointerTracker;
@property (nonatomic) BOOL enabled;
@property (nonatomic) ABI46_0_0RNGestureHandlerActionType actionType;
...
- (void)handleGesture:(nonnull id)recognizer inState:(ABI46_0_0RNGestureHandlerState)state;
- (BOOL)containsPointInView;
- (ABI46_0_0RNGestureHandlerState)state;
- (nullable ABI46_0_0RNGestureHandlerEventExtraData *)eventExtraData:(nonnull id)recognizer;
...
- (void)sendEventsInState:(ABI46_0_0RNGestureHandlerState)state
           forViewWithTag:(nonnull NSNumber *)ABI46_0_0ReactTag
            withExtraData:(nonnull ABI46_0_0RNGestureHandlerEventExtraData *)extraData;
- (void)sendEvent:(nonnull ABI46_0_0RNGestureHandlerStateChange *)event;
