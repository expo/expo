...
Class<ABI46_0_0RCTComponentViewProtocol> ABI46_0_0RNGestureHandlerRootViewCls(void)
{
  // ABI46_0_0RNGestureHandlerRootView is Android-only.
  // However, if we set `excludedPlatforms: ['iOS']` in `codegenNativeComponent`,
  // codegen still generates `ABI46_0_0RNGestureHandlerRootViewShadowNode` (which it shouldn't)
  // and thus the project fails to compile due to missing `ABI46_0_0RNGestureHandlerRootViewProps`.
