...
@implementation ABI46_0_0RNGestureHandlerEventExtraData
...
{
    return [[ABI46_0_0RNGestureHandlerEventExtraData alloc]
            initWithData:@{
                           @"x": @(position.x),
                           @"y": @(position.y),
                             ...
                             withNumberOfTouches:(NSUInteger)numberOfTouches
{
    if (changedPointers == nil || allPointers == nil) {
        changedPointers = @[];
        allPointers = @[];
        eventType = ABI46_0_0RNGHTouchEventTypeUndetermined;
    }
...
@implementation ABI46_0_0RNGestureHandlerEvent
{
    NSNumber *_handlerTag;
    ABI46_0_0RNGestureHandlerState _state;
    ABI46_0_0RNGestureHandlerEventExtraData *_extraData;
}
...
@implementation ABI46_0_0RNGestureHandlerStateChange
{
    NSNumber *_handlerTag;
    ABI46_0_0RNGestureHandlerState _state;
    ABI46_0_0RNGestureHandlerState _prevState;
    ABI46_0_0RNGestureHandlerEventExtraData *_extraData;
}
