...
@interface ABI46_0_0REAUpdateContext ()

@property (nonatomic, nonnull) NSMutableArray<ABI46_0_0REANode *> *updatedNodes;
@property (nonatomic) NSNumber *loopID;

@end

@implementation ABI46_0_0REAUpdateContext
...
@interface ABI46_0_0REANode ()

@property (nonatomic) NSMutableDictionary<ABI46_0_0REANodeID, NSNumber *> *lastLoopID;
@property (nonatomic) NSMutableDictionary<ABI46_0_0REANodeID, id> *memoizedValue;
@property (nonatomic, nullable) NSMutableArray<ABI46_0_0REANode *> *childNodes;

@end

@implementation ABI46_0_0REANode
...
- (void)addChild:(ABI46_0_0REANode *)child
{
  if (!_childNodes) {
...
- (void)removeChild:(ABI46_0_0REANode *)child
{
  if (child) {
...
+ (NSMutableArray<ABI46_0_0REANode *> *)updatedNodes
{
  static NSMutableArray<ABI46_0_0REANode *> *updatedNodes;
...
+ (void)findAndUpdateNodes:(nonnull ABI46_0_0REANode *)node
            withVisitedSet:(NSMutableSet<ABI46_0_0REANode *> *)visitedNodes
            withFinalNodes:(NSMutableArray<id<ABI46_0_0REAFinalNode>> *)finalNodes
{
  ...
  for (ABI46_0_0REANode *child in node.childNodes) {
    [self findAndUpdateNodes:child withVisitedSet:visitedNodes withFinalNodes:finalNodes];
  }
  if ([node conformsToProtocol:@protocol(ABI46_0_0REAFinalNode)]) {
    [finalNodes addObject:(id<ABI46_0_0REAFinalNode>)node];
  }
}

+ (void)runPropUpdates:(ABI46_0_0REAUpdateContext *)context
{
  NSMutableSet<ABI46_0_0REANode *> *visitedNodes = [NSMutableSet new];
  NSMutableArray<id<ABI46_0_0REAFinalNode>> *finalNodes = [NSMutableArray new];
