...
@implementation ABI46_0_0REACallFuncNode {
...
- (void)beginContext
{
  ...
  for (NSUInteger i = 0; i < _params.count; i++) {
    ...
    ABI46_0_0REAParamNode *param = (ABI46_0_0REAParamNode *)[self.nodesManager findNodeByID:paramID];
...
{
  [self beginContext];
  ABI46_0_0REAFunctionNode *what = (ABI46_0_0REAFunctionNode *)[self.nodesManager findNodeByID:_whatNodeID];
