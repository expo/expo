...
#import <ABI46_0_0RNReanimated/ABI46_0_0REAAllTransitions.h>
#import <ABI46_0_0React/ABI46_0_0RCTViewManager.h>

@interface ABI46_0_0REASnapshotRemover : NSObject <CAAnimationDelegate>
@end

@implementation ABI46_0_0REASnapshotRemover {
  UIView *_view;
}
...
@implementation ABI46_0_0REATransitionGroup

- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
    _sequence = [ABI46_0_0RCTConvert BOOL:config[@"sequence"]];
    NSArray *transitions = [ABI46_0_0RCTConvert NSArray:config[@"transitions"]];
    NSMutableArray<ABI46_0_0REATransition *> *inflated = [NSMutableArray new];
    for (NSDictionary *transitionConfig in transitions) {
      [inflated addObject:[ABI46_0_0REATransition inflate:transitionConfig]];
                       ...
                       forRoot:(UIView *)root
{
  ...
  for (ABI46_0_0REATransition *transition in _transitions) {
    ...
    for (ABI46_0_0REATransitionAnimation *anim in subanims) {
      [anim delayBy:delay];
...
@implementation ABI46_0_0REAVisibilityTransition

- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
    _animationType = [ABI46_0_0RCTConvert ABI46_0_0REATransitionAnimationType:config[@"animation"]];
  }
  return self;
}

- (ABI46_0_0REATransitionAnimation *)appearView:(UIView *)view inParent:(UIView *)parent forRoot:(UIView *)root
{
  return nil;
}

- (ABI46_0_0REATransitionAnimation *)disappearView:(UIView *)view fromParent:(UIView *)parent forRoot:(UIView *)root
{
  return nil;
}
                                              ...
                                              forRoot:(UIView *)root
{
  ...
  if (isViewAppearing && !IS_LAYOUT_ONLY(endValues.view)) {
    NSNumber *parentKey = endValues.reactParent.ABI46_0_0ReactTag;
    ABI46_0_0REATransitionValues *parentStartValues = [self findStartValuesForKey:parentKey];
    ABI46_0_0REATransitionValues *parentEndValues = [self findEndValuesForKey:parentKey];
...
@implementation ABI46_0_0REAInTransition
- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
  }
...
- (ABI46_0_0REATransitionAnimation *)appearView:(UIView *)view inParent:(UIView *)parent forRoot:(UIView *)root
{
  ...
  switch (self.animationType) {
    case ABI46_0_0REATransitionAnimationTypeNone:
      return nil;
    case ABI46_0_0REATransitionAnimationTypeFade: {
    ...
    case ABI46_0_0REATransitionAnimationTypeScale: {
    ...
    case ABI46_0_0REATransitionAnimationTypeSlideTop:
    case ABI46_0_0REATransitionAnimationTypeSlideBottom:
    case ABI46_0_0REATransitionAnimationTypeSlideLeft:
    case ABI46_0_0REATransitionAnimationTypeSlideRight: {
  ...
  return [ABI46_0_0REATransitionAnimation transitionWithAnimation:animation layer:view.layer andKeyPath:animation.keyPath];
}
@end

@implementation ABI46_0_0REAOutTransition
- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
  }
...
- (ABI46_0_0REATransitionAnimation *)disappearView:(UIView *)view fromParent:(UIView *)parent forRoot:(UIView *)root
{
  if (self.animationType == ABI46_0_0REATransitionAnimationTypeNone) {
    return nil;
  }
  ...
  animation.fillMode = kCAFillModeBackwards;
  animation.delegate = [[ABI46_0_0REASnapshotRemover alloc] initWithView:snapshotView];

  return [ABI46_0_0REATransitionAnimation transitionWithAnimation:animation layer:snapshot andKeyPath:animation.keyPath];
}
@end

@implementation ABI46_0_0REAChangeTransition
                                              ...
                                              forRoot:(UIView *)root
{
  ...
  return [ABI46_0_0REATransitionAnimation transitionWithAnimation:group layer:layer andKeyPath:nil];
}
@end
