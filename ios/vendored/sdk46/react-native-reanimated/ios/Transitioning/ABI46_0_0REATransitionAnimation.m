...
CGFloat ABI46_0_0SimAnimationDragCoefficient()
{
#if TARGET_IPHONE_SIMULATOR
...
@implementation ABI46_0_0REATransitionAnimation {
...
{
  ABI46_0_0REATransitionAnimation *anim = [ABI46_0_0REATransitionAnimation new];
...
- (void)play
{
  ...
  */
  if (_delay > 0) {
    _animation.beginTime = CACurrentMediaTime() + _delay * ABI46_0_0SimAnimationDragCoefficient();
  }
  _animation.duration = self.duration * ABI46_0_0SimAnimationDragCoefficient();
