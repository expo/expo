...
@implementation ABI45_0_0RNCSegmentedControl
...
- (void)setValues:(NSArray *)values {
	...
	for (id segment in values) {
		if ([segment isKindOfClass:[NSMutableDictionary class]]){
			UIImage *image = [[ABI45_0_0RCTConvert UIImage:segment] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
