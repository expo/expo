//
//  ABI45_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI45_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI45_0_0RNGestureHandler *otherHandler = [ABI45_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI45_0_0RCTTouchHandler class]];
}
