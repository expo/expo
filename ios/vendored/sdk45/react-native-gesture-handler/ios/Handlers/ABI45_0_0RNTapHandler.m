...
#import "ABI45_0_0RNTapHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI45_0_0React/ABI45_0_0RCTConvert.h>

// ABI45_0_0RNBetterTapGestureRecognizer extends UIGestureRecognizer instead of UITapGestureRecognizer 
...
@interface ABI45_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
@implementation ABI45_0_0RNBetterTapGestureRecognizer {
...
@implementation ABI45_0_0RNTapGestureHandler {
    ABI45_0_0RNGestureHandlerEventExtraData * _lastData;
}

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI45_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
{
  [super resetConfig];
  ABI45_0_0RNBetterTapGestureRecognizer *recognizer = (ABI45_0_0RNBetterTapGestureRecognizer *)_recognizer;
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.maxDelay = [ABI45_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDurationMs"];
  if (prop != nil) {
    recognizer.maxDuration = [ABI45_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDist"];
  if (prop != nil) {
    CGFloat dist = [ABI45_0_0RCTConvert CGFloat:prop];
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
  ...
  // in ABI45_0_0RNGestureHandler it resets _lastSatate variable, making is seem like handler
