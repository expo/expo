//
//  ABI45_0_0RNNativeViewHandler.m
...
#import "ABI45_0_0RNNativeViewHandler.h"
...
#pragma mark ABI45_0_0RNDummyGestureRecognizer

@implementation ABI45_0_0RNDummyGestureRecognizer {
...
#pragma mark ABI45_0_0RNNativeViewgestureHandler

@implementation ABI45_0_0RNNativeViewGestureHandler {
...
- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI45_0_0RNDummyGestureRecognizer alloc] initWithGestureHandler:self];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    _shouldActivateOnStart = [ABI45_0_0RCTConvert BOOL:config[@"shouldActivateOnStart"]];
    _disallowInterruption = [ABI45_0_0RCTConvert BOOL:config[@"disallowInterruption"]];
}
...
- (void)bindToView:(UIView *)view
{
    ...
    if ([view isKindOfClass:[ABI45_0_0RCTScrollView class]]) {
        ...
        // we expect for ABI45_0_0RCTScrollView component to contain a subclass of UIScrollview as the only
        // subview
...
- (void)handleTouchDown:(UIView *)sender forEvent:(UIEvent *)event
{
    ...
    [self sendEventsInState:ABI45_0_0RNGestureHandlerStateActive
             forViewWithTag:sender.ABI45_0_0ReactTag
              withExtraData:[ABI45_0_0RNGestureHandlerEventExtraData forPointerInside:YES]];
}

- (void)handleTouchUpOutside:(UIView *)sender forEvent:(UIEvent *)event
{
    [self sendEventsInState:ABI45_0_0RNGestureHandlerStateEnd
             forViewWithTag:sender.ABI45_0_0ReactTag
              withExtraData:[ABI45_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
...
{
    [self sendEventsInState:ABI45_0_0RNGestureHandlerStateCancelled
             forViewWithTag:sender.ABI45_0_0ReactTag
              withExtraData:[ABI45_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
