...
@implementation ABI45_0_0RNSSearchBar {
...
@implementation ABI45_0_0RNSSearchBarManager

ABI45_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
  return [[ABI45_0_0RNSSearchBar alloc] initWithBridge:self.bridge];
}

ABI45_0_0RCT_EXPORT_VIEW_PROPERTY(obscureBackground, BOOL)
ABI45_0_0RCT_EXPORT_VIEW_PROPERTY(hideNavigationBar, BOOL)
ABI45_0_0RCT_EXPORT_VIEW_PROPERTY(hideWhenScrolling, BOOL)
ABI45_0_0RCT_EXPORT_VIEW_PROPERTY(autoCapitalize, UITextAutocapitalizationType)
ABI45_0_0RCT_EXPORT_VIEW_PROPERTY(placeholder, NSString)
ABI45_0_0RCT_EXPORT_VIEW_PROPERTY(barTintColor, UIColor)
ABI45_0_0RCT_EXPORT_VIEW_PROPERTY(textColor, UIColor)
ABI45_0_0RCT_EXPORT_VIEW_PROPERTY(cancelButtonText, NSString)

ABI45_0_0RCT_EXPORT_VIEW_PROPERTY(onChangeText, ABI45_0_0RCTBubblingEventBlock)
ABI45_0_0RCT_EXPORT_VIEW_PROPERTY(onCancelButtonPress, ABI45_0_0RCTBubblingEventBlock)
ABI45_0_0RCT_EXPORT_VIEW_PROPERTY(onSearchButtonPress, ABI45_0_0RCTBubblingEventBlock)
ABI45_0_0RCT_EXPORT_VIEW_PROPERTY(onFocus, ABI45_0_0RCTBubblingEventBlock)
ABI45_0_0RCT_EXPORT_VIEW_PROPERTY(onBlur, ABI45_0_0RCTBubblingEventBlock)
