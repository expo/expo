...
typedef enum ABI45_0_0RNCWebViewPermissionGrantType : NSUInteger {
    ABI45_0_0RNCWebViewPermissionGrantType_GrantIfSameHost_ElsePrompt,
    ABI45_0_0RNCWebViewPermissionGrantType_GrantIfSameHost_ElseDeny,
    ABI45_0_0RNCWebViewPermissionGrantType_Deny,
    ABI45_0_0RNCWebViewPermissionGrantType_Grant,
    ABI45_0_0RNCWebViewPermissionGrantType_Prompt
} ABI45_0_0RNCWebViewPermissionGrantType;

@class ABI45_0_0RNCWebView;

@protocol ABI45_0_0RNCWebViewDelegate <NSObject>

- (BOOL)webView:(ABI45_0_0RNCWebView *_Nonnull)webView
   shouldStartLoadForRequest:(NSMutableDictionary<NSString *, id> *_Nonnull)request
   withCallback:(ABI45_0_0RCTDirectEventBlock _Nonnull)callback;

@end

@interface ABI45_0_0RNCWeakScriptMessageDelegate : NSObject<WKScriptMessageHandler>
...
@interface ABI45_0_0RNCWebView : ABI45_0_0RCTView
@property (nonatomic, strong) NSString *scopeKey;

@property (nonatomic, weak) id<ABI45_0_0RNCWebViewDelegate> _Nullable delegate;
...
@property (nonatomic, assign) ABI45_0_0RNCWebViewPermissionGrantType mediaCapturePermissionGrantType;
#endif
