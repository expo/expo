...
//                ]
    ...
    class func mapToBillingDetails(billingDetails: NSDictionary?) -> STPPaymentMethodBillingDetails? {
        ...
        billing.email = ABI45_0_0RCTConvert.nsString(billingDetails["email"])
        billing.phone = ABI45_0_0RCTConvert.nsString(billingDetails["phone"])
        billing.name = ABI45_0_0RCTConvert.nsString(billingDetails["name"])

        let billingAddres = STPPaymentMethodAddress()

        billingAddres.city = ABI45_0_0RCTConvert.nsString(billingDetails["addressCity"])
        billingAddres.postalCode = ABI45_0_0RCTConvert.nsString(billingDetails["addressPostalCode"])
        billingAddres.country = ABI45_0_0RCTConvert.nsString(billingDetails["addressCountry"])
        billingAddres.line1 = ABI45_0_0RCTConvert.nsString(billingDetails["addressLine1"])
        billingAddres.line2 = ABI45_0_0RCTConvert.nsString(billingDetails["addressLine2"])
        billingAddres.state = ABI45_0_0RCTConvert.nsString(billingDetails["addressState"])
