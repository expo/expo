...
@objc(ABI45_0_0StripeSdk)
class StripeSdk: ABI45_0_0RCTEventEmitter, STPApplePayContextDelegate, STPBankSelectionViewControllerDelegate, UIAdaptivePresentationControllerDelegate {
    ...
    var applePayRequestResolver: ABI45_0_0RCTPromiseResolveBlock? = nil
    var applePayRequestRejecter: ABI45_0_0RCTPromiseRejectBlock? = nil
    var applePayCompletionRejecter: ABI45_0_0RCTPromiseRejectBlock? = nil
    var confirmApplePayPaymentResolver: ABI45_0_0RCTPromiseResolveBlock? = nil
    var confirmPaymentResolver: ABI45_0_0RCTPromiseResolveBlock? = nil
    ...
    func initialise(params: NSDictionary, resolver resolve: @escaping ABI45_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI45_0_0RCTPromiseRejectBlock) -> Void {
        ...
        let name = ABI45_0_0RCTConvert.nsString(appInfo["name"]) ?? ""
        let partnerId = ABI45_0_0RCTConvert.nsString(appInfo["partnerId"]) ?? ""
        let version = ABI45_0_0RCTConvert.nsString(appInfo["version"]) ?? ""
        let url = ABI45_0_0RCTConvert.nsString(appInfo["url"]) ?? ""
    ...
    func initPaymentSheet(params: NSDictionary, resolver resolve: @escaping ABI45_0_0RCTPromiseResolveBlock,
                          rejecter reject: @escaping ABI45_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func confirmPaymentSheetPayment(resolver resolve: @escaping ABI45_0_0RCTPromiseResolveBlock,
                                    rejecter reject: @escaping ABI45_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func presentPaymentSheet(resolver resolve: @escaping ABI45_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI45_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func createTokenForCVCUpdate(cvc: String?, resolver resolve: @escaping ABI45_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI45_0_0RCTPromiseRejectBlock) {
    ...
    func confirmSetupIntent (setupIntentClientSecret: String, params: NSDictionary,
                             options: NSDictionary, resolver resolve: @escaping ABI45_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI45_0_0RCTPromiseRejectBlock) {
    ...
    func updateApplePaySummaryItems(summaryItems: NSArray, errorAddressFields: [NSDictionary], resolver resolve: @escaping ABI45_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI45_0_0RCTPromiseRejectBlock) {
    ...
    func openApplePaySetup(resolver resolve: @escaping ABI45_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI45_0_0RCTPromiseRejectBlock) -> Void {
    ...
    func confirmApplePayPayment(clientSecret: String, resolver resolve: @escaping ABI45_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI45_0_0RCTPromiseRejectBlock) {
    ...
    func isApplePaySupported(resolver resolve: @escaping ABI45_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI45_0_0RCTPromiseRejectBlock) {
    ...
    func handleURLCallback(url: String?, resolver resolve: @escaping ABI45_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI45_0_0RCTPromiseRejectBlock) {
    ...
    func presentApplePay(params: NSDictionary,
                         resolver resolve: @escaping ABI45_0_0RCTPromiseResolveBlock,
                         rejecter reject: @escaping ABI45_0_0RCTPromiseRejectBlock) {
