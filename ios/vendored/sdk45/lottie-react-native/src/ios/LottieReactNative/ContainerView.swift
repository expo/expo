...
class ContainerView: ABI45_0_0RCTView {
    ...
    @objc var onAnimationFinish: ABI45_0_0RCTBubblingEventBlock?
    ...
    override func abi45_0_0ReactSetFrame(_ frame: CGRect) {
        super.abi45_0_0ReactSetFrame(frame)
        animationView?.abi45_0_0ReactSetFrame(frame)
    }
