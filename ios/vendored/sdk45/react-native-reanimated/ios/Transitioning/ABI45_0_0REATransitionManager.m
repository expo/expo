...
@interface ABI45_0_0REATransitionManager () <ABI45_0_0RCTUIManagerObserver>
@end

@implementation ABI45_0_0REATransitionManager {
  ABI45_0_0REATransition *_pendingTransition;
...
- (void)beginTransition:(ABI45_0_0REATransition *)transition forView:(UIView *)view
{
...
{
  [manager addUIBlock:^(ABI45_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
...
- (void)animateNextTransitionInRoot:(NSNumber *)ABI45_0_0ReactTag withConfig:(NSDictionary *)config
{
  [_uiManager.observerCoordinator addObserver:self];
  [_uiManager prependUIBlock:^(ABI45_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    UIView *view = viewRegistry[ABI45_0_0ReactTag];
    NSArray *transitionConfigs = [ABI45_0_0RCTConvert NSArray:config[@"transitions"]];
    for (id transitionConfig in transitionConfigs) {
      ABI45_0_0REATransition *transition = [ABI45_0_0REATransition inflate:transitionConfig];
      [self beginTransition:transition forView:view];
    }
  }];
  __weak id weakSelf = self;
  [_uiManager addUIBlock:^(ABI45_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
