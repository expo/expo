#import <ABI45_0_0RNReanimated/LayoutAnimationsProxy.h>
#import <ABI45_0_0RNReanimated/NativeMethods.h>
...
#import <ABI45_0_0RNReanimated/ABI45_0_0ReanimatedSensorContainer.h>
...
// COPIED FROM ABI45_0_0RCTTurboModule.mm
...
{
  ABI45_0_0REAModule *reanimatedModule = [bridge moduleForClass:[ABI45_0_0REAModule class]];
  ...
  ABI45_0_0RCTUIManager *uiManager = reanimatedModule.nodesManager.uiManager;
...
#if __has_include(<reacthermes/ABI45_0_0HermesExecutorFactory.h>)
  std::shared_ptr<jsi::Runtime> animatedRuntime = ABI45_0_0facebook::hermes::makeHermesRuntime();
#else
  std::shared_ptr<jsi::Runtime> animatedRuntime = ABI45_0_0facebook::jsc::makeJSCRuntime();
#endif

  std::shared_ptr<Scheduler> scheduler = std::make_shared<ABI45_0_0REAIOSScheduler>(jsInvoker);
  std::shared_ptr<ErrorHandler> errorHandler = std::make_shared<ABI45_0_0REAIOSErrorHandler>(scheduler);
  std::shared_ptr<NativeReanimatedModule> module;

  __block std::weak_ptr<Scheduler> weakScheduler = scheduler;
  ((ABI45_0_0REAUIManager *)uiManager).flushUiOperations = ^void() {
  ...
  ABI45_0_0REAUIManager *reaUiManagerNoCast = [bridge moduleForClass:[ABI45_0_0REAUIManager class]];
  ABI45_0_0RCTUIManager *reaUiManager = reaUiManagerNoCast;
  ABI45_0_0REAAnimationsManager *animationsManager = [[ABI45_0_0REAAnimationsManager alloc] initWithUIManager:reaUiManager];
  ...
  // sensors
  ABI45_0_0ReanimatedSensorContainer *reanimatedSensorContainer = [[ABI45_0_0ReanimatedSensorContainer alloc] init];
  auto registerSensorFunction = [=](int sensorType, int interval, std::function<void(double[])> setter) -> int {
    return [reanimatedSensorContainer registerSensor:(ABI45_0_0ReanimatedSensorType)sensorType
                                            interval:interval
                                              setter:^(double *data) {
                                                setter(data);
                                              }];
  ...
  [reanimatedModule.nodesManager registerEventHandler:^(NSString *eventName, id<ABI45_0_0RCTEvent> event) {
