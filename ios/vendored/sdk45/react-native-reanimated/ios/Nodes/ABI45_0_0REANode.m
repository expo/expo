...
@interface ABI45_0_0REAUpdateContext ()

@property (nonatomic, nonnull) NSMutableArray<ABI45_0_0REANode *> *updatedNodes;
@property (nonatomic) NSNumber *loopID;

@end

@implementation ABI45_0_0REAUpdateContext
...
@interface ABI45_0_0REANode ()

@property (nonatomic) NSMutableDictionary<ABI45_0_0REANodeID, NSNumber *> *lastLoopID;
@property (nonatomic) NSMutableDictionary<ABI45_0_0REANodeID, id> *memoizedValue;
@property (nonatomic, nullable) NSMutableArray<ABI45_0_0REANode *> *childNodes;

@end

@implementation ABI45_0_0REANode
...
- (void)addChild:(ABI45_0_0REANode *)child
{
  if (!_childNodes) {
...
- (void)removeChild:(ABI45_0_0REANode *)child
{
  if (child) {
...
+ (NSMutableArray<ABI45_0_0REANode *> *)updatedNodes
{
  static NSMutableArray<ABI45_0_0REANode *> *updatedNodes;
...
+ (void)findAndUpdateNodes:(nonnull ABI45_0_0REANode *)node
            withVisitedSet:(NSMutableSet<ABI45_0_0REANode *> *)visitedNodes
            withFinalNodes:(NSMutableArray<id<ABI45_0_0REAFinalNode>> *)finalNodes
{
  ...
  for (ABI45_0_0REANode *child in node.childNodes) {
    [self findAndUpdateNodes:child withVisitedSet:visitedNodes withFinalNodes:finalNodes];
  }
  if ([node conformsToProtocol:@protocol(ABI45_0_0REAFinalNode)]) {
    [finalNodes addObject:(id<ABI45_0_0REAFinalNode>)node];
  }
}

+ (void)runPropUpdates:(ABI45_0_0REAUpdateContext *)context
{
  NSMutableSet<ABI45_0_0REANode *> *visitedNodes = [NSMutableSet new];
  NSMutableArray<id<ABI45_0_0REAFinalNode>> *finalNodes = [NSMutableArray new];
