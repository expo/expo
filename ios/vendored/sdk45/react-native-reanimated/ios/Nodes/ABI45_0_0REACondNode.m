...
@implementation ABI45_0_0REACondNode {
...
- (instancetype)initWithID:(ABI45_0_0REANodeID)nodeID config:(NSDictionary<NSString *, id> *)config
{
  if ((self = [super initWithID:nodeID config:config])) {
    _condNodeID = [ABI45_0_0RCTConvert NSNumber:config[@"cond"]];
    ...
    _ifBlockID = [ABI45_0_0RCTConvert NSNumber:config[@"ifBlock"]];
    ABI45_0_0REA_LOG_ERROR_IF_NIL(
        _ifBlockID, @"Reanimated: Second argument passed to cond node is either of wrong type or is missing.");
    _elseBlockID = [ABI45_0_0RCTConvert NSNumber:config[@"elseBlock"]];
  }
  return self;
}
