...
#import "ABI42_0_0RNSScreenStackAnimator.h"
...
@interface ABI42_0_0RNSScreenStackView () <UINavigationControllerDelegate, UIAdaptivePresentationControllerDelegate, UIGestureRecognizerDelegate, UIViewControllerTransitioningDelegate>
...
@implementation ABI42_0_0RNScreensNavigationController
...
@interface ABI42_0_0RNSGestureRecognizer: UIScreenEdgePanGestureRecognizer
@end

@implementation ABI42_0_0RNSGestureRecognizer
@end

@implementation ABI42_0_0RNSScreenStackView {
  UINavigationController *_controller;
  NSMutableArray<ABI42_0_0RNSScreenView *> *_ABI42_0_0ReactSubviews;
  __weak ABI42_0_0RNSScreenStackManager *_manager;
  BOOL _hasLayout;
  BOOL _invalidated;
...
- (instancetype)initWithManager:(ABI42_0_0RNSScreenStackManager*)manager
{
  if (self = [super init]) {
    _hasLayout = NO;
    _invalidated = NO;
    ...
    _controller = [[ABI42_0_0RNScreensNavigationController alloc] init];
...
- (void)navigationController:(UINavigationController *)navigationController willShowViewController:(UIViewController *)viewController animated:(BOOL)animated
{
  ...
  [ABI42_0_0RNSScreenStackHeaderConfig willShowViewController:viewController animated:animated withConfig:config];
}
...
- (void)presentationControllerDidDismiss:(UIPresentationController *)presentationController
{
  ...
  if ([screenView isKindOfClass:[ABI42_0_0RNSScreenView class]]) {
    ...
    if (self.onFinishTransitioning) {
      ...
      // finish event to arrive later than onDismiss (see ABI42_0_0RNSScreen#notifyDismiss)
...
{
  if (![subview isKindOfClass:[ABI42_0_0RNSScreenView class]]) {
    ABI42_0_0RCTLogError(@"ScreenStack only accepts children of type Screen");
    return;
  }
...
- (void)setModalViewControllers:(NSArray<UIViewController *> *)controllers
{
  ...
  for (NSUInteger i = changeRootIndex; i < controllers.count; i++) {
    if ([_presentedModals containsObject:controllers[i]]) {
      ABI42_0_0RCTAssert(false, @"Modally presented controllers are being reshuffled, this is not allowed");
    }
  }

  __weak ABI42_0_0RNSScreenStackView *weakSelf = self;
  ...
  void (^finish)(void) = ^{
    ...
    __IPHONE_OS_VERSION_MAX_ALLOWED >= __IPHONE_13_0
        ...
        BOOL shouldAnimate = lastModal && [next isKindOfClass:[ABI42_0_0RNSScreen class]] && ((ABI42_0_0RNSScreenView *) next.view).stackAnimation != ABI42_0_0RNSScreenStackAnimationNone;
  ...
  if (changeRootController.presentedViewController != nil
    ...
    BOOL shouldAnimate = changeRootIndex == controllers.count && [changeRootController.presentedViewController isKindOfClass:[ABI42_0_0RNSScreen class]] && ((ABI42_0_0RNSScreenView *) changeRootController.presentedViewController.view).stackAnimation != ABI42_0_0RNSScreenStackAnimationNone;
...
- (void)setPushViewControllers:(NSArray<UIViewController *> *)controllers
{
  ...
  BOOL firstTimePush = ![lastTop isKindOfClass:[ABI42_0_0RNSScreen class]];

  BOOL shouldAnimate = !firstTimePush && ((ABI42_0_0RNSScreenView *) lastTop.view).stackAnimation != ABI42_0_0RNSScreenStackAnimationNone;
  ...
  if (firstTimePush) {
    ...
    if (![controllers containsObject:lastTop]) {
      ...
      if ( ![_controller.viewControllers containsObject:top] && ((ABI42_0_0RNSScreenView *) top.view).replaceAnimation == ABI42_0_0RNSScreenReplaceAnimationPush) {
  ...
  for (ABI42_0_0RNSScreenView *screen in _ABI42_0_0ReactSubviews) {
    if (!screen.dismissed && screen.controller != nil) {
      if (pushControllers.count == 0) {
        ...
        if (screen.stackPresentation == ABI42_0_0RNSScreenStackPresentationPush) {
          [pushControllers addObject:screen.controller];
        } else {
...
{
  ABI42_0_0RNSScreenView *screen;
  if (operation == UINavigationControllerOperationPush) {
    screen = (ABI42_0_0RNSScreenView *) toVC.view;
  } else if (operation == UINavigationControllerOperationPop) {
    screen = (ABI42_0_0RNSScreenView *) fromVC.view;
  }
  if (screen != nil && (screen.stackAnimation == ABI42_0_0RNSScreenStackAnimationFade || screen.stackAnimation == ABI42_0_0RNSScreenStackAnimationSimplePush || screen.stackAnimation == ABI42_0_0RNSScreenStackAnimationNone ||
                        screen.stackAnimation == ABI42_0_0RNSScreenStackAnimationSlideFromBottom)) {
    return [[ABI42_0_0RNSScreenStackAnimator alloc] initWithOperation:operation];
  }
  return nil;
}
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
  ...
  if (parent != nil) {
    ABI42_0_0RCTTouchHandler *touchHandler = [parent performSelector:@selector(touchHandler)];
    [touchHandler cancel];
    [touchHandler reset];
  }
  
  ABI42_0_0RNSScreenView *topScreen = (ABI42_0_0RNSScreenView *)_controller.viewControllers.lastObject.view;
  
  if (!topScreen.gestureEnabled || _controller.viewControllers.count < 2) {
    return NO;
  }
  
  if ([gestureRecognizer isKindOfClass:[ABI42_0_0RNSGestureRecognizer class]]) {
    ...
    BOOL isCorrectEdge = (_controller.view.semanticContentAttribute == UISemanticContentAttributeForceRightToLeft && ((ABI42_0_0RNSGestureRecognizer *)gestureRecognizer).edges == UIRectEdgeRight) ||
    (_controller.view.semanticContentAttribute != UISemanticContentAttributeForceRightToLeft && ((ABI42_0_0RNSGestureRecognizer *)gestureRecognizer).edges == UIRectEdgeLeft);
    if (isCorrectEdge) {
      return topScreen.stackAnimation == ABI42_0_0RNSScreenStackAnimationSimplePush;
    }
    return NO;
  } else {
    return topScreen.stackAnimation != ABI42_0_0RNSScreenStackAnimationSimplePush;
...
- (void)setupGestureHandlers
{
  ...
  ABI42_0_0RNSGestureRecognizer *leftEdgeSwipeGestureRecognizer = [[ABI42_0_0RNSGestureRecognizer alloc] initWithTarget:self action:@selector(handleSwipe:)];
  ...
  ABI42_0_0RNSGestureRecognizer *rightEdgeSwipeGestureRecognizer = [[ABI42_0_0RNSGestureRecognizer alloc] initWithTarget:self action:@selector(handleSwipe:)];
...
- (void)handleSwipe:(ABI42_0_0RNSGestureRecognizer *)gestureRecognizer {
...
@implementation ABI42_0_0RNSScreenStackManager {
  NSPointerArray *_stacks;
}

ABI42_0_0RCT_EXPORT_MODULE()

ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(onFinishTransitioning, ABI42_0_0RCTDirectEventBlock);

- (UIView *)view
{
  ABI42_0_0RNSScreenStackView *view = [[ABI42_0_0RNSScreenStackView alloc] initWithManager:self];
  if (!_stacks) {
...
- (void)invalidate
{
 for (ABI42_0_0RNSScreenStackView *stack in _stacks) {
