...
#import "ABI42_0_0REAIOSScheduler.h"
#import "ABI42_0_0REAIOSErrorHandler.h"
...
// COPIED FROM ABI42_0_0RCTTurboModule.mm
...
std::shared_ptr<NativeReanimatedModule> createReanimatedModule(std::shared_ptr<CallInvoker> jsInvoker) {
  ABI42_0_0RCTBridge *bridge = ABI42_0_0_bridge_reanimated;
  ABI42_0_0REAModule *reanimatedModule = [bridge moduleForClass:[ABI42_0_0REAModule class]];
  ...
  ABI42_0_0RCTUIManager *uiManager = reanimatedModule.nodesManager.uiManager;
  ...
  std::shared_ptr<Scheduler> scheduler = std::make_shared<ABI42_0_0REAIOSScheduler>(jsInvoker);
  std::shared_ptr<ErrorHandler> errorHandler = std::make_shared<ABI42_0_0REAIOSErrorHandler>(scheduler);
  ...
  [reanimatedModule.nodesManager registerEventHandler:^(NSString *eventName, id<ABI42_0_0RCTEvent> event) {
