...
CGFloat ABI42_0_0SimAnimationDragCoefficient()
{
#if TARGET_IPHONE_SIMULATOR
...
@implementation ABI42_0_0REATransitionAnimation {
...
{
  ABI42_0_0REATransitionAnimation *anim = [ABI42_0_0REATransitionAnimation new];
...
- (void)play
{
  ...
  */
  if (_delay > 0){
    _animation.beginTime = CACurrentMediaTime() + _delay * ABI42_0_0SimAnimationDragCoefficient();
  }
  _animation.duration = self.duration * ABI42_0_0SimAnimationDragCoefficient();
