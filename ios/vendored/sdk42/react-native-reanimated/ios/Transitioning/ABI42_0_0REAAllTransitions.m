...
#import "ABI42_0_0REAAllTransitions.h"
#import "ABI42_0_0RCTConvert+REATransition.h"

@interface ABI42_0_0REASnapshotRemover : NSObject <CAAnimationDelegate>
@end

@implementation ABI42_0_0REASnapshotRemover {
  UIView *_view;
}
...
@implementation ABI42_0_0REATransitionGroup

- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
    _sequence = [ABI42_0_0RCTConvert BOOL:config[@"sequence"]];
    NSArray *transitions = [ABI42_0_0RCTConvert NSArray:config[@"transitions"]];
    NSMutableArray<ABI42_0_0REATransition*> *inflated = [NSMutableArray new];
    for (NSDictionary *transitionConfig in transitions) {
      [inflated addObject:[ABI42_0_0REATransition inflate:transitionConfig]];
                                                             ...
                                                             forRoot:(UIView *)root
{
  ...
  for (ABI42_0_0REATransition *transition in _transitions) {
    ...
    for (ABI42_0_0REATransitionAnimation *anim in subanims) {
      [anim delayBy:delay];
...
@implementation ABI42_0_0REAVisibilityTransition

- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
    _animationType = [ABI42_0_0RCTConvert ABI42_0_0REATransitionAnimationType:config[@"animation"]];
  }
  return self;
}

- (ABI42_0_0REATransitionAnimation *)appearView:(UIView *)view
...
- (ABI42_0_0REATransitionAnimation *)disappearView:(UIView *)view
                                                 ...
                                                 forRoot:(UIView *)root
{
  ...
  if (isViewAppearing && !IS_LAYOUT_ONLY(endValues.view)) {
    NSNumber *parentKey = endValues.reactParent.ABI42_0_0ReactTag;
    ABI42_0_0REATransitionValues *parentStartValues = [self findStartValuesForKey:parentKey];
    ABI42_0_0REATransitionValues *parentEndValues = [self findEndValuesForKey:parentKey];
...
@implementation ABI42_0_0REAInTransition
- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
  }
                                  ...
                                  forRoot:(UIView *)root
{
  ...
  switch (self.animationType) {
    case ABI42_0_0REATransitionAnimationTypeNone:
      return nil;
    case ABI42_0_0REATransitionAnimationTypeFade: {
    ...
    case ABI42_0_0REATransitionAnimationTypeScale: {
    ...
    case ABI42_0_0REATransitionAnimationTypeSlideTop:
    case ABI42_0_0REATransitionAnimationTypeSlideBottom:
    case ABI42_0_0REATransitionAnimationTypeSlideLeft:
    case ABI42_0_0REATransitionAnimationTypeSlideRight: {
  ...
  return [ABI42_0_0REATransitionAnimation transitionWithAnimation:animation layer:view.layer andKeyPath:animation.keyPath];
}
@end


@implementation ABI42_0_0REAOutTransition
- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
  }
...
- (ABI42_0_0REATransitionAnimation *)disappearView:(UIView *)view
                               fromParent:(UIView *)parent
                                  forRoot:(UIView *)root
{
  if (self.animationType == ABI42_0_0REATransitionAnimationTypeNone) {
    return nil;
  }
  ...
  animation.fillMode = kCAFillModeBackwards;
  animation.delegate = [[ABI42_0_0REASnapshotRemover alloc] initWithView:snapshotView];

  return [ABI42_0_0REATransitionAnimation transitionWithAnimation:animation layer:snapshot andKeyPath:animation.keyPath];
}
@end


@implementation ABI42_0_0REAChangeTransition
                                                 ...
                                                 forRoot:(UIView *)root
{
  ...
  return [ABI42_0_0REATransitionAnimation transitionWithAnimation:group layer:layer andKeyPath:nil];
}
@end
