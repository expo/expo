...
class Scheduler {
  public:
    ...
    void setJSCallInvoker(std::shared_ptr<ABI42_0_0facebook::ABI42_0_0React::CallInvoker> jsCallInvoker);
  ...
  protected:
    ...
    std::shared_ptr<ABI42_0_0facebook::ABI42_0_0React::CallInvoker> jsCallInvoker_;
