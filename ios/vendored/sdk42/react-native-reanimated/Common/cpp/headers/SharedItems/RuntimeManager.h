...
/**
 A class that manages a jsi::Runtime apart from the ABI42_0_0React-JS runtime.
 */
...
public:
  ...
  std::shared_ptr<ErrorHandler> errorHandler;
  /**
   Holds the Scheduler that is responsible for scheduling work on the UI- or ABI42_0_0React-JS Thread.
   */
