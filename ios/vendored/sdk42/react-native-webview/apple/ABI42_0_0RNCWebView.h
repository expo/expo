...
@class ABI42_0_0RNCWebView;

@protocol ABI42_0_0RNCWebViewDelegate <NSObject>

- (BOOL)webView:(ABI42_0_0RNCWebView *_Nonnull)webView
   shouldStartLoadForRequest:(NSMutableDictionary<NSString *, id> *_Nonnull)request
   withCallback:(ABI42_0_0RCTDirectEventBlock _Nonnull)callback;

@end

@interface ABI42_0_0RNCWeakScriptMessageDelegate : NSObject<WKScriptMessageHandler>
