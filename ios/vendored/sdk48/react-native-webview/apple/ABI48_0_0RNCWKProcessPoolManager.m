...
#import "ABI48_0_0RNCWKProcessPoolManager.h"

@interface ABI48_0_0RNCWKProcessPoolManager() {
  WKProcessPool *_sharedProcessPool;
    NSMutableDictionary<NSString *, WKProcessPool *> *_pools;
}
@end

@implementation ABI48_0_0RNCWKProcessPoolManager
...
+ (id) sharedManager {
  static ABI48_0_0RNCWKProcessPoolManager *_sharedManager = nil;
  @synchronized(self) {
