...
public:
  JSI_HOST_FUNCTION(fromURI) {
    ...
    return ABI48_0_0React::createPromiseAsJSIValue(
        runtime,
        [context = std::move(context), localUri = std::move(localUri)](
            jsi::Runtime &runtime,
            std::shared_ptr<ABI48_0_0React::Promise> promise) -> void {
  ...
  explicit JsiSkDataFactory(std::shared_ptr<ABI48_0_0RNSkPlatformContext> context)
