...
public:
  ...
  explicit JsiSkCanvas(std::shared_ptr<ABI48_0_0RNSkPlatformContext> context)
      : JsiSkHostObject(std::move(context)) {}

  JsiSkCanvas(std::shared_ptr<ABI48_0_0RNSkPlatformContext> context, SkCanvas *canvas)
