...
#include <ABI48_0_0RNSkClockValue.h>
 ...
 */
class ABI48_0_0RNSkAnimation : public ABI48_0_0RNSkClockValue {

public:
  ABI48_0_0RNSkAnimation(std::shared_ptr<ABI48_0_0RNSkPlatformContext> platformContext,
                size_t identifier, jsi::Runtime &runtime,
                const jsi::Value *arguments, size_t count)
      : ABI48_0_0RNSkClockValue(platformContext, identifier, runtime, arguments, count) {
  ...
  JSI_EXPORT_FUNCTIONS(JSI_EXPORT_FUNC(ABI48_0_0RNSkAnimation, cancel))
