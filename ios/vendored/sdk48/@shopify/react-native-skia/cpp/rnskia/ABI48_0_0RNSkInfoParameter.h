...
class ABI48_0_0RNSkInfoObject : public ABI48_0_0RNJsi::JsiHostObject {
public:
  ...
  JSI_EXPORT_PROPERTY_GETTERS(JSI_EXPORT_PROP_GET(ABI48_0_0RNSkInfoObject, width),
                              JSI_EXPORT_PROP_GET(ABI48_0_0RNSkInfoObject, height),
                              JSI_EXPORT_PROP_GET(ABI48_0_0RNSkInfoObject, timestamp),
                              JSI_EXPORT_PROP_GET(ABI48_0_0RNSkInfoObject, touches))
  ...
  ABI48_0_0RNSkInfoObject() : JsiHostObject() {}
