...
/**
 ...
 started.
 */
class ABI48_0_0RNSkReadonlyValue
    : public JsiSkHostObject,
      public std::enable_shared_from_this<ABI48_0_0RNSkReadonlyValue> {
public:
  explicit ABI48_0_0RNSkReadonlyValue(
      std::shared_ptr<ABI48_0_0RNSkPlatformContext> platformContext)
      : JsiSkHostObject(platformContext),
        _valueHolder(std::make_shared<ABI48_0_0RNJsi::JsiValueWrapper>(
            *platformContext->getJsRuntime())) {}

  virtual ~ABI48_0_0RNSkReadonlyValue() { invalidate(); }
  ...
  JSI_EXPORT_PROPERTY_GETTERS(JSI_EXPORT_PROP_GET(ABI48_0_0RNSkReadonlyValue,
                                                  __typename__),
                              JSI_EXPORT_PROP_GET(ABI48_0_0RNSkReadonlyValue, current))
        ...
        addListener([weakSelf = weak_from_this(),
          ...
          if (self) {
            auto selfReadonlyValue =
                std::dynamic_pointer_cast<ABI48_0_0RNSkReadonlyValue>(self);
  ...
  JSI_EXPORT_FUNCTIONS(JSI_EXPORT_FUNC(ABI48_0_0RNSkReadonlyValue, addListener),
                       JSI_EXPORT_FUNC(ABI48_0_0RNSkReadonlyValue, __invalidate))
   ...
   */
  std::shared_ptr<ABI48_0_0RNJsi::JsiValueWrapper> getCurrent() { return _valueHolder; }
...
private:
  std::shared_ptr<ABI48_0_0RNJsi::JsiValueWrapper> _valueHolder;
