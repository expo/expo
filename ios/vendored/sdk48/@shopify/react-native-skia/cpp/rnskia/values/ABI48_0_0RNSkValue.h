 ...
 */
class ABI48_0_0RNSkValue : public ABI48_0_0RNSkReadonlyValue {
public:
  ABI48_0_0RNSkValue(std::shared_ptr<ABI48_0_0RNSkPlatformContext> platformContext,
  ...
  ~ABI48_0_0RNSkValue() { unsubscribe(); }
  ...
  JSI_PROPERTY_SET(animation) {
    ...
    // Verify input
    if (value.isObject() &&
        value.asObject(runtime).isHostObject<ABI48_0_0RNSkAnimation>(runtime)) {
      auto animation =
          value.asObject(runtime).getHostObject<ABI48_0_0RNSkAnimation>(runtime);
  ...
  JSI_EXPORT_PROPERTY_SETTERS(JSI_EXPORT_PROP_SET(ABI48_0_0RNSkValue, current),
                              JSI_EXPORT_PROP_SET(ABI48_0_0RNSkValue, animation))

  JSI_EXPORT_PROPERTY_GETTERS(JSI_EXPORT_PROP_GET(ABI48_0_0RNSkReadonlyValue,
                                                  __typename__),
                              JSI_EXPORT_PROP_GET(ABI48_0_0RNSkValue, current),
                              JSI_EXPORT_PROP_GET(ABI48_0_0RNSkValue, animation))

  JSI_EXPORT_FUNCTIONS(JSI_EXPORT_FUNC(ABI48_0_0RNSkValue, addListener),
                       JSI_EXPORT_FUNC(ABI48_0_0RNSkReadonlyValue, __invalidate))

private:
  void subscribe(std::shared_ptr<ABI48_0_0RNSkAnimation> animation) {
    if (animation != nullptr) {
      ...
      _unsubscribe =
          std::make_shared<std::function<void()>>(_animation->addListener(
              [weakSelf = weak_from_this()](jsi::Runtime &runtime) {
                ...
                if (self) {
                  auto selfAsThis = std::dynamic_pointer_cast<ABI48_0_0RNSkValue>(self);
  ...
  std::shared_ptr<ABI48_0_0RNSkAnimation> _animation;
