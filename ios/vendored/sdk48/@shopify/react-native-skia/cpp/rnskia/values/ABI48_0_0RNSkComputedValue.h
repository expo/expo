 ...
 */
class ABI48_0_0RNSkComputedValue : public ABI48_0_0RNSkReadonlyValue {
public:
  ABI48_0_0RNSkComputedValue(std::shared_ptr<ABI48_0_0RNSkPlatformContext> platformContext,
                    jsi::Runtime &runtime, const jsi::Value *arguments,
                    size_t count)
      : ABI48_0_0RNSkReadonlyValue(platformContext) {
    // Verify input
  ...
  void invalidate() override {
    ABI48_0_0RNSkReadonlyValue::invalidate();
  ...
  void initializeDependencies(jsi::Runtime &runtime,
    ...
    // Save dependencies
    std::vector<std::shared_ptr<ABI48_0_0RNSkReadonlyValue>> dependencies;
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      auto value =
          dep.asObject(runtime).asHostObject<ABI48_0_0RNSkReadonlyValue>(runtime);
      if (value == nullptr) {
        continue;
      }
    ...
    for (const auto &dep : dependencies) {
      _unsubscribers.push_back(dep->addListener([weakSelf = weak_from_this()](
        ...
        if (self) {
          auto selfAsThis = std::dynamic_pointer_cast<ABI48_0_0RNSkComputedValue>(self);
