...
ABI48_0_0RNSkJsRenderer::ABI48_0_0RNSkJsRenderer(std::function<void()> requestRedraw,
                               std::shared_ptr<ABI48_0_0RNSkPlatformContext> context)
    : ABI48_0_0RNSkRenderer(requestRedraw),
      _jsiCanvas(std::make_shared<JsiSkCanvas>(context)),
      _platformContext(std::move(context)),
      _infoObject(std::make_shared<ABI48_0_0RNSkInfoObject>()),
...
bool ABI48_0_0RNSkJsRenderer::tryRender(
...
void ABI48_0_0RNSkJsRenderer::renderImmediate(
    std::shared_ptr<ABI48_0_0RNSkCanvasProvider> canvasProvider) {
...
void ABI48_0_0RNSkJsRenderer::setDrawCallback(
    std::shared_ptr<jsi::Function> drawCallback) {
  _drawCallback = drawCallback;
}

std::shared_ptr<ABI48_0_0RNSkInfoObject> ABI48_0_0RNSkJsRenderer::getInfoObject() {
  return _infoObject;
}

void ABI48_0_0RNSkJsRenderer::performDraw(
    std::shared_ptr<ABI48_0_0RNSkCanvasProvider> canvasProvider) {
  // Start timing
...
void ABI48_0_0RNSkJsRenderer::callJsDrawCallback(std::shared_ptr<JsiSkCanvas> jsiCanvas,
...
void ABI48_0_0RNSkJsRenderer::drawInJsiCanvas(std::shared_ptr<JsiSkCanvas> jsiCanvas,
