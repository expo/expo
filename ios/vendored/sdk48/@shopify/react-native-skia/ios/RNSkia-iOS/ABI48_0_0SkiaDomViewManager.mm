...
#include <ABI48_0_0SkiaDomViewManager.h>
...
@implementation ABI48_0_0SkiaDomViewManager

ABI48_0_0RCT_EXPORT_MODULE(ABI48_0_0SkiaDomView)

- (ABI48_0_0SkiaManager*) skiaManager {
  auto bridge = [ABI48_0_0RCTBridge currentBridge];
  auto skiaModule = (ABI48_0_0RNSkiaModule*)[bridge moduleForName:@"ABI48_0_0RNSkia"];
...
- (UIView *)view
{
  ...
  return [[ABI48_0_0SkiaUIView alloc] initWithManager: skManager.get()
    ...
    return std::make_shared<ABI48_0_0RNSkiOSView<ABI48_0_0RNSkia::ABI48_0_0RNSkDomView>>(context);
  }];
}
