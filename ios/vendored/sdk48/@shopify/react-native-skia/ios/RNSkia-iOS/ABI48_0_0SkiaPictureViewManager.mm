...
@implementation ABI48_0_0SkiaPictureViewManager

ABI48_0_0RCT_EXPORT_MODULE(SkiaPictureView)
...
- (UIView *)view
{
  ...
  return [[ABI48_0_0SkiaUIView alloc] initWithManager: skManager.get()
    ...
    return std::make_shared<ABI48_0_0RNSkiOSView<ABI48_0_0RNSkia::ABI48_0_0RNSkPictureView>>(context);
  }];
}
