...
class ContainerView: ABI48_0_0RCTView {
    ...
    @objc var onAnimationFinish: ABI48_0_0RCTBubblingEventBlock?
    ...
    override func abi48_0_0ReactSetFrame(_ frame: CGRect) {
        super.abi48_0_0ReactSetFrame(frame)
        animationView?.abi48_0_0ReactSetFrame(frame)
    }
