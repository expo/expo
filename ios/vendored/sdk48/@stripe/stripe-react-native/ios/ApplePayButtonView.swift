...
@objc(ABI48_0_0ApplePayButtonView)
class ApplePayButtonView: UIView {
    var applePayButton: PKPaymentButton?
    var stripeSdk: StripeSdk?
    
    @objc var onPressAction: ABI48_0_0RCTDirectEventBlock?
    @objc var onShippingMethodSelectedAction: ABI48_0_0RCTDirectEventBlock?
    @objc var onShippingContactSelectedAction: ABI48_0_0RCTDirectEventBlock?
    @objc var onCouponCodeEnteredAction: ABI48_0_0RCTDirectEventBlock?
