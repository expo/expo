...
@implementation ABI48_0_0RNSSearchBar {
...
{
  if (self = [super init]) {
    static const auto defaultProps = std::make_shared<const ABI48_0_0facebook::ABI48_0_0React::ABI48_0_0RNSSearchBarProps>();
    _props = defaultProps;
    [self initCommonProps];
  }
  return self;
...
- (void)emitOnFocusEvent
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI48_0_0facebook::ABI48_0_0React::ABI48_0_0RNSSearchBarEventEmitter>(_eventEmitter)
        ->onFocus(ABI48_0_0facebook::ABI48_0_0React::ABI48_0_0RNSSearchBarEventEmitter::OnFocus{});
  }
#else
  if (self.onFocus) {
    self.onFocus(@{});
...
- (void)emitOnBlurEvent
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI48_0_0facebook::ABI48_0_0React::ABI48_0_0RNSSearchBarEventEmitter>(_eventEmitter)
        ->onBlur(ABI48_0_0facebook::ABI48_0_0React::ABI48_0_0RNSSearchBarEventEmitter::OnBlur{});
  }
#else
  if (self.onBlur) {
    self.onBlur(@{});
...
- (void)emitOnSearchButtonPressEventWithText:(NSString *)text
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI48_0_0facebook::ABI48_0_0React::ABI48_0_0RNSSearchBarEventEmitter>(_eventEmitter)
        ->onSearchButtonPress(
            ABI48_0_0facebook::ABI48_0_0React::ABI48_0_0RNSSearchBarEventEmitter::OnSearchButtonPress{.text = ABI48_0_0RCTStringFromNSString(text)});
  }
#else
...
- (void)emitOnCancelButtonPressEvent
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI48_0_0facebook::ABI48_0_0React::ABI48_0_0RNSSearchBarEventEmitter>(_eventEmitter)
        ->onCancelButtonPress(ABI48_0_0facebook::ABI48_0_0React::ABI48_0_0RNSSearchBarEventEmitter::OnCancelButtonPress{});
  }
#else
...
- (void)emitOnChangeTextEventWithText:(NSString *)text
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI48_0_0facebook::ABI48_0_0React::ABI48_0_0RNSSearchBarEventEmitter>(_eventEmitter)
        ->onChangeText(ABI48_0_0facebook::ABI48_0_0React::ABI48_0_0RNSSearchBarEventEmitter::OnChangeText{.text = ABI48_0_0RCTStringFromNSString(text)});
  }
#else
...
{
  const auto &oldScreenProps = *std::static_pointer_cast<const ABI48_0_0facebook::ABI48_0_0React::ABI48_0_0RNSSearchBarProps>(_props);
  const auto &newScreenProps = *std::static_pointer_cast<const ABI48_0_0facebook::ABI48_0_0React::ABI48_0_0RNSSearchBarProps>(props);
  ...
  if (oldScreenProps.cancelButtonText != newScreenProps.cancelButtonText) {
    [self setCancelButtonText:ABI48_0_0RCTNSStringFromStringNilIfEmpty(newScreenProps.cancelButtonText)];
  }
  ...
  if (oldScreenProps.placeholder != newScreenProps.placeholder) {
    [self setPlaceholder:ABI48_0_0RCTNSStringFromStringNilIfEmpty(newScreenProps.placeholder)];
  }

  if (oldScreenProps.autoCapitalize != newScreenProps.autoCapitalize) {
    [self setAutoCapitalize:[ABI48_0_0RNSConvert UITextAutocapitalizationTypeFromCppEquivalent:newScreenProps.autoCapitalize]];
  }

  if (oldScreenProps.tintColor != newScreenProps.tintColor) {
    [self setTintColor:ABI48_0_0RCTUIColorFromSharedColor(newScreenProps.tintColor)];
  }

  if (oldScreenProps.barTintColor != newScreenProps.barTintColor) {
    [self setBarTintColor:ABI48_0_0RCTUIColorFromSharedColor(newScreenProps.barTintColor)];
  }

  if (oldScreenProps.textColor != newScreenProps.textColor) {
    [self setTextColor:ABI48_0_0RCTUIColorFromSharedColor(newScreenProps.textColor)];
  }
...
{
  return ABI48_0_0facebook::ABI48_0_0React::concreteComponentDescriptorProvider<ABI48_0_0facebook::ABI48_0_0React::ABI48_0_0RNSSearchBarComponentDescriptor>();
}
...
#ifdef RN_FABRIC_ENABLED
Class<ABI48_0_0RCTComponentViewProtocol> ABI48_0_0RNSSearchBarCls(void)
{
  return ABI48_0_0RNSSearchBar.class;
}
#endif

@implementation ABI48_0_0RNSSearchBarManager
...
- (UIView *)view
{
  return [[ABI48_0_0RNSSearchBar alloc] initWithBridge:self.bridge];
}
#endif

ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(obscureBackground, BOOL)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(hideNavigationBar, BOOL)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(hideWhenScrolling, BOOL)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(autoCapitalize, UITextAutocapitalizationType)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(placeholder, NSString)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(barTintColor, UIColor)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(tintColor, UIColor)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(textColor, UIColor)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(cancelButtonText, NSString)

ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(onChangeText, ABI48_0_0RCTBubblingEventBlock)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(onCancelButtonPress, ABI48_0_0RCTBubblingEventBlock)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(onSearchButtonPress, ABI48_0_0RCTBubblingEventBlock)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(onFocus, ABI48_0_0RCTBubblingEventBlock)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(onBlur, ABI48_0_0RCTBubblingEventBlock)
