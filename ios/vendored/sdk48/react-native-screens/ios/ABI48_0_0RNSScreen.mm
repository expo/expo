...
- (void)updatePresentationStyle
{
  ...
  if (@available(iOS 15.0, *)) {
    ...
    if (_stackPresentation == ABI48_0_0RNSScreenStackPresentationFormSheet && sheet != nil) {
      ...
      if (_sheetLargestUndimmedDetent == ABI48_0_0RNSScreenDetentTypeMedium) {
        sheet.largestUndimmedDetentIdentifier = UISheetPresentationControllerDetentIdentifierMedium;
      } else if (_sheetLargestUndimmedDetent == ABI48_0_0RNSScreenDetentTypeLarge) {
        sheet.largestUndimmedDetentIdentifier = UISheetPresentationControllerDetentIdentifierLarge;
      } else if (_sheetLargestUndimmedDetent == ABI48_0_0RNSScreenDetentTypeAll) {
        sheet.largestUndimmedDetentIdentifier = nil;
      } else {
        ABI48_0_0RCTLogError(@"Unhandled value of sheetLargestUndimmedDetent passed");
      }

      if (_sheetAllowedDetents == ABI48_0_0RNSScreenDetentTypeMedium) {
      ...
      } else if (_sheetAllowedDetents == ABI48_0_0RNSScreenDetentTypeLarge) {
      ...
      } else if (_sheetAllowedDetents == ABI48_0_0RNSScreenDetentTypeAll) {
        sheet.detents =
            @[ UISheetPresentationControllerDetent.mediumDetent, UISheetPresentationControllerDetent.largeDetent ];
      } else {
        ABI48_0_0RCTLogError(@"Unhandled value of sheetAllowedDetents passed");
      }
    }
  }
           ...
           oldProps:(ABI48_0_0facebook::ABI48_0_0React::Props::Shared const &)oldProps
{
  ...
  if (newScreenProps.sheetAllowedDetents != oldScreenProps.sheetAllowedDetents) {
    [self setSheetAllowedDetents:[ABI48_0_0RNSConvert ABI48_0_0RNSScreenDetentTypeFromAllowedDetents:newScreenProps.sheetAllowedDetents]];
  }

  if (newScreenProps.sheetLargestUndimmedDetent != oldScreenProps.sheetLargestUndimmedDetent) {
    [self setSheetLargestUndimmedDetent:
              [ABI48_0_0RNSConvert ABI48_0_0RNSScreenDetentTypeFromLargestUndimmedDetent:newScreenProps.sheetLargestUndimmedDetent]];
  }
#endif // !TARGET_OS_TV
...
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(sheetAllowedDetents, ABI48_0_0RNSScreenDetentType);
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(sheetLargestUndimmedDetent, ABI48_0_0RNSScreenDetentType);
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(sheetGrabberVisible, BOOL);
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(sheetCornerRadius, CGFloat);
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(sheetExpandsWhenScrolledToEdge, BOOL);
#endif
...
ABI48_0_0RCT_ENUM_CONVERTER(
    ABI48_0_0RNSScreenDetentType,
    (@{
      @"large" : @(ABI48_0_0RNSScreenDetentTypeLarge),
      @"medium" : @(ABI48_0_0RNSScreenDetentTypeMedium),
      @"all" : @(ABI48_0_0RNSScreenDetentTypeAll),
    }),
