...
CGFloat ABI48_0_0SimAnimationDragCoefficient()
{
#if TARGET_IPHONE_SIMULATOR
...
@implementation ABI48_0_0REATransitionAnimation {
...
{
  ABI48_0_0REATransitionAnimation *anim = [ABI48_0_0REATransitionAnimation new];
...
- (void)play
{
  ...
  */
  if (_delay > 0) {
    _animation.beginTime = CACurrentMediaTime() + _delay * ABI48_0_0SimAnimationDragCoefficient();
  }
  _animation.duration = self.duration * ABI48_0_0SimAnimationDragCoefficient();
