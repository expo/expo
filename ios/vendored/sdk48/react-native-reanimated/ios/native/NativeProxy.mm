#import <ABI48_0_0RNReanimated/LayoutAnimationsProxy.h>
#import <ABI48_0_0RNReanimated/NativeMethods.h>
...
#import <ABI48_0_0RNReanimated/ABI48_0_0REAKeyboardEventObserver.h>
...
#if __has_include(<ABI48_0_0reacthermes/ABI48_0_0HermesExecutorFactory.h>)
#import <ABI48_0_0reacthermes/ABI48_0_0HermesExecutorFactory.h>
#else
#if REACT_NATIVE_MINOR_VERSION >= 71
#include <jsc/JSCRuntime.h>
#else
#include <ABI48_0_0jsi/ABI48_0_0JSCRuntime.h>
...
// COPIED FROM ABI48_0_0RCTTurboModule.mm
...
{
  ABI48_0_0REAModule *reanimatedModule = [bridge moduleForClass:[ABI48_0_0REAModule class]];
  ...
  ABI48_0_0RCTUIManager *uiManager = reanimatedModule.nodesManager.uiManager;
  ...
  id<ABI48_0_0RNGestureHandlerStateManager> gestureHandlerStateManager = nil;
  auto setGestureStateFunction = [gestureHandlerStateManager, bridge](int handlerTag, int newState) mutable {
    if (gestureHandlerStateManager == nil) {
      gestureHandlerStateManager = [bridge moduleForName:@"ABI48_0_0RNGestureHandlerModule"];
    }
...
#if __has_include(<ABI48_0_0reacthermes/ABI48_0_0HermesExecutorFactory.h>)
  std::shared_ptr<jsi::Runtime> animatedRuntime = ABI48_0_0facebook::ABI48_0_0hermes::makeHermesRuntime();
#else
  std::shared_ptr<jsi::Runtime> animatedRuntime = ABI48_0_0facebook::jsc::makeJSCRuntime();
#endif

  std::shared_ptr<Scheduler> scheduler = std::make_shared<ABI48_0_0REAIOSScheduler>(jsInvoker);
  std::shared_ptr<ErrorHandler> errorHandler = std::make_shared<ABI48_0_0REAIOSErrorHandler>(scheduler);
  std::shared_ptr<NativeReanimatedModule> module;

  __block std::weak_ptr<Scheduler> weakScheduler = scheduler;
  ((ABI48_0_0REAUIManager *)uiManager).flushUiOperations = ^void() {
  ...
  ABI48_0_0REAUIManager *reaUiManagerNoCast = [bridge moduleForClass:[ABI48_0_0REAUIManager class]];
  ABI48_0_0RCTUIManager *reaUiManager = reaUiManagerNoCast;
  ABI48_0_0REAAnimationsManager *animationsManager = [[ABI48_0_0REAAnimationsManager alloc] initWithUIManager:reaUiManager];
  ...
  // sensors
  ABI48_0_0ReanimatedSensorContainer *reanimatedSensorContainer = [[ABI48_0_0ReanimatedSensorContainer alloc] init];
  auto registerSensorFunction = [=](int sensorType, int interval, std::function<void(double[])> setter) -> int {
    return [reanimatedSensorContainer registerSensor:(ABI48_0_0ReanimatedSensorType)sensorType
                                            interval:interval
                                              setter:^(double *data) {
                                                setter(data);
                                              }];
  ...
  static ABI48_0_0REAKeyboardEventObserver *keyboardObserver = [[ABI48_0_0REAKeyboardEventObserver alloc] init];
  ...
  [reanimatedModule.nodesManager registerEventHandler:^(NSString *eventName, id<ABI48_0_0RCTEvent> event) {
