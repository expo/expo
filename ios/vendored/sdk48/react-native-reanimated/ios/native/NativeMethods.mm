...
std::vector<std::pair<std::string, double>> measure(int viewTag, ABI48_0_0RCTUIManager *uiManager)
{
  UIView *view = [uiManager viewForABI48_0_0ReactTag:@(viewTag)];
...
void scrollTo(int scrollViewTag, ABI48_0_0RCTUIManager *uiManager, double x, double y, bool animated)
{
  UIView *view = [uiManager viewForABI48_0_0ReactTag:@(scrollViewTag)];
  ABI48_0_0RCTScrollView *scrollView = (ABI48_0_0RCTScrollView *)view;
  [scrollView scrollToOffset:(CGPoint){(CGFloat)x, (CGFloat)y} animated:animated];
}

void setGestureState(id<ABI48_0_0RNGestureHandlerStateManager> gestureHandlerStateManager, int handlerTag, int newState)
{
