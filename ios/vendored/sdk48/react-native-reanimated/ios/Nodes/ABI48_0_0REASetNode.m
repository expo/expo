...
#import <ABI48_0_0RNReanimated/ABI48_0_0REASetNode.h>
...
@implementation ABI48_0_0REASetNode {
...
- (instancetype)initWithID:(ABI48_0_0REANodeID)nodeID config:(NSDictionary<NSString *, id> *)config
{
  if ((self = [super initWithID:nodeID config:config])) {
    _whatNodeID = [ABI48_0_0RCTConvert NSNumber:config[@"what"]];
...
- (id)evaluate
{
  ...
  ABI48_0_0REAValueNode *what = (ABI48_0_0REAValueNode *)[self.nodesManager findNodeByID:_whatNodeID];
