#import "ABI48_0_0RNManualHandler.h"

@interface ABI48_0_0RNManualRecognizer : UIGestureRecognizer

- (id)initWithGestureHandler:(ABI48_0_0RNGestureHandler *)gestureHandler;

@end

@implementation ABI48_0_0RNManualRecognizer {
...
@implementation ABI48_0_0RNManualGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI48_0_0RNManualRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
