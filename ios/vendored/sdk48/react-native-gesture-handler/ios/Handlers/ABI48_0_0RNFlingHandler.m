#import "ABI48_0_0RNFlingHandler.h"

@interface ABI48_0_0RNBetterSwipeGestureRecognizer : UISwipeGestureRecognizer

- (id)initWithGestureHandler:(ABI48_0_0RNGestureHandler *)gestureHandler;

@end

@implementation ABI48_0_0RNBetterSwipeGestureRecognizer {
...
@implementation ABI48_0_0RNFlingGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI48_0_0RNBetterSwipeGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
- (void)resetConfig
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.direction = [ABI48_0_0RCTConvert NSInteger:prop];
  }

#if !TARGET_OS_TV
  prop = config[@"numberOfPointers"];
  if (prop != nil) {
    recognizer.numberOfTouchesRequired = [ABI48_0_0RCTConvert NSInteger:prop];
  }
#endif
}
...
- (ABI48_0_0RNGestureHandlerEventExtraData *)eventExtraData:(id)_recognizer
{
  ...
  ABI48_0_0RNBetterSwipeGestureRecognizer *recognizer = (ABI48_0_0RNBetterSwipeGestureRecognizer *)_recognizer;
  ...
  return [ABI48_0_0RNGestureHandlerEventExtraData
