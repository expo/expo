#import "ABI48_0_0RNForceTouchHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI48_0_0React/ABI48_0_0RCTConvert.h>

@interface ABI48_0_0RNForceTouchGestureRecognizer : UIGestureRecognizer
...
@implementation ABI48_0_0RNForceTouchGestureRecognizer {
...
@implementation ABI48_0_0RNForceTouchHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI48_0_0RNForceTouchGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
{
  [super resetConfig];
  ABI48_0_0RNForceTouchGestureRecognizer *recognizer = (ABI48_0_0RNForceTouchGestureRecognizer *)_recognizer;
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.feedbackOnActivation = [ABI48_0_0RCTConvert BOOL:prop];
  }
}

- (ABI48_0_0RNGestureHandlerEventExtraData *)eventExtraData:(ABI48_0_0RNForceTouchGestureRecognizer *)recognizer
{
  return [ABI48_0_0RNGestureHandlerEventExtraData forForce:recognizer.force
