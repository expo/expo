...
#import "ABI48_0_0RNTapHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI48_0_0React/ABI48_0_0RCTConvert.h>

// ABI48_0_0RNBetterTapGestureRecognizer extends UIGestureRecognizer instead of UITapGestureRecognizer
...
@interface ABI48_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
@implementation ABI48_0_0RNBetterTapGestureRecognizer {
...
@implementation ABI48_0_0RNTapGestureHandler {
  ABI48_0_0RNGestureHandlerEventExtraData *_lastData;
}

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI48_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
{
  [super resetConfig];
  ABI48_0_0RNBetterTapGestureRecognizer *recognizer = (ABI48_0_0RNBetterTapGestureRecognizer *)_recognizer;
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.maxDelay = [ABI48_0_0RCTConvert CGFloat:prop] / 1000.0;
  }

  prop = config[@"maxDurationMs"];
  if (prop != nil) {
    recognizer.maxDuration = [ABI48_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
  ...
  // in ABI48_0_0RNGestureHandler it resets _lastSatate variable, making is seem like handler
