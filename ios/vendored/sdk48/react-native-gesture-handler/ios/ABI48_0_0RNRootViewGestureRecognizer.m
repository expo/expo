//
//  ABI48_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI48_0_0RNRootViewGestureRecognizer {
  BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
  ...
  ABI48_0_0RNGestureHandler *otherHandler = [ABI48_0_0RNGestureHandler findGestureHandlerByRecognizer:otherGestureRecognizer];
...
#ifdef ABI48_0_0RN_FABRIC_ENABLED
        ABI48_0_0RCTSurfaceTouchHandler
#else
        ABI48_0_0RCTTouchHandler
#endif
        class]];
}
