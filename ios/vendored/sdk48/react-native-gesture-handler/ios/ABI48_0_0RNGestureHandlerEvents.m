...
@implementation ABI48_0_0RNGestureHandlerEventExtraData
...
{
  return [[ABI48_0_0RNGestureHandlerEventExtraData alloc] initWithData:@{
    @"x" : @(position.x),
    @"y" : @(position.y),
                             ...
                             withNumberOfTouches:(NSUInteger)numberOfTouches
{
  if (changedPointers == nil || allPointers == nil) {
    changedPointers = @[];
    allPointers = @[];
    eventType = ABI48_0_0RNGHTouchEventTypeUndetermined;
  }
...
{
  return [[ABI48_0_0RNGestureHandlerEventExtraData alloc] initWithData:@{@"pointerInside" : @(pointerInside)}];
}

@end

@implementation ABI48_0_0RNGestureHandlerEvent {
  NSNumber *_handlerTag;
  ABI48_0_0RNGestureHandlerState _state;
  ABI48_0_0RNGestureHandlerEventExtraData *_extraData;
}
...
@implementation ABI48_0_0RNGestureHandlerStateChange {
  NSNumber *_handlerTag;
  ABI48_0_0RNGestureHandlerState _state;
  ABI48_0_0RNGestureHandlerState _prevState;
  ABI48_0_0RNGestureHandlerEventExtraData *_extraData;
}
