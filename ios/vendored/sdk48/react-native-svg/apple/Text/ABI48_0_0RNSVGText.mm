...
@implementation ABI48_0_0RNSVGText {
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI48_0_0RNSVGTextProps>();
    _props = defaultProps;
  }
  return self;
}
...
{
  return concreteComponentDescriptorProvider<ABI48_0_0RNSVGTextComponentDescriptor>();
}

- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  const auto &newProps = *std::static_pointer_cast<const ABI48_0_0RNSVGTextProps>(props);

  setCommonTextProps(newProps, self);
  _props = std::static_pointer_cast<ABI48_0_0RNSVGTextProps const>(props);
}
...
- (void)setInlineSize:(ABI48_0_0RNSVGLength *)inlineSize
{
...
- (void)setTextLength:(ABI48_0_0RNSVGLength *)textLength
{
...
- (void)setDeltaX:(NSArray<ABI48_0_0RNSVGLength *> *)deltaX
{
  if (deltaX == _deltaX) {
    return;
  }
...
- (void)setDeltaY:(NSArray<ABI48_0_0RNSVGLength *> *)deltaY
{
  if (deltaY == _deltaY) {
    return;
  }
...
- (void)setPositionX:(NSArray<ABI48_0_0RNSVGLength *> *)positionX
{
...
- (void)setPositionY:(NSArray<ABI48_0_0RNSVGLength *> *)positionY
{
...
- (void)setRotate:(NSArray<ABI48_0_0RNSVGLength *> *)rotate
{
  if (rotate == _rotate) {
    return;
  }
...
- (void)setupGlyphContext:(CGContextRef)context
{
  ...
  _glyphContext = [[ABI48_0_0RNSVGGlyphContext alloc] initWithWidth:size.width height:size.height];
}
...
- (ABI48_0_0RNSVGText *)textRoot
{
  ABI48_0_0RNSVGText *root = self;
  while (root && [root class] != [ABI48_0_0RNSVGText class]) {
    if (![root isKindOfClass:[ABI48_0_0RNSVGText class]]) {
      // todo: throw exception here
      break;
    }
    root = (ABI48_0_0RNSVGText *)[root superview];
  }
...
- (NSString *)alignmentBaseline
{
  ...
  ABI48_0_0RNSVGPlatformView *parent = self.superview;
  while (parent != nil) {
    if ([parent isKindOfClass:[ABI48_0_0RNSVGText class]]) {
      ABI48_0_0RNSVGText *node = (ABI48_0_0RNSVGText *)parent;
  ...
  if (_alignmentBaseline == nil) {
    _alignmentBaseline = ABI48_0_0RNSVGAlignmentBaselineStrings[0];
  }
  return _alignmentBaseline;
}
...
- (ABI48_0_0RNSVGText *)getTextAnchorRoot
{
  ...
  ABI48_0_0RNSVGText *node = self;
  ABI48_0_0RNSVGPlatformView *parent = [self superview];
  for (NSInteger i = [font count] - 1; i >= 0; i--) {
    ABI48_0_0RNSVGFontData *fontData = [font objectAtIndex:i];
    if (![parent isKindOfClass:[ABI48_0_0RNSVGText class]] || fontData->textAnchor == ABI48_0_0RNSVGTextAnchorStart ||
        node.positionX != nil) {
      return node;
    }
    node = (ABI48_0_0RNSVGText *)parent;
...
#ifdef RN_FABRIC_ENABLED
Class<ABI48_0_0RCTComponentViewProtocol> ABI48_0_0RNSVGTextCls(void)
{
  return ABI48_0_0RNSVGText.class;
}
#endif // RN_FABRIC_ENABLED
