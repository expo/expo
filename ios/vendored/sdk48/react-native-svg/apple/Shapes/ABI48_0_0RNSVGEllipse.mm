...
@implementation ABI48_0_0RNSVGEllipse
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI48_0_0RNSVGEllipseProps>();
    _props = defaultProps;
  }
  return self;
}
...
{
  return concreteComponentDescriptorProvider<ABI48_0_0RNSVGEllipseComponentDescriptor>();
}

- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  const auto &newProps = *std::static_pointer_cast<const ABI48_0_0RNSVGEllipseProps>(props);
  ...
  _props = std::static_pointer_cast<ABI48_0_0RNSVGEllipseProps const>(props);
}
...
#ifdef RN_FABRIC_ENABLED
Class<ABI48_0_0RCTComponentViewProtocol> ABI48_0_0RNSVGEllipseCls(void)
{
  return ABI48_0_0RNSVGEllipse.class;
}
#endif // RN_FABRIC_ENABLED
