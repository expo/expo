...
#import "ABI48_0_0RNSVGGroupManager.h"
#import "ABI48_0_0RNSVGCGFCRule.h"
#import "ABI48_0_0RNSVGGroup.h"

@implementation ABI48_0_0RNSVGGroupManager

ABI48_0_0RCT_EXPORT_MODULE()

- (ABI48_0_0RNSVGNode *)node
{
  return [ABI48_0_0RNSVGGroup new];
}

ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(font, NSDictionary)

ABI48_0_0RCT_CUSTOM_VIEW_PROPERTY(fontSize, id, ABI48_0_0RNSVGGroup)
{
...
ABI48_0_0RCT_CUSTOM_VIEW_PROPERTY(fontWeight, id, ABI48_0_0RNSVGGroup)
{
  if ([json isKindOfClass:[NSString class]]) {
    NSString *stringValue = (NSString *)json;
