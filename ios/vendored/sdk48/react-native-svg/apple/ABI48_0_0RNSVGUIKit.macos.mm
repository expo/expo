...
@implementation ABI48_0_0RNSVGView {
  NSColor *_tintColor;
}
...
- (NSColor *)tintColor
{
  ...
  // (b) we reach a view that isn't an ABI48_0_0RNSVGView
  NSView *parentView = [self superview];
  if ([parentView isKindOfClass:[ABI48_0_0RNSVGView class]]) {
    return [(ABI48_0_0RNSVGView *)parentView tintColor];
  } else {
...
@implementation NSImage (ABI48_0_0RNSVGMacOSExtensions)
...
@implementation NSValue (ABI48_0_0RNSVGMacOSExtensions)
