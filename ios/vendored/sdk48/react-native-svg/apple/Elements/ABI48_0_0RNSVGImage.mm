...
#if __has_include(<ABI48_0_0React/ABI48_0_0RCTImageLoader.h>)
...
#import <react/renderer/imagemanager/ABI48_0_0RCTImagePrimitivesConversions.h>
#import "ABI48_0_0RNSVGFabricConversions.h"

// Some RN private method hacking below similar to how it is done in ABI48_0_0RNScreens:
// https://github.com/software-mansion/react-native-screens/blob/90e548739f35b5ded2524a9d6410033fc233f586/ios/ABI48_0_0RNSScreenStackHeaderConfig.mm#L30
@interface ABI48_0_0RCTBridge (Private)
+ (ABI48_0_0RCTBridge *)currentBridge;
@end

#endif // RN_FABRIC_ENABLED

@implementation ABI48_0_0RNSVGImage {
  CGImageRef _image;
  CGSize _imageSize;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI48_0_0RNSVGImageProps>();
    _props = defaultProps;
  }
  return self;
}
...
{
  return concreteComponentDescriptorProvider<ABI48_0_0RNSVGImageComponentDescriptor>();
}

- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  const auto &newProps = *std::static_pointer_cast<const ABI48_0_0RNSVGImageProps>(props);
  const auto &oldImageProps = *std::static_pointer_cast<const ABI48_0_0RNSVGImageProps>(oldProps);
  ...
  if (ABI48_0_0RCTNSStringFromStringNilIfEmpty(newProps.height)) {
    self.imageheight = [ABI48_0_0RNSVGLength lengthWithString:ABI48_0_0RCTNSStringFromString(newProps.height)];
  }
  if (ABI48_0_0RCTNSStringFromStringNilIfEmpty(newProps.width)) {
    self.imagewidth = [ABI48_0_0RNSVGLength lengthWithString:ABI48_0_0RCTNSStringFromString(newProps.width)];
  }
  ...
  if (oldProps == nullptr || oldImageProps.src != newProps.src) {
    ...
    CGSize size = ABI48_0_0RCTCGSizeFromSize(newProps.src.size);
  ...
  _props = std::static_pointer_cast<ABI48_0_0RNSVGImageProps const>(props);
}
...
- (void)setImageSrc:(ABI48_0_0RCTImageSource *)src request:(NSURLRequest *)request
{
  if (src == _src) {
    return;
  }
  ...
  ABI48_0_0RCTImageLoaderCancellationBlock previousCancellationBlock = _reloadImageCancellationBlock;
...
- (void)setSrc:(ABI48_0_0RCTImageSource *)src
{
...
- (void)setImagewidth:(ABI48_0_0RNSVGLength *)width
{
...
- (void)setImageheight:(ABI48_0_0RNSVGLength *)height
{
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
  ...
  CGAffineTransform viewbox = [ABI48_0_0RNSVGViewBox getTransform:imageBounds
                                                   eRect:hitArea
                                                   align:self.align
...
#ifdef RN_FABRIC_ENABLED
Class<ABI48_0_0RCTComponentViewProtocol> ABI48_0_0RNSVGImageCls(void)
{
  return ABI48_0_0RNSVGImage.class;
}
#endif // RN_FABRIC_ENABLED
