...
@implementation ABI48_0_0RNSVGMarker
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI48_0_0RNSVGMarkerProps>();
    _props = defaultProps;
  }
  return self;
}
...
{
  return concreteComponentDescriptorProvider<ABI48_0_0RNSVGMarkerComponentDescriptor>();
}

- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  const auto &newProps = *std::static_pointer_cast<const ABI48_0_0RNSVGMarkerProps>(props);

  self.refX = [ABI48_0_0RNSVGLength lengthWithString:ABI48_0_0RCTNSStringFromString(newProps.refX)];
  self.refY = [ABI48_0_0RNSVGLength lengthWithString:ABI48_0_0RCTNSStringFromString(newProps.refY)];
  self.markerHeight = [ABI48_0_0RNSVGLength lengthWithString:ABI48_0_0RCTNSStringFromString(newProps.markerHeight)];
  self.markerWidth = [ABI48_0_0RNSVGLength lengthWithString:ABI48_0_0RCTNSStringFromString(newProps.markerWidth)];
  self.markerUnits = ABI48_0_0RCTNSStringFromStringNilIfEmpty(newProps.markerUnits);
  self.orient = ABI48_0_0RCTNSStringFromStringNilIfEmpty(newProps.orient);
  ...
  _props = std::static_pointer_cast<ABI48_0_0RNSVGMarkerProps const>(props);
}
...
- (void)setX:(ABI48_0_0RNSVGLength *)refX
{
...
- (void)setY:(ABI48_0_0RNSVGLength *)refY
{
...
- (void)setMarkerWidth:(ABI48_0_0RNSVGLength *)markerWidth
{
...
- (void)setMarkerHeight:(ABI48_0_0RNSVGLength *)markerHeight
{
...
static CGFloat ABI48_0_0RNSVG_degToRad = (CGFloat)M_PI / 180;

double ABI48_0_0deg2rad(CGFloat deg)
{
  return deg * ABI48_0_0RNSVG_degToRad;
}
         ...
         strokeWidth:(CGFloat)strokeWidth
{
  ...
  float rad = ABI48_0_0deg2rad(angle);
...
#ifdef RN_FABRIC_ENABLED
Class<ABI48_0_0RCTComponentViewProtocol> ABI48_0_0RNSVGMarkerCls(void)
{
  return ABI48_0_0RNSVGMarker.class;
}
#endif // RN_FABRIC_ENABLED
