...
@implementation ABI48_0_0RNSVGContextBrush {
  BOOL _isStroke;
}
...
{
  ABI48_0_0RNSVGRenderable *element = ABI48_0_0RNSVGRenderable.contextElement;
  if (!element) {
    return NO;
  }

  ABI48_0_0RNSVGBrush *brush = _isStroke ? element.stroke : element.fill;

  BOOL fillColor;

  if (brush.class == ABI48_0_0RNSVGBrush.class) {
