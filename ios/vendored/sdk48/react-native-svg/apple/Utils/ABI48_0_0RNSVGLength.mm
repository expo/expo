...
@implementation ABI48_0_0RNSVGLength
...
{
  ABI48_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype)lengthWithString:(NSString *)lengthString
{
  ...
  ABI48_0_0RNSVGLength *output = [ABI48_0_0RNSVGLength alloc];
  if (stringLength == 0) {
    ...
    ABI48_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
