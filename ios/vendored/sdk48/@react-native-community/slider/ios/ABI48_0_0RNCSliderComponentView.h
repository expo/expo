...
typedef void (^ABI48_0_0RNCLoadImageCompletionBlock)(NSError * _Nullable error, UIImage * _Nullable image);
typedef void (^ABI48_0_0RNCLoadImageFailureBlock)();

@interface ABI48_0_0RNCSliderComponentView : ABI48_0_0RCTViewComponentView
