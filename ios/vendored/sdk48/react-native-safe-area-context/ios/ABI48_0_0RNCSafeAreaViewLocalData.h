...
@interface ABI48_0_0RNCSafeAreaViewLocalData : NSObject
...
@property (atomic, readonly) ABI48_0_0RNCSafeAreaViewMode mode;
@property (atomic, readonly) ABI48_0_0RNCSafeAreaViewEdges edges;
