//
//  ABI49_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI49_0_0RNRootViewGestureRecognizer {
  BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
  ...
  ABI49_0_0RNGestureHandler *otherHandler = [ABI49_0_0RNGestureHandler findGestureHandlerByRecognizer:otherGestureRecognizer];
...
#ifdef ABI49_0_0RCT_NEW_ARCH_ENABLED
        ABI49_0_0RCTSurfaceTouchHandler
#else
        ABI49_0_0RCTTouchHandler
#endif
        class]];
}
