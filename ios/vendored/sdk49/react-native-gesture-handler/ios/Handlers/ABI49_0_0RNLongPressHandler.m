...
#import "ABI49_0_0RNLongPressHandler.h"
...
@interface ABI49_0_0RNBetterLongPressGestureRecognizer : UILongPressGestureRecognizer {
  uint64_t startTime;
...
@implementation ABI49_0_0RNBetterLongPressGestureRecognizer {
...
@implementation ABI49_0_0RNLongPressGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI49_0_0RNBetterLongPressGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.minimumPressDuration = [ABI49_0_0RCTConvert CGFloat:prop] / 1000.0;
  }

  prop = config[@"maxDist"];
  if (prop != nil) {
    recognizer.allowableMovement = [ABI49_0_0RCTConvert CGFloat:prop];
  }
}
...
- (ABI49_0_0RNGestureHandlerState)state
{
  ...
  if (_recognizer.state == UIGestureRecognizerStateBegan) {
    return ABI49_0_0RNGestureHandlerStateActive;
  }
  return [super state];
}
...
{
  return [ABI49_0_0RNGestureHandlerEventExtraData forPosition:[recognizer locationInView:recognizer.view]
                                withAbsolutePosition:[recognizer locationInView:recognizer.view.window]
                                 withNumberOfTouches:recognizer.numberOfTouches
                                        withDuration:[(ABI49_0_0RNBetterLongPressGestureRecognizer *)recognizer getDuration]];
}
@end
