//
//  ABI49_0_0RNNativeViewHandler.m
...
#import "ABI49_0_0RNNativeViewHandler.h"
...
#pragma mark ABI49_0_0RNDummyGestureRecognizer

@implementation ABI49_0_0RNDummyGestureRecognizer {
...
#pragma mark ABI49_0_0RNNativeViewgestureHandler

@implementation ABI49_0_0RNNativeViewGestureHandler {
...
- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI49_0_0RNDummyGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  _shouldActivateOnStart = [ABI49_0_0RCTConvert BOOL:config[@"shouldActivateOnStart"]];
  _disallowInterruption = [ABI49_0_0RCTConvert BOOL:config[@"disallowInterruption"]];
}
...
- (void)bindToView:(UIView *)view
{
  ...
  // is set
#ifdef ABI49_0_0RCT_NEW_ARCH_ENABLED
  if ([view isKindOfClass:[ABI49_0_0RCTScrollViewComponentView class]]) {
    UIScrollView *scrollView = ((ABI49_0_0RCTScrollViewComponentView *)view).scrollView;
    scrollView.delaysContentTouches = YES;
  }
#else
  if ([view isKindOfClass:[ABI49_0_0RCTScrollView class]]) {
    // This part of the code is coupled with RN implementation of ScrollView native wrapper and
    // we expect for ABI49_0_0RCTScrollView component to contain a subclass of UIScrollview as the only
    // subview
...
- (void)handleTouchDown:(UIView *)sender forEvent:(UIEvent *)event
{
  ...
  [self sendEventsInState:ABI49_0_0RNGestureHandlerStateActive
           forViewWithTag:sender.ABI49_0_0ReactTag
            withExtraData:[ABI49_0_0RNGestureHandlerEventExtraData forPointerInside:YES]];
}

- (void)handleTouchUpOutside:(UIView *)sender forEvent:(UIEvent *)event
{
  [self sendEventsInState:ABI49_0_0RNGestureHandlerStateEnd
           forViewWithTag:sender.ABI49_0_0ReactTag
            withExtraData:[ABI49_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
...
{
  [self sendEventsInState:ABI49_0_0RNGestureHandlerStateCancelled
           forViewWithTag:sender.ABI49_0_0ReactTag
            withExtraData:[ABI49_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
