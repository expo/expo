#import "ABI49_0_0RNManualHandler.h"

@interface ABI49_0_0RNManualRecognizer : UIGestureRecognizer

- (id)initWithGestureHandler:(ABI49_0_0RNGestureHandler *)gestureHandler;

@end

@implementation ABI49_0_0RNManualRecognizer {
...
@implementation ABI49_0_0RNManualGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI49_0_0RNManualRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
