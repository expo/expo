...
#import "ABI49_0_0RNTapHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI49_0_0React/ABI49_0_0RCTConvert.h>

// ABI49_0_0RNBetterTapGestureRecognizer extends UIGestureRecognizer instead of UITapGestureRecognizer
...
@interface ABI49_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
@implementation ABI49_0_0RNBetterTapGestureRecognizer {
...
@implementation ABI49_0_0RNTapGestureHandler {
  ABI49_0_0RNGestureHandlerEventExtraData *_lastData;
}

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI49_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
{
  [super resetConfig];
  ABI49_0_0RNBetterTapGestureRecognizer *recognizer = (ABI49_0_0RNBetterTapGestureRecognizer *)_recognizer;
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.maxDelay = [ABI49_0_0RCTConvert CGFloat:prop] / 1000.0;
  }

  prop = config[@"maxDurationMs"];
  if (prop != nil) {
    recognizer.maxDuration = [ABI49_0_0RCTConvert CGFloat:prop] / 1000.0;
  }

  prop = config[@"maxDist"];
  if (prop != nil) {
    CGFloat dist = [ABI49_0_0RCTConvert CGFloat:prop];
    recognizer.maxDistSq = dist * dist;
  }
}

- (ABI49_0_0RNGestureHandlerEventExtraData *)eventExtraData:(UIGestureRecognizer *)recognizer
{
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
  ...
  // in ABI49_0_0RNGestureHandler it resets _lastSatate variable, making is seem like handler
  ...
  ABI49_0_0RNGestureHandlerState savedState = _lastState;
