#import "ABI49_0_0RNForceTouchHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI49_0_0React/ABI49_0_0RCTConvert.h>

@interface ABI49_0_0RNForceTouchGestureRecognizer : UIGestureRecognizer
...
@implementation ABI49_0_0RNForceTouchGestureRecognizer {
...
@implementation ABI49_0_0RNForceTouchHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI49_0_0RNForceTouchGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
{
  [super resetConfig];
  ABI49_0_0RNForceTouchGestureRecognizer *recognizer = (ABI49_0_0RNForceTouchGestureRecognizer *)_recognizer;
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.feedbackOnActivation = [ABI49_0_0RCTConvert BOOL:prop];
  }
}

- (ABI49_0_0RNGestureHandlerEventExtraData *)eventExtraData:(ABI49_0_0RNForceTouchGestureRecognizer *)recognizer
{
  return [ABI49_0_0RNGestureHandlerEventExtraData forForce:recognizer.force
