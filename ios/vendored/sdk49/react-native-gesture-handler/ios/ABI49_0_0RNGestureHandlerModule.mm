#import "ABI49_0_0RNGestureHandlerModule.h"
...
#import <ABI49_0_0ReactCommon/CallInvoker.h>
...
#import "ABI49_0_0RNGestureHandlerStateManager.h"
...
#ifdef ABI49_0_0RCT_NEW_ARCH_ENABLED
@interface ABI49_0_0RNGestureHandlerModule () <ABI49_0_0RCTSurfacePresenterObserver, ABI49_0_0RNGestureHandlerStateManager>

@end
#else
@interface ABI49_0_0RNGestureHandlerModule () <ABI49_0_0RCTUIManagerObserver, ABI49_0_0RNGestureHandlerStateManager>

@end
#endif // ABI49_0_0RCT_NEW_ARCH_ENABLED

typedef void (^GestureHandlerOperation)(ABI49_0_0RNGestureHandlerManager *manager);

@implementation ABI49_0_0RNGestureHandlerModule {
  ABI49_0_0RNGestureHandlerManager *_manager;
...
- (void)invalidate
{
  ABI49_0_0RNGestureHandlerManager *handlerManager = _manager;
...
- (void)setBridge:(ABI49_0_0RCTBridge *)bridge
{
  ...
  _manager = [[ABI49_0_0RNGestureHandlerManager alloc] initWithUIManager:bridge.uiManager
...
{
  ABI49_0_0RCTCxxBridge *cxxBridge = (ABI49_0_0RCTCxxBridge *)self.bridge;
...
ABI49_0_0RCT_EXPORT_METHOD(createGestureHandler
                  : (nonnull NSString *)handlerName tag
                  : (nonnull NSNumber *)handlerTag config
                  : (NSDictionary *)config)
{
  [self addOperationBlock:^(ABI49_0_0RNGestureHandlerManager *manager) {
    [manager createGestureHandler:handlerName tag:handlerTag config:config];
  }];
}

ABI49_0_0RCT_EXPORT_METHOD(attachGestureHandler
                  ...
                  : (nonnull NSNumber *)actionType)
{
  [self addOperationBlock:^(ABI49_0_0RNGestureHandlerManager *manager) {
    [manager attachGestureHandler:handlerTag
                   ...
                   withActionType:(ABI49_0_0RNGestureHandlerActionType)[actionType integerValue]];
  }];
}

ABI49_0_0RCT_EXPORT_METHOD(updateGestureHandler : (nonnull NSNumber *)handlerTag config : (NSDictionary *)config)
{
  [self addOperationBlock:^(ABI49_0_0RNGestureHandlerManager *manager) {
...
ABI49_0_0RCT_EXPORT_METHOD(dropGestureHandler : (nonnull NSNumber *)handlerTag)
{
  [self addOperationBlock:^(ABI49_0_0RNGestureHandlerManager *manager) {
...
ABI49_0_0RCT_EXPORT_METHOD(handleSetJSResponder
...
ABI49_0_0RCT_EXPORT_METHOD(handleClearJSResponder)
{
  [self addOperationBlock:^(ABI49_0_0RNGestureHandlerManager *manager) {
...
ABI49_0_0RCT_EXPORT_METHOD(flushOperations)
{
  ...
  [self.bridge.uiManager
      addUIBlock:^(__unused ABI49_0_0RCTUIManager *manager, __unused NSDictionary<NSNumber *, UIView *> *viewRegistry) {
...
{
  ABI49_0_0RNGestureHandler *handler = [_manager handlerWithTag:@(handlerTag)];
...
- (void)uiManagerWillFlushUIBlocks:(ABI49_0_0RCTUIManager *)uiManager
{
...
- (NSDictionary *)constantsToExport
{
  return @{
    @"State" : @{
      @"UNDETERMINED" : @(ABI49_0_0RNGestureHandlerStateUndetermined),
      @"BEGAN" : @(ABI49_0_0RNGestureHandlerStateBegan),
      @"ACTIVE" : @(ABI49_0_0RNGestureHandlerStateActive),
      @"CANCELLED" : @(ABI49_0_0RNGestureHandlerStateCancelled),
      @"FAILED" : @(ABI49_0_0RNGestureHandlerStateFailed),
      @"END" : @(ABI49_0_0RNGestureHandlerStateEnd)
    },
    @"Direction" : @{
      @"RIGHT" : @(ABI49_0_0RNGestureHandlerDirectionRight),
      @"LEFT" : @(ABI49_0_0RNGestureHandlerDirectionLeft),
      @"UP" : @(ABI49_0_0RNGestureHandlerDirectionUp),
      @"DOWN" : @(ABI49_0_0RNGestureHandlerDirectionDown)
    }
  };
}
