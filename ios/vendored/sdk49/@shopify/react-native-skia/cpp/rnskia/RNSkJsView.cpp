...
ABI49_0_0RNSkJsRenderer::ABI49_0_0RNSkJsRenderer(std::function<void()> requestRedraw,
                               std::shared_ptr<ABI49_0_0RNSkPlatformContext> context)
    : ABI49_0_0RNSkRenderer(requestRedraw),
      _jsiCanvas(std::make_shared<JsiSkCanvas>(context)),
      _platformContext(context),
      _infoObject(std::make_shared<ABI49_0_0RNSkInfoObject>()),
...
bool ABI49_0_0RNSkJsRenderer::tryRender(
...
void ABI49_0_0RNSkJsRenderer::renderImmediate(
    std::shared_ptr<ABI49_0_0RNSkCanvasProvider> canvasProvider) {
...
void ABI49_0_0RNSkJsRenderer::setDrawCallback(
    std::shared_ptr<jsi::Function> drawCallback) {
  _drawCallback = drawCallback;
}

std::shared_ptr<ABI49_0_0RNSkInfoObject> ABI49_0_0RNSkJsRenderer::getInfoObject() {
  return _infoObject;
}

void ABI49_0_0RNSkJsRenderer::performDraw(
    std::shared_ptr<ABI49_0_0RNSkCanvasProvider> canvasProvider) {
  // Start timing
...
void ABI49_0_0RNSkJsRenderer::callJsDrawCallback(std::shared_ptr<JsiSkCanvas> jsiCanvas,
...
void ABI49_0_0RNSkJsRenderer::drawInJsiCanvas(std::shared_ptr<JsiSkCanvas> jsiCanvas,
