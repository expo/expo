...
public:
   ...
   */
  JsiDomNode(std::shared_ptr<ABI49_0_0RNSkPlatformContext> context, const char *type,
             NodeClass nodeClass)
...
protected:
  ...
  */
  ...
  /**
   ...
   reconciler when properties are set due to changes in ABI49_0_0React.
   */
  ...
  void printDebugInfo(const std::string &message, size_t indentation = 0) {
    ABI49_0_0RNSkLogger::logToConsole("%s%s %lu: %s",
