...
/**
 ...
 started.
 */
class ABI49_0_0RNSkReadonlyValue
    : public JsiSkHostObject,
      public std::enable_shared_from_this<ABI49_0_0RNSkReadonlyValue> {
public:
  explicit ABI49_0_0RNSkReadonlyValue(
      std::shared_ptr<ABI49_0_0RNSkPlatformContext> platformContext)
      : JsiSkHostObject(platformContext),
        _valueHolder(std::make_shared<ABI49_0_0RNJsi::JsiValueWrapper>(
            *platformContext->getJsRuntime())) {}

  virtual ~ABI49_0_0RNSkReadonlyValue() { invalidate(); }
  ...
  JSI_EXPORT_PROPERTY_GETTERS(JSI_EXPORT_PROP_GET(ABI49_0_0RNSkReadonlyValue,
                                                  __typename__),
                              JSI_EXPORT_PROP_GET(ABI49_0_0RNSkReadonlyValue, current))
        ...
        addListener([weakSelf = weak_from_this(),
          ...
          if (self) {
            auto selfReadonlyValue =
                std::dynamic_pointer_cast<ABI49_0_0RNSkReadonlyValue>(self);
   ...
   */
  std::shared_ptr<ABI49_0_0RNJsi::JsiValueWrapper> getCurrent() { return _valueHolder; }
...
private:
  std::shared_ptr<ABI49_0_0RNJsi::JsiValueWrapper> _valueHolder;
