...
class ABI49_0_0RNSkPlatformContext {
public:
  /**
   * Constructor
   */
  ABI49_0_0RNSkPlatformContext(jsi::Runtime *runtime,
                      std::shared_ptr<ABI49_0_0React::CallInvoker> callInvoker,
                      float pixelDensity)
      : _pixelDensity(pixelDensity), _jsRuntime(runtime),
        _callInvoker(callInvoker),
        _dispatchQueue(
            std::make_unique<ABI49_0_0RNSkDispatchQueue>("skia-render-thread")) {
   ...
   * Destructor
   */
  virtual ~ABI49_0_0RNSkPlatformContext() { invalidate(); }
   ...
   * @param tag ABI49_0_0React view tag
   */
   ...
   * children.
   * @param viewTag ABI49_0_0React viewtag
...
private:
  ...
  std::shared_ptr<ABI49_0_0React::CallInvoker> _callInvoker;
  std::unique_ptr<ABI49_0_0RNSkDispatchQueue> _dispatchQueue;
