...
public:
  ...
  explicit JsiSkCanvas(std::shared_ptr<ABI49_0_0RNSkPlatformContext> context)
      : JsiSkHostObject(std::move(context)) {}

  JsiSkCanvas(std::shared_ptr<ABI49_0_0RNSkPlatformContext> context, SkCanvas *canvas)
