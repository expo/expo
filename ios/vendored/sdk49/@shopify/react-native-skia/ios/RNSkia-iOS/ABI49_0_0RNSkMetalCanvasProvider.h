...
#import "ABI49_0_0RNSkPlatformContext.h"
...
class ABI49_0_0RNSkMetalCanvasProvider : public ABI49_0_0RNSkia::ABI49_0_0RNSkCanvasProvider {
public:
  ABI49_0_0RNSkMetalCanvasProvider(std::function<void()> requestRedraw,
                          std::shared_ptr<ABI49_0_0RNSkia::ABI49_0_0RNSkPlatformContext> context);

  ~ABI49_0_0RNSkMetalCanvasProvider();
...
private:
  ...
  std::shared_ptr<ABI49_0_0RNSkia::ABI49_0_0RNSkPlatformContext> _context;
  float _width = -1;
  float _height = -1;
