#import "ABI49_0_0ViewScreenshotService.h"
...
@implementation ABI49_0_0ViewScreenshotService {
...
- (sk_sp<SkImage>)screenshotOfViewWithTag:(NSNumber *)viewTag {
  ...
  auto view = [_uiManager viewForABI49_0_0ReactTag:viewTag];
  if (view == NULL) {
    ABI49_0_0RCTFatal(ABI49_0_0RCTErrorWithMessage(@"Could not find view with tag"));
  }
