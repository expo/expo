...
ABI49_0_0RNSkMetalCanvasProvider::getMetalRenderContext() {
...
ABI49_0_0RNSkMetalCanvasProvider::ABI49_0_0RNSkMetalCanvasProvider(
    std::function<void()> requestRedraw,
    std::shared_ptr<ABI49_0_0RNSkia::ABI49_0_0RNSkPlatformContext> context)
    : ABI49_0_0RNSkCanvasProvider(requestRedraw), _context(context) {
#pragma clang diagnostic push
 ...
 */
float ABI49_0_0RNSkMetalCanvasProvider::getScaledWidth() {
 ...
 */
float ABI49_0_0RNSkMetalCanvasProvider::getScaledHeight() {
...
/**
 Render to a canvas
 */
bool ABI49_0_0RNSkMetalCanvasProvider::renderToCanvas(
  ...
  @autoreleasepool {
    ...
    if (skSurface == nullptr || skSurface->getCanvas() == nullptr) {
      ABI49_0_0RNSkia::ABI49_0_0RNSkLogger::logToConsole(
...
void ABI49_0_0RNSkMetalCanvasProvider::setSize(int width, int height) {
  _width = width;
  _height = height;
...
CALayer *ABI49_0_0RNSkMetalCanvasProvider::getLayer() { return _layer; }
