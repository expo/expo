...
@implementation ABI49_0_0SkiaPictureViewManager

ABI49_0_0RCT_EXPORT_MODULE(SkiaPictureView)
  ...
  return [[ABI49_0_0SkiaUIView alloc]
      initWithManager:skManager.get()
              factory:[](std::shared_ptr<ABI49_0_0RNSkia::ABI49_0_0RNSkPlatformContext> context) {
                return std::make_shared<ABI49_0_0RNSkiOSView<ABI49_0_0RNSkia::ABI49_0_0RNSkPictureView>>(
                    context);
              }];
}
