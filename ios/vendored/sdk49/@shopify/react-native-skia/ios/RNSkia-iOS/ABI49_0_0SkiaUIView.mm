...
@implementation ABI49_0_0SkiaUIView {
  std::shared_ptr<ABI49_0_0RNSkBaseiOSView> _impl;
  ABI49_0_0RNSkia::ABI49_0_0RNSkManager *_manager;
  ABI49_0_0RNSkia::ABI49_0_0RNSkDrawingMode _drawingMode;
  std::function<std::shared_ptr<ABI49_0_0RNSkBaseiOSView>(
      std::shared_ptr<ABI49_0_0RNSkia::ABI49_0_0RNSkPlatformContext>)>
      _factory;
  bool _debugMode;
  size_t _nativeId;
}
...
- (instancetype)initWithManager:(ABI49_0_0RNSkia::ABI49_0_0RNSkManager *)manager
                        factory:
                            (std::function<std::shared_ptr<ABI49_0_0RNSkBaseiOSView>(
                                 std::shared_ptr<ABI49_0_0RNSkia::ABI49_0_0RNSkPlatformContext>)>)
                                factory {
  ...
  if (self) {
    ...
    _nativeId = 0;
    _debugMode = false;
    _drawingMode = ABI49_0_0RNSkia::ABI49_0_0RNSkDrawingMode::Default;
    _factory = factory;
...
- (void)setDrawingMode:(std::string)mode {
  _drawingMode = mode.compare("continuous") == 0
                     ? ABI49_0_0RNSkia::ABI49_0_0RNSkDrawingMode::Continuous
                     : ABI49_0_0RNSkia::ABI49_0_0RNSkDrawingMode::Default;
...
- (void)handleTouches:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
  if (event.type == UIEventTypeTouches) {
    std::vector<ABI49_0_0RNSkia::ABI49_0_0RNSkTouchInfo> nextTouches;
    for (UITouch *touch in touches) {
      auto position = [touch preciseLocationInView:self];
      ABI49_0_0RNSkia::ABI49_0_0RNSkTouchInfo nextTouch;
      ...
      case UITouchPhaseBegan:
        nextTouch.type = ABI49_0_0RNSkia::ABI49_0_0RNSkTouchInfo::TouchType::Start;
        break;
      case UITouchPhaseMoved:
        nextTouch.type = ABI49_0_0RNSkia::ABI49_0_0RNSkTouchInfo::TouchType::Active;
        break;
      case UITouchPhaseEnded:
        nextTouch.type = ABI49_0_0RNSkia::ABI49_0_0RNSkTouchInfo::TouchType::End;
        break;
      case UITouchPhaseCancelled:
        nextTouch.type = ABI49_0_0RNSkia::ABI49_0_0RNSkTouchInfo::TouchType::Cancelled;
        break;
      default:
        nextTouch.type = ABI49_0_0RNSkia::ABI49_0_0RNSkTouchInfo::TouchType::Active;
        break;
