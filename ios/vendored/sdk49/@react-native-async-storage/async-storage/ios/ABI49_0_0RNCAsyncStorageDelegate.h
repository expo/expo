...
typedef void (^ABI49_0_0RNCAsyncStorageResultCallback)(NSArray<id<NSObject>> *valuesOrErrors);

@protocol ABI49_0_0RNCAsyncStorageDelegate <NSObject>
 ...
 * @param block Block to call with result.
 */
- (void)valuesForKeys:(NSArray<NSString *> *)keys completion:(ABI49_0_0RNCAsyncStorageResultCallback)block;
