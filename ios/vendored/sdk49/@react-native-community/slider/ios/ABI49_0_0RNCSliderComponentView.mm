...
#import <react/renderer/components/ABI49_0_0RNCSlider/ComponentDescriptors.h>
#import <react/renderer/components/ABI49_0_0RNCSlider/EventEmitters.h>
#import <react/renderer/components/ABI49_0_0RNCSlider/Props.h>
#import <react/renderer/components/ABI49_0_0RNCSlider/ABI49_0_0RCTComponentViewHelpers.h>
...
@interface ABI49_0_0RNCSliderComponentView () <ABI49_0_0RCTRNCSliderViewProtocol>
...
{
    return concreteComponentDescriptorProvider<ABI49_0_0RNCSliderComponentDescriptor>();
}

- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        static const auto defaultProps = std::make_shared<const ABI49_0_0RNCSliderProps>();
        _props = defaultProps;
...
- (void)tapHandler:(UITapGestureRecognizer *)gesture {
    ...
    std::dynamic_pointer_cast<const ABI49_0_0RNCSliderEventEmitter>(_eventEmitter)
    ->onRNCSliderSlidingStart(ABI49_0_0RNCSliderEventEmitter::OnRNCSliderSlidingStart{.value = static_cast<Float>(slider.lastValue)});
    
    // Trigger onValueChange to address https://github.com/react-native-community/react-native-slider/issues/212
    std::dynamic_pointer_cast<const ABI49_0_0RNCSliderEventEmitter>(_eventEmitter)
    ->onRNCSliderValueChange(ABI49_0_0RNCSliderEventEmitter::OnRNCSliderValueChange{.value = static_cast<Float>(slider.value)});
    
    std::dynamic_pointer_cast<const ABI49_0_0RNCSliderEventEmitter>(_eventEmitter)
    ->onRNCSliderSlidingComplete(ABI49_0_0RNCSliderEventEmitter::OnRNCSliderSlidingComplete{.value = static_cast<Float>(slider.value)});
}
...
- (void)ABI49_0_0RNCSendSliderEvent:(ABI49_0_0RNCSlider *)sender withContinuous:(BOOL)continuous isSlidingStart:(BOOL)isSlidingStart
{
    ...
    if (continuous) {
        if (sender.lastValue != value)  {
            std::dynamic_pointer_cast<const ABI49_0_0RNCSliderEventEmitter>(_eventEmitter)
            ->onRNCSliderValueChange(ABI49_0_0RNCSliderEventEmitter::OnRNCSliderValueChange{.value = static_cast<Float>(value)});
        }
    } else {
        if (!isSlidingStart) {
            std::dynamic_pointer_cast<const ABI49_0_0RNCSliderEventEmitter>(_eventEmitter)
            ->onRNCSliderSlidingComplete(ABI49_0_0RNCSliderEventEmitter::OnRNCSliderSlidingComplete{.value = static_cast<Float>(value)});
        }
        if (isSlidingStart) {
            std::dynamic_pointer_cast<const ABI49_0_0RNCSliderEventEmitter>(_eventEmitter)
            ->onRNCSliderSlidingStart(ABI49_0_0RNCSliderEventEmitter::OnRNCSliderSlidingStart{.value = static_cast<Float>(value)});
        }
    }
...
{
    const auto &oldScreenProps = *std::static_pointer_cast<const ABI49_0_0RNCSliderProps>(_props);
    const auto &newScreenProps = *std::static_pointer_cast<const ABI49_0_0RNCSliderProps>(props);
...
Class<ABI49_0_0RCTComponentViewProtocol> ABI49_0_0RNCSliderCls(void)
{
