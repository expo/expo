...
@implementation ABI49_0_0REASnapshot

static const int ScreenStackPresentationModal = 1; // ABI49_0_0RNSScreenStackPresentationModal
...
- (void)makeSnapshotForView:(UIView *)view useAbsolutePositionOnly:(BOOL)useAbsolutePositionOnly
{
  ...
  if (useAbsolutePositionOnly) {
    ...
    UIView *navigationContainer = view.ABI49_0_0ReactViewController.navigationController.view;
    ...
    if (header != nil) {
      ...
      if ([ABI49_0_0REAScreensHelper isScreenModal:screen] && screen.superview == nil) {
        int additionalModalOffset = 0;
        UIView *screenWrapper = [ABI49_0_0REAScreensHelper getScreenWrapper:view];
        int screenType = [ABI49_0_0REAScreensHelper getScreenType:screenWrapper];
  ...
  do {
    ...
    isTransformed = transform.a != 1 || transform.b != 0 || transform.c != 0 || transform.d != 1 || transform.tx != 0 ||
        transform.ty != 0;
           ...
           && ![ABI49_0_0REAScreensHelper isRNSScreenType:transformedView]);
