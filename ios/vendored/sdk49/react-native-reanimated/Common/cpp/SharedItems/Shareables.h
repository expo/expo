...
class JSRuntimeHelper {
 private:
  jsi::Runtime *rnRuntime_; // ABI49_0_0React-Native's main JS runtime
 ...
 public:
  ...
  inline void runOnUIGuarded(const jsi::Value &function, Args &&...args) {
    ...
    // JavaScript and propagating them to the main ABI49_0_0React Native thread such that
 ...
 public:
  ...
  ~RetainingShareable() {
    if (runtimeHelper_->uiRuntimeDestroyed) {
      ...
      // This scenario can only occur when the ABI49_0_0React instance is torn down which
