...
#endif
{
  ...
  auto scheduleOnJS = [this](
    ...
    auto shareableRemoteFun = extractShareableOrThrow<ShareableRemoteFunction>(
        rt,
        remoteFun,
        "Incompatible object passed to scheduleOnJS. It is only allowed to schedule functions defined on the ABI49_0_0React Native JS runtime this way.");
        ...
        [&](RootShadowNode const &oldRootShadowNode) {
          ...
          for (const auto &pair : copiedOperationsQueue) {
            ...
            if (newRootNode == nullptr) {
              // this happens when ABI49_0_0React removed the component but Reanimated
...
jsi::Value NativeReanimatedModule::measure(
  ...
  if (layoutMetrics == EmptyLayoutMetrics) {
    // Originally, in this case ABI49_0_0React Native returns `{0, 0, 0, 0, 0, 0}`, most
  ...
  ABI49_0_0facebook::ABI49_0_0React::Point originRelativeToParent =
      layoutableShadowNode != nullptr
      ? layoutableShadowNode->getLayoutMetrics().frame.origin
      : ABI49_0_0facebook::ABI49_0_0React::Point();
