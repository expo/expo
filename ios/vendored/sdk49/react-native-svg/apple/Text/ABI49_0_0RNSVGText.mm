...
@implementation ABI49_0_0RNSVGText {
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI49_0_0RNSVGTextProps>();
    _props = defaultProps;
  }
  return self;
}
...
{
  return concreteComponentDescriptorProvider<ABI49_0_0RNSVGTextComponentDescriptor>();
}

- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  const auto &newProps = *std::static_pointer_cast<const ABI49_0_0RNSVGTextProps>(props);

  setCommonTextProps(newProps, self);
  _props = std::static_pointer_cast<ABI49_0_0RNSVGTextProps const>(props);
}
...
- (void)setInlineSize:(ABI49_0_0RNSVGLength *)inlineSize
{
...
- (void)setTextLength:(ABI49_0_0RNSVGLength *)textLength
{
...
- (void)setDeltaX:(NSArray<ABI49_0_0RNSVGLength *> *)deltaX
{
  if (deltaX == _deltaX) {
    return;
  }
...
- (void)setDeltaY:(NSArray<ABI49_0_0RNSVGLength *> *)deltaY
{
  if (deltaY == _deltaY) {
    return;
  }
...
- (void)setPositionX:(NSArray<ABI49_0_0RNSVGLength *> *)positionX
{
...
- (void)setPositionY:(NSArray<ABI49_0_0RNSVGLength *> *)positionY
{
...
- (void)setRotate:(NSArray<ABI49_0_0RNSVGLength *> *)rotate
{
  if (rotate == _rotate) {
    return;
  }
...
- (void)setupGlyphContext:(CGContextRef)context
{
  ...
  _glyphContext = [[ABI49_0_0RNSVGGlyphContext alloc] initWithWidth:size.width height:size.height];
}
...
- (ABI49_0_0RNSVGText *)textRoot
{
  ABI49_0_0RNSVGText *root = self;
  while (root && [root class] != [ABI49_0_0RNSVGText class]) {
    if (![root isKindOfClass:[ABI49_0_0RNSVGText class]]) {
      // todo: throw exception here
      break;
    }
    root = (ABI49_0_0RNSVGText *)[root superview];
  }
...
- (NSString *)alignmentBaseline
{
  ...
  while (parent != nil) {
    if ([parent isKindOfClass:[ABI49_0_0RNSVGText class]]) {
      ABI49_0_0RNSVGText *node = (ABI49_0_0RNSVGText *)parent;
  ...
  if (_alignmentBaseline == nil) {
    _alignmentBaseline = ABI49_0_0RNSVGAlignmentBaselineStrings[0];
  }
  return _alignmentBaseline;
}
...
{
  ABI49_0_0RNSVGGlyphContext *gc = [self.textRoot getGlyphContext];
  NSArray *font = [gc getFontContext];
  ABI49_0_0RNSVGText *node = self;
  ABI49_0_0RNSVGPlatformView *parent = [self superview];
  for (NSInteger i = [font count] - 1; i >= 0; i--) {
    ABI49_0_0RNSVGFontData *fontData = [font objectAtIndex:i];
    if (![parent isKindOfClass:[ABI49_0_0RNSVGText class]] || fontData->textAnchor == ABI49_0_0RNSVGTextAnchorStart ||
        node.positionX != nil) {
      return node;
    }
    node = (ABI49_0_0RNSVGText *)parent;
...
- (CGFloat)getSubtreeTextChunksTotalAdvance
{
  ...
  for (ABI49_0_0RNSVGView *node in self.subviews) {
    if ([node isKindOfClass:[ABI49_0_0RNSVGText class]]) {
      ABI49_0_0RNSVGText *text = (ABI49_0_0RNSVGText *)node;
...
#ifdef ABI49_0_0RCT_NEW_ARCH_ENABLED
Class<ABI49_0_0RCTComponentViewProtocol> ABI49_0_0RNSVGTextCls(void)
{
  return ABI49_0_0RNSVGText.class;
}
#endif // ABI49_0_0RCT_NEW_ARCH_ENABLED
