...
#import "ABI49_0_0RNSVGGroupManager.h"
#import "ABI49_0_0RNSVGCGFCRule.h"
#import "ABI49_0_0RNSVGGroup.h"

@implementation ABI49_0_0RNSVGGroupManager

ABI49_0_0RCT_EXPORT_MODULE()

- (ABI49_0_0RNSVGNode *)node
{
  return [ABI49_0_0RNSVGGroup new];
}

ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(font, NSDictionary)

ABI49_0_0RCT_CUSTOM_VIEW_PROPERTY(fontSize, id, ABI49_0_0RNSVGGroup)
{
...
ABI49_0_0RCT_CUSTOM_VIEW_PROPERTY(fontWeight, id, ABI49_0_0RNSVGGroup)
{
  if ([json isKindOfClass:[NSString class]]) {
    NSString *stringValue = (NSString *)json;
