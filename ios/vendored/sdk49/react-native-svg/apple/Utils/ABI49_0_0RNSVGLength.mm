...
@implementation ABI49_0_0RNSVGLength
...
{
  ABI49_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype)lengthWithString:(NSString *)lengthString
{
  ...
  ABI49_0_0RNSVGLength *output = [ABI49_0_0RNSVGLength alloc];
  if (stringLength == 0) {
    ...
    ABI49_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
