...
@implementation ABI49_0_0RNSVGSymbol
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI49_0_0RNSVGSymbolProps>();
    _props = defaultProps;
  }
  return self;
}
...
{
  return concreteComponentDescriptorProvider<ABI49_0_0RNSVGSymbolComponentDescriptor>();
}

- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  const auto &newProps = *std::static_pointer_cast<const ABI49_0_0RNSVGSymbolProps>(props);
  ...
  _props = std::static_pointer_cast<ABI49_0_0RNSVGSymbolProps const>(props);
}
...
#ifdef ABI49_0_0RCT_NEW_ARCH_ENABLED
Class<ABI49_0_0RCTComponentViewProtocol> ABI49_0_0RNSVGSymbolCls(void)
{
  return ABI49_0_0RNSVGSymbol.class;
}
#endif // ABI49_0_0RCT_NEW_ARCH_ENABLED
