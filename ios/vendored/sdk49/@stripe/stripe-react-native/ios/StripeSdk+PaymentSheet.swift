...
extension StripeSdk {
    internal func buildPaymentSheetConfiguration(params: NSDictionary, orderTrackingCallback: ABI49_0_0RCTResponseSenderBlock? = nil) -> (error: NSDictionary?, configuration: PaymentSheet.Configuration?) {
    ...
    internal func preparePaymentSheetInstance(params: NSDictionary, configuration: PaymentSheet.Configuration, resolve: @escaping ABI49_0_0RCTPromiseResolveBlock) {
    ...
    private func buildCustomerHandlersForPaymentSheet(applePayParams: NSDictionary, orderTrackingCallback: ABI49_0_0RCTResponseSenderBlock?) -> PaymentSheet.ApplePayConfiguration.Handlers? {
        ...
        return PaymentSheet.ApplePayConfiguration.Handlers(paymentRequestHandler: { request in
            do {
                ...
                ABI49_0_0RCTMakeAndLogError(error.localizedDescription, nil, nil)
            }
            return request
