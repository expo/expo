...
@objc(ABI49_0_0StripeSdk)
class StripeSdk: ABI49_0_0RCTEventEmitter, STPBankSelectionViewControllerDelegate, UIAdaptivePresentationControllerDelegate {
    ...
    var confirmPaymentResolver: ABI49_0_0RCTPromiseResolveBlock? = nil

    var applePayCompletionCallback: STPIntentClientSecretCompletionBlock? = nil
    var deprecatedApplePayRequestResolver: ABI49_0_0RCTPromiseResolveBlock? = nil
    var deprecatedApplePayRequestRejecter: ABI49_0_0RCTPromiseRejectBlock? = nil
    var deprecatedApplePayCompletionRejecter: ABI49_0_0RCTPromiseRejectBlock? = nil
    var deprecatedConfirmApplePayPaymentResolver: ABI49_0_0RCTPromiseResolveBlock? = nil
    
    var confirmApplePayResolver: ABI49_0_0RCTPromiseResolveBlock? = nil
    ...
    var createPlatformPayPaymentMethodResolver: ABI49_0_0RCTPromiseResolveBlock? = nil
    ...
    var shippingMethodUpdateJSCallback: ABI49_0_0RCTDirectEventBlock? = nil
    var shippingContactUpdateJSCallback: ABI49_0_0RCTDirectEventBlock? = nil
    var couponCodeEnteredJSCallback: ABI49_0_0RCTDirectEventBlock? = nil
    var platformPayOrderTrackingJSCallback: ABI49_0_0RCTDirectEventBlock? = nil
    ...
    func initialise(params: NSDictionary, resolver resolve: @escaping ABI49_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI49_0_0RCTPromiseRejectBlock) -> Void {
    ...
    func initPaymentSheet(params: NSDictionary, resolver resolve: @escaping ABI49_0_0RCTPromiseResolveBlock,
                          rejecter reject: @escaping ABI49_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func initPaymentSheetWithOrderTracking(params: NSDictionary, callback orderTrackingCallback: @escaping ABI49_0_0RCTResponseSenderBlock, resolver resolve: @escaping ABI49_0_0RCTPromiseResolveBlock,
                          rejecter reject: @escaping ABI49_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func confirmPaymentSheetPayment(resolver resolve: @escaping ABI49_0_0RCTPromiseResolveBlock,
                                    rejecter reject: @escaping ABI49_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func resetPaymentSheetCustomer(resolver resolve: @escaping ABI49_0_0RCTPromiseResolveBlock,
                                   rejecter reject: @escaping ABI49_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func presentPaymentSheet(options: NSDictionary,
                             resolver resolve: @escaping ABI49_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI49_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func createTokenForCVCUpdate(cvc: String?, resolver resolve: @escaping ABI49_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI49_0_0RCTPromiseRejectBlock) {
    ...
    func confirmSetupIntent (setupIntentClientSecret: String, params: NSDictionary,
                             options: NSDictionary, resolver resolve: @escaping ABI49_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI49_0_0RCTPromiseRejectBlock) {
    ...
    func updateApplePaySummaryItems(summaryItems: NSArray, errorAddressFields: [NSDictionary], resolver resolve: @escaping ABI49_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI49_0_0RCTPromiseRejectBlock) {
    ...
    func openApplePaySetup(resolver resolve: @escaping ABI49_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI49_0_0RCTPromiseRejectBlock) -> Void {
        PKPassLibrary.init().openPaymentSetup()
        resolve([])
    }

    @objc(confirmApplePayPayment:resolver:rejecter:)
    func confirmApplePayPayment(clientSecret: String, resolver resolve: @escaping ABI49_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI49_0_0RCTPromiseRejectBlock) {
    ...
    func isApplePaySupported(resolver resolve: @escaping ABI49_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI49_0_0RCTPromiseRejectBlock) {
    ...
    func handleURLCallback(url: String?, resolver resolve: @escaping ABI49_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI49_0_0RCTPromiseRejectBlock) {
    ...
    func dismissPlatformPay(resolver resolve: @escaping ABI49_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI49_0_0RCTPromiseRejectBlock) -> Void {
