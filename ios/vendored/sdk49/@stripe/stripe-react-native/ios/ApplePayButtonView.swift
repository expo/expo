...
@objc(ABI49_0_0ApplePayButtonView)
class ApplePayButtonView: UIView {
    var applePayButton: PKPaymentButton?
    var stripeSdk: StripeSdk?
    
    @objc var onPressAction: ABI49_0_0RCTDirectEventBlock?
    @objc var onShippingMethodSelectedAction: ABI49_0_0RCTDirectEventBlock?
    @objc var onShippingContactSelectedAction: ABI49_0_0RCTDirectEventBlock?
    @objc var onCouponCodeEnteredAction: ABI49_0_0RCTDirectEventBlock?
    @objc var onOrderTrackingAction: ABI49_0_0RCTDirectEventBlock?
