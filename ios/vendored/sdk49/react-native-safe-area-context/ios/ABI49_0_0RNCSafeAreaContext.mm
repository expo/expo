#import "ABI49_0_0RNCSafeAreaContext.h"

#if __has_include(<safeareacontext/safeareacontext.h>)
#define ABI49_0_0RCT_USE_CODEGEN 1
#else
#define ABI49_0_0RCT_USE_CODEGEN 0
#endif

#import <ABI49_0_0React/ABI49_0_0RCTUtils.h>
#import <UIKit/UIKit.h>
#if ABI49_0_0RCT_USE_CODEGEN
...
@interface ABI49_0_0RNCSafeAreaContext () <NativeSafeAreaContextSpec>
@end
#endif

@implementation ABI49_0_0RNCSafeAreaContext
...
- (NSDictionary *)getConstants
{
  ...
  ABI49_0_0RCTUnsafeExecuteOnMainQueueSync(^{
    UIWindow *window = ABI49_0_0RCTKeyWindow();
    if (window == nil) {
