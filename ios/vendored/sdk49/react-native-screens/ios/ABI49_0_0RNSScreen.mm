...
#import "ABI49_0_0RNSScreenWindowTraits.h"
...
#import <rnscreens/ABI49_0_0RNSScreenComponentDescriptor.h>
#import "ABI49_0_0RNSConvert.h"
#import "ABI49_0_0RNSScreenViewEvent.h"
#else
...
#import "ABI49_0_0RNSScreenStack.h"
#import "ABI49_0_0RNSScreenStackHeaderConfig.h"

@interface ABI49_0_0RNSScreenView ()
#ifdef ABI49_0_0RCT_NEW_ARCH_ENABLED
    <ABI49_0_0RCTRNSScreenViewProtocol, UIAdaptivePresentationControllerDelegate>
#else
    <UIAdaptivePresentationControllerDelegate, ABI49_0_0RCTInvalidating>
#endif
@end

@implementation ABI49_0_0RNSScreenView {
  __weak ABI49_0_0RCTBridge *_bridge;
#ifdef ABI49_0_0RCT_NEW_ARCH_ENABLED
  ABI49_0_0RCTSurfaceTouchHandler *_touchHandler;
  ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenShadowNode::ConcreteState::Shared _state;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenProps>();
    _props = defaultProps;
...
{
  _controller = [[ABI49_0_0RNSScreen alloc] initWithView:self];
  _stackPresentation = ABI49_0_0RNSScreenStackPresentationPush;
  _stackAnimation = ABI49_0_0RNSScreenStackAnimationDefault;
  _gestureEnabled = YES;
  _replaceAnimation = ABI49_0_0RNSScreenReplaceAnimationPop;
  _dismissed = NO;
...
#ifdef ABI49_0_0RCT_NEW_ARCH_ENABLED
  if (_state != nullptr) {
    auto newState = ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenState{ABI49_0_0RCTSizeFromCGSize(self.bounds.size)};
...
- (void)setStackPresentation:(ABI49_0_0RNSScreenStackPresentation)stackPresentation
{
  switch (stackPresentation) {
    case ABI49_0_0RNSScreenStackPresentationModal:
...
#endif
      break;
    case ABI49_0_0RNSScreenStackPresentationFullScreenModal:
      _controller.modalPresentationStyle = UIModalPresentationFullScreen;
      break;
#if !TARGET_OS_TV
    case ABI49_0_0RNSScreenStackPresentationFormSheet:
      _controller.modalPresentationStyle = UIModalPresentationFormSheet;
      break;
#endif
    case ABI49_0_0RNSScreenStackPresentationTransparentModal:
      _controller.modalPresentationStyle = UIModalPresentationOverFullScreen;
      break;
    case ABI49_0_0RNSScreenStackPresentationContainedModal:
      _controller.modalPresentationStyle = UIModalPresentationCurrentContext;
      break;
    case ABI49_0_0RNSScreenStackPresentationContainedTransparentModal:
      _controller.modalPresentationStyle = UIModalPresentationOverCurrentContext;
      break;
    case ABI49_0_0RNSScreenStackPresentationPush:
  ...
  if (stackPresentation != ABI49_0_0RNSScreenStackPresentationPush) {
  ...
  } else if (_stackPresentation != ABI49_0_0RNSScreenStackPresentationPush) {
#ifdef ABI49_0_0RCT_NEW_ARCH_ENABLED
...
- (void)setStackAnimation:(ABI49_0_0RNSScreenStackAnimation)stackAnimation
{
  _stackAnimation = stackAnimation;

  switch (stackAnimation) {
    case ABI49_0_0RNSScreenStackAnimationFade:
      _controller.modalTransitionStyle = UIModalTransitionStyleCrossDissolve;
      break;
#if !TARGET_OS_TV
    case ABI49_0_0RNSScreenStackAnimationFlip:
      _controller.modalTransitionStyle = UIModalTransitionStyleFlipHorizontal;
      break;
#endif
    case ABI49_0_0RNSScreenStackAnimationNone:
    case ABI49_0_0RNSScreenStackAnimationDefault:
    case ABI49_0_0RNSScreenStackAnimationSimplePush:
    case ABI49_0_0RNSScreenStackAnimationSlideFromBottom:
    case ABI49_0_0RNSScreenStackAnimationFadeFromBottom:
      // Default
      break;
  }
}
...
- (void)setReplaceAnimation:(ABI49_0_0RNSScreenReplaceAnimation)replaceAnimation
{
...
- (void)setActivityStateOrNil:(NSNumber *)activityStateOrNil
{
  ...
  if (activityStateOrNil != nil && activityState != -1 && activityState != _activityState) {
    ...
    [_ABI49_0_0ReactSuperview markChildUpdated];
  }
}

#if !TARGET_OS_TV
- (void)setStatusBarStyle:(ABI49_0_0RNSStatusBarStyle)statusBarStyle
{
  _hasStatusBarStyleSet = YES;
  _statusBarStyle = statusBarStyle;
  [ABI49_0_0RNSScreenWindowTraits assertViewControllerBasedStatusBarAppearenceSet];
  [ABI49_0_0RNSScreenWindowTraits updateStatusBarAppearance];
}
...
- (void)setScreenOrientation:(UIInterfaceOrientationMask)screenOrientation
{
  ...
  [ABI49_0_0RNSScreenWindowTraits enforceDesiredDeviceOrientation];
}
...
- (void)setHomeIndicatorHidden:(BOOL)homeIndicatorHidden
{
  ...
  [ABI49_0_0RNSScreenWindowTraits updateHomeIndicatorAutoHidden];
}
#endif

- (UIView *)ABI49_0_0ReactSuperview
{
  return _ABI49_0_0ReactSuperview;
}
...
- (void)addSubview:(UIView *)view
{
  if (![view isKindOfClass:[ABI49_0_0RNSScreenStackHeaderConfig class]]) {
    ...
    ((ABI49_0_0RNSScreenStackHeaderConfig *)view).screenView = self;
  }
}
...
- (void)notifyDismissedWithCount:(int)dismissCount
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenEventEmitter>(_eventEmitter)
        ->onDismissed(ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenEventEmitter::OnDismissed{.dismissCount = dismissCount});
  }
#else
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenEventEmitter>(_eventEmitter)
        ->onNativeDismissCancelled(
            ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenEventEmitter::OnNativeDismissCancelled{.dismissCount = dismissCount});
  }
#else
...
- (void)notifyWillAppear
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenEventEmitter>(_eventEmitter)
        ->onWillAppear(ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenEventEmitter::OnWillAppear{});
  }
  ...
  [self ABI49_0_0ReactSetFrame:_reactFrame];
#endif
}
...
- (void)notifyWillDisappear
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenEventEmitter>(_eventEmitter)
        ->onWillDisappear(ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenEventEmitter::OnWillDisappear{});
  }
#else
...
- (void)notifyAppear
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenEventEmitter>(_eventEmitter)
        ->onAppear(ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenEventEmitter::OnAppear{});
  }
#else
  if (self.onAppear) {
    dispatch_async(dispatch_get_main_queue(), ^{
...
- (void)notifyDisappear
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenEventEmitter>(_eventEmitter)
        ->onDisappear(ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenEventEmitter::OnDisappear{});
  }
#else
  if (self.onDisappear) {
...
{
#ifdef ABI49_0_0RCT_NEW_ARCH_ENABLED
#define ABI49_0_0RNS_EXPECTED_VIEW ABI49_0_0RCTRootComponentView
#else
#define ABI49_0_0RNS_EXPECTED_VIEW ABI49_0_0RCTRootView
#endif
  for (UIView *parent = self.superview; parent != nil; parent = parent.superview) {
    if ([parent isKindOfClass:[ABI49_0_0RNS_EXPECTED_VIEW class]] || [parent isKindOfClass:[ABI49_0_0RNSScreenView class]]) {
      return YES;
    }
  }
  return NO;
#undef ABI49_0_0RNS_EXPECTED_VIEW
}

- (void)didMoveToWindow
{
  // For RN touches to work we need to instantiate and connect ABI49_0_0RCTTouchHandler. This only applies
  // for screens that aren't mounted under ABI49_0_0RCTRootView e.g., modals that are mounted directly to
...
#ifdef ABI49_0_0RCT_NEW_ARCH_ENABLED
- (ABI49_0_0RCTSurfaceTouchHandler *)touchHandler
#else
- (ABI49_0_0RCTTouchHandler *)touchHandler
#endif
{
  if (_touchHandler != nil) {
...
- (void)notifyTransitionProgress:(double)progress closing:(BOOL)closing goingForward:(BOOL)goingForward
{
  ...
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenEventEmitter>(_eventEmitter)
        ->onTransitionProgress(ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenEventEmitter::OnTransitionProgress{
            .progress = progress, .closing = closing ? 1 : 0, .goingForward = goingForward ? 1 : 0});
  }
  ABI49_0_0RNSScreenViewEvent *event = [[ABI49_0_0RNSScreenViewEvent alloc] initWithEventName:@"onTransitionProgress"
                                                                   ABI49_0_0ReactTag:[NSNumber numberWithInt:self.tag]
                                                                   progress:progress
                                                                    closing:closing
                                                               goingForward:goingForward];
  [[ABI49_0_0RCTBridge currentBridge].eventDispatcher sendEvent:event];
#else
...
- (void)presentationControllerWillDismiss:(UIPresentationController *)presentationController
{
  ...
  // Because of that, at the moment when this method gets called the ABI49_0_0React's
  // gesture recognizer is already in FAILED state but cancel events never gets
  // send to JS. Calling "reset" forces ABI49_0_0RCTTouchHanler to dispatch cancel event.
...
{
  if ([_ABI49_0_0ReactSuperview respondsToSelector:@selector(presentationControllerDidDismiss:)]) {
    [_ABI49_0_0ReactSuperview performSelector:@selector(presentationControllerDidDismiss:) withObject:presentationController];
  }
}

- (BOOL)isModal
{
  return self.stackPresentation != ABI49_0_0RNSScreenStackPresentationPush;
}
...
- (void)updatePresentationStyle
{
  ...
  if (@available(iOS 15.0, *)) {
    ...
    if (_stackPresentation == ABI49_0_0RNSScreenStackPresentationFormSheet && sheet != nil) {
      ...
      if (_sheetLargestUndimmedDetent == ABI49_0_0RNSScreenDetentTypeMedium) {
        sheet.largestUndimmedDetentIdentifier = UISheetPresentationControllerDetentIdentifierMedium;
      } else if (_sheetLargestUndimmedDetent == ABI49_0_0RNSScreenDetentTypeLarge) {
        sheet.largestUndimmedDetentIdentifier = UISheetPresentationControllerDetentIdentifierLarge;
      } else if (_sheetLargestUndimmedDetent == ABI49_0_0RNSScreenDetentTypeAll) {
        sheet.largestUndimmedDetentIdentifier = nil;
      } else {
        ABI49_0_0RCTLogError(@"Unhandled value of sheetLargestUndimmedDetent passed");
      }

      if (_sheetAllowedDetents == ABI49_0_0RNSScreenDetentTypeMedium) {
      ...
      } else if (_sheetAllowedDetents == ABI49_0_0RNSScreenDetentTypeLarge) {
      ...
      } else if (_sheetAllowedDetents == ABI49_0_0RNSScreenDetentTypeAll) {
        sheet.detents =
            @[ UISheetPresentationControllerDetent.mediumDetent, UISheetPresentationControllerDetent.largeDetent ];
      } else {
        ABI49_0_0RCTLogError(@"Unhandled value of sheetAllowedDetents passed");
      }
    }
  }
...
{
  return ABI49_0_0facebook::ABI49_0_0React::concreteComponentDescriptorProvider<ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenComponentDescriptor>();
}
...
- (void)mountChildComponentView:(UIView<ABI49_0_0RCTComponentViewProtocol> *)childComponentView index:(NSInteger)index
{
  ...
  if ([childComponentView isKindOfClass:[ABI49_0_0RNSScreenStackHeaderConfig class]]) {
    _config = childComponentView;
    ((ABI49_0_0RNSScreenStackHeaderConfig *)childComponentView).screenView = self;
  }
...
{
  const auto &oldScreenProps = *std::static_pointer_cast<const ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenProps>(_props);
  const auto &newScreenProps = *std::static_pointer_cast<const ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenProps>(props);
  ...
  [self
      setGestureResponseDistance:[ABI49_0_0RNSConvert
  ...
  [self setSwipeDirection:[ABI49_0_0RNSConvert ABI49_0_0RNSScreenSwipeDirectionFromCppEquivalent:newScreenProps.swipeDirection]];
  ...
  if (newScreenProps.statusBarStyle != oldScreenProps.statusBarStyle) {
    [self setStatusBarStyle:[ABI49_0_0RCTConvert
                                ABI49_0_0RNSStatusBarStyle:ABI49_0_0RCTNSStringFromStringNilIfEmpty(newScreenProps.statusBarStyle)]];
  }

  if (newScreenProps.statusBarAnimation != oldScreenProps.statusBarAnimation) {
    [self setStatusBarAnimation:[ABI49_0_0RCTConvert UIStatusBarAnimation:ABI49_0_0RCTNSStringFromStringNilIfEmpty(
                                                                     newScreenProps.statusBarAnimation)]];
  }

  if (newScreenProps.screenOrientation != oldScreenProps.screenOrientation) {
    [self setScreenOrientation:[ABI49_0_0RCTConvert UIInterfaceOrientationMask:ABI49_0_0RCTNSStringFromStringNilIfEmpty(
  ...
  if (newScreenProps.sheetAllowedDetents != oldScreenProps.sheetAllowedDetents) {
    [self setSheetAllowedDetents:[ABI49_0_0RNSConvert ABI49_0_0RNSScreenDetentTypeFromAllowedDetents:newScreenProps.sheetAllowedDetents]];
  }

  if (newScreenProps.sheetLargestUndimmedDetent != oldScreenProps.sheetLargestUndimmedDetent) {
    [self setSheetLargestUndimmedDetent:
              [ABI49_0_0RNSConvert ABI49_0_0RNSScreenDetentTypeFromLargestUndimmedDetent:newScreenProps.sheetLargestUndimmedDetent]];
  }
#endif // !TARGET_OS_TV
  ...
  ABI49_0_0RNSScreenStackPresentation newStackPresentation =
      [ABI49_0_0RNSConvert ABI49_0_0RNSScreenStackPresentationFromCppEquivalent:newScreenProps.stackPresentation];
  ...
  if (newScreenProps.stackAnimation != oldScreenProps.stackAnimation) {
    [self setStackAnimation:[ABI49_0_0RNSConvert ABI49_0_0RNSScreenStackAnimationFromCppEquivalent:newScreenProps.stackAnimation]];
  }

  if (newScreenProps.replaceAnimation != oldScreenProps.replaceAnimation) {
    [self setReplaceAnimation:[ABI49_0_0RNSConvert ABI49_0_0RNSScreenReplaceAnimationFromCppEquivalent:newScreenProps.replaceAnimation]];
  }
...
{
  _state = std::static_pointer_cast<const ABI49_0_0facebook::ABI49_0_0React::ABI49_0_0RNSScreenShadowNode::ConcreteState>(state);
}
           ...
           oldLayoutMetrics:(const ABI49_0_0facebook::ABI49_0_0React::LayoutMetrics &)oldLayoutMetrics
{
  ...
  UIViewController *parentVC = self.ABI49_0_0ReactViewController.parentViewController;
  if (parentVC != nil && ![parentVC isKindOfClass:[ABI49_0_0RNScreensNavigationController class]]) {
    [super updateLayoutMetrics:layoutMetrics oldLayoutMetrics:oldLayoutMetrics];
  }
  // when screen is mounted under ABI49_0_0RNScreensNavigationController it's size is controller
  ...
  // subviews
  // Explanation taken from `ABI49_0_0ReactSetFrame`, which is old arch equivalent of this code.
}
...
- (void)setPointerEvents:(ABI49_0_0RCTPointerEvents)pointerEvents
{
  ...
  // any attempt of setting that via ABI49_0_0React props
}
...
#ifdef ABI49_0_0RCT_NEW_ARCH_ENABLED
Class<ABI49_0_0RCTComponentViewProtocol> ABI49_0_0RNSScreenCls(void)
{
  return ABI49_0_0RNSScreenView.class;
}
#endif

#pragma mark - ABI49_0_0RNSScreen

@implementation ABI49_0_0RNSScreen {
  __weak id _previousFirstResponder;
  CGRect _lastViewFrame;
  ABI49_0_0RNSScreenView *_initialView;
  UIView *_fakeView;
...
- (instancetype)initWithView:(UIView *)view
{
  if (self = [super init]) {
    ...
    _shouldNotify = YES;
#ifdef ABI49_0_0RCT_NEW_ARCH_ENABLED
    _initialView = (ABI49_0_0RNSScreenView *)view;
#endif
  }
  return self;
}
...
- (void)viewWillAppear:(BOOL)animated
{
  ...
  [ABI49_0_0RNSScreenWindowTraits updateWindowTraits];
  if (_shouldNotify) {
    _closing = NO;
...
- (void)viewDidDisappear:(BOOL)animated
{
  ...
  if (self.parentViewController == nil && self.presentingViewController == nil) {
    if (self.screenView.preventNativeDismiss) {
      ...
      [self.screenView.ABI49_0_0ReactSuperview updateContainer];
...
- (void)viewDidLayoutSubviews
{
  ...
  // into account only when the view is mounted under ABI49_0_0RNScreensNavigationController in which case system
  ...
  BOOL isDisplayedWithinUINavController =
      [self.parentViewController isKindOfClass:[ABI49_0_0RNScreensNavigationController class]];
  ...
  if (isDisplayedWithinUINavController || isPresentedAsNativeModal) {
    ...
    if (!CGRectEqualToRect(_lastViewFrame, self.screenView.frame)) {
      ...
      [((ABI49_0_0RNSScreenView *)self.viewIfLoaded) updateBounds];
    }
#endif
  }
}
...
- (void)notifyTransitionProgress:(double)progress closing:(BOOL)closing goingForward:(BOOL)goingForward
{
  if ([self.view isKindOfClass:[ABI49_0_0RNSScreenView class]]) {
    ...
    [(ABI49_0_0RNSScreenView *)self.view notifyTransitionProgress:progress closing:closing goingForward:goingForward];
  }
}
...
- (UIViewController *)findChildVCForConfigAndTrait:(ABI49_0_0RNSWindowTrait)trait includingModals:(BOOL)includingModals
{
  ...
  if ([self.presentedViewController isKindOfClass:[ABI49_0_0RNSScreen class]]) {
    ...
    return !includingModals
        ? nil
        : [(ABI49_0_0RNSScreen *)lastViewController findChildVCForConfigAndTrait:trait includingModals:includingModals]
            ?: lastViewController;
  }
  ...
  if (lastViewController == nil) {
    ...
    if ([lastViewController conformsToProtocol:@protocol(ABI49_0_0RNScreensViewControllerDelegate)]) {
      ...
      if ([childScreen isKindOfClass:[ABI49_0_0RNSScreen class]]) {
        return [(ABI49_0_0RNSScreen *)childScreen findChildVCForConfigAndTrait:trait includingModals:includingModals]
            ?: selfOrNil;
      } else {
        return selfOrNil;
      }
...
- (BOOL)hasTraitSet:(ABI49_0_0RNSWindowTrait)trait
{
  switch (trait) {
    case ABI49_0_0RNSWindowTraitStyle: {
      return self.screenView.hasStatusBarStyleSet;
    }
    case ABI49_0_0RNSWindowTraitAnimation: {
      return self.screenView.hasStatusBarAnimationSet;
    }
    case ABI49_0_0RNSWindowTraitHidden: {
      return self.screenView.hasStatusBarHiddenSet;
    }
    case ABI49_0_0RNSWindowTraitOrientation: {
      return self.screenView.hasOrientationSet;
    }
    case ABI49_0_0RNSWindowTraitHomeIndicatorHidden: {
      return self.screenView.hasHomeIndicatorHiddenSet;
    }
    default: {
      ABI49_0_0RCTLogError(@"Unknown trait passed: %d", (int)trait);
    }
  }
  return NO;
}
...
{
  UIViewController *vc = [self findChildVCForConfigAndTrait:ABI49_0_0RNSWindowTraitHidden includingModals:NO];
...
{
  UIViewController *vc = [self findChildVCForConfigAndTrait:ABI49_0_0RNSWindowTraitStyle includingModals:NO];
  return vc == self ? nil : vc;
}

- (UIStatusBarStyle)preferredStatusBarStyle
{
  return [ABI49_0_0RNSScreenWindowTraits statusBarStyleForRNSStatusBarStyle:self.screenView.statusBarStyle];
}

- (UIStatusBarAnimation)preferredStatusBarUpdateAnimation
{
  UIViewController *vc = [self findChildVCForConfigAndTrait:ABI49_0_0RNSWindowTraitAnimation includingModals:NO];

  if ([vc isKindOfClass:[ABI49_0_0RNSScreen class]]) {
    return ((ABI49_0_0RNSScreen *)vc).screenView.statusBarAnimation;
  }
...
{
  UIViewController *vc = [self findChildVCForConfigAndTrait:ABI49_0_0RNSWindowTraitOrientation includingModals:YES];

  if ([vc isKindOfClass:[ABI49_0_0RNSScreen class]]) {
    return ((ABI49_0_0RNSScreen *)vc).screenView.screenOrientation;
  }
...
{
  UIViewController *vc = [self findChildVCForConfigAndTrait:ABI49_0_0RNSWindowTraitHomeIndicatorHidden includingModals:YES];
  return vc == self ? nil : vc;
}
...
{
  return (int)[[self.screenView.ABI49_0_0ReactSuperview ABI49_0_0ReactSubviews] count];
}
#endif

- (int)getIndexOfView:(UIView *)view
{
  return (int)[[self.screenView.ABI49_0_0ReactSuperview ABI49_0_0ReactSubviews] indexOfObject:view];
}
...
- (ABI49_0_0RNSScreenView *)screenView
{
  ...
  return _initialView;
#else
  return (ABI49_0_0RNSScreenView *)self.view;
#endif
}
...
- (void)hideHeaderIfNecessary
{
  ...
  if (@available(iOS 13.0, *)) {
    ...
    // we need to check whether ABI49_0_0ReactSubviews array is empty, because on Fabric child nodes are unmounted first ->
    // ABI49_0_0ReactSubviews array may be empty
    if (currentIndex > 0 && [self.screenView.ABI49_0_0ReactSubviews count] > 0 &&
        [self.screenView.ABI49_0_0ReactSubviews[0] isKindOfClass:[ABI49_0_0RNSScreenStackHeaderConfig class]]) {
      UINavigationItem *prevNavigationItem =
          [self.navigationController.viewControllers objectAtIndex:currentIndex - 1].navigationItem;
      ABI49_0_0RNSScreenStackHeaderConfig *config = ((ABI49_0_0RNSScreenStackHeaderConfig *)self.screenView.ABI49_0_0ReactSubviews[0]);
...
- (void)setViewToSnapshot:(UIView *)snapshot
{
  ...
  if (_initialView.stackPresentation != ABI49_0_0RNSScreenStackPresentationPush) {
...
@implementation ABI49_0_0RNSScreenManager

ABI49_0_0RCT_EXPORT_MODULE()

// we want to handle the case when activityState is nil
ABI49_0_0RCT_REMAP_VIEW_PROPERTY(activityState, activityStateOrNil, NSNumber)
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(customAnimationOnSwipe, BOOL);
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(fullScreenSwipeEnabled, BOOL);
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(gestureEnabled, BOOL)
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(gestureResponseDistance, NSDictionary)
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(hideKeyboardOnSwipe, BOOL)
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(preventNativeDismiss, BOOL)
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(replaceAnimation, ABI49_0_0RNSScreenReplaceAnimation)
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(stackPresentation, ABI49_0_0RNSScreenStackPresentation)
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(stackAnimation, ABI49_0_0RNSScreenStackAnimation)
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(swipeDirection, ABI49_0_0RNSScreenSwipeDirection)
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(transitionDuration, NSNumber)

ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(onAppear, ABI49_0_0RCTDirectEventBlock);
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(onDisappear, ABI49_0_0RCTDirectEventBlock);
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(onDismissed, ABI49_0_0RCTDirectEventBlock);
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(onNativeDismissCancelled, ABI49_0_0RCTDirectEventBlock);
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(onTransitionProgress, ABI49_0_0RCTDirectEventBlock);
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(onWillAppear, ABI49_0_0RCTDirectEventBlock);
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(onWillDisappear, ABI49_0_0RCTDirectEventBlock);

#if !TARGET_OS_TV
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(screenOrientation, UIInterfaceOrientationMask)
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(statusBarAnimation, UIStatusBarAnimation)
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(statusBarHidden, BOOL)
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(statusBarStyle, ABI49_0_0RNSStatusBarStyle)
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(homeIndicatorHidden, BOOL)

ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(sheetAllowedDetents, ABI49_0_0RNSScreenDetentType);
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(sheetLargestUndimmedDetent, ABI49_0_0RNSScreenDetentType);
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(sheetGrabberVisible, BOOL);
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(sheetCornerRadius, CGFloat);
ABI49_0_0RCT_EXPORT_VIEW_PROPERTY(sheetExpandsWhenScrolledToEdge, BOOL);
#endif
...
// This class is instatiated from ABI49_0_0React Native's internals during application startup
- (instancetype)init
{
  if (self = [super init]) {
    dispatch_async(dispatch_get_main_queue(), ^{
...
- (UIView *)view
{
  return [[ABI49_0_0RNSScreenView alloc] initWithBridge:self.bridge];
}
...
@implementation ABI49_0_0RCTConvert (ABI49_0_0RNSScreen)

ABI49_0_0RCT_ENUM_CONVERTER(
    ABI49_0_0RNSScreenStackPresentation,
    (@{
      @"push" : @(ABI49_0_0RNSScreenStackPresentationPush),
      @"modal" : @(ABI49_0_0RNSScreenStackPresentationModal),
      @"fullScreenModal" : @(ABI49_0_0RNSScreenStackPresentationFullScreenModal),
      @"formSheet" : @(ABI49_0_0RNSScreenStackPresentationFormSheet),
      @"containedModal" : @(ABI49_0_0RNSScreenStackPresentationContainedModal),
      @"transparentModal" : @(ABI49_0_0RNSScreenStackPresentationTransparentModal),
      @"containedTransparentModal" : @(ABI49_0_0RNSScreenStackPresentationContainedTransparentModal)
    }),
    ABI49_0_0RNSScreenStackPresentationPush,
    integerValue)

ABI49_0_0RCT_ENUM_CONVERTER(
    ABI49_0_0RNSScreenStackAnimation,
    (@{
      @"default" : @(ABI49_0_0RNSScreenStackAnimationDefault),
      @"none" : @(ABI49_0_0RNSScreenStackAnimationNone),
      @"fade" : @(ABI49_0_0RNSScreenStackAnimationFade),
      @"fade_from_bottom" : @(ABI49_0_0RNSScreenStackAnimationFadeFromBottom),
      @"flip" : @(ABI49_0_0RNSScreenStackAnimationFlip),
      @"simple_push" : @(ABI49_0_0RNSScreenStackAnimationSimplePush),
      @"slide_from_bottom" : @(ABI49_0_0RNSScreenStackAnimationSlideFromBottom),
      @"slide_from_right" : @(ABI49_0_0RNSScreenStackAnimationDefault),
      @"slide_from_left" : @(ABI49_0_0RNSScreenStackAnimationDefault),
    }),
    ABI49_0_0RNSScreenStackAnimationDefault,
    integerValue)

ABI49_0_0RCT_ENUM_CONVERTER(
    ABI49_0_0RNSScreenReplaceAnimation,
    (@{
      @"push" : @(ABI49_0_0RNSScreenReplaceAnimationPush),
      @"pop" : @(ABI49_0_0RNSScreenReplaceAnimationPop),
    }),
    ABI49_0_0RNSScreenReplaceAnimationPop,
    integerValue)

ABI49_0_0RCT_ENUM_CONVERTER(
    ABI49_0_0RNSScreenSwipeDirection,
    (@{
      @"vertical" : @(ABI49_0_0RNSScreenSwipeDirectionVertical),
      @"horizontal" : @(ABI49_0_0RNSScreenSwipeDirectionHorizontal),
    }),
...
ABI49_0_0RCT_ENUM_CONVERTER(
    ABI49_0_0RNSStatusBarStyle,
    (@{
      @"auto" : @(ABI49_0_0RNSStatusBarStyleAuto),
      @"inverted" : @(ABI49_0_0RNSStatusBarStyleInverted),
      @"light" : @(ABI49_0_0RNSStatusBarStyleLight),
      @"dark" : @(ABI49_0_0RNSStatusBarStyleDark),
    }),
    ABI49_0_0RNSStatusBarStyleAuto,
    integerValue)

ABI49_0_0RCT_ENUM_CONVERTER(
    ABI49_0_0RNSScreenDetentType,
    (@{
      @"large" : @(ABI49_0_0RNSScreenDetentTypeLarge),
      @"medium" : @(ABI49_0_0RNSScreenDetentTypeMedium),
      @"all" : @(ABI49_0_0RNSScreenDetentTypeAll),
    }),
