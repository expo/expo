...
class ContainerView: ABI38_0_0RCTView {
    ...
    @objc var onAnimationFinish: ABI38_0_0RCTBubblingEventBlock?
    ...
    override func abi38_0_0ReactSetFrame(_ frame: CGRect) {
        super.abi38_0_0ReactSetFrame(frame)
        animationView?.abi38_0_0ReactSetFrame(frame)
    }
