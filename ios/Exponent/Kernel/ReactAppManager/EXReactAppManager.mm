...
- (NSString *)bundleResourceNameForAppFetcher:(EXAppFetcher *)appFetcher withManifest:(nonnull EXRawManifestsRawManifest *)manifest
{
...
{
  EXRawManifestsRawManifest *manifest = _appRecord.appLoader.manifest;
  if (manifest) {
