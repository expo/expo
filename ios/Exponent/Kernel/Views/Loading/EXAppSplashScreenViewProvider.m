...
#import "EXAppSplashScreenConfigurationBuilder.h"
#import "EXKernel.h"
...
@interface EXAppSplashScreenViewProvider ()
...
@implementation EXAppSplashScreenViewProvider

- (instancetype)initWithManifest:(NSDictionary *)manifest
{
  if (self = [super init]) {
    _configuration = [EXAppSplashScreenConfigurationBuilder parseManifest:manifest];
  }
  return self;
}
