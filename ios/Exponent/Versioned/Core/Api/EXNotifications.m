...
{
  EXConstantsBinding *constants = [[[self.bridge moduleForClass:[UMModuleRegistryHolderReactModule class]] umModuleRegistry] getModuleImplementingProtocol:@protocol(UMConstantsInterface)];
