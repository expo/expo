...
RCT_REMAP_METHOD(getCurrentDeviceCountryAsync,
                 getCurrentDeviceCountryWithResolver
                 : (RCTPromiseResolveBlock)resolve rejecter
                 : (RCTPromiseRejectBlock)reject) {
...
RCT_REMAP_METHOD(getPreferredLocalesAsync, getPreferredLocalesWithResolver
                 : (RCTPromiseResolveBlock)resolve rejecter
                 : (RCTPromiseRejectBlock)reject) {
  resolve([NSLocale preferredLanguages]);
}

RCT_REMAP_METHOD(getISOCurrencyCodesAsync, getISOCurrencyCodesWithResolver
                 : (RCTPromiseResolveBlock)resolve rejecter
                 : (__unused RCTPromiseRejectBlock)reject) {
  resolve([NSLocale ISOCurrencyCodes]);
}

RCT_REMAP_METHOD(getCurrentTimeZoneAsync, getCurrentTimeZoneWithResolver
                 : (RCTPromiseResolveBlock)resolve rejecter
                 : (RCTPromiseRejectBlock)reject) {
