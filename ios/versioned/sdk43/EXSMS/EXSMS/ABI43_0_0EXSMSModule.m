...
#import <ABI43_0_0EXSMS/ABI43_0_0EXSMSModule.h>
...
@interface ABI43_0_0EXSMSModule () <MFMessageComposeViewControllerDelegate>

@property (nonatomic, weak) id<ABI43_0_0EXUtilitiesInterface> utils;
...
@implementation ABI43_0_0EXSMSModule

ABI43_0_0EX_EXPORT_MODULE(ExpoSMS);
...
{
  _utils = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI43_0_0EXUtilitiesInterface)];
}
...
ABI43_0_0EX_EXPORT_METHOD_AS(sendSMSAsync,
