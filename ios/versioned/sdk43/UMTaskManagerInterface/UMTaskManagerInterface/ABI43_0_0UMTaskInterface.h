...
@protocol ABI43_0_0UMTaskConsumerInterface;

@protocol ABI43_0_0UMTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI43_0_0UMTaskConsumerInterface> __nonnull consumer;
