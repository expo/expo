...
// Interface for ABI43_0_0UMTaskManager module.

@protocol ABI43_0_0UMTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI43_0_0UMTaskConsumerInterface protocol.
 */
