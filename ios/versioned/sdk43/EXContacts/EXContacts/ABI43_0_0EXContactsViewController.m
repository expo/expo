...
#import <ABI43_0_0EXContacts/ABI43_0_0EXContactsViewController.h>
@import Contacts;

@interface ABI43_0_0EXContactsViewController()

@property (nonatomic, copy) void (^onViewDisappeared)(void);

@end

@implementation ABI43_0_0EXContactsViewController
