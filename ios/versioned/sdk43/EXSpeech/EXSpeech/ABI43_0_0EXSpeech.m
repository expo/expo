...
#import <ABI43_0_0EXSpeech/ABI43_0_0EXSpeech.h>

@interface ABI43_0_0EXSpeechUtteranceWithId : AVSpeechUtterance
...
@implementation ABI43_0_0EXSpeechUtteranceWithId
...
@interface ABI43_0_0EXSpeech () <AVSpeechSynthesizerDelegate>
...
@implementation ABI43_0_0EXSpeech

ABI43_0_0EX_EXPORT_MODULE(ExponentSpeech)
...
{
  id<ABI43_0_0EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI43_0_0EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStarted" body:@{ @"id": ((ABI43_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didCancelSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI43_0_0EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI43_0_0EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStopped" body:@{ @"id": ((ABI43_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didFinishSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI43_0_0EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI43_0_0EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingDone" body:@{ @"id": ((ABI43_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}


ABI43_0_0EX_EXPORT_METHOD_AS(speak,
  ...
  AVSpeechUtterance *utterance = [[ABI43_0_0EXSpeechUtteranceWithId alloc] initWithString:text utteranceId:utteranceId];
...
ABI43_0_0EX_EXPORT_METHOD_AS(getVoices,
                    getVoices:(ABI43_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject) {
...
ABI43_0_0EX_EXPORT_METHOD_AS(stop,
                    stop:(ABI43_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject) {
  [_synthesizer stopSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI43_0_0EX_EXPORT_METHOD_AS(pause,
                    pause:(ABI43_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject) {
  [_synthesizer pauseSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI43_0_0EX_EXPORT_METHOD_AS(resume,
                    resume:(ABI43_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject) {
  [_synthesizer continueSpeaking];
  resolve(nil);
}

ABI43_0_0EX_EXPORT_METHOD_AS(isSpeaking,
                    isSpeaking:(ABI43_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject) {
