...
@implementation ABI43_0_0EXBackgroundFetchTaskConsumer

+ (BOOL)supportsLaunchReason:(ABI43_0_0UMTaskLaunchReason)launchReason
{
  return launchReason == ABI43_0_0UMTaskLaunchReasonBackgroundFetch;
}
...
- (NSUInteger)normalizeTaskResult:(id)result
{
  ...
  switch ([result unsignedIntegerValue]) {
    case ABI43_0_0EXBackgroundFetchResultNewData:
      return UIBackgroundFetchResultNewData;
    case ABI43_0_0EXBackgroundFetchResultFailed:
      return UIBackgroundFetchResultFailed;
    case ABI43_0_0EXBackgroundFetchResultNoData:
    default:
      return UIBackgroundFetchResultNoData;
  }
}
