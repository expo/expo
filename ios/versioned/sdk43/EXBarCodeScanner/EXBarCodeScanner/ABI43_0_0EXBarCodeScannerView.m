...
@interface ABI43_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI43_0_0EXBarCodeScanner *barCodeScanner;
...
@property (nonatomic, copy) ABI43_0_0EXDirectEventBlock onCameraReady;
@property (nonatomic, copy) ABI43_0_0EXDirectEventBlock onMountError;
@property (nonatomic, copy) ABI43_0_0EXDirectEventBlock onBarCodeScanned;

@end

@implementation ABI43_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI43_0_0EXModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI43_0_0EXAppLifecycleListener)];
...
{
  ABI43_0_0EX_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI43_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI43_0_0EXBareCodeCameraRequester class]]) {
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI43_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI43_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI43_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI43_0_0EXBarCodeScanner *barCodeScanner = [ABI43_0_0EXBarCodeScanner new];
