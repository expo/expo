...
@interface ABI43_0_0EXGeofencingTaskConsumer ()
...
@implementation ABI43_0_0EXGeofencingTaskConsumer
...
# pragma mark - ABI43_0_0UMTaskConsumerInterface
...
- (void)startMonitoringRegionsForTask:(id<ABI43_0_0UMTaskInterface>)task
{
  [ABI43_0_0EXUtilities performSynchronouslyOnMainThread:^{
...
- (void)executeTaskWithRegion:(nonnull CLRegion *)region eventType:(ABI43_0_0EXGeofencingEventType)eventType
{
...
- (void)locationManager:(CLLocationManager *)manager didEnterRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != CLRegionStateInside) {
    ...
    [self executeTaskWithRegion:region eventType:ABI43_0_0EXGeofencingEventTypeEnter];
  }
}
...
- (void)locationManager:(CLLocationManager *)manager didExitRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != CLRegionStateOutside) {
    ...
    [self executeTaskWithRegion:region eventType:ABI43_0_0EXGeofencingEventTypeExit];
  }
}
...
- (void)locationManager:(CLLocationManager *)manager didDetermineState:(CLRegionState)state forRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != state) {
    ABI43_0_0EXGeofencingEventType eventType = state == CLRegionStateInside ? ABI43_0_0EXGeofencingEventTypeEnter : ABI43_0_0EXGeofencingEventTypeExit;
...
+ (ABI43_0_0EXGeofencingRegionState)exportRegionState:(CLRegionState)regionState
{
  switch (regionState) {
    case CLRegionStateUnknown:
      return ABI43_0_0EXGeofencingRegionStateUnknown;
    case CLRegionStateInside:
      return ABI43_0_0EXGeofencingRegionStateInside;
    case CLRegionStateOutside:
      return ABI43_0_0EXGeofencingRegionStateOutside;
  }
}
