...
@interface ABI43_0_0EXBaseLocationRequester () <CLLocationManagerDelegate>
...
@implementation ABI43_0_0EXBaseLocationRequester
...
- (void)requestPermissionsWithResolver:(ABI43_0_0EXPromiseResolveBlock)resolve rejecter:(ABI43_0_0EXPromiseRejectBlock)reject {
  ...
  if (existingPermissions && [existingPermissions[@"status"] intValue] != ABI43_0_0EXPermissionStatusUndetermined) {
