...
/**
 * An ABI43_0_0EXUpdatesReaperSelectionPolicy which chooses which updates to delete taking into account manifest filters
 ...
 */
@interface ABI43_0_0EXUpdatesReaperSelectionPolicyFilterAware : NSObject <ABI43_0_0EXUpdatesReaperSelectionPolicy>
