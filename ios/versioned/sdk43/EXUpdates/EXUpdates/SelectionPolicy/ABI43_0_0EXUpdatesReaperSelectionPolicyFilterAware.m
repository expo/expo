...
@implementation ABI43_0_0EXUpdatesReaperSelectionPolicyFilterAware
...
- (NSArray<ABI43_0_0EXUpdatesUpdate *> *)updatesToDeleteWithLaunchedUpdate:(ABI43_0_0EXUpdatesUpdate *)launchedUpdate updates:(NSArray<ABI43_0_0EXUpdatesUpdate *> *)updates filters:(nullable NSDictionary *)filters
{
  ...
  ABI43_0_0EXUpdatesUpdate *nextNewestUpdate;
  ABI43_0_0EXUpdatesUpdate *nextNewestUpdateMatchingFilters;
  for (ABI43_0_0EXUpdatesUpdate *update in updates) {
    ...
    if ([launchedUpdate.commitTime compare:update.commitTime] == NSOrderedDescending) {
      ...
      if ([ABI43_0_0EXUpdatesSelectionPolicies doesUpdate:update matchFilters:filters] &&
