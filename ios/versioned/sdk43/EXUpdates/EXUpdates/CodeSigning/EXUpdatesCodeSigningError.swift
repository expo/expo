...
@objc public enum ABI43_0_0EXUpdatesCodeSigningError : Int, Error {
...
@objc public class ABI43_0_0EXUpdatesCodeSigningErrorUtils : NSObject {
  @objc public static func message(forError: ABI43_0_0EXUpdatesCodeSigningError) -> String {
    switch forError {
    case .CertificateEncodingError:
