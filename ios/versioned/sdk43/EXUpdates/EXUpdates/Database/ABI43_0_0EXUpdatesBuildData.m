 ...
 *
 *   ABI43_0_0EXUpdatesReleaseChannel
 *   ABI43_0_0EXUpdatesURL
 *
 * and all of the values in json
 *
 *   ABI43_0_0EXUpdatesRequestHeaders
 */
@implementation ABI43_0_0EXUpdatesBuildData

+ (void)ensureBuildDataIsConsistentAsync:(ABI43_0_0EXUpdatesDatabase *)database
...
{
  return @{
    @"ABI43_0_0EXUpdatesURL": config.updateUrl.absoluteString,
    @"ABI43_0_0EXUpdatesReleaseChannel": config.releaseChannel,
    @"ABI43_0_0EXUpdatesRequestHeaders": config.requestHeaders,
  };
}

+ (void)clearAllUpdatesAndSetStaticBuildData:(ABI43_0_0EXUpdatesDatabase *)database
                             config:(ABI43_0_0EXUpdatesConfig *)config
{
  NSError *queryError;
  NSArray<ABI43_0_0EXUpdatesUpdate *> *allUpdates = [database allUpdatesWithConfig:config error:&queryError];
  if (queryError) {
