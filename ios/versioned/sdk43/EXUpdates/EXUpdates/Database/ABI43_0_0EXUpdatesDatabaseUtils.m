...
static NSString * const ABI43_0_0EXUpdatesDatabaseUtilsErrorDomain = @"ABI43_0_0EXUpdatesDatabase";

@implementation ABI43_0_0EXUpdatesDatabaseUtils
...
+ (NSError *)errorFromSqlite:(struct sqlite3 *)db
{
  ...
  return [NSError errorWithDomain:ABI43_0_0EXUpdatesDatabaseUtilsErrorDomain
                             code:extendedCode
