...
static NSString * const ABI43_0_0EXUpdatesDatabaseV7Filename = @"expo-v7.db";

@implementation ABI43_0_0EXUpdatesDatabaseMigration7To8

- (NSString *)filename
{
  return ABI43_0_0EXUpdatesDatabaseV7Filename;
}
