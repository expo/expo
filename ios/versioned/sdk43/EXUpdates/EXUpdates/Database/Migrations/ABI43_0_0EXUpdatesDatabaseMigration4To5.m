...
static NSString * const ABI43_0_0EXUpdatesDatabaseV4Filename = @"expo-v4.db";

@implementation ABI43_0_0EXUpdatesDatabaseMigration4To5

- (NSString *)filename
{
  return ABI43_0_0EXUpdatesDatabaseV4Filename;
}
