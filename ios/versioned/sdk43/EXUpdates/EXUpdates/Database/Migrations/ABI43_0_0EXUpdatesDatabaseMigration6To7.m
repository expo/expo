...
static NSString * const ABI43_0_0EXUpdatesDatabaseV6Filename = @"expo-v6.db";

@implementation ABI43_0_0EXUpdatesDatabaseMigration6To7

- (NSString *)filename
{
  return ABI43_0_0EXUpdatesDatabaseV6Filename;
}
