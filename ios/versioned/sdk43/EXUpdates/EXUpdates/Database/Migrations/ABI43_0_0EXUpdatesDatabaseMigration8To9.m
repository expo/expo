...
static NSString * const ABI43_0_0EXUpdatesDatabaseV8Filename = @"expo-v8.db";

@implementation ABI43_0_0EXUpdatesDatabaseMigration8To9

- (NSString *)filename
{
  return ABI43_0_0EXUpdatesDatabaseV8Filename;
}
