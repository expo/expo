...
static NSString * const ABI43_0_0EXUpdatesDatabaseV6Schema = @"\
CREATE TABLE \"updates\" (\
\"id\"  BLOB UNIQUE,\
\"scope_key\"  TEXT NOT NULL,\
\"commit_time\"  INTEGER NOT NULL,\
...
static NSString * const ABI43_0_0EXUpdatesDatabaseV7Schema = @"\
CREATE TABLE \"updates\" (\
\"id\"  BLOB UNIQUE,\
\"scope_key\"  TEXT NOT NULL,\
\"commit_time\"  INTEGER NOT NULL,\
...
static NSString * const ABI43_0_0EXUpdatesDatabaseV8Schema = @"\
CREATE TABLE \"updates\" (\
\"id\"  BLOB UNIQUE,\
\"scope_key\"  TEXT NOT NULL,\
\"commit_time\"  INTEGER NOT NULL,\
...
- (void)testMigration4ToLatest
{
  ...
  XCTAssertEqual(1, [ABI43_0_0EXUpdatesDatabaseUtils executeSql:lastAccessedSql withArgs:nil onDatabase:migratedDb error:nil].count);
  NSString * const successfulLaunchCountSql = @"SELECT * FROM `updates` WHERE `successful_launch_count` = 1";
  XCTAssertEqual(2, [ABI43_0_0EXUpdatesDatabaseUtils executeSql:successfulLaunchCountSql withArgs:nil onDatabase:migratedDb error:nil].count);
}
...
- (void)testMigration6To7
{
  sqlite3 *db;
  NSError *initializeError;
  [ABI43_0_0EXUpdatesDatabaseInitialization initializeDatabaseWithSchema:ABI43_0_0EXUpdatesDatabaseV6Schema
                                                       filename:@"expo-v6.db"
                                                    inDirectory:_testDatabaseDir
                                                  shouldMigrate:NO
                                                     migrations:@[]
  ...
  [ABI43_0_0EXUpdatesDatabaseInitialization initializeDatabaseWithLatestSchemaInDirectory:_testDatabaseDir
                                                                        database:&migratedDb
                                                                      migrations:@[[ABI43_0_0EXUpdatesDatabaseMigration6To7 new]]
                                                                           error:&migrateError];
  XCTAssertNil(migrateError);
  ...
  XCTAssertEqual(1, [ABI43_0_0EXUpdatesDatabaseUtils executeSql:successfulLaunchCountSql withArgs:nil onDatabase:migratedDb error:nil].count);
  NSString * const failedLaunchCount = @"SELECT DISTINCT `failed_launch_count` FROM `updates`";
  XCTAssertEqual(1, [ABI43_0_0EXUpdatesDatabaseUtils executeSql:failedLaunchCount withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  [ABI43_0_0EXUpdatesDatabaseUtils executeSql:modifySuccessfulLaunchCountSql withArgs:nil onDatabase:migratedDb error:&modifySuccessfulLaunchCountError];
  ...
  [ABI43_0_0EXUpdatesDatabaseUtils executeSql:modifyFailedLaunchCountSql withArgs:nil onDatabase:migratedDb error:&modifyFailedLaunchCountError];
  ...
  XCTAssertEqual(1, [ABI43_0_0EXUpdatesDatabaseUtils executeSql:checkFailedLaunchCountSql withArgs:nil onDatabase:migratedDb error:nil].count);
...
- (void)testMigration7To8 {
  sqlite3 *db;
  NSError *initializeError;
  [ABI43_0_0EXUpdatesDatabaseInitialization initializeDatabaseWithSchema:ABI43_0_0EXUpdatesDatabaseV7Schema
                                                       filename:@"expo-v7.db"
                                                    inDirectory:_testDatabaseDir
                                                  shouldMigrate:NO
                                                     migrations:@[]
...
- (void)testMigration8To9 {
  sqlite3 *db;
  NSError *initializeError;
  [ABI43_0_0EXUpdatesDatabaseInitialization initializeDatabaseWithSchema:ABI43_0_0EXUpdatesDatabaseV8Schema
                                                       filename:@"expo-v8.db"
                                                    inDirectory:_testDatabaseDir
                                                  shouldMigrate:NO
                                                     migrations:@[]
