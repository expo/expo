...
/**
 * Fork of {@link ABI43_0_0EXUpdatesMultipartStreamReaderTests}.
 */
@interface ABI43_0_0EXUpdatesMultipartStreamReaderTests : XCTestCase

@end

@implementation ABI43_0_0EXUpdatesMultipartStreamReaderTests
...
- (void)testSimpleCase
{
  ...
  ABI43_0_0EXUpdatesMultipartStreamReader *reader = [[ABI43_0_0EXUpdatesMultipartStreamReader alloc] initWithInputStream:inputStream
