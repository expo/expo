...
#import "ABI43_0_0EXUpdates_Unit_Tests-Swift.h"

@interface ABI43_0_0EXUpdatesFileDownloaderManifestParsingTests : XCTestCase
...
@implementation ABI43_0_0EXUpdatesFileDownloaderManifestParsingTests
...
- (void)testManifestParsing_JSONBody
{
  ...
  __block ABI43_0_0EXUpdatesUpdate *resultUpdateManifest;
  
  [downloader parseManifestResponse:response withData:bodyData database:nil successBlock:^(ABI43_0_0EXUpdatesUpdate * _Nonnull update) {
...
- (void)testManifestParsing_JSONBodySigned {
  ABI43_0_0EXUpdatesConfig *config = [ABI43_0_0EXUpdatesConfig configWithDictionary:@{
    ABI43_0_0EXUpdatesConfigUpdateUrlKey: @"https://exp.host/@test/test",
    ABI43_0_0EXUpdatesConfigCodeSigningCertificateKey: _modernJSONCertificate,
    ABI43_0_0EXUpdatesConfigCodeSigningMetadataKey: @{},
  }];
  ABI43_0_0EXUpdatesFileDownloader *downloader = [[ABI43_0_0EXUpdatesFileDownloader alloc] initWithUpdatesConfig:config];
...
- (void)testManifestParsing_JSONBodySigned_UnsignedRequest_ManifestSignatureOptional {
  ABI43_0_0EXUpdatesConfig *config = [ABI43_0_0EXUpdatesConfig configWithDictionary:@{
    ...
    ABI43_0_0EXUpdatesConfigCodeSigningCertificateKey: _modernJSONCertificate,
    ABI43_0_0EXUpdatesConfigCodeSigningMetadataKey: @{},
    ABI43_0_0EXUpdatesConfigCodeSigningAllowUnsignedManifestsKey: @YES,
  }];
  ABI43_0_0EXUpdatesFileDownloader *downloader = [[ABI43_0_0EXUpdatesFileDownloader alloc] initWithUpdatesConfig:config];
...
- (void)testManifestParsing_MultipartBodySignedCertificateParticularExperience {
  ABI43_0_0EXUpdatesConfig *config = [ABI43_0_0EXUpdatesConfig configWithDictionary:@{
    ABI43_0_0EXUpdatesConfigUpdateUrlKey: @"https://exp.host/@test/test",
    ABI43_0_0EXUpdatesConfigCodeSigningCertificateKey: _rootCertificate,
    ABI43_0_0EXUpdatesConfigCodeSigningMetadataKey: @{
      @"keyid": @"ca-root",
    },
    ABI43_0_0EXUpdatesConfigCodeSigningIncludeManifestResponseCertificateChainKey: @YES,
  }];
  ABI43_0_0EXUpdatesFileDownloader *downloader = [[ABI43_0_0EXUpdatesFileDownloader alloc] initWithUpdatesConfig:config];
