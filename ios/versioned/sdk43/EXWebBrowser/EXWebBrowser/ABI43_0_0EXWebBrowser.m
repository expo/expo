...
#import <ABI43_0_0EXWebBrowser/ABI43_0_0EXWebBrowser.h>
...
@interface ABI43_0_0EXWebBrowser () <SFSafariViewControllerDelegate>

@property (nonatomic, copy) ABI43_0_0EXPromiseResolveBlock redirectResolve;
@property (nonatomic, copy) ABI43_0_0EXPromiseRejectBlock redirectReject;
...
@implementation ABI43_0_0EXWebBrowser
{
  UIStatusBarStyle _initialStatusBarStyle;
}

ABI43_0_0EX_EXPORT_MODULE(ExpoWebBrowser)
...
ABI43_0_0EX_EXPORT_METHOD_AS(openAuthSessionAsync,
...
ABI43_0_0EX_EXPORT_METHOD_AS(openBrowserAsync,
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  if([[arguments allKeys] containsObject:WebBrowserToolbarColorKey]) {
    safariVC.preferredBarTintColor = [ABI43_0_0EXWebBrowser convertHexColorString:arguments[WebBrowserToolbarColorKey]];
  }
  if([[arguments allKeys] containsObject:WebBrowserControlsColorKey]) {
    safariVC.preferredControlTintColor = [ABI43_0_0EXWebBrowser convertHexColorString:arguments[WebBrowserControlsColorKey]];
  }
...
ABI43_0_0EX_EXPORT_METHOD_AS(dismissBrowser,
                    dismissBrowserWithResolver:(ABI43_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  __weak typeof(self) weakSelf = self;
  UIViewController *currentViewController = [UIApplication sharedApplication].keyWindow.rootViewController;
...
ABI43_0_0EX_EXPORT_METHOD_AS(dismissAuthSession,
                    dismissAuthSessionWithResolver:(ABI43_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  if (@available(iOS 11, *)) {
    [_authSession cancel];
...
ABI43_0_0EX_EXPORT_METHOD_AS(warmUpAsync,
...
ABI43_0_0EX_EXPORT_METHOD_AS(coolDownAsync,
...
ABI43_0_0EX_EXPORT_METHOD_AS(getCustomTabsSupportingBrowsers,
                    getCustomTabsSupportingBrowsersWithPackage:(ABI43_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  // stub for jest-expo-mock-generator
}

ABI43_0_0EX_EXPORT_METHOD_AS(mayInitWithUrlAsync,
 ...
 */
- (BOOL)initializeWebBrowserWithResolver:(ABI43_0_0EXPromiseResolveBlock)resolve andRejecter:(ABI43_0_0EXPromiseRejectBlock)reject {
  if (_redirectResolve) {
...
+ (UIColor *)convertHexColorString:(NSString *)stringToConvert {
  ...
  return [ABI43_0_0EXWebBrowser colorWithRGBHex:hexNum];
}
