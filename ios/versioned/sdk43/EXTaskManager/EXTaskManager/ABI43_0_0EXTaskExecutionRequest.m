...
@interface ABI43_0_0EXTaskExecutionRequest ()

@property (nonatomic, strong, nullable) NSMutableSet<id<ABI43_0_0UMTaskInterface>> *tasks;
...
@implementation ABI43_0_0EXTaskExecutionRequest
...
- (void)_maybeExecuteCallback
{
  if (_callback) {
    ...
    __strong ABI43_0_0EXTaskExecutionRequest *strongSelf = self;
