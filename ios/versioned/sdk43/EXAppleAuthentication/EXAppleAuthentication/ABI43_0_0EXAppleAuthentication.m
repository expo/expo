...
#import <ABI43_0_0EXAppleAuthentication/ABI43_0_0EXAppleAuthentication.h>
...
#import <ABI43_0_0ExpoModulesCore/ABI43_0_0EXErrorCodes.h>

static NSString *const ABI43_0_0EXAppleIDCredentialRevokedEvent = @"Expo.appleIdCredentialRevoked";

@interface ABI43_0_0EXAppleAuthentication ()

@property (nonatomic, weak) ABI43_0_0EXModuleRegistry *moduleRegistry;

@end

@implementation ABI43_0_0EXAppleAuthentication

ABI43_0_0EX_EXPORT_MODULE(ExpoAppleAuthentication);
...
{
  return @[ABI43_0_0EXAppleIDCredentialRevokedEvent];
}
...
{
  id<ABI43_0_0EXEventEmitterService> eventEmitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI43_0_0EXEventEmitterService)];
  [eventEmitter sendEventWithName:ABI43_0_0EXAppleIDCredentialRevokedEvent body:@{}];
}
...
ABI43_0_0EX_EXPORT_METHOD_AS(requestAsync,
...
ABI43_0_0EX_EXPORT_METHOD_AS(getCredentialStateAsync,
                                   ...
                                   rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  if (@available(iOS 13.0, *)) {
    ...
    [appleIDProvider getCredentialStateForUserID:userID
      ...
      resolve([ABI43_0_0EXAppleAuthenticationMappings exportCredentialState:credentialState]);
    }];
  } else {
    reject(@"ERR_APPLE_AUTHENTICATION_UNAVAILABLE", @"Apple authentication is not supported on this device.", nil);
  }
...
- (void)requestWithOptions:(NSDictionary *)options
                  resolver:(ABI43_0_0EXPromiseResolveBlock)resolve
                  rejecter:(ABI43_0_0EXPromiseRejectBlock)reject API_AVAILABLE(ios(13.0))
{
  ASAuthorizationProviderAuthorizationOperation operation = [ABI43_0_0EXAppleAuthenticationMappings importOperation:options[@"requestedOperation"]];
  __block ABI43_0_0EXAppleAuthenticationRequest *request = [ABI43_0_0EXAppleAuthenticationRequest performOperation:operation
                                                                                     withOptions:options
                                                                                    withCallback:^(NSDictionary *response, NSError *error) {
    if (error) {
      if (error.code == 1001) {
        // User canceled authentication attempt.
        reject(ABI43_0_0EXErrorCodeCanceled, @"The Apple authentication request has been canceled by the user.", nil);
      } else {
