...
@implementation ABI43_0_0EXAppleAuthenticationMappings
...
{
  return @{
           @"namePrefix": ABI43_0_0EXNullIfNil(nameComponents.namePrefix),
           @"givenName": ABI43_0_0EXNullIfNil(nameComponents.givenName),
           @"middleName": ABI43_0_0EXNullIfNil(nameComponents.middleName),
           @"familyName": ABI43_0_0EXNullIfNil(nameComponents.familyName),
           @"nameSuffix": ABI43_0_0EXNullIfNil(nameComponents.nameSuffix),
           @"nickname": ABI43_0_0EXNullIfNil(nameComponents.nickname)
           };
}
