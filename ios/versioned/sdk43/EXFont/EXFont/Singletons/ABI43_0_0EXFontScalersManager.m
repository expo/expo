...
@implementation UIFont (ABI43_0_0EXFontLoader)

- (UIFont *)ABI43_0_0EXFontWithSize:(CGFloat)fontSize
{
  for (id<ABI43_0_0EXFontScalerInterface> fontScaler in currentFontScalers) {
  ...
  return [self ABI43_0_0EXFontWithSize:fontSize];
}
...
@implementation ABI43_0_0EXFontScalersManager

ABI43_0_0EX_REGISTER_SINGLETON_MODULE(FontScalersManager);
...
+ (void)initialize
{
  ...
  dispatch_once(&initializeCurrentFontScalersOnce, ^{
    ...
    SEL exUpdate = @selector(ABI43_0_0EXFontWithSize:);
...
- (void)registerFontScaler:(id<ABI43_0_0EXFontScalerInterface>)fontScaler
{
