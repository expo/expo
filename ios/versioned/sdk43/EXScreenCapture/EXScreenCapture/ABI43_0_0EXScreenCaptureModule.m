...
@implementation ABI43_0_0EXScreenCaptureModule {
  UIView *_blockView;
}

ABI43_0_0EX_EXPORT_MODULE(ExpoScreenCapture);
...
ABI43_0_0EX_EXPORT_METHOD_AS(preventScreenCapture,
                    preventScreenCaptureWithResolver:(ABI43_0_0EXPromiseResolveBlock)resolve
...
ABI43_0_0EX_EXPORT_METHOD_AS(allowScreenCapture,
                    allowScreenCaptureWithResolver:(ABI43_0_0EXPromiseResolveBlock)resolve
