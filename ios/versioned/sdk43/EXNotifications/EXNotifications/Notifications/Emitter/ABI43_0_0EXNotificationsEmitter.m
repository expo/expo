...
@interface ABI43_0_0EXNotificationsEmitter ()
...
@implementation ABI43_0_0EXNotificationsEmitter

ABI43_0_0EX_EXPORT_MODULE(ExpoNotificationsEmitter);

ABI43_0_0EX_EXPORT_METHOD_AS(getLastNotificationResponseAsync,
                    getLastNotificationResponseAsyncWithResolver:(ABI43_0_0EXPromiseResolveBlock)resolve reject:(ABI43_0_0EXPromiseRejectBlock)reject)
{
...
{
  // Silence ABI43_0_0React Native warning: "Sending ... with no listeners registered."
...
{
  return [ABI43_0_0EXNotificationSerializer serializedNotification:notification];
}

- (NSDictionary *)serializedNotificationResponse:(UNNotificationResponse *)notificationResponse
{
  return [ABI43_0_0EXNotificationSerializer serializedNotificationResponse:notificationResponse];
}
