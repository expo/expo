...
@interface ABI43_0_0EXNotificationPresentationModule ()

@property (nonatomic, weak) id<ABI43_0_0EXNotificationBuilder> notificationBuilder;
...
@implementation ABI43_0_0EXNotificationPresentationModule

ABI43_0_0EX_EXPORT_MODULE(ExpoNotificationPresenter);
...
// Remove once presentNotificationAsync is removed
ABI43_0_0EX_EXPORT_METHOD_AS(presentNotificationAsync,
                    ...
                    reject:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  __weak ABI43_0_0EXNotificationPresentationModule *weakSelf = self;
...
ABI43_0_0EX_EXPORT_METHOD_AS(getPresentedNotificationsAsync,
                    getPresentedNotificationsAsyncWithResolve:(ABI43_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI43_0_0EXPromiseRejectBlock)reject)
{
...
ABI43_0_0EX_EXPORT_METHOD_AS(dismissNotificationAsync,
...
ABI43_0_0EX_EXPORT_METHOD_AS(dismissAllNotificationsAsync,
                    dismissAllNotificationsWithResolver:(ABI43_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI43_0_0EXPromiseRejectBlock)reject)
{
...
{
  _notificationBuilder = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI43_0_0EXNotificationBuilder)];

  // Remove once presentNotificationAsync is removed
  id<ABI43_0_0EXNotificationCenterDelegate> notificationCenterDelegate = (id<ABI43_0_0EXNotificationCenterDelegate>)[moduleRegistry getSingletonModuleForName:@"NotificationCenterDelegate"];
...
- (NSArray * _Nonnull)serializeNotifications:(NSArray<UNNotification *> * _Nonnull)notifications
{
  ...
  for (UNNotification *notification in notifications) {
    [serializedNotifications addObject:[ABI43_0_0EXNotificationSerializer serializedNotification:notification]];
  }
