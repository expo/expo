...
@implementation ABI43_0_0EXNotificationCategoriesModule

ABI43_0_0EX_EXPORT_MODULE(ExpoNotificationCategoriesModule);

# pragma mark - Exported methods

ABI43_0_0EX_EXPORT_METHOD_AS(getNotificationCategoriesAsync,
                 getNotificationCategoriesAsyncWithResolver:(ABI43_0_0EXPromiseResolveBlock)resolve reject:(ABI43_0_0EXPromiseRejectBlock)reject)
{
...
ABI43_0_0EX_EXPORT_METHOD_AS(setNotificationCategoryAsync,
                 setNotificationCategoryWithCategoryId:(NSString *)categoryId
                 actions:(NSArray *)actions
                 options:(NSDictionary *)options
                 resolve:(ABI43_0_0EXPromiseResolveBlock)resolve reject:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  UNNotificationCategory *newCategory = [ABI43_0_0EXNotificationCategoriesModule createCategoryWithId:categoryId
                                                                                     actions:actions
                                                                                     options:options];
...
ABI43_0_0EX_EXPORT_METHOD_AS(deleteNotificationCategoryAsync,
