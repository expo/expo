...
#import <ABI43_0_0EXNotifications/ABI43_0_0EXPushTokenModule.h>
...
@interface ABI43_0_0EXPushTokenModule ()

@property (nonatomic, weak) id<ABI43_0_0EXPushTokenManager> pushTokenManager;
...
@property (nonatomic, strong) ABI43_0_0EXPromiseResolveBlock getDevicePushTokenResolver;
@property (nonatomic, strong) ABI43_0_0EXPromiseRejectBlock getDevicePushTokenRejecter;

@end

@implementation ABI43_0_0EXPushTokenModule

ABI43_0_0EX_EXPORT_MODULE(ExpoPushTokenManager);

# pragma mark - Exported methods

ABI43_0_0EX_EXPORT_METHOD_AS(getDevicePushTokenAsync,
                    getDevicePushTokenResolving:(ABI43_0_0EXPromiseResolveBlock)resolve rejecting:(ABI43_0_0EXPromiseRejectBlock)reject)
{
...
# pragma mark - ABI43_0_0EXPushTokenListener
