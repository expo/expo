...
@interface ABI43_0_0EXRemoteNotificationPermissionSingletonModule ()

@property (nonatomic, strong) NSPointerArray *delegates;

@end

@implementation ABI43_0_0EXRemoteNotificationPermissionSingletonModule

ABI43_0_0EX_REGISTER_SINGLETON_MODULE(RemoteNotificationPermissionPublisher);
...
# pragma mark - ABI43_0_0EXNotificationCenterDelegate
