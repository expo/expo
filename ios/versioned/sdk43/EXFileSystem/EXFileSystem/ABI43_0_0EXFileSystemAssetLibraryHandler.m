...
#import <ABI43_0_0EXFileSystem/ABI43_0_0EXFileSystemAssetLibraryHandler.h>

#import <Photos/Photos.h>

@implementation ABI43_0_0EXFileSystemAssetLibraryHandler
  ...
  if (fetchResult.count > 0) {
    ...
    if (asset.mediaType == PHAssetMediaTypeVideo) {
      [[PHImageManager defaultManager] requestAVAssetForVideo:asset options:nil resultHandler:^(AVAsset *asset, AVAudioMix *audioMix, NSDictionary *info) {
        ...
        [ABI43_0_0EXFileSystemAssetLibraryHandler copyData:data toPath:toPath resolver:resolve rejecter:reject];
      }];
    } else {
      [[PHImageManager defaultManager] requestImageDataForAsset:asset options:nil resultHandler:^(NSData * _Nullable imageData, NSString * _Nullable dataUTI, UIImageOrientation orientation, NSDictionary * _Nullable info) {
        [ABI43_0_0EXFileSystemAssetLibraryHandler copyData:imageData toPath:toPath resolver:resolve rejecter:reject];
      }];
    }
  } else {
    reject(@"E_FILE_NOT_COPIED",
...
// adapted from ABI43_0_0RCTImageLoader.m
