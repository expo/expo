...
#import <ABI43_0_0EXFileSystem/ABI43_0_0EXSessionCancelableUploadTaskDelegate.h>

@interface ABI43_0_0EXSessionCancelableUploadTaskDelegate ()

@property (strong, nonatomic, readonly) ABI43_0_0EXUploadDelegateOnSendCallback onSendCallback;
@property (weak, nonatomic) ABI43_0_0EXTaskHandlersManager *manager;
@property (strong, nonatomic) NSString *uuid;

@end

@implementation ABI43_0_0EXSessionCancelableUploadTaskDelegate
