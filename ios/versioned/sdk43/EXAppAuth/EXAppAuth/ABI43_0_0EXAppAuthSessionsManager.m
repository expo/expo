...
@interface ABI43_0_0EXAppAuthSessionsManager ()

@property (nonatomic, strong) NSMutableSet<id<OIDExternalUserAgentSession>> *currentAuthorizationFlows;

@end

@implementation ABI43_0_0EXAppAuthSessionsManager

ABI43_0_0EX_REGISTER_SINGLETON_MODULE(AppAuthSessionsManager)
