...
@implementation ABI43_0_0EXAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitializedAndSorted {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI43_0_0EXSingletonModule*> * singletonModules = [[ABI43_0_0EXModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI43_0_0EXSingletonModule *singletonModule in singletonModules) {
