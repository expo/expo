...
@protocol ABI43_0_0EXTaskConsumerInterface;

@protocol ABI43_0_0EXTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI43_0_0EXTaskConsumerInterface> __nonnull consumer;
