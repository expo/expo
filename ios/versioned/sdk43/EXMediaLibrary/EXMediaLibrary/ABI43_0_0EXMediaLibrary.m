...
#import <ABI43_0_0EXMediaLibrary/ABI43_0_0EXMediaLibraryMediaLibraryPermissionRequester.h>
...
NSString *const ABI43_0_0EXAssetMediaTypeAudio = @"audio";
NSString *const ABI43_0_0EXAssetMediaTypePhoto = @"photo";
NSString *const ABI43_0_0EXAssetMediaTypeVideo = @"video";
NSString *const ABI43_0_0EXAssetMediaTypeUnknown = @"unknown";
NSString *const ABI43_0_0EXAssetMediaTypeAll = @"all";

NSString *const ABI43_0_0EXMediaLibraryDidChangeEvent = @"mediaLibraryDidChange";

NSString *const ABI43_0_0EXMediaLibraryCachesDirectory = @"MediaLibrary";

NSString *const ABI43_0_0EXMediaLibraryShouldDownloadFromNetworkKey = @"shouldDownloadFromNetwork";

@interface ABI43_0_0EXMediaLibrary ()
...
@implementation ABI43_0_0EXMediaLibrary

ABI43_0_0EX_EXPORT_MODULE(ExponentMediaLibrary);
...
- (void)setModuleRegistry:(ABI43_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  [ABI43_0_0EXPermissionsMethodsDelegate registerRequesters:@[[ABI43_0_0EXMediaLibraryMediaLibraryPermissionRequester new], [ABI43_0_0EXMediaLibraryMediaLibraryWriteOnlyPermissionRequester new]] withPermissionsManager:_permissionsManager];
}
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"MediaType": @{
               @"audio": ABI43_0_0EXAssetMediaTypeAudio,
               @"photo": ABI43_0_0EXAssetMediaTypePhoto,
               @"video": ABI43_0_0EXAssetMediaTypeVideo,
               @"unknown": ABI43_0_0EXAssetMediaTypeUnknown,
               @"all": ABI43_0_0EXAssetMediaTypeAll,
               },
           @"SortBy": @{
               @"default": @"default",
           ...
           @"CHANGE_LISTENER_NAME": ABI43_0_0EXMediaLibraryDidChangeEvent,
           };
}

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI43_0_0EXMediaLibraryDidChangeEvent];
}

- (id)requesterClass:(BOOL)writeOnly
{
  if (writeOnly) {
    return [ABI43_0_0EXMediaLibraryMediaLibraryWriteOnlyPermissionRequester class];
  } else {
    return [ABI43_0_0EXMediaLibraryMediaLibraryPermissionRequester class];
  }
}
...
ABI43_0_0EX_EXPORT_METHOD_AS(presentPermissionsPickerAsync,
                    presentPermissionsPickerAsync:(ABI43_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
#ifdef __IPHONE_14_0
  if (@available(iOS 14, *)) {
...
ABI43_0_0EX_EXPORT_METHOD_AS(createAssetAsync,
                    ...
                    reject:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  PHAssetMediaType assetType = [ABI43_0_0EXMediaLibrary _assetTypeForUri:localUri];
  ...
  if (!([_fileSystem permissionsForURI:assetUrl] & ABI43_0_0EXFileSystemPermissionRead)) {
  ...
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    ...
    if (success) {
      PHAsset *asset = [ABI43_0_0EXMediaLibrary _getAssetById:assetPlaceholder.localIdentifier];
      resolve([ABI43_0_0EXMediaLibrary _exportAsset:asset]);
    } else {
...
ABI43_0_0EX_EXPORT_METHOD_AS(saveToLibraryAsync,
                    ...
                    reject:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  __block ABI43_0_0EXSaveToLibraryDelegate *delegate = [ABI43_0_0EXSaveToLibraryDelegate new];
  [_saveToLibraryDelegates addObject:delegate];
  ABI43_0_0EXSaveToLibraryCallback callback = ^(id asset, NSError *error){
...
ABI43_0_0EX_EXPORT_METHOD_AS(addAssetsToAlbumAsync,
                    ...
                    reject:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    [ABI43_0_0EXMediaLibrary _addAssets:assetIds toAlbum:albumId withCallback:^(BOOL success, NSError *error) {
      if (error) {
...
ABI43_0_0EX_EXPORT_METHOD_AS(removeAssetsFromAlbumAsync,
                    ...
                    reject:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
      PHAssetCollection *collection = [ABI43_0_0EXMediaLibrary _getAlbumById:albumId];
      PHFetchResult *assets = [ABI43_0_0EXMediaLibrary _getAssetsByIds:assetIds];
...
ABI43_0_0EX_EXPORT_METHOD_AS(deleteAssetsAsync,
...
ABI43_0_0EX_EXPORT_METHOD_AS(getAlbumsAsync,
                    ...
                    reject:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    ...
    [albums addObjectsFromArray:[ABI43_0_0EXMediaLibrary _exportCollections:userAlbumsFetchResult withFetchOptions:fetchOptions inFolder:nil]];
    ...
    if ([options[@"includeSmartAlbums"] boolValue]) {
      ...
      [albums addObjectsFromArray:[ABI43_0_0EXMediaLibrary _exportCollections:smartAlbumsFetchResult withFetchOptions:fetchOptions inFolder:nil]];
    }
...
ABI43_0_0EX_EXPORT_METHOD_AS(getMomentsAsync,
                    getMoments:(ABI43_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  if (![self _checkPermissions:reject]) {
    return;
  ...
  NSArray<NSDictionary *> *albums = [ABI43_0_0EXMediaLibrary _exportCollections:fetchResult withFetchOptions:options inFolder:nil];
  
  resolve(albums);
}

ABI43_0_0EX_EXPORT_METHOD_AS(getAlbumAsync,
                    getAlbumWithTitle:(nonnull NSString *)title
                    resolve:(ABI43_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    PHAssetCollection *collection = [ABI43_0_0EXMediaLibrary _getAlbumWithTitle:title];
    resolve(ABI43_0_0EXNullIfNil([ABI43_0_0EXMediaLibrary _exportCollection:collection]));
  }];
}

ABI43_0_0EX_EXPORT_METHOD_AS(createAlbumAsync,
...
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    [ABI43_0_0EXMediaLibrary _createAlbumWithTitle:title completion:^(PHAssetCollection *collection, NSError *error) {
      if (collection) {
        if (assetId) {
          [ABI43_0_0EXMediaLibrary _addAssets:@[assetId] toAlbum:collection.localIdentifier withCallback:^(BOOL success, NSError *error) {
            if (success) {
              resolve(ABI43_0_0EXNullIfNil([ABI43_0_0EXMediaLibrary _exportCollection:collection]));
            } else {
...
ABI43_0_0EX_EXPORT_METHOD_AS(deleteAlbumsAsync,
...
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    PHFetchResult *collections = [ABI43_0_0EXMediaLibrary _getAlbumsById:albumIds];
    [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
      if (assetRemove) {
...
ABI43_0_0EX_EXPORT_METHOD_AS(getAssetInfoAsync,
                    ...
                    reject:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  PHAsset *asset = [ABI43_0_0EXMediaLibrary _getAssetById:assetId];
    
  BOOL shouldDownloadFromNetwork = [options objectForKey:ABI43_0_0EXMediaLibraryShouldDownloadFromNetworkKey] != nil
    ? [[options objectForKey:ABI43_0_0EXMediaLibraryShouldDownloadFromNetworkKey] boolValue]
    : YES;
  
  if (asset) {
    NSMutableDictionary *result = [ABI43_0_0EXMediaLibrary _exportAssetInfo:asset];
    if (asset.mediaType == PHAssetMediaTypeImage) {
      ...
      [[PHImageManager defaultManager] requestAVAssetForVideo:asset
        ...
        if ([asset isKindOfClass:[AVComposition class]]) {
            NSString *directory = [self.fileSystem.cachesDirectory stringByAppendingPathComponent:ABI43_0_0EXMediaLibraryCachesDirectory];
...
ABI43_0_0EX_EXPORT_METHOD_AS(getAssetsAsync,
                    ...
                    reject:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *createdAfter = [ABI43_0_0EXUtilities NSDate:options[@"createdAfter"]];
  NSDate *createdBefore = [ABI43_0_0EXUtilities NSDate:options[@"createdBefore"]];
  ...
  if (albumId) {
    [self _runIfAllPermissionsWereGranted:reject block:^{
      ...
      [ABI43_0_0EXMediaLibrary _getAssetsWithAfter:after
                                    first:first
                                mediaType:mediaType
                                   sortBy:sortBy
...
- (void)startObserving
{
  _allAssetsFetchResult = [ABI43_0_0EXMediaLibrary _getAllAssets];
    ...
    if (changeDetails != nil) {
      ...
      if (changeDetails.hasIncrementalChanges && (changeDetails.insertedObjects.count > 0 || changeDetails.removedObjects.count > 0)) {
        ...
        for (PHAsset *asset in changeDetails.insertedObjects) {
          [insertedAssets addObject:[ABI43_0_0EXMediaLibrary _exportAsset:asset]];
        }
        for (PHAsset *asset in changeDetails.removedObjects) {
          [deletedAssets addObject:[ABI43_0_0EXMediaLibrary _exportAsset:asset]];
        }
        for (PHAsset *asset in changeDetails.changedObjects) {
          [updatedAssets addObject:[ABI43_0_0EXMediaLibrary _exportAsset:asset]];
        }
        
        [_eventEmitter sendEventWithName:ABI43_0_0EXMediaLibraryDidChangeEvent body:body];
        return;
      }
      ...
      if (!changeDetails.hasIncrementalChanges) {
        [_eventEmitter sendEventWithName:ABI43_0_0EXMediaLibraryDidChangeEvent body:@{
                     ...
                     reject:(ABI43_0_0EXPromiseRejectBlock)reject
{
  ...
  PHAsset *cursor;
  if (after) {
    cursor = [ABI43_0_0EXMediaLibrary _getAssetById:after];
  ...
  if (mediaType && [mediaType count] > 0) {
    NSMutableArray<NSNumber *> *assetTypes = [ABI43_0_0EXMediaLibrary _convertMediaTypes:mediaType];
  ...
  if (sortBy && sortBy.count > 0) {
    fetchOptions.sortDescriptors = [ABI43_0_0EXMediaLibrary _prepareSortDescriptors:sortBy];
  }
  ...
  if (fetchOptions.sortDescriptors.count == 0) {
    ...
    for (NSInteger i = startIndex; i >= endIndex; i--) {
      ...
      [assets addObject:[ABI43_0_0EXMediaLibrary _exportAsset:asset]];
    }
...
{
  if (assetId) {
    return [ABI43_0_0EXMediaLibrary _getAssetsByIds:@[assetId]].firstObject;
  }
  return nil;
}
...
+ (void)_ensureAlbumWithTitle:(nonnull NSString *)title completion:(void(^)(PHAssetCollection *collection, NSError *error))completion
{
  ...
  [ABI43_0_0EXMediaLibrary _createAlbumWithTitle:title completion:completion];
}
...
+ (NSDictionary *)_exportAsset:(PHAsset *)asset
{
  if (asset) {
    ...
    return @{
             ...
             @"filename": fileName,
             @"uri": [ABI43_0_0EXMediaLibrary _assetUriForLocalId:asset.localIdentifier],
             @"mediaType": [ABI43_0_0EXMediaLibrary _stringifyMediaType:asset.mediaType],
             @"mediaSubtypes": [ABI43_0_0EXMediaLibrary _stringifyMediaSubtypes:asset.mediaSubtypes],
             @"width": @(asset.pixelWidth),
             @"height": @(asset.pixelHeight),
             @"creationTime": [ABI43_0_0EXMediaLibrary _exportDate:asset.creationDate],
             @"modificationTime": [ABI43_0_0EXMediaLibrary _exportDate:asset.modificationDate],
...
{
  NSMutableDictionary *assetDict = [[ABI43_0_0EXMediaLibrary _exportAsset:asset] mutableCopy];
  
  if (assetDict) {
    assetDict[@"location"] = [ABI43_0_0EXMediaLibrary _exportLocation:asset.location];
...
{
  return [ABI43_0_0EXMediaLibrary _exportCollection:collection inFolder:nil];
}
...
+ (nullable NSDictionary *)_exportCollection:(PHAssetCollection *)collection inFolder:(nullable NSString *)folderName
{
  if (collection) {
    return @{
             @"id": [ABI43_0_0EXMediaLibrary _assetIdFromLocalId:collection.localIdentifier],
             @"title": ABI43_0_0EXNullIfNil(collection.localizedTitle),
             @"folderName": ABI43_0_0EXNullIfNil(folderName),
             @"type": [ABI43_0_0EXMediaLibrary _stringifyAlbumType:collection.assetCollectionType],
             @"assetCount": [ABI43_0_0EXMediaLibrary _assetCountOfCollection:collection],
             @"startTime": [ABI43_0_0EXMediaLibrary _exportDate:collection.startDate],
             @"endTime": [ABI43_0_0EXMediaLibrary _exportDate:collection.endDate],
             @"approximateLocation": [ABI43_0_0EXMediaLibrary _exportLocation:collection.approximateLocation],
             @"locationNames": ABI43_0_0EXNullIfNil(collection.localizedLocationNames),
             };
  }
  return nil;
}
                       ...
                       inFolder:(nullable NSString *)folderName
{
  ...
  for (PHCollection *collection in collections) {
    if ([collection isKindOfClass:[PHAssetCollection class]]) {
      [albums addObject:[ABI43_0_0EXMediaLibrary _exportCollection:(PHAssetCollection *)collection inFolder:folderName]];
      ...
      [albums addObjectsFromArray:[ABI43_0_0EXMediaLibrary _exportCollections:collectionsInFolder withFetchOptions:options inFolder:collection.localizedTitle]];
    }
  }
  return [albums copy];
}
...
{
  NSString *assetId = [ABI43_0_0EXMediaLibrary _assetIdFromLocalId:localId];
...
+ (NSString *)_stringifyMediaType:(PHAssetMediaType)mediaType
{
  switch (mediaType) {
    case PHAssetMediaTypeAudio:
      return ABI43_0_0EXAssetMediaTypeAudio;
    case PHAssetMediaTypeImage:
      return ABI43_0_0EXAssetMediaTypePhoto;
    case PHAssetMediaTypeVideo:
      return ABI43_0_0EXAssetMediaTypeVideo;
    default:
      return ABI43_0_0EXAssetMediaTypeUnknown;
  }
}

+ (PHAssetMediaType)_convertMediaType:(NSString *)mediaType
{
  if ([mediaType isEqualToString:ABI43_0_0EXAssetMediaTypeAudio]) {
    return PHAssetMediaTypeAudio;
  }
  if ([mediaType isEqualToString:ABI43_0_0EXAssetMediaTypePhoto]) {
    return PHAssetMediaTypeImage;
  }
  if ([mediaType isEqualToString:ABI43_0_0EXAssetMediaTypeVideo]) {
    return PHAssetMediaTypeVideo;
  }
  return PHAssetMediaTypeUnknown;
}
...
+ (NSMutableArray<NSNumber *> *)_convertMediaTypes:(NSArray<NSString *> *)mediaTypes
{
  ...
  [mediaTypes enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
    if ([obj isEqualToString:ABI43_0_0EXAssetMediaTypeAll]) {
      *stop = YES;
      assetTypes = nil;
      return;
    }
    PHAssetMediaType assetType = [ABI43_0_0EXMediaLibrary _convertMediaType:obj];
...
+ (NSString *)_convertSortByKey:(NSString *)key
{
  ...
  if (value == nil) {
    ...
    @throw [NSException exceptionWithName:@"ABI43_0_0EXMediaLibrary.UNSUPPORTED_SORTBY_KEY" reason:reason userInfo:nil];
  }
  return value;
}
...
+ (NSSortDescriptor *)_sortDescriptorFrom:(id)config
{
  if ([config isKindOfClass:[NSString class]]) {
    NSString *key = [ABI43_0_0EXMediaLibrary _convertSortByKey:config];
  ...
  if ([config isKindOfClass:[NSArray class]]) {
    ...
    NSString *key = [ABI43_0_0EXMediaLibrary _convertSortByKey:sortArray[0]];
...
+ (NSArray *)_prepareSortDescriptors:(NSArray *)sortBy
{
  ...
  for (id config in sortByArray) {
    NSSortDescriptor *sortDescriptor = [ABI43_0_0EXMediaLibrary _sortDescriptorFrom:config];
...
- (void)_runIfAllPermissionsWereGranted:(ABI43_0_0EXPromiseRejectBlock)reject block:(void (^)(void))block
{
  [_permissionsManager getPermissionUsingRequesterClass:[ABI43_0_0EXMediaLibraryMediaLibraryPermissionRequester class] resolve:^(id result) {
...
- (BOOL)_checkPermissions:(ABI43_0_0EXPromiseRejectBlock)reject
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI43_0_0EXMediaLibraryMediaLibraryPermissionRequester class]]) {
    reject(@"E_NO_PERMISSIONS", @"MEDIA_LIBRARY permission is required to do this operation.", nil);
    return NO;
  }
  return YES;
