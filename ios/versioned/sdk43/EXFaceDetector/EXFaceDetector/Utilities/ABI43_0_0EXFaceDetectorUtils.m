//
//  ABI43_0_0EXFaceDetectorUtils.m
//  Exponent
//
...
NSString *const ABI43_0_0EXGMVDataOutputWidthKey = @"Width";
NSString *const ABI43_0_0EXGMVDataOutputHeightKey = @"Height";
...
@implementation ABI43_0_0EXFaceDetectorUtils
...
+ (ABI43_0_0EXFaceDetectionAngleTransformBlock)angleTransformerFromTransform:(CGAffineTransform)transform
{
  return ^(float angle) {
