//
//  ABI43_0_0EXFaceDetectorManager.m
//  Exponent
//
//  Created by Stanisław Chmiela on 22.11.2017.
//  Copyright © 2017 650 Industries. All rights reserved.

#import <ABI43_0_0EXFaceDetector/ABI43_0_0EXFaceEncoder.h>
#import <ABI43_0_0EXFaceDetector/ABI43_0_0EXFaceDetectorUtils.h>
#import <ABI43_0_0EXFaceDetector/ABI43_0_0EXFaceDetectorModule.h>
#import <ABI43_0_0EXFaceDetector/ABI43_0_0EXFaceDetectorManager.h>
#import <ABI43_0_0EXFaceDetector/ABI43_0_0EXFaceDetector.h>
#import <ABI43_0_0EXFaceDetector/ABI43_0_0EXCSBufferOrientationCalculator.h>

static const NSString *kMinDetectionInterval = @"minDetectionInterval";

@interface ABI43_0_0EXFaceDetectorManager() <AVCaptureVideoDataOutputSampleBufferDelegate>
...
@property ABI43_0_0EXFaceDetector *faceDetector;
@property NSInteger timeIntervalMillis;

@end

@implementation ABI43_0_0EXFaceDetectorManager

- (instancetype)init
{
  return [self initWithOptions:[ABI43_0_0EXFaceDetectorUtils defaultFaceDetectorOptions]];
}
...
- (instancetype)initWithOptions:(NSDictionary*)options
{
  if (self = [super init]) {
    ...
    _faceDetectorOptions = [ABI43_0_0EXFaceDetectorUtils mapOptions:options];
...
{
  MLKFaceDetectorOptions* newOptions = [ABI43_0_0EXFaceDetectorUtils newOptions:self.faceDetectorOptions withValues:settings];
  if(![ABI43_0_0EXFaceDetectorUtils areOptionsEqual:newOptions to:self.faceDetectorOptions])
  {
...
- (void)tryEnablingFaceDetection
{
  ...
  if ([self isDetectingFaceEnabled]) {
    @try {
      self.faceDetector = [[ABI43_0_0EXFaceDetector alloc] initWithOptions:_faceDetectorOptions];
      ...
      if([_session canAddOutput:output]) {
        ...
        ABI43_0_0EXLogError(@"Unable to add output to camera session! Face detection aborted!");
      }
    } @catch (NSException *exception) {
      ABI43_0_0EXLogWarn(@"%@", [exception description]);
    }
  }
...
- (void)_notifyOfFaces:(NSArray<MLKFace *> *)faces
           withEncoder:(ABI43_0_0EXFaceEncoder*)encoder
{
       ...
       fromConnection:(AVCaptureConnection *)connection
{
  ...
  if (timePassedMillis > self.timeIntervalMillis) {
    ...
    ABI43_0_0EXFaceDetectionAngleTransformBlock angleTransform = ^(float angle) { return -angle; };

    CGAffineTransform transformation = [ABI43_0_0EXCSBufferOrientationCalculator pointTransformForInterfaceOrientation:_interfaceOrientation
    ...
    UIImageOrientation orientation = [ABI43_0_0EXFaceDetectorManager imageOrientationFrom:_interfaceOrientation
                                                                     andMirrored:_mirroredImageSession];
    ...
    [_faceDetector detectFromBuffer:sampleBuffer
      ...
      if (error != nil) {
        ...
        [self _notifyOfFaces:faces
                 withEncoder:[[ABI43_0_0EXFaceEncoder alloc] initWithTransform:transformation
