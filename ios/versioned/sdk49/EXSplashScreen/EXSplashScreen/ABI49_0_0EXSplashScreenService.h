...
#import <ABI49_0_0EXSplashScreen/ABI49_0_0EXSplashScreenViewProvider.h>

NS_ASSUME_NONNULL_BEGIN

typedef NS_OPTIONS(NSUInteger, ABI49_0_0EXSplashScreenOptions) {
  ABI49_0_0EXSplashScreenDefault = 0,

  // Show splash screen even it was already shown before.
  // e.g. show splash screen again when reloading apps,
  ABI49_0_0EXSplashScreenForceShow = 1 << 0,
};
...
*/
@protocol ABI49_0_0EXSplashScreenService <NSObject>
...
/**
 * Entry point for SplashScreen unimodule.
 * Registers SplashScreen for given viewController and ABI49_0_0EXSplashController and presents it in that viewController.
 */
-(void)showSplashScreenFor:(UIViewController *)viewController
                   options:(ABI49_0_0EXSplashScreenOptions)options
...
@interface ABI49_0_0EXSplashScreenService : ABI49_0_0EXSingletonModule <ABI49_0_0EXSplashScreenService, UIApplicationDelegate>
@end
