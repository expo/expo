...
void ABI49_0_0EXGLContext::prepareContext(jsi::Runtime &runtime, std::function<void(void)> flushMethod) {
  ...
  try {
    ...
    ABI49_0_0EXGLSysLog("Failed to setup ABI49_0_0EXGLContext [%s]", err.what());
  }
}

void ABI49_0_0EXGLContext::maybeResolveWorkletContext(jsi::Runtime &runtime) {
...
void ABI49_0_0EXGLContext::prepareWorkletContext() {
...
void ABI49_0_0EXGLContext::endNextBatch() noexcept {
...
void ABI49_0_0EXGLContext::addToNextBatch(Op &&op) noexcept {
...
void ABI49_0_0EXGLContext::addBlockingToNextBatch(Op &&op) {
...
jsi::Value ABI49_0_0EXGLContext::addFutureToNextBatch(
    jsi::Runtime &runtime,
...
void ABI49_0_0EXGLContext::flush(void) {
...
ABI49_0_0EXGLObjectId ABI49_0_0EXGLContext::createObject(void) noexcept {
  return nextObjectId++;
}

void ABI49_0_0EXGLContext::destroyObject(ABI49_0_0EXGLObjectId exglObjId) noexcept {
  objects.erase(exglObjId);
}

void ABI49_0_0EXGLContext::mapObject(ABI49_0_0EXGLObjectId exglObjId, GLuint glObj) noexcept {
  objects[exglObjId] = glObj;
}

GLuint ABI49_0_0EXGLContext::lookupObject(ABI49_0_0EXGLObjectId exglObjId) noexcept {
  auto iter = objects.find(exglObjId);
  return iter == objects.end() ? 0 : iter->second;
}

void ABI49_0_0EXGLContext::tryRegisterOnJSRuntimeDestroy(jsi::Runtime &runtime) {
...
glesContext ABI49_0_0EXGLContext::prepareOpenGLESContext() {
  glesContext result;
...
void ABI49_0_0EXGLContext::maybeReadAndCacheSupportedExtensions() {
