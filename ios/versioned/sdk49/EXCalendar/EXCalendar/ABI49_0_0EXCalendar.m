...
#import <ABI49_0_0EXCalendar/ABI49_0_0EXCalendar.h>
#import <ABI49_0_0EXCalendar/ABI49_0_0EXCalendarConverter.h>
#import <ABI49_0_0EXCalendar/ABI49_0_0EXCalendarPermissionRequester.h>
...
@implementation ABI49_0_0EXCalendar
...
ABI49_0_0EX_EXPORT_MODULE(ExpoCalendar);
...
- (void)setModuleRegistry:(ABI49_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  [ABI49_0_0EXPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI49_0_0EXCalendarPermissionRequester new],
                                                    [ABI49_0_0EXRemindersPermissionRequester new]
                                                    ]
...
ABI49_0_0EX_EXPORT_METHOD_AS(getCalendarsAsync,
                    ...
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve([ABI49_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI49_0_0EX_EXPORT_METHOD_AS(getDefaultCalendarAsync,
                    getDefaultCalendarAsync:(ABI49_0_0EXPromiseResolveBlock)resolve
                    rejector:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  if (![self _checkCalendarPermissions:reject]) {
    return;
  }
  ...
  resolve([ABI49_0_0EXCalendarConverter serializeCalendar:defaultCalendar]);
}

ABI49_0_0EX_EXPORT_METHOD_AS(saveCalendarAsync,
                    ...
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (color) {
    calendar.CGColor = [ABI49_0_0EXUtilities UIColor:color].CGColor;
...
ABI49_0_0EX_EXPORT_METHOD_AS(deleteCalendarAsync,
...
ABI49_0_0EX_EXPORT_METHOD_AS(getEventsAsync,
                    ...
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI49_0_0EXUtilities NSDate:startDateStr];
  NSDate *endDate = [ABI49_0_0EXUtilities NSDate:endDateStr];
  ...
  if (calendarEvents) {
    resolve([ABI49_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI49_0_0EX_EXPORT_METHOD_AS(getEventByIdAsync,
                    ...
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (calendarEvent) {
    resolve([ABI49_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI49_0_0EX_EXPORT_METHOD_AS(saveEventAsync,
                    ...
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI49_0_0EXUtilities NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI49_0_0EXUtilities NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI49_0_0EXUtilities NSDate:details[@"instanceStartDate"]];
...
ABI49_0_0EX_EXPORT_METHOD_AS(deleteEventAsync,
                    ...
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *instanceStartDate = [ABI49_0_0EXUtilities NSDate:event[@"instanceStartDate"]];
...
ABI49_0_0EX_EXPORT_METHOD_AS(getAttendeesForEventAsync,
                    ...
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (item.hasAttendees) {
    resolve([ABI49_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI49_0_0EX_EXPORT_METHOD_AS(getRemindersAsync,
                    ...
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI49_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI49_0_0EX_EXPORT_METHOD_AS(getReminderByIdAsync,
                    ...
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (reminder) {
    ...
    resolve([ABI49_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI49_0_0EX_EXPORT_METHOD_AS(saveReminderAsync,
                    ...
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI49_0_0EXUtilities NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI49_0_0EXUtilities NSDate:details[@"dueDate"]];
  NSDate *completionDate = [ABI49_0_0EXUtilities NSDate:details[@"completionDate"]];
...
ABI49_0_0EX_EXPORT_METHOD_AS(deleteReminderAsync,
...
ABI49_0_0EX_EXPORT_METHOD_AS(getSourcesAsync,
                    getSourcesAsync:(ABI49_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI49_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI49_0_0EX_EXPORT_METHOD_AS(getSourceByIdAsync,
                    ...
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve([ABI49_0_0EXCalendarConverter serializeSource:source]);
}

ABI49_0_0EX_EXPORT_METHOD_AS(getCalendarPermissionsAsync,
                    getCalendarPermissionsAsync:(ABI49_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  [ABI49_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI49_0_0EXCalendarPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI49_0_0EX_EXPORT_METHOD_AS(requestCalendarPermissionsAsync,
                    requestCalendarPermissionsAsync:(ABI49_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
...
ABI49_0_0EX_EXPORT_METHOD_AS(getRemindersPermissionsAsync,
                    getRemindersPermissionsAsync:(ABI49_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  [ABI49_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI49_0_0EXRemindersPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI49_0_0EX_EXPORT_METHOD_AS(requestRemindersPermissionsAsync,
                    requestRemindersPermissionsAsync:(ABI49_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  [ABI49_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI49_0_0EXRemindersPermissionRequester class]
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI49_0_0EXUtilities NSDate:alarm[@"absoluteDate"]];
...
- (EKRecurrenceRule *)_createRecurrenceRule:(NSDictionary *)recurrenceRule
{
  ...
  if (recurrenceRule[@"endDate"]) {
      endDate = [ABI49_0_0EXUtilities NSDate:recurrenceRule[@"endDate"]];
  }
...
- (BOOL)_checkPermissions:(EKEntityType)entity reject:(ABI49_0_0EXPromiseRejectBlock)reject
{
  ...
  switch (entity) {
    case EKEntityTypeEvent:
      requesterClass = [ABI49_0_0EXCalendarPermissionRequester class];
      break;
    case EKEntityTypeReminder:
      requesterClass = [ABI49_0_0EXRemindersPermissionRequester class];
      break;
    default: {
...
- (BOOL)_checkCalendarPermissions:(ABI49_0_0EXPromiseRejectBlock)reject
{
  return [self _checkPermissions:EKEntityTypeEvent reject:reject];
}

- (BOOL)_checkRemindersPermissions:(ABI49_0_0EXPromiseRejectBlock)reject
{
...
- (void)_initializePermittedEntities
{
  ...
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI49_0_0EXCalendarPermissionRequester class]]) {
    permittedEntities |= EKEntityMaskEvent;
  }
  
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI49_0_0EXRemindersPermissionRequester class]]) {
