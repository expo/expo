...
@interface ABI49_0_0EXTaskExecutionRequest ()

@property (nonatomic, strong, nullable) NSMutableSet<id<ABI49_0_0EXTaskInterface>> *tasks;
...
@implementation ABI49_0_0EXTaskExecutionRequest
...
- (void)addTask:(nonnull id<ABI49_0_0EXTaskInterface>)task
{
  [_tasks addObject:task];
}

- (void)task:(nonnull id<ABI49_0_0EXTaskInterface>)task didFinishWithResult:(id)result
{
...
- (BOOL)isIncludingTask:(nullable id<ABI49_0_0EXTaskInterface>)task
{
...
- (void)_maybeExecuteCallback
{
  if (_callback) {
    ...
    __strong ABI49_0_0EXTaskExecutionRequest *strongSelf = self;
