...
#import <ABI49_0_0EXMediaLibrary/ABI49_0_0EXMediaLibraryMediaLibraryPermissionRequester.h>
...
NSString *const ABI49_0_0EXAssetMediaTypeAudio = @"audio";
NSString *const ABI49_0_0EXAssetMediaTypePhoto = @"photo";
NSString *const ABI49_0_0EXAssetMediaTypeVideo = @"video";
NSString *const ABI49_0_0EXAssetMediaTypeUnknown = @"unknown";
NSString *const ABI49_0_0EXAssetMediaTypeAll = @"all";

NSString *const ABI49_0_0EXMediaLibraryDidChangeEvent = @"mediaLibraryDidChange";

NSString *const ABI49_0_0EXMediaLibraryCachesDirectory = @"MediaLibrary";

NSString *const ABI49_0_0EXMediaLibraryShouldDownloadFromNetworkKey = @"shouldDownloadFromNetwork";

@interface ABI49_0_0EXMediaLibrary ()
...
@implementation ABI49_0_0EXMediaLibrary

ABI49_0_0EX_EXPORT_MODULE(ExpoMediaLibrary);
...
- (void)setModuleRegistry:(ABI49_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  [ABI49_0_0EXPermissionsMethodsDelegate registerRequesters:@[[ABI49_0_0EXMediaLibraryMediaLibraryPermissionRequester new], [ABI49_0_0EXMediaLibraryMediaLibraryWriteOnlyPermissionRequester new]] withPermissionsManager:_permissionsManager];
}
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"MediaType": @{
               @"audio": ABI49_0_0EXAssetMediaTypeAudio,
               @"photo": ABI49_0_0EXAssetMediaTypePhoto,
               @"video": ABI49_0_0EXAssetMediaTypeVideo,
               @"unknown": ABI49_0_0EXAssetMediaTypeUnknown,
               @"all": ABI49_0_0EXAssetMediaTypeAll,
               },
           @"SortBy": @{
               @"default": @"default",
           ...
           @"CHANGE_LISTENER_NAME": ABI49_0_0EXMediaLibraryDidChangeEvent,
           };
}

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI49_0_0EXMediaLibraryDidChangeEvent];
}

- (id)requesterClass:(BOOL)writeOnly
{
  if (writeOnly) {
    return [ABI49_0_0EXMediaLibraryMediaLibraryWriteOnlyPermissionRequester class];
  } else {
    return [ABI49_0_0EXMediaLibraryMediaLibraryPermissionRequester class];
  }
}
...
ABI49_0_0EX_EXPORT_METHOD_AS(presentPermissionsPickerAsync,
                    presentPermissionsPickerAsync:(ABI49_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
#ifdef __IPHONE_14_0
  if (@available(iOS 14, *)) {
...
ABI49_0_0EX_EXPORT_METHOD_AS(createAssetAsync,
                    ...
                    reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  PHAssetMediaType assetType = [ABI49_0_0EXMediaLibrary _assetTypeForUri:localUri];
  ...
  if (!([_fileSystem permissionsForURI:assetUrl] & ABI49_0_0EXFileSystemPermissionRead)) {
  ...
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    ...
    if (success) {
      PHAsset *asset = [ABI49_0_0EXMediaLibrary _getAssetById:assetPlaceholder.localIdentifier];
      resolve([ABI49_0_0EXMediaLibrary _exportAsset:asset]);
    } else {
...
ABI49_0_0EX_EXPORT_METHOD_AS(saveToLibraryAsync,
                    ...
                    reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  __block ABI49_0_0EXSaveToLibraryDelegate *delegate = [ABI49_0_0EXSaveToLibraryDelegate new];
  [_saveToLibraryDelegates addObject:delegate];
  ABI49_0_0EXSaveToLibraryCallback callback = ^(id asset, NSError *error){
...
ABI49_0_0EX_EXPORT_METHOD_AS(addAssetsToAlbumAsync,
                    ...
                    reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    [ABI49_0_0EXMediaLibrary _addAssets:assetIds toAlbum:albumId withCallback:^(BOOL success, NSError *error) {
      if (error) {
...
ABI49_0_0EX_EXPORT_METHOD_AS(removeAssetsFromAlbumAsync,
                    ...
                    reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
      PHAssetCollection *collection = [ABI49_0_0EXMediaLibrary _getAlbumById:albumId];
      PHFetchResult *assets = [ABI49_0_0EXMediaLibrary _getAssetsByIds:assetIds];
...
ABI49_0_0EX_EXPORT_METHOD_AS(deleteAssetsAsync,
...
ABI49_0_0EX_EXPORT_METHOD_AS(getAlbumsAsync,
                    ...
                    reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    ...
    [albums addObjectsFromArray:[ABI49_0_0EXMediaLibrary _exportCollections:userAlbumsFetchResult withFetchOptions:fetchOptions inFolder:nil]];
    ...
    if ([options[@"includeSmartAlbums"] boolValue]) {
      ...
      [albums addObjectsFromArray:[ABI49_0_0EXMediaLibrary _exportCollections:smartAlbumsFetchResult withFetchOptions:fetchOptions inFolder:nil]];
    }
...
ABI49_0_0EX_EXPORT_METHOD_AS(getMomentsAsync,
                    getMoments:(ABI49_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  if (![self _checkPermissions:reject]) {
    return;
  ...
  NSArray<NSDictionary *> *albums = [ABI49_0_0EXMediaLibrary _exportCollections:fetchResult withFetchOptions:options inFolder:nil];
  
  resolve(albums);
}

ABI49_0_0EX_EXPORT_METHOD_AS(getAlbumAsync,
                    getAlbumWithTitle:(nonnull NSString *)title
                    resolve:(ABI49_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    PHAssetCollection *collection = [ABI49_0_0EXMediaLibrary _getAlbumWithTitle:title];
    resolve(ABI49_0_0EXNullIfNil([ABI49_0_0EXMediaLibrary _exportCollection:collection]));
  }];
}

ABI49_0_0EX_EXPORT_METHOD_AS(createAlbumAsync,
...
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    [ABI49_0_0EXMediaLibrary _createAlbumWithTitle:title completion:^(PHAssetCollection *collection, NSError *error) {
      if (collection) {
        if (assetId) {
          [ABI49_0_0EXMediaLibrary _addAssets:@[assetId] toAlbum:collection.localIdentifier withCallback:^(BOOL success, NSError *error) {
            if (success) {
              resolve(ABI49_0_0EXNullIfNil([ABI49_0_0EXMediaLibrary _exportCollection:collection]));
            } else {
...
ABI49_0_0EX_EXPORT_METHOD_AS(deleteAlbumsAsync,
...
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    PHFetchResult *collections = [ABI49_0_0EXMediaLibrary _getAlbumsById:albumIds];
    [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
      if (assetRemove) {
...
ABI49_0_0EX_EXPORT_METHOD_AS(getAssetInfoAsync,
                    ...
                    reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  PHAsset *asset = [ABI49_0_0EXMediaLibrary _getAssetById:assetId];
    
  BOOL shouldDownloadFromNetwork = [options objectForKey:ABI49_0_0EXMediaLibraryShouldDownloadFromNetworkKey] != nil
    ? [[options objectForKey:ABI49_0_0EXMediaLibraryShouldDownloadFromNetworkKey] boolValue]
    : YES;
  
  if (asset) {
    NSMutableDictionary *result = [ABI49_0_0EXMediaLibrary _exportAssetInfo:asset];
    if (asset.mediaType == PHAssetMediaTypeImage) {
      ...
      [[PHImageManager defaultManager] requestAVAssetForVideo:asset
        ...
        if ([asset isKindOfClass:[AVComposition class]]) {
            NSString *directory = [self.fileSystem.cachesDirectory stringByAppendingPathComponent:ABI49_0_0EXMediaLibraryCachesDirectory];
...
ABI49_0_0EX_EXPORT_METHOD_AS(getAssetsAsync,
                    ...
                    reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *createdAfter = [ABI49_0_0EXUtilities NSDate:options[@"createdAfter"]];
  NSDate *createdBefore = [ABI49_0_0EXUtilities NSDate:options[@"createdBefore"]];
  ...
  if (albumId) {
    [self _runIfAllPermissionsWereGranted:reject block:^{
      ...
      [ABI49_0_0EXMediaLibrary _getAssetsWithAfter:after
                                    first:first
                                mediaType:mediaType
                                   sortBy:sortBy
...
- (void)startObserving
{
  _allAssetsFetchResult = [ABI49_0_0EXMediaLibrary _getAllAssets];
    ...
    if (changeDetails != nil) {
      ...
      if (changeDetails.hasIncrementalChanges && (changeDetails.insertedObjects.count > 0 || changeDetails.removedObjects.count > 0)) {
        ...
        for (PHAsset *asset in changeDetails.insertedObjects) {
          [insertedAssets addObject:[ABI49_0_0EXMediaLibrary _exportAsset:asset]];
        }
        for (PHAsset *asset in changeDetails.removedObjects) {
          [deletedAssets addObject:[ABI49_0_0EXMediaLibrary _exportAsset:asset]];
        }
        for (PHAsset *asset in changeDetails.changedObjects) {
          [updatedAssets addObject:[ABI49_0_0EXMediaLibrary _exportAsset:asset]];
        }
        
        [_eventEmitter sendEventWithName:ABI49_0_0EXMediaLibraryDidChangeEvent body:body];
        return;
      }
      ...
      if (!changeDetails.hasIncrementalChanges) {
        [_eventEmitter sendEventWithName:ABI49_0_0EXMediaLibraryDidChangeEvent body:@{
                     ...
                     reject:(ABI49_0_0EXPromiseRejectBlock)reject
{
  ...
  PHAsset *cursor;
  if (after) {
    cursor = [ABI49_0_0EXMediaLibrary _getAssetById:after];
  ...
  if (mediaType && [mediaType count] > 0) {
    NSMutableArray<NSNumber *> *assetTypes = [ABI49_0_0EXMediaLibrary _convertMediaTypes:mediaType];
  ...
  if (sortBy && sortBy.count > 0) {
    fetchOptions.sortDescriptors = [ABI49_0_0EXMediaLibrary _prepareSortDescriptors:sortBy];
  }
  ...
  if (fetchOptions.sortDescriptors.count == 0) {
    ...
    for (NSInteger i = startIndex; i >= endIndex; i--) {
      ...
      [assets addObject:[ABI49_0_0EXMediaLibrary _exportAsset:asset]];
    }
...
{
  if (assetId) {
    return [ABI49_0_0EXMediaLibrary _getAssetsByIds:@[assetId]].firstObject;
  }
  return nil;
}
...
+ (void)_ensureAlbumWithTitle:(nonnull NSString *)title completion:(void(^)(PHAssetCollection *collection, NSError *error))completion
{
  ...
  [ABI49_0_0EXMediaLibrary _createAlbumWithTitle:title completion:completion];
}
...
+ (NSDictionary *)_exportAsset:(PHAsset *)asset
{
  if (asset) {
    ...
    return @{
             ...
             @"filename": ABI49_0_0EXNullIfNil(fileName),
             @"uri": [ABI49_0_0EXMediaLibrary _assetUriForLocalId:asset.localIdentifier],
             @"mediaType": [ABI49_0_0EXMediaLibrary _stringifyMediaType:asset.mediaType],
             @"mediaSubtypes": [ABI49_0_0EXMediaLibrary _stringifyMediaSubtypes:asset.mediaSubtypes],
             @"width": @(asset.pixelWidth),
             @"height": @(asset.pixelHeight),
             @"creationTime": [ABI49_0_0EXMediaLibrary _exportDate:asset.creationDate],
             @"modificationTime": [ABI49_0_0EXMediaLibrary _exportDate:asset.modificationDate],
...
{
  NSMutableDictionary *assetDict = [[ABI49_0_0EXMediaLibrary _exportAsset:asset] mutableCopy];
  
  if (assetDict) {
    assetDict[@"location"] = [ABI49_0_0EXMediaLibrary _exportLocation:asset.location];
...
{
  return [ABI49_0_0EXMediaLibrary _exportCollection:collection inFolder:nil];
}
...
+ (nullable NSDictionary *)_exportCollection:(PHAssetCollection *)collection inFolder:(nullable NSString *)folderName
{
  if (collection) {
    return @{
             @"id": [ABI49_0_0EXMediaLibrary _assetIdFromLocalId:collection.localIdentifier],
             @"title": ABI49_0_0EXNullIfNil(collection.localizedTitle),
             @"folderName": ABI49_0_0EXNullIfNil(folderName),
             @"type": [ABI49_0_0EXMediaLibrary _stringifyAlbumType:collection.assetCollectionType],
             @"assetCount": [ABI49_0_0EXMediaLibrary _assetCountOfCollection:collection],
             @"startTime": [ABI49_0_0EXMediaLibrary _exportDate:collection.startDate],
             @"endTime": [ABI49_0_0EXMediaLibrary _exportDate:collection.endDate],
             @"approximateLocation": [ABI49_0_0EXMediaLibrary _exportLocation:collection.approximateLocation],
             @"locationNames": ABI49_0_0EXNullIfNil(collection.localizedLocationNames),
             };
  }
  return nil;
}
                       ...
                       inFolder:(nullable NSString *)folderName
{
  ...
  for (PHCollection *collection in collections) {
    if ([collection isKindOfClass:[PHAssetCollection class]]) {
      [albums addObject:[ABI49_0_0EXMediaLibrary _exportCollection:(PHAssetCollection *)collection inFolder:folderName]];
      ...
      [albums addObjectsFromArray:[ABI49_0_0EXMediaLibrary _exportCollections:collectionsInFolder withFetchOptions:options inFolder:collection.localizedTitle]];
    }
  }
  return [albums copy];
}
...
{
  NSString *assetId = [ABI49_0_0EXMediaLibrary _assetIdFromLocalId:localId];
...
+ (PHAssetMediaType)assetTypeForFileExtension:(nonnull NSString *)fileExtension
{
  ...
  ABI49_0_0EXLogWarn(@"Asset media type is recognized from file extension and this behavior can differ on iOS Simulator and a physical device.");
...
+ (PHAssetMediaType)_assetTypeForUri:(nonnull NSString *)localUri
{
  ...
  if (fileUTI == nil){
    return [ABI49_0_0EXMediaLibrary assetTypeForFileExtension:[localUri pathExtension]];
  }
...
+ (NSString *)_stringifyMediaType:(PHAssetMediaType)mediaType
{
  switch (mediaType) {
    case PHAssetMediaTypeAudio:
      return ABI49_0_0EXAssetMediaTypeAudio;
    case PHAssetMediaTypeImage:
      return ABI49_0_0EXAssetMediaTypePhoto;
    case PHAssetMediaTypeVideo:
      return ABI49_0_0EXAssetMediaTypeVideo;
    default:
      return ABI49_0_0EXAssetMediaTypeUnknown;
  }
}

+ (PHAssetMediaType)_convertMediaType:(NSString *)mediaType
{
  if ([mediaType isEqualToString:ABI49_0_0EXAssetMediaTypeAudio]) {
    return PHAssetMediaTypeAudio;
  }
  if ([mediaType isEqualToString:ABI49_0_0EXAssetMediaTypePhoto]) {
    return PHAssetMediaTypeImage;
  }
  if ([mediaType isEqualToString:ABI49_0_0EXAssetMediaTypeVideo]) {
    return PHAssetMediaTypeVideo;
  }
  return PHAssetMediaTypeUnknown;
}
...
+ (NSMutableArray<NSNumber *> *)_convertMediaTypes:(NSArray<NSString *> *)mediaTypes
{
  ...
  [mediaTypes enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
    if ([obj isEqualToString:ABI49_0_0EXAssetMediaTypeAll]) {
      *stop = YES;
      assetTypes = nil;
      return;
    }
    PHAssetMediaType assetType = [ABI49_0_0EXMediaLibrary _convertMediaType:obj];
...
+ (NSString *)_convertSortByKey:(NSString *)key
{
  ...
  if (value == nil) {
    ...
    @throw [NSException exceptionWithName:@"ABI49_0_0EXMediaLibrary.UNSUPPORTED_SORTBY_KEY" reason:reason userInfo:nil];
  }
  return value;
}
...
+ (NSSortDescriptor *)_sortDescriptorFrom:(id)config
{
  ...
  NSString *key = [ABI49_0_0EXMediaLibrary _convertSortByKey:parts[0]];
...
+ (NSArray *)_prepareSortDescriptors:(NSArray *)sortBy
{
  ...
  for (id config in sortByArray) {
    NSSortDescriptor *sortDescriptor = [ABI49_0_0EXMediaLibrary _sortDescriptorFrom:config];
...
- (void)_runIfAllPermissionsWereGranted:(ABI49_0_0EXPromiseRejectBlock)reject block:(void (^)(void))block
{
  [_permissionsManager getPermissionUsingRequesterClass:[ABI49_0_0EXMediaLibraryMediaLibraryPermissionRequester class] resolve:^(id result) {
...
- (BOOL)_checkPermissions:(ABI49_0_0EXPromiseRejectBlock)reject
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI49_0_0EXMediaLibraryMediaLibraryPermissionRequester class]]) {
    reject(@"E_NO_PERMISSIONS", @"MEDIA_LIBRARY permission is required to do this operation.", nil);
    return NO;
  }
  return YES;
