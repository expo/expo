...
static NSString * const ABI49_0_0EXNotificationResponseDefaultActionIdentifier = @"expo.modules.notifications.actions.DEFAULT";

@implementation ABI49_0_0EXNotificationSerializer
...
+ (NSDictionary *)serializedNotificationResponse:(UNNotificationResponse *)response
{
  ...
  if ([UNNotificationDefaultActionIdentifier isEqualToString:actionIdentifier]) {
    actionIdentifier = ABI49_0_0EXNotificationResponseDefaultActionIdentifier;
  }
