...
@interface ABI49_0_0EXNotificationSchedulerModule ()

@property (nonatomic, weak) id<ABI49_0_0EXNotificationBuilder> builder;

@end

@implementation ABI49_0_0EXNotificationSchedulerModule

ABI49_0_0EX_EXPORT_MODULE(ExpoNotificationScheduler);

- (void)setModuleRegistry:(ABI49_0_0EXModuleRegistry *)moduleRegistry
{
  _builder = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI49_0_0EXNotificationBuilder)];
}

# pragma mark - Exported methods

ABI49_0_0EX_EXPORT_METHOD_AS(getAllScheduledNotificationsAsync,
                    getAllScheduledNotifications:(ABI49_0_0EXPromiseResolveBlock)resolve reject:(ABI49_0_0EXPromiseRejectBlock)reject
                    )
{
...
ABI49_0_0EX_EXPORT_METHOD_AS(scheduleNotificationAsync,
                     scheduleNotification:(NSString *)identifier notificationSpec:(NSDictionary *)notificationSpec triggerSpec:(NSDictionary *)triggerSpec resolve:(ABI49_0_0EXPromiseResolveBlock)resolve rejecting:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  @try {
...
ABI49_0_0EX_EXPORT_METHOD_AS(cancelScheduledNotificationAsync,
                     cancelNotification:(NSString *)identifier resolve:(ABI49_0_0EXPromiseResolveBlock)resolve rejecting:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  [[UNUserNotificationCenter currentNotificationCenter] removePendingNotificationRequestsWithIdentifiers:@[identifier]];
  resolve(nil);
}

ABI49_0_0EX_EXPORT_METHOD_AS(cancelAllScheduledNotificationsAsync,
                     cancelAllNotificationsWithResolver:(ABI49_0_0EXPromiseResolveBlock)resolve rejecting:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  [[UNUserNotificationCenter currentNotificationCenter] removeAllPendingNotificationRequests];
  resolve(nil);
}

ABI49_0_0EX_EXPORT_METHOD_AS(getNextTriggerDateAsync,
                    getNextTriggerDate:(NSDictionary *)triggerSpec resolve:(ABI49_0_0EXPromiseResolveBlock)resolve rejecting:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  @try {
...
- (NSArray * _Nonnull)serializeNotificationRequests:(NSArray<UNNotificationRequest *> * _Nonnull) requests
{
  ...
  for (UNNotificationRequest *request in requests) {
    [serializedRequests addObject:[ABI49_0_0EXNotificationSerializer serializedNotificationRequest:request]];
  }
