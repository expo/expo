...
@interface ABI49_0_0EXNotificationsHandlerModule ()
...
@property (nonatomic, strong) NSMutableDictionary<NSString *, ABI49_0_0EXSingleNotificationHandlerTask *> *tasksMap;

@end

@implementation ABI49_0_0EXNotificationsHandlerModule

ABI49_0_0EX_EXPORT_MODULE(ExpoNotificationsHandlerModule);
...
ABI49_0_0EX_EXPORT_METHOD_AS(handleNotificationAsync,
                    handleNotificationAsync:(NSString *)identifier withBehavior:(NSDictionary *)behavior resolver:(ABI49_0_0EXPromiseResolveBlock)resolve rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ABI49_0_0EXSingleNotificationHandlerTask *task = _tasksMap[identifier];
  if (!task) {
...
{
  return [ABI49_0_0EXSingleNotificationHandlerTask eventNames];
}
...
{
  ABI49_0_0EXSingleNotificationHandlerTask *task = [[ABI49_0_0EXSingleNotificationHandlerTask alloc] initWithEventEmitter:_eventEmitter
...
# pragma mark - ABI49_0_0EXSingleNotificationHandlerTaskDelegate
