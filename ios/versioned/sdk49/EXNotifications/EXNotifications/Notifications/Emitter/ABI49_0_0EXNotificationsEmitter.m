...
@interface ABI49_0_0EXNotificationsEmitter ()
...
@implementation ABI49_0_0EXNotificationsEmitter

ABI49_0_0EX_EXPORT_MODULE(ExpoNotificationsEmitter);

ABI49_0_0EX_EXPORT_METHOD_AS(getLastNotificationResponseAsync,
                    getLastNotificationResponseAsyncWithResolver:(ABI49_0_0EXPromiseResolveBlock)resolve reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
...
{
  // Silence ABI49_0_0React Native warning: "Sending ... with no listeners registered."
...
{
  return [ABI49_0_0EXNotificationSerializer serializedNotification:notification];
}

- (NSDictionary *)serializedNotificationResponse:(UNNotificationResponse *)notificationResponse
{
  return [ABI49_0_0EXNotificationSerializer serializedNotificationResponse:notificationResponse];
}
