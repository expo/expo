...
internal final class BareUpdate: Update {
  ...
  static func update(
    ...
    let jsBundleAsset = UpdateAsset(key: bundleKey, type: EmbeddedAppLoader.ABI49_0_0EXUpdatesBareEmbeddedBundleFileType)
    jsBundleAsset.isLaunchAsset = true
    jsBundleAsset.mainBundleFilename = EmbeddedAppLoader.ABI49_0_0EXUpdatesBareEmbeddedBundleFilename
