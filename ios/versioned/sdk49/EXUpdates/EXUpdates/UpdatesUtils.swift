...
@objc(ABI49_0_0EXUpdatesUtils)
@objcMembers
public final class UpdatesUtils: NSObject {
  private static let ABI49_0_0EXUpdatesEventName = "Expo.nativeUpdatesEvent"
  private static let ABI49_0_0EXUpdatesUtilsErrorDomain = "ABI49_0_0EXUpdatesUtils"
  public static let methodQueue = DispatchQueue(label: "expo.modules.ABI49_0_0EXUpdatesQueue")
  ...
  public static func initializeUpdatesDirectory() throws -> URL {
    ...
    if exists {
      if !isDir.boolValue {
        throw NSError(
          domain: ABI49_0_0EXUpdatesUtilsErrorDomain,
          code: 1005,
          userInfo: [
  ...
  internal static func isNativeDebuggingEnabled() -> Bool {
    #if ABI49_0_0EX_UPDATES_NATIVE_DEBUG
    return true
    #else
    return false
    #endif
