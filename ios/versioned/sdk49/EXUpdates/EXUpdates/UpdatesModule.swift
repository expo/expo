 ...
 *
 * Communicates with the updates hub (AppController in most apps, ABI49_0_0EXAppLoaderExpoUpdates in
 * Expo Go and legacy standalone apps) via ABI49_0_0EXUpdatesService, an internal module which is overridden
 * by ABI49_0_0EXUpdatesBinding, a scoped module, in Expo Go.
 */
public final class UpdatesModule: Module {
  private let updatesService: ABI49_0_0EXUpdatesModuleInterface?
