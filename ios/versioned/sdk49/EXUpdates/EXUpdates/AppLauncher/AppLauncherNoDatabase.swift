 ...
 */
@objc(ABI49_0_0EXUpdatesAppLauncherNoDatabase)
@objcMembers
    ...
    if let launchedUpdate = launchedUpdate {
      if launchedUpdate.status == UpdateStatus.StatusEmbedded {
        ...
        launchAssetUrl = Bundle.main.url(
          forResource: EmbeddedAppLoader.ABI49_0_0EXUpdatesBareEmbeddedBundleFilename,
          withExtension: EmbeddedAppLoader.ABI49_0_0EXUpdatesBareEmbeddedBundleFileType
        )
      } else {
        launchAssetUrl = Bundle.main.url(
          forResource: EmbeddedAppLoader.ABI49_0_0EXUpdatesEmbeddedBundleFilename,
          withExtension: EmbeddedAppLoader.ABI49_0_0EXUpdatesEmbeddedBundleFileType
        )
