 ...
 *
 *   ABI49_0_0EXUpdatesReleaseChannel
 *   ABI49_0_0EXUpdatesURL
 *
 * and all of the values in json
 *
 *   ABI49_0_0EXUpdatesRequestHeaders
 */
internal final class UpdatesBuildData {
  ...
  static func getBuildDataFromConfig(_ config: UpdatesConfig) -> [String: Any] {
    return [
      "ABI49_0_0EXUpdatesURL": config.updateUrl.require("Must supply updateUrl in config").absoluteString,
      "ABI49_0_0EXUpdatesReleaseChannel": config.releaseChannel,
      "ABI49_0_0EXUpdatesRequestHeaders": config.requestHeaders
    ]
  }
