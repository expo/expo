...
@objc(ABI49_0_0EXUpdatesAppLoaderTaskDelegate)
...
@objc(ABI49_0_0EXUpdatesBackgroundUpdateStatus)
 ...
 *   be sent to JS.
 */
@objc(ABI49_0_0EXUpdatesAppLoaderTask)
@objcMembers
public final class AppLoaderTask: NSObject {
  private static let ErrorDomain = "ABI49_0_0EXUpdatesAppLoaderTask"
