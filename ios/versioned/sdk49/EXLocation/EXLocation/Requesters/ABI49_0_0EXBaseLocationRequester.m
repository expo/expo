...
#import <ABI49_0_0EXLocation/ABI49_0_0EXBaseLocationRequester.h>
#import <ABI49_0_0ExpoModulesCore/ABI49_0_0EXUtilities.h>

#import <objc/message.h>
#import <CoreLocation/CLLocationManagerDelegate.h>

@interface ABI49_0_0EXBaseLocationRequester () <CLLocationManagerDelegate>
...
@implementation ABI49_0_0EXBaseLocationRequester
...
# pragma mark - ABI49_0_0UMPermissionsRequester

- (NSDictionary *)getPermissions {

  CLAuthorizationStatus systemStatus;
  if (![ABI49_0_0EXBaseLocationRequester isConfiguredForAlwaysAuthorization] && ![ABI49_0_0EXBaseLocationRequester isConfiguredForWhenInUseAuthorization]) {
    ABI49_0_0EXFatal(ABI49_0_0EXErrorWithMessage(@"This app is missing usage descriptions, so location services will fail. Add one of the `NSLocation*UsageDescription` keys to your bundle's Info.plist. See https://bit.ly/3iLqy6S (https://docs.expo.dev/distribution/app-stores/#system-permissions-dialogs-on-ios) for more information."));
...
- (void)requestPermissionsWithResolver:(ABI49_0_0EXPromiseResolveBlock)resolve rejecter:(ABI49_0_0EXPromiseRejectBlock)reject {
  ...
  if (existingPermissions && [existingPermissions[@"status"] intValue] != ABI49_0_0EXPermissionStatusUndetermined) {
