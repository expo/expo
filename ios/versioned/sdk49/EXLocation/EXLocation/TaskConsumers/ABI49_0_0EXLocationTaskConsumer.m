...
@interface ABI49_0_0EXLocationTaskConsumer ()
...
@implementation ABI49_0_0EXLocationTaskConsumer
...
# pragma mark - ABI49_0_0EXTaskConsumerInterface
...
- (void)setOptions:(NSDictionary *)options
{
  [ABI49_0_0EXUtilities performSynchronouslyOnMainThread:^{
    ...
    locationManager.desiredAccuracy = [ABI49_0_0EXLocation CLLocationAccuracyFromOption:accuracy];
    locationManager.distanceFilter = [options[@"distanceInterval"] doubleValue] ?: kCLDistanceFilterNone;
    locationManager.activityType = [ABI49_0_0EXLocation CLActivityTypeFromOption:[options[@"activityType"] integerValue]];
...
- (void)executeTaskWithDeferredLocations
{
  ...
  NSDictionary *data = @{ @"locations": [ABI49_0_0EXLocationTaskConsumer _exportLocations:_deferredLocations] };
...
+ (NSArray<NSDictionary *> *)_exportLocations:(NSArray<CLLocation *> *)locations
{
  ...
  for (CLLocation *location in locations) {
    [result addObject:[ABI49_0_0EXLocation exportLocation:location]];
  }
  return result;
}
