...
#import <ABI49_0_0EXLocation/ABI49_0_0EXLocation.h>
#import <ABI49_0_0EXLocation/ABI49_0_0EXLocationDelegate.h>
#import <ABI49_0_0EXLocation/ABI49_0_0EXLocationTaskConsumer.h>
#import <ABI49_0_0EXLocation/ABI49_0_0EXGeofencingTaskConsumer.h>
...
NSString * const ABI49_0_0EXLocationChangedEventName = @"Expo.locationChanged";
NSString * const ABI49_0_0EXHeadingChangedEventName = @"Expo.headingChanged";

@interface ABI49_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI49_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) NSMutableSet<ABI49_0_0EXLocationDelegate *> *retainedDelegates;
...
@property (nonatomic, weak) id<ABI49_0_0EXTaskManagerInterface> tasksManager;

@end

@implementation ABI49_0_0EXLocation

ABI49_0_0EX_EXPORT_MODULE(ExpoLocation);
...
- (void)setModuleRegistry:(ABI49_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  _tasksManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI49_0_0EXTaskManagerInterface)];

  _permissionsManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI49_0_0EXPermissionsInterface)];
  [ABI49_0_0EXPermissionsMethodsDelegate registerRequesters:@[
    [ABI49_0_0EXLocationPermissionRequester new],
    [ABI49_0_0EXForegroundPermissionRequester new],
    [ABI49_0_0EXBackgroundLocationPermissionRequester new]
...
{
  return @[ABI49_0_0EXLocationChangedEventName, ABI49_0_0EXHeadingChangedEventName];
}
...
ABI49_0_0EX_EXPORT_METHOD_AS(getProviderStatusAsync,
...
ABI49_0_0EX_EXPORT_METHOD_AS(getCurrentPositionAsync,
                    ...
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  __block ABI49_0_0EXLocationDelegate *delegate;

  delegate = [[ABI49_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (delegate != nil) {
      if (locations.lastObject != nil) {
        resolve([ABI49_0_0EXLocation exportLocation:locations.lastObject]);
      } else {
...
ABI49_0_0EX_EXPORT_METHOD_AS(watchPositionImplAsync,
                    ...
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  ABI49_0_0EXLocationDelegate *delegate = [[ABI49_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject != nil && weakSelf != nil) {
      ...
      NSDictionary *body = @{
                             @"watchId": watchId,
                             @"location": [ABI49_0_0EXLocation exportLocation:loc],
                             };

      [strongSelf->_eventEmitter sendEventWithName:ABI49_0_0EXLocationChangedEventName body:body];
    }
  } onUpdateHeadings:nil onError:^(NSError *error) {
    // TODO: report errors
...
ABI49_0_0EX_EXPORT_METHOD_AS(getLastKnownPositionAsync,
                    ...
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  if ([self.class isLocation:location validWithOptions:options]) {
    resolve([ABI49_0_0EXLocation exportLocation:location]);
  } else {
    resolve([NSNull null]);
  }
}
...
ABI49_0_0EX_EXPORT_METHOD_AS(watchDeviceHeading,
  ...
  ABI49_0_0EXLocationDelegate *delegate = [[ABI49_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
    if (newHeading != nil && weakSelf != nil) {
      ...
      [strongSelf->_eventEmitter sendEventWithName:ABI49_0_0EXHeadingChangedEventName body:body];
    }
...
ABI49_0_0EX_EXPORT_METHOD_AS(removeWatchAsync,
                    watchId:(nonnull NSNumber *)watchId
                    resolver:(ABI49_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ABI49_0_0EXLocationDelegate *delegate = _delegates[watchId];
...
ABI49_0_0EX_EXPORT_METHOD_AS(geocodeAsync,
...
ABI49_0_0EX_EXPORT_METHOD_AS(reverseGeocodeAsync,
    ...
    if (!error) {
      ...
      for (CLPlacemark* placemark in placemarks) {
        NSDictionary *address = @{
                                  @"city": ABI49_0_0UMNullIfNil(placemark.locality),
                                  @"district": ABI49_0_0UMNullIfNil(placemark.subLocality),
                                  @"streetNumber": ABI49_0_0UMNullIfNil(placemark.subThoroughfare),
                                  @"street": ABI49_0_0EXNullIfNil(placemark.thoroughfare),
                                  @"region": ABI49_0_0EXNullIfNil(placemark.administrativeArea),
                                  @"subregion": ABI49_0_0EXNullIfNil(placemark.subAdministrativeArea),
                                  @"country": ABI49_0_0EXNullIfNil(placemark.country),
                                  @"postalCode": ABI49_0_0EXNullIfNil(placemark.postalCode),
                                  @"name": ABI49_0_0EXNullIfNil(placemark.name),
                                  @"isoCountryCode": ABI49_0_0EXNullIfNil(placemark.ISOcountryCode),
                                  @"timezone": ABI49_0_0EXNullIfNil(placemark.timeZone.name),
                                  };
                    ...
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  [ABI49_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI49_0_0EXLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
...
ABI49_0_0EX_EXPORT_METHOD_AS(getForegroundPermissionsAsync,
                    getForegroundPermissionsAsync:(ABI49_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  [ABI49_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI49_0_0EXForegroundPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI49_0_0EX_EXPORT_METHOD_AS(requestForegroundPermissionsAsync,
                    requestForegroundPermissionsAsync:(ABI49_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  [ABI49_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI49_0_0EXForegroundPermissionRequester class]
...
ABI49_0_0EX_EXPORT_METHOD_AS(getBackgroundPermissionsAsync,
                    getBackgroundPermissionsAsync:(ABI49_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  [ABI49_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI49_0_0EXBackgroundLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI49_0_0EX_EXPORT_METHOD_AS(requestBackgroundPermissionsAsync,
                    requestBackgroundPermissionsAsync:(ABI49_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  [ABI49_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI49_0_0EXBackgroundLocationPermissionRequester class]
...
ABI49_0_0EX_EXPORT_METHOD_AS(hasServicesEnabledAsync,
                    hasServicesEnabled:(ABI49_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
...
ABI49_0_0EX_EXPORT_METHOD_AS(startLocationUpdatesAsync,
                    ...
                    reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI49_0_0EXLocationTaskConsumer class] options:options];
  }
  @catch (NSException *e) {
...
ABI49_0_0EX_EXPORT_METHOD_AS(stopLocationUpdatesAsync,
                    ...
                    reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI49_0_0EXLocationTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI49_0_0EX_EXPORT_METHOD_AS(hasStartedLocationUpdatesAsync,
                    ...
                    reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI49_0_0EXLocationTaskConsumer class]]));
}

# pragma mark - Geofencing

ABI49_0_0EX_EXPORT_METHOD_AS(startGeofencingAsync,
                    ...
                    reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI49_0_0EXGeofencingTaskConsumer class] options:options];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI49_0_0EX_EXPORT_METHOD_AS(stopGeofencingAsync,
                    ...
                    reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI49_0_0EXGeofencingTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI49_0_0EX_EXPORT_METHOD_AS(hasStartedGeofencingAsync,
                    ...
                    reject:(ABI49_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI49_0_0EXGeofencingTaskConsumer class]]));
}
...
- (CLLocationManager *)locationManagerWithOptions:(nullable NSDictionary *)options
{
  ...
  if (options) {
    ...
    if (options[@"accuracy"]) {
      ABI49_0_0EXLocationAccuracy accuracy = [options[@"accuracy"] unsignedIntegerValue] ?: ABI49_0_0EXLocationAccuracyBalanced;
...
- (BOOL)checkForegroundPermissions:(ABI49_0_0EXPromiseRejectBlock)reject
{
  if (![CLLocationManager locationServicesEnabled]) {
    reject(@"E_LOCATION_SERVICES_DISABLED", @"Location services are disabled", nil);
    return NO;
  }
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI49_0_0EXForegroundPermissionRequester class]]) {
...
- (BOOL)checkBackgroundPermissions:(ABI49_0_0EXPromiseRejectBlock)reject
{
  if (![CLLocationManager locationServicesEnabled]) {
    reject(@"E_LOCATION_SERVICES_DISABLED", @"Location services are disabled", nil);
    return NO;
  }
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI49_0_0EXBackgroundLocationPermissionRequester class]]) {
...
- (BOOL)checkTaskManagerExists:(ABI49_0_0EXPromiseRejectBlock)reject
{
...
- (BOOL)checkBackgroundServices:(ABI49_0_0EXPromiseRejectBlock)reject
{
...
{
  switch (accuracy) {
    case ABI49_0_0EXLocationAccuracyLowest:
      return kCLLocationAccuracyThreeKilometers;
    case ABI49_0_0EXLocationAccuracyLow:
      return kCLLocationAccuracyKilometer;
    case ABI49_0_0EXLocationAccuracyBalanced:
      return kCLLocationAccuracyHundredMeters;
    case ABI49_0_0EXLocationAccuracyHigh:
      return kCLLocationAccuracyNearestTenMeters;
    case ABI49_0_0EXLocationAccuracyHighest:
      return kCLLocationAccuracyBest;
    case ABI49_0_0EXLocationAccuracyBestForNavigation:
