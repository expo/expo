...
public final class BarCodeScannerModule: Module {
  public func definition() -> ModuleDefinition {
    ...
    Constants([
      ...
      "BarCodeType": ABI49_0_0EXBarCodeScannerUtils.validBarCodeTypes()
    ])
    ...
    OnCreate {
      ...
      ABI49_0_0EXPermissionsMethodsDelegate.register(
        [ABI49_0_0EXBareCodeCameraRequester()],
    ...
    AsyncFunction("getPermissionsAsync") { (promise: Promise) in
      ABI49_0_0EXPermissionsMethodsDelegate.getPermissionWithPermissionsManager(
        ...
        withRequester: ABI49_0_0EXBareCodeCameraRequester.self,
    ...
    View(ABI49_0_0EXBarCodeScannerView.self) {
  ...
  private func getResultFrom(_ features: [CIFeature]) -> [[AnyHashable: Any]?] {
    ...
    for feature in features {
      if let qrCodeFeature = feature as? CIQRCodeFeature {
        let item = ABI49_0_0EXBarCodeScannerUtils.ciQRCodeFeature(
