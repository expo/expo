...
#import <ABI49_0_0EXBarCodeScanner/ABI49_0_0EXBarCodeScannerUtils.h>
#import <ABI49_0_0EXBarCodeScanner/ABI49_0_0EXBarCodeCameraRequester.h>
...
@interface ABI49_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI49_0_0EXBarCodeScanner *barCodeScanner;
...
@implementation ABI49_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI49_0_0EXModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI49_0_0EXAppLifecycleListener)];
...
{
  ABI49_0_0EX_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI49_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI49_0_0EXBareCodeCameraRequester class]]) {
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI49_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI49_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI49_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI49_0_0EXBarCodeScanner *barCodeScanner = [ABI49_0_0EXBarCodeScanner new];
