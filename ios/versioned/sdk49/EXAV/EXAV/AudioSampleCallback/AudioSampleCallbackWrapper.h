...
// TODO: Replace this with just ABI49_0_0facebook::react namespace after we upgrade to RN 0.66
using JsiCallbackWrapper = ABI49_0_0expo::CallbackWrapper;
using LongLivedObjectCollection = ABI49_0_0expo::LongLivedObjectCollection;
