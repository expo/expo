...
#import <ABI49_0_0EXAV/AudioSampleCallbackWrapper.h>

namespace jsi = ABI49_0_0facebook::jsi;
using CallInvoker = ABI49_0_0facebook::ABI49_0_0React::CallInvoker;
using namespace ABI49_0_0expo::av;
...
@implementation ABI49_0_0EXAV (AudioSampleCallback)
                 ...
                 withSoundDictionary:(NSMutableDictionary <NSNumber *, ABI49_0_0EXAVPlayerData *> *)soundDictionary
{
  ...
  auto setAudioSampleCallback = [weakCallInvoker, weakSoundDictionary](jsi::Runtime &runtime,
    ...
    if (argsCount > 1 && args[1].isObject()) {
      ...
      ABI49_0_0EXAudioSampleCallback* objcWrapper = [[ABI49_0_0EXAudioSampleCallback alloc] initWithCallbackWrapper:(std::move(wrapper))];
