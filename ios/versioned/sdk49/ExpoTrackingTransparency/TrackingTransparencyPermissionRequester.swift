...
public class TrackingTransparencyPermissionRequester: NSObject, ABI49_0_0EXPermissionsRequester {
  static public func permissionType() -> String {
    return "appTracking"
  }

  public func requestPermissions(resolver resolve: @escaping ABI49_0_0EXPromiseResolveBlock, rejecter reject: ABI49_0_0EXPromiseRejectBlock) {
    if #available(iOS 14, *) {
  ...
  public func getPermissions() -> [AnyHashable: Any] {
    var status: ABI49_0_0EXPermissionStatus
    ...
    if #available(iOS 14, *) {
      ...
      if trackingUsageDescription == nil {
        ABI49_0_0EXFatal(ABI49_0_0EXErrorWithMessage("""
