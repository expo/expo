...
@implementation ABI49_0_0EXProvisioningProfile {
  NSDictionary *_plist;
}

+ (nonnull instancetype)mainProvisioningProfile
{
  static ABI49_0_0EXProvisioningProfile *profile;
...
- (ABI49_0_0EXAppReleaseType)appReleaseType {
  ...
  if (!provisioningPath) {
    ...
    return ABI49_0_0EXAppReleaseSimulator;
#else
    return ABI49_0_0EXAppReleaseAppStore;
#endif
  }
  ...
  if (!mobileProvision) {
    ...
    return ABI49_0_0EXAppReleaseTypeUnknown;
    ...
    return ABI49_0_0EXAppReleaseEnterprise;
    ...
    if ([[entitlements objectForKey:@"get-task-allow"] boolValue]) {
      return ABI49_0_0EXAppReleaseDev;
    } else {
      return ABI49_0_0EXAppReleaseAdHoc;
    }
  } else {
