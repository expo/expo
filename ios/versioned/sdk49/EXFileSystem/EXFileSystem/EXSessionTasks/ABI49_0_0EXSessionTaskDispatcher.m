...
#import <ABI49_0_0EXFileSystem/ABI49_0_0EXSessionTaskDispatcher.h>
#import <ABI49_0_0EXFileSystem/ABI49_0_0EXSessionResumableDownloadTaskDelegate.h>

@interface ABI49_0_0EXSessionTaskDispatcher ()

@property (nonatomic, strong) NSMutableDictionary<NSURLSessionTask *, ABI49_0_0EXSessionTaskDelegate *> *tasks;
@property (nonatomic) BOOL isActive;
@property (nonatomic, weak) id<ABI49_0_0EXSessionHandler> sessionHandler;

@end

@implementation ABI49_0_0EXSessionTaskDispatcher
...
{
  if (_isActive) {
    ABI49_0_0EXSessionTaskDelegate *exTask = _tasks[downloadTask];
    if (exTask) {
...
{
  if (_isActive) {
    ABI49_0_0EXSessionTaskDelegate *exTask = _tasks[task];
    if (exTask) {
...
{
  if (_isActive) {
    ABI49_0_0EXSessionTaskDelegate *exTask = _tasks[dataTask];
