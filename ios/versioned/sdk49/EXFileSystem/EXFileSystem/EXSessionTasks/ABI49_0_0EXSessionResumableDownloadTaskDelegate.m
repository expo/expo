...
@interface ABI49_0_0EXSessionResumableDownloadTaskDelegate ()

@property (strong, nonatomic, readonly) ABI49_0_0EXDownloadDelegateOnWriteCallback onWriteCallback;
@property (weak, nonatomic) ABI49_0_0EXTaskHandlersManager *manager;
@property (strong, nonatomic) NSString *uuid;

@end

@implementation ABI49_0_0EXSessionResumableDownloadTaskDelegate
...
- (instancetype)initWithResolve:(ABI49_0_0EXPromiseResolveBlock)resolve
             ...
             shouldCalculateMd5:(BOOL)shouldCalculateMd5
                onWriteCallback:(ABI49_0_0EXDownloadDelegateOnWriteCallback)onWriteCallback
