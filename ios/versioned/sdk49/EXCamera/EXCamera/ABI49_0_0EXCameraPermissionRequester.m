...
#import <ABI49_0_0EXCamera/ABI49_0_0EXCameraPermissionRequester.h>
...
@implementation ABI49_0_0EXCameraPermissionRequester
...
- (NSDictionary *)getPermissions
{
  ...
  if (!(cameraUsageDescription && microphoneUsageDescription)) {
    ABI49_0_0EXFatal(ABI49_0_0EXErrorWithMessage(@"This app is missing either NSCameraUsageDescription or NSMicrophoneUsageDescription, so audio/video services will fail. Add one of these entries to your bundle's Info.plist."));
