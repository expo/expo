...
@implementation ABI49_0_0EXCameraCameraPermissionRequester
...
- (NSDictionary *)getPermissions
{
  ...
  if (!cameraUsageDescription) {
    ABI49_0_0EXFatal(ABI49_0_0EXErrorWithMessage(@"This app is missing NSCameraUsageDescription, so video services will fail. Add this entry to your bundle's Info.plist."));
