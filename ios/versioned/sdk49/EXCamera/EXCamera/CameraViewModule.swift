...
public final class CameraViewModule: Module {
  public func definition() -> ModuleDefinition {
    ...
    OnCreate {
      ...
      ABI49_0_0EXPermissionsMethodsDelegate.register(
        [ABI49_0_0EXCameraPermissionRequester(), ABI49_0_0EXCameraCameraPermissionRequester(), ABI49_0_0EXCameraMicrophonePermissionRequester()],
    ...
    Constants([
      "Type": [
        "front": ABI49_0_0EXCameraType.front.rawValue,
        "back": ABI49_0_0EXCameraType.back.rawValue
      ],
      "FlashMode": [
        "off": ABI49_0_0EXCameraFlashMode.off.rawValue,
        "on": ABI49_0_0EXCameraFlashMode.on.rawValue,
        "auto": ABI49_0_0EXCameraFlashMode.auto.rawValue,
        "torch": ABI49_0_0EXCameraFlashMode.torch.rawValue
      ],
      "AutoFocus": [
        "on": ABI49_0_0EXCameraAutoFocus.on.rawValue,
        "off": ABI49_0_0EXCameraAutoFocus.off.rawValue
      ],
      "WhiteBalance": [
        "auto": ABI49_0_0EXCameraWhiteBalance.auto.rawValue,
        "sunny": ABI49_0_0EXCameraWhiteBalance.sunny.rawValue,
        "cloudy": ABI49_0_0EXCameraWhiteBalance.cloudy.rawValue,
        "shadow": ABI49_0_0EXCameraWhiteBalance.shadow.rawValue,
        "incandescent": ABI49_0_0EXCameraWhiteBalance.incandescent.rawValue,
        "fluorescent": ABI49_0_0EXCameraWhiteBalance.fluorescent.rawValue
      ],
      "VideoQuality": [
        "2160p": ABI49_0_0EXCameraVideoResolution.video2160p.rawValue,
        "1080p": ABI49_0_0EXCameraVideoResolution.video1080p.rawValue,
        "720p": ABI49_0_0EXCameraVideoResolution.video720p.rawValue,
        "480p": ABI49_0_0EXCameraVideoResolution.video4x3.rawValue,
        "4:3": ABI49_0_0EXCameraVideoResolution.video4x3.rawValue
      ],
      "VideoStabilization": [
        "off": ABI49_0_0EXCameraVideoStabilizationMode.videoStabilizationModeOff.rawValue,
        "standard": ABI49_0_0EXCameraVideoStabilizationMode.videoStabilizationModeStandard.rawValue,
        "cinematic": ABI49_0_0EXCameraVideoStabilizationMode.videoStabilizationModeCinematic.rawValue,
        "auto": ABI49_0_0EXCameraVideoStabilizationMode.avCaptureVideoStabilizationModeAuto.rawValue
      ],
      "VideoCodec": [
        "H264": ABI49_0_0EXCameraVideoCodec.H264.rawValue,
        "HEVC": ABI49_0_0EXCameraVideoCodec.HEVC.rawValue,
        "JPEG": ABI49_0_0EXCameraVideoCodec.JPEG.rawValue,
        "AppleProRes422": ABI49_0_0EXCameraVideoCodec.appleProRes422.rawValue,
        "AppleProRes4444": ABI49_0_0EXCameraVideoCodec.appleProRes4444.rawValue
      ]
    ])

    View(ABI49_0_0EXCamera.self) {
      Events(
        "onCameraReady",
        "onMountError",
        "onPictureSaved",
      ...
      Prop("flashMode") { (view, flashMode: Int) in
        if let flashMode = ABI49_0_0EXCameraFlashMode(rawValue: flashMode), view.flashMode != flashMode {
    ...
    AsyncFunction("takePicture") { (options: TakePictureOptions, viewTag: Int, promise: Promise) in
      guard let view = self.appContext?.findView(withTag: viewTag, ofType: ABI49_0_0EXCamera.self) else {
        throw Exceptions.ViewNotFound((tag: viewTag, type: ABI49_0_0EXCamera.self))
      }
    ...
    AsyncFunction("getPermissionsAsync") { (promise: Promise) in
      ABI49_0_0EXPermissionsMethodsDelegate.getPermissionWithPermissionsManager(
        ...
        withRequester: ABI49_0_0EXCameraPermissionRequester.self,
    ...
    AsyncFunction("getCameraPermissionsAsync") { (promise: Promise) in
      ABI49_0_0EXPermissionsMethodsDelegate.getPermissionWithPermissionsManager(
        self.appContext?.permissions,
        withRequester: ABI49_0_0EXCameraCameraPermissionRequester.self,
        resolve: promise.resolver,
        reject: promise.legacyRejecter
      )
    }
    ...
    AsyncFunction("getMicrophonePermissionsAsync") { (promise: Promise) in
      ABI49_0_0EXPermissionsMethodsDelegate.getPermissionWithPermissionsManager(
        self.appContext?.permissions,
        withRequester: ABI49_0_0EXCameraMicrophonePermissionRequester.self,
        resolve: promise.resolver,
        reject: promise.legacyRejecter
      )
    }
...
private func takePictureForSimulator(_ appContext: AppContext?, _ view: ABI49_0_0EXCamera, _ options: TakePictureOptions, _ promise: Promise) throws {
  if options.fastMode {
    promise.resolve()
  }
...
private func generatePictureForSimulator(appContext: AppContext?, options: TakePictureOptions) throws -> [String: Any?] {
  ...
  let generatedPhoto = ABI49_0_0EXCameraUtils.generatePhoto(of: CGSize(width: 200, height: 200))
  let photoData = generatedPhoto.jpegData(compressionQuality: options.quality)

  return [
    "uri": ABI49_0_0EXCameraUtils.writeImage(photoData, toPath: path),
...
private func getAvailableVideoCodecs() -> [String] {
  ...
  guard let captureDevice = ABI49_0_0EXCameraUtils.device(withMediaType: AVMediaType.video.rawValue, preferring: AVCaptureDevice.Position.front) else {
    return []
  }
