...
public class CameraPermissionRequester: NSObject, ABI49_0_0EXPermissionsRequester {
...
public class MediaLibraryPermissionRequester: DefaultMediaLibraryPermissionRequester,
                                              ABI49_0_0EXPermissionsRequester {
...
/**
 * This extension is adding default implmentation for ABI49_0_0EXPermissionsRequester that can be shared by many classe.
 ...
 * to this extension. I'm using as a mixin that implements major part of ABI49_0_0EXPermissionsRequester protocol.
 */
