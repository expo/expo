...
#import <ABI49_0_0ExpoModulesCore/ABI49_0_0EXJSIInstaller.h>
...
#import <ABI49_0_0ExpoModulesCore/LazyObject.h>
...
@interface ABI49_0_0RCTBridge (ExpoBridgeWithRuntime)
...
@implementation ABI49_0_0EXJavaScriptRuntimeManager

+ (nullable ABI49_0_0EXRuntime *)runtimeFromBridge:(nonnull ABI49_0_0RCTBridge *)bridge
{
  jsi::Runtime *jsiRuntime = [bridge respondsToSelector:@selector(runtime)] ? reinterpret_cast<jsi::Runtime *>(bridge.runtime) : nullptr;
  return jsiRuntime ? [[ABI49_0_0EXRuntime alloc] initWithRuntime:jsiRuntime callInvoker:bridge.jsCallInvoker] : nil;
}

+ (BOOL)installExpoModulesHostObject:(nonnull ABI49_0_0EXAppContext *)appContext
{
  ABI49_0_0EXRuntime *runtime = [appContext _runtime];
  ...
  ABI49_0_0EXJavaScriptObject *global = [runtime global];
  ABI49_0_0EXJavaScriptObject *coreObject = [runtime coreObject];

  if ([coreObject hasProperty:modulesHostObjectPropertyName]) {
    return false;
  }

  std::shared_ptr<ABI49_0_0expo::ExpoModulesHostObject> modulesHostObjectPtr = std::make_shared<ABI49_0_0expo::ExpoModulesHostObject>(appContext);
  ABI49_0_0EXJavaScriptObject *modulesHostObject = [runtime createHostObject:modulesHostObjectPtr];
  ...
  [coreObject defineProperty:modulesHostObjectPropertyName
                     ...
                     options:ABI49_0_0EXJavaScriptObjectPropertyDescriptorEnumerable];
