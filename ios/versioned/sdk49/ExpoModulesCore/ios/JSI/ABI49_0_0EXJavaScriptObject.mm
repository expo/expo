...
@implementation ABI49_0_0EXJavaScriptObject {
  /**
  ...
  /**
   Shared pointer to the original JSI object that is being wrapped by `ABI49_0_0EXJavaScriptObject` class.
   */
...
- (nonnull ABI49_0_0EXJavaScriptValue *)getProperty:(nonnull NSString *)name
{
  ...
  return [[ABI49_0_0EXJavaScriptValue alloc] initWithRuntime:_runtime value:value];
}
...
- (nonnull NSArray<NSString *> *)getPropertyNames
{
  ...
  return ABI49_0_0expo::convertJSIArrayToNSArray(*runtime, propertyNamesArray, nullptr);
}
...
{
  jsi::Value jsiValue = ABI49_0_0expo::convertObjCObjectToJSIValue(*[_runtime get], value);
...
- (void)defineProperty:(nonnull NSString *)name value:(nullable id)value options:(ABI49_0_0EXJavaScriptObjectPropertyDescriptor)options
{
  ...
  descriptor.setProperty(*runtime, "value", ABI49_0_0expo::convertObjCObjectToJSIValue(*runtime, value));
...
{
  return [[ABI49_0_0EXJavaScriptWeakObject alloc] initWith:_jsObjectPtr runtime:_runtime];
}
...
{
  ABI49_0_0expo::setDeallocator(*[_runtime get], _jsObjectPtr, deallocatorBlock);
}
...
{
  if ([object isKindOfClass:ABI49_0_0EXJavaScriptObject.class]) {
    jsi::Runtime *runtime = [_runtime get];
...
- (jsi::Object)preparePropertyDescriptorWithOptions:(ABI49_0_0EXJavaScriptObjectPropertyDescriptor)options
{
  jsi::Runtime *runtime = [_runtime get];
  jsi::Object descriptor(*runtime);
  descriptor.setProperty(*runtime, "configurable", (bool)(options & ABI49_0_0EXJavaScriptObjectPropertyDescriptorConfigurable));
  descriptor.setProperty(*runtime, "enumerable", (bool)(options & ABI49_0_0EXJavaScriptObjectPropertyDescriptorEnumerable));
  descriptor.setProperty(*runtime, "writable", (bool)(options & ABI49_0_0EXJavaScriptObjectPropertyDescriptorWritable));
  return descriptor;
}
