...
@protocol ABI49_0_0EXTaskConsumerInterface;

@protocol ABI49_0_0EXTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI49_0_0EXTaskConsumerInterface> __nonnull consumer;
