...
@implementation ABI49_0_0EXLegacyAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitializedAndSorted {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI49_0_0EXSingletonModule*> * singletonModules = [[ABI49_0_0EXModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI49_0_0EXSingletonModule *singletonModule in singletonModules) {
