...
/**
 ...
 - Creating and owning the `AppContext` when the Expo modules architecture is automatically initialized
   by ABI49_0_0React Native (as opposed to native unit tests, where ABI49_0_0React Native is not used at all).
 - Installing the host object to the runtime.
 */
@objc(ABI49_0_0ExpoBridgeModule)
public final class ABI49_0_0ExpoBridgeModule: NSObject, ABI49_0_0RCTBridgeModule {
  @objc
  public let appContext: AppContext

  /**
   The initializer that is used by ABI49_0_0React Native when it loads bridge modules.
  ...
  public var bridge: ABI49_0_0RCTBridge! {
    didSet {
      ...
      let attachRuntime = { [weak self] in
        ...
        self.appContext._runtime = ABI49_0_0EXJavaScriptRuntimeManager.runtime(fromBridge: bridge)
      }
      ...
      if bridge.responds(to: Selector(("runtime"))) {
        ...
        if result == nil {
          ...
          bridge.dispatchBlock({ [weak self] in
            ...
            bridge.dispatchBlock(attachRuntime, queue: ABI49_0_0RCTJSThread)
  ...
  /**
   This should be called inside ABI49_0_0EXNativeModulesProxy.setBridge()
   */
  @objc
  public func legacyProxyDidSetBridge(legacyModulesProxy: LegacyNativeModulesProxy,
                                      legacyModuleRegistry: ABI49_0_0EXModuleRegistry) {
    ...
    appContext.useModulesProvider("ABI49_0_0ExpoModulesProvider")
