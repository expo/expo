...
public struct Promise: AnyArgument {
  ...
  /**
   The rejecter that is compatible with the legacy `ABI49_0_0EXPromiseRejectBlock`.
   Necessary in some places not converted to Swift, such as `ABI49_0_0EXPermissionsMethodsDelegate`.
   */
  public var legacyRejecter: ABI49_0_0EXPromiseRejectBlock {
