...
public struct Exceptions {
  ...
  /**
   An exception to throw when there is no module implementing the `ABI49_0_0EXFileSystemInterface` interface.
   */
  ...
  /**
   An exception to throw when there is no module implementing the `ABI49_0_0EXPermissionsInterface` interface.
