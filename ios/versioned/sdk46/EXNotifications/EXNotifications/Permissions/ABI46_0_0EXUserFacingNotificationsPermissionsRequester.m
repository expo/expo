...
@interface ABI46_0_0EXUserFacingNotificationsPermissionsRequester ()

@property (nonatomic, assign) dispatch_queue_t methodQueue;

@end

@implementation ABI46_0_0EXUserFacingNotificationsPermissionsRequester
...
- (NSDictionary *)getPermissions
{
  ...
  __block ABI46_0_0EXPermissionStatus generalStatus = ABI46_0_0EXPermissionStatusUndetermined;

  [[UNUserNotificationCenter currentNotificationCenter] getNotificationSettingsWithCompletionHandler:^(UNNotificationSettings *settings) {
    if (settings.authorizationStatus == UNAuthorizationStatusAuthorized) {
      generalStatus = ABI46_0_0EXPermissionStatusGranted;
    } else if (settings.authorizationStatus == UNAuthorizationStatusDenied) {
      generalStatus = ABI46_0_0EXPermissionStatusDenied;
    }
...
- (void)requestPermissions:(NSDictionary *)permissions withResolver:(ABI46_0_0EXPromiseResolveBlock)resolve rejecter:(ABI46_0_0EXPromiseRejectBlock)reject
{
...
- (void)requestAuthorizationOptions:(UNAuthorizationOptions)options withResolver:(ABI46_0_0EXPromiseResolveBlock)resolve rejecter:(ABI46_0_0EXPromiseRejectBlock)reject
{
