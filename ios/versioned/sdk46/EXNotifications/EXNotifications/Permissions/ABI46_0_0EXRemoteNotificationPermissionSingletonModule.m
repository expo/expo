...
@interface ABI46_0_0EXRemoteNotificationPermissionSingletonModule ()

@property (nonatomic, strong) NSPointerArray *delegates;

@end

@implementation ABI46_0_0EXRemoteNotificationPermissionSingletonModule

ABI46_0_0EX_REGISTER_SINGLETON_MODULE(RemoteNotificationPermissionPublisher);
