...
#define ABI46_0_0EX_UNVERSIONED(symbol) symbol

static NSString * const kEXDeviceInstallationUUIDKey = ABI46_0_0EX_UNVERSIONED(@"ABI46_0_0EXDeviceInstallationUUIDKey");
static NSString * const kEXDeviceInstallationUUIDLegacyKey = ABI46_0_0EX_UNVERSIONED(@"ABI46_0_0EXDeviceInstallUUIDKey");

static NSString * const kEXRegistrationInfoKey = ABI46_0_0EX_UNVERSIONED(@"ABI46_0_0EXNotificationRegistrationInfoKey");

@implementation ABI46_0_0EXServerRegistrationModule

ABI46_0_0EX_EXPORT_MODULE(NotificationsServerRegistrationModule)

ABI46_0_0EX_EXPORT_METHOD_AS(getInstallationIdAsync,
                    getInstallationIdAsyncWithResolver:(ABI46_0_0EXPromiseResolveBlock)resolve
...
ABI46_0_0EX_EXPORT_METHOD_AS(getRegistrationInfoAsync,
                    getRegistrationInfoAsyncWithResolver:(ABI46_0_0EXPromiseResolveBlock)resolve
                                                rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  CFTypeRef keychainResult = NULL;
...
ABI46_0_0EX_EXPORT_METHOD_AS(setRegistrationInfoAsync,
