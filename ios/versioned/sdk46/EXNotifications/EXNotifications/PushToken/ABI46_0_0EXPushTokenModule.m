...
#import <ABI46_0_0EXNotifications/ABI46_0_0EXPushTokenModule.h>
#import <ABI46_0_0EXNotifications/ABI46_0_0EXPushTokenManager.h>
...
@interface ABI46_0_0EXPushTokenModule ()

@property (nonatomic, weak) id<ABI46_0_0EXPushTokenManager> pushTokenManager;
...
@property (nonatomic, strong) ABI46_0_0EXPromiseResolveBlock getDevicePushTokenResolver;
@property (nonatomic, strong) ABI46_0_0EXPromiseRejectBlock getDevicePushTokenRejecter;

@end

@implementation ABI46_0_0EXPushTokenModule

ABI46_0_0EX_EXPORT_MODULE(ExpoPushTokenManager);

# pragma mark - Exported methods

ABI46_0_0EX_EXPORT_METHOD_AS(getDevicePushTokenAsync,
                    getDevicePushTokenResolving:(ABI46_0_0EXPromiseResolveBlock)resolve rejecting:(ABI46_0_0EXPromiseRejectBlock)reject)
{
...
ABI46_0_0EX_EXPORT_METHOD_AS(unregisterForNotificationsAsync,
        	    unregisterForNotificationsAsync:(ABI46_0_0EXPromiseResolveBlock)resolve reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
...
# pragma mark - ABI46_0_0EXPushTokenListener
