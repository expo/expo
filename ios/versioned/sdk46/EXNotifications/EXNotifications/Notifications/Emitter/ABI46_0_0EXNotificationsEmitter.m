...
@interface ABI46_0_0EXNotificationsEmitter ()
...
@implementation ABI46_0_0EXNotificationsEmitter

ABI46_0_0EX_EXPORT_MODULE(ExpoNotificationsEmitter);

ABI46_0_0EX_EXPORT_METHOD_AS(getLastNotificationResponseAsync,
                    getLastNotificationResponseAsyncWithResolver:(ABI46_0_0EXPromiseResolveBlock)resolve reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
...
{
  // Silence ABI46_0_0React Native warning: "Sending ... with no listeners registered."
...
{
  return [ABI46_0_0EXNotificationSerializer serializedNotification:notification];
}

- (NSDictionary *)serializedNotificationResponse:(UNNotificationResponse *)notificationResponse
{
  return [ABI46_0_0EXNotificationSerializer serializedNotificationResponse:notificationResponse];
}
