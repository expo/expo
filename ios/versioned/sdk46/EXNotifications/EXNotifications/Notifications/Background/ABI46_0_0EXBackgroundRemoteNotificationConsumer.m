...
@implementation ABI46_0_0EXBackgroundRemoteNotificationConsumer

+ (BOOL)supportsLaunchReason:(ABI46_0_0EXTaskLaunchReason)launchReason
{
  return launchReason == ABI46_0_0EXTaskLaunchReasonRemoteNotification;
}
...
- (void)didRegisterTask:(id<ABI46_0_0EXTaskInterface>)task
{
  _task = task;
}
...
- (NSUInteger)normalizeTaskResult:(id)result
{
  ...
  switch ([result unsignedIntegerValue]) {
    case ABI46_0_0EXBackgroundNotificationResultNewData:
      return UIBackgroundFetchResultNewData;
    case ABI46_0_0EXBackgroundNotificationResultFailed:
      return UIBackgroundFetchResultFailed;
    case ABI46_0_0EXBackgroundNotificationResultNoData:
    default:
      return UIBackgroundFetchResultNoData;
  }
}
