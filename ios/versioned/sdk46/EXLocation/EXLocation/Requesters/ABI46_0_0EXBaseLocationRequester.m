...
@interface ABI46_0_0EXBaseLocationRequester () <CLLocationManagerDelegate>
...
@implementation ABI46_0_0EXBaseLocationRequester
...
# pragma mark - ABI46_0_0UMPermissionsRequester

- (NSDictionary *)getPermissions {

  CLAuthorizationStatus systemStatus;
  if (![ABI46_0_0EXBaseLocationRequester isConfiguredForAlwaysAuthorization] && ![ABI46_0_0EXBaseLocationRequester isConfiguredForWhenInUseAuthorization]) {
    ABI46_0_0EXFatal(ABI46_0_0EXErrorWithMessage(@"This app is missing usage descriptions, so location services will fail. Add one of the `NSLocation*UsageDescription` keys to your bundle's Info.plist. See https://bit.ly/3iLqy6S (https://docs.expo.dev/distribution/app-stores/#system-permissions-dialogs-on-ios) for more information."));
...
- (void)requestPermissionsWithResolver:(ABI46_0_0EXPromiseResolveBlock)resolve rejecter:(ABI46_0_0EXPromiseRejectBlock)reject {
  ...
  if (existingPermissions && [existingPermissions[@"status"] intValue] != ABI46_0_0EXPermissionStatusUndetermined) {
