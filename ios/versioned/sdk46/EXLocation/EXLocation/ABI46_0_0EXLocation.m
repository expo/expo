...
#import <ABI46_0_0EXLocation/ABI46_0_0EXLocation.h>
#import <ABI46_0_0EXLocation/ABI46_0_0EXLocationDelegate.h>
#import <ABI46_0_0EXLocation/ABI46_0_0EXLocationTaskConsumer.h>
#import <ABI46_0_0EXLocation/ABI46_0_0EXGeofencingTaskConsumer.h>
#import <ABI46_0_0EXLocation/ABI46_0_0EXLocationPermissionRequester.h>
#import <ABI46_0_0EXLocation/ABI46_0_0EXForegroundPermissionRequester.h>
#import <ABI46_0_0EXLocation/ABI46_0_0EXBackgroundLocationPermissionRequester.h>
...
NSString * const ABI46_0_0EXLocationChangedEventName = @"Expo.locationChanged";
NSString * const ABI46_0_0EXHeadingChangedEventName = @"Expo.headingChanged";

@interface ABI46_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI46_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) NSMutableSet<ABI46_0_0EXLocationDelegate *> *retainedDelegates;
...
@property (nonatomic, weak) id<ABI46_0_0EXTaskManagerInterface> tasksManager;

@end

@implementation ABI46_0_0EXLocation

ABI46_0_0EX_EXPORT_MODULE(ExpoLocation);
...
- (void)setModuleRegistry:(ABI46_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  _tasksManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI46_0_0EXTaskManagerInterface)];

  _permissionsManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI46_0_0EXPermissionsInterface)];
  [ABI46_0_0EXPermissionsMethodsDelegate registerRequesters:@[
    [ABI46_0_0EXLocationPermissionRequester new],
    [ABI46_0_0EXForegroundPermissionRequester new],
    [ABI46_0_0EXBackgroundLocationPermissionRequester new]
...
{
  return @[ABI46_0_0EXLocationChangedEventName, ABI46_0_0EXHeadingChangedEventName];
}
...
ABI46_0_0EX_EXPORT_METHOD_AS(getProviderStatusAsync,
...
ABI46_0_0EX_EXPORT_METHOD_AS(getCurrentPositionAsync,
                    ...
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  __block ABI46_0_0EXLocationDelegate *delegate;

  delegate = [[ABI46_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (delegate != nil) {
      if (locations.lastObject != nil) {
        resolve([ABI46_0_0EXLocation exportLocation:locations.lastObject]);
      } else {
...
ABI46_0_0EX_EXPORT_METHOD_AS(watchPositionImplAsync,
                    ...
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  ABI46_0_0EXLocationDelegate *delegate = [[ABI46_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject != nil && weakSelf != nil) {
      ...
      NSDictionary *body = @{
                             @"watchId": watchId,
                             @"location": [ABI46_0_0EXLocation exportLocation:loc],
                             };

      [strongSelf->_eventEmitter sendEventWithName:ABI46_0_0EXLocationChangedEventName body:body];
    }
  } onUpdateHeadings:nil onError:^(NSError *error) {
    // TODO: report errors
...
ABI46_0_0EX_EXPORT_METHOD_AS(getLastKnownPositionAsync,
                    ...
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  if ([self.class isLocation:location validWithOptions:options]) {
    resolve([ABI46_0_0EXLocation exportLocation:location]);
  } else {
    resolve([NSNull null]);
  }
}
...
ABI46_0_0EX_EXPORT_METHOD_AS(watchDeviceHeading,
  ...
  ABI46_0_0EXLocationDelegate *delegate = [[ABI46_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
    if (newHeading != nil && weakSelf != nil) {
      ...
      [strongSelf->_eventEmitter sendEventWithName:ABI46_0_0EXHeadingChangedEventName body:body];
    }
...
ABI46_0_0EX_EXPORT_METHOD_AS(removeWatchAsync,
                    watchId:(nonnull NSNumber *)watchId
                    resolver:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ABI46_0_0EXLocationDelegate *delegate = _delegates[watchId];
...
ABI46_0_0EX_EXPORT_METHOD_AS(geocodeAsync,
...
ABI46_0_0EX_EXPORT_METHOD_AS(reverseGeocodeAsync,
    ...
    if (!error) {
      ...
      for (CLPlacemark* placemark in placemarks) {
        NSDictionary *address = @{
                                  @"city": ABI46_0_0UMNullIfNil(placemark.locality),
                                  @"district": ABI46_0_0UMNullIfNil(placemark.subLocality),
                                  @"streetNumber": ABI46_0_0UMNullIfNil(placemark.subThoroughfare),
                                  @"street": ABI46_0_0EXNullIfNil(placemark.thoroughfare),
                                  @"region": ABI46_0_0EXNullIfNil(placemark.administrativeArea),
                                  @"subregion": ABI46_0_0EXNullIfNil(placemark.subAdministrativeArea),
                                  @"country": ABI46_0_0EXNullIfNil(placemark.country),
                                  @"postalCode": ABI46_0_0EXNullIfNil(placemark.postalCode),
                                  @"name": ABI46_0_0EXNullIfNil(placemark.name),
                                  @"isoCountryCode": ABI46_0_0EXNullIfNil(placemark.ISOcountryCode),
                                  @"timezone": ABI46_0_0EXNullIfNil(placemark.timeZone.name),
                                  };
                    ...
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  [ABI46_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI46_0_0EXLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
...
ABI46_0_0EX_EXPORT_METHOD_AS(getForegroundPermissionsAsync,
                    getForegroundPermissionsAsync:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  [ABI46_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI46_0_0EXForegroundPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI46_0_0EX_EXPORT_METHOD_AS(requestForegroundPermissionsAsync,
                    requestForegroundPermissionsAsync:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  [ABI46_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI46_0_0EXForegroundPermissionRequester class]
...
ABI46_0_0EX_EXPORT_METHOD_AS(getBackgroundPermissionsAsync,
                    getBackgroundPermissionsAsync:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  [ABI46_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI46_0_0EXBackgroundLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI46_0_0EX_EXPORT_METHOD_AS(requestBackgroundPermissionsAsync,
                    requestBackgroundPermissionsAsync:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  [ABI46_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI46_0_0EXBackgroundLocationPermissionRequester class]
...
ABI46_0_0EX_EXPORT_METHOD_AS(hasServicesEnabledAsync,
                    hasServicesEnabled:(ABI46_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
...
ABI46_0_0EX_EXPORT_METHOD_AS(startLocationUpdatesAsync,
                    ...
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI46_0_0EXLocationTaskConsumer class] options:options];
  }
  @catch (NSException *e) {
...
ABI46_0_0EX_EXPORT_METHOD_AS(stopLocationUpdatesAsync,
                    ...
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI46_0_0EXLocationTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI46_0_0EX_EXPORT_METHOD_AS(hasStartedLocationUpdatesAsync,
                    ...
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI46_0_0EXLocationTaskConsumer class]]));
}

# pragma mark - Geofencing

ABI46_0_0EX_EXPORT_METHOD_AS(startGeofencingAsync,
                    ...
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI46_0_0EXGeofencingTaskConsumer class] options:options];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI46_0_0EX_EXPORT_METHOD_AS(stopGeofencingAsync,
                    ...
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI46_0_0EXGeofencingTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI46_0_0EX_EXPORT_METHOD_AS(hasStartedGeofencingAsync,
                    ...
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI46_0_0EXGeofencingTaskConsumer class]]));
}
...
- (CLLocationManager *)locationManagerWithOptions:(nullable NSDictionary *)options
{
  ...
  if (options) {
    ...
    if (options[@"accuracy"]) {
      ABI46_0_0EXLocationAccuracy accuracy = [options[@"accuracy"] unsignedIntegerValue] ?: ABI46_0_0EXLocationAccuracyBalanced;
...
- (BOOL)checkForegroundPermissions:(ABI46_0_0EXPromiseRejectBlock)reject
{
  if (![CLLocationManager locationServicesEnabled]) {
    reject(@"E_LOCATION_SERVICES_DISABLED", @"Location services are disabled", nil);
    return NO;
  }
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI46_0_0EXForegroundPermissionRequester class]]) {
...
- (BOOL)checkBackgroundPermissions:(ABI46_0_0EXPromiseRejectBlock)reject
{
  if (![CLLocationManager locationServicesEnabled]) {
    reject(@"E_LOCATION_SERVICES_DISABLED", @"Location services are disabled", nil);
    return NO;
  }
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI46_0_0EXBackgroundLocationPermissionRequester class]]) {
...
- (BOOL)checkTaskManagerExists:(ABI46_0_0EXPromiseRejectBlock)reject
{
...
- (BOOL)checkBackgroundServices:(ABI46_0_0EXPromiseRejectBlock)reject
{
...
{
  switch (accuracy) {
    case ABI46_0_0EXLocationAccuracyLowest:
      return kCLLocationAccuracyThreeKilometers;
    case ABI46_0_0EXLocationAccuracyLow:
      return kCLLocationAccuracyKilometer;
    case ABI46_0_0EXLocationAccuracyBalanced:
      return kCLLocationAccuracyHundredMeters;
    case ABI46_0_0EXLocationAccuracyHigh:
      return kCLLocationAccuracyNearestTenMeters;
    case ABI46_0_0EXLocationAccuracyHighest:
      return kCLLocationAccuracyBest;
    case ABI46_0_0EXLocationAccuracyBestForNavigation:
