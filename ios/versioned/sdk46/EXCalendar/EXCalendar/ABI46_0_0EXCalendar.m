...
#import <ABI46_0_0EXCalendar/ABI46_0_0EXCalendar.h>
#import <ABI46_0_0EXCalendar/ABI46_0_0EXCalendarConverter.h>
...
@implementation ABI46_0_0EXCalendar
...
ABI46_0_0EX_EXPORT_MODULE(ExpoCalendar);
...
- (void)setModuleRegistry:(ABI46_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  [ABI46_0_0EXPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI46_0_0EXCalendarPermissionRequester new],
                                                    [ABI46_0_0EXRemindersPermissionRequester new]
                                                    ]
...
ABI46_0_0EX_EXPORT_METHOD_AS(getCalendarsAsync,
                    ...
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve([ABI46_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI46_0_0EX_EXPORT_METHOD_AS(getDefaultCalendarAsync,
                    getDefaultCalendarAsync:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejector:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  if (![self _checkCalendarPermissions:reject]) {
    return;
  }
  ...
  resolve([ABI46_0_0EXCalendarConverter serializeCalendar:defaultCalendar]);
}

ABI46_0_0EX_EXPORT_METHOD_AS(saveCalendarAsync,
                    ...
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (color) {
    calendar.CGColor = [ABI46_0_0EXUtilities UIColor:color].CGColor;
...
ABI46_0_0EX_EXPORT_METHOD_AS(deleteCalendarAsync,
...
ABI46_0_0EX_EXPORT_METHOD_AS(getEventsAsync,
                    ...
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI46_0_0EXUtilities NSDate:startDateStr];
  NSDate *endDate = [ABI46_0_0EXUtilities NSDate:endDateStr];
  ...
  if (calendarEvents) {
    resolve([ABI46_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI46_0_0EX_EXPORT_METHOD_AS(getEventByIdAsync,
                    ...
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (calendarEvent) {
    resolve([ABI46_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI46_0_0EX_EXPORT_METHOD_AS(saveEventAsync,
                    ...
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI46_0_0EXUtilities NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI46_0_0EXUtilities NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI46_0_0EXUtilities NSDate:details[@"instanceStartDate"]];
...
ABI46_0_0EX_EXPORT_METHOD_AS(deleteEventAsync,
                    ...
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *instanceStartDate = [ABI46_0_0EXUtilities NSDate:event[@"instanceStartDate"]];
...
ABI46_0_0EX_EXPORT_METHOD_AS(getAttendeesForEventAsync,
                    ...
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (item.hasAttendees) {
    resolve([ABI46_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI46_0_0EX_EXPORT_METHOD_AS(getRemindersAsync,
                    ...
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI46_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI46_0_0EX_EXPORT_METHOD_AS(getReminderByIdAsync,
                    ...
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (reminder) {
    ...
    resolve([ABI46_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI46_0_0EX_EXPORT_METHOD_AS(saveReminderAsync,
                    ...
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI46_0_0EXUtilities NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI46_0_0EXUtilities NSDate:details[@"dueDate"]];
  NSDate *completionDate = [ABI46_0_0EXUtilities NSDate:details[@"completionDate"]];
...
ABI46_0_0EX_EXPORT_METHOD_AS(deleteReminderAsync,
...
ABI46_0_0EX_EXPORT_METHOD_AS(getSourcesAsync,
                    getSourcesAsync:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI46_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI46_0_0EX_EXPORT_METHOD_AS(getSourceByIdAsync,
                    ...
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve([ABI46_0_0EXCalendarConverter serializeSource:source]);
}

ABI46_0_0EX_EXPORT_METHOD_AS(getCalendarPermissionsAsync,
                    getCalendarPermissionsAsync:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  [ABI46_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI46_0_0EXCalendarPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI46_0_0EX_EXPORT_METHOD_AS(requestCalendarPermissionsAsync,
                    requestCalendarPermissionsAsync:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
...
ABI46_0_0EX_EXPORT_METHOD_AS(getRemindersPermissionsAsync,
                    getRemindersPermissionsAsync:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  [ABI46_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI46_0_0EXRemindersPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI46_0_0EX_EXPORT_METHOD_AS(requestRemindersPermissionsAsync,
                    requestRemindersPermissionsAsync:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  [ABI46_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI46_0_0EXRemindersPermissionRequester class]
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI46_0_0EXUtilities NSDate:alarm[@"absoluteDate"]];
...
- (EKRecurrenceRule *)_createRecurrenceRule:(NSDictionary *)recurrenceRule
{
  ...
  if (recurrenceRule[@"endDate"]) {
      endDate = [ABI46_0_0EXUtilities NSDate:recurrenceRule[@"endDate"]];
  }
...
- (BOOL)_checkPermissions:(EKEntityType)entity reject:(ABI46_0_0EXPromiseRejectBlock)reject
{
  ...
  switch (entity) {
    case EKEntityTypeEvent:
      requesterClass = [ABI46_0_0EXCalendarPermissionRequester class];
      break;
    case EKEntityTypeReminder:
      requesterClass = [ABI46_0_0EXRemindersPermissionRequester class];
      break;
    default: {
...
- (BOOL)_checkCalendarPermissions:(ABI46_0_0EXPromiseRejectBlock)reject
{
  return [self _checkPermissions:EKEntityTypeEvent reject:reject];
}

- (BOOL)_checkRemindersPermissions:(ABI46_0_0EXPromiseRejectBlock)reject
{
...
- (void)_initializePermittedEntities
{
  ...
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI46_0_0EXCalendarPermissionRequester class]]) {
    permittedEntities |= EKEntityMaskEvent;
  }
  
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI46_0_0EXRemindersPermissionRequester class]]) {
