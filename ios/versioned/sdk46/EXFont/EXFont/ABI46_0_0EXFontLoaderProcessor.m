...
@interface ABI46_0_0EXFontLoaderProcessor ()
...
@implementation ABI46_0_0EXFontLoaderProcessor
         ...
         scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  ABI46_0_0EXFont *exFont = nil;

  // Did we get a new family, and if so, is it associated with an ABI46_0_0EXFont?
  ...
  // Did the passed-in UIFont come from an ABI46_0_0EXFont?
  if (!exFont && uiFont) {
    exFont = objc_getAssociatedObject(uiFont, ABI46_0_0EXFontAssocKey);
  }

  // If it's an ABI46_0_0EXFont, generate the corresponding UIFont, else fallback to ABI46_0_0React Native's built-in method
  if (exFont) {
