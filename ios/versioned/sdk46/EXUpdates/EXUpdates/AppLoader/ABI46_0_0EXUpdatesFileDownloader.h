...
typedef void (^ABI46_0_0EXUpdatesFileDownloaderSuccessBlock)(NSData *data, NSURLResponse *response);
typedef void (^ABI46_0_0EXUpdatesFileDownloaderWithHashSuccessBlock)(NSData *data, NSURLResponse *response, NSString *base64URLEncodedSHA256Hash);
typedef void (^ABI46_0_0EXUpdatesFileDownloaderManifestSuccessBlock)(ABI46_0_0EXUpdatesUpdate *update);
typedef void (^ABI46_0_0EXUpdatesFileDownloaderErrorBlock)(NSError *error);

@interface ABI46_0_0EXUpdatesFileDownloader : NSObject
