...
@implementation ABI46_0_0EXUpdatesMultipartStreamReader {
...
- (void)emitChunk:(NSData *)data headers:(NSDictionary *)headers callback:(ABI46_0_0RCTMultipartCallback)callback done:(BOOL)done
{
