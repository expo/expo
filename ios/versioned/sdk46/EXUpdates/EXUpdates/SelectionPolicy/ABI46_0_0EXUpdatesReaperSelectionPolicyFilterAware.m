...
@implementation ABI46_0_0EXUpdatesReaperSelectionPolicyFilterAware
...
- (NSArray<ABI46_0_0EXUpdatesUpdate *> *)updatesToDeleteWithLaunchedUpdate:(ABI46_0_0EXUpdatesUpdate *)launchedUpdate updates:(NSArray<ABI46_0_0EXUpdatesUpdate *> *)updates filters:(nullable NSDictionary *)filters
{
  ...
  ABI46_0_0EXUpdatesUpdate *nextNewestUpdate;
  ABI46_0_0EXUpdatesUpdate *nextNewestUpdateMatchingFilters;
  for (ABI46_0_0EXUpdatesUpdate *update in updates) {
    ...
    if ([launchedUpdate.commitTime compare:update.commitTime] == NSOrderedDescending) {
      ...
      if ([ABI46_0_0EXUpdatesSelectionPolicies doesUpdate:update matchFilters:filters] &&
