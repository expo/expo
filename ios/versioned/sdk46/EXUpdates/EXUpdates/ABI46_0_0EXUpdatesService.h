...
typedef void (^ABI46_0_0EXUpdatesAppRelaunchCompletionBlock)(BOOL success);

@protocol ABI46_0_0EXUpdatesModuleInterface

@property (nonatomic, readonly) ABI46_0_0EXUpdatesConfig *config;
@property (nonatomic, readonly) ABI46_0_0EXUpdatesDatabase *database;
@property (nonatomic, readonly) ABI46_0_0EXUpdatesSelectionPolicy *selectionPolicy;
@property (nonatomic, readonly) NSURL *directory;

@property (nullable, nonatomic, readonly, strong) ABI46_0_0EXUpdatesUpdate *embeddedUpdate;
@property (nullable, nonatomic, readonly, strong) ABI46_0_0EXUpdatesUpdate *launchedUpdate;
...
@interface ABI46_0_0EXUpdatesService : NSObject <ABI46_0_0EXInternalModule, ABI46_0_0EXUpdatesModuleInterface>
