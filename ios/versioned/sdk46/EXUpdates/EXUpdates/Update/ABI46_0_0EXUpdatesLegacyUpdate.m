...
static NSString * const ABI46_0_0EXUpdatesExpoAssetBaseUrl = @"https://classic-assets.eascdn.net/~assets/";
static NSString * const ABI46_0_0EXUpdatesExpoIoDomain = @"expo.io";
static NSString * const ABI46_0_0EXUpdatesExpHostDomain = @"exp.host";
static NSString * const ABI46_0_0EXUpdatesExpoTestDomain = @"expo.test";

@implementation ABI46_0_0EXUpdatesLegacyUpdate
                                     ...
                                     database:(ABI46_0_0EXUpdatesDatabase *)database
{
  ...
  if (manifest.isUsingDeveloperTool) {
    ...
    update.commitTime = [ABI46_0_0RCTConvert NSDate:commitTimeString];
  }

  if (manifest.isDevelopmentMode) {
    update.isDevelopmentMode = YES;
    update.status = ABI46_0_0EXUpdatesUpdateStatusDevelopment;
  } else {
...
+ (NSURL *)bundledAssetBaseUrlWithManifest:(ABI46_0_0EXManifestsLegacyManifest *)manifest config:(ABI46_0_0EXUpdatesConfig *)config
{
  ...
  if (!host ||
      [host containsString:ABI46_0_0EXUpdatesExpoIoDomain] ||
      [host containsString:ABI46_0_0EXUpdatesExpHostDomain] ||
      [host containsString:ABI46_0_0EXUpdatesExpoTestDomain]) {
    return [NSURL URLWithString:ABI46_0_0EXUpdatesExpoAssetBaseUrl];
  } else {
