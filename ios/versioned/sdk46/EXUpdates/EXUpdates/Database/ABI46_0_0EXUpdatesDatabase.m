...
#import <ABI46_0_0EXUpdates/ABI46_0_0EXUpdatesDatabaseInitialization.h>
...
@interface ABI46_0_0EXUpdatesDatabase ()

@property (nonatomic, assign) sqlite3 *db;

@end

static NSString * const ABI46_0_0EXUpdatesDatabaseManifestFiltersKey = @"manifestFilters";
static NSString * const ABI46_0_0EXUpdatesDatabaseServerDefinedHeadersKey = @"serverDefinedHeaders";
static NSString * const ABI46_0_0EXUpdatesDatabaseStaticBuildDataKey = @"staticBuildData";

@implementation ABI46_0_0EXUpdatesDatabase
...
- (BOOL)openDatabaseInDirectory:(NSURL *)directory withError:(NSError ** _Nullable)error
{
  ...
  sqlite3 *db;
  if (![ABI46_0_0EXUpdatesDatabaseInitialization initializeDatabaseWithLatestSchemaInDirectory:directory database:&db error:error]) {
    return NO;
  }
...
- (void)addUpdate:(ABI46_0_0EXUpdatesUpdate *)update error:(NSError ** _Nullable)error
{
...
- (void)addNewAssets:(NSArray<ABI46_0_0EXUpdatesAsset *> *)assets toUpdateWithId:(NSUUID *)updateId error:(NSError ** _Nullable)error
{
  ...
  for (ABI46_0_0EXUpdatesAsset *asset in assets) {
    ...
    if ([self _executeSql:assetInsertSql
                 withArgs:@[
                          ...
                          asset.filename,
                          asset.contentHash,
                          @(ABI46_0_0EXUpdatesDatabaseHashTypeSha1),
...
- (BOOL)addExistingAsset:(ABI46_0_0EXUpdatesAsset *)asset toUpdateWithId:(NSUUID *)updateId error:(NSError ** _Nullable)error
{
  if (!asset.key) {
    return NO;
  }
...
- (void)updateAsset:(ABI46_0_0EXUpdatesAsset *)asset error:(NSError ** _Nullable)error
{
  NSAssert(asset.downloadTime, @"asset downloadTime should be nonnull");
  NSAssert(asset.filename, @"asset filename should be nonnull");
  NSAssert(asset.contentHash, @"asset contentHash should be nonnull");
...
- (void)mergeAsset:(ABI46_0_0EXUpdatesAsset *)asset withExistingEntry:(ABI46_0_0EXUpdatesAsset *)existingAsset error:(NSError ** _Nullable)error
{
...
- (void)markUpdateFinished:(ABI46_0_0EXUpdatesUpdate *)update error:(NSError ** _Nullable)error
{
  if (update.status != ABI46_0_0EXUpdatesUpdateStatusDevelopment) {
    update.status = ABI46_0_0EXUpdatesUpdateStatusReady;
  }
...
- (void)markUpdateAccessed:(ABI46_0_0EXUpdatesUpdate *)update error:(NSError ** _Nullable)error
{
...
- (void)incrementSuccessfulLaunchCountForUpdate:(ABI46_0_0EXUpdatesUpdate *)update error:(NSError ** _Nullable)error
{
  update.successfulLaunchCount++;
...
- (void)incrementFailedLaunchCountForUpdate:(ABI46_0_0EXUpdatesUpdate *)update error:(NSError ** _Nullable)error
{
  update.failedLaunchCount++;
...
- (void)setScopeKey:(NSString *)scopeKey onUpdate:(ABI46_0_0EXUpdatesUpdate *)update error:(NSError ** _Nullable)error
{
...
- (void)markMissingAssets:(NSArray<ABI46_0_0EXUpdatesAsset *> *)assets error:(NSError ** _Nullable)error
{
  sqlite3_exec(_db, "BEGIN;", NULL, NULL, NULL);
  ...
  for (ABI46_0_0EXUpdatesAsset *asset in assets) {
    if ([self _executeSql:updatesSql withArgs:@[@(ABI46_0_0EXUpdatesUpdateStatusPending), @(asset.assetId)] error:error] == nil) {
      sqlite3_exec(_db, "ROLLBACK;", NULL, NULL, NULL);
      return;
    }
  }
...
- (void)deleteUpdates:(NSArray<ABI46_0_0EXUpdatesUpdate *> *)updates error:(NSError ** _Nullable)error
{
  sqlite3_exec(_db, "BEGIN;", NULL, NULL, NULL);
...
- (nullable NSArray<ABI46_0_0EXUpdatesAsset *> *)deleteUnusedAssetsWithError:(NSError ** _Nullable)error
{
...
- (nullable NSArray<ABI46_0_0EXUpdatesUpdate *> *)allUpdatesWithConfig:(ABI46_0_0EXUpdatesConfig *)config error:(NSError ** _Nullable)error
{
  ...
  NSMutableArray<ABI46_0_0EXUpdatesUpdate *> *launchableUpdates = [NSMutableArray new];
  for (NSDictionary *row in rows) {
...
- (nullable NSArray<ABI46_0_0EXUpdatesUpdate *> *)allUpdatesWithStatus:(ABI46_0_0EXUpdatesUpdateStatus)status config:(ABI46_0_0EXUpdatesConfig *)config error:(NSError ** _Nullable)error
{
  ...
  NSMutableArray<ABI46_0_0EXUpdatesUpdate *> *updates = [NSMutableArray new];
  for (NSDictionary *row in rows) {
...
- (nullable NSArray<NSUUID *> *)allUpdateIdsWithStatus:(ABI46_0_0EXUpdatesUpdateStatus)status error:(NSError ** _Nullable)error
{
...
- (nullable NSArray<ABI46_0_0EXUpdatesUpdate *> *)launchableUpdatesWithConfig:(ABI46_0_0EXUpdatesConfig *)config error:(NSError ** _Nullable)error
{
  ...
  AND status IN (%li, %li, %li);", (long)ABI46_0_0EXUpdatesUpdateStatusReady, (long)ABI46_0_0EXUpdatesUpdateStatusEmbedded, (long)ABI46_0_0EXUpdatesUpdateStatusDevelopment];
...
- (nullable ABI46_0_0EXUpdatesUpdate *)updateWithId:(NSUUID *)updateId config:(ABI46_0_0EXUpdatesConfig *)config error:(NSError ** _Nullable)error
{
...
- (nullable NSArray<ABI46_0_0EXUpdatesAsset *> *)allAssetsWithError:(NSError ** _Nullable)error
{
  ...
  NSMutableArray<ABI46_0_0EXUpdatesAsset *> *assets = [NSMutableArray arrayWithCapacity:rows.count];
...
- (nullable NSArray<ABI46_0_0EXUpdatesAsset *> *)assetsWithUpdateId:(NSUUID *)updateId error:(NSError ** _Nullable)error
{
...
- (nullable ABI46_0_0EXUpdatesAsset *)assetWithKey:(nullable NSString *)key error:(NSError ** _Nullable)error
{
  if (!key) {
    return nil;
  }
...
{
  return [self _jsonDataWithKey:ABI46_0_0EXUpdatesDatabaseServerDefinedHeadersKey scopeKey:scopeKey error:error];
}

- (nullable NSDictionary *)manifestFiltersWithScopeKey:(NSString *)scopeKey error:(NSError ** _Nullable)error
{
  return [self _jsonDataWithKey:ABI46_0_0EXUpdatesDatabaseManifestFiltersKey scopeKey:scopeKey error:error];
}

- (nullable NSDictionary *)staticBuildDataWithScopeKey:(NSString *)scopeKey error:(NSError ** _Nullable)error
{
  return [self _jsonDataWithKey:ABI46_0_0EXUpdatesDatabaseStaticBuildDataKey scopeKey:scopeKey error:error];
}
...
{
  [self _setJsonData:serverDefinedHeaders withKey:ABI46_0_0EXUpdatesDatabaseServerDefinedHeadersKey scopeKey:scopeKey isInTransaction:NO error:error];
}

- (void)setManifestFilters:(NSDictionary *)manifestFilters withScopeKey:(NSString *)scopeKey error:(NSError ** _Nullable)error
{
  [self _setJsonData:manifestFilters withKey:ABI46_0_0EXUpdatesDatabaseManifestFiltersKey scopeKey:scopeKey isInTransaction:NO error:error];
}

- (void)setMetadataWithManifest:(ABI46_0_0EXUpdatesUpdate *)updateManifest error:(NSError ** _Nullable)error
{
  sqlite3_exec(_db, "BEGIN;", NULL, NULL, NULL);
  if (updateManifest.serverDefinedHeaders) {
    if (![self _setJsonData:updateManifest.serverDefinedHeaders
                   withKey:ABI46_0_0EXUpdatesDatabaseServerDefinedHeadersKey
  ...
  if (updateManifest.manifestFilters) {
    if (![self _setJsonData:updateManifest.manifestFilters
                   withKey:ABI46_0_0EXUpdatesDatabaseManifestFiltersKey
                  scopeKey:updateManifest.scopeKey
           isInTransaction:YES
                     error:error]) {
      sqlite3_exec(_db, "ROLLBACK;", NULL, NULL, NULL);
...
{
  [self _setJsonData:staticBuildData withKey:ABI46_0_0EXUpdatesDatabaseStaticBuildDataKey scopeKey:scopeKey isInTransaction:NO error:error];
}
...
- (nullable NSArray<NSDictionary *> *)_executeSql:(NSString *)sql withArgs:(nullable NSArray *)args error:(NSError ** _Nullable)error
{
  ...
  dispatch_assert_queue(_databaseQueue);
  return [ABI46_0_0EXUpdatesDatabaseUtils executeSql:sql withArgs:args onDatabase:_db error:error];
}

- (NSError *)_errorFromSqlite:(struct sqlite3 *)db
{
  return [ABI46_0_0EXUpdatesDatabaseUtils errorFromSqlite:db];
}

- (ABI46_0_0EXUpdatesUpdate *)_updateWithRow:(NSDictionary *)row config:(ABI46_0_0EXUpdatesConfig *)config
{
  NSError *error;
  id manifest = nil;
  ...
  ABI46_0_0EXUpdatesUpdate *update = [ABI46_0_0EXUpdatesUpdate updateWithId:row[@"id"]
                                                 scopeKey:row[@"scope_key"]
                                               commitTime:[ABI46_0_0EXUpdatesDatabaseUtils dateFromUnixTimeMilliseconds:(NSNumber *)row[@"commit_time"]]
                                           runtimeVersion:row[@"runtime_version"]
                                                 manifest:manifest
                                                   status:(ABI46_0_0EXUpdatesUpdateStatus)[(NSNumber *)row[@"status"] integerValue]
                                                     keep:[(NSNumber *)row[@"keep"] boolValue]
                                                   config:config
                                                 database:self];
  update.lastAccessed = [ABI46_0_0EXUpdatesDatabaseUtils dateFromUnixTimeMilliseconds:(NSNumber *)row[@"last_accessed"]];
...
- (ABI46_0_0EXUpdatesAsset *)_assetWithRow:(NSDictionary *)row
{
  ...
  ABI46_0_0EXUpdatesAsset *asset = [[ABI46_0_0EXUpdatesAsset alloc] initWithKey:key type:row[@"type"]];
  asset.assetId = [(NSNumber *)row[@"id"] unsignedIntegerValue];
  asset.url = url;
  asset.extraRequestHeaders = extraRequestHeaders;
  asset.downloadTime = [ABI46_0_0EXUpdatesDatabaseUtils dateFromUnixTimeMilliseconds:(NSNumber *)row[@"download_time"]];
