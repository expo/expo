...
static NSString * const ABI46_0_0EXUpdatesDatabaseUtilsErrorDomain = @"ABI46_0_0EXUpdatesDatabase";

@implementation ABI46_0_0EXUpdatesDatabaseUtils
...
+ (NSError *)errorFromSqlite:(struct sqlite3 *)db
{
  ...
  return [NSError errorWithDomain:ABI46_0_0EXUpdatesDatabaseUtilsErrorDomain
                             code:extendedCode
