...
static NSString * const ABI46_0_0EXUpdatesDatabaseV5Filename = @"expo-v5.db";

@implementation ABI46_0_0EXUpdatesDatabaseMigration5To6

- (NSString *)filename
{
  return ABI46_0_0EXUpdatesDatabaseV5Filename;
}
...
{
  NSError *error;
  NSArray<NSDictionary *> *rows = [ABI46_0_0EXUpdatesDatabaseUtils executeSql:sql withArgs:args onDatabase:db error:&error];
  if (!rows || error) {
    sqlite3_exec(db, "ROLLBACK;", NULL, NULL, NULL);
    return NO;
  }
