...
static NSString * const ABI46_0_0EXUpdatesDatabaseV6Filename = @"expo-v6.db";

@implementation ABI46_0_0EXUpdatesDatabaseMigration6To7

- (NSString *)filename
{
  return ABI46_0_0EXUpdatesDatabaseV6Filename;
}
