...
static NSString * const ABI46_0_0EXUpdatesDatabaseV7Filename = @"expo-v7.db";

@implementation ABI46_0_0EXUpdatesDatabaseMigration7To8

- (NSString *)filename
{
  return ABI46_0_0EXUpdatesDatabaseV7Filename;
}
