...
static NSString * const ABI46_0_0EXUpdatesDatabaseV4Filename = @"expo-v4.db";

@implementation ABI46_0_0EXUpdatesDatabaseMigration4To5

- (NSString *)filename
{
  return ABI46_0_0EXUpdatesDatabaseV4Filename;
}
