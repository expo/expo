 ...
 *
 *   ABI46_0_0EXUpdatesReleaseChannel
 *   ABI46_0_0EXUpdatesURL
 *
 * and all of the values in json
 *
 *   ABI46_0_0EXUpdatesRequestHeaders
 */
@implementation ABI46_0_0EXUpdatesBuildData

+ (void)ensureBuildDataIsConsistentAsync:(ABI46_0_0EXUpdatesDatabase *)database
...
{
  return @{
    @"ABI46_0_0EXUpdatesURL": config.updateUrl.absoluteString,
    @"ABI46_0_0EXUpdatesReleaseChannel": config.releaseChannel,
    @"ABI46_0_0EXUpdatesRequestHeaders": config.requestHeaders,
  };
}

+ (void)clearAllUpdatesAndSetStaticBuildData:(ABI46_0_0EXUpdatesDatabase *)database
                             config:(ABI46_0_0EXUpdatesConfig *)config
{
  NSError *queryError;
  NSArray<ABI46_0_0EXUpdatesUpdate *> *allUpdates = [database allUpdatesWithConfig:config error:&queryError];
  if (queryError) {
