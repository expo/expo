...
@objc public enum ABI46_0_0EXUpdatesCodeSigningError : Int, Error {
...
@objc public class ABI46_0_0EXUpdatesCodeSigningErrorUtils : NSObject {
  @objc public static func message(forError: ABI46_0_0EXUpdatesCodeSigningError) -> String {
    switch forError {
    case .CertificateEncodingError:
