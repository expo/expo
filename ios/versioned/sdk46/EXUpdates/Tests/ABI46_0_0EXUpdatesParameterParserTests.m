...
@interface ABI46_0_0EXUpdatesParameterParserTests : XCTestCase
@end

@implementation ABI46_0_0EXUpdatesParameterParserTests
...
- (void)testParameterParser
{
  ...
  for (NSArray *testCase in testCases) {
    ...
    NSDictionary<NSString *, NSString *> *parameters = [[ABI46_0_0EXUpdatesParameterParser new] parseParameterString:parameterString withDelimiter:';'];
