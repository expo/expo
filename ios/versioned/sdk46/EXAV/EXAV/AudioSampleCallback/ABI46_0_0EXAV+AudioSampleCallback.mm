...
using namespace ABI46_0_0expo::av;
...
@implementation ABI46_0_0EXAV (AudioSampleCallback)
                 ...
                 withSoundDictionary:(NSMutableDictionary <NSNumber *, ABI46_0_0EXAVPlayerData *> *)soundDictionary
{
  ...
  auto setAudioSampleCallback = [weakCallInvoker, weakSoundDictionary](jsi::Runtime &runtime,
    ...
    if (argsCount > 1 && args[1].isObject()) {
      ...
      ABI46_0_0EXAudioSampleCallback* objcWrapper = [[ABI46_0_0EXAudioSampleCallback alloc] initWithCallbackWrapper:(std::move(wrapper))];
