...
@implementation ABI46_0_0EXAppleAuthenticationMappings
...
{
  return @{
           @"namePrefix": ABI46_0_0EXNullIfNil(nameComponents.namePrefix),
           @"givenName": ABI46_0_0EXNullIfNil(nameComponents.givenName),
           @"middleName": ABI46_0_0EXNullIfNil(nameComponents.middleName),
           @"familyName": ABI46_0_0EXNullIfNil(nameComponents.familyName),
           @"nameSuffix": ABI46_0_0EXNullIfNil(nameComponents.nameSuffix),
           @"nickname": ABI46_0_0EXNullIfNil(nameComponents.nickname)
           };
}
