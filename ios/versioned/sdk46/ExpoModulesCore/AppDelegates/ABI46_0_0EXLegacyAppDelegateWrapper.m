...
@implementation ABI46_0_0EXLegacyAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitializedAndSorted {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI46_0_0EXSingletonModule*> * singletonModules = [[ABI46_0_0EXModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI46_0_0EXSingletonModule *singletonModule in singletonModules) {
