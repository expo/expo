 ...
 */
@interface ABI46_0_0EXAppDelegateWrapper : UIResponder <UIApplicationDelegate>

@property (nonatomic, strong, readonly) ABI46_0_0EXReactDelegateWrapper *reactDelegate;
