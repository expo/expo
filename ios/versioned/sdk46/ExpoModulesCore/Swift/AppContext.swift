...
public final class AppContext: NSObject {
   ...
   */
  internal weak var legacyModuleRegistry: ABI46_0_0EXModuleRegistry?

  internal weak var legacyModulesProxy: LegacyNativeModulesProxy?

  /**
   ABI46_0_0React bridge of the context's app. Can be `nil` when the bridge
   hasn't been propagated to the bridge modules yet (see ``ABI46_0_0ExpoBridgeModule``),
   or when the app context is "bridgeless" (for example in native unit tests).
   */
  @objc
  public internal(set) weak var reactBridge: ABI46_0_0RCTBridge?
   ...
   */
  public var constants: ABI46_0_0EXConstantsInterface? {
    return legacyModule(implementing: ABI46_0_0EXConstantsInterface.self)
  }

  /**
   Provides access to the file system manager from legacy module registry.
   */
  public var fileSystem: ABI46_0_0EXFileSystemInterface? {
    return legacyModule(implementing: ABI46_0_0EXFileSystemInterface.self)
  }

  /**
   Provides access to the permissions manager from legacy module registry.
   */
  public var permissions: ABI46_0_0EXPermissionsInterface? {
    return legacyModule(implementing: ABI46_0_0EXPermissionsInterface.self)
  }

  /**
   Provides access to the image loader from legacy module registry.
   */
  public var imageLoader: ABI46_0_0EXImageLoaderInterface? {
    return legacyModule(implementing: ABI46_0_0EXImageLoaderInterface.self)
  }

  /**
   Provides access to the utilities from legacy module registry.
   */
  public var utilities: ABI46_0_0EXUtilitiesInterface? {
    return legacyModule(implementing: ABI46_0_0EXUtilitiesInterface.self)
  }

  /**
   Provides access to the event emitter from legacy module registry.
   */
  public var eventEmitter: ABI46_0_0EXEventEmitterService? {
    return legacyModule(implementing: ABI46_0_0EXEventEmitterService.self)
  }
  ...
  public func callFunction(
    ...
    withArgs args: [Any],
    resolve: @escaping ABI46_0_0EXPromiseResolveBlock,
    reject: @escaping ABI46_0_0EXPromiseRejectBlock
  ) {
    moduleRegistry
      .get(moduleHolderForName: moduleName)?
  ...
  internal func installExpoModulesHostObject() throws {
    ...
    ABI46_0_0EXJavaScriptRuntimeManager.installExpoModulesHostObject(self)
  }
   ...
   */
  @objc
  public static func modulesProvider(withName providerName: String = "ABI46_0_0ExpoModulesProvider") -> ModulesProvider {
