...
public struct Promise: AnyArgument {
  ...
  /**
   The rejecter that is compatible with the legacy `ABI46_0_0EXPromiseRejectBlock`.
   Necessary in some places not converted to Swift, such as `ABI46_0_0EXPermissionsMethodsDelegate`.
   */
  public var legacyRejecter: ABI46_0_0EXPromiseRejectBlock {
