...
/**
 ...
 - Creating and owning the `AppContext` when the Expo modules architecture is automatically initialized
   by ABI46_0_0React Native (as opposed to native unit tests, where ABI46_0_0React Native is not used at all).
 - Installing the host object to the runtime.
 */
@objc(ABI46_0_0ExpoBridgeModule)
public final class ABI46_0_0ExpoBridgeModule: NSObject, ABI46_0_0RCTBridgeModule {
  @objc
  public let appContext: AppContext

  /**
   The initializer that is used by ABI46_0_0React Native when it loads bridge modules.
  ...
  override init() {
    ...
    // Listen to ABI46_0_0React Native notifications posted just before the JS is executed.
    NotificationCenter.default.addObserver(self,
                                           selector: #selector(javaScriptWillStartExecutingNotification(_:)),
                                           name: NSNotification.Name.ABI46_0_0RCTJavaScriptWillStartExecuting,
                                           object: nil)
  }
  ...
  public var bridge: ABI46_0_0RCTBridge! {
    didSet {
  ...
  /**
   This should be called inside ABI46_0_0EXNativeModulesProxy.setBridge()
   */
  @objc
  public func legacyProxyDidSetBridge(legacyModulesProxy: LegacyNativeModulesProxy,
                                      legacyModuleRegistry: ABI46_0_0EXModuleRegistry) {
    ...
    appContext.useModulesProvider("ABI46_0_0ExpoModulesProvider")
  ...
  public func javaScriptWillStartExecutingNotification(_ notification: Notification) {
    if (notification.object as? ABI46_0_0RCTBridge)?.batched == bridge {
      ...
      appContext.runtime = ABI46_0_0EXJavaScriptRuntimeManager.runtime(fromBridge: bridge)
    }
  }
}
