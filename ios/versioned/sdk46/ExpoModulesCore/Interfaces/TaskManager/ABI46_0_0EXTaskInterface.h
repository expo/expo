...
@protocol ABI46_0_0EXTaskConsumerInterface;

@protocol ABI46_0_0EXTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI46_0_0EXTaskConsumerInterface> __nonnull consumer;
