...
// Interface for ABI46_0_0EXTaskManager module.

@protocol ABI46_0_0EXTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI46_0_0EXTaskConsumerInterface protocol.
 */
