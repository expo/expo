...
/**
 Internal `ABI46_0_0EXReactDelegateWrapper` interface for the designated initializer with `ExpoReactDelegate`.
 ...
 */
@interface ABI46_0_0EXReactDelegateWrapper(Private)
