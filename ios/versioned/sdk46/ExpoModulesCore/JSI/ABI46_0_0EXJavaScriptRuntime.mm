...
@implementation ABI46_0_0EXJavaScriptRuntime {
  std::shared_ptr<jsi::Runtime> _runtime;
  std::shared_ptr<react::CallInvoker> _jsCallInvoker;
}

/**
 Initializes a runtime that is independent from ABI46_0_0React Native and its runtime initialization.
                            ...
                            callInvoker:(std::shared_ptr<react::CallInvoker>)callInvoker
{
  if (self = [super init]) {
    ...
    // In this code flow, the runtime should be owned by something else like the ABI46_0_0RCTBridge.
...
- (nonnull ABI46_0_0EXJavaScriptObject *)createObject
{
  ...
  return [[ABI46_0_0EXJavaScriptObject alloc] initWith:jsObjectPtr runtime:self];
}
...
- (nonnull ABI46_0_0EXJavaScriptObject *)global
{
  ...
  return [[ABI46_0_0EXJavaScriptObject alloc] initWith:jsGlobalPtr runtime:self];
}
                                             ...
                                             block:(nonnull JSSyncFunctionBlock)block
{
  JSHostFunctionBlock hostFunctionBlock = ^jsi::Value(
    ...
    NSArray<ABI46_0_0EXJavaScriptValue *> * _Nonnull arguments) {
      ...
      if (error == nil) {
        return ABI46_0_0expo::convertObjCObjectToJSIValue(runtime, result);
      } else {
                                              ...
                                              block:(nonnull JSAsyncFunctionBlock)block
{
  JSHostFunctionBlock hostFunctionBlock = ^jsi::Value(
    ...
    NSArray<ABI46_0_0EXJavaScriptValue *> * _Nonnull arguments) {
      ...
      // The function that is invoked as a setup of the ABI46_0_0EXJavaScript `Promise`.
      auto promiseSetup = [callInvoker, block, thisValue, arguments](jsi::Runtime &runtime, std::shared_ptr<Promise> promise) {
        ABI46_0_0expo::callPromiseSetupWithBlock(runtime, callInvoker, promise, ^(ABI46_0_0RCTPromiseResolveBlock resolver, ABI46_0_0RCTPromiseRejectBlock rejecter) {
...
{
  ABI46_0_0expo::ClassConstructor jsConstructor = [self, constructor](jsi::Runtime &runtime, const jsi::Value &thisValue, const jsi::Value *args, size_t count) {
    std::shared_ptr<jsi::Object> thisPtr = std::make_shared<jsi::Object>(thisValue.asObject(runtime));
    ABI46_0_0EXJavaScriptObject *caller = [[ABI46_0_0EXJavaScriptObject alloc] initWith:thisPtr runtime:self];
    NSArray<ABI46_0_0EXJavaScriptValue *> *arguments = ABI46_0_0expo::convertJSIValuesToNSArray(self, args, count);

    constructor(caller, arguments);
  };
  std::shared_ptr<jsi::Function> klass = ABI46_0_0expo::createClass(*_runtime, [name UTF8String], jsConstructor);
  return [[ABI46_0_0EXJavaScriptObject alloc] initWith:klass runtime:self];
}

#pragma mark - Script evaluation

- (nonnull ABI46_0_0EXJavaScriptValue *)evaluateScript:(nonnull NSString *)scriptSource
{
  ...
  return [[ABI46_0_0EXJavaScriptValue alloc] initWithRuntime:self value:result];
}

#pragma mark - Private

- (nonnull ABI46_0_0EXJavaScriptObject *)createHostFunction:(nonnull NSString *)name
                                         argsCount:(NSInteger)argsCount
                                             block:(nonnull JSHostFunctionBlock)block
{
  ...
  jsi::HostFunctionType function = [weakCallInvoker, block, self](jsi::Runtime &runtime, const jsi::Value &thisVal, const jsi::Value *args, size_t count) -> jsi::Value {
    ...
    ABI46_0_0EXJavaScriptValue *thisValue = [[ABI46_0_0EXJavaScriptValue alloc] initWithRuntime:self value:thisValPtr];
  ...
  return [[ABI46_0_0EXJavaScriptObject alloc] initWith:fnPtr runtime:self];
}
