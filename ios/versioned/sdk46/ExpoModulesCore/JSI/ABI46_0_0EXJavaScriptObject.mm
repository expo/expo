...
#import <ABI46_0_0ExpoModulesCore/ABI46_0_0EXJSIConversions.h>
...
@implementation ABI46_0_0EXJavaScriptObject {
  /**
  ...
  /**
   Shared pointer to the original JSI object that is being wrapped by `ABI46_0_0EXJavaScriptObject` class.
   */
...
- (nonnull ABI46_0_0EXJavaScriptValue *)getProperty:(nonnull NSString *)name
{
  std::shared_ptr<jsi::Value> value = std::make_shared<jsi::Value>(_jsObjectPtr->getProperty(*[_runtime get], [name UTF8String]));
  return [[ABI46_0_0EXJavaScriptValue alloc] initWithRuntime:_runtime value:value];
}
...
- (nonnull NSArray<NSString *> *)getPropertyNames
{
  ...
  return ABI46_0_0expo::convertJSIArrayToNSArray(*runtime, propertyNamesArray, nullptr);
}
...
{
  jsi::Value jsiValue = ABI46_0_0expo::convertObjCObjectToJSIValue(*[_runtime get], value);
  _jsObjectPtr->setProperty(*[_runtime get], [name UTF8String], jsiValue);
}

- (void)defineProperty:(nonnull NSString *)name descriptor:(nonnull ABI46_0_0EXJavaScriptObject *)descriptor
{
  jsi::Runtime *runtime = [_runtime get];
...
- (void)defineProperty:(nonnull NSString *)name value:(nullable id)value options:(ABI46_0_0EXJavaScriptObjectPropertyDescriptor)options
{
  jsi::Runtime *runtime = [_runtime get];
  jsi::Object global = runtime->global();
  jsi::Object objectClass = global.getPropertyAsObject(*runtime, "Object");
  ...
  descriptor.setProperty(*runtime, "value", ABI46_0_0expo::convertObjCObjectToJSIValue(*runtime, value));
...
- (nonnull ABI46_0_0EXJavaScriptWeakObject *)createWeak
{
  return [[ABI46_0_0EXJavaScriptWeakObject alloc] initWith:_jsObjectPtr runtime:_runtime];
}
...
{
  ABI46_0_0expo::setDeallocator(*[_runtime get], _jsObjectPtr, deallocatorBlock);
}
...
{
  if ([object isKindOfClass:ABI46_0_0EXJavaScriptObject.class]) {
    jsi::Runtime *runtime = [_runtime get];
...
- (jsi::Object)preparePropertyDescriptorWithOptions:(ABI46_0_0EXJavaScriptObjectPropertyDescriptor)options
{
  jsi::Runtime *runtime = [_runtime get];
  jsi::Object descriptor(*runtime);
  descriptor.setProperty(*runtime, "configurable", (bool)(options & ABI46_0_0EXJavaScriptObjectPropertyDescriptorConfigurable));
  descriptor.setProperty(*runtime, "enumerable", (bool)(options & ABI46_0_0EXJavaScriptObjectPropertyDescriptorEnumerable));
  descriptor.setProperty(*runtime, "writable", (bool)(options & ABI46_0_0EXJavaScriptObjectPropertyDescriptorWritable));
  return descriptor;
}
