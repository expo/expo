...
typedef NS_OPTIONS(NSUInteger, ABI46_0_0EXSplashScreenOptions) {
  ABI46_0_0EXSplashScreenDefault = 0,

  // Show splash screen even it was already shown before.
  // e.g. show splash screen again when reloading apps,
  ABI46_0_0EXSplashScreenForceShow = 1 << 0,
};
...
*/
@protocol ABI46_0_0EXSplashScreenService <NSObject>
...
/**
 * Entry point for SplashScreen unimodule.
 * Registers SplashScreen for given viewController and ABI46_0_0EXSplashController and presents it in that viewController.
 */
-(void)showSplashScreenFor:(UIViewController *)viewController
                   options:(ABI46_0_0EXSplashScreenOptions)options
...
@interface ABI46_0_0EXSplashScreenService : ABI46_0_0EXSingletonModule <ABI46_0_0EXSplashScreenService, UIApplicationDelegate>
@end
