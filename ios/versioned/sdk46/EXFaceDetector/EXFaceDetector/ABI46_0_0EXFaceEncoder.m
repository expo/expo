...
#import <ABI46_0_0EXFaceDetector/ABI46_0_0EXFaceEncoder.h>
...
@interface ABI46_0_0EXFaceEncoder()

@property (assign, nonatomic) BOOL swapWidthAndHeight;
@property CGAffineTransform transform;
@property ABI46_0_0EXFaceDetectionAngleTransformBlock angleTransformer;

@end

@implementation ABI46_0_0EXFaceEncoder
...
{
  ABI46_0_0EXFaceDetectionAngleTransformBlock transformer = ^(float angle) {return angle;};
  return [self initWithTransform:pointTransformer withRotationTransform:transformer];
}

- (instancetype)initWithRotationTransform:(ABI46_0_0EXFaceDetectionAngleTransformBlock)rotationTransform
{
