//
//  ABI46_0_0EXFaceDetectorUtils.h
//  Exponent
//
...
typedef float (^ABI46_0_0EXFaceDetectionAngleTransformBlock)(float);

@interface ABI46_0_0EXFaceDetectorUtils : NSObject
...
+ (ABI46_0_0EXFaceDetectionAngleTransformBlock)angleTransformerFromTransform:(CGAffineTransform)transform;
