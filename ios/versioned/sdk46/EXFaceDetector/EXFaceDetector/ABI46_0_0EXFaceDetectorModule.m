...
#import <ABI46_0_0EXFaceDetector/ABI46_0_0EXFaceDetectorModule.h>
#import <ABI46_0_0EXFaceDetector/ABI46_0_0EXFaceDetector.h>
...
#import <ABI46_0_0EXFaceDetector/ABI46_0_0EXCSBufferOrientationCalculator.h>

@interface ABI46_0_0EXFaceDetectorModule ()

@property (nonatomic, weak) ABI46_0_0EXModuleRegistry *moduleRegistry;

@end

@implementation ABI46_0_0EXFaceDetectorModule
...
ABI46_0_0EX_EXPORT_MODULE(ExpoFaceDetector);

- (NSDictionary *)constantsToExport
{
  return [ABI46_0_0EXFaceDetectorUtils constantsToExport];
}
...
ABI46_0_0EX_EXPORT_METHOD_AS(detectFaces, detectFaces:(nonnull NSDictionary *)options resolver:(ABI46_0_0EXPromiseResolveBlock)resolve rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([fileSystem permissionsForURI:url] & ABI46_0_0EXFileSystemPermissionRead)) {
  ...
  @try {
    ...
    ciImage = [ciImage imageByApplyingOrientation:[ABI46_0_0EXFaceDetectorUtils toCGImageOrientation:image.imageOrientation]];
    ...
    ABI46_0_0EXFaceDetector* detector = [[ABI46_0_0EXFaceDetector alloc] initWithOptions: [ABI46_0_0EXFaceDetectorUtils mapOptions:options]];
    [detector detectFromImage:finalImage completionListener:^(NSArray<MLKFace *> * _Nullable faces, NSError * _Nullable error) {
      ...
      if(faces.count > 0) {
        ABI46_0_0EXFaceEncoder *encoder = [[ABI46_0_0EXFaceEncoder alloc] init];
      ...
      if (error != nil) {
        ...
        resolve(@{
                  ...
                  @"image" : @{
                      ...
                      @"orientation" : @([ABI46_0_0EXFaceDetectorModule exifOrientationFor:image.imageOrientation])
                      }
                  });
      }}];
