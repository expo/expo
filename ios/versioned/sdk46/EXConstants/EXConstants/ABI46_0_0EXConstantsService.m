...
#import <ABI46_0_0EXConstants/ABI46_0_0EXConstantsInstallationIdProvider.h>

NSString * const ABI46_0_0EXConstantsExecutionEnvironmentBare = @"bare";
NSString * const ABI46_0_0EXConstantsExecutionEnvironmentStandalone = @"standalone";
NSString * const ABI46_0_0EXConstantsExecutionEnvironmentStoreClient = @"storeClient";

@interface ABI46_0_0EXConstantsService ()

@property (nonatomic, strong) NSString *sessionId;
@property (nonatomic, strong) ABI46_0_0EXConstantsInstallationIdProvider *installationIdProvider;

@end

@implementation ABI46_0_0EXConstantsService

- (instancetype)init
{
  return [self initWithInstallationIdProvider:[[ABI46_0_0EXConstantsInstallationIdProvider alloc] init]];
}

- (instancetype)initWithInstallationIdProvider:(ABI46_0_0EXConstantsInstallationIdProvider *)installationIdProvider
{
  if (self = [super init]) {
...
{
  return @[@protocol(ABI46_0_0EXConstantsInterface)];
}
...
- (NSDictionary *)constants
{
  ...
  return @{
           ...
           @"executionEnvironment": ABI46_0_0EXConstantsExecutionEnvironmentBare,
           ...
           @"manifest": ABI46_0_0EXNullIfNil([[self class] appConfig]),
           @"platform": @{
               @"ios": @{
                   @"buildNumber": [self buildVersion],
                   @"platform": [[self class] devicePlatform],
                   @"model": ABI46_0_0EXNullIfNil([[self class] deviceModel]),
...
{
  NSBundle *frameworkBundle = [NSBundle bundleForClass:[ABI46_0_0EXConstantsService class]];
  NSURL *bundleUrl = [frameworkBundle.resourceURL URLByAppendingPathComponent:@"ABI46_0_0EXConstants.bundle"];
