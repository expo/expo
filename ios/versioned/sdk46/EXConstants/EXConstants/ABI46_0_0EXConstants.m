...
#import <ABI46_0_0EXConstants/ABI46_0_0EXConstants.h>
#import <ABI46_0_0ExpoModulesCore/ABI46_0_0EXConstantsInterface.h>

#import <WebKit/WKWebView.h>

@interface ABI46_0_0EXConstants () {
  WKWebView *webView;
}
...
@implementation ABI46_0_0EXConstants
...
ABI46_0_0EX_EXPORT_METHOD_AS(getWebViewUserAgentAsync,
                    getWebViewUserAgentWithResolver:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  __weak ABI46_0_0EXConstants *weakSelf = self;
  dispatch_async(dispatch_get_main_queue(), ^{
    __strong ABI46_0_0EXConstants *strongSelf = weakSelf;
    if (strongSelf) {
      if (!strongSelf.webViewUserAgent) {
        ...
        [strongSelf->webView evaluateJavaScript:@"window.navigator.userAgent;" completionHandler:^(id _Nullable result, NSError * _Nullable error) {
          ...
          resolve(ABI46_0_0EXNullIfNil(strongSelf.webViewUserAgent));
