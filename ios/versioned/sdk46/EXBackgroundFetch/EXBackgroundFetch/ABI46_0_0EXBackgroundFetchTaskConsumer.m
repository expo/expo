...
@implementation ABI46_0_0EXBackgroundFetchTaskConsumer

+ (BOOL)supportsLaunchReason:(ABI46_0_0EXTaskLaunchReason)launchReason
{
  return launchReason == ABI46_0_0EXTaskLaunchReasonBackgroundFetch;
}
...
- (NSUInteger)normalizeTaskResult:(id)result
{
  ...
  switch ([result unsignedIntegerValue]) {
    case ABI46_0_0EXBackgroundFetchResultNewData:
      return UIBackgroundFetchResultNewData;
    case ABI46_0_0EXBackgroundFetchResultFailed:
      return UIBackgroundFetchResultFailed;
    case ABI46_0_0EXBackgroundFetchResultNoData:
    default:
      return UIBackgroundFetchResultNoData;
  }
}
