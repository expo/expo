...
#import <ABI46_0_0EXDevice/ABI46_0_0EXDevice.h>
...
@interface ABI46_0_0EXDevice()

@end

@implementation ABI46_0_0EXDevice

ABI46_0_0EX_EXPORT_MODULE(ExpoDevice);
...
- (NSDictionary *)constantsToExport
{
  ...
  return @{
           ...
           @"brand": @"Apple",
           @"manufacturer": @"Apple",
           @"modelId": ABI46_0_0EXNullIfNil([[self class] modelId]),
           @"modelName": [[self class] modelName],
           @"deviceYearClass": [[self class] deviceYear],
           @"totalMemory": @(NSProcessInfo.processInfo.physicalMemory),
           @"supportedCpuArchitectures": ABI46_0_0EXNullIfNil([[self class] cpuArchitectures]),
...
ABI46_0_0EX_EXPORT_METHOD_AS(getDeviceTypeAsync,
                    getDeviceTypeAsyncWithResolver:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  resolve(@([[self class] deviceType]));
}

ABI46_0_0EX_EXPORT_METHOD_AS(getUptimeAsync,
                    getUptimeAsyncWithResolver:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
...
ABI46_0_0EX_EXPORT_METHOD_AS(isRootedExperimentalAsync,
                    isRootedExperimentalAsyncWithResolver:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
...
+ (ABI46_0_0EXDeviceType)deviceType
{
  switch (UIDevice.currentDevice.userInterfaceIdiom) {
    case UIUserInterfaceIdiomPhone:
      return ABI46_0_0EXDeviceTypePhone;
    case UIUserInterfaceIdiomPad:
      return ABI46_0_0EXDeviceTypeTablet;
    case UIUserInterfaceIdiomTV:
      return ABI46_0_0EXDeviceTypeTV;
    default:
      // NOTE: in the future for macOS, return Desktop
      return ABI46_0_0EXDeviceTypeUnknown;
  }
}
