...
#import <ABI46_0_0EXVideoThumbnails/ABI46_0_0EXVideoThumbnailsModule.h>
...
@implementation ABI46_0_0EXVideoThumbnailsModule

ABI46_0_0EX_EXPORT_MODULE(ExpoVideoThumbnails);
...
ABI46_0_0EX_EXPORT_METHOD_AS(getThumbnail,
                    ...
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  if ([url isFileURL]) {
    ...
    if (!([_fileSystem permissionsForURI:url] & ABI46_0_0EXFileSystemPermissionRead)) {
