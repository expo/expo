...
#import <ABI46_0_0EXSpeech/ABI46_0_0EXSpeech.h>

@interface ABI46_0_0EXSpeechUtteranceWithId : AVSpeechUtterance
...
@implementation ABI46_0_0EXSpeechUtteranceWithId
...
@interface ABI46_0_0EXSpeech () <AVSpeechSynthesizerDelegate>
...
@implementation ABI46_0_0EXSpeech

ABI46_0_0EX_EXPORT_MODULE(ExponentSpeech)
...
{
  id<ABI46_0_0EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI46_0_0EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStarted" body:@{ @"id": ((ABI46_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didCancelSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI46_0_0EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI46_0_0EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStopped" body:@{ @"id": ((ABI46_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didFinishSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI46_0_0EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI46_0_0EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingDone" body:@{ @"id": ((ABI46_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}


ABI46_0_0EX_EXPORT_METHOD_AS(speak,
  ...
  AVSpeechUtterance *utterance = [[ABI46_0_0EXSpeechUtteranceWithId alloc] initWithString:text utteranceId:utteranceId];
...
ABI46_0_0EX_EXPORT_METHOD_AS(getVoices,
                    getVoices:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject) {
...
ABI46_0_0EX_EXPORT_METHOD_AS(stop,
                    stop:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject) {
  [_synthesizer stopSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI46_0_0EX_EXPORT_METHOD_AS(pause,
                    pause:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject) {
  [_synthesizer pauseSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI46_0_0EX_EXPORT_METHOD_AS(resume,
                    resume:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject) {
  [_synthesizer continueSpeaking];
  resolve(nil);
}

ABI46_0_0EX_EXPORT_METHOD_AS(isSpeaking,
                    isSpeaking:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject) {
