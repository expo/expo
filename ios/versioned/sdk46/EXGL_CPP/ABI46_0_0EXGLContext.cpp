...
void ABI46_0_0EXGLContext::prepareContext(jsi::Runtime &runtime, std::function<void(void)> flushMethod) {
  ...
  try {
    ...
    ABI46_0_0EXGLSysLog("Failed to setup ABI46_0_0EXGLContext [%s]", err.what());
  }
}

void ABI46_0_0EXGLContext::maybePrepareWorkletContext(jsi::Runtime &runtime, initGlesContext viewport) {
...
void ABI46_0_0EXGLContext::endNextBatch() noexcept {
...
void ABI46_0_0EXGLContext::addToNextBatch(Op &&op) noexcept {
...
void ABI46_0_0EXGLContext::addBlockingToNextBatch(Op &&op) {
...
// [JS thread] Enqueue a function and return an ABI46_0_0EXGL object that will get mapped
// to the function's return value when it is called on the GL thread.
jsi::Value ABI46_0_0EXGLContext::addFutureToNextBatch(
    jsi::Runtime &runtime,
...
void ABI46_0_0EXGLContext::flush(void) {
...
ABI46_0_0EXGLObjectId ABI46_0_0EXGLContext::createObject(void) noexcept {
  return nextObjectId++;
}

void ABI46_0_0EXGLContext::destroyObject(ABI46_0_0EXGLObjectId exglObjId) noexcept {
  objects.erase(exglObjId);
}

void ABI46_0_0EXGLContext::mapObject(ABI46_0_0EXGLObjectId exglObjId, GLuint glObj) noexcept {
  objects[exglObjId] = glObj;
}

GLuint ABI46_0_0EXGLContext::lookupObject(ABI46_0_0EXGLObjectId exglObjId) noexcept {
  auto iter = objects.find(exglObjId);
  return iter == objects.end() ? 0 : iter->second;
}

void ABI46_0_0EXGLContext::tryRegisterOnJSRuntimeDestroy(jsi::Runtime &runtime) {
...
initGlesContext ABI46_0_0EXGLContext::prepareOpenGLESContext() {
...
void ABI46_0_0EXGLContext::maybeReadAndCacheSupportedExtensions() {
