...
class ABI46_0_0EXGLContext {
 ...
 public:
  ABI46_0_0EXGLContext(ABI46_0_0EXGLContextId ctxId): ctxId(ctxId) {}
  ...
  ABI46_0_0EXGLObjectId createObject(void) noexcept;
  void destroyObject(ABI46_0_0EXGLObjectId exglObjId) noexcept;
  void mapObject(ABI46_0_0EXGLObjectId exglObjId, GLuint glObj) noexcept;
  GLuint lookupObject(ABI46_0_0EXGLObjectId exglObjId) noexcept;
 ...
 public:
  ABI46_0_0EXGLContextId ctxId;

  // Object mapping
  std::unordered_map<ABI46_0_0EXGLObjectId, GLuint> objects;
