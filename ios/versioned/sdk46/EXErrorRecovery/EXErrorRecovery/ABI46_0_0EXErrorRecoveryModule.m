...
@implementation ABI46_0_0EXErrorRecoveryModule

ABI46_0_0EX_EXPORT_MODULE(ExpoErrorRecovery);

ABI46_0_0EX_EXPORT_METHOD_AS(saveRecoveryProps,
...
{
  return @{
           @"recoveredProps": ABI46_0_0EXNullIfNil([self consumeRecoveryProps])
           };
}
