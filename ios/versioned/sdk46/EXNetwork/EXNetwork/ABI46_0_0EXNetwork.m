...
#import <ABI46_0_0EXNetwork/ABI46_0_0EXNetwork.h>
...
@implementation ABI46_0_0EXNetwork
...
- (instancetype)init
{
  self = [super init];
  if (self) {
    _type = ABI46_0_0EXNetworkTypeUnknown;
  }
  return self;
}

ABI46_0_0EX_EXPORT_MODULE(ExpoNetwork);
...
ABI46_0_0EX_EXPORT_METHOD_AS(getIpAddressAsync,
                    getIpAddressAsyncWithResolver:(ABI46_0_0EXPromiseResolveBlock)resolve rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
...
ABI46_0_0EX_EXPORT_METHOD_AS(getNetworkStateAsync,
                    getNetworkStateAsyncWithResolver:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  if ((flags & kSCNetworkReachabilityFlagsReachable) == 0 ||
    ...
    _type = ABI46_0_0EXNetworkTypeNone;
  }
  
#if !TARGET_OS_TV
  else if ((flags & kSCNetworkReachabilityFlagsIsWWAN) != 0) {
    _type = ABI46_0_0EXNetworkTypeCellular;
  }
#endif
  else {
    _type = ABI46_0_0EXNetworkTypeWifi;
  }
...
- (BOOL)connected
{
  return ![self.type isEqualToString:ABI46_0_0EXNetworkTypeUnknown] && ![self.type isEqualToString:ABI46_0_0EXNetworkTypeNone];
}
