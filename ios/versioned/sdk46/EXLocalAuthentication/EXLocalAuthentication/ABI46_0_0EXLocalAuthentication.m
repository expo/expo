...
typedef NS_ENUM(NSInteger, ABI46_0_0EXAuthenticationType) {
  ABI46_0_0EXAuthenticationTypeFingerprint = 1,
  ABI46_0_0EXAuthenticationTypeFacialRecognition = 2,
};

typedef NS_ENUM(NSInteger, ABI46_0_0EXSecurityLevel) {
  ABI46_0_0EXSecurityLevelNone = 0,
  ABI46_0_0EXSecurityLevelSecret = 1,
  ABI46_0_0EXSecurityLevelBiometric = 2,
};

@implementation ABI46_0_0EXLocalAuthentication

ABI46_0_0EX_EXPORT_MODULE(ExpoLocalAuthentication)

ABI46_0_0EX_EXPORT_METHOD_AS(supportedAuthenticationTypesAsync,
                    supportedAuthenticationTypesAsync:(ABI46_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  NSMutableArray *results = [NSMutableArray array];
  if ([[self class] isTouchIdDevice]) {
    [results addObject:@(ABI46_0_0EXAuthenticationTypeFingerprint)];
  }
  if ([[self class] isFaceIdDevice]) {
    [results addObject:@(ABI46_0_0EXAuthenticationTypeFacialRecognition)];
  }
  resolve(results);
}

ABI46_0_0EX_EXPORT_METHOD_AS(hasHardwareAsync,
                    hasHardwareAsync:(ABI46_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
...
ABI46_0_0EX_EXPORT_METHOD_AS(isEnrolledAsync,
                    isEnrolledAsync:(ABI46_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI46_0_0EX_EXPORT_METHOD_AS(getEnrolledLevelAsync,
                    getEnrolledLevelAsync:(ABI46_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;

  int level = ABI46_0_0EXSecurityLevelNone;
  ...
  if (isAuthenticationSupported && error == nil) {
    level = ABI46_0_0EXSecurityLevelSecret;
  }
  ...
  if (isBiometricsSupported && error == nil) {
    level = ABI46_0_0EXSecurityLevelBiometric;
  }
          ...
          localizedReason:reason
                    reply:^(BOOL success, NSError *error) {
                      resolve(@{
                                ...
                                @"warning": ABI46_0_0EXNullIfNil(warningMessage),
                                });
                    }];
  } else {
