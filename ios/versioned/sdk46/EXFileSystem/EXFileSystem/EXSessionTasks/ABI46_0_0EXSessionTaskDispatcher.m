...
@interface ABI46_0_0EXSessionTaskDispatcher ()

@property (nonatomic, strong) NSMutableDictionary<NSURLSessionTask *, ABI46_0_0EXSessionTaskDelegate *> *tasks;
@property (nonatomic) BOOL isActive;
@property (nonatomic, weak) id<ABI46_0_0EXSessionHandler> sessionHandler;

@end

@implementation ABI46_0_0EXSessionTaskDispatcher
...
{
  if (_isActive) {
    ABI46_0_0EXSessionTaskDelegate *exTask = _tasks[downloadTask];
    if (exTask) {
...
{
  if (_isActive) {
    ABI46_0_0EXSessionTaskDelegate *exTask = _tasks[task];
    if (exTask) {
...
{
  if (_isActive) {
    ABI46_0_0EXSessionTaskDelegate *exTask = _tasks[dataTask];
