...
@interface ABI46_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI46_0_0EXBarCodeScanner *barCodeScanner;
...
@implementation ABI46_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI46_0_0EXModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI46_0_0EXAppLifecycleListener)];
...
{
  ABI46_0_0EX_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI46_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI46_0_0EXBareCodeCameraRequester class]]) {
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI46_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI46_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI46_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI46_0_0EXBarCodeScanner *barCodeScanner = [ABI46_0_0EXBarCodeScanner new];
