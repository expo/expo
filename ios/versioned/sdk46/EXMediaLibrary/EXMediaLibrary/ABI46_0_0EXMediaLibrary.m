...
NSString *const ABI46_0_0EXAssetMediaTypeAudio = @"audio";
NSString *const ABI46_0_0EXAssetMediaTypePhoto = @"photo";
NSString *const ABI46_0_0EXAssetMediaTypeVideo = @"video";
NSString *const ABI46_0_0EXAssetMediaTypeUnknown = @"unknown";
NSString *const ABI46_0_0EXAssetMediaTypeAll = @"all";

NSString *const ABI46_0_0EXMediaLibraryDidChangeEvent = @"mediaLibraryDidChange";

NSString *const ABI46_0_0EXMediaLibraryCachesDirectory = @"MediaLibrary";

NSString *const ABI46_0_0EXMediaLibraryShouldDownloadFromNetworkKey = @"shouldDownloadFromNetwork";

@interface ABI46_0_0EXMediaLibrary ()
...
@implementation ABI46_0_0EXMediaLibrary

ABI46_0_0EX_EXPORT_MODULE(ExponentMediaLibrary);
...
- (void)setModuleRegistry:(ABI46_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  [ABI46_0_0EXPermissionsMethodsDelegate registerRequesters:@[[ABI46_0_0EXMediaLibraryMediaLibraryPermissionRequester new], [ABI46_0_0EXMediaLibraryMediaLibraryWriteOnlyPermissionRequester new]] withPermissionsManager:_permissionsManager];
}
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"MediaType": @{
               @"audio": ABI46_0_0EXAssetMediaTypeAudio,
               @"photo": ABI46_0_0EXAssetMediaTypePhoto,
               @"video": ABI46_0_0EXAssetMediaTypeVideo,
               @"unknown": ABI46_0_0EXAssetMediaTypeUnknown,
               @"all": ABI46_0_0EXAssetMediaTypeAll,
               },
           @"SortBy": @{
               @"default": @"default",
           ...
           @"CHANGE_LISTENER_NAME": ABI46_0_0EXMediaLibraryDidChangeEvent,
           };
}

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI46_0_0EXMediaLibraryDidChangeEvent];
}

- (id)requesterClass:(BOOL)writeOnly
{
  if (writeOnly) {
    return [ABI46_0_0EXMediaLibraryMediaLibraryWriteOnlyPermissionRequester class];
  } else {
    return [ABI46_0_0EXMediaLibraryMediaLibraryPermissionRequester class];
  }
}
...
ABI46_0_0EX_EXPORT_METHOD_AS(presentPermissionsPickerAsync,
                    presentPermissionsPickerAsync:(ABI46_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI46_0_0EXPromiseRejectBlock)reject)
{
#ifdef __IPHONE_14_0
  if (@available(iOS 14, *)) {
...
ABI46_0_0EX_EXPORT_METHOD_AS(createAssetAsync,
                    ...
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  PHAssetMediaType assetType = [ABI46_0_0EXMediaLibrary _assetTypeForUri:localUri];
  ...
  if (!([_fileSystem permissionsForURI:assetUrl] & ABI46_0_0EXFileSystemPermissionRead)) {
  ...
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    ...
    if (success) {
      PHAsset *asset = [ABI46_0_0EXMediaLibrary _getAssetById:assetPlaceholder.localIdentifier];
      resolve([ABI46_0_0EXMediaLibrary _exportAsset:asset]);
    } else {
...
ABI46_0_0EX_EXPORT_METHOD_AS(saveToLibraryAsync,
                    ...
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  __block ABI46_0_0EXSaveToLibraryDelegate *delegate = [ABI46_0_0EXSaveToLibraryDelegate new];
  [_saveToLibraryDelegates addObject:delegate];
  ABI46_0_0EXSaveToLibraryCallback callback = ^(id asset, NSError *error){
...
ABI46_0_0EX_EXPORT_METHOD_AS(addAssetsToAlbumAsync,
                    ...
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    [ABI46_0_0EXMediaLibrary _addAssets:assetIds toAlbum:albumId withCallback:^(BOOL success, NSError *error) {
      if (error) {
...
ABI46_0_0EX_EXPORT_METHOD_AS(removeAssetsFromAlbumAsync,
                    ...
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
      PHAssetCollection *collection = [ABI46_0_0EXMediaLibrary _getAlbumById:albumId];
      PHFetchResult *assets = [ABI46_0_0EXMediaLibrary _getAssetsByIds:assetIds];
...
ABI46_0_0EX_EXPORT_METHOD_AS(deleteAssetsAsync,
...
ABI46_0_0EX_EXPORT_METHOD_AS(getAlbumsAsync,
                    ...
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    ...
    [albums addObjectsFromArray:[ABI46_0_0EXMediaLibrary _exportCollections:userAlbumsFetchResult withFetchOptions:fetchOptions inFolder:nil]];
    ...
    if ([options[@"includeSmartAlbums"] boolValue]) {
      ...
      [albums addObjectsFromArray:[ABI46_0_0EXMediaLibrary _exportCollections:smartAlbumsFetchResult withFetchOptions:fetchOptions inFolder:nil]];
    }
...
ABI46_0_0EX_EXPORT_METHOD_AS(getMomentsAsync,
                    getMoments:(ABI46_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  if (![self _checkPermissions:reject]) {
    return;
  ...
  NSArray<NSDictionary *> *albums = [ABI46_0_0EXMediaLibrary _exportCollections:fetchResult withFetchOptions:options inFolder:nil];
  
  resolve(albums);
}

ABI46_0_0EX_EXPORT_METHOD_AS(getAlbumAsync,
                    getAlbumWithTitle:(nonnull NSString *)title
                    resolve:(ABI46_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    PHAssetCollection *collection = [ABI46_0_0EXMediaLibrary _getAlbumWithTitle:title];
    resolve(ABI46_0_0EXNullIfNil([ABI46_0_0EXMediaLibrary _exportCollection:collection]));
  }];
}

ABI46_0_0EX_EXPORT_METHOD_AS(createAlbumAsync,
...
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    [ABI46_0_0EXMediaLibrary _createAlbumWithTitle:title completion:^(PHAssetCollection *collection, NSError *error) {
      if (collection) {
        if (assetId) {
          [ABI46_0_0EXMediaLibrary _addAssets:@[assetId] toAlbum:collection.localIdentifier withCallback:^(BOOL success, NSError *error) {
            if (success) {
              resolve(ABI46_0_0EXNullIfNil([ABI46_0_0EXMediaLibrary _exportCollection:collection]));
            } else {
...
ABI46_0_0EX_EXPORT_METHOD_AS(deleteAlbumsAsync,
...
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    PHFetchResult *collections = [ABI46_0_0EXMediaLibrary _getAlbumsById:albumIds];
    [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
      if (assetRemove) {
...
ABI46_0_0EX_EXPORT_METHOD_AS(getAssetInfoAsync,
                    ...
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  PHAsset *asset = [ABI46_0_0EXMediaLibrary _getAssetById:assetId];
    
  BOOL shouldDownloadFromNetwork = [options objectForKey:ABI46_0_0EXMediaLibraryShouldDownloadFromNetworkKey] != nil
    ? [[options objectForKey:ABI46_0_0EXMediaLibraryShouldDownloadFromNetworkKey] boolValue]
    : YES;
  
  if (asset) {
    NSMutableDictionary *result = [ABI46_0_0EXMediaLibrary _exportAssetInfo:asset];
    if (asset.mediaType == PHAssetMediaTypeImage) {
      ...
      [[PHImageManager defaultManager] requestAVAssetForVideo:asset
        ...
        if ([asset isKindOfClass:[AVComposition class]]) {
            NSString *directory = [self.fileSystem.cachesDirectory stringByAppendingPathComponent:ABI46_0_0EXMediaLibraryCachesDirectory];
...
ABI46_0_0EX_EXPORT_METHOD_AS(getAssetsAsync,
                    ...
                    reject:(ABI46_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *createdAfter = [ABI46_0_0EXUtilities NSDate:options[@"createdAfter"]];
  NSDate *createdBefore = [ABI46_0_0EXUtilities NSDate:options[@"createdBefore"]];
  ...
  if (albumId) {
    [self _runIfAllPermissionsWereGranted:reject block:^{
      ...
      [ABI46_0_0EXMediaLibrary _getAssetsWithAfter:after
                                    first:first
                                mediaType:mediaType
                                   sortBy:sortBy
...
- (void)startObserving
{
  _allAssetsFetchResult = [ABI46_0_0EXMediaLibrary _getAllAssets];
    ...
    if (changeDetails != nil) {
      ...
      if (changeDetails.hasIncrementalChanges && (changeDetails.insertedObjects.count > 0 || changeDetails.removedObjects.count > 0)) {
        ...
        for (PHAsset *asset in changeDetails.insertedObjects) {
          [insertedAssets addObject:[ABI46_0_0EXMediaLibrary _exportAsset:asset]];
        }
        for (PHAsset *asset in changeDetails.removedObjects) {
          [deletedAssets addObject:[ABI46_0_0EXMediaLibrary _exportAsset:asset]];
        }
        for (PHAsset *asset in changeDetails.changedObjects) {
          [updatedAssets addObject:[ABI46_0_0EXMediaLibrary _exportAsset:asset]];
        }
        
        [_eventEmitter sendEventWithName:ABI46_0_0EXMediaLibraryDidChangeEvent body:body];
        return;
      }
      ...
      if (!changeDetails.hasIncrementalChanges) {
        [_eventEmitter sendEventWithName:ABI46_0_0EXMediaLibraryDidChangeEvent body:@{
                     ...
                     reject:(ABI46_0_0EXPromiseRejectBlock)reject
{
  ...
  PHAsset *cursor;
  if (after) {
    cursor = [ABI46_0_0EXMediaLibrary _getAssetById:after];
  ...
  if (mediaType && [mediaType count] > 0) {
    NSMutableArray<NSNumber *> *assetTypes = [ABI46_0_0EXMediaLibrary _convertMediaTypes:mediaType];
  ...
  if (sortBy && sortBy.count > 0) {
    fetchOptions.sortDescriptors = [ABI46_0_0EXMediaLibrary _prepareSortDescriptors:sortBy];
  }
  ...
  if (fetchOptions.sortDescriptors.count == 0) {
    ...
    for (NSInteger i = startIndex; i >= endIndex; i--) {
      ...
      [assets addObject:[ABI46_0_0EXMediaLibrary _exportAsset:asset]];
    }
...
{
  if (assetId) {
    return [ABI46_0_0EXMediaLibrary _getAssetsByIds:@[assetId]].firstObject;
  }
  return nil;
}
...
+ (void)_ensureAlbumWithTitle:(nonnull NSString *)title completion:(void(^)(PHAssetCollection *collection, NSError *error))completion
{
  ...
  [ABI46_0_0EXMediaLibrary _createAlbumWithTitle:title completion:completion];
}
...
+ (NSDictionary *)_exportAsset:(PHAsset *)asset
{
  if (asset) {
    ...
    return @{
             ...
             @"filename": ABI46_0_0EXNullIfNil(fileName),
             @"uri": [ABI46_0_0EXMediaLibrary _assetUriForLocalId:asset.localIdentifier],
             @"mediaType": [ABI46_0_0EXMediaLibrary _stringifyMediaType:asset.mediaType],
             @"mediaSubtypes": [ABI46_0_0EXMediaLibrary _stringifyMediaSubtypes:asset.mediaSubtypes],
             @"width": @(asset.pixelWidth),
             @"height": @(asset.pixelHeight),
             @"creationTime": [ABI46_0_0EXMediaLibrary _exportDate:asset.creationDate],
             @"modificationTime": [ABI46_0_0EXMediaLibrary _exportDate:asset.modificationDate],
...
{
  NSMutableDictionary *assetDict = [[ABI46_0_0EXMediaLibrary _exportAsset:asset] mutableCopy];
  
  if (assetDict) {
    assetDict[@"location"] = [ABI46_0_0EXMediaLibrary _exportLocation:asset.location];
...
{
  return [ABI46_0_0EXMediaLibrary _exportCollection:collection inFolder:nil];
}
...
+ (nullable NSDictionary *)_exportCollection:(PHAssetCollection *)collection inFolder:(nullable NSString *)folderName
{
  if (collection) {
    return @{
             @"id": [ABI46_0_0EXMediaLibrary _assetIdFromLocalId:collection.localIdentifier],
             @"title": ABI46_0_0EXNullIfNil(collection.localizedTitle),
             @"folderName": ABI46_0_0EXNullIfNil(folderName),
             @"type": [ABI46_0_0EXMediaLibrary _stringifyAlbumType:collection.assetCollectionType],
             @"assetCount": [ABI46_0_0EXMediaLibrary _assetCountOfCollection:collection],
             @"startTime": [ABI46_0_0EXMediaLibrary _exportDate:collection.startDate],
             @"endTime": [ABI46_0_0EXMediaLibrary _exportDate:collection.endDate],
             @"approximateLocation": [ABI46_0_0EXMediaLibrary _exportLocation:collection.approximateLocation],
             @"locationNames": ABI46_0_0EXNullIfNil(collection.localizedLocationNames),
             };
  }
  return nil;
}
                       ...
                       inFolder:(nullable NSString *)folderName
{
  ...
  for (PHCollection *collection in collections) {
    if ([collection isKindOfClass:[PHAssetCollection class]]) {
      [albums addObject:[ABI46_0_0EXMediaLibrary _exportCollection:(PHAssetCollection *)collection inFolder:folderName]];
      ...
      [albums addObjectsFromArray:[ABI46_0_0EXMediaLibrary _exportCollections:collectionsInFolder withFetchOptions:options inFolder:collection.localizedTitle]];
    }
  }
  return [albums copy];
}
...
{
  NSString *assetId = [ABI46_0_0EXMediaLibrary _assetIdFromLocalId:localId];
...
+ (NSString *)_stringifyMediaType:(PHAssetMediaType)mediaType
{
  switch (mediaType) {
    case PHAssetMediaTypeAudio:
      return ABI46_0_0EXAssetMediaTypeAudio;
    case PHAssetMediaTypeImage:
      return ABI46_0_0EXAssetMediaTypePhoto;
    case PHAssetMediaTypeVideo:
      return ABI46_0_0EXAssetMediaTypeVideo;
    default:
      return ABI46_0_0EXAssetMediaTypeUnknown;
  }
}

+ (PHAssetMediaType)_convertMediaType:(NSString *)mediaType
{
  if ([mediaType isEqualToString:ABI46_0_0EXAssetMediaTypeAudio]) {
    return PHAssetMediaTypeAudio;
  }
  if ([mediaType isEqualToString:ABI46_0_0EXAssetMediaTypePhoto]) {
    return PHAssetMediaTypeImage;
  }
  if ([mediaType isEqualToString:ABI46_0_0EXAssetMediaTypeVideo]) {
    return PHAssetMediaTypeVideo;
  }
  return PHAssetMediaTypeUnknown;
}
...
+ (NSMutableArray<NSNumber *> *)_convertMediaTypes:(NSArray<NSString *> *)mediaTypes
{
  ...
  [mediaTypes enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
    if ([obj isEqualToString:ABI46_0_0EXAssetMediaTypeAll]) {
      *stop = YES;
      assetTypes = nil;
      return;
    }
    PHAssetMediaType assetType = [ABI46_0_0EXMediaLibrary _convertMediaType:obj];
...
+ (NSString *)_convertSortByKey:(NSString *)key
{
  ...
  if (value == nil) {
    ...
    @throw [NSException exceptionWithName:@"ABI46_0_0EXMediaLibrary.UNSUPPORTED_SORTBY_KEY" reason:reason userInfo:nil];
  }
  return value;
}
...
+ (NSSortDescriptor *)_sortDescriptorFrom:(id)config
{
  if ([config isKindOfClass:[NSString class]]) {
    NSString *key = [ABI46_0_0EXMediaLibrary _convertSortByKey:config];
  ...
  if ([config isKindOfClass:[NSArray class]]) {
    ...
    NSString *key = [ABI46_0_0EXMediaLibrary _convertSortByKey:sortArray[0]];
...
+ (NSArray *)_prepareSortDescriptors:(NSArray *)sortBy
{
  ...
  for (id config in sortByArray) {
    NSSortDescriptor *sortDescriptor = [ABI46_0_0EXMediaLibrary _sortDescriptorFrom:config];
...
- (void)_runIfAllPermissionsWereGranted:(ABI46_0_0EXPromiseRejectBlock)reject block:(void (^)(void))block
{
  [_permissionsManager getPermissionUsingRequesterClass:[ABI46_0_0EXMediaLibraryMediaLibraryPermissionRequester class] resolve:^(id result) {
...
- (BOOL)_checkPermissions:(ABI46_0_0EXPromiseRejectBlock)reject
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI46_0_0EXMediaLibraryMediaLibraryPermissionRequester class]]) {
    reject(@"E_NO_PERMISSIONS", @"MEDIA_LIBRARY permission is required to do this operation.", nil);
    return NO;
  }
  return YES;
