...
#import <ABI45_0_0EXGL/ABI45_0_0EXGLCameraObject.h>
#import <ABI45_0_0EXGL/ABI45_0_0EXGLContext.h>

@interface ABI45_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) id<ABI45_0_0EXCameraInterface> camera;
...
@implementation ABI45_0_0EXGLCameraObject
