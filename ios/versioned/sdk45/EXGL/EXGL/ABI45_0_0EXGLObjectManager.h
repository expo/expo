...
@interface ABI45_0_0EXGLObjectManager : ABI45_0_0EXExportedModule <ABI45_0_0EXModuleRegistryConsumer>

@property (nonatomic, weak, nullable) id<ABI45_0_0EXUIManager> uiManager;
@property (nonatomic, weak, nullable) id<ABI45_0_0EXFileSystemInterface> fileSystem;
