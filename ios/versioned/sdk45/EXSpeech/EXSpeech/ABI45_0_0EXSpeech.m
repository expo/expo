...
#import <ABI45_0_0EXSpeech/ABI45_0_0EXSpeech.h>

@interface ABI45_0_0EXSpeechUtteranceWithId : AVSpeechUtterance
...
@implementation ABI45_0_0EXSpeechUtteranceWithId
...
@interface ABI45_0_0EXSpeech () <AVSpeechSynthesizerDelegate>
...
@implementation ABI45_0_0EXSpeech

ABI45_0_0EX_EXPORT_MODULE(ExponentSpeech)
...
{
  id<ABI45_0_0EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI45_0_0EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStarted" body:@{ @"id": ((ABI45_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didCancelSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI45_0_0EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI45_0_0EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStopped" body:@{ @"id": ((ABI45_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didFinishSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI45_0_0EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI45_0_0EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingDone" body:@{ @"id": ((ABI45_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}


ABI45_0_0EX_EXPORT_METHOD_AS(speak,
  ...
  AVSpeechUtterance *utterance = [[ABI45_0_0EXSpeechUtteranceWithId alloc] initWithString:text utteranceId:utteranceId];
...
ABI45_0_0EX_EXPORT_METHOD_AS(getVoices,
                    getVoices:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject) {
...
ABI45_0_0EX_EXPORT_METHOD_AS(stop,
                    stop:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject) {
  [_synthesizer stopSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI45_0_0EX_EXPORT_METHOD_AS(pause,
                    pause:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject) {
  [_synthesizer pauseSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI45_0_0EX_EXPORT_METHOD_AS(resume,
                    resume:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject) {
  [_synthesizer continueSpeaking];
  resolve(nil);
}

ABI45_0_0EX_EXPORT_METHOD_AS(isSpeaking,
                    isSpeaking:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject) {
