...
#import <ABI45_0_0EXSensors/ABI45_0_0EXDeviceMotion.h>
#import <ABI45_0_0ExpoModulesCore/ABI45_0_0EXDeviceMotionInterface.h>

@implementation ABI45_0_0EXDeviceMotion

ABI45_0_0EX_EXPORT_MODULE(ExponentDeviceMotion);
...
{
  return [moduleRegistry getModuleImplementingProtocol:@protocol(ABI45_0_0EXDeviceMotionInterface)];
}
