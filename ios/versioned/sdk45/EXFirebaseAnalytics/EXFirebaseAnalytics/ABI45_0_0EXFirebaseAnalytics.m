...
#import <ABI45_0_0EXFirebaseAnalytics/ABI45_0_0EXFirebaseAnalytics.h>
...
@interface ABI45_0_0EXFirebaseAnalytics ()

@property (nonatomic, weak) ABI45_0_0EXModuleRegistry *moduleRegistry;
@property (nonatomic, weak) id<ABI45_0_0EXFirebaseCoreInterface> firebaseCore;

@end

@implementation ABI45_0_0EXFirebaseAnalytics

ABI45_0_0EX_EXPORT_MODULE(ExpoFirebaseAnalytics);
...
- (void)reject:(ABI45_0_0EXPromiseRejectBlock)reject withException:(NSException *)exception {
...
- (void)setModuleRegistry:(ABI45_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  _firebaseCore = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI45_0_0EXFirebaseCoreInterface)];
}

- (nullable FIRApp *)getAppOrReject:(ABI45_0_0EXPromiseRejectBlock)reject
{
  if (!_firebaseCore) {
    reject(@"ERR_FIREBASE_ANALYTICS", @"ABI45_0_0EXFirebaseCore could not be found. Ensure that your app has correctly linked 'expo-firebase-core' and your project has react-native-unimodules installed.", nil);
    return nil;
  }
...
ABI45_0_0EX_EXPORT_METHOD_AS(logEvent,
...
ABI45_0_0EX_EXPORT_METHOD_AS(setAnalyticsCollectionEnabled,
...
ABI45_0_0EX_EXPORT_METHOD_AS(setSessionTimeoutDuration,
...
ABI45_0_0EX_EXPORT_METHOD_AS(setUserId,
...
ABI45_0_0EX_EXPORT_METHOD_AS(setUserProperties, 
...
ABI45_0_0EX_EXPORT_METHOD_AS(resetAnalyticsData,
                    resetAnalyticsData:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject) {
  if ([self getAppOrReject:reject] == nil) return;
  @try {
