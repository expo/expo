...
#import <ABI45_0_0EXGoogleSignIn/ABI45_0_0EXAuthTask.h>
...
@interface ABI45_0_0EXGoogleSignIn ()
...
@property (nonatomic, strong) ABI45_0_0EXAuthTask *authTask;

@end

@implementation ABI45_0_0EXGoogleSignIn

ABI45_0_0EX_EXPORT_MODULE(ExpoGoogleSignIn);

- (instancetype)init
{
  if (self = [super init]) {
    _authTask = [[ABI45_0_0EXAuthTask alloc] init];
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"ERRORS": @{
               ...
               @"TASK_IN_PROGRESS": ABI45_0_0EX_E_CONCURRENT_TASK_IN_PROGRESS,
               @"SIGN_IN_EXCEPTION": ABI45_0_0EX_E_EXCEPTION
               },
           @"TYPES": @{},
           @"SCOPES": @{
               @"PROFILE": @"profile",
...
- (NSString *)_getNativeClientIdOrReject:(ABI45_0_0EXPromiseRejectBlock)reject
{
  NSString *path = [[NSBundle mainBundle] pathForResource:@"GoogleService-Info" ofType:@"plist"];
  
  if (!path) {
    reject(ABI45_0_0EX_E_EXCEPTION, @"Missing GoogleService-Info.plist", nil);
    return nil;
  }
  NSDictionary *plist = [[NSDictionary alloc] initWithContentsOfFile:path];
  NSString *clientId = plist[@"CLIENT_ID"];
  if (clientId != nil && ![clientId isEqualToString:@""]) return clientId;
  reject(ABI45_0_0EX_E_EXCEPTION, @"GoogleService-Info.plist `CLIENT_ID` is invalid", nil);
  return nil;
}
...
ABI45_0_0EX_EXPORT_METHOD_AS(initAsync,
...
ABI45_0_0EX_EXPORT_METHOD_AS(signInSilentlyAsync,
                    signInSilentlyAsync:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
...
ABI45_0_0EX_EXPORT_METHOD_AS(signInAsync,
                    signInAsync:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
...
ABI45_0_0EX_EXPORT_METHOD_AS(signOutAsync,
                    signOutAsync:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
...
ABI45_0_0EX_EXPORT_METHOD_AS(disconnectAsync,
                    disconnectAsync:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
...
ABI45_0_0EX_EXPORT_METHOD_AS(isConnectedAsync,
                    isConnectedAsync:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  resolve(@([[GIDSignIn sharedInstance] hasPreviousSignIn]));
}

ABI45_0_0EX_EXPORT_METHOD_AS(getCurrentUserAsync,
                    getCurrentUserAsync:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  GIDGoogleUser *currentUser = [GIDSignIn sharedInstance].currentUser;
  resolve(ABI45_0_0EXNullIfNil([ABI45_0_0EXGoogleSignIn jsonFromGIDGoogleUser:currentUser]));
}

ABI45_0_0EX_EXPORT_METHOD_AS(getPhotoAsync,
...
ABI45_0_0EX_EXPORT_METHOD_AS(getTokensAsync,
                    ...
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  GIDGoogleUser *currentUser = [GIDSignIn sharedInstance].currentUser;
  if (currentUser == nil) {
    reject(ABI45_0_0EX_E_EXCEPTION, @"getTokens requires a user to be signed in", nil);
    return;
  }

  GIDAuthenticationHandler handler = ^void(GIDAuthentication *authentication, NSError *error) {
    if (error) {
      reject(ABI45_0_0EX_E_EXCEPTION, error.localizedDescription, nil);
    } else {
      resolve(@{
...
- (void)signIn:(GIDSignIn *)signIn didSignInForUser:(GIDGoogleUser *)user withError:(NSError *)error {
  [self.authTask parse:[ABI45_0_0EXGoogleSignIn jsonFromGIDGoogleUser:user] error:error];
}
