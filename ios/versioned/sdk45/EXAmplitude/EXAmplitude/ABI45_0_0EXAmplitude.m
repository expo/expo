...
#import <ABI45_0_0EXAmplitude/ABI45_0_0EXAmplitude.h>

#import <Amplitude/Amplitude.h>
#import <Amplitude/AMPTrackingOptions.h>

@implementation ABI45_0_0EXAmplitude

ABI45_0_0EX_EXPORT_MODULE(ExpoAmplitude);
...
ABI45_0_0EX_EXPORT_METHOD_AS(setUserPropertiesAsync,
...
ABI45_0_0EX_EXPORT_METHOD_AS(clearUserPropertiesAsync,
                    clearUserPropertiesAsyncWithResolver:(ABI45_0_0EXPromiseResolveBlock)resolve
...
ABI45_0_0EX_EXPORT_METHOD_AS(logEventWithPropertiesAsync,
...
ABI45_0_0EX_EXPORT_METHOD_AS(setGroupAsync,
...
ABI45_0_0EX_EXPORT_METHOD_AS(setTrackingOptionsAsync,
