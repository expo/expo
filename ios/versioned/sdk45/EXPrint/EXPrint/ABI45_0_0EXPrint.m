...
#import <ABI45_0_0EXPrint/ABI45_0_0EXPrint.h>
...
NSString *const ABI45_0_0EXPrintOrientationPortrait = @"portrait";
NSString *const ABI45_0_0EXPrintOrientationLandscape = @"landscape";

@interface ABI45_0_0EXPrint () <UIPrintInteractionControllerDelegate, UIPrinterPickerControllerDelegate>
...
@implementation ABI45_0_0EXPrint

ABI45_0_0EX_EXPORT_MODULE(ExponentPrint);
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"Orientation": @{
               @"portrait": ABI45_0_0EXPrintOrientationPortrait,
               @"landscape": ABI45_0_0EXPrintOrientationLandscape,
               },
           };
}

ABI45_0_0EX_EXPORT_METHOD_AS(print,
                    ...
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  [self _getPrintingDataForOptions:options callback:^(NSData *printingData, NSDictionary *errorDetails) {
    if (errorDetails != nil) {
      reject(errorDetails[@"code"], errorDetails[@"message"], ABI45_0_0EXErrorWithMessage(errorDetails[@"message"]));
      return;
    }
    ...
    if (printingData == nil) {
      ...
      if (htmlString != nil) {
        ...
        reject(@"E_HTML_INVALID", message, ABI45_0_0EXErrorWithMessage(message));
        return;
      }
    }
...
ABI45_0_0EX_EXPORT_METHOD_AS(selectPrinter,selectPrinter:(ABI45_0_0EXPromiseResolveBlock)resolve
                  rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
...
ABI45_0_0EX_EXPORT_METHOD_AS(printToFileAsync,
...
{
  __block ABI45_0_0EXWKPDFRenderer *renderTask;
  ...
  if ([options[@"useMarkupFormatter"] boolValue]) {
    ...
    renderTask = [ABI45_0_0EXWKPDFRenderer new];
...
{
  id<ABI45_0_0EXUtilitiesInterface> utils = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI45_0_0EXUtilitiesInterface)];
...
- (void)_getPrintingDataForOptions:(nonnull NSDictionary *)options callback:(void(^)(NSData *, NSDictionary *))callback
{
  ...
  if (options[@"html"] && ![options[@"useMarkupFormatter"] boolValue]) {
    __block ABI45_0_0EXWKPDFRenderer *renderTask = [ABI45_0_0EXWKPDFRenderer new];
...
{
  if ([orientation isEqualToString:ABI45_0_0EXPrintOrientationLandscape]) {
