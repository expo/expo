...
#import <ABI45_0_0EXPrint/ABI45_0_0EXWKPDFRenderer.h>
#import <ABI45_0_0ExpoModulesCore/ABI45_0_0EXDefines.h>
#import <ABI45_0_0EXPrint/ABI45_0_0EXWKViewPrintPDFRenderer.h>

@interface ABI45_0_0EXWKPDFRenderer () <WKNavigationDelegate>

@property (nonatomic, assign) CGSize pageSize;
@property (nonatomic, assign) UIEdgeInsets pageMargins;
@property (nonatomic, strong) WKWebView *webView;
@property (nonatomic, strong) id<ABI45_0_0EXPDFRenderer> renderer;
...
@implementation ABI45_0_0EXWKPDFRenderer
...
- (void)PDFWithHtml:(NSString *)htmlString pageSize:(CGSize)pageSize pageMargins:(UIEdgeInsets)pageMargins completionHandler:(void (^)(NSError * _Nullable, NSData * _Nullable, int))handler
{
  ...
  _renderer = [[ABI45_0_0EXWKViewPrintPDFRenderer alloc] initWithPageSize:pageSize pageMargins:pageMargins];
