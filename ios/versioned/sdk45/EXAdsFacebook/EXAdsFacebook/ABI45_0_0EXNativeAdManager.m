#import <ABI45_0_0EXAdsFacebook/ABI45_0_0EXNativeAdManager.h>
...
@class ABI45_0_0EXAdManagerDelegate;

@interface ABI45_0_0EXNativeAdManager ()
...
@property (nonatomic, strong) NSMutableDictionary<NSString*, ABI45_0_0EXAdManagerDelegate*> *adsManagersDelegates;
...
// about errors to ABI45_0_0EXNativeAdManager, but with a specific placement ID
...
@interface ABI45_0_0EXAdManagerDelegate : NSObject <FBNativeAdsManagerDelegate>

@property (nonatomic, weak) ABI45_0_0EXNativeAdManager *manager;
@property (nonatomic, strong) NSString *placementId;

@end

@implementation ABI45_0_0EXAdManagerDelegate

- (instancetype)initWithPlacementId:(NSString *)placementId andManager:(ABI45_0_0EXNativeAdManager *)manager
{
  if (self = [super init]) {
    _manager = manager;
...
@implementation ABI45_0_0EXNativeAdManager

ABI45_0_0EX_EXPORT_MODULE(CTKNativeAdManager)
...
ABI45_0_0EX_EXPORT_METHOD_AS(registerViewsForInteraction,
                    ...
                    reject:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  ...
  [uiManager executeUIBlock:^(NSDictionary<id,UIView *> * viewRegistry) {
    ...
    if (![nativeAdView isKindOfClass:[ABI45_0_0EXNativeAdView class]]) {
      reject(@"E_INVALID_VIEW_CLASS", @"View returned for passed native ad view tag is not an instance of ABI45_0_0EXNativeAdView", nil);
      return;
    }
    ...
    [(ABI45_0_0EXNativeAdView *)nativeAdView registerViewsForInteraction:(FBMediaView *)mediaView adIcon:(FBAdIconView *)adIconView clickableViews:clickableViews];
    resolve(@[]);
  }];
}

ABI45_0_0EX_EXPORT_METHOD_AS(init,
                    ...
                    reject:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  ...
  ABI45_0_0EXAdManagerDelegate *delegate = [[ABI45_0_0EXAdManagerDelegate alloc] initWithPlacementId:placementId andManager:self];
...
ABI45_0_0EX_EXPORT_METHOD_AS(setMediaCachePolicy,
...
ABI45_0_0EX_EXPORT_METHOD_AS(disableAutoRefresh,
...
- (void)nativeAdsLoaded
{
  ...
  [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI45_0_0EXEventEmitterService)] sendEventWithName:@"CTKNativeAdsManagersChanged" body:adsManagersState];
}

- (void)nativeAdForPlacementId:(NSString *)placementId failedToLoadWithError:(NSError *)error
{
  [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI45_0_0EXEventEmitterService)] sendEventWithName:@"CTKNativeAdManagerErrored" body:@{
...
- (UIView *)view
{
  return [[ABI45_0_0EXNativeAdView alloc] initWithModuleRegistry:_moduleRegistry];
}

ABI45_0_0EX_VIEW_PROPERTY(adsManager, NSString *, ABI45_0_0EXNativeAdView)
{
