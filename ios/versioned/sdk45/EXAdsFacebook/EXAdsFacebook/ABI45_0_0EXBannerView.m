...
@interface ABI45_0_0EXBannerView () <FBAdViewDelegate>
...
@implementation ABI45_0_0EXBannerView
...
- (void)createViewIfCan
{
  ...
  UIViewController *rootViewController = [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI45_0_0EXUtilitiesInterface)] currentViewController];
...
- (void)adView:(FBAdView *)adView didFailWithError:(NSError *)error
{
  if (_onAdError) {
    ...
    ABI45_0_0EXLogError(@"%@: %@", error.localizedDescription, error.userInfo);
  }
}
