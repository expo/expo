...
@implementation ABI45_0_0EXAppleAuthenticationMappings
...
{
  return @{
           @"namePrefix": ABI45_0_0EXNullIfNil(nameComponents.namePrefix),
           @"givenName": ABI45_0_0EXNullIfNil(nameComponents.givenName),
           @"middleName": ABI45_0_0EXNullIfNil(nameComponents.middleName),
           @"familyName": ABI45_0_0EXNullIfNil(nameComponents.familyName),
           @"nameSuffix": ABI45_0_0EXNullIfNil(nameComponents.nameSuffix),
           @"nickname": ABI45_0_0EXNullIfNil(nameComponents.nickname)
           };
}
