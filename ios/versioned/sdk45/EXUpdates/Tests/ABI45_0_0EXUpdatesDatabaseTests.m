...
@interface ABI45_0_0EXUpdatesDatabaseTests : XCTestCase
...
@implementation ABI45_0_0EXUpdatesDatabaseTests
...
{
  ABI45_0_0EXUpdatesManifestHeaders *manifestHeaders1 = [[ABI45_0_0EXUpdatesManifestHeaders alloc] initWithProtocolVersion:nil
                                                                                   serverDefinedHeaders:nil
                                                                                        manifestFilters:@"branch-name=\"rollout-1\",test=\"value\""
                                                                                      manifestSignature:nil
                                                                                               signature:nil];
  ABI45_0_0EXUpdatesUpdate *update1 = [ABI45_0_0EXUpdatesNewUpdate updateWithNewManifest:_manifest
  ...
  ABI45_0_0EXUpdatesManifestHeaders *manifestHeaders2 = [[ABI45_0_0EXUpdatesManifestHeaders alloc] initWithProtocolVersion:nil
                                                                                   serverDefinedHeaders:nil
                                                                                        manifestFilters:@"branch-name=\"rollout-2\""
                                                                                      manifestSignature:nil
                                                                                               signature:nil];
  ABI45_0_0EXUpdatesUpdate *update2 = [ABI45_0_0EXUpdatesNewUpdate updateWithNewManifest:_manifest
...
{
  ABI45_0_0EXManifestsNewManifest *manifest1 = [[ABI45_0_0EXManifestsNewManifest alloc] initWithRawManifestJSON:@{
    @"runtimeVersion": @"1",
    @"id": @"0eef8214-4833-4089-9dff-b4138a14f196",
    @"createdAt": @"2020-11-11T00:17:54.797Z",
    @"launchAsset": @{@"url": @"https://url.to/bundle1.js", @"contentType": @"application/javascript"}
  }];
  ABI45_0_0EXManifestsNewManifest *manifest2 = [[ABI45_0_0EXManifestsNewManifest alloc] initWithRawManifestJSON:@{
    @"runtimeVersion": @"1",
  ...
  ABI45_0_0EXUpdatesAsset *asset1 = [self createMockAssetWithKey:@"key1"];
  ABI45_0_0EXUpdatesAsset *asset2 = [self createMockAssetWithKey:@"key2"];
  ABI45_0_0EXUpdatesAsset *asset3 = [self createMockAssetWithKey:@"key3"];
  ...
  ABI45_0_0EXUpdatesManifestHeaders *manifestHeaders = [[ABI45_0_0EXUpdatesManifestHeaders alloc] initWithProtocolVersion:nil
                                                                                   serverDefinedHeaders:nil
                                                                                      ...
                                                                                      manifestSignature:nil
                                                                                              signature:nil];
  ABI45_0_0EXUpdatesUpdate *update1 = [ABI45_0_0EXUpdatesNewUpdate updateWithNewManifest:manifest1
                                                       manifestHeaders:manifestHeaders
                                                            extensions:@{}
                                                                config:_config
                                                              database:_db];
  ABI45_0_0EXUpdatesUpdate *update2 = [ABI45_0_0EXUpdatesNewUpdate updateWithNewManifest:manifest2
                                                       manifestHeaders:manifestHeaders
                                                            extensions:@{}
                                                                config:_config
                                                              database:_db];
  ...
  dispatch_sync(_db.databaseQueue, ^{
    ...
    NSArray<ABI45_0_0EXUpdatesAsset *> *assets = [_db allAssetsWithError:nil];
    XCTAssertEqual(3, assets.count); // two bundles and asset1 and asset2

    NSError *deleteAssetsError;
    NSArray<ABI45_0_0EXUpdatesAsset *> *deletedAssets = [_db deleteUnusedAssetsWithError:&deleteAssetsError];
    ...
    for (ABI45_0_0EXUpdatesAsset *deletedAsset in deletedAssets) {
...
- (ABI45_0_0EXUpdatesAsset *)createMockAssetWithKey:(NSString *)key
{
  ABI45_0_0EXUpdatesAsset *asset = [[ABI45_0_0EXUpdatesAsset alloc] initWithKey:key type:@"png"];
