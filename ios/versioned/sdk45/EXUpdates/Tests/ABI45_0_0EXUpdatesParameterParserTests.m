...
@interface ABI45_0_0EXUpdatesParameterParserTests : XCTestCase
@end

@implementation ABI45_0_0EXUpdatesParameterParserTests
...
- (void)testParameterParser
{
  ...
  for (NSArray *testCase in testCases) {
    ...
    NSDictionary<NSString *, NSString *> *parameters = [[ABI45_0_0EXUpdatesParameterParser new] parseParameterString:parameterString withDelimiter:';'];
