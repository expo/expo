...
@interface ABI45_0_0EXUpdatesSelectionPolicyFilterAwareTests : XCTestCase

@property (nonatomic, strong) ABI45_0_0EXUpdatesUpdate *updateDefault1;
@property (nonatomic, strong) ABI45_0_0EXUpdatesUpdate *updateDefault2;
@property (nonatomic, strong) ABI45_0_0EXUpdatesUpdate *updateRollout0;
@property (nonatomic, strong) ABI45_0_0EXUpdatesUpdate *updateRollout1;
@property (nonatomic, strong) ABI45_0_0EXUpdatesUpdate *updateRollout2;
@property (nonatomic, strong) ABI45_0_0EXUpdatesUpdate *updateMultipleFilters;
@property (nonatomic, strong) ABI45_0_0EXUpdatesUpdate *updateNoMetadata;
@property (nonatomic, strong) ABI45_0_0EXUpdatesSelectionPolicy *selectionPolicy;
@property (nonatomic, strong) NSDictionary *manifestFilters;

@end

@implementation ABI45_0_0EXUpdatesSelectionPolicyFilterAwareTests
...
- (void)setUp
{
  ...
  ABI45_0_0EXUpdatesConfig *config = [ABI45_0_0EXUpdatesConfig configWithDictionary:@{
    ABI45_0_0EXUpdatesConfigRuntimeVersionKey: runtimeVersion,
  ...
  _updateRollout0 = [ABI45_0_0EXUpdatesNewUpdate updateWithNewManifest:[[ABI45_0_0EXManifestsNewManifest alloc] initWithRawManifestJSON:@{
  ...
  _updateDefault1 = [ABI45_0_0EXUpdatesNewUpdate updateWithNewManifest:[[ABI45_0_0EXManifestsNewManifest alloc] initWithRawManifestJSON:@{
  ...
  _updateRollout1 = [ABI45_0_0EXUpdatesNewUpdate updateWithNewManifest:[[ABI45_0_0EXManifestsNewManifest alloc] initWithRawManifestJSON:@{
  ...
  _updateDefault2 = [ABI45_0_0EXUpdatesNewUpdate updateWithNewManifest:[[ABI45_0_0EXManifestsNewManifest alloc] initWithRawManifestJSON:@{
  ...
  _updateRollout2 = [ABI45_0_0EXUpdatesNewUpdate updateWithNewManifest:[[ABI45_0_0EXManifestsNewManifest alloc] initWithRawManifestJSON:@{
  ...
  _updateMultipleFilters = [ABI45_0_0EXUpdatesNewUpdate updateWithNewManifest:[[ABI45_0_0EXManifestsNewManifest alloc] initWithRawManifestJSON:@{
    @"id": @"079cde35-8433-4c17-81c8-7117c1513e72",
    @"createdAt": @"2021-01-11T19:39:22.480Z",
    @"runtimeVersion": @"1.0",
    @"launchAsset": launchAsset,
  ...
  _updateNoMetadata = [ABI45_0_0EXUpdatesNewUpdate updateWithNewManifest:[[ABI45_0_0EXManifestsNewManifest alloc] initWithRawManifestJSON:@{
    @"id": @"079cde35-8433-4c17-81c8-7117c1513e72",
    @"createdAt": @"2021-01-11T19:39:22.480Z",
    @"runtimeVersion": @"1.0",
    @"launchAsset": launchAsset,
  ...
  _selectionPolicy = [ABI45_0_0EXUpdatesSelectionPolicyFactory filterAwarePolicyWithRuntimeVersion:runtimeVersion];
...
{
  ABI45_0_0EXUpdatesUpdate *actual = [_selectionPolicy launchableUpdateFromUpdates:@[_updateDefault1, _updateRollout1, _updateDefault2] filters:_manifestFilters];
...
{
  NSArray<ABI45_0_0EXUpdatesUpdate *> *actual = [_selectionPolicy updatesToDeleteWithLaunchedUpdate:_updateRollout2 updates:@[_updateRollout0, _updateDefault1, _updateRollout1, _updateDefault2, _updateRollout2] filters:_manifestFilters];
...
{
  NSArray<ABI45_0_0EXUpdatesUpdate *> *actual = [_selectionPolicy updatesToDeleteWithLaunchedUpdate:_updateRollout2 updates:@[_updateDefault1, _updateDefault2, _updateRollout2] filters:_manifestFilters];
...
- (void)testDoesUpdateMatchFilters_MultipleFilters
{
  ...
  XCTAssertFalse([ABI45_0_0EXUpdatesSelectionPolicies doesUpdate:_updateMultipleFilters matchFilters:filtersBadMatch], @"should fail unless all filters pass");

  NSDictionary *filtersGoodMatch = @{
    @"firstkey": @"value1",
    @"secondkey": @"value2"
  };
  XCTAssertTrue([ABI45_0_0EXUpdatesSelectionPolicies doesUpdate:_updateMultipleFilters matchFilters:filtersGoodMatch], @"should pass if all filters pass");
}

- (void)testDoesUpdateMatchFilters_EmptyMatchesAll
{
  XCTAssertTrue([ABI45_0_0EXUpdatesSelectionPolicies doesUpdate:_updateDefault1 matchFilters:@{@"field-that-update-doesnt-have": @"value"}], @"no field counts as a match");
}

- (void)testDoesUpdateMatchFilters_Null
{
  // null filters or null metadata (i.e. bare or legacy manifests) is counted as a match
  XCTAssertTrue([ABI45_0_0EXUpdatesSelectionPolicies doesUpdate:_updateDefault1 matchFilters:nil]);
  XCTAssertTrue([ABI45_0_0EXUpdatesSelectionPolicies doesUpdate:_updateNoMetadata matchFilters:_manifestFilters]);
}
