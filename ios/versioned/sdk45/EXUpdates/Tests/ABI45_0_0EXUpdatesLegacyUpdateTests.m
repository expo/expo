...
@interface ABI45_0_0EXUpdatesLegacyUpdateTests : XCTestCase

@property (nonatomic, strong) ABI45_0_0EXUpdatesConfig *config;
@property (nonatomic, strong) ABI45_0_0EXUpdatesConfig *selfHostedConfig;
@property (nonatomic, strong) ABI45_0_0EXUpdatesDatabase *database;

@end

@implementation ABI45_0_0EXUpdatesLegacyUpdateTests
...
- (void)setUp
{
  ...
  _selfHostedConfig = [ABI45_0_0EXUpdatesConfig configWithDictionary:@{
    ABI45_0_0EXUpdatesConfigUpdateUrlKey: @"https://esamelson.github.io/self-hosting-test/ios-index.json",
    ABI45_0_0EXUpdatesConfigSDKVersionKey: @"38.0.0"
  }];
...
{
  ABI45_0_0EXManifestsLegacyManifest *manifest = [[ABI45_0_0EXManifestsLegacyManifest alloc] initWithRawManifestJSON:@{}];
  NSURL *expected = [NSURL URLWithString:@"https://classic-assets.eascdn.net/~assets/"];
  XCTAssert([expected isEqual:[ABI45_0_0EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:manifest config:[ABI45_0_0EXUpdatesConfig configWithDictionary:@{ABI45_0_0EXUpdatesConfigUpdateUrlKey: @"https://exp.host/@test/test"}]]]);
  XCTAssert([expected isEqual:[ABI45_0_0EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:manifest config:[ABI45_0_0EXUpdatesConfig configWithDictionary:@{ABI45_0_0EXUpdatesConfigUpdateUrlKey: @"https://expo.io/@test/test"}]]]);
  XCTAssert([expected isEqual:[ABI45_0_0EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:manifest config:[ABI45_0_0EXUpdatesConfig configWithDictionary:@{ABI45_0_0EXUpdatesConfigUpdateUrlKey: @"https://expo.test/@test/test"}]]]);
}
...
- (void)testBundledAssetBaseUrl_ExpoSubdomain
{
  ABI45_0_0EXManifestsLegacyManifest *manifest = [[ABI45_0_0EXManifestsLegacyManifest alloc] initWithRawManifestJSON:@{}];
  NSURL *expected = [NSURL URLWithString:@"https://classic-assets.eascdn.net/~assets/"];
  XCTAssert([expected isEqual:[ABI45_0_0EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:manifest config:[ABI45_0_0EXUpdatesConfig configWithDictionary:@{ABI45_0_0EXUpdatesConfigUpdateUrlKey: @"https://staging.exp.host/@test/test"}]]]);
  XCTAssert([expected isEqual:[ABI45_0_0EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:manifest config:[ABI45_0_0EXUpdatesConfig configWithDictionary:@{ABI45_0_0EXUpdatesConfigUpdateUrlKey: @"https://staging.expo.io/@test/test"}]]]);
  XCTAssert([expected isEqual:[ABI45_0_0EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:manifest config:[ABI45_0_0EXUpdatesConfig configWithDictionary:@{ABI45_0_0EXUpdatesConfigUpdateUrlKey: @"https://staging.expo.test/@test/test"}]]]);
}
...
- (void)testBundledAssetBaseUrl_AssetUrlOverride_AbsoluteUrl
{
  ...
  NSURL *absoluteActual = [ABI45_0_0EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:[[ABI45_0_0EXManifestsLegacyManifest alloc] initWithRawManifestJSON:@{ @"assetUrlOverride": absoluteUrlString }] config:_selfHostedConfig];
...
- (void)testBundledAssetBaseUrl_AssetUrlOverride_RelativeUrl
{
  ...
  NSURL *relativeActual = [ABI45_0_0EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:[[ABI45_0_0EXManifestsLegacyManifest alloc] initWithRawManifestJSON:@{ @"assetUrlOverride": @"my_assets" }] config:_selfHostedConfig];
...
- (void)testBundledAssetBaseUrl_AssetUrlOverride_OriginRelativeUrl
{
  ...
  NSURL *originRelativeActual = [ABI45_0_0EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:[[ABI45_0_0EXManifestsLegacyManifest alloc] initWithRawManifestJSON:@{ @"assetUrlOverride": @"/my_assets" }] config:_selfHostedConfig];
...
- (void)testBundledAssetBaseUrl_AssetUrlOverride_RelativeUrlDotSlash
{
  ...
  NSURL *relativeDotSlashActual = [ABI45_0_0EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:[[ABI45_0_0EXManifestsLegacyManifest alloc] initWithRawManifestJSON:@{ @"assetUrlOverride": @"./my_assets" }] config:_selfHostedConfig];
...
- (void)testBundledAssetBaseUrl_AssetUrlOverride_Normalize
{
  ...
  NSURL *actual = [ABI45_0_0EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:[[ABI45_0_0EXManifestsLegacyManifest alloc] initWithRawManifestJSON:@{ @"assetUrlOverride": @"./a/../b" }] config:_selfHostedConfig];
...
- (void)testBundledAssetBaseUrl_AssetUrlOverride_NormalizeToHostname
{
  ...
  NSURL *actual = [ABI45_0_0EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:[[ABI45_0_0EXManifestsLegacyManifest alloc] initWithRawManifestJSON:@{ @"assetUrlOverride": @"../b" }] config:_selfHostedConfig];
...
- (void)testBundledAssetBaseUrl_AssetUrlOverride_Default
{
  ...
  NSURL *defaultActual = [ABI45_0_0EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:[[ABI45_0_0EXManifestsLegacyManifest alloc] initWithRawManifestJSON:@{}] config:_selfHostedConfig];
...
- (void)testUpdateWithLegacyManifest_Development
{
  ...
  XCTAssert([ABI45_0_0EXUpdatesLegacyUpdate updateWithLegacyManifest:manifest config:_config database:_database] != nil);
}
...
- (void)testUpdateWithLegacyManifest_Production_NoSdkVersion
{
  ...
  XCTAssertThrows([ABI45_0_0EXUpdatesLegacyUpdate updateWithLegacyManifest:manifest config:_config database:_database]);
}
...
- (void)testUpdateWithLegacyManifest_setsUpdateRuntimeAsSdkIfNoManifestRuntime
{
  ...
  ABI45_0_0EXUpdatesUpdate *update = [ABI45_0_0EXUpdatesLegacyUpdate updateWithLegacyManifest:manifest config:_config database:_database];
