...
/**
 * Fork of {@link ABI45_0_0EXUpdatesMultipartStreamReaderTests}.
 */
@interface ABI45_0_0EXUpdatesMultipartStreamReaderTests : XCTestCase

@end

@implementation ABI45_0_0EXUpdatesMultipartStreamReaderTests
...
- (void)testSimpleCase
{
  ...
  ABI45_0_0EXUpdatesMultipartStreamReader *reader = [[ABI45_0_0EXUpdatesMultipartStreamReader alloc] initWithInputStream:inputStream
