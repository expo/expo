...
#import "ABI45_0_0EXUpdates_Unit_Tests-Swift.h"

@interface ABI45_0_0EXUpdatesFileDownloaderManifestParsingTests : XCTestCase
...
@implementation ABI45_0_0EXUpdatesFileDownloaderManifestParsingTests
...
- (void)testManifestParsing_JSONBody
{
  ...
  ABI45_0_0EXUpdatesFileDownloader *downloader = [[ABI45_0_0EXUpdatesFileDownloader alloc] initWithUpdatesConfig:config];
  ...
  __block ABI45_0_0EXUpdatesUpdate *resultUpdateManifest;
  
  [downloader parseManifestResponse:response withData:bodyData database:nil successBlock:^(ABI45_0_0EXUpdatesUpdate * _Nonnull update) {
...
- (void)testManifestParsing_JSONBodySigned {
  ABI45_0_0EXUpdatesConfig *config = [ABI45_0_0EXUpdatesConfig configWithDictionary:@{
    ABI45_0_0EXUpdatesConfigUpdateUrlKey: @"https://exp.host/@test/test",
    ABI45_0_0EXUpdatesConfigCodeSigningCertificateKey: _modernJSONCertificate,
    ABI45_0_0EXUpdatesConfigCodeSigningMetadataKey: @{},
  }];
  ABI45_0_0EXUpdatesFileDownloader *downloader = [[ABI45_0_0EXUpdatesFileDownloader alloc] initWithUpdatesConfig:config];
...
- (void)testManifestParsing_JSONBodySigned_UnsignedRequest_ManifestSignatureOptional {
  ABI45_0_0EXUpdatesConfig *config = [ABI45_0_0EXUpdatesConfig configWithDictionary:@{
    ...
    ABI45_0_0EXUpdatesConfigCodeSigningCertificateKey: _modernJSONCertificate,
    ABI45_0_0EXUpdatesConfigCodeSigningMetadataKey: @{},
    ABI45_0_0EXUpdatesConfigCodeSigningAllowUnsignedManifestsKey: @YES,
  }];
  ABI45_0_0EXUpdatesFileDownloader *downloader = [[ABI45_0_0EXUpdatesFileDownloader alloc] initWithUpdatesConfig:config];
...
- (void)testManifestParsing_MultipartBodySignedCertificateParticularExperience {
  ABI45_0_0EXUpdatesConfig *config = [ABI45_0_0EXUpdatesConfig configWithDictionary:@{
    ABI45_0_0EXUpdatesConfigUpdateUrlKey: @"https://exp.host/@test/test",
    ABI45_0_0EXUpdatesConfigCodeSigningCertificateKey: _rootCertificate,
    ABI45_0_0EXUpdatesConfigCodeSigningMetadataKey: @{
      @"keyid": @"ca-root",
    },
    ABI45_0_0EXUpdatesConfigCodeSigningIncludeManifestResponseCertificateChainKey: @YES,
  }];
  ABI45_0_0EXUpdatesFileDownloader *downloader = [[ABI45_0_0EXUpdatesFileDownloader alloc] initWithUpdatesConfig:config];
