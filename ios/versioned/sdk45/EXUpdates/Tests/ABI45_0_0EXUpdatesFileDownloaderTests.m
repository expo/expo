...
@interface ABI45_0_0EXUpdatesFileDownloaderTests : XCTestCase

@end

@implementation ABI45_0_0EXUpdatesFileDownloaderTests
...
- (void)testCacheControl_LegacyManifest
{
  ABI45_0_0EXUpdatesConfig *config = [ABI45_0_0EXUpdatesConfig configWithDictionary:@{
    ...
    ABI45_0_0EXUpdatesConfigRuntimeVersionKey: @"1.0",
  }];
...
{
  ABI45_0_0EXUpdatesConfig *config = [ABI45_0_0EXUpdatesConfig configWithDictionary:@{
    ABI45_0_0EXUpdatesConfigUpdateUrlKey: @"https://u.expo.dev/00000000-0000-0000-0000-000000000000",
    ABI45_0_0EXUpdatesConfigRuntimeVersionKey: @"1.0",
  }];
  ABI45_0_0EXUpdatesFileDownloader *downloader = [[ABI45_0_0EXUpdatesFileDownloader alloc] initWithUpdatesConfig:config];
...
- (void)testExtraHeaders_OverrideOrder
{
  ABI45_0_0EXUpdatesConfig *config = [ABI45_0_0EXUpdatesConfig configWithDictionary:@{
    ABI45_0_0EXUpdatesConfigUpdateUrlKey: @"https://u.expo.dev/00000000-0000-0000-0000-000000000000",
    ABI45_0_0EXUpdatesConfigRuntimeVersionKey: @"1.0",
    ABI45_0_0EXUpdatesConfigRequestHeadersKey: @{
...
- (void)testGetExtraHeaders
{
  ...
  ABI45_0_0EXUpdatesUpdate *launchedUpdate = [ABI45_0_0EXUpdatesUpdate updateWithId:[[NSUUID alloc] initWithUUIDString:launchedUpdateUUIDString]
                                                         scopeKey:@"test"
  ...
  ABI45_0_0EXUpdatesUpdate *embeddedUpdate = [ABI45_0_0EXUpdatesUpdate updateWithId:[[NSUUID alloc] initWithUUIDString:embeddedUpdateUUIDString]
                                                         scopeKey:@"test"
                                                       commitTime:[NSDate date]
                                                   runtimeVersion:@"1.0"
                                                         manifest:nil
                                                           ...
                                                           config:nil
                                                         database:nil];
  NSDictionary *extraHeaders = [ABI45_0_0EXUpdatesFileDownloader extraHeadersWithDatabase:nil
                                                                          config:nil
