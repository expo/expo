...
@objc public enum ABI45_0_0EXUpdatesCodeSigningError : Int, Error {
...
@objc public class ABI45_0_0EXUpdatesCodeSigningErrorUtils : NSObject {
  @objc public static func message(forError: ABI45_0_0EXUpdatesCodeSigningError) -> String {
    switch forError {
    case .CertificateEncodingError:
