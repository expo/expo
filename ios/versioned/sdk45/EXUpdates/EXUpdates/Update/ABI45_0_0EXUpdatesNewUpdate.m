...
@implementation ABI45_0_0EXUpdatesNewUpdate
                                  ...
                                  database:(ABI45_0_0EXUpdatesDatabase *)database
{
  ...
  if (assets) {
    for (NSDictionary *assetDict in (NSArray *)assets) {
      ...
      ABI45_0_0EXUpdatesAsset *asset = [[ABI45_0_0EXUpdatesAsset alloc] initWithKey:key type:(NSString *)fileExtension];
      asset.url = url;
  ...
  update.commitTime = [ABI45_0_0RCTConvert NSDate:(NSString *)commitTime];
...
+ (nullable NSDictionary *)dictionaryWithStructuredHeader:(NSString *)headerString
{
  ...
  ABI45_0_0EXStructuredHeadersParser *parser = [[ABI45_0_0EXStructuredHeadersParser alloc] initWithRawInput:headerString fieldType:ABI45_0_0EXStructuredHeadersParserFieldTypeDictionary ignoringParameters:YES];
  NSError *error;
