...
@class ABI45_0_0EXUpdatesDatabase;
 ...
 */
typedef NS_ENUM(NSInteger, ABI45_0_0EXUpdatesUpdateStatus) {
  ABI45_0_0EXUpdatesUpdateStatus0_Unused = 0,
  /**
   * The update has been fully downloaded and is ready to launch.
   */
  ABI45_0_0EXUpdatesUpdateStatusReady = 1,
  ABI45_0_0EXUpdatesUpdateStatus2_Unused = 2,
  /**
   * The update manifest has been download from the server but not all
   * assets have finished downloading successfully.
   */
  ABI45_0_0EXUpdatesUpdateStatusPending = 3,
  ABI45_0_0EXUpdatesUpdateStatus4_Unused = 4,
  /**
   ...
   */
  ABI45_0_0EXUpdatesUpdateStatusEmbedded = 5,
  /**
   ...
   */
  ABI45_0_0EXUpdatesUpdateStatusDevelopment = 6
};

@interface ABI45_0_0EXUpdatesUpdate : NSObject
...
@property (nonatomic, strong, readonly) NSArray<ABI45_0_0EXUpdatesAsset *> *assets;
...
@property (nonatomic, strong, readonly) ABI45_0_0EXManifestsManifest *manifest;

@property (nonatomic, assign) ABI45_0_0EXUpdatesUpdateStatus status;
