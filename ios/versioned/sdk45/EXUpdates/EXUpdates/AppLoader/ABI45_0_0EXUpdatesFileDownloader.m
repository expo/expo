...
#import <ABI45_0_0EXUpdates/ABI45_0_0EXUpdatesMultipartStreamReader.h>
#import <ABI45_0_0EXUpdates/ABI45_0_0EXUpdatesParameterParser.h>
...
NSTimeInterval const ABI45_0_0EXUpdatesDefaultTimeoutInterval = 60;

NSString * const ABI45_0_0EXUpdatesMultipartManifestPartName = @"manifest";
NSString * const ABI45_0_0EXUpdatesMultipartExtensionsPartName = @"extensions";
NSString * const ABI45_0_0EXUpdatesMultipartCertificateChainPartName = @"certificate_chain";

NSString * const ABI45_0_0EXUpdatesFileDownloaderErrorDomain = @"ABI45_0_0EXUpdatesFileDownloader";
const NSInteger ABI45_0_0EXUpdatesFileDownloaderErrorCodeFileWriteError = 1002;
const NSInteger ABI45_0_0EXUpdatesFileDownloaderErrorCodeManifestVerificationError = 1003;
const NSInteger ABI45_0_0EXUpdatesFileDownloaderErrorCodeNoCompatibleUpdateError = 1009;
const NSInteger ABI45_0_0EXUpdatesFileDownloaderErrorCodeMismatchedManifestFiltersError = 1021;
const NSInteger ABI45_0_0EXUpdatesFileDownloaderErrorCodeManifestParseError = 1022;
const NSInteger ABI45_0_0EXUpdatesFileDownloaderErrorCodeInvalidResponseError = 1040;
const NSInteger ABI45_0_0EXUpdatesFileDownloaderErrorCodeManifestStringError = 1041;
const NSInteger ABI45_0_0EXUpdatesFileDownloaderErrorCodeManifestJSONError = 1042;
const NSInteger ABI45_0_0EXUpdatesFileDownloaderErrorCodeManifestSignatureError = 1043;
const NSInteger ABI45_0_0EXUpdatesFileDownloaderErrorCodeMultipartParsingError = 1044;
const NSInteger ABI45_0_0EXUpdatesFileDownloaderErrorCodeMultipartMissingManifestError = 1045;
const NSInteger ABI45_0_0EXUpdatesFileDownloaderErrorCodeMissingMultipartBoundaryError = 1047;
const NSInteger ABI45_0_0EXUpdatesFileDownloaderErrorCodeCodeSigningSignatureError = 1048;

@interface ABI45_0_0EXUpdatesFileDownloader () <NSURLSessionDataDelegate>
...
@implementation ABI45_0_0EXUpdatesFileDownloader
                 ...
                 errorBlock:(ABI45_0_0EXUpdatesFileDownloaderErrorBlock)errorBlock
{
  [self downloadDataFromURL:url extraHeaders:extraHeaders successBlock:^(NSData *data, NSURLResponse *response) {
    ...
    if ([data writeToFile:destinationPath options:NSDataWritingAtomic error:&error]) {
      ...
      errorBlock([NSError errorWithDomain:ABI45_0_0EXUpdatesFileDownloaderErrorDomain
                                     code:ABI45_0_0EXUpdatesFileDownloaderErrorCodeFileWriteError
                                 userInfo:@{
...
- (NSURLRequest *)createManifestRequestWithURL:(NSURL *)url extraHeaders:(nullable NSDictionary *)extraHeaders
{
  ...
  NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url cachePolicy:cachePolicy timeoutInterval:ABI45_0_0EXUpdatesDefaultTimeoutInterval];
...
- (void)parseManifestResponse:(NSHTTPURLResponse *)httpResponse
  ...
  if ([[contentType lowercaseString] hasPrefix:@"multipart/"]) {
    NSDictionary<NSString *, NSString *> *contentTypeParameters = [[ABI45_0_0EXUpdatesParameterParser new] parseParameterString:contentType withDelimiter:';'];
    NSString *boundaryParameterValue = contentTypeParameters[@"boundary"];

    if (boundaryParameterValue == nil) {
      NSError *error = [NSError errorWithDomain:ABI45_0_0EXUpdatesFileDownloaderErrorDomain
                                           code:ABI45_0_0EXUpdatesFileDownloaderErrorCodeMissingMultipartBoundaryError
                                       userInfo:@{
    ...
    ABI45_0_0EXUpdatesManifestHeaders *manifestHeaders = [[ABI45_0_0EXUpdatesManifestHeaders alloc] initWithProtocolVersion:responseHeaders[@"expo-protocol-version"]
...
- (void)parseMultipartManifestResponse:(NSHTTPURLResponse *)httpResponse
  ...
  ABI45_0_0EXUpdatesMultipartStreamReader *reader = [[ABI45_0_0EXUpdatesMultipartStreamReader alloc] initWithInputStream:inputStream boundary:boundary];
  ...
  BOOL completed = [reader readAllPartsWithCompletionCallback:^(NSDictionary *headers, NSData *content, BOOL done) {
    ...
    if (contentDisposition != nil) {
      NSDictionary<NSString *, NSString *> *contentDispositionParameters = [[ABI45_0_0EXUpdatesParameterParser new] parseParameterString:contentDisposition withDelimiter:';'];
      NSString *contentDispositionNameFieldValue = contentDispositionParameters[@"name"];
      if (contentDispositionNameFieldValue != nil) {
        if ([contentDispositionNameFieldValue isEqualToString:ABI45_0_0EXUpdatesMultipartManifestPartName]) {
          manifestPartHeaders = headers;
          manifestPartData = content;
        } else if ([contentDispositionNameFieldValue isEqualToString:ABI45_0_0EXUpdatesMultipartExtensionsPartName]) {
          extensionsData = content;
        } else if ([contentDispositionNameFieldValue isEqualToString:ABI45_0_0EXUpdatesMultipartCertificateChainPartName]) {
  ...
  if (!completed) {
    NSError *error = [NSError errorWithDomain:ABI45_0_0EXUpdatesFileDownloaderErrorDomain
                                         code:ABI45_0_0EXUpdatesFileDownloaderErrorCodeMultipartParsingError
                                     userInfo:@{
  ...
  if (manifestPartHeaders == nil || manifestPartData == nil) {
    NSError *error = [NSError errorWithDomain:ABI45_0_0EXUpdatesFileDownloaderErrorDomain
                                         code:ABI45_0_0EXUpdatesFileDownloaderErrorCodeMultipartMissingManifestError
                                     userInfo:@{
...
certificateChainFromManifestResponse:(nullable NSString *)certificateChainFromManifestResponse
  ...
  if (![manifestString isKindOfClass:[NSString class]]) {
    errorBlock([NSError errorWithDomain:ABI45_0_0EXUpdatesFileDownloaderErrorDomain
                                   code:ABI45_0_0EXUpdatesFileDownloaderErrorCodeManifestStringError
                               userInfo:@{
  ...
  if (error || !manifest || ![manifest isKindOfClass:[NSDictionary class]]) {
    errorBlock([NSError errorWithDomain:ABI45_0_0EXUpdatesFileDownloaderErrorDomain
                                   code:ABI45_0_0EXUpdatesFileDownloaderErrorCodeManifestJSONError
                               userInfo:@{
  ...
  if (signature != nil && !isUnsignedFromXDL) {
    if (![signature isKindOfClass:[NSString class]]) {
      errorBlock([NSError errorWithDomain:ABI45_0_0EXUpdatesFileDownloaderErrorDomain
                                     code:ABI45_0_0EXUpdatesFileDownloaderErrorCodeManifestSignatureError
                                 userInfo:@{
    ...
    [ABI45_0_0EXUpdatesCrypto verifySignatureWithData:(NSString *)manifestString
                                ...
                                successBlock:^(BOOL isValid) {
                                             ...
                                             certificateChainFromManifestResponse:certificateChainFromManifestResponse
                                                  ...
                                                  NSError *error = [NSError errorWithDomain:ABI45_0_0EXUpdatesFileDownloaderErrorDomain
                                                                                       code:ABI45_0_0EXUpdatesFileDownloaderErrorCodeManifestVerificationError
                     ...
                     errorBlock:(ABI45_0_0EXUpdatesFileDownloaderErrorBlock)errorBlock
{
  ...
  [self _downloadDataWithRequest:request successBlock:^(NSData *data, NSURLResponse *response) {
    if (![response isKindOfClass:[NSHTTPURLResponse class]]) {
      errorBlock([NSError errorWithDomain:ABI45_0_0EXUpdatesFileDownloaderErrorDomain
                                     code:ABI45_0_0EXUpdatesFileDownloaderErrorCodeInvalidResponseError
                                 userInfo:@{
                       ...
                       errorBlock:(ABI45_0_0EXUpdatesFileDownloaderErrorBlock)errorBlock
{
  ...
  ABI45_0_0EXUpdatesCodeSigningConfiguration *codeSigningConfiguration = _config.codeSigningConfiguration;
  if (codeSigningConfiguration) {
    NSError *error;
    ABI45_0_0EXUpdatesSignatureValidationResult *signatureValidationResult = [codeSigningConfiguration validateSignatureWithSignature:manifestHeaders.signature
    ...
    if (error) {
      ...
      errorBlock([NSError errorWithDomain:ABI45_0_0EXUpdatesFileDownloaderErrorDomain
                                     code:ABI45_0_0EXUpdatesFileDownloaderErrorCodeCodeSigningSignatureError
                                 userInfo:@{NSLocalizedDescriptionKey: [NSString stringWithFormat:@"Downloaded manifest signature is invalid: %@", message]}]);
      return;
    }

    if (signatureValidationResult.validationResult == ABI45_0_0EXUpdatesValidationResultInvalid) {
      errorBlock([NSError errorWithDomain:ABI45_0_0EXUpdatesFileDownloaderErrorDomain
                                     code:ABI45_0_0EXUpdatesFileDownloaderErrorCodeCodeSigningSignatureError
    ...
    if (signatureValidationResult.validationResult != ABI45_0_0EXUpdatesValidationResultSkipped) {
      ABI45_0_0EXUpdatesExpoProjectInformation *expoProjectInformation = signatureValidationResult.expoProjectInformation;
      if (expoProjectInformation != nil) {
        NSError *error;
        ABI45_0_0EXUpdatesUpdate *update;
        @try {
          update = [ABI45_0_0EXUpdatesUpdate updateWithManifest:mutableManifest
                                       manifestHeaders:manifestHeaders
                                            extensions:extensions
                                                config:_config
                                              database:database
        ...
        @catch (NSException *exception) {
          ...
          error = [NSError errorWithDomain:ABI45_0_0EXUpdatesFileDownloaderErrorDomain
                                      code:ABI45_0_0EXUpdatesFileDownloaderErrorCodeManifestParseError
        ...
        ABI45_0_0EXManifestsManifest *manifestForProjectInformation = update.manifest;
  ...
  if (![ABI45_0_0EXUpdatesSelectionPolicies doesUpdate:update matchFilters:update.manifestFilters]) {
    NSError *error = [NSError errorWithDomain:ABI45_0_0EXUpdatesFileDownloaderErrorDomain
                                         code:ABI45_0_0EXUpdatesFileDownloaderErrorCodeMismatchedManifestFiltersError
...
- (nullable NSDictionary *)_extractUpdateResponseDictionary:(id)parsedJson error:(NSError **)error
{
  ...
  if (error) {
    *error = [NSError errorWithDomain:ABI45_0_0EXUpdatesFileDownloaderErrorDomain
                                 code:ABI45_0_0EXUpdatesFileDownloaderErrorCodeNoCompatibleUpdateError
...
- (void)_setManifestHTTPHeaderFields:(NSMutableURLRequest *)request withExtraHeaders:(nullable NSDictionary *)extraHeaders
{
  ...
  NSString *previousFatalError = [ABI45_0_0EXUpdatesErrorRecovery consumeErrorLog];
...
- (NSError *)_errorFromResponse:(NSHTTPURLResponse *)response body:(NSString *)body
{
  ...
  return [NSError errorWithDomain:ABI45_0_0EXUpdatesFileDownloaderErrorDomain code:response.statusCode userInfo:userInfo];
}
