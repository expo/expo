...
@implementation ABI45_0_0EXUpdatesLoaderSelectionPolicyFilterAware
...
- (BOOL)shouldLoadNewUpdate:(nullable ABI45_0_0EXUpdatesUpdate *)newUpdate withLaunchedUpdate:(nullable ABI45_0_0EXUpdatesUpdate *)launchedUpdate filters:(nullable NSDictionary *)filters
{
  ...
  if (![ABI45_0_0EXUpdatesSelectionPolicies doesUpdate:newUpdate matchFilters:filters]) {
    return NO;
  }
  ...
  if (![ABI45_0_0EXUpdatesSelectionPolicies doesUpdate:launchedUpdate matchFilters:filters]) {
    return YES;
  }
