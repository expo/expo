...
/**
 * An ABI45_0_0EXUpdatesLauncherSelectionPolicy which chooses an update to launch based on the manifest filters
 ...
 */
@interface ABI45_0_0EXUpdatesLauncherSelectionPolicyFilterAware : NSObject <ABI45_0_0EXUpdatesLauncherSelectionPolicy>
