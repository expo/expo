...
/**
 * An ABI45_0_0EXUpdatesReaperSelectionPolicy which chooses which updates to delete taking into account manifest filters
 ...
 */
@interface ABI45_0_0EXUpdatesReaperSelectionPolicyFilterAware : NSObject <ABI45_0_0EXUpdatesReaperSelectionPolicy>
