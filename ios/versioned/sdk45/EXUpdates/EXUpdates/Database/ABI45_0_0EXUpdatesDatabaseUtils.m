...
static NSString * const ABI45_0_0EXUpdatesDatabaseUtilsErrorDomain = @"ABI45_0_0EXUpdatesDatabase";

@implementation ABI45_0_0EXUpdatesDatabaseUtils
...
+ (NSError *)errorFromSqlite:(struct sqlite3 *)db
{
  ...
  return [NSError errorWithDomain:ABI45_0_0EXUpdatesDatabaseUtilsErrorDomain
                             code:extendedCode
