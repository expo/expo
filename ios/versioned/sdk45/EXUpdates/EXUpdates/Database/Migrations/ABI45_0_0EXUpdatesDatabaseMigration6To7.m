...
static NSString * const ABI45_0_0EXUpdatesDatabaseV6Filename = @"expo-v6.db";

@implementation ABI45_0_0EXUpdatesDatabaseMigration6To7

- (NSString *)filename
{
  return ABI45_0_0EXUpdatesDatabaseV6Filename;
}
