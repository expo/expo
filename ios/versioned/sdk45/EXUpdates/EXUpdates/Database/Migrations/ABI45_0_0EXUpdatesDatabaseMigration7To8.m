...
static NSString * const ABI45_0_0EXUpdatesDatabaseV7Filename = @"expo-v7.db";

@implementation ABI45_0_0EXUpdatesDatabaseMigration7To8

- (NSString *)filename
{
  return ABI45_0_0EXUpdatesDatabaseV7Filename;
}
