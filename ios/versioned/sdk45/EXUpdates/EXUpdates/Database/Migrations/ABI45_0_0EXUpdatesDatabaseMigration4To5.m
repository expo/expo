...
static NSString * const ABI45_0_0EXUpdatesDatabaseV4Filename = @"expo-v4.db";

@implementation ABI45_0_0EXUpdatesDatabaseMigration4To5

- (NSString *)filename
{
  return ABI45_0_0EXUpdatesDatabaseV4Filename;
}
