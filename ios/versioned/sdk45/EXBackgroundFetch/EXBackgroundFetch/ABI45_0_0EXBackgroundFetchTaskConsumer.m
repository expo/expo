...
@implementation ABI45_0_0EXBackgroundFetchTaskConsumer

+ (BOOL)supportsLaunchReason:(ABI45_0_0EXTaskLaunchReason)launchReason
{
  return launchReason == ABI45_0_0EXTaskLaunchReasonBackgroundFetch;
}
...
- (NSUInteger)normalizeTaskResult:(id)result
{
  ...
  switch ([result unsignedIntegerValue]) {
    case ABI45_0_0EXBackgroundFetchResultNewData:
      return UIBackgroundFetchResultNewData;
    case ABI45_0_0EXBackgroundFetchResultFailed:
      return UIBackgroundFetchResultFailed;
    case ABI45_0_0EXBackgroundFetchResultNoData:
    default:
      return UIBackgroundFetchResultNoData;
  }
}
