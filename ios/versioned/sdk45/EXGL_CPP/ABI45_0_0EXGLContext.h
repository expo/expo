...
#include "ABI45_0_0EXTypedArrayApi.h"
...
class ABI45_0_0EXGLContext {
 ...
 public:
  ABI45_0_0EXGLContext(ABI45_0_0EXGLContextId ctxId): ctxId(ctxId) {}
  ...
  ABI45_0_0EXGLObjectId createObject(void) noexcept;
  void destroyObject(ABI45_0_0EXGLObjectId exglObjId) noexcept;
  void mapObject(ABI45_0_0EXGLObjectId exglObjId, GLuint glObj) noexcept;
  GLuint lookupObject(ABI45_0_0EXGLObjectId exglObjId) noexcept;
 ...
 public:
  ABI45_0_0EXGLContextId ctxId;

  // Object mapping
  std::unordered_map<ABI45_0_0EXGLObjectId, GLuint> objects;
