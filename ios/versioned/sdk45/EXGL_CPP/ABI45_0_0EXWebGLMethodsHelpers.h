...
inline jsi::Value exglGetActiveInfo(
    ...
    jsi::Runtime &runtime,
    ABI45_0_0EXGLObjectId fProgram,
    GLuint index,
    GLenum lengthParam,
    Func glFunc) {
  if (fProgram == 0) {
...
inline jsi::Value
exglIsObject(ABI45_0_0EXGLContext *ctx, ABI45_0_0EXGLObjectId id, std::function<GLboolean(GLuint)> func) {
  GLboolean glResult;
...
inline jsi::Value exglGenObject(
    ABI45_0_0EXGLContext *ctx,
    jsi::Runtime &runtime,
    std::function<void(GLsizei, ABI45_0_0EXGLObjectId *)> func,
...
inline jsi::Value
exglDeleteObject(ABI45_0_0EXGLContext *ctx, ABI45_0_0EXGLObjectId id, std::function<void(ABI45_0_0EXGLObjectId)> func) {
...
inline jsi::Value exglDeleteObject(
    ABI45_0_0EXGLContext *ctx,
    ABI45_0_0EXGLObjectId id,
    std::function<void(GLsizei, const ABI45_0_0EXGLObjectId *)> func) {
  ctx->addToNextBatch([=] {
