...
@interface ABI45_0_0EXSessionCancelableUploadTaskDelegate ()

@property (strong, nonatomic, readonly) ABI45_0_0EXUploadDelegateOnSendCallback onSendCallback;
@property (weak, nonatomic) ABI45_0_0EXTaskHandlersManager *manager;
@property (strong, nonatomic) NSString *uuid;

@end

@implementation ABI45_0_0EXSessionCancelableUploadTaskDelegate
