...
@interface ABI45_0_0EXSessionTaskDelegate : NSObject

@property (nonatomic, strong, readonly) ABI45_0_0EXPromiseResolveBlock resolve;
@property (nonatomic, strong, readonly) ABI45_0_0EXPromiseRejectBlock reject;
