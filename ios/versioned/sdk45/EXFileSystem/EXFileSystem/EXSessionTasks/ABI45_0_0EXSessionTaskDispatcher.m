...
@interface ABI45_0_0EXSessionTaskDispatcher ()

@property (nonatomic, strong) NSMutableDictionary<NSURLSessionTask *, ABI45_0_0EXSessionTaskDelegate *> *tasks;
@property (nonatomic) BOOL isActive;
@property (nonatomic, weak) id<ABI45_0_0EXSessionHandler> sessionHandler;

@end

@implementation ABI45_0_0EXSessionTaskDispatcher
...
{
  if (_isActive) {
    ABI45_0_0EXSessionTaskDelegate *exTask = _tasks[downloadTask];
    if (exTask) {
...
{
  if (_isActive) {
    ABI45_0_0EXSessionTaskDelegate *exTask = _tasks[task];
    if (exTask) {
...
{
  if (_isActive) {
    ABI45_0_0EXSessionTaskDelegate *exTask = _tasks[dataTask];
