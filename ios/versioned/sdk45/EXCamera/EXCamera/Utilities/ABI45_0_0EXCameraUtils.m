...
@implementation ABI45_0_0EXCameraUtils
...
+ (float)temperatureForWhiteBalance:(ABI45_0_0EXCameraWhiteBalance)whiteBalance
{
  switch (whiteBalance) {
    case ABI45_0_0EXCameraWhiteBalanceSunny: default:
      return 5200;
    case ABI45_0_0EXCameraWhiteBalanceCloudy:
      return 6000;
    case ABI45_0_0EXCameraWhiteBalanceShadow:
      return 7000;
    case ABI45_0_0EXCameraWhiteBalanceIncandescent:
      return 3000;
    case ABI45_0_0EXCameraWhiteBalanceFluorescent:
      return 4200;
  }
}

+ (NSString *)captureSessionPresetForVideoResolution:(ABI45_0_0EXCameraVideoResolution)resolution
{
  switch (resolution) {
    case ABI45_0_0EXCameraVideo2160p:
      return AVCaptureSessionPreset3840x2160;
    case ABI45_0_0EXCameraVideo1080p:
      return AVCaptureSessionPreset1920x1080;
    case ABI45_0_0EXCameraVideo720p:
      return AVCaptureSessionPreset1280x720;
    case ABI45_0_0EXCameraVideo4x3:
...
+ (AVVideoCodecType)videoCodecForType:(ABI45_0_0EXCameraVideoCodec)videoCodecType
{
  switch (videoCodecType) {
    case ABI45_0_0EXCameraVideoCodecH264:
      return AVVideoCodecTypeH264;
    case ABI45_0_0EXCameraVideoCodecHEVC:
      return AVVideoCodecTypeHEVC;
    case ABI45_0_0EXCameraVideoCodecJPEG:
      return AVVideoCodecTypeJPEG;
    case ABI45_0_0EXCameraVideoCodecAppleProRes422:
      return AVVideoCodecTypeAppleProRes422;
    case ABI45_0_0EXCameraVideoCodecAppleProRes4444:
...
{
  // Get metadata (includes the ABI45_0_0EXIF data)
