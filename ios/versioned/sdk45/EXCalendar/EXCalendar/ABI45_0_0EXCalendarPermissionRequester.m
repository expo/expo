#import <ABI45_0_0EXCalendar/ABI45_0_0EXCalendarPermissionRequester.h>
#import <EventKit/EventKit.h>
#import <ABI45_0_0ExpoModulesCore/ABI45_0_0EXDefines.h>

@implementation ABI45_0_0EXCalendarPermissionRequester
...
- (NSDictionary *)getPermissions
{
  ...
  if (!calendarUsageDescription) {
    ABI45_0_0EXFatal(ABI45_0_0EXErrorWithMessage(@"This app is missing NSCalendarsUsageDescription, so calendar methods will fail. Add this key to your bundle's Info.plist."));
