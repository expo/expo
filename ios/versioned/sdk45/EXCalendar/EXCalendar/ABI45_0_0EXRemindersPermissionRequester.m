#import <ABI45_0_0EXCalendar/ABI45_0_0EXRemindersPermissionRequester.h>
#import <EventKit/EventKit.h>


@implementation ABI45_0_0EXRemindersPermissionRequester
...
- (NSDictionary *)getPermissions
{
  ...
  if (!remindersUsageDescription) {
    ABI45_0_0EXFatal(ABI45_0_0EXErrorWithMessage(@"This app is missing NSRemindersUsageDescription, so reminders methods will fail. Add this key to your bundle's Info.plist."));
