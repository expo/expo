...
/**
 Internal `ABI45_0_0EXReactDelegateWrapper` interface for the designated initializer with `ExpoReactDelegate`.
 ...
 */
@interface ABI45_0_0EXReactDelegateWrapper(Private)
