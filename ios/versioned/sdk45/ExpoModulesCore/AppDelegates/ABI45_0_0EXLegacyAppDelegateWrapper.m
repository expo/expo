...
@implementation ABI45_0_0EXLegacyAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitializedAndSorted {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI45_0_0EXSingletonModule*> * singletonModules = [[ABI45_0_0EXModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI45_0_0EXSingletonModule *singletonModule in singletonModules) {
