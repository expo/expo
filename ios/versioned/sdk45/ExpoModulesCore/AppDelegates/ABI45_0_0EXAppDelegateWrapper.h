 ...
 */
@interface ABI45_0_0EXAppDelegateWrapper : UIResponder <UIApplicationDelegate>

@property (nonatomic, strong, readonly) ABI45_0_0EXReactDelegateWrapper *reactDelegate;
