...
@protocol ABI45_0_0EXTaskConsumerInterface;

@protocol ABI45_0_0EXTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI45_0_0EXTaskConsumerInterface> __nonnull consumer;
