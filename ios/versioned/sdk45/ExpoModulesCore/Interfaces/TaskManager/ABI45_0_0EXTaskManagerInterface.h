...
// Interface for ABI45_0_0EXTaskManager module.

@protocol ABI45_0_0EXTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI45_0_0EXTaskConsumerInterface protocol.
 */
