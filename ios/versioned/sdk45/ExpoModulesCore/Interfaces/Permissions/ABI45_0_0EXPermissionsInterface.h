...
// Many headers of permissions requesters have refs to `ABI45_0_0UMPromise*Block` without importing
// the header declaring it, so we fix it here, but this definitely needs to be removed.
#import <ABI45_0_0ExpoModulesCore/ABI45_0_0EXUnimodulesCompat.h>

typedef enum ABI45_0_0EXPermissionStatus {
  ABI45_0_0EXPermissionStatusDenied,
  ABI45_0_0EXPermissionStatusGranted,
  ABI45_0_0EXPermissionStatusUndetermined,
} ABI45_0_0EXPermissionStatus;


@protocol ABI45_0_0EXPermissionsRequester <NSObject>
...
@protocol ABI45_0_0EXPermissionsInterface
