...
public final class SwiftInteropBridge: NSObject {
  ...
  @objc
  public init(modulesProvider: ModulesProvider, legacyModuleRegistry: ABI45_0_0EXModuleRegistry) {
  ...
  @objc
  public func setReactBridge(_ reactBridge: ABI45_0_0RCTBridge) {
  ...
  public func callFunction(
    ...
    withArgs args: [Any],
    resolve: @escaping ABI45_0_0EXPromiseResolveBlock,
    reject: @escaping ABI45_0_0EXPromiseRejectBlock
  ) {
    registry
