...
@interface ABI45_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI45_0_0EXBarCodeScanner *barCodeScanner;
...
@implementation ABI45_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI45_0_0EXModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI45_0_0EXAppLifecycleListener)];
...
{
  ABI45_0_0EX_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI45_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI45_0_0EXBareCodeCameraRequester class]]) {
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI45_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI45_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI45_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI45_0_0EXBarCodeScanner *barCodeScanner = [ABI45_0_0EXBarCodeScanner new];
