...
#import <ABI45_0_0EXMailComposer/ABI45_0_0EXMailComposer.h>
...
@interface ABI45_0_0EXMailComposer ()
...
@implementation ABI45_0_0EXMailComposer

ABI45_0_0EX_EXPORT_MODULE(ExpoMailComposer);
...
ABI45_0_0EX_EXPORT_METHOD_AS(composeAsync,
                    ...
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  ...
  self.reject = reject;
  id<ABI45_0_0EXUtilitiesInterface> utilities = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI45_0_0EXUtilitiesInterface)];
