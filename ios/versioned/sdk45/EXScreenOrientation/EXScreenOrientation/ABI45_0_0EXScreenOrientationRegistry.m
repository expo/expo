...
@interface ABI45_0_0EXScreenOrientationRegistry ()
...
@implementation ABI45_0_0EXScreenOrientationRegistry

ABI45_0_0EX_REGISTER_SINGLETON_MODULE(ScreenOrientationRegistry)
...
- (void)enforceDesiredDeviceOrientationWithOrientationMask:(UIInterfaceOrientationMask)orientationMask
{
  ...
  if (![ABI45_0_0EXScreenOrientationUtilities doesOrientationMask:orientationMask containOrientation:_currentScreenOrientation]) {
    __block UIInterfaceOrientation newOrientation = [ABI45_0_0EXScreenOrientationUtilities defaultOrientationForOrientationMask:orientationMask];
...
{
  UIInterfaceOrientation newScreenOrientation = [ABI45_0_0EXScreenOrientationUtilities interfaceOrientationFromDeviceOrientation:[[UIDevice currentDevice] orientation]];
...
- (void)interfaceOrientationDidChange:(UIInterfaceOrientation)newScreenOrientation
{
  ...
  if ([ABI45_0_0EXScreenOrientationUtilities doesOrientationMask:currentOrientationMask containOrientation:newScreenOrientation]) {
    ...
    if ([ABI45_0_0EXScreenOrientationUtilities isIPad] &&
...
- (void)traitCollectionDidChangeTo:(UITraitCollection *)traitCollection
{
  ...
  UIInterfaceOrientation currentDeviceOrientation = [ABI45_0_0EXScreenOrientationUtilities interfaceOrientationFromDeviceOrientation:[[UIDevice currentDevice] orientation]];
