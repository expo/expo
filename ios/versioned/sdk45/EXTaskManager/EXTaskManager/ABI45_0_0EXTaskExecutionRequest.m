...
@interface ABI45_0_0EXTaskExecutionRequest ()

@property (nonatomic, strong, nullable) NSMutableSet<id<ABI45_0_0EXTaskInterface>> *tasks;
...
@implementation ABI45_0_0EXTaskExecutionRequest
...
- (void)_maybeExecuteCallback
{
  if (_callback) {
    ...
    __strong ABI45_0_0EXTaskExecutionRequest *strongSelf = self;
