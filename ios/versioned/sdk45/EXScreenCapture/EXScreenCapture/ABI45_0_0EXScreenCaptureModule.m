...
@implementation ABI45_0_0EXScreenCaptureModule {
  UIView *_blockView;
}

ABI45_0_0EX_EXPORT_MODULE(ExpoScreenCapture);
...
ABI45_0_0EX_EXPORT_METHOD_AS(preventScreenCapture,
                    preventScreenCaptureWithResolver:(ABI45_0_0EXPromiseResolveBlock)resolve
...
ABI45_0_0EX_EXPORT_METHOD_AS(allowScreenCapture,
                    allowScreenCaptureWithResolver:(ABI45_0_0EXPromiseResolveBlock)resolve
