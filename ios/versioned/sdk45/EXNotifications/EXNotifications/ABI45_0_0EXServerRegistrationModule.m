...
#define ABI45_0_0EX_UNVERSIONED(symbol) symbol

static NSString * const kEXDeviceInstallationUUIDKey = ABI45_0_0EX_UNVERSIONED(@"ABI45_0_0EXDeviceInstallationUUIDKey");
static NSString * const kEXDeviceInstallationUUIDLegacyKey = ABI45_0_0EX_UNVERSIONED(@"ABI45_0_0EXDeviceInstallUUIDKey");

static NSString * const kEXRegistrationInfoKey = ABI45_0_0EX_UNVERSIONED(@"ABI45_0_0EXNotificationRegistrationInfoKey");

@implementation ABI45_0_0EXServerRegistrationModule

ABI45_0_0EX_EXPORT_MODULE(NotificationsServerRegistrationModule)

ABI45_0_0EX_EXPORT_METHOD_AS(getInstallationIdAsync,
                    getInstallationIdAsyncWithResolver:(ABI45_0_0EXPromiseResolveBlock)resolve
...
ABI45_0_0EX_EXPORT_METHOD_AS(getRegistrationInfoAsync,
                    getRegistrationInfoAsyncWithResolver:(ABI45_0_0EXPromiseResolveBlock)resolve
                                                rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  CFTypeRef keychainResult = NULL;
...
ABI45_0_0EX_EXPORT_METHOD_AS(setRegistrationInfoAsync,
