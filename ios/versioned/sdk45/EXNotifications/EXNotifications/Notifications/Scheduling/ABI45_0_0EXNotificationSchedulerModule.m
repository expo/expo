...
@interface ABI45_0_0EXNotificationSchedulerModule ()

@property (nonatomic, weak) id<ABI45_0_0EXNotificationBuilder> builder;

@end

@implementation ABI45_0_0EXNotificationSchedulerModule

ABI45_0_0EX_EXPORT_MODULE(ExpoNotificationScheduler);

- (void)setModuleRegistry:(ABI45_0_0EXModuleRegistry *)moduleRegistry
{
  _builder = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI45_0_0EXNotificationBuilder)];
}

# pragma mark - Exported methods

ABI45_0_0EX_EXPORT_METHOD_AS(getAllScheduledNotificationsAsync,
                    getAllScheduledNotifications:(ABI45_0_0EXPromiseResolveBlock)resolve reject:(ABI45_0_0EXPromiseRejectBlock)reject
                    )
{
...
ABI45_0_0EX_EXPORT_METHOD_AS(scheduleNotificationAsync,
                     scheduleNotification:(NSString *)identifier notificationSpec:(NSDictionary *)notificationSpec triggerSpec:(NSDictionary *)triggerSpec resolve:(ABI45_0_0EXPromiseResolveBlock)resolve rejecting:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  @try {
...
ABI45_0_0EX_EXPORT_METHOD_AS(cancelScheduledNotificationAsync,
                     cancelNotification:(NSString *)identifier resolve:(ABI45_0_0EXPromiseResolveBlock)resolve rejecting:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  [[UNUserNotificationCenter currentNotificationCenter] removePendingNotificationRequestsWithIdentifiers:@[identifier]];
  resolve(nil);
}

ABI45_0_0EX_EXPORT_METHOD_AS(cancelAllScheduledNotificationsAsync,
                     cancelAllNotificationsWithResolver:(ABI45_0_0EXPromiseResolveBlock)resolve rejecting:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  [[UNUserNotificationCenter currentNotificationCenter] removeAllPendingNotificationRequests];
  resolve(nil);
}

ABI45_0_0EX_EXPORT_METHOD_AS(getNextTriggerDateAsync,
                    getNextTriggerDate:(NSDictionary *)triggerSpec resolve:(ABI45_0_0EXPromiseResolveBlock)resolve rejecting:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  @try {
...
- (NSArray * _Nonnull)serializeNotificationRequests:(NSArray<UNNotificationRequest *> * _Nonnull) requests
{
  ...
  for (UNNotificationRequest *request in requests) {
    [serializedRequests addObject:[ABI45_0_0EXNotificationSerializer serializedNotificationRequest:request]];
  }
