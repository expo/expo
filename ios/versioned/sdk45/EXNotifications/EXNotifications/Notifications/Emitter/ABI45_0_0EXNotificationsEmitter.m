...
@interface ABI45_0_0EXNotificationsEmitter ()
...
@implementation ABI45_0_0EXNotificationsEmitter

ABI45_0_0EX_EXPORT_MODULE(ExpoNotificationsEmitter);

ABI45_0_0EX_EXPORT_METHOD_AS(getLastNotificationResponseAsync,
                    getLastNotificationResponseAsyncWithResolver:(ABI45_0_0EXPromiseResolveBlock)resolve reject:(ABI45_0_0EXPromiseRejectBlock)reject)
{
...
{
  // Silence ABI45_0_0React Native warning: "Sending ... with no listeners registered."
...
{
  return [ABI45_0_0EXNotificationSerializer serializedNotification:notification];
}

- (NSDictionary *)serializedNotificationResponse:(UNNotificationResponse *)notificationResponse
{
  return [ABI45_0_0EXNotificationSerializer serializedNotificationResponse:notificationResponse];
}
