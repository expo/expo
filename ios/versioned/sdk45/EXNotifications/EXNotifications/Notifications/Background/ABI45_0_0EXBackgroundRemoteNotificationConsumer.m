...
@implementation ABI45_0_0EXBackgroundRemoteNotificationConsumer

+ (BOOL)supportsLaunchReason:(ABI45_0_0EXTaskLaunchReason)launchReason
{
  return launchReason == ABI45_0_0EXTaskLaunchReasonRemoteNotification;
}
...
- (void)didRegisterTask:(id<ABI45_0_0EXTaskInterface>)task
{
  _task = task;
}
...
- (NSUInteger)normalizeTaskResult:(id)result
{
  ...
  switch ([result unsignedIntegerValue]) {
    case ABI45_0_0EXBackgroundNotificationResultNewData:
      return UIBackgroundFetchResultNewData;
    case ABI45_0_0EXBackgroundNotificationResultFailed:
      return UIBackgroundFetchResultFailed;
    case ABI45_0_0EXBackgroundNotificationResultNoData:
    default:
      return UIBackgroundFetchResultNoData;
  }
}
