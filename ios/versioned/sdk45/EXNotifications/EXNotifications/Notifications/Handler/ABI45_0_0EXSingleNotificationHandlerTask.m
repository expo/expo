...
static NSString * const ABI45_0_0EXNotificationHandlerErrorDomain = @"expo.notifications.handler";

@interface ABI45_0_0EXSingleNotificationHandlerTask ()
...
@property (nonatomic, weak) id<ABI45_0_0EXSingleNotificationHandlerTaskDelegate> delegate;

@property (nonatomic, strong) NSTimer *timer;

@end

@implementation ABI45_0_0EXSingleNotificationHandlerTask
...
- (instancetype)initWithEventEmitter:(id<ABI45_0_0EXEventEmitterService>)eventEmitter
                   ...
                   completionHandler:(void (^)(UNNotificationPresentationOptions))completionHandler
                            delegate:(nonnull id<ABI45_0_0EXSingleNotificationHandlerTaskDelegate>)delegate
{
  if (self = [super init]) {
...
- (void)start
{
  [_eventEmitter sendEventWithName:onHandleNotification body:@{
    ...
    @"notification": [ABI45_0_0EXNotificationSerializer serializedNotification:_notification]
  }];
...
- (nullable NSError *)callCompletionHandlerWithOptions:(UNNotificationPresentationOptions)options
{
  if (_completionHandler) {
    ...
    return [NSError errorWithDomain:ABI45_0_0EXNotificationHandlerErrorDomain code:-1 userInfo:@{
