...
@interface ABI45_0_0EXRemoteNotificationPermissionSingletonModule ()

@property (nonatomic, strong) NSPointerArray *delegates;

@end

@implementation ABI45_0_0EXRemoteNotificationPermissionSingletonModule

ABI45_0_0EX_REGISTER_SINGLETON_MODULE(RemoteNotificationPermissionPublisher);
...
# pragma mark - ABI45_0_0EXNotificationCenterDelegate
