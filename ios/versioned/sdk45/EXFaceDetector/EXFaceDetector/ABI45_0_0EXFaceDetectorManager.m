//
//  ABI45_0_0EXFaceDetectorManager.m
//  Exponent
//
//  Created by Stanisław Chmiela on 22.11.2017.
//  Copyright © 2017 650 Industries. All rights reserved.

#import <ABI45_0_0EXFaceDetector/ABI45_0_0EXFaceEncoder.h>
#import <ABI45_0_0EXFaceDetector/ABI45_0_0EXFaceDetectorUtils.h>
#import <ABI45_0_0EXFaceDetector/ABI45_0_0EXFaceDetectorModule.h>
#import <ABI45_0_0EXFaceDetector/ABI45_0_0EXFaceDetectorManager.h>
#import <ABI45_0_0EXFaceDetector/ABI45_0_0EXFaceDetector.h>
#import <ABI45_0_0EXFaceDetector/ABI45_0_0EXCSBufferOrientationCalculator.h>

static const NSString *kMinDetectionInterval = @"minDetectionInterval";

@interface ABI45_0_0EXFaceDetectorManager() <AVCaptureVideoDataOutputSampleBufferDelegate>
...
@property ABI45_0_0EXFaceDetector *faceDetector;
@property NSInteger timeIntervalMillis;

@end

@implementation ABI45_0_0EXFaceDetectorManager

- (instancetype)init
{
  return [self initWithOptions:[ABI45_0_0EXFaceDetectorUtils defaultFaceDetectorOptions]];
}
...
- (instancetype)initWithOptions:(NSDictionary*)options
{
  if (self = [super init]) {
    ...
    _faceDetectorOptions = [ABI45_0_0EXFaceDetectorUtils mapOptions:options];
...
{
  MLKFaceDetectorOptions* newOptions = [ABI45_0_0EXFaceDetectorUtils newOptions:self.faceDetectorOptions withValues:settings];
  if(![ABI45_0_0EXFaceDetectorUtils areOptionsEqual:newOptions to:self.faceDetectorOptions])
  {
...
- (void)tryEnablingFaceDetection
{
  ...
  if ([self isDetectingFaceEnabled]) {
    @try {
      self.faceDetector = [[ABI45_0_0EXFaceDetector alloc] initWithOptions:_faceDetectorOptions];
      ...
      if([_session canAddOutput:output]) {
        ...
        ABI45_0_0EXLogError(@"Unable to add output to camera session! Face detection aborted!");
      }
    } @catch (NSException *exception) {
      ABI45_0_0EXLogWarn(@"%@", [exception description]);
    }
  }
...
- (void)_notifyOfFaces:(NSArray<MLKFace *> *)faces
           withEncoder:(ABI45_0_0EXFaceEncoder*)encoder
{
       ...
       fromConnection:(AVCaptureConnection *)connection
{
  ...
  if (timePassedMillis > self.timeIntervalMillis) {
    ...
    ABI45_0_0EXFaceDetectionAngleTransformBlock angleTransform = ^(float angle) { return -angle; };

    CGAffineTransform transformation = [ABI45_0_0EXCSBufferOrientationCalculator pointTransformForInterfaceOrientation:_interfaceOrientation
    ...
    UIImageOrientation orientation = [ABI45_0_0EXFaceDetectorManager imageOrientationFrom:_interfaceOrientation
                                                                     andMirrored:_mirroredImageSession];
    ...
    [_faceDetector detectFromBuffer:sampleBuffer
      ...
      if (error != nil) {
        ...
        [self _notifyOfFaces:faces
                 withEncoder:[[ABI45_0_0EXFaceEncoder alloc] initWithTransform:transformation
