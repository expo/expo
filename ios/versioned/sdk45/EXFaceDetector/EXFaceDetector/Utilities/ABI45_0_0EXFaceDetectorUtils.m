//
//  ABI45_0_0EXFaceDetectorUtils.m
//  Exponent
//
...
NSString *const ABI45_0_0EXGMVDataOutputWidthKey = @"Width";
NSString *const ABI45_0_0EXGMVDataOutputHeightKey = @"Height";
...
@implementation ABI45_0_0EXFaceDetectorUtils
...
+ (ABI45_0_0EXFaceDetectionAngleTransformBlock)angleTransformerFromTransform:(CGAffineTransform)transform
{
  return ^(float angle) {
