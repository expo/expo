...
@interface ABI45_0_0EXFaceDetectorModule ()

@property (nonatomic, weak) ABI45_0_0EXModuleRegistry *moduleRegistry;

@end

@implementation ABI45_0_0EXFaceDetectorModule
...
ABI45_0_0EX_EXPORT_MODULE(ExpoFaceDetector);

- (NSDictionary *)constantsToExport
{
  return [ABI45_0_0EXFaceDetectorUtils constantsToExport];
}
...
ABI45_0_0EX_EXPORT_METHOD_AS(detectFaces, detectFaces:(nonnull NSDictionary *)options resolver:(ABI45_0_0EXPromiseResolveBlock)resolve rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([fileSystem permissionsForURI:url] & ABI45_0_0EXFileSystemPermissionRead)) {
  ...
  @try {
    ...
    ciImage = [ciImage imageByApplyingOrientation:[ABI45_0_0EXFaceDetectorUtils toCGImageOrientation:image.imageOrientation]];
    ...
    ABI45_0_0EXFaceDetector* detector = [[ABI45_0_0EXFaceDetector alloc] initWithOptions: [ABI45_0_0EXFaceDetectorUtils mapOptions:options]];
    [detector detectFromImage:finalImage completionListener:^(NSArray<MLKFace *> * _Nullable faces, NSError * _Nullable error) {
      ...
      if(faces.count > 0) {
        ABI45_0_0EXFaceEncoder *encoder = [[ABI45_0_0EXFaceEncoder alloc] init];
      ...
      if (error != nil) {
        ...
        resolve(@{
                  ...
                  @"image" : @{
                      ...
                      @"orientation" : @([ABI45_0_0EXFaceDetectorModule exifOrientationFor:image.imageOrientation])
                      }
                  });
      }}];
