...
#import <ABI45_0_0EXVideoThumbnails/ABI45_0_0EXVideoThumbnailsModule.h>
...
@implementation ABI45_0_0EXVideoThumbnailsModule

ABI45_0_0EX_EXPORT_MODULE(ExpoVideoThumbnails);
...
ABI45_0_0EX_EXPORT_METHOD_AS(getThumbnail,
                    ...
                    reject:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  ...
  if ([url isFileURL]) {
    ...
    if (!([_fileSystem permissionsForURI:url] & ABI45_0_0EXFileSystemPermissionRead)) {
