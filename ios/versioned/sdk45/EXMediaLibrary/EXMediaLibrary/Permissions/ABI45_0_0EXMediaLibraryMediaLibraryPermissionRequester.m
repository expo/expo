...
#import <ABI45_0_0EXMediaLibrary/ABI45_0_0EXMediaLibraryMediaLibraryPermissionRequester.h>

@implementation ABI45_0_0EXMediaLibraryMediaLibraryPermissionRequester
...
- (NSDictionary *)getPermissions
{
  ...
  return @{
    ...
    @"granted": @(status == ABI45_0_0EXPermissionStatusGranted)
  };
}
