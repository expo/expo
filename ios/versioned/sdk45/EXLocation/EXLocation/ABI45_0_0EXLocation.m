...
#import <ABI45_0_0EXLocation/ABI45_0_0EXLocation.h>
#import <ABI45_0_0EXLocation/ABI45_0_0EXLocationDelegate.h>
#import <ABI45_0_0EXLocation/ABI45_0_0EXLocationTaskConsumer.h>
#import <ABI45_0_0EXLocation/ABI45_0_0EXGeofencingTaskConsumer.h>
...
NSString * const ABI45_0_0EXLocationChangedEventName = @"Expo.locationChanged";
NSString * const ABI45_0_0EXHeadingChangedEventName = @"Expo.headingChanged";

@interface ABI45_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI45_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) NSMutableSet<ABI45_0_0EXLocationDelegate *> *retainedDelegates;
...
@property (nonatomic, weak) id<ABI45_0_0EXTaskManagerInterface> tasksManager;

@end

@implementation ABI45_0_0EXLocation

ABI45_0_0EX_EXPORT_MODULE(ExpoLocation);
...
- (void)setModuleRegistry:(ABI45_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  _tasksManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI45_0_0EXTaskManagerInterface)];

  _permissionsManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI45_0_0EXPermissionsInterface)];
  [ABI45_0_0EXPermissionsMethodsDelegate registerRequesters:@[
    [ABI45_0_0EXLocationPermissionRequester new],
    [ABI45_0_0EXForegroundPermissionRequester new],
    [ABI45_0_0EXBackgroundLocationPermissionRequester new]
...
{
  return @[ABI45_0_0EXLocationChangedEventName, ABI45_0_0EXHeadingChangedEventName];
}
...
ABI45_0_0EX_EXPORT_METHOD_AS(getProviderStatusAsync,
...
ABI45_0_0EX_EXPORT_METHOD_AS(getCurrentPositionAsync,
                    ...
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  ...
  __block ABI45_0_0EXLocationDelegate *delegate;

  delegate = [[ABI45_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (delegate != nil) {
      if (locations.lastObject != nil) {
        resolve([ABI45_0_0EXLocation exportLocation:locations.lastObject]);
      } else {
...
ABI45_0_0EX_EXPORT_METHOD_AS(watchPositionImplAsync,
                    ...
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  ...
  ABI45_0_0EXLocationDelegate *delegate = [[ABI45_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject != nil && weakSelf != nil) {
      ...
      NSDictionary *body = @{
                             @"watchId": watchId,
                             @"location": [ABI45_0_0EXLocation exportLocation:loc],
                             };

      [strongSelf->_eventEmitter sendEventWithName:ABI45_0_0EXLocationChangedEventName body:body];
    }
  } onUpdateHeadings:nil onError:^(NSError *error) {
    // TODO: report errors
...
ABI45_0_0EX_EXPORT_METHOD_AS(getLastKnownPositionAsync,
                    ...
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  ...
  if ([self.class isLocation:location validWithOptions:options]) {
    resolve([ABI45_0_0EXLocation exportLocation:location]);
  } else {
    resolve([NSNull null]);
  }
}
...
ABI45_0_0EX_EXPORT_METHOD_AS(watchDeviceHeading,
  ...
  ABI45_0_0EXLocationDelegate *delegate = [[ABI45_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
    if (newHeading != nil && weakSelf != nil) {
      ...
      [strongSelf->_eventEmitter sendEventWithName:ABI45_0_0EXHeadingChangedEventName body:body];
    }
...
ABI45_0_0EX_EXPORT_METHOD_AS(removeWatchAsync,
                    watchId:(nonnull NSNumber *)watchId
                    resolver:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  ABI45_0_0EXLocationDelegate *delegate = _delegates[watchId];
...
ABI45_0_0EX_EXPORT_METHOD_AS(geocodeAsync,
...
ABI45_0_0EX_EXPORT_METHOD_AS(reverseGeocodeAsync,
    ...
    if (!error) {
      ...
      for (CLPlacemark* placemark in placemarks) {
        NSDictionary *address = @{
                                  @"city": ABI45_0_0UMNullIfNil(placemark.locality),
                                  @"district": ABI45_0_0UMNullIfNil(placemark.subLocality),
                                  @"streetNumber": ABI45_0_0UMNullIfNil(placemark.subThoroughfare),
                                  @"street": ABI45_0_0EXNullIfNil(placemark.thoroughfare),
                                  @"region": ABI45_0_0EXNullIfNil(placemark.administrativeArea),
                                  @"subregion": ABI45_0_0EXNullIfNil(placemark.subAdministrativeArea),
                                  @"country": ABI45_0_0EXNullIfNil(placemark.country),
                                  @"postalCode": ABI45_0_0EXNullIfNil(placemark.postalCode),
                                  @"name": ABI45_0_0EXNullIfNil(placemark.name),
                                  @"isoCountryCode": ABI45_0_0EXNullIfNil(placemark.ISOcountryCode),
                                  @"timezone": ABI45_0_0EXNullIfNil(placemark.timeZone.name),
                                  };
                    ...
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  [ABI45_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI45_0_0EXLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
...
ABI45_0_0EX_EXPORT_METHOD_AS(getForegroundPermissionsAsync,
                    getForegroundPermissionsAsync:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  [ABI45_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI45_0_0EXForegroundPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI45_0_0EX_EXPORT_METHOD_AS(requestForegroundPermissionsAsync,
                    requestForegroundPermissionsAsync:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  [ABI45_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI45_0_0EXForegroundPermissionRequester class]
...
ABI45_0_0EX_EXPORT_METHOD_AS(getBackgroundPermissionsAsync,
                    getBackgroundPermissionsAsync:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  [ABI45_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI45_0_0EXBackgroundLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI45_0_0EX_EXPORT_METHOD_AS(requestBackgroundPermissionsAsync,
                    requestBackgroundPermissionsAsync:(ABI45_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  [ABI45_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI45_0_0EXBackgroundLocationPermissionRequester class]
...
ABI45_0_0EX_EXPORT_METHOD_AS(hasServicesEnabledAsync,
                    hasServicesEnabled:(ABI45_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI45_0_0EXPromiseRejectBlock)reject)
{
...
ABI45_0_0EX_EXPORT_METHOD_AS(startLocationUpdatesAsync,
                    ...
                    reject:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI45_0_0EXLocationTaskConsumer class] options:options];
  }
  @catch (NSException *e) {
...
ABI45_0_0EX_EXPORT_METHOD_AS(stopLocationUpdatesAsync,
                    ...
                    reject:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI45_0_0EXLocationTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI45_0_0EX_EXPORT_METHOD_AS(hasStartedLocationUpdatesAsync,
                    ...
                    reject:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI45_0_0EXLocationTaskConsumer class]]));
}

# pragma mark - Geofencing

ABI45_0_0EX_EXPORT_METHOD_AS(startGeofencingAsync,
                    ...
                    reject:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI45_0_0EXGeofencingTaskConsumer class] options:options];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI45_0_0EX_EXPORT_METHOD_AS(stopGeofencingAsync,
                    ...
                    reject:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI45_0_0EXGeofencingTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI45_0_0EX_EXPORT_METHOD_AS(hasStartedGeofencingAsync,
                    ...
                    reject:(ABI45_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI45_0_0EXGeofencingTaskConsumer class]]));
}
...
- (CLLocationManager *)locationManagerWithOptions:(nullable NSDictionary *)options
{
  ...
  if (options) {
    ...
    if (options[@"accuracy"]) {
      ABI45_0_0EXLocationAccuracy accuracy = [options[@"accuracy"] unsignedIntegerValue] ?: ABI45_0_0EXLocationAccuracyBalanced;
...
- (BOOL)checkForegroundPermissions:(ABI45_0_0EXPromiseRejectBlock)reject
{
  if (![CLLocationManager locationServicesEnabled]) {
    reject(@"E_LOCATION_SERVICES_DISABLED", @"Location services are disabled", nil);
    return NO;
  }
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI45_0_0EXForegroundPermissionRequester class]]) {
...
- (BOOL)checkBackgroundPermissions:(ABI45_0_0EXPromiseRejectBlock)reject
{
  if (![CLLocationManager locationServicesEnabled]) {
    reject(@"E_LOCATION_SERVICES_DISABLED", @"Location services are disabled", nil);
    return NO;
  }
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI45_0_0EXBackgroundLocationPermissionRequester class]]) {
...
- (BOOL)checkTaskManagerExists:(ABI45_0_0EXPromiseRejectBlock)reject
{
...
- (BOOL)checkBackgroundServices:(ABI45_0_0EXPromiseRejectBlock)reject
{
...
{
  switch (accuracy) {
    case ABI45_0_0EXLocationAccuracyLowest:
      return kCLLocationAccuracyThreeKilometers;
    case ABI45_0_0EXLocationAccuracyLow:
      return kCLLocationAccuracyKilometer;
    case ABI45_0_0EXLocationAccuracyBalanced:
      return kCLLocationAccuracyHundredMeters;
    case ABI45_0_0EXLocationAccuracyHigh:
      return kCLLocationAccuracyNearestTenMeters;
    case ABI45_0_0EXLocationAccuracyHighest:
      return kCLLocationAccuracyBest;
    case ABI45_0_0EXLocationAccuracyBestForNavigation:
