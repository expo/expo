...
#import <ABI45_0_0EXLocation/ABI45_0_0EXLocationPermissionRequester.h>
...
@implementation ABI45_0_0EXLocationPermissionRequester
...
- (void)requestLocationPermissions
{
  ...
  } else if ([ABI45_0_0EXBaseLocationRequester isConfiguredForWhenInUseAuthorization] && [self.locationManager respondsToSelector:whenInUseAuthorizationSelector]) {
