...
#import <ABI45_0_0EXAV/CallbackWrapper.h>

namespace jsi = ABI45_0_0facebook::jsi;
using CallInvoker = ABI45_0_0facebook::ABI45_0_0React::CallInvoker;

// TODO: Replace this with just ABI45_0_0facebook::react namespace after we upgrade to RN 0.66
using JsiCallbackWrapper = ABI45_0_0expo::CallbackWrapper;
using LongLivedObjectCollection = ABI45_0_0expo::LongLivedObjectCollection;
