...
typedef NS_OPTIONS(NSUInteger, ABI45_0_0EXAudioInterruptionMode)
{
  ABI45_0_0EXAudioInterruptionModeMixWithOthers = 0,
  ABI45_0_0EXAudioInterruptionModeDoNotMix      = 1,
  ABI45_0_0EXAudioInterruptionModeDuckOthers    = 2
};

typedef NS_OPTIONS(NSUInteger, ABI45_0_0EXAudioRecordingOptionBitRateStrategy)
{
  ABI45_0_0EXAudioRecordingOptionBitRateStrategyConstant            = 0,
  ABI45_0_0EXAudioRecordingOptionBitRateStrategyLongTermAverage     = 1,
  ABI45_0_0EXAudioRecordingOptionBitRateStrategyVariableConstrained = 2,
  ABI45_0_0EXAudioRecordingOptionBitRateStrategyVariable            = 3
};

@protocol ABI45_0_0EXAVScopedModuleDelegate
...
@protocol ABI45_0_0EXAVInterface

- (NSError *)promoteAudioSessionIfNecessary;

- (NSError *)demoteAudioSessionIfPossible;

- (void)registerVideoForAudioLifecycle:(NSObject<ABI45_0_0EXAVObject> *)video;

- (void)unregisterVideoForAudioLifecycle:(NSObject<ABI45_0_0EXAVObject> *)video;

@end

@interface ABI45_0_0EXAV : ABI45_0_0EXExportedModule <ABI45_0_0RCTBridgeModule, ABI45_0_0EXEventEmitter, ABI45_0_0EXAppLifecycleListener, ABI45_0_0EXModuleRegistryConsumer, ABI45_0_0EXAVInterface>
