...
@implementation ABI45_0_0EXAdsGAMBannerView {
  GAMBannerView *_bannerView;
  id<ABI45_0_0EXEventEmitterService> _eventEmitter;
}
...
- (void)setOnSizeChange:(ABI45_0_0EXDirectEventBlock)block
{
  _onSizeChange = block;
  [self loadBanner];
}

- (void)setOnDidFailToReceiveAdWithError:(ABI45_0_0EXDirectEventBlock)block
{
