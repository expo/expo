...
public class CameraPermissionRequester: NSObject, ABI45_0_0EXPermissionsRequester {
  static public func permissionType() -> String {
    return "camera"
  }

  public func requestPermissions(resolver resolve: @escaping ABI45_0_0EXPromiseResolveBlock, rejecter reject: ABI45_0_0EXPromiseRejectBlock) {
  ...
  public func getPermissions() -> [AnyHashable: Any] {
    ...
    var status: ABI45_0_0EXPermissionStatus
    ...
    if cameraUsageDescription == nil || microphoneUsageDescription == nil {
      ABI45_0_0EXFatal(ABI45_0_0EXErrorWithMessage("""
...
public class MediaLibraryPermissionRequester: DefaultMediaLibraryPermissionRequester,
                                              ABI45_0_0EXPermissionsRequester {
...
/**
 * This extension is adding default implmentation for ABI45_0_0EXPermissionsRequester that can be shared by many classe.
 ...
 * to this extension. I'm using as a mixin that implements major part of ABI45_0_0EXPermissionsRequester protocol.
 */
