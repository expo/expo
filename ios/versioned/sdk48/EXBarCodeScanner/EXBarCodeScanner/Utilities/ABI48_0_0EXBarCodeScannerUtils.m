...
@implementation ABI48_0_0EXBarCodeScannerUtils
...
+ (NSDictionary *)ciQRCodeFeatureToDicitionary:(CIQRCodeFeature *)barCodeScannerResult barCodeType:(NSString *)type
{
  ...
  if (!CGRectIsEmpty(barCodeScannerResult.bounds)) {
    ...
    [ABI48_0_0EXBarCodeScannerUtils addEmptyCornerPoints:result];
  }
...
{
  NSMutableDictionary *result = [NSMutableDictionary new];
  result[@"type"] = [ABI48_0_0EXBarCodeScannerUtils zxingFormatToString:barCodeScannerResult.barcodeFormat];
