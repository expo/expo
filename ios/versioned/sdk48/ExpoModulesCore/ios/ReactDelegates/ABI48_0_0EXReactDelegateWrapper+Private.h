...
/**
 Internal `ABI48_0_0EXReactDelegateWrapper` interface for the designated initializer with `ExpoReactDelegate`.
 ...
 */
@interface ABI48_0_0EXReactDelegateWrapper(Private)
