...
@implementation ABI48_0_0EXLegacyAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitializedAndSorted {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI48_0_0EXSingletonModule*> * singletonModules = [[ABI48_0_0EXModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI48_0_0EXSingletonModule *singletonModule in singletonModules) {
