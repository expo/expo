...
// Interface for ABI48_0_0EXTaskManager module.

@protocol ABI48_0_0EXTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI48_0_0EXTaskConsumerInterface protocol.
 */
