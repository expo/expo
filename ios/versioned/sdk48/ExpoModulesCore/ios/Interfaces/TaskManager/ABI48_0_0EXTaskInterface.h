...
@protocol ABI48_0_0EXTaskConsumerInterface;

@protocol ABI48_0_0EXTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI48_0_0EXTaskConsumerInterface> __nonnull consumer;
