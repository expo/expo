...
@implementation ABI48_0_0EXJavaScriptWeakObject {
  /**
                         ...
                         runtime:(nonnull ABI48_0_0EXJavaScriptRuntime *)runtime
{
  if (self = [super init]) {
    ...
    if (ABI48_0_0expo::isWeakRefSupported(*[runtime get])) {
      _jsObject = ABI48_0_0expo::createWeakRef(*[runtime get], jsObject);
    } else {
      _jsObject = jsObject;
    }
  }
...
- (nullable ABI48_0_0EXJavaScriptObject *)lock
{
  jsi::Runtime *runtime = [_runtime get];
  std::shared_ptr<jsi::Object> objectPtr = ABI48_0_0expo::isWeakRefSupported(*runtime)
    ? ABI48_0_0expo::derefWeakRef(*runtime, _jsObject)
    : _jsObject;

  if (!objectPtr) {
    return nil;
  }
  return [[ABI48_0_0EXJavaScriptObject alloc] initWith:objectPtr runtime:_runtime];
}
