...
@implementation ABI48_0_0EXJavaScriptValue {
...
- (BOOL)isTypedArray
{
  if (_value->isObject()) {
    jsi::Runtime *runtime = [_runtime get];
    return ABI48_0_0expo::isTypedArray(*runtime, _value->getObject(*runtime));
  }
  return false;
}
...
- (nullable id)getRaw
{
  return ABI48_0_0expo::convertJSIValueToObjCObject(*[_runtime get], *_value, [_runtime callInvoker]);
}
...
{
  jsi::Runtime *runtime = [_runtime get];
  return ABI48_0_0expo::convertJSIStringToNSString(*runtime, _value->getString(*runtime));
}
...
- (nonnull NSArray<ABI48_0_0EXJavaScriptValue *> *)getArray
{
  ...
  for (size_t i = 0; i < arraySize; i++) {
    ...
    if (item.isUndefined() || item.isNull()) {
      ...
      [result addObject:[[ABI48_0_0EXJavaScriptValue alloc] initWithRuntime:_runtime value:valuePtr]];
    }
  }
  return result;
}
...
{
  jsi::Runtime *runtime = [_runtime get];
  return ABI48_0_0expo::convertJSIObjectToNSDictionary(*runtime, _value->getObject(*runtime), [_runtime callInvoker]);
}
...
- (nullable ABI48_0_0EXJavaScriptTypedArray *)getTypedArray
{
  ...
  jsi::Runtime *runtime = [_runtime get];
  std::shared_ptr<jsi::Object> objectPtr = std::make_shared<jsi::Object>(_value->asObject(*runtime));
  return [[ABI48_0_0EXJavaScriptTypedArray alloc] initWith:objectPtr runtime:_runtime];
}
...
{
  jsi::Runtime *runtime = [_runtime get];
  return ABI48_0_0expo::convertJSIStringToNSString(*runtime, _value->toString(*runtime));
}
