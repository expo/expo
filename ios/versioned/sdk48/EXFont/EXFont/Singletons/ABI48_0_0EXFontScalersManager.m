...
@implementation UIFont (ABI48_0_0EXFontLoader)

- (UIFont *)ABI48_0_0EXFontWithSize:(CGFloat)fontSize
{
  for (id<ABI48_0_0EXFontScalerInterface> fontScaler in currentFontScalers) {
  ...
  return [self ABI48_0_0EXFontWithSize:fontSize];
}
...
@implementation ABI48_0_0EXFontScalersManager

ABI48_0_0EX_REGISTER_SINGLETON_MODULE(FontScalersManager);
...
+ (void)initialize
{
  ...
  dispatch_once(&initializeCurrentFontScalersOnce, ^{
    ...
    SEL exUpdate = @selector(ABI48_0_0EXFontWithSize:);
...
- (void)registerFontScaler:(id<ABI48_0_0EXFontScalerInterface>)fontScaler
{
