...
@protocol ABI48_0_0EXOrientationListener <NSObject>

- (void)screenOrientationDidChange:(UIInterfaceOrientation)orientation;

@end

@protocol ABI48_0_0EXScreenOrientationEventEmitter <NSObject>
...
@protocol ABI48_0_0EXScreenOrientationRegistry <NSObject>
...
@interface ABI48_0_0EXScreenOrientationRegistry : ABI48_0_0EXSingletonModule <UIApplicationDelegate, ABI48_0_0EXScreenOrientationEventEmitter, ABI48_0_0EXScreenOrientationRegistry>
