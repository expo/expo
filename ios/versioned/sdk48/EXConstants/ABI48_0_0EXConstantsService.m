...
NSString * const ABI48_0_0EXConstantsExecutionEnvironmentBare = @"bare";
NSString * const ABI48_0_0EXConstantsExecutionEnvironmentStandalone = @"standalone";
NSString * const ABI48_0_0EXConstantsExecutionEnvironmentStoreClient = @"storeClient";

@interface ABI48_0_0EXConstantsService ()

@property (nonatomic, strong) NSString *sessionId;
@property (nonatomic, strong) ABI48_0_0EXConstantsInstallationIdProvider *installationIdProvider;

@end

@implementation ABI48_0_0EXConstantsService

- (instancetype)init
{
  return [self initWithInstallationIdProvider:[[ABI48_0_0EXConstantsInstallationIdProvider alloc] init]];
}

- (instancetype)initWithInstallationIdProvider:(ABI48_0_0EXConstantsInstallationIdProvider *)installationIdProvider
{
  if (self = [super init]) {
...
{
  return @[@protocol(ABI48_0_0EXConstantsInterface)];
}
...
- (NSDictionary *)constants
{
  ...
  return @{
           ...
           @"executionEnvironment": ABI48_0_0EXConstantsExecutionEnvironmentBare,
           ...
           @"manifest": ABI48_0_0EXNullIfNil([[self class] appConfig]),
           @"platform": @{
               @"ios": @{
                   @"buildNumber": [self buildVersion],
                   @"platform": [[self class] devicePlatform],
                   @"model": ABI48_0_0EXNullIfNil([[self class] deviceModel]),
...
{
  NSBundle *frameworkBundle = [NSBundle bundleForClass:[ABI48_0_0EXConstantsService class]];
  NSURL *bundleUrl = [frameworkBundle.resourceURL URLByAppendingPathComponent:@"ABI48_0_0EXConstants.bundle"];
