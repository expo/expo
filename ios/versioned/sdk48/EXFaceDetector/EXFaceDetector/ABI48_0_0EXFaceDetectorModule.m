...
@interface ABI48_0_0EXFaceDetectorModule ()

@property (nonatomic, weak) ABI48_0_0EXModuleRegistry *moduleRegistry;

@end

@implementation ABI48_0_0EXFaceDetectorModule
...
ABI48_0_0EX_EXPORT_MODULE(ExpoFaceDetector);

- (NSDictionary *)constantsToExport
{
  return [ABI48_0_0EXFaceDetectorUtils constantsToExport];
}
...
ABI48_0_0EX_EXPORT_METHOD_AS(detectFaces, detectFaces:(nonnull NSDictionary *)options resolver:(ABI48_0_0EXPromiseResolveBlock)resolve rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([fileSystem permissionsForURI:url] & ABI48_0_0EXFileSystemPermissionRead)) {
  ...
  @try {
    ...
    ciImage = [ciImage imageByApplyingOrientation:[ABI48_0_0EXFaceDetectorUtils toCGImageOrientation:image.imageOrientation]];
    ...
    ABI48_0_0EXFaceDetector* detector = [[ABI48_0_0EXFaceDetector alloc] initWithOptions: [ABI48_0_0EXFaceDetectorUtils mapOptions:options]];
    [detector detectFromImage:finalImage completionListener:^(NSArray<MLKFace *> * _Nullable faces, NSError * _Nullable error) {
      ...
      if(faces.count > 0) {
        ABI48_0_0EXFaceEncoder *encoder = [[ABI48_0_0EXFaceEncoder alloc] init];
      ...
      if (error != nil) {
        ...
        resolve(@{
                  ...
                  @"image" : @{
                      ...
                      @"orientation" : @([ABI48_0_0EXFaceDetectorModule exifOrientationFor:image.imageOrientation])
                      }
                  });
      }}];
