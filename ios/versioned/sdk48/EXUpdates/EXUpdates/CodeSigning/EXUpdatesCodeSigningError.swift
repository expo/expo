...
@objc public enum ABI48_0_0EXUpdatesCodeSigningError : Int, Error {
...
@objc public class ABI48_0_0EXUpdatesCodeSigningErrorUtils : NSObject {
  @objc public static func message(forError: ABI48_0_0EXUpdatesCodeSigningError) -> String {
    switch forError {
    case .CertificateEncodingError:
