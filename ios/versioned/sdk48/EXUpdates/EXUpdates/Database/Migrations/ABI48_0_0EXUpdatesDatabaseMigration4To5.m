...
static NSString * const ABI48_0_0EXUpdatesDatabaseV4Filename = @"expo-v4.db";

@implementation ABI48_0_0EXUpdatesDatabaseMigration4To5

- (NSString *)filename
{
  return ABI48_0_0EXUpdatesDatabaseV4Filename;
}
