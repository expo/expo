...
static NSString * const ABI48_0_0EXUpdatesDatabaseV5Filename = @"expo-v5.db";

@implementation ABI48_0_0EXUpdatesDatabaseMigration5To6

- (NSString *)filename
{
  return ABI48_0_0EXUpdatesDatabaseV5Filename;
}
...
{
  NSError *error;
  NSArray<NSDictionary *> *rows = [ABI48_0_0EXUpdatesDatabaseUtils executeSql:sql withArgs:args onDatabase:db error:&error];
  if (!rows || error) {
    sqlite3_exec(db, "ROLLBACK;", NULL, NULL, NULL);
    return NO;
  }
