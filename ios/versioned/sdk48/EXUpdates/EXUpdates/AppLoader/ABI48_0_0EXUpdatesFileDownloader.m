...
#import <ABI48_0_0EXUpdates/ABI48_0_0EXUpdatesMultipartStreamReader.h>
#import <ABI48_0_0EXUpdates/ABI48_0_0EXUpdatesParameterParser.h>
...
NSTimeInterval const ABI48_0_0EXUpdatesDefaultTimeoutInterval = 60;

NSString * const ABI48_0_0EXUpdatesMultipartManifestPartName = @"manifest";
NSString * const ABI48_0_0EXUpdatesMultipartExtensionsPartName = @"extensions";
NSString * const ABI48_0_0EXUpdatesMultipartCertificateChainPartName = @"certificate_chain";

NSString * const ABI48_0_0EXUpdatesFileDownloaderErrorDomain = @"ABI48_0_0EXUpdatesFileDownloader";
const NSInteger ABI48_0_0EXUpdatesFileDownloaderErrorCodeFileWriteError = 1002;
const NSInteger ABI48_0_0EXUpdatesFileDownloaderErrorCodeManifestVerificationError = 1003;
const NSInteger ABI48_0_0EXUpdatesFileDownloaderErrorCodeFileHashMismatchError = 1004;
const NSInteger ABI48_0_0EXUpdatesFileDownloaderErrorCodeNoCompatibleUpdateError = 1009;
const NSInteger ABI48_0_0EXUpdatesFileDownloaderErrorCodeMismatchedManifestFiltersError = 1021;
const NSInteger ABI48_0_0EXUpdatesFileDownloaderErrorCodeManifestParseError = 1022;
const NSInteger ABI48_0_0EXUpdatesFileDownloaderErrorCodeInvalidResponseError = 1040;
const NSInteger ABI48_0_0EXUpdatesFileDownloaderErrorCodeManifestStringError = 1041;
const NSInteger ABI48_0_0EXUpdatesFileDownloaderErrorCodeManifestJSONError = 1042;
const NSInteger ABI48_0_0EXUpdatesFileDownloaderErrorCodeManifestSignatureError = 1043;
const NSInteger ABI48_0_0EXUpdatesFileDownloaderErrorCodeMultipartParsingError = 1044;
const NSInteger ABI48_0_0EXUpdatesFileDownloaderErrorCodeMultipartMissingManifestError = 1045;
const NSInteger ABI48_0_0EXUpdatesFileDownloaderErrorCodeMissingMultipartBoundaryError = 1047;
const NSInteger ABI48_0_0EXUpdatesFileDownloaderErrorCodeCodeSigningSignatureError = 1048;

@interface ABI48_0_0EXUpdatesFileDownloader () <NSURLSessionDataDelegate>
 ...
 */
@implementation ABI48_0_0EXUpdatesFileDownloader
                 ...
                 errorBlock:(ABI48_0_0EXUpdatesFileDownloaderErrorBlock)errorBlock
{
  [self downloadDataFromURL:url extraHeaders:extraHeaders successBlock:^(NSData *data, NSURLResponse *response) {
    NSString *hashBase64String = [ABI48_0_0EXUpdatesUtils base64UrlEncodedSHA256WithData:data];
    if (expectedBase64URLEncodedSHA256Hash && ![expectedBase64URLEncodedSHA256Hash isEqualToString:hashBase64String]) {
      ...
      [self->_logger error:errorMessage code:ABI48_0_0EXUpdatesErrorCodeAssetsFailedToLoad updateId:nil assetId:expectedBase64URLEncodedSHA256Hash];
      errorBlock([NSError errorWithDomain:ABI48_0_0EXUpdatesFileDownloaderErrorDomain
                                     code:ABI48_0_0EXUpdatesFileDownloaderErrorCodeFileHashMismatchError
                                 userInfo:@{
    ...
    if ([data writeToFile:destinationPath options:NSDataWritingAtomic error:&error]) {
      ...
      [self->_logger error:errorMessage code:ABI48_0_0EXUpdatesErrorCodeAssetsFailedToLoad updateId:nil assetId:expectedBase64URLEncodedSHA256Hash];
      errorBlock([NSError errorWithDomain:ABI48_0_0EXUpdatesFileDownloaderErrorDomain
                                     code:ABI48_0_0EXUpdatesFileDownloaderErrorCodeFileWriteError
                                 userInfo:@{
                                   NSLocalizedDescriptionKey: errorMessage,
...
- (NSURLRequest *)createManifestRequestWithURL:(NSURL *)url extraHeaders:(nullable NSDictionary *)extraHeaders
{
  ...
  NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url cachePolicy:cachePolicy timeoutInterval:ABI48_0_0EXUpdatesDefaultTimeoutInterval];
...
- (void)parseManifestResponse:(NSHTTPURLResponse *)httpResponse
  ...
  if ([[contentType lowercaseString] hasPrefix:@"multipart/"]) {
    NSDictionary<NSString *, NSString *> *contentTypeParameters = [[ABI48_0_0EXUpdatesParameterParser new] parseParameterString:contentType withDelimiter:';'];
    ...
    if (boundaryParameterValue == nil) {
      ...
      [self->_logger error:errorMessage code:ABI48_0_0EXUpdatesErrorCodeAssetsFailedToLoad];
      NSError *error = [NSError errorWithDomain:ABI48_0_0EXUpdatesFileDownloaderErrorDomain
                                           code:ABI48_0_0EXUpdatesFileDownloaderErrorCodeMissingMultipartBoundaryError
                                       userInfo:@{
        NSLocalizedDescriptionKey: errorMessage,
      }];
      errorBlock(error);
    ...
    ABI48_0_0EXUpdatesManifestHeaders *manifestHeaders = [[ABI48_0_0EXUpdatesManifestHeaders alloc] initWithProtocolVersion:responseHeaders[@"expo-protocol-version"]
...
- (void)parseMultipartManifestResponse:(NSHTTPURLResponse *)httpResponse
  ...
  ABI48_0_0EXUpdatesMultipartStreamReader *reader = [[ABI48_0_0EXUpdatesMultipartStreamReader alloc] initWithInputStream:inputStream boundary:boundary];
  ...
  BOOL completed = [reader readAllPartsWithCompletionCallback:^(NSDictionary *headers, NSData *content, BOOL done) {
    ...
    if (contentDisposition != nil) {
      NSDictionary<NSString *, NSString *> *contentDispositionParameters = [[ABI48_0_0EXUpdatesParameterParser new] parseParameterString:contentDisposition withDelimiter:';'];
      NSString *contentDispositionNameFieldValue = contentDispositionParameters[@"name"];
      if (contentDispositionNameFieldValue != nil) {
        if ([contentDispositionNameFieldValue isEqualToString:ABI48_0_0EXUpdatesMultipartManifestPartName]) {
          manifestPartHeaders = headers;
          manifestPartData = content;
        } else if ([contentDispositionNameFieldValue isEqualToString:ABI48_0_0EXUpdatesMultipartExtensionsPartName]) {
          extensionsData = content;
        } else if ([contentDispositionNameFieldValue isEqualToString:ABI48_0_0EXUpdatesMultipartCertificateChainPartName]) {
  ...
  if (!completed) {
    NSError *error = [NSError errorWithDomain:ABI48_0_0EXUpdatesFileDownloaderErrorDomain
                                         code:ABI48_0_0EXUpdatesFileDownloaderErrorCodeMultipartParsingError
                                     userInfo:@{
      NSLocalizedDescriptionKey: @"Could not read multipart manifest response",
    }];
    [self->_logger error:error.localizedDescription code:ABI48_0_0EXUpdatesErrorCodeAssetsFailedToLoad];
    errorBlock(error);
    return;
  }
  ...
  if (manifestPartHeaders == nil || manifestPartData == nil) {
    NSError *error = [NSError errorWithDomain:ABI48_0_0EXUpdatesFileDownloaderErrorDomain
                                         code:ABI48_0_0EXUpdatesFileDownloaderErrorCodeMultipartMissingManifestError
                                     userInfo:@{
      NSLocalizedDescriptionKey: @"Multipart manifest response missing manifest part",
    }];
    [self->_logger error:error.userInfo[NSLocalizedDescriptionKey] code:ABI48_0_0EXUpdatesErrorCodeAssetsFailedToLoad];
    errorBlock(error);
    return;
  }
...
certificateChainFromManifestResponse:(nullable NSString *)certificateChainFromManifestResponse
  ...
  if (![manifestString isKindOfClass:[NSString class]]) {
    ...
    [self->_logger error:errorMessage code:ABI48_0_0EXUpdatesErrorCodeUpdateHasInvalidSignature];
    errorBlock([NSError errorWithDomain:ABI48_0_0EXUpdatesFileDownloaderErrorDomain
                                   code:ABI48_0_0EXUpdatesFileDownloaderErrorCodeManifestStringError
                               userInfo:@{
                                 NSLocalizedDescriptionKey: errorMessage,
                               }
                ]);
  ...
  if (error || !manifest || ![manifest isKindOfClass:[NSDictionary class]]) {
    ...
    [self->_logger error:errorMessage code:ABI48_0_0EXUpdatesErrorCodeUpdateHasInvalidSignature];
    errorBlock([NSError errorWithDomain:ABI48_0_0EXUpdatesFileDownloaderErrorDomain
                                   code:ABI48_0_0EXUpdatesFileDownloaderErrorCodeManifestJSONError
                               userInfo:@{
                                 NSLocalizedDescriptionKey: errorMessage,
                               }
                ]);
  ...
  if (signature != nil && !isUnsignedFromXDL) {
    if (![signature isKindOfClass:[NSString class]]) {
      ...
      [self->_logger error:errorMessage code:ABI48_0_0EXUpdatesErrorCodeUpdateHasInvalidSignature];
      errorBlock([NSError errorWithDomain:ABI48_0_0EXUpdatesFileDownloaderErrorDomain
                                     code:ABI48_0_0EXUpdatesFileDownloaderErrorCodeManifestSignatureError
                                 userInfo:@{
                                   NSLocalizedDescriptionKey: errorMessage,
                                 }
                  ]);
    ...
    [ABI48_0_0EXUpdatesCrypto verifySignatureWithData:(NSString *)manifestString
                                ...
                                successBlock:^(BOOL isValid) {
                                             ...
                                             certificateChainFromManifestResponse:certificateChainFromManifestResponse
                                                  ...
                                                  NSError *error = [NSError errorWithDomain:ABI48_0_0EXUpdatesFileDownloaderErrorDomain
                                                                                       code:ABI48_0_0EXUpdatesFileDownloaderErrorCodeManifestVerificationError
                                                                                   userInfo:@{NSLocalizedDescriptionKey: @"Manifest verification failed"}];
                                                  [self->_logger error:error.userInfo[NSLocalizedDescriptionKey] code:ABI48_0_0EXUpdatesErrorCodeUpdateHasInvalidSignature];
                                                  errorBlock(error);
                                                }
                                              }
                     ...
                     errorBlock:(ABI48_0_0EXUpdatesFileDownloaderErrorBlock)errorBlock
{
  ...
  [self _downloadDataWithRequest:request successBlock:^(NSData *data, NSURLResponse *response) {
    if (![response isKindOfClass:[NSHTTPURLResponse class]]) {
      ...
      errorBlock([NSError errorWithDomain:ABI48_0_0EXUpdatesFileDownloaderErrorDomain
                                     code:ABI48_0_0EXUpdatesFileDownloaderErrorCodeInvalidResponseError
                                 userInfo:@{
                                   NSLocalizedDescriptionKey: errorMessage ,
                                 }
                  ]);
                       ...
                       errorBlock:(ABI48_0_0EXUpdatesFileDownloaderErrorBlock)errorBlock
{
  ...
  ABI48_0_0EXUpdatesCodeSigningConfiguration *codeSigningConfiguration = _config.codeSigningConfiguration;
  if (codeSigningConfiguration) {
    NSError *error;
    ABI48_0_0EXUpdatesSignatureValidationResult *signatureValidationResult = [codeSigningConfiguration validateSignatureWithSignature:manifestHeaders.signature
    ...
    if (error) {
      ...
      [self->_logger error:errorMessage code:ABI48_0_0EXUpdatesErrorCodeUpdateCodeSigningError];
      errorBlock([NSError errorWithDomain:ABI48_0_0EXUpdatesFileDownloaderErrorDomain
                                     code:ABI48_0_0EXUpdatesFileDownloaderErrorCodeCodeSigningSignatureError
                                 userInfo:@{NSLocalizedDescriptionKey: errorMessage}] );
      return;
    }

    if (signatureValidationResult.validationResult == ABI48_0_0EXUpdatesValidationResultInvalid) {
    ...
    if (signatureValidationResult.validationResult != ABI48_0_0EXUpdatesValidationResultSkipped) {
      ABI48_0_0EXUpdatesExpoProjectInformation *expoProjectInformation = signatureValidationResult.expoProjectInformation;
      if (expoProjectInformation != nil) {
        NSError *error;
        ABI48_0_0EXUpdatesUpdate *update;
        @try {
          update = [ABI48_0_0EXUpdatesUpdate updateWithManifest:mutableManifest
                                       manifestHeaders:manifestHeaders
                                            extensions:extensions
                                                config:_config
                                              database:database
        ...
        @catch (NSException *exception) {
          ...
          error = [NSError errorWithDomain:ABI48_0_0EXUpdatesFileDownloaderErrorDomain
                                      code:ABI48_0_0EXUpdatesFileDownloaderErrorCodeManifestParseError
                                  userInfo:@{NSLocalizedDescriptionKey: [@"Failed to parse manifest: " stringByAppendingString:exception.reason] }];
        }
        if (error) {
          [self->_logger error:error.userInfo[NSLocalizedDescriptionKey] code:ABI48_0_0EXUpdatesErrorCodeUpdateCodeSigningError];
          errorBlock(error);
          return;
        }

        ABI48_0_0EXManifestsManifest *manifestForProjectInformation = update.manifest;
  ...
  if (error) {
    [self->_logger error:error.userInfo[NSLocalizedDescriptionKey] code:ABI48_0_0EXUpdatesErrorCodeUpdateFailedToLoad];
    errorBlock(error);
    return;
  }

  if (![ABI48_0_0EXUpdatesSelectionPolicies doesUpdate:update matchFilters:update.manifestFilters]) {
    NSError *error = [NSError errorWithDomain:ABI48_0_0EXUpdatesFileDownloaderErrorDomain
                                         code:ABI48_0_0EXUpdatesFileDownloaderErrorCodeMismatchedManifestFiltersError
...
- (nullable NSDictionary *)_extractUpdateResponseDictionary:(id)parsedJson error:(NSError **)error
{
  ...
  if (error) {
    *error = [NSError errorWithDomain:ABI48_0_0EXUpdatesFileDownloaderErrorDomain
                                 code:ABI48_0_0EXUpdatesFileDownloaderErrorCodeNoCompatibleUpdateError
...
- (void)_setHTTPHeaderFields:(NSMutableURLRequest *)request
                extraHeaders:(NSDictionary *)extraHeaders
{
  [ABI48_0_0EXUpdatesFileDownloader _setHTTPHeaderFields:extraHeaders onRequest:request];
...
- (void)_setManifestHTTPHeaderFields:(NSMutableURLRequest *)request withExtraHeaders:(nullable NSDictionary *)extraHeaders
{
  ...
  NSString *previousFatalError = [ABI48_0_0EXUpdatesErrorRecovery consumeErrorLog];
...
- (NSError *)_errorFromResponse:(NSHTTPURLResponse *)response body:(NSString *)body
{
  ...
  return [NSError errorWithDomain:ABI48_0_0EXUpdatesFileDownloaderErrorDomain code:response.statusCode userInfo:userInfo];
}
