 ...
 */
@objc(ABI48_0_0EXUpdatesLogger)
public class UpdatesLogger: NSObject {
  public static let ABI48_0_0EXPO_UPDATES_LOG_CATEGORY = "expo-updates"

  private let logger = Logger(category: UpdatesLogger.ABI48_0_0EXPO_UPDATES_LOG_CATEGORY, options: [.logToOS, .logToFile])
