...
typedef void (^ABI48_0_0EXUpdatesAppLauncherCompletionBlock)(NSError * _Nullable error, BOOL success);
 ...
 */
@protocol ABI48_0_0EXUpdatesAppLauncher

@property (nullable, nonatomic, strong, readonly) ABI48_0_0EXUpdatesUpdate *launchedUpdate;
