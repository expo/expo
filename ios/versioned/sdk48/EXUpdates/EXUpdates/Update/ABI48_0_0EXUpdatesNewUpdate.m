...
@implementation ABI48_0_0EXUpdatesNewUpdate
                                  ...
                                  database:(ABI48_0_0EXUpdatesDatabase *)database
{
  ...
  if (assets) {
    for (NSDictionary *assetDict in (NSArray *)assets) {
      ...
      ABI48_0_0EXUpdatesAsset *asset = [[ABI48_0_0EXUpdatesAsset alloc] initWithKey:key type:(NSString *)fileExtension];
      asset.url = url;
  ...
  update.commitTime = [ABI48_0_0RCTConvert NSDate:(NSString *)commitTime];
...
+ (nullable NSDictionary *)dictionaryWithStructuredHeader:(NSString *)headerString
{
  ...
  ABI48_0_0EXStructuredHeadersParser *parser = [[ABI48_0_0EXStructuredHeadersParser alloc] initWithRawInput:headerString fieldType:ABI48_0_0EXStructuredHeadersParserFieldTypeDictionary ignoringParameters:YES];
  NSError *error;
