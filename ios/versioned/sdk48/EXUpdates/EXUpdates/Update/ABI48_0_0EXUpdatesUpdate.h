...
@class ABI48_0_0EXUpdatesDatabase;
 ...
 */
typedef NS_ENUM(NSInteger, ABI48_0_0EXUpdatesUpdateStatus) {
  ABI48_0_0EXUpdatesUpdateStatus0_Unused = 0,
  /**
   * The update has been fully downloaded and is ready to launch.
   */
  ABI48_0_0EXUpdatesUpdateStatusReady = 1,
  ABI48_0_0EXUpdatesUpdateStatus2_Unused = 2,
  /**
   * The update manifest has been download from the server but not all
   * assets have finished downloading successfully.
   */
  ABI48_0_0EXUpdatesUpdateStatusPending = 3,
  ABI48_0_0EXUpdatesUpdateStatus4_Unused = 4,
  /**
   ...
   */
  ABI48_0_0EXUpdatesUpdateStatusEmbedded = 5,
  /**
   ...
   */
  ABI48_0_0EXUpdatesUpdateStatusDevelopment = 6
};
 ...
 */
@interface ABI48_0_0EXUpdatesUpdate : NSObject
 ...
 */
@property (nonatomic, strong, readonly) NSArray<ABI48_0_0EXUpdatesAsset *> *assets;
...
@property (nonatomic, strong, readonly) ABI48_0_0EXManifestsManifest *manifest;

@property (nonatomic, assign) ABI48_0_0EXUpdatesUpdateStatus status;
