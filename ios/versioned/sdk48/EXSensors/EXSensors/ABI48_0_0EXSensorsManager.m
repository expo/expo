...
#import <ABI48_0_0EXSensors/ABI48_0_0EXSensorsManager.h>

@interface ABI48_0_0EXSensorsManager ()
...
@implementation ABI48_0_0EXSensorsManager

ABI48_0_0EX_REGISTER_MODULE();

+ (const NSArray<Protocol *> *)exportedInterfaces
{
  return @[@protocol(ABI48_0_0EXAccelerometerInterface), @protocol(ABI48_0_0EXBarometerInterface), @protocol(ABI48_0_0EXDeviceMotionInterface), @protocol(ABI48_0_0EXGyroscopeInterface), @protocol(ABI48_0_0EXMagnetometerInterface), @protocol(ABI48_0_0EXMagnetometerUncalibratedInterface)];
}
                                            ...
                                            withHandler:(void (^)(NSDictionary *event))handlerBlock
{
  ...
  if (![[self manager] isAccelerometerActive]) {
    ...
    __weak ABI48_0_0EXSensorsManager *weakSelf = self;
    [[self manager] startAccelerometerUpdatesToQueue:[NSOperationQueue mainQueue] withHandler:^(CMAccelerometerData *data, NSError *error) {
      __strong ABI48_0_0EXSensorsManager *strongSelf = weakSelf;
      if (strongSelf) {
  ...
  [[self manager] startDeviceMotionUpdatesUsingReferenceFrame:CMAttitudeReferenceFrameXArbitraryCorrectedZVertical toQueue:[NSOperationQueue mainQueue] withHandler:^(CMDeviceMotion *data, NSError *error) {
    ...
    NSMutableDictionary *result = [NSMutableDictionary dictionaryWithDictionary:@{
                             ...
                             @"accelerationIncludingGravity": @{
                                 @"x": @((data.userAcceleration.x + data.gravity.x) * ABI48_0_0EXGravity),
                                 @"y": @((data.userAcceleration.y + data.gravity.y) * ABI48_0_0EXGravity),
                                 @"z": @((data.userAcceleration.z + data.gravity.z) * ABI48_0_0EXGravity)
                                 },
                             @"rotation": @{
    ...
    if ([[strongSelf manager] isGyroAvailable]) {
      result[@"acceleration"] = @{
        @"x": @(data.userAcceleration.x * ABI48_0_0EXGravity),
        @"y": @(data.userAcceleration.y * ABI48_0_0EXGravity),
        @"z": @(data.userAcceleration.z * ABI48_0_0EXGravity)
      };
