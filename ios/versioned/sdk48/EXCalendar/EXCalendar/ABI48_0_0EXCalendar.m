...
#import <ABI48_0_0EXCalendar/ABI48_0_0EXCalendar.h>
#import <ABI48_0_0EXCalendar/ABI48_0_0EXCalendarConverter.h>
#import <ABI48_0_0EXCalendar/ABI48_0_0EXCalendarPermissionRequester.h>
...
@implementation ABI48_0_0EXCalendar
...
ABI48_0_0EX_EXPORT_MODULE(ExpoCalendar);
...
- (void)setModuleRegistry:(ABI48_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  [ABI48_0_0EXPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI48_0_0EXCalendarPermissionRequester new],
                                                    [ABI48_0_0EXRemindersPermissionRequester new]
                                                    ]
...
ABI48_0_0EX_EXPORT_METHOD_AS(getCalendarsAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve([ABI48_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI48_0_0EX_EXPORT_METHOD_AS(getDefaultCalendarAsync,
                    getDefaultCalendarAsync:(ABI48_0_0EXPromiseResolveBlock)resolve
                    rejector:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  if (![self _checkCalendarPermissions:reject]) {
    return;
  }
  ...
  resolve([ABI48_0_0EXCalendarConverter serializeCalendar:defaultCalendar]);
}

ABI48_0_0EX_EXPORT_METHOD_AS(saveCalendarAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (color) {
    calendar.CGColor = [ABI48_0_0EXUtilities UIColor:color].CGColor;
...
ABI48_0_0EX_EXPORT_METHOD_AS(deleteCalendarAsync,
...
ABI48_0_0EX_EXPORT_METHOD_AS(getEventsAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI48_0_0EXUtilities NSDate:startDateStr];
  NSDate *endDate = [ABI48_0_0EXUtilities NSDate:endDateStr];
  ...
  if (calendarEvents) {
    resolve([ABI48_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI48_0_0EX_EXPORT_METHOD_AS(getEventByIdAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (calendarEvent) {
    resolve([ABI48_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI48_0_0EX_EXPORT_METHOD_AS(saveEventAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI48_0_0EXUtilities NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI48_0_0EXUtilities NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI48_0_0EXUtilities NSDate:details[@"instanceStartDate"]];
...
ABI48_0_0EX_EXPORT_METHOD_AS(deleteEventAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *instanceStartDate = [ABI48_0_0EXUtilities NSDate:event[@"instanceStartDate"]];
...
ABI48_0_0EX_EXPORT_METHOD_AS(getAttendeesForEventAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (item.hasAttendees) {
    resolve([ABI48_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI48_0_0EX_EXPORT_METHOD_AS(getRemindersAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI48_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI48_0_0EX_EXPORT_METHOD_AS(getReminderByIdAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (reminder) {
    ...
    resolve([ABI48_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI48_0_0EX_EXPORT_METHOD_AS(saveReminderAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI48_0_0EXUtilities NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI48_0_0EXUtilities NSDate:details[@"dueDate"]];
  NSDate *completionDate = [ABI48_0_0EXUtilities NSDate:details[@"completionDate"]];
...
ABI48_0_0EX_EXPORT_METHOD_AS(deleteReminderAsync,
...
ABI48_0_0EX_EXPORT_METHOD_AS(getSourcesAsync,
                    getSourcesAsync:(ABI48_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI48_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI48_0_0EX_EXPORT_METHOD_AS(getSourceByIdAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve([ABI48_0_0EXCalendarConverter serializeSource:source]);
}

ABI48_0_0EX_EXPORT_METHOD_AS(getCalendarPermissionsAsync,
                    getCalendarPermissionsAsync:(ABI48_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  [ABI48_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI48_0_0EXCalendarPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI48_0_0EX_EXPORT_METHOD_AS(requestCalendarPermissionsAsync,
                    requestCalendarPermissionsAsync:(ABI48_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
...
ABI48_0_0EX_EXPORT_METHOD_AS(getRemindersPermissionsAsync,
                    getRemindersPermissionsAsync:(ABI48_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  [ABI48_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI48_0_0EXRemindersPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI48_0_0EX_EXPORT_METHOD_AS(requestRemindersPermissionsAsync,
                    requestRemindersPermissionsAsync:(ABI48_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  [ABI48_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI48_0_0EXRemindersPermissionRequester class]
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI48_0_0EXUtilities NSDate:alarm[@"absoluteDate"]];
...
- (EKRecurrenceRule *)_createRecurrenceRule:(NSDictionary *)recurrenceRule
{
  ...
  if (recurrenceRule[@"endDate"]) {
      endDate = [ABI48_0_0EXUtilities NSDate:recurrenceRule[@"endDate"]];
  }
...
- (BOOL)_checkPermissions:(EKEntityType)entity reject:(ABI48_0_0EXPromiseRejectBlock)reject
{
  ...
  switch (entity) {
    case EKEntityTypeEvent:
      requesterClass = [ABI48_0_0EXCalendarPermissionRequester class];
      break;
    case EKEntityTypeReminder:
      requesterClass = [ABI48_0_0EXRemindersPermissionRequester class];
      break;
    default: {
...
- (BOOL)_checkCalendarPermissions:(ABI48_0_0EXPromiseRejectBlock)reject
{
  return [self _checkPermissions:EKEntityTypeEvent reject:reject];
}

- (BOOL)_checkRemindersPermissions:(ABI48_0_0EXPromiseRejectBlock)reject
{
...
- (void)_initializePermittedEntities
{
  ...
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI48_0_0EXCalendarPermissionRequester class]]) {
    permittedEntities |= EKEntityMaskEvent;
  }
  
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI48_0_0EXRemindersPermissionRequester class]]) {
