...
@implementation ABI48_0_0EXCalendarPermissionRequester
...
- (NSDictionary *)getPermissions
{
  ...
  if (!calendarUsageDescription) {
    ABI48_0_0EXFatal(ABI48_0_0EXErrorWithMessage(@"This app is missing NSCalendarsUsageDescription, so calendar methods will fail. Add this key to your bundle's Info.plist."));
