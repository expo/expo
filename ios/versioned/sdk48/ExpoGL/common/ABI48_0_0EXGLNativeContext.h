...
class ABI48_0_0EXGLContext {
 ...
 public:
  ABI48_0_0EXGLContext(ABI48_0_0EXGLContextId ctxId): ctxId(ctxId) {}
  ...
  ABI48_0_0EXGLObjectId createObject(void) noexcept;
  void destroyObject(ABI48_0_0EXGLObjectId exglObjId) noexcept;
  void mapObject(ABI48_0_0EXGLObjectId exglObjId, GLuint glObj) noexcept;
  GLuint lookupObject(ABI48_0_0EXGLObjectId exglObjId) noexcept;
 ...
 public:
  ABI48_0_0EXGLContextId ctxId;

  // Object mapping
  std::unordered_map<ABI48_0_0EXGLObjectId, GLuint> objects;
