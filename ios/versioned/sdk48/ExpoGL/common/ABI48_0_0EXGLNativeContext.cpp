...
#include "ABI48_0_0EXPlatformUtils.h"
...
void ABI48_0_0EXGLContext::prepareContext(jsi::Runtime &runtime, std::function<void(void)> flushMethod) {
  ...
  try {
    ...
    ABI48_0_0EXGLSysLog("Failed to setup ABI48_0_0EXGLContext [%s]", err.what());
  }
}

void ABI48_0_0EXGLContext::maybePrepareWorkletContext(jsi::Runtime &runtime, initGlesContext viewport) {
...
void ABI48_0_0EXGLContext::endNextBatch() noexcept {
...
void ABI48_0_0EXGLContext::addToNextBatch(Op &&op) noexcept {
...
void ABI48_0_0EXGLContext::addBlockingToNextBatch(Op &&op) {
...
// [JS thread] Enqueue a function and return an ABI48_0_0EXGL object that will get mapped
// to the function's return value when it is called on the GL thread.
jsi::Value ABI48_0_0EXGLContext::addFutureToNextBatch(
    jsi::Runtime &runtime,
...
void ABI48_0_0EXGLContext::flush(void) {
...
ABI48_0_0EXGLObjectId ABI48_0_0EXGLContext::createObject(void) noexcept {
  return nextObjectId++;
}

void ABI48_0_0EXGLContext::destroyObject(ABI48_0_0EXGLObjectId exglObjId) noexcept {
  objects.erase(exglObjId);
}

void ABI48_0_0EXGLContext::mapObject(ABI48_0_0EXGLObjectId exglObjId, GLuint glObj) noexcept {
  objects[exglObjId] = glObj;
}

GLuint ABI48_0_0EXGLContext::lookupObject(ABI48_0_0EXGLObjectId exglObjId) noexcept {
  auto iter = objects.find(exglObjId);
  return iter == objects.end() ? 0 : iter->second;
}

void ABI48_0_0EXGLContext::tryRegisterOnJSRuntimeDestroy(jsi::Runtime &runtime) {
...
initGlesContext ABI48_0_0EXGLContext::prepareOpenGLESContext() {
...
void ABI48_0_0EXGLContext::maybeReadAndCacheSupportedExtensions() {
