...
@interface ABI48_0_0EXNotificationPresentationModule ()

@property (nonatomic, weak) id<ABI48_0_0EXNotificationBuilder> notificationBuilder;
...
@implementation ABI48_0_0EXNotificationPresentationModule

ABI48_0_0EX_EXPORT_MODULE(ExpoNotificationPresenter);
...
// Remove once presentNotificationAsync is removed
ABI48_0_0EX_EXPORT_METHOD_AS(presentNotificationAsync,
                    ...
                    reject:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  __weak ABI48_0_0EXNotificationPresentationModule *weakSelf = self;
...
ABI48_0_0EX_EXPORT_METHOD_AS(getPresentedNotificationsAsync,
                    getPresentedNotificationsAsyncWithResolve:(ABI48_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI48_0_0EXPromiseRejectBlock)reject)
{
...
ABI48_0_0EX_EXPORT_METHOD_AS(dismissNotificationAsync,
...
ABI48_0_0EX_EXPORT_METHOD_AS(dismissAllNotificationsAsync,
                    dismissAllNotificationsWithResolver:(ABI48_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI48_0_0EXPromiseRejectBlock)reject)
{
...
{
  _notificationBuilder = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI48_0_0EXNotificationBuilder)];

  // Remove once presentNotificationAsync is removed
  id<ABI48_0_0EXNotificationCenterDelegate> notificationCenterDelegate = (id<ABI48_0_0EXNotificationCenterDelegate>)[moduleRegistry getSingletonModuleForName:@"NotificationCenterDelegate"];
...
- (NSArray * _Nonnull)serializeNotifications:(NSArray<UNNotification *> * _Nonnull)notifications
{
  ...
  for (UNNotification *notification in notifications) {
    [serializedNotifications addObject:[ABI48_0_0EXNotificationSerializer serializedNotification:notification]];
  }
