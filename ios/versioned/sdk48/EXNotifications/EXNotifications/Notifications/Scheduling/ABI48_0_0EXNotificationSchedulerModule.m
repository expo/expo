...
#import <ABI48_0_0EXNotifications/ABI48_0_0EXNotificationSchedulerModule.h>
...
#import <ABI48_0_0EXNotifications/NSDictionary+ABI48_0_0EXNotificationsVerifyingClass.h>
...
@interface ABI48_0_0EXNotificationSchedulerModule ()

@property (nonatomic, weak) id<ABI48_0_0EXNotificationBuilder> builder;

@end

@implementation ABI48_0_0EXNotificationSchedulerModule

ABI48_0_0EX_EXPORT_MODULE(ExpoNotificationScheduler);

- (void)setModuleRegistry:(ABI48_0_0EXModuleRegistry *)moduleRegistry
{
  _builder = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI48_0_0EXNotificationBuilder)];
}

# pragma mark - Exported methods

ABI48_0_0EX_EXPORT_METHOD_AS(getAllScheduledNotificationsAsync,
                    getAllScheduledNotifications:(ABI48_0_0EXPromiseResolveBlock)resolve reject:(ABI48_0_0EXPromiseRejectBlock)reject
                    )
{
...
ABI48_0_0EX_EXPORT_METHOD_AS(scheduleNotificationAsync,
                     scheduleNotification:(NSString *)identifier notificationSpec:(NSDictionary *)notificationSpec triggerSpec:(NSDictionary *)triggerSpec resolve:(ABI48_0_0EXPromiseResolveBlock)resolve rejecting:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  @try {
...
ABI48_0_0EX_EXPORT_METHOD_AS(cancelScheduledNotificationAsync,
                     cancelNotification:(NSString *)identifier resolve:(ABI48_0_0EXPromiseResolveBlock)resolve rejecting:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  [[UNUserNotificationCenter currentNotificationCenter] removePendingNotificationRequestsWithIdentifiers:@[identifier]];
  resolve(nil);
}

ABI48_0_0EX_EXPORT_METHOD_AS(cancelAllScheduledNotificationsAsync,
                     cancelAllNotificationsWithResolver:(ABI48_0_0EXPromiseResolveBlock)resolve rejecting:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  [[UNUserNotificationCenter currentNotificationCenter] removeAllPendingNotificationRequests];
  resolve(nil);
}

ABI48_0_0EX_EXPORT_METHOD_AS(getNextTriggerDateAsync,
                    getNextTriggerDate:(NSDictionary *)triggerSpec resolve:(ABI48_0_0EXPromiseResolveBlock)resolve rejecting:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  @try {
...
- (NSArray * _Nonnull)serializeNotificationRequests:(NSArray<UNNotificationRequest *> * _Nonnull) requests
{
  ...
  for (UNNotificationRequest *request in requests) {
    [serializedRequests addObject:[ABI48_0_0EXNotificationSerializer serializedNotificationRequest:request]];
  }
