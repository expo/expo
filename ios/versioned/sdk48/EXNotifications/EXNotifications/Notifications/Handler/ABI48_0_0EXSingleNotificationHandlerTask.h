...
@class ABI48_0_0EXSingleNotificationHandlerTask;

@protocol ABI48_0_0EXSingleNotificationHandlerTaskDelegate

- (void)taskDidFinish:(ABI48_0_0EXSingleNotificationHandlerTask *)task;

@end

@interface ABI48_0_0EXSingleNotificationHandlerTask : NSObject
...
- (instancetype)initWithEventEmitter:(id<ABI48_0_0EXEventEmitterService>)eventEmitter
                   ...
                   completionHandler:(void (^)(UNNotificationPresentationOptions))completionHandler
                            delegate:(id<ABI48_0_0EXSingleNotificationHandlerTaskDelegate>)delegate;
