...
#import <ABI48_0_0EXNotifications/ABI48_0_0EXPushTokenModule.h>
...
@interface ABI48_0_0EXPushTokenModule ()

@property (nonatomic, weak) id<ABI48_0_0EXPushTokenManager> pushTokenManager;
...
@property (nonatomic, strong) ABI48_0_0EXPromiseResolveBlock getDevicePushTokenResolver;
@property (nonatomic, strong) ABI48_0_0EXPromiseRejectBlock getDevicePushTokenRejecter;

@end

@implementation ABI48_0_0EXPushTokenModule

ABI48_0_0EX_EXPORT_MODULE(ExpoPushTokenManager);

# pragma mark - Exported methods

ABI48_0_0EX_EXPORT_METHOD_AS(getDevicePushTokenAsync,
                    getDevicePushTokenResolving:(ABI48_0_0EXPromiseResolveBlock)resolve rejecting:(ABI48_0_0EXPromiseRejectBlock)reject)
{
...
ABI48_0_0EX_EXPORT_METHOD_AS(unregisterForNotificationsAsync,
        	    unregisterForNotificationsAsync:(ABI48_0_0EXPromiseResolveBlock)resolve reject:(ABI48_0_0EXPromiseRejectBlock)reject)
{
...
# pragma mark - ABI48_0_0EXPushTokenListener
