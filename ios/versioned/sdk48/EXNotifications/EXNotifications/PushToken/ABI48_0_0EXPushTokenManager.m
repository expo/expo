...
#import <ABI48_0_0EXNotifications/ABI48_0_0EXPushTokenManager.h>
#import <ABI48_0_0ExpoModulesCore/ABI48_0_0EXDefines.h>

@interface ABI48_0_0EXPushTokenManager ()

@property (nonatomic, strong) NSPointerArray *listeners;

@end

@implementation ABI48_0_0EXPushTokenManager

ABI48_0_0EX_REGISTER_SINGLETON_MODULE(PushTokenManager);
