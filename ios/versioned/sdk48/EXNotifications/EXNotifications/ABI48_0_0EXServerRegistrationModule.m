...
#define ABI48_0_0EX_UNVERSIONED(symbol) symbol

static NSString * const kEXDeviceInstallationUUIDKey = ABI48_0_0EX_UNVERSIONED(@"ABI48_0_0EXDeviceInstallationUUIDKey");
static NSString * const kEXDeviceInstallationUUIDLegacyKey = ABI48_0_0EX_UNVERSIONED(@"ABI48_0_0EXDeviceInstallUUIDKey");

static NSString * const kEXRegistrationInfoKey = ABI48_0_0EX_UNVERSIONED(@"ABI48_0_0EXNotificationRegistrationInfoKey");

@implementation ABI48_0_0EXServerRegistrationModule

ABI48_0_0EX_EXPORT_MODULE(NotificationsServerRegistrationModule)

ABI48_0_0EX_EXPORT_METHOD_AS(getInstallationIdAsync,
                    getInstallationIdAsyncWithResolver:(ABI48_0_0EXPromiseResolveBlock)resolve
...
ABI48_0_0EX_EXPORT_METHOD_AS(getRegistrationInfoAsync,
                    getRegistrationInfoAsyncWithResolver:(ABI48_0_0EXPromiseResolveBlock)resolve
                                                rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  CFTypeRef keychainResult = NULL;
...
ABI48_0_0EX_EXPORT_METHOD_AS(setRegistrationInfoAsync,
