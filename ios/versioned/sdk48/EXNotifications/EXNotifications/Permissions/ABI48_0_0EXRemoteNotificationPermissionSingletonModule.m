...
@interface ABI48_0_0EXRemoteNotificationPermissionSingletonModule ()

@property (nonatomic, strong) NSPointerArray *delegates;

@end

@implementation ABI48_0_0EXRemoteNotificationPermissionSingletonModule

ABI48_0_0EX_REGISTER_SINGLETON_MODULE(RemoteNotificationPermissionPublisher);
