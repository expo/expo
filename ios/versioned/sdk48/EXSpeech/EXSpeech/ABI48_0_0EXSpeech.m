...
#import <ABI48_0_0EXSpeech/ABI48_0_0EXSpeech.h>

@interface ABI48_0_0EXSpeechUtteranceWithId : AVSpeechUtterance
...
@implementation ABI48_0_0EXSpeechUtteranceWithId
...
@interface ABI48_0_0EXSpeech () <AVSpeechSynthesizerDelegate>
...
@implementation ABI48_0_0EXSpeech

ABI48_0_0EX_EXPORT_MODULE(ExponentSpeech)
...
{
  id<ABI48_0_0EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI48_0_0EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStarted" body:@{ @"id": ((ABI48_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
  ...
  willSpeakRangeOfSpeechString:(NSRange)characterRange utterance:(nonnull AVSpeechUtterance *)utterance
{
  id<ABI48_0_0EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI48_0_0EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingWillSayNextString" body:@{ @"id": ((ABI48_0_0EXSpeechUtteranceWithId *) utterance).utteranceId, @"charIndex": @(characterRange.location), @"charLength": @(characterRange.length) }];
  }
}
 ...
 didCancelSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI48_0_0EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI48_0_0EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStopped" body:@{ @"id": ((ABI48_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didFinishSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI48_0_0EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI48_0_0EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingDone" body:@{ @"id": ((ABI48_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}


ABI48_0_0EX_EXPORT_METHOD_AS(speak,
  ...
  AVSpeechUtterance *utterance = [[ABI48_0_0EXSpeechUtteranceWithId alloc] initWithString:text utteranceId:utteranceId];
...
ABI48_0_0EX_EXPORT_METHOD_AS(getVoices,
                    getVoices:(ABI48_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject) {
...
ABI48_0_0EX_EXPORT_METHOD_AS(stop,
                    stop:(ABI48_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject) {
  [_synthesizer stopSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI48_0_0EX_EXPORT_METHOD_AS(pause,
                    pause:(ABI48_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject) {
  [_synthesizer pauseSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI48_0_0EX_EXPORT_METHOD_AS(resume,
                    resume:(ABI48_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject) {
  [_synthesizer continueSpeaking];
  resolve(nil);
}

ABI48_0_0EX_EXPORT_METHOD_AS(isSpeaking,
                    isSpeaking:(ABI48_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject) {
