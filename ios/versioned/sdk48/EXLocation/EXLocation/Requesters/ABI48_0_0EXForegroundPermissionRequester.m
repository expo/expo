...
@implementation ABI48_0_0EXForegroundPermissionRequester
...
{
  if ([ABI48_0_0EXBaseLocationRequester isConfiguredForWhenInUseAuthorization] && [self.locationManager  respondsToSelector:whenInUseAuthorizationSelector]) {
