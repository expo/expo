...
#import <ABI48_0_0EXLocation/ABI48_0_0EXLocationDelegate.h>
...
#import <ABI48_0_0EXLocation/ABI48_0_0EXForegroundPermissionRequester.h>
...
NSString * const ABI48_0_0EXLocationChangedEventName = @"Expo.locationChanged";
NSString * const ABI48_0_0EXHeadingChangedEventName = @"Expo.headingChanged";

@interface ABI48_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI48_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) NSMutableSet<ABI48_0_0EXLocationDelegate *> *retainedDelegates;
...
@property (nonatomic, weak) id<ABI48_0_0EXTaskManagerInterface> tasksManager;

@end

@implementation ABI48_0_0EXLocation

ABI48_0_0EX_EXPORT_MODULE(ExpoLocation);
...
- (void)setModuleRegistry:(ABI48_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  _tasksManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI48_0_0EXTaskManagerInterface)];
  ...
  [ABI48_0_0EXPermissionsMethodsDelegate registerRequesters:@[
    [ABI48_0_0EXLocationPermissionRequester new],
    [ABI48_0_0EXForegroundPermissionRequester new],
    [ABI48_0_0EXBackgroundLocationPermissionRequester new]
...
{
  return @[ABI48_0_0EXLocationChangedEventName, ABI48_0_0EXHeadingChangedEventName];
}
...
ABI48_0_0EX_EXPORT_METHOD_AS(getProviderStatusAsync,
...
ABI48_0_0EX_EXPORT_METHOD_AS(getCurrentPositionAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  __block ABI48_0_0EXLocationDelegate *delegate;

  delegate = [[ABI48_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (delegate != nil) {
      if (locations.lastObject != nil) {
        resolve([ABI48_0_0EXLocation exportLocation:locations.lastObject]);
      } else {
...
ABI48_0_0EX_EXPORT_METHOD_AS(watchPositionImplAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  ABI48_0_0EXLocationDelegate *delegate = [[ABI48_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject != nil && weakSelf != nil) {
      ...
      NSDictionary *body = @{
                             @"watchId": watchId,
                             @"location": [ABI48_0_0EXLocation exportLocation:loc],
                             };

      [strongSelf->_eventEmitter sendEventWithName:ABI48_0_0EXLocationChangedEventName body:body];
    }
  } onUpdateHeadings:nil onError:^(NSError *error) {
    // TODO: report errors
...
ABI48_0_0EX_EXPORT_METHOD_AS(getLastKnownPositionAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  if ([self.class isLocation:location validWithOptions:options]) {
    resolve([ABI48_0_0EXLocation exportLocation:location]);
  } else {
    resolve([NSNull null]);
  }
}
...
ABI48_0_0EX_EXPORT_METHOD_AS(watchDeviceHeading,
  ...
  ABI48_0_0EXLocationDelegate *delegate = [[ABI48_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
    if (newHeading != nil && weakSelf != nil) {
      ...
      [strongSelf->_eventEmitter sendEventWithName:ABI48_0_0EXHeadingChangedEventName body:body];
    }
...
ABI48_0_0EX_EXPORT_METHOD_AS(removeWatchAsync,
                    watchId:(nonnull NSNumber *)watchId
                    resolver:(ABI48_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ABI48_0_0EXLocationDelegate *delegate = _delegates[watchId];
...
ABI48_0_0EX_EXPORT_METHOD_AS(geocodeAsync,
...
ABI48_0_0EX_EXPORT_METHOD_AS(reverseGeocodeAsync,
    ...
    if (!error) {
      ...
      for (CLPlacemark* placemark in placemarks) {
        NSDictionary *address = @{
                                  @"city": ABI48_0_0UMNullIfNil(placemark.locality),
                                  @"district": ABI48_0_0UMNullIfNil(placemark.subLocality),
                                  @"streetNumber": ABI48_0_0UMNullIfNil(placemark.subThoroughfare),
                                  @"street": ABI48_0_0EXNullIfNil(placemark.thoroughfare),
                                  @"region": ABI48_0_0EXNullIfNil(placemark.administrativeArea),
                                  @"subregion": ABI48_0_0EXNullIfNil(placemark.subAdministrativeArea),
                                  @"country": ABI48_0_0EXNullIfNil(placemark.country),
                                  @"postalCode": ABI48_0_0EXNullIfNil(placemark.postalCode),
                                  @"name": ABI48_0_0EXNullIfNil(placemark.name),
                                  @"isoCountryCode": ABI48_0_0EXNullIfNil(placemark.ISOcountryCode),
                                  @"timezone": ABI48_0_0EXNullIfNil(placemark.timeZone.name),
                                  };
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  [ABI48_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI48_0_0EXLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
...
ABI48_0_0EX_EXPORT_METHOD_AS(getForegroundPermissionsAsync,
                    getForegroundPermissionsAsync:(ABI48_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  [ABI48_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI48_0_0EXForegroundPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI48_0_0EX_EXPORT_METHOD_AS(requestForegroundPermissionsAsync,
                    requestForegroundPermissionsAsync:(ABI48_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  [ABI48_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI48_0_0EXForegroundPermissionRequester class]
...
ABI48_0_0EX_EXPORT_METHOD_AS(getBackgroundPermissionsAsync,
                    getBackgroundPermissionsAsync:(ABI48_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  [ABI48_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI48_0_0EXBackgroundLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI48_0_0EX_EXPORT_METHOD_AS(requestBackgroundPermissionsAsync,
                    requestBackgroundPermissionsAsync:(ABI48_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  [ABI48_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI48_0_0EXBackgroundLocationPermissionRequester class]
...
ABI48_0_0EX_EXPORT_METHOD_AS(hasServicesEnabledAsync,
                    hasServicesEnabled:(ABI48_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI48_0_0EXPromiseRejectBlock)reject)
{
...
ABI48_0_0EX_EXPORT_METHOD_AS(startLocationUpdatesAsync,
                    ...
                    reject:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI48_0_0EXLocationTaskConsumer class] options:options];
  }
  @catch (NSException *e) {
...
ABI48_0_0EX_EXPORT_METHOD_AS(stopLocationUpdatesAsync,
                    ...
                    reject:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI48_0_0EXLocationTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI48_0_0EX_EXPORT_METHOD_AS(hasStartedLocationUpdatesAsync,
                    ...
                    reject:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI48_0_0EXLocationTaskConsumer class]]));
}

# pragma mark - Geofencing

ABI48_0_0EX_EXPORT_METHOD_AS(startGeofencingAsync,
                    ...
                    reject:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI48_0_0EXGeofencingTaskConsumer class] options:options];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI48_0_0EX_EXPORT_METHOD_AS(stopGeofencingAsync,
                    ...
                    reject:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI48_0_0EXGeofencingTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI48_0_0EX_EXPORT_METHOD_AS(hasStartedGeofencingAsync,
                    ...
                    reject:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI48_0_0EXGeofencingTaskConsumer class]]));
}
...
- (BOOL)checkForegroundPermissions:(ABI48_0_0EXPromiseRejectBlock)reject
{
  if (![CLLocationManager locationServicesEnabled]) {
    reject(@"E_LOCATION_SERVICES_DISABLED", @"Location services are disabled", nil);
    return NO;
  }
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI48_0_0EXForegroundPermissionRequester class]]) {
...
- (BOOL)checkBackgroundPermissions:(ABI48_0_0EXPromiseRejectBlock)reject
{
  if (![CLLocationManager locationServicesEnabled]) {
    reject(@"E_LOCATION_SERVICES_DISABLED", @"Location services are disabled", nil);
    return NO;
  }
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI48_0_0EXBackgroundLocationPermissionRequester class]]) {
...
- (BOOL)checkTaskManagerExists:(ABI48_0_0EXPromiseRejectBlock)reject
{
...
- (BOOL)checkBackgroundServices:(ABI48_0_0EXPromiseRejectBlock)reject
{
...
{
  switch (accuracy) {
    case ABI48_0_0EXLocationAccuracyLowest:
      return kCLLocationAccuracyThreeKilometers;
    case ABI48_0_0EXLocationAccuracyLow:
      return kCLLocationAccuracyKilometer;
    case ABI48_0_0EXLocationAccuracyBalanced:
      return kCLLocationAccuracyHundredMeters;
    case ABI48_0_0EXLocationAccuracyHigh:
      return kCLLocationAccuracyNearestTenMeters;
    case ABI48_0_0EXLocationAccuracyHighest:
      return kCLLocationAccuracyBest;
    case ABI48_0_0EXLocationAccuracyBestForNavigation:
