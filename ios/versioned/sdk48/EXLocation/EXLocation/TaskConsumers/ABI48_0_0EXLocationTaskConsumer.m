...
#import <ABI48_0_0EXLocation/ABI48_0_0EXLocationTaskConsumer.h>

@interface ABI48_0_0EXLocationTaskConsumer ()
...
@implementation ABI48_0_0EXLocationTaskConsumer
...
- (void)setOptions:(NSDictionary *)options
{
  [ABI48_0_0EXUtilities performSynchronouslyOnMainThread:^{
    ...
    ABI48_0_0EXLocationAccuracy accuracy = [options[@"accuracy"] unsignedIntegerValue] ?: ABI48_0_0EXLocationAccuracyBalanced;

    locationManager.desiredAccuracy = [ABI48_0_0EXLocation CLLocationAccuracyFromOption:accuracy];
    locationManager.distanceFilter = [options[@"distanceInterval"] doubleValue] ?: kCLDistanceFilterNone;
    locationManager.activityType = [ABI48_0_0EXLocation CLActivityTypeFromOption:[options[@"activityType"] integerValue]];
...
- (void)executeTaskWithDeferredLocations
{
  ...
  NSDictionary *data = @{ @"locations": [ABI48_0_0EXLocationTaskConsumer _exportLocations:_deferredLocations] };
...
+ (NSArray<NSDictionary *> *)_exportLocations:(NSArray<CLLocation *> *)locations
{
  ...
  for (CLLocation *location in locations) {
    [result addObject:[ABI48_0_0EXLocation exportLocation:location]];
  }
  return result;
}
