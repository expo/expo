...
#import <ABI48_0_0EXFileSystem/ABI48_0_0EXFileSystemLocalFileHandler.h>
#import <ABI48_0_0EXFileSystem/ABI48_0_0EXFileSystemAssetLibraryHandler.h>
...
NSString * const ABI48_0_0EXDownloadProgressEventName = @"expo-file-system.downloadProgress";
NSString * const ABI48_0_0EXUploadProgressEventName = @"expo-file-system.uploadProgress";

typedef NS_ENUM(NSInteger, ABI48_0_0EXFileSystemSessionType) {
  ABI48_0_0EXFileSystemBackgroundSession = 0,
  ABI48_0_0EXFileSystemForegroundSession = 1,
};

typedef NS_ENUM(NSInteger, ABI48_0_0EXFileSystemUploadType) {
  ABI48_0_0EXFileSystemInvalidType = -1,
  ABI48_0_0EXFileSystemBinaryContent = 0,
  ABI48_0_0EXFileSystemMultipart = 1,
};

@interface ABI48_0_0EXFileSystem ()

@property (nonatomic, strong) NSURLSession *backgroundSession;
@property (nonatomic, strong) NSURLSession *foregroundSession;
@property (nonatomic, strong) ABI48_0_0EXSessionTaskDispatcher *sessionTaskDispatcher;
@property (nonatomic, strong) ABI48_0_0EXTaskHandlersManager *taskHandlersManager;
...
@implementation ABI48_0_0EXFileSystem
...
{
  return @[@protocol(ABI48_0_0EXFileSystemInterface)];
}
...
- (instancetype)initWithDocumentDirectory:(NSString *)documentDirectory cachesDirectory:(NSString *)cachesDirectory bundleDirectory:(NSString *)bundleDirectory
{
  if (self = [super init]) {
    ...
    _taskHandlersManager = [ABI48_0_0EXTaskHandlersManager new];

    [ABI48_0_0EXFileSystem ensureDirExistsWithPath:_documentDirectory];
    [ABI48_0_0EXFileSystem ensureDirExistsWithPath:_cachesDirectory];
  }
  return self;
}
...
- (void)setModuleRegistry:(ABI48_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  _eventEmitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI48_0_0EXEventEmitterService)];

  _sessionTaskDispatcher = [[ABI48_0_0EXSessionTaskDispatcher alloc] initWithSessionHandler:[moduleRegistry getSingletonModuleForName:@"SessionHandler"]];
  _backgroundSession = [self _createSession:ABI48_0_0EXFileSystemBackgroundSession delegate:_sessionTaskDispatcher];
  _foregroundSession = [self _createSession:ABI48_0_0EXFileSystemForegroundSession delegate:_sessionTaskDispatcher];
}
...
{
  return @[ABI48_0_0EXDownloadProgressEventName, ABI48_0_0EXUploadProgressEventName];
}
...
ABI48_0_0EX_EXPORT_METHOD_AS(getInfoAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  if ([uri.scheme isEqualToString:@"file"]) {
    [ABI48_0_0EXFileSystemLocalFileHandler getInfoForFile:uri withOptions:options resolver:resolve rejecter:reject];
  } else if ([uri.scheme isEqualToString:@"assets-library"] || [uri.scheme isEqualToString:@"ph"]) {
    [ABI48_0_0EXFileSystemAssetLibraryHandler getInfoForFile:uri withOptions:options resolver:resolve rejecter:reject];
  } else {
...
ABI48_0_0EX_EXPORT_METHOD_AS(readAsStringAsync,
...
ABI48_0_0EX_EXPORT_METHOD_AS(writeAsStringAsync,
...
ABI48_0_0EX_EXPORT_METHOD_AS(deleteAsync,
...
ABI48_0_0EX_EXPORT_METHOD_AS(moveAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:[from URLByAppendingPathComponent:@".."]] & ABI48_0_0EXFileSystemPermissionWrite)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
  ...
  if (!([self permissionsForURI:to] & ABI48_0_0EXFileSystemPermissionWrite)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
...
ABI48_0_0EX_EXPORT_METHOD_AS(copyAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:from] & ABI48_0_0EXFileSystemPermissionRead)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
  ...
  if ([from.scheme isEqualToString:@"file"]) {
    [ABI48_0_0EXFileSystemLocalFileHandler copyFrom:from to:to resolver:resolve rejecter:reject];
  } else if ([from.scheme isEqualToString:@"assets-library"] || [from.scheme isEqualToString:@"ph"]) {
    [ABI48_0_0EXFileSystemAssetLibraryHandler copyFrom:from to:to resolver:resolve rejecter:reject];
  } else {
    reject(@"ERR_FILESYSTEM_INVALID_URI",
           [NSString stringWithFormat:@"Unsupported URI scheme for '%@'", from],
           nil);
...
ABI48_0_0EX_EXPORT_METHOD_AS(makeDirectoryAsync,
...
ABI48_0_0EX_EXPORT_METHOD_AS(readDirectoryAsync,
...
ABI48_0_0EX_EXPORT_METHOD_AS(downloadAsync,
                                ...
                                rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:localUri] & ABI48_0_0EXFileSystemPermissionWrite)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
  ...
  ABI48_0_0EXSessionTaskDelegate *taskDelegate = [[ABI48_0_0EXSessionDownloadTaskDelegate alloc] initWithResolve:resolve
                                                                                        reject:reject
                                                                                      localUrl:localUri
...
ABI48_0_0EX_EXPORT_METHOD_AS(uploadAsync,
                       ...
                       rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  ABI48_0_0EXSessionTaskDelegate *taskDelegate = [[ABI48_0_0EXSessionUploadTaskDelegate alloc] initWithResolve:resolve reject:reject];
  [_sessionTaskDispatcher registerTaskDelegate:taskDelegate forTask:task];
  [task resume];
}

ABI48_0_0EX_EXPORT_METHOD_AS(uploadTaskStartAsync,
                                ...
                                rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  ABI48_0_0EXUploadDelegateOnSendCallback onSend = ^(NSURLSessionUploadTask *task, int64_t bytesSent, int64_t totalBytesSent, int64_t totalBytesExpectedToSend) {
    ABI48_0_0EX_ENSURE_STRONGIFY(self);
    [self sendEventWithName:ABI48_0_0EXUploadProgressEventName
                       body:@{
                             @"uuid": uuid,
                             @"data": @{
  ...
  ABI48_0_0EXSessionTaskDelegate *taskDelegate = [[ABI48_0_0EXSessionCancelableUploadTaskDelegate alloc] initWithResolve:resolve
                                                                                          reject:reject
                                              ...
                                              rejecter:(ABI48_0_0EXPromiseRejectBlock)reject
{
  ...
  if (type == ABI48_0_0EXFileSystemBinaryContent) {
    task = [session uploadTaskWithRequest:request fromFile:fileUri];
  } else if (type == ABI48_0_0EXFileSystemMultipart) {
...
ABI48_0_0EX_EXPORT_METHOD_AS(downloadResumableStartAsync,
                                              ...
                                              rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([self _permissionsForPath:path] & ABI48_0_0EXFileSystemPermissionWrite)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
...
ABI48_0_0EX_EXPORT_METHOD_AS(downloadResumablePauseAsync,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  ...
  [task cancelByProducingResumeData:^(NSData * _Nullable resumeData) {
    ABI48_0_0EX_ENSURE_STRONGIFY(self);
    resolve(@{ @"resumeData": ABI48_0_0EXNullIfNil([resumeData base64EncodedStringWithOptions:0]) });
  }];
}

ABI48_0_0EX_EXPORT_METHOD_AS(networkTaskCancelAsync,
...
ABI48_0_0EX_EXPORT_METHOD_AS(getFreeDiskStorageAsync, getFreeDiskStorageAsyncWithResolver:(ABI48_0_0EXPromiseResolveBlock)resolve rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  NSError *error = nil;
...
ABI48_0_0EX_EXPORT_METHOD_AS(getTotalDiskCapacityAsync, getTotalDiskCapacityAsyncWithResolver:(ABI48_0_0EXPromiseResolveBlock)resolve rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  NSError *error = nil;
...
- (ABI48_0_0EXFileSystemUploadType)_getUploadTypeFrom:(NSNumber * _Nullable)type
{
  switch ([type intValue]) {
    case ABI48_0_0EXFileSystemBinaryContent:
    case ABI48_0_0EXFileSystemMultipart:
      return [type intValue];
  }

  return ABI48_0_0EXFileSystemInvalidType;
}
...
- (NSURLSession *)_sessionForType:(ABI48_0_0EXFileSystemSessionType)type
{
  switch (type) {
    case ABI48_0_0EXFileSystemBackgroundSession:
      return _backgroundSession;
    case ABI48_0_0EXFileSystemForegroundSession:
...
- (NSURLSession *)_createSession:(ABI48_0_0EXFileSystemSessionType)type delegate:(id<NSURLSessionDelegate>)delegate
{
  NSURLSessionConfiguration *sessionConfiguration;
  if (type == ABI48_0_0EXFileSystemForegroundSession) {
...
{
  ABI48_0_0EX_WEAKIFY(self);
  ABI48_0_0EXDownloadDelegateOnWriteCallback onWrite = ^(NSURLSessionDownloadTask *task, int64_t bytesWritten, int64_t totalBytesWritten, int64_t totalBytesExpectedToWrite) {
    ABI48_0_0EX_ENSURE_STRONGIFY(self);
    [self sendEventWithName:ABI48_0_0EXDownloadProgressEventName
                       body:@{
                             @"uuid": uuid,
                             @"data": @{
  ...
  ABI48_0_0EXSessionTaskDelegate *taskDelegate = [[ABI48_0_0EXSessionResumableDownloadTaskDelegate alloc] initWithResolve:resolve
                                                                                                 reject:reject
                                                                                               localUrl:fileUrl
                                                                                     shouldCalculateMd5:[options[@"md5"] boolValue]
...
- (ABI48_0_0EXFileSystemPermissionFlags)_permissionsForPath:(NSString *)path
{
  return [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI48_0_0EXFilePermissionModuleInterface)] getPathPermissions:(NSString *)path];
}
...
{
  return [ABI48_0_0EXFileSystem ensureDirExistsWithPath:path];
}
...
{
  return [ABI48_0_0EXFileSystem generatePathInDirectory:directory withExtension:extension];
}

+ (NSString *)generatePathInDirectory:(NSString *)directory withExtension:(NSString *)extension
{
  NSString *fileName = [[[NSUUID UUID] UUIDString] stringByAppendingString:extension];
  [ABI48_0_0EXFileSystem ensureDirExistsWithPath:directory];
