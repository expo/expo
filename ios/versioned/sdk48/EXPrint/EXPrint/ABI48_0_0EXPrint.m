...
#import <ABI48_0_0EXPrint/ABI48_0_0EXPrint.h>
...
NSString *const ABI48_0_0EXPrintOrientationPortrait = @"portrait";
NSString *const ABI48_0_0EXPrintOrientationLandscape = @"landscape";

@interface ABI48_0_0EXPrint () <UIPrintInteractionControllerDelegate, UIPrinterPickerControllerDelegate>
...
@implementation ABI48_0_0EXPrint

ABI48_0_0EX_EXPORT_MODULE(ExponentPrint);
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"Orientation": @{
               @"portrait": ABI48_0_0EXPrintOrientationPortrait,
               @"landscape": ABI48_0_0EXPrintOrientationLandscape,
               },
           };
}

ABI48_0_0EX_EXPORT_METHOD_AS(print,
                    ...
                    rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
  [self _getPrintingDataForOptions:options callback:^(NSData *printingData, NSDictionary *errorDetails) {
    if (errorDetails != nil) {
      reject(errorDetails[@"code"], errorDetails[@"message"], ABI48_0_0EXErrorWithMessage(errorDetails[@"message"]));
      return;
    }
...
ABI48_0_0EX_EXPORT_METHOD_AS(selectPrinter,selectPrinter:(ABI48_0_0EXPromiseResolveBlock)resolve
                  rejecter:(ABI48_0_0EXPromiseRejectBlock)reject)
{
...
ABI48_0_0EX_EXPORT_METHOD_AS(printToFileAsync,
...
{
  __block ABI48_0_0EXWKPDFRenderer *renderTask;
  ...
  if ([options[@"useMarkupFormatter"] boolValue]) {
    ...
    renderTask = [ABI48_0_0EXWKPDFRenderer new];
...
{
  id<ABI48_0_0EXUtilitiesInterface> utils = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI48_0_0EXUtilitiesInterface)];
...
- (void)_getPrintingDataForOptions:(nonnull NSDictionary *)options callback:(void(^)(NSData *, NSDictionary *))callback
{
  ...
  if (options[@"html"] && ![options[@"useMarkupFormatter"] boolValue]) {
    __block ABI48_0_0EXWKPDFRenderer *renderTask = [ABI48_0_0EXWKPDFRenderer new];
...
{
  if ([orientation isEqualToString:ABI48_0_0EXPrintOrientationLandscape]) {
