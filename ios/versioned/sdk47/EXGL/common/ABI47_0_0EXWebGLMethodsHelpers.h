...
inline jsi::Value exglGetActiveInfo(
    ...
    jsi::Runtime &runtime,
    ABI47_0_0EXGLObjectId fProgram,
    GLuint index,
    GLenum lengthParam,
    Func glFunc) {
  if (fProgram == 0) {
...
inline jsi::Value
exglIsObject(ABI47_0_0EXGLContext *ctx, ABI47_0_0EXGLObjectId id, std::function<GLboolean(GLuint)> func) {
  GLboolean glResult;
...
inline jsi::Value exglGenObject(
    ABI47_0_0EXGLContext *ctx,
    jsi::Runtime &runtime,
    std::function<void(GLsizei, ABI47_0_0EXGLObjectId *)> func,
...
inline jsi::Value
exglDeleteObject(ABI47_0_0EXGLContext *ctx, ABI47_0_0EXGLObjectId id, std::function<void(ABI47_0_0EXGLObjectId)> func) {
...
inline jsi::Value exglDeleteObject(
    ABI47_0_0EXGLContext *ctx,
    ABI47_0_0EXGLObjectId id,
    std::function<void(GLsizei, const ABI47_0_0EXGLObjectId *)> func) {
  ctx->addToNextBatch([=] {
