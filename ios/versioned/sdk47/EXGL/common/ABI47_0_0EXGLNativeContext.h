...
#include "ABI47_0_0EXTypedArrayApi.h"
...
class ABI47_0_0EXGLContext {
 ...
 public:
  ABI47_0_0EXGLContext(ABI47_0_0EXGLContextId ctxId): ctxId(ctxId) {}
  ...
  ABI47_0_0EXGLObjectId createObject(void) noexcept;
  void destroyObject(ABI47_0_0EXGLObjectId exglObjId) noexcept;
  void mapObject(ABI47_0_0EXGLObjectId exglObjId, GLuint glObj) noexcept;
  GLuint lookupObject(ABI47_0_0EXGLObjectId exglObjId) noexcept;
 ...
 public:
  ABI47_0_0EXGLContextId ctxId;

  // Object mapping
  std::unordered_map<ABI47_0_0EXGLObjectId, GLuint> objects;
