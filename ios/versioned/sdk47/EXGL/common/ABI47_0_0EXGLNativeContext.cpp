...
ABI47_0_0EXGLObjectId ABI47_0_0EXGLContext::createObject(void) noexcept {
  return nextObjectId++;
}

void ABI47_0_0EXGLContext::destroyObject(ABI47_0_0EXGLObjectId exglObjId) noexcept {
  objects.erase(exglObjId);
}

void ABI47_0_0EXGLContext::mapObject(ABI47_0_0EXGLObjectId exglObjId, GLuint glObj) noexcept {
  objects[exglObjId] = glObj;
}

GLuint ABI47_0_0EXGLContext::lookupObject(ABI47_0_0EXGLObjectId exglObjId) noexcept {
