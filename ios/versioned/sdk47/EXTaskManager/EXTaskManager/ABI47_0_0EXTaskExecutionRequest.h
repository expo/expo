...
@interface ABI47_0_0EXTaskExecutionRequest : NSObject
...
- (void)addTask:(nonnull id<ABI47_0_0EXTaskInterface>)task;
- (void)task:(nonnull id<ABI47_0_0EXTaskInterface>)task didFinishWithResult:(id)result;
- (BOOL)isIncludingTask:(nullable id<ABI47_0_0EXTaskInterface>)task;
- (void)maybeEvaluate;
