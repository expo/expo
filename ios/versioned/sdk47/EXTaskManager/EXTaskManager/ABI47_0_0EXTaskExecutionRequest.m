...
@interface ABI47_0_0EXTaskExecutionRequest ()

@property (nonatomic, strong, nullable) NSMutableSet<id<ABI47_0_0EXTaskInterface>> *tasks;
...
@implementation ABI47_0_0EXTaskExecutionRequest
...
- (void)_maybeExecuteCallback
{
  if (_callback) {
    ...
    __strong ABI47_0_0EXTaskExecutionRequest *strongSelf = self;
