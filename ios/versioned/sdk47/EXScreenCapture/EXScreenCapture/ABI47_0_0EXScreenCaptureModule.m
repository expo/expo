...
@implementation ABI47_0_0EXScreenCaptureModule {
  UIView *_blockView;
}

ABI47_0_0EX_EXPORT_MODULE(ExpoScreenCapture);
...
ABI47_0_0EX_EXPORT_METHOD_AS(preventScreenCapture,
                    preventScreenCaptureWithResolver:(ABI47_0_0EXPromiseResolveBlock)resolve
...
ABI47_0_0EX_EXPORT_METHOD_AS(allowScreenCapture,
                    allowScreenCaptureWithResolver:(ABI47_0_0EXPromiseResolveBlock)resolve
