...
#import <ABI47_0_0EXPrint/ABI47_0_0EXWKViewPrintPDFRenderer.h>

@interface ABI47_0_0EXWKPDFRenderer () <WKNavigationDelegate>

@property (nonatomic, assign) CGSize pageSize;
@property (nonatomic, assign) UIEdgeInsets pageMargins;
@property (nonatomic, strong) WKWebView *webView;
@property (nonatomic, strong) id<ABI47_0_0EXPDFRenderer> renderer;
...
@implementation ABI47_0_0EXWKPDFRenderer
...
- (void)PDFWithHtml:(NSString *)htmlString pageSize:(CGSize)pageSize pageMargins:(UIEdgeInsets)pageMargins completionHandler:(void (^)(NSError * _Nullable, NSData * _Nullable, int))handler
{
  ...
  _renderer = [[ABI47_0_0EXWKViewPrintPDFRenderer alloc] initWithPageSize:pageSize pageMargins:pageMargins];
