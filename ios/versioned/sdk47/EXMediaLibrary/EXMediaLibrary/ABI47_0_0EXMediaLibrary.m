...
+ (PHAssetMediaType)assetTypeForFileExtension:(nonnull NSString *)fileExtension
{
  ...
  ABI47_0_0EXLogWarn(@"Asset media type is recognized from file extension and this behavior can differ on iOS Simulator and a physical device.");
...
+ (PHAssetMediaType)_assetTypeForUri:(nonnull NSString *)localUri
{
  ...
  if (fileUTI == nil){
    return [ABI47_0_0EXMediaLibrary assetTypeForFileExtension:[localUri pathExtension]];
  }
