...
#import <ABI47_0_0EXSplashScreen/ABI47_0_0EXSplashScreenViewNativeProvider.h>
#import <ABI47_0_0ExpoModulesCore/ABI47_0_0EXLogManager.h>

@implementation ABI47_0_0EXSplashScreenViewNativeProvider
...
- (nonnull UIView *)createSplashScreenView
{
  ...
  @try {
    ...
    ABI47_0_0EXLogWarn([NSString stringWithFormat:@"'%@.storyboard' file is missing. Fallbacking to '%@.xib' file.", splashScreenFilename, splashScreenFilename]);
  }
  if (storyboard) {
    @try {
  ...
  @try {
    ...
    ABI47_0_0EXLogWarn([NSString stringWithFormat:@"'%@.xib' file is missing - 'expo-splash-screen' will not work as expected.", splashScreenFilename]);
  }
  if (views) {
