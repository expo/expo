...
#import <ABI47_0_0EXContacts/ABI47_0_0EXContactsViewController.h>
@import Contacts;

@interface ABI47_0_0EXContactsViewController()

@property (nonatomic, copy) void (^onViewDisappeared)(void);

@end

@implementation ABI47_0_0EXContactsViewController
