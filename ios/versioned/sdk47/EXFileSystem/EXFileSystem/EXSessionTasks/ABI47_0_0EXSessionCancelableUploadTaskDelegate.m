...
#import <ABI47_0_0EXFileSystem/ABI47_0_0EXSessionCancelableUploadTaskDelegate.h>

@interface ABI47_0_0EXSessionCancelableUploadTaskDelegate ()

@property (strong, nonatomic, readonly) ABI47_0_0EXUploadDelegateOnSendCallback onSendCallback;
@property (weak, nonatomic) ABI47_0_0EXTaskHandlersManager *manager;
@property (strong, nonatomic) NSString *uuid;

@end

@implementation ABI47_0_0EXSessionCancelableUploadTaskDelegate
