...
@interface ABI47_0_0EXSessionTaskDelegate : NSObject

@property (nonatomic, strong, readonly) ABI47_0_0EXPromiseResolveBlock resolve;
@property (nonatomic, strong, readonly) ABI47_0_0EXPromiseRejectBlock reject;
