//
//  ABI47_0_0EXFaceDetectorManager.m
//  Exponent
//
...
@interface ABI47_0_0EXFaceDetectorManager() <AVCaptureVideoDataOutputSampleBufferDelegate>
...
@property ABI47_0_0EXFaceDetector *faceDetector;
@property NSInteger timeIntervalMillis;

@end

@implementation ABI47_0_0EXFaceDetectorManager

- (instancetype)init
{
  return [self initWithOptions:[ABI47_0_0EXFaceDetectorUtils defaultFaceDetectorOptions]];
}
...
- (instancetype)initWithOptions:(NSDictionary*)options
{
  if (self = [super init]) {
    ...
    _faceDetectorOptions = [ABI47_0_0EXFaceDetectorUtils mapOptions:options];
...
{
  MLKFaceDetectorOptions* newOptions = [ABI47_0_0EXFaceDetectorUtils newOptions:self.faceDetectorOptions withValues:settings];
  if(![ABI47_0_0EXFaceDetectorUtils areOptionsEqual:newOptions to:self.faceDetectorOptions])
  {
...
- (void)tryEnablingFaceDetection
{
  ...
  if ([self isDetectingFaceEnabled]) {
    @try {
      self.faceDetector = [[ABI47_0_0EXFaceDetector alloc] initWithOptions:_faceDetectorOptions];
      ...
      if([_session canAddOutput:output]) {
        ...
        ABI47_0_0EXLogError(@"Unable to add output to camera session! Face detection aborted!");
      }
    } @catch (NSException *exception) {
      ABI47_0_0EXLogWarn(@"%@", [exception description]);
    }
  }
...
- (void)_notifyOfFaces:(NSArray<MLKFace *> *)faces
           withEncoder:(ABI47_0_0EXFaceEncoder*)encoder
{
       ...
       fromConnection:(AVCaptureConnection *)connection
{
  ...
  if (timePassedMillis > self.timeIntervalMillis) {
    ...
    ABI47_0_0EXFaceDetectionAngleTransformBlock angleTransform = ^(float angle) { return -angle; };

    CGAffineTransform transformation = [ABI47_0_0EXCSBufferOrientationCalculator pointTransformForInterfaceOrientation:_interfaceOrientation
    ...
    UIImageOrientation orientation = [ABI47_0_0EXFaceDetectorManager imageOrientationFrom:_interfaceOrientation
                                                                     andMirrored:_mirroredImageSession];
    ...
    [_faceDetector detectFromBuffer:sampleBuffer
      ...
      if (error != nil) {
        ...
        [self _notifyOfFaces:faces
                 withEncoder:[[ABI47_0_0EXFaceEncoder alloc] initWithTransform:transformation
