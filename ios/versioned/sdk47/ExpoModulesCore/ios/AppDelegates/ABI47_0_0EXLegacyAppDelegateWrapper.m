...
@implementation ABI47_0_0EXLegacyAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitializedAndSorted {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI47_0_0EXSingletonModule*> * singletonModules = [[ABI47_0_0EXModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI47_0_0EXSingletonModule *singletonModule in singletonModules) {
