...
#import <ABI47_0_0ExpoModulesCore/ABI47_0_0ExpoViewComponentDescriptor.h>
...
/**
 ABI47_0_0React Native doesn't use the "on" prefix internally. Instead, it uses "top" but it's on the roadmap to get rid of it too.
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI47_0_0expo::ExpoViewProps>();
    _props = defaultProps;
...
+ (ABI47_0_0facebook::ABI47_0_0React::ComponentDescriptorProvider)componentDescriptorProvider
{
  ...
  return ComponentDescriptorProvider {
    ...
    componentName,
    flavor,
    &ABI47_0_0facebook::ABI47_0_0React::concreteComponentDescriptorConstructor<ABI47_0_0expo::ExpoViewComponentDescriptor>
  };
}
...
- (void)updateProps:(const ABI47_0_0facebook::ABI47_0_0React::Props::Shared &)props oldProps:(const ABI47_0_0facebook::ABI47_0_0React::Props::Shared &)oldProps
{
...
- (void)dispatchEvent:(nonnull NSString *)eventName payload:(nullable id)payload
{
  _eventEmitter->dispatch([normalizeEventName(eventName) UTF8String], [payload](jsi::Runtime &runtime) {
    return jsi::Value(runtime, ABI47_0_0expo::convertObjCObjectToJSIValue(runtime, payload));
  });
}
