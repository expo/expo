...
@interface ABI47_0_0EXModulesProxyConfig : NSObject
...
// ABI47_0_0RCTBridgeModule capable of receiving method calls from JS and forwarding them
...
@interface ABI47_0_0EXNativeModulesProxy : NSObject <ABI47_0_0RCTBridgeModule>

@property (nonatomic, strong, readonly) ABI47_0_0EXModulesProxyConfig *nativeModulesConfig;

- (nonnull instancetype)init;
- (nonnull instancetype)initWithModuleRegistry:(nullable ABI47_0_0EXModuleRegistry *)moduleRegistry;
- (nonnull instancetype)initWithCustomModuleRegistry:(nonnull ABI47_0_0EXModuleRegistry *)moduleRegistry;

- (void)callMethod:(NSString *)moduleName methodNameOrKey:(id)methodNameOrKey arguments:(NSArray *)arguments resolver:(ABI47_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI47_0_0RCTPromiseRejectBlock)reject;
