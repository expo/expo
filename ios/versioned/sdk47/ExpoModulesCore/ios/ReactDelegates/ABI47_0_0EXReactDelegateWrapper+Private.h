...
/**
 Internal `ABI47_0_0EXReactDelegateWrapper` interface for the designated initializer with `ExpoReactDelegate`.
 ...
 */
@interface ABI47_0_0EXReactDelegateWrapper(Private)
