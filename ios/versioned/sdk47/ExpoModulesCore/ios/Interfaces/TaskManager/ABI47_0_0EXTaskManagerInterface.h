...
// Interface for ABI47_0_0EXTaskManager module.

@protocol ABI47_0_0EXTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI47_0_0EXTaskConsumerInterface protocol.
 */
