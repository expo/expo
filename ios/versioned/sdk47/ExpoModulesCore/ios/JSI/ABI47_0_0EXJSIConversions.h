...
NSArray<ABI47_0_0EXJavaScriptValue *> *convertJSIValuesToNSArray(ABI47_0_0EXJavaScriptRuntime *runtime, const jsi::Value *values, size_t count);
...
ABI47_0_0RCTResponseSenderBlock convertJSIFunctionToCallback(jsi::Runtime &runtime, const jsi::Function &value, std::shared_ptr<CallInvoker> jsInvoker);
