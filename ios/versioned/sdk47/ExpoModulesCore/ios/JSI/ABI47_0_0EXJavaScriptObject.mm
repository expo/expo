...
@implementation ABI47_0_0EXJavaScriptObject {
  /**
  ...
  /**
   Shared pointer to the original JSI object that is being wrapped by `ABI47_0_0EXJavaScriptObject` class.
   */
...
- (nonnull ABI47_0_0EXJavaScriptValue *)getProperty:(nonnull NSString *)name
{
  std::shared_ptr<jsi::Value> value = std::make_shared<jsi::Value>(_jsObjectPtr->getProperty(*[_runtime get], [name UTF8String]));
  return [[ABI47_0_0EXJavaScriptValue alloc] initWithRuntime:_runtime value:value];
}
...
- (nonnull NSArray<NSString *> *)getPropertyNames
{
  ...
  return ABI47_0_0expo::convertJSIArrayToNSArray(*runtime, propertyNamesArray, nullptr);
}
...
{
  jsi::Value jsiValue = ABI47_0_0expo::convertObjCObjectToJSIValue(*[_runtime get], value);
  _jsObjectPtr->setProperty(*[_runtime get], [name UTF8String], jsiValue);
}

- (void)defineProperty:(nonnull NSString *)name descriptor:(nonnull ABI47_0_0EXJavaScriptObject *)descriptor
{
  jsi::Runtime *runtime = [_runtime get];
...
- (void)defineProperty:(nonnull NSString *)name value:(nullable id)value options:(ABI47_0_0EXJavaScriptObjectPropertyDescriptor)options
{
  jsi::Runtime *runtime = [_runtime get];
  jsi::Object global = runtime->global();
  jsi::Object objectClass = global.getPropertyAsObject(*runtime, "Object");
  ...
  descriptor.setProperty(*runtime, "value", ABI47_0_0expo::convertObjCObjectToJSIValue(*runtime, value));
...
- (nonnull ABI47_0_0EXJavaScriptWeakObject *)createWeak
{
  return [[ABI47_0_0EXJavaScriptWeakObject alloc] initWith:_jsObjectPtr runtime:_runtime];
}
...
{
  ABI47_0_0expo::setDeallocator(*[_runtime get], _jsObjectPtr, deallocatorBlock);
}
...
{
  if ([object isKindOfClass:ABI47_0_0EXJavaScriptObject.class]) {
    jsi::Runtime *runtime = [_runtime get];
...
- (jsi::Object)preparePropertyDescriptorWithOptions:(ABI47_0_0EXJavaScriptObjectPropertyDescriptor)options
{
  jsi::Runtime *runtime = [_runtime get];
  jsi::Object descriptor(*runtime);
  descriptor.setProperty(*runtime, "configurable", (bool)(options & ABI47_0_0EXJavaScriptObjectPropertyDescriptorConfigurable));
  descriptor.setProperty(*runtime, "enumerable", (bool)(options & ABI47_0_0EXJavaScriptObjectPropertyDescriptorEnumerable));
  descriptor.setProperty(*runtime, "writable", (bool)(options & ABI47_0_0EXJavaScriptObjectPropertyDescriptorWritable));
  return descriptor;
}
