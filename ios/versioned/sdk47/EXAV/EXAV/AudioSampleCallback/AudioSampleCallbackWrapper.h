...
#import <ABI47_0_0EXAV/CallbackWrapper.h>

namespace jsi = ABI47_0_0facebook::jsi;
using CallInvoker = ABI47_0_0facebook::ABI47_0_0React::CallInvoker;

// TODO: Replace this with just ABI47_0_0facebook::react namespace after we upgrade to RN 0.66
using JsiCallbackWrapper = ABI47_0_0expo::CallbackWrapper;
using LongLivedObjectCollection = ABI47_0_0expo::LongLivedObjectCollection;
