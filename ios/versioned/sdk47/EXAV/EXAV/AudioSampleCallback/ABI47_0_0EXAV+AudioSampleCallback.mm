...
#import <ABI47_0_0EXAV/ABI47_0_0EXAudioSampleCallback.h>
#import <ABI47_0_0EXAV/AudioSampleCallbackWrapper.h>

namespace jsi = ABI47_0_0facebook::jsi;
using CallInvoker = ABI47_0_0facebook::ABI47_0_0React::CallInvoker;
using namespace ABI47_0_0expo::av;
...
@implementation ABI47_0_0EXAV (AudioSampleCallback)
                 ...
                 withSoundDictionary:(NSMutableDictionary <NSNumber *, ABI47_0_0EXAVPlayerData *> *)soundDictionary
{
  ...
  auto setAudioSampleCallback = [weakCallInvoker, weakSoundDictionary](jsi::Runtime &runtime,
    ...
    if (argsCount > 1 && args[1].isObject()) {
      ...
      ABI47_0_0EXAudioSampleCallback* objcWrapper = [[ABI47_0_0EXAudioSampleCallback alloc] initWithCallbackWrapper:(std::move(wrapper))];
