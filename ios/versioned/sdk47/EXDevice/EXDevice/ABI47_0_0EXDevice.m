...
#import <ABI47_0_0EXDevice/ABI47_0_0EXDevice.h>
...
@interface ABI47_0_0EXDevice()

@end

@implementation ABI47_0_0EXDevice

ABI47_0_0EX_EXPORT_MODULE(ExpoDevice);
...
- (NSDictionary *)constantsToExport
{
  ...
  return @{
           ...
           @"brand": @"Apple",
           @"manufacturer": @"Apple",
           @"modelId": ABI47_0_0EXNullIfNil([[self class] modelId]),
           @"modelName": [[self class] modelName],
           @"deviceYearClass": [[self class] deviceYear],
           @"totalMemory": @(NSProcessInfo.processInfo.physicalMemory),
           @"supportedCpuArchitectures": ABI47_0_0EXNullIfNil([[self class] cpuArchitectures]),
...
ABI47_0_0EX_EXPORT_METHOD_AS(getDeviceTypeAsync,
                    getDeviceTypeAsyncWithResolver:(ABI47_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  resolve(@([[self class] deviceType]));
}

ABI47_0_0EX_EXPORT_METHOD_AS(getUptimeAsync,
                    getUptimeAsyncWithResolver:(ABI47_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
...
ABI47_0_0EX_EXPORT_METHOD_AS(isRootedExperimentalAsync,
                    isRootedExperimentalAsyncWithResolver:(ABI47_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
...
+ (ABI47_0_0EXDeviceType)deviceType
{
  switch (UIDevice.currentDevice.userInterfaceIdiom) {
    case UIUserInterfaceIdiomPhone:
      return ABI47_0_0EXDeviceTypePhone;
    case UIUserInterfaceIdiomPad:
      return ABI47_0_0EXDeviceTypeTablet;
    case UIUserInterfaceIdiomTV:
      return ABI47_0_0EXDeviceTypeTV;
    default:
      // NOTE: in the future for macOS, return Desktop
      return ABI47_0_0EXDeviceTypeUnknown;
  }
}
