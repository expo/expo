...
#import <ABI47_0_0EXNotifications/ABI47_0_0EXPushTokenModule.h>
...
@interface ABI47_0_0EXPushTokenModule ()

@property (nonatomic, weak) id<ABI47_0_0EXPushTokenManager> pushTokenManager;
...
@property (nonatomic, strong) ABI47_0_0EXPromiseResolveBlock getDevicePushTokenResolver;
@property (nonatomic, strong) ABI47_0_0EXPromiseRejectBlock getDevicePushTokenRejecter;

@end

@implementation ABI47_0_0EXPushTokenModule

ABI47_0_0EX_EXPORT_MODULE(ExpoPushTokenManager);

# pragma mark - Exported methods

ABI47_0_0EX_EXPORT_METHOD_AS(getDevicePushTokenAsync,
                    getDevicePushTokenResolving:(ABI47_0_0EXPromiseResolveBlock)resolve rejecting:(ABI47_0_0EXPromiseRejectBlock)reject)
{
...
ABI47_0_0EX_EXPORT_METHOD_AS(unregisterForNotificationsAsync,
        	    unregisterForNotificationsAsync:(ABI47_0_0EXPromiseResolveBlock)resolve reject:(ABI47_0_0EXPromiseRejectBlock)reject)
{
...
# pragma mark - ABI47_0_0EXPushTokenListener
