...
@interface ABI47_0_0EXNotificationsEmitter ()
...
@implementation ABI47_0_0EXNotificationsEmitter

ABI47_0_0EX_EXPORT_MODULE(ExpoNotificationsEmitter);

ABI47_0_0EX_EXPORT_METHOD_AS(getLastNotificationResponseAsync,
                    getLastNotificationResponseAsyncWithResolver:(ABI47_0_0EXPromiseResolveBlock)resolve reject:(ABI47_0_0EXPromiseRejectBlock)reject)
{
...
{
  // Silence ABI47_0_0React Native warning: "Sending ... with no listeners registered."
...
{
  return [ABI47_0_0EXNotificationSerializer serializedNotification:notification];
}

- (NSDictionary *)serializedNotificationResponse:(UNNotificationResponse *)notificationResponse
{
  return [ABI47_0_0EXNotificationSerializer serializedNotificationResponse:notificationResponse];
}
