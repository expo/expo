...
#define ABI47_0_0EX_UNVERSIONED(symbol) symbol

static NSString * const kEXDeviceInstallationUUIDKey = ABI47_0_0EX_UNVERSIONED(@"ABI47_0_0EXDeviceInstallationUUIDKey");
static NSString * const kEXDeviceInstallationUUIDLegacyKey = ABI47_0_0EX_UNVERSIONED(@"ABI47_0_0EXDeviceInstallUUIDKey");

static NSString * const kEXRegistrationInfoKey = ABI47_0_0EX_UNVERSIONED(@"ABI47_0_0EXNotificationRegistrationInfoKey");

@implementation ABI47_0_0EXServerRegistrationModule

ABI47_0_0EX_EXPORT_MODULE(NotificationsServerRegistrationModule)

ABI47_0_0EX_EXPORT_METHOD_AS(getInstallationIdAsync,
                    getInstallationIdAsyncWithResolver:(ABI47_0_0EXPromiseResolveBlock)resolve
...
ABI47_0_0EX_EXPORT_METHOD_AS(getRegistrationInfoAsync,
                    getRegistrationInfoAsyncWithResolver:(ABI47_0_0EXPromiseResolveBlock)resolve
                                                rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  CFTypeRef keychainResult = NULL;
...
ABI47_0_0EX_EXPORT_METHOD_AS(setRegistrationInfoAsync,
