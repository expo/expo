...
@implementation ABI47_0_0EXForegroundPermissionRequester
...
{
  if ([ABI47_0_0EXBaseLocationRequester isConfiguredForWhenInUseAuthorization] && [self.locationManager  respondsToSelector:whenInUseAuthorizationSelector]) {
