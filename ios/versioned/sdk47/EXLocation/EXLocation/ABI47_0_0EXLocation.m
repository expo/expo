...
#import <ABI47_0_0EXLocation/ABI47_0_0EXLocationDelegate.h>
...
#import <ABI47_0_0EXLocation/ABI47_0_0EXForegroundPermissionRequester.h>
...
NSString * const ABI47_0_0EXLocationChangedEventName = @"Expo.locationChanged";
NSString * const ABI47_0_0EXHeadingChangedEventName = @"Expo.headingChanged";

@interface ABI47_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI47_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) NSMutableSet<ABI47_0_0EXLocationDelegate *> *retainedDelegates;
...
@property (nonatomic, weak) id<ABI47_0_0EXTaskManagerInterface> tasksManager;

@end

@implementation ABI47_0_0EXLocation

ABI47_0_0EX_EXPORT_MODULE(ExpoLocation);
...
- (void)setModuleRegistry:(ABI47_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  _tasksManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI47_0_0EXTaskManagerInterface)];
  ...
  [ABI47_0_0EXPermissionsMethodsDelegate registerRequesters:@[
    [ABI47_0_0EXLocationPermissionRequester new],
    [ABI47_0_0EXForegroundPermissionRequester new],
    [ABI47_0_0EXBackgroundLocationPermissionRequester new]
...
{
  return @[ABI47_0_0EXLocationChangedEventName, ABI47_0_0EXHeadingChangedEventName];
}
...
ABI47_0_0EX_EXPORT_METHOD_AS(getProviderStatusAsync,
...
ABI47_0_0EX_EXPORT_METHOD_AS(getCurrentPositionAsync,
                    ...
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  __block ABI47_0_0EXLocationDelegate *delegate;

  delegate = [[ABI47_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (delegate != nil) {
      if (locations.lastObject != nil) {
        resolve([ABI47_0_0EXLocation exportLocation:locations.lastObject]);
      } else {
...
ABI47_0_0EX_EXPORT_METHOD_AS(watchPositionImplAsync,
                    ...
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  ABI47_0_0EXLocationDelegate *delegate = [[ABI47_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject != nil && weakSelf != nil) {
      ...
      NSDictionary *body = @{
                             @"watchId": watchId,
                             @"location": [ABI47_0_0EXLocation exportLocation:loc],
                             };

      [strongSelf->_eventEmitter sendEventWithName:ABI47_0_0EXLocationChangedEventName body:body];
    }
  } onUpdateHeadings:nil onError:^(NSError *error) {
    // TODO: report errors
...
ABI47_0_0EX_EXPORT_METHOD_AS(getLastKnownPositionAsync,
                    ...
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  if ([self.class isLocation:location validWithOptions:options]) {
    resolve([ABI47_0_0EXLocation exportLocation:location]);
  } else {
    resolve([NSNull null]);
  }
}
...
ABI47_0_0EX_EXPORT_METHOD_AS(watchDeviceHeading,
  ...
  ABI47_0_0EXLocationDelegate *delegate = [[ABI47_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
    if (newHeading != nil && weakSelf != nil) {
      ...
      [strongSelf->_eventEmitter sendEventWithName:ABI47_0_0EXHeadingChangedEventName body:body];
    }
...
ABI47_0_0EX_EXPORT_METHOD_AS(removeWatchAsync,
                    watchId:(nonnull NSNumber *)watchId
                    resolver:(ABI47_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ABI47_0_0EXLocationDelegate *delegate = _delegates[watchId];
...
ABI47_0_0EX_EXPORT_METHOD_AS(geocodeAsync,
...
ABI47_0_0EX_EXPORT_METHOD_AS(reverseGeocodeAsync,
    ...
    if (!error) {
      ...
      for (CLPlacemark* placemark in placemarks) {
        NSDictionary *address = @{
                                  @"city": ABI47_0_0UMNullIfNil(placemark.locality),
                                  @"district": ABI47_0_0UMNullIfNil(placemark.subLocality),
                                  @"streetNumber": ABI47_0_0UMNullIfNil(placemark.subThoroughfare),
                                  @"street": ABI47_0_0EXNullIfNil(placemark.thoroughfare),
                                  @"region": ABI47_0_0EXNullIfNil(placemark.administrativeArea),
                                  @"subregion": ABI47_0_0EXNullIfNil(placemark.subAdministrativeArea),
                                  @"country": ABI47_0_0EXNullIfNil(placemark.country),
                                  @"postalCode": ABI47_0_0EXNullIfNil(placemark.postalCode),
                                  @"name": ABI47_0_0EXNullIfNil(placemark.name),
                                  @"isoCountryCode": ABI47_0_0EXNullIfNil(placemark.ISOcountryCode),
                                  @"timezone": ABI47_0_0EXNullIfNil(placemark.timeZone.name),
                                  };
                    ...
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  [ABI47_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI47_0_0EXLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
...
ABI47_0_0EX_EXPORT_METHOD_AS(getForegroundPermissionsAsync,
                    getForegroundPermissionsAsync:(ABI47_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  [ABI47_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI47_0_0EXForegroundPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI47_0_0EX_EXPORT_METHOD_AS(requestForegroundPermissionsAsync,
                    requestForegroundPermissionsAsync:(ABI47_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  [ABI47_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI47_0_0EXForegroundPermissionRequester class]
...
ABI47_0_0EX_EXPORT_METHOD_AS(getBackgroundPermissionsAsync,
                    getBackgroundPermissionsAsync:(ABI47_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  [ABI47_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI47_0_0EXBackgroundLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI47_0_0EX_EXPORT_METHOD_AS(requestBackgroundPermissionsAsync,
                    requestBackgroundPermissionsAsync:(ABI47_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  [ABI47_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI47_0_0EXBackgroundLocationPermissionRequester class]
...
ABI47_0_0EX_EXPORT_METHOD_AS(hasServicesEnabledAsync,
                    hasServicesEnabled:(ABI47_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI47_0_0EXPromiseRejectBlock)reject)
{
...
ABI47_0_0EX_EXPORT_METHOD_AS(startLocationUpdatesAsync,
                    ...
                    reject:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI47_0_0EXLocationTaskConsumer class] options:options];
  }
  @catch (NSException *e) {
...
ABI47_0_0EX_EXPORT_METHOD_AS(stopLocationUpdatesAsync,
                    ...
                    reject:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI47_0_0EXLocationTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI47_0_0EX_EXPORT_METHOD_AS(hasStartedLocationUpdatesAsync,
                    ...
                    reject:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI47_0_0EXLocationTaskConsumer class]]));
}

# pragma mark - Geofencing

ABI47_0_0EX_EXPORT_METHOD_AS(startGeofencingAsync,
                    ...
                    reject:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI47_0_0EXGeofencingTaskConsumer class] options:options];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI47_0_0EX_EXPORT_METHOD_AS(stopGeofencingAsync,
                    ...
                    reject:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI47_0_0EXGeofencingTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI47_0_0EX_EXPORT_METHOD_AS(hasStartedGeofencingAsync,
                    ...
                    reject:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI47_0_0EXGeofencingTaskConsumer class]]));
}
...
- (BOOL)checkForegroundPermissions:(ABI47_0_0EXPromiseRejectBlock)reject
{
  if (![CLLocationManager locationServicesEnabled]) {
    reject(@"E_LOCATION_SERVICES_DISABLED", @"Location services are disabled", nil);
    return NO;
  }
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI47_0_0EXForegroundPermissionRequester class]]) {
...
- (BOOL)checkBackgroundPermissions:(ABI47_0_0EXPromiseRejectBlock)reject
{
  if (![CLLocationManager locationServicesEnabled]) {
    reject(@"E_LOCATION_SERVICES_DISABLED", @"Location services are disabled", nil);
    return NO;
  }
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI47_0_0EXBackgroundLocationPermissionRequester class]]) {
...
- (BOOL)checkTaskManagerExists:(ABI47_0_0EXPromiseRejectBlock)reject
{
...
- (BOOL)checkBackgroundServices:(ABI47_0_0EXPromiseRejectBlock)reject
{
...
{
  switch (accuracy) {
    case ABI47_0_0EXLocationAccuracyLowest:
      return kCLLocationAccuracyThreeKilometers;
    case ABI47_0_0EXLocationAccuracyLow:
      return kCLLocationAccuracyKilometer;
    case ABI47_0_0EXLocationAccuracyBalanced:
      return kCLLocationAccuracyHundredMeters;
    case ABI47_0_0EXLocationAccuracyHigh:
      return kCLLocationAccuracyNearestTenMeters;
    case ABI47_0_0EXLocationAccuracyHighest:
      return kCLLocationAccuracyBest;
    case ABI47_0_0EXLocationAccuracyBestForNavigation:
