...
#import <ABI47_0_0EXSensors/ABI47_0_0EXPedometer.h>
...
NSString * const ABI47_0_0EXPedometerUpdateEventName = @"Exponent.pedometerUpdate";
NSString * const ABI47_0_0EXPedometerModuleName = @"ExponentPedometer";

@interface ABI47_0_0EXPedometer () <ABI47_0_0EXAppLifecycleListener>
...
@implementation ABI47_0_0EXPedometer
...
{
  if (self = [super init]) {
    __weak ABI47_0_0EXPedometer *weakSelf = self;
    _watchHandler = ^(CMPedometerData * _Nullable pedometerData, NSError * _Nullable error) {
      ...
      __strong ABI47_0_0EXPedometer *strongSelf = weakSelf;
      if (strongSelf) {
        __strong id<ABI47_0_0EXEventEmitterService> eventEmitter = strongSelf.eventEmitter;
        if (eventEmitter) {
          [eventEmitter sendEventWithName:ABI47_0_0EXPedometerUpdateEventName
...
- (void)setModuleRegistry:(ABI47_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  [ABI47_0_0EXPermissionsMethodsDelegate registerRequesters:@[[ABI47_0_0EXMotionPermissionRequester new]] withPermissionsManager:_permissionsManager];
...
{
  return ABI47_0_0EXPedometerModuleName;
}
...
{
  return @[ABI47_0_0EXPedometerUpdateEventName];
}
...
ABI47_0_0EX_EXPORT_METHOD_AS(getStepCountAsync,
                    ...
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  [ABI47_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI47_0_0EXMotionPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
