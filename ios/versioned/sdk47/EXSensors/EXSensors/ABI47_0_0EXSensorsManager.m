...
#import <ABI47_0_0EXSensors/ABI47_0_0EXSensorsManager.h>

@interface ABI47_0_0EXSensorsManager ()
...
@implementation ABI47_0_0EXSensorsManager

ABI47_0_0EX_REGISTER_MODULE();

+ (const NSArray<Protocol *> *)exportedInterfaces
{
  return @[@protocol(ABI47_0_0EXAccelerometerInterface), @protocol(ABI47_0_0EXBarometerInterface), @protocol(ABI47_0_0EXDeviceMotionInterface), @protocol(ABI47_0_0EXGyroscopeInterface), @protocol(ABI47_0_0EXMagnetometerInterface), @protocol(ABI47_0_0EXMagnetometerUncalibratedInterface)];
}
                                            ...
                                            withHandler:(void (^)(NSDictionary *event))handlerBlock
{
  ...
  if (![[self manager] isAccelerometerActive]) {
    ...
    __weak ABI47_0_0EXSensorsManager *weakSelf = self;
    [[self manager] startAccelerometerUpdatesToQueue:[NSOperationQueue mainQueue] withHandler:^(CMAccelerometerData *data, NSError *error) {
      __strong ABI47_0_0EXSensorsManager *strongSelf = weakSelf;
      if (strongSelf) {
  ...
  [[self manager] startDeviceMotionUpdatesUsingReferenceFrame:CMAttitudeReferenceFrameXArbitraryCorrectedZVertical toQueue:[NSOperationQueue mainQueue] withHandler:^(CMDeviceMotion *data, NSError *error) {
    ...
    NSMutableDictionary *result = [NSMutableDictionary dictionaryWithDictionary:@{
                             ...
                             @"accelerationIncludingGravity": @{
                                 @"x": @((data.userAcceleration.x + data.gravity.x) * ABI47_0_0EXGravity),
                                 @"y": @((data.userAcceleration.y + data.gravity.y) * ABI47_0_0EXGravity),
                                 @"z": @((data.userAcceleration.z + data.gravity.z) * ABI47_0_0EXGravity)
                                 },
                             @"rotation": @{
    ...
    if ([[strongSelf manager] isGyroAvailable]) {
      result[@"acceleration"] = @{
        @"x": @(data.userAcceleration.x * ABI47_0_0EXGravity),
        @"y": @(data.userAcceleration.y * ABI47_0_0EXGravity),
        @"z": @(data.userAcceleration.z * ABI47_0_0EXGravity)
      };
