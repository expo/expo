...
#import <ABI47_0_0EXCalendar/ABI47_0_0EXCalendar.h>
#import <ABI47_0_0EXCalendar/ABI47_0_0EXCalendarConverter.h>
...
@implementation ABI47_0_0EXCalendar
...
ABI47_0_0EX_EXPORT_MODULE(ExpoCalendar);
...
- (void)setModuleRegistry:(ABI47_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  [ABI47_0_0EXPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI47_0_0EXCalendarPermissionRequester new],
                                                    [ABI47_0_0EXRemindersPermissionRequester new]
                                                    ]
...
ABI47_0_0EX_EXPORT_METHOD_AS(getCalendarsAsync,
                    ...
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve([ABI47_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI47_0_0EX_EXPORT_METHOD_AS(getDefaultCalendarAsync,
                    getDefaultCalendarAsync:(ABI47_0_0EXPromiseResolveBlock)resolve
                    rejector:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  if (![self _checkCalendarPermissions:reject]) {
    return;
  }
  ...
  resolve([ABI47_0_0EXCalendarConverter serializeCalendar:defaultCalendar]);
}

ABI47_0_0EX_EXPORT_METHOD_AS(saveCalendarAsync,
                    ...
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (color) {
    calendar.CGColor = [ABI47_0_0EXUtilities UIColor:color].CGColor;
...
ABI47_0_0EX_EXPORT_METHOD_AS(deleteCalendarAsync,
...
ABI47_0_0EX_EXPORT_METHOD_AS(getEventsAsync,
                    ...
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI47_0_0EXUtilities NSDate:startDateStr];
  NSDate *endDate = [ABI47_0_0EXUtilities NSDate:endDateStr];
  ...
  if (calendarEvents) {
    resolve([ABI47_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI47_0_0EX_EXPORT_METHOD_AS(getEventByIdAsync,
                    ...
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (calendarEvent) {
    resolve([ABI47_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI47_0_0EX_EXPORT_METHOD_AS(saveEventAsync,
                    ...
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI47_0_0EXUtilities NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI47_0_0EXUtilities NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI47_0_0EXUtilities NSDate:details[@"instanceStartDate"]];
...
ABI47_0_0EX_EXPORT_METHOD_AS(deleteEventAsync,
                    ...
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *instanceStartDate = [ABI47_0_0EXUtilities NSDate:event[@"instanceStartDate"]];
...
ABI47_0_0EX_EXPORT_METHOD_AS(getAttendeesForEventAsync,
                    ...
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (item.hasAttendees) {
    resolve([ABI47_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI47_0_0EX_EXPORT_METHOD_AS(getRemindersAsync,
                    ...
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI47_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI47_0_0EX_EXPORT_METHOD_AS(getReminderByIdAsync,
                    ...
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (reminder) {
    ...
    resolve([ABI47_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI47_0_0EX_EXPORT_METHOD_AS(saveReminderAsync,
                    ...
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI47_0_0EXUtilities NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI47_0_0EXUtilities NSDate:details[@"dueDate"]];
  NSDate *completionDate = [ABI47_0_0EXUtilities NSDate:details[@"completionDate"]];
...
ABI47_0_0EX_EXPORT_METHOD_AS(deleteReminderAsync,
...
ABI47_0_0EX_EXPORT_METHOD_AS(getSourcesAsync,
                    getSourcesAsync:(ABI47_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI47_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI47_0_0EX_EXPORT_METHOD_AS(getSourceByIdAsync,
                    ...
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve([ABI47_0_0EXCalendarConverter serializeSource:source]);
}

ABI47_0_0EX_EXPORT_METHOD_AS(getCalendarPermissionsAsync,
                    getCalendarPermissionsAsync:(ABI47_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  [ABI47_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI47_0_0EXCalendarPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI47_0_0EX_EXPORT_METHOD_AS(requestCalendarPermissionsAsync,
                    requestCalendarPermissionsAsync:(ABI47_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
...
ABI47_0_0EX_EXPORT_METHOD_AS(getRemindersPermissionsAsync,
                    getRemindersPermissionsAsync:(ABI47_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  [ABI47_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI47_0_0EXRemindersPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI47_0_0EX_EXPORT_METHOD_AS(requestRemindersPermissionsAsync,
                    requestRemindersPermissionsAsync:(ABI47_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI47_0_0EXPromiseRejectBlock)reject)
{
  [ABI47_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI47_0_0EXRemindersPermissionRequester class]
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI47_0_0EXUtilities NSDate:alarm[@"absoluteDate"]];
...
- (EKRecurrenceRule *)_createRecurrenceRule:(NSDictionary *)recurrenceRule
{
  ...
  if (recurrenceRule[@"endDate"]) {
      endDate = [ABI47_0_0EXUtilities NSDate:recurrenceRule[@"endDate"]];
  }
...
- (BOOL)_checkPermissions:(EKEntityType)entity reject:(ABI47_0_0EXPromiseRejectBlock)reject
{
  ...
  switch (entity) {
    case EKEntityTypeEvent:
      requesterClass = [ABI47_0_0EXCalendarPermissionRequester class];
      break;
    case EKEntityTypeReminder:
      requesterClass = [ABI47_0_0EXRemindersPermissionRequester class];
      break;
    default: {
...
- (BOOL)_checkCalendarPermissions:(ABI47_0_0EXPromiseRejectBlock)reject
{
  return [self _checkPermissions:EKEntityTypeEvent reject:reject];
}

- (BOOL)_checkRemindersPermissions:(ABI47_0_0EXPromiseRejectBlock)reject
{
...
- (void)_initializePermittedEntities
{
  ...
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI47_0_0EXCalendarPermissionRequester class]]) {
    permittedEntities |= EKEntityMaskEvent;
  }
  
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI47_0_0EXRemindersPermissionRequester class]]) {
