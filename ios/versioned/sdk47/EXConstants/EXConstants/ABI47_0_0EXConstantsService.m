...
#import <ABI47_0_0EXConstants/ABI47_0_0EXConstantsInstallationIdProvider.h>

NSString * const ABI47_0_0EXConstantsExecutionEnvironmentBare = @"bare";
NSString * const ABI47_0_0EXConstantsExecutionEnvironmentStandalone = @"standalone";
NSString * const ABI47_0_0EXConstantsExecutionEnvironmentStoreClient = @"storeClient";

@interface ABI47_0_0EXConstantsService ()

@property (nonatomic, strong) NSString *sessionId;
@property (nonatomic, strong) ABI47_0_0EXConstantsInstallationIdProvider *installationIdProvider;

@end

@implementation ABI47_0_0EXConstantsService

- (instancetype)init
{
  return [self initWithInstallationIdProvider:[[ABI47_0_0EXConstantsInstallationIdProvider alloc] init]];
}

- (instancetype)initWithInstallationIdProvider:(ABI47_0_0EXConstantsInstallationIdProvider *)installationIdProvider
{
  if (self = [super init]) {
...
{
  return @[@protocol(ABI47_0_0EXConstantsInterface)];
}
...
- (NSDictionary *)constants
{
  ...
  return @{
           ...
           @"executionEnvironment": ABI47_0_0EXConstantsExecutionEnvironmentBare,
           ...
           @"manifest": ABI47_0_0EXNullIfNil([[self class] appConfig]),
           @"platform": @{
               @"ios": @{
                   @"buildNumber": [self buildVersion],
                   @"platform": [[self class] devicePlatform],
                   @"model": ABI47_0_0EXNullIfNil([[self class] deviceModel]),
...
{
  NSBundle *frameworkBundle = [NSBundle bundleForClass:[ABI47_0_0EXConstantsService class]];
  NSURL *bundleUrl = [frameworkBundle.resourceURL URLByAppendingPathComponent:@"ABI47_0_0EXConstants.bundle"];
