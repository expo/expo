...
@objc public enum ABI47_0_0EXUpdatesCodeSigningError : Int, Error {
...
@objc public class ABI47_0_0EXUpdatesCodeSigningErrorUtils : NSObject {
  @objc public static func message(forError: ABI47_0_0EXUpdatesCodeSigningError) -> String {
    switch forError {
    case .CertificateEncodingError:
