 ...
 */
@objc(ABI47_0_0EXUpdatesLogger)
public class UpdatesLogger: NSObject {
  public static let ABI47_0_0EXPO_UPDATES_LOG_CATEGORY = "expo-updates"

  private let logger = Logger(category: UpdatesLogger.ABI47_0_0EXPO_UPDATES_LOG_CATEGORY, options: [.logToOS, .logToFile])
