...
#import <ABI47_0_0EXUpdates/ABI47_0_0EXUpdatesBuildData+Tests.h>
 ...
 *
 *   ABI47_0_0EXUpdatesReleaseChannel
 *   ABI47_0_0EXUpdatesURL
 *
 * and all of the values in json
 *
 *   ABI47_0_0EXUpdatesRequestHeaders
 */
@implementation ABI47_0_0EXUpdatesBuildData

+ (void)ensureBuildDataIsConsistentAsync:(ABI47_0_0EXUpdatesDatabase *)database
...
{
  return @{
    @"ABI47_0_0EXUpdatesURL": config.updateUrl.absoluteString,
    @"ABI47_0_0EXUpdatesReleaseChannel": config.releaseChannel,
    @"ABI47_0_0EXUpdatesRequestHeaders": config.requestHeaders,
  };
}

+ (void)clearAllUpdatesAndSetStaticBuildData:(ABI47_0_0EXUpdatesDatabase *)database
                             config:(ABI47_0_0EXUpdatesConfig *)config
{
  NSError *queryError;
  NSArray<ABI47_0_0EXUpdatesUpdate *> *allUpdates = [database allUpdatesWithConfig:config error:&queryError];
  if (queryError) {
