...
static NSString * const ABI47_0_0EXUpdatesDatabaseUtilsErrorDomain = @"ABI47_0_0EXUpdatesDatabase";

/**
 * Utility class with methods for common database functions used across multiple classes.
 */
@implementation ABI47_0_0EXUpdatesDatabaseUtils
...
+ (NSError *)errorFromSqlite:(struct sqlite3 *)db
{
  ...
  return [NSError errorWithDomain:ABI47_0_0EXUpdatesDatabaseUtilsErrorDomain
                             code:extendedCode
