...
static NSString * const ABI47_0_0EXUpdatesDatabaseV6Filename = @"expo-v6.db";

@implementation ABI47_0_0EXUpdatesDatabaseMigration6To7

- (NSString *)filename
{
  return ABI47_0_0EXUpdatesDatabaseV6Filename;
}
