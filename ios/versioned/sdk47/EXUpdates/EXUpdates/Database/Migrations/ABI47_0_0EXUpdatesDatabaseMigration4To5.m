...
static NSString * const ABI47_0_0EXUpdatesDatabaseV4Filename = @"expo-v4.db";

@implementation ABI47_0_0EXUpdatesDatabaseMigration4To5

- (NSString *)filename
{
  return ABI47_0_0EXUpdatesDatabaseV4Filename;
}
