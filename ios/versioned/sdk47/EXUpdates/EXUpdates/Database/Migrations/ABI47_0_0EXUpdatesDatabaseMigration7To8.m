...
static NSString * const ABI47_0_0EXUpdatesDatabaseV7Filename = @"expo-v7.db";

@implementation ABI47_0_0EXUpdatesDatabaseMigration7To8

- (NSString *)filename
{
  return ABI47_0_0EXUpdatesDatabaseV7Filename;
}
