...
typedef void (^ABI47_0_0EXUpdatesAppLauncherCompletionBlock)(NSError * _Nullable error, BOOL success);
 ...
 */
@protocol ABI47_0_0EXUpdatesAppLauncher

@property (nullable, nonatomic, strong, readonly) ABI47_0_0EXUpdatesUpdate *launchedUpdate;
