...
#import <ABI47_0_0EXUpdates/ABI47_0_0EXUpdatesLoaderSelectionPolicy.h>
 ...
 * implementation of ABI47_0_0EXUpdatesReaperSelectionPolicy.
 *
 ...
 */
@interface ABI47_0_0EXUpdatesSelectionPolicy : NSObject

@property (nonatomic, strong, readonly) id<ABI47_0_0EXUpdatesLauncherSelectionPolicy> launcherSelectionPolicy;
@property (nonatomic, strong, readonly) id<ABI47_0_0EXUpdatesLoaderSelectionPolicy> loaderSelectionPolicy;
@property (nonatomic, strong, readonly) id<ABI47_0_0EXUpdatesReaperSelectionPolicy> reaperSelectionPolicy;
