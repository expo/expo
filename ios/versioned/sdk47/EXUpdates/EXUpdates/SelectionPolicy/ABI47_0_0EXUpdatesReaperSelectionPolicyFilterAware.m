...
@implementation ABI47_0_0EXUpdatesReaperSelectionPolicyFilterAware
...
- (NSArray<ABI47_0_0EXUpdatesUpdate *> *)updatesToDeleteWithLaunchedUpdate:(ABI47_0_0EXUpdatesUpdate *)launchedUpdate updates:(NSArray<ABI47_0_0EXUpdatesUpdate *> *)updates filters:(nullable NSDictionary *)filters
{
  ...
  ABI47_0_0EXUpdatesUpdate *nextNewestUpdate;
  ABI47_0_0EXUpdatesUpdate *nextNewestUpdateMatchingFilters;
  for (ABI47_0_0EXUpdatesUpdate *update in updates) {
    ...
    if ([launchedUpdate.commitTime compare:update.commitTime] == NSOrderedDescending) {
      ...
      if ([ABI47_0_0EXUpdatesSelectionPolicies doesUpdate:update matchFilters:filters] &&
