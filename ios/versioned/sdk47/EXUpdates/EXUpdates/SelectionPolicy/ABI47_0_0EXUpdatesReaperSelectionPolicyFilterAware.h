...
/**
 * An ABI47_0_0EXUpdatesReaperSelectionPolicy which chooses which updates to delete taking into account manifest filters
 ...
 */
@interface ABI47_0_0EXUpdatesReaperSelectionPolicyFilterAware : NSObject <ABI47_0_0EXUpdatesReaperSelectionPolicy>
