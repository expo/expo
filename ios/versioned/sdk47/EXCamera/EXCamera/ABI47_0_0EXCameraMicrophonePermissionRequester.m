...
#import <ABI47_0_0EXCamera/ABI47_0_0EXCameraMicrophonePermissionRequester.h>
...
@implementation ABI47_0_0EXCameraMicrophonePermissionRequester
...
- (NSDictionary *)getPermissions
{
  ...
  if (!microphoneUsageDescription) {
    ABI47_0_0EXFatal(ABI47_0_0EXErrorWithMessage(@"This app is missing NSMicrophoneUsageDescription, so audio services will fail. Add this entry to your bundle's Info.plist."));
