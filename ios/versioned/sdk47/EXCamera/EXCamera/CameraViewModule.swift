...
public final class CameraViewModule: Module {
  public func definition() -> ModuleDefinition {
    ...
    OnCreate {
      ...
      ABI47_0_0EXPermissionsMethodsDelegate.register(
        [ABI47_0_0EXCameraPermissionRequester(), ABI47_0_0EXCameraCameraPermissionRequester(), ABI47_0_0EXCameraMicrophonePermissionRequester()],
    ...
    Constants([
      "Type": [
        "front": ABI47_0_0EXCameraType.front.rawValue,
        "back": ABI47_0_0EXCameraType.back.rawValue
      ],
      "FlashMode": [
        "off": ABI47_0_0EXCameraFlashMode.off.rawValue,
        "on": ABI47_0_0EXCameraFlashMode.on.rawValue,
        "auto": ABI47_0_0EXCameraFlashMode.auto.rawValue,
        "torch": ABI47_0_0EXCameraFlashMode.torch.rawValue
      ],
      "AutoFocus": [
        "on": ABI47_0_0EXCameraAutoFocus.on.rawValue,
        "off": ABI47_0_0EXCameraAutoFocus.off.rawValue
      ],
      "WhiteBalance": [
        "auto": ABI47_0_0EXCameraWhiteBalance.auto.rawValue,
        "sunny": ABI47_0_0EXCameraWhiteBalance.sunny.rawValue,
        "cloudy": ABI47_0_0EXCameraWhiteBalance.cloudy.rawValue,
        "shadow": ABI47_0_0EXCameraWhiteBalance.shadow.rawValue,
        "incandescent": ABI47_0_0EXCameraWhiteBalance.incandescent.rawValue,
        "fluorescent": ABI47_0_0EXCameraWhiteBalance.fluorescent.rawValue
      ],
      "VideoQuality": [
        "2160p": ABI47_0_0EXCameraVideoResolution.video2160p.rawValue,
        "1080p": ABI47_0_0EXCameraVideoResolution.video1080p.rawValue,
        "720p": ABI47_0_0EXCameraVideoResolution.video720p.rawValue,
        "480p": ABI47_0_0EXCameraVideoResolution.video4x3.rawValue,
        "4:3": ABI47_0_0EXCameraVideoResolution.video4x3.rawValue
      ],
      "VideoStabilization": [
        "off": ABI47_0_0EXCameraVideoStabilizationMode.videoStabilizationModeOff.rawValue,
        "standard": ABI47_0_0EXCameraVideoStabilizationMode.videoStabilizationModeStandard.rawValue,
        "cinematic": ABI47_0_0EXCameraVideoStabilizationMode.videoStabilizationModeCinematic.rawValue,
        "auto": ABI47_0_0EXCameraVideoStabilizationMode.avCaptureVideoStabilizationModeAuto.rawValue
      ],
      "VideoCodec": [
        "H264": ABI47_0_0EXCameraVideoCodec.H264.rawValue,
        "HEVC": ABI47_0_0EXCameraVideoCodec.HEVC.rawValue,
        "JPEG": ABI47_0_0EXCameraVideoCodec.JPEG.rawValue,
        "AppleProRes422": ABI47_0_0EXCameraVideoCodec.appleProRes422.rawValue,
        "AppleProRes4444": ABI47_0_0EXCameraVideoCodec.appleProRes4444.rawValue
      ]
    ])

    View(ABI47_0_0EXCamera.self) {
      Events(
        "onCameraReady",
        "onMountError",
        "onPictureSaved",
      ...
      Prop("flashMode") { (view, flashMode: Int) in
        if let flashMode = ABI47_0_0EXCameraFlashMode(rawValue: flashMode), view.flashMode != flashMode {
    ...
    AsyncFunction("takePicture") { (options: TakePictureOptions, viewTag: Int, promise: Promise) in
      guard let view = self.appContext?.findView(withTag: viewTag, ofType: ABI47_0_0EXCamera.self) else {
        throw Exceptions.ViewNotFound((tag: viewTag, type: ABI47_0_0EXCamera.self))
      }
    ...
    AsyncFunction("getPermissionsAsync") { (promise: Promise) in
      ABI47_0_0EXPermissionsMethodsDelegate.getPermissionWithPermissionsManager(
        ...
        withRequester: ABI47_0_0EXCameraPermissionRequester.self,
    ...
    AsyncFunction("getCameraPermissionsAsync") { (promise: Promise) in
      ABI47_0_0EXPermissionsMethodsDelegate.getPermissionWithPermissionsManager(
        self.appContext?.permissions,
        withRequester: ABI47_0_0EXCameraCameraPermissionRequester.self,
        resolve: promise.resolver,
        reject: promise.legacyRejecter
      )
    }
    ...
    AsyncFunction("getMicrophonePermissionsAsync") { (promise: Promise) in
      ABI47_0_0EXPermissionsMethodsDelegate.getPermissionWithPermissionsManager(
        self.appContext?.permissions,
        withRequester: ABI47_0_0EXCameraMicrophonePermissionRequester.self,
        resolve: promise.resolver,
        reject: promise.legacyRejecter
      )
    }
...
private func takePictureForSimulator(_ appContext: AppContext?, _ view: ABI47_0_0EXCamera, _ options: TakePictureOptions, _ promise: Promise) throws {
  if options.fastMode {
    promise.resolve()
  }
...
private func generatePictureForSimulator(appContext: AppContext?, options: TakePictureOptions) throws -> [String: Any?] {
  ...
  let generatedPhoto = ABI47_0_0EXCameraUtils.generatePhoto(of: CGSize(width: 200, height: 200))
  let photoData = generatedPhoto.jpegData(compressionQuality: options.quality)

  return [
    "uri": ABI47_0_0EXCameraUtils.writeImage(photoData, toPath: path),
...
private func getAvailableVideoCodecs() -> [String] {
  ...
  guard let captureDevice = ABI47_0_0EXCameraUtils.device(withMediaType: AVMediaType.video.rawValue, preferring: AVCaptureDevice.Position.front) else {
    return []
  }
