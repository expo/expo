...
@implementation ABI44_0_0EXAmplitude

ABI44_0_0EX_EXPORT_MODULE(ExpoAmplitude);
...
ABI44_0_0EX_EXPORT_METHOD_AS(setUserPropertiesAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(clearUserPropertiesAsync,
                    clearUserPropertiesAsyncWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve
...
ABI44_0_0EX_EXPORT_METHOD_AS(logEventWithPropertiesAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(setGroupAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(setTrackingOptionsAsync,
