...
#import <ABI44_0_0EXLocation/ABI44_0_0EXBaseLocationRequester.h>
#import <ABI44_0_0ExpoModulesCore/ABI44_0_0EXUtilities.h>

#import <objc/message.h>
#import <CoreLocation/CLLocationManagerDelegate.h>

@interface ABI44_0_0EXBaseLocationRequester () <CLLocationManagerDelegate>
...
@implementation ABI44_0_0EXBaseLocationRequester
...
# pragma mark - ABI44_0_0UMPermissionsRequester

- (NSDictionary *)getPermissions {
  
  CLAuthorizationStatus systemStatus;
  if (![ABI44_0_0EXBaseLocationRequester isConfiguredForAlwaysAuthorization] && ![ABI44_0_0EXBaseLocationRequester isConfiguredForWhenInUseAuthorization]) {
    ABI44_0_0EXFatal(ABI44_0_0EXErrorWithMessage(@"This app is missing usage descriptions, so location services will fail. Add one of the `NSLocation*UsageDescription` keys to your bundle's Info.plist. See https://bit.ly/2P5fEbG (https://docs.expo.io/versions/latest/guides/app-stores.html#system-permissions-dialogs-on-ios) for more information."));
...
- (void)requestPermissionsWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve rejecter:(ABI44_0_0EXPromiseRejectBlock)reject {
  ...
  if (existingPermissions && [existingPermissions[@"status"] intValue] != ABI44_0_0EXPermissionStatusUndetermined) {
