...
@interface ABI44_0_0EXBannerView () <FBAdViewDelegate>
...
@implementation ABI44_0_0EXBannerView
...
- (void)createViewIfCan
{
  ...
  UIViewController *rootViewController = [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI44_0_0EXUtilitiesInterface)] currentViewController];
...
- (void)adView:(FBAdView *)adView didFailWithError:(NSError *)error
{
  if (_onAdError) {
    ...
    ABI44_0_0EXLogError(@"%@: %@", error.localizedDescription, error.userInfo);
  }
}
