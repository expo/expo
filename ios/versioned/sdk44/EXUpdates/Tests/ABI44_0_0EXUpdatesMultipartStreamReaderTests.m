...
/**
 * Fork of {@link ABI44_0_0EXUpdatesMultipartStreamReaderTests}.
 */
@interface ABI44_0_0EXUpdatesMultipartStreamReaderTests : XCTestCase

@end

@implementation ABI44_0_0EXUpdatesMultipartStreamReaderTests
...
- (void)testSimpleCase
{
  ...
  ABI44_0_0EXUpdatesMultipartStreamReader *reader = [[ABI44_0_0EXUpdatesMultipartStreamReader alloc] initWithInputStream:inputStream
