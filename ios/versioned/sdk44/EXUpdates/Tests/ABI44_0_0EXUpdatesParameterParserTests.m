...
@interface ABI44_0_0EXUpdatesParameterParserTests : XCTestCase
@end

@implementation ABI44_0_0EXUpdatesParameterParserTests
...
- (void)testParameterParser
{
  ...
  for (NSArray *testCase in testCases) {
    ...
    NSDictionary<NSString *, NSString *> *parameters = [[ABI44_0_0EXUpdatesParameterParser new] parseParameterString:parameterString withDelimiter:';'];
