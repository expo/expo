...
class ABI44_0_0EXUpdatesCertificateChainTests : XCTestCase {
  func test_ValidSingleCertificate() throws {
    let cert = try TestHelper.getTestCertificate(TestCertificate.test)
    let codeSigningCertificate = try ABI44_0_0EXUpdatesCertificateChain(certificateStrings: [cert]).codeSigningCertificate()
  ...
  func test_ValidCertificateChain() throws {
    ...
    let codeSigningCertificate = try ABI44_0_0EXUpdatesCertificateChain(certificateStrings: [leafCert, intermediateCert, rootCert]).codeSigningCertificate()
    XCTAssertNotNil(codeSigningCertificate)
  ...
  func test_RequiresLengthGreaterThanZero() throws {
    XCTAssertThrowsError(try ABI44_0_0EXUpdatesCertificateChain(certificateStrings: []).codeSigningCertificate()) { error in
      XCTAssertEqual(error as? ABI44_0_0EXUpdatesCodeSigningError, ABI44_0_0EXUpdatesCodeSigningError.CertificateEmptyError)
    }
  }
  ...
  func test_ThrowsWhenAnyCertificateIsInvalidDate() throws {
    ...
    XCTAssertThrowsError(try ABI44_0_0EXUpdatesCertificateChain(certificateStrings: [cert]).codeSigningCertificate()) { error in
      XCTAssertEqual(error as? ABI44_0_0EXUpdatesCodeSigningError, ABI44_0_0EXUpdatesCodeSigningError.CertificateValidityError)
    }
  }
  ...
  func test_ThrowsWhenLeafIsNotCodeSigningNoKeyUsage() throws {
    ...
    XCTAssertThrowsError(try ABI44_0_0EXUpdatesCertificateChain(certificateStrings: [cert]).codeSigningCertificate()) { error in
      XCTAssertEqual(error as? ABI44_0_0EXUpdatesCodeSigningError, ABI44_0_0EXUpdatesCodeSigningError.CertificateMissingCodeSigningError)
    }
  }
  ...
  func test_ThrowsChainIsNotValid() throws {
    ...
    XCTAssertThrowsError(try ABI44_0_0EXUpdatesCertificateChain(certificateStrings: [leafCert, rootCert]).codeSigningCertificate()) { error in
      XCTAssertEqual(error as? ABI44_0_0EXUpdatesCodeSigningError, ABI44_0_0EXUpdatesCodeSigningError.CertificateChainError)
    }
  }
  ...
  func test_ThrowsWhenAnySignatureInvalid() throws {
    ...
    XCTAssertThrowsError(try ABI44_0_0EXUpdatesCertificateChain(certificateStrings: [leafCert, intermediateCert, rootCert]).codeSigningCertificate()) { error in
      XCTAssertEqual(error as? ABI44_0_0EXUpdatesCodeSigningError, ABI44_0_0EXUpdatesCodeSigningError.CertificateChainError)
    }
  }
  ...
  func test_ThrowsWhenRootIsNotSelfSigned() throws {
    ...
    XCTAssertThrowsError(try ABI44_0_0EXUpdatesCertificateChain(certificateStrings: [leafCert, intermediateCert]).codeSigningCertificate()) { error in
      XCTAssertEqual(error as? ABI44_0_0EXUpdatesCodeSigningError, ABI44_0_0EXUpdatesCodeSigningError.CertificateRootNotSelfSigned)
    }
  }
  ...
  func test_ThrowsWhenExpoProjectInformationViolation() throws {
    ...
    XCTAssertThrowsError(try ABI44_0_0EXUpdatesCertificateChain(certificateStrings: [leafCert, intermediateCert, rootCert]).codeSigningCertificate()) { error in
      XCTAssertEqual(error as? ABI44_0_0EXUpdatesCodeSigningError, ABI44_0_0EXUpdatesCodeSigningError.CertificateProjectInformationChainError)
    }
  }
}
