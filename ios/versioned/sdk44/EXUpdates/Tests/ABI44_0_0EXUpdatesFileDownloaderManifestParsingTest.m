...
#import "ABI44_0_0EXUpdates_Unit_Tests-Swift.h"

@interface ABI44_0_0EXUpdatesFileDownloaderManifestParsingTests : XCTestCase
...
@implementation ABI44_0_0EXUpdatesFileDownloaderManifestParsingTests
...
- (void)testManifestParsing_JSONBody
{
  ...
  __block ABI44_0_0EXUpdatesUpdate *resultUpdateManifest;
  
  [downloader parseManifestResponse:response withData:bodyData database:nil successBlock:^(ABI44_0_0EXUpdatesUpdate * _Nonnull update) {
...
- (void)testManifestParsing_JSONBodySigned {
  ABI44_0_0EXUpdatesConfig *config = [ABI44_0_0EXUpdatesConfig configWithDictionary:@{
    ABI44_0_0EXUpdatesConfigUpdateUrlKey: @"https://exp.host/@test/test",
    ABI44_0_0EXUpdatesConfigCodeSigningCertificateKey: _modernJSONCertificate,
    ABI44_0_0EXUpdatesConfigCodeSigningMetadataKey: @{},
  }];
  ABI44_0_0EXUpdatesFileDownloader *downloader = [[ABI44_0_0EXUpdatesFileDownloader alloc] initWithUpdatesConfig:config];
...
- (void)testManifestParsing_JSONBodySigned_UnsignedRequest_ManifestSignatureOptional {
  ABI44_0_0EXUpdatesConfig *config = [ABI44_0_0EXUpdatesConfig configWithDictionary:@{
    ...
    ABI44_0_0EXUpdatesConfigCodeSigningCertificateKey: _modernJSONCertificate,
    ABI44_0_0EXUpdatesConfigCodeSigningMetadataKey: @{},
    ABI44_0_0EXUpdatesConfigCodeSigningAllowUnsignedManifestsKey: @YES,
  }];
  ABI44_0_0EXUpdatesFileDownloader *downloader = [[ABI44_0_0EXUpdatesFileDownloader alloc] initWithUpdatesConfig:config];
...
- (void)testManifestParsing_MultipartBodySignedCertificateParticularExperience {
  ABI44_0_0EXUpdatesConfig *config = [ABI44_0_0EXUpdatesConfig configWithDictionary:@{
    ABI44_0_0EXUpdatesConfigUpdateUrlKey: @"https://exp.host/@test/test",
    ABI44_0_0EXUpdatesConfigCodeSigningCertificateKey: _rootCertificate,
    ABI44_0_0EXUpdatesConfigCodeSigningMetadataKey: @{
      @"keyid": @"ca-root",
    },
    ABI44_0_0EXUpdatesConfigCodeSigningIncludeManifestResponseCertificateChainKey: @YES,
  }];
  ABI44_0_0EXUpdatesFileDownloader *downloader = [[ABI44_0_0EXUpdatesFileDownloader alloc] initWithUpdatesConfig:config];
