...
static NSString * const ABI44_0_0EXUpdatesDatabaseV4Schema = @"\
...
static NSString * const ABI44_0_0EXUpdatesDatabaseV5Schema = @"\
CREATE TABLE \"updates\" (\
\"id\"  BLOB UNIQUE,\
\"scope_key\"  TEXT NOT NULL,\
\"commit_time\"  INTEGER NOT NULL,\
...
static NSString * const ABI44_0_0EXUpdatesDatabaseV6Schema = @"\
CREATE TABLE \"updates\" (\
\"id\"  BLOB UNIQUE,\
\"scope_key\"  TEXT NOT NULL,\
\"commit_time\"  INTEGER NOT NULL,\
...
static NSString * const ABI44_0_0EXUpdatesDatabaseV7Schema = @"\
CREATE TABLE \"updates\" (\
\"id\"  BLOB UNIQUE,\
\"scope_key\"  TEXT NOT NULL,\
\"commit_time\"  INTEGER NOT NULL,\
...
static NSString * const ABI44_0_0EXUpdatesDatabaseV8Schema = @"\
CREATE TABLE \"updates\" (\
\"id\"  BLOB UNIQUE,\
\"scope_key\"  TEXT NOT NULL,\
\"commit_time\"  INTEGER NOT NULL,\
...
@interface ABI44_0_0EXUpdatesDatabaseInitializationTests : XCTestCase

@property (nonatomic, strong) NSURL *testDatabaseDir;

@end

@implementation ABI44_0_0EXUpdatesDatabaseInitializationTests
...
- (void)testDatabasePersistence
{
  ...
  [ABI44_0_0EXUpdatesDatabaseInitialization initializeDatabaseWithLatestSchemaInDirectory:_testDatabaseDir
                                                                        database:&db
  ...
  NSError *insertError;
  [ABI44_0_0EXUpdatesDatabaseUtils executeSql:insertSql withArgs:nil onDatabase:db error:&insertError];
  ...
  NSArray<NSDictionary *> *rows = [ABI44_0_0EXUpdatesDatabaseUtils executeSql:selectSql withArgs:nil onDatabase:newDb error:nil];
...
- (void)testMigration4ToLatest
{
  ...
  sqlite3 *db;
  NSError *initializeError;
  [ABI44_0_0EXUpdatesDatabaseInitialization initializeDatabaseWithSchema:ABI44_0_0EXUpdatesDatabaseV4Schema
                                                       filename:@"expo-v4.db"
  ...
  [ABI44_0_0EXUpdatesDatabaseUtils executeSql:insertAssetsSql withArgs:nil onDatabase:db error:&insertAssetsError];
  NSError *insertUpdatesError;
  [ABI44_0_0EXUpdatesDatabaseUtils executeSql:insertUpdatesSql withArgs:nil onDatabase:db error:&insertUpdatesError];
  NSError *insertUpdatesAssetsError;
  [ABI44_0_0EXUpdatesDatabaseUtils executeSql:insertUpdatesAssetsSql withArgs:nil onDatabase:db error:&insertUpdatesAssetsError];
  ...
  XCTAssertEqual(1, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:updatesSql1 withArgs:nil onDatabase:migratedDb error:nil].count);
  NSString * const updatesSql2 = @"SELECT * FROM `updates` WHERE `id` = X'594100ea066e4804b5c7c907c773f980'";
  XCTAssertEqual(1, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:updatesSql2 withArgs:nil onDatabase:migratedDb error:nil].count);

  NSString * const assetsSql1 = @"SELECT * FROM `assets` WHERE `id` = 2";
  XCTAssertEqual(1, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:assetsSql1 withArgs:nil onDatabase:migratedDb error:nil].count);
  NSString * const assetsSql2 = @"SELECT * FROM `assets` WHERE `id` = 3";
  XCTAssertEqual(1, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:assetsSql2 withArgs:nil onDatabase:migratedDb error:nil].count);
  NSString * const assetsSql3 = @"SELECT * FROM `assets` WHERE `id` = 4";
  XCTAssertEqual(1, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:assetsSql3 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:updatesAssetsSql1 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:updatesAssetsSql2 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:updatesAssetsSql3 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:lastAccessedSql withArgs:nil onDatabase:migratedDb error:nil].count);
  NSString * const successfulLaunchCountSql = @"SELECT * FROM `updates` WHERE `successful_launch_count` = 1";
  XCTAssertEqual(2, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:successfulLaunchCountSql withArgs:nil onDatabase:migratedDb error:nil].count);
}
...
- (void)testMigration4To5
{
  ...
  [ABI44_0_0EXUpdatesDatabaseInitialization initializeDatabaseWithLatestSchemaInDirectory:_testDatabaseDir
                                                                        database:&migratedDb
                                                                      migrations:@[[ABI44_0_0EXUpdatesDatabaseMigration4To5 new]]
                                                                           error:&migrateError];
  XCTAssertNil(migrateError);
  ...
  [ABI44_0_0EXUpdatesDatabaseUtils executeSql:nullInsertSql withArgs:nil onDatabase:migratedDb error:&nullInsertError];
  ...
  [ABI44_0_0EXUpdatesDatabaseUtils executeSql:foreignKeyInsertSql withArgs:nil onDatabase:migratedDb error:nil];
  XCTAssertEqual(1, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:foreignKeySelectSql withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  [ABI44_0_0EXUpdatesDatabaseUtils executeSql:foreignKeyInsertBadSql withArgs:nil onDatabase:migratedDb error:&foreignKeyError];
  ...
  [ABI44_0_0EXUpdatesDatabaseUtils executeSql:deleteSql withArgs:nil onDatabase:migratedDb error:nil];
  XCTAssertEqual(0, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:selectDeletedSql withArgs:nil onDatabase:migratedDb error:nil].count);
}
...
- (void)testMigration5To6
{
  sqlite3 *db;
  NSError *initializeError;
  [ABI44_0_0EXUpdatesDatabaseInitialization initializeDatabaseWithSchema:ABI44_0_0EXUpdatesDatabaseV5Schema
                                                       filename:@"expo-v5.db"
                                                    inDirectory:_testDatabaseDir
                                                  shouldMigrate:NO
                                                     migrations:@[]
  ...
  [ABI44_0_0EXUpdatesDatabaseInitialization initializeDatabaseWithLatestSchemaInDirectory:_testDatabaseDir
                                                                        database:&migratedDb
                                                                      migrations:@[[ABI44_0_0EXUpdatesDatabaseMigration5To6 new]]
                                                                           error:&migrateError];
  XCTAssertNil(migrateError);
  ...
  XCTAssertEqual(1, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:updatesNonNullManifestSql withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:lastAccessedSql1 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  [ABI44_0_0EXUpdatesDatabaseUtils executeSql:lastAccessedSql2 withArgs:nil onDatabase:migratedDb error:&lastAccessedError];
  XCTAssertNil(lastAccessedError);
  NSString * const lastAccessedSql3 = @"SELECT DISTINCT last_accessed FROM `updates`";
  XCTAssertEqual(2, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:lastAccessedSql3 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  [ABI44_0_0EXUpdatesDatabaseUtils executeSql:foreignKeyInsertBadSql1 withArgs:nil onDatabase:migratedDb error:&foreignKeyError1];
  ...
  [ABI44_0_0EXUpdatesDatabaseUtils executeSql:foreignKeyInsertBadSql2 withArgs:nil onDatabase:migratedDb error:&foreignKeyError2];
  ...
  [ABI44_0_0EXUpdatesDatabaseUtils executeSql:deleteSql withArgs:nil onDatabase:migratedDb error:nil];
  XCTAssertEqual(0, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:selectDeletedSql1 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(0, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:selectDeletedSql2 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(0, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:selectDeletedSql3 withArgs:nil onDatabase:migratedDb error:nil].count);
}
...
- (void)testMigration6To7
{
  sqlite3 *db;
  NSError *initializeError;
  [ABI44_0_0EXUpdatesDatabaseInitialization initializeDatabaseWithSchema:ABI44_0_0EXUpdatesDatabaseV6Schema
                                                       filename:@"expo-v6.db"
                                                    inDirectory:_testDatabaseDir
                                                  shouldMigrate:NO
                                                     migrations:@[]
  ...
  [ABI44_0_0EXUpdatesDatabaseInitialization initializeDatabaseWithLatestSchemaInDirectory:_testDatabaseDir
                                                                        database:&migratedDb
                                                                      migrations:@[[ABI44_0_0EXUpdatesDatabaseMigration6To7 new]]
                                                                           error:&migrateError];
  XCTAssertNil(migrateError);
  ...
  XCTAssertEqual(1, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:successfulLaunchCountSql withArgs:nil onDatabase:migratedDb error:nil].count);
  NSString * const failedLaunchCount = @"SELECT DISTINCT `failed_launch_count` FROM `updates`";
  XCTAssertEqual(1, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:failedLaunchCount withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  [ABI44_0_0EXUpdatesDatabaseUtils executeSql:modifySuccessfulLaunchCountSql withArgs:nil onDatabase:migratedDb error:&modifySuccessfulLaunchCountError];
  ...
  [ABI44_0_0EXUpdatesDatabaseUtils executeSql:modifyFailedLaunchCountSql withArgs:nil onDatabase:migratedDb error:&modifyFailedLaunchCountError];
  ...
  XCTAssertEqual(1, [ABI44_0_0EXUpdatesDatabaseUtils executeSql:checkFailedLaunchCountSql withArgs:nil onDatabase:migratedDb error:nil].count);
...
- (void)testMigration7To8 {
  sqlite3 *db;
  NSError *initializeError;
  [ABI44_0_0EXUpdatesDatabaseInitialization initializeDatabaseWithSchema:ABI44_0_0EXUpdatesDatabaseV7Schema
                                                       filename:@"expo-v7.db"
                                                    inDirectory:_testDatabaseDir
                                                  shouldMigrate:NO
                                                     migrations:@[]
...
- (void)testMigration8To9 {
  sqlite3 *db;
  NSError *initializeError;
  [ABI44_0_0EXUpdatesDatabaseInitialization initializeDatabaseWithSchema:ABI44_0_0EXUpdatesDatabaseV8Schema
                                                       filename:@"expo-v8.db"
                                                    inDirectory:_testDatabaseDir
                                                  shouldMigrate:NO
                                                     migrations:@[]
