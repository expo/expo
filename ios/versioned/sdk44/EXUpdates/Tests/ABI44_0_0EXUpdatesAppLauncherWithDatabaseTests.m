...
@interface ABI44_0_0EXUpdatesAppLauncherWithDatabaseMock : ABI44_0_0EXUpdatesAppLauncherWithDatabase

+ (ABI44_0_0EXUpdatesUpdate *)testUpdate;

@end

@implementation ABI44_0_0EXUpdatesAppLauncherWithDatabaseMock

+ (ABI44_0_0EXUpdatesUpdate *)testUpdate
{
  static ABI44_0_0EXUpdatesUpdate *theUpdate;
  ...
  dispatch_once(&once, ^{
    if (!theUpdate) {
      ...
      theUpdate = [ABI44_0_0EXUpdatesUpdate updateWithId:NSUUID.UUID scopeKey:scopeKey commitTime:[NSDate dateWithTimeIntervalSince1970:1608667851] runtimeVersion:runtimeVersion manifest:nil status:ABI44_0_0EXUpdatesUpdateStatusReady keep:YES config:config database:database];
    }
  });
  return theUpdate;
}
...
@interface ABI44_0_0EXUpdatesAppLauncherWithDatabaseTests : XCTestCase
...
@implementation ABI44_0_0EXUpdatesAppLauncherWithDatabaseTests
...
- (void)testExample
{
  ABI44_0_0EXUpdatesUpdate *testUpdate = [ABI44_0_0EXUpdatesAppLauncherWithDatabaseMock testUpdate];
  ...
  ABI44_0_0EXUpdatesAsset *testAsset = [[ABI44_0_0EXUpdatesAsset alloc] initWithKey:@"bundle-1234" type:@"js"];
  ...
  ABI44_0_0EXUpdatesAppLauncherWithDatabase *launcher = [[ABI44_0_0EXUpdatesAppLauncherWithDatabaseMock alloc] initWithConfig:[ABI44_0_0EXUpdatesConfig new] database:_db directory:_testDatabaseDir completionQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)];
  [launcher launchUpdateWithSelectionPolicy:[ABI44_0_0EXUpdatesSelectionPolicy new] completion:^(NSError * _Nullable error, BOOL success) {
  ...
  dispatch_sync(_db.databaseQueue, ^{
    NSError *error3;
    ABI44_0_0EXUpdatesUpdate *sameUpdate = [_db updateWithId:testUpdate.updateId config:[ABI44_0_0EXUpdatesConfig new] error:&error3];
    XCTAssertNil(error3);
