...
typedef NS_ENUM(NSInteger, ABI44_0_0EXUpdatesRemoteLoadStatus) {
  ABI44_0_0EXUpdatesRemoteLoadStatusIdle,
  ABI44_0_0EXUpdatesRemoteLoadStatusLoading,
  ABI44_0_0EXUpdatesRemoteLoadStatusNewUpdateLoaded
};

@protocol ABI44_0_0EXUpdatesErrorRecoveryDelegate <NSObject>

@property (nonatomic, readonly, strong) ABI44_0_0EXUpdatesConfig *config;
@property (nonatomic, readonly, strong) ABI44_0_0EXUpdatesUpdate *launchedUpdate;
@property (nonatomic, readonly, assign) ABI44_0_0EXUpdatesRemoteLoadStatus remoteLoadStatus;
...
@interface ABI44_0_0EXUpdatesErrorRecovery : NSObject

@property (nonatomic, weak) id<ABI44_0_0EXUpdatesErrorRecoveryDelegate> delegate;
