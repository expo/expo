...
@objc public enum ABI44_0_0EXUpdatesCodeSigningError : Int, Error {
...
@objc public class ABI44_0_0EXUpdatesCodeSigningErrorUtils : NSObject {
  @objc public static func message(forError: ABI44_0_0EXUpdatesCodeSigningError) -> String {
    switch forError {
    case .CertificateEncodingError:
