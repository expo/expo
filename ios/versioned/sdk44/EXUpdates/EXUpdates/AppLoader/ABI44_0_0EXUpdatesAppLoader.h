...
typedef BOOL (^ABI44_0_0EXUpdatesAppLoaderManifestBlock)(ABI44_0_0EXUpdatesUpdate *update);
typedef void (^ABI44_0_0EXUpdatesAppLoaderAssetBlock) (ABI44_0_0EXUpdatesAsset *asset, NSUInteger successfulAssetCount, NSUInteger failedAssetCount, NSUInteger totalAssetCount);
typedef void (^ABI44_0_0EXUpdatesAppLoaderSuccessBlock)(ABI44_0_0EXUpdatesUpdate * _Nullable update);
typedef void (^ABI44_0_0EXUpdatesAppLoaderErrorBlock)(NSError *error);

@interface ABI44_0_0EXUpdatesAppLoader : NSObject
