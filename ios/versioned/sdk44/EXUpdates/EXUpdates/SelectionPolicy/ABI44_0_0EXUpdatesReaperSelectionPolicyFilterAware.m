...
@implementation ABI44_0_0EXUpdatesReaperSelectionPolicyFilterAware
...
- (NSArray<ABI44_0_0EXUpdatesUpdate *> *)updatesToDeleteWithLaunchedUpdate:(ABI44_0_0EXUpdatesUpdate *)launchedUpdate updates:(NSArray<ABI44_0_0EXUpdatesUpdate *> *)updates filters:(nullable NSDictionary *)filters
{
  ...
  ABI44_0_0EXUpdatesUpdate *nextNewestUpdate;
  ABI44_0_0EXUpdatesUpdate *nextNewestUpdateMatchingFilters;
  for (ABI44_0_0EXUpdatesUpdate *update in updates) {
    ...
    if ([launchedUpdate.commitTime compare:update.commitTime] == NSOrderedDescending) {
      ...
      if ([ABI44_0_0EXUpdatesSelectionPolicies doesUpdate:update matchFilters:filters] &&
