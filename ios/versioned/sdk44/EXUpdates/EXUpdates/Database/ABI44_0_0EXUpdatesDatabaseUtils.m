...
static NSString * const ABI44_0_0EXUpdatesDatabaseUtilsErrorDomain = @"ABI44_0_0EXUpdatesDatabase";

@implementation ABI44_0_0EXUpdatesDatabaseUtils
...
+ (NSError *)errorFromSqlite:(struct sqlite3 *)db
{
  ...
  return [NSError errorWithDomain:ABI44_0_0EXUpdatesDatabaseUtilsErrorDomain
                             code:extendedCode
