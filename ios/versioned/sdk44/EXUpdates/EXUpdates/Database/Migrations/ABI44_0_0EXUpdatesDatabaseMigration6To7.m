...
static NSString * const ABI44_0_0EXUpdatesDatabaseV6Filename = @"expo-v6.db";

@implementation ABI44_0_0EXUpdatesDatabaseMigration6To7

- (NSString *)filename
{
  return ABI44_0_0EXUpdatesDatabaseV6Filename;
}
