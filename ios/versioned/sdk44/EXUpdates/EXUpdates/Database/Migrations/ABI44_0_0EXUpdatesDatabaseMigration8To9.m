...
static NSString * const ABI44_0_0EXUpdatesDatabaseV8Filename = @"expo-v8.db";

@implementation ABI44_0_0EXUpdatesDatabaseMigration8To9

- (NSString *)filename
{
  return ABI44_0_0EXUpdatesDatabaseV8Filename;
}
