...
static NSString * const ABI44_0_0EXUpdatesDatabaseV7Filename = @"expo-v7.db";

@implementation ABI44_0_0EXUpdatesDatabaseMigration7To8

- (NSString *)filename
{
  return ABI44_0_0EXUpdatesDatabaseV7Filename;
}
