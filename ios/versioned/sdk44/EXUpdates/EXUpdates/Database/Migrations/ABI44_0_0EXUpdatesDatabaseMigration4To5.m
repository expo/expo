...
static NSString * const ABI44_0_0EXUpdatesDatabaseV4Filename = @"expo-v4.db";

@implementation ABI44_0_0EXUpdatesDatabaseMigration4To5

- (NSString *)filename
{
  return ABI44_0_0EXUpdatesDatabaseV4Filename;
}
