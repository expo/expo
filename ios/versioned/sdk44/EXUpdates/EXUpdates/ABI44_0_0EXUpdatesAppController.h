...
#import <ABI44_0_0EXUpdates/ABI44_0_0EXUpdatesAppLoaderTask.h>
...
@class ABI44_0_0EXUpdatesAppController;

@protocol ABI44_0_0EXUpdatesAppControllerDelegate <NSObject>

- (void)appController:(ABI44_0_0EXUpdatesAppController *)appController didStartWithSuccess:(BOOL)success;

@end

@interface ABI44_0_0EXUpdatesAppController : NSObject <ABI44_0_0EXUpdatesAppLoaderTaskDelegate>

/**
 Delegate which will be notified when ABI44_0_0EXUpdates has an update ready to launch and
 `launchAssetUrl` is nonnull.
 */
@property (nonatomic, weak) id<ABI44_0_0EXUpdatesAppControllerDelegate> delegate;

/**
 The ABI44_0_0RCTBridge for which ABI44_0_0EXUpdates is providing the JS bundle and assets.
...
/**
 The URL on disk to source asset for the ABI44_0_0RCTBridge.
 Will be null until the ABI44_0_0EXUpdatesAppController delegate method is called.
 This should be provided in the `sourceURLForBridge:` method of ABI44_0_0RCTBridgeDelegate.
 */
...
/**
 ...
 can be used by `expo-asset` or a similar module to override ABI44_0_0React Native's asset resolution and
...
/**
 for internal use in ABI44_0_0EXUpdates
 */
...
/**
 ...
 shared instance of ABI44_0_0EXUpdatesAppController.
 */
 ...
 * ABI44_0_0EXUpdatesAppController's default selection policy is.
 */
