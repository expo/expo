...
#import <ABI44_0_0EXDevice/ABI44_0_0EXDevice.h>
...
@interface ABI44_0_0EXDevice()

@end

@implementation ABI44_0_0EXDevice

ABI44_0_0EX_EXPORT_MODULE(ExpoDevice);
...
- (NSDictionary *)constantsToExport
{
  ...
  return @{
           ...
           @"brand": @"Apple",
           @"manufacturer": @"Apple",
           @"modelId": ABI44_0_0EXNullIfNil([[self class] modelId]),
           @"modelName": [[self class] modelName],
           @"deviceYearClass": [[self class] deviceYear],
           @"totalMemory": @(NSProcessInfo.processInfo.physicalMemory),
           @"supportedCpuArchitectures": ABI44_0_0EXNullIfNil([[self class] cpuArchitectures]),
...
ABI44_0_0EX_EXPORT_METHOD_AS(getDeviceTypeAsync,
                    getDeviceTypeAsyncWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  resolve(@([[self class] deviceType]));
}

ABI44_0_0EX_EXPORT_METHOD_AS(getUptimeAsync,
                    getUptimeAsyncWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
...
ABI44_0_0EX_EXPORT_METHOD_AS(isRootedExperimentalAsync,
                    isRootedExperimentalAsyncWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
...
+ (ABI44_0_0EXDeviceType)deviceType
{
  switch (UIDevice.currentDevice.userInterfaceIdiom) {
    case UIUserInterfaceIdiomPhone:
      return ABI44_0_0EXDeviceTypePhone;
    case UIUserInterfaceIdiomPad:
      return ABI44_0_0EXDeviceTypeTablet;
    case UIUserInterfaceIdiomTV:
      return ABI44_0_0EXDeviceTypeTV;
    default:
      // NOTE: in the future for macOS, return Desktop
      return ABI44_0_0EXDeviceTypeUnknown;
  }
}
