...
@implementation ABI44_0_0EXErrorRecoveryModule

ABI44_0_0EX_EXPORT_MODULE(ExpoErrorRecovery);

ABI44_0_0EX_EXPORT_METHOD_AS(saveRecoveryProps,
...
{
  return @{
           @"recoveredProps": ABI44_0_0EXNullIfNil([self consumeRecoveryProps])
           };
}
