...
#import <ABI44_0_0EXSpeech/ABI44_0_0EXSpeech.h>

@interface ABI44_0_0EXSpeechUtteranceWithId : AVSpeechUtterance
...
@implementation ABI44_0_0EXSpeechUtteranceWithId
...
@interface ABI44_0_0EXSpeech () <AVSpeechSynthesizerDelegate>
...
@implementation ABI44_0_0EXSpeech

ABI44_0_0EX_EXPORT_MODULE(ExponentSpeech)
...
{
  id<ABI44_0_0EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI44_0_0EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStarted" body:@{ @"id": ((ABI44_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didCancelSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI44_0_0EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI44_0_0EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStopped" body:@{ @"id": ((ABI44_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didFinishSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI44_0_0EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI44_0_0EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingDone" body:@{ @"id": ((ABI44_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}


ABI44_0_0EX_EXPORT_METHOD_AS(speak,
  ...
  AVSpeechUtterance *utterance = [[ABI44_0_0EXSpeechUtteranceWithId alloc] initWithString:text utteranceId:utteranceId];
...
ABI44_0_0EX_EXPORT_METHOD_AS(getVoices,
                    getVoices:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject) {
...
ABI44_0_0EX_EXPORT_METHOD_AS(stop,
                    stop:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject) {
  [_synthesizer stopSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI44_0_0EX_EXPORT_METHOD_AS(pause,
                    pause:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject) {
  [_synthesizer pauseSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI44_0_0EX_EXPORT_METHOD_AS(resume,
                    resume:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject) {
  [_synthesizer continueSpeaking];
  resolve(nil);
}

ABI44_0_0EX_EXPORT_METHOD_AS(isSpeaking,
                    isSpeaking:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject) {
