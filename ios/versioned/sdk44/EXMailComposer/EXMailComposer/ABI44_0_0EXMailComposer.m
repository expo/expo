...
#import <ABI44_0_0EXMailComposer/ABI44_0_0EXMailComposer.h>
...
@interface ABI44_0_0EXMailComposer ()
...
@implementation ABI44_0_0EXMailComposer

ABI44_0_0EX_EXPORT_MODULE(ExpoMailComposer);
...
ABI44_0_0EX_EXPORT_METHOD_AS(composeAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  self.reject = reject;
  id<ABI44_0_0EXUtilitiesInterface> utilities = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI44_0_0EXUtilitiesInterface)];
