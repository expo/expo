...
#import <ABI44_0_0EXScreenOrientation/ABI44_0_0EXScreenOrientationModule.h>
#import <ABI44_0_0EXScreenOrientation/ABI44_0_0EXScreenOrientationUtilities.h>
#import <ABI44_0_0EXScreenOrientation/ABI44_0_0EXScreenOrientationRegistry.h>

#import <UIKit/UIKit.h>

static NSString *const ABI44_0_0EXScreenOrientationDidUpdateDimensions = @"expoDidUpdateDimensions";

@interface ABI44_0_0EXScreenOrientationModule ()

@property (nonatomic, weak) ABI44_0_0EXScreenOrientationRegistry *screenOrientationRegistry;
@property (nonatomic, weak) id<ABI44_0_0EXEventEmitterService> eventEmitter;

@end

@implementation ABI44_0_0EXScreenOrientationModule

ABI44_0_0EX_EXPORT_MODULE(ExpoScreenOrientation);
...
ABI44_0_0EX_EXPORT_METHOD_AS(lockAsync,
...
{
  UIInterfaceOrientationMask orientationMask = [ABI44_0_0EXScreenOrientationUtilities importOrientationLock:orientationLock];
  ...
  if (![ABI44_0_0EXScreenOrientationUtilities doesDeviceSupportOrientationMask:orientationMask]) {
...
ABI44_0_0EX_EXPORT_METHOD_AS(lockPlatformAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  for (NSNumber *allowedOrientation in allowedOrientations) {
    UIInterfaceOrientation orientation = [ABI44_0_0EXScreenOrientationUtilities importOrientation:allowedOrientation];
    UIInterfaceOrientationMask orientationMask = [ABI44_0_0EXScreenOrientationUtilities maskFromOrientation:orientation];
    if (!orientationMask) {
  ...
  if (![ABI44_0_0EXScreenOrientationUtilities doesDeviceSupportOrientationMask:allowedOrientationsMask]) {
...
ABI44_0_0EX_EXPORT_METHOD_AS(getOrientationLockAsync,
                    getOrientationLockAsyncWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  resolve([ABI44_0_0EXScreenOrientationUtilities exportOrientationLock:[_screenOrientationRegistry currentOrientationMask]]);
}

ABI44_0_0EX_EXPORT_METHOD_AS(getPlatformOrientationLockAsync,
                    getPlatformOrientationLockAsyncResolver:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  for (NSNumber *wrappedSingleOrientation in [maskToOrienationMap allKeys]) {
    ...
    if (supportedOrientationMask) {
      ...
      [allowedOrientations addObject:[ABI44_0_0EXScreenOrientationUtilities exportOrientation:supportedOrientation]];
    }
  }
  resolve(allowedOrientations);
}

ABI44_0_0EX_EXPORT_METHOD_AS(supportsOrientationLockAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (orientationMask && [ABI44_0_0EXScreenOrientationUtilities doesDeviceSupportOrientationMask:orientationMask]) {
    return resolve(@YES);
  }
...
ABI44_0_0EX_EXPORT_METHOD_AS(getOrientationAsync,
                    getOrientationAsyncResolver:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  resolve([ABI44_0_0EXScreenOrientationUtilities exportOrientation:[_screenOrientationRegistry currentOrientation]]);
}
...
- (void)screenOrientationDidChange:(UIInterfaceOrientation)orientation
{
  ...
  [_eventEmitter sendEventWithName:ABI44_0_0EXScreenOrientationDidUpdateDimensions body:@{
    @"orientationLock": [ABI44_0_0EXScreenOrientationUtilities exportOrientationLock:[_screenOrientationRegistry currentOrientationMask]],
    @"orientationInfo": @{
      @"orientation": [ABI44_0_0EXScreenOrientationUtilities exportOrientation:orientation],
      @"verticalSizeClass": ABI44_0_0EXNullIfNil(@(currentTraitCollection.verticalSizeClass)),
      @"horizontalSizeClass": ABI44_0_0EXNullIfNil(@(currentTraitCollection.horizontalSizeClass)),
    }
  }];
}

- (NSArray<NSString *> *)supportedEvents {
  return @[ABI44_0_0EXScreenOrientationDidUpdateDimensions];
}
