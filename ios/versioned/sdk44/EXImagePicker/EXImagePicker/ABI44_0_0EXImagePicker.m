#import <ABI44_0_0EXImagePicker/ABI44_0_0EXImagePicker.h>
#import <ABI44_0_0EXImagePicker/ABI44_0_0EXImagePickerCameraPermissionRequester.h>
#import <ABI44_0_0EXImagePicker/ABI44_0_0EXImagePickerMediaLibraryPermissionRequester.h>
...
const CGFloat ABI44_0_0EXDefaultImageQuality = 0.2;

@interface ABI44_0_0EXImagePicker ()
...
@implementation ABI44_0_0EXImagePicker

ABI44_0_0EX_EXPORT_MODULE(ExponentImagePicker);
...
- (void)setModuleRegistry:(ABI44_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  _permissionsManager = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI44_0_0EXPermissionsInterface)];
  [ABI44_0_0EXPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI44_0_0EXImagePickerCameraPermissionRequester new],
                                                    [ABI44_0_0EXImagePickerMediaLibraryPermissionRequester new],
                                                    [ABI44_0_0EXImagePickerMediaLibraryWriteOnlyPermissionRequester new]
                                                    ]
...
{
  if (writeOnly) {
    return [ABI44_0_0EXImagePickerMediaLibraryWriteOnlyPermissionRequester class];
  } else {
    return [ABI44_0_0EXImagePickerMediaLibraryPermissionRequester class];
  }
}
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  [ABI44_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI44_0_0EXImagePickerCameraPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI44_0_0EX_EXPORT_METHOD_AS(getMediaLibraryPermissionsAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(requestMediaLibraryPermissionsAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(launchCameraAsync, launchCameraAsync:(NSDictionary *)options
                  resolver:(ABI44_0_0EXPromiseResolveBlock)resolve
                  rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  BOOL permissionsAreGranted = [self hasCameraRollPermission] &&
                               [self.permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI44_0_0EXImagePickerCameraPermissionRequester class]];
  ...
  self.reject = reject;
  [self launchImagePicker:ABI44_0_0EXImagePickerTargetCamera options:options];
}

ABI44_0_0EX_EXPORT_METHOD_AS(launchImageLibraryAsync, launchImageLibraryAsync:(NSDictionary *)options
                  resolver:(ABI44_0_0EXPromiseResolveBlock)resolve
                  rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  if (!_permissionsManager) {
  ...
  self.resolve = resolve;
  self.reject = reject;
  [self launchImagePicker:ABI44_0_0EXImagePickerTargetLibrarySingleImage options:options];
}

- (void)launchImagePicker:(ABI44_0_0EXImagePickerTarget)target options:(NSDictionary *)options
{
...
- (void)launchImagePicker:(ABI44_0_0EXImagePickerTarget)target
{
  dispatch_async(dispatch_get_main_queue(), ^{
    self.picker = [UIImagePickerController new];

    if (target == ABI44_0_0EXImagePickerTargetCamera) {
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
  dispatch_block_t dismissCompletionBlock = ^{
    ...
    id<ABI44_0_0EXFileSystemInterface> fileSystem = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI44_0_0EXFileSystemInterface)];
    if (!fileSystem) {
          ...
          completionHandler:(void (^)(void))completionHandler
{
  ...
  NSData *data = UIImageJPEGRepresentation(image, quality == nil ? ABI44_0_0EXDefaultImageQuality : [quality floatValue]);
  ...
  if ([[self.options objectForKey:@"exif"] boolValue]) {
    ...
    if (metadata) {
      ...
      if (!asset) {
        ABI44_0_0EXLogInfo(@"Could not fetch metadata for image %@", [imageURL absoluteString]);
        completionHandler();
      }
...
- (BOOL)hasCameraRollPermission
{
  ...
  return [_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI44_0_0EXImagePickerMediaLibraryPermissionRequester class]];
}
