...
#import <ABI44_0_0EXCrypto/ABI44_0_0EXCrypto.h>
#import <CommonCrypto/CommonDigest.h>

@implementation ABI44_0_0EXCrypto

ABI44_0_0EX_EXPORT_MODULE(ExpoCrypto);

ABI44_0_0EX_EXPORT_METHOD_AS(digestStringAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  int digestLength = [ABI44_0_0EXCrypto digestLengthForJSAlgorithm:algorithm];
  if (digestLength == -1) {
