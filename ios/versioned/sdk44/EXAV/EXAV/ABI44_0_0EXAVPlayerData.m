...
typedef struct AVAudioTapProcessorContext {
  ...
  void *self; // a pointer to ABI44_0_0EXAVPlayerData
} AVAudioTapProcessorContext;

NSString *const ABI44_0_0EXAVPlayerDataStatusIsLoadedKeyPath = @"isLoaded";
NSString *const ABI44_0_0EXAVPlayerDataStatusURIKeyPath = @"uri";
NSString *const ABI44_0_0EXAVPlayerDataStatusHeadersKeyPath = @"headers";
NSString *const ABI44_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath = @"progressUpdateIntervalMillis";
NSString *const ABI44_0_0EXAVPlayerDataStatusDurationMillisKeyPath = @"durationMillis";
NSString *const ABI44_0_0EXAVPlayerDataStatusPositionMillisKeyPath = @"positionMillis";
NSString *const ABI44_0_0EXAVPlayerDataStatusSeekMillisToleranceBeforeKeyPath = @"seekMillisToleranceBefore";
NSString *const ABI44_0_0EXAVPlayerDataStatusSeekMillisToleranceAfterKeyPath = @"seekMillisToleranceAfter";
NSString *const ABI44_0_0EXAVPlayerDataStatusPlayableDurationMillisKeyPath = @"playableDurationMillis";
NSString *const ABI44_0_0EXAVPlayerDataStatusShouldPlayKeyPath = @"shouldPlay";
NSString *const ABI44_0_0EXAVPlayerDataStatusIsPlayingKeyPath = @"isPlaying";
NSString *const ABI44_0_0EXAVPlayerDataStatusIsBufferingKeyPath = @"isBuffering";
NSString *const ABI44_0_0EXAVPlayerDataStatusRateKeyPath = @"rate";
NSString *const ABI44_0_0EXAVPlayerDataStatusPitchCorrectionQualityKeyPath = @"pitchCorrectionQuality";
NSString *const ABI44_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath = @"shouldCorrectPitch";
NSString *const ABI44_0_0EXAVPlayerDataStatusVolumeKeyPath = @"volume";
NSString *const ABI44_0_0EXAVPlayerDataStatusIsMutedKeyPath = @"isMuted";
NSString *const ABI44_0_0EXAVPlayerDataStatusIsLoopingKeyPath = @"isLooping";
NSString *const ABI44_0_0EXAVPlayerDataStatusDidJustFinishKeyPath = @"didJustFinish";
NSString *const ABI44_0_0EXAVPlayerDataStatusHasJustBeenInterruptedKeyPath = @"hasJustBeenInterrupted";

NSString *const ABI44_0_0EXAVPlayerDataObserverStatusKeyPath = @"status";
NSString *const ABI44_0_0EXAVPlayerDataObserverRateKeyPath = @"rate";
NSString *const ABI44_0_0EXAVPlayerDataObserverCurrentItemKeyPath = @"currentItem";
NSString *const ABI44_0_0EXAVPlayerDataObserverTimeControlStatusPath = @"timeControlStatus";
NSString *const ABI44_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath = @"playbackBufferEmpty";
NSString *const ABI44_0_0EXAVPlayerDataObserverMetadataKeyPath = @"timedMetadata";

@interface ABI44_0_0EXAVPlayerData ()

@property (nonatomic, weak) ABI44_0_0EXAV *exAV;
...
@property (nonatomic, strong) ABI44_0_0EXPromiseResolveBlock replayResolve;

@end

@implementation ABI44_0_0EXAVPlayerData
{
  ABI44_0_0EXAudioSampleCallback* _audioSampleBufferCallback;
}
...
{
  return @{ABI44_0_0EXAVPlayerDataStatusIsLoadedKeyPath: @(NO)};
}
         ...
         withLoadFinishBlock:(void (^)(BOOL success, NSDictionary *successStatus, NSString *error))loadFinishBlock
{
  if ((self = [super init])) {
    ...
    _url = [NSURL URLWithString:[source objectForKey:ABI44_0_0EXAVPlayerDataStatusURIKeyPath]];
    _headers = [self validatedRequestHeaders:source[ABI44_0_0EXAVPlayerDataStatusHeadersKeyPath]];
...
- (void)_loadNewPlayer
{
  ...
  [avAsset loadValuesAsynchronouslyForKeys:@[ @"duration" ] completionHandler:^{
    ...
    if (self.player) {
      [self _addObserver:self.player forKeyPath:ABI44_0_0EXAVPlayerDataObserverStatusKeyPath];
      [self _addObserver:self.player.currentItem forKeyPath:ABI44_0_0EXAVPlayerDataObserverStatusKeyPath];
      [self _addObserver:self.player.currentItem forKeyPath:ABI44_0_0EXAVPlayerDataObserverMetadataKeyPath];
    } else {
...
- (void)_finishLoadingNewPlayer
{
  ...
  [_player seekToTime:_currentPosition completionHandler:^(BOOL finished) {
    ABI44_0_0EX_ENSURE_STRONGIFY(self);
    __strong ABI44_0_0EXAV *strongEXAV = self.exAV;
    if (strongEXAV) {
         ...
         rejecter:(ABI44_0_0EXPromiseRejectBlock)reject
{
  ...
  if ([parameters objectForKey:ABI44_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath] != nil) {
    NSNumber *progressUpdateIntervalMillis = parameters[ABI44_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath];
  ...
  if ([parameters objectForKey:ABI44_0_0EXAVPlayerDataStatusPositionMillisKeyPath] != nil) {
    NSNumber *currentPositionMillis = parameters[ABI44_0_0EXAVPlayerDataStatusPositionMillisKeyPath];
  ...
  if (mustSeek && [parameters objectForKey:ABI44_0_0EXAVPlayerDataStatusSeekMillisToleranceBeforeKeyPath] != nil) {
    NSNumber *seekMillisToleranceBefore = parameters[ABI44_0_0EXAVPlayerDataStatusSeekMillisToleranceBeforeKeyPath];
  ...
  if (mustSeek && [parameters objectForKey:ABI44_0_0EXAVPlayerDataStatusSeekMillisToleranceAfterKeyPath] != nil) {
    NSNumber *seekMillisToleranceAfter = parameters[ABI44_0_0EXAVPlayerDataStatusSeekMillisToleranceAfterKeyPath];
    toleranceAfter = CMTimeMakeWithSeconds(seekMillisToleranceAfter.floatValue / 1000, NSEC_PER_SEC);
  }
  
  if ([parameters objectForKey:ABI44_0_0EXAVPlayerDataStatusShouldPlayKeyPath] != nil) {
    NSNumber *shouldPlay = parameters[ABI44_0_0EXAVPlayerDataStatusShouldPlayKeyPath];
    _shouldPlay = shouldPlay.boolValue;
  }
  
  if ([parameters objectForKey:ABI44_0_0EXAVPlayerDataStatusRateKeyPath] != nil) {
    NSNumber *rate = parameters[ABI44_0_0EXAVPlayerDataStatusRateKeyPath];
    _rate = rate;
  }
  
  if (parameters[ABI44_0_0EXAVPlayerDataStatusPitchCorrectionQualityKeyPath] != nil) {
    _pitchCorrectionQuality = parameters[ABI44_0_0EXAVPlayerDataStatusPitchCorrectionQualityKeyPath];
  }
  
  if ([parameters objectForKey:ABI44_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath] != nil) {
    NSNumber *shouldCorrectPitch = parameters[ABI44_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath];
    _shouldCorrectPitch = shouldCorrectPitch.boolValue;
  }
  if ([parameters objectForKey:ABI44_0_0EXAVPlayerDataStatusVolumeKeyPath] != nil) {
    NSNumber *volume = parameters[ABI44_0_0EXAVPlayerDataStatusVolumeKeyPath];
    _volume = volume;
  }
  if ([parameters objectForKey:ABI44_0_0EXAVPlayerDataStatusIsMutedKeyPath] != nil) {
    NSNumber *isMuted = parameters[ABI44_0_0EXAVPlayerDataStatusIsMutedKeyPath];
    _isMuted = isMuted.boolValue;
  }
  if ([parameters objectForKey:ABI44_0_0EXAVPlayerDataStatusIsLoopingKeyPath] != nil) {
    NSNumber *isLooping = parameters[ABI44_0_0EXAVPlayerDataStatusIsLoopingKeyPath];
  ...
  if (_player && _isLoaded) {
    ...
    void (^applyPostSeekParameters)(BOOL) = ^(BOOL seekSucceeded) {
      ...
      if (audioSessionError) {
        ...
        if (reject) {
          reject(@"E_AV_SEEKING", nil, ABI44_0_0EXErrorWithMessage(@"Seeking interrupted."));
        }
      } else if (resolve) {
...
- (NSDictionary *)getStatus
{
  if (!_isLoaded || _player == nil) {
    return [ABI44_0_0EXAVPlayerData getUnloadedStatus];
  }
  ...
  NSMutableDictionary *mutableStatus = [@{ABI44_0_0EXAVPlayerDataStatusIsLoadedKeyPath: @(YES),
                                          
                                          ABI44_0_0EXAVPlayerDataStatusURIKeyPath: [_url absoluteString],
                                          
                                          ABI44_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath: _progressUpdateIntervalMillis,
                                          // positionMillis, playableDurationMillis, and durationMillis may be nil and are added after this definition.
                                          
                                          ABI44_0_0EXAVPlayerDataStatusShouldPlayKeyPath: @(_shouldPlay),
                                          ABI44_0_0EXAVPlayerDataStatusIsPlayingKeyPath: @(isPlaying),
                                          ABI44_0_0EXAVPlayerDataStatusIsBufferingKeyPath: @(isBuffering),
                                          
                                          ABI44_0_0EXAVPlayerDataStatusRateKeyPath: _rate,
                                          ABI44_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath: @(_shouldCorrectPitch),
                                          ABI44_0_0EXAVPlayerDataStatusPitchCorrectionQualityKeyPath: _pitchCorrectionQuality,
                                          ABI44_0_0EXAVPlayerDataStatusVolumeKeyPath: @(_player.volume),
                                          ABI44_0_0EXAVPlayerDataStatusIsMutedKeyPath: @(_player.muted),
                                          ABI44_0_0EXAVPlayerDataStatusIsLoopingKeyPath: @(_isLooping),
                                          
                                          ABI44_0_0EXAVPlayerDataStatusDidJustFinishKeyPath: @(NO),
                                          ABI44_0_0EXAVPlayerDataStatusHasJustBeenInterruptedKeyPath: @(NO),
                                          } mutableCopy];
  
  mutableStatus[ABI44_0_0EXAVPlayerDataStatusPlayableDurationMillisKeyPath] = playableDurationMillis;
  mutableStatus[ABI44_0_0EXAVPlayerDataStatusDurationMillisKeyPath] = durationMillis;
  mutableStatus[ABI44_0_0EXAVPlayerDataStatusPositionMillisKeyPath] = positionMillis;
                ...
                rejecter:(ABI44_0_0EXPromiseRejectBlock)reject
{
  [self _callStatusUpdateCallbackWithExtraFields:@{
                                                   ABI44_0_0EXAVPlayerDataStatusHasJustBeenInterruptedKeyPath: @([self _isPlayerPlaying]),
                                                   }];
...
{
  [self _tryRemoveObserver:_player forKeyPath:ABI44_0_0EXAVPlayerDataObserverStatusKeyPath];
  [self _removeObserversForPlayerItems];
  [self _tryRemoveObserver:_player forKeyPath:ABI44_0_0EXAVPlayerDataObserverRateKeyPath];
  [self _tryRemoveObserver:_player forKeyPath:ABI44_0_0EXAVPlayerDataObserverCurrentItemKeyPath];
  [self _tryRemoveObserver:_player forKeyPath:ABI44_0_0EXAVPlayerDataObserverTimeControlStatusPath];
}
...
{
  [self _tryRemoveObserver:playerItem forKeyPath:ABI44_0_0EXAVPlayerDataObserverStatusKeyPath];
  ...
  [self _tryRemoveObserver:playerItem forKeyPath:ABI44_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath];
  [self _tryRemoveObserver:playerItem forKeyPath:ABI44_0_0EXAVPlayerDataObserverMetadataKeyPath];
}
...
- (void)_addObserversForPlayerItem:(AVPlayerItem *)playerItem
{
  ...
  void (^didPlayToEndTimeObserverBlock)(NSNotification *note) = ^(NSNotification *note) {
    ...
    if (strongEXAV) {
      dispatch_async(strongEXAV.methodQueue, ^{
        ABI44_0_0EX_ENSURE_STRONGIFY(self);
        [self _callStatusUpdateCallbackWithExtraFields:@{ABI44_0_0EXAVPlayerDataStatusDidJustFinishKeyPath: @(YES)}];
        // If the player is looping, we would only like to advance to next item (which is handled by actionAtItemEnd)
        if (!self.isLooping) {
          [self.player pause];
          self.shouldPlay = NO;
          __strong ABI44_0_0EXAV *strongEXAVInner = self.exAV;
          if (strongEXAVInner) {
  ...
  [self _addObserver:playerItem forKeyPath:ABI44_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath];
  [self _addObserver:playerItem forKeyPath:ABI44_0_0EXAVPlayerDataObserverStatusKeyPath];
  [self _addObserver:playerItem forKeyPath:ABI44_0_0EXAVPlayerDataObserverMetadataKeyPath];
}
...
- (void)_addObserversForNewPlayer
{
  ...
  [self _addObserver:_player forKeyPath:ABI44_0_0EXAVPlayerDataObserverRateKeyPath];
  NSUInteger currentItemObservationOptions = NSKeyValueObservingOptionOld | NSKeyValueObservingOptionNew;
  [self _addObserver:_player forKeyPath:ABI44_0_0EXAVPlayerDataObserverCurrentItemKeyPath options:currentItemObservationOptions];
  [self _addObserver:_player forKeyPath:ABI44_0_0EXAVPlayerDataObserverTimeControlStatusPath]; // Only available after iOS 10
                       ...
                       context:(void *)context
{
  ...
  __weak ABI44_0_0EXAVPlayerData *weakSelf = nil;
  ...
  // as the ABI44_0_0EXAVPlayerData is being deallocated, so let's early return.
  //
  ...
  __strong ABI44_0_0EXAV *strongEXAV = _exAV;
  if (strongEXAV == nil) {
    return;
  }
  
  dispatch_async(strongEXAV.methodQueue, ^{
    __strong ABI44_0_0EXAVPlayerData *strongSelf = weakSelf;
    if (strongSelf) {
      if (object == strongSelf.player) {
        if ([keyPath isEqualToString:ABI44_0_0EXAVPlayerDataObserverStatusKeyPath]) {
        ...
        } else if ([keyPath isEqualToString:ABI44_0_0EXAVPlayerDataObserverRateKeyPath]) {
        ...
        } else if ([keyPath isEqualToString:ABI44_0_0EXAVPlayerDataObserverTimeControlStatusPath]) {
        ...
        } else if ([keyPath isEqualToString:ABI44_0_0EXAVPlayerDataObserverCurrentItemKeyPath]) {
        ...
        if ([keyPath isEqualToString:ABI44_0_0EXAVPlayerDataObserverStatusKeyPath]) {
          ...
          [strongSelf _callStatusUpdateCallback];
        } else if ([keyPath isEqualToString:ABI44_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath]) {
          [strongSelf _callStatusUpdateCallback];
        } else if ([keyPath isEqualToString:ABI44_0_0EXAVPlayerDataObserverMetadataKeyPath] && strongSelf.metadataUpdateCallback) {
...
- (void)setSampleBufferCallback:(ABI44_0_0EXAudioSampleCallback *)sampleBufferCallback
{
...
- (ABI44_0_0EXAudioSampleCallback *)sampleBufferCallback
{
...
- (void)installTap
{
  ...
  if (!track)
  {
    ABI44_0_0EXLogError(@"Failed to find a track in the current player item!");
    return;
  }
  ...
  if (audioMix) {
    ...
    if (audioMixInputParameters) {
      ...
      callbacks.init = ABI44_0_0EXTapInit;
      callbacks.finalize = ABI44_0_0EXTapFinalize;
      callbacks.prepare = ABI44_0_0EXTapPrepare;
      callbacks.unprepare = ABI44_0_0EXTapUnprepare;
      callbacks.process = ABI44_0_0EXTapProcess;
      ...
      if (status == noErr) {
        ...
        ABI44_0_0EXLogError(@"Failed to create MTAudioProcessingTap!");
      }
    }
  }
}
...
void ABI44_0_0EXTapInit(MTAudioProcessingTapRef tap, void *clientInfo, void **tapStorageOut)
{
...
void ABI44_0_0EXTapFinalize(MTAudioProcessingTapRef tap)
{
...
void ABI44_0_0EXTapPrepare(MTAudioProcessingTapRef tap, CMItemCount maxFrames, const AudioStreamBasicDescription *processingFormat)
{
  AVAudioTapProcessorContext *context = (AVAudioTapProcessorContext *)MTAudioProcessingTapGetStorage(tap);
  ...
  if (processingFormat->mFormatID != kAudioFormatLinearPCM) {
    ABI44_0_0EXLogInfo(@"Audio Format ID for audioProcessingTap: LinearPCM");
  ...
  if (!(processingFormat->mFormatFlags & kAudioFormatFlagIsFloat)) {
    ABI44_0_0EXLogInfo(@"Audio Format ID for audioProcessingTap: Float only");
...
void ABI44_0_0EXTapUnprepare(MTAudioProcessingTapRef tap)
{
...
void ABI44_0_0EXTapProcess(MTAudioProcessingTapRef tap, CMItemCount numberFrames, MTAudioProcessingTapFlags flags, AudioBufferList *bufferListInOut, CMItemCount *numberFramesOut, MTAudioProcessingTapFlags *flagsOut)
{
  AVAudioTapProcessorContext *context =
    (AVAudioTapProcessorContext *)MTAudioProcessingTapGetStorage(tap);

  if (!context->self) {
    ABI44_0_0EXLogWarn(@"Audio Processing Tap has been destroyed!");
    return;
  }

  ABI44_0_0EXAVPlayerData *_self = ((__bridge ABI44_0_0EXAVPlayerData *)context->self);
  ...
  if (noErr != status) {
    ABI44_0_0EXLogWarn(@"MTAudioProcessingTapGetSourceAudio: %d", (int)status);
    return;
  }
...
#pragma mark - ABI44_0_0EXAVObject
...
- (ABI44_0_0EXAVAudioSessionMode)getAudioSessionModeRequired
{
  if (_player && ([self _isPlayerPlaying] || [self _shouldPlayerPlay])) {
    return _isMuted ? ABI44_0_0EXAVAudioSessionModeActiveMuted : ABI44_0_0EXAVAudioSessionModeActive;
  }
  return ABI44_0_0EXAVAudioSessionModeInactive;
}
...
{
  // ABI44_0_0EXAudio already forced pause.
}
