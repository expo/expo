...
using namespace ABI44_0_0expo::av;
...
@implementation ABI44_0_0EXAV (AudioSampleCallback)
                 ...
                 withSoundDictionary:(NSMutableDictionary <NSNumber *, ABI44_0_0EXAVPlayerData *> *)soundDictionary
{
  ...
  auto setAudioSampleCallback = [weakCallInvoker, weakSoundDictionary](jsi::Runtime &runtime,
    ...
    if (argsCount > 1 && args[1].isObject()) {
      ...
      ABI44_0_0EXAudioSampleCallback* objcWrapper = [[ABI44_0_0EXAudioSampleCallback alloc] initWithCallbackWrapper:(std::move(wrapper))];
