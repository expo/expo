...
@implementation UIFont (ABI44_0_0EXFontLoader)

- (UIFont *)ABI44_0_0EXFontWithSize:(CGFloat)fontSize
{
  for (id<ABI44_0_0EXFontScalerInterface> fontScaler in currentFontScalers) {
  ...
  return [self ABI44_0_0EXFontWithSize:fontSize];
}
...
@implementation ABI44_0_0EXFontScalersManager

ABI44_0_0EX_REGISTER_SINGLETON_MODULE(FontScalersManager);
...
+ (void)initialize
{
  ...
  dispatch_once(&initializeCurrentFontScalersOnce, ^{
    ...
    SEL exUpdate = @selector(ABI44_0_0EXFontWithSize:);
...
- (void)registerFontScaler:(id<ABI44_0_0EXFontScalerInterface>)fontScaler
{
