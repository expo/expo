...
#import <ABI44_0_0EXConstants/ABI44_0_0EXConstantsInstallationIdProvider.h>

NSString * const ABI44_0_0EXConstantsExecutionEnvironmentBare = @"bare";
NSString * const ABI44_0_0EXConstantsExecutionEnvironmentStandalone = @"standalone";
NSString * const ABI44_0_0EXConstantsExecutionEnvironmentStoreClient = @"storeClient";

@interface ABI44_0_0EXConstantsService ()

@property (nonatomic, strong) NSString *sessionId;
@property (nonatomic, strong) ABI44_0_0EXConstantsInstallationIdProvider *installationIdProvider;

@end

@implementation ABI44_0_0EXConstantsService

- (instancetype)init
{
  return [self initWithInstallationIdProvider:[[ABI44_0_0EXConstantsInstallationIdProvider alloc] init]];
}

- (instancetype)initWithInstallationIdProvider:(ABI44_0_0EXConstantsInstallationIdProvider *)installationIdProvider
{
  if (self = [super init]) {
...
{
  return @[@protocol(ABI44_0_0EXConstantsInterface)];
}
...
- (NSDictionary *)constants
{
  ...
  return @{
           ...
           @"executionEnvironment": ABI44_0_0EXConstantsExecutionEnvironmentBare,
           ...
           @"manifest": ABI44_0_0EXNullIfNil([[self class] appConfig]),
           @"platform": @{
               @"ios": @{
                   @"buildNumber": [self buildVersion],
                   @"platform": [[self class] devicePlatform],
                   @"model": ABI44_0_0EXNullIfNil([[self class] deviceModel]),
...
{
  NSBundle *frameworkBundle = [NSBundle bundleForClass:[ABI44_0_0EXConstantsService class]];
  NSURL *bundleUrl = [frameworkBundle.resourceURL URLByAppendingPathComponent:@"ABI44_0_0EXConstants.bundle"];
