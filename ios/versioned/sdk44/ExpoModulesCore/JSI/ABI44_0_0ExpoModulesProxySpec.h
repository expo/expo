...
public:
  ExpoModulesProxySpec(std::shared_ptr<CallInvoker> callInvoker, ABI44_0_0EXNativeModulesProxy *nativeModulesProxy);

  ABI44_0_0EXNativeModulesProxy *nativeModulesProxy;
};
