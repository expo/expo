...
public struct Promise: AnyArgument {
  ...
  /**
   The rejecter that is compatible with the legacy `ABI44_0_0EXPromiseRejectBlock`.
   Necessary in some places not converted to Swift, such as `ABI44_0_0EXPermissionsMethodsDelegate`.
   */
  public var legacyRejecter: ABI44_0_0EXPromiseRejectBlock {
