...
@protocol ABI44_0_0EXTaskConsumerInterface;

@protocol ABI44_0_0EXTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI44_0_0EXTaskConsumerInterface> __nonnull consumer;
