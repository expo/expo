...
// Interface for ABI44_0_0EXTaskManager module.

@protocol ABI44_0_0EXTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI44_0_0EXTaskConsumerInterface protocol.
 */
