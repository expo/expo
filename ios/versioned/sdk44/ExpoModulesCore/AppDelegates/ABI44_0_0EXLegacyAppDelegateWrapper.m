...
#import <ABI44_0_0ExpoModulesCore/ABI44_0_0EXLegacyAppDelegateWrapper.h>
...
@implementation ABI44_0_0EXLegacyAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitializedAndSorted {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI44_0_0EXSingletonModule*> * singletonModules = [[ABI44_0_0EXModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI44_0_0EXSingletonModule *singletonModule in singletonModules) {
