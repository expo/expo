...
#import <ABI44_0_0EXImageManipulator/ABI44_0_0EXImageManipulatorModule.h>
...
@interface ABI44_0_0EXImageManipulatorModule ()
...
@implementation ABI44_0_0EXImageManipulatorModule

ABI44_0_0EX_EXPORT_MODULE(ExpoImageManipulator);
...
ABI44_0_0EX_EXPORT_METHOD_AS(manipulateAsync,
                    uri:(NSString *)uri
                    ...
                    reject:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([_fileSystem permissionsForURI:url] & ABI44_0_0EXFileSystemPermissionRead)) {
