...
@interface ABI44_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) id<ABI44_0_0EXCameraInterface> camera;
...
@implementation ABI44_0_0EXGLCameraObject
