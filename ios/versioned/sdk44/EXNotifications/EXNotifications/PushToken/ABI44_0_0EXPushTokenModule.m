...
#import <ABI44_0_0EXNotifications/ABI44_0_0EXPushTokenModule.h>
#import <ABI44_0_0EXNotifications/ABI44_0_0EXPushTokenManager.h>
...
@interface ABI44_0_0EXPushTokenModule ()

@property (nonatomic, weak) id<ABI44_0_0EXPushTokenManager> pushTokenManager;
...
@property (nonatomic, strong) ABI44_0_0EXPromiseResolveBlock getDevicePushTokenResolver;
@property (nonatomic, strong) ABI44_0_0EXPromiseRejectBlock getDevicePushTokenRejecter;

@end

@implementation ABI44_0_0EXPushTokenModule

ABI44_0_0EX_EXPORT_MODULE(ExpoPushTokenManager);

# pragma mark - Exported methods

ABI44_0_0EX_EXPORT_METHOD_AS(getDevicePushTokenAsync,
                    getDevicePushTokenResolving:(ABI44_0_0EXPromiseResolveBlock)resolve rejecting:(ABI44_0_0EXPromiseRejectBlock)reject)
{
...
# pragma mark - ABI44_0_0EXPushTokenListener
