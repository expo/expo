...
#import <ABI44_0_0EXNotifications/NSDictionary+ABI44_0_0EXNotificationsVerifyingClass.h>
...
@interface ABI44_0_0EXNotificationSchedulerModule ()

@property (nonatomic, weak) id<ABI44_0_0EXNotificationBuilder> builder;

@end

@implementation ABI44_0_0EXNotificationSchedulerModule

ABI44_0_0EX_EXPORT_MODULE(ExpoNotificationScheduler);

- (void)setModuleRegistry:(ABI44_0_0EXModuleRegistry *)moduleRegistry
{
  _builder = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI44_0_0EXNotificationBuilder)];
}

# pragma mark - Exported methods

ABI44_0_0EX_EXPORT_METHOD_AS(getAllScheduledNotificationsAsync,
                    getAllScheduledNotifications:(ABI44_0_0EXPromiseResolveBlock)resolve reject:(ABI44_0_0EXPromiseRejectBlock)reject
                    )
{
...
ABI44_0_0EX_EXPORT_METHOD_AS(scheduleNotificationAsync,
                     scheduleNotification:(NSString *)identifier notificationSpec:(NSDictionary *)notificationSpec triggerSpec:(NSDictionary *)triggerSpec resolve:(ABI44_0_0EXPromiseResolveBlock)resolve rejecting:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  @try {
...
ABI44_0_0EX_EXPORT_METHOD_AS(cancelScheduledNotificationAsync,
                     cancelNotification:(NSString *)identifier resolve:(ABI44_0_0EXPromiseResolveBlock)resolve rejecting:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  [[UNUserNotificationCenter currentNotificationCenter] removePendingNotificationRequestsWithIdentifiers:@[identifier]];
  resolve(nil);
}

ABI44_0_0EX_EXPORT_METHOD_AS(cancelAllScheduledNotificationsAsync,
                     cancelAllNotificationsWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve rejecting:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  [[UNUserNotificationCenter currentNotificationCenter] removeAllPendingNotificationRequests];
  resolve(nil);
}

ABI44_0_0EX_EXPORT_METHOD_AS(getNextTriggerDateAsync,
                    getNextTriggerDate:(NSDictionary *)triggerSpec resolve:(ABI44_0_0EXPromiseResolveBlock)resolve rejecting:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  @try {
...
- (NSArray * _Nonnull)serializeNotificationRequests:(NSArray<UNNotificationRequest *> * _Nonnull) requests
{
  ...
  for (UNNotificationRequest *request in requests) {
    [serializedRequests addObject:[ABI44_0_0EXNotificationSerializer serializedNotificationRequest:request]];
  }
