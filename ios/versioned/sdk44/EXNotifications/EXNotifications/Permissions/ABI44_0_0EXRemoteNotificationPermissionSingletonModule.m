...
@interface ABI44_0_0EXRemoteNotificationPermissionSingletonModule ()

@property (nonatomic, strong) NSPointerArray *delegates;

@end

@implementation ABI44_0_0EXRemoteNotificationPermissionSingletonModule

ABI44_0_0EX_REGISTER_SINGLETON_MODULE(RemoteNotificationPermissionPublisher);
