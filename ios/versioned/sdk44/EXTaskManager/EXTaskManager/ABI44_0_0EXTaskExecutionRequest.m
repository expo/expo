...
@interface ABI44_0_0EXTaskExecutionRequest ()

@property (nonatomic, strong, nullable) NSMutableSet<id<ABI44_0_0UMTaskInterface>> *tasks;
...
@implementation ABI44_0_0EXTaskExecutionRequest
...
- (void)_maybeExecuteCallback
{
  if (_callback) {
    ...
    __strong ABI44_0_0EXTaskExecutionRequest *strongSelf = self;
