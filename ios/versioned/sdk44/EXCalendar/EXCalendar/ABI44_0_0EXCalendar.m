...
#import <ABI44_0_0EXCalendar/ABI44_0_0EXCalendar.h>
#import <ABI44_0_0EXCalendar/ABI44_0_0EXCalendarConverter.h>
...
@implementation ABI44_0_0EXCalendar
...
ABI44_0_0EX_EXPORT_MODULE(ExpoCalendar);
...
- (void)setModuleRegistry:(ABI44_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  [ABI44_0_0EXPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI44_0_0EXCalendarPermissionRequester new],
                                                    [ABI44_0_0EXRemindersPermissionRequester new]
                                                    ]
...
ABI44_0_0EX_EXPORT_METHOD_AS(getCalendarsAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve([ABI44_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI44_0_0EX_EXPORT_METHOD_AS(getDefaultCalendarAsync,
                    getDefaultCalendarAsync:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejector:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  if (![self _checkCalendarPermissions:reject]) {
    return;
  }
  ...
  resolve([ABI44_0_0EXCalendarConverter serializeCalendar:defaultCalendar]);
}

ABI44_0_0EX_EXPORT_METHOD_AS(saveCalendarAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (color) {
    calendar.CGColor = [ABI44_0_0EXUtilities UIColor:color].CGColor;
...
ABI44_0_0EX_EXPORT_METHOD_AS(deleteCalendarAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(getEventsAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI44_0_0EXUtilities NSDate:startDateStr];
  NSDate *endDate = [ABI44_0_0EXUtilities NSDate:endDateStr];
  ...
  if (calendarEvents) {
    resolve([ABI44_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI44_0_0EX_EXPORT_METHOD_AS(getEventByIdAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (calendarEvent) {
    resolve([ABI44_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI44_0_0EX_EXPORT_METHOD_AS(saveEventAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI44_0_0EXUtilities NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI44_0_0EXUtilities NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI44_0_0EXUtilities NSDate:details[@"instanceStartDate"]];
...
ABI44_0_0EX_EXPORT_METHOD_AS(deleteEventAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *instanceStartDate = [ABI44_0_0EXUtilities NSDate:event[@"instanceStartDate"]];
...
ABI44_0_0EX_EXPORT_METHOD_AS(getAttendeesForEventAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (item.hasAttendees) {
    resolve([ABI44_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI44_0_0EX_EXPORT_METHOD_AS(getRemindersAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI44_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI44_0_0EX_EXPORT_METHOD_AS(getReminderByIdAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (reminder) {
    ...
    resolve([ABI44_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI44_0_0EX_EXPORT_METHOD_AS(saveReminderAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI44_0_0EXUtilities NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI44_0_0EXUtilities NSDate:details[@"dueDate"]];
  NSDate *completionDate = [ABI44_0_0EXUtilities NSDate:details[@"completionDate"]];
...
ABI44_0_0EX_EXPORT_METHOD_AS(deleteReminderAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(getSourcesAsync,
                    getSourcesAsync:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI44_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI44_0_0EX_EXPORT_METHOD_AS(getSourceByIdAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve([ABI44_0_0EXCalendarConverter serializeSource:source]);
}

ABI44_0_0EX_EXPORT_METHOD_AS(getCalendarPermissionsAsync,
                    getCalendarPermissionsAsync:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  [ABI44_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI44_0_0EXCalendarPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI44_0_0EX_EXPORT_METHOD_AS(requestCalendarPermissionsAsync,
                    requestCalendarPermissionsAsync:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
...
ABI44_0_0EX_EXPORT_METHOD_AS(getRemindersPermissionsAsync,
                    getRemindersPermissionsAsync:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  [ABI44_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI44_0_0EXRemindersPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI44_0_0EX_EXPORT_METHOD_AS(requestRemindersPermissionsAsync,
                    requestRemindersPermissionsAsync:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  [ABI44_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI44_0_0EXRemindersPermissionRequester class]
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI44_0_0EXUtilities NSDate:alarm[@"absoluteDate"]];
...
- (EKRecurrenceRule *)_createRecurrenceRule:(NSDictionary *)recurrenceRule
{
  ...
  if (recurrenceRule[@"endDate"]) {
      endDate = [ABI44_0_0EXUtilities NSDate:recurrenceRule[@"endDate"]];
  }
...
- (BOOL)_checkPermissions:(EKEntityType)entity reject:(ABI44_0_0EXPromiseRejectBlock)reject
{
  ...
  switch (entity) {
    case EKEntityTypeEvent:
      requesterClass = [ABI44_0_0EXCalendarPermissionRequester class];
      break;
    case EKEntityTypeReminder:
      requesterClass = [ABI44_0_0EXRemindersPermissionRequester class];
      break;
    default: {
...
- (BOOL)_checkCalendarPermissions:(ABI44_0_0EXPromiseRejectBlock)reject
{
  return [self _checkPermissions:EKEntityTypeEvent reject:reject];
}

- (BOOL)_checkRemindersPermissions:(ABI44_0_0EXPromiseRejectBlock)reject
{
...
- (void)_initializePermittedEntities
{
  ...
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI44_0_0EXCalendarPermissionRequester class]]) {
    permittedEntities |= EKEntityMaskEvent;
  }
  
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI44_0_0EXRemindersPermissionRequester class]]) {
