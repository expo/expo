...
@implementation ABI44_0_0EXBackgroundFetchTaskConsumer

+ (BOOL)supportsLaunchReason:(ABI44_0_0UMTaskLaunchReason)launchReason
{
  return launchReason == ABI44_0_0UMTaskLaunchReasonBackgroundFetch;
}
...
- (NSUInteger)normalizeTaskResult:(id)result
{
  ...
  switch ([result unsignedIntegerValue]) {
    case ABI44_0_0EXBackgroundFetchResultNewData:
      return UIBackgroundFetchResultNewData;
    case ABI44_0_0EXBackgroundFetchResultFailed:
      return UIBackgroundFetchResultFailed;
    case ABI44_0_0EXBackgroundFetchResultNoData:
    default:
      return UIBackgroundFetchResultNoData;
  }
}
