...
#import <ABI44_0_0EXSensors/ABI44_0_0EXAccelerometer.h>
#import <ABI44_0_0ExpoModulesCore/ABI44_0_0EXAccelerometerInterface.h>

@implementation ABI44_0_0EXAccelerometer

ABI44_0_0EX_EXPORT_MODULE(ExponentAccelerometer);
...
{
  return [moduleRegistry getModuleImplementingProtocol:@protocol(ABI44_0_0EXAccelerometerInterface)];
}
