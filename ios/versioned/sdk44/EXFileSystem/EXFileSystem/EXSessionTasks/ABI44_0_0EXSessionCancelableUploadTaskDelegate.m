...
#import <ABI44_0_0EXFileSystem/ABI44_0_0EXSessionCancelableUploadTaskDelegate.h>

@interface ABI44_0_0EXSessionCancelableUploadTaskDelegate ()

@property (strong, nonatomic, readonly) ABI44_0_0EXUploadDelegateOnSendCallback onSendCallback;
@property (weak, nonatomic) ABI44_0_0EXTaskHandlersManager *manager;
@property (strong, nonatomic) NSString *uuid;

@end

@implementation ABI44_0_0EXSessionCancelableUploadTaskDelegate
