...
typedef struct ABI11_0_0RCTJSCWrapper {
...
} ABI11_0_0RCTJSCWrapper;

ABI11_0_0RCT_EXTERN ABI11_0_0RCTJSCWrapper *ABI11_0_0RCTJSCWrapperCreate(BOOL useCustomJSC);
ABI11_0_0RCT_EXTERN void ABI11_0_0RCTJSCWrapperRelease(ABI11_0_0RCTJSCWrapper *wrapper);
 ...
 */
void __attribute__((visibility("hidden"))) ABI11_0_0RCTCustomJSCInit(void *handle);
