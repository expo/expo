...
#import "ABI11_0_0RCTBridgeDelegate.h"
...
@class ABI11_0_0RCTPerformanceLogger;

/**
 * This notification triggers a reload of all bridges currently running.
 * Deprecated, use ABI11_0_0RCTBridge::requestReload instead.
 */
ABI11_0_0RCT_EXTERN NSString *const ABI11_0_0RCTReloadNotification DEPRECATED_ATTRIBUTE;

/**
 * This notification fires when the bridge starts loading the JS bundle.
 */
ABI11_0_0RCT_EXTERN NSString *const ABI11_0_0RCTJavaScriptWillStartLoadingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI11_0_0RCT_EXTERN NSString *const ABI11_0_0RCTJavaScriptDidLoadNotification;

/**
 * This notification fires when the bridge failed to load the JS bundle. The
 * `error` key can be used to determine the error that occured.
 */
ABI11_0_0RCT_EXTERN NSString *const ABI11_0_0RCTJavaScriptDidFailToLoadNotification;
 ...
 */
ABI11_0_0RCT_EXTERN NSString *const ABI11_0_0RCTDidInitializeModuleNotification;
 ...
 */
typedef NSArray<id<ABI11_0_0RCTBridgeModule>> *(^ABI11_0_0RCTBridgeModuleProviderBlock)(void);

/**
 * This function returns the module name for a given class.
 */
ABI11_0_0RCT_EXTERN NSString *ABI11_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI11_0_0RCTBridge : NSObject <ABI11_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI11_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI11_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 * See also -[ABI11_0_0RCTBridgeDelgate shouldBridgeLoadJavaScriptSynchronously], which
 ...
 */
@property (nonatomic, weak, readonly) id<ABI11_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ReactABI11_0_0 Native perf events.
 */
@property (nonatomic, readonly, strong) ABI11_0_0RCTPerformanceLogger *performanceLogger;
