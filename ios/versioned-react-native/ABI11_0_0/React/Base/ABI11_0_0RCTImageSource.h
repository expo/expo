 ...
 */
@interface ABI11_0_0RCTImageSource : NSObject
...
@interface ABI11_0_0RCTConvert (ImageSource)

+ (ABI11_0_0RCTImageSource *)ABI11_0_0RCTImageSource:(id)json;
+ (NSArray<ABI11_0_0RCTImageSource *> *)ABI11_0_0RCTImageSourceArray:(id)json;
