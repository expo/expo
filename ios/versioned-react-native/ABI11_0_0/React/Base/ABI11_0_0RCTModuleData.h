...
@interface ABI11_0_0RCTModuleData : NSObject <ABI11_0_0RCTInvalidating>

- (instancetype)initWithModuleClass:(Class)moduleClass
                             bridge:(ABI11_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;

- (instancetype)initWithModuleInstance:(id<ABI11_0_0RCTBridgeModule>)instance
                                bridge:(ABI11_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI11_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI11_0_0RCTBridgeModule> instance;
