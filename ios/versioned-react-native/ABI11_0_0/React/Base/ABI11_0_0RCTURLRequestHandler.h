 ...
 * are also bridge modules, so should be registered using ABI11_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI11_0_0RCTURLRequestHandler <ABI11_0_0RCTBridgeModule>
...
/**
 * If more than one ABI11_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
