...
extern NSString *const ABI11_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI11_0_0RCTBundleURLProviderDefaultPort;

@interface ABI11_0_0RCTBundleURLProvider : NSObject
