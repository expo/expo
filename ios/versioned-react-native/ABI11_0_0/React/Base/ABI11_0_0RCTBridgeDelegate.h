...
@protocol ABI11_0_0RCTBridgeModule;

@protocol ABI11_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI11_0_0RCTBridge *)bridge;
 ...
 */
- (NSURL *)fallbackSourceURLForBridge:(ABI11_0_0RCTBridge *)bridge;

/**
 * The bridge initializes any registered ABI11_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI11_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI11_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (NSArray<Class> *)whitelistedModulesForBridge:(ABI11_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeLoadJavaScriptSynchronously:(ABI11_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeInitializeNativeModulesSynchronously:(ABI11_0_0RCTBridge *)bridge;
 ...
 */
- (void)loadSourceForBridge:(ABI11_0_0RCTBridge *)bridge
                  withBlock:(ABI11_0_0RCTSourceLoadBlock)loadCallback;
