...
@implementation ABI11_0_0RCTExceptionsManager
{
  __weak id<ABI11_0_0RCTExceptionsManagerDelegate> _delegate;
...
ABI11_0_0RCT_EXPORT_METHOD(reportSoftException:(NSString *)message
...
ABI11_0_0RCT_EXPORT_METHOD(reportFatalException:(NSString *)message
                  stack:(NSArray<NSDictionary *> *)stack
                  exceptionId:(nonnull NSNumber *)exceptionId)
{
  [_bridge.redBox showErrorMessage:message withStack:stack];
  ...
  if (!ABI11_0_0RCT_DEBUG && reloadRetries < _maxReloadAttempts) {
    reloadRetries++;
    [_bridge requestReload];
  } else {
    NSString *description = [@"Unhandled JS Exception: " stringByAppendingString:message];
    NSDictionary *errorInfo = @{ NSLocalizedDescriptionKey: description, ABI11_0_0RCTJSStackTraceKey: stack };
    ABI11_0_0RCTFatal([NSError errorWithDomain:ABI11_0_0RCTErrorDomain code:0 userInfo:errorInfo]);
  }
}

ABI11_0_0RCT_EXPORT_METHOD(updateExceptionMessage:(NSString *)message
                  stack:(NSArray<NSDictionary *> *)stack
                  exceptionId:(nonnull NSNumber *)exceptionId)
{
...
ABI11_0_0RCT_EXPORT_METHOD(reportUnhandledException:(NSString *)message
                  stack:(NSArray<NSDictionary *> *)stack)
{
