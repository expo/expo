...
@implementation ABI11_0_0RCTConvert (UITabBarSystemItem)

ABI11_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI11_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI11_0_0ViewController;
}
