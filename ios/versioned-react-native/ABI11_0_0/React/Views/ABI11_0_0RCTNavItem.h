...
@interface ABI11_0_0RCTNavItem : UIView
...
@property (nonatomic, copy) ABI11_0_0RCTBubblingEventBlock onLeftButtonPress;
@property (nonatomic, copy) ABI11_0_0RCTBubblingEventBlock onRightButtonPress;
