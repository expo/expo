...
#import "ABI11_0_0RCTPhotoLibraryImageLoader.h"
...
@implementation ABI11_0_0RCTPhotoLibraryImageLoader

ABI11_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI11_0_0RCTImageLoader
...
- (ABI11_0_0RCTImageLoaderCancellationBlock)loadImageForURL:(NSURL *)imageURL
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                        resizeMode:(ABI11_0_0RCTResizeMode)resizeMode
                                   progressHandler:(ABI11_0_0RCTImageLoaderProgressBlock)progressHandler
                                partialLoadHandler:(ABI11_0_0RCTImageLoaderPartialLoadBlock)partialLoadHandler
                                 completionHandler:(ABI11_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI11_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI11_0_0RCTResizeModeContain) {
