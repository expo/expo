...
#import "ABI11_0_0RCTLinkingManager.h"

#import "ABI11_0_0RCTBridge.h"
#import "ABI11_0_0RCTEventDispatcher.h"
#import "ABI11_0_0RCTUtils.h"

NSString *const ABI11_0_0RCTOpenURLNotification = @"ABI11_0_0RCTOpenURLNotification";

@implementation ABI11_0_0RCTLinkingManager
...
- (void)startObserving
{
  [[NSNotificationCenter defaultCenter] addObserver:self
                                           selector:@selector(handleOpenURLNotification:)
                                               name:ABI11_0_0RCTOpenURLNotification
                                             object:nil];
}
         ...
         annotation:(id)annotation
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI11_0_0RCTOpenURLNotification
                                                      object:self
                                                    userInfo:payload];
  return YES;
}
                  ...
                  reject:(__unused ABI11_0_0RCTPromiseRejectBlock)reject)
{
  ...
  BOOL canOpen = [ABI11_0_0RCTSharedApplication() canOpenURL:URL];
  resolve(@(canOpen));
}
                  ...
                  reject:(__unused ABI11_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve(ABI11_0_0RCTNullIfNil(initialURL.absoluteString));
}
