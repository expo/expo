...
@interface ABI11_0_0RCTImageStoreManager : NSObject <ABI11_0_0RCTURLRequestHandler>
...
@interface ABI11_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI11_0_0RCTBridge (ABI11_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI11_0_0RCTImageStoreManager *imageStoreManager;
