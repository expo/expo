...
#import "ABI11_0_0RCTLocalAssetImageLoader.h"

#import <libkern/OSAtomic.h>

#import "ABI11_0_0RCTUtils.h"

@implementation ABI11_0_0RCTLocalAssetImageLoader

ABI11_0_0RCT_EXPORT_MODULE()

- (BOOL)canLoadImageURL:(NSURL *)requestURL
{
  return ABI11_0_0RCTIsLocalAssetURL(requestURL);
}
                                  ...
                                  completionHandler:(ABI11_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  ABI11_0_0RCTExecuteOnMainQueue(^{
    ...
    NSString *imageName = ABI11_0_0RCTBundlePathForURL(imageURL);
    ...
    if (image) {
      ...
      completionHandler(ABI11_0_0RCTErrorWithMessage(message), nil);
    }
  });
