...
#import "ABI11_0_0ARTRenderable.h"

@implementation ABI11_0_0ARTRenderable

- (void)setFill:(ABI11_0_0ARTBrush *)fill
{
  [self invalidate];
  _fill = fill;
}
...
- (void)setStrokeDash:(ABI11_0_0ARTCGFloatArray)strokeDash
{
