...
@interface ABI11_0_0ARTRenderable : ABI11_0_0ARTNode

@property (nonatomic, strong) ABI11_0_0ARTBrush *fill;
...
@property (nonatomic, assign) ABI11_0_0ARTCGFloatArray strokeDash;
