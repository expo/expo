...
#import "ABI11_0_0ARTText.h"

#import <CoreText/CoreText.h>

@implementation ABI11_0_0ARTText
...
static void ABI11_0_0ARTFreeTextFrame(ABI11_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI11_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI11_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI11_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI11_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
