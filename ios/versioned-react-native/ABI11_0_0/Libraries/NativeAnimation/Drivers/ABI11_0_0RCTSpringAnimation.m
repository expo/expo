...
@implementation ABI11_0_0RCTSpringAnimation
{
  ...
  ABI11_0_0RCTResponseSenderBlock _callback;
                  ...
                  callBack:(nullable ABI11_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _toValue = [ABI11_0_0RCTConvert CGFloat:config[@"toValue"]];
    _fromValue = valueNode.value;
    _valueNode = valueNode;
    _overshootClamping = [ABI11_0_0RCTConvert BOOL:config[@"overshootClamping"]];
    _restDisplacementThreshold = [ABI11_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
    _restSpeedThreshold = [ABI11_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
    _tension = [ABI11_0_0RCTConvert CGFloat:config[@"tension"]];
    _friction = [ABI11_0_0RCTConvert CGFloat:config[@"friction"]];
