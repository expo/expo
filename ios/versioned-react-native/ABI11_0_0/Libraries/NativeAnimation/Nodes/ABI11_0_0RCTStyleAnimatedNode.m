...
@implementation ABI11_0_0RCTStyleAnimatedNode
{
...
- (void)performUpdate
{
  ...
  [style enumerateKeysAndObjectsUsingBlock:^(NSString *property, NSNumber *nodeTag, __unused BOOL *stop) {
    ABI11_0_0RCTAnimatedNode *node = self.parentNodes[nodeTag];
    if (node && node.hasUpdated) {
      if ([node isKindOfClass:[ABI11_0_0RCTValueAnimatedNode class]]) {
        ABI11_0_0RCTValueAnimatedNode *parentNode = (ABI11_0_0RCTValueAnimatedNode *)node;
        [self->_updatedPropsDictionary setObject:@(parentNode.value) forKey:property];
      } else if ([node isKindOfClass:[ABI11_0_0RCTTransformAnimatedNode class]]) {
        ABI11_0_0RCTTransformAnimatedNode *parentNode = (ABI11_0_0RCTTransformAnimatedNode *)node;
