...
@implementation ABI11_0_0RCTDiffClampAnimatedNode
{
...
{
  ABI11_0_0RCTValueAnimatedNode *inputNode = (ABI11_0_0RCTValueAnimatedNode *)self.parentNodes[_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI11_0_0RCTValueAnimatedNode class]]) {
    ABI11_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
