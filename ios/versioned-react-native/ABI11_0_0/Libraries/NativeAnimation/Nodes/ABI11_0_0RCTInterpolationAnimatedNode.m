...
@implementation ABI11_0_0RCTInterpolationAnimatedNode
{
  __weak ABI11_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI11_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI11_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI11_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI11_0_0RCTInterpolateValue(inputValue,
