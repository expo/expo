...
@implementation ABI11_0_0RCTAnimatedNode
{
  NSMutableDictionary<NSNumber *, ABI11_0_0RCTAnimatedNode *> *_childNodes;
  NSMutableDictionary<NSNumber *, ABI11_0_0RCTAnimatedNode *> *_parentNodes;
}
...
- (NSDictionary<NSNumber *, ABI11_0_0RCTAnimatedNode *> *)childNodes
{
  return _childNodes;
}

- (NSDictionary<NSNumber *, ABI11_0_0RCTAnimatedNode *> *)parentNodes
{
  return _parentNodes;
}

- (void)addChild:(ABI11_0_0RCTAnimatedNode *)child
{
  if (!_childNodes) {
...
- (void)removeChild:(ABI11_0_0RCTAnimatedNode *)child
{
  if (!_childNodes) {
    return;
  }
...
- (void)detachNode
{
  for (ABI11_0_0RCTAnimatedNode *parent in _parentNodes.allValues) {
    [parent removeChild:self];
  }
  for (ABI11_0_0RCTAnimatedNode *child in _childNodes.allValues) {
