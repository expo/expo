...
typedef NS_ENUM(NSInteger, ABI11_0_0RCTTestStatus) {
  ABI11_0_0RCTTestStatusPending = 0,
  ABI11_0_0RCTTestStatusPassed,
  ABI11_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI11_0_0RCTTestModule : NSObject <ABI11_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI11_0_0RCTTestStatus status;
