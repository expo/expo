...
#import "ABI11_0_0RCTTextFieldManager.h"
...
@interface ABI11_0_0RCTTextFieldManager() <UITextFieldDelegate>

@end

@implementation ABI11_0_0RCTTextFieldManager

ABI11_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
  ABI11_0_0RCTTextField *textField = [[ABI11_0_0RCTTextField alloc] initWithEventDispatcher:self.bridge.eventDispatcher];
  textField.delegate = self;
  return textField;
}

- (BOOL)textField:(ABI11_0_0RCTTextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string
{
...
- (BOOL)keyboardInputShouldDelete:(ABI11_0_0RCTTextField *)textField
{
...
ABI11_0_0RCT_EXPORT_VIEW_PROPERTY(caretHidden, BOOL)
ABI11_0_0RCT_EXPORT_VIEW_PROPERTY(autoCorrect, BOOL)
ABI11_0_0RCT_REMAP_VIEW_PROPERTY(editable, enabled, BOOL)
...
ABI11_0_0RCT_EXPORT_VIEW_PROPERTY(clearButtonMode, UITextFieldViewMode)
ABI11_0_0RCT_REMAP_VIEW_PROPERTY(clearTextOnFocus, clearsOnBeginEditing, BOOL)
ABI11_0_0RCT_EXPORT_VIEW_PROPERTY(selectTextOnFocus, BOOL)
ABI11_0_0RCT_EXPORT_VIEW_PROPERTY(blurOnSubmit, BOOL)
ABI11_0_0RCT_EXPORT_VIEW_PROPERTY(keyboardType, UIKeyboardType)
ABI11_0_0RCT_EXPORT_VIEW_PROPERTY(keyboardAppearance, UIKeyboardAppearance)
ABI11_0_0RCT_EXPORT_VIEW_PROPERTY(onSelectionChange, ABI11_0_0RCTDirectEventBlock)
ABI11_0_0RCT_EXPORT_VIEW_PROPERTY(returnKeyType, UIReturnKeyType)
ABI11_0_0RCT_EXPORT_VIEW_PROPERTY(enablesReturnKeyAutomatically, BOOL)
ABI11_0_0RCT_EXPORT_VIEW_PROPERTY(secureTextEntry, BOOL)
ABI11_0_0RCT_REMAP_VIEW_PROPERTY(password, secureTextEntry, BOOL) // backwards compatibility
ABI11_0_0RCT_REMAP_VIEW_PROPERTY(color, textColor, UIColor)
ABI11_0_0RCT_REMAP_VIEW_PROPERTY(autoCapitalize, autocapitalizationType, UITextAutocapitalizationType)
ABI11_0_0RCT_REMAP_VIEW_PROPERTY(textAlign, textAlignment, NSTextAlignment)
ABI11_0_0RCT_REMAP_VIEW_PROPERTY(selectionColor, tintColor, UIColor)
ABI11_0_0RCT_CUSTOM_VIEW_PROPERTY(fontSize, NSNumber, ABI11_0_0RCTTextField)
{
  view.font = [ABI11_0_0RCTFont updateFont:view.font withSize:json ?: @(defaultView.font.pointSize)];
}
ABI11_0_0RCT_CUSTOM_VIEW_PROPERTY(fontWeight, NSString, __unused ABI11_0_0RCTTextField)
{
  view.font = [ABI11_0_0RCTFont updateFont:view.font withWeight:json]; // defaults to normal
}
ABI11_0_0RCT_CUSTOM_VIEW_PROPERTY(fontStyle, NSString, __unused ABI11_0_0RCTTextField)
{
  view.font = [ABI11_0_0RCTFont updateFont:view.font withStyle:json]; // defaults to normal
}
ABI11_0_0RCT_CUSTOM_VIEW_PROPERTY(fontFamily, NSString, ABI11_0_0RCTTextField)
{
...
- (ABI11_0_0RCTViewManagerUIBlock)uiBlockToAmendWithShadowView:(ABI11_0_0RCTShadowView *)shadowView
{
  ...
  return ^(__unused ABI11_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, ABI11_0_0RCTTextField *> *viewRegistry) {
