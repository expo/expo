#import "ABI11_0_0EXImagePicker.h"
...
@interface ABI11_0_0EXImagePicker ()
...
@implementation ABI11_0_0EXImagePicker

ABI11_0_0RCT_EXPORT_MODULE(ExponentImagePicker);
...
ABI11_0_0RCT_EXPORT_METHOD(launchCameraAsync:(NSDictionary *)options
...
ABI11_0_0RCT_EXPORT_METHOD(launchImageLibraryAsync:(NSDictionary *)options
                  resolver:(ABI11_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI11_0_0RCTPromiseRejectBlock)reject)
{
    self.resolve = resolve;
...
- (void)launchImagePicker:(RNImagePickerTarget)target
{
    ...
    if (target == RNImagePickerTargetCamera) {
        ...
        self.reject(ABI11_0_0RCTErrorUnspecified, @"Camera not available on simulator", nil);
        return;
#else
        ...
        if ([self.options objectForKey:@"storageOptions"] && [[self.options objectForKey:@"storageOptions"] isKindOfClass:[NSDictionary class]]) {
            ...
            if ([storageOptions objectForKey:@"path"]) {
                ...
                if (error) {
                    ...
                    self.reject(ABI11_0_0RCTErrorUnspecified, error.localizedFailureReason, error);
                    return;
                }
                else {
