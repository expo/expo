...
NSString * const ABI11_0_0EXLocationChangedEventName = @"Exponent.locationChanged";

@interface ABI11_0_0EXLocationDelegate : NSObject <CLLocationManagerDelegate>
...
@implementation ABI11_0_0EXLocationDelegate
...
@interface ABI11_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI11_0_0EXLocationDelegate*> *delegates;

@end

@implementation ABI11_0_0EXLocation

ABI11_0_0RCT_EXPORT_MODULE(ExponentLocation)
...
{
  return @[ABI11_0_0EXLocationChangedEventName];
}


ABI11_0_0RCT_REMAP_METHOD(getCurrentPositionAsync,
...
ABI11_0_0RCT_REMAP_METHOD(watchPositionImplAsync,
                 ...
                 rejecter:(ABI11_0_0RCTPromiseRejectBlock)reject)
{
  ...
  locMgr.distanceFilter = options[@"distanceInterval"] ? [ABI11_0_0RCTConvert double:options[@"distanceInterval"]] ?: kCLDistanceFilterNone : kCLLocationAccuracyHundredMeters;
  locMgr.desiredAccuracy = [ABI11_0_0RCTConvert BOOL:options[@"enableHighAccuracy"]] ? kCLLocationAccuracyBest : kCLLocationAccuracyHundredMeters;

  __weak typeof(self) weakSelf = self;
  ABI11_0_0EXLocationDelegate *delegate = [[ABI11_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject) {
      ...
      [weakSelf sendEventWithName:ABI11_0_0EXLocationChangedEventName body:body];
    }
...
ABI11_0_0RCT_REMAP_METHOD(removeWatchAsync,
                 watchId:(nonnull NSNumber *)watchId
                 resolver:(ABI11_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI11_0_0RCTPromiseRejectBlock)reject)
{
  ABI11_0_0EXLocationDelegate *delegate = _delegates[watchId];
  if (delegate) {
