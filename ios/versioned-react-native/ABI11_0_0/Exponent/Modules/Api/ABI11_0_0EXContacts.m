...
#import "ABI11_0_0EXContacts.h"

@import AddressBook;

@interface ABI11_0_0EXContacts ()

@property (nonatomic, assign) ABAddressBookRef addressBookRef;

@end

@implementation ABI11_0_0EXContacts

ABI11_0_0RCT_EXPORT_MODULE(ExponentContacts);
 ...
 */
ABI11_0_0RCT_EXPORT_METHOD(getContactsAsync:(NSArray *)fields resolver:(ABI11_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI11_0_0RCTPromiseRejectBlock)reject)
{
...
- (void)_getContactsWithPermissionGrantedAsync: (NSArray *)fields addressBook:(ABAddressBookRef)addressBook resolver:(ABI11_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI11_0_0RCTPromiseRejectBlock)reject
{
