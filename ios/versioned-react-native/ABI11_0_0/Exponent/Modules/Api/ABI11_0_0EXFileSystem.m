...
@implementation NSData (ABI11_0_0EXFileSystem)
...
@interface ABI11_0_0EXFileSystem ()
...
@implementation ABI11_0_0EXFileSystem
...
{
  if (self = [super init]) {
    NSString *subdir = [ABI11_0_0EXVersionManager escapedResourceName:experienceId];
...
ABI11_0_0RCT_REMAP_METHOD(downloadAsync,
...
ABI11_0_0RCT_REMAP_METHOD(getInfoAsync,
...
ABI11_0_0RCT_REMAP_METHOD(deleteAsync,
...
- (NSString *)scopedPathWithPath:(NSString *)path withOptions:(NSDictionary *)options
{
  ...
  if (![ABI11_0_0EXFileSystem ensureDirExistsWithPath:prefix]) {
    return nil;
  }
