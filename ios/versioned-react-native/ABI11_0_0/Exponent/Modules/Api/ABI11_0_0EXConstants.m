...
@interface ABI11_0_0EXConstants ()
...
@implementation ABI11_0_0EXConstants
...
{
  NSString *exponentClientVersion = [[[NSBundle mainBundle] infoDictionary] objectForKey:@"ABI11_0_0EXClientVersion"];
