...
@interface ABI11_0_0EXAVPermissionRequester ()

@property (nonatomic, weak) id<ABI11_0_0EXPermissionRequesterDelegate> delegate;

@end

@implementation ABI11_0_0EXAVPermissionRequester
...
+ (NSDictionary *)permissions
{
  ...
  if (!(cameraUsageDescription && microphoneUsageDescription)) {
    ABI11_0_0RCTFatal(ABI11_0_0RCTErrorWithMessage(@"This app is missing either NSCameraUsageDescription or NSMicrophoneUsageDescription, so audio/video services will fail. Add one of these keys to your bundle's Info.plist."));
