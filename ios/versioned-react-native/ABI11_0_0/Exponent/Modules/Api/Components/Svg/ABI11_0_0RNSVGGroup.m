...
@implementation ABI11_0_0RNSVGGroup

- (void)renderLayerTo:(CGContextRef)context
{
    ABI11_0_0RNSVGSvgView* svg = [self getSvgView];
    [self clip:context];
    
    [self traverseSubviews:^(ABI11_0_0RNSVGNode *node) {
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event withTransform:(CGAffineTransform)transform
{
    ...
    for (ABI11_0_0RNSVGNode *node in [self.subviews reverseObjectEnumerator]) {
...
- (void)traverseSubviews:(BOOL (^)(ABI11_0_0RNSVGNode *node))block
{
