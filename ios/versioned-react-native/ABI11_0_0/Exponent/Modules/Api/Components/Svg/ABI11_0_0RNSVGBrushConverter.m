...
@implementation ABI11_0_0RNSVGBrushConverter

- (void)drawLinearGradient:(CGContextRef)context
{
    
    CGGradientRef gradient = CGGradientRetain([ABI11_0_0RCTConvert CGGradient:self.colors offset:0]);
    ...
    ABI11_0_0RNSVGPercentageConverter* convert = [[ABI11_0_0RNSVGPercentageConverter alloc] init];
