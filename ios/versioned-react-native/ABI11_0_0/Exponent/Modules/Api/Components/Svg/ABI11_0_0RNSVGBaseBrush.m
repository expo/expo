...
@implementation ABI11_0_0RNSVGBaseBrush

- (instancetype)initWithArray:(NSArray *)array
{
    if ((self = [super initWithArray:array])) {
        if (array.count != 2) {
            ABI11_0_0RCTLogError(@"-[%@ %@] expects 2 elements, received %@",
...
- (void)paint:(CGContextRef)context opacity:(CGFloat)opacity brushConverter:(ABI11_0_0RNSVGBrushConverter *)brushConverter
{
    ...
    if (brushConverter.type == kABI11_0_0RNSVGLinearGradient) {
        [brushConverter drawLinearGradient:context];
    } else if (brushConverter.type == kABI11_0_0RNSVGRadialGradient) {
        [brushConverter drawRidialGradient:context];
    } else if (brushConverter.type == kABI11_0_0RNSVGPattern) {
        // todo:
    }
