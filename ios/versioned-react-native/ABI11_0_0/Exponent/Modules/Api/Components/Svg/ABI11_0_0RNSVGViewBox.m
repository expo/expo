...
@implementation ABI11_0_0RNSVGViewBox
{
    BOOL _fromSymbol;
}
...
- (void)setMeetOrSlice:(ABI11_0_0RNSVGVBMOS)meetOrSlice
{
...
- (CGAffineTransform)getTransform
{
    ...
    ABI11_0_0RNSVGVBMOS meetOrSlice = self.meetOrSlice;
    ...
    // If align is 'none'
    if (meetOrSlice == kABI11_0_0RNSVGVBMOSNone) {
        ...
        if (![align isEqualToString: @"none"] && meetOrSlice == kABI11_0_0RNSVGVBMOSMeet) {
            scaleX = scaleY = fmin(scaleX, scaleY);
        } else if (![align isEqualToString: @"none"] && meetOrSlice == kABI11_0_0RNSVGVBMOSSlice) {
...
- (void)mergeProperties:(__kindof ABI11_0_0RNSVGNode *)target mergeList:(NSArray<NSString *> *)mergeList
{
    if ([target isKindOfClass:[ABI11_0_0RNSVGUse class]]) {
        ABI11_0_0RNSVGUse *use = target;
        _fromSymbol = YES;
