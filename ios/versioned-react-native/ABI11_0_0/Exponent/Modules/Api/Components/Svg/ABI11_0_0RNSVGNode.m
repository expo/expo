...
#import "ABI11_0_0RNSVGClipPath.h"

@implementation ABI11_0_0RNSVGNode
{
    BOOL _transparent;
}
...
- (void)invalidate
{
    id<ABI11_0_0RNSVGContainer> container = (id<ABI11_0_0RNSVGContainer>)self.superview;
...
- (void)clip:(CGContextRef)context
{
    ...
    if (clipPath) {
        ...
        if (self.clipRule == kABI11_0_0RNSVGCGFCRuleEvenodd) {
...
- (ABI11_0_0RNSVGSvgView *)getSvgView
{
    ...
    while (parent && [parent class] != [ABI11_0_0RNSVGSvgView class]) {
        parent = parent.superview;
    }

    return (ABI11_0_0RNSVGSvgView *)parent;
}
