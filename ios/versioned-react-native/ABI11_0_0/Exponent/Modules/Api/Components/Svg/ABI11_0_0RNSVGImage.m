...
@implementation ABI11_0_0RNSVGImage
{
    CGImageRef _image;
    CGFloat _imageRatio;
}
...
- (void)setSrc:(id)src
{
    ...
    ABI11_0_0RCTImageSource *source = [ABI11_0_0RCTConvert ABI11_0_0RCTImageSource:src];
    _imageRatio = source.size.width / source.size.height;
    _image = CGImageRetain([ABI11_0_0RCTConvert CGImage:src]);
    [self invalidate];
}
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    ABI11_0_0RNSVGViewBox *viewBox = [[ABI11_0_0RNSVGViewBox alloc] init];
