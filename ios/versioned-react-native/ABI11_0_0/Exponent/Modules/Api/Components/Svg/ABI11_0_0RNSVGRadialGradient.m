...
@implementation ABI11_0_0RNSVGRadialGradient
...
- (void)saveDefinition
{
    ABI11_0_0RNSVGBrushConverter *converter = [[ABI11_0_0RNSVGBrushConverter alloc] init];
    converter.colors = self.gradient;
    converter.points = @[self.fx, self.fy, self.rx, self.ry, self.cx, self.cy];
    converter.type = kABI11_0_0RNSVGRadialGradient;
