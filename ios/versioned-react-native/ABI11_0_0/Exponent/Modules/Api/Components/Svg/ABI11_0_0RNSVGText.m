...
#import "ABI11_0_0RNSVGBezierPath.h"
#import <CoreText/CoreText.h>

@implementation ABI11_0_0RNSVGText

static void ABI11_0_0RNSVGFreeTextFrame(ABI11_0_0RNSVGTextFrame frame)
{
    if (frame.count) {
...
- (void)setTextFrame:(ABI11_0_0RNSVGTextFrame)textFrame
{
    ABI11_0_0RNSVGFreeTextFrame(_textFrame);
    [self invalidate];
...
- (CGPathRef)getPath:(CGContextRef)context
{
    ...
    ABI11_0_0RNSVGTextFrame frame = self.textFrame;
    for (int i = 0; i < frame.count; i++) {
        CGFloat shift;
...
- (CGMutablePathRef)setLinePath:(CTLineRef)line
{
    ...
    ABI11_0_0RNSVGBezierPath *bezierPath = [[ABI11_0_0RNSVGBezierPath alloc] initWithBezierCurves:self.path];
