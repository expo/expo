...
@interface ABI11_0_0EXBarCodeScanner ()

@property (nonatomic, weak) ABI11_0_0EXBarCodeScannerManager *manager;
@property (nonatomic, weak) ABI11_0_0RCTBridge *bridge;
@property (nonatomic, copy) ABI11_0_0RCTDirectEventBlock onBarCodeRead;

@end

@implementation ABI11_0_0EXBarCodeScanner
