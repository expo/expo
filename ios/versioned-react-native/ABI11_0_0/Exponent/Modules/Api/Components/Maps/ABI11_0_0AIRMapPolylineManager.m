...
#import "ABI11_0_0AIRMapPolylineManager.h"
...
@interface ABI11_0_0AIRMapPolylineManager()

@end

@implementation ABI11_0_0AIRMapPolylineManager

ABI11_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI11_0_0AIRMapPolyline *polyline = [ABI11_0_0AIRMapPolyline new];
    return polyline;
}
