...
@interface ABI11_0_0EXKernelModule ()
...
@implementation ABI11_0_0EXKernelModule
...
- (void)sendEventWithName:(NSString *)eventName body:(id)body
{
  ...
  [self.bridge enqueueJSCall:@"ABI11_0_0RCTDeviceEventEmitter.emit"
...
ABI11_0_0RCT_EXPORT_METHOD(addDevMenu)
{
...
ABI11_0_0RCT_REMAP_METHOD(routeDidForeground,
...
ABI11_0_0RCT_REMAP_METHOD(onEventSuccess,
...
ABI11_0_0RCT_REMAP_METHOD(onEventFailure,
                 eventId:(NSString *)eventId
