...
#import "ABI11_0_0EXStatusBarManager.h"
...
#if !TARGET_OS_TV
@implementation ABI11_0_0RCTConvert (ABI11_0_0EXStatusBar)

ABI11_0_0RCT_ENUM_CONVERTER(UIStatusBarStyle, (@{
  @"default": @(UIStatusBarStyleDefault),
  @"light-content": @(UIStatusBarStyleLightContent),
  @"dark-content": @(UIStatusBarStyleDefault),
}), UIStatusBarStyleDefault, integerValue);

ABI11_0_0RCT_ENUM_CONVERTER(UIStatusBarAnimation, (@{
...
@interface ABI11_0_0EXStatusBarManager ()

@property (nonatomic, strong) NSDictionary *capturedStatusBarProperties;

@end

@implementation ABI11_0_0EXStatusBarManager

+ (NSString *)moduleName { return @"ABI11_0_0RCTStatusBarManager"; }
...
ABI11_0_0RCT_EXPORT_METHOD(getHeight:(ABI11_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@{
...
ABI11_0_0RCT_EXPORT_METHOD(setStyle:(UIStatusBarStyle)statusBarStyle
                  animated:(BOOL)animated)
{
  if ([[self class] _viewControllerBasedStatusBarAppearance]) {
    ABI11_0_0RCTLogError(@"ABI11_0_0RCTStatusBarManager module requires that the \
                UIViewControllerBasedStatusBarAppearance key in the Info.plist is set to NO");
  } else {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ABI11_0_0RCTSharedApplication() setStatusBarStyle:statusBarStyle
                                     animated:animated];
#pragma clang diagnostic pop
  }
}

ABI11_0_0RCT_EXPORT_METHOD(setHidden:(BOOL)hidden
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ABI11_0_0RCTSharedApplication() setStatusBarHidden:hidden
                                 withAnimation:animation];
#pragma clang diagnostic pop
  }
}

ABI11_0_0RCT_EXPORT_METHOD(setNetworkActivityIndicatorVisible:(BOOL)visible)
{
  ABI11_0_0RCTSharedApplication().networkActivityIndicatorVisible = visible;
}
 ...
 */
ABI11_0_0RCT_REMAP_METHOD(_captureProperties,
                 _capturePropertiesWithResolver:(ABI11_0_0RCTPromiseResolveBlock)resolve
 ...
 *  Normally nobody should use this method because it bypasses the JS state used by the StatusBar component.
 */
ABI11_0_0RCT_EXPORT_METHOD(_applyPropertiesAndForget:(NSDictionary *)properties)
{
...
{
  UIApplication *currentApplication = ABI11_0_0RCTSharedApplication();
  return @{
