...
@implementation ABI11_0_0EXFrameExceptionsManager {
  __weak id<ABI11_0_0RCTExceptionsManagerDelegate> _delegate;
}

@synthesize bridge = _bridge;

+ (NSString *)moduleName { return @"ABI11_0_0RCTExceptionsManager"; }
...
{
  // this will hit ABI11_0_0EXDisabledRedBox when not debugging
