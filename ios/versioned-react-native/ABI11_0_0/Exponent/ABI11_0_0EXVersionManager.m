...
{
  ABI11_0_0RCTDevMenu *devMenuInstance = [self _devMenuInstanceForBridge:bridge];
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
  [((ABI11_0_0RCTBridge *)bridge).eventDispatcher sendDeviceEventWithName:@"toggleElementInspector" body:nil];
...
- (ABI11_0_0RCTDevMenu *)_devMenuInstanceForBridge:(id)bridge
{
  if ([bridge respondsToSelector:@selector(batchedBridge)]) {
    bridge = [bridge batchedBridge];
  }
  ABI11_0_0RCTModuleData *data = [bridge moduleDataForName:@"DevMenu"];
  if (data) {
...
- (NSArray *)extraModulesWithParams:(NSDictionary *)params
{
  ...
  NSMutableArray *extraModules = [NSMutableArray arrayWithArray:
                                  @[
                                    ...
                                    [[ABI11_0_0EXStatusBarManager alloc] init],
