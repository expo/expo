...
#import "ABI30_0_0EXMailComposer.h"
...
@interface ABI30_0_0EXMailComposer ()
...
@implementation ABI30_0_0EXMailComposer

ABI30_0_0RCT_EXPORT_MODULE(ExponentMailComposer);
...
ABI30_0_0RCT_EXPORT_METHOD(composeAsync:(NSDictionary *)options
                  ...
                  rejecter:(ABI30_0_0RCTPromiseRejectBlock)reject)
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    [ABI30_0_0RCTPresentedViewController() presentViewController:composeController animated:YES completion:nil];
  });
}
