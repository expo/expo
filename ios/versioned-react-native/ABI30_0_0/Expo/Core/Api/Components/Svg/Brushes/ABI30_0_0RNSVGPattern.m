...
- (instancetype)initWithArray:(NSArray<id /* imagesource + numbers */> *)array
{
  if ((self = [super initWithArray:array])) {
    ...
    _rect = [ABI30_0_0RCTConvert ABI30_0_0RNSVGCGRect:array offset:2];
  }
  return self;
}
...
- (void)paint:(CGContextRef)context opacity:(CGFloat)opacity brushConverter:(ABI30_0_0RNSVGPainter *)brushConverter;
{
