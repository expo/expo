...
@implementation ABI30_0_0RNSVGViewBox

+ (CGAffineTransform)getTransform:(CGRect)vbRect eRect:(CGRect)eRect align:(NSString *)align meetOrSlice:(ABI30_0_0RNSVGVBMOS)meetOrSlice
{
