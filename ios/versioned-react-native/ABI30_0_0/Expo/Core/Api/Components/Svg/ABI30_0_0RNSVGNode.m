...
#import "ABI30_0_0RNSVGClipPath.h"
#import "ABI30_0_0RNSVGGroup.h"
#import "ABI30_0_0RNSVGGlyphContext.h"

@implementation ABI30_0_0RNSVGNode
{
    ABI30_0_0RNSVGGroup *_textRoot;
    ABI30_0_0RNSVGGlyphContext *glyphContext;
    BOOL _transparent;
    CGPathRef _cachedClipPath;
    ABI30_0_0RNSVGSvgView *_svgView;
}

CGFloat const M_SQRT1_2l = 0.707106781186547524400844362104849039;
CGFloat const ABI30_0_0RNSVG_DEFAULT_FONT_SIZE = 12;
...
- (void)invalidate
{
    id<ABI30_0_0RNSVGContainer> container = (id<ABI30_0_0RNSVGContainer>)self.superview;
    [container invalidate];
}

- (ABI30_0_0RNSVGGroup *)getTextRoot
{
    ABI30_0_0RNSVGNode* node = self;
    if (_textRoot == nil) {
        while (node != nil) {
            if ([node isKindOfClass:[ABI30_0_0RNSVGGroup class]] && [((ABI30_0_0RNSVGGroup*) node) getGlyphContext] != nil) {
                _textRoot = (ABI30_0_0RNSVGGroup*)node;
                break;
            }
            ...
            if (![node isKindOfClass:[ABI30_0_0RNSVGNode class]]) {
                ...
                node = (ABI30_0_0RNSVGNode*)parent;
            }
        }
    }
...
{
    ABI30_0_0RNSVGNode* parent = (ABI30_0_0RNSVGGroup*)[self superview];
    if (![parent isKindOfClass:[ABI30_0_0RNSVGGroup class]]) {
        return nil;
    } else {
...
{
    ABI30_0_0RNSVGGroup* root = [self getTextRoot];
    if (root == nil) {
        return ABI30_0_0RNSVG_DEFAULT_FONT_SIZE;
    }
...
- (void)ReactABI30_0_0SetInheritedBackgroundColor:(UIColor *)inheritedBackgroundColor
{
...
- (ABI30_0_0RNSVGSvgView *)getSvgView
{
    ...
    if ([parent class] == [ABI30_0_0RNSVGSvgView class]) {
        _svgView = parent;
    } else if ([parent isKindOfClass:[ABI30_0_0RNSVGNode class]]) {
        ABI30_0_0RNSVGNode *node = parent;
        _svgView = [node getSvgView];
    } else {
        ABI30_0_0RCTLogError(@"ABI30_0_0RNSVG: %@ should be descendant of a SvgViewShadow.", NSStringFromClass(self.class));
    }
...
{
    return [ABI30_0_0RNSVGPropHelper fromRelativeWithNSString:length
...
{
    ABI30_0_0RNSVGGroup * root = [self getTextRoot];
    ABI30_0_0RNSVGGlyphContext * gc = [root getGlyphContext];
    if (root == nil || gc == nil) {
...
{
    for (ABI30_0_0RNSVGNode *node in self.subviews) {
        if ([node isKindOfClass:[ABI30_0_0RNSVGNode class]]) {
            if (!block(node)) {
                break;
            }
