...
@implementation ABI30_0_0RNSVGImage
{
    CGImageRef _image;
    CGSize _imageSize;
}
...
- (void)setSrc:(id)src
{
    ...
    _image = CGImageRetain([ABI30_0_0RCTConvert CGImage:src]);
    ABI30_0_0RCTImageSource *source = [ABI30_0_0RCTConvert ABI30_0_0RCTImageSource:src];
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    CGAffineTransform viewbox = [ABI30_0_0RNSVGViewBox getTransform:imageBounds eRect:hitArea align:self.align meetOrSlice:self.meetOrSlice];
