...
@implementation ABI30_0_0RNSVGTSpan
{
    CGFloat startOffset;
    CGPathRef _cache;
    CGFloat _pathLength;
    ABI30_0_0RNSVGTextPath *textPath;
    NSArray *lengths;
    NSArray *lines;
...
- (CGMutablePathRef)getLinePath:(NSString *)str
{
    ...
    ABI30_0_0RNSVGGlyphContext* gc = [[self getTextRoot] getGlyphContext];
    ABI30_0_0RNSVGFontData* font = [gc getFont];
     ...
     */
    bool allowOptionalLigatures = letterSpacing == 0 && font->fontVariantLigatures == ABI30_0_0RNSVGFontVariantLigaturesNormal;
     ...
     */
    enum ABI30_0_0RNSVGTextAnchor textAnchor = font->textAnchor;
    ...
    if (hasTextPath) {
        sharpMidLine = ABI30_0_0RNSVGTextPathMidLineFromString([textPath midLine]) == ABI30_0_0RNSVGTextPathMidLineSharp;
        /*
         Name
         side
         Value
         ...
         */
        side = ABI30_0_0RNSVGTextPathSideFromString([textPath side]) == ABI30_0_0RNSVGTextPathSideRight ? -1 : 1;
        /*
         Name
         startOffset
         Value
         ...
         the path is reached.
         */
        double absoluteStartOffset = [ABI30_0_0RNSVGPropHelper fromRelativeWithNSString:textPath.startOffset
        ...
        if (isClosed) {
            ...
            startOfRendering = absoluteStartOffset + (textAnchor == ABI30_0_0RNSVGTextAnchorMiddle ? -halfPathDistance : 0);
            endOfRendering = startOfRendering + _pathLength;
        }
        /*
         ABI30_0_0RNSVGTextPathSpacing spacing = textPath.getSpacing();
         if (spacing == ABI30_0_0RNSVGTextPathSpacing.auto) {
         // Hmm, what to do here?
    ...
    enum ABI30_0_0RNSVGTextLengthAdjust mLengthAdjust = ABI30_0_0RNSVGTextLengthAdjustFromString([self lengthAdjust]);
    if (mTextLength != nil) {
        double author = [ABI30_0_0RNSVGPropHelper fromRelativeWithNSString:mTextLength
        ...
        switch (mLengthAdjust) {
            default:
            case ABI30_0_0RNSVGTextLengthAdjustSpacing:
                // TODO account for ligatures
                letterSpacing += (author - textMeasure) / (n - 1);
                break;
            case ABI30_0_0RNSVGTextLengthAdjustSpacingAndGlyphs:
    ...
    */
    ...
    enum ABI30_0_0RNSVGAlignmentBaseline baseline = ABI30_0_0RNSVGAlignmentBaselineFromString([self getAlignmentBaseline]);
    if (baseline != ABI30_0_0RNSVGAlignmentBaselineBaseline) {
        ...
        switch (baseline) {
            ...
            default:
            case ABI30_0_0RNSVGAlignmentBaselineBaseline:
                // Use the dominant baseline choice of the parent.
                // Match the box’s corresponding baseline to that of its parent.
                baselineShift = 0;
                break;

            case ABI30_0_0RNSVGAlignmentBaselineTextBottom:
            case ABI30_0_0RNSVGAlignmentBaselineAfterEdge:
            case ABI30_0_0RNSVGAlignmentBaselineTextAfterEdge:
            ...
            case ABI30_0_0RNSVGAlignmentBaselineCentral:
            ...
            case ABI30_0_0RNSVGAlignmentBaselineMathematical:
            ...
            case ABI30_0_0RNSVGAlignmentBaselineHanging:
                baselineShift = 0.8 * ascenderHeight;
                break;

            case ABI30_0_0RNSVGAlignmentBaselineTextTop:
            case ABI30_0_0RNSVGAlignmentBaselineBeforeEdge:
            case ABI30_0_0RNSVGAlignmentBaselineTextBeforeEdge:
            ...
            case ABI30_0_0RNSVGAlignmentBaselineBottom:
                // Align the top of the aligned subtree with the top of the line box.
                baselineShift = bottom;
                break;

            case ABI30_0_0RNSVGAlignmentBaselineCenter:
                // Align the center of the aligned subtree with the center of the line box.
                baselineShift = totalHeight / 2;
                break;

            case ABI30_0_0RNSVGAlignmentBaselineTop:
        ...
        switch (baseline) {
            ...
            default:
                if (fontData != nil && [baselineShiftString isEqualToString:@"sub"]) {
                    ...
                    baselineShift -= [ABI30_0_0RNSVGPropHelper fromRelativeWithNSString:baselineShiftString
                                                                   relative:fontSize
                                                                     offset:0
                                                                      scale:1
                                                                   fontSize:fontSize];
...
CGFloat ABI30_0_0getTextAnchorOffset(enum ABI30_0_0RNSVGTextAnchor textAnchor, CGFloat width)
{
    switch (textAnchor) {
        case ABI30_0_0RNSVGTextAnchorStart:
            return 0;
        case ABI30_0_0RNSVGTextAnchorMiddle:
            return -width / 2;
        case ABI30_0_0RNSVGTextAnchorEnd:
            return -width;
    }
...
- (void)setupTextPath:(CGContextRef)context
{
    ...
    lengths = nil;
    textPath = nil;
    [self traverseTextSuperviews:^(__kindof ABI30_0_0RNSVGText *node) {
        if ([node class] == [ABI30_0_0RNSVGTextPath class]) {
            textPath = (ABI30_0_0RNSVGTextPath*) node;
...
- (void)traverseTextSuperviews:(BOOL (^)(__kindof ABI30_0_0RNSVGText *node))block
{
    ABI30_0_0RNSVGText *targetView = self;
    BOOL result = block(self);

    while (targetView && [targetView class] != [ABI30_0_0RNSVGText class] && result) {
        if (![targetView isKindOfClass:[ABI30_0_0RNSVGText class]]) {
            //todo: throw exception here
            break;
        }

        targetView = (ABI30_0_0RNSVGText*)[targetView superview];
