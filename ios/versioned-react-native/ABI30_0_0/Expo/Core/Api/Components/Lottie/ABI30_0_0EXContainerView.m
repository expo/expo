...
#if __has_include(<ReactABI30_0_0/UIView+ReactABI30_0_0.h>)
#import <ReactABI30_0_0/UIView+ReactABI30_0_0.h>
#elif __has_include("UIView+ReactABI30_0_0.h")
#import "UIView+ReactABI30_0_0.h"
#else
#import "ReactABI30_0_0/UIView+ReactABI30_0_0.h"
#endif

@implementation ABI30_0_0EXContainerView {
...
- (void)ReactABI30_0_0SetFrame:(CGRect)frame
{
  ...
  if (_animationView != nil) {
    [_animationView ReactABI30_0_0SetFrame:frame];
  }
}
...
- (void)replaceAnimationView:(LOTAnimationView *)next {
  ...
  [_animationView ReactABI30_0_0SetFrame:self.frame];
  [_animationView setContentMode:UIViewContentModeScaleAspectFit];
