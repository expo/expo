...
#import "ABI30_0_0AIRMapLocalTileOverlay.h"

@implementation ABI30_0_0AIRMapLocalTile {
...
- (void) createTileOverlayAndRendererIfPossible
{
    ...
    self.tileOverlay = [[ABI30_0_0AIRMapLocalTileOverlay alloc] initWithURLTemplate:self.pathTemplate];
