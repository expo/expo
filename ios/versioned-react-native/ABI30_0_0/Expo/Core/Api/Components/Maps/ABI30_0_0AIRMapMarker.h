...
@interface ABI30_0_0AIRMapMarker : MKAnnotationView <MKAnnotation>

@property (nonatomic, strong) ABI30_0_0AIRMapCallout *calloutView;
...
@property (nonatomic, copy) ABI30_0_0RCTDirectEventBlock onSelect;
@property (nonatomic, copy) ABI30_0_0RCTDirectEventBlock onDeselect;
...
@interface ABI30_0_0AIREmptyCalloutBackgroundView : ABI30_0_0SMCalloutBackgroundView
@end
