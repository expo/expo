...
#import "ABI30_0_0RNTapHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ReactABI30_0_0/ABI30_0_0RCTConvert.h>

// ABI30_0_0RNBetterTapGestureRecognizer extends UIGestureRecognizer instead of UITapGestureRecognizer 
...
@interface ABI30_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
@implementation ABI30_0_0RNBetterTapGestureRecognizer {
...
@implementation ABI30_0_0RNTapGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI30_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    ABI30_0_0RNBetterTapGestureRecognizer *recognizer = (ABI30_0_0RNBetterTapGestureRecognizer *)_recognizer;
    ...
    if (prop != nil) {
        recognizer.maxDelay = [ABI30_0_0RCTConvert CGFloat:prop] / 1000.0;
    }

    prop = config[@"maxDurationMs"];
    if (prop != nil) {
        recognizer.maxDuration = [ABI30_0_0RCTConvert CGFloat:prop] / 1000.0;
    }
  
    prop = config[@"maxDist"];
    if (prop != nil) {
        CGFloat dist = [ABI30_0_0RCTConvert CGFloat:prop];
