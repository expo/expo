...
@implementation ABI30_0_0RNGestureHandlerEventExtraData
...
{
    return [[ABI30_0_0RNGestureHandlerEventExtraData alloc]
            initWithData:@{
                           @"x": @(position.x),
                           @"y": @(position.y),
...
@implementation ABI30_0_0RNGestureHandlerEvent
{
    NSNumber *_handlerTag;
    ABI30_0_0RNGestureHandlerState _state;
    ABI30_0_0RNGestureHandlerEventExtraData *_extraData;
}
...
- (instancetype)initWithRactTag:(NSNumber *)ReactABI30_0_0Tag
                     handlerTag:(NSNumber *)handlerTag
                      ...
                      extraData:(ABI30_0_0RNGestureHandlerEventExtraData *)extraData
{
...
@implementation ABI30_0_0RNGestureHandlerStateChange
{
    NSNumber *_handlerTag;
    ABI30_0_0RNGestureHandlerState _state;
    ABI30_0_0RNGestureHandlerState _prevState;
    ABI30_0_0RNGestureHandlerEventExtraData *_extraData;
}
