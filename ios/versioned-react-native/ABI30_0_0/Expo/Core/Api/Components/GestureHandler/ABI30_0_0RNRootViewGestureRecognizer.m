//
//  ABI30_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI30_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI30_0_0RNGestureHandler *otherHandler = [ABI30_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI30_0_0RCTTouchHandler class]];
}
