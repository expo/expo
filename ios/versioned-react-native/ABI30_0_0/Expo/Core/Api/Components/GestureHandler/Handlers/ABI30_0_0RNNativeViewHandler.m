//
//  ABI30_0_0RNNativeViewHandler.m
...
#import "ABI30_0_0RNNativeViewHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ReactABI30_0_0/ABI30_0_0RCTConvert.h>
#import <ReactABI30_0_0/ABI30_0_0RCTScrollView.h>
#import <ReactABI30_0_0/UIView+ReactABI30_0_0.h>

#pragma mark ABI30_0_0RNDummyGestureRecognizer

@implementation ABI30_0_0RNDummyGestureRecognizer
...
#pragma mark ABI30_0_0RNNativeViewgestureHandler

@implementation ABI30_0_0RNNativeViewGestureHandler {
...
- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI30_0_0RNDummyGestureRecognizer alloc] init];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    _shouldActivateOnStart = [ABI30_0_0RCTConvert BOOL:config[@"shouldActivateOnStart"]];
    _disallowInterruption = [ABI30_0_0RCTConvert BOOL:config[@"disallowInterruption"]];
}
...
- (void)bindToView:(UIView *)view
{
    ...
    // is set
    if ([view isKindOfClass:[ABI30_0_0RCTScrollView class]]) {
        // This part of the code is coupled with ABI30_0_0RN implementation of ScrollView native wrapper and
        // we expect for ABI30_0_0RCTScrollView component to contain a subclass of UIScrollview as the only
        // subview
...
- (void)handleTouchDown:(UIView *)sender forEvent:(UIEvent *)event
{
    ...
    [self sendEventsInState:ABI30_0_0RNGestureHandlerStateActive
             forViewWithTag:sender.ReactABI30_0_0Tag
              withExtraData:[ABI30_0_0RNGestureHandlerEventExtraData forPointerInside:YES]];
}

- (void)handleTouchUpOutside:(UIView *)sender forEvent:(UIEvent *)event
{
    [self sendEventsInState:ABI30_0_0RNGestureHandlerStateEnd
             forViewWithTag:sender.ReactABI30_0_0Tag
              withExtraData:[ABI30_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
...
{
    [self sendEventsInState:ABI30_0_0RNGestureHandlerStateCancelled
             forViewWithTag:sender.ReactABI30_0_0Tag
              withExtraData:[ABI30_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
