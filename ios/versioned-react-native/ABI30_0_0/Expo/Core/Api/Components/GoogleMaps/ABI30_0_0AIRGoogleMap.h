...
@interface ABI30_0_0AIRGoogleMap : GMSMapView
...
@property (nonatomic, copy) ABI30_0_0RCTBubblingEventBlock onKmlReady;
...
@property (nonatomic, copy) ABI30_0_0RCTBubblingEventBlock onUserLocationChange;
@property (nonatomic, copy) ABI30_0_0RCTBubblingEventBlock onMarkerPress;
@property (nonatomic, copy) ABI30_0_0RCTBubblingEventBlock onChange;
@property (nonatomic, copy) ABI30_0_0RCTBubblingEventBlock onPoiClick;
@property (nonatomic, copy) ABI30_0_0RCTDirectEventBlock onRegionChange;
@property (nonatomic, copy) ABI30_0_0RCTDirectEventBlock onRegionChangeComplete;
