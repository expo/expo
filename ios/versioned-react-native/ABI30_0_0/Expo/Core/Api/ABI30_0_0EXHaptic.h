...
#if !TARGET_OS_TV
@interface ABI30_0_0RCTConvert (UINotificationFeedback)

+ (UINotificationFeedbackType)UINotificationFeedbackType:(id)json;

@end

@interface ABI30_0_0RCTConvert (UIImpactFeedback)
...
@interface ABI30_0_0EXHaptic : NSObject <ABI30_0_0RCTBridgeModule>
