...
@implementation ABI30_0_0REAStyleNode
{
  NSMutableDictionary<NSString *, ABI30_0_0REANodeID> *_styleConfig;
}
...
- (id)evaluate
{
  ...
  for (NSString *prop in _styleConfig) {
    ABI30_0_0REANode *propNode = [self.nodesManager findNodeByID:_styleConfig[prop]];
