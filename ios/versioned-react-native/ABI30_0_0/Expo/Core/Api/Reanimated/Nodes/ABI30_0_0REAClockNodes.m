#import "ABI30_0_0REAClockNodes.h"
#import "ABI30_0_0REANodesManager.h"

@interface ABI30_0_0REAClockNode ()
...
@implementation ABI30_0_0REAClockNode
...
- (void)start
{
  ...
  __weak ABI30_0_0REAClockNode *weakSelf = self;
...
@implementation ABI30_0_0REAClockOpNode {
...
- (ABI30_0_0REAClockNode*)clockNode
{
  return (ABI30_0_0REAClockNode*)[self.nodesManager findNodeByID:_clockNodeID];
}

@end

@implementation ABI30_0_0REAClockStartNode
...
@implementation ABI30_0_0REAClockStopNode
...
@implementation ABI30_0_0REAClockTestNode
