...
extern NSString *const ABI30_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI30_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI30_0_0RCTBundleURLProvider : NSObject
