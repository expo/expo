...
@implementation ABI30_0_0RCTRootContentView

- (instancetype)initWithFrame:(CGRect)frame
                       bridge:(ABI30_0_0RCTBridge *)bridge
                     ReactABI30_0_0Tag:(NSNumber *)ReactABI30_0_0Tag
               sizeFlexiblity:(ABI30_0_0RCTRootViewSizeFlexibility)sizeFlexibility
{
  if ((self = [super initWithFrame:frame])) {
    _bridge = bridge;
    self.ReactABI30_0_0Tag = ReactABI30_0_0Tag;
    _sizeFlexibility = sizeFlexibility;
    _touchHandler = [[ABI30_0_0RCTTouchHandler alloc] initWithBridge:_bridge];
...
ABI30_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithCoder:(nonnull NSCoder *)aDecoder)
...
- (void)insertReactABI30_0_0Subview:(UIView *)subview atIndex:(NSInteger)atIndex
{
  ...
  [_bridge.performanceLogger markStopForTag:ABI30_0_0RCTPLTTI];
...
- (CGSize)availableSize
{
  ...
  return CGSizeMake(
      _sizeFlexibility & ABI30_0_0RCTRootViewSizeFlexibilityWidth ? INFINITY : size.width,
      _sizeFlexibility & ABI30_0_0RCTRootViewSizeFlexibilityHeight ? INFINITY : size.height
    );
}

- (void)updateAvailableSize
{
  if (!self.ReactABI30_0_0Tag || !_bridge.isValid) {
    return;
  }
...
- (void)invalidate
{
  if (self.userInteractionEnabled) {
    ...
    [(ABI30_0_0RCTRootView *)self.superview contentViewInvalidated];

    [_bridge enqueueJSCall:@"AppRegistry"
                    method:@"unmountApplicationComponentAtRootTag"
                      args:@[self.ReactABI30_0_0Tag]
                completion:NULL];
  }
}
