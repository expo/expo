...
@protocol ABI30_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI30_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI30_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI30_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI30_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI30_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI30_0_0RCTBridge *)bridge;
...
*/
- (BOOL)bridge:(ABI30_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI30_0_0RCTBridge *)bridge
                 onProgress:(ABI30_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI30_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI30_0_0RCTBridge *)bridge
                  withBlock:(ABI30_0_0RCTSourceLoadBlock)loadCallback;
