...
typedef id<ABI30_0_0RCTBridgeModule>(^ABI30_0_0RCTBridgeModuleProvider)(void);

@interface ABI30_0_0RCTModuleData : NSObject <ABI30_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI30_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI30_0_0RCTBridgeModule> instance;
