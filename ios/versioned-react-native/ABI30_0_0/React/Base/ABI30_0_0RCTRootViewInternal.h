 ...
 * classes to change the ABI30_0_0RCTRootViews's internal state.
 */
@interface ABI30_0_0RCTRootView ()

/**
 * This setter should be used only by ABI30_0_0RCTUIManager on ReactABI30_0_0 root view
...
@property (nonatomic, strong) UIView *ReactABI30_0_0PreferredFocusedView;
#endif
