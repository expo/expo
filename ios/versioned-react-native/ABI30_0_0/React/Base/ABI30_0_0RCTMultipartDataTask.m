...
#import "ABI30_0_0RCTMultipartDataTask.h"

@interface ABI30_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI30_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI30_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI30_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI30_0_0RCTMultipartStreamReader *reader = [[ABI30_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI30_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
