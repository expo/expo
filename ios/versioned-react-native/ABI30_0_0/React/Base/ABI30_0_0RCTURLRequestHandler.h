 ...
 * are also bridge modules, so should be registered using ABI30_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI30_0_0RCTURLRequestHandler <ABI30_0_0RCTBridgeModule>
...
/**
 * If more than one ABI30_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
