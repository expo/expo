...
#import "ABI30_0_0RCTBundleURLProvider.h"

#import "ABI30_0_0RCTConvert.h"
#import "ABI30_0_0RCTDefines.h"

NSString *const ABI30_0_0RCTBundleURLProviderUpdatedNotification = @"ABI30_0_0RCTBundleURLProviderUpdatedNotification";

const NSUInteger kABI30_0_0RCTBundleURLProviderDefaultPort = ABI30_0_0RCT_METRO_PORT;

static NSString *const kABI30_0_0RCTJsLocationKey = @"ABI30_0_0RCT_jsLocation";
static NSString *const kABI30_0_0RCTEnableLiveReloadKey = @"ABI30_0_0RCT_enableLiveReload";
static NSString *const kABI30_0_0RCTEnableDevKey = @"ABI30_0_0RCT_enableDev";
static NSString *const kABI30_0_0RCTEnableMinificationKey = @"ABI30_0_0RCT_enableMinification";

@implementation ABI30_0_0RCTBundleURLProvider
...
{
  return @{
    kABI30_0_0RCTEnableLiveReloadKey: @NO,
    kABI30_0_0RCTEnableDevKey: @YES,
    kABI30_0_0RCTEnableMinificationKey: @NO,
  };
}

- (void)settingsUpdated
{
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI30_0_0RCTBundleURLProviderUpdatedNotification object:self];
}
...
static NSURL *serverRootWithHost(NSString *host)
{
  return [NSURL URLWithString:
          [NSString stringWithFormat:@"http://%@:%lu/",
           host, (unsigned long)kABI30_0_0RCTBundleURLProviderDefaultPort]];
}
...
- (NSURL *)jsBundleURLForBundleRoot:(NSString *)bundleRoot fallbackResource:(NSString *)resourceName fallbackExtension:(NSString *)extension
{
  ...
  if (!packagerServerHost) {
    ...
    return [ABI30_0_0RCTBundleURLProvider jsBundleURLForBundleRoot:bundleRoot
...
- (BOOL)enableDev
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI30_0_0RCTEnableDevKey];
}

- (BOOL)enableLiveReload
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI30_0_0RCTEnableLiveReloadKey];
}

- (BOOL)enableMinification
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI30_0_0RCTEnableMinificationKey];
}

- (NSString *)jsLocation
{
  return [[NSUserDefaults standardUserDefaults] stringForKey:kABI30_0_0RCTJsLocationKey];
}

- (void)setEnableDev:(BOOL)enableDev
{
  [self updateValue:@(enableDev) forKey:kABI30_0_0RCTEnableDevKey];
}

- (void)setEnableLiveReload:(BOOL)enableLiveReload
{
  [self updateValue:@(enableLiveReload) forKey:kABI30_0_0RCTEnableLiveReloadKey];
}

- (void)setJsLocation:(NSString *)jsLocation
{
  [self updateValue:jsLocation forKey:kABI30_0_0RCTJsLocationKey];
}

- (void)setEnableMinification:(BOOL)enableMinification
{
  [self updateValue:@(enableMinification) forKey:kABI30_0_0RCTEnableMinificationKey];
}

+ (instancetype)sharedSettings
{
  static ABI30_0_0RCTBundleURLProvider *sharedInstance;
  static dispatch_once_t once_token;
  dispatch_once(&once_token, ^{
    sharedInstance = [ABI30_0_0RCTBundleURLProvider new];
  });
