 ...
 */
@interface ABI30_0_0RCTImageSource : NSObject
...
@interface ABI30_0_0RCTConvert (ImageSource)

+ (ABI30_0_0RCTImageSource *)ABI30_0_0RCTImageSource:(id)json;
+ (NSArray<ABI30_0_0RCTImageSource *> *)ABI30_0_0RCTImageSourceArray:(id)json;
