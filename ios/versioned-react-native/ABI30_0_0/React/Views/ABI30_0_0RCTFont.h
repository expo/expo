...
typedef UIFont *(^ABI30_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ReactABI30_0_0 Native will use the System font for rendering by default. If you want to
 ...
 */
ABI30_0_0RCT_EXTERN void ABI30_0_0RCTSetDefaultFontHandler(ABI30_0_0RCTFontHandler handler);
ABI30_0_0RCT_EXTERN BOOL ABI30_0_0RCTHasFontHandlerSet();

@interface ABI30_0_0RCTFont : NSObject
...
@interface ABI30_0_0RCTConvert (ABI30_0_0RCTFont)
