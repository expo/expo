...
@class ABI30_0_0RCTView;

@interface ABI30_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI30_0_0RCTDirectEventBlock onAccessibilityAction;
@property (nonatomic, copy) ABI30_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI30_0_0RCTDirectEventBlock onMagicTap;
 ...
 */
@property (nonatomic, assign) ABI30_0_0RCTPointerEvents pointerEvents;
 ...
 * This is inherited from UIView+ReactABI30_0_0, but we override it here
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI30_0_0RCTBorderStyle borderStyle;
