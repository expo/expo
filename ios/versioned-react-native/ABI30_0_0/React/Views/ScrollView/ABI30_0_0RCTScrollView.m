...
@interface ABI30_0_0RCTScrollEvent : NSObject <ABI30_0_0RCTEvent>
...
@implementation ABI30_0_0RCTScrollEvent
{
...
{
  ABI30_0_0RCTAssertParam(ReactABI30_0_0Tag);
...
- (ABI30_0_0RCTScrollEvent *)coalesceWithEvent:(ABI30_0_0RCTScrollEvent *)newEvent
{
...
{
  return @"ABI30_0_0RCTEventEmitter.receiveEvent";
}

- (NSArray *)arguments
{
  return @[self.viewTag, ABI30_0_0RCTNormalizeInputEventName(self.eventName), [self body]];
}
 ...
 */
@interface ABI30_0_0RCTCustomScrollView : UIScrollView<UIGestureRecognizerDelegate>

@property (nonatomic, assign) BOOL centerContent;
#if !TARGET_OS_TV
@property (nonatomic, strong) ABI30_0_0RCTRefreshControl *rctRefreshControl;
...
@implementation ABI30_0_0RCTCustomScrollView
...
- (UIView *)contentView
{
  return ((ABI30_0_0RCTScrollView *)self.superview).contentView;
}
...
- (BOOL)_shouldDisableScrollInteraction
{
  ...
  UIView *JSResponder = [ABI30_0_0RCTUIManager JSResponder];
...
{
  if ([self _shouldDisableScrollInteraction] && ![[ABI30_0_0RCTUIManager JSResponder] isKindOfClass:[ABI30_0_0RCTScrollView class]]) {
 ...
 * touch started inside of a `UIControl` (`UIButton` etc). For ReactABI30_0_0 scroll
...
#if !TARGET_OS_TV
- (void)setRctRefreshControl:(ABI30_0_0RCTRefreshControl *)refreshControl
{
...
@interface ABI30_0_0RCTScrollView () <ABI30_0_0RCTUIManagerObserver>

@end

@implementation ABI30_0_0RCTScrollView
{
  ABI30_0_0RCTEventDispatcher *_eventDispatcher;
  CGRect _prevFirstVisibleFrame;
  __weak UIView *_firstVisibleView;
  ABI30_0_0RCTCustomScrollView *_scrollView;
  UIView *_contentView;
...
- (instancetype)initWithEventDispatcher:(ABI30_0_0RCTEventDispatcher *)eventDispatcher
{
  ABI30_0_0RCTAssertParam(eventDispatcher);

  if ((self = [super initWithFrame:CGRectZero])) {
    _eventDispatcher = eventDispatcher;

    _scrollView = [[ABI30_0_0RCTCustomScrollView alloc] initWithFrame:CGRectZero];
...
static inline void ABI30_0_0RCTApplyTransformationAccordingLayoutDirection(UIView *view, UIUserInterfaceLayoutDirection layoutDirection) {
  view.transform =
...
{
  [super setReactABI30_0_0LayoutDirection:layoutDirection];

  ABI30_0_0RCTApplyTransformationAccordingLayoutDirection(_scrollView, layoutDirection);
  ABI30_0_0RCTApplyTransformationAccordingLayoutDirection(_contentView, layoutDirection);
}
...
- (void)insertReactABI30_0_0Subview:(UIView *)view atIndex:(NSInteger)atIndex
{
  [super insertReactABI30_0_0Subview:view atIndex:atIndex];
#if !TARGET_OS_TV
  if ([view isKindOfClass:[ABI30_0_0RCTRefreshControl class]]) {
    [_scrollView setRctRefreshControl:(ABI30_0_0RCTRefreshControl *)view];
  } else
#endif
  {
    ABI30_0_0RCTAssert(_contentView == nil, @"ABI30_0_0RCTScrollView may only contain a single subview");
    _contentView = view;
    ABI30_0_0RCTApplyTransformationAccordingLayoutDirection(_contentView, self.ReactABI30_0_0LayoutDirection);
...
#if !TARGET_OS_TV
  if ([subview isKindOfClass:[ABI30_0_0RCTRefreshControl class]]) {
    [_scrollView setRctRefreshControl:nil];
  } else
#endif
  {
    ABI30_0_0RCTAssert(_contentView == subview, @"Attempted to remove non-existent subview");
    _contentView = nil;
  }
}
...
- (void)layoutSubviews
{
  ...
  ABI30_0_0RCTAssert(self.subviews.count == 1, @"we should only have exactly one subview");
  ABI30_0_0RCTAssert([self.subviews lastObject] == _scrollView, @"our only subview should be a scrollview");

#if !TARGET_OS_TV
  // Adjust the refresh control frame if the scrollview layout changes.
  ABI30_0_0RCTRefreshControl *refreshControl = _scrollView.rctRefreshControl;
...
- (void)updateClippedSubviews
{
  ...
  if (shouldClipAgain) {
    ...
    [self ReactABI30_0_0_updateClippedSubviewsWithClipRect:clipRect relativeToView:clipView];
...
- (void)setContentInset:(UIEdgeInsets)contentInset
{
  ...
  [ABI30_0_0RCTView autoAdjustInsetsForView:self
...
#define ABI30_0_0RCT_SEND_SCROLL_EVENT(_eventName, _userData) { \
...
#define ABI30_0_0RCT_FORWARD_SCROLL_EVENT(call) \
...
#define ABI30_0_0RCT_SCROLL_EVENT_HANDLER(delegateMethod, eventName) \
- (void)delegateMethod:(UIScrollView *)scrollView           \
{                                                           \
  ABI30_0_0RCT_SEND_SCROLL_EVENT(eventName, nil);                    \
  ABI30_0_0RCT_FORWARD_SCROLL_EVENT(delegateMethod:scrollView);      \
}

ABI30_0_0RCT_SCROLL_EVENT_HANDLER(scrollViewWillBeginDecelerating, onMomentumScrollBegin)
ABI30_0_0RCT_SCROLL_EVENT_HANDLER(scrollViewDidZoom, onScroll)
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
  ...
  if (_allowNextScrollNoMatterWhat ||
    ...
    if (_DEPRECATED_sendUpdatedChildFrames) {
      ...
      ABI30_0_0RCT_SEND_SCROLL_EVENT(onScroll, (@{@"updatedChildFrames": [self calculateChildFramesData]}));
    } else {
      ABI30_0_0RCT_SEND_SCROLL_EVENT(onScroll, nil);
    }
  ...
  ABI30_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewDidScroll:scrollView);
}

- (NSArray<NSDictionary *> *)calculateChildFramesData
{
    NSMutableArray<NSDictionary *> *updatedChildFrames = [NSMutableArray new];
    [[_contentView ReactABI30_0_0Subviews] enumerateObjectsUsingBlock:
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView
{
  ...
  ABI30_0_0RCT_SEND_SCROLL_EVENT(onScrollBeginDrag, nil);
  ABI30_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewWillBeginDragging:scrollView);
}
...
- (void)scrollViewWillEndDragging:(UIScrollView *)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(inout CGPoint *)targetContentOffset
{
  ...
  ABI30_0_0RCT_SEND_SCROLL_EVENT(onScrollEndDrag, userData);
  ABI30_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewWillEndDragging:scrollView withVelocity:velocity targetContentOffset:targetContentOffset);
}

- (void)scrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate
{
  ABI30_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewDidEndDragging:scrollView willDecelerate:decelerate);
}

- (void)scrollViewWillBeginZooming:(UIScrollView *)scrollView withView:(UIView *)view
{
  ABI30_0_0RCT_SEND_SCROLL_EVENT(onScrollBeginDrag, nil);
  ABI30_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewWillBeginZooming:scrollView withView:view);
}

- (void)scrollViewDidEndZooming:(UIScrollView *)scrollView withView:(UIView *)view atScale:(CGFloat)scale
{
  ABI30_0_0RCT_SEND_SCROLL_EVENT(onScrollEndDrag, nil);
  ABI30_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewDidEndZooming:scrollView withView:view atScale:scale);
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
  ...
  ABI30_0_0RCT_SEND_SCROLL_EVENT(onMomentumScrollEnd, nil);
  ABI30_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewDidEndDecelerating:scrollView);
}
...
- (void)scrollViewDidEndScrollingAnimation:(UIScrollView *)scrollView
{
  ...
  // Fire the end deceleration event
  ABI30_0_0RCT_SEND_SCROLL_EVENT(onMomentumScrollEnd, nil);
  ABI30_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewDidEndScrollingAnimation:scrollView);
}
...
- (CGSize)_calculateViewportSize
{
  ...
  if (_automaticallyAdjustContentInsets) {
    UIEdgeInsets contentInsets = [ABI30_0_0RCTView contentInsetsForView:self];
...
- (void)uiManagerWillPerformMounting:(ABI30_0_0RCTUIManager *)manager
{
  ...
  [manager prependUIBlock:^(ABI30_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
  ...
  [manager addUIBlock:^(ABI30_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
...
#define ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setter, getter, type) \
...
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setAlwaysBounceHorizontal, alwaysBounceHorizontal, BOOL)
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setAlwaysBounceVertical, alwaysBounceVertical, BOOL)
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setBounces, bounces, BOOL)
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setBouncesZoom, bouncesZoom, BOOL)
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setCanCancelContentTouches, canCancelContentTouches, BOOL)
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setDecelerationRate, decelerationRate, CGFloat)
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setDirectionalLockEnabled, isDirectionalLockEnabled, BOOL)
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setIndicatorStyle, indicatorStyle, UIScrollViewIndicatorStyle)
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setKeyboardDismissMode, keyboardDismissMode, UIScrollViewKeyboardDismissMode)
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setMaximumZoomScale, maximumZoomScale, CGFloat)
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setMinimumZoomScale, minimumZoomScale, CGFloat)
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setScrollEnabled, isScrollEnabled, BOOL)
#if !TARGET_OS_TV
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setPagingEnabled, isPagingEnabled, BOOL)
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setScrollsToTop, scrollsToTop, BOOL)
#endif
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setShowsHorizontalScrollIndicator, showsHorizontalScrollIndicator, BOOL)
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setShowsVerticalScrollIndicator, showsVerticalScrollIndicator, BOOL)
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setZoomScale, zoomScale, CGFloat);
ABI30_0_0RCT_SET_AND_PRESERVE_OFFSET(setScrollIndicatorInsets, scrollIndicatorInsets, UIEdgeInsets);
                       ...
                       userData:(NSDictionary *)userData
{
  ...
  ABI30_0_0RCTScrollEvent *scrollEvent = [[ABI30_0_0RCTScrollEvent alloc] initWithEventName:eventName
                                                                 ReactABI30_0_0Tag:self.ReactABI30_0_0Tag
...
@implementation ABI30_0_0RCTEventDispatcher (ABI30_0_0RCTScrollView)

- (void)sendFakeScrollEvent:(NSNumber *)ReactABI30_0_0Tag
{
  ...
  ABI30_0_0RCTScrollEvent *fakeScrollEvent = [[ABI30_0_0RCTScrollEvent alloc] initWithEventName:eventName
                                                                     ReactABI30_0_0Tag:ReactABI30_0_0Tag
