...
static const CGFloat ABI30_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI30_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return
  ABS(borderInsets.left - borderInsets.right) < ABI30_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.bottom) < ABI30_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.top) < ABI30_0_0RCTViewBorderThreshold;
}

BOOL ABI30_0_0RCTCornerRadiiAreEqual(ABI30_0_0RCTCornerRadii cornerRadii)
{
  return
  ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI30_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI30_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI30_0_0RCTViewBorderThreshold;
}
...
{
  return (ABI30_0_0RCTCornerInsets) {
    {
...
static UIEdgeInsets ABI30_0_0RCTRoundInsetsToPixel(UIEdgeInsets edgeInsets) {
    edgeInsets.top = ABI30_0_0RCTRoundPixelValue(edgeInsets.top);
    edgeInsets.bottom = ABI30_0_0RCTRoundPixelValue(edgeInsets.bottom);
    edgeInsets.left = ABI30_0_0RCTRoundPixelValue(edgeInsets.left);
    edgeInsets.right = ABI30_0_0RCTRoundPixelValue(edgeInsets.right);

    return edgeInsets;
}

static void ABI30_0_0RCTPathAddEllipticArc(CGMutablePathRef path,
                                       ...
                                       const CGAffineTransform *transform)
{
  ...
  ABI30_0_0RCTPathAddEllipticArc(path, transform, (CGPoint){
...
static void ABI30_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds,
                                               CGPoint lineStart,
                                               CGPoint lineEnd,
...
NS_INLINE BOOL ABI30_0_0RCTCornerRadiiAreAboveThreshold(ABI30_0_0RCTCornerRadii cornerRadii) {
  return (cornerRadii.topLeft > ABI30_0_0RCTViewBorderThreshold ||
    cornerRadii.topRight > ABI30_0_0RCTViewBorderThreshold      ||
    cornerRadii.bottomLeft > ABI30_0_0RCTViewBorderThreshold    ||
    cornerRadii.bottomRight > ABI30_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI30_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI30_0_0RCTCornerRadii cornerRadii) {
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI30_0_0RCTPathCreateWithRoundedRect(rect, ABI30_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef ABI30_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge) {
...
static UIImage *ABI30_0_0RCTGetSolidBorderImage(ABI30_0_0RCTCornerRadii cornerRadii,
                                       CGSize viewSize,
                                       ...
                                       BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI30_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI30_0_0RCTCornerInsets cornerInsets = ABI30_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  borderInsets = ABI30_0_0RCTRoundInsetsToPixel(borderInsets);
  ...
  CGContextRef ctx = ABI30_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI30_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI30_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI30_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI30_0_0RCTEllipseGetIntersectionsWithLine((CGRect){
...
static UIImage *ABI30_0_0RCTGetDashedOrDottedBorderImage(ABI30_0_0RCTBorderStyle borderStyle,
                                                ...
                                                BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI30_0_0RCTBorderStyleDashed || borderStyle == ABI30_0_0RCTBorderStyleDotted);

  if (!ABI30_0_0RCTBorderColorsAreEqual(borderColors) || !ABI30_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI30_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI30_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI30_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI30_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI30_0_0RCTPathCreateWithRoundedRect(pathRect, ABI30_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI30_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
                           ...
                           BOOL drawToEdge)
{
  ...
  switch (borderStyle) {
    case ABI30_0_0RCTBorderStyleSolid:
      return ABI30_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI30_0_0RCTBorderStyleDashed:
    case ABI30_0_0RCTBorderStyleDotted:
      return ABI30_0_0RCTGetDashedOrDottedBorderImage(borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI30_0_0RCTBorderStyleUnset:
      break;
  }
