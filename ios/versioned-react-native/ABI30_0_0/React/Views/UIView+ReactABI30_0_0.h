...
@interface UIView (ReactABI30_0_0) <ABI30_0_0RCTComponent>

/**
 * ABI30_0_0RCTComponent interface.
 */
- (NSArray<UIView *> *)ReactABI30_0_0Subviews NS_REQUIRES_SUPER;
- (UIView *)ReactABI30_0_0Superview NS_REQUIRES_SUPER;
- (void)insertReactABI30_0_0Subview:(UIView *)subview atIndex:(NSInteger)atIndex NS_REQUIRES_SUPER;
- (void)removeReactABI30_0_0Subview:(UIView *)subview NS_REQUIRES_SUPER;
 ...
 */
@property (nonatomic, assign) UIUserInterfaceLayoutDirection ReactABI30_0_0LayoutDirection;
 ...
 */
@property (nonatomic, assign) ABI30_0_0YGDisplay ReactABI30_0_0Display;

/**
 * The z-index of the view.
 */
@property (nonatomic, assign) NSInteger ReactABI30_0_0ZIndex;
...
/**
 * Updates the subviews array based on the ReactABI30_0_0Subviews. Default behavior is
 * to insert the sortedReactABI30_0_0Subviews into the UIView.
 */
 ...
 */
@property (nonatomic, readonly) UIEdgeInsets ReactABI30_0_0BorderInsets;
@property (nonatomic, readonly) UIEdgeInsets ReactABI30_0_0PaddingInsets;
@property (nonatomic, readonly) UIEdgeInsets ReactABI30_0_0CompoundInsets;
@property (nonatomic, readonly) CGRect ReactABI30_0_0ContentFrame;
 ...
 * Defaults to `self`.
 */
@property (nonatomic, readonly) UIView *ReactABI30_0_0AccessibilityElement;
