...
// These constants can only be removed when ReactABI30_0_0 Native drops iOS8 support.
...
typedef CGFloat ABI30_0_0RCTFontWeight;
static ABI30_0_0RCTFontWeight weightOfFont(UIFont *font)
{
  ...
  for (NSInteger i = 0; i < fontNames.count; i++) {
    if ([font.fontName.lowercaseString hasSuffix:fontNames[i]]) {
      return (ABI30_0_0RCTFontWeight)[fontWeights[i] doubleValue];
    }
  }

  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  return (ABI30_0_0RCTFontWeight)[traits[UIFontWeightTrait] doubleValue];
}
...
static ABI30_0_0RCTFontHandler defaultFontHandler;

void ABI30_0_0RCTSetDefaultFontHandler(ABI30_0_0RCTFontHandler handler) {
  defaultFontHandler = handler;
}

BOOL ABI30_0_0RCTHasFontHandlerSet() {
...
static NSString *FontWeightDescriptionFromUIFontWeight(UIFontWeight fontWeight)
{
  ...
  ABI30_0_0RCTAssert(NO, @"Unknown UIFontWeight passed in: %f", fontWeight);
  return @"regular";
}

static UIFont *cachedSystemFont(CGFloat size, ABI30_0_0RCTFontWeight weight)
{
...
@implementation ABI30_0_0RCTConvert (ABI30_0_0RCTFont)

+ (UIFont *)UIFont:(id)json
{
  json = [self NSDictionary:json];
  return [ABI30_0_0RCTFont updateFont:nil
                  withFamily:[ABI30_0_0RCTConvert NSString:json[@"fontFamily"]]
                        size:[ABI30_0_0RCTConvert NSNumber:json[@"fontSize"]]
                      weight:[ABI30_0_0RCTConvert NSString:json[@"fontWeight"]]
                       style:[ABI30_0_0RCTConvert NSString:json[@"fontStyle"]]
                     variant:[ABI30_0_0RCTConvert NSStringArray:json[@"fontVariant"]]
             scaleMultiplier:1];
}

ABI30_0_0RCT_ENUM_CONVERTER(ABI30_0_0RCTFontWeight, (@{
...
typedef BOOL ABI30_0_0RCTFontStyle;
ABI30_0_0RCT_ENUM_CONVERTER(ABI30_0_0RCTFontStyle, (@{
                                    @"normal": @NO,
                                    @"italic": @YES,
                                    @"oblique": @YES,
                                    }), NO, boolValue)

typedef NSDictionary ABI30_0_0RCTFontVariantDescriptor;
+ (ABI30_0_0RCTFontVariantDescriptor *)ABI30_0_0RCTFontVariantDescriptor:(id)json
{
  ...
  ABI30_0_0RCTFontVariantDescriptor *value = mapping[json];
  if (ABI30_0_0RCT_DEBUG && !value && [json description].length > 0) {
    ABI30_0_0RCTLogError(@"Invalid ABI30_0_0RCTFontVariantDescriptor '%@'. should be one of: %@", json,
                [[mapping allKeys] sortedArrayUsingSelector:@selector(caseInsensitiveCompare:)]);
  }
  return value;
}

ABI30_0_0RCT_ARRAY_CONVERTER(ABI30_0_0RCTFontVariantDescriptor)

@end

@implementation ABI30_0_0RCTFont
...
+ (UIFont *)updateFont:(UIFont *)font
            withFamily:(NSString *)family
               ...
               variant:(NSArray<ABI30_0_0RCTFontVariantDescriptor *> *)variant
       scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  const ABI30_0_0RCTFontWeight defaultFontWeight = UIFontWeightRegular;
  const CGFloat defaultFontSize = 14;

  // Initialize properties to defaults
  CGFloat fontSize = defaultFontSize;
  ABI30_0_0RCTFontWeight fontWeight = defaultFontWeight;
  ...
  // Get font attributes
  fontSize = [ABI30_0_0RCTConvert CGFloat:size] ?: fontSize;
  if (scaleMultiplier > 0.0 && scaleMultiplier != 1.0) {
    fontSize = round(fontSize * scaleMultiplier);
  }
  familyName = [ABI30_0_0RCTConvert NSString:family] ?: familyName;
  isItalic = style ? [ABI30_0_0RCTConvert ABI30_0_0RCTFontStyle:style] : isItalic;
  fontWeight = weight ? [ABI30_0_0RCTConvert ABI30_0_0RCTFontWeight:weight] : fontWeight;
  ...
  if (!didFindFont && [UIFont fontNamesForFamilyName:familyName].count == 0) {
    ...
    if (font) {
      ...
      ABI30_0_0RCTLogError(@"Unrecognized font family '%@'", familyName);
  ...
  if (variant) {
    NSArray *fontFeatures = [ABI30_0_0RCTConvert ABI30_0_0RCTFontVariantDescriptorArray:variant];
