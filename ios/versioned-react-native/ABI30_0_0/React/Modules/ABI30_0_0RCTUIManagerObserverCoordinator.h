...
typedef dispatch_block_t ABI30_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI30_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ReactABI30_0_0-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI30_0_0RCTUIManager's observers.
 */
@interface ABI30_0_0RCTUIManagerObserverCoordinator : NSObject <ABI30_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI30_0_0RCTUIManagerObserver` protocol for more info.
