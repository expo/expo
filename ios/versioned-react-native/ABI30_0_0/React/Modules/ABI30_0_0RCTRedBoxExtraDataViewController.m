...
@interface ABI30_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI30_0_0RCTRedBoxExtraDataCell
...
@interface ABI30_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI30_0_0RCTRedBoxExtraDataViewController
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ABI30_0_0RCTRedBoxExtraDataCell *cell =
            (ABI30_0_0RCTRedBoxExtraDataCell *)[tableView
            dequeueReusableCellWithIdentifier:reuseIdentifier];

    if (cell == nil) {
        cell = [[ABI30_0_0RCTRedBoxExtraDataCell alloc]
