...
NSString *const ABI30_0_0RCTTVNavigationEventNotification = @"ABI30_0_0RCTTVNavigationEventNotification";

static NSString *const TVNavigationEventName = @"onHWKeyEvent";

@implementation ABI30_0_0RCTTVNavigationEventEmitter
  ...
  if (self = [super init]) {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(handleTVNavigationEventNotification:)
                                                 name:ABI30_0_0RCTTVNavigationEventNotification
                                               object:nil];
