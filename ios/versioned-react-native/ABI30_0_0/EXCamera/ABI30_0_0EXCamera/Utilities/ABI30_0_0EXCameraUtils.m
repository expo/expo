...
@implementation ABI30_0_0EXCameraUtils
...
+ (float)temperatureForWhiteBalance:(ABI30_0_0EXCameraWhiteBalance)whiteBalance
{
  switch (whiteBalance) {
    case ABI30_0_0EXCameraWhiteBalanceSunny: default:
      return 5200;
    case ABI30_0_0EXCameraWhiteBalanceCloudy:
      return 6000;
    case ABI30_0_0EXCameraWhiteBalanceShadow:
      return 7000;
    case ABI30_0_0EXCameraWhiteBalanceIncandescent:
      return 3000;
    case ABI30_0_0EXCameraWhiteBalanceFluorescent:
      return 4200;
  }
}

+ (NSString *)captureSessionPresetForVideoResolution:(ABI30_0_0EXCameraVideoResolution)resolution
{
  switch (resolution) {
    case ABI30_0_0EXCameraVideo2160p:
      return AVCaptureSessionPreset3840x2160;
    case ABI30_0_0EXCameraVideo1080p:
      return AVCaptureSessionPreset1920x1080;
    case ABI30_0_0EXCameraVideo720p:
      return AVCaptureSessionPreset1280x720;
    case ABI30_0_0EXCameraVideo4x3:
