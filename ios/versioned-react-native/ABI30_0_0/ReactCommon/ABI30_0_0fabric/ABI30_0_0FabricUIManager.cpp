...
#include "ABI30_0_0FabricUIManager.h"

#include "ABI30_0_0IFabricPlatformUIOperationManager.h"
...
ShadowNodeRef FabricUIManager::createNode(int ReactABI30_0_0Tag, std::string viewName, int rootTag, folly::dynamic props, void *instanceHandle) {
  platformUIOperationManager_->performUIOperation();
  return std::make_shared<ShadowNode>(ReactABI30_0_0Tag, viewName, rootTag, props, instanceHandle);
}
