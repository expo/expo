...
folly::Optional<Object> JSCNativeModules::createModule(const std::string& name, JSContextRef context) {
  ReactABI30_0_0Marker::logTaggedMarker(ReactABI30_0_0Marker::NATIVE_MODULE_SETUP_START, name.c_str());
  ...
  ReactABI30_0_0Marker::logTaggedMarker(ReactABI30_0_0Marker::NATIVE_MODULE_SETUP_STOP, name.c_str());
