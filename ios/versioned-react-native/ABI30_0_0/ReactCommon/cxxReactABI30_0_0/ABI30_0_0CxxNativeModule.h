...
#include <cxxReactABI30_0_0/ABI30_0_0CxxModule.h>
#include <cxxReactABI30_0_0/ABI30_0_0NativeModule.h>
...
public:
  ...
  void invoke(unsigned int ReactABI30_0_0MethodId, folly::dynamic&& params, int callId) override;
