...
#include "ABI30_0_0JSCExecutor.h"
...
#include <ABI30_0_0jschelpers/ABI30_0_0JSCHelpers.h>
#include <ABI30_0_0jschelpers/ABI30_0_0Value.h>
#include <ABI30_0_0jsinspector/ABI30_0_0InspectorInterfaces.h>

#include "ABI30_0_0JSBigString.h"
#include "ABI30_0_0JSBundleType.h"
#include "ABI30_0_0JSCLegacyTracing.h"
#include "ABI30_0_0JSCMemory.h"
#include "ABI30_0_0JSCNativeModules.h"
#include "ABI30_0_0JSCPerfStats.h"
#include "ABI30_0_0JSCSamplingProfiler.h"
#include "ABI30_0_0JSCTracing.h"
#include "ABI30_0_0JSCUtils.h"
#include "ABI30_0_0JSModulesUnbundle.h"
#include "ABI30_0_0ModuleRegistry.h"
#include "ABI30_0_0Platform.h"
#include "ABI30_0_0RAMBundleRegistry.h"
#include "ABI30_0_0RecoverableError.h"
#include "ABI30_0_0SystraceSection.h"
  ...
  namespace ReactABI30_0_0 {
    ...
    void JSCExecutor::initOnJSVMThread() throw(JSException) {
      ...
      if (canUseInspector(m_context)) {
        ...
        auto& globalInspector = facebook::ReactABI30_0_0::getInspectorInstance();
    ...
    void JSCExecutor::loadApplicationScript(std::unique_ptr<const JSBigString> script, std::string sourceURL) {
      ...
      ReactABI30_0_0Marker::logTaggedMarker(ReactABI30_0_0Marker::RUN_JS_BUNDLE_START, scriptName.c_str());
      ...
      if (auto fileStr = dynamic_cast<const JSBigFileString *>(script.get())) {
        ...
        switch (jsStatus) {
          case JSLoadSourceIsCompiled:
            ...
            ReactABI30_0_0Marker::logMarker(ReactABI30_0_0Marker::CREATE_REACT_CONTEXT_STOP);
            ReactABI30_0_0Marker::logTaggedMarker(ReactABI30_0_0Marker::RUN_JS_BUNDLE_STOP, scriptName.c_str());
            return;
...
#endif
      {
        ...
        JSContextLock lock(m_context);
        {
          ...
          ReactABI30_0_0Marker::logMarker(ReactABI30_0_0Marker::JS_BUNDLE_STRING_CONVERT_START);
          jsScript = adoptString(std::move(script));
          ReactABI30_0_0Marker::logMarker(ReactABI30_0_0Marker::JS_BUNDLE_STRING_CONVERT_STOP);
        }
    ...
    JSValueRef JSCExecutor::nativeRequire(size_t count, const JSValueRef arguments[]) {
      ...
      ReactABI30_0_0Marker::logMarker(ReactABI30_0_0Marker::NATIVE_REQUIRE_START);
      loadModule(bundleId, moduleId);
      ReactABI30_0_0Marker::logMarker(ReactABI30_0_0Marker::NATIVE_REQUIRE_STOP);
