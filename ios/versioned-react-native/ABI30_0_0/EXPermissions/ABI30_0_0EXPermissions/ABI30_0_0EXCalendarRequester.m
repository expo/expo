...
@interface ABI30_0_0EXCalendarRequester ()

@property (nonatomic, weak) id<ABI30_0_0EXPermissionRequesterDelegate> delegate;

@end

@implementation ABI30_0_0EXCalendarRequester
...
+ (NSDictionary *)permissions
{
  ...
  if (!calendarUsageDescription) {
    ABI30_0_0EXFatal(ABI30_0_0EXErrorWithMessage(@"This app is missing NSCalendarsUsageDescription, so calendar methods will fail. Add this key to your bundle's Info.plist."));
