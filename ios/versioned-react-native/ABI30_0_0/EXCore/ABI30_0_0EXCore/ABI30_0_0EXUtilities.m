...
@interface ABI30_0_0EXUtilities ()

@property (nonatomic, nullable, weak) ABI30_0_0EXModuleRegistry *moduleRegistry;
...
@implementation ABI30_0_0EXUtilities

ABI30_0_0EX_REGISTER_MODULE();

+ (const NSArray<Protocol *> *)exportedInterfaces
{
  return @[@protocol(ABI30_0_0EXUtilitiesInterface)];
}
...
- (UIViewController *)currentViewController
{
  id<ABI30_0_0EXUtilService> utilService = [_moduleRegistry getSingletonModuleForName:@"Util"];

  if (utilService != nil) {
    // Uses currentViewController from ABI30_0_0EXUtilService that is a part of ExpoKit
    return [utilService currentViewController];
  }
  
  // If the app doesn't have ExpoKit - then do the same as ABI30_0_0RCTPresentedViewController() does
