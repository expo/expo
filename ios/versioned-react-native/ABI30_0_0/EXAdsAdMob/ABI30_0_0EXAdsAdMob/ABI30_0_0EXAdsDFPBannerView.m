...
@implementation ABI30_0_0EXAdsDFPBannerView {
  DFPBannerView *_bannerView;
  id<ABI30_0_0EXEventEmitterService> _eventEmitter;
}
...
- (void)setOnSizeChange:(ABI30_0_0EXDirectEventBlock)block
{
  _onSizeChange = block;
  [self loadBanner];
}

- (void)setOnDidFailToReceiveAdWithError:(ABI30_0_0EXDirectEventBlock)block
{
