//
//  ABI30_0_0EXFaceDetectorPointTransformCalculator.m
//  Exponent
//
...
#import <ABI30_0_0EXFaceDetector/ABI30_0_0EXFaceDetectorPointTransformCalculator.h>
...
typedef NS_ENUM(NSInteger, ABI30_0_0EXTranslationEnum) {
  ABI30_0_0EXTranslateYNegativeWidth,
  ABI30_0_0EXTranslateXNegativeHeight,
  ABI30_0_0EXTranslateXYNegative,
  ABI30_0_0EXTranslateYXNegative
};

@interface ABI30_0_0EXFaceDetectorPointTransformCalculator()
...
@implementation ABI30_0_0EXFaceDetectorPointTransformCalculator
...
- (CGPoint)translation
{
  ...
  AVCaptureVideoOrientation firstOrientation = MIN(_fromOrientation, _toOrientation);
  AVCaptureVideoOrientation secondOrientation = MAX(_fromOrientation, _toOrientation);
  ABI30_0_0EXTranslationEnum enumValue = [[[self class] getTranslationDictionary][@(firstOrientation)][@(secondOrientation)] intValue];
...
- (CGPoint)translationForEnum:(ABI30_0_0EXTranslationEnum)enumValue
{
  switch (enumValue) {
    case ABI30_0_0EXTranslateXNegativeHeight:
      return CGPointMake(-_videoHeight, 0);
    case ABI30_0_0EXTranslateYNegativeWidth:
      return CGPointMake(0, -_videoWidth);
    case ABI30_0_0EXTranslateXYNegative:
      return CGPointMake(-_videoWidth, -_videoHeight);
    case ABI30_0_0EXTranslateYXNegative:
...
+ (void)initTranslationDictionary
{
  translationDictionary = @{
                            @(AVCaptureVideoOrientationPortrait): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI30_0_0EXTranslateYNegativeWidth),
                                @(AVCaptureVideoOrientationLandscapeRight) : @(ABI30_0_0EXTranslateXNegativeHeight),
                                @(AVCaptureVideoOrientationPortraitUpsideDown) : @(ABI30_0_0EXTranslateYXNegative)
                                },
                            @(AVCaptureVideoOrientationPortraitUpsideDown): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI30_0_0EXTranslateXNegativeHeight),
                                @(AVCaptureVideoOrientationLandscapeRight) : @(ABI30_0_0EXTranslateYNegativeWidth)
                                },
                            @(AVCaptureVideoOrientationLandscapeRight): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI30_0_0EXTranslateXYNegative)
                                }
                            };
}
