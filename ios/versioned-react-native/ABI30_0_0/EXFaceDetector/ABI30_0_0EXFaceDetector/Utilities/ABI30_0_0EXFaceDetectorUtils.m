//
//  ABI30_0_0EXFaceDetectorUtils.m
//  Exponent
//
...
NSString *const ABI30_0_0EXGMVDataOutputWidthKey = @"Width";
NSString *const ABI30_0_0EXGMVDataOutputHeightKey = @"Height";

@implementation ABI30_0_0EXFaceDetectorUtils

+ (NSDictionary *)constantsToExport
{
  return @{
           @"Mode" : @{
               @"fast" : @(ABI30_0_0EXFaceDetectionFastMode),
               @"accurate" : @(ABI30_0_0EXFaceDetectionAccurateMode)
               },
           @"Landmarks" : @{
               @"all" : @(ABI30_0_0EXFaceDetectAllLandmarks),
               @"none" : @(ABI30_0_0EXFaceDetectNoLandmarks)
               },
           @"Classifications" : @{
               @"all" : @(ABI30_0_0EXFaceRunAllClassifications),
               @"none" : @(ABI30_0_0EXFaceRunNoClassifications)
               }
           };
}
...
{
  ABI30_0_0EXFaceDetectorPointTransformCalculator *calculator = [[ABI30_0_0EXFaceDetectorPointTransformCalculator alloc] initToTransformFromOrientation:deviceVideoOrientation toOrientation:interfaceVideoOrientation forVideoWidth:[width floatValue] andVideoHeight:[height floatValue]];
...
+ (CGAffineTransform)transformFromDeviceOutput:(GMVDataOutput *)dataOutput withInterfaceOrientation:(AVCaptureVideoOrientation)interfaceVideoOrientation
{
  ...
  CGFloat xScale = interfaceWidth / [(NSNumber *)dataOutput.videoSettings[ABI30_0_0EXGMVDataOutputHeightKey] floatValue];
  CGFloat yScale = interfaceHeight / [(NSNumber *)dataOutput.videoSettings[ABI30_0_0EXGMVDataOutputWidthKey] floatValue];
...
+ (CGAffineTransform)transformFromDeviceOutput:(GMVDataOutput *)dataOutput toInterfaceVideoOrientation:(AVCaptureVideoOrientation)interfaceVideoOrientation
{
  ...
  NSNumber *videoWidth = dataOutput.videoSettings[ABI30_0_0EXGMVDataOutputWidthKey];
  NSNumber *videoHeight = dataOutput.videoSettings[ABI30_0_0EXGMVDataOutputHeightKey];
