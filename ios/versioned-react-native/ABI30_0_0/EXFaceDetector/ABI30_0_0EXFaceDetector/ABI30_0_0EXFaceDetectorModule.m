...
#import <ABI30_0_0EXFaceDetector/ABI30_0_0EXFaceDetectorModule.h>
#import <ABI30_0_0EXFaceDetector/ABI30_0_0EXFaceEncoder.h>
#import <ABI30_0_0EXFileSystemInterface/ABI30_0_0EXFileSystemInterface.h>
#import <ABI30_0_0EXFaceDetector/ABI30_0_0EXFaceDetectorUtils.h>
...
@interface ABI30_0_0EXFaceDetectorModule ()

@property (nonatomic, weak) ABI30_0_0EXModuleRegistry *moduleRegistry;

@end

@implementation ABI30_0_0EXFaceDetectorModule
...
ABI30_0_0EX_EXPORT_MODULE(ExpoFaceDetector);

- (NSDictionary *)constantsToExport
{
  return [ABI30_0_0EXFaceDetectorUtils constantsToExport];
}
...
ABI30_0_0EX_EXPORT_METHOD_AS(detectFaces, detectFaces:(nonnull NSDictionary *)options resolver:(ABI30_0_0EXPromiseResolveBlock)resolve rejecter:(ABI30_0_0EXPromiseRejectBlock)reject) {
  ...
  id<ABI30_0_0EXFileSystemInterface> fileSystem = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI30_0_0EXFileSystemInterface)];
...
//    }
    ...
    ABI30_0_0EXFaceEncoder *faceEncoder = [[ABI30_0_0EXFaceEncoder alloc] init];
    ...
    resolve(@{
              ...
              @"image" : @{
                  ...
                  @"orientation" : @([ABI30_0_0EXFaceDetectorModule exifOrientationFor:image.imageOrientation])
                  }
              });
...
// the value of GMVImageOrientation is the same as the value defined by ABI30_0_0EXIF specifications, so we can adapt
