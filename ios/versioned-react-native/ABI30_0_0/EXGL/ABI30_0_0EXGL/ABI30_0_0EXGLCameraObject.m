...
@interface ABI30_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) id<ABI30_0_0EXCameraInterface> camera;
...
@implementation ABI30_0_0EXGLCameraObject
