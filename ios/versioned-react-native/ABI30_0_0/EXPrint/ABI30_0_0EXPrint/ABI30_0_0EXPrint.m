...
#import <ABI30_0_0EXPrint/ABI30_0_0EXPrint.h>
...
NSString *const ABI30_0_0EXPrintOrientationPortrait = @"portrait";
NSString *const ABI30_0_0EXPrintOrientationLandscape = @"landscape";

@interface ABI30_0_0EXPrint () <UIPrintInteractionControllerDelegate, UIPrinterPickerControllerDelegate>
...
@implementation ABI30_0_0EXPrint

ABI30_0_0EX_EXPORT_MODULE(ExponentPrint);
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"Orientation": @{
               @"portrait": ABI30_0_0EXPrintOrientationPortrait,
               @"landscape": ABI30_0_0EXPrintOrientationLandscape,
               },
           };
}

ABI30_0_0EX_EXPORT_METHOD_AS(print,
                    ...
                    rejecter:(ABI30_0_0EXPromiseRejectBlock)reject)
{
  [self _getPrintingDataForOptions:options callback:^(NSData *printingData, NSDictionary *errorDetails) {
    if (errorDetails != nil) {
      reject(errorDetails[@"code"], errorDetails[@"message"], ABI30_0_0EXErrorWithMessage(errorDetails[@"message"]));
      return;
    }
    ...
    if (printingData == nil) {
      ...
      if (options[@"markupFormatterIOS"] && [options[@"markupFormatterIOS"] isKindOfClass:[NSString class]]) {
        ...
        if (htmlString != nil) {
          ...
          reject(@"E_HTML_INVALID", message, ABI30_0_0EXErrorWithMessage(message));
          return;
        }
      } else {
...
ABI30_0_0EX_EXPORT_METHOD_AS(selectPrinter,selectPrinter:(ABI30_0_0EXPromiseResolveBlock)resolve
                  rejecter:(ABI30_0_0EXPromiseRejectBlock)reject)
{
...
ABI30_0_0EX_EXPORT_METHOD_AS(printToFileAsync,
                    ...
                    reject:(ABI30_0_0EXPromiseRejectBlock)reject)
{
  ...
  ABI30_0_0EXPrintPDFRenderTask *renderTask = [ABI30_0_0EXPrintPDFRenderTask new];
...
{
  id<ABI30_0_0EXUtilitiesInterface> utils = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI30_0_0EXUtilitiesInterface)];
...
- (void)_getPrintingDataForOptions:(nonnull NSDictionary *)options callback:(void(^)(NSData *, NSDictionary *))callback
{
  ...
  if (options[@"html"]) {
    __block ABI30_0_0EXPrintPDFRenderTask *renderTask = [ABI30_0_0EXPrintPDFRenderTask new];
...
{
  if ([orientation isEqualToString:ABI30_0_0EXPrintOrientationLandscape]) {
