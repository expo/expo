...
@implementation ABI30_0_0ARTText
...
static void ABI30_0_0ARTFreeTextFrame(ABI30_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI30_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI30_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI30_0_0ARTTextFrame frame = self.textFrame;
