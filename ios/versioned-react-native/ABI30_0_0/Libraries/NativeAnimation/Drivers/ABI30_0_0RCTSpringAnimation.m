...
@interface ABI30_0_0RCTSpringAnimation ()
...
@implementation ABI30_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
                  ...
                  callBack:(nullable ABI30_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _lastVelocity = [ABI30_0_0RCTConvert CGFloat:config[@"initialVelocity"]];
...
- (void)resetAnimationConfig:(NSDictionary *)config
{
  ...
  _toValue = [ABI30_0_0RCTConvert CGFloat:config[@"toValue"]];
  _overshootClamping = [ABI30_0_0RCTConvert BOOL:config[@"overshootClamping"]];
  _restDisplacementThreshold = [ABI30_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
  _restSpeedThreshold = [ABI30_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
  _stiffness = [ABI30_0_0RCTConvert CGFloat:config[@"stiffness"]];
  _damping = [ABI30_0_0RCTConvert CGFloat:config[@"damping"]];
  _mass = [ABI30_0_0RCTConvert CGFloat:config[@"mass"]];
