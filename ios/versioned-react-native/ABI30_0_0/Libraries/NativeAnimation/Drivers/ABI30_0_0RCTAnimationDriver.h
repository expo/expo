...
static CGFloat ABI30_0_0RCTSingleFrameInterval = 1.0 / 60.0;

@class ABI30_0_0RCTValueAnimatedNode;

NS_ASSUME_NONNULL_BEGIN

@protocol ABI30_0_0RCTAnimationDriver <NSObject>

@property (nonatomic, readonly) NSNumber *animationId;
@property (nonatomic, readonly) ABI30_0_0RCTValueAnimatedNode *valueNode;
