...
@implementation ABI30_0_0RCTInterpolationAnimatedNode
{
  __weak ABI30_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI30_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI30_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI30_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI30_0_0RCTInterpolateValueInRange(inputValue,
                                          _inputRange,
                                          _outputRange,
                                          _extrapolateLeft,
                                          _extrapolateRight);
