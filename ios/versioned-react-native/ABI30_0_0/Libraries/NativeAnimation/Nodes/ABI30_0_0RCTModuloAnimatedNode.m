...
@implementation ABI30_0_0RCTModuloAnimatedNode
...
- (void)performUpdate
{
  ...
  ABI30_0_0RCTValueAnimatedNode *parent = (ABI30_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:inputNode];
