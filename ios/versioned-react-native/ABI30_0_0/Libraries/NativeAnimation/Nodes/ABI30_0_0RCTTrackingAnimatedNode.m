...
@implementation ABI30_0_0RCTTrackingAnimatedNode {
...
- (void)performUpdate
{
  ...
  ABI30_0_0RCTValueAnimatedNode *node = (ABI30_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
