 ...
 */
#import "ABI30_0_0RCTNativeAnimatedModule.h"

#import "ABI30_0_0RCTNativeAnimatedNodesManager.h"

typedef void (^AnimatedOperation)(ABI30_0_0RCTNativeAnimatedNodesManager *nodesManager);

@implementation ABI30_0_0RCTNativeAnimatedModule
{
  ABI30_0_0RCTNativeAnimatedNodesManager *_nodesManager;
...
- (void)setBridge:(ABI30_0_0RCTBridge *)bridge
{
  ...
  _nodesManager = [[ABI30_0_0RCTNativeAnimatedNodesManager alloc] initWithUIManager:self.bridge.uiManager];
...
ABI30_0_0RCT_EXPORT_METHOD(createAnimatedNode:(nonnull NSNumber *)tag
                  config:(NSDictionary<NSString *, id> *)config)
{
  [self addOperationBlock:^(ABI30_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager createAnimatedNode:tag config:config];
  }];
}

ABI30_0_0RCT_EXPORT_METHOD(connectAnimatedNodes:(nonnull NSNumber *)parentTag
...
ABI30_0_0RCT_EXPORT_METHOD(disconnectAnimatedNodes:(nonnull NSNumber *)parentTag
                  childTag:(nonnull NSNumber *)childTag)
{
  [self addOperationBlock:^(ABI30_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI30_0_0RCT_EXPORT_METHOD(startAnimatingNode:(nonnull NSNumber *)animationId
...
ABI30_0_0RCT_EXPORT_METHOD(stopAnimation:(nonnull NSNumber *)animationId)
{
  [self addOperationBlock:^(ABI30_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI30_0_0RCT_EXPORT_METHOD(setAnimatedNodeValue:(nonnull NSNumber *)nodeTag
...
ABI30_0_0RCT_EXPORT_METHOD(setAnimatedNodeOffset:(nonnull NSNumber *)nodeTag
...
ABI30_0_0RCT_EXPORT_METHOD(flattenAnimatedNodeOffset:(nonnull NSNumber *)nodeTag)
{
  [self addOperationBlock:^(ABI30_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI30_0_0RCT_EXPORT_METHOD(extractAnimatedNodeOffset:(nonnull NSNumber *)nodeTag)
{
  [self addOperationBlock:^(ABI30_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI30_0_0RCT_EXPORT_METHOD(connectAnimatedNodeToView:(nonnull NSNumber *)nodeTag
...
ABI30_0_0RCT_EXPORT_METHOD(disconnectAnimatedNodeFromView:(nonnull NSNumber *)nodeTag
                  viewTag:(nonnull NSNumber *)viewTag)
{
  [self addPreOperationBlock:^(ABI30_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI30_0_0RCT_EXPORT_METHOD(dropAnimatedNode:(nonnull NSNumber *)tag)
{
  [self addOperationBlock:^(ABI30_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI30_0_0RCT_EXPORT_METHOD(startListeningToAnimatedNodeValue:(nonnull NSNumber *)tag)
{
  __weak id<ABI30_0_0RCTValueAnimatedNodeObserver> valueObserver = self;
  [self addOperationBlock:^(ABI30_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager startListeningToAnimatedNodeValue:tag valueObserver:valueObserver];
  }];
}

ABI30_0_0RCT_EXPORT_METHOD(stopListeningToAnimatedNodeValue:(nonnull NSNumber *)tag)
{
  [self addOperationBlock:^(ABI30_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI30_0_0RCT_EXPORT_METHOD(addAnimatedEventToView:(nonnull NSNumber *)viewTag
...
ABI30_0_0RCT_EXPORT_METHOD(removeAnimatedEventFromView:(nonnull NSNumber *)viewTag
                  eventName:(nonnull NSString *)eventName
...
- (void)uiManagerWillPerformMounting:(ABI30_0_0RCTUIManager *)uiManager
{
  ...
  [uiManager prependUIBlock:^(__unused ABI30_0_0RCTUIManager *manager, __unused NSDictionary<NSNumber *, UIView *> *viewRegistry) {
