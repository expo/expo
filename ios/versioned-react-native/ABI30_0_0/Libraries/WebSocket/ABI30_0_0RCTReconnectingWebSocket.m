...
#import "ABI30_0_0RCTReconnectingWebSocket.h"
...
@interface ABI30_0_0RCTReconnectingWebSocket () <ABI30_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI30_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  __weak ABI30_0_0RCTSRWebSocket *socket = _socket;
