...
#import "ABI30_0_0RCTNetworking.h"

@interface ABI30_0_0RCTHTTPRequestHandler () <NSURLSessionDataDelegate>

@end

@implementation ABI30_0_0RCTHTTPRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  dispatch_once(&onceToken, ^{
    // technically, ABI30_0_0RCTHTTPRequestHandler can handle file:// as well,
    // but it's less efficient than using ABI30_0_0RCTFileRequestHandler
...
{
  id<ABI30_0_0RCTURLRequestDelegate> delegate;
  {
    std::lock_guard<std::mutex> lock(_mutex);
