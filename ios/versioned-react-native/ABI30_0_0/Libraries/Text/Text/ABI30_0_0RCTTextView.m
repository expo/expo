...
@implementation ABI30_0_0RCTTextView
{
...
- (NSString *)description
{
  ...
  NSString *replacement = [NSString stringWithFormat:@"; ReactABI30_0_0Tag: %@; text: %@", self.ReactABI30_0_0Tag, _textStorage.string];
...
- (void)drawRect:(CGRect)rect
{
  ...
  [_textStorage enumerateAttribute:ABI30_0_0RCTTextAttributesIsHighlightedAttributeName
...
- (NSNumber *)ReactABI30_0_0TagAtPoint:(CGPoint)point
{
  ...
  if (_textStorage.length > 0 && (fraction > 0 || characterIndex > 0) && (fraction < 1 || characterIndex < _textStorage.length - 1)) {
    ReactABI30_0_0Tag = [_textStorage attribute:ABI30_0_0RCTTextAttributesTagAttributeName atIndex:characterIndex effectiveRange:NULL];
  }

  return ReactABI30_0_0Tag;
}
