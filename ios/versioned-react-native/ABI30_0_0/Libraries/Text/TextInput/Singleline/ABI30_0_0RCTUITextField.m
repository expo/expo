...
#import "ABI30_0_0RCTBackedTextInputDelegateAdapter.h"

@implementation ABI30_0_0RCTUITextField {
  ABI30_0_0RCTBackedTextFieldDelegateAdapter *_textInputDelegateAdapter;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI30_0_0RCTBackedTextFieldDelegateAdapter alloc] initWithTextField:self];
  }
...
- (CGSize)intrinsicContentSize
{
  ...
  size = CGSizeMake(ABI30_0_0RCTCeilPixelValue(size.width), ABI30_0_0RCTCeilPixelValue(size.height));
