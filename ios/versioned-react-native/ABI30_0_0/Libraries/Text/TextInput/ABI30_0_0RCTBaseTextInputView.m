...
@implementation ABI30_0_0RCTBaseTextInputView {
...
- (UIView<ABI30_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  ABI30_0_0RCTAssert(NO, @"-[ABI30_0_0RCTBaseTextInputView backedTextInputView] must be implemented in subclass.");
  return nil;
}

#pragma mark - ABI30_0_0RCTComponent
...
- (void)setTextAttributes:(ABI30_0_0RCTTextAttributes *)textAttributes
{
...
{
  id<ABI30_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
...
- (void)setReactABI30_0_0PaddingInsets:(UIEdgeInsets)ReactABI30_0_0PaddingInsets
{
  _ReactABI30_0_0PaddingInsets = ReactABI30_0_0PaddingInsets;
  // We apply `paddingInsets` as `backedTextInputView`'s `textContainerInset`.
  self.backedTextInputView.textContainerInset = ReactABI30_0_0PaddingInsets;
  [self setNeedsLayout];
}

- (void)setReactABI30_0_0BorderInsets:(UIEdgeInsets)ReactABI30_0_0BorderInsets
{
  _ReactABI30_0_0BorderInsets = ReactABI30_0_0BorderInsets;
  // We apply `borderInsets` as `backedTextInputView` layout offset.
  self.backedTextInputView.frame = UIEdgeInsetsInsetRect(self.bounds, ReactABI30_0_0BorderInsets);
  [self setNeedsLayout];
}
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  [backedTextInputViewTextCopy removeAttribute:ABI30_0_0RCTTextAttributesTagAttributeName
                                         range:NSMakeRange(0, backedTextInputViewTextCopy.length)];

  [attributedTextCopy removeAttribute:ABI30_0_0RCTTextAttributesTagAttributeName
  ...
  } else if (eventLag > ABI30_0_0RCTTextUpdateLagWarningThreshold) {
    ABI30_0_0RCTLogWarn(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", self.backedTextInputView.attributedText.string, (long long)eventLag);
  }
}

- (ABI30_0_0RCTTextSelection *)selection
{
  id<ABI30_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
  UITextRange *selectedTextRange = backedTextInputView.selectedTextRange;
  return [[ABI30_0_0RCTTextSelection new] initWithStart:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.start]
                                           end:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.end]];
}

- (void)setSelection:(ABI30_0_0RCTTextSelection *)selection
{
  if (!selection) {
    return;
  }
  ...
  if (eventLag == 0 && ![previousSelectedTextRange isEqual:selectedTextRange]) {
    ...
    ABI30_0_0RCTLogWarn(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", backedTextInputView.attributedText.string, (long long)eventLag);
  }
}
...
{
  UIView<ABI30_0_0RCTBackedTextInputViewProtocol> *textInputView = self.backedTextInputView;
...
#pragma mark - ABI30_0_0RCTBackedTextInputDelegate
...
- (void)textInputDidBeginEditing
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI30_0_0RCTTextEventTypeFocus
...
{
  [_eventDispatcher sendTextEventWithType:ABI30_0_0RCTTextEventTypeEnd
                                 ReactABI30_0_0Tag:self.ReactABI30_0_0Tag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];

  [_eventDispatcher sendTextEventWithType:ABI30_0_0RCTTextEventTypeBlur
                                 ReactABI30_0_0Tag:self.ReactABI30_0_0Tag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldReturn
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI30_0_0RCTTextEventTypeSubmit
                                 ReactABI30_0_0Tag:self.ReactABI30_0_0Tag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text
{
  ...
  if (!backedTextInputView.textWasPasted) {
    [_eventDispatcher sendTextEventWithType:ABI30_0_0RCTTextEventTypeKeyPress
                                   ReactABI30_0_0Tag:self.ReactABI30_0_0Tag
                                       text:nil
                                        key:text
                                 eventCount:_nativeEventCount];
...
- (void)textInputDidChangeSelection
{
  ...
  ABI30_0_0RCTTextSelection *selection = self.selection;
...
- (CGSize)intrinsicContentSize
{
  ...
  size.width += _ReactABI30_0_0BorderInsets.left + _ReactABI30_0_0BorderInsets.right;
  size.height += _ReactABI30_0_0BorderInsets.top + _ReactABI30_0_0BorderInsets.bottom;
...
{
  CGFloat compoundHorizontalBorderInset = _ReactABI30_0_0BorderInsets.left + _ReactABI30_0_0BorderInsets.right;
  CGFloat compoundVerticalBorderInset = _ReactABI30_0_0BorderInsets.top + _ReactABI30_0_0BorderInsets.bottom;
...
{
  [self.backedTextInputView ReactABI30_0_0Focus];
}

- (void)ReactABI30_0_0Blur
{
  [self.backedTextInputView ReactABI30_0_0Blur];
}

- (void)didMoveToWindow
{
  [self.backedTextInputView ReactABI30_0_0FocusIfNeeded];
}
...
{
  #if !TARGET_OS_TV
  __weak ABI30_0_0RCTBaseTextInputView *weakSelf = self;
  [_bridge.uiManager rootViewForReactABI30_0_0Tag:self.ReactABI30_0_0Tag withCompletion:^(UIView *rootView) {
    ABI30_0_0RCTBaseTextInputView *strongSelf = weakSelf;
    if (rootView) {
      UIView *accessoryView = [strongSelf->_bridge.uiManager viewForNativeID:nativeID
                                                                 withRootTag:rootView.ReactABI30_0_0Tag];
      if (accessoryView && [accessoryView isKindOfClass:[ABI30_0_0RCTInputAccessoryView class]]) {
        strongSelf.backedTextInputView.inputAccessoryView = ((ABI30_0_0RCTInputAccessoryView *)accessoryView).inputAccessoryView;
