...
#import "ABI30_0_0RCTMultilineTextInputView.h"

#import <ReactABI30_0_0/ABI30_0_0RCTUtils.h>

#import "ABI30_0_0RCTUITextView.h"

@implementation ABI30_0_0RCTMultilineTextInputView
{
  ABI30_0_0RCTUITextView *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI30_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI30_0_0RCTUITextView alloc] initWithFrame:self.bounds];
...
{
  ABI30_0_0RCTDirectEventBlock onScroll = self.onScroll;
