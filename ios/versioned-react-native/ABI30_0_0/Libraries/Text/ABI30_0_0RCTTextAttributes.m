...
NSString *const ABI30_0_0RCTTextAttributesIsHighlightedAttributeName = @"ABI30_0_0RCTTextAttributesIsHighlightedAttributeName";
NSString *const ABI30_0_0RCTTextAttributesTagAttributeName = @"ABI30_0_0RCTTextAttributesTagAttributeName";

@implementation ABI30_0_0RCTTextAttributes
...
- (void)applyTextAttributes:(ABI30_0_0RCTTextAttributes *)textAttributes
{
  ...
  _textDecorationLine = textAttributes->_textDecorationLine != ABI30_0_0RCTTextDecorationLineTypeNone ? textAttributes->_textDecorationLine : _textDecorationLine; // *
...
- (NSDictionary<NSAttributedStringKey, id> *)effectiveTextAttributes
{
  ...
  if (_textDecorationLine == ABI30_0_0RCTTextDecorationLineTypeUnderline ||
      _textDecorationLine == ABI30_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    isTextDecorationEnabled = YES;
    attributes[NSUnderlineStyleAttributeName] = @(_textDecorationStyle);
  }

  if (_textDecorationLine == ABI30_0_0RCTTextDecorationLineTypeStrikethrough ||
      _textDecorationLine == ABI30_0_0RCTTextDecorationLineTypeUnderlineStrikethrough){
    isTextDecorationEnabled = YES;
  ...
  // Special
  if (_isHighlighted) {
    attributes[ABI30_0_0RCTTextAttributesIsHighlightedAttributeName] = @YES;
  }

  if (_tag) {
    attributes[ABI30_0_0RCTTextAttributesTagAttributeName] = _tag;
  }
...
{
  // FIXME: ABI30_0_0RCTFont has thread-safety issues and must be rewritten.
  return [ABI30_0_0RCTFont updateFont:nil
...
{
  return !ABI30_0_0RCTHasFontHandlerSet() && _allowFontScaling && !isnan(_fontSizeMultiplier) ? _fontSizeMultiplier : 1.0;
}
...
- (ABI30_0_0RCTTextAttributes *)copyWithZone:(NSZone *)zone
{
  ABI30_0_0RCTTextAttributes *textAttributes = [ABI30_0_0RCTTextAttributes new];
...
- (BOOL)isEqual:(ABI30_0_0RCTTextAttributes *)textAttributes
{
  if (self == textAttributes) {
    return YES;
  }

#define ABI30_0_0RCTTextAttributesCompareFloats(a) ((a == textAttributes->a) || (isnan(a) && isnan(textAttributes->a)))
#define ABI30_0_0RCTTextAttributesCompareSize(a) CGSizeEqualToSize(a, textAttributes->a)
#define ABI30_0_0RCTTextAttributesCompareObjects(a) ((a == textAttributes->a) || [a isEqual:textAttributes->a])
#define ABI30_0_0RCTTextAttributesCompareStrings(a) ((a == textAttributes->a) || [a isEqualToString:textAttributes->a])
#define ABI30_0_0RCTTextAttributesCompareOthers(a) (a == textAttributes->a)

  return
    ABI30_0_0RCTTextAttributesCompareObjects(_foregroundColor) &&
    ABI30_0_0RCTTextAttributesCompareObjects(_backgroundColor) &&
    ABI30_0_0RCTTextAttributesCompareFloats(_opacity) &&
    // Font
    ABI30_0_0RCTTextAttributesCompareObjects(_fontFamily) &&
    ABI30_0_0RCTTextAttributesCompareFloats(_fontSize) &&
    ABI30_0_0RCTTextAttributesCompareFloats(_fontSizeMultiplier) &&
    ABI30_0_0RCTTextAttributesCompareStrings(_fontWeight) &&
    ABI30_0_0RCTTextAttributesCompareObjects(_fontStyle) &&
    ABI30_0_0RCTTextAttributesCompareObjects(_fontVariant) &&
    ABI30_0_0RCTTextAttributesCompareOthers(_allowFontScaling) &&
    ABI30_0_0RCTTextAttributesCompareFloats(_letterSpacing) &&
    // Paragraph Styles
    ABI30_0_0RCTTextAttributesCompareFloats(_lineHeight) &&
    ABI30_0_0RCTTextAttributesCompareFloats(_alignment) &&
    ABI30_0_0RCTTextAttributesCompareOthers(_baseWritingDirection) &&
    // Decoration
    ABI30_0_0RCTTextAttributesCompareObjects(_textDecorationColor) &&
    ABI30_0_0RCTTextAttributesCompareOthers(_textDecorationStyle) &&
    ABI30_0_0RCTTextAttributesCompareOthers(_textDecorationLine) &&
    // Shadow
    ABI30_0_0RCTTextAttributesCompareSize(_textShadowOffset) &&
    ABI30_0_0RCTTextAttributesCompareFloats(_textShadowRadius) &&
    ABI30_0_0RCTTextAttributesCompareObjects(_textShadowColor) &&
    // Special
    ABI30_0_0RCTTextAttributesCompareOthers(_isHighlighted) &&
    ABI30_0_0RCTTextAttributesCompareObjects(_tag) &&
    ABI30_0_0RCTTextAttributesCompareOthers(_layoutDirection);
}
