...
#import "ABI30_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI30_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI30_0_0ViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI30_0_0ViewController detachChildViewController:self.contentViewController];
}
