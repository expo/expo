...
#import "ABI30_0_0RCTPhotoLibraryImageLoader.h"

#import <Photos/Photos.h>

#import <ReactABI30_0_0/ABI30_0_0RCTUtils.h>

@implementation ABI30_0_0RCTPhotoLibraryImageLoader

ABI30_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI30_0_0RCTImageLoader
...
- (ABI30_0_0RCTImageLoaderCancellationBlock)loadImageForURL:(NSURL *)imageURL
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                        resizeMode:(ABI30_0_0RCTResizeMode)resizeMode
                                   progressHandler:(ABI30_0_0RCTImageLoaderProgressBlock)progressHandler
                                partialLoadHandler:(ABI30_0_0RCTImageLoaderPartialLoadBlock)partialLoadHandler
                                 completionHandler:(ABI30_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (!imageURL) {
    completionHandler(ABI30_0_0RCTErrorWithMessage(@"Cannot load a photo library asset with no URL"), nil);
    return ^{};
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI30_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI30_0_0RCTResizeModeContain) {
