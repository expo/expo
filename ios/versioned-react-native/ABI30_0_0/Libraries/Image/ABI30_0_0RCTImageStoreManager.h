...
@interface ABI30_0_0RCTImageStoreManager : NSObject <ABI30_0_0RCTURLRequestHandler>
...
@interface ABI30_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI30_0_0RCTBridge (ABI30_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI30_0_0RCTImageStoreManager *imageStoreManager;
