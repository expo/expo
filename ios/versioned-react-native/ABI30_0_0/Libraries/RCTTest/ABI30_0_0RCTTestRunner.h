...
#define ABI30_0_0RCT_RUN_RUNLOOP_WHILE(CONDITION)                                                          \
{                                                                                                 \
...
/**
 * Use the ABI30_0_0RCTInitRunnerForApp macro for typical usage. See FBSnapshotTestCase.h for more information
 * on how to configure the snapshotting system.
 */
#define ABI30_0_0RCTInitRunnerForApp(app__, moduleProvider__, scriptURL__) \
[[ABI30_0_0RCTTestRunner alloc] initWithApp:(app__) \
                referenceDirectory:@FB_REFERENCE_IMAGE_DIR \
                    moduleProvider:(moduleProvider__) \
                    scriptURL: scriptURL__]

@protocol ABI30_0_0RCTBridgeModule;
@class ABI30_0_0RCTBridge;

@class ABI30_0_0RCTRootView;

@interface ABI30_0_0RCTTestRunner : NSObject
...
/**
 * Initialize a runner.  It's recommended that you use the ABI30_0_0RCTInitRunnerForApp
 ...
 *
 *   ABI30_0_0RCTTestModule.markTestCompleted()
 *
 * JS errors/exceptions and timeouts will fail the test.  Snapshot tests call
 * ABI30_0_0RCTTestModule.verifySnapshot whenever they want to verify what has been
...
configurationBlock:(void(^)(ABI30_0_0RCTRootView *rootView))configurationBlock;
