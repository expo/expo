...
@interface ABI40_0_0RCTDataRequestHandler() <ABI40_0_0RCTTurboModule>
@end

@implementation ABI40_0_0RCTDataRequestHandler
{
...
Class ABI40_0_0RCTDataRequestHandlerCls(void) {
  return ABI40_0_0RCTDataRequestHandler.class;
}
