...
@interface ABI40_0_0RCTFileRequestHandler() <ABI40_0_0RCTTurboModule>
@end

@implementation ABI40_0_0RCTFileRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  && !ABI40_0_0RCTIsBundleAssetURL(request.URL);
}

- (NSOperation *)sendRequest:(NSURLRequest *)request
                withDelegate:(id<ABI40_0_0RCTURLRequestDelegate>)delegate
{
  // Lazy setup
  if (!_fileQueue) {
...
Class ABI40_0_0RCTFileRequestHandlerCls(void) {
  return ABI40_0_0RCTFileRequestHandler.class;
}
