...
@implementation ABI40_0_0ARTText
...
static void ABI40_0_0ARTFreeTextFrame(ABI40_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI40_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI40_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI40_0_0ARTTextFrame frame = self.textFrame;
