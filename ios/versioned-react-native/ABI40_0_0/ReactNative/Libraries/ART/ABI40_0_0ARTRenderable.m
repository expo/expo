...
#import <ABI40_0_0React/ABI40_0_0ARTRenderable.h>

@implementation ABI40_0_0ARTRenderable

- (void)setFill:(ABI40_0_0ARTBrush *)fill
{
  [self invalidate];
  _fill = fill;
}
...
- (void)setStrokeDash:(ABI40_0_0ARTCGFloatArray)strokeDash
{
