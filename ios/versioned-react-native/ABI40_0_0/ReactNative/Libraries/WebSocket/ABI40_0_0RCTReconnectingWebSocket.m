...
@interface ABI40_0_0RCTReconnectingWebSocket () <ABI40_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI40_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  ...
  __weak ABI40_0_0RCTSRWebSocket *socket = _socket;
