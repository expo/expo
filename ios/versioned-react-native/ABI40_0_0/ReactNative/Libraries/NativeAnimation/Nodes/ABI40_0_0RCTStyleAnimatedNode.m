...
@implementation ABI40_0_0RCTStyleAnimatedNode
{
...
- (void)performUpdate
{
  ...
  [style enumerateKeysAndObjectsUsingBlock:^(NSString *property, NSNumber *nodeTag, __unused BOOL *stop) {
    ...
    if (node) {
      ...
      } else if ([node isKindOfClass:[ABI40_0_0RCTTransformAnimatedNode class]]) {
        ABI40_0_0RCTTransformAnimatedNode *parentNode = (ABI40_0_0RCTTransformAnimatedNode *)node;
