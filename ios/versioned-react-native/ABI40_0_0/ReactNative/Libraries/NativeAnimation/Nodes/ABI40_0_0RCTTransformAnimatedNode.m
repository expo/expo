...
@implementation ABI40_0_0RCTTransformAnimatedNode
{
...
- (void)performUpdate
{
  ...
  for (NSDictionary *transformConfig in transformConfigs) {
    ...
    if ([type isEqualToString: @"animated"]) {
      ...
      ABI40_0_0RCTAnimatedNode *node = [self.parentNodes objectForKey:nodeTag];
      if (![node isKindOfClass:[ABI40_0_0RCTValueAnimatedNode class]]) {
        continue;
      }
      ABI40_0_0RCTValueAnimatedNode *parentNode = (ABI40_0_0RCTValueAnimatedNode *)node;
