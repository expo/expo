...
@implementation ABI40_0_0RCTTrackingAnimatedNode {
...
- (void)performUpdate
{
  ...
  ABI40_0_0RCTValueAnimatedNode *node = (ABI40_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
