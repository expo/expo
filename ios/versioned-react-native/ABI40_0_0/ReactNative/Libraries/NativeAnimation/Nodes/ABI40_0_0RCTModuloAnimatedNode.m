...
@implementation ABI40_0_0RCTModuloAnimatedNode
...
- (void)performUpdate
{
  ...
  ABI40_0_0RCTValueAnimatedNode *parent = (ABI40_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:inputNode];
