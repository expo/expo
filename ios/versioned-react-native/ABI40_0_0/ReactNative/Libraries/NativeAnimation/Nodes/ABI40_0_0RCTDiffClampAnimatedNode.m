...
@implementation ABI40_0_0RCTDiffClampAnimatedNode
{
...
- (void)onAttachedToNode:(ABI40_0_0RCTAnimatedNode *)parent
{
...
{
  ABI40_0_0RCTValueAnimatedNode *inputNode = (ABI40_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI40_0_0RCTValueAnimatedNode class]]) {
    ABI40_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
