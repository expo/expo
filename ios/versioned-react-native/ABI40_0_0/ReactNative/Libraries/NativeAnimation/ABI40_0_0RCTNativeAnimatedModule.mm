...
#import <ABI40_0_0React/ABI40_0_0RCTNativeAnimatedModule.h>
#import <ABI40_0_0React/ABI40_0_0RCTNativeAnimatedNodesManager.h>

#import <ABI40_0_0RCTTypeSafety/ABI40_0_0RCTConvertHelpers.h>

#import "ABI40_0_0RCTAnimationPlugins.h"

typedef void (^AnimatedOperation)(ABI40_0_0RCTNativeAnimatedNodesManager *nodesManager);

@interface ABI40_0_0RCTNativeAnimatedModule() <ABI40_0_0NativeAnimatedModuleSpec>
@end

@implementation ABI40_0_0RCTNativeAnimatedModule
{
  ABI40_0_0RCTNativeAnimatedNodesManager *_nodesManager;
...
- (void)setBridge:(ABI40_0_0RCTBridge *)bridge
{
  ...
  _nodesManager = [[ABI40_0_0RCTNativeAnimatedNodesManager alloc] initWithBridge:self.bridge];
...
ABI40_0_0RCT_EXPORT_METHOD(createAnimatedNode:(double)tag
                  config:(NSDictionary<NSString *, id> *)config)
{
  [self addOperationBlock:^(ABI40_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager createAnimatedNode:[NSNumber numberWithDouble:tag] config:config];
  }];
}

ABI40_0_0RCT_EXPORT_METHOD(connectAnimatedNodes:(double)parentTag
...
ABI40_0_0RCT_EXPORT_METHOD(disconnectAnimatedNodes:(double)parentTag
                  childTag:(double)childTag)
{
  [self addOperationBlock:^(ABI40_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI40_0_0RCT_EXPORT_METHOD(startAnimatingNode:(double)animationId
...
ABI40_0_0RCT_EXPORT_METHOD(stopAnimation:(double)animationId)
{
  [self addOperationBlock:^(ABI40_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI40_0_0RCT_EXPORT_METHOD(setAnimatedNodeValue:(double)nodeTag
                  value:(double)value)
{
  [self addOperationBlock:^(ABI40_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI40_0_0RCT_EXPORT_METHOD(setAnimatedNodeOffset:(double)nodeTag
...
ABI40_0_0RCT_EXPORT_METHOD(flattenAnimatedNodeOffset:(double)nodeTag)
{
  [self addOperationBlock:^(ABI40_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI40_0_0RCT_EXPORT_METHOD(extractAnimatedNodeOffset:(double)nodeTag)
{
  [self addOperationBlock:^(ABI40_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI40_0_0RCT_EXPORT_METHOD(connectAnimatedNodeToView:(double)nodeTag
                  viewTag:(double)viewTag)
{
  NSString *viewName = [self.bridge.uiManager viewNameForABI40_0_0ReactTag:[NSNumber numberWithDouble:viewTag]];
  [self addOperationBlock:^(ABI40_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI40_0_0RCT_EXPORT_METHOD(disconnectAnimatedNodeFromView:(double)nodeTag
                  viewTag:(double)viewTag)
{
  [self addOperationBlock:^(ABI40_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI40_0_0RCT_EXPORT_METHOD(restoreDefaultValues:(double)nodeTag)
{
  [self addPreOperationBlock:^(ABI40_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager restoreDefaultValues:[NSNumber numberWithDouble:nodeTag]];
  }];
}

ABI40_0_0RCT_EXPORT_METHOD(dropAnimatedNode:(double)tag)
{
  [self addOperationBlock:^(ABI40_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI40_0_0RCT_EXPORT_METHOD(startListeningToAnimatedNodeValue:(double)tag)
{
  __weak id<ABI40_0_0RCTValueAnimatedNodeObserver> valueObserver = self;
  [self addOperationBlock:^(ABI40_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager startListeningToAnimatedNodeValue:[NSNumber numberWithDouble:tag] valueObserver:valueObserver];
  }];
}

ABI40_0_0RCT_EXPORT_METHOD(stopListeningToAnimatedNodeValue:(double)tag)
{
  [self addOperationBlock:^(ABI40_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI40_0_0RCT_EXPORT_METHOD(addAnimatedEventToView:(double)viewTag
                  ...
                  eventMapping:(JS::NativeAnimatedModule::EventMapping &)eventMapping)
{
  ...
  eventMappingDict[@"nativeEventPath"] = ABI40_0_0RCTConvertVecToArray(eventMapping.nativeEventPath());
...
ABI40_0_0RCT_EXPORT_METHOD(removeAnimatedEventFromView:(double)viewTag
                  eventName:(nonnull NSString *)eventName
...
#pragma mark - ABI40_0_0RCTSurfacePresenterObserver
...
- (void)uiManagerWillPerformMounting:(ABI40_0_0RCTUIManager *)uiManager
{
  ...
  [uiManager prependUIBlock:^(__unused ABI40_0_0RCTUIManager *manager, __unused NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    for (AnimatedOperation operation in preOperations) {
      operation(self->_nodesManager);
    }
  }];
...
{
  return std::make_shared<ABI40_0_0facebook::ABI40_0_0React::NativeAnimatedModuleSpecJSI>(self, jsInvoker, nativeInvoker, perfLogger);
}

@end

Class ABI40_0_0RCTNativeAnimatedModuleCls(void) {
  return ABI40_0_0RCTNativeAnimatedModule.class;
}
