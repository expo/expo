...
@interface ABI40_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI40_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI40_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
...
@interface ABI40_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI40_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI40_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}
