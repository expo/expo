...
#import "ABI40_0_0NSTextStorage+FontScaling.h"
#import <ABI40_0_0React/ABI40_0_0RCTBaseTextInputView.h>

@implementation ABI40_0_0RCTBaseTextInputShadowView
{
...
- (instancetype)initWithBridge:(ABI40_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI40_0_0YGNodeSetMeasureFunc(self.yogaNode, ABI40_0_0RCTBaseTextInputShadowViewMeasure);
    ABI40_0_0YGNodeSetBaselineFunc(self.yogaNode, ABI40_0_0RCTTextInputShadowViewBaseline);
  }
...
{
  if (ABI40_0_0YGNodeIsDirty(self.yogaNode)) {
    return;
  }
  ...
  ABI40_0_0RCTTextAttributes *textAttributes = [self.textAttributes copy];
  ...
  [attributedText removeAttribute:ABI40_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                            range:NSMakeRange(0, attributedText.length)];

  [attributedText removeAttribute:ABI40_0_0RCTTextAttributesTagAttributeName
                            range:NSMakeRange(0, attributedText.length)];
  ...
  NSNumber *tag = self.ABI40_0_0ReactTag;

  [_bridge.uiManager addUIBlock:^(ABI40_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI40_0_0RCTBaseTextInputView *baseTextInputView = (ABI40_0_0RCTBaseTextInputView *)viewRegistry[tag];
    if (!baseTextInputView) {
      return;
    }

    baseTextInputView.textAttributes = textAttributes;
    baseTextInputView.ABI40_0_0ReactBorderInsets = borderInsets;
    baseTextInputView.ABI40_0_0ReactPaddingInsets = paddingInsets;
...
- (CGSize)sizeThatFitsMinimumSize:(CGSize)minimumSize maximumSize:(CGSize)maximumSize
{
  ...
  return (CGSize){
    MAX(minimumSize.width, MIN(ABI40_0_0RCTCeilPixelValue(size.width), maximumSize.width)),
    MAX(minimumSize.height, MIN(ABI40_0_0RCTCeilPixelValue(size.height), maximumSize.height))
  };
}
...
static ABI40_0_0YGSize ABI40_0_0RCTBaseTextInputShadowViewMeasure(ABI40_0_0YGNodeRef node, float width, ABI40_0_0YGMeasureMode widthMode, float height, ABI40_0_0YGMeasureMode heightMode)
{
  ABI40_0_0RCTShadowView *shadowView = (__bridge ABI40_0_0RCTShadowView *)ABI40_0_0YGNodeGetContext(node);

  CGSize minimumSize = CGSizeMake(0, 0);
  CGSize maximumSize = CGSizeMake(CGFLOAT_MAX, CGFLOAT_MAX);

  CGSize size = {
    ABI40_0_0RCTCoreGraphicsFloatFromYogaFloat(width),
    ABI40_0_0RCTCoreGraphicsFloatFromYogaFloat(height)
  };
  ...
  return (ABI40_0_0YGSize){
    ABI40_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.width),
    ABI40_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.height)
  };
}

static float ABI40_0_0RCTTextInputShadowViewBaseline(ABI40_0_0YGNodeRef node, const float width, const float height)
{
  ABI40_0_0RCTBaseTextInputShadowView *shadowTextView = (__bridge ABI40_0_0RCTBaseTextInputShadowView *)ABI40_0_0YGNodeGetContext(node);
  ...
  return ABI40_0_0RCTYogaFloatFromCoreGraphicsFloat(lastBaseline);
}
