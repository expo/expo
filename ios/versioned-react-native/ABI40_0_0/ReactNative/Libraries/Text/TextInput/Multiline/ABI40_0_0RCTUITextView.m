...
#import <ABI40_0_0React/ABI40_0_0RCTBackedTextInputDelegateAdapter.h>
#import <ABI40_0_0React/ABI40_0_0RCTTextAttributes.h>

@implementation ABI40_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI40_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI40_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  // see: https://github.com/facebook/ABI40_0_0React-native/issues/19339
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI40_0_0RCTCeilPixelValue(placeholderSize.width), ABI40_0_0RCTCeilPixelValue(placeholderSize.height));
