...
#import <ABI40_0_0React/ABI40_0_0RCTBackedTextInputDelegate.h>
 ...
 */
@interface ABI40_0_0RCTUITextView : UITextView <ABI40_0_0RCTBackedTextInputViewProtocol>

- (instancetype)initWithFrame:(CGRect)frame textContainer:(nullable NSTextContainer *)textContainer NS_UNAVAILABLE;
- (instancetype)initWithCoder:(NSCoder *)decoder NS_UNAVAILABLE;

@property (nonatomic, weak) id<ABI40_0_0RCTBackedTextInputDelegate> textInputDelegate;
