...
@protocol ABI40_0_0RCTBackedTextInputDelegate;
@class ABI40_0_0RCTTextAttributes;

NS_ASSUME_NONNULL_BEGIN

@protocol ABI40_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI40_0_0RCTBackedTextInputDelegate> textInputDelegate;
