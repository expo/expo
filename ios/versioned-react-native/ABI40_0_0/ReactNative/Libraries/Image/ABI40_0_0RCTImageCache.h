...
@interface UIImage (ABI40_0_0React)
 ...
 */
@property (nonatomic, assign) NSInteger ABI40_0_0ReactDecodedImageBytes;
 ...
 */
@protocol ABI40_0_0RCTImageCache <NSObject>
...
@interface ABI40_0_0RCTImageCache : NSObject <ABI40_0_0RCTImageCache>
@end
