...
typedef void (^ABI40_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI40_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI40_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI40_0_0RCTImageLoaderCancellationBlock;
 ...
 */
@protocol ABI40_0_0RCTImageURLLoader <ABI40_0_0RCTBridgeModule>
...
/**
 * If more than one ABI40_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI40_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
