...
@interface ABI40_0_0RCTImageStoreManager : NSObject <ABI40_0_0RCTURLRequestHandler>
...
@interface ABI40_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI40_0_0RCTBridge (ABI40_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI40_0_0RCTImageStoreManager *imageStoreManager;
