...
#import "ABI40_0_0RCTImagePickerManager.h"
...
@interface ABI40_0_0RCTImagePickerController : UIImagePickerController

@property (nonatomic, assign) BOOL unmirrorFrontFacingCamera;

@end

@implementation ABI40_0_0RCTImagePickerController

@end

@interface ABI40_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate, ABI40_0_0NativeImagePickerIOSSpec>
@end

@implementation ABI40_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI40_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI40_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
  NSMutableDictionary<NSString *, NSDictionary<NSString *, id> *> *_pendingVideoInfo;
}

ABI40_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI40_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI40_0_0RCTResponseSenderBlock)callback)
{
...
ABI40_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI40_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI40_0_0RCT_EXPORT_METHOD(openCameraDialog:(JS::NativeImagePickerIOS::SpecOpenCameraDialogConfig &)config
                  successCallback:(ABI40_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI40_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  ABI40_0_0RCTImagePickerController *imagePicker = [ABI40_0_0RCTImagePickerController new];
...
ABI40_0_0RCT_EXPORT_METHOD(openSelectDialog:(JS::NativeImagePickerIOS::SpecOpenSelectDialogConfig &)config
                  successCallback:(ABI40_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI40_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI40_0_0RCTRunningInAppExtension()) {
...
ABI40_0_0RCT_EXPORT_METHOD(clearAllPendingVideos)
{
...
ABI40_0_0RCT_EXPORT_METHOD(removePendingVideo:(NSString *)url)
{
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    ...
    [self _dismissPicker:picker args:@[imageURLString, ABI40_0_0RCTNullIfNil(height), ABI40_0_0RCTNullIfNil(width)]];
    return;
  }
  ...
  [_bridge.imageStoreManager storeImage:originalImage withBlock:^(NSString *tempImageTag) {
    [self _dismissPicker:picker args:tempImageTag ? @[tempImageTag, ABI40_0_0RCTNullIfNil(height), ABI40_0_0RCTNullIfNil(width)] : nil];
  }];
}
        ...
        cancelCallback:(ABI40_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI40_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI40_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI40_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
...
- (void)cameraChanged:(NSNotification *)notification
{
  for (UIImagePickerController *picker in _pickers) {
    ...
    if ([picker isKindOfClass:[ABI40_0_0RCTImagePickerController class]]
      && ((ABI40_0_0RCTImagePickerController *)picker).unmirrorFrontFacingCamera
...
{
  return std::make_shared<ABI40_0_0facebook::ABI40_0_0React::NativeImagePickerIOSSpecJSI>(self, jsInvoker, nativeInvoker, perfLogger);
}

@end

Class ABI40_0_0RCTImagePickerManagerCls(void) {
  return ABI40_0_0RCTImagePickerManager.class;
}
