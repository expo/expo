...
typedef uint32_t ABI40_0_0RCTHandlerToken;
typedef void (^ABI40_0_0RCTNotificationHandler)(NSDictionary<NSString *, id> *);
typedef void (^ABI40_0_0RCTRequestHandler)(NSDictionary<NSString *, id> *, ABI40_0_0RCTPackagerClientResponder *);
typedef void (^ABI40_0_0RCTConnectedHandler)(void);

/** Encapsulates singleton connection to ABI40_0_0React Native packager. */
@interface ABI40_0_0RCTPackagerConnection : NSObject
