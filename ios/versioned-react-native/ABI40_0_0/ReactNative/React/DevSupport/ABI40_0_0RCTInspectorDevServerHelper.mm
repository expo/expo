...
static NSURL *getInspectorDeviceUrl(NSURL *bundleURL)
{
  ...
  NSString *inspectorProxyPortStr = [[[NSProcessInfo processInfo] environment] objectForKey:@"ABI40_0_0RCT_METRO_PORT"];
...
@implementation ABI40_0_0RCTInspectorDevServerHelper

ABI40_0_0RCT_NOT_IMPLEMENTED(-(instancetype)init)

static NSMutableDictionary<NSString *, ABI40_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
...
+ (ABI40_0_0RCTInspectorPackagerConnection *)connectWithBundleURL:(NSURL *)bundleURL
{
  ...
  ABI40_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection || !connection.isConnected) {
    connection = [[ABI40_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
