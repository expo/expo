...
#import <ABI40_0_0React/ABI40_0_0RCTJSInvokerModule.h>

/**
 * ABI40_0_0RCTEventEmitter is an abstract base class to be used for modules that emit
 * events to be observed by JS.
 */
@interface ABI40_0_0RCTEventEmitter : NSObject <ABI40_0_0RCTBridgeModule, ABI40_0_0RCTJSInvokerModule>
