...
#import "ABI40_0_0RCTRedBoxExtraDataViewController.h"

@interface ABI40_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI40_0_0RCTRedBoxExtraDataCell
...
@interface ABI40_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI40_0_0RCTRedBoxExtraDataViewController {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  ABI40_0_0RCTRedBoxExtraDataCell *cell =
      (ABI40_0_0RCTRedBoxExtraDataCell *)[tableView dequeueReusableCellWithIdentifier:reuseIdentifier];

  if (cell == nil) {
    cell = [[ABI40_0_0RCTRedBoxExtraDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
  }
