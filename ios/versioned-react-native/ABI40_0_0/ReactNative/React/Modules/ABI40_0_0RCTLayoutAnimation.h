...
#import <ABI40_0_0React/ABI40_0_0RCTAnimationType.h>

@interface ABI40_0_0RCTLayoutAnimation : NSObject
...
@property (nonatomic, readonly) ABI40_0_0RCTAnimationType animationType;
...
- (instancetype)initWithDuration:(NSTimeInterval)duration
                 ...
                 initialVelocity:(CGFloat)initialVelocity
                   animationType:(ABI40_0_0RCTAnimationType)animationType;
