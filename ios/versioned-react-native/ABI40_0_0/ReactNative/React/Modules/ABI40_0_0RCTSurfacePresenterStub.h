...
// TODO: Eventually this should go away and files should just include ABI40_0_0RCTSurfacePresenter.h, but
...
@protocol ABI40_0_0RCTSurfacePresenterObserver <NSObject>
...
@protocol ABI40_0_0RCTSurfacePresenterStub <NSObject>
...
@interface ABI40_0_0RCTBridge (ABI40_0_0RCTSurfacePresenterStub)

- (id<ABI40_0_0RCTSurfacePresenterStub>)surfacePresenter;
- (void)setSurfacePresenter:(id<ABI40_0_0RCTSurfacePresenterStub>)presenter;
