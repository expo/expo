...
typedef dispatch_block_t ABI40_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI40_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ABI40_0_0React-independent state can compute and cache
 * own intrinsic content size (which will be used by Yoga) at this point.
 */
- (void)uiManagerWillPerformLayout:(ABI40_0_0RCTUIManager *)manager;
 ...
 */
- (void)uiManagerDidPerformLayout:(ABI40_0_0RCTUIManager *)manager;
 ...
 */
- (void)uiManagerDidPerformMounting:(ABI40_0_0RCTUIManager *)manager;

@end

/**
 * Simple helper which take care of ABI40_0_0RCTUIManager's observers.
 */
@interface ABI40_0_0RCTUIManagerObserverCoordinator : NSObject <ABI40_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI40_0_0RCTUIManagerObserver` protocol for more info.
 * References to observers are held weakly.
 * This method can be called safely from any queue.
 */
- (void)addObserver:(id<ABI40_0_0RCTUIManagerObserver>)observer;

/**
 * Remove a `UIManagerObserver`.
 * This method can be called safely from any queue.
 */
- (void)removeObserver:(id<ABI40_0_0RCTUIManagerObserver>)observer;
