...
@interface UIView (ABI40_0_0React) <ABI40_0_0RCTComponent>

/**
 * ABI40_0_0RCTComponent interface.
 */
- (NSArray<UIView *> *)ABI40_0_0ReactSubviews NS_REQUIRES_SUPER;
- (UIView *)ABI40_0_0ReactSuperview NS_REQUIRES_SUPER;
- (void)insertABI40_0_0ReactSubview:(UIView *)subview atIndex:(NSInteger)atIndex NS_REQUIRES_SUPER;
- (void)removeABI40_0_0ReactSubview:(UIView *)subview NS_REQUIRES_SUPER;
 ...
 */
@property (nonatomic, assign) UIUserInterfaceLayoutDirection ABI40_0_0ReactLayoutDirection;
 ...
 */
@property (nonatomic, assign) ABI40_0_0YGDisplay ABI40_0_0ReactDisplay;

/**
 * The z-index of the view.
 */
@property (nonatomic, assign) NSInteger ABI40_0_0ReactZIndex;
...
/**
 * Updates the subviews array based on the ABI40_0_0ReactSubviews. Default behavior is
 * to insert the sortedABI40_0_0ReactSubviews into the UIView.
 */
 ...
 */
@property (nonatomic, readonly) UIEdgeInsets ABI40_0_0ReactBorderInsets;
@property (nonatomic, readonly) UIEdgeInsets ABI40_0_0ReactPaddingInsets;
@property (nonatomic, readonly) UIEdgeInsets ABI40_0_0ReactCompoundInsets;
@property (nonatomic, readonly) CGRect ABI40_0_0ReactContentFrame;
 ...
 * Defaults to `self`.
 */
@property (nonatomic, readonly) UIView *ABI40_0_0ReactAccessibilityElement;
