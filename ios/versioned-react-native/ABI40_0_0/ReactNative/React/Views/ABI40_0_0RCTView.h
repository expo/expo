...
@protocol ABI40_0_0RCTAutoInsetsProtocol;

@class ABI40_0_0RCTView;

@interface ABI40_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI40_0_0RCTDirectEventBlock onAccessibilityAction;
@property (nonatomic, copy) ABI40_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI40_0_0RCTDirectEventBlock onMagicTap;
@property (nonatomic, copy) ABI40_0_0RCTDirectEventBlock onAccessibilityEscape;
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI40_0_0RCTBorderStyle borderStyle;
