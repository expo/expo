...
@implementation ABI40_0_0RCTModalHostViewController {
...
#if !TARGET_OS_TV
  _preferredStatusBarStyle = [ABI40_0_0RCTSharedApplication() statusBarStyle];
  _preferredStatusBarHidden = [ABI40_0_0RCTSharedApplication() isStatusBarHidden];
#endif
