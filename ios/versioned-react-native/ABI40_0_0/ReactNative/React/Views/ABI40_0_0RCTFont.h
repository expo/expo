...
typedef UIFont * (^ABI40_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ABI40_0_0React Native will use the System font for rendering by default. If you want to
 ...
 */
ABI40_0_0RCT_EXTERN void ABI40_0_0RCTSetDefaultFontHandler(ABI40_0_0RCTFontHandler handler);
ABI40_0_0RCT_EXTERN BOOL ABI40_0_0RCTHasFontHandlerSet(void);

@interface ABI40_0_0RCTFont : NSObject
...
@interface ABI40_0_0RCTConvert (ABI40_0_0RCTFont)
