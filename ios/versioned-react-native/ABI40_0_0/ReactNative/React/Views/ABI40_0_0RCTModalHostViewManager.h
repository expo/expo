...
@interface ABI40_0_0RCTConvert (ABI40_0_0RCTModalHostView)

+ (UIModalPresentationStyle)UIModalPresentationStyle:(id)json;

@end

typedef void (^ABI40_0_0RCTModalViewInteractionBlock)(
    UIViewController *ABI40_0_0ReactViewController,
    UIViewController *viewController,
    BOOL animated,
    dispatch_block_t completionBlock);

@interface ABI40_0_0RCTModalHostViewManager : ABI40_0_0RCTViewManager <ABI40_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, strong) ABI40_0_0RCTModalViewInteractionBlock presentationBlock;
@property (nonatomic, strong) ABI40_0_0RCTModalViewInteractionBlock dismissalBlock;
