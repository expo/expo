...
@implementation ABI40_0_0RCTScrollEvent {
...
- (ABI40_0_0RCTScrollEvent *)coalesceWithEvent:(ABI40_0_0RCTScrollEvent *)newEvent
{
...
- (NSArray *)arguments
{
  return @[ self.viewTag, ABI40_0_0RCTNormalizeInputEventName(self.eventName), [self body] ];
}
