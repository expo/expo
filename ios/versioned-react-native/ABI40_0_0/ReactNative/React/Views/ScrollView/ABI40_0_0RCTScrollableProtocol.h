...
/**
 * Contains any methods related to scrolling. Any `ABI40_0_0RCTView` that has scrolling
 * features should implement these methods.
 */
@protocol ABI40_0_0RCTScrollableProtocol
 ...
 */
@protocol ABI40_0_0RCTCustomRefreshContolProtocol

@property (nonatomic, copy) ABI40_0_0RCTDirectEventBlock onRefresh;
