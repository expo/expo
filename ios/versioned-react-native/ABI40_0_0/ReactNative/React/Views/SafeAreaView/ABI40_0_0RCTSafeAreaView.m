...
@implementation ABI40_0_0RCTSafeAreaView {
...
{
  if (UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI40_0_0RCTScreenScale())) {
    return;
  }

  _currentSafeAreaInsets = safeAreaInsets;

  ABI40_0_0RCTSafeAreaViewLocalData *localData = [[ABI40_0_0RCTSafeAreaViewLocalData alloc] initWithInsets:safeAreaInsets];
