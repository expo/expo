...
@protocol ABI40_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI40_0_0RCTExceptionsManager : NSObject <ABI40_0_0RCTBridgeModule>
...
@property (nonatomic, weak) id<ABI40_0_0RCTExceptionsManagerDelegate> delegate;
