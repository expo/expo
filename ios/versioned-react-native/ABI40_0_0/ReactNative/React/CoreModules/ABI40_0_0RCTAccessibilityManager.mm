...
#import "ABI40_0_0RCTAccessibilityManager.h"
...
NSString *const ABI40_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification =
    @"ABI40_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification";

@interface ABI40_0_0RCTAccessibilityManager () <ABI40_0_0NativeAccessibilityManagerSpec>
...
@implementation ABI40_0_0RCTAccessibilityManager
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    self.contentSizeCategory = ABI40_0_0RCTSharedApplication().preferredContentSizeCategory;
...
- (void)invalidateMultiplier
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI40_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification
                                                      object:self];
}
...
- (CGFloat)multiplierForContentSizeCategory:(NSString *)category
{
  ...
  if (m.doubleValue <= 0.0) {
    ABI40_0_0RCTLogError(@"Can't determine multiplier for category %@. Using 1.0.", category);
    m = @1.0;
  }
...
ABI40_0_0RCT_EXPORT_METHOD(setAccessibilityContentSizeMultipliers
...
ABI40_0_0RCT_EXPORT_METHOD(setAccessibilityFocus : (double)ABI40_0_0ReactTag)
{
  dispatch_async(dispatch_get_main_queue(), ^{
    UIView *view = [self.bridge.uiManager viewForABI40_0_0ReactTag:@(ABI40_0_0ReactTag)];
    UIAccessibilityPostNotification(UIAccessibilityLayoutChangedNotification, view);
  });
}

ABI40_0_0RCT_EXPORT_METHOD(announceForAccessibility : (NSString *)announcement)
{
  UIAccessibilityPostNotification(UIAccessibilityAnnouncementNotification, announcement);
}

ABI40_0_0RCT_EXPORT_METHOD(getMultiplier : (ABI40_0_0RCTResponseSenderBlock)callback)
{
  if (callback) {
...
ABI40_0_0RCT_EXPORT_METHOD(getCurrentBoldTextState
                  : (ABI40_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI40_0_0RCTResponseSenderBlock)onError)
{
  onSuccess(@[ @(_isBoldTextEnabled) ]);
}

ABI40_0_0RCT_EXPORT_METHOD(getCurrentGrayscaleState
                  : (ABI40_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI40_0_0RCTResponseSenderBlock)onError)
{
...
ABI40_0_0RCT_EXPORT_METHOD(getCurrentInvertColorsState
                  : (ABI40_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI40_0_0RCTResponseSenderBlock)onError)
{
...
ABI40_0_0RCT_EXPORT_METHOD(getCurrentReduceMotionState
                  : (ABI40_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI40_0_0RCTResponseSenderBlock)onError)
{
...
ABI40_0_0RCT_EXPORT_METHOD(getCurrentReduceTransparencyState
                  : (ABI40_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI40_0_0RCTResponseSenderBlock)onError)
{
...
ABI40_0_0RCT_EXPORT_METHOD(getCurrentVoiceOverState
                  : (ABI40_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI40_0_0RCTResponseSenderBlock)onError)
{
...
{
  return std::make_shared<ABI40_0_0facebook::ABI40_0_0React::NativeAccessibilityManagerSpecJSI>(
      self, jsInvoker, nativeInvoker, perfLogger);
}

@end

@implementation ABI40_0_0RCTBridge (ABI40_0_0RCTAccessibilityManager)

- (ABI40_0_0RCTAccessibilityManager *)accessibilityManager
{
  return [self moduleForClass:[ABI40_0_0RCTAccessibilityManager class]];
}

@end

Class ABI40_0_0RCTAccessibilityManagerCls(void)
{
  return ABI40_0_0RCTAccessibilityManager.class;
}
