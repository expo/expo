 ...
 * being atomic, unless someone bypasses the `ABI40_0_0RCTAsyncLocalStorage` API.
 *
 * Keys and values must always be strings or an error is returned.
 */
@interface ABI40_0_0RCTAsyncLocalStorage : NSObject <ABI40_0_0RCTBridgeModule, ABI40_0_0RCTInvalidating>
...
// Clear the ABI40_0_0RCTAsyncLocalStorage data from native code
- (void)clearAllData;
...
- (void)multiGet:(NSArray<NSString *> *)keys callback:(ABI40_0_0RCTResponseSenderBlock)callback;

// Add multiple key value pairs to the cache.
- (void)multiSet:(NSArray<NSArray<NSString *> *> *)kvPairs callback:(ABI40_0_0RCTResponseSenderBlock)callback;
