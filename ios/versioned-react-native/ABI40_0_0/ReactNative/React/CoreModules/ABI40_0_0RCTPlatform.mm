...
@interface ABI40_0_0RCTPlatform () <ABI40_0_0NativePlatformConstantsIOSSpec>
@end

@implementation ABI40_0_0RCTPlatform

ABI40_0_0RCT_EXPORT_MODULE(PlatformConstants)
...
- (ModuleConstants<JS::NativePlatformConstantsIOS::Constants>)getConstants
{
  ...
  auto versions = ABI40_0_0RCTGetreactNativeVersion();
  return typedConstants<JS::NativePlatformConstantsIOS::Constants>({
      .forceTouchAvailable = ABI40_0_0RCTForceTouchAvailable() ? true : false,
      .osVersion = [device systemVersion],
      .systemName = [device systemName],
      .interfaceIdiom = interfaceIdiom([device userInterfaceIdiom]),
      .isTesting = ABI40_0_0RCTRunningInTestEnvironment() ? true : false,
...
Class ABI40_0_0RCTPlatformCls(void)
{
  return ABI40_0_0RCTPlatform.class;
}
