...
@protocol ABI40_0_0RCTPackagerClientMethod;

/**
 * An abstraction for a key-value store to manage ABI40_0_0RCTDevSettings behavior.
 * The default implementation persists settings using NSUserDefaults.
 */
@protocol ABI40_0_0RCTDevSettingsDataSource <NSObject>
...
@interface ABI40_0_0RCTDevSettings : ABI40_0_0RCTEventEmitter

- (instancetype)initWithDataSource:(id<ABI40_0_0RCTDevSettingsDataSource>)dataSource;
...
/*
 * Whether shaking will show ABI40_0_0RCTDevMenu. The menu is enabled by default if ABI40_0_0RCT_DEV=1, but
...
- (void)addHandler:(id<ABI40_0_0RCTPackagerClientMethod>)handler
    forPackagerMethod:(NSString *)name __deprecated_msg("Use ABI40_0_0RCTPackagerConnection directly instead");
#endif

@end

@interface ABI40_0_0RCTBridge (ABI40_0_0RCTDevSettings)

@property (nonatomic, readonly) ABI40_0_0RCTDevSettings *devSettings;
...
// (i.e. ABI40_0_0RCT_DEV or ABI40_0_0RCT_DEV_MENU is set)
ABI40_0_0RCT_EXTERN void ABI40_0_0RCTDevSettingsSetEnabled(BOOL enabled);
