...
#import "ABI40_0_0RCTDeviceInfo.h"

#import <ABI40_0_0FBReactNativeSpec/ABI40_0_0FBReactNativeSpec.h>
#import <ABI40_0_0React/ABI40_0_0RCTAccessibilityManager.h>
...
#import <ABI40_0_0React/ABI40_0_0RCTUIUtils.h>
...
@interface ABI40_0_0RCTDeviceInfo () <ABI40_0_0NativeDeviceInfoSpec>
@end

@implementation ABI40_0_0RCTDeviceInfo {
#if !TARGET_OS_TV
...
- (void)setBridge:(ABI40_0_0RCTBridge *)bridge
{
...
#if !TARGET_OS_TV
  _currentInterfaceOrientation = [ABI40_0_0RCTSharedApplication() statusBarOrientation];
  ...
  _currentInterfaceDimensions = ABI40_0_0RCTExportedDimensions(_bridge);
...
static BOOL ABI40_0_0RCTIsIPhoneX()
{
...
static NSDictionary *ABI40_0_0RCTExportedDimensions(ABI40_0_0RCTBridge *bridge)
{
  ABI40_0_0RCTAssertMainQueue();
  ABI40_0_0RCTDimensions dimensions = ABI40_0_0RCTGetDimensions(bridge.accessibilityManager.multiplier);
...
{
  return @{
    @"Dimensions" : ABI40_0_0RCTExportedDimensions(_bridge),
    // Note:
    // This prop is deprecated and will be removed in a future release.
    // Please use this only for a quick and temporary solution.
    // Use <SafeAreaView> instead.
    @"isIPhoneX_deprecated" : @(ABI40_0_0RCTIsIPhoneX()),
  };
}
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [bridge.eventDispatcher sendDeviceEventWithName:@"didUpdateDimensions" body:ABI40_0_0RCTExportedDimensions(bridge)];
...
{
  UIInterfaceOrientation nextOrientation = [ABI40_0_0RCTSharedApplication() statusBarOrientation];
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [_bridge.eventDispatcher sendDeviceEventWithName:@"didUpdateDimensions" body:ABI40_0_0RCTExportedDimensions(_bridge)];
#pragma clang diagnostic pop
  }
...
{
  NSDictionary *nextInterfaceDimensions = ABI40_0_0RCTExportedDimensions(_bridge);
...
Class ABI40_0_0RCTDeviceInfoCls(void)
{
  return ABI40_0_0RCTDeviceInfo.class;
}
