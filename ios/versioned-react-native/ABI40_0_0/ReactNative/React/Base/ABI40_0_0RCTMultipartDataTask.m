...
@interface ABI40_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>

@end

@implementation ABI40_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI40_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI40_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI40_0_0RCTMultipartStreamReader *reader = [[ABI40_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream
                                                                                  boundary:_boundary];
  ABI40_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
