...
typedef id<ABI40_0_0RCTBridgeModule> (^ABI40_0_0RCTBridgeModuleProvider)(void);

@interface ABI40_0_0RCTModuleData : NSObject <ABI40_0_0RCTInvalidating>
...
- (instancetype)initWithModuleClass:(Class)moduleClass
                     moduleProvider:(ABI40_0_0RCTBridgeModuleProvider)moduleProvider
                             bridge:(ABI40_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;

- (instancetype)initWithModuleInstance:(id<ABI40_0_0RCTBridgeModule>)instance
                                bridge:(ABI40_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI40_0_0RCTBridgeMethod>> *methods;

/**
 * Returns a map of the module methods. Note that this will gather the methods the first
 * time it is called and then memoize the results.
 */
@property (nonatomic, copy, readonly) NSDictionary<NSString *, id<ABI40_0_0RCTBridgeMethod>> *methodsByName;
 ...
 */
@property (nonatomic, strong, readwrite) id<ABI40_0_0RCTBridgeModule> instance;
