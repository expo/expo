...
extern NSString *const ABI40_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI40_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI40_0_0RCTBundleURLProvider : NSObject
