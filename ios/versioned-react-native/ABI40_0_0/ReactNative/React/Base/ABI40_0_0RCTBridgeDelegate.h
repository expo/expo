...
@protocol ABI40_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI40_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI40_0_0RCTBridgeModules automatically, however
 ...
 * previously called ABI40_0_0facebook::ABI40_0_0React::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI40_0_0RCTBridge *)bridge;
 ...
 */
- (BOOL)bridge:(ABI40_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI40_0_0RCTBridge *)bridge
                 onProgress:(ABI40_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI40_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Similar to loadSourceForBridge:onProgress:onComplete: but without progress
 * reporting.
 */
- (void)loadSourceForBridge:(ABI40_0_0RCTBridge *)bridge withBlock:(ABI40_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Retrieve the list of lazy-native-modules names for the given bridge.
 */
- (NSDictionary<NSString *, Class> *)extraLazyModuleClassesForBridge:(ABI40_0_0RCTBridge *)bridge;
