 ...
 * are also bridge modules, so should be registered using ABI40_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI40_0_0RCTURLRequestHandler <ABI40_0_0RCTBridgeModule>
...
/**
 * If more than one ABI40_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
