 ...
 */
@interface ABI40_0_0RCTImageSource : NSObject
...
@interface ABI40_0_0RCTConvert (ImageSource)

+ (ABI40_0_0RCTImageSource *)ABI40_0_0RCTImageSource:(id)json;
+ (NSArray<ABI40_0_0RCTImageSource *> *)ABI40_0_0RCTImageSourceArray:(id)json;
