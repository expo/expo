...
#import <ABI40_0_0cxxreact/ABI40_0_0JSBigString.h>
...
class ABI40_0_0RCTObjcExecutor : public JSExecutor {
 public:
  ABI40_0_0RCTObjcExecutor(
  ...
  {
    ABI40_0_0RCTAssert(NO, @"RAM bundles are not supported in ABI40_0_0RCTObjcExecutor");
  }
 ...
 private:
  ...
  ABI40_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI40_0_0RCTObjcExecutorFactory::ABI40_0_0RCTObjcExecutorFactory(id<ABI40_0_0RCTJavaScriptExecutor> jse, ABI40_0_0RCTJavaScriptCompleteBlock errorBlock)
    : m_jse(jse), m_errorBlock(errorBlock)
{
}

std::unique_ptr<JSExecutor> ABI40_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue)
{
  return std::unique_ptr<JSExecutor>(new ABI40_0_0RCTObjcExecutor(m_jse, m_errorBlock, jsQueue, delegate));
}
