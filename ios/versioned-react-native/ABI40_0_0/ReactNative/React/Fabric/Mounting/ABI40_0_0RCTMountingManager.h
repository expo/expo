...
#import <ABI40_0_0React/mounting/ShadowView.h>

NS_ASSUME_NONNULL_BEGIN

@class ABI40_0_0RCTComponentViewRegistry;

/**
 * Manages mounting process.
 */
@interface ABI40_0_0RCTMountingManager : NSObject

@property (nonatomic, weak) id<ABI40_0_0RCTMountingManagerDelegate> delegate;
@property (nonatomic, strong) ABI40_0_0RCTComponentViewRegistry *componentViewRegistry;

/**
 * Schedule a mounting transaction to be performed on the main thread.
 * Can be called from any thread.
 */
- (void)scheduleTransaction:(ABI40_0_0facebook::ABI40_0_0React::MountingCoordinator::Shared const &)mountingCoordinator;
...
- (void)synchronouslyUpdateViewOnUIThread:(ABI40_0_0ReactTag)ABI40_0_0ReactTag
                      ...
                      componentDescriptor:(const ABI40_0_0facebook::ABI40_0_0React::ComponentDescriptor &)componentDescriptor;
@end
