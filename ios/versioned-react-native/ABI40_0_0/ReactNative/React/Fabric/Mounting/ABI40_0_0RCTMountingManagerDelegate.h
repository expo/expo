 ...
 */
@protocol ABI40_0_0RCTMountingManagerDelegate <NSObject>
 ...
 */
- (void)mountingManager:(ABI40_0_0RCTMountingManager *)mountingManager willMountComponentsWithRootTag:(ABI40_0_0ReactTag)MountingManager;
