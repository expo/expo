...
static NSAttributedString *ABI40_0_0RCTSanitizeAttributedString(NSAttributedString *attributedString)
{
...
{
  toTextInput.attributedText = ABI40_0_0RCTSanitizeAttributedString(fromTextInput.attributedText);
...
UIKeyboardAppearance ABI40_0_0RCTUIKeyboardAppearanceFromKeyboardAppearance(KeyboardAppearance keyboardAppearance)
{
...
UIKeyboardType ABI40_0_0RCTUIKeyboardTypeFromKeyboardType(KeyboardType keyboardType)
{
  switch (keyboardType) {
    // Universal
...
UIReturnKeyType ABI40_0_0RCTUIReturnKeyTypeFromReturnKeyType(ReturnKeyType returnKeyType)
{
...
UITextContentType ABI40_0_0RCTUITextContentTypeFromString(std::string const &contentType)
{
  ...
  return ABI40_0_0RCTNSStringFromStringNilIfEmpty(contentType);
}

API_AVAILABLE(ios(12.0))
UITextInputPasswordRules *ABI40_0_0RCTUITextInputPasswordRulesFromString(std::string const &passwordRules)
{
  return [UITextInputPasswordRules passwordRulesWithDescriptor:ABI40_0_0RCTNSStringFromStringNilIfEmpty(passwordRules)];
}
