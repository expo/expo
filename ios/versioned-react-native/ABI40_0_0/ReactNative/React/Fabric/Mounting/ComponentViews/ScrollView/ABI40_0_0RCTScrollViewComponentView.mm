...
#import "ABI40_0_0RCTScrollViewComponentView.h"

#import <ABI40_0_0React/ABI40_0_0RCTAssert.h>
#import <ABI40_0_0React/ABI40_0_0RCTBridge+Private.h>
#import <ABI40_0_0React/ABI40_0_0RCTScrollEvent.h>

#import <ABI40_0_0React/components/scrollview/ABI40_0_0RCTComponentViewHelpers.h>
#import <ABI40_0_0React/components/scrollview/ScrollViewComponentDescriptor.h>
#import <ABI40_0_0React/components/scrollview/ScrollViewEventEmitter.h>
#import <ABI40_0_0React/components/scrollview/ScrollViewProps.h>
#import <ABI40_0_0React/components/scrollview/ScrollViewState.h>
...
static void ABI40_0_0RCTSendPaperScrollEvent_DEPRECATED(UIScrollView *scrollView, NSInteger tag)
{
  static uint16_t coalescingKey = 0;
  ABI40_0_0RCTScrollEvent *scrollEvent = [[ABI40_0_0RCTScrollEvent alloc] initWithEventName:@"onScroll"
                                                                 ABI40_0_0ReactTag:[NSNumber numberWithInt:tag]
  ...
  [[ABI40_0_0RCTBridge currentBridge].eventDispatcher sendEvent:scrollEvent];
}

@interface ABI40_0_0RCTScrollViewComponentView () <UIScrollViewDelegate, ABI40_0_0RCTScrollViewProtocol, ABI40_0_0RCTScrollableProtocol>

@end

@implementation ABI40_0_0RCTScrollViewComponentView {
...
+ (ABI40_0_0RCTScrollViewComponentView *_Nullable)findScrollViewComponentViewForView:(UIView *)view
{
  do {
    view = view.superview;
  } while (view != nil && ![view isKindOfClass:[ABI40_0_0RCTScrollViewComponentView class]]);
  return (ABI40_0_0RCTScrollViewComponentView *)view;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _scrollView = [[ABI40_0_0RCTEnhancedScrollView alloc] initWithFrame:self.bounds];
...
{
  return ((ABI40_0_0RCTEnhancedScrollView *)_scrollView).delegateSplitter;
}
...
#define REMAP_PROP(ABI40_0_0ReactName, localName, target)                      \
  if (oldScrollViewProps.ABI40_0_0ReactName != newScrollViewProps.ABI40_0_0ReactName) { \
    target.localName = newScrollViewProps.ABI40_0_0ReactName;                  \
  }

#define REMAP_VIEW_PROP(ABI40_0_0ReactName, localName) REMAP_PROP(ABI40_0_0ReactName, localName, self)
#define MAP_VIEW_PROP(name) REMAP_VIEW_PROP(name, name)
#define REMAP_SCROLL_VIEW_PROP(ABI40_0_0ReactName, localName) \
  REMAP_PROP(ABI40_0_0ReactName, localName, ((ABI40_0_0RCTEnhancedScrollView *)_scrollView))
#define MAP_SCROLL_VIEW_PROP(name) REMAP_SCROLL_VIEW_PROP(name, name)
  ...
  if (oldScrollViewProps.contentInset != newScrollViewProps.contentInset) {
    _scrollView.contentInset = ABI40_0_0RCTUIEdgeInsetsFromEdgeInsets(newScrollViewProps.contentInset);
  }
...
- (void)updateState:(State::Shared const &)state oldState:(State::Shared const &)oldState
{
  ...
  CGSize contentSize = ABI40_0_0RCTCGSizeFromSize(_state->getData().getContentSize());
...
{
  ABI40_0_0RCTAssert(childComponentView.superview == _containerView, @"Attempt to unmount improperly mounted component view.");
...
- (ScrollViewMetrics)_scrollViewMetrics
{
  ...
  metrics.contentSize = ABI40_0_0RCTSizeFromCGSize(_scrollView.contentSize);
  metrics.contentOffset = ABI40_0_0RCTPointFromCGPoint(_scrollView.contentOffset);
  metrics.contentInset = ABI40_0_0RCTEdgeInsetsFromUIEdgeInsets(_scrollView.contentInset);
  metrics.containerSize = ABI40_0_0RCTSizeFromCGSize(_scrollView.bounds.size);
...
- (void)_updateStateWithContentOffset
{
  ...
  auto contentOffset = ABI40_0_0RCTPointFromCGPoint(_scrollView.contentOffset);
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
  ...
  if ((_lastScrollEventDispatchTime == 0) || (now - _lastScrollEventDispatchTime > _scrollEventThrottle)) {
    ...
    ABI40_0_0RCTSendPaperScrollEvent_DEPRECATED(scrollView, self.tag);
  }
}
...
{
  ABI40_0_0RCTScrollViewHandleCommand(self, commandName, args);
}
...
#pragma mark - ABI40_0_0RCTScrollableProtocol
...
Class<ABI40_0_0RCTComponentViewProtocol> ABI40_0_0RCTScrollViewCls(void)
{
  return ABI40_0_0RCTScrollViewComponentView.class;
}
