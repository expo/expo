...
#import "ABI40_0_0RCTPullToRefreshViewComponentView.h"
...
#import <ABI40_0_0React/ABI40_0_0RCTRefreshableProtocol.h>
#import <ABI40_0_0React/ABI40_0_0RCTScrollViewComponentView.h>

#import "ABI40_0_0FBABI40_0_0RCTFabricComponentsPlugins.h"

using namespace ABI40_0_0facebook::ABI40_0_0React;

@interface ABI40_0_0RCTPullToRefreshViewComponentView () <ABI40_0_0RCTPullToRefreshViewViewProtocol, ABI40_0_0RCTRefreshableProtocol>
@end

@implementation ABI40_0_0RCTPullToRefreshViewComponentView {
  UIRefreshControl *_refreshControl;
  ABI40_0_0RCTScrollViewComponentView *_scrollViewComponentView;
}
...
- (void)_updateTitle
{
  ...
  if (concreteProps.titleColor) {
    attributes[NSForegroundColorAttributeName] = ABI40_0_0RCTUIColorFromSharedColor(concreteProps.titleColor);
  }

  _refreshControl.attributedTitle =
      [[NSAttributedString alloc] initWithString:ABI40_0_0RCTNSStringFromString(concreteProps.title) attributes:attributes];
}
...
- (void)_attach
{
  ...
  _scrollViewComponentView = [ABI40_0_0RCTScrollViewComponentView findScrollViewComponentViewForView:self];
  if (!_scrollViewComponentView) {
    return;
  }
...
{
  ABI40_0_0RCTPullToRefreshViewHandleCommand(self, commandName, args);
}
...
#pragma mark - ABI40_0_0RCTRefreshableProtocol
...
Class<ABI40_0_0RCTComponentViewProtocol> ABI40_0_0RCTPullToRefreshViewCls(void)
{
  return ABI40_0_0RCTPullToRefreshViewComponentView.class;
}
