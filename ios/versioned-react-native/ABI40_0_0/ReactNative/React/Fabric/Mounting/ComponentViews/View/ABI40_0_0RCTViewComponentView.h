...
#import <ABI40_0_0React/ABI40_0_0RCTTouchableComponentViewProtocol.h>
#import <ABI40_0_0React/ABI40_0_0UIView+ComponentViewProtocol.h>
 ...
 */
@interface ABI40_0_0RCTViewComponentView : UIView <ABI40_0_0RCTComponentViewProtocol, ABI40_0_0RCTTouchableComponentViewProtocol> {
 @protected
  ABI40_0_0facebook::ABI40_0_0React::LayoutMetrics _layoutMetrics;
  ABI40_0_0facebook::ABI40_0_0React::SharedViewProps _props;
  ABI40_0_0facebook::ABI40_0_0React::SharedViewEventEmitter _eventEmitter;
}
...
/**
 * Enforcing `call super` semantic for overridden methods from `ABI40_0_0RCTComponentViewProtocol`.
 * The methods update the instance variables.
 */
- (void)updateProps:(ABI40_0_0facebook::ABI40_0_0React::Props::Shared const &)props
           oldProps:(ABI40_0_0facebook::ABI40_0_0React::Props::Shared const &)oldProps NS_REQUIRES_SUPER;
- (void)updateEventEmitter:(ABI40_0_0facebook::ABI40_0_0React::EventEmitter::Shared const &)eventEmitter NS_REQUIRES_SUPER;
- (void)updateLayoutMetrics:(ABI40_0_0facebook::ABI40_0_0React::LayoutMetrics const &)layoutMetrics
           oldLayoutMetrics:(ABI40_0_0facebook::ABI40_0_0React::LayoutMetrics const &)oldLayoutMetrics NS_REQUIRES_SUPER;
