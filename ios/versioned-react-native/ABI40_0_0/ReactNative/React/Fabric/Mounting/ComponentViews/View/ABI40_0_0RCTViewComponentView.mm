...
#import <ABI40_0_0React/components/view/ViewComponentDescriptor.h>
#import <ABI40_0_0React/components/view/ViewEventEmitter.h>
#import <ABI40_0_0React/components/view/ViewProps.h>

#import "ABI40_0_0RCTConversions.h"

using namespace ABI40_0_0facebook::ABI40_0_0React;

@implementation ABI40_0_0RCTViewComponentView {
...
- (void)layoutSubviews
{
  ...
  // by ABI40_0_0React Native Renderer within `CATransaction`.
...
{
  ABI40_0_0RCTAssert(
      self == [ABI40_0_0RCTViewComponentView class],
      @"`+[ABI40_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented for all subclasses (and `%@` particularly).",
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  ABI40_0_0RCTAssert(
      propsRawPtr &&
          ([self class] == [ABI40_0_0RCTViewComponentView class] ||
           typeid(*propsRawPtr).hash_code() != typeid(ViewProps const).hash_code()),
      @"`ABI40_0_0RCTViewComponentView` subclasses (and `%@` particularly) must setup `_props`"
  ...
  if (oldViewProps.backgroundColor != newViewProps.backgroundColor) {
    self.backgroundColor = ABI40_0_0RCTUIColorFromSharedColor(newViewProps.backgroundColor);
    needsInvalidateLayer = YES;
  }

  // `foregroundColor`
  if (oldViewProps.foregroundColor != newViewProps.foregroundColor) {
    self.foregroundColor = ABI40_0_0RCTUIColorFromSharedColor(newViewProps.foregroundColor);
  }

  // `shadowColor`
  if (oldViewProps.shadowColor != newViewProps.shadowColor) {
    CGColorRef shadowColor = ABI40_0_0RCTCGColorRefFromSharedColor(newViewProps.shadowColor);
  ...
  if (oldViewProps.shadowOffset != newViewProps.shadowOffset) {
    self.layer.shadowOffset = ABI40_0_0RCTCGSizeFromSize(newViewProps.shadowOffset);
    needsInvalidateLayer = YES;
  }
  ...
  if (oldViewProps.transform != newViewProps.transform) {
    self.layer.transform = ABI40_0_0RCTCATransform3DFromTransformMatrix(newViewProps.transform);
    self.layer.allowsEdgeAntialiasing = newViewProps.transform != Transform::Identity();
  }

  // `hitSlop`
  if (oldViewProps.hitSlop != newViewProps.hitSlop) {
    self.hitTestEdgeInsets = ABI40_0_0RCTUIEdgeInsetsFromEdgeInsets(newViewProps.hitSlop);
  }
  ...
  if (oldViewProps.nativeId != newViewProps.nativeId) {
    self.nativeId = ABI40_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.nativeId);
  }
  ...
  if (oldViewProps.accessibilityLabel != newViewProps.accessibilityLabel) {
    self.accessibilityElement.accessibilityLabel = ABI40_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityLabel);
  }

  // `accessibilityHint`
  if (oldViewProps.accessibilityHint != newViewProps.accessibilityHint) {
    self.accessibilityElement.accessibilityHint = ABI40_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityHint);
  }
  ...
  if (oldViewProps.accessibilityTraits != newViewProps.accessibilityTraits) {
    self.accessibilityElement.accessibilityTraits =
        ABI40_0_0RCTUIAccessibilityTraitsFromAccessibilityTraits(newViewProps.accessibilityTraits);
  }
           ...
           oldLayoutMetrics:(LayoutMetrics const &)oldLayoutMetrics
{
  ...
  if (_contentView) {
    _contentView.frame = ABI40_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
  }
}
...
static ABI40_0_0RCTCornerRadii ABI40_0_0RCTCornerRadiiFromBorderRadii(BorderRadii borderRadii)
{
  return ABI40_0_0RCTCornerRadii{.topLeft = (CGFloat)borderRadii.topLeft,
...
static ABI40_0_0RCTBorderColors ABI40_0_0RCTBorderColorsFromBorderColors(BorderColors borderColors)
{
  return ABI40_0_0RCTBorderColors{.left = ABI40_0_0RCTCGColorRefUnretainedFromSharedColor(borderColors.left),
                         .top = ABI40_0_0RCTCGColorRefUnretainedFromSharedColor(borderColors.top),
                         .bottom = ABI40_0_0RCTCGColorRefUnretainedFromSharedColor(borderColors.bottom),
                         .right = ABI40_0_0RCTCGColorRefUnretainedFromSharedColor(borderColors.right)};
}

static ABI40_0_0RCTBorderStyle ABI40_0_0RCTBorderStyleFromBorderStyle(BorderStyle borderStyle)
{
  switch (borderStyle) {
    case BorderStyle::Solid:
      return ABI40_0_0RCTBorderStyleSolid;
    case BorderStyle::Dotted:
      return ABI40_0_0RCTBorderStyleDotted;
    case BorderStyle::Dashed:
      return ABI40_0_0RCTBorderStyleDashed;
  }
}
...
- (void)invalidateLayer
{
  ...
  if (layerHasShadow) {
    if (CGColorGetAlpha(_backgroundColor.CGColor) > 0.999) {
      ...
      ABI40_0_0RCTCornerInsets const cornerInsets =
          ABI40_0_0RCTGetCornerInsets(ABI40_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero);
      CGPathRef shadowPath = ABI40_0_0RCTPathCreateWithRoundedRect(self.bounds, cornerInsets, nil);
  ...
  if (useCoreAnimationBorderRendering) {
    ...
    CGColorRef borderColor = ABI40_0_0RCTCGColorRefFromSharedColor(borderMetrics.borderColors.left);
    ...
    UIImage *image = ABI40_0_0RCTGetBorderImage(
        ABI40_0_0RCTBorderStyleFromBorderStyle(borderMetrics.borderStyles.left),
        layer.bounds.size,
        ABI40_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii),
        ABI40_0_0RCTUIEdgeInsetsFromEdgeInsets(borderMetrics.borderWidths),
        ABI40_0_0RCTBorderColorsFromBorderColors(borderMetrics.borderColors),
    ...
    if (self.clipsToBounds) {
      if (borderMetrics.borderRadii.isUniform()) {
        ...
        CGPathRef path = ABI40_0_0RCTPathCreateWithRoundedRect(
            self.bounds,
            ABI40_0_0RCTGetCornerInsets(ABI40_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero),
            nil);
...
- (NSArray<UIAccessibilityCustomAction *> *)accessibilityCustomActions
{
  ...
  for (auto const &accessibilityAction : accessibilityActions) {
    [customActions
        addObject:[[UIAccessibilityCustomAction alloc] initWithName:ABI40_0_0RCTNSStringFromString(accessibilityAction)
                                                             target:self
...
- (BOOL)didActivateAccessibilityCustomAction:(UIAccessibilityCustomAction *)action
{
  if (_eventEmitter && _props->onAccessibilityAction) {
    _eventEmitter->onAccessibilityAction(ABI40_0_0RCTStringFromNSString(action.name));
    return YES;
  } else {
    return NO;
  }
...
{
  return ABI40_0_0RCTNSStringFromString([[self class] componentDescriptorProvider].name);
}
