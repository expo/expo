...
#import "ABI40_0_0RCTSliderComponentView.h"
...
#import <ABI40_0_0React/components/slider/SliderComponentDescriptor.h>

#import "ABI40_0_0FBABI40_0_0RCTFabricComponentsPlugins.h"

using namespace ABI40_0_0facebook::ABI40_0_0React;

@interface ABI40_0_0RCTSliderComponentView () <ABI40_0_0RCTImageResponseDelegate>
@end

@implementation ABI40_0_0RCTSliderComponentView {
  ...
  ABI40_0_0RCTImageResponseObserverProxy _trackImageResponseObserverProxy;
  ABI40_0_0RCTImageResponseObserverProxy _minimumTrackImageResponseObserverProxy;
  ABI40_0_0RCTImageResponseObserverProxy _maximumTrackImageResponseObserverProxy;
  ABI40_0_0RCTImageResponseObserverProxy _thumbImageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _trackImageResponseObserverProxy = ABI40_0_0RCTImageResponseObserverProxy(self);
    _minimumTrackImageResponseObserverProxy = ABI40_0_0RCTImageResponseObserverProxy(self);
    _maximumTrackImageResponseObserverProxy = ABI40_0_0RCTImageResponseObserverProxy(self);
    _thumbImageResponseObserverProxy = ABI40_0_0RCTImageResponseObserverProxy(self);
...
Class<ABI40_0_0RCTComponentViewProtocol> ABI40_0_0RCTSliderCls(void)
{
  return ABI40_0_0RCTSliderComponentView.class;
}
