...
#import <ABI40_0_0React/ABI40_0_0RCTImageResponseDelegate.h>
#import <ABI40_0_0React/ABI40_0_0RCTImageResponseObserverProxy.h>
#import <ABI40_0_0React/components/image/ImageComponentDescriptor.h>
#import <ABI40_0_0React/components/image/ImageEventEmitter.h>
#import <ABI40_0_0React/components/image/ImageProps.h>
#import <ABI40_0_0React/imagemanager/ImageInstrumentation.h>
#import <ABI40_0_0React/imagemanager/ImageRequest.h>
#import <ABI40_0_0React/imagemanager/ABI40_0_0RCTImageInstrumentationProxy.h>
#import <ABI40_0_0React/imagemanager/ABI40_0_0RCTImagePrimitivesConversions.h>
...
@interface ABI40_0_0RCTImageComponentView () <ABI40_0_0RCTImageResponseDelegate>
@end

@implementation ABI40_0_0RCTImageComponentView {
  UIImageView *_imageView;
  ImageShadowNode::ConcreteState::Shared _state;
  ImageResponseObserverCoordinator const *_coordinator;
  ABI40_0_0RCTImageResponseObserverProxy _imageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _imageView.contentMode = (UIViewContentMode)ABI40_0_0RCTResizeModeFromImageResizeMode(defaultProps->resizeMode);

    _imageResponseObserverProxy = ABI40_0_0RCTImageResponseObserverProxy(self);
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldImageProps.resizeMode != newImageProps.resizeMode) {
    if (newImageProps.resizeMode == ImageResizeMode::Repeat) {
      ...
      _imageView.contentMode = (UIViewContentMode)ABI40_0_0RCTResizeModeFromImageResizeMode(newImageProps.resizeMode);
    }
  }
...
- (void)updateState:(State::Shared const &)state oldState:(State::Shared const &)oldState
{
  ...
  if (!havePreviousData || data.getImageSource() != _oldState->getData().getImageSource()) {
    ...
    auto instrumentation = std::static_pointer_cast<ABI40_0_0RCTImageInstrumentationProxy const>(
...
#pragma mark - ABI40_0_0RCTImageResponseDelegate
...
- (void)didReceiveImage:(UIImage *)image fromObserver:(void const *)observer
{
  ...
  if (imageProps.resizeMode == ImageResizeMode::Repeat) {
    image = [image resizableImageWithCapInsets:ABI40_0_0RCTUIEdgeInsetsFromEdgeInsets(imageProps.capInsets)
...
Class<ABI40_0_0RCTComponentViewProtocol> ABI40_0_0RCTImageCls(void)
{
  return ABI40_0_0RCTImageComponentView.class;
}
