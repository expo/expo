...
#import "ABI40_0_0RCTModalHostViewComponentView.h"

#import <ABI40_0_0React/ABI40_0_0UIView+React.h>
#import <ABI40_0_0React/components/modal/ModalHostViewComponentDescriptor.h>
#import <ABI40_0_0React/components/modal/ModalHostViewState.h>
#import <ABI40_0_0React/components/rncore/EventEmitters.h>
#import <ABI40_0_0React/components/rncore/Props.h>

#import "ABI40_0_0FBABI40_0_0RCTFabricComponentsPlugins.h"
#import "ABI40_0_0RCTConversions.h"
#import "ABI40_0_0RCTFabricModalHostViewController.h"
...
@interface ABI40_0_0RCTModalHostViewComponentView () <ABI40_0_0RCTFabricModalHostViewControllerDelegate>

@end

@implementation ABI40_0_0RCTModalHostViewComponentView {
  ABI40_0_0RCTFabricModalHostViewController *_viewController;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _viewController = [ABI40_0_0RCTFabricModalHostViewController new];
...
- (void)ensurePresentedOnlyIfNeeded
{
  ...
  if (shouldBePresented) {
    UIViewController *controller = [self ABI40_0_0ReactViewController];
    _isPresented = YES;
    return [controller
...
#pragma mark - ABI40_0_0RCTFabricModalHostViewControllerDelegate
...
- (void)boundsDidChange:(CGRect)newBounds
{
  ...
  if (_state != nullptr) {
    auto newState = ModalHostViewState{ABI40_0_0RCTSizeFromCGSize(newBounds.size)};
...
Class<ABI40_0_0RCTComponentViewProtocol> ABI40_0_0RCTModalHostViewCls(void)
{
  return ABI40_0_0RCTModalHostViewComponentView.class;
}
