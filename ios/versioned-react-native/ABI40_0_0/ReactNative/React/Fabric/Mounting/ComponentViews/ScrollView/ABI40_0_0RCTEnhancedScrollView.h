 ...
 * which are not directly related to ABI40_0_0React Native.
 */
@interface ABI40_0_0RCTEnhancedScrollView : UIScrollView
 ...
 */
@property (nonatomic, strong, readonly) ABI40_0_0RCTGenericDelegateSplitter<id<UIScrollViewDelegate>> *delegateSplitter;
