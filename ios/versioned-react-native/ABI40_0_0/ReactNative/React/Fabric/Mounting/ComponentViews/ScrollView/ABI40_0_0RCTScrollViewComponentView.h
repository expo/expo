...
#import <ABI40_0_0React/ABI40_0_0RCTGenericDelegateSplitter.h>
 ...
 */
@interface ABI40_0_0RCTScrollViewComponentView : ABI40_0_0RCTViewComponentView

/*
 * Finds and returns the closet ABI40_0_0RCTScrollViewComponentView component to the given view
 */
+ (ABI40_0_0RCTScrollViewComponentView *_Nullable)findScrollViewComponentViewForView:(UIView *)view;
...
@property (nonatomic, strong, readonly)
    ABI40_0_0RCTGenericDelegateSplitter<id<UIScrollViewDelegate>> *scrollViewDelegateSplitter;

@end

/*
 * ABI40_0_0RCTScrollableProtocol is a protocol which ABI40_0_0RCTScrollViewManager uses to communicate with all kinds of `UIScrollView`s.
 ...
 */
@interface ABI40_0_0RCTScrollViewComponentView (ScrollableProtocol) <ABI40_0_0RCTScrollableProtocol>
