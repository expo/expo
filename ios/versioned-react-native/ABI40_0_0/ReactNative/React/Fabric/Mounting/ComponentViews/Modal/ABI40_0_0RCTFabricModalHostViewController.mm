...
#import <ABI40_0_0React/ABI40_0_0RCTSurfaceTouchHandler.h>

@implementation ABI40_0_0RCTFabricModalHostViewController {
  CGRect _lastViewBounds;
  ABI40_0_0RCTSurfaceTouchHandler *_touchHandler;
}
...
- (instancetype)init
{
  ...
  _touchHandler = [ABI40_0_0RCTSurfaceTouchHandler new];
...
{
  return [ABI40_0_0RCTSharedApplication() statusBarStyle];
}
...
{
  return [ABI40_0_0RCTSharedApplication() isStatusBarHidden];
}
...
- (UIInterfaceOrientationMask)supportedInterfaceOrientations
{
  UIInterfaceOrientationMask appSupportedOrientationsMask =
      [ABI40_0_0RCTSharedApplication() supportedInterfaceOrientationsForWindow:[ABI40_0_0RCTSharedApplication() keyWindow]];
