...
#import "ABI40_0_0UIView+ComponentViewProtocol.h"
...
{
  ABI40_0_0RCTAssert(NO, @"`-[ABI40_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented in a concrete class.");
  return {};
}
...
{
  ABI40_0_0RCTAssert(childComponentView.superview == self, @"Attempt to unmount improperly mounted component view.");
           ...
           oldLayoutMetrics:(LayoutMetrics const &)oldLayoutMetrics
{
  ...
  if (forceUpdate || (layoutMetrics.frame != oldLayoutMetrics.frame)) {
    CGRect frame = ABI40_0_0RCTCGRectFromRect(layoutMetrics.frame);
...
{
  ABI40_0_0RCTAssert(NO, @"props access should be implemented by ABI40_0_0RCTViewComponentView.");
  return nullptr;
}
