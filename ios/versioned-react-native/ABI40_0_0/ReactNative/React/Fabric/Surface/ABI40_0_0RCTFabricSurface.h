...
@class ABI40_0_0RCTSurfaceView;
@class ABI40_0_0RCTSurfacePresenter;
@protocol ABI40_0_0RCTSurfaceDelegate;

/**
 * (This is Fabric-compatible ABI40_0_0RCTSurface implementation.)
 *
 * ABI40_0_0RCTSurface instance represents ABI40_0_0React Native-powered piece of a user interface
 * which can be a full-screen app, separate modal view controller,
 * or even small widget.
 * It is called "Surface".
 *
 * The ABI40_0_0RCTSurface instance is completely thread-safe by design;
 ...
 *
 * The primary goals of the ABI40_0_0RCTSurface are:
 ...
 */
@interface ABI40_0_0RCTFabricSurface : NSObject

@property (atomic, readonly) ABI40_0_0RCTSurfaceStage stage;
@property (atomic, readonly) NSString *moduleName;
@property (atomic, readonly) ABI40_0_0ReactTag rootTag;

@property (atomic, readwrite, weak, nullable) id<ABI40_0_0RCTSurfaceDelegate> delegate;

@property (atomic, copy, readwrite) NSDictionary *properties;

- (instancetype)initWithSurfacePresenter:(ABI40_0_0RCTSurfacePresenter *)surfacePresenter
 ...
 * ABI40_0_0RCTSurface does not control (or influence in any way) the size or origin
 ...
 * The starting process includes initializing all underlying ABI40_0_0React Native
 * infrastructure and running ABI40_0_0React app.
...
/**
 * Simple shortcut to `-[ABI40_0_0RCTSurface setMinimumSize:size maximumSize:size]`.
 */
...
@interface ABI40_0_0RCTFabricSurface (Internal)

/**
 * Sets and clears given stage flags (bitmask).
 * Returns `YES` if the actual state was changed.
 */
- (BOOL)_setStage:(ABI40_0_0RCTSurfaceStage)stage;
- (BOOL)_unsetStage:(ABI40_0_0RCTSurfaceStage)stage;

@end

@interface ABI40_0_0RCTFabricSurface (Deprecated)
