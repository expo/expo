...
#import "ABI40_0_0RCTScheduler.h"

#import <ABI40_0_0React/debug/SystraceSection.h>
#import <ABI40_0_0React/uimanager/ComponentDescriptorFactory.h>
#import <ABI40_0_0React/uimanager/Scheduler.h>
#import <ABI40_0_0React/uimanager/SchedulerDelegate.h>
...
class SchedulerDelegateProxy : public SchedulerDelegate {
 public:
  ...
  {
    ABI40_0_0RCTScheduler *scheduler = (__bridge ABI40_0_0RCTScheduler *)scheduler_;
...
@implementation ABI40_0_0RCTScheduler {
...
{
  SystraceSection s("-[ABI40_0_0RCTScheduler startSurfaceWithSurfaceId:...]");

  auto props = convertIdToFollyDynamic(initialProps);
  _scheduler->startSurface(surfaceId, ABI40_0_0RCTStringFromNSString(moduleName), props, layoutConstraints, layoutContext);
...
{
  SystraceSection s("-[ABI40_0_0RCTScheduler stopSurfaceWithSurfaceId:]");
...
{
  SystraceSection s("-[ABI40_0_0RCTScheduler measureSurfaceWithLayoutConstraints:]");
  return ABI40_0_0RCTCGSizeFromSize(_scheduler->measureSurface(surfaceId, layoutConstraints, layoutContext));
}
...
- (void)constraintSurfaceLayoutWithLayoutConstraints:(LayoutConstraints)layoutConstraints
                                       layoutContext:(LayoutContext)layoutContext
                                           surfaceId:(SurfaceId)surfaceId
{
  SystraceSection s("-[ABI40_0_0RCTScheduler constraintSurfaceLayoutWithLayoutConstraints:]");
