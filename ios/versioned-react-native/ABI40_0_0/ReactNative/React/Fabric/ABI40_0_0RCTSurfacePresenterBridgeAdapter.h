 ...
 */
@interface ABI40_0_0RCTSurfacePresenterBridgeAdapter : NSObject

- (instancetype)initWithBridge:(ABI40_0_0RCTBridge *)bridge
              contextContainer:(ABI40_0_0facebook::ABI40_0_0React::ContextContainer::Shared)contextContainer;

/*
 * Returns a stored instance of Surface Presenter which is managed by a bridge.
 */
@property (nonatomic, readonly) ABI40_0_0RCTSurfacePresenter *surfacePresenter;
