...
#import "ABI40_0_0RCTSurfaceRegistry.h"
...
@implementation ABI40_0_0RCTSurfaceRegistry {
  better::shared_mutex _mutex;
  NSMapTable<id, ABI40_0_0RCTFabricSurface *> *_registry;
}
...
- (void)enumerateWithBlock:(ABI40_0_0RCTSurfaceEnumeratorBlock)block
{
...
- (void)registerSurface:(ABI40_0_0RCTFabricSurface *)surface
{
  ...
  ABI40_0_0ReactTag rootTag = surface.rootViewTag.integerValue;
