...
#import "ABI40_0_0RCTUIUtils.h"

#import "ABI40_0_0RCTUtils.h"

ABI40_0_0RCTDimensions ABI40_0_0RCTGetDimensions(CGFloat fontScale)
{
  UIScreen *mainScreen = UIScreen.mainScreen;
  CGSize screenSize = mainScreen.bounds.size;

  UIView *mainWindow;
  mainWindow = ABI40_0_0RCTKeyWindow();
  CGSize windowSize = mainWindow.bounds.size;

  ABI40_0_0RCTDimensions result;
...
CGFloat ABI40_0_0RCTGetMultiplierForContentSizeCategory(UIContentSizeCategory category)
{
