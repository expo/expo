...
#import <ABI40_0_0cxxreact/ABI40_0_0JsArgumentHelpers.h>
...
@implementation ABI40_0_0RCTCxxMethod {
...
- (ABI40_0_0RCTFunctionType)functionType
{
  std::string type(_method->getType());
  if (type == "sync") {
    return ABI40_0_0RCTFunctionTypeSync;
  } else if (type == "async") {
    return ABI40_0_0RCTFunctionTypeNormal;
  } else {
    return ABI40_0_0RCTFunctionTypePromise;
  }
}
...
- (id)invokeWithBridge:(ABI40_0_0RCTBridge *)bridge module:(id)module arguments:(NSArray *)arguments
{
  ...
  if (arguments.count < _method->callbacks) {
    ABI40_0_0RCTLogError(
        ...
        ABI40_0_0RCTBridgeModuleNameForClass([module class]),
        _method->name.c_str(),
        _method->callbacks,
        arguments.count);
    return nil;
