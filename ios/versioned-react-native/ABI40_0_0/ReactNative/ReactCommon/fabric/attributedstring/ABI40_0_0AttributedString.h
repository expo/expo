...
/*
 * Simple, cross-platfrom, ABI40_0_0React-specific implementation of attributed string
 * (aka spanned string).
...
namespace std {
template <>
struct hash<ABI40_0_0facebook::ABI40_0_0React::AttributedString::Fragment> {
  size_t operator()(
      const ABI40_0_0facebook::ABI40_0_0React::AttributedString::Fragment &fragment) const {
...
template <>
struct hash<ABI40_0_0facebook::ABI40_0_0React::AttributedString> {
  size_t operator()(
      const ABI40_0_0facebook::ABI40_0_0React::AttributedString &attributedString) const {
    auto seed = size_t{0};
