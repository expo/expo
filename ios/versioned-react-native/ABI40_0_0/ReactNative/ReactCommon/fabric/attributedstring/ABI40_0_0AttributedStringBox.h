...
template <>
struct std::hash<ABI40_0_0facebook::ABI40_0_0React::AttributedStringBox> {
  size_t operator()(
      ABI40_0_0facebook::ABI40_0_0React::AttributedStringBox const &attributedStringBox) const {
    switch (attributedStringBox.getMode()) {
      case ABI40_0_0facebook::ABI40_0_0React::AttributedStringBox::Mode::Value:
        return std::hash<ABI40_0_0facebook::ABI40_0_0React::AttributedString>()(
