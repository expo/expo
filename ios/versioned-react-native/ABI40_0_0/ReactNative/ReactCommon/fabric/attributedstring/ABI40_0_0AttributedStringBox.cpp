...
#include "ABI40_0_0AttributedStringBox.h"
...
bool operator==(
  ...
  switch (lhs.getMode()) {
    case ABI40_0_0facebook::ABI40_0_0React::AttributedStringBox::Mode::Value:
      return lhs.getValue() == rhs.getValue();
    case ABI40_0_0facebook::ABI40_0_0React::AttributedStringBox::Mode::OpaquePointer:
