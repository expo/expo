...
#include <ABI40_0_0React/core/LayoutableShadowNode.h>
...
inline folly::dynamic toDynamic(const AttributedString &attributedString) {
  ...
  for (auto fragment : attributedString.getFragments()) {
    ...
    if (fragment.parentShadowView.componentHandle) {
      dynamicFragment["ABI40_0_0ReactTag"] = fragment.parentShadowView.tag;
    }
  ...
  value(
      "hash", std::hash<ABI40_0_0facebook::ABI40_0_0React::AttributedString>{}(attributedString));
