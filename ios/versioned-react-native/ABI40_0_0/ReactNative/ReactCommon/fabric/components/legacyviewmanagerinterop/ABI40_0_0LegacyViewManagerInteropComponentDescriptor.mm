...
#include "ABI40_0_0LegacyViewManagerInteropComponentDescriptor.h"
#include <ABI40_0_0React/ABI40_0_0RCTBridge.h>
...
static std::string moduleNameFromComponentName(const std::string &componentName)
{
  ...
  return "ABI40_0_0RCT" + componentName + "Manager";
}

inline NSString *ABI40_0_0RCTNSStringFromString(const std::string &string)
{
    ...
    ComponentDescriptor::Flavor const &flavor)
{
  ...
  Class module = NSClassFromString(ABI40_0_0RCTNSStringFromString(moduleName));
  assert(module);
  ABI40_0_0RCTBridge *bridge = (ABI40_0_0RCTBridge *)unwrapManagedObjectWeakly(contextContainer->at<std::shared_ptr<void>>("Bridge"));
  ABI40_0_0RCTComponentData *componentData = [[ABI40_0_0RCTComponentData alloc] initWithManagerClass:module bridge:bridge];
  return wrapManagedObject([[ABI40_0_0RCTLegacyViewManagerInteropCoordinator alloc] initWithComponentData:componentData
                                                                                          bridge:bridge]);
}
