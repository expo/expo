...
#include "ABI40_0_0ViewShadowNode.h"
#include <ABI40_0_0React/components/view/primitives.h>
...
void ViewShadowNode::initialize() noexcept {
  ...
  bool formsStackingContext = !viewProps.collapsable ||
      ...
      viewProps.yogaStyle.positionType() == ABI40_0_0YGPositionTypeAbsolute ||
      isColorMeaningful(viewProps.shadowColor);

  bool formsView = isColorMeaningful(viewProps.backgroundColor) ||
      isColorMeaningful(viewProps.foregroundColor) ||
      !(viewProps.yogaStyle.border() == ABI40_0_0YGStyle::Edges{});
