...
#include "ABI40_0_0YogaLayoutableShadowNode.h"
...
#include <ABI40_0_0React/debug/DebugStringConvertibleItem.h>
#include <ABI40_0_0React/debug/SystraceSection.h>
#include <ABI40_0_0yoga/ABI40_0_0Yoga.h>
#include <iostream>
...
static void applyLayoutConstraints(
  ...
  yogaStyle.minDimensions()[ABI40_0_0YGDimensionWidth] =
      yogaStyleValueFromFloat(layoutConstraints.minimumSize.width);
  yogaStyle.minDimensions()[ABI40_0_0YGDimensionHeight] =
      yogaStyleValueFromFloat(layoutConstraints.minimumSize.height);

  yogaStyle.maxDimensions()[ABI40_0_0YGDimensionWidth] =
      yogaStyleValueFromFloat(layoutConstraints.maximumSize.width);
  yogaStyle.maxDimensions()[ABI40_0_0YGDimensionHeight] =
...
void YogaLayoutableShadowNode::updateYogaChildren() {
  ...
  auto oldChildren = isClean ? yogaNode_.getChildren() : ABI40_0_0YGVector{};
...
void YogaLayoutableShadowNode::setSize(Size size) const {
  ...
  style.dimensions()[ABI40_0_0YGDimensionWidth] = yogaStyleValueFromFloat(size.width);
  style.dimensions()[ABI40_0_0YGDimensionHeight] = yogaStyleValueFromFloat(size.height);
...
void YogaLayoutableShadowNode::setPadding(RectangleEdges<Float> padding) const {
  ...
  auto style = yogaNode_.getStyle();
  style.padding()[ABI40_0_0YGEdgeTop] = yogaStyleValueFromFloat(padding.top);
  style.padding()[ABI40_0_0YGEdgeLeft] = yogaStyleValueFromFloat(padding.left);
  style.padding()[ABI40_0_0YGEdgeRight] = yogaStyleValueFromFloat(padding.right);
  style.padding()[ABI40_0_0YGEdgeBottom] = yogaStyleValueFromFloat(padding.bottom);
  yogaNode_.setStyle(style);
  yogaNode_.setDirty(true);
}
...
void YogaLayoutableShadowNode::layoutTree(
  ...
  {
    SystraceSection s("YogaLayoutableShadowNode::ABI40_0_0YGNodeCalculateLayout");

    ABI40_0_0YGNodeCalculateLayout(
        &yogaNode_, ABI40_0_0YGUndefined, ABI40_0_0YGUndefined, ABI40_0_0YGDirectionInherit);
  }
...
ABI40_0_0YGNode *YogaLayoutableShadowNode::yogaNodeCloneCallbackConnector(
    ABI40_0_0YGNode *oldYogaNode,
    ABI40_0_0YGNode *parentYogaNode,
    int childIndex) {
...
ABI40_0_0YGSize YogaLayoutableShadowNode::yogaNodeMeasureCallbackConnector(
    ABI40_0_0YGNode *yogaNode,
    float width,
  ...
  return ABI40_0_0YGSize{yogaFloatFromFloat(size.width),
                yogaFloatFromFloat(size.height)};
}

ABI40_0_0YGConfig &YogaLayoutableShadowNode::initializeYogaConfig(ABI40_0_0YGConfig &config) {
...
void YogaLayoutableShadowNode::swapLeftAndRightInYogaStyleProps(
  ...
  ABI40_0_0YGStyle::Edges const &position = yogaStyle.position();
  ABI40_0_0YGStyle::Edges const &padding = yogaStyle.padding();
  ABI40_0_0YGStyle::Edges const &margin = yogaStyle.margin();

  // Swap Yoga node values, position, padding and margin.

  if (yogaStyle.position()[ABI40_0_0YGEdgeLeft] != ABI40_0_0YGValueUndefined) {
    yogaStyle.position()[ABI40_0_0YGEdgeStart] = position[ABI40_0_0YGEdgeLeft];
    yogaStyle.position()[ABI40_0_0YGEdgeLeft] = ABI40_0_0YGValueUndefined;
  }

  if (yogaStyle.position()[ABI40_0_0YGEdgeRight] != ABI40_0_0YGValueUndefined) {
    yogaStyle.position()[ABI40_0_0YGEdgeEnd] = position[ABI40_0_0YGEdgeRight];
    yogaStyle.position()[ABI40_0_0YGEdgeRight] = ABI40_0_0YGValueUndefined;
  }

  if (yogaStyle.padding()[ABI40_0_0YGEdgeLeft] != ABI40_0_0YGValueUndefined) {
    yogaStyle.padding()[ABI40_0_0YGEdgeStart] = padding[ABI40_0_0YGEdgeLeft];
    yogaStyle.padding()[ABI40_0_0YGEdgeLeft] = ABI40_0_0YGValueUndefined;
  }

  if (yogaStyle.padding()[ABI40_0_0YGEdgeRight] != ABI40_0_0YGValueUndefined) {
    yogaStyle.padding()[ABI40_0_0YGEdgeEnd] = padding[ABI40_0_0YGEdgeRight];
    yogaStyle.padding()[ABI40_0_0YGEdgeRight] = ABI40_0_0YGValueUndefined;
  }

  if (yogaStyle.margin()[ABI40_0_0YGEdgeLeft] != ABI40_0_0YGValueUndefined) {
    yogaStyle.margin()[ABI40_0_0YGEdgeStart] = margin[ABI40_0_0YGEdgeLeft];
    yogaStyle.margin()[ABI40_0_0YGEdgeLeft] = ABI40_0_0YGValueUndefined;
  }

  if (yogaStyle.margin()[ABI40_0_0YGEdgeRight] != ABI40_0_0YGValueUndefined) {
    yogaStyle.margin()[ABI40_0_0YGEdgeEnd] = margin[ABI40_0_0YGEdgeRight];
    yogaStyle.margin()[ABI40_0_0YGEdgeLeft] = ABI40_0_0YGValueUndefined;
  }
...
void YogaLayoutableShadowNode::swapLeftAndRightInViewProps(
  ...
  ABI40_0_0YGStyle::Edges const &border = props.yogaStyle.border();

  if (props.yogaStyle.border()[ABI40_0_0YGEdgeLeft] != ABI40_0_0YGValueUndefined) {
    props.yogaStyle.border()[ABI40_0_0YGEdgeStart] = border[ABI40_0_0YGEdgeLeft];
    props.yogaStyle.border()[ABI40_0_0YGEdgeLeft] = ABI40_0_0YGValueUndefined;
  }

  if (props.yogaStyle.border()[ABI40_0_0YGEdgeRight] != ABI40_0_0YGValueUndefined) {
    props.yogaStyle.border()[ABI40_0_0YGEdgeEnd] = border[ABI40_0_0YGEdgeRight];
    props.yogaStyle.border()[ABI40_0_0YGEdgeRight] = ABI40_0_0YGValueUndefined;
  }
}
