...
#pragma mark - Mutating Methods
   ...
   */
  void setPositionType(ABI40_0_0YGPositionType positionType) const;
...
#pragma mark - LayoutableShadowNode
 ...
 protected:
   ...
   * all the time.
   */
  mutable ABI40_0_0YGNode yogaNode_;
 ...
 private:
  ...
  static ABI40_0_0YGConfig &initializeYogaConfig(ABI40_0_0YGConfig &config);
  static ABI40_0_0YGNode *yogaNodeCloneCallbackConnector(
      ABI40_0_0YGNode *oldYogaNode,
      ABI40_0_0YGNode *parentYogaNode,
      int childIndex);
  static ABI40_0_0YGSize yogaNodeMeasureCallbackConnector(
