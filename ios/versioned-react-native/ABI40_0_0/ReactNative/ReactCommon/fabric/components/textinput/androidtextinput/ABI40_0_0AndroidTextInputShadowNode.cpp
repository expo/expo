...
#include "ABI40_0_0AndroidTextInputShadowNode.h"
...
#include <ABI40_0_0React/components/text/BaseTextShadowNode.h>
#include <ABI40_0_0React/core/LayoutConstraints.h>
#include <ABI40_0_0React/core/LayoutContext.h>
#include <ABI40_0_0React/core/conversions.h>
#include <ABI40_0_0React/jni/ReadableNativeMap.h>

using namespace ABI40_0_0facebook::jni;
...
AttributedString AndroidTextInputShadowNode::getMostRecentAttributedString()
  ...
  auto ABI40_0_0ReactTreeAttributedString = getAttributedString();
  ...
  bool treeAttributedStringChanged =
      !state.ABI40_0_0ReactTreeAttributedString.compareTextAttributesWithoutFrame(
          ABI40_0_0ReactTreeAttributedString);
...
void AndroidTextInputShadowNode::updateStateIfNeeded() {
  ...
  if (state.ABI40_0_0ReactTreeAttributedString == ABI40_0_0ReactTreeAttributedString &&
  ...
  auto newEventCount =
      (state.ABI40_0_0ReactTreeAttributedString == ABI40_0_0ReactTreeAttributedString
           ? 0
