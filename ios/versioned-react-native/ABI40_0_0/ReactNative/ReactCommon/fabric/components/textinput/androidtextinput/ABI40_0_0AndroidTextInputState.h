...
class AndroidTextInputState final {
 public:
  ...
  /*
   * All content of <TextInput> component represented as an `AttributedString`.
   * This stores the previous computed *from the ABI40_0_0React tree*. This usually
   ...
   */
  AttributedString ABI40_0_0ReactTreeAttributedString{};
  ...
  AndroidTextInputState(
      ...
      AttributedString const &ABI40_0_0ReactTreeAttributedString,
      ...
      : mostRecentEventCount(mostRecentEventCount),
        attributedString(attributedString),
        ABI40_0_0ReactTreeAttributedString(ABI40_0_0ReactTreeAttributedString),
        paragraphAttributes(paragraphAttributes),
  ...
  AndroidTextInputState(
      ...
      : mostRecentEventCount(data.getDefault(
        ...
        attributedString(updateAttributedString(
            ...
            data)),
        ABI40_0_0ReactTreeAttributedString(previousState.ABI40_0_0ReactTreeAttributedString),
