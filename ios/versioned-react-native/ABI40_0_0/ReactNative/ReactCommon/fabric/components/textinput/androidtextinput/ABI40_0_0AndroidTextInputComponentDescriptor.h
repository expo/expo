...
#include <ABI40_0_0yoga/ABI40_0_0CompactValue.h>
#include <ABI40_0_0yoga/ABI40_0_0YGEnums.h>
#include <ABI40_0_0yoga/ABI40_0_0YGValue.h>
...
class AndroidTextInputComponentDescriptor final
 ...
 public:
  ...
  virtual State::Shared createInitialState(
    ...
    if (surfaceIdToThemePaddingMap_.find(surfaceId) !=
      ...
      ABI40_0_0YGStyle::Edges theme = surfaceIdToThemePaddingMap_[surfaceId];
      defaultThemePaddingStart = ((ABI40_0_0YGValue)theme[ABI40_0_0YGEdgeStart]).value;
      defaultThemePaddingEnd = ((ABI40_0_0YGValue)theme[ABI40_0_0YGEdgeEnd]).value;
      defaultThemePaddingTop = ((ABI40_0_0YGValue)theme[ABI40_0_0YGEdgeTop]).value;
      defaultThemePaddingBottom = ((ABI40_0_0YGValue)theme[ABI40_0_0YGEdgeBottom]).value;
    }
 ...
 protected:
  void adopt(UnsharedShadowNode shadowNode) const override {
    ...
    if (surfaceIdToThemePaddingMap_.find(surfaceId) ==
      ...
      ABI40_0_0YGStyle::Edges result;
      result[ABI40_0_0YGEdgeStart] =
          (ABI40_0_0YGValue){state.defaultThemePaddingStart, ABI40_0_0YGUnitPoint};
      result[ABI40_0_0YGEdgeEnd] = (ABI40_0_0YGValue){state.defaultThemePaddingEnd, ABI40_0_0YGUnitPoint};
      result[ABI40_0_0YGEdgeTop] = (ABI40_0_0YGValue){state.defaultThemePaddingTop, ABI40_0_0YGUnitPoint};
      result[ABI40_0_0YGEdgeBottom] =
          (ABI40_0_0YGValue){state.defaultThemePaddingBottom, ABI40_0_0YGUnitPoint};
    ...
    if (surfaceIdToThemePaddingMap_.find(surfaceId) !=
      ...
      if (!textInputShadowNode->getConcreteProps().hasPadding &&
        ...
        changedPadding = true;
        result[ABI40_0_0YGEdgeStart] = theme[ABI40_0_0YGEdgeStart];
      }
      if (!textInputShadowNode->getConcreteProps().hasPadding &&
      ...
      if ((textInputShadowNode->getConcreteProps().hasPadding ||
           ...
           textInputShadowNode->getConcreteProps().hasPaddingHorizontal) &&
          !textInputShadowNode->getConcreteProps().hasPaddingStart) {
        result[ABI40_0_0YGEdgeStart] = ABI40_0_0YGValueUndefined;
      }
      if ((textInputShadowNode->getConcreteProps().hasPadding ||
           textInputShadowNode->getConcreteProps().hasPaddingRight ||
           textInputShadowNode->getConcreteProps().hasPaddingHorizontal) &&
          !textInputShadowNode->getConcreteProps().hasPaddingEnd) {
        result[ABI40_0_0YGEdgeEnd] = ABI40_0_0YGValueUndefined;
      }
 ...
 private:
  ...
  mutable better::map<int, ABI40_0_0YGStyle::Edges> surfaceIdToThemePaddingMap_;
};
