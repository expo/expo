...
#include "ABI40_0_0UITemplateProcessor.h"
...
#include <ABI40_0_0React/components/view/ViewShadowNode.h>
#include <ABI40_0_0React/core/ComponentDescriptor.h>
#include <ABI40_0_0React/core/LayoutContext.h>
#include <ABI40_0_0React/core/ShadowNodeFragment.h>
...
SharedShadowNode UITemplateProcessor::runCommand(
    ...
    const ComponentDescriptorRegistry &componentDescriptorRegistry,
    const NativeModuleRegistry &nativeModuleRegistry,
    const std::shared_ptr<const ABI40_0_0ReactNativeConfig> ABI40_0_0ReactNativeConfig) {
  ...
  if (opcode == "createNode") {
    ...
    registers[registerNumber] = ABI40_0_0ReactNativeConfig->getBool(param);
...
SharedShadowNode UITemplateProcessor::buildShadowTree(
  ...
  LOG(ERROR) << "ABI40_0_0React ui template missing returnRoot command :(";
