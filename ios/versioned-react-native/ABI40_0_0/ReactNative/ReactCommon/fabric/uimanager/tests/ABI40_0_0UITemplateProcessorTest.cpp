...
#include <ABI40_0_0React/uimanager/ComponentDescriptorFactory.h>
#include <ABI40_0_0React/uimanager/UITemplateProcessor.h>

using namespace ABI40_0_0facebook::ABI40_0_0React;

#include <ABI40_0_0React/components/rncore/ComponentDescriptors.h>
...
class MockABI40_0_0ReactNativeConfig : public ABI40_0_0ReactNativeConfig {
 public:
  MockABI40_0_0ReactNativeConfig() {}
...
std::shared_ptr<const ABI40_0_0ReactNativeConfig> mockABI40_0_0ReactNativeConfig_ =
    std::make_shared<const MockABI40_0_0ReactNativeConfig>();
...
TEST(UITemplateProcessorTest, testSimpleBytecode) {
  ...
  auto bytecode = R"delim({"version":0.1,"commands":[
    ["createNode",2,"ABI40_0_0RCTView",-1,{"opacity": 0.5, "testId": "root"}],
    ["createNode",4,"ABI40_0_0RCTView",2,{"testId": "child"}],
    ["returnRoot",2]
  ]})delim";
...
TEST(UITemplateProcessorTest, testConditionalBytecode) {
  ...
  auto bytecode = R"delim({"version":0.1,"commands":[
    ["createNode",2,"ABI40_0_0RCTView",-1,{"testId": "root"}],
    ["loadNativeBool",1,"MobileConfig","getBool",["qe:simple_test"]],
    ["conditional",1,
      [["createNode",4,"ABI40_0_0RCTView",2,{"testId": "cond_true"}]],
      [["createNode",4,"ABI40_0_0RCTView",2,{"testId": "cond_false"}]]
    ],
    ["returnRoot",2]
  ]})delim";
