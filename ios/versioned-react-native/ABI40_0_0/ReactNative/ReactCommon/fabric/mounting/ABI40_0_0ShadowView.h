...
#include <ABI40_0_0React/core/LayoutMetrics.h>
...
template <>
struct hash<ABI40_0_0facebook::ABI40_0_0React::ShadowView> {
  size_t operator()(const ABI40_0_0facebook::ABI40_0_0React::ShadowView &shadowView) const {
