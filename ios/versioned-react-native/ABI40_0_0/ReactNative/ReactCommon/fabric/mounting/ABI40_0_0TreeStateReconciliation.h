...
/**
 * Problem Description: because of C++ State, the ABI40_0_0React Native C++ ShadowTree
 * can diverge from the ABI40_0_0ReactJS ShadowTree; ABI40_0_0ReactJS communicates all tree
 * changes to C++, but C++ state commits are not propagated to ABI40_0_0ReactJS (ABI40_0_0ReactJS
