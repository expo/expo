...
#include <ABI40_0_0React/graphics/ColorComponents.h>
...
namespace std {
template <>
struct hash<ABI40_0_0facebook::ABI40_0_0React::SharedColor> {
  size_t operator()(const ABI40_0_0facebook::ABI40_0_0React::SharedColor &sharedColor) const {
