...
namespace std {
template <>
struct hash<ABI40_0_0facebook::ABI40_0_0React::Point> {
  size_t operator()(const ABI40_0_0facebook::ABI40_0_0React::Point &point) const {
    return folly::hash::hash_combine(0, point.x, point.y);
  }
};

template <>
struct hash<ABI40_0_0facebook::ABI40_0_0React::Size> {
  size_t operator()(const ABI40_0_0facebook::ABI40_0_0React::Size &size) const {
    return folly::hash::hash_combine(0, size.width, size.height);
  }
};

template <>
struct hash<ABI40_0_0facebook::ABI40_0_0React::Rect> {
  size_t operator()(const ABI40_0_0facebook::ABI40_0_0React::Rect &rect) const {
    return folly::hash::hash_combine(0, rect.origin, rect.size);
  }
};

template <typename T>
struct hash<ABI40_0_0facebook::ABI40_0_0React::RectangleEdges<T>> {
  size_t operator()(const ABI40_0_0facebook::ABI40_0_0React::RectangleEdges<T> &edges) const {
...
template <typename T>
struct hash<ABI40_0_0facebook::ABI40_0_0React::RectangleCorners<T>> {
  size_t operator()(const ABI40_0_0facebook::ABI40_0_0React::RectangleCorners<T> &corners) const {
    return folly::hash::hash_combine(
        0,
        corners.topLeft,
        corners.bottomLeft,
