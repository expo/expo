...
#include <ABI40_0_0React/utils/ManagedObjectWrapper.h>
...
{
  self_ = wrapManagedObject([ABI40_0_0RCTTextLayoutManager new]);
}
...
{
  ABI40_0_0RCTTextLayoutManager *textLayoutManager = (ABI40_0_0RCTTextLayoutManager *)unwrapManagedObject(self_);
