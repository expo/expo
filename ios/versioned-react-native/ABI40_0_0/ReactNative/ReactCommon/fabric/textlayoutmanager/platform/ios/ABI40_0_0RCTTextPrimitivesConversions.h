...
#include <ABI40_0_0React/textlayoutmanager/ABI40_0_0RCTFontProperties.h>
#include <ABI40_0_0React/textlayoutmanager/ABI40_0_0RCTFontUtils.h>

using namespace ABI40_0_0facebook::ABI40_0_0React;

inline static NSTextAlignment ABI40_0_0RCTNSTextAlignmentFromTextAlignment(TextAlignment textAlignment)
{
...
inline static NSWritingDirection ABI40_0_0RCTNSWritingDirectionFromWritingDirection(WritingDirection writingDirection)
{
...
inline static ABI40_0_0RCTFontStyle ABI40_0_0RCTFontStyleFromFontStyle(FontStyle fontStyle)
{
  switch (fontStyle) {
    ...
    case FontStyle::Oblique:
      return ABI40_0_0RCTFontStyleOblique;
  }
}

inline static ABI40_0_0RCTFontVariant ABI40_0_0RCTFontVariantFromFontVariant(FontVariant fontVariant)
{
  return (ABI40_0_0RCTFontVariant)fontVariant;
}

inline static NSUnderlineStyle ABI40_0_0RCTNSUnderlineStyleFromStyleAndPattern(
...
inline static UIColor *ABI40_0_0RCTUIColorFromSharedColor(const SharedColor &color)
{
