...
TextMeasurement TextLayoutManager::doMeasure(
  ...
  static auto measure =
      jni::findClassStatic("com/facebook/ABI40_0_0React/fabric/FabricUIManager")
          ->getMethod<jlong(
              jint,
              jstring,
  ...
  local_ref<JString> componentName = make_jstring("ABI40_0_0RCTText");
  ...
  if (attachmentsCount > 0) {
    ...
    for (int i = 0; i < fragments.size(); i++) {
      ...
      if (fragment["isAttachment"] == true) {
        ...
        auto rect = ABI40_0_0facebook::ABI40_0_0React::Rect{{left, top},
                                          ABI40_0_0facebook::ABI40_0_0React::Size{width, height}};
