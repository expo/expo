...
#import "ABI40_0_0RCTTextLayoutManager.h"

#import "ABI40_0_0NSTextStorage+FontScaling.h"
#import "ABI40_0_0RCTAttributedTextUtils.h"

#import <ABI40_0_0React/utils/SimpleThreadSafeCache.h>

using namespace ABI40_0_0facebook::ABI40_0_0React;

@implementation ABI40_0_0RCTTextLayoutManager {
  SimpleThreadSafeCache<AttributedString, std::shared_ptr<const void>, 256> _cache;
}

static NSLineBreakMode ABI40_0_0RCTNSLineBreakModeFromEllipsizeMode(EllipsizeMode ellipsizeMode)
{
  ...
  [textStorage
      enumerateAttribute:NSAttachmentAttributeName
              ...
              usingBlock:^(NSTextAttachment *attachment, NSRange range, BOOL *stop) {
                ...
                auto rect = ABI40_0_0facebook::ABI40_0_0React::Rect{ABI40_0_0facebook::ABI40_0_0React::Point{frame.origin.x, frame.origin.y},
                                                  ABI40_0_0facebook::ABI40_0_0React::Size{frame.size.width, frame.size.height}};
                                                               ...
                                                               size:(CGSize)size
{
  ...
  textContainer.lineBreakMode = paragraphAttributes.maximumNumberOfLines > 0
      ? ABI40_0_0RCTNSLineBreakModeFromEllipsizeMode(paragraphAttributes.ellipsizeMode)
                                                 ...
                                                 atPoint:(CGPoint)point
{
  ...
  if (textStorage.length > 0 && (fraction > 0 || characterIndex > 0) &&
    ...
    ABI40_0_0RCTWeakEventEmitterWrapper *eventEmitterWrapper =
        (ABI40_0_0RCTWeakEventEmitterWrapper *)[textStorage attribute:ABI40_0_0RCTAttributedStringEventEmitterKey
...
- (NSAttributedString *)_nsAttributedStringFromAttributedString:(AttributedString)attributedString
{
  auto sharedNSAttributedString = _cache.get(attributedString, [](const AttributedString attributedString) {
    return std::shared_ptr<void>(
        (__bridge_retained void *)ABI40_0_0RCTNSAttributedStringFromAttributedString(attributedString), CFRelease);
  });
