...
#include <ABI40_0_0React/utils/SimpleThreadSafeCache.h>
...
template <>
struct hash<ABI40_0_0facebook::ABI40_0_0React::TextMeasureCacheKey> {
  size_t operator()(ABI40_0_0facebook::ABI40_0_0React::TextMeasureCacheKey const &key) const {
    return folly::hash::hash_combine(
        0,
