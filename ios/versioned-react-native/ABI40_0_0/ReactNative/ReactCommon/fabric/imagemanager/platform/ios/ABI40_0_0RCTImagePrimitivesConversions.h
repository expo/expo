...
#import <ABI40_0_0React/imagemanager/primitives.h>

using namespace ABI40_0_0facebook::ABI40_0_0React;

inline static ABI40_0_0RCTResizeMode ABI40_0_0RCTResizeModeFromImageResizeMode(ImageResizeMode imageResizeMode)
{
  switch (imageResizeMode) {
    case ImageResizeMode::Cover:
      return ABI40_0_0RCTResizeModeCover;
    case ImageResizeMode::Contain:
      return ABI40_0_0RCTResizeModeContain;
    case ImageResizeMode::Stretch:
      return ABI40_0_0RCTResizeModeStretch;
    case ImageResizeMode::Center:
      return ABI40_0_0RCTResizeModeCenter;
    case ImageResizeMode::Repeat:
      return ABI40_0_0RCTResizeModeRepeat;
  }
}
...
inline static NSURLRequest *NSURLRequestFromImageSource(const ImageSource &imageSource)
{
  ...
  if (!url) {
    ABI40_0_0RCTLogError(@"URI parsing error.");
    return nil;
  }
