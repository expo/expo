...
#include "ABI40_0_0ImageManager.h"
...
{
  id<ABI40_0_0RCTImageLoaderWithAttributionProtocol> imageLoader =
      (id<ABI40_0_0RCTImageLoaderWithAttributionProtocol>)unwrapManagedObject(
          contextContainer->at<std::shared_ptr<void>>("ABI40_0_0RCTImageLoader"));
  if (ABI40_0_0RCTRunningInTestEnvironment()) {
    self_ = (__bridge_retained void *)[[ABI40_0_0RCTSyncImageManager alloc] initWithImageLoader:imageLoader];
  } else {
    self_ = (__bridge_retained void *)[[ABI40_0_0RCTImageManager alloc] initWithImageLoader:imageLoader];
  }
}
...
{
  ABI40_0_0RCTImageManager *imageManager = (__bridge ABI40_0_0RCTImageManager *)self_;
