...
#include "ABI40_0_0SampleCxxModule.h"
#include <ABI40_0_0cxxreact/ABI40_0_0JsArgumentHelpers.h>
...
ABI40_0_0facebook::xplat::module::CxxModule *SampleCxxModule() {
  return new ABI40_0_0facebook::xplat::samples::SampleCxxModule(
      std::make_unique<ABI40_0_0facebook::xplat::samples::Sample>());
}
