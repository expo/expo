...
#include <ABI40_0_0cxxreact/ABI40_0_0JSDeltaBundleClient.h>
...
TEST(JSDeltaBundleClient, PatchStartupCode) {
  ...
  ABI40_0_0EXPECT_STREQ(client.getStartupCode()->c_str(), "pre\npost\n");
  ...
  ABI40_0_0EXPECT_STREQ(client.getStartupCode()->c_str(), "pre2\npost2\n");
}
...
TEST(JSDeltaBundleClient, PatchModule) {
  ...
  ABI40_0_0EXPECT_EQ(client.getModule(0).code, "0");
  ABI40_0_0EXPECT_EQ(client.getModule(1).code, "1");
  ...
  ABI40_0_0EXPECT_EQ(client.getModule(0).code, "0.1");
  ABI40_0_0EXPECT_EQ(client.getModule(2).code, "2");
  ...
  ABI40_0_0EXPECT_EQ(client.getModule(3).code, "3");
  ABI40_0_0EXPECT_EQ(client.getModule(4).code, "4");
}
...
TEST(JSDeltaBundleClient, Clear) {
  ...
  ABI40_0_0EXPECT_STREQ(client.getStartupCode()->c_str(), "");
}
