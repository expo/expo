...
#import <ABI40_0_0EXCalendar/ABI40_0_0EXCalendar.h>
#import <ABI40_0_0EXCalendar/ABI40_0_0EXCalendarConverter.h>
#import <ABI40_0_0EXCalendar/ABI40_0_0EXCalendarPermissionRequester.h>
...
@implementation ABI40_0_0EXCalendar
...
ABI40_0_0UM_EXPORT_MODULE(ExpoCalendar);
...
- (void)setModuleRegistry:(ABI40_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  [ABI40_0_0UMPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI40_0_0EXCalendarPermissionRequester new],
                                                    [ABI40_0_0EXRemindersPermissionRequester new]
                                                    ]
...
ABI40_0_0UM_EXPORT_METHOD_AS(getCalendarsAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI40_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI40_0_0UM_EXPORT_METHOD_AS(getDefaultCalendarAsync,
                    getDefaultCalendarAsync:(ABI40_0_0UMPromiseResolveBlock)resolve
                    rejector:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  if (![self _checkCalendarPermissions:reject]) {
    return;
  }
  ...
  resolve([ABI40_0_0EXCalendarConverter serializeCalendar:defaultCalendar]);
}

ABI40_0_0UM_EXPORT_METHOD_AS(saveCalendarAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (color) {
    calendar.CGColor = [ABI40_0_0UMUtilities UIColor:color].CGColor;
...
ABI40_0_0UM_EXPORT_METHOD_AS(deleteCalendarAsync,
...
ABI40_0_0UM_EXPORT_METHOD_AS(getEventsAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI40_0_0UMUtilities NSDate:startDateStr];
  NSDate *endDate = [ABI40_0_0UMUtilities NSDate:endDateStr];
  ...
  if (calendarEvents) {
    resolve([ABI40_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI40_0_0UM_EXPORT_METHOD_AS(getEventByIdAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (calendarEvent) {
    resolve([ABI40_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI40_0_0UM_EXPORT_METHOD_AS(saveEventAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI40_0_0UMUtilities NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI40_0_0UMUtilities NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI40_0_0UMUtilities NSDate:details[@"instanceStartDate"]];
...
ABI40_0_0UM_EXPORT_METHOD_AS(deleteEventAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *instanceStartDate = [ABI40_0_0UMUtilities NSDate:event[@"instanceStartDate"]];
...
ABI40_0_0UM_EXPORT_METHOD_AS(getAttendeesForEventAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (item.hasAttendees) {
    resolve([ABI40_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI40_0_0UM_EXPORT_METHOD_AS(getRemindersAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI40_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI40_0_0UM_EXPORT_METHOD_AS(getReminderByIdAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (reminder) {
    ...
    resolve([ABI40_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI40_0_0UM_EXPORT_METHOD_AS(saveReminderAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI40_0_0UMUtilities NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI40_0_0UMUtilities NSDate:details[@"dueDate"]];
  NSDate *completionDate = [ABI40_0_0UMUtilities NSDate:details[@"completionDate"]];
...
ABI40_0_0UM_EXPORT_METHOD_AS(deleteReminderAsync,
...
ABI40_0_0UM_EXPORT_METHOD_AS(getSourcesAsync,
                    getSourcesAsync:(ABI40_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI40_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI40_0_0UM_EXPORT_METHOD_AS(getSourceByIdAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI40_0_0EXCalendarConverter serializeSource:source]);
}

ABI40_0_0UM_EXPORT_METHOD_AS(getCalendarPermissionsAsync,
                    getCalendarPermissionsAsync:(ABI40_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  [ABI40_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI40_0_0EXCalendarPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI40_0_0UM_EXPORT_METHOD_AS(requestCalendarPermissionsAsync,
                    requestCalendarPermissionsAsync:(ABI40_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
...
ABI40_0_0UM_EXPORT_METHOD_AS(getRemindersPermissionsAsync,
                    getRemindersPermissionsAsync:(ABI40_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  [ABI40_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI40_0_0EXRemindersPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI40_0_0UM_EXPORT_METHOD_AS(requestRemindersPermissionsAsync,
                    requestRemindersPermissionsAsync:(ABI40_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  [ABI40_0_0UMPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI40_0_0EXRemindersPermissionRequester class]
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI40_0_0UMUtilities NSDate:alarm[@"absoluteDate"]];
...
- (EKRecurrenceRule *)_createRecurrenceRule:(NSDictionary *)recurrenceRule
{
  ...
  if (recurrenceRule[@"endDate"]) {
      endDate = [ABI40_0_0UMUtilities NSDate:recurrenceRule[@"endDate"]];
  }
...
- (BOOL)_checkPermissions:(EKEntityType)entity reject:(ABI40_0_0UMPromiseRejectBlock)reject
{
  ...
  switch (entity) {
    case EKEntityTypeEvent:
      requesterClass = [ABI40_0_0EXCalendarPermissionRequester class];
      break;
    case EKEntityTypeReminder:
      requesterClass = [ABI40_0_0EXRemindersPermissionRequester class];
      break;
    default: {
...
- (BOOL)_checkCalendarPermissions:(ABI40_0_0UMPromiseRejectBlock)reject
{
  return [self _checkPermissions:EKEntityTypeEvent reject:reject];
}

- (BOOL)_checkRemindersPermissions:(ABI40_0_0UMPromiseRejectBlock)reject
{
...
- (void)_initializePermittedEntities
{
  ...
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI40_0_0EXCalendarPermissionRequester class]]) {
    permittedEntities |= EKEntityMaskEvent;
  }
  
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI40_0_0EXRemindersPermissionRequester class]]) {
