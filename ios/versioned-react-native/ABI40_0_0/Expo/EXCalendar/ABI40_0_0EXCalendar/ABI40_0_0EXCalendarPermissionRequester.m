...
@implementation ABI40_0_0EXCalendarPermissionRequester
...
- (NSDictionary *)getPermissions
{
  ...
  if (!calendarUsageDescription) {
    ABI40_0_0UMFatal(ABI40_0_0UMErrorWithMessage(@"This app is missing NSCalendarsUsageDescription, so calendar methods will fail. Add this key to your bundle's Info.plist."));
