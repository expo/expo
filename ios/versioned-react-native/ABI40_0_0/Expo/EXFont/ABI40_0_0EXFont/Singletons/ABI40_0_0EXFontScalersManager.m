...
@implementation UIFont (ABI40_0_0EXFontLoader)

- (UIFont *)ABI40_0_0EXFontWithSize:(CGFloat)fontSize
{
  for (id<ABI40_0_0UMFontScalerInterface> fontScaler in currentFontScalers) {
  ...
  return [self ABI40_0_0EXFontWithSize:fontSize];
}
...
@implementation ABI40_0_0EXFontScalersManager

ABI40_0_0UM_REGISTER_SINGLETON_MODULE(FontScalersManager);
...
+ (void)initialize
{
  ...
  dispatch_once(&initializeCurrentFontScalersOnce, ^{
    ...
    SEL exUpdate = @selector(ABI40_0_0EXFontWithSize:);
...
- (void)registerFontScaler:(id<ABI40_0_0UMFontScalerInterface>)fontScaler
{
