...
#import <ABI40_0_0EXHaptics/ABI40_0_0EXHapticsModule.h>

@interface ABI40_0_0EXHapticsModule ()

@end

@implementation ABI40_0_0EXHapticsModule

ABI40_0_0UM_EXPORT_MODULE(ExpoHaptics);
...
ABI40_0_0UM_EXPORT_METHOD_AS(notificationAsync,
...
ABI40_0_0UM_EXPORT_METHOD_AS(impactAsync,
...
ABI40_0_0UM_EXPORT_METHOD_AS(selectionAsync,
                    resolve:(ABI40_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
