...
#import <ABI40_0_0EXMailComposer/ABI40_0_0EXMailComposer.h>
...
@interface ABI40_0_0EXMailComposer ()
...
@implementation ABI40_0_0EXMailComposer

ABI40_0_0UM_EXPORT_MODULE(ExpoMailComposer);
...
ABI40_0_0UM_EXPORT_METHOD_AS(composeAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  self.reject = reject;
  id<ABI40_0_0UMUtilitiesInterface> utilities = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI40_0_0UMUtilitiesInterface)];
