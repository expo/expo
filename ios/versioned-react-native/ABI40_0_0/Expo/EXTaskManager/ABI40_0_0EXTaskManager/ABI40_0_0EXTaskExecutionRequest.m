...
@interface ABI40_0_0EXTaskExecutionRequest ()

@property (nonatomic, strong, nullable) NSMutableSet<id<ABI40_0_0UMTaskInterface>> *tasks;
...
@implementation ABI40_0_0EXTaskExecutionRequest
...
- (void)_maybeExecuteCallback
{
  if (_callback) {
    ...
    __strong ABI40_0_0EXTaskExecutionRequest *strongSelf = self;
