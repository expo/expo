...
// Interface for ABI40_0_0UMTaskManager module.

@protocol ABI40_0_0UMTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI40_0_0UMTaskConsumerInterface protocol.
 */
