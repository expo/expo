...
@protocol ABI40_0_0UMTaskConsumerInterface;

@protocol ABI40_0_0UMTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI40_0_0UMTaskConsumerInterface> __nonnull consumer;
