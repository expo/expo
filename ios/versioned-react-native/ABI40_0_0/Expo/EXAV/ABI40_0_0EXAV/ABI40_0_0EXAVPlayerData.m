...
NSString *const ABI40_0_0EXAVPlayerDataStatusIsLoadedKeyPath = @"isLoaded";
NSString *const ABI40_0_0EXAVPlayerDataStatusURIKeyPath = @"uri";
NSString *const ABI40_0_0EXAVPlayerDataStatusHeadersKeyPath = @"headers";
NSString *const ABI40_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath = @"progressUpdateIntervalMillis";
NSString *const ABI40_0_0EXAVPlayerDataStatusDurationMillisKeyPath = @"durationMillis";
NSString *const ABI40_0_0EXAVPlayerDataStatusPositionMillisKeyPath = @"positionMillis";
NSString *const ABI40_0_0EXAVPlayerDataStatusSeekMillisToleranceBeforeKeyPath = @"seekMillisToleranceBefore";
NSString *const ABI40_0_0EXAVPlayerDataStatusSeekMillisToleranceAfterKeyPath = @"seekMillisToleranceAfter";
NSString *const ABI40_0_0EXAVPlayerDataStatusPlayableDurationMillisKeyPath = @"playableDurationMillis";
NSString *const ABI40_0_0EXAVPlayerDataStatusShouldPlayKeyPath = @"shouldPlay";
NSString *const ABI40_0_0EXAVPlayerDataStatusIsPlayingKeyPath = @"isPlaying";
NSString *const ABI40_0_0EXAVPlayerDataStatusIsBufferingKeyPath = @"isBuffering";
NSString *const ABI40_0_0EXAVPlayerDataStatusRateKeyPath = @"rate";
NSString *const ABI40_0_0EXAVPlayerDataStatusPitchCorrectionQualityKeyPath = @"pitchCorrectionQuality";
NSString *const ABI40_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath = @"shouldCorrectPitch";
NSString *const ABI40_0_0EXAVPlayerDataStatusVolumeKeyPath = @"volume";
NSString *const ABI40_0_0EXAVPlayerDataStatusIsMutedKeyPath = @"isMuted";
NSString *const ABI40_0_0EXAVPlayerDataStatusIsLoopingKeyPath = @"isLooping";
NSString *const ABI40_0_0EXAVPlayerDataStatusDidJustFinishKeyPath = @"didJustFinish";
NSString *const ABI40_0_0EXAVPlayerDataStatusHasJustBeenInterruptedKeyPath = @"hasJustBeenInterrupted";

NSString *const ABI40_0_0EXAVPlayerDataObserverStatusKeyPath = @"status";
NSString *const ABI40_0_0EXAVPlayerDataObserverRateKeyPath = @"rate";
NSString *const ABI40_0_0EXAVPlayerDataObserverCurrentItemKeyPath = @"currentItem";
NSString *const ABI40_0_0EXAVPlayerDataObserverTimeControlStatusPath = @"timeControlStatus";
NSString *const ABI40_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath = @"playbackBufferEmpty";

@interface ABI40_0_0EXAVPlayerData ()

@property (nonatomic, weak) ABI40_0_0EXAV *exAV;
...
@property (nonatomic, strong) ABI40_0_0UMPromiseResolveBlock replayResolve;

@end

@implementation ABI40_0_0EXAVPlayerData

#pragma mark - Static methods

+ (NSDictionary *)getUnloadedStatus
{
  return @{ABI40_0_0EXAVPlayerDataStatusIsLoadedKeyPath: @(NO)};
}
         ...
         withLoadFinishBlock:(void (^)(BOOL success, NSDictionary *successStatus, NSString *error))loadFinishBlock
{
  if ((self = [super init])) {
    ...
    _url = [NSURL URLWithString:[source objectForKey:ABI40_0_0EXAVPlayerDataStatusURIKeyPath]];
    _headers = [self validatedRequestHeaders:source[ABI40_0_0EXAVPlayerDataStatusHeadersKeyPath]];
...
- (void)_loadNewPlayer
{
  ...
  [avAsset loadValuesAsynchronouslyForKeys:@[ @"duration" ] completionHandler:^{
    ...
    if (self.player) {
      [self _addObserver:self.player forKeyPath:ABI40_0_0EXAVPlayerDataObserverStatusKeyPath];
      [self _addObserver:self.player.currentItem forKeyPath:ABI40_0_0EXAVPlayerDataObserverStatusKeyPath];
    } else {
...
- (void)_finishLoadingNewPlayer
{
  ...
  [_player seekToTime:_currentPosition completionHandler:^(BOOL finished) {
    ABI40_0_0UM_ENSURE_STRONGIFY(self);
    __strong ABI40_0_0EXAV *strongEXAV = self.exAV;
    if (strongEXAV) {
         ...
         rejecter:(ABI40_0_0UMPromiseRejectBlock)reject
{
  ...
  if ([parameters objectForKey:ABI40_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath] != nil) {
    NSNumber *progressUpdateIntervalMillis = parameters[ABI40_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath];
  ...
  if ([parameters objectForKey:ABI40_0_0EXAVPlayerDataStatusPositionMillisKeyPath] != nil) {
    NSNumber *currentPositionMillis = parameters[ABI40_0_0EXAVPlayerDataStatusPositionMillisKeyPath];
  ...
  if (mustSeek && [parameters objectForKey:ABI40_0_0EXAVPlayerDataStatusSeekMillisToleranceBeforeKeyPath] != nil) {
    NSNumber *seekMillisToleranceBefore = parameters[ABI40_0_0EXAVPlayerDataStatusSeekMillisToleranceBeforeKeyPath];
  ...
  if (mustSeek && [parameters objectForKey:ABI40_0_0EXAVPlayerDataStatusSeekMillisToleranceAfterKeyPath] != nil) {
    NSNumber *seekMillisToleranceAfter = parameters[ABI40_0_0EXAVPlayerDataStatusSeekMillisToleranceAfterKeyPath];
    toleranceAfter = CMTimeMakeWithSeconds(seekMillisToleranceAfter.floatValue / 1000, NSEC_PER_SEC);
  }
  
  if ([parameters objectForKey:ABI40_0_0EXAVPlayerDataStatusShouldPlayKeyPath] != nil) {
    NSNumber *shouldPlay = parameters[ABI40_0_0EXAVPlayerDataStatusShouldPlayKeyPath];
    _shouldPlay = shouldPlay.boolValue;
  }
  
  if ([parameters objectForKey:ABI40_0_0EXAVPlayerDataStatusRateKeyPath] != nil) {
    NSNumber *rate = parameters[ABI40_0_0EXAVPlayerDataStatusRateKeyPath];
    _rate = rate;
  }
  
  if (parameters[ABI40_0_0EXAVPlayerDataStatusPitchCorrectionQualityKeyPath] != nil) {
    _pitchCorrectionQuality = parameters[ABI40_0_0EXAVPlayerDataStatusPitchCorrectionQualityKeyPath];
  }
  
  if ([parameters objectForKey:ABI40_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath] != nil) {
    NSNumber *shouldCorrectPitch = parameters[ABI40_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath];
    _shouldCorrectPitch = shouldCorrectPitch.boolValue;
  }
  if ([parameters objectForKey:ABI40_0_0EXAVPlayerDataStatusVolumeKeyPath] != nil) {
    NSNumber *volume = parameters[ABI40_0_0EXAVPlayerDataStatusVolumeKeyPath];
    _volume = volume;
  }
  if ([parameters objectForKey:ABI40_0_0EXAVPlayerDataStatusIsMutedKeyPath] != nil) {
    NSNumber *isMuted = parameters[ABI40_0_0EXAVPlayerDataStatusIsMutedKeyPath];
    _isMuted = isMuted.boolValue;
  }
  if ([parameters objectForKey:ABI40_0_0EXAVPlayerDataStatusIsLoopingKeyPath] != nil) {
    NSNumber *isLooping = parameters[ABI40_0_0EXAVPlayerDataStatusIsLoopingKeyPath];
  ...
  if (_player && _isLoaded) {
    ...
    void (^applyPostSeekParameters)(BOOL) = ^(BOOL seekSucceeded) {
      ...
      if (audioSessionError) {
        ...
        if (reject) {
          reject(@"E_AV_SEEKING", nil, ABI40_0_0UMErrorWithMessage(@"Seeking interrupted."));
        }
      } else if (resolve) {
...
- (NSDictionary *)getStatus
{
  if (!_isLoaded || _player == nil) {
    return [ABI40_0_0EXAVPlayerData getUnloadedStatus];
  }
  ...
  // TODO : ABI40_0_0React-native-video includes the iOS-only keys seekableDuration and canReverse (etc) flags.
  //        Consider adding these.
  NSMutableDictionary *mutableStatus = [@{ABI40_0_0EXAVPlayerDataStatusIsLoadedKeyPath: @(YES),
                                          
                                          ABI40_0_0EXAVPlayerDataStatusURIKeyPath: [_url absoluteString],
                                          
                                          ABI40_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath: _progressUpdateIntervalMillis,
                                          // positionMillis, playableDurationMillis, and durationMillis may be nil and are added after this definition.
                                          
                                          ABI40_0_0EXAVPlayerDataStatusShouldPlayKeyPath: @(_shouldPlay),
                                          ABI40_0_0EXAVPlayerDataStatusIsPlayingKeyPath: @(isPlaying),
                                          ABI40_0_0EXAVPlayerDataStatusIsBufferingKeyPath: @(isBuffering),
                                          
                                          ABI40_0_0EXAVPlayerDataStatusRateKeyPath: _rate,
                                          ABI40_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath: @(_shouldCorrectPitch),
                                          ABI40_0_0EXAVPlayerDataStatusPitchCorrectionQualityKeyPath: _pitchCorrectionQuality,
                                          ABI40_0_0EXAVPlayerDataStatusVolumeKeyPath: @(_player.volume),
                                          ABI40_0_0EXAVPlayerDataStatusIsMutedKeyPath: @(_player.muted),
                                          ABI40_0_0EXAVPlayerDataStatusIsLoopingKeyPath: @(_isLooping),
                                          
                                          ABI40_0_0EXAVPlayerDataStatusDidJustFinishKeyPath: @(NO),
                                          ABI40_0_0EXAVPlayerDataStatusHasJustBeenInterruptedKeyPath: @(NO),
                                          } mutableCopy];
  
  mutableStatus[ABI40_0_0EXAVPlayerDataStatusPlayableDurationMillisKeyPath] = playableDurationMillis;
  mutableStatus[ABI40_0_0EXAVPlayerDataStatusDurationMillisKeyPath] = durationMillis;
  mutableStatus[ABI40_0_0EXAVPlayerDataStatusPositionMillisKeyPath] = positionMillis;
                ...
                rejecter:(ABI40_0_0UMPromiseRejectBlock)reject
{
  [self _callStatusUpdateCallbackWithExtraFields:@{
                                                   ABI40_0_0EXAVPlayerDataStatusHasJustBeenInterruptedKeyPath: @([self _isPlayerPlaying]),
                                                   }];
...
{
  [self _tryRemoveObserver:_player forKeyPath:ABI40_0_0EXAVPlayerDataObserverStatusKeyPath];
  [self _removeObserversForPlayerItems];
  [self _tryRemoveObserver:_player forKeyPath:ABI40_0_0EXAVPlayerDataObserverRateKeyPath];
  [self _tryRemoveObserver:_player forKeyPath:ABI40_0_0EXAVPlayerDataObserverCurrentItemKeyPath];
  [self _tryRemoveObserver:_player forKeyPath:ABI40_0_0EXAVPlayerDataObserverTimeControlStatusPath];
}
...
{
  [self _tryRemoveObserver:playerItem forKeyPath:ABI40_0_0EXAVPlayerDataObserverStatusKeyPath];
  ...
  [self _tryRemoveObserver:playerItem forKeyPath:ABI40_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath];
}
...
- (void)_addObserversForPlayerItem:(AVPlayerItem *)playerItem
{
  ...
  void (^didPlayToEndTimeObserverBlock)(NSNotification *note) = ^(NSNotification *note) {
    ...
    if (strongEXAV) {
      dispatch_async(strongEXAV.methodQueue, ^{
        ABI40_0_0UM_ENSURE_STRONGIFY(self);
        [self _callStatusUpdateCallbackWithExtraFields:@{ABI40_0_0EXAVPlayerDataStatusDidJustFinishKeyPath: @(YES)}];
        // If the player is looping, we would only like to advance to next item (which is handled by actionAtItemEnd)
        if (!self.isLooping) {
          [self.player pause];
          self.shouldPlay = NO;
          __strong ABI40_0_0EXAV *strongEXAVInner = self.exAV;
          if (strongEXAVInner) {
  ...
  [self _addObserver:playerItem forKeyPath:ABI40_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath];
  [self _addObserver:playerItem forKeyPath:ABI40_0_0EXAVPlayerDataObserverStatusKeyPath];
}
...
- (void)_addObserversForNewPlayer
{
  ...
  [self _addObserver:_player forKeyPath:ABI40_0_0EXAVPlayerDataObserverRateKeyPath];
  NSUInteger currentItemObservationOptions = NSKeyValueObservingOptionOld | NSKeyValueObservingOptionNew;
  [self _addObserver:_player forKeyPath:ABI40_0_0EXAVPlayerDataObserverCurrentItemKeyPath options:currentItemObservationOptions];
  [self _addObserver:_player forKeyPath:ABI40_0_0EXAVPlayerDataObserverTimeControlStatusPath]; // Only available after iOS 10
                       ...
                       context:(void *)context
{
  ...
  __weak ABI40_0_0EXAVPlayerData *weakSelf = nil;
  ...
  // as the ABI40_0_0EXAVPlayerData is being deallocated, so let's early return.
  //
  ...
  __strong ABI40_0_0EXAV *strongEXAV = _exAV;
  if (strongEXAV == nil) {
    return;
  }
  
  dispatch_async(strongEXAV.methodQueue, ^{
    __strong ABI40_0_0EXAVPlayerData *strongSelf = weakSelf;
    if (strongSelf) {
      if (object == strongSelf.player) {
        if ([keyPath isEqualToString:ABI40_0_0EXAVPlayerDataObserverStatusKeyPath]) {
        ...
        } else if ([keyPath isEqualToString:ABI40_0_0EXAVPlayerDataObserverRateKeyPath]) {
        ...
        } else if ([keyPath isEqualToString:ABI40_0_0EXAVPlayerDataObserverTimeControlStatusPath]) {
        ...
        } else if ([keyPath isEqualToString:ABI40_0_0EXAVPlayerDataObserverCurrentItemKeyPath]) {
        ...
        if ([keyPath isEqualToString:ABI40_0_0EXAVPlayerDataObserverStatusKeyPath]) {
          ...
          [strongSelf _callStatusUpdateCallback];
        } else if ([keyPath isEqualToString:ABI40_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath]) {
          [strongSelf _callStatusUpdateCallback];
        }
      }
    }
...
#pragma mark - ABI40_0_0EXAVObject
...
- (ABI40_0_0EXAVAudioSessionMode)getAudioSessionModeRequired
{
  if (_player && ([self _isPlayerPlaying] || [self _shouldPlayerPlay])) {
    return _isMuted ? ABI40_0_0EXAVAudioSessionModeActiveMuted : ABI40_0_0EXAVAudioSessionModeActive;
  }
  return ABI40_0_0EXAVAudioSessionModeInactive;
}
...
{
  // ABI40_0_0EXAudio already forced pause.
}
