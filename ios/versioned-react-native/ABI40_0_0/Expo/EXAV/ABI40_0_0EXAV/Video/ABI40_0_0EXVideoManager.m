...
#import <ABI40_0_0EXAV/ABI40_0_0EXVideoManager.h>
#import <ABI40_0_0EXAV/ABI40_0_0EXVideoView.h>
#import <ABI40_0_0UMCore/ABI40_0_0UMUIManager.h>

@interface ABI40_0_0EXVideoManager ()

@property (nonatomic, weak) ABI40_0_0UMModuleRegistry *moduleRegistry;

@end

@implementation ABI40_0_0EXVideoManager

ABI40_0_0UM_EXPORT_MODULE(ExpoVideoManager);
...
- (UIView *)view
{
  return [[ABI40_0_0EXVideoView alloc] initWithModuleRegistry:_moduleRegistry];
}
...
ABI40_0_0UM_VIEW_PROPERTY(status, NSDictionary *, ABI40_0_0EXVideoView)
{
  [view setStatus:value];
}

ABI40_0_0UM_VIEW_PROPERTY(useNativeControls, BOOL, ABI40_0_0EXVideoView)
{
  [view setUseNativeControls:value];
}

// Native only props -- set by Video.js
ABI40_0_0UM_VIEW_PROPERTY(source, NSDictionary *, ABI40_0_0EXVideoView)
{
  [view setSource:value];
}
ABI40_0_0UM_VIEW_PROPERTY(resizeMode, NSString *, ABI40_0_0EXVideoView)
{
     ...
     withRejecter:(ABI40_0_0UMPromiseRejectBlock)reject
{
  ...
  [uiManager executeUIBlock:^(id view) {
    if ([view isKindOfClass:[ABI40_0_0EXVideoView class]]) {
      block((ABI40_0_0EXVideoView *)view);
    } else {
      NSString *errorMessage = [NSString stringWithFormat:@"Invalid view returned from registry, expecting ABI40_0_0EXVideo, got: %@", view];
      reject(@"E_VIDEO_TAGINCORRECT", errorMessage, ABI40_0_0UMErrorWithMessage(errorMessage));
    }
  } forView:viewTag ofClass:[ABI40_0_0EXVideoView class]];
}

ABI40_0_0UM_EXPORT_METHOD_AS(setFullscreen,
