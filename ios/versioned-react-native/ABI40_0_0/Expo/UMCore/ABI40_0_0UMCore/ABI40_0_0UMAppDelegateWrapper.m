...
@implementation ABI40_0_0UMAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitializedAndSorted {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI40_0_0UMSingletonModule*> * singletonModules = [[ABI40_0_0UMModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI40_0_0UMSingletonModule *singletonModule in singletonModules) {
