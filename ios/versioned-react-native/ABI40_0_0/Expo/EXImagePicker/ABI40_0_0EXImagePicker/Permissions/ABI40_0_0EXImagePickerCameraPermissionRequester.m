...
#import <ABI40_0_0EXImagePicker/ABI40_0_0EXImagePickerCameraPermissionRequester.h>
...
@implementation ABI40_0_0EXImagePickerCameraPermissionRequester
...
- (NSDictionary *)getPermissions
{
  ...
  if (!(cameraUsageDescription && microphoneUsageDescription)) {
    ABI40_0_0UMFatal(ABI40_0_0UMErrorWithMessage(@"This app is missing either 'NSCameraUsageDescription' or 'NSMicrophoneUsageDescription', so audio/video services will fail. Ensure both of these keys exist in app's Info.plist."));
