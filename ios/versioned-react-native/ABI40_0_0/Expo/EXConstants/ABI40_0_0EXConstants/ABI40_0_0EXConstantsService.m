...
NSString * const ABI40_0_0EXConstantsExecutionEnvironmentBare = @"bare";
NSString * const ABI40_0_0EXConstantsExecutionEnvironmentStandalone = @"standalone";
NSString * const ABI40_0_0EXConstantsExecutionEnvironmentStoreClient = @"storeClient";

@interface ABI40_0_0EXConstantsService ()

@property (nonatomic, strong) NSString *sessionId;
@property (nonatomic, strong) ABI40_0_0EXConstantsInstallationIdProvider *installationIdProvider;

@end

@implementation ABI40_0_0EXConstantsService

- (instancetype)init
{
  return [self initWithInstallationIdProvider:[[ABI40_0_0EXConstantsInstallationIdProvider alloc] init]];
}

- (instancetype)initWithInstallationIdProvider:(ABI40_0_0EXConstantsInstallationIdProvider *)installationIdProvider
{
  if (self = [super init]) {
...
{
  return @[@protocol(ABI40_0_0UMConstantsInterface)];
}
...
- (NSDictionary *)constants
{
  ...
  return @{
           ...
           @"executionEnvironment": ABI40_0_0EXConstantsExecutionEnvironmentBare,
           ...
           @"manifest": ABI40_0_0UMNullIfNil([[self class] appConfig]),
           @"platform": @{
               @"ios": @{
