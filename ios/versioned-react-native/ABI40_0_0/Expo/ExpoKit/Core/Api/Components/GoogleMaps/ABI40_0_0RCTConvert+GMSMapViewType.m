//
//  ABI40_0_0RCTConvert+GMSMapViewType.m
//
...
@implementation ABI40_0_0RCTConvert (GMSMapViewType)
  ABI40_0_0RCT_ENUM_CONVERTER(GMSMapViewType,
  (
    @{
...
+ (GMSCameraPosition*)GMSCameraPosition:(id)json
{
    ...
    return [ABI40_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:nil];
}
