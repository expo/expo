...
#import "ABI40_0_0RNGestureHandlerEvents.h"
...
if (value != nil) recognizer.prop = [ABI40_0_0RCTConvert type:value]; \
} while(0)
...
@protocol ABI40_0_0RNGestureHandlerEventEmitter

- (void)sendTouchEvent:(nonnull ABI40_0_0RNGestureHandlerEvent *)event;

- (void)sendStateChangeEvent:(nonnull ABI40_0_0RNGestureHandlerStateChange *)event;

@end


@protocol ABI40_0_0RNRootViewGestureRecognizerDelegate <UIGestureRecognizerDelegate>
...
@interface ABI40_0_0RNGestureHandler : NSObject <UIGestureRecognizerDelegate> {

@protected UIGestureRecognizer *_recognizer;
@protected ABI40_0_0RNGestureHandlerState _lastState;

}

+ (nullable ABI40_0_0RNGestureHandler *)findGestureHandlerByRecognizer:(nonnull UIGestureRecognizer *)recognizer;

- (nonnull instancetype)initWithTag:(nonnull NSNumber *)tag;

@property (nonatomic, readonly, nonnull) NSNumber *tag;
@property (nonatomic, weak, nullable) id<ABI40_0_0RNGestureHandlerEventEmitter> emitter;
...
- (nullable ABI40_0_0RNGestureHandlerEventExtraData *)eventExtraData:(nonnull id)recognizer;
