...
@implementation ABI40_0_0RCTConvert (AirMap)
...
{
    json = [self NSDictionary:json];
    return [ABI40_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:nil];
}
...
ABI40_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI40_0_0AIRMapCoordinate *)ABI40_0_0AIRMapCoordinate:(id)json
{
    ABI40_0_0AIRMapCoordinate *coord = [ABI40_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI40_0_0RCT_ARRAY_CONVERTER(ABI40_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI40_0_0AIRMapCoordinate *> *> *)ABI40_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI40_0_0RCTConvertArrayValue(@selector(ABI40_0_0AIRMapCoordinateArray:), json);
}
