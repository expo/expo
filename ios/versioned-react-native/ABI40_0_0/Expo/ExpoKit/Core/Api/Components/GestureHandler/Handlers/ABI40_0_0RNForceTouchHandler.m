#import "ABI40_0_0RNForceTouchHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI40_0_0React/ABI40_0_0RCTConvert.h>

@interface ABI40_0_0RNForceTouchGestureRecognizer : UIGestureRecognizer
...
@implementation ABI40_0_0RNForceTouchGestureRecognizer {
...
@implementation ABI40_0_0RNForceTouchHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI40_0_0RNForceTouchGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI40_0_0RNForceTouchGestureRecognizer *recognizer = (ABI40_0_0RNForceTouchGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    recognizer.feedbackOnActivation = [ABI40_0_0RCTConvert BOOL:prop];
  }
}

- (ABI40_0_0RNGestureHandlerEventExtraData *)eventExtraData:(ABI40_0_0RNForceTouchGestureRecognizer *)recognizer
{
