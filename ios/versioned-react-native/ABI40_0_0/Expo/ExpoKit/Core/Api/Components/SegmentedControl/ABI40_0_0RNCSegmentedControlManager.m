...
#import "ABI40_0_0RNCSegmentedControlManager.h"
...
@implementation ABI40_0_0RNCSegmentedControlManager

ABI40_0_0RCT_EXPORT_MODULE()

- (UIView *)view {
  return [ABI40_0_0RNCSegmentedControl new];
}

ABI40_0_0RCT_EXPORT_VIEW_PROPERTY(values, NSArray)
...
ABI40_0_0RCT_EXPORT_VIEW_PROPERTY(appearance, NSString)

ABI40_0_0RCT_CUSTOM_VIEW_PROPERTY(fontStyle, NSObject, ABI40_0_0RNCSegmentedControl) {
#if defined(__IPHONE_OS_VERSION_MAX_ALLOWED) && defined(__IPHONE_13_0) &&      \
    __IPHONE_OS_VERSION_MAX_ALLOWED >= __IPHONE_13_0
  if (@available(iOS 13.0, *)) {
    if (json) {
      UIColor *color = json[@"color"] ? [ABI40_0_0RCTConvert UIColor:json[@"color"]]
                                      : UIColor.labelColor;
      NSInteger fontSize =
          json[@"fontSize"] ? [ABI40_0_0RCTConvert NSInteger:json[@"fontSize"]] : 13.0;
...
ABI40_0_0RCT_CUSTOM_VIEW_PROPERTY(activeFontStyle, NSObject, ABI40_0_0RNCSegmentedControl) {
#if defined(__IPHONE_OS_VERSION_MAX_ALLOWED) && defined(__IPHONE_13_0) &&      \
    __IPHONE_OS_VERSION_MAX_ALLOWED >= __IPHONE_13_0
  if (@available(iOS 13.0, *)) {
    if (json) {
