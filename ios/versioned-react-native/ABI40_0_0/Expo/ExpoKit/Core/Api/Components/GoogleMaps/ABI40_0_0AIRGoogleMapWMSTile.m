//
//  ABI40_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI40_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI40_0_0WMSTileOverlay *tile = [[ABI40_0_0WMSTileOverlay alloc] init];
...
@implementation ABI40_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
