...
@implementation ABI40_0_0RNSVGLength
...
{
    ABI40_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype) lengthWithString: (NSString *) lengthString {
    ...
    ABI40_0_0RNSVGLength *output = [ABI40_0_0RNSVGLength alloc];
    if (stringLength == 0) {
        ...
        ABI40_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
