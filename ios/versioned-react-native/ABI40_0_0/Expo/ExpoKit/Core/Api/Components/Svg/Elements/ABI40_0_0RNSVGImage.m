...
#if __has_include(<ABI40_0_0React/ABI40_0_0RCTImageLoader.h>)
...
#import "ABI40_0_0RNSVGViewBox.h"

@implementation ABI40_0_0RNSVGImage
{
    CGImageRef _image;
    CGSize _imageSize;
...
- (void)setSrc:(id)src
{
    ...
    _image = nil;
    ABI40_0_0RCTImageSource *source = [ABI40_0_0RCTConvert ABI40_0_0RCTImageSource:src];
    ...
    ABI40_0_0RCTImageLoaderCancellationBlock previousCancellationBlock = _reloadImageCancellationBlock;
    if (previousCancellationBlock) {
        previousCancellationBlock();
        _reloadImageCancellationBlock = nil;
    }

    _reloadImageCancellationBlock = [[self.bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI40_0_0RCTConvert NSURLRequest:src] callback:^(NSError *error, UIImage *image) {
...
- (void)setX:(ABI40_0_0RNSVGLength *)x
{
    if ([x isEqualTo:_x]) {
        return;
    }
...
- (void)setY:(ABI40_0_0RNSVGLength *)y
{
    if ([y isEqualTo:_y]) {
        return;
    }
...
- (void)setImagewidth:(ABI40_0_0RNSVGLength *)width
{
...
- (void)setImageheight:(ABI40_0_0RNSVGLength *)height
{
...
- (void)setMeetOrSlice:(ABI40_0_0RNSVGVBMOS)meetOrSlice
{
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    CGAffineTransform viewbox = [ABI40_0_0RNSVGViewBox getTransform:imageBounds eRect:hitArea align:self.align meetOrSlice:self.meetOrSlice];
