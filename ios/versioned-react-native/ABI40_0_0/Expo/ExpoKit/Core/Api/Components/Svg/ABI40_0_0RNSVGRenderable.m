...
#import "ABI40_0_0RNSVGVectorEffect.h"
#import "ABI40_0_0RNSVGBezierElement.h"
#import "ABI40_0_0RNSVGMarker.h"
#import "ABI40_0_0RNSVGMarkerPosition.h"

@implementation ABI40_0_0RNSVGRenderable
{
    NSMutableDictionary *_originProperties;
    NSArray<NSString *> *_lastMergedList;
    NSArray<NSString *> *_attributeList;
    NSArray<ABI40_0_0RNSVGLength *> *_sourceStrokeDashArray;
    CGFloat *_strokeDashArrayData;
    CGPathRef _srcHitPath;
}

static ABI40_0_0RNSVGRenderable * _contextElement;
+ (ABI40_0_0RNSVGRenderable *)contextElement { return _contextElement; }
+ (void)setContextElement:(ABI40_0_0RNSVGRenderable *)contextElement { _contextElement = contextElement; }
...
- (id)init
{
    if (self = [super init]) {
        _fillOpacity = 1;
        _strokeOpacity = 1;
        _strokeWidth = [ABI40_0_0RNSVGLength lengthWithNumber:1];
...
- (void)setFill:(ABI40_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI40_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI40_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)setStrokeWidth:(ABI40_0_0RNSVGLength*)strokeWidth
{
...
- (void)setStrokeDasharray:(NSArray<ABI40_0_0RNSVGLength *> *)strokeDasharray
{
...
- (void)setVectorEffect:(ABI40_0_0RNSVGVectorEffect)vectorEffect
{
...
UInt32 ABI40_0_0saturate(CGFloat value) {
...
- (void)renderTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    if (self.mask) {
        ...
        ABI40_0_0RNSVGMask *_maskNode = (ABI40_0_0RNSVGMask*)[self.svgView getDefinedMask:self.mask];
        ...
        for (NSUInteger i = 0; i < npixels; i++) {
            ...
            *currentPixel = ABI40_0_0saturate(luma) << 24;
            currentPixel++;
        }
...
- (void)prepareStrokeDash:(NSUInteger)count strokeDasharray:(NSArray<ABI40_0_0RNSVGLength *> *)strokeDasharray {
...
- (void)renderMarkers:(CGContextRef)context path:(CGPathRef)path rect:(const CGRect *)rect {
    ABI40_0_0RNSVGMarker *markerStart = (ABI40_0_0RNSVGMarker*)[self.svgView getDefinedMarker:self.markerStart];
    ABI40_0_0RNSVGMarker *markerMid = (ABI40_0_0RNSVGMarker*)[self.svgView getDefinedMarker:self.markerMid];
    ABI40_0_0RNSVGMarker *markerEnd = (ABI40_0_0RNSVGMarker*)[self.svgView getDefinedMarker:self.markerEnd];
    if (markerStart || markerMid || markerEnd) {
        _contextElement = self;
        NSArray<ABI40_0_0RNSVGMarkerPosition*>* positions = [ABI40_0_0RNSVGMarkerPosition fromCGPath:path];
        ...
        for (ABI40_0_0RNSVGMarkerPosition* position in positions) {
            ABI40_0_0RNSVGMarkerType type = [position type];
            ABI40_0_0RNSVGMarker *marker;
            switch (type) {
                case kStartMarker:
                    marker = markerStart;
                    break;
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    if (self.stroke) {
        ...
        NSArray<ABI40_0_0RNSVGLength *>* strokeDasharray = self.strokeDasharray;
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    BOOL canReceiveTouchEvents = (self.pointerEvents != ABI40_0_0RCTPointerEventsNone && ![self isHidden]);
...
- (void)mergeProperties:(__kindof ABI40_0_0RNSVGRenderable *)target
{
