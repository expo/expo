...
@class ABI40_0_0RNCWebView;

@protocol ABI40_0_0RNCWebViewDelegate <NSObject>

- (BOOL)webView:(ABI40_0_0RNCWebView *_Nonnull)webView
   shouldStartLoadForRequest:(NSMutableDictionary<NSString *, id> *_Nonnull)request
   withCallback:(ABI40_0_0RCTDirectEventBlock _Nonnull)callback;

@end

@interface ABI40_0_0RNCWeakScriptMessageDelegate : NSObject<WKScriptMessageHandler>
