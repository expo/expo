//
//  ABI40_0_0AIRGoogleMapWMSTile.h
//  AirMaps
//
...
@interface ABI40_0_0WMSTileOverlay : GMSSyncTileLayer
...
@interface ABI40_0_0AIRGoogleMapWMSTile : UIView
@property (nonatomic, strong) ABI40_0_0WMSTileOverlay *tileLayer;
