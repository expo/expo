//
//  ABI40_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI40_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI40_0_0RNGestureHandler *otherHandler = [ABI40_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI40_0_0RCTTouchHandler class]];
}
