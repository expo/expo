...
#if __has_include(<ABI40_0_0React/ABI40_0_0UIView+React.h>)
...
@implementation ABI40_0_0EXContainerView {
...
- (void)ABI40_0_0ReactSetFrame:(CGRect)frame
{
  ...
  if (_animationView != nil) {
    [_animationView ABI40_0_0ReactSetFrame:frame];
  }
}
...
- (void)replaceAnimationView:(LOTAnimationView *)next {
  ...
  [_animationView ABI40_0_0ReactSetFrame:self.frame];
