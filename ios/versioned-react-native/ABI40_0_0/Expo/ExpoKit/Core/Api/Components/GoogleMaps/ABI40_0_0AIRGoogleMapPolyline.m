//
//  ABI40_0_0AIRGoogleMapPolyline.m
//
...
#import "ABI40_0_0AIRGMSPolyline.h"
...
@implementation ABI40_0_0AIRGoogleMapPolyline

- (instancetype)init
{
  if (self = [super init]) {
    _polyline = [[ABI40_0_0AIRGMSPolyline alloc] init];
  }
  return self;
}

-(void)setCoordinates:(NSArray<ABI40_0_0AIRMapCoordinate *> *)coordinates
{
