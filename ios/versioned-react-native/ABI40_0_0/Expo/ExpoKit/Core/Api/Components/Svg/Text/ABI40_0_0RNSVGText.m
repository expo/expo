...
@implementation ABI40_0_0RNSVGText
{
...
- (void)setInlineSize:(ABI40_0_0RNSVGLength *)inlineSize
{
...
- (void)setTextLength:(ABI40_0_0RNSVGLength *)textLength
{
...
- (void)setDeltaX:(NSArray<ABI40_0_0RNSVGLength *> *)deltaX
{
    if (deltaX == _deltaX) {
        return;
    }
...
- (void)setDeltaY:(NSArray<ABI40_0_0RNSVGLength *> *)deltaY
{
    if (deltaY == _deltaY) {
        return;
    }
...
- (void)setPositionX:(NSArray<ABI40_0_0RNSVGLength *>*)positionX
{
...
- (void)setPositionY:(NSArray<ABI40_0_0RNSVGLength *>*)positionY
{
...
- (void)setRotate:(NSArray<ABI40_0_0RNSVGLength *> *)rotate
{
    if (rotate == _rotate) {
        return;
    }
...
- (void)setupGlyphContext:(CGContextRef)context
{
    ...
    _glyphContext = [[ABI40_0_0RNSVGGlyphContext alloc] initWithWidth:size.width
                                                      height:size.height];
}
...
- (ABI40_0_0RNSVGText *)textRoot
{
    ABI40_0_0RNSVGText *root = self;
    while (root && [root class] != [ABI40_0_0RNSVGText class]) {
        if (![root isKindOfClass:[ABI40_0_0RNSVGText class]]) {
            //todo: throw exception here
            break;
        }
        root = (ABI40_0_0RNSVGText*)[root superview];
    }
...
- (NSString *)alignmentBaseline
{
    ...
    while (parent != nil) {
        if ([parent isKindOfClass:[ABI40_0_0RNSVGText class]]) {
            ABI40_0_0RNSVGText* node = (ABI40_0_0RNSVGText*)parent;
    ...
    if (_alignmentBaseline == nil) {
        _alignmentBaseline = ABI40_0_0RNSVGAlignmentBaselineStrings[0];
    }
    return _alignmentBaseline;
}
...
- (ABI40_0_0RNSVGText*)getTextAnchorRoot
{
    ABI40_0_0RNSVGGlyphContext* gc = [self.textRoot getGlyphContext];
    NSArray* font = [gc getFontContext];
    ABI40_0_0RNSVGText* node = self;
    UIView* parent = [self superview];
    for (NSInteger i = [font count] - 1; i >= 0; i--) {
        ABI40_0_0RNSVGFontData* fontData = [font objectAtIndex:i];
        if (![parent isKindOfClass:[ABI40_0_0RNSVGText class]] ||
            fontData->textAnchor == ABI40_0_0RNSVGTextAnchorStart ||
            node.positionX != nil) {
            return node;
        }
        node = (ABI40_0_0RNSVGText*) parent;
