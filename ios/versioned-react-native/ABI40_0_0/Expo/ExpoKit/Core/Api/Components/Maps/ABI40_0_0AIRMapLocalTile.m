...
#import "ABI40_0_0AIRMapLocalTileOverlay.h"

@implementation ABI40_0_0AIRMapLocalTile {
...
- (void) createTileOverlayAndRendererIfPossible
{
    ...
    self.tileOverlay = [[ABI40_0_0AIRMapLocalTileOverlay alloc] initWithURLTemplate:self.pathTemplate];
