...
#import "ABI40_0_0RNSVGBrushType.h"
#import "ABI40_0_0RNSVGNode.h"

@implementation ABI40_0_0RNSVGPattern
...
{
    self.dirty = false;
    NSArray<ABI40_0_0RNSVGLength *> *points = @[self.x, self.y, self.patternwidth, self.patternheight];
...
- (void)setPatternwidth:(ABI40_0_0RNSVGLength *)patternwidth
{
...
- (void)setPatternheight:(ABI40_0_0RNSVGLength *)patternheight
{
...
- (void)setPatternUnits:(ABI40_0_0RNSVGUnits)patternUnits
{
...
- (void)setPatternContentUnits:(ABI40_0_0RNSVGUnits)patternContentUnits
{
