/**
 * Copyright (c) 2015-present, ABI40_0_0React-native-community.
 * All rights reserved.
 *
...
#import "ABI40_0_0RNSVGContextBrush.h"
...
@implementation ABI40_0_0RNSVGContextBrush
{
    BOOL _isStroke;
}
...
{
    ABI40_0_0RNSVGRenderable *element = ABI40_0_0RNSVGRenderable.contextElement;
    if (!element) {
        return NO;
    }

    ABI40_0_0RNSVGBrush *brush = _isStroke ? element.stroke : element.fill;

    BOOL fillColor;

    if (brush.class == ABI40_0_0RNSVGBrush.class) {
