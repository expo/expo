...
#import "ABI40_0_0RNSVGClipPath.h"
#import "ABI40_0_0RNSVGMask.h"
#import "ABI40_0_0RNSVGNode.h"

@implementation ABI40_0_0RNSVGForeignObject
...
- (void)renderGroupTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    [self traverseSubviews:^(UIView *node) {
        if ([node isKindOfClass:[ABI40_0_0RNSVGMask class]] || [node isKindOfClass:[ABI40_0_0RNSVGClipPath class]]) {
            // no-op
        } else if ([node isKindOfClass:[ABI40_0_0RNSVGNode class]]) {
            ABI40_0_0RNSVGNode* svgNode = (ABI40_0_0RNSVGNode*)node;
            ...
            if ([node isKindOfClass:[ABI40_0_0RNSVGRenderable class]]) {
                [(ABI40_0_0RNSVGRenderable*)node mergeProperties:self];
            }
            ...
            if ([node isKindOfClass:[ABI40_0_0RNSVGRenderable class]]) {
                [(ABI40_0_0RNSVGRenderable*)node resetProperties];
            }
        } else if ([node isKindOfClass:[ABI40_0_0RNSVGSvgView class]]) {
            ABI40_0_0RNSVGSvgView* svgView = (ABI40_0_0RNSVGSvgView*)node;
...
- (void)setForeignObjectwidth:(ABI40_0_0RNSVGLength *)foreignObjectwidth
{
...
- (void)setForeignObjectheight:(ABI40_0_0RNSVGLength *)foreignObjectheight
{
