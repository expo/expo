...
#import "ABI40_0_0AIRGMSMarker.h"
...
@interface ABI40_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI40_0_0AIRGMSMarker*)marker;
@end

@implementation ABI40_0_0AIRGoogleMapMarker {
  ABI40_0_0RCTImageLoaderCancellationBlock _reloadImageCancellationBlock;
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI40_0_0AIRGMSMarker alloc] init];
...
- (void)insertABI40_0_0ReactSubview:(id<ABI40_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI40_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI40_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI40_0_0AIRDummyView *dummySubview = [[ABI40_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertABI40_0_0ReactSubview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeABI40_0_0ReactSubview:(id<ABI40_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI40_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeABI40_0_0ReactSubview:(UIView*)dummySubview];
}
...
- (void)didTapInfoWindowOfMarker:(ABI40_0_0AIRGMSMarker *)marker point:(CGPoint)point frame:(CGRect)frame {
...
- (void)didTapInfoWindowOfMarker:(ABI40_0_0AIRGMSMarker *)marker {
    [self didTapInfoWindowOfMarker:marker point:CGPointMake(-1, -1) frame:CGRectZero];
}

- (void)didTapInfoWindowOfMarker:(ABI40_0_0AIRGMSMarker *)marker subview:(ABI40_0_0AIRGoogleMapCalloutSubview*)subview point:(CGPoint)point frame:(CGRect)frame {
...
- (void)didBeginDraggingMarker:(ABI40_0_0AIRGMSMarker *)marker {
  if (!self.onDragStart) return;
  self.onDragStart([self eventFromMarker:marker]);
}

- (void)didEndDraggingMarker:(ABI40_0_0AIRGMSMarker *)marker {
  if (!self.onDragEnd) return;
  self.onDragEnd([self eventFromMarker:marker]);
}

- (void)didDragMarker:(ABI40_0_0AIRGMSMarker *)marker {
...
- (void)setOnPress:(ABI40_0_0RCTBubblingEventBlock)onPress {
  _realMarker.onPress = onPress;
}

- (ABI40_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/ABI40_0_0React-native-community/ABI40_0_0React-native-maps/issues/738)
  ...
  _reloadImageCancellationBlock = [[_bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI40_0_0RCTConvert NSURLRequest:_imageSrc]
                                                                          size:self.bounds.size
                                                                         scale:ABI40_0_0RCTScreenScale()
                                                                       clipped:YES
                                                                    resizeMode:ABI40_0_0RCTResizeModeCenter
                                                                 progressBlock:nil
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI40_0_0RN?
...
- (void)setIconSrc:(NSString *)iconSrc
{
  ...
  _reloadImageCancellationBlock =
  [[_bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI40_0_0RCTConvert NSURLRequest:_iconSrc]
                                          size:self.bounds.size
                                         scale:ABI40_0_0RCTScreenScale()
                                       clipped:YES
                                    resizeMode:ABI40_0_0RCTResizeModeCenter
