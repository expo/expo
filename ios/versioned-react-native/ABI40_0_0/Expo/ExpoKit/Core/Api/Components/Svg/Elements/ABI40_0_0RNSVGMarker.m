...
@implementation ABI40_0_0RNSVGMarker
...
- (void)setX:(ABI40_0_0RNSVGLength *)refX
{
...
- (void)setY:(ABI40_0_0RNSVGLength *)refY
{
...
- (void)setMarkerWidth:(ABI40_0_0RNSVGLength *)markerWidth
{
...
- (void)setMarkerHeight:(ABI40_0_0RNSVGLength *)markerHeight
{
...
static CGFloat ABI40_0_0RNSVG_degToRad = (CGFloat)M_PI / 180;

double ABI40_0_0deg2rad(CGFloat deg) {
    return deg * ABI40_0_0RNSVG_degToRad;
}
...
- (void)renderMarker:(CGContextRef)context rect:(CGRect)rect position:(ABI40_0_0RNSVGMarkerPosition*)position strokeWidth:(CGFloat)strokeWidth
{
    ...
    float rad = ABI40_0_0deg2rad(angle);
