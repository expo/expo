...
#import "ABI40_0_0RNTapHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI40_0_0React/ABI40_0_0RCTConvert.h>

// ABI40_0_0RNBetterTapGestureRecognizer extends UIGestureRecognizer instead of UITapGestureRecognizer 
...
@interface ABI40_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
- (id)initWithGestureHandler:(ABI40_0_0RNGestureHandler*)gestureHandler;

@end

@implementation ABI40_0_0RNBetterTapGestureRecognizer {
  __weak ABI40_0_0RNGestureHandler *_gestureHandler;
...
@implementation ABI40_0_0RNTapGestureHandler {
    ABI40_0_0RNGestureHandlerEventExtraData * _lastData;
}

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI40_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI40_0_0RNBetterTapGestureRecognizer *recognizer = (ABI40_0_0RNBetterTapGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    recognizer.maxDelay = [ABI40_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDurationMs"];
  if (prop != nil) {
    recognizer.maxDuration = [ABI40_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDist"];
  if (prop != nil) {
    CGFloat dist = [ABI40_0_0RCTConvert CGFloat:prop];
