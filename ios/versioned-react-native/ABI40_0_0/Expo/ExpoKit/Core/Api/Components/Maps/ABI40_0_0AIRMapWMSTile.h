...
@interface ABI40_0_0AIRMapWMSTile : MKAnnotationView <MKOverlay>

@property (nonatomic, weak) ABI40_0_0AIRMap *map;
...
@interface ABI40_0_0TileOverlay : MKTileOverlay
