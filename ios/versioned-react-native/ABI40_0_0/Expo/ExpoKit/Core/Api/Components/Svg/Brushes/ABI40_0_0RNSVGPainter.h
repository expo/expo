...
@class ABI40_0_0RNSVGPattern;

@interface ABI40_0_0RNSVGPainter : NSObject

@property (nonatomic, assign) ABI40_0_0RNSVGPattern* pattern;
@property (nonatomic, assign) CGRect paintBounds;
@property (nonatomic, assign) bool useObjectBoundingBoxForContentUnits;
@property (nonatomic, assign) CGRect bounds;

- (instancetype)initWithPointsArray:(NSArray<ABI40_0_0RNSVGLength *> *)pointsArray NS_DESIGNATED_INITIALIZER;

- (void)paint:(CGContextRef)context bounds:(CGRect)bounds;

- (void)setUnits:(ABI40_0_0RNSVGUnits)unit;

- (void)setContentUnits:(ABI40_0_0RNSVGUnits)unit;
