...
class Scheduler {
  public:
    ...
    void setJSCallInvoker(std::shared_ptr<ABI40_0_0facebook::ABI40_0_0React::CallInvoker> jsCallInvoker);
  ...
  protected:
    ...
    std::shared_ptr<ABI40_0_0facebook::ABI40_0_0React::CallInvoker> jsCallInvoker_;
