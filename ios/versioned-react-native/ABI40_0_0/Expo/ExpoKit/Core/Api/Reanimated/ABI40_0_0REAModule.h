...
extern ABI40_0_0RCTBridge *ABI40_0_0_bridge_reanimated;

@interface ABI40_0_0REAModule : ABI40_0_0RCTEventEmitter <ABI40_0_0RCTBridgeModule, ABI40_0_0RCTEventDispatcherObserver, ABI40_0_0RCTUIManagerObserver>

@property (nonatomic, readonly) ABI40_0_0REANodesManager *nodesManager;
