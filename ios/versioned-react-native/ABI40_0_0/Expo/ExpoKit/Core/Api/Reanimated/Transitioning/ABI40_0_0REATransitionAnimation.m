...
CGFloat ABI40_0_0SimAnimationDragCoefficient()
{
#if TARGET_IPHONE_SIMULATOR
...
@implementation ABI40_0_0REATransitionAnimation {
  NSTimeInterval _delay;
}

+ (ABI40_0_0REATransitionAnimation *)transitionWithAnimation:(CAAnimation *)animation
                                              layer:(CALayer *)layer
                                         andKeyPath:(NSString*)keyPath;
{
  ABI40_0_0REATransitionAnimation *anim = [ABI40_0_0REATransitionAnimation new];
...
- (void)play
{
  ...
  */
  if (_delay > 0){
    _animation.beginTime = CACurrentMediaTime() + _delay * ABI40_0_0SimAnimationDragCoefficient();
  }
  _animation.duration = self.duration * ABI40_0_0SimAnimationDragCoefficient();
