...
#import "ABI40_0_0REAAllTransitions.h"
#import "ABI40_0_0RCTConvert+REATransition.h"

@interface ABI40_0_0REASnapshotRemover : NSObject <CAAnimationDelegate>
@end

@implementation ABI40_0_0REASnapshotRemover {
  UIView *_view;
}
...
@implementation ABI40_0_0REATransitionGroup

- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
    _sequence = [ABI40_0_0RCTConvert BOOL:config[@"sequence"]];
    NSArray *transitions = [ABI40_0_0RCTConvert NSArray:config[@"transitions"]];
    NSMutableArray<ABI40_0_0REATransition*> *inflated = [NSMutableArray new];
    for (NSDictionary *transitionConfig in transitions) {
      [inflated addObject:[ABI40_0_0REATransition inflate:transitionConfig]];
                                                             ...
                                                             forRoot:(UIView *)root
{
  ...
  for (ABI40_0_0REATransition *transition in _transitions) {
    ...
    for (ABI40_0_0REATransitionAnimation *anim in subanims) {
      [anim delayBy:delay];
...
@implementation ABI40_0_0REAVisibilityTransition

- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
    _animationType = [ABI40_0_0RCTConvert ABI40_0_0REATransitionAnimationType:config[@"animation"]];
  }
  return self;
}

- (ABI40_0_0REATransitionAnimation *)appearView:(UIView *)view
...
- (ABI40_0_0REATransitionAnimation *)disappearView:(UIView *)view
                                                 ...
                                                 forRoot:(UIView *)root
{
  ...
  if (isViewAppearing && !IS_LAYOUT_ONLY(endValues.view)) {
    NSNumber *parentKey = endValues.ABI40_0_0ReactParent.ABI40_0_0ReactTag;
    ABI40_0_0REATransitionValues *parentStartValues = [self findStartValuesForKey:parentKey];
    ABI40_0_0REATransitionValues *parentEndValues = [self findEndValuesForKey:parentKey];
  ...
  if (endValues == nil && !IS_LAYOUT_ONLY(startValues.view) && startValues.ABI40_0_0ReactParent.window != nil) {
    startValues.view.center = startValues.centerInABI40_0_0ReactParent;
    return [self disappearView:startValues.view fromParent:startValues.ABI40_0_0ReactParent forRoot:root];
  }
  return nil;
}
...
@implementation ABI40_0_0REAInTransition
- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
  }
                                  ...
                                  forRoot:(UIView *)root
{
  ...
  switch (self.animationType) {
    case ABI40_0_0REATransitionAnimationTypeNone:
      return nil;
    case ABI40_0_0REATransitionAnimationTypeFade: {
    ...
    case ABI40_0_0REATransitionAnimationTypeScale: {
    ...
    case ABI40_0_0REATransitionAnimationTypeSlideTop:
    case ABI40_0_0REATransitionAnimationTypeSlideBottom:
    case ABI40_0_0REATransitionAnimationTypeSlideLeft:
    case ABI40_0_0REATransitionAnimationTypeSlideRight: {
  ...
  return [ABI40_0_0REATransitionAnimation transitionWithAnimation:animation layer:view.layer andKeyPath:animation.keyPath];
}
@end


@implementation ABI40_0_0REAOutTransition
- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
  }
...
- (ABI40_0_0REATransitionAnimation *)disappearView:(UIView *)view
                               fromParent:(UIView *)parent
                                  forRoot:(UIView *)root
{
  if (self.animationType == ABI40_0_0REATransitionAnimationTypeNone) {
    return nil;
  }
  ...
  animation.fillMode = kCAFillModeBackwards;
  animation.delegate = [[ABI40_0_0REASnapshotRemover alloc] initWithView:snapshotView];

  return [ABI40_0_0REATransitionAnimation transitionWithAnimation:animation layer:snapshot andKeyPath:animation.keyPath];
}
@end


@implementation ABI40_0_0REAChangeTransition
                                                 ...
                                                 forRoot:(UIView *)root
{
  ...
  return [ABI40_0_0REATransitionAnimation transitionWithAnimation:group layer:layer andKeyPath:nil];
}
@end
