...
@interface ABI40_0_0RNCAppearanceProvider ()

@property (nonatomic, weak) ABI40_0_0RCTBridge *bridge;

@end

@implementation ABI40_0_0RNCAppearanceProvider
...
- (void)notifyUserInterfaceStyleChanged
{
  ...
  if (self.bridge) {
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ABI40_0_0RNCUserInterfaceStyleDidChangeNotification"
                                                        object:self.bridge
