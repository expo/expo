...
BOOL ABI40_0_0UIEdgeInsetsEqualToEdgeInsetsWithThreshold(UIEdgeInsets insets1, UIEdgeInsets insets2, CGFloat threshold)
{
...
{
  UIViewController* vc = self.ABI40_0_0ReactViewController;
