...
#import "ABI40_0_0EXSyncBinding.h"

NS_ASSUME_NONNULL_BEGIN

@interface ABI40_0_0EXSyncBinding ()

@property (nonatomic, strong) NSString *experienceId;
@property (nonatomic, weak) id<ABI40_0_0EXSyncBindingDelegate> updatesKernelService;
@property (nonatomic, weak) id<ABI40_0_0EXSyncDatabaseBindingDelegate> databaseKernelService;

@end

@implementation ABI40_0_0EXSyncBinding : ABI40_0_0EXSyncService
