...
#if !TARGET_OS_TV
@implementation ABI40_0_0RCTConvert (ABI40_0_0EXStatusBar)

ABI40_0_0RCT_ENUM_CONVERTER(UIStatusBarStyle, (@{
  @"default": @(UIStatusBarStyleDefault),
  @"light-content": @(UIStatusBarStyleLightContent),
  @"dark-content": @(UIStatusBarStyleDefault),
}), UIStatusBarStyleDefault, integerValue);

ABI40_0_0RCT_ENUM_CONVERTER(UIStatusBarAnimation, (@{
...
@interface ABI40_0_0EXStatusBarManager ()

@property (nonatomic, strong) NSMutableDictionary *capturedStatusBarProperties;

@end

@implementation ABI40_0_0EXStatusBarManager

+ (NSString *)moduleName { return @"ABI40_0_0RCTStatusBarManager"; }
...
ABI40_0_0RCT_EXPORT_METHOD(setStyle:(UIStatusBarStyle)statusBarStyle
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ABI40_0_0RCTSharedApplication() setStatusBarStyle:statusBarStyle
                                     animated:animated];
...
ABI40_0_0RCT_EXPORT_METHOD(setHidden:(BOOL)hidden
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ABI40_0_0RCTSharedApplication() setStatusBarHidden:hidden
 ...
 */
ABI40_0_0RCT_REMAP_METHOD(_captureProperties,
                 _capturePropertiesWithResolver:(ABI40_0_0RCTPromiseResolveBlock)resolve
 ...
 *  Normally nobody should use this method because it bypasses the JS state used by the StatusBar component.
 */
ABI40_0_0RCT_EXPORT_METHOD(_applyPropertiesAndForget:(NSDictionary *)properties)
{
...
{
  UIApplication *currentApplication = ABI40_0_0RCTSharedApplication();
  return @{
