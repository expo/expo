...
@implementation ABI40_0_0EXDisabledDevLoadingView {
  BOOL _isObserving;
}

+ (NSString *)moduleName { return @"ABI40_0_0RCTDevLoadingView"; }


ABI40_0_0RCT_EXPORT_METHOD(hide)
{
  ABI40_0_0RCTDevSettings *settings = [[super bridge] devSettings];
...
ABI40_0_0RCT_EXPORT_METHOD(showMessage:(NSString *)message color:(UIColor *)color backgroundColor:(UIColor *)backgroundColor)
{
  ABI40_0_0RCTDevSettings *settings = [[super bridge] devSettings];
  BOOL isFastRefreshEnabled = [settings isHotLoadingEnabled];
  if (_isObserving && isFastRefreshEnabled) {
