...
#import "ABI40_0_0EXScopedEventEmitter.h"

@implementation ABI40_0_0EXScopedEventEmitter

+ (NSString *)moduleName
{
  NSAssert(NO, @"ABI40_0_0EXScopedEventEmitter is abstract, you should only export subclasses to the bridge.");
