...
@interface ABI40_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) id<ABI40_0_0UMCameraInterface> camera;
...
@implementation ABI40_0_0EXGLCameraObject
