...
@implementation ABI40_0_0EXAdsDFPBannerView {
  DFPBannerView *_bannerView;
  id<ABI40_0_0UMEventEmitterService> _eventEmitter;
}
...
- (void)setOnSizeChange:(ABI40_0_0UMDirectEventBlock)block
{
  _onSizeChange = block;
  [self loadBanner];
}

- (void)setOnDidFailToReceiveAdWithError:(ABI40_0_0UMDirectEventBlock)block
{
