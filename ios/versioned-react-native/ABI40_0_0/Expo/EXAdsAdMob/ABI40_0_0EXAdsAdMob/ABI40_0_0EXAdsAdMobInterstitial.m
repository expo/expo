...
#import <ABI40_0_0EXAdsAdMob/ABI40_0_0EXAdsAdMobInterstitial.h>

static NSString *const ABI40_0_0EXAdsAdMobInterstitialDidLoad = @"interstitialDidLoad";
static NSString *const ABI40_0_0EXAdsAdMobInterstitialDidFailToLoad = @"interstitialDidFailToLoad";
static NSString *const ABI40_0_0EXAdsAdMobInterstitialDidOpen = @"interstitialDidOpen";
static NSString *const ABI40_0_0EXAdsAdMobInterstitialDidClose = @"interstitialDidClose";
static NSString *const ABI40_0_0EXAdsAdMobInterstitialWillLeaveApplication = @"interstitialWillLeaveApplication";

@interface ABI40_0_0EXAdsAdMobInterstitial ()
...
@implementation ABI40_0_0EXAdsAdMobInterstitial {
...
ABI40_0_0UM_EXPORT_MODULE(ExpoAdsAdMobInterstitialManager);
...
{
  return @[
           ABI40_0_0EXAdsAdMobInterstitialDidLoad,
           ABI40_0_0EXAdsAdMobInterstitialDidFailToLoad,
           ABI40_0_0EXAdsAdMobInterstitialDidOpen,
           ABI40_0_0EXAdsAdMobInterstitialDidClose,
           ABI40_0_0EXAdsAdMobInterstitialWillLeaveApplication,
           ];
}
...
- (void)interstitialDidReceiveAd:(GADInterstitial *)ad {
  [self _maybeSendEventWithName:ABI40_0_0EXAdsAdMobInterstitialDidLoad body:nil];
  _requestAdResolver(nil);
  [self _cleanupRequestAdPromise];
}

- (void)interstitial:(GADInterstitial *)interstitial didFailToReceiveAdWithError:(GADRequestError *)error {
  [self _maybeSendEventWithName:ABI40_0_0EXAdsAdMobInterstitialDidFailToLoad body:@{ @"name": [error description] }];
...
- (void)interstitialWillPresentScreen:(GADInterstitial *)ad {
  [self _maybeSendEventWithName:ABI40_0_0EXAdsAdMobInterstitialDidOpen body:nil];
  _showAdResolver(nil);
  _showAdResolver = nil;
}

- (void)interstitialDidDismissScreen:(GADInterstitial *)ad {
  [self _maybeSendEventWithName:ABI40_0_0EXAdsAdMobInterstitialDidClose body:nil];
}

- (void)interstitialWillLeaveApplication:(GADInterstitial *)ad {
  [self _maybeSendEventWithName:ABI40_0_0EXAdsAdMobInterstitialWillLeaveApplication body:nil];
}
