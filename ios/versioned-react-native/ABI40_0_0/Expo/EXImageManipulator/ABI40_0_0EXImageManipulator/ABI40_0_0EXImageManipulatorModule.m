...
#import <ABI40_0_0EXImageManipulator/ABI40_0_0EXImageManipulatorModule.h>
...
@interface ABI40_0_0EXImageManipulatorModule ()
...
@implementation ABI40_0_0EXImageManipulatorModule

ABI40_0_0UM_EXPORT_MODULE(ExpoImageManipulator);
...
ABI40_0_0UM_EXPORT_METHOD_AS(manipulateAsync,
                    uri:(NSString *)uri
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (!([_fileSystem permissionsForURI:url] & ABI40_0_0UMFileSystemPermissionRead)) {
