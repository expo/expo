...
@implementation ABI40_0_0EXScreenCaptureModule {
  UIView *_blockView;
}

ABI40_0_0UM_EXPORT_MODULE(ExpoScreenCapture);
...
ABI40_0_0UM_EXPORT_METHOD_AS(preventScreenCapture,
                    preventScreenCaptureWithResolver:(ABI40_0_0UMPromiseResolveBlock)resolve
...
ABI40_0_0UM_EXPORT_METHOD_AS(allowScreenCapture,
                    allowScreenCaptureWithResolver:(ABI40_0_0UMPromiseResolveBlock)resolve
