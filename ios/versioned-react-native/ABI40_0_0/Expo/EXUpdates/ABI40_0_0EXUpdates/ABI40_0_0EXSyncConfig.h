...
typedef NS_ENUM(NSInteger, ABI40_0_0EXSyncCheckAutomaticallyConfig) {
  ABI40_0_0EXSyncCheckAutomaticallyConfigAlways = 0,
  ABI40_0_0EXSyncCheckAutomaticallyConfigWifiOnly = 1,
  ABI40_0_0EXSyncCheckAutomaticallyConfigNever = 2
};

@interface ABI40_0_0EXSyncConfig : NSObject
...
@property (nonatomic, readonly) ABI40_0_0EXSyncCheckAutomaticallyConfig checkOnLaunch;
