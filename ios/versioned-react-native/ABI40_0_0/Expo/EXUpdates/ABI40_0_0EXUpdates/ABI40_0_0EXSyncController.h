...
#import <ABI40_0_0EXUpdates/ABI40_0_0EXSyncLoaderTask.h>
...
@class ABI40_0_0EXSyncController;

@protocol ABI40_0_0EXSyncControllerDelegate <NSObject>

- (void)appController:(ABI40_0_0EXSyncController *)appController didStartWithSuccess:(BOOL)success;

@end

@interface ABI40_0_0EXSyncController : NSObject <ABI40_0_0EXSyncLoaderTaskDelegate>

/**
 Delegate which will be notified when ABI40_0_0EXUpdates has an update ready to launch and
 `launchAssetUrl` is nonnull.
 */
@property (nonatomic, weak) id<ABI40_0_0EXSyncControllerDelegate> delegate;

/**
 The ABI40_0_0RCTBridge for which ABI40_0_0EXUpdates is providing the JS bundle and assets.
...
/**
 The URL on disk to source asset for the ABI40_0_0RCTBridge.
 Will be null until the ABI40_0_0EXSyncController delegate method is called.
 This should be provided in the `sourceURLForBridge:` method of ABI40_0_0RCTBridgeDelegate.
 */
...
/**
 ...
 can be used by `expo-asset` or a similar module to override ABI40_0_0React Native's asset resolution and
...
/**
 for internal use in ABI40_0_0EXUpdates
 */
...
/**
 ...
 shared instance of ABI40_0_0EXSyncController.
 */
