...
static NSString * const ABI40_0_0EXUpdatesDatabaseUtilsErrorDomain = @"ABI40_0_0EXUpdatesDatabase";

@implementation ABI40_0_0EXUpdatesDatabaseUtils
...
+ (NSError *)errorFromSqlite:(struct sqlite3 *)db
{
  ...
  return [NSError errorWithDomain:ABI40_0_0EXUpdatesDatabaseUtilsErrorDomain
                             code:extendedCode
