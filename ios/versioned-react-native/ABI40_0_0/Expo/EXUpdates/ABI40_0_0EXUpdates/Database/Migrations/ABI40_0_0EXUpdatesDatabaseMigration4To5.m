...
static NSString * const ABI40_0_0EXUpdatesDatabaseV4Filename = @"expo-v4.db";

@implementation ABI40_0_0EXUpdatesDatabaseMigration4To5

- (NSString *)filename
{
  return ABI40_0_0EXUpdatesDatabaseV4Filename;
}
