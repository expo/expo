...
/**
 * An ABI40_0_0EXUpdatesLauncherSelectionPolicy which chooses an update to launch based on the manifest filters
 ...
 */
@interface ABI40_0_0EXUpdatesLauncherSelectionPolicyFilterAware : NSObject <ABI40_0_0EXUpdatesLauncherSelectionPolicy>
