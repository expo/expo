...
@implementation ABI40_0_0EXUpdatesReaperSelectionPolicyFilterAware
...
- (NSArray<ABI40_0_0EXUpdatesUpdate *> *)updatesToDeleteWithLaunchedUpdate:(ABI40_0_0EXUpdatesUpdate *)launchedUpdate updates:(NSArray<ABI40_0_0EXUpdatesUpdate *> *)updates filters:(nullable NSDictionary *)filters
{
  ...
  ABI40_0_0EXUpdatesUpdate *nextNewestUpdate;
  ABI40_0_0EXUpdatesUpdate *nextNewestUpdateMatchingFilters;
  for (ABI40_0_0EXUpdatesUpdate *update in updates) {
    ...
    if ([launchedUpdate.commitTime compare:update.commitTime] == NSOrderedDescending) {
      ...
      if ([ABI40_0_0EXUpdatesSelectionPolicies doesUpdate:update matchFilters:filters] &&
