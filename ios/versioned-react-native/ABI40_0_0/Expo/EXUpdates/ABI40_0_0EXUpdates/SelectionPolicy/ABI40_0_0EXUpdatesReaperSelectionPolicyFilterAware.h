...
/**
 * An ABI40_0_0EXUpdatesReaperSelectionPolicy which chooses which updates to delete taking into account manifest filters
 ...
 */
@interface ABI40_0_0EXUpdatesReaperSelectionPolicyFilterAware : NSObject <ABI40_0_0EXUpdatesReaperSelectionPolicy>
