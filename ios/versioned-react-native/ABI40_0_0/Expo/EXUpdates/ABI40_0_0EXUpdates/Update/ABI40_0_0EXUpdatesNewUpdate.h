...
#import <ABI40_0_0EXRawManifests/ABI40_0_0EXUpdatesNewRawManifest.h>

NS_ASSUME_NONNULL_BEGIN

@interface ABI40_0_0EXUpdatesNewUpdate : NSObject

+ (ABI40_0_0EXUpdatesUpdate *)updateWithNewManifest:(ABI40_0_0EXUpdatesNewRawManifest *)manifest
