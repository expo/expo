...
@property (nonatomic, strong, readonly) ABI40_0_0EXRawManifestsRawManifest *rawManifest;
...
+ (ABI40_0_0EXRawManifestsRawManifest *)rawManifestForJSON:(NSDictionary *)manifestJSON;
