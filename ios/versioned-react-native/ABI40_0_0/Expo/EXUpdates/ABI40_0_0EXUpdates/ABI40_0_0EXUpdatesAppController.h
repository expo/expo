...
@class ABI40_0_0EXUpdatesAppController;

@protocol ABI40_0_0EXUpdatesAppControllerDelegate <NSObject>

- (void)appController:(ABI40_0_0EXUpdatesAppController *)appController didStartWithSuccess:(BOOL)success;

@end

@interface ABI40_0_0EXUpdatesAppController : NSObject <ABI40_0_0EXUpdatesAppLoaderTaskDelegate>

/**
 Delegate which will be notified when ABI40_0_0EXUpdates has an update ready to launch and
 `launchAssetUrl` is nonnull.
 */
@property (nonatomic, weak) id<ABI40_0_0EXUpdatesAppControllerDelegate> delegate;
...
/**
 ...
 Will be null until the ABI40_0_0EXUpdatesAppController delegate method is called.
