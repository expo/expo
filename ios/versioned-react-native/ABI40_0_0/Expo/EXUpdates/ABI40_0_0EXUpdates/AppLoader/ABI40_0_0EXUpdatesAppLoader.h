...
typedef void (^ABI40_0_0EXUpdatesAppLoaderAssetBlock) (ABI40_0_0EXUpdatesAsset *asset, NSUInteger successfulAssetCount, NSUInteger failedAssetCount, NSUInteger totalAssetCount);
