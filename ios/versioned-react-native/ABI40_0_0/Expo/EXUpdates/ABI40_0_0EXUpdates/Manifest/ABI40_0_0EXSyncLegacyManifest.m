...
static NSString * const ABI40_0_0EXSyncExpoAssetBaseUrl = @"https://d1wp6m56sqw74a.cloudfront.net/~assets/";
static NSString * const ABI40_0_0EXSyncExpoIoDomain = @"expo.io";
static NSString * const ABI40_0_0EXSyncExpHostDomain = @"exp.host";
static NSString * const ABI40_0_0EXSyncExpoTestDomain = @"expo.test";

@implementation ABI40_0_0EXSyncLegacyManifest
                                     ...
                                     database:(ABI40_0_0EXSyncDatabase *)database
{
  ...
  if ([[self class] isDevelopmentModeManifest:manifest]) {
    ...
    update.status = ABI40_0_0EXSyncManifestStatusDevelopment;
  } else {
    update.status = ABI40_0_0EXSyncManifestStatusPending;
  }
  ...
  NSString *bundleKey = [NSString stringWithFormat:@"bundle-%@", [ABI40_0_0EXSyncUtils sha256WithData:[(NSString *)bundleUrlString dataUsingEncoding:NSUTF8StringEncoding]]];
  ABI40_0_0EXSyncAsset *jsBundleAsset = [[ABI40_0_0EXSyncAsset alloc] initWithKey:bundleKey type:ABI40_0_0EXSyncEmbeddedBundleFileType];
  jsBundleAsset.url = bundleUrl;
  jsBundleAsset.isLaunchAsset = YES;
  jsBundleAsset.mainBundleFilename = ABI40_0_0EXSyncEmbeddedBundleFilename;
...
+ (NSURL *)bundledAssetBaseUrlWithManifest:(NSDictionary *)manifest config:(ABI40_0_0EXSyncConfig *)config
{
  ...
  if (!host ||
      [host containsString:ABI40_0_0EXSyncExpoIoDomain] ||
      [host containsString:ABI40_0_0EXSyncExpHostDomain] ||
      [host containsString:ABI40_0_0EXSyncExpoTestDomain]) {
    return [NSURL URLWithString:ABI40_0_0EXSyncExpoAssetBaseUrl];
  } else {
