...
NSString * const ABI40_0_0EXSyncEmbeddedManifestName = @"app";
NSString * const ABI40_0_0EXSyncEmbeddedManifestType = @"manifest";
NSString * const ABI40_0_0EXSyncEmbeddedBundleFilename = @"app";
NSString * const ABI40_0_0EXSyncEmbeddedBundleFileType = @"bundle";
NSString * const ABI40_0_0EXSyncBareEmbeddedBundleFilename = @"main";
NSString * const ABI40_0_0EXSyncBareEmbeddedBundleFileType = @"jsbundle";

static NSString * const ABI40_0_0EXSyncEmbeddedLoaderErrorDomain = @"ABI40_0_0EXSyncEmbeddedLoader";

@implementation ABI40_0_0EXSyncEmbeddedLoader
...
{
  static ABI40_0_0EXSyncManifest *embeddedManifest;
  static dispatch_once_t once;
  dispatch_once(&once, ^{
    if (!config.hasEmbeddedUpdate) {
      embeddedManifest = nil;
    } else if (!embeddedManifest) {
      NSString *path = [[NSBundle mainBundle] pathForResource:ABI40_0_0EXSyncEmbeddedManifestName ofType:ABI40_0_0EXSyncEmbeddedManifestType];
      ...
      if (!manifest) {
        ...
        embeddedManifest = [ABI40_0_0EXSyncManifest updateWithEmbeddedManifest:[mutableManifest copy]
                                                                config:config
                                                              database:database];
...
{
  ABI40_0_0EXSyncManifest *embeddedManifest = [[self class] embeddedManifestWithConfig:self.config
  ...
  if (embeddedManifest) {
    ...
    error([NSError errorWithDomain:ABI40_0_0EXSyncEmbeddedLoaderErrorDomain
                              code:1008
...
- (void)loadUpdateFromUrl:(NSURL *)url
                  success:(ABI40_0_0EXSyncLoaderSuccessBlock)success
                    error:(ABI40_0_0EXSyncLoaderErrorBlock)error
{
  @throw [NSException exceptionWithName:NSInternalInconsistencyException reason:@"Should not call ABI40_0_0EXSyncEmbeddedLoader#loadUpdateFromUrl" userInfo:nil];
}
