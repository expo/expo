...
@implementation ABI40_0_0EXAppleAuthenticationMappings
...
{
  return @{
           @"namePrefix": ABI40_0_0UMNullIfNil(nameComponents.namePrefix),
           @"givenName": ABI40_0_0UMNullIfNil(nameComponents.givenName),
           @"middleName": ABI40_0_0UMNullIfNil(nameComponents.middleName),
           @"familyName": ABI40_0_0UMNullIfNil(nameComponents.familyName),
           @"nameSuffix": ABI40_0_0UMNullIfNil(nameComponents.nameSuffix),
           @"nickname": ABI40_0_0UMNullIfNil(nameComponents.nickname)
           };
}
