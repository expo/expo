...
#import <ABI40_0_0EXSensors/ABI40_0_0EXPedometer.h>
...
NSString * const ABI40_0_0EXPedometerUpdateEventName = @"Exponent.pedometerUpdate";
NSString * const ABI40_0_0EXPedometerModuleName = @"ExponentPedometer";

@interface ABI40_0_0EXPedometer () <ABI40_0_0UMAppLifecycleListener>
...
@implementation ABI40_0_0EXPedometer
...
{
  if (self = [super init]) {
    __weak ABI40_0_0EXPedometer *weakSelf = self;
    _watchHandler = ^(CMPedometerData * _Nullable pedometerData, NSError * _Nullable error) {
      ...
      __strong ABI40_0_0EXPedometer *strongSelf = weakSelf;
      if (strongSelf) {
        __strong id<ABI40_0_0UMEventEmitterService> eventEmitter = strongSelf.eventEmitter;
        if (eventEmitter) {
          [eventEmitter sendEventWithName:ABI40_0_0EXPedometerUpdateEventName
...
{
  return ABI40_0_0EXPedometerModuleName;
}
...
{
  return @[ABI40_0_0EXPedometerUpdateEventName];
}
...
ABI40_0_0UM_EXPORT_METHOD_AS(getStepCountAsync,
...
ABI40_0_0UM_EXPORT_METHOD_AS(isAvailableAsync, isAvailableAsync:(ABI40_0_0UMPromiseResolveBlock)resolve rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
