...
#import <ABI40_0_0EXSpeech/ABI40_0_0EXSpeech.h>

@interface ABI40_0_0EXSpeechUtteranceWithId : AVSpeechUtterance
...
@implementation ABI40_0_0EXSpeechUtteranceWithId
...
@interface ABI40_0_0EXSpeech () <AVSpeechSynthesizerDelegate>
...
@implementation ABI40_0_0EXSpeech

ABI40_0_0UM_EXPORT_MODULE(ExponentSpeech)
...
{
  id<ABI40_0_0UMEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI40_0_0UMEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStarted" body:@{ @"id": ((ABI40_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didCancelSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI40_0_0UMEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI40_0_0UMEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStopped" body:@{ @"id": ((ABI40_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didFinishSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI40_0_0UMEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI40_0_0UMEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingDone" body:@{ @"id": ((ABI40_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}


ABI40_0_0UM_EXPORT_METHOD_AS(speak,
  ...
  AVSpeechUtterance *utterance = [[ABI40_0_0EXSpeechUtteranceWithId alloc] initWithString:text utteranceId:utteranceId];
...
ABI40_0_0UM_EXPORT_METHOD_AS(getVoices,
                    getVoices:(ABI40_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject) {
...
ABI40_0_0UM_EXPORT_METHOD_AS(stop,
                    stop:(ABI40_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject) {
  [_synthesizer stopSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI40_0_0UM_EXPORT_METHOD_AS(pause,
                    pause:(ABI40_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject) {
  [_synthesizer pauseSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI40_0_0UM_EXPORT_METHOD_AS(resume,
                    resume:(ABI40_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject) {
  [_synthesizer continueSpeaking];
  resolve(nil);
}

ABI40_0_0UM_EXPORT_METHOD_AS(isSpeaking,
                    isSpeaking:(ABI40_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject) {
