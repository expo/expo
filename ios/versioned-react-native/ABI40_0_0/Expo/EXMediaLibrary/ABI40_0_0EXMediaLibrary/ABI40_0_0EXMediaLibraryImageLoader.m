...
// Prior to ABI40_0_0React Native 0.61, it contained `ABI40_0_0RCTAssetsLibraryRequestHandler` that handles loading data from URLs
// with `assets-library://` or `ph://` schemes. Due to lean core project, it's been moved to `@ABI40_0_0React-native-community/cameraroll`
// and that made it impossible to render assets using URLs returned by MediaLibrary without installing CameraRoll.
// Because it's still a unimodule and we need to export bare ABI40_0_0React Native module, we should make sure ABI40_0_0React Native is installed.
#if __has_include(<ABI40_0_0React/ABI40_0_0RCTImageURLLoader.h>)

#import <Photos/Photos.h>
#import <ABI40_0_0React/ABI40_0_0RCTUtils.h>
#import <ABI40_0_0EXMediaLibrary/ABI40_0_0EXMediaLibraryImageLoader.h>

@implementation ABI40_0_0EXMediaLibraryImageLoader

ABI40_0_0RCT_EXPORT_MODULE()

#pragma mark - ABI40_0_0RCTImageURLLoader
