...
#import <ABI40_0_0EXMediaLibrary/ABI40_0_0EXMediaLibraryMediaLibraryWriteOnlyPermissionRequester.h>
...
NSString *const ABI40_0_0EXAssetMediaTypeAudio = @"audio";
NSString *const ABI40_0_0EXAssetMediaTypePhoto = @"photo";
NSString *const ABI40_0_0EXAssetMediaTypeVideo = @"video";
NSString *const ABI40_0_0EXAssetMediaTypeUnknown = @"unknown";
NSString *const ABI40_0_0EXAssetMediaTypeAll = @"all";

NSString *const ABI40_0_0EXMediaLibraryDidChangeEvent = @"mediaLibraryDidChange";

NSString *const ABI40_0_0EXMediaLibraryCachesDirectory = @"MediaLibrary";

NSString *const ABI40_0_0EXMediaLibraryShouldDownloadFromNetworkKey = @"shouldDownloadFromNetwork";

@interface ABI40_0_0EXMediaLibrary ()
...
@implementation ABI40_0_0EXMediaLibrary

ABI40_0_0UM_EXPORT_MODULE(ExponentMediaLibrary);
...
- (void)setModuleRegistry:(ABI40_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  [ABI40_0_0UMPermissionsMethodsDelegate registerRequesters:@[[ABI40_0_0EXMediaLibraryMediaLibraryPermissionRequester new], [ABI40_0_0EXMediaLibraryMediaLibraryWriteOnlyPermissionRequester new]] withPermissionsManager:_permissionsManager];
}
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"MediaType": @{
               @"audio": ABI40_0_0EXAssetMediaTypeAudio,
               @"photo": ABI40_0_0EXAssetMediaTypePhoto,
               @"video": ABI40_0_0EXAssetMediaTypeVideo,
               @"unknown": ABI40_0_0EXAssetMediaTypeUnknown,
               @"all": ABI40_0_0EXAssetMediaTypeAll,
               },
           @"SortBy": @{
               @"default": @"default",
           ...
           @"CHANGE_LISTENER_NAME": ABI40_0_0EXMediaLibraryDidChangeEvent,
           };
}

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI40_0_0EXMediaLibraryDidChangeEvent];
}

- (id)requesterClass:(BOOL)writeOnly
{
  if (writeOnly) {
    return [ABI40_0_0EXMediaLibraryMediaLibraryWriteOnlyPermissionRequester class];
  } else {
    return [ABI40_0_0EXMediaLibraryMediaLibraryPermissionRequester class];
  }
}
...
ABI40_0_0UM_EXPORT_METHOD_AS(presentPermissionsPickerAsync,
                    presentPermissionsPickerAsync:(ABI40_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
#ifdef __IPHONE_14_0
  if (@available(iOS 14, *)) {
...
ABI40_0_0UM_EXPORT_METHOD_AS(createAssetAsync,
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  PHAssetMediaType assetType = [ABI40_0_0EXMediaLibrary _assetTypeForUri:localUri];
  ...
  if (!([_fileSystem permissionsForURI:assetUrl] & ABI40_0_0UMFileSystemPermissionRead)) {
  ...
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    ...
    if (success) {
      PHAsset *asset = [ABI40_0_0EXMediaLibrary _getAssetById:assetPlaceholder.localIdentifier];
      resolve([ABI40_0_0EXMediaLibrary _exportAsset:asset]);
    } else {
...
ABI40_0_0UM_EXPORT_METHOD_AS(saveToLibraryAsync,
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI40_0_0EXSaveToLibraryDelegate *delegate = [ABI40_0_0EXSaveToLibraryDelegate new];
  [_saveToLibraryDelegates addObject:delegate];
  ABI40_0_0EXSaveToLibraryCallback callback = ^(id asset, NSError *error){
...
ABI40_0_0UM_EXPORT_METHOD_AS(addAssetsToAlbumAsync,
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    [ABI40_0_0EXMediaLibrary _addAssets:assetIds toAlbum:albumId withCallback:^(BOOL success, NSError *error) {
      if (error) {
...
ABI40_0_0UM_EXPORT_METHOD_AS(removeAssetsFromAlbumAsync,
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
      PHAssetCollection *collection = [ABI40_0_0EXMediaLibrary _getAlbumById:albumId];
      PHFetchResult *assets = [ABI40_0_0EXMediaLibrary _getAssetsByIds:assetIds];
...
ABI40_0_0UM_EXPORT_METHOD_AS(deleteAssetsAsync,
...
ABI40_0_0UM_EXPORT_METHOD_AS(getAlbumsAsync,
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    ...
    [albums addObjectsFromArray:[ABI40_0_0EXMediaLibrary _exportCollections:userAlbumsFetchResult withFetchOptions:fetchOptions inFolder:nil]];
    ...
    if ([options[@"includeSmartAlbums"] boolValue]) {
      ...
      [albums addObjectsFromArray:[ABI40_0_0EXMediaLibrary _exportCollections:smartAlbumsFetchResult withFetchOptions:fetchOptions inFolder:nil]];
    }
...
ABI40_0_0UM_EXPORT_METHOD_AS(getMomentsAsync,
                    getMoments:(ABI40_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  if (![self _checkPermissions:reject]) {
    return;
  ...
  NSArray<NSDictionary *> *albums = [ABI40_0_0EXMediaLibrary _exportCollections:fetchResult withFetchOptions:options inFolder:nil];
  
  resolve(albums);
}

ABI40_0_0UM_EXPORT_METHOD_AS(getAlbumAsync,
                    getAlbumWithTitle:(nonnull NSString *)title
                    resolve:(ABI40_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    PHAssetCollection *collection = [ABI40_0_0EXMediaLibrary _getAlbumWithTitle:title];
    resolve(ABI40_0_0UMNullIfNil([ABI40_0_0EXMediaLibrary _exportCollection:collection]));
  }];
}

ABI40_0_0UM_EXPORT_METHOD_AS(createAlbumAsync,
...
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    [ABI40_0_0EXMediaLibrary _createAlbumWithTitle:title completion:^(PHAssetCollection *collection, NSError *error) {
      if (collection) {
        if (assetId) {
          [ABI40_0_0EXMediaLibrary _addAssets:@[assetId] toAlbum:collection.localIdentifier withCallback:^(BOOL success, NSError *error) {
            if (success) {
              resolve(ABI40_0_0UMNullIfNil([ABI40_0_0EXMediaLibrary _exportCollection:collection]));
            } else {
...
ABI40_0_0UM_EXPORT_METHOD_AS(deleteAlbumsAsync,
...
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    PHFetchResult *collections = [ABI40_0_0EXMediaLibrary _getAlbumsById:albumIds];
    [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
      if (assetRemove) {
...
ABI40_0_0UM_EXPORT_METHOD_AS(getAssetInfoAsync,
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  PHAsset *asset = [ABI40_0_0EXMediaLibrary _getAssetById:assetId];
    
  BOOL shouldDownloadFromNetwork = [[options objectForKey:ABI40_0_0EXMediaLibraryShouldDownloadFromNetworkKey] boolValue] ?: YES;
  
  if (asset) {
    NSMutableDictionary *result = [ABI40_0_0EXMediaLibrary _exportAssetInfo:asset];
    if (asset.mediaType == PHAssetMediaTypeImage) {
      ...
      [[PHImageManager defaultManager] requestAVAssetForVideo:asset
        ...
        if ([asset isKindOfClass:[AVComposition class]]) {
            NSString *directory = [self.fileSystem.cachesDirectory stringByAppendingPathComponent:ABI40_0_0EXMediaLibraryCachesDirectory];
...
ABI40_0_0UM_EXPORT_METHOD_AS(getAssetsAsync,
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *createdAfter = [ABI40_0_0UMUtilities NSDate:options[@"createdAfter"]];
  NSDate *createdBefore = [ABI40_0_0UMUtilities NSDate:options[@"createdBefore"]];
  ...
  if (albumId) {
    [self _runIfAllPermissionsWereGranted:reject block:^{
      ...
      [ABI40_0_0EXMediaLibrary _getAssetsWithAfter:after
                                    first:first
                                mediaType:mediaType
                                   sortBy:sortBy
...
- (void)startObserving
{
  _allAssetsFetchResult = [ABI40_0_0EXMediaLibrary _getAllAssets];
    ...
    if (changeDetails != nil) {
      ...
      if (changeDetails.hasIncrementalChanges && (changeDetails.insertedObjects.count > 0 || changeDetails.removedObjects.count > 0)) {
        ...
        for (PHAsset *asset in changeDetails.insertedObjects) {
          [insertedAssets addObject:[ABI40_0_0EXMediaLibrary _exportAsset:asset]];
        }
        for (PHAsset *asset in changeDetails.removedObjects) {
          [deletedAssets addObject:[ABI40_0_0EXMediaLibrary _exportAsset:asset]];
        }
        for (PHAsset *asset in changeDetails.changedObjects) {
          [updatedAssets addObject:[ABI40_0_0EXMediaLibrary _exportAsset:asset]];
        }
        
        [_eventEmitter sendEventWithName:ABI40_0_0EXMediaLibraryDidChangeEvent body:body];
        return;
      }
      ...
      if (!changeDetails.hasIncrementalChanges) {
        [_eventEmitter sendEventWithName:ABI40_0_0EXMediaLibraryDidChangeEvent body:@{
                     ...
                     reject:(ABI40_0_0UMPromiseRejectBlock)reject
{
  ...
  PHAsset *cursor;
  if (after) {
    cursor = [ABI40_0_0EXMediaLibrary _getAssetById:after];
  ...
  if (mediaType && [mediaType count] > 0) {
    NSMutableArray<NSNumber *> *assetTypes = [ABI40_0_0EXMediaLibrary _convertMediaTypes:mediaType];
  ...
  if (sortBy && sortBy.count > 0) {
    fetchOptions.sortDescriptors = [ABI40_0_0EXMediaLibrary _prepareSortDescriptors:sortBy];
  }
  ...
  if (fetchOptions.sortDescriptors.count == 0) {
    ...
    for (NSInteger i = startIndex; i >= endIndex; i--) {
      ...
      [assets addObject:[ABI40_0_0EXMediaLibrary _exportAsset:asset]];
    }
...
{
  if (assetId) {
    return [ABI40_0_0EXMediaLibrary _getAssetsByIds:@[assetId]].firstObject;
  }
  return nil;
}
...
+ (void)_ensureAlbumWithTitle:(nonnull NSString *)title completion:(void(^)(PHAssetCollection *collection, NSError *error))completion
{
  ...
  [ABI40_0_0EXMediaLibrary _createAlbumWithTitle:title completion:completion];
}
...
+ (NSDictionary *)_exportAsset:(PHAsset *)asset
{
  if (asset) {
    ...
    return @{
             ...
             @"filename": fileName,
             @"uri": [ABI40_0_0EXMediaLibrary _assetUriForLocalId:asset.localIdentifier andExtension:assetExtension],
             @"mediaType": [ABI40_0_0EXMediaLibrary _stringifyMediaType:asset.mediaType],
             @"mediaSubtypes": [ABI40_0_0EXMediaLibrary _stringifyMediaSubtypes:asset.mediaSubtypes],
             @"width": @(asset.pixelWidth),
             @"height": @(asset.pixelHeight),
             @"creationTime": [ABI40_0_0EXMediaLibrary _exportDate:asset.creationDate],
             @"modificationTime": [ABI40_0_0EXMediaLibrary _exportDate:asset.modificationDate],
...
{
  NSMutableDictionary *assetDict = [[ABI40_0_0EXMediaLibrary _exportAsset:asset] mutableCopy];
  
  if (assetDict) {
    assetDict[@"location"] = [ABI40_0_0EXMediaLibrary _exportLocation:asset.location];
...
{
  return [ABI40_0_0EXMediaLibrary _exportCollection:collection inFolder:nil];
}
...
+ (nullable NSDictionary *)_exportCollection:(PHAssetCollection *)collection inFolder:(nullable NSString *)folderName
{
  if (collection) {
    return @{
             @"id": [ABI40_0_0EXMediaLibrary _assetIdFromLocalId:collection.localIdentifier],
             @"title": ABI40_0_0UMNullIfNil(collection.localizedTitle),
             @"folderName": ABI40_0_0UMNullIfNil(folderName),
             @"type": [ABI40_0_0EXMediaLibrary _stringifyAlbumType:collection.assetCollectionType],
             @"assetCount": [ABI40_0_0EXMediaLibrary _assetCountOfCollection:collection],
             @"startTime": [ABI40_0_0EXMediaLibrary _exportDate:collection.startDate],
             @"endTime": [ABI40_0_0EXMediaLibrary _exportDate:collection.endDate],
             @"approximateLocation": [ABI40_0_0EXMediaLibrary _exportLocation:collection.approximateLocation],
             @"locationNames": ABI40_0_0UMNullIfNil(collection.localizedLocationNames),
             };
  }
  return nil;
}
                       ...
                       inFolder:(nullable NSString *)folderName
{
  ...
  for (PHCollection *collection in collections) {
    if ([collection isKindOfClass:[PHAssetCollection class]]) {
      [albums addObject:[ABI40_0_0EXMediaLibrary _exportCollection:(PHAssetCollection *)collection inFolder:folderName]];
      ...
      [albums addObjectsFromArray:[ABI40_0_0EXMediaLibrary _exportCollections:collectionsInFolder withFetchOptions:options inFolder:collection.localizedTitle]];
    }
  }
  return [albums copy];
}
...
{
  NSString *assetId = [ABI40_0_0EXMediaLibrary _assetIdFromLocalId:localId];
...
+ (NSString *)_stringifyMediaType:(PHAssetMediaType)mediaType
{
  switch (mediaType) {
    case PHAssetMediaTypeAudio:
      return ABI40_0_0EXAssetMediaTypeAudio;
    case PHAssetMediaTypeImage:
      return ABI40_0_0EXAssetMediaTypePhoto;
    case PHAssetMediaTypeVideo:
      return ABI40_0_0EXAssetMediaTypeVideo;
    default:
      return ABI40_0_0EXAssetMediaTypeUnknown;
  }
}

+ (PHAssetMediaType)_convertMediaType:(NSString *)mediaType
{
  if ([mediaType isEqualToString:ABI40_0_0EXAssetMediaTypeAudio]) {
    return PHAssetMediaTypeAudio;
  }
  if ([mediaType isEqualToString:ABI40_0_0EXAssetMediaTypePhoto]) {
    return PHAssetMediaTypeImage;
  }
  if ([mediaType isEqualToString:ABI40_0_0EXAssetMediaTypeVideo]) {
    return PHAssetMediaTypeVideo;
  }
  return PHAssetMediaTypeUnknown;
}
...
+ (NSMutableArray<NSNumber *> *)_convertMediaTypes:(NSArray<NSString *> *)mediaTypes
{
  ...
  [mediaTypes enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
    if ([obj isEqualToString:ABI40_0_0EXAssetMediaTypeAll]) {
      *stop = YES;
      assetTypes = nil;
      return;
    }
    PHAssetMediaType assetType = [ABI40_0_0EXMediaLibrary _convertMediaType:obj];
...
+ (NSString *)_convertSortByKey:(NSString *)key
{
  ...
  if (value == nil) {
    ...
    @throw [NSException exceptionWithName:@"ABI40_0_0EXMediaLibrary.UNSUPPORTED_SORTBY_KEY" reason:reason userInfo:nil];
  }
  return value;
}
...
+ (NSSortDescriptor *)_sortDescriptorFrom:(id)config
{
  if ([config isKindOfClass:[NSString class]]) {
    NSString *key = [ABI40_0_0EXMediaLibrary _convertSortByKey:config];
  ...
  if ([config isKindOfClass:[NSArray class]]) {
    ...
    NSString *key = [ABI40_0_0EXMediaLibrary _convertSortByKey:sortArray[0]];
...
+ (NSArray *)_prepareSortDescriptors:(NSArray *)sortBy
{
  ...
  for (id config in sortByArray) {
    NSSortDescriptor *sortDescriptor = [ABI40_0_0EXMediaLibrary _sortDescriptorFrom:config];
...
- (void)_runIfAllPermissionsWereGranted:(ABI40_0_0UMPromiseRejectBlock)reject block:(void (^)(void))block
{
  [_permissionsManager getPermissionUsingRequesterClass:[ABI40_0_0EXMediaLibraryMediaLibraryPermissionRequester class] resolve:^(id result) {
...
- (BOOL)_checkPermissions:(ABI40_0_0UMPromiseRejectBlock)reject
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI40_0_0EXMediaLibraryMediaLibraryPermissionRequester class]]) {
    reject(@"E_NO_PERMISSIONS", @"MEDIA_LIBRARY permission is required to do this operation.", nil);
    return NO;
  }
  return YES;
