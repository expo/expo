...
@implementation ABI40_0_0EXNotificationCategoriesModule

ABI40_0_0UM_EXPORT_MODULE(ExpoNotificationCategoriesModule);

# pragma mark - Exported methods

ABI40_0_0UM_EXPORT_METHOD_AS(getNotificationCategoriesAsync,
                 getNotificationCategoriesAsyncWithResolver:(ABI40_0_0UMPromiseResolveBlock)resolve reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
...
ABI40_0_0UM_EXPORT_METHOD_AS(setNotificationCategoryAsync,
                 setNotificationCategoryWithCategoryId:(NSString *)categoryId
                 actions:(NSArray *)actions
                 options:(NSDictionary *)options
                 resolve:(ABI40_0_0UMPromiseResolveBlock)resolve reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
...
ABI40_0_0UM_EXPORT_METHOD_AS(deleteNotificationCategoryAsync,
