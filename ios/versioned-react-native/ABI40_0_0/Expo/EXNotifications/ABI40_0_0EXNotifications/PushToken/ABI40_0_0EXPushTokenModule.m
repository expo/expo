...
#import <ABI40_0_0EXNotifications/ABI40_0_0EXPushTokenModule.h>
...
@interface ABI40_0_0EXPushTokenModule ()

@property (nonatomic, weak) id<ABI40_0_0EXPushTokenManager> pushTokenManager;
...
@property (nonatomic, strong) ABI40_0_0UMPromiseResolveBlock getDevicePushTokenResolver;
@property (nonatomic, strong) ABI40_0_0UMPromiseRejectBlock getDevicePushTokenRejecter;

@end

@implementation ABI40_0_0EXPushTokenModule

ABI40_0_0UM_EXPORT_MODULE(ExpoPushTokenManager);

# pragma mark - Exported methods

ABI40_0_0UM_EXPORT_METHOD_AS(getDevicePushTokenAsync,
                    getDevicePushTokenResolving:(ABI40_0_0UMPromiseResolveBlock)resolve rejecting:(ABI40_0_0UMPromiseRejectBlock)reject)
{
...
# pragma mark - ABI40_0_0EXPushTokenListener
