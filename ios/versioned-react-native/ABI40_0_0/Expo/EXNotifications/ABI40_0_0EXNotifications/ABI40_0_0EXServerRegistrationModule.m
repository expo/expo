...
ABI40_0_0UM_EXPORT_MODULE(NotificationsServerRegistrationModule)

ABI40_0_0UM_EXPORT_METHOD_AS(getInstallationIdAsync,
                    getInstallationIdAsyncWithResolver:(ABI40_0_0UMPromiseResolveBlock)resolve
...
ABI40_0_0UM_EXPORT_METHOD_AS(getRegistrationInfoAsync,
                    getRegistrationInfoAsyncWithResolver:(ABI40_0_0UMPromiseResolveBlock)resolve
                                                rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  CFTypeRef keychainResult = NULL;
...
ABI40_0_0UM_EXPORT_METHOD_AS(setRegistrationInfoAsync,
