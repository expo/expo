...
@interface ABI40_0_0EXUserFacingNotificationsPermissionsRequester ()
...
- (NSDictionary *)getPermissions
{
  ...
  __block ABI40_0_0UMPermissionStatus generalStatus = ABI40_0_0UMPermissionStatusUndetermined;

  [[UNUserNotificationCenter currentNotificationCenter] getNotificationSettingsWithCompletionHandler:^(UNNotificationSettings *settings) {
    if (settings.authorizationStatus == UNAuthorizationStatusAuthorized) {
      generalStatus = ABI40_0_0UMPermissionStatusGranted;
    } else if (settings.authorizationStatus == UNAuthorizationStatusDenied) {
      generalStatus = ABI40_0_0UMPermissionStatusDenied;
    }
...
- (void)requestAuthorizationOptions:(UNAuthorizationOptions)options withResolver:(ABI40_0_0UMPromiseResolveBlock)resolve rejecter:(ABI40_0_0UMPromiseRejectBlock)reject
{
