...
#import <ABI40_0_0EXCrypto/ABI40_0_0EXCrypto.h>
#import <CommonCrypto/CommonDigest.h>

@implementation ABI40_0_0EXCrypto

ABI40_0_0UM_EXPORT_MODULE(ExpoCrypto);

ABI40_0_0UM_EXPORT_METHOD_AS(digestStringAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  int digestLength = [ABI40_0_0EXCrypto digestLengthForJSAlgorithm:algorithm];
  if (digestLength == -1) {
