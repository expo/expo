...
@interface ABI40_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI40_0_0EXBarCodeScanner *barCodeScanner;
...
@implementation ABI40_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI40_0_0UMModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI40_0_0UMAppLifecycleListener)];
...
{
  ABI40_0_0UM_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI40_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI40_0_0EXBareCodeCameraRequester class]]) {
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI40_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI40_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI40_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI40_0_0EXBarCodeScanner *barCodeScanner = [ABI40_0_0EXBarCodeScanner new];
