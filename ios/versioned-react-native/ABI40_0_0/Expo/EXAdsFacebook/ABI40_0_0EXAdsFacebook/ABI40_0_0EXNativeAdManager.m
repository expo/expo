#import <ABI40_0_0EXAdsFacebook/ABI40_0_0EXNativeAdManager.h>
...
@class ABI40_0_0EXAdManagerDelegate;

@interface ABI40_0_0EXNativeAdManager ()
...
@property (nonatomic, strong) NSMutableDictionary<NSString*, ABI40_0_0EXAdManagerDelegate*> *adsManagersDelegates;
...
// about errors to ABI40_0_0EXNativeAdManager, but with a specific placement ID
...
@interface ABI40_0_0EXAdManagerDelegate : NSObject <FBNativeAdsManagerDelegate>

@property (nonatomic, weak) ABI40_0_0EXNativeAdManager *manager;
@property (nonatomic, strong) NSString *placementId;

@end

@implementation ABI40_0_0EXAdManagerDelegate

- (instancetype)initWithPlacementId:(NSString *)placementId andManager:(ABI40_0_0EXNativeAdManager *)manager
{
  if (self = [super init]) {
    _manager = manager;
...
@implementation ABI40_0_0EXNativeAdManager

ABI40_0_0UM_EXPORT_MODULE(CTKNativeAdManager)
...
ABI40_0_0UM_EXPORT_METHOD_AS(registerViewsForInteraction,
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  [uiManager executeUIBlock:^(NSDictionary<id,UIView *> * viewRegistry) {
    ...
    if (![nativeAdView isKindOfClass:[ABI40_0_0EXNativeAdView class]]) {
      reject(@"E_INVALID_VIEW_CLASS", @"View returned for passed native ad view tag is not an instance of ABI40_0_0EXNativeAdView", nil);
      return;
    }
    ...
    [(ABI40_0_0EXNativeAdView *)nativeAdView registerViewsForInteraction:(FBMediaView *)mediaView adIcon:(FBAdIconView *)adIconView clickableViews:clickableViews];
    resolve(@[]);
  }];
}

ABI40_0_0UM_EXPORT_METHOD_AS(init,
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  ABI40_0_0EXAdManagerDelegate *delegate = [[ABI40_0_0EXAdManagerDelegate alloc] initWithPlacementId:placementId andManager:self];
...
ABI40_0_0UM_EXPORT_METHOD_AS(setMediaCachePolicy,
...
ABI40_0_0UM_EXPORT_METHOD_AS(disableAutoRefresh,
...
- (void)nativeAdsLoaded
{
  ...
  [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI40_0_0UMEventEmitterService)] sendEventWithName:@"CTKNativeAdsManagersChanged" body:adsManagersState];
}

- (void)nativeAdForPlacementId:(NSString *)placementId failedToLoadWithError:(NSError *)error
{
  [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI40_0_0UMEventEmitterService)] sendEventWithName:@"CTKNativeAdManagerErrored" body:@{
...
- (UIView *)view
{
  return [[ABI40_0_0EXNativeAdView alloc] initWithModuleRegistry:_moduleRegistry];
}

ABI40_0_0UM_VIEW_PROPERTY(adsManager, NSString *, ABI40_0_0EXNativeAdView)
{
