...
@interface ABI40_0_0EXBannerView () <FBAdViewDelegate>
...
@implementation ABI40_0_0EXBannerView
...
- (void)createViewIfCan
{
  ...
  UIViewController *rootViewController = [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI40_0_0UMUtilitiesInterface)] currentViewController];
...
- (void)adView:(FBAdView *)adView didFailWithError:(NSError *)error
{
  if (_onAdError) {
    ...
    ABI40_0_0UMLogError(@"%@: %@", error.localizedDescription, error.userInfo);
  }
}
