#import <ABI40_0_0EXAdsFacebook/ABI40_0_0EXAdSettingsManager.h>
#import <FBAudienceNetwork/FBAudienceNetwork.h>
#import <ABI40_0_0UMCore/ABI40_0_0UMAppLifecycleService.h>

@interface ABI40_0_0EXAdSettingsManager ()
...
@implementation ABI40_0_0EXAdSettingsManager

ABI40_0_0UM_EXPORT_MODULE(CTKAdSettingsManager)
...
ABI40_0_0UM_EXPORT_METHOD_AS(addTestDevice,
...
ABI40_0_0UM_EXPORT_METHOD_AS(clearTestDevices,
                    clearTestDevicesWithResolver:(ABI40_0_0UMPromiseResolveBlock)resolver
                    reject:(ABI40_0_0UMPromiseRejectBlock)rejecter)
{
...
ABI40_0_0UM_EXPORT_METHOD_AS(setLogLevel,
...
ABI40_0_0UM_EXPORT_METHOD_AS(setIsChildDirected,
...
ABI40_0_0UM_EXPORT_METHOD_AS(setMeditationService,
...
ABI40_0_0UM_EXPORT_METHOD_AS(setUrlPrefix,
