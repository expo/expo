...
#import <ABI40_0_0EXWebBrowser/ABI40_0_0EXWebBrowser.h>
...
@interface ABI40_0_0EXWebBrowser () <SFSafariViewControllerDelegate>

@property (nonatomic, copy) ABI40_0_0UMPromiseResolveBlock redirectResolve;
@property (nonatomic, copy) ABI40_0_0UMPromiseRejectBlock redirectReject;
...
@implementation ABI40_0_0EXWebBrowser
{
  UIStatusBarStyle _initialStatusBarStyle;
}

ABI40_0_0UM_EXPORT_MODULE(ExpoWebBrowser)
...
ABI40_0_0UM_EXPORT_METHOD_AS(openAuthSessionAsync,
...
ABI40_0_0UM_EXPORT_METHOD_AS(openBrowserAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  if([[arguments allKeys] containsObject:WebBrowserToolbarColorKey]) {
    safariVC.preferredBarTintColor = [ABI40_0_0EXWebBrowser convertHexColorString:arguments[WebBrowserToolbarColorKey]];
  }
  if([[arguments allKeys] containsObject:WebBrowserControlsColorKey]) {
    safariVC.preferredControlTintColor = [ABI40_0_0EXWebBrowser convertHexColorString:arguments[WebBrowserControlsColorKey]];
  }
...
ABI40_0_0UM_EXPORT_METHOD_AS(dismissBrowser,
                    dismissBrowserWithResolver:(ABI40_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  __weak typeof(self) weakSelf = self;
  UIViewController *currentViewController = [UIApplication sharedApplication].keyWindow.rootViewController;
...
ABI40_0_0UM_EXPORT_METHOD_AS(dismissAuthSession,
                    dismissAuthSessionWithResolver:(ABI40_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  if (@available(iOS 11, *)) {
    [_authSession cancel];
...
ABI40_0_0UM_EXPORT_METHOD_AS(warmUpAsync,
...
ABI40_0_0UM_EXPORT_METHOD_AS(coolDownAsync,
...
ABI40_0_0UM_EXPORT_METHOD_AS(getCustomTabsSupportingBrowsers,
                    getCustomTabsSupportingBrowsersWithPackage:(ABI40_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  // stub for jest-expo-mock-generator
}

ABI40_0_0UM_EXPORT_METHOD_AS(mayInitWithUrlAsync,
 ...
 */
- (BOOL)initializeWebBrowserWithResolver:(ABI40_0_0UMPromiseResolveBlock)resolve andRejecter:(ABI40_0_0UMPromiseRejectBlock)reject {
  if (_redirectResolve) {
...
+ (UIColor *)convertHexColorString:(NSString *)stringToConvert {
  ...
  return [ABI40_0_0EXWebBrowser colorWithRGBHex:hexNum];
}
