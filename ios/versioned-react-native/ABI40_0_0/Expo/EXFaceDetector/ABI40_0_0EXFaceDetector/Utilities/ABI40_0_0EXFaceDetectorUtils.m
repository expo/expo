//
//  ABI40_0_0EXFaceDetectorUtils.m
//  Exponent
//
...
NSString *const ABI40_0_0EXGMVDataOutputWidthKey = @"Width";
NSString *const ABI40_0_0EXGMVDataOutputHeightKey = @"Height";
...
@implementation ABI40_0_0EXFaceDetectorUtils
...
+ (ABI40_0_0EXFaceDetectionAngleTransformBlock)angleTransformerFromTransform:(CGAffineTransform)transform
{
  return ^(float angle) {
