//
//  ABI40_0_0EXFaceDetectorManager.m
//  Exponent
//
...
@interface ABI40_0_0EXFaceDetectorManager() <AVCaptureVideoDataOutputSampleBufferDelegate>
...
@property ABI40_0_0EXFaceDetector *faceDetector;
@property NSInteger timeIntervalMillis;

@end

@implementation ABI40_0_0EXFaceDetectorManager

- (instancetype)init
{
  return [self initWithOptions:[ABI40_0_0EXFaceDetectorUtils defaultFaceDetectorOptions]];
}
...
- (instancetype)initWithOptions:(NSDictionary*)options
{
  if (self = [super init]) {
    ...
    _faceDetectorOptions = [ABI40_0_0EXFaceDetectorUtils mapOptions:options];
  ...
  if ([self isDetectingFaceEnabled]) {
    @try {
      ...
      if([_session canAddOutput:output]) {
        ...
        ABI40_0_0UMLogError(@"Unable to add output to camera session! Face detection aborted!");
      }
