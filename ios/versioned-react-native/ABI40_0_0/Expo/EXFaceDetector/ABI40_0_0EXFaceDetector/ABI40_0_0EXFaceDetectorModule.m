...
#import <ABI40_0_0EXFaceDetector/ABI40_0_0EXFaceDetectorModule.h>
...
ABI40_0_0UM_EXPORT_MODULE(ExpoFaceDetector);

- (NSDictionary *)constantsToExport
{
  return [ABI40_0_0EXFaceDetectorUtils constantsToExport];
}
...
ABI40_0_0UM_EXPORT_METHOD_AS(detectFaces, detectFaces:(nonnull NSDictionary *)options resolver:(ABI40_0_0UMPromiseResolveBlock)resolve rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (!([fileSystem permissionsForURI:url] & ABI40_0_0UMFileSystemPermissionRead)) {
  ...
  @try {
    ...
    ciImage = [ciImage imageByApplyingOrientation:[ABI40_0_0EXFaceDetectorUtils toCGImageOrientation:image.imageOrientation]];
    ...
    ABI40_0_0EXFaceDetector* detector = [[ABI40_0_0EXFaceDetector alloc] initWithOptions: [ABI40_0_0EXFaceDetectorUtils mapOptions:options]];
    [detector detectFromImage:finalImage completionListener:^(NSArray<FIRVisionFace *> * _Nullable faces, NSError * _Nullable error) {
      ...
      if(faces.count > 0) {
        ABI40_0_0EXFaceEncoder *encoder = [[ABI40_0_0EXFaceEncoder alloc] init];
      ...
      if (error != nil) {
        ...
        resolve(@{
                  ...
                  @"image" : @{
                      ...
                      @"orientation" : @([ABI40_0_0EXFaceDetectorModule exifOrientationFor:image.imageOrientation])
                      }
                  });
      }}];
