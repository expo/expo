...
#import <ABI40_0_0EXLocation/ABI40_0_0EXLocation.h>
#import <ABI40_0_0EXLocation/ABI40_0_0EXGeofencingTaskConsumer.h>
#import <ABI40_0_0UMTaskManagerInterface/ABI40_0_0UMTaskInterface.h>

@interface ABI40_0_0EXGeofencingTaskConsumer ()
...
@implementation ABI40_0_0EXGeofencingTaskConsumer
...
# pragma mark - ABI40_0_0UMTaskConsumerInterface
...
- (void)didRegisterTask:(id<ABI40_0_0UMTaskInterface>)task
{
...
- (void)startMonitoringRegionsForTask:(id<ABI40_0_0UMTaskInterface>)task
{
  [ABI40_0_0UMUtilities performSynchronouslyOnMainThread:^{
...
- (void)executeTaskWithRegion:(nonnull CLRegion *)region eventType:(ABI40_0_0EXGeofencingEventType)eventType
{
...
- (void)locationManager:(CLLocationManager *)manager didEnterRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != CLRegionStateInside) {
    ...
    [self executeTaskWithRegion:region eventType:ABI40_0_0EXGeofencingEventTypeEnter];
  }
}
...
- (void)locationManager:(CLLocationManager *)manager didExitRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != CLRegionStateOutside) {
    ...
    [self executeTaskWithRegion:region eventType:ABI40_0_0EXGeofencingEventTypeExit];
  }
}
...
- (void)locationManager:(CLLocationManager *)manager didDetermineState:(CLRegionState)state forRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != state) {
    ABI40_0_0EXGeofencingEventType eventType = state == CLRegionStateInside ? ABI40_0_0EXGeofencingEventTypeEnter : ABI40_0_0EXGeofencingEventTypeExit;
...
+ (ABI40_0_0EXGeofencingRegionState)exportRegionState:(CLRegionState)regionState
{
  switch (regionState) {
    case CLRegionStateUnknown:
      return ABI40_0_0EXGeofencingRegionStateUnknown;
    case CLRegionStateInside:
      return ABI40_0_0EXGeofencingRegionStateInside;
    case CLRegionStateOutside:
      return ABI40_0_0EXGeofencingRegionStateOutside;
  }
}
