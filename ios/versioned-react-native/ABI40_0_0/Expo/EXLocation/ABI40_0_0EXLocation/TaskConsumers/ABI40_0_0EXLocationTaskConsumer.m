...
#import <ABI40_0_0EXLocation/ABI40_0_0EXLocationTaskConsumer.h>
#import <ABI40_0_0UMTaskManagerInterface/ABI40_0_0UMTaskInterface.h>

@interface ABI40_0_0EXLocationTaskConsumer ()
...
@implementation ABI40_0_0EXLocationTaskConsumer
...
- (void)setOptions:(NSDictionary *)options
{
  [ABI40_0_0UMUtilities performSynchronouslyOnMainThread:^{
    ...
    ABI40_0_0EXLocationAccuracy accuracy = [options[@"accuracy"] unsignedIntegerValue] ?: ABI40_0_0EXLocationAccuracyBalanced;

    locationManager.desiredAccuracy = [ABI40_0_0EXLocation CLLocationAccuracyFromOption:accuracy];
    locationManager.distanceFilter = [options[@"distanceInterval"] doubleValue] ?: kCLDistanceFilterNone;
    locationManager.activityType = [ABI40_0_0EXLocation CLActivityTypeFromOption:[options[@"activityType"] integerValue]];
...
- (void)executeTaskWithDeferredLocations
{
  ...
  NSDictionary *data = @{ @"locations": [ABI40_0_0EXLocationTaskConsumer _exportLocations:_deferredLocations] };
...
+ (NSArray<NSDictionary *> *)_exportLocations:(NSArray<CLLocation *> *)locations
{
  ...
  for (CLLocation *location in locations) {
    [result addObject:[ABI40_0_0EXLocation exportLocation:location]];
  }
  return result;
}
