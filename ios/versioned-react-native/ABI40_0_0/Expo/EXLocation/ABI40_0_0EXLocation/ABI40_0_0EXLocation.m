...
NSString * const ABI40_0_0EXLocationChangedEventName = @"Expo.locationChanged";
NSString * const ABI40_0_0EXHeadingChangedEventName = @"Expo.headingChanged";

@interface ABI40_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI40_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) NSMutableSet<ABI40_0_0EXLocationDelegate *> *retainedDelegates;
...
@property (nonatomic, weak) id<ABI40_0_0UMTaskManagerInterface> tasksManager;

@end

@implementation ABI40_0_0EXLocation

ABI40_0_0UM_EXPORT_MODULE(ExpoLocation);
...
- (void)setModuleRegistry:(ABI40_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  [ABI40_0_0UMPermissionsMethodsDelegate registerRequesters:@[[ABI40_0_0EXLocationPermissionRequester new]] withPermissionsManager:_permissionsManager];
  _tasksManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI40_0_0UMTaskManagerInterface)];
}
...
{
  return @[ABI40_0_0EXLocationChangedEventName, ABI40_0_0EXHeadingChangedEventName];
}
...
ABI40_0_0UM_EXPORT_METHOD_AS(getProviderStatusAsync,
...
ABI40_0_0UM_EXPORT_METHOD_AS(getCurrentPositionAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI40_0_0EXLocationDelegate *delegate;

  delegate = [[ABI40_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (delegate != nil) {
      if (locations.lastObject != nil) {
        resolve([ABI40_0_0EXLocation exportLocation:locations.lastObject]);
      } else {
...
ABI40_0_0UM_EXPORT_METHOD_AS(watchPositionImplAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  ABI40_0_0EXLocationDelegate *delegate = [[ABI40_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject != nil && weakSelf != nil) {
      ...
      NSDictionary *body = @{
                             @"watchId": watchId,
                             @"location": [ABI40_0_0EXLocation exportLocation:loc],
                             };

      [strongSelf->_eventEmitter sendEventWithName:ABI40_0_0EXLocationChangedEventName body:body];
    }
  } onUpdateHeadings:nil onError:^(NSError *error) {
    // TODO: report errors
...
ABI40_0_0UM_EXPORT_METHOD_AS(getLastKnownPositionAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  if ([self.class isLocation:location validWithOptions:options]) {
    resolve([ABI40_0_0EXLocation exportLocation:location]);
  } else {
    resolve([NSNull null]);
  }
}
...
ABI40_0_0UM_EXPORT_METHOD_AS(watchDeviceHeading,
                    watchHeadingWithWatchId:(nonnull NSNumber *)watchId
                    resolve:(ABI40_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject) {
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI40_0_0EXLocationPermissionRequester class]]) {
  ...
  ABI40_0_0EXLocationDelegate *delegate = [[ABI40_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
    if (newHeading != nil && weakSelf != nil) {
      ...
      [strongSelf->_eventEmitter sendEventWithName:ABI40_0_0EXHeadingChangedEventName body:body];
    }
...
ABI40_0_0UM_EXPORT_METHOD_AS(removeWatchAsync,
                    watchId:(nonnull NSNumber *)watchId
                    resolver:(ABI40_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ABI40_0_0EXLocationDelegate *delegate = _delegates[watchId];
...
ABI40_0_0UM_EXPORT_METHOD_AS(geocodeAsync,
...
ABI40_0_0UM_EXPORT_METHOD_AS(reverseGeocodeAsync,
    ...
    if (!error) {
      ...
      for (CLPlacemark* placemark in placemarks) {
        NSDictionary *address = @{
                                  @"city": ABI40_0_0UMNullIfNil(placemark.locality),
                                  @"district": ABI40_0_0UMNullIfNil(placemark.subLocality),
                                  @"street": ABI40_0_0UMNullIfNil(placemark.thoroughfare),
                                  @"region": ABI40_0_0UMNullIfNil(placemark.administrativeArea),
                                  @"subregion": ABI40_0_0UMNullIfNil(placemark.subAdministrativeArea),
                                  @"country": ABI40_0_0UMNullIfNil(placemark.country),
                                  @"postalCode": ABI40_0_0UMNullIfNil(placemark.postalCode),
                                  @"name": ABI40_0_0UMNullIfNil(placemark.name),
                                  @"isoCountryCode": ABI40_0_0UMNullIfNil(placemark.ISOcountryCode),
                                  @"timezone": ABI40_0_0UMNullIfNil(placemark.timeZone.name),
                                  };
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  [ABI40_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI40_0_0EXLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
...
ABI40_0_0UM_EXPORT_METHOD_AS(hasServicesEnabledAsync,
                    hasServicesEnabled:(ABI40_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
...
ABI40_0_0UM_EXPORT_METHOD_AS(startLocationUpdatesAsync,
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI40_0_0EXLocationTaskConsumer class] options:options];
  }
  @catch (NSException *e) {
...
ABI40_0_0UM_EXPORT_METHOD_AS(stopLocationUpdatesAsync,
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI40_0_0EXLocationTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI40_0_0UM_EXPORT_METHOD_AS(hasStartedLocationUpdatesAsync,
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI40_0_0EXLocationTaskConsumer class]]));
}

# pragma mark - Geofencing

ABI40_0_0UM_EXPORT_METHOD_AS(startGeofencingAsync,
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI40_0_0EXGeofencingTaskConsumer class] options:options];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI40_0_0UM_EXPORT_METHOD_AS(stopGeofencingAsync,
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI40_0_0EXGeofencingTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI40_0_0UM_EXPORT_METHOD_AS(hasStartedGeofencingAsync,
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI40_0_0EXGeofencingTaskConsumer class]]));
}
...
- (BOOL)checkPermissions:(ABI40_0_0UMPromiseRejectBlock)reject
{
...
- (BOOL)checkTaskManagerExists:(ABI40_0_0UMPromiseRejectBlock)reject
{
...
- (BOOL)checkBackgroundServices:(ABI40_0_0UMPromiseRejectBlock)reject
{
...
{
  switch (accuracy) {
    case ABI40_0_0EXLocationAccuracyLowest:
      return kCLLocationAccuracyThreeKilometers;
    case ABI40_0_0EXLocationAccuracyLow:
      return kCLLocationAccuracyKilometer;
    case ABI40_0_0EXLocationAccuracyBalanced:
      return kCLLocationAccuracyHundredMeters;
    case ABI40_0_0EXLocationAccuracyHigh:
      return kCLLocationAccuracyNearestTenMeters;
    case ABI40_0_0EXLocationAccuracyHighest:
      return kCLLocationAccuracyBest;
    case ABI40_0_0EXLocationAccuracyBestForNavigation:
