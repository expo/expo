...
@interface ABI40_0_0EXSessionUploadTaskDelegate ()

@property (strong, nonatomic) NSMutableData *responseData;

@end

@implementation ABI40_0_0EXSessionUploadTaskDelegate

- (instancetype)initWithResolve:(ABI40_0_0UMPromiseResolveBlock)resolve reject:(ABI40_0_0UMPromiseRejectBlock)reject
{
...
- (void)URLSession:(NSURLSession *)session task:(NSURLSessionTask *)task didCompleteWithError:(NSError *)error
{
  ...
  // We only set ABI40_0_0EXSessionUploadTaskDelegates as delegates of upload tasks
...
- (NSDictionary *)parseServerResponse:(NSURLResponse *)response
{
  ...
  result[@"body"] = ABI40_0_0UMNullIfNil([[NSString alloc] initWithData:_responseData encoding:NSUTF8StringEncoding]);
  return result;
}
