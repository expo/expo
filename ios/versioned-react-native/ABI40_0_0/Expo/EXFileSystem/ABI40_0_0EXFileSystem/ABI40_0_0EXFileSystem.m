...
#import <ABI40_0_0EXFileSystem/ABI40_0_0EXFileSystem.h>

#import <CommonCrypto/CommonDigest.h>
#import <MobileCoreServices/MobileCoreServices.h>

#import <ABI40_0_0EXFileSystem/ABI40_0_0EXFileSystemLocalFileHandler.h>
#import <ABI40_0_0EXFileSystem/ABI40_0_0EXFileSystemAssetLibraryHandler.h>
...
#import <ABI40_0_0EXFileSystem/ABI40_0_0EXSessionTaskDispatcher.h>
...
#import <ABI40_0_0EXFileSystem/ABI40_0_0EXSessionUploadTaskDelegate.h>

NSString * const ABI40_0_0EXDownloadProgressEventName = @"expo-file-system.downloadProgress";

typedef NS_ENUM(NSInteger, ABI40_0_0EXFileSystemSessionType) {
  ABI40_0_0EXFileSystemBackgroundSession = 0,
  ABI40_0_0EXFileSystemForegroundSession = 1,
};

typedef NS_ENUM(NSInteger, ABI40_0_0EXFileSystemUploadType) {
  ABI40_0_0EXFileSystemInvalidType = -1,
  ABI40_0_0EXFileSystemBinaryContent = 0,
  ABI40_0_0EXFileSystemMultipart = 1,
};
 
@interface ABI40_0_0EXFileSystem ()

@property (nonatomic, strong) NSURLSession *backgroundSession;
@property (nonatomic, strong) NSURLSession *foregroundSession;
@property (nonatomic, strong) ABI40_0_0EXSessionTaskDispatcher *sessionTaskDispatcher;
@property (nonatomic, strong) ABI40_0_0EXResumablesManager *resumableManager;
...
@implementation ABI40_0_0EXFileSystem
...
{
  return @[@protocol(ABI40_0_0UMFileSystemInterface)];
}
...
- (instancetype)initWithDocumentDirectory:(NSString *)documentDirectory cachesDirectory:(NSString *)cachesDirectory bundleDirectory:(NSString *)bundleDirectory
{
  if (self = [super init]) {
    ...
    _resumableManager = [ABI40_0_0EXResumablesManager new];
    
    [ABI40_0_0EXFileSystem ensureDirExistsWithPath:_documentDirectory];
    [ABI40_0_0EXFileSystem ensureDirExistsWithPath:_cachesDirectory];
  }
  return self;
}
...
- (void)setModuleRegistry:(ABI40_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  _eventEmitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI40_0_0UMEventEmitterService)];
  
  _sessionTaskDispatcher = [[ABI40_0_0EXSessionTaskDispatcher alloc] initWithSessionHandler:[moduleRegistry getSingletonModuleForName:@"SessionHandler"]];
  _backgroundSession = [self _createSession:ABI40_0_0EXFileSystemBackgroundSession delegate:_sessionTaskDispatcher];
  _foregroundSession = [self _createSession:ABI40_0_0EXFileSystemForegroundSession delegate:_sessionTaskDispatcher];
}
...
{
  return @[ABI40_0_0EXDownloadProgressEventName];
}
...
ABI40_0_0UM_EXPORT_METHOD_AS(getInfoAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:uri] & ABI40_0_0UMFileSystemPermissionRead)) {
  ...
  if ([uri.scheme isEqualToString:@"file"]) {
    [ABI40_0_0EXFileSystemLocalFileHandler getInfoForFile:uri withOptions:options resolver:resolve rejecter:reject];
  } else if ([uri.scheme isEqualToString:@"assets-library"] || [uri.scheme isEqualToString:@"ph"]) {
    [ABI40_0_0EXFileSystemAssetLibraryHandler getInfoForFile:uri withOptions:options resolver:resolve rejecter:reject];
  } else {
...
ABI40_0_0UM_EXPORT_METHOD_AS(readAsStringAsync,
...
ABI40_0_0UM_EXPORT_METHOD_AS(writeAsStringAsync,
...
{
  NSURL *uri = [NSURL URLWithString:uriString];
  if (!([self permissionsForURI:uri] & ABI40_0_0UMFileSystemPermissionWrite)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
...
ABI40_0_0UM_EXPORT_METHOD_AS(deleteAsync,
...
{
  NSURL *uri = [NSURL URLWithString:uriString];
  if (!([self permissionsForURI:[uri URLByAppendingPathComponent:@".."]] & ABI40_0_0UMFileSystemPermissionWrite)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
...
ABI40_0_0UM_EXPORT_METHOD_AS(moveAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:[from URLByAppendingPathComponent:@".."]] & ABI40_0_0UMFileSystemPermissionWrite)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
  ...
  if (!([self permissionsForURI:to] & ABI40_0_0UMFileSystemPermissionWrite)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
...
ABI40_0_0UM_EXPORT_METHOD_AS(copyAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:from] & ABI40_0_0UMFileSystemPermissionRead)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
  ...
  if ([from.scheme isEqualToString:@"file"]) {
    [ABI40_0_0EXFileSystemLocalFileHandler copyFrom:from to:to resolver:resolve rejecter:reject];
  } else if ([from.scheme isEqualToString:@"assets-library"] || [from.scheme isEqualToString:@"ph"]) {
    [ABI40_0_0EXFileSystemAssetLibraryHandler copyFrom:from to:to resolver:resolve rejecter:reject];
  } else {
    reject(@"ERR_FILESYSTEM_INVALID_URI",
           [NSString stringWithFormat:@"Unsupported URI scheme for '%@'", from],
           nil);
...
ABI40_0_0UM_EXPORT_METHOD_AS(makeDirectoryAsync,
...
ABI40_0_0UM_EXPORT_METHOD_AS(readDirectoryAsync,
...
ABI40_0_0UM_EXPORT_METHOD_AS(downloadAsync,
                                ...
                                rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:localUri] & ABI40_0_0UMFileSystemPermissionWrite)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
  ...
  ABI40_0_0EXSessionTaskDelegate *taskDelegate = [[ABI40_0_0EXSessionDownloadTaskDelegate alloc] initWithResolve:resolve
                                                                                        reject:reject
                                                                                      localUrl:localUri
...
ABI40_0_0UM_EXPORT_METHOD_AS(uploadAsync,
                       ...
                       rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  ABI40_0_0EXFileSystemUploadType type = [self _getUploadTypeFrom:options[@"uploadType"]];
  ...
  if (type == ABI40_0_0EXFileSystemBinaryContent) {
    task = [session uploadTaskWithRequest:request fromFile:fileUri];
  } else if (type == ABI40_0_0EXFileSystemMultipart) {
  ...
  ABI40_0_0EXSessionTaskDelegate *taskDelegate = [[ABI40_0_0EXSessionUploadTaskDelegate alloc] initWithResolve:resolve reject:reject];
  [_sessionTaskDispatcher registerTaskDelegate:taskDelegate forTask:task];
  [task resume];
}

ABI40_0_0UM_EXPORT_METHOD_AS(downloadResumableStartAsync,
                                              ...
                                              rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (!([self _permissionsForPath:path] & ABI40_0_0UMFileSystemPermissionWrite)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
...
ABI40_0_0UM_EXPORT_METHOD_AS(downloadResumablePauseAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  [task cancelByProducingResumeData:^(NSData * _Nullable resumeData) {
    ...
    resolve(@{ @"resumeData": ABI40_0_0UMNullIfNil([resumeData base64EncodedStringWithOptions:0]) });
  }];
}

ABI40_0_0UM_EXPORT_METHOD_AS(getFreeDiskStorageAsync, getFreeDiskStorageAsyncWithResolver:(ABI40_0_0UMPromiseResolveBlock)resolve rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
...
ABI40_0_0UM_EXPORT_METHOD_AS(getTotalDiskCapacityAsync, getTotalDiskCapacityAsyncWithResolver:(ABI40_0_0UMPromiseResolveBlock)resolve rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
...
- (ABI40_0_0EXFileSystemUploadType)_getUploadTypeFrom:(NSNumber * _Nullable)type
{
  switch ([type intValue]) {
    case ABI40_0_0EXFileSystemBinaryContent:
    case ABI40_0_0EXFileSystemMultipart:
      return [type intValue];
  }
  
  return ABI40_0_0EXFileSystemInvalidType;
}
...
- (NSURLSession *)_sessionForType:(ABI40_0_0EXFileSystemSessionType)type
{
  switch (type) {
    case ABI40_0_0EXFileSystemBackgroundSession:
      return _backgroundSession;
    case ABI40_0_0EXFileSystemForegroundSession:
...
- (NSURLSession *)_createSession:(ABI40_0_0EXFileSystemSessionType)type delegate:(id<NSURLSessionDelegate>)delegate
{
  NSURLSessionConfiguration *sessionConfiguration;
  if (type == ABI40_0_0EXFileSystemForegroundSession) {
...
{
  ABI40_0_0UM_WEAKIFY(self);
  ABI40_0_0EXDownloadDelegateOnWriteCallback onWrite = ^(NSURLSessionDownloadTask *task, int64_t bytesWritten, int64_t totalBytesWritten, int64_t totalBytesExpectedToWrite) {
    ABI40_0_0UM_ENSURE_STRONGIFY(self);
    [self sendEventWithName:ABI40_0_0EXDownloadProgressEventName
                       body:@{
                             @"uuid": uuid,
                             @"data": @{
  ...
  ABI40_0_0EXSessionTaskDelegate *taskDelegate = [[ABI40_0_0EXSessionResumableDownloadTaskDelegate alloc] initWithResolve:resolve
                                                                                                 reject:reject
                                                                                               localUrl:fileUrl
                                                                                     shouldCalculateMd5:[options[@"md5"] boolValue]
...
- (ABI40_0_0UMFileSystemPermissionFlags)_permissionsForPath:(NSString *)path
{
  return [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI40_0_0UMFilePermissionModuleInterface)] getPathPermissions:(NSString *)path];
}
...
{
  return [ABI40_0_0EXFileSystem ensureDirExistsWithPath:path];
}
...
{
  return [ABI40_0_0EXFileSystem generatePathInDirectory:directory withExtension:extension];
}

+ (NSString *)generatePathInDirectory:(NSString *)directory withExtension:(NSString *)extension
{
  NSString *fileName = [[[NSUUID UUID] UUIDString] stringByAppendingString:extension];
  [ABI40_0_0EXFileSystem ensureDirExistsWithPath:directory];
