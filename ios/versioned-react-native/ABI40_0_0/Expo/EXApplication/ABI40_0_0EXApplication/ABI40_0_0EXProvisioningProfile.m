...
@implementation ABI40_0_0EXProvisioningProfile {
  NSDictionary *_plist;
}

+ (nonnull instancetype)mainProvisioningProfile
{
  static ABI40_0_0EXProvisioningProfile *profile;
...
- (ABI40_0_0EXAppReleaseType)appReleaseType {
  ...
  if (!provisioningPath) {
    ...
    return ABI40_0_0EXAppReleaseSimulator;
#else
    return ABI40_0_0EXAppReleaseAppStore;
#endif
  }
  ...
  if (!mobileProvision) {
    ...
    return ABI40_0_0EXAppReleaseTypeUnknown;
    ...
    return ABI40_0_0EXAppReleaseEnterprise;
    ...
    if ([[entitlements objectForKey:@"get-task-allow"] boolValue]) {
      return ABI40_0_0EXAppReleaseDev;
    } else {
      return ABI40_0_0EXAppReleaseAdHoc;
    }
  } else {
