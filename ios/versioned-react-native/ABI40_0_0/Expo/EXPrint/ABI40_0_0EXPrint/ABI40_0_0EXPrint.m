...
#import <ABI40_0_0EXPrint/ABI40_0_0EXPrint.h>
#import <ABI40_0_0EXPrint/ABI40_0_0EXWKPDFRenderer.h>
...
NSString *const ABI40_0_0EXPrintOrientationPortrait = @"portrait";
NSString *const ABI40_0_0EXPrintOrientationLandscape = @"landscape";

@interface ABI40_0_0EXPrint () <UIPrintInteractionControllerDelegate, UIPrinterPickerControllerDelegate>
...
@implementation ABI40_0_0EXPrint

ABI40_0_0UM_EXPORT_MODULE(ExponentPrint);
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"Orientation": @{
               @"portrait": ABI40_0_0EXPrintOrientationPortrait,
               @"landscape": ABI40_0_0EXPrintOrientationLandscape,
               },
           };
}

ABI40_0_0UM_EXPORT_METHOD_AS(print,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  [self _getPrintingDataForOptions:options callback:^(NSData *printingData, NSDictionary *errorDetails) {
    if (errorDetails != nil) {
      reject(errorDetails[@"code"], errorDetails[@"message"], ABI40_0_0UMErrorWithMessage(errorDetails[@"message"]));
      return;
    }
    ...
    if (printingData == nil) {
      ...
      if (options[@"markupFormatterIOS"] && [options[@"markupFormatterIOS"] isKindOfClass:[NSString class]]) {
        ...
        if (htmlString != nil) {
          ...
          reject(@"E_HTML_INVALID", message, ABI40_0_0UMErrorWithMessage(message));
          return;
        }
      } else {
...
ABI40_0_0UM_EXPORT_METHOD_AS(selectPrinter,selectPrinter:(ABI40_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
...
ABI40_0_0UM_EXPORT_METHOD_AS(printToFileAsync,
                    ...
                    reject:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI40_0_0EXWKPDFRenderer *renderTask = [ABI40_0_0EXWKPDFRenderer new];
...
{
  id<ABI40_0_0UMUtilitiesInterface> utils = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI40_0_0UMUtilitiesInterface)];
...
{
  if ([orientation isEqualToString:ABI40_0_0EXPrintOrientationLandscape]) {
