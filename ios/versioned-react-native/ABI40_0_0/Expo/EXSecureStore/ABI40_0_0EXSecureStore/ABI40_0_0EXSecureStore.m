...
@implementation ABI40_0_0EXSecureStore
...
- (CFStringRef)_accessibilityAttributeWithOptions:(NSDictionary *)options
{
  ...
  switch (accessibility) {
    case ABI40_0_0EXSecureStoreAccessibleAfterFirstUnlock:
      return kSecAttrAccessibleAfterFirstUnlock;
    case ABI40_0_0EXSecureStoreAccessibleAfterFirstUnlockThisDeviceOnly:
      return kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly;
    case ABI40_0_0EXSecureStoreAccessibleAlways:
      return kSecAttrAccessibleAlways;
    case ABI40_0_0EXSecureStoreAccessibleWhenPasscodeSetThisDeviceOnly:
      return kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly;
    case ABI40_0_0EXSecureStoreAccessibleWhenUnlocked:
      return kSecAttrAccessibleWhenUnlocked;
    case ABI40_0_0EXSecureStoreAccessibleAlwaysThisDeviceOnly:
      return kSecAttrAccessibleAlwaysThisDeviceOnly;
    case ABI40_0_0EXSecureStoreAccessibleWhenUnlockedThisDeviceOnly:
...
{
  return @{
           @"AFTER_FIRST_UNLOCK":@(ABI40_0_0EXSecureStoreAccessibleAfterFirstUnlock),
           @"AFTER_FIRST_UNLOCK_THIS_DEVICE_ONLY":@(ABI40_0_0EXSecureStoreAccessibleAfterFirstUnlockThisDeviceOnly),
           @"ALWAYS":@(ABI40_0_0EXSecureStoreAccessibleAlways),
           @"WHEN_PASSCODE_SET_THIS_DEVICE_ONLY":@(ABI40_0_0EXSecureStoreAccessibleWhenPasscodeSetThisDeviceOnly),
           @"ALWAYS_THIS_DEVICE_ONLY":@(ABI40_0_0EXSecureStoreAccessibleAlwaysThisDeviceOnly),
           @"WHEN_UNLOCKED":@(ABI40_0_0EXSecureStoreAccessibleWhenUnlocked),
           @"WHEN_UNLOCKED_THIS_DEVICE_ONLY":@(ABI40_0_0EXSecureStoreAccessibleWhenUnlockedThisDeviceOnly)
           };
};

ABI40_0_0UM_EXPORT_MODULE(ExpoSecureStore);

ABI40_0_0UM_EXPORT_METHOD_AS(setValueWithKeyAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (!validatedKey) {
    reject(@"E_SECURESTORE_SETVALUEFAIL", nil, ABI40_0_0UMErrorWithMessage(@"Invalid key."));
  } else {
    NSError *error;
    ...
    if (setValue) {
      ...
      reject(@"E_SECURESTORE_SETVALUEFAIL", nil, ABI40_0_0UMErrorWithMessage([[self class] _messageForError:error]));
    }
  }
}

ABI40_0_0UM_EXPORT_METHOD_AS(getValueWithKeyAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  NSString *validatedKey = [self validatedKey:key];
  if (!validatedKey) {
    reject(@"E_SECURESTORE_GETVALUEFAIL", nil, ABI40_0_0UMErrorWithMessage(@"Invalid key."));
  } else {
    NSError *error;
    ...
    if (error) {
      if (error.code == errSecItemNotFound) {
        ...
        reject(@"E_SECURESTORE_GETVALUEFAIL", nil, ABI40_0_0UMErrorWithMessage([[self class] _messageForError:error]));
      }
    } else {
      resolve(value);
    }
...
ABI40_0_0UM_EXPORT_METHOD_AS(deleteValueWithKeyAsync,
                    ...
                    rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
  NSString *validatedKey = [self validatedKey:key];
  if (!validatedKey) {
    reject(@"E_SECURESTORE_DELETEVALUEFAIL", nil, ABI40_0_0UMErrorWithMessage(@"Invalid key."));
  } else {
