...
@implementation ABI28_0_0ARTText
...
static void ABI28_0_0ARTFreeTextFrame(ABI28_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI28_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI28_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI28_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI28_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
