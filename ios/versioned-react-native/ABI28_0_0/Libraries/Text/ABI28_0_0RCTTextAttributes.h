...
extern NSString *const ABI28_0_0RCTTextAttributesIsHighlightedAttributeName;
extern NSString *const ABI28_0_0RCTTextAttributesTagAttributeName;
 ...
 * and <TextInput>.
 */
@interface ABI28_0_0RCTTextAttributes : NSObject <NSCopying>
...
@property (nonatomic, assign) ABI28_0_0RCTTextDecorationLineType textDecorationLine;
// Shadow
