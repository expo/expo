...
#import "ABI28_0_0RCTBackedTextInputDelegateAdapter.h"
...
@interface ABI28_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI28_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI28_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
...
@interface ABI28_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI28_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI28_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}
