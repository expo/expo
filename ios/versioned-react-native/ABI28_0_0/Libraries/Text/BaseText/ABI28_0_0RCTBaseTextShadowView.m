...
NSString *const ABI28_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName = @"ABI28_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName";

@implementation ABI28_0_0RCTBaseTextShadowView
{
  NSAttributedString *_Nullable _cachedAttributedText;
  ABI28_0_0RCTTextAttributes *_Nullable _cachedTextAttributes;
}

- (instancetype)init
{
  if (self = [super init]) {
    _textAttributes = [ABI28_0_0RCTTextAttributes new];
  }
...
{
  [super setReactABI28_0_0Tag:ReactABI28_0_0Tag];
  _textAttributes.tag = ReactABI28_0_0Tag;
}
...
{
  ABI28_0_0RCTTextAttributes *textAttributes;
  ...
  for (ABI28_0_0RCTShadowView *shadowView in self.ReactABI28_0_0Subviews) {
    // Special Case: ABI28_0_0RCTRawTextShadowView
    if ([shadowView isKindOfClass:[ABI28_0_0RCTRawTextShadowView class]]) {
      ABI28_0_0RCTRawTextShadowView *rawTextShadowView = (ABI28_0_0RCTRawTextShadowView *)shadowView;
    ...
    // Special Case: ABI28_0_0RCTBaseTextShadowView
    if ([shadowView isKindOfClass:[ABI28_0_0RCTBaseTextShadowView class]]) {
      ABI28_0_0RCTBaseTextShadowView *baseTextShadowView = (ABI28_0_0RCTBaseTextShadowView *)shadowView;
    ...
    // Generic Case: Any ABI28_0_0RCTShadowView
    ...
    [embeddedShadowViewAttributedString addAttribute:ABI28_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                                               value:shadowView
