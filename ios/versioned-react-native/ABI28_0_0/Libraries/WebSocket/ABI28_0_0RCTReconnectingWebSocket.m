...
#import "ABI28_0_0RCTReconnectingWebSocket.h"
...
@interface ABI28_0_0RCTReconnectingWebSocket () <ABI28_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI28_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  __weak ABI28_0_0RCTSRWebSocket *socket = _socket;
