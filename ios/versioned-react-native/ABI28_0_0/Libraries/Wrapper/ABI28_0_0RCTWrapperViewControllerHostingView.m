...
#import "ABI28_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI28_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI28_0_0ViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI28_0_0ViewController detachChildViewController:self.contentViewController];
}
