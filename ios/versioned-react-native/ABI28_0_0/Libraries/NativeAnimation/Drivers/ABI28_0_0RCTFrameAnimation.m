...
@interface ABI28_0_0RCTFrameAnimation ()
...
@implementation ABI28_0_0RCTFrameAnimation
{
...
{
  NSNumber *toValue = [ABI28_0_0RCTConvert NSNumber:config[@"toValue"]] ?: @1;
  NSArray<NSNumber *> *frames = [ABI28_0_0RCTConvert NSNumberArray:config[@"frames"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  NSUInteger startIndex = floor(currentDuration / ABI28_0_0RCTSingleFrameInterval);
  ...
  NSTimeInterval fromInterval = startIndex * ABI28_0_0RCTSingleFrameInterval;
  NSTimeInterval toInterval = nextIndex * ABI28_0_0RCTSingleFrameInterval;
  ...
  CGFloat frameOutput = ABI28_0_0RCTInterpolateValue(currentDuration,
                                            fromInterval,
                                            toInterval,
                                            fromFrameValue.doubleValue,
                                            toFrameValue.doubleValue,
                                            ABI28_0_0EXTRAPOLATE_TYPE_EXTEND,
                                            ABI28_0_0EXTRAPOLATE_TYPE_EXTEND);
...
{
  CGFloat outputValue = ABI28_0_0RCTInterpolateValue(frameOutput,
                                            0,
                                            1,
                                            _fromValue,
                                            _toValue,
