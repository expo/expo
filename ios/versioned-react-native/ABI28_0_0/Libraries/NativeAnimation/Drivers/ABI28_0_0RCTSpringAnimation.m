...
@interface ABI28_0_0RCTSpringAnimation ()
...
@implementation ABI28_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
                  ...
                  callBack:(nullable ABI28_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _lastVelocity = [ABI28_0_0RCTConvert CGFloat:config[@"initialVelocity"]];
...
- (void)resetAnimationConfig:(NSDictionary *)config
{
  ...
  _toValue = [ABI28_0_0RCTConvert CGFloat:config[@"toValue"]];
  _overshootClamping = [ABI28_0_0RCTConvert BOOL:config[@"overshootClamping"]];
  _restDisplacementThreshold = [ABI28_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
  _restSpeedThreshold = [ABI28_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
  _stiffness = [ABI28_0_0RCTConvert CGFloat:config[@"stiffness"]];
  _damping = [ABI28_0_0RCTConvert CGFloat:config[@"damping"]];
  _mass = [ABI28_0_0RCTConvert CGFloat:config[@"mass"]];
