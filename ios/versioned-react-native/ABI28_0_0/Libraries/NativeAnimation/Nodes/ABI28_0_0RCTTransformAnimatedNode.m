...
@implementation ABI28_0_0RCTTransformAnimatedNode
{
...
- (void)performUpdate
{
  ...
  for (NSDictionary *transformConfig in transformConfigs) {
    ...
    if ([type isEqualToString: @"animated"]) {
      ...
      ABI28_0_0RCTAnimatedNode *node = [self.parentNodes objectForKey:nodeTag];
      if (![node isKindOfClass:[ABI28_0_0RCTValueAnimatedNode class]]) {
        continue;
      }
      ABI28_0_0RCTValueAnimatedNode *parentNode = (ABI28_0_0RCTValueAnimatedNode *)node;
