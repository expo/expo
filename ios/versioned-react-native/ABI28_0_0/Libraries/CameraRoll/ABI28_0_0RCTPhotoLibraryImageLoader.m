...
#import "ABI28_0_0RCTPhotoLibraryImageLoader.h"

#import <Photos/Photos.h>

#import <ReactABI28_0_0/ABI28_0_0RCTUtils.h>

@implementation ABI28_0_0RCTPhotoLibraryImageLoader

ABI28_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI28_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI28_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (!imageURL) {
    completionHandler(ABI28_0_0RCTErrorWithMessage(@"Cannot load a photo library asset with no URL"), nil);
    return ^{};
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI28_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI28_0_0RCTResizeModeContain) {
