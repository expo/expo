...
#import "ABI28_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI28_0_0/ABI28_0_0RCTConvert.h>
#import <ReactABI28_0_0/ABI28_0_0RCTImageStoreManager.h>
#import <ReactABI28_0_0/ABI28_0_0RCTRootView.h>
#import <ReactABI28_0_0/ABI28_0_0RCTUtils.h>

@interface ABI28_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI28_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI28_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI28_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI28_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI28_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI28_0_0RCTResponseSenderBlock)callback)
{
...
ABI28_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI28_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI28_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI28_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI28_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI28_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI28_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI28_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI28_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI28_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI28_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI28_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI28_0_0RCTNullIfNil(height), ABI28_0_0RCTNullIfNil(width)]];
    return;
  }
        ...
        cancelCallback:(ABI28_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI28_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI28_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI28_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
