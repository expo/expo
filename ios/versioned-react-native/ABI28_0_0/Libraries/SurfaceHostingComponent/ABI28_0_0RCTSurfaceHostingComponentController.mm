...
#import "ABI28_0_0RCTSurfaceHostingComponentController.h"
...
#import "ABI28_0_0RCTSurfaceHostingComponent+Internal.h"
#import "ABI28_0_0RCTSurfaceHostingComponent.h"
#import "ABI28_0_0RCTSurfaceHostingComponentState.h"

@interface ABI28_0_0RCTSurfaceHostingComponentController() <ABI28_0_0RCTSurfaceDelegate>
@end

@implementation ABI28_0_0RCTSurfaceHostingComponentController {
  ABI28_0_0RCTSurface *_surface;
}

- (instancetype)initWithComponent:(ABI28_0_0RCTSurfaceHostingComponent *)component
{
...
- (void)didUpdateComponent
{
  ...
  [self updateSurfaceWithComponent:(ABI28_0_0RCTSurfaceHostingComponent *)self.component];
}
...
- (void)updateSurfaceWithComponent:(ABI28_0_0RCTSurfaceHostingComponent *)component
{
  // Updating `surface`
  ABI28_0_0RCTSurface *const surface = component.surface;
  if (surface != _surface) {
...
{
  [self.component updateState:^(ABI28_0_0RCTSurfaceHostingComponentState *state) {
    return [ABI28_0_0RCTSurfaceHostingComponentState newWithStage:state.stage
...
{
  [self.component updateState:^(ABI28_0_0RCTSurfaceHostingComponentState *state) {
    return [ABI28_0_0RCTSurfaceHostingComponentState newWithStage:stage
...
{
  return ((ABI28_0_0RCTSurfaceHostingComponent *)self.component).options.synchronousStateUpdates && ABI28_0_0RCTIsMainQueue() ? CKUpdateModeSynchronous : CKUpdateModeAsynchronous;
}
...
- (void)mountSurfaceView
{
  ...
  ABI28_0_0RCTAssert([superview.subviews count] <= 1, @"Should never have more than a single stateful subview.");
