...
#if !TARGET_OS_TV
@implementation ABI28_0_0RCTConvert (ABI28_0_0EXStatusBar)
...
@interface ABI28_0_0EXStatusBarManager ()

@property (nonatomic, strong) NSMutableDictionary *capturedStatusBarProperties;

@end

@implementation ABI28_0_0EXStatusBarManager

+ (NSString *)moduleName { return @"ABI28_0_0RCTStatusBarManager"; }
 ...
 */
ABI28_0_0RCT_REMAP_METHOD(_captureProperties,
                 _capturePropertiesWithResolver:(ABI28_0_0RCTPromiseResolveBlock)resolve
 ...
 *  Normally nobody should use this method because it bypasses the JS state used by the StatusBar component.
 */
ABI28_0_0RCT_EXPORT_METHOD(_applyPropertiesAndForget:(NSDictionary *)properties)
{
...
{
  UIApplication *currentApplication = ABI28_0_0RCTSharedApplication();
  return @{
