...
#import "ABI28_0_0EXCalendar.h"
#import "ABI28_0_0EXCalendarConverter.h"
...
@implementation ABI28_0_0EXCalendar

@synthesize bridge = _bridge;

ABI28_0_0EX_EXPORT_SCOPED_MODULE(ExponentCalendar, PermissionsManager);
...
ABI28_0_0RCT_EXPORT_METHOD(getCalendarsAsync:(NSString *)typeString resolver:(ABI28_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI28_0_0EXPermissions statusForPermissions:[ABI28_0_0EXCalendarRequester permissions]] != ABI28_0_0EXPermissionStatusGranted ||
  ...
  resolve([ABI28_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI28_0_0RCT_EXPORT_METHOD(saveCalendarAsync:(NSDictionary *)details resolver:(ABI28_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI28_0_0EXPermissions statusForPermissions:[ABI28_0_0EXCalendarRequester permissions]] != ABI28_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  NSString *title = [ABI28_0_0RCTConvert NSString:details[@"title"]];
  NSNumber *color = [ABI28_0_0RCTConvert NSNumber:details[@"color"]];
  NSString *sourceId = [ABI28_0_0RCTConvert NSString:details[@"sourceId"]];
  NSString *type = [ABI28_0_0RCTConvert NSString:details[@"entityType"]];
  NSString *calendarId = [ABI28_0_0RCTConvert NSString:details[@"id"]];
  ...
  if (color) {
    calendar.CGColor = [ABI28_0_0RCTConvert UIColor:color].CGColor;
...
ABI28_0_0RCT_EXPORT_METHOD(deleteCalendarAsync:(NSString *)calendarId resolver:(ABI28_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI28_0_0EXPermissions statusForPermissions:[ABI28_0_0EXCalendarRequester permissions]] != ABI28_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
...
ABI28_0_0RCT_EXPORT_METHOD(getEventsAsync:(NSDate *)startDate endDate:(NSDate *)endDate calendars:(NSArray *)calendars resolver:(ABI28_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI28_0_0EXPermissions statusForPermissions:[ABI28_0_0EXCalendarRequester permissions]] != ABI28_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  if (calendarEvents) {
    resolve([ABI28_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI28_0_0RCT_EXPORT_METHOD(getEventByIdAsync:(NSString *)eventId startDate:(NSDate *)startDate resolver:(ABI28_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI28_0_0EXPermissions statusForPermissions:[ABI28_0_0EXCalendarRequester permissions]] != ABI28_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  if (calendarEvent) {
    resolve([ABI28_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI28_0_0RCT_EXPORT_METHOD(saveEventAsync:(NSDictionary *)details options:(NSDictionary *)options resolver:(ABI28_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI28_0_0EXPermissions statusForPermissions:[ABI28_0_0EXCalendarRequester permissions]] != ABI28_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  if (details[@"calendarId"]) {
    calendarId = [ABI28_0_0RCTConvert NSString:details[@"calendarId"]];
  }
  NSString *eventId = [ABI28_0_0RCTConvert NSString:details[@"id"]];
  NSString *title = [ABI28_0_0RCTConvert NSString:details[@"title"]];
  NSString *location = [ABI28_0_0RCTConvert NSString:details[@"location"]];
  NSDate *startDate = [ABI28_0_0RCTConvert NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI28_0_0RCTConvert NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI28_0_0RCTConvert NSDate:details[@"instanceStartDate"]];
  NSNumber *allDay = [ABI28_0_0RCTConvert NSNumber:details[@"allDay"]];
  NSString *notes = [ABI28_0_0RCTConvert NSString:details[@"notes"]];
  NSString *timeZone = [ABI28_0_0RCTConvert NSString:details[@"timeZone"]];
  NSString *url = [ABI28_0_0RCTConvert NSString:details[@"url"]];
  NSArray *alarms = [ABI28_0_0RCTConvert NSArray:details[@"alarms"]];
  NSDictionary *recurrenceRule = [ABI28_0_0RCTConvert NSDictionary:details[@"recurrenceRule"]];
  NSString *availability = [ABI28_0_0RCTConvert NSString:details[@"availability"]];
  ...
  if (recurrenceRule) {
    NSString *frequency = [ABI28_0_0RCTConvert NSString:recurrenceRule[@"frequency"]];
    NSInteger interval = [ABI28_0_0RCTConvert NSInteger:recurrenceRule[@"interval"]];
    NSInteger occurrence = [ABI28_0_0RCTConvert NSInteger:recurrenceRule[@"occurrence"]];
    NSDate *endDate = nil;
    if (recurrenceRule[@"endDate"]) {
      endDate = [ABI28_0_0RCTConvert NSDate:recurrenceRule[@"endDate"]];
    }
...
ABI28_0_0RCT_EXPORT_METHOD(deleteEventAsync:(NSDictionary *)event options:(NSDictionary *)options resolver:(ABI28_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI28_0_0EXPermissions statusForPermissions:[ABI28_0_0EXCalendarRequester permissions]] != ABI28_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  NSDate *instanceStartDate = [ABI28_0_0RCTConvert NSDate:event[@"instanceStartDate"]];
...
ABI28_0_0RCT_EXPORT_METHOD(getAttendeesForEventAsync:(NSDictionary *)event resolver:(ABI28_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI28_0_0EXPermissions statusForPermissions:[ABI28_0_0EXCalendarRequester permissions]] != ABI28_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  if (item.hasAttendees) {
    resolve([ABI28_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI28_0_0RCT_EXPORT_METHOD(getRemindersAsync:(NSDate * _Nullable)startDate endDate:(NSDate * _Nullable)endDate calendars:(NSArray *)calendars status:(NSString * _Nullable)status resolver:(ABI28_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI28_0_0EXPermissions statusForPermissions:[ABI28_0_0EXRemindersRequester permissions]] != ABI28_0_0EXPermissionStatusGranted ||
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI28_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI28_0_0RCT_EXPORT_METHOD(getReminderByIdAsync:(NSString *)reminderId resolver:(ABI28_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI28_0_0EXPermissions statusForPermissions:[ABI28_0_0EXRemindersRequester permissions]] != ABI28_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"reminders" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing reminders permission.", nil);
  ...
  if (reminder) {
    ...
    resolve([ABI28_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI28_0_0RCT_EXPORT_METHOD(saveReminderAsync:(NSDictionary *)details resolver:(ABI28_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI28_0_0EXPermissions statusForPermissions:[ABI28_0_0EXRemindersRequester permissions]] != ABI28_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"reminders" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing reminders permission.", nil);
  ...
  NSString *reminderId = [ABI28_0_0RCTConvert NSString:details[@"id"]];
  NSDate *startDate = [ABI28_0_0RCTConvert NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI28_0_0RCTConvert NSDate:details[@"dueDate"]];
  NSNumber *completed = [ABI28_0_0RCTConvert NSNumber:details[@"completed"]];
  NSDate *completionDate = [ABI28_0_0RCTConvert NSDate:details[@"completionDate"]];
  NSString *title = [ABI28_0_0RCTConvert NSString:details[@"title"]];
  NSString *location = [ABI28_0_0RCTConvert NSString:details[@"location"]];
  NSString *notes = [ABI28_0_0RCTConvert NSString:details[@"notes"]];
  NSString *timeZone = [ABI28_0_0RCTConvert NSString:details[@"timeZone"]];
...
ABI28_0_0RCT_EXPORT_METHOD(deleteReminderAsync:(NSString *)reminderId resolver:(ABI28_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI28_0_0EXPermissions statusForPermissions:[ABI28_0_0EXRemindersRequester permissions]] != ABI28_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"reminders" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing reminders permission.", nil);
...
ABI28_0_0RCT_EXPORT_METHOD(getSourcesAsync:(ABI28_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI28_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI28_0_0RCT_EXPORT_METHOD(getSourceByIdAsync:(NSString *)sourceId resolver:(ABI28_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve([ABI28_0_0EXCalendarConverter serializeSource:source]);
}
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI28_0_0RCTConvert NSDate:alarm[@"absoluteDate"]];
  NSNumber *relativeOffset = [ABI28_0_0RCTConvert NSNumber:alarm[@"relativeOffset"]];
