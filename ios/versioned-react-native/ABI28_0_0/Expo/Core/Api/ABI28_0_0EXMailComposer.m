...
#import "ABI28_0_0EXMailComposer.h"
...
@interface ABI28_0_0EXMailComposer ()
...
@implementation ABI28_0_0EXMailComposer

ABI28_0_0RCT_EXPORT_MODULE(ExponentMailComposer);
...
ABI28_0_0RCT_EXPORT_METHOD(composeAsync:(NSDictionary *)options
                  ...
                  rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    [ABI28_0_0RCTPresentedViewController() presentViewController:composeController animated:YES completion:nil];
  });
}
