...
#import "ABI28_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI28_0_0EXFingerprint

ABI28_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI28_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI28_0_0RCTPromiseResolveBlock)resolve
...
ABI28_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI28_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI28_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
