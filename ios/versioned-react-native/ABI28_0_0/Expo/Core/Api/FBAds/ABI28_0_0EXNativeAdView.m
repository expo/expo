...
@interface ABI28_0_0EXNativeAdView ()
...
@implementation ABI28_0_0EXNativeAdView
...
- (void)setNativeAd:(FBNativeAd *)nativeAd
{
  ...
  [_nativeAd registerViewForInteraction:self mediaView:_mediaView iconView:nil viewController:ABI28_0_0RCTPresentedViewController() clickableViews:@[self]];
}
