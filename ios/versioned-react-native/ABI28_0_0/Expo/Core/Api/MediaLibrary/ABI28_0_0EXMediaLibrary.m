...
#import "ABI28_0_0EXMediaLibrary.h"
...
NSString *const ABI28_0_0EXAssetMediaTypeAudio = @"audio";
NSString *const ABI28_0_0EXAssetMediaTypePhoto = @"photo";
NSString *const ABI28_0_0EXAssetMediaTypeVideo = @"video";
NSString *const ABI28_0_0EXAssetMediaTypeUnknown = @"unknown";
NSString *const ABI28_0_0EXAssetMediaTypeAll = @"all";

NSString *const ABI28_0_0EXMediaLibraryDidChangeEvent = @"mediaLibraryDidChange";

@interface ABI28_0_0EXMediaLibrary ()

@property (nonatomic, weak) id<ABI28_0_0EXPermissionsScopedModuleDelegate> kernelPermissionsServiceDelegate;
@property (nonatomic, strong) PHFetchResult *allAssetsFetchResult;

@end

@implementation ABI28_0_0EXMediaLibrary

@synthesize bridge = _bridge;

ABI28_0_0EX_EXPORT_SCOPED_MODULE(ExponentMediaLibrary, PermissionsManager);

- (instancetype)initWithExperienceId:(NSString *)experienceId kernelServiceDelegate:(id<ABI28_0_0EXPermissionsScopedModuleDelegate>)kernelServiceInstance params:(NSDictionary *)params
{
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"MediaType": @{
               @"audio": ABI28_0_0EXAssetMediaTypeAudio,
               @"photo": ABI28_0_0EXAssetMediaTypePhoto,
               @"video": ABI28_0_0EXAssetMediaTypeVideo,
               @"unknown": ABI28_0_0EXAssetMediaTypeUnknown,
               @"all": ABI28_0_0EXAssetMediaTypeAll,
               },
           @"SortBy": @{
               @"default": @"default",
               @"id": @"id",
           ...
           @"CHANGE_LISTENER_NAME": ABI28_0_0EXMediaLibraryDidChangeEvent,
           };
}

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI28_0_0EXMediaLibraryDidChangeEvent];
}

ABI28_0_0RCT_REMAP_METHOD(createAssetAsync,
                 ...
                 reject:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  ...
  PHAssetMediaType assetType = [ABI28_0_0EXMediaLibrary _assetTypeForUri:localUri];
  ...
  if (!([_bridge.scopedModules.fileSystem permissionsForURI:assetUrl] & ABI28_0_0EXFileSystemPermissionRead)) {
  ...
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    ...
    if (success) {
      PHAsset *asset = [ABI28_0_0EXMediaLibrary _getAssetById:assetPlaceholder.localIdentifier];
      resolve([ABI28_0_0EXMediaLibrary _exportAsset:asset]);
    } else {
...
ABI28_0_0RCT_REMAP_METHOD(addAssetsToAlbumAsync,
                 ...
                 reject:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  ...
  [ABI28_0_0EXMediaLibrary _addAssets:assetIds toAlbum:albumId withCallback:^(BOOL success, NSError *error) {
    if (error) {
...
ABI28_0_0RCT_REMAP_METHOD(removeAssetsFromAlbumAsync,
                 ...
                 reject:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  ...
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    PHAssetCollection *collection = [ABI28_0_0EXMediaLibrary _getAlbumById:albumId];
    PHFetchResult *assets = [ABI28_0_0EXMediaLibrary _getAssetsByIds:assetIds];
...
ABI28_0_0RCT_REMAP_METHOD(deleteAssetsAsync,
...
ABI28_0_0RCT_EXPORT_METHOD(getAlbumsAsync:(ABI28_0_0RCTPromiseResolveBlock)resolve
                  reject:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  if (![self _checkPermissions:reject]) {
    return;
  ...
  NSArray<NSDictionary *> *albums = [ABI28_0_0EXMediaLibrary _exportCollections:fetchResult];
  
  resolve(albums);
}

ABI28_0_0RCT_REMAP_METHOD(getMomentsAsync,
                 getMoments:(ABI28_0_0RCTPromiseResolveBlock)resolve
                 reject:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  if (![self _checkPermissions:reject]) {
    return;
...
ABI28_0_0RCT_REMAP_METHOD(getAlbumAsync,
                 ...
                 reject:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  ...
  PHAssetCollection *collection = [ABI28_0_0EXMediaLibrary _getAlbumWithTitle:title];
  resolve([ABI28_0_0EXMediaLibrary _exportCollection:collection]);
}

ABI28_0_0RCT_REMAP_METHOD(createAlbumAsync,
                 ...
                 reject:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  ...
  [ABI28_0_0EXMediaLibrary _createAlbumWithTitle:title completion:^(PHAssetCollection *collection, NSError *error) {
    if (collection) {
      if (assetId) {
        [ABI28_0_0EXMediaLibrary _addAssets:@[assetId] toAlbum:collection.localIdentifier withCallback:^(BOOL success, NSError *error) {
          if (success) {
            resolve([ABI28_0_0EXMediaLibrary _exportCollection:collection]);
          } else {
...
ABI28_0_0RCT_REMAP_METHOD(getAssetInfoAsync,
                 ...
                 reject:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  ...
  PHAsset *asset = [ABI28_0_0EXMediaLibrary _getAssetById:assetId];
  
  if (asset) {
    NSMutableDictionary *result = [ABI28_0_0EXMediaLibrary _exportAssetInfo:asset];
...
ABI28_0_0RCT_REMAP_METHOD(getAssetsAsync,
                 ...
                 reject:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (after) {
    cursor = [ABI28_0_0EXMediaLibrary _getAssetById:after];
  ...
  if (albumId) {
    collection = [ABI28_0_0EXMediaLibrary _getAlbumById:albumId];
  ...
  if (mediaType && [mediaType count] > 0) {
    NSMutableArray<NSNumber *> *assetTypes = [ABI28_0_0EXMediaLibrary _convertMediaTypes:mediaType];
  ...
  if (sortBy && sortBy.count > 0) {
    fetchOptions.sortDescriptors = [ABI28_0_0EXMediaLibrary _prepareSortDescriptors:sortBy];
  }
  ...
  if (fetchOptions.sortDescriptors.count == 0) {
    ...
    for (NSInteger i = startIndex; i >= endIndex; i--) {
      ...
      [assets addObject:[ABI28_0_0EXMediaLibrary _exportAsset:asset]];
    }
...
- (void)startObserving
{
  _allAssetsFetchResult = [ABI28_0_0EXMediaLibrary _getAllAssets];
    ...
    if (changeDetails != nil) {
      ...
      if (changeDetails.hasIncrementalChanges && (changeDetails.insertedObjects.count > 0 || changeDetails.removedObjects.count > 0)) {
        ...
        for (PHAsset *asset in changeDetails.insertedObjects) {
          [insertedAssets addObject:[ABI28_0_0EXMediaLibrary _exportAsset:asset]];
        }
        for (PHAsset *asset in changeDetails.removedObjects) {
          [deletedAssets addObject:[ABI28_0_0EXMediaLibrary _exportAsset:asset]];
        }
        
        [self sendEventWithName:ABI28_0_0EXMediaLibraryDidChangeEvent body:body];
      }
    }
  }
}
...
{
  if (assetId) {
    return [ABI28_0_0EXMediaLibrary _getAssetsByIds:@[assetId]].firstObject;
  }
  return nil;
}
...
+ (void)_ensureAlbumWithTitle:(nonnull NSString *)title completion:(void(^)(PHAssetCollection *collection, NSError *error))completion
{
  ...
  [ABI28_0_0EXMediaLibrary _createAlbumWithTitle:title completion:completion];
}
...
+ (NSDictionary *)_exportAsset:(PHAsset *)asset
{
  if (asset) {
    ...
    return @{
             ...
             @"filename": fileName,
             @"uri": [ABI28_0_0EXMediaLibrary _assetUriForLocalId:asset.localIdentifier andExtension:assetExtension],
             @"mediaType": [ABI28_0_0EXMediaLibrary _stringifyMediaType:asset.mediaType],
             @"mediaSubtypes": [ABI28_0_0EXMediaLibrary _stringifyMediaSubtypes:asset.mediaSubtypes],
             @"width": @(asset.pixelWidth),
             @"height": @(asset.pixelHeight),
             @"creationTime": [ABI28_0_0EXMediaLibrary _exportDate:asset.creationDate],
             @"modificationTime": [ABI28_0_0EXMediaLibrary _exportDate:asset.modificationDate],
...
{
  NSMutableDictionary *assetDict = [[ABI28_0_0EXMediaLibrary _exportAsset:asset] mutableCopy];
  
  if (assetDict) {
    assetDict[@"location"] = [ABI28_0_0EXMediaLibrary _exportLocation:asset.location];
...
+ (NSDictionary *)_exportCollection:(PHAssetCollection *)collection
{
  if (collection) {
    return @{
             @"id": [ABI28_0_0EXMediaLibrary _assetIdFromLocalId:collection.localIdentifier],
             @"title": collection.localizedTitle ?: [NSNull null],
             @"type": [ABI28_0_0EXMediaLibrary _stringifyAlbumType:collection.assetCollectionType],
             @"assetCount": [ABI28_0_0EXMediaLibrary _assetCountOfCollection:collection],
             @"startTime": [ABI28_0_0EXMediaLibrary _exportDate:collection.startDate],
             @"endTime": [ABI28_0_0EXMediaLibrary _exportDate:collection.endDate],
             @"approximateLocation": [ABI28_0_0EXMediaLibrary _exportLocation:collection.approximateLocation],
...
+ (NSArray *)_exportCollections:(PHFetchResult *)collections
{
  ...
  for (PHAssetCollection *collection in collections) {
    [albums addObject:[ABI28_0_0EXMediaLibrary _exportCollection:collection]];
  }
  return [albums copy];
}
...
{
  NSString *assetId = [ABI28_0_0EXMediaLibrary _assetIdFromLocalId:localId];
...
+ (NSString *)_stringifyMediaType:(PHAssetMediaType)mediaType
{
  switch (mediaType) {
    case PHAssetMediaTypeAudio:
      return ABI28_0_0EXAssetMediaTypeAudio;
    case PHAssetMediaTypeImage:
      return ABI28_0_0EXAssetMediaTypePhoto;
    case PHAssetMediaTypeVideo:
      return ABI28_0_0EXAssetMediaTypeVideo;
    default:
      return ABI28_0_0EXAssetMediaTypeUnknown;
  }
}

+ (PHAssetMediaType)_convertMediaType:(NSString *)mediaType
{
  if ([mediaType isEqualToString:ABI28_0_0EXAssetMediaTypeAudio]) {
    return PHAssetMediaTypeAudio;
  }
  if ([mediaType isEqualToString:ABI28_0_0EXAssetMediaTypePhoto]) {
    return PHAssetMediaTypeImage;
  }
  if ([mediaType isEqualToString:ABI28_0_0EXAssetMediaTypeVideo]) {
    return PHAssetMediaTypeVideo;
  }
  return PHAssetMediaTypeUnknown;
}
...
+ (NSMutableArray<NSNumber *> *)_convertMediaTypes:(NSArray<NSString *> *)mediaTypes
{
  ...
  [mediaTypes enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
    if ([obj isEqualToString:ABI28_0_0EXAssetMediaTypeAll]) {
      *stop = YES;
      assetTypes = nil;
      return;
    }
    PHAssetMediaType assetType = [ABI28_0_0EXMediaLibrary _convertMediaType:obj];
...
+ (NSString *)_convertSortByKey:(NSString *)key
{
  ...
  if (value == nil) {
    ...
    @throw [NSException exceptionWithName:@"ABI28_0_0EXMediaLibrary.UNSUPPORTED_SORTBY_KEY" reason:reason userInfo:nil];
  }
  return value;
}
...
+ (NSSortDescriptor *)_sortDescriptorFrom:(id)config
{
  if ([config isKindOfClass:[NSString class]]) {
    NSString *key = [ABI28_0_0EXMediaLibrary _convertSortByKey:config];
  ...
  if ([config isKindOfClass:[NSArray class]]) {
    ...
    NSString *key = [ABI28_0_0EXMediaLibrary _convertSortByKey:sortArray[0]];
...
+ (NSArray *)_prepareSortDescriptors:(NSArray *)sortBy
{
  ...
  for (id config in sortByArray) {
    NSSortDescriptor *sortDescriptor = [ABI28_0_0EXMediaLibrary _sortDescriptorFrom:config];
...
- (BOOL)_checkPermissions:(ABI28_0_0RCTPromiseRejectBlock)reject
{
