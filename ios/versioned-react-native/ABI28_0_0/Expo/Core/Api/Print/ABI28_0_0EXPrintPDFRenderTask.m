//
//  ABI28_0_0EXPrintPDFRenderTask.m
//  Exponent
//
...
#import "ABI28_0_0EXPrintPDFRenderTask.h"

#define kLetterPaperSize CGSizeMake(612, 792)

@interface ABI28_0_0EXPrintPDFRenderTask () <UIWebViewDelegate>
...
@implementation ABI28_0_0EXPrintPDFRenderTask
...
- (void)renderWithOptions:(nonnull NSDictionary *)options completionHandler:(void(^)(NSData *))handler
{
  ...
  if (options[@"html"] != nil) {
    htmlString = [ABI28_0_0RCTConvert NSString:options[@"html"]];
  }
  
  if (options[@"width"] != nil) {
    _paperRect.size.width = [ABI28_0_0RCTConvert CGFloat:options[@"width"]];
  }
  
  if (options[@"height"] != nil) {
    _paperRect.size.height = [ABI28_0_0RCTConvert CGFloat:options[@"height"]];
  }
