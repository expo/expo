...
#if __has_include("ABI28_0_0EXGLARSessionManager.h")
#import "ABI28_0_0EXGLARSessionManager.h"
#else
#import "ABI28_0_0EXGLARSessionManagerStub.h"
#endif

@interface ABI28_0_0EXGLView ()

@property (nonatomic, weak) ABI28_0_0EXGLViewManager *viewManager;
...
@implementation ABI28_0_0EXGLView
...
- (instancetype)initWithManager:(ABI28_0_0EXGLViewManager *)viewManager
{
  if ((self = [super init])) {
    ...
    self.contentScaleFactor = ABI28_0_0RCTScreenScale();
    ...
    ABI28_0_0EXGLObjectManager *objectManager = [viewManager.bridge moduleForClass:[ABI28_0_0EXGLObjectManager class]];
    _glContext = [[ABI28_0_0EXGLContext alloc] initWithDelegate:self andManager:objectManager];
...
- (void)setOnSurfaceCreate:(ABI28_0_0RCTDirectEventBlock)onSurfaceCreate
{
...
- (void)draw
{
  ...
  // called on the JS thread to create the ABI28_0_0EXGL context and save its id (see ABI28_0_0EXGLContext.initializeContextWithBridge method).
...
#pragma mark - ABI28_0_0EXGLContextDelegate
