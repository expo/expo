...
@implementation ABI28_0_0EXDeviceMotion

ABI28_0_0EX_EXPORT_SCOPED_MODULE(ExponentDeviceMotion, SensorManager);
...
{
  return @{ @"Gravity" : @(ABI28_0_0EXGravity) };
}
