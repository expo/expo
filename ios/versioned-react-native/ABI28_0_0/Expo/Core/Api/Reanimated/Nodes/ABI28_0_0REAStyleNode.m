...
@implementation ABI28_0_0REAStyleNode
{
  NSMutableDictionary<NSString *, ABI28_0_0REANodeID> *_styleConfig;
}
...
- (id)evaluate
{
  ...
  for (NSString *prop in _styleConfig) {
    ABI28_0_0REANode *propNode = [self.nodesManager findNodeByID:_styleConfig[prop]];
