...
if (value != nil) recognizer.prop = [ABI28_0_0RCTConvert type:value]; \
} while(0)
...
@protocol ABI28_0_0RNGestureHandlerEventEmitter

- (void)sendTouchEvent:(nonnull ABI28_0_0RNGestureHandlerEvent *)event;

- (void)sendStateChangeEvent:(nonnull ABI28_0_0RNGestureHandlerStateChange *)event;

@end


@protocol ABI28_0_0RNRootViewGestureRecognizerDelegate <UIGestureRecognizerDelegate>
...
@interface ABI28_0_0RNGestureHandler : NSObject <UIGestureRecognizerDelegate> {

@protected UIGestureRecognizer *_recognizer;
@protected ABI28_0_0RNGestureHandlerState _lastState;

}

+ (nullable ABI28_0_0RNGestureHandler *)findGestureHandlerByRecognizer:(nonnull UIGestureRecognizer *)recognizer;

- (nonnull instancetype)initWithTag:(nonnull NSNumber *)tag;

@property (nonatomic, readonly, nonnull) NSNumber *tag;
@property (nonatomic, weak, nullable) id<ABI28_0_0RNGestureHandlerEventEmitter> emitter;
...
- (nullable ABI28_0_0RNGestureHandlerEventExtraData *)eventExtraData:(nonnull id)recognizer;
