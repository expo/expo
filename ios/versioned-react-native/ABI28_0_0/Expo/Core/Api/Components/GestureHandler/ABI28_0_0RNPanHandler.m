...
@interface ABI28_0_0RNBetterPanGestureRecognizer : UIPanGestureRecognizer
...
@implementation ABI28_0_0RNBetterPanGestureRecognizer {
...
@implementation ABI28_0_0RNPanGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI28_0_0RNBetterPanGestureRecognizer alloc] initWithGestureHandler:self];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    ABI28_0_0RNBetterPanGestureRecognizer *recognizer = (ABI28_0_0RNBetterPanGestureRecognizer *)_recognizer;
    ...
    if (prop != nil) {
        CGFloat dist = [ABI28_0_0RCTConvert CGFloat:prop];
        recognizer.minDistSq = dist * dist;
    }

    prop = config[@"minVelocity"];
    if (prop != nil) {
        CGFloat velocity = [ABI28_0_0RCTConvert CGFloat:prop];
        recognizer.minVelocitySq = velocity * velocity;
    }
    [recognizer updateHasCustomActivationCriteria];
}

- (ABI28_0_0RNGestureHandlerEventExtraData *)eventExtraData:(UIPanGestureRecognizer *)recognizer
{
