...
// ABI28_0_0RNBetterTapGestureRecognizer extends UIPanGestureRecognizer instead of UITapGestureRecognizer so that
...
@interface ABI28_0_0RNBetterTapGestureRecognizer : UIPanGestureRecognizer
...
@implementation ABI28_0_0RNBetterTapGestureRecognizer {
...
@implementation ABI28_0_0RNTapGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI28_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    ABI28_0_0RNBetterTapGestureRecognizer *recognizer = (ABI28_0_0RNBetterTapGestureRecognizer *)_recognizer;
    ...
    if (prop != nil) {
        recognizer.maxDelay = [ABI28_0_0RCTConvert CGFloat:prop] / 1000.0;
    }

    prop = config[@"maxDurationMs"];
    if (prop != nil) {
        recognizer.maxDuration = [ABI28_0_0RCTConvert CGFloat:prop] / 1000.0;
    }
