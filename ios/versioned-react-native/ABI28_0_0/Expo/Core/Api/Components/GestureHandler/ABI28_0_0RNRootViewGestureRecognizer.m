//
//  ABI28_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI28_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI28_0_0RNGestureHandler *otherHandler = [ABI28_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI28_0_0RCTTouchHandler class]];
}
