...
/**
 * ABI28_0_0RNSVG nodes are implemented as base UIViews. They should be implementation for all basic
 ＊interfaces for all non-defination nodes.
 */

@interface ABI28_0_0RNSVGNode : UIView
 ...
 */
extern CGFloat const ABI28_0_0M_SQRT1_2l;
extern CGFloat const ABI28_0_0RNSVG_DEFAULT_FONT_SIZE;

@property (nonatomic, strong) NSString *name;
@property (nonatomic, assign) CGFloat opacity;
@property (nonatomic, assign) ABI28_0_0RNSVGCGFCRule clipRule;
...
/**
 * get ABI28_0_0RNSVGSvgView which ownes current ABI28_0_0RNSVGNode
 */
