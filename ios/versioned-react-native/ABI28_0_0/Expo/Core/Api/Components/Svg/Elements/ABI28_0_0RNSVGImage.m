...
#import <ReactABI28_0_0/ABI28_0_0RCTImageSource.h>
#import <ReactABI28_0_0/ABI28_0_0RCTLog.h>
#import "ABI28_0_0RNSVGViewBox.h"

@implementation ABI28_0_0RNSVGImage
{
    CGImageRef _image;
    CGSize _imageSize;
}
...
- (void)setSrc:(id)src
{
    ...
    _image = CGImageRetain([ABI28_0_0RCTConvert CGImage:src]);
    ABI28_0_0RCTImageSource *source = [ABI28_0_0RCTConvert ABI28_0_0RCTImageSource:src];
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    CGAffineTransform viewbox = [ABI28_0_0RNSVGViewBox getTransform:imageBounds eRect:hitArea align:self.align meetOrSlice:self.meetOrSlice];
