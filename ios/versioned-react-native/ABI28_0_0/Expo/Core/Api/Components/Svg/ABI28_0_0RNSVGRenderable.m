...
@implementation ABI28_0_0RNSVGRenderable
{
...
- (void)setFill:(ABI28_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI28_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI28_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    if (self.stroke) {
        ...
        ABI28_0_0RNSVGCGFloatArray dash = self.strokeDasharrayData;
