...
@interface ABI28_0_0RNSVGSvgView : UIView <ABI28_0_0RNSVGContainer>
...
- (void)defineTemplate:(__kindof ABI28_0_0RNSVGNode *)template templateName:(NSString *)templateName;
