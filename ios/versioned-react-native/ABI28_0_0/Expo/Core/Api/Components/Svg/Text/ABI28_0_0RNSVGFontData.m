...
#define ABI28_0_0RNSVG_DEFAULT_KERNING 0.0
#define ABI28_0_0RNSVG_DEFAULT_WORD_SPACING 0.0
#define ABI28_0_0RNSVG_DEFAULT_LETTER_SPACING 0.0
...
ABI28_0_0RNSVGFontData *ABI28_0_0RNSVGFontData_Defaults;

@implementation ABI28_0_0RNSVGFontData

+ (instancetype)Defaults {
    if (!ABI28_0_0RNSVGFontData_Defaults) {
        ABI28_0_0RNSVGFontData *self = [ABI28_0_0RNSVGFontData alloc];
        self->fontData = nil;
        self->fontFamily = @"";
        self->fontStyle = ABI28_0_0RNSVGFontStyleNormal;
        self->fontWeight = ABI28_0_0RNSVGFontWeightNormal;
        self->fontFeatureSettings = @"";
        self->fontVariantLigatures = ABI28_0_0RNSVGFontVariantLigaturesNormal;
        self->textAnchor = ABI28_0_0RNSVGTextAnchorStart;
        self->textDecoration = ABI28_0_0RNSVGTextDecorationNone;
        self->manualKerning = false;
        self->kerning = ABI28_0_0RNSVG_DEFAULT_KERNING;
        self->fontSize = ABI28_0_0RNSVG_DEFAULT_FONT_SIZE;
        self->wordSpacing = ABI28_0_0RNSVG_DEFAULT_WORD_SPACING;
        self->letterSpacing = ABI28_0_0RNSVG_DEFAULT_LETTER_SPACING;
        ABI28_0_0RNSVGFontData_Defaults = self;
    }
    return ABI28_0_0RNSVGFontData_Defaults;
}

+ (double)toAbsoluteWithNSString:(NSString *)string
                           scale:(double)scale
                        fontSize:(double)fontSize {
    return [ABI28_0_0RNSVGPropHelper fromRelativeWithNSString:string
                                         relative:0
                                           offset:0
                                            scale:scale
                                         fontSize:fontSize];
...
+ (instancetype)initWithNSDictionary:(NSDictionary *)font
                              parent:(ABI28_0_0RNSVGFontData *)parent
                               scale:(double)scale {
    ABI28_0_0RNSVGFontData *data = [ABI28_0_0RNSVGFontData alloc];
    double parentFontSize = parent->fontSize;
    if ([font objectForKey:FONT_SIZE]) {
        NSString *string = [font objectForKey:FONT_SIZE];
        data->fontSize = [ABI28_0_0RNSVGPropHelper fromRelativeWithNSString:string
    ...
    data->fontStyle = style ? ABI28_0_0RNSVGFontStyleFromString(style) : parent->fontStyle;
    NSString* weight = [font objectForKey:FONT_WEIGHT];
    data->fontWeight = weight ? ABI28_0_0RNSVGFontWeightFromString(weight) : parent->fontWeight;
    ...
    data->fontVariantLigatures = variant ? ABI28_0_0RNSVGFontVariantLigaturesFromString(variant) : parent->fontVariantLigatures;
    NSString* anchor = [font objectForKey:TEXT_ANCHOR];
    data->textAnchor = anchor ? ABI28_0_0RNSVGTextAnchorFromString(anchor) : parent->textAnchor;
    NSString* decoration = [font objectForKey:TEXT_DECORATION];
    data->textDecoration = decoration ? ABI28_0_0RNSVGTextDecorationFromString(decoration) : parent->textDecoration;
    NSString* kerning = [font objectForKey:KERNING];
    data->manualKerning = (kerning || parent->manualKerning );
    data->kerning = kerning ? [ABI28_0_0RNSVGFontData toAbsoluteWithNSString:kerning
                                                         scale:scale
                                                      fontSize:data->fontSize ] : parent->kerning;
    NSString* wordSpacing = [font objectForKey:WORD_SPACING];
    data->wordSpacing = wordSpacing ? [ABI28_0_0RNSVGFontData toAbsoluteWithNSString:wordSpacing
                                                                 scale:scale
                                                              fontSize:data->fontSize ] : parent->wordSpacing;
    NSString* letterSpacing = [font objectForKey:LETTER_SPACING];
    data->letterSpacing = letterSpacing ? [ABI28_0_0RNSVGFontData toAbsoluteWithNSString:letterSpacing
                                                                     scale:scale
