...
extern const CLLocationDegrees ABI28_0_0AIRMapDefaultSpan;
extern const NSTimeInterval ABI28_0_0AIRMapRegionChangeObserveInterval;
extern const CGFloat ABI28_0_0AIRMapZoomBoundBuffer;
extern const NSInteger ABI28_0_0AIRMapMaxZoomLevel;

@interface ABI28_0_0AIRMap: MKMapView<ABI28_0_0SMCalloutViewDelegate>

@property (nonatomic, strong) ABI28_0_0SMCalloutView *calloutView;
...
@property (nonatomic, copy) ABI28_0_0RCTBubblingEventBlock onPanDrag;
@property (nonatomic, copy) ABI28_0_0RCTBubblingEventBlock onLongPress;
@property (nonatomic, copy) ABI28_0_0RCTDirectEventBlock onMarkerPress;
@property (nonatomic, copy) ABI28_0_0RCTDirectEventBlock onMarkerSelect;
@property (nonatomic, copy) ABI28_0_0RCTDirectEventBlock onMarkerDeselect;
@property (nonatomic, copy) ABI28_0_0RCTDirectEventBlock onMarkerDragStart;
@property (nonatomic, copy) ABI28_0_0RCTDirectEventBlock onMarkerDrag;
@property (nonatomic, copy) ABI28_0_0RCTDirectEventBlock onMarkerDragEnd;
