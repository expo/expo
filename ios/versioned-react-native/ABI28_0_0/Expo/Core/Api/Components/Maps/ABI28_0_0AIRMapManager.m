...
#import "ABI28_0_0AIRMapManager.h"
...
#import "ABI28_0_0AIRMapSnapshot.h"
...
@interface ABI28_0_0AIRMapManager() <MKMapViewDelegate>

@end

@implementation ABI28_0_0AIRMapManager
  
ABI28_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI28_0_0AIRMap *map = [ABI28_0_0AIRMap new];
    map.delegate = self;
...
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(userLocationAnnotationTitle, NSString)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(showsPointsOfInterest, BOOL)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
...
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(cacheEnabled, BOOL)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(maxDelta, CGFloat)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(minDelta, CGFloat)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(legalLabelInsets, UIEdgeInsets)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, MKMapType)
...
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(onPanDrag, ABI28_0_0RCTBubblingEventBlock)
...
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI28_0_0RCTDirectEventBlock)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI28_0_0RCTDirectEventBlock)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI28_0_0RCTDirectEventBlock)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI28_0_0RCTDirectEventBlock)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI28_0_0RCTDirectEventBlock)
ABI28_0_0RCT_EXPORT_VIEW_PROPERTY(onCalloutPress, ABI28_0_0RCTDirectEventBlock)
ABI28_0_0RCT_CUSTOM_VIEW_PROPERTY(initialRegion, MKCoordinateRegion, ABI28_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setInitialRegion:[ABI28_0_0RCTConvert MKCoordinateRegion:json]];
...
ABI28_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI28_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setRegion:[ABI28_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI28_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI28_0_0AIRMap class]]) {
            ABI28_0_0RCTLogError(@"Invalid view returned from registry, expecting ABI28_0_0AIRMap, got: %@", view);
        } else {
            [ABI28_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI28_0_0AIRMap *)view setRegion:region animated:YES];
            }];
        }
    }];
}
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI28_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI28_0_0AIRMap class]]) {
            ...
            ABI28_0_0AIRMap *mapView = (ABI28_0_0AIRMap *)view;
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI28_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI28_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ABI28_0_0AIRMapMarker *marker = (ABI28_0_0AIRMapMarker *)evaluatedObject;
                return [marker isKindOfClass:[ABI28_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
                  ...
                  rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI28_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        ABI28_0_0AIRMap *mapView = (ABI28_0_0AIRMap *)view;
        if (![view isKindOfClass:[ABI28_0_0AIRMap class]]) {
            reject(@"Invalid argument", [NSString stringWithFormat:@"Invalid view returned from registry, expecting ABI28_0_0AIRMap, got: %@", view], NULL);
        } else {
...
- (void)takeMapSnapshot:(ABI28_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI28_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI28_0_0AIRMap *map = (ABI28_0_0AIRMap *)recognizer.view;
    ...
    ABI28_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI28_0_0AIRMapPolygon class]]){
            ABI28_0_0AIRMapPolygon *polygon = (ABI28_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI28_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI28_0_0AIRMapPolyline class]]){
            ABI28_0_0AIRMapPolyline *polyline = (ABI28_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
        ...
        if ([overlay isKindOfClass:[ABI28_0_0AIRMapOverlay class]]) {
            ABI28_0_0AIRMapOverlay *imageOverlay = (ABI28_0_0AIRMapOverlay*) overlay;
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI28_0_0AIRMapPolyline class]]) {
        return ((ABI28_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI28_0_0AIRMapPolygon class]]) {
        return ((ABI28_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI28_0_0AIRMapCircle class]]) {
        return ((ABI28_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI28_0_0AIRMapUrlTile class]]) {
        return ((ABI28_0_0AIRMapUrlTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI28_0_0AIRMapLocalTile class]]) {
        return ((ABI28_0_0AIRMapLocalTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI28_0_0AIRMapOverlay class]]) {
        return ((ABI28_0_0AIRMapOverlay *)overlay).renderer;
...
- (void)mapView:(ABI28_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI28_0_0AIRMapMarker class]]) {
        [(ABI28_0_0AIRMapMarker *)view.annotation showCalloutView];
...
- (void)mapView:(ABI28_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI28_0_0AIRMapMarker class]]) {
        [(ABI28_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI28_0_0AIRMap *)mapView viewForAnnotation:(ABI28_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI28_0_0AIRMapMarker class]]) {
...
- (void)mapView:(ABI28_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI28_0_0AIRMapMarker class]]) return;
    ABI28_0_0AIRMapMarker *marker = (ABI28_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI28_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI28_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI28_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI28_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI28_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    [self _regionChanged:mapView];

    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI28_0_0AIRMapRegionChangeObserveInterval
                                                               target:self
                                                             selector:@selector(_onTick:)
                                                             userInfo:@{ ABI28_0_0RCTMapViewKey: mapView }
                                                              repeats:YES];

    [[NSRunLoop mainRunLoop] addTimer:mapView.regionChangeObserveTimer forMode:NSRunLoopCommonModes];
}

- (void)mapView:(ABI28_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI28_0_0AIRMap *)mapView
{
    if (!mapView.hasStartedRendering) {
      mapView.onMapReady(@{}); 
...
- (void)mapViewDidFinishRenderingMap:(ABI28_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
{
    [self _regionChanged:timer.userInfo[ABI28_0_0RCTMapViewKey]];
}

- (void)_regionChanged:(ABI28_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI28_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI28_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI28_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI28_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI28_0_0AIRMap *)mapView
{
...
- (MKCoordinateSpan)coordinateSpanWithMapView:(ABI28_0_0AIRMap *)mapView
                             centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                 andZoomLevel:(double)zoomLevel
{
    // convert center coordiate to pixel space
    double centerPixelX = [ABI28_0_0AIRMapManager longitudeToPixelSpaceX:centerCoordinate.longitude];
    double centerPixelY = [ABI28_0_0AIRMapManager latitudeToPixelSpaceY:centerCoordinate.latitude];

    // determine the scale value from the zoom level
    double zoomExponent = ABI28_0_0AIRMapMaxZoomLevel - zoomLevel;
    ...
    CLLocationDegrees minLng = [ABI28_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX];
    CLLocationDegrees maxLng = [ABI28_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX + scaledMapWidth];
    CLLocationDegrees longitudeDelta = maxLng - minLng;

    // find delta between top and bottom latitudes
    CLLocationDegrees minLat = [ABI28_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY];
    CLLocationDegrees maxLat = [ABI28_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY + scaledMapHeight];
...
- (void)setCenterCoordinate:(CLLocationCoordinate2D)centerCoordinate
                  zoomLevel:(double)zoomLevel
                   animated:(BOOL)animated
                    mapView:(ABI28_0_0AIRMap *)mapView
{
    // clamp large numbers to 28
    zoomLevel = MIN(zoomLevel, ABI28_0_0AIRMapMaxZoomLevel);
...
-(MKCoordinateRegion)coordinateRegionWithMapView:(ABI28_0_0AIRMap *)mapView
                                centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                    andZoomLevel:(double)zoomLevel
{
	...
	// find delta between top and bottom latitudes
	CLLocationDegrees minLat = [ABI28_0_0AIRMapManager pixelSpaceYToLatitude:topPixelY];
	CLLocationDegrees maxLat = [ABI28_0_0AIRMapManager pixelSpaceYToLatitude:bottomPixelY];
	CLLocationDegrees latitudeDelta = -1 * (maxLat - minLat);
	...
	if (adjustedCenterPoint) {
		region.center.latitude = [ABI28_0_0AIRMapManager pixelSpaceYToLatitude:((bottomPixelY + topPixelY) / 2.0)];
	}

	return region;
}

- (double) zoomLevel:(ABI28_0_0AIRMap *)mapView {
    MKCoordinateRegion region = mapView.region;

    double centerPixelX = [ABI28_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude];
    double topLeftPixelX = [ABI28_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude - region.span.longitudeDelta / 2];

    double scaledMapWidth = (centerPixelX - topLeftPixelX) * 2;
    CGSize mapSizeInPixels = mapView.bounds.size;
    double zoomScale = scaledMapWidth / mapSizeInPixels.width;
    double zoomExponent = log(zoomScale) / log(2);
    double zoomLevel = ABI28_0_0AIRMapMaxZoomLevel - zoomExponent;
