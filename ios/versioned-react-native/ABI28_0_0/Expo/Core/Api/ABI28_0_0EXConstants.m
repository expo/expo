...
ABI28_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI28_0_0EXConstants, constants)

@import UIKit.UIApplication;

@interface ABI28_0_0EXConstants ()
...
@implementation ABI28_0_0EXConstants

ABI28_0_0EX_EXPORT_SCOPED_MODULE(ExponentConstants, nil)
...
ABI28_0_0RCT_REMAP_METHOD(getWebViewUserAgentAsync,
                 getWebViewUserAgentWithResolver:(ABI28_0_0RCTPromiseResolveBlock)resolve
