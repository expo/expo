...
#import "ABI28_0_0EXWebBrowser.h"
#import "ABI28_0_0EXUnversioned.h"
#import "ABI28_0_0EXUtil.h"

@interface ABI28_0_0EXWebBrowser () <SFSafariViewControllerDelegate>

@property (nonatomic, copy) ABI28_0_0RCTPromiseResolveBlock redirectResolve;
@property (nonatomic, copy) ABI28_0_0RCTPromiseRejectBlock redirectReject;
...
NSString *ABI28_0_0EXWebBrowserErrorCode = @"ABI28_0_0EXWebBrowser";


@implementation ABI28_0_0EXWebBrowser
{
  UIStatusBarStyle _initialStatusBarStyle;
}

ABI28_0_0RCT_EXPORT_MODULE(ExponentWebBrowser)
...
ABI28_0_0RCT_EXPORT_METHOD(openAuthSessionAsync:(NSString *)authURL
...
ABI28_0_0RCT_EXPORT_METHOD(openBrowserAsync:(NSString *)authURL
                  resolver:(ABI28_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
 ...
 [ABI28_0_0RCTPresentedViewController() presentViewController:safariHackVC animated:true completion:nil];
}
...
- (void)_dismissBrowser
{
  ...
  [ABI28_0_0EXUtil performSynchronouslyOnMainThread:^{
    [ABI28_0_0RCTPresentedViewController() dismissViewControllerAnimated:YES completion:^{
...
ABI28_0_0RCT_EXPORT_METHOD(dismissBrowser) {
  [self _dismissBrowser];
}

ABI28_0_0RCT_EXPORT_METHOD(dismissAuthSession) {
  if (@available(iOS 11, *)) {
    [_authSession cancel];
    if (_redirectResolve) {
      _redirectResolve(@{
 ...
 */
- (BOOL)initializeWebBrowserWithResolver:(ABI28_0_0RCTPromiseResolveBlock)resolve andRejecter:(ABI28_0_0RCTPromiseRejectBlock)reject {
  if (_redirectResolve) {
    reject(ABI28_0_0EXWebBrowserErrorCode, @"Another WebBrowser is already being presented.", nil);
    return NO;
  }
  _redirectReject = reject;
  _redirectResolve = resolve;
  
  _initialStatusBarStyle = ABI28_0_0RCTSharedApplication().statusBarStyle;
  
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
  [ABI28_0_0RCTSharedApplication() setStatusBarStyle:UIStatusBarStyleDefault
                                   animated:YES];
#pragma clang diagnostic pop
  return YES;
}
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
  [ABI28_0_0RCTSharedApplication() setStatusBarStyle:_initialStatusBarStyle animated:YES];
#pragma clang diagnostic pop
