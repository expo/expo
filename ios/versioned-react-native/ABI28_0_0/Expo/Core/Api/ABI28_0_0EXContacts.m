...
@implementation ABI28_0_0EXContacts

ABI28_0_0EX_EXPORT_SCOPED_MODULE(ExponentContacts, PermissionsManager);
 ...
 */
ABI28_0_0RCT_EXPORT_METHOD(getContactsAsync:(NSDictionary *)options resolver:(ABI28_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI28_0_0RCTPromiseRejectBlock)reject)
{
  if (!_contactStore) {
    _contactStore = [[CNContactStore alloc] init];
  }

  if ([ABI28_0_0EXPermissions statusForPermissions:[ABI28_0_0EXContactsRequester permissions]] != ABI28_0_0EXPermissionStatusGranted ||
