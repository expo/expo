#import "ABI28_0_0RNAdMobInterstitial.h"

static NSString *const ABI28_0_0EXAdMobInterstitialDidLoad = @"interstitialDidLoad";
static NSString *const ABI28_0_0EXAdMobInterstitialDidFailToLoad = @"interstitialDidFailToLoad";
static NSString *const ABI28_0_0EXAdMobInterstitialDidOpen = @"interstitialDidOpen";
static NSString *const ABI28_0_0EXAdMobInterstitialDidClose = @"interstitialDidClose";
static NSString *const ABI28_0_0EXAdMobInterstitialWillLeaveApplication = @"interstitialWillLeaveApplication";

@implementation ABI28_0_0RNAdMobInterstitial {
...
{
  return @[
           ABI28_0_0EXAdMobInterstitialDidLoad,
           ABI28_0_0EXAdMobInterstitialDidFailToLoad,
           ABI28_0_0EXAdMobInterstitialDidOpen,
           ABI28_0_0EXAdMobInterstitialDidClose,
           ABI28_0_0EXAdMobInterstitialWillLeaveApplication,
           ];
}
...
- (void)interstitialDidReceiveAd:(GADInterstitial *)ad {
  [self _maybeSendEventWithName:ABI28_0_0EXAdMobInterstitialDidLoad body:nil];
  _requestAdResolver(nil);
  [self _cleanupRequestAdPromise];
}

- (void)interstitial:(GADInterstitial *)interstitial didFailToReceiveAdWithError:(GADRequestError *)error {
  [self _maybeSendEventWithName:ABI28_0_0EXAdMobInterstitialDidFailToLoad body:@{ @"name": [error description] }];
...
- (void)interstitialWillPresentScreen:(GADInterstitial *)ad {
  [self _maybeSendEventWithName:ABI28_0_0EXAdMobInterstitialDidOpen body:nil];
  _showAdResolver(nil);
  _showAdResolver = nil;
}

- (void)interstitialDidDismissScreen:(GADInterstitial *)ad {
  [self _maybeSendEventWithName:ABI28_0_0EXAdMobInterstitialDidClose body:nil];
}

- (void)interstitialWillLeaveApplication:(GADInterstitial *)ad {
  [self _maybeSendEventWithName:ABI28_0_0EXAdMobInterstitialWillLeaveApplication body:nil];
}
