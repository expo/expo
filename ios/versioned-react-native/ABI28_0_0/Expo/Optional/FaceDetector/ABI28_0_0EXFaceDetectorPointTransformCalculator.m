//
//  ABI28_0_0EXFaceDetectorPointTransformCalculator.m
//  Exponent
//
...
typedef NS_ENUM(NSInteger, ABI28_0_0EXTranslationEnum) {
  ABI28_0_0EXTranslateYNegativeWidth,
  ABI28_0_0EXTranslateXNegativeHeight,
  ABI28_0_0EXTranslateXYNegative,
  ABI28_0_0EXTranslateYXNegative
};

@interface ABI28_0_0EXFaceDetectorPointTransformCalculator()
...
@implementation ABI28_0_0EXFaceDetectorPointTransformCalculator
...
- (CGPoint)translation
{
  ...
  AVCaptureVideoOrientation firstOrientation = MIN(_fromOrientation, _toOrientation);
  AVCaptureVideoOrientation secondOrientation = MAX(_fromOrientation, _toOrientation);
  ABI28_0_0EXTranslationEnum enumValue = [[[self class] getTranslationDictionary][@(firstOrientation)][@(secondOrientation)] intValue];
...
- (CGPoint)translationForEnum:(ABI28_0_0EXTranslationEnum)enumValue
{
  switch (enumValue) {
    case ABI28_0_0EXTranslateXNegativeHeight:
      return CGPointMake(-_videoHeight, 0);
    case ABI28_0_0EXTranslateYNegativeWidth:
      return CGPointMake(0, -_videoWidth);
    case ABI28_0_0EXTranslateXYNegative:
      return CGPointMake(-_videoWidth, -_videoHeight);
    case ABI28_0_0EXTranslateYXNegative:
...
+ (void)initTranslationDictionary
{
  translationDictionary = @{
                            @(AVCaptureVideoOrientationPortrait): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI28_0_0EXTranslateYNegativeWidth),
                                @(AVCaptureVideoOrientationLandscapeRight) : @(ABI28_0_0EXTranslateXNegativeHeight),
                                @(AVCaptureVideoOrientationPortraitUpsideDown) : @(ABI28_0_0EXTranslateYXNegative)
                                },
                            @(AVCaptureVideoOrientationPortraitUpsideDown): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI28_0_0EXTranslateXNegativeHeight),
                                @(AVCaptureVideoOrientationLandscapeRight) : @(ABI28_0_0EXTranslateYNegativeWidth)
                                },
                            @(AVCaptureVideoOrientationLandscapeRight): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI28_0_0EXTranslateXYNegative)
                                }
                            };
}
