...
folly::Optional<Object> JSCNativeModules::createModule(const std::string& name, JSContextRef context) {
  ReactABI28_0_0Marker::logTaggedMarker(ReactABI28_0_0Marker::NATIVE_MODULE_SETUP_START, name.c_str());
  ...
  ReactABI28_0_0Marker::logTaggedMarker(ReactABI28_0_0Marker::NATIVE_MODULE_SETUP_STOP, name.c_str());
