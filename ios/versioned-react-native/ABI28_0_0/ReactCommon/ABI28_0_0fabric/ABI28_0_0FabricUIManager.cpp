...
#include "ABI28_0_0FabricUIManager.h"

#include "ABI28_0_0IFabricPlatformUIOperationManager.h"
...
ShadowNodeRef FabricUIManager::createNode(int ReactABI28_0_0Tag, std::string viewName, int rootTag, folly::dynamic props, void *instanceHandle) {
  platformUIOperationManager_->performUIOperation();
  return std::make_shared<ShadowNode>(ReactABI28_0_0Tag, viewName, rootTag, props, instanceHandle);
}
