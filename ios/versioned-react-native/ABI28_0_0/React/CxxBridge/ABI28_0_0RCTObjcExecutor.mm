...
class ABI28_0_0RCTObjcExecutor : public JSExecutor {
public:
  ABI28_0_0RCTObjcExecutor(id<ABI28_0_0RCTJavaScriptExecutor> jse,
                  ABI28_0_0RCTJavaScriptCompleteBlock errorBlock,
  ...
  void setBundleRegistry(std::unique_ptr<RAMBundleRegistry>) override {
    ABI28_0_0RCTAssert(NO, @"RAM bundles are not supported in ABI28_0_0RCTObjcExecutor");
  }
...
private:
  ...
  ABI28_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI28_0_0RCTObjcExecutorFactory::ABI28_0_0RCTObjcExecutorFactory(
  id<ABI28_0_0RCTJavaScriptExecutor> jse, ABI28_0_0RCTJavaScriptCompleteBlock errorBlock)
  : m_jse(jse)
  , m_errorBlock(errorBlock) {}

std::unique_ptr<JSExecutor> ABI28_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue) {
  return std::unique_ptr<JSExecutor>(
    new ABI28_0_0RCTObjcExecutor(m_jse, m_errorBlock, jsQueue, delegate));
}
