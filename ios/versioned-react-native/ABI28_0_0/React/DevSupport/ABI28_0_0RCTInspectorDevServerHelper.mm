...
@implementation ABI28_0_0RCTInspectorDevServerHelper

ABI28_0_0RCT_NOT_IMPLEMENTED(- (instancetype)init)

static NSMutableDictionary<NSString *, ABI28_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
...
+ (ABI28_0_0RCTInspectorPackagerConnection *)connectWithBundleURL:(NSURL *)bundleURL
{
  ...
  ABI28_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection) {
    connection = [[ABI28_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
