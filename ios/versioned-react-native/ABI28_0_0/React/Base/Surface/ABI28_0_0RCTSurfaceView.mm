...
@implementation ABI28_0_0RCTSurfaceView {
  ABI28_0_0RCTSurfaceRootView *_Nullable _rootView;
...
- (void)setRootView:(ABI28_0_0RCTSurfaceRootView *)rootView
{
...
- (void)_updateStage
{
  if (ABI28_0_0RCTSurfaceStageIsRunning(_stage)) {
