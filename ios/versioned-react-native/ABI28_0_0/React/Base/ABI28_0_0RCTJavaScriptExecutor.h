...
typedef void (^ABI28_0_0RCTJavaScriptCompleteBlock)(NSError *error);
typedef void (^ABI28_0_0RCTJavaScriptCallback)(id result, NSError *error);

/**
 * Abstracts away a JavaScript execution context - we may be running code in a
 * web view (for debugging purposes), or may be running code in a `JSContext`.
 */
@protocol ABI28_0_0RCTJavaScriptExecutor <ABI28_0_0RCTInvalidating, ABI28_0_0RCTBridgeModule>
 ...
 */
- (void)flushedQueue:(ABI28_0_0RCTJavaScriptCallback)onComplete;
...
- (void)callFunctionOnModule:(NSString *)module
                   ...
                   arguments:(NSArray *)args
                    callback:(ABI28_0_0RCTJavaScriptCallback)onComplete;
...
- (void)executeApplicationScript:(NSData *)script
                      ...
                      onComplete:(ABI28_0_0RCTJavaScriptCompleteBlock)onComplete;

- (void)injectJSONText:(NSString *)script
   asGlobalObjectNamed:(NSString *)objectName
              callback:(ABI28_0_0RCTJavaScriptCompleteBlock)onComplete;
