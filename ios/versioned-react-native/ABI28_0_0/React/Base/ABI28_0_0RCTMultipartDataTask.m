...
@interface ABI28_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI28_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI28_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI28_0_0RCTMultipartProgressCallback _progressHandler;
...
- (instancetype)initWithURL:(NSURL *)url
                partHandler:(ABI28_0_0RCTMultipartDataTaskCallback)partHandler
            progressHandler:(ABI28_0_0RCTMultipartProgressCallback)progressHandler
{
  if (self = [super init]) {
    _url = url;
...
{
  ABI28_0_0RCTMultipartStreamReader *reader = [[ABI28_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI28_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
