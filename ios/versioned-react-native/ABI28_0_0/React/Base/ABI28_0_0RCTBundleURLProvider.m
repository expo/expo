...
#import "ABI28_0_0RCTBundleURLProvider.h"

#import "ABI28_0_0RCTConvert.h"
#import "ABI28_0_0RCTDefines.h"

NSString *const ABI28_0_0RCTBundleURLProviderUpdatedNotification = @"ABI28_0_0RCTBundleURLProviderUpdatedNotification";

const NSUInteger kABI28_0_0RCTBundleURLProviderDefaultPort = ABI28_0_0RCT_METRO_PORT;

static NSString *const kABI28_0_0RCTJsLocationKey = @"ABI28_0_0RCT_jsLocation";
static NSString *const kABI28_0_0RCTEnableLiveReloadKey = @"ABI28_0_0RCT_enableLiveReload";
static NSString *const kABI28_0_0RCTEnableDevKey = @"ABI28_0_0RCT_enableDev";
static NSString *const kABI28_0_0RCTEnableMinificationKey = @"ABI28_0_0RCT_enableMinification";

@implementation ABI28_0_0RCTBundleURLProvider
...
{
  return @{
    kABI28_0_0RCTEnableLiveReloadKey: @NO,
    kABI28_0_0RCTEnableDevKey: @YES,
    kABI28_0_0RCTEnableMinificationKey: @NO,
  };
}

- (void)settingsUpdated
{
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI28_0_0RCTBundleURLProviderUpdatedNotification object:self];
}
...
static NSURL *serverRootWithHost(NSString *host)
{
  return [NSURL URLWithString:
          [NSString stringWithFormat:@"http://%@:%lu/",
           host, (unsigned long)kABI28_0_0RCTBundleURLProviderDefaultPort]];
}
...
- (NSURL *)jsBundleURLForBundleRoot:(NSString *)bundleRoot fallbackResource:(NSString *)resourceName fallbackExtension:(NSString *)extension
{
  ...
  if (!packagerServerHost) {
    ...
    return [ABI28_0_0RCTBundleURLProvider jsBundleURLForBundleRoot:bundleRoot
...
- (BOOL)enableDev
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI28_0_0RCTEnableDevKey];
}

- (BOOL)enableLiveReload
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI28_0_0RCTEnableLiveReloadKey];
}

- (BOOL)enableMinification
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI28_0_0RCTEnableMinificationKey];
}

- (NSString *)jsLocation
{
  return [[NSUserDefaults standardUserDefaults] stringForKey:kABI28_0_0RCTJsLocationKey];
}

- (void)setEnableDev:(BOOL)enableDev
{
  [self updateValue:@(enableDev) forKey:kABI28_0_0RCTEnableDevKey];
}

- (void)setEnableLiveReload:(BOOL)enableLiveReload
{
  [self updateValue:@(enableLiveReload) forKey:kABI28_0_0RCTEnableLiveReloadKey];
}

- (void)setJsLocation:(NSString *)jsLocation
{
  [self updateValue:jsLocation forKey:kABI28_0_0RCTJsLocationKey];
}

- (void)setEnableMinification:(BOOL)enableMinification
{
  [self updateValue:@(enableMinification) forKey:kABI28_0_0RCTEnableMinificationKey];
}

+ (instancetype)sharedSettings
{
  static ABI28_0_0RCTBundleURLProvider *sharedInstance;
  static dispatch_once_t once_token;
  dispatch_once(&once_token, ^{
    sharedInstance = [ABI28_0_0RCTBundleURLProvider new];
  });
