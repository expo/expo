...
@protocol ABI28_0_0RCTRootViewDelegate;
 ...
 * rootViewDidChangeIntrinsicSize method of the ABI28_0_0RCTRootViewDelegate will be called.
 */
typedef NS_ENUM(NSInteger, ABI28_0_0RCTRootViewSizeFlexibility) {
  ABI28_0_0RCTRootViewSizeFlexibilityNone           = 0,
  ABI28_0_0RCTRootViewSizeFlexibilityWidth          = 1 << 0,
  ABI28_0_0RCTRootViewSizeFlexibilityHeight         = 1 << 1,
  ABI28_0_0RCTRootViewSizeFlexibilityWidthAndHeight = ABI28_0_0RCTRootViewSizeFlexibilityWidth | ABI28_0_0RCTRootViewSizeFlexibilityHeight,
};
 ...
 */
extern NSString *const ABI28_0_0RCTContentDidAppearNotification;

/**
 * Native view used to host ReactABI28_0_0-managed views within the app. Can be used just
 * like any ordinary UIView. You can have multiple ABI28_0_0RCTRootViews on screen at
 * once, all controlled by the same JavaScript application.
 */
@interface ABI28_0_0RCTRootView : UIView
 ...
 * This initializer is intended to be used when the app has a single ABI28_0_0RCTRootView,
 * otherwise create an `ABI28_0_0RCTBridge` and pass it in via `initWithBridge:moduleName:`
 ...
 * root views, so you can use this property to initialize another ABI28_0_0RCTRootView.
 */
...
/**
 * The ReactABI28_0_0-managed contents view of the root view.
 */
...
/**
 * When set, any touches on the ABI28_0_0RCTRootView that are not matched up to any of the child
 * views will be passed to siblings of the ABI28_0_0RCTRootView. See -[UIView hitTest:withEvent:]
...
@interface ABI28_0_0RCTRootView (Deprecated)

/**
 * The intrinsic size of the root view's content. This is set right before the
 * `rootViewDidChangeIntrinsicSize` method of `ABI28_0_0RCTRootViewDelegate` is called.
