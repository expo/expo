...
extern NSString *const ABI28_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI28_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI28_0_0RCTBundleURLProvider : NSObject
