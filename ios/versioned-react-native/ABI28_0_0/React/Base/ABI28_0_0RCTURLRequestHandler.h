 ...
 */
@protocol ABI28_0_0RCTURLRequestHandler <ABI28_0_0RCTBridgeModule>
...
- (id)sendRequest:(NSURLRequest *)request
     withDelegate:(id<ABI28_0_0RCTURLRequestDelegate>)delegate;
...
/**
 * If more than one ABI28_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
