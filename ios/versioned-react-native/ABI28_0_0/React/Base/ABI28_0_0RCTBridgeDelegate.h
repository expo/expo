...
@protocol ABI28_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI28_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI28_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI28_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI28_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI28_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI28_0_0RCTBridge *)bridge;
...
*/
- (BOOL)bridge:(ABI28_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI28_0_0RCTBridge *)bridge
                 onProgress:(ABI28_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI28_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI28_0_0RCTBridge *)bridge
                  withBlock:(ABI28_0_0RCTSourceLoadBlock)loadCallback;
