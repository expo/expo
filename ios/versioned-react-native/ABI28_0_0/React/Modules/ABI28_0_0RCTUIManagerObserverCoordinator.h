...
typedef dispatch_block_t ABI28_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI28_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ReactABI28_0_0-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI28_0_0RCTUIManager's observers.
 */
@interface ABI28_0_0RCTUIManagerObserverCoordinator : NSObject <ABI28_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI28_0_0RCTUIManagerObserver` protocol for more info.
