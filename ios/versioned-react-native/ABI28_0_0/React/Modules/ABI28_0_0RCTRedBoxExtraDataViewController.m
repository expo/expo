...
@interface ABI28_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI28_0_0RCTRedBoxExtraDataCell
...
@interface ABI28_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI28_0_0RCTRedBoxExtraDataViewController
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ABI28_0_0RCTRedBoxExtraDataCell *cell =
            (ABI28_0_0RCTRedBoxExtraDataCell *)[tableView
            dequeueReusableCellWithIdentifier:reuseIdentifier];

    if (cell == nil) {
        cell = [[ABI28_0_0RCTRedBoxExtraDataCell alloc]
