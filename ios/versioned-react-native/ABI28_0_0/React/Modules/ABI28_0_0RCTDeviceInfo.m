...
#if !TARGET_OS_TV
  _currentInterfaceOrientation = [ABI28_0_0RCTSharedApplication() statusBarOrientation];
...
static BOOL ABI28_0_0RCTIsIPhoneX() {
...
static NSDictionary *ABI28_0_0RCTExportedDimensions(ABI28_0_0RCTBridge *bridge)
{
  ABI28_0_0RCTAssertMainQueue();

  ABI28_0_0RCTDimensions dimensions = ABI28_0_0RCTGetDimensions(bridge.accessibilityManager.multiplier);
...
{
  return @{
    @"Dimensions": ABI28_0_0RCTExportedDimensions(_bridge),
    // Note:
    // This prop is deprecated and will be removed right after June 01, 2018.
    // Please use this only for a quick and temporary solution.
    // Use <SafeAreaView> instead.
    @"isIPhoneX_deprecated": @(ABI28_0_0RCTIsIPhoneX()),
  };
}
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [bridge.eventDispatcher sendDeviceEventWithName:@"didUpdateDimensions"
                                        body:ABI28_0_0RCTExportedDimensions(bridge)];
...
{
  UIInterfaceOrientation nextOrientation = [ABI28_0_0RCTSharedApplication() statusBarOrientation];
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
        [_bridge.eventDispatcher sendDeviceEventWithName:@"didUpdateDimensions"
                                                    body:ABI28_0_0RCTExportedDimensions(_bridge)];
#pragma clang diagnostic pop
      }
