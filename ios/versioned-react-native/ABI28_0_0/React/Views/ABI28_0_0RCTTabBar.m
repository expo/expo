...
@interface ABI28_0_0RCTTabBar() <UITabBarControllerDelegate>

@end

@implementation ABI28_0_0RCTTabBar
{
  BOOL _tabsChanged;
...
- (void)insertReactABI28_0_0Subview:(ABI28_0_0RCTTabBarItem *)subview atIndex:(NSInteger)atIndex
{
  if (![subview isKindOfClass:[ABI28_0_0RCTTabBarItem class]]) {
    ABI28_0_0RCTLogError(@"subview should be of type ABI28_0_0RCTTabBarItem");
    return;
  }
...
- (void)removeReactABI28_0_0Subview:(ABI28_0_0RCTTabBarItem *)subview
{
  if (self.ReactABI28_0_0Subviews.count == 0) {
    ABI28_0_0RCTLogError(@"should have at least one view to remove a subview");
    return;
  }
...
- (void)layoutSubviews
{
  ...
  [self ReactABI28_0_0AddControllerToClosestParent:_tabController];
...
- (void)uiManagerDidPerformMounting
{
  ...
  if (_tabsChanged) {
    ...
    for (ABI28_0_0RCTTabBarItem *tab in [self ReactABI28_0_0Subviews]) {
      UIViewController *controller = tab.ReactABI28_0_0ViewController;
      if (!controller) {
        controller = [[ABI28_0_0RCTWrapperViewController alloc] initWithContentView:tab];
      }
  ...
  [self.ReactABI28_0_0Subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger index, __unused BOOL *stop) {

    ABI28_0_0RCTTabBarItem *tab = (ABI28_0_0RCTTabBarItem *)view;
...
- (void)tabBarController:(UITabBarController *)tabBarController didSelectViewController:(nonnull UIViewController *)viewController
{
  ...
  ABI28_0_0RCTTabBarItem *tab = (ABI28_0_0RCTTabBarItem *)self.ReactABI28_0_0Subviews[index];
