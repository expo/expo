...
@implementation ABI28_0_0RCTConvert (UITabBarSystemItem)

ABI28_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI28_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI28_0_0ViewController;
}
