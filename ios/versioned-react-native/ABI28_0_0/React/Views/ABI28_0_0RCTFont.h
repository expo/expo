...
typedef UIFont *(^ABI28_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ReactABI28_0_0 Native will use the System font for rendering by default. If you want to
 ...
 */
ABI28_0_0RCT_EXTERN void ABI28_0_0RCTSetDefaultFontHandler(ABI28_0_0RCTFontHandler handler);
ABI28_0_0RCT_EXTERN BOOL ABI28_0_0RCTHasFontHandlerSet();

@interface ABI28_0_0RCTFont : NSObject
...
@interface ABI28_0_0RCTConvert (ABI28_0_0RCTFont)
