...
#import <ABI32_0_0EXMediaLibrary/ABI32_0_0EXMediaLibrary.h>
...
NSString *const ABI32_0_0EXAssetMediaTypeAudio = @"audio";
NSString *const ABI32_0_0EXAssetMediaTypePhoto = @"photo";
NSString *const ABI32_0_0EXAssetMediaTypeVideo = @"video";
NSString *const ABI32_0_0EXAssetMediaTypeUnknown = @"unknown";
NSString *const ABI32_0_0EXAssetMediaTypeAll = @"all";

NSString *const ABI32_0_0EXMediaLibraryDidChangeEvent = @"mediaLibraryDidChange";

@interface ABI32_0_0EXMediaLibrary ()
...
@implementation ABI32_0_0EXMediaLibrary

ABI32_0_0EX_EXPORT_MODULE(ExponentMediaLibrary);
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"MediaType": @{
               @"audio": ABI32_0_0EXAssetMediaTypeAudio,
               @"photo": ABI32_0_0EXAssetMediaTypePhoto,
               @"video": ABI32_0_0EXAssetMediaTypeVideo,
               @"unknown": ABI32_0_0EXAssetMediaTypeUnknown,
               @"all": ABI32_0_0EXAssetMediaTypeAll,
               },
           @"SortBy": @{
               @"default": @"default",
               @"id": @"id",
           ...
           @"CHANGE_LISTENER_NAME": ABI32_0_0EXMediaLibraryDidChangeEvent,
           };
}

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI32_0_0EXMediaLibraryDidChangeEvent];
}

ABI32_0_0EX_EXPORT_METHOD_AS(createAssetAsync,
                    ...
                    reject:(ABI32_0_0EXPromiseRejectBlock)reject)
{
  ...
  PHAssetMediaType assetType = [ABI32_0_0EXMediaLibrary _assetTypeForUri:localUri];
  ...
  if (!([_fileSystem permissionsForURI:assetUrl] & ABI32_0_0EXFileSystemPermissionRead)) {
  ...
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    ...
    if (success) {
      PHAsset *asset = [ABI32_0_0EXMediaLibrary _getAssetById:assetPlaceholder.localIdentifier];
      resolve([ABI32_0_0EXMediaLibrary _exportAsset:asset]);
    } else {
...
ABI32_0_0EX_EXPORT_METHOD_AS(addAssetsToAlbumAsync,
                    ...
                    reject:(ABI32_0_0EXPromiseRejectBlock)reject)
{
  ...
  [ABI32_0_0EXMediaLibrary _addAssets:assetIds toAlbum:albumId withCallback:^(BOOL success, NSError *error) {
    if (error) {
...
ABI32_0_0EX_EXPORT_METHOD_AS(removeAssetsFromAlbumAsync,
                    ...
                    reject:(ABI32_0_0EXPromiseRejectBlock)reject)
{
  ...
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    PHAssetCollection *collection = [ABI32_0_0EXMediaLibrary _getAlbumById:albumId];
    PHFetchResult *assets = [ABI32_0_0EXMediaLibrary _getAssetsByIds:assetIds];
...
ABI32_0_0EX_EXPORT_METHOD_AS(deleteAssetsAsync,
...
ABI32_0_0EX_EXPORT_METHOD_AS(getAlbumsAsync,
                    getAlbums:(ABI32_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI32_0_0EXPromiseRejectBlock)reject)
{
  if (![self _checkPermissions:reject]) {
    return;
  ...
  NSArray<NSDictionary *> *albums = [ABI32_0_0EXMediaLibrary _exportCollections:fetchResult];
  
  resolve(albums);
}

ABI32_0_0EX_EXPORT_METHOD_AS(getMomentsAsync,
                    getMoments:(ABI32_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI32_0_0EXPromiseRejectBlock)reject)
{
  if (![self _checkPermissions:reject]) {
    return;
...
ABI32_0_0EX_EXPORT_METHOD_AS(getAlbumAsync,
                    ...
                    reject:(ABI32_0_0EXPromiseRejectBlock)reject)
{
  ...
  PHAssetCollection *collection = [ABI32_0_0EXMediaLibrary _getAlbumWithTitle:title];
  resolve(ABI32_0_0EXNullIfNil([ABI32_0_0EXMediaLibrary _exportCollection:collection]));
}

ABI32_0_0EX_EXPORT_METHOD_AS(createAlbumAsync,
                    ...
                    reject:(ABI32_0_0EXPromiseRejectBlock)reject)
{
  ...
  [ABI32_0_0EXMediaLibrary _createAlbumWithTitle:title completion:^(PHAssetCollection *collection, NSError *error) {
    if (collection) {
      if (assetId) {
        [ABI32_0_0EXMediaLibrary _addAssets:@[assetId] toAlbum:collection.localIdentifier withCallback:^(BOOL success, NSError *error) {
          if (success) {
            resolve(ABI32_0_0EXNullIfNil([ABI32_0_0EXMediaLibrary _exportCollection:collection]));
          } else {
...
ABI32_0_0EX_EXPORT_METHOD_AS(deleteAlbumsAsync,
                    ...
                    reject:(ABI32_0_0EXPromiseRejectBlock)reject)
{
  ...
  PHFetchResult *collections = [ABI32_0_0EXMediaLibrary _getAlbumsById:albumIds];
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    if (assetRemove) {
...
ABI32_0_0EX_EXPORT_METHOD_AS(getAssetInfoAsync,
                    ...
                    reject:(ABI32_0_0EXPromiseRejectBlock)reject)
{
  ...
  PHAsset *asset = [ABI32_0_0EXMediaLibrary _getAssetById:assetId];
  
  if (asset) {
    NSMutableDictionary *result = [ABI32_0_0EXMediaLibrary _exportAssetInfo:asset];
...
ABI32_0_0EX_EXPORT_METHOD_AS(getAssetsAsync,
                    ...
                    reject:(ABI32_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (albumId) {
    collection = [ABI32_0_0EXMediaLibrary _getAlbumById:albumId];
  ...
  if (mediaType && [mediaType count] > 0) {
    NSMutableArray<NSNumber *> *assetTypes = [ABI32_0_0EXMediaLibrary _convertMediaTypes:mediaType];
  ...
  if (sortBy && sortBy.count > 0) {
    fetchOptions.sortDescriptors = [ABI32_0_0EXMediaLibrary _prepareSortDescriptors:sortBy];
  }
  ...
  if (fetchOptions.sortDescriptors.count == 0) {
    ...
    for (NSInteger i = startIndex; i >= endIndex; i--) {
      ...
      [assets addObject:[ABI32_0_0EXMediaLibrary _exportAsset:asset]];
    }
...
- (void)startObserving
{
  _allAssetsFetchResult = [ABI32_0_0EXMediaLibrary _getAllAssets];
    ...
    if (changeDetails != nil) {
      ...
      if (changeDetails.hasIncrementalChanges && (changeDetails.insertedObjects.count > 0 || changeDetails.removedObjects.count > 0)) {
        ...
        for (PHAsset *asset in changeDetails.insertedObjects) {
          [insertedAssets addObject:[ABI32_0_0EXMediaLibrary _exportAsset:asset]];
        }
        for (PHAsset *asset in changeDetails.removedObjects) {
          [deletedAssets addObject:[ABI32_0_0EXMediaLibrary _exportAsset:asset]];
        }
        
        [_eventEmitter sendEventWithName:ABI32_0_0EXMediaLibraryDidChangeEvent body:body];
      }
    }
  }
}
...
{
  if (assetId) {
    return [ABI32_0_0EXMediaLibrary _getAssetsByIds:@[assetId]].firstObject;
  }
  return nil;
}
...
+ (void)_ensureAlbumWithTitle:(nonnull NSString *)title completion:(void(^)(PHAssetCollection *collection, NSError *error))completion
{
  ...
  [ABI32_0_0EXMediaLibrary _createAlbumWithTitle:title completion:completion];
}
...
+ (NSDictionary *)_exportAsset:(PHAsset *)asset
{
  if (asset) {
    ...
    return @{
             ...
             @"filename": fileName,
             @"uri": [ABI32_0_0EXMediaLibrary _assetUriForLocalId:asset.localIdentifier andExtension:assetExtension],
             @"mediaType": [ABI32_0_0EXMediaLibrary _stringifyMediaType:asset.mediaType],
             @"mediaSubtypes": [ABI32_0_0EXMediaLibrary _stringifyMediaSubtypes:asset.mediaSubtypes],
             @"width": @(asset.pixelWidth),
             @"height": @(asset.pixelHeight),
             @"creationTime": [ABI32_0_0EXMediaLibrary _exportDate:asset.creationDate],
             @"modificationTime": [ABI32_0_0EXMediaLibrary _exportDate:asset.modificationDate],
...
{
  NSMutableDictionary *assetDict = [[ABI32_0_0EXMediaLibrary _exportAsset:asset] mutableCopy];
  
  if (assetDict) {
    assetDict[@"location"] = [ABI32_0_0EXMediaLibrary _exportLocation:asset.location];
...
+ (nullable NSDictionary *)_exportCollection:(PHAssetCollection *)collection
{
  if (collection) {
    return @{
             @"id": [ABI32_0_0EXMediaLibrary _assetIdFromLocalId:collection.localIdentifier],
             @"title": collection.localizedTitle ?: [NSNull null],
             @"type": [ABI32_0_0EXMediaLibrary _stringifyAlbumType:collection.assetCollectionType],
             @"assetCount": [ABI32_0_0EXMediaLibrary _assetCountOfCollection:collection],
             @"startTime": [ABI32_0_0EXMediaLibrary _exportDate:collection.startDate],
             @"endTime": [ABI32_0_0EXMediaLibrary _exportDate:collection.endDate],
             @"approximateLocation": [ABI32_0_0EXMediaLibrary _exportLocation:collection.approximateLocation],
...
+ (NSArray *)_exportCollections:(PHFetchResult *)collections
{
  ...
  for (PHAssetCollection *collection in collections) {
    [albums addObject:[ABI32_0_0EXMediaLibrary _exportCollection:collection]];
  }
  return [albums copy];
}
...
{
  NSString *assetId = [ABI32_0_0EXMediaLibrary _assetIdFromLocalId:localId];
...
+ (NSString *)_stringifyMediaType:(PHAssetMediaType)mediaType
{
  switch (mediaType) {
    case PHAssetMediaTypeAudio:
      return ABI32_0_0EXAssetMediaTypeAudio;
    case PHAssetMediaTypeImage:
      return ABI32_0_0EXAssetMediaTypePhoto;
    case PHAssetMediaTypeVideo:
      return ABI32_0_0EXAssetMediaTypeVideo;
    default:
      return ABI32_0_0EXAssetMediaTypeUnknown;
  }
}

+ (PHAssetMediaType)_convertMediaType:(NSString *)mediaType
{
  if ([mediaType isEqualToString:ABI32_0_0EXAssetMediaTypeAudio]) {
    return PHAssetMediaTypeAudio;
  }
  if ([mediaType isEqualToString:ABI32_0_0EXAssetMediaTypePhoto]) {
    return PHAssetMediaTypeImage;
  }
  if ([mediaType isEqualToString:ABI32_0_0EXAssetMediaTypeVideo]) {
    return PHAssetMediaTypeVideo;
  }
  return PHAssetMediaTypeUnknown;
}
...
+ (NSMutableArray<NSNumber *> *)_convertMediaTypes:(NSArray<NSString *> *)mediaTypes
{
  ...
  [mediaTypes enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
    if ([obj isEqualToString:ABI32_0_0EXAssetMediaTypeAll]) {
      *stop = YES;
      assetTypes = nil;
      return;
    }
    PHAssetMediaType assetType = [ABI32_0_0EXMediaLibrary _convertMediaType:obj];
...
+ (NSString *)_convertSortByKey:(NSString *)key
{
  ...
  if (value == nil) {
    ...
    @throw [NSException exceptionWithName:@"ABI32_0_0EXMediaLibrary.UNSUPPORTED_SORTBY_KEY" reason:reason userInfo:nil];
  }
  return value;
}
...
+ (NSSortDescriptor *)_sortDescriptorFrom:(id)config
{
  if ([config isKindOfClass:[NSString class]]) {
    NSString *key = [ABI32_0_0EXMediaLibrary _convertSortByKey:config];
  ...
  if ([config isKindOfClass:[NSArray class]]) {
    ...
    NSString *key = [ABI32_0_0EXMediaLibrary _convertSortByKey:sortArray[0]];
...
+ (NSArray *)_prepareSortDescriptors:(NSArray *)sortBy
{
  ...
  for (id config in sortByArray) {
    NSSortDescriptor *sortDescriptor = [ABI32_0_0EXMediaLibrary _sortDescriptorFrom:config];
...
- (BOOL)_checkPermissions:(ABI32_0_0EXPromiseRejectBlock)reject
{
