...
@interface ABI32_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI32_0_0EXBarCodeScanner *barCodeScanner;
...
@implementation ABI32_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI32_0_0EXModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI32_0_0EXAppLifecycleListener)];
...
{
  ABI32_0_0EX_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI32_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI32_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI32_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI32_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI32_0_0EXBarCodeScanner *barCodeScanner = [ABI32_0_0EXBarCodeScanner new];
