...
@implementation ABI32_0_0EXGLView
...
- (instancetype)initWithModuleRegistry:(ABI32_0_0EXModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    self.contentScaleFactor = [ABI32_0_0EXUtilities screenScale];
    ...
    _glContext = [[ABI32_0_0EXGLContext alloc] initWithDelegate:self andModuleRegistry:moduleRegistry];
...
- (void)setOnSurfaceCreate:(ABI32_0_0EXDirectEventBlock)onSurfaceCreate
{
...
- (void)draw
{
  ...
  // called on the JS thread to create the ABI32_0_0EXGL context and save its id (see ABI32_0_0EXGLContext.initializeContextWithBridge method).
...
#pragma mark - ABI32_0_0EXGLContextDelegate
