...
@interface ABI32_0_0EXConstantsService ()

@property (nonatomic, strong) NSString *sessionId;

@end

@implementation ABI32_0_0EXConstantsService
...
{
  return @[@protocol(ABI32_0_0EXConstantsInterface)];
}
...
- (NSDictionary *)constants
{
  ...
  BOOL isDetached = YES;
#ifdef ABI32_0_0EXPO_CLIENT
  isDetached = NO;
#endif
#ifdef ABI32_0_0EX_DETACHED
  isDetached = YES;
#endif
