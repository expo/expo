...
#import "ABI32_0_0RCTPhotoLibraryImageLoader.h"

#import <Photos/Photos.h>

#import <ReactABI32_0_0/ABI32_0_0RCTUtils.h>

@implementation ABI32_0_0RCTPhotoLibraryImageLoader

ABI32_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI32_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI32_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (!imageURL) {
    completionHandler(ABI32_0_0RCTErrorWithMessage(@"Cannot load a photo library asset with no URL"), nil);
    return ^{};
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI32_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI32_0_0RCTResizeModeContain) {
