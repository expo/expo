...
#import "ABI32_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI32_0_0/ABI32_0_0RCTConvert.h>
#import <ReactABI32_0_0/ABI32_0_0RCTImageStoreManager.h>
#import <ReactABI32_0_0/ABI32_0_0RCTRootView.h>
#import <ReactABI32_0_0/ABI32_0_0RCTUtils.h>

@interface ABI32_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI32_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI32_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI32_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI32_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI32_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI32_0_0RCTResponseSenderBlock)callback)
{
...
ABI32_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI32_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI32_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI32_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI32_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI32_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI32_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI32_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI32_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI32_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI32_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI32_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI32_0_0RCTNullIfNil(height), ABI32_0_0RCTNullIfNil(width)]];
    return;
  }
  ...
  [_bridge.imageStoreManager storeImage:originalImage withBlock:^(NSString *tempImageTag) {
    [self _dismissPicker:picker args:tempImageTag ? @[tempImageTag, ABI32_0_0RCTNullIfNil(height), ABI32_0_0RCTNullIfNil(width)] : nil];
  }];
}
        ...
        cancelCallback:(ABI32_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI32_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI32_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI32_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
