...
#import "ABI32_0_0RCTReconnectingWebSocket.h"

#import <ReactABI32_0_0/ABI32_0_0RCTConvert.h>
#import <ReactABI32_0_0/ABI32_0_0RCTDefines.h>

#if __has_include(<ReactABI32_0_0/fishhook.h>)
#import <ReactABI32_0_0/fishhook.h>
#else
...
@interface ABI32_0_0RCTReconnectingWebSocket () <ABI32_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI32_0_0RCTReconnectingWebSocket {
  NSURL *_url;
  ABI32_0_0RCTSRWebSocket *_socket;
}
...
{
  [self stop];
  _socket = [[ABI32_0_0RCTSRWebSocket alloc] initWithURL:_url];
...
- (void)reconnect
{
  __weak ABI32_0_0RCTSRWebSocket *socket = _socket;
