...
extern NSString *const ABI32_0_0RCTTextAttributesIsHighlightedAttributeName;
extern NSString *const ABI32_0_0RCTTextAttributesTagAttributeName;
 ...
 * and <TextInput>.
 */
@interface ABI32_0_0RCTTextAttributes : NSObject <NSCopying>
...
@property (nonatomic, assign) ABI32_0_0RCTTextDecorationLineType textDecorationLine;
// Shadow
...
@property (nonatomic, assign) ABI32_0_0RCTTextTransform textTransform;
