...
NSString *const ABI32_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName = @"ABI32_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName";

@implementation ABI32_0_0RCTBaseTextShadowView
{
  NSAttributedString *_Nullable _cachedAttributedText;
  ABI32_0_0RCTTextAttributes *_Nullable _cachedTextAttributes;
}

- (instancetype)init
{
  if (self = [super init]) {
    _textAttributes = [ABI32_0_0RCTTextAttributes new];
  }
...
{
  [super setReactABI32_0_0Tag:ReactABI32_0_0Tag];
  _textAttributes.tag = ReactABI32_0_0Tag;
}
...
{
  ABI32_0_0RCTTextAttributes *textAttributes;
  ...
  for (ABI32_0_0RCTShadowView *shadowView in self.ReactABI32_0_0Subviews) {
    // Special Case: ABI32_0_0RCTRawTextShadowView
    if ([shadowView isKindOfClass:[ABI32_0_0RCTRawTextShadowView class]]) {
      ABI32_0_0RCTRawTextShadowView *rawTextShadowView = (ABI32_0_0RCTRawTextShadowView *)shadowView;
    ...
    // Special Case: ABI32_0_0RCTBaseTextShadowView
    if ([shadowView isKindOfClass:[ABI32_0_0RCTBaseTextShadowView class]]) {
      ABI32_0_0RCTBaseTextShadowView *baseTextShadowView = (ABI32_0_0RCTBaseTextShadowView *)shadowView;
    ...
    // Generic Case: Any ABI32_0_0RCTShadowView
    ...
    [embeddedShadowViewAttributedString addAttribute:ABI32_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                                               value:shadowView
