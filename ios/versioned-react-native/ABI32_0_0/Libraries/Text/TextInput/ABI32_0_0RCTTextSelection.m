...
@implementation ABI32_0_0RCTTextSelection
...
@implementation ABI32_0_0RCTConvert (ABI32_0_0RCTTextSelection)
...
+ (ABI32_0_0RCTTextSelection *)ABI32_0_0RCTTextSelection:(id)json
{
  if ([json isKindOfClass:[NSDictionary class]]) {
    ...
    return [[ABI32_0_0RCTTextSelection alloc] initWithStart:start end:end];
  }
