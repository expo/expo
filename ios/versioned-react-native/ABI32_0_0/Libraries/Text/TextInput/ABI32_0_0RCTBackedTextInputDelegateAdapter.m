...
#pragma mark - ABI32_0_0RCTBackedTextFieldDelegateAdapter (for UITextField)

static void *TextFieldSelectionObservingContext = &TextFieldSelectionObservingContext;

@interface ABI32_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI32_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI32_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}

- (instancetype)initWithTextField:(UITextField<ABI32_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  if (self = [super init]) {
...
#pragma mark - ABI32_0_0RCTBackedTextViewDelegateAdapter (for UITextView)

@interface ABI32_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI32_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI32_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}

- (instancetype)initWithTextView:(UITextView<ABI32_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  if (self = [super init]) {
    _backedTextInputView = backedTextInputView;
    backedTextInputView.delegate = self;
