...
#import "ABI32_0_0RCTMultilineTextInputView.h"

#import <ReactABI32_0_0/ABI32_0_0RCTUtils.h>

#import "ABI32_0_0RCTUITextView.h"

@implementation ABI32_0_0RCTMultilineTextInputView
{
  ABI32_0_0RCTUITextView *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI32_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI32_0_0RCTUITextView alloc] initWithFrame:self.bounds];
...
{
  ABI32_0_0RCTDirectEventBlock onScroll = self.onScroll;
