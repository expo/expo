...
#import "ABI32_0_0RCTUITextView.h"

#import <ReactABI32_0_0/ABI32_0_0RCTUtils.h>
#import <ReactABI32_0_0/UIView+ReactABI32_0_0.h>

#import "ABI32_0_0RCTBackedTextInputDelegateAdapter.h"

@implementation ABI32_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI32_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI32_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
  }
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI32_0_0RCTCeilPixelValue(placeholderSize.width), ABI32_0_0RCTCeilPixelValue(placeholderSize.height));
