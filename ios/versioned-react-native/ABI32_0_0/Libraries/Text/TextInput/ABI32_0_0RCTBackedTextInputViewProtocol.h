...
@protocol ABI32_0_0RCTBackedTextInputDelegate;

NS_ASSUME_NONNULL_BEGIN

@protocol ABI32_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI32_0_0RCTBackedTextInputDelegate> textInputDelegate;
