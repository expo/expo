...
@implementation ABI32_0_0RCTInterpolationAnimatedNode
{
  __weak ABI32_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI32_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI32_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI32_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI32_0_0RCTInterpolateValueInRange(inputValue,
                                          _inputRange,
                                          _outputRange,
                                          _extrapolateLeft,
                                          _extrapolateRight);
