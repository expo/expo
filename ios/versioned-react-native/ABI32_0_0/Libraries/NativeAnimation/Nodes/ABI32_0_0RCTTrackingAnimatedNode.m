...
@implementation ABI32_0_0RCTTrackingAnimatedNode {
...
- (void)performUpdate
{
  ...
  ABI32_0_0RCTValueAnimatedNode *node = (ABI32_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
