 ...
 */
#import "ABI32_0_0RCTNativeAnimatedModule.h"

#import "ABI32_0_0RCTNativeAnimatedNodesManager.h"

typedef void (^AnimatedOperation)(ABI32_0_0RCTNativeAnimatedNodesManager *nodesManager);

@implementation ABI32_0_0RCTNativeAnimatedModule
{
  ABI32_0_0RCTNativeAnimatedNodesManager *_nodesManager;
...
- (void)setBridge:(ABI32_0_0RCTBridge *)bridge
{
  ...
  _nodesManager = [[ABI32_0_0RCTNativeAnimatedNodesManager alloc] initWithUIManager:self.bridge.uiManager];
...
ABI32_0_0RCT_EXPORT_METHOD(createAnimatedNode:(nonnull NSNumber *)tag
                  config:(NSDictionary<NSString *, id> *)config)
{
  [self addOperationBlock:^(ABI32_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager createAnimatedNode:tag config:config];
  }];
}

ABI32_0_0RCT_EXPORT_METHOD(connectAnimatedNodes:(nonnull NSNumber *)parentTag
...
ABI32_0_0RCT_EXPORT_METHOD(disconnectAnimatedNodes:(nonnull NSNumber *)parentTag
                  childTag:(nonnull NSNumber *)childTag)
{
  [self addOperationBlock:^(ABI32_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI32_0_0RCT_EXPORT_METHOD(startAnimatingNode:(nonnull NSNumber *)animationId
...
ABI32_0_0RCT_EXPORT_METHOD(stopAnimation:(nonnull NSNumber *)animationId)
{
  [self addOperationBlock:^(ABI32_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI32_0_0RCT_EXPORT_METHOD(setAnimatedNodeValue:(nonnull NSNumber *)nodeTag
...
ABI32_0_0RCT_EXPORT_METHOD(setAnimatedNodeOffset:(nonnull NSNumber *)nodeTag
...
ABI32_0_0RCT_EXPORT_METHOD(flattenAnimatedNodeOffset:(nonnull NSNumber *)nodeTag)
{
  [self addOperationBlock:^(ABI32_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI32_0_0RCT_EXPORT_METHOD(extractAnimatedNodeOffset:(nonnull NSNumber *)nodeTag)
{
  [self addOperationBlock:^(ABI32_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI32_0_0RCT_EXPORT_METHOD(connectAnimatedNodeToView:(nonnull NSNumber *)nodeTag
...
ABI32_0_0RCT_EXPORT_METHOD(disconnectAnimatedNodeFromView:(nonnull NSNumber *)nodeTag
                  viewTag:(nonnull NSNumber *)viewTag)
{
  [self addPreOperationBlock:^(ABI32_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI32_0_0RCT_EXPORT_METHOD(dropAnimatedNode:(nonnull NSNumber *)tag)
{
  [self addOperationBlock:^(ABI32_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI32_0_0RCT_EXPORT_METHOD(startListeningToAnimatedNodeValue:(nonnull NSNumber *)tag)
{
  __weak id<ABI32_0_0RCTValueAnimatedNodeObserver> valueObserver = self;
  [self addOperationBlock:^(ABI32_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager startListeningToAnimatedNodeValue:tag valueObserver:valueObserver];
  }];
}

ABI32_0_0RCT_EXPORT_METHOD(stopListeningToAnimatedNodeValue:(nonnull NSNumber *)tag)
{
  [self addOperationBlock:^(ABI32_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI32_0_0RCT_EXPORT_METHOD(addAnimatedEventToView:(nonnull NSNumber *)viewTag
...
ABI32_0_0RCT_EXPORT_METHOD(removeAnimatedEventFromView:(nonnull NSNumber *)viewTag
                  eventName:(nonnull NSString *)eventName
...
- (void)uiManagerWillPerformMounting:(ABI32_0_0RCTUIManager *)uiManager
{
  ...
  [uiManager prependUIBlock:^(__unused ABI32_0_0RCTUIManager *manager, __unused NSDictionary<NSNumber *, UIView *> *viewRegistry) {
