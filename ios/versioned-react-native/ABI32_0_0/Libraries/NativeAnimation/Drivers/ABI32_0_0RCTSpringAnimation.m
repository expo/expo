...
@interface ABI32_0_0RCTSpringAnimation ()
...
@implementation ABI32_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
                  ...
                  callBack:(nullable ABI32_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _lastVelocity = [ABI32_0_0RCTConvert CGFloat:config[@"initialVelocity"]];
...
- (void)resetAnimationConfig:(NSDictionary *)config
{
  ...
  _toValue = [ABI32_0_0RCTConvert CGFloat:config[@"toValue"]];
  _overshootClamping = [ABI32_0_0RCTConvert BOOL:config[@"overshootClamping"]];
  _restDisplacementThreshold = [ABI32_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
  _restSpeedThreshold = [ABI32_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
  _stiffness = [ABI32_0_0RCTConvert CGFloat:config[@"stiffness"]];
  _damping = [ABI32_0_0RCTConvert CGFloat:config[@"damping"]];
  _mass = [ABI32_0_0RCTConvert CGFloat:config[@"mass"]];
