...
#import "ABI32_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI32_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI32_0_0ViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI32_0_0ViewController detachChildViewController:self.contentViewController];
}
