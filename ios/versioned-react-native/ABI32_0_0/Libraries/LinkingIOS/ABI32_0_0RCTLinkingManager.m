...
#import "ABI32_0_0RCTLinkingManager.h"
...
static NSString *const kOpenURLNotification = @"ABI32_0_0RCTOpenURLNotification";
...
@implementation ABI32_0_0RCTLinkingManager
...
{
  BOOL opened = [ABI32_0_0RCTSharedApplication() openURL:URL];
  if (opened) {
    resolve(nil);
  } else {
                  ...
                  reject:(__unused ABI32_0_0RCTPromiseRejectBlock)reject)
{
  ...
  BOOL canOpen = [ABI32_0_0RCTSharedApplication() canOpenURL:URL];
  resolve(@(canOpen));
}
                  ...
                  reject:(__unused ABI32_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve(ABI32_0_0RCTNullIfNil(initialURL.absoluteString));
}
