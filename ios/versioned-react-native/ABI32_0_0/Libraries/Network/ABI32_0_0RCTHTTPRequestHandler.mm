...
#import "ABI32_0_0RCTNetworking.h"

@interface ABI32_0_0RCTHTTPRequestHandler () <NSURLSessionDataDelegate>

@end

@implementation ABI32_0_0RCTHTTPRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  dispatch_once(&onceToken, ^{
    // technically, ABI32_0_0RCTHTTPRequestHandler can handle file:// as well,
    // but it's less efficient than using ABI32_0_0RCTFileRequestHandler
...
{
  id<ABI32_0_0RCTURLRequestDelegate> delegate;
  {
    std::lock_guard<std::mutex> lock(_mutex);
