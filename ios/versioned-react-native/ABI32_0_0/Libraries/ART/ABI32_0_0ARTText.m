...
@implementation ABI32_0_0ARTText
...
static void ABI32_0_0ARTFreeTextFrame(ABI32_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI32_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI32_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI32_0_0ARTTextFrame frame = self.textFrame;
