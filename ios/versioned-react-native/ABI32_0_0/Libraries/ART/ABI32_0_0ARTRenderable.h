...
@interface ABI32_0_0ARTRenderable : ABI32_0_0ARTNode

@property (nonatomic, strong) ABI32_0_0ARTBrush *fill;
...
@property (nonatomic, assign) ABI32_0_0ARTCGFloatArray strokeDash;
