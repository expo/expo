...
@interface ABI32_0_0RCTImageStoreManager : NSObject <ABI32_0_0RCTURLRequestHandler>
...
@interface ABI32_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI32_0_0RCTBridge (ABI32_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI32_0_0RCTImageStoreManager *imageStoreManager;
