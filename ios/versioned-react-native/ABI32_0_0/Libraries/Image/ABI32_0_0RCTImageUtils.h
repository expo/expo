 ...
 */
ABI32_0_0RCT_EXTERN CGRect ABI32_0_0RCTTargetRect(CGSize sourceSize, CGSize destSize,
                                CGFloat destScale, ABI32_0_0RCTResizeMode resizeMode);
 ...
 */
ABI32_0_0RCT_EXTERN CGAffineTransform ABI32_0_0RCTTransformFromTargetRect(CGSize sourceSize,
                                                        CGRect targetRect);
 ...
 */
ABI32_0_0RCT_EXTERN CGSize ABI32_0_0RCTTargetSize(CGSize sourceSize, CGFloat sourceScale,
                                CGSize destSize, CGFloat destScale,
                                ABI32_0_0RCTResizeMode resizeMode, BOOL allowUpscaling);
 ...
 */
ABI32_0_0RCT_EXTERN BOOL ABI32_0_0RCTUpscalingRequired(CGSize sourceSize, CGFloat sourceScale,
                                     CGSize destSize, CGFloat destScale,
                                     ABI32_0_0RCTResizeMode resizeMode);
 ...
 */
ABI32_0_0RCT_EXTERN UIImage *__nullable ABI32_0_0RCTDecodeImageWithData(NSData *data,
                                                      CGSize destSize,
                                                      CGFloat destScale,
                                                      ABI32_0_0RCTResizeMode resizeMode);
 ...
 */
ABI32_0_0RCT_EXTERN NSDictionary<NSString *, id> *__nullable ABI32_0_0RCTGetImageMetadata(NSData *data);
 ...
 */
ABI32_0_0RCT_EXTERN NSData *__nullable ABI32_0_0RCTGetImageData(UIImage *image, float quality);
 ...
 */
ABI32_0_0RCT_EXTERN UIImage *__nullable ABI32_0_0RCTTransformImage(UIImage *image,
                                                 CGSize destSize,
                                                 CGFloat destScale,
 ...
 */
ABI32_0_0RCT_EXTERN BOOL ABI32_0_0RCTImageHasAlpha(CGImageRef image);
