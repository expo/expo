...
#import <ReactABI32_0_0/ABI32_0_0RCTResizeMode.h>
#import <ReactABI32_0_0/ABI32_0_0RCTURLRequestHandler.h>

typedef void (^ABI32_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI32_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI32_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI32_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI32_0_0RCTImageCache <NSObject>
...
/**
 * If available, ABI32_0_0RCTImageRedirectProtocol is invoked before loading an asset.
 * Implementation should return either a new URL or nil when redirection is
 * not needed.
 */

@protocol ABI32_0_0RCTImageRedirectProtocol

- (NSURL *)redirectAssetsURL:(NSURL *)URL;

@end

@interface UIImage (ReactABI32_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI32_0_0KeyframeAnimation;

@end

@interface ABI32_0_0RCTImageLoader : NSObject <ABI32_0_0RCTBridgeModule, ABI32_0_0RCTURLRequestHandler>
...
- (instancetype)init;
- (instancetype)initWithRedirectDelegate:(id<ABI32_0_0RCTImageRedirectProtocol>)redirectDelegate NS_DESIGNATED_INITIALIZER;

/**
 * Loads the specified image at the highest available resolution.
 * Can be called from any thread, will call back on an unspecified thread.
 */
- (ABI32_0_0RCTImageLoaderCancellationBlock)loadImageWithURLRequest:(NSURLRequest *)imageURLRequest
                                                  callback:(ABI32_0_0RCTImageLoaderCompletionBlock)callback;
...
- (ABI32_0_0RCTImageLoaderCancellationBlock)loadImageWithURLRequest:(NSURLRequest *)imageURLRequest
                                                ...
                                                resizeMode:(ABI32_0_0RCTResizeMode)resizeMode
                                             progressBlock:(ABI32_0_0RCTImageLoaderProgressBlock)progressBlock
                                          partialLoadBlock:(ABI32_0_0RCTImageLoaderPartialLoadBlock)partialLoadBlock
                                           completionBlock:(ABI32_0_0RCTImageLoaderCompletionBlock)completionBlock;
 ...
 */
- (ABI32_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                           clipped:(BOOL)clipped
                                        resizeMode:(ABI32_0_0RCTResizeMode)resizeMode
 ...
 */
- (ABI32_0_0RCTImageLoaderCancellationBlock)getImageSizeForURLRequest:(NSURLRequest *)imageURLRequest
                                                       block:(void(^)(NSError *error, CGSize size))completionBlock;

/**
 * Allows developers to set their own caching implementation for
 * decoded images as long as it conforms to the ABI32_0_0RCTImageCacheDelegate
 * protocol. This method should be called in bridgeDidInitializeModule.
 */
- (void)setImageCache:(id<ABI32_0_0RCTImageCache>)cache;

@end

@interface ABI32_0_0RCTBridge (ABI32_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI32_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI32_0_0RCTImageURLLoader <ABI32_0_0RCTBridgeModule>
...
/**
 * If more than one ABI32_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI32_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 * are also bridge modules, so should be registered using ABI32_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI32_0_0RCTImageDataDecoder <ABI32_0_0RCTBridgeModule>
...
/**
 * If more than one ABI32_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
