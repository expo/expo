...
@implementation ABI32_0_0EXAdsDFPBannerView {
  DFPBannerView *_bannerView;
  id<ABI32_0_0EXEventEmitterService> _eventEmitter;
}
...
- (void)setOnSizeChange:(ABI32_0_0EXDirectEventBlock)block
{
  _onSizeChange = block;
  [self loadBanner];
}

- (void)setOnDidFailToReceiveAdWithError:(ABI32_0_0EXDirectEventBlock)block
{
