...
#include "ABI32_0_0FabricUIManager.h"

#include <glog/logging.h>

#include <ABI32_0_0fabric/ABI32_0_0components/view/ViewComponentDescriptor.h>
...
#include <ABI32_0_0fabric/ABI32_0_0core/componentDescriptor.h>
...
SharedShadowNode FabricUIManager::createNode(int tag, std::string viewName, int rootTag, folly::dynamic props, EventTarget eventTarget) {
  ...
  ComponentName componentName = componentNameByReactABI32_0_0ViewName(viewName);
