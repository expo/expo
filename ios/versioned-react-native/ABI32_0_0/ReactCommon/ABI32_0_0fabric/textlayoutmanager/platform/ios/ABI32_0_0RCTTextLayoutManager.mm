...
@implementation ABI32_0_0RCTTextLayoutManager

static NSLineBreakMode ABI32_0_0RCTNSLineBreakModeFromWritingDirection(EllipsizeMode ellipsizeMode) {
...
- (facebook::ReactABI32_0_0::Size)measureWithAttributedString:(AttributedString)attributedString
                                   ...
                                   layoutConstraints:(LayoutConstraints)layoutConstraints
{
  ...
  NSTextStorage *textStorage =
    [self _textStorageAndLayoutManagerWithAttributesString:ABI32_0_0RCTNSAttributedStringFromAttributedString(attributedString)
  ...
  return facebook::ReactABI32_0_0::Size {size.width, size.height};
}
                                                               ...
                                                               size:(CGSize)size
{
  ...
  textContainer.lineBreakMode =
    paragraphAttributes.maximumNumberOfLines > 0 ? ABI32_0_0RCTNSLineBreakModeFromWritingDirection(paragraphAttributes.ellipsizeMode) : NSLineBreakByClipping;
