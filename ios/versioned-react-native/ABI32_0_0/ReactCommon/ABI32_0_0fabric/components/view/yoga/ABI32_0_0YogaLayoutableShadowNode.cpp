...
#include "ABI32_0_0YogaLayoutableShadowNode.h"
...
void YogaLayoutableShadowNode::layout(LayoutContext layoutContext) {
  if (!getIsLayoutClean()) {
    ...
    ABI32_0_0YGNodeCalculateLayout(&yogaNode_, ABI32_0_0YGUndefined, ABI32_0_0YGUndefined, ABI32_0_0YGDirectionInherit);
  }
...
ABI32_0_0YGNode *YogaLayoutableShadowNode::yogaNodeCloneCallbackConnector(ABI32_0_0YGNode *oldYogaNode, ABI32_0_0YGNode *parentYogaNode, int childIndex) {
...
ABI32_0_0YGSize YogaLayoutableShadowNode::yogaNodeMeasureCallbackConnector(ABI32_0_0YGNode *yogaNode, float width, ABI32_0_0YGMeasureMode widthMode, float height, ABI32_0_0YGMeasureMode heightMode) {
...
void YogaLayoutableShadowNode::initializeYogaConfig(ABI32_0_0YGConfig &config) {
