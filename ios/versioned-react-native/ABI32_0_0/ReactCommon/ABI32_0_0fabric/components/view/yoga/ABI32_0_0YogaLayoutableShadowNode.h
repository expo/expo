...
protected:
   ...
   * all the time.
   */
  mutable ABI32_0_0YGNode yogaNode_;

  /*
   * Yoga config associated (only) with this particular node.
   */
  ABI32_0_0YGConfig yogaConfig_;

private:
  static void initializeYogaConfig(ABI32_0_0YGConfig &config);
  static ABI32_0_0YGNode *yogaNodeCloneCallbackConnector(ABI32_0_0YGNode *oldYogaNode, ABI32_0_0YGNode *parentYogaNode, int childIndex);
  static ABI32_0_0YGSize yogaNodeMeasureCallbackConnector(ABI32_0_0YGNode *yogaNode, float width, ABI32_0_0YGMeasureMode widthMode, float height, ABI32_0_0YGMeasureMode heightMode);
};
