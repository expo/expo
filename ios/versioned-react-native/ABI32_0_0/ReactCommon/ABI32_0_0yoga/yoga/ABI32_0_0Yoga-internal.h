...
using ABI32_0_0YGVector = std::vector<ABI32_0_0YGNodeRef>;
...
inline bool isUndefined(float value) {
  ...
  // point values are not NAN and Inf, we represent ABI32_0_0YGUndefined as 10.1E20. But
  // now if ABI32_0_0YGUndefined is involved in any mathematical operations this
...
extern const std::array<ABI32_0_0YGEdge, 4> trailing;
extern const std::array<ABI32_0_0YGEdge, 4> leading;
extern bool ABI32_0_0YGValueEqual(const ABI32_0_0YGValue a, const ABI32_0_0YGValue b);
extern const ABI32_0_0YGValue ABI32_0_0YGValueUndefined;
extern const ABI32_0_0YGValue ABI32_0_0YGValueAuto;
extern const ABI32_0_0YGValue ABI32_0_0YGValueZero;

template <std::size_t size>
bool ABI32_0_0YGValueArrayEqual(
    const std::array<ABI32_0_0YGValue, size> val1,
    const std::array<ABI32_0_0YGValue, size> val2) {
  bool areEqual = true;
  for (uint32_t i = 0; i < size && areEqual; ++i) {
    areEqual = ABI32_0_0YGValueEqual(val1[i], val2[i]);
  }
  return areEqual;
}

struct ABI32_0_0YGCachedMeasurement {
  ...
  ABI32_0_0YGCachedMeasurement()
      : availableWidth(0),
        availableHeight(0),
        widthMeasureMode((ABI32_0_0YGMeasureMode)-1),
        heightMeasureMode((ABI32_0_0YGMeasureMode)-1),
        computedWidth(-1),
        computedHeight(-1) {}

  bool operator==(ABI32_0_0YGCachedMeasurement measurement) const {
...
#define ABI32_0_0YG_MAX_CACHED_RESULT_COUNT 16

static const float kDefaultFlexGrow = 0.0f;
static const float kDefaultFlexShrink = 0.0f;
static const float kWebDefaultFlexShrink = 1.0f;

extern bool ABI32_0_0YGFloatsEqual(const float a, const float b);
extern bool ABI32_0_0YGValueEqual(const ABI32_0_0YGValue a, const ABI32_0_0YGValue b);
extern const ABI32_0_0YGValue* ABI32_0_0YGComputedEdgeValue(
