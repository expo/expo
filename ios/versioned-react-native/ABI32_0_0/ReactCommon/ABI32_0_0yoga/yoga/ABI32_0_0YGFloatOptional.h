...
struct ABI32_0_0YGFloatOptional {
 private:
  float value_;
  bool isUndefined_;

 public:
  explicit ABI32_0_0YGFloatOptional(float value);
  explicit ABI32_0_0YGFloatOptional() : value_(0), isUndefined_(true) {}
  ...
  ABI32_0_0YGFloatOptional operator+(const ABI32_0_0YGFloatOptional& op);
  bool operator>(const ABI32_0_0YGFloatOptional& op) const;
  bool operator<(const ABI32_0_0YGFloatOptional& op) const;
  bool operator>=(const ABI32_0_0YGFloatOptional& op) const;
  bool operator<=(const ABI32_0_0YGFloatOptional& op) const;
  bool operator==(const ABI32_0_0YGFloatOptional& op) const;
