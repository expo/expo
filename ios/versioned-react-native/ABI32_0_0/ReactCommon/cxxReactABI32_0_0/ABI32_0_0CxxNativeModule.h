...
#include <cxxReactABI32_0_0/ABI32_0_0CxxModule.h>
#include <cxxReactABI32_0_0/ABI32_0_0NativeModule.h>
...
public:
  ...
  void invoke(unsigned int ReactABI32_0_0MethodId, folly::dynamic&& params, int callId) override;
