...
#include "ABI32_0_0JSCNativeModules.h"
...
folly::Optional<Object> JSCNativeModules::createModule(const std::string& name, JSContextRef context) {
  ReactABI32_0_0Marker::logTaggedMarker(ReactABI32_0_0Marker::NATIVE_MODULE_SETUP_START, name.c_str());
  ...
  ReactABI32_0_0Marker::logTaggedMarker(ReactABI32_0_0Marker::NATIVE_MODULE_SETUP_STOP, name.c_str());
