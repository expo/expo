...
#import "ABI32_0_0UIView+ComponentViewProtocol.h"
...
- (void)unmountChildComponentView:(UIView<ABI32_0_0RCTComponentViewProtocol> *)childComponentView
                            index:(NSInteger)index
{
  ABI32_0_0RCTAssert(childComponentView.superview == self, @"Attempt to unmount improperly mounted component view.");
           ...
           oldLayoutMetrics:(LayoutMetrics)oldLayoutMetrics
{
  if (layoutMetrics.frame != oldLayoutMetrics.frame) {
    self.frame = ABI32_0_0RCTCGRectFromRect(layoutMetrics.frame);
  }
