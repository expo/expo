...
#import "ABI32_0_0RCTScrollViewComponentView.h"

#import <ReactABI32_0_0/ABI32_0_0RCTAssert.h>
#import <ABI32_0_0fabric/ABI32_0_0components/scrollview/ScrollViewLocalData.h>
#import <ABI32_0_0fabric/ABI32_0_0components/scrollview/ScrollViewProps.h>
#import <ABI32_0_0fabric/ABI32_0_0components/scrollview/ScrollViewEventEmitter.h>
#import <ABI32_0_0fabric/ABI32_0_0graphics/Geometry.h>

#import "ABI32_0_0RCTConversions.h"
#import "ABI32_0_0RCTEnhancedScrollView.h"

using namespace facebook::ReactABI32_0_0;

@interface ABI32_0_0RCTScrollViewComponentView () <UIScrollViewDelegate>

@property (nonatomic, assign) CGFloat scrollEventThrottle;

@end

@implementation ABI32_0_0RCTScrollViewComponentView {
  ABI32_0_0RCTEnhancedScrollView *_Nonnull _scrollView;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    _scrollView = [[ABI32_0_0RCTEnhancedScrollView alloc] initWithFrame:self.bounds];
...
#define REMAP_PROP(ReactABI32_0_0Name, localName, target) \
  if (oldScrollViewProps.ReactABI32_0_0Name != newScrollViewProps.ReactABI32_0_0Name) { \
    target.localName = newScrollViewProps.ReactABI32_0_0Name; \
  }

#define REMAP_VIEW_PROP(ReactABI32_0_0Name, localName) REMAP_PROP(ReactABI32_0_0Name, localName, self)
#define MAP_VIEW_PROP(name) REMAP_VIEW_PROP(name, name)
#define REMAP_SCROLL_VIEW_PROP(ReactABI32_0_0Name, localName) REMAP_PROP(ReactABI32_0_0Name, localName, _scrollView)
           ...
           oldLocalData:(SharedLocalData)oldLocalData
{
  ...
  CGSize contentSize = ABI32_0_0RCTCGSizeFromSize(_scrollViewLocalData->getContentSize());
...
- (void)unmountChildComponentView:(UIView<ABI32_0_0RCTComponentViewProtocol> *)childComponentView
                            index:(NSInteger)index
{
  ABI32_0_0RCTAssert(childComponentView.superview == _contentView, @"Attempt to unmount improperly mounted component view.");
...
- (ScrollViewMetrics)_scrollViewMetrics
{
  ...
  metrics.contentSize = ABI32_0_0RCTSizeFromCGSize(_scrollView.contentSize);
  metrics.contentOffset = ABI32_0_0RCTPointFromCGPoint(_scrollView.contentOffset);
  metrics.contentInset = ABI32_0_0RCTEdgeInsetsFromUIEdgeInsets(_scrollView.contentInset);
  metrics.containerSize = ABI32_0_0RCTSizeFromCGSize(_scrollView.bounds.size);
