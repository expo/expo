...
#import <ReactABI32_0_0/UIView+ComponentViewProtocol.h>
 ...
 */
@interface ABI32_0_0RCTViewComponentView : UIView <ABI32_0_0RCTComponentViewProtocol> {
@protected
  facebook::ReactABI32_0_0::LayoutMetrics _layoutMetrics;
  facebook::ReactABI32_0_0::SharedProps _props;
  facebook::ReactABI32_0_0::SharedViewEventEmitter _eventEmitter;
}
