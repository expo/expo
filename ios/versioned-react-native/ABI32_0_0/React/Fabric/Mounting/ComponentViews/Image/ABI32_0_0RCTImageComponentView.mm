...
#import "ABI32_0_0RCTImageComponentView.h"

#import <ABI32_0_0fabric/ABI32_0_0components/image/ImageEventEmitter.h>
#import <ABI32_0_0fabric/ABI32_0_0components/image/ImageLocalData.h>
#import <ABI32_0_0fabric/ABI32_0_0components/image/ImageProps.h>
#import <ABI32_0_0fabric/ABI32_0_0imagemanager/ImageRequest.h>
#import <ABI32_0_0fabric/ABI32_0_0imagemanager/ImageResponse.h>
#import <ABI32_0_0fabric/ABI32_0_0imagemanager/ABI32_0_0RCTImagePrimitivesConversions.h>

#import "ABI32_0_0RCTConversions.h"
#import "ABI32_0_0MainQueueExecutor.h"

using namespace facebook::ReactABI32_0_0;

@implementation ABI32_0_0RCTImageComponentView {
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _imageView.contentMode = (UIViewContentMode)ABI32_0_0RCTResizeModeFromImageResizeMode(defaultProps.resizeMode);
...
#pragma mark - ABI32_0_0RCTComponentViewProtocol
...
- (void)updateProps:(SharedProps)props oldProps:(SharedProps)oldProps
{
  ...
  if (oldImageProps.resizeMode != newImageProps.resizeMode) {
    if (newImageProps.resizeMode == ImageResizeMode::Repeat) {
      ...
      _imageView.contentMode = (UIViewContentMode)ABI32_0_0RCTResizeModeFromImageResizeMode(newImageProps.resizeMode);
    }
  }
...
- (void)setImage:(UIImage *)image
{
  ...
  if (imageProps.resizeMode == ImageResizeMode::Repeat) {
    image = [image resizableImageWithCapInsets:ABI32_0_0RCTUIEdgeInsetsFromEdgeInsets(imageProps.capInsets)
