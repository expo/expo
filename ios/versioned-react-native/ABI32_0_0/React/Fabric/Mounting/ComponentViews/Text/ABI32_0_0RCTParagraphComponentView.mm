...
#import "ABI32_0_0RCTParagraphComponentView.h"

#import <ABI32_0_0fabric/ABI32_0_0components/text/ParagraphLocalData.h>
#import <ABI32_0_0fabric/ABI32_0_0components/text/ParagraphProps.h>
#import <ABI32_0_0fabric/ABI32_0_0core/LocalData.h>
#import <ABI32_0_0fabric/ABI32_0_0graphics/Geometry.h>
#import <ABI32_0_0fabric/ABI32_0_0textlayoutmanager/TextLayoutManager.h>
#import <ABI32_0_0fabric/ABI32_0_0textlayoutmanager/ABI32_0_0RCTTextLayoutManager.h>
#import "ABI32_0_0RCTConversions.h"

using namespace facebook::ReactABI32_0_0;

@implementation ABI32_0_0RCTParagraphComponentView {
...
- (void)drawRect:(CGRect)rect
{
  ...
  ABI32_0_0RCTTextLayoutManager *nativeTextLayoutManager =
    (__bridge ABI32_0_0RCTTextLayoutManager *)textLayoutManager->getNativeTextLayoutManager();

  CGRect frame = ABI32_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
...
- (NSString *)accessibilityLabel
{
  ...
  return ABI32_0_0RCTNSStringFromString(_paragraphLocalData->getAttributedString().getString());
}
