...
#import "ABI32_0_0RCTScheduler.h"

#import <ABI32_0_0fabric/ABI32_0_0imagemanager/ImageManager.h>
#import <ABI32_0_0fabric/ABI32_0_0uimanager/ContextContainer.h>
#import <ABI32_0_0fabric/ABI32_0_0uimanager/Scheduler.h>
#import <ABI32_0_0fabric/ABI32_0_0uimanager/SchedulerDelegate.h>
...
public:
  ...
  void schedulerDidComputeMutationInstructions(Tag rootTag, const TreeMutationInstructionList &instructions) override {
    ABI32_0_0RCTScheduler *scheduler = (__bridge ABI32_0_0RCTScheduler *)scheduler_;
  ...
  void schedulerDidRequestPreliminaryViewAllocation(ComponentName componentName) override {
    ABI32_0_0RCTScheduler *scheduler = (__bridge ABI32_0_0RCTScheduler *)scheduler_;
    [scheduler.delegate schedulerDidRequestPreliminaryViewAllocationWithComponentName:ABI32_0_0RCTNSStringFromString(componentName, NSASCIIStringEncoding)];
  }
...
@implementation ABI32_0_0RCTScheduler {
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    void *imageLoader = (__bridge void *)[[ABI32_0_0RCTBridge currentBridge] imageLoader];
...
{
  return ABI32_0_0RCTCGSizeFromSize(_scheduler->measure(rootTag, layoutConstraints, layoutContext));
}
...
@implementation ABI32_0_0RCTScheduler (Deprecated)
