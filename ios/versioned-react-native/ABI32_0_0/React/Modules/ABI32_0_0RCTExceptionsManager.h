...
@protocol ABI32_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI32_0_0RCTExceptionsManager : NSObject <ABI32_0_0RCTBridgeModule>

- (instancetype)initWithDelegate:(id<ABI32_0_0RCTExceptionsManagerDelegate>)delegate;
...
@property (nonatomic, weak) id<ABI32_0_0RCTExceptionsManagerDelegate> delegate;
