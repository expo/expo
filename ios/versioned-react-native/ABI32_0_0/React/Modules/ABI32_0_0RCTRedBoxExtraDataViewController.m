...
@interface ABI32_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI32_0_0RCTRedBoxExtraDataCell
...
@interface ABI32_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI32_0_0RCTRedBoxExtraDataViewController
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ABI32_0_0RCTRedBoxExtraDataCell *cell =
            (ABI32_0_0RCTRedBoxExtraDataCell *)[tableView
            dequeueReusableCellWithIdentifier:reuseIdentifier];

    if (cell == nil) {
        cell = [[ABI32_0_0RCTRedBoxExtraDataCell alloc]
