...
typedef dispatch_block_t ABI32_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI32_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ReactABI32_0_0-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI32_0_0RCTUIManager's observers.
 */
@interface ABI32_0_0RCTUIManagerObserverCoordinator : NSObject <ABI32_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI32_0_0RCTUIManagerObserver` protocol for more info.
