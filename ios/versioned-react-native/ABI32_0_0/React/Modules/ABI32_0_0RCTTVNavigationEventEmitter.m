...
NSString *const ABI32_0_0RCTTVNavigationEventNotification = @"ABI32_0_0RCTTVNavigationEventNotification";

static NSString *const TVNavigationEventName = @"onHWKeyEvent";

@implementation ABI32_0_0RCTTVNavigationEventEmitter
  ...
  if (self = [super init]) {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(handleTVNavigationEventNotification:)
                                                 name:ABI32_0_0RCTTVNavigationEventNotification
                                               object:nil];
