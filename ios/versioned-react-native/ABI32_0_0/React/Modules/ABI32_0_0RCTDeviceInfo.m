...
#import "ABI32_0_0RCTDeviceInfo.h"
...
@implementation ABI32_0_0RCTDeviceInfo {
#if !TARGET_OS_TV
...
#if !TARGET_OS_TV
  _currentInterfaceOrientation = [ABI32_0_0RCTSharedApplication() statusBarOrientation];
...
static BOOL ABI32_0_0RCTIsIPhoneX() {
...
static NSDictionary *ABI32_0_0RCTExportedDimensions(ABI32_0_0RCTBridge *bridge)
{
  ABI32_0_0RCTAssertMainQueue();

  ABI32_0_0RCTDimensions dimensions = ABI32_0_0RCTGetDimensions(bridge.accessibilityManager.multiplier);
...
{
  return @{
    @"Dimensions": ABI32_0_0RCTExportedDimensions(_bridge),
    // Note:
    // This prop is deprecated and will be removed in a future release.
    // Please use this only for a quick and temporary solution.
    // Use <SafeAreaView> instead.
    @"isIPhoneX_deprecated": @(ABI32_0_0RCTIsIPhoneX()),
  };
}
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [bridge.eventDispatcher sendDeviceEventWithName:@"didUpdateDimensions"
                                        body:ABI32_0_0RCTExportedDimensions(bridge)];
...
{
  UIInterfaceOrientation nextOrientation = [ABI32_0_0RCTSharedApplication() statusBarOrientation];
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
        [_bridge.eventDispatcher sendDeviceEventWithName:@"didUpdateDimensions"
                                                    body:ABI32_0_0RCTExportedDimensions(_bridge)];
#pragma clang diagnostic pop
      }
