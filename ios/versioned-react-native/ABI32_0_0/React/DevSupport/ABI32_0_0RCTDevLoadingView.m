...
#if ABI32_0_0RCT_DEV | ABI32_0_0RCT_ENABLE_LOADING_VIEW

static BOOL isEnabled = YES;

@implementation ABI32_0_0RCTDevLoadingView
{
  UIWindow *_window;
  UILabel *_label;
  NSDate *_showDate;
...
- (void)setBridge:(ABI32_0_0RCTBridge *)bridge
{
  ...
  [[NSNotificationCenter defaultCenter] addObserver:self
                                           selector:@selector(hide)
                                               name:ABI32_0_0RCTJavaScriptDidFailToLoadNotification
                                             object:nil];
...
ABI32_0_0RCT_EXPORT_METHOD(showMessage:(NSString *)message color:(UIColor *)color backgroundColor:(UIColor *)backgroundColor)
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    if (!self->_window && !ABI32_0_0RCTRunningInTestEnvironment()) {
