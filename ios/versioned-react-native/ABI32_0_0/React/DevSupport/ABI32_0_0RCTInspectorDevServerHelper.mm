...
@implementation ABI32_0_0RCTInspectorDevServerHelper

ABI32_0_0RCT_NOT_IMPLEMENTED(- (instancetype)init)

static NSMutableDictionary<NSString *, ABI32_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
...
+ (ABI32_0_0RCTInspectorPackagerConnection *)connectWithBundleURL:(NSURL *)bundleURL
{
  ...
  ABI32_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection) {
    connection = [[ABI32_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
