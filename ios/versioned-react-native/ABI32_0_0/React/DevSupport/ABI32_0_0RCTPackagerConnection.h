...
@protocol ABI32_0_0RCTPackagerClientMethod;
@class ABI32_0_0RCTPackagerClientResponder;

typedef uint32_t ABI32_0_0RCTHandlerToken;
typedef void (^ABI32_0_0RCTNotificationHandler)(NSDictionary<NSString *, id> *);
typedef void (^ABI32_0_0RCTRequestHandler)(NSDictionary<NSString *, id> *, ABI32_0_0RCTPackagerClientResponder *);
typedef void (^ABI32_0_0RCTConnectedHandler)(void);

/** Encapsulates singleton connection to ReactABI32_0_0 Native packager. */
@interface ABI32_0_0RCTPackagerConnection : NSObject
 ...
 */
- (ABI32_0_0RCTHandlerToken)addNotificationHandler:(ABI32_0_0RCTNotificationHandler)handler
 ...
 */
- (ABI32_0_0RCTHandlerToken)addRequestHandler:(ABI32_0_0RCTRequestHandler)handler
                               queue:(dispatch_queue_t)queue
                           forMethod:(NSString *)method;
 ...
 */
- (ABI32_0_0RCTHandlerToken)addConnectedHandler:(ABI32_0_0RCTConnectedHandler)handler
                                 queue:(dispatch_queue_t)queue;
 ...
 */
- (void)addHandler:(id<ABI32_0_0RCTPackagerClientMethod>)handler
