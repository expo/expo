...
extern const int ABI32_0_0RCT_PACKAGER_CLIENT_PROTOCOL_VERSION;

#if defined(__cplusplus)
}
#endif

@protocol ABI32_0_0RCTPackagerClientMethod <NSObject>

- (void)handleRequest:(NSDictionary<NSString *, id> *)params withResponder:(ABI32_0_0RCTPackagerClientResponder *)responder;
...
@interface ABI32_0_0RCTPackagerClientResponder : NSObject
