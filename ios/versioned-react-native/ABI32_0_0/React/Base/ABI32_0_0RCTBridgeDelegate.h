...
@protocol ABI32_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI32_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI32_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI32_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI32_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI32_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI32_0_0RCTBridge *)bridge;
...
*/
- (BOOL)bridge:(ABI32_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI32_0_0RCTBridge *)bridge
                 onProgress:(ABI32_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI32_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI32_0_0RCTBridge *)bridge
                  withBlock:(ABI32_0_0RCTSourceLoadBlock)loadCallback;
