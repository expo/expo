...
#import <ReactABI32_0_0/ABI32_0_0RCTSurfaceSizeMeasureMode.h>
#import <ReactABI32_0_0/ABI32_0_0RCTSurfaceStage.h>

@class ABI32_0_0RCTBridge;
@class ABI32_0_0RCTSurface;

typedef UIView *(^ABI32_0_0RCTSurfaceHostingViewActivityIndicatorViewFactory)();
 ...
 * of ReactABI32_0_0Native-powered experiences in UIKit based apps.
 */
@interface ABI32_0_0RCTSurfaceHostingView : UIView <ABI32_0_0RCTSurfaceDelegate>
...
- (instancetype)initWithSurface:(ABI32_0_0RCTSurface *)surface
                sizeMeasureMode:(ABI32_0_0RCTSurfaceSizeMeasureMode)sizeMeasureMode NS_DESIGNATED_INITIALIZER;
...
/**
 * Create an instance of ABI32_0_0RCTSurface to be hosted.
 */
...
/**
 * Size measure mode which are defining relationship between UIKit and ReactABI32_0_0Native
 * layout approaches.
 * Defaults to `ABI32_0_0RCTSurfaceSizeMeasureModeWidthAtMost | ABI32_0_0RCTSurfaceSizeMeasureModeHeightAtMost`.
 */
@property (nonatomic, assign) ABI32_0_0RCTSurfaceSizeMeasureMode sizeMeasureMode;
 ...
 */
@property (nonatomic, copy, nullable) ABI32_0_0RCTSurfaceHostingViewActivityIndicatorViewFactory activityIndicatorViewFactory;
