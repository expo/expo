 ...
 */
@interface ABI32_0_0RCTSurface : NSObject
 ...
 *  - Calling on the main queue with `ABI32_0_0RCTSurfaceStageSurfaceDidInitialMounting`
 *    stage temporary is not supported; in this case the stage will be
 *    downgraded to `ABI32_0_0RCTSurfaceStageSurfaceDidInitialLayout`.
 */
- (BOOL)synchronouslyWaitForStage:(ABI32_0_0RCTSurfaceStage)stage timeout:(NSTimeInterval)timeout;

#pragma mark - Mounting/Unmounting of ReactABI32_0_0 components

/**
 * Mount the ReactABI32_0_0 component specified by the given moduleName. This is typically
 * calling runApplication.js from the native side.
 */
- (void)mountReactABI32_0_0ComponentWithBridge:(ABI32_0_0RCTBridge *)bridge moduleName:(NSString *)moduleName params:(NSDictionary *)params;

/**
 * Unmount the ReactABI32_0_0 component specified by the given rootViewTag, called from native.
 */
- (void)unmountReactABI32_0_0ComponentWithBridge:(ABI32_0_0RCTBridge *)bridge rootViewTag:(NSNumber *)rootViewTag;
