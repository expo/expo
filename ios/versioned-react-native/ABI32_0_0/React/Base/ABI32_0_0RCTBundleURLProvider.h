...
extern NSString *const ABI32_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI32_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI32_0_0RCTBundleURLProvider : NSObject
