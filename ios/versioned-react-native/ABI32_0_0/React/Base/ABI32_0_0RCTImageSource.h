 ...
 */
@interface ABI32_0_0RCTImageSource : NSObject
...
@interface ABI32_0_0RCTConvert (ImageSource)

+ (ABI32_0_0RCTImageSource *)ABI32_0_0RCTImageSource:(id)json;
+ (NSArray<ABI32_0_0RCTImageSource *> *)ABI32_0_0RCTImageSourceArray:(id)json;
