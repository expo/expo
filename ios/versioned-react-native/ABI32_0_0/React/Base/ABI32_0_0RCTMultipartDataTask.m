...
@interface ABI32_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI32_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI32_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI32_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI32_0_0RCTMultipartStreamReader *reader = [[ABI32_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI32_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
