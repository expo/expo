...
@protocol ABI32_0_0RCTJavaScriptExecutor;

ABI32_0_0RCT_EXTERN NSArray<Class> *ABI32_0_0RCTGetModuleClasses(void);

ABI32_0_0RCT_EXTERN __attribute__((weak)) void ABI32_0_0RCTFBQuickPerformanceLoggerConfigureHooks(JSGlobalContextRef ctx);

#if ABI32_0_0RCT_DEBUG
ABI32_0_0RCT_EXTERN void ABI32_0_0RCTVerifyAllModulesExported(NSArray *extraModules);
#endif

ABI32_0_0RCT_EXTERN void ABI32_0_0RCTRegisterModule(Class);

@interface ABI32_0_0RCTBridge ()
...
// Used by ABI32_0_0RCTDevMenu
@property (nonatomic, copy) NSString *bridgeDescription;

+ (instancetype)currentBridge;
+ (void)setCurrentBridge:(ABI32_0_0RCTBridge *)bridge;

/**
 * Bridge setup code - creates an instance of ABI32_0_0RCTBachedBridge. Exposed for
 * test only
 */
- (void)setUp;
 ...
 * a background thread if the ABI32_0_0RCTBridge happens to deallocate on a background
 * thread. Therefore, we want all writes to it to be seen atomically.
 */
@property (atomic, strong) ABI32_0_0RCTBridge *batchedBridge;

/**
 * The block that creates the modules' instances to be added to the bridge.
 * Exposed for ABI32_0_0RCTCxxBridge
 */
@property (nonatomic, copy, readonly) ABI32_0_0RCTBridgeModuleListProvider moduleProvider;

/**
 * Used by ABI32_0_0RCTDevMenu to override the `hot` param of the current bundleURL.
 */
@property (nonatomic, strong, readwrite) NSURL *bundleURL;

@end

@interface ABI32_0_0RCTBridge (ABI32_0_0RCTCxxBridge)

/**
 * Used by ABI32_0_0RCTModuleData
 */
...
/**
 * Used by ABI32_0_0RCTModuleData to register the module for frame updates after it is
 * lazily initialized.
 */
...
/**
 * Dispatch work to a module's queue - this is also suports the fake ABI32_0_0RCTJSThread
 * queue. Exposed for the ABI32_0_0RCTProfiler
 */
...
/**
 * Systrace profiler toggling methods exposed for the ABI32_0_0RCTDevMenu
 */
- (void)startProfiling;
...
/**
 * Hook exposed for ABI32_0_0RCTLog to send logs to JavaScript when not running in JSC
 */
...
@interface ABI32_0_0RCTBridge (JavaScriptCore)
...
@interface ABI32_0_0RCTBridge (Inspector)

@property (nonatomic, readonly, getter=isInspectable) BOOL inspectable;

@end

@interface ABI32_0_0RCTCxxBridge : ABI32_0_0RCTBridge

- (instancetype)initWithParentBridge:(ABI32_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;
