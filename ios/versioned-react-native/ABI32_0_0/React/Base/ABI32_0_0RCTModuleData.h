...
@protocol ABI32_0_0RCTBridgeModule;
@class ABI32_0_0RCTBridge;

typedef id<ABI32_0_0RCTBridgeModule>(^ABI32_0_0RCTBridgeModuleProvider)(void);

@interface ABI32_0_0RCTModuleData : NSObject <ABI32_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI32_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI32_0_0RCTBridgeModule> instance;
