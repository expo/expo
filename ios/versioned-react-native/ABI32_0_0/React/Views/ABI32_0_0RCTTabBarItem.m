...
@implementation ABI32_0_0RCTConvert (UITabBarSystemItem)

ABI32_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI32_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI32_0_0ViewController;
}
