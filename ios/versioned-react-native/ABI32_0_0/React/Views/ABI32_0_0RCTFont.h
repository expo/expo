...
typedef UIFont *(^ABI32_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ReactABI32_0_0 Native will use the System font for rendering by default. If you want to
 ...
 */
ABI32_0_0RCT_EXTERN void ABI32_0_0RCTSetDefaultFontHandler(ABI32_0_0RCTFontHandler handler);
ABI32_0_0RCT_EXTERN BOOL ABI32_0_0RCTHasFontHandlerSet(void);

@interface ABI32_0_0RCTFont : NSObject
...
@interface ABI32_0_0RCTConvert (ABI32_0_0RCTFont)
