...
// Register a subclass of this class in ABI32_0_0EXModuleRegistryProvider
...
@interface ABI32_0_0EXExportedModule : NSObject <ABI32_0_0EXInternalModule, NSCopying>

- (NSDictionary *)constantsToExport;
+ (const NSString *)exportedModuleName;
- (NSDictionary<NSString *, NSString *> *)getExportedMethods;
- (void)callExportedMethod:(NSString *)methodName withArguments:(NSArray *)arguments resolver:(ABI32_0_0EXPromiseResolveBlock)resolver rejecter:(ABI32_0_0EXPromiseRejectBlock)rejecter;
