...
@interface ABI32_0_0EXUtilities ()

@property (nonatomic, nullable, weak) ABI32_0_0EXModuleRegistry *moduleRegistry;
...
@implementation ABI32_0_0EXUtilities

ABI32_0_0EX_REGISTER_MODULE();

+ (const NSArray<Protocol *> *)exportedInterfaces
{
  return @[@protocol(ABI32_0_0EXUtilitiesInterface)];
}
...
- (nullable NSDictionary *)launchOptions
{
  id<ABI32_0_0EXUtilService> utilService = [_moduleRegistry getSingletonModuleForName:@"Util"];
  
  if (utilService != nil) {
    // Uses launchOptions from ABI32_0_0EXUtilService that is a part of ExpoKit
...
- (UIViewController *)currentViewController
{
  ...
  if (utilService != nil) {
    // Uses currentViewController from ABI32_0_0EXUtilService that is a part of ExpoKit
    return [utilService currentViewController];
  }
  
  // If the app doesn't have ExpoKit - then do the same as ABI32_0_0RCTPresentedViewController() does
