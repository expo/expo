...
@interface ABI32_0_0EXSensorsManagerBinding ()

@property (nonatomic, strong) NSString *experienceId;
@property (nonatomic, weak) id<ABI32_0_0EXSensorsManagerBindingDelegate> kernelService;

@end

@implementation ABI32_0_0EXSensorsManagerBinding

- (instancetype)initWithExperienceId:(NSString *)experienceId andKernelService:(id<ABI32_0_0EXSensorsManagerBindingDelegate>)kernelService
{
  if (self = [super init]) {
