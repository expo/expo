...
#import "ABI32_0_0EXWebBrowser.h"
#import "ABI32_0_0EXUnversioned.h"
#import "ABI32_0_0EXUtil.h"

@interface ABI32_0_0EXWebBrowser () <SFSafariViewControllerDelegate>

@property (nonatomic, copy) ABI32_0_0RCTPromiseResolveBlock redirectResolve;
@property (nonatomic, copy) ABI32_0_0RCTPromiseRejectBlock redirectReject;
...
NSString *ABI32_0_0EXWebBrowserErrorCode = @"ABI32_0_0EXWebBrowser";


@implementation ABI32_0_0EXWebBrowser
{
  UIStatusBarStyle _initialStatusBarStyle;
}

ABI32_0_0RCT_EXPORT_MODULE(ExponentWebBrowser)
...
ABI32_0_0RCT_EXPORT_METHOD(openAuthSessionAsync:(NSString *)authURL
...
ABI32_0_0RCT_EXPORT_METHOD(openBrowserAsync:(NSString *)authURL
                  resolver:(ABI32_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
 ...
 [ABI32_0_0RCTPresentedViewController() presentViewController:safariHackVC animated:true completion:nil];
}
...
- (void)_dismissBrowser
{
  ...
  [ABI32_0_0EXUtil performSynchronouslyOnMainThread:^{
    [ABI32_0_0RCTPresentedViewController() dismissViewControllerAnimated:YES completion:^{
...
ABI32_0_0RCT_EXPORT_METHOD(dismissBrowser) {
  [self _dismissBrowser];
}

ABI32_0_0RCT_EXPORT_METHOD(dismissAuthSession) {
  if (@available(iOS 11, *)) {
    [_authSession cancel];
    if (_redirectResolve) {
      _redirectResolve(@{
 ...
 */
- (BOOL)initializeWebBrowserWithResolver:(ABI32_0_0RCTPromiseResolveBlock)resolve andRejecter:(ABI32_0_0RCTPromiseRejectBlock)reject {
  if (_redirectResolve) {
    reject(ABI32_0_0EXWebBrowserErrorCode, @"Another WebBrowser is already being presented.", nil);
    return NO;
  }
  _redirectReject = reject;
  _redirectResolve = resolve;
  
  _initialStatusBarStyle = ABI32_0_0RCTSharedApplication().statusBarStyle;
  
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
  [ABI32_0_0RCTSharedApplication() setStatusBarStyle:UIStatusBarStyleDefault
                                   animated:YES];
#pragma clang diagnostic pop
  return YES;
}
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
  [ABI32_0_0RCTSharedApplication() setStatusBarStyle:_initialStatusBarStyle animated:YES];
#pragma clang diagnostic pop
