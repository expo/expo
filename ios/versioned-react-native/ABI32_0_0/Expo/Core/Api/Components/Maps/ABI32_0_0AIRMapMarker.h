...
@interface ABI32_0_0AIRMapMarker : MKAnnotationView <MKAnnotation>

@property (nonatomic, strong) ABI32_0_0AIRMapCallout *calloutView;
...
@property (nonatomic, copy) ABI32_0_0RCTDirectEventBlock onSelect;
@property (nonatomic, copy) ABI32_0_0RCTDirectEventBlock onDeselect;
...
@interface ABI32_0_0AIREmptyCalloutBackgroundView : ABI32_0_0SMCalloutBackgroundView
@end
