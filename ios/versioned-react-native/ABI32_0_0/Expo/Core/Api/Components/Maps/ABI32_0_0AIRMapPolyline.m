...
#import "ABI32_0_0AIRMapPolylineRenderer.h"
#import <ReactABI32_0_0/UIView+ReactABI32_0_0.h>


@implementation ABI32_0_0AIRMapPolyline {
...
- (void)setStrokeColors:(NSArray<UIColor *> *)strokeColors {
    ...
    if ((self.renderer != nil) && ![_renderer isKindOfClass:[ABI32_0_0AIRMapPolylineRenderer class]]) {
...
- (MKOverlayPathRenderer*)createRenderer {
    ...
    if (self.strokeColors == nil) {
        ...
        return [[ABI32_0_0AIRMapPolylineRenderer alloc] initWithOverlay:self polyline:self.polyline];
    }
}
...
- (void) updateRenderer:(MKOverlayPathRenderer*)renderer {
    ...
    if ([renderer isKindOfClass:[ABI32_0_0AIRMapPolylineRenderer class]]) {
        ((ABI32_0_0AIRMapPolylineRenderer*)renderer).strokeColors = _strokeColors;
    }
}
...
#pragma mark ABI32_0_0AIRMapSnapshot implementation

- (void) drawToSnapshot:(MKMapSnapshot *) snapshot context:(CGContextRef) context
{
    ABI32_0_0AIRMapPolylineRenderer* renderer = [[ABI32_0_0AIRMapPolylineRenderer alloc] initWithSnapshot:snapshot overlay:self polyline:self.polyline];
