...
@implementation ABI32_0_0RCTConvert (AirMap)
...
ABI32_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI32_0_0AIRMapCoordinate *)ABI32_0_0AIRMapCoordinate:(id)json
{
    ABI32_0_0AIRMapCoordinate *coord = [ABI32_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI32_0_0RCT_ARRAY_CONVERTER(ABI32_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI32_0_0AIRMapCoordinate *> *> *)ABI32_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI32_0_0RCTConvertArrayValue(@selector(ABI32_0_0AIRMapCoordinateArray:), json);
}
