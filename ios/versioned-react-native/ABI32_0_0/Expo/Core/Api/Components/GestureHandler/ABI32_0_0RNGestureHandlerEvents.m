...
@implementation ABI32_0_0RNGestureHandlerEventExtraData
...
{
    return [[ABI32_0_0RNGestureHandlerEventExtraData alloc]
            initWithData:@{
                           @"x": @(position.x),
                           @"y": @(position.y),
...
@implementation ABI32_0_0RNGestureHandlerEvent
{
    NSNumber *_handlerTag;
    ABI32_0_0RNGestureHandlerState _state;
    ABI32_0_0RNGestureHandlerEventExtraData *_extraData;
}
...
- (instancetype)initWithRactTag:(NSNumber *)ReactABI32_0_0Tag
                     handlerTag:(NSNumber *)handlerTag
                      ...
                      extraData:(ABI32_0_0RNGestureHandlerEventExtraData *)extraData
{
...
{
    return @"ABI32_0_0RCTEventEmitter.receiveEvent";
}
...
@implementation ABI32_0_0RNGestureHandlerStateChange
{
    NSNumber *_handlerTag;
    ABI32_0_0RNGestureHandlerState _state;
    ABI32_0_0RNGestureHandlerState _prevState;
    ABI32_0_0RNGestureHandlerEventExtraData *_extraData;
}
