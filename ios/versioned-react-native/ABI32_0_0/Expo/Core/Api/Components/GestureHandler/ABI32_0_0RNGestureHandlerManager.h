...
@interface ABI32_0_0RNGestureHandlerManager : NSObject

- (nonnull instancetype)initWithUIManager:(nonnull ABI32_0_0RCTUIManager *)uiManager
                          eventDispatcher:(nonnull ABI32_0_0RCTEventDispatcher *)eventDispatcher;
