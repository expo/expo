...
#import "ABI32_0_0RNTapHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ReactABI32_0_0/ABI32_0_0RCTConvert.h>

// ABI32_0_0RNBetterTapGestureRecognizer extends UIGestureRecognizer instead of UITapGestureRecognizer 
...
@interface ABI32_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
@implementation ABI32_0_0RNBetterTapGestureRecognizer {
...
@implementation ABI32_0_0RNTapGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI32_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    ABI32_0_0RNBetterTapGestureRecognizer *recognizer = (ABI32_0_0RNBetterTapGestureRecognizer *)_recognizer;
    ...
    if (prop != nil) {
        recognizer.maxDelay = [ABI32_0_0RCTConvert CGFloat:prop] / 1000.0;
    }

    prop = config[@"maxDurationMs"];
    if (prop != nil) {
        recognizer.maxDuration = [ABI32_0_0RCTConvert CGFloat:prop] / 1000.0;
    }
