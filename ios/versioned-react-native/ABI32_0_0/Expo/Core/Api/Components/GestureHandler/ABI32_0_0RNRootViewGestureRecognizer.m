//
//  ABI32_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI32_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI32_0_0RNGestureHandler *otherHandler = [ABI32_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI32_0_0RCTTouchHandler class]];
}
