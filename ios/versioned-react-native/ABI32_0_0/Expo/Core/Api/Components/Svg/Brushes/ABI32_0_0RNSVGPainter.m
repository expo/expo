...
@implementation ABI32_0_0RNSVGPainter
{
    NSArray<ABI32_0_0RNSVGLength *> *_points;
    NSArray<NSNumber *> *_colors;
    ABI32_0_0RNSVGBrushType _type;
...
- (instancetype)initWithPointsArray:(NSArray<ABI32_0_0RNSVGLength *> *)pointsArray
{
    if ((self = [super init])) {
        _points = pointsArray;
    }
...
- (void)setPattern:(ABI32_0_0RNSVGPattern *)pattern
{
...
void ABI32_0_0PatternFunction(void* info, CGContextRef context)
{
    ...
    CGAffineTransform _viewBoxTransform = [ABI32_0_0RNSVGViewBox getTransform:CGRectMake(_pattern.minX, _pattern.minY, _pattern.vbWidth, _pattern.vbHeight)
                                             eRect:rect
...
- (void)paintPattern:(CGContextRef)context bounds:(CGRect)bounds
{
    ...
    CGFloat x = [ABI32_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:0]
                                                relative:width
                                                  offset:offsetX];
    CGFloat y = [ABI32_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:1]
                                                relative:height
                                                  offset:offsetY];
    CGFloat w = [ABI32_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:2]
                                                relative:width
                                                  offset:offsetX];
    CGFloat h = [ABI32_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:3]
                                                relative:height
                                                  offset:offsetY];
...
- (void)paintLinearGradient:(CGContextRef)context bounds:(CGRect)bounds
{
    ...
    CGGradientRef gradient = CGGradientRetain([ABI32_0_0RCTConvert ABI32_0_0RNSVGCGGradient:_colors offset:0]);
    ...
    CGFloat x1 = [ABI32_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:0]
                                                relative:width
                                                  offset:offsetX];
    CGFloat y1 = [ABI32_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:1]
                                                relative:height
                                                  offset:offsetY];
    CGFloat x2 = [ABI32_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:2]
                                                relative:width
                                                  offset:offsetX];
    CGFloat y2 = [ABI32_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:3]
                                                relative:height
                                                  offset:offsetY];
...
- (void)paintRadialGradient:(CGContextRef)context bounds:(CGRect)bounds
{
    ...
    CGFloat rx = [ABI32_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:2]
                                                relative:width
                                                  offset:0];
    CGFloat ry = [ABI32_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:3]
                                                relative:height
                                                  offset:0];
    CGFloat fx = [ABI32_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:0]
                                                relative:width
                                                  offset:offsetX];
    CGFloat fy = [ABI32_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:1]
                                                relative:height
                                                  offset:offsetY] / (ry / rx);
    CGFloat cx = [ABI32_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:4]
                                                relative:width
                                                  offset:offsetX];
    CGFloat cy = [ABI32_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:5]
                                                relative:height
                                                  offset:offsetY] / (ry / rx);
