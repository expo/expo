...
@implementation ABI32_0_0RNSVGLength
...
{
    ABI32_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype) lengthWithString: (NSString *) lengthString {
    ...
    ABI32_0_0RNSVGLength *output = [ABI32_0_0RNSVGLength alloc];
    if (stringLength == 0) {
        ...
        ABI32_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
...
- (BOOL) isEqualTo: (ABI32_0_0RNSVGLength *)other {
