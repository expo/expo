...
@implementation ABI32_0_0RNSVGText
{
...
- (void)setTextLength:(ABI32_0_0RNSVGLength *)textLength
{
...
- (void)setDeltaX:(NSArray<ABI32_0_0RNSVGLength *> *)deltaX
{
    if (deltaX == _deltaX) {
        return;
    }
...
- (void)setDeltaY:(NSArray<ABI32_0_0RNSVGLength *> *)deltaY
{
    if (deltaY == _deltaY) {
        return;
    }
...
- (void)setPositionX:(NSArray<ABI32_0_0RNSVGLength *>*)positionX
{
...
- (void)setPositionY:(NSArray<ABI32_0_0RNSVGLength *>*)positionY
{
...
- (void)setRotate:(NSArray<ABI32_0_0RNSVGLength *> *)rotate
{
    if (rotate == _rotate) {
        return;
    }
...
- (void)setupGlyphContext:(CGContextRef)context
{
    ...
    _glyphContext = [[ABI32_0_0RNSVGGlyphContext alloc] initWithWidth:size.width
                                                      height:size.height];
}
...
- (ABI32_0_0RNSVGText *)textRoot
{
    ABI32_0_0RNSVGText *root = self;
    while (root && [root class] != [ABI32_0_0RNSVGText class]) {
        if (![root isKindOfClass:[ABI32_0_0RNSVGText class]]) {
            //todo: throw exception here
            break;
        }
        root = (ABI32_0_0RNSVGText*)[root superview];
    }
...
- (NSString *)alignmentBaseline
{
    ...
    while (parent != nil) {
        if ([parent isKindOfClass:[ABI32_0_0RNSVGText class]]) {
            ABI32_0_0RNSVGText* node = (ABI32_0_0RNSVGText*)parent;
    ...
    if (_alignmentBaseline == nil) {
        _alignmentBaseline = ABI32_0_0RNSVGAlignmentBaselineStrings[0];
    }
    return _alignmentBaseline;
}
