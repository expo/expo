...
static NSCharacterSet *ABI32_0_0RNSVGTSpan_separators = nil;
static CGFloat ABI32_0_0RNSVGTSpan_radToDeg = 180 / (CGFloat)M_PI;

@implementation ABI32_0_0RNSVGTSpan
{
    CGFloat startOffset;
    CGPathRef _cache;
    CGFloat _pathLength;
    ABI32_0_0RNSVGTextPath *textPath;
    NSArray *lengths;
    NSArray *lines;
...
- (id)init
{
    ...
    if (ABI32_0_0RNSVGTSpan_separators == nil) {
        ABI32_0_0RNSVGTSpan_separators = [NSCharacterSet whitespaceCharacterSet];
    }
...
- (CGPathRef)getLinePath:(NSString *)str context:(CGContextRef)context
{
    ...
    ABI32_0_0RNSVGGlyphContext* gc = [self.textRoot getGlyphContext];
    ABI32_0_0RNSVGFontData* font = [gc getFont];
     ...
     */
    bool allowOptionalLigatures = letterSpacing == 0 && font->fontVariantLigatures == ABI32_0_0RNSVGFontVariantLigaturesNormal;
     ...
     */
    enum ABI32_0_0RNSVGTextAnchor textAnchor = font->textAnchor;
    CGRect textBounds = CTLineGetBoundsWithOptions(line, 0);
    CGFloat textMeasure = CGRectGetWidth(textBounds);
    CGFloat offset = [ABI32_0_0RNSVGTSpan getTextAnchorOffset:textAnchor width:textMeasure];
    ...
    if (hasTextPath) {
        //sharpMidLine = ABI32_0_0RNSVGTextPathMidLineFromString([textPath midLine]) == ABI32_0_0RNSVGTextPathMidLineSharp;
        /*
         Name
         side
         Value
         ...
         */
        side = ABI32_0_0RNSVGTextPathSideFromString([textPath side]) == ABI32_0_0RNSVGTextPathSideRight ? -1 : 1;
        /*
         Name
         startOffset
         Value
         ...
         the path is reached.
         */
        CGFloat absoluteStartOffset = [ABI32_0_0RNSVGPropHelper fromRelative:textPath.startOffset
                                                          relative:_pathLength
                                                          fontSize:fontSize];
        offset += absoluteStartOffset;
        if (isClosed) {
            CGFloat halfPathDistance = _pathLength / 2;
            startOfRendering = absoluteStartOffset + (textAnchor == ABI32_0_0RNSVGTextAnchorMiddle ? -halfPathDistance : 0);
            endOfRendering = startOfRendering + _pathLength;
        }
        /*
         ABI32_0_0RNSVGTextPathSpacing spacing = textPath.getSpacing();
         if (spacing == ABI32_0_0RNSVGTextPathSpacing.auto) {
         // Hmm, what to do here?
    ...
    ABI32_0_0RNSVGLength *mTextLength = [self textLength];
    enum ABI32_0_0RNSVGTextLengthAdjust mLengthAdjust = ABI32_0_0RNSVGTextLengthAdjustFromString([self lengthAdjust]);
    if (mTextLength != nil) {
        CGFloat author = [ABI32_0_0RNSVGPropHelper fromRelative:mTextLength
        ...
        switch (mLengthAdjust) {
            default:
            case ABI32_0_0RNSVGTextLengthAdjustSpacing:
                // TODO account for ligatures
                letterSpacing += (author - textMeasure) / (n - 1);
                break;
            case ABI32_0_0RNSVGTextLengthAdjustSpacingAndGlyphs:
    ...
    */
    ...
    enum ABI32_0_0RNSVGAlignmentBaseline baseline = ABI32_0_0RNSVGAlignmentBaselineFromString(self.alignmentBaseline);
    if (baseline != ABI32_0_0RNSVGAlignmentBaselineBaseline) {
        ...
        switch (baseline) {
            ...
            default:
            case ABI32_0_0RNSVGAlignmentBaselineBaseline:
                // Use the dominant baseline choice of the parent.
                // Match the box’s corresponding baseline to that of its parent.
                baselineShift = 0;
                break;

            case ABI32_0_0RNSVGAlignmentBaselineTextBottom:
            case ABI32_0_0RNSVGAlignmentBaselineAfterEdge:
            case ABI32_0_0RNSVGAlignmentBaselineTextAfterEdge:
            ...
            case ABI32_0_0RNSVGAlignmentBaselineCentral:
            ...
            case ABI32_0_0RNSVGAlignmentBaselineMathematical:
            ...
            case ABI32_0_0RNSVGAlignmentBaselineHanging:
                baselineShift = (CGFloat)0.8 * ascenderHeight;
                break;

            case ABI32_0_0RNSVGAlignmentBaselineTextTop:
            case ABI32_0_0RNSVGAlignmentBaselineBeforeEdge:
            case ABI32_0_0RNSVGAlignmentBaselineTextBeforeEdge:
            ...
            case ABI32_0_0RNSVGAlignmentBaselineBottom:
                // Align the top of the aligned subtree with the top of the line box.
                baselineShift = bottom;
                break;

            case ABI32_0_0RNSVGAlignmentBaselineCenter:
                // Align the center of the aligned subtree with the center of the line box.
                baselineShift = totalHeight / 2;
                break;

            case ABI32_0_0RNSVGAlignmentBaselineTop:
        ...
        switch (baseline) {
            ...
            default:
                if (fontData != nil && [baselineShiftString isEqualToString:@"sub"]) {
                    ...
                    baselineShift -= [ABI32_0_0RNSVGPropHelper fromRelativeWithNSString:baselineShiftString
                                                                   relative:fontSize
                                                                   fontSize:fontSize];
                }
                break;
    ...
    for (CFIndex r = 0; r < runEnd; r++) {
        ...
        for(CFIndex g = 0; g < runGlyphCount; g++) {
            ...
            bool isWordSeparator = [ABI32_0_0RNSVGTSpan_separators characterIsMember:currentChar];
            ...
            CGFloat r = [gc nextRotation] / ABI32_0_0RNSVGTSpan_radToDeg;
...
+ (CGFloat)getTextAnchorOffset:(ABI32_0_0RNSVGTextAnchor)textAnchor width:(CGFloat) width
{
    switch (textAnchor) {
        case ABI32_0_0RNSVGTextAnchorStart:
            return 0;
        case ABI32_0_0RNSVGTextAnchorMiddle:
            return -width / 2;
        case ABI32_0_0RNSVGTextAnchorEnd:
            return -width;
    }
...
- (void)setupTextPath:(CGContextRef)context
{
    ...
    lengths = nil;
    textPath = nil;
    ABI32_0_0RNSVGText *parent = (ABI32_0_0RNSVGText*)[self superview];

    while (parent) {
        if ([parent class] == [ABI32_0_0RNSVGTextPath class]) {
            textPath = (ABI32_0_0RNSVGTextPath*) parent;
            [textPath getPathLength:&_pathLength
                          lineCount:&lineCount
                           ...
                           isClosed:&isClosed];
            break;
        } else if (![parent isKindOfClass:[ABI32_0_0RNSVGText class]]) {
            break;
        }

        parent = (ABI32_0_0RNSVGText*)[parent superview];
    }
}
