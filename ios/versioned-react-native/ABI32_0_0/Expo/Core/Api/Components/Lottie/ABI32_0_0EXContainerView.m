...
#if __has_include(<ReactABI32_0_0/UIView+ReactABI32_0_0.h>)
#import <ReactABI32_0_0/UIView+ReactABI32_0_0.h>
#elif __has_include("UIView+ReactABI32_0_0.h")
#import "UIView+ReactABI32_0_0.h"
#else
#import "ReactABI32_0_0/UIView+ReactABI32_0_0.h"
#endif

@implementation ABI32_0_0EXContainerView {
...
- (void)ReactABI32_0_0SetFrame:(CGRect)frame
{
  ...
  if (_animationView != nil) {
    [_animationView ReactABI32_0_0SetFrame:frame];
  }
}
...
- (void)replaceAnimationView:(LOTAnimationView *)next {
  ...
  [_animationView ReactABI32_0_0SetFrame:self.frame];
  [_animationView setContentMode:UIViewContentModeScaleAspectFit];
