#import "ABI32_0_0RNAWSCognito.h"
...
@implementation ABI32_0_0RNAWSCognito
...
ABI32_0_0RCT_EXPORT_METHOD(computeModPow:(NSDictionary *)values
    ...
    if (result) {
        ...
        callback(@[@[ABI32_0_0RCTMakeError(@"computeModPow error", nil, nil)], [NSNull null]]);
    }
}

ABI32_0_0RCT_EXPORT_METHOD(computeS:(NSDictionary *)values
                  callback:(ABI32_0_0RCTResponseSenderBlock)callback) {
    ...
    if (result) {
        ...
        callback(@[@[ABI32_0_0RCTMakeError(@"computeS error", nil, nil)], [NSNull null]]);
    }
}
