//
//  ABI32_0_0RNBranchAgingDictionary.m
//  ABI32_0_0RNBranch
//
...
@interface ABI32_0_0RNBranchAgingDictionary()
@property (nonatomic) NSMutableDictionary *dictionary;
@end

@implementation ABI32_0_0RNBranchAgingDictionary
...
- (void)insertItem:(id)obj forKey:(id<NSCopying>)key
{
    ...
    self.dictionary[key] = [[ABI32_0_0RNBranchAgingItem alloc] initWithItem:obj];
}

- (id)itemForKey:(id)key
{
    ABI32_0_0RNBranchAgingItem *item = self.dictionary[key];
    return item.item;
}
