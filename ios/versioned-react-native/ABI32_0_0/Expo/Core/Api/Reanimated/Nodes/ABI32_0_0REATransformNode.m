#import "ABI32_0_0REATransformNode.h"

#import "ABI32_0_0REANodesManager.h"

@implementation ABI32_0_0REATransformNode
{
...
- (id)evaluate
{
  ...
  for (NSDictionary *transformConfig in _transformConfigs) {
    ...
    ABI32_0_0REANodeID nodeID = transformConfig[@"nodeID"];
    NSNumber *value;
    if (nodeID) {
      ABI32_0_0REANode *node = [self.nodesManager findNodeByID:nodeID];
      value = [node value];
    } else {
