#import "ABI32_0_0REAClockNodes.h"
#import "ABI32_0_0REANodesManager.h"

@interface ABI32_0_0REAClockNode ()
...
@implementation ABI32_0_0REAClockNode
...
- (void)start
{
  ...
  __weak ABI32_0_0REAClockNode *weakSelf = self;
...
@implementation ABI32_0_0REAClockOpNode {
...
- (ABI32_0_0REAClockNode*)clockNode
{
  return (ABI32_0_0REAClockNode*)[self.nodesManager findNodeByID:_clockNodeID];
}

@end

@implementation ABI32_0_0REAClockStartNode
...
@implementation ABI32_0_0REAClockStopNode
...
@implementation ABI32_0_0REAClockTestNode
