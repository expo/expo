#import "ABI32_0_0REAPropsNode.h"
...
#import "ReactABI32_0_0/ABI32_0_0RCTComponentData.h"

@implementation ABI32_0_0REAPropsNode
{
  NSNumber *_connectedViewTag;
  NSString *_connectedViewName;
  NSMutableDictionary<NSString *, ABI32_0_0REANodeID> *_propsConfig;
}
...
- (id)evaluate
{
  ...
  for (NSString *prop in _propsConfig) {
    ABI32_0_0REANode *propNode = [self.nodesManager findNodeByID:_propsConfig[prop]];
    
    if ([propNode isKindOfClass:[ABI32_0_0REAStyleNode class]]) {
