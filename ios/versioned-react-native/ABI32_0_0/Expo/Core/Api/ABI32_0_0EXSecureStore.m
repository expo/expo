...
#import "ABI32_0_0EXSecureStore.h"
...
@implementation ABI32_0_0RCTConvert (ABI32_0_0EXSecureStore)

ABI32_0_0RCT_ENUM_CONVERTER(ABI32_0_0EXSecureStoreAccessible, (@{
                                               @"AFTER_FIRST_UNLOCK":@(ABI32_0_0EXSecureStoreAccessibleAfterFirstUnlock),
                                               @"AFTER_FIRST_UNLOCK_THIS_DEVICE_ONLY":@(ABI32_0_0EXSecureStoreAccessibleAfterFirstUnlockThisDeviceOnly),
                                               @"ALWAYS":@(ABI32_0_0EXSecureStoreAccessibleAlways),
                                               @"WHEN_PASSCODE_SET_THIS_DEVICE_ONLY":@(ABI32_0_0EXSecureStoreAccessibleWhenPasscodeSetThisDeviceOnly),
                                               @"ALWAYS_THIS_DEVICE_ONLY":@(ABI32_0_0EXSecureStoreAccessibleAlwaysThisDeviceOnly),
                                               @"WHEN_UNLOCKED":@(ABI32_0_0EXSecureStoreAccessibleWhenUnlocked),
                                               @"WHEN_UNLOCKED_THIS_DEVICE_ONLY":@(ABI32_0_0EXSecureStoreAccessibleWhenUnlockedThisDeviceOnly),
                                               }), ABI32_0_0EXSecureStoreAccessibleWhenUnlocked, integerValue)

@end

@implementation ABI32_0_0EXSecureStore
...
{
  NSInteger accessibility = [ABI32_0_0RCTConvert NSInteger:options[@"keychainAccessible"]];
  switch (accessibility) {
    case ABI32_0_0EXSecureStoreAccessibleAfterFirstUnlock:
      return kSecAttrAccessibleAfterFirstUnlock;
    case ABI32_0_0EXSecureStoreAccessibleAfterFirstUnlockThisDeviceOnly:
      return kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly;
    case ABI32_0_0EXSecureStoreAccessibleAlways:
      return kSecAttrAccessibleAlways;
    case ABI32_0_0EXSecureStoreAccessibleWhenPasscodeSetThisDeviceOnly:
      return kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly;
    case ABI32_0_0EXSecureStoreAccessibleWhenUnlocked:
      return kSecAttrAccessibleWhenUnlocked;
    case ABI32_0_0EXSecureStoreAccessibleAlwaysThisDeviceOnly:
      return kSecAttrAccessibleAlwaysThisDeviceOnly;
    case ABI32_0_0EXSecureStoreAccessibleWhenUnlockedThisDeviceOnly:
      return kSecAttrAccessibleAlwaysThisDeviceOnly;
    default:
      return kSecAttrAccessibleWhenUnlocked;
  }
...
ABI32_0_0EX_EXPORT_SCOPED_MODULE(ExponentSecureStore, nil);

ABI32_0_0RCT_EXPORT_METHOD(setValueWithKeyAsync:(NSString *)value
                  key:(NSString *)key
                  ...
                  rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (!scopedKey) {
    reject(@"E_SECURESTORE_SETVALUEFAIL", nil, ABI32_0_0RCTErrorWithMessage(@"Invalid key."));
  } else {
    NSError *error;
    ...
    if (setValue) {
      ...
      reject(@"E_SECURESTORE_SETVALUEFAIL", nil, ABI32_0_0RCTErrorWithMessage([[self class] _messageForError:error]));
    }
  }
}

ABI32_0_0RCT_EXPORT_METHOD(getValueWithKeyAsync:(NSString *)key
                  options:(NSDictionary *)options
                  resolver:(ABI32_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  NSString *scopedKey = [self _scopedKey:key];
  if (!scopedKey) {
    reject(@"E_SECURESTORE_GETVALUEFAIL", nil, ABI32_0_0RCTErrorWithMessage(@"Invalid key."));
  } else {
    NSError *error;
    ...
    if (error) {
      if (error.code == errSecItemNotFound) {
        ...
        reject(@"E_SECURESTORE_GETVALUEFAIL", nil, ABI32_0_0RCTErrorWithMessage([[self class] _messageForError:error]));
      }
    } else {
      resolve(value);
    }
...
ABI32_0_0RCT_EXPORT_METHOD(deleteValueWithKeyAsync:(NSString *)key
                  options:(NSDictionary *)options
                  resolver:(ABI32_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  NSString *scopedKey = [self _scopedKey:key];
  if (!scopedKey) {
    reject(@"E_SECURESTORE_DELETEVALUEFAIL", nil, ABI32_0_0RCTErrorWithMessage(@"Invalid key."));
  } else {
