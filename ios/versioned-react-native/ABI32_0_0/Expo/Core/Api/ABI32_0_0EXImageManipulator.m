...
#import "ABI32_0_0EXImageManipulator.h"
#import "ABI32_0_0EXFileSystem.h"
#import "ABI32_0_0EXImageUtils.h"
...
@implementation ABI32_0_0EXImageManipulator

ABI32_0_0RCT_EXPORT_MODULE(ExponentImageManipulator);
...
ABI32_0_0RCT_EXPORT_METHOD(manipulate:(NSString *)uri
              ...
              rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject
{
  for (NSDictionary *options in actions) {
    if (options[@"resize"]) {
      ...
      image = [ABI32_0_0EXImageUtils cropImage:image toRect:cropDimensions];
    }
  }
  ...
  if ([format isEqualToString:@"jpeg"]) {
    ...
    ABI32_0_0RCTLogWarn(@"Unsupported format: %@, using JPEG instead.", format);
    imageData = UIImageJPEGRepresentation(image, compressionValue);
    extension = @".jpg";
  }
