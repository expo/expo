...
#import "ABI32_0_0EXCalendar.h"
#import "ABI32_0_0EXCalendarConverter.h"
#import "ABI32_0_0EXScopedModuleRegistry.h"
#import "ABI32_0_0EXCalendarRequester.h"
#import "ABI32_0_0EXRemindersRequester.h"
...
@interface ABI32_0_0EXCalendar ()

@property (nonatomic, strong) EKEventStore *eventStore;
@property (nonatomic) BOOL isAccessToEventStoreGranted;
@property (nonatomic, weak) id<ABI32_0_0EXPermissionsScopedModuleDelegate> kernelPermissionsServiceDelegate;

@end

@implementation ABI32_0_0EXCalendar

@synthesize bridge = _bridge;

ABI32_0_0EX_EXPORT_SCOPED_MODULE(ExponentCalendar, PermissionsManager);

- (instancetype)initWithExperienceId:(NSString *)experienceId kernelServiceDelegate:(id<ABI32_0_0EXPermissionsScopedModuleDelegate>)kernelServiceInstance params:(NSDictionary *)params
{
...
ABI32_0_0RCT_EXPORT_METHOD(getCalendarsAsync:(NSString *)typeString resolver:(ABI32_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI32_0_0EXPermissions statusForPermissions:[ABI32_0_0EXCalendarRequester permissions]] != ABI32_0_0EXPermissionStatusGranted ||
  ...
  resolve([ABI32_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI32_0_0RCT_EXPORT_METHOD(saveCalendarAsync:(NSDictionary *)details resolver:(ABI32_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI32_0_0EXPermissions statusForPermissions:[ABI32_0_0EXCalendarRequester permissions]] != ABI32_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  NSString *title = [ABI32_0_0RCTConvert NSString:details[@"title"]];
  NSNumber *color = [ABI32_0_0RCTConvert NSNumber:details[@"color"]];
  NSString *sourceId = [ABI32_0_0RCTConvert NSString:details[@"sourceId"]];
  NSString *type = [ABI32_0_0RCTConvert NSString:details[@"entityType"]];
  NSString *calendarId = [ABI32_0_0RCTConvert NSString:details[@"id"]];
  ...
  if (color) {
    calendar.CGColor = [ABI32_0_0RCTConvert UIColor:color].CGColor;
...
ABI32_0_0RCT_EXPORT_METHOD(deleteCalendarAsync:(NSString *)calendarId resolver:(ABI32_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI32_0_0EXPermissions statusForPermissions:[ABI32_0_0EXCalendarRequester permissions]] != ABI32_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
...
ABI32_0_0RCT_EXPORT_METHOD(getEventsAsync:(NSDate *)startDate endDate:(NSDate *)endDate calendars:(NSArray *)calendars resolver:(ABI32_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI32_0_0EXPermissions statusForPermissions:[ABI32_0_0EXCalendarRequester permissions]] != ABI32_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  if (calendarEvents) {
    resolve([ABI32_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI32_0_0RCT_EXPORT_METHOD(getEventByIdAsync:(NSString *)eventId startDate:(NSDate *)startDate resolver:(ABI32_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI32_0_0EXPermissions statusForPermissions:[ABI32_0_0EXCalendarRequester permissions]] != ABI32_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  if (calendarEvent) {
    resolve([ABI32_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI32_0_0RCT_EXPORT_METHOD(saveEventAsync:(NSDictionary *)details options:(NSDictionary *)options resolver:(ABI32_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI32_0_0EXPermissions statusForPermissions:[ABI32_0_0EXCalendarRequester permissions]] != ABI32_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  if (details[@"calendarId"]) {
    calendarId = [ABI32_0_0RCTConvert NSString:details[@"calendarId"]];
  }
  NSString *eventId = [ABI32_0_0RCTConvert NSString:details[@"id"]];
  NSString *title = [ABI32_0_0RCTConvert NSString:details[@"title"]];
  NSString *location = [ABI32_0_0RCTConvert NSString:details[@"location"]];
  NSDate *startDate = [ABI32_0_0RCTConvert NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI32_0_0RCTConvert NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI32_0_0RCTConvert NSDate:details[@"instanceStartDate"]];
  NSNumber *allDay = [ABI32_0_0RCTConvert NSNumber:details[@"allDay"]];
  NSString *notes = [ABI32_0_0RCTConvert NSString:details[@"notes"]];
  NSString *timeZone = [ABI32_0_0RCTConvert NSString:details[@"timeZone"]];
  NSString *url = [ABI32_0_0RCTConvert NSString:details[@"url"]];
  NSArray *alarms = [ABI32_0_0RCTConvert NSArray:details[@"alarms"]];
  NSDictionary *recurrenceRule = [ABI32_0_0RCTConvert NSDictionary:details[@"recurrenceRule"]];
  NSString *availability = [ABI32_0_0RCTConvert NSString:details[@"availability"]];
  ...
  if (recurrenceRule) {
    NSString *frequency = [ABI32_0_0RCTConvert NSString:recurrenceRule[@"frequency"]];
    NSInteger interval = [ABI32_0_0RCTConvert NSInteger:recurrenceRule[@"interval"]];
    NSInteger occurrence = [ABI32_0_0RCTConvert NSInteger:recurrenceRule[@"occurrence"]];
    NSDate *endDate = nil;
    if (recurrenceRule[@"endDate"]) {
      endDate = [ABI32_0_0RCTConvert NSDate:recurrenceRule[@"endDate"]];
    }
...
ABI32_0_0RCT_EXPORT_METHOD(deleteEventAsync:(NSDictionary *)event options:(NSDictionary *)options resolver:(ABI32_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI32_0_0EXPermissions statusForPermissions:[ABI32_0_0EXCalendarRequester permissions]] != ABI32_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  NSDate *instanceStartDate = [ABI32_0_0RCTConvert NSDate:event[@"instanceStartDate"]];
...
ABI32_0_0RCT_EXPORT_METHOD(getAttendeesForEventAsync:(NSDictionary *)event resolver:(ABI32_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI32_0_0EXPermissions statusForPermissions:[ABI32_0_0EXCalendarRequester permissions]] != ABI32_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  if (item.hasAttendees) {
    resolve([ABI32_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI32_0_0RCT_EXPORT_METHOD(getRemindersAsync:(NSDate * _Nullable)startDate endDate:(NSDate * _Nullable)endDate calendars:(NSArray *)calendars status:(NSString * _Nullable)status resolver:(ABI32_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI32_0_0EXPermissions statusForPermissions:[ABI32_0_0EXRemindersRequester permissions]] != ABI32_0_0EXPermissionStatusGranted ||
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI32_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI32_0_0RCT_EXPORT_METHOD(getReminderByIdAsync:(NSString *)reminderId resolver:(ABI32_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI32_0_0EXPermissions statusForPermissions:[ABI32_0_0EXRemindersRequester permissions]] != ABI32_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"reminders" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing reminders permission.", nil);
  ...
  if (reminder) {
    ...
    resolve([ABI32_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI32_0_0RCT_EXPORT_METHOD(saveReminderAsync:(NSDictionary *)details resolver:(ABI32_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI32_0_0EXPermissions statusForPermissions:[ABI32_0_0EXRemindersRequester permissions]] != ABI32_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"reminders" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing reminders permission.", nil);
  ...
  NSString *reminderId = [ABI32_0_0RCTConvert NSString:details[@"id"]];
  NSDate *startDate = [ABI32_0_0RCTConvert NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI32_0_0RCTConvert NSDate:details[@"dueDate"]];
  NSNumber *completed = [ABI32_0_0RCTConvert NSNumber:details[@"completed"]];
  NSDate *completionDate = [ABI32_0_0RCTConvert NSDate:details[@"completionDate"]];
  NSString *title = [ABI32_0_0RCTConvert NSString:details[@"title"]];
  NSString *location = [ABI32_0_0RCTConvert NSString:details[@"location"]];
  NSString *notes = [ABI32_0_0RCTConvert NSString:details[@"notes"]];
  NSString *timeZone = [ABI32_0_0RCTConvert NSString:details[@"timeZone"]];
...
ABI32_0_0RCT_EXPORT_METHOD(deleteReminderAsync:(NSString *)reminderId resolver:(ABI32_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI32_0_0EXPermissions statusForPermissions:[ABI32_0_0EXRemindersRequester permissions]] != ABI32_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"reminders" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing reminders permission.", nil);
...
ABI32_0_0RCT_EXPORT_METHOD(getSourcesAsync:(ABI32_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI32_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI32_0_0RCT_EXPORT_METHOD(getSourceByIdAsync:(NSString *)sourceId resolver:(ABI32_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve([ABI32_0_0EXCalendarConverter serializeSource:source]);
}
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI32_0_0RCTConvert NSDate:alarm[@"absoluteDate"]];
  NSNumber *relativeOffset = [ABI32_0_0RCTConvert NSNumber:alarm[@"relativeOffset"]];
