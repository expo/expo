...
@interface ABI32_0_0RNSScreenContainerManager : ABI32_0_0RCTViewManager

- (void)markUpdated:(ABI32_0_0RNSScreenContainerView *)screen;

@end

@interface ABI32_0_0RNSScreenContainerView ()

@property (nonatomic, retain) UIViewController *controller;
@property (nonatomic, retain) NSMutableSet<ABI32_0_0RNSScreenView *> *activeScreens;
@property (nonatomic, retain) NSMutableArray<ABI32_0_0RNSScreenView *> *ReactABI32_0_0Subviews;

- (void)updateContainer;

@end

@implementation ABI32_0_0RNSScreenContainerView {
  BOOL _needUpdate;
  __weak ABI32_0_0RNSScreenContainerManager *_manager;
}

- (instancetype)initWithManager:(ABI32_0_0RNSScreenContainerManager *)manager
{
  if (self = [super init]) {
...
- (void)insertReactABI32_0_0Subview:(ABI32_0_0RNSScreenView *)subview atIndex:(NSInteger)atIndex
{
  subview.ReactABI32_0_0Superview = self;
  [_ReactABI32_0_0Subviews insertObject:subview atIndex:atIndex];
}

- (void)removeReactABI32_0_0Subview:(ABI32_0_0RNSScreenView *)subview
{
  subview.ReactABI32_0_0Superview = nil;
...
- (void)detachScreen:(ABI32_0_0RNSScreenView *)screen
{
...
- (void)attachScreen:(ABI32_0_0RNSScreenView *)screen
{
...
- (void)updateContainer
{
  ...
  for (ABI32_0_0RNSScreenView *screen in orphaned) {
    activeScreenRemoved = YES;
    [self detachScreen:screen];
  }
...
- (void)layoutSubviews
{
  ...
  [self ReactABI32_0_0AddControllerToClosestParent:_controller];
...
@implementation ABI32_0_0RNSScreenContainerManager {
  NSMutableArray<ABI32_0_0RNSScreenContainerView *> *_markedContainers;
}
...
- (UIView *)view
{
  ...
  return [[ABI32_0_0RNSScreenContainerView alloc] initWithManager:self];
}
...
- (void)markUpdated:(ABI32_0_0RNSScreenContainerView *)screen
{
  ...
  if ([_markedContainers count] == 1) {
    ...
    ABI32_0_0RCTExecuteOnMainQueue(^{
      for (ABI32_0_0RNSScreenContainerView *container in _markedContainers) {
