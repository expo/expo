...
@implementation UIFont (ABI32_0_0EXFontLoader)

- (UIFont *)ABI32_0_0EXFontWithSize:(CGFloat)fontSize
{
  for (id<ABI32_0_0EXFontScalerInterface> fontScaler in currentFontScalers) {
  ...
  return [self ABI32_0_0EXFontWithSize:fontSize];
}
...
@implementation ABI32_0_0EXFontScalersManager

ABI32_0_0EX_REGISTER_SINGLETON_MODULE(FontScalersManager);
...
+ (void)initialize
{
  ...
  dispatch_once(&initializeCurrentFontScalersOnce, ^{
    ...
    SEL exUpdate = @selector(ABI32_0_0EXFontWithSize:);
...
- (void)registerFontScaler:(id<ABI32_0_0EXFontScalerInterface>)fontScaler
{
