...
#import "ABI32_0_0CSBufferOrientationCalculator.h"
...
@implementation ABI32_0_0CSBufferOrientationCalculator
                                               ...
                                               andMirrored:(BOOL)mirrored
{
  CGAffineTransform rotationTransform = CGAffineTransformConcat(
                                                                [ABI32_0_0CSBufferOrientationCalculator rotationTransformForOrientation:orientation],
                                                                [ABI32_0_0CSBufferOrientationCalculator transformForMirror:orientation forMirrored:mirrored]);
  CGAffineTransform rotationWithTranslation = [ABI32_0_0CSBufferOrientationCalculator rotationWithTranslation:rotationTransform forVideoWidth:videoWidth forVideoHeight:videoHeight];
  
  CGFloat scaleFactor = [ABI32_0_0CSBufferOrientationCalculator scaleForCropWithPreservingAspectRatioforBufferWidth:bufferWidth andBufferHeight:bufferHeight andVideoWidth:videoWidth andVideoHeight:videoHeight];
  
  CGAffineTransform cropTranslation = [ABI32_0_0CSBufferOrientationCalculator cropTranslationsTransformationForRotation:rotationWithTranslation andScale:scaleFactor andBufferWidth:bufferWidth andBufferHeight:bufferHeight andVideoWidth:videoWidth andVideoHeight:videoHeight];
