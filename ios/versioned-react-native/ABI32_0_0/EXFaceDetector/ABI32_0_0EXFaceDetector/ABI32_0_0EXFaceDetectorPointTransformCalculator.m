//
//  ABI32_0_0EXFaceDetectorPointTransformCalculator.m
//  Exponent
//
...
#import <ABI32_0_0EXFaceDetector/ABI32_0_0EXFaceDetectorPointTransformCalculator.h>
...
typedef NS_ENUM(NSInteger, ABI32_0_0EXTranslationEnum) {
  ABI32_0_0EXTranslateYNegativeWidth,
  ABI32_0_0EXTranslateXNegativeHeight,
  ABI32_0_0EXTranslateXYNegative,
  ABI32_0_0EXTranslateYXNegative
};

@interface ABI32_0_0EXFaceDetectorPointTransformCalculator()
...
@implementation ABI32_0_0EXFaceDetectorPointTransformCalculator
...
- (CGPoint)translation
{
  ...
  AVCaptureVideoOrientation firstOrientation = MIN(_fromOrientation, _toOrientation);
  AVCaptureVideoOrientation secondOrientation = MAX(_fromOrientation, _toOrientation);
  ABI32_0_0EXTranslationEnum enumValue = [[[self class] getTranslationDictionary][@(firstOrientation)][@(secondOrientation)] intValue];
...
- (CGPoint)translationForEnum:(ABI32_0_0EXTranslationEnum)enumValue
{
  switch (enumValue) {
    case ABI32_0_0EXTranslateXNegativeHeight:
      return CGPointMake(-_videoHeight, 0);
    case ABI32_0_0EXTranslateYNegativeWidth:
      return CGPointMake(0, -_videoWidth);
    case ABI32_0_0EXTranslateXYNegative:
      return CGPointMake(-_videoWidth, -_videoHeight);
    case ABI32_0_0EXTranslateYXNegative:
...
+ (void)initTranslationDictionary
{
  translationDictionary = @{
                            @(AVCaptureVideoOrientationPortrait): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI32_0_0EXTranslateYNegativeWidth),
                                @(AVCaptureVideoOrientationLandscapeRight) : @(ABI32_0_0EXTranslateXNegativeHeight),
                                @(AVCaptureVideoOrientationPortraitUpsideDown) : @(ABI32_0_0EXTranslateYXNegative)
                                },
                            @(AVCaptureVideoOrientationPortraitUpsideDown): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI32_0_0EXTranslateXNegativeHeight),
                                @(AVCaptureVideoOrientationLandscapeRight) : @(ABI32_0_0EXTranslateYNegativeWidth)
                                },
                            @(AVCaptureVideoOrientationLandscapeRight): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI32_0_0EXTranslateXYNegative)
                                }
                            };
}
