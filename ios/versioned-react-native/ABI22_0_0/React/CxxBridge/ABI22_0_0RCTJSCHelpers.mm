...
#include "ABI22_0_0RCTJSCHelpers.h"
...
#import <cxxReactABI22_0_0/ABI22_0_0Platform.h>
#import <ABI22_0_0jschelpers/ABI22_0_0Value.h>
...
JSValueRef nativeLoggingHook(
  ...
  if (argumentCount > 1) {
    level = MAX(level, (ABI22_0_0RCTLogLevel)Value(ctx, arguments[1]).asNumber());
  }
  if (argumentCount > 0) {
    ...
    _ABI22_0_0RCTLogJavaScriptInternal(level, [msg toString]);
  }
...
void ABI22_0_0RCTPrepareJSCExecutor() {
  ReactABI22_0_0Marker::logTaggedMarker = [](const ReactABI22_0_0Marker::ReactABI22_0_0MarkerId, const char *tag) {};
  JSCNativeHooks::loggingHook = nativeLoggingHook;
  JSCNativeHooks::nowHook = nativePerformanceNow;
  JSCNativeHooks::installPerfHooks = ABI22_0_0RCTFBQuickPerformanceLoggerConfigureHooks;
}
