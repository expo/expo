...
#import <ReactABI22_0_0/ABI22_0_0RCTCxxBridgeDelegate.h>
#import <ReactABI22_0_0/ABI22_0_0RCTCxxModule.h>
#import <ReactABI22_0_0/ABI22_0_0RCTCxxUtils.h>
#import <ReactABI22_0_0/ABI22_0_0RCTDevSettings.h>
#import <ReactABI22_0_0/ABI22_0_0RCTDisplayLink.h>
...
#import <cxxReactABI22_0_0/ABI22_0_0CxxNativeModule.h>
#import <cxxReactABI22_0_0/ABI22_0_0Instance.h>
#import <cxxReactABI22_0_0/ABI22_0_0JSBundleType.h>
#import <cxxReactABI22_0_0/ABI22_0_0JSCExecutor.h>
#import <cxxReactABI22_0_0/ABI22_0_0JSIndexedRAMBundle.h>
#import <cxxReactABI22_0_0/ABI22_0_0Platform.h>
#import <ABI22_0_0jschelpers/ABI22_0_0Value.h>

#import "ABI22_0_0NSDataBigString.h"
#import "ABI22_0_0RCTJSCHelpers.h"
#import "ABI22_0_0RCTMessageThread.h"
#import "ABI22_0_0RCTObjcExecutor.h"

#ifdef WITH_FBSYSTRACE
#import <ReactABI22_0_0/ABI22_0_0RCTFBSystrace.h>
#endif
...
@interface ABI22_0_0RCTCxxBridge : ABI22_0_0RCTBridge
@end

#define ABI22_0_0RCTAssertJSThread() \
  ABI22_0_0RCTAssert(self.executorClass || self->_jsThread == [NSThread currentThread], \
            @"This method must be called on JS thread")

static NSString *const ABI22_0_0RCTJSThreadName = @"com.facebook.ReactABI22_0_0.JavaScript";
...
static void registerPerformanceLoggerHooks(ABI22_0_0RCTPerformanceLogger *performanceLogger) {
  __weak ABI22_0_0RCTPerformanceLogger *weakPerformanceLogger = performanceLogger;
  ReactABI22_0_0Marker::logTaggedMarker = [weakPerformanceLogger](const ReactABI22_0_0Marker::ReactABI22_0_0MarkerId markerId, const char *tag) {
    switch (markerId) {
      case ReactABI22_0_0Marker::RUN_JS_BUNDLE_START:
        [weakPerformanceLogger markStartForTag:ABI22_0_0RCTPLScriptExecution];
        break;
      case ReactABI22_0_0Marker::RUN_JS_BUNDLE_STOP:
        [weakPerformanceLogger markStopForTag:ABI22_0_0RCTPLScriptExecution];
        break;
      case ReactABI22_0_0Marker::NATIVE_REQUIRE_START:
        [weakPerformanceLogger appendStartForTag:ABI22_0_0RCTPLRAMNativeRequires];
        break;
      case ReactABI22_0_0Marker::NATIVE_REQUIRE_STOP:
        [weakPerformanceLogger appendStopForTag:ABI22_0_0RCTPLRAMNativeRequires];
        [weakPerformanceLogger addValue:1 forTag:ABI22_0_0RCTPLRAMNativeRequiresCount];
        break;
      case ReactABI22_0_0Marker::CREATE_REACT_CONTEXT_STOP:
      case ReactABI22_0_0Marker::JS_BUNDLE_STRING_CONVERT_START:
      case ReactABI22_0_0Marker::JS_BUNDLE_STRING_CONVERT_STOP:
      case ReactABI22_0_0Marker::NATIVE_MODULE_SETUP_START:
      case ReactABI22_0_0Marker::NATIVE_MODULE_SETUP_STOP:
...
@interface ABI22_0_0RCTCxxBridge ()

@property (nonatomic, weak, readonly) ABI22_0_0RCTBridge *parentBridge;
...
struct ABI22_0_0RCTInstanceCallback : public InstanceCallback {
  __weak ABI22_0_0RCTCxxBridge *bridge_;
  ABI22_0_0RCTInstanceCallback(ABI22_0_0RCTCxxBridge *bridge): bridge_(bridge) {};
...
@implementation ABI22_0_0RCTCxxBridge
{
  ...
  // Native modules
  NSMutableDictionary<NSString *, ABI22_0_0RCTModuleData *> *_moduleDataByName;
  NSMutableArray<ABI22_0_0RCTModuleData *> *_moduleDataByID;
  ...
  NSThread *_jsThread;
  std::shared_ptr<ABI22_0_0RCTMessageThread> _jsMessageThread;

  // This is uniquely owned, but weak_ptr is used.
  std::shared_ptr<Instance> _ReactABI22_0_0Instance;
}
...
+ (void)initialize
{
  if (self == [ABI22_0_0RCTCxxBridge class]) {
    ABI22_0_0RCTPrepareJSCExecutor();
  }
}
...
{
  return (JSGlobalContextRef)(self->_ReactABI22_0_0Instance ? self->_ReactABI22_0_0Instance->getJavaScriptContext() : nullptr);
}
...
{
  @autoreleasepool {
    ABI22_0_0RCT_PROFILE_BEGIN_EVENT(ABI22_0_0RCTProfileTagAlways, @"-[ABI22_0_0RCTCxxBridge runJSRunLoop] setup", nil);
...
{
  ABI22_0_0RCTAssert(_jsThread, @"This method must not be called before the JS thread is created");
...
- (void)start
{
  ABI22_0_0RCT_PROFILE_BEGIN_EVENT(ABI22_0_0RCTProfileTagAlways, @"-[ABI22_0_0RCTCxxBridge start]", nil);
  ...
  _jsThread = [[NSThread alloc] initWithTarget:[self class]
                                      selector:@selector(runRunLoop)
                                        object:nil];
  _jsThread.name = ABI22_0_0RCTJSThreadName;
  ...
  [self _initModules:ABI22_0_0RCTGetModuleClasses() withDispatchGroup:prepareBridge lazilyDiscovered:NO];
  ...
  _ReactABI22_0_0Instance.reset(new Instance);

  __weak ABI22_0_0RCTCxxBridge *weakSelf = self;

  // Prepare executor factory (shared_ptr for copy into block)
  std::shared_ptr<JSExecutorFactory> executorFactory;
  if (!self.executorClass) {
    if ([self.delegate conformsToProtocol:@protocol(ABI22_0_0RCTCxxBridgeDelegate)]) {
      id<ABI22_0_0RCTCxxBridgeDelegate> cxxDelegate = (id<ABI22_0_0RCTCxxBridgeDelegate>) self.delegate;
    ...
    if (!executorFactory) {
      ...
      executorFactory.reset(new JSCExecutorFactory(folly::dynamic::object
        ("OwnerIdentity", "ReactABI22_0_0Native")
    ...
    id<ABI22_0_0RCTJavaScriptExecutor> objcExecutor = [self moduleForClass:self.executorClass];
    executorFactory.reset(new ABI22_0_0RCTObjcExecutorFactory(objcExecutor, ^(NSError *error) {
      if (error) {
  ...
  if (!self.executorClass &&
    ...
    NSData *sourceCode = [ABI22_0_0RCTJavaScriptLoader attemptSynchronousLoadOfBundleAtURL:self.bundleURL
    ...
    dispatch_group_notify(prepareBridge, dispatch_get_global_queue(QOS_CLASS_USER_INTERACTIVE, 0), ^{
      ABI22_0_0RCTCxxBridge *strongSelf = weakSelf;
...
- (void)loadSource:(ABI22_0_0RCTSourceLoadBlock)_onSourceLoad onProgress:(ABI22_0_0RCTSourceLoadProgressBlock)onProgress
{
  ...
  [center postNotificationName:ABI22_0_0RCTBridgeWillDownloadScriptNotification object:_parentBridge];
  [_performanceLogger markStartForTag:ABI22_0_0RCTPLScriptDownload];
  NSUInteger cookie = ABI22_0_0RCTProfileBeginAsyncEvent(0, @"JavaScript download", nil);

  // Suppress a warning if ABI22_0_0RCTProfileBeginAsyncEvent gets compiled out
  (void)cookie;
  ...
  ABI22_0_0RCTSourceLoadBlock onSourceLoad = ^(NSError *error, ABI22_0_0RCTSource *source) {
    ABI22_0_0RCTProfileEndAsyncEvent(0, @"native", cookie, @"JavaScript download", @"JS async");
    ...
    NSDictionary *userInfo = source ? @{ ABI22_0_0RCTBridgeDidDownloadScriptNotificationSourceKey: source } : nil;
    [center postNotificationName:ABI22_0_0RCTBridgeDidDownloadScriptNotification object:self->_parentBridge userInfo:userInfo];
...
- (std::shared_ptr<ModuleRegistry>)_buildModuleRegistry
{
  ...
  [_performanceLogger markStartForTag:ABI22_0_0RCTPLNativeModulePrepareConfig];
  ABI22_0_0RCT_PROFILE_BEGIN_EVENT(ABI22_0_0RCTProfileTagAlways, @"-[ABI22_0_0RCTCxxBridge buildModuleRegistry]", nil);
  ...
  auto registry = std::make_shared<ModuleRegistry>(
         createNativeModules(_moduleDataByID, self, _ReactABI22_0_0Instance),
         moduleNotFoundCallback);

  [_performanceLogger markStopForTag:ABI22_0_0RCTPLNativeModulePrepareConfig];
  ABI22_0_0RCT_PROFILE_END_EVENT(ABI22_0_0RCTProfileTagAlways, @"");
...
- (void)_initializeBridge:(std::shared_ptr<JSExecutorFactory>)executorFactory
{
  ...
  __weak ABI22_0_0RCTCxxBridge *weakSelf = self;
  _jsMessageThread = std::make_shared<ABI22_0_0RCTMessageThread>([NSRunLoop currentRunLoop], ^(NSError *error) {
    if (error) {
      [weakSelf handleError:error];
    }
  });

  ABI22_0_0RCT_PROFILE_BEGIN_EVENT(ABI22_0_0RCTProfileTagAlways, @"-[ABI22_0_0RCTCxxBridge initializeBridge:]", nil);
  // This can only be false if the bridge was invalidated before startup completed
  if (_ReactABI22_0_0Instance) {
    // This is async, but any calls into JS are blocked by the m_syncReady CV in Instance
    _ReactABI22_0_0Instance->initializeBridge(
      std::make_unique<ABI22_0_0RCTInstanceCallback>(self),
      executorFactory,
      _jsMessageThread,
    ...
    if (ABI22_0_0RCTProfileIsProfiling()) {
      _ReactABI22_0_0Instance->setGlobalVariable(
        "__ABI22_0_0RCTProfileIsProfiling",
...
- (NSArray<ABI22_0_0RCTModuleData *> *)registerModulesForClasses:(NSArray<Class> *)moduleClasses
{
  ABI22_0_0RCT_PROFILE_BEGIN_EVENT(ABI22_0_0RCTProfileTagAlways,
                          @"-[ABI22_0_0RCTCxxBridge initModulesWithDispatchGroup:] autoexported moduleData", nil);

  NSMutableArray<ABI22_0_0RCTModuleData *> *moduleDataByID = [NSMutableArray arrayWithCapacity:moduleClasses.count];
  for (Class moduleClass in moduleClasses) {
    ...
    if ([moduleName isEqualToString:@"ABI22_0_0RCTJSCExecutor"]) {
      continue;
    }
    ...
    moduleData = [[ABI22_0_0RCTModuleData alloc] initWithModuleClass:moduleClass bridge:self];
...
{
  ABI22_0_0RCT_PROFILE_BEGIN_EVENT(ABI22_0_0RCTProfileTagAlways,
                          @"-[ABI22_0_0RCTCxxBridge initModulesWithDispatchGroup:] extraModules", nil);
  ...
  ABI22_0_0RCT_PROFILE_BEGIN_EVENT(ABI22_0_0RCTProfileTagAlways,
                          @"-[ABI22_0_0RCTCxxBridge initModulesWithDispatchGroup:] preinitialized moduleData", nil);
  ...
  for (id<ABI22_0_0RCTBridgeModule> module in extraModules) {
    ...
    ABI22_0_0RCTModuleData *moduleData = [[ABI22_0_0RCTModuleData alloc] initWithModuleInstance:module bridge:self];
    _moduleDataByName[moduleName] = moduleData;
    [_moduleClassesByID addObject:moduleClass];
...
- (void)_initModules:(NSArray<id<ABI22_0_0RCTBridgeModule>> *)modules
   withDispatchGroup:(dispatch_group_t)dispatchGroup
    lazilyDiscovered:(BOOL)lazilyDiscovered
{
  ABI22_0_0RCTAssert(!(ABI22_0_0RCTIsMainQueue() && lazilyDiscovered), @"Lazy discovery can only happen off the Main Queue");

  // Set up moduleData for automatically-exported modules
  NSArray<ABI22_0_0RCTModuleData *> *moduleDataById = [self registerModulesForClasses:modules];

#ifdef ABI22_0_0RCT_DEBUG
  if (lazilyDiscovered) {
    ...
    for (ABI22_0_0RCTModuleData *moduleData in moduleDataById) {
      ABI22_0_0RCTAssert(!(moduleData.requiresMainQueueSetup || moduleData.hasInstance),
  ...
  {
    ABI22_0_0RCT_PROFILE_BEGIN_EVENT(ABI22_0_0RCTProfileTagAlways,
                            @"-[ABI22_0_0RCTCxxBridge initModulesWithDispatchGroup:] moduleData.hasInstance", nil);
    ...
    for (ABI22_0_0RCTModuleData *moduleData in _moduleDataByID) {
      if (moduleData.hasInstance && (!moduleData.requiresMainQueueSetup || ABI22_0_0RCTIsMainQueue())) {
  ...
  if (ABI22_0_0RCTProfileIsProfiling()) {
    ...
    ABI22_0_0RCTProfileHookModules(self);
  }
#endif
}
...
- (void)_prepareModulesWithDispatchGroup:(dispatch_group_t)dispatchGroup
{
  ...
  [_performanceLogger setValue:0 forTag:ABI22_0_0RCTPLNativeModuleMainThread];
  ...
  for (ABI22_0_0RCTModuleData *moduleData in _moduleDataByID) {
    ...
    if (moduleData.requiresMainQueueSetup) {
      ...
      dispatch_block_t block = ^{
        if (self.valid && ![moduleData.moduleClass isSubclassOfClass:[ABI22_0_0RCTCxxModule class]]) {
...
- (void)handleError:(NSError *)error
{
  ...
  // through this method, but through ABI22_0_0RCTExceptionManager.
  ...
  // In state 1: on main queue, move to state 2, reset the bridge, and ABI22_0_0RCTFatal.
  // In state 2: go directly to ABI22_0_0RCTFatal.  Do not enqueue, do not collect $200.
  // In state 3: do nothing.

  if (self->_valid && !self->_loading) {
    if ([error userInfo][ABI22_0_0RCTJSRawStackTraceKey]) {
      [self.redBox showErrorMessage:[error localizedDescription]
                       withRawStack:[error userInfo][ABI22_0_0RCTJSRawStackTraceKey]];
    }
  ...
  ABI22_0_0RCTRedBox *redBox = [self redBox];
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    self->_ReactABI22_0_0Instance.reset();
...
- (void)invalidate
{
  ...
  ABI22_0_0RCTAssertMainQueue();
  ABI22_0_0RCTLogInfo(@"Invalidating %@ (parent: %@, executor: %@)", self, _parentBridge, [self executorClass]);
  ...
  [self ensureOnJavaScriptThread:^{
    ...
    for (ABI22_0_0RCTModuleData *moduleData in self->_moduleDataByID) {
      ...
      if ([moduleData.instance respondsToSelector:@selector(invalidate)]) {
        ...
        [self dispatchBlock:^{
          [(id<ABI22_0_0RCTInvalidating>)moduleData.instance invalidate];
    ...
    if (dispatch_group_wait(moduleInvalidation, dispatch_time(DISPATCH_TIME_NOW, 10 * NSEC_PER_SEC))) {
      ABI22_0_0RCTLogError(@"Timed out waiting for modules to be invalidated");
    }
...
- (void)_flushPendingCalls
{
  ...
  [_performanceLogger setValue:nativeRequiresCount forTag:ABI22_0_0RCTPLRAMStartupNativeRequiresCount];
  uint64_t nativeRequires = [self->_performanceLogger valueForTag:ABI22_0_0RCTPLRAMNativeRequires];
  [_performanceLogger setValue:nativeRequires forTag:ABI22_0_0RCTPLRAMStartupNativeRequires];

  [_performanceLogger markStopForTag:ABI22_0_0RCTPLBridgeStartup];

  ABI22_0_0RCT_PROFILE_BEGIN_EVENT(0, @"Processing pendingCalls", @{ @"count": [@(_pendingCalls.count) stringValue] });
...
- (void)enqueueJSCall:(NSString *)module method:(NSString *)method args:(NSArray *)args completion:(dispatch_block_t)completion
{
   ...
   * AnyThread
   */
  ABI22_0_0RCT_PROFILE_BEGIN_EVENT(ABI22_0_0RCTProfileTagAlways, @"-[ABI22_0_0RCTCxxBridge enqueueJSCall:]", nil);

  ABI22_0_0RCTProfileBeginFlowEvent();
  [self _runAfterLoad:^{
    ABI22_0_0RCTProfileEndFlowEvent();

    if (self->_ReactABI22_0_0Instance) {
      self->_ReactABI22_0_0Instance->callJSFunction([module UTF8String], [method UTF8String],
      ...
      if (completion) {
        if (self->_jsMessageThread) {
          ...
          ABI22_0_0RCTLogWarn(@"Can't invoke completion without messageThread");
        }
      }
    }
  }];
...
- (void)enqueueCallback:(NSNumber *)cbID args:(NSArray *)args
{
  ...
  [self _runAfterLoad:^{
    ...
    if (self->_ReactABI22_0_0Instance) {
      self->_ReactABI22_0_0Instance->callJSCallback([cbID unsignedLongLongValue], convertIdToFollyDynamic(args ?: @[]));
    }
  }];
}
...
- (void)_immediatelyCallTimer:(NSNumber *)timer
{
  ...
  if (_ReactABI22_0_0Instance) {
    _ReactABI22_0_0Instance->callJSFunction("JSTimers", "callTimers",
...
{
  ABI22_0_0RCT_PROFILE_BEGIN_EVENT(ABI22_0_0RCTProfileTagAlways, @"-[ABI22_0_0RCTCxxBridge enqueueApplicationScript]", nil);

  [self _tryAndHandleError:^{
    NSString *sourceUrlStr = deriveSourceURL(url);
    if (isRAMBundle(script)) {
      [self->_performanceLogger markStartForTag:ABI22_0_0RCTPLRAMBundleLoad];
      auto ramBundle = std::make_unique<JSIndexedRAMBundle>(sourceUrlStr.UTF8String);
      std::unique_ptr<const JSBigString> scriptStr = ramBundle->getStartupCode();
      [self->_performanceLogger markStopForTag:ABI22_0_0RCTPLRAMBundleLoad];
      [self->_performanceLogger setValue:scriptStr->size() forTag:ABI22_0_0RCTPLRAMStartupCodeSize];
      if (self->_ReactABI22_0_0Instance) {
        self->_ReactABI22_0_0Instance->loadUnbundle(std::move(ramBundle), std::move(scriptStr),
                                           sourceUrlStr.UTF8String, false);
      }
    } else if (self->_ReactABI22_0_0Instance) {
      self->_ReactABI22_0_0Instance->loadScriptFromString(std::make_unique<NSDataBigString>(script),
                                                 sourceUrlStr.UTF8String, false);
    } else {
  ...
  if (onComplete) {
    ABI22_0_0RCTAssert(_jsMessageThread != nullptr, @"Cannot invoke completion without jsMessageThread");
                            ...
                            error:(NSError **)error
{
  if (!_ReactABI22_0_0Instance) {
    if (error) {
      *error = ABI22_0_0RCTErrorWithMessage(
  ...
  NSError *errorObj = tryAndReturnError(^{
    Value result = self->_ReactABI22_0_0Instance->callFunctionSync([module UTF8String], [method UTF8String], (id)arguments);
...
- (void)batchDidComplete
{
  // TODO #12592471: batchDidComplete is only used by ABI22_0_0RCTUIManager,
...
- (void)startProfiling
{
  ...
  [self ensureOnJavaScriptThread:^{
    #if WITH_FBSYSTRACE
    [ABI22_0_0RCTFBSystrace registerCallbacks];
    #endif
...
- (void)stopProfiling:(void (^)(NSData *))callback
{
  ...
  [self ensureOnJavaScriptThread:^{
    ...
    ABI22_0_0RCTProfileEnd(self, ^(NSString *log) {
      ...
      callback(logData);
      #if WITH_FBSYSTRACE
      [ABI22_0_0RCTFBSystrace unregisterCallbacks];
      #endif
    });
  }];
}
