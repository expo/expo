...
@implementation ABI22_0_0RCTSamplingProfilerPackagerMethod {
  __weak id<ABI22_0_0RCTJSEnvironment> _jsEnvironment;
}
...
- (void)handleRequest:(__unused id)params withResponder:(ABI22_0_0RCTPackagerClientResponder *)responder
{
...
{
  ABI22_0_0RCTLogError(@"%@ does not implement onNotification", [self class]);
}
