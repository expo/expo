...
#import <ABI22_0_0jschelpers/ABI22_0_0JSCWrapper.h>
...
@implementation ABI22_0_0RCTInspectorDevServerHelper

ABI22_0_0RCT_NOT_IMPLEMENTED(- (instancetype)init)

static NSMutableDictionary<NSString *, ABI22_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
            ...
            withBundleURL:(NSURL *)bundleURL
{
  ...
  ABI22_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection) {
    connection = [[ABI22_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
