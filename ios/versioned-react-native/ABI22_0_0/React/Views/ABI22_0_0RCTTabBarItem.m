...
@implementation ABI22_0_0RCTConvert (UITabBarSystemItem)

ABI22_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI22_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI22_0_0ViewController;
}
