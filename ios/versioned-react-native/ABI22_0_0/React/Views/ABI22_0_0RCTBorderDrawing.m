...
static const CGFloat ABI22_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI22_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return
  ABS(borderInsets.left - borderInsets.right) < ABI22_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.bottom) < ABI22_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.top) < ABI22_0_0RCTViewBorderThreshold;
}

BOOL ABI22_0_0RCTCornerRadiiAreEqual(ABI22_0_0RCTCornerRadii cornerRadii)
{
  return
  ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI22_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI22_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI22_0_0RCTViewBorderThreshold;
}

BOOL ABI22_0_0RCTBorderColorsAreEqual(ABI22_0_0RCTBorderColors borderColors)
{
  return
...
ABI22_0_0RCTCornerInsets ABI22_0_0RCTGetCornerInsets(ABI22_0_0RCTCornerRadii cornerRadii,
                                   UIEdgeInsets edgeInsets)
{
  return (ABI22_0_0RCTCornerInsets) {
    {
...
static void ABI22_0_0RCTPathAddEllipticArc(CGMutablePathRef path,
...
CGPathRef ABI22_0_0RCTPathCreateWithRoundedRect(CGRect bounds,
                                       ABI22_0_0RCTCornerInsets cornerInsets,
                                       const CGAffineTransform *transform)
{
  ...
  ABI22_0_0RCTPathAddEllipticArc(path, transform, (CGPoint){
...
static void ABI22_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds,
                                               CGPoint lineStart,
                                               CGPoint lineEnd,
...
NS_INLINE BOOL ABI22_0_0RCTCornerRadiiAreAboveThreshold(ABI22_0_0RCTCornerRadii cornerRadii) {
  return (cornerRadii.topLeft > ABI22_0_0RCTViewBorderThreshold ||
    cornerRadii.topRight > ABI22_0_0RCTViewBorderThreshold      ||
    cornerRadii.bottomLeft > ABI22_0_0RCTViewBorderThreshold    ||
    cornerRadii.bottomRight > ABI22_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI22_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI22_0_0RCTCornerRadii cornerRadii) {
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI22_0_0RCTPathCreateWithRoundedRect(rect, ABI22_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef ABI22_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge) {
...
static UIImage *ABI22_0_0RCTGetSolidBorderImage(ABI22_0_0RCTCornerRadii cornerRadii,
                                       CGSize viewSize,
                                       UIEdgeInsets borderInsets,
                                       ABI22_0_0RCTBorderColors borderColors,
                                       CGColorRef backgroundColor,
                                       BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI22_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI22_0_0RCTCornerInsets cornerInsets = ABI22_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  CGContextRef ctx = ABI22_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI22_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI22_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI22_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI22_0_0RCTEllipseGetIntersectionsWithLine((CGRect){
...
static UIImage *ABI22_0_0RCTGetDashedOrDottedBorderImage(ABI22_0_0RCTBorderStyle borderStyle,
                                                ABI22_0_0RCTCornerRadii cornerRadii,
                                                CGSize viewSize,
                                                UIEdgeInsets borderInsets,
                                                ABI22_0_0RCTBorderColors borderColors,
                                                CGColorRef backgroundColor,
                                                BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI22_0_0RCTBorderStyleDashed || borderStyle == ABI22_0_0RCTBorderStyleDotted);

  if (!ABI22_0_0RCTBorderColorsAreEqual(borderColors) || !ABI22_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI22_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI22_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI22_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI22_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI22_0_0RCTPathCreateWithRoundedRect(pathRect, ABI22_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI22_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
...
UIImage *ABI22_0_0RCTGetBorderImage(ABI22_0_0RCTBorderStyle borderStyle,
                           CGSize viewSize,
                           ABI22_0_0RCTCornerRadii cornerRadii,
                           UIEdgeInsets borderInsets,
                           ABI22_0_0RCTBorderColors borderColors,
                           ...
                           BOOL drawToEdge)
{
  ...
  switch (borderStyle) {
    case ABI22_0_0RCTBorderStyleSolid:
      return ABI22_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI22_0_0RCTBorderStyleDashed:
    case ABI22_0_0RCTBorderStyleDotted:
      return ABI22_0_0RCTGetDashedOrDottedBorderImage(borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI22_0_0RCTBorderStyleUnset:
      break;
  }
