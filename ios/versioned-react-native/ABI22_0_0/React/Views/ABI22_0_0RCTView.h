...
@protocol ABI22_0_0RCTAutoInsetsProtocol;

@class ABI22_0_0RCTView;

@interface ABI22_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI22_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI22_0_0RCTDirectEventBlock onMagicTap;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI22_0_0RCTPointerEvents pointerEvents;

+ (void)autoAdjustInsetsForView:(UIView<ABI22_0_0RCTAutoInsetsProtocol> *)parentView
 ...
 * This is inherited from UIView+ReactABI22_0_0, but we override it here
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI22_0_0RCTBorderStyle borderStyle;
