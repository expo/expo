...
#import "ABI22_0_0RCTViewControllerProtocol.h"
#import "ABI22_0_0RCTWrapperViewController.h"
#import "UIView+ReactABI22_0_0.h"

@interface ABI22_0_0RCTTabBar() <UITabBarControllerDelegate>

@end

@implementation ABI22_0_0RCTTabBar
{
  BOOL _tabsChanged;
...
- (void)insertReactABI22_0_0Subview:(ABI22_0_0RCTTabBarItem *)subview atIndex:(NSInteger)atIndex
{
  if (![subview isKindOfClass:[ABI22_0_0RCTTabBarItem class]]) {
    ABI22_0_0RCTLogError(@"subview should be of type ABI22_0_0RCTTabBarItem");
    return;
  }
...
- (void)removeReactABI22_0_0Subview:(ABI22_0_0RCTTabBarItem *)subview
{
  if (self.ReactABI22_0_0Subviews.count == 0) {
    ABI22_0_0RCTLogError(@"should have at least one view to remove a subview");
    return;
  }
...
{
  // Do nothing, as subviews are managed by `ReactABI22_0_0BridgeDidFinishTransaction`
}

- (void)layoutSubviews
{
  [super layoutSubviews];
  [self ReactABI22_0_0AddControllerToClosestParent:_tabController];
  _tabController.view.frame = self.bounds;
}

- (void)ReactABI22_0_0BridgeDidFinishTransaction
{
  ...
  if (_tabsChanged) {
    ...
    for (ABI22_0_0RCTTabBarItem *tab in [self ReactABI22_0_0Subviews]) {
      UIViewController *controller = tab.ReactABI22_0_0ViewController;
      if (!controller) {
        controller = [[ABI22_0_0RCTWrapperViewController alloc] initWithContentView:tab];
      }
  ...
  [self.ReactABI22_0_0Subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger index, __unused BOOL *stop) {

    ABI22_0_0RCTTabBarItem *tab = (ABI22_0_0RCTTabBarItem *)view;
...
- (void)tabBarController:(UITabBarController *)tabBarController didSelectViewController:(nonnull UIViewController *)viewController
{
  ...
  ABI22_0_0RCTTabBarItem *tab = (ABI22_0_0RCTTabBarItem *)self.ReactABI22_0_0Subviews[index];
