...
#import <yogaABI22_0_0/ABI22_0_0YGEnums.h>

@class ABI22_0_0RCTShadowView;

@interface UIView (ReactABI22_0_0) <ABI22_0_0RCTComponent>

/**
 * ABI22_0_0RCTComponent interface.
 */
- (NSArray<UIView *> *)ReactABI22_0_0Subviews NS_REQUIRES_SUPER;
- (UIView *)ReactABI22_0_0Superview NS_REQUIRES_SUPER;
- (void)insertReactABI22_0_0Subview:(UIView *)subview atIndex:(NSInteger)atIndex NS_REQUIRES_SUPER;
- (void)removeReactABI22_0_0Subview:(UIView *)subview NS_REQUIRES_SUPER;
 ...
 */
@property (nonatomic, assign) UIUserInterfaceLayoutDirection ReactABI22_0_0LayoutDirection;
 ...
 */
@property (nonatomic, assign) ABI22_0_0YGDisplay ReactABI22_0_0Display;

/**
 * The z-index of the view.
 */
@property (nonatomic, assign) NSInteger ReactABI22_0_0ZIndex;
...
/**
 * Updates the subviews array based on the ReactABI22_0_0Subviews. Default behavior is
 * to insert the sortedReactABI22_0_0Subviews into the UIView.
 */
 ...
 */
@property (nonatomic, readonly) UIEdgeInsets ReactABI22_0_0BorderInsets;
@property (nonatomic, readonly) UIEdgeInsets ReactABI22_0_0PaddingInsets;
@property (nonatomic, readonly) UIEdgeInsets ReactABI22_0_0CompoundInsets;
@property (nonatomic, readonly) CGRect ReactABI22_0_0ContentFrame;
 ...
 * Defaults to `self`.
 */
@property (nonatomic, readonly) UIView *ReactABI22_0_0AccessibilityElement;
...
@property (nonatomic, strong, setter=_DEBUG_setReactABI22_0_0ShadowView:) ABI22_0_0RCTShadowView *_DEBUG_ReactABI22_0_0ShadowView;
