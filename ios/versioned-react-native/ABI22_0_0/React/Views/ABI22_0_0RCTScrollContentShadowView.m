...
@implementation ABI22_0_0RCTScrollContentShadowView
       ...
       absolutePosition:(CGPoint)absolutePosition
{
  ...
  CGFloat xCompensation = ABI22_0_0YGNodeLayoutGetRight(node) - ABI22_0_0YGNodeLayoutGetLeft(node);
  ...
  _frame.origin.x = ABI22_0_0RCTRoundPixelValue(ABI22_0_0YGNodeLayoutGetRight(node));
}
