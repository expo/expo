 ...
 */
@protocol ABI22_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ReactABI22_0_0-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI22_0_0RCTUIManager's observers.
 */
@interface ABI22_0_0RCTUIManagerObserverCoordinator : NSObject <ABI22_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI22_0_0RCTUIManagerObserver` protocol for more info.
