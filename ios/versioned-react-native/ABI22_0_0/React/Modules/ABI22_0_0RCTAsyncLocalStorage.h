 ...
 * being atomic, unless someone bypasses the `ABI22_0_0RCTAsyncLocalStorage` API.
 *
 * Keys and values must always be strings or an error is returned.
 */
@interface ABI22_0_0RCTAsyncLocalStorage : NSObject <ABI22_0_0RCTBridgeModule,ABI22_0_0RCTInvalidating>
...
// Clear the ABI22_0_0RCTAsyncLocalStorage data from native code
- (void)clearAllData;
