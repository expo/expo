...
#import "ABI22_0_0RCTKeyboardObserver.h"

#import "ABI22_0_0RCTEventDispatcher.h"

static NSDictionary *ABI22_0_0RCTParseKeyboardNotification(NSNotification *notification);

@implementation ABI22_0_0RCTKeyboardObserver
...
{ \
  [self sendEventWithName:@#EVENT \
    body:ABI22_0_0RCTParseKeyboardNotification(notification)]; \
}
...
NS_INLINE NSDictionary *ABI22_0_0RCTRectDictionaryValue(CGRect rect)
{
  return @{
...
static NSString *ABI22_0_0RCTAnimationNameForCurve(UIViewAnimationCurve curve)
{
  switch (curve) {
...
static NSDictionary *ABI22_0_0RCTParseKeyboardNotification(NSNotification *notification)
{
  ...
  return @{
    @"startCoordinates": ABI22_0_0RCTRectDictionaryValue(beginFrame),
    @"endCoordinates": ABI22_0_0RCTRectDictionaryValue(endFrame),
    @"duration": @(duration * 1000.0), // ms
    @"easing": ABI22_0_0RCTAnimationNameForCurve(curve),
  };
#endif
}
