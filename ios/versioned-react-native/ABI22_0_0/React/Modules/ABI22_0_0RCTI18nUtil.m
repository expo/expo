...
@implementation ABI22_0_0RCTI18nUtil

+ (id)sharedInstance {
   static ABI22_0_0RCTI18nUtil *sharedABI22_0_0RCTI18nUtilInstance = nil;
   @synchronized(self) {
     if (sharedABI22_0_0RCTI18nUtilInstance == nil)
      sharedABI22_0_0RCTI18nUtilInstance = [self new];
   }
   return sharedABI22_0_0RCTI18nUtilInstance;
}
...
- (BOOL)isRTLAllowed
{
  NSNumber *value = [[NSUserDefaults standardUserDefaults] objectForKey:@"ABI22_0_0RCTI18nUtil_allowRTL"];
  if (value == nil) {
    return YES;
  }
...
{
  [[NSUserDefaults standardUserDefaults] setBool:rtlStatus forKey:@"ABI22_0_0RCTI18nUtil_allowRTL"];
...
- (BOOL)isRTLForced
{
  BOOL rtlStatus = [[NSUserDefaults standardUserDefaults]
                            boolForKey:@"ABI22_0_0RCTI18nUtil_forceRTL"];
  return rtlStatus;
}

- (void)forceRTL:(BOOL)rtlStatus
{
  [[NSUserDefaults standardUserDefaults] setBool:rtlStatus forKey:@"ABI22_0_0RCTI18nUtil_forceRTL"];
  [[NSUserDefaults standardUserDefaults] synchronize];
}
