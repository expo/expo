...
@implementation ABI22_0_0RCTLayoutAnimationGroup
                      ...
                      callback:(ABI22_0_0RCTResponseSenderBlock)callback
{
  ...
  if (self = [super init]) {
    NSTimeInterval duration = [ABI22_0_0RCTConvert NSTimeInterval:config[@"duration"]];
    ...
    _creatingLayoutAnimation = [[ABI22_0_0RCTLayoutAnimation alloc] initWithDuration:duration config:config[@"create"]];
    _updatingLayoutAnimation = [[ABI22_0_0RCTLayoutAnimation alloc] initWithDuration:duration config:config[@"update"]];
    _deletingLayoutAnimation = [[ABI22_0_0RCTLayoutAnimation alloc] initWithDuration:duration config:config[@"delete"]];
    _callback = callback;
  }
...
- (BOOL)isEqual:(ABI22_0_0RCTLayoutAnimationGroup *)layoutAnimation
{
  ABI22_0_0RCTLayoutAnimation *creatingLayoutAnimation = layoutAnimation.creatingLayoutAnimation;
  ABI22_0_0RCTLayoutAnimation *updatingLayoutAnimation = layoutAnimation.updatingLayoutAnimation;
  ABI22_0_0RCTLayoutAnimation *deletingLayoutAnimation = layoutAnimation.deletingLayoutAnimation;
