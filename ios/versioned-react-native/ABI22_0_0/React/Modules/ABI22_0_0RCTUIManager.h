 ...
 * UIManager queue
 */
ABI22_0_0RCT_EXTERN dispatch_queue_t ABI22_0_0RCTGetUIManagerQueue(void);

/**
 * Default name for the UIManager queue
 */
ABI22_0_0RCT_EXTERN char *const ABI22_0_0RCTUIManagerQueueName;

/**
 * Check if we are currently on UIManager queue.
 */
ABI22_0_0RCT_EXTERN BOOL ABI22_0_0RCTIsUIManagerQueue(void);

/**
 * Convenience macro for asserting that we're running on UIManager queue.
 */
#define ABI22_0_0RCTAssertUIManagerQueue() ABI22_0_0RCTAssert(ABI22_0_0RCTIsUIManagerQueue(), \
 ...
 */
ABI22_0_0RCT_EXTERN NSString *const ABI22_0_0RCTUIManagerWillUpdateViewsDueToContentSizeMultiplierChangeNotification;

@class ABI22_0_0RCTLayoutAnimationGroup;
@class ABI22_0_0RCTUIManagerObserverCoordinator;

/**
 * The ABI22_0_0RCTUIManager is the module responsible for updating the view hierarchy.
 */
@interface ABI22_0_0RCTUIManager : NSObject <ABI22_0_0RCTBridgeModule, ABI22_0_0RCTInvalidating>

/**
 * Register a root view with the ABI22_0_0RCTUIManager.
 */
- (void)registerRootView:(UIView *)rootView;

/**
 * Gets the view name associated with a ReactABI22_0_0Tag.
 */
- (NSString *)viewNameForReactABI22_0_0Tag:(NSNumber *)ReactABI22_0_0Tag;

/**
 * Gets the view associated with a ReactABI22_0_0Tag.
 */
- (UIView *)viewForReactABI22_0_0Tag:(NSNumber *)ReactABI22_0_0Tag;

/**
 * Gets the shadow view associated with a ReactABI22_0_0Tag.
 */
 ...
 * or some other layout event outside of the ReactABI22_0_0-managed view hierarchy.
 */
...
/**
 * Given a ReactABI22_0_0Tag from a component, find its root view, if possible.
 * Otherwise, this will give back nil.
 *
 * @param ReactABI22_0_0Tag the component tag
 ...
 * @param rootTag the ReactABI22_0_0 tag of root view hierarchy from which to find the view.
 */
 ...
 * ReactABI22_0_0 won't be aware of this, so we need to make sure it happens.
 */
- (void)setNeedsLayout;

/**
 * Dedicated object for subscribing for UIManager events.
 * See `ABI22_0_0RCTUIManagerObserver` protocol for more details.
 */
@property (atomic, retain, readonly) ABI22_0_0RCTUIManagerObserverCoordinator *observerCoordinator;

@end

@interface ABI22_0_0RCTUIManager (Deprecated)
 ...
 */
- (void)registerRootView:(UIView *)rootView withSizeFlexibility:(ABI22_0_0RCTRootViewSizeFlexibility)sizeFlexibility
__deprecated_msg("Use `registerRootView:` instead.");

@end

/**
 * This category makes the current ABI22_0_0RCTUIManager instance available via the
 * ABI22_0_0RCTBridge, which is useful for ABI22_0_0RCTBridgeModules or ABI22_0_0RCTViewManagers that
 * need to access the ABI22_0_0RCTUIManager.
 */
@interface ABI22_0_0RCTBridge (ABI22_0_0RCTUIManager)

@property (nonatomic, readonly) ABI22_0_0RCTUIManager *uiManager;
