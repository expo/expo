...
@protocol ABI22_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI22_0_0RCTBridge *)bridge;
 ...
 */
- (NSURL *)fallbackSourceURLForBridge:(ABI22_0_0RCTBridge *)bridge;

/**
 * The bridge initializes any registered ABI22_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI22_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI22_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (NSArray<Class> *)whitelistedModulesForBridge:(ABI22_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeLoadJavaScriptSynchronously:(ABI22_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeInitializeNativeModulesSynchronously:(ABI22_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI22_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI22_0_0RCTBridge *)bridge;

/**
 * Configure whether the legacy ABI22_0_0RCTBatchedBridge or new ABI22_0_0RCTCxxBridge
 ...
 * implemented, the implementation will default to ABI22_0_0RCTBatchedBridge,
 * but if it is not linked in, will try ABI22_0_0RCTCxxBridge instead.  If
 ...
 * @experimental
 */
- (BOOL)shouldBridgeUseCxxBridge:(ABI22_0_0RCTBridge *)bridge;
...
*/
- (BOOL)bridge:(ABI22_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI22_0_0RCTBridge *)bridge
                 onProgress:(ABI22_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI22_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI22_0_0RCTBridge *)bridge
                  withBlock:(ABI22_0_0RCTSourceLoadBlock)loadCallback;
