...
extern NSString *const ABI22_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI22_0_0RCTBundleURLProviderDefaultPort;

@interface ABI22_0_0RCTBundleURLProvider : NSObject
