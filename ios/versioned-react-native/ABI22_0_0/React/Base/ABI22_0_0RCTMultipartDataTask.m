...
#import "ABI22_0_0RCTMultipartDataTask.h"

@interface ABI22_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI22_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI22_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI22_0_0RCTMultipartProgressCallback _progressHandler;
...
- (instancetype)initWithURL:(NSURL *)url
                partHandler:(ABI22_0_0RCTMultipartDataTaskCallback)partHandler
            progressHandler:(ABI22_0_0RCTMultipartProgressCallback)progressHandler
{
  if (self = [super init]) {
    _url = url;
...
{
  ABI22_0_0RCTMultipartStreamReader *reader = [[ABI22_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI22_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
