...
@interface ABI22_0_0RCTImageSource ()

@property (nonatomic, assign) BOOL packagerAsset;

@end

@implementation ABI22_0_0RCTImageSource
...
{
  ABI22_0_0RCTImageSource *imageSource = [[ABI22_0_0RCTImageSource alloc] initWithURLRequest:_request
                                                                      size:size
                                                                     scale:scale];
...
- (BOOL)isEqual:(ABI22_0_0RCTImageSource *)object
{
  if (![object isKindOfClass:[ABI22_0_0RCTImageSource class]]) {
    return NO;
  }
...
{
  return [NSString stringWithFormat:@"<ABI22_0_0RCTImageSource: %p URL=%@, size=%@, scale=%0.f>",
          self, _request.URL, NSStringFromCGSize(_size), _scale];
}

@end

@implementation ABI22_0_0RCTConvert (ImageSource)
...
+ (ABI22_0_0RCTImageSource *)ABI22_0_0RCTImageSource:(id)json
{
  ...
  if ([json isKindOfClass:[NSDictionary class]]) {
    ...
    ABI22_0_0RCTLogConvertError(json, @"an image. Did you forget to call resolveAssetSource() on the JS side?");
    return nil;
  }

  ABI22_0_0RCTImageSource *imageSource = [[ABI22_0_0RCTImageSource alloc] initWithURLRequest:request
                                                                      size:size
                                                                     scale:scale];
...
ABI22_0_0RCT_ARRAY_CONVERTER(ABI22_0_0RCTImageSource)
