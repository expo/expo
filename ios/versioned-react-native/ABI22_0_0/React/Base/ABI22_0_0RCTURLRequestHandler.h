 ...
 * are also bridge modules, so should be registered using ABI22_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI22_0_0RCTURLRequestHandler <ABI22_0_0RCTBridgeModule>
...
/**
 * If more than one ABI22_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
