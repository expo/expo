 ...
 */
@interface ABI22_0_0RCTImageSource : NSObject
...
@interface ABI22_0_0RCTConvert (ImageSource)

+ (ABI22_0_0RCTImageSource *)ABI22_0_0RCTImageSource:(id)json;
+ (NSArray<ABI22_0_0RCTImageSource *> *)ABI22_0_0RCTImageSourceArray:(id)json;
