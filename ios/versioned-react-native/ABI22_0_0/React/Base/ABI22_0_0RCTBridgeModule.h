...
@protocol ABI22_0_0RCTBridgeMethod;

/**
 * The type of a block that is capable of sending a response to a bridged
 * operation. Use this for returning callback methods to JS.
 */
typedef void (^ABI22_0_0RCTResponseSenderBlock)(NSArray *response);
 ...
 */
typedef void (^ABI22_0_0RCTResponseErrorBlock)(NSError *error);

/**
 * Block that bridge modules use to resolve the JS promise waiting for a result.
 * Nil results are supported and are converted to JS's undefined value.
 */
typedef void (^ABI22_0_0RCTPromiseResolveBlock)(id result);
 ...
 */
typedef void (^ABI22_0_0RCTPromiseRejectBlock)(NSString *code, NSString *message, NSError *error);
 ...
 * you need.
 *
 * NOTE: ABI22_0_0RCTJSThread is not a real libdispatch queue
 */
ABI22_0_0RCT_EXTERN dispatch_queue_t ABI22_0_0RCTJSThread;

ABI22_0_0RCT_EXTERN_C_BEGIN

typedef struct ABI22_0_0RCTMethodInfo {
  const char *const jsName;
  const char *const objcName;
  const BOOL isSync;
} ABI22_0_0RCTMethodInfo;
 ...
 */
@protocol ABI22_0_0RCTBridgeModule <NSObject>
 ...
 */
#define ABI22_0_0RCT_EXPORT_MODULE(js_name) \
ABI22_0_0RCT_EXTERN void ABI22_0_0RCTRegisterModule(Class); \
+ (NSString *)moduleName { return @#js_name; } \
+ (void)load { ABI22_0_0RCTRegisterModule(self); }

// Implemented by ABI22_0_0RCT_EXPORT_MODULE
+ (NSString *)moduleName;

@optional

/**
 * A reference to the ABI22_0_0RCTBridge. Useful for modules that require access
 * to bridge features, such as sending events or making JS calls. This
 * will be set automatically by the bridge when it initializes the module.
 * To implement this in your module, just add `@synthesize bridge = _bridge;`
 */
@property (nonatomic, weak, readonly) ABI22_0_0RCTBridge *bridge;
 ...
 * thread-only. You can tell ReactABI22_0_0 Native to call your module methods on the
 ...
 * ABI22_0_0RCT_REMAP_METHOD to specify the JS name of the method.
 *
 ...
 * becomes
 *
 * ABI22_0_0RCT_EXPORT_METHOD(doSomething:(NSString *)aString
 *                   withA:(NSInteger)a
 *                   andB:(NSInteger)b)
 * { ... }
 *
 ...
 * For example:
 *
 * ABI22_0_0RCT_EXPORT_METHOD(doSomethingAsync:(NSString *)aString
 ...
 *
 */
#define ABI22_0_0RCT_EXPORT_METHOD(method) \
  ABI22_0_0RCT_REMAP_METHOD(, method)

/**
 * Same as ABI22_0_0RCT_EXPORT_METHOD but the method is called from JS
 * synchronously **on the JS thread**, possibly returning a result.
 *
 * WARNING: in the vast majority of cases, you should use ABI22_0_0RCT_EXPORT_METHOD which
 ...
 */
#define ABI22_0_0RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(method) \
  ABI22_0_0RCT_REMAP_BLOCKING_SYNCHRONOUS_METHOD(, method)

/**
 * Similar to ABI22_0_0RCT_EXPORT_METHOD but lets you set the JS name of the exported
 * method. Example usage:
 *
 * ABI22_0_0RCT_REMAP_METHOD(executeQueryWithParameters,
 *   executeQuery:(NSString *)query parameters:(NSDictionary *)parameters)
 * { ... }
 */
#define ABI22_0_0RCT_REMAP_METHOD(js_name, method) \
  _ABI22_0_0RCT_EXTERN_REMAP_METHOD(js_name, method, NO) \
  - (void)method;

/**
 * Similar to ABI22_0_0RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD but lets you set
 * the JS name of the exported method. Example usage:
 *
 * ABI22_0_0RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(executeQueryWithParameters,
 *   executeQuery:(NSString *)query parameters:(NSDictionary *)parameters)
 * { ... }
 */
#define ABI22_0_0RCT_REMAP_BLOCKING_SYNCHRONOUS_METHOD(js_name, method) \
  _ABI22_0_0RCT_EXTERN_REMAP_METHOD(js_name, method, YES) \
  - (id)method;
 ...
 *
 *   @interface ABI22_0_0RCT_EXTERN_MODULE(MyModule, NSObject)
 *
 *   ABI22_0_0RCT_EXTERN_METHOD(doSomething:(NSString *)string withFoo:(NSInteger)a bar:(NSInteger)b)
 *
 *   @end
 *
 ...
 */
#define ABI22_0_0RCT_EXTERN_MODULE(objc_name, objc_supername) \
  ABI22_0_0RCT_EXTERN_REMAP_MODULE(, objc_name, objc_supername)

/**
 * Like ABI22_0_0RCT_EXTERN_MODULE, but allows setting a custom JavaScript name.
 */
#define ABI22_0_0RCT_EXTERN_REMAP_MODULE(js_name, objc_name, objc_supername) \
  objc_name : objc_supername \
  @end \
  @interface objc_name (ABI22_0_0RCTExternModule) <ABI22_0_0RCTBridgeModule> \
  @end \
  @implementation objc_name (ABI22_0_0RCTExternModule) \
  ABI22_0_0RCT_EXPORT_MODULE(js_name)

/**
 * Use this macro in accordance with ABI22_0_0RCT_EXTERN_MODULE to export methods
 * of an external module.
 */
#define ABI22_0_0RCT_EXTERN_METHOD(method) \
  _ABI22_0_0RCT_EXTERN_REMAP_METHOD(, method, NO)

/**
 * Use this macro in accordance with ABI22_0_0RCT_EXTERN_MODULE to export methods
 * of an external module that should be invoked synchronously.
 */
#define ABI22_0_0RCT_EXTERN__BLOCKING_SYNCHRONOUS_METHOD(method) \
  _ABI22_0_0RCT_EXTERN_REMAP_METHOD(, method, YES)

/**
 * Like ABI22_0_0RCT_EXTERN_REMAP_METHOD, but allows setting a custom JavaScript name
 * and also whether this method is synchronous.
 */
#define _ABI22_0_0RCT_EXTERN_REMAP_METHOD(js_name, method, is_blocking_synchronous_method) \
  + (const ABI22_0_0RCTMethodInfo *)ABI22_0_0RCT_CONCAT(__rct_export__, ABI22_0_0RCT_CONCAT(js_name, ABI22_0_0RCT_CONCAT(__LINE__, __COUNTER__))) { \
    static ABI22_0_0RCTMethodInfo config = {#js_name, #method, is_blocking_synchronous_method}; \
    return &config; \
  }
 ...
 * values such as session keys, that are regenerated only as part of a reload of the entire ReactABI22_0_0 application.
 *
