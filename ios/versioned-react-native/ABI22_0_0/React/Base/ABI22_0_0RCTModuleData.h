...
typedef id<ABI22_0_0RCTBridgeModule>(^ABI22_0_0RCTBridgeModuleProvider)(void);

@interface ABI22_0_0RCTModuleData : NSObject <ABI22_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI22_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI22_0_0RCTBridgeModule> instance;
