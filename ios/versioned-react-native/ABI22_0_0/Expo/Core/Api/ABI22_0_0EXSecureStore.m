...
#import "ABI22_0_0EXSecureStore.h"
...
@implementation ABI22_0_0RCTConvert (ABI22_0_0EXSecureStore)

ABI22_0_0RCT_ENUM_CONVERTER(ABI22_0_0EXSecureStoreAccessible, (@{
                                               @"AFTER_FIRST_UNLOCK":@(ABI22_0_0EXSecureStoreAccessibleAfterFirstUnlock),
                                               @"AFTER_FIRST_UNLOCK_THIS_DEVICE_ONLY":@(ABI22_0_0EXSecureStoreAccessibleAfterFirstUnlockThisDeviceOnly),
                                               @"ALWAYS":@(ABI22_0_0EXSecureStoreAccessibleAlways),
                                               @"WHEN_PASSCODE_SET_THIS_DEVICE_ONLY":@(ABI22_0_0EXSecureStoreAccessibleWhenPasscodeSetThisDeviceOnly),
                                               @"ALWAYS_THIS_DEVICE_ONLY":@(ABI22_0_0EXSecureStoreAccessibleAlwaysThisDeviceOnly),
                                               @"WHEN_UNLOCKED":@(ABI22_0_0EXSecureStoreAccessibleWhenUnlocked),
                                               @"WHEN_UNLOCKED_THIS_DEVICE_ONLY":@(ABI22_0_0EXSecureStoreAccessibleWhenUnlockedThisDeviceOnly),
                                               }), ABI22_0_0EXSecureStoreAccessibleWhenUnlocked, integerValue)

@end

@implementation ABI22_0_0EXSecureStore
...
{
  NSInteger accessibility = [ABI22_0_0RCTConvert NSInteger:options[@"keychainAccessible"]];
  switch (accessibility) {
    case ABI22_0_0EXSecureStoreAccessibleAfterFirstUnlock:
      return kSecAttrAccessibleAfterFirstUnlock;
    case ABI22_0_0EXSecureStoreAccessibleAfterFirstUnlockThisDeviceOnly:
      return kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly;
    case ABI22_0_0EXSecureStoreAccessibleAlways:
      return kSecAttrAccessibleAlways;
    case ABI22_0_0EXSecureStoreAccessibleWhenPasscodeSetThisDeviceOnly:
      return kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly;
    case ABI22_0_0EXSecureStoreAccessibleWhenUnlocked:
      return kSecAttrAccessibleWhenUnlocked;
    case ABI22_0_0EXSecureStoreAccessibleAlwaysThisDeviceOnly:
      return kSecAttrAccessibleAlwaysThisDeviceOnly;
    case ABI22_0_0EXSecureStoreAccessibleWhenUnlockedThisDeviceOnly:
      return kSecAttrAccessibleAlwaysThisDeviceOnly;
    default:
      return kSecAttrAccessibleWhenUnlocked;
  }
...
ABI22_0_0EX_EXPORT_SCOPED_MODULE(ExponentSecureStore, nil);

ABI22_0_0RCT_EXPORT_METHOD(setValueWithKeyAsync:(NSString *)value
                  key:(NSString *)key
                  ...
                  rejecter:(ABI22_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (!scopedKey) {
    reject(@"E_SECURESTORE_SETVALUEFAIL", nil, ABI22_0_0RCTErrorWithMessage(@"Invalid key."));
  } else {
    NSError *error;
    ...
    if (setValue) {
      ...
      reject(@"E_SECURESTORE_SETVALUEFAIL", nil, ABI22_0_0RCTErrorWithMessage([[self class] _messageForError:error]));
    }
  }
}

ABI22_0_0RCT_EXPORT_METHOD(getValueWithKeyAsync:(NSString *)key
                  options:(NSDictionary *)options
                  resolver:(ABI22_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI22_0_0RCTPromiseRejectBlock)reject)
{
  NSString *scopedKey = [self _scopedKey:key];
  if (!scopedKey) {
    reject(@"E_SECURESTORE_GETVALUEFAIL", nil, ABI22_0_0RCTErrorWithMessage(@"Invalid key."));
  } else {
    NSError *error;
    ...
    if (error) {
      if (error.code == errSecItemNotFound) {
        ...
        reject(@"E_SECURESTORE_GETVALUEFAIL", nil, ABI22_0_0RCTErrorWithMessage([[self class] _messageForError:error]));
      }
    } else {
      resolve(value);
    }
...
ABI22_0_0RCT_EXPORT_METHOD(deleteValueWithKeyAsync:(NSString *)key
                  options:(NSDictionary *)options
                  resolver:(ABI22_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI22_0_0RCTPromiseRejectBlock)reject)
{
  NSString *scopedKey = [self _scopedKey:key];
  if (!scopedKey) {
    reject(@"E_SECURESTORE_DELETEVALUEFAIL", nil, ABI22_0_0RCTErrorWithMessage(@"Invalid key."));
  } else {
