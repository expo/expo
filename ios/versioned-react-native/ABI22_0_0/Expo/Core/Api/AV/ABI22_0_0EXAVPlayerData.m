...
NSString *const ABI22_0_0EXAVPlayerDataStatusIsLoadedKeyPath = @"isLoaded";
NSString *const ABI22_0_0EXAVPlayerDataStatusURIKeyPath = @"uri";
NSString *const ABI22_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath = @"progressUpdateIntervalMillis";
NSString *const ABI22_0_0EXAVPlayerDataStatusDurationMillisKeyPath = @"durationMillis";
NSString *const ABI22_0_0EXAVPlayerDataStatusPositionMillisKeyPath = @"positionMillis";
NSString *const ABI22_0_0EXAVPlayerDataStatusPlayableDurationMillisKeyPath = @"playableDurationMillis";
NSString *const ABI22_0_0EXAVPlayerDataStatusShouldPlayKeyPath = @"shouldPlay";
NSString *const ABI22_0_0EXAVPlayerDataStatusIsPlayingKeyPath = @"isPlaying";
NSString *const ABI22_0_0EXAVPlayerDataStatusIsBufferingKeyPath = @"isBuffering";
NSString *const ABI22_0_0EXAVPlayerDataStatusRateKeyPath = @"rate";
NSString *const ABI22_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath = @"shouldCorrectPitch";
NSString *const ABI22_0_0EXAVPlayerDataStatusVolumeKeyPath = @"volume";
NSString *const ABI22_0_0EXAVPlayerDataStatusIsMutedKeyPath = @"isMuted";
NSString *const ABI22_0_0EXAVPlayerDataStatusIsLoopingKeyPath = @"isLooping";
NSString *const ABI22_0_0EXAVPlayerDataStatusDidJustFinishKeyPath = @"didJustFinish";

NSString *const ABI22_0_0EXAVPlayerDataObserverStatusKeyPath = @"status";
NSString *const ABI22_0_0EXAVPlayerDataObserverRateKeyPath = @"rate";
NSString *const ABI22_0_0EXAVPlayerDataObserverTimeControlStatusPath = @"timeControlStatus";
NSString *const ABI22_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath = @"playbackBufferEmpty";

@interface ABI22_0_0EXAVPlayerData ()

@property (nonatomic, weak) ABI22_0_0EXAV *exAV;
...
@implementation ABI22_0_0EXAVPlayerData

#pragma mark - Static methods

+ (NSDictionary *)getUnloadedStatus
{
  return @{ABI22_0_0EXAVPlayerDataStatusIsLoadedKeyPath: @(NO)};
}
...
- (void)_loadNewPlayer
{
  ...
  [avAsset loadValuesAsynchronouslyForKeys:@[ @"duration" ] completionHandler:^{
    ...
    if (weakSelf.player) {
      [weakSelf.player addObserver:weakSelf forKeyPath:ABI22_0_0EXAVPlayerDataObserverStatusKeyPath options:0 context:nil];
      [playerItem addObserver:weakSelf forKeyPath:ABI22_0_0EXAVPlayerDataObserverStatusKeyPath options:0 context:nil];
    } else {
         ...
         rejecter:(ABI22_0_0RCTPromiseRejectBlock)reject
{
  ...
  if ([parameters objectForKey:ABI22_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath] != nil) {
    NSNumber *progressUpdateIntervalMillis = parameters[ABI22_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath];
  ...
  if ([parameters objectForKey:ABI22_0_0EXAVPlayerDataStatusPositionMillisKeyPath] != nil) {
    NSNumber *currentPositionMillis = parameters[ABI22_0_0EXAVPlayerDataStatusPositionMillisKeyPath];
  ...
  if ([parameters objectForKey:ABI22_0_0EXAVPlayerDataStatusShouldPlayKeyPath] != nil) {
    NSNumber *shouldPlay = parameters[ABI22_0_0EXAVPlayerDataStatusShouldPlayKeyPath];
    _shouldPlay = shouldPlay.boolValue;
  }
  
  if ([parameters objectForKey:ABI22_0_0EXAVPlayerDataStatusRateKeyPath] != nil) {
    NSNumber *rate = parameters[ABI22_0_0EXAVPlayerDataStatusRateKeyPath];
    _rate = rate;
  }
  if ([parameters objectForKey:ABI22_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath] != nil) {
    NSNumber *shouldCorrectPitch = parameters[ABI22_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath];
    _shouldCorrectPitch = shouldCorrectPitch.boolValue;
  }
  if ([parameters objectForKey:ABI22_0_0EXAVPlayerDataStatusVolumeKeyPath] != nil) {
    NSNumber *volume = parameters[ABI22_0_0EXAVPlayerDataStatusVolumeKeyPath];
    _volume = volume;
  }
  if ([parameters objectForKey:ABI22_0_0EXAVPlayerDataStatusIsMutedKeyPath] != nil) {
    NSNumber *isMuted = parameters[ABI22_0_0EXAVPlayerDataStatusIsMutedKeyPath];
    _isMuted = isMuted.boolValue;
  }
  if ([parameters objectForKey:ABI22_0_0EXAVPlayerDataStatusIsLoopingKeyPath] != nil) {
    NSNumber *isLooping = parameters[ABI22_0_0EXAVPlayerDataStatusIsLoopingKeyPath];
  ...
  if (_player && _isLoaded) {
    ...
    void (^applyPostSeekParameters)(BOOL) = ^(BOOL seekSucceeded) {
      ...
      if (audioSessionError) {
        ...
        if (reject) {
          reject(@"E_AV_SEEKING", nil, ABI22_0_0RCTErrorWithMessage(@"Seeking interrupted."));
        }
      } else if (resolve) {
...
- (NSDictionary *)getStatus
{
  if (!_isLoaded || _player == nil) {
    return [ABI22_0_0EXAVPlayerData getUnloadedStatus];
  }
  ...
  // TODO : ReactABI22_0_0-native-video includes the iOS-only keys seekableDuration and canReverse (etc) flags.
  //        Consider adding these.
  NSMutableDictionary *mutableStatus = [@{ABI22_0_0EXAVPlayerDataStatusIsLoadedKeyPath: @(YES),
                                          
                                          ABI22_0_0EXAVPlayerDataStatusURIKeyPath: [_url absoluteString],
                                          
                                          ABI22_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath: _progressUpdateIntervalMillis,
                                          ABI22_0_0EXAVPlayerDataStatusPositionMillisKeyPath: positionMillis,
                                          // playableDurationMillis, and durationMillis may be nil and are added after this definition.
                                          
                                          ABI22_0_0EXAVPlayerDataStatusShouldPlayKeyPath: @(_shouldPlay),
                                          ABI22_0_0EXAVPlayerDataStatusIsPlayingKeyPath: @(isPlaying),
                                          ABI22_0_0EXAVPlayerDataStatusIsBufferingKeyPath: @(isBuffering),
                                          
                                          ABI22_0_0EXAVPlayerDataStatusRateKeyPath: _rate,
                                          ABI22_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath: @(_shouldCorrectPitch),
                                          ABI22_0_0EXAVPlayerDataStatusVolumeKeyPath: @(_player.volume),
                                          ABI22_0_0EXAVPlayerDataStatusIsMutedKeyPath: @(_player.muted),
                                          ABI22_0_0EXAVPlayerDataStatusIsLoopingKeyPath: @(_isLooping),
                                          
                                          ABI22_0_0EXAVPlayerDataStatusDidJustFinishKeyPath: @(NO),
                                          } mutableCopy];
  
  mutableStatus[ABI22_0_0EXAVPlayerDataStatusPlayableDurationMillisKeyPath] = playableDurationMillis;
  mutableStatus[ABI22_0_0EXAVPlayerDataStatusDurationMillisKeyPath] = durationMillis;
...
- (void)_removeObservers
{
  ...
  [self _tryRemoveObserver:_player forKeyPath:ABI22_0_0EXAVPlayerDataObserverStatusKeyPath];
  [self _tryRemoveObserver:_player.currentItem forKeyPath:ABI22_0_0EXAVPlayerDataObserverStatusKeyPath];
  ...
  [self _tryRemoveObserver:_player forKeyPath:ABI22_0_0EXAVPlayerDataObserverRateKeyPath];
  [self _tryRemoveObserver:_player forKeyPath:ABI22_0_0EXAVPlayerDataObserverTimeControlStatusPath];
  [self _tryRemoveObserver:_player.currentItem forKeyPath:ABI22_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath];
}
...
- (void)_updateTimeObserver
{
  ...
  void (^timeObserverBlock)(CMTime time) = ^(CMTime time) {
    ...
    __strong ABI22_0_0EXAV *strongEXAV = strongSelfOuter ? strongSelfOuter.exAV : nil;
...
- (void)_addObserversForNewPlayer
{
  ...
  void (^didPlayToEndTimeObserverBlock)(NSNotification *note) = ^(NSNotification *note) {
    ...
    if (strongSelf) {
      [strongSelf _callStatusUpdateCallbackWithExtraFields:@{ABI22_0_0EXAVPlayerDataStatusDidJustFinishKeyPath: @(YES)}];
  ...
  [_player addObserver:self forKeyPath:ABI22_0_0EXAVPlayerDataObserverRateKeyPath options:0 context:nil];
  [_player addObserver:self forKeyPath:ABI22_0_0EXAVPlayerDataObserverTimeControlStatusPath options:0 context:nil]; // Only available after iOS 10
  [_player.currentItem addObserver:self forKeyPath:ABI22_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath options:0 context:nil];
}
                       ...
                       context:(void *)context
{
  ...
  __strong ABI22_0_0EXAV *strongEXAV = _exAV;
  if (strongEXAV == nil) {
    return;
  }
  ...
  dispatch_async(strongEXAV.methodQueue, ^{
    if (object == _player) {
      if ([keyPath isEqualToString:ABI22_0_0EXAVPlayerDataObserverStatusKeyPath]) {
      ...
      } else if ([keyPath isEqualToString:ABI22_0_0EXAVPlayerDataObserverRateKeyPath]) {
        if (_player.rate != 0) {
          _rate = @(_player.rate);
        }
        [self _callStatusUpdateCallback];
      } else if ([keyPath isEqualToString:ABI22_0_0EXAVPlayerDataObserverTimeControlStatusPath]
                 || [keyPath isEqualToString:ABI22_0_0EXAVPlayerDataObserverStatusKeyPath]) {
        [self _callStatusUpdateCallback];
      }
      ...
      } else if ([keyPath isEqualToString:ABI22_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath]
                 || [keyPath isEqualToString:ABI22_0_0EXAVPlayerDataObserverStatusKeyPath]) {
        [self _callStatusUpdateCallback];
      }
    }
...
#pragma mark - ABI22_0_0EXAVObject
...
- (ABI22_0_0EXAVAudioSessionMode)getAudioSessionModeRequired
{
  if (_player && ([self _isPlayerPlaying] || [self _shouldPlayerPlay])) {
    return _isMuted ? ABI22_0_0EXAVAudioSessionModeActiveMuted : ABI22_0_0EXAVAudioSessionModeActive;
  }
  return ABI22_0_0EXAVAudioSessionModeInactive;
}
...
{
  // ABI22_0_0EXAudio already forced pause.
}
