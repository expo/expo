...
ABI22_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentAV, @"AudioSessionManager", @"PermissionsManager");
...
ABI22_0_0RCT_EXPORT_METHOD(prepareAudioRecorder:(nonnull NSDictionary *)options
                              ...
                              rejecter:(ABI22_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI22_0_0EXPermissions statusForPermissions:[ABI22_0_0EXAudioRecordingPermissionRequester permissions]] != ABI22_0_0EXPermissionStatusGranted ||
