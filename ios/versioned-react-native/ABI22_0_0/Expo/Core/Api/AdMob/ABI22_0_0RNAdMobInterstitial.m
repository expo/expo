#import "ABI22_0_0RNAdMobInterstitial.h"

@implementation ABI22_0_0RNAdMobInterstitial {
  GADInterstitial  *_interstitial;
  NSString *_adUnitID;
  NSString *_testDeviceID;
  ABI22_0_0RCTResponseSenderBlock _requestAdCallback;
  ABI22_0_0RCTResponseSenderBlock _showAdCallback;
}
...
ABI22_0_0RCT_EXPORT_METHOD(setAdUnitID:(NSString *)adUnitID)
{
  _adUnitID = adUnitID;
}

ABI22_0_0RCT_EXPORT_METHOD(setTestDeviceID:(NSString *)testDeviceID)
{
  _testDeviceID = testDeviceID;
}

ABI22_0_0RCT_EXPORT_METHOD(requestAd:(ABI22_0_0RCTResponseSenderBlock)callback)
{
  if ([_interstitial hasBeenUsed] || _interstitial == nil) {
    ...
    callback(@[@"Ad is already loaded."]); // TODO: make proper error via ABI22_0_0RCTUtils.h
  }
}

ABI22_0_0RCT_EXPORT_METHOD(showAd:(ABI22_0_0RCTResponseSenderBlock)callback)
{
  if ([_interstitial isReady]) {
    ...
    callback(@[@"Ad is not ready."]); // TODO: make proper error via ABI22_0_0RCTUtils.h
  }
}

ABI22_0_0RCT_EXPORT_METHOD(isReady:(ABI22_0_0RCTResponseSenderBlock)callback)
{
