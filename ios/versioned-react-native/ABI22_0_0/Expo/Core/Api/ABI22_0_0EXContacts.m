...
@implementation ABI22_0_0EXContacts

ABI22_0_0EX_EXPORT_SCOPED_MODULE(ExponentContacts, PermissionsManager);
 ...
 */
ABI22_0_0RCT_EXPORT_METHOD(getContactsAsync:(NSDictionary *)options resolver:(ABI22_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI22_0_0RCTPromiseRejectBlock)reject)
{
  if (!_contactStore) {
    _contactStore = [[CNContactStore alloc] init];
  }

  if ([ABI22_0_0EXPermissions statusForPermissions:[ABI22_0_0EXContactsRequester permissions]] != ABI22_0_0EXPermissionStatusGranted ||
