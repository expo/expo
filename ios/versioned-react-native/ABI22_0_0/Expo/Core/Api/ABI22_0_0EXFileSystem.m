...
#import "ABI22_0_0EXDownloadDelegate.h"
...
NSString * const ABI22_0_0EXDownloadProgressEventName = @"Exponent.downloadProgress";

@interface ABI22_0_0EXDownloadResumable : NSObject
  
@property (nonatomic, strong) NSString *uuid;
@property (nonatomic, strong) NSURLSession *session;
@property (nonatomic, strong) ABI22_0_0EXDownloadDelegate *delegate;
  
@end

@implementation ABI22_0_0EXDownloadResumable
  
- (instancetype)initWithId:(NSString *)uuid
               withSession:(NSURLSession *)session
              withDelegate:(ABI22_0_0EXDownloadDelegate *)delegate;
  {
    if ((self = [super init])) {
      _uuid = uuid;
      _session = session;
...
@interface ABI22_0_0EXFileSystem ()

@property (nonatomic, strong) NSMutableDictionary<NSString *, ABI22_0_0EXDownloadResumable*> *downloadObjects;

@end

ABI22_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI22_0_0EXFileSystem, fileSystem)

@implementation NSData (ABI22_0_0EXFileSystem)
...
@implementation ABI22_0_0EXFileSystem

ABI22_0_0EX_EXPORT_SCOPED_MODULE(ExponentFileSystem, nil);
...
- (instancetype)initWithExperienceId:(NSString *)experienceId kernelServiceDelegate:(id)kernelServiceInstance params:(NSDictionary *)params
{
  if (self = [super initWithExperienceId:experienceId kernelServiceDelegate:kernelServiceInstance params:params]) {
    ...
    [ABI22_0_0EXFileSystem ensureDirExistsWithPath:_documentDirectory];
    [ABI22_0_0EXFileSystem ensureDirExistsWithPath:_cachesDirectory];
  }
  return self;
}
...
{
  return @[ABI22_0_0EXDownloadProgressEventName];
}

ABI22_0_0RCT_REMAP_METHOD(getInfoAsync,
...
ABI22_0_0RCT_REMAP_METHOD(readAsStringAsync,
...
ABI22_0_0RCT_REMAP_METHOD(writeAsStringAsync,
...
ABI22_0_0RCT_REMAP_METHOD(deleteAsync,
...
ABI22_0_0RCT_REMAP_METHOD(moveAsync,
...
ABI22_0_0RCT_REMAP_METHOD(copyAsync,
...
ABI22_0_0RCT_REMAP_METHOD(makeDirectoryAsync,
...
ABI22_0_0RCT_REMAP_METHOD(readDirectoryAsync,
...
ABI22_0_0RCT_REMAP_METHOD(downloadAsync,
...
ABI22_0_0RCT_REMAP_METHOD(downloadResumableStartAsync,
                 ...
                 rejecter:(ABI22_0_0RCTPromiseRejectBlock)reject)
{
  ...
  NSData *resumeData = data ? [ABI22_0_0RCTConvert NSData:data]:nil;
...
ABI22_0_0RCT_REMAP_METHOD(downloadResumablePauseAsync,
                 downloadResumablePauseAsyncWithUUID:(NSString *)uuid
                 resolver:(ABI22_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI22_0_0RCTPromiseRejectBlock)reject)
{
  ABI22_0_0EXDownloadResumable *downloadResumable = (ABI22_0_0EXDownloadResumable *)self.downloadObjects[uuid];
...
- (void)_downloadResumableCreateSessionWithUrl:(NSURL *)url withScopedPath:(NSString *)scopedPath withUUID:(NSString *)uuid withOptions:(NSDictionary *)options withResumeData:(NSData * _Nullable)resumeData withResolver:(ABI22_0_0RCTPromiseResolveBlock)resolve withRejecter:(ABI22_0_0RCTPromiseRejectBlock)reject
{
  NSURLSessionConfiguration *sessionConfiguration = [NSURLSessionConfiguration defaultSessionConfiguration];
  sessionConfiguration.requestCachePolicy = NSURLRequestReloadIgnoringLocalCacheData;
  sessionConfiguration.URLCache = nil;
  ...
  ABI22_0_0EXDownloadDelegate *downloadDelegate = [[ABI22_0_0EXDownloadDelegate alloc] initWithId:uuid
                                                                        onWrite:^(NSURLSessionDownloadTask *task, int64_t bytesWritten, int64_t totalBytesWritten, int64_t totalBytesExpectedToWrite) {
    if(bytesWritten > 0)
      [weakSelf sendEventWithName:ABI22_0_0EXDownloadProgressEventName
                             body:@{@"uuid":uuid,
                                    @"data":@{
    ...
    if (!data) {
      reject(@"E_UNABLE_TO_SAVE",
             nil,
             ABI22_0_0RCTErrorWithMessage(@"Unable to save file to local URI"));
      return;
    }
    NSMutableDictionary *result = [NSMutableDictionary dictionary];
  ...
  ABI22_0_0EXDownloadResumable *downloadResumable = [[ABI22_0_0EXDownloadResumable alloc] initWithId:uuid
                                                                       withSession:session
...
{
  NSString *subdir = [ABI22_0_0EXUtil escapedResourceName:experienceId];
