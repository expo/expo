...
ABI22_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI22_0_0EXConstants, constants)

@import UIKit.UIApplication;

@interface ABI22_0_0EXConstants ()
...
@implementation ABI22_0_0EXConstants

ABI22_0_0EX_EXPORT_SCOPED_MODULE(ExponentConstants, nil)
...
ABI22_0_0RCT_REMAP_METHOD(getWebViewUserAgentAsync,
                 getWebViewUserAgentWithResolver:(ABI22_0_0RCTPromiseResolveBlock)resolve
