...
@implementation ABI22_0_0RNSVGRadialGradient
...
- (void)parseReference
{
    ...
    ABI22_0_0RNSVGPainter *painter = [[ABI22_0_0RNSVGPainter alloc] initWithPointsArray:points];
    ...
    ABI22_0_0RNSVGSvgView *svg = [self getSvgView];
