...
@implementation ABI22_0_0RNSVGText
{
    ABI22_0_0RNSVGText *_textRoot;
    ABI22_0_0RNSVGGlyphContext *_glyphContext;
}

- (void)setTextAnchor:(ABI22_0_0RNSVGTextAnchor)textAnchor
{
    [self invalidate];
...
{
    _glyphContext = [[ABI22_0_0RNSVGGlyphContext alloc] initWithDimensions:[self getContextWidth]
                                                  height:[self getContextHeight]];
}

// release the cached CGPathRef for ABI22_0_0RNSVGTSpan
- (void)releaseCachedPath
{
    [self traverseSubviews:^BOOL(__kindof ABI22_0_0RNSVGNode *node) {
        ABI22_0_0RNSVGText *text = node;
...
- (ABI22_0_0RNSVGTextAnchor)getComputedTextAnchor
{
    ABI22_0_0RNSVGTextAnchor anchor = self.textAnchor;
    if (self.subviews.count > 0) {
        ABI22_0_0RNSVGText *child = [self.subviews firstObject];
...
- (ABI22_0_0RNSVGText *)getTextRoot
{
    if (!_textRoot) {
        _textRoot = self;
        while (_textRoot && [_textRoot class] != [ABI22_0_0RNSVGText class]) {
            if (![_textRoot isKindOfClass:[ABI22_0_0RNSVGText class]]) {
                //todo: throw exception here
                break;
            }
            _textRoot = (ABI22_0_0RNSVGText*)[_textRoot superview];
        }
    }
