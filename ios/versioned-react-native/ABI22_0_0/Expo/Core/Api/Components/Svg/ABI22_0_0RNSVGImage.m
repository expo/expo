...
@implementation ABI22_0_0RNSVGImage
{
    CGImageRef _image;
    CGFloat _imageRatio;
}
...
- (void)setSrc:(id)src
{
    ...
    ABI22_0_0RCTImageSource *source = [ABI22_0_0RCTConvert ABI22_0_0RCTImageSource:src];
    ...
    _image = CGImageRetain([ABI22_0_0RCTConvert CGImage:src]);
    [self invalidate];
}
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    CGAffineTransform transform = [ABI22_0_0RNSVGViewBox getTransform:vbRect eRect:eRect align:self.align meetOrSlice:self.meetOrSlice fromSymbol:NO];
