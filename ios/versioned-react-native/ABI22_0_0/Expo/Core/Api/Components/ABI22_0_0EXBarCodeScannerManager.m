...
@implementation ABI22_0_0EXBarCodeScannerManager

ABI22_0_0RCT_EXPORT_MODULE(ExponentBarCodeScannerManager);
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(onBarCodeRead, ABI22_0_0RCTDirectEventBlock);
...
- (UIView *)view
{
  ...
  if (!self.camera) {
    self.camera = [[ABI22_0_0EXBarCodeScanner alloc] initWithManager:self bridge:self.bridge];
  }
  return self.camera;
}
...
- (NSDictionary *)constantsToExport
{
  return @{
    ...
    @"Type" :
        @{@"front" : @(ABI22_0_0EXBarCodeScannerTypeFront), @"back" : @(ABI22_0_0EXBarCodeScannerTypeBack)},
    @"TorchMode" : @{
      @"off" : @(ABI22_0_0EXBarCodeScannerTorchModeOff),
      @"on" : @(ABI22_0_0EXBarCodeScannerTorchModeOn),
      @"auto" : @(ABI22_0_0EXBarCodeScannerTorchModeAuto)
    }
  };
}
...
ABI22_0_0RCT_CUSTOM_VIEW_PROPERTY(type, NSInteger, ABI22_0_0EXBarCodeScanner)
{
...
ABI22_0_0RCT_CUSTOM_VIEW_PROPERTY(torchMode, NSInteger, ABI22_0_0EXBarCodeScanner)
{
  self.torchMode = [ABI22_0_0RCTConvert NSInteger:json];
  [self setTorchMode];
}
...
ABI22_0_0RCT_CUSTOM_VIEW_PROPERTY(barCodeTypes, NSArray, ABI22_0_0EXBarCodeScanner)
{
  NSArray *types = [ABI22_0_0RCTConvert NSArray:json];
  NSSet *validTypes = [NSSet setWithArray:[[self class] validBarCodeTypes].allValues];
  for (id type in types) {
    if (![validTypes containsObject:type]) {
      ABI22_0_0RCTLogWarn(@"Unsupported BarCodeType: %@", type);
      return;
    }
  }
...
- (void)startSession
{
  ...
  dispatch_async(self.sessionQueue, ^{
    ...
    __weak ABI22_0_0EXBarCodeScannerManager *weakSelf = self;
              ...
              [NSNotificationCenter.defaultCenter
                  addObserverForName:AVCaptureSessionRuntimeErrorNotification
                          ...
                          usingBlock:^(NSNotification *note) {
                            ABI22_0_0EXBarCodeScannerManager *strongSelf = weakSelf;
