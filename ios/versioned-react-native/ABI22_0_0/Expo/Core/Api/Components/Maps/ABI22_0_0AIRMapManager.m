...
#import "ABI22_0_0AIRMapManager.h"
...
#import "ABI22_0_0AIRMap.h"
#import "ABI22_0_0AIRMapMarker.h"
#import "ABI22_0_0AIRMapPolyline.h"
#import "ABI22_0_0AIRMapPolygon.h"
#import "ABI22_0_0AIRMapCircle.h"
#import "ABI22_0_0SMCalloutView.h"
#import "ABI22_0_0AIRMapUrlTile.h"
#import "ABI22_0_0AIRMapSnapshot.h"
#import "ABI22_0_0RCTConvert+AirMap.h"

#import <MapKit/MapKit.h>

static NSString *const ABI22_0_0RCTMapViewKey = @"MapView";


@interface ABI22_0_0AIRMapManager() <MKMapViewDelegate>

@end

@implementation ABI22_0_0AIRMapManager

ABI22_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI22_0_0AIRMap *map = [ABI22_0_0AIRMap new];
    map.delegate = self;
...
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(showsUserLocation, BOOL)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(userLocationAnnotationTitle, NSString)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(showsPointsOfInterest, BOOL)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(showsTraffic, BOOL)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(zoomEnabled, BOOL)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(rotateEnabled, BOOL)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(scrollEnabled, BOOL)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(pitchEnabled, BOOL)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(cacheEnabled, BOOL)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(maxDelta, CGFloat)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(minDelta, CGFloat)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(legalLabelInsets, UIEdgeInsets)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, MKMapType)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(onMapReady, ABI22_0_0RCTBubblingEventBlock)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(onChange, ABI22_0_0RCTBubblingEventBlock)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(onPanDrag, ABI22_0_0RCTBubblingEventBlock)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(onPress, ABI22_0_0RCTBubblingEventBlock)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(onLongPress, ABI22_0_0RCTBubblingEventBlock)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerPress, ABI22_0_0RCTDirectEventBlock)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI22_0_0RCTDirectEventBlock)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI22_0_0RCTDirectEventBlock)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI22_0_0RCTDirectEventBlock)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI22_0_0RCTDirectEventBlock)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI22_0_0RCTDirectEventBlock)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(onCalloutPress, ABI22_0_0RCTDirectEventBlock)
ABI22_0_0RCT_CUSTOM_VIEW_PROPERTY(initialRegion, MKCoordinateRegion, ABI22_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setInitialRegion:[ABI22_0_0RCTConvert MKCoordinateRegion:json]];
    view.ignoreRegionChanges = originalIgnore;
}

ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(minZoomLevel, CGFloat)
ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(maxZoomLevel, CGFloat)


ABI22_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI22_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setRegion:[ABI22_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}
...
ABI22_0_0RCT_EXPORT_METHOD(animateToRegion:(nonnull NSNumber *)ReactABI22_0_0Tag
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI22_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI22_0_0AIRMap class]]) {
            ABI22_0_0RCTLogError(@"Invalid view returned from registry, expecting ABI22_0_0AIRMap, got: %@", view);
        } else {
            [ABI22_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI22_0_0AIRMap *)view setRegion:region animated:YES];
            }];
        }
    }];
}

ABI22_0_0RCT_EXPORT_METHOD(animateToCoordinate:(nonnull NSNumber *)ReactABI22_0_0Tag
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI22_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI22_0_0AIRMap class]]) {
            ...
            ABI22_0_0AIRMap *mapView = (ABI22_0_0AIRMap *)view;
...
ABI22_0_0RCT_EXPORT_METHOD(animateToViewingAngle:(nonnull NSNumber *)ReactABI22_0_0Tag
...
ABI22_0_0RCT_EXPORT_METHOD(animateToBearing:(nonnull NSNumber *)ReactABI22_0_0Tag
...
ABI22_0_0RCT_EXPORT_METHOD(fitToElements:(nonnull NSNumber *)ReactABI22_0_0Tag
...
ABI22_0_0RCT_EXPORT_METHOD(fitToSuppliedMarkers:(nonnull NSNumber *)ReactABI22_0_0Tag
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI22_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI22_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ABI22_0_0AIRMapMarker *marker = (ABI22_0_0AIRMapMarker *)evaluatedObject;
                return [marker isKindOfClass:[ABI22_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
...
ABI22_0_0RCT_EXPORT_METHOD(fitToCoordinates:(nonnull NSNumber *)ReactABI22_0_0Tag
                  coordinates:(nonnull NSArray<ABI22_0_0AIRMapCoordinate *> *)coordinates
                  ...
                  animated:(BOOL)animated)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI22_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI22_0_0AIRMap class]]) {
            ...
            // Set Map viewport
            CGFloat top = [ABI22_0_0RCTConvert CGFloat:edgePadding[@"top"]];
            CGFloat right = [ABI22_0_0RCTConvert CGFloat:edgePadding[@"right"]];
            CGFloat bottom = [ABI22_0_0RCTConvert CGFloat:edgePadding[@"bottom"]];
            CGFloat left = [ABI22_0_0RCTConvert CGFloat:edgePadding[@"left"]];
...
ABI22_0_0RCT_EXPORT_METHOD(takeSnapshot:(nonnull NSNumber *)ReactABI22_0_0Tag
...
- (void)takeMapSnapshot:(ABI22_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI22_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI22_0_0AIRMap *map = (ABI22_0_0AIRMap *)recognizer.view;
    ...
    ABI22_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI22_0_0AIRMapPolygon class]]){
            ABI22_0_0AIRMapPolygon *polygon = (ABI22_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI22_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI22_0_0AIRMapPolyline class]]){
            ABI22_0_0AIRMapPolyline *polyline = (ABI22_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI22_0_0AIRMapPolyline class]]) {
        return ((ABI22_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI22_0_0AIRMapPolygon class]]) {
        return ((ABI22_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI22_0_0AIRMapCircle class]]) {
        return ((ABI22_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI22_0_0AIRMapUrlTile class]]) {
        return ((ABI22_0_0AIRMapUrlTile *)overlay).renderer;
...
- (void)mapView:(ABI22_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI22_0_0AIRMapMarker class]]) {
        [(ABI22_0_0AIRMapMarker *)view.annotation showCalloutView];
...
- (void)mapView:(ABI22_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI22_0_0AIRMapMarker class]]) {
        [(ABI22_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI22_0_0AIRMap *)mapView viewForAnnotation:(ABI22_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI22_0_0AIRMapMarker class]]) {
...
- (void)mapView:(ABI22_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI22_0_0AIRMapMarker class]]) return;
    ABI22_0_0AIRMapMarker *marker = (ABI22_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI22_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI22_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI22_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI22_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI22_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    [self _regionChanged:mapView];

    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI22_0_0AIRMapRegionChangeObserveInterval
                                                               target:self
                                                             selector:@selector(_onTick:)
                                                             userInfo:@{ ABI22_0_0RCTMapViewKey: mapView }
                                                              repeats:YES];

    [[NSRunLoop mainRunLoop] addTimer:mapView.regionChangeObserveTimer forMode:NSRunLoopCommonModes];
}

- (void)mapView:(ABI22_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI22_0_0AIRMap *)mapView
{
...
- (void)mapViewDidFinishRenderingMap:(ABI22_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
{
    [self _regionChanged:timer.userInfo[ABI22_0_0RCTMapViewKey]];
}

- (void)_regionChanged:(ABI22_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI22_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI22_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI22_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI22_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI22_0_0AIRMap *)mapView
{
...
- (MKCoordinateSpan)coordinateSpanWithMapView:(ABI22_0_0AIRMap *)mapView
                             centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                 andZoomLevel:(double)zoomLevel
{
    // convert center coordiate to pixel space
    double centerPixelX = [ABI22_0_0AIRMapManager longitudeToPixelSpaceX:centerCoordinate.longitude];
    double centerPixelY = [ABI22_0_0AIRMapManager latitudeToPixelSpaceY:centerCoordinate.latitude];

    // determine the scale value from the zoom level
    double zoomExponent = ABI22_0_0AIRMapMaxZoomLevel - zoomLevel;
    ...
    CLLocationDegrees minLng = [ABI22_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX];
    CLLocationDegrees maxLng = [ABI22_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX + scaledMapWidth];
    CLLocationDegrees longitudeDelta = maxLng - minLng;

    // find delta between top and bottom latitudes
    CLLocationDegrees minLat = [ABI22_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY];
    CLLocationDegrees maxLat = [ABI22_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY + scaledMapHeight];
...
- (void)setCenterCoordinate:(CLLocationCoordinate2D)centerCoordinate
                  zoomLevel:(double)zoomLevel
                   animated:(BOOL)animated
                    mapView:(ABI22_0_0AIRMap *)mapView
{
    // clamp large numbers to 28
    zoomLevel = MIN(zoomLevel, ABI22_0_0AIRMapMaxZoomLevel);
...
-(MKCoordinateRegion)coordinateRegionWithMapView:(ABI22_0_0AIRMap *)mapView
                                centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                    andZoomLevel:(double)zoomLevel
{
	...
	// find delta between top and bottom latitudes
	CLLocationDegrees minLat = [ABI22_0_0AIRMapManager pixelSpaceYToLatitude:topPixelY];
	CLLocationDegrees maxLat = [ABI22_0_0AIRMapManager pixelSpaceYToLatitude:bottomPixelY];
	CLLocationDegrees latitudeDelta = -1 * (maxLat - minLat);
	...
	if (adjustedCenterPoint) {
		region.center.latitude = [ABI22_0_0AIRMapManager pixelSpaceYToLatitude:((bottomPixelY + topPixelY) / 2.0)];
	}

	return region;
}

- (double) zoomLevel:(ABI22_0_0AIRMap *)mapView {
    MKCoordinateRegion region = mapView.region;

    double centerPixelX = [ABI22_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude];
    double topLeftPixelX = [ABI22_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude - region.span.longitudeDelta / 2];

    double scaledMapWidth = (centerPixelX - topLeftPixelX) * 2;
    CGSize mapSizeInPixels = mapView.bounds.size;
    double zoomScale = scaledMapWidth / mapSizeInPixels.width;
    double zoomExponent = log(zoomScale) / log(2);
    double zoomLevel = ABI22_0_0AIRMapMaxZoomLevel - zoomExponent;
