...
#import "ABI22_0_0AIRMapPolygonManager.h"
...
@interface ABI22_0_0AIRMapPolygonManager()

@end

@implementation ABI22_0_0AIRMapPolygonManager

ABI22_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI22_0_0AIRMapPolygon *polygon = [ABI22_0_0AIRMapPolygon new];
    return polygon;
}
