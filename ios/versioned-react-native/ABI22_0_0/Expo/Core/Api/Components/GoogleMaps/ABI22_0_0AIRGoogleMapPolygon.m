//
//  ABI22_0_0AIRGoogleMapPolygon.m
//
...
@implementation ABI22_0_0AIRGoogleMapPolygon

- (instancetype)init
{
  if (self = [super init]) {
    _polygon = [[ABI22_0_0AIRGMSPolygon alloc] init];
  }
...
- (void)setHoles:(NSArray<NSArray<ABI22_0_0AIRMapCoordinate *> *> *)holes
{
  _holes = holes;
...
- (void)setOnPress:(ABI22_0_0RCTBubblingEventBlock)onPress {
