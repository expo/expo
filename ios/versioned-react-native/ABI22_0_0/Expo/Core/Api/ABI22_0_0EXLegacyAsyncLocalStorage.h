...
// Read-only access to legacy (unscoped) `ABI22_0_0RCTAsyncLocalStorage` backing for
 ...
 */
@interface ABI22_0_0EXLegacyAsyncLocalStorage : NSObject <ABI22_0_0RCTBridgeModule,ABI22_0_0RCTInvalidating>
