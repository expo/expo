...
#import "ABI22_0_0EXGLGPUImageObject.h"

@implementation ABI22_0_0EXGLObject

+ (instancetype)createWithConfig:(NSDictionary *)config
{
  // TODO(nikki): Maintain these `config` --> `ABI22_0_0EXGLObject` implementation mapping rules in a common place
  if (config[@"texture"]) {
    if (config[@"texture"][@"camera"]) {
      return [[ABI22_0_0EXGLGPUImageObject alloc] initWithConfig:config];
    }
  }
