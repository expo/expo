...
@interface ABI22_0_0EXKernelModule ()
...
@property (nonatomic, weak) id<ABI22_0_0EXKernelModuleDelegate> delegate;


@end

@implementation ABI22_0_0EXKernelModule
...
- (void)sendEventWithName:(NSString *)eventName body:(id)body
{
  ...
  [self.bridge enqueueJSCall:@"ABI22_0_0RCTDeviceEventEmitter.emit"
...
ABI22_0_0RCT_REMAP_METHOD(doesCurrentTaskEnableDevtools,
                 doesCurrentTaskEnableDevtoolsWithResolver:(ABI22_0_0RCTPromiseResolveBlock)resolve
...
ABI22_0_0RCT_REMAP_METHOD(shouldCurrentTaskAutoReload,
                 shouldCurrentTaskAutoReloadWithResolver:(ABI22_0_0RCTPromiseResolveBlock)resolve
                 reject:(ABI22_0_0RCTPromiseRejectBlock)reject)
{
  if (_delegate) {
...
ABI22_0_0RCT_REMAP_METHOD(isLegacyMenuBehaviorEnabledAsync,
                 isLegacyMenuBehaviorEnabledWithResolver:(ABI22_0_0RCTPromiseResolveBlock)resolve
...
ABI22_0_0RCT_EXPORT_METHOD(setIsLegacyMenuBehaviorEnabledAsync:(BOOL)isEnabled)
{
  if (_delegate) {
...
ABI22_0_0RCT_REMAP_METHOD(getDevMenuItemsToShow,
                 getDevMenuItemsToShowWithResolver:(ABI22_0_0RCTPromiseResolveBlock)resolve
                 reject:(ABI22_0_0RCTPromiseRejectBlock)reject)
{
...
ABI22_0_0RCT_EXPORT_METHOD(selectDevMenuItemWithKey:(NSString *)key)
{
  if (_delegate) {
...
ABI22_0_0RCT_EXPORT_METHOD(addDevMenu)
{
...
ABI22_0_0RCT_REMAP_METHOD(routeDidForeground,
...
ABI22_0_0RCT_REMAP_METHOD(onEventSuccess,
...
ABI22_0_0RCT_REMAP_METHOD(onEventFailure,
                 eventId:(NSString *)eventId
