...
@interface ABI22_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI22_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI22_0_0RCTBackedTextInputViewProtocol> *_backedTextInput;
...
@interface ABI22_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI22_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI22_0_0RCTBackedTextInputViewProtocol> *_backedTextInput;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}
