...
static void collectNonTextDescendants(ABI22_0_0RCTText *view, NSMutableArray *nonTextDescendants)
{
  for (UIView *child in view.ReactABI22_0_0Subviews) {
    if ([child isKindOfClass:[ABI22_0_0RCTText class]]) {
      collectNonTextDescendants((ABI22_0_0RCTText *)child, nonTextDescendants);
...
@implementation ABI22_0_0RCTText
{
...
- (NSString *)description
{
  ...
  NSString *replacement = [NSString stringWithFormat:@"; ReactABI22_0_0Tag: %@; text: %@", self.ReactABI22_0_0Tag, self.textStorage.string];
...
- (void)ReactABI22_0_0SetFrame:(CGRect)frame
{
  ...
  [UIView performWithoutAnimation:^{
    [super ReactABI22_0_0SetFrame:frame];
  }];
}
...
- (void)drawRect:(CGRect)rect
{
  ...
  [layoutManager.textStorage enumerateAttribute:ABI22_0_0RCTIsHighlightedAttributeName inRange:characterRange options:0 usingBlock:^(NSNumber *value, NSRange range, BOOL *_) {
    if (!value.boolValue) {
      return;
    }
...
{
  NSNumber *ReactABI22_0_0Tag = self.ReactABI22_0_0Tag;
  ...
  if (_textStorage.length > 0 && (fraction > 0 || characterIndex > 0) && (fraction < 1 || characterIndex < _textStorage.length - 1)) {
    ReactABI22_0_0Tag = [_textStorage attribute:ABI22_0_0RCTReactABI22_0_0TagAttributeName atIndex:characterIndex effectiveRange:NULL];
  }
  return ReactABI22_0_0Tag;
}
