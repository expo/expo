...
@interface ABI22_0_0RCTTextField () <ABI22_0_0RCTBackedTextInputDelegate>

@end

@implementation ABI22_0_0RCTTextField
{
  ABI22_0_0RCTUITextField *_backedTextInput;
  BOOL _submitted;
...
- (instancetype)initWithBridge:(ABI22_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInput = [[ABI22_0_0RCTUITextField alloc] initWithFrame:self.bounds];
...
- (void)setText:(NSString *)text
{
  ...
  if (eventLag == 0 && ![text isEqualToString:self.text]) {
    ...
    ABI22_0_0RCTLogWarn(@"Native TextInput(%@) is %zd events ahead of JS - try to make your JS faster.", _backedTextInput.text, eventLag);
  }
}
...
{
  _nativeEventCount++;
  [_eventDispatcher sendTextEventWithType:ABI22_0_0RCTTextEventTypeChange
                                 ReactABI22_0_0Tag:self.ReactABI22_0_0Tag
