...
@interface ABI22_0_0RCTReconnectingWebSocket () <ABI22_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI22_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  __weak ABI22_0_0RCTSRWebSocket *socket = _socket;
