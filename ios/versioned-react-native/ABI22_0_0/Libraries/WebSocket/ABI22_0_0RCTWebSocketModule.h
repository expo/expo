...
@protocol ABI22_0_0RCTWebSocketContentHandler <NSObject>
...
@interface ABI22_0_0RCTWebSocketModule : ABI22_0_0RCTEventEmitter

// Register a custom handler for a specific websocket. The handler will be strongly held by the WebSocketModule.
- (void)setContentHandler:(id<ABI22_0_0RCTWebSocketContentHandler> __nullable)handler forSocketID:(NSNumber *)socketID;

- (void)sendData:(NSData *)data forSocketID:(nonnull NSNumber *)socketID;

@end

@interface ABI22_0_0RCTBridge (ABI22_0_0RCTWebSocketModule)
