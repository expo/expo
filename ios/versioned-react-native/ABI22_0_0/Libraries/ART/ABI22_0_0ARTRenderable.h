...
@interface ABI22_0_0ARTRenderable : ABI22_0_0ARTNode

@property (nonatomic, strong) ABI22_0_0ARTBrush *fill;
...
@property (nonatomic, assign) ABI22_0_0ARTCGFloatArray strokeDash;
