...
@implementation ABI22_0_0ARTText
...
static void ABI22_0_0ARTFreeTextFrame(ABI22_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI22_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI22_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI22_0_0ARTTextFrame frame = self.textFrame;
