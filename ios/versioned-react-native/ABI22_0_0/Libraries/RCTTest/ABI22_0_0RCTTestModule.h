...
typedef NS_ENUM(NSInteger, ABI22_0_0RCTTestStatus) {
  ABI22_0_0RCTTestStatusPending = 0,
  ABI22_0_0RCTTestStatusPassed,
  ABI22_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI22_0_0RCTTestModule : NSObject <ABI22_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI22_0_0RCTTestStatus status;
