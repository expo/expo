...
#import "ABI22_0_0RCTGIFImageDecoder.h"
...
@implementation ABI22_0_0RCTGIFImageDecoder
...
- (ABI22_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                 ...
                                 completionHandler:(ABI22_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (imageCount > 1) {
    ...
    image.ReactABI22_0_0KeyframeAnimation = animation;
