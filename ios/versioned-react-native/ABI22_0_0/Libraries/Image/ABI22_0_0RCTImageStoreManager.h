...
@interface ABI22_0_0RCTImageStoreManager : NSObject <ABI22_0_0RCTURLRequestHandler>
...
@interface ABI22_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI22_0_0RCTBridge (ABI22_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI22_0_0RCTImageStoreManager *imageStoreManager;
