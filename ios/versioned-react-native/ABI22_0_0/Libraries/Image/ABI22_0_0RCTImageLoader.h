...
typedef void (^ABI22_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI22_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI22_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI22_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI22_0_0RCTImageCache <NSObject>
...
@interface UIImage (ReactABI22_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI22_0_0KeyframeAnimation;

@end

@interface ABI22_0_0RCTImageLoader : NSObject <ABI22_0_0RCTBridgeModule, ABI22_0_0RCTURLRequestHandler>
 ...
 * decoded images as long as it conforms to the ABI22_0_0RCTImageCacheDelegate
...
@interface ABI22_0_0RCTBridge (ABI22_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI22_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI22_0_0RCTImageURLLoader <ABI22_0_0RCTBridgeModule>
...
/**
 * If more than one ABI22_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI22_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 */
@protocol ABI22_0_0RCTImageDataDecoder <ABI22_0_0RCTBridgeModule>
...
/**
 * If more than one ABI22_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
