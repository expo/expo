...
@implementation ABI22_0_0RCTInterpolationAnimatedNode
{
  __weak ABI22_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI22_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI22_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI22_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI22_0_0RCTInterpolateValueInRange(inputValue,
                                          _inputRange,
                                          _outputRange,
                                          _extrapolateLeft,
                                          _extrapolateRight);
