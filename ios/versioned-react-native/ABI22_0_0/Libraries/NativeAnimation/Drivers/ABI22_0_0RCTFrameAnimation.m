...
@interface ABI22_0_0RCTFrameAnimation ()
...
@implementation ABI22_0_0RCTFrameAnimation
{
...
{
  if ((self = [super init])) {
    NSNumber *toValue = [ABI22_0_0RCTConvert NSNumber:config[@"toValue"]] ?: @1;
    NSArray<NSNumber *> *frames = [ABI22_0_0RCTConvert NSNumberArray:config[@"frames"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  NSUInteger startIndex = floor(currentDuration / ABI22_0_0RCTSingleFrameInterval);
  ...
  NSTimeInterval fromInterval = startIndex * ABI22_0_0RCTSingleFrameInterval;
  NSTimeInterval toInterval = nextIndex * ABI22_0_0RCTSingleFrameInterval;
  ...
  CGFloat frameOutput = ABI22_0_0RCTInterpolateValue(currentDuration,
                                            fromInterval,
                                            toInterval,
                                            fromFrameValue.doubleValue,
                                            toFrameValue.doubleValue,
                                            ABI22_0_0EXTRAPOLATE_TYPE_EXTEND,
                                            ABI22_0_0EXTRAPOLATE_TYPE_EXTEND);
...
{
  CGFloat outputValue = ABI22_0_0RCTInterpolateValue(frameOutput,
                                            0,
                                            1,
                                            _fromValue,
                                            _toValue,
