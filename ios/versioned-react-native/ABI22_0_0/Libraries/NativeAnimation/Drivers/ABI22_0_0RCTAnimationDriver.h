...
static CGFloat ABI22_0_0RCTSingleFrameInterval = 1.0 / 60.0;

@class ABI22_0_0RCTValueAnimatedNode;

NS_ASSUME_NONNULL_BEGIN

@protocol ABI22_0_0RCTAnimationDriver <NSObject>

@property (nonatomic, readonly) NSNumber *animationId;
@property (nonatomic, readonly) ABI22_0_0RCTValueAnimatedNode *valueNode;
