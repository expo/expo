...
#import "ABI22_0_0RCTBlobManager.h"

#import <ReactABI22_0_0/ABI22_0_0RCTConvert.h>
#import <ReactABI22_0_0/ABI22_0_0RCTWebSocketModule.h>

static NSString *const kBlobUriScheme = @"blob";

@interface _ABI22_0_0RCTBlobContentHandler : NSObject <ABI22_0_0RCTWebSocketContentHandler>

- (instancetype)initWithBlobManager:(ABI22_0_0RCTBlobManager *)blobManager;

@end


@implementation ABI22_0_0RCTBlobManager
{
  NSMutableDictionary<NSString *, NSData *> *_blobs;
  _ABI22_0_0RCTBlobContentHandler *_contentHandler;
  NSOperationQueue *_queue;
}

ABI22_0_0RCT_EXPORT_MODULE(BlobModule)
...
{
  NSString *blobId = [ABI22_0_0RCTConvert NSString:blob[@"blobId"]];
  NSNumber *offset = [ABI22_0_0RCTConvert NSNumber:blob[@"offset"]];
  NSNumber *size = [ABI22_0_0RCTConvert NSNumber:blob[@"size"]];
...
ABI22_0_0RCT_EXPORT_METHOD(enableBlobSupport:(nonnull NSNumber *)socketID)
{
  if (!_contentHandler) {
    _contentHandler = [[_ABI22_0_0RCTBlobContentHandler alloc] initWithBlobManager:self];
  }
  [[_bridge webSocketModule] setContentHandler:_contentHandler forSocketID:socketID];
}

ABI22_0_0RCT_EXPORT_METHOD(disableBlobSupport:(nonnull NSNumber *)socketID)
{
  [[_bridge webSocketModule] setContentHandler:nil forSocketID:socketID];
}

ABI22_0_0RCT_EXPORT_METHOD(sendBlob:(NSDictionary *)blob socketID:(nonnull NSNumber *)socketID)
{
  [[_bridge webSocketModule] sendData:[self resolve:blob] forSocketID:socketID];
}

ABI22_0_0RCT_EXPORT_METHOD(createFromParts:(NSArray<NSDictionary<NSString *, id> *> *)parts withId:(NSString *)blobId)
{
...
ABI22_0_0RCT_EXPORT_METHOD(release:(NSString *)blobId)
{
  [_blobs removeObjectForKey:blobId];
}

#pragma mark - ABI22_0_0RCTURLRequestHandler methods
...
@implementation _ABI22_0_0RCTBlobContentHandler {
  __weak ABI22_0_0RCTBlobManager *_blobManager;
}
