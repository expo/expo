...
#import "ABI22_0_0RCTPhotoLibraryImageLoader.h"

#import <Photos/Photos.h>

#import <ReactABI22_0_0/ABI22_0_0RCTUtils.h>

@implementation ABI22_0_0RCTPhotoLibraryImageLoader

ABI22_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI22_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI22_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (!imageURL) {
    completionHandler(ABI22_0_0RCTErrorWithMessage(@"Cannot load a photo library asset with no URL"), nil);
    return ^{};
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI22_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI22_0_0RCTResizeModeContain) {
