...
#import "ABI22_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI22_0_0/ABI22_0_0RCTConvert.h>
#import <ReactABI22_0_0/ABI22_0_0RCTImageStoreManager.h>
#import <ReactABI22_0_0/ABI22_0_0RCTRootView.h>
#import <ReactABI22_0_0/ABI22_0_0RCTUtils.h>

@interface ABI22_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI22_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI22_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI22_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI22_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI22_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI22_0_0RCTResponseSenderBlock)callback)
{
...
ABI22_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI22_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI22_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI22_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI22_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI22_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI22_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI22_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI22_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI22_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI22_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI22_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI22_0_0RCTNullIfNil(height), ABI22_0_0RCTNullIfNil(width)]];
    return;
  }
        ...
        cancelCallback:(ABI22_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI22_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI22_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI22_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
