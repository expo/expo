...
#import "ABI22_0_0RCTLinkingManager.h"
...
static NSString *const kOpenURLNotification = @"ABI22_0_0RCTOpenURLNotification";
...
@implementation ABI22_0_0RCTLinkingManager
                  ...
                  reject:(__unused ABI22_0_0RCTPromiseRejectBlock)reject)
{
  ...
  BOOL canOpen = [ABI22_0_0RCTSharedApplication() canOpenURL:URL];
  resolve(@(canOpen));
}
                  ...
                  reject:(__unused ABI22_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve(ABI22_0_0RCTNullIfNil(initialURL.absoluteString));
}
