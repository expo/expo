...
#include "ABI22_0_0CxxNativeModule.h"
#include "ABI22_0_0Instance.h"

#include <iterator>

#include <folly/json.h>

#include "ABI22_0_0JsArgumentHelpers.h"
...
void CxxNativeModule::invoke(unsigned int ReactABI22_0_0MethodId, folly::dynamic&& params, int callId) {
  if (ReactABI22_0_0MethodId >= methods_.size()) {
    throw std::invalid_argument(folly::to<std::string>("methodId ", ReactABI22_0_0MethodId,
  ...
  const auto& method = methods_[ReactABI22_0_0MethodId];
