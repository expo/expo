...
#include "ABI22_0_0JSCExecutor.h"
...
#include "ABI22_0_0JSBundleType.h"
#include "ABI22_0_0JSCLegacyTracing.h"
#include "ABI22_0_0JSCMemory.h"
#include "ABI22_0_0JSCNativeModules.h"
#include "ABI22_0_0JSCPerfStats.h"
...
void JSCExecutor::loadApplicationScript(std::unique_ptr<const JSBigString> script, std::string sourceURL) {
  ...
  ReactABI22_0_0Marker::logTaggedMarker(ReactABI22_0_0Marker::RUN_JS_BUNDLE_START, scriptName.c_str());
  ...
  if (auto fileStr = dynamic_cast<const JSBigFileString *>(script.get())) {
    ...
    case JSLoadSourceIsCompiled:
      ...
      ReactABI22_0_0Marker::logMarker(ReactABI22_0_0Marker::CREATE_REACT_CONTEXT_STOP);
      ReactABI22_0_0Marker::logTaggedMarker(ReactABI22_0_0Marker::RUN_JS_BUNDLE_STOP, scriptName.c_str());
      return;
...
#endif
  {
    ...
    JSContextLock lock(m_context);
    {
      ...
      ReactABI22_0_0Marker::logMarker(ReactABI22_0_0Marker::JS_BUNDLE_STRING_CONVERT_START);
      jsScript = adoptString(std::move(script));
      ReactABI22_0_0Marker::logMarker(ReactABI22_0_0Marker::JS_BUNDLE_STRING_CONVERT_STOP);
    }
...
JSValueRef JSCExecutor::nativeRequire(
  ...
  ReactABI22_0_0Marker::logMarker(ReactABI22_0_0Marker::NATIVE_REQUIRE_START);
  loadModule(moduleId);
  ReactABI22_0_0Marker::logMarker(ReactABI22_0_0Marker::NATIVE_REQUIRE_STOP);
