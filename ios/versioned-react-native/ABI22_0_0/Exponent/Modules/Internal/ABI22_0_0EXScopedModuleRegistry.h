...
/**
 *  Use this in place of ABI22_0_0RCT_EXPORT_MODULE() to auto-init an instance of your scoped module on ABI22_0_0RCTBridge instances.
 *  @param js_name same as ABI22_0_0RCT_EXPORT_MODULE(), the module name available in JS
 ...
 *         e.g. MyKernelService -> an instance of ABI22_0_0EXMyKernelService
 */
#define ABI22_0_0EX_EXPORT_SCOPED_MODULE(js_name, kernel_service_class) \
ABI22_0_0RCT_EXTERN void ABI22_0_0EXRegisterScopedModule(Class, NSString *); \
+ (NSString *)moduleName { return @#js_name; } \
+ (void)load { ABI22_0_0EXRegisterScopedModule(self, @#kernel_service_class); }
