...
@implementation ABI22_0_0EXFrameExceptionsManager {
  __weak id<ABI22_0_0RCTExceptionsManagerDelegate> _delegate;
}

@synthesize bridge = _bridge;

+ (NSString *)moduleName { return @"ABI22_0_0RCTExceptionsManager"; }
...
{
  // this will hit ABI22_0_0EXDisabledRedBox when not debugging
