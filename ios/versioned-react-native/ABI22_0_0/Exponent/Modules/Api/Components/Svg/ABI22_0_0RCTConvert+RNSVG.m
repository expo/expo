...
ABI22_0_0RCT_ENUM_CONVERTER(ABI22_0_0RNSVGUnits, (@{
...
+ (ABI22_0_0RNSVGCGFloatArray)ABI22_0_0RNSVGCGFloatArray:(id)json
{
    ...
    ABI22_0_0RNSVGCGFloatArray array;
    array.count = count;
    array.array = nil;
...
+ (ABI22_0_0RNSVGBrush *)ABI22_0_0RNSVGBrush:(id)json
{
    ...
    switch (type) {
        case 0: // solid color
            ...
            return [[ABI22_0_0RNSVGSolidColorBrush alloc] initWithArray:arr];
        case 1: // brush
            return [[ABI22_0_0RNSVGPainterBrush alloc] initWithArray:arr];
        default:
            ABI22_0_0RCTLogError(@"Unknown brush type: %zd", type);
            return nil;
    }
}
...
{
    return [[ABI22_0_0RNSVGPathParser alloc] initWithPathString: d];
}
...
+ (CGRect)ABI22_0_0RNSVGCGRect:(id)json offset:(NSUInteger)offset
{
    ...
    if (arr.count < offset + 4) {
        ABI22_0_0RCTLogError(@"Too few elements in array (expected at least %zd): %@", 4 + offset, arr);
        return CGRectZero;
    }
    return (CGRect){
...
+ (CGGradientRef)ABI22_0_0RNSVGCGGradient:(id)json offset:(NSUInteger)offset
{
    NSArray *arr = [self NSArray:json];
    if (arr.count < offset) {
        ABI22_0_0RCTLogError(@"Too few elements in array (expected at least %zd): %@", offset, arr);
        return nil;
    }
    arr = [arr subarrayWithRange:(NSRange){offset, arr.count - offset}];
    ABI22_0_0RNSVGCGFloatArray colorsAndOffsets = [self ABI22_0_0RNSVGCGFloatArray:arr];
