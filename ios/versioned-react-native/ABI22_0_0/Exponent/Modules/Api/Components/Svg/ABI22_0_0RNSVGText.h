...
@interface ABI22_0_0RNSVGText : ABI22_0_0RNSVGGroup

@property (nonatomic, assign) ABI22_0_0RNSVGTextAnchor textAnchor;
...
- (ABI22_0_0RNSVGText *)getTextRoot;
- (void)releaseCachedPath;
- (CGPathRef)getGroupPath:(CGContextRef)context;

- (ABI22_0_0RNSVGGlyphContext *)getGlyphContext;
