...
@implementation ABI22_0_0RNSVGRenderable
{
...
- (void)setFill:(ABI22_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI22_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI22_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)setStrokeDasharray:(ABI22_0_0RNSVGCGFloatArray)strokeDasharray
{
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    if (self.stroke) {
        ...
        ABI22_0_0RNSVGCGFloatArray dash = self.strokeDasharray;
