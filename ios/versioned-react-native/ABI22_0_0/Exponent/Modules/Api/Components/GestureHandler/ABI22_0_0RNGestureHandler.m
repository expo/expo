...
#import <ReactABI22_0_0/ABI22_0_0RCTScrollView.h>
...
#define APPLY_PROP(recognizer, config, type, prop, propName) do { \
    ...
    if (value != nil) recognizer.prop = [ABI22_0_0RCTConvert type:value]; \
} while(0)
...
@property (nonatomic, readonly) ABI22_0_0RNGestureHandler *gestureHandler;
@end

@implementation UIGestureRecognizer (GestureHandler)

- (ABI22_0_0RNGestureHandler *)gestureHandler
{
    id delegate = self.delegate;
    if ([delegate isKindOfClass:[ABI22_0_0RNGestureHandler class]]) {
        return (ABI22_0_0RNGestureHandler *)delegate;
    }
    return nil;
}
...
@interface ABI22_0_0RNDummyGestureRecognizer : UIGestureRecognizer
@end


@implementation ABI22_0_0RNDummyGestureRecognizer
...
@interface ABI22_0_0RNGestureHandler () <UIGestureRecognizerDelegate>
...
@implementation ABI22_0_0RNGestureHandlerRegistry {
    NSMutableDictionary<NSNumber *, ABI22_0_0RNGestureHandler *> *_handlers;
}
...
- (ABI22_0_0RNGestureHandler *)handlerWithTag:(NSNumber *)handlerTag
{
    return _handlers[handlerTag];
}

- (void)registerGestureHandler:(ABI22_0_0RNGestureHandler *)gestureHandler
{
...
{
    ABI22_0_0RNGestureHandler *handler = _handlers[handlerTag];
    ABI22_0_0RCTAssert(handler != nil, @"Handler for tag %@ does not exists", handlerTag);
...
@implementation ABI22_0_0RNGestureHandler {
...
- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super init])) {
        _tag = tag;
        _lastState = ABI22_0_0RNGestureHandlerStateUndetermined;
...
{
    _handlersToWaitFor = [ABI22_0_0RCTConvert NSNumberArray:config[@"waitFor"]];
    _simultaniousHandlers = [ABI22_0_0RCTConvert NSNumberArray:config[@"simultaneousHandlers"]];

    id prop = config[@"enabled"];
    if (prop != nil) {
        self.enabled = [ABI22_0_0RCTConvert BOOL:prop];
    } else {
        self.enabled = YES;
    }
    ...
    if (prop != nil) {
        _shouldCancelWhenOutside = [ABI22_0_0RCTConvert BOOL:prop];
    } else {
    ...
    prop = config[@"hitSlop"];
    if (prop != nil) {
         UIEdgeInsets insets = [ABI22_0_0RCTConvert UIEdgeInsets:prop];
...
- (ABI22_0_0RNGestureHandlerEventExtraData *)eventExtraData:(UIGestureRecognizer *)recognizer
{
    return [ABI22_0_0RNGestureHandlerEventExtraData
...
{
    ABI22_0_0RNGestureHandlerEventExtraData *eventData = [self eventExtraData:recognizer];
    [self sendEventsInState:self.state forViewWithTag:recognizer.view.ReactABI22_0_0Tag withExtraData:eventData];
}

- (void)sendEventsInState:(ABI22_0_0RNGestureHandlerState)state
           forViewWithTag:(nonnull NSNumber *)ReactABI22_0_0Tag
            withExtraData:(ABI22_0_0RNGestureHandlerEventExtraData *)extraData
{
    id touchEvent = [[ABI22_0_0RNGestureHandlerEvent alloc] initWithRactTag:ReactABI22_0_0Tag
                                                        handlerTag:_tag
                                                             state:state
                                                         extraData:extraData];

    if (state != _lastState) {
        if (state == ABI22_0_0RNGestureHandlerStateEnd && _lastState != ABI22_0_0RNGestureHandlerStateActive) {
            [self.emitter sendStateChangeEvent:[[ABI22_0_0RNGestureHandlerStateChange alloc] initWithRactTag:ReactABI22_0_0Tag
                                                                                         handlerTag:_tag
                                                                                              state:ABI22_0_0RNGestureHandlerStateActive
                                                                                          prevState:_lastState
                                                                                          extraData:extraData]];
            _lastState = ABI22_0_0RNGestureHandlerStateActive;
        }
        id stateEvent = [[ABI22_0_0RNGestureHandlerStateChange alloc] initWithRactTag:ReactABI22_0_0Tag
                                                                  handlerTag:_tag
                                                                       state:state
                                                                   prevState:_lastState
                                                                   extraData:extraData];
    ...
    if (state == ABI22_0_0RNGestureHandlerStateActive) {
...
- (ABI22_0_0RNGestureHandlerState)state
{
    switch (_recognizer.state) {
        ...
        case UIGestureRecognizerStatePossible:
            return ABI22_0_0RNGestureHandlerStateBegan;
        case UIGestureRecognizerStateEnded:
            return ABI22_0_0RNGestureHandlerStateEnd;
        case UIGestureRecognizerStateFailed:
            return ABI22_0_0RNGestureHandlerStateFailed;
        case UIGestureRecognizerStateCancelled:
            return ABI22_0_0RNGestureHandlerStateCancelled;
        case UIGestureRecognizerStateChanged:
            return ABI22_0_0RNGestureHandlerStateActive;
    }
    return ABI22_0_0RNGestureHandlerStateUndetermined;
}

#pragma mark UIGestureRecognizerDelegate

+ (ABI22_0_0RNGestureHandler *)findGestureHandlerByRecognizer:(UIGestureRecognizer *)recognizer
{
    ABI22_0_0RNGestureHandler *handler = recognizer.gestureHandler;
    if (handler != nil) {
        return handler;
    }
    ...
    UIView *ReactABI22_0_0View = recognizer.view;
    while (ReactABI22_0_0View != nil && ReactABI22_0_0View.ReactABI22_0_0Tag == nil) {
        ReactABI22_0_0View = ReactABI22_0_0View.superview;
    }

    for (UIGestureRecognizer *recognizer in ReactABI22_0_0View.gestureRecognizers) {
        if ([recognizer isKindOfClass:[ABI22_0_0RNDummyGestureRecognizer class]]) {
...
{
    ABI22_0_0RNGestureHandler *handler = [ABI22_0_0RNGestureHandler findGestureHandlerByRecognizer:otherGestureRecognizer];
    if ([handler isKindOfClass:[ABI22_0_0RNNativeViewGestureHandler class]]) {
...
@interface ABI22_0_0RNBetterPanGestureRecognizer : UIPanGestureRecognizer
...
- (id)initWithGestureHandler:(ABI22_0_0RNGestureHandler*)gestureHandler;

@end


@implementation ABI22_0_0RNBetterPanGestureRecognizer {
    __weak ABI22_0_0RNGestureHandler *_gestureHandler;
...
@implementation ABI22_0_0RNPanGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI22_0_0RNBetterPanGestureRecognizer alloc] initWithGestureHandler:self];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    ABI22_0_0RNBetterPanGestureRecognizer *recognizer = (ABI22_0_0RNBetterPanGestureRecognizer *)_recognizer;
    ...
    if (prop != nil) {
        CGFloat dist = [ABI22_0_0RCTConvert CGFloat:prop];
        recognizer.minDistSq = dist * dist;
    }

    prop = config[@"minVelocity"];
    if (prop != nil) {
        CGFloat velocity = [ABI22_0_0RCTConvert CGFloat:prop];
        recognizer.minVelocitySq = velocity * velocity;
    }
    [recognizer updateHasCustomActivationCriteria];
}

- (ABI22_0_0RNGestureHandlerEventExtraData *)eventExtraData:(UIPanGestureRecognizer *)recognizer
{
    return [ABI22_0_0RNGestureHandlerEventExtraData
...
@interface ABI22_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
@implementation ABI22_0_0RNBetterTapGestureRecognizer {
    __weak ABI22_0_0RNGestureHandler *_gestureHandler;
...
@implementation ABI22_0_0RNTapGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI22_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
    }
    return self;
}
...
{
    [super configure:config];
    ABI22_0_0RNBetterTapGestureRecognizer *recognizer = (ABI22_0_0RNBetterTapGestureRecognizer *)_recognizer;

    APPLY_INT_PROP(numberOfTaps);

    id prop = config[@"maxDelayMs"];
    if (prop != nil) {
        recognizer.maxDelay = [ABI22_0_0RCTConvert CGFloat:prop] / 1000.0;
    }

    prop = config[@"maxDurationMs"];
    if (prop != nil) {
        recognizer.maxDuration = [ABI22_0_0RCTConvert CGFloat:prop] / 1000.0;
    }
}
...
@implementation ABI22_0_0RNLongPressGestureHandler
...
- (void)configure:(NSDictionary *)config
{
    ...
    if (prop != nil) {
        recognizer.minimumPressDuration = [ABI22_0_0RCTConvert CGFloat:prop] / 1000.0;
    }
}
...
@implementation ABI22_0_0RNNativeViewGestureHandler {
...
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI22_0_0RNDummyGestureRecognizer alloc] init];
    }
    return self;
}
...
{
    [super configure:config];
    _shouldActivateOnStart = [ABI22_0_0RCTConvert BOOL:config[@"shouldActivateOnStart"]];
    _disallowInterruption = [ABI22_0_0RCTConvert BOOL:config[@"disallowInterruption"]];
}
...
- (void)bindToView:(UIView *)view
{
    ...
    // is set
    if ([view isKindOfClass:[ABI22_0_0RCTScrollView class]]) {
        // This part of the code is coupled with ABI22_0_0RN implementation of ScrollView native wrapper and
        // we expect for ABI22_0_0RCTScrollView component to contain a subclass of UIScrollview as the only
        // subview
...
- (void)handleTouchDown:(UIView *)sender forEvent:(UIEvent *)event
{
    ...
    [self sendEventsInState:ABI22_0_0RNGestureHandlerStateActive
             forViewWithTag:sender.ReactABI22_0_0Tag
              withExtraData:[ABI22_0_0RNGestureHandlerEventExtraData forPointerInside:YES]];
}

- (void)handleTouchUpOutside:(UIView *)sender forEvent:(UIEvent *)event
{
    [self sendEventsInState:ABI22_0_0RNGestureHandlerStateEnd
             forViewWithTag:sender.ReactABI22_0_0Tag
              withExtraData:[ABI22_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
...
{
    [self sendEventsInState:ABI22_0_0RNGestureHandlerStateCancelled
             forViewWithTag:sender.ReactABI22_0_0Tag
              withExtraData:[ABI22_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
...
@implementation ABI22_0_0RNPinchGestureHandler
...
- (ABI22_0_0RNGestureHandlerEventExtraData *)eventExtraData:(UIPinchGestureRecognizer *)recognizer
{
    return [ABI22_0_0RNGestureHandlerEventExtraData
...
@implementation ABI22_0_0RNRotationGestureHandler
...
- (ABI22_0_0RNGestureHandlerEventExtraData *)eventExtraData:(UIRotationGestureRecognizer *)recognizer
{
    return [ABI22_0_0RNGestureHandlerEventExtraData
...
@implementation ABI22_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI22_0_0RNGestureHandler *otherHandler = [ABI22_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI22_0_0RCTTouchHandler class]];
}
...
/**
 * Gesture Handler Button components overrides standard mechanism used by ABI22_0_0RN
 ...
 */
@implementation ABI22_0_0RNGestureHandlerButton
