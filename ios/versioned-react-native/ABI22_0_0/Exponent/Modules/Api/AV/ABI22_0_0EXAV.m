...
- (NSError *)_updateAudioSessionCategory:(AVAudioSession *)audioSession forAudioSessionMode:(ABI22_0_0EXAVAudioSessionMode)audioSessionMode
{
  NSError *error;
     ...
     withRejecter:(ABI22_0_0RCTPromiseRejectBlock)reject
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    UIView *view = [_bridge.uiManager viewForReactABI22_0_0Tag:ReactABI22_0_0Tag];
...
ABI22_0_0RCT_EXPORT_MODULE(ExponentAV);
