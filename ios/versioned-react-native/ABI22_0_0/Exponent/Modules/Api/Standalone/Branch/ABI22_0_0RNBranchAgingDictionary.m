//
//  ABI22_0_0RNBranchAgingDictionary.m
//  ABI22_0_0RNBranch
//
...
#import "ABI22_0_0RNBranchAgingItem.h"

@interface ABI22_0_0RNBranchAgingDictionary()
@property (nonatomic) NSMutableDictionary *dictionary;
@end

@implementation ABI22_0_0RNBranchAgingDictionary
...
- (void)insertItem:(id)obj forKey:(id<NSCopying>)key
{
    ...
    self.dictionary[key] = [[ABI22_0_0RNBranchAgingItem alloc] initWithItem:obj];
}

- (id)itemForKey:(id)key
{
    ABI22_0_0RNBranchAgingItem *item = self.dictionary[key];
    return item.item;
}
