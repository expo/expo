...
@interface ABI22_0_0EXBannerView () <FBAdViewDelegate>

@property (nonatomic, strong) FBAdView *adView;

@end

@implementation ABI22_0_0EXBannerView
...
- (void)createViewIfCan
{
  ...
  FBAdView *adView = [[FBAdView alloc] initWithPlacementID:_placementId
                                                    adSize:fbAdSize
                                        rootViewController:ABI22_0_0RCTPresentedViewController()];
...
{
  _onAdError(ABI22_0_0RCTJSErrorFromNSError(error));
}
