...
@interface ABI22_0_0EXNativeAdView ()

@end

@implementation ABI22_0_0EXNativeAdView
...
- (void)setNativeAd:(FBNativeAd *)nativeAd
{
  ...
  [_nativeAd registerViewForInteraction:self withViewController:ABI22_0_0RCTKeyWindow().rootViewController];
}
