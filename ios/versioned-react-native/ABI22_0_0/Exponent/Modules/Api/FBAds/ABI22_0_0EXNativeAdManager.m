...
#import "ABI22_0_0EXNativeAdManager.h"
#import "ABI22_0_0EXNativeAdView.h"
...
@implementation ABI22_0_0RCTConvert (ABI22_0_0EXNativeAdView)

ABI22_0_0RCT_ENUM_CONVERTER(FBNativeAdsCachePolicy, (@{
...
@interface ABI22_0_0EXNativeAdManager () <FBNativeAdsManagerDelegate>

@property (nonatomic, strong) NSMutableDictionary<NSString*, FBNativeAdsManager*> *adsManagers;

@end

@implementation ABI22_0_0EXNativeAdManager

ABI22_0_0RCT_EXPORT_MODULE(CTKNativeAdManager)
...
ABI22_0_0RCT_EXPORT_METHOD(init:(NSString *)placementId withAdsToRequest:(nonnull NSNumber *)adsToRequest)
{
...
ABI22_0_0RCT_EXPORT_METHOD(setMediaCachePolicy:(NSString*)placementId cachePolicy:(FBNativeAdsCachePolicy)cachePolicy)
{
  [_adsManagers[placementId] setMediaCachePolicy:cachePolicy];
}

ABI22_0_0RCT_EXPORT_METHOD(disableAutoRefresh:(NSString*)placementId)
{
...
- (void)nativeAdsLoaded
{
  ...
  ABI22_0_0EXNativeAdEmitter *nativeAdEmitter = [_bridge moduleForClass:[ABI22_0_0EXNativeAdEmitter class]];
...
- (UIView *)view
{
  return [ABI22_0_0EXNativeAdView new];
}

ABI22_0_0RCT_EXPORT_VIEW_PROPERTY(onAdLoaded, ABI22_0_0RCTBubblingEventBlock)
ABI22_0_0RCT_CUSTOM_VIEW_PROPERTY(adsManager, NSString, ABI22_0_0EXNativeAdView)
{
