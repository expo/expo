...
#import "ABI22_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI22_0_0EXFingerprint

ABI22_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI22_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI22_0_0RCTPromiseResolveBlock)resolve
...
ABI22_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI22_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI22_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI22_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
