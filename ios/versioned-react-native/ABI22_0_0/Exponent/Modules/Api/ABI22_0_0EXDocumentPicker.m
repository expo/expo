...
static NSString * ABI22_0_0EXConvertMimeTypeToUTI(NSString *mimeType)
{
  CFStringRef uti;
...
@interface ABI22_0_0EXDocumentPicker () <UIDocumentMenuDelegate, UIDocumentPickerDelegate>
...
ABI22_0_0RCT_EXPORT_METHOD(getDocumentAsync:(NSDictionary *)options resolver:(ABI22_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI22_0_0RCTPromiseRejectBlock)reject) {
  ...
  NSString *type = ABI22_0_0EXConvertMimeTypeToUTI(options[@"type"] ?: @"*/*");
