...
#import "ABI22_0_0EXPedometer.h"
#import "ABI22_0_0EXUnversioned.h"

#import <CoreMotion/CoreMotion.h>

NSString * const ABI22_0_0EXPedometerUpdateEventName = @"Exponent.pedometerUpdate";

@implementation ABI22_0_0EXPedometer
{
...
- (void)setBridge:(ABI22_0_0RCTBridge *)bridge
{
  ...
  _watchHandler = ^(CMPedometerData * _Nullable pedometerData, NSError * _Nullable error) {
    ...
    [weakSelf sendEventWithName:ABI22_0_0EXPedometerUpdateEventName
...
ABI22_0_0RCT_EXPORT_MODULE(ExponentPedometer)

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI22_0_0EXPedometerUpdateEventName];
}

ABI22_0_0RCT_EXPORT_METHOD(getStepCountAsync:(nonnull NSNumber *)startTime
...
ABI22_0_0RCT_EXPORT_METHOD(watchStepCount)
{
  if (!_pedometer) {
    _pedometer = [CMPedometer new];
  }
...
ABI22_0_0RCT_EXPORT_METHOD(stopWatchingStepCount)
{
  _watchStartDate = nil;
  _isWatching = NO;
  [_pedometer stopPedometerUpdates];
...
ABI22_0_0RCT_EXPORT_METHOD(isAvailableAsync:(ABI22_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI22_0_0RCTPromiseRejectBlock)reject)
{
