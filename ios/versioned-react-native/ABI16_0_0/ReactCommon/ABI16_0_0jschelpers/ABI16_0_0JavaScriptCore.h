...
#include <ABI16_0_0jschelpers/ABI16_0_0JSCWrapper.h>

#if defined(__APPLE__)

// Use for methods that are taking JSContextRef as a first param
#define __jsc_wrapper(method, ctx, ...)   \
  (facebook::ReactABI16_0_0::isCustomJSCPtr(ctx) ? \
    facebook::ReactABI16_0_0::customJSCWrapper() : \
    facebook::ReactABI16_0_0::systemJSCWrapper()   \
