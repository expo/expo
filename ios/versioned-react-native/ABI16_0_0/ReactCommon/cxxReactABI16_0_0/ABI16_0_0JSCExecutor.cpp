...
#include "ABI16_0_0JSCExecutor.h"
...
void JSCExecutor::loadApplicationScript(std::unique_ptr<const JSBigString> script, std::string sourceURL) {
  ...
  ReactABI16_0_0Marker::logMarker("RUN_JS_BUNDLE_START");
  ...
  if (auto fileStr = dynamic_cast<const JSBigFileString *>(script.get())) {
    ...
    case JSLoadSourceIsCompiled:
      ...
      ReactABI16_0_0Marker::logMarker("CREATE_REACT_CONTEXT_END");
      ReactABI16_0_0Marker::logMarker("RUN_JS_BUNDLE_END");
      return;
...
#endif
  {
    ...
    ReactABI16_0_0Marker::logMarker("loadApplicationScript_startStringConvert");
    String jsScript = jsStringFromBigString(m_context, *script);
    ReactABI16_0_0Marker::logMarker("loadApplicationScript_endStringConvert");
...
void JSCExecutor::stopProfiler(const std::string &titleString, const std::string& filename) {
  #ifdef WITH_JSC_EXTRA_TRACING
  String title(m_context, titleString.c_str());
  facebook::ReactABI16_0_0::stopAndOutputProfilingFile(m_context, title, filename.c_str());
  #endif
}
