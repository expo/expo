...
namespace facebook { namespace ReactABI16_0_0 {
  class Instance;
}}
...
public:
   ...
   */
  void setInstance(std::weak_ptr<ReactABI16_0_0::Instance> instance) {
    instance_ = instance;
  }
   ...
   */
  std::weak_ptr<ReactABI16_0_0::Instance> getInstance() {
    return instance_;
  }

private:
  std::weak_ptr<ReactABI16_0_0::Instance> instance_;
};
