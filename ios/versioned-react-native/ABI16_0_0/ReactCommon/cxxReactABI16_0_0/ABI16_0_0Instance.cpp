...
#include "ABI16_0_0Instance.h"

#include "ABI16_0_0Executor.h"
#include "ABI16_0_0MethodCall.h"
#include "ABI16_0_0RecoverableError.h"
#include "ABI16_0_0SystraceSection.h"
...
void Instance::setSourceURL(std::string sourceURL) {
  ...
  SystraceSection s("ReactABI16_0_0bridge_xplat_setSourceURL",
                    "sourceURL", sourceURL);
...
void Instance::loadScriptFromString(std::unique_ptr<const JSBigString> string,
  ...
  callback_->incrementPendingJSCalls();
  SystraceSection s("ReactABI16_0_0bridge_xplat_loadScriptFromString",
                    "sourceURL", sourceURL);
...
void Instance::loadScriptFromFile(const std::string& filename,
  ...
  callback_->incrementPendingJSCalls();
  SystraceSection s("ReactABI16_0_0bridge_xplat_loadScriptFromFile",
                    "fileName", filename);
...
void Instance::loadUnbundleSync(std::unique_ptr<JSModulesUnbundle> unbundle,
  ...
  SystraceSection s("ReactABI16_0_0bridge_xplat_loadApplicationSync");
