...
#include <cxxReactABI16_0_0/ABI16_0_0RecoverableError.h>

using namespace facebook::ReactABI16_0_0::detail;
...
TEST(RecoverableError, RunRethrowingAsRecoverableRecoverTest) {
  try {
    ...
    ASSERT_STREQ(err.what(), "facebook::ReactABI16_0_0::Recoverable: catch me");
  } catch (...) {
