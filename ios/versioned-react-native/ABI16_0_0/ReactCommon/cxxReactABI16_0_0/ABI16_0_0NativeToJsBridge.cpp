...
#include "ABI16_0_0NativeToJsBridge.h"
...
class JsToNativeBridge : public ReactABI16_0_0::ExecutorDelegate {
public:
  ...
  void callNativeModules(
    ...
    m_nativeQueue->runOnQueue([this, token, calls=std::move(calls), isEndOfBatch] () mutable {
      ...
      for (auto& call : ReactABI16_0_0::parseMethodCalls(std::move(calls))) {
