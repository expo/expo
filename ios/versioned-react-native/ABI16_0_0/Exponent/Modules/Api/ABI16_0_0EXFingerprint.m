...
#import "ABI16_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI16_0_0EXFingerprint

ABI16_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI16_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI16_0_0RCTPromiseResolveBlock)resolve
...
ABI16_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI16_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI16_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI16_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
