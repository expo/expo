...
@interface ABI16_0_0EXSQLite ()

@property (nonatomic, copy) NSMutableDictionary *cachedDatabases;

@end

@implementation ABI16_0_0EXSQLite
...
ABI16_0_0RCT_EXPORT_MODULE(ExponentSQLite)
...
- (NSValue *)openDatabase:(NSString *)dbName
{
  ...
  if (cachedDB == nil) {
    [ABI16_0_0EXFileSystem ensureDirExistsWithPath:[self.bridge.experienceScope scopedPathWithPath:@"SQLite" withOptions:@{}]];
...
ABI16_0_0RCT_EXPORT_METHOD(exec:(NSString *)dbName
                 ...
                 withDb:(sqlite3*)db withReadOnly:(BOOL)readOnly
{
  ...
  if (sqlite3_prepare_v2(db, [sql UTF8String], -1, &statement, NULL) != SQLITE_OK) {
    error = [ABI16_0_0EXSQLite convertSQLiteErrorToString:db];
    return @[error];
  }
