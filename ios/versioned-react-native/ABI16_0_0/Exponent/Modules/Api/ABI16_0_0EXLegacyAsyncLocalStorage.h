...
// Read-only access to legacy (unscoped) `ABI16_0_0RCTAsyncLocalStorage` backing for
// access to legacy data, now that the new one we use in our fork is scoped
// per-app

// This code is basically based on ReactABI16_0_0-native's built-in
// `ABI16_0_0RCTAsyncLocalStorage.{h,m}` except made to be read-only and with
// naming changes to `ABI16_0_0EXLegacyAsyncLocalStorage` for the Objective-C class
 ...
 * being atomic, unless someone bypasses the `ABI16_0_0RCTAsyncLocalStorage` API.
 *
 * Keys and values must always be strings or an error is returned.
 */
@interface ABI16_0_0EXLegacyAsyncLocalStorage : NSObject <ABI16_0_0RCTBridgeModule,ABI16_0_0RCTInvalidating>
