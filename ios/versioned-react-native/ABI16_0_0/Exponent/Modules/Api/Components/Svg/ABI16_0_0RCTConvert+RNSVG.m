...
#import "ABI16_0_0RNSVGBaseBrush.h"
#import "ABI16_0_0RNSVGPattern.h"
...
@implementation ABI16_0_0RCTConvert (ABI16_0_0RNSVG)
...
#define NEXT_VALUE [self double:arr[i++]]
        ...
        while (i < count) {
            ...
            switch (type) {
                ...
                case 4:
                    ...
                    break;
                default:
                    ABI16_0_0RCTLogError(@"Invalid CGPath type %zd at element %zd of %@", type, i, arr);
                    CGPathRelease(path);
                    return nil;
            }
        }
    ...
    @catch (NSException *exception) {
        ABI16_0_0RCTLogError(@"Invalid CGPath format: %@", arr);
        CGPathRelease(path);
        return nil;
    }
...
ABI16_0_0RCT_ENUM_CONVERTER(CTTextAlignment, (@{
...
ABI16_0_0RCT_ENUM_CONVERTER(ABI16_0_0RNSVGCGFCRule, (@{
                                     @"evenodd": @(kABI16_0_0RNSVGCGFCRuleEvenodd),
                                     @"nonzero": @(kABI16_0_0RNSVGCGFCRuleNonzero),
                                     }), kABI16_0_0RNSVGCGFCRuleNonzero, intValue)

ABI16_0_0RCT_ENUM_CONVERTER(ABI16_0_0RNSVGVBMOS, (@{
                                  @"meet": @(kABI16_0_0RNSVGVBMOSMeet),
                                  @"slice": @(kABI16_0_0RNSVGVBMOSSlice),
                                  @"none": @(kABI16_0_0RNSVGVBMOSNone)
                                  }), kABI16_0_0RNSVGVBMOSMeet, intValue)


// This takes a tuple of text lines and a font to generate a CTLine for each text line.
// This prepares everything for rendering a frame of text in ABI16_0_0RNSVGText.
+ (ABI16_0_0RNSVGTextFrame)ABI16_0_0RNSVGTextFrame:(id)json
{
    NSDictionary *dict = [self NSDictionary:json];
    ABI16_0_0RNSVGTextFrame frame;
    frame.count = 0;
    ...
    CTFontRef font = (__bridge CTFontRef)[ABI16_0_0RCTFont updateFont:nil withFamily:fontFamily size:fontDict[@"fontSize"] weight:fontDict[@"fontWeight"] style:fontDict[@"fontStyle"]
    ...
    frame.lineHeight = size * 1.1; // Base on ABI16_0_0RNSVG canvas line height estimate
...
+ (ABI16_0_0RNSVGCGFloatArray)ABI16_0_0RNSVGCGFloatArray:(id)json
{
    ...
    ABI16_0_0RNSVGCGFloatArray array;
    array.count = count;
    array.array = nil;
...
+ (ABI16_0_0RNSVGBrush *)ABI16_0_0RNSVGBrush:(id)json
{
    ...
    switch (type) {
        case 0: // solid color
            ...
            return [[ABI16_0_0RNSVGSolidColorBrush alloc] initWithArray:arr];
        case 1: // brush
            return [[ABI16_0_0RNSVGBaseBrush alloc] initWithArray:arr];
        default:
            ABI16_0_0RCTLogError(@"Unknown brush type: %zd", type);
            return nil;
    }
}
        ...
        while (i < count) {
            ...
            switch (type) {
                ...
                case 3:
                    ...
                    break;
                default:
                    ABI16_0_0RCTLogError(@"Invalid ABI16_0_0RNSVGBezier type %zd at element %zd of %@", type, i, arr);
                    return nil;
            }
        }
    }
    @catch (NSException *exception) {
        ABI16_0_0RCTLogError(@"Invalid ABI16_0_0RNSVGBezier format: %@", arr);
        return nil;
    }
...
+ (CGRect)CGRect:(id)json offset:(NSUInteger)offset
{
    ...
    if (arr.count < offset + 4) {
        ABI16_0_0RCTLogError(@"Too few elements in array (expected at least %zd): %@", 4 + offset, arr);
        return CGRectZero;
    }
    return (CGRect){
...
+ (CGGradientRef)CGGradient:(id)json offset:(NSUInteger)offset
{
    NSArray *arr = [self NSArray:json];
    if (arr.count < offset) {
        ABI16_0_0RCTLogError(@"Too few elements in array (expected at least %zd): %@", offset, arr);
        return nil;
    }
    arr = [arr subarrayWithRange:(NSRange){offset, arr.count - offset}];
    ABI16_0_0RNSVGCGFloatArray colorsAndOffsets = [self ABI16_0_0RNSVGCGFloatArray:arr];
