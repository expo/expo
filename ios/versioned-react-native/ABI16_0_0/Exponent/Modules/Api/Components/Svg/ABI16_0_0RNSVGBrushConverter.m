...
@implementation ABI16_0_0RNSVGBrushConverter

- (void)drawLinearGradient:(CGContextRef)context
{
    
    CGGradientRef gradient = CGGradientRetain([ABI16_0_0RCTConvert CGGradient:self.colors offset:0]);
    ...
    ABI16_0_0RNSVGPercentageConverter* convert = [[ABI16_0_0RNSVGPercentageConverter alloc] init];
