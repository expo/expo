...
@implementation ABI16_0_0RNSVGNode
{
    BOOL _transparent;
}
...
- (void)invalidate
{
    id<ABI16_0_0RNSVGContainer> container = (id<ABI16_0_0RNSVGContainer>)self.superview;
...
- (void)clip:(CGContextRef)context
{
    ...
    if (clipPath) {
        ...
        if (self.clipRule == kABI16_0_0RNSVGCGFCRuleEvenodd) {
...
- (ABI16_0_0RNSVGSvgView *)getSvgView
{
    UIView *parent = self.superview;
    while (parent && [parent class] != [ABI16_0_0RNSVGSvgView class]) {
        parent = parent.superview;
    }

    return (ABI16_0_0RNSVGSvgView *)parent;
}
...
- (void)traverseSubviews:(BOOL (^)(ABI16_0_0RNSVGNode *node))block
{
