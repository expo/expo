...
@implementation ABI16_0_0RNSVGImage
{
    CGImageRef _image;
    CGFloat _imageRatio;
}
...
- (void)setSrc:(id)src
{
    ...
    ABI16_0_0RCTImageSource *source = [ABI16_0_0RCTConvert ABI16_0_0RCTImageSource:src];
    _imageRatio = source.size.width / source.size.height;
    _image = CGImageRetain([ABI16_0_0RCTConvert CGImage:src]);
    [self invalidate];
}
...
- (void)setMeetOrSlice:(ABI16_0_0RNSVGVBMOS)meetOrSlice
{
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    ABI16_0_0RNSVGViewBox *viewBox = [[ABI16_0_0RNSVGViewBox alloc] init];
