...
#import "ABI16_0_0AIRDummyView.h"
...
@interface ABI16_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI16_0_0AIRGMSMarker*)marker;
@end

@implementation ABI16_0_0AIRGoogleMapMarker {
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI16_0_0AIRGMSMarker alloc] init];
...
- (void)insertReactABI16_0_0Subview:(id<ABI16_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI16_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI16_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI16_0_0AIRDummyView *dummySubview = [[ABI16_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertReactABI16_0_0Subview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeReactABI16_0_0Subview:(id<ABI16_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI16_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeReactABI16_0_0Subview:(UIView*)dummySubview];
}
...
- (void)setOnPress:(ABI16_0_0RCTBubblingEventBlock)onPress {
  _realMarker.onPress = onPress;
}

- (ABI16_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/airbnb/ReactABI16_0_0-native-maps/issues/738)
