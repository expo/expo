...
@interface ABI16_0_0AIRMapPolygon: MKAnnotationView <MKOverlay>

@property (nonatomic, weak) ABI16_0_0AIRMap *map;
...
@property (nonatomic, strong) NSArray<ABI16_0_0AIRMapCoordinate *> *coordinates;
@property (nonatomic, strong) NSArray<NSArray<ABI16_0_0AIRMapCoordinate *> *> *holes;
