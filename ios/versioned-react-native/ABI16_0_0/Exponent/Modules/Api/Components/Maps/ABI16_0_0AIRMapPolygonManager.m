...
#import "ABI16_0_0AIRMapPolygonManager.h"
...
@interface ABI16_0_0AIRMapPolygonManager()

@end

@implementation ABI16_0_0AIRMapPolygonManager

ABI16_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI16_0_0AIRMapPolygon *polygon = [ABI16_0_0AIRMapPolygon new];
    return polygon;
}
