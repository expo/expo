...
@interface ABI16_0_0AIRMapMarker : MKAnnotationView <MKAnnotation>

@property (nonatomic, strong) ABI16_0_0AIRMapCallout *calloutView;
...
@property (nonatomic, copy) ABI16_0_0RCTDirectEventBlock onSelect;
@property (nonatomic, copy) ABI16_0_0RCTDirectEventBlock onDeselect;
...
@interface ABI16_0_0AIREmptyCalloutBackgroundView : ABI16_0_0SMCalloutBackgroundView
@end
