...
@interface ABI16_0_0EXBarCodeScanner ()

@property (nonatomic, weak) ABI16_0_0EXBarCodeScannerManager *manager;
@property (nonatomic, weak) ABI16_0_0RCTBridge *bridge;
@property (nonatomic, copy) ABI16_0_0RCTDirectEventBlock onBarCodeRead;

@end

@implementation ABI16_0_0EXBarCodeScanner
