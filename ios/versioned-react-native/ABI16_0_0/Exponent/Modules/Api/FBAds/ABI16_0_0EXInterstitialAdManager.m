#import "ABI16_0_0EXInterstitialAdManager.h"
#import "ABI16_0_0EXUnversioned.h"

#import <FBAudienceNetwork/FBAudienceNetwork.h>
#import <ReactABI16_0_0/ABI16_0_0RCTUtils.h>

@interface ABI16_0_0EXInterstitialAdManager () <FBInterstitialAdDelegate>
...
@implementation ABI16_0_0EXInterstitialAdManager

@synthesize bridge = _bridge;

ABI16_0_0RCT_EXPORT_MODULE(CTKInterstitialAdManager)
...
{
  ABI16_0_0RCTAssert(_resolve == nil && _reject == nil, @"Only one `showAd` can be called at once");
  ABI16_0_0RCTAssert(_isBackground == false, @"`showAd` can be called only when experience is running in foreground");
...
{
  [_interstitialAd showAdFromRootViewController:ABI16_0_0RCTPresentedViewController()];
}
...
- (void)bridgeDidForeground:(NSNotification *)notification
{
  ...
  if (_adViewController) {
    [ABI16_0_0RCTPresentedViewController() presentViewController:_adViewController animated:NO completion:nil];
...
- (void)bridgeDidBackground:(NSNotification *)notification
{
  ...
  if (_interstitialAd) {
    _adViewController = ABI16_0_0RCTPresentedViewController();
