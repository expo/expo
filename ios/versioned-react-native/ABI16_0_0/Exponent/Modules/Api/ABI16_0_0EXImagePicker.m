#import "ABI16_0_0EXImagePicker.h"
...
@interface ABI16_0_0EXImagePicker ()
...
@implementation ABI16_0_0EXImagePicker

ABI16_0_0RCT_EXPORT_MODULE(ExponentImagePicker);
...
ABI16_0_0RCT_EXPORT_METHOD(launchCameraAsync:(NSDictionary *)options
...
ABI16_0_0RCT_EXPORT_METHOD(launchImageLibraryAsync:(NSDictionary *)options
                  resolver:(ABI16_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI16_0_0RCTPromiseRejectBlock)reject)
{
  self.resolve = resolve;
...
- (void)launchImagePicker:(RNImagePickerTarget)target
{
  ...
  if (target == RNImagePickerTargetCamera) {
    ...
    self.reject(ABI16_0_0RCTErrorUnspecified, @"Camera not available on simulator", nil);
    return;
#else
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
  dispatch_block_t dismissCompletionBlock = ^{
    ...
    [ABI16_0_0EXFileSystem ensureDirExistsWithPath:[self.bridge.experienceScope scopedPathWithPath:@"ImagePicker"
    ...
    if ([mediaType isEqualToString:(NSString *)kUTTypeImage]) { // PHOTOS
      ...
      if (imageURL && [[imageURL absoluteString] rangeOfString:@"ext=GIF"].location != NSNotFound) {
        ...
        [assetsLibrary assetForURL:imageURL resultBlock:^(ALAsset *asset) {
          ...
          self.reject(ABI16_0_0RCTErrorUnspecified, error.localizedFailureReason, error);
        }];
        return;
      }
