...
@interface ABI16_0_0EXKernelModule ()
...
@implementation ABI16_0_0EXKernelModule
...
- (void)sendEventWithName:(NSString *)eventName body:(id)body
{
  ...
  [self.bridge enqueueJSCall:@"ABI16_0_0RCTDeviceEventEmitter.emit"
...
ABI16_0_0RCT_REMAP_METHOD(doesCurrentTaskEnableDevtools,
                 doesCurrentTaskEnableDevtoolsWithResolver:(ABI16_0_0RCTPromiseResolveBlock)resolve
...
ABI16_0_0RCT_REMAP_METHOD(shouldCurrentTaskAutoReload,
                 shouldCurrentTaskAutoReloadWithResolver:(ABI16_0_0RCTPromiseResolveBlock)resolve
                 reject:(ABI16_0_0RCTPromiseRejectBlock)reject)
{
  if (_delegate) {
...
ABI16_0_0RCT_REMAP_METHOD(getDevMenuItemsToShow,
                 getDevMenuItemsToShowWithResolver:(ABI16_0_0RCTPromiseResolveBlock)resolve
                 reject:(ABI16_0_0RCTPromiseRejectBlock)reject)
{
...
ABI16_0_0RCT_EXPORT_METHOD(selectDevMenuItemWithKey:(NSString *)key)
{
  if (_delegate) {
...
ABI16_0_0RCT_EXPORT_METHOD(addDevMenu)
{
...
ABI16_0_0RCT_REMAP_METHOD(routeDidForeground,
...
ABI16_0_0RCT_REMAP_METHOD(onEventSuccess,
...
ABI16_0_0RCT_REMAP_METHOD(onEventFailure,
                 eventId:(NSString *)eventId
