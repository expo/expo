...
@implementation ABI16_0_0EXScope
...
- (instancetype)initWithParams:(NSDictionary *)params
{
  if (self = [super init]) {
    ...
    ABI16_0_0RCTAssert(manifest, @"Need manifest to get experience id.");
    _experienceId = manifest[@"id"];

    NSString *subdir = [ABI16_0_0EXVersionManager escapedResourceName:_experienceId];
...
- (NSString *)scopedPathWithPath:(NSString *)path withOptions:(NSDictionary *)options
{
  ...
  if (![ABI16_0_0EXFileSystem ensureDirExistsWithPath:prefix]) {
    return nil;
  }
...
@implementation  ABI16_0_0RCTBridge (ABI16_0_0EXScope)

- (ABI16_0_0EXScope *)experienceScope
{
  return [self moduleForClass:[ABI16_0_0EXScope class]];
}
