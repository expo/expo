...
typedef void (^ABI16_0_0RCTJavaScriptValueCallback)(JSValue *result, NSError *error);

/**
 * Default name for the JS thread
 */
ABI16_0_0RCT_EXTERN NSString *const ABI16_0_0RCTJSCThreadName;
 ...
 */
ABI16_0_0RCT_EXTERN NSString *const ABI16_0_0RCTJavaScriptContextCreatedNotification;
 ...
 *  used in ReactABI16_0_0 (or ComponenetScript). It is recommended not to access it
 ...
 */
ABI16_0_0RCT_EXTERN NSString *const ABI16_0_0RCTFBJSContextClassKey;
 ...
 */
ABI16_0_0RCT_EXTERN NSString *const ABI16_0_0RCTFBJSValueClassKey;

/**
 * Uses a JavaScriptCore context as the execution engine.
 */
@interface ABI16_0_0RCTJSCExecutor : NSObject <ABI16_0_0RCTJavaScriptExecutor>

/**
 * Returns whether executor uses custom JSC library.
 * This value is used to initialize ABI16_0_0RCTJSCWrapper.
 * @default is NO.
 */
 ...
 * @default is "ABI16_0_0RCTJSContext"
 */
@property (nonatomic, copy) NSString *contextName;

/**
 * Inits a new executor instance with given flag that's used
 * to initialize ABI16_0_0RCTJSCWrapper.
 */
...
- (void)callFunctionOnModule:(NSString *)module
             ...
             jsValueCallback:(ABI16_0_0RCTJavaScriptValueCallback)onComplete;
...
/**
 * @experimental
 * May be used to pre-create the JSContext to make ABI16_0_0RCTJSCExecutor creation less costly.
 * Avoid using this; it's experimental and is not likely to be supported long-term.
 */
@interface ABI16_0_0RCTJSContextProvider : NSObject
...
/**
 * @experimental
 * Create an ABI16_0_0RCTJSCExecutor from an provider instance. This may only be called once.
 * The underlying JSContext will be returned in the JSContext pointer if it is non-NULL.
 */
- (ABI16_0_0RCTJSCExecutor *)createExecutorWithContext:(JSContext **)JSContext;
