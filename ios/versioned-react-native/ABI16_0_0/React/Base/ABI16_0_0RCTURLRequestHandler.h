 ...
 * are also bridge modules, so should be registered using ABI16_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI16_0_0RCTURLRequestHandler <ABI16_0_0RCTBridgeModule>
...
/**
 * If more than one ABI16_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
