 ...
 */
@interface ABI16_0_0RCTImageSource : NSObject
...
@interface ABI16_0_0RCTConvert (ImageSource)

+ (ABI16_0_0RCTImageSource *)ABI16_0_0RCTImageSource:(id)json;
+ (NSArray<ABI16_0_0RCTImageSource *> *)ABI16_0_0RCTImageSourceArray:(id)json;
