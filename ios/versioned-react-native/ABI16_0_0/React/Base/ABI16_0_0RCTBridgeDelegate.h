...
@protocol ABI16_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI16_0_0RCTBridge *)bridge;
 ...
 */
- (NSURL *)fallbackSourceURLForBridge:(ABI16_0_0RCTBridge *)bridge;

/**
 * The bridge initializes any registered ABI16_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI16_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI16_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (NSArray<Class> *)whitelistedModulesForBridge:(ABI16_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeLoadJavaScriptSynchronously:(ABI16_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeInitializeNativeModulesSynchronously:(ABI16_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI16_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI16_0_0RCTBridge *)bridge;
 ...
 */
- (void)loadSourceForBridge:(ABI16_0_0RCTBridge *)bridge
                 onProgress:(ABI16_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI16_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI16_0_0RCTBridge *)bridge
                  withBlock:(ABI16_0_0RCTSourceLoadBlock)loadCallback;
