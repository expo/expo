...
#import "ABI16_0_0RCTMultipartStreamReader.h"

#define CRLF @"\r\n"

@implementation ABI16_0_0RCTMultipartStreamReader {
...
- (void)emitChunk:(NSData *)data callback:(ABI16_0_0RCTMultipartCallback)callback done:(BOOL)done
{
...
- (BOOL)readAllParts:(ABI16_0_0RCTMultipartCallback)callback
{
