...
@protocol ABI16_0_0RCTBridgeMethod;
@protocol ABI16_0_0RCTBridgeModule;
@class ABI16_0_0RCTBridge;

@interface ABI16_0_0RCTModuleData : NSObject <ABI16_0_0RCTInvalidating>

- (instancetype)initWithModuleClass:(Class)moduleClass
                             bridge:(ABI16_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;

- (instancetype)initWithModuleInstance:(id<ABI16_0_0RCTBridgeModule>)instance
                                bridge:(ABI16_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI16_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI16_0_0RCTBridgeModule> instance;
