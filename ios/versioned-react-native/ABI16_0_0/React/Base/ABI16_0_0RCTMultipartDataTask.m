...
@interface ABI16_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI16_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI16_0_0RCTMultipartDataTaskCallback _partHandler;
...
{
  ABI16_0_0RCTMultipartStreamReader *reader = [[ABI16_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI16_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
