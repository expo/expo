...
extern NSString *const ABI16_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI16_0_0RCTBundleURLProviderDefaultPort;

@interface ABI16_0_0RCTBundleURLProvider : NSObject
