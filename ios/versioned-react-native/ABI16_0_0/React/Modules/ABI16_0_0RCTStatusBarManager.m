...
#import "ABI16_0_0RCTStatusBarManager.h"
...
#if !TARGET_OS_TV
@implementation ABI16_0_0RCTConvert (UIStatusBar)
...
@implementation ABI16_0_0RCTStatusBarManager

static BOOL ABI16_0_0RCTViewControllerBasedStatusBarAppearance()
{
  static BOOL value;
...
{
  if (ABI16_0_0RCTViewControllerBasedStatusBarAppearance()) {
