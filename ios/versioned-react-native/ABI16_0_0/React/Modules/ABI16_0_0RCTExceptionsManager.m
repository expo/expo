...
#import "ABI16_0_0RCTExceptionsManager.h"
...
@implementation ABI16_0_0RCTExceptionsManager
{
                  ...
                  exceptionId:(nonnull NSNumber *)exceptionId)
{
  ...
  if (!ABI16_0_0RCT_DEBUG && reloadRetries < _maxReloadAttempts) {
    reloadRetries++;
    [_bridge reload];
  } else {
    NSString *description = [@"Unhandled JS Exception: " stringByAppendingString:message];
    NSDictionary *errorInfo = @{ NSLocalizedDescriptionKey: description, ABI16_0_0RCTJSStackTraceKey: stack };
    ABI16_0_0RCTFatal([NSError errorWithDomain:ABI16_0_0RCTErrorDomain code:0 userInfo:errorInfo]);
  }
}
...
ABI16_0_0RCT_EXPORT_METHOD(reportUnhandledException:(NSString *)message
                  stack:(NSArray<NSDictionary *> *)stack)
{
