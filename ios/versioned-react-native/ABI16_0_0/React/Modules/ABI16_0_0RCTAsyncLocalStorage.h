 ...
 */
@interface ABI16_0_0RCTAsyncLocalStorage : NSObject <ABI16_0_0RCTBridgeModule,ABI16_0_0RCTInvalidating>
...
// Clear the ABI16_0_0RCTAsyncLocalStorage data from native code
- (void)clearAllData;
