...
@implementation ABI16_0_0RCTDevLoadingView
{
  UIWindow *_window;
  UILabel *_label;
  NSDate *_showDate;
...
- (void)setBridge:(ABI16_0_0RCTBridge *)bridge
{
  ...
  [[NSNotificationCenter defaultCenter] addObserver:self
                                           selector:@selector(hide)
                                               name:ABI16_0_0RCTJavaScriptDidFailToLoadNotification
                                             object:nil];
...
ABI16_0_0RCT_EXPORT_METHOD(showMessage:(NSString *)message color:(UIColor *)color backgroundColor:(UIColor *)backgroundColor)
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    if (!self->_window && !ABI16_0_0RCTRunningInTestEnvironment()) {
...
- (void)updateProgress:(ABI16_0_0RCTLoadingProgress *)progress
{
  if (!progress) {
    return;
  }
