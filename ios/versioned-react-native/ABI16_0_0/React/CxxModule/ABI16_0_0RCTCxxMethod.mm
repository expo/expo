...
#import "ABI16_0_0RCTCxxMethod.h"
...
#import <cxxReactABI16_0_0/ABI16_0_0JsArgumentHelpers.h>
...
@implementation ABI16_0_0RCTCxxMethod
{
             ...
             arguments:(NSArray *)arguments
{
  ...
  if (arguments.count < _method->callbacks) {
    ABI16_0_0RCTLogError(@"Method %@.%s expects at least %lu arguments, but got %tu",
                ABI16_0_0RCTBridgeModuleNameForClass([module class]), _method->name.c_str(),
  ...
  if (_method->callbacks >= 1) {
    if (![arguments[arguments.count - 1] isKindOfClass:[NSNumber class]]) {
      ABI16_0_0RCTLogError(@"Argument %tu (%@) of %@.%s should be a function",
  ...
  folly::dynamic args = [ABI16_0_0RCTConvert folly_dynamic:arguments];
  ...
  try {
    ...
    ABI16_0_0RCTLogError(@"Method %@.%s argument error: %s",
                ABI16_0_0RCTBridgeModuleNameForClass([module class]), _method->name.c_str(),
                ex.what());
    return nil;
  }
...
- (ABI16_0_0RCTFunctionType)functionType
{
  ...
  return _method->syncFunc ? ABI16_0_0RCTFunctionTypeSync : ABI16_0_0RCTFunctionTypeNormal;
}
