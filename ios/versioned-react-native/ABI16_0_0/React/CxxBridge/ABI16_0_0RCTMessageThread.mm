...
#include "ABI16_0_0RCTMessageThread.h"
...
#include <ABI16_0_0jschelpers/ABI16_0_0JSCHelpers.h>
...
ABI16_0_0RCTMessageThread::ABI16_0_0RCTMessageThread(NSRunLoop *runLoop, ABI16_0_0RCTJavaScriptCompleteBlock errorBlock)
...
ABI16_0_0RCTMessageThread::~ABI16_0_0RCTMessageThread() {
  CFRelease(m_cfRunLoop);
}

// This is analogous to dispatch_async
void ABI16_0_0RCTMessageThread::runAsync(std::function<void()> func) {
...
void ABI16_0_0RCTMessageThread::runSync(std::function<void()> func) {
...
void ABI16_0_0RCTMessageThread::tryFunc(const std::function<void()>& func) {
...
void ABI16_0_0RCTMessageThread::runOnQueue(std::function<void()>&& func) {
  if (m_shutdown) {
    return;
  }
...
void ABI16_0_0RCTMessageThread::runOnQueueSync(std::function<void()>&& func) {
  if (m_shutdown) {
    return;
  }
...
void ABI16_0_0RCTMessageThread::quitSynchronous() {
  m_shutdown = true;
  runSync([]{});
