...
@implementation ABI16_0_0RCTConvert (UITabBarSystemItem)

ABI16_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI16_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI16_0_0ViewController;
}
