...
@implementation ABI16_0_0RCTConvert(MapKit)
...
ABI16_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
{
  json = [self NSDictionary:json];
  ABI16_0_0RCTMapAnnotation *annotation = [ABI16_0_0RCTMapAnnotation new];
...
ABI16_0_0RCT_ARRAY_CONVERTER(ABI16_0_0RCTMapAnnotation)
...
+ (ABI16_0_0RCTMapOverlay *)ABI16_0_0RCTMapOverlay:(id)json
{
  ...
  ABI16_0_0RCTMapOverlay *overlay = [ABI16_0_0RCTMapOverlay polylineWithCoordinates:coordinates
...
ABI16_0_0RCT_ARRAY_CONVERTER(ABI16_0_0RCTMapOverlay)
