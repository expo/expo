...
// These constants can only be removed when ReactABI16_0_0 Native drops iOS8 support.
...
typedef CGFloat ABI16_0_0RCTFontWeight;
static ABI16_0_0RCTFontWeight weightOfFont(UIFont *font)
{
  ...
  ABI16_0_0RCTFontWeight weight = [traits[UIFontWeightTrait] doubleValue];
  if (weight == 0.0) {
...
static UIFont *cachedSystemFont(CGFloat size, ABI16_0_0RCTFontWeight weight)
{
...
@implementation ABI16_0_0RCTConvert (ABI16_0_0RCTFont)

+ (UIFont *)UIFont:(id)json
{
  json = [self NSDictionary:json];
  return [ABI16_0_0RCTFont updateFont:nil
                  withFamily:[ABI16_0_0RCTConvert NSString:json[@"fontFamily"]]
                        size:[ABI16_0_0RCTConvert NSNumber:json[@"fontSize"]]
                      weight:[ABI16_0_0RCTConvert NSString:json[@"fontWeight"]]
                       style:[ABI16_0_0RCTConvert NSString:json[@"fontStyle"]]
                     variant:[ABI16_0_0RCTConvert NSStringArray:json[@"fontVariant"]]
             scaleMultiplier:1];
}

ABI16_0_0RCT_ENUM_CONVERTER(ABI16_0_0RCTFontWeight, (@{
                                     @"normal": @(UIFontWeightRegular),
                                     @"bold": @(UIFontWeightBold),
...
typedef BOOL ABI16_0_0RCTFontStyle;
ABI16_0_0RCT_ENUM_CONVERTER(ABI16_0_0RCTFontStyle, (@{
                                    @"normal": @NO,
                                    @"italic": @YES,
                                    @"oblique": @YES,
                                    }), NO, boolValue)

typedef NSDictionary ABI16_0_0RCTFontVariantDescriptor;
+ (ABI16_0_0RCTFontVariantDescriptor *)ABI16_0_0RCTFontVariantDescriptor:(id)json
{
  ...
  ABI16_0_0RCTFontVariantDescriptor *value = mapping[json];
  if (ABI16_0_0RCT_DEBUG && !value && [json description].length > 0) {
    ABI16_0_0RCTLogError(@"Invalid ABI16_0_0RCTFontVariantDescriptor '%@'. should be one of: %@", json,
                [[mapping allKeys] sortedArrayUsingSelector:@selector(caseInsensitiveCompare:)]);
  }
  return value;
}

ABI16_0_0RCT_ARRAY_CONVERTER(ABI16_0_0RCTFontVariantDescriptor)

@end

@implementation ABI16_0_0RCTFont
...
+ (UIFont *)updateFont:(UIFont *)font
            withFamily:(NSString *)family
               ...
               variant:(NSArray<ABI16_0_0RCTFontVariantDescriptor *> *)variant
       scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  const ABI16_0_0RCTFontWeight defaultFontWeight = UIFontWeightRegular;
  const CGFloat defaultFontSize = 14;

  // Initialize properties to defaults
  CGFloat fontSize = defaultFontSize;
  ABI16_0_0RCTFontWeight fontWeight = defaultFontWeight;
  ...
  // Get font attributes
  fontSize = [ABI16_0_0RCTConvert CGFloat:size] ?: fontSize;
  if (scaleMultiplier > 0.0 && scaleMultiplier != 1.0) {
    fontSize = round(fontSize * scaleMultiplier);
  }
  familyName = [ABI16_0_0RCTConvert NSString:family] ?: familyName;
  isItalic = style ? [ABI16_0_0RCTConvert ABI16_0_0RCTFontStyle:style] : isItalic;
  fontWeight = weight ? [ABI16_0_0RCTConvert ABI16_0_0RCTFontWeight:weight] : fontWeight;
  ...
  if (!didFindFont && [UIFont fontNamesForFamilyName:familyName].count == 0) {
    ...
    if (font) {
      ...
      ABI16_0_0RCTLogError(@"Unrecognized font family '%@'", familyName);
      if ([UIFont respondsToSelector:@selector(systemFontOfSize:weight:)]) {
  ...
  if (variant) {
    NSArray *fontFeatures = [ABI16_0_0RCTConvert ABI16_0_0RCTFontVariantDescriptorArray:variant];
