...
@protocol ABI16_0_0RCTAutoInsetsProtocol;

@class ABI16_0_0RCTView;

@interface ABI16_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI16_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI16_0_0RCTDirectEventBlock onMagicTap;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI16_0_0RCTPointerEvents pointerEvents;
 ...
 * This is inherited from UIView+ReactABI16_0_0, but we override it here
...
/**
 * z-index, used to override sibling order in didUpdateReactABI16_0_0Subviews. This is
 * inherited from UIView+ReactABI16_0_0, but we override it here to reduce the boxing
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI16_0_0RCTBorderStyle borderStyle;
