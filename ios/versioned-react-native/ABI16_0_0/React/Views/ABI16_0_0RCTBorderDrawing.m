...
#import "ABI16_0_0RCTBorderDrawing.h"
#import "ABI16_0_0RCTLog.h"

static const CGFloat ABI16_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI16_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return
  ABS(borderInsets.left - borderInsets.right) < ABI16_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.bottom) < ABI16_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.top) < ABI16_0_0RCTViewBorderThreshold;
}

BOOL ABI16_0_0RCTCornerRadiiAreEqual(ABI16_0_0RCTCornerRadii cornerRadii)
{
  return
  ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI16_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI16_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI16_0_0RCTViewBorderThreshold;
}
...
{
  return (ABI16_0_0RCTCornerInsets) {
    {
...
static void ABI16_0_0RCTPathAddEllipticArc(CGMutablePathRef path,
                                       ...
                                       const CGAffineTransform *transform)
{
  ...
  ABI16_0_0RCTPathAddEllipticArc(path, transform, (CGPoint){
...
static void ABI16_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds,
                                               CGPoint lineStart,
                                               CGPoint lineEnd,
...
NS_INLINE BOOL ABI16_0_0RCTCornerRadiiAreAboveThreshold(ABI16_0_0RCTCornerRadii cornerRadii) {
  return (cornerRadii.topLeft > ABI16_0_0RCTViewBorderThreshold ||
    cornerRadii.topRight > ABI16_0_0RCTViewBorderThreshold      ||
    cornerRadii.bottomLeft > ABI16_0_0RCTViewBorderThreshold    ||
    cornerRadii.bottomRight > ABI16_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI16_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI16_0_0RCTCornerRadii cornerRadii) {
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI16_0_0RCTPathCreateWithRoundedRect(rect, ABI16_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef ABI16_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge) {
...
static UIImage *ABI16_0_0RCTGetSolidBorderImage(ABI16_0_0RCTCornerRadii cornerRadii,
                                       CGSize viewSize,
                                       ...
                                       BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI16_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI16_0_0RCTCornerInsets cornerInsets = ABI16_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  CGContextRef ctx = ABI16_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI16_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI16_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI16_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI16_0_0RCTEllipseGetIntersectionsWithLine((CGRect){
...
static UIImage *ABI16_0_0RCTGetDashedOrDottedBorderImage(ABI16_0_0RCTBorderStyle borderStyle,
                                                ...
                                                BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI16_0_0RCTBorderStyleDashed || borderStyle == ABI16_0_0RCTBorderStyleDotted);

  if (!ABI16_0_0RCTBorderColorsAreEqual(borderColors) || !ABI16_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI16_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI16_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI16_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI16_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI16_0_0RCTPathCreateWithRoundedRect(pathRect, ABI16_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI16_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
                           ...
                           BOOL drawToEdge)
{
  ...
  switch (borderStyle) {
    case ABI16_0_0RCTBorderStyleSolid:
      return ABI16_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI16_0_0RCTBorderStyleDashed:
    case ABI16_0_0RCTBorderStyleDotted:
      return ABI16_0_0RCTGetDashedOrDottedBorderImage(borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI16_0_0RCTBorderStyleUnset:
      break;
  }
