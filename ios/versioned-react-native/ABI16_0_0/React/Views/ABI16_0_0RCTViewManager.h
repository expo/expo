...
@class ABI16_0_0RCTUIManager;

typedef void (^ABI16_0_0RCTViewManagerUIBlock)(ABI16_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry);

@interface ABI16_0_0RCTViewManager : NSObject <ABI16_0_0RCTBridgeModule>

/**
 * The bridge can be used to access both the ABI16_0_0RCTUIIManager and the ABI16_0_0RCTEventDispatcher,
 ...
 * an ordinary ABI16_0_0RCTShadowView instance will be created, which is typically fine for
...
/**
 * DEPRECATED: declare properties of type ABI16_0_0RCTBubblingEventBlock instead
 *
 ...
 */
- (NSArray<NSString *> *)customBubblingEventTypes __deprecated_msg("Use ABI16_0_0RCTBubblingEventBlock props instead.");
 ...
 */
#define ABI16_0_0RCT_CUSTOM_VIEW_PROPERTY(name, type, viewClass) \
ABI16_0_0RCT_REMAP_VIEW_PROPERTY(name, __custom__, type)         \
- (void)set_##name:(id)json forView:(viewClass *)view withDefaultView:(viewClass *)defaultView

/**
 * This macro is used to map properties to the shadow view, instead of the view.
 */
#define ABI16_0_0RCT_EXPORT_SHADOW_PROPERTY(name, type) \
 ...
 */
#define ABI16_0_0RCT_REMAP_SHADOW_PROPERTY(name, keyPath, type) \
 ...
 */
#define ABI16_0_0RCT_CUSTOM_SHADOW_PROPERTY(name, type, viewClass) \
ABI16_0_0RCT_REMAP_SHADOW_PROPERTY(name, __custom__, type)         \
