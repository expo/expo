...
#import "ABI16_0_0RCTViewControllerProtocol.h"
#import "ABI16_0_0RCTWrapperViewController.h"
#import "UIView+ReactABI16_0_0.h"

@interface ABI16_0_0RCTTabBar() <UITabBarControllerDelegate>

@end

@implementation ABI16_0_0RCTTabBar
{
  BOOL _tabsChanged;
...
- (void)insertReactABI16_0_0Subview:(ABI16_0_0RCTTabBarItem *)subview atIndex:(NSInteger)atIndex
{
  if (![subview isKindOfClass:[ABI16_0_0RCTTabBarItem class]]) {
    ABI16_0_0RCTLogError(@"subview should be of type ABI16_0_0RCTTabBarItem");
    return;
  }
...
- (void)removeReactABI16_0_0Subview:(ABI16_0_0RCTTabBarItem *)subview
{
  if (self.ReactABI16_0_0Subviews.count == 0) {
    ABI16_0_0RCTLogError(@"should have at least one view to remove a subview");
    return;
  }
...
- (void)layoutSubviews
{
  ...
  [self ReactABI16_0_0AddControllerToClosestParent:_tabController];
...
- (void)ReactABI16_0_0BridgeDidFinishTransaction
{
  ...
  if (_tabsChanged) {
    ...
    for (ABI16_0_0RCTTabBarItem *tab in [self ReactABI16_0_0Subviews]) {
      UIViewController *controller = tab.ReactABI16_0_0ViewController;
      if (!controller) {
        controller = [[ABI16_0_0RCTWrapperViewController alloc] initWithContentView:tab];
      }
  ...
  [self.ReactABI16_0_0Subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger index, __unused BOOL *stop) {

    ABI16_0_0RCTTabBarItem *tab = (ABI16_0_0RCTTabBarItem *)view;
...
- (BOOL)tabBarController:(UITabBarController *)tabBarController shouldSelectViewController:(UIViewController *)viewController
{
  ...
  ABI16_0_0RCTTabBarItem *tab = (ABI16_0_0RCTTabBarItem *)self.ReactABI16_0_0Subviews[index];
