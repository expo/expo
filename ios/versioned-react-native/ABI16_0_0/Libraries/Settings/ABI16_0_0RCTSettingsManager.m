...
#import "ABI16_0_0RCTSettingsManager.h"
...
@implementation ABI16_0_0RCTSettingsManager
{
...
{
  return @{@"settings": ABI16_0_0RCTJSONClean([_defaults dictionaryRepresentation])};
}
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
  [_bridge.eventDispatcher
   ...
   body:ABI16_0_0RCTJSONClean([_defaults dictionaryRepresentation])];
 ...
 */
ABI16_0_0RCT_EXPORT_METHOD(setValues:(NSDictionary *)values)
{
  _ignoringUpdates = YES;
  [values enumerateKeysAndObjectsUsingBlock:^(NSString *key, id json, BOOL *stop) {
    id plist = [ABI16_0_0RCTConvert NSPropertyList:json];
    if (plist) {
 ...
 */
ABI16_0_0RCT_EXPORT_METHOD(deleteValues:(NSArray<NSString *> *)keys)
{
  _ignoringUpdates = YES;
