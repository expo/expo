...
#import "ABI16_0_0RCTGIFImageDecoder.h"
...
@implementation ABI16_0_0RCTGIFImageDecoder
...
- (ABI16_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                 ...
                                 completionHandler:(ABI16_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (imageCount > 1) {
    ...
    image.ReactABI16_0_0KeyframeAnimation = animation;
