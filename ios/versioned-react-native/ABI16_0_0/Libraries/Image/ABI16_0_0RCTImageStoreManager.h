...
@interface ABI16_0_0RCTImageStoreManager : NSObject <ABI16_0_0RCTURLRequestHandler>
...
@interface ABI16_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI16_0_0RCTBridge (ABI16_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI16_0_0RCTImageStoreManager *imageStoreManager;
