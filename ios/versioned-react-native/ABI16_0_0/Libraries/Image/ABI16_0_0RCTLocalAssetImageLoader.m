...
#import "ABI16_0_0RCTLocalAssetImageLoader.h"

#import <libkern/OSAtomic.h>

#import <ReactABI16_0_0/ABI16_0_0RCTUtils.h>

@implementation ABI16_0_0RCTLocalAssetImageLoader

ABI16_0_0RCT_EXPORT_MODULE()

- (BOOL)canLoadImageURL:(NSURL *)requestURL
{
  return ABI16_0_0RCTIsLocalAssetURL(requestURL);
}
                                  ...
                                  completionHandler:(ABI16_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  ABI16_0_0RCTExecuteOnMainQueue(^{
    ...
    NSString *imageName = ABI16_0_0RCTBundlePathForURL(imageURL);
    ...
    if (image) {
      ...
      ABI16_0_0RCTLogWarn(@"%@", message);
      completionHandler(ABI16_0_0RCTErrorWithMessage(message), nil);
    }
  });
