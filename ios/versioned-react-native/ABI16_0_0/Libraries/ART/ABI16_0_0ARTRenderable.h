...
@interface ABI16_0_0ARTRenderable : ABI16_0_0ARTNode

@property (nonatomic, strong) ABI16_0_0ARTBrush *fill;
...
@property (nonatomic, assign) ABI16_0_0ARTCGFloatArray strokeDash;
