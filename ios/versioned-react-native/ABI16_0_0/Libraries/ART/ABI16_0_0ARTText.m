...
@implementation ABI16_0_0ARTText
...
static void ABI16_0_0ARTFreeTextFrame(ABI16_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI16_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI16_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI16_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI16_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
