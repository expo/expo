...
#import "ABI16_0_0ARTLinearGradient.h"
#import "ABI16_0_0ARTPattern.h"
#import "ABI16_0_0ARTRadialGradient.h"
#import "ABI16_0_0ARTSolidColor.h"

@implementation ABI16_0_0RCTConvert (ABI16_0_0ART)
...
// This prepares everything for rendering a frame of text in ABI16_0_0ARTText.
+ (ABI16_0_0ARTTextFrame)ABI16_0_0ARTTextFrame:(id)json
{
  NSDictionary *dict = [self NSDictionary:json];
  ABI16_0_0ARTTextFrame frame;
  frame.count = 0;
  ...
  frame.lineHeight = size * 1.1; // Base on ABI16_0_0ART canvas line height estimate
...
+ (ABI16_0_0ARTCGFloatArray)ABI16_0_0ARTCGFloatArray:(id)json
{
  ...
  ABI16_0_0ARTCGFloatArray array;
  array.count = count;
  array.array = NULL;
...
+ (ABI16_0_0ARTBrush *)ABI16_0_0ARTBrush:(id)json
{
  ...
  switch (type) {
    case 0: // solid color
      ...
      return [[ABI16_0_0ARTSolidColor alloc] initWithArray:arr];
    case 1: // linear gradient
      return [[ABI16_0_0ARTLinearGradient alloc] initWithArray:arr];
    case 2: // radial gradient
      return [[ABI16_0_0ARTRadialGradient alloc] initWithArray:arr];
    case 3: // pattern
      return [[ABI16_0_0ARTPattern alloc] initWithArray:arr];
    default:
...
+ (CGPoint)CGPoint:(id)json offset:(NSUInteger)offset
{
  ...
  if (arr.count < offset + 2) {
    ABI16_0_0RCTLogError(@"Too few elements in array (expected at least %zd): %@", 2 + offset, arr);
    return CGPointZero;
  }
  return (CGPoint){
...
+ (CGGradientRef)CGGradient:(id)json offset:(NSUInteger)offset
{
  ...
  ABI16_0_0ARTCGFloatArray colorsAndOffsets = [self ABI16_0_0ARTCGFloatArray:arr];
