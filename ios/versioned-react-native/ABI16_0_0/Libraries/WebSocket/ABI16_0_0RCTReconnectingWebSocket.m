...
@interface ABI16_0_0RCTReconnectingWebSocket () <ABI16_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI16_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  __weak ABI16_0_0RCTSRWebSocket *socket = _socket;
