...
#import "ABI16_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI16_0_0/ABI16_0_0RCTConvert.h>
#import <ReactABI16_0_0/ABI16_0_0RCTImageStoreManager.h>
#import <ReactABI16_0_0/ABI16_0_0RCTRootView.h>
#import <ReactABI16_0_0/ABI16_0_0RCTUtils.h>

@interface ABI16_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI16_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI16_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI16_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI16_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI16_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI16_0_0RCTResponseSenderBlock)callback)
{
...
ABI16_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI16_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI16_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI16_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI16_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI16_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI16_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI16_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI16_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI16_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI16_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI16_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI16_0_0RCTNullIfNil(height), ABI16_0_0RCTNullIfNil(width)]];
    return;
  }
        ...
        cancelCallback:(ABI16_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI16_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI16_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI16_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
