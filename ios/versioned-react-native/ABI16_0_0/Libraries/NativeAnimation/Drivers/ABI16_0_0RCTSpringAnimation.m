...
@implementation ABI16_0_0RCTSpringAnimation
{
  ...
  ABI16_0_0RCTResponseSenderBlock _callback;
...
- (instancetype)initWithId:(NSNumber *)animationId
                   ...
                   forNode:(ABI16_0_0RCTValueAnimatedNode *)valueNode
                  callBack:(nullable ABI16_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    _animationId = animationId;
    _toValue = [ABI16_0_0RCTConvert CGFloat:config[@"toValue"]];
    _fromValue = valueNode.value;
    _valueNode = valueNode;
    _overshootClamping = [ABI16_0_0RCTConvert BOOL:config[@"overshootClamping"]];
    _restDisplacementThreshold = [ABI16_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
    _restSpeedThreshold = [ABI16_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
    _tension = [ABI16_0_0RCTConvert CGFloat:config[@"tension"]];
    _friction = [ABI16_0_0RCTConvert CGFloat:config[@"friction"]];
    _initialVelocity = [ABI16_0_0RCTConvert CGFloat:config[@"initialVelocity"]];
