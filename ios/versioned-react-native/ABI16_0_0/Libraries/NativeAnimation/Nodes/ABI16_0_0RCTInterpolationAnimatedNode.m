...
@implementation ABI16_0_0RCTInterpolationAnimatedNode
{
  __weak ABI16_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI16_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI16_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI16_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI16_0_0RCTInterpolateValue(inputValue,
