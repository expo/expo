...
@implementation ABI16_0_0RCTDiffClampAnimatedNode
{
...
- (void)onAttachedToNode:(ABI16_0_0RCTAnimatedNode *)parent
{
...
{
  ABI16_0_0RCTValueAnimatedNode *inputNode = (ABI16_0_0RCTValueAnimatedNode *)self.parentNodes[_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI16_0_0RCTValueAnimatedNode class]]) {
    ABI16_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
