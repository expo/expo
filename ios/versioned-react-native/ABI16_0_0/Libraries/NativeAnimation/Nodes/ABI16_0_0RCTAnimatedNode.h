...
@interface ABI16_0_0RCTAnimatedNode : NSObject
...
@property (nonatomic, copy, readonly) NSDictionary<NSNumber *, ABI16_0_0RCTAnimatedNode *> *childNodes;
@property (nonatomic, copy, readonly) NSDictionary<NSNumber *, ABI16_0_0RCTAnimatedNode *> *parentNodes;
...
- (void)addChild:(ABI16_0_0RCTAnimatedNode *)child NS_REQUIRES_SUPER;
- (void)removeChild:(ABI16_0_0RCTAnimatedNode *)child NS_REQUIRES_SUPER;

- (void)onAttachedToNode:(ABI16_0_0RCTAnimatedNode *)parent NS_REQUIRES_SUPER;
- (void)onDetachedFromNode:(ABI16_0_0RCTAnimatedNode *)parent NS_REQUIRES_SUPER;
