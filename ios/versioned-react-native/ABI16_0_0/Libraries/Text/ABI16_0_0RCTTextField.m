...
#import "ABI16_0_0RCTTextSelection.h"

@interface ABI16_0_0RCTTextField()
...
@interface ABI16_0_0RCTTextFieldDelegateProxy: NSObject <UITextFieldDelegate>
@end

@implementation ABI16_0_0RCTTextFieldDelegateProxy

- (BOOL)textField:(ABI16_0_0RCTTextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string
{
  return [textField shouldChangeCharactersInRange:range replacementString:string];
}

- (BOOL)keyboardInputShouldDelete:(ABI16_0_0RCTTextField *)textField
{
  return [textField keyboardInputShouldDelete];
}

- (BOOL)textFieldShouldEndEditing:(ABI16_0_0RCTTextField *)textField {
  return [textField textFieldShouldEndEditing];
}

@end

@implementation ABI16_0_0RCTTextField
{
  ...
  BOOL _textWasPasted;
  NSString *_finalText;
  ABI16_0_0RCTTextFieldDelegateProxy *_delegateProxy;
}

- (instancetype)initWithEventDispatcher:(ABI16_0_0RCTEventDispatcher *)eventDispatcher
{
  if ((self = [super initWithFrame:CGRectZero])) {
    ABI16_0_0RCTAssert(eventDispatcher, @"eventDispatcher is a required parameter");
    ...
    _delegateProxy = [ABI16_0_0RCTTextFieldDelegateProxy new];
...
{
  [_eventDispatcher sendTextEventWithType:ABI16_0_0RCTTextEventTypeKeyPress
...
- (void)setSelection:(ABI16_0_0RCTTextSelection *)selection
{
  if (!selection) {
    return;
  }
  ...
  } else if (eventLag > ABI16_0_0RCTTextUpdateLagWarningThreshold) {
    ABI16_0_0RCTLogWarn(@"Native TextInput(%@) is %zd events ahead of JS - try to make your JS faster.", self.text, eventLag);
  }
}
...
static void ABI16_0_0RCTUpdatePlaceholder(ABI16_0_0RCTTextField *self)
{
...
- (void)setPlaceholderTextColor:(UIColor *)placeholderTextColor
{
  ...
  ABI16_0_0RCTUpdatePlaceholder(self);
}
...
{
  _nativeEventCount++;
  [_eventDispatcher sendTextEventWithType:ABI16_0_0RCTTextEventTypeChange
                                 ReactABI16_0_0Tag:self.ReactABI16_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (void)textFieldEndEditing
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI16_0_0RCTTextEventTypeEnd
                                 ReactABI16_0_0Tag:self.ReactABI16_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
{
  _submitted = YES;
  [_eventDispatcher sendTextEventWithType:ABI16_0_0RCTTextEventTypeSubmit
                                 ReactABI16_0_0Tag:self.ReactABI16_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
{
  [_eventDispatcher sendTextEventWithType:ABI16_0_0RCTTextEventTypeFocus
                                 ReactABI16_0_0Tag:self.ReactABI16_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (void)observeValueForKeyPath:(NSString *)keyPath
                      ofObject:(ABI16_0_0RCTTextField *)textField
...
- (BOOL)resignFirstResponder
{
  ...
  if (result)
  {
    [_eventDispatcher sendTextEventWithType:ABI16_0_0RCTTextEventTypeBlur
                                   ReactABI16_0_0Tag:self.ReactABI16_0_0Tag
                                       text:self.text
                                        key:nil
                                 eventCount:_nativeEventCount];
