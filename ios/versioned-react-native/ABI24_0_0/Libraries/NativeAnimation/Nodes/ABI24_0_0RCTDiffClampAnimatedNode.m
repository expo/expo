...
@implementation ABI24_0_0RCTDiffClampAnimatedNode
{
...
{
  ABI24_0_0RCTValueAnimatedNode *inputNode = (ABI24_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI24_0_0RCTValueAnimatedNode class]]) {
    ABI24_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
