...
@implementation ABI24_0_0RCTStyleAnimatedNode
{
...
- (void)performUpdate
{
  ...
  [style enumerateKeysAndObjectsUsingBlock:^(NSString *property, NSNumber *nodeTag, __unused BOOL *stop) {
    ...
    if (node) {
      ...
      } else if ([node isKindOfClass:[ABI24_0_0RCTTransformAnimatedNode class]]) {
        ABI24_0_0RCTTransformAnimatedNode *parentNode = (ABI24_0_0RCTTransformAnimatedNode *)node;
