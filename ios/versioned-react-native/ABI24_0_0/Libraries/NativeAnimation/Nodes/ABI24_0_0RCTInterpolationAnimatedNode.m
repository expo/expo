...
@implementation ABI24_0_0RCTInterpolationAnimatedNode
{
  __weak ABI24_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI24_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI24_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI24_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI24_0_0RCTInterpolateValueInRange(inputValue,
                                          _inputRange,
                                          _outputRange,
                                          _extrapolateLeft,
                                          _extrapolateRight);
