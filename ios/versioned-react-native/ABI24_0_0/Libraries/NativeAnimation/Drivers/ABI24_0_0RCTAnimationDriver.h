...
static CGFloat ABI24_0_0RCTSingleFrameInterval = 1.0 / 60.0;

@class ABI24_0_0RCTValueAnimatedNode;

NS_ASSUME_NONNULL_BEGIN

@protocol ABI24_0_0RCTAnimationDriver <NSObject>

@property (nonatomic, readonly) NSNumber *animationId;
@property (nonatomic, readonly) ABI24_0_0RCTValueAnimatedNode *valueNode;
