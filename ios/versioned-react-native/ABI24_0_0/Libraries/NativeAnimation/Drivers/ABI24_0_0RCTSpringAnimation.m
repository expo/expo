...
@interface ABI24_0_0RCTSpringAnimation ()
...
@implementation ABI24_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
                  ...
                  callBack:(nullable ABI24_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _toValue = [ABI24_0_0RCTConvert CGFloat:config[@"toValue"]];
    _fromValue = valueNode.value;
    _lastPosition = 0;
    _valueNode = valueNode;
    _overshootClamping = [ABI24_0_0RCTConvert BOOL:config[@"overshootClamping"]];
    _restDisplacementThreshold = [ABI24_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
    _restSpeedThreshold = [ABI24_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
    _stiffness = [ABI24_0_0RCTConvert CGFloat:config[@"stiffness"]];
    _damping = [ABI24_0_0RCTConvert CGFloat:config[@"damping"]];
    _mass = [ABI24_0_0RCTConvert CGFloat:config[@"mass"]];
