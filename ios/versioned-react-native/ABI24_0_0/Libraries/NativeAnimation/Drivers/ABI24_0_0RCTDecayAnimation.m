...
#import "ABI24_0_0RCTDecayAnimation.h"
...
@interface ABI24_0_0RCTDecayAnimation ()
...
@implementation ABI24_0_0RCTDecayAnimation
{
  CGFloat _velocity;
                  ...
                  callBack:(nullable ABI24_0_0RCTResponseSenderBlock)callback;
{
  if ((self = [super init])) {
    ...
    _velocity = [ABI24_0_0RCTConvert CGFloat:config[@"velocity"]];
    _deceleration = [ABI24_0_0RCTConvert CGFloat:config[@"deceleration"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  if (_frameStartTime == -1) {
    ...
    _frameStartTime = currentTime - ABI24_0_0RCTSingleFrameInterval;
