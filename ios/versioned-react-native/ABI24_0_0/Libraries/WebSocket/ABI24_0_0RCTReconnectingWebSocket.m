...
#import "ABI24_0_0RCTReconnectingWebSocket.h"
...
@interface ABI24_0_0RCTReconnectingWebSocket () <ABI24_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI24_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  __weak ABI24_0_0RCTSRWebSocket *socket = _socket;
