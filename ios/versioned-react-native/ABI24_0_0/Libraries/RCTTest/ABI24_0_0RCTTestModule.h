...
typedef NS_ENUM(NSInteger, ABI24_0_0RCTTestStatus) {
  ABI24_0_0RCTTestStatusPending = 0,
  ABI24_0_0RCTTestStatusPassed,
  ABI24_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI24_0_0RCTTestModule : NSObject <ABI24_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI24_0_0RCTTestStatus status;
