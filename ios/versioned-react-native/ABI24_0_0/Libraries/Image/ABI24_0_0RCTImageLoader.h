...
typedef void (^ABI24_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI24_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI24_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI24_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI24_0_0RCTImageCache <NSObject>
...
@interface UIImage (ReactABI24_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI24_0_0KeyframeAnimation;

@end

@interface ABI24_0_0RCTImageLoader : NSObject <ABI24_0_0RCTBridgeModule, ABI24_0_0RCTURLRequestHandler>
 ...
 */
- (ABI24_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                           clipped:(BOOL)clipped
                                        resizeMode:(ABI24_0_0RCTResizeMode)resizeMode
 ...
 * decoded images as long as it conforms to the ABI24_0_0RCTImageCacheDelegate
...
@interface ABI24_0_0RCTBridge (ABI24_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI24_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI24_0_0RCTImageURLLoader <ABI24_0_0RCTBridgeModule>
...
/**
 * If more than one ABI24_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI24_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 */
@protocol ABI24_0_0RCTImageDataDecoder <ABI24_0_0RCTBridgeModule>
...
/**
 * If more than one ABI24_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
