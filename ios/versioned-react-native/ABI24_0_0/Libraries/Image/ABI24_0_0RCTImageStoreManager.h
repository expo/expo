...
@interface ABI24_0_0RCTImageStoreManager : NSObject <ABI24_0_0RCTURLRequestHandler>
...
@interface ABI24_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI24_0_0RCTBridge (ABI24_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI24_0_0RCTImageStoreManager *imageStoreManager;
