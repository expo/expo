...
#import "ABI24_0_0RCTLocalAssetImageLoader.h"

#import <stdatomic.h>

#import <ReactABI24_0_0/ABI24_0_0RCTUtils.h>

@implementation ABI24_0_0RCTLocalAssetImageLoader

ABI24_0_0RCT_EXPORT_MODULE()

- (BOOL)canLoadImageURL:(NSURL *)requestURL
{
  return ABI24_0_0RCTIsLocalAssetURL(requestURL);
}
                                  ...
                                  completionHandler:(ABI24_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  ABI24_0_0RCTExecuteOnMainQueue(^{
    ...
    UIImage *image = ABI24_0_0RCTImageFromLocalAssetURL(imageURL);
    if (image) {
      if (progressHandler) {
        progressHandler(1, 1);
      }
      ...
      ABI24_0_0RCTLogWarn(@"%@", message);
      completionHandler(ABI24_0_0RCTErrorWithMessage(message), nil);
    }
  });
