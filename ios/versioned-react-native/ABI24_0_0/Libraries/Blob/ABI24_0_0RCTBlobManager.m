...
#import "ABI24_0_0RCTBlobManager.h"

#import <ReactABI24_0_0/ABI24_0_0RCTConvert.h>
#import <ReactABI24_0_0/ABI24_0_0RCTWebSocketModule.h>

static NSString *const kBlobUriScheme = @"blob";

@interface _ABI24_0_0RCTBlobContentHandler : NSObject <ABI24_0_0RCTWebSocketContentHandler>

- (instancetype)initWithBlobManager:(ABI24_0_0RCTBlobManager *)blobManager;

@end


@implementation ABI24_0_0RCTBlobManager
{
  NSMutableDictionary<NSString *, NSData *> *_blobs;
  _ABI24_0_0RCTBlobContentHandler *_contentHandler;
  NSOperationQueue *_queue;
}

ABI24_0_0RCT_EXPORT_MODULE(BlobModule)
...
{
  NSString *blobId = [ABI24_0_0RCTConvert NSString:blob[@"blobId"]];
  NSNumber *offset = [ABI24_0_0RCTConvert NSNumber:blob[@"offset"]];
  NSNumber *size = [ABI24_0_0RCTConvert NSNumber:blob[@"size"]];
...
ABI24_0_0RCT_EXPORT_METHOD(enableBlobSupport:(nonnull NSNumber *)socketID)
{
  if (!_contentHandler) {
    _contentHandler = [[_ABI24_0_0RCTBlobContentHandler alloc] initWithBlobManager:self];
  }
  [[_bridge webSocketModule] setContentHandler:_contentHandler forSocketID:socketID];
}

ABI24_0_0RCT_EXPORT_METHOD(disableBlobSupport:(nonnull NSNumber *)socketID)
{
  [[_bridge webSocketModule] setContentHandler:nil forSocketID:socketID];
}

ABI24_0_0RCT_EXPORT_METHOD(sendBlob:(NSDictionary *)blob socketID:(nonnull NSNumber *)socketID)
{
  [[_bridge webSocketModule] sendData:[self resolve:blob] forSocketID:socketID];
}

ABI24_0_0RCT_EXPORT_METHOD(createFromParts:(NSArray<NSDictionary<NSString *, id> *> *)parts withId:(NSString *)blobId)
{
...
ABI24_0_0RCT_EXPORT_METHOD(release:(NSString *)blobId)
{
  [_blobs removeObjectForKey:blobId];
}

#pragma mark - ABI24_0_0RCTURLRequestHandler methods
...
@implementation _ABI24_0_0RCTBlobContentHandler {
  __weak ABI24_0_0RCTBlobManager *_blobManager;
}
