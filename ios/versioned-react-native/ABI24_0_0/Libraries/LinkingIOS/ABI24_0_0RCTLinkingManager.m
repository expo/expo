...
#import "ABI24_0_0RCTLinkingManager.h"
...
static NSString *const kOpenURLNotification = @"ABI24_0_0RCTOpenURLNotification";
...
@implementation ABI24_0_0RCTLinkingManager
                  ...
                  reject:(__unused ABI24_0_0RCTPromiseRejectBlock)reject)
{
  ...
  BOOL canOpen = [ABI24_0_0RCTSharedApplication() canOpenURL:URL];
  resolve(@(canOpen));
}
                  ...
                  reject:(__unused ABI24_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve(ABI24_0_0RCTNullIfNil(initialURL.absoluteString));
}
