...
#import "ABI24_0_0RCTTextFieldManager.h"
...
#import "ABI24_0_0RCTShadowTextField.h"
#import "ABI24_0_0RCTTextField.h"
#import "ABI24_0_0RCTUITextField.h"

@implementation ABI24_0_0RCTTextFieldManager

ABI24_0_0RCT_EXPORT_MODULE()

- (ABI24_0_0RCTShadowView *)shadowView
{
  return [ABI24_0_0RCTShadowTextField new];
}

- (UIView *)view
{
  return [[ABI24_0_0RCTTextField alloc] initWithBridge:self.bridge];
}
...
ABI24_0_0RCT_REMAP_VIEW_PROPERTY(caretHidden, backedTextInputView.caretHidden, BOOL)
ABI24_0_0RCT_REMAP_VIEW_PROPERTY(clearButtonMode, backedTextInputView.clearButtonMode, UITextFieldViewMode)
