 ...
 */
@interface ABI24_0_0RCTUITextView : UITextView <ABI24_0_0RCTBackedTextInputViewProtocol>

- (instancetype)initWithFrame:(CGRect)frame textContainer:(nullable NSTextContainer *)textContainer NS_UNAVAILABLE;
- (instancetype)initWithCoder:(NSCoder *)aDecoder NS_UNAVAILABLE;

@property (nonatomic, weak) id<ABI24_0_0RCTBackedTextInputDelegate> textInputDelegate;
