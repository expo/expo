...
@interface ABI24_0_0RCTFontAttributes ()
{
  ABI24_0_0RCTAccessibilityManager *_accessibilityManager;
}
...
- (void)updateFont
{
  ...
  self.font = [ABI24_0_0RCTFont updateFont:nil
