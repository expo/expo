...
@protocol ABI24_0_0RCTBackedTextInputDelegate;

@protocol ABI24_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI24_0_0RCTBackedTextInputDelegate> textInputDelegate;
