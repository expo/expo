...
#import "ABI24_0_0RCTBackedTextInputDelegateAdapter.h"
...
@interface ABI24_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI24_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI24_0_0RCTBackedTextInputViewProtocol> *_backedTextInput;
...
@interface ABI24_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI24_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI24_0_0RCTBackedTextInputViewProtocol> *_backedTextInput;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}
