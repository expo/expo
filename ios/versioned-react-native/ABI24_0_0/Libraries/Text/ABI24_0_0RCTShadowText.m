...
NSString *const ABI24_0_0RCTIsHighlightedAttributeName = @"IsHighlightedAttributeName";
NSString *const ABI24_0_0RCTReactABI24_0_0TagAttributeName = @"ReactABI24_0_0TagAttributeName";

static NSString *const kShadowViewAttributeName = @"ABI24_0_0RCTShadowViewAttributeName";
...
@implementation ABI24_0_0RCTShadowText
{
...
static ABI24_0_0YGSize ABI24_0_0RCTMeasure(ABI24_0_0YGNodeRef node, float width, ABI24_0_0YGMeasureMode widthMode, float height, ABI24_0_0YGMeasureMode heightMode)
{
  ABI24_0_0RCTShadowText *shadowText = (__bridge ABI24_0_0RCTShadowText *)ABI24_0_0YGNodeGetContext(node);
  ...
  result.width = ABI24_0_0RCTCeilPixelValue(computedSize.width);
  if (shadowText->_effectiveLetterSpacing < 0) {
    result.width -= shadowText->_effectiveLetterSpacing;
  }
  result.height = ABI24_0_0RCTCeilPixelValue(computedSize.height);
  return result;
}
...
- (instancetype)init
{
  if ((self = [super init])) {
    ...
    ABI24_0_0YGNodeSetMeasureFunc(self.yogaNode, ABI24_0_0RCTMeasure);

    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(contentSizeMultiplierDidChange:)
                                                 name:ABI24_0_0RCTUIManagerWillUpdateViewsDueToContentSizeMultiplierChangeNotification
                                               object:nil];
  }
  return self;
}
...
{
  ABI24_0_0YGNodeMarkDirty(self.yogaNode);
  [self dirtyText];
}
...
{
  if ([[self ReactABI24_0_0Superview] isKindOfClass:[ABI24_0_0RCTShadowText class]]) {
  ...
  NSNumber *parentTag = [[self ReactABI24_0_0Superview] ReactABI24_0_0Tag];
  NSTextStorage *textStorage = [self buildTextStorageForWidth:availableWidth widthMode:ABI24_0_0YGMeasureModeExactly];
  CGRect textFrame = [self calculateTextFrame:textStorage];
  BOOL selectable = _selectable;
  [applierBlocks addObject:^(NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI24_0_0RCTText *view = (ABI24_0_0RCTText *)viewRegistry[self.ReactABI24_0_0Tag];
     ...
     * textStorage (aka attributed string) is copied over from the ABI24_0_0RCTShadowText
     * to the ABI24_0_0RCTText view in time to be used to update the editable text content.
     * TODO: we should establish a delegate relationship betweeen ABI24_0_0RCTTextView
     * and its contaned ABI24_0_0RCTText element when they get inserted and get rid of this
     */
    UIView *parentView = viewRegistry[parentTag];
    if ([parentView respondsToSelector:@selector(performTextUpdate)]) {
      [(ABI24_0_0RCTTextView *)parentView performTextUpdate];
    }
  }];
             ...
             absolutePosition:(CGPoint)absolutePosition
{
  ...
  [layoutManager.textStorage enumerateAttribute:kShadowViewAttributeName inRange:characterRange options:0 usingBlock:^(ABI24_0_0RCTShadowView *child, NSRange range, BOOL *_) {
    if (child) {
      ABI24_0_0YGNodeRef childNode = child.yogaNode;
      float width = ABI24_0_0YGNodeStyleGetWidth(childNode).value;
      float height = ABI24_0_0YGNodeStyleGetHeight(childNode).value;
      if (ABI24_0_0YGFloatIsUndefined(width) || ABI24_0_0YGFloatIsUndefined(height)) {
        ABI24_0_0RCTLogError(@"Views nested within a <Text> must have a width and height");
      }
      UIFont *font = [textStorage attribute:NSFontAttributeName atIndex:range.location effectiveRange:nil];
      CGRect glyphRect = [layoutManager boundingRectForGlyphRange:range inTextContainer:textContainer];
      CGRect childFrame = {{
        ABI24_0_0RCTRoundPixelValue(glyphRect.origin.x),
        ABI24_0_0RCTRoundPixelValue(glyphRect.origin.y + glyphRect.size.height - height + font.descender)
      }, {
        ABI24_0_0RCTRoundPixelValue(width),
        ABI24_0_0RCTRoundPixelValue(height)
      }};
...
- (NSTextStorage *)buildTextStorageForWidth:(CGFloat)width widthMode:(ABI24_0_0YGMeasureMode)widthMode
{
  ...
  textContainer.size = (CGSize){
    widthMode == ABI24_0_0YGMeasureModeUndefined || isnan(width) ? CGFLOAT_MAX : width,
    CGFLOAT_MAX
  };
                                                ...
                                                opacity:(CGFloat)opacity
{
  ...
  UIFont *font = [ABI24_0_0RCTFont updateFont:nil
  ...
  for (ABI24_0_0RCTShadowView *child in [self ReactABI24_0_0Subviews]) {
    if ([child isKindOfClass:[ABI24_0_0RCTShadowText class]]) {
      ABI24_0_0RCTShadowText *shadowText = (ABI24_0_0RCTShadowText *)child;
      ...
      ABI24_0_0RCTShadowRawText *shadowRawText = (ABI24_0_0RCTShadowRawText *)child;
      [attributedString appendAttributedString:[[NSAttributedString alloc] initWithString:shadowRawText.text ?: @""]];
      [child setTextComputed];
    } else {
      float width = ABI24_0_0YGNodeStyleGetWidth(child.yogaNode).value;
      float height = ABI24_0_0YGNodeStyleGetHeight(child.yogaNode).value;
      if (ABI24_0_0YGFloatIsUndefined(width) || ABI24_0_0YGFloatIsUndefined(height)) {
        ABI24_0_0RCTLogError(@"Views nested within a <Text> must have a width and height");
      }
      ...
      // Don't call setTextComputed on this child. ABI24_0_0RCTTextManager takes care of
  ...
  if (_isHighlighted) {
    [self _addAttribute:ABI24_0_0RCTIsHighlightedAttributeName withValue:@YES toAttributedString:attributedString];
  }
  ...
  [self _addAttribute:ABI24_0_0RCTReactABI24_0_0TagAttributeName withValue:self.ReactABI24_0_0Tag toAttributedString:attributedString];
                      ...
                      heightOfTallestSubview:(CGFloat)heightOfTallestSubview
{
  ...
  // Text decoration
  if (_textDecorationLine == ABI24_0_0RCTTextDecorationLineTypeUnderline ||
      _textDecorationLine == ABI24_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    [self _addAttribute:NSUnderlineStyleAttributeName withValue:@(_textDecorationStyle)
     toAttributedString:attributedString];
  }
  if (_textDecorationLine == ABI24_0_0RCTTextDecorationLineTypeStrikethrough ||
      _textDecorationLine == ABI24_0_0RCTTextDecorationLineTypeUnderlineStrikethrough){
...
- (CGRect)updateStorage:(NSTextStorage *)textStorage toFitFrame:(CGRect)frame
{
  ...
  frame.origin.y = self.compoundInsets.top + ABI24_0_0RCTRoundPixelValue((CGRectGetHeight(frame) - requiredSize.height) / 2.0f);
  return frame;
}
                               ...
                               prevMid:(CGFloat)prevMid
{
  ...
  if (round((prevMid / kAutoSizeGranularity)) == round((midScale / kAutoSizeGranularity))) {
    ...
    ABI24_0_0RCTSizeComparison comparison = [self attemptScale:midScale
                                            inStorage:textStorage
                                             forFrame:frame];
    if (comparison == ABI24_0_0RCTSizeWithinRange) {
      return [self calculateSize:textStorage];
    } else if (comparison == ABI24_0_0RCTSizeTooLarge) {
...
- (ABI24_0_0RCTSizeComparison)attemptScale:(CGFloat)scale
                         ...
                         forFrame:(CGRect)frame
{
                        ...
                        usingBlock:^(UIFont *font, NSRange range, BOOL *stop)
   {
     if (font) {
       ...
       if (newFont) {
         ...
         ABI24_0_0RCTLogError(@"Font '%@' doesn't support automatic scaling.", originalFont.familyName);
         *stop = YES;
       }
     }
   }];
  ...
  if (fitLines && fitSize) {
    ...
    {
      return ABI24_0_0RCTSizeWithinRange;
    } else {
      return ABI24_0_0RCTSizeTooSmall;
    }
  } else {
    return ABI24_0_0RCTSizeTooLarge;
  }
}
...
#define ABI24_0_0RCT_TEXT_PROPERTY(setProp, ivar, type) \
...
ABI24_0_0RCT_TEXT_PROPERTY(AdjustsFontSizeToFit, _adjustsFontSizeToFit, BOOL)
ABI24_0_0RCT_TEXT_PROPERTY(Color, _color, UIColor *)
ABI24_0_0RCT_TEXT_PROPERTY(FontFamily, _fontFamily, NSString *)
ABI24_0_0RCT_TEXT_PROPERTY(FontSize, _fontSize, CGFloat)
ABI24_0_0RCT_TEXT_PROPERTY(FontWeight, _fontWeight, NSString *)
ABI24_0_0RCT_TEXT_PROPERTY(FontStyle, _fontStyle, NSString *)
ABI24_0_0RCT_TEXT_PROPERTY(FontVariant, _fontVariant, NSArray *)
ABI24_0_0RCT_TEXT_PROPERTY(IsHighlighted, _isHighlighted, BOOL)
ABI24_0_0RCT_TEXT_PROPERTY(LetterSpacing, _letterSpacing, CGFloat)
ABI24_0_0RCT_TEXT_PROPERTY(LineHeight, _lineHeight, CGFloat)
ABI24_0_0RCT_TEXT_PROPERTY(NumberOfLines, _numberOfLines, NSUInteger)
ABI24_0_0RCT_TEXT_PROPERTY(EllipsizeMode, _ellipsizeMode, NSLineBreakMode)
ABI24_0_0RCT_TEXT_PROPERTY(TextAlign, _textAlign, NSTextAlignment)
ABI24_0_0RCT_TEXT_PROPERTY(TextDecorationColor, _textDecorationColor, UIColor *);
ABI24_0_0RCT_TEXT_PROPERTY(TextDecorationLine, _textDecorationLine, ABI24_0_0RCTTextDecorationLineType);
ABI24_0_0RCT_TEXT_PROPERTY(TextDecorationStyle, _textDecorationStyle, NSUnderlineStyle);
ABI24_0_0RCT_TEXT_PROPERTY(WritingDirection, _writingDirection, NSWritingDirection)
ABI24_0_0RCT_TEXT_PROPERTY(Opacity, _opacity, CGFloat)
ABI24_0_0RCT_TEXT_PROPERTY(TextShadowOffset, _textShadowOffset, CGSize);
ABI24_0_0RCT_TEXT_PROPERTY(TextShadowRadius, _textShadowRadius, CGFloat);
ABI24_0_0RCT_TEXT_PROPERTY(TextShadowColor, _textShadowColor, UIColor *);
...
- (void)setAllowFontScaling:(BOOL)allowFontScaling
{
  ...
  for (ABI24_0_0RCTShadowView *child in [self ReactABI24_0_0Subviews]) {
    if ([child isKindOfClass:[ABI24_0_0RCTShadowText class]]) {
      ((ABI24_0_0RCTShadowText *)child).allowFontScaling = allowFontScaling;
    }
  }
  [self dirtyText];
}
...
- (void)setFontSizeMultiplier:(CGFloat)fontSizeMultiplier
{
  ...
  if (_fontSizeMultiplier == 0) {
    ABI24_0_0RCTLogError(@"fontSizeMultiplier value must be > zero.");
    _fontSizeMultiplier = 1.0;
  }
  for (ABI24_0_0RCTShadowView *child in [self ReactABI24_0_0Subviews]) {
    if ([child isKindOfClass:[ABI24_0_0RCTShadowText class]]) {
      ((ABI24_0_0RCTShadowText *)child).fontSizeMultiplier = fontSizeMultiplier;
    }
  }
  [self dirtyText];
}
