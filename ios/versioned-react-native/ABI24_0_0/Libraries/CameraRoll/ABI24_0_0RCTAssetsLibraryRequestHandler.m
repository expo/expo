...
#import "ABI24_0_0RCTAssetsLibraryRequestHandler.h"
...
@implementation ABI24_0_0RCTAssetsLibraryRequestHandler
{
     ...
     withDelegate:(id<ABI24_0_0RCTURLRequestDelegate>)delegate
{
  ...
  [[self assetsLibrary] assetForURL:request.URL resultBlock:^(ALAsset *asset) {
    ...
    if (asset) {
      ...
      NSError *error = ABI24_0_0RCTErrorWithMessage(errorMessage);
      [delegate URLRequest:cancellationBlock didCompleteWithError:error];
    }
...
@implementation ABI24_0_0RCTBridge (ABI24_0_0RCTAssetsLibraryImageLoader)

- (ALAssetsLibrary *)assetsLibrary
{
  return [[self moduleForClass:[ABI24_0_0RCTAssetsLibraryRequestHandler class]] assetsLibrary];
}
