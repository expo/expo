...
#import "ABI24_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI24_0_0/ABI24_0_0RCTConvert.h>
#import <ReactABI24_0_0/ABI24_0_0RCTImageStoreManager.h>
#import <ReactABI24_0_0/ABI24_0_0RCTRootView.h>
#import <ReactABI24_0_0/ABI24_0_0RCTUtils.h>

@interface ABI24_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI24_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI24_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI24_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI24_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI24_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI24_0_0RCTResponseSenderBlock)callback)
{
...
ABI24_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI24_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI24_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI24_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI24_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI24_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI24_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI24_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI24_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI24_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI24_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI24_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI24_0_0RCTNullIfNil(height), ABI24_0_0RCTNullIfNil(width)]];
    return;
  }
        ...
        cancelCallback:(ABI24_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI24_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI24_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI24_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
