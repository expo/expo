...
#import "ABI24_0_0ARTRenderable.h"

@implementation ABI24_0_0ARTRenderable

- (void)setFill:(ABI24_0_0ARTBrush *)fill
{
  [self invalidate];
  _fill = fill;
}
...
- (void)setStrokeDash:(ABI24_0_0ARTCGFloatArray)strokeDash
{
