...
@implementation ABI24_0_0ARTText
...
static void ABI24_0_0ARTFreeTextFrame(ABI24_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI24_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI24_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI24_0_0ARTTextFrame frame = self.textFrame;
