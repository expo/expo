...
#import "ABI24_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI24_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI24_0_0ViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI24_0_0ViewController detachChildViewController:self.contentViewController];
}
