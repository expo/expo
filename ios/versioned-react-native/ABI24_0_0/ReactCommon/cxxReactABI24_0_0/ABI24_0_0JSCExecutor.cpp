...
#include "ABI24_0_0JSBundleType.h"
...
namespace facebook {
  namespace ReactABI24_0_0 {
    ...
    void JSCExecutor::loadApplicationScript(std::unique_ptr<const JSBigString> script, std::string sourceURL) {
      ...
      ReactABI24_0_0Marker::logTaggedMarker(ReactABI24_0_0Marker::RUN_JS_BUNDLE_START, scriptName.c_str());
      ...
      if (auto fileStr = dynamic_cast<const JSBigFileString *>(script.get())) {
        ...
        switch (jsStatus) {
          case JSLoadSourceIsCompiled:
            ...
            ReactABI24_0_0Marker::logMarker(ReactABI24_0_0Marker::CREATE_REACT_CONTEXT_STOP);
            ReactABI24_0_0Marker::logTaggedMarker(ReactABI24_0_0Marker::RUN_JS_BUNDLE_STOP, scriptName.c_str());
            return;
...
#endif
      {
        ...
        JSContextLock lock(m_context);
        {
          ...
          ReactABI24_0_0Marker::logMarker(ReactABI24_0_0Marker::JS_BUNDLE_STRING_CONVERT_START);
          jsScript = adoptString(std::move(script));
          ReactABI24_0_0Marker::logMarker(ReactABI24_0_0Marker::JS_BUNDLE_STRING_CONVERT_STOP);
        }
    ...
    JSValueRef JSCExecutor::nativeRequire(
      ...
      ReactABI24_0_0Marker::logMarker(ReactABI24_0_0Marker::NATIVE_REQUIRE_START);
      loadModule(bundleId, moduleId);
      ReactABI24_0_0Marker::logMarker(ReactABI24_0_0Marker::NATIVE_REQUIRE_STOP);
