...
#include <cxxReactABI24_0_0/ABI24_0_0JSExecutor.h>
...
namespace ReactABI24_0_0Marker {

enum ReactABI24_0_0MarkerId {
...
using LogTaggedMarker = std::function<void(const ReactABI24_0_0MarkerId, const char* tag)>;
extern RN_EXPORT LogTaggedMarker logTaggedMarker;

extern void logMarker(const ReactABI24_0_0MarkerId markerId);
