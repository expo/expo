...
Pod::Spec.new do |s|
  ...
  s.subspec "Core" do |ss|
    ss.dependency             "yogaABI24_0_0", "#{package["version"]}.React"
    ss.source_files         = "React/**/*.{c,h,m,mm,S}"
    ss.exclude_files        = "**/__tests__/*",
                              "IntegrationTests/*",
                              "React/DevSupport/*",
                              "React/Inspector/*",
                              "ReactCommon/ABI24_0_0yoga/*",
                              "React/Cxx*/*",
                              "React/Base/ABI24_0_0RCTBatchedBridge.mm",
                              "React/Executors/*"
    ss.ios.exclude_files    = "React/**/ABI24_0_0RCTTVView.*"
  ...
  s.subspec "BatchedBridge" do |ss|
    ss.dependency             "ReactABI24_0_0/Core"
    ss.dependency             "ReactABI24_0_0/cxxReactABI24_0_0_legacy"
    ss.source_files         = "React/Base/ABI24_0_0RCTBatchedBridge.mm", "React/Executors/*"
  end
  ...
  s.subspec "DevSupport" do |ss|
    ss.dependency             "ReactABI24_0_0/Core"
    ss.dependency             "ReactABI24_0_0/RCTWebSocket"
  ...
  s.subspec "ABI24_0_0jschelpers_legacy" do |ss|
    ss.source_files         = "ReactCommon/ABI24_0_0jschelpers/ABI24_0_0{JavaScriptCore,JSCWrapper,InspectorInterfaces}.{cpp,h}", "ReactCommon/ABI24_0_0jschelpers/ABI24_0_0systemJSCWrapper.cpp"
    ss.private_header_files = "ReactCommon/ABI24_0_0jschelpers/ABI24_0_0{JavaScriptCore,JSCWrapper,InspectorInterfaces}.h"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\"" }
    ss.framework            = "JavaScriptCore"
  end

  s.subspec "cxxReactABI24_0_0_legacy" do |ss|
    ss.dependency             "ReactABI24_0_0/ABI24_0_0jschelpers_legacy"
    ss.source_files         = "ReactCommon/cxxReactABI24_0_0/ABI24_0_0{JSBundleType,oss-compat-util}.{cpp,h}"
    ss.private_header_files = "ReactCommon/cxxReactABI24_0_0/ABI24_0_0{JSBundleType,oss-compat-util}.h"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\"" }
  end
  ...
  s.subspec "ABI24_0_0jschelpers" do |ss|
    ...
    ss.private_header_files = "ReactCommon/ABI24_0_0jschelpers/*.h"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\"" }
    ss.framework            = "JavaScriptCore"
  end

  s.subspec "ABI24_0_0PrivateDatabase" do |ss|
    ss.source_files         = "ReactCommon/ABI24_0_0privatedata/*.{cpp,h}"
    ss.private_header_files = "ReactCommon/ABI24_0_0privatedata/*.h"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\"" }
  end
  ...
  s.subspec "RCTAnimation" do |ss|
    ...
    ss.header_dir           = "ABI24_0_0RCTAnimation"
  end
  ...
  s.subspec "RCTImage" do |ss|
    ss.dependency             "ReactABI24_0_0/Core"
    ss.dependency             "ReactABI24_0_0/RCTNetwork"
  ...
  s.subspec "RCTWebSocket" do |ss|
    ss.dependency             "ReactABI24_0_0/Core"
    ss.dependency             "ReactABI24_0_0/RCTBlob"
    ss.dependency             "ReactABI24_0_0/fishhook"
  ...
  s.subspec "_ignore_me_subspec_for_linting_" do |ss|
    ss.dependency             "ReactABI24_0_0/Core"
    ss.dependency             "ReactABI24_0_0/CxxBridge"
  end
end
