...
NSString *const ABI24_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification = @"ABI24_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification";
...
@interface ABI24_0_0RCTAccessibilityManager ()
...
@implementation ABI24_0_0RCTAccessibilityManager
...
- (instancetype)init
{
  if ((self = [super init])) {
    ...
    self.contentSizeCategory = ABI24_0_0RCTSharedApplication().preferredContentSizeCategory;
...
- (void)invalidateMultiplier
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI24_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification object:self];
}
...
- (CGFloat)multiplierForContentSizeCategory:(NSString *)category
{
  ...
  if (m.doubleValue <= 0.0) {
    ABI24_0_0RCTLogError(@"Can't determinte multiplier for category %@. Using 1.0.", category);
    m = @1.0;
  }
...
ABI24_0_0RCT_EXPORT_METHOD(setAccessibilityContentSizeMultipliers:(NSDictionary *)JSMultipliers)
{
  ...
  for (NSString *__nonnull JSCategory in JSMultipliers) {
    NSNumber *m = [ABI24_0_0RCTConvert NSNumber:JSMultipliers[JSCategory]];
...
ABI24_0_0RCT_EXPORT_METHOD(setAccessibilityFocus:(nonnull NSNumber *)ReactABI24_0_0Tag)
{
...
ABI24_0_0RCT_EXPORT_METHOD(announceForAccessibility:(NSString *)announcement)
{
  UIAccessibilityPostNotification(UIAccessibilityAnnouncementNotification, announcement);
}

ABI24_0_0RCT_EXPORT_METHOD(getMultiplier:(ABI24_0_0RCTResponseSenderBlock)callback)
{
  if (callback) {
...
ABI24_0_0RCT_EXPORT_METHOD(getCurrentVoiceOverState:(ABI24_0_0RCTResponseSenderBlock)callback
                  error:(__unused ABI24_0_0RCTResponseSenderBlock)error)
{
...
@implementation ABI24_0_0RCTBridge (ABI24_0_0RCTAccessibilityManager)

- (ABI24_0_0RCTAccessibilityManager *)accessibilityManager
{
  return [self moduleForClass:[ABI24_0_0RCTAccessibilityManager class]];
}
