...
NSString *const ABI24_0_0RCTTVNavigationEventNotification = @"ABI24_0_0RCTTVNavigationEventNotification";

static NSString *const TVNavigationEventName = @"onTVNavEvent";

@implementation ABI24_0_0RCTTVNavigationEventEmitter
  ...
  if (self = [super init]) {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(handleTVNavigationEventNotification:)
                                                 name:ABI24_0_0RCTTVNavigationEventNotification
                                               object:nil];
