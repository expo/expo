 ...
 */
ABI24_0_0RCT_EXTERN NSString *const ABI24_0_0RCTUIManagerWillUpdateViewsDueToContentSizeMultiplierChangeNotification;

@class ABI24_0_0RCTLayoutAnimationGroup;
@class ABI24_0_0RCTUIManagerObserverCoordinator;

/**
 * The ABI24_0_0RCTUIManager is the module responsible for updating the view hierarchy.
 */
@interface ABI24_0_0RCTUIManager : NSObject <ABI24_0_0RCTBridgeModule, ABI24_0_0RCTInvalidating>

/**
 * Register a root view with the ABI24_0_0RCTUIManager.
 */
- (void)registerRootView:(UIView *)rootView;

/**
 * Gets the view name associated with a ReactABI24_0_0Tag.
 */
- (NSString *)viewNameForReactABI24_0_0Tag:(NSNumber *)ReactABI24_0_0Tag;

/**
 * Gets the view associated with a ReactABI24_0_0Tag.
 */
- (UIView *)viewForReactABI24_0_0Tag:(NSNumber *)ReactABI24_0_0Tag;

/**
 * Gets the shadow view associated with a ReactABI24_0_0Tag.
 */
 ...
 * or some other layout event outside of the ReactABI24_0_0-managed view hierarchy.
 */
...
/**
 * Given a ReactABI24_0_0Tag from a component, find its root view, if possible.
 * Otherwise, this will give back nil.
 *
 * @param ReactABI24_0_0Tag the component tag
 ...
 * @param rootTag the ReactABI24_0_0 tag of root view hierarchy from which to find the view.
 */
 ...
 * ReactABI24_0_0 won't be aware of this, so we need to make sure it happens.
 */
- (void)setNeedsLayout;

/**
 * Dedicated object for subscribing for UIManager events.
 * See `ABI24_0_0RCTUIManagerObserver` protocol for more details.
 */
@property (atomic, retain, readonly) ABI24_0_0RCTUIManagerObserverCoordinator *observerCoordinator;

@end

/**
 * This category makes the current ABI24_0_0RCTUIManager instance available via the
 * ABI24_0_0RCTBridge, which is useful for ABI24_0_0RCTBridgeModules or ABI24_0_0RCTViewManagers that
 * need to access the ABI24_0_0RCTUIManager.
 */
@interface ABI24_0_0RCTBridge (ABI24_0_0RCTUIManager)

@property (nonatomic, readonly) ABI24_0_0RCTUIManager *uiManager;
