...
@protocol ABI24_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI24_0_0RCTExceptionsManager : NSObject <ABI24_0_0RCTBridgeModule>

- (instancetype)initWithDelegate:(id<ABI24_0_0RCTExceptionsManagerDelegate>)delegate;

@property (nonatomic, weak) id<ABI24_0_0RCTExceptionsManagerDelegate> delegate;
