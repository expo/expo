...
class ABI24_0_0RCTObjcExecutor : public JSExecutor {
public:
  ABI24_0_0RCTObjcExecutor(id<ABI24_0_0RCTJavaScriptExecutor> jse,
                  ABI24_0_0RCTJavaScriptCompleteBlock errorBlock,
  ...
  void setBundleRegistry(std::unique_ptr<RAMBundleRegistry>) override {
    ABI24_0_0RCTAssert(NO, @"RAM bundles are not supported in ABI24_0_0RCTObjcExecutor");
  }
...
private:
  ...
  ABI24_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI24_0_0RCTObjcExecutorFactory::ABI24_0_0RCTObjcExecutorFactory(
  id<ABI24_0_0RCTJavaScriptExecutor> jse, ABI24_0_0RCTJavaScriptCompleteBlock errorBlock)
  : m_jse(jse)
  , m_errorBlock(errorBlock) {}

std::unique_ptr<JSExecutor> ABI24_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue) {
  return std::unique_ptr<JSExecutor>(
    new ABI24_0_0RCTObjcExecutor(m_jse, m_errorBlock, jsQueue, delegate));
}
