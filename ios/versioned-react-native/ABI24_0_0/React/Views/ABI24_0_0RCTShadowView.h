...
@class ABI24_0_0RCTSparseArray;

typedef NS_ENUM(NSUInteger, ABI24_0_0RCTUpdateLifecycle) {
  ABI24_0_0RCTUpdateLifecycleUninitialized = 0,
  ABI24_0_0RCTUpdateLifecycleComputed,
  ABI24_0_0RCTUpdateLifecycleDirtied,
};

typedef void (^ABI24_0_0RCTApplierBlock)(NSDictionary<NSNumber *, UIView *> *viewRegistry);

/**
 * ShadowView tree mirrors ABI24_0_0RCT view tree. Every node is highly stateful.
 * 1. A node is in one of three lifecycles: uninitialized, computed, dirtied.
 * 1. ABI24_0_0RCTBridge may call any of the padding/margin/width/height/top/left setters. A setter would dirty
 ...
 */
@interface ABI24_0_0RCTShadowView : NSObject <ABI24_0_0RCTComponent>
 ...
 */
- (NSArray<ABI24_0_0RCTShadowView *> *)ReactABI24_0_0Subviews NS_REQUIRES_SUPER;
- (ABI24_0_0RCTShadowView *)ReactABI24_0_0Superview NS_REQUIRES_SUPER;
- (void)insertReactABI24_0_0Subview:(ABI24_0_0RCTShadowView *)subview atIndex:(NSInteger)atIndex NS_REQUIRES_SUPER;
- (void)removeReactABI24_0_0Subview:(ABI24_0_0RCTShadowView *)subview NS_REQUIRES_SUPER;

@property (nonatomic, weak, readonly) ABI24_0_0RCTRootShadowView *rootView;
@property (nonatomic, weak, readonly) ABI24_0_0RCTShadowView *superview;
@property (nonatomic, assign, readonly) ABI24_0_0YGNodeRef yogaNode;
@property (nonatomic, copy) NSString *viewName;
@property (nonatomic, strong) UIColor *backgroundColor; // Used to propagate to children
@property (nonatomic, copy) ABI24_0_0RCTDirectEventBlock onLayout;
 ...
 * the shadow view.
 * Please respect one-directional data flow of ReactABI24_0_0.
 * Use `-[ABI24_0_0RCTUIManager setLocalData:forView:]` to set this property
 ...
 * set to NO in ABI24_0_0RCTUIManager after the layout pass is done and all frames have been extracted to be applied to the
 * corresponding UIViews.
 */
@property (nonatomic, assign, getter=isNewView) BOOL newView;

/**
 * isHidden - ABI24_0_0RCTUIManager uses this to determine whether or not the UIView should be hidden. Useful if the
 ...
 */
@property (nonatomic, assign) ABI24_0_0YGValue top;
@property (nonatomic, assign) ABI24_0_0YGValue left;
@property (nonatomic, assign) ABI24_0_0YGValue bottom;
@property (nonatomic, assign) ABI24_0_0YGValue right;
@property (nonatomic, assign) ABI24_0_0YGValue start;
@property (nonatomic, assign) ABI24_0_0YGValue end;

@property (nonatomic, assign) ABI24_0_0YGValue width;
@property (nonatomic, assign) ABI24_0_0YGValue height;

@property (nonatomic, assign) ABI24_0_0YGValue minWidth;
@property (nonatomic, assign) ABI24_0_0YGValue maxWidth;
@property (nonatomic, assign) ABI24_0_0YGValue minHeight;
@property (nonatomic, assign) ABI24_0_0YGValue maxHeight;
 ...
 */
@property (nonatomic, assign) ABI24_0_0YGValue margin;
@property (nonatomic, assign) ABI24_0_0YGValue marginVertical;
@property (nonatomic, assign) ABI24_0_0YGValue marginHorizontal;
@property (nonatomic, assign) ABI24_0_0YGValue marginTop;
@property (nonatomic, assign) ABI24_0_0YGValue marginLeft;
@property (nonatomic, assign) ABI24_0_0YGValue marginBottom;
@property (nonatomic, assign) ABI24_0_0YGValue marginRight;
@property (nonatomic, assign) ABI24_0_0YGValue marginStart;
@property (nonatomic, assign) ABI24_0_0YGValue marginEnd;

/**
 * Padding. Defaults to { 0, 0, 0, 0 }.
 */
@property (nonatomic, assign) ABI24_0_0YGValue padding;
@property (nonatomic, assign) ABI24_0_0YGValue paddingVertical;
@property (nonatomic, assign) ABI24_0_0YGValue paddingHorizontal;
@property (nonatomic, assign) ABI24_0_0YGValue paddingTop;
@property (nonatomic, assign) ABI24_0_0YGValue paddingLeft;
@property (nonatomic, assign) ABI24_0_0YGValue paddingBottom;
@property (nonatomic, assign) ABI24_0_0YGValue paddingRight;
@property (nonatomic, assign) ABI24_0_0YGValue paddingStart;
@property (nonatomic, assign) ABI24_0_0YGValue paddingEnd;

/**
 * Flexbox properties. All zero/disabled by default
 */
@property (nonatomic, assign) ABI24_0_0YGFlexDirection flexDirection;
@property (nonatomic, assign) ABI24_0_0YGJustify justifyContent;
@property (nonatomic, assign) ABI24_0_0YGAlign alignSelf;
@property (nonatomic, assign) ABI24_0_0YGAlign alignItems;
@property (nonatomic, assign) ABI24_0_0YGAlign alignContent;
@property (nonatomic, assign) ABI24_0_0YGPositionType position;
@property (nonatomic, assign) ABI24_0_0YGWrap flexWrap;
@property (nonatomic, assign) ABI24_0_0YGDisplay display;

@property (nonatomic, assign) float flex;
@property (nonatomic, assign) float flexGrow;
@property (nonatomic, assign) float flexShrink;
@property (nonatomic, assign) ABI24_0_0YGValue flexBasis;
 ...
 */
@property (nonatomic, assign) ABI24_0_0YGDirection direction;

/**
 * Clipping properties
 */
@property (nonatomic, assign) ABI24_0_0YGOverflow overflow;
 ...
 * The applierBlocks set contains ABI24_0_0RCTApplierBlock functions that must be applied
 ...
 * For example `ABI24_0_0RCTShadowText` has children which it does not want Yoga
...
/**
 * As described in ABI24_0_0RCTComponent protocol.
 */
- (void)didUpdateReactABI24_0_0Subviews NS_REQUIRES_SUPER;
