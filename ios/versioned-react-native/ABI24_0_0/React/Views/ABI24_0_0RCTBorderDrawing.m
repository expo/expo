...
static const CGFloat ABI24_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI24_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return
  ABS(borderInsets.left - borderInsets.right) < ABI24_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.bottom) < ABI24_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.top) < ABI24_0_0RCTViewBorderThreshold;
}

BOOL ABI24_0_0RCTCornerRadiiAreEqual(ABI24_0_0RCTCornerRadii cornerRadii)
{
  return
  ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI24_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI24_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI24_0_0RCTViewBorderThreshold;
}
...
{
  return (ABI24_0_0RCTCornerInsets) {
    {
...
static void ABI24_0_0RCTPathAddEllipticArc(CGMutablePathRef path,
                                       ...
                                       const CGAffineTransform *transform)
{
  ...
  ABI24_0_0RCTPathAddEllipticArc(path, transform, (CGPoint){
...
static void ABI24_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds,
                                               CGPoint lineStart,
                                               CGPoint lineEnd,
...
NS_INLINE BOOL ABI24_0_0RCTCornerRadiiAreAboveThreshold(ABI24_0_0RCTCornerRadii cornerRadii) {
  return (cornerRadii.topLeft > ABI24_0_0RCTViewBorderThreshold ||
    cornerRadii.topRight > ABI24_0_0RCTViewBorderThreshold      ||
    cornerRadii.bottomLeft > ABI24_0_0RCTViewBorderThreshold    ||
    cornerRadii.bottomRight > ABI24_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI24_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI24_0_0RCTCornerRadii cornerRadii) {
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI24_0_0RCTPathCreateWithRoundedRect(rect, ABI24_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef ABI24_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge) {
...
static UIImage *ABI24_0_0RCTGetSolidBorderImage(ABI24_0_0RCTCornerRadii cornerRadii,
                                       CGSize viewSize,
                                       ...
                                       BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI24_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI24_0_0RCTCornerInsets cornerInsets = ABI24_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  CGContextRef ctx = ABI24_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI24_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI24_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI24_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI24_0_0RCTEllipseGetIntersectionsWithLine((CGRect){
...
static UIImage *ABI24_0_0RCTGetDashedOrDottedBorderImage(ABI24_0_0RCTBorderStyle borderStyle,
                                                ...
                                                BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI24_0_0RCTBorderStyleDashed || borderStyle == ABI24_0_0RCTBorderStyleDotted);

  if (!ABI24_0_0RCTBorderColorsAreEqual(borderColors) || !ABI24_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI24_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI24_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI24_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI24_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI24_0_0RCTPathCreateWithRoundedRect(pathRect, ABI24_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI24_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
                           ...
                           BOOL drawToEdge)
{
  ...
  switch (borderStyle) {
    case ABI24_0_0RCTBorderStyleSolid:
      return ABI24_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI24_0_0RCTBorderStyleDashed:
    case ABI24_0_0RCTBorderStyleDotted:
      return ABI24_0_0RCTGetDashedOrDottedBorderImage(borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI24_0_0RCTBorderStyleUnset:
      break;
  }
