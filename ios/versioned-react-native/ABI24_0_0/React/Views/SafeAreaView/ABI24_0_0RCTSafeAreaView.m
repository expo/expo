...
@implementation ABI24_0_0RCTSafeAreaView {
...
- (void)safeAreaInsetsDidChange
{
  ...
  if (UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI24_0_0RCTScreenScale())) {
    return;
  }

  _currentSafeAreaInsets = safeAreaInsets;

  ABI24_0_0RCTSafeAreaViewLocalData *localData =
    [[ABI24_0_0RCTSafeAreaViewLocalData alloc] initWithInsets:safeAreaInsets];
