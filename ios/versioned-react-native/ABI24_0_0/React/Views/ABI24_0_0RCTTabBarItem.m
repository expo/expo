...
@implementation ABI24_0_0RCTConvert (UITabBarSystemItem)

ABI24_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI24_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI24_0_0ViewController;
}
