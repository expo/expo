...
// These constants can only be removed when ReactABI24_0_0 Native drops iOS8 support.
...
typedef CGFloat ABI24_0_0RCTFontWeight;
static ABI24_0_0RCTFontWeight weightOfFont(UIFont *font)
{
  ...
  for (NSInteger i = 0; i < fontNames.count; i++) {
    if ([font.fontName.lowercaseString hasSuffix:fontNames[i]]) {
      return (ABI24_0_0RCTFontWeight)[fontWeights[i] doubleValue];
    }
  }

  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  return (ABI24_0_0RCTFontWeight)[traits[UIFontWeightTrait] doubleValue];
}
...
static UIFont *cachedSystemFont(CGFloat size, ABI24_0_0RCTFontWeight weight)
{
...
@implementation ABI24_0_0RCTConvert (ABI24_0_0RCTFont)

+ (UIFont *)UIFont:(id)json
{
  json = [self NSDictionary:json];
  return [ABI24_0_0RCTFont updateFont:nil
                  withFamily:[ABI24_0_0RCTConvert NSString:json[@"fontFamily"]]
                        size:[ABI24_0_0RCTConvert NSNumber:json[@"fontSize"]]
                      weight:[ABI24_0_0RCTConvert NSString:json[@"fontWeight"]]
                       style:[ABI24_0_0RCTConvert NSString:json[@"fontStyle"]]
                     variant:[ABI24_0_0RCTConvert NSStringArray:json[@"fontVariant"]]
             scaleMultiplier:1];
}

ABI24_0_0RCT_ENUM_CONVERTER(ABI24_0_0RCTFontWeight, (@{
...
typedef BOOL ABI24_0_0RCTFontStyle;
ABI24_0_0RCT_ENUM_CONVERTER(ABI24_0_0RCTFontStyle, (@{
                                    @"normal": @NO,
                                    @"italic": @YES,
                                    @"oblique": @YES,
                                    }), NO, boolValue)

typedef NSDictionary ABI24_0_0RCTFontVariantDescriptor;
+ (ABI24_0_0RCTFontVariantDescriptor *)ABI24_0_0RCTFontVariantDescriptor:(id)json
{
  ...
  ABI24_0_0RCTFontVariantDescriptor *value = mapping[json];
  if (ABI24_0_0RCT_DEBUG && !value && [json description].length > 0) {
    ABI24_0_0RCTLogError(@"Invalid ABI24_0_0RCTFontVariantDescriptor '%@'. should be one of: %@", json,
                [[mapping allKeys] sortedArrayUsingSelector:@selector(caseInsensitiveCompare:)]);
  }
  return value;
}

ABI24_0_0RCT_ARRAY_CONVERTER(ABI24_0_0RCTFontVariantDescriptor)

@end

@implementation ABI24_0_0RCTFont
...
+ (UIFont *)updateFont:(UIFont *)font
            withFamily:(NSString *)family
               ...
               variant:(NSArray<ABI24_0_0RCTFontVariantDescriptor *> *)variant
       scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  const ABI24_0_0RCTFontWeight defaultFontWeight = UIFontWeightRegular;
  const CGFloat defaultFontSize = 14;

  // Initialize properties to defaults
  CGFloat fontSize = defaultFontSize;
  ABI24_0_0RCTFontWeight fontWeight = defaultFontWeight;
  ...
  // Get font attributes
  fontSize = [ABI24_0_0RCTConvert CGFloat:size] ?: fontSize;
  if (scaleMultiplier > 0.0 && scaleMultiplier != 1.0) {
    fontSize = round(fontSize * scaleMultiplier);
  }
  familyName = [ABI24_0_0RCTConvert NSString:family] ?: familyName;
  isItalic = style ? [ABI24_0_0RCTConvert ABI24_0_0RCTFontStyle:style] : isItalic;
  fontWeight = weight ? [ABI24_0_0RCTConvert ABI24_0_0RCTFontWeight:weight] : fontWeight;
  ...
  if (!didFindFont && [UIFont fontNamesForFamilyName:familyName].count == 0) {
    ...
    if (font) {
      ...
      ABI24_0_0RCTLogError(@"Unrecognized font family '%@'", familyName);
      if ([UIFont respondsToSelector:@selector(systemFontOfSize:weight:)]) {
  ...
  if (variant) {
    NSArray *fontFeatures = [ABI24_0_0RCTConvert ABI24_0_0RCTFontVariantDescriptorArray:variant];
