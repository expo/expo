...
@interface ABI24_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI24_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI24_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI24_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI24_0_0RCTMultipartStreamReader *reader = [[ABI24_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI24_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
