...
extern NSString *const ABI24_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI24_0_0RCTBundleURLProviderDefaultPort;

@interface ABI24_0_0RCTBundleURLProvider : NSObject
