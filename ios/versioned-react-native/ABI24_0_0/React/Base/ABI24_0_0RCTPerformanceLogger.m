...
@interface ABI24_0_0RCTPerformanceLogger ()
{
  int64_t _data[ABI24_0_0RCTPLSize][2];
  NSUInteger _cookies[ABI24_0_0RCTPLSize];
}
...
@implementation ABI24_0_0RCTPerformanceLogger
...
- (void)markStartForTag:(ABI24_0_0RCTPLTag)tag
{
  ...
  if (ABI24_0_0RCTProfileIsProfiling()) {
    ...
    _cookies[tag] = ABI24_0_0RCTProfileBeginAsyncEvent(ABI24_0_0RCTProfileTagAlways, label, nil);
  }
#endif
...
- (void)markStopForTag:(ABI24_0_0RCTPLTag)tag
{
  ...
  if (ABI24_0_0RCTProfileIsProfiling()) {
    NSString *label =_labelsForTags[tag];
    ABI24_0_0RCTProfileEndAsyncEvent(ABI24_0_0RCTProfileTagAlways, @"native", _cookies[tag], label, @"ABI24_0_0RCTPerformanceLogger");
  }
#endif
  if (_data[tag][0] != 0 && _data[tag][1] == 0) {
    _data[tag][1] = CACurrentMediaTime() * 1000;
  } else {
    ABI24_0_0RCTLogInfo(@"Unbalanced calls start/end for tag %li", (unsigned long)tag);
  }
}
...
- (NSArray<NSNumber *> *)valuesForTags
{
  ...
  for (NSUInteger index = 0; index < ABI24_0_0RCTPLSize; index++) {
