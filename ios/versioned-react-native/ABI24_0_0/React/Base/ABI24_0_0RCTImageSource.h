 ...
 */
@interface ABI24_0_0RCTImageSource : NSObject
...
@interface ABI24_0_0RCTConvert (ImageSource)

+ (ABI24_0_0RCTImageSource *)ABI24_0_0RCTImageSource:(id)json;
+ (NSArray<ABI24_0_0RCTImageSource *> *)ABI24_0_0RCTImageSourceArray:(id)json;
