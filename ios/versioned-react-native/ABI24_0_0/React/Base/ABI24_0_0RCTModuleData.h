...
typedef id<ABI24_0_0RCTBridgeModule>(^ABI24_0_0RCTBridgeModuleProvider)(void);

@interface ABI24_0_0RCTModuleData : NSObject <ABI24_0_0RCTInvalidating>
...
- (instancetype)initWithModuleClass:(Class)moduleClass
                     moduleProvider:(ABI24_0_0RCTBridgeModuleProvider)moduleProvider
                             bridge:(ABI24_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI24_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI24_0_0RCTBridgeModule> instance;
