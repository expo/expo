...
@class ABI24_0_0RCTPerformanceLogger;

/**
 * This notification fires when the bridge starts loading the JS bundle.
 */
ABI24_0_0RCT_EXTERN NSString *const ABI24_0_0RCTJavaScriptWillStartLoadingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI24_0_0RCT_EXTERN NSString *const ABI24_0_0RCTJavaScriptDidLoadNotification;

/**
 * This notification fires when the bridge failed to load the JS bundle. The
 * `error` key can be used to determine the error that occured.
 */
ABI24_0_0RCT_EXTERN NSString *const ABI24_0_0RCTJavaScriptDidFailToLoadNotification;
 ...
 */
ABI24_0_0RCT_EXTERN NSString *const ABI24_0_0RCTDidInitializeModuleNotification;

/**
 * This notification fires just before the bridge starts processing a request to
 * reload.
 */
ABI24_0_0RCT_EXTERN NSString *const ABI24_0_0RCTBridgeWillReloadNotification;

/**
 * This notification fires just before the bridge begins downloading a script
 * from the packager.
 */
ABI24_0_0RCT_EXTERN NSString *const ABI24_0_0RCTBridgeWillDownloadScriptNotification;

/**
 * This notification fires just after the bridge finishes downloading a script
 * from the packager.
 */
ABI24_0_0RCT_EXTERN NSString *const ABI24_0_0RCTBridgeDidDownloadScriptNotification;

/**
 * Key for the ABI24_0_0RCTSource object in the ABI24_0_0RCTBridgeDidDownloadScriptNotification
 * userInfo dictionary.
 */
ABI24_0_0RCT_EXTERN NSString *const ABI24_0_0RCTBridgeDidDownloadScriptNotificationSourceKey;
 ...
 */
typedef NSArray<id<ABI24_0_0RCTBridgeModule>> *(^ABI24_0_0RCTBridgeModuleListProvider)(void);

/**
 * This function returns the module name for a given class.
 */
ABI24_0_0RCT_EXTERN NSString *ABI24_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI24_0_0RCTBridge : NSObject <ABI24_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI24_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI24_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 * See also -[ABI24_0_0RCTBridgeDelgate shouldBridgeLoadJavaScriptSynchronously], which
 ...
 */
@property (nonatomic, weak, readonly) id<ABI24_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ReactABI24_0_0 Native perf events.
 */
@property (nonatomic, readonly, strong) ABI24_0_0RCTPerformanceLogger *performanceLogger;
