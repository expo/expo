 ...
 * are also bridge modules, so should be registered using ABI24_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI24_0_0RCTURLRequestHandler <ABI24_0_0RCTBridgeModule>
...
/**
 * If more than one ABI24_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
