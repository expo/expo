...
#import <ABI24_0_0jschelpers/ABI24_0_0JSCWrapper.h>
...
@implementation ABI24_0_0RCTInspectorDevServerHelper

ABI24_0_0RCT_NOT_IMPLEMENTED(- (instancetype)init)

static NSMutableDictionary<NSString *, ABI24_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
            ...
            withBundleURL:(NSURL *)bundleURL
{
  ...
  ABI24_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection) {
    connection = [[ABI24_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
