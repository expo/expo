...
@implementation ABI24_0_0RCTSamplingProfilerPackagerMethod {
  __weak id<ABI24_0_0RCTJSEnvironment> _jsEnvironment;
}
...
{
  ABI24_0_0RCTLogError(@"%@ does not implement onNotification", [self class]);
}
