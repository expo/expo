...
#if !TARGET_OS_TV
@implementation ABI24_0_0RCTConvert (ABI24_0_0EXStatusBar)

ABI24_0_0RCT_ENUM_CONVERTER(UIStatusBarStyle, (@{
  @"default": @(UIStatusBarStyleDefault),
  @"light-content": @(UIStatusBarStyleLightContent),
  @"dark-content": @(UIStatusBarStyleDefault),
}), UIStatusBarStyleDefault, integerValue);

ABI24_0_0RCT_ENUM_CONVERTER(UIStatusBarAnimation, (@{
...
@interface ABI24_0_0EXStatusBarManager ()

@property (nonatomic, strong) NSMutableDictionary *capturedStatusBarProperties;

@end

@implementation ABI24_0_0EXStatusBarManager

+ (NSString *)moduleName { return @"ABI24_0_0RCTStatusBarManager"; }
...
ABI24_0_0RCT_EXPORT_METHOD(getHeight:(ABI24_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@{
...
ABI24_0_0RCT_EXPORT_METHOD(setStyle:(UIStatusBarStyle)statusBarStyle
                  animated:(BOOL)animated)
{
  if ([[self class] _viewControllerBasedStatusBarAppearance]) {
    ABI24_0_0RCTLogError(@"ABI24_0_0RCTStatusBarManager module requires that the \
                UIViewControllerBasedStatusBarAppearance key in the Info.plist is set to NO");
  } else {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ABI24_0_0RCTSharedApplication() setStatusBarStyle:statusBarStyle
                                     animated:animated];
...
ABI24_0_0RCT_EXPORT_METHOD(setHidden:(BOOL)hidden
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ABI24_0_0RCTSharedApplication() setStatusBarHidden:hidden
...
ABI24_0_0RCT_EXPORT_METHOD(setNetworkActivityIndicatorVisible:(BOOL)visible)
{
  ABI24_0_0RCTSharedApplication().networkActivityIndicatorVisible = visible;
 ...
 */
ABI24_0_0RCT_REMAP_METHOD(_captureProperties,
                 _capturePropertiesWithResolver:(ABI24_0_0RCTPromiseResolveBlock)resolve
 ...
 *  Normally nobody should use this method because it bypasses the JS state used by the StatusBar component.
 */
ABI24_0_0RCT_EXPORT_METHOD(_applyPropertiesAndForget:(NSDictionary *)properties)
{
...
{
  UIApplication *currentApplication = ABI24_0_0RCTSharedApplication();
  return @{
