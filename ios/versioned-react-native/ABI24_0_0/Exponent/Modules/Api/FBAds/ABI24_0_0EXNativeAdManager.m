...
#import "ABI24_0_0EXNativeAdManager.h"
...
ABI24_0_0RCT_ENUM_CONVERTER(FBNativeAdsCachePolicy, (@{
...
@interface ABI24_0_0EXNativeAdManager () <FBNativeAdsManagerDelegate>

@property (nonatomic, strong) NSMutableDictionary<NSString*, FBNativeAdsManager*> *adsManagers;

@end

@implementation ABI24_0_0EXNativeAdManager

ABI24_0_0RCT_EXPORT_MODULE(CTKNativeAdManager)
...
ABI24_0_0RCT_EXPORT_METHOD(init:(NSString *)placementId withAdsToRequest:(nonnull NSNumber *)adsToRequest)
{
...
ABI24_0_0RCT_EXPORT_METHOD(setMediaCachePolicy:(NSString*)placementId cachePolicy:(FBNativeAdsCachePolicy)cachePolicy)
{
  [_adsManagers[placementId] setMediaCachePolicy:cachePolicy];
}

ABI24_0_0RCT_EXPORT_METHOD(disableAutoRefresh:(NSString*)placementId)
{
...
- (void)nativeAdsLoaded
{
  ...
  ABI24_0_0EXNativeAdEmitter *nativeAdEmitter = [_bridge moduleForClass:[ABI24_0_0EXNativeAdEmitter class]];
...
- (UIView *)view
{
  return [ABI24_0_0EXNativeAdView new];
}

ABI24_0_0RCT_EXPORT_VIEW_PROPERTY(onAdLoaded, ABI24_0_0RCTBubblingEventBlock)
ABI24_0_0RCT_CUSTOM_VIEW_PROPERTY(adsManager, NSString, ABI24_0_0EXNativeAdView)
{
