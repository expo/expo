...
- (NSDictionary *)startARSessionWithGLView:(ABI24_0_0EXGLView *)glView
{
  ...
  // Create camera texture output ABI24_0_0EXGLObject
...
- (NSDictionary *)arMatricesForViewportSize:(CGSize)viewportSize zNear:(CGFloat)zNear zFar:(CGFloat)zFar
{
  ...
  return @{
    @"transform": [ABI24_0_0EXGLARSessionManager nsArrayForMatrix:transform],
    @"viewMatrix": [ABI24_0_0EXGLARSessionManager nsArrayForMatrix:viewMat],
    @"projectionMatrix": [ABI24_0_0EXGLARSessionManager nsArrayForMatrix:projMat],
  };
}
