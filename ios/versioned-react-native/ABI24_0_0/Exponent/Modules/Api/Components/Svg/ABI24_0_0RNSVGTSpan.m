...
#import "ABI24_0_0RNSVGTSpan.h"
#import "ABI24_0_0RNSVGBezierTransformer.h"
#import "ABI24_0_0RNSVGText.h"
#import "ABI24_0_0RNSVGTextPath.h"

@implementation ABI24_0_0RNSVGTSpan
{
    ABI24_0_0RNSVGBezierTransformer *_bezierTransformer;
    CGPathRef _cache;
}
...
{
    __block ABI24_0_0RNSVGBezierTransformer *bezierTransformer;
    [self traverseTextSuperviews:^(__kindof ABI24_0_0RNSVGText *node) {
        if ([node class] == [ABI24_0_0RNSVGTextPath class]) {
            bezierTransformer = [(ABI24_0_0RNSVGTextPath*)node getBezierTransformer];
            return NO;
        }
        return YES;
    }];
...
- (void)traverseTextSuperviews:(BOOL (^)(__kindof ABI24_0_0RNSVGText *node))block
{
    ABI24_0_0RNSVGText *targetView = self;
    BOOL result = block(self);
    
    while (targetView && [targetView class] != [ABI24_0_0RNSVGText class] && result) {
        if (![targetView isKindOfClass:[ABI24_0_0RNSVGText class]]) {
            //todo: throw exception here
            break;
        }
        
        targetView = (ABI24_0_0RNSVGText*)[targetView superview];
