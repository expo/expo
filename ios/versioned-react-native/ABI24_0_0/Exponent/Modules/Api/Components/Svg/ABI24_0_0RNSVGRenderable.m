...
@implementation ABI24_0_0RNSVGRenderable
{
...
- (void)setFill:(ABI24_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI24_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI24_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)setStrokeDasharray:(ABI24_0_0RNSVGCGFloatArray)strokeDasharray
{
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    if (self.stroke) {
        ...
        ABI24_0_0RNSVGCGFloatArray dash = self.strokeDasharray;
