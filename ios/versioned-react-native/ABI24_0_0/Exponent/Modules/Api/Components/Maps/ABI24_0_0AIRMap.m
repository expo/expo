...
const CLLocationDegrees ABI24_0_0AIRMapDefaultSpan = 0.005;
const NSTimeInterval ABI24_0_0AIRMapRegionChangeObserveInterval = 0.1;
const CGFloat ABI24_0_0AIRMapZoomBoundBuffer = 0.01;
const NSInteger ABI24_0_0AIRMapMaxZoomLevel = 20;
...
@implementation ABI24_0_0AIRMap
{
    UIView *_legalLabel;
    CLLocationManager *_locationManager;
    BOOL _initialRegionSet;

    // Array to manually track ABI24_0_0RN subviews
    //
    // ABI24_0_0AIRMap implicitly creates subviews that aren't regular ABI24_0_0RN children
    // (ABI24_0_0SMCalloutView injects an overlay subview), which otherwise confuses ABI24_0_0RN
    // during component re-renders:
    // https://github.com/facebook/ReactABI24_0_0-native/blob/v0.16.0/ReactABI24_0_0/Modules/ABI24_0_0RCTUIManager.m#L657
    //
    // Implementation based on ABI24_0_0RCTTextField, another component with indirect children
    // https://github.com/facebook/ReactABI24_0_0-native/blob/v0.16.0/Libraries/Text/ABI24_0_0RCTTextField.m#L20
    NSMutableArray<UIView *> *_ReactABI24_0_0Subviews;
}
...
- (instancetype)init
{
    if ((self = [super init])) {
        ...
        _ReactABI24_0_0Subviews = [NSMutableArray new];
        ...
        self.calloutView = [ABI24_0_0SMCalloutView platformCalloutView];
        self.calloutView.delegate = self;

        self.minZoomLevel = 0;
        self.maxZoomLevel = ABI24_0_0AIRMapMaxZoomLevel;
    }
    return self;
}
...
- (void)insertReactABI24_0_0Subview:(id<ABI24_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
    ...
    if ([subview isKindOfClass:[ABI24_0_0AIRMapMarker class]]) {
        [self addAnnotation:(id <MKAnnotation>) subview];
    } else if ([subview isKindOfClass:[ABI24_0_0AIRMapPolyline class]]) {
        ((ABI24_0_0AIRMapPolyline *)subview).map = self;
        [self addOverlay:(id<MKOverlay>)subview];
    } else if ([subview isKindOfClass:[ABI24_0_0AIRMapPolygon class]]) {
        ((ABI24_0_0AIRMapPolygon *)subview).map = self;
        [self addOverlay:(id<MKOverlay>)subview];
    } else if ([subview isKindOfClass:[ABI24_0_0AIRMapCircle class]]) {
        [self addOverlay:(id<MKOverlay>)subview];
    } else if ([subview isKindOfClass:[ABI24_0_0AIRMapUrlTile class]]) {
        ((ABI24_0_0AIRMapUrlTile *)subview).map = self;
        [self addOverlay:(id<MKOverlay>)subview];
    } else {
        NSArray<id<ABI24_0_0RCTComponent>> *childSubviews = [subview ReactABI24_0_0Subviews];
        for (int i = 0; i < childSubviews.count; i++) {
          [self insertReactABI24_0_0Subview:(UIView *)childSubviews[i] atIndex:atIndex];
        }
    }
    [_ReactABI24_0_0Subviews insertObject:(UIView *)subview atIndex:(NSUInteger) atIndex];
}
...
- (void)removeReactABI24_0_0Subview:(id<ABI24_0_0RCTComponent>)subview {
    ...
    if ([subview isKindOfClass:[ABI24_0_0AIRMapMarker class]]) {
        ...
        NSArray<id<ABI24_0_0RCTComponent>> *childSubviews = [subview ReactABI24_0_0Subviews];
        for (int i = 0; i < childSubviews.count; i++) {
          [self removeReactABI24_0_0Subview:(UIView *)childSubviews[i]];
        }
    }
    [_ReactABI24_0_0Subviews removeObject:(UIView *)subview];
}
#pragma clang diagnostic pop
...
#pragma mark ABI24_0_0SMCalloutViewDelegate
