...
#import "ABI24_0_0AIRMapPolygonManager.h"
...
@interface ABI24_0_0AIRMapPolygonManager()

@end

@implementation ABI24_0_0AIRMapPolygonManager

ABI24_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI24_0_0AIRMapPolygon *polygon = [ABI24_0_0AIRMapPolygon new];
    return polygon;
}
