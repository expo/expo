//
//  ABI24_0_0EXFaceDetectorManager.m
//  Exponent
//
...
@interface ABI24_0_0EXFaceDetectorManager() <GMVDataOutputDelegate>
...
@property (nonatomic, weak) id <ABI24_0_0EXFaceDetectorDelegate> delegate;
...
@implementation ABI24_0_0EXFaceDetectorManager
...
{
  BOOL newFaceDetecting = [ABI24_0_0RCTConvert BOOL:json];
...
- (void)tryEnablingFaceDetection
{
  ...
  if ([self isDetectingFaces]) {
    @try {
      ...
      ABI24_0_0RCTLogWarn(@"%@", [exception description]);
    }
  }
...
{
  long requestedValue = [ABI24_0_0RCTConvert NSInteger:json];
...
- (void)dataOutput:(GMVDataOutput *)dataOutput didFinishedDetection:(NSArray<__kindof GMVFeature *> *)results
{
  ...
  // width or height started happen after refactor: moving face detection logic from ABI24_0_0EXCameraManager to ABI24_0_0EXFaceDetectorManager.
  ...
  CGAffineTransform transform = [ABI24_0_0EXFaceDetectorUtils transformFromDeviceOutput:dataOutput toInterfaceVideoOrientation:interfaceVideoOrientation];
  
  ABI24_0_0EXFaceEncoder *faceEncoder = [[ABI24_0_0EXFaceEncoder alloc] initWithTransform:transform];
