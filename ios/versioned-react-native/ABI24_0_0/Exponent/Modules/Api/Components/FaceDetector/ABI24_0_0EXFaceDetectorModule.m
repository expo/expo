...
#import "ABI24_0_0EXFaceDetectorModule.h"
#import "ABI24_0_0EXFaceEncoder.h"
...
@implementation ABI24_0_0EXFaceDetectorModule
...
ABI24_0_0RCT_EXPORT_MODULE(ExpoFaceDetector);
...
{
  return [ABI24_0_0EXFaceDetectorUtils constantsToExport];
}

ABI24_0_0RCT_EXPORT_METHOD(detectFaces:(nonnull NSDictionary *)options
                     ...
                     rejecter:(ABI24_0_0RCTPromiseRejectBlock)reject)
{
  ...
  @try {
    ...
    ABI24_0_0EXFaceEncoder *faceEncoder = [[ABI24_0_0EXFaceEncoder alloc] init];
    ...
    resolve(@{
              ...
              @"image" : @{
                  ...
                  @"orientation" : @([ABI24_0_0EXFaceDetectorModule exifOrientationFor:image.imageOrientation])
                  }
              });
...
// the value of GMVImageOrientation is the same as the value defined by ABI24_0_0EXIF specifications, so we can adapt
