//
//  ABI24_0_0EXFaceDetectorPointTransformCalculator.m
//  Exponent
//
...
#import "ABI24_0_0EXFaceDetectorPointTransformCalculator.h"
...
typedef NS_ENUM(NSInteger, ABI24_0_0EXTranslationEnum) {
  ABI24_0_0EXTranslateYNegativeWidth,
  ABI24_0_0EXTranslateXNegativeHeight,
  ABI24_0_0EXTranslateXYNegative,
  ABI24_0_0EXTranslateYXNegative
};

@interface ABI24_0_0EXFaceDetectorPointTransformCalculator()
...
@implementation ABI24_0_0EXFaceDetectorPointTransformCalculator
...
- (CGPoint)translation
{
  ...
  AVCaptureVideoOrientation firstOrientation = MIN(_fromOrientation, _toOrientation);
  AVCaptureVideoOrientation secondOrientation = MAX(_fromOrientation, _toOrientation);
  ABI24_0_0EXTranslationEnum enumValue = [[[self class] getTranslationDictionary][@(firstOrientation)][@(secondOrientation)] intValue];
...
- (CGPoint)translationForEnum:(ABI24_0_0EXTranslationEnum)enumValue
{
  switch (enumValue) {
    case ABI24_0_0EXTranslateXNegativeHeight:
      return CGPointMake(-_videoHeight, 0);
    case ABI24_0_0EXTranslateYNegativeWidth:
      return CGPointMake(0, -_videoWidth);
    case ABI24_0_0EXTranslateXYNegative:
      return CGPointMake(-_videoWidth, -_videoHeight);
    case ABI24_0_0EXTranslateYXNegative:
...
+ (void)initTranslationDictionary
{
  translationDictionary = @{
                            @(AVCaptureVideoOrientationPortrait): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI24_0_0EXTranslateYNegativeWidth),
                                @(AVCaptureVideoOrientationLandscapeRight) : @(ABI24_0_0EXTranslateXNegativeHeight),
                                @(AVCaptureVideoOrientationPortraitUpsideDown) : @(ABI24_0_0EXTranslateYXNegative)
                                },
                            @(AVCaptureVideoOrientationPortraitUpsideDown): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI24_0_0EXTranslateXNegativeHeight),
                                @(AVCaptureVideoOrientationLandscapeRight) : @(ABI24_0_0EXTranslateYNegativeWidth)
                                },
                            @(AVCaptureVideoOrientationLandscapeRight): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI24_0_0EXTranslateXYNegative)
                                }
                            };
}
