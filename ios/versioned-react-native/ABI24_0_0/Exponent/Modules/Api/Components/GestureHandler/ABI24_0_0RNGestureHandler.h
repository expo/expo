...
if (value != nil) recognizer.prop = [ABI24_0_0RCTConvert type:value]; \
} while(0)
...
@protocol ABI24_0_0RNGestureHandlerEventEmitter

- (void)sendTouchEvent:(nonnull ABI24_0_0RNGestureHandlerEvent *)event;

- (void)sendStateChangeEvent:(nonnull ABI24_0_0RNGestureHandlerStateChange *)event;

@end


@protocol ABI24_0_0RNRootViewGestureRecognizerDelegate <UIGestureRecognizerDelegate>
...
@interface ABI24_0_0RNGestureHandler : NSObject <UIGestureRecognizerDelegate> {

@protected UIGestureRecognizer *_recognizer;
@protected ABI24_0_0RNGestureHandlerState _lastState;

}

+ (nullable ABI24_0_0RNGestureHandler *)findGestureHandlerByRecognizer:(nonnull UIGestureRecognizer *)recognizer;

- (nonnull instancetype)initWithTag:(nonnull NSNumber *)tag;

@property (nonatomic, readonly, nonnull) NSNumber *tag;
@property (nonatomic, weak, nullable) id<ABI24_0_0RNGestureHandlerEventEmitter> emitter;
...
- (nullable ABI24_0_0RNGestureHandlerEventExtraData *)eventExtraData:(nonnull id)recognizer;
