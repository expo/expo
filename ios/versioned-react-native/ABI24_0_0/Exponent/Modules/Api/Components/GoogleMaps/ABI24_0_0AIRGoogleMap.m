...
@interface ABI24_0_0AIRGoogleMap ()

- (id)eventFromCoordinate:(CLLocationCoordinate2D)coordinate;

@end

@implementation ABI24_0_0AIRGoogleMap
{
...
- (void)insertReactABI24_0_0Subview:(id<ABI24_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  ...
  if ([subview isKindOfClass:[ABI24_0_0AIRGoogleMapMarker class]]) {
    ABI24_0_0AIRGoogleMapMarker *marker = (ABI24_0_0AIRGoogleMapMarker*)subview;
    marker.realMarker.map = self;
    [self.markers addObject:marker];
  } else if ([subview isKindOfClass:[ABI24_0_0AIRGoogleMapPolygon class]]) {
    ABI24_0_0AIRGoogleMapPolygon *polygon = (ABI24_0_0AIRGoogleMapPolygon*)subview;
    polygon.polygon.map = self;
    [self.polygons addObject:polygon];
  } else if ([subview isKindOfClass:[ABI24_0_0AIRGoogleMapPolyline class]]) {
    ABI24_0_0AIRGoogleMapPolyline *polyline = (ABI24_0_0AIRGoogleMapPolyline*)subview;
    polyline.polyline.map = self;
    [self.polylines addObject:polyline];
  } else if ([subview isKindOfClass:[ABI24_0_0AIRGoogleMapCircle class]]) {
    ABI24_0_0AIRGoogleMapCircle *circle = (ABI24_0_0AIRGoogleMapCircle*)subview;
    circle.circle.map = self;
    [self.circles addObject:circle];
  } else if ([subview isKindOfClass:[ABI24_0_0AIRGoogleMapUrlTile class]]) {
    ABI24_0_0AIRGoogleMapUrlTile *tile = (ABI24_0_0AIRGoogleMapUrlTile*)subview;
...
- (void)setInitialRegion:(MKCoordinateRegion)initialRegion {
  ...
  self.camera = [ABI24_0_0AIRGoogleMap makeGMSCameraPositionFromMap:self andMKCoordinateRegion:initialRegion];
}

- (void)setRegion:(MKCoordinateRegion)region {
  // TODO: The JS component is repeatedly setting region unnecessarily. We might want to deal with that in here.
  self.camera = [ABI24_0_0AIRGoogleMap makeGMSCameraPositionFromMap:self  andMKCoordinateRegion:region];
}

- (BOOL)didTapMarker:(GMSMarker *)marker {
  ABI24_0_0AIRGMSMarker *airMarker = (ABI24_0_0AIRGMSMarker *)marker;
...
- (void)didTapPolygon:(GMSOverlay *)polygon {
    ABI24_0_0AIRGMSPolygon *airPolygon = (ABI24_0_0AIRGMSPolygon *)polygon;
...
- (void)didChangeCameraPosition:(GMSCameraPosition *)position {
  id event = @{@"continuous": @YES,
               @"region": regionAsJSON([ABI24_0_0AIRGoogleMap makeGMSCameraPositionFromMap:self andGMSCameraPosition:position]),
               };
