//
//  ABI24_0_0EXFaceDetectorUtils.m
//  Exponent
//
...
#import "ABI24_0_0EXFaceDetectorUtils.h"
#import "ABI24_0_0EXFaceDetectorPointTransformCalculator.h"

NSString *const ABI24_0_0EXGMVDataOutputWidthKey = @"Width";
NSString *const ABI24_0_0EXGMVDataOutputHeightKey = @"Height";

@implementation ABI24_0_0EXFaceDetectorUtils

+ (NSDictionary *)constantsToExport
{
  return @{
           @"Mode" : @{
               @"fast" : @(ABI24_0_0EXFaceDetectionFastMode),
               @"accurate" : @(ABI24_0_0EXFaceDetectionAccurateMode)
               },
           @"Landmarks" : @{
               @"all" : @(ABI24_0_0EXFaceDetectAllLandmarks),
               @"none" : @(ABI24_0_0EXFaceDetectNoLandmarks)
               },
           @"Classifications" : @{
               @"all" : @(ABI24_0_0EXFaceRunAllClassifications),
               @"none" : @(ABI24_0_0EXFaceRunNoClassifications)
               }
           };
}
...
{
  ABI24_0_0EXFaceDetectorPointTransformCalculator *calculator = [[ABI24_0_0EXFaceDetectorPointTransformCalculator alloc] initToTransformFromOrientation:deviceVideoOrientation toOrientation:interfaceVideoOrientation forVideoWidth:[width floatValue] andVideoHeight:[height floatValue]];
...
+ (CGAffineTransform)transformFromDeviceOutput:(GMVDataOutput *)dataOutput withInterfaceOrientation:(AVCaptureVideoOrientation)interfaceVideoOrientation
{
  ...
  CGFloat xScale = interfaceWidth / [(NSNumber *)dataOutput.videoSettings[ABI24_0_0EXGMVDataOutputHeightKey] floatValue];
  CGFloat yScale = interfaceHeight / [(NSNumber *)dataOutput.videoSettings[ABI24_0_0EXGMVDataOutputWidthKey] floatValue];
...
+ (CGAffineTransform)transformFromDeviceOutput:(GMVDataOutput *)dataOutput toInterfaceVideoOrientation:(AVCaptureVideoOrientation)interfaceVideoOrientation
{
  ...
  AVCaptureVideoOrientation deviceVideoOrientation = [ABI24_0_0EXCameraUtils videoOrientationForDeviceOrientation:currentDeviceOrientation];
  
  NSNumber *videoWidth = dataOutput.videoSettings[ABI24_0_0EXGMVDataOutputWidthKey];
  NSNumber *videoHeight = dataOutput.videoSettings[ABI24_0_0EXGMVDataOutputHeightKey];
