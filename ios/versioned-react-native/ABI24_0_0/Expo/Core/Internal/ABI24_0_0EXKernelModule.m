...
@interface ABI24_0_0EXKernelModule ()
...
@property (nonatomic, weak) id<ABI24_0_0EXKernelModuleDelegate> delegate;


@end

@implementation ABI24_0_0EXKernelModule
...
- (void)sendEventWithName:(NSString *)eventName body:(id)body
{
  ...
  [self.bridge enqueueJSCall:@"ABI24_0_0RCTDeviceEventEmitter.emit"
...
ABI24_0_0RCT_REMAP_METHOD(doesCurrentTaskEnableDevtools,
                 doesCurrentTaskEnableDevtoolsWithResolver:(ABI24_0_0RCTPromiseResolveBlock)resolve
...
ABI24_0_0RCT_REMAP_METHOD(shouldCurrentTaskAutoReload,
                 shouldCurrentTaskAutoReloadWithResolver:(ABI24_0_0RCTPromiseResolveBlock)resolve
                 reject:(ABI24_0_0RCTPromiseRejectBlock)reject)
{
  if (_delegate) {
...
ABI24_0_0RCT_REMAP_METHOD(isLegacyMenuBehaviorEnabledAsync,
                 isLegacyMenuBehaviorEnabledWithResolver:(ABI24_0_0RCTPromiseResolveBlock)resolve
...
ABI24_0_0RCT_EXPORT_METHOD(setIsLegacyMenuBehaviorEnabledAsync:(BOOL)isEnabled)
{
  if (_delegate) {
...
ABI24_0_0RCT_REMAP_METHOD(getDevMenuItemsToShow,
                 getDevMenuItemsToShowWithResolver:(ABI24_0_0RCTPromiseResolveBlock)resolve
                 reject:(ABI24_0_0RCTPromiseRejectBlock)reject)
{
...
ABI24_0_0RCT_EXPORT_METHOD(selectDevMenuItemWithKey:(NSString *)key)
{
  if (_delegate) {
...
ABI24_0_0RCT_EXPORT_METHOD(addDevMenu)
{
...
ABI24_0_0RCT_REMAP_METHOD(routeDidForeground,
...
ABI24_0_0RCT_REMAP_METHOD(onEventSuccess,
...
ABI24_0_0RCT_REMAP_METHOD(onEventFailure,
                 eventId:(NSString *)eventId
