...
#import "ABI24_0_0EXImageManipulator.h"
#import "ABI24_0_0EXFileSystem.h"
#import "ABI24_0_0EXImageUtils.h"
#import <ReactABI24_0_0/ABI24_0_0RCTLog.h>

@implementation ABI24_0_0EXImageManipulator

ABI24_0_0RCT_EXPORT_MODULE(ExponentImageManipulator);
...
ABI24_0_0RCT_EXPORT_METHOD(manipulate:(NSString *)uri
                  ...
                  rejecter:(ABI24_0_0RCTPromiseRejectBlock)reject)
{
  ...
  for (NSDictionary *options in actions) {
    if (options[@"resize"]) {
      ...
      image = [ABI24_0_0EXImageUtils cropImage:image toRect:cropDimensions];
    }
  }
  ...
  if ([format isEqualToString:@"jpeg"]) {
    ...
    ABI24_0_0RCTLogWarn(@"Unsupported format: %@, using JPEG instead.", format);
    imageData = UIImageJPEGRepresentation(image, compressionValue);
    extension = @".jpg";
  }
