...
#import "ABI24_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI24_0_0EXFingerprint

ABI24_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI24_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI24_0_0RCTPromiseResolveBlock)resolve
...
ABI24_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI24_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI24_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI24_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
