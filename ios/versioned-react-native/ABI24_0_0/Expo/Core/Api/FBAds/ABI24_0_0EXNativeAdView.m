#import "ABI24_0_0EXNativeAdView.h"

#import <FBAudienceNetwork/FBAudienceNetwork.h>
#import <ReactABI24_0_0/ABI24_0_0RCTUtils.h>

@interface ABI24_0_0EXNativeAdView ()
...
@implementation ABI24_0_0EXNativeAdView
...
- (void)setNativeAd:(FBNativeAd *)nativeAd
{
  ...
  [_nativeAd registerViewForInteraction:self mediaView:_mediaView iconView:nil viewController:ABI24_0_0RCTPresentedViewController() clickableViews:@[self]];
}
