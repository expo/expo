...
@property (nonatomic, weak) id<ABI24_0_0EXUtilScopedModuleDelegate> kernelUpdatesServiceDelegate;
@property (nonatomic, weak) id<ABI24_0_0EXUtilService> kernelUtilService;

@end

ABI24_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI24_0_0EXUtil, util)
...
ABI24_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentUtil, @"UpdatesManager", @"UtilService");
