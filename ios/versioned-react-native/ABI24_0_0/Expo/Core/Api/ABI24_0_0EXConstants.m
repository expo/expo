...
ABI24_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI24_0_0EXConstants, constants)

@import UIKit.UIApplication;

@interface ABI24_0_0EXConstants ()
...
@implementation ABI24_0_0EXConstants

ABI24_0_0EX_EXPORT_SCOPED_MODULE(ExponentConstants, nil)
...
ABI24_0_0RCT_REMAP_METHOD(getWebViewUserAgentAsync,
                 getWebViewUserAgentWithResolver:(ABI24_0_0RCTPromiseResolveBlock)resolve
