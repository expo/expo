...
#import "ABI24_0_0EXWebBrowser.h"
#import "ABI24_0_0EXUnversioned.h"

@interface ABI24_0_0EXWebBrowser () <SFSafariViewControllerDelegate>

@property (nonatomic, copy) ABI24_0_0RCTPromiseResolveBlock redirectResolve;
@property (nonatomic, copy) ABI24_0_0RCTPromiseRejectBlock redirectReject;
...
NSString *ABI24_0_0EXWebBrowserErrorCode = @"ABI24_0_0EXWebBrowser";


@implementation ABI24_0_0EXWebBrowser
{
  UIStatusBarStyle _initialStatusBarStyle;
}

ABI24_0_0RCT_EXPORT_MODULE(ExponentWebBrowser)
...
ABI24_0_0RCT_EXPORT_METHOD(openAuthSessionAsync:(NSString *)authURL
...
ABI24_0_0RCT_EXPORT_METHOD(openBrowserAsync:(NSString *)authURL
                  resolver:(ABI24_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI24_0_0RCTPromiseRejectBlock)reject)
{
 ...
 [ABI24_0_0RCTPresentedViewController() presentViewController:safariHackVC animated:true completion:nil];
}
...
- (void)_dismissBrowser
{
  ...
  [self _performSynchronouslyOnMainThread:^{
    [ABI24_0_0RCTPresentedViewController() dismissViewControllerAnimated:YES completion:^{
...
ABI24_0_0RCT_EXPORT_METHOD(dismissBrowser) {
  [self _dismissBrowser];
}

ABI24_0_0RCT_EXPORT_METHOD(dismissAuthSession) {
  if (@available(iOS 11, *)) {
    [_authSession cancel];
    if (_redirectResolve) {
      _redirectResolve(@{
 ...
 */
- (BOOL)initializeWebBrowserWithResolver:(ABI24_0_0RCTPromiseResolveBlock)resolve andRejecter:(ABI24_0_0RCTPromiseRejectBlock)reject {
  if (_redirectResolve) {
    reject(ABI24_0_0EXWebBrowserErrorCode, @"Another WebBrowser is already being presented.", nil);
    return NO;
  }
  _redirectReject = reject;
  _redirectResolve = resolve;
  
  _initialStatusBarStyle = ABI24_0_0RCTSharedApplication().statusBarStyle;
  
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
  [ABI24_0_0RCTSharedApplication() setStatusBarStyle:UIStatusBarStyleDefault
                                   animated:YES];
#pragma clang diagnostic pop
  return YES;
}
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
  [ABI24_0_0RCTSharedApplication() setStatusBarStyle:_initialStatusBarStyle animated:YES];
#pragma clang diagnostic pop
