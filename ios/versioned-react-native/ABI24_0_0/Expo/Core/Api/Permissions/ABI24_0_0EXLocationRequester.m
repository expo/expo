...
@interface ABI24_0_0EXLocationRequester () <CLLocationManagerDelegate>
...
@implementation ABI24_0_0EXLocationRequester
...
- (void)requestPermissionsWithResolver:(ABI24_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI24_0_0RCTPromiseRejectBlock)reject
{
  ...
  if (existingPermissions && ![existingPermissions[@"status"] isEqualToString:[ABI24_0_0EXPermissions permissionStringForStatus:ABI24_0_0EXPermissionStatusUndetermined]]) {
