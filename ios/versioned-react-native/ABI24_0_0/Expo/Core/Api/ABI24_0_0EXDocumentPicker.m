...
#import "ABI24_0_0EXDocumentPicker.h"

#import <MobileCoreServices/MobileCoreServices.h>
#import <UIKit/UIKit.h>
#import <ReactABI24_0_0/ABI24_0_0RCTUtils.h>

static NSString * ABI24_0_0EXConvertMimeTypeToUTI(NSString *mimeType)
{
  CFStringRef uti;
...
@interface ABI24_0_0EXDocumentPicker () <UIDocumentMenuDelegate, UIDocumentPickerDelegate>
...
@implementation ABI24_0_0EXDocumentPicker

ABI24_0_0RCT_EXPORT_MODULE(ExponentDocumentPicker)

ABI24_0_0RCT_EXPORT_METHOD(getDocumentAsync:(NSDictionary *)options resolver:(ABI24_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI24_0_0RCTPromiseRejectBlock)reject) {
  _resolve = resolve;
  _reject = reject;

  NSString *type = ABI24_0_0EXConvertMimeTypeToUTI(options[@"type"] ?: @"*/*");
  ...
  [ABI24_0_0RCTPresentedViewController() presentViewController:documentMenuVC animated:YES completion:nil];
}

- (void)documentMenu:(UIDocumentMenuViewController *)documentMenu didPickDocumentPicker:(UIDocumentPickerViewController *)documentPicker
{
  documentPicker.delegate = self;
  [ABI24_0_0RCTPresentedViewController() presentViewController:documentPicker animated:YES completion:nil];
}
