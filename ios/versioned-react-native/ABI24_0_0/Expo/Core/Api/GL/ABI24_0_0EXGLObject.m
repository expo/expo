...
@implementation ABI24_0_0EXGLObject

+ (instancetype)createWithConfig:(NSDictionary *)config
{
  // TODO(nikki): Maintain these `config` --> `ABI24_0_0EXGLObject` implementation mapping rules in a common place
  if (config[@"texture"]) {
    if (config[@"texture"][@"camera"]) {
      return [[ABI24_0_0EXGLGPUImageObject alloc] initWithConfig:config];
    }
  }
