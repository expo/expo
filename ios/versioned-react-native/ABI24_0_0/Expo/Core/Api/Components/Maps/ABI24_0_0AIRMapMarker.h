...
@interface ABI24_0_0AIRMapMarker : MKAnnotationView <MKAnnotation>

@property (nonatomic, strong) ABI24_0_0AIRMapCallout *calloutView;
...
@property (nonatomic, copy) ABI24_0_0RCTDirectEventBlock onSelect;
@property (nonatomic, copy) ABI24_0_0RCTDirectEventBlock onDeselect;
...
@interface ABI24_0_0AIREmptyCalloutBackgroundView : ABI24_0_0SMCalloutBackgroundView
@end
