...
@implementation ABI24_0_0RNSVGSvgView
{
    NSMutableDictionary<NSString *, ABI24_0_0RNSVGNode *> *_clipPaths;
    NSMutableDictionary<NSString *, ABI24_0_0RNSVGNode *> *_templates;
    NSMutableDictionary<NSString *, ABI24_0_0RNSVGPainter *> *_painters;
    CGRect _boundingBox;
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.align) {
        _viewBoxTransform = [ABI24_0_0RNSVGViewBox getTransform:CGRectMake(self.minX, self.minY, self.vbWidth, self.vbHeight)
                                                 eRect:rect
                                                 align:self.align
    ...
    for (ABI24_0_0RNSVGNode *node in self.subviews) {
...
- (void)defineClipPath:(__kindof ABI24_0_0RNSVGNode *)clipPath clipPathName:(NSString *)clipPathName
{
    if (!_clipPaths) {
...
- (ABI24_0_0RNSVGNode *)getDefinedClipPath:(NSString *)clipPathName
{
    return _clipPaths ? [_clipPaths objectForKey:clipPathName] : nil;
}

- (void)defineTemplate:(ABI24_0_0RNSVGNode *)template templateName:(NSString *)templateName
{
    if (!_templates) {
...
- (ABI24_0_0RNSVGNode *)getDefinedTemplate:(NSString *)templateName
{
    return _templates ? [_templates objectForKey:templateName] : nil;
}


- (void)definePainter:(ABI24_0_0RNSVGPainter *)painter painterName:(NSString *)painterName
{
    if (!_painters) {
...
- (ABI24_0_0RNSVGPainter *)getDefinedPainter:(NSString *)painterName;
{
