...
#import "ABI24_0_0RNSVGViewBox.h"

@implementation ABI24_0_0RNSVGImage
{
    CGImageRef _image;
    CGFloat _imageRatio;
}
...
- (void)setSrc:(id)src
{
    ...
    ABI24_0_0RCTImageSource *source = [ABI24_0_0RCTConvert ABI24_0_0RCTImageSource:src];
    ...
    _image = CGImageRetain([ABI24_0_0RCTConvert CGImage:src]);
    [self invalidate];
}
...
- (void)setMeetOrSlice:(ABI24_0_0RNSVGVBMOS)meetOrSlice
{
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    CGAffineTransform transform = [ABI24_0_0RNSVGViewBox getTransform:vbRect eRect:eRect align:self.align meetOrSlice:self.meetOrSlice fromSymbol:NO];
