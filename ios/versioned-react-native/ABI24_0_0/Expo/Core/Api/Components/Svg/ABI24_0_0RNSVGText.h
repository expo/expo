...
@interface ABI24_0_0RNSVGText : ABI24_0_0RNSVGGroup

@property (nonatomic, assign) ABI24_0_0RNSVGTextAnchor textAnchor;
...
- (ABI24_0_0RNSVGText *)getTextRoot;
- (void)releaseCachedPath;
- (CGPathRef)getGroupPath:(CGContextRef)context;

- (ABI24_0_0RNSVGGlyphContext *)getGlyphContext;
