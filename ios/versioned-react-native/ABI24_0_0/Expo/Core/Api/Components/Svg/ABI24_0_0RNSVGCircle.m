...
@implementation ABI24_0_0RNSVGCircle
...
- (CGPathRef)getPath:(CGContextRef)context
{
    ...
    if ([ABI24_0_0RNSVGPercentageConverter isPercentage:self.r]) {
        CGFloat radiusPercent = [ABI24_0_0RNSVGPercentageConverter percentageToFloat:self.r relative:1 offset:0];
