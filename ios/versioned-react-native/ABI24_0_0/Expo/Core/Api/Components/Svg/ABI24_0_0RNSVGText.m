...
@implementation ABI24_0_0RNSVGText
{
    ABI24_0_0RNSVGText *_textRoot;
    ABI24_0_0RNSVGGlyphContext *_glyphContext;
}

- (void)setTextAnchor:(ABI24_0_0RNSVGTextAnchor)textAnchor
{
    [self invalidate];
...
{
    _glyphContext = [[ABI24_0_0RNSVGGlyphContext alloc] initWithDimensions:[self getContextWidth]
                                                  height:[self getContextHeight]];
}

// release the cached CGPathRef for ABI24_0_0RNSVGTSpan
- (void)releaseCachedPath
{
    [self traverseSubviews:^BOOL(__kindof ABI24_0_0RNSVGNode *node) {
        ABI24_0_0RNSVGText *text = node;
...
- (ABI24_0_0RNSVGTextAnchor)getComputedTextAnchor
{
    ABI24_0_0RNSVGTextAnchor anchor = self.textAnchor;
    if (self.subviews.count > 0) {
        ABI24_0_0RNSVGText *child = [self.subviews firstObject];
...
- (ABI24_0_0RNSVGText *)getTextRoot
{
    if (!_textRoot) {
        _textRoot = self;
        while (_textRoot && [_textRoot class] != [ABI24_0_0RNSVGText class]) {
            if (![_textRoot isKindOfClass:[ABI24_0_0RNSVGText class]]) {
                //todo: throw exception here
                break;
            }
            _textRoot = (ABI24_0_0RNSVGText*)[_textRoot superview];
        }
    }
