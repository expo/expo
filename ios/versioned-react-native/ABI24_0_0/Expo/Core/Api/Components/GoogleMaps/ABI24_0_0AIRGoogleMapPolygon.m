//
//  ABI24_0_0AIRGoogleMapPolygon.m
//
//  Created by Nick Italiano on 10/22/16.
//

#import "ABI24_0_0AIRGoogleMapPolygon.h"
#import "ABI24_0_0AIRGMSPolygon.h"
#import <GoogleMaps/GoogleMaps.h>

@implementation ABI24_0_0AIRGoogleMapPolygon

- (instancetype)init
{
  if (self = [super init]) {
    _polygon = [[ABI24_0_0AIRGMSPolygon alloc] init];
  }

  return self;
}

- (void)setCoordinates:(NSArray<ABI24_0_0AIRMapCoordinate *> *)coordinates
{
...
- (void)setHoles:(NSArray<NSArray<ABI24_0_0AIRMapCoordinate *> *> *)holes
{
  _holes = holes;
