...
#import "ABI24_0_0AIRDummyView.h"
...
@interface ABI24_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI24_0_0AIRGMSMarker*)marker;
@end

@implementation ABI24_0_0AIRGoogleMapMarker {
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI24_0_0AIRGMSMarker alloc] init];
...
- (void)insertReactABI24_0_0Subview:(id<ABI24_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI24_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI24_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI24_0_0AIRDummyView *dummySubview = [[ABI24_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertReactABI24_0_0Subview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeReactABI24_0_0Subview:(id<ABI24_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI24_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeReactABI24_0_0Subview:(UIView*)dummySubview];
}
...
- (void)setOnPress:(ABI24_0_0RCTBubblingEventBlock)onPress {
  _realMarker.onPress = onPress;
}

- (ABI24_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/airbnb/ReactABI24_0_0-native-maps/issues/738)
  ...
  _reloadImageCancellationBlock = [_bridge.imageLoader loadImageWithURLRequest:[ABI24_0_0RCTConvert NSURLRequest:_imageSrc]
                                                                          size:self.bounds.size
                                                                         scale:ABI24_0_0RCTScreenScale()
                                                                       clipped:YES
                                                                    resizeMode:ABI24_0_0RCTResizeModeCenter
                                                                 progressBlock:nil
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI24_0_0RN?
