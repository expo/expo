...
@implementation ABI24_0_0EXDeviceMotion

ABI24_0_0EX_EXPORT_SCOPED_MODULE(ExponentDeviceMotion, SensorManager);
...
{
  return @{ @"Gravity" : @(ABI24_0_0EXGravity) };
}
