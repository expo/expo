...
#import "ABI24_0_0EXPedometer.h"
#import "ABI24_0_0EXUnversioned.h"

#import <CoreMotion/CoreMotion.h>

NSString * const ABI24_0_0EXPedometerUpdateEventName = @"Exponent.pedometerUpdate";

@implementation ABI24_0_0EXPedometer
{
...
- (void)setBridge:(ABI24_0_0RCTBridge *)bridge
{
  ...
  _watchHandler = ^(CMPedometerData * _Nullable pedometerData, NSError * _Nullable error) {
    ...
    [weakSelf sendEventWithName:ABI24_0_0EXPedometerUpdateEventName
...
ABI24_0_0RCT_EXPORT_MODULE(ExponentPedometer)

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI24_0_0EXPedometerUpdateEventName];
}

ABI24_0_0RCT_EXPORT_METHOD(getStepCountAsync:(nonnull NSNumber *)startTime
...
ABI24_0_0RCT_EXPORT_METHOD(watchStepCount)
{
  if (!_pedometer) {
    _pedometer = [CMPedometer new];
  }
...
ABI24_0_0RCT_EXPORT_METHOD(stopWatchingStepCount)
{
  _watchStartDate = nil;
  _isWatching = NO;
  [_pedometer stopPedometerUpdates];
...
ABI24_0_0RCT_EXPORT_METHOD(isAvailableAsync:(ABI24_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI24_0_0RCTPromiseRejectBlock)reject)
{
