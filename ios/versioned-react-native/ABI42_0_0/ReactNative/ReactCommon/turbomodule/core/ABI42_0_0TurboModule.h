 ...
 */
class JSI_EXPORT TurboModule : public ABI42_0_0facebook::jsi::HostObject {
 public:
  TurboModule(const std::string &name, std::shared_ptr<CallInvoker> jsInvoker);
  virtual ~TurboModule();

  virtual ABI42_0_0facebook::jsi::Value get(
      ABI42_0_0facebook::jsi::Runtime &runtime,
      const ABI42_0_0facebook::jsi::PropNameID &propName) override;
 ...
 protected:
  struct MethodMetadata {
    size_t argCount;
    ABI42_0_0facebook::jsi::Value (*invoker)(
