...
#include "ABI42_0_0jsireact/ABI42_0_0JSINativeModules.h"
...
folly::Optional<Object> JSINativeModules::createModule(
  ...
  if (hasLogger) {
    ABI42_0_0ReactMarker::logTaggedMarker(
        ABI42_0_0ReactMarker::NATIVE_MODULE_SETUP_START, name.c_str());
  }
  ...
  if (hasLogger) {
    ABI42_0_0ReactMarker::logTaggedMarker(
        ABI42_0_0ReactMarker::NATIVE_MODULE_SETUP_STOP, name.c_str());
  }
