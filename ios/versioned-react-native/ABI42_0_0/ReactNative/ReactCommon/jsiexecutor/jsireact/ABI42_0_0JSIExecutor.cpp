...
#include <ABI42_0_0cxxreact/ABI42_0_0ReactMarker.h>
...
void JSIExecutor::initializeRuntime() {
  ...
  bool hasLogger(ABI42_0_0ReactMarker::logTaggedMarker);
  if (hasLogger) {
    ABI42_0_0ReactMarker::logMarker(ABI42_0_0ReactMarker::CREATE_REACT_CONTEXT_STOP);
  }
}
...
void JSIExecutor::loadBundle(
  ...
  if (hasLogger) {
    ABI42_0_0ReactMarker::logTaggedMarker(
        ABI42_0_0ReactMarker::RUN_JS_BUNDLE_START, scriptName.c_str());
  }
  ...
  if (hasLogger) {
    ABI42_0_0ReactMarker::logTaggedMarker(
        ABI42_0_0ReactMarker::RUN_JS_BUNDLE_STOP, scriptName.c_str());
  }
}
        ...
        *runtime_,
        ...
        Function::createFromHostFunction(
            *runtime_,
            ...
            [this](
                __unused Runtime &rt,
                const ABI42_0_0facebook::jsi::Value &,
...
void JSIExecutor::registerBundle(
  ...
  ABI42_0_0ReactMarker::logTaggedMarker(
      ABI42_0_0ReactMarker::REGISTER_JS_SEGMENT_START, tag.c_str());
  if (bundleRegistry_) {
  ...
  ABI42_0_0ReactMarker::logTaggedMarker(
      ABI42_0_0ReactMarker::REGISTER_JS_SEGMENT_STOP, tag.c_str());
}
...
Value JSIExecutor::nativeRequire(const Value *args, size_t count) {
  ...
  return ABI42_0_0facebook::jsi::Value();
}
