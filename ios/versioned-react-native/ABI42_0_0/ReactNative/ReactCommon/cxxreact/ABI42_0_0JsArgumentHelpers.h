...
// When building a cross-platform module for ABI42_0_0React Native, arguments passed
...
// they can be caught and reported to ABI42_0_0RN consistently.  The goal is to make the
...
#include <ABI42_0_0cxxreact/ABI42_0_0JsArgumentHelpers-inl.h>
