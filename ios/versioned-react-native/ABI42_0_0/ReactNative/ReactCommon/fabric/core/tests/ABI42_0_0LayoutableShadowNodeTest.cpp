...
TEST_F(LayoutableShadowNodeTest, relativeLayoutMetrics) {
  ...
  ABI42_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 10);
  ABI42_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 20);
}
...
TEST_F(LayoutableShadowNodeTest, relativeLayoutMetricsOnTransformedNode) {
  ...
  ABI42_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 35);
  ABI42_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 70);

  ABI42_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 50);
  ABI42_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 100);
}
...
TEST_F(LayoutableShadowNodeTest, relativeLayoutMetricsOnTransformedParent) {
  ...
  ABI42_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 45);
  ABI42_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 45);

  ABI42_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 25);
  ABI42_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 25);
}
...
TEST_F(LayoutableShadowNodeTest, relativeLayoutMetricsOnSameNode) {
  ...
  ABI42_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 0);
  ABI42_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 0);
  ABI42_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 100);
  ABI42_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 200);
}
...
TEST_F(LayoutableShadowNodeTest, relativeLayourMetricsOnClonedNode) {
  ...
  ABI42_0_0EXPECT_EQ(newRelativeLayoutMetrics.frame.size.width, 500);
  ABI42_0_0EXPECT_EQ(newRelativeLayoutMetrics.frame.size.height, 600);
}
...
TEST_F(LayoutableShadowNodeTest, relativeLayoutMetricsOnSameNode2) {
  ...
  ABI42_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 10);
  ABI42_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 10);
}
