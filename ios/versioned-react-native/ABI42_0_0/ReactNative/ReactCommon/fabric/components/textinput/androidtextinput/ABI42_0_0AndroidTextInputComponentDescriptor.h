...
#include <ABI42_0_0yoga/ABI42_0_0CompactValue.h>
#include <ABI42_0_0yoga/ABI42_0_0YGEnums.h>
#include <ABI42_0_0yoga/ABI42_0_0YGValue.h>
...
class AndroidTextInputComponentDescriptor final
 ...
 public:
  ...
  virtual State::Shared createInitialState(
    ...
    if (surfaceIdToThemePaddingMap_.find(surfaceId) !=
      ...
      ABI42_0_0YGStyle::Edges theme = surfaceIdToThemePaddingMap_[surfaceId];
      defaultThemePaddingStart = ((ABI42_0_0YGValue)theme[ABI42_0_0YGEdgeStart]).value;
      defaultThemePaddingEnd = ((ABI42_0_0YGValue)theme[ABI42_0_0YGEdgeEnd]).value;
      defaultThemePaddingTop = ((ABI42_0_0YGValue)theme[ABI42_0_0YGEdgeTop]).value;
      defaultThemePaddingBottom = ((ABI42_0_0YGValue)theme[ABI42_0_0YGEdgeBottom]).value;
    }
 ...
 protected:
  void adopt(UnsharedShadowNode shadowNode) const override {
    ...
    if (surfaceIdToThemePaddingMap_.find(surfaceId) ==
      ...
      ABI42_0_0YGStyle::Edges result;
      result[ABI42_0_0YGEdgeStart] =
          (ABI42_0_0YGValue){state.defaultThemePaddingStart, ABI42_0_0YGUnitPoint};
      result[ABI42_0_0YGEdgeEnd] = (ABI42_0_0YGValue){state.defaultThemePaddingEnd, ABI42_0_0YGUnitPoint};
      result[ABI42_0_0YGEdgeTop] = (ABI42_0_0YGValue){state.defaultThemePaddingTop, ABI42_0_0YGUnitPoint};
      result[ABI42_0_0YGEdgeBottom] =
          (ABI42_0_0YGValue){state.defaultThemePaddingBottom, ABI42_0_0YGUnitPoint};
    ...
    if (surfaceIdToThemePaddingMap_.find(surfaceId) !=
      ...
      if (!textInputShadowNode->getConcreteProps().hasPadding &&
        ...
        changedPadding = true;
        result[ABI42_0_0YGEdgeStart] = theme[ABI42_0_0YGEdgeStart];
      }
      if (!textInputShadowNode->getConcreteProps().hasPadding &&
      ...
      if ((textInputShadowNode->getConcreteProps().hasPadding ||
           ...
           textInputShadowNode->getConcreteProps().hasPaddingHorizontal) &&
          !textInputShadowNode->getConcreteProps().hasPaddingStart) {
        result[ABI42_0_0YGEdgeStart] = ABI42_0_0YGValueUndefined;
      }
      if ((textInputShadowNode->getConcreteProps().hasPadding ||
           textInputShadowNode->getConcreteProps().hasPaddingRight ||
           textInputShadowNode->getConcreteProps().hasPaddingHorizontal) &&
          !textInputShadowNode->getConcreteProps().hasPaddingEnd) {
        result[ABI42_0_0YGEdgeEnd] = ABI42_0_0YGValueUndefined;
      }
 ...
 private:
  ...
  mutable better::map<int, ABI42_0_0YGStyle::Edges> surfaceIdToThemePaddingMap_;
};
