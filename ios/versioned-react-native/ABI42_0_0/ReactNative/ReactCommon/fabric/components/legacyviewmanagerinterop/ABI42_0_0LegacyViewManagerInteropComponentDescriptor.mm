...
#include "ABI42_0_0LegacyViewManagerInteropComponentDescriptor.h"
#include <ABI42_0_0React/ABI42_0_0RCTBridge.h>
...
#include "ABI42_0_0LegacyViewManagerInteropState.h"
...
static std::string moduleNameFromComponentName(const std::string &componentName)
{
  ...
  return "ABI42_0_0RCT" + componentName + "Manager";
}

inline NSString *ABI42_0_0RCTNSStringFromString(const std::string &string)
{
    ...
    ComponentDescriptor::Flavor const &flavor)
{
  ...
  Class module = NSClassFromString(ABI42_0_0RCTNSStringFromString(moduleName));
  assert(module);
  ABI42_0_0RCTBridge *bridge = (ABI42_0_0RCTBridge *)unwrapManagedObjectWeakly(contextContainer->at<std::shared_ptr<void>>("Bridge"));
  ABI42_0_0RCTComponentData *componentData = [[ABI42_0_0RCTComponentData alloc] initWithManagerClass:module bridge:bridge];
  return wrapManagedObject([[ABI42_0_0RCTLegacyViewManagerInteropCoordinator alloc] initWithComponentData:componentData
                                                                                          bridge:bridge]);
}
