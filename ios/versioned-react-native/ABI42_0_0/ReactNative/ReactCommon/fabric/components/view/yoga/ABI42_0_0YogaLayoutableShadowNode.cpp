...
#include "ABI42_0_0YogaLayoutableShadowNode.h"
...
static void applyLayoutConstraints(
  ...
  yogaStyle.minDimensions()[ABI42_0_0YGDimensionWidth] =
      yogaStyleValueFromFloat(layoutConstraints.minimumSize.width);
  yogaStyle.minDimensions()[ABI42_0_0YGDimensionHeight] =
      yogaStyleValueFromFloat(layoutConstraints.minimumSize.height);

  yogaStyle.maxDimensions()[ABI42_0_0YGDimensionWidth] =
      yogaStyleValueFromFloat(layoutConstraints.maximumSize.width);
  yogaStyle.maxDimensions()[ABI42_0_0YGDimensionHeight] =
...
void YogaLayoutableShadowNode::updateYogaChildren() {
  ...
  auto oldChildren = isClean ? yogaNode_.getChildren() : ABI42_0_0YGVector{};
...
void YogaLayoutableShadowNode::setSize(Size size) const {
  ...
  style.dimensions()[ABI42_0_0YGDimensionWidth] = yogaStyleValueFromFloat(size.width);
  style.dimensions()[ABI42_0_0YGDimensionHeight] = yogaStyleValueFromFloat(size.height);
...
void YogaLayoutableShadowNode::setPadding(RectangleEdges<Float> padding) const {
  ...
  auto style = yogaNode_.getStyle();
  style.padding()[ABI42_0_0YGEdgeTop] = yogaStyleValueFromFloat(padding.top);
  style.padding()[ABI42_0_0YGEdgeLeft] = yogaStyleValueFromFloat(padding.left);
  style.padding()[ABI42_0_0YGEdgeRight] = yogaStyleValueFromFloat(padding.right);
  style.padding()[ABI42_0_0YGEdgeBottom] = yogaStyleValueFromFloat(padding.bottom);
  yogaNode_.setStyle(style);
  yogaNode_.setDirty(true);
}
...
void YogaLayoutableShadowNode::layoutTree(
  ...
  {
    SystraceSection s("YogaLayoutableShadowNode::ABI42_0_0YGNodeCalculateLayout");

    ABI42_0_0YGNodeCalculateLayout(
        &yogaNode_, ABI42_0_0YGUndefined, ABI42_0_0YGUndefined, ABI42_0_0YGDirectionInherit);
  }
...
ABI42_0_0YGNode *YogaLayoutableShadowNode::yogaNodeCloneCallbackConnector(
...
ABI42_0_0YGSize YogaLayoutableShadowNode::yogaNodeMeasureCallbackConnector(
  ...
  return ABI42_0_0YGSize{yogaFloatFromFloat(size.width),
                yogaFloatFromFloat(size.height)};
}

ABI42_0_0YGConfig &YogaLayoutableShadowNode::initializeYogaConfig(ABI42_0_0YGConfig &config) {
...
void YogaLayoutableShadowNode::swapLeftAndRightInYogaStyleProps(
  ...
  ABI42_0_0YGStyle::Edges const &position = yogaStyle.position();
  ABI42_0_0YGStyle::Edges const &padding = yogaStyle.padding();
  ABI42_0_0YGStyle::Edges const &margin = yogaStyle.margin();

  // Swap Yoga node values, position, padding and margin.

  if (yogaStyle.position()[ABI42_0_0YGEdgeLeft] != ABI42_0_0YGValueUndefined) {
    yogaStyle.position()[ABI42_0_0YGEdgeStart] = position[ABI42_0_0YGEdgeLeft];
    yogaStyle.position()[ABI42_0_0YGEdgeLeft] = ABI42_0_0YGValueUndefined;
  }

  if (yogaStyle.position()[ABI42_0_0YGEdgeRight] != ABI42_0_0YGValueUndefined) {
    yogaStyle.position()[ABI42_0_0YGEdgeEnd] = position[ABI42_0_0YGEdgeRight];
    yogaStyle.position()[ABI42_0_0YGEdgeRight] = ABI42_0_0YGValueUndefined;
  }

  if (yogaStyle.padding()[ABI42_0_0YGEdgeLeft] != ABI42_0_0YGValueUndefined) {
    yogaStyle.padding()[ABI42_0_0YGEdgeStart] = padding[ABI42_0_0YGEdgeLeft];
    yogaStyle.padding()[ABI42_0_0YGEdgeLeft] = ABI42_0_0YGValueUndefined;
  }

  if (yogaStyle.padding()[ABI42_0_0YGEdgeRight] != ABI42_0_0YGValueUndefined) {
    yogaStyle.padding()[ABI42_0_0YGEdgeEnd] = padding[ABI42_0_0YGEdgeRight];
    yogaStyle.padding()[ABI42_0_0YGEdgeRight] = ABI42_0_0YGValueUndefined;
  }

  if (yogaStyle.margin()[ABI42_0_0YGEdgeLeft] != ABI42_0_0YGValueUndefined) {
    yogaStyle.margin()[ABI42_0_0YGEdgeStart] = margin[ABI42_0_0YGEdgeLeft];
    yogaStyle.margin()[ABI42_0_0YGEdgeLeft] = ABI42_0_0YGValueUndefined;
  }

  if (yogaStyle.margin()[ABI42_0_0YGEdgeRight] != ABI42_0_0YGValueUndefined) {
    yogaStyle.margin()[ABI42_0_0YGEdgeEnd] = margin[ABI42_0_0YGEdgeRight];
    yogaStyle.margin()[ABI42_0_0YGEdgeLeft] = ABI42_0_0YGValueUndefined;
  }
...
void YogaLayoutableShadowNode::swapLeftAndRightInViewProps(
  ...
  ABI42_0_0YGStyle::Edges const &border = props.yogaStyle.border();

  if (props.yogaStyle.border()[ABI42_0_0YGEdgeLeft] != ABI42_0_0YGValueUndefined) {
    props.yogaStyle.border()[ABI42_0_0YGEdgeStart] = border[ABI42_0_0YGEdgeLeft];
    props.yogaStyle.border()[ABI42_0_0YGEdgeLeft] = ABI42_0_0YGValueUndefined;
  }

  if (props.yogaStyle.border()[ABI42_0_0YGEdgeRight] != ABI42_0_0YGValueUndefined) {
    props.yogaStyle.border()[ABI42_0_0YGEdgeEnd] = border[ABI42_0_0YGEdgeRight];
    props.yogaStyle.border()[ABI42_0_0YGEdgeRight] = ABI42_0_0YGValueUndefined;
  }
}
