...
@implementation ABI42_0_0ARTText
...
static void ABI42_0_0ARTFreeTextFrame(ABI42_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI42_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI42_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI42_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI42_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
