...
#import <ABI42_0_0React/ABI42_0_0ARTRenderable.h>

@implementation ABI42_0_0ARTRenderable

- (void)setFill:(ABI42_0_0ARTBrush *)fill
{
  [self invalidate];
  _fill = fill;
}
...
- (void)setStrokeDash:(ABI42_0_0ARTCGFloatArray)strokeDash
{
