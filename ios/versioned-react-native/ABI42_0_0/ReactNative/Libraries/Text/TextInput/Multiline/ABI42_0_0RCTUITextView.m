...
#import <ABI42_0_0React/ABI42_0_0RCTUITextView.h>
...
@implementation ABI42_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI42_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI42_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  // see: https://github.com/facebook/ABI42_0_0React-native/issues/19339
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI42_0_0RCTCeilPixelValue(placeholderSize.width), ABI42_0_0RCTCeilPixelValue(placeholderSize.height));
