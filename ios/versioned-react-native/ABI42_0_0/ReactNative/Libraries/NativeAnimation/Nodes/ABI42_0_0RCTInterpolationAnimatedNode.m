...
#import <ABI42_0_0React/ABI42_0_0RCTInterpolationAnimatedNode.h>

#import <ABI42_0_0React/ABI42_0_0RCTAnimationUtils.h>

static NSRegularExpression *regex;

@implementation ABI42_0_0RCTInterpolationAnimatedNode
{
  __weak ABI42_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI42_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI42_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI42_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  CGFloat interpolated = ABI42_0_0RCTInterpolateValueInRange(inputValue,
                                                    _inputRange,
                                                    _outputRange,
                                                    _extrapolateLeft,
                                                    _extrapolateRight);
  ...
  if (_hasStringOutput) {
    ...
    if (_numVals > 1) {
      ...
      for (NSTextCheckingResult *match in [_matches reverseObjectEnumerator]) {
        CGFloat val = ABI42_0_0RCTInterpolateValueInRange(inputValue,
                                                          _inputRange,
                                                          _outputs[--i],
                                                          _extrapolateLeft,
                                                          _extrapolateRight);
