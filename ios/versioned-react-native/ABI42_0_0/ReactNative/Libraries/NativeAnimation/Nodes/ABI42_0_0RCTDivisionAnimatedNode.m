...
#import <ABI42_0_0React/ABI42_0_0RCTDivisionAnimatedNode.h>

#import <ABI42_0_0React/ABI42_0_0RCTLog.h>

@implementation ABI42_0_0RCTDivisionAnimatedNode
...
- (void)performUpdate
{
  ...
  if (inputNodes.count > 1) {
    ...
    if ([parent1 isKindOfClass:[ABI42_0_0RCTValueAnimatedNode class]] &&
      ...
      if (parent2.value == 0) {
        ABI42_0_0RCTLogError(@"Detected a division by zero in Animated.divide node");
        return;
      }
