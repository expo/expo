...
#import "ABI42_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI42_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ABI42_0_0ReactViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ABI42_0_0ReactViewController detachChildViewController:self.contentViewController];
}
