...
#import <ABI42_0_0React/components/text/ParagraphComponentDescriptor.h>
#import <ABI42_0_0React/components/text/ParagraphProps.h>
#import <ABI42_0_0React/components/text/ParagraphState.h>
#import <ABI42_0_0React/components/text/RawTextComponentDescriptor.h>
#import <ABI42_0_0React/components/text/TextComponentDescriptor.h>
#import <ABI42_0_0React/graphics/Geometry.h>
#import <ABI42_0_0React/textlayoutmanager/ABI42_0_0RCTAttributedTextUtils.h>
#import <ABI42_0_0React/textlayoutmanager/ABI42_0_0RCTTextLayoutManager.h>
#import <ABI42_0_0React/textlayoutmanager/TextLayoutManager.h>
...
@implementation ABI42_0_0RCTParagraphComponentView {
...
- (NSAttributedString *_Nullable)attributedText
{
  ...
  return ABI42_0_0RCTNSAttributedStringFromAttributedString(_state->getData().attributedString);
}
...
- (void)drawRect:(CGRect)rect
{
  ...
  ABI42_0_0RCTTextLayoutManager *nativeTextLayoutManager =
      (ABI42_0_0RCTTextLayoutManager *)unwrapManagedObject(textLayoutManager->getNativeTextLayoutManager());

  CGRect frame = ABI42_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
...
{
  NSString *superAccessibilityLabel = ABI42_0_0RCTNSStringFromStringNilIfEmpty(_props->accessibilityLabel);
  ...
  return ABI42_0_0RCTNSStringFromString(_state->getData().attributedString.getString());
}
