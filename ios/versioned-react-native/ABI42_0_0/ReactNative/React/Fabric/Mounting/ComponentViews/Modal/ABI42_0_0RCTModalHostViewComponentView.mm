...
#import "ABI42_0_0RCTModalHostViewComponentView.h"

#import <ABI42_0_0React/ABI42_0_0UIView+React.h>
#import <ABI42_0_0React/components/modal/ModalHostViewComponentDescriptor.h>
#import <ABI42_0_0React/components/modal/ModalHostViewState.h>
...
#import "ABI42_0_0RCTFabricModalHostViewController.h"
...
@interface ABI42_0_0RCTModalHostViewComponentView () <ABI42_0_0RCTFabricModalHostViewControllerDelegate>

@end

@implementation ABI42_0_0RCTModalHostViewComponentView {
  ABI42_0_0RCTFabricModalHostViewController *_viewController;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _viewController = [ABI42_0_0RCTFabricModalHostViewController new];
...
- (void)ensurePresentedOnlyIfNeeded
{
  ...
  if (shouldBePresented) {
    UIViewController *controller = [self ABI42_0_0ReactViewController];
    _isPresented = YES;
    return [controller
...
#pragma mark - ABI42_0_0RCTFabricModalHostViewControllerDelegate
...
- (void)boundsDidChange:(CGRect)newBounds
{
  ...
  if (_state != nullptr) {
    auto newState = ModalHostViewState{ABI42_0_0RCTSizeFromCGSize(newBounds.size)};
...
Class<ABI42_0_0RCTComponentViewProtocol> ABI42_0_0RCTModalHostViewCls(void)
{
  return ABI42_0_0RCTModalHostViewComponentView.class;
}
