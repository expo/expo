...
#import "ABI42_0_0RCTSliderComponentView.h"
...
#import <ABI42_0_0React/components/slider/SliderComponentDescriptor.h>

#import "ABI42_0_0FBABI42_0_0RCTFabricComponentsPlugins.h"

using namespace ABI42_0_0facebook::ABI42_0_0React;

@interface ABI42_0_0RCTSliderComponentView () <ABI42_0_0RCTImageResponseDelegate>
@end

@implementation ABI42_0_0RCTSliderComponentView {
  ...
  ABI42_0_0RCTImageResponseObserverProxy _trackImageResponseObserverProxy;
  ABI42_0_0RCTImageResponseObserverProxy _minimumTrackImageResponseObserverProxy;
  ABI42_0_0RCTImageResponseObserverProxy _maximumTrackImageResponseObserverProxy;
  ABI42_0_0RCTImageResponseObserverProxy _thumbImageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _trackImageResponseObserverProxy = ABI42_0_0RCTImageResponseObserverProxy(self);
    _minimumTrackImageResponseObserverProxy = ABI42_0_0RCTImageResponseObserverProxy(self);
    _maximumTrackImageResponseObserverProxy = ABI42_0_0RCTImageResponseObserverProxy(self);
    _thumbImageResponseObserverProxy = ABI42_0_0RCTImageResponseObserverProxy(self);
...
Class<ABI42_0_0RCTComponentViewProtocol> ABI42_0_0RCTSliderCls(void)
{
  return ABI42_0_0RCTSliderComponentView.class;
}
