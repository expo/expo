...
#import <ABI42_0_0React/ABI42_0_0RCTTouchableComponentViewProtocol.h>
#import <ABI42_0_0React/ABI42_0_0UIView+ComponentViewProtocol.h>
 ...
 */
@interface ABI42_0_0RCTViewComponentView : UIView <ABI42_0_0RCTComponentViewProtocol, ABI42_0_0RCTTouchableComponentViewProtocol> {
 @protected
  ABI42_0_0facebook::ABI42_0_0React::LayoutMetrics _layoutMetrics;
  ABI42_0_0facebook::ABI42_0_0React::SharedViewProps _props;
  ABI42_0_0facebook::ABI42_0_0React::SharedViewEventEmitter _eventEmitter;
}
...
/**
 * Enforcing `call super` semantic for overridden methods from `ABI42_0_0RCTComponentViewProtocol`.
 * The methods update the instance variables.
 */
- (void)updateProps:(ABI42_0_0facebook::ABI42_0_0React::Props::Shared const &)props
           oldProps:(ABI42_0_0facebook::ABI42_0_0React::Props::Shared const &)oldProps NS_REQUIRES_SUPER;
- (void)updateEventEmitter:(ABI42_0_0facebook::ABI42_0_0React::EventEmitter::Shared const &)eventEmitter NS_REQUIRES_SUPER;
- (void)updateLayoutMetrics:(ABI42_0_0facebook::ABI42_0_0React::LayoutMetrics const &)layoutMetrics
           oldLayoutMetrics:(ABI42_0_0facebook::ABI42_0_0React::LayoutMetrics const &)oldLayoutMetrics NS_REQUIRES_SUPER;
