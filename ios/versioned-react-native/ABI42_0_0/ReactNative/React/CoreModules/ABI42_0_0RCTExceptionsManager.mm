...
#import "ABI42_0_0RCTExceptionsManager.h"
...
@interface ABI42_0_0RCTExceptionsManager () <ABI42_0_0NativeExceptionsManagerSpec>

@end

@implementation ABI42_0_0RCTExceptionsManager

@synthesize bridge = _bridge;

ABI42_0_0RCT_EXPORT_MODULE()

- (instancetype)initWithDelegate:(id<ABI42_0_0RCTExceptionsManagerDelegate>)delegate
{
  if ((self = [self init])) {
    _delegate = delegate;
  }
     ...
     suppressRedBox:(BOOL)suppressRedBox
{
  ...
  if (!ABI42_0_0RCT_DEBUG && reloadRetries < _maxReloadAttempts) {
    reloadRetries++;
    ABI42_0_0RCTTriggerReloadCommandListeners(@"JS Crash Reload");
  } else if (!ABI42_0_0RCT_DEV || !suppressRedBox) {
    NSString *description = [@"Unhandled JS Exception: " stringByAppendingString:message];
    NSDictionary *errorInfo = @{NSLocalizedDescriptionKey : description, ABI42_0_0RCTJSStackTraceKey : stack};
    ABI42_0_0RCTFatal([NSError errorWithDomain:ABI42_0_0RCTErrorDomain code:0 userInfo:errorInfo]);
  }
}

ABI42_0_0RCT_EXPORT_METHOD(reportSoftException
...
ABI42_0_0RCT_EXPORT_METHOD(reportFatalException
                  : (NSString *)message stack
                  : (NSArray<NSDictionary *> *)stack exceptionId
                  : (double)exceptionId)
{
...
ABI42_0_0RCT_EXPORT_METHOD(updateExceptionMessage
                  : (NSString *)message stack
                  : (NSArray<NSDictionary *> *)stack exceptionId
                  : (double)exceptionId)
{
...
ABI42_0_0RCT_EXPORT_METHOD(reportUnhandledException : (NSString *)message stack : (NSArray<NSDictionary *> *)stack)
{
  [self reportFatalException:message stack:stack exceptionId:-1];
}

ABI42_0_0RCT_EXPORT_METHOD(dismissRedbox) {}

ABI42_0_0RCT_EXPORT_METHOD(reportException : (JS::NativeExceptionsManager::ExceptionData &)data)
{
...
{
  return std::make_shared<ABI42_0_0facebook::ABI42_0_0React::NativeExceptionsManagerSpecJSI>(self, jsInvoker, nativeInvoker, perfLogger);
}

@end

Class ABI42_0_0RCTExceptionsManagerCls(void)
{
  return ABI42_0_0RCTExceptionsManager.class;
}
