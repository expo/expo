...
#import "ABI42_0_0RCTAccessibilityManager.h"
...
NSString *const ABI42_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification =
    @"ABI42_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification";

@interface ABI42_0_0RCTAccessibilityManager () <ABI42_0_0NativeAccessibilityManagerSpec>
...
@implementation ABI42_0_0RCTAccessibilityManager
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    self.contentSizeCategory = ABI42_0_0RCTSharedApplication().preferredContentSizeCategory;
...
- (void)invalidateMultiplier
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI42_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification
                                                      object:self];
}
...
- (CGFloat)multiplierForContentSizeCategory:(NSString *)category
{
  ...
  if (m.doubleValue <= 0.0) {
    ABI42_0_0RCTLogError(@"Can't determine multiplier for category %@. Using 1.0.", category);
    m = @1.0;
  }
...
ABI42_0_0RCT_EXPORT_METHOD(setAccessibilityContentSizeMultipliers
...
ABI42_0_0RCT_EXPORT_METHOD(setAccessibilityFocus : (double)ABI42_0_0ReactTag)
{
  dispatch_async(dispatch_get_main_queue(), ^{
    UIView *view = [self.bridge.uiManager viewForABI42_0_0ReactTag:@(ABI42_0_0ReactTag)];
    UIAccessibilityPostNotification(UIAccessibilityLayoutChangedNotification, view);
  });
}

ABI42_0_0RCT_EXPORT_METHOD(announceForAccessibility : (NSString *)announcement)
{
  UIAccessibilityPostNotification(UIAccessibilityAnnouncementNotification, announcement);
}

ABI42_0_0RCT_EXPORT_METHOD(getMultiplier : (ABI42_0_0RCTResponseSenderBlock)callback)
{
  if (callback) {
...
ABI42_0_0RCT_EXPORT_METHOD(getCurrentBoldTextState
                  : (ABI42_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI42_0_0RCTResponseSenderBlock)onError)
{
  onSuccess(@[ @(_isBoldTextEnabled) ]);
}

ABI42_0_0RCT_EXPORT_METHOD(getCurrentGrayscaleState
                  : (ABI42_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI42_0_0RCTResponseSenderBlock)onError)
{
...
ABI42_0_0RCT_EXPORT_METHOD(getCurrentInvertColorsState
                  : (ABI42_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI42_0_0RCTResponseSenderBlock)onError)
{
...
ABI42_0_0RCT_EXPORT_METHOD(getCurrentReduceMotionState
                  : (ABI42_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI42_0_0RCTResponseSenderBlock)onError)
{
...
ABI42_0_0RCT_EXPORT_METHOD(getCurrentReduceTransparencyState
                  : (ABI42_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI42_0_0RCTResponseSenderBlock)onError)
{
...
ABI42_0_0RCT_EXPORT_METHOD(getCurrentVoiceOverState
                  : (ABI42_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI42_0_0RCTResponseSenderBlock)onError)
{
...
{
  return std::make_shared<ABI42_0_0facebook::ABI42_0_0React::NativeAccessibilityManagerSpecJSI>(
      self, jsInvoker, nativeInvoker, perfLogger);
}

@end

@implementation ABI42_0_0RCTBridge (ABI42_0_0RCTAccessibilityManager)

- (ABI42_0_0RCTAccessibilityManager *)accessibilityManager
{
  return [self moduleForClass:[ABI42_0_0RCTAccessibilityManager class]];
}

@end

Class ABI42_0_0RCTAccessibilityManagerCls(void)
{
  return ABI42_0_0RCTAccessibilityManager.class;
}
