...
@protocol ABI42_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI42_0_0RCTExceptionsManager : NSObject <ABI42_0_0RCTBridgeModule>
...
@property (nonatomic, weak) id<ABI42_0_0RCTExceptionsManagerDelegate> delegate;
