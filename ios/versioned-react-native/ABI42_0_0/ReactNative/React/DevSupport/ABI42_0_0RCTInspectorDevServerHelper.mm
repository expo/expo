...
static NSURL *getInspectorDeviceUrl(NSURL *bundleURL)
{
  ...
  NSString *inspectorProxyPortStr = [[[NSProcessInfo processInfo] environment] objectForKey:@"ABI42_0_0RCT_METRO_PORT"];
...
@implementation ABI42_0_0RCTInspectorDevServerHelper

ABI42_0_0RCT_NOT_IMPLEMENTED(-(instancetype)init)

static NSMutableDictionary<NSString *, ABI42_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
...
+ (ABI42_0_0RCTInspectorPackagerConnection *)connectWithBundleURL:(NSURL *)bundleURL
{
  ...
  ABI42_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection || !connection.isConnected) {
    connection = [[ABI42_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
