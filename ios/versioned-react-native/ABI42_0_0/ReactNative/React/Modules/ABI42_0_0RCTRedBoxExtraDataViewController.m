...
#import "ABI42_0_0RCTRedBoxExtraDataViewController.h"

@interface ABI42_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI42_0_0RCTRedBoxExtraDataCell
...
@interface ABI42_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI42_0_0RCTRedBoxExtraDataViewController {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  ABI42_0_0RCTRedBoxExtraDataCell *cell =
      (ABI42_0_0RCTRedBoxExtraDataCell *)[tableView dequeueReusableCellWithIdentifier:reuseIdentifier];

  if (cell == nil) {
    cell = [[ABI42_0_0RCTRedBoxExtraDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
  }
