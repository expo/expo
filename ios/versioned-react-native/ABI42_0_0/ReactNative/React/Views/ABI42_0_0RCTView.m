...
UIAccessibilityTraits const ABI42_0_0SwitchAccessibilityTrait = 0x20000000000001;

@implementation UIView (ABI42_0_0RCTViewUnmounting)
...
- (void)ABI42_0_0React_remountAllSubviews
{
  ...
  for (UIView *subview in self.subviews) {
    [subview ABI42_0_0React_remountAllSubviews];
  }
}
...
- (void)ABI42_0_0React_updateClippedSubviewsWithClipRect:(CGRect)clipRect relativeToView:(UIView *)clipView
{
  ...
  for (UIView *subview in self.subviews) {
    [subview ABI42_0_0React_updateClippedSubviewsWithClipRect:clipRect relativeToView:clipView];
  }
}
...
- (UIView *)ABI42_0_0React_findClipView
{
  ...
  while (testView) {
    ...
    if ([testView isABI42_0_0ReactRootView]) {
      break;
    }
...
@implementation ABI42_0_0RCTView {
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if ((self = [super initWithFrame:frame])) {
    ...
    _borderStyle = ABI42_0_0RCTBorderStyleSolid;
...
{
  if (_ABI42_0_0ReactLayoutDirection != layoutDirection) {
    _ABI42_0_0ReactLayoutDirection = layoutDirection;
...
- (BOOL)didActivateAccessibilityCustomAction:(UIAccessibilityCustomAction *)action
{
  ...
  if (actionObject) {
    _onAccessibilityAction(@{@"actionName" : actionObject[@"name"], @"actionTarget" : self.ABI42_0_0ReactTag});
  }
  return YES;
}
...
- (NSString *)accessibilityValue
{
  ...
  if ((self.accessibilityTraits & ABI42_0_0SwitchAccessibilityTrait) == ABI42_0_0SwitchAccessibilityTrait) {
...
- (void)setPointerEvents:(ABI42_0_0RCTPointerEvents)pointerEvents
{
  ...
  self.userInteractionEnabled = (pointerEvents != ABI42_0_0RCTPointerEventsNone);
  if (pointerEvents == ABI42_0_0RCTPointerEventsBoxNone) {
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
  ...
  BOOL needsHitSubview = !(_pointerEvents == ABI42_0_0RCTPointerEventsNone || _pointerEvents == ABI42_0_0RCTPointerEventsBoxOnly);
  if (needsHitSubview && (![self clipsToBounds] || isPointInside)) {
    // Take z-index into account when calculating the touch target.
    NSArray<UIView *> *sortedSubviews = [self ABI42_0_0ReactZIndexSortedSubviews];
  ...
  switch (_pointerEvents) {
    ...
    case ABI42_0_0RCTPointerEventsBoxOnly:
      return hitView;
    case ABI42_0_0RCTPointerEventsBoxNone:
      return hitSubview;
    default:
      ABI42_0_0RCTLogError(@"Invalid pointer-events specified %lld on %@", (long long)_pointerEvents, self);
      return hitSubview ?: hitView;
  }
}
...
{
  if (self.ABI42_0_0ReactAccessibilityElement == self) {
...
- (BOOL)performAccessibilityAction:(NSString *)name
{
  if (_onAccessibilityAction && accessibilityActionsNameMap[name]) {
    _onAccessibilityAction(@{@"actionName" : name, @"actionTarget" : self.ABI42_0_0ReactTag});
    return YES;
  }
  return NO;
}
...
- (NSString *)description
{
  ...
  NSString *replacement = [NSString stringWithFormat:@"; ABI42_0_0ReactTag: %@;", self.ABI42_0_0ReactTag];
...
{
  while (view) {
    UIViewController *controller = view.ABI42_0_0ReactViewController;
    if (controller) {
...
- (void)ABI42_0_0React_remountAllSubviews
{
  if (_removeClippedSubviews) {
    for (UIView *view in self.ABI42_0_0ReactSubviews) {
      if (view.superview != self) {
        [self addSubview:view];
        [view ABI42_0_0React_remountAllSubviews];
      }
    }
  } else {
    // If _removeClippedSubviews is false, we must already be showing all subviews
    [super ABI42_0_0React_remountAllSubviews];
  }
}
...
- (void)ABI42_0_0React_updateClippedSubviewsWithClipRect:(CGRect)clipRect relativeToView:(UIView *)clipView
{
  ...
  if (!_removeClippedSubviews) {
    ...
    return [super ABI42_0_0React_updateClippedSubviewsWithClipRect:clipRect relativeToView:clipView];
  }

  if (self.ABI42_0_0ReactSubviews.count == 0) {
  ...
  for (UIView *view in self.ABI42_0_0ReactSubviews) {
    if (!CGSizeEqualToSize(CGRectIntersection(clipRect, view.frame).size, CGSizeZero)) {
      ...
      if (CGRectContainsRect(clipRect, view.frame)) {
        ...
        [view ABI42_0_0React_updateClippedSubviewsWithClipRect:clipRect relativeToView:clipView];
      }
...
- (void)setRemoveClippedSubviews:(BOOL)removeClippedSubviews
{
  if (!removeClippedSubviews && _removeClippedSubviews) {
    [self ABI42_0_0React_remountAllSubviews];
  }
...
- (void)updateClippedSubviews
{
  ...
  if (clipView) {
    [self ABI42_0_0React_updateClippedSubviewsWithClipRect:clipView.bounds relativeToView:clipView];
  }
}
...
static CGFloat ABI42_0_0RCTDefaultIfNegativeTo(CGFloat defaultValue, CGFloat x)
{
...
- (UIEdgeInsets)bordersAsInsets
{
  ...
  const BOOL isRTL = _ABI42_0_0ReactLayoutDirection == UIUserInterfaceLayoutDirectionRightToLeft;

  if ([[ABI42_0_0RCTI18nUtil sharedInstance] doLeftAndRightSwapInRTL]) {
    const CGFloat borderStartWidth = ABI42_0_0RCTDefaultIfNegativeTo(_borderLeftWidth, _borderStartWidth);
    const CGFloat borderEndWidth = ABI42_0_0RCTDefaultIfNegativeTo(_borderRightWidth, _borderEndWidth);
    ...
    return (UIEdgeInsets){
        ABI42_0_0RCTDefaultIfNegativeTo(borderWidth, _borderTopWidth),
        ABI42_0_0RCTDefaultIfNegativeTo(borderWidth, directionAwareBorderLeftWidth),
        ABI42_0_0RCTDefaultIfNegativeTo(borderWidth, _borderBottomWidth),
        ABI42_0_0RCTDefaultIfNegativeTo(borderWidth, directionAwareBorderRightWidth),
    };
  }
  ...
  return (UIEdgeInsets){
      ABI42_0_0RCTDefaultIfNegativeTo(borderWidth, _borderTopWidth),
      ABI42_0_0RCTDefaultIfNegativeTo(borderWidth, ABI42_0_0RCTDefaultIfNegativeTo(_borderLeftWidth, directionAwareBorderLeftWidth)),
      ABI42_0_0RCTDefaultIfNegativeTo(borderWidth, _borderBottomWidth),
      ABI42_0_0RCTDefaultIfNegativeTo(borderWidth, ABI42_0_0RCTDefaultIfNegativeTo(_borderRightWidth, directionAwareBorderRightWidth)),
  };
}
...
- (ABI42_0_0RCTCornerRadii)cornerRadii
{
  ...
  if ([[ABI42_0_0RCTI18nUtil sharedInstance] doLeftAndRightSwapInRTL]) {
    const CGFloat topStartRadius = ABI42_0_0RCTDefaultIfNegativeTo(_borderTopLeftRadius, _borderTopStartRadius);
    const CGFloat topEndRadius = ABI42_0_0RCTDefaultIfNegativeTo(_borderTopRightRadius, _borderTopEndRadius);
    const CGFloat bottomStartRadius = ABI42_0_0RCTDefaultIfNegativeTo(_borderBottomLeftRadius, _borderBottomStartRadius);
    const CGFloat bottomEndRadius = ABI42_0_0RCTDefaultIfNegativeTo(_borderBottomRightRadius, _borderBottomEndRadius);
    ...
    topLeftRadius = ABI42_0_0RCTDefaultIfNegativeTo(radius, directionAwareTopLeftRadius);
    topRightRadius = ABI42_0_0RCTDefaultIfNegativeTo(radius, directionAwareTopRightRadius);
    bottomLeftRadius = ABI42_0_0RCTDefaultIfNegativeTo(radius, directionAwareBottomLeftRadius);
    bottomRightRadius = ABI42_0_0RCTDefaultIfNegativeTo(radius, directionAwareBottomRightRadius);
  } else {
    ...
    topLeftRadius =
        ABI42_0_0RCTDefaultIfNegativeTo(radius, ABI42_0_0RCTDefaultIfNegativeTo(_borderTopLeftRadius, directionAwareTopLeftRadius));
    topRightRadius =
        ABI42_0_0RCTDefaultIfNegativeTo(radius, ABI42_0_0RCTDefaultIfNegativeTo(_borderTopRightRadius, directionAwareTopRightRadius));
    bottomLeftRadius =
        ABI42_0_0RCTDefaultIfNegativeTo(radius, ABI42_0_0RCTDefaultIfNegativeTo(_borderBottomLeftRadius, directionAwareBottomLeftRadius));
    bottomRightRadius = ABI42_0_0RCTDefaultIfNegativeTo(
        radius, ABI42_0_0RCTDefaultIfNegativeTo(_borderBottomRightRadius, directionAwareBottomRightRadius));
  }

  // Get scale factors required to prevent radii from overlapping
  const CGSize size = self.bounds.size;
  const CGFloat topScaleFactor = ABI42_0_0RCTZeroIfNaN(MIN(1, size.width / (topLeftRadius + topRightRadius)));
  const CGFloat bottomScaleFactor = ABI42_0_0RCTZeroIfNaN(MIN(1, size.width / (bottomLeftRadius + bottomRightRadius)));
  const CGFloat rightScaleFactor = ABI42_0_0RCTZeroIfNaN(MIN(1, size.height / (topRightRadius + bottomRightRadius)));
  const CGFloat leftScaleFactor = ABI42_0_0RCTZeroIfNaN(MIN(1, size.height / (topLeftRadius + bottomLeftRadius)));

  // Return scaled radii
  return (ABI42_0_0RCTCornerRadii){
...
- (ABI42_0_0RCTBorderColors)borderColors
{
  ...
  if ([[ABI42_0_0RCTI18nUtil sharedInstance] doLeftAndRightSwapInRTL]) {
    ...
    return (ABI42_0_0RCTBorderColors){
...
- (void)displayLayer:(CALayer *)layer
{
  ...
  ABI42_0_0RCTUpdateShadowPathForView(self);

  const ABI42_0_0RCTCornerRadii cornerRadii = [self cornerRadii];
  const UIEdgeInsets borderInsets = [self bordersAsInsets];
  const ABI42_0_0RCTBorderColors borderColors = [self borderColors];

  BOOL useIOSBorderRendering = ABI42_0_0RCTCornerRadiiAreEqual(cornerRadii) && ABI42_0_0RCTBorderInsetsAreEqual(borderInsets) &&
      ABI42_0_0RCTBorderColorsAreEqual(borderColors) && _borderStyle == ABI42_0_0RCTBorderStyleSolid &&
...
static BOOL ABI42_0_0RCTLayerHasShadow(CALayer *layer)
{
  return layer.shadowOpacity * CGColorGetAlpha(layer.shadowColor) > 0;
}

static void ABI42_0_0RCTUpdateShadowPathForView(ABI42_0_0RCTView *view)
{
  if (ABI42_0_0RCTLayerHasShadow(view.layer)) {
    if (CGColorGetAlpha(view.backgroundColor.CGColor) > 0.999) {
      // If view has a solid background color, calculate shadow path from border
      const ABI42_0_0RCTCornerRadii cornerRadii = [view cornerRadii];
      const ABI42_0_0RCTCornerInsets cornerInsets = ABI42_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero);
      CGPathRef shadowPath = ABI42_0_0RCTPathCreateWithRoundedRect(view.bounds, cornerInsets, NULL);
...
- (void)updateClippingForLayer:(CALayer *)layer
{
  ...
  if (self.clipsToBounds) {
    const ABI42_0_0RCTCornerRadii cornerRadii = [self cornerRadii];
    if (ABI42_0_0RCTCornerRadiiAreEqual(cornerRadii)) {
      cornerRadius = cornerRadii.topLeft;

    } else {
      CAShapeLayer *shapeLayer = [CAShapeLayer layer];
      CGPathRef path =
          ABI42_0_0RCTPathCreateWithRoundedRect(self.bounds, ABI42_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
...
#define setBorderStyle(side)                            \
  -(void)setBorder##side##Style : (ABI42_0_0RCTBorderStyle)style \
  {                                                     \
