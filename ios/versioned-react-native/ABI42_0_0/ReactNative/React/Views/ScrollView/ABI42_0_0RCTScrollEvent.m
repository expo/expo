...
@implementation ABI42_0_0RCTScrollEvent {
...
- (ABI42_0_0RCTScrollEvent *)coalesceWithEvent:(ABI42_0_0RCTScrollEvent *)newEvent
{
...
- (NSArray *)arguments
{
  return @[ self.viewTag, ABI42_0_0RCTNormalizeInputEventName(self.eventName), [self body] ];
}
