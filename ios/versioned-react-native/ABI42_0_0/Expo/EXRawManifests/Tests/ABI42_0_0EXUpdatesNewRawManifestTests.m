...
@interface ABI42_0_0EXUpdatesNewRawManifestTests : XCTestCase

@end

@implementation ABI42_0_0EXUpdatesNewRawManifestTests
...
- (void)testSDKVersion_ValidCases {
  ...
  ABI42_0_0EXUpdatesNewRawManifest *manifest = [[ABI42_0_0EXUpdatesNewRawManifest alloc] initWithRawManifestJSON:manifestJson];
