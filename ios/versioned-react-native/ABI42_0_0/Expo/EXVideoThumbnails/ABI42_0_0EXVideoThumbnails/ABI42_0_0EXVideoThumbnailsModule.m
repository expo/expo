...
#import <ABI42_0_0EXVideoThumbnails/ABI42_0_0EXVideoThumbnailsModule.h>
...
@implementation ABI42_0_0EXVideoThumbnailsModule

ABI42_0_0UM_EXPORT_MODULE(ExpoVideoThumbnails);
...
ABI42_0_0UM_EXPORT_METHOD_AS(getThumbnail,
                    ...
                    reject:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  ...
  if ([url isFileURL]) {
    ...
    if (!([_fileSystem permissionsForURI:url] & ABI42_0_0EXFileSystemPermissionRead)) {
