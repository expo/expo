...
@implementation ABI42_0_0EXProvisioningProfile {
  NSDictionary *_plist;
}

+ (nonnull instancetype)mainProvisioningProfile
{
  static ABI42_0_0EXProvisioningProfile *profile;
...
- (ABI42_0_0EXAppReleaseType)appReleaseType {
  ...
  if (!provisioningPath) {
    ...
    return ABI42_0_0EXAppReleaseSimulator;
#else
    return ABI42_0_0EXAppReleaseAppStore;
#endif
  }
  ...
  if (!mobileProvision) {
    ...
    return ABI42_0_0EXAppReleaseTypeUnknown;
    ...
    return ABI42_0_0EXAppReleaseEnterprise;
    ...
    if ([[entitlements objectForKey:@"get-task-allow"] boolValue]) {
      return ABI42_0_0EXAppReleaseDev;
    } else {
      return ABI42_0_0EXAppReleaseAdHoc;
    }
  } else {
