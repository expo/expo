...
@implementation ABI42_0_0RNCSafeAreaProvider
{
...
{
  // This gets called before the view size is set by ABI42_0_0React-native so
  ...
  if (
    _initialInsetsSent &&
    ABI42_0_0UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI42_0_0RCTScreenScale()) &&
