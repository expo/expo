...
@protocol ABI42_0_0EXUserNotificationCenterService
...
@protocol ABI42_0_0EXNotificationsScopedModuleDelegate
...
@interface ABI42_0_0EXNotifications : ABI42_0_0EXScopedBridgeModule
