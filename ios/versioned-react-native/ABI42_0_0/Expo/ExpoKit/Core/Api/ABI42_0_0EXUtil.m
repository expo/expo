...
@interface ABI42_0_0EXUtil ()

@property (nonatomic, weak) id<ABI42_0_0EXUtilService> kernelUtilService;

@end

ABI42_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI42_0_0EXUtil, util)

@implementation ABI42_0_0EXUtil
...
- (instancetype)initWithExperienceStableLegacyId:(NSString *)experienceStableLegacyId
                           ...
                           kernelServiceDelegate:(id<ABI42_0_0EXUtilService>)kernelServiceInstance
