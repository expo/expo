...
@interface ABI42_0_0RNCAppearanceProvider ()

@property (nonatomic, weak) ABI42_0_0RCTBridge *bridge;

@end

@implementation ABI42_0_0RNCAppearanceProvider

- (instancetype)initWithBridge:(nonnull ABI42_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    _bridge = bridge;
  }
...
- (void)notifyUserInterfaceStyleChanged
{
  ...
  if (self.bridge) {
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ABI42_0_0RNCUserInterfaceStyleDidChangeNotification"
                                                        object:self.bridge
