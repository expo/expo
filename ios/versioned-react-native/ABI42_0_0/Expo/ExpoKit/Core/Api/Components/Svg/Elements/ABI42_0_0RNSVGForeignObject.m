...
@implementation ABI42_0_0RNSVGForeignObject
...
- (void)renderGroupTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    [self traverseSubviews:^(ABI42_0_0RNSVGView *node) {
        if ([node isKindOfClass:[ABI42_0_0RNSVGMask class]] || [node isKindOfClass:[ABI42_0_0RNSVGClipPath class]]) {
            // no-op
        } else if ([node isKindOfClass:[ABI42_0_0RNSVGNode class]]) {
            ABI42_0_0RNSVGNode* svgNode = (ABI42_0_0RNSVGNode*)node;
            ...
            if ([node isKindOfClass:[ABI42_0_0RNSVGRenderable class]]) {
                [(ABI42_0_0RNSVGRenderable*)node mergeProperties:self];
            }
            ...
            if ([node isKindOfClass:[ABI42_0_0RNSVGRenderable class]]) {
                [(ABI42_0_0RNSVGRenderable*)node resetProperties];
            }
        } else if ([node isKindOfClass:[ABI42_0_0RNSVGSvgView class]]) {
            ABI42_0_0RNSVGSvgView* svgView = (ABI42_0_0RNSVGSvgView*)node;
...
- (void)setForeignObjectwidth:(ABI42_0_0RNSVGLength *)foreignObjectwidth
{
...
- (void)setForeignObjectheight:(ABI42_0_0RNSVGLength *)foreignObjectheight
{
