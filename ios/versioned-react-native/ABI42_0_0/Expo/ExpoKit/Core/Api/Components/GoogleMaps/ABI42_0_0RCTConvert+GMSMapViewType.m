//
//  ABI42_0_0RCTConvert+GMSMapViewType.m
//
...
@implementation ABI42_0_0RCTConvert (GMSMapViewType)
  ABI42_0_0RCT_ENUM_CONVERTER(GMSMapViewType,
  (
    @{
...
+ (GMSCameraPosition*)GMSCameraPosition:(id)json
{
    ...
    return [ABI42_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:nil];
}
