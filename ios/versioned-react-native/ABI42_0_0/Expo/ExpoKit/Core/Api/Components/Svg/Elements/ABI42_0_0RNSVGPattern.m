...
@implementation ABI42_0_0RNSVGPattern
...
{
    self.dirty = false;
    NSArray<ABI42_0_0RNSVGLength *> *points = @[self.x, self.y, self.patternwidth, self.patternheight];
...
- (void)setPatternwidth:(ABI42_0_0RNSVGLength *)patternwidth
{
...
- (void)setPatternheight:(ABI42_0_0RNSVGLength *)patternheight
{
...
- (void)setPatternUnits:(ABI42_0_0RNSVGUnits)patternUnits
{
...
- (void)setPatternContentUnits:(ABI42_0_0RNSVGUnits)patternContentUnits
{
