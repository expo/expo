...
#import "ABI42_0_0AIRMapManager.h"
...
#import "ABI42_0_0AIRMapSnapshot.h"
...
@interface ABI42_0_0AIRMapManager() <MKMapViewDelegate, UIGestureRecognizerDelegate>

- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer;

@end

@implementation ABI42_0_0AIRMapManager{
   BOOL _hasObserver;
}
...
- (UIView *)view
{
    ABI42_0_0AIRMap *map = [ABI42_0_0AIRMap new];
    map.delegate = self;
...
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
...
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(maxDelta, CGFloat)
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(minDelta, CGFloat)
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(compassOffset, CGPoint)
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(legalLabelInsets, UIEdgeInsets)
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(mapPadding, UIEdgeInsets)
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, MKMapType)
...
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(onDoublePress, ABI42_0_0RCTBubblingEventBlock)
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerPress, ABI42_0_0RCTDirectEventBlock)
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI42_0_0RCTDirectEventBlock)
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI42_0_0RCTDirectEventBlock)
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI42_0_0RCTDirectEventBlock)
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI42_0_0RCTDirectEventBlock)
ABI42_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI42_0_0RCTDirectEventBlock)
...
ABI42_0_0RCT_CUSTOM_VIEW_PROPERTY(initialRegion, MKCoordinateRegion, ABI42_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setInitialRegion:[ABI42_0_0RCTConvert MKCoordinateRegion:json]];
    view.ignoreRegionChanges = originalIgnore;
}
ABI42_0_0RCT_CUSTOM_VIEW_PROPERTY(initialCamera, MKMapCamera, ABI42_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setInitialCamera:[ABI42_0_0RCTConvert MKMapCamera:json]];
    view.ignoreRegionChanges = originalIgnore;
}
...
ABI42_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI42_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setRegion:[ABI42_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}

ABI42_0_0RCT_CUSTOM_VIEW_PROPERTY(camera, MKMapCamera*, ABI42_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setCamera:[ABI42_0_0RCTConvert MKMapCamera:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}
                  ...
                  rejecter:(ABI42_0_0RCTPromiseRejectBlock)reject)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI42_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        id view = viewRegistry[ABI42_0_0ReactTag];
        ABI42_0_0AIRMap *mapView = (ABI42_0_0AIRMap *)view;
        if (![view isKindOfClass:[ABI42_0_0AIRMap class]]) {
                  ...
                  camera:(id)json)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI42_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI42_0_0AIRMap class]]) {
            ...
            MKMapCamera *camera = [ABI42_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:[mapView camera]];
                  ...
                  withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI42_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI42_0_0AIRMap class]]) {
            ...
            BOOL originalIgnore = mapView.ignoreRegionChanges;
            mapView.ignoreRegionChanges = YES;
            [ABI42_0_0AIRMap animateWithDuration:duration/1000 animations:^{
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI42_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI42_0_0AIRMap class]]) {
            ...
            [ABI42_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI42_0_0AIRMap *)view setRegion:region animated:YES];
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI42_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI42_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ...
                return [marker isKindOfClass:[ABI42_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
...
- (void)takeMapSnapshot:(ABI42_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI42_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI42_0_0AIRMap *map = (ABI42_0_0AIRMap *)recognizer.view;
    ...
    ABI42_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI42_0_0AIRMapPolygon class]]){
            ABI42_0_0AIRMapPolygon *polygon = (ABI42_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI42_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI42_0_0AIRMapPolyline class]]){
            ABI42_0_0AIRMapPolyline *polyline = (ABI42_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
        ...
        if ([overlay isKindOfClass:[ABI42_0_0AIRMapOverlay class]]) {
            ABI42_0_0AIRMapOverlay *imageOverlay = (ABI42_0_0AIRMapOverlay*) overlay;
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI42_0_0AIRMapPolyline class]]) {
        return ((ABI42_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI42_0_0AIRMapPolygon class]]) {
        return ((ABI42_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI42_0_0AIRMapCircle class]]) {
        return ((ABI42_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI42_0_0AIRMapUrlTile class]]) {
        return ((ABI42_0_0AIRMapUrlTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI42_0_0AIRMapWMSTile class]]) {
        return ((ABI42_0_0AIRMapWMSTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI42_0_0AIRMapLocalTile class]]) {
        return ((ABI42_0_0AIRMapLocalTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI42_0_0AIRMapOverlay class]]) {
        return ((ABI42_0_0AIRMapOverlay *)overlay).renderer;
...
{
    if ([view.annotation isKindOfClass:[ABI42_0_0AIRMapMarker class]]) {
        [(ABI42_0_0AIRMapMarker *)view.annotation showCalloutView];
...
- (void)mapView:(ABI42_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI42_0_0AIRMapMarker class]]) {
        [(ABI42_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI42_0_0AIRMap *)mapView viewForAnnotation:(ABI42_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI42_0_0AIRMapMarker class]]) {
...
- (void)mapView:(ABI42_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI42_0_0AIRMapMarker class]]) return;
    ABI42_0_0AIRMapMarker *marker = (ABI42_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI42_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI42_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    id event = @{@"coordinate": @{
    ...
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI42_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI42_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI42_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    [self _regionChanged:mapView];

    ABI42_0_0AIRWeakTimerReference *weakTarget = [[ABI42_0_0AIRWeakTimerReference alloc] initWithTarget:self andSelector:@selector(_onTick:)];
    
    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI42_0_0AIRMapRegionChangeObserveInterval
                                                               target:weakTarget
                                                             selector:@selector(timerDidFire:)
                                                             userInfo:@{ ABI42_0_0RCTMapViewKey: [[ABI42_0_0AIRWeakMapReference alloc] initWithMapView: mapView] }
                                                              repeats:YES];

    [[NSRunLoop mainRunLoop] addTimer:mapView.regionChangeObserveTimer forMode:NSRunLoopCommonModes];
}

- (void)mapView:(ABI42_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI42_0_0AIRMap *)mapView
{
    if (!mapView.hasStartedRendering) {
      mapView.onMapReady(@{});
...
- (void)mapViewDidFinishRenderingMap:(ABI42_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
{
    ABI42_0_0AIRWeakMapReference *weakRef = timer.userInfo[ABI42_0_0RCTMapViewKey];
    [self _regionChanged:weakRef.mapView];
}

- (void)_regionChanged:(ABI42_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI42_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI42_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI42_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI42_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI42_0_0AIRMap *)mapView
{
...
- (MKCoordinateSpan)coordinateSpanWithMapView:(ABI42_0_0AIRMap *)mapView
                             centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                 andZoomLevel:(double)zoomLevel
{
    // convert center coordiate to pixel space
    double centerPixelX = [ABI42_0_0AIRMapManager longitudeToPixelSpaceX:centerCoordinate.longitude];
    double centerPixelY = [ABI42_0_0AIRMapManager latitudeToPixelSpaceY:centerCoordinate.latitude];

    // determine the scale value from the zoom level
    double zoomExponent = ABI42_0_0AIRMapMaxZoomLevel - zoomLevel;
    ...
    CLLocationDegrees minLng = [ABI42_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX];
    CLLocationDegrees maxLng = [ABI42_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX + scaledMapWidth];
    CLLocationDegrees longitudeDelta = maxLng - minLng;

    // find delta between top and bottom latitudes
    CLLocationDegrees minLat = [ABI42_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY];
    CLLocationDegrees maxLat = [ABI42_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY + scaledMapHeight];
                    ...
                    mapView:(ABI42_0_0AIRMap *)mapView
{
    ...
    zoomLevel = MIN(zoomLevel, ABI42_0_0AIRMapMaxZoomLevel);
                                    ...
                                    andZoomLevel:(double)zoomLevel
{
	...
	// find delta between top and bottom latitudes
	CLLocationDegrees minLat = [ABI42_0_0AIRMapManager pixelSpaceYToLatitude:topPixelY];
	CLLocationDegrees maxLat = [ABI42_0_0AIRMapManager pixelSpaceYToLatitude:bottomPixelY];
	CLLocationDegrees latitudeDelta = -1 * (maxLat - minLat);
	...
	if (adjustedCenterPoint) {
		region.center.latitude = [ABI42_0_0AIRMapManager pixelSpaceYToLatitude:((bottomPixelY + topPixelY) / 2.0)];
	}
...
- (double) zoomLevel:(ABI42_0_0AIRMap *)mapView {
    ...
    double centerPixelX = [ABI42_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude];
    double topLeftPixelX = [ABI42_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude - region.span.longitudeDelta / 2];

    double scaledMapWidth = (centerPixelX - topLeftPixelX) * 2;
    CGSize mapSizeInPixels = mapView.bounds.size;
    double zoomScale = scaledMapWidth / mapSizeInPixels.width;
    double zoomExponent = log(zoomScale) / log(2);
    double zoomLevel = ABI42_0_0AIRMapMaxZoomLevel - zoomExponent;
...
- (void)mapView:(ABI42_0_0AIRMap *)mapView didFailToLocateUserWithError:(NSError *)error {
