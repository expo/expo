...
if (value != nil) recognizer.prop = [ABI42_0_0RCTConvert type:value]; \
} while(0)
...
@protocol ABI42_0_0RNGestureHandlerEventEmitter

- (void)sendTouchEvent:(nonnull ABI42_0_0RNGestureHandlerEvent *)event;

- (void)sendStateChangeEvent:(nonnull ABI42_0_0RNGestureHandlerStateChange *)event;

@end


@protocol ABI42_0_0RNRootViewGestureRecognizerDelegate <UIGestureRecognizerDelegate>
...
@interface ABI42_0_0RNGestureHandler : NSObject <UIGestureRecognizerDelegate> {

@protected UIGestureRecognizer *_recognizer;
@protected ABI42_0_0RNGestureHandlerState _lastState;

}

+ (nullable ABI42_0_0RNGestureHandler *)findGestureHandlerByRecognizer:(nonnull UIGestureRecognizer *)recognizer;

- (nonnull instancetype)initWithTag:(nonnull NSNumber *)tag;

@property (nonatomic, readonly, nonnull) NSNumber *tag;
@property (nonatomic, weak, nullable) id<ABI42_0_0RNGestureHandlerEventEmitter> emitter;
...
- (nullable ABI42_0_0RNGestureHandlerEventExtraData *)eventExtraData:(nonnull id)recognizer;
