//
//  ABI42_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI42_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI42_0_0WMSTileOverlay *tile = [[ABI42_0_0WMSTileOverlay alloc] init];
...
@implementation ABI42_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
