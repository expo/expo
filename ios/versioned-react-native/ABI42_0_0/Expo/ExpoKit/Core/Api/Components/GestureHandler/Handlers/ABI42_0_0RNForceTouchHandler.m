#import "ABI42_0_0RNForceTouchHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI42_0_0React/ABI42_0_0RCTConvert.h>

@interface ABI42_0_0RNForceTouchGestureRecognizer : UIGestureRecognizer
...
@implementation ABI42_0_0RNForceTouchGestureRecognizer {
...
@implementation ABI42_0_0RNForceTouchHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI42_0_0RNForceTouchGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI42_0_0RNForceTouchGestureRecognizer *recognizer = (ABI42_0_0RNForceTouchGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    recognizer.feedbackOnActivation = [ABI42_0_0RCTConvert BOOL:prop];
  }
}

- (ABI42_0_0RNGestureHandlerEventExtraData *)eventExtraData:(ABI42_0_0RNForceTouchGestureRecognizer *)recognizer
{
