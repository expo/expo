...
@interface ABI42_0_0RNSVGRect : ABI42_0_0RNSVGRenderable

@property (nonatomic, strong) ABI42_0_0RNSVGLength* x;
@property (nonatomic, strong) ABI42_0_0RNSVGLength* y;
@property (nonatomic, strong) ABI42_0_0RNSVGLength* rectwidth;
@property (nonatomic, strong) ABI42_0_0RNSVGLength* rectheight;
