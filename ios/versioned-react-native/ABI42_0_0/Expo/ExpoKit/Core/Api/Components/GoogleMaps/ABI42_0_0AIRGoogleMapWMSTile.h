//
//  ABI42_0_0AIRGoogleMapWMSTile.h
//  AirMaps
//
...
@interface ABI42_0_0WMSTileOverlay : GMSSyncTileLayer
...
@interface ABI42_0_0AIRGoogleMapWMSTile : UIView
@property (nonatomic, strong) ABI42_0_0WMSTileOverlay *tileLayer;
