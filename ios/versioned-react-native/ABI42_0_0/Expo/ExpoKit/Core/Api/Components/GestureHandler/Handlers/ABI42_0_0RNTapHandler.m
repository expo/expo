...
#import "ABI42_0_0RNTapHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI42_0_0React/ABI42_0_0RCTConvert.h>

// ABI42_0_0RNBetterTapGestureRecognizer extends UIGestureRecognizer instead of UITapGestureRecognizer 
...
@interface ABI42_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
@implementation ABI42_0_0RNBetterTapGestureRecognizer {
...
@implementation ABI42_0_0RNTapGestureHandler {
    ABI42_0_0RNGestureHandlerEventExtraData * _lastData;
}

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI42_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI42_0_0RNBetterTapGestureRecognizer *recognizer = (ABI42_0_0RNBetterTapGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    recognizer.maxDelay = [ABI42_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDurationMs"];
  if (prop != nil) {
    recognizer.maxDuration = [ABI42_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
