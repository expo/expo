...
@implementation ABI42_0_0RNSVGLength
...
{
    ABI42_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype) lengthWithString: (NSString *) lengthString {
    ...
    ABI42_0_0RNSVGLength *output = [ABI42_0_0RNSVGLength alloc];
    if (stringLength == 0) {
        ...
        ABI42_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
