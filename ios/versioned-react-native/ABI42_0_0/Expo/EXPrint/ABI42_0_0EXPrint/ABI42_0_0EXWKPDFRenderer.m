...
@interface ABI42_0_0EXWKPDFRenderer () <WKNavigationDelegate>

@property (nonatomic, assign) CGSize pageSize;
@property (nonatomic, strong) WKWebView *webView;
@property (nonatomic, strong) id<ABI42_0_0EXPDFRenderer> renderer;
...
@implementation ABI42_0_0EXWKPDFRenderer
...
- (void)PDFWithHtml:(NSString *)htmlString pageSize:(CGSize)pageSize completionHandler:(void (^)(NSError * _Nullable, NSData * _Nullable, int))handler
{
  ...
  if (@available(iOS 11.0, *)) {
    _renderer = [[ABI42_0_0EXWKSnapshotPDFRenderer alloc] init];
  } else {
    _renderer = [[ABI42_0_0EXWKViewPDFRenderer alloc] init];
  }
