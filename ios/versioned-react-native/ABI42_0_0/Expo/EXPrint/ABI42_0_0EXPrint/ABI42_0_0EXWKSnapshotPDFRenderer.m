...
#import <ABI42_0_0EXPrint/ABI42_0_0EXWKSnapshotPDFRenderer.h>
#import <ABI42_0_0UMCore/ABI42_0_0UMDefines.h>

@interface ABI42_0_0EXWKSnapshotPDFRenderer ()

@end

@implementation ABI42_0_0EXWKSnapshotPDFRenderer
...
- (void)takeSnapshotForPage:(int)pageIndex ofPages:(int)pagesCount ofWebView:(WKWebView *)webView withScrollHeight:(CGFloat)scrollHeight withCompletionHandler:(void (^ _Nullable)(NSError * _Nullable error))completionHandler
{
  ...
  if (@available(iOS 11.0, *)) {
    ...
    NSError *error = ABI42_0_0UMErrorWithMessage(@"Unexpected error occurred - on iOS under 11.0 use ABI42_0_0EXWKViewPDFRenderer.");
    completionHandler(error);
  }
}
