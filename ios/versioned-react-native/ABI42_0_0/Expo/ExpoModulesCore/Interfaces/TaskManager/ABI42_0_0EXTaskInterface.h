...
@protocol ABI42_0_0EXTaskConsumerInterface;

@protocol ABI42_0_0EXTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI42_0_0EXTaskConsumerInterface> __nonnull consumer;
