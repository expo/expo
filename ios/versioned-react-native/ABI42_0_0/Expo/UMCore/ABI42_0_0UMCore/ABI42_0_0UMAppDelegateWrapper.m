...
@implementation ABI42_0_0UMAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitializedAndSorted {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI42_0_0UMSingletonModule*> * singletonModules = [[ABI42_0_0UMModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI42_0_0UMSingletonModule *singletonModule in singletonModules) {
