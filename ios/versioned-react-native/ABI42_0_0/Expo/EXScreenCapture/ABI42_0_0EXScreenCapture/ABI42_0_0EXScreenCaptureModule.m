...
@implementation ABI42_0_0EXScreenCaptureModule {
  UIView *_blockView;
}

ABI42_0_0UM_EXPORT_MODULE(ExpoScreenCapture);
...
ABI42_0_0UM_EXPORT_METHOD_AS(preventScreenCapture,
                    preventScreenCaptureWithResolver:(ABI42_0_0UMPromiseResolveBlock)resolve
...
ABI42_0_0UM_EXPORT_METHOD_AS(allowScreenCapture,
                    allowScreenCaptureWithResolver:(ABI42_0_0UMPromiseResolveBlock)resolve
