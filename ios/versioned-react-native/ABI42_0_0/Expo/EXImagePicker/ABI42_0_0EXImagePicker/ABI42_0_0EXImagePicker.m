#import <ABI42_0_0EXImagePicker/ABI42_0_0EXImagePicker.h>
#import <ABI42_0_0EXImagePicker/ABI42_0_0EXImagePickerCameraPermissionRequester.h>
...
const CGFloat ABI42_0_0EXDefaultImageQuality = 0.2;

@interface ABI42_0_0EXImagePicker ()
...
@implementation ABI42_0_0EXImagePicker

ABI42_0_0UM_EXPORT_MODULE(ExponentImagePicker);
...
- (void)setModuleRegistry:(ABI42_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  _permissionsManager = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI42_0_0EXPermissionsInterface)];
  [ABI42_0_0EXPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI42_0_0EXImagePickerCameraPermissionRequester new],
                                                    [ABI42_0_0EXImagePickerMediaLibraryPermissionRequester new],
                                                    [ABI42_0_0EXImagePickerMediaLibraryWriteOnlyPermissionRequester new]
                                                    ]
...
{
  if (writeOnly) {
    return [ABI42_0_0EXImagePickerMediaLibraryWriteOnlyPermissionRequester class];
  } else {
    return [ABI42_0_0EXImagePickerMediaLibraryPermissionRequester class];
  }
}
                    ...
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  [ABI42_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI42_0_0EXImagePickerCameraPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI42_0_0UM_EXPORT_METHOD_AS(getMediaLibraryPermissionsAsync,
...
ABI42_0_0UM_EXPORT_METHOD_AS(requestMediaLibraryPermissionsAsync,
...
ABI42_0_0UM_EXPORT_METHOD_AS(launchCameraAsync, launchCameraAsync:(NSDictionary *)options
                  resolver:(ABI42_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  ...
  BOOL permissionsAreGranted = [self hasCameraRollPermission] &&
                               [self.permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI42_0_0EXImagePickerCameraPermissionRequester class]];
  ...
  self.reject = reject;
  [self launchImagePicker:ABI42_0_0EXImagePickerTargetCamera options:options];
}

ABI42_0_0UM_EXPORT_METHOD_AS(launchImageLibraryAsync, launchImageLibraryAsync:(NSDictionary *)options
                  resolver:(ABI42_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  if (!_permissionsManager) {
  ...
  self.resolve = resolve;
  self.reject = reject;
  [self launchImagePicker:ABI42_0_0EXImagePickerTargetLibrarySingleImage options:options];
}

- (void)launchImagePicker:(ABI42_0_0EXImagePickerTarget)target options:(NSDictionary *)options
{
...
- (void)launchImagePicker:(ABI42_0_0EXImagePickerTarget)target
{
  dispatch_async(dispatch_get_main_queue(), ^{
    self.picker = [UIImagePickerController new];

    if (target == ABI42_0_0EXImagePickerTargetCamera) {
    ...
    id<ABI42_0_0UMUtilitiesInterface> utils = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI42_0_0UMUtilitiesInterface)];
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
  dispatch_block_t dismissCompletionBlock = ^{
    ...
    id<ABI42_0_0EXFileSystemInterface> fileSystem = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI42_0_0EXFileSystemInterface)];
    if (!fileSystem) {
          ...
          completionHandler:(void (^)(void))completionHandler
{
  ...
  NSData *data = UIImageJPEGRepresentation(image, quality == nil ? ABI42_0_0EXDefaultImageQuality : [quality floatValue]);
  ...
  if ([[self.options objectForKey:@"exif"] boolValue]) {
    ...
    if (metadata) {
      ...
      if (!asset) {
        ABI42_0_0UMLogInfo(@"Could not fetch metadata for image %@", [imageURL absoluteString]);
        completionHandler();
      }
...
- (BOOL)hasCameraRollPermission
{
  ...
  return [_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI42_0_0EXImagePickerMediaLibraryPermissionRequester class]];
}
