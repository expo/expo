//
//  ABI42_0_0EXFaceDetectorUtils.h
//  Exponent
//
...
typedef float (^ABI42_0_0EXFaceDetectionAngleTransformBlock)(float);

@interface ABI42_0_0EXFaceDetectorUtils : NSObject
...
+ (ABI42_0_0EXFaceDetectionAngleTransformBlock)angleTransformerFromTransform:(CGAffineTransform)transform;
