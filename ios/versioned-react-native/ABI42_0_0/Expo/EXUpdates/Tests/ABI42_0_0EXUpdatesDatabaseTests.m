...
#import <ABI42_0_0EXUpdates/ABI42_0_0EXUpdatesDatabase+Tests.h>
#import <ABI42_0_0EXUpdates/ABI42_0_0EXUpdatesNewUpdate.h>

@interface ABI42_0_0EXUpdatesDatabaseTests : XCTestCase

@property (nonatomic, strong) ABI42_0_0EXUpdatesDatabase *db;
@property (nonatomic, strong) NSURL *testDatabaseDir;
@property (nonatomic, strong) ABI42_0_0EXUpdatesNewRawManifest *manifest;
@property (nonatomic, strong) ABI42_0_0EXUpdatesConfig *config;

@end

@implementation ABI42_0_0EXUpdatesDatabaseTests
...
- (void)setUp
{
  ...
  _manifest = [[ABI42_0_0EXUpdatesNewRawManifest alloc] initWithRawManifestJSON:@{
    @"runtimeVersion": @"1",
...
- (void)testForeignKeys
{
  ...
  ABI42_0_0EXUpdatesUpdate *update = [ABI42_0_0EXUpdatesNewUpdate updateWithNewManifest:_manifest response:nil config:_config database:_db];
  dispatch_sync(_db.databaseQueue, ^{
...
- (void)testSetMetadata_OverwriteAllFields
{
  ...
  ABI42_0_0EXUpdatesUpdate *update1 = [ABI42_0_0EXUpdatesNewUpdate updateWithNewManifest:_manifest response:response1 config:_config database:_db];
  ...
  ABI42_0_0EXUpdatesUpdate *update2 = [ABI42_0_0EXUpdatesNewUpdate updateWithNewManifest:_manifest response:response2 config:_config database:_db];
