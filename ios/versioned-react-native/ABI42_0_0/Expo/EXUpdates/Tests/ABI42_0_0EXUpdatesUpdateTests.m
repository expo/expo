...
@interface ABI42_0_0EXUpdatesUpdateTests : XCTestCase
...
@implementation ABI42_0_0EXUpdatesUpdateTests
...
- (void)testUpdateWithManifest_Legacy
{
  ...
  ABI42_0_0EXUpdatesUpdate *update = [ABI42_0_0EXUpdatesUpdate updateWithManifest:_legacyManifest response:response config:_config database:_database error:&error];
...
- (void)testUpdateWithManifest_New
{
  ...
  ABI42_0_0EXUpdatesUpdate *update = [ABI42_0_0EXUpdatesUpdate updateWithManifest:_easNewManifest response:response config:_config database:_database error:&error];
  XCTAssert(update != nil);
}
...
{
  ABI42_0_0EXUpdatesUpdate *update = [ABI42_0_0EXUpdatesUpdate updateWithEmbeddedManifest:_legacyManifest config:_config database:_database];
  XCTAssert(update != nil);
}

- (void)testUpdateWithEmbeddedManifest_Legacy_Bare
{
  ABI42_0_0EXUpdatesUpdate *update = [ABI42_0_0EXUpdatesUpdate updateWithEmbeddedManifest:_bareManifest config:_config database:_database];
  XCTAssert(update != nil);
}
