...
@interface ABI42_0_0EXUpdatesConfig ()
...
@property (nonatomic, readwrite, assign) ABI42_0_0EXUpdatesCheckAutomaticallyConfig checkOnLaunch;
...
static NSString * const ABI42_0_0EXUpdatesConfigPlistName = @"Expo";

static NSString * const ABI42_0_0EXUpdatesDefaultReleaseChannelName = @"default";

static NSString * const ABI42_0_0EXUpdatesConfigEnabledKey = @"ABI42_0_0EXUpdatesEnabled";
static NSString * const ABI42_0_0EXUpdatesConfigScopeKeyKey = @"ABI42_0_0EXUpdatesScopeKey";
static NSString * const ABI42_0_0EXUpdatesConfigUpdateUrlKey = @"ABI42_0_0EXUpdatesURL";
static NSString * const ABI42_0_0EXUpdatesConfigRequestHeadersKey = @"ABI42_0_0EXUpdatesRequestHeaders";
static NSString * const ABI42_0_0EXUpdatesConfigReleaseChannelKey = @"ABI42_0_0EXUpdatesReleaseChannel";
static NSString * const ABI42_0_0EXUpdatesConfigLaunchWaitMsKey = @"ABI42_0_0EXUpdatesLaunchWaitMs";
static NSString * const ABI42_0_0EXUpdatesConfigCheckOnLaunchKey = @"ABI42_0_0EXUpdatesCheckOnLaunch";
static NSString * const ABI42_0_0EXUpdatesConfigSDKVersionKey = @"ABI42_0_0EXUpdatesSDKVersion";
static NSString * const ABI42_0_0EXUpdatesConfigRuntimeVersionKey = @"ABI42_0_0EXUpdatesRuntimeVersion";
static NSString * const ABI42_0_0EXUpdatesConfigHasEmbeddedUpdateKey = @"ABI42_0_0EXUpdatesHasEmbeddedUpdate";

static NSString * const ABI42_0_0EXUpdatesConfigAlwaysString = @"ALWAYS";
static NSString * const ABI42_0_0EXUpdatesConfigWifiOnlyString = @"WIFI_ONLY";
static NSString * const ABI42_0_0EXUpdatesConfigNeverString = @"NEVER";

@implementation ABI42_0_0EXUpdatesConfig
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _requestHeaders = @{};
    _releaseChannel = ABI42_0_0EXUpdatesDefaultReleaseChannelName;
    _launchWaitMs = @(0);
    _checkOnLaunch = ABI42_0_0EXUpdatesCheckAutomaticallyConfigAlways;
...
{
  ABI42_0_0EXUpdatesConfig *updatesConfig = [[ABI42_0_0EXUpdatesConfig alloc] init];
...
{
  NSString *configPath = [[NSBundle mainBundle] pathForResource:ABI42_0_0EXUpdatesConfigPlistName ofType:@"plist"];
  if (!configPath) {
...
{
  id isEnabled = config[ABI42_0_0EXUpdatesConfigEnabledKey];
  if (isEnabled && [isEnabled isKindOfClass:[NSNumber class]]) {
    _isEnabled = [(NSNumber *)isEnabled boolValue];
  }
  
  id expectsSignedManifest = config[@"ABI42_0_0EXUpdatesExpectsSignedManifest"];
  ...
  id updateUrl = config[ABI42_0_0EXUpdatesConfigUpdateUrlKey];
  if (updateUrl && [updateUrl isKindOfClass:[NSString class]]) {
    NSURL *url = [NSURL URLWithString:(NSString *)updateUrl];
    _updateUrl = url;
  }

  id scopeKey = config[ABI42_0_0EXUpdatesConfigScopeKeyKey];
  ...
  id requestHeaders = config[ABI42_0_0EXUpdatesConfigRequestHeadersKey];
  if (requestHeaders) {
    if(![requestHeaders isKindOfClass:[NSDictionary class]]){
      @throw [NSException exceptionWithName:NSInternalInconsistencyException
                                     reason:[NSString stringWithFormat:@"PList key '%@' must be a string valued Dictionary.", ABI42_0_0EXUpdatesConfigRequestHeadersKey]
                                   userInfo:@{}];
    }
  ...
  id releaseChannel = config[ABI42_0_0EXUpdatesConfigReleaseChannelKey];
  if (releaseChannel && [releaseChannel isKindOfClass:[NSString class]]) {
    _releaseChannel = (NSString *)releaseChannel;
  }

  id launchWaitMs = config[ABI42_0_0EXUpdatesConfigLaunchWaitMsKey];
  ...
  id checkOnLaunch = config[ABI42_0_0EXUpdatesConfigCheckOnLaunchKey];
  if (checkOnLaunch && [checkOnLaunch isKindOfClass:[NSString class]]) {
    if ([ABI42_0_0EXUpdatesConfigNeverString isEqualToString:(NSString *)checkOnLaunch]) {
      _checkOnLaunch = ABI42_0_0EXUpdatesCheckAutomaticallyConfigNever;
    } else if ([ABI42_0_0EXUpdatesConfigWifiOnlyString isEqualToString:(NSString *)checkOnLaunch]) {
      _checkOnLaunch = ABI42_0_0EXUpdatesCheckAutomaticallyConfigWifiOnly;
    } else if ([ABI42_0_0EXUpdatesConfigAlwaysString isEqualToString:(NSString *)checkOnLaunch]) {
      _checkOnLaunch = ABI42_0_0EXUpdatesCheckAutomaticallyConfigAlways;
    }
  }

  id sdkVersion = config[ABI42_0_0EXUpdatesConfigSDKVersionKey];
  if (sdkVersion && [sdkVersion isKindOfClass:[NSString class]]) {
    _sdkVersion = (NSString *)sdkVersion;
  }

  id runtimeVersion = config[ABI42_0_0EXUpdatesConfigRuntimeVersionKey];
  if (runtimeVersion && [runtimeVersion isKindOfClass:[NSString class]]) {
    _runtimeVersion = (NSString *)runtimeVersion;
  }

  id hasEmbeddedUpdate = config[ABI42_0_0EXUpdatesConfigHasEmbeddedUpdateKey];
