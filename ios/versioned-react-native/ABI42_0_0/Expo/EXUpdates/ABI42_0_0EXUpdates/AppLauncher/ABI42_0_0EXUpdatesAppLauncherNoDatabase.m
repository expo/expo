...
#import <ABI42_0_0EXUpdates/ABI42_0_0EXUpdatesAppLauncherNoDatabase.h>
#import <ABI42_0_0EXUpdates/ABI42_0_0EXUpdatesEmbeddedAppLoader.h>

NS_ASSUME_NONNULL_BEGIN

static NSString * const ABI42_0_0EXUpdatesErrorLogFile = @"expo-error.log";

@interface ABI42_0_0EXUpdatesAppLauncherNoDatabase ()
...
@implementation ABI42_0_0EXUpdatesAppLauncherNoDatabase

- (void)launchUpdateWithConfig:(ABI42_0_0EXUpdatesConfig *)config
{
  _launchedUpdate = [ABI42_0_0EXUpdatesEmbeddedAppLoader embeddedManifestWithConfig:config database:nil];
  if (_launchedUpdate) {
    if (_launchedUpdate.status == ABI42_0_0EXUpdatesUpdateStatusEmbedded) {
      ...
      _launchAssetUrl = [[NSBundle mainBundle] URLForResource:ABI42_0_0EXUpdatesEmbeddedBundleFilename withExtension:ABI42_0_0EXUpdatesEmbeddedBundleFileType];
...
+ (NSString *)_errorLogFilePath
{
  ...
  return [[applicationDocumentsDirectory URLByAppendingPathComponent:ABI42_0_0EXUpdatesErrorLogFile] path];
}
