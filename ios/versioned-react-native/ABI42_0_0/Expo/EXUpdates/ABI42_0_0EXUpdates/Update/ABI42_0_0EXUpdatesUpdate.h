...
@property (nonatomic, strong, readonly) ABI42_0_0EXManifestsRawManifest *rawManifest;
...
+ (ABI42_0_0EXManifestsRawManifest *)rawManifestForJSON:(NSDictionary *)manifestJSON;
