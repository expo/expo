...
@property (nonatomic, strong, readonly) ABI42_0_0EXUpdatesRawManifest *rawManifest;
...
+ (ABI42_0_0EXUpdatesRawManifest *)rawManifestForJSON:(NSDictionary *)manifestJSON;
