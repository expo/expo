...
@property (nonatomic, strong, readonly) ABI42_0_0EXRawManifestsRawManifest *rawManifest;
...
+ (ABI42_0_0EXRawManifestsRawManifest *)rawManifestForJSON:(NSDictionary *)manifestJSON;
