...
#import <ABI42_0_0EXRawManifests/ABI42_0_0EXRawManifestsBareRawManifest.h>
...
@property (nonatomic, strong, readwrite) ABI42_0_0EXRawManifestsRawManifest* rawManifest;

@end

@implementation ABI42_0_0EXUpdatesUpdate

- (instancetype)initWithRawManifest:(ABI42_0_0EXRawManifestsRawManifest *)manifest
                             ...
                             error:(NSError ** _Nullable)error
{
  ...
  if (expoProtocolVersion == nil) {
    return [ABI42_0_0EXUpdatesLegacyUpdate updateWithLegacyManifest:[[ABI42_0_0EXRawManifestsLegacyRawManifest alloc] initWithRawManifestJSON:manifest]
                                                    config:config
                                                  database:database];
  } else if (expoProtocolVersion.integerValue == 0) {
    return [ABI42_0_0EXUpdatesNewUpdate updateWithNewManifest:[[ABI42_0_0EXRawManifestsNewRawManifest alloc] initWithRawManifestJSON:manifest]
                                            response:response
                                              config:config
                                            database:database];
  } else {
                                  ...
                                  database:(nullable ABI42_0_0EXUpdatesDatabase *)database
{
  if (manifest[@"releaseId"]) {
    ...
    return [ABI42_0_0EXUpdatesBareUpdate updateWithBareRawManifest:[[ABI42_0_0EXRawManifestsBareRawManifest alloc] initWithRawManifestJSON:manifest]
                                                   config:config
                                                 database:database];
  }
}
...
+ (nonnull ABI42_0_0EXRawManifestsRawManifest *)rawManifestForJSON:(nonnull NSDictionary *)manifestJSON { 
  ABI42_0_0EXRawManifestsRawManifest *rawManifest;
  if (manifestJSON[@"releaseId"]) {
    rawManifest = [[ABI42_0_0EXRawManifestsLegacyRawManifest alloc] initWithRawManifestJSON:manifestJSON];
  } else if (manifestJSON[@"metadata"]) {
    rawManifest = [[ABI42_0_0EXRawManifestsNewRawManifest alloc] initWithRawManifestJSON:manifestJSON];
  } else {
    rawManifest = [[ABI42_0_0EXRawManifestsBareRawManifest alloc] initWithRawManifestJSON:manifestJSON];
  }
  return rawManifest;
}
