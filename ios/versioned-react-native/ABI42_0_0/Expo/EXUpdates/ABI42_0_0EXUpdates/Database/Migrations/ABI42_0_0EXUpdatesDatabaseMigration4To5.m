...
static NSString * const ABI42_0_0EXUpdatesDatabaseV4Filename = @"expo-v4.db";

@implementation ABI42_0_0EXUpdatesDatabaseMigration4To5

- (NSString *)filename
{
  return ABI42_0_0EXUpdatesDatabaseV4Filename;
}
