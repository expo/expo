...
static NSString * const ABI42_0_0EXUpdatesDatabaseUtilsErrorDomain = @"ABI42_0_0EXUpdatesDatabase";

@implementation ABI42_0_0EXUpdatesDatabaseUtils
...
+ (NSError *)errorFromSqlite:(struct sqlite3 *)db
{
  ...
  return [NSError errorWithDomain:ABI42_0_0EXUpdatesDatabaseUtilsErrorDomain
                             code:extendedCode
