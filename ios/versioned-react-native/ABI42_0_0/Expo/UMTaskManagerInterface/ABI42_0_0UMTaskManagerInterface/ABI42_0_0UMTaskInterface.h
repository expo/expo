...
@protocol ABI42_0_0UMTaskConsumerInterface;

@protocol ABI42_0_0UMTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI42_0_0UMTaskConsumerInterface> __nonnull consumer;
