...
// Interface for ABI42_0_0UMTaskManager module.

@protocol ABI42_0_0UMTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI42_0_0UMTaskConsumerInterface protocol.
 */
