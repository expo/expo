...
@interface ABI42_0_0UMNativeModulesProxy ()

@property (nonatomic, strong) NSRegularExpression *regexp;
@property (nonatomic, strong) ABI42_0_0UMModuleRegistry *umModuleRegistry;
...
@implementation ABI42_0_0UMNativeModulesProxy
...
# pragma mark - ABI42_0_0React API
...
- (NSDictionary *)constantsToExport
{
  ...
  NSArray<ABI42_0_0UMViewManager *> *viewManagers = [_umModuleRegistry getAllViewManagers];
  NSMutableArray<NSString *> *viewManagersNames = [NSMutableArray arrayWithCapacity:[viewManagers count]];
  for (ABI42_0_0UMViewManager *viewManager in viewManagers) {
...
ABI42_0_0RCT_EXPORT_METHOD(callMethod:(NSString *)moduleName methodNameOrKey:(id)methodNameOrKey arguments:(NSArray *)arguments resolver:(ABI42_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI42_0_0RCTPromiseRejectBlock)reject)
{
