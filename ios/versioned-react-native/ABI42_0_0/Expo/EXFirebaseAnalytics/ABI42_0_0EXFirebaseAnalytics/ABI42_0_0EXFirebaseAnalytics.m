...
#import <ABI42_0_0EXFirebaseCore/ABI42_0_0UMFirebaseCoreInterface.h>
#import <ABI42_0_0EXFirebaseAnalytics/ABI42_0_0EXFirebaseAnalytics.h>
...
@interface ABI42_0_0EXFirebaseAnalytics ()

@property (nonatomic, weak) ABI42_0_0UMModuleRegistry *moduleRegistry;
@property (nonatomic, weak) id<ABI42_0_0UMFirebaseCoreInterface> firebaseCore;

@end

@implementation ABI42_0_0EXFirebaseAnalytics

ABI42_0_0UM_EXPORT_MODULE(ExpoFirebaseAnalytics);
...
- (void)reject:(ABI42_0_0UMPromiseRejectBlock)reject withException:(NSException *)exception {
...
- (void)setModuleRegistry:(ABI42_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  _firebaseCore = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI42_0_0UMFirebaseCoreInterface)];
}

- (nullable FIRApp *)getAppOrReject:(ABI42_0_0UMPromiseRejectBlock)reject
{
  if (!_firebaseCore) {
    reject(@"ERR_FIREBASE_ANALYTICS", @"ABI42_0_0EXFirebaseCore could not be found. Ensure that your app has correctly linked 'expo-firebase-core' and your project has ABI42_0_0React-native-unimodules installed.", nil);
    return nil;
  }
...
ABI42_0_0UM_EXPORT_METHOD_AS(logEvent,
...
ABI42_0_0UM_EXPORT_METHOD_AS(setAnalyticsCollectionEnabled,
...
ABI42_0_0UM_EXPORT_METHOD_AS(setCurrentScreen,
...
ABI42_0_0UM_EXPORT_METHOD_AS(setUserId,
...
ABI42_0_0UM_EXPORT_METHOD_AS(setUserProperties, 
...
ABI42_0_0UM_EXPORT_METHOD_AS(resetAnalyticsData,
                    resetAnalyticsData:(ABI42_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject) {
  if ([self getAppOrReject:reject] == nil) return;
  @try {
