...
*/
@protocol ABI42_0_0EXSplashScreenService <NSObject>
...
@interface ABI42_0_0EXSplashScreenService : ABI42_0_0UMSingletonModule <ABI42_0_0EXSplashScreenService, UIApplicationDelegate>
@end
