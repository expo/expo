...
@interface ABI42_0_0EXAdsDFPBannerView : UIView <GADBannerViewDelegate, GADAppEventDelegate>
...
@property (nonatomic, copy) ABI42_0_0UMDirectEventBlock onAdmobDispatchAppEvent;
