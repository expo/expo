...
#import <ABI42_0_0EXAmplitude/ABI42_0_0EXAmplitude.h>

#import <Amplitude/Amplitude.h>
#import <Amplitude/AMPTrackingOptions.h>

@implementation ABI42_0_0EXAmplitude

ABI42_0_0UM_EXPORT_MODULE(ExpoAmplitude);
...
ABI42_0_0UM_EXPORT_METHOD_AS(setUserPropertiesAsync,
...
ABI42_0_0UM_EXPORT_METHOD_AS(clearUserPropertiesAsync,
                    clearUserPropertiesAsyncWithResolver:(ABI42_0_0UMPromiseResolveBlock)resolve
...
ABI42_0_0UM_EXPORT_METHOD_AS(logEventWithPropertiesAsync,
...
ABI42_0_0UM_EXPORT_METHOD_AS(setGroupAsync,
...
ABI42_0_0UM_EXPORT_METHOD_AS(setTrackingOptionsAsync,
