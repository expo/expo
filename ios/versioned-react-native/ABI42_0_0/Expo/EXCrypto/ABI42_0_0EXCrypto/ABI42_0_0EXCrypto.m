...
#import <ABI42_0_0EXCrypto/ABI42_0_0EXCrypto.h>
#import <CommonCrypto/CommonDigest.h>

@implementation ABI42_0_0EXCrypto

ABI42_0_0UM_EXPORT_MODULE(ExpoCrypto);

ABI42_0_0UM_EXPORT_METHOD_AS(digestStringAsync,
                    ...
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  ...
  int digestLength = [ABI42_0_0EXCrypto digestLengthForJSAlgorithm:algorithm];
  if (digestLength == -1) {
