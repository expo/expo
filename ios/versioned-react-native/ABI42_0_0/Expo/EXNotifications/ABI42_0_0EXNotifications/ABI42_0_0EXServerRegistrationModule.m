...
ABI42_0_0UM_EXPORT_MODULE(NotificationsServerRegistrationModule)

ABI42_0_0UM_EXPORT_METHOD_AS(getInstallationIdAsync,
                    getInstallationIdAsyncWithResolver:(ABI42_0_0UMPromiseResolveBlock)resolve
...
ABI42_0_0UM_EXPORT_METHOD_AS(getRegistrationInfoAsync,
                    getRegistrationInfoAsyncWithResolver:(ABI42_0_0UMPromiseResolveBlock)resolve
                                                rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  CFTypeRef keychainResult = NULL;
...
ABI42_0_0UM_EXPORT_METHOD_AS(setRegistrationInfoAsync,
