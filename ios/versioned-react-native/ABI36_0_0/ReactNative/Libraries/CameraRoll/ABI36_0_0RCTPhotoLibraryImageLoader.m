...
#import "ABI36_0_0RCTPhotoLibraryImageLoader.h"

#import <Photos/Photos.h>

#import <ABI36_0_0React/ABI36_0_0RCTUtils.h>

@implementation ABI36_0_0RCTPhotoLibraryImageLoader

ABI36_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI36_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI36_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (!imageURL) {
    completionHandler(ABI36_0_0RCTErrorWithMessage(@"Cannot load a photo library asset with no URL"), nil);
    return ^{};
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI36_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI36_0_0RCTResizeModeContain) {
