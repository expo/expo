 ...
 * are also bridge modules, so should be registered using ABI36_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI36_0_0RCTImageDataDecoder <ABI36_0_0RCTBridgeModule>
...
/**
 * If more than one ABI36_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
