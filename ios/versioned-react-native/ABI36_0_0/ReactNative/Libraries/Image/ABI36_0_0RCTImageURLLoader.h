...
typedef void (^ABI36_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI36_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI36_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI36_0_0RCTImageLoaderCancellationBlock;
 ...
 */
@protocol ABI36_0_0RCTImageURLLoader <ABI36_0_0RCTBridgeModule>
...
/**
 * If more than one ABI36_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI36_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
