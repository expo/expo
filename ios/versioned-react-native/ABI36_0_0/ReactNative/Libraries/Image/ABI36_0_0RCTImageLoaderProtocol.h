...
/**
 * If available, ABI36_0_0RCTImageRedirectProtocol is invoked before loading an asset.
 * Implementation should return either a new URL or nil when redirection is
 * not needed.
 */

@protocol ABI36_0_0RCTImageRedirectProtocol

- (NSURL *)redirectAssetsURL:(NSURL *)URL;

@end

@protocol ABI36_0_0RCTImageLoaderProtocol<ABI36_0_0RCTURLRequestHandler>
 ...
 * `partialLoadBlock` is meant for custom image loaders that do not ship with the core ABI36_0_0RN library.
 ...
 * decoded images as long as it conforms to the ABI36_0_0RCTImageCache
