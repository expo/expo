...
@implementation ABI36_0_0RCTTrackingAnimatedNode {
...
- (void)onDetachedFromNode:(ABI36_0_0RCTAnimatedNode *)parent
{
...
- (void)performUpdate
{
  ...
  ABI36_0_0RCTValueAnimatedNode *node = (ABI36_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
