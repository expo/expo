...
#import "ABI36_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI36_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ABI36_0_0ReactViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ABI36_0_0ReactViewController detachChildViewController:self.contentViewController];
}
