...
// ABI36_0_0RCT_WRAPPER_FOR_VIEW
#define ABI36_0_0RCT_WRAPPER_FOR_VIEW(ClassName)                                        \
                                                                               \
NS_ASSUME_NONNULL_BEGIN                                                        \
                                                                               \
@interface ClassName##Manager : ABI36_0_0RCTWrapperViewManager                          \
                                                                               \
@end                                                                           \
                                                                               \
...
// ABI36_0_0RCT_WRAPPER_FOR_VIEW_CONTROLLER
#define ABI36_0_0RCT_WRAPPER_FOR_VIEW_CONTROLLER(ClassName)                             \
                                                                               \
NS_ASSUME_NONNULL_BEGIN                                                        \
                                                                               \
@interface ClassName##Manager : ABI36_0_0RCTWrapperViewManager                          \
