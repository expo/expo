...
NSString *const ABI36_0_0RCTTextAttributesIsHighlightedAttributeName = @"ABI36_0_0RCTTextAttributesIsHighlightedAttributeName";
NSString *const ABI36_0_0RCTTextAttributesTagAttributeName = @"ABI36_0_0RCTTextAttributesTagAttributeName";

@implementation ABI36_0_0RCTTextAttributes
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _opacity = NAN;
    _textTransform = ABI36_0_0RCTTextTransformUndefined;
  }

  return self;
}

- (void)applyTextAttributes:(ABI36_0_0RCTTextAttributes *)textAttributes
{
  ...
  _textDecorationLine = textAttributes->_textDecorationLine != ABI36_0_0RCTTextDecorationLineTypeNone ? textAttributes->_textDecorationLine : _textDecorationLine; // *
  ...
  _textTransform = textAttributes->_textTransform != ABI36_0_0RCTTextTransformUndefined ? textAttributes->_textTransform : _textTransform;
}
...
- (NSDictionary<NSAttributedStringKey, id> *)effectiveTextAttributes
{
  ...
  if (_textDecorationLine == ABI36_0_0RCTTextDecorationLineTypeUnderline ||
      _textDecorationLine == ABI36_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    isTextDecorationEnabled = YES;
    attributes[NSUnderlineStyleAttributeName] = @(_textDecorationStyle);
  }

  if (_textDecorationLine == ABI36_0_0RCTTextDecorationLineTypeStrikethrough ||
      _textDecorationLine == ABI36_0_0RCTTextDecorationLineTypeUnderlineStrikethrough){
    isTextDecorationEnabled = YES;
  ...
  // Special
  if (_isHighlighted) {
    attributes[ABI36_0_0RCTTextAttributesIsHighlightedAttributeName] = @YES;
  }

  if (_tag) {
    attributes[ABI36_0_0RCTTextAttributesTagAttributeName] = _tag;
  }
...
{
  // FIXME: ABI36_0_0RCTFont has thread-safety issues and must be rewritten.
  return [ABI36_0_0RCTFont updateFont:nil
...
{
  bool fontScalingEnabled = !ABI36_0_0RCTHasFontHandlerSet() && _allowFontScaling;
...
- (NSString *)applyTextAttributesToText:(NSString *)text
{
  switch (_textTransform) {
    case ABI36_0_0RCTTextTransformUndefined:
    case ABI36_0_0RCTTextTransformNone:
      return text;
    case ABI36_0_0RCTTextTransformLowercase:
      return [text lowercaseString];
    case ABI36_0_0RCTTextTransformUppercase:
      return [text uppercaseString];
    case ABI36_0_0RCTTextTransformCapitalize:
      return [text capitalizedString];
  }
}

- (ABI36_0_0RCTTextAttributes *)copyWithZone:(NSZone *)zone
{
  ABI36_0_0RCTTextAttributes *textAttributes = [ABI36_0_0RCTTextAttributes new];
...
- (BOOL)isEqual:(ABI36_0_0RCTTextAttributes *)textAttributes
{
  if (!textAttributes) {
    return NO;
  }
...
#define ABI36_0_0RCTTextAttributesCompareFloats(a) ((a == textAttributes->a) || (isnan(a) && isnan(textAttributes->a)))
#define ABI36_0_0RCTTextAttributesCompareSize(a) CGSizeEqualToSize(a, textAttributes->a)
#define ABI36_0_0RCTTextAttributesCompareObjects(a) ((a == textAttributes->a) || [a isEqual:textAttributes->a])
#define ABI36_0_0RCTTextAttributesCompareStrings(a) ((a == textAttributes->a) || [a isEqualToString:textAttributes->a])
#define ABI36_0_0RCTTextAttributesCompareOthers(a) (a == textAttributes->a)

  return
    ABI36_0_0RCTTextAttributesCompareObjects(_foregroundColor) &&
    ABI36_0_0RCTTextAttributesCompareObjects(_backgroundColor) &&
    ABI36_0_0RCTTextAttributesCompareFloats(_opacity) &&
    // Font
    ABI36_0_0RCTTextAttributesCompareObjects(_fontFamily) &&
    ABI36_0_0RCTTextAttributesCompareFloats(_fontSize) &&
    ABI36_0_0RCTTextAttributesCompareFloats(_fontSizeMultiplier) &&
    ABI36_0_0RCTTextAttributesCompareFloats(_maxFontSizeMultiplier) &&
    ABI36_0_0RCTTextAttributesCompareStrings(_fontWeight) &&
    ABI36_0_0RCTTextAttributesCompareObjects(_fontStyle) &&
    ABI36_0_0RCTTextAttributesCompareObjects(_fontVariant) &&
    ABI36_0_0RCTTextAttributesCompareOthers(_allowFontScaling) &&
    ABI36_0_0RCTTextAttributesCompareFloats(_letterSpacing) &&
    // Paragraph Styles
    ABI36_0_0RCTTextAttributesCompareFloats(_lineHeight) &&
    ABI36_0_0RCTTextAttributesCompareFloats(_alignment) &&
    ABI36_0_0RCTTextAttributesCompareOthers(_baseWritingDirection) &&
    // Decoration
    ABI36_0_0RCTTextAttributesCompareObjects(_textDecorationColor) &&
    ABI36_0_0RCTTextAttributesCompareOthers(_textDecorationStyle) &&
    ABI36_0_0RCTTextAttributesCompareOthers(_textDecorationLine) &&
    // Shadow
    ABI36_0_0RCTTextAttributesCompareSize(_textShadowOffset) &&
    ABI36_0_0RCTTextAttributesCompareFloats(_textShadowRadius) &&
    ABI36_0_0RCTTextAttributesCompareObjects(_textShadowColor) &&
    // Special
    ABI36_0_0RCTTextAttributesCompareOthers(_isHighlighted) &&
    ABI36_0_0RCTTextAttributesCompareObjects(_tag) &&
    ABI36_0_0RCTTextAttributesCompareOthers(_layoutDirection) &&
    ABI36_0_0RCTTextAttributesCompareOthers(_textTransform);
}
