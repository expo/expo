...
@implementation ABI36_0_0RCTBaseTextInputView {
  __weak ABI36_0_0RCTBridge *_bridge;
  __weak ABI36_0_0RCTEventDispatcher *_eventDispatcher;
...
{
  ABI36_0_0RCTAssertParam(bridge);
...
ABI36_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithCoder:(NSCoder *)decoder)
ABI36_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithFrame:(CGRect)frame)

- (UIView<ABI36_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  ABI36_0_0RCTAssert(NO, @"-[ABI36_0_0RCTBaseTextInputView backedTextInputView] must be implemented in subclass.");
  return nil;
}

#pragma mark - ABI36_0_0RCTComponent
...
- (void)setTextAttributes:(ABI36_0_0RCTTextAttributes *)textAttributes
{
...
{
  id<ABI36_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
  backedTextInputView.ABI36_0_0ReactTextAttributes = _textAttributes;
}

- (void)setABI36_0_0ReactPaddingInsets:(UIEdgeInsets)ABI36_0_0ReactPaddingInsets
{
  _ABI36_0_0ReactPaddingInsets = ABI36_0_0ReactPaddingInsets;
  // We apply `paddingInsets` as `backedTextInputView`'s `textContainerInset`.
  self.backedTextInputView.textContainerInset = ABI36_0_0ReactPaddingInsets;
  [self setNeedsLayout];
}

- (void)setABI36_0_0ReactBorderInsets:(UIEdgeInsets)ABI36_0_0ReactBorderInsets
{
  _ABI36_0_0ReactBorderInsets = ABI36_0_0ReactBorderInsets;
  // We apply `borderInsets` as `backedTextInputView` layout offset.
  self.backedTextInputView.frame = UIEdgeInsetsInsetRect(self.bounds, ABI36_0_0ReactBorderInsets);
  [self setNeedsLayout];
}
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  [backedTextInputViewTextCopy removeAttribute:ABI36_0_0RCTTextAttributesTagAttributeName
                                         range:NSMakeRange(0, backedTextInputViewTextCopy.length)];

  [attributedTextCopy removeAttribute:ABI36_0_0RCTTextAttributesTagAttributeName
  ...
  } else if (eventLag > ABI36_0_0RCTTextUpdateLagWarningThreshold) {
    ABI36_0_0RCTLog(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", self.backedTextInputView.attributedText.string, (long long)eventLag);
  }
}

- (ABI36_0_0RCTTextSelection *)selection
{
  id<ABI36_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
  UITextRange *selectedTextRange = backedTextInputView.selectedTextRange;
  return [[ABI36_0_0RCTTextSelection new] initWithStart:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.start]
                                           end:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.end]];
}

- (void)setSelection:(ABI36_0_0RCTTextSelection *)selection
{
  if (!selection) {
    return;
  }
  ...
  if (eventLag == 0 && ![previousSelectedTextRange isEqual:selectedTextRange]) {
    ...
    ABI36_0_0RCTLog(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", backedTextInputView.attributedText.string, (long long)eventLag);
  }
}
...
{
  UIView<ABI36_0_0RCTBackedTextInputViewProtocol> *textInputView = self.backedTextInputView;
...
#pragma mark - ABI36_0_0RCTBackedTextInputDelegate
...
- (void)textInputDidBeginEditing
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI36_0_0RCTTextEventTypeFocus
...
{
  [_eventDispatcher sendTextEventWithType:ABI36_0_0RCTTextEventTypeEnd
                                 ABI36_0_0ReactTag:self.ABI36_0_0ReactTag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];

  [_eventDispatcher sendTextEventWithType:ABI36_0_0RCTTextEventTypeBlur
                                 ABI36_0_0ReactTag:self.ABI36_0_0ReactTag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldReturn
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI36_0_0RCTTextEventTypeSubmit
                                 ABI36_0_0ReactTag:self.ABI36_0_0ReactTag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text
{
  ...
  if (!backedTextInputView.textWasPasted) {
    [_eventDispatcher sendTextEventWithType:ABI36_0_0RCTTextEventTypeKeyPress
                                   ABI36_0_0ReactTag:self.ABI36_0_0ReactTag
                                       text:nil
                                        key:text
                                 eventCount:_nativeEventCount];
...
- (void)textInputDidChangeSelection
{
  ...
  ABI36_0_0RCTTextSelection *selection = self.selection;
...
- (CGSize)intrinsicContentSize
{
  ...
  size.width += _ABI36_0_0ReactBorderInsets.left + _ABI36_0_0ReactBorderInsets.right;
  size.height += _ABI36_0_0ReactBorderInsets.top + _ABI36_0_0ReactBorderInsets.bottom;
...
{
  CGFloat compoundHorizontalBorderInset = _ABI36_0_0ReactBorderInsets.left + _ABI36_0_0ReactBorderInsets.right;
  CGFloat compoundVerticalBorderInset = _ABI36_0_0ReactBorderInsets.top + _ABI36_0_0ReactBorderInsets.bottom;
...
{
  [self.backedTextInputView ABI36_0_0ReactFocus];
}

- (void)ABI36_0_0ReactBlur
{
  [self.backedTextInputView ABI36_0_0ReactBlur];
}

- (void)didMoveToWindow
{
  [self.backedTextInputView ABI36_0_0ReactFocusIfNeeded];
}
...
{
  #if !TARGET_OS_TV
  __weak ABI36_0_0RCTBaseTextInputView *weakSelf = self;
  [_bridge.uiManager rootViewForABI36_0_0ReactTag:self.ABI36_0_0ReactTag withCompletion:^(UIView *rootView) {
    ABI36_0_0RCTBaseTextInputView *strongSelf = weakSelf;
    if (rootView) {
      UIView *accessoryView = [strongSelf->_bridge.uiManager viewForNativeID:nativeID
                                                                 withRootTag:rootView.ABI36_0_0ReactTag];
      if (accessoryView && [accessoryView isKindOfClass:[ABI36_0_0RCTInputAccessoryView class]]) {
        strongSelf.backedTextInputView.inputAccessoryView = ((ABI36_0_0RCTInputAccessoryView *)accessoryView).inputAccessoryView;
