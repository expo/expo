...
@implementation ABI36_0_0RCTUITextField {
  ABI36_0_0RCTBackedTextFieldDelegateAdapter *_textInputDelegateAdapter;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI36_0_0RCTBackedTextFieldDelegateAdapter alloc] initWithTextField:self];
  }
...
- (void)setABI36_0_0ReactTextAttributes:(ABI36_0_0RCTTextAttributes *)ABI36_0_0ReactTextAttributes
{
  ...
  self.defaultTextAttributes = ABI36_0_0ReactTextAttributes.effectiveTextAttributes;
...
- (NSDictionary<NSAttributedStringKey, id> *)placeholderEffectiveTextAttributes
{
  ...
  // Kerning
  if (!isnan(_ABI36_0_0ReactTextAttributes.letterSpacing)) {
    effectiveTextAttributes[NSKernAttributeName] = @(_ABI36_0_0ReactTextAttributes.letterSpacing);
  }
...
- (CGSize)intrinsicContentSize
{
  ...
  size = CGSizeMake(ABI36_0_0RCTCeilPixelValue(size.width), ABI36_0_0RCTCeilPixelValue(size.height));
