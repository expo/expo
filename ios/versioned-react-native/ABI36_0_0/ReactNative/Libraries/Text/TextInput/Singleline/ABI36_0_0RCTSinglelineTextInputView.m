...
@implementation ABI36_0_0RCTSinglelineTextInputView
{
  ABI36_0_0RCTUITextField *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI36_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI36_0_0RCTUITextField alloc] initWithFrame:self.bounds];
