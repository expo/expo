...
@protocol ABI36_0_0RCTBackedTextInputDelegate;
@class ABI36_0_0RCTTextAttributes;

NS_ASSUME_NONNULL_BEGIN

@protocol ABI36_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI36_0_0RCTBackedTextInputDelegate> textInputDelegate;
@property (nonatomic, readonly) CGSize contentSize;
@property (nonatomic, strong, nullable) ABI36_0_0RCTTextAttributes *ABI36_0_0ReactTextAttributes;
