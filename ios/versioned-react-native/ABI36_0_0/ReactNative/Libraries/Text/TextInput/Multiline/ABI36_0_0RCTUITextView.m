...
@implementation ABI36_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI36_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
}

@synthesize ABI36_0_0ReactTextAttributes = _ABI36_0_0ReactTextAttributes;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI36_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
  }
...
- (void)setABI36_0_0ReactTextAttributes:(ABI36_0_0RCTTextAttributes *)ABI36_0_0ReactTextAttributes
{
  if ([ABI36_0_0ReactTextAttributes isEqual:_ABI36_0_0ReactTextAttributes]) {
    return;
  }
  self.typingAttributes = ABI36_0_0ReactTextAttributes.effectiveTextAttributes;
  _ABI36_0_0ReactTextAttributes = ABI36_0_0ReactTextAttributes;
  // Update placeholder text attributes
  [self setPlaceholder:_placeholder];
}

- (ABI36_0_0RCTTextAttributes *)ABI36_0_0ReactTextAttributes
{
  return _ABI36_0_0ReactTextAttributes;
}
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  // see: https://github.com/facebook/ABI36_0_0React-native/issues/19339
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI36_0_0RCTCeilPixelValue(placeholderSize.width), ABI36_0_0RCTCeilPixelValue(placeholderSize.height));
...
- (NSDictionary<NSAttributedStringKey, id> *)placeholderEffectiveTextAttributes
{
  NSMutableDictionary<NSAttributedStringKey, id> *effectiveTextAttributes = [NSMutableDictionary dictionaryWithDictionary:@{
                                                                                                                            NSFontAttributeName: _ABI36_0_0ReactTextAttributes.effectiveFont ?: defaultPlaceholderFont(),
                                                                                                                            NSForegroundColorAttributeName: self.placeholderColor ?: defaultPlaceholderColor(),
                                                                                                                            NSKernAttributeName:isnan(_ABI36_0_0ReactTextAttributes.letterSpacing) ? @0 : @(_ABI36_0_0ReactTextAttributes.letterSpacing)
                                                                                                                            }];
  NSParagraphStyle *paragraphStyle = [_ABI36_0_0ReactTextAttributes effectiveParagraphStyle];
  if (paragraphStyle) {
