...
@interface ABI36_0_0RCTReconnectingWebSocket () <ABI36_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI36_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  __weak ABI36_0_0RCTSRWebSocket *socket = _socket;
