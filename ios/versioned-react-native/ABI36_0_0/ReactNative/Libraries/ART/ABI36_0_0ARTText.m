...
@implementation ABI36_0_0ARTText
...
static void ABI36_0_0ARTFreeTextFrame(ABI36_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI36_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI36_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI36_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI36_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
