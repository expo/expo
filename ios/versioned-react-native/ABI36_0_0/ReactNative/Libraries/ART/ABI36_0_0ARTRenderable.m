...
#import <ABI36_0_0React/ABI36_0_0ARTRenderable.h>

@implementation ABI36_0_0ARTRenderable

- (void)setFill:(ABI36_0_0ARTBrush *)fill
{
  [self invalidate];
  _fill = fill;
}
...
- (void)setStrokeDash:(ABI36_0_0ARTCGFloatArray)strokeDash
{
