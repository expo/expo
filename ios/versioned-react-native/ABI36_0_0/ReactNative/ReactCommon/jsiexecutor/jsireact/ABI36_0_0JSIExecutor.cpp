...
#include "ABI36_0_0jsireact/ABI36_0_0JSIExecutor.h"

#include <ABI36_0_0cxxreact/ABI36_0_0JSBigString.h>
#include <ABI36_0_0cxxreact/ABI36_0_0ModuleRegistry.h>
#include <ABI36_0_0cxxreact/ABI36_0_0ReactMarker.h>
#include <ABI36_0_0cxxreact/ABI36_0_0SystraceSection.h>
#include <folly/Conv.h>
#include <folly/json.h>
#include <glog/logging.h>
#include <ABI36_0_0jsi/ABI36_0_0JSIDynamic.h>
...
void JSIExecutor::loadApplicationScript(
  ...
  bool hasLogger(ABI36_0_0ReactMarker::logTaggedMarker);
  std::string scriptName = simpleBasename(sourceURL);
  if (hasLogger) {
    ABI36_0_0ReactMarker::logTaggedMarker(
        ABI36_0_0ReactMarker::RUN_JS_BUNDLE_START, scriptName.c_str());
  }
  runtime_->evaluateJavaScript(
      std::make_unique<BigStringBuffer>(std::move(script)), sourceURL);
  flush();
  if (hasLogger) {
    ABI36_0_0ReactMarker::logMarker(ABI36_0_0ReactMarker::CREATE_REACT_CONTEXT_STOP);
    ABI36_0_0ReactMarker::logTaggedMarker(
        ABI36_0_0ReactMarker::RUN_JS_BUNDLE_STOP, scriptName.c_str());
  }
}
        ...
        *runtime_,
        ...
        Function::createFromHostFunction(
            *runtime_,
            ...
            [this](
                __unused Runtime &rt,
                const ABI36_0_0facebook::jsi::Value &,
...
void JSIExecutor::registerBundle(
  ...
  ABI36_0_0ReactMarker::logTaggedMarker(
      ABI36_0_0ReactMarker::REGISTER_JS_SEGMENT_START, tag.c_str());
  if (bundleRegistry_) {
  ...
  ABI36_0_0ReactMarker::logTaggedMarker(
      ABI36_0_0ReactMarker::REGISTER_JS_SEGMENT_STOP, tag.c_str());
}
...
Value JSIExecutor::nativeRequire(const Value *args, size_t count) {
  ...
  return ABI36_0_0facebook::jsi::Value();
}
