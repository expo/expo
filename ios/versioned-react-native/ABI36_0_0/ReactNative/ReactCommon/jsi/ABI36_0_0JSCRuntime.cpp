...
#include "ABI36_0_0JSCRuntime.h"

#include <JavaScriptCore/JavaScript.h>
#include <atomic>
#include <condition_variable>
#include <cstdlib>
#include <ABI36_0_0jsi/ABI36_0_0jsilib.h>
#include <mutex>
#include <queue>
#include <sstream>
#include <thread>
...
#ifdef ABI36_0_0RN_FABRIC_ENABLED
...
#define JSC_LIKELY(ABI36_0_0EXPR) __builtin_expect((bool)(ABI36_0_0EXPR), true)
#define JSC_UNLIKELY(ABI36_0_0EXPR) __builtin_expect((bool)(ABI36_0_0EXPR), false)
#else
#define JSC_LIKELY(ABI36_0_0EXPR) (ABI36_0_0EXPR)
#define JSC_UNLIKELY(ABI36_0_0EXPR) (ABI36_0_0EXPR)
#endif
