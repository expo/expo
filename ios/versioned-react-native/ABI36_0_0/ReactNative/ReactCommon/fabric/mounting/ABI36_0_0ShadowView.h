...
#include <ABI36_0_0React/core/EventEmitter.h>
...
template <>
struct hash<ABI36_0_0facebook::ABI36_0_0React::ShadowView> {
  size_t operator()(const ABI36_0_0facebook::ABI36_0_0React::ShadowView &shadowView) const {
