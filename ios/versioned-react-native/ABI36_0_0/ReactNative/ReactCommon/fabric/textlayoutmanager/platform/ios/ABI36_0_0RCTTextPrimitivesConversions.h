...
#include <ABI36_0_0React/textlayoutmanager/ABI36_0_0RCTFontProperties.h>
#include <ABI36_0_0React/textlayoutmanager/ABI36_0_0RCTFontUtils.h>

using namespace ABI36_0_0facebook::ABI36_0_0React;

inline static NSTextAlignment ABI36_0_0RCTNSTextAlignmentFromTextAlignment(
...
inline static NSWritingDirection ABI36_0_0RCTNSWritingDirectionFromWritingDirection(
...
inline static ABI36_0_0RCTFontStyle ABI36_0_0RCTFontStyleFromFontStyle(FontStyle fontStyle) {
  switch (fontStyle) {
    case FontStyle::Normal:
      return ABI36_0_0RCTFontStyleNormal;
    case FontStyle::Italic:
      return ABI36_0_0RCTFontStyleItalic;
    case FontStyle::Oblique:
      return ABI36_0_0RCTFontStyleOblique;
  }
}

inline static ABI36_0_0RCTFontVariant ABI36_0_0RCTFontVariantFromFontVariant(
    FontVariant fontVariant) {
  return (ABI36_0_0RCTFontVariant)fontVariant;
}

inline static NSUnderlineStyle ABI36_0_0RCTNSUnderlineStyleFromStyleAndPattern(
...
inline static UIColor *ABI36_0_0RCTUIColorFromSharedColor(const SharedColor &color) {
