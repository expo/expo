...
- (void)abi36_0_0_rct_scaleFontSizeToFitSize:(CGSize)size
  ...
  while (true) {
    ...
    ABI36_0_0RCTTextSizeComparisonOptions comparsion = [self abi36_0_0_rct_compareToSize:size
                                                   thresholdRatio:0.01];

    if ((comparsion & ABI36_0_0RCTTextSizeComparisonWithinRange) &&
...
- (ABI36_0_0RCTTextSizeComparisonOptions)abi36_0_0_rct_compareToSize:(CGSize)size
  ...
  result |=
      (fitsSize) ? ABI36_0_0RCTTextSizeComparisonSmaller : ABI36_0_0RCTTextSizeComparisonLarger;
