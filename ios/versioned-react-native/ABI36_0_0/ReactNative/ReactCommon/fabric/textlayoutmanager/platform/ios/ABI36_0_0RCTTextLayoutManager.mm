...
#import "ABI36_0_0RCTAttributedTextUtils.h"

#import <ABI36_0_0React/utils/SimpleThreadSafeCache.h>

using namespace ABI36_0_0facebook::ABI36_0_0React;

@implementation ABI36_0_0RCTTextLayoutManager {
  SimpleThreadSafeCache<AttributedString, std::shared_ptr<const void>, 256> _cache;
}

static NSLineBreakMode ABI36_0_0RCTNSLineBreakModeFromWritingDirection(
...
- (ABI36_0_0facebook::ABI36_0_0React::Size)
  ...
  return ABI36_0_0facebook::ABI36_0_0React::Size{size.width, size.height};
}
...
- (NSTextStorage *)
  ...
  textContainer.lineBreakMode = paragraphAttributes.maximumNumberOfLines > 0
      ? ABI36_0_0RCTNSLineBreakModeFromWritingDirection(
...
- (SharedEventEmitter)
  ...
  if (textStorage.length > 0 && (fraction > 0 || characterIndex > 0) &&
    ...
    ABI36_0_0RCTWeakEventEmitterWrapper *eventEmitterWrapper =
        (ABI36_0_0RCTWeakEventEmitterWrapper *)[textStorage
                 attribute:ABI36_0_0RCTAttributedStringEventEmitterKey
...
- (NSAttributedString *)_nsAttributedStringFromAttributedString:(AttributedString)attributedString
{
  auto sharedNSAttributedString = _cache.get(attributedString, [](const AttributedString attributedString) {
    return std::shared_ptr<void>(
        (__bridge_retained void *)ABI36_0_0RCTNSAttributedStringFromAttributedString(attributedString), CFRelease);
  });
