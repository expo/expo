...
ViewProps::ViewProps(ABI36_0_0YGStyle const &yogaStyle) : YogaStylableProps(yogaStyle) {}
...
BorderMetrics ViewProps::resolveBorderMetrics(
  ...
  auto borderWidths = CascadedBorderWidths{
      /* .left = */ optionalFloatFromYogaValue(yogaStyle.border()[ABI36_0_0YGEdgeLeft]),
      /* .top = */ optionalFloatFromYogaValue(yogaStyle.border()[ABI36_0_0YGEdgeTop]),
      /* .right = */
      optionalFloatFromYogaValue(yogaStyle.border()[ABI36_0_0YGEdgeRight]),
      /* .bottom = */
      optionalFloatFromYogaValue(yogaStyle.border()[ABI36_0_0YGEdgeBottom]),
      /* .start = */
      optionalFloatFromYogaValue(yogaStyle.border()[ABI36_0_0YGEdgeStart]),
      /* .end = */ optionalFloatFromYogaValue(yogaStyle.border()[ABI36_0_0YGEdgeEnd]),
      /* .horizontal = */
      optionalFloatFromYogaValue(yogaStyle.border()[ABI36_0_0YGEdgeHorizontal]),
      /* .vertical = */
      optionalFloatFromYogaValue(yogaStyle.border()[ABI36_0_0YGEdgeVertical]),
      /* .all = */ optionalFloatFromYogaValue(yogaStyle.border()[ABI36_0_0YGEdgeAll]),
  };
...
bool ViewProps::getClipsContentToBounds() const {
  return yogaStyle.overflow() != ABI36_0_0YGOverflowVisible;
}

#ifdef ANDROID
bool ViewProps::getProbablyMoreHorizontalThanVertical_DEPRECATED() const {
  return yogaStyle.flexDirection() == ABI36_0_0YGFlexDirectionRow;
}
#endif
