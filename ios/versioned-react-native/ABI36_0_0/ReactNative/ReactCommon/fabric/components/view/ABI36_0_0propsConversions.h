...
static inline ABI36_0_0YGStyle::Dimensions convertRawProp(
    RawProps const &rawProps,
    char const *widthName,
    char const *heightName,
    ABI36_0_0YGStyle::Dimensions const &sourceValue,
    ABI36_0_0YGStyle::Dimensions const &defaultValue) {
  auto dimensions = defaultValue;
  dimensions[ABI36_0_0YGDimensionWidth] = convertRawProp(
      rawProps,
      widthName,
      sourceValue[ABI36_0_0YGDimensionWidth],
      defaultValue[ABI36_0_0YGDimensionWidth]);
  dimensions[ABI36_0_0YGDimensionHeight] = convertRawProp(
      rawProps,
      heightName,
      sourceValue[ABI36_0_0YGDimensionHeight],
      defaultValue[ABI36_0_0YGDimensionWidth]);
  return dimensions;
}

static inline ABI36_0_0YGStyle::Edges convertRawProp(
    RawProps const &rawProps,
    char const *prefix,
    char const *suffix,
    ABI36_0_0YGStyle::Edges const &sourceValue,
    ABI36_0_0YGStyle::Edges const &defaultValue) {
  auto result = defaultValue;
  result[ABI36_0_0YGEdgeLeft] = convertRawProp(
      rawProps,
      "Left",
      sourceValue[ABI36_0_0YGEdgeLeft],
      defaultValue[ABI36_0_0YGEdgeLeft],
      prefix,
      suffix);
  result[ABI36_0_0YGEdgeTop] = convertRawProp(
      rawProps,
      "Top",
      sourceValue[ABI36_0_0YGEdgeTop],
      defaultValue[ABI36_0_0YGEdgeTop],
      prefix,
      suffix);
  result[ABI36_0_0YGEdgeRight] = convertRawProp(
      rawProps,
      "Right",
      sourceValue[ABI36_0_0YGEdgeRight],
      defaultValue[ABI36_0_0YGEdgeRight],
      prefix,
      suffix);
  result[ABI36_0_0YGEdgeBottom] = convertRawProp(
      rawProps,
      "Bottom",
      sourceValue[ABI36_0_0YGEdgeBottom],
      defaultValue[ABI36_0_0YGEdgeBottom],
      prefix,
      suffix);
  result[ABI36_0_0YGEdgeStart] = convertRawProp(
      rawProps,
      "Start",
      sourceValue[ABI36_0_0YGEdgeStart],
      defaultValue[ABI36_0_0YGEdgeStart],
      prefix,
      suffix);
  result[ABI36_0_0YGEdgeEnd] = convertRawProp(
      rawProps,
      "End",
      sourceValue[ABI36_0_0YGEdgeEnd],
      defaultValue[ABI36_0_0YGEdgeEnd],
      prefix,
      suffix);
  result[ABI36_0_0YGEdgeHorizontal] = convertRawProp(
      rawProps,
      "Horizontal",
      sourceValue[ABI36_0_0YGEdgeHorizontal],
      defaultValue[ABI36_0_0YGEdgeHorizontal],
      prefix,
      suffix);
  result[ABI36_0_0YGEdgeVertical] = convertRawProp(
      rawProps,
      "Vertical",
      sourceValue[ABI36_0_0YGEdgeVertical],
      defaultValue[ABI36_0_0YGEdgeVertical],
      prefix,
      suffix);
  result[ABI36_0_0YGEdgeAll] = convertRawProp(
      rawProps,
      "",
      sourceValue[ABI36_0_0YGEdgeAll],
      defaultValue[ABI36_0_0YGEdgeAll],
      prefix,
      suffix);
  return result;
}
...
static inline ABI36_0_0YGStyle::Edges convertRawProp(
  ...
  auto result = defaultValue;
  result[ABI36_0_0YGEdgeLeft] = convertRawProp(
      rawProps, "left", sourceValue[ABI36_0_0YGEdgeLeft], defaultValue[ABI36_0_0YGEdgeLeft]);
  result[ABI36_0_0YGEdgeTop] = convertRawProp(
      rawProps, "top", sourceValue[ABI36_0_0YGEdgeTop], defaultValue[ABI36_0_0YGEdgeTop]);
  result[ABI36_0_0YGEdgeRight] = convertRawProp(
      rawProps, "right", sourceValue[ABI36_0_0YGEdgeRight], defaultValue[ABI36_0_0YGEdgeRight]);
  result[ABI36_0_0YGEdgeBottom] = convertRawProp(
      rawProps,
      "bottom",
      sourceValue[ABI36_0_0YGEdgeBottom],
      defaultValue[ABI36_0_0YGEdgeBottom]);
  result[ABI36_0_0YGEdgeStart] = convertRawProp(
      rawProps, "start", sourceValue[ABI36_0_0YGEdgeStart], defaultValue[ABI36_0_0YGEdgeStart]);
  result[ABI36_0_0YGEdgeEnd] = convertRawProp(
      rawProps, "end", sourceValue[ABI36_0_0YGEdgeEnd], defaultValue[ABI36_0_0YGEdgeEnd]);
  return result;
}

static inline ABI36_0_0YGStyle convertRawProp(
    RawProps const &rawProps,
    ABI36_0_0YGStyle const &sourceValue) {
