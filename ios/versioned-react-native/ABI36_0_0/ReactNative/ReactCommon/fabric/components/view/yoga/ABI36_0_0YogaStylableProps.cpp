...
#include "ABI36_0_0YogaStylableProps.h"
...
#include "ABI36_0_0conversions.h"

namespace ABI36_0_0facebook {
namespace ABI36_0_0React {

YogaStylableProps::YogaStylableProps(ABI36_0_0YGStyle const &yogaStyle)
    : yogaStyle(yogaStyle) {}
...
SharedDebugStringConvertibleList YogaStylableProps::getDebugProps() const {
  auto const defaultYogaStyle = ABI36_0_0YGStyle{};
  return {
