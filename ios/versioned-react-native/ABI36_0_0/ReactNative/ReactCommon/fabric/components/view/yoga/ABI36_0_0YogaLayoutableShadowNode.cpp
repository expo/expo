...
#include "ABI36_0_0YogaLayoutableShadowNode.h"
...
#include <ABI36_0_0yoga/ABI36_0_0Yoga.h>
...
void YogaLayoutableShadowNode::setChildren(
  ...
  auto oldChildren = isClean ? yogaNode_.getChildren() : ABI36_0_0YGVector{};
...
void YogaLayoutableShadowNode::setSize(Size size) const {
  ...
  style.dimensions()[ABI36_0_0YGDimensionWidth] = yogaStyleValueFromFloat(size.width);
  style.dimensions()[ABI36_0_0YGDimensionHeight] = yogaStyleValueFromFloat(size.height);
  yogaNode_.setStyle(style);
  yogaNode_.setDirty(true);
}

void YogaLayoutableShadowNode::setPositionType(
    ABI36_0_0YGPositionType positionType) const {
  ensureUnsealed();
...
void YogaLayoutableShadowNode::layout(LayoutContext layoutContext) {
  if (!getIsLayoutClean()) {
    ...
    {
      SystraceSection s("YogaLayoutableShadowNode::ABI36_0_0YGNodeCalculateLayout");

      ABI36_0_0YGNodeCalculateLayout(
          &yogaNode_, ABI36_0_0YGUndefined, ABI36_0_0YGUndefined, ABI36_0_0YGDirectionInherit);
    }
  }
...
ABI36_0_0YGNode *YogaLayoutableShadowNode::yogaNodeCloneCallbackConnector(
...
ABI36_0_0YGSize YogaLayoutableShadowNode::yogaNodeMeasureCallbackConnector(
  ...
  return ABI36_0_0YGSize{yogaFloatFromFloat(size.width),
                yogaFloatFromFloat(size.height)};
}

ABI36_0_0YGConfig &YogaLayoutableShadowNode::initializeYogaConfig(ABI36_0_0YGConfig &config) {
