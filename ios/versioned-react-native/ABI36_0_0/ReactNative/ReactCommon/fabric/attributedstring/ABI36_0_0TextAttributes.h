...
#include <ABI36_0_0React/attributedstring/primitives.h>
...
template <>
struct hash<ABI36_0_0facebook::ABI36_0_0React::TextAttributes> {
  size_t operator()(
      const ABI36_0_0facebook::ABI36_0_0React::TextAttributes &textAttributes) const {
