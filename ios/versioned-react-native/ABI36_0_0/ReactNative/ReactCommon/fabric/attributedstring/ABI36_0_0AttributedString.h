...
#include <ABI36_0_0React/mounting/ShadowView.h>
...
/*
 * Simple, cross-platfrom, ABI36_0_0React-specific implementation of attributed string
 * (aka spanned string).
...
namespace std {
template <>
struct hash<ABI36_0_0facebook::ABI36_0_0React::AttributedString::Fragment> {
  size_t operator()(
      const ABI36_0_0facebook::ABI36_0_0React::AttributedString::Fragment &fragment) const {
...
template <>
struct hash<ABI36_0_0facebook::ABI36_0_0React::AttributedString> {
  size_t operator()(
      const ABI36_0_0facebook::ABI36_0_0React::AttributedString &attributedString) const {
    auto seed = size_t{0};
