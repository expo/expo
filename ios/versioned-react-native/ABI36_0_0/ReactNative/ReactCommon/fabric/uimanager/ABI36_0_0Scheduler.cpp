...
Scheduler::Scheduler(
  ...
  ABI36_0_0ReactNativeConfig_ =
      schedulerToolbox.contextContainer
          ->at<std::shared_ptr<const ABI36_0_0ReactNativeConfig>>("ABI36_0_0ReactNativeConfig");
...
void Scheduler::renderTemplateToSurface(
  ...
  try {
    ...
    LOG(ERROR) << "    >>>> ABI36_0_0EXCEPTION <<<  rendering uiTemplate in "
