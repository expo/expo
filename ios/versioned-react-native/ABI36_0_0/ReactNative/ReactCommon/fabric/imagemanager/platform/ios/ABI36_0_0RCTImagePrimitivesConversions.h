...
inline static ABI36_0_0RCTResizeMode ABI36_0_0RCTResizeModeFromImageResizeMode(
    ImageResizeMode imageResizeMode) {
  switch (imageResizeMode) {
    case ImageResizeMode::Cover:
      return ABI36_0_0RCTResizeModeCover;
    case ImageResizeMode::Contain:
      return ABI36_0_0RCTResizeModeContain;
    case ImageResizeMode::Stretch:
      return ABI36_0_0RCTResizeModeStretch;
    case ImageResizeMode::Center:
      return ABI36_0_0RCTResizeModeCenter;
    case ImageResizeMode::Repeat:
      return ABI36_0_0RCTResizeModeRepeat;
  }
}
...
inline static NSURLRequest *NSURLRequestFromImageSource(
  ...
  if (!url) {
    ABI36_0_0RCTLogError(@"URI parsing error.");
    return nil;
  }
