...
#include <ABI36_0_0React/graphics/ColorComponents.h>
...
namespace std {
template <>
struct hash<ABI36_0_0facebook::ABI36_0_0React::SharedColor> {
  size_t operator()(const ABI36_0_0facebook::ABI36_0_0React::SharedColor &sharedColor) const {
