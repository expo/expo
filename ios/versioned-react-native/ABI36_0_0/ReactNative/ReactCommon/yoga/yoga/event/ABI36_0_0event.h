...
#include <vector>
#include <array>
#include <ABI36_0_0yoga/ABI36_0_0YGEnums.h>
...
struct Event {
  ...
  class Data;
  using Subscriber = void(const ABI36_0_0YGNode&, Type, Data);
  ...
  template <Type E>
  static void publish(const ABI36_0_0YGNode& node, const TypedData<E>& eventData = {}) {
#ifdef ABI36_0_0YG_ENABLE_EVENTS
...
private:
  static void publish(const ABI36_0_0YGNode&, Type, const Data&);
};
