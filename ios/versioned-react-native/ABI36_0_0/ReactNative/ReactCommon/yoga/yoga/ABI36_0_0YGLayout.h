...
struct ABI36_0_0YGLayout {
  std::array<float, 4> position = {};
  std::array<float, 2> dimensions = {{ABI36_0_0YGUndefined, ABI36_0_0YGUndefined}};
...
private:
  ...
  ABI36_0_0facebook::yoga::Bitfield<uint8_t, ABI36_0_0YGDirection, bool, bool, bool> flags_ =
      {ABI36_0_0YGDirectionInherit, false, false, false};

public:
  uint32_t computedFlexBasisGeneration = 0;
  ABI36_0_0YGFloatOptional computedFlexBasis = {};

  // Instead of recomputing the entire layout every single time, we cache some
  // information to break early when nothing changed
  uint32_t generationCount = 0;
  ABI36_0_0YGDirection lastOwnerDirection = (ABI36_0_0YGDirection) -1;

  uint32_t nextCachedMeasurementsIndex = 0;
  std::array<ABI36_0_0YGCachedMeasurement, ABI36_0_0YG_MAX_CACHED_RESULT_COUNT>
      cachedMeasurements = {};
  std::array<float, 2> measuredDimensions = {{ABI36_0_0YGUndefined, ABI36_0_0YGUndefined}};

  ABI36_0_0YGCachedMeasurement cachedLayout = ABI36_0_0YGCachedMeasurement();
  ...
  bool operator==(ABI36_0_0YGLayout layout) const;
  bool operator!=(ABI36_0_0YGLayout layout) const { return !(*this == layout); }
};
