...
#include "ABI36_0_0SampleCxxModule.h"
...
namespace ABI36_0_0facebook { namespace xplat { namespace samples {
...
ABI36_0_0facebook::xplat::module::CxxModule *SampleCxxModule() {
  return new ABI36_0_0facebook::xplat::samples::SampleCxxModule(
    folly::make_unique<ABI36_0_0facebook::xplat::samples::Sample>());
}
