...
@implementation ABI36_0_0RCTSafeAreaView {
...
{
  if (UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI36_0_0RCTScreenScale())) {
    return;
  }

  _currentSafeAreaInsets = safeAreaInsets;

  ABI36_0_0RCTSafeAreaViewLocalData *localData = [[ABI36_0_0RCTSafeAreaViewLocalData alloc] initWithInsets:safeAreaInsets];
