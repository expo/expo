...
typedef UIFont *(^ABI36_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ABI36_0_0React Native will use the System font for rendering by default. If you want to
 ...
 */
ABI36_0_0RCT_EXTERN void ABI36_0_0RCTSetDefaultFontHandler(ABI36_0_0RCTFontHandler handler);
ABI36_0_0RCT_EXTERN BOOL ABI36_0_0RCTHasFontHandlerSet(void);

@interface ABI36_0_0RCTFont : NSObject
...
@interface ABI36_0_0RCTConvert (ABI36_0_0RCTFont)
