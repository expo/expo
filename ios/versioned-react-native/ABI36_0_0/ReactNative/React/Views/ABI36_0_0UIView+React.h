...
@interface UIView (ABI36_0_0React) <ABI36_0_0RCTComponent>

/**
 * ABI36_0_0RCTComponent interface.
 */
- (NSArray<UIView *> *)ABI36_0_0ReactSubviews NS_REQUIRES_SUPER;
- (UIView *)ABI36_0_0ReactSuperview NS_REQUIRES_SUPER;
- (void)insertABI36_0_0ReactSubview:(UIView *)subview atIndex:(NSInteger)atIndex NS_REQUIRES_SUPER;
- (void)removeABI36_0_0ReactSubview:(UIView *)subview NS_REQUIRES_SUPER;
 ...
 */
@property (nonatomic, assign) ABI36_0_0YGDisplay ABI36_0_0ReactDisplay;

/**
 * The z-index of the view.
 */
@property (nonatomic, assign) NSInteger ABI36_0_0ReactZIndex;
...
/**
 * Updates the subviews array based on the ABI36_0_0ReactSubviews. Default behavior is
 * to insert the sortedABI36_0_0ReactSubviews into the UIView.
 */
 ...
 */
@property (nonatomic, readonly) UIEdgeInsets ABI36_0_0ReactBorderInsets;
@property (nonatomic, readonly) UIEdgeInsets ABI36_0_0ReactPaddingInsets;
@property (nonatomic, readonly) UIEdgeInsets ABI36_0_0ReactCompoundInsets;
@property (nonatomic, readonly) CGRect ABI36_0_0ReactContentFrame;
 ...
 * Defaults to `self`.
 */
@property (nonatomic, readonly) UIView *ABI36_0_0ReactAccessibilityElement;
