...
@implementation ABI36_0_0RCTTVView
{
      ...
      completion:^(__unused BOOL finished1){
        [UIView animateWithDuration:(pressDuration/2)
          ...
          completion:^(__unused BOOL finished2) {
            [[NSNotificationCenter defaultCenter] postNotificationName:ABI36_0_0RCTTVNavigationEventNotification 
              object:@{@"eventType":@"select",@"tag":self.ABI36_0_0ReactTag}];
          }];
       }];
...
- (void)didUpdateFocusInContext:(UIFocusUpdateContext *)context withAnimationCoordinator:(UIFocusAnimationCoordinator *)coordinator
{
  if (context.nextFocusedView == self && self.isTVSelectable ) {
    ...
    [coordinator addCoordinatedAnimations:^(void){
      ...
      [[NSNotificationCenter defaultCenter] postNotificationName:ABI36_0_0RCTTVNavigationEventNotification
                                                          object:@{@"eventType":@"focus",@"tag":self.ABI36_0_0ReactTag}];
    } completion:^(void){}];
  } else {
    [coordinator addCoordinatedAnimations:^(void){
      [[NSNotificationCenter defaultCenter] postNotificationName:ABI36_0_0RCTTVNavigationEventNotification
                                                          object:@{@"eventType":@"blur",@"tag":self.ABI36_0_0ReactTag}];
      [UIView animateWithDuration:0.2 animations:^{
...
- (void)setHasTVPreferredFocus:(BOOL)hasTVPreferredFocus
{
  ...
  if (hasTVPreferredFocus) {
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
      ...
      while (![rootview isABI36_0_0ReactRootView] && rootview != nil) {
