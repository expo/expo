...
#import "ABI36_0_0RCTBorderDrawing.h"
#import "ABI36_0_0RCTLog.h"

static const CGFloat ABI36_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI36_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return
  ABS(borderInsets.left - borderInsets.right) < ABI36_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.bottom) < ABI36_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.top) < ABI36_0_0RCTViewBorderThreshold;
}

BOOL ABI36_0_0RCTCornerRadiiAreEqual(ABI36_0_0RCTCornerRadii cornerRadii)
{
  return
  ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI36_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI36_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI36_0_0RCTViewBorderThreshold;
}

BOOL ABI36_0_0RCTBorderColorsAreEqual(ABI36_0_0RCTBorderColors borderColors)
{
  return
...
ABI36_0_0RCTCornerInsets ABI36_0_0RCTGetCornerInsets(ABI36_0_0RCTCornerRadii cornerRadii,
                                   UIEdgeInsets edgeInsets)
{
  return (ABI36_0_0RCTCornerInsets) {
    {
...
static UIEdgeInsets ABI36_0_0RCTRoundInsetsToPixel(UIEdgeInsets edgeInsets) {
    edgeInsets.top = ABI36_0_0RCTRoundPixelValue(edgeInsets.top);
    edgeInsets.bottom = ABI36_0_0RCTRoundPixelValue(edgeInsets.bottom);
    edgeInsets.left = ABI36_0_0RCTRoundPixelValue(edgeInsets.left);
    edgeInsets.right = ABI36_0_0RCTRoundPixelValue(edgeInsets.right);

    return edgeInsets;
}

static void ABI36_0_0RCTPathAddEllipticArc(CGMutablePathRef path,
...
CGPathRef ABI36_0_0RCTPathCreateWithRoundedRect(CGRect bounds,
                                       ABI36_0_0RCTCornerInsets cornerInsets,
                                       const CGAffineTransform *transform)
{
  ...
  ABI36_0_0RCTPathAddEllipticArc(path, transform, (CGPoint){
...
static void ABI36_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds,
                                               CGPoint lineStart,
                                               CGPoint lineEnd,
...
NS_INLINE BOOL ABI36_0_0RCTCornerRadiiAreAboveThreshold(ABI36_0_0RCTCornerRadii cornerRadii) {
  return (cornerRadii.topLeft > ABI36_0_0RCTViewBorderThreshold ||
    cornerRadii.topRight > ABI36_0_0RCTViewBorderThreshold      ||
    cornerRadii.bottomLeft > ABI36_0_0RCTViewBorderThreshold    ||
    cornerRadii.bottomRight > ABI36_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI36_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI36_0_0RCTCornerRadii cornerRadii) {
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI36_0_0RCTPathCreateWithRoundedRect(rect, ABI36_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef ABI36_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge) {
...
static UIImage *ABI36_0_0RCTGetSolidBorderImage(ABI36_0_0RCTCornerRadii cornerRadii,
                                       CGSize viewSize,
                                       UIEdgeInsets borderInsets,
                                       ABI36_0_0RCTBorderColors borderColors,
                                       CGColorRef backgroundColor,
                                       BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI36_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI36_0_0RCTCornerInsets cornerInsets = ABI36_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  borderInsets = ABI36_0_0RCTRoundInsetsToPixel(borderInsets);
  ...
  CGContextRef ctx = ABI36_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI36_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI36_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI36_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI36_0_0RCTEllipseGetIntersectionsWithLine((CGRect){
...
static UIImage *ABI36_0_0RCTGetDashedOrDottedBorderImage(ABI36_0_0RCTBorderStyle borderStyle,
                                                ABI36_0_0RCTCornerRadii cornerRadii,
                                                CGSize viewSize,
                                                UIEdgeInsets borderInsets,
                                                ABI36_0_0RCTBorderColors borderColors,
                                                CGColorRef backgroundColor,
                                                BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI36_0_0RCTBorderStyleDashed || borderStyle == ABI36_0_0RCTBorderStyleDotted);

  if (!ABI36_0_0RCTBorderColorsAreEqual(borderColors) || !ABI36_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI36_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI36_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI36_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI36_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI36_0_0RCTPathCreateWithRoundedRect(pathRect, ABI36_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI36_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
...
UIImage *ABI36_0_0RCTGetBorderImage(ABI36_0_0RCTBorderStyle borderStyle,
                           CGSize viewSize,
                           ABI36_0_0RCTCornerRadii cornerRadii,
                           UIEdgeInsets borderInsets,
                           ABI36_0_0RCTBorderColors borderColors,
                           ...
                           BOOL drawToEdge)
{
  ...
  switch (borderStyle) {
    case ABI36_0_0RCTBorderStyleSolid:
      return ABI36_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI36_0_0RCTBorderStyleDashed:
    case ABI36_0_0RCTBorderStyleDotted:
      return ABI36_0_0RCTGetDashedOrDottedBorderImage(borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI36_0_0RCTBorderStyleUnset:
      break;
  }
