...
/**
 * Contains any methods related to scrolling. Any `ABI36_0_0RCTView` that has scrolling
 * features should implement these methods.
 */
@protocol ABI36_0_0RCTScrollableProtocol
 ...
 */
@protocol ABI36_0_0RCTCustomRefreshContolProtocol

@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onRefresh;
