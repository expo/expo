...
@class ABI36_0_0RCTModalHostViewController;
@class ABI36_0_0RCTTVRemoteHandler;

@protocol ABI36_0_0RCTModalHostViewInteractor;

@interface ABI36_0_0RCTModalHostView : UIView <ABI36_0_0RCTInvalidating>

@property (nonatomic, copy) NSString *animationType;
@property (nonatomic, assign) UIModalPresentationStyle presentationStyle;
@property (nonatomic, assign, getter=isTransparent) BOOL transparent;

@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onShow;

@property (nonatomic, copy) NSNumber *identifier;

@property (nonatomic, weak) id<ABI36_0_0RCTModalHostViewInteractor> delegate;

@property (nonatomic, copy) NSArray<NSString *> *supportedOrientations;
@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onOrientationChange;

#if TARGET_OS_TV
@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onRequestClose;
...
@protocol ABI36_0_0RCTModalHostViewInteractor <NSObject>
