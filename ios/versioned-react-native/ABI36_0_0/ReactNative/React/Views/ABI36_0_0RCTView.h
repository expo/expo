...
@protocol ABI36_0_0RCTAutoInsetsProtocol;

@class ABI36_0_0RCTView;

@interface ABI36_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onAccessibilityAction;
@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onMagicTap;
@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onAccessibilityEscape;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI36_0_0RCTPointerEvents pointerEvents;

+ (void)autoAdjustInsetsForView:(UIView<ABI36_0_0RCTAutoInsetsProtocol> *)parentView
 ...
 */
@property (nonatomic, assign) UIUserInterfaceLayoutDirection ABI36_0_0ReactLayoutDirection;
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI36_0_0RCTBorderStyle borderStyle;
