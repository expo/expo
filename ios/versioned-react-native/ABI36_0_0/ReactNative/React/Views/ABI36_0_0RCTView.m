...
#import "ABI36_0_0RCTAutoInsetsProtocol.h"
...
UIAccessibilityTraits const ABI36_0_0SwitchAccessibilityTrait = 0x20000000000001;

@implementation UIView (ABI36_0_0RCTViewUnmounting)
...
- (void)ABI36_0_0React_remountAllSubviews
{
  ...
  for (UIView *subview in self.subviews) {
    [subview ABI36_0_0React_remountAllSubviews];
  }
}
...
- (void)ABI36_0_0React_updateClippedSubviewsWithClipRect:(CGRect)clipRect relativeToView:(UIView *)clipView
{
  ...
  for (UIView *subview in self.subviews) {
    [subview ABI36_0_0React_updateClippedSubviewsWithClipRect:clipRect relativeToView:clipView];
  }
}
...
- (UIView *)ABI36_0_0React_findClipView
{
  ...
  while (testView) {
    ...
    if ([testView isABI36_0_0ReactRootView]) {
      break;
    }
...
@implementation ABI36_0_0RCTView
{
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if ((self = [super initWithFrame:frame])) {
    ...
    _borderStyle = ABI36_0_0RCTBorderStyleSolid;
...
ABI36_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithCoder:unused)

- (void)setABI36_0_0ReactLayoutDirection:(UIUserInterfaceLayoutDirection)layoutDirection
{
  if (_ABI36_0_0ReactLayoutDirection != layoutDirection) {
    _ABI36_0_0ReactLayoutDirection = layoutDirection;
...
- (BOOL)didActivateAccessibilityCustomAction:(UIAccessibilityCustomAction *)action
{
  ...
  if (actionObject) {
    _onAccessibilityAction(@{
      ...
      @"actionTarget": self.ABI36_0_0ReactTag
    });
  }
  return YES;
}
...
{
  if ((self.accessibilityTraits & ABI36_0_0SwitchAccessibilityTrait) == ABI36_0_0SwitchAccessibilityTrait) {
...
- (void)setPointerEvents:(ABI36_0_0RCTPointerEvents)pointerEvents
{
  ...
  self.userInteractionEnabled = (pointerEvents != ABI36_0_0RCTPointerEventsNone);
  if (pointerEvents == ABI36_0_0RCTPointerEventsBoxNone) {
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
  ...
  BOOL needsHitSubview = !(_pointerEvents == ABI36_0_0RCTPointerEventsNone || _pointerEvents == ABI36_0_0RCTPointerEventsBoxOnly);
  if (needsHitSubview && (![self clipsToBounds] || isPointInside)) {
    // Take z-index into account when calculating the touch target.
    NSArray<UIView *> *sortedSubviews = [self ABI36_0_0ReactZIndexSortedSubviews];
  ...
  switch (_pointerEvents) {
    ...
    case ABI36_0_0RCTPointerEventsBoxOnly:
      return hitView;
    case ABI36_0_0RCTPointerEventsBoxNone:
      return hitSubview;
    default:
      ABI36_0_0RCTLogError(@"Invalid pointer-events specified %lld on %@", (long long)_pointerEvents, self);
      return hitSubview ?: hitView;
  }
}
...
{
  if (self.ABI36_0_0ReactAccessibilityElement == self) {
...
- (NSString *)description
{
  ...
  NSString *replacement = [NSString stringWithFormat:@"; ABI36_0_0ReactTag: %@;", self.ABI36_0_0ReactTag];
...
{
  while (view) {
    UIViewController *controller = view.ABI36_0_0ReactViewController;
    if (controller) {
      return (UIEdgeInsets){
  ...
  if (_removeClippedSubviews) {
    for (UIView *view in self.ABI36_0_0ReactSubviews) {
      if (view.superview != self) {
        ...
        [view ABI36_0_0React_remountAllSubviews];
      }
    }
  } else {
    // If _removeClippedSubviews is false, we must already be showing all subviews
    [super ABI36_0_0React_remountAllSubviews];
  }
}
...
- (void)ABI36_0_0React_updateClippedSubviewsWithClipRect:(CGRect)clipRect relativeToView:(UIView *)clipView
{
  ...
  if (!_removeClippedSubviews) {
    ...
    return [super ABI36_0_0React_updateClippedSubviewsWithClipRect:clipRect relativeToView:clipView];
  }

  if (self.ABI36_0_0ReactSubviews.count == 0) {
  ...
  for (UIView *view in self.ABI36_0_0ReactSubviews) {
    if (!CGSizeEqualToSize(CGRectIntersection(clipRect, view.frame).size, CGSizeZero)) {
      ...
      if (CGRectContainsRect(clipRect, view.frame)) {
        ...
        [view ABI36_0_0React_updateClippedSubviewsWithClipRect:clipRect relativeToView:clipView];
      }
...
- (void)setRemoveClippedSubviews:(BOOL)removeClippedSubviews
{
  if (!removeClippedSubviews && _removeClippedSubviews) {
    [self ABI36_0_0React_remountAllSubviews];
  }
...
- (void)updateClippedSubviews
{
  ...
  if (clipView) {
    [self ABI36_0_0React_updateClippedSubviewsWithClipRect:clipView.bounds relativeToView:clipView];
  }
}
...
static CGFloat ABI36_0_0RCTDefaultIfNegativeTo(CGFloat defaultValue, CGFloat x) {
...
- (UIEdgeInsets)bordersAsInsets
{
  ...
  const BOOL isRTL = _ABI36_0_0ReactLayoutDirection == UIUserInterfaceLayoutDirectionRightToLeft;

  if ([[ABI36_0_0RCTI18nUtil sharedInstance] doLeftAndRightSwapInRTL]) {
    const CGFloat borderStartWidth = ABI36_0_0RCTDefaultIfNegativeTo(_borderLeftWidth, _borderStartWidth);
    const CGFloat borderEndWidth = ABI36_0_0RCTDefaultIfNegativeTo(_borderRightWidth, _borderEndWidth);
    ...
    return (UIEdgeInsets) {
      ABI36_0_0RCTDefaultIfNegativeTo(borderWidth, _borderTopWidth),
      ABI36_0_0RCTDefaultIfNegativeTo(borderWidth, directionAwareBorderLeftWidth),
      ABI36_0_0RCTDefaultIfNegativeTo(borderWidth, _borderBottomWidth),
      ABI36_0_0RCTDefaultIfNegativeTo(borderWidth, directionAwareBorderRightWidth),
    };
  }
  ...
  return (UIEdgeInsets) {
    ABI36_0_0RCTDefaultIfNegativeTo(borderWidth, _borderTopWidth),
    ABI36_0_0RCTDefaultIfNegativeTo(borderWidth, ABI36_0_0RCTDefaultIfNegativeTo(_borderLeftWidth, directionAwareBorderLeftWidth)),
    ABI36_0_0RCTDefaultIfNegativeTo(borderWidth, _borderBottomWidth),
    ABI36_0_0RCTDefaultIfNegativeTo(borderWidth, ABI36_0_0RCTDefaultIfNegativeTo(_borderRightWidth, directionAwareBorderRightWidth)),
  };
}
...
- (ABI36_0_0RCTCornerRadii)cornerRadii
{
  ...
  if ([[ABI36_0_0RCTI18nUtil sharedInstance] doLeftAndRightSwapInRTL]) {
    const CGFloat topStartRadius = ABI36_0_0RCTDefaultIfNegativeTo(_borderTopLeftRadius, _borderTopStartRadius);
    const CGFloat topEndRadius = ABI36_0_0RCTDefaultIfNegativeTo(_borderTopRightRadius, _borderTopEndRadius);
    const CGFloat bottomStartRadius = ABI36_0_0RCTDefaultIfNegativeTo(_borderBottomLeftRadius, _borderBottomStartRadius);
    const CGFloat bottomEndRadius = ABI36_0_0RCTDefaultIfNegativeTo(_borderBottomRightRadius, _borderBottomEndRadius);
    ...
    topLeftRadius = ABI36_0_0RCTDefaultIfNegativeTo(radius, directionAwareTopLeftRadius);
    topRightRadius = ABI36_0_0RCTDefaultIfNegativeTo(radius, directionAwareTopRightRadius);
    bottomLeftRadius = ABI36_0_0RCTDefaultIfNegativeTo(radius, directionAwareBottomLeftRadius);
    bottomRightRadius = ABI36_0_0RCTDefaultIfNegativeTo(radius, directionAwareBottomRightRadius);
  } else {
    ...
    topLeftRadius = ABI36_0_0RCTDefaultIfNegativeTo(radius, ABI36_0_0RCTDefaultIfNegativeTo(_borderTopLeftRadius, directionAwareTopLeftRadius));
    topRightRadius = ABI36_0_0RCTDefaultIfNegativeTo(radius, ABI36_0_0RCTDefaultIfNegativeTo(_borderTopRightRadius, directionAwareTopRightRadius));
    bottomLeftRadius = ABI36_0_0RCTDefaultIfNegativeTo(radius, ABI36_0_0RCTDefaultIfNegativeTo(_borderBottomLeftRadius, directionAwareBottomLeftRadius));
    bottomRightRadius = ABI36_0_0RCTDefaultIfNegativeTo(radius, ABI36_0_0RCTDefaultIfNegativeTo(_borderBottomRightRadius, directionAwareBottomRightRadius));
  }

  // Get scale factors required to prevent radii from overlapping
  const CGSize size = self.bounds.size;
  const CGFloat topScaleFactor = ABI36_0_0RCTZeroIfNaN(MIN(1, size.width / (topLeftRadius + topRightRadius)));
  const CGFloat bottomScaleFactor = ABI36_0_0RCTZeroIfNaN(MIN(1, size.width / (bottomLeftRadius + bottomRightRadius)));
  const CGFloat rightScaleFactor = ABI36_0_0RCTZeroIfNaN(MIN(1, size.height / (topRightRadius + bottomRightRadius)));
  const CGFloat leftScaleFactor = ABI36_0_0RCTZeroIfNaN(MIN(1, size.height / (topLeftRadius + bottomLeftRadius)));

  // Return scaled radii
  return (ABI36_0_0RCTCornerRadii){
...
- (ABI36_0_0RCTBorderColors)borderColors
{
  ...
  if ([[ABI36_0_0RCTI18nUtil sharedInstance] doLeftAndRightSwapInRTL]) {
    ...
    return (ABI36_0_0RCTBorderColors){
...
- (void)displayLayer:(CALayer *)layer
{
  ...
  ABI36_0_0RCTUpdateShadowPathForView(self);

  const ABI36_0_0RCTCornerRadii cornerRadii = [self cornerRadii];
  const UIEdgeInsets borderInsets = [self bordersAsInsets];
  const ABI36_0_0RCTBorderColors borderColors = [self borderColors];

  BOOL useIOSBorderRendering =
  ABI36_0_0RCTCornerRadiiAreEqual(cornerRadii) &&
  ABI36_0_0RCTBorderInsetsAreEqual(borderInsets) &&
  ABI36_0_0RCTBorderColorsAreEqual(borderColors) &&
  _borderStyle == ABI36_0_0RCTBorderStyleSolid &&
  ...
  UIImage *image = ABI36_0_0RCTGetBorderImage(_borderStyle,
                                     layer.bounds.size,
                                     cornerRadii,
                                     borderInsets,
                                     borderColors,
...
static BOOL ABI36_0_0RCTLayerHasShadow(CALayer *layer)
{
  return layer.shadowOpacity * CGColorGetAlpha(layer.shadowColor) > 0;
}

static void ABI36_0_0RCTUpdateShadowPathForView(ABI36_0_0RCTView *view)
{
  if (ABI36_0_0RCTLayerHasShadow(view.layer)) {
    if (CGColorGetAlpha(view.backgroundColor.CGColor) > 0.999) {

      // If view has a solid background color, calculate shadow path from border
      const ABI36_0_0RCTCornerRadii cornerRadii = [view cornerRadii];
      const ABI36_0_0RCTCornerInsets cornerInsets = ABI36_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero);
      CGPathRef shadowPath = ABI36_0_0RCTPathCreateWithRoundedRect(view.bounds, cornerInsets, NULL);
      ...
      ABI36_0_0RCTLogAdvice(@"View #%@ of type %@ has a shadow set but cannot calculate "
        "shadow efficiently. Consider setting a background color to "
        "fix this, or apply the shadow to a more specific component.",
        view.ABI36_0_0ReactTag, [view class]);
    }
  }
}
...
- (void)updateClippingForLayer:(CALayer *)layer
{
  ...
  if (self.clipsToBounds) {
    ...
    const ABI36_0_0RCTCornerRadii cornerRadii = [self cornerRadii];
    if (ABI36_0_0RCTCornerRadiiAreEqual(cornerRadii)) {
      ...
      CGPathRef path = ABI36_0_0RCTPathCreateWithRoundedRect(self.bounds, ABI36_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
...
#define setBorderStyle(side)                           \
  - (void)setBorder##side##Style:(ABI36_0_0RCTBorderStyle)style \
  {                                                    \
