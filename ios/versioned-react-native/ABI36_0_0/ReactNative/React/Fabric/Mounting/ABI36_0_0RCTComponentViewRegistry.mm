...
@interface ABI36_0_0RCTUIManager (Hack)
...
@implementation ABI36_0_0RCTUIManager (Hack)
...
+ (void)registerView:(UIView *)view
{
  ...
  ABI36_0_0RCTUIManager *uiManager = [[ABI36_0_0RCTBridge currentBridge] uiManager];
  view.ABI36_0_0ReactTag = @(view.tag);
...
const NSInteger ABI36_0_0RCTComponentViewRegistryRecyclePoolMaxSize = 1024;

@implementation ABI36_0_0RCTComponentViewRegistry {
  NSMapTable<id /* ABI36_0_0ReactTag */, UIView<ABI36_0_0RCTComponentViewProtocol> *> *_registry;
  NSMapTable<id /* ComponentHandle */, NSHashTable<UIView<ABI36_0_0RCTComponentViewProtocol> *> *> *_recyclePool;
}
  ...
  if (self = [super init]) {
    ...
    _recyclePool =
        [NSMapTable mapTableWithKeyOptions:NSPointerFunctionsOpaquePersonality | NSPointerFunctionsOpaqueMemory
                              valueOptions:NSPointerFunctionsObjectPersonality];
    _componentViewFactory = [ABI36_0_0RCTComponentViewFactory standardComponentViewFactory];
...
- (void)preallocateViewComponents
{
  ...
  std::vector<std::pair<ComponentHandle, float>> componentMagnitudes = {
      {[ABI36_0_0RCTViewComponentView componentDescriptorProvider].handle, 1},
      {[ABI36_0_0RCTImageComponentView componentDescriptorProvider].handle, 0.3},
      {[ABI36_0_0RCTParagraphComponentView componentDescriptorProvider].handle, 0.3},
  };
...
- (UIView<ABI36_0_0RCTComponentViewProtocol> *)dequeueComponentViewWithComponentHandle:(ComponentHandle)componentHandle
                                                                          tag:(ABI36_0_0ReactTag)tag
{
  ...
  ABI36_0_0RCTAssert(
      ...
      @"ABI36_0_0RCTComponentViewRegistry: Attempt to dequeue already registered component.");

  UIView<ABI36_0_0RCTComponentViewProtocol> *componentView = [self _dequeueComponentViewWithComponentHandle:componentHandle];
  componentView.tag = tag;
  [_registry setObject:componentView forKey:(__bridge id)(void *)tag];

#ifdef LEGACY_UIMANAGER_INTEGRATION_ENABLED
  [ABI36_0_0RCTUIManager registerView:componentView];
#endif
                                  ...
                                  componentView:(UIView<ABI36_0_0RCTComponentViewProtocol> *)componentView
{
  ...
  ABI36_0_0RCTAssert(
      [_registry objectForKey:(__bridge id)(void *)tag],
      @"ABI36_0_0RCTComponentViewRegistry: Attempt to enqueue unregistered component.");

#ifdef LEGACY_UIMANAGER_INTEGRATION_ENABLED
  [ABI36_0_0RCTUIManager unregisterView:componentView];
#endif
...
- (nullable UIView<ABI36_0_0RCTComponentViewProtocol> *)_dequeueComponentViewWithComponentHandle:(ComponentHandle)componentHandle
{
  ABI36_0_0RCTAssertMainQueue();
  NSHashTable<UIView<ABI36_0_0RCTComponentViewProtocol> *> *componentViews =
  ...
  UIView<ABI36_0_0RCTComponentViewProtocol> *componentView = [componentViews anyObject];
                                   ...
                                   componentView:(UIView<ABI36_0_0RCTComponentViewProtocol> *)componentView
{
  ...
  if (componentViews.count >= ABI36_0_0RCTComponentViewRegistryRecyclePoolMaxSize) {
    return;
  }
