...
#import <ABI36_0_0React/components/text/ParagraphComponentDescriptor.h>
#import <ABI36_0_0React/components/text/ParagraphProps.h>
#import <ABI36_0_0React/components/text/ParagraphState.h>
#import <ABI36_0_0React/components/text/RawTextComponentDescriptor.h>
#import <ABI36_0_0React/components/text/TextComponentDescriptor.h>
#import <ABI36_0_0React/core/LocalData.h>
#import <ABI36_0_0React/graphics/Geometry.h>
#import <ABI36_0_0React/textlayoutmanager/ABI36_0_0RCTTextLayoutManager.h>
#import <ABI36_0_0React/textlayoutmanager/TextLayoutManager.h>
#import "ABI36_0_0RCTConversions.h"

using namespace ABI36_0_0facebook::ABI36_0_0React;

@implementation ABI36_0_0RCTParagraphComponentView {
...
- (void)drawRect:(CGRect)rect
{
  ...
  ABI36_0_0RCTTextLayoutManager *nativeTextLayoutManager =
      (__bridge ABI36_0_0RCTTextLayoutManager *)textLayoutManager->getNativeTextLayoutManager();

  CGRect frame = ABI36_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
...
{
  NSString *superAccessibilityLabel = ABI36_0_0RCTNSStringFromStringNilIfEmpty(_props->accessibilityLabel);
  ...
  return ABI36_0_0RCTNSStringFromString(_state->getData().attributedString.getString());
}
