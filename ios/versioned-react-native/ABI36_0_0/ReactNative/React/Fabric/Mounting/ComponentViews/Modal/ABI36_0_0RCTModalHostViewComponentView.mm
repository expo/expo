...
#import <ABI36_0_0React/components/modal/ModalHostViewComponentDescriptor.h>
#import <ABI36_0_0React/components/modal/ModalHostViewState.h>
...
#import "ABI36_0_0RCTFabricModalHostViewController.h"
...
@interface ABI36_0_0RCTModalHostViewComponentView () <ABI36_0_0RCTFabricModalHostViewControllerDelegate>

@end

@implementation ABI36_0_0RCTModalHostViewComponentView {
  ABI36_0_0RCTFabricModalHostViewController *_viewController;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _viewController = [ABI36_0_0RCTFabricModalHostViewController new];
...
- (void)ensurePresentedOnlyIfNeeded
{
  ...
  if (shouldBePresented) {
    UIViewController *controller = [self ABI36_0_0ReactViewController];
    return [controller
...
#pragma mark - ABI36_0_0RCTFabricModalHostViewControllerDelegate
...
- (void)boundsDidChange:(CGRect)newBounds
{
  ...
  if (_state != nullptr) {
    auto newState = ModalHostViewState{ABI36_0_0RCTSizeFromCGSize(newBounds.size)};
