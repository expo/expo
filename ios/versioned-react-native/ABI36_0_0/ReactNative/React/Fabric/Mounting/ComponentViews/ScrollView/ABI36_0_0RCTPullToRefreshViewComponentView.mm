...
#import <ABI36_0_0React/components/rncore/ComponentDescriptors.h>
#import <ABI36_0_0React/components/rncore/EventEmitters.h>
#import <ABI36_0_0React/components/rncore/Props.h>

#import <ABI36_0_0React/ABI36_0_0RCTConversions.h>
#import <ABI36_0_0React/ABI36_0_0RCTScrollViewComponentView.h>

using namespace ABI36_0_0facebook::ABI36_0_0React;

@implementation ABI36_0_0RCTPullToRefreshViewComponentView {
  UIRefreshControl *_refreshControl;
  ABI36_0_0RCTScrollViewComponentView *_scrollViewComponentView;
}
...
- (void)_updateTitle
{
  ...
  if (concreteProps.titleColor) {
    attributes[NSForegroundColorAttributeName] = ABI36_0_0RCTUIColorFromSharedColor(concreteProps.titleColor);
  }

  _refreshControl.attributedTitle =
      [[NSAttributedString alloc] initWithString:ABI36_0_0RCTNSStringFromString(concreteProps.title) attributes:attributes];
}
...
- (void)_attach
{
  ...
  _scrollViewComponentView = [ABI36_0_0RCTScrollViewComponentView findScrollViewComponentViewForView:self];
  if (!_scrollViewComponentView) {
    return;
  }
