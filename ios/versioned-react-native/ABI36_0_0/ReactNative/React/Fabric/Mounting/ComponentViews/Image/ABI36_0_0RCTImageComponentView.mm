...
#import <ABI36_0_0React/ABI36_0_0RCTImageResponseObserverProxy.h>
#import <ABI36_0_0React/components/image/ImageComponentDescriptor.h>
#import <ABI36_0_0React/components/image/ImageEventEmitter.h>
#import <ABI36_0_0React/components/image/ImageLocalData.h>
#import <ABI36_0_0React/components/image/ImageProps.h>
#import <ABI36_0_0React/imagemanager/ImageRequest.h>
#import <ABI36_0_0React/imagemanager/ABI36_0_0RCTImagePrimitivesConversions.h>

#import "ABI36_0_0RCTConversions.h"

@implementation ABI36_0_0RCTImageComponentView {
  UIImageView *_imageView;
  SharedImageLocalData _imageLocalData;
  const ImageResponseObserverCoordinator *_coordinator;
  std::unique_ptr<ABI36_0_0RCTImageResponseObserverProxy> _imageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _imageView.contentMode = (UIViewContentMode)ABI36_0_0RCTResizeModeFromImageResizeMode(defaultProps->resizeMode);

    _imageResponseObserverProxy = std::make_unique<ABI36_0_0RCTImageResponseObserverProxy>((__bridge void *)self);
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldImageProps.resizeMode != newImageProps.resizeMode) {
    if (newImageProps.resizeMode == ImageResizeMode::Repeat) {
      ...
      _imageView.contentMode = (UIViewContentMode)ABI36_0_0RCTResizeModeFromImageResizeMode(newImageProps.resizeMode);
    }
  }
...
#pragma mark - ABI36_0_0RCTImageResponseDelegate
...
- (void)didReceiveImage:(UIImage *)image fromObserver:(void *)observer
{
  ...
  if (imageProps.resizeMode == ImageResizeMode::Repeat) {
    image = [image resizableImageWithCapInsets:ABI36_0_0RCTUIEdgeInsetsFromEdgeInsets(imageProps.capInsets)
