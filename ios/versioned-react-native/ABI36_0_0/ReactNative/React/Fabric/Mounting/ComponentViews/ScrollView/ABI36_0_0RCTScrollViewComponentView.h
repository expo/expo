...
#import <ABI36_0_0React/ABI36_0_0RCTGenericDelegateSplitter.h>
 ...
 */
@interface ABI36_0_0RCTScrollViewComponentView : ABI36_0_0RCTViewComponentView

/*
 * Finds and returns the closet ABI36_0_0RCTScrollViewComponentView component to the given view
 */
...
@property (nonatomic, strong, readonly)
    ABI36_0_0RCTGenericDelegateSplitter<id<UIScrollViewDelegate>> *scrollViewDelegateSplitter;

@end

/*
 * ABI36_0_0RCTScrollableProtocol is a protocol which ABI36_0_0RCTScrollViewManager uses to communicate with all kinds of `UIScrollView`s.
 ...
 */
@interface ABI36_0_0RCTScrollViewComponentView (ScrollableProtocol) <ABI36_0_0RCTScrollableProtocol>
