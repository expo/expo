...
#import <ABI36_0_0React/components/slider/SliderComponentDescriptor.h>
#import <ABI36_0_0React/components/slider/SliderLocalData.h>

using namespace ABI36_0_0facebook::ABI36_0_0React;

@implementation ABI36_0_0RCTSliderComponentView {
  ...
  std::unique_ptr<ABI36_0_0RCTImageResponseObserverProxy> _trackImageResponseObserverProxy;
  std::unique_ptr<ABI36_0_0RCTImageResponseObserverProxy> _minimumTrackImageResponseObserverProxy;
  std::unique_ptr<ABI36_0_0RCTImageResponseObserverProxy> _maximumTrackImageResponseObserverProxy;
  std::unique_ptr<ABI36_0_0RCTImageResponseObserverProxy> _thumbImageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _trackImageResponseObserverProxy = std::make_unique<ABI36_0_0RCTImageResponseObserverProxy>((__bridge void *)self);
    _minimumTrackImageResponseObserverProxy = std::make_unique<ABI36_0_0RCTImageResponseObserverProxy>((__bridge void *)self);
    _maximumTrackImageResponseObserverProxy = std::make_unique<ABI36_0_0RCTImageResponseObserverProxy>((__bridge void *)self);
    _thumbImageResponseObserverProxy = std::make_unique<ABI36_0_0RCTImageResponseObserverProxy>((__bridge void *)self);
