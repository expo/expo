...
@implementation ABI36_0_0RCTFabricModalHostViewController {
  CGRect _lastViewBounds;
  ABI36_0_0RCTSurfaceTouchHandler *_touchHandler;
}
...
{
  return [ABI36_0_0RCTSharedApplication() statusBarStyle];
}
...
{
  return [ABI36_0_0RCTSharedApplication() isStatusBarHidden];
}
...
- (UIInterfaceOrientationMask)supportedInterfaceOrientations
{
  UIInterfaceOrientationMask appSupportedOrientationsMask =
      [ABI36_0_0RCTSharedApplication() supportedInterfaceOrientationsForWindow:[ABI36_0_0RCTSharedApplication() keyWindow]];
