...
#import <ABI36_0_0React/ABI36_0_0RCTTouchableComponentViewProtocol.h>
#import <ABI36_0_0React/ABI36_0_0UIView+ComponentViewProtocol.h>
 ...
 */
@interface ABI36_0_0RCTViewComponentView : UIView <ABI36_0_0RCTComponentViewProtocol, ABI36_0_0RCTTouchableComponentViewProtocol> {
 @protected
  ABI36_0_0facebook::ABI36_0_0React::LayoutMetrics _layoutMetrics;
  ABI36_0_0facebook::ABI36_0_0React::SharedViewProps _props;
  ABI36_0_0facebook::ABI36_0_0React::SharedViewEventEmitter _eventEmitter;
}
...
/**
 * Enforcing `call super` semantic for overridden methods from `ABI36_0_0RCTComponentViewProtocol`.
 * The methods update the instance variables.
 */
- (void)updateProps:(ABI36_0_0facebook::ABI36_0_0React::Props::Shared const &)props
           oldProps:(ABI36_0_0facebook::ABI36_0_0React::Props::Shared const &)oldProps NS_REQUIRES_SUPER;
- (void)updateEventEmitter:(ABI36_0_0facebook::ABI36_0_0React::EventEmitter::Shared const &)eventEmitter NS_REQUIRES_SUPER;
- (void)updateLayoutMetrics:(ABI36_0_0facebook::ABI36_0_0React::LayoutMetrics const &)layoutMetrics
           oldLayoutMetrics:(ABI36_0_0facebook::ABI36_0_0React::LayoutMetrics const &)oldLayoutMetrics NS_REQUIRES_SUPER;
