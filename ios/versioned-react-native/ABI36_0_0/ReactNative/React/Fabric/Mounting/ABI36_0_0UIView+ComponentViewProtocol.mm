...
#import "ABI36_0_0UIView+ComponentViewProtocol.h"
...
{
  ABI36_0_0RCTAssert(NO, @"`-[ABI36_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented in a concrete class.");
  return {};
}
...
{
  ABI36_0_0RCTAssert(childComponentView.superview == self, @"Attempt to unmount improperly mounted component view.");
           ...
           oldLayoutMetrics:(LayoutMetrics const &)oldLayoutMetrics
{
  if (layoutMetrics.frame != oldLayoutMetrics.frame) {
    CGRect frame = ABI36_0_0RCTCGRectFromRect(layoutMetrics.frame);
...
{
  ABI36_0_0RCTAssert(NO, @"props access should be implemented by ABI36_0_0RCTViewComponentView.");
  return nullptr;
}
