...
@class ABI36_0_0RCTSurfaceView;
@class ABI36_0_0RCTSurfacePresenter;
@protocol ABI36_0_0RCTSurfaceDelegate;

/**
 * (This is Fabric-compatible ABI36_0_0RCTSurface implementation.)
 *
 * ABI36_0_0RCTSurface instance represents ABI36_0_0React Native-powered piece of a user interface
 * which can be a full-screen app, separate modal view controller,
 * or even small widget.
 * It is called "Surface".
 *
 * The ABI36_0_0RCTSurface instance is completely thread-safe by design;
 ...
 *
 * The primary goals of the ABI36_0_0RCTSurface are:
 ...
 */
@interface ABI36_0_0RCTFabricSurface : NSObject

@property (atomic, readonly) ABI36_0_0RCTSurfaceStage stage;
@property (atomic, readonly) NSString *moduleName;
@property (atomic, readonly) ABI36_0_0ReactTag rootTag;

@property (atomic, readwrite, weak, nullable) id<ABI36_0_0RCTSurfaceDelegate> delegate;

@property (atomic, copy, readwrite) NSDictionary *properties;

- (instancetype)initWithSurfacePresenter:(ABI36_0_0RCTSurfacePresenter *)surfacePresenter
 ...
 * ABI36_0_0RCTSurface does not control (or influence in any way) the size or origin
 ...
 * The starting process includes initializing all underlying ABI36_0_0React Native
 * infrastructure and running ABI36_0_0React app.
...
/**
 * Simple shortcut to `-[ABI36_0_0RCTSurface setMinimumSize:size maximumSize:size]`.
 */
...
@interface ABI36_0_0RCTFabricSurface (Internal)

/**
 * Sets and clears given stage flags (bitmask).
 * Returns `YES` if the actual state was changed.
 */
- (BOOL)_setStage:(ABI36_0_0RCTSurfaceStage)stage;
- (BOOL)_unsetStage:(ABI36_0_0RCTSurfaceStage)stage;

@end

@interface ABI36_0_0RCTFabricSurface (Deprecated)
