...
#import "ABI36_0_0RCTSurfaceRegistry.h"
...
@implementation ABI36_0_0RCTSurfaceRegistry {
  better::shared_mutex _mutex;
  NSMapTable<id, ABI36_0_0RCTFabricSurface *> *_registry;
}
...
- (void)enumerateWithBlock:(ABI36_0_0RCTSurfaceEnumeratorBlock)block
{
...
- (void)registerSurface:(ABI36_0_0RCTFabricSurface *)surface
{
  ...
  ABI36_0_0ReactTag rootTag = surface.rootViewTag.integerValue;
