...
@interface ABI36_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI36_0_0RCTRedBoxExtraDataCell
...
@interface ABI36_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI36_0_0RCTRedBoxExtraDataViewController
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ABI36_0_0RCTRedBoxExtraDataCell *cell =
            (ABI36_0_0RCTRedBoxExtraDataCell *)[tableView
            dequeueReusableCellWithIdentifier:reuseIdentifier];

    if (cell == nil) {
        cell = [[ABI36_0_0RCTRedBoxExtraDataCell alloc]
