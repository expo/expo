...
NSString *const ABI36_0_0RCTTVNavigationEventNotification = @"ABI36_0_0RCTTVNavigationEventNotification";

static NSString *const TVNavigationEventName = @"onHWKeyEvent";

@implementation ABI36_0_0RCTTVNavigationEventEmitter
  ...
  if (self = [super init]) {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(handleTVNavigationEventNotification:)
                                                 name:ABI36_0_0RCTTVNavigationEventNotification
                                               object:nil];
