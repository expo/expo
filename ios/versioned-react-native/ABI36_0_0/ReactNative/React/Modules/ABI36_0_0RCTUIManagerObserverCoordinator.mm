...
@implementation ABI36_0_0RCTUIManagerObserverCoordinator {
  NSHashTable<id<ABI36_0_0RCTUIManagerObserver>> *_observers;
  std::mutex _mutex;
}
...
- (void)uiManagerWillPerformLayout:(ABI36_0_0RCTUIManager *)manager
{
  ...
  for (id<ABI36_0_0RCTUIManagerObserver> observer in _observers) {
