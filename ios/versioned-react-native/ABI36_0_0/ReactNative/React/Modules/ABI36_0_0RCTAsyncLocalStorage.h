 ...
 * being atomic, unless someone bypasses the `ABI36_0_0RCTAsyncLocalStorage` API.
 *
 * Keys and values must always be strings or an error is returned.
 */
@interface ABI36_0_0RCTAsyncLocalStorage : NSObject <ABI36_0_0RCTBridgeModule,ABI36_0_0RCTInvalidating>
...
// Clear the ABI36_0_0RCTAsyncLocalStorage data from native code
- (void)clearAllData;
...
- (void)multiGet:(NSArray<NSString *> *)keys callback:(ABI36_0_0RCTResponseSenderBlock)callback;

// Add multiple key value pairs to the cache.
- (void)multiSet:(NSArray<NSArray<NSString *> *> *)kvPairs callback:(ABI36_0_0RCTResponseSenderBlock)callback;
