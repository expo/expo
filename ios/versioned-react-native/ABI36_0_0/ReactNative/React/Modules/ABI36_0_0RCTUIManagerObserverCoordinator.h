...
typedef dispatch_block_t ABI36_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI36_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ABI36_0_0React-independent state can compute and cache
 * own intrinsic content size (which will be used by Yoga) at this point.
 */
- (void)uiManagerWillPerformLayout:(ABI36_0_0RCTUIManager *)manager;
 ...
 */
- (void)uiManagerDidPerformLayout:(ABI36_0_0RCTUIManager *)manager;
 ...
 * execution later).
 */
- (BOOL)uiManager:(ABI36_0_0RCTUIManager *)manager performMountingWithBlock:(ABI36_0_0RCTUIManagerMountingBlock)block;

/**
 * Called just after flushing UI blocks.
 * This is called from the UIManager queue.
 */
- (void)uiManagerDidPerformMounting:(ABI36_0_0RCTUIManager *)manager;

@end

/**
 * Simple helper which take care of ABI36_0_0RCTUIManager's observers.
 */
@interface ABI36_0_0RCTUIManagerObserverCoordinator : NSObject <ABI36_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI36_0_0RCTUIManagerObserver` protocol for more info.
 * References to observers are held weakly.
 * This method can be called safely from any queue.
 */
- (void)addObserver:(id<ABI36_0_0RCTUIManagerObserver>)observer;

/**
 * Remove a `UIManagerObserver`.
 * This method can be called safely from any queue.
 */
- (void)removeObserver:(id<ABI36_0_0RCTUIManagerObserver>)observer;
