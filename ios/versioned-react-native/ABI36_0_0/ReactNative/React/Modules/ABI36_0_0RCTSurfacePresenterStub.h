...
// TODO: Eventually this should go away and files should just include ABI36_0_0RCTSurfacePresenter.h, but
...
@protocol ABI36_0_0RCTSurfacePresenterObserver <NSObject>
...
@protocol ABI36_0_0RCTSurfacePresenterStub <NSObject>
...
@interface ABI36_0_0RCTBridge (ABI36_0_0RCTSurfacePresenterStub)

- (id<ABI36_0_0RCTSurfacePresenterStub>)surfacePresenter;
- (void)setSurfacePresenter:(id<ABI36_0_0RCTSurfacePresenterStub>)presenter;
