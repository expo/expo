...
#import "ABI36_0_0RCTDeviceInfo.h"
...
@implementation ABI36_0_0RCTDeviceInfo {
#if !TARGET_OS_TV
...
- (void)setBridge:(ABI36_0_0RCTBridge *)bridge
{
...
#if !TARGET_OS_TV
  _currentInterfaceOrientation = [ABI36_0_0RCTSharedApplication() statusBarOrientation];
  ...
  _currentInterfaceDimensions = ABI36_0_0RCTExportedDimensions(_bridge);
...
static BOOL ABI36_0_0RCTIsIPhoneX() {
...
static NSDictionary *ABI36_0_0RCTExportedDimensions(ABI36_0_0RCTBridge *bridge)
{
  ABI36_0_0RCTAssertMainQueue();

  ABI36_0_0RCTDimensions dimensions = ABI36_0_0RCTGetDimensions(bridge.accessibilityManager.multiplier);
...
{
  return @{
    @"Dimensions": ABI36_0_0RCTExportedDimensions(_bridge),
    // Note:
    // This prop is deprecated and will be removed in a future release.
    // Please use this only for a quick and temporary solution.
    // Use <SafeAreaView> instead.
    @"isIPhoneX_deprecated": @(ABI36_0_0RCTIsIPhoneX()),
  };
}
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [bridge.eventDispatcher sendDeviceEventWithName:@"didUpdateDimensions"
                                        body:ABI36_0_0RCTExportedDimensions(bridge)];
...
{
  UIInterfaceOrientation nextOrientation = [ABI36_0_0RCTSharedApplication() statusBarOrientation];
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
        [_bridge.eventDispatcher sendDeviceEventWithName:@"didUpdateDimensions"
                                                    body:ABI36_0_0RCTExportedDimensions(_bridge)];
#pragma clang diagnostic pop
      }
...
{
  NSDictionary *nextInterfaceDimensions = ABI36_0_0RCTExportedDimensions(_bridge);
