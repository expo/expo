...
extern NSString *const ABI36_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification; // posted when multiplier is changed

@interface ABI36_0_0RCTAccessibilityManager : NSObject <ABI36_0_0RCTBridgeModule>
...
@interface ABI36_0_0RCTBridge (ABI36_0_0RCTAccessibilityManager)

@property (nonatomic, readonly) ABI36_0_0RCTAccessibilityManager *accessibilityManager;
