...
#import "ABI36_0_0RCTKeyboardObserver.h"

#import "ABI36_0_0RCTEventDispatcher.h"

static NSDictionary *ABI36_0_0RCTParseKeyboardNotification(NSNotification *notification);

@implementation ABI36_0_0RCTKeyboardObserver
...
{ \
  ...
  [self sendEventWithName:@#EVENT \
    body:ABI36_0_0RCTParseKeyboardNotification(notification)]; \
}
...
NS_INLINE NSDictionary *ABI36_0_0RCTRectDictionaryValue(CGRect rect)
{
  return @{
...
static NSString *ABI36_0_0RCTAnimationNameForCurve(UIViewAnimationCurve curve)
{
  switch (curve) {
...
static NSDictionary *ABI36_0_0RCTParseKeyboardNotification(NSNotification *notification)
{
  ...
  return @{
    @"startCoordinates": ABI36_0_0RCTRectDictionaryValue(beginFrame),
    @"endCoordinates": ABI36_0_0RCTRectDictionaryValue(endFrame),
    @"duration": @(duration * 1000.0), // ms
    @"easing": ABI36_0_0RCTAnimationNameForCurve(curve),
