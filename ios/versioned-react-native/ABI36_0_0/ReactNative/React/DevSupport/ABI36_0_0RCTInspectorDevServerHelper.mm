...
static NSURL *getInspectorDeviceUrl(NSURL *bundleURL)
{
  ...
  NSString *inspectorProxyPortStr = [[[NSProcessInfo processInfo] environment] objectForKey:@"ABI36_0_0RCT_METRO_PORT"];
...
static NSURL *getAttachDeviceUrl(NSURL *bundleURL, NSString *title)
{
  ...
  NSString *metroBundlerPortStr = [[[NSProcessInfo processInfo] environment] objectForKey:@"ABI36_0_0RCT_METRO_PORT"];
...
@implementation ABI36_0_0RCTInspectorDevServerHelper

ABI36_0_0RCT_NOT_IMPLEMENTED(- (instancetype)init)

static NSMutableDictionary<NSString *, ABI36_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
...
+ (ABI36_0_0RCTInspectorPackagerConnection *)connectWithBundleURL:(NSURL *)bundleURL
{
  ...
  ABI36_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection) {
    connection = [[ABI36_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
