...
class ABI36_0_0RCTMessageThread : public MessageQueueThread {
 public:
  ABI36_0_0RCTMessageThread(NSRunLoop *runLoop, ABI36_0_0RCTJavaScriptCompleteBlock errorBlock);
  ~ABI36_0_0RCTMessageThread() override;
