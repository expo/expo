...
@interface ABI36_0_0RCTImageStoreManager : NSObject <ABI36_0_0RCTURLRequestHandler>
...
@interface ABI36_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI36_0_0RCTBridge (ABI36_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI36_0_0RCTImageStoreManager *imageStoreManager;
