...
@protocol ABI36_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI36_0_0RCTExceptionsManager : NSObject <ABI36_0_0RCTBridgeModule>
...
@property (nonatomic, weak) id<ABI36_0_0RCTExceptionsManagerDelegate> delegate;
