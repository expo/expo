...
#import "ABI36_0_0RCTUIUtils.h"

#import "ABI36_0_0RCTUtils.h"

ABI36_0_0RCTDimensions ABI36_0_0RCTGetDimensions(CGFloat fontScale)
{
  UIScreen *mainScreen = UIScreen.mainScreen;
  CGSize screenSize = mainScreen.bounds.size;

  UIView *mainWindow;
  mainWindow = ABI36_0_0RCTKeyWindow();
  CGSize windowSize = mainWindow.bounds.size;

  ABI36_0_0RCTDimensions result;
...
CGFloat ABI36_0_0RCTGetMultiplierForContentSizeCategory(UIContentSizeCategory category)
{
