 ...
 */
@interface ABI36_0_0RCTImageSource : NSObject
...
@interface ABI36_0_0RCTConvert (ImageSource)

+ (ABI36_0_0RCTImageSource *)ABI36_0_0RCTImageSource:(id)json;
+ (NSArray<ABI36_0_0RCTImageSource *> *)ABI36_0_0RCTImageSourceArray:(id)json;
