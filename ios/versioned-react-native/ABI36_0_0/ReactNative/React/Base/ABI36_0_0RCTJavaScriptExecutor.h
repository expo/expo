...
typedef void (^ABI36_0_0RCTJavaScriptCompleteBlock)(NSError *error);
typedef void (^ABI36_0_0RCTJavaScriptCallback)(id result, NSError *error);

/**
 * Abstracts away a JavaScript execution context - we may be running code in a
 * web view (for debugging purposes), or may be running code in a `JSContext`.
 */
@protocol ABI36_0_0RCTJavaScriptExecutor <ABI36_0_0RCTInvalidating, ABI36_0_0RCTBridgeModule>
...
- (void)executeApplicationScript:(NSData *)script
                      ...
                      onComplete:(ABI36_0_0RCTJavaScriptCompleteBlock)onComplete;

- (void)injectJSONText:(NSString *)script
   asGlobalObjectNamed:(NSString *)objectName
              callback:(ABI36_0_0RCTJavaScriptCompleteBlock)onComplete;
