...
extern NSString *const ABI36_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI36_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI36_0_0RCTBundleURLProvider : NSObject
