...
#import "ABI36_0_0RCTBundleURLProvider.h"

#import "ABI36_0_0RCTConvert.h"
#import "ABI36_0_0RCTDefines.h"

NSString *const ABI36_0_0RCTBundleURLProviderUpdatedNotification = @"ABI36_0_0RCTBundleURLProviderUpdatedNotification";

const NSUInteger kABI36_0_0RCTBundleURLProviderDefaultPort = ABI36_0_0RCT_METRO_PORT;

static NSString *const kABI36_0_0RCTJsLocationKey = @"ABI36_0_0RCT_jsLocation";
...
static NSString *const kABI36_0_0RCTEnableLiveReloadKey = @"ABI36_0_0RCT_enableLiveReload_LEGACY";
static NSString *const kABI36_0_0RCTEnableDevKey = @"ABI36_0_0RCT_enableDev";
static NSString *const kABI36_0_0RCTEnableMinificationKey = @"ABI36_0_0RCT_enableMinification";

@implementation ABI36_0_0RCTBundleURLProvider
...
{
  return @{
    kABI36_0_0RCTEnableLiveReloadKey: @NO,
    kABI36_0_0RCTEnableDevKey: @YES,
    kABI36_0_0RCTEnableMinificationKey: @NO,
  };
}

- (void)settingsUpdated
{
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI36_0_0RCTBundleURLProviderUpdatedNotification object:self];
}
...
static NSURL *serverRootWithHostPort(NSString *hostPort)
{
  ...
  return [NSURL URLWithString:
          [NSString stringWithFormat:@"http://%@:%lu/",
           hostPort, (unsigned long)kABI36_0_0RCTBundleURLProviderDefaultPort]];
}
...
- (NSURL *)jsBundleURLForBundleRoot:(NSString *)bundleRoot fallbackResource:(NSString *)resourceName fallbackExtension:(NSString *)extension
{
  ...
  if (!packagerServerHost) {
    ...
    return [ABI36_0_0RCTBundleURLProvider jsBundleURLForBundleRoot:bundleRoot
...
- (BOOL)enableDev
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI36_0_0RCTEnableDevKey];
}

- (BOOL)enableLiveReload
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI36_0_0RCTEnableLiveReloadKey];
}

- (BOOL)enableMinification
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI36_0_0RCTEnableMinificationKey];
}

- (NSString *)jsLocation
{
  return [[NSUserDefaults standardUserDefaults] stringForKey:kABI36_0_0RCTJsLocationKey];
}

- (void)setEnableDev:(BOOL)enableDev
{
  [self updateValue:@(enableDev) forKey:kABI36_0_0RCTEnableDevKey];
}

- (void)setEnableLiveReload:(BOOL)enableLiveReload
{
  [self updateValue:@(enableLiveReload) forKey:kABI36_0_0RCTEnableLiveReloadKey];
}

- (void)setJsLocation:(NSString *)jsLocation
{
  [self updateValue:jsLocation forKey:kABI36_0_0RCTJsLocationKey];
}

- (void)setEnableMinification:(BOOL)enableMinification
{
  [self updateValue:@(enableMinification) forKey:kABI36_0_0RCTEnableMinificationKey];
}

+ (instancetype)sharedSettings
{
  static ABI36_0_0RCTBundleURLProvider *sharedInstance;
  static dispatch_once_t once_token;
  dispatch_once(&once_token, ^{
    sharedInstance = [ABI36_0_0RCTBundleURLProvider new];
  });
