...
@interface ABI36_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>

@end

@implementation ABI36_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI36_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI36_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI36_0_0RCTMultipartStreamReader *reader = [[ABI36_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI36_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
