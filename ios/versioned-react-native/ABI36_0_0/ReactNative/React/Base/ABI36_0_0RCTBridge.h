...
@class ABI36_0_0RCTPerformanceLogger;

/**
 * This notification fires when the bridge initializes.
 */
ABI36_0_0RCT_EXTERN NSString *const ABI36_0_0RCTJavaScriptWillStartLoadingNotification;


/**
 * This notification fires when the bridge starts executing the JS bundle.
 */
ABI36_0_0RCT_EXTERN NSString *const ABI36_0_0RCTJavaScriptWillStartExecutingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI36_0_0RCT_EXTERN NSString *const ABI36_0_0RCTJavaScriptDidLoadNotification;

/**
 * This notification fires when the bridge failed to load the JS bundle. The
 * `error` key can be used to determine the error that occurred.
 */
ABI36_0_0RCT_EXTERN NSString *const ABI36_0_0RCTJavaScriptDidFailToLoadNotification;
 ...
 */
ABI36_0_0RCT_EXTERN NSString *const ABI36_0_0RCTDidInitializeModuleNotification;

/**
 * This notification fires each time a module is setup after it is initialized. The
 * `ABI36_0_0RCTDidSetupModuleNotificationModuleNameKey` key will contain a reference to the module name and
 * `ABI36_0_0RCTDidSetupModuleNotificationSetupTimeKey` will contain the setup time in ms.
 */
ABI36_0_0RCT_EXTERN NSString *const ABI36_0_0RCTDidSetupModuleNotification;

/**
 * Key for the module name (NSString) in the
 * ABI36_0_0RCTDidSetupModuleNotification userInfo dictionary.
 */
ABI36_0_0RCT_EXTERN NSString *const ABI36_0_0RCTDidSetupModuleNotificationModuleNameKey;

/**
 * Key for the setup time (NSNumber) in the
 * ABI36_0_0RCTDidSetupModuleNotification userInfo dictionary.
 */
ABI36_0_0RCT_EXTERN NSString *const ABI36_0_0RCTDidSetupModuleNotificationSetupTimeKey;

/**
 * This notification fires just before the bridge starts processing a request to
 * reload.
 */
ABI36_0_0RCT_EXTERN NSString *const ABI36_0_0RCTBridgeWillReloadNotification;

/**
 * This notification fires just before the bridge begins downloading a script
 * from the packager.
 */
ABI36_0_0RCT_EXTERN NSString *const ABI36_0_0RCTBridgeWillDownloadScriptNotification;

/**
 * This notification fires just after the bridge finishes downloading a script
 * from the packager.
 */
ABI36_0_0RCT_EXTERN NSString *const ABI36_0_0RCTBridgeDidDownloadScriptNotification;
 ...
 */
ABI36_0_0RCT_EXTERN NSString *const ABI36_0_0RCTBridgeWillInvalidateModulesNotification;

/**
 * This notification fires right after the bridge finishes invalidating NativeModule
 * instances during teardown. Handle this notification to perform additional invalidation.
 */
ABI36_0_0RCT_EXTERN NSString *const ABI36_0_0RCTBridgeDidInvalidateModulesNotification;

/**
 * Key for the ABI36_0_0RCTSource object in the ABI36_0_0RCTBridgeDidDownloadScriptNotification
 * userInfo dictionary.
 */
ABI36_0_0RCT_EXTERN NSString *const ABI36_0_0RCTBridgeDidDownloadScriptNotificationSourceKey;

/**
 * Key for the bridge description (NSString_ in the
 * ABI36_0_0RCTBridgeDidDownloadScriptNotification userInfo dictionary.
 */
ABI36_0_0RCT_EXTERN NSString *const ABI36_0_0RCTBridgeDidDownloadScriptNotificationBridgeDescriptionKey;
 ...
 */
typedef NSArray<id<ABI36_0_0RCTBridgeModule>> *(^ABI36_0_0RCTBridgeModuleListProvider)(void);

/**
 * This function returns the module name for a given class.
 */
ABI36_0_0RCT_EXTERN NSString *ABI36_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Experimental.
 * Check/set if JSI-bound NativeModule is enabled. By default it's off.
 */
ABI36_0_0RCT_EXTERN BOOL ABI36_0_0RCTTurboModuleEnabled(void);
ABI36_0_0RCT_EXTERN void ABI36_0_0RCTEnableTurboModule(BOOL enabled);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI36_0_0RCTBridge : NSObject <ABI36_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI36_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI36_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 */
@property (nonatomic, weak, readonly) id<ABI36_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ABI36_0_0React Native perf events.
 */
@property (nonatomic, readonly, strong) ABI36_0_0RCTPerformanceLogger *performanceLogger;
