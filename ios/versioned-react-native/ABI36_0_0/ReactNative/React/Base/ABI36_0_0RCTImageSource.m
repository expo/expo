...
@implementation ABI36_0_0RCTImageSource
...
{
  ABI36_0_0RCTImageSource *imageSource = [[ABI36_0_0RCTImageSource alloc] initWithURLRequest:_request
                                                                      size:size
                                                                     scale:scale];
...
- (BOOL)isEqual:(ABI36_0_0RCTImageSource *)object
{
  if (![object isKindOfClass:[ABI36_0_0RCTImageSource class]]) {
    return NO;
  }
...
{
  return [NSString stringWithFormat:@"<ABI36_0_0RCTImageSource: %p URL=%@, size=%@, scale=%0.f>",
          self, _request.URL, NSStringFromCGSize(_size), _scale];
}

@end

@implementation ABI36_0_0RCTConvert (ImageSource)

+ (ABI36_0_0RCTImageSource *)ABI36_0_0RCTImageSource:(id)json
{
  if (!json) {
    return nil;
  }
  ...
  if ([json isKindOfClass:[NSDictionary class]]) {
    ...
    ABI36_0_0RCTLogConvertError(json, @"an image. Did you forget to call resolveAssetSource() on the JS side?");
    return nil;
  }

  ABI36_0_0RCTImageSource *imageSource = [[ABI36_0_0RCTImageSource alloc] initWithURLRequest:request
                                                                      size:size
                                                                     scale:scale];
...
ABI36_0_0RCT_ARRAY_CONVERTER(ABI36_0_0RCTImageSource)
