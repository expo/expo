...
@protocol ABI36_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI36_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI36_0_0RCTBridgeModules automatically, however
 ...
 * previously called ABI36_0_0facebook::ABI36_0_0React::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI36_0_0RCTBridge *)bridge;
...
*/
- (BOOL)bridge:(ABI36_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI36_0_0RCTBridge *)bridge
                 onProgress:(ABI36_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI36_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI36_0_0RCTBridge *)bridge
                  withBlock:(ABI36_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Retrieve the list of lazy-native-modules names for the given bridge.
 */
- (NSDictionary<NSString *, Class> *)extraLazyModuleClassesForBridge:(ABI36_0_0RCTBridge *)bridge;
