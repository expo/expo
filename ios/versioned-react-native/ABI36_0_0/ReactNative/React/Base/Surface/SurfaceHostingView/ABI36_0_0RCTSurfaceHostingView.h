...
typedef UIView *_Nullable(^ABI36_0_0RCTSurfaceHostingViewActivityIndicatorViewFactory)(void);
 ...
 * of ABI36_0_0ReactNative-powered experiences in UIKit based apps.
 */
@interface ABI36_0_0RCTSurfaceHostingView : UIView <ABI36_0_0RCTSurfaceDelegate>

/**
 * Create an instance of ABI36_0_0RCTSurface to be hosted.
 */
...
- (instancetype)initWithSurface:(ABI36_0_0RCTSurface *)surface
                sizeMeasureMode:(ABI36_0_0RCTSurfaceSizeMeasureMode)sizeMeasureMode NS_DESIGNATED_INITIALIZER;
...
/**
 * Size measure mode which are defining relationship between UIKit and ABI36_0_0ReactNative
 * layout approaches.
 * Defaults to `ABI36_0_0RCTSurfaceSizeMeasureModeWidthAtMost | ABI36_0_0RCTSurfaceSizeMeasureModeHeightAtMost`.
 */
@property (nonatomic, assign) ABI36_0_0RCTSurfaceSizeMeasureMode sizeMeasureMode;
 ...
 */
@property (nonatomic, copy, nullable) ABI36_0_0RCTSurfaceHostingViewActivityIndicatorViewFactory activityIndicatorViewFactory;
