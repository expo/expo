...
#import <ABI36_0_0EXVideoThumbnails/ABI36_0_0EXVideoThumbnailsModule.h>
...
@implementation ABI36_0_0EXVideoThumbnailsModule

ABI36_0_0UM_EXPORT_MODULE(ExpoVideoThumbnails);
...
ABI36_0_0UM_EXPORT_METHOD_AS(getThumbnail,
                    ...
                    reject:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  if ([url isFileURL]) {
    ...
    if (!([_fileSystem permissionsForURI:url] & ABI36_0_0UMFileSystemPermissionRead)) {
