...
#import <ABI36_0_0EXMailComposer/ABI36_0_0EXMailComposer.h>
...
@interface ABI36_0_0EXMailComposer ()
...
@implementation ABI36_0_0EXMailComposer

ABI36_0_0UM_EXPORT_MODULE(ExpoMailComposer);
...
ABI36_0_0UM_EXPORT_METHOD_AS(composeAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  self.reject = reject;
  id<ABI36_0_0UMUtilitiesInterface> utilities = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI36_0_0UMUtilitiesInterface)];
