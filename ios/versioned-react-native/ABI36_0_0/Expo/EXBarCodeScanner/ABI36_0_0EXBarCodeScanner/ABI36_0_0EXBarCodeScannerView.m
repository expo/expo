...
@interface ABI36_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI36_0_0EXBarCodeScanner *barCodeScanner;
...
@implementation ABI36_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI36_0_0UMModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI36_0_0UMAppLifecycleListener)];
...
{
  ABI36_0_0UM_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI36_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI36_0_0EXBareCodeCameraRequester class]]) {
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI36_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI36_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI36_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI36_0_0EXBarCodeScanner *barCodeScanner = [ABI36_0_0EXBarCodeScanner new];
