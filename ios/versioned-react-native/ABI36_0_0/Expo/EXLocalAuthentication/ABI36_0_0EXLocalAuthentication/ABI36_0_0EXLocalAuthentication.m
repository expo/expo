...
#import <ABI36_0_0EXLocalAuthentication/ABI36_0_0EXLocalAuthentication.h>

typedef NS_ENUM(NSInteger, ABI36_0_0EXAuthenticationType) {
  ABI36_0_0EXAuthenticationTypeFingerprint = 1,
  ABI36_0_0EXAuthenticationTypeFacialRecognition = 2,
};

@implementation ABI36_0_0EXLocalAuthentication

ABI36_0_0UM_EXPORT_MODULE(ExpoLocalAuthentication)

ABI36_0_0UM_EXPORT_METHOD_AS(supportedAuthenticationTypesAsync,
                    supportedAuthenticationTypesAsync:(ABI36_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  NSMutableArray *results = [NSMutableArray array];
  if ([[self class] isTouchIdDevice]) {
    [results addObject:@(ABI36_0_0EXAuthenticationTypeFingerprint)];
  }
  if ([[self class] isFaceIdDevice]) {
    [results addObject:@(ABI36_0_0EXAuthenticationTypeFacialRecognition)];
  }
  resolve(results);
}

ABI36_0_0UM_EXPORT_METHOD_AS(hasHardwareAsync,
                    hasHardwareAsync:(ABI36_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI36_0_0UMPromiseRejectBlock)reject)
{
...
ABI36_0_0UM_EXPORT_METHOD_AS(isEnrolledAsync,
                    isEnrolledAsync:(ABI36_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
          ...
          localizedReason:reason
                    reply:^(BOOL success, NSError *error) {
                      resolve(@{
                                ...
                                @"warning": ABI36_0_0UMNullIfNil(warningMessage),
                                });
                    }];
}
