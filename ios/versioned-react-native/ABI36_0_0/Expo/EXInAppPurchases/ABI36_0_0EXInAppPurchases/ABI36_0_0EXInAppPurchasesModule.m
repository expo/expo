...
#import <ABI36_0_0EXInAppPurchases/ABI36_0_0EXInAppPurchasesModule.h>

@interface ABI36_0_0EXInAppPurchasesModule ()
...
@implementation ABI36_0_0EXInAppPurchasesModule

ABI36_0_0UM_EXPORT_MODULE(ExpoInAppPurchases);
...
ABI36_0_0UM_EXPORT_METHOD_AS(connectAsync,
                    connectAsync:(ABI36_0_0UMPromiseResolveBlock)resolve
...
ABI36_0_0UM_EXPORT_METHOD_AS(getProductsAsync,
...
ABI36_0_0UM_EXPORT_METHOD_AS(purchaseItemAsync,
...
ABI36_0_0UM_EXPORT_METHOD_AS(finishTransactionAsync,
...
ABI36_0_0UM_EXPORT_METHOD_AS(getPurchaseHistoryAsync,
...
- (BOOL)setPromise:(NSString*)key resolve:(ABI36_0_0UMPromiseResolveBlock)resolve reject:(ABI36_0_0UMPromiseRejectBlock)reject
{
...
- (void)resolvePromise:(NSString*)key value:(id)value
{
  ...
  if (currentPromise != nil) {
    ABI36_0_0UMPromiseResolveBlock resolve = currentPromise[0];
    _promises[key] = nil;
...
- (void)rejectPromise:(NSString*)key code:(NSString*)code message:(NSString*)message error:(NSError*) error
{
  ...
  if (currentPromise != nil) {
    ABI36_0_0UMPromiseRejectBlock reject = currentPromise[1];
    _promises[key] = nil;
