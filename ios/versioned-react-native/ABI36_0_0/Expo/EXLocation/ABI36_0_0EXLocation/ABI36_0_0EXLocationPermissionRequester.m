...
@interface ABI36_0_0EXLocationPermissionRequester () <CLLocationManagerDelegate>
...
@implementation ABI36_0_0EXLocationPermissionRequester
...
- (NSDictionary *)getPermissions
{
  ...
  if (![[self class] isConfiguredForAlwaysAuthorization] && ![[self class] isConfiguredForWhenInUseAuthorization]) {
    ABI36_0_0UMFatal(ABI36_0_0UMErrorWithMessage(@"This app is missing usage descriptions, so location services will fail. Add one of the `NSLocation*UsageDescription` keys to your bundle's Info.plist. See https://bit.ly/2P5fEbG (https://docs.expo.io/versions/latest/guides/app-stores.html#system-permissions-dialogs-on-ios) for more information."));
...
- (void)requestPermissionsWithResolver:(ABI36_0_0UMPromiseResolveBlock)resolve rejecter:(ABI36_0_0UMPromiseRejectBlock)reject
{
  ...
  if (existingPermissions && [existingPermissions[@"status"] intValue] != ABI36_0_0UMPermissionStatusUndetermined) {
