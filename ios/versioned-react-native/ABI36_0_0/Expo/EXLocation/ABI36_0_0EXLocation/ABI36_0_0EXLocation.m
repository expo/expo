...
ABI36_0_0UM_EXPORT_METHOD_AS(getLastKnownPositionAsync,
                    getLastKnownPositionAsync:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  if (![self checkPermissions:reject]) {
    return;
  ...
  delegate = [[ABI36_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:lockMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (lockMgr) {
