...
@interface ABI36_0_0EXTaskExecutionRequest ()

@property (nonatomic, strong, nullable) NSMutableSet<id<ABI36_0_0UMTaskInterface>> *tasks;
...
@implementation ABI36_0_0EXTaskExecutionRequest
...
- (void)_maybeExecuteCallback
{
  if (_callback) {
    ...
    __strong ABI36_0_0EXTaskExecutionRequest *strongSelf = self;
