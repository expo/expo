#import <ABI36_0_0EXAdsFacebook/ABI36_0_0EXAdSettingsManager.h>
#import <FBAudienceNetwork/FBAudienceNetwork.h>
#import <ABI36_0_0UMCore/ABI36_0_0UMAppLifecycleService.h>

@interface ABI36_0_0EXAdSettingsManager ()
...
@implementation ABI36_0_0EXAdSettingsManager

ABI36_0_0UM_EXPORT_MODULE(CTKAdSettingsManager)
...
ABI36_0_0UM_EXPORT_METHOD_AS(addTestDevice,
...
ABI36_0_0UM_EXPORT_METHOD_AS(clearTestDevices,
                    clearTestDevicesWithResolver:(ABI36_0_0UMPromiseResolveBlock)resolver
                    reject:(ABI36_0_0UMPromiseRejectBlock)rejecter)
{
...
ABI36_0_0UM_EXPORT_METHOD_AS(setLogLevel,
...
ABI36_0_0UM_EXPORT_METHOD_AS(setIsChildDirected,
...
ABI36_0_0UM_EXPORT_METHOD_AS(setMeditationService,
...
ABI36_0_0UM_EXPORT_METHOD_AS(setUrlPrefix,
