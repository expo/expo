...
@interface ABI36_0_0EXNativeAdView ()

@property (nonatomic, weak) ABI36_0_0UMModuleRegistry *moduleRegistry;

@end

@implementation ABI36_0_0EXNativeAdView
...
- (void)setOnAdLoaded:(ABI36_0_0UMDirectEventBlock)onAdLoaded
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    if (strongSelf) {
      [strongSelf.nativeAd registerViewForInteraction:strongSelf
                                            mediaView:mediaView
                                             iconView:adIconView
                                       viewController:[[strongSelf.moduleRegistry getModuleImplementingProtocol:@protocol(ABI36_0_0UMUtilitiesInterface)] currentViewController]
