...
#import <ABI36_0_0EXFont/ABI36_0_0EXFontLoader.h>
#import <ABI36_0_0EXFont/ABI36_0_0EXFontLoaderProcessor.h>
...
@interface ABI36_0_0EXFontLoader ()

@property (nonatomic, strong) ABI36_0_0EXFontScaler *scaler;
@property (nonatomic, strong) ABI36_0_0EXFontLoaderProcessor *processor;
@property (nonatomic, strong) ABI36_0_0EXFontManager *manager;

@end

@implementation ABI36_0_0EXFontLoader

ABI36_0_0UM_EXPORT_MODULE(ExpoFontLoader);

- (instancetype)init
{
  if (self = [super init]) {
    _scaler = [[ABI36_0_0EXFontScaler alloc] init];
    _manager = [[ABI36_0_0EXFontManager alloc] init];
    _processor = [[ABI36_0_0EXFontLoaderProcessor alloc] initWithManager:_manager];
  }
  return self;
}
...
- (instancetype)initWithFontFamilyPrefix:(NSString *)prefix
{
  if (self = [super init]) {
    _scaler = [[ABI36_0_0EXFontScaler alloc] init];
    _manager = [[ABI36_0_0EXFontManager alloc] init];
    _processor = [[ABI36_0_0EXFontLoaderProcessor alloc] initWithFontFamilyPrefix:prefix manager:_manager];
  }
  return self;
}
...
{
  if (moduleRegistry) {
    id<ABI36_0_0UMFontManagerInterface> manager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI36_0_0UMFontManagerInterface)];
    [manager addFontProcessor:_processor];

    id<ABI36_0_0UMFontScalersManagerInterface> scalersManager = [moduleRegistry getSingletonModuleForName:@"FontScalersManager"];
    [scalersManager registerFontScaler:_scaler];
  }
}

ABI36_0_0UM_EXPORT_METHOD_AS(loadAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  [_manager setFont:[[ABI36_0_0EXFont alloc] initWithCGFont:font] forName:fontFamilyName];
  resolve(nil);
}
