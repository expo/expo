...
#import <ABI36_0_0EXHaptics/ABI36_0_0EXHapticsModule.h>

@interface ABI36_0_0EXHapticsModule ()

@end

@implementation ABI36_0_0EXHapticsModule

ABI36_0_0UM_EXPORT_MODULE(ExpoHaptics);
...
ABI36_0_0UM_EXPORT_METHOD_AS(notificationAsync,
...
ABI36_0_0UM_EXPORT_METHOD_AS(impactAsync,
...
ABI36_0_0UM_EXPORT_METHOD_AS(selectionAsync,
                    resolve:(ABI36_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI36_0_0UMPromiseRejectBlock)reject)
{
