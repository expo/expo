...
#import <ABI36_0_0UMTaskManagerInterface/ABI36_0_0UMTaskLaunchReason.h>
...
@protocol ABI36_0_0UMTaskConsumerInterface <NSObject>

@property (nonatomic, strong) id<ABI36_0_0UMTaskInterface> __nullable task;
...
/**
 *  Called by ABI36_0_0UMTaskService when the task is created and associated with the consumer.
 */
- (void)didRegisterTask:(nonnull id<ABI36_0_0UMTaskInterface>)task;
 ...
 */
+ (BOOL)supportsLaunchReason:(ABI36_0_0UMTaskLaunchReason)launchReason;
...
/**
 *  Called by ABI36_0_0UMTaskService to inform the consumer that the associated task is ready to be executed.
 */
...
/**
 *  Called by ABI36_0_0UMTaskManager when the task has been completed and we received a result from JS app.
 */
- (void)didFinish;
