...
// Interface for ABI36_0_0UMTaskManager module.

@protocol ABI36_0_0UMTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI36_0_0UMTaskConsumerInterface protocol.
 */
