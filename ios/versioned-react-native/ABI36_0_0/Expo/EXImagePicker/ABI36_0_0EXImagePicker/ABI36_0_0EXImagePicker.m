#import <ABI36_0_0EXImagePicker/ABI36_0_0EXImagePicker.h>
...
const CGFloat ABI36_0_0EXDefaultImageQuality = 0.2;

@interface ABI36_0_0EXImagePicker ()
...
@implementation ABI36_0_0EXImagePicker

ABI36_0_0UM_EXPORT_MODULE(ExponentImagePicker);
...
- (void)setModuleRegistry:(ABI36_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  _permissionsManager = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI36_0_0UMPermissionsInterface)];
  [ABI36_0_0UMPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI36_0_0EXImagePickerCameraPermissionRequester new],
                                                    [ABI36_0_0EXImagePickerCameraRollPermissionRequester new]
                                                    ]
                           withPermissionsManager:_permissionsManager];
}

ABI36_0_0UM_EXPORT_METHOD_AS(getCameraPermissionsAsync,
                    getCameraPermissionsAsync:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  [ABI36_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI36_0_0EXImagePickerCameraPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI36_0_0UM_EXPORT_METHOD_AS(getCameraRollPermissionsAsync,
                    getPermissionsAsync:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  [ABI36_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI36_0_0EXImagePickerCameraRollPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI36_0_0UM_EXPORT_METHOD_AS(requestCameraPermissionsAsync,
                    requestCameraPermissionsAsync:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
...
ABI36_0_0UM_EXPORT_METHOD_AS(requestCameraRollPermissionsAsync,
                    requestCameraRollPermissionsAsync:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  [ABI36_0_0UMPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI36_0_0EXImagePickerCameraRollPermissionRequester class]
...
ABI36_0_0UM_EXPORT_METHOD_AS(launchCameraAsync, launchCameraAsync:(NSDictionary *)options
                  ...
                  rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  BOOL permissionsAreGranted = [self hasCameraRollPermission] &&
                               [self.permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI36_0_0EXImagePickerCameraPermissionRequester class]];
  ...
  self.reject = reject;
  [self launchImagePicker:ABI36_0_0EXImagePickerTargetCamera options:options];
}

ABI36_0_0UM_EXPORT_METHOD_AS(launchImageLibraryAsync, launchImageLibraryAsync:(NSDictionary *)options
                  resolver:(ABI36_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  if (!_permissionsManager) {
  ...
  self.resolve = resolve;
  self.reject = reject;
  [self launchImagePicker:ABI36_0_0EXImagePickerTargetLibrarySingleImage options:options];
}

- (void)launchImagePicker:(ABI36_0_0EXImagePickerTarget)target options:(NSDictionary *)options
{
...
- (void)launchImagePicker:(ABI36_0_0EXImagePickerTarget)target
{
  dispatch_async(dispatch_get_main_queue(), ^{
    self.picker = [[UIImagePickerController alloc] init];

    if (target == ABI36_0_0EXImagePickerTargetCamera) {
  ...
  #endif
    } else { // ABI36_0_0RNImagePickerTargetLibrarySingleImage
    ...
    id<ABI36_0_0UMUtilitiesInterface> utils = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI36_0_0UMUtilitiesInterface)];
...
- (void)unlockCroppingBox:(UIImagePickerController *)imagePickerController
{
  ...
  [ABI36_0_0EXImagePicker foreachSubviewIn:imagePickerController.view call:^(UIView *subview) {
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
  dispatch_block_t dismissCompletionBlock = ^{
    ...
    id<ABI36_0_0UMFileSystemInterface> fileSystem = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI36_0_0UMFileSystemInterface)];
    if (!fileSystem) {
          ...
          completionHandler:(void (^)(void))completionHandler
{
  ...
  NSData *data = UIImageJPEGRepresentation(image, quality == nil ? ABI36_0_0EXDefaultImageQuality : [quality floatValue]);
  ...
  if ([[self.options objectForKey:@"exif"] boolValue]) {
    ...
    if (metadata) {
      ...
      if (!asset) {
        ABI36_0_0UMLogInfo(@"Could not fetch metadata for image %@", [imageURL absoluteString]);
        completionHandler();
      }
...
- (BOOL)hasCameraRollPermission
{
  ...
  return [_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI36_0_0EXImagePickerCameraRollPermissionRequester class]];
}
...
+ (void)foreachSubviewIn:(UIView *)view call:(void (^)(UIView *subview))function 
{
  for (UIView *subview in view.subviews) {
    function(subview);
    [ABI36_0_0EXImagePicker foreachSubviewIn:subview call:function];
  }
}
