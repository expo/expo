...
@implementation ABI36_0_0UMAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitialized {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI36_0_0UMSingletonModule*> * singletonModules = [[ABI36_0_0UMModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI36_0_0UMSingletonModule *singletonModule in singletonModules) {
