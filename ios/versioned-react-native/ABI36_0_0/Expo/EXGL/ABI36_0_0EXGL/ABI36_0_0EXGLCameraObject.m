...
@interface ABI36_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) id<ABI36_0_0UMCameraInterface> camera;
...
@implementation ABI36_0_0EXGLCameraObject
