...
#import <ABI36_0_0EXSpeech/ABI36_0_0EXSpeech.h>

@interface ABI36_0_0EXSpeechUtteranceWithId : AVSpeechUtterance
...
@implementation ABI36_0_0EXSpeechUtteranceWithId
...
@interface ABI36_0_0EXSpeech () <AVSpeechSynthesizerDelegate>
...
@implementation ABI36_0_0EXSpeech

ABI36_0_0UM_EXPORT_MODULE(ExponentSpeech)
...
{
  id<ABI36_0_0UMEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI36_0_0UMEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStarted" body:@{ @"id": ((ABI36_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didCancelSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI36_0_0UMEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI36_0_0UMEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStopped" body:@{ @"id": ((ABI36_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didFinishSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI36_0_0UMEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI36_0_0UMEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingDone" body:@{ @"id": ((ABI36_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}


ABI36_0_0UM_EXPORT_METHOD_AS(speak,
  ...
  AVSpeechUtterance *utterance = [[ABI36_0_0EXSpeechUtteranceWithId alloc] initWithString:text utteranceId:utteranceId];
...
ABI36_0_0UM_EXPORT_METHOD_AS(getVoices,
                    getVoices:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject) {
...
ABI36_0_0UM_EXPORT_METHOD_AS(stop,
                    stop:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject) {
  [_synthesizer stopSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI36_0_0UM_EXPORT_METHOD_AS(pause,
                    pause:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject) {
  [_synthesizer pauseSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI36_0_0UM_EXPORT_METHOD_AS(resume,
                    resume:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject) {
  [_synthesizer continueSpeaking];
  resolve(nil);
}

ABI36_0_0UM_EXPORT_METHOD_AS(isSpeaking,
                    isSpeaking:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject) {
