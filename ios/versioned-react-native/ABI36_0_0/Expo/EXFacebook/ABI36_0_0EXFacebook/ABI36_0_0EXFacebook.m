...
NSString * const ABI36_0_0EXFacebookLoginErrorDomain = @"E_FBLOGIN";
NSString * const ABI36_0_0EXFacebookLoginAppIdErrorDomain = @"E_FBLOGIN_APP_ID";

@implementation ABI36_0_0EXFacebook

ABI36_0_0UM_EXPORT_MODULE(ExponentFacebook)

ABI36_0_0UM_EXPORT_METHOD_AS(setAutoLogAppEventsEnabledAsync,
...
ABI36_0_0UM_EXPORT_METHOD_AS(setAutoInitEnabledAsync,
...
ABI36_0_0UM_EXPORT_METHOD_AS(initializeAsync,
...
ABI36_0_0UM_EXPORT_METHOD_AS(setAdvertiserIDCollectionEnabledAsync,
...
ABI36_0_0UM_EXPORT_METHOD_AS(logInWithReadPermissionsAsync,
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    @try {
      [loginMgr logInWithPermissions:permissions fromViewController:nil handler:^(FBSDKLoginManagerLoginResult *result, NSError *error) {
        if (error) {
          reject(ABI36_0_0EXFacebookLoginErrorDomain, @"Error with Facebook login", error);
          return;
        }
    ...
    @catch (NSException *exception) {
      NSError *error = [[NSError alloc] initWithDomain:ABI36_0_0EXFacebookLoginErrorDomain code:650 userInfo:@{
