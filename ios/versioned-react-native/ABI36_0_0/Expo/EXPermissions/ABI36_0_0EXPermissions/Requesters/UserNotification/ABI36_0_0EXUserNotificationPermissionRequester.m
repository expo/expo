...
@interface ABI36_0_0EXUserNotificationPermissionRequester ()

@property (nonatomic, weak) id<ABI36_0_0UMUserNotificationCenterProxyInterface> notificationCenter;
@property (nonatomic, weak) dispatch_queue_t methodQueue;

@end

@implementation ABI36_0_0EXUserNotificationPermissionRequester
...
- (void)_consumeResolverWithCurrentPermissions:(ABI36_0_0UMPromiseResolveBlock)resolver
{
  if (resolver) {
