...
#import <ABI36_0_0EXSensors/ABI36_0_0EXSensorsManager.h>
#import <CoreMotion/CoreMotion.h>

@interface ABI36_0_0EXSensorsManager ()
...
@implementation ABI36_0_0EXSensorsManager

ABI36_0_0UM_REGISTER_MODULE();

+ (const NSArray<Protocol *> *)exportedInterfaces
{
  return @[@protocol(ABI36_0_0UMAccelerometerInterface), @protocol(ABI36_0_0UMBarometerInterface), @protocol(ABI36_0_0UMDeviceMotionInterface), @protocol(ABI36_0_0UMGyroscopeInterface), @protocol(ABI36_0_0UMMagnetometerInterface), @protocol(ABI36_0_0UMMagnetometerUncalibratedInterface)];
}
                                            ...
                                            withHandler:(void (^)(NSDictionary *event))handlerBlock
{
  ...
  if (![[self manager] isAccelerometerActive]) {
    ...
    __weak ABI36_0_0EXSensorsManager *weakSelf = self;
    [[self manager] startAccelerometerUpdatesToQueue:[NSOperationQueue mainQueue] withHandler:^(CMAccelerometerData *data, NSError *error) {
      __strong ABI36_0_0EXSensorsManager *strongSelf = weakSelf;
      if (strongSelf) {
...
- (void)activateDeviceMotionUpdates
{
  ...
  [[self manager] startDeviceMotionUpdatesUsingReferenceFrame:CMAttitudeReferenceFrameXArbitraryCorrectedZVertical toQueue:[NSOperationQueue mainQueue] withHandler:^(CMDeviceMotion *data, NSError *error) {
    ...
    NSDictionary *result = @{
                             @"acceleration": @{
                                 @"x": @(data.userAcceleration.x * ABI36_0_0EXGravity),
                                 @"y": @(data.userAcceleration.y * ABI36_0_0EXGravity),
                                 @"z": @(data.userAcceleration.z * ABI36_0_0EXGravity)
                                 },
                             @"accelerationIncludingGravity": @{
                                 @"x": @((data.userAcceleration.x + data.gravity.x) * ABI36_0_0EXGravity),
                                 @"y": @((data.userAcceleration.y + data.gravity.y) * ABI36_0_0EXGravity),
                                 @"z": @((data.userAcceleration.z + data.gravity.z) * ABI36_0_0EXGravity)
                                 },
                             @"rotation": @{
