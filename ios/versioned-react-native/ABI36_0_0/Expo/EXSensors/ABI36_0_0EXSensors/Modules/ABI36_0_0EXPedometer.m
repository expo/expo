...
#import <ABI36_0_0EXSensors/ABI36_0_0EXPedometer.h>
...
NSString * const ABI36_0_0EXPedometerUpdateEventName = @"Exponent.pedometerUpdate";
NSString * const ABI36_0_0EXPedometerModuleName = @"ExponentPedometer";

@interface ABI36_0_0EXPedometer () <ABI36_0_0UMAppLifecycleListener>
...
@implementation ABI36_0_0EXPedometer
...
{
  if (self = [super init]) {
    __weak ABI36_0_0EXPedometer *weakSelf = self;
    _watchHandler = ^(CMPedometerData * _Nullable pedometerData, NSError * _Nullable error) {
      ...
      __strong ABI36_0_0EXPedometer *strongSelf = weakSelf;
      if (strongSelf) {
        __strong id<ABI36_0_0UMEventEmitterService> eventEmitter = strongSelf.eventEmitter;
        if (eventEmitter) {
          [eventEmitter sendEventWithName:ABI36_0_0EXPedometerUpdateEventName
...
{
  return ABI36_0_0EXPedometerModuleName;
}
...
{
  return @[ABI36_0_0EXPedometerUpdateEventName];
}
...
ABI36_0_0UM_EXPORT_METHOD_AS(getStepCountAsync,
