...
@interface ABI36_0_0EXGLARSessionManager : NSObject

@property (nonatomic, weak) id<ABI36_0_0EXGLARSessionManagerDelegate> delegate;
...
- (NSDictionary *)startWithGLView:(ABI36_0_0EXGLView *)glView trackingConfiguration:(NSString *) trackingConfiguration;
