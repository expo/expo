// Simplified version of https://github.com/facebook/ABI36_0_0React-native/blob/master/ABI36_0_0React/Views/SafeAreaView/ABI36_0_0RCTSafeAreaView.m
...
@implementation ABI36_0_0RNCSafeAreaView
{
...
{
  UIViewController* vc = self.ABI36_0_0ReactViewController;
...
{
  // This gets called before the view size is set by ABI36_0_0React-native so
  ...
  if (_initialInsetsSent && UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI36_0_0RCTScreenScale())) {
    return;
  }
