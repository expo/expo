...
@interface ABI36_0_0REAClockNode ()
...
@implementation ABI36_0_0REAClockNode
...
- (void)start
{
  ...
  __weak ABI36_0_0REAClockNode *weakSelf = self;
...
@implementation ABI36_0_0REAClockOpNode {
...
- (ABI36_0_0REAClockNode*)clockNode
{
  return (ABI36_0_0REAClockNode*)[self.nodesManager findNodeByID:_clockNodeID];
}

@end

@implementation ABI36_0_0REAClockStartNode
...
@implementation ABI36_0_0REAClockStopNode
...
@implementation ABI36_0_0REAClockTestNode
