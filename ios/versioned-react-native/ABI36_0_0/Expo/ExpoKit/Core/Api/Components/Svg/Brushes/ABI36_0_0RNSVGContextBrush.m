...
@implementation ABI36_0_0RNSVGContextBrush
{
    BOOL _isStroke;
}
...
{
    ABI36_0_0RNSVGRenderable *element = ABI36_0_0RNSVGRenderable.contextElement;
    if (!element) {
        return NO;
    }

    ABI36_0_0RNSVGBrush *brush = _isStroke ? element.stroke : element.fill;

    BOOL fillColor;

    if (brush.class == ABI36_0_0RNSVGBrush.class) {
