//
//  ABI36_0_0AIRGoogleMapWMSTile.h
//  AirMaps
//
...
@interface ABI36_0_0WMSTileOverlay : GMSSyncTileLayer
...
@interface ABI36_0_0AIRGoogleMapWMSTile : UIView
@property (nonatomic, strong) ABI36_0_0WMSTileOverlay *tileLayer;
