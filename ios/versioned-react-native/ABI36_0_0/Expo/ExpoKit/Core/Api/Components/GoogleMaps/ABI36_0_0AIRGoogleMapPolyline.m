//
//  ABI36_0_0AIRGoogleMapPolyline.m
//
...
@implementation ABI36_0_0AIRGoogleMapPolyline

- (instancetype)init
{
  if (self = [super init]) {
    _polyline = [[ABI36_0_0AIRGMSPolyline alloc] init];
  }
  return self;
}

-(void)setCoordinates:(NSArray<ABI36_0_0AIRMapCoordinate *> *)coordinates
{
...
- (void)setOnPress:(ABI36_0_0RCTBubblingEventBlock)onPress {
