...
@implementation ABI36_0_0RNSVGLength
...
{
    ABI36_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype) lengthWithString: (NSString *) lengthString {
    ...
    ABI36_0_0RNSVGLength *output = [ABI36_0_0RNSVGLength alloc];
    if (stringLength == 0) {
        ...
        ABI36_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
...
- (BOOL) isEqualTo: (ABI36_0_0RNSVGLength *)other {
