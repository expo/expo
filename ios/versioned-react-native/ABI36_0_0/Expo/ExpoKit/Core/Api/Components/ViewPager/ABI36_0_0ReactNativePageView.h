...
@interface ABI36_0_0ReactNativePageView: UIView <UIPageViewControllerDataSource, UIPageViewControllerDelegate,UIScrollViewDelegate>

- (instancetype)initWithEventDispatcher:(ABI36_0_0RCTEventDispatcher *)eventDispatcher;

@property(strong, nonatomic, readonly) UIPageViewController *ABI36_0_0ReactPageViewController;
@property(strong, nonatomic, readonly) UIPageControl *ABI36_0_0ReactPageIndicatorView;
@property(nonatomic, readonly) ABI36_0_0RCTEventDispatcher *eventDispatcher;
...
@property(nonatomic, copy) ABI36_0_0RCTDirectEventBlock onPageSelected;
@property(nonatomic, copy) ABI36_0_0RCTDirectEventBlock onPageScroll;
@property(nonatomic, copy) ABI36_0_0RCTDirectEventBlock onPageScrollStateChanged;
