...
@interface ABI36_0_0_SwizzleHelperWK : UIView
@property (nonatomic, copy) WKWebView *webView;
@end
@implementation ABI36_0_0_SwizzleHelperWK
...
@interface ABI36_0_0RNCWebView () <WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler, UIScrollViewDelegate, ABI36_0_0RCTAutoInsetsProtocol>
@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onLoadingStart;
@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onLoadingFinish;
@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onLoadingError;
@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onLoadingProgress;
@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onShouldStartLoadWithRequest;
@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onHttpError;
@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onMessage;
@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onScroll;
@property (nonatomic, copy) ABI36_0_0RCTDirectEventBlock onContentProcessDidTerminate;
@property (nonatomic, copy) WKWebView *webView;
@end

@implementation ABI36_0_0RNCWebView
{
  ...
  // https://github.com/ABI36_0_0React-native-community/ABI36_0_0React-native-webview/issues/62
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if ((self = [super initWithFrame:frame])) {
    ...
    _savedStatusBarStyle = ABI36_0_0RCTSharedApplication().statusBarStyle;
    _savedStatusBarHidden = ABI36_0_0RCTSharedApplication().statusBarHidden;
...
- (void)didMoveToWindow
{
  if (self.window != nil && _webView == nil) {
    ...
    if(self.useSharedProcessPool) {
      wkWebViewConfig.processPool = [[ABI36_0_0RNCWKProcessPoolManager sharedManager] sharedProcessPoolForExperienceId:self.experienceId];
    }
        ...
        */
        ...
        for (NSHTTPCookie *cookie in [[NSHTTPCookieStorage sharedHTTPCookieStorage] cookies]) {
          [script appendFormat:@"document.cookie = %@ + '=' + %@",
            ABI36_0_0RCTJSONStringify(cookie.name, NULL),
            ABI36_0_0RCTJSONStringify(cookie.value, NULL)];
          if (cookie.path) {
            [script appendFormat:@" + '; Path=' + %@", ABI36_0_0RCTJSONStringify(cookie.path, NULL)];
          }
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    ...
    ABI36_0_0RCTUnsafeExecuteOnMainQueueSync(^{
      [ABI36_0_0RCTSharedApplication() setStatusBarStyle:UIStatusBarStyleLightContent animated:YES];
    });
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    ...
    ABI36_0_0RCTUnsafeExecuteOnMainQueueSync(^{
      [ABI36_0_0RCTSharedApplication() setStatusBarHidden:self->_savedStatusBarHidden animated:YES];
      [ABI36_0_0RCTSharedApplication() setStatusBarStyle:self->_savedStatusBarStyle animated:YES];
    });
#pragma clang diagnostic pop
}
...
- (void)visitSource
{
    ...
    NSString *html = [ABI36_0_0RCTConvert NSString:_source[@"html"]];
    if (html) {
        NSURL *baseURL = [ABI36_0_0RCTConvert NSURL:_source[@"baseUrl"]];
        if (!baseURL) {
    ...
    // Because of the way ABI36_0_0React works, as pages redirect, we actually end up
    ...
    if (request.URL.host) {
        ...
        NSURL* readAccessUrl = _allowingReadAccessToURL ? [ABI36_0_0RCTConvert NSURL:_allowingReadAccessToURL] : request.URL;
...
-(void)setHideKeyboardAccessoryView:(BOOL)hideKeyboardAccessoryView
{
    ...
    NSString* name = [NSString stringWithFormat:@"%@ABI36_0_0_SwizzleHelperWK", subview.class.superclass];
    ...
    if(newClass == nil)
    {
        ...
        Method method = class_getInstanceMethod([ABI36_0_0_SwizzleHelperWK class], @selector(inputAccessoryView));
...
- (void)postMessage:(NSString *)message
{
  ...
  NSString *source = [NSString
    ...
    ABI36_0_0RCTJSONStringify(eventInitDict, NULL)
  ];
...
- (void)layoutSubviews
{
  ...
  // Ensure webview takes the position and dimensions of ABI36_0_0RNCWebView
...
{
  ABI36_0_0RCTLogWarn(@"Webview Process Terminated");
          ...
          thenCall: (void (^)(NSString*)) callback
{
  [self.webView evaluateJavaScript: js completionHandler: ^(id result, NSError *error) {
    ...
    if (error != nil) {
      ABI36_0_0RCTLogWarn(@"%@", [NSString stringWithFormat:@"Error evaluating injectedJavaScript: This is possibly due to an unsupported return type. Try adding true to the end of your injectedJavaScript string. %@", error]);
    }
  }];
}
...
- (NSURLRequest *)requestForSource:(id)json {
  NSURLRequest *request = [ABI36_0_0RCTConvert NSURLRequest:self.source];
