...
@class ABI36_0_0RNSVGPattern;

@interface ABI36_0_0RNSVGPainter : NSObject

@property (nonatomic, assign) ABI36_0_0RNSVGPattern* pattern;
@property (nonatomic, assign) CGRect paintBounds;
@property (nonatomic, assign) bool useObjectBoundingBoxForContentUnits;
@property (nonatomic, assign) CGRect bounds;

- (instancetype)initWithPointsArray:(NSArray<ABI36_0_0RNSVGLength *> *)pointsArray NS_DESIGNATED_INITIALIZER;
