//
//  ABI36_0_0RNSharedElementStyle.m
//  ABI36_0_0React-native-shared-element
//

#import "ABI36_0_0RNSharedElementStyle.h"

@implementation ABI36_0_0RNSharedElementStyle
{
...
+ (ABI36_0_0RNSharedElementStyle*) getInterpolatedStyle:(ABI36_0_0RNSharedElementStyle*)style1 style2:(ABI36_0_0RNSharedElementStyle*)style2 position:(CGFloat) position
{
    ...
    style.borderColor = [ABI36_0_0RNSharedElementStyle getInterpolatedColor:style1.borderColor color2:style2.borderColor position:position];
    style.backgroundColor = [ABI36_0_0RNSharedElementStyle getInterpolatedColor:style1.backgroundColor color2:style2.backgroundColor position:position];
    ...
    style.shadowColor = [ABI36_0_0RNSharedElementStyle getInterpolatedColor:style1.shadowColor color2:style2.shadowColor position:position];
    return style;
}
