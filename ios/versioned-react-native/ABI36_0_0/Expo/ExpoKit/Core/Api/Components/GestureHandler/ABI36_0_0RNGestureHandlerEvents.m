...
@implementation ABI36_0_0RNGestureHandlerEventExtraData
...
{
    return [[ABI36_0_0RNGestureHandlerEventExtraData alloc]
            initWithData:@{
                           @"x": @(position.x),
                           @"y": @(position.y),
...
@implementation ABI36_0_0RNGestureHandlerEvent
{
    NSNumber *_handlerTag;
    ABI36_0_0RNGestureHandlerState _state;
    ABI36_0_0RNGestureHandlerEventExtraData *_extraData;
}
...
- (instancetype)initWithRactTag:(NSNumber *)ABI36_0_0ReactTag
                     handlerTag:(NSNumber *)handlerTag
                      ...
                      extraData:(ABI36_0_0RNGestureHandlerEventExtraData *)extraData
{
...
@implementation ABI36_0_0RNGestureHandlerStateChange
{
    NSNumber *_handlerTag;
    ABI36_0_0RNGestureHandlerState _state;
    ABI36_0_0RNGestureHandlerState _prevState;
    ABI36_0_0RNGestureHandlerEventExtraData *_extraData;
}
