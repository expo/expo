//
//  ABI36_0_0RCTConvert+GMSMapViewType.m
//
...
@implementation ABI36_0_0RCTConvert (GMSMapViewType)
  ABI36_0_0RCT_ENUM_CONVERTER(GMSMapViewType,
  (
    @{
...
+ (GMSCameraPosition*)GMSCameraPosition:(id)json
{
    ...
    return [ABI36_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:nil];
}
