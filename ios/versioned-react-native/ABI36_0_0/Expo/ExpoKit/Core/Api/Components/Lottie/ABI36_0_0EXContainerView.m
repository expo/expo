...
#if __has_include(<ABI36_0_0React/ABI36_0_0UIView+React.h>)
...
@implementation ABI36_0_0EXContainerView {
...
- (void)ABI36_0_0ReactSetFrame:(CGRect)frame
{
  ...
  if (_animationView != nil) {
    [_animationView ABI36_0_0ReactSetFrame:frame];
  }
}
...
- (void)replaceAnimationView:(LOTAnimationView *)next {
  ...
  [_animationView ABI36_0_0ReactSetFrame:self.frame];
