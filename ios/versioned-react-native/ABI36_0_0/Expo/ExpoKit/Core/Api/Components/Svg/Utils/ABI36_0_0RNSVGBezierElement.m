...
@implementation ABI36_0_0RNSVGBezierElement
- (instancetype) init
{
    self = [super init];
    if (self)
    {
        ...
        _point = ABI36_0_0RNSVGNULLPOINT;
        _controlPoint1 = ABI36_0_0RNSVGNULLPOINT;
        _controlPoint2 = ABI36_0_0RNSVGNULLPOINT;
    }
    return self;
}
...
{
    ABI36_0_0RNSVGBezierElement *newElement = [[self alloc] init];
...
// Convert one element to ABI36_0_0RNSVGBezierElement and save to array
void ABI36_0_0RNSVGBezierElement_getBezierElements(void *info, const CGPathElement *element)
{
    NSMutableArray *bezierElements = (__bridge NSMutableArray *)info;
    if (element)
        [bezierElements addObject:[ABI36_0_0RNSVGBezierElement elementWithPathElement:*element]];
}
...
+ (NSArray *) elementsFromCGPath:(CGPathRef)path
{
    ...
    CGPathApply(path, (__bridge void *)elements, ABI36_0_0RNSVGBezierElement_getBezierElements);
    return elements;
}
