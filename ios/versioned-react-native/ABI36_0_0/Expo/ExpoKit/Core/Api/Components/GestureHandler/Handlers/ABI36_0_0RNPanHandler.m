...
@interface ABI36_0_0RNBetterPanGestureRecognizer : UIPanGestureRecognizer
...
@implementation ABI36_0_0RNBetterPanGestureRecognizer {
...
@implementation ABI36_0_0RNPanGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI36_0_0RNBetterPanGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI36_0_0RNBetterPanGestureRecognizer *recognizer = (ABI36_0_0RNBetterPanGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    CGFloat velocity = [ABI36_0_0RCTConvert CGFloat:prop];
    recognizer.minVelocitySq = velocity * velocity;
  }
  [recognizer updateHasCustomActivationCriteria];
}

- (ABI36_0_0RNGestureHandlerEventExtraData *)eventExtraData:(UIPanGestureRecognizer *)recognizer
{
