...
@implementation ABI36_0_0RNSVGPattern
...
{
    self.dirty = false;
    NSArray<ABI36_0_0RNSVGLength *> *points = @[self.x, self.y, self.patternwidth, self.patternheight];
...
- (void)setPatternwidth:(ABI36_0_0RNSVGLength *)patternwidth
{
...
- (void)setPatternheight:(ABI36_0_0RNSVGLength *)patternheight
{
...
- (void)setPatternUnits:(ABI36_0_0RNSVGUnits)patternUnits
{
...
- (void)setPatternContentUnits:(ABI36_0_0RNSVGUnits)patternContentUnits
{
