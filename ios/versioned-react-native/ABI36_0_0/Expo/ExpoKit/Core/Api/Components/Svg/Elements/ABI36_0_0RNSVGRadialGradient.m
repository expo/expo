...
@implementation ABI36_0_0RNSVGRadialGradient

- (void)setFx:(ABI36_0_0RNSVGLength *)fx
{
    if ([fx isEqualTo:_fx]) {
        return;
    }
...
- (void)setFy:(ABI36_0_0RNSVGLength *)fy
{
    if ([fy isEqualTo:_fy]) {
        return;
    }
...
- (void)setGradientUnits:(ABI36_0_0RNSVGUnits)gradientUnits
{
...
{
    self.dirty = false;
    NSArray<ABI36_0_0RNSVGLength *> *points = @[self.fx, self.fy, self.rx, self.ry, self.cx, self.cy];
    ABI36_0_0RNSVGPainter *painter = [[ABI36_0_0RNSVGPainter alloc] initWithPointsArray:points];
