...
@interface ABI36_0_0RNForceTouchGestureRecognizer : UIGestureRecognizer
...
@implementation ABI36_0_0RNForceTouchGestureRecognizer {
...
@implementation ABI36_0_0RNForceTouchHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI36_0_0RNForceTouchGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI36_0_0RNForceTouchGestureRecognizer *recognizer = (ABI36_0_0RNForceTouchGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    recognizer.feedbackOnActivation = [ABI36_0_0RCTConvert BOOL:prop];
  }
}

- (ABI36_0_0RNGestureHandlerEventExtraData *)eventExtraData:(ABI36_0_0RNForceTouchGestureRecognizer *)recognizer
{
