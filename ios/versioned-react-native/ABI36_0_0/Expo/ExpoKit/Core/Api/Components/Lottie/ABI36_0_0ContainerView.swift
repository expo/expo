#if canImport(ABI36_0_0React)
import ABI36_0_0React
#endif

import Lottie

class ContainerView: ABI36_0_0RCTView {
    ...
    @objc var onAnimationFinish: ABI36_0_0RCTBubblingEventBlock?
  ...
  override func abi36_0_0ReactSetFrame(_ frame: CGRect) {
        super.abi36_0_0ReactSetFrame(frame)
        animationView?.abi36_0_0ReactSetFrame(frame)
    }
