...
@implementation ABI36_0_0RNSVGPainter
{
    NSArray<ABI36_0_0RNSVGLength *> *_points;
    NSArray<NSNumber *> *_colors;
    ABI36_0_0RNSVGBrushType _type;
...
- (instancetype)initWithPointsArray:(NSArray<ABI36_0_0RNSVGLength *> *)pointsArray
{
    if ((self = [super init])) {
        _points = pointsArray;
    }
...
- (void)setUnits:(ABI36_0_0RNSVGUnits)unit
{
    _useObjectBoundingBox = unit == kRNSVGUnitsObjectBoundingBox;
}

- (void)setContentUnits:(ABI36_0_0RNSVGUnits)unit
{
...
- (void)setPattern:(ABI36_0_0RNSVGPattern *)pattern
{
...
void ABI36_0_0PatternFunction(void* info, CGContextRef context)
{
    ABI36_0_0RNSVGPainter *_painter = (__bridge ABI36_0_0RNSVGPainter *)info;
    ABI36_0_0RNSVGPattern *_pattern = [_painter pattern];
    ...
    if (vbWidth > 0 && vbHeight > 0) {
        ...
        CGAffineTransform _viewBoxTransform = [ABI36_0_0RNSVGViewBox
                                               getTransform:vbRect
                                               eRect:rect
...
- (CGFloat)getVal:(ABI36_0_0RNSVGLength*)length relative:(CGFloat)relative
{
    ABI36_0_0RNSVGLengthUnitType unit = [length unit];
    CGFloat val = [ABI36_0_0RNSVGPropHelper fromRelative:length
                                       relative:relative];
...
- (void)paintPattern:(CGContextRef)context bounds:(CGRect)bounds
{
    ...
    const CGPatternCallbacks callbacks = { 0, &ABI36_0_0PatternFunction, NULL };
...
{
    if ([_colors count] == 0) {
        ABI36_0_0RCTLogWarn(@"No stops in gradient");
        return;
    }
    CGGradientRef gradient = CGGradientRetain([ABI36_0_0RCTConvert ABI36_0_0RNSVGCGGradient:_colors]);
