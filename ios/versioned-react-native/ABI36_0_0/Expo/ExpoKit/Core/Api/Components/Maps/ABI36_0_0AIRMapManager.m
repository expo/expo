...
static NSString *const ABI36_0_0RCTMapViewKey = @"MapView";


@interface ABI36_0_0AIRMapManager() <MKMapViewDelegate, UIGestureRecognizerDelegate>

- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer;

@end

@implementation ABI36_0_0AIRMapManager{
   BOOL _hasObserver;
}
...
- (UIView *)view
{
    ABI36_0_0AIRMap *map = [ABI36_0_0AIRMap new];
    map.delegate = self;
...
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(showsUserLocation, BOOL)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(userLocationAnnotationTitle, NSString)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(showsPointsOfInterest, BOOL)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(showsTraffic, BOOL)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(zoomEnabled, BOOL)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(kmlSrc, NSString)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(rotateEnabled, BOOL)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(scrollEnabled, BOOL)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(pitchEnabled, BOOL)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(cacheEnabled, BOOL)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(maxDelta, CGFloat)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(minDelta, CGFloat)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(compassOffset, CGPoint)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(legalLabelInsets, UIEdgeInsets)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, MKMapType)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(onMapReady, ABI36_0_0RCTBubblingEventBlock)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(onChange, ABI36_0_0RCTBubblingEventBlock)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(onPanDrag, ABI36_0_0RCTBubblingEventBlock)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(onPress, ABI36_0_0RCTBubblingEventBlock)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(onLongPress, ABI36_0_0RCTBubblingEventBlock)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(onDoublePress, ABI36_0_0RCTBubblingEventBlock)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerPress, ABI36_0_0RCTDirectEventBlock)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI36_0_0RCTDirectEventBlock)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI36_0_0RCTDirectEventBlock)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI36_0_0RCTDirectEventBlock)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI36_0_0RCTDirectEventBlock)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI36_0_0RCTDirectEventBlock)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(onCalloutPress, ABI36_0_0RCTDirectEventBlock)
ABI36_0_0RCT_CUSTOM_VIEW_PROPERTY(initialRegion, MKCoordinateRegion, ABI36_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setInitialRegion:[ABI36_0_0RCTConvert MKCoordinateRegion:json]];
    view.ignoreRegionChanges = originalIgnore;
}
ABI36_0_0RCT_CUSTOM_VIEW_PROPERTY(initialCamera, MKMapCamera, ABI36_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setInitialCamera:[ABI36_0_0RCTConvert MKMapCamera:json]];
    view.ignoreRegionChanges = originalIgnore;
}


ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(minZoomLevel, CGFloat)
ABI36_0_0RCT_EXPORT_VIEW_PROPERTY(maxZoomLevel, CGFloat)


ABI36_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI36_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setRegion:[ABI36_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}

ABI36_0_0RCT_CUSTOM_VIEW_PROPERTY(camera, MKMapCamera*, ABI36_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setCamera:[ABI36_0_0RCTConvert MKMapCamera:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}
...
ABI36_0_0RCT_EXPORT_METHOD(getMapBoundaries:(nonnull NSNumber *)ABI36_0_0ReactTag
                  ...
                  rejecter:(ABI36_0_0RCTPromiseRejectBlock)reject)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI36_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI36_0_0AIRMap class]]) {
...
ABI36_0_0RCT_EXPORT_METHOD(getCamera:(nonnull NSNumber *)ABI36_0_0ReactTag
                  resolver: (ABI36_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI36_0_0RCTPromiseRejectBlock)reject)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI36_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        id view = viewRegistry[ABI36_0_0ReactTag];
        ABI36_0_0AIRMap *mapView = (ABI36_0_0AIRMap *)view;
        if (![view isKindOfClass:[ABI36_0_0AIRMap class]]) {
            reject(@"Invalid argument", [NSString stringWithFormat:@"Invalid view returned from registry, expecting ABI36_0_0AIRMap, got: %@", view], NULL);
        } else {
...
ABI36_0_0RCT_EXPORT_METHOD(setCamera:(nonnull NSNumber *)ABI36_0_0ReactTag
                  camera:(id)json)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI36_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        id view = viewRegistry[ABI36_0_0ReactTag];
        if (![view isKindOfClass:[ABI36_0_0AIRMap class]]) {
            ...
            MKMapCamera *camera = [ABI36_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:[mapView camera]];
...
ABI36_0_0RCT_EXPORT_METHOD(animateCamera:(nonnull NSNumber *)ABI36_0_0ReactTag
                  withCamera:(id)json
                  withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI36_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI36_0_0AIRMap class]]) {
            ...
            BOOL originalIgnore = mapView.ignoreRegionChanges;
            mapView.ignoreRegionChanges = YES;
            [ABI36_0_0AIRMap animateWithDuration:duration/1000 animations:^{
...
ABI36_0_0RCT_EXPORT_METHOD(animateToNavigation:(nonnull NSNumber *)ABI36_0_0ReactTag
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI36_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI36_0_0AIRMap class]]) {
            ...
            [ABI36_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI36_0_0AIRMap *)view setRegion:region animated:YES];
...
ABI36_0_0RCT_EXPORT_METHOD(animateToRegion:(nonnull NSNumber *)ABI36_0_0ReactTag
        withRegion:(MKCoordinateRegion)region
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI36_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
...
ABI36_0_0RCT_EXPORT_METHOD(animateToCoordinate:(nonnull NSNumber *)ABI36_0_0ReactTag
...
ABI36_0_0RCT_EXPORT_METHOD(animateToViewingAngle:(nonnull NSNumber *)ABI36_0_0ReactTag
                  withAngle:(double)angle
                  withDuration:(CGFloat)duration)
{
  [self.bridge.uiManager addUIBlock:^(__unused ABI36_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
...
ABI36_0_0RCT_EXPORT_METHOD(animateToBearing:(nonnull NSNumber *)ABI36_0_0ReactTag
                  withBearing:(CGFloat)bearing
                  withDuration:(CGFloat)duration)
{
  [self.bridge.uiManager addUIBlock:^(__unused ABI36_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
...
ABI36_0_0RCT_EXPORT_METHOD(fitToElements:(nonnull NSNumber *)ABI36_0_0ReactTag
...
ABI36_0_0RCT_EXPORT_METHOD(fitToSuppliedMarkers:(nonnull NSNumber *)ABI36_0_0ReactTag
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI36_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI36_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ...
                return [marker isKindOfClass:[ABI36_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
...
ABI36_0_0RCT_EXPORT_METHOD(fitToCoordinates:(nonnull NSNumber *)ABI36_0_0ReactTag
                  coordinates:(nonnull NSArray<ABI36_0_0AIRMapCoordinate *> *)coordinates
                  edgePadding:(nonnull NSDictionary *)edgePadding
                  animated:(BOOL)animated)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI36_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI36_0_0AIRMap class]]) {
            ...
            // Set Map viewport
            CGFloat top = [ABI36_0_0RCTConvert CGFloat:edgePadding[@"top"]];
            CGFloat right = [ABI36_0_0RCTConvert CGFloat:edgePadding[@"right"]];
            CGFloat bottom = [ABI36_0_0RCTConvert CGFloat:edgePadding[@"bottom"]];
            CGFloat left = [ABI36_0_0RCTConvert CGFloat:edgePadding[@"left"]];
...
ABI36_0_0RCT_EXPORT_METHOD(takeSnapshot:(nonnull NSNumber *)ABI36_0_0ReactTag
...
ABI36_0_0RCT_EXPORT_METHOD(pointForCoordinate:(nonnull NSNumber *)ABI36_0_0ReactTag
...
ABI36_0_0RCT_EXPORT_METHOD(getMarkersFrames:(nonnull NSNumber *)ABI36_0_0ReactTag
...
ABI36_0_0RCT_EXPORT_METHOD(coordinateForPoint:(nonnull NSNumber *)ABI36_0_0ReactTag
...
- (void)takeMapSnapshot:(ABI36_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI36_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI36_0_0AIRMap *map = (ABI36_0_0AIRMap *)recognizer.view;
    ...
    ABI36_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI36_0_0AIRMapPolygon class]]){
            ABI36_0_0AIRMapPolygon *polygon = (ABI36_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI36_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI36_0_0AIRMapPolyline class]]){
            ABI36_0_0AIRMapPolyline *polyline = (ABI36_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
        ...
        if ([overlay isKindOfClass:[ABI36_0_0AIRMapOverlay class]]) {
            ABI36_0_0AIRMapOverlay *imageOverlay = (ABI36_0_0AIRMapOverlay*) overlay;
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI36_0_0AIRMapPolyline class]]) {
        return ((ABI36_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI36_0_0AIRMapPolygon class]]) {
        return ((ABI36_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI36_0_0AIRMapCircle class]]) {
        return ((ABI36_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI36_0_0AIRMapUrlTile class]]) {
        return ((ABI36_0_0AIRMapUrlTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI36_0_0AIRMapWMSTile class]]) {
        return ((ABI36_0_0AIRMapWMSTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI36_0_0AIRMapLocalTile class]]) {
        return ((ABI36_0_0AIRMapLocalTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI36_0_0AIRMapOverlay class]]) {
        return ((ABI36_0_0AIRMapOverlay *)overlay).renderer;
...
- (void)mapView:(ABI36_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI36_0_0AIRMapMarker class]]) {
        [(ABI36_0_0AIRMapMarker *)view.annotation showCalloutView];
...
- (void)mapView:(ABI36_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI36_0_0AIRMapMarker class]]) {
        [(ABI36_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI36_0_0AIRMap *)mapView viewForAnnotation:(ABI36_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI36_0_0AIRMapMarker class]]) {
...
- (void)mapView:(ABI36_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI36_0_0AIRMapMarker class]]) return;
    ABI36_0_0AIRMapMarker *marker = (ABI36_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI36_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI36_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI36_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI36_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI36_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    [self _regionChanged:mapView];

    ABI36_0_0AIRWeakTimerReference *weakTarget = [[ABI36_0_0AIRWeakTimerReference alloc] initWithTarget:self andSelector:@selector(_onTick:)];
    
    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI36_0_0AIRMapRegionChangeObserveInterval
                                                               target:weakTarget
                                                             selector:@selector(timerDidFire:)
                                                             userInfo:@{ ABI36_0_0RCTMapViewKey: [[ABI36_0_0AIRWeakMapReference alloc] initWithMapView: mapView] }
                                                              repeats:YES];

    [[NSRunLoop mainRunLoop] addTimer:mapView.regionChangeObserveTimer forMode:NSRunLoopCommonModes];
}

- (void)mapView:(ABI36_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI36_0_0AIRMap *)mapView
{
    if (!mapView.hasStartedRendering) {
      mapView.onMapReady(@{});
...
- (void)mapViewDidFinishRenderingMap:(ABI36_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
{
    ABI36_0_0AIRWeakMapReference *weakRef = timer.userInfo[ABI36_0_0RCTMapViewKey];
    [self _regionChanged:weakRef.mapView];
}

- (void)_regionChanged:(ABI36_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI36_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI36_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI36_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI36_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI36_0_0AIRMap *)mapView
{
...
- (MKCoordinateSpan)coordinateSpanWithMapView:(ABI36_0_0AIRMap *)mapView
                             centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                 andZoomLevel:(double)zoomLevel
{
    // convert center coordiate to pixel space
    double centerPixelX = [ABI36_0_0AIRMapManager longitudeToPixelSpaceX:centerCoordinate.longitude];
    double centerPixelY = [ABI36_0_0AIRMapManager latitudeToPixelSpaceY:centerCoordinate.latitude];

    // determine the scale value from the zoom level
    double zoomExponent = ABI36_0_0AIRMapMaxZoomLevel - zoomLevel;
    ...
    CLLocationDegrees minLng = [ABI36_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX];
    CLLocationDegrees maxLng = [ABI36_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX + scaledMapWidth];
    CLLocationDegrees longitudeDelta = maxLng - minLng;

    // find delta between top and bottom latitudes
    CLLocationDegrees minLat = [ABI36_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY];
    CLLocationDegrees maxLat = [ABI36_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY + scaledMapHeight];
...
- (void)setCenterCoordinate:(CLLocationCoordinate2D)centerCoordinate
                  zoomLevel:(double)zoomLevel
                   animated:(BOOL)animated
                    mapView:(ABI36_0_0AIRMap *)mapView
{
    // clamp large numbers to 28
    zoomLevel = MIN(zoomLevel, ABI36_0_0AIRMapMaxZoomLevel);
...
-(MKCoordinateRegion)coordinateRegionWithMapView:(ABI36_0_0AIRMap *)mapView
                                centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                    andZoomLevel:(double)zoomLevel
{
	...
	// find delta between top and bottom latitudes
	CLLocationDegrees minLat = [ABI36_0_0AIRMapManager pixelSpaceYToLatitude:topPixelY];
	CLLocationDegrees maxLat = [ABI36_0_0AIRMapManager pixelSpaceYToLatitude:bottomPixelY];
	CLLocationDegrees latitudeDelta = -1 * (maxLat - minLat);
	...
	if (adjustedCenterPoint) {
		region.center.latitude = [ABI36_0_0AIRMapManager pixelSpaceYToLatitude:((bottomPixelY + topPixelY) / 2.0)];
	}

	return region;
}

- (double) zoomLevel:(ABI36_0_0AIRMap *)mapView {
    MKCoordinateRegion region = mapView.region;

    double centerPixelX = [ABI36_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude];
    double topLeftPixelX = [ABI36_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude - region.span.longitudeDelta / 2];

    double scaledMapWidth = (centerPixelX - topLeftPixelX) * 2;
    CGSize mapSizeInPixels = mapView.bounds.size;
    double zoomScale = scaledMapWidth / mapSizeInPixels.width;
    double zoomExponent = log(zoomScale) / log(2);
    double zoomLevel = ABI36_0_0AIRMapMaxZoomLevel - zoomExponent;
