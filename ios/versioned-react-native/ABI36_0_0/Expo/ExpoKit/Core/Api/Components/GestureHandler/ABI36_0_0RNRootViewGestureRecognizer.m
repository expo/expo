//
//  ABI36_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI36_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI36_0_0RNGestureHandler *otherHandler = [ABI36_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI36_0_0RCTTouchHandler class]];
}
