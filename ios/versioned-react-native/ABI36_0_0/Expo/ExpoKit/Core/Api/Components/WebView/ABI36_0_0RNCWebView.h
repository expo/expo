...
@class ABI36_0_0RNCWebView;

@protocol ABI36_0_0RNCWebViewDelegate <NSObject>

- (BOOL)webView:(ABI36_0_0RNCWebView *_Nonnull)webView
   shouldStartLoadForRequest:(NSMutableDictionary<NSString *, id> *_Nonnull)request
   withCallback:(ABI36_0_0RCTDirectEventBlock _Nonnull)callback;

@end

@interface ABI36_0_0RNCWebView : ABI36_0_0RCTView

@property (nonatomic, strong) NSString *experienceId;

@property (nonatomic, weak) id<ABI36_0_0RNCWebViewDelegate> _Nullable delegate;
