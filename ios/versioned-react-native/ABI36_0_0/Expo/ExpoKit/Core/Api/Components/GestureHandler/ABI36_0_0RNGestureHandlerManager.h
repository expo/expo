...
@interface ABI36_0_0RNGestureHandlerManager : NSObject

- (nonnull instancetype)initWithUIManager:(nonnull ABI36_0_0RCTUIManager *)uiManager
                          eventDispatcher:(nonnull ABI36_0_0RCTEventDispatcher *)eventDispatcher;
