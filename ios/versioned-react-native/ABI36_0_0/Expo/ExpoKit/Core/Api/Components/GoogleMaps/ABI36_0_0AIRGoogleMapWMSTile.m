//
//  ABI36_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI36_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI36_0_0WMSTileOverlay *tile = [[ABI36_0_0WMSTileOverlay alloc] init];
...
@implementation ABI36_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
