...
@implementation ABI36_0_0RCTConvert (AirMap)
...
{
    json = [self NSDictionary:json];
    return [ABI36_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:nil];
}
...
ABI36_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI36_0_0AIRMapCoordinate *)ABI36_0_0AIRMapCoordinate:(id)json
{
    ABI36_0_0AIRMapCoordinate *coord = [ABI36_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI36_0_0RCT_ARRAY_CONVERTER(ABI36_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI36_0_0AIRMapCoordinate *> *> *)ABI36_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI36_0_0RCTConvertArrayValue(@selector(ABI36_0_0AIRMapCoordinateArray:), json);
}
