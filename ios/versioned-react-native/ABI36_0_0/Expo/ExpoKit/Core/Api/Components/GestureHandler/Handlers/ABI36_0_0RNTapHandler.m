...
// ABI36_0_0RNBetterTapGestureRecognizer extends UIGestureRecognizer instead of UITapGestureRecognizer 
...
@interface ABI36_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
@implementation ABI36_0_0RNBetterTapGestureRecognizer {
...
@implementation ABI36_0_0RNTapGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI36_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI36_0_0RNBetterTapGestureRecognizer *recognizer = (ABI36_0_0RNBetterTapGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    recognizer.maxDelay = [ABI36_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDurationMs"];
  if (prop != nil) {
    recognizer.maxDuration = [ABI36_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDist"];
  if (prop != nil) {
    CGFloat dist = [ABI36_0_0RCTConvert CGFloat:prop];
