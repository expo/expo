...
#if __has_include(<ABI36_0_0React/ABI36_0_0RCTImageLoader.h>)
...
@implementation ABI36_0_0RNSVGImage
{
    CGImageRef _image;
    CGSize _imageSize;
...
- (void)setSrc:(id)src
{
    ...
    ABI36_0_0RCTImageSource *source = [ABI36_0_0RCTConvert ABI36_0_0RCTImageSource:src];
    ...
    _reloadImageCancellationBlock = [[self.bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI36_0_0RCTConvert NSURLRequest:src] callback:^(NSError *error, UIImage *image) {
...
- (void)setX:(ABI36_0_0RNSVGLength *)x
{
    if ([x isEqualTo:_x]) {
        return;
    }
...
- (void)setY:(ABI36_0_0RNSVGLength *)y
{
    if ([y isEqualTo:_y]) {
        return;
    }
...
- (void)setImagewidth:(ABI36_0_0RNSVGLength *)width
{
...
- (void)setImageheight:(ABI36_0_0RNSVGLength *)height
{
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    CGAffineTransform viewbox = [ABI36_0_0RNSVGViewBox getTransform:imageBounds eRect:hitArea align:self.align meetOrSlice:self.meetOrSlice];
