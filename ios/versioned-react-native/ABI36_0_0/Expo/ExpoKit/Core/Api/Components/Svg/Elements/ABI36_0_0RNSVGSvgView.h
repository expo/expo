...
@interface ABI36_0_0RNSVGSvgView : UIView <ABI36_0_0RNSVGContainer>

@property (nonatomic, strong) ABI36_0_0RNSVGLength *bbWidth;
@property (nonatomic, strong) ABI36_0_0RNSVGLength *bbHeight;
...
- (void)defineTemplate:(__kindof ABI36_0_0RNSVGNode *)template templateName:(NSString *)templateName;
