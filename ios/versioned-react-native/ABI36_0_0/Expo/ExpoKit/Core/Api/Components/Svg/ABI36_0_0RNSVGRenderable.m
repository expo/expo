...
@implementation ABI36_0_0RNSVGRenderable
{
    NSMutableDictionary *_originProperties;
    NSArray<NSString *> *_lastMergedList;
    NSArray<NSString *> *_attributeList;
    NSArray<ABI36_0_0RNSVGLength *> *_sourceStrokeDashArray;
    CGFloat *_strokeDashArrayData;
    CGPathRef _srcHitPath;
}

static ABI36_0_0RNSVGRenderable * _contextElement;
+ (ABI36_0_0RNSVGRenderable *)contextElement { return _contextElement; }
+ (void)setContextElement:(ABI36_0_0RNSVGRenderable *)contextElement { _contextElement = contextElement; }
...
- (id)init
{
    if (self = [super init]) {
        _fillOpacity = 1;
        _strokeOpacity = 1;
        _strokeWidth = [ABI36_0_0RNSVGLength lengthWithNumber:1];
...
- (void)setFill:(ABI36_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI36_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI36_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)setStrokeWidth:(ABI36_0_0RNSVGLength*)strokeWidth
{
...
- (void)setStrokeDasharray:(NSArray<ABI36_0_0RNSVGLength *> *)strokeDasharray
{
...
- (void)setVectorEffect:(ABI36_0_0RNSVGVectorEffect)vectorEffect
{
...
UInt32 ABI36_0_0saturate(CGFloat value) {
...
- (void)renderTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    if (self.mask) {
        ...
        ABI36_0_0RNSVGMask *_maskNode = (ABI36_0_0RNSVGMask*)[self.svgView getDefinedMask:self.mask];
        ...
        for (NSUInteger i = 0; i < npixels; i++) {
            ...
            *currentPixel = ABI36_0_0saturate(luma) << 24;
            currentPixel++;
        }
...
- (void)prepareStrokeDash:(NSUInteger)count strokeDasharray:(NSArray<ABI36_0_0RNSVGLength *> *)strokeDasharray {
...
- (void)renderMarkers:(CGContextRef)context path:(CGPathRef)path rect:(const CGRect *)rect {
    ABI36_0_0RNSVGMarker *markerStart = (ABI36_0_0RNSVGMarker*)[self.svgView getDefinedMarker:self.markerStart];
    ABI36_0_0RNSVGMarker *markerMid = (ABI36_0_0RNSVGMarker*)[self.svgView getDefinedMarker:self.markerMid];
    ABI36_0_0RNSVGMarker *markerEnd = (ABI36_0_0RNSVGMarker*)[self.svgView getDefinedMarker:self.markerEnd];
    if (markerStart || markerMid || markerEnd) {
        _contextElement = self;
        NSArray<ABI36_0_0RNSVGMarkerPosition*>* positions = [ABI36_0_0RNSVGMarkerPosition fromCGPath:path];
        ...
        for (ABI36_0_0RNSVGMarkerPosition* position in positions) {
            ABI36_0_0RNSVGMarkerType type = [position type];
            ABI36_0_0RNSVGMarker *marker;
            switch (type) {
                case kStartMarker:
                    marker = markerStart;
                    break;
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    if (self.fill) {
        if (self.fill.class == ABI36_0_0RNSVGBrush.class) {
    ...
    if (self.stroke) {
        ...
        NSArray<ABI36_0_0RNSVGLength *>* strokeDasharray = self.strokeDasharray;
        ...
        if (self.stroke.class == ABI36_0_0RNSVGBrush.class) {
