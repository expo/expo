...
@interface ABI36_0_0EXUtil ()

@property (nonatomic, weak) id<ABI36_0_0EXUtilService> kernelUtilService;

@end

ABI36_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI36_0_0EXUtil, util)

@implementation ABI36_0_0EXUtil

ABI36_0_0EX_EXPORT_SCOPED_MODULE(ExponentUtil, UtilService);

- (instancetype)initWithExperienceId:(NSString *)experienceId kernelServiceDelegate:(id<ABI36_0_0EXUtilService>)kernelServiceInstance params:(NSDictionary *)params
{
