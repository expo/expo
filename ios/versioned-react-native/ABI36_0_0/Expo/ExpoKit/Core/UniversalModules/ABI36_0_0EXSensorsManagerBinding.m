...
@interface ABI36_0_0EXSensorsManagerBinding ()

@property (nonatomic, strong) NSString *experienceId;
@property (nonatomic, weak) id<ABI36_0_0EXSensorsManagerBindingDelegate> kernelService;

@end

@implementation ABI36_0_0EXSensorsManagerBinding

- (instancetype)initWithExperienceId:(NSString *)experienceId andKernelService:(id<ABI36_0_0EXSensorsManagerBindingDelegate>)kernelService
{
  if (self = [super init]) {
