...
@interface ABI36_0_0EXExpoUserNotificationCenterProxy ()

@property (nonatomic, weak) id<ABI36_0_0UMUserNotificationCenterProxyInterface> userNotificationCenter;

@end

@implementation ABI36_0_0EXExpoUserNotificationCenterProxy
