...
#import <ABI36_0_0EXConstants/ABI36_0_0EXConstants.h>
#import <ABI36_0_0UMConstantsInterface/ABI36_0_0UMConstantsInterface.h>

#import <WebKit/WKWebView.h>

@interface ABI36_0_0EXConstants () {
  WKWebView *webView;
}

@property (nonatomic, strong) NSString *webViewUserAgent;
@property (nonatomic, weak) id<ABI36_0_0UMConstantsInterface> constantsService;

@end

@implementation ABI36_0_0EXConstants
...
{
  _constantsService = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI36_0_0UMConstantsInterface)];
}
...
ABI36_0_0UM_EXPORT_METHOD_AS(getWebViewUserAgentAsync,
                    getWebViewUserAgentWithResolver:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  __weak ABI36_0_0EXConstants *weakSelf = self;
  dispatch_async(dispatch_get_main_queue(), ^{
    __strong ABI36_0_0EXConstants *strongSelf = weakSelf;
    if (strongSelf) {
      if (!strongSelf.webViewUserAgent) {
        ...
        [strongSelf->webView evaluateJavaScript:@"window.navigator.userAgent;" completionHandler:^(id _Nullable result, NSError * _Nullable error) {
          ...
          resolve(ABI36_0_0UMNullIfNil(strongSelf.webViewUserAgent));
