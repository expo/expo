...
@interface ABI36_0_0EXAppAuthSessionsManager ()

@property (nonatomic, strong) NSMutableSet<id<OIDExternalUserAgentSession>> *currentAuthorizationFlows;

@end

@implementation ABI36_0_0EXAppAuthSessionsManager

ABI36_0_0UM_REGISTER_SINGLETON_MODULE(AppAuthSessionsManager)
