...
@implementation ABI36_0_0EXAdsDFPBannerView {
  DFPBannerView *_bannerView;
  id<ABI36_0_0UMEventEmitterService> _eventEmitter;
}
...
- (void)setOnSizeChange:(ABI36_0_0UMDirectEventBlock)block
{
  _onSizeChange = block;
  [self loadBanner];
}

- (void)setOnDidFailToReceiveAdWithError:(ABI36_0_0UMDirectEventBlock)block
{
