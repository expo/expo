...
#import <ABI36_0_0EXNetwork/ABI36_0_0EXNetwork.h>
...
@implementation ABI36_0_0EXNetwork
...
- (instancetype)init
{
  self = [super init];
  if (self) {
    _type = ABI36_0_0EXNetworkTypeUnknown;
  }
  return self;
}

ABI36_0_0UM_EXPORT_MODULE(ExpoNetwork);
...
ABI36_0_0UM_EXPORT_METHOD_AS(getMacAddressAsync,
...
ABI36_0_0UM_EXPORT_METHOD_AS(getIpAddressAsync,
                    getIpAddressAsyncWithResolver:(ABI36_0_0UMPromiseResolveBlock)resolve rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
...
ABI36_0_0UM_EXPORT_METHOD_AS(getNetworkStateAsync,
                    getNetworkStateAsyncWithResolver:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  if ((flags & kSCNetworkReachabilityFlagsReachable) == 0 ||
    ...
    _type = ABI36_0_0EXNetworkTypeNone;
  }
  
#if !TARGET_OS_TV
  else if ((flags & kSCNetworkReachabilityFlagsIsWWAN) != 0) {
    _type = ABI36_0_0EXNetworkTypeCellular;
  }
#endif
  else {
    _type = ABI36_0_0EXNetworkTypeWifi;
  }
...
- (BOOL)connected
{
  return ![self.type isEqualToString:ABI36_0_0EXNetworkTypeUnknown] && ![self.type isEqualToString:ABI36_0_0EXNetworkTypeNone];
}
