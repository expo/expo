...
#import <ABI36_0_0EXDocumentPicker/ABI36_0_0EXDocumentPickerModule.h>
...
static NSString * ABI36_0_0EXConvertMimeTypeToUTI(NSString *mimeType)
{
  CFStringRef uti;
...
@interface ABI36_0_0EXDocumentPickerModule () <UIDocumentMenuDelegate, UIDocumentPickerDelegate>
...
@implementation ABI36_0_0EXDocumentPickerModule

ABI36_0_0UM_EXPORT_MODULE(ExpoDocumentPicker);
...
ABI36_0_0UM_EXPORT_METHOD_AS(getDocumentAsync,
                    ...
                    reject:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSString *type = ABI36_0_0EXConvertMimeTypeToUTI(options[@"type"] ?: @"*/*");
