...
// An "adapter" over module registry, for given ABI36_0_0RCTBridge and NSString
// is able to provide an array of exported ABI36_0_0RCTBridgeModules. Override
// it and use in your AppDelegate to export different bridge modules
// for different experiences.

@interface ABI36_0_0UMModuleRegistryAdapter : NSObject

@property (nonatomic, readonly) ABI36_0_0UMModuleRegistryProvider *moduleRegistryProvider;
