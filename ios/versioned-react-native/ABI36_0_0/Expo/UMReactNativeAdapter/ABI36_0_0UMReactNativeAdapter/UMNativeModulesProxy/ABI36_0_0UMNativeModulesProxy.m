...
@interface ABI36_0_0UMNativeModulesProxy ()

@property (nonatomic, strong) NSRegularExpression *regexp;
@property (nonatomic, strong) ABI36_0_0UMModuleRegistry *moduleRegistry;
...
@implementation ABI36_0_0UMNativeModulesProxy
...
# pragma mark - ABI36_0_0React API
...
- (NSDictionary *)constantsToExport
{
  ...
  NSArray<ABI36_0_0UMViewManager *> *viewManagers = [_moduleRegistry getAllViewManagers];
...
ABI36_0_0RCT_EXPORT_METHOD(callMethod:(NSString *)moduleName methodNameOrKey:(id)methodNameOrKey arguments:(NSArray *)arguments resolver:(ABI36_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI36_0_0RCTPromiseRejectBlock)reject)
{
