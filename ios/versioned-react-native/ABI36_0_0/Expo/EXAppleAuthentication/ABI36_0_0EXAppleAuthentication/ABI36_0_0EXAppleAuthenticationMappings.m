...
@implementation ABI36_0_0EXAppleAuthenticationMappings
...
{
  return @{
           @"namePrefix": ABI36_0_0UMNullIfNil(nameComponents.namePrefix),
           @"givenName": ABI36_0_0UMNullIfNil(nameComponents.givenName),
           @"middleName": ABI36_0_0UMNullIfNil(nameComponents.middleName),
           @"familyName": ABI36_0_0UMNullIfNil(nameComponents.familyName),
           @"nameSuffix": ABI36_0_0UMNullIfNil(nameComponents.nameSuffix),
           @"nickname": ABI36_0_0UMNullIfNil(nameComponents.nickname)
           };
}
