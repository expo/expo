...
#import <ABI36_0_0EXCrypto/ABI36_0_0EXCrypto.h>
#import <CommonCrypto/CommonDigest.h>

@implementation ABI36_0_0EXCrypto

ABI36_0_0UM_EXPORT_MODULE(ExpoCrypto);

ABI36_0_0UM_EXPORT_METHOD_AS(digestStringAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  int digestLength = [ABI36_0_0EXCrypto digestLengthForJSAlgorithm:algorithm];
  if (digestLength == -1) {
