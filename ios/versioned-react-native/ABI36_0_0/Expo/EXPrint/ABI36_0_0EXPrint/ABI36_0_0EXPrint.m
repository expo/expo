...
#import <ABI36_0_0EXPrint/ABI36_0_0EXPrint.h>
#import <ABI36_0_0EXPrint/ABI36_0_0EXWKPDFRenderer.h>
...
NSString *const ABI36_0_0EXPrintOrientationPortrait = @"portrait";
NSString *const ABI36_0_0EXPrintOrientationLandscape = @"landscape";

@interface ABI36_0_0EXPrint () <UIPrintInteractionControllerDelegate, UIPrinterPickerControllerDelegate>
...
@implementation ABI36_0_0EXPrint

ABI36_0_0UM_EXPORT_MODULE(ExponentPrint);
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"Orientation": @{
               @"portrait": ABI36_0_0EXPrintOrientationPortrait,
               @"landscape": ABI36_0_0EXPrintOrientationLandscape,
               },
           };
}

ABI36_0_0UM_EXPORT_METHOD_AS(print,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  [self _getPrintingDataForOptions:options callback:^(NSData *printingData, NSDictionary *errorDetails) {
    if (errorDetails != nil) {
      reject(errorDetails[@"code"], errorDetails[@"message"], ABI36_0_0UMErrorWithMessage(errorDetails[@"message"]));
      return;
    }
    ...
    if (printingData == nil) {
      ...
      if (options[@"markupFormatterIOS"] && [options[@"markupFormatterIOS"] isKindOfClass:[NSString class]]) {
        ...
        if (htmlString != nil) {
          ...
          reject(@"E_HTML_INVALID", message, ABI36_0_0UMErrorWithMessage(message));
          return;
        }
      } else {
...
ABI36_0_0UM_EXPORT_METHOD_AS(selectPrinter,selectPrinter:(ABI36_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
...
ABI36_0_0UM_EXPORT_METHOD_AS(printToFileAsync,
                    ...
                    reject:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI36_0_0EXWKPDFRenderer *renderTask = [ABI36_0_0EXWKPDFRenderer new];
...
{
  id<ABI36_0_0UMUtilitiesInterface> utils = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI36_0_0UMUtilitiesInterface)];
...
{
  if ([orientation isEqualToString:ABI36_0_0EXPrintOrientationLandscape]) {
