...
#include <cxxReactABI15_0_0/ABI15_0_0RecoverableError.h>

using namespace facebook::ReactABI15_0_0::detail;
...
TEST(RecoverableError, RunRethrowingAsRecoverableRecoverTest) {
  try {
    ...
    ASSERT_STREQ(err.what(), "facebook::ReactABI15_0_0::Recoverable: catch me");
  } catch (...) {
