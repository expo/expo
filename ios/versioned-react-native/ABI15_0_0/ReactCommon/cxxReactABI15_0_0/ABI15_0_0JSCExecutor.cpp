...
#include "ABI15_0_0JSCExecutor.h"
...
#include "ABI15_0_0SystraceSection.h"
#include "ABI15_0_0JSCNativeModules.h"
#include "ABI15_0_0JSCSamplingProfiler.h"
#include "ABI15_0_0JSCUtils.h"
#include "JSModulesUnbundle.h"
#include "ABI15_0_0ModuleRegistry.h"
#include "ABI15_0_0RecoverableError.h"

#if defined(WITH_JSC_EXTRA_TRACING) || (DEBUG && defined(WITH_FBSYSTRACE))
#include "ABI15_0_0JSCTracing.h"
#endif

#ifdef WITH_JSC_EXTRA_TRACING
#include "ABI15_0_0JSCLegacyProfiler.h"
#include "ABI15_0_0JSCLegacyTracing.h"
#endif
...
#include "ABI15_0_0JSCPerfStats.h"
#endif
...
void JSCExecutor::loadApplicationScript(
  ...
  ReactABI15_0_0Marker::logMarker("RUN_JS_BUNDLE_START");
  ...
  flush();
  ReactABI15_0_0Marker::logMarker("CREATE_REACT_CONTEXT_END");
  ReactABI15_0_0Marker::logMarker("RUN_JS_BUNDLE_END");
}
#endif
...
void JSCExecutor::loadApplicationScript(std::unique_ptr<const JSBigString> script, std::string sourceURL) {
  ...
  ReactABI15_0_0Marker::logMarker("loadApplicationScript_startStringConvert");
  String jsScript = jsStringFromBigString(m_context, *script);
  ReactABI15_0_0Marker::logMarker("loadApplicationScript_endStringConvert");
...
void JSCExecutor::stopProfiler(const std::string &titleString, const std::string& filename) {
  #ifdef WITH_JSC_EXTRA_TRACING
  String title(m_context, titleString.c_str());
  facebook::ReactABI15_0_0::stopAndOutputProfilingFile(m_context, title, filename.c_str());
  #endif
}
