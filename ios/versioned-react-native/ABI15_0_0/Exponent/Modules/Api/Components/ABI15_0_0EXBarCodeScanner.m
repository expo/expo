...
@interface ABI15_0_0EXBarCodeScanner ()

@property (nonatomic, weak) ABI15_0_0EXBarCodeScannerManager *manager;
@property (nonatomic, weak) ABI15_0_0RCTBridge *bridge;
@property (nonatomic, copy) ABI15_0_0RCTDirectEventBlock onBarCodeRead;

@end

@implementation ABI15_0_0EXBarCodeScanner
