...
#import "ABI15_0_0AIRMapManager.h"
...
#import "ABI15_0_0AIRMapSnapshot.h"
...
@interface ABI15_0_0AIRMapManager() <MKMapViewDelegate>

@end

@implementation ABI15_0_0AIRMapManager

ABI15_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI15_0_0AIRMap *map = [ABI15_0_0AIRMap new];
    map.delegate = self;
...
ABI15_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
...
ABI15_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
...
ABI15_0_0RCT_EXPORT_VIEW_PROPERTY(cacheEnabled, BOOL)
ABI15_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI15_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI15_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI15_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
...
ABI15_0_0RCT_EXPORT_VIEW_PROPERTY(onPanDrag, ABI15_0_0RCTBubblingEventBlock)
...
ABI15_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI15_0_0RCTDirectEventBlock)
ABI15_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI15_0_0RCTDirectEventBlock)
ABI15_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI15_0_0RCTDirectEventBlock)
ABI15_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI15_0_0RCTDirectEventBlock)
ABI15_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI15_0_0RCTDirectEventBlock)
...
ABI15_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI15_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setRegion:[ABI15_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI15_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI15_0_0AIRMap class]]) {
            ABI15_0_0RCTLogError(@"Invalid view returned from registry, expecting ABI15_0_0AIRMap, got: %@", view);
        } else {
            [ABI15_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI15_0_0AIRMap *)view setRegion:region animated:YES];
            }];
        }
    }];
}

ABI15_0_0RCT_EXPORT_METHOD(animateToCoordinate:(nonnull NSNumber *)ReactABI15_0_0Tag
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI15_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI15_0_0AIRMap class]]) {
            ...
            ABI15_0_0AIRMap *mapView = (ABI15_0_0AIRMap *)view;
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI15_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI15_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ABI15_0_0AIRMapMarker *marker = (ABI15_0_0AIRMapMarker *)evaluatedObject;
                return [marker isKindOfClass:[ABI15_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
...
- (void)takeMapSnapshot:(ABI15_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI15_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI15_0_0AIRMap *map = (ABI15_0_0AIRMap *)recognizer.view;
    ...
    ABI15_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI15_0_0AIRMapPolygon class]]){
            ABI15_0_0AIRMapPolygon *polygon = (ABI15_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI15_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI15_0_0AIRMapPolyline class]]){
            ABI15_0_0AIRMapPolyline *polyline = (ABI15_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI15_0_0AIRMapPolyline class]]) {
        return ((ABI15_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI15_0_0AIRMapPolygon class]]) {
        return ((ABI15_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI15_0_0AIRMapCircle class]]) {
        return ((ABI15_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI15_0_0AIRMapUrlTile class]]) {
        return ((ABI15_0_0AIRMapUrlTile *)overlay).renderer;
    } else {
        return nil;
    }
}
...
- (void)mapView:(ABI15_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI15_0_0AIRMapMarker class]]) {
        [(ABI15_0_0AIRMapMarker *)view.annotation showCalloutView];
    }
}

- (void)mapView:(ABI15_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI15_0_0AIRMapMarker class]]) {
        [(ABI15_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI15_0_0AIRMap *)mapView viewForAnnotation:(ABI15_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI15_0_0AIRMapMarker class]]) {
        return nil;
    }
...
- (void)mapView:(ABI15_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI15_0_0AIRMapMarker class]]) return;
    ABI15_0_0AIRMapMarker *marker = (ABI15_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI15_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI15_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI15_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI15_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI15_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    [self _regionChanged:mapView];

    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI15_0_0AIRMapRegionChangeObserveInterval
                                                               target:self
...
- (void)mapView:(ABI15_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI15_0_0AIRMap *)mapView
{
...
- (void)mapViewDidFinishRenderingMap:(ABI15_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
- (void)_regionChanged:(ABI15_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI15_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI15_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI15_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI15_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI15_0_0AIRMap *)mapView
{
