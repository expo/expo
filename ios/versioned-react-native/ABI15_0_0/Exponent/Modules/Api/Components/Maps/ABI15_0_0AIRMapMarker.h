...
@interface ABI15_0_0AIRMapMarker : MKAnnotationView <MKAnnotation>

@property (nonatomic, strong) ABI15_0_0AIRMapCallout *calloutView;
...
@property (nonatomic, copy) ABI15_0_0RCTDirectEventBlock onSelect;
@property (nonatomic, copy) ABI15_0_0RCTDirectEventBlock onDeselect;
@property (nonatomic, copy) ABI15_0_0RCTDirectEventBlock onCalloutPress;
...
@interface ABI15_0_0AIREmptyCalloutBackgroundView : ABI15_0_0SMCalloutBackgroundView
@end
