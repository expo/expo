...
const CLLocationDegrees ABI15_0_0AIRMapDefaultSpan = 0.005;
const NSTimeInterval ABI15_0_0AIRMapRegionChangeObserveInterval = 0.1;
const CGFloat ABI15_0_0AIRMapZoomBoundBuffer = 0.01;
...
@implementation ABI15_0_0AIRMap
{
    UIView *_legalLabel;
    ...
    //
    // ABI15_0_0AIRMap implicitly creates subviews that aren't regular RN children
    // (ABI15_0_0SMCalloutView injects an overlay subview), which otherwise confuses RN
    // during component re-renders:
    // https://github.com/facebook/ReactABI15_0_0-native/blob/v0.16.0/ReactABI15_0_0/Modules/ABI15_0_0RCTUIManager.m#L657
    //
    // Implementation based on ABI15_0_0RCTTextField, another component with indirect children
    // https://github.com/facebook/ReactABI15_0_0-native/blob/v0.16.0/Libraries/Text/ABI15_0_0RCTTextField.m#L20
...
- (instancetype)init
{
    if ((self = [super init])) {
        ...
        self.calloutView = [ABI15_0_0SMCalloutView platformCalloutView];
...
- (void)insertReactABI15_0_0Subview:(id<ABI15_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
    ...
    if ([subview isKindOfClass:[ABI15_0_0AIRMapMarker class]]) {
        [self addAnnotation:(id <MKAnnotation>) subview];
    } else if ([subview isKindOfClass:[ABI15_0_0AIRMapPolyline class]]) {
        ((ABI15_0_0AIRMapPolyline *)subview).map = self;
        [self addOverlay:(id<MKOverlay>)subview];
    } else if ([subview isKindOfClass:[ABI15_0_0AIRMapPolygon class]]) {
        ((ABI15_0_0AIRMapPolygon *)subview).map = self;
        [self addOverlay:(id<MKOverlay>)subview];
    } else if ([subview isKindOfClass:[ABI15_0_0AIRMapCircle class]]) {
        [self addOverlay:(id<MKOverlay>)subview];
    } else if ([subview isKindOfClass:[ABI15_0_0AIRMapUrlTile class]]) {
        [self addOverlay:(id<MKOverlay>)subview];
    }
...
#pragma mark ABI15_0_0SMCalloutViewDelegate
