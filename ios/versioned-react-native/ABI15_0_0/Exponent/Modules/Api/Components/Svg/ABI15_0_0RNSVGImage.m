...
@implementation ABI15_0_0RNSVGImage
{
    CGImageRef _image;
    CGFloat _imageRatio;
}
...
- (void)setSrc:(id)src
{
    ...
    ABI15_0_0RCTImageSource *source = [ABI15_0_0RCTConvert ABI15_0_0RCTImageSource:src];
    _imageRatio = source.size.width / source.size.height;
    _image = CGImageRetain([ABI15_0_0RCTConvert CGImage:src]);
    [self invalidate];
}
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    ABI15_0_0RNSVGViewBox *viewBox = [[ABI15_0_0RNSVGViewBox alloc] init];
