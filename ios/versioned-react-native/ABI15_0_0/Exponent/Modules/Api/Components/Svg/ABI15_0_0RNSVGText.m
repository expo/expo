...
#import "ABI15_0_0RNSVGBezierPath.h"
#import <CoreText/CoreText.h>

@implementation ABI15_0_0RNSVGText

static void ABI15_0_0RNSVGFreeTextFrame(ABI15_0_0RNSVGTextFrame frame)
{
    if (frame.count) {
...
- (void)setTextFrame:(ABI15_0_0RNSVGTextFrame)textFrame
{
    ABI15_0_0RNSVGFreeTextFrame(_textFrame);
    [self invalidate];
...
- (CGPathRef)getPath:(CGContextRef)context
{
    ...
    ABI15_0_0RNSVGTextFrame frame = self.textFrame;
    for (int i = 0; i < frame.count; i++) {
        CGFloat shift;
...
- (CGMutablePathRef)setLinePath:(CTLineRef)line
{
    ...
    ABI15_0_0RNSVGBezierPath *bezierPath = [[ABI15_0_0RNSVGBezierPath alloc] initWithBezierCurves:self.path];
