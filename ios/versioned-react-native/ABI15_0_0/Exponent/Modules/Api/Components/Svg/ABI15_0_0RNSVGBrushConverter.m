...
@implementation ABI15_0_0RNSVGBrushConverter

- (void)drawLinearGradient:(CGContextRef)context
{
    
    CGGradientRef gradient = CGGradientRetain([ABI15_0_0RCTConvert CGGradient:self.colors offset:0]);
    ...
    ABI15_0_0RNSVGPercentageConverter* convert = [[ABI15_0_0RNSVGPercentageConverter alloc] init];
