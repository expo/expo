...
@implementation ABI15_0_0RNSVGRenderable
{
    NSMutableDictionary *_originProperties;
    NSArray *_changedList;
    ABI15_0_0RNSVGPercentageConverter *_widthConverter;
    ABI15_0_0RNSVGPercentageConverter *_heightConverter;
...
- (void)setFill:(ABI15_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI15_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI15_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)setStrokeDasharray:(ABI15_0_0RNSVGCGFloatArray)strokeDasharray
{
...
- (void)setBoundingBox:(CGRect)boundingBox
{
    ...
    _widthConverter = [[ABI15_0_0RNSVGPercentageConverter alloc] initWithRelativeAndOffset:boundingBox.size.width offset:0];
    _heightConverter = [[ABI15_0_0RNSVGPercentageConverter alloc] initWithRelativeAndOffset:boundingBox.size.height offset:0];
}
...
- (void)inheritProperty:(__kindof ABI15_0_0RNSVGNode *)parent propName:(NSString *)propName
{
