...
#import "ABI15_0_0AIRGoogleMapCircle.h"
...
@interface ABI15_0_0AIRGoogleMap ()

- (id)eventFromCoordinate:(CLLocationCoordinate2D)coordinate;

@end

@implementation ABI15_0_0AIRGoogleMap
{
  NSMutableArray<UIView *> *_ReactABI15_0_0Subviews;
...
{
  if ((self = [super init])) {
    _ReactABI15_0_0Subviews = [NSMutableArray new];
...
- (void)insertReactABI15_0_0Subview:(id<ABI15_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  ...
  if ([subview isKindOfClass:[ABI15_0_0AIRGoogleMapMarker class]]) {
    ABI15_0_0AIRGoogleMapMarker *marker = (ABI15_0_0AIRGoogleMapMarker*)subview;
    marker.realMarker.map = self;
    [self.markers addObject:marker];
  } else if ([subview isKindOfClass:[ABI15_0_0AIRGoogleMapPolygon class]]) {
    ABI15_0_0AIRGoogleMapPolygon *polygon = (ABI15_0_0AIRGoogleMapPolygon*)subview;
    polygon.polygon.map = self;
    [self.polygons addObject:polygon];
  } else if ([subview isKindOfClass:[ABI15_0_0AIRGoogleMapPolyline class]]) {
    ABI15_0_0AIRGoogleMapPolyline *polyline = (ABI15_0_0AIRGoogleMapPolyline*)subview;
    polyline.polyline.map = self;
    [self.polylines addObject:polyline];
  } else if ([subview isKindOfClass:[ABI15_0_0AIRGoogleMapCircle class]]) {
    ABI15_0_0AIRGoogleMapCircle *circle = (ABI15_0_0AIRGoogleMapCircle*)subview;
    circle.circle.map = self;
    [self.circles addObject:circle];
  } else if ([subview isKindOfClass:[ABI15_0_0AIRGoogleMapUrlTile class]]) {
    ABI15_0_0AIRGoogleMapUrlTile *tile = (ABI15_0_0AIRGoogleMapUrlTile*)subview;
    tile.tileLayer.map = self;
    [self.tiles addObject:tile];
  }
  [_ReactABI15_0_0Subviews insertObject:(UIView *)subview atIndex:(NSUInteger) atIndex];
}
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wobjc-missing-super-calls"
- (void)removeReactABI15_0_0Subview:(id<ABI15_0_0RCTComponent>)subview {
  ...
  [_ReactABI15_0_0Subviews removeObject:(UIView *)subview];
}
#pragma clang diagnostic pop

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wobjc-missing-super-calls"
- (NSArray<id<ABI15_0_0RCTComponent>> *)ReactABI15_0_0Subviews {
...
- (void)setInitialRegion:(MKCoordinateRegion)initialRegion {
  ...
  self.camera = [ABI15_0_0AIRGoogleMap makeGMSCameraPositionFromMap:self andMKCoordinateRegion:initialRegion];
}

- (void)setRegion:(MKCoordinateRegion)region {
  // TODO: The JS component is repeatedly setting region unnecessarily. We might want to deal with that in here.
  self.camera = [ABI15_0_0AIRGoogleMap makeGMSCameraPositionFromMap:self  andMKCoordinateRegion:region];
}

- (BOOL)didTapMarker:(GMSMarker *)marker {
  ABI15_0_0AIRGMSMarker *airMarker = (ABI15_0_0AIRGMSMarker *)marker;
...
- (void)didChangeCameraPosition:(GMSCameraPosition *)position {
  id event = @{@"continuous": @YES,
               @"region": regionAsJSON([ABI15_0_0AIRGoogleMap makeGMSCameraPositionFromMap:self andGMSCameraPosition:position]),
               };
