...
#import "ABI15_0_0AIRDummyView.h"
...
@interface ABI15_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI15_0_0AIRGMSMarker*)marker;
@end

@implementation ABI15_0_0AIRGoogleMapMarker {
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI15_0_0AIRGMSMarker alloc] init];
...
- (void)insertReactABI15_0_0Subview:(id<ABI15_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI15_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI15_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI15_0_0AIRDummyView *dummySubview = [[ABI15_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertReactABI15_0_0Subview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeReactABI15_0_0Subview:(id<ABI15_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI15_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeReactABI15_0_0Subview:(UIView*)dummySubview];
}
...
- (void)setOnPress:(ABI15_0_0RCTBubblingEventBlock)onPress {
  _realMarker.onPress = onPress;
}

- (ABI15_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/airbnb/ReactABI15_0_0-native-maps/issues/738)
