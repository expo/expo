...
@interface ABI15_0_0EXNativeAdView ()

@end

@implementation ABI15_0_0EXNativeAdView
...
- (void)setNativeAd:(FBNativeAd *)nativeAd
{
  ...
  [_nativeAd registerViewForInteraction:self withViewController:ABI15_0_0RCTKeyWindow().rootViewController];
}
