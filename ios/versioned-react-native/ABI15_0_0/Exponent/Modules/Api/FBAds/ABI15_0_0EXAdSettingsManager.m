#import "ABI15_0_0EXAdSettingsManager.h"
...
ABI15_0_0RCT_ENUM_CONVERTER(FBAdLogLevel, (@{
...
@interface ABI15_0_0EXAdSettingsManager ()
...
@implementation ABI15_0_0EXAdSettingsManager

@synthesize bridge = _bridge;

ABI15_0_0RCT_EXPORT_MODULE(CTKAdSettingsManager)
...
ABI15_0_0RCT_EXPORT_METHOD(addTestDevice:(NSString *)deviceHash)
{
  [FBAdSettings addTestDevice:deviceHash];
  [_testDevices addObject:deviceHash];
}

ABI15_0_0RCT_EXPORT_METHOD(clearTestDevices)
{
  [FBAdSettings clearTestDevices];
  [_testDevices removeAllObjects];
}

ABI15_0_0RCT_EXPORT_METHOD(setLogLevel:(FBAdLogLevel)logLevel)
{
  [FBAdSettings setLogLevel:logLevel];
  _logLevel = logLevel;
}

ABI15_0_0RCT_EXPORT_METHOD(setIsChildDirected:(BOOL)isDirected)
{
  [FBAdSettings setIsChildDirected:isDirected];
  _isChildDirected = isDirected;
}

ABI15_0_0RCT_EXPORT_METHOD(setMediationService:(NSString *)mediationService)
{
  [FBAdSettings setMediationService:mediationService];
  _mediationService = mediationService;
}

ABI15_0_0RCT_EXPORT_METHOD(setUrlPrefix:(NSString *)urlPrefix)
{
