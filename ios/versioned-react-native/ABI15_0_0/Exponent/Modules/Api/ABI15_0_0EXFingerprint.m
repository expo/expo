...
#import "ABI15_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI15_0_0EXFingerprint

ABI15_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI15_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI15_0_0RCTPromiseResolveBlock)resolve
...
ABI15_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI15_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI15_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI15_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
