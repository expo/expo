...
#import "ABI15_0_0EXAudio.h"
#import "ABI15_0_0EXUnversioned.h"

@interface ABI15_0_0EXAudioPlayerData: NSObject

@property (nonatomic, strong) AVPlayer *player;
@property (nonatomic, strong) NSNumber *rate;
@property (nonatomic, strong) id <NSObject> finishObserver;
@property (nonatomic, strong) ABI15_0_0RCTResponseSenderBlock finishCallback;
...
@implementation ABI15_0_0EXAudioPlayerData
    ...
    withInternalFinishCallback:(void (^)())internalFinishCallback
{
  ...
  void (^didPlayToEndTimeObserverBlock)(NSNotification *note) = ^(NSNotification *note) {
    if (weakSelf.isLooping) {
      ...
      ABI15_0_0RCTResponseSenderBlock callback = weakSelf.finishCallback;
...
@implementation ABI15_0_0EXAudio
...
- (void)setBridge:(ABI15_0_0RCTBridge *)bridge
{
  ...
  [[NSNotificationCenter defaultCenter] addObserver:self
                                           selector:@selector(_bridgeDidForeground:)
                                               name:@"ABI15_0_0EXKernelBridgeDidForegroundNotification"
                                             object:_bridge];
  
  [[NSNotificationCenter defaultCenter] addObserver:self
                                           selector:@selector(_bridgeDidBackground:)
                                               name:@"ABI15_0_0EXKernelBridgeDidBackgroundNotification"
                                             object:_bridge];
}
...
- (NSError *)_deactivateAudioSession
{
  ...
  for (ABI15_0_0EXAudioPlayerData *data in [_playerDataPool allValues]) {
    [data.player pause];
  }
  NSError *error;
  ...
  if ([_pausedOnBackgroundingSet count] > 0) {
    ...
    if (!error) {
      for (NSNumber *key in _pausedOnBackgroundingSet) {
        ABI15_0_0EXAudioPlayerData *data = _playerDataPool[key];
...
- (void)_runBlock:(void (^)(ABI15_0_0EXAudioPlayerData *data))block
withPlayerDataForKey:(nonnull NSNumber *)key
        withRejecter:(ABI15_0_0RCTPromiseRejectBlock)reject
{
  ABI15_0_0EXAudioPlayerData *data = _playerDataPool[key];
  if (data) {
    block(data);
...
ABI15_0_0RCT_EXPORT_MODULE(ExponentAudio);

ABI15_0_0RCT_EXPORT_METHOD(setIsEnabled:(BOOL)value
...
ABI15_0_0RCT_EXPORT_METHOD(load:(NSString *)uriString
              resolver:(ABI15_0_0RCTPromiseResolveBlock)resolve
              rejecter:(ABI15_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (player) {
    ...
    __weak __typeof__(self) weakSelf = self;
    ABI15_0_0EXAudioPlayerData *data = [[ABI15_0_0EXAudioPlayerData alloc] initWithPlayer:player
                                                            withLooping:NO
...
ABI15_0_0RCT_EXPORT_METHOD(play:(nonnull NSNumber *)key
              resolver:(ABI15_0_0RCTPromiseResolveBlock)resolve
              rejecter:(ABI15_0_0RCTPromiseRejectBlock)reject)
{
  [self _runBlock:^(ABI15_0_0EXAudioPlayerData *data) {
    NSError *error = [self _activateAudioSessionIfNecessary];
    if (!error) {
      [data playPlayerWithRate];
    }
...
ABI15_0_0RCT_EXPORT_METHOD(pause:(nonnull NSNumber *)key
               resolver:(ABI15_0_0RCTPromiseResolveBlock)resolve
               rejecter:(ABI15_0_0RCTPromiseRejectBlock)reject)
{
  [self _runBlock:^(ABI15_0_0EXAudioPlayerData *data) {
...
ABI15_0_0RCT_EXPORT_METHOD(stop:(nonnull NSNumber *)key
              resolver:(ABI15_0_0RCTPromiseResolveBlock)resolve
              rejecter:(ABI15_0_0RCTPromiseRejectBlock)reject)
{
  [self _runBlock:^(ABI15_0_0EXAudioPlayerData *data) {
...
ABI15_0_0RCT_EXPORT_METHOD(unload:(nonnull NSNumber *)key
                resolver:(ABI15_0_0RCTPromiseResolveBlock)resolve
                rejecter:(ABI15_0_0RCTPromiseRejectBlock)reject)
{
  [self _runBlock:^(ABI15_0_0EXAudioPlayerData *data) {
...
ABI15_0_0RCT_EXPORT_METHOD(setPosition:(nonnull NSNumber *)key
...
ABI15_0_0RCT_EXPORT_METHOD(setRate:(nonnull NSNumber *)key
...
ABI15_0_0RCT_EXPORT_METHOD(setVolume:(nonnull NSNumber *)key
                    toValue:(nonnull NSNumber *)value
                   resolver:(ABI15_0_0RCTPromiseResolveBlock)resolve
                   rejecter:(ABI15_0_0RCTPromiseRejectBlock)reject)
{
...
ABI15_0_0RCT_EXPORT_METHOD(setIsMuted:(nonnull NSNumber *)key
                     toValue:(BOOL)value
                    resolver:(ABI15_0_0RCTPromiseResolveBlock)resolve
                    rejecter:(ABI15_0_0RCTPromiseRejectBlock)reject)
{
...
ABI15_0_0RCT_EXPORT_METHOD(setIsLooping:(nonnull NSNumber *)key
                       toValue:(BOOL)value
                      resolver:(ABI15_0_0RCTPromiseResolveBlock)resolve
                      rejecter:(ABI15_0_0RCTPromiseRejectBlock)reject)
{
...
ABI15_0_0RCT_EXPORT_METHOD(getStatus:(nonnull NSNumber *)key
                   resolver:(ABI15_0_0RCTPromiseResolveBlock)resolve
                   rejecter:(ABI15_0_0RCTPromiseRejectBlock)reject)
{
  [self _runBlock:^(ABI15_0_0EXAudioPlayerData *data) {
...
ABI15_0_0RCT_EXPORT_METHOD(setPlaybackFinishedCallback:(nonnull NSNumber *)key
