...
NSString * const ABI15_0_0EXLocationChangedEventName = @"Exponent.locationChanged";

@interface ABI15_0_0EXLocationDelegate : NSObject <CLLocationManagerDelegate>
...
@implementation ABI15_0_0EXLocationDelegate
...
@interface ABI15_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI15_0_0EXLocationDelegate*> *delegates;

@end

@implementation ABI15_0_0EXLocation

ABI15_0_0RCT_EXPORT_MODULE(ExponentLocation)
...
{
  return @[ABI15_0_0EXLocationChangedEventName];
}


ABI15_0_0RCT_REMAP_METHOD(getCurrentPositionAsync,
...
ABI15_0_0RCT_REMAP_METHOD(watchPositionImplAsync,
                 ...
                 rejecter:(ABI15_0_0RCTPromiseRejectBlock)reject)
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    locMgr.distanceFilter = options[@"distanceInterval"] ? [ABI15_0_0RCTConvert double:options[@"distanceInterval"]] ?: kCLDistanceFilterNone : kCLLocationAccuracyHundredMeters;
    locMgr.desiredAccuracy = [ABI15_0_0RCTConvert BOOL:options[@"enableHighAccuracy"]] ? kCLLocationAccuracyBest : kCLLocationAccuracyHundredMeters;
    
    ABI15_0_0EXLocationDelegate *delegate = [[ABI15_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
      if (locations.lastObject) {
        ...
        [weakSelf sendEventWithName:ABI15_0_0EXLocationChangedEventName body:body];
      }
...
ABI15_0_0RCT_REMAP_METHOD(removeWatchAsync,
                 watchId:(nonnull NSNumber *)watchId
                 resolver:(ABI15_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI15_0_0RCTPromiseRejectBlock)reject)
{
  ABI15_0_0EXLocationDelegate *delegate = _delegates[watchId];
  if (delegate) {
    __weak typeof(self) weakSelf = self;
    dispatch_async(dispatch_get_main_queue(), ^{
