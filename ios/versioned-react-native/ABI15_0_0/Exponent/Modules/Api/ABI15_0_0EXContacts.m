...
#import "ABI15_0_0EXContacts.h"

@import Contacts;

@interface ABI15_0_0EXContacts ()

@property (nonatomic, strong) CNContactStore *contactStore;

@end

@implementation ABI15_0_0EXContacts

ABI15_0_0RCT_EXPORT_MODULE(ExponentContacts);

/**
 * @param fields array with possible values 'addresses', 'phoneNumbers', 'emails'
 */
ABI15_0_0RCT_EXPORT_METHOD(getContactsAsync:(NSArray *)fields resolver:(ABI15_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI15_0_0RCTPromiseRejectBlock)reject)
{
  if (!_contactStore) {
...
- (void)_getContactsWithPermissionGrantedAsync:(NSArray *)fields resolver:(ABI15_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI15_0_0RCTPromiseRejectBlock)reject
{
