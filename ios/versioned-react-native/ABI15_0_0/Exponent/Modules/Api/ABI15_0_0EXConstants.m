...
@interface ABI15_0_0EXConstants ()
...
@implementation ABI15_0_0EXConstants
...
{
  NSString *expoClientVersion = [[[NSBundle mainBundle] infoDictionary] objectForKey:@"ABI15_0_0EXClientVersion"];
