...
@interface ABI15_0_0EXKernelModule ()
...
@implementation ABI15_0_0EXKernelModule
...
- (void)sendEventWithName:(NSString *)eventName body:(id)body
{
  ...
  [self.bridge enqueueJSCall:@"ABI15_0_0RCTDeviceEventEmitter.emit"
...
ABI15_0_0RCT_EXPORT_METHOD(addDevMenu)
{
...
ABI15_0_0RCT_REMAP_METHOD(routeDidForeground,
...
ABI15_0_0RCT_REMAP_METHOD(onEventSuccess,
...
ABI15_0_0RCT_REMAP_METHOD(onEventFailure,
                 eventId:(NSString *)eventId
