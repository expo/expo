...
#if !TARGET_OS_TV
@implementation ABI15_0_0RCTConvert (ABI15_0_0EXStatusBar)
...
@interface ABI15_0_0EXStatusBarManager ()

@property (nonatomic, strong) NSDictionary *capturedStatusBarProperties;

@end

@implementation ABI15_0_0EXStatusBarManager

+ (NSString *)moduleName { return @"ABI15_0_0RCTStatusBarManager"; }
 ...
 */
ABI15_0_0RCT_REMAP_METHOD(_captureProperties,
                 _capturePropertiesWithResolver:(ABI15_0_0RCTPromiseResolveBlock)resolve
 ...
 *  Normally nobody should use this method because it bypasses the JS state used by the StatusBar component.
 */
ABI15_0_0RCT_EXPORT_METHOD(_applyPropertiesAndForget:(NSDictionary *)properties)
{
...
{
  UIApplication *currentApplication = ABI15_0_0RCTSharedApplication();
  return @{
