...
@interface ABI15_0_0RCTDevMenuItem ()

@property (nonatomic, copy, readonly) NSString *title;

@end

@implementation ABI15_0_0RCTDevMenu (Device)
...
- (NSArray *)menuItems: (NSArray *)items notContainingPattern: (NSString *)pattern
{
  ...
  NSIndexSet *indexes = [items indexesOfObjectsWithOptions:NSEnumerationConcurrent passingTest:^BOOL(ABI15_0_0RCTDevMenuItem *menuItem, NSUInteger index, BOOL *stop) {
