...
typedef NS_ENUM(NSInteger, ABI15_0_0RCTTestStatus) {
  ABI15_0_0RCTTestStatusPending = 0,
  ABI15_0_0RCTTestStatusPassed,
  ABI15_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI15_0_0RCTTestModule : NSObject <ABI15_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI15_0_0RCTTestStatus status;
