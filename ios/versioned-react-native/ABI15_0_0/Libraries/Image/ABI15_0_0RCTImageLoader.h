...
#import <ReactABI15_0_0/ABI15_0_0RCTResizeMode.h>
#import <ReactABI15_0_0/ABI15_0_0RCTURLRequestHandler.h>

typedef void (^ABI15_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI15_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI15_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI15_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI15_0_0RCTImageCache <NSObject>
...
@interface UIImage (ReactABI15_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI15_0_0KeyframeAnimation;

@end

@interface ABI15_0_0RCTImageLoader : NSObject <ABI15_0_0RCTBridgeModule, ABI15_0_0RCTURLRequestHandler>
 ...
 */
- (ABI15_0_0RCTImageLoaderCancellationBlock)loadImageWithURLRequest:(NSURLRequest *)imageURLRequest
                                                  callback:(ABI15_0_0RCTImageLoaderCompletionBlock)callback;
...
- (ABI15_0_0RCTImageLoaderCancellationBlock)loadImageWithURLRequest:(NSURLRequest *)imageURLRequest
                                                ...
                                                resizeMode:(ABI15_0_0RCTResizeMode)resizeMode
                                             progressBlock:(ABI15_0_0RCTImageLoaderProgressBlock)progressBlock
                                          partialLoadBlock:(ABI15_0_0RCTImageLoaderPartialLoadBlock)partialLoadBlock
                                           completionBlock:(ABI15_0_0RCTImageLoaderCompletionBlock)completionBlock;
 ...
 */
- (ABI15_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                           clipped:(BOOL)clipped
                                        resizeMode:(ABI15_0_0RCTResizeMode)resizeMode
 ...
 */
- (ABI15_0_0RCTImageLoaderCancellationBlock)getImageSizeForURLRequest:(NSURLRequest *)imageURLRequest
                                                       block:(void(^)(NSError *error, CGSize size))completionBlock;

/**
 * Allows developers to set their own caching implementation for
 * decoded images as long as it conforms to the ABI15_0_0RCTImageCacheDelegate
 * protocol. This method should be called in bridgeDidInitializeModule.
 */
- (void)setImageCache:(id<ABI15_0_0RCTImageCache>)cache;

@end

@interface ABI15_0_0RCTBridge (ABI15_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI15_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI15_0_0RCTImageURLLoader <ABI15_0_0RCTBridgeModule>
...
/**
 * If more than one ABI15_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI15_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 * are also bridge modules, so should be registered using ABI15_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI15_0_0RCTImageDataDecoder <ABI15_0_0RCTBridgeModule>
...
/**
 * If more than one ABI15_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
