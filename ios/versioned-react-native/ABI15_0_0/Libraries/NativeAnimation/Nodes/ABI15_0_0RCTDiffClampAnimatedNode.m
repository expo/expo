...
@implementation ABI15_0_0RCTDiffClampAnimatedNode
{
...
{
  ABI15_0_0RCTValueAnimatedNode *inputNode = (ABI15_0_0RCTValueAnimatedNode *)self.parentNodes[_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI15_0_0RCTValueAnimatedNode class]]) {
    ABI15_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
