...
@implementation ABI15_0_0RCTStyleAnimatedNode
{
...
- (void)performUpdate
{
  ...
  [style enumerateKeysAndObjectsUsingBlock:^(NSString *property, NSNumber *nodeTag, __unused BOOL *stop) {
    ABI15_0_0RCTAnimatedNode *node = self.parentNodes[nodeTag];
    if (node) {
      if ([node isKindOfClass:[ABI15_0_0RCTValueAnimatedNode class]]) {
        ABI15_0_0RCTValueAnimatedNode *parentNode = (ABI15_0_0RCTValueAnimatedNode *)node;
        [self->_propsDictionary setObject:@(parentNode.value) forKey:property];
      } else if ([node isKindOfClass:[ABI15_0_0RCTTransformAnimatedNode class]]) {
        ABI15_0_0RCTTransformAnimatedNode *parentNode = (ABI15_0_0RCTTransformAnimatedNode *)node;
