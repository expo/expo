...
@implementation ABI15_0_0RCTAnimatedNode
{
  NSMutableDictionary<NSNumber *, ABI15_0_0RCTAnimatedNode *> *_childNodes;
  NSMutableDictionary<NSNumber *, ABI15_0_0RCTAnimatedNode *> *_parentNodes;
}
...
- (NSDictionary<NSNumber *, ABI15_0_0RCTAnimatedNode *> *)childNodes
{
  return _childNodes;
}

- (NSDictionary<NSNumber *, ABI15_0_0RCTAnimatedNode *> *)parentNodes
{
  return _parentNodes;
}

- (void)addChild:(ABI15_0_0RCTAnimatedNode *)child
{
  if (!_childNodes) {
...
- (void)removeChild:(ABI15_0_0RCTAnimatedNode *)child
{
  if (!_childNodes) {
    return;
  }
...
- (void)detachNode
{
  for (ABI15_0_0RCTAnimatedNode *parent in _parentNodes.allValues) {
    [parent removeChild:self];
  }
  for (ABI15_0_0RCTAnimatedNode *child in _childNodes.allValues) {
