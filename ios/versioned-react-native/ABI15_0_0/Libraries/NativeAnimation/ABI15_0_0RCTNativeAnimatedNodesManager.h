...
@interface ABI15_0_0RCTNativeAnimatedNodesManager : NSObject

- (nonnull instancetype)initWithUIManager:(nonnull ABI15_0_0RCTUIManager *)uiManager;
...
- (void)startAnimatingNode:(nonnull NSNumber *)animationId
                   nodeTag:(nonnull NSNumber *)nodeTag
                    config:(NSDictionary<NSString *, id> *__nonnull)config
               endCallback:(nullable ABI15_0_0RCTResponseSenderBlock)callBack;
...
- (void)handleAnimatedEvent:(nonnull id<ABI15_0_0RCTEvent>)event;

// listeners

- (void)startListeningToAnimatedNodeValue:(nonnull NSNumber *)tag
                            valueObserver:(nonnull id<ABI15_0_0RCTValueAnimatedNodeObserver>)valueObserver;
