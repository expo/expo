...
@implementation ABI15_0_0RCTSpringAnimation
{
  ...
  ABI15_0_0RCTResponseSenderBlock _callback;
                  ...
                  callBack:(nullable ABI15_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _toValue = [ABI15_0_0RCTConvert CGFloat:config[@"toValue"]];
    _fromValue = valueNode.value;
    _valueNode = valueNode;
    _overshootClamping = [ABI15_0_0RCTConvert BOOL:config[@"overshootClamping"]];
    _restDisplacementThreshold = [ABI15_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
    _restSpeedThreshold = [ABI15_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
    _tension = [ABI15_0_0RCTConvert CGFloat:config[@"tension"]];
    _friction = [ABI15_0_0RCTConvert CGFloat:config[@"friction"]];
