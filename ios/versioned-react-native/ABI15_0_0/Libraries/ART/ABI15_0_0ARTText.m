...
@implementation ABI15_0_0ARTText
...
static void ABI15_0_0ARTFreeTextFrame(ABI15_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI15_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI15_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI15_0_0ARTTextFrame frame = self.textFrame;
