...
#import "ABI15_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI15_0_0/ABI15_0_0RCTConvert.h>
#import <ReactABI15_0_0/ABI15_0_0RCTImageStoreManager.h>
...
@interface ABI15_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI15_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI15_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI15_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI15_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI15_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI15_0_0RCTResponseSenderBlock)callback)
{
...
ABI15_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI15_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI15_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI15_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI15_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI15_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI15_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI15_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI15_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI15_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI15_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI15_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI15_0_0RCTNullIfNil(height), ABI15_0_0RCTNullIfNil(width)]];
    return;
  }
        ...
        cancelCallback:(ABI15_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI15_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI15_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI15_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
