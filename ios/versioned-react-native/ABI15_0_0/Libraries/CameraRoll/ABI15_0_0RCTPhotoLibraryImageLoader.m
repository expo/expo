...
#import "ABI15_0_0RCTPhotoLibraryImageLoader.h"

#import <Photos/Photos.h>

#import <ReactABI15_0_0/ABI15_0_0RCTUtils.h>

@implementation ABI15_0_0RCTPhotoLibraryImageLoader

ABI15_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI15_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI15_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI15_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI15_0_0RCTResizeModeContain) {
