...
#import <cxxReactABI15_0_0/ABI15_0_0Executor.h>
#import <cxxReactABI15_0_0/ABI15_0_0ModuleRegistry.h>
#import <folly/json.h>
...
class ABI15_0_0RCTObjcExecutor : public JSExecutor {
public:
  ABI15_0_0RCTObjcExecutor(id<ABI15_0_0RCTJavaScriptExecutor> jse, ABI15_0_0RCTJavaScriptCompleteBlock errorBlock,
                  std::shared_ptr<facebook::ReactABI15_0_0::ExecutorDelegate> delegate)
    : m_jse(jse)
    ...
    , m_delegate(delegate)
  {
    m_jsCallback = ^(id json, NSError *error) {
      ...
      m_delegate->callNativeModules(*this, [ABI15_0_0RCTConvert folly_dynamic:json], true);
    };
  ...
  void setJSModulesUnbundle(std::unique_ptr<JSModulesUnbundle>) override {
    ABI15_0_0RCTLogWarn(@"Unbundle is not supported in ABI15_0_0RCTObjcExecutor");
  }
  ...
  void callFunction(const std::string &module, const std::string &method,
    ...
    [m_jse callFunctionOnModule:@(module.c_str())
           method:@(method.c_str())
           arguments:ABI15_0_0RCTConvertFollyDynamic(arguments)
...
private:
  ...
  std::shared_ptr<facebook::ReactABI15_0_0::ExecutorDelegate> m_delegate;
  ABI15_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI15_0_0RCTObjcExecutorFactory::ABI15_0_0RCTObjcExecutorFactory(
  id<ABI15_0_0RCTJavaScriptExecutor> jse, ABI15_0_0RCTJavaScriptCompleteBlock errorBlock)
  : m_jse(jse)
  , m_errorBlock(errorBlock) {}

std::unique_ptr<JSExecutor> ABI15_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue) {
  return std::unique_ptr<JSExecutor>(
    new ABI15_0_0RCTObjcExecutor(m_jse, m_errorBlock, delegate));
}
