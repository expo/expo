...
#import "ABI15_0_0RCTMultipartStreamReader.h"

#define CRLF @"\r\n"

@implementation ABI15_0_0RCTMultipartStreamReader {
...
- (void)emitChunk:(NSData *)data callback:(ABI15_0_0RCTMultipartCallback)callback done:(BOOL)done
{
