...
@interface ABI15_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI15_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI15_0_0RCTMultipartDataTaskCallback _partHandler;
...
{
  ABI15_0_0RCTMultipartStreamReader *reader = [[ABI15_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI15_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
