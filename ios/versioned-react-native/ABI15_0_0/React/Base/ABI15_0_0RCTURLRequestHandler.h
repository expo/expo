 ...
 */
@protocol ABI15_0_0RCTURLRequestHandler <ABI15_0_0RCTBridgeModule>
...
- (id)sendRequest:(NSURLRequest *)request
     withDelegate:(id<ABI15_0_0RCTURLRequestDelegate>)delegate;
...
/**
 * If more than one ABI15_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
