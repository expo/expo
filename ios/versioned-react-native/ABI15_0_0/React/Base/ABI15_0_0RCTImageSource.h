 ...
 */
@interface ABI15_0_0RCTImageSource : NSObject
...
@interface ABI15_0_0RCTConvert (ImageSource)

+ (ABI15_0_0RCTImageSource *)ABI15_0_0RCTImageSource:(id)json;
+ (NSArray<ABI15_0_0RCTImageSource *> *)ABI15_0_0RCTImageSourceArray:(id)json;
