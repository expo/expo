...
#import "ABI15_0_0RCTBundleURLProvider.h"

#import "ABI15_0_0RCTConvert.h"
#import "ABI15_0_0RCTDefines.h"

NSString *const ABI15_0_0RCTBundleURLProviderUpdatedNotification = @"ABI15_0_0RCTBundleURLProviderUpdatedNotification";

const NSUInteger kABI15_0_0RCTBundleURLProviderDefaultPort = 8081;

static NSString *const kABI15_0_0RCTJsLocationKey = @"ABI15_0_0RCT_jsLocation";
static NSString *const kABI15_0_0RCTEnableLiveReloadKey = @"ABI15_0_0RCT_enableLiveReload";
static NSString *const kABI15_0_0RCTEnableDevKey = @"ABI15_0_0RCT_enableDev";
static NSString *const kABI15_0_0RCTEnableMinificationKey = @"ABI15_0_0RCT_enableMinification";

@implementation ABI15_0_0RCTBundleURLProvider
...
{
  return @{
    kABI15_0_0RCTEnableLiveReloadKey: @NO,
    kABI15_0_0RCTEnableDevKey: @YES,
    kABI15_0_0RCTEnableMinificationKey: @NO,
  };
}

- (void)settingsUpdated
{
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI15_0_0RCTBundleURLProviderUpdatedNotification object:self];
}
...
static NSURL *serverRootWithHost(NSString *host)
{
  return [NSURL URLWithString:
          [NSString stringWithFormat:@"http://%@:%lu/",
           host, (unsigned long)kABI15_0_0RCTBundleURLProviderDefaultPort]];
}
...
- (BOOL)enableDev
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI15_0_0RCTEnableDevKey];
}

- (BOOL)enableLiveReload
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI15_0_0RCTEnableLiveReloadKey];
}

- (BOOL)enableMinification
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI15_0_0RCTEnableMinificationKey];
}

- (NSString *)jsLocation
{
  return [[NSUserDefaults standardUserDefaults] stringForKey:kABI15_0_0RCTJsLocationKey];
}

- (void)setEnableDev:(BOOL)enableDev
{
  [self updateValue:@(enableDev) forKey:kABI15_0_0RCTEnableDevKey];
}

- (void)setEnableLiveReload:(BOOL)enableLiveReload
{
  [self updateValue:@(enableLiveReload) forKey:kABI15_0_0RCTEnableLiveReloadKey];
}

- (void)setJsLocation:(NSString *)jsLocation
{
  [self updateValue:jsLocation forKey:kABI15_0_0RCTJsLocationKey];
}

- (void)setEnableMinification:(BOOL)enableMinification
{
  [self updateValue:@(enableMinification) forKey:kABI15_0_0RCTEnableMinificationKey];
}

+ (instancetype)sharedSettings
{
  static ABI15_0_0RCTBundleURLProvider *sharedInstance;
  static dispatch_once_t once_token;
  dispatch_once(&once_token, ^{
    sharedInstance = [ABI15_0_0RCTBundleURLProvider new];
  });
