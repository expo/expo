...
@protocol ABI15_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI15_0_0RCTBridge *)bridge;
 ...
 */
- (NSURL *)fallbackSourceURLForBridge:(ABI15_0_0RCTBridge *)bridge;

/**
 * The bridge initializes any registered ABI15_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI15_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI15_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (NSArray<Class> *)whitelistedModulesForBridge:(ABI15_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeLoadJavaScriptSynchronously:(ABI15_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeInitializeNativeModulesSynchronously:(ABI15_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI15_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI15_0_0RCTBridge *)bridge;
 ...
 */
- (void)loadSourceForBridge:(ABI15_0_0RCTBridge *)bridge
                 onProgress:(ABI15_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI15_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI15_0_0RCTBridge *)bridge
                  withBlock:(ABI15_0_0RCTSourceLoadBlock)loadCallback;
