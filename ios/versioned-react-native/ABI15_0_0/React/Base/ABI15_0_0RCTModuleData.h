...
@protocol ABI15_0_0RCTBridgeMethod;
@protocol ABI15_0_0RCTBridgeModule;
@class ABI15_0_0RCTBridge;

@interface ABI15_0_0RCTModuleData : NSObject <ABI15_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI15_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI15_0_0RCTBridgeModule> instance;
