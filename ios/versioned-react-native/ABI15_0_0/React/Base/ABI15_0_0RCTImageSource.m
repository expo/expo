...
@interface ABI15_0_0RCTImageSource ()

@property (nonatomic, assign) BOOL packagerAsset;

@end

@implementation ABI15_0_0RCTImageSource
...
{
  ABI15_0_0RCTImageSource *imageSource = [[ABI15_0_0RCTImageSource alloc] initWithURLRequest:_request
                                                                      size:size
                                                                     scale:scale];
...
- (BOOL)isEqual:(ABI15_0_0RCTImageSource *)object
{
  if (![object isKindOfClass:[ABI15_0_0RCTImageSource class]]) {
    return NO;
  }
...
{
  return [NSString stringWithFormat:@"<ABI15_0_0RCTImageSource: %p URL=%@, size=%@, scale=%0.f>",
          self, _request.URL, NSStringFromCGSize(_size), _scale];
}

@end

@implementation ABI15_0_0RCTConvert (ImageSource)
...
+ (ABI15_0_0RCTImageSource *)ABI15_0_0RCTImageSource:(id)json
{
  ...
  if ([json isKindOfClass:[NSDictionary class]]) {
    ...
    ABI15_0_0RCTLogConvertError(json, @"an image. Did you forget to call resolveAssetSource() on the JS side?");
    return nil;
  }

  ABI15_0_0RCTImageSource *imageSource = [[ABI15_0_0RCTImageSource alloc] initWithURLRequest:request
                                                                      size:size
                                                                     scale:scale];
...
ABI15_0_0RCT_ARRAY_CONVERTER(ABI15_0_0RCTImageSource)
