...
#import <ReactABI15_0_0/ABI15_0_0RCTBridgeDelegate.h>
...
@class ABI15_0_0RCTPerformanceLogger;

/**
 * This notification fires when the bridge starts loading the JS bundle.
 */
ABI15_0_0RCT_EXTERN NSString *const ABI15_0_0RCTJavaScriptWillStartLoadingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI15_0_0RCT_EXTERN NSString *const ABI15_0_0RCTJavaScriptDidLoadNotification;

/**
 * This notification fires when the bridge failed to load the JS bundle. The
 * `error` key can be used to determine the error that occured.
 */
ABI15_0_0RCT_EXTERN NSString *const ABI15_0_0RCTJavaScriptDidFailToLoadNotification;
 ...
 */
ABI15_0_0RCT_EXTERN NSString *const ABI15_0_0RCTDidInitializeModuleNotification;
 ...
 */
typedef NSArray<id<ABI15_0_0RCTBridgeModule>> *(^ABI15_0_0RCTBridgeModuleProviderBlock)(void);

/**
 * This function returns the module name for a given class.
 */
ABI15_0_0RCT_EXTERN NSString *ABI15_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI15_0_0RCTBridge : NSObject <ABI15_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI15_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI15_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 * See also -[ABI15_0_0RCTBridgeDelgate shouldBridgeLoadJavaScriptSynchronously], which
 ...
 */
@property (nonatomic, weak, readonly) id<ABI15_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ReactABI15_0_0 Native perf events.
 */
@property (nonatomic, readonly, strong) ABI15_0_0RCTPerformanceLogger *performanceLogger;
