...
#import "ABI15_0_0RCTExceptionsManager.h"
...
@implementation ABI15_0_0RCTExceptionsManager
{
  __weak id<ABI15_0_0RCTExceptionsManagerDelegate> _delegate;
}
...
ABI15_0_0RCT_EXPORT_METHOD(reportSoftException:(NSString *)message
...
ABI15_0_0RCT_EXPORT_METHOD(reportFatalException:(NSString *)message
                  stack:(NSArray<NSDictionary *> *)stack
                  exceptionId:(nonnull NSNumber *)exceptionId)
{
  [_bridge.redBox showErrorMessage:message withStack:stack];
  ...
  if (!ABI15_0_0RCT_DEBUG && reloadRetries < _maxReloadAttempts) {
    reloadRetries++;
    [_bridge reload];
  } else {
    NSString *description = [@"Unhandled JS Exception: " stringByAppendingString:message];
    NSDictionary *errorInfo = @{ NSLocalizedDescriptionKey: description, ABI15_0_0RCTJSStackTraceKey: stack };
    ABI15_0_0RCTFatal([NSError errorWithDomain:ABI15_0_0RCTErrorDomain code:0 userInfo:errorInfo]);
  }
}

ABI15_0_0RCT_EXPORT_METHOD(updateExceptionMessage:(NSString *)message
                  stack:(NSArray<NSDictionary *> *)stack
                  exceptionId:(nonnull NSNumber *)exceptionId)
{
...
ABI15_0_0RCT_EXPORT_METHOD(reportUnhandledException:(NSString *)message
                  stack:(NSArray<NSDictionary *> *)stack)
{
