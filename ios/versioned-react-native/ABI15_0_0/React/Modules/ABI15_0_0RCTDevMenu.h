 ...
 */
@interface ABI15_0_0RCTDevMenu : NSObject

/**
 * Deprecated, use ABI15_0_0RCTDevSettings instead.
 */
 ...
 */
@property (nonatomic, copy, readonly) NSArray<ABI15_0_0RCTDevMenuItem *> *presentedItems;
...
/**
 * Deprecated, use -[ABI15_0_0RCTBRidge reload] instead.
 */
...
typedef NSString *(^ABI15_0_0RCTDevMenuItemTitleBlock)(void);

/**
 * Developer menu item, used to expose additional functionality via the menu.
 */
@interface ABI15_0_0RCTDevMenuItem : NSObject
 ...
 */
+ (instancetype)buttonItemWithTitleBlock:(ABI15_0_0RCTDevMenuItemTitleBlock)titleBlock
                                 handler:(dispatch_block_t)handler;
 ...
 * ABI15_0_0RCTBridge, which is useful for any class that needs to access the menu.
 */
@interface ABI15_0_0RCTBridge (ABI15_0_0RCTDevMenu)

@property (nonatomic, readonly) ABI15_0_0RCTDevMenu *devMenu;
