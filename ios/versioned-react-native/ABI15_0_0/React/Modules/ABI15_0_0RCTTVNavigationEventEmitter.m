...
NSString *const ABI15_0_0RCTTVNavigationEventNotification = @"ABI15_0_0RCTTVNavigationEventNotification";

static NSString *const TVNavigationEventName = @"onTVNavEvent";

@implementation ABI15_0_0RCTTVNavigationEventEmitter
  ...
  if (self = [super init]) {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(handleTVNavigationEventNotification:)
                                                 name:ABI15_0_0RCTTVNavigationEventNotification
                                               object:nil];
