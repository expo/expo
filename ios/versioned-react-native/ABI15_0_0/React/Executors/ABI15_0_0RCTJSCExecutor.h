...
#import <ReactABI15_0_0/ABI15_0_0RCTJavaScriptExecutor.h>

typedef void (^ABI15_0_0RCTJavaScriptValueCallback)(JSValue *result, NSError *error);

/**
 * Default name for the JS thread
 */
ABI15_0_0RCT_EXTERN NSString *const ABI15_0_0RCTJSCThreadName;
 ...
 */
ABI15_0_0RCT_EXTERN NSString *const ABI15_0_0RCTJavaScriptContextCreatedNotification;
 ...
 *  used in ReactABI15_0_0 (or ComponenetScript). It is recommended not to access it
 ...
 */
ABI15_0_0RCT_EXTERN NSString *const ABI15_0_0RCTFBJSContextClassKey;
 ...
 */
ABI15_0_0RCT_EXTERN NSString *const ABI15_0_0RCTFBJSValueClassKey;

/**
 * @experimental
 * May be used to pre-create the JSContext to make ABI15_0_0RCTJSCExecutor creation less costly.
 * Avoid using this; it's experimental and is not likely to be supported long-term.
 */
@interface ABI15_0_0RCTJSContextProvider : NSObject
 ...
 */
@interface ABI15_0_0RCTJSCExecutor : NSObject <ABI15_0_0RCTJavaScriptExecutor>

/**
 * Returns whether executor uses custom JSC library.
 * This value is used to initialize ABI15_0_0RCTJSCWrapper.
 * @default is NO.
 */
@property (nonatomic, readonly, assign) BOOL useCustomJSCLibrary;
 ...
 * @default is "ABI15_0_0RCTJSContext"
 */
@property (nonatomic, copy) NSString *contextName;

/**
 * Inits a new executor instance with given flag that's used
 * to initialize ABI15_0_0RCTJSCWrapper.
 */
- (instancetype)initWithUseCustomJSCLibrary:(BOOL)useCustomJSCLibrary;
 ...
 * the documentation for `ABI15_0_0RCTJSContextProvider` for more information as to their
 * purpose.
 */
- (instancetype)initWithUseCustomJSCLibrary:(BOOL)useCustomJSCLibrary
                                tryBytecode:(BOOL)tryBytecode;
...
/**
 * @experimental
 * Pass a ABI15_0_0RCTJSContextProvider object to use an NSThread/JSContext pair that have already been created.
...
- (void)callFunctionOnModule:(NSString *)module
             ...
             jsValueCallback:(ABI15_0_0RCTJavaScriptValueCallback)onComplete;
