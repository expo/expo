...
/**
 ...
 - The JS exception's unsymbolicated stack trace is available via the NSError userInfo's ABI15_0_0RCTJSExceptionUnsymbolicatedStackTraceKey
 */
ABI15_0_0RCT_EXTERN NSError *ABI15_0_0RCTNSErrorFromJSError(JSValue *exception);

/**
 Translates a given exception into an NSError.

 @see ABI15_0_0RCTNSErrorFromJSError for details
 */
ABI15_0_0RCT_EXTERN NSError *ABI15_0_0RCTNSErrorFromJSErrorRef(JSValueRef exceptionRef, JSGlobalContextRef ctx);
