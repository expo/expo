...
@implementation ABI15_0_0RCTConvert(MapKit)
...
ABI15_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
{
  json = [self NSDictionary:json];
  ABI15_0_0RCTMapAnnotation *annotation = [ABI15_0_0RCTMapAnnotation new];
...
ABI15_0_0RCT_ARRAY_CONVERTER(ABI15_0_0RCTMapAnnotation)
...
+ (ABI15_0_0RCTMapOverlay *)ABI15_0_0RCTMapOverlay:(id)json
{
  ...
  ABI15_0_0RCTMapOverlay *overlay = [ABI15_0_0RCTMapOverlay polylineWithCoordinates:coordinates
...
ABI15_0_0RCT_ARRAY_CONVERTER(ABI15_0_0RCTMapOverlay)
