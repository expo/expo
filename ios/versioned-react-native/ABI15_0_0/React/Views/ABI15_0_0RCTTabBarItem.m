...
@implementation ABI15_0_0RCTConvert (UITabBarSystemItem)

ABI15_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI15_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI15_0_0ViewController;
}
