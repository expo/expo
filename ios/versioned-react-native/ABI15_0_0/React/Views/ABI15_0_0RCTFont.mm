...
// These constants can only be removed when ReactABI15_0_0 Native drops iOS8 support.
...
typedef CGFloat ABI15_0_0RCTFontWeight;
static ABI15_0_0RCTFontWeight weightOfFont(UIFont *font)
{
  ...
  ABI15_0_0RCTFontWeight weight = [traits[UIFontWeightTrait] doubleValue];
  if (weight == 0.0) {
...
static UIFont *cachedSystemFont(CGFloat size, ABI15_0_0RCTFontWeight weight)
{
...
@implementation ABI15_0_0RCTConvert (ABI15_0_0RCTFont)

+ (UIFont *)UIFont:(id)json
{
  json = [self NSDictionary:json];
  return [ABI15_0_0RCTFont updateFont:nil
                  withFamily:[ABI15_0_0RCTConvert NSString:json[@"fontFamily"]]
                        size:[ABI15_0_0RCTConvert NSNumber:json[@"fontSize"]]
                      weight:[ABI15_0_0RCTConvert NSString:json[@"fontWeight"]]
                       style:[ABI15_0_0RCTConvert NSString:json[@"fontStyle"]]
                     variant:[ABI15_0_0RCTConvert NSStringArray:json[@"fontVariant"]]
             scaleMultiplier:1];
}

ABI15_0_0RCT_ENUM_CONVERTER(ABI15_0_0RCTFontWeight, (@{
                                     @"normal": @(UIFontWeightRegular),
                                     @"bold": @(UIFontWeightBold),
...
typedef BOOL ABI15_0_0RCTFontStyle;
ABI15_0_0RCT_ENUM_CONVERTER(ABI15_0_0RCTFontStyle, (@{
                                    @"normal": @NO,
                                    @"italic": @YES,
                                    @"oblique": @YES,
                                    }), NO, boolValue)

typedef NSDictionary ABI15_0_0RCTFontVariantDescriptor;
+ (ABI15_0_0RCTFontVariantDescriptor *)ABI15_0_0RCTFontVariantDescriptor:(id)json
{
  ...
  ABI15_0_0RCTFontVariantDescriptor *value = mapping[json];
  if (ABI15_0_0RCT_DEBUG && !value && [json description].length > 0) {
    ABI15_0_0RCTLogError(@"Invalid ABI15_0_0RCTFontVariantDescriptor '%@'. should be one of: %@", json,
                [[mapping allKeys] sortedArrayUsingSelector:@selector(caseInsensitiveCompare:)]);
  }
  return value;
}

ABI15_0_0RCT_ARRAY_CONVERTER(ABI15_0_0RCTFontVariantDescriptor)

@end

@implementation ABI15_0_0RCTFont
...
+ (UIFont *)updateFont:(UIFont *)font
            withFamily:(NSString *)family
               ...
               variant:(NSArray<ABI15_0_0RCTFontVariantDescriptor *> *)variant
       scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  const ABI15_0_0RCTFontWeight defaultFontWeight = UIFontWeightRegular;
  const CGFloat defaultFontSize = 14;

  // Initialize properties to defaults
  CGFloat fontSize = defaultFontSize;
  ABI15_0_0RCTFontWeight fontWeight = defaultFontWeight;
  ...
  // Get font attributes
  fontSize = [ABI15_0_0RCTConvert CGFloat:size] ?: fontSize;
  if (scaleMultiplier > 0.0 && scaleMultiplier != 1.0) {
    fontSize = round(fontSize * scaleMultiplier);
  }
  familyName = [ABI15_0_0RCTConvert NSString:family] ?: familyName;
  isItalic = style ? [ABI15_0_0RCTConvert ABI15_0_0RCTFontStyle:style] : isItalic;
  fontWeight = weight ? [ABI15_0_0RCTConvert ABI15_0_0RCTFontWeight:weight] : fontWeight;
  ...
  if (!didFindFont && [UIFont fontNamesForFamilyName:familyName].count == 0) {
    ...
    if (font) {
      ...
      ABI15_0_0RCTLogError(@"Unrecognized font family '%@'", familyName);
      if ([UIFont respondsToSelector:@selector(systemFontOfSize:weight:)]) {
  ...
  if (variant) {
    NSArray *fontFeatures = [ABI15_0_0RCTConvert ABI15_0_0RCTFontVariantDescriptorArray:variant];
