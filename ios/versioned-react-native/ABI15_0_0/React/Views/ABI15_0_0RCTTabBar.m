...
@interface ABI15_0_0RCTTabBar() <UITabBarControllerDelegate>

@end

@implementation ABI15_0_0RCTTabBar
{
  BOOL _tabsChanged;
...
- (void)insertReactABI15_0_0Subview:(ABI15_0_0RCTTabBarItem *)subview atIndex:(NSInteger)atIndex
{
  if (![subview isKindOfClass:[ABI15_0_0RCTTabBarItem class]]) {
    ABI15_0_0RCTLogError(@"subview should be of type ABI15_0_0RCTTabBarItem");
    return;
  }
...
- (void)removeReactABI15_0_0Subview:(ABI15_0_0RCTTabBarItem *)subview
{
  if (self.ReactABI15_0_0Subviews.count == 0) {
    ABI15_0_0RCTLogError(@"should have at least one view to remove a subview");
    return;
  }
...
- (void)layoutSubviews
{
  ...
  [self ReactABI15_0_0AddControllerToClosestParent:_tabController];
...
- (void)ReactABI15_0_0BridgeDidFinishTransaction
{
  ...
  if (_tabsChanged) {
    ...
    for (ABI15_0_0RCTTabBarItem *tab in [self ReactABI15_0_0Subviews]) {
      UIViewController *controller = tab.ReactABI15_0_0ViewController;
      if (!controller) {
        controller = [[ABI15_0_0RCTWrapperViewController alloc] initWithContentView:tab];
      }
  ...
  [self.ReactABI15_0_0Subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger index, __unused BOOL *stop) {

    ABI15_0_0RCTTabBarItem *tab = (ABI15_0_0RCTTabBarItem *)view;
...
- (BOOL)tabBarController:(UITabBarController *)tabBarController shouldSelectViewController:(UIViewController *)viewController
{
  ...
  ABI15_0_0RCTTabBarItem *tab = (ABI15_0_0RCTTabBarItem *)self.ReactABI15_0_0Subviews[index];
