...
@implementation ABI15_0_0RCTModalHostView
{
  __weak ABI15_0_0RCTBridge *_bridge;
  BOOL _isPresented;
  ABI15_0_0RCTModalHostViewController *_modalViewController;
  ABI15_0_0RCTTouchHandler *_touchHandler;
  UIView *_ReactABI15_0_0Subview;
#if !TARGET_OS_TV
...
ABI15_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithCoder:coder)

- (instancetype)initWithBridge:(ABI15_0_0RCTBridge *)bridge
{
  if ((self = [super initWithFrame:CGRectZero])) {
    _bridge = bridge;
    _modalViewController = [ABI15_0_0RCTModalHostViewController new];
    UIView *containerView = [UIView new];
    containerView.autoresizingMask = UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
    _modalViewController.view = containerView;
    _touchHandler = [[ABI15_0_0RCTTouchHandler alloc] initWithBridge:bridge];
    _isPresented = NO;
...
{
  if (_ReactABI15_0_0Subview && _isPresented) {
    [_bridge.uiManager setFrame:newBounds forView:_ReactABI15_0_0Subview];
...
{
  ABI15_0_0RCTAssert(_ReactABI15_0_0Subview == nil, @"Modal view can only have one subview");
  ...
  _ReactABI15_0_0Subview = subview;
}

- (void)removeReactABI15_0_0Subview:(UIView *)subview
{
  ABI15_0_0RCTAssert(subview == _ReactABI15_0_0Subview, @"Cannot remove view other than modal view");
  [super removeReactABI15_0_0Subview:subview];
  [_touchHandler detachFromView:subview];
  _ReactABI15_0_0Subview = nil;
}

- (void)didUpdateReactABI15_0_0Subviews
{
  // Do nothing, as subview (singular) is managed by `insertReactABI15_0_0Subview:atIndex:`
}
...
- (void)didMoveToWindow
{
  ...
  if (!_isPresented && self.window) {
    ABI15_0_0RCTAssert(self.ReactABI15_0_0ViewController, @"Can't present modal view controller without a presenting view controller");
