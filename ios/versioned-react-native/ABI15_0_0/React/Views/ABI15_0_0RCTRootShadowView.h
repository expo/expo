...
@interface ABI15_0_0RCTRootShadowView : ABI15_0_0RCTShadowView

/**
 * Size flexibility type used to find size constraints.
 * Default to ABI15_0_0RCTRootViewSizeFlexibilityNone
 */
@property (nonatomic, assign) ABI15_0_0RCTRootViewSizeFlexibility sizeFlexibility;
