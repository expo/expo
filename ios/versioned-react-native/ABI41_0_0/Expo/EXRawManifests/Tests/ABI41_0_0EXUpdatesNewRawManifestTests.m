...
@interface ABI41_0_0EXUpdatesNewRawManifestTests : XCTestCase

@end

@implementation ABI41_0_0EXUpdatesNewRawManifestTests
...
- (void)testSDKVersion_ValidCases {
  ...
  ABI41_0_0EXUpdatesNewRawManifest *manifest = [[ABI41_0_0EXUpdatesNewRawManifest alloc] initWithRawManifestJSON:manifestJson];
