...
#import <ABI41_0_0EXCrypto/ABI41_0_0EXCrypto.h>
#import <CommonCrypto/CommonDigest.h>

@implementation ABI41_0_0EXCrypto

ABI41_0_0UM_EXPORT_MODULE(ExpoCrypto);

ABI41_0_0UM_EXPORT_METHOD_AS(digestStringAsync,
                    ...
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  ...
  int digestLength = [ABI41_0_0EXCrypto digestLengthForJSAlgorithm:algorithm];
  if (digestLength == -1) {
