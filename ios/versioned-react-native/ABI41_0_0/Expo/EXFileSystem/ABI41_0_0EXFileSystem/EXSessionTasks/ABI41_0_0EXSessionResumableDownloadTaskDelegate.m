...
#import <ABI41_0_0EXFileSystem/ABI41_0_0EXSessionResumableDownloadTaskDelegate.h>

@interface ABI41_0_0EXSessionResumableDownloadTaskDelegate ()

@property (strong, nonatomic, readonly) ABI41_0_0EXDownloadDelegateOnWriteCallback onWriteCallback;
@property (weak, nonatomic) ABI41_0_0EXResumablesManager *manager;
@property (strong, nonatomic) NSString *uuid;

@end

@implementation ABI41_0_0EXSessionResumableDownloadTaskDelegate
