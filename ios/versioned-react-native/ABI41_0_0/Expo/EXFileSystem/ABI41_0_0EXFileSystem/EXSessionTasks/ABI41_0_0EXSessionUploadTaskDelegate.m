...
#import <ABI41_0_0EXFileSystem/ABI41_0_0EXSessionUploadTaskDelegate.h>

@interface ABI41_0_0EXSessionUploadTaskDelegate ()

@property (strong, nonatomic) NSMutableData *responseData;

@end

@implementation ABI41_0_0EXSessionUploadTaskDelegate

- (instancetype)initWithResolve:(ABI41_0_0UMPromiseResolveBlock)resolve reject:(ABI41_0_0UMPromiseRejectBlock)reject
{
...
- (void)URLSession:(NSURLSession *)session task:(NSURLSessionTask *)task didCompleteWithError:(NSError *)error
{
  ...
  // We only set ABI41_0_0EXSessionUploadTaskDelegates as delegates of upload tasks
...
- (NSDictionary *)parseServerResponse:(NSURLResponse *)response
{
  ...
  result[@"body"] = ABI41_0_0UMNullIfNil([[NSString alloc] initWithData:_responseData encoding:NSUTF8StringEncoding]);
  return result;
}
