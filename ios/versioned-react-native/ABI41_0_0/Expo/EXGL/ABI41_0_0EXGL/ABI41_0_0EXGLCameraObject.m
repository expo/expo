...
@interface ABI41_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) id<ABI41_0_0UMCameraInterface> camera;
...
@implementation ABI41_0_0EXGLCameraObject
