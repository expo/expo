...
@interface ABI41_0_0UMViewManagerAdapterClassesRegistry ()

@property (nonatomic, strong) NSMutableDictionary<Class, Class> *viewManagerAdaptersClasses;

@end

@implementation ABI41_0_0UMViewManagerAdapterClassesRegistry
...
- (Class)_createViewManagerAdapterClassForViewManager:(ABI41_0_0UMViewManager *)viewManager
{
  ...
  Class viewManagerAdapterClass = objc_allocateClassPair([ABI41_0_0UMViewManagerAdapter class], viewManagerClassName, 0);
...
- (void)_ensureDirectEventBlockImplementationIsPresent
{
  dispatch_once(&directEventBlockImplementationOnceToken, ^{
    directEventBlockImplementation = imp_implementationWithBlock(^{
      return @[@"ABI41_0_0RCTDirectEventBlock"];
    });
  });
}
