...
#import <ABI41_0_0EXLocation/ABI41_0_0EXLocationDelegate.h>
#import <ABI41_0_0EXLocation/ABI41_0_0EXLocationTaskConsumer.h>
...
NSString * const ABI41_0_0EXLocationChangedEventName = @"Expo.locationChanged";
NSString * const ABI41_0_0EXHeadingChangedEventName = @"Expo.headingChanged";

@interface ABI41_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI41_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) NSMutableSet<ABI41_0_0EXLocationDelegate *> *retainedDelegates;
...
@property (nonatomic, weak) id<ABI41_0_0UMTaskManagerInterface> tasksManager;

@end

@implementation ABI41_0_0EXLocation

ABI41_0_0UM_EXPORT_MODULE(ExpoLocation);
...
- (void)setModuleRegistry:(ABI41_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  _tasksManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI41_0_0UMTaskManagerInterface)];
  ...
  [ABI41_0_0UMPermissionsMethodsDelegate registerRequesters:@[
    [ABI41_0_0EXLocationPermissionRequester new],
    [ABI41_0_0EXForegroundPermissionRequester new],
    [ABI41_0_0EXBackgroundLocationPermissionRequester new]
...
{
  return @[ABI41_0_0EXLocationChangedEventName, ABI41_0_0EXHeadingChangedEventName];
}
...
ABI41_0_0UM_EXPORT_METHOD_AS(getProviderStatusAsync,
...
ABI41_0_0UM_EXPORT_METHOD_AS(getCurrentPositionAsync,
                    ...
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI41_0_0EXLocationDelegate *delegate;

  delegate = [[ABI41_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (delegate != nil) {
      if (locations.lastObject != nil) {
        resolve([ABI41_0_0EXLocation exportLocation:locations.lastObject]);
      } else {
...
ABI41_0_0UM_EXPORT_METHOD_AS(watchPositionImplAsync,
                    ...
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  ...
  ABI41_0_0EXLocationDelegate *delegate = [[ABI41_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject != nil && weakSelf != nil) {
      ...
      NSDictionary *body = @{
                             @"watchId": watchId,
                             @"location": [ABI41_0_0EXLocation exportLocation:loc],
                             };

      [strongSelf->_eventEmitter sendEventWithName:ABI41_0_0EXLocationChangedEventName body:body];
    }
  } onUpdateHeadings:nil onError:^(NSError *error) {
    // TODO: report errors
...
ABI41_0_0UM_EXPORT_METHOD_AS(getLastKnownPositionAsync,
                    ...
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  ...
  if ([self.class isLocation:location validWithOptions:options]) {
    resolve([ABI41_0_0EXLocation exportLocation:location]);
  } else {
    resolve([NSNull null]);
  }
}
...
ABI41_0_0UM_EXPORT_METHOD_AS(watchDeviceHeading,
  ...
  ABI41_0_0EXLocationDelegate *delegate = [[ABI41_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
    if (newHeading != nil && weakSelf != nil) {
      ...
      [strongSelf->_eventEmitter sendEventWithName:ABI41_0_0EXHeadingChangedEventName body:body];
    }
...
ABI41_0_0UM_EXPORT_METHOD_AS(removeWatchAsync,
                    watchId:(nonnull NSNumber *)watchId
                    resolver:(ABI41_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  ABI41_0_0EXLocationDelegate *delegate = _delegates[watchId];
...
ABI41_0_0UM_EXPORT_METHOD_AS(geocodeAsync,
...
ABI41_0_0UM_EXPORT_METHOD_AS(reverseGeocodeAsync,
    ...
    if (!error) {
      ...
      for (CLPlacemark* placemark in placemarks) {
        NSDictionary *address = @{
                                  @"city": ABI41_0_0UMNullIfNil(placemark.locality),
                                  @"district": ABI41_0_0UMNullIfNil(placemark.subLocality),
                                  @"street": ABI41_0_0UMNullIfNil(placemark.thoroughfare),
                                  @"region": ABI41_0_0UMNullIfNil(placemark.administrativeArea),
                                  @"subregion": ABI41_0_0UMNullIfNil(placemark.subAdministrativeArea),
                                  @"country": ABI41_0_0UMNullIfNil(placemark.country),
                                  @"postalCode": ABI41_0_0UMNullIfNil(placemark.postalCode),
                                  @"name": ABI41_0_0UMNullIfNil(placemark.name),
                                  @"isoCountryCode": ABI41_0_0UMNullIfNil(placemark.ISOcountryCode),
                                  @"timezone": ABI41_0_0UMNullIfNil(placemark.timeZone.name),
                                  };
                    ...
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  [ABI41_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI41_0_0EXLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
...
ABI41_0_0UM_EXPORT_METHOD_AS(getForegroundPermissionsAsync,
                    getForegroundPermissionsAsync:(ABI41_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  [ABI41_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI41_0_0EXForegroundPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI41_0_0UM_EXPORT_METHOD_AS(requestForegroundPermissionsAsync,
                    requestForegroundPermissionsAsync:(ABI41_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  [ABI41_0_0UMPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI41_0_0EXForegroundPermissionRequester class]
...
ABI41_0_0UM_EXPORT_METHOD_AS(getBackgroundPermissionsAsync,
                    getBackgroundPermissionsAsync:(ABI41_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  [ABI41_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI41_0_0EXBackgroundLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI41_0_0UM_EXPORT_METHOD_AS(requestBackgroundPermissionsAsync,
                    requestBackgroundPermissionsAsync:(ABI41_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  [ABI41_0_0UMPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI41_0_0EXBackgroundLocationPermissionRequester class]
...
ABI41_0_0UM_EXPORT_METHOD_AS(hasServicesEnabledAsync,
                    hasServicesEnabled:(ABI41_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI41_0_0UMPromiseRejectBlock)reject)
{
...
ABI41_0_0UM_EXPORT_METHOD_AS(startLocationUpdatesAsync,
                    ...
                    reject:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI41_0_0EXLocationTaskConsumer class] options:options];
  }
  @catch (NSException *e) {
...
ABI41_0_0UM_EXPORT_METHOD_AS(stopLocationUpdatesAsync,
                    ...
                    reject:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI41_0_0EXLocationTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI41_0_0UM_EXPORT_METHOD_AS(hasStartedLocationUpdatesAsync,
                    ...
                    reject:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI41_0_0EXLocationTaskConsumer class]]));
}

# pragma mark - Geofencing

ABI41_0_0UM_EXPORT_METHOD_AS(startGeofencingAsync,
                    ...
                    reject:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI41_0_0EXGeofencingTaskConsumer class] options:options];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI41_0_0UM_EXPORT_METHOD_AS(stopGeofencingAsync,
                    ...
                    reject:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI41_0_0EXGeofencingTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI41_0_0UM_EXPORT_METHOD_AS(hasStartedGeofencingAsync,
                    ...
                    reject:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI41_0_0EXGeofencingTaskConsumer class]]));
}
...
- (CLLocationManager *)locationManagerWithOptions:(nullable NSDictionary *)options
{
  ...
  if (options) {
    ...
    if (options[@"accuracy"]) {
      ABI41_0_0EXLocationAccuracy accuracy = [options[@"accuracy"] unsignedIntegerValue] ?: ABI41_0_0EXLocationAccuracyBalanced;
...
- (BOOL)checkForegroundPermissions:(ABI41_0_0UMPromiseRejectBlock)reject
{
  if (![CLLocationManager locationServicesEnabled]) {
    reject(@"E_LOCATION_SERVICES_DISABLED", @"Location services are disabled", nil);
    return NO;
  }
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI41_0_0EXForegroundPermissionRequester class]]) {
...
- (BOOL)checkBackgroundPermissions:(ABI41_0_0UMPromiseRejectBlock)reject
{
  if (![CLLocationManager locationServicesEnabled]) {
    reject(@"E_LOCATION_SERVICES_DISABLED", @"Location services are disabled", nil);
    return NO;
  }
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI41_0_0EXBackgroundLocationPermissionRequester class]]) {
...
- (BOOL)checkTaskManagerExists:(ABI41_0_0UMPromiseRejectBlock)reject
{
...
- (BOOL)checkBackgroundServices:(ABI41_0_0UMPromiseRejectBlock)reject
{
...
{
  switch (accuracy) {
    case ABI41_0_0EXLocationAccuracyLowest:
      return kCLLocationAccuracyThreeKilometers;
    case ABI41_0_0EXLocationAccuracyLow:
      return kCLLocationAccuracyKilometer;
    case ABI41_0_0EXLocationAccuracyBalanced:
      return kCLLocationAccuracyHundredMeters;
    case ABI41_0_0EXLocationAccuracyHigh:
      return kCLLocationAccuracyNearestTenMeters;
    case ABI41_0_0EXLocationAccuracyHighest:
      return kCLLocationAccuracyBest;
    case ABI41_0_0EXLocationAccuracyBestForNavigation:
