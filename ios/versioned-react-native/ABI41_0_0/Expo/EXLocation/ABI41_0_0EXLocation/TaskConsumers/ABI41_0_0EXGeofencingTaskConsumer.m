...
#import <ABI41_0_0EXLocation/ABI41_0_0EXLocation.h>
#import <ABI41_0_0EXLocation/ABI41_0_0EXGeofencingTaskConsumer.h>
#import <ABI41_0_0UMTaskManagerInterface/ABI41_0_0UMTaskInterface.h>

@interface ABI41_0_0EXGeofencingTaskConsumer ()
...
@implementation ABI41_0_0EXGeofencingTaskConsumer
...
# pragma mark - ABI41_0_0UMTaskConsumerInterface
...
- (void)didRegisterTask:(id<ABI41_0_0UMTaskInterface>)task
{
...
- (void)startMonitoringRegionsForTask:(id<ABI41_0_0UMTaskInterface>)task
{
  [ABI41_0_0UMUtilities performSynchronouslyOnMainThread:^{
...
- (void)executeTaskWithRegion:(nonnull CLRegion *)region eventType:(ABI41_0_0EXGeofencingEventType)eventType
{
...
- (void)locationManager:(CLLocationManager *)manager didEnterRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != CLRegionStateInside) {
    ...
    [self executeTaskWithRegion:region eventType:ABI41_0_0EXGeofencingEventTypeEnter];
  }
}
...
- (void)locationManager:(CLLocationManager *)manager didExitRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != CLRegionStateOutside) {
    ...
    [self executeTaskWithRegion:region eventType:ABI41_0_0EXGeofencingEventTypeExit];
  }
}
...
- (void)locationManager:(CLLocationManager *)manager didDetermineState:(CLRegionState)state forRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != state) {
    ABI41_0_0EXGeofencingEventType eventType = state == CLRegionStateInside ? ABI41_0_0EXGeofencingEventTypeEnter : ABI41_0_0EXGeofencingEventTypeExit;
...
+ (ABI41_0_0EXGeofencingRegionState)exportRegionState:(CLRegionState)regionState
{
  switch (regionState) {
    case CLRegionStateUnknown:
      return ABI41_0_0EXGeofencingRegionStateUnknown;
    case CLRegionStateInside:
      return ABI41_0_0EXGeofencingRegionStateInside;
    case CLRegionStateOutside:
      return ABI41_0_0EXGeofencingRegionStateOutside;
  }
}
