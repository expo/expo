...
@implementation UIFont (ABI41_0_0EXFontLoader)

- (UIFont *)ABI41_0_0EXFontWithSize:(CGFloat)fontSize
{
  for (id<ABI41_0_0UMFontScalerInterface> fontScaler in currentFontScalers) {
  ...
  return [self ABI41_0_0EXFontWithSize:fontSize];
}
...
@implementation ABI41_0_0EXFontScalersManager

ABI41_0_0UM_REGISTER_SINGLETON_MODULE(FontScalersManager);
...
+ (void)initialize
{
  ...
  dispatch_once(&initializeCurrentFontScalersOnce, ^{
    ...
    SEL exUpdate = @selector(ABI41_0_0EXFontWithSize:);
...
- (void)registerFontScaler:(id<ABI41_0_0UMFontScalerInterface>)fontScaler
{
