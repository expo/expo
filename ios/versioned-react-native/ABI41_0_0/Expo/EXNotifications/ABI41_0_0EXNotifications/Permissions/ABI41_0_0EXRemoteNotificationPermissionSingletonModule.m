...
@interface ABI41_0_0EXRemoteNotificationPermissionSingletonModule ()

@property (nonatomic, strong) NSPointerArray *delegates;

@end

@implementation ABI41_0_0EXRemoteNotificationPermissionSingletonModule

ABI41_0_0UM_REGISTER_SINGLETON_MODULE(RemoteNotificationPermissionPublisher);
