...
ABI41_0_0UM_EXPORT_MODULE(NotificationsServerRegistrationModule)

ABI41_0_0UM_EXPORT_METHOD_AS(getInstallationIdAsync,
                    getInstallationIdAsyncWithResolver:(ABI41_0_0UMPromiseResolveBlock)resolve
...
ABI41_0_0UM_EXPORT_METHOD_AS(getRegistrationInfoAsync,
                    getRegistrationInfoAsyncWithResolver:(ABI41_0_0UMPromiseResolveBlock)resolve
                                                rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  CFTypeRef keychainResult = NULL;
...
ABI41_0_0UM_EXPORT_METHOD_AS(setRegistrationInfoAsync,
