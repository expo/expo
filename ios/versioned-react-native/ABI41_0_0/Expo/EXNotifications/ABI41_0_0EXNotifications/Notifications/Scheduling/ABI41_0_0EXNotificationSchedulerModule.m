...
@interface ABI41_0_0EXNotificationSchedulerModule ()

@property (nonatomic, weak) id<ABI41_0_0EXNotificationBuilder> builder;

@end

@implementation ABI41_0_0EXNotificationSchedulerModule

ABI41_0_0UM_EXPORT_MODULE(ExpoNotificationScheduler);

- (void)setModuleRegistry:(ABI41_0_0UMModuleRegistry *)moduleRegistry
{
  _builder = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI41_0_0EXNotificationBuilder)];
}

# pragma mark - Exported methods

ABI41_0_0UM_EXPORT_METHOD_AS(getAllScheduledNotificationsAsync,
                    getAllScheduledNotifications:(ABI41_0_0UMPromiseResolveBlock)resolve reject:(ABI41_0_0UMPromiseRejectBlock)reject
                    )
{
...
ABI41_0_0UM_EXPORT_METHOD_AS(scheduleNotificationAsync,
                     scheduleNotification:(NSString *)identifier notificationSpec:(NSDictionary *)notificationSpec triggerSpec:(NSDictionary *)triggerSpec resolve:(ABI41_0_0UMPromiseResolveBlock)resolve rejecting:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  @try {
...
ABI41_0_0UM_EXPORT_METHOD_AS(cancelScheduledNotificationAsync,
                     cancelNotification:(NSString *)identifier resolve:(ABI41_0_0UMPromiseResolveBlock)resolve rejecting:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  [[UNUserNotificationCenter currentNotificationCenter] removePendingNotificationRequestsWithIdentifiers:@[identifier]];
  resolve(nil);
}

ABI41_0_0UM_EXPORT_METHOD_AS(cancelAllScheduledNotificationsAsync,
                     cancelAllNotificationsWithResolver:(ABI41_0_0UMPromiseResolveBlock)resolve rejecting:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  [[UNUserNotificationCenter currentNotificationCenter] removeAllPendingNotificationRequests];
  resolve(nil);
}

ABI41_0_0UM_EXPORT_METHOD_AS(getNextTriggerDateAsync,
                    getNextTriggerDate:(NSDictionary *)triggerSpec resolve:(ABI41_0_0UMPromiseResolveBlock)resolve rejecting:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  @try {
...
- (NSArray * _Nonnull)serializeNotificationRequests:(NSArray<UNNotificationRequest *> * _Nonnull) requests
{
  ...
  for (UNNotificationRequest *request in requests) {
    [serializedRequests addObject:[ABI41_0_0EXNotificationSerializer serializedNotificationRequest:request]];
  }
