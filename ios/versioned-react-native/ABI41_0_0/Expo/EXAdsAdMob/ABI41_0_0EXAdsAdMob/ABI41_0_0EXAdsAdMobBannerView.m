...
@implementation ABI41_0_0EXAdsAdMobBannerView {
...
- (void)setOnSizeChange:(ABI41_0_0UMDirectEventBlock)block
{
  _onSizeChange = block;
  [self loadBanner];
}

- (void)setOnDidFailToReceiveAdWithError:(ABI41_0_0UMDirectEventBlock)block
{
