...
@implementation ABI41_0_0EXImagePickerCameraPermissionRequester
...
- (NSDictionary *)getPermissions
{
  ...
  if (!(cameraUsageDescription && microphoneUsageDescription)) {
    ABI41_0_0UMFatal(ABI41_0_0UMErrorWithMessage(@"This app is missing either 'NSCameraUsageDescription' or 'NSMicrophoneUsageDescription', so audio/video services will fail. Ensure both of these keys exist in app's Info.plist."));
