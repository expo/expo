//
//  ABI41_0_0EXFaceDetectorUtils.m
//  Exponent
//
...
NSString *const ABI41_0_0EXGMVDataOutputWidthKey = @"Width";
NSString *const ABI41_0_0EXGMVDataOutputHeightKey = @"Height";
...
@implementation ABI41_0_0EXFaceDetectorUtils
...
+ (ABI41_0_0EXFaceDetectionAngleTransformBlock)angleTransformerFromTransform:(CGAffineTransform)transform
{
  return ^(float angle) {
