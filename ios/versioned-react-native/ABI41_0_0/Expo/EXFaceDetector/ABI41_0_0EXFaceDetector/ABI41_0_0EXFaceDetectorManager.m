//
//  ABI41_0_0EXFaceDetectorManager.m
//  Exponent
//
...
@interface ABI41_0_0EXFaceDetectorManager() <AVCaptureVideoDataOutputSampleBufferDelegate>
...
@property ABI41_0_0EXFaceDetector *faceDetector;
@property NSInteger timeIntervalMillis;

@end

@implementation ABI41_0_0EXFaceDetectorManager

- (instancetype)init
{
  return [self initWithOptions:[ABI41_0_0EXFaceDetectorUtils defaultFaceDetectorOptions]];
}
...
- (instancetype)initWithOptions:(NSDictionary*)options
{
  if (self = [super init]) {
    ...
    _faceDetectorOptions = [ABI41_0_0EXFaceDetectorUtils mapOptions:options];
...
{
  MLKFaceDetectorOptions* newOptions = [ABI41_0_0EXFaceDetectorUtils newOptions:self.faceDetectorOptions withValues:settings];
  if(![ABI41_0_0EXFaceDetectorUtils areOptionsEqual:newOptions to:self.faceDetectorOptions])
  {
...
- (void)tryEnablingFaceDetection
{
  ...
  if ([self isDetectingFaceEnabled]) {
    @try {
      self.faceDetector = [[ABI41_0_0EXFaceDetector alloc] initWithOptions:_faceDetectorOptions];
      ...
      if([_session canAddOutput:output]) {
        ...
        ABI41_0_0UMLogError(@"Unable to add output to camera session! Face detection aborted!");
      }
    } @catch (NSException *exception) {
      ABI41_0_0UMLogWarn(@"%@", [exception description]);
    }
  }
...
- (void)_notifyOfFaces:(NSArray<MLKFace *> *)faces
           withEncoder:(ABI41_0_0EXFaceEncoder*)encoder
{
       ...
       fromConnection:(AVCaptureConnection *)connection
{
  ...
  if (timePassedMillis > self.timeIntervalMillis) {
    ...
    ABI41_0_0EXFaceDetectionAngleTransformBlock angleTransform = ^(float angle) { return -angle; };

    CGAffineTransform transformation = [ABI41_0_0EXCSBufferOrientationCalculator pointTransformForInterfaceOrientation:_interfaceOrientation
    ...
    UIImageOrientation orientation = [ABI41_0_0EXFaceDetectorManager imageOrientationFrom:_interfaceOrientation
                                                                     andMirrored:_mirroredImageSession];
    ...
    [_faceDetector detectFromBuffer:sampleBuffer
      ...
      if (error != nil) {
        ...
        [self _notifyOfFaces:faces
                 withEncoder:[[ABI41_0_0EXFaceEncoder alloc] initWithTransform:transformation
