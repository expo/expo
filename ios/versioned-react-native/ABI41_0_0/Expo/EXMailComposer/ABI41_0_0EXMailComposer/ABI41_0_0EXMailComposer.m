...
#import <ABI41_0_0EXMailComposer/ABI41_0_0EXMailComposer.h>
...
@interface ABI41_0_0EXMailComposer ()
...
@implementation ABI41_0_0EXMailComposer

ABI41_0_0UM_EXPORT_MODULE(ExpoMailComposer);
...
ABI41_0_0UM_EXPORT_METHOD_AS(composeAsync,
                    ...
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  ...
  self.reject = reject;
  id<ABI41_0_0UMUtilitiesInterface> utilities = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI41_0_0UMUtilitiesInterface)];
