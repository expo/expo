...
@interface ABI41_0_0EXAppAuthSessionsManager ()

@property (nonatomic, strong) NSMutableSet<id<OIDExternalUserAgentSession>> *currentAuthorizationFlows;

@end

@implementation ABI41_0_0EXAppAuthSessionsManager

ABI41_0_0UM_REGISTER_SINGLETON_MODULE(AppAuthSessionsManager)
