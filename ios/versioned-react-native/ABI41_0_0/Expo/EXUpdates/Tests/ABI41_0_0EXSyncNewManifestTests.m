...
@interface ABI41_0_0EXSyncNewManifestTests : XCTestCase
...
@implementation ABI41_0_0EXSyncNewManifestTests
...
- (void)testUpdateWithNewManifest_AllFields
{
  ...
  XCTAssert([ABI41_0_0EXSyncNewManifest updateWithNewManifest:manifest response:nil config:_config database:_database] != nil);
}
...
- (void)testUpdateWithNewManifest_NoRuntimeVersion
{
  ...
  XCTAssertThrows([ABI41_0_0EXSyncNewManifest updateWithNewManifest:manifest response:nil config:_config database:_database]);
}
...
- (void)testUpdateWithNewManifest_StripsOptionalRootLevelKeys
{
  ...
  ABI41_0_0EXSyncManifest *update1 = [ABI41_0_0EXSyncNewManifest updateWithNewManifest:manifestNoRootLevelKeys response:nil config:_config database:_database];
  ABI41_0_0EXSyncManifest *update2 = [ABI41_0_0EXSyncNewManifest updateWithNewManifest:manifestWithRootLevelKeys response:nil config:_config database:_database];
...
- (void)testDictionaryWithStructuredHeader_SupportedTypes
{
  ...
  NSDictionary *actual = [ABI41_0_0EXSyncNewManifest dictionaryWithStructuredHeader:header];
...
- (void)testDictionaryWithStructuredHeader_ParsingError
{
  ...
  XCTAssertNil([ABI41_0_0EXSyncNewManifest dictionaryWithStructuredHeader:header]);
}
