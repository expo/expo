...
#import <ABI41_0_0EXUpdates/ABI41_0_0EXSyncDatabaseInitialization+Tests.h>
#import <ABI41_0_0EXUpdates/ABI41_0_0EXSyncDatabaseUtils.h>

#import <sqlite3.h>

static NSString * const ABI41_0_0EXSyncDatabaseV4Schema = @"\
...
@interface ABI41_0_0EXSyncDatabaseInitializationTests : XCTestCase

@property (nonatomic, strong) NSURL *testDatabaseDir;

@end

@implementation ABI41_0_0EXSyncDatabaseInitializationTests
...
- (void)setUp
{
  ...
  _testDatabaseDir = [applicationSupportDir URLByAppendingPathComponent:@"ABI41_0_0EXSyncDatabaseTests"];
...
- (void)testDatabasePersistence
{
  ...
  [ABI41_0_0EXSyncDatabaseInitialization initializeDatabaseWithLatestSchemaInDirectory:_testDatabaseDir
                                                                        database:&db
  ...
  NSError *insertError;
  [ABI41_0_0EXSyncDatabaseUtils executeSql:insertSql withArgs:nil onDatabase:db error:&insertError];
  ...
  NSArray<NSDictionary *> *rows = [ABI41_0_0EXSyncDatabaseUtils executeSql:selectSql withArgs:nil onDatabase:newDb error:nil];
...
- (void)testMigration4To5
{
  sqlite3 *db;
  NSError *initializeError;
  [ABI41_0_0EXSyncDatabaseInitialization initializeDatabaseWithSchema:ABI41_0_0EXSyncDatabaseV4Schema
                                                       filename:@"expo-v4.db"
  ...
  [ABI41_0_0EXSyncDatabaseUtils executeSql:insertAssetsSql withArgs:nil onDatabase:db error:&insertAssetsError];
  NSError *insertUpdatesError;
  [ABI41_0_0EXSyncDatabaseUtils executeSql:insertUpdatesSql withArgs:nil onDatabase:db error:&insertUpdatesError];
  NSError *insertUpdatesAssetsError;
  [ABI41_0_0EXSyncDatabaseUtils executeSql:insertUpdatesAssetsSql withArgs:nil onDatabase:db error:&insertUpdatesAssetsError];
  ...
  XCTAssertEqual(1, [ABI41_0_0EXSyncDatabaseUtils executeSql:updatesSql1 withArgs:nil onDatabase:migratedDb error:nil].count);
  NSString * const updatesSql2 = @"SELECT * FROM `updates` WHERE `id` = X'594100ea066e4804b5c7c907c773f980'";
  XCTAssertEqual(1, [ABI41_0_0EXSyncDatabaseUtils executeSql:updatesSql2 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI41_0_0EXSyncDatabaseUtils executeSql:assetsSql1 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI41_0_0EXSyncDatabaseUtils executeSql:assetsSql2 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI41_0_0EXSyncDatabaseUtils executeSql:assetsSql3 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI41_0_0EXSyncDatabaseUtils executeSql:updatesAssetsSql1 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI41_0_0EXSyncDatabaseUtils executeSql:updatesAssetsSql2 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI41_0_0EXSyncDatabaseUtils executeSql:updatesAssetsSql3 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  [ABI41_0_0EXSyncDatabaseUtils executeSql:nullInsertSql withArgs:nil onDatabase:migratedDb error:&nullInsertError];
  ...
  [ABI41_0_0EXSyncDatabaseUtils executeSql:foreignKeyInsertSql withArgs:nil onDatabase:migratedDb error:nil];
  XCTAssertEqual(1, [ABI41_0_0EXSyncDatabaseUtils executeSql:foreignKeySelectSql withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  [ABI41_0_0EXSyncDatabaseUtils executeSql:foreignKeyInsertBadSql withArgs:nil onDatabase:migratedDb error:&foreignKeyError];
  ...
  [ABI41_0_0EXSyncDatabaseUtils executeSql:deleteSql withArgs:nil onDatabase:migratedDb error:nil];
  XCTAssertEqual(0, [ABI41_0_0EXSyncDatabaseUtils executeSql:selectDeletedSql withArgs:nil onDatabase:migratedDb error:nil].count);
}
