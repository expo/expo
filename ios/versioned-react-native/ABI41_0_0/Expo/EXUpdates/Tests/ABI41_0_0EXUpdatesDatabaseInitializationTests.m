...
#import <ABI41_0_0EXUpdates/ABI41_0_0EXUpdatesDatabaseInitialization+Tests.h>
#import <ABI41_0_0EXUpdates/ABI41_0_0EXUpdatesDatabaseUtils.h>

#import <sqlite3.h>

static NSString * const ABI41_0_0EXUpdatesDatabaseV4Schema = @"\
...
@interface ABI41_0_0EXUpdatesDatabaseInitializationTests : XCTestCase

@property (nonatomic, strong) NSURL *testDatabaseDir;

@end

@implementation ABI41_0_0EXUpdatesDatabaseInitializationTests
...
- (void)testDatabasePersistence
{
  ...
  [ABI41_0_0EXUpdatesDatabaseInitialization initializeDatabaseWithLatestSchemaInDirectory:_testDatabaseDir
                                                                        database:&db
  ...
  NSError *insertError;
  [ABI41_0_0EXUpdatesDatabaseUtils executeSql:insertSql withArgs:nil onDatabase:db error:&insertError];
  ...
  NSArray<NSDictionary *> *rows = [ABI41_0_0EXUpdatesDatabaseUtils executeSql:selectSql withArgs:nil onDatabase:newDb error:nil];
...
- (void)testMigration4To5
{
  sqlite3 *db;
  NSError *initializeError;
  [ABI41_0_0EXUpdatesDatabaseInitialization initializeDatabaseWithSchema:ABI41_0_0EXUpdatesDatabaseV4Schema
                                                       filename:@"expo-v4.db"
  ...
  [ABI41_0_0EXUpdatesDatabaseUtils executeSql:insertAssetsSql withArgs:nil onDatabase:db error:&insertAssetsError];
  NSError *insertUpdatesError;
  [ABI41_0_0EXUpdatesDatabaseUtils executeSql:insertUpdatesSql withArgs:nil onDatabase:db error:&insertUpdatesError];
  NSError *insertUpdatesAssetsError;
  [ABI41_0_0EXUpdatesDatabaseUtils executeSql:insertUpdatesAssetsSql withArgs:nil onDatabase:db error:&insertUpdatesAssetsError];
  ...
  XCTAssertEqual(1, [ABI41_0_0EXUpdatesDatabaseUtils executeSql:updatesSql1 withArgs:nil onDatabase:migratedDb error:nil].count);
  NSString * const updatesSql2 = @"SELECT * FROM `updates` WHERE `id` = X'594100ea066e4804b5c7c907c773f980'";
  XCTAssertEqual(1, [ABI41_0_0EXUpdatesDatabaseUtils executeSql:updatesSql2 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI41_0_0EXUpdatesDatabaseUtils executeSql:assetsSql1 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI41_0_0EXUpdatesDatabaseUtils executeSql:assetsSql2 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI41_0_0EXUpdatesDatabaseUtils executeSql:assetsSql3 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI41_0_0EXUpdatesDatabaseUtils executeSql:updatesAssetsSql1 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI41_0_0EXUpdatesDatabaseUtils executeSql:updatesAssetsSql2 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  XCTAssertEqual(1, [ABI41_0_0EXUpdatesDatabaseUtils executeSql:updatesAssetsSql3 withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  [ABI41_0_0EXUpdatesDatabaseUtils executeSql:nullInsertSql withArgs:nil onDatabase:migratedDb error:&nullInsertError];
  ...
  [ABI41_0_0EXUpdatesDatabaseUtils executeSql:foreignKeyInsertSql withArgs:nil onDatabase:migratedDb error:nil];
  XCTAssertEqual(1, [ABI41_0_0EXUpdatesDatabaseUtils executeSql:foreignKeySelectSql withArgs:nil onDatabase:migratedDb error:nil].count);
  ...
  [ABI41_0_0EXUpdatesDatabaseUtils executeSql:foreignKeyInsertBadSql withArgs:nil onDatabase:migratedDb error:&foreignKeyError];
  ...
  [ABI41_0_0EXUpdatesDatabaseUtils executeSql:deleteSql withArgs:nil onDatabase:migratedDb error:nil];
  XCTAssertEqual(0, [ABI41_0_0EXUpdatesDatabaseUtils executeSql:selectDeletedSql withArgs:nil onDatabase:migratedDb error:nil].count);
}
