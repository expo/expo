...
#import <ABI41_0_0EXUpdates/ABI41_0_0EXSyncDatabase+Tests.h>
#import <ABI41_0_0EXUpdates/ABI41_0_0EXSyncNewManifest.h>

@interface ABI41_0_0EXSyncDatabaseTests : XCTestCase

@property (nonatomic, strong) ABI41_0_0EXSyncDatabase *db;
...
@implementation ABI41_0_0EXSyncDatabaseTests
...
- (void)setUp
{
  ...
  _db = [[ABI41_0_0EXSyncDatabase alloc] init];
...
- (void)testForeignKeys
{
  ...
  ABI41_0_0EXSyncManifest *update = [ABI41_0_0EXSyncNewManifest updateWithNewManifest:_manifest response:nil config:_config database:_db];
  dispatch_sync(_db.databaseQueue, ^{
...
- (void)testSetMetadata_OverwriteAllFields
{
  ...
  ABI41_0_0EXSyncManifest *update1 = [ABI41_0_0EXSyncNewManifest updateWithNewManifest:_manifest response:response1 config:_config database:_db];
  ...
  ABI41_0_0EXSyncManifest *update2 = [ABI41_0_0EXSyncNewManifest updateWithNewManifest:_manifest response:response2 config:_config database:_db];
