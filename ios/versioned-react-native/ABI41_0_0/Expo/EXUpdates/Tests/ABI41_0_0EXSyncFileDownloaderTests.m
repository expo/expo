...
@interface ABI41_0_0EXSyncFileDownloaderTests : XCTestCase

@end

@implementation ABI41_0_0EXSyncFileDownloaderTests
...
{
  ABI41_0_0EXSyncConfig *config = [ABI41_0_0EXSyncConfig configWithDictionary:@{
    @"ABI41_0_0EXSyncURL": @"https://exp.host/@test/test",
    @"ABI41_0_0EXSyncRuntimeVersion": @"1.0",
    @"ABI41_0_0EXSyncUsesLegacyManifest": @(YES)
  }];
  ABI41_0_0EXSyncFileDownloader *downloader = [[ABI41_0_0EXSyncFileDownloader alloc] initWithUpdatesConfig:config];
...
{
  ABI41_0_0EXSyncConfig *config = [ABI41_0_0EXSyncConfig configWithDictionary:@{
    @"ABI41_0_0EXSyncURL": @"https://exp.host/manifest/00000000-0000-0000-0000-000000000000",
    @"ABI41_0_0EXSyncRuntimeVersion": @"1.0",
