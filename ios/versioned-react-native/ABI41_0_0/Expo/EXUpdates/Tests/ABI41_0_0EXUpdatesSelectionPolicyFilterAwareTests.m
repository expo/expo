...
@interface ABI41_0_0EXUpdatesSelectionPolicyFilterAwareTests : XCTestCase

@property (nonatomic, strong) ABI41_0_0EXUpdatesUpdate *updateDefault1;
@property (nonatomic, strong) ABI41_0_0EXUpdatesUpdate *updateDefault2;
@property (nonatomic, strong) ABI41_0_0EXUpdatesUpdate *updateRollout0;
@property (nonatomic, strong) ABI41_0_0EXUpdatesUpdate *updateRollout1;
@property (nonatomic, strong) ABI41_0_0EXUpdatesUpdate *updateRollout2;
@property (nonatomic, strong) ABI41_0_0EXUpdatesUpdate *updateMultipleFilters;
@property (nonatomic, strong) ABI41_0_0EXUpdatesUpdate *updateNoMetadata;
@property (nonatomic, strong) ABI41_0_0EXUpdatesSelectionPolicyFilterAware *selectionPolicy;
@property (nonatomic, strong) NSDictionary *manifestFilters;

@end

@implementation ABI41_0_0EXUpdatesSelectionPolicyFilterAwareTests
...
- (void)setUp
{
  ...
  _updateRollout0 = [ABI41_0_0EXUpdatesNewUpdate updateWithNewManifest:@{
  ...
  _updateDefault1 = [ABI41_0_0EXUpdatesNewUpdate updateWithNewManifest:@{
  ...
  _updateRollout1 = [ABI41_0_0EXUpdatesNewUpdate updateWithNewManifest:@{
  ...
  _updateDefault2 = [ABI41_0_0EXUpdatesNewUpdate updateWithNewManifest:@{
  ...
  _updateRollout2 = [ABI41_0_0EXUpdatesNewUpdate updateWithNewManifest:@{
  ...
  _updateMultipleFilters = [ABI41_0_0EXUpdatesNewUpdate updateWithNewManifest:@{
    @"id": @"079cde35-8433-4c17-81c8-7117c1513e72",
    @"createdAt": @"2021-01-11T19:39:22.480Z",
    @"runtimeVersion": @"1.0",
    @"launchAsset": launchAsset,
  ...
  _updateNoMetadata = [ABI41_0_0EXUpdatesNewUpdate updateWithNewManifest:@{
    @"id": @"079cde35-8433-4c17-81c8-7117c1513e72",
    @"createdAt": @"2021-01-11T19:39:22.480Z",
    @"runtimeVersion": @"1.0",
    @"launchAsset": launchAsset,
  ...
  _selectionPolicy = [[ABI41_0_0EXUpdatesSelectionPolicyFilterAware alloc] initWithRuntimeVersion:runtimeVersion];
...
{
  ABI41_0_0EXUpdatesUpdate *actual = [_selectionPolicy launchableUpdateWithUpdates:@[_updateDefault1, _updateRollout1, _updateDefault2] filters:_manifestFilters];
...
{
  NSArray<ABI41_0_0EXUpdatesUpdate *> *actual = [_selectionPolicy updatesToDeleteWithLaunchedUpdate:_updateRollout2 updates:@[_updateRollout0, _updateDefault1, _updateRollout1, _updateDefault2, _updateRollout2] filters:_manifestFilters];
...
{
  NSArray<ABI41_0_0EXUpdatesUpdate *> *actual = [_selectionPolicy updatesToDeleteWithLaunchedUpdate:_updateRollout2 updates:@[_updateDefault1, _updateDefault2, _updateRollout2] filters:_manifestFilters];
...
- (void)testDoesUpdateMatchFilters_MultipleFilters
{
  ...
  XCTAssertFalse([ABI41_0_0EXUpdatesSelectionPolicyFilterAware doesUpdate:_updateMultipleFilters matchFilters:filtersBadMatch], @"should fail unless all filters pass");

  NSDictionary *filtersGoodMatch = @{
    @"firstkey": @"value1",
    @"secondkey": @"value2"
  };
  XCTAssertTrue([ABI41_0_0EXUpdatesSelectionPolicyFilterAware doesUpdate:_updateMultipleFilters matchFilters:filtersGoodMatch], @"should pass if all filters pass");
}

- (void)testDoesUpdateMatchFilters_EmptyMatchesAll
{
  XCTAssertTrue([ABI41_0_0EXUpdatesSelectionPolicyFilterAware doesUpdate:_updateDefault1 matchFilters:@{@"field-that-update-doesnt-have": @"value"}], @"no field counts as a match");
}
...
- (void)testDoesUpdateMatchFilters_Null
{
  ...
  XCTAssertTrue([ABI41_0_0EXUpdatesSelectionPolicyFilterAware doesUpdate:_updateDefault1 matchFilters:nil]);
  XCTAssertTrue([ABI41_0_0EXUpdatesSelectionPolicyFilterAware doesUpdate:_updateNoMetadata matchFilters:_manifestFilters]);
}
