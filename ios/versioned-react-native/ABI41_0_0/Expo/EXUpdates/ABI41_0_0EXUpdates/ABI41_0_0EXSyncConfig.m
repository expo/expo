...
@interface ABI41_0_0EXSyncConfig ()
...
@property (nonatomic, readwrite, assign) ABI41_0_0EXSyncCheckAutomaticallyConfig checkOnLaunch;
...
static NSString * const ABI41_0_0EXSyncDefaultReleaseChannelName = @"default";

static NSString * const ABI41_0_0EXSyncConfigEnabledKey = @"ABI41_0_0EXSyncEnabled";
static NSString * const ABI41_0_0EXSyncConfigScopeKeyKey = @"ABI41_0_0EXSyncScopeKey";
static NSString * const ABI41_0_0EXSyncConfigManifestUrlKey = @"ABI41_0_0EXSyncURL";
static NSString * const ABI41_0_0EXSyncConfigRequestHeadersKey = @"ABI41_0_0EXSyncRequestHeaders";
static NSString * const ABI41_0_0EXSyncConfigReleaseChannelKey = @"ABI41_0_0EXSyncReleaseChannel";
static NSString * const ABI41_0_0EXSyncConfigLaunchWaitMsKey = @"ABI41_0_0EXSyncLaunchWaitMs";
static NSString * const ABI41_0_0EXSyncConfigCheckOnLaunchKey = @"ABI41_0_0EXSyncCheckOnLaunch";
static NSString * const ABI41_0_0EXSyncConfigSDKVersionKey = @"ABI41_0_0EXSyncSDKVersion";
static NSString * const ABI41_0_0EXSyncConfigRuntimeVersionKey = @"ABI41_0_0EXSyncRuntimeVersion";
static NSString * const ABI41_0_0EXSyncConfigUsesLegacyManifestKey = @"ABI41_0_0EXSyncUsesLegacyManifest";
static NSString * const ABI41_0_0EXSyncConfigHasEmbeddedManifestKey = @"ABI41_0_0EXSyncHasEmbeddedManifest";

static NSString * const ABI41_0_0EXSyncConfigAlwaysString = @"ALWAYS";
static NSString * const ABI41_0_0EXSyncConfigWifiOnlyString = @"WIFI_ONLY";
static NSString * const ABI41_0_0EXSyncConfigNeverString = @"NEVER";

@implementation ABI41_0_0EXSyncConfig
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _requestHeaders = @{};
    _releaseChannel = ABI41_0_0EXSyncDefaultReleaseChannelName;
    _launchWaitMs = @(0);
    _checkOnLaunch = ABI41_0_0EXSyncCheckAutomaticallyConfigAlways;
...
{
  ABI41_0_0EXSyncConfig *updatesConfig = [[ABI41_0_0EXSyncConfig alloc] init];
...
{
  id isEnabled = config[ABI41_0_0EXSyncConfigEnabledKey];
  if (isEnabled && [isEnabled isKindOfClass:[NSNumber class]]) {
    _isEnabled = [(NSNumber *)isEnabled boolValue];
  }
  
  id expectsSignedManifest = config[@"ABI41_0_0EXSyncExpectsSignedManifest"];
  ...
  id updateUrl = config[ABI41_0_0EXSyncConfigManifestUrlKey];
  if (updateUrl && [updateUrl isKindOfClass:[NSString class]]) {
    NSURL *url = [NSURL URLWithString:(NSString *)updateUrl];
    _updateUrl = url;
  }

  id scopeKey = config[ABI41_0_0EXSyncConfigScopeKeyKey];
  ...
  id checkOnLaunch = config[ABI41_0_0EXSyncConfigCheckOnLaunchKey];
  if (checkOnLaunch && [checkOnLaunch isKindOfClass:[NSString class]]) {
    if ([ABI41_0_0EXSyncConfigNeverString isEqualToString:(NSString *)checkOnLaunch]) {
      _checkOnLaunch = ABI41_0_0EXSyncCheckAutomaticallyConfigNever;
    } else if ([ABI41_0_0EXSyncConfigWifiOnlyString isEqualToString:(NSString *)checkOnLaunch]) {
      _checkOnLaunch = ABI41_0_0EXSyncCheckAutomaticallyConfigWifiOnly;
    } else if ([ABI41_0_0EXSyncConfigAlwaysString isEqualToString:(NSString *)checkOnLaunch]) {
      _checkOnLaunch = ABI41_0_0EXSyncCheckAutomaticallyConfigAlways;
    }
  }

  id sdkVersion = config[ABI41_0_0EXSyncConfigSDKVersionKey];
  if (sdkVersion && [sdkVersion isKindOfClass:[NSString class]]) {
    _sdkVersion = (NSString *)sdkVersion;
  }

  id runtimeVersion = config[ABI41_0_0EXSyncConfigRuntimeVersionKey];
  if (runtimeVersion && [runtimeVersion isKindOfClass:[NSString class]]) {
    _runtimeVersion = (NSString *)runtimeVersion;
  }

  id usesLegacyManifest = config[ABI41_0_0EXSyncConfigUsesLegacyManifestKey];
  ...
  id hasEmbeddedUpdate = config[ABI41_0_0EXSyncConfigHasEmbeddedManifestKey];
