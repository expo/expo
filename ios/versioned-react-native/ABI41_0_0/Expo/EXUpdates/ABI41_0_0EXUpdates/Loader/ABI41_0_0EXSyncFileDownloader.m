...
#import <ABI41_0_0EXUpdates/ABI41_0_0EXSyncCrypto.h>
...
NSString * const ABI41_0_0EXSyncFileDownloaderErrorDomain = @"ABI41_0_0EXSyncFileDownloader";
NSTimeInterval const ABI41_0_0EXSyncDefaultTimeoutInterval = 60;

@interface ABI41_0_0EXSyncFileDownloader () <NSURLSessionDataDelegate>
...
@implementation ABI41_0_0EXSyncFileDownloader
                 ...
                 errorBlock:(ABI41_0_0EXSyncFileDownloaderErrorBlock)errorBlock
{
  [self downloadDataFromURL:url successBlock:^(NSData *data, NSURLResponse *response) {
    ...
    if ([data writeToFile:destinationPath options:NSDataWritingAtomic error:&error]) {
      ...
      errorBlock([NSError errorWithDomain:ABI41_0_0EXSyncFileDownloaderErrorDomain
                                     code:1002
                                 userInfo:@{
...
- (NSURLRequest *)createManifestRequestWithURL:(NSURL *)url extraHeaders:(nullable NSDictionary *)extraHeaders
{
  ...
  NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url cachePolicy:cachePolicy timeoutInterval:ABI41_0_0EXSyncDefaultTimeoutInterval];
                     ...
                     errorBlock:(ABI41_0_0EXSyncFileDownloaderErrorBlock)errorBlock
{
  ...
  [self _downloadDataWithRequest:request successBlock:^(NSData *data, NSURLResponse *response) {
    ...
    if (signature != nil && !isUnsignedFromXDL) {
      ...
      [ABI41_0_0EXSyncCrypto verifySignatureWithData:(NSString *)manifestString
                                  ...
                                  successBlock:^(BOOL isValid) {
                                                  if (isValid) {
                                                    ...
                                                    NSError *error = [NSError errorWithDomain:ABI41_0_0EXSyncFileDownloaderErrorDomain code:1003 userInfo:@{NSLocalizedDescriptionKey: @"Manifest verification failed"}];
                       ...
                       errorBlock:(ABI41_0_0EXSyncFileDownloaderErrorBlock)errorBlock
{
  ...
  ABI41_0_0EXSyncManifest *update = [ABI41_0_0EXSyncManifest updateWithManifest:mutableManifest.copy
                                                       response:response
                                                         config:_config
                                                       database:database];
  if (![ABI41_0_0EXSyncSelectionPolicyFilterAware doesUpdate:update matchFilters:update.manifestFilters]) {
    NSError *error = [NSError errorWithDomain:ABI41_0_0EXSyncFileDownloaderErrorDomain
                                         code:1021
...
- (nullable NSDictionary *)_extractUpdateResponseDictionary:(id)parsedJson error:(NSError **)error
{
  ...
  if (error) {
    *error = [NSError errorWithDomain:ABI41_0_0EXSyncFileDownloaderErrorDomain code:1009 userInfo:@{NSLocalizedDescriptionKey: [NSString stringWithFormat:@"No compatible update found at %@. Only %@ are supported.", _config.updateUrl.absoluteString, _config.sdkVersion]}];
  }
  return nil;
}
...
- (void)_setManifestHTTPHeaderFields:(NSMutableURLRequest *)request withExtraHeaders:(nullable NSDictionary *)extraHeaders
{
  ...
  NSString *previousFatalError = [ABI41_0_0EXSyncLauncherNoDatabase consumeError];
...
- (NSError *)_errorFromResponse:(NSHTTPURLResponse *)response body:(NSString *)body
{
  ...
  return [NSError errorWithDomain:ABI41_0_0EXSyncFileDownloaderErrorDomain code:response.statusCode userInfo:userInfo];
}
