...
@interface ABI41_0_0EXSyncRemoteLoader ()

@property (nonatomic, strong) ABI41_0_0EXSyncFileDownloader *downloader;
@property (nonatomic, strong) ABI41_0_0EXSyncManifest *remoteUpdate;

@property (nonatomic, strong) dispatch_queue_t completionQueue;

@end
static NSString * const ABI41_0_0EXSyncRemoteLoaderErrorDomain = @"ABI41_0_0EXSyncRemoteLoader";

@implementation ABI41_0_0EXSyncRemoteLoader
               ...
               completionQueue:(dispatch_queue_t)completionQueue
{
  if (self = [super initWithConfig:config database:database directory:directory completionQueue:completionQueue]) {
    _downloader = [[ABI41_0_0EXSyncFileDownloader alloc] initWithUpdatesConfig:self.config];
                    ...
                    error:(ABI41_0_0EXSyncLoaderErrorBlock)error
{
  ...
  self.successBlock = ^(ABI41_0_0EXSyncManifest * _Nullable update) {
  ...
  dispatch_async(self.database.databaseQueue, ^{
    ...
    [self->_downloader downloadManifestFromURL:url withDatabase:self.database extraHeaders:extraHeaders successBlock:^(ABI41_0_0EXSyncManifest *update) {
...
- (void)downloadAsset:(ABI41_0_0EXSyncAsset *)asset
{
  ...
  dispatch_async([ABI41_0_0EXSyncFileDownloader assetFilesQueue], ^{
    if ([[NSFileManager defaultManager] fileExistsAtPath:[urlOnDisk path]]) {
      ...
      if (!asset.url) {
        [self handleAssetDownloadWithError:[NSError errorWithDomain:ABI41_0_0EXSyncRemoteLoaderErrorDomain code:1006 userInfo:@{NSLocalizedDescriptionKey: @"Failed to download asset with no URL provided"}] asset:asset];
        return;
      }
