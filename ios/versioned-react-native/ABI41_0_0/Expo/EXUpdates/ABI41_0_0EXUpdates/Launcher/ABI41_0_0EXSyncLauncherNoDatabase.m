...
static NSString * const ABI41_0_0EXSyncErrorLogFile = @"expo-error.log";

@interface ABI41_0_0EXSyncLauncherNoDatabase ()
...
@implementation ABI41_0_0EXSyncLauncherNoDatabase

- (void)launchUpdateWithConfig:(ABI41_0_0EXSyncConfig *)config
{
  _launchedUpdate = [ABI41_0_0EXSyncEmbeddedLoader embeddedManifestWithConfig:config database:nil];
  if (_launchedUpdate) {
    if (_launchedUpdate.status == ABI41_0_0EXSyncManifestStatusEmbedded) {
      ...
      _launchAssetUrl = [[NSBundle mainBundle] URLForResource:ABI41_0_0EXSyncEmbeddedBundleFilename withExtension:ABI41_0_0EXSyncEmbeddedBundleFileType];
...
+ (NSString *)_errorLogFilePath
{
  ...
  return [[applicationDocumentsDirectory URLByAppendingPathComponent:ABI41_0_0EXSyncErrorLogFile] path];
}
