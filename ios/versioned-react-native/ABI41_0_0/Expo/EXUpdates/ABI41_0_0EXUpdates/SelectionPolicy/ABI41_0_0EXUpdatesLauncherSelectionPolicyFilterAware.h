...
/**
 * An ABI41_0_0EXUpdatesLauncherSelectionPolicy which chooses an update to launch based on the manifest filters
 ...
 */
@interface ABI41_0_0EXUpdatesLauncherSelectionPolicyFilterAware : NSObject <ABI41_0_0EXUpdatesLauncherSelectionPolicy>
