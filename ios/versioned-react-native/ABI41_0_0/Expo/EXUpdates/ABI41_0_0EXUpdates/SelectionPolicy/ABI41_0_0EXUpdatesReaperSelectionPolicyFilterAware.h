...
/**
 * An ABI41_0_0EXUpdatesReaperSelectionPolicy which chooses which updates to delete taking into account manifest filters
 ...
 */
@interface ABI41_0_0EXUpdatesReaperSelectionPolicyFilterAware : NSObject <ABI41_0_0EXUpdatesReaperSelectionPolicy>
