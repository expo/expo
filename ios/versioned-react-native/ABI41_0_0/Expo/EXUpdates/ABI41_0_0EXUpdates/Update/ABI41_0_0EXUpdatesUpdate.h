...
@property (nonatomic, strong, readonly) ABI41_0_0EXManifestsRawManifest *rawManifest;
...
+ (ABI41_0_0EXManifestsRawManifest *)rawManifestForJSON:(NSDictionary *)manifestJSON;
