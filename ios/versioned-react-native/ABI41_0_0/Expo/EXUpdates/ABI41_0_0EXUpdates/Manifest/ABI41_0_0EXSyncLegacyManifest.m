...
static NSString * const ABI41_0_0EXSyncExpoAssetBaseUrl = @"https://d1wp6m56sqw74a.cloudfront.net/~assets/";
static NSString * const ABI41_0_0EXSyncExpoIoDomain = @"expo.io";
static NSString * const ABI41_0_0EXSyncExpHostDomain = @"exp.host";
static NSString * const ABI41_0_0EXSyncExpoTestDomain = @"expo.test";

@implementation ABI41_0_0EXSyncLegacyManifest
                                     ...
                                     database:(ABI41_0_0EXSyncDatabase *)database
{
  ...
  if ([[self class] isDevelopmentModeManifest:manifest]) {
    ...
    update.status = ABI41_0_0EXSyncManifestStatusDevelopment;
  } else {
...
+ (NSURL *)bundledAssetBaseUrlWithManifest:(NSDictionary *)manifest config:(ABI41_0_0EXSyncConfig *)config
{
  ...
  if (!host ||
      [host containsString:ABI41_0_0EXSyncExpoIoDomain] ||
      [host containsString:ABI41_0_0EXSyncExpHostDomain] ||
      [host containsString:ABI41_0_0EXSyncExpoTestDomain]) {
    return [NSURL URLWithString:ABI41_0_0EXSyncExpoAssetBaseUrl];
  } else {
