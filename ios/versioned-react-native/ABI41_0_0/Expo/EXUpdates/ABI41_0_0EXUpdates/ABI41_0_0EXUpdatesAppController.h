...
@class ABI41_0_0EXUpdatesAppController;

@protocol ABI41_0_0EXUpdatesAppControllerDelegate <NSObject>

- (void)appController:(ABI41_0_0EXUpdatesAppController *)appController didStartWithSuccess:(BOOL)success;

@end

@interface ABI41_0_0EXUpdatesAppController : NSObject <ABI41_0_0EXUpdatesAppLoaderTaskDelegate>

/**
 Delegate which will be notified when ABI41_0_0EXUpdates has an update ready to launch and
 `launchAssetUrl` is nonnull.
 */
@property (nonatomic, weak) id<ABI41_0_0EXUpdatesAppControllerDelegate> delegate;
...
/**
 ...
 Will be null until the ABI41_0_0EXUpdatesAppController delegate method is called.
...
@property (nonatomic, readonly) ABI41_0_0EXUpdatesSelectionPolicy *selectionPolicy;
...
/**
 ...
 shared instance of ABI41_0_0EXUpdatesAppController.
 */
 ...
 * ABI41_0_0EXUpdatesAppController's default selection policy is.
 */
