...
static NSString * const ABI41_0_0EXSyncDatabaseV4Filename = @"expo-v4.db";

@implementation ABI41_0_0EXSyncDatabaseMigration4To5

- (NSString *)filename
{
  return ABI41_0_0EXSyncDatabaseV4Filename;
}
