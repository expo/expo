...
static NSString * const ABI41_0_0EXUpdatesDatabaseV4Filename = @"expo-v4.db";

@implementation ABI41_0_0EXUpdatesDatabaseMigration4To5

- (NSString *)filename
{
  return ABI41_0_0EXUpdatesDatabaseV4Filename;
}
