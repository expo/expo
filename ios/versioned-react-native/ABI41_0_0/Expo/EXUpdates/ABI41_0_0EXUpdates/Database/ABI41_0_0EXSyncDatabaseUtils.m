...
static NSString * const ABI41_0_0EXSyncDatabaseUtilsErrorDomain = @"ABI41_0_0EXSyncDatabase";

@implementation ABI41_0_0EXSyncDatabaseUtils
...
+ (NSError *)errorFromSqlite:(struct sqlite3 *)db
{
  ...
  return [NSError errorWithDomain:ABI41_0_0EXSyncDatabaseUtilsErrorDomain
                             code:extendedCode
