#import "ABI41_0_0RNAWSCognito.h"
...
@implementation ABI41_0_0RNAWSCognito
...
ABI41_0_0RCT_EXPORT_METHOD(computeModPow:(NSDictionary *)values
    ...
    if (result) {
        ...
        callback(@[@[ABI41_0_0RCTMakeError(@"computeModPow error", nil, nil)], [NSNull null]]);
    }
}

ABI41_0_0RCT_EXPORT_METHOD(computeS:(NSDictionary *)values
                  callback:(ABI41_0_0RCTResponseSenderBlock)callback) {
    ...
    if (result) {
        ...
        callback(@[@[ABI41_0_0RCTMakeError(@"computeS error", nil, nil)], [NSNull null]]);
    }
}
