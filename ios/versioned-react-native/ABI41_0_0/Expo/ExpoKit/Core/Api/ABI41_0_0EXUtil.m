...
@interface ABI41_0_0EXUtil ()

@property (nonatomic, weak) id<ABI41_0_0EXUtilService> kernelUtilService;

@end

ABI41_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI41_0_0EXUtil, util)

@implementation ABI41_0_0EXUtil
