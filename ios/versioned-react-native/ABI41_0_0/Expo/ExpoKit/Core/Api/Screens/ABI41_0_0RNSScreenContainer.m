...
- (void)insertABI41_0_0ReactSubview:(ABI41_0_0RNSScreenView *)subview atIndex:(NSInteger)atIndex
{
...
- (void)removeABI41_0_0ReactSubview:(ABI41_0_0RNSScreenView *)subview
{
...
- (void)attachScreen:(ABI41_0_0RNSScreenView *)screen atIndex:(NSInteger)index
{
  ...
  // the frame is already set at this moment because we adjust it in insertABI41_0_0ReactSubview. We don't
  // want to update it here as ABI41_0_0React-driven animations may already run and hence changing the frame
...
- (void)markUpdated:(ABI41_0_0RNSScreenContainerView *)screen
{
  ...
  if ([_markedContainers count] == 1) {
    ...
    // See https://github.com/software-mansion/ABI41_0_0React-native-screens/issues/726#issuecomment-757879605
