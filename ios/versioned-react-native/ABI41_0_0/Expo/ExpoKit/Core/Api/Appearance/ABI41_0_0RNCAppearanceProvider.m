...
@interface ABI41_0_0RNCAppearanceProvider ()

@property (nonatomic, weak) ABI41_0_0RCTBridge *bridge;

@end

@implementation ABI41_0_0RNCAppearanceProvider
...
- (void)notifyUserInterfaceStyleChanged
{
  ...
  if (self.bridge) {
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ABI41_0_0RNCUserInterfaceStyleDidChangeNotification"
                                                        object:self.bridge
