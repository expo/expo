...
#import "ABI41_0_0UIViewController+CreateExtension.h"
...
@property(nonatomic, strong) UIPageViewController *ABI41_0_0ReactPageViewController;
@property(nonatomic, strong) UIPageControl *ABI41_0_0ReactPageIndicatorView;
...
- (void)layoutSubviews {
    ...
    if (self.ABI41_0_0ReactPageViewController) {
...
- (void)didUpdateABI41_0_0ReactSubviews {
    if (!self.ABI41_0_0ReactPageViewController && self.ABI41_0_0ReactViewController != nil) {
        [self embed];
...
- (void)embed {
    ...
    self.ABI41_0_0ReactPageViewController = pageViewController;
    ...
    self.ABI41_0_0ReactPageIndicatorView = pageIndicatorView;
...
- (void)shouldScroll:(BOOL)scrollEnabled {
    ...
    if (self.ABI41_0_0ReactPageViewController.view) {
...
- (void)setABI41_0_0ReactViewControllers:(NSInteger)index
    ...
    if (self.ABI41_0_0ReactPageViewController == nil) {
        return;
    }
    __weak ABI41_0_0ReactNativePageView *weakSelf = self;
    uint16_t coalescingKey = _coalescingKey++;
    
    [self.ABI41_0_0ReactPageViewController setViewControllers:@[controller]
                                           direction:direction
                                            animated:animated
...
- (UIViewController *)currentlyDisplayed {
    return self.ABI41_0_0ReactPageViewController.viewControllers.firstObject;
}
...
- (void)goTo:(NSInteger)index animated:(BOOL)animated {
    ...
    self.ABI41_0_0ReactPageIndicatorView.numberOfPages = numberOfPages;
    self.ABI41_0_0ReactPageIndicatorView.currentPage = indexToDisplay;
...
- (void)pageViewController:(UIPageViewController *)pageViewController
   ...
   previousViewControllers:(nonnull NSArray<UIViewController *> *)previousViewControllers
    ...
    if (completed) {
        ...
        self.ABI41_0_0ReactPageIndicatorView.currentPage = currentIndex;
...
- (void)shouldShowPageIndicator:(BOOL)showPageIndicator {
    ...
    if (self.ABI41_0_0ReactPageIndicatorView) {
        self.ABI41_0_0ReactPageIndicatorView.hidden = !showPageIndicator;
    }
}
...
- (void)scrollViewWillEndDragging:(UIScrollView *)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(inout CGPoint *)targetContentOffset {
    ...
    if (!_overdrag) {
        ...
        } else if (_currentIndex == _ABI41_0_0ReactPageIndicatorView.numberOfPages -1 && scrollView.contentOffset.x >= scrollView.bounds.size.width) {
            *targetContentOffset = CGPointMake(scrollView.bounds.size.width, 0);
        }
    }
}
