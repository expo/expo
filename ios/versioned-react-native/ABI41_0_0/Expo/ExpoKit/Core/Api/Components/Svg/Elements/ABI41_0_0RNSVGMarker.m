...
@implementation ABI41_0_0RNSVGMarker
...
- (void)setX:(ABI41_0_0RNSVGLength *)refX
{
...
- (void)setY:(ABI41_0_0RNSVGLength *)refY
{
...
- (void)setMarkerWidth:(ABI41_0_0RNSVGLength *)markerWidth
{
...
- (void)setMarkerHeight:(ABI41_0_0RNSVGLength *)markerHeight
{
...
static CGFloat ABI41_0_0RNSVG_degToRad = (CGFloat)M_PI / 180;

double ABI41_0_0deg2rad(CGFloat deg) {
    return deg * ABI41_0_0RNSVG_degToRad;
}

- (void)renderMarker:(CGContextRef)context rect:(CGRect)rect position:(ABI41_0_0RNSVGMarkerPosition*)position strokeWidth:(CGFloat)strokeWidth
{
    ...
    float rad = ABI41_0_0deg2rad(angle);
