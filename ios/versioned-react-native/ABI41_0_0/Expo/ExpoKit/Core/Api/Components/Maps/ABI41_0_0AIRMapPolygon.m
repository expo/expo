...
@implementation ABI41_0_0AIRMapPolygon {
...
- (void)setCoordinates:(NSArray<ABI41_0_0AIRMapCoordinate *> *)coordinates {
...
- (void)setHoles:(NSArray<NSArray<ABI41_0_0AIRMapCoordinate *> *> *)holes {
    _holes = holes;
    if (holes.count)
    {
