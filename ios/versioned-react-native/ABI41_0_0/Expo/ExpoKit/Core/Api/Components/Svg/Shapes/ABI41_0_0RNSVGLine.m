...
#import "ABI41_0_0RNSVGLine.h"
#import <ABI41_0_0React/ABI41_0_0RCTLog.h>

@implementation ABI41_0_0RNSVGLine

- (void)setX1:(ABI41_0_0RNSVGLength *)x1
{
    if ([x1 isEqualTo:_x1]) {
        return;
    }
...
- (void)setY1:(ABI41_0_0RNSVGLength *)y1
{
    if ([y1 isEqualTo:_y1]) {
        return;
    }
...
- (void)setX2:(ABI41_0_0RNSVGLength *)x2
{
    if ([x2 isEqualTo:_x2]) {
        return;
    }
...
- (void)setY2:(ABI41_0_0RNSVGLength *)y2
{
    if ([y2 isEqualTo:_y2]) {
        return;
    }
