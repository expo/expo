...
@implementation ABI41_0_0RNSVGLength
...
{
    ABI41_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype) lengthWithString: (NSString *) lengthString {
    ...
    ABI41_0_0RNSVGLength *output = [ABI41_0_0RNSVGLength alloc];
    if (stringLength == 0) {
        ...
        ABI41_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
