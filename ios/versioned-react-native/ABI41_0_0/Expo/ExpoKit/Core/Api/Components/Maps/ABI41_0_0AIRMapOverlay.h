...
#import "ABI41_0_0AIRMapOverlayRenderer.h"

@class ABI41_0_0RCTBridge;

@interface ABI41_0_0AIRMapOverlay : UIView <MKOverlay>

@property (nonatomic, strong) ABI41_0_0AIRMapOverlayRenderer *renderer;
