...
@implementation ABI41_0_0RNSVGGroupManager

ABI41_0_0RCT_EXPORT_MODULE()

- (ABI41_0_0RNSVGNode *)node
{
  return [ABI41_0_0RNSVGGroup new];
}

ABI41_0_0RCT_EXPORT_VIEW_PROPERTY(font, NSDictionary)

ABI41_0_0RCT_CUSTOM_VIEW_PROPERTY(fontSize, id, ABI41_0_0RNSVGGroup)
{
...
ABI41_0_0RCT_CUSTOM_VIEW_PROPERTY(fontWeight, id, ABI41_0_0RNSVGGroup)
{
    if ([json isKindOfClass:[NSString class]]) {
        NSString *stringValue = (NSString *)json;
