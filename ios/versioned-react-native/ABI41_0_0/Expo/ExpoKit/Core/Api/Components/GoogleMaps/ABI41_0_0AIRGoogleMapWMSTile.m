//
//  ABI41_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI41_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI41_0_0WMSTileOverlay *tile = [[ABI41_0_0WMSTileOverlay alloc] init];
...
@implementation ABI41_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
