...
#import "ABI41_0_0RNPanHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

@interface ABI41_0_0RNBetterPanGestureRecognizer : UIPanGestureRecognizer
...
@implementation ABI41_0_0RNBetterPanGestureRecognizer {
...
@implementation ABI41_0_0RNPanGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI41_0_0RNBetterPanGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI41_0_0RNBetterPanGestureRecognizer *recognizer = (ABI41_0_0RNBetterPanGestureRecognizer *)_recognizer;
...
- (ABI41_0_0RNGestureHandlerEventExtraData *)eventExtraData:(UIPanGestureRecognizer *)recognizer
{
