...
#import "ABI41_0_0AIRMapCalloutManager.h"
...
@interface ABI41_0_0AIRMapCalloutManager()

@end

@implementation ABI41_0_0AIRMapCalloutManager

ABI41_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    return [ABI41_0_0AIRMapCallout new];
}
