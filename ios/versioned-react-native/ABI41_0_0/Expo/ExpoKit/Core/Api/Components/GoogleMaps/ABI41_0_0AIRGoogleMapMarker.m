...
#import "ABI41_0_0AIRDummyView.h"
...
@interface ABI41_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI41_0_0AIRGMSMarker*)marker;
@end

@implementation ABI41_0_0AIRGoogleMapMarker {
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI41_0_0AIRGMSMarker alloc] init];
...
- (void)insertABI41_0_0ReactSubview:(id<ABI41_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI41_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI41_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI41_0_0AIRDummyView *dummySubview = [[ABI41_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertABI41_0_0ReactSubview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeABI41_0_0ReactSubview:(id<ABI41_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI41_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeABI41_0_0ReactSubview:(UIView*)dummySubview];
}
...
- (void)setOnPress:(ABI41_0_0RCTBubblingEventBlock)onPress {
  _realMarker.onPress = onPress;
}

- (ABI41_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/ABI41_0_0React-native-community/ABI41_0_0React-native-maps/issues/738)
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI41_0_0RN?
...
- (void)setIconSrc:(NSString *)iconSrc
{
  ...
  _reloadImageCancellationBlock =
  [[_bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI41_0_0RCTConvert NSURLRequest:_iconSrc]
                                          size:self.bounds.size
                                         scale:ABI41_0_0RCTScreenScale()
                                       clipped:YES
                                    resizeMode:ABI41_0_0RCTResizeModeCenter
