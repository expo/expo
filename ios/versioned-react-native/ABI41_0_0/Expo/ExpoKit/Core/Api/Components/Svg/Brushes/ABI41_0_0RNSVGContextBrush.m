...
@implementation ABI41_0_0RNSVGContextBrush
{
    BOOL _isStroke;
}
...
{
    ABI41_0_0RNSVGRenderable *element = ABI41_0_0RNSVGRenderable.contextElement;
    if (!element) {
        return NO;
    }

    ABI41_0_0RNSVGBrush *brush = _isStroke ? element.stroke : element.fill;

    BOOL fillColor;

    if (brush.class == ABI41_0_0RNSVGBrush.class) {
