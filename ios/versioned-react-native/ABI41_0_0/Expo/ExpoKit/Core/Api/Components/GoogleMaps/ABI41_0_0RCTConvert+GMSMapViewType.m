//
//  ABI41_0_0RCTConvert+GMSMapViewType.m
//
...
@implementation ABI41_0_0RCTConvert (GMSMapViewType)
  ABI41_0_0RCT_ENUM_CONVERTER(GMSMapViewType,
  (
    @{
...
+ (GMSCameraPosition*)GMSCameraPosition:(id)json
{
    ...
    return [ABI41_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:nil];
}
