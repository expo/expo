...
#import "ABI41_0_0RNTapHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI41_0_0React/ABI41_0_0RCTConvert.h>

// ABI41_0_0RNBetterTapGestureRecognizer extends UIGestureRecognizer instead of UITapGestureRecognizer 
...
@interface ABI41_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
- (id)initWithGestureHandler:(ABI41_0_0RNGestureHandler*)gestureHandler;

@end

@implementation ABI41_0_0RNBetterTapGestureRecognizer {
  __weak ABI41_0_0RNGestureHandler *_gestureHandler;
...
@implementation ABI41_0_0RNTapGestureHandler {
    ABI41_0_0RNGestureHandlerEventExtraData * _lastData;
}

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI41_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI41_0_0RNBetterTapGestureRecognizer *recognizer = (ABI41_0_0RNBetterTapGestureRecognizer *)_recognizer;
