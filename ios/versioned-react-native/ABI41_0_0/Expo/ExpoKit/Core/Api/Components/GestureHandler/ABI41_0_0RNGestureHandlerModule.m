#import "ABI41_0_0RNGestureHandlerModule.h"
...
@interface ABI41_0_0RNGestureHandlerModule () <ABI41_0_0RCTUIManagerObserver>

@end

@interface ABI41_0_0RNGestureHandlerButtonManager : ABI41_0_0RCTViewManager
@end

@implementation ABI41_0_0RNGestureHandlerButtonManager

ABI41_0_0RCT_EXPORT_MODULE(ABI41_0_0RNGestureHandlerButton)

ABI41_0_0RCT_EXPORT_VIEW_PROPERTY(enabled, BOOL)
#if !TARGET_OS_TV
ABI41_0_0RCT_CUSTOM_VIEW_PROPERTY(exclusive, BOOL, ABI41_0_0RNGestureHandlerButton)
{
  [view setExclusiveTouch: json == nil ? YES : [ABI41_0_0RCTConvert BOOL: json]];
}
#endif
ABI41_0_0RCT_CUSTOM_VIEW_PROPERTY(hitSlop, UIEdgeInsets, ABI41_0_0RNGestureHandlerButton)
{
  if (json) {
...
- (UIView *)view
{
    return [ABI41_0_0RNGestureHandlerButton new];
}

@end


typedef void (^GestureHandlerOperation)(ABI41_0_0RNGestureHandlerManager *manager);

@implementation ABI41_0_0RNGestureHandlerModule
{
    ABI41_0_0RNGestureHandlerManager *_manager;
...
- (void)setBridge:(ABI41_0_0RCTBridge *)bridge
{
    ...
    _manager = [[ABI41_0_0RNGestureHandlerManager alloc]
...
{
    [self addOperationBlock:^(ABI41_0_0RNGestureHandlerManager *manager) {
...
{
    return @{ @"State": @{
                      @"UNDETERMINED": @(ABI41_0_0RNGestureHandlerStateUndetermined),
                      @"BEGAN": @(ABI41_0_0RNGestureHandlerStateBegan),
                      @"ACTIVE": @(ABI41_0_0RNGestureHandlerStateActive),
                      @"CANCELLED": @(ABI41_0_0RNGestureHandlerStateCancelled),
                      @"FAILED": @(ABI41_0_0RNGestureHandlerStateFailed),
                      @"END": @(ABI41_0_0RNGestureHandlerStateEnd)
                      },
              @"Direction": @{
                      @"RIGHT": @(ABI41_0_0RNGestureHandlerDirectionRight),
                      @"LEFT": @(ABI41_0_0RNGestureHandlerDirectionLeft),
                      @"UP": @(ABI41_0_0RNGestureHandlerDirectionUp),
                      @"DOWN": @(ABI41_0_0RNGestureHandlerDirectionDown)
                      }
              };
}
