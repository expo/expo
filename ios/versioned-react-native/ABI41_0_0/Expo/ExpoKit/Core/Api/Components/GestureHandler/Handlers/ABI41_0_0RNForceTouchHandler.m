#import "ABI41_0_0RNForceTouchHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI41_0_0React/ABI41_0_0RCTConvert.h>

@interface ABI41_0_0RNForceTouchGestureRecognizer : UIGestureRecognizer
...
@implementation ABI41_0_0RNForceTouchGestureRecognizer {
...
@implementation ABI41_0_0RNForceTouchHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI41_0_0RNForceTouchGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI41_0_0RNForceTouchGestureRecognizer *recognizer = (ABI41_0_0RNForceTouchGestureRecognizer *)_recognizer;
...
- (ABI41_0_0RNGestureHandlerEventExtraData *)eventExtraData:(ABI41_0_0RNForceTouchGestureRecognizer *)recognizer
{
