...
@implementation ABI41_0_0RCTConvert (AirMap)
...
{
    json = [self NSDictionary:json];
    return [ABI41_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:nil];
}
...
ABI41_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI41_0_0AIRMapCoordinate *)ABI41_0_0AIRMapCoordinate:(id)json
{
    ABI41_0_0AIRMapCoordinate *coord = [ABI41_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI41_0_0RCT_ARRAY_CONVERTER(ABI41_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI41_0_0AIRMapCoordinate *> *> *)ABI41_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI41_0_0RCTConvertArrayValue(@selector(ABI41_0_0AIRMapCoordinateArray:), json);
}
