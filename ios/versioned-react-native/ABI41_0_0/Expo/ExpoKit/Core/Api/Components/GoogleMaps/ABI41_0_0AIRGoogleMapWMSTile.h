//
//  ABI41_0_0AIRGoogleMapWMSTile.h
//  AirMaps
//
...
@interface ABI41_0_0WMSTileOverlay : GMSSyncTileLayer
...
@interface ABI41_0_0AIRGoogleMapWMSTile : UIView
@property (nonatomic, strong) ABI41_0_0WMSTileOverlay *tileLayer;
