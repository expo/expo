...
@implementation ABI41_0_0RNCSafeAreaProvider
{
...
{
  // This gets called before the view size is set by ABI41_0_0React-native so
  ...
  if (
    _initialInsetsSent &&
    ABI41_0_0UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI41_0_0RCTScreenScale()) &&
