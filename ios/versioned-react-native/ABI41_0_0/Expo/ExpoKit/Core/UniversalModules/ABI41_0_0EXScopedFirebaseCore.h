...
- (instancetype)initWithScopeKey:(NSString *)scopeKey manifest:(ABI41_0_0EXManifestsRawManifest *)manifest constantsBinding:(ABI41_0_0EXConstantsBinding *)constantsBinding;
