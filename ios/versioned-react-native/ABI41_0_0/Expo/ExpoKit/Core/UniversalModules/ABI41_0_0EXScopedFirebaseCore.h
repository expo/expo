...
- (instancetype)initWithScopeKey:(NSString *)scopeKey manifest:(ABI41_0_0EXRawManifestsRawManifest *)manifest constantsBinding:(ABI41_0_0EXConstantsBinding *)constantsBinding;
