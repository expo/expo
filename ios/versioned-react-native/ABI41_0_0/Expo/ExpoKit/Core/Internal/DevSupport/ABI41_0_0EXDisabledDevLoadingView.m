...
@implementation ABI41_0_0EXDisabledDevLoadingView {
  BOOL _isObserving;
}

+ (NSString *)moduleName { return @"ABI41_0_0RCTDevLoadingView"; }


ABI41_0_0RCT_EXPORT_METHOD(hide)
{
  ABI41_0_0RCTDevSettings *settings = [[super bridge] devSettings];
...
ABI41_0_0RCT_EXPORT_METHOD(showMessage:(NSString *)message color:(UIColor *)color backgroundColor:(UIColor *)backgroundColor)
{
  ABI41_0_0RCTDevSettings *settings = [[super bridge] devSettings];
  BOOL isFastRefreshEnabled = [settings isHotLoadingEnabled];
  if (_isObserving && isFastRefreshEnabled) {
