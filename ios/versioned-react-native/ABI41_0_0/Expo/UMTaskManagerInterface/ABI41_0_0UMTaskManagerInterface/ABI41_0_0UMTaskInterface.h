...
@protocol ABI41_0_0UMTaskConsumerInterface;

@protocol ABI41_0_0UMTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI41_0_0UMTaskConsumerInterface> __nonnull consumer;
