...
// Interface for ABI41_0_0UMTaskManager module.

@protocol ABI41_0_0UMTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI41_0_0UMTaskConsumerInterface protocol.
 */
