...
@interface ABI41_0_0EXScreenOrientationRegistry ()
...
@implementation ABI41_0_0EXScreenOrientationRegistry

ABI41_0_0UM_REGISTER_SINGLETON_MODULE(ScreenOrientationRegistry)
...
- (void)enforceDesiredDeviceOrientationWithOrientationMask:(UIInterfaceOrientationMask)orientationMask
{
  ...
  if (![ABI41_0_0EXScreenOrientationUtilities doesOrientationMask:orientationMask containOrientation:_currentScreenOrientation]) {
    __block UIInterfaceOrientation newOrientation = [ABI41_0_0EXScreenOrientationUtilities defaultOrientationForOrientationMask:orientationMask];
...
- (void)interfaceOrientationDidChange:(UIInterfaceOrientation)newScreenOrientation
{
  ...
  if ([ABI41_0_0EXScreenOrientationUtilities doesOrientationMask:currentOrientationMask containOrientation:newScreenOrientation]) {
    ...
    if ([ABI41_0_0EXScreenOrientationUtilities isIPad] &&
...
- (void)traitCollectionDidChangeTo:(UITraitCollection *)traitCollection
{
  ...
  UIInterfaceOrientation currentDeviceOrientation = [ABI41_0_0EXScreenOrientationUtilities interfaceOrientationFromDeviceOrientation:[[UIDevice currentDevice] orientation]];
...
- (void)registerModuleToReceiveNotification:(id<ABI41_0_0EXOrientationListener>)module
{
  [_notificationListeners addPointer:(__bridge void * _Nullable)(module)];
}

- (void)unregisterModuleFromReceivingNotification:(id<ABI41_0_0EXOrientationListener>)module
{
