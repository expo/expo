...
@implementation ABI41_0_0EXBareCodeCameraRequester
...
- (NSDictionary *)getPermissions
{
  ...
  if (!(cameraUsageDescription && microphoneUsageDescription)) {
    ABI41_0_0UMFatal(ABI41_0_0UMErrorWithMessage(@"This app is missing either 'NSCameraUsageDescription' or 'NSMicrophoneUsageDescription', so audio/video services will fail. Add both of these entries to your bundle's Info.plist."));
