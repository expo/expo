...
#import <ABI41_0_0EXLocalAuthentication/ABI41_0_0EXLocalAuthentication.h>

typedef NS_ENUM(NSInteger, ABI41_0_0EXAuthenticationType) {
  ABI41_0_0EXAuthenticationTypeFingerprint = 1,
  ABI41_0_0EXAuthenticationTypeFacialRecognition = 2,
};

typedef NS_ENUM(NSInteger, ABI41_0_0EXSecurityLevel) {
  ABI41_0_0EXSecurityLevelNone = 0,
  ABI41_0_0EXSecurityLevelSecret = 1,
  ABI41_0_0EXSecurityLevelBiometric = 2,
};

@implementation ABI41_0_0EXLocalAuthentication

ABI41_0_0UM_EXPORT_MODULE(ExpoLocalAuthentication)

ABI41_0_0UM_EXPORT_METHOD_AS(supportedAuthenticationTypesAsync,
                    supportedAuthenticationTypesAsync:(ABI41_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  NSMutableArray *results = [NSMutableArray array];
  if ([[self class] isTouchIdDevice]) {
    [results addObject:@(ABI41_0_0EXAuthenticationTypeFingerprint)];
  }
  if ([[self class] isFaceIdDevice]) {
    [results addObject:@(ABI41_0_0EXAuthenticationTypeFacialRecognition)];
  }
  resolve(results);
}

ABI41_0_0UM_EXPORT_METHOD_AS(hasHardwareAsync,
                    hasHardwareAsync:(ABI41_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI41_0_0UMPromiseRejectBlock)reject)
{
...
ABI41_0_0UM_EXPORT_METHOD_AS(isEnrolledAsync,
                    isEnrolledAsync:(ABI41_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI41_0_0UM_EXPORT_METHOD_AS(getEnrolledLevelAsync,
                    getEnrolledLevelAsync:(ABI41_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;

  int level = ABI41_0_0EXSecurityLevelNone;
  ...
  if (isAuthenticationSupported && error == nil) {
    level = ABI41_0_0EXSecurityLevelSecret;
  }
  ...
  if (isBiometricsSupported && error == nil) {
    level = ABI41_0_0EXSecurityLevelBiometric;
  }
          ...
          localizedReason:reason
                    reply:^(BOOL success, NSError *error) {
                      resolve(@{
                                ...
                                @"warning": ABI41_0_0UMNullIfNil(warningMessage),
                                });
                    }];
  } else {
