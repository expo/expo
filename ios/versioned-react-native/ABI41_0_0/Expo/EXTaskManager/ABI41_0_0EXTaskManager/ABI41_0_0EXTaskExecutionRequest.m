...
@interface ABI41_0_0EXTaskExecutionRequest ()

@property (nonatomic, strong, nullable) NSMutableSet<id<ABI41_0_0UMTaskInterface>> *tasks;
...
@implementation ABI41_0_0EXTaskExecutionRequest
...
- (void)_maybeExecuteCallback
{
  if (_callback) {
    ...
    __strong ABI41_0_0EXTaskExecutionRequest *strongSelf = self;
