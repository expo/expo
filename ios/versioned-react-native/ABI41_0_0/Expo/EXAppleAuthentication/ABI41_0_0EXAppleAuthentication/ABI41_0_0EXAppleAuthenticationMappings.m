...
@implementation ABI41_0_0EXAppleAuthenticationMappings
...
{
  return @{
           @"namePrefix": ABI41_0_0UMNullIfNil(nameComponents.namePrefix),
           @"givenName": ABI41_0_0UMNullIfNil(nameComponents.givenName),
           @"middleName": ABI41_0_0UMNullIfNil(nameComponents.middleName),
           @"familyName": ABI41_0_0UMNullIfNil(nameComponents.familyName),
           @"nameSuffix": ABI41_0_0UMNullIfNil(nameComponents.nameSuffix),
           @"nickname": ABI41_0_0UMNullIfNil(nameComponents.nickname)
           };
}
