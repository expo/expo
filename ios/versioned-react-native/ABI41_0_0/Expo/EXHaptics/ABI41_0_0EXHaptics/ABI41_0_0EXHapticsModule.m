...
#import <ABI41_0_0EXHaptics/ABI41_0_0EXHapticsModule.h>

@interface ABI41_0_0EXHapticsModule ()

@end

@implementation ABI41_0_0EXHapticsModule

ABI41_0_0UM_EXPORT_MODULE(ExpoHaptics);
...
ABI41_0_0UM_EXPORT_METHOD_AS(notificationAsync,
...
ABI41_0_0UM_EXPORT_METHOD_AS(impactAsync,
...
ABI41_0_0UM_EXPORT_METHOD_AS(selectionAsync,
                    resolve:(ABI41_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI41_0_0UMPromiseRejectBlock)reject)
{
