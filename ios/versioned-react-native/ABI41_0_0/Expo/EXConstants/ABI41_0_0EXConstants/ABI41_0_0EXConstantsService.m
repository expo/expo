...
#import <ABI41_0_0EXConstants/ABI41_0_0EXConstantsInstallationIdProvider.h>

NSString * const ABI41_0_0EXConstantsExecutionEnvironmentBare = @"bare";
NSString * const ABI41_0_0EXConstantsExecutionEnvironmentStandalone = @"standalone";
NSString * const ABI41_0_0EXConstantsExecutionEnvironmentStoreClient = @"storeClient";

@interface ABI41_0_0EXConstantsService ()

@property (nonatomic, strong) NSString *sessionId;
@property (nonatomic, strong) ABI41_0_0EXConstantsInstallationIdProvider *installationIdProvider;

@end

@implementation ABI41_0_0EXConstantsService

- (instancetype)init
{
  return [self initWithInstallationIdProvider:[[ABI41_0_0EXConstantsInstallationIdProvider alloc] init]];
}

- (instancetype)initWithInstallationIdProvider:(ABI41_0_0EXConstantsInstallationIdProvider *)installationIdProvider
{
  if (self = [super init]) {
...
{
  return @[@protocol(ABI41_0_0UMConstantsInterface)];
}
...
- (NSDictionary *)constants
{
  ...
  return @{
           ...
           @"executionEnvironment": ABI41_0_0EXConstantsExecutionEnvironmentBare,
           ...
           @"manifest": ABI41_0_0UMNullIfNil([[self class] appConfig]),
           @"platform": @{
               @"ios": @{
                   @"buildNumber": [self buildVersion],
                   @"platform": [[self class] devicePlatform],
                   @"model": ABI41_0_0UMNullIfNil([[self class] deviceModel]),
