...
#import <ABI41_0_0EXDevice/ABI41_0_0EXDevice.h>
...
@interface ABI41_0_0EXDevice()

@end

@implementation ABI41_0_0EXDevice

ABI41_0_0UM_EXPORT_MODULE(ExpoDevice);
...
- (NSDictionary *)constantsToExport
{
  ...
  return @{
           ...
           @"brand": @"Apple",
           @"manufacturer": @"Apple",
           @"modelId": ABI41_0_0UMNullIfNil([[self class] modelId]),
           @"deviceYearClass": [[self class] deviceYear],
           @"totalMemory": @(NSProcessInfo.processInfo.physicalMemory),
           @"supportedCpuArchitectures": ABI41_0_0UMNullIfNil([[self class] cpuArchitectures]),
...
ABI41_0_0UM_EXPORT_METHOD_AS(getDeviceTypeAsync,
                    getDeviceTypeAsyncWithResolver:(ABI41_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  resolve(@([[self class] deviceType]));
}

ABI41_0_0UM_EXPORT_METHOD_AS(getUptimeAsync,
                    getUptimeAsyncWithResolver:(ABI41_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
...
ABI41_0_0UM_EXPORT_METHOD_AS(isRootedExperimentalAsync,
                    isRootedExperimentalAsyncWithResolver:(ABI41_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
...
+ (ABI41_0_0EXDeviceType)deviceType
{
  switch (UIDevice.currentDevice.userInterfaceIdiom) {
    case UIUserInterfaceIdiomPhone:
      return ABI41_0_0EXDeviceTypePhone;
    case UIUserInterfaceIdiomPad:
      return ABI41_0_0EXDeviceTypeTablet;
    case UIUserInterfaceIdiomTV:
      return ABI41_0_0EXDeviceTypeTV;
    default:
      // NOTE: in the future for macOS, return Desktop
      return ABI41_0_0EXDeviceTypeUnknown;
  }
}
