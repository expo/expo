...
@implementation ABI41_0_0UMAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitializedAndSorted {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI41_0_0UMSingletonModule*> * singletonModules = [[ABI41_0_0UMModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI41_0_0UMSingletonModule *singletonModule in singletonModules) {
