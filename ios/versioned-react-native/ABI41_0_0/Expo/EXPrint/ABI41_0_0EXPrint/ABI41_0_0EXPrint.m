...
#import <ABI41_0_0EXPrint/ABI41_0_0EXPrint.h>
...
NSString *const ABI41_0_0EXPrintOrientationPortrait = @"portrait";
NSString *const ABI41_0_0EXPrintOrientationLandscape = @"landscape";

@interface ABI41_0_0EXPrint () <UIPrintInteractionControllerDelegate, UIPrinterPickerControllerDelegate>
...
@implementation ABI41_0_0EXPrint

ABI41_0_0UM_EXPORT_MODULE(ExponentPrint);
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"Orientation": @{
               @"portrait": ABI41_0_0EXPrintOrientationPortrait,
               @"landscape": ABI41_0_0EXPrintOrientationLandscape,
               },
           };
}

ABI41_0_0UM_EXPORT_METHOD_AS(print,
                    ...
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  [self _getPrintingDataForOptions:options callback:^(NSData *printingData, NSDictionary *errorDetails) {
    if (errorDetails != nil) {
      reject(errorDetails[@"code"], errorDetails[@"message"], ABI41_0_0UMErrorWithMessage(errorDetails[@"message"]));
      return;
    }
    ...
    if (printingData == nil) {
      ...
      if (options[@"markupFormatterIOS"] && [options[@"markupFormatterIOS"] isKindOfClass:[NSString class]]) {
        ...
        if (htmlString != nil) {
          ...
          reject(@"E_HTML_INVALID", message, ABI41_0_0UMErrorWithMessage(message));
          return;
        }
      } else {
...
ABI41_0_0UM_EXPORT_METHOD_AS(selectPrinter,selectPrinter:(ABI41_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
...
ABI41_0_0UM_EXPORT_METHOD_AS(printToFileAsync,
                    ...
                    reject:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI41_0_0EXWKPDFRenderer *renderTask = [ABI41_0_0EXWKPDFRenderer new];
...
{
  id<ABI41_0_0UMUtilitiesInterface> utils = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI41_0_0UMUtilitiesInterface)];
...
{
  if ([orientation isEqualToString:ABI41_0_0EXPrintOrientationLandscape]) {
