...
#import <ABI41_0_0EXSensors/ABI41_0_0EXPedometer.h>
...
NSString * const ABI41_0_0EXPedometerUpdateEventName = @"Exponent.pedometerUpdate";
NSString * const ABI41_0_0EXPedometerModuleName = @"ExponentPedometer";

@interface ABI41_0_0EXPedometer () <ABI41_0_0UMAppLifecycleListener>
...
@implementation ABI41_0_0EXPedometer
...
{
  if (self = [super init]) {
    __weak ABI41_0_0EXPedometer *weakSelf = self;
    _watchHandler = ^(CMPedometerData * _Nullable pedometerData, NSError * _Nullable error) {
      ...
      __strong ABI41_0_0EXPedometer *strongSelf = weakSelf;
      if (strongSelf) {
        __strong id<ABI41_0_0UMEventEmitterService> eventEmitter = strongSelf.eventEmitter;
        if (eventEmitter) {
          [eventEmitter sendEventWithName:ABI41_0_0EXPedometerUpdateEventName
...
{
  return ABI41_0_0EXPedometerModuleName;
}
...
{
  return @[ABI41_0_0EXPedometerUpdateEventName];
}
...
ABI41_0_0UM_EXPORT_METHOD_AS(getStepCountAsync,
