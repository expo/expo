...
#include "ABI41_0_0SampleCxxModule.h"
...
ABI41_0_0facebook::xplat::module::CxxModule *SampleCxxModule() {
  return new ABI41_0_0facebook::xplat::samples::SampleCxxModule(
      std::make_unique<ABI41_0_0facebook::xplat::samples::Sample>());
}
