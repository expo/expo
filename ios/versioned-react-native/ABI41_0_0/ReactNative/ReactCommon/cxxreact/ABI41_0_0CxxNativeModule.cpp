...
#include "ABI41_0_0CxxNativeModule.h"
#include "ABI41_0_0Instance.h"

#include <folly/json.h>
#include <glog/logging.h>
#include <iterator>

#include "ABI41_0_0JsArgumentHelpers.h"
#include "ABI41_0_0MessageQueueThread.h"
#include "ABI41_0_0SystraceSection.h"

using ABI41_0_0facebook::xplat::module::CxxModule;
...
void CxxNativeModule::invoke(
    ...
    int callId) {
  if (ABI41_0_0ReactMethodId >= methods_.size()) {
    throw std::invalid_argument(folly::to<std::string>(
        "methodId ",
        ABI41_0_0ReactMethodId,
        " out of range [0..",
        methods_.size(),
        "]"));
  }
  ...
  const auto &method = methods_[ABI41_0_0ReactMethodId];
  ...
  messageQueueThread_->runOnQueue(
      [method, params = std::move(params), first, second, callId]() {
        ...
        } catch (const ABI41_0_0facebook::xplat::JsArgumentException &ex) {
          throw;
