...
#include "ABI41_0_0JSBundleType.h"
...
#include "ABI41_0_0RecoverableError.h"
#include "ABI41_0_0SystraceSection.h"

#include <ABI41_0_0cxxreact/ABI41_0_0JSIndexedRAMBundle.h>
...
void Instance::JSCallInvoker::invokeAsync(std::function<void()> &&work) {
   ...
   *    is initialized. ABI41_0_0RCTDevLoadingView shows bundle download progress.
