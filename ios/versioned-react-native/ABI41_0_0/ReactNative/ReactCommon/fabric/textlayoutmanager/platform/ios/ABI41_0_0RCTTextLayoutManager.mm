...
#import <ABI41_0_0React/utils/SimpleThreadSafeCache.h>

using namespace ABI41_0_0facebook::ABI41_0_0React;

@implementation ABI41_0_0RCTTextLayoutManager {
  SimpleThreadSafeCache<AttributedString, std::shared_ptr<const void>, 256> _cache;
}

static NSLineBreakMode ABI41_0_0RCTNSLineBreakModeFromEllipsizeMode(EllipsizeMode ellipsizeMode)
{
  ...
  [textStorage
      enumerateAttribute:NSAttachmentAttributeName
              ...
              usingBlock:^(NSTextAttachment *attachment, NSRange range, BOOL *stop) {
                ...
                auto rect = ABI41_0_0facebook::ABI41_0_0React::Rect{ABI41_0_0facebook::ABI41_0_0React::Point{frame.origin.x, frame.origin.y},
                                                  ABI41_0_0facebook::ABI41_0_0React::Size{frame.size.width, frame.size.height}};
                                                               ...
                                                               size:(CGSize)size
{
  ...
  textContainer.lineBreakMode = paragraphAttributes.maximumNumberOfLines > 0
      ? ABI41_0_0RCTNSLineBreakModeFromEllipsizeMode(paragraphAttributes.ellipsizeMode)
                                                 ...
                                                 atPoint:(CGPoint)point
{
  ...
  if (textStorage.length > 0 && (fraction > 0 || characterIndex > 0) &&
    ...
    ABI41_0_0RCTWeakEventEmitterWrapper *eventEmitterWrapper =
        (ABI41_0_0RCTWeakEventEmitterWrapper *)[textStorage attribute:ABI41_0_0RCTAttributedStringEventEmitterKey
...
- (NSAttributedString *)_nsAttributedStringFromAttributedString:(AttributedString)attributedString
{
  auto sharedNSAttributedString = _cache.get(attributedString, [](const AttributedString attributedString) {
    return std::shared_ptr<void>(
        (__bridge_retained void *)ABI41_0_0RCTNSAttributedStringFromAttributedString(attributedString), CFRelease);
  });
