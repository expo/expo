...
#include <ABI41_0_0React/uimanager/UIManager.h>
...
Scheduler::Scheduler(
  ...
  ABI41_0_0ReactNativeConfig_ =
      schedulerToolbox.contextContainer
          ->at<std::shared_ptr<const ABI41_0_0ReactNativeConfig>>("ABI41_0_0ReactNativeConfig");
...
void Scheduler::renderTemplateToSurface(
  ...
  try {
    ...
    LOG(ERROR) << "    >>>> ABI41_0_0EXCEPTION <<<  rendering uiTemplate in "
...
void Scheduler::stopSurface(SurfaceId surfaceId) const {
  ...
  // We execute JavaScript/ABI41_0_0React part of the process at the very end to minimize
