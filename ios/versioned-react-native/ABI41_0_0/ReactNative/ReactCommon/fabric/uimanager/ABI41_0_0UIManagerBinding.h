...
#include <ABI41_0_0React/uimanager/primitives.h>
...
class UIManagerBinding : public jsi::HostObject {
 public:
  ...
  /*
   * Starts ABI41_0_0React Native Surface with given id, moduleName, and props.
   * Thread synchronization must be enforced externally.
   */
  void startSurface(
      jsi::Runtime &runtime,
  ...
  /*
   * Stops ABI41_0_0React Native Surface with given id.
   * Thread synchronization must be enforced externally.
   */
