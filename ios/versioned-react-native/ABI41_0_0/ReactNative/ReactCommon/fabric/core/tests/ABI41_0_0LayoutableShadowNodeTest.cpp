...
#include "ABI41_0_0TestComponent.h"
...
TEST_F(LayoutableShadowNodeTest, relativeLayoutMetrics) {
  ...
  ABI41_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 10);
  ABI41_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 20);
}
...
TEST_F(LayoutableShadowNodeTest, relativeLayoutMetricsOnTransformedNode) {
  ...
  ABI41_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 35);
  ABI41_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 70);

  ABI41_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 50);
  ABI41_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 100);
}
...
TEST_F(LayoutableShadowNodeTest, relativeLayoutMetricsOnTransformedParent) {
  ...
  ABI41_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 45);
  ABI41_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 45);

  ABI41_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 25);
  ABI41_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 25);
}
...
TEST_F(LayoutableShadowNodeTest, relativeLayoutMetricsOnSameNode) {
  ...
  ABI41_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 0);
  ABI41_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 0);
  ABI41_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 100);
  ABI41_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 200);
}
...
TEST_F(LayoutableShadowNodeTest, relativeLayourMetricsOnClonedNode) {
  ...
  ABI41_0_0EXPECT_EQ(newRelativeLayoutMetrics.frame.size.width, 500);
  ABI41_0_0EXPECT_EQ(newRelativeLayoutMetrics.frame.size.height, 600);
}
...
TEST_F(LayoutableShadowNodeTest, relativeLayoutMetricsOnSameNode2) {
  ...
  ABI41_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 10);
  ABI41_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 10);
}
