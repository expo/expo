...
#include "ABI41_0_0AttributedStringBox.h"
...
bool operator==(
  ...
  switch (lhs.getMode()) {
    case ABI41_0_0facebook::ABI41_0_0React::AttributedStringBox::Mode::Value:
      return lhs.getValue() == rhs.getValue();
    case ABI41_0_0facebook::ABI41_0_0React::AttributedStringBox::Mode::OpaquePointer:
