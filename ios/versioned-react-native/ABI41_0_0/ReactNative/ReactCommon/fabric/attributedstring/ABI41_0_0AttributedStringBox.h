...
template <>
struct std::hash<ABI41_0_0facebook::ABI41_0_0React::AttributedStringBox> {
  size_t operator()(
      ABI41_0_0facebook::ABI41_0_0React::AttributedStringBox const &attributedStringBox) const {
    switch (attributedStringBox.getMode()) {
      case ABI41_0_0facebook::ABI41_0_0React::AttributedStringBox::Mode::Value:
        return std::hash<ABI41_0_0facebook::ABI41_0_0React::AttributedString>()(
