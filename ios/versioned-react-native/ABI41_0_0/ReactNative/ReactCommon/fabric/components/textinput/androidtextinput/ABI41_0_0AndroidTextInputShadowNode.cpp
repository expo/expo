...
AttributedString AndroidTextInputShadowNode::getMostRecentAttributedString()
  ...
  bool treeAttributedStringChanged =
      !state.ABI41_0_0ReactTreeAttributedString.compareTextAttributesWithoutFrame(
          ABI41_0_0ReactTreeAttributedString);
...
void AndroidTextInputShadowNode::updateStateIfNeeded() {
  ...
  auto newEventCount =
      (state.ABI41_0_0ReactTreeAttributedString == ABI41_0_0ReactTreeAttributedString
           ? 0
