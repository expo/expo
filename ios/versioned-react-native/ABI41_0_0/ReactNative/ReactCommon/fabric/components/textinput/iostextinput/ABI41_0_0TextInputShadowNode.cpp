...
#include "ABI41_0_0TextInputShadowNode.h"
...
void TextInputShadowNode::updateStateIfNeeded() {
  ...
  auto ABI41_0_0ReactTreeAttributedString = getAttributedString();
  ...
  if (state.ABI41_0_0ReactTreeAttributedString == ABI41_0_0ReactTreeAttributedString &&
      state.layoutManager == textLayoutManager_) {
    return;
  }

  auto newState = TextInputState{};
  newState.attributedStringBox = AttributedStringBox{ABI41_0_0ReactTreeAttributedString};
  newState.paragraphAttributes = getConcreteProps().paragraphAttributes;
  newState.ABI41_0_0ReactTreeAttributedString = ABI41_0_0ReactTreeAttributedString;
