...
class AndroidTextInputState final {
 public:
  ...
  /*
   * All content of <TextInput> component represented as an `AttributedString`.
   * This stores the previous computed *from the ABI41_0_0React tree*. This usually
   ...
   */
  AttributedString ABI41_0_0ReactTreeAttributedString{};
  ...
  AndroidTextInputState(
      ...
      AttributedString const &ABI41_0_0ReactTreeAttributedString,
      ...
      : mostRecentEventCount(mostRecentEventCount),
        attributedString(attributedString),
        ABI41_0_0ReactTreeAttributedString(ABI41_0_0ReactTreeAttributedString),
        paragraphAttributes(paragraphAttributes),
  ...
  AndroidTextInputState(
      ...
      : mostRecentEventCount(data.getDefault(
        ...
        attributedString(updateAttributedString(
            ...
            data)),
        ABI41_0_0ReactTreeAttributedString(previousState.ABI41_0_0ReactTreeAttributedString),
