...
#pragma mark - Mutating Methods
   ...
   */
  void setPositionType(ABI41_0_0YGPositionType positionType) const;
...
#pragma mark - LayoutableShadowNode
 ...
 protected:
   ...
   * all the time.
   */
  mutable ABI41_0_0YGNode yogaNode_;
 ...
 private:
  ...
  static ABI41_0_0YGConfig &initializeYogaConfig(ABI41_0_0YGConfig &config);
  static ABI41_0_0YGNode *yogaNodeCloneCallbackConnector(
      ABI41_0_0YGNode *oldYogaNode,
      ABI41_0_0YGNode *parentYogaNode,
      int childIndex);
  static ABI41_0_0YGSize yogaNodeMeasureCallbackConnector(
