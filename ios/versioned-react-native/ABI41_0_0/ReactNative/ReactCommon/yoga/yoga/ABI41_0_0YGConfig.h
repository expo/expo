...
struct YOGA_EXPORT ABI41_0_0YGConfig {
  using LogWithContextFn = int (*)(
      ...
      const char* format,
      va_list args);
  using CloneWithContextFn = ABI41_0_0YGNodeRef (*)(
      ABI41_0_0YGNodeRef node,
...
private:
  union {
    ...
    ABI41_0_0YGCloneNodeFunc noContext;
  } cloneNodeCallback_;
  union {
    LogWithContextFn withContext;
    ABI41_0_0YGLogger noContext;
  } logger_;
...
public:
  ...
  std::array<bool, ABI41_0_0facebook::yoga::enums::count<ABI41_0_0YGExperimentalFeature>()>
      experimentalFeatures = {};
  void* context = nullptr;

  ABI41_0_0YGConfig(ABI41_0_0YGLogger logger);
  void log(ABI41_0_0YGConfig*, ABI41_0_0YGNode*, ABI41_0_0YGLogLevel, void*, const char*, va_list);
  void setLogger(ABI41_0_0YGLogger logger) {
  ...
  void setLogger(std::nullptr_t) { setLogger(ABI41_0_0YGLogger{nullptr}); }

  ABI41_0_0YGNodeRef cloneNode(
      ABI41_0_0YGNodeRef node,
      ABI41_0_0YGNodeRef owner,
      int childIndex,
      void* cloneContext);
  void setCloneNodeCallback(ABI41_0_0YGCloneNodeFunc cloneNode) {
  ...
  void setCloneNodeCallback(std::nullptr_t) {
    setCloneNodeCallback(ABI41_0_0YGCloneNodeFunc{nullptr});
  }
};
