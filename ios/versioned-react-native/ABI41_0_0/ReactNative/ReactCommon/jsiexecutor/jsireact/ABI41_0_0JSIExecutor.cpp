...
#include <ABI41_0_0cxxreact/ABI41_0_0ModuleRegistry.h>
#include <ABI41_0_0cxxreact/ABI41_0_0ReactMarker.h>
#include <ABI41_0_0cxxreact/ABI41_0_0SystraceSection.h>
...
void JSIExecutor::initializeRuntime() {
  ...
  if (hasLogger) {
    ABI41_0_0ReactMarker::logMarker(ABI41_0_0ReactMarker::CREATE_REACT_CONTEXT_STOP);
  }
}
...
void JSIExecutor::loadBundle(
  ...
  if (hasLogger) {
    ABI41_0_0ReactMarker::logTaggedMarker(
        ABI41_0_0ReactMarker::RUN_JS_BUNDLE_START, scriptName.c_str());
  }
  ...
  if (hasLogger) {
    ABI41_0_0ReactMarker::logTaggedMarker(
        ABI41_0_0ReactMarker::RUN_JS_BUNDLE_STOP, scriptName.c_str());
  }
}
        ...
        *runtime_,
        ...
        Function::createFromHostFunction(
            *runtime_,
            ...
            [this](
                __unused Runtime &rt,
                const ABI41_0_0facebook::jsi::Value &,
...
void JSIExecutor::registerBundle(
  ...
  ABI41_0_0ReactMarker::logTaggedMarker(
      ABI41_0_0ReactMarker::REGISTER_JS_SEGMENT_START, tag.c_str());
  if (bundleRegistry_) {
  ...
  ABI41_0_0ReactMarker::logTaggedMarker(
      ABI41_0_0ReactMarker::REGISTER_JS_SEGMENT_STOP, tag.c_str());
}
...
Value JSIExecutor::nativeRequire(const Value *args, size_t count) {
  ...
  return ABI41_0_0facebook::jsi::Value();
}
