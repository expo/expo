...
#import "ABI41_0_0RCTCxxMethod.h"
...
#import <ABI41_0_0cxxreact/ABI41_0_0JsArgumentHelpers.h>
...
@implementation ABI41_0_0RCTCxxMethod {
...
- (id)invokeWithBridge:(ABI41_0_0RCTBridge *)bridge module:(id)module arguments:(NSArray *)arguments
{
  ...
  if (arguments.count < _method->callbacks) {
    ABI41_0_0RCTLogError(
        ...
        ABI41_0_0RCTBridgeModuleNameForClass([module class]),
        _method->name.c_str(),
        _method->callbacks,
        arguments.count);
    return nil;
