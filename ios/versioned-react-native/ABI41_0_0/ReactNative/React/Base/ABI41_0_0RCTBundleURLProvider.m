...
#import "ABI41_0_0RCTBundleURLProvider.h"

#import "ABI41_0_0RCTConvert.h"
#import "ABI41_0_0RCTDefines.h"

NSString *const ABI41_0_0RCTBundleURLProviderUpdatedNotification = @"ABI41_0_0RCTBundleURLProviderUpdatedNotification";

const NSUInteger kABI41_0_0RCTBundleURLProviderDefaultPort = ABI41_0_0RCT_METRO_PORT;

static NSString *const kABI41_0_0RCTJsLocationKey = @"ABI41_0_0RCT_jsLocation";
...
static NSString *const kABI41_0_0RCTEnableLiveReloadKey = @"ABI41_0_0RCT_enableLiveReload_LEGACY";
static NSString *const kABI41_0_0RCTEnableDevKey = @"ABI41_0_0RCT_enableDev";
static NSString *const kABI41_0_0RCTEnableMinificationKey = @"ABI41_0_0RCT_enableMinification";

@implementation ABI41_0_0RCTBundleURLProvider
...
{
  return @{
    kABI41_0_0RCTEnableLiveReloadKey : @NO,
    kABI41_0_0RCTEnableDevKey : @YES,
    kABI41_0_0RCTEnableMinificationKey : @NO,
  };
}

- (void)settingsUpdated
{
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI41_0_0RCTBundleURLProviderUpdatedNotification object:self];
}
...
static NSURL *serverRootWithHostPort(NSString *hostPort)
{
  ...
  return [NSURL
      URLWithString:[NSString
                        stringWithFormat:@"http://%@:%lu/", hostPort, (unsigned long)kABI41_0_0RCTBundleURLProviderDefaultPort]];
}
...
- (NSURL *)jsBundleURLForBundleRoot:(NSString *)bundleRoot fallbackURLProvider:(NSURL * (^)(void))fallbackURLProvider
{
  ...
  if (!packagerServerHost) {
    ...
    return [ABI41_0_0RCTBundleURLProvider jsBundleURLForBundleRoot:bundleRoot
...
- (BOOL)enableDev
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI41_0_0RCTEnableDevKey];
}

- (BOOL)enableLiveReload
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI41_0_0RCTEnableLiveReloadKey];
}

- (BOOL)enableMinification
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI41_0_0RCTEnableMinificationKey];
}

- (NSString *)jsLocation
{
  return [[NSUserDefaults standardUserDefaults] stringForKey:kABI41_0_0RCTJsLocationKey];
}

- (void)setEnableDev:(BOOL)enableDev
{
  [self updateValue:@(enableDev) forKey:kABI41_0_0RCTEnableDevKey];
}

- (void)setEnableLiveReload:(BOOL)enableLiveReload
{
  [self updateValue:@(enableLiveReload) forKey:kABI41_0_0RCTEnableLiveReloadKey];
}

- (void)setJsLocation:(NSString *)jsLocation
{
  [self updateValue:jsLocation forKey:kABI41_0_0RCTJsLocationKey];
}

- (void)setEnableMinification:(BOOL)enableMinification
{
  [self updateValue:@(enableMinification) forKey:kABI41_0_0RCTEnableMinificationKey];
}

+ (instancetype)sharedSettings
{
  static ABI41_0_0RCTBundleURLProvider *sharedInstance;
  static dispatch_once_t once_token;
  dispatch_once(&once_token, ^{
    sharedInstance = [ABI41_0_0RCTBundleURLProvider new];
  });
