...
extern NSString *const ABI41_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI41_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI41_0_0RCTBundleURLProvider : NSObject
