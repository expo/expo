...
#import "ABI41_0_0RCTMultipartDataTask.h"

@interface ABI41_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>

@end

@implementation ABI41_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI41_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI41_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI41_0_0RCTMultipartStreamReader *reader = [[ABI41_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream
                                                                                  boundary:_boundary];
  ABI41_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
