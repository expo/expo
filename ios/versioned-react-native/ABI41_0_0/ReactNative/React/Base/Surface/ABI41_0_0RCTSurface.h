 ...
 */
@interface ABI41_0_0RCTSurface : NSObject
 ...
 *  - Calling on the main queue with `ABI41_0_0RCTSurfaceStageSurfaceDidInitialMounting`
 *    stage temporary is not supported; in this case the stage will be
 *    downgraded to `ABI41_0_0RCTSurfaceStageSurfaceDidInitialLayout`.
 */
 ...
 * Those methods are a no-op for regular ABI41_0_0RCTSurface (for now), but all call sites must call them appropriately.
 */
- (BOOL)start;
- (BOOL)stop;
...
/**
 * Mount the ABI41_0_0React component specified by the given moduleName. This is typically
...
/**
 * Unmount the ABI41_0_0React component specified by the given rootViewTag, called from native.
 */
