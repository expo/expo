...
@protocol ABI41_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI41_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI41_0_0RCTBridgeModules automatically, however
 ...
 * previously called ABI41_0_0facebook::ABI41_0_0React::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI41_0_0RCTBridge *)bridge;
 ...
 */
- (BOOL)bridge:(ABI41_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI41_0_0RCTBridge *)bridge
                 onProgress:(ABI41_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI41_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Similar to loadSourceForBridge:onProgress:onComplete: but without progress
 * reporting.
 */
- (void)loadSourceForBridge:(ABI41_0_0RCTBridge *)bridge withBlock:(ABI41_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Retrieve the list of lazy-native-modules names for the given bridge.
 */
- (NSDictionary<NSString *, Class> *)extraLazyModuleClassesForBridge:(ABI41_0_0RCTBridge *)bridge;
