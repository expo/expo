...
#import "ABI41_0_0RCTKeyCommands.h"
...
NSString *const ABI41_0_0RCTContentDidAppearNotification = @"ABI41_0_0RCTContentDidAppearNotification";

@interface ABI41_0_0RCTUIManager (ABI41_0_0RCTRootView)

- (NSNumber *)allocateRootTag;

@end

@implementation ABI41_0_0RCTRootView {
  ABI41_0_0RCTBridge *_bridge;
  NSString *_moduleName;
  ABI41_0_0RCTRootContentView *_contentView;
             ...
             initialProperties:(NSDictionary *)initialProperties
{
  ...
  ABI41_0_0RCTAssert(bridge, @"A bridge instance is required to create an ABI41_0_0RCTRootView");
  ABI41_0_0RCTAssert(moduleName, @"A moduleName is required to create an ABI41_0_0RCTRootView");

  ABI41_0_0RCT_PROFILE_BEGIN_EVENT(ABI41_0_0RCTProfileTagAlways, @"-[ABI41_0_0RCTRootView init]", nil);
  if (!bridge.isLoading) {
  ...
  if (self = [super initWithFrame:CGRectZero]) {
    ...
    _sizeFlexibility = ABI41_0_0RCTRootViewSizeFlexibilityNone;
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(hideLoadingView)
                                                 name:ABI41_0_0RCTContentDidAppearNotification
                                               object:self];
...
{
  if (self.ABI41_0_0ReactPreferredFocusedView) {
    return self.ABI41_0_0ReactPreferredFocusedView;
  }
...
- (CGSize)sizeThatFits:(CGSize)size
{
  ...
  fitSize = CGSizeMake(
      _sizeFlexibility & ABI41_0_0RCTRootViewSizeFlexibilityWidth ? fitSize.width : currentSize.width,
      _sizeFlexibility & ABI41_0_0RCTRootViewSizeFlexibilityHeight ? fitSize.height : currentSize.height);
...
- (void)setMinimumSize:(CGSize)minimumSize
{
  ...
  __block NSNumber *tag = self.ABI41_0_0ReactTag;
  __weak typeof(self) weakSelf = self;
  ABI41_0_0RCTExecuteOnUIManagerQueue(^{
    __strong typeof(self) strongSelf = weakSelf;
    if (strongSelf && strongSelf->_bridge.isValid) {
      ABI41_0_0RCTRootShadowView *shadowView = (ABI41_0_0RCTRootShadowView *)[strongSelf->_bridge.uiManager shadowViewForABI41_0_0ReactTag:tag];
...
{
  ABI41_0_0RCTAssertMainQueue();
  if (!super.ABI41_0_0ReactTag) {
    /**
     * Every root view that is created must have a unique ABI41_0_0React tag.
     * Numbering of these tags goes from 1, 11, 21, 31, etc
     *
     * NOTE: Since the bridge persists, the RootViews might be reused, so the
     * ABI41_0_0React tag must be re-assigned every time a new UIManager is created.
     */
    self.ABI41_0_0ReactTag = ABI41_0_0RCTAllocateRootViewTag();
  }
  return super.ABI41_0_0ReactTag;
}

- (void)bridgeDidReload
{
  ABI41_0_0RCTAssertMainQueue();
  // Clear the ABI41_0_0ReactTag so it can be re-assigned
  self.ABI41_0_0ReactTag = nil;
}
...
- (void)javaScriptDidLoad:(NSNotification *)notification
{
  ...
  // ABI41_0_0RCTRootContentView is scoped to the right bridge
...
- (void)bundleFinishedLoading:(ABI41_0_0RCTBridge *)bridge
{
  ABI41_0_0RCTAssert(bridge != nil, @"Bridge cannot be nil");
  if (!bridge.valid) {
    return;
  }

  [_contentView removeFromSuperview];
  _contentView = [[ABI41_0_0RCTRootContentView alloc] initWithFrame:self.bounds
                                                    bridge:bridge
  ...
  if (_sizeFlexibility == ABI41_0_0RCTRootViewSizeFlexibilityNone) {
    self.intrinsicContentSize = self.bounds.size;
  }
}

- (void)runApplication:(ABI41_0_0RCTBridge *)bridge
{
  NSString *moduleName = _moduleName ?: @"";
  NSDictionary *appParameters = @{
    @"rootTag" : _contentView.ABI41_0_0ReactTag,
    @"initialProps" : _appProperties ?: @{},
  };

  ABI41_0_0RCTLogInfo(@"Running application %@ (%@)", moduleName, appParameters);
...
@implementation ABI41_0_0RCTRootView (Deprecated)

- (CGSize)intrinsicSize
{
  ABI41_0_0RCTLogWarn(@"Calling deprecated `[-ABI41_0_0RCTRootView intrinsicSize]`.");
  return self.intrinsicContentSize;
}

- (void)cancelTouches
{
  ABI41_0_0RCTLogWarn(@"`-[ABI41_0_0RCTRootView cancelTouches]` is deprecated and will be deleted soon.");
