 ...
 */
@interface ABI41_0_0RCTImageSource : NSObject
...
@interface ABI41_0_0RCTConvert (ImageSource)

+ (ABI41_0_0RCTImageSource *)ABI41_0_0RCTImageSource:(id)json;
+ (NSArray<ABI41_0_0RCTImageSource *> *)ABI41_0_0RCTImageSourceArray:(id)json;
