...
#import "ABI41_0_0RCTUIUtils.h"

#import "ABI41_0_0RCTUtils.h"

ABI41_0_0RCTDimensions ABI41_0_0RCTGetDimensions(CGFloat fontScale)
{
  UIScreen *mainScreen = UIScreen.mainScreen;
  CGSize screenSize = mainScreen.bounds.size;

  UIView *mainWindow;
  mainWindow = ABI41_0_0RCTKeyWindow();
  CGSize windowSize = mainWindow.bounds.size;

  ABI41_0_0RCTDimensions result;
...
CGFloat ABI41_0_0RCTGetMultiplierForContentSizeCategory(UIContentSizeCategory category)
{
