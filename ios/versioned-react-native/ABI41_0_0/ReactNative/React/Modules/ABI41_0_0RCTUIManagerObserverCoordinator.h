...
typedef dispatch_block_t ABI41_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI41_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ABI41_0_0React-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI41_0_0RCTUIManager's observers.
 */
@interface ABI41_0_0RCTUIManagerObserverCoordinator : NSObject <ABI41_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI41_0_0RCTUIManagerObserver` protocol for more info.
