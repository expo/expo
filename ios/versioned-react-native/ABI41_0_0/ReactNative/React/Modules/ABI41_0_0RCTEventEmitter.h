...
#import <ABI41_0_0React/ABI41_0_0RCTJSInvokerModule.h>

/**
 * ABI41_0_0RCTEventEmitter is an abstract base class to be used for modules that emit
 * events to be observed by JS.
 */
@interface ABI41_0_0RCTEventEmitter : NSObject <ABI41_0_0RCTBridgeModule, ABI41_0_0RCTJSInvokerModule>
