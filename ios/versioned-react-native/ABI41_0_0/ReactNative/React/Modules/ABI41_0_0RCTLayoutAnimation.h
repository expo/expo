...
#import <ABI41_0_0React/ABI41_0_0RCTAnimationType.h>

@interface ABI41_0_0RCTLayoutAnimation : NSObject
...
@property (nonatomic, readonly) ABI41_0_0RCTAnimationType animationType;
...
- (instancetype)initWithDuration:(NSTimeInterval)duration
                 ...
                 initialVelocity:(CGFloat)initialVelocity
                   animationType:(ABI41_0_0RCTAnimationType)animationType;
