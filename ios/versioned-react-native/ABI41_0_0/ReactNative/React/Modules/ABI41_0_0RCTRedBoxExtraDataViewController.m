...
#import "ABI41_0_0RCTRedBoxExtraDataViewController.h"

@interface ABI41_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI41_0_0RCTRedBoxExtraDataCell
...
@interface ABI41_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI41_0_0RCTRedBoxExtraDataViewController {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  ABI41_0_0RCTRedBoxExtraDataCell *cell =
      (ABI41_0_0RCTRedBoxExtraDataCell *)[tableView dequeueReusableCellWithIdentifier:reuseIdentifier];

  if (cell == nil) {
    cell = [[ABI41_0_0RCTRedBoxExtraDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
  }
