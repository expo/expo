...
@class ABI41_0_0RCTPackagerClientResponder;
...
extern const int ABI41_0_0RCT_PACKAGER_CLIENT_PROTOCOL_VERSION;

#if defined(__cplusplus)
}
#endif

@protocol ABI41_0_0RCTPackagerClientMethod <NSObject>

- (void)handleRequest:(NSDictionary<NSString *, id> *)params withResponder:(ABI41_0_0RCTPackagerClientResponder *)responder;
...
@interface ABI41_0_0RCTPackagerClientResponder : NSObject
