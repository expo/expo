...
typedef uint32_t ABI41_0_0RCTHandlerToken;
typedef void (^ABI41_0_0RCTNotificationHandler)(NSDictionary<NSString *, id> *);
typedef void (^ABI41_0_0RCTRequestHandler)(NSDictionary<NSString *, id> *, ABI41_0_0RCTPackagerClientResponder *);
typedef void (^ABI41_0_0RCTConnectedHandler)(void);

/** Encapsulates singleton connection to ABI41_0_0React Native packager. */
@interface ABI41_0_0RCTPackagerConnection : NSObject
