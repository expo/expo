...
@protocol ABI41_0_0RCTPackagerClientMethod;

/**
 * An abstraction for a key-value store to manage ABI41_0_0RCTDevSettings behavior.
 * The default implementation persists settings using NSUserDefaults.
 */
@protocol ABI41_0_0RCTDevSettingsDataSource <NSObject>
...
@interface ABI41_0_0RCTDevSettings : ABI41_0_0RCTEventEmitter
...
/*
 * Whether shaking will show ABI41_0_0RCTDevMenu. The menu is enabled by default if ABI41_0_0RCT_DEV=1, but
...
- (void)addHandler:(id<ABI41_0_0RCTPackagerClientMethod>)handler
    forPackagerMethod:(NSString *)name __deprecated_msg("Use ABI41_0_0RCTPackagerConnection directly instead");
#endif

@end

@interface ABI41_0_0RCTBridge (ABI41_0_0RCTDevSettings)

@property (nonatomic, readonly) ABI41_0_0RCTDevSettings *devSettings;
...
// (i.e. ABI41_0_0RCT_DEV or ABI41_0_0RCT_DEV_MENU is set)
ABI41_0_0RCT_EXTERN void ABI41_0_0RCTDevSettingsSetEnabled(BOOL enabled);
