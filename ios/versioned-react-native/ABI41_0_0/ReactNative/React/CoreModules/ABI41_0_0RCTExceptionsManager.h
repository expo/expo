...
@protocol ABI41_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI41_0_0RCTExceptionsManager : NSObject <ABI41_0_0RCTBridgeModule>
...
@property (nonatomic, weak) id<ABI41_0_0RCTExceptionsManagerDelegate> delegate;
