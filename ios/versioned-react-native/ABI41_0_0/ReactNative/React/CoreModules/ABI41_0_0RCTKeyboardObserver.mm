...
#import "ABI41_0_0RCTKeyboardObserver.h"
...
static NSDictionary *ABI41_0_0RCTParseKeyboardNotification(NSNotification *notification);

@interface ABI41_0_0RCTKeyboardObserver () <ABI41_0_0NativeKeyboardObserverSpec>
@end

@implementation ABI41_0_0RCTKeyboardObserver
...
#define IMPLEMENT_KEYBOARD_HANDLER(EVENT)                                              \
  ...
  {                                                                                    \
    ...
    [self sendEventWithName:@ #EVENT body:ABI41_0_0RCTParseKeyboardNotification(notification)]; \
  }
...
{
  return std::make_shared<ABI41_0_0facebook::ABI41_0_0React::NativeKeyboardObserverSpecJSI>(self, jsInvoker, nativeInvoker, perfLogger);
}

@end

NS_INLINE NSDictionary *ABI41_0_0RCTRectDictionaryValue(CGRect rect)
{
  return @{
...
static NSString *ABI41_0_0RCTAnimationNameForCurve(UIViewAnimationCurve curve)
{
  switch (curve) {
...
static NSDictionary *ABI41_0_0RCTParseKeyboardNotification(NSNotification *notification)
{
  ...
  return @{
    @"startCoordinates" : ABI41_0_0RCTRectDictionaryValue(beginFrame),
    @"endCoordinates" : ABI41_0_0RCTRectDictionaryValue(endFrame),
    @"duration" : @(duration * 1000.0), // ms
    @"easing" : ABI41_0_0RCTAnimationNameForCurve(curve),
    @"isEventFromThisApp" : isLocalUserInfoKey == 1 ? @YES : @NO,
  };
#endif
}

Class ABI41_0_0RCTKeyboardObserverCls(void)
{
  return ABI41_0_0RCTKeyboardObserver.class;
}
