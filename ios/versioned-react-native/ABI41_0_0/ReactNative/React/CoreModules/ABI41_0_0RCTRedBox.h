...
typedef void (^ABI41_0_0RCTRedBoxButtonPressHandler)(void);

@interface ABI41_0_0RCTRedBox : NSObject <ABI41_0_0RCTBridgeModule>

- (void)registerErrorCustomizer:(id<ABI41_0_0RCTErrorCustomizer>)errorCustomizer;
...
- (void)showErrorMessage:(NSString *)message withParsedStack:(NSArray<ABI41_0_0RCTJSStackFrame *> *)stack;
- (void)updateErrorMessage:(NSString *)message withParsedStack:(NSArray<ABI41_0_0RCTJSStackFrame *> *)stack;
- (void)showErrorMessage:(NSString *)message
         withParsedStack:(NSArray<ABI41_0_0RCTJSStackFrame *> *)stack
...
- (void)addCustomButton:(NSString *)title onPressHandler:(ABI41_0_0RCTRedBoxButtonPressHandler)handler;
...
/**
 * This category makes the red box instance available via the ABI41_0_0RCTBridge, which
 * is useful for any class that needs to access the red box or error log.
 */
@interface ABI41_0_0RCTBridge (ABI41_0_0RCTRedBox)

@property (nonatomic, readonly) ABI41_0_0RCTRedBox *redBox;
