...
typedef UIFont * (^ABI41_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ABI41_0_0React Native will use the System font for rendering by default. If you want to
 ...
 */
ABI41_0_0RCT_EXTERN void ABI41_0_0RCTSetDefaultFontHandler(ABI41_0_0RCTFontHandler handler);
ABI41_0_0RCT_EXTERN BOOL ABI41_0_0RCTHasFontHandlerSet(void);

@interface ABI41_0_0RCTFont : NSObject
...
@interface ABI41_0_0RCTConvert (ABI41_0_0RCTFont)
