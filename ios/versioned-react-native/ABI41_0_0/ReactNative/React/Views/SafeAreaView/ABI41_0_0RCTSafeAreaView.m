...
@implementation ABI41_0_0RCTSafeAreaView {
...
ABI41_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithCoder : (NSCoder *)decoder)
...
{
  UIViewController *vc = self.ABI41_0_0ReactViewController;
...
{
  if (UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI41_0_0RCTScreenScale())) {
    return;
  }

  _currentSafeAreaInsets = safeAreaInsets;

  ABI41_0_0RCTSafeAreaViewLocalData *localData = [[ABI41_0_0RCTSafeAreaViewLocalData alloc] initWithInsets:safeAreaInsets];
