...
@implementation ABI41_0_0RCTModalHostViewController {
...
#if !TARGET_OS_TV
  _preferredStatusBarStyle = [ABI41_0_0RCTSharedApplication() statusBarStyle];
  _preferredStatusBarHidden = [ABI41_0_0RCTSharedApplication() isStatusBarHidden];
#endif
