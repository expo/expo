...
#import "ABI41_0_0RCTBorderDrawing.h"
#import "ABI41_0_0RCTLog.h"

static const CGFloat ABI41_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI41_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return ABS(borderInsets.left - borderInsets.right) < ABI41_0_0RCTViewBorderThreshold &&
      ABS(borderInsets.left - borderInsets.bottom) < ABI41_0_0RCTViewBorderThreshold &&
      ABS(borderInsets.left - borderInsets.top) < ABI41_0_0RCTViewBorderThreshold;
}

BOOL ABI41_0_0RCTCornerRadiiAreEqual(ABI41_0_0RCTCornerRadii cornerRadii)
{
  return ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI41_0_0RCTViewBorderThreshold &&
      ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI41_0_0RCTViewBorderThreshold &&
      ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI41_0_0RCTViewBorderThreshold;
}

BOOL ABI41_0_0RCTBorderColorsAreEqual(ABI41_0_0RCTBorderColors borderColors)
{
...
ABI41_0_0RCTCornerInsets ABI41_0_0RCTGetCornerInsets(ABI41_0_0RCTCornerRadii cornerRadii, UIEdgeInsets edgeInsets)
{
  return (ABI41_0_0RCTCornerInsets){{
...
static UIEdgeInsets ABI41_0_0RCTRoundInsetsToPixel(UIEdgeInsets edgeInsets)
{
  edgeInsets.top = ABI41_0_0RCTRoundPixelValue(edgeInsets.top);
  edgeInsets.bottom = ABI41_0_0RCTRoundPixelValue(edgeInsets.bottom);
  edgeInsets.left = ABI41_0_0RCTRoundPixelValue(edgeInsets.left);
  edgeInsets.right = ABI41_0_0RCTRoundPixelValue(edgeInsets.right);

  return edgeInsets;
}

static void ABI41_0_0RCTPathAddEllipticArc(
...
CGPathRef ABI41_0_0RCTPathCreateWithRoundedRect(CGRect bounds, ABI41_0_0RCTCornerInsets cornerInsets, const CGAffineTransform *transform)
{
  ...
  ABI41_0_0RCTPathAddEllipticArc(
...
static void
ABI41_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds, CGPoint lineStart, CGPoint lineEnd, CGPoint intersections[2])
{
...
NS_INLINE BOOL ABI41_0_0RCTCornerRadiiAreAboveThreshold(ABI41_0_0RCTCornerRadii cornerRadii)
{
  return (
      cornerRadii.topLeft > ABI41_0_0RCTViewBorderThreshold || cornerRadii.topRight > ABI41_0_0RCTViewBorderThreshold ||
      cornerRadii.bottomLeft > ABI41_0_0RCTViewBorderThreshold || cornerRadii.bottomRight > ABI41_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI41_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI41_0_0RCTCornerRadii cornerRadii)
{
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI41_0_0RCTPathCreateWithRoundedRect(rect, ABI41_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef
ABI41_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge)
{
...
static UIImage *ABI41_0_0RCTGetSolidBorderImage(
    ...
    BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI41_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI41_0_0RCTCornerInsets cornerInsets = ABI41_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  borderInsets = ABI41_0_0RCTRoundInsetsToPixel(borderInsets);
  ...
  CGContextRef ctx = ABI41_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI41_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI41_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI41_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI41_0_0RCTEllipseGetIntersectionsWithLine(
...
static UIImage *ABI41_0_0RCTGetDashedOrDottedBorderImage(
    ...
    BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI41_0_0RCTBorderStyleDashed || borderStyle == ABI41_0_0RCTBorderStyleDotted);

  if (!ABI41_0_0RCTBorderColorsAreEqual(borderColors) || !ABI41_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI41_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI41_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI41_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI41_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI41_0_0RCTPathCreateWithRoundedRect(pathRect, ABI41_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI41_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
...
UIImage *ABI41_0_0RCTGetBorderImage(
    ABI41_0_0RCTBorderStyle borderStyle,
    CGSize viewSize,
    ABI41_0_0RCTCornerRadii cornerRadii,
    UIEdgeInsets borderInsets,
...
{
  switch (borderStyle) {
    case ABI41_0_0RCTBorderStyleSolid:
      return ABI41_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI41_0_0RCTBorderStyleDashed:
    case ABI41_0_0RCTBorderStyleDotted:
      return ABI41_0_0RCTGetDashedOrDottedBorderImage(
          borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI41_0_0RCTBorderStyleUnset:
      break;
  }
