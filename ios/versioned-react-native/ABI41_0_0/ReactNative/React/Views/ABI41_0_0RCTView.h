...
@protocol ABI41_0_0RCTAutoInsetsProtocol;

@class ABI41_0_0RCTView;

@interface ABI41_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI41_0_0RCTDirectEventBlock onAccessibilityAction;
@property (nonatomic, copy) ABI41_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI41_0_0RCTDirectEventBlock onMagicTap;
@property (nonatomic, copy) ABI41_0_0RCTDirectEventBlock onAccessibilityEscape;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI41_0_0RCTPointerEvents pointerEvents;

+ (void)autoAdjustInsetsForView:(UIView<ABI41_0_0RCTAutoInsetsProtocol> *)parentView
 ...
 */
@property (nonatomic, assign) UIUserInterfaceLayoutDirection ABI41_0_0ReactLayoutDirection;
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI41_0_0RCTBorderStyle borderStyle;
