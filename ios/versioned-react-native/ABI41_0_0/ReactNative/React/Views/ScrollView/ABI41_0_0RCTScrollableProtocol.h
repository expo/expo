...
/**
 * Contains any methods related to scrolling. Any `ABI41_0_0RCTView` that has scrolling
 * features should implement these methods.
 */
@protocol ABI41_0_0RCTScrollableProtocol
 ...
 */
@protocol ABI41_0_0RCTCustomRefreshContolProtocol
