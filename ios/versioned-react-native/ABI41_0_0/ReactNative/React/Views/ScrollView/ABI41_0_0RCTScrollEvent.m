...
#import "ABI41_0_0RCTScrollEvent.h"
#import <ABI41_0_0React/ABI41_0_0RCTAssert.h>

@implementation ABI41_0_0RCTScrollEvent {
...
- (ABI41_0_0RCTScrollEvent *)coalesceWithEvent:(ABI41_0_0RCTScrollEvent *)newEvent
{
...
- (NSArray *)arguments
{
  return @[ self.viewTag, ABI41_0_0RCTNormalizeInputEventName(self.eventName), [self body] ];
}
