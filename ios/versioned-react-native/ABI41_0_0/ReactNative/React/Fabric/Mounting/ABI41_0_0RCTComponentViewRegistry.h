 ...
 */
@interface ABI41_0_0RCTComponentViewRegistry : NSObject

@property (nonatomic, strong, readonly) ABI41_0_0RCTComponentViewFactory *componentViewFactory;
 ...
 * #RefuseSingleUse
 */
- (ABI41_0_0RCTComponentViewDescriptor)dequeueComponentViewWithComponentHandle:(ABI41_0_0facebook::ABI41_0_0React::ComponentHandle)componentHandle
                                                                  tag:(ABI41_0_0facebook::ABI41_0_0React::Tag)tag;

/**
 * Puts a given native component view to the recycle pool.
 * #RefuseSingleUse
 */
- (void)enqueueComponentViewWithComponentHandle:(ABI41_0_0facebook::ABI41_0_0React::ComponentHandle)componentHandle
                                            tag:(ABI41_0_0facebook::ABI41_0_0React::Tag)tag
 ...
 */
- (ABI41_0_0RCTComponentViewDescriptor const &)componentViewDescriptorWithTag:(ABI41_0_0facebook::ABI41_0_0React::Tag)tag;

/**
 * Finds a native component view by given `tag`.
 * Returns `nil` if there is no registered component with the `tag`.
 */
- (nullable UIView<ABI41_0_0RCTComponentViewProtocol> *)findComponentViewWithTag:(ABI41_0_0facebook::ABI41_0_0React::Tag)tag;

/**
 * Creates a component view with a given type and puts it to the recycle pool.
 */
- (void)optimisticallyCreateComponentViewWithComponentHandle:(ABI41_0_0facebook::ABI41_0_0React::ComponentHandle)componentHandle;
