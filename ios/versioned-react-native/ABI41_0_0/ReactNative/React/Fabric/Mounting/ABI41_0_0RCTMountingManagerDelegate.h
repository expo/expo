 ...
 */
@protocol ABI41_0_0RCTMountingManagerDelegate <NSObject>
 ...
 */
- (void)mountingManager:(ABI41_0_0RCTMountingManager *)mountingManager willMountComponentsWithRootTag:(ABI41_0_0ReactTag)MountingManager;
