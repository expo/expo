 ...
 */
class ABI41_0_0RCTComponentViewDescriptor final {
 public:
  /*
   * Associated (and owned) native view instance.
   */
  __strong UIView<ABI41_0_0RCTComponentViewProtocol> *view = nil;

  /*
   * Indicates a requirement to call on the view methods from
   * `ABI41_0_0RCTMountingTransactionObserving` protocol.
   */
  bool observesMountingTransactionWillMount{false};
  bool observesMountingTransactionDidMount{false};
};

inline bool operator==(ABI41_0_0RCTComponentViewDescriptor const &lhs, ABI41_0_0RCTComponentViewDescriptor const &rhs)
{
...
template <>
struct std::hash<ABI41_0_0RCTComponentViewDescriptor> {
  size_t operator()(ABI41_0_0RCTComponentViewDescriptor const &componentViewDescriptor) const
  {
