...
#import "ABI41_0_0RCTPullToRefreshViewComponentView.h"
...
#import <ABI41_0_0React/ABI41_0_0RCTRefreshableProtocol.h>
#import <ABI41_0_0React/ABI41_0_0RCTScrollViewComponentView.h>

#import "ABI41_0_0FBABI41_0_0RCTFabricComponentsPlugins.h"

using namespace ABI41_0_0facebook::ABI41_0_0React;

@interface ABI41_0_0RCTPullToRefreshViewComponentView () <ABI41_0_0RCTPullToRefreshViewViewProtocol, ABI41_0_0RCTRefreshableProtocol>
@end

@implementation ABI41_0_0RCTPullToRefreshViewComponentView {
  UIRefreshControl *_refreshControl;
  ABI41_0_0RCTScrollViewComponentView *_scrollViewComponentView;
}
...
- (void)_updateTitle
{
  ...
  if (concreteProps.titleColor) {
    attributes[NSForegroundColorAttributeName] = ABI41_0_0RCTUIColorFromSharedColor(concreteProps.titleColor);
  }

  _refreshControl.attributedTitle =
      [[NSAttributedString alloc] initWithString:ABI41_0_0RCTNSStringFromString(concreteProps.title) attributes:attributes];
}
...
- (void)_attach
{
  ...
  _scrollViewComponentView = [ABI41_0_0RCTScrollViewComponentView findScrollViewComponentViewForView:self];
  if (!_scrollViewComponentView) {
    return;
  }
...
{
  ABI41_0_0RCTPullToRefreshViewHandleCommand(self, commandName, args);
}
...
#pragma mark - ABI41_0_0RCTRefreshableProtocol
...
Class<ABI41_0_0RCTComponentViewProtocol> ABI41_0_0RCTPullToRefreshViewCls(void)
{
  return ABI41_0_0RCTPullToRefreshViewComponentView.class;
}
