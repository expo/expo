...
#import <ABI41_0_0React/ABI41_0_0RCTSurfaceTouchHandler.h>

@implementation ABI41_0_0RCTFabricModalHostViewController {
  CGRect _lastViewBounds;
  ABI41_0_0RCTSurfaceTouchHandler *_touchHandler;
}
...
- (instancetype)init
{
  ...
  _touchHandler = [ABI41_0_0RCTSurfaceTouchHandler new];
...
{
  return [ABI41_0_0RCTSharedApplication() statusBarStyle];
}
...
{
  return [ABI41_0_0RCTSharedApplication() isStatusBarHidden];
}
...
- (UIInterfaceOrientationMask)supportedInterfaceOrientations
{
  UIInterfaceOrientationMask appSupportedOrientationsMask =
      [ABI41_0_0RCTSharedApplication() supportedInterfaceOrientationsForWindow:[ABI41_0_0RCTSharedApplication() keyWindow]];
