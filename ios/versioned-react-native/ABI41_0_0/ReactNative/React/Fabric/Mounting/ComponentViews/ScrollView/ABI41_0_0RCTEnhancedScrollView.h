 ...
 * which are not directly related to ABI41_0_0React Native.
 */
@interface ABI41_0_0RCTEnhancedScrollView : UIScrollView
 ...
 */
@property (nonatomic, strong, readonly) ABI41_0_0RCTGenericDelegateSplitter<id<UIScrollViewDelegate>> *delegateSplitter;
