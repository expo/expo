...
#import <ABI41_0_0React/ABI41_0_0RCTGenericDelegateSplitter.h>
 ...
 */
@interface ABI41_0_0RCTScrollViewComponentView : ABI41_0_0RCTViewComponentView

/*
 * Finds and returns the closet ABI41_0_0RCTScrollViewComponentView component to the given view
 */
...
/*
 * ABI41_0_0RCTScrollableProtocol is a protocol which ABI41_0_0RCTScrollViewManager uses to communicate with all kinds of `UIScrollView`s.
 ...
 */
@interface ABI41_0_0RCTScrollViewComponentView (ScrollableProtocol) <ABI41_0_0RCTScrollableProtocol>
