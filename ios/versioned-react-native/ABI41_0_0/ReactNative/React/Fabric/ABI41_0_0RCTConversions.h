...
#import <ABI41_0_0React/components/view/AccessibilityPrimitives.h>
#import <ABI41_0_0React/components/view/primitives.h>
#import <ABI41_0_0React/core/LayoutPrimitives.h>
#import <ABI41_0_0React/graphics/Color.h>
#import <ABI41_0_0React/graphics/Geometry.h>
#import <ABI41_0_0React/graphics/Transform.h>

NS_ASSUME_NONNULL_BEGIN

inline NSString *ABI41_0_0RCTNSStringFromString(
...
inline NSString *_Nullable ABI41_0_0RCTNSStringFromStringNilIfEmpty(
    const std::string &string,
    const NSStringEncoding &encoding = NSUTF8StringEncoding)
{
  return string.empty() ? nil : ABI41_0_0RCTNSStringFromString(string, encoding);
}

inline std::string ABI41_0_0RCTStringFromNSString(NSString *string, const NSStringEncoding &encoding = NSUTF8StringEncoding)
{
  return [string cStringUsingEncoding:encoding];
}

inline UIColor *_Nullable ABI41_0_0RCTUIColorFromSharedColor(const ABI41_0_0facebook::ABI41_0_0React::SharedColor &sharedColor)
{
  return sharedColor ? [UIColor colorWithCGColor:sharedColor.get()] : nil;
}

inline CF_RETURNS_NOT_RETAINED CGColorRef
ABI41_0_0RCTCGColorRefUnretainedFromSharedColor(const ABI41_0_0facebook::ABI41_0_0React::SharedColor &sharedColor)
{
  return sharedColor ? sharedColor.get() : nil;
}

inline CF_RETURNS_RETAINED CGColorRef ABI41_0_0RCTCGColorRefFromSharedColor(const ABI41_0_0facebook::ABI41_0_0React::SharedColor &sharedColor)
{
  return sharedColor ? CGColorCreateCopy(sharedColor.get()) : nil;
}

inline CGPoint ABI41_0_0RCTCGPointFromPoint(const ABI41_0_0facebook::ABI41_0_0React::Point &point)
{
  return {point.x, point.y};
}

inline CGSize ABI41_0_0RCTCGSizeFromSize(const ABI41_0_0facebook::ABI41_0_0React::Size &size)
{
  return {size.width, size.height};
}

inline CGRect ABI41_0_0RCTCGRectFromRect(const ABI41_0_0facebook::ABI41_0_0React::Rect &rect)
{
  return {ABI41_0_0RCTCGPointFromPoint(rect.origin), ABI41_0_0RCTCGSizeFromSize(rect.size)};
}

inline UIEdgeInsets ABI41_0_0RCTUIEdgeInsetsFromEdgeInsets(const ABI41_0_0facebook::ABI41_0_0React::EdgeInsets &edgeInsets)
{
  return {edgeInsets.top, edgeInsets.left, edgeInsets.bottom, edgeInsets.right};
}

inline UIAccessibilityTraits ABI41_0_0RCTUIAccessibilityTraitsFromAccessibilityTraits(
    ABI41_0_0facebook::ABI41_0_0React::AccessibilityTraits accessibilityTraits)
{
  using AccessibilityTraits = ABI41_0_0facebook::ABI41_0_0React::AccessibilityTraits;
...
inline CATransform3D ABI41_0_0RCTCATransform3DFromTransformMatrix(const ABI41_0_0facebook::ABI41_0_0React::Transform &transformMatrix)
{
...
inline ABI41_0_0facebook::ABI41_0_0React::Point ABI41_0_0RCTPointFromCGPoint(const CGPoint &point)
{
  return {point.x, point.y};
}

inline ABI41_0_0facebook::ABI41_0_0React::Size ABI41_0_0RCTSizeFromCGSize(const CGSize &size)
{
  return {size.width, size.height};
}

inline ABI41_0_0facebook::ABI41_0_0React::Rect ABI41_0_0RCTRectFromCGRect(const CGRect &rect)
{
  return {ABI41_0_0RCTPointFromCGPoint(rect.origin), ABI41_0_0RCTSizeFromCGSize(rect.size)};
}

inline ABI41_0_0facebook::ABI41_0_0React::EdgeInsets ABI41_0_0RCTEdgeInsetsFromUIEdgeInsets(const UIEdgeInsets &edgeInsets)
{
  return {edgeInsets.left, edgeInsets.top, edgeInsets.right, edgeInsets.bottom};
}

inline ABI41_0_0facebook::ABI41_0_0React::LayoutDirection ABI41_0_0RCTLayoutDirection(BOOL isRTL)
{
  return isRTL ? ABI41_0_0facebook::ABI41_0_0React::LayoutDirection::RightToLeft : ABI41_0_0facebook::ABI41_0_0React::LayoutDirection::LeftToRight;
}
