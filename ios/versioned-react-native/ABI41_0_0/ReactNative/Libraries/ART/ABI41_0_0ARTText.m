...
@implementation ABI41_0_0ARTText
...
static void ABI41_0_0ARTFreeTextFrame(ABI41_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI41_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI41_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI41_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI41_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
