...
#import <ABI41_0_0React/ABI41_0_0ARTRenderable.h>

@implementation ABI41_0_0ARTRenderable

- (void)setFill:(ABI41_0_0ARTBrush *)fill
{
  [self invalidate];
  _fill = fill;
}
...
- (void)setStrokeDash:(ABI41_0_0ARTCGFloatArray)strokeDash
{
