...
#import "ABI41_0_0RCTImagePickerManager.h"
...
@interface ABI41_0_0RCTImagePickerController : UIImagePickerController

@property (nonatomic, assign) BOOL unmirrorFrontFacingCamera;

@end

@implementation ABI41_0_0RCTImagePickerController

@end

@interface ABI41_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate, ABI41_0_0NativeImagePickerIOSSpec>
@end

@implementation ABI41_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI41_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI41_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
  NSMutableDictionary<NSString *, NSDictionary<NSString *, id> *> *_pendingVideoInfo;
}

ABI41_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI41_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI41_0_0RCTResponseSenderBlock)callback)
{
...
ABI41_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI41_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI41_0_0RCT_EXPORT_METHOD(openCameraDialog:(JS::NativeImagePickerIOS::SpecOpenCameraDialogConfig &)config
                  successCallback:(ABI41_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI41_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  ABI41_0_0RCTImagePickerController *imagePicker = [ABI41_0_0RCTImagePickerController new];
...
ABI41_0_0RCT_EXPORT_METHOD(openSelectDialog:(JS::NativeImagePickerIOS::SpecOpenSelectDialogConfig &)config
                  successCallback:(ABI41_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI41_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI41_0_0RCTRunningInAppExtension()) {
...
ABI41_0_0RCT_EXPORT_METHOD(clearAllPendingVideos)
{
...
ABI41_0_0RCT_EXPORT_METHOD(removePendingVideo:(NSString *)url)
{
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    ...
    [self _dismissPicker:picker args:@[imageURLString, ABI41_0_0RCTNullIfNil(height), ABI41_0_0RCTNullIfNil(width)]];
    return;
  }
  ...
  [_bridge.imageStoreManager storeImage:originalImage withBlock:^(NSString *tempImageTag) {
    [self _dismissPicker:picker args:tempImageTag ? @[tempImageTag, ABI41_0_0RCTNullIfNil(height), ABI41_0_0RCTNullIfNil(width)] : nil];
  }];
}
        ...
        cancelCallback:(ABI41_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI41_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI41_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI41_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
...
- (void)cameraChanged:(NSNotification *)notification
{
  for (UIImagePickerController *picker in _pickers) {
    ...
    if ([picker isKindOfClass:[ABI41_0_0RCTImagePickerController class]]
      && ((ABI41_0_0RCTImagePickerController *)picker).unmirrorFrontFacingCamera
...
{
  return std::make_shared<ABI41_0_0facebook::ABI41_0_0React::NativeImagePickerIOSSpecJSI>(self, jsInvoker, nativeInvoker, perfLogger);
}

@end

Class ABI41_0_0RCTImagePickerManagerCls(void) {
  return ABI41_0_0RCTImagePickerManager.class;
}
