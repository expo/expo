...
#import "ABI41_0_0RCTCameraRollManager.h"
...
@implementation ABI41_0_0RCTConvert (PHAssetCollectionSubtype)

ABI41_0_0RCT_ENUM_CONVERTER(PHAssetCollectionSubtype, (@{
...
@implementation ABI41_0_0RCTConvert (PHFetchOptions)
...
+ (PHFetchOptions *)PHFetchOptionsFromMediaType:(NSString *)mediaType
{
  ...
  if ([lowercase isEqualToString:@"photos"]) {
    ...
    if (![lowercase isEqualToString:@"all"]) {
      ABI41_0_0RCTLogError(@"Invalid filter option: '%@'. Expected one of 'photos',"
...
@interface ABI41_0_0RCTCameraRollManager() <ABI41_0_0NativeCameraRollManagerSpec>
@end

@implementation ABI41_0_0RCTCameraRollManager
...
static void requestPhotoLibraryAccess(ABI41_0_0RCTPromiseRejectBlock reject, PhotosAuthorizedBlock authorizedBlock) {
...
ABI41_0_0RCT_EXPORT_METHOD(saveToCameraRoll:(NSURLRequest *)request
                  type:(NSString *)type
                  ...
                  reject:(ABI41_0_0RCTPromiseRejectBlock)reject)
{
  ...
  void (^loadBlock)(void) = ^void() {
    if ([type isEqualToString:@"video"]) {
      ...
      [[self.bridge moduleForClass:[ABI41_0_0RCTImageLoader class]] loadImageWithURLRequest:request callback:^(NSError *error, UIImage *image) {
        if (error) {
...
static void ABI41_0_0RCTResolvePromise(ABI41_0_0RCTPromiseResolveBlock resolve,
...
ABI41_0_0RCT_EXPORT_METHOD(getPhotos:(JS::NativeCameraRollManager::GetPhotosParams &)params
                  resolve:(ABI41_0_0RCTPromiseResolveBlock)resolve
                  reject:(ABI41_0_0RCTPromiseRejectBlock)reject)
{
  checkPhotoLibraryConfig();

  NSUInteger const first = [ABI41_0_0RCTConvert NSInteger:[NSNumber numberWithDouble:params.first()]];
  NSString *const afterCursor = [ABI41_0_0RCTConvert NSString:params.after()];
  NSString *const groupName = [ABI41_0_0RCTConvert NSString:params.groupName()];
  NSString *const groupTypes = [[ABI41_0_0RCTConvert NSString:params.groupTypes()] lowercaseString];
  NSString *const mediaType = [ABI41_0_0RCTConvert NSString:params.assetType()];
  NSArray<NSString *> *const mimeTypes = [ABI41_0_0RCTConvert NSStringArray:ABI41_0_0RCTConvertOptionalVecToArray(params.mimeTypes())];
  ...
  PHAssetCollectionSubtype const collectionSubtype = [ABI41_0_0RCTConvert PHAssetCollectionSubtype:groupTypes];

  // Predicate for fetching assets within a collection
  PHFetchOptions *const assetFetchOptions = [ABI41_0_0RCTConvert PHFetchOptionsFromMediaType:mediaType];
    ...
    [assetCollectionFetchResult enumerateObjectsUsingBlock:^(PHAssetCollection * _Nonnull assetCollection, NSUInteger collectionIdx, BOOL * _Nonnull stopCollections) {
      ...
      [assetsFetchResult enumerateObjectsUsingBlock:^(PHAsset * _Nonnull asset, NSUInteger assetIdx, BOOL * _Nonnull stopAssets) {
        ...
        if (first == assets.count) {
          ...
          *stopCollections = YES;
          hasNextPage = YES;
          ABI41_0_0RCTAssert(resolvedPromise == NO, @"Resolved the promise before we finished processing the results.");
          ABI41_0_0RCTResolvePromise(resolve, assets, hasNextPage);
          resolvedPromise = YES;
          return;
        }
...
ABI41_0_0RCT_EXPORT_METHOD(deletePhotos:(NSArray<NSString *>*)assets
                  resolve:(ABI41_0_0RCTPromiseResolveBlock)resolve
                  reject:(ABI41_0_0RCTPromiseRejectBlock)reject)
{
  NSArray<NSURL *> *assets_ = [ABI41_0_0RCTConvert NSURLArray:assets];
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
...
static void checkPhotoLibraryConfig()
{
  ...
  if (![[NSBundle mainBundle] objectForInfoDictionaryKey:@"NSPhotoLibraryUsageDescription"]) {
    ABI41_0_0RCTLogError(@"NSPhotoLibraryUsageDescription key must be present in Info.plist to use camera roll.");
  }
#endif
}
...
{
  return std::make_shared<ABI41_0_0facebook::ABI41_0_0React::NativeCameraRollManagerSpecJSI>(self, jsInvoker, nativeInvoker, perfLogger);
}

@end

Class ABI41_0_0RCTCameraRollManagerCls(void) {
  return ABI41_0_0RCTCameraRollManager.class;
}
