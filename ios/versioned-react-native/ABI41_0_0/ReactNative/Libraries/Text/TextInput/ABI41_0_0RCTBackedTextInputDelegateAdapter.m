...
#import <ABI41_0_0React/ABI41_0_0RCTBackedTextInputDelegateAdapter.h>
...
@interface ABI41_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI41_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI41_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
...
@interface ABI41_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI41_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI41_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}
