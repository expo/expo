...
@implementation ABI41_0_0RCTMultilineTextInputView
{
  ABI41_0_0RCTUITextView *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI41_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI41_0_0RCTUITextView alloc] initWithFrame:self.bounds];
...
- (id<ABI41_0_0RCTBackedTextInputViewProtocol>)backedTextInputView
{
...
{
  ABI41_0_0RCTDirectEventBlock onScroll = self.onScroll;
