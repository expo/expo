...
@implementation ABI41_0_0RCTSinglelineTextInputView
{
  ABI41_0_0RCTUITextField *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI41_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI41_0_0RCTUITextField alloc] initWithFrame:self.bounds];
