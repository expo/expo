...
@implementation ABI41_0_0RCTBaseTextInputShadowView
{
...
- (instancetype)initWithBridge:(ABI41_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI41_0_0YGNodeSetMeasureFunc(self.yogaNode, ABI41_0_0RCTBaseTextInputShadowViewMeasure);
    ABI41_0_0YGNodeSetBaselineFunc(self.yogaNode, ABI41_0_0RCTTextInputShadowViewBaseline);
  }
...
- (void)uiManagerWillPerformMounting
{
  ...
  ABI41_0_0RCTTextAttributes *textAttributes = [self.textAttributes copy];
  ...
  [attributedText removeAttribute:ABI41_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                            range:NSMakeRange(0, attributedText.length)];

  [attributedText removeAttribute:ABI41_0_0RCTTextAttributesTagAttributeName
                            range:NSMakeRange(0, attributedText.length)];
  ...
  [_bridge.uiManager addUIBlock:^(ABI41_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI41_0_0RCTBaseTextInputView *baseTextInputView = (ABI41_0_0RCTBaseTextInputView *)viewRegistry[tag];
    if (!baseTextInputView) {
      return;
    }

    baseTextInputView.textAttributes = textAttributes;
    baseTextInputView.ABI41_0_0ReactBorderInsets = borderInsets;
    baseTextInputView.ABI41_0_0ReactPaddingInsets = paddingInsets;
...
- (CGSize)sizeThatFitsMinimumSize:(CGSize)minimumSize maximumSize:(CGSize)maximumSize
{
  ...
  return (CGSize){
    MAX(minimumSize.width, MIN(ABI41_0_0RCTCeilPixelValue(size.width), maximumSize.width)),
    MAX(minimumSize.height, MIN(ABI41_0_0RCTCeilPixelValue(size.height), maximumSize.height))
  };
}
...
static ABI41_0_0YGSize ABI41_0_0RCTBaseTextInputShadowViewMeasure(ABI41_0_0YGNodeRef node, float width, ABI41_0_0YGMeasureMode widthMode, float height, ABI41_0_0YGMeasureMode heightMode)
{
  ...
  return (ABI41_0_0YGSize){
    ABI41_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.width),
    ABI41_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.height)
  };
}

static float ABI41_0_0RCTTextInputShadowViewBaseline(ABI41_0_0YGNodeRef node, const float width, const float height)
{
  ABI41_0_0RCTBaseTextInputShadowView *shadowTextView = (__bridge ABI41_0_0RCTBaseTextInputShadowView *)ABI41_0_0YGNodeGetContext(node);
