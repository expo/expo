...
#import <ABI41_0_0React/ABI41_0_0RCTBaseTextShadowView.h>
...
NSString *const ABI41_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName = @"ABI41_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName";

static void ABI41_0_0RCTInlineViewYogaNodeDirtied(ABI41_0_0YGNodeRef node)
{
  ...
  ABI41_0_0RCTShadowView *inlineView = (__bridge ABI41_0_0RCTShadowView *)ABI41_0_0YGNodeGetContext(node);
  ABI41_0_0RCTBaseTextShadowView *baseTextShadowView =
    (ABI41_0_0RCTBaseTextShadowView *)inlineView.ABI41_0_0ReactSuperview;
  
  [baseTextShadowView dirtyLayout];
}

@implementation ABI41_0_0RCTBaseTextShadowView

- (instancetype)init
{
  if (self = [super init]) {
    _textAttributes = [ABI41_0_0RCTTextAttributes new];
  }
...
{
  [super setABI41_0_0ReactTag:ABI41_0_0ReactTag];
  _textAttributes.tag = ABI41_0_0ReactTag;
}

#pragma mark - Life Cycle

- (void)insertABI41_0_0ReactSubview:(ABI41_0_0RCTShadowView *)subview atIndex:(NSInteger)index
{
  [super insertABI41_0_0ReactSubview:subview atIndex:index];
  
  [self dirtyLayout];
  
  if (![subview isKindOfClass:[ABI41_0_0RCTVirtualTextShadowView class]]) {
    ABI41_0_0YGNodeSetDirtiedFunc(subview.yogaNode, ABI41_0_0RCTInlineViewYogaNodeDirtied);
  }
}
...
{
  if (![subview isKindOfClass:[ABI41_0_0RCTVirtualTextShadowView class]]) {
    ABI41_0_0YGNodeSetDirtiedFunc(subview.yogaNode, NULL);
  }
...
{
  ABI41_0_0RCTTextAttributes *textAttributes;
  ...
  for (ABI41_0_0RCTShadowView *shadowView in self.ABI41_0_0ReactSubviews) {
    // Special Case: ABI41_0_0RCTRawTextShadowView
    if ([shadowView isKindOfClass:[ABI41_0_0RCTRawTextShadowView class]]) {
      ABI41_0_0RCTRawTextShadowView *rawTextShadowView = (ABI41_0_0RCTRawTextShadowView *)shadowView;
    ...
    // Special Case: ABI41_0_0RCTBaseTextShadowView
    if ([shadowView isKindOfClass:[ABI41_0_0RCTBaseTextShadowView class]]) {
      ABI41_0_0RCTBaseTextShadowView *baseTextShadowView = (ABI41_0_0RCTBaseTextShadowView *)shadowView;
    ...
    // Generic Case: Any ABI41_0_0RCTShadowView
    ...
    [embeddedShadowViewAttributedString addAttribute:ABI41_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                                               value:shadowView
