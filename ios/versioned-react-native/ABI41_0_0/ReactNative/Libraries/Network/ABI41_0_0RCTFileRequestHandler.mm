...
@interface ABI41_0_0RCTFileRequestHandler() <ABI41_0_0RCTTurboModule>
@end

@implementation ABI41_0_0RCTFileRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  && !ABI41_0_0RCTIsBundleAssetURL(request.URL);
}
...
Class ABI41_0_0RCTFileRequestHandlerCls(void) {
  return ABI41_0_0RCTFileRequestHandler.class;
}
