...
@interface ABI41_0_0RCTDataRequestHandler() <ABI41_0_0RCTTurboModule>
@end

@implementation ABI41_0_0RCTDataRequestHandler
{
...
Class ABI41_0_0RCTDataRequestHandlerCls(void) {
  return ABI41_0_0RCTDataRequestHandler.class;
}
