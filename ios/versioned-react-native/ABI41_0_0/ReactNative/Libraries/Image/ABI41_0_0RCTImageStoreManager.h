...
@interface ABI41_0_0RCTImageStoreManager : NSObject <ABI41_0_0RCTURLRequestHandler>
...
@interface ABI41_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI41_0_0RCTBridge (ABI41_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI41_0_0RCTImageStoreManager *imageStoreManager;
