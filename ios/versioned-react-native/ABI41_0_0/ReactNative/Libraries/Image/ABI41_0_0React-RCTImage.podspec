...
Pod::Spec.new do |s|
  s.name                   = "ABI41_0_0React-RCTImage"
  s.version                = version
  ...
  s.header_dir             = "ABI41_0_0RCTImage"
  ...
  s.dependency "ABI41_0_0React-Core/RCTImageHeaders", version
  s.dependency "ABI41_0_0React-RCTNetwork", version
end
