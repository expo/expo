...
@interface ABI41_0_0RCTGIFCoderFrame : NSObject
...
@implementation ABI41_0_0RCTGIFCoderFrame
@end

@implementation ABI41_0_0RCTAnimatedImage {
  CGImageSourceRef _imageSource;
  CGFloat _scale;
  NSUInteger _loopCount;
  NSUInteger _frameCount;
  NSArray<ABI41_0_0RCTGIFCoderFrame *> *_frames;
}
...
- (BOOL)scanAndCheckFramesValidWithSource:(CGImageSourceRef)imageSource
{
  ...
  NSMutableArray<ABI41_0_0RCTGIFCoderFrame *> *frames = [NSMutableArray array];

  for (size_t i = 0; i < frameCount; i++) {
    ABI41_0_0RCTGIFCoderFrame *frame = [[ABI41_0_0RCTGIFCoderFrame alloc] init];
    frame.index = i;
