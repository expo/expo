...
#import "ABI41_0_0RCTTypedModuleConstants.h"

#import <ABI41_0_0React/ABI41_0_0RCTDefines.h>

@implementation _ABI41_0_0RCTTypedModuleConstants {
  NSDictionary *_dictionary;
}

+ (instancetype)newWithUnsafeDictionary:(NSDictionary<NSString *, id> *)dictionary
{
  _ABI41_0_0RCTTypedModuleConstants *constants = [self new];
  if (constants) {
...
ABI41_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithObjects:(id  _Nonnull const [])objects
