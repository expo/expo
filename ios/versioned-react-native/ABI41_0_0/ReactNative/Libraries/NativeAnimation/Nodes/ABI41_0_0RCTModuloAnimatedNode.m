...
@implementation ABI41_0_0RCTModuloAnimatedNode
...
- (void)performUpdate
{
  ...
  ABI41_0_0RCTValueAnimatedNode *parent = (ABI41_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:inputNode];
