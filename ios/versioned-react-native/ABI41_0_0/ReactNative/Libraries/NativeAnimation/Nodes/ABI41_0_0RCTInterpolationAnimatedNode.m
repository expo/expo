...
@implementation ABI41_0_0RCTInterpolationAnimatedNode
{
  __weak ABI41_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI41_0_0RCTAnimatedNode *)parent
{
  [super onAttachedToNode:parent];
  if ([parent isKindOfClass:[ABI41_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI41_0_0RCTValueAnimatedNode *)parent;
  }
}

- (void)onDetachedFromNode:(ABI41_0_0RCTAnimatedNode *)parent
{
...
- (void)performUpdate
{
  ...
  CGFloat interpolated = ABI41_0_0RCTInterpolateValueInRange(inputValue,
                                                    _inputRange,
                                                    _outputRange,
                                                    _extrapolateLeft,
                                                    _extrapolateRight);
  ...
  if (_hasStringOutput) {
    ...
    if (_numVals > 1) {
      ...
      for (NSTextCheckingResult *match in [_matches reverseObjectEnumerator]) {
        CGFloat val = ABI41_0_0RCTInterpolateValueInRange(inputValue,
                                                          _inputRange,
                                                          _outputs[--i],
                                                          _extrapolateLeft,
                                                          _extrapolateRight);
