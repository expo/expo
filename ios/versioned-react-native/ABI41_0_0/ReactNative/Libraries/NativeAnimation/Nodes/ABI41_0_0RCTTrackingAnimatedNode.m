...
@implementation ABI41_0_0RCTTrackingAnimatedNode {
...
- (void)performUpdate
{
  ...
  ABI41_0_0RCTValueAnimatedNode *node = (ABI41_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
