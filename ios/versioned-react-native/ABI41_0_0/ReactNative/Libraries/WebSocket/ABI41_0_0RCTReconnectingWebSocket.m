...
@interface ABI41_0_0RCTReconnectingWebSocket () <ABI41_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI41_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  ...
  __weak ABI41_0_0RCTSRWebSocket *socket = _socket;
