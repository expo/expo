...
#import "ABI41_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI41_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ABI41_0_0ReactViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ABI41_0_0ReactViewController detachChildViewController:self.contentViewController];
}
