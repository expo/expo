...
// ABI41_0_0RCT_WRAPPER_FOR_VIEW
#define ABI41_0_0RCT_WRAPPER_FOR_VIEW(ClassName)                                        \
                                                                               \
NS_ASSUME_NONNULL_BEGIN                                                        \
                                                                               \
@interface ClassName##Manager : ABI41_0_0RCTWrapperViewManager                          \
                                                                               \
@end                                                                           \
                                                                               \
...
// ABI41_0_0RCT_WRAPPER_FOR_VIEW_CONTROLLER
#define ABI41_0_0RCT_WRAPPER_FOR_VIEW_CONTROLLER(ClassName)                             \
                                                                               \
NS_ASSUME_NONNULL_BEGIN                                                        \
                                                                               \
@interface ClassName##Manager : ABI41_0_0RCTWrapperViewManager                          \
