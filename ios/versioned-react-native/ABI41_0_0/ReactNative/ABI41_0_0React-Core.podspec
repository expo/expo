...
header_subspecs = {
  ...
  'RCTBlobHeaders'              => 'Libraries/Blob/{ABI41_0_0RCTBlobManager,ABI41_0_0RCTFileReaderModule}.h',
...
Pod::Spec.new do |s|
  ...
  s.source                 = { :path => "." }
  s.resource_bundle        = { "ABI41_0_0AccessibilityResources" => ["React/AccessibilityResources/*.lproj"]}
  ...
  s.user_target_xcconfig   = { "HEADER_SEARCH_PATHS" => "\"$(PODS_ROOT)/Headers/Private/ABI41_0_0React-Core\""}
  ...
  s.subspec "DevSupport" do |ss|
    ...
    ss.dependency "ABI41_0_0React-Core/Default", version
    ss.dependency "ABI41_0_0React-Core/RCTWebSocket", version
    ss.dependency "ABI41_0_0React-jsinspector", version
  end
  ...
  header_subspecs.each do |name, headers|
    s.subspec name do |ss|
      ...
      ss.dependency "ABI41_0_0React-Core/Default"
    end
  end
