...
namespace facebook { namespace ReactABI17_0_0 {
  class Instance;
}}
 ...
 * This is most useful for registering a lambda as a ABI17_0_0RN method.  There
...
public:
   ...
   */
  void setInstance(std::weak_ptr<ReactABI17_0_0::Instance> instance) {
    instance_ = instance;
  }
   ...
   */
  std::weak_ptr<ReactABI17_0_0::Instance> getInstance() {
    return instance_;
  }

private:
  std::weak_ptr<ReactABI17_0_0::Instance> instance_;
};
