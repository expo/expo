...
#include <cxxReactABI17_0_0/ABI17_0_0CxxModule.h>
#include <cxxReactABI17_0_0/ABI17_0_0NativeModule.h>
...
public:
  ...
  void invoke(ExecutorToken token, unsigned int ReactABI17_0_0MethodId, folly::dynamic&& params) override;
