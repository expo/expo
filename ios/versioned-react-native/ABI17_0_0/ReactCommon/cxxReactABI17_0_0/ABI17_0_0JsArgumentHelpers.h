...
// When building a cross-platform module for ReactABI17_0_0 Native, arguments passed
...
// they can be caught and reported to ABI17_0_0RN consistently.  The goal is to make the
...
#include <cxxReactABI17_0_0/ABI17_0_0JsArgumentHelpers-inl.h>
