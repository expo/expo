...
#include "ABI17_0_0CxxNativeModule.h"
#include "ABI17_0_0Instance.h"

#include <iterator>

#include <folly/json.h>

#include <cxxReactABI17_0_0/ABI17_0_0JsArgumentHelpers.h>
...
void CxxNativeModule::invoke(ExecutorToken token, unsigned int ReactABI17_0_0MethodId, folly::dynamic&& params) {
  if (ReactABI17_0_0MethodId >= methods_.size()) {
    throw std::invalid_argument(folly::to<std::string>("methodId ", ReactABI17_0_0MethodId,
  ...
  const auto& method = methods_[ReactABI17_0_0MethodId];
