...
#include "ABI17_0_0JSCExecutor.h"
...
#include "ABI17_0_0JSCSamplingProfiler.h"
...
#include "ABI17_0_0JSCTracing.h"
#endif

#ifdef WITH_JSC_EXTRA_TRACING
#include "ABI17_0_0JSCLegacyProfiler.h"
#include "ABI17_0_0JSCLegacyTracing.h"
#endif
...
void JSCExecutor::loadApplicationScript(std::unique_ptr<const JSBigString> script, std::string sourceURL) {
  ...
  ReactABI17_0_0Marker::logMarker("RUN_JS_BUNDLE_START");
  ...
  if (auto fileStr = dynamic_cast<const JSBigFileString *>(script.get())) {
    ...
    case JSLoadSourceIsCompiled:
      ...
      ReactABI17_0_0Marker::logMarker("CREATE_REACT_CONTEXT_END");
      ReactABI17_0_0Marker::logMarker("RUN_JS_BUNDLE_END");
      return;
...
#endif
  {
    ...
    ReactABI17_0_0Marker::logMarker("loadApplicationScript_startStringConvert");
    String jsScript = jsStringFromBigString(m_context, *script);
    ReactABI17_0_0Marker::logMarker("loadApplicationScript_endStringConvert");
...
void JSCExecutor::stopProfiler(const std::string &titleString, const std::string& filename) {
  #ifdef WITH_JSC_EXTRA_TRACING
  String title(m_context, titleString.c_str());
  facebook::ReactABI17_0_0::stopAndOutputProfilingFile(m_context, title, filename.c_str());
  #endif
}
