...
#include <cxxReactABI17_0_0/ABI17_0_0JSCNativeModules.h>
...
class ABI17_0_0RN_EXPORT JSCExecutorFactory : public JSExecutorFactory {
public:
...
class ABI17_0_0RN_EXPORT JSCExecutor : public JSExecutor {
public:
  /**
