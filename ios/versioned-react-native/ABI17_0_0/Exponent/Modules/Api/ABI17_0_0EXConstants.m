...
@interface ABI17_0_0EXConstants ()
...
@implementation ABI17_0_0EXConstants
...
{
  NSString *expoClientVersion = [[[NSBundle mainBundle] infoDictionary] objectForKey:@"ABI17_0_0EXClientVersion"];
