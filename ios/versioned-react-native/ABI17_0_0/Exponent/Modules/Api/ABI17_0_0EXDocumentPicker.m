...
#import "ABI17_0_0EXDocumentPicker.h"

#import <MobileCoreServices/MobileCoreServices.h>
#import <UIKit/UIKit.h>
#import <ReactABI17_0_0/ABI17_0_0RCTUtils.h>

static NSString * ABI17_0_0EXConvertMimeTypeToUTI(NSString *mimeType)
{
  CFStringRef uti;
...
@interface ABI17_0_0EXDocumentPicker () <UIDocumentMenuDelegate, UIDocumentPickerDelegate>
...
@implementation ABI17_0_0EXDocumentPicker

ABI17_0_0RCT_EXPORT_MODULE(ExponentDocumentPicker)

ABI17_0_0RCT_EXPORT_METHOD(getDocumentAsync:(NSDictionary *)options resolver:(ABI17_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI17_0_0RCTPromiseRejectBlock)reject) {
  _resolve = resolve;
  _reject = reject;

  NSString *type = ABI17_0_0EXConvertMimeTypeToUTI(options[@"type"] ?: @"*/*");
  ...
  [ABI17_0_0RCTPresentedViewController() presentViewController:documentMenuVC animated:YES completion:nil];
}

- (void)documentMenu:(UIDocumentMenuViewController *)documentMenu didPickDocumentPicker:(UIDocumentPickerViewController *)documentPicker
{
  documentPicker.delegate = self;
  [ABI17_0_0RCTPresentedViewController() presentViewController:documentPicker animated:YES completion:nil];
}
