...
#import "ABI17_0_0EXContacts.h"
#import "ABI17_0_0EXContactsRequester.h"

@import Contacts;

@interface ABI17_0_0EXContacts ()

@property (nonatomic, strong) CNContactStore *contactStore;

@end

@implementation ABI17_0_0EXContacts

ABI17_0_0RCT_EXPORT_MODULE(ExponentContacts);

/**
 * @param options Options including what fields to get and paging information.
 */
ABI17_0_0RCT_EXPORT_METHOD(getContactsAsync:(NSDictionary *)options resolver:(ABI17_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI17_0_0RCTPromiseRejectBlock)reject)
{
  if (!_contactStore) {
    _contactStore = [[CNContactStore alloc] init];
  }

  if ([ABI17_0_0EXPermissions statusForPermissions:[ABI17_0_0EXContactsRequester permissions]] != ABI17_0_0EXPermissionStatusGranted) {
