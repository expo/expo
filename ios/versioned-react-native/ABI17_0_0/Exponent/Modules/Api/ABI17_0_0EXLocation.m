...
NSString * const ABI17_0_0EXLocationChangedEventName = @"Exponent.locationChanged";

@interface ABI17_0_0EXLocationDelegate : NSObject <CLLocationManagerDelegate>
...
@implementation ABI17_0_0EXLocationDelegate
...
@interface ABI17_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI17_0_0EXLocationDelegate*> *delegates;

@end

@implementation ABI17_0_0EXLocation

ABI17_0_0RCT_EXPORT_MODULE(ExponentLocation)
...
{
  return @[ABI17_0_0EXLocationChangedEventName];
}


ABI17_0_0RCT_REMAP_METHOD(getCurrentPositionAsync,
...
ABI17_0_0RCT_REMAP_METHOD(watchPositionImplAsync,
                 ...
                 rejecter:(ABI17_0_0RCTPromiseRejectBlock)reject)
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    locMgr.distanceFilter = options[@"distanceInterval"] ? [ABI17_0_0RCTConvert double:options[@"distanceInterval"]] ?: kCLDistanceFilterNone : kCLLocationAccuracyHundredMeters;
    locMgr.desiredAccuracy = [ABI17_0_0RCTConvert BOOL:options[@"enableHighAccuracy"]] ? kCLLocationAccuracyBest : kCLLocationAccuracyHundredMeters;
    
    ABI17_0_0EXLocationDelegate *delegate = [[ABI17_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
      if (locations.lastObject) {
        ...
        [weakSelf sendEventWithName:ABI17_0_0EXLocationChangedEventName body:body];
      }
...
ABI17_0_0RCT_REMAP_METHOD(removeWatchAsync,
                 watchId:(nonnull NSNumber *)watchId
                 resolver:(ABI17_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI17_0_0RCTPromiseRejectBlock)reject)
{
  ABI17_0_0EXLocationDelegate *delegate = _delegates[watchId];
  if (delegate) {
    __weak typeof(self) weakSelf = self;
    dispatch_async(dispatch_get_main_queue(), ^{
