...
// Read-only access to legacy (unscoped) `ABI17_0_0RCTAsyncLocalStorage` backing for
 ...
 * being atomic, unless someone bypasses the `ABI17_0_0RCTAsyncLocalStorage` API.
 *
 * Keys and values must always be strings or an error is returned.
 */
@interface ABI17_0_0EXLegacyAsyncLocalStorage : NSObject <ABI17_0_0RCTBridgeModule,ABI17_0_0RCTInvalidating>
