...
#import "ABI17_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI17_0_0EXFingerprint

ABI17_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI17_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI17_0_0RCTPromiseResolveBlock)resolve
...
ABI17_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI17_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI17_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI17_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
