...
#import "ABI17_0_0EXGLGPUImageObject.h"

@implementation ABI17_0_0EXGLObject

+ (instancetype)createWithConfig:(NSDictionary *)config
{
  // TODO(nikki): Maintain these `config` --> `ABI17_0_0EXGLObject` implementation mapping rules in a common place
  if (config[@"texture"]) {
    if (config[@"texture"][@"camera"]) {
      return [[ABI17_0_0EXGLGPUImageObject alloc] initWithConfig:config];
    }
  }
