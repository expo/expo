...
#import "ABI17_0_0EXNotifications.h"
...
@interface ABI17_0_0EXNotifications ()

@property (nonatomic, strong) NSString *experienceId;

@end

@implementation ABI17_0_0EXNotifications

ABI17_0_0RCT_EXPORT_MODULE(ExponentNotifications);
...
ABI17_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
                 getExponentPushTokenAsyncWithResolver:(ABI17_0_0RCTPromiseResolveBlock)resolve
...
ABI17_0_0RCT_EXPORT_METHOD(presentLocalNotification:(NSDictionary *)payload
...
ABI17_0_0RCT_EXPORT_METHOD(scheduleLocalNotification:(NSDictionary *)payload
                  ...
                  rejecter:(__unused ABI17_0_0RCTPromiseRejectBlock)reject)
{
  ...
  notification.fireDate = [ABI17_0_0RCTConvert NSDate:options[@"time"]] ?: [NSDate new];
  notification.repeatInterval = [ABI17_0_0RCTConvert NSCalendarUnit:options[@"repeat"]] ?: 0;
...
ABI17_0_0RCT_EXPORT_METHOD(cancelScheduledNotification:(NSString *)uniqueId)
{
...
ABI17_0_0RCT_EXPORT_METHOD(cancelAllScheduledNotifications)
{
  for (UILocalNotification *notification in [ABI17_0_0RCTSharedApplication() scheduledLocalNotifications]) {
...
ABI17_0_0RCT_REMAP_METHOD(getBadgeNumberAsync,
                 getBadgeNumberAsyncWithResolver:(ABI17_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(__unused ABI17_0_0RCTPromiseRejectBlock)reject)
{
  resolve(@(ABI17_0_0RCTSharedApplication().applicationIconBadgeNumber));
}

ABI17_0_0RCT_EXPORT_METHOD(setBadgeNumberAsync:(nonnull NSNumber *)number
                  resolver:(ABI17_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI17_0_0RCTPromiseRejectBlock)reject)
{
  ABI17_0_0RCTSharedApplication().applicationIconBadgeNumber = number.integerValue;
  resolve(nil);
}
...
{
  ABI17_0_0RCTAssert((payload[@"data"] != nil), @"Attempted to send a local notification with no `data` property.");
  ...
  localNotification.applicationIconBadgeNumber = [ABI17_0_0RCTConvert NSInteger:payload[@"count"]] ?: 0;
