...
@interface ABI17_0_0EXBannerView () <FBAdViewDelegate>

@property (nonatomic, strong) FBAdView *adView;

@end

@implementation ABI17_0_0EXBannerView
...
- (void)createViewIfCan
{
  ...
  FBAdView *adView = [[FBAdView alloc] initWithPlacementID:_placementId
                                                    adSize:fbAdSize
                                        rootViewController:ABI17_0_0RCTPresentedViewController()];
...
{
  _onAdError(ABI17_0_0RCTJSErrorFromNSError(error));
}
