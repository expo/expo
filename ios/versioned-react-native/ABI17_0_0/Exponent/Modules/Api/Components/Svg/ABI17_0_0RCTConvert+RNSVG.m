...
#import "ABI17_0_0RNSVGPainterBrush.h"
#import "ABI17_0_0RNSVGSolidColorBrush.h"
#import <ReactABI17_0_0/ABI17_0_0RCTLog.h>
#import <ReactABI17_0_0/ABI17_0_0RCTFont.h>

@implementation ABI17_0_0RCTConvert (ABI17_0_0RNSVG)

ABI17_0_0RCT_ENUM_CONVERTER(ABI17_0_0RNSVGCGFCRule, (@{
                                     @"evenodd": @(kRNSVGCGFCRuleEvenodd),
                                     @"nonzero": @(kRNSVGCGFCRuleNonzero),
                                     }), kRNSVGCGFCRuleNonzero, intValue)

ABI17_0_0RCT_ENUM_CONVERTER(ABI17_0_0RNSVGVBMOS, (@{
                                  @"meet": @(kRNSVGVBMOSMeet),
                                  @"slice": @(kRNSVGVBMOSSlice),
                                  @"none": @(kRNSVGVBMOSNone)
                                  }), kRNSVGVBMOSMeet, intValue)

ABI17_0_0RCT_ENUM_CONVERTER(ABI17_0_0RNSVGTextAnchor, (@{
...
ABI17_0_0RCT_ENUM_CONVERTER(ABI17_0_0RNSVGUnits, (@{
...
+ (ABI17_0_0RNSVGCGFloatArray)ABI17_0_0RNSVGCGFloatArray:(id)json
{
    ...
    ABI17_0_0RNSVGCGFloatArray array;
    array.count = count;
    array.array = nil;
...
+ (ABI17_0_0RNSVGBrush *)ABI17_0_0RNSVGBrush:(id)json
{
    ...
    switch (type) {
        case 0: // solid color
            ...
            return [[ABI17_0_0RNSVGSolidColorBrush alloc] initWithArray:arr];
        case 1: // brush
            return [[ABI17_0_0RNSVGPainterBrush alloc] initWithArray:arr];
        default:
...
{
    return [[ABI17_0_0RNSVGPathParser alloc] initWithPathString: d];
}
...
+ (CGGradientRef)ABI17_0_0RNSVGCGGradient:(id)json offset:(NSUInteger)offset
{
    ...
    ABI17_0_0RNSVGCGFloatArray colorsAndOffsets = [self ABI17_0_0RNSVGCGFloatArray:arr];
