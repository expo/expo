...
#import <ReactABI17_0_0/ABI17_0_0RCTImageSource.h>
#import <ReactABI17_0_0/ABI17_0_0RCTLog.h>
#import "ABI17_0_0RNSVGViewBox.h"

@implementation ABI17_0_0RNSVGImage
{
    CGImageRef _image;
    CGFloat _imageRatio;
}
...
- (void)setSrc:(id)src
{
    ...
    ABI17_0_0RCTImageSource *source = [ABI17_0_0RCTConvert ABI17_0_0RCTImageSource:src];
    ...
    _image = CGImageRetain([ABI17_0_0RCTConvert CGImage:src]);
    [self invalidate];
}
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    CGAffineTransform transform = [ABI17_0_0RNSVGViewBox getTransform:vbRect eRect:eRect align:self.align meetOrSlice:self.meetOrSlice fromSymbol:NO];
