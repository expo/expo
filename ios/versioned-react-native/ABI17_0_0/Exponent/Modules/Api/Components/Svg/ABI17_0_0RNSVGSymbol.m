 ...
 */
#import "ABI17_0_0RNSVGSymbol.h"
#import "ABI17_0_0RNSVGViewBox.h"

@class ABI17_0_0RNSVGNode;

@implementation ABI17_0_0RNSVGSymbol
...
- (void)setMeetOrSlice:(ABI17_0_0RNSVGVBMOS)meetOrSlice
{
...
- (void)renderSymbolTo:(CGContextRef)context width:(CGFloat)width height:(CGFloat)height
{
    if (self.align) {
        ...
        CGAffineTransform viewBoxTransform = [ABI17_0_0RNSVGViewBox getTransform:CGRectMake(self.minX, self.minY, self.vbWidth, self.vbHeight)
                                                                  eRect:eRect
                                                                  align:self.align
