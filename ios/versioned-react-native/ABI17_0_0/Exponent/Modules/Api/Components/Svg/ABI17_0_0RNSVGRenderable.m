...
@implementation ABI17_0_0RNSVGRenderable
{
...
- (void)setFill:(ABI17_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI17_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI17_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)setStrokeDasharray:(ABI17_0_0RNSVGCGFloatArray)strokeDasharray
{
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    if (self.stroke) {
        ...
        ABI17_0_0RNSVGCGFloatArray dash = self.strokeDasharray;
