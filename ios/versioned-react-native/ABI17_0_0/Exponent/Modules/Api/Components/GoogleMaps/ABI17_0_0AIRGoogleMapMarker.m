...
#import "ABI17_0_0AIRDummyView.h"
...
@interface ABI17_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI17_0_0AIRGMSMarker*)marker;
@end

@implementation ABI17_0_0AIRGoogleMapMarker {
  ABI17_0_0RCTImageLoaderCancellationBlock _reloadImageCancellationBlock;
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI17_0_0AIRGMSMarker alloc] init];
...
- (void)insertReactABI17_0_0Subview:(id<ABI17_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI17_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI17_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI17_0_0AIRDummyView *dummySubview = [[ABI17_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertReactABI17_0_0Subview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeReactABI17_0_0Subview:(id<ABI17_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI17_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeReactABI17_0_0Subview:(UIView*)dummySubview];
}
...
- (void)setOnPress:(ABI17_0_0RCTBubblingEventBlock)onPress {
  _realMarker.onPress = onPress;
}

- (ABI17_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/airbnb/ReactABI17_0_0-native-maps/issues/738)
  ...
  _reloadImageCancellationBlock = [_bridge.imageLoader loadImageWithURLRequest:[ABI17_0_0RCTConvert NSURLRequest:_imageSrc]
                                                                          size:self.bounds.size
                                                                         scale:ABI17_0_0RCTScreenScale()
                                                                       clipped:YES
                                                                    resizeMode:ABI17_0_0RCTResizeModeCenter
                                                                 progressBlock:nil
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI17_0_0RN?
