...
@interface ABI17_0_0EXBarCodeScanner ()

@property (nonatomic, weak) ABI17_0_0EXBarCodeScannerManager *manager;
@property (nonatomic, weak) ABI17_0_0RCTBridge *bridge;
@property (nonatomic, copy) ABI17_0_0RCTDirectEventBlock onBarCodeRead;

@end

@implementation ABI17_0_0EXBarCodeScanner
