...
#import "ABI17_0_0AIRMapPolygonManager.h"
...
@interface ABI17_0_0AIRMapPolygonManager()

@end

@implementation ABI17_0_0AIRMapPolygonManager

ABI17_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI17_0_0AIRMapPolygon *polygon = [ABI17_0_0AIRMapPolygon new];
    return polygon;
}
