...
#import "ABI17_0_0AIRMap.h"
#import "ABI17_0_0SMCalloutView.h"
#import "ABI17_0_0RCTConvert+AirMap.h"

@class ABI17_0_0RCTBridge;

@interface ABI17_0_0AIRMapMarker : MKAnnotationView <MKAnnotation>

@property (nonatomic, strong) ABI17_0_0AIRMapCallout *calloutView;
@property (nonatomic, weak) ABI17_0_0AIRMap *map;
...
@property (nonatomic, copy) ABI17_0_0RCTDirectEventBlock onSelect;
@property (nonatomic, copy) ABI17_0_0RCTDirectEventBlock onDeselect;
...
- (void)fillCalloutView:(ABI17_0_0SMCalloutView *)calloutView;
...
@interface ABI17_0_0AIREmptyCalloutBackgroundView : ABI17_0_0SMCalloutBackgroundView
@end
