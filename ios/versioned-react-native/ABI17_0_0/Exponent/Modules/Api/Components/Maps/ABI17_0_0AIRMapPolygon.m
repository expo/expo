...
@implementation ABI17_0_0AIRMapPolygon {
...
- (void)setCoordinates:(NSArray<ABI17_0_0AIRMapCoordinate *> *)coordinates {
...
- (void)setHoles:(NSArray<NSArray<ABI17_0_0AIRMapCoordinate *> *> *)holes {
    _holes = holes;
    if (holes.count)
    {
