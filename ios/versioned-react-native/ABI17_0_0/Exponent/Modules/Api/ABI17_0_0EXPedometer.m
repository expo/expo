...
#import "ABI17_0_0EXPedometer.h"
#import "ABI17_0_0EXUnversioned.h"

#import <CoreMotion/CoreMotion.h>

NSString * const ABI17_0_0EXPedometerUpdateEventName = @"Exponent.pedometerUpdate";

@implementation ABI17_0_0EXPedometer
{
...
- (void)setBridge:(ABI17_0_0RCTBridge *)bridge
{
  ...
  _watchHandler = ^(CMPedometerData * _Nullable pedometerData, NSError * _Nullable error) {
    ...
    [weakSelf sendEventWithName:ABI17_0_0EXPedometerUpdateEventName
...
ABI17_0_0RCT_EXPORT_MODULE(ExponentPedometer)

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI17_0_0EXPedometerUpdateEventName];
}

ABI17_0_0RCT_EXPORT_METHOD(getStepCountAsync:(nonnull NSNumber *)startTime
...
ABI17_0_0RCT_EXPORT_METHOD(watchStepCount)
{
  if (!_pedometer) {
    _pedometer = [CMPedometer new];
  }
...
ABI17_0_0RCT_EXPORT_METHOD(stopWatchingStepCount)
{
  _watchStartDate = nil;
  _isWatching = NO;
  [_pedometer stopPedometerUpdates];
...
ABI17_0_0RCT_EXPORT_METHOD(isAvailableAsync:(ABI17_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI17_0_0RCTPromiseRejectBlock)reject)
{
