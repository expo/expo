...
@interface ABI17_0_0EXKernelModule ()
...
@implementation ABI17_0_0EXKernelModule
...
#pragma mark - ABI17_0_0RCTEventEmitter methods
...
- (void)sendEventWithName:(NSString *)eventName body:(id)body
{
  ...
  [self.bridge enqueueJSCall:@"ABI17_0_0RCTDeviceEventEmitter.emit"
...
ABI17_0_0RCT_REMAP_METHOD(doesCurrentTaskEnableDevtools,
                 doesCurrentTaskEnableDevtoolsWithResolver:(ABI17_0_0RCTPromiseResolveBlock)resolve
...
ABI17_0_0RCT_REMAP_METHOD(shouldCurrentTaskAutoReload,
                 shouldCurrentTaskAutoReloadWithResolver:(ABI17_0_0RCTPromiseResolveBlock)resolve
                 reject:(ABI17_0_0RCTPromiseRejectBlock)reject)
{
  if (_delegate) {
...
ABI17_0_0RCT_REMAP_METHOD(isLegacyMenuBehaviorEnabledAsync,
                 isLegacyMenuBehaviorEnabledWithResolver:(ABI17_0_0RCTPromiseResolveBlock)resolve
...
ABI17_0_0RCT_EXPORT_METHOD(setIsLegacyMenuBehaviorEnabledAsync:(BOOL)isEnabled)
{
  if (_delegate) {
...
ABI17_0_0RCT_REMAP_METHOD(getDevMenuItemsToShow,
                 getDevMenuItemsToShowWithResolver:(ABI17_0_0RCTPromiseResolveBlock)resolve
                 reject:(ABI17_0_0RCTPromiseRejectBlock)reject)
{
...
ABI17_0_0RCT_EXPORT_METHOD(selectDevMenuItemWithKey:(NSString *)key)
{
  if (_delegate) {
...
ABI17_0_0RCT_EXPORT_METHOD(addDevMenu)
{
...
ABI17_0_0RCT_REMAP_METHOD(routeDidForeground,
...
ABI17_0_0RCT_REMAP_METHOD(onEventSuccess,
...
ABI17_0_0RCT_REMAP_METHOD(onEventFailure,
                 eventId:(NSString *)eventId
