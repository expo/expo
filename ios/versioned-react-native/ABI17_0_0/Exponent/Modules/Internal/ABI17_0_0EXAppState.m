...
@interface ABI17_0_0EXAppState ()

@property (nonatomic, assign) BOOL isObserving;

@end

@implementation ABI17_0_0EXAppState

+ (NSString *)moduleName { return @"ABI17_0_0RCTAppState"; }
...
ABI17_0_0RCT_EXPORT_METHOD(getCurrentAppState:(ABI17_0_0RCTResponseSenderBlock)callback
