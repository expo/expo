...
#import "ABI17_0_0RCTViewControllerProtocol.h"
#import "ABI17_0_0RCTWrapperViewController.h"
#import "UIView+ReactABI17_0_0.h"

@interface ABI17_0_0RCTTabBar() <UITabBarControllerDelegate>

@end

@implementation ABI17_0_0RCTTabBar
{
  BOOL _tabsChanged;
...
- (void)insertReactABI17_0_0Subview:(ABI17_0_0RCTTabBarItem *)subview atIndex:(NSInteger)atIndex
{
  if (![subview isKindOfClass:[ABI17_0_0RCTTabBarItem class]]) {
    ABI17_0_0RCTLogError(@"subview should be of type ABI17_0_0RCTTabBarItem");
    return;
  }
...
- (void)removeReactABI17_0_0Subview:(ABI17_0_0RCTTabBarItem *)subview
{
  if (self.ReactABI17_0_0Subviews.count == 0) {
    ABI17_0_0RCTLogError(@"should have at least one view to remove a subview");
    return;
  }
...
{
  // Do nothing, as subviews are managed by `ReactABI17_0_0BridgeDidFinishTransaction`
}

- (void)layoutSubviews
{
  [super layoutSubviews];
  [self ReactABI17_0_0AddControllerToClosestParent:_tabController];
...
- (void)ReactABI17_0_0BridgeDidFinishTransaction
{
  ...
  if (_tabsChanged) {
    ...
    for (ABI17_0_0RCTTabBarItem *tab in [self ReactABI17_0_0Subviews]) {
      UIViewController *controller = tab.ReactABI17_0_0ViewController;
      if (!controller) {
        controller = [[ABI17_0_0RCTWrapperViewController alloc] initWithContentView:tab];
      }
  ...
  [self.ReactABI17_0_0Subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger index, __unused BOOL *stop) {

    ABI17_0_0RCTTabBarItem *tab = (ABI17_0_0RCTTabBarItem *)view;
...
- (BOOL)tabBarController:(UITabBarController *)tabBarController shouldSelectViewController:(UIViewController *)viewController
{
  ...
  ABI17_0_0RCTTabBarItem *tab = (ABI17_0_0RCTTabBarItem *)self.ReactABI17_0_0Subviews[index];
