...
#import "ABI17_0_0RCTBorderDrawing.h"
#import "ABI17_0_0RCTLog.h"

static const CGFloat ABI17_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI17_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return
  ABS(borderInsets.left - borderInsets.right) < ABI17_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.bottom) < ABI17_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.top) < ABI17_0_0RCTViewBorderThreshold;
}

BOOL ABI17_0_0RCTCornerRadiiAreEqual(ABI17_0_0RCTCornerRadii cornerRadii)
{
  return
  ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI17_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI17_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI17_0_0RCTViewBorderThreshold;
}

BOOL ABI17_0_0RCTBorderColorsAreEqual(ABI17_0_0RCTBorderColors borderColors)
{
  return
...
ABI17_0_0RCTCornerInsets ABI17_0_0RCTGetCornerInsets(ABI17_0_0RCTCornerRadii cornerRadii,
                                   UIEdgeInsets edgeInsets)
{
  return (ABI17_0_0RCTCornerInsets) {
    {
...
static void ABI17_0_0RCTPathAddEllipticArc(CGMutablePathRef path,
...
CGPathRef ABI17_0_0RCTPathCreateWithRoundedRect(CGRect bounds,
                                       ABI17_0_0RCTCornerInsets cornerInsets,
                                       const CGAffineTransform *transform)
{
  ...
  ABI17_0_0RCTPathAddEllipticArc(path, transform, (CGPoint){
...
static void ABI17_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds,
                                               CGPoint lineStart,
                                               CGPoint lineEnd,
...
NS_INLINE BOOL ABI17_0_0RCTCornerRadiiAreAboveThreshold(ABI17_0_0RCTCornerRadii cornerRadii) {
  return (cornerRadii.topLeft > ABI17_0_0RCTViewBorderThreshold ||
    cornerRadii.topRight > ABI17_0_0RCTViewBorderThreshold      ||
    cornerRadii.bottomLeft > ABI17_0_0RCTViewBorderThreshold    ||
    cornerRadii.bottomRight > ABI17_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI17_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI17_0_0RCTCornerRadii cornerRadii) {
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI17_0_0RCTPathCreateWithRoundedRect(rect, ABI17_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef ABI17_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge) {
...
static UIImage *ABI17_0_0RCTGetSolidBorderImage(ABI17_0_0RCTCornerRadii cornerRadii,
                                       CGSize viewSize,
                                       UIEdgeInsets borderInsets,
                                       ABI17_0_0RCTBorderColors borderColors,
                                       CGColorRef backgroundColor,
                                       BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI17_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI17_0_0RCTCornerInsets cornerInsets = ABI17_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  CGContextRef ctx = ABI17_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI17_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI17_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI17_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI17_0_0RCTEllipseGetIntersectionsWithLine((CGRect){
...
static UIImage *ABI17_0_0RCTGetDashedOrDottedBorderImage(ABI17_0_0RCTBorderStyle borderStyle,
                                                ABI17_0_0RCTCornerRadii cornerRadii,
                                                CGSize viewSize,
                                                UIEdgeInsets borderInsets,
                                                ABI17_0_0RCTBorderColors borderColors,
                                                CGColorRef backgroundColor,
                                                BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI17_0_0RCTBorderStyleDashed || borderStyle == ABI17_0_0RCTBorderStyleDotted);

  if (!ABI17_0_0RCTBorderColorsAreEqual(borderColors) || !ABI17_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI17_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI17_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI17_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI17_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI17_0_0RCTPathCreateWithRoundedRect(pathRect, ABI17_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI17_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
...
UIImage *ABI17_0_0RCTGetBorderImage(ABI17_0_0RCTBorderStyle borderStyle,
                           CGSize viewSize,
                           ABI17_0_0RCTCornerRadii cornerRadii,
                           UIEdgeInsets borderInsets,
                           ABI17_0_0RCTBorderColors borderColors,
                           ...
                           BOOL drawToEdge)
{
  ...
  switch (borderStyle) {
    case ABI17_0_0RCTBorderStyleSolid:
      return ABI17_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI17_0_0RCTBorderStyleDashed:
    case ABI17_0_0RCTBorderStyleDotted:
      return ABI17_0_0RCTGetDashedOrDottedBorderImage(borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI17_0_0RCTBorderStyleUnset:
      break;
  }
