...
// These constants can only be removed when ReactABI17_0_0 Native drops iOS8 support.
...
typedef CGFloat ABI17_0_0RCTFontWeight;
static ABI17_0_0RCTFontWeight weightOfFont(UIFont *font)
{
  ...
  ABI17_0_0RCTFontWeight weight = [traits[UIFontWeightTrait] doubleValue];
  if (weight == 0.0) {
...
static UIFont *cachedSystemFont(CGFloat size, ABI17_0_0RCTFontWeight weight)
{
...
@implementation ABI17_0_0RCTConvert (ABI17_0_0RCTFont)

+ (UIFont *)UIFont:(id)json
{
  json = [self NSDictionary:json];
  return [ABI17_0_0RCTFont updateFont:nil
                  withFamily:[ABI17_0_0RCTConvert NSString:json[@"fontFamily"]]
                        size:[ABI17_0_0RCTConvert NSNumber:json[@"fontSize"]]
                      weight:[ABI17_0_0RCTConvert NSString:json[@"fontWeight"]]
                       style:[ABI17_0_0RCTConvert NSString:json[@"fontStyle"]]
                     variant:[ABI17_0_0RCTConvert NSStringArray:json[@"fontVariant"]]
             scaleMultiplier:1];
}

ABI17_0_0RCT_ENUM_CONVERTER(ABI17_0_0RCTFontWeight, (@{
                                     @"normal": @(UIFontWeightRegular),
                                     @"bold": @(UIFontWeightBold),
...
typedef BOOL ABI17_0_0RCTFontStyle;
ABI17_0_0RCT_ENUM_CONVERTER(ABI17_0_0RCTFontStyle, (@{
                                    @"normal": @NO,
                                    @"italic": @YES,
                                    @"oblique": @YES,
                                    }), NO, boolValue)

typedef NSDictionary ABI17_0_0RCTFontVariantDescriptor;
+ (ABI17_0_0RCTFontVariantDescriptor *)ABI17_0_0RCTFontVariantDescriptor:(id)json
{
  ...
  ABI17_0_0RCTFontVariantDescriptor *value = mapping[json];
  if (ABI17_0_0RCT_DEBUG && !value && [json description].length > 0) {
    ABI17_0_0RCTLogError(@"Invalid ABI17_0_0RCTFontVariantDescriptor '%@'. should be one of: %@", json,
                [[mapping allKeys] sortedArrayUsingSelector:@selector(caseInsensitiveCompare:)]);
  }
  return value;
}

ABI17_0_0RCT_ARRAY_CONVERTER(ABI17_0_0RCTFontVariantDescriptor)

@end

@implementation ABI17_0_0RCTFont
...
+ (UIFont *)updateFont:(UIFont *)font
            withFamily:(NSString *)family
               ...
               variant:(NSArray<ABI17_0_0RCTFontVariantDescriptor *> *)variant
       scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  const ABI17_0_0RCTFontWeight defaultFontWeight = UIFontWeightRegular;
  const CGFloat defaultFontSize = 14;

  // Initialize properties to defaults
  CGFloat fontSize = defaultFontSize;
  ABI17_0_0RCTFontWeight fontWeight = defaultFontWeight;
  ...
  // Get font attributes
  fontSize = [ABI17_0_0RCTConvert CGFloat:size] ?: fontSize;
  if (scaleMultiplier > 0.0 && scaleMultiplier != 1.0) {
    fontSize = round(fontSize * scaleMultiplier);
  }
  familyName = [ABI17_0_0RCTConvert NSString:family] ?: familyName;
  isItalic = style ? [ABI17_0_0RCTConvert ABI17_0_0RCTFontStyle:style] : isItalic;
  fontWeight = weight ? [ABI17_0_0RCTConvert ABI17_0_0RCTFontWeight:weight] : fontWeight;
  ...
  if (!didFindFont && [UIFont fontNamesForFamilyName:familyName].count == 0) {
    ...
    if (font) {
      ...
      ABI17_0_0RCTLogError(@"Unrecognized font family '%@'", familyName);
      if ([UIFont respondsToSelector:@selector(systemFontOfSize:weight:)]) {
  ...
  if (variant) {
    NSArray *fontFeatures = [ABI17_0_0RCTConvert ABI17_0_0RCTFontVariantDescriptorArray:variant];
