...
@implementation ABI17_0_0RCTConvert (UITabBarSystemItem)

ABI17_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI17_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI17_0_0ViewController;
}
