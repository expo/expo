...
@implementation ABI17_0_0RCTModalHostView
{
  __weak ABI17_0_0RCTBridge *_bridge;
  BOOL _isPresented;
  ABI17_0_0RCTModalHostViewController *_modalViewController;
  ABI17_0_0RCTTouchHandler *_touchHandler;
  UIView *_ReactABI17_0_0Subview;
#if !TARGET_OS_TV
...
ABI17_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithCoder:coder)

- (instancetype)initWithBridge:(ABI17_0_0RCTBridge *)bridge
{
  if ((self = [super initWithFrame:CGRectZero])) {
    _bridge = bridge;
    _modalViewController = [ABI17_0_0RCTModalHostViewController new];
    UIView *containerView = [UIView new];
    containerView.autoresizingMask = UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
    _modalViewController.view = containerView;
    _touchHandler = [[ABI17_0_0RCTTouchHandler alloc] initWithBridge:bridge];
    _isPresented = NO;
...
{
  if (_ReactABI17_0_0Subview && _isPresented) {
    [_bridge.uiManager setSize:newBounds.size forView:_ReactABI17_0_0Subview];
...
- (void)notifyForOrientationChange
{
  ...
  UIInterfaceOrientation currentOrientation = [ABI17_0_0RCTSharedApplication() statusBarOrientation];
...
{
  ABI17_0_0RCTAssert(_ReactABI17_0_0Subview == nil, @"Modal view can only have one subview");
  ...
  _ReactABI17_0_0Subview = subview;
}

- (void)removeReactABI17_0_0Subview:(UIView *)subview
{
  ABI17_0_0RCTAssert(subview == _ReactABI17_0_0Subview, @"Cannot remove view other than modal view");
  [super removeReactABI17_0_0Subview:subview];
  [_touchHandler detachFromView:subview];
  _ReactABI17_0_0Subview = nil;
}

- (void)didUpdateReactABI17_0_0Subviews
{
  // Do nothing, as subview (singular) is managed by `insertReactABI17_0_0Subview:atIndex:`
}
...
- (void)didMoveToWindow
{
  ...
  if (!_isPresented && self.window) {
    ABI17_0_0RCTAssert(self.ReactABI17_0_0ViewController, @"Can't present modal view controller without a presenting view controller");
