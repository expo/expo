...
#import <ReactABI17_0_0/ABI17_0_0RCTModalHostViewManager.h>
#import <ReactABI17_0_0/ABI17_0_0RCTView.h>

@class ABI17_0_0RCTBridge;
@class ABI17_0_0RCTModalHostViewController;

@protocol ABI17_0_0RCTModalHostViewInteractor;

@interface ABI17_0_0RCTModalHostView : UIView <ABI17_0_0RCTInvalidating>

@property (nonatomic, copy) NSString *animationType;
@property (nonatomic, assign, getter=isTransparent) BOOL transparent;

@property (nonatomic, copy) ABI17_0_0RCTDirectEventBlock onShow;

@property (nonatomic, weak) id<ABI17_0_0RCTModalHostViewInteractor> delegate;

@property (nonatomic, copy) NSArray<NSString *> *supportedOrientations;
@property (nonatomic, copy) ABI17_0_0RCTDirectEventBlock onOrientationChange;

- (instancetype)initWithBridge:(ABI17_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;

@end

@protocol ABI17_0_0RCTModalHostViewInteractor <NSObject>
