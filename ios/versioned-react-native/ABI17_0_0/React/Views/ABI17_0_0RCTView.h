...
#import <ReactABI17_0_0/ABI17_0_0RCTBorderStyle.h>
#import <ReactABI17_0_0/ABI17_0_0RCTComponent.h>
#import <ReactABI17_0_0/ABI17_0_0RCTPointerEvents.h>
#import <ReactABI17_0_0/ABI17_0_0RCTView.h>

@protocol ABI17_0_0RCTAutoInsetsProtocol;

@class ABI17_0_0RCTView;

@interface ABI17_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI17_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI17_0_0RCTDirectEventBlock onMagicTap;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI17_0_0RCTPointerEvents pointerEvents;

+ (void)autoAdjustInsetsForView:(UIView<ABI17_0_0RCTAutoInsetsProtocol> *)parentView
 ...
 * This is inherited from UIView+ReactABI17_0_0, but we override it here
...
/**
 * z-index, used to override sibling order in didUpdateReactABI17_0_0Subviews. This is
 * inherited from UIView+ReactABI17_0_0, but we override it here to reduce the boxing
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI17_0_0RCTBorderStyle borderStyle;
