...
extern NSString *const ABI17_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI17_0_0RCTBundleURLProviderDefaultPort;

@interface ABI17_0_0RCTBundleURLProvider : NSObject
