...
@protocol ABI17_0_0RCTBridgeMethod;
@protocol ABI17_0_0RCTBridgeModule;
@class ABI17_0_0RCTBridge;

@interface ABI17_0_0RCTModuleData : NSObject <ABI17_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI17_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI17_0_0RCTBridgeModule> instance;
