...
/**
 ...
 - The JS exception's unsymbolicated stack trace is available via the NSError userInfo's ABI17_0_0RCTJSExceptionUnsymbolicatedStackTraceKey
 */
ABI17_0_0RCT_EXTERN NSError *ABI17_0_0RCTNSErrorFromJSError(JSValue *exception);

/**
 Translates a given exception into an NSError.

 @see ABI17_0_0RCTNSErrorFromJSError for details
 */
ABI17_0_0RCT_EXTERN NSError *ABI17_0_0RCTNSErrorFromJSErrorRef(JSValueRef exceptionRef, JSGlobalContextRef ctx);
