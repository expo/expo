...
@interface ABI17_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI17_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI17_0_0RCTMultipartDataTaskCallback _partHandler;
...
{
  ABI17_0_0RCTMultipartStreamReader *reader = [[ABI17_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI17_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
