...
@protocol ABI17_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI17_0_0RCTBridge *)bridge;
 ...
 */
- (NSURL *)fallbackSourceURLForBridge:(ABI17_0_0RCTBridge *)bridge;

/**
 * The bridge initializes any registered ABI17_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI17_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI17_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (NSArray<Class> *)whitelistedModulesForBridge:(ABI17_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeLoadJavaScriptSynchronously:(ABI17_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeInitializeNativeModulesSynchronously:(ABI17_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI17_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI17_0_0RCTBridge *)bridge;

/**
 * Configure whether the legacy ABI17_0_0RCTBatchedBridge or new ABI17_0_0RCTCxxBridge
 ...
 * implemented, the implementation will default to ABI17_0_0RCTBatchedBridge,
 * but if it is not linked in, will try ABI17_0_0RCTCxxBridge instead.  If
 ...
 * @experimental
 */
- (BOOL)shouldBridgeUseCxxBridge:(ABI17_0_0RCTBridge *)bridge;
 ...
 */
- (void)loadSourceForBridge:(ABI17_0_0RCTBridge *)bridge
                 onProgress:(ABI17_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI17_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI17_0_0RCTBridge *)bridge
                  withBlock:(ABI17_0_0RCTSourceLoadBlock)loadCallback;
