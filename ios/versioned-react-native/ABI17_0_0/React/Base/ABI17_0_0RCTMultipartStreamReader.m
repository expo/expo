...
#import "ABI17_0_0RCTMultipartStreamReader.h"

#define CRLF @"\r\n"

@implementation ABI17_0_0RCTMultipartStreamReader {
...
- (void)emitChunk:(NSData *)data callback:(ABI17_0_0RCTMultipartCallback)callback done:(BOOL)done
{
...
- (BOOL)readAllParts:(ABI17_0_0RCTMultipartCallback)callback
{
