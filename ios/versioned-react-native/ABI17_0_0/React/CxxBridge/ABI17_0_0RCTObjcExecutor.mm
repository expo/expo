...
#import "ABI17_0_0RCTObjcExecutor.h"
...
#import <cxxReactABI17_0_0/ABI17_0_0Executor.h>
#import <cxxReactABI17_0_0/ABI17_0_0ModuleRegistry.h>
#import <folly/json.h>
...
class ABI17_0_0RCTObjcExecutor : public JSExecutor {
public:
  ABI17_0_0RCTObjcExecutor(id<ABI17_0_0RCTJavaScriptExecutor> jse, ABI17_0_0RCTJavaScriptCompleteBlock errorBlock,
                  std::shared_ptr<facebook::ReactABI17_0_0::ExecutorDelegate> delegate)
    : m_jse(jse)
    ...
    , m_delegate(delegate)
  {
    m_jsCallback = ^(id json, NSError *error) {
      ...
      m_delegate->callNativeModules(*this, [ABI17_0_0RCTConvert folly_dynamic:json], true);
    };
  ...
  void setJSModulesUnbundle(std::unique_ptr<JSModulesUnbundle>) override {
    ABI17_0_0RCTLogWarn(@"Unbundle is not supported in ABI17_0_0RCTObjcExecutor");
  }
...
private:
  ...
  std::shared_ptr<facebook::ReactABI17_0_0::ExecutorDelegate> m_delegate;
  ABI17_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI17_0_0RCTObjcExecutorFactory::ABI17_0_0RCTObjcExecutorFactory(
  id<ABI17_0_0RCTJavaScriptExecutor> jse, ABI17_0_0RCTJavaScriptCompleteBlock errorBlock)
  : m_jse(jse)
  , m_errorBlock(errorBlock) {}

std::unique_ptr<JSExecutor> ABI17_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue) {
  return std::unique_ptr<JSExecutor>(
    new ABI17_0_0RCTObjcExecutor(m_jse, m_errorBlock, delegate));
}
