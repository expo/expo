...
NSString *const ABI17_0_0RCTTVNavigationEventNotification = @"ABI17_0_0RCTTVNavigationEventNotification";

static NSString *const TVNavigationEventName = @"onTVNavEvent";

@implementation ABI17_0_0RCTTVNavigationEventEmitter
  ...
  if (self = [super init]) {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(handleTVNavigationEventNotification:)
                                                 name:ABI17_0_0RCTTVNavigationEventNotification
                                               object:nil];
