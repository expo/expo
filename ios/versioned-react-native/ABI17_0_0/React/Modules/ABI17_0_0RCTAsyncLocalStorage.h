 ...
 */
@interface ABI17_0_0RCTAsyncLocalStorage : NSObject <ABI17_0_0RCTBridgeModule,ABI17_0_0RCTInvalidating>
...
// Clear the ABI17_0_0RCTAsyncLocalStorage data from native code
- (void)clearAllData;
