...
@class ABI17_0_0RCTDevMenuItem;

/**
 * Developer menu, useful for exposing extra functionality when debugging.
 */
@interface ABI17_0_0RCTDevMenu : NSObject

/**
 * Deprecated, use ABI17_0_0RCTDevSettings instead.
 */
 ...
 */
@property (nonatomic, copy, readonly) NSArray<ABI17_0_0RCTDevMenuItem *> *presentedItems;
...
/**
 * Deprecated, use -[ABI17_0_0RCTBRidge reload] instead.
 */
...
typedef NSString *(^ABI17_0_0RCTDevMenuItemTitleBlock)(void);

/**
 * Developer menu item, used to expose additional functionality via the menu.
 */
@interface ABI17_0_0RCTDevMenuItem : NSObject
 ...
 */
+ (instancetype)buttonItemWithTitleBlock:(ABI17_0_0RCTDevMenuItemTitleBlock)titleBlock
                                 handler:(dispatch_block_t)handler;
 ...
 * ABI17_0_0RCTBridge, which is useful for any class that needs to access the menu.
 */
@interface ABI17_0_0RCTBridge (ABI17_0_0RCTDevMenu)

@property (nonatomic, readonly) ABI17_0_0RCTDevMenu *devMenu;
