...
@interface ABI17_0_0RCTImageStoreManager : NSObject <ABI17_0_0RCTURLRequestHandler>
...
@interface ABI17_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI17_0_0RCTBridge (ABI17_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI17_0_0RCTImageStoreManager *imageStoreManager;
