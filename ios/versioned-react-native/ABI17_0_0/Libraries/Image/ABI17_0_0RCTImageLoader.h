...
typedef void (^ABI17_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI17_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI17_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI17_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI17_0_0RCTImageCache <NSObject>
...
@interface UIImage (ReactABI17_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI17_0_0KeyframeAnimation;

@end

@interface ABI17_0_0RCTImageLoader : NSObject <ABI17_0_0RCTBridgeModule, ABI17_0_0RCTURLRequestHandler>
 ...
 * `partialLoadBlock` is meant for custom image loaders that do not ship with the core ABI17_0_0RN library.
 ...
 */
- (ABI17_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                           clipped:(BOOL)clipped
                                        resizeMode:(ABI17_0_0RCTResizeMode)resizeMode
 ...
 * decoded images as long as it conforms to the ABI17_0_0RCTImageCacheDelegate
...
@interface ABI17_0_0RCTBridge (ABI17_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI17_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI17_0_0RCTImageURLLoader <ABI17_0_0RCTBridgeModule>
...
/**
 * If more than one ABI17_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI17_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 * are also bridge modules, so should be registered using ABI17_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI17_0_0RCTImageDataDecoder <ABI17_0_0RCTBridgeModule>
...
/**
 * If more than one ABI17_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
