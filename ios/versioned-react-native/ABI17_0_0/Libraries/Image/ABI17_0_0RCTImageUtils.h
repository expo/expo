 ...
 */
ABI17_0_0RCT_EXTERN CGRect ABI17_0_0RCTTargetRect(CGSize sourceSize, CGSize destSize,
                                CGFloat destScale, ABI17_0_0RCTResizeMode resizeMode);
 ...
 */
ABI17_0_0RCT_EXTERN CGAffineTransform ABI17_0_0RCTTransformFromTargetRect(CGSize sourceSize,
                                                        CGRect targetRect);
 ...
 */
ABI17_0_0RCT_EXTERN CGSize ABI17_0_0RCTTargetSize(CGSize sourceSize, CGFloat sourceScale,
                                CGSize destSize, CGFloat destScale,
                                ABI17_0_0RCTResizeMode resizeMode, BOOL allowUpscaling);
 ...
 */
ABI17_0_0RCT_EXTERN BOOL ABI17_0_0RCTUpscalingRequired(CGSize sourceSize, CGFloat sourceScale,
                                     CGSize destSize, CGFloat destScale,
                                     ABI17_0_0RCTResizeMode resizeMode);
 ...
 */
ABI17_0_0RCT_EXTERN UIImage *__nullable ABI17_0_0RCTDecodeImageWithData(NSData *data,
                                                      CGSize destSize,
                                                      CGFloat destScale,
                                                      ABI17_0_0RCTResizeMode resizeMode);
 ...
 */
ABI17_0_0RCT_EXTERN NSDictionary<NSString *, id> *__nullable ABI17_0_0RCTGetImageMetadata(NSData *data);
 ...
 */
ABI17_0_0RCT_EXTERN NSData *__nullable ABI17_0_0RCTGetImageData(CGImageRef image, float quality);
 ...
 */
ABI17_0_0RCT_EXTERN UIImage *__nullable ABI17_0_0RCTTransformImage(UIImage *image,
                                                 CGSize destSize,
                                                 CGFloat destScale,
 ...
 */
ABI17_0_0RCT_EXTERN BOOL ABI17_0_0RCTImageHasAlpha(CGImageRef image);
