...
@implementation ABI17_0_0RCTTransformAnimatedNode
{
...
- (void)performUpdate
{
  ...
  for (NSDictionary *transformConfig in transformConfigs) {
    ...
    if ([type isEqualToString: @"animated"]) {
      ...
      ABI17_0_0RCTAnimatedNode *node = self.parentNodes[nodeTag];
      if (![node isKindOfClass:[ABI17_0_0RCTValueAnimatedNode class]]) {
        continue;
      }
      ABI17_0_0RCTValueAnimatedNode *parentNode = (ABI17_0_0RCTValueAnimatedNode *)node;
