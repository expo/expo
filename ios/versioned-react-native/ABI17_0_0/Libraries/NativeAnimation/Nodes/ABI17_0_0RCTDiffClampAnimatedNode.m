...
@implementation ABI17_0_0RCTDiffClampAnimatedNode
{
...
{
  ABI17_0_0RCTValueAnimatedNode *inputNode = (ABI17_0_0RCTValueAnimatedNode *)self.parentNodes[_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI17_0_0RCTValueAnimatedNode class]]) {
    ABI17_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
