...
@interface ABI17_0_0RCTSpringAnimation ()
...
@implementation ABI17_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
                  ...
                  callBack:(nullable ABI17_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _toValue = [ABI17_0_0RCTConvert CGFloat:config[@"toValue"]];
    _fromValue = valueNode.value;
    _valueNode = valueNode;
    _overshootClamping = [ABI17_0_0RCTConvert BOOL:config[@"overshootClamping"]];
    _restDisplacementThreshold = [ABI17_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
    _restSpeedThreshold = [ABI17_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
    _tension = [ABI17_0_0RCTConvert CGFloat:config[@"tension"]];
    _friction = [ABI17_0_0RCTConvert CGFloat:config[@"friction"]];
