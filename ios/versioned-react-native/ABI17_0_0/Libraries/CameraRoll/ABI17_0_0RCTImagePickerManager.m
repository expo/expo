...
#import "ABI17_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI17_0_0/ABI17_0_0RCTConvert.h>
#import <ReactABI17_0_0/ABI17_0_0RCTImageStoreManager.h>
#import <ReactABI17_0_0/ABI17_0_0RCTRootView.h>
#import <ReactABI17_0_0/ABI17_0_0RCTUtils.h>

@interface ABI17_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI17_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI17_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI17_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI17_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI17_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI17_0_0RCTResponseSenderBlock)callback)
{
...
ABI17_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI17_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI17_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI17_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI17_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI17_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI17_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI17_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI17_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI17_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI17_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI17_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI17_0_0RCTNullIfNil(height), ABI17_0_0RCTNullIfNil(width)]];
    return;
  }
        ...
        cancelCallback:(ABI17_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI17_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI17_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI17_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
