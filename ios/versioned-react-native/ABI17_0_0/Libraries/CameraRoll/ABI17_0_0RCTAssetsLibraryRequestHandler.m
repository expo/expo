...
@implementation ABI17_0_0RCTAssetsLibraryRequestHandler
{
...
#pragma mark - ABI17_0_0RCTURLRequestHandler
     ...
     withDelegate:(id<ABI17_0_0RCTURLRequestDelegate>)delegate
{
  ...
  [[self assetsLibrary] assetForURL:request.URL resultBlock:^(ALAsset *asset) {
    ...
    if (asset) {
      ...
      NSError *error = ABI17_0_0RCTErrorWithMessage(errorMessage);
      [delegate URLRequest:cancellationBlock didCompleteWithError:error];
    }
...
@implementation ABI17_0_0RCTBridge (ABI17_0_0RCTAssetsLibraryImageLoader)

- (ALAssetsLibrary *)assetsLibrary
{
  return [[self moduleForClass:[ABI17_0_0RCTAssetsLibraryRequestHandler class]] assetsLibrary];
}
