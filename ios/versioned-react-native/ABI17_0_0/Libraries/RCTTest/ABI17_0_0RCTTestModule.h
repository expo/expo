...
typedef NS_ENUM(NSInteger, ABI17_0_0RCTTestStatus) {
  ABI17_0_0RCTTestStatusPending = 0,
  ABI17_0_0RCTTestStatusPassed,
  ABI17_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI17_0_0RCTTestModule : NSObject <ABI17_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI17_0_0RCTTestStatus status;
