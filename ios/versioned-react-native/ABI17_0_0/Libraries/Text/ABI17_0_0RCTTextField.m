...
@interface ABI17_0_0RCTTextField()
...
@interface ABI17_0_0RCTTextFieldDelegateProxy: NSObject <UITextFieldDelegate>
@end

@implementation ABI17_0_0RCTTextFieldDelegateProxy

- (BOOL)textField:(ABI17_0_0RCTTextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string
{
  return [textField shouldChangeCharactersInRange:range replacementString:string];
}

- (BOOL)keyboardInputShouldDelete:(ABI17_0_0RCTTextField *)textField
{
  return [textField keyboardInputShouldDelete];
}

- (BOOL)textFieldShouldEndEditing:(ABI17_0_0RCTTextField *)textField {
  return [textField textFieldShouldEndEditing];
}

@end

@implementation ABI17_0_0RCTTextField
{
  ...
  BOOL _textWasPasted;
  NSString *_finalText;
  ABI17_0_0RCTTextFieldDelegateProxy *_delegateProxy;
}

- (instancetype)initWithEventDispatcher:(ABI17_0_0RCTEventDispatcher *)eventDispatcher
{
  if ((self = [super initWithFrame:CGRectZero])) {
    ABI17_0_0RCTAssert(eventDispatcher, @"eventDispatcher is a required parameter");
    ...
    _delegateProxy = [ABI17_0_0RCTTextFieldDelegateProxy new];
...
static void ABI17_0_0RCTUpdatePlaceholder(ABI17_0_0RCTTextField *self)
{
...
- (void)setPlaceholderTextColor:(UIColor *)placeholderTextColor
{
  ...
  ABI17_0_0RCTUpdatePlaceholder(self);
}
...
{
  _nativeEventCount++;
  [_eventDispatcher sendTextEventWithType:ABI17_0_0RCTTextEventTypeChange
                                 ReactABI17_0_0Tag:self.ReactABI17_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (void)observeValueForKeyPath:(NSString *)keyPath
                      ofObject:(ABI17_0_0RCTTextField *)textField
