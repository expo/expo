...
@implementation ABI17_0_0ARTText
...
static void ABI17_0_0ARTFreeTextFrame(ABI17_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI17_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI17_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI17_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI17_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
