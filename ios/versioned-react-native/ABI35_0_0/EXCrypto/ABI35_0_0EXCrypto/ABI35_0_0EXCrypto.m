...
#import <ABI35_0_0EXCrypto/ABI35_0_0EXCrypto.h>
#import <CommonCrypto/CommonDigest.h>

@implementation ABI35_0_0EXCrypto

ABI35_0_0UM_EXPORT_MODULE(ExpoCrypto);

ABI35_0_0UM_EXPORT_METHOD_AS(digestStringAsync,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  int digestLength = [ABI35_0_0EXCrypto digestLengthForJSAlgorithm:algorithm];
  if (digestLength == -1) {
