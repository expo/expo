...
#import <ABI35_0_0EXSpeech/ABI35_0_0EXSpeech.h>

@interface ABI35_0_0EXSpeechUtteranceWithId : AVSpeechUtterance
...
@implementation ABI35_0_0EXSpeechUtteranceWithId
...
@interface ABI35_0_0EXSpeech () <AVSpeechSynthesizerDelegate>
...
@implementation ABI35_0_0EXSpeech

ABI35_0_0UM_EXPORT_MODULE(ExponentSpeech)
...
{
  id<ABI35_0_0UMEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI35_0_0UMEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStarted" body:@{ @"id": ((ABI35_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didCancelSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI35_0_0UMEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI35_0_0UMEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStopped" body:@{ @"id": ((ABI35_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didFinishSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI35_0_0UMEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI35_0_0UMEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingDone" body:@{ @"id": ((ABI35_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}


ABI35_0_0UM_EXPORT_METHOD_AS(speak,
  ...
  AVSpeechUtterance *utterance = [[ABI35_0_0EXSpeechUtteranceWithId alloc] initWithString:text utteranceId:utteranceId];
...
ABI35_0_0UM_EXPORT_METHOD_AS(getVoices,
                    getVoices:(ABI35_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject) {
...
ABI35_0_0UM_EXPORT_METHOD_AS(stop,
                    stop:(ABI35_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject) {
  [_synthesizer stopSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI35_0_0UM_EXPORT_METHOD_AS(pause,
                    pause:(ABI35_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject) {
  [_synthesizer pauseSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI35_0_0UM_EXPORT_METHOD_AS(resume,
                    resume:(ABI35_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject) {
  [_synthesizer continueSpeaking];
  resolve(nil);
}

ABI35_0_0UM_EXPORT_METHOD_AS(isSpeaking,
                    isSpeaking:(ABI35_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject) {
