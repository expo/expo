...
#import <ABI35_0_0EXImageManipulator/ABI35_0_0EXImageManipulatorModule.h>
...
@interface ABI35_0_0EXImageManipulatorModule ()
...
@implementation ABI35_0_0EXImageManipulatorModule

ABI35_0_0UM_EXPORT_MODULE(ExpoImageManipulator);
...
ABI35_0_0UM_EXPORT_METHOD_AS(manipulateAsync,
                    uri:(NSString *)uri
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (!([_fileSystem permissionsForURI:url] & ABI35_0_0UMFileSystemPermissionRead)) {
