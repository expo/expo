...
@interface ABI35_0_0EXAppState ()

@property (nonatomic, assign) BOOL isObserving;

@end

@implementation ABI35_0_0EXAppState

+ (NSString *)moduleName { return @"ABI35_0_0RCTAppState"; }
...
- (void)setState:(NSString *)state
{
  if (![state isEqualToString:_lastKnownState]) {
    ...
    // TODO: just make ABI35_0_0EXAppState a universal module implementing ABI35_0_0UMAppLifecycleService
    id<ABI35_0_0UMAppLifecycleService> lifeCycleManager = [self.bridge.scopedModules.moduleRegistry
                                                  getModuleImplementingProtocol:@protocol(ABI35_0_0UMAppLifecycleService)];
