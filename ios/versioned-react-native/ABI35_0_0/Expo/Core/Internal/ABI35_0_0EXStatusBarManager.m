...
#if !TARGET_OS_TV
@implementation ABI35_0_0RCTConvert (ABI35_0_0EXStatusBar)
...
@interface ABI35_0_0EXStatusBarManager ()

@property (nonatomic, strong) NSMutableDictionary *capturedStatusBarProperties;

@end

@implementation ABI35_0_0EXStatusBarManager

+ (NSString *)moduleName { return @"ABI35_0_0RCTStatusBarManager"; }
 ...
 */
ABI35_0_0RCT_REMAP_METHOD(_captureProperties,
                 _capturePropertiesWithResolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
 ...
 *  Normally nobody should use this method because it bypasses the JS state used by the StatusBar component.
 */
ABI35_0_0RCT_EXPORT_METHOD(_applyPropertiesAndForget:(NSDictionary *)properties)
{
...
{
  UIApplication *currentApplication = ABI35_0_0RCTSharedApplication();
  return @{
