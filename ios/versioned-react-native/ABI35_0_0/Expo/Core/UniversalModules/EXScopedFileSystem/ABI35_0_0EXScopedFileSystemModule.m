...
NSString * const ABI35_0_0EXShellManifestResourceName = @"shell-app-manifest";

@implementation ABI35_0_0EXScopedFileSystemModule

- (instancetype)initWithExperienceId:(NSString *)experienceId andConstantsBinding:(ABI35_0_0EXConstantsBinding *)constantsBinding
{
  NSString *escapedExperienceId = [ABI35_0_0EXScopedFileSystemModule escapedResourceName:experienceId];
...
- (NSArray<NSString *> *)bundledAssets
{
  ...
  dispatch_once(&once, ^{
    NSString *manifestBundlePath = [[NSBundle mainBundle] pathForResource:ABI35_0_0EXShellManifestResourceName ofType:@"json"];
    ...
    if (error) {
      ABI35_0_0UMLogError(@"Error parsing bundled manifest: %@", error);
      return;
    }
