...
@interface ABI35_0_0EXSensorsManagerBinding ()

@property (nonatomic, strong) NSString *experienceId;
@property (nonatomic, weak) id<ABI35_0_0EXSensorsManagerBindingDelegate> kernelService;

@end

@implementation ABI35_0_0EXSensorsManagerBinding
