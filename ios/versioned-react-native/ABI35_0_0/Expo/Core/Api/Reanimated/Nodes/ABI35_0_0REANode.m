...
@interface ABI35_0_0REAUpdateContext ()

@property (nonatomic, nonnull) NSMutableArray<ABI35_0_0REANode *> *updatedNodes;
@property (nonatomic) NSUInteger loopID;

@end

@implementation ABI35_0_0REAUpdateContext
...
@interface ABI35_0_0REANode ()

@property (nonatomic) NSUInteger lastLoopID;
@property (nonatomic) id memoizedValue;
@property (nonatomic, nullable) NSMutableArray<ABI35_0_0REANode *> *childNodes;

@end

@implementation ABI35_0_0REANode
...
- (void)addChild:(ABI35_0_0REANode *)child
{
  if (!_childNodes) {
...
- (void)removeChild:(ABI35_0_0REANode *)child
{
  if (child) {
...
+ (NSMutableArray<ABI35_0_0REANode *> *)updatedNodes
{
  static NSMutableArray<ABI35_0_0REANode *> *updatedNodes;
...
+ (void)findAndUpdateNodes:(nonnull ABI35_0_0REANode *)node
            withVisitedSet:(NSMutableSet<ABI35_0_0REANode *> *)visitedNodes
            withFinalNodes:(NSMutableArray<id<ABI35_0_0REAFinalNode>> *)finalNodes
{
  ...
  for (ABI35_0_0REANode *child in node.childNodes) {
    [self findAndUpdateNodes:child withVisitedSet:visitedNodes withFinalNodes:finalNodes];
  }
  if ([node conformsToProtocol:@protocol(ABI35_0_0REAFinalNode)]) {
    [finalNodes addObject:(id<ABI35_0_0REAFinalNode>)node];
  }
}

+ (void)runPropUpdates:(ABI35_0_0REAUpdateContext *)context
{
  NSMutableSet<ABI35_0_0REANode *> *visitedNodes = [NSMutableSet new];
  NSMutableArray<id<ABI35_0_0REAFinalNode>> *finalNodes = [NSMutableArray new];
