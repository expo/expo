#import "ABI35_0_0REAClockNodes.h"
#import "ABI35_0_0REANodesManager.h"

@interface ABI35_0_0REAClockNode ()
...
@implementation ABI35_0_0REAClockNode
...
- (void)start
{
  ...
  __weak ABI35_0_0REAClockNode *weakSelf = self;
...
@implementation ABI35_0_0REAClockOpNode {
...
- (ABI35_0_0REAClockNode*)clockNode
{
  return (ABI35_0_0REAClockNode*)[self.nodesManager findNodeByID:_clockNodeID];
}

@end

@implementation ABI35_0_0REAClockStartNode
...
@implementation ABI35_0_0REAClockStopNode
...
@implementation ABI35_0_0REAClockTestNode
