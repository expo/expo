#import "ABI35_0_0REAEventNode.h"
#import "ABI35_0_0REANodesManager.h"
#import "ABI35_0_0REAValueNode.h"

@implementation ABI35_0_0REAEventNode {
  NSArray *_argMapping;
}
  ...
  for (NSArray *eventPath in _argMapping) {
    ...
    for (NSUInteger i = 0; i < eventPath.count; i++) {
      if (i < eventPath.count - 1) {
        ...
        ABI35_0_0REAValueNode *node = (ABI35_0_0REAValueNode *)[self.nodesManager findNodeByID:eventPath[i]];
        [node setValue:value];
      }
    }
  }
