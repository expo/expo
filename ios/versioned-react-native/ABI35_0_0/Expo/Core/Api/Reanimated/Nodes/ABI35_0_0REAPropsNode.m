#import "ABI35_0_0REAPropsNode.h"
...
#import "ReactABI35_0_0/ABI35_0_0RCTComponentData.h"

@implementation ABI35_0_0REAPropsNode
{
  NSNumber *_connectedViewTag;
  NSString *_connectedViewName;
  NSMutableDictionary<NSString *, ABI35_0_0REANodeID> *_propsConfig;
}
...
- (id)evaluate
{
  ...
  for (NSString *prop in _propsConfig) {
    ABI35_0_0REANode *propNode = [self.nodesManager findNodeByID:_propsConfig[prop]];
    
    if ([propNode isKindOfClass:[ABI35_0_0REAStyleNode class]]) {
