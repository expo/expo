...
#import "ABI35_0_0REAAllTransitions.h"
#import "ABI35_0_0RCTConvert+REATransition.h"

@interface ABI35_0_0REASnapshotRemover : NSObject <CAAnimationDelegate>
@end

@implementation ABI35_0_0REASnapshotRemover {
  UIView *_view;
}
...
@implementation ABI35_0_0REATransitionGroup

- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
    _sequence = [ABI35_0_0RCTConvert BOOL:config[@"sequence"]];
    NSArray *transitions = [ABI35_0_0RCTConvert NSArray:config[@"transitions"]];
    NSMutableArray<ABI35_0_0REATransition*> *inflated = [NSMutableArray new];
    for (NSDictionary *transitionConfig in transitions) {
      [inflated addObject:[ABI35_0_0REATransition inflate:transitionConfig]];
                                                             ...
                                                             forRoot:(UIView *)root
{
  ...
  for (ABI35_0_0REATransition *transition in _transitions) {
    ...
    for (ABI35_0_0REATransitionAnimation *anim in subanims) {
      [anim delayBy:delay];
...
@implementation ABI35_0_0REAVisibilityTransition

- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
    _animationType = [ABI35_0_0RCTConvert ABI35_0_0REATransitionAnimationType:config[@"animation"]];
  }
  return self;
}

- (ABI35_0_0REATransitionAnimation *)appearView:(UIView *)view
...
- (ABI35_0_0REATransitionAnimation *)disappearView:(UIView *)view
                                                 ...
                                                 forRoot:(UIView *)root
{
  ...
  if (isViewAppearing && !IS_LAYOUT_ONLY(endValues.view)) {
    NSNumber *parentKey = endValues.ReactABI35_0_0Parent.ReactABI35_0_0Tag;
    ABI35_0_0REATransitionValues *parentStartValues = [self findStartValuesForKey:parentKey];
    ABI35_0_0REATransitionValues *parentEndValues = [self findEndValuesForKey:parentKey];
  ...
  if (endValues == nil && !IS_LAYOUT_ONLY(startValues.view) && startValues.ReactABI35_0_0Parent.window != nil) {
    startValues.view.center = startValues.centerInReactABI35_0_0Parent;
    return [self disappearView:startValues.view fromParent:startValues.ReactABI35_0_0Parent forRoot:root];
  }
  return nil;
}
...
@implementation ABI35_0_0REAInTransition
- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
  }
                                  ...
                                  forRoot:(UIView *)root
{
  ...
  switch (self.animationType) {
    case ABI35_0_0REATransitionAnimationTypeNone:
      return nil;
    case ABI35_0_0REATransitionAnimationTypeFade: {
    ...
    case ABI35_0_0REATransitionAnimationTypeScale: {
    ...
    case ABI35_0_0REATransitionAnimationTypeSlideTop:
    case ABI35_0_0REATransitionAnimationTypeSlideBottom:
    case ABI35_0_0REATransitionAnimationTypeSlideLeft:
    case ABI35_0_0REATransitionAnimationTypeSlideRight: {
  ...
  return [ABI35_0_0REATransitionAnimation transitionWithAnimation:animation layer:view.layer andKeyPath:animation.keyPath];
}
@end


@implementation ABI35_0_0REAOutTransition
- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
  }
...
- (ABI35_0_0REATransitionAnimation *)disappearView:(UIView *)view
                               fromParent:(UIView *)parent
                                  forRoot:(UIView *)root
{
  if (self.animationType == ABI35_0_0REATransitionAnimationTypeNone) {
    return nil;
  }
  ...
  animation.fillMode = kCAFillModeBackwards;
  animation.delegate = [[ABI35_0_0REASnapshotRemover alloc] initWithView:snapshotView];

  return [ABI35_0_0REATransitionAnimation transitionWithAnimation:animation layer:snapshot andKeyPath:animation.keyPath];
}
@end


@implementation ABI35_0_0REAChangeTransition
                                                 ...
                                                 forRoot:(UIView *)root
{
  ...
  return [ABI35_0_0REATransitionAnimation transitionWithAnimation:group layer:layer andKeyPath:nil];
}
@end
