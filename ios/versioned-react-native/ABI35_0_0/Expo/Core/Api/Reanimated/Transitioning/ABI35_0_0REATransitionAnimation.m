...
CGFloat ABI35_0_0SimAnimationDragCoefficient()
{
#if TARGET_IPHONE_SIMULATOR
...
@implementation ABI35_0_0REATransitionAnimation {
...
{
  ABI35_0_0REATransitionAnimation *anim = [ABI35_0_0REATransitionAnimation new];
...
- (void)play
{
  _animation.duration = self.duration * ABI35_0_0SimAnimationDragCoefficient();
  _animation.beginTime = CACurrentMediaTime() + _delay * ABI35_0_0SimAnimationDragCoefficient();
