...
#import <ReactABI35_0_0/ABI35_0_0RCTImageSource.h>
#import <ReactABI35_0_0/ABI35_0_0RCTImageLoader.h>
#import <ReactABI35_0_0/ABI35_0_0RCTLog.h>
#import "ABI35_0_0RNSVGViewBox.h"

@implementation ABI35_0_0RNSVGImage
{
    CGImageRef _image;
    CGSize _imageSize;
    ABI35_0_0RCTImageLoaderCancellationBlock _reloadImageCancellationBlock;
}
...
- (void)setSrc:(id)src
{
    ...
    ABI35_0_0RCTImageSource *source = [ABI35_0_0RCTConvert ABI35_0_0RCTImageSource:src];
    ...
    ABI35_0_0RCTImageLoaderCancellationBlock previousCancellationBlock = _reloadImageCancellationBlock;
    if (previousCancellationBlock) {
        previousCancellationBlock();
        _reloadImageCancellationBlock = nil;
    }

    _reloadImageCancellationBlock = [self.bridge.imageLoader loadImageWithURLRequest:[ABI35_0_0RCTConvert NSURLRequest:src] callback:^(NSError *error, UIImage *image) {
...
- (void)setX:(ABI35_0_0RNSVGLength *)x
{
    if ([x isEqualTo:_x]) {
        return;
    }
...
- (void)setY:(ABI35_0_0RNSVGLength *)y
{
    if ([y isEqualTo:_y]) {
        return;
    }
...
- (void)setImagewidth:(ABI35_0_0RNSVGLength *)width
{
...
- (void)setImageheight:(ABI35_0_0RNSVGLength *)height
{
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    CGAffineTransform viewbox = [ABI35_0_0RNSVGViewBox getTransform:imageBounds eRect:hitArea align:self.align meetOrSlice:self.meetOrSlice];
