#import "ABI35_0_0RNSVGGlyphContext.h"
...
@interface ABI35_0_0RNSVGGlyphContext () {
@public
    ...
    NSMutableArray<NSArray<ABI35_0_0RNSVGLength*>*> *mXsContext_;
    NSMutableArray<NSArray<ABI35_0_0RNSVGLength*>*> *mYsContext_;
    NSMutableArray<NSArray<ABI35_0_0RNSVGLength*>*> *mDXsContext_;
    NSMutableArray<NSArray<ABI35_0_0RNSVGLength*>*> *mDYsContext_;
    NSMutableArray<NSArray<ABI35_0_0RNSVGLength*>*> *mRsContext_;
    ...
    CGFloat mFontSize_;
    ABI35_0_0RNSVGFontData *topFont_;
    ...
    NSArray<ABI35_0_0RNSVGLength*> *mXs_;

    // https://www.w3.org/TR/SVG/text.html#TSpanElementYAttribute
    NSArray<ABI35_0_0RNSVGLength*> *mYs_;
    ...
    NSArray<ABI35_0_0RNSVGLength*> *mDXs_;

    // https://www.w3.org/TR/SVG/text.html#TSpanElementDYAttribute
    NSArray<ABI35_0_0RNSVGLength*> *mDYs_;
    ...
    NSArray<ABI35_0_0RNSVGLength*> *mRs_;
...
@implementation ABI35_0_0RNSVGGlyphContext
...
- (CTFontRef)getGlyphFont
{
    ...
    NSString *fontStyle = ABI35_0_0RNSVGFontStyleStrings[topFont_->fontStyle];
    NSString *fontWeight = ABI35_0_0RNSVGFontWeightStrings[topFont_->fontWeight];
    UIFont *font = [ABI35_0_0RCTFont updateFont:nil
...
- (instancetype)initWithWidth:(CGFloat)width
    ...
    self->mFontSize_ = ABI35_0_0RNSVGFontData_DEFAULT_FONT_SIZE;
    self->topFont_ = [ABI35_0_0RNSVGFontData Defaults];

    self->mXs_ = [[NSArray alloc]init];
    self->mYs_ = [[NSArray alloc]init];
    self->mDXs_ = [[NSArray alloc]init];
    self->mDYs_ = [[NSArray alloc]init];
    self->mRs_ = [[NSArray alloc]initWithObjects:[ABI35_0_0RNSVGLength lengthWithNumber:0], nil];
...
- (ABI35_0_0RNSVGFontData *)getTopOrParentFont:(ABI35_0_0RNSVGGroup *)child
{
    if (self->mTop_ > 0) {
        return self->topFont_;
    } else {
        ABI35_0_0RNSVGGroup *parentRoot = [child getParentTextRoot];
        ABI35_0_0RNSVGFontData *Defaults = [ABI35_0_0RNSVGFontData Defaults];
        while (parentRoot != nil) {
            ABI35_0_0RNSVGFontData *map = [[parentRoot getGlyphContext] getFont];
            if (map != Defaults) {
                return map;
            }
...
- (void)pushNode:(ABI35_0_0RNSVGGroup *)node andFont:(NSDictionary *)font
{
    ABI35_0_0RNSVGFontData *parent = [self getTopOrParentFont:node];
    self->mTop_++;
    if (font == nil) {
        [self->mFontContext_ addObject:parent];
        return;
    }
    ABI35_0_0RNSVGFontData *data = [ABI35_0_0RNSVGFontData initWithNSDictionary:font
                                                       parent:parent];
...
- (void)pushContext:(ABI35_0_0RNSVGText*)node
             ...
             deltaY:(NSArray<ABI35_0_0RNSVGLength*>*)deltaY
             rotate:(NSArray<ABI35_0_0RNSVGLength*>*)rotate {
    [self pushNode:(ABI35_0_0RNSVGGroup*)node andFont:font];
    if (x != nil && [x count] != 0) {
        mXsIndex_++;
        mXIndex_ = -1;
...
- (CGFloat)nextXWithDouble:(CGFloat)advance {
    [ABI35_0_0RNSVGGlyphContext incrementIndices:mXIndices_ topIndex:mXsIndex_];
    long nextIndex = mXIndex_ + 1;
    if (nextIndex < [mXs_ count]) {
        mDX_ = 0;
        mXIndex_ = nextIndex;
        ABI35_0_0RNSVGLength *length = [mXs_ objectAtIndex:nextIndex];
        mX_ = [ABI35_0_0RNSVGPropHelper fromRelative:length
                                   relative:mWidth_
                                   fontSize:mFontSize_];
    }
    mX_ += advance;
...
- (CGFloat)nextY {
    [ABI35_0_0RNSVGGlyphContext incrementIndices:mYIndices_ topIndex:mYsIndex_];
    long nextIndex = mYIndex_ + 1;
    if (nextIndex < [mYs_ count]) {
        mDY_ = 0;
        mYIndex_ = nextIndex;
        ABI35_0_0RNSVGLength *length = [mYs_ objectAtIndex:nextIndex];
        mY_ = [ABI35_0_0RNSVGPropHelper fromRelative:length
                                   relative:mHeight_
                                   fontSize:mFontSize_];
    }
    return mY_;
...
- (CGFloat)nextDeltaX {
    [ABI35_0_0RNSVGGlyphContext incrementIndices:mDXIndices_ topIndex:mDXsIndex_];
    long nextIndex = mDXIndex_ + 1;
    if (nextIndex < [mDXs_ count]) {
        mDXIndex_ = nextIndex;
        ABI35_0_0RNSVGLength *length = [mDXs_ objectAtIndex:nextIndex];
        CGFloat val = [ABI35_0_0RNSVGPropHelper fromRelative:length
                                          relative:mWidth_
                                          fontSize:mFontSize_];
        mDX_ += val;
    }
...
- (CGFloat)nextDeltaY {
    [ABI35_0_0RNSVGGlyphContext incrementIndices:mDYIndices_ topIndex:mDYsIndex_];
    long nextIndex = mDYIndex_ + 1;
    if (nextIndex < [mDYs_ count]) {
        mDYIndex_ = nextIndex;
        ABI35_0_0RNSVGLength *length = [mDYs_ objectAtIndex:nextIndex];
        CGFloat val = [ABI35_0_0RNSVGPropHelper fromRelative:length
                                          relative:mHeight_
                                          fontSize:mFontSize_];
        mDY_ += val;
...
- (CGFloat)nextRotation {
    [ABI35_0_0RNSVGGlyphContext incrementIndices:mRIndices_ topIndex:mRsIndex_];
