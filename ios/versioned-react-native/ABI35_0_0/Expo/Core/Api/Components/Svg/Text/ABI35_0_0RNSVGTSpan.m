...
static NSCharacterSet *ABI35_0_0RNSVGTSpan_separators = nil;
static CGFloat ABI35_0_0RNSVGTSpan_radToDeg = 180 / (CGFloat)M_PI;

@interface ABI35_0_0TopAlignedLabel : UILabel

@end


@implementation ABI35_0_0TopAlignedLabel
...
@implementation ABI35_0_0RNSVGTSpan
{
    CGFloat startOffset;
    CGFloat _pathLength;
    ABI35_0_0RNSVGTextPath *textPath;
    NSArray *lengths;
    NSArray *lines;
...
- (id)init
{
    ...
    if (ABI35_0_0RNSVGTSpan_separators == nil) {
        ABI35_0_0RNSVGTSpan_separators = [NSCharacterSet whitespaceCharacterSet];
    }
...
{
    if (self.content) {
        ABI35_0_0RNSVGGlyphContext* gc = [self.textRoot getGlyphContext];
...
- (NSMutableDictionary *)getAttributes:(ABI35_0_0RNSVGFontData *)fontdata {
    ...
    bool allowOptionalLigatures = letterSpacing == 0 && fontdata->fontVariantLigatures == ABI35_0_0RNSVGFontVariantLigaturesNormal;
...
static ABI35_0_0TopAlignedLabel *label;
- (void)drawWrappedText:(CGContextRef)context gc:(ABI35_0_0RNSVGGlyphContext *)gc rect:(CGRect)rect {
    [self pushGlyphContext];
    fontRef = [self getFontFromContext];
    ABI35_0_0RNSVGFontData* fontdata = [gc getFont];
    ...
    enum ABI35_0_0RNSVGTextAnchor textAnchor = fontdata->textAnchor;
    NSTextAlignment align;
    switch (textAnchor) {
        case ABI35_0_0RNSVGTextAnchorStart:
            align = NSTextAlignmentLeft;
            break;

        case ABI35_0_0RNSVGTextAnchorMiddle:
            align = NSTextAlignmentCenter;
            break;

        case ABI35_0_0RNSVGTextAnchorEnd:
    ...
    if (!label) {
        label = [[ABI35_0_0TopAlignedLabel alloc] init];
    }
    ...
    CGFloat width = [ABI35_0_0RNSVGPropHelper fromRelative:self.inlineSize
...
- (CGFloat)getSubtreeTextChunksTotalAdvance
{
    ...
    if (!str) {
        for (UIView *node in self.subviews) {
            if ([node isKindOfClass:[ABI35_0_0RNSVGText class]]) {
                ABI35_0_0RNSVGText *text = (ABI35_0_0RNSVGText*)node;
...
- (CGPathRef)getLinePath:(NSString *)str context:(CGContextRef)context
{
    ...
    ABI35_0_0RNSVGGlyphContext *gc = [self.textRoot getGlyphContext];
    ABI35_0_0RNSVGFontData *font = [gc getFont];
     ...
     */
    bool allowOptionalLigatures = letterSpacing == 0 && font->fontVariantLigatures == ABI35_0_0RNSVGFontVariantLigaturesNormal;
     ...
     */
    enum ABI35_0_0RNSVGTextAnchor textAnchor = font->textAnchor;
    ABI35_0_0RNSVGText *anchorRoot = [self getTextAnchorRoot];
    CGFloat textMeasure = [anchorRoot getSubtreeTextChunksTotalAdvance];
    CGFloat offset = [ABI35_0_0RNSVGTSpan getTextAnchorOffset:textAnchor width:textMeasure];
    ...
    if (hasTextPath) {
        //sharpMidLine = ABI35_0_0RNSVGTextPathMidLineFromString([textPath midLine]) == ABI35_0_0RNSVGTextPathMidLineSharp;
        /*
         Name
         side
         Value
         ...
         */
        side = ABI35_0_0RNSVGTextPathSideFromString([textPath side]) == ABI35_0_0RNSVGTextPathSideRight ? -1 : 1;
        /*
         Name
         startOffset
         Value
         ...
         the path is reached.
         */
        CGFloat absoluteStartOffset = [ABI35_0_0RNSVGPropHelper fromRelative:textPath.startOffset
                                                          relative:_pathLength
                                                          fontSize:fontSize];
        offset += absoluteStartOffset;
        if (isClosed) {
            CGFloat halfPathDistance = _pathLength / 2;
            startOfRendering = absoluteStartOffset + (textAnchor == ABI35_0_0RNSVGTextAnchorMiddle ? -halfPathDistance : 0);
            endOfRendering = startOfRendering + _pathLength;
        }
        /*
         ABI35_0_0RNSVGTextPathSpacing spacing = textPath.getSpacing();
         if (spacing == ABI35_0_0RNSVGTextPathSpacing.auto) {
         // Hmm, what to do here?
    ...
    ABI35_0_0RNSVGLength *mTextLength = [self textLength];
    enum ABI35_0_0RNSVGTextLengthAdjust mLengthAdjust = ABI35_0_0RNSVGTextLengthAdjustFromString([self lengthAdjust]);
    if (mTextLength != nil) {
        CGFloat author = [ABI35_0_0RNSVGPropHelper fromRelative:mTextLength
                                             relative:[gc getWidth]
                                             fontSize:fontSize];
        if (author < 0) {
        ...
        switch (mLengthAdjust) {
            default:
            case ABI35_0_0RNSVGTextLengthAdjustSpacing:
                // TODO account for ligatures
                letterSpacing += (author - textMeasure) / (n - 1);
                break;
            case ABI35_0_0RNSVGTextLengthAdjustSpacingAndGlyphs:
    ...
    */
    ...
    enum ABI35_0_0RNSVGAlignmentBaseline baseline = ABI35_0_0RNSVGAlignmentBaselineFromString(self.alignmentBaseline);
    if (baseline != ABI35_0_0RNSVGAlignmentBaselineBaseline) {
        ...
        switch (baseline) {
            ...
            default:
            case ABI35_0_0RNSVGAlignmentBaselineBaseline:
                // Use the dominant baseline choice of the parent.
                // Match the box’s corresponding baseline to that of its parent.
                baselineShift = 0;
                break;

            case ABI35_0_0RNSVGAlignmentBaselineTextBottom:
            case ABI35_0_0RNSVGAlignmentBaselineAfterEdge:
            case ABI35_0_0RNSVGAlignmentBaselineTextAfterEdge:
            ...
            case ABI35_0_0RNSVGAlignmentBaselineCentral:
            ...
            case ABI35_0_0RNSVGAlignmentBaselineMathematical:
            ...
            case ABI35_0_0RNSVGAlignmentBaselineHanging:
                baselineShift = (CGFloat)0.8 * ascenderHeight;
                break;

            case ABI35_0_0RNSVGAlignmentBaselineTextTop:
            case ABI35_0_0RNSVGAlignmentBaselineBeforeEdge:
            case ABI35_0_0RNSVGAlignmentBaselineTextBeforeEdge:
            ...
            case ABI35_0_0RNSVGAlignmentBaselineBottom:
                // Align the top of the aligned subtree with the top of the line box.
                baselineShift = bottom;
                break;

            case ABI35_0_0RNSVGAlignmentBaselineCenter:
                // Align the center of the aligned subtree with the center of the line box.
                baselineShift = totalHeight / 2;
                break;

            case ABI35_0_0RNSVGAlignmentBaselineTop:
        ...
        switch (baseline) {
            ...
            default:
                if (fontData != nil && [baselineShiftString isEqualToString:@"sub"]) {
                    ...
                    baselineShift -= [ABI35_0_0RNSVGPropHelper fromRelativeWithNSString:baselineShiftString
                                                                   relative:fontSize
                                                                   fontSize:fontSize];
                }
                break;
    ...
    for (CFIndex ri = 0; ri < runEnd; ri++) {
        ...
        for(CFIndex g = 0; g < runGlyphCount; g++) {
            ...
            bool isWordSeparator = [ABI35_0_0RNSVGTSpan_separators characterIsMember:currentChar];
            ...
            CGFloat r = [gc nextRotation] / ABI35_0_0RNSVGTSpan_radToDeg;
...
+ (CGFloat)getTextAnchorOffset:(ABI35_0_0RNSVGTextAnchor)textAnchor width:(CGFloat) width
{
    switch (textAnchor) {
        case ABI35_0_0RNSVGTextAnchorStart:
            return 0;
...
- (void)setupTextPath:(CGContextRef)context
{
    ...
    lengths = nil;
    textPath = nil;
    ABI35_0_0RNSVGText *parent = (ABI35_0_0RNSVGText*)[self superview];

    while (parent) {
        if ([parent class] == [ABI35_0_0RNSVGTextPath class]) {
            textPath = (ABI35_0_0RNSVGTextPath*) parent;
            [textPath getPathLength:&_pathLength
                          lineCount:&lineCount
                           ...
                           isClosed:&isClosed];
            break;
        } else if (![parent isKindOfClass:[ABI35_0_0RNSVGText class]]) {
            break;
        }

        parent = (ABI35_0_0RNSVGText*)[parent superview];
    }
}
