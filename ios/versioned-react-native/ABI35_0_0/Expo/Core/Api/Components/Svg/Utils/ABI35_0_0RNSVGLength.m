...
@implementation ABI35_0_0RNSVGLength
...
{
    ABI35_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype) lengthWithString: (NSString *) lengthString {
    ...
    ABI35_0_0RNSVGLength *output = [ABI35_0_0RNSVGLength alloc];
    if (stringLength == 0) {
        ...
        ABI35_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
...
- (BOOL) isEqualTo: (ABI35_0_0RNSVGLength *)other {
