...
- (id)init
{
    if (self = [super init]) {
        _fillOpacity = 1;
        _strokeOpacity = 1;
        _strokeWidth = [ABI35_0_0RNSVGLength lengthWithNumber:1];
...
- (void)setFill:(ABI35_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI35_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI35_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)setStrokeWidth:(ABI35_0_0RNSVGLength*)strokeWidth
{
...
- (void)setStrokeDasharray:(NSArray<ABI35_0_0RNSVGLength *> *)strokeDasharray
{
...
- (void)setVectorEffect:(ABI35_0_0RNSVGVectorEffect)vectorEffect
{
...
UInt32 ABI35_0_0saturate(CGFloat value) {
...
- (void)renderTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    if (self.mask) {
        ...
        ABI35_0_0RNSVGMask *_maskNode = (ABI35_0_0RNSVGMask*)[self.svgView getDefinedMask:self.mask];
        ...
        for (NSUInteger i = 0; i < npixels; i++) {
            ...
            *currentPixel = ABI35_0_0saturate(luma) << 24;
            currentPixel++;
        }
...
- (void)prepareStrokeDash:(NSUInteger)count strokeDasharray:(NSArray<ABI35_0_0RNSVGLength *> *)strokeDasharray {
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    if (self.fill) {
        if (self.fill.class == ABI35_0_0RNSVGBrush.class) {
    ...
    if (self.stroke) {
        ...
        NSArray<ABI35_0_0RNSVGLength *>* strokeDasharray = self.strokeDasharray;
        ...
        if (self.stroke.class == ABI35_0_0RNSVGBrush.class) {
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    if (self.clipPath) {
        ABI35_0_0RNSVGClipPath *clipNode = (ABI35_0_0RNSVGClipPath*)[self.svgView getDefinedClipPath:self.clipPath];
        if ([clipNode isSimpleClipPath]) {
            ...
            ABI35_0_0RNSVGRenderable *clipGroup = (ABI35_0_0RNSVGRenderable*)clipNode;
...
- (void)mergeProperties:(__kindof ABI35_0_0RNSVGRenderable *)target
{
