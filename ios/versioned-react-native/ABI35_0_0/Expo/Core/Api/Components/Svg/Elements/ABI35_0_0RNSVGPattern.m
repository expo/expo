...
@implementation ABI35_0_0RNSVGPattern
...
{
    self.dirty = false;
    NSArray<ABI35_0_0RNSVGLength *> *points = @[self.x, self.y, self.patternwidth, self.patternheight];
...
- (void)setPatternwidth:(ABI35_0_0RNSVGLength *)patternwidth
{
...
- (void)setPatternheight:(ABI35_0_0RNSVGLength *)patternheight
{
...
- (void)setPatternUnits:(ABI35_0_0RNSVGUnits)patternUnits
{
...
- (void)setPatternContentUnits:(ABI35_0_0RNSVGUnits)patternContentUnits
{
