...
@implementation ABI35_0_0RNSVGGroupManager

ABI35_0_0RCT_EXPORT_MODULE()

- (ABI35_0_0RNSVGNode *)node
{
  return [ABI35_0_0RNSVGGroup new];
}

ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(font, NSDictionary)

ABI35_0_0RCT_CUSTOM_VIEW_PROPERTY(fontSize, id, ABI35_0_0RNSVGGroup)
{
...
ABI35_0_0RCT_CUSTOM_VIEW_PROPERTY(fontWeight, id, ABI35_0_0RNSVGGroup)
{
    if ([json isKindOfClass:[NSString class]]) {
        NSString *stringValue = (NSString *)json;
