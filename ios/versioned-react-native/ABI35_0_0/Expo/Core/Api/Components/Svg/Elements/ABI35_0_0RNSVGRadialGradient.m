...
@implementation ABI35_0_0RNSVGRadialGradient

- (void)setFx:(ABI35_0_0RNSVGLength *)fx
{
    if ([fx isEqualTo:_fx]) {
        return;
    }
...
- (void)setFy:(ABI35_0_0RNSVGLength *)fy
{
    if ([fy isEqualTo:_fy]) {
        return;
    }
...
- (void)setRx:(ABI35_0_0RNSVGLength *)rx
{
    if ([rx isEqualTo:_rx]) {
        return;
    }
...
- (void)setRy:(ABI35_0_0RNSVGLength *)ry
{
    if ([ry isEqualTo:_ry]) {
        return;
    }
...
- (void)setCx:(ABI35_0_0RNSVGLength *)cx
{
    if ([cx isEqualTo:_cx]) {
        return;
    }
...
- (void)setCy:(ABI35_0_0RNSVGLength *)cy
{
    if ([cy isEqualTo:_cy]) {
        return;
    }
...
- (void)setGradientUnits:(ABI35_0_0RNSVGUnits)gradientUnits
{
...
{
    self.dirty = false;
    NSArray<ABI35_0_0RNSVGLength *> *points = @[self.fx, self.fy, self.rx, self.ry, self.cx, self.cy];
    ABI35_0_0RNSVGPainter *painter = [[ABI35_0_0RNSVGPainter alloc] initWithPointsArray:points];
