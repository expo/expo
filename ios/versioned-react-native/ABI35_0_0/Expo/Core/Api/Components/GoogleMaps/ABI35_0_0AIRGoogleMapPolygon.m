//
//  ABI35_0_0AIRGoogleMapPolygon.m
//
...
#import "ABI35_0_0AIRGMSPolygon.h"
#import <GoogleMaps/GoogleMaps.h>

@implementation ABI35_0_0AIRGoogleMapPolygon

- (instancetype)init
{
  if (self = [super init]) {
    _polygon = [[ABI35_0_0AIRGMSPolygon alloc] init];
  }
...
- (void)setHoles:(NSArray<NSArray<ABI35_0_0AIRMapCoordinate *> *> *)holes
{
  _holes = holes;
...
- (void)setOnPress:(ABI35_0_0RCTBubblingEventBlock)onPress {
