//
//  ABI35_0_0AIRGoogleMapWMSTile.h
//  AirMaps
//
...
@interface ABI35_0_0WMSTileOverlay : GMSSyncTileLayer
...
@interface ABI35_0_0AIRGoogleMapWMSTile : UIView
@property (nonatomic, strong) ABI35_0_0WMSTileOverlay *tileLayer;
