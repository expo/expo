...
#import "ABI35_0_0AIRDummyView.h"
...
@interface ABI35_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI35_0_0AIRGMSMarker*)marker;
@end

@implementation ABI35_0_0AIRGoogleMapMarker {
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI35_0_0AIRGMSMarker alloc] init];
...
- (void)insertReactABI35_0_0Subview:(id<ABI35_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI35_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI35_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI35_0_0AIRDummyView *dummySubview = [[ABI35_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertReactABI35_0_0Subview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeReactABI35_0_0Subview:(id<ABI35_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI35_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeReactABI35_0_0Subview:(UIView*)dummySubview];
}
...
- (ABI35_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/ReactABI35_0_0-native-community/ReactABI35_0_0-native-maps/issues/738)
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI35_0_0RN?
...
- (void)setIconSrc:(NSString *)iconSrc
{
  ...
  _reloadImageCancellationBlock =
  [_bridge.imageLoader loadImageWithURLRequest:[ABI35_0_0RCTConvert NSURLRequest:_iconSrc]
                                          size:self.bounds.size
                                         scale:ABI35_0_0RCTScreenScale()
                                       clipped:YES
                                    resizeMode:ABI35_0_0RCTResizeModeCenter
