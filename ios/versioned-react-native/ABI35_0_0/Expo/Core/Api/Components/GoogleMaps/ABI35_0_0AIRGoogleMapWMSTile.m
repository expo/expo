//
//  ABI35_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI35_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI35_0_0WMSTileOverlay *tile = [[ABI35_0_0WMSTileOverlay alloc] init];
...
@implementation ABI35_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
