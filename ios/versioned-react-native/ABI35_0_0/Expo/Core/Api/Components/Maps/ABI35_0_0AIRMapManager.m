...
#import "ABI35_0_0AIRMapManager.h"
...
#import "ABI35_0_0AIRMapPolygon.h"
#import "ABI35_0_0AIRMapCircle.h"
#import "ABI35_0_0SMCalloutView.h"
#import "ABI35_0_0AIRMapUrlTile.h"
#import "ABI35_0_0AIRMapWMSTile.h"
#import "ABI35_0_0AIRMapLocalTile.h"
#import "ABI35_0_0AIRMapSnapshot.h"
#import "ABI35_0_0RCTConvert+AirMap.h"
#import "ABI35_0_0AIRMapOverlay.h"
#import "ABI35_0_0AIRWeakTimerReference.h"
#import "ABI35_0_0AIRWeakMapReference.h"
#import <MapKit/MapKit.h>

static NSString *const ABI35_0_0RCTMapViewKey = @"MapView";


@interface ABI35_0_0AIRMapManager() <MKMapViewDelegate>

@end

@implementation ABI35_0_0AIRMapManager{
   BOOL _hasObserver;
}
...
- (UIView *)view
{
    ABI35_0_0AIRMap *map = [ABI35_0_0AIRMap new];
    map.delegate = self;
...
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(showsUserLocation, BOOL)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(userLocationAnnotationTitle, NSString)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(showsPointsOfInterest, BOOL)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(showsTraffic, BOOL)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(zoomEnabled, BOOL)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(kmlSrc, NSString)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(rotateEnabled, BOOL)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(scrollEnabled, BOOL)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(pitchEnabled, BOOL)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(cacheEnabled, BOOL)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(maxDelta, CGFloat)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(minDelta, CGFloat)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(compassOffset, CGPoint)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(legalLabelInsets, UIEdgeInsets)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, MKMapType)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(onMapReady, ABI35_0_0RCTBubblingEventBlock)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(onChange, ABI35_0_0RCTBubblingEventBlock)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(onPanDrag, ABI35_0_0RCTBubblingEventBlock)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(onPress, ABI35_0_0RCTBubblingEventBlock)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(onLongPress, ABI35_0_0RCTBubblingEventBlock)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerPress, ABI35_0_0RCTDirectEventBlock)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI35_0_0RCTDirectEventBlock)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI35_0_0RCTDirectEventBlock)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI35_0_0RCTDirectEventBlock)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI35_0_0RCTDirectEventBlock)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI35_0_0RCTDirectEventBlock)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(onCalloutPress, ABI35_0_0RCTDirectEventBlock)
ABI35_0_0RCT_CUSTOM_VIEW_PROPERTY(initialRegion, MKCoordinateRegion, ABI35_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setInitialRegion:[ABI35_0_0RCTConvert MKCoordinateRegion:json]];
    view.ignoreRegionChanges = originalIgnore;
}
ABI35_0_0RCT_CUSTOM_VIEW_PROPERTY(initialCamera, MKMapCamera, ABI35_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setInitialCamera:[ABI35_0_0RCTConvert MKMapCamera:json]];
    view.ignoreRegionChanges = originalIgnore;
}


ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(minZoomLevel, CGFloat)
ABI35_0_0RCT_EXPORT_VIEW_PROPERTY(maxZoomLevel, CGFloat)


ABI35_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI35_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setRegion:[ABI35_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}

ABI35_0_0RCT_CUSTOM_VIEW_PROPERTY(camera, MKMapCamera*, ABI35_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setCamera:[ABI35_0_0RCTConvert MKMapCamera:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}
...
ABI35_0_0RCT_EXPORT_METHOD(getMapBoundaries:(nonnull NSNumber *)ReactABI35_0_0Tag
                  ...
                  rejecter:(ABI35_0_0RCTPromiseRejectBlock)reject)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI35_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI35_0_0AIRMap class]]) {
...
ABI35_0_0RCT_EXPORT_METHOD(getCamera:(nonnull NSNumber *)ReactABI35_0_0Tag
                  resolver: (ABI35_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI35_0_0RCTPromiseRejectBlock)reject)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI35_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        id view = viewRegistry[ReactABI35_0_0Tag];
        ABI35_0_0AIRMap *mapView = (ABI35_0_0AIRMap *)view;
        if (![view isKindOfClass:[ABI35_0_0AIRMap class]]) {
            reject(@"Invalid argument", [NSString stringWithFormat:@"Invalid view returned from registry, expecting ABI35_0_0AIRMap, got: %@", view], NULL);
        } else {
...
ABI35_0_0RCT_EXPORT_METHOD(setCamera:(nonnull NSNumber *)ReactABI35_0_0Tag
                  camera:(id)json)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI35_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        id view = viewRegistry[ReactABI35_0_0Tag];
        if (![view isKindOfClass:[ABI35_0_0AIRMap class]]) {
            ...
            MKMapCamera *camera = [ABI35_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:[mapView camera]];
...
ABI35_0_0RCT_EXPORT_METHOD(animateCamera:(nonnull NSNumber *)ReactABI35_0_0Tag
                  withCamera:(id)json
                  withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI35_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI35_0_0AIRMap class]]) {
            ...
            BOOL originalIgnore = mapView.ignoreRegionChanges;
            mapView.ignoreRegionChanges = YES;
            [ABI35_0_0AIRMap animateWithDuration:duration/1000 animations:^{
...
ABI35_0_0RCT_EXPORT_METHOD(animateToNavigation:(nonnull NSNumber *)ReactABI35_0_0Tag
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI35_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI35_0_0AIRMap class]]) {
            ...
            [ABI35_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI35_0_0AIRMap *)view setRegion:region animated:YES];
...
ABI35_0_0RCT_EXPORT_METHOD(animateToRegion:(nonnull NSNumber *)ReactABI35_0_0Tag
        withRegion:(MKCoordinateRegion)region
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI35_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
...
ABI35_0_0RCT_EXPORT_METHOD(animateToCoordinate:(nonnull NSNumber *)ReactABI35_0_0Tag
...
ABI35_0_0RCT_EXPORT_METHOD(animateToViewingAngle:(nonnull NSNumber *)ReactABI35_0_0Tag
                  withAngle:(double)angle
                  withDuration:(CGFloat)duration)
{
  [self.bridge.uiManager addUIBlock:^(__unused ABI35_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
...
ABI35_0_0RCT_EXPORT_METHOD(animateToBearing:(nonnull NSNumber *)ReactABI35_0_0Tag
                  withBearing:(CGFloat)bearing
                  withDuration:(CGFloat)duration)
{
  [self.bridge.uiManager addUIBlock:^(__unused ABI35_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
...
ABI35_0_0RCT_EXPORT_METHOD(fitToElements:(nonnull NSNumber *)ReactABI35_0_0Tag
...
ABI35_0_0RCT_EXPORT_METHOD(fitToSuppliedMarkers:(nonnull NSNumber *)ReactABI35_0_0Tag
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI35_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI35_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ABI35_0_0AIRMapMarker *marker = (ABI35_0_0AIRMapMarker *)evaluatedObject;
                return [marker isKindOfClass:[ABI35_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
...
ABI35_0_0RCT_EXPORT_METHOD(fitToCoordinates:(nonnull NSNumber *)ReactABI35_0_0Tag
                  coordinates:(nonnull NSArray<ABI35_0_0AIRMapCoordinate *> *)coordinates
                  edgePadding:(nonnull NSDictionary *)edgePadding
                  animated:(BOOL)animated)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI35_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI35_0_0AIRMap class]]) {
            ...
            // Set Map viewport
            CGFloat top = [ABI35_0_0RCTConvert CGFloat:edgePadding[@"top"]];
            CGFloat right = [ABI35_0_0RCTConvert CGFloat:edgePadding[@"right"]];
            CGFloat bottom = [ABI35_0_0RCTConvert CGFloat:edgePadding[@"bottom"]];
            CGFloat left = [ABI35_0_0RCTConvert CGFloat:edgePadding[@"left"]];
...
ABI35_0_0RCT_EXPORT_METHOD(takeSnapshot:(nonnull NSNumber *)ReactABI35_0_0Tag
...
ABI35_0_0RCT_EXPORT_METHOD(pointForCoordinate:(nonnull NSNumber *)ReactABI35_0_0Tag
...
ABI35_0_0RCT_EXPORT_METHOD(getMarkersFrames:(nonnull NSNumber *)ReactABI35_0_0Tag
...
ABI35_0_0RCT_EXPORT_METHOD(coordinateForPoint:(nonnull NSNumber *)ReactABI35_0_0Tag
...
- (void)takeMapSnapshot:(ABI35_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI35_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI35_0_0AIRMap *map = (ABI35_0_0AIRMap *)recognizer.view;
    ...
    ABI35_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI35_0_0AIRMapPolygon class]]){
            ABI35_0_0AIRMapPolygon *polygon = (ABI35_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI35_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI35_0_0AIRMapPolyline class]]){
            ABI35_0_0AIRMapPolyline *polyline = (ABI35_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
        ...
        if ([overlay isKindOfClass:[ABI35_0_0AIRMapOverlay class]]) {
            ABI35_0_0AIRMapOverlay *imageOverlay = (ABI35_0_0AIRMapOverlay*) overlay;
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI35_0_0AIRMapPolyline class]]) {
        return ((ABI35_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI35_0_0AIRMapPolygon class]]) {
        return ((ABI35_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI35_0_0AIRMapCircle class]]) {
        return ((ABI35_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI35_0_0AIRMapUrlTile class]]) {
        return ((ABI35_0_0AIRMapUrlTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI35_0_0AIRMapWMSTile class]]) {
        return ((ABI35_0_0AIRMapWMSTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI35_0_0AIRMapLocalTile class]]) {
        return ((ABI35_0_0AIRMapLocalTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI35_0_0AIRMapOverlay class]]) {
        return ((ABI35_0_0AIRMapOverlay *)overlay).renderer;
...
- (void)mapView:(ABI35_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI35_0_0AIRMapMarker class]]) {
        [(ABI35_0_0AIRMapMarker *)view.annotation showCalloutView];
...
- (void)mapView:(ABI35_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI35_0_0AIRMapMarker class]]) {
        [(ABI35_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI35_0_0AIRMap *)mapView viewForAnnotation:(ABI35_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI35_0_0AIRMapMarker class]]) {
...
- (void)mapView:(ABI35_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI35_0_0AIRMapMarker class]]) return;
    ABI35_0_0AIRMapMarker *marker = (ABI35_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI35_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI35_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI35_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI35_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI35_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    [self _regionChanged:mapView];

    ABI35_0_0AIRWeakTimerReference *weakTarget = [[ABI35_0_0AIRWeakTimerReference alloc] initWithTarget:self andSelector:@selector(_onTick:)];
    
    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI35_0_0AIRMapRegionChangeObserveInterval
                                                               target:weakTarget
                                                             selector:@selector(timerDidFire:)
                                                             userInfo:@{ ABI35_0_0RCTMapViewKey: [[ABI35_0_0AIRWeakMapReference alloc] initWithMapView: mapView] }
                                                              repeats:YES];

    [[NSRunLoop mainRunLoop] addTimer:mapView.regionChangeObserveTimer forMode:NSRunLoopCommonModes];
}

- (void)mapView:(ABI35_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI35_0_0AIRMap *)mapView
{
    if (!mapView.hasStartedRendering) {
      mapView.onMapReady(@{});
...
- (void)mapViewDidFinishRenderingMap:(ABI35_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
{
    ABI35_0_0AIRWeakMapReference *weakRef = timer.userInfo[ABI35_0_0RCTMapViewKey];
    [self _regionChanged:weakRef.mapView];
}

- (void)_regionChanged:(ABI35_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI35_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI35_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI35_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI35_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI35_0_0AIRMap *)mapView
{
...
- (MKCoordinateSpan)coordinateSpanWithMapView:(ABI35_0_0AIRMap *)mapView
                             centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                 andZoomLevel:(double)zoomLevel
{
    // convert center coordiate to pixel space
    double centerPixelX = [ABI35_0_0AIRMapManager longitudeToPixelSpaceX:centerCoordinate.longitude];
    double centerPixelY = [ABI35_0_0AIRMapManager latitudeToPixelSpaceY:centerCoordinate.latitude];

    // determine the scale value from the zoom level
    double zoomExponent = ABI35_0_0AIRMapMaxZoomLevel - zoomLevel;
    ...
    CLLocationDegrees minLng = [ABI35_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX];
    CLLocationDegrees maxLng = [ABI35_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX + scaledMapWidth];
    CLLocationDegrees longitudeDelta = maxLng - minLng;

    // find delta between top and bottom latitudes
    CLLocationDegrees minLat = [ABI35_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY];
    CLLocationDegrees maxLat = [ABI35_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY + scaledMapHeight];
...
- (void)setCenterCoordinate:(CLLocationCoordinate2D)centerCoordinate
                  zoomLevel:(double)zoomLevel
                   animated:(BOOL)animated
                    mapView:(ABI35_0_0AIRMap *)mapView
{
    // clamp large numbers to 28
    zoomLevel = MIN(zoomLevel, ABI35_0_0AIRMapMaxZoomLevel);
...
-(MKCoordinateRegion)coordinateRegionWithMapView:(ABI35_0_0AIRMap *)mapView
                                centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                    andZoomLevel:(double)zoomLevel
{
	...
	// find delta between top and bottom latitudes
	CLLocationDegrees minLat = [ABI35_0_0AIRMapManager pixelSpaceYToLatitude:topPixelY];
	CLLocationDegrees maxLat = [ABI35_0_0AIRMapManager pixelSpaceYToLatitude:bottomPixelY];
	CLLocationDegrees latitudeDelta = -1 * (maxLat - minLat);
	...
	if (adjustedCenterPoint) {
		region.center.latitude = [ABI35_0_0AIRMapManager pixelSpaceYToLatitude:((bottomPixelY + topPixelY) / 2.0)];
	}

	return region;
}

- (double) zoomLevel:(ABI35_0_0AIRMap *)mapView {
    MKCoordinateRegion region = mapView.region;

    double centerPixelX = [ABI35_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude];
    double topLeftPixelX = [ABI35_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude - region.span.longitudeDelta / 2];

    double scaledMapWidth = (centerPixelX - topLeftPixelX) * 2;
    CGSize mapSizeInPixels = mapView.bounds.size;
    double zoomScale = scaledMapWidth / mapSizeInPixels.width;
    double zoomExponent = log(zoomScale) / log(2);
    double zoomLevel = ABI35_0_0AIRMapMaxZoomLevel - zoomExponent;
