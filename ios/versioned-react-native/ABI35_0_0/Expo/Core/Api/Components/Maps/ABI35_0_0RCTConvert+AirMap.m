...
@implementation ABI35_0_0RCTConvert (AirMap)
...
{
    json = [self NSDictionary:json];
    return [ABI35_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:nil];
}
...
ABI35_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI35_0_0AIRMapCoordinate *)ABI35_0_0AIRMapCoordinate:(id)json
{
    ABI35_0_0AIRMapCoordinate *coord = [ABI35_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI35_0_0RCT_ARRAY_CONVERTER(ABI35_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI35_0_0AIRMapCoordinate *> *> *)ABI35_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI35_0_0RCTConvertArrayValue(@selector(ABI35_0_0AIRMapCoordinateArray:), json);
}
