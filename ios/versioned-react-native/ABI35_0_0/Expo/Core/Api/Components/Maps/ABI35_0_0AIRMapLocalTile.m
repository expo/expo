...
#import "ABI35_0_0AIRMapLocalTileOverlay.h"

@implementation ABI35_0_0AIRMapLocalTile {
...
- (void) createTileOverlayAndRendererIfPossible
{
    ...
    self.tileOverlay = [[ABI35_0_0AIRMapLocalTileOverlay alloc] initWithURLTemplate:self.pathTemplate];
