...
#import <ReactABI35_0_0/ABI35_0_0RCTAutoInsetsProtocol.h>
#import "ABI35_0_0RNCWKProcessPoolManager.h"
...
@interface ABI35_0_0_SwizzleHelperWK : NSObject @end
@implementation ABI35_0_0_SwizzleHelperWK
...
@interface ABI35_0_0RNCWebView () <WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler, UIScrollViewDelegate, ABI35_0_0RCTAutoInsetsProtocol>
...
@property (nonatomic, copy) ABI35_0_0RCTDirectEventBlock onLoadingProgress;
...
@property (nonatomic, copy) ABI35_0_0RCTDirectEventBlock onScroll;
@property (nonatomic, copy) WKWebView *webView;
@end

@implementation ABI35_0_0RNCWebView
{
  ...
  // https://github.com/ReactABI35_0_0-native-community/ReactABI35_0_0-native-webview/issues/62
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if ((self = [super initWithFrame:frame])) {
    ...
    _savedStatusBarStyle = ABI35_0_0RCTSharedApplication().statusBarStyle;
    _savedStatusBarHidden = ABI35_0_0RCTSharedApplication().statusBarHidden;
...
- (void)didMoveToWindow
{
  if (self.window != nil && _webView == nil) {
    ...
    if(self.useSharedProcessPool) {
      wkWebViewConfig.processPool = [[ABI35_0_0RNCWKProcessPoolManager sharedManager] sharedProcessPoolForExperienceId:self.experienceId];
    }
        ...
        */
        ...
        for (NSHTTPCookie *cookie in [[NSHTTPCookieStorage sharedHTTPCookieStorage] cookies]) {
          [script appendFormat:@"document.cookie = %@ + '=' + %@",
            ABI35_0_0RCTJSONStringify(cookie.name, NULL),
            ABI35_0_0RCTJSONStringify(cookie.value, NULL)];
          if (cookie.path) {
            [script appendFormat:@" + '; Path=' + %@", ABI35_0_0RCTJSONStringify(cookie.path, NULL)];
          }
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
  if (!_isFullScreenVideoOpen) {
    ...
    ABI35_0_0RCTUnsafeExecuteOnMainQueueSync(^{
      [ABI35_0_0RCTSharedApplication() setStatusBarStyle:UIStatusBarStyleLightContent animated:YES];
    });
  } else {
    _isFullScreenVideoOpen = NO;
    ABI35_0_0RCTUnsafeExecuteOnMainQueueSync(^{
      [ABI35_0_0RCTSharedApplication() setStatusBarHidden:_savedStatusBarHidden animated:YES];
      [ABI35_0_0RCTSharedApplication() setStatusBarStyle:_savedStatusBarStyle animated:YES];
    });
  }
...
- (void)visitSource
{
    ...
    if (request.URL.host) {
        ...
        NSURL* readAccessUrl = _allowingReadAccessToURL ? [ABI35_0_0RCTConvert NSURL:_allowingReadAccessToURL] : request.URL;
...
-(void)setHideKeyboardAccessoryView:(BOOL)hideKeyboardAccessoryView
{
    ...
    NSString* name = [NSString stringWithFormat:@"%@ABI35_0_0_SwizzleHelperWK", subview.class.superclass];
    ...
    if(newClass == nil)
    {
        ...
        Method method = class_getInstanceMethod([ABI35_0_0_SwizzleHelperWK class], @selector(inputAccessoryView));
...
- (void)layoutSubviews
{
  ...
  // Ensure webview takes the position and dimensions of ABI35_0_0RNCWebView
          ...
          thenCall: (void (^)(NSString*)) callback
{
  [self.webView evaluateJavaScript: js completionHandler: ^(id result, NSError *error) {
    ...
    if (error != nil) {
      ABI35_0_0RCTLogWarn([NSString stringWithFormat:@"Error evaluating injectedJavaScript: This is possibly due to an unsupported return type. Try adding true to the end of your injectedJavaScript string. %@", error]);
    }
  }];
}
