//
//  ABI35_0_0RNSharedElementTransitionItem.m
//  ReactABI35_0_0-native-shared-element
//

#import <Foundation/Foundation.h>
#import <UIKit/UIKit.h>
#import "ABI35_0_0RNSharedElementTransitionItem.h"
...
@implementation ABI35_0_0RNSharedElementTransitionItem {
...
- (instancetype)initWithNodeManager:(ABI35_0_0RNSharedElementNodeManager*)nodeManager name:(NSString*)name isAncestor:(BOOL)isAncestor
{
    ...
    _needsContent = NO;
    _content = nil;
    _contentType = ABI35_0_0RNSharedElementContentTypeNone;
    _style = nil;
    _hidden = NO;
    return self;
}

- (void) setNode:(ABI35_0_0RNSharedElementNode *)node
{
    if (_node == node) {
...
{
    switch(_contentType) {
        case ABI35_0_0RNSharedElementContentTypeNone: return @"none";
        case ABI35_0_0RNSharedElementContentTypeRawImage: return @"image";
        case ABI35_0_0RNSharedElementContentTypeSnapshotView: return @"snapshotView";
        case ABI35_0_0RNSharedElementContentTypeSnapshotImage: return @"snapshotImage";
...
+ (CGSize) contentSizeFor:(CGRect)layout content:(id)content contentType:(ABI35_0_0RNSharedElementContentType)contentType
{
    ...
    if (contentType != ABI35_0_0RNSharedElementContentTypeRawImage) return layout.size;
...
+ (CGRect) contentLayoutFor:(CGRect)layout content:(id)content contentType:(ABI35_0_0RNSharedElementContentType)contentType contentMode:(UIViewContentMode) contentMode reverse:(BOOL)reverse
{
    ...
    if (contentType != ABI35_0_0RNSharedElementContentTypeRawImage) return layout;
    CGSize size = layout.size;
    CGSize contentSize = [ABI35_0_0RNSharedElementTransitionItem contentSizeFor:layout content:content contentType:contentType];
...
- (CGRect) contentLayoutForContent:(id)content contentType:(ABI35_0_0RNSharedElementContentType)contentType
{
    ...
    return [ABI35_0_0RNSharedElementTransitionItem contentLayoutFor:_style.layout content:content contentType:contentType contentMode:_style.contentMode reverse:NO];
}
