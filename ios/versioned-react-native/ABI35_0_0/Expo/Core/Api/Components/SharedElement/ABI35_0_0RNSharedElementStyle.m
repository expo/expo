//
//  ABI35_0_0RNSharedElementStyle.m
//  ReactABI35_0_0-native-shared-element
//

#import "ABI35_0_0RNSharedElementStyle.h"

@implementation ABI35_0_0RNSharedElementStyle
{
...
+ (ABI35_0_0RNSharedElementStyle*) getInterpolatedStyle:(ABI35_0_0RNSharedElementStyle*)style1 style2:(ABI35_0_0RNSharedElementStyle*)style2 position:(CGFloat) position
{
    ...
    style.borderColor = [ABI35_0_0RNSharedElementStyle getInterpolatedColor:style1.borderColor color2:style2.borderColor position:position];
    style.backgroundColor = [ABI35_0_0RNSharedElementStyle getInterpolatedColor:style1.backgroundColor color2:style2.backgroundColor position:position];
    ...
    style.shadowColor = [ABI35_0_0RNSharedElementStyle getInterpolatedColor:style1.shadowColor color2:style2.shadowColor position:position];
    return style;
}
