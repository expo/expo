//
//  ABI35_0_0RNSharedElementTransition.m
...
@implementation ABI35_0_0RNSharedElementTransition
{
    NSArray* _items;
...
- (instancetype)initWithNodeManager:(ABI35_0_0RNSharedElementNodeManager*)nodeManager
{
    if ((self = [super init])) {
        _items = @[
                   [[ABI35_0_0RNSharedElementTransitionItem alloc]initWithNodeManager:nodeManager name:@"startAncestor" isAncestor:YES],
                   [[ABI35_0_0RNSharedElementTransitionItem alloc]initWithNodeManager:nodeManager name:@"endAncestor" isAncestor:YES],
                   [[ABI35_0_0RNSharedElementTransitionItem alloc]initWithNodeManager:nodeManager name:@"startNode" isAncestor:NO],
                   [[ABI35_0_0RNSharedElementTransitionItem alloc]initWithNodeManager:nodeManager name:@"endNode" isAncestor:NO]
                   ];
        _nodePosition = 0.0f;
        _animation = ABI35_0_0RNSharedElementAnimationMove;
        _resize = ABI35_0_0RNSharedElementResizeStretch;
        _align = ABI35_0_0RNSharedElementAlignCenterCenter;
        _ReactABI35_0_0FrameSet = NO;
...
- (void)removeFromSuperview
{
    ...
    for (ABI35_0_0RNSharedElementTransitionItem* item in _items) {
...
- (ABI35_0_0RNSharedElementTransitionItem*) findItemForNode:(ABI35_0_0RNSharedElementNode*) node
{
    for (ABI35_0_0RNSharedElementTransitionItem* item in _items) {
        if (item.node == node) {
            return item;
...
- (void)setStartNode:(ABI35_0_0RNSharedElementNode *)startNode
{
    ((ABI35_0_0RNSharedElementTransitionItem*)[_items objectAtIndex:ITEM_START]).node = startNode;
}

- (void)setEndNode:(ABI35_0_0RNSharedElementNode *)endNode
{
    ((ABI35_0_0RNSharedElementTransitionItem*)[_items objectAtIndex:ITEM_END]).node = endNode;
}

- (void)setStartAncestor:(ABI35_0_0RNSharedElementNode *)startNodeAncestor
{
    ((ABI35_0_0RNSharedElementTransitionItem*)[_items objectAtIndex:ITEM_START_ANCESTOR]).node = startNodeAncestor;
}

- (void)setEndAncestor:(ABI35_0_0RNSharedElementNode *)endNodeAncestor
{
    ((ABI35_0_0RNSharedElementTransitionItem*)[_items objectAtIndex:ITEM_END_ANCESTOR]).node = endNodeAncestor;
}
...
- (void) setAnimation:(ABI35_0_0RNSharedElementAnimation)animation
{
...
- (void) setResize:(ABI35_0_0RNSharedElementResize)resize
{
    if (_resize != resize) {
        _resize = resize;
        [self updateStyle];
...
- (void) setAlign:(ABI35_0_0RNSharedElementAlign)align
{
    if (_align != align) {
        _align = align;
        [self updateStyle];
...
- (void)updateNodeVisibility
{
    for (ABI35_0_0RNSharedElementTransitionItem* item in _items) {
        ...
        if (hidden && (_animation == ABI35_0_0RNSharedElementAnimationFadeIn) && [item.name isEqualToString:@"startNode"]) hidden = NO;
        if (hidden && (_animation == ABI35_0_0RNSharedElementAnimationFadeOut) && [item.name isEqualToString:@"endNode"]) hidden = NO;
        item.hidden = hidden;
    }
}
...
- (void) didLoadContent:(id)content contentType:(ABI35_0_0RNSharedElementContentType)contentType node:(ABI35_0_0RNSharedElementNode*)node
{
    // NSLog(@"didLoadContent: %@", content);
    ABI35_0_0RNSharedElementTransitionItem* item = [self findItemForNode:node];
    if (item == nil) return;
    item.content = content;
    item.contentType = contentType;
    if ((contentType == ABI35_0_0RNSharedElementContentTypeSnapshotImage) || (contentType == ABI35_0_0RNSharedElementContentTypeRawImage)) {
        UIImage* image = content;
        if (_animation == ABI35_0_0RNSharedElementAnimationMove) {
...
- (void) didLoadStyle:(ABI35_0_0RNSharedElementStyle *)style node:(ABI35_0_0RNSharedElementNode*)node
{
...
- (CGRect)normalizeLayout:(CGRect)layout ancestor:(ABI35_0_0RNSharedElementTransitionItem*)ancestor
{
    ABI35_0_0RNSharedElementStyle* style = ancestor.style;
...
- (void) applyStyle:(ABI35_0_0RNSharedElementStyle*)style layer:(CALayer*)layer
{
...
- (void) fireMeasureEvent:(ABI35_0_0RNSharedElementTransitionItem*) item layout:(CGRect)layout visibleLayout:(CGRect)visibleLayout contentLayout:(CGRect)contentLayout
{
...
- (void) updateStyle
{
    ...
    // Local data
    ABI35_0_0RNSharedElementTransitionItem* startItem = [_items objectAtIndex:ITEM_START];
    ABI35_0_0RNSharedElementTransitionItem* startAncestor = [_items objectAtIndex:ITEM_START_ANCESTOR];
    ABI35_0_0RNSharedElementTransitionItem* endItem = [_items objectAtIndex:ITEM_END];
    ABI35_0_0RNSharedElementTransitionItem* endAncestor = [_items objectAtIndex:ITEM_END_ANCESTOR];
    
    // Get start layout
    ABI35_0_0RNSharedElementStyle* startStyle = startItem.style;
    ...
    // Get end layout
    ABI35_0_0RNSharedElementStyle* endStyle = endItem.style;
    ...
    ABI35_0_0RNSharedElementStyle* interpolatedStyle;
    ...
    if (startStyle && endStyle) {
        interpolatedStyle = [ABI35_0_0RNSharedElementStyle getInterpolatedStyle:startStyle style2:endStyle position:_nodePosition];
    ...
    [super ReactABI35_0_0SetFrame:parentBounds];
    ...
    _innerClipView.layer.masksToBounds = _resize != ABI35_0_0RNSharedElementResizeNone;
    
    // Update content
    UIView* contentView1 = (startItem.contentType == ABI35_0_0RNSharedElementContentTypeSnapshotView) ? startItem.content : _primaryImageView;
    ...
    if (_animation == ABI35_0_0RNSharedElementAnimationMove) {
        ...
        UIView* contentView2 = (endItem.contentType == ABI35_0_0RNSharedElementContentTypeSnapshotView) ? endItem.content : _secondaryImageView;
        ...
        CGRect startContentLayout2 = startStyle ? [ABI35_0_0RNSharedElementTransitionItem contentLayoutFor:endStyle ? endContentLayout : startContentLayout content:startItem.content contentType:startItem.contentType contentMode:startStyle.contentMode reverse:YES] : CGRectZero;
        CGRect endContentLayout1 = endStyle ? [ABI35_0_0RNSharedElementTransitionItem contentLayoutFor:startStyle ? startContentLayout : endContentLayout content:endItem.content contentType:endItem.contentType contentMode:endStyle.contentMode reverse:YES] : CGRectZero;
        ...
        // Calculate new size
        switch (_resize) {
            case ABI35_0_0RNSharedElementResizeAuto:
                // Nothing to do
                break;
            case ABI35_0_0RNSharedElementResizeStretch:
                // TODO
                break;
            case ABI35_0_0RNSharedElementResizeClip:
            case ABI35_0_0RNSharedElementResizeNone:
        ...
        switch (_align) {
            case ABI35_0_0RNSharedElementAlignLeftTop:
                ...
                break;
            case ABI35_0_0RNSharedElementAlignLeftCenter:
                startInterpolatedContentLayout.origin.x = 0;
                ...
                break;
            case ABI35_0_0RNSharedElementAlignLeftBottom:
                startInterpolatedContentLayout.origin.x = 0;
                ...
                break;
            case ABI35_0_0RNSharedElementAlignRightTop:
                ...
                endInterpolatedContentLayout.origin.y = 0;
                break;
            case ABI35_0_0RNSharedElementAlignRightCenter:
                startInterpolatedContentLayout.origin.x = interpolatedLayout.size.width - startInterpolatedContentLayout.size.width;
                startInterpolatedContentLayout.origin.y = (interpolatedLayout.size.height - startInterpolatedContentLayout.size.height) / 2;
                endInterpolatedContentLayout.origin.x = interpolatedLayout.size.width - endInterpolatedContentLayout.size.width;
                endInterpolatedContentLayout.origin.y = (interpolatedLayout.size.height - endInterpolatedContentLayout.size.height) / 2;
                break;
            case ABI35_0_0RNSharedElementAlignRightBottom:
                startInterpolatedContentLayout.origin.x = interpolatedLayout.size.width - startInterpolatedContentLayout.size.width;
                startInterpolatedContentLayout.origin.y = interpolatedLayout.size.height - startInterpolatedContentLayout.size.height;
                endInterpolatedContentLayout.origin.x = interpolatedLayout.size.width - endInterpolatedContentLayout.size.width;
                endInterpolatedContentLayout.origin.y = interpolatedLayout.size.height - endInterpolatedContentLayout.size.height;
                break;
            case ABI35_0_0RNSharedElementAlignCenterTop:
                ...
                endInterpolatedContentLayout.origin.y = 0;
                break;
            case ABI35_0_0RNSharedElementAlignAuto:
            case ABI35_0_0RNSharedElementAlignCenterCenter:
                startInterpolatedContentLayout.origin.x = (interpolatedLayout.size.width - startInterpolatedContentLayout.size.width) / 2;
                startInterpolatedContentLayout.origin.y = (interpolatedLayout.size.height - startInterpolatedContentLayout.size.height) / 2;
                endInterpolatedContentLayout.origin.x = (interpolatedLayout.size.width - endInterpolatedContentLayout.size.width) / 2;
                endInterpolatedContentLayout.origin.y = (interpolatedLayout.size.height - endInterpolatedContentLayout.size.height) / 2;
                break;
            case ABI35_0_0RNSharedElementAlignCenterBottom:
                startInterpolatedContentLayout.origin.x = (interpolatedLayout.size.width - startInterpolatedContentLayout.size.width) / 2;
                startInterpolatedContentLayout.origin.y = interpolatedLayout.size.height - startInterpolatedContentLayout.size.height;
                endInterpolatedContentLayout.origin.x = (interpolatedLayout.size.width - endInterpolatedContentLayout.size.width) / 2;
                endInterpolatedContentLayout.origin.y = interpolatedLayout.size.height - endInterpolatedContentLayout.size.height;
        ...
        // Fade
        if (_animation == ABI35_0_0RNSharedElementAnimationFadeIn) {
            // Fade-in
            contentView1.layer.opacity = 0.0f;
            contentView2.layer.opacity = MIN(MAX(_nodePosition, 0.0f), 1.0f);
        }
        else if (_animation == ABI35_0_0RNSharedElementAnimationFadeOut) {
            // Fade-out
...
{
    // Only after the frame bounds have been set by the ABI35_0_0RN layout-system
    // we schedule a layout-fetch to run after these updates to ensure
    // that Yoga/UIManager has finished the initial layout pass.
    if (_ReactABI35_0_0FrameSet == NO) {
        //NSLog(@"ReactABI35_0_0SetFrame: %@", NSStringFromCGRect(frame));
        _ReactABI35_0_0FrameSet = YES;
    ...
    // When ReactABI35_0_0 attempts to change the frame on this view,
