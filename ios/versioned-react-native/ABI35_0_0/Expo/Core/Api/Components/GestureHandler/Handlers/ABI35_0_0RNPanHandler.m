...
#import "ABI35_0_0RNPanHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

@interface ABI35_0_0RNBetterPanGestureRecognizer : UIPanGestureRecognizer
...
@implementation ABI35_0_0RNBetterPanGestureRecognizer {
...
@implementation ABI35_0_0RNPanGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI35_0_0RNBetterPanGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI35_0_0RNBetterPanGestureRecognizer *recognizer = (ABI35_0_0RNBetterPanGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    CGFloat velocity = [ABI35_0_0RCTConvert CGFloat:prop];
    recognizer.minVelocitySq = velocity * velocity;
  }
  [recognizer updateHasCustomActivationCriteria];
}

- (ABI35_0_0RNGestureHandlerEventExtraData *)eventExtraData:(UIPanGestureRecognizer *)recognizer
{
