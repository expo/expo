...
@interface ABI35_0_0RNGestureHandlerManager : NSObject

- (nonnull instancetype)initWithUIManager:(nonnull ABI35_0_0RCTUIManager *)uiManager
                          eventDispatcher:(nonnull ABI35_0_0RCTEventDispatcher *)eventDispatcher;
