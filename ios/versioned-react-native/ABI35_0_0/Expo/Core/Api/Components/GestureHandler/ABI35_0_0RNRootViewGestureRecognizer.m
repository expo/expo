//
//  ABI35_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI35_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI35_0_0RNGestureHandler *otherHandler = [ABI35_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI35_0_0RCTTouchHandler class]];
}
