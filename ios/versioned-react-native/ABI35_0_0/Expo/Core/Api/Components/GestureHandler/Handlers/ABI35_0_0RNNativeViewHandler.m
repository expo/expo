//
//  ABI35_0_0RNNativeViewHandler.m
...
#import "ABI35_0_0RNNativeViewHandler.h"
...
#pragma mark ABI35_0_0RNDummyGestureRecognizer

@implementation ABI35_0_0RNDummyGestureRecognizer
...
#pragma mark ABI35_0_0RNNativeViewgestureHandler

@implementation ABI35_0_0RNNativeViewGestureHandler {
...
- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI35_0_0RNDummyGestureRecognizer alloc] init];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    _shouldActivateOnStart = [ABI35_0_0RCTConvert BOOL:config[@"shouldActivateOnStart"]];
    _disallowInterruption = [ABI35_0_0RCTConvert BOOL:config[@"disallowInterruption"]];
}
...
- (void)bindToView:(UIView *)view
{
    ...
    if ([view isKindOfClass:[ABI35_0_0RCTScrollView class]]) {
        // This part of the code is coupled with ABI35_0_0RN implementation of ScrollView native wrapper and
        // we expect for ABI35_0_0RCTScrollView component to contain a subclass of UIScrollview as the only
        // subview
...
- (void)handleTouchDown:(UIView *)sender forEvent:(UIEvent *)event
{
    ...
    [self sendEventsInState:ABI35_0_0RNGestureHandlerStateActive
             forViewWithTag:sender.ReactABI35_0_0Tag
              withExtraData:[ABI35_0_0RNGestureHandlerEventExtraData forPointerInside:YES]];
}

- (void)handleTouchUpOutside:(UIView *)sender forEvent:(UIEvent *)event
{
    [self sendEventsInState:ABI35_0_0RNGestureHandlerStateEnd
             forViewWithTag:sender.ReactABI35_0_0Tag
              withExtraData:[ABI35_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
...
{
    [self sendEventsInState:ABI35_0_0RNGestureHandlerStateCancelled
             forViewWithTag:sender.ReactABI35_0_0Tag
              withExtraData:[ABI35_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
