#import "ABI35_0_0RNForceTouchHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ReactABI35_0_0/ABI35_0_0RCTConvert.h>

@interface ABI35_0_0RNForceTouchGestureRecognizer : UIGestureRecognizer
...
- (id)initWithGestureHandler:(ABI35_0_0RNGestureHandler*)gestureHandler;

@end

@implementation ABI35_0_0RNForceTouchGestureRecognizer {
  __weak ABI35_0_0RNGestureHandler *_gestureHandler;
  UITouch *_firstTouch;
}
...
@implementation ABI35_0_0RNForceTouchHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI35_0_0RNForceTouchGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI35_0_0RNForceTouchGestureRecognizer *recognizer = (ABI35_0_0RNForceTouchGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    recognizer.feedbackOnActivation = [ABI35_0_0RCTConvert BOOL:prop];
  }
}

- (ABI35_0_0RNGestureHandlerEventExtraData *)eventExtraData:(ABI35_0_0RNForceTouchGestureRecognizer *)recognizer
{
