...
static NSString *const ABI35_0_0RNCConnectionTypeUnknown = @"unknown";
static NSString *const ABI35_0_0RNCConnectionTypeNone = @"none";
static NSString *const ABI35_0_0RNCConnectionTypeWifi = @"wifi";
static NSString *const ABI35_0_0RNCConnectionTypeCellular = @"cellular";

// Based on the EffectiveConnectionType enum described in the W3C Network Information API spec
// (https://wicg.github.io/netinfo/).
static NSString *const ABI35_0_0RNCCellularGeneration2g = @"2g";
static NSString *const ABI35_0_0RNCCellularGeneration3g = @"3g";
static NSString *const ABI35_0_0RNCCellularGeneration4g = @"4g";

@implementation ABI35_0_0RNCNetInfo
{
  ...
  BOOL _isObserving;
  NSMutableSet<ABI35_0_0RCTPromiseResolveBlock> *_firstTimeReachabilityResolvers;
}

ABI35_0_0RCT_EXPORT_MODULE()

static void ABI35_0_0RNCReachabilityCallback(__unused SCNetworkReachabilityRef target, SCNetworkReachabilityFlags flags, void *info)
{
  ABI35_0_0RNCNetInfo *self = (__bridge id)info;
  BOOL didSetReachabilityFlags = [self setReachabilityStatus:flags];

  if (self->_firstTimeReachability) {
    [self->_firstTimeReachabilityResolvers enumerateObjectsUsingBlock:^(ABI35_0_0RCTPromiseResolveBlock resolver, BOOL *stop) {
...
// We need ABI35_0_0RNCReachabilityCallback's and module methods to be called on the same thread so that we can have
...
{
  _isObserving = YES;
  _connectionType = ABI35_0_0RNCConnectionTypeUnknown;
...
- (SCNetworkReachabilityRef)getReachabilityRef
{
  ...
  SCNetworkReachabilitySetCallback(reachability, ABI35_0_0RNCReachabilityCallback, &context);
...
{
  NSString *connectionType = ABI35_0_0RNCConnectionTypeUnknown;
  bool connectionExpensive = false;
  NSString *effectiveConnectionType = nil;
  if ((flags & kSCNetworkReachabilityFlagsReachable) == 0 ||
      (flags & kSCNetworkReachabilityFlagsConnectionRequired) != 0) {
    connectionType = ABI35_0_0RNCConnectionTypeNone;
  }
  
#if !TARGET_OS_TV
  
  else if ((flags & kSCNetworkReachabilityFlagsIsWWAN) != 0) {
    connectionType = ABI35_0_0RNCConnectionTypeCellular;
    ...
    if (netinfo) {
      if ([netinfo.currentRadioAccessTechnology isEqualToString:CTRadioAccessTechnologyGPRS] ||
        ...
        effectiveConnectionType = ABI35_0_0RNCCellularGeneration2g;
        ...
        effectiveConnectionType = ABI35_0_0RNCCellularGeneration3g;
      } else if ([netinfo.currentRadioAccessTechnology isEqualToString:CTRadioAccessTechnologyLTE]) {
        effectiveConnectionType = ABI35_0_0RNCCellularGeneration4g;
      }
    }
  }
    ...
    connectionType = ABI35_0_0RNCConnectionTypeWifi;
  }
...
- (id)currentState
{
  NSString *connectionType = self->_connectionType ?: ABI35_0_0RNCConnectionTypeUnknown;
  NSString *effectiveConnectionType = self->_effectiveConnectionType;
  
  BOOL isConnected = ![connectionType isEqualToString:ABI35_0_0RNCConnectionTypeNone] && ![connectionType isEqualToString:ABI35_0_0RNCConnectionTypeUnknown];
  ...
  if (isConnected) {
    ...
    if ([connectionType isEqualToString:ABI35_0_0RNCConnectionTypeCellular]) {
...
ABI35_0_0RCT_EXPORT_METHOD(getCurrentState:(ABI35_0_0RCTPromiseResolveBlock)resolve
