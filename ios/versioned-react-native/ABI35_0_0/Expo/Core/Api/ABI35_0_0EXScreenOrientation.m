...
#import "ABI35_0_0EXScreenOrientation.h"
#import "ABI35_0_0EXScopedModuleRegistry.h"

#import <UIKit/UIKit.h>
#import <sys/utsname.h>

@interface ABI35_0_0EXScreenOrientation ()

@property (nonatomic, weak) id<ABI35_0_0EXScreenOrientationScopedModuleDelegate> kernelOrientationServiceDelegate;

@end

static int INVALID_MASK = 0;

@implementation ABI35_0_0RCTConvert (OrientationLock)
ABI35_0_0RCT_ENUM_CONVERTER(ABI35_0_0EXOrientationLock, [ABI35_0_0EXScreenOrientation getStringToOrientationLockJSDict],
                   ABI35_0_0EXOrientationDefaultLock, integerValue)
@end


@implementation ABI35_0_0EXScreenOrientation {
  bool hasListeners;
}

ABI35_0_0EX_EXPORT_SCOPED_MODULE(ExpoScreenOrientation, ScreenOrientationManager);
...
ABI35_0_0RCT_EXPORT_METHOD(lockAsync:(ABI35_0_0EXOrientationLock)orientationLock
...
ABI35_0_0RCT_EXPORT_METHOD(lockPlatformAsync:(NSArray <NSString *> *)allowedOrientations
                  resolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI35_0_0RCTPromiseRejectBlock)reject)
{
...
ABI35_0_0RCT_REMAP_METHOD(unlockAsync,
                 unlockAsyncWithResolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI35_0_0RCTPromiseRejectBlock)reject)
{
  [self lockAsync:ABI35_0_0EXOrientationDefaultLock resolver:resolve rejecter:reject];
}

ABI35_0_0RCT_REMAP_METHOD(getOrientationLockAsync,
                 getOrientationLockAsyncWithResolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI35_0_0RCTPromiseRejectBlock)reject)
{
  UIInterfaceOrientationMask orientationMask = [_kernelOrientationServiceDelegate supportedInterfaceOrientationsForVisibleApp];
  ABI35_0_0EXOrientationLock orientationLock = [self orientationLockNativeToJS:orientationMask];
  resolve([self orientationLockToString:orientationLock]);
}

ABI35_0_0RCT_REMAP_METHOD(getPlatformOrientationLockAsync,
                 getPlatformOrientationLockAsyncResolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI35_0_0RCTPromiseRejectBlock)reject)
{
  UIInterfaceOrientationMask orientationMask = [_kernelOrientationServiceDelegate supportedInterfaceOrientationsForVisibleApp];
  ...
  for (NSNumber *wrappedSingleOrientation in singleOrientations) {
    ...
    if (supportedOrientation == singleOrientationMask){
      ABI35_0_0EXOrientation orientation = [self orientationNativeToJS: (UIInterfaceOrientationMask) singleOrientationMask];
...
ABI35_0_0RCT_EXPORT_METHOD(doesSupportAsync:(ABI35_0_0EXOrientationLock)orientationLock
                  resolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI35_0_0RCTPromiseRejectBlock)reject)
{
...
ABI35_0_0RCT_EXPORT_METHOD(supportsOrientationLockAsync:(ABI35_0_0EXOrientationLock)orientationLock
                  resolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI35_0_0RCTPromiseRejectBlock)reject)
{
  UIInterfaceOrientationMask orientationMask = [self orientationLockJSToNative:orientationLock];
...
ABI35_0_0RCT_REMAP_METHOD(getOrientationAsync,
                 getOrientationAsyncResolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI35_0_0RCTPromiseRejectBlock)reject)
{
...
+ (NSDictionary *)getStringToOrientationJSDict
{
  ...
  dispatch_once(&onceToken, ^{
    strToOrientationDict = @{@"PORTRAIT" : @(ABI35_0_0EXOrientationPortrait),
                             @"PORTRAIT_UP" : @(ABI35_0_0EXOrientationPortraitUp),
                             @"PORTRAIT_DOWN" : @(ABI35_0_0EXOrientationPortraitDown),
                             @"LANDSCAPE" : @(ABI35_0_0EXOrientationLandscape),
                             @"LANDSCAPE_LEFT" : @(ABI35_0_0EXOrientationLandscapeLeft),
                             @"LANDSCAPE_RIGHT" : @(ABI35_0_0EXOrientationLandscapeRight),
                             @"UNKNOWN": @(ABI35_0_0EXOrientationUnknown)
                             };
  });
...
+ (NSDictionary *)getOrientationJSToStringDict
{
  ...
  dispatch_once(&onceToken, ^{
    ...
    NSDictionary *strToOrientation = [ABI35_0_0EXScreenOrientation getStringToOrientationJSDict];
...
+ (NSDictionary *)getStringToOrientationLockJSDict
{
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    strToOrientationLockDict = @{ @"DEFAULT" : @(ABI35_0_0EXOrientationDefaultLock),
                                  @"ALL" : @(ABI35_0_0EXOrientationAllLock),
                                  @"PORTRAIT" : @(ABI35_0_0EXOrientationPortraitLock),
                                  @"PORTRAIT_UP" : @(ABI35_0_0EXOrientationPortraitUpLock),
                                  @"PORTRAIT_DOWN" : @(ABI35_0_0EXOrientationPortraitDownLock),
                                  @"LANDSCAPE" : @(ABI35_0_0EXOrientationLandscapeLock),
                                  @"LANDSCAPE_LEFT" : @(ABI35_0_0EXOrientationLandscapeLeftLock),
                                  @"LANDSCAPE_RIGHT" : @(ABI35_0_0EXOrientationLandscapeRightLock),
                                  @"OTHER" : @(ABI35_0_0EXOrientationOtherLock),
                                  @"ALL_BUT_UPSIDE_DOWN": @(ABI35_0_0EXOrientationAllButUpsideDownLock)
                                  };
  });
...
+ (NSDictionary *)getOrientationLockJSToStringDict
{
  ...
  dispatch_once(&onceToken, ^{
    ...
    NSDictionary *strToOrientationLock = [ABI35_0_0EXScreenOrientation getStringToOrientationLockJSDict];
...
{
  ABI35_0_0EXOrientation orientation = [self traitCollectionToOrientation:traitCollection];
  return @{
...
- (ABI35_0_0EXOrientation)traitCollectionToOrientation:(UITraitCollection *)traitCollection
{
  ...
  if (verticalSizeClass == UIUserInterfaceSizeClassRegular && horizontalSizeClass == UIUserInterfaceSizeClassCompact){
    return ABI35_0_0EXOrientationPortrait;
  } else if (verticalSizeClass == UIUserInterfaceSizeClassCompact && horizontalSizeClass == UIUserInterfaceSizeClassCompact){
    return ABI35_0_0EXOrientationLandscape;
  } else if (verticalSizeClass == UIUserInterfaceSizeClassCompact && horizontalSizeClass == UIUserInterfaceSizeClassRegular) {
    return ABI35_0_0EXOrientationLandscape; // iPhone 7 plus
  } else {
    return ABI35_0_0EXOrientationUnknown;
  }
}

- (ABI35_0_0EXOrientation)orientationNativeToJS:(UIInterfaceOrientationMask)orientationMask
{
  if (orientationMask == (UIInterfaceOrientationMaskPortrait | UIInterfaceOrientationMaskPortraitUpsideDown)) {
    ...
    return ABI35_0_0EXOrientationPortraitUp;
  } else if (orientationMask == UIInterfaceOrientationMaskPortraitUpsideDown) {
    return ABI35_0_0EXOrientationPortraitDown;
    ...
    return ABI35_0_0EXOrientationLandscapeLeft;
  } else if (orientationMask == UIInterfaceOrientationMaskLandscapeRight) {
    return ABI35_0_0EXOrientationLandscapeRight;
  } else {
    return ABI35_0_0EXOrientationUnknown;
  }
}

- (ABI35_0_0EXOrientationLock)orientationLockNativeToJS:(UIInterfaceOrientationMask)orientationMask
{
  if (orientationMask == UIInterfaceOrientationMaskAllButUpsideDown){
    return ABI35_0_0EXOrientationDefaultLock;
  } else if (orientationMask == UIInterfaceOrientationMaskAll) {
    return ABI35_0_0EXOrientationAllLock;
  } else if (orientationMask == (UIInterfaceOrientationMaskPortrait | UIInterfaceOrientationMaskPortraitUpsideDown)) {
    return ABI35_0_0EXOrientationPortraitLock;
  } else if (orientationMask == UIInterfaceOrientationMaskPortrait) {
    return ABI35_0_0EXOrientationPortraitUpLock;
  } else if (orientationMask == UIInterfaceOrientationMaskPortraitUpsideDown) {
    return ABI35_0_0EXOrientationPortraitDownLock;
  } else if (orientationMask == UIInterfaceOrientationMaskLandscape) {
    return ABI35_0_0EXOrientationLandscapeLock;
  } else if (orientationMask == UIInterfaceOrientationMaskLandscapeLeft) {
    return ABI35_0_0EXOrientationLandscapeLeftLock;
  } else if (orientationMask == UIInterfaceOrientationMaskLandscapeRight) {
    return ABI35_0_0EXOrientationLandscapeRightLock;
  } else {
    return ABI35_0_0EXOrientationOtherLock;
  }
}

- (UIInterfaceOrientationMask)orientationJSToNative:(ABI35_0_0EXOrientation)orientation
{
  if (orientation == ABI35_0_0EXOrientationPortrait) {
    return UIInterfaceOrientationMaskPortrait | UIInterfaceOrientationMaskPortraitUpsideDown;
  } else if (orientation == ABI35_0_0EXOrientationPortraitUp) {
    return UIInterfaceOrientationMaskPortrait;
  } else if (orientation == ABI35_0_0EXOrientationPortraitDown) {
    return UIInterfaceOrientationMaskPortraitUpsideDown;
  } else if (orientation == ABI35_0_0EXOrientationLandscape) {
    return UIInterfaceOrientationMaskLandscape;
  } else if (orientation == ABI35_0_0EXOrientationLandscapeLeft) {
    return UIInterfaceOrientationMaskLandscapeLeft;
  } else if (orientation == ABI35_0_0EXOrientationLandscapeRight) {
...
- (UIInterfaceOrientationMask)orientationLockJSToNative:(ABI35_0_0EXOrientationLock)orientationLock
{
  if (orientationLock == ABI35_0_0EXOrientationDefaultLock) {
    return UIInterfaceOrientationMaskAllButUpsideDown;
  } else if (orientationLock == ABI35_0_0EXOrientationAllLock) {
    return UIInterfaceOrientationMaskAll;
  } else if (orientationLock == ABI35_0_0EXOrientationPortraitLock) {
    return UIInterfaceOrientationMaskPortrait | UIInterfaceOrientationMaskPortraitUpsideDown;
  } else if (orientationLock == ABI35_0_0EXOrientationPortraitUpLock) {
    return UIInterfaceOrientationMaskPortrait;
  } else if (orientationLock == ABI35_0_0EXOrientationPortraitDownLock) {
    return UIInterfaceOrientationMaskPortraitUpsideDown;
  } else if (orientationLock == ABI35_0_0EXOrientationLandscapeLock) {
    return UIInterfaceOrientationMaskLandscape;
  } else if (orientationLock == ABI35_0_0EXOrientationLandscapeLeftLock) {
    return UIInterfaceOrientationMaskLandscapeLeft;
  } else if (orientationLock == ABI35_0_0EXOrientationLandscapeRightLock) {
    return UIInterfaceOrientationMaskLandscapeRight;
  } else if (orientationLock == ABI35_0_0EXOrientationAllButUpsideDownLock) { // legacy
    return UIInterfaceOrientationMaskAllButUpsideDown;
  }else {
    return INVALID_MASK;
  }
...
- (ABI35_0_0EXOrientation)stringToOrientation:(NSString *)orientationString
{
  return [[[ABI35_0_0EXScreenOrientation getStringToOrientationJSDict] objectForKey:orientationString] intValue];
}

- (NSString *)orientationToString:(ABI35_0_0EXOrientation)orientation
{
  return [[ABI35_0_0EXScreenOrientation getOrientationJSToStringDict] objectForKey:@(orientation)];
}


- (ABI35_0_0EXOrientationLock)stringToOrientationLock:(NSString *)orientationLockString
{
  return [[[ABI35_0_0EXScreenOrientation getStringToOrientationLockJSDict] objectForKey:orientationLockString] intValue];
}

- (NSString *)orientationLockToString:(ABI35_0_0EXOrientationLock)orientationLock
{
  return [[ABI35_0_0EXScreenOrientation getOrientationLockJSToStringDict] objectForKey:@(orientationLock)];
}
