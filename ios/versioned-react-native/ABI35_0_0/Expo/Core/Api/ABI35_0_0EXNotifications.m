...
#import "ABI35_0_0EXNotifications.h"
...
@interface ABI35_0_0EXNotifications ()

// unversioned ABI35_0_0EXRemoteNotificationManager instance
@property (nonatomic, weak) id <ABI35_0_0EXNotificationsScopedModuleDelegate> remoteNotificationsDelegate;
@property (nonatomic, weak) id <ABI35_0_0EXNotificationsIdentifiersManager> notificationsIdentifiersManager;
@property (nonatomic, weak) id <ABI35_0_0EXUserNotificationCenterService> userNotificationCenter;

@end

@implementation ABI35_0_0EXNotifications

ABI35_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentNotifications, @"RemoteNotificationManager", @"UserNotificationManager", @"UserNotificationCenter");
...
ABI35_0_0RCT_REMAP_METHOD(getDevicePushTokenAsync,
...
{
  ABI35_0_0EXConstantsBinding *constants = [_bridge.scopedModules.moduleRegistry getModuleImplementingProtocol:@protocol(ABI35_0_0UMConstantsInterface)];
...
ABI35_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
                 getExponentPushTokenAsyncWithResolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI35_0_0RCTPromiseRejectBlock)reject)
{
...
ABI35_0_0RCT_EXPORT_METHOD(presentLocalNotification:(NSDictionary *)payload
                  resolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI35_0_0RCTPromiseRejectBlock)reject)
{
  ...
  ABI35_0_0RCT_EXPORT_METHOD(scheduleNotificationWithTimer:(NSDictionary *)payload
...
ABI35_0_0RCT_EXPORT_METHOD(scheduleNotificationWithCalendar:(NSDictionary *)payload
                 withOptions:(NSDictionary *)options
                 resolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI35_0_0RCTPromiseRejectBlock)reject)
{
...
ABI35_0_0RCT_EXPORT_METHOD(scheduleLocalNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI35_0_0RCTPromiseRejectBlock)reject)
{
...
ABI35_0_0RCT_EXPORT_METHOD(legacyScheduleLocalRepeatingNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI35_0_0RCTPromiseRejectBlock)reject)
{
  ...
  localNotification.applicationIconBadgeNumber = [ABI35_0_0RCTConvert NSInteger:payload[@"count"]] ?: 0;
  localNotification.userInfo = @{
                                 @"body": payload[@"data"],
                                 @"experienceId": self.experienceId,
                                 @"id": uniqueId
                                 };
  localNotification.fireDate = [ABI35_0_0RCTConvert NSDate:options[@"time"]] ?: [NSDate new];
  localNotification.repeatInterval = [ABI35_0_0RCTConvert NSCalendarUnit:options[@"repeat"]] ?: 0;

  __weak typeof(self) weakSelf = self;
  [ABI35_0_0EXUtil performSynchronouslyOnMainThread:^{
    [ABI35_0_0RCTSharedApplication() scheduleLocalNotification:localNotification];
...
ABI35_0_0RCT_REMAP_METHOD(cancelScheduledNotificationAsync,
                 cancelScheduledNotificationAsync:(NSString *)uniqueId
                 withResolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI35_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI35_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
...
ABI35_0_0RCT_REMAP_METHOD(cancelAllScheduledNotificationsAsync,
                 cancelAllScheduledNotificationsAsyncWithResolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(__unused ABI35_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI35_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
  [_userNotificationCenter getPendingNotificationRequestsWithCompletionHandler:^(NSArray<UNNotificationRequest *> * _Nonnull requests) {
...
ABI35_0_0RCT_REMAP_METHOD(getBadgeNumberAsync,
                 getBadgeNumberAsyncWithResolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI35_0_0RCTPromiseRejectBlock)reject)
{
  __block NSInteger badgeNumber;
  [ABI35_0_0EXUtil performSynchronouslyOnMainThread:^{
    badgeNumber = ABI35_0_0RCTSharedApplication().applicationIconBadgeNumber;
  }];
  resolve(@(badgeNumber));
}

ABI35_0_0RCT_EXPORT_METHOD(setBadgeNumberAsync:(nonnull NSNumber *)number
                  resolver:(ABI35_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI35_0_0RCTPromiseRejectBlock)reject)
{
  [ABI35_0_0EXUtil performSynchronouslyOnMainThread:^{
    ABI35_0_0RCTSharedApplication().applicationIconBadgeNumber = number.integerValue;
  }];
  resolve(nil);
}
...
ABI35_0_0RCT_REMAP_METHOD(createCategoryAsync,
...
ABI35_0_0RCT_REMAP_METHOD(deleteCategoryAsync,
...
- (NSDateComponents *)dateComponentsFrom:(NSNumber * _Nullable)unixTime {
  ...
  NSDate *triggerDate = [ABI35_0_0RCTConvert NSDate:unixTime] ?: [NSDate new];
