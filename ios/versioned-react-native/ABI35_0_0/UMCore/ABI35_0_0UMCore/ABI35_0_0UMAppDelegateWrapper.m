...
@implementation ABI35_0_0UMAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitialized {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI35_0_0UMSingletonModule*> * singletonModules = [[ABI35_0_0UMModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI35_0_0UMSingletonModule *singletonModule in singletonModules) {
