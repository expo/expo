...
@implementation ABI35_0_0EXAppleAuthenticationMappings
...
{
  return @{
           @"namePrefix": ABI35_0_0UMNullIfNil(nameComponents.namePrefix),
           @"givenName": ABI35_0_0UMNullIfNil(nameComponents.givenName),
           @"middleName": ABI35_0_0UMNullIfNil(nameComponents.middleName),
           @"familyName": ABI35_0_0UMNullIfNil(nameComponents.familyName),
           @"nameSuffix": ABI35_0_0UMNullIfNil(nameComponents.nameSuffix),
           @"nickname": ABI35_0_0UMNullIfNil(nameComponents.nickname)
           };
}
