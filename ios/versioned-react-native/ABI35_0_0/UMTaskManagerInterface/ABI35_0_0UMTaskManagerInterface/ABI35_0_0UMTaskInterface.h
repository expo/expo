...
@protocol ABI35_0_0UMTaskConsumerInterface;

@protocol ABI35_0_0UMTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI35_0_0UMTaskConsumerInterface> __nonnull consumer;
