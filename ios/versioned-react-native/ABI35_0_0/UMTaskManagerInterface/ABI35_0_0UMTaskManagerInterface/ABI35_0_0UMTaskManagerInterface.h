...
// Interface for ABI35_0_0UMTaskManager module.

@protocol ABI35_0_0UMTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI35_0_0UMTaskConsumerInterface protocol.
 */
