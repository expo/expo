...
#import <ABI35_0_0EXSQLite/ABI35_0_0EXSQLite.h>

#import <ABI35_0_0UMFileSystemInterface/ABI35_0_0UMFileSystemInterface.h>

#import <sqlite3.h>

@interface ABI35_0_0EXSQLite ()
...
@implementation ABI35_0_0EXSQLite
...
ABI35_0_0UM_EXPORT_MODULE(ExponentSQLite);
...
- (NSString *)pathForDatabaseName:(NSString *)name
{
  ...
  if (!fileSystem) {
    ABI35_0_0UMLogError(@"No FileSystem module.");
    return nil;
  }
...
ABI35_0_0UM_EXPORT_METHOD_AS(exec,
...
ABI35_0_0UM_EXPORT_METHOD_AS(close,
                 ...
                 withDb:(sqlite3*)db withReadOnly:(BOOL)readOnly
{
  ...
  if (sqlite3_prepare_v2(db, [sql UTF8String], -1, &statement, NULL) != SQLITE_OK) {
    error = [ABI35_0_0EXSQLite convertSQLiteErrorToString:db];
    return @[error];
  }
