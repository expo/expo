...
@implementation ABI35_0_0EXAdsDFPBannerView {
  DFPBannerView *_bannerView;
  id<ABI35_0_0UMEventEmitterService> _eventEmitter;
}
...
- (void)setOnSizeChange:(ABI35_0_0UMDirectEventBlock)block
{
  _onSizeChange = block;
  [self loadBanner];
}

- (void)setOnDidFailToReceiveAdWithError:(ABI35_0_0UMDirectEventBlock)block
{
