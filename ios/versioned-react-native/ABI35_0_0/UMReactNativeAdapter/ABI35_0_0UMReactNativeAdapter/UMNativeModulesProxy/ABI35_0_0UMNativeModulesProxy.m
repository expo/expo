...
@interface ABI35_0_0UMNativeModulesProxy ()

@property (nonatomic, strong) NSRegularExpression *regexp;
@property (nonatomic, strong) ABI35_0_0UMModuleRegistry *moduleRegistry;
...
@implementation ABI35_0_0UMNativeModulesProxy
...
# pragma mark - ReactABI35_0_0 API
...
- (NSDictionary *)constantsToExport
{
  ...
  NSArray<ABI35_0_0UMViewManager *> *viewManagers = [_moduleRegistry getAllViewManagers];
  NSMutableArray<NSString *> *viewManagersNames = [NSMutableArray arrayWithCapacity:[viewManagers count]];
  for (ABI35_0_0UMViewManager *viewManager in viewManagers) {
...
ABI35_0_0RCT_EXPORT_METHOD(callMethod:(NSString *)moduleName methodNameOrKey:(id)methodNameOrKey arguments:(NSArray *)arguments resolver:(ABI35_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI35_0_0RCTPromiseRejectBlock)reject)
{
