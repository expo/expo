...
@interface ABI35_0_0UMViewManagerAdapter ()

@property ABI35_0_0UMViewManager *viewManager;

@end

@implementation ABI35_0_0UMViewManagerAdapter
...
// in runtime by ABI35_0_0UMNativeModulesProxy for each exported view manager.
// Each created class has different class name, conforming to convention.
// This way we can provide ReactABI35_0_0 Native with different ABI35_0_0RCTViewManagers
...
ABI35_0_0RCT_CUSTOM_VIEW_PROPERTY(proxiedProperties, NSDictionary, UIView)
{
  __weak ABI35_0_0UMViewManagerAdapter *weakSelf = self;
  [json enumerateKeysAndObjectsUsingBlock:^(id  _Nonnull key, id  _Nonnull obj, BOOL * _Nonnull stop) {
    __strong ABI35_0_0UMViewManagerAdapter *strongSelf = weakSelf;
