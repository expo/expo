...
#import "ABI35_0_0RCTImagePrimitivesConversions.h"

using namespace facebook::ReactABI35_0_0;

@implementation ABI35_0_0RCTImageManager {
  ABI35_0_0RCTImageLoader *_imageLoader;
}
...
- (ImageRequest)requestImage:(const ImageSource &)imageSource {
  ...
  ABI35_0_0RCTImageLoaderCancellationBlock cancelationBlock =
      [_imageLoader loadImageWithURLRequest:request
                                    ...
                                    clipped:YES
                                 resizeMode:ABI35_0_0RCTResizeModeStretch
