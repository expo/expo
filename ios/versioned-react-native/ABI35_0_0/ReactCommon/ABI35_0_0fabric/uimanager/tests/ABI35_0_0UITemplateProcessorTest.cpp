...
#include <ReactABI35_0_0/uimanager/ComponentDescriptorFactory.h>
#include <ReactABI35_0_0/uimanager/UITemplateProcessor.h>

using namespace facebook::ReactABI35_0_0;

#include <ReactABI35_0_0/components/activityindicator/ActivityIndicatorViewComponentDescriptor.h>
#include <ReactABI35_0_0/components/image/ImageComponentDescriptor.h>
#include <ReactABI35_0_0/components/scrollview/ScrollViewComponentDescriptor.h>
#include <ReactABI35_0_0/components/text/ParagraphComponentDescriptor.h>
#include <ReactABI35_0_0/components/text/RawTextComponentDescriptor.h>
#include <ReactABI35_0_0/components/text/TextComponentDescriptor.h>
#include <ReactABI35_0_0/components/view/ViewComponentDescriptor.h>
#include <ReactABI35_0_0/config/ReactABI35_0_0NativeConfig.h>
#include <ReactABI35_0_0/uimanager/ComponentDescriptorFactory.h>
#include <ReactABI35_0_0/uimanager/ComponentDescriptorRegistry.h>
#include <ReactABI35_0_0/uimanager/ContextContainer.h>
...
class MockReactABI35_0_0NativeConfig : public ReactABI35_0_0NativeConfig {
 public:
  MockReactABI35_0_0NativeConfig() {}
...
std::shared_ptr<const ReactABI35_0_0NativeConfig> mockReactABI35_0_0NativeConfig_ =
    std::make_shared<const MockReactABI35_0_0NativeConfig>();
...
TEST(UITemplateProcessorTest, testSimpleBytecode) {
  ...
  auto bytecode = R"delim({"version":0.1,"commands":[
    ["createNode",2,"ABI35_0_0RCTView",-1,{"opacity": 0.5, "testId": "root"}],
    ["createNode",4,"ABI35_0_0RCTView",2,{"testId": "child"}],
    ["returnRoot",2]
  ]})delim";
  ...
  auto root1 = UITemplateProcessor::buildShadowTree(
      ...
      *componentDescriptorRegistry,
      ...
      mockReactABI35_0_0NativeConfig_);
#ifndef NDEBUG
...
TEST(UITemplateProcessorTest, testConditionalBytecode) {
  ...
  auto bytecode = R"delim({"version":0.1,"commands":[
    ["createNode",2,"ABI35_0_0RCTView",-1,{"testId": "root"}],
    ["loadNativeBool",1,"MobileConfig","getBool",["qe:simple_test"]],
    ["conditional",1,
      [["createNode",4,"ABI35_0_0RCTView",2,{"testId": "cond_true"}]],
      [["createNode",4,"ABI35_0_0RCTView",2,{"testId": "cond_false"}]]
    ],
    ["returnRoot",2]
  ]})delim";
