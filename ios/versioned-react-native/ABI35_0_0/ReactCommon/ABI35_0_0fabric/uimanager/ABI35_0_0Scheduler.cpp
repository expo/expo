...
#include <ReactABI35_0_0/uimanager/UIManager.h>
...
Scheduler::Scheduler(
  ...
  ReactABI35_0_0NativeConfig_ =
      contextContainer->getInstance<std::shared_ptr<const ReactABI35_0_0NativeConfig>>(
...
void Scheduler::renderTemplateToSurface(
  ...
  try {
    ...
    LOG(ERROR) << "    >>>> ABI35_0_0EXCEPTION <<<  rendering uiTemplate in "
