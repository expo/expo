...
#include "ABI35_0_0UITemplateProcessor.h"
...
#include <ReactABI35_0_0/components/view/ViewShadowNode.h>
#include <ReactABI35_0_0/core/ComponentDescriptor.h>
#include <ReactABI35_0_0/core/LayoutContext.h>
#include <ReactABI35_0_0/core/ShadowNodeFragment.h>
...
SharedShadowNode UITemplateProcessor::runCommand(
  ...
  if (opcode == "createNode") {
    ...
    registers[registerNumber] = ReactABI35_0_0NativeConfig->getBool(param);
...
SharedShadowNode UITemplateProcessor::buildShadowTree(
  ...
  LOG(ERROR) << "ReactABI35_0_0 ui template missing returnRoot command :(";
