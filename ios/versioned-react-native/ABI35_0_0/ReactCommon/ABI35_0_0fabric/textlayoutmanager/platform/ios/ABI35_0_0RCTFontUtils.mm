...
#import "ABI35_0_0RCTFontUtils.h"

#import <cmath>
#import <mutex>

static ABI35_0_0RCTFontProperties ABI35_0_0RCTDefaultFontProperties() {
  static ABI35_0_0RCTFontProperties defaultFontProperties;
  ...
  dispatch_once(&onceToken, ^{
    ...
    defaultFontProperties.style = ABI35_0_0RCTFontStyleNormal;
    defaultFontProperties.variant = ABI35_0_0RCTFontVariantDefault;
...
static ABI35_0_0RCTFontProperties ABI35_0_0RCTResolveFontProperties(
    ABI35_0_0RCTFontProperties fontProperties) {
  ABI35_0_0RCTFontProperties defaultFontProperties = ABI35_0_0RCTDefaultFontProperties();
  ...
  fontProperties.style = fontProperties.style != ABI35_0_0RCTFontStyleUndefined
      ? fontProperties.style
      : defaultFontProperties.style;
  fontProperties.variant = fontProperties.variant != ABI35_0_0RCTFontVariantUndefined
      ? fontProperties.variant
      : defaultFontProperties.variant;
  return fontProperties;
}

static UIFontWeight ABI35_0_0RCTGetFontWeight(UIFont *font) {
  NSDictionary *traits =
      [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  return [traits[UIFontWeightTrait] doubleValue];
}

static ABI35_0_0RCTFontStyle ABI35_0_0RCTGetFontStyle(UIFont *font) {
  NSDictionary *traits =
      [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  ...
  if (symbolicTraits & UIFontDescriptorTraitItalic) {
    return ABI35_0_0RCTFontStyleItalic;
  }

  return ABI35_0_0RCTFontStyleNormal;
}

static NSArray *ABI35_0_0RCTFontFeatures(ABI35_0_0RCTFontVariant fontVariant) {
  // FIXME:
  return @[];
}

static UIFontWeight ABI35_0_0RCTUIFontWeightFromFloat(CGFloat fontWeight) {
...
static UIFont *ABI35_0_0RCTDefaultFontWithFontProperties(
    ABI35_0_0RCTFontProperties fontProperties) {
  ...
  if (!font) {
    font = [UIFont
        systemFontOfSize:fontProperties.size
                  weight:ABI35_0_0RCTUIFontWeightFromFloat(fontProperties.weight)];

    if (fontProperties.variant == ABI35_0_0RCTFontStyleItalic) {
...
UIFont *ABI35_0_0RCTFontWithFontProperties(ABI35_0_0RCTFontProperties fontProperties) {
  ABI35_0_0RCTFontProperties defaultFontProperties = ABI35_0_0RCTDefaultFontProperties();
  fontProperties = ABI35_0_0RCTResolveFontProperties(fontProperties);
  ...
  if ([fontProperties.family isEqualToString:defaultFontProperties.family]) {
    ...
    font = ABI35_0_0RCTDefaultFontWithFontProperties(fontProperties);
  } else {
    ...
    if (fontNames.count == 0) {
      ...
      for (NSString *name in fontNames) {
        ...
        if (ABI35_0_0RCTGetFontStyle(fontMatch) != fontProperties.style) {
          continue;
        }

        CGFloat testWeight = ABI35_0_0RCTGetFontWeight(fontMatch);
  ...
  if (fontProperties.variant != ABI35_0_0RCTFontVariantDefault) {
    NSArray *fontFeatures = ABI35_0_0RCTFontFeatures(fontProperties.variant);
