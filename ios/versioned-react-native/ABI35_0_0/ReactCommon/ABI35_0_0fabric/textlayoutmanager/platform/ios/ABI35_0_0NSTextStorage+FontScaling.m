...
- (void)abi35_0_0_rct_scaleFontSizeToFitSize:(CGSize)size
  ...
  while (true) {
    ...
    ABI35_0_0RCTTextSizeComparisonOptions comparsion = [self abi35_0_0_rct_compareToSize:size
                                                   thresholdRatio:0.01];

    if ((comparsion & ABI35_0_0RCTTextSizeComparisonWithinRange) &&
...
- (ABI35_0_0RCTTextSizeComparisonOptions)abi35_0_0_rct_compareToSize:(CGSize)size
  ...
  result |=
      (fitsSize) ? ABI35_0_0RCTTextSizeComparisonSmaller : ABI35_0_0RCTTextSizeComparisonLarger;
