...
#import "ABI35_0_0RCTTextLayoutManager.h"
...
@implementation ABI35_0_0RCTTextLayoutManager

static NSLineBreakMode ABI35_0_0RCTNSLineBreakModeFromWritingDirection(
...
- (facebook::ReactABI35_0_0::Size)
  ...
  NSTextStorage *textStorage =
      [self _textStorageAndLayoutManagerWithAttributesString:
                ABI35_0_0RCTNSAttributedStringFromAttributedString(attributedString)
  ...
  return facebook::ReactABI35_0_0::Size{size.width, size.height};
}
...
- (NSTextStorage *)
  ...
  textContainer.lineBreakMode = paragraphAttributes.maximumNumberOfLines > 0
      ? ABI35_0_0RCTNSLineBreakModeFromWritingDirection(
...
- (SharedEventEmitter)
  ...
  if (textStorage.length > 0 && (fraction > 0 || characterIndex > 0) &&
    ...
    ABI35_0_0RCTWeakEventEmitterWrapper *eventEmitterWrapper =
        (ABI35_0_0RCTWeakEventEmitterWrapper *)[textStorage
                 attribute:ABI35_0_0RCTAttributedStringEventEmitterKey
