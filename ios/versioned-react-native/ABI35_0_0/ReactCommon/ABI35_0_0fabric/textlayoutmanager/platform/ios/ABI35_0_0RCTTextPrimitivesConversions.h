...
inline static NSTextAlignment ABI35_0_0RCTNSTextAlignmentFromTextAlignment(
...
inline static NSWritingDirection ABI35_0_0RCTNSWritingDirectionFromWritingDirection(
...
inline static ABI35_0_0RCTFontStyle ABI35_0_0RCTFontStyleFromFontStyle(FontStyle fontStyle) {
  switch (fontStyle) {
    ...
    case FontStyle::Oblique:
      return ABI35_0_0RCTFontStyleOblique;
  }
}

inline static ABI35_0_0RCTFontVariant ABI35_0_0RCTFontVariantFromFontVariant(
    FontVariant fontVariant) {
  return (ABI35_0_0RCTFontVariant)fontVariant;
}

inline static NSUnderlineStyle ABI35_0_0RCTNSUnderlineStyleFromStyleAndPattern(
...
inline static UIColor *ABI35_0_0RCTUIColorFromSharedColor(const SharedColor &color) {
