...
Size TextLayoutManager::measure(
  ...
  static auto measure =
      jni::findClassStatic("com/facebook/ReactABI35_0_0/fabric/FabricUIManager")
          ->getMethod<jlong(
              jstring,
  ...
  local_ref<JString> componentName = make_jstring("ABI35_0_0RCTText");
  return ABI35_0_0yogaMeassureToSize(measure(
      fabricUIManager,
      componentName.get(),
