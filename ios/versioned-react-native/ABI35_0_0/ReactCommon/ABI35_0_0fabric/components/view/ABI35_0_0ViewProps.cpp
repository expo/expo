...
ViewProps::ViewProps(const ABI35_0_0YGStyle &ABI35_0_0yogaStyle) : YogaStylableProps(ABI35_0_0yogaStyle) {}
...
BorderMetrics ViewProps::resolveBorderMetrics(bool isRTL) const {
  auto borderWidths = CascadedBorderWidths{
      .left = optionalFloatFromYogaValue(ABI35_0_0yogaStyle.border[ABI35_0_0YGEdgeLeft]),
      .top = optionalFloatFromYogaValue(ABI35_0_0yogaStyle.border[ABI35_0_0YGEdgeTop]),
      .right = optionalFloatFromYogaValue(ABI35_0_0yogaStyle.border[ABI35_0_0YGEdgeRight]),
      .bottom = optionalFloatFromYogaValue(ABI35_0_0yogaStyle.border[ABI35_0_0YGEdgeBottom]),
      .start = optionalFloatFromYogaValue(ABI35_0_0yogaStyle.border[ABI35_0_0YGEdgeStart]),
      .end = optionalFloatFromYogaValue(ABI35_0_0yogaStyle.border[ABI35_0_0YGEdgeEnd]),
      .horizontal =
          optionalFloatFromYogaValue(ABI35_0_0yogaStyle.border[ABI35_0_0YGEdgeHorizontal]),
      .vertical = optionalFloatFromYogaValue(ABI35_0_0yogaStyle.border[ABI35_0_0YGEdgeVertical]),
      .all = optionalFloatFromYogaValue(ABI35_0_0yogaStyle.border[ABI35_0_0YGEdgeAll])};
