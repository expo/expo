...
#include <ReactABI35_0_0/components/view/AccessibleShadowNode.h>
...
class ConcreteViewShadowNode : public ConcreteShadowNode<
 ...
 public:
  ...
  void appendChild(const SharedShadowNode &child) {
    ...
    auto ABI35_0_0yogaLayoutableChild =
        dynamic_cast<YogaLayoutableShadowNode *>(nonConstChild);
    if (ABI35_0_0yogaLayoutableChild) {
      YogaLayoutableShadowNode::appendChild(ABI35_0_0yogaLayoutableChild);
    }
  }
