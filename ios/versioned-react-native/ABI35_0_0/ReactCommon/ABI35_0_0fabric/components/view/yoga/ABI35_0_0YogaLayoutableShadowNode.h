...
#pragma mark - LayoutableShadowNode
 ...
 protected:
   ...
   * all the time.
   */
  mutable ABI35_0_0YGNode ABI35_0_0yogaNode_;

  /*
   * Yoga config associated (only) with this particular node.
   */
  ABI35_0_0YGConfig ABI35_0_0yogaConfig_;

 private:
  static void initializeYogaConfig(ABI35_0_0YGConfig &config);
  static ABI35_0_0YGNode *ABI35_0_0yogaNodeCloneCallbackConnector(
      ABI35_0_0YGNode *oldYogaNode,
      ABI35_0_0YGNode *parentYogaNode,
      int childIndex);
  static ABI35_0_0YGSize ABI35_0_0yogaNodeMeasureCallbackConnector(
