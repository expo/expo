...
#include <ReactABI35_0_0/components/view/AccessibilityProps.h>
#include <ReactABI35_0_0/components/view/YogaStylableProps.h>
#include <ReactABI35_0_0/components/view/primitives.h>
...
class ViewProps : public Props,
 ...
 public:
  ViewProps() = default;
  ViewProps(const ABI35_0_0YGStyle &ABI35_0_0yogaStyle);
