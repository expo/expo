...
#include <ReactABI35_0_0/core/RawProps.h>
#include <ReactABI35_0_0/core/RawValue.h>
#include <memory>
#include <string>
...
/*
 * `Tag` and `InstanceHandle` are used to address ReactABI35_0_0 Native components.
 */
using Tag = int32_t;
