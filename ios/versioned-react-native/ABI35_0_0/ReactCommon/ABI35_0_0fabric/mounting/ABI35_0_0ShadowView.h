...
#include <ReactABI35_0_0/core/LayoutMetrics.h>
...
#include <ReactABI35_0_0/events/EventEmitter.h>
...
template <>
struct hash<facebook::ReactABI35_0_0::ShadowView> {
  size_t operator()(const facebook::ReactABI35_0_0::ShadowView &shadowView) const {
    auto seed = size_t{0};
