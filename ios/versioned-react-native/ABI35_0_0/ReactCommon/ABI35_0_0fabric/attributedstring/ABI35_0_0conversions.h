...
#include <ReactABI35_0_0/core/conversions.h>
...
inline folly::dynamic toDynamic(const AttributedString &attributedString) {
  ...
  for (auto fragment : attributedString.getFragments()) {
    ...
    if (fragment.parentShadowView.componentHandle) {
      dynamicFragment["ReactABI35_0_0Tag"] = fragment.parentShadowView.tag;
    }
  ...
  value(
      "hash", std::hash<facebook::ReactABI35_0_0::AttributedString>{}(attributedString));
