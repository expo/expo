...
#include <ReactABI35_0_0/graphics/ColorComponents.h>
...
namespace std {
template <>
struct hash<facebook::ReactABI35_0_0::SharedColor> {
  size_t operator()(const facebook::ReactABI35_0_0::SharedColor &sharedColor) const {
