...
#include <cxxReactABI35_0_0/ABI35_0_0JSDeltaBundleClient.h>
...
TEST(JSDeltaBundleClient, PatchStartupCode) {
  ...
  ABI35_0_0EXPECT_STREQ(client.getStartupCode()->c_str(), "pre\npost\n");
  ...
  ABI35_0_0EXPECT_STREQ(client.getStartupCode()->c_str(), "pre2\npost2\n");
}
...
TEST(JSDeltaBundleClient, PatchModule) {
  ...
  ABI35_0_0EXPECT_EQ(client.getModule(0).code, "0");
  ABI35_0_0EXPECT_EQ(client.getModule(1).code, "1");
  ...
  ABI35_0_0EXPECT_EQ(client.getModule(0).code, "0.1");
  ABI35_0_0EXPECT_EQ(client.getModule(2).code, "2");
  ...
  ABI35_0_0EXPECT_EQ(client.getModule(3).code, "3");
  ABI35_0_0EXPECT_EQ(client.getModule(4).code, "4");
}
...
TEST(JSDeltaBundleClient, Clear) {
  ...
  ABI35_0_0EXPECT_STREQ(client.getStartupCode()->c_str(), "");
}
