...
#include <cxxReactABI35_0_0/ABI35_0_0MethodCall.h>
...
TEST(parseMethodCalls, MapReturn) {
  ...
  ABI35_0_0EXPECT_EQ(folly::dynamic("hello"), foo);
  auto bar = returnedMap.at("bar");
  ABI35_0_0EXPECT_EQ(folly::dynamic(4.0), bar);
  auto baz = returnedMap.at("baz");
  ABI35_0_0EXPECT_EQ(folly::dynamic(true), baz);
}
