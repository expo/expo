...
#include "ABI35_0_0CxxNativeModule.h"
...
#include "ABI35_0_0JsArgumentHelpers.h"
...
void CxxNativeModule::invoke(unsigned int ReactABI35_0_0MethodId, folly::dynamic&& params, int callId) {
  if (ReactABI35_0_0MethodId >= methods_.size()) {
    throw std::invalid_argument(folly::to<std::string>("methodId ", ReactABI35_0_0MethodId,
  ...
  const auto& method = methods_[ReactABI35_0_0MethodId];
