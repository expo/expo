...
#include <cxxReactABI35_0_0/ABI35_0_0SystraceSection.h>
...
void JSIExecutor::loadApplicationScript(
  ...
  if (hasLogger) {
    ReactABI35_0_0Marker::logTaggedMarker(
        ReactABI35_0_0Marker::RUN_JS_BUNDLE_START, scriptName.c_str());
  }
  runtime_->evaluateJavaScript(
      std::make_unique<BigStringBuffer>(std::move(script)), sourceURL);
  flush();
  if (hasLogger) {
    ReactABI35_0_0Marker::logMarker(ReactABI35_0_0Marker::CREATE_REACT_CONTEXT_STOP);
    ReactABI35_0_0Marker::logTaggedMarker(
        ReactABI35_0_0Marker::RUN_JS_BUNDLE_STOP, scriptName.c_str());
  }
}
...
void JSIExecutor::registerBundle(
  ...
  ReactABI35_0_0Marker::logTaggedMarker(
      ReactABI35_0_0Marker::REGISTER_JS_SEGMENT_START, tag.c_str());
  if (bundleRegistry_) {
  ...
  ReactABI35_0_0Marker::logTaggedMarker(
      ReactABI35_0_0Marker::REGISTER_JS_SEGMENT_STOP, tag.c_str());
}
