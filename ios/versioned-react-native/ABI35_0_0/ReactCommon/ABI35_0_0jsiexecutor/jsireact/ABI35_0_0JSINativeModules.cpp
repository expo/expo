...
#include <jsiReactABI35_0_0/ABI35_0_0JSINativeModules.h>

#include <cxxReactABI35_0_0/ReactABI35_0_0Marker.h>

#include <ABI35_0_0jsi/ABI35_0_0JSIDynamic.h>
...
folly::Optional<Object> JSINativeModules::createModule(
  ...
  bool hasLogger(ReactABI35_0_0Marker::logTaggedMarker);
  if (hasLogger) {
    ReactABI35_0_0Marker::logTaggedMarker(
        ReactABI35_0_0Marker::NATIVE_MODULE_SETUP_START, name.c_str());
  }
  ...
  if (hasLogger) {
    ReactABI35_0_0Marker::logTaggedMarker(
        ReactABI35_0_0Marker::NATIVE_MODULE_SETUP_STOP, name.c_str());
  }
