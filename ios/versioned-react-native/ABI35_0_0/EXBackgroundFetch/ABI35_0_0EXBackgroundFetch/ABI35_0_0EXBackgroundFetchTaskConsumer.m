...
@implementation ABI35_0_0EXBackgroundFetchTaskConsumer

+ (BOOL)supportsLaunchReason:(ABI35_0_0UMTaskLaunchReason)launchReason
{
  return launchReason == ABI35_0_0UMTaskLaunchReasonBackgroundFetch;
}
...
- (void)didRegisterTask:(id<ABI35_0_0UMTaskInterface>)task
{
  _task = task;
...
- (NSUInteger)normalizeTaskResult:(id)result
{
  ...
  switch ([result unsignedIntegerValue]) {
    case ABI35_0_0EXBackgroundFetchResultNewData:
      return UIBackgroundFetchResultNewData;
    case ABI35_0_0EXBackgroundFetchResultFailed:
      return UIBackgroundFetchResultFailed;
    case ABI35_0_0EXBackgroundFetchResultNoData:
    default:
      return UIBackgroundFetchResultNoData;
  }
}
