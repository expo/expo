...
@interface ABI35_0_0EXFaceDetectorModule ()

@property (nonatomic, weak) ABI35_0_0UMModuleRegistry *moduleRegistry;

@end

@implementation ABI35_0_0EXFaceDetectorModule
...
ABI35_0_0UM_EXPORT_MODULE(ExpoFaceDetector);

- (NSDictionary *)constantsToExport
{
  return [ABI35_0_0EXFaceDetectorUtils constantsToExport];
}
...
ABI35_0_0UM_EXPORT_METHOD_AS(detectFaces, detectFaces:(nonnull NSDictionary *)options resolver:(ABI35_0_0UMPromiseResolveBlock)resolve rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    ...
    ciImage = [ciImage imageByApplyingOrientation:[ABI35_0_0EXFaceDetectorUtils toCGImageOrientation:image.imageOrientation]];
    ...
    ABI35_0_0EXFaceDetector* detector = [[ABI35_0_0EXFaceDetector alloc] initWithOptions: [ABI35_0_0EXFaceDetectorUtils mapOptions:options]];
    [detector detectFromImage:finalImage completionListener:^(NSArray<FIRVisionFace *> * _Nullable faces, NSError * _Nullable error) {
      ...
      if(faces.count > 0) {
        ABI35_0_0EXFaceEncoder *encoder = [[ABI35_0_0EXFaceEncoder alloc] init];
      ...
      if (error != nil) {
        ...
        resolve(@{
                  ...
                  @"image" : @{
                      ...
                      @"orientation" : @([ABI35_0_0EXFaceDetectorModule exifOrientationFor:image.imageOrientation])
                      }
                  });
      }}];
...
// the value of GMVImageOrientation is the same as the value defined by ABI35_0_0EXIF specifications, so we can adapt
