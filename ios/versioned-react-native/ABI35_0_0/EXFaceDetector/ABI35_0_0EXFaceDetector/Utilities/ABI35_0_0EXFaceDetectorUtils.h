//
//  ABI35_0_0EXFaceDetectorUtils.h
//  Exponent
//
...
typedef float (^ABI35_0_0EXFaceDetectionAngleTransformBlock)(float);

@interface ABI35_0_0EXFaceDetectorUtils : NSObject
...
+ (ABI35_0_0EXFaceDetectionAngleTransformBlock)angleTransformerFromTransform:(CGAffineTransform)transform;
