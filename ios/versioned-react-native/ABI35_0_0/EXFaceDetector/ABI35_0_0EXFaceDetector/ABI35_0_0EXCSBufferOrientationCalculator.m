//
//  ABI35_0_0EXFaceDetectorPointTransformCalculator.m
//  Exponent
//
...
@implementation ABI35_0_0EXCSBufferOrientationCalculator
                                               ...
                                               andMirrored:(BOOL)mirrored
{
  CGAffineTransform rotationTransform = CGAffineTransformConcat(
                                                                [ABI35_0_0EXCSBufferOrientationCalculator rotationTransformForOrientation:orientation],
                                                                [ABI35_0_0EXCSBufferOrientationCalculator transformForMirror:orientation forMirrored:mirrored]);
  CGAffineTransform rotationWithTranslation = [ABI35_0_0EXCSBufferOrientationCalculator rotationWithTranslation:rotationTransform forVideoWidth:videoWidth forVideoHeight:videoHeight];
  
  CGFloat scaleFactor = [ABI35_0_0EXCSBufferOrientationCalculator scaleForCropWithPreservingAspectRatioforBufferWidth:bufferWidth andBufferHeight:bufferHeight andVideoWidth:videoWidth andVideoHeight:videoHeight];
  
  CGAffineTransform cropTranslation = [ABI35_0_0EXCSBufferOrientationCalculator cropTranslationsTransformationForRotation:rotationWithTranslation andScale:scaleFactor andBufferWidth:bufferWidth andBufferHeight:bufferHeight andVideoWidth:videoWidth andVideoHeight:videoHeight];
