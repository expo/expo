...
#import "ABI35_0_0RCTPhotoLibraryImageLoader.h"

#import <Photos/Photos.h>

#import <ReactABI35_0_0/ABI35_0_0RCTUtils.h>

@implementation ABI35_0_0RCTPhotoLibraryImageLoader

ABI35_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI35_0_0RCTImageLoader
...
- (ABI35_0_0RCTImageLoaderCancellationBlock)loadImageForURL:(NSURL *)imageURL
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                        resizeMode:(ABI35_0_0RCTResizeMode)resizeMode
                                   progressHandler:(ABI35_0_0RCTImageLoaderProgressBlock)progressHandler
                                partialLoadHandler:(ABI35_0_0RCTImageLoaderPartialLoadBlock)partialLoadHandler
                                 completionHandler:(ABI35_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (!imageURL) {
    completionHandler(ABI35_0_0RCTErrorWithMessage(@"Cannot load a photo library asset with no URL"), nil);
    return ^{};
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI35_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI35_0_0RCTResizeModeContain) {
