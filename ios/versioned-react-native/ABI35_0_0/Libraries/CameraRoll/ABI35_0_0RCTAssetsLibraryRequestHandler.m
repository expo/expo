...
@implementation ABI35_0_0RCTAssetsLibraryRequestHandler
     ...
     withDelegate:(id<ABI35_0_0RCTURLRequestDelegate>)delegate
{
  ...
  if (!request.URL) {
    ...
    [delegate URLRequest:cancellationBlock didCompleteWithError:ABI35_0_0RCTErrorWithMessage(msg)];
  ...
  if (![fetchResult firstObject]) {
    ...
    NSError *error = ABI35_0_0RCTErrorWithMessage(errorMessage);
