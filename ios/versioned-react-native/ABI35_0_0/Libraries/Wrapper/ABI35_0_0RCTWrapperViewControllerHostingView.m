...
#import "ABI35_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI35_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI35_0_0ViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI35_0_0ViewController detachChildViewController:self.contentViewController];
}
