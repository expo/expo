...
#import "ABI35_0_0RCTSurfaceHostingComponent.h"
#import "ABI35_0_0RCTSurfaceHostingComponent+Internal.h"
...
#import "ABI35_0_0RCTSurfaceHostingComponentController.h"
#import "ABI35_0_0RCTSurfaceHostingComponentState.h"

@implementation ABI35_0_0RCTSurfaceHostingComponent

+ (Class<CKComponentControllerProtocol>)controllerClass
{
  return [ABI35_0_0RCTSurfaceHostingComponentController class];
}

+ (id)initialState
{
  return [ABI35_0_0RCTSurfaceHostingComponentState new];
}
...
+ (instancetype)newWithSurface:(ABI35_0_0RCTSurface *)surface options:(ABI35_0_0RCTSurfaceHostingComponentOptions)options
{
  ...
  ABI35_0_0RCTSurfaceHostingComponentState *const state = scope.state();

  ABI35_0_0RCTSurfaceHostingComponentState *const newState =
    [ABI35_0_0RCTSurfaceHostingComponentState newWithStage:surface.stage
  ...
  ABI35_0_0RCTSurfaceHostingComponent *const component =
...
- (CKComponentLayout)computeLayoutThatFits:(CKSizeRange)constrainedSize
{
  ...
  // just to provide layout constraints to ReactABI35_0_0 Native as early as possible.
  // ReactABI35_0_0 Native *may* use this info later during applying the own state and
  ...
  // interop compatibilities of ReactABI35_0_0 Native which will enable us granularly
  // control ReactABI35_0_0 Native mounting blocks and, as a result, implement
  // truly synchronous mounting stage between ReactABI35_0_0 Native and ComponentKit.
  [_surface setMinimumSize:constrainedSize.min
               maximumSize:constrainedSize.max];

  // Just in case of the very first building pass, we give ReactABI35_0_0 Native a chance
  // to prepare its internals for coming synchronous measuring.
  [_surface synchronouslyWaitForStage:ABI35_0_0RCTSurfaceStageSurfaceDidInitialLayout
                              timeout:_options.synchronousLayoutingTimeout];

  CGSize fittingSize = CGSizeZero;
  if (_surface.stage & ABI35_0_0RCTSurfaceStageSurfaceDidInitialLayout) {
...
- (CKComponentBoundsAnimation)boundsAnimationFromPreviousComponent:(ABI35_0_0RCTSurfaceHostingComponent *)previousComponent
{
