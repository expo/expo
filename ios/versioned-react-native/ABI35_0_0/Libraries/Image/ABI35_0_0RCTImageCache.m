...
static const NSUInteger ABI35_0_0RCTMaxCachableDecodedImageSizeInBytes = 2097152; // 2 MB

static NSString *ABI35_0_0RCTCacheKeyForImage(NSString *imageTag, CGSize size, CGFloat scale,
...
@implementation ABI35_0_0RCTImageCache
{
                 ...
                 forKey:(NSString *)cacheKey
{
  ...
  NSInteger bytes = image.ReactABI35_0_0DecodedImageBytes;
  if (bytes <= ABI35_0_0RCTMaxCachableDecodedImageSizeInBytes) {
...
{
  NSString *cacheKey = ABI35_0_0RCTCacheKeyForImage(url, size, scale, resizeMode);
  @synchronized(_cacheStaleTimes) {
