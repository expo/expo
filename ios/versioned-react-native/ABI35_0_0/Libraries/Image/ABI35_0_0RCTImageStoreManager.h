...
@interface ABI35_0_0RCTImageStoreManager : NSObject <ABI35_0_0RCTURLRequestHandler>
...
@interface ABI35_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI35_0_0RCTBridge (ABI35_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI35_0_0RCTImageStoreManager *imageStoreManager;
