...
NSString *const ABI35_0_0RCTTextAttributesIsHighlightedAttributeName = @"ABI35_0_0RCTTextAttributesIsHighlightedAttributeName";
NSString *const ABI35_0_0RCTTextAttributesTagAttributeName = @"ABI35_0_0RCTTextAttributesTagAttributeName";

@implementation ABI35_0_0RCTTextAttributes
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _opacity = NAN;
    _textTransform = ABI35_0_0RCTTextTransformUndefined;
  }

  return self;
}

- (void)applyTextAttributes:(ABI35_0_0RCTTextAttributes *)textAttributes
{
  ...
  _textDecorationLine = textAttributes->_textDecorationLine != ABI35_0_0RCTTextDecorationLineTypeNone ? textAttributes->_textDecorationLine : _textDecorationLine; // *
  ...
  _textTransform = textAttributes->_textTransform != ABI35_0_0RCTTextTransformUndefined ? textAttributes->_textTransform : _textTransform;
}
...
- (NSDictionary<NSAttributedStringKey, id> *)effectiveTextAttributes
{
  ...
  if (_textDecorationLine == ABI35_0_0RCTTextDecorationLineTypeUnderline ||
      _textDecorationLine == ABI35_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    isTextDecorationEnabled = YES;
    attributes[NSUnderlineStyleAttributeName] = @(_textDecorationStyle);
  }

  if (_textDecorationLine == ABI35_0_0RCTTextDecorationLineTypeStrikethrough ||
      _textDecorationLine == ABI35_0_0RCTTextDecorationLineTypeUnderlineStrikethrough){
    isTextDecorationEnabled = YES;
  ...
  // Special
  if (_isHighlighted) {
    attributes[ABI35_0_0RCTTextAttributesIsHighlightedAttributeName] = @YES;
  }

  if (_tag) {
    attributes[ABI35_0_0RCTTextAttributesTagAttributeName] = _tag;
  }
...
{
  // FIXME: ABI35_0_0RCTFont has thread-safety issues and must be rewritten.
...
{
  bool fontScalingEnabled = !ABI35_0_0RCTHasFontHandlerSet() && _allowFontScaling;
...
- (NSString *)applyTextAttributesToText:(NSString *)text
{
  switch (_textTransform) {
    case ABI35_0_0RCTTextTransformUndefined:
    case ABI35_0_0RCTTextTransformNone:
      return text;
    case ABI35_0_0RCTTextTransformLowercase:
      return [text lowercaseString];
    case ABI35_0_0RCTTextTransformUppercase:
      return [text uppercaseString];
    case ABI35_0_0RCTTextTransformCapitalize:
      return [text capitalizedString];
  }
}

- (ABI35_0_0RCTTextAttributes *)copyWithZone:(NSZone *)zone
{
  ABI35_0_0RCTTextAttributes *textAttributes = [ABI35_0_0RCTTextAttributes new];
...
- (BOOL)isEqual:(ABI35_0_0RCTTextAttributes *)textAttributes
{
  if (self == textAttributes) {
    return YES;
  }

#define ABI35_0_0RCTTextAttributesCompareFloats(a) ((a == textAttributes->a) || (isnan(a) && isnan(textAttributes->a)))
#define ABI35_0_0RCTTextAttributesCompareSize(a) CGSizeEqualToSize(a, textAttributes->a)
#define ABI35_0_0RCTTextAttributesCompareObjects(a) ((a == textAttributes->a) || [a isEqual:textAttributes->a])
#define ABI35_0_0RCTTextAttributesCompareStrings(a) ((a == textAttributes->a) || [a isEqualToString:textAttributes->a])
#define ABI35_0_0RCTTextAttributesCompareOthers(a) (a == textAttributes->a)

  return
    ABI35_0_0RCTTextAttributesCompareObjects(_foregroundColor) &&
    ABI35_0_0RCTTextAttributesCompareObjects(_backgroundColor) &&
    ABI35_0_0RCTTextAttributesCompareFloats(_opacity) &&
    // Font
    ABI35_0_0RCTTextAttributesCompareObjects(_fontFamily) &&
    ABI35_0_0RCTTextAttributesCompareFloats(_fontSize) &&
    ABI35_0_0RCTTextAttributesCompareFloats(_fontSizeMultiplier) &&
    ABI35_0_0RCTTextAttributesCompareFloats(_maxFontSizeMultiplier) &&
    ABI35_0_0RCTTextAttributesCompareStrings(_fontWeight) &&
    ABI35_0_0RCTTextAttributesCompareObjects(_fontStyle) &&
    ABI35_0_0RCTTextAttributesCompareObjects(_fontVariant) &&
    ABI35_0_0RCTTextAttributesCompareOthers(_allowFontScaling) &&
    ABI35_0_0RCTTextAttributesCompareFloats(_letterSpacing) &&
    // Paragraph Styles
    ABI35_0_0RCTTextAttributesCompareFloats(_lineHeight) &&
    ABI35_0_0RCTTextAttributesCompareFloats(_alignment) &&
    ABI35_0_0RCTTextAttributesCompareOthers(_baseWritingDirection) &&
    // Decoration
    ABI35_0_0RCTTextAttributesCompareObjects(_textDecorationColor) &&
    ABI35_0_0RCTTextAttributesCompareOthers(_textDecorationStyle) &&
    ABI35_0_0RCTTextAttributesCompareOthers(_textDecorationLine) &&
    // Shadow
    ABI35_0_0RCTTextAttributesCompareSize(_textShadowOffset) &&
    ABI35_0_0RCTTextAttributesCompareFloats(_textShadowRadius) &&
    ABI35_0_0RCTTextAttributesCompareObjects(_textShadowColor) &&
    // Special
    ABI35_0_0RCTTextAttributesCompareOthers(_isHighlighted) &&
    ABI35_0_0RCTTextAttributesCompareObjects(_tag) &&
    ABI35_0_0RCTTextAttributesCompareOthers(_layoutDirection) &&
    ABI35_0_0RCTTextAttributesCompareOthers(_textTransform);
}
