...
extern NSString *const ABI35_0_0RCTTextAttributesIsHighlightedAttributeName;
extern NSString *const ABI35_0_0RCTTextAttributesTagAttributeName;
 ...
 * and <TextInput>.
 */
@interface ABI35_0_0RCTTextAttributes : NSObject <NSCopying>
...
@property (nonatomic, assign) ABI35_0_0RCTTextDecorationLineType textDecorationLine;
// Shadow
...
@property (nonatomic, assign) ABI35_0_0RCTTextTransform textTransform;
