...
@implementation ABI35_0_0RCTTextShadowView
{
...
- (instancetype)initWithBridge:(ABI35_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI35_0_0YGNodeSetMeasureFunc(self.ABI35_0_0yogaNode, ABI35_0_0RCTTextShadowViewMeasure);
    ABI35_0_0YGNodeSetBaselineFunc(self.ABI35_0_0yogaNode, ABI35_0_0RCTTextShadowViewBaseline);
  }
...
{
  if (ABI35_0_0YGNodeIsDirty(self.ABI35_0_0yogaNode)) {
    return;
  }
  ...
  NSNumber *tag = self.ReactABI35_0_0Tag;
  NSMutableArray<NSNumber *> *descendantViewTags = [NSMutableArray new];
  [textStorage enumerateAttribute:ABI35_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                          inRange:NSMakeRange(0, textStorage.length)
                          options:0
                       usingBlock:
   ^(ABI35_0_0RCTShadowView *shadowView, NSRange range, __unused BOOL *stop) {
     if (!shadowView) {
       return;
     }

     [descendantViewTags addObject:shadowView.ReactABI35_0_0Tag];
   }
  ];

  [_bridge.uiManager addUIBlock:^(ABI35_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI35_0_0RCTTextView *textView = (ABI35_0_0RCTTextView *)viewRegistry[tag];
    if (!textView) {
      return;
    }
    ...
    [textStorage removeAttribute:ABI35_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName range:NSMakeRange(0, textStorage.length)];
...
- (NSAttributedString *)attributedTextWithMeasuredAttachmentsThatFitSize:(CGSize)size
{
  ...
  [attributedText enumerateAttribute:ABI35_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                               inRange:NSMakeRange(0, attributedText.length)
                               options:0
                            usingBlock:
    ^(ABI35_0_0RCTShadowView *shadowView, NSRange range, __unused BOOL *stop) {
                                        ...
                                        exclusiveOwnership:(BOOL)exclusiveOwnership
{
  ...
  if (_adjustsFontSizeToFit) {
    ...
    [textStorage abi35_0_0_rct_scaleFontSizeToFitSize:size
...
- (void)layoutSubviewsWithContext:(ABI35_0_0RCTLayoutContext)layoutContext
{
  ...
  [textStorage enumerateAttribute:ABI35_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                          ...
                          options:0
                       usingBlock:
    ^(ABI35_0_0RCTShadowView *shadowView, NSRange range, BOOL *stop) {
      if (!shadowView) {
        return;
      }
      ...
      CGRect frame = {{
        ABI35_0_0RCTRoundPixelValue(glyphRect.origin.x),
        ABI35_0_0RCTRoundPixelValue(glyphRect.origin.y + glyphRect.size.height - attachmentSize.height + font.descender)
      }, {
        ABI35_0_0RCTRoundPixelValue(attachmentSize.width),
        ABI35_0_0RCTRoundPixelValue(attachmentSize.height)
      }};
      
      NSRange truncatedGlyphRange = [layoutManager truncatedGlyphRangeInLineFragmentForGlyphAtIndex:range.location];
      BOOL viewIsTruncated = NSIntersectionRange(range, truncatedGlyphRange).length != 0;

      ABI35_0_0RCTLayoutContext localLayoutContext = layoutContext;
      ...
      ABI35_0_0RCTLayoutMetrics localLayoutMetrics = shadowView.layoutMetrics;
      localLayoutMetrics.frame.origin = frame.origin; // Reinforcing a proper frame origin for the Shadow View.
      if (viewIsTruncated) {
        localLayoutMetrics.displayType = ABI35_0_0RCTDisplayTypeNone;
      }
...
static ABI35_0_0YGSize ABI35_0_0RCTTextShadowViewMeasure(ABI35_0_0YGNodeRef node, float width, ABI35_0_0YGMeasureMode widthMode, float height, ABI35_0_0YGMeasureMode heightMode)
{
  CGSize maximumSize = (CGSize){
    widthMode == ABI35_0_0YGMeasureModeUndefined ? CGFLOAT_MAX : ABI35_0_0RCTCoreGraphicsFloatFromYogaFloat(width),
    heightMode == ABI35_0_0YGMeasureModeUndefined ? CGFLOAT_MAX : ABI35_0_0RCTCoreGraphicsFloatFromYogaFloat(height),
  };

  ABI35_0_0RCTTextShadowView *shadowTextView = (__bridge ABI35_0_0RCTTextShadowView *)ABI35_0_0YGNodeGetContext(node);
  ...
  size = (CGSize){
    MIN(ABI35_0_0RCTCeilPixelValue(size.width), maximumSize.width),
    MIN(ABI35_0_0RCTCeilPixelValue(size.height), maximumSize.height)
  };
  ...
  return (ABI35_0_0YGSize){
    ABI35_0_0RCTYogaFloatFromCoreGraphicsFloat(size.width + epsilon),
    ABI35_0_0RCTYogaFloatFromCoreGraphicsFloat(size.height + epsilon)
  };
}

static float ABI35_0_0RCTTextShadowViewBaseline(ABI35_0_0YGNodeRef node, const float width, const float height)
{
  ABI35_0_0RCTTextShadowView *shadowTextView = (__bridge ABI35_0_0RCTTextShadowView *)ABI35_0_0YGNodeGetContext(node);

  CGSize size = (CGSize){
    ABI35_0_0RCTCoreGraphicsFloatFromYogaFloat(width),
    ABI35_0_0RCTCoreGraphicsFloatFromYogaFloat(height)
  };

  CGFloat lastBaseline = [shadowTextView lastBaselineForSize:size];

  return ABI35_0_0RCTYogaFloatFromCoreGraphicsFloat(lastBaseline);
}
