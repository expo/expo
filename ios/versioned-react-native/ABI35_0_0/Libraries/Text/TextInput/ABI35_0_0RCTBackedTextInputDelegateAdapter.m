...
@interface ABI35_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI35_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI35_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
...
@interface ABI35_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI35_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI35_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}
