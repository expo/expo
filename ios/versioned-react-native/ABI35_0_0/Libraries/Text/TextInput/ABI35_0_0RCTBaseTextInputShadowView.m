...
@implementation ABI35_0_0RCTBaseTextInputShadowView
{
...
- (instancetype)initWithBridge:(ABI35_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI35_0_0YGNodeSetMeasureFunc(self.ABI35_0_0yogaNode, ABI35_0_0RCTBaseTextInputShadowViewMeasure);
    ABI35_0_0YGNodeSetBaselineFunc(self.ABI35_0_0yogaNode, ABI35_0_0RCTTextInputShadowViewBaseline);
  }
...
- (void)uiManagerWillPerformMounting
{
  ...
  ABI35_0_0RCTTextAttributes *textAttributes = [self.textAttributes copy];
  ...
  [attributedText removeAttribute:ABI35_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                            range:NSMakeRange(0, attributedText.length)];

  [attributedText removeAttribute:ABI35_0_0RCTTextAttributesTagAttributeName
                            range:NSMakeRange(0, attributedText.length)];
  ...
  [_bridge.uiManager addUIBlock:^(ABI35_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI35_0_0RCTBaseTextInputView *baseTextInputView = (ABI35_0_0RCTBaseTextInputView *)viewRegistry[tag];
    if (!baseTextInputView) {
      return;
    }

    baseTextInputView.textAttributes = textAttributes;
    baseTextInputView.ReactABI35_0_0BorderInsets = borderInsets;
    baseTextInputView.ReactABI35_0_0PaddingInsets = paddingInsets;
...
- (CGSize)sizeThatFitsMinimumSize:(CGSize)minimumSize maximumSize:(CGSize)maximumSize
{
  ...
  return (CGSize){
    MAX(minimumSize.width, MIN(ABI35_0_0RCTCeilPixelValue(size.width), maximumSize.width)),
    MAX(minimumSize.height, MIN(ABI35_0_0RCTCeilPixelValue(size.height), maximumSize.height))
  };
}
...
static ABI35_0_0YGSize ABI35_0_0RCTBaseTextInputShadowViewMeasure(ABI35_0_0YGNodeRef node, float width, ABI35_0_0YGMeasureMode widthMode, float height, ABI35_0_0YGMeasureMode heightMode)
{
  ...
  return (ABI35_0_0YGSize){
    ABI35_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.width),
    ABI35_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.height)
  };
}

static float ABI35_0_0RCTTextInputShadowViewBaseline(ABI35_0_0YGNodeRef node, const float width, const float height)
{
  ABI35_0_0RCTBaseTextInputShadowView *shadowTextView = (__bridge ABI35_0_0RCTBaseTextInputShadowView *)ABI35_0_0YGNodeGetContext(node);
