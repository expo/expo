...
@implementation ABI35_0_0RCTMultilineTextInputView
{
  ABI35_0_0RCTUITextView *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI35_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI35_0_0RCTUITextView alloc] initWithFrame:self.bounds];
...
- (id<ABI35_0_0RCTBackedTextInputViewProtocol>)backedTextInputView
{
...
{
  ABI35_0_0RCTDirectEventBlock onScroll = self.onScroll;
