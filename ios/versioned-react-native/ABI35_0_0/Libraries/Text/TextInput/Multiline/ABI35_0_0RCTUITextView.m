...
#import "ABI35_0_0RCTUITextView.h"

#import <ReactABI35_0_0/ABI35_0_0RCTUtils.h>
#import <ReactABI35_0_0/UIView+ReactABI35_0_0.h>

#import "ABI35_0_0RCTBackedTextInputDelegateAdapter.h"

@implementation ABI35_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI35_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI35_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
  }
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  // see: https://github.com/facebook/ReactABI35_0_0-native/issues/19339
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI35_0_0RCTCeilPixelValue(placeholderSize.width), ABI35_0_0RCTCeilPixelValue(placeholderSize.height));
