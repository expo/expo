...
#import "ABI35_0_0RCTBackedTextInputViewProtocol.h"

#import "ABI35_0_0RCTBackedTextInputDelegate.h"
 ...
 */
@interface ABI35_0_0RCTUITextView : UITextView <ABI35_0_0RCTBackedTextInputViewProtocol>

- (instancetype)initWithFrame:(CGRect)frame textContainer:(nullable NSTextContainer *)textContainer NS_UNAVAILABLE;
- (instancetype)initWithCoder:(NSCoder *)decoder NS_UNAVAILABLE;

@property (nonatomic, weak) id<ABI35_0_0RCTBackedTextInputDelegate> textInputDelegate;
