...
typedef NS_ENUM(NSInteger, ABI35_0_0RCTTestStatus) {
  ABI35_0_0RCTTestStatusPending = 0,
  ABI35_0_0RCTTestStatusPassed,
  ABI35_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI35_0_0RCTTestModule : NSObject <ABI35_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI35_0_0RCTTestStatus status;
