...
@implementation ABI35_0_0RCTFrameAnimation
{
  ...
  ABI35_0_0RCTResponseSenderBlock _callback;
...
{
  NSNumber *toValue = [ABI35_0_0RCTConvert NSNumber:config[@"toValue"]] ?: @1;
  NSArray<NSNumber *> *frames = [ABI35_0_0RCTConvert NSNumberArray:config[@"frames"]];
  NSNumber *iterations = [ABI35_0_0RCTConvert NSNumber:config[@"iterations"]] ?: @1;
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  NSTimeInterval currentDuration = (_animationCurrentTime - _animationStartTime) / ABI35_0_0RCTAnimationDragCoefficient();

  // Determine how many frames have passed since last update.
  // Get index of frames that surround the current interval
  NSUInteger startIndex = floor(currentDuration / ABI35_0_0RCTSingleFrameInterval);
  ...
  NSTimeInterval fromInterval = startIndex * ABI35_0_0RCTSingleFrameInterval;
  NSTimeInterval toInterval = nextIndex * ABI35_0_0RCTSingleFrameInterval;
  ...
  CGFloat frameOutput = ABI35_0_0RCTInterpolateValue(currentDuration,
                                            fromInterval,
                                            toInterval,
                                            fromFrameValue.doubleValue,
                                            toFrameValue.doubleValue,
                                            ABI35_0_0EXTRAPOLATE_TYPE_EXTEND,
                                            ABI35_0_0EXTRAPOLATE_TYPE_EXTEND);
...
{
  CGFloat outputValue = ABI35_0_0RCTInterpolateValue(frameOutput,
                                            0,
                                            1,
                                            _fromValue,
                                            _toValue,
