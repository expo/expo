...
@interface ABI35_0_0RCTSpringAnimation ()
...
@implementation ABI35_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
                  ...
                  callBack:(nullable ABI35_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _lastVelocity = [ABI35_0_0RCTConvert CGFloat:config[@"initialVelocity"]];
...
- (void)resetAnimationConfig:(NSDictionary *)config
{
  ...
  _toValue = [ABI35_0_0RCTConvert CGFloat:config[@"toValue"]];
  _overshootClamping = [ABI35_0_0RCTConvert BOOL:config[@"overshootClamping"]];
  _restDisplacementThreshold = [ABI35_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
  _restSpeedThreshold = [ABI35_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
  _stiffness = [ABI35_0_0RCTConvert CGFloat:config[@"stiffness"]];
  _damping = [ABI35_0_0RCTConvert CGFloat:config[@"damping"]];
  _mass = [ABI35_0_0RCTConvert CGFloat:config[@"mass"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  if(_animationStartTime == -1) {
    ...
    _t = _t + deltaTime / ABI35_0_0RCTAnimationDragCoefficient();
  }
