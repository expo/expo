...
@implementation ABI35_0_0RCTStyleAnimatedNode
{
...
- (void)performUpdate
{
  ...
  [style enumerateKeysAndObjectsUsingBlock:^(NSString *property, NSNumber *nodeTag, __unused BOOL *stop) {
    ...
    if (node) {
      ...
      } else if ([node isKindOfClass:[ABI35_0_0RCTTransformAnimatedNode class]]) {
        ABI35_0_0RCTTransformAnimatedNode *parentNode = (ABI35_0_0RCTTransformAnimatedNode *)node;
