...
@implementation ABI35_0_0RCTTransformAnimatedNode
{
...
- (void)performUpdate
{
  ...
  for (NSDictionary *transformConfig in transformConfigs) {
    ...
    if ([type isEqualToString: @"animated"]) {
      ...
      ABI35_0_0RCTAnimatedNode *node = [self.parentNodes objectForKey:nodeTag];
      if (![node isKindOfClass:[ABI35_0_0RCTValueAnimatedNode class]]) {
        continue;
      }
      ABI35_0_0RCTValueAnimatedNode *parentNode = (ABI35_0_0RCTValueAnimatedNode *)node;
