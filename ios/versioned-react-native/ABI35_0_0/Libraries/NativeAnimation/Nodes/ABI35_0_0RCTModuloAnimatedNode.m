...
@implementation ABI35_0_0RCTModuloAnimatedNode
...
- (void)performUpdate
{
  ...
  ABI35_0_0RCTValueAnimatedNode *parent = (ABI35_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:inputNode];
