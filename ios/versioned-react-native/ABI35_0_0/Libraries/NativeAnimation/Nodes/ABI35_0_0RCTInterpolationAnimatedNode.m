...
@implementation ABI35_0_0RCTInterpolationAnimatedNode
{
  __weak ABI35_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI35_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI35_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI35_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI35_0_0RCTInterpolateValueInRange(inputValue,
                                          _inputRange,
                                          _outputRange,
                                          _extrapolateLeft,
                                          _extrapolateRight);
