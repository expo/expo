...
@implementation ABI35_0_0RCTTrackingAnimatedNode {
...
- (void)performUpdate
{
  ...
  ABI35_0_0RCTValueAnimatedNode *node = (ABI35_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
