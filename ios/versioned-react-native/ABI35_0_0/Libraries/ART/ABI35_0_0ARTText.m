...
@implementation ABI35_0_0ARTText
...
static void ABI35_0_0ARTFreeTextFrame(ABI35_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI35_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI35_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI35_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI35_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
