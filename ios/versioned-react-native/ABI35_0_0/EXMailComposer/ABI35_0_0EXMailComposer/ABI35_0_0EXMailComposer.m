...
#import <ABI35_0_0EXMailComposer/ABI35_0_0EXMailComposer.h>
...
@interface ABI35_0_0EXMailComposer ()
...
@implementation ABI35_0_0EXMailComposer

ABI35_0_0UM_EXPORT_MODULE(ExpoMailComposer);
...
ABI35_0_0UM_EXPORT_METHOD_AS(composeAsync,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (options[@"attachments"] != nil) {
    for (NSString *uri in options[@"attachments"]) {
      ...
      if (!([fileSystem permissionsForURI:url] & ABI35_0_0UMFileSystemPermissionRead)) {
  ...
  self.reject = reject;
  id<ABI35_0_0UMUtilitiesInterface> utilities = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI35_0_0UMUtilitiesInterface)];
