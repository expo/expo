...
#import <ABI35_0_0EXMediaLibrary/ABI35_0_0EXMediaLibrary.h>
...
NSString *const ABI35_0_0EXAssetMediaTypeAudio = @"audio";
NSString *const ABI35_0_0EXAssetMediaTypePhoto = @"photo";
NSString *const ABI35_0_0EXAssetMediaTypeVideo = @"video";
NSString *const ABI35_0_0EXAssetMediaTypeUnknown = @"unknown";
NSString *const ABI35_0_0EXAssetMediaTypeAll = @"all";

NSString *const ABI35_0_0EXMediaLibraryDidChangeEvent = @"mediaLibraryDidChange";

@interface ABI35_0_0EXMediaLibrary ()
...
@implementation ABI35_0_0EXMediaLibrary

ABI35_0_0UM_EXPORT_MODULE(ExponentMediaLibrary);
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"MediaType": @{
               @"audio": ABI35_0_0EXAssetMediaTypeAudio,
               @"photo": ABI35_0_0EXAssetMediaTypePhoto,
               @"video": ABI35_0_0EXAssetMediaTypeVideo,
               @"unknown": ABI35_0_0EXAssetMediaTypeUnknown,
               @"all": ABI35_0_0EXAssetMediaTypeAll,
               },
           @"SortBy": @{
               @"default": @"default",
           ...
           @"CHANGE_LISTENER_NAME": ABI35_0_0EXMediaLibraryDidChangeEvent,
           };
}

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI35_0_0EXMediaLibraryDidChangeEvent];
}

ABI35_0_0UM_EXPORT_METHOD_AS(requestPermissionsAsync,
                    requestPermissions:(ABI35_0_0UMPromiseResolveBlock)resolve
...
ABI35_0_0UM_EXPORT_METHOD_AS(getPermissionsAsync,
                    getPermissions:(ABI35_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  if (!_permissionsManager) {
    return reject(@"E_NO_PERMISSIONS_MODULE", @"Permissions module not found. Are you sure that Expo modules are properly linked?", nil);
...
ABI35_0_0UM_EXPORT_METHOD_AS(createAssetAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  PHAssetMediaType assetType = [ABI35_0_0EXMediaLibrary _assetTypeForUri:localUri];
  ...
  if (!([_fileSystem permissionsForURI:assetUrl] & ABI35_0_0UMFileSystemPermissionRead)) {
  ...
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    ...
    if (success) {
      PHAsset *asset = [ABI35_0_0EXMediaLibrary _getAssetById:assetPlaceholder.localIdentifier];
      resolve([ABI35_0_0EXMediaLibrary _exportAsset:asset]);
    } else {
...
ABI35_0_0UM_EXPORT_METHOD_AS(addAssetsToAlbumAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  [ABI35_0_0EXMediaLibrary _addAssets:assetIds toAlbum:albumId withCallback:^(BOOL success, NSError *error) {
    if (error) {
...
ABI35_0_0UM_EXPORT_METHOD_AS(removeAssetsFromAlbumAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    PHAssetCollection *collection = [ABI35_0_0EXMediaLibrary _getAlbumById:albumId];
    PHFetchResult *assets = [ABI35_0_0EXMediaLibrary _getAssetsByIds:assetIds];
...
ABI35_0_0UM_EXPORT_METHOD_AS(deleteAssetsAsync,
...
ABI35_0_0UM_EXPORT_METHOD_AS(getAlbumsAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  [albums addObjectsFromArray:[ABI35_0_0EXMediaLibrary _exportCollections:userAlbumsFetchResult]];
  ...
  if ([options[@"includeSmartAlbums"] boolValue]) {
    ...
    [albums addObjectsFromArray:[ABI35_0_0EXMediaLibrary _exportCollections:smartAlbumsFetchResult]];
  }
  
  resolve(albums);
}

ABI35_0_0UM_EXPORT_METHOD_AS(getMomentsAsync,
                    getMoments:(ABI35_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  if (![self _checkPermissions:reject]) {
    return;
  ...
  NSArray<NSDictionary *> *albums = [ABI35_0_0EXMediaLibrary _exportCollections:fetchResult];
  
  resolve(albums);
}

ABI35_0_0UM_EXPORT_METHOD_AS(getAlbumAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  PHAssetCollection *collection = [ABI35_0_0EXMediaLibrary _getAlbumWithTitle:title];
  resolve(ABI35_0_0UMNullIfNil([ABI35_0_0EXMediaLibrary _exportCollection:collection]));
}

ABI35_0_0UM_EXPORT_METHOD_AS(createAlbumAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  [ABI35_0_0EXMediaLibrary _createAlbumWithTitle:title completion:^(PHAssetCollection *collection, NSError *error) {
    if (collection) {
      if (assetId) {
        [ABI35_0_0EXMediaLibrary _addAssets:@[assetId] toAlbum:collection.localIdentifier withCallback:^(BOOL success, NSError *error) {
          if (success) {
            resolve(ABI35_0_0UMNullIfNil([ABI35_0_0EXMediaLibrary _exportCollection:collection]));
          } else {
...
ABI35_0_0UM_EXPORT_METHOD_AS(deleteAlbumsAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  PHFetchResult *collections = [ABI35_0_0EXMediaLibrary _getAlbumsById:albumIds];
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    if (assetRemove) {
...
ABI35_0_0UM_EXPORT_METHOD_AS(getAssetInfoAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  PHAsset *asset = [ABI35_0_0EXMediaLibrary _getAssetById:assetId];
  
  if (asset) {
    NSMutableDictionary *result = [ABI35_0_0EXMediaLibrary _exportAssetInfo:asset];
...
ABI35_0_0UM_EXPORT_METHOD_AS(getAssetsAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *createdAfter = [ABI35_0_0UMUtilities NSDate:options[@"createdAfter"]];
  NSDate *createdBefore = [ABI35_0_0UMUtilities NSDate:options[@"createdBefore"]];
  
  PHAssetCollection *collection;
  PHAsset *cursor;
  
  if (after) {
    cursor = [ABI35_0_0EXMediaLibrary _getAssetById:after];
  ...
  if (albumId) {
    collection = [ABI35_0_0EXMediaLibrary _getAlbumById:albumId];
  ...
  if (mediaType && [mediaType count] > 0) {
    NSMutableArray<NSNumber *> *assetTypes = [ABI35_0_0EXMediaLibrary _convertMediaTypes:mediaType];
  ...
  if (sortBy && sortBy.count > 0) {
    fetchOptions.sortDescriptors = [ABI35_0_0EXMediaLibrary _prepareSortDescriptors:sortBy];
  }
  ...
  if (fetchOptions.sortDescriptors.count == 0) {
    ...
    for (NSInteger i = startIndex; i >= endIndex; i--) {
      ...
      [assets addObject:[ABI35_0_0EXMediaLibrary _exportAsset:asset]];
    }
...
- (void)startObserving
{
  _allAssetsFetchResult = [ABI35_0_0EXMediaLibrary _getAllAssets];
    ...
    if (changeDetails != nil) {
      ...
      if (changeDetails.hasIncrementalChanges && (changeDetails.insertedObjects.count > 0 || changeDetails.removedObjects.count > 0)) {
        ...
        for (PHAsset *asset in changeDetails.insertedObjects) {
          [insertedAssets addObject:[ABI35_0_0EXMediaLibrary _exportAsset:asset]];
        }
        for (PHAsset *asset in changeDetails.removedObjects) {
          [deletedAssets addObject:[ABI35_0_0EXMediaLibrary _exportAsset:asset]];
        }
        
        [_eventEmitter sendEventWithName:ABI35_0_0EXMediaLibraryDidChangeEvent body:body];
      }
    }
  }
}
...
{
  if (assetId) {
    return [ABI35_0_0EXMediaLibrary _getAssetsByIds:@[assetId]].firstObject;
  }
  return nil;
}
...
+ (void)_ensureAlbumWithTitle:(nonnull NSString *)title completion:(void(^)(PHAssetCollection *collection, NSError *error))completion
{
  ...
  [ABI35_0_0EXMediaLibrary _createAlbumWithTitle:title completion:completion];
}
...
+ (NSDictionary *)_exportAsset:(PHAsset *)asset
{
  if (asset) {
    ...
    return @{
             ...
             @"filename": fileName,
             @"uri": [ABI35_0_0EXMediaLibrary _assetUriForLocalId:asset.localIdentifier andExtension:assetExtension],
             @"mediaType": [ABI35_0_0EXMediaLibrary _stringifyMediaType:asset.mediaType],
             @"mediaSubtypes": [ABI35_0_0EXMediaLibrary _stringifyMediaSubtypes:asset.mediaSubtypes],
             @"width": @(asset.pixelWidth),
             @"height": @(asset.pixelHeight),
             @"creationTime": [ABI35_0_0EXMediaLibrary _exportDate:asset.creationDate],
             @"modificationTime": [ABI35_0_0EXMediaLibrary _exportDate:asset.modificationDate],
...
{
  NSMutableDictionary *assetDict = [[ABI35_0_0EXMediaLibrary _exportAsset:asset] mutableCopy];
  
  if (assetDict) {
    assetDict[@"location"] = [ABI35_0_0EXMediaLibrary _exportLocation:asset.location];
...
+ (nullable NSDictionary *)_exportCollection:(PHAssetCollection *)collection
{
  if (collection) {
    return @{
             @"id": [ABI35_0_0EXMediaLibrary _assetIdFromLocalId:collection.localIdentifier],
             @"title": collection.localizedTitle ?: [NSNull null],
             @"type": [ABI35_0_0EXMediaLibrary _stringifyAlbumType:collection.assetCollectionType],
             @"assetCount": [ABI35_0_0EXMediaLibrary _assetCountOfCollection:collection],
             @"startTime": [ABI35_0_0EXMediaLibrary _exportDate:collection.startDate],
             @"endTime": [ABI35_0_0EXMediaLibrary _exportDate:collection.endDate],
             @"approximateLocation": [ABI35_0_0EXMediaLibrary _exportLocation:collection.approximateLocation],
...
+ (NSArray *)_exportCollections:(PHFetchResult *)collections
{
  ...
  for (PHAssetCollection *collection in collections) {
    [albums addObject:[ABI35_0_0EXMediaLibrary _exportCollection:collection]];
  }
  return [albums copy];
}
...
{
  NSString *assetId = [ABI35_0_0EXMediaLibrary _assetIdFromLocalId:localId];
...
+ (NSString *)_stringifyMediaType:(PHAssetMediaType)mediaType
{
  switch (mediaType) {
    case PHAssetMediaTypeAudio:
      return ABI35_0_0EXAssetMediaTypeAudio;
    case PHAssetMediaTypeImage:
      return ABI35_0_0EXAssetMediaTypePhoto;
    case PHAssetMediaTypeVideo:
      return ABI35_0_0EXAssetMediaTypeVideo;
    default:
      return ABI35_0_0EXAssetMediaTypeUnknown;
  }
}

+ (PHAssetMediaType)_convertMediaType:(NSString *)mediaType
{
  if ([mediaType isEqualToString:ABI35_0_0EXAssetMediaTypeAudio]) {
    return PHAssetMediaTypeAudio;
  }
  if ([mediaType isEqualToString:ABI35_0_0EXAssetMediaTypePhoto]) {
    return PHAssetMediaTypeImage;
  }
  if ([mediaType isEqualToString:ABI35_0_0EXAssetMediaTypeVideo]) {
    return PHAssetMediaTypeVideo;
  }
  return PHAssetMediaTypeUnknown;
}
...
+ (NSMutableArray<NSNumber *> *)_convertMediaTypes:(NSArray<NSString *> *)mediaTypes
{
  ...
  [mediaTypes enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
    if ([obj isEqualToString:ABI35_0_0EXAssetMediaTypeAll]) {
      *stop = YES;
      assetTypes = nil;
      return;
    }
    PHAssetMediaType assetType = [ABI35_0_0EXMediaLibrary _convertMediaType:obj];
...
+ (NSString *)_convertSortByKey:(NSString *)key
{
  ...
  if (value == nil) {
    ...
    @throw [NSException exceptionWithName:@"ABI35_0_0EXMediaLibrary.UNSUPPORTED_SORTBY_KEY" reason:reason userInfo:nil];
  }
  return value;
}
...
+ (NSSortDescriptor *)_sortDescriptorFrom:(id)config
{
  if ([config isKindOfClass:[NSString class]]) {
    NSString *key = [ABI35_0_0EXMediaLibrary _convertSortByKey:config];
  ...
  if ([config isKindOfClass:[NSArray class]]) {
    ...
    NSString *key = [ABI35_0_0EXMediaLibrary _convertSortByKey:sortArray[0]];
...
+ (NSArray *)_prepareSortDescriptors:(NSArray *)sortBy
{
  ...
  for (id config in sortByArray) {
    NSSortDescriptor *sortDescriptor = [ABI35_0_0EXMediaLibrary _sortDescriptorFrom:config];
...
- (BOOL)_checkPermissions:(ABI35_0_0UMPromiseRejectBlock)reject
{
