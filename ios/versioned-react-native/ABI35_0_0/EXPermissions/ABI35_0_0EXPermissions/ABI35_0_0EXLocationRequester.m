...
#import <ABI35_0_0EXPermissions/ABI35_0_0EXLocationRequester.h>
...
@interface ABI35_0_0EXLocationRequester () <CLLocationManagerDelegate>
...
@implementation ABI35_0_0EXLocationRequester
...
+ (NSDictionary *)permissions
{
  ...
  if (![self isConfiguredForAlwaysAuthorization] && ![self isConfiguredForWhenInUseAuthorization]) {
    ABI35_0_0UMFatal(ABI35_0_0UMErrorWithMessage(@"This app is missing usage descriptions, so location services will fail. Add one of the `NSLocation*UsageDescription` keys to your bundle's Info.plist. See https://bit.ly/2P5fEbG (https://docs.expo.io/versions/latest/guides/app-stores.html#system-permissions-dialogs-on-ios) for more information."));
...
- (void)requestPermissionsWithResolver:(ABI35_0_0UMPromiseResolveBlock)resolve rejecter:(ABI35_0_0UMPromiseRejectBlock)reject
{
  ...
  if (existingPermissions && ![existingPermissions[@"status"] isEqualToString:[ABI35_0_0EXPermissions permissionStringForStatus:ABI35_0_0EXPermissionStatusUndetermined]]) {
