...
#import <ABI35_0_0EXPaymentsStripe/ABI35_0_0EXTPSStripeManager.h>
#import <ABI35_0_0EXPaymentsStripe/ABI35_0_0EXTPSError.h>
...
@interface ABI35_0_0EXTPSStripeManager ()
...
@implementation ABI35_0_0EXTPSStripeManager
{
    NSString *publishableKey;
    NSString *merchantId;
    NSDictionary *errorCodes;

    ABI35_0_0UMPromiseResolveBlock promiseResolver;
    ABI35_0_0UMPromiseRejectBlock promiseRejector;
...
ABI35_0_0UM_EXPORT_METHOD_AS(init, init:(NSDictionary *)options
...
ABI35_0_0UM_EXPORT_METHOD_AS(deviceSupportsApplePay, deviceSupportsApplePay:(ABI35_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI35_0_0UMPromiseRejectBlock)reject) {
    resolve(@([PKPaymentAuthorizationViewController canMakePayments]));
}

ABI35_0_0UM_EXPORT_METHOD_AS(canMakeApplePayPayments, canMakeApplePayPayments:(NSDictionary *)options
                  resolver:(ABI35_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI35_0_0UMPromiseRejectBlock)reject) {
    NSArray <NSString *> *paymentNetworksStrings =
    options[@"networks"] ?: [ABI35_0_0EXTPSStripeManager supportedPaymentNetworksStrings];
...
ABI35_0_0UM_EXPORT_METHOD_AS(completeApplePayRequest, completeApplePayRequest:(ABI35_0_0UMPromiseResolveBlock)resolve
                                 rejecter:(ABI35_0_0UMPromiseRejectBlock)reject) {
...
ABI35_0_0UM_EXPORT_METHOD_AS(cancelApplePayRequest, cancelApplePayRequest:(ABI35_0_0UMPromiseResolveBlock)resolve
                               rejecter:(ABI35_0_0UMPromiseRejectBlock)reject) {
    if (applePayCompletion) {
        promiseResolver = resolve;
...
ABI35_0_0UM_EXPORT_METHOD_AS(createTokenWithCard, createTokenWithCard:(NSDictionary *)params
                             resolver:(ABI35_0_0UMPromiseResolveBlock)resolve
                             rejecter:(ABI35_0_0UMPromiseRejectBlock)reject) {
...
ABI35_0_0UM_EXPORT_METHOD_AS(createTokenWithBankAccount, createTokenWithBankAccount:(NSDictionary *)params
                  resolver:(ABI35_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI35_0_0UMPromiseRejectBlock)reject) {
    if(!requestIsCompleted) {
        NSDictionary *error = [errorCodes valueForKey:kErrorKeyBusy];
    ...
    [ABI35_0_0EXTPSConvert holderType:params[@"accountHolderType"]];
...
ABI35_0_0UM_EXPORT_METHOD_AS(createSourceWithParams, createSourceWithParams:(NSDictionary *)params
                  resolver:(ABI35_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI35_0_0UMPromiseRejectBlock)reject) {
    if(!requestIsCompleted) {
        NSDictionary *error = [errorCodes valueForKey:kErrorKeyBusy];
...
ABI35_0_0UM_EXPORT_METHOD_AS(paymentRequestWithCardForm, paymentRequestWithCardForm:(NSDictionary *)options
                                    resolver:(ABI35_0_0UMPromiseResolveBlock)resolve
                                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject) {
    if(!requestIsCompleted) {
        NSDictionary *error = [errorCodes valueForKey:kErrorKeyBusy];
...
ABI35_0_0UM_EXPORT_METHOD_AS(paymentRequestWithApplePay, paymentRequestWithApplePay:(NSArray *)items
...
ABI35_0_0UM_EXPORT_METHOD_AS(openApplePaySetup, openApplePaySetup:(ABI35_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject) {
...
-(UIViewController*) getViewController {
  return [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI35_0_0UMUtilitiesInterface)] currentViewController];
}
...
- (BOOL)canSubmitPaymentRequest:(PKPaymentRequest *)paymentRequest rejecter:(ABI35_0_0UMPromiseRejectBlock)reject {
...
- (NSDictionary *)convertTokenObject:(STPToken*)token {
    ...
    if (token.bankAccount) {
        ...
        [ABI35_0_0EXTPSConvert STPBankAccountStatusToString:token.bankAccount.status];
        ...
        [ABI35_0_0EXTPSConvert STPBankAccountHolderTypeToString:token.bankAccount.accountHolderType];
...
- (STPTheme *)formTheme:(NSDictionary*)options {
    ...
    [theme setPrimaryBackgroundColor:[ABI35_0_0EXTPSConvert UIColor:options[@"primaryBackgroundColor"]]];
    [theme setSecondaryBackgroundColor:[ABI35_0_0EXTPSConvert UIColor:options[@"secondaryBackgroundColor"]]];
    [theme setPrimaryForegroundColor:[ABI35_0_0EXTPSConvert UIColor:options[@"primaryForegroundColor"]]];
    [theme setSecondaryForegroundColor:[ABI35_0_0EXTPSConvert UIColor:options[@"secondaryForegroundColor"]]];
    [theme setAccentColor:[ABI35_0_0EXTPSConvert UIColor:options[@"accentColor"]]];
    [theme setErrorColor:[ABI35_0_0EXTPSConvert UIColor:options[@"errorColor"]]];
    [theme setErrorColor:[ABI35_0_0EXTPSConvert UIColor:options[@"errorColor"]]];
