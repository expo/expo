...
@implementation ABI35_0_0EXTPSConvert
...
+ (NSArray *)ABI35_0_0EXConvertArrayValue:(SEL) type value:(id) json
{
  __block BOOL copy = NO;
  __block NSArray *values = json = [ABI35_0_0EXTPSConvert NSArray:json];
  [json enumerateObjectsUsingBlock:^(id jsonValue, NSUInteger idx, __unused BOOL *stop) {
    id value = [ABI35_0_0EXTPSConvert performSelector:type withObject:jsonValue];
    if (copy) {
      if (value) {
...
ABI35_0_0EX_ENUM_CONVERTER(UIKeyboardAppearance, (@{
                                           @"default": @(UIKeyboardAppearanceDefault),
                                           @"light": @(UIKeyboardAppearanceLight),
                                           @"dark": @(UIKeyboardAppearanceDark),
                                           }), UIKeyboardAppearanceDefault, integerValue)

ABI35_0_0EX_JSON_ARRAY_CONVERTER(NSArray)
ABI35_0_0EX_JSON_ARRAY_CONVERTER(NSString)
ABI35_0_0EX_JSON_ARRAY_CONVERTER_NAMED(NSArray<NSString *>, NSStringArray)
ABI35_0_0EX_JSON_ARRAY_CONVERTER(NSDictionary)
ABI35_0_0EX_JSON_ARRAY_CONVERTER(NSNumber)
