...
#import <ABI35_0_0EXSensors/ABI35_0_0EXSensorsManager.h>
#import <CoreMotion/CoreMotion.h>

@interface ABI35_0_0EXSensorsManager ()
...
@implementation ABI35_0_0EXSensorsManager

ABI35_0_0UM_REGISTER_MODULE();

+ (const NSArray<Protocol *> *)exportedInterfaces
{
  return @[@protocol(ABI35_0_0UMAccelerometerInterface), @protocol(ABI35_0_0UMBarometerInterface), @protocol(ABI35_0_0UMDeviceMotionInterface), @protocol(ABI35_0_0UMGyroscopeInterface), @protocol(ABI35_0_0UMMagnetometerInterface), @protocol(ABI35_0_0UMMagnetometerUncalibratedInterface)];
}
                                            ...
                                            withHandler:(void (^)(NSDictionary *event))handlerBlock
{
  ...
  if (![[self manager] isAccelerometerActive]) {
    ...
    __weak ABI35_0_0EXSensorsManager *weakSelf = self;
    [[self manager] startAccelerometerUpdatesToQueue:[NSOperationQueue mainQueue] withHandler:^(CMAccelerometerData *data, NSError *error) {
      __strong ABI35_0_0EXSensorsManager *strongSelf = weakSelf;
      if (strongSelf) {
...
- (void)activateDeviceMotionUpdates
{
  ...
  [[self manager] startDeviceMotionUpdatesUsingReferenceFrame:CMAttitudeReferenceFrameXArbitraryCorrectedZVertical toQueue:[NSOperationQueue mainQueue] withHandler:^(CMDeviceMotion *data, NSError *error) {
    ...
    NSDictionary *result = @{
                             @"acceleration": @{
                                 @"x": @(data.userAcceleration.x * ABI35_0_0EXGravity),
                                 @"y": @(data.userAcceleration.y * ABI35_0_0EXGravity),
                                 @"z": @(data.userAcceleration.z * ABI35_0_0EXGravity)
                                 },
                             @"accelerationIncludingGravity": @{
                                 @"x": @((data.userAcceleration.x + data.gravity.x) * ABI35_0_0EXGravity),
                                 @"y": @((data.userAcceleration.y + data.gravity.y) * ABI35_0_0EXGravity),
                                 @"z": @((data.userAcceleration.z + data.gravity.z) * ABI35_0_0EXGravity)
                                 },
                             @"rotation": @{
