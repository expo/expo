...
#import <ABI35_0_0EXSensors/ABI35_0_0EXPedometer.h>
...
NSString * const ABI35_0_0EXPedometerUpdateEventName = @"Exponent.pedometerUpdate";
NSString * const ABI35_0_0EXPedometerModuleName = @"ExponentPedometer";

@interface ABI35_0_0EXPedometer () <ABI35_0_0UMAppLifecycleListener>
...
@implementation ABI35_0_0EXPedometer
...
{
  if (self = [super init]) {
    __weak ABI35_0_0EXPedometer *weakSelf = self;
    _watchHandler = ^(CMPedometerData * _Nullable pedometerData, NSError * _Nullable error) {
      ...
      __strong ABI35_0_0EXPedometer *strongSelf = weakSelf;
      if (strongSelf) {
        __strong id<ABI35_0_0UMEventEmitterService> eventEmitter = strongSelf.eventEmitter;
        if (eventEmitter) {
          [eventEmitter sendEventWithName:ABI35_0_0EXPedometerUpdateEventName
...
{
  return ABI35_0_0EXPedometerModuleName;
}
...
{
  return @[ABI35_0_0EXPedometerUpdateEventName];
}
...
ABI35_0_0UM_EXPORT_METHOD_AS(getStepCountAsync,
