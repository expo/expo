...
#import <ABI35_0_0EXDocumentPicker/ABI35_0_0EXDocumentPickerModule.h>
...
static NSString * ABI35_0_0EXConvertMimeTypeToUTI(NSString *mimeType)
{
  CFStringRef uti;
...
@interface ABI35_0_0EXDocumentPickerModule () <UIDocumentMenuDelegate, UIDocumentPickerDelegate>
...
@implementation ABI35_0_0EXDocumentPickerModule

ABI35_0_0UM_EXPORT_MODULE(ExpoDocumentPicker);
...
ABI35_0_0UM_EXPORT_METHOD_AS(getDocumentAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSString *type = ABI35_0_0EXConvertMimeTypeToUTI(options[@"type"] ?: @"*/*");
