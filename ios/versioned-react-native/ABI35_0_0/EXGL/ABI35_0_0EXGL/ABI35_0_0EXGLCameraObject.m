...
@interface ABI35_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) id<ABI35_0_0UMCameraInterface> camera;
...
@implementation ABI35_0_0EXGLCameraObject
