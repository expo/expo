...
#import <ABI35_0_0EXAdsFacebook/ABI35_0_0EXNativeAdManager.h>
...
@interface ABI35_0_0EXNativeAdManager () <FBNativeAdsManagerDelegate>
...
@implementation ABI35_0_0EXNativeAdManager

ABI35_0_0UM_EXPORT_MODULE(CTKNativeAdManager)
...
ABI35_0_0UM_EXPORT_METHOD_AS(registerViewsForInteraction,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  [uiManager executeUIBlock:^(NSDictionary<id,UIView *> * viewRegistry) {
    ...
    if (![nativeAdView isKindOfClass:[ABI35_0_0EXNativeAdView class]]) {
      reject(@"E_INVALID_VIEW_CLASS", @"View returned for passed native ad view tag is not an instance of ABI35_0_0EXNativeAdView", nil);
      return;
    }
...
ABI35_0_0UM_EXPORT_METHOD_AS(init,
...
ABI35_0_0UM_EXPORT_METHOD_AS(setMediaCachePolicy,
...
ABI35_0_0UM_EXPORT_METHOD_AS(disableAutoRefresh,
...
- (void)nativeAdsLoaded
{
  ...
  [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI35_0_0UMEventEmitterService)] sendEventWithName:@"CTKNativeAdsManagersChanged" body:adsManagersState];
}
...
- (UIView *)view
{
  return [[ABI35_0_0EXNativeAdView alloc] initWithModuleRegistry:_moduleRegistry];
}

ABI35_0_0UM_VIEW_PROPERTY(adsManager, NSString *, ABI35_0_0EXNativeAdView)
{
