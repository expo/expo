...
#import <ABI35_0_0EXNetwork/ABI35_0_0EXNetwork.h>
...
@implementation ABI35_0_0EXNetwork
...
- (instancetype)init
{
  self = [super init];
  if (self) {
    _type = ABI35_0_0EXNetworkTypeUnknown;
  }
  return self;
}

ABI35_0_0UM_EXPORT_MODULE(ExpoNetwork);
...
ABI35_0_0UM_EXPORT_METHOD_AS(getMacAddressAsync,
...
ABI35_0_0UM_EXPORT_METHOD_AS(getIpAddressAsync,
                    getIpAddressAsyncWithResolver:(ABI35_0_0UMPromiseResolveBlock)resolve rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
...
ABI35_0_0UM_EXPORT_METHOD_AS(getNetworkStateAsync,
                    getNetworkStateAsyncWithResolver:(ABI35_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  if ((flags & kSCNetworkReachabilityFlagsReachable) == 0 ||
    ...
    _type = ABI35_0_0EXNetworkTypeNone;
  }
  
#if !TARGET_OS_TV
  else if ((flags & kSCNetworkReachabilityFlagsIsWWAN) != 0) {
    _type = ABI35_0_0EXNetworkTypeCellular;
  }
#endif
  else {
    _type = ABI35_0_0EXNetworkTypeWifi;
  }
...
- (BOOL)connected
{
  return ![self.type isEqualToString:ABI35_0_0EXNetworkTypeUnknown] && ![self.type isEqualToString:ABI35_0_0EXNetworkTypeNone];
}
