...
@interface ABI35_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI35_0_0EXBarCodeScanner *barCodeScanner;
...
@implementation ABI35_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI35_0_0UMModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI35_0_0UMAppLifecycleListener)];
...
{
  ABI35_0_0UM_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI35_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI35_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI35_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI35_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI35_0_0EXBarCodeScanner *barCodeScanner = [ABI35_0_0EXBarCodeScanner new];
