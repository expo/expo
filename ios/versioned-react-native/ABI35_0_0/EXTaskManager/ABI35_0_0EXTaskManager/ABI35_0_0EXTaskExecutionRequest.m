...
@interface ABI35_0_0EXTaskExecutionRequest ()

@property (nonatomic, strong, nullable) NSMutableSet<id<ABI35_0_0UMTaskInterface>> *tasks;
...
@implementation ABI35_0_0EXTaskExecutionRequest
...
- (void)_maybeExecuteCallback
{
  if (_callback) {
    ...
    __strong ABI35_0_0EXTaskExecutionRequest *strongSelf = self;
