...
@protocol ABI35_0_0EXTaskDelegate <NSObject>
...
@interface ABI35_0_0EXTask : NSObject <ABI35_0_0UMTaskInterface>

@property (nonatomic, strong, readonly) NSString *name;
@property (nonatomic, strong, readonly) NSString *appId;
@property (nonatomic, strong, readonly) NSString *appUrl;
@property (nonatomic, strong, readonly) id<ABI35_0_0UMTaskConsumerInterface> consumer;
@property (nonatomic, strong) NSDictionary *options;
@property (nonatomic, weak) id<ABI35_0_0EXTaskDelegate> delegate;
...
- (instancetype)initWithName:(nonnull NSString *)name
               ...
               consumerClass:(Class)consumerClass
                    ...
                    delegate:(nullable id<ABI35_0_0EXTaskDelegate>)delegate;
