...
#import <cxxReactABI35_0_0/ABI35_0_0JsArgumentHelpers.h>
             ...
             arguments:(NSArray *)arguments
{
  ...
  if (arguments.count < _method->callbacks) {
    ABI35_0_0RCTLogError(@"Method %@.%s expects at least %zu arguments, but got %tu",
  ...
  if (_method->callbacks >= 1) {
    if (![arguments[arguments.count - 1] isKindOfClass:[NSNumber class]]) {
      ABI35_0_0RCTLogError(@"Argument %tu (%@) of %@.%s should be a function",
