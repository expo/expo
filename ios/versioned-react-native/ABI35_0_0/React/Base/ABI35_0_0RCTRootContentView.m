...
@implementation ABI35_0_0RCTRootContentView

- (instancetype)initWithFrame:(CGRect)frame
                       bridge:(ABI35_0_0RCTBridge *)bridge
                     ReactABI35_0_0Tag:(NSNumber *)ReactABI35_0_0Tag
               sizeFlexiblity:(ABI35_0_0RCTRootViewSizeFlexibility)sizeFlexibility
{
  if ((self = [super initWithFrame:frame])) {
    _bridge = bridge;
    self.ReactABI35_0_0Tag = ReactABI35_0_0Tag;
    _sizeFlexibility = sizeFlexibility;
    _touchHandler = [[ABI35_0_0RCTTouchHandler alloc] initWithBridge:_bridge];
...
ABI35_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithCoder:(nonnull NSCoder *)aDecoder)
...
- (CGSize)availableSize
{
  ...
  return CGSizeMake(
      _sizeFlexibility & ABI35_0_0RCTRootViewSizeFlexibilityWidth ? INFINITY : size.width,
      _sizeFlexibility & ABI35_0_0RCTRootViewSizeFlexibilityHeight ? INFINITY : size.height
    );
}

- (void)updateAvailableSize
{
  if (!self.ReactABI35_0_0Tag || !_bridge.isValid) {
    return;
  }
...
- (void)invalidate
{
  if (self.userInteractionEnabled) {
    ...
    [(ABI35_0_0RCTRootView *)self.superview contentViewInvalidated];

    [_bridge enqueueJSCall:@"AppRegistry"
                    method:@"unmountApplicationComponentAtRootTag"
                      args:@[self.ReactABI35_0_0Tag]
                completion:NULL];
  }
}
