...
@protocol ABI35_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI35_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI35_0_0RCTBridgeModules automatically, however
 ...
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI35_0_0RCTBridge *)bridge;
...
*/
- (BOOL)bridge:(ABI35_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI35_0_0RCTBridge *)bridge
                 onProgress:(ABI35_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI35_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI35_0_0RCTBridge *)bridge
                  withBlock:(ABI35_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Retrieve the list of lazy-native-modules names for the given bridge.
 */
- (NSDictionary<NSString *, Class> *)extraLazyModuleClassesForBridge:(ABI35_0_0RCTBridge *)bridge;
