 ...
 * classes to change the ABI35_0_0RCTRootViews's internal state.
 */
@interface ABI35_0_0RCTRootView ()

/**
 * This setter should be used only by ABI35_0_0RCTUIManager on ReactABI35_0_0 root view
...
@property (nonatomic, strong) UIView *ReactABI35_0_0PreferredFocusedView;
#endif
