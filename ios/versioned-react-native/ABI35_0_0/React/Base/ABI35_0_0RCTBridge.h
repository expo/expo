...
@class ABI35_0_0RCTEventDispatcher;
@class ABI35_0_0RCTPerformanceLogger;

/**
 * This notification fires when the bridge initializes.
 */
ABI35_0_0RCT_EXTERN NSString *const ABI35_0_0RCTJavaScriptWillStartLoadingNotification;


/**
 * This notification fires when the bridge starts executing the JS bundle.
 */
ABI35_0_0RCT_EXTERN NSString *const ABI35_0_0RCTJavaScriptWillStartExecutingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI35_0_0RCT_EXTERN NSString *const ABI35_0_0RCTJavaScriptDidLoadNotification;

/**
 * This notification fires when the bridge failed to load the JS bundle. The
 * `error` key can be used to determine the error that occurred.
 */
ABI35_0_0RCT_EXTERN NSString *const ABI35_0_0RCTJavaScriptDidFailToLoadNotification;
 ...
 */
ABI35_0_0RCT_EXTERN NSString *const ABI35_0_0RCTDidInitializeModuleNotification;

/**
 * This notification fires just before the bridge starts processing a request to
 * reload.
 */
ABI35_0_0RCT_EXTERN NSString *const ABI35_0_0RCTBridgeWillReloadNotification;

/**
 * This notification fires just before the bridge begins downloading a script
 * from the packager.
 */
ABI35_0_0RCT_EXTERN NSString *const ABI35_0_0RCTBridgeWillDownloadScriptNotification;

/**
 * This notification fires just after the bridge finishes downloading a script
 * from the packager.
 */
ABI35_0_0RCT_EXTERN NSString *const ABI35_0_0RCTBridgeDidDownloadScriptNotification;

/**
 * Key for the ABI35_0_0RCTSource object in the ABI35_0_0RCTBridgeDidDownloadScriptNotification
 * userInfo dictionary.
 */
ABI35_0_0RCT_EXTERN NSString *const ABI35_0_0RCTBridgeDidDownloadScriptNotificationSourceKey;

/**
 * Key for the bridge description (NSString_ in the
 * ABI35_0_0RCTBridgeDidDownloadScriptNotification userInfo dictionary.
 */
ABI35_0_0RCT_EXTERN NSString *const ABI35_0_0RCTBridgeDidDownloadScriptNotificationBridgeDescriptionKey;
 ...
 */
typedef NSArray<id<ABI35_0_0RCTBridgeModule>> *(^ABI35_0_0RCTBridgeModuleListProvider)(void);

/**
 * This function returns the module name for a given class.
 */
ABI35_0_0RCT_EXTERN NSString *ABI35_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Experimental.
 * Check/set if JSI-bound NativeModule is enabled. By default it's off.
 */
ABI35_0_0RCT_EXTERN BOOL ABI35_0_0RCTTurboModuleEnabled(void);
ABI35_0_0RCT_EXTERN void ABI35_0_0RCTEnableTurboModule(BOOL enabled);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI35_0_0RCTBridge : NSObject <ABI35_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI35_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI35_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 */
@property (nonatomic, weak, readonly) id<ABI35_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ReactABI35_0_0 Native perf events.
 */
@property (nonatomic, readonly, strong) ABI35_0_0RCTPerformanceLogger *performanceLogger;
