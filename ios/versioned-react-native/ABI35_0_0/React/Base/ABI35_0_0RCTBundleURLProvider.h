...
extern NSString *const ABI35_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI35_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI35_0_0RCTBundleURLProvider : NSObject
