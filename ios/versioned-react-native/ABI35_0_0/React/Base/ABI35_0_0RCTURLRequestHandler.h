 ...
 * are also bridge modules, so should be registered using ABI35_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI35_0_0RCTURLRequestHandler <ABI35_0_0RCTBridgeModule>
...
/**
 * If more than one ABI35_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
