 ...
 */
@interface ABI35_0_0RCTImageSource : NSObject
...
@interface ABI35_0_0RCTConvert (ImageSource)

+ (ABI35_0_0RCTImageSource *)ABI35_0_0RCTImageSource:(id)json;
+ (NSArray<ABI35_0_0RCTImageSource *> *)ABI35_0_0RCTImageSourceArray:(id)json;
