...
@interface ABI35_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI35_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI35_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI35_0_0RCTMultipartProgressCallback _progressHandler;
...
- (instancetype)initWithURL:(NSURL *)url
                partHandler:(ABI35_0_0RCTMultipartDataTaskCallback)partHandler
            progressHandler:(ABI35_0_0RCTMultipartProgressCallback)progressHandler
{
  if (self = [super init]) {
    _url = url;
...
{
  ABI35_0_0RCTMultipartStreamReader *reader = [[ABI35_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI35_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
