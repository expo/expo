...
#import "ABI35_0_0RCTSurfaceDelegate.h"
#import "ABI35_0_0RCTSurfaceView.h"
#import "ABI35_0_0RCTUtils.h"

@interface ABI35_0_0RCTSurfaceHostingView ()
...
@implementation ABI35_0_0RCTSurfaceHostingView {
...
{
  return [[ABI35_0_0RCTSurface alloc] initWithBridge:bridge moduleName:moduleName initialProperties:initialProperties];
}
...
{
  ABI35_0_0RCTSurface *surface = [[self class] createSurfaceWithBridge:bridge moduleName:moduleName initialProperties:initialProperties];
  [surface start];
  return [self initWithSurface:surface sizeMeasureMode:sizeMeasureMode];
}

- (instancetype)initWithSurface:(ABI35_0_0RCTSurface *)surface sizeMeasureMode:(ABI35_0_0RCTSurfaceSizeMeasureMode)sizeMeasureMode
{
...
- (void)setFrame:(CGRect)frame
{
  ...
  ABI35_0_0RCTSurfaceMinimumSizeAndMaximumSizeFromSizeAndSizeMeasureMode(
    self.bounds.size,
    _sizeMeasureMode,
    &minimumSize,
    &maximumSize
...
{
  if (ABI35_0_0RCTSurfaceStageIsPreparing(_stage)) {
...
- (void)setStage:(ABI35_0_0RCTSurfaceStage)stage
{
  ...
  BOOL shouldInvalidateLayout =
    ABI35_0_0RCTSurfaceStageIsRunning(stage) != ABI35_0_0RCTSurfaceStageIsRunning(_stage) ||
    ABI35_0_0RCTSurfaceStageIsPreparing(stage) != ABI35_0_0RCTSurfaceStageIsPreparing(_stage);
...
- (void)setSizeMeasureMode:(ABI35_0_0RCTSurfaceSizeMeasureMode)sizeMeasureMode
{
...
- (void)setActivityIndicatorViewFactory:(ABI35_0_0RCTSurfaceHostingViewActivityIndicatorViewFactory)activityIndicatorViewFactory
{
...
- (void)_updateViews
{
  self.isSurfaceViewVisible = ABI35_0_0RCTSurfaceStageIsRunning(_stage);
  self.isActivityIndicatorViewVisible = ABI35_0_0RCTSurfaceStageIsPreparing(_stage);
}
...
#pragma mark - ABI35_0_0RCTSurfaceDelegate
