...
@class ABI35_0_0RCTSurfaceView;
@protocol ABI35_0_0RCTSurfaceDelegate;

/**
 * ABI35_0_0RCTSurface instance represents ReactABI35_0_0 Native-powered piece of a user interface
 * which can be a full-screen app, separate modal view controller,
 * or even small widget.
 * It is called "Surface".
 *
 * The ABI35_0_0RCTSurface instance is completely thread-safe by design;
 ...
 *
 * The primary goals of the ABI35_0_0RCTSurface are:
 ...
 */
@interface ABI35_0_0RCTSurface : NSObject

@property (atomic, readonly) ABI35_0_0RCTSurfaceStage stage;
@property (atomic, readonly) NSString *moduleName;
@property (atomic, readonly) NSNumber *rootViewTag;

@property (atomic, readwrite, weak, nullable) id<ABI35_0_0RCTSurfaceDelegate> delegate;
 ...
 * ABI35_0_0RCTSurface does not control (or influence in any way) the size or origin
...
/**
 * Simple shortcut to `-[ABI35_0_0RCTSurface setMinimumSize:size maximumSize:size]`.
 */
 ...
 *  - Calling on the main queue with `ABI35_0_0RCTSurfaceStageSurfaceDidInitialMounting`
 *    stage temporary is not supported; in this case the stage will be
 *    downgraded to `ABI35_0_0RCTSurfaceStageSurfaceDidInitialLayout`.
 */
 ...
 * Those methods are a no-op for regular ABI35_0_0RCTSurface (for now), but all call sites must call them appropriately.
 */
- (BOOL)start;
- (BOOL)stop;
...
/**
 * Mount the ReactABI35_0_0 component specified by the given moduleName. This is typically
...
/**
 * Unmount the ReactABI35_0_0 component specified by the given rootViewTag, called from native.
 */
