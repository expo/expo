...
@protocol ABI35_0_0RCTBridgeMethod;
@protocol ABI35_0_0RCTBridgeModule;
@class ABI35_0_0RCTBridge;

typedef id<ABI35_0_0RCTBridgeModule>(^ABI35_0_0RCTBridgeModuleProvider)(void);

@interface ABI35_0_0RCTModuleData : NSObject <ABI35_0_0RCTInvalidating>

- (instancetype)initWithModuleClass:(Class)moduleClass
                             bridge:(ABI35_0_0RCTBridge *)bridge;

- (instancetype)initWithModuleClass:(Class)moduleClass
                     moduleProvider:(ABI35_0_0RCTBridgeModuleProvider)moduleProvider
                             bridge:(ABI35_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;

- (instancetype)initWithModuleInstance:(id<ABI35_0_0RCTBridgeModule>)instance
                                bridge:(ABI35_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI35_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readwrite) id<ABI35_0_0RCTBridgeModule> instance;
