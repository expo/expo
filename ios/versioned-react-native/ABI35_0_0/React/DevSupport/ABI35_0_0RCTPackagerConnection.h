...
@class ABI35_0_0RCTPackagerClientResponder;

typedef uint32_t ABI35_0_0RCTHandlerToken;
typedef void (^ABI35_0_0RCTNotificationHandler)(NSDictionary<NSString *, id> *);
typedef void (^ABI35_0_0RCTRequestHandler)(NSDictionary<NSString *, id> *, ABI35_0_0RCTPackagerClientResponder *);
typedef void (^ABI35_0_0RCTConnectedHandler)(void);

/** Encapsulates singleton connection to ReactABI35_0_0 Native packager. */
@interface ABI35_0_0RCTPackagerConnection : NSObject
 ...
 */
- (ABI35_0_0RCTHandlerToken)addNotificationHandler:(ABI35_0_0RCTNotificationHandler)handler
 ...
 */
- (ABI35_0_0RCTHandlerToken)addRequestHandler:(ABI35_0_0RCTRequestHandler)handler
                               queue:(dispatch_queue_t)queue
                           forMethod:(NSString *)method;
 ...
 */
- (ABI35_0_0RCTHandlerToken)addConnectedHandler:(ABI35_0_0RCTConnectedHandler)handler
                                 queue:(dispatch_queue_t)queue;
 ...
 */
- (void)addHandler:(id<ABI35_0_0RCTPackagerClientMethod>)handler
