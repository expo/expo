...
@class ABI35_0_0RCTSurfacePresenter;
@protocol ABI35_0_0RCTSurfaceDelegate;

/**
 * (This is Fabric-compatible ABI35_0_0RCTSurface implementation.)
 *
 ...
 * The starting process includes initializing all underlying ReactABI35_0_0 Native
 * infrastructure and running ReactABI35_0_0 app.
...
@interface ABI35_0_0RCTFabricSurface (Internal)
...
@interface ABI35_0_0RCTFabricSurface (Deprecated)
