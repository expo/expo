...
#import <ReactABI35_0_0/components/view/primitives.h>
#import <ReactABI35_0_0/components/view/AccessibilityPrimitives.h>
#import <ReactABI35_0_0/graphics/Color.h>
#import <ReactABI35_0_0/graphics/Geometry.h>

NS_ASSUME_NONNULL_BEGIN

inline NSString *ABI35_0_0RCTNSStringFromString(const std::string &string, const NSStringEncoding &encoding = NSUTF8StringEncoding) {
  return [NSString stringWithCString:string.c_str() encoding:encoding];
}

inline NSString *_Nullable ABI35_0_0RCTNSStringFromStringNilIfEmpty(const std::string &string, const NSStringEncoding &encoding = NSUTF8StringEncoding) {
  return string.empty() ? nil : ABI35_0_0RCTNSStringFromString(string, encoding);
}

inline std::string ABI35_0_0RCTStringFromNSString(NSString *string, const NSStringEncoding &encoding = NSUTF8StringEncoding) {
  return [string cStringUsingEncoding:encoding];
}

inline UIColor *_Nullable ABI35_0_0RCTUIColorFromSharedColor(const facebook::ReactABI35_0_0::SharedColor &sharedColor) {
  return sharedColor ? [UIColor colorWithCGColor:sharedColor.get()] : nil;
}

inline CGColorRef ABI35_0_0RCTCGColorRefFromSharedColor(const facebook::ReactABI35_0_0::SharedColor &sharedColor) {
  return sharedColor ? CGColorCreateCopy(sharedColor.get()) : nil;
}

inline CGPoint ABI35_0_0RCTCGPointFromPoint(const facebook::ReactABI35_0_0::Point &point) {
  return {point.x, point.y};
}

inline CGSize ABI35_0_0RCTCGSizeFromSize(const facebook::ReactABI35_0_0::Size &size) {
  return {size.width, size.height};
}

inline CGRect ABI35_0_0RCTCGRectFromRect(const facebook::ReactABI35_0_0::Rect &rect) {
  return {ABI35_0_0RCTCGPointFromPoint(rect.origin), ABI35_0_0RCTCGSizeFromSize(rect.size)};
}

inline UIEdgeInsets ABI35_0_0RCTUIEdgeInsetsFromEdgeInsets(const facebook::ReactABI35_0_0::EdgeInsets &edgeInsets) {
  return {edgeInsets.top, edgeInsets.left, edgeInsets.bottom, edgeInsets.right};
}

inline UIAccessibilityTraits ABI35_0_0RCTUIAccessibilityTraitsFromAccessibilityTraits(facebook::ReactABI35_0_0::AccessibilityTraits accessibilityTraits) {
  using AccessibilityTraits = facebook::ReactABI35_0_0::AccessibilityTraits;
...
inline CATransform3D ABI35_0_0RCTCATransform3DFromTransformMatrix(const facebook::ReactABI35_0_0::Transform &transformMatrix) {
  return {
...
inline facebook::ReactABI35_0_0::Point ABI35_0_0RCTPointFromCGPoint(const CGPoint &point) {
  return {point.x, point.y};
}

inline facebook::ReactABI35_0_0::Size ABI35_0_0RCTSizeFromCGSize(const CGSize &size) {
  return {size.width, size.height};
}

inline facebook::ReactABI35_0_0::Rect ABI35_0_0RCTRectFromCGRect(const CGRect &rect) {
  return {ABI35_0_0RCTPointFromCGPoint(rect.origin), ABI35_0_0RCTSizeFromCGSize(rect.size)};
}

inline facebook::ReactABI35_0_0::EdgeInsets ABI35_0_0RCTEdgeInsetsFromUIEdgeInsets(const UIEdgeInsets &edgeInsets) {
  return {edgeInsets.top, edgeInsets.left, edgeInsets.bottom, edgeInsets.right};
}
