...
#import <ReactABI35_0_0/components/text/ParagraphLocalData.h>
#import <ReactABI35_0_0/components/text/ParagraphProps.h>
#import <ReactABI35_0_0/components/text/ParagraphShadowNode.h>
#import <ReactABI35_0_0/core/LocalData.h>
#import <ReactABI35_0_0/graphics/Geometry.h>
#import <ReactABI35_0_0/textlayoutmanager/TextLayoutManager.h>
#import <ReactABI35_0_0/textlayoutmanager/ABI35_0_0RCTTextLayoutManager.h>
#import "ABI35_0_0RCTConversions.h"

using namespace facebook::ReactABI35_0_0;

@implementation ABI35_0_0RCTParagraphComponentView {
...
- (void)drawRect:(CGRect)rect
{
  ...
  ABI35_0_0RCTTextLayoutManager *nativeTextLayoutManager =
    (__bridge ABI35_0_0RCTTextLayoutManager *)textLayoutManager->getNativeTextLayoutManager();

  CGRect frame = ABI35_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
...
- (NSString *)accessibilityLabel
{
  NSString *superAccessibilityLabel =
    ABI35_0_0RCTNSStringFromStringNilIfEmpty(_props->accessibilityLabel);
  ...
  return ABI35_0_0RCTNSStringFromString(_paragraphLocalData->getAttributedString().getString());
}
...
- (SharedTouchEventEmitter)touchEventEmitterAtPoint:(CGPoint)point
{
  ...
  ABI35_0_0RCTTextLayoutManager *nativeTextLayoutManager = (__bridge ABI35_0_0RCTTextLayoutManager *)textLayoutManager->getNativeTextLayoutManager();
  CGRect frame = ABI35_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
