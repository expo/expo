...
#import <ReactABI35_0_0/components/slider/SliderEventEmitter.h>
#import <ReactABI35_0_0/components/slider/SliderProps.h>
#import <ReactABI35_0_0/components/slider/SliderShadowNode.h>
#import <ReactABI35_0_0/components/slider/SliderLocalData.h>
...
@implementation ABI35_0_0RCTSliderComponentView {
  ...
  std::unique_ptr<ABI35_0_0RCTImageResponseObserverProxy> _trackImageResponseObserverProxy;
  std::unique_ptr<ABI35_0_0RCTImageResponseObserverProxy> _minimumTrackImageResponseObserverProxy;
  std::unique_ptr<ABI35_0_0RCTImageResponseObserverProxy> _maximumTrackImageResponseObserverProxy;
  std::unique_ptr<ABI35_0_0RCTImageResponseObserverProxy> _thumbImageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _trackImageResponseObserverProxy = std::make_unique<ABI35_0_0RCTImageResponseObserverProxy>((__bridge void *)self);
    _minimumTrackImageResponseObserverProxy = std::make_unique<ABI35_0_0RCTImageResponseObserverProxy>((__bridge void *)self);
    _maximumTrackImageResponseObserverProxy = std::make_unique<ABI35_0_0RCTImageResponseObserverProxy>((__bridge void *)self);
    _thumbImageResponseObserverProxy = std::make_unique<ABI35_0_0RCTImageResponseObserverProxy>((__bridge void *)self);
