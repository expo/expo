...
#import <ReactABI35_0_0/components/image/ImageEventEmitter.h>
#import <ReactABI35_0_0/components/image/ImageLocalData.h>
#import <ReactABI35_0_0/components/image/ImageProps.h>
#import <ReactABI35_0_0/components/image/ImageShadowNode.h>
#import <ReactABI35_0_0/imagemanager/ImageRequest.h>
#import <ReactABI35_0_0/imagemanager/ABI35_0_0RCTImagePrimitivesConversions.h>
#import <ReactABI35_0_0/ABI35_0_0RCTImageResponseObserverProxy.h>

#import "ABI35_0_0RCTConversions.h"
#import "ABI35_0_0MainQueueExecutor.h"

@implementation ABI35_0_0RCTImageComponentView {
  UIImageView *_imageView;
  SharedImageLocalData _imageLocalData;
  const ImageResponseObserverCoordinator *_coordinator;
  std::unique_ptr<ABI35_0_0RCTImageResponseObserverProxy> _imageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _imageView.contentMode = (UIViewContentMode)ABI35_0_0RCTResizeModeFromImageResizeMode(defaultProps->resizeMode);
      
    _imageResponseObserverProxy = std::make_unique<ABI35_0_0RCTImageResponseObserverProxy>((__bridge void *)self);
...
- (void)updateProps:(SharedProps)props oldProps:(SharedProps)oldProps
{
  ...
  if (oldImageProps.resizeMode != newImageProps.resizeMode) {
    if (newImageProps.resizeMode == ImageResizeMode::Repeat) {
      ...
      _imageView.contentMode = (UIViewContentMode)ABI35_0_0RCTResizeModeFromImageResizeMode(newImageProps.resizeMode);
    }
  }
...
#pragma mark - ABI35_0_0RCTImageResponseDelegate
...
- (void)didReceiveImage:(UIImage *)image fromObserver:(void*)observer
{
  ...
  if (imageProps.resizeMode == ImageResizeMode::Repeat) {
    image = [image resizableImageWithCapInsets:ABI35_0_0RCTUIEdgeInsetsFromEdgeInsets(imageProps.capInsets)
