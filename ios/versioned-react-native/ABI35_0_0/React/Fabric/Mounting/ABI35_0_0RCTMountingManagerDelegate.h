 ...
 */
@protocol ABI35_0_0RCTMountingManagerDelegate <NSObject>
 ...
 */
- (void)mountingManager:(ABI35_0_0RCTMountingManager *)mountingManager willMountComponentsWithRootTag:(ReactABI35_0_0Tag)MountingManager;
