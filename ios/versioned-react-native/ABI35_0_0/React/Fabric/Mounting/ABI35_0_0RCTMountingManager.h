...
#import <ReactABI35_0_0/mounting/ShadowView.h>
 ...
 */
@interface ABI35_0_0RCTMountingManager : NSObject

@property (nonatomic, weak) id<ABI35_0_0RCTMountingManagerDelegate> delegate;
@property (nonatomic, strong) ABI35_0_0RCTComponentViewRegistry *componentViewRegistry;
