...
@implementation ABI35_0_0RCTRemoveMountItem {
  ReactABI35_0_0Tag _childTag;
  ReactABI35_0_0Tag _parentTag;
  NSInteger _index;
}
...
{
  UIView<ABI35_0_0RCTComponentViewProtocol> *childComponentView = [registry componentViewByTag:_childTag];
  UIView<ABI35_0_0RCTComponentViewProtocol> *parentComponentView = [registry componentViewByTag:_parentTag];
