...
NSString *const ABI35_0_0RCTTVNavigationEventNotification = @"ABI35_0_0RCTTVNavigationEventNotification";

static NSString *const TVNavigationEventName = @"onHWKeyEvent";

@implementation ABI35_0_0RCTTVNavigationEventEmitter
  ...
  if (self = [super init]) {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(handleTVNavigationEventNotification:)
                                                 name:ABI35_0_0RCTTVNavigationEventNotification
                                               object:nil];
