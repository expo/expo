...
@implementation ABI35_0_0RCTUIManagerObserverCoordinator {
  NSHashTable<id<ABI35_0_0RCTUIManagerObserver>> *_observers;
  std::mutex _mutex;
}
...
- (void)uiManagerWillPerformLayout:(ABI35_0_0RCTUIManager *)manager
{
  ...
  for (id<ABI35_0_0RCTUIManagerObserver> observer in _observers) {
