...
@protocol ABI35_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI35_0_0RCTExceptionsManager : NSObject <ABI35_0_0RCTBridgeModule>
...
@property (nonatomic, weak) id<ABI35_0_0RCTExceptionsManagerDelegate> delegate;
