...
@interface ABI35_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI35_0_0RCTRedBoxExtraDataCell
...
@interface ABI35_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI35_0_0RCTRedBoxExtraDataViewController
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ABI35_0_0RCTRedBoxExtraDataCell *cell =
            (ABI35_0_0RCTRedBoxExtraDataCell *)[tableView
            dequeueReusableCellWithIdentifier:reuseIdentifier];

    if (cell == nil) {
        cell = [[ABI35_0_0RCTRedBoxExtraDataCell alloc]
