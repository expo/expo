...
typedef UIFont *(^ABI35_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ReactABI35_0_0 Native will use the System font for rendering by default. If you want to
 ...
 */
ABI35_0_0RCT_EXTERN void ABI35_0_0RCTSetDefaultFontHandler(ABI35_0_0RCTFontHandler handler);
ABI35_0_0RCT_EXTERN BOOL ABI35_0_0RCTHasFontHandlerSet(void);

@interface ABI35_0_0RCTFont : NSObject
...
@interface ABI35_0_0RCTConvert (ABI35_0_0RCTFont)
