...
@interface ABI35_0_0RCTScrollEvent : NSObject <ABI35_0_0RCTEvent>
...
@implementation ABI35_0_0RCTScrollEvent
{
...
{
  ABI35_0_0RCTAssertParam(ReactABI35_0_0Tag);
...
- (ABI35_0_0RCTScrollEvent *)coalesceWithEvent:(ABI35_0_0RCTScrollEvent *)newEvent
{
...
{
  return @"ABI35_0_0RCTEventEmitter.receiveEvent";
}

- (NSArray *)arguments
{
  return @[self.viewTag, ABI35_0_0RCTNormalizeInputEventName(self.eventName), [self body]];
}
 ...
 */
@interface ABI35_0_0RCTCustomScrollView : UIScrollView<UIGestureRecognizerDelegate>

@property (nonatomic, assign) BOOL centerContent;
#if !TARGET_OS_TV
@property (nonatomic, strong) UIView<ABI35_0_0RCTCustomRefreshContolProtocol> *customRefreshControl;
...
@implementation ABI35_0_0RCTCustomScrollView
...
- (UIView *)contentView
{
  return ((ABI35_0_0RCTScrollView *)self.superview).contentView;
}
...
- (BOOL)_shouldDisableScrollInteraction
{
  ...
  UIView *JSResponder = [ABI35_0_0RCTUIManager JSResponder];
...
{
  if ([self _shouldDisableScrollInteraction] && ![[ABI35_0_0RCTUIManager JSResponder] isKindOfClass:[ABI35_0_0RCTScrollView class]]) {
 ...
 * touch started inside of a `UIControl` (`UIButton` etc). For ReactABI35_0_0 scroll
...
- (void)setContentOffset:(CGPoint)contentOffset
{
  ...
  super.contentOffset = CGPointMake(
    ABI35_0_0RCTSanitizeNaNValue(contentOffset.x, @"scrollView.contentOffset.x"),
    ABI35_0_0RCTSanitizeNaNValue(contentOffset.y, @"scrollView.contentOffset.y"));
}
...
#if !TARGET_OS_TV
- (void)setCustomRefreshControl:(UIView<ABI35_0_0RCTCustomRefreshContolProtocol> *)refreshControl
{
...
@interface ABI35_0_0RCTScrollView () <ABI35_0_0RCTUIManagerObserver>

@end

@implementation ABI35_0_0RCTScrollView
{
  ABI35_0_0RCTEventDispatcher *_eventDispatcher;
  CGRect _prevFirstVisibleFrame;
  __weak UIView *_firstVisibleView;
  ABI35_0_0RCTCustomScrollView *_scrollView;
  UIView *_contentView;
...
- (instancetype)initWithEventDispatcher:(ABI35_0_0RCTEventDispatcher *)eventDispatcher
{
  ABI35_0_0RCTAssertParam(eventDispatcher);

  if ((self = [super initWithFrame:CGRectZero])) {
    _eventDispatcher = eventDispatcher;

    _scrollView = [[ABI35_0_0RCTCustomScrollView alloc] initWithFrame:CGRectZero];
...
static inline void ABI35_0_0RCTApplyTransformationAccordingLayoutDirection(UIView *view, UIUserInterfaceLayoutDirection layoutDirection) {
  view.transform =
...
{
  [super setReactABI35_0_0LayoutDirection:layoutDirection];

  ABI35_0_0RCTApplyTransformationAccordingLayoutDirection(_scrollView, layoutDirection);
  ABI35_0_0RCTApplyTransformationAccordingLayoutDirection(_contentView, layoutDirection);
}
...
- (void)insertReactABI35_0_0Subview:(UIView *)view atIndex:(NSInteger)atIndex
{
  [super insertReactABI35_0_0Subview:view atIndex:atIndex];
#if !TARGET_OS_TV
  if ([view conformsToProtocol:@protocol(ABI35_0_0RCTCustomRefreshContolProtocol)]) {
    [_scrollView setCustomRefreshControl:(UIView<ABI35_0_0RCTCustomRefreshContolProtocol> *)view];
...
#endif
  {
    ABI35_0_0RCTAssert(_contentView == nil, @"ABI35_0_0RCTScrollView may only contain a single subview");
    _contentView = view;
    ABI35_0_0RCTApplyTransformationAccordingLayoutDirection(_contentView, self.ReactABI35_0_0LayoutDirection);
...
#if !TARGET_OS_TV
  if ([subview conformsToProtocol:@protocol(ABI35_0_0RCTCustomRefreshContolProtocol)]) {
...
#endif
  {
    ABI35_0_0RCTAssert(_contentView == subview, @"Attempted to remove non-existent subview");
    _contentView = nil;
  }
}
...
- (void)layoutSubviews
{
  ...
  ABI35_0_0RCTAssert(self.subviews.count == 1, @"we should only have exactly one subview");
  ABI35_0_0RCTAssert([self.subviews lastObject] == _scrollView, @"our only subview should be a scrollview");

#if !TARGET_OS_TV
  // Adjust the refresh control frame if the scrollview layout changes.
  UIView<ABI35_0_0RCTCustomRefreshContolProtocol> *refreshControl = _scrollView.customRefreshControl;
...
- (void)updateClippedSubviews
{
  ...
  UIView *clipView = [self ReactABI35_0_0_findClipView];
  if (!clipView) {
    return;
  }
  ...
  if (shouldClipAgain) {
    ...
    [self ReactABI35_0_0_updateClippedSubviewsWithClipRect:clipRect relativeToView:clipView];
...
- (void)setContentInset:(UIEdgeInsets)contentInset
{
  ...
  [ABI35_0_0RCTView autoAdjustInsetsForView:self
...
#define ABI35_0_0RCT_SEND_SCROLL_EVENT(_eventName, _userData) { \
...
#define ABI35_0_0RCT_FORWARD_SCROLL_EVENT(call) \
...
#define ABI35_0_0RCT_SCROLL_EVENT_HANDLER(delegateMethod, eventName) \
- (void)delegateMethod:(UIScrollView *)scrollView           \
{                                                           \
  ABI35_0_0RCT_SEND_SCROLL_EVENT(eventName, nil);                    \
  ABI35_0_0RCT_FORWARD_SCROLL_EVENT(delegateMethod:scrollView);      \
}

ABI35_0_0RCT_SCROLL_EVENT_HANDLER(scrollViewWillBeginDecelerating, onMomentumScrollBegin)
ABI35_0_0RCT_SCROLL_EVENT_HANDLER(scrollViewDidZoom, onScroll)
ABI35_0_0RCT_SCROLL_EVENT_HANDLER(scrollViewDidScrollToTop, onScrollToTop)
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
  ...
  if (_allowNextScrollNoMatterWhat ||
    ...
    if (_DEPRECATED_sendUpdatedChildFrames) {
      ...
      ABI35_0_0RCT_SEND_SCROLL_EVENT(onScroll, (@{@"updatedChildFrames": [self calculateChildFramesData]}));
    } else {
      ABI35_0_0RCT_SEND_SCROLL_EVENT(onScroll, nil);
    }
  ...
  ABI35_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewDidScroll:scrollView);
}

- (NSArray<NSDictionary *> *)calculateChildFramesData
{
    NSMutableArray<NSDictionary *> *updatedChildFrames = [NSMutableArray new];
    [[_contentView ReactABI35_0_0Subviews] enumerateObjectsUsingBlock:
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView
{
  ...
  ABI35_0_0RCT_SEND_SCROLL_EVENT(onScrollBeginDrag, nil);
  ABI35_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewWillBeginDragging:scrollView);
}
...
- (void)scrollViewWillEndDragging:(UIScrollView *)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(inout CGPoint *)targetContentOffset
{
  ...
  ABI35_0_0RCT_SEND_SCROLL_EVENT(onScrollEndDrag, userData);
  ABI35_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewWillEndDragging:scrollView withVelocity:velocity targetContentOffset:targetContentOffset);
}

- (void)scrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate
{
  ABI35_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewDidEndDragging:scrollView willDecelerate:decelerate);
}

- (void)scrollViewWillBeginZooming:(UIScrollView *)scrollView withView:(UIView *)view
{
  ABI35_0_0RCT_SEND_SCROLL_EVENT(onScrollBeginDrag, nil);
  ABI35_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewWillBeginZooming:scrollView withView:view);
}

- (void)scrollViewDidEndZooming:(UIScrollView *)scrollView withView:(UIView *)view atScale:(CGFloat)scale
{
  ABI35_0_0RCT_SEND_SCROLL_EVENT(onScrollEndDrag, nil);
  ABI35_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewDidEndZooming:scrollView withView:view atScale:scale);
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
  ...
  ABI35_0_0RCT_SEND_SCROLL_EVENT(onMomentumScrollEnd, nil);
  ABI35_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewDidEndDecelerating:scrollView);
}
...
- (void)scrollViewDidEndScrollingAnimation:(UIScrollView *)scrollView
{
  ...
  // Fire the end deceleration event
  ABI35_0_0RCT_SEND_SCROLL_EVENT(onMomentumScrollEnd, nil);
  ABI35_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewDidEndScrollingAnimation:scrollView);
}
...
- (CGSize)_calculateViewportSize
{
  ...
  if (_automaticallyAdjustContentInsets) {
    UIEdgeInsets contentInsets = [ABI35_0_0RCTView contentInsetsForView:self];
...
- (void)uiManagerWillPerformMounting:(ABI35_0_0RCTUIManager *)manager
{
  ...
  [manager prependUIBlock:^(ABI35_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
...
#define ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setter, getter, type) \
...
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setAlwaysBounceHorizontal, alwaysBounceHorizontal, BOOL)
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setAlwaysBounceVertical, alwaysBounceVertical, BOOL)
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setBounces, bounces, BOOL)
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setBouncesZoom, bouncesZoom, BOOL)
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setCanCancelContentTouches, canCancelContentTouches, BOOL)
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setDecelerationRate, decelerationRate, CGFloat)
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setDirectionalLockEnabled, isDirectionalLockEnabled, BOOL)
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setIndicatorStyle, indicatorStyle, UIScrollViewIndicatorStyle)
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setKeyboardDismissMode, keyboardDismissMode, UIScrollViewKeyboardDismissMode)
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setMaximumZoomScale, maximumZoomScale, CGFloat)
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setMinimumZoomScale, minimumZoomScale, CGFloat)
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setScrollEnabled, isScrollEnabled, BOOL)
#if !TARGET_OS_TV
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setPagingEnabled, isPagingEnabled, BOOL)
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setScrollsToTop, scrollsToTop, BOOL)
#endif
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setShowsHorizontalScrollIndicator, showsHorizontalScrollIndicator, BOOL)
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setShowsVerticalScrollIndicator, showsVerticalScrollIndicator, BOOL)
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setZoomScale, zoomScale, CGFloat);
ABI35_0_0RCT_SET_AND_PRESERVE_OFFSET(setScrollIndicatorInsets, scrollIndicatorInsets, UIEdgeInsets);
                       ...
                       userData:(NSDictionary *)userData
{
  ...
  ABI35_0_0RCTScrollEvent *scrollEvent = [[ABI35_0_0RCTScrollEvent alloc] initWithEventName:eventName
                                                                 ReactABI35_0_0Tag:self.ReactABI35_0_0Tag
...
@implementation ABI35_0_0RCTEventDispatcher (ABI35_0_0RCTScrollView)

- (void)sendFakeScrollEvent:(NSNumber *)ReactABI35_0_0Tag
{
  ...
  ABI35_0_0RCTScrollEvent *fakeScrollEvent = [[ABI35_0_0RCTScrollEvent alloc] initWithEventName:eventName
                                                                     ReactABI35_0_0Tag:ReactABI35_0_0Tag
