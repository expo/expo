...
/**
 * Contains any methods related to scrolling. Any `ABI35_0_0RCTView` that has scrolling
 * features should implement these methods.
 */
@protocol ABI35_0_0RCTScrollableProtocol
 ...
 */
@protocol ABI35_0_0RCTCustomRefreshContolProtocol
