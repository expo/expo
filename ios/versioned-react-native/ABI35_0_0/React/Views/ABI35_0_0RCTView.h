...
@protocol ABI35_0_0RCTAutoInsetsProtocol;

@class ABI35_0_0RCTView;

@interface ABI35_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI35_0_0RCTDirectEventBlock onAccessibilityAction;
@property (nonatomic, copy) ABI35_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI35_0_0RCTDirectEventBlock onMagicTap;
@property (nonatomic, copy) ABI35_0_0RCTDirectEventBlock onAccessibilityEscape;
 ...
 */
@property (nonatomic, assign) ABI35_0_0RCTPointerEvents pointerEvents;
 ...
 * This is inherited from UIView+ReactABI35_0_0, but we override it here
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI35_0_0RCTBorderStyle borderStyle;
