...
@implementation ABI35_0_0RCTSafeAreaView {
...
{
  UIViewController* vc = self.ReactABI35_0_0ViewController;
...
{
  if (UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI35_0_0RCTScreenScale())) {
    return;
  }

  _currentSafeAreaInsets = safeAreaInsets;

  ABI35_0_0RCTSafeAreaViewLocalData *localData = [[ABI35_0_0RCTSafeAreaViewLocalData alloc] initWithInsets:safeAreaInsets];
