...
static const CGFloat ABI35_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI35_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return
  ABS(borderInsets.left - borderInsets.right) < ABI35_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.bottom) < ABI35_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.top) < ABI35_0_0RCTViewBorderThreshold;
}

BOOL ABI35_0_0RCTCornerRadiiAreEqual(ABI35_0_0RCTCornerRadii cornerRadii)
{
  return
  ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI35_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI35_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI35_0_0RCTViewBorderThreshold;
}

BOOL ABI35_0_0RCTBorderColorsAreEqual(ABI35_0_0RCTBorderColors borderColors)
{
  return
...
ABI35_0_0RCTCornerInsets ABI35_0_0RCTGetCornerInsets(ABI35_0_0RCTCornerRadii cornerRadii,
                                   UIEdgeInsets edgeInsets)
{
  return (ABI35_0_0RCTCornerInsets) {
    {
...
static UIEdgeInsets ABI35_0_0RCTRoundInsetsToPixel(UIEdgeInsets edgeInsets) {
    edgeInsets.top = ABI35_0_0RCTRoundPixelValue(edgeInsets.top);
    edgeInsets.bottom = ABI35_0_0RCTRoundPixelValue(edgeInsets.bottom);
    edgeInsets.left = ABI35_0_0RCTRoundPixelValue(edgeInsets.left);
    edgeInsets.right = ABI35_0_0RCTRoundPixelValue(edgeInsets.right);

    return edgeInsets;
}

static void ABI35_0_0RCTPathAddEllipticArc(CGMutablePathRef path,
...
CGPathRef ABI35_0_0RCTPathCreateWithRoundedRect(CGRect bounds,
                                       ...
                                       const CGAffineTransform *transform)
{
  ...
  ABI35_0_0RCTPathAddEllipticArc(path, transform, (CGPoint){
...
static void ABI35_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds,
                                               CGPoint lineStart,
                                               CGPoint lineEnd,
...
NS_INLINE BOOL ABI35_0_0RCTCornerRadiiAreAboveThreshold(ABI35_0_0RCTCornerRadii cornerRadii) {
  return (cornerRadii.topLeft > ABI35_0_0RCTViewBorderThreshold ||
    cornerRadii.topRight > ABI35_0_0RCTViewBorderThreshold      ||
    cornerRadii.bottomLeft > ABI35_0_0RCTViewBorderThreshold    ||
    cornerRadii.bottomRight > ABI35_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI35_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI35_0_0RCTCornerRadii cornerRadii) {
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI35_0_0RCTPathCreateWithRoundedRect(rect, ABI35_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef ABI35_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge) {
...
static UIImage *ABI35_0_0RCTGetSolidBorderImage(ABI35_0_0RCTCornerRadii cornerRadii,
                                       CGSize viewSize,
                                       ...
                                       BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI35_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI35_0_0RCTCornerInsets cornerInsets = ABI35_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  borderInsets = ABI35_0_0RCTRoundInsetsToPixel(borderInsets);
  ...
  CGContextRef ctx = ABI35_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI35_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI35_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI35_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI35_0_0RCTEllipseGetIntersectionsWithLine((CGRect){
...
static UIImage *ABI35_0_0RCTGetDashedOrDottedBorderImage(ABI35_0_0RCTBorderStyle borderStyle,
                                                ...
                                                BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI35_0_0RCTBorderStyleDashed || borderStyle == ABI35_0_0RCTBorderStyleDotted);

  if (!ABI35_0_0RCTBorderColorsAreEqual(borderColors) || !ABI35_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI35_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI35_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI35_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI35_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI35_0_0RCTPathCreateWithRoundedRect(pathRect, ABI35_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI35_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
...
UIImage *ABI35_0_0RCTGetBorderImage(ABI35_0_0RCTBorderStyle borderStyle,
                           CGSize viewSize,
                           ABI35_0_0RCTCornerRadii cornerRadii,
                           UIEdgeInsets borderInsets,
                           ABI35_0_0RCTBorderColors borderColors,
                           ...
                           BOOL drawToEdge)
{
  ...
  switch (borderStyle) {
    case ABI35_0_0RCTBorderStyleSolid:
      return ABI35_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI35_0_0RCTBorderStyleDashed:
    case ABI35_0_0RCTBorderStyleDotted:
      return ABI35_0_0RCTGetDashedOrDottedBorderImage(borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI35_0_0RCTBorderStyleUnset:
      break;
  }
