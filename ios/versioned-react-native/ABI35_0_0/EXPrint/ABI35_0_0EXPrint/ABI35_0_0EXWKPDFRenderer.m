...
#import <ABI35_0_0EXPrint/ABI35_0_0EXWKSnapshotPDFRenderer.h>
#import <ABI35_0_0EXPrint/ABI35_0_0EXWKViewPDFRenderer.h>

@interface ABI35_0_0EXWKPDFRenderer () <WKNavigationDelegate>

@property (nonatomic, assign) CGSize pageSize;
@property (nonatomic, strong) WKWebView *webView;
@property (nonatomic, strong) id<ABI35_0_0EXPDFRenderer> renderer;
...
@implementation ABI35_0_0EXWKPDFRenderer
...
- (void)PDFWithHtml:(NSString *)htmlString pageSize:(CGSize)pageSize completionHandler:(void (^)(NSError * _Nullable, NSData * _Nullable, int))handler
{
  ...
  if (@available(iOS 11.0, *)) {
    _renderer = [[ABI35_0_0EXWKSnapshotPDFRenderer alloc] init];
  } else {
    _renderer = [[ABI35_0_0EXWKViewPDFRenderer alloc] init];
  }
