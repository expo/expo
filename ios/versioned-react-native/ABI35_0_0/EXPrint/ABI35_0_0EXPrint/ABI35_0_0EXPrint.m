...
#import <ABI35_0_0EXPrint/ABI35_0_0EXPrint.h>
#import <ABI35_0_0EXPrint/ABI35_0_0EXWKPDFRenderer.h>
...
NSString *const ABI35_0_0EXPrintOrientationPortrait = @"portrait";
NSString *const ABI35_0_0EXPrintOrientationLandscape = @"landscape";

@interface ABI35_0_0EXPrint () <UIPrintInteractionControllerDelegate, UIPrinterPickerControllerDelegate>
...
@implementation ABI35_0_0EXPrint

ABI35_0_0UM_EXPORT_MODULE(ExponentPrint);
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"Orientation": @{
               @"portrait": ABI35_0_0EXPrintOrientationPortrait,
               @"landscape": ABI35_0_0EXPrintOrientationLandscape,
               },
           };
}

ABI35_0_0UM_EXPORT_METHOD_AS(print,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  [self _getPrintingDataForOptions:options callback:^(NSData *printingData, NSDictionary *errorDetails) {
    if (errorDetails != nil) {
      reject(errorDetails[@"code"], errorDetails[@"message"], ABI35_0_0UMErrorWithMessage(errorDetails[@"message"]));
      return;
    }
    ...
    if (printingData == nil) {
      ...
      if (options[@"markupFormatterIOS"] && [options[@"markupFormatterIOS"] isKindOfClass:[NSString class]]) {
        ...
        if (htmlString != nil) {
          ...
          reject(@"E_HTML_INVALID", message, ABI35_0_0UMErrorWithMessage(message));
          return;
        }
      } else {
...
ABI35_0_0UM_EXPORT_METHOD_AS(selectPrinter,selectPrinter:(ABI35_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
...
ABI35_0_0UM_EXPORT_METHOD_AS(printToFileAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI35_0_0EXWKPDFRenderer *renderTask = [ABI35_0_0EXWKPDFRenderer new];
...
{
  id<ABI35_0_0UMUtilitiesInterface> utils = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI35_0_0UMUtilitiesInterface)];
...
{
  if ([orientation isEqualToString:ABI35_0_0EXPrintOrientationLandscape]) {
