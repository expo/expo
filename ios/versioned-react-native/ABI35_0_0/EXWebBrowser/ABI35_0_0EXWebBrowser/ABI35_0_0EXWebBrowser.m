...
#import <ABI35_0_0EXWebBrowser/ABI35_0_0EXWebBrowser.h>
...
@interface ABI35_0_0EXWebBrowser () <SFSafariViewControllerDelegate>

@property (nonatomic, copy) ABI35_0_0UMPromiseResolveBlock redirectResolve;
@property (nonatomic, copy) ABI35_0_0UMPromiseRejectBlock redirectReject;
...
@implementation ABI35_0_0EXWebBrowser
{
  UIStatusBarStyle _initialStatusBarStyle;
}

ABI35_0_0UM_EXPORT_MODULE(ExpoWebBrowser)
...
ABI35_0_0UM_EXPORT_METHOD_AS(openAuthSessionAsync,
...
ABI35_0_0UM_EXPORT_METHOD_AS(openBrowserAsync,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  if([[arguments allKeys] containsObject:WebBrowserToolbarColorKey]) {
    safariVC.preferredBarTintColor = [ABI35_0_0EXWebBrowser convertHexColorString:arguments[WebBrowserToolbarColorKey]];
  }
  if([[arguments allKeys] containsObject:WebBrowserControlsColorKey]) {
    safariVC.preferredControlTintColor = [ABI35_0_0EXWebBrowser convertHexColorString:arguments[WebBrowserControlsColorKey]];
  }
...
ABI35_0_0UM_EXPORT_METHOD_AS(dismissBrowser,
                    dismissBrowserWithResolver:(ABI35_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  __weak typeof(self) weakSelf = self;
  UIViewController *currentViewController = [UIApplication sharedApplication].keyWindow.rootViewController;
...
ABI35_0_0UM_EXPORT_METHOD_AS(dismissAuthSession,
                    dismissAuthSessionWithResolver:(ABI35_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  if (@available(iOS 11, *)) {
    [_authSession cancel];
...
ABI35_0_0UM_EXPORT_METHOD_AS(warmUpAsync,
...
ABI35_0_0UM_EXPORT_METHOD_AS(coolDownAsync,
...
ABI35_0_0UM_EXPORT_METHOD_AS(getCustomTabsSupportingBrowsers,
                    getCustomTabsSupportingBrowsersWithPackage:(ABI35_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  // stub for jest-expo-mock-generator
}

ABI35_0_0UM_EXPORT_METHOD_AS(mayInitWithUrlAsync,
 ...
 */
- (BOOL)initializeWebBrowserWithResolver:(ABI35_0_0UMPromiseResolveBlock)resolve andRejecter:(ABI35_0_0UMPromiseRejectBlock)reject {
  if (_redirectResolve) {
...
+ (UIColor *)convertHexColorString:(NSString *)stringToConvert {
  ...
  return [ABI35_0_0EXWebBrowser colorWithRGBHex:hexNum];
}
