...
#import <ABI35_0_0EXLocation/ABI35_0_0EXLocation.h>
#import <ABI35_0_0EXLocation/ABI35_0_0EXGeofencingTaskConsumer.h>
#import <ABI35_0_0UMTaskManagerInterface/ABI35_0_0UMTaskInterface.h>

@interface ABI35_0_0EXGeofencingTaskConsumer ()
...
@implementation ABI35_0_0EXGeofencingTaskConsumer
...
# pragma mark - ABI35_0_0UMTaskConsumerInterface
...
- (void)startMonitoringRegionsForTask:(id<ABI35_0_0UMTaskInterface>)task
{
  [ABI35_0_0UMUtilities performSynchronouslyOnMainThread:^{
...
- (void)executeTaskWithRegion:(nonnull CLRegion *)region eventType:(ABI35_0_0EXGeofencingEventType)eventType
{
...
- (void)locationManager:(CLLocationManager *)manager didEnterRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != CLRegionStateInside) {
    ...
    [self executeTaskWithRegion:region eventType:ABI35_0_0EXGeofencingEventTypeEnter];
  }
}
...
- (void)locationManager:(CLLocationManager *)manager didExitRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != CLRegionStateOutside) {
    ...
    [self executeTaskWithRegion:region eventType:ABI35_0_0EXGeofencingEventTypeExit];
  }
}
...
- (void)locationManager:(CLLocationManager *)manager didDetermineState:(CLRegionState)state forRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != state) {
    ABI35_0_0EXGeofencingEventType eventType = state == CLRegionStateInside ? ABI35_0_0EXGeofencingEventTypeEnter : ABI35_0_0EXGeofencingEventTypeExit;
...
+ (ABI35_0_0EXGeofencingRegionState)exportRegionState:(CLRegionState)regionState
{
  switch (regionState) {
    case CLRegionStateUnknown:
      return ABI35_0_0EXGeofencingRegionStateUnknown;
    case CLRegionStateInside:
      return ABI35_0_0EXGeofencingRegionStateInside;
    case CLRegionStateOutside:
      return ABI35_0_0EXGeofencingRegionStateOutside;
  }
}
