...
#import <ABI35_0_0EXLocation/ABI35_0_0EXLocationTaskConsumer.h>
#import <ABI35_0_0UMTaskManagerInterface/ABI35_0_0UMTaskInterface.h>

@interface ABI35_0_0EXLocationTaskConsumer ()
...
@implementation ABI35_0_0EXLocationTaskConsumer
...
- (void)setOptions:(NSDictionary *)options
{
  [ABI35_0_0UMUtilities performSynchronouslyOnMainThread:^{
    ...
    ABI35_0_0EXLocationAccuracy accuracy = [options[@"accuracy"] unsignedIntegerValue] ?: ABI35_0_0EXLocationAccuracyBalanced;

    locationManager.desiredAccuracy = [ABI35_0_0EXLocation CLLocationAccuracyFromOption:accuracy];
    locationManager.distanceFilter = [options[@"distanceInterval"] doubleValue] ?: kCLDistanceFilterNone;
    locationManager.activityType = [ABI35_0_0EXLocation CLActivityTypeFromOption:[options[@"activityType"] integerValue]];
...
- (void)executeTaskWithDeferredLocations
{
  ...
  NSDictionary *data = @{ @"locations": [ABI35_0_0EXLocationTaskConsumer _exportLocations:_deferredLocations] };
...
+ (NSArray<NSDictionary *> *)_exportLocations:(NSArray<CLLocation *> *)locations
{
  ...
  for (CLLocation *location in locations) {
    [result addObject:[ABI35_0_0EXLocation exportLocation:location]];
  }
  return result;
}
