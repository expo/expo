...
NSString * const ABI35_0_0EXLocationChangedEventName = @"Expo.locationChanged";
NSString * const ABI35_0_0EXHeadingChangedEventName = @"Expo.headingChanged";

@interface ABI35_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI35_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) NSMutableSet<ABI35_0_0EXLocationDelegate *> *retainedDelegates;
@property (nonatomic, assign, getter=isPaused) BOOL paused;
@property (nonatomic, weak) id<ABI35_0_0UMEventEmitterService> eventEmitter;
@property (nonatomic, weak) id<ABI35_0_0UMPermissionsInterface> permissions;
@property (nonatomic, weak) id<ABI35_0_0UMAppLifecycleService> lifecycleService;
@property (nonatomic, weak) id<ABI35_0_0UMTaskManagerInterface> tasksManager;

@end

@implementation ABI35_0_0EXLocation

ABI35_0_0UM_EXPORT_MODULE(ExpoLocation);
...
- (void)setModuleRegistry:(ABI35_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  _permissions = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI35_0_0UMPermissionsInterface)];
  _lifecycleService = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI35_0_0UMAppLifecycleService)];
  _tasksManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI35_0_0UMTaskManagerInterface)];
...
{
  return @[ABI35_0_0EXLocationChangedEventName, ABI35_0_0EXHeadingChangedEventName];
}
...
ABI35_0_0UM_EXPORT_METHOD_AS(getProviderStatusAsync,
...
ABI35_0_0UM_EXPORT_METHOD_AS(getCurrentPositionAsync,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI35_0_0EXLocationDelegate *delegate;

  delegate = [[ABI35_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (delegate != nil) {
      if (locations.lastObject != nil) {
        resolve([ABI35_0_0EXLocation exportLocation:locations.lastObject]);
      } else {
...
ABI35_0_0UM_EXPORT_METHOD_AS(watchPositionImplAsync,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  ABI35_0_0EXLocationDelegate *delegate = [[ABI35_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject != nil && weakSelf != nil) {
      ...
      NSDictionary *body = @{
                             @"watchId": watchId,
                             @"location": [ABI35_0_0EXLocation exportLocation:loc],
                             };

      [strongSelf->_eventEmitter sendEventWithName:ABI35_0_0EXLocationChangedEventName body:body];
    }
  } onUpdateHeadings:nil onError:^(NSError *error) {
    // TODO: report errors
...
ABI35_0_0UM_EXPORT_METHOD_AS(watchDeviceHeading,
  ...
  ABI35_0_0EXLocationDelegate *delegate = [[ABI35_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
    if (newHeading != nil && weakSelf != nil) {
      ...
      [strongSelf->_eventEmitter sendEventWithName:ABI35_0_0EXHeadingChangedEventName body:body];
    }
...
ABI35_0_0UM_EXPORT_METHOD_AS(removeWatchAsync,
                    watchId:(nonnull NSNumber *)watchId
                    resolver:(ABI35_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ABI35_0_0EXLocationDelegate *delegate = _delegates[watchId];
...
ABI35_0_0UM_EXPORT_METHOD_AS(geocodeAsync,
...
ABI35_0_0UM_EXPORT_METHOD_AS(reverseGeocodeAsync,
...
ABI35_0_0UM_EXPORT_METHOD_AS(requestPermissionsAsync,
                    requestPermissionsResolver:(ABI35_0_0UMPromiseResolveBlock)resolve
                                      rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  if (!_permissions) {
...
ABI35_0_0UM_EXPORT_METHOD_AS(hasServicesEnabledAsync,
                    hasServicesEnabled:(ABI35_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
...
ABI35_0_0UM_EXPORT_METHOD_AS(startLocationUpdatesAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI35_0_0EXLocationTaskConsumer class] options:options];
  }
  @catch (NSException *e) {
...
ABI35_0_0UM_EXPORT_METHOD_AS(stopLocationUpdatesAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI35_0_0EXLocationTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI35_0_0UM_EXPORT_METHOD_AS(hasStartedLocationUpdatesAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI35_0_0EXLocationTaskConsumer class]]));
}

# pragma mark - Geofencing

ABI35_0_0UM_EXPORT_METHOD_AS(startGeofencingAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI35_0_0EXGeofencingTaskConsumer class] options:options];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI35_0_0UM_EXPORT_METHOD_AS(stopGeofencingAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI35_0_0EXGeofencingTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI35_0_0UM_EXPORT_METHOD_AS(hasStartedGeofencingAsync,
                    ...
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI35_0_0EXGeofencingTaskConsumer class]]));
}
...
- (BOOL)checkPermissions:(ABI35_0_0UMPromiseRejectBlock)reject
{
...
- (BOOL)checkTaskManagerExists:(ABI35_0_0UMPromiseRejectBlock)reject
{
...
- (BOOL)checkBackgroundServices:(ABI35_0_0UMPromiseRejectBlock)reject
{
...
{
  switch (accuracy) {
    case ABI35_0_0EXLocationAccuracyLowest:
      return kCLLocationAccuracyThreeKilometers;
    case ABI35_0_0EXLocationAccuracyLow:
      return kCLLocationAccuracyKilometer;
    case ABI35_0_0EXLocationAccuracyBalanced:
      return kCLLocationAccuracyHundredMeters;
    case ABI35_0_0EXLocationAccuracyHigh:
      return kCLLocationAccuracyNearestTenMeters;
    case ABI35_0_0EXLocationAccuracyHighest:
      return kCLLocationAccuracyBest;
    case ABI35_0_0EXLocationAccuracyBestForNavigation:
