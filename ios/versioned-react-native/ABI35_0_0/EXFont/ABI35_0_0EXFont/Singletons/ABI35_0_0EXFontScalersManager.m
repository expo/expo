...
@implementation UIFont (ABI35_0_0EXFontLoader)

- (UIFont *)ABI35_0_0EXFontWithSize:(CGFloat)fontSize
{
  for (id<ABI35_0_0UMFontScalerInterface> fontScaler in currentFontScalers) {
  ...
  return [self ABI35_0_0EXFontWithSize:fontSize];
}
...
@implementation ABI35_0_0EXFontScalersManager

ABI35_0_0UM_REGISTER_SINGLETON_MODULE(FontScalersManager);
...
+ (void)initialize
{
  ...
  dispatch_once(&initializeCurrentFontScalersOnce, ^{
    ...
    SEL exUpdate = @selector(ABI35_0_0EXFontWithSize:);
...
- (void)registerFontScaler:(id<ABI35_0_0UMFontScalerInterface>)fontScaler
{
