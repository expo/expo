...
#import <ABI35_0_0EXHaptics/ABI35_0_0EXHapticsModule.h>

@interface ABI35_0_0EXHapticsModule ()

@end

@implementation ABI35_0_0EXHapticsModule

ABI35_0_0UM_EXPORT_MODULE(ExpoHaptics);
...
ABI35_0_0UM_EXPORT_METHOD_AS(notificationAsync,
...
ABI35_0_0UM_EXPORT_METHOD_AS(impactAsync,
...
ABI35_0_0UM_EXPORT_METHOD_AS(selectionAsync,
                    resolve:(ABI35_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
