...
#import <ABI35_0_0EXCalendar/ABI35_0_0EXCalendar.h>
...
@implementation ABI35_0_0EXCalendar

ABI35_0_0UM_EXPORT_MODULE(ExpoCalendar);
...
ABI35_0_0UM_EXPORT_METHOD_AS(getCalendarsAsync,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI35_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI35_0_0UM_EXPORT_METHOD_AS(getDefaultCalendarAsync,
                    getDefaultCalendarAsync:(ABI35_0_0UMPromiseResolveBlock)resolve
                    rejector:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI35_0_0EXCalendarConverter serializeCalendar:defaultCalendar]);
}

ABI35_0_0UM_EXPORT_METHOD_AS(saveCalendarAsync,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (color) {
    calendar.CGColor = [ABI35_0_0UMUtilities UIColor:color].CGColor;
...
ABI35_0_0UM_EXPORT_METHOD_AS(deleteCalendarAsync,
...
ABI35_0_0UM_EXPORT_METHOD_AS(getEventsAsync,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI35_0_0UMUtilities NSDate:startDateStr];
  NSDate *endDate = [ABI35_0_0UMUtilities NSDate:endDateStr];
  ...
  if (calendarEvents) {
    resolve([ABI35_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI35_0_0UM_EXPORT_METHOD_AS(getEventByIdAsync,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (calendarEvent) {
    resolve([ABI35_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI35_0_0UM_EXPORT_METHOD_AS(saveEventAsync,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI35_0_0UMUtilities NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI35_0_0UMUtilities NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI35_0_0UMUtilities NSDate:details[@"instanceStartDate"]];
  ...
  if (recurrenceRule) {
    ...
    if (recurrenceRule[@"endDate"]) {
      endDate = [ABI35_0_0UMUtilities NSDate:recurrenceRule[@"endDate"]];
    }
...
ABI35_0_0UM_EXPORT_METHOD_AS(deleteEventAsync,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *instanceStartDate = [ABI35_0_0UMUtilities NSDate:event[@"instanceStartDate"]];
...
ABI35_0_0UM_EXPORT_METHOD_AS(getAttendeesForEventAsync,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (item.hasAttendees) {
    resolve([ABI35_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI35_0_0UM_EXPORT_METHOD_AS(getRemindersAsync,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI35_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI35_0_0UM_EXPORT_METHOD_AS(getReminderByIdAsync,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (reminder) {
    ...
    resolve([ABI35_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI35_0_0UM_EXPORT_METHOD_AS(saveReminderAsync,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI35_0_0UMUtilities NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI35_0_0UMUtilities NSDate:details[@"dueDate"]];
  NSDate *completionDate = [ABI35_0_0UMUtilities NSDate:details[@"completionDate"]];
...
ABI35_0_0UM_EXPORT_METHOD_AS(deleteReminderAsync,
...
ABI35_0_0UM_EXPORT_METHOD_AS(getSourcesAsync,
                    getSourcesAsync:(ABI35_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI35_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI35_0_0UM_EXPORT_METHOD_AS(getSourceByIdAsync,
                    ...
                    rejecter:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI35_0_0EXCalendarConverter serializeSource:source]);
}

ABI35_0_0UM_EXPORT_METHOD_AS(requestPermissionsAsync,
                    requestPermissionsAsync:(ABI35_0_0UMPromiseResolveBlock)resolve
...
ABI35_0_0UM_EXPORT_METHOD_AS(requestRemindersPermissionsAsync,
                    requestRemindersPermissionsAsync:(ABI35_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI35_0_0UMPromiseRejectBlock)reject)
{
  if (!_permissionsManager) {
    return reject(@"E_NO_PERMISSIONS", @"Permissions module not found. Are you sure that Expo modules are properly linked?", nil);
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI35_0_0UMUtilities NSDate:alarm[@"absoluteDate"]];
...
- (BOOL)_checkPermissions:(NSString *)permissionType reject:(ABI35_0_0UMPromiseRejectBlock)reject
{
...
- (BOOL)_checkCalendarPermissions:(ABI35_0_0UMPromiseRejectBlock)reject
{
  return [self _checkPermissions:@"calendar" reject:reject];
}

- (BOOL)_checkRemindersPermissions:(ABI35_0_0UMPromiseRejectBlock)reject
{
