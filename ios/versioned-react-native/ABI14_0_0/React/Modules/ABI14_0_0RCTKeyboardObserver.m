...
#import "ABI14_0_0RCTKeyboardObserver.h"

#import "ABI14_0_0RCTEventDispatcher.h"

static NSDictionary *ABI14_0_0RCTParseKeyboardNotification(NSNotification *notification);

@implementation ABI14_0_0RCTKeyboardObserver
...
{ \
  [self sendEventWithName:@#EVENT \
    body:ABI14_0_0RCTParseKeyboardNotification(notification)]; \
}
...
NS_INLINE NSDictionary *ABI14_0_0RCTRectDictionaryValue(CGRect rect)
{
  return @{
...
static NSString *ABI14_0_0RCTAnimationNameForCurve(UIViewAnimationCurve curve)
{
  switch (curve) {
...
static NSDictionary *ABI14_0_0RCTParseKeyboardNotification(NSNotification *notification)
{
  ...
  return @{
    @"startCoordinates": ABI14_0_0RCTRectDictionaryValue(beginFrame),
    @"endCoordinates": ABI14_0_0RCTRectDictionaryValue(endFrame),
    @"duration": @(duration * 1000.0), // ms
    @"easing": ABI14_0_0RCTAnimationNameForCurve(curve),
  };
#endif
}
