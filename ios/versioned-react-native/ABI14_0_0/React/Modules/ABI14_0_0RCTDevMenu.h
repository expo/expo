...
@class ABI14_0_0RCTDevMenuItem;

/**
 * Developer menu, useful for exposing extra functionality when debugging.
 */
@interface ABI14_0_0RCTDevMenu : NSObject

/**
 * Is the menu enabled. The menu is enabled by default if ABI14_0_0RCT_DEV=1, but
 ...
 */
@property (nonatomic, copy, readonly) NSArray<ABI14_0_0RCTDevMenuItem *> *presentedItems;
 ...
 */
- (void)addItem:(ABI14_0_0RCTDevMenuItem *)item;
 ...
 */
@interface ABI14_0_0RCTDevMenuItem : NSObject
 ...
 * ABI14_0_0RCTBridge, which is useful for any class that needs to access the menu.
 */
@interface ABI14_0_0RCTBridge (ABI14_0_0RCTDevMenu)

@property (nonatomic, readonly) ABI14_0_0RCTDevMenu *devMenu;
