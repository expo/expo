...
#import "ABI14_0_0RCTAccessibilityManager.h"
...
NSString *const ABI14_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification = @"ABI14_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification";

@interface ABI14_0_0RCTAccessibilityManager ()
...
@implementation ABI14_0_0RCTAccessibilityManager
...
- (void)invalidateMultiplier
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI14_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification object:self];
}
...
- (CGFloat)multiplierForContentSizeCategory:(NSString *)category
{
  ...
  if (m.doubleValue <= 0.0) {
    ABI14_0_0RCTLogError(@"Can't determinte multiplier for category %@. Using 1.0.", category);
    m = @1.0;
  }
...
ABI14_0_0RCT_EXPORT_METHOD(setAccessibilityContentSizeMultipliers:(NSDictionary *)JSMultipliers)
{
  ...
  for (NSString *__nonnull JSCategory in JSMultipliers) {
    NSNumber *m = [ABI14_0_0RCTConvert NSNumber:JSMultipliers[JSCategory]];
...
ABI14_0_0RCT_EXPORT_METHOD(getMultiplier:(ABI14_0_0RCTResponseSenderBlock)callback)
{
  if (callback) {
...
ABI14_0_0RCT_EXPORT_METHOD(getCurrentVoiceOverState:(ABI14_0_0RCTResponseSenderBlock)callback
...
@implementation ABI14_0_0RCTBridge (ABI14_0_0RCTAccessibilityManager)

- (ABI14_0_0RCTAccessibilityManager *)accessibilityManager
{
  return [self moduleForClass:[ABI14_0_0RCTAccessibilityManager class]];
}
