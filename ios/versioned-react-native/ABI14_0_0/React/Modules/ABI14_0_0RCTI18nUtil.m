...
@implementation ABI14_0_0RCTI18nUtil

+ (id)sharedInstance {
   static ABI14_0_0RCTI18nUtil *sharedABI14_0_0RCTI18nUtilInstance = nil;
   @synchronized(self) {
     if (sharedABI14_0_0RCTI18nUtilInstance == nil)
      sharedABI14_0_0RCTI18nUtilInstance = [self new];
   }
   return sharedABI14_0_0RCTI18nUtilInstance;
}
...
- (BOOL)isRTLAllowed
{
  NSNumber *value = [[NSUserDefaults standardUserDefaults] objectForKey:@"ABI14_0_0RCTI18nUtil_allowRTL"];
  if (value == nil) {
    return YES;
  }
...
{
  [[NSUserDefaults standardUserDefaults] setBool:rtlStatus forKey:@"ABI14_0_0RCTI18nUtil_allowRTL"];
...
- (BOOL)isRTLForced
{
  BOOL rtlStatus = [[NSUserDefaults standardUserDefaults]
                            boolForKey:@"ABI14_0_0RCTI18nUtil_forceRTL"];
  return rtlStatus;
}

- (void)forceRTL:(BOOL)rtlStatus
{
  [[NSUserDefaults standardUserDefaults] setBool:rtlStatus forKey:@"ABI14_0_0RCTI18nUtil_forceRTL"];
  [[NSUserDefaults standardUserDefaults] synchronize];
}
