...
@interface ABI14_0_0RCTRootShadowView : ABI14_0_0RCTShadowView

/**
 * Size flexibility type used to find size constraints.
 * Default to ABI14_0_0RCTRootViewSizeFlexibilityNone
 */
@property (nonatomic, assign) ABI14_0_0RCTRootViewSizeFlexibility sizeFlexibility;
