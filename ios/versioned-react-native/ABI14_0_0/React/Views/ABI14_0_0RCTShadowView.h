...
@class ABI14_0_0RCTSparseArray;

typedef NS_ENUM(NSUInteger, ABI14_0_0RCTUpdateLifecycle) {
  ABI14_0_0RCTUpdateLifecycleUninitialized = 0,
  ABI14_0_0RCTUpdateLifecycleComputed,
  ABI14_0_0RCTUpdateLifecycleDirtied,
};

typedef void (^ABI14_0_0RCTApplierBlock)(NSDictionary<NSNumber *, UIView *> *viewRegistry);

/**
 * ShadowView tree mirrors ABI14_0_0RCT view tree. Every node is highly stateful.
 * 1. A node is in one of three lifecycles: uninitialized, computed, dirtied.
 * 1. ABI14_0_0RCTBridge may call any of the padding/margin/width/height/top/left setters. A setter would dirty
 ...
 */
@interface ABI14_0_0RCTShadowView : NSObject <ABI14_0_0RCTComponent>

/**
 * ABI14_0_0RCTComponent interface.
 */
- (NSArray<ABI14_0_0RCTShadowView *> *)ReactABI14_0_0Subviews NS_REQUIRES_SUPER;
- (ABI14_0_0RCTShadowView *)ReactABI14_0_0Superview NS_REQUIRES_SUPER;
- (void)insertReactABI14_0_0Subview:(ABI14_0_0RCTShadowView *)subview atIndex:(NSInteger)atIndex NS_REQUIRES_SUPER;
- (void)removeReactABI14_0_0Subview:(ABI14_0_0RCTShadowView *)subview NS_REQUIRES_SUPER;

@property (nonatomic, weak, readonly) ABI14_0_0RCTShadowView *superview;
@property (nonatomic, assign, readonly) ABI14_0_0YGNodeRef cssNode;
@property (nonatomic, copy) NSString *viewName;
@property (nonatomic, strong) UIColor *backgroundColor; // Used to propagate to children
@property (nonatomic, copy) ABI14_0_0RCTDirectEventBlock onLayout;

/**
 * isNewView - Used to track the first time the view is introduced into the hierarchy.  It is initialized YES, then is
 * set to NO in ABI14_0_0RCTUIManager after the layout pass is done and all frames have been extracted to be applied to the
 * corresponding UIViews.
 */
@property (nonatomic, assign, getter=isNewView) BOOL newView;

/**
 * isHidden - ABI14_0_0RCTUIManager uses this to determine whether or not the UIView should be hidden. Useful if the
 ...
 */
@property (nonatomic, assign) ABI14_0_0YGFlexDirection flexDirection;
@property (nonatomic, assign) ABI14_0_0YGJustify justifyContent;
@property (nonatomic, assign) ABI14_0_0YGAlign alignSelf;
@property (nonatomic, assign) ABI14_0_0YGAlign alignItems;
@property (nonatomic, assign) ABI14_0_0YGPositionType position;
@property (nonatomic, assign) ABI14_0_0YGWrap flexWrap;
 ...
 * Clipping properties
 */
@property (nonatomic, assign) ABI14_0_0YGOverflow overflow;

/**
 * Calculate property changes that need to be propagated to the view.
 * The applierBlocks set contains ABI14_0_0RCTApplierBlock functions that must be applied
 ...
 * ABI14_0_0RCTShadowText has children which it does not want Yoga to lay out so in the eyes of
...
/**
 * As described in ABI14_0_0RCTComponent protocol.
 */
- (void)didUpdateReactABI14_0_0Subviews NS_REQUIRES_SUPER;
