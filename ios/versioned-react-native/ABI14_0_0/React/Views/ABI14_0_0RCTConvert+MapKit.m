...
@implementation ABI14_0_0RCTConvert(MapKit)
...
ABI14_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
{
  json = [self NSDictionary:json];
  ABI14_0_0RCTMapAnnotation *annotation = [ABI14_0_0RCTMapAnnotation new];
...
ABI14_0_0RCT_ARRAY_CONVERTER(ABI14_0_0RCTMapAnnotation)
...
+ (ABI14_0_0RCTMapOverlay *)ABI14_0_0RCTMapOverlay:(id)json
{
  ...
  ABI14_0_0RCTMapOverlay *overlay = [ABI14_0_0RCTMapOverlay polylineWithCoordinates:coordinates
...
ABI14_0_0RCT_ARRAY_CONVERTER(ABI14_0_0RCTMapOverlay)
