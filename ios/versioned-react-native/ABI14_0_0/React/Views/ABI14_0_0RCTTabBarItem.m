...
@implementation ABI14_0_0RCTConvert (UITabBarSystemItem)

ABI14_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI14_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI14_0_0ViewController;
}
