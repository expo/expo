...
#import "ABI14_0_0RCTMultipartStreamReader.h"

#define CRLF @"\r\n"

@implementation ABI14_0_0RCTMultipartStreamReader {
...
- (void)emitChunk:(NSData *)data callback:(ABI14_0_0RCTMultipartCallback)callback done:(BOOL)done
{
...
- (BOOL)readAllParts:(ABI14_0_0RCTMultipartCallback)callback
{
