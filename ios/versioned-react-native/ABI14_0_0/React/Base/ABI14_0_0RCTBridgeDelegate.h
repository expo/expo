...
#import <ReactABI14_0_0/ABI14_0_0RCTJavaScriptLoader.h>

@class ABI14_0_0RCTBridge;
@protocol ABI14_0_0RCTBridgeModule;

@protocol ABI14_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI14_0_0RCTBridge *)bridge;
 ...
 */
- (NSURL *)fallbackSourceURLForBridge:(ABI14_0_0RCTBridge *)bridge;

/**
 * The bridge initializes any registered ABI14_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI14_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI14_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (NSArray<Class> *)whitelistedModulesForBridge:(ABI14_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeLoadJavaScriptSynchronously:(ABI14_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeInitializeNativeModulesSynchronously:(ABI14_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI14_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI14_0_0RCTBridge *)bridge;
 ...
 */
- (void)loadSourceForBridge:(ABI14_0_0RCTBridge *)bridge
                 onProgress:(ABI14_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI14_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI14_0_0RCTBridge *)bridge
                  withBlock:(ABI14_0_0RCTSourceLoadBlock)loadCallback;
