...
#import <ReactABI14_0_0/ABI14_0_0RCTBridgeDelegate.h>
...
@class ABI14_0_0RCTPerformanceLogger;

/**
 * This notification fires when the bridge starts loading the JS bundle.
 */
ABI14_0_0RCT_EXTERN NSString *const ABI14_0_0RCTJavaScriptWillStartLoadingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI14_0_0RCT_EXTERN NSString *const ABI14_0_0RCTJavaScriptDidLoadNotification;

/**
 * This notification fires when the bridge failed to load the JS bundle. The
 * `error` key can be used to determine the error that occured.
 */
ABI14_0_0RCT_EXTERN NSString *const ABI14_0_0RCTJavaScriptDidFailToLoadNotification;
 ...
 */
ABI14_0_0RCT_EXTERN NSString *const ABI14_0_0RCTDidInitializeModuleNotification;
 ...
 */
typedef NSArray<id<ABI14_0_0RCTBridgeModule>> *(^ABI14_0_0RCTBridgeModuleProviderBlock)(void);

/**
 * This function returns the module name for a given class.
 */
ABI14_0_0RCT_EXTERN NSString *ABI14_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI14_0_0RCTBridge : NSObject <ABI14_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI14_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI14_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 * See also -[ABI14_0_0RCTBridgeDelgate shouldBridgeLoadJavaScriptSynchronously], which
 ...
 */
@property (nonatomic, weak, readonly) id<ABI14_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ReactABI14_0_0 Native perf events.
 */
@property (nonatomic, readonly, strong) ABI14_0_0RCTPerformanceLogger *performanceLogger;
