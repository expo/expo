 ...
 */
@interface ABI14_0_0RCTImageSource : NSObject
...
@interface ABI14_0_0RCTConvert (ImageSource)

+ (ABI14_0_0RCTImageSource *)ABI14_0_0RCTImageSource:(id)json;
+ (NSArray<ABI14_0_0RCTImageSource *> *)ABI14_0_0RCTImageSourceArray:(id)json;
