...
@interface ABI14_0_0RCTPerformanceLogger ()
{
  int64_t _data[ABI14_0_0RCTPLSize][2];
  NSUInteger _cookies[ABI14_0_0RCTPLSize];
}
...
@implementation ABI14_0_0RCTPerformanceLogger
...
- (void)markStartForTag:(ABI14_0_0RCTPLTag)tag
{
  ...
  if (ABI14_0_0RCTProfileIsProfiling()) {
    ...
    _cookies[tag] = ABI14_0_0RCTProfileBeginAsyncEvent(ABI14_0_0RCTProfileTagAlways, label, nil);
  }
#endif
...
- (void)markStopForTag:(ABI14_0_0RCTPLTag)tag
{
  ...
  if (ABI14_0_0RCTProfileIsProfiling()) {
    NSString *label =_labelsForTags[tag];
    ABI14_0_0RCTProfileEndAsyncEvent(ABI14_0_0RCTProfileTagAlways, @"native", _cookies[tag], label, @"ABI14_0_0RCTPerformanceLogger");
  }
#endif
  if (_data[tag][0] != 0 && _data[tag][1] == 0) {
    _data[tag][1] = CACurrentMediaTime() * 1000;
  } else {
    ABI14_0_0RCTLogInfo(@"Unbalanced calls start/end for tag %li", (unsigned long)tag);
  }
}
...
- (NSArray<NSNumber *> *)valuesForTags
{
  ...
  for (NSUInteger index = 0; index < ABI14_0_0RCTPLSize; index++) {
