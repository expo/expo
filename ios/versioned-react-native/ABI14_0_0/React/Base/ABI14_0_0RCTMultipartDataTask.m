...
@interface ABI14_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI14_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI14_0_0RCTMultipartDataTaskCallback _partHandler;
...
{
  ABI14_0_0RCTMultipartStreamReader *reader = [[ABI14_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI14_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
