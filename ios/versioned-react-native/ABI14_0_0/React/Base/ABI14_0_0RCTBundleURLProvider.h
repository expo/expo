...
extern NSString *const ABI14_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI14_0_0RCTBundleURLProviderDefaultPort;

@interface ABI14_0_0RCTBundleURLProvider : NSObject
