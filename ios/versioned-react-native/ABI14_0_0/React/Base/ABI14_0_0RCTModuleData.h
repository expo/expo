...
@protocol ABI14_0_0RCTBridgeMethod;
@protocol ABI14_0_0RCTBridgeModule;
@class ABI14_0_0RCTBridge;

@interface ABI14_0_0RCTModuleData : NSObject <ABI14_0_0RCTInvalidating>

- (instancetype)initWithModuleClass:(Class)moduleClass
                             bridge:(ABI14_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;

- (instancetype)initWithModuleInstance:(id<ABI14_0_0RCTBridgeModule>)instance
                                bridge:(ABI14_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI14_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI14_0_0RCTBridgeModule> instance;
