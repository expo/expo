...
@implementation ABI14_0_0RCTDiffClampAnimatedNode
{
...
- (void)onAttachedToNode:(ABI14_0_0RCTAnimatedNode *)parent
{
...
{
  ABI14_0_0RCTValueAnimatedNode *inputNode = (ABI14_0_0RCTValueAnimatedNode *)self.parentNodes[_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI14_0_0RCTValueAnimatedNode class]]) {
    ABI14_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
