...
@implementation ABI14_0_0RCTInterpolationAnimatedNode
{
  __weak ABI14_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI14_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI14_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI14_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI14_0_0RCTInterpolateValue(inputValue,
