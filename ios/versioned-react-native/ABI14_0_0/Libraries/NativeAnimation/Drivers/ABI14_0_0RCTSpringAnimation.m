...
@implementation ABI14_0_0RCTSpringAnimation
{
  ...
  ABI14_0_0RCTResponseSenderBlock _callback;
                  ...
                  callBack:(nullable ABI14_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _toValue = [ABI14_0_0RCTConvert CGFloat:config[@"toValue"]];
    _fromValue = valueNode.value;
    _valueNode = valueNode;
    _overshootClamping = [ABI14_0_0RCTConvert BOOL:config[@"overshootClamping"]];
    _restDisplacementThreshold = [ABI14_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
    _restSpeedThreshold = [ABI14_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
    _tension = [ABI14_0_0RCTConvert CGFloat:config[@"tension"]];
    _friction = [ABI14_0_0RCTConvert CGFloat:config[@"friction"]];
    _initialVelocity = [ABI14_0_0RCTConvert CGFloat:config[@"initialVelocity"]];
