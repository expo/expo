...
#import "ABI14_0_0RCTPhotoLibraryImageLoader.h"

#import <Photos/Photos.h>

#import <ReactABI14_0_0/ABI14_0_0RCTUtils.h>

@implementation ABI14_0_0RCTPhotoLibraryImageLoader

ABI14_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI14_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI14_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI14_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI14_0_0RCTResizeModeContain) {
