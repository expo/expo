...
#import "ABI14_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI14_0_0/ABI14_0_0RCTConvert.h>
#import <ReactABI14_0_0/ABI14_0_0RCTImageStoreManager.h>
...
@interface ABI14_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI14_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI14_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI14_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI14_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI14_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI14_0_0RCTResponseSenderBlock)callback)
{
...
ABI14_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI14_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI14_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI14_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI14_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI14_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI14_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI14_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI14_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI14_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI14_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI14_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI14_0_0RCTNullIfNil(height), ABI14_0_0RCTNullIfNil(width)]];
    return;
  }
        ...
        cancelCallback:(ABI14_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI14_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI14_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI14_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
