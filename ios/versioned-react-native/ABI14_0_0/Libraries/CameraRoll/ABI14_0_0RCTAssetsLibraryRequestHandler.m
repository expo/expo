...
@implementation ABI14_0_0RCTAssetsLibraryRequestHandler
{
...
- (id)sendRequest:(NSURLRequest *)request
     withDelegate:(id<ABI14_0_0RCTURLRequestDelegate>)delegate
{
  ...
  [[self assetsLibrary] assetForURL:request.URL resultBlock:^(ALAsset *asset) {
    ...
    if (asset) {
      ...
      NSError *error = ABI14_0_0RCTErrorWithMessage(errorMessage);
      [delegate URLRequest:cancellationBlock didCompleteWithError:error];
    }
...
@implementation ABI14_0_0RCTBridge (ABI14_0_0RCTAssetsLibraryImageLoader)

- (ALAssetsLibrary *)assetsLibrary
{
  return [[self moduleForClass:[ABI14_0_0RCTAssetsLibraryRequestHandler class]] assetsLibrary];
}
