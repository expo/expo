...
typedef NS_ENUM(NSInteger, ABI14_0_0RCTTestStatus) {
  ABI14_0_0RCTTestStatusPending = 0,
  ABI14_0_0RCTTestStatusPassed,
  ABI14_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI14_0_0RCTTestModule : NSObject <ABI14_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI14_0_0RCTTestStatus status;
