...
@interface ABI14_0_0RCTImageStoreManager : NSObject <ABI14_0_0RCTURLRequestHandler>
...
@interface ABI14_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI14_0_0RCTBridge (ABI14_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI14_0_0RCTImageStoreManager *imageStoreManager;
