...
#import "ABI14_0_0RCTLocalAssetImageLoader.h"

#import <libkern/OSAtomic.h>

#import <ReactABI14_0_0/ABI14_0_0RCTUtils.h>

@implementation ABI14_0_0RCTLocalAssetImageLoader

ABI14_0_0RCT_EXPORT_MODULE()

- (BOOL)canLoadImageURL:(NSURL *)requestURL
{
  return ABI14_0_0RCTIsLocalAssetURL(requestURL);
}
...
static NSBundle *bundleForPath(NSString *key)
{
 ...
 - (ABI14_0_0RCTImageLoaderCancellationBlock)loadImageForURL:(NSURL *)imageURL
                                               size:(CGSize)size
                                              scale:(CGFloat)scale
                                         resizeMode:(ABI14_0_0RCTResizeMode)resizeMode
                                    progressHandler:(ABI14_0_0RCTImageLoaderProgressBlock)progressHandler
                                 partialLoadHandler:(ABI14_0_0RCTImageLoaderPartialLoadBlock)partialLoadHandler
                                  completionHandler:(ABI14_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  ABI14_0_0RCTExecuteOnMainQueue(^{
    ...
    NSString *imageName = ABI14_0_0RCTBundlePathForURL(imageURL);
    ...
    if (image) {
      ...
      ABI14_0_0RCTLogWarn(@"%@", message);
      completionHandler(ABI14_0_0RCTErrorWithMessage(message), nil);
    }
  });
