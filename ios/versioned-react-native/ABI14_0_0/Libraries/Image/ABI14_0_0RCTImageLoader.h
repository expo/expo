...
typedef void (^ABI14_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI14_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI14_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI14_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI14_0_0RCTImageCache <NSObject>
...
@interface UIImage (ReactABI14_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI14_0_0KeyframeAnimation;

@end

@interface ABI14_0_0RCTImageLoader : NSObject <ABI14_0_0RCTBridgeModule, ABI14_0_0RCTURLRequestHandler>
 ...
 * decoded images as long as it conforms to the ABI14_0_0RCTImageCacheDelegate
...
@interface ABI14_0_0RCTBridge (ABI14_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI14_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI14_0_0RCTImageURLLoader <ABI14_0_0RCTBridgeModule>
...
/**
 * If more than one ABI14_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI14_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 * are also bridge modules, so should be registered using ABI14_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI14_0_0RCTImageDataDecoder <ABI14_0_0RCTBridgeModule>
...
/**
 * If more than one ABI14_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
