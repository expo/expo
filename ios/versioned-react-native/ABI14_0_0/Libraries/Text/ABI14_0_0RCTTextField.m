...
@implementation ABI14_0_0RCTTextField
{
...
- (instancetype)initWithEventDispatcher:(ABI14_0_0RCTEventDispatcher *)eventDispatcher
{
  if ((self = [super initWithFrame:CGRectZero])) {
    ABI14_0_0RCTAssert(eventDispatcher, @"eventDispatcher is a required parameter");
...
static void ABI14_0_0RCTUpdatePlaceholder(ABI14_0_0RCTTextField *self)
{
...
- (void)setPlaceholderTextColor:(UIColor *)placeholderTextColor
{
  ...
  ABI14_0_0RCTUpdatePlaceholder(self);
}
...
{
  _nativeEventCount++;
  [_eventDispatcher sendTextEventWithType:ABI14_0_0RCTTextEventTypeChange
                                 ReactABI14_0_0Tag:self.ReactABI14_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (void)observeValueForKeyPath:(NSString *)keyPath
                      ofObject:(ABI14_0_0RCTTextField *)textField
