...
@interface ABI14_0_0ARTRenderable : ABI14_0_0ARTNode

@property (nonatomic, strong) ABI14_0_0ARTBrush *fill;
...
@property (nonatomic, assign) ABI14_0_0ARTCGFloatArray strokeDash;
