...
@implementation ABI14_0_0ARTText
...
static void ABI14_0_0ARTFreeTextFrame(ABI14_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI14_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI14_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI14_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI14_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
