...
#import "ABI14_0_0RNSVGClipPath.h"

@implementation ABI14_0_0RNSVGNode
{
    BOOL _transparent;
}
...
- (void)invalidate
{
    id<ABI14_0_0RNSVGContainer> container = (id<ABI14_0_0RNSVGContainer>)self.superview;
...
- (void)clip:(CGContextRef)context
{
    ...
    if (clipPath) {
        ...
        if (self.clipRule == kABI14_0_0RNSVGCGFCRuleEvenodd) {
...
- (ABI14_0_0RNSVGSvgView *)getSvgView
{
    UIView *parent = self.superview;
    while (parent && [parent class] != [ABI14_0_0RNSVGSvgView class]) {
        parent = parent.superview;
    }

    return (ABI14_0_0RNSVGSvgView *)parent;
}

- (void)saveDefinition
{
    if (self.name) {
        ABI14_0_0RNSVGSvgView* svg = [self getSvgView];
...
- (void)traverseSubviews:(BOOL (^)(ABI14_0_0RNSVGNode *node))block
{
