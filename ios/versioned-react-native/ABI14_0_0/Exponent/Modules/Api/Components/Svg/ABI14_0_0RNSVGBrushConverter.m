...
@implementation ABI14_0_0RNSVGBrushConverter

- (void)drawLinearGradient:(CGContextRef)context
{
    
    CGGradientRef gradient = CGGradientRetain([ABI14_0_0RCTConvert CGGradient:self.colors offset:0]);
    ...
    ABI14_0_0RNSVGPercentageConverter* convert = [[ABI14_0_0RNSVGPercentageConverter alloc] init];
