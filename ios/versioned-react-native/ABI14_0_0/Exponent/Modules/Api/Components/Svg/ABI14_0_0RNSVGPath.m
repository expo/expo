...
@implementation ABI14_0_0RNSVGPath
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    if (self.fill) {
        mode = self.fillRule == kABI14_0_0RNSVGCGFCRuleEvenodd ? kCGPathEOFill : kCGPathFill;
        ...
        if (!fillColor) {
            ...
            ABI14_0_0RNSVGBrushConverter *brushConverter = [[self getSvgView] getDefinedBrushConverter:[self.fill brushRef]];
    ...
    if (self.stroke) {
        ...
        ABI14_0_0RNSVGCGFloatArray dash = self.strokeDasharray;
        ...
        if ([self.stroke applyStrokeColor:context opacity:self.strokeOpacity]) {
            ...
            CGContextReplacePathWithStrokedPath(context);
            CGContextClip(context);
            ABI14_0_0RNSVGBrushConverter *brushConverter = [[self getSvgView] getDefinedBrushConverter:[self.stroke brushRef]];
