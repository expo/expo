...
@implementation ABI14_0_0RNSVGViewBox
{
    BOOL _fromSymbol;
}
...
- (void)setMeetOrSlice:(ABI14_0_0RNSVGVBMOS)meetOrSlice
{
...
- (CGAffineTransform)getTransform
{
    ...
    ABI14_0_0RNSVGVBMOS meetOrSlice = self.meetOrSlice;
    ...
    // If align is 'none'
    if (meetOrSlice == kABI14_0_0RNSVGVBMOSNone) {
        ...
        if (![align isEqualToString: @"none"] && meetOrSlice == kABI14_0_0RNSVGVBMOSMeet) {
            scaleX = scaleY = fmin(scaleX, scaleY);
        } else if (![align isEqualToString: @"none"] && meetOrSlice == kABI14_0_0RNSVGVBMOSSlice) {
...
{
    if ([target isKindOfClass:[ABI14_0_0RNSVGUse class]]) {
        ABI14_0_0RNSVGUse *use = target;
        _fromSymbol = YES;
