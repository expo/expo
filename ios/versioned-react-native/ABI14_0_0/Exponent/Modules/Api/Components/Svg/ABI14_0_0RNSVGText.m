...
#import "ABI14_0_0RNSVGBezierPath.h"
#import <CoreText/CoreText.h>

@implementation ABI14_0_0RNSVGText

static void ABI14_0_0RNSVGFreeTextFrame(ABI14_0_0RNSVGTextFrame frame)
{
    if (frame.count) {
...
- (void)setTextFrame:(ABI14_0_0RNSVGTextFrame)textFrame
{
    ABI14_0_0RNSVGFreeTextFrame(_textFrame);
    [self invalidate];
...
- (CGPathRef)getPath:(CGContextRef)context
{
    ...
    ABI14_0_0RNSVGTextFrame frame = self.textFrame;
    for (int i = 0; i < frame.count; i++) {
        CGFloat shift;
...
- (CGMutablePathRef)setLinePath:(CTLineRef)line
{
    ...
    ABI14_0_0RNSVGBezierPath *bezierPath = [[ABI14_0_0RNSVGBezierPath alloc] initWithBezierCurves:self.path];
