...
#import "ABI14_0_0EXContacts.h"

@import AddressBook;

@interface ABI14_0_0EXContacts ()

@property (nonatomic, assign) ABAddressBookRef addressBookRef;

@end

@implementation ABI14_0_0EXContacts

ABI14_0_0RCT_EXPORT_MODULE(ExponentContacts);
 ...
 */
ABI14_0_0RCT_EXPORT_METHOD(getContactsAsync:(NSArray *)fields resolver:(ABI14_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI14_0_0RCTPromiseRejectBlock)reject)
{
...
- (void)_getContactsWithPermissionGrantedAsync:(NSArray *)fields addressBook:(ABAddressBookRef)addressBook resolver:(ABI14_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI14_0_0RCTPromiseRejectBlock)reject
{
