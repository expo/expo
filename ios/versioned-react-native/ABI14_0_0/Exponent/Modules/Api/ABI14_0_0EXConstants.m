...
@interface ABI14_0_0EXConstants ()
...
@implementation ABI14_0_0EXConstants
...
{
  NSString *exponentClientVersion = [[[NSBundle mainBundle] infoDictionary] objectForKey:@"ABI14_0_0EXClientVersion"];
