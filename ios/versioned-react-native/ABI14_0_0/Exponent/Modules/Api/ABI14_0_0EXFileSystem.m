...
@implementation NSData (ABI14_0_0EXFileSystem)
...
@interface ABI14_0_0EXFileSystem ()
...
@implementation ABI14_0_0EXFileSystem
...
{
  if (self = [super init]) {
    NSString *subdir = [ABI14_0_0EXVersionManager escapedResourceName:experienceId];
...
ABI14_0_0RCT_REMAP_METHOD(downloadAsync,
...
ABI14_0_0RCT_REMAP_METHOD(getInfoAsync,
...
ABI14_0_0RCT_REMAP_METHOD(deleteAsync,
...
- (NSString *)scopedPathWithPath:(NSString *)path withOptions:(NSDictionary *)options
{
  ...
  if (![ABI14_0_0EXFileSystem ensureDirExistsWithPath:prefix]) {
    return nil;
  }
