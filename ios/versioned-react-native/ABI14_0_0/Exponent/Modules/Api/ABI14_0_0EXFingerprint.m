...
#import "ABI14_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI14_0_0EXFingerprint

ABI14_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI14_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI14_0_0RCTPromiseResolveBlock)resolve
...
ABI14_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI14_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI14_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI14_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
