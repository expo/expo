...
#import "ABI14_0_0EXFontLoader.h"
...
static NSMutableDictionary *ABI14_0_0EXFonts = nil;

@interface ABI14_0_0EXFont : NSObject
...
@implementation ABI14_0_0EXFont
...
@implementation ABI14_0_0RCTFont (ABI14_0_0EXFontLoader)

// Will swap this with +[ABI14_0_0RCTFont updateFont: ...]
          ...
          scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  if ([family hasPrefix:exponentPrefix] && ABI14_0_0EXFonts) {
    NSString *suffix = [family substringFromIndex:exponentPrefix.length];
    if (ABI14_0_0EXFonts[suffix]) {
      return [ABI14_0_0EXFonts[suffix] UIFontWithSize:[ABI14_0_0RCTConvert CGFloat:size] ?: font.pointSize ?: defaultFontSize];
    }
  }
...
@implementation ABI14_0_0EXFontLoader

ABI14_0_0RCT_EXPORT_MODULE(ExponentFontLoader);
...
+ (void)initialize {
  ...
  method_exchangeImplementations(class_getClassMethod([ABI14_0_0RCTFont class], a),
                                 class_getClassMethod([ABI14_0_0RCTFont class], b));
}

ABI14_0_0RCT_REMAP_METHOD(loadAsync,
...
{
  if (ABI14_0_0EXFonts && ABI14_0_0EXFonts[fontFamilyName]) {
  ...
  if (!ABI14_0_0EXFonts) {
    ABI14_0_0EXFonts = [NSMutableDictionary dictionary];
  }
  ABI14_0_0EXFonts[fontFamilyName] = [[ABI14_0_0EXFont alloc] initWithCGFont:font];
  resolve(nil);
}
