...
@interface ABI14_0_0EXLocationRequester () <CLLocationManagerDelegate>
...
@implementation ABI14_0_0EXLocationRequester
...
+ (NSDictionary *)permissions
{
  ...
  if (!(alwaysUsageDescription || whenInUseUsageDescription)) {
    ABI14_0_0RCTFatal(ABI14_0_0RCTErrorWithMessage(@"This app is missing NSLocationAlwaysUsageDescription or NSLocationWhenInUseUsageDescription, so location services will fail. Add one of these keys to your bundle's Info.plist."));
...
- (void)requestPermissionsWithResolver:(ABI14_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI14_0_0RCTPromiseRejectBlock)reject
{
  ...
  if (existingPermissions && ![existingPermissions[@"status"] isEqualToString:[ABI14_0_0EXPermissions permissionStringForStatus:ABI14_0_0EXPermissionStatusUndetermined]]) {
