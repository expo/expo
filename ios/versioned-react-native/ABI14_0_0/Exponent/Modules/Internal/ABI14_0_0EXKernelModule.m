...
@interface ABI14_0_0EXKernelModule ()
...
@implementation ABI14_0_0EXKernelModule
...
- (void)sendEventWithName:(NSString *)eventName body:(id)body
{
  ...
  [self.bridge enqueueJSCall:@"ABI14_0_0RCTDeviceEventEmitter.emit"
...
ABI14_0_0RCT_EXPORT_METHOD(addDevMenu)
{
...
ABI14_0_0RCT_REMAP_METHOD(routeDidForeground,
...
ABI14_0_0RCT_REMAP_METHOD(onEventSuccess,
...
ABI14_0_0RCT_REMAP_METHOD(onEventFailure,
                 eventId:(NSString *)eventId
