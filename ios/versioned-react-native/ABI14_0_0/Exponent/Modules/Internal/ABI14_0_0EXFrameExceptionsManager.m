...
#import <ReactABI14_0_0/ABI14_0_0RCTRedBox.h>

@implementation ABI14_0_0EXFrameExceptionsManager {
  __weak id<ABI14_0_0RCTExceptionsManagerDelegate> _delegate;
}

@synthesize bridge = _bridge;

+ (NSString *)moduleName { return @"ABI14_0_0RCTExceptionsManager"; }
...
{
  // this will hit ABI14_0_0EXDisabledRedBox when not debugging
