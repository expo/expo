...
#include "ABI14_0_0JSIndexedRAMBundle.h"
#include "ABI14_0_0oss-compat-util.h"
...
std::unique_ptr<const facebook::ReactABI14_0_0::JSBigString> JSIndexedRAMBundle::getStartupCode() {
