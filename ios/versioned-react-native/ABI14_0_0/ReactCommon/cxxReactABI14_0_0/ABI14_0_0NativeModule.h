...
class NativeModule {
 public:
  ...
  // or only Java?
  virtual void invoke(ExecutorToken token, unsigned int ReactABI14_0_0MethodId, folly::dynamic&& params) = 0;
  virtual MethodCallResult callSerializableNativeHook(ExecutorToken token, unsigned int ReactABI14_0_0MethodId, folly::dynamic&& args) = 0;
};
