...
#include "ABI14_0_0JSCExecutor.h"
...
#include "ABI14_0_0RecoverableError.h"
...
void JSCExecutor::loadApplicationScript(
  ...
  ReactABI14_0_0Marker::logMarker("RUN_JS_BUNDLE_START");
  ...
  flush();
  ReactABI14_0_0Marker::logMarker("CREATE_REACT_CONTEXT_END");
  ReactABI14_0_0Marker::logMarker("RUN_JS_BUNDLE_END");
}
#endif
...
void JSCExecutor::loadApplicationScript(std::unique_ptr<const JSBigString> script, std::string sourceURL) throw(JSException) {
  ...
  ReactABI14_0_0Marker::logMarker("loadApplicationScript_startStringConvert");
  String jsScript = jsStringFromBigString(m_context, *script);
  ReactABI14_0_0Marker::logMarker("loadApplicationScript_endStringConvert");
...
void JSCExecutor::stopProfiler(const std::string &titleString, const std::string& filename) {
  #ifdef WITH_JSC_EXTRA_TRACING
  String title(m_context, titleString.c_str());
  facebook::ReactABI14_0_0::stopAndOutputProfilingFile(m_context, title, filename.c_str());
  #endif
}
