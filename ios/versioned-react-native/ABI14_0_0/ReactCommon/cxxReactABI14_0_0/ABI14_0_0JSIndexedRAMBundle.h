...
#include "ABI14_0_0JSBundleType.h"
...
#include <cxxReactABI14_0_0/ABI14_0_0JSModulesUnbundle.h>

class JSIndexedRAMBundle : public facebook::ReactABI14_0_0::JSModulesUnbundle {
public:
  // Throws std::runtime_error on failure.
  JSIndexedRAMBundle(const char *sourceURL);

  // Throws std::runtime_error on failure.
  std::unique_ptr<const facebook::ReactABI14_0_0::JSBigString> getStartupCode();
  // Throws std::runtime_error on failure.
...
private:
  ...
  ModuleTable m_table;
  size_t m_baseOffset;
  std::unique_ptr<facebook::ReactABI14_0_0::JSBigBufferString> m_startupCode;
};
