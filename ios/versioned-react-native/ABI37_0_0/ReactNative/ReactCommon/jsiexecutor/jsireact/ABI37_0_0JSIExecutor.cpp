...
#include <ABI37_0_0cxxreact/ABI37_0_0ModuleRegistry.h>
#include <ABI37_0_0cxxreact/ABI37_0_0ReactMarker.h>
#include <ABI37_0_0cxxreact/ABI37_0_0SystraceSection.h>
...
void JSIExecutor::loadApplicationScript(
  ...
  bool hasLogger(ABI37_0_0ReactMarker::logTaggedMarker);
  std::string scriptName = simpleBasename(sourceURL);
  if (hasLogger) {
    ABI37_0_0ReactMarker::logTaggedMarker(
        ABI37_0_0ReactMarker::RUN_JS_BUNDLE_START, scriptName.c_str());
  }
  runtime_->evaluateJavaScript(
      std::make_unique<BigStringBuffer>(std::move(script)), sourceURL);
  flush();
  if (hasLogger) {
    ABI37_0_0ReactMarker::logMarker(ABI37_0_0ReactMarker::CREATE_REACT_CONTEXT_STOP);
    ABI37_0_0ReactMarker::logTaggedMarker(
        ABI37_0_0ReactMarker::RUN_JS_BUNDLE_STOP, scriptName.c_str());
  }
}
        ...
        *runtime_,
        ...
        Function::createFromHostFunction(
            *runtime_,
            ...
            [this](
                __unused Runtime &rt,
                const ABI37_0_0facebook::jsi::Value &,
...
void JSIExecutor::registerBundle(
  ...
  ABI37_0_0ReactMarker::logTaggedMarker(
      ABI37_0_0ReactMarker::REGISTER_JS_SEGMENT_START, tag.c_str());
  if (bundleRegistry_) {
  ...
  ABI37_0_0ReactMarker::logTaggedMarker(
      ABI37_0_0ReactMarker::REGISTER_JS_SEGMENT_STOP, tag.c_str());
}
...
Value JSIExecutor::nativeRequire(const Value *args, size_t count) {
  ...
  return ABI37_0_0facebook::jsi::Value();
}
