...
Pod::Spec.new do |s|
  ...
  s.dependency "ABI37_0_0React-graphics", version
  s.dependency "ABI37_0_0React-jsiexecutor", version
  ...
  s.subspec "attributedstring" do |ss|
    ...
    ss.header_dir           = "ABI37_0_0react/attributedstring"
  ...
  s.subspec "better" do |ss|
    ...
    ss.exclude_files        = "**/tests/*"
    ss.header_dir           = "ABI37_0_0better"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/Folly\"" }
  end

  s.subspec "config" do |ss|
    ss.source_files         = "config/*.{m,mm,cpp,h}"
    ss.header_dir           = "ABI37_0_0react/config"
  ...
  s.subspec "core" do |ss|
    ...
    ss.exclude_files        = "**/tests/**/*"
    ss.header_dir           = "ABI37_0_0react/core"
  ...
  s.subspec "components" do |ss|
    ss.subspec "activityindicator" do |sss|
      ...
      sss.header_dir           = "ABI37_0_0react/components/activityindicator"
    ...
    ss.subspec "image" do |sss|
      ...
      sss.exclude_files        = "**/tests/*"
      sss.header_dir           = "ABI37_0_0react/components/image"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/Folly\"" }
    end
    ...
    ss.subspec "rncore" do |sss|
      ...
      sss.header_dir           = "ABI37_0_0react/components/rncore"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/Folly\"" }
    end
    ...
    ss.subspec "root" do |sss|
      ...
      sss.exclude_files        = "**/tests/*"
      sss.header_dir           = "ABI37_0_0react/components/root"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/Folly\"" }
    end
    ...
    ss.subspec "scrollview" do |sss|
      ...
      sss.exclude_files        = "**/tests/*"
      sss.header_dir           = "ABI37_0_0react/components/scrollview"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/Folly\"" }
    end
    ...
    ss.subspec "slider" do |sss|
      ...
      sss.exclude_files        = "**/tests/*",
                                 "**/android/*"
      sss.header_dir           = "ABI37_0_0react/components/slider"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/Folly\"" }
    end
    ...
    ss.subspec "text" do |sss|
      ...
      sss.exclude_files        = "**/tests/*"
      sss.header_dir           = "ABI37_0_0react/components/text"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/Folly\"" }
    end
    ...
    ss.subspec "view" do |sss|
      ...
      sss.exclude_files        = "**/tests/*"
      sss.header_dir           = "ABI37_0_0react/components/view"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/Folly\"" }
    end
  end
  ...
  s.subspec "debug" do |ss|
    ...
    ss.exclude_files        = "**/tests/*"
    ss.header_dir           = "ABI37_0_0react/debug"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/Folly\"" }
  end

  s.subspec "imagemanager" do |ss|
    ss.dependency             "ABI37_0_0React-RCTImage", version
    ss.dependency             folly_dep_name, folly_version
    ss.compiler_flags       = folly_compiler_flags
    ss.source_files         = "fabric/imagemanager/**/*.{m,mm,cpp,h}"
    ss.exclude_files        = "**/tests/*",
                              "**/android/*"
    ss.header_dir           = "ABI37_0_0react/imagemanager"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/Folly\"" }
  end
  ...
  s.subspec "mounting" do |ss|
    ...
    ss.exclude_files        = "**/tests/*"
    ss.header_dir           = "ABI37_0_0react/mounting"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/Folly\"" }
  end
  ...
  s.subspec "textlayoutmanager" do |ss|
    ...
    ss.exclude_files        = "**/tests/*",
                              "**/android/*"
    ss.header_dir           = "ABI37_0_0react/textlayoutmanager"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/Folly\"" }
  end
  ...
  s.subspec "uimanager" do |ss|
    ...
    ss.exclude_files        = "**/tests/*",
    ss.header_dir           = "ABI37_0_0react/uimanager"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/Folly\"" }
  end

  s.subspec "utils" do |ss|
    ss.source_files         = "utils/*.{m,mm,cpp,h}"
    ss.header_dir           = "ABI37_0_0react/utils"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/Folly\"" }
  end
end
