...
inline static ABI37_0_0RCTResizeMode ABI37_0_0RCTResizeModeFromImageResizeMode(
    ImageResizeMode imageResizeMode) {
  switch (imageResizeMode) {
    case ImageResizeMode::Cover:
      return ABI37_0_0RCTResizeModeCover;
    case ImageResizeMode::Contain:
      return ABI37_0_0RCTResizeModeContain;
    case ImageResizeMode::Stretch:
      return ABI37_0_0RCTResizeModeStretch;
    case ImageResizeMode::Center:
      return ABI37_0_0RCTResizeModeCenter;
    case ImageResizeMode::Repeat:
      return ABI37_0_0RCTResizeModeRepeat;
  }
}
...
inline static NSURLRequest *NSURLRequestFromImageSource(
  ...
  if (!url) {
    ABI37_0_0RCTLogError(@"URI parsing error.");
    return nil;
  }
