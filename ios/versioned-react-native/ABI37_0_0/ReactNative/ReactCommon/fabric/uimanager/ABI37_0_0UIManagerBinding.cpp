...
#include "ABI37_0_0UIManagerBinding.h"
...
void UIManagerBinding::startSurface(
  ...
  if (runtime.global().hasProperty(runtime, "ABI37_0_0RN$SurfaceRegistry")) {
    auto registry =
        runtime.global().getPropertyAsObject(runtime, "ABI37_0_0RN$SurfaceRegistry");
...
void UIManagerBinding::stopSurface(jsi::Runtime &runtime, SurfaceId surfaceId)
    const {
  if (runtime.global().hasProperty(runtime, "ABI37_0_0RN$stopSurface")) {
    auto method =
        runtime.global().getPropertyAsFunction(runtime, "ABI37_0_0RN$stopSurface");
    method.call(runtime, {jsi::Value{surfaceId}});
  } else {
    auto module = getModule(runtime, "ABI37_0_0ReactFabric");
    auto method =
