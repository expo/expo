...
#include <ABI37_0_0React/components/rncore/ComponentDescriptors.h>
#include <ABI37_0_0React/components/scrollview/ScrollViewComponentDescriptor.h>
#include <ABI37_0_0React/components/view/ViewComponentDescriptor.h>
...
class MockABI37_0_0ReactNativeConfig : public ABI37_0_0ReactNativeConfig {
 public:
  MockABI37_0_0ReactNativeConfig() {}
...
std::shared_ptr<const ABI37_0_0ReactNativeConfig> mockABI37_0_0ReactNativeConfig_ =
    std::make_shared<const MockABI37_0_0ReactNativeConfig>();
...
TEST(UITemplateProcessorTest, testSimpleBytecode) {
  ...
  auto bytecode = R"delim({"version":0.1,"commands":[
    ["createNode",2,"ABI37_0_0RCTView",-1,{"opacity": 0.5, "testId": "root"}],
    ["createNode",4,"ABI37_0_0RCTView",2,{"testId": "child"}],
    ["returnRoot",2]
  ]})delim";
  ...
  auto root1 = UITemplateProcessor::buildShadowTree(
      ...
      *componentDescriptorRegistry,
      ...
      mockABI37_0_0ReactNativeConfig_);
#ifndef NDEBUG
...
TEST(UITemplateProcessorTest, testConditionalBytecode) {
  ...
  auto bytecode = R"delim({"version":0.1,"commands":[
    ["createNode",2,"ABI37_0_0RCTView",-1,{"testId": "root"}],
    ["loadNativeBool",1,"MobileConfig","getBool",["qe:simple_test"]],
    ["conditional",1,
      [["createNode",4,"ABI37_0_0RCTView",2,{"testId": "cond_true"}]],
      [["createNode",4,"ABI37_0_0RCTView",2,{"testId": "cond_false"}]]
    ],
    ["returnRoot",2]
  ]})delim";
