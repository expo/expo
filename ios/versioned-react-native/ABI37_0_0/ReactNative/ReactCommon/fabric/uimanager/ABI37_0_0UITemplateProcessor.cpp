...
#include "ABI37_0_0UITemplateProcessor.h"
...
#include <ABI37_0_0React/components/view/ViewShadowNode.h>
...
SharedShadowNode UITemplateProcessor::runCommand(
  ...
  if (opcode == "createNode") {
    ...
    registers[registerNumber] = ABI37_0_0ReactNativeConfig->getBool(param);
...
SharedShadowNode UITemplateProcessor::buildShadowTree(
  ...
  LOG(ERROR) << "ABI37_0_0React ui template missing returnRoot command :(";
