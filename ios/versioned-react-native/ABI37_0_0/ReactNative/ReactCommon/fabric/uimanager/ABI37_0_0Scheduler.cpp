...
#include <ABI37_0_0React/uimanager/UITemplateProcessor.h>
...
Scheduler::Scheduler(
  ...
  ABI37_0_0ReactNativeConfig_ =
      schedulerToolbox.contextContainer
          ->at<std::shared_ptr<const ABI37_0_0ReactNativeConfig>>("ABI37_0_0ReactNativeConfig");
...
void Scheduler::renderTemplateToSurface(
  ...
  try {
    ...
    LOG(ERROR) << "    >>>> ABI37_0_0EXCEPTION <<<  rendering uiTemplate in "
