...
#import "ABI37_0_0RCTFontUtils.h"
...
static ABI37_0_0RCTFontProperties ABI37_0_0RCTDefaultFontProperties()
{
  static ABI37_0_0RCTFontProperties defaultFontProperties;
  ...
  dispatch_once(&onceToken, ^{
    ...
    defaultFontProperties.style = ABI37_0_0RCTFontStyleNormal;
    defaultFontProperties.variant = ABI37_0_0RCTFontVariantDefault;
...
static ABI37_0_0RCTFontProperties ABI37_0_0RCTResolveFontProperties(
    ABI37_0_0RCTFontProperties fontProperties,
    ABI37_0_0RCTFontProperties baseFontProperties)
{
  ...
  fontProperties.style =
      fontProperties.style != ABI37_0_0RCTFontStyleUndefined ? fontProperties.style : baseFontProperties.style;
  fontProperties.variant =
      fontProperties.variant != ABI37_0_0RCTFontVariantUndefined ? fontProperties.variant : baseFontProperties.variant;
  return fontProperties;
}

static UIFontWeight ABI37_0_0RCTGetFontWeight(UIFont *font)
{
  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  return [traits[UIFontWeightTrait] doubleValue];
}

static ABI37_0_0RCTFontStyle ABI37_0_0RCTGetFontStyle(UIFont *font)
{
  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  ...
  if (symbolicTraits & UIFontDescriptorTraitItalic) {
    return ABI37_0_0RCTFontStyleItalic;
  }

  return ABI37_0_0RCTFontStyleNormal;
}

static NSArray *ABI37_0_0RCTFontFeatures(ABI37_0_0RCTFontVariant fontVariant)
{
  // FIXME:
  return @[];
}

static UIFont *ABI37_0_0RCTDefaultFontWithFontProperties(ABI37_0_0RCTFontProperties fontProperties)
{
  ...
  if (!font) {
    ...
    if (fontProperties.variant == ABI37_0_0RCTFontStyleItalic) {
...
UIFont *ABI37_0_0RCTFontWithFontProperties(ABI37_0_0RCTFontProperties fontProperties)
{
  ABI37_0_0RCTFontProperties defaultFontProperties = ABI37_0_0RCTDefaultFontProperties();
  fontProperties = ABI37_0_0RCTResolveFontProperties(fontProperties, defaultFontProperties);
  ...
  if ([fontProperties.family isEqualToString:defaultFontProperties.family]) {
    ...
    font = ABI37_0_0RCTDefaultFontWithFontProperties(fontProperties);
  } else {
    ...
    if (fontNames.count == 0) {
      ...
      for (NSString *name in fontNames) {
        ...
        if (ABI37_0_0RCTGetFontStyle(fontMatch) != fontProperties.style) {
          continue;
        }

        CGFloat testWeight = ABI37_0_0RCTGetFontWeight(fontMatch);
  ...
  if (fontProperties.variant != ABI37_0_0RCTFontVariantDefault) {
    NSArray *fontFeatures = ABI37_0_0RCTFontFeatures(fontProperties.variant);
    UIFontDescriptor *fontDescriptor = [font.fontDescriptor
