...
inline static NSTextAlignment ABI37_0_0RCTNSTextAlignmentFromTextAlignment(
...
inline static NSWritingDirection ABI37_0_0RCTNSWritingDirectionFromWritingDirection(
...
inline static ABI37_0_0RCTFontStyle ABI37_0_0RCTFontStyleFromFontStyle(FontStyle fontStyle) {
  switch (fontStyle) {
    ...
    case FontStyle::Oblique:
      return ABI37_0_0RCTFontStyleOblique;
  }
}

inline static ABI37_0_0RCTFontVariant ABI37_0_0RCTFontVariantFromFontVariant(
    FontVariant fontVariant) {
  return (ABI37_0_0RCTFontVariant)fontVariant;
}

inline static NSUnderlineStyle ABI37_0_0RCTNSUnderlineStyleFromStyleAndPattern(
...
inline static UIColor *ABI37_0_0RCTUIColorFromSharedColor(const SharedColor &color) {
