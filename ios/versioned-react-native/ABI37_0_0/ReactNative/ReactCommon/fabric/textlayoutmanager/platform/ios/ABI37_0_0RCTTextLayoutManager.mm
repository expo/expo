...
#import <ABI37_0_0React/utils/SimpleThreadSafeCache.h>

using namespace ABI37_0_0facebook::ABI37_0_0React;

@implementation ABI37_0_0RCTTextLayoutManager {
  SimpleThreadSafeCache<AttributedString, std::shared_ptr<const void>, 256> _cache;
}

static NSLineBreakMode ABI37_0_0RCTNSLineBreakModeFromWritingDirection(
...
- (ABI37_0_0facebook::ABI37_0_0React::Size)
  ...
  return ABI37_0_0facebook::ABI37_0_0React::Size{size.width, size.height};
}
...
- (NSTextStorage *)
  ...
  textContainer.lineBreakMode = paragraphAttributes.maximumNumberOfLines > 0
      ? ABI37_0_0RCTNSLineBreakModeFromWritingDirection(
...
- (SharedEventEmitter)
  ...
  if (textStorage.length > 0 && (fraction > 0 || characterIndex > 0) &&
    ...
    ABI37_0_0RCTWeakEventEmitterWrapper *eventEmitterWrapper =
        (ABI37_0_0RCTWeakEventEmitterWrapper *)[textStorage
                 attribute:ABI37_0_0RCTAttributedStringEventEmitterKey
...
- (NSAttributedString *)_nsAttributedStringFromAttributedString:(AttributedString)attributedString
{
  auto sharedNSAttributedString = _cache.get(attributedString, [](const AttributedString attributedString) {
    return std::shared_ptr<void>(
        (__bridge_retained void *)ABI37_0_0RCTNSAttributedStringFromAttributedString(attributedString), CFRelease);
  });
