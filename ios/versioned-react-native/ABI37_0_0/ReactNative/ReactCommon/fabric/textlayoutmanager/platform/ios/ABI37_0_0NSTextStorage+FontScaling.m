...
- (void)abi37_0_0_rct_scaleFontSizeToFitSize:(CGSize)size
  ...
  while (true) {
    ...
    ABI37_0_0RCTTextSizeComparisonOptions comparsion = [self abi37_0_0_rct_compareToSize:size
                                                   thresholdRatio:0.01];

    if ((comparsion & ABI37_0_0RCTTextSizeComparisonWithinRange) &&
...
- (ABI37_0_0RCTTextSizeComparisonOptions)abi37_0_0_rct_compareToSize:(CGSize)size
  ...
  result |=
      (fitsSize) ? ABI37_0_0RCTTextSizeComparisonSmaller : ABI37_0_0RCTTextSizeComparisonLarger;
