...
#include "ABI37_0_0YogaStylableProps.h"
...
#include "ABI37_0_0conversions.h"

namespace ABI37_0_0facebook {
namespace ABI37_0_0React {

YogaStylableProps::YogaStylableProps(ABI37_0_0YGStyle const &yogaStyle)
    : yogaStyle(yogaStyle) {}
...
SharedDebugStringConvertibleList YogaStylableProps::getDebugProps() const {
  auto const defaultYogaStyle = ABI37_0_0YGStyle{};
  return {
