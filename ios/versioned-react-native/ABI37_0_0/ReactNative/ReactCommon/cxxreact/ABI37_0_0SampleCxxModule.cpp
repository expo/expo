...
#include "ABI37_0_0SampleCxxModule.h"
...
namespace ABI37_0_0facebook { namespace xplat { namespace samples {
...
ABI37_0_0facebook::xplat::module::CxxModule *SampleCxxModule() {
  return new ABI37_0_0facebook::xplat::samples::SampleCxxModule(
    folly::make_unique<ABI37_0_0facebook::xplat::samples::Sample>());
}
