...
#include <ABI37_0_0cxxreact/ABI37_0_0NativeModule.h>
...
class ABI37_0_0RN_EXPORT CxxNativeModule : public NativeModule {
public:
  ...
  void invoke(unsigned int ABI37_0_0ReactMethodId, folly::dynamic&& params, int callId) override;
