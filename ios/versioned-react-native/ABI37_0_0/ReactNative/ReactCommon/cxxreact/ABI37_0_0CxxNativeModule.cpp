...
#include "ABI37_0_0CxxNativeModule.h"
...
#include "ABI37_0_0JsArgumentHelpers.h"
...
void CxxNativeModule::invoke(unsigned int ABI37_0_0ReactMethodId, folly::dynamic&& params, int callId) {
  if (ABI37_0_0ReactMethodId >= methods_.size()) {
    throw std::invalid_argument(folly::to<std::string>("methodId ", ABI37_0_0ReactMethodId,
  ...
  const auto& method = methods_[ABI37_0_0ReactMethodId];
