...
class JSI_EXPORT TurboCxxModule : public TurboModule {
 public:
  TurboCxxModule(
      std::unique_ptr<ABI37_0_0facebook::xplat::module::CxxModule> cxxModule,
 ...
 private:
  std::vector<ABI37_0_0facebook::xplat::module::CxxModule::Method> cxxMethods_;
  std::unique_ptr<ABI37_0_0facebook::xplat::module::CxxModule> cxxModule_;
};
