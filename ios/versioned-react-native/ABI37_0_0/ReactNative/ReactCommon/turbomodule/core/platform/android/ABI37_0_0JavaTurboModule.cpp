...
#include <ABI37_0_0React/jni/NativeMap.h>
#include <ABI37_0_0React/jni/ReadableNativeMap.h>
#include <ABI37_0_0React/jni/WritableNativeMap.h>

#include "ABI37_0_0JavaTurboModule.h"
...
JavaTurboModule::createJavaCallbackFromJSIFunction(
    ...
    jsi::Runtime &rt,
    std::shared_ptr<JSCallInvoker> jsInvoker) {
  auto wrapper = std::make_shared<ABI37_0_0React::CallbackWrapper>(
...
std::vector<jvalue> JavaTurboModule::convertJSIArgsToJNIArgs(
  ...
  for (unsigned int argIndex = 0; argIndex < count; argIndex += 1) {
    ...
    if (!(type == "Ljava/lang/Double;" || type == "Ljava/lang/Boolean;" ||
          ...
          type == "Lcom/facebook/ABI37_0_0React/bridge/ReadableArray;" ||
          type == "Lcom/facebook/ABI37_0_0React/bridge/Callback;" ||
          type == "Lcom/facebook/ABI37_0_0React/bridge/ReadableMap;")) {
    ...
    if (type == "Lcom/facebook/ABI37_0_0React/bridge/ReadableArray;") {
    ...
    if (type == "Lcom/facebook/ABI37_0_0React/bridge/Callback;") {
    ...
    if (type == "Lcom/facebook/ABI37_0_0React/bridge/ReadableMap;") {
      if (!(arg->isObject())) {
        throw JavaTurboModuleArgumentConversionException(
...
jsi::Value convertFromJMapToValue(JNIEnv *env, jsi::Runtime &rt, jobject arg) {
  ...
  jclass jArguments = env->FindClass("com/facebook/ABI37_0_0React/bridge/Arguments");
  static jmethodID jMakeNativeMap = env->GetStaticMethodID(
      jArguments,
      "makeNativeMap",
      "(Ljava/util/Map;)Lcom/facebook/ABI37_0_0React/bridge/WritableNativeMap;");
  auto constants =
    ...
    case PromiseKind: {
      ...
      jsi::Function promiseConstructorArg = jsi::Function::createFromHostFunction(
          ...
          [this, &jargs, count, instance, methodID, env](
            ...
            jclass cls =
                env->FindClass("com/facebook/ABI37_0_0React/bridge/PromiseImpl");
            jmethodID constructor = env->GetMethodID(
                cls,
                "<init>",
                "(Lcom/facebook/ABI37_0_0React/bridge/Callback;Lcom/facebook/ABI37_0_0React/bridge/Callback;)V");
