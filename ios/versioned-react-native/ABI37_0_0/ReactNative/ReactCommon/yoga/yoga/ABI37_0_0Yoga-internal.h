...
using ABI37_0_0YGVector = std::vector<ABI37_0_0YGNodeRef>;
...
extern const std::array<ABI37_0_0YGEdge, 4> trailing;
extern const std::array<ABI37_0_0YGEdge, 4> leading;
...
struct ABI37_0_0YGCachedMeasurement {
  float availableWidth;
  float availableHeight;
  ...
  ABI37_0_0YGCachedMeasurement()
      : availableWidth(0),
        availableHeight(0),
        widthMeasureMode((ABI37_0_0YGMeasureMode) -1),
        heightMeasureMode((ABI37_0_0YGMeasureMode) -1),
        computedWidth(-1),
        computedHeight(-1) {}

  bool operator==(ABI37_0_0YGCachedMeasurement measurement) const {
...
#define ABI37_0_0YG_MAX_CACHED_RESULT_COUNT 8
...
public:
  Values() = default;
  explicit Values(const ABI37_0_0YGValue& defaultValue) noexcept {
  ...
  template <size_t I>
  ABI37_0_0YGValue get() const noexcept {
    return std::get<I>(values_);
  }

  template <size_t I>
  void set(ABI37_0_0YGValue& value) noexcept {
...
extern bool ABI37_0_0YGFloatsEqual(const float a, const float b);
extern ABI37_0_0facebook::yoga::detail::CompactValue ABI37_0_0YGComputedEdgeValue(
    const ABI37_0_0facebook::yoga::detail::Values<
        ABI37_0_0facebook::yoga::enums::count<ABI37_0_0YGEdge>()>& edges,
    ABI37_0_0YGEdge edge,
    ABI37_0_0facebook::yoga::detail::CompactValue defaultValue);
