...
ABI37_0_0YGFlexDirection ABI37_0_0YGFlexDirectionCross(
  ...
  return ABI37_0_0YGFlexDirectionIsColumn(flexDirection)
...
bool ABI37_0_0YGValueEqual(const ABI37_0_0YGValue& a, const ABI37_0_0YGValue& b) {
  ...
  if (a.unit == ABI37_0_0YGUnitUndefined ||
...
ABI37_0_0YGFloatOptional ABI37_0_0YGFloatOptionalMax(ABI37_0_0YGFloatOptional op1, ABI37_0_0YGFloatOptional op2) {
  if (op1 >= op2) {
    return op1;
  }
  if (op2 > op1) {
