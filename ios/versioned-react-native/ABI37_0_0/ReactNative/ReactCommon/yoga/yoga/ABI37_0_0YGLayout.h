...
struct ABI37_0_0YGLayout {
  std::array<float, 4> position = {};
  std::array<float, 2> dimensions = {{ABI37_0_0YGUndefined, ABI37_0_0YGUndefined}};
...
private:
  ...
  ABI37_0_0facebook::yoga::Bitfield<uint8_t, ABI37_0_0YGDirection, bool, bool, bool> flags_ =
      {ABI37_0_0YGDirectionInherit, false, false, false};

public:
  uint32_t computedFlexBasisGeneration = 0;
  ABI37_0_0YGFloatOptional computedFlexBasis = {};

  // Instead of recomputing the entire layout every single time, we cache some
  // information to break early when nothing changed
  uint32_t generationCount = 0;
  ABI37_0_0YGDirection lastOwnerDirection = (ABI37_0_0YGDirection) -1;

  uint32_t nextCachedMeasurementsIndex = 0;
  std::array<ABI37_0_0YGCachedMeasurement, ABI37_0_0YG_MAX_CACHED_RESULT_COUNT>
      cachedMeasurements = {};
  std::array<float, 2> measuredDimensions = {{ABI37_0_0YGUndefined, ABI37_0_0YGUndefined}};

  ABI37_0_0YGCachedMeasurement cachedLayout = ABI37_0_0YGCachedMeasurement();
  ...
  bool operator==(ABI37_0_0YGLayout layout) const;
  bool operator!=(ABI37_0_0YGLayout layout) const { return !(*this == layout); }
};
