...
header_subspecs = {
  ...
  'RCTBlobHeaders'              => 'Libraries/Blob/{ABI37_0_0RCTBlobManager,ABI37_0_0RCTFileReaderModule}.h',
...
Pod::Spec.new do |s|
  ...
  s.user_target_xcconfig   = { "HEADER_SEARCH_PATHS" => "\"$(PODS_ROOT)/Headers/Private/ABI37_0_0React-Core\""}
  ...
  s.subspec "DevSupport" do |ss|
    ...
    ss.dependency "ABI37_0_0React-Core/Default", version
    ss.dependency "ABI37_0_0React-Core/RCTWebSocket", version
    ss.dependency "ABI37_0_0React-jsinspector", version
  end
  ...
  header_subspecs.each do |name, headers|
    s.subspec name do |ss|
      ...
      ss.dependency "ABI37_0_0React-Core/Default"
    end
  end

  s.dependency "Folly", folly_version
  s.dependency "ABI37_0_0React-cxxreact", version
  s.dependency "ABI37_0_0React-jsi", version
  s.dependency "ABI37_0_0React-jsiexecutor", version
  s.dependency "ABI37_0_0Yoga"
  s.dependency "glog"
end
