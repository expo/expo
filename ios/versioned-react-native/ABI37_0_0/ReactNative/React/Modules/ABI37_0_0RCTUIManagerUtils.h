 ...
 *  1. `ABI37_0_0RCTAssertUIManagerQueue` is okay with execution on both actual UIManager and
 *     Pseudo UIManager queues.
 *  2. Both `ABI37_0_0RCTExecuteOnUIManagerQueue` and `ABI37_0_0RCTUnsafeExecuteOnUIManagerQueueSync`
 *     execute given block *synchronously* if they were called on actual UIManager
 *     or Pseudo UIManager queues.
 *  3. `ABI37_0_0RCTExecuteOnMainQueue` executes given block *synchronously* if we already on
 *     the Main queue.
 *  4. `ABI37_0_0RCTUnsafeExecuteOnUIManagerQueueSync` is smart enough to do the trick:
 ...
 * *explicitly* block the Main queue via calling `ABI37_0_0RCTUnsafeExecuteOnMainQueueSync`.
 ...
 */
ABI37_0_0RCT_EXTERN dispatch_queue_t ABI37_0_0RCTGetUIManagerQueue(void);

/**
 * Default name for the UIManager queue.
 */
ABI37_0_0RCT_EXTERN char *const ABI37_0_0RCTUIManagerQueueName;

/**
 * Check if we are currently on UIManager queue.
 * Please do not use this unless you really know what you're doing.
 */
ABI37_0_0RCT_EXTERN BOOL ABI37_0_0RCTIsUIManagerQueue(void);

/**
 * Check if we are currently on Pseudo UIManager queue.
 * Please do not use this unless you really know what you're doing.
 */
ABI37_0_0RCT_EXTERN BOOL ABI37_0_0RCTIsPseudoUIManagerQueue(void);
 ...
 */
ABI37_0_0RCT_EXTERN void ABI37_0_0RCTExecuteOnUIManagerQueue(dispatch_block_t block);
 ...
 * Please do not use this unless you really know what you're doing.
 */
ABI37_0_0RCT_EXTERN void ABI37_0_0RCTUnsafeExecuteOnUIManagerQueueSync(dispatch_block_t block);

/**
 * Convenience macro for asserting that we're running on UIManager queue.
 */
#define ABI37_0_0RCTAssertUIManagerQueue() ABI37_0_0RCTAssert(ABI37_0_0RCTIsUIManagerQueue() || ABI37_0_0RCTIsPseudoUIManagerQueue(), \
@"This function must be called on the UIManager queue")

/**
 * Returns new unique root view tag.
 */
ABI37_0_0RCT_EXTERN NSNumber *ABI37_0_0RCTAllocateRootViewTag(void);
