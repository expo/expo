...
typedef dispatch_block_t ABI37_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI37_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ABI37_0_0React-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI37_0_0RCTUIManager's observers.
 */
@interface ABI37_0_0RCTUIManagerObserverCoordinator : NSObject <ABI37_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI37_0_0RCTUIManagerObserver` protocol for more info.
