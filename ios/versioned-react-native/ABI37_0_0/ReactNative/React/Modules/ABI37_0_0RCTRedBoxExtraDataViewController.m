...
@interface ABI37_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI37_0_0RCTRedBoxExtraDataCell
...
@interface ABI37_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI37_0_0RCTRedBoxExtraDataViewController
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ABI37_0_0RCTRedBoxExtraDataCell *cell =
            (ABI37_0_0RCTRedBoxExtraDataCell *)[tableView
            dequeueReusableCellWithIdentifier:reuseIdentifier];

    if (cell == nil) {
        cell = [[ABI37_0_0RCTRedBoxExtraDataCell alloc]
