...
#import "ABI37_0_0RCTKeyboardObserver.h"

#import "ABI37_0_0RCTEventDispatcher.h"

static NSDictionary *ABI37_0_0RCTParseKeyboardNotification(NSNotification *notification);

@implementation ABI37_0_0RCTKeyboardObserver
...
{ \
  ...
  [self sendEventWithName:@#EVENT \
    body:ABI37_0_0RCTParseKeyboardNotification(notification)]; \
}
...
NS_INLINE NSDictionary *ABI37_0_0RCTRectDictionaryValue(CGRect rect)
{
  return @{
...
static NSString *ABI37_0_0RCTAnimationNameForCurve(UIViewAnimationCurve curve)
{
  switch (curve) {
...
static NSDictionary *ABI37_0_0RCTParseKeyboardNotification(NSNotification *notification)
{
  ...
  return @{
    @"startCoordinates": ABI37_0_0RCTRectDictionaryValue(beginFrame),
    @"endCoordinates": ABI37_0_0RCTRectDictionaryValue(endFrame),
    @"duration": @(duration * 1000.0), // ms
    @"easing": ABI37_0_0RCTAnimationNameForCurve(curve),
