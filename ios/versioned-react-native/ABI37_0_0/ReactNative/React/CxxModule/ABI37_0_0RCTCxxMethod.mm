...
#import <ABI37_0_0cxxreact/ABI37_0_0JsArgumentHelpers.h>
#import <folly/Memory.h>

#import "ABI37_0_0RCTCxxUtils.h"

using ABI37_0_0facebook::xplat::module::CxxModule;
using namespace ABI37_0_0facebook::ABI37_0_0React;

@implementation ABI37_0_0RCTCxxMethod
{
             ...
             arguments:(NSArray *)arguments
{
  ...
  if (arguments.count < _method->callbacks) {
    ABI37_0_0RCTLogError(@"Method %@.%s expects at least %zu arguments, but got %tu",
                ABI37_0_0RCTBridgeModuleNameForClass([module class]), _method->name.c_str(),
  ...
  if (_method->callbacks >= 1) {
    if (![arguments[arguments.count - 1] isKindOfClass:[NSNumber class]]) {
      ABI37_0_0RCTLogError(@"Argument %tu (%@) of %@.%s should be a function",
  ...
  } catch (const ABI37_0_0facebook::xplat::JsArgumentException &ex) {
    ABI37_0_0RCTLogError(@"Method %@.%s argument error: %s",
                ABI37_0_0RCTBridgeModuleNameForClass([module class]), _method->name.c_str(),
                ex.what());
    return nil;
  }
