...
@implementation ABI37_0_0RCTSafeAreaView {
...
{
  if (UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI37_0_0RCTScreenScale())) {
    return;
  }

  _currentSafeAreaInsets = safeAreaInsets;

  ABI37_0_0RCTSafeAreaViewLocalData *localData = [[ABI37_0_0RCTSafeAreaViewLocalData alloc] initWithInsets:safeAreaInsets];
