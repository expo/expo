...
@protocol ABI37_0_0RCTAutoInsetsProtocol;

@class ABI37_0_0RCTView;

@interface ABI37_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI37_0_0RCTDirectEventBlock onAccessibilityAction;
@property (nonatomic, copy) ABI37_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI37_0_0RCTDirectEventBlock onMagicTap;
@property (nonatomic, copy) ABI37_0_0RCTDirectEventBlock onAccessibilityEscape;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI37_0_0RCTPointerEvents pointerEvents;
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI37_0_0RCTBorderStyle borderStyle;
