...
typedef UIFont *(^ABI37_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ABI37_0_0React Native will use the System font for rendering by default. If you want to
 ...
 */
ABI37_0_0RCT_EXTERN void ABI37_0_0RCTSetDefaultFontHandler(ABI37_0_0RCTFontHandler handler);
ABI37_0_0RCT_EXTERN BOOL ABI37_0_0RCTHasFontHandlerSet(void);

@interface ABI37_0_0RCTFont : NSObject
...
@interface ABI37_0_0RCTConvert (ABI37_0_0RCTFont)
