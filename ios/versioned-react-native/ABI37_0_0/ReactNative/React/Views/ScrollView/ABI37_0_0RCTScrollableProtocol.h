...
/**
 * Contains any methods related to scrolling. Any `ABI37_0_0RCTView` that has scrolling
 * features should implement these methods.
 */
@protocol ABI37_0_0RCTScrollableProtocol
 ...
 */
@protocol ABI37_0_0RCTCustomRefreshContolProtocol
