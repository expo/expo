...
@protocol ABI37_0_0RCTPackagerClientMethod;
@class ABI37_0_0RCTPackagerClientResponder;

typedef uint32_t ABI37_0_0RCTHandlerToken;
typedef void (^ABI37_0_0RCTNotificationHandler)(NSDictionary<NSString *, id> *);
typedef void (^ABI37_0_0RCTRequestHandler)(NSDictionary<NSString *, id> *, ABI37_0_0RCTPackagerClientResponder *);
typedef void (^ABI37_0_0RCTConnectedHandler)(void);

/** Encapsulates singleton connection to ABI37_0_0React Native packager. */
@interface ABI37_0_0RCTPackagerConnection : NSObject
 ...
 */
- (ABI37_0_0RCTHandlerToken)addNotificationHandler:(ABI37_0_0RCTNotificationHandler)handler
 ...
 */
- (ABI37_0_0RCTHandlerToken)addRequestHandler:(ABI37_0_0RCTRequestHandler)handler
                               queue:(dispatch_queue_t)queue
                           forMethod:(NSString *)method;
 ...
 */
- (ABI37_0_0RCTHandlerToken)addConnectedHandler:(ABI37_0_0RCTConnectedHandler)handler
                                 queue:(dispatch_queue_t)queue;
 ...
 */
- (void)addHandler:(id<ABI37_0_0RCTPackagerClientMethod>)handler
