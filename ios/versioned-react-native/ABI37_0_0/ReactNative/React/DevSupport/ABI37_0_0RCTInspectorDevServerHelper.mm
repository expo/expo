...
static NSURL *getInspectorDeviceUrl(NSURL *bundleURL)
{
  ...
  NSString *inspectorProxyPortStr = [[[NSProcessInfo processInfo] environment] objectForKey:@"ABI37_0_0RCT_METRO_PORT"];
...
static NSURL *getAttachDeviceUrl(NSURL *bundleURL, NSString *title)
{
  ...
  NSString *metroBundlerPortStr = [[[NSProcessInfo processInfo] environment] objectForKey:@"ABI37_0_0RCT_METRO_PORT"];
...
@implementation ABI37_0_0RCTInspectorDevServerHelper

ABI37_0_0RCT_NOT_IMPLEMENTED(- (instancetype)init)

static NSMutableDictionary<NSString *, ABI37_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
...
+ (ABI37_0_0RCTInspectorPackagerConnection *)connectWithBundleURL:(NSURL *)bundleURL
{
  ...
  ABI37_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection) {
    connection = [[ABI37_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
