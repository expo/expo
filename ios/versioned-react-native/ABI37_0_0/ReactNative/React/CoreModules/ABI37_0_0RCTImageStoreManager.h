...
@interface ABI37_0_0RCTImageStoreManager : NSObject <ABI37_0_0RCTURLRequestHandler>
...
@interface ABI37_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI37_0_0RCTBridge (ABI37_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI37_0_0RCTImageStoreManager *imageStoreManager;
