...
@protocol ABI37_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI37_0_0RCTExceptionsManager : NSObject <ABI37_0_0RCTBridgeModule>
...
@property (nonatomic, weak) id<ABI37_0_0RCTExceptionsManagerDelegate> delegate;
