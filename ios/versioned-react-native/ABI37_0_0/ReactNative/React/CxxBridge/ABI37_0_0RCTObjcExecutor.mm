...
#import <ABI37_0_0cxxreact/ABI37_0_0JSBigString.h>
...
class ABI37_0_0RCTObjcExecutor : public JSExecutor {
public:
  ABI37_0_0RCTObjcExecutor(id<ABI37_0_0RCTJavaScriptExecutor> jse,
                  ABI37_0_0RCTJavaScriptCompleteBlock errorBlock,
  ...
  void setBundleRegistry(std::unique_ptr<RAMBundleRegistry>) override {
    ABI37_0_0RCTAssert(NO, @"RAM bundles are not supported in ABI37_0_0RCTObjcExecutor");
  }
...
private:
  ...
  ABI37_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI37_0_0RCTObjcExecutorFactory::ABI37_0_0RCTObjcExecutorFactory(
  id<ABI37_0_0RCTJavaScriptExecutor> jse, ABI37_0_0RCTJavaScriptCompleteBlock errorBlock)
  : m_jse(jse)
  , m_errorBlock(errorBlock) {}

std::unique_ptr<JSExecutor> ABI37_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue) {
  return std::unique_ptr<JSExecutor>(
    new ABI37_0_0RCTObjcExecutor(m_jse, m_errorBlock, jsQueue, delegate));
}
