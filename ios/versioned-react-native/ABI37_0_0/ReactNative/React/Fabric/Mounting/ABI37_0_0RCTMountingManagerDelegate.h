 ...
 */
@protocol ABI37_0_0RCTMountingManagerDelegate <NSObject>
 ...
 */
- (void)mountingManager:(ABI37_0_0RCTMountingManager *)mountingManager willMountComponentsWithRootTag:(ABI37_0_0ReactTag)MountingManager;
