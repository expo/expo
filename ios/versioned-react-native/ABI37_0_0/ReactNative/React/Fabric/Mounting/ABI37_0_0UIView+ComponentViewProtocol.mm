...
#import "ABI37_0_0UIView+ComponentViewProtocol.h"
...
{
  ABI37_0_0RCTAssert(NO, @"`-[ABI37_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented in a concrete class.");
  return {};
}
...
{
  ABI37_0_0RCTAssert(childComponentView.superview == self, @"Attempt to unmount improperly mounted component view.");
           ...
           oldLayoutMetrics:(LayoutMetrics const &)oldLayoutMetrics
{
  if (layoutMetrics.frame != oldLayoutMetrics.frame) {
    CGRect frame = ABI37_0_0RCTCGRectFromRect(layoutMetrics.frame);
...
{
  ABI37_0_0RCTAssert(NO, @"props access should be implemented by ABI37_0_0RCTViewComponentView.");
  return nullptr;
}
