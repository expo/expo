...
#import <ABI37_0_0React/components/view/ViewComponentDescriptor.h>
#import <ABI37_0_0React/components/view/ViewEventEmitter.h>
#import <ABI37_0_0React/components/view/ViewProps.h>

#import "ABI37_0_0RCTConversions.h"

using namespace ABI37_0_0facebook::ABI37_0_0React;

@implementation ABI37_0_0RCTViewComponentView {
...
- (void)layoutSubviews
{
  ...
  if (_contentView) {
    _contentView.frame = ABI37_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
  }
}
...
{
  ABI37_0_0RCTAssert(
      self == [ABI37_0_0RCTViewComponentView class],
      @"`+[ABI37_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented for all subclasses (and `%@` particularly).",
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  ABI37_0_0RCTAssert(
      propsRawPtr &&
          ([self class] == [ABI37_0_0RCTViewComponentView class] ||
           typeid(*propsRawPtr).hash_code() != typeid(ViewProps const).hash_code()),
      @"`ABI37_0_0RCTViewComponentView` subclasses (and `%@` particularly) must setup `_props`"
  ...
  if (oldViewProps.backgroundColor != newViewProps.backgroundColor) {
    self.backgroundColor = ABI37_0_0RCTUIColorFromSharedColor(newViewProps.backgroundColor);
    needsInvalidateLayer = YES;
  }

  // `foregroundColor`
  if (oldViewProps.foregroundColor != newViewProps.foregroundColor) {
    self.foregroundColor = ABI37_0_0RCTUIColorFromSharedColor(newViewProps.foregroundColor);
  }

  // `shadowColor`
  if (oldViewProps.shadowColor != newViewProps.shadowColor) {
    CGColorRef shadowColor = ABI37_0_0RCTCGColorRefFromSharedColor(newViewProps.shadowColor);
  ...
  if (oldViewProps.shadowOffset != newViewProps.shadowOffset) {
    self.layer.shadowOffset = ABI37_0_0RCTCGSizeFromSize(newViewProps.shadowOffset);
    needsInvalidateLayer = YES;
  }
  ...
  if (oldViewProps.transform != newViewProps.transform) {
    self.layer.transform = ABI37_0_0RCTCATransform3DFromTransformMatrix(newViewProps.transform);
    self.layer.allowsEdgeAntialiasing = newViewProps.transform != Transform::Identity();
  }

  // `hitSlop`
  if (oldViewProps.hitSlop != newViewProps.hitSlop) {
    self.hitTestEdgeInsets = ABI37_0_0RCTUIEdgeInsetsFromEdgeInsets(newViewProps.hitSlop);
  }
  ...
  if (oldViewProps.nativeId != newViewProps.nativeId) {
    self.nativeId = ABI37_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.nativeId);
  }
  ...
  if (oldViewProps.accessibilityLabel != newViewProps.accessibilityLabel) {
    self.accessibilityElement.accessibilityLabel = ABI37_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityLabel);
  }

  // `accessibilityHint`
  if (oldViewProps.accessibilityHint != newViewProps.accessibilityHint) {
    self.accessibilityElement.accessibilityHint = ABI37_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityHint);
  }
...
static ABI37_0_0RCTCornerRadii ABI37_0_0RCTCornerRadiiFromBorderRadii(BorderRadii borderRadii)
{
  return ABI37_0_0RCTCornerRadii{.topLeft = (CGFloat)borderRadii.topLeft,
...
static ABI37_0_0RCTBorderColors ABI37_0_0RCTBorderColorsFromBorderColors(BorderColors borderColors)
{
  return ABI37_0_0RCTBorderColors{.left = ABI37_0_0RCTCGColorRefUnretainedFromSharedColor(borderColors.left),
                         .top = ABI37_0_0RCTCGColorRefUnretainedFromSharedColor(borderColors.top),
                         .bottom = ABI37_0_0RCTCGColorRefUnretainedFromSharedColor(borderColors.bottom),
                         .right = ABI37_0_0RCTCGColorRefUnretainedFromSharedColor(borderColors.right)};
}
...
static ABI37_0_0RCTBorderStyle ABI37_0_0RCTBorderStyleFromBorderStyle(BorderStyle borderStyle)
{
  switch (borderStyle) {
    case BorderStyle::Solid:
      return ABI37_0_0RCTBorderStyleSolid;
    case BorderStyle::Dotted:
      return ABI37_0_0RCTBorderStyleDotted;
    case BorderStyle::Dashed:
      return ABI37_0_0RCTBorderStyleDashed;
  }
}
...
- (void)invalidateLayer
{
  ...
  if (layerHasShadow) {
    if (CGColorGetAlpha(_backgroundColor.CGColor) > 0.999) {
      ...
      ABI37_0_0RCTCornerInsets const cornerInsets =
          ABI37_0_0RCTGetCornerInsets(ABI37_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero);
      CGPathRef shadowPath = ABI37_0_0RCTPathCreateWithRoundedRect(self.bounds, cornerInsets, nil);
  ...
  if (useCoreAnimationBorderRendering) {
    ...
    CGColorRef borderColor = ABI37_0_0RCTCGColorRefFromSharedColor(borderMetrics.borderColors.left);
    ...
    UIImage *image = ABI37_0_0RCTGetBorderImage(
        ABI37_0_0RCTBorderStyleFromBorderStyle(borderMetrics.borderStyles.left),
        layer.bounds.size,
        ABI37_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii),
        UIEdgeInsetsFromBorderInsets(borderMetrics.borderWidths),
        ABI37_0_0RCTBorderColorsFromBorderColors(borderMetrics.borderColors),
    ...
    if (self.clipsToBounds) {
      if (borderMetrics.borderRadii.isUniform()) {
        ...
        CGPathRef path = ABI37_0_0RCTPathCreateWithRoundedRect(
            self.bounds,
            ABI37_0_0RCTGetCornerInsets(ABI37_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero),
            nil);
...
- (NSArray<UIAccessibilityCustomAction *> *)accessibilityCustomActions
{
  ...
  for (auto const &accessibilityAction : accessibilityActions) {
    [customActions
        addObject:[[UIAccessibilityCustomAction alloc] initWithName:ABI37_0_0RCTNSStringFromString(accessibilityAction)
                                                             target:self
...
{
  _eventEmitter->onAccessibilityAction(ABI37_0_0RCTStringFromNSString(action.name));
  return YES;
}
...
{
  return ABI37_0_0RCTNSStringFromString([[self class] componentDescriptorProvider].name);
}
