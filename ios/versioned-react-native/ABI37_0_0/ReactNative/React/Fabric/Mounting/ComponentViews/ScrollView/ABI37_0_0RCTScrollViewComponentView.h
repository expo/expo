...
#import <ABI37_0_0React/ABI37_0_0RCTGenericDelegateSplitter.h>
 ...
 */
@interface ABI37_0_0RCTScrollViewComponentView : ABI37_0_0RCTViewComponentView

/*
 * Finds and returns the closet ABI37_0_0RCTScrollViewComponentView component to the given view
 */
...
@property (nonatomic, strong, readonly)
    ABI37_0_0RCTGenericDelegateSplitter<id<UIScrollViewDelegate>> *scrollViewDelegateSplitter;

@end

/*
 * ABI37_0_0RCTScrollableProtocol is a protocol which ABI37_0_0RCTScrollViewManager uses to communicate with all kinds of `UIScrollView`s.
 ...
 */
@interface ABI37_0_0RCTScrollViewComponentView (ScrollableProtocol) <ABI37_0_0RCTScrollableProtocol>
