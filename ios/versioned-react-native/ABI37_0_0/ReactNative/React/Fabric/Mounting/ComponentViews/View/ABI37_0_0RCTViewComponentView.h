...
#import <ABI37_0_0React/ABI37_0_0RCTTouchableComponentViewProtocol.h>
#import <ABI37_0_0React/ABI37_0_0UIView+ComponentViewProtocol.h>
 ...
 */
@interface ABI37_0_0RCTViewComponentView : UIView <ABI37_0_0RCTComponentViewProtocol, ABI37_0_0RCTTouchableComponentViewProtocol> {
 @protected
  ABI37_0_0facebook::ABI37_0_0React::LayoutMetrics _layoutMetrics;
  ABI37_0_0facebook::ABI37_0_0React::SharedViewProps _props;
  ABI37_0_0facebook::ABI37_0_0React::SharedViewEventEmitter _eventEmitter;
}
...
/**
 * Enforcing `call super` semantic for overridden methods from `ABI37_0_0RCTComponentViewProtocol`.
 * The methods update the instance variables.
 */
- (void)updateProps:(ABI37_0_0facebook::ABI37_0_0React::Props::Shared const &)props
           oldProps:(ABI37_0_0facebook::ABI37_0_0React::Props::Shared const &)oldProps NS_REQUIRES_SUPER;
- (void)updateEventEmitter:(ABI37_0_0facebook::ABI37_0_0React::EventEmitter::Shared const &)eventEmitter NS_REQUIRES_SUPER;
- (void)updateLayoutMetrics:(ABI37_0_0facebook::ABI37_0_0React::LayoutMetrics const &)layoutMetrics
           oldLayoutMetrics:(ABI37_0_0facebook::ABI37_0_0React::LayoutMetrics const &)oldLayoutMetrics NS_REQUIRES_SUPER;
