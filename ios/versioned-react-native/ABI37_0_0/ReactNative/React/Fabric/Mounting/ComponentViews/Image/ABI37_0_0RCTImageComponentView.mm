...
#import <ABI37_0_0React/components/image/ImageComponentDescriptor.h>
#import <ABI37_0_0React/components/image/ImageEventEmitter.h>
#import <ABI37_0_0React/components/image/ImageLocalData.h>
#import <ABI37_0_0React/components/image/ImageProps.h>
#import <ABI37_0_0React/imagemanager/ImageRequest.h>
#import <ABI37_0_0React/imagemanager/ABI37_0_0RCTImagePrimitivesConversions.h>

#import "ABI37_0_0RCTConversions.h"

@implementation ABI37_0_0RCTImageComponentView {
  UIImageView *_imageView;
  SharedImageLocalData _imageLocalData;
  const ImageResponseObserverCoordinator *_coordinator;
  std::unique_ptr<ABI37_0_0RCTImageResponseObserverProxy> _imageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _imageView.contentMode = (UIViewContentMode)ABI37_0_0RCTResizeModeFromImageResizeMode(defaultProps->resizeMode);

    _imageResponseObserverProxy = std::make_unique<ABI37_0_0RCTImageResponseObserverProxy>((__bridge void *)self);
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldImageProps.resizeMode != newImageProps.resizeMode) {
    if (newImageProps.resizeMode == ImageResizeMode::Repeat) {
      ...
      _imageView.contentMode = (UIViewContentMode)ABI37_0_0RCTResizeModeFromImageResizeMode(newImageProps.resizeMode);
    }
  }
...
- (void)didReceiveImage:(UIImage *)image fromObserver:(void *)observer
{
  ...
  if (imageProps.resizeMode == ImageResizeMode::Repeat) {
    image = [image resizableImageWithCapInsets:ABI37_0_0RCTUIEdgeInsetsFromEdgeInsets(imageProps.capInsets)
