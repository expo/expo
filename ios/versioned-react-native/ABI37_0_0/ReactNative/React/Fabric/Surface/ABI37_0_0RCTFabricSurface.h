...
@class ABI37_0_0RCTSurfaceView;
@class ABI37_0_0RCTSurfacePresenter;
@protocol ABI37_0_0RCTSurfaceDelegate;

/**
 * (This is Fabric-compatible ABI37_0_0RCTSurface implementation.)
 *
 * ABI37_0_0RCTSurface instance represents ABI37_0_0React Native-powered piece of a user interface
 * which can be a full-screen app, separate modal view controller,
 * or even small widget.
 * It is called "Surface".
 *
 * The ABI37_0_0RCTSurface instance is completely thread-safe by design;
 ...
 *
 * The primary goals of the ABI37_0_0RCTSurface are:
 ...
 */
@interface ABI37_0_0RCTFabricSurface : NSObject

@property (atomic, readonly) ABI37_0_0RCTSurfaceStage stage;
@property (atomic, readonly) NSString *moduleName;
@property (atomic, readonly) ABI37_0_0ReactTag rootTag;

@property (atomic, readwrite, weak, nullable) id<ABI37_0_0RCTSurfaceDelegate> delegate;
 ...
 * ABI37_0_0RCTSurface does not control (or influence in any way) the size or origin
 ...
 * The starting process includes initializing all underlying ABI37_0_0React Native
 * infrastructure and running ABI37_0_0React app.
...
/**
 * Simple shortcut to `-[ABI37_0_0RCTSurface setMinimumSize:size maximumSize:size]`.
 */
...
@interface ABI37_0_0RCTFabricSurface (Internal)
...
@interface ABI37_0_0RCTFabricSurface (Deprecated)
