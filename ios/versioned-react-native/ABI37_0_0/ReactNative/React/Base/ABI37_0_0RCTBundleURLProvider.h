...
extern NSString *const ABI37_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI37_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI37_0_0RCTBundleURLProvider : NSObject
