 ...
 */
@interface ABI37_0_0RCTImageSource : NSObject
...
@interface ABI37_0_0RCTConvert (ImageSource)

+ (ABI37_0_0RCTImageSource *)ABI37_0_0RCTImageSource:(id)json;
+ (NSArray<ABI37_0_0RCTImageSource *> *)ABI37_0_0RCTImageSourceArray:(id)json;
