...
@interface ABI37_0_0RCTSurfaceRootShadowView : ABI37_0_0RCTShadowView
...
@property (nonatomic, weak) id<ABI37_0_0RCTSurfaceRootShadowViewDelegate> delegate;
 ...
 */
@property (nonatomic, assign) ABI37_0_0YGDirection baseDirection;
