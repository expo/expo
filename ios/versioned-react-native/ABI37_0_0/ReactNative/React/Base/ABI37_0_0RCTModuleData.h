...
@protocol ABI37_0_0RCTBridgeMethod;
@protocol ABI37_0_0RCTBridgeModule;
@class ABI37_0_0RCTBridge;

typedef id<ABI37_0_0RCTBridgeModule>(^ABI37_0_0RCTBridgeModuleProvider)(void);

@interface ABI37_0_0RCTModuleData : NSObject <ABI37_0_0RCTInvalidating>

- (instancetype)initWithModuleClass:(Class)moduleClass
                             bridge:(ABI37_0_0RCTBridge *)bridge;

- (instancetype)initWithModuleClass:(Class)moduleClass
                     moduleProvider:(ABI37_0_0RCTBridgeModuleProvider)moduleProvider
                             bridge:(ABI37_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;

- (instancetype)initWithModuleInstance:(id<ABI37_0_0RCTBridgeModule>)instance
                                bridge:(ABI37_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI37_0_0RCTBridgeMethod>> *methods;

/**
 * Returns a map of the module methods. Note that this will gather the methods the first
 * time it is called and then memoize the results.
 */
@property (nonatomic, copy, readonly) NSDictionary<NSString *, id<ABI37_0_0RCTBridgeMethod>> *methodsByName;
 ...
 */
@property (nonatomic, strong, readwrite) id<ABI37_0_0RCTBridgeModule> instance;
