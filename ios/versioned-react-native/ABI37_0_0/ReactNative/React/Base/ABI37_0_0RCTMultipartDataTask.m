...
@interface ABI37_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>

@end

@implementation ABI37_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI37_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI37_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI37_0_0RCTMultipartStreamReader *reader = [[ABI37_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI37_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
