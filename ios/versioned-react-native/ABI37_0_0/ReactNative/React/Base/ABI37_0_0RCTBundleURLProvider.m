...
#import "ABI37_0_0RCTBundleURLProvider.h"

#import "ABI37_0_0RCTConvert.h"
#import "ABI37_0_0RCTDefines.h"

NSString *const ABI37_0_0RCTBundleURLProviderUpdatedNotification = @"ABI37_0_0RCTBundleURLProviderUpdatedNotification";

const NSUInteger kABI37_0_0RCTBundleURLProviderDefaultPort = ABI37_0_0RCT_METRO_PORT;

static NSString *const kABI37_0_0RCTJsLocationKey = @"ABI37_0_0RCT_jsLocation";
...
static NSString *const kABI37_0_0RCTEnableLiveReloadKey = @"ABI37_0_0RCT_enableLiveReload_LEGACY";
static NSString *const kABI37_0_0RCTEnableDevKey = @"ABI37_0_0RCT_enableDev";
static NSString *const kABI37_0_0RCTEnableMinificationKey = @"ABI37_0_0RCT_enableMinification";

@implementation ABI37_0_0RCTBundleURLProvider
...
{
  return @{
    kABI37_0_0RCTEnableLiveReloadKey: @NO,
    kABI37_0_0RCTEnableDevKey: @YES,
    kABI37_0_0RCTEnableMinificationKey: @NO,
  };
}

- (void)settingsUpdated
{
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI37_0_0RCTBundleURLProviderUpdatedNotification object:self];
}
...
static NSURL *serverRootWithHostPort(NSString *hostPort)
{
  ...
  return [NSURL URLWithString:
          [NSString stringWithFormat:@"http://%@:%lu/",
           hostPort, (unsigned long)kABI37_0_0RCTBundleURLProviderDefaultPort]];
}
...
- (NSURL *)jsBundleURLForBundleRoot:(NSString *)bundleRoot fallbackResource:(NSString *)resourceName fallbackExtension:(NSString *)extension
{
  ...
  if (!packagerServerHost) {
    ...
    return [ABI37_0_0RCTBundleURLProvider jsBundleURLForBundleRoot:bundleRoot
...
- (BOOL)enableDev
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI37_0_0RCTEnableDevKey];
}

- (BOOL)enableLiveReload
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI37_0_0RCTEnableLiveReloadKey];
}

- (BOOL)enableMinification
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI37_0_0RCTEnableMinificationKey];
}

- (NSString *)jsLocation
{
  return [[NSUserDefaults standardUserDefaults] stringForKey:kABI37_0_0RCTJsLocationKey];
}

- (void)setEnableDev:(BOOL)enableDev
{
  [self updateValue:@(enableDev) forKey:kABI37_0_0RCTEnableDevKey];
}

- (void)setEnableLiveReload:(BOOL)enableLiveReload
{
  [self updateValue:@(enableLiveReload) forKey:kABI37_0_0RCTEnableLiveReloadKey];
}

- (void)setJsLocation:(NSString *)jsLocation
{
  [self updateValue:jsLocation forKey:kABI37_0_0RCTJsLocationKey];
}

- (void)setEnableMinification:(BOOL)enableMinification
{
  [self updateValue:@(enableMinification) forKey:kABI37_0_0RCTEnableMinificationKey];
}

+ (instancetype)sharedSettings
{
  static ABI37_0_0RCTBundleURLProvider *sharedInstance;
  static dispatch_once_t once_token;
  dispatch_once(&once_token, ^{
    sharedInstance = [ABI37_0_0RCTBundleURLProvider new];
  });
