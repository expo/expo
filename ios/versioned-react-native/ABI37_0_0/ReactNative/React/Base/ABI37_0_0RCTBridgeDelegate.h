...
@protocol ABI37_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI37_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI37_0_0RCTBridgeModules automatically, however
 ...
 * previously called ABI37_0_0facebook::ABI37_0_0React::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI37_0_0RCTBridge *)bridge;
...
*/
- (BOOL)bridge:(ABI37_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI37_0_0RCTBridge *)bridge
                 onProgress:(ABI37_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI37_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI37_0_0RCTBridge *)bridge
                  withBlock:(ABI37_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Retrieve the list of lazy-native-modules names for the given bridge.
 */
- (NSDictionary<NSString *, Class> *)extraLazyModuleClassesForBridge:(ABI37_0_0RCTBridge *)bridge;
