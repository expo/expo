...
#import "ABI37_0_0RCTSurfaceHostingComponent.h"
#import "ABI37_0_0RCTSurfaceHostingComponent+Internal.h"
...
#import "ABI37_0_0RCTSurfaceHostingComponentController.h"
#import "ABI37_0_0RCTSurfaceHostingComponentState.h"

@implementation ABI37_0_0RCTSurfaceHostingComponent

+ (Class<CKComponentControllerProtocol>)controllerClass
{
  return [ABI37_0_0RCTSurfaceHostingComponentController class];
}

+ (id)initialState
{
  return [ABI37_0_0RCTSurfaceHostingComponentState new];
}
...
+ (instancetype)newWithSurface:(ABI37_0_0RCTSurface *)surface options:(ABI37_0_0RCTSurfaceHostingComponentOptions)options
{
  ...
  ABI37_0_0RCTSurfaceHostingComponentState *const state = scope.state();

  ABI37_0_0RCTSurfaceHostingComponentState *const newState =
    [ABI37_0_0RCTSurfaceHostingComponentState newWithStage:surface.stage
  ...
  ABI37_0_0RCTSurfaceHostingComponent *const component =
...
- (CKComponentLayout)computeLayoutThatFits:(CKSizeRange)constrainedSize
{
  ...
  // just to provide layout constraints to ABI37_0_0React Native as early as possible.
  // ABI37_0_0React Native *may* use this info later during applying the own state and
  ...
  // interop compatibilities of ABI37_0_0React Native which will enable us granularly
  // control ABI37_0_0React Native mounting blocks and, as a result, implement
  // truly synchronous mounting stage between ABI37_0_0React Native and ComponentKit.
  [_surface setMinimumSize:constrainedSize.min
               maximumSize:constrainedSize.max];

  // Just in case of the very first building pass, we give ABI37_0_0React Native a chance
  // to prepare its internals for coming synchronous measuring.
  [_surface synchronouslyWaitForStage:ABI37_0_0RCTSurfaceStageSurfaceDidInitialLayout
                              timeout:_options.synchronousLayoutingTimeout];

  CGSize fittingSize = CGSizeZero;
  if (_surface.stage & ABI37_0_0RCTSurfaceStageSurfaceDidInitialLayout) {
...
- (CKComponentBoundsAnimation)boundsAnimationFromPreviousComponent:(ABI37_0_0RCTSurfaceHostingComponent *)previousComponent
{
