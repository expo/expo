...
#import <ABI37_0_0React/ABI37_0_0ARTPattern.h>

#import <ABI37_0_0React/ABI37_0_0RCTLog.h>

#import "ABI37_0_0RCTConvert+ART.h"

@implementation ABI37_0_0ARTPattern
{
  CGImageRef _image;
  CGRect _rect;
}
...
- (instancetype)initWithArray:(NSArray<id /* imagesource + numbers */> *)array
{
  if ((self = [super initWithArray:array])) {
    if (array.count < 6) {
      ABI37_0_0RCTLogError(@"-[%@ %@] expects 6 elements, received %@",
                  self.class, NSStringFromSelector(_cmd), array);
      return nil;
    }
    _image = CGImageRetain([ABI37_0_0RCTConvert CGImage:array[1]]);
    _rect = [ABI37_0_0RCTConvert CGRect:array offset:2];
  }
  return self;
}
