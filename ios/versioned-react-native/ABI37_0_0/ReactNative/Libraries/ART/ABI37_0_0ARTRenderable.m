...
#import <ABI37_0_0React/ABI37_0_0ARTRenderable.h>

@implementation ABI37_0_0ARTRenderable

- (void)setFill:(ABI37_0_0ARTBrush *)fill
{
  [self invalidate];
  _fill = fill;
}
...
- (void)setStrokeDash:(ABI37_0_0ARTCGFloatArray)strokeDash
{
