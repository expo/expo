...
@implementation ABI37_0_0ARTText
...
static void ABI37_0_0ARTFreeTextFrame(ABI37_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI37_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI37_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI37_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI37_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
