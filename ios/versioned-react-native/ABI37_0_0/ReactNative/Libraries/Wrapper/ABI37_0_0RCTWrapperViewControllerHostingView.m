...
#import "ABI37_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI37_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ABI37_0_0ReactViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ABI37_0_0ReactViewController detachChildViewController:self.contentViewController];
}
