...
#import "ABI37_0_0RCTTypedModuleConstants.h"

#import <ABI37_0_0React/ABI37_0_0RCTDefines.h>

@implementation _ABI37_0_0RCTTypedModuleConstants {
  NSDictionary *_dictionary;
}

+ (instancetype)newWithUnsafeDictionary:(NSDictionary<NSString *, id> *)dictionary
{
  _ABI37_0_0RCTTypedModuleConstants *constants = [self new];
  if (constants) {
...
ABI37_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithObjects:(id  _Nonnull const [])objects
