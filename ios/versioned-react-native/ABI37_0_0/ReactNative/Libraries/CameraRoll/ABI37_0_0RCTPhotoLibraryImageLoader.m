...
#import "ABI37_0_0RCTPhotoLibraryImageLoader.h"

#import <Photos/Photos.h>

#import <ABI37_0_0React/ABI37_0_0RCTUtils.h>

@implementation ABI37_0_0RCTPhotoLibraryImageLoader

ABI37_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI37_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI37_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (!imageURL) {
    completionHandler(ABI37_0_0RCTErrorWithMessage(@"Cannot load a photo library asset with no URL"), nil);
    return ^{};
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI37_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI37_0_0RCTResizeModeContain) {
