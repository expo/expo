...
@implementation ABI37_0_0RCTModuloAnimatedNode
...
- (void)performUpdate
{
  ...
  ABI37_0_0RCTValueAnimatedNode *parent = (ABI37_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:inputNode];
