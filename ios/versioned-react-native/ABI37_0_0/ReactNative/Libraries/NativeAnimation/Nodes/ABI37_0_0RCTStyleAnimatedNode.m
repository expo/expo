...
@implementation ABI37_0_0RCTStyleAnimatedNode
{
...
- (void)performUpdate
{
  ...
  [style enumerateKeysAndObjectsUsingBlock:^(NSString *property, NSNumber *nodeTag, __unused BOOL *stop) {
    ABI37_0_0RCTAnimatedNode *node = [self.parentNodes objectForKey:nodeTag];
    if (node) {
      if ([node isKindOfClass:[ABI37_0_0RCTValueAnimatedNode class]]) {
        ABI37_0_0RCTValueAnimatedNode *parentNode = (ABI37_0_0RCTValueAnimatedNode *)node;
        [self->_propsDictionary setObject:@(parentNode.value) forKey:property];
      } else if ([node isKindOfClass:[ABI37_0_0RCTTransformAnimatedNode class]]) {
        ABI37_0_0RCTTransformAnimatedNode *parentNode = (ABI37_0_0RCTTransformAnimatedNode *)node;
