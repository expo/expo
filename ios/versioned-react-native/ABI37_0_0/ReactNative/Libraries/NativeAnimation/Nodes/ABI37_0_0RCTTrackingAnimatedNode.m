...
@implementation ABI37_0_0RCTTrackingAnimatedNode {
...
- (void)performUpdate
{
  ...
  ABI37_0_0RCTValueAnimatedNode *node = (ABI37_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
