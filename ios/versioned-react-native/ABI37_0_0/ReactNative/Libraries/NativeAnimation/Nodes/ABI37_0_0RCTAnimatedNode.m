...
@implementation ABI37_0_0RCTAnimatedNode
{
  NSMapTable<NSNumber *, ABI37_0_0RCTAnimatedNode *> *_childNodes;
  NSMapTable<NSNumber *, ABI37_0_0RCTAnimatedNode *> *_parentNodes;
}
...
- (NSMapTable<NSNumber *, ABI37_0_0RCTAnimatedNode *> *)childNodes
{
  return _childNodes;
}

- (NSMapTable<NSNumber *, ABI37_0_0RCTAnimatedNode *> *)parentNodes
{
  return _parentNodes;
}

- (void)addChild:(ABI37_0_0RCTAnimatedNode *)child
{
  if (!_childNodes) {
...
- (void)removeChild:(ABI37_0_0RCTAnimatedNode *)child
{
  if (!_childNodes) {
    return;
  }
...
- (void)onAttachedToNode:(ABI37_0_0RCTAnimatedNode *)parent
{
  if (!_parentNodes) {
...
- (void)onDetachedFromNode:(ABI37_0_0RCTAnimatedNode *)parent
{
  if (!_parentNodes) {
    return;
  }
...
- (void)detachNode
{
  for (ABI37_0_0RCTAnimatedNode *parent in _parentNodes.objectEnumerator) {
    [parent removeChild:self];
  }
  for (ABI37_0_0RCTAnimatedNode *child in _childNodes.objectEnumerator) {
