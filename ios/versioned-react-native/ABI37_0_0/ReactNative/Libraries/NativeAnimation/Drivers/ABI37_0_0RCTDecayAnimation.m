...
@implementation ABI37_0_0RCTDecayAnimation
{
  ...
  ABI37_0_0RCTResponseSenderBlock _callback;
}

- (instancetype)initWithId:(NSNumber *)animationId
                    config:(NSDictionary *)config
                   forNode:(ABI37_0_0RCTValueAnimatedNode *)valueNode
                  callBack:(nullable ABI37_0_0RCTResponseSenderBlock)callback;
{
  if ((self = [super init])) {
    ...
    _fromValue = 0;
    _lastValue = 0;
    _velocity = [ABI37_0_0RCTConvert CGFloat:config[@"velocity"]]; // initial velocity
...
{
  NSNumber *iterations = [ABI37_0_0RCTConvert NSNumber:config[@"iterations"]] ?: @1;
  _fromValue = _lastValue;
  _deceleration = [ABI37_0_0RCTConvert CGFloat:config[@"deceleration"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  if (_frameStartTime == -1) {
    ...
    _frameStartTime = currentTime - ABI37_0_0RCTSingleFrameInterval;
  ...
  CGFloat value = _fromValue +
    ...
    (1 - exp(-(1 - _deceleration) * (currentTime - _frameStartTime) * 1000.0 / ABI37_0_0RCTAnimationDragCoefficient()));
