...
static NSUInteger ABI37_0_0RCTDeviceTotalMemory() {
  return (NSUInteger)[[NSProcessInfo processInfo] physicalMemory];
}

static NSUInteger ABI37_0_0RCTDeviceFreeMemory() {
...
@interface ABI37_0_0RCTUIImageViewAnimated () <CALayerDelegate>
...
@property (nonatomic, strong) UIImage<ABI37_0_0RCTAnimatedImage> *animatedImage;
...
@implementation ABI37_0_0RCTUIImageViewAnimated
...
- (void)setImage:(UIImage *)image
{
  ...
  if ([image respondsToSelector:@selector(animatedImageFrameAtIndex:)]) {
    NSUInteger animatedImageFrameCount = ((UIImage<ABI37_0_0RCTAnimatedImage> *)image).animatedImageFrameCount;
    ...
    self.animatedImage = (UIImage<ABI37_0_0RCTAnimatedImage> *)image;
...
{
  if (!_displayLink) {
    _displayLink = [CADisplayLink displayLinkWithTarget:[ABI37_0_0RCTWeakProxy weakProxyWithTarget:self] selector:@selector(displayDidRefresh:)];
...
- (void)displayDidRefresh:(CADisplayLink *)displayLink
{
  ...
  if (!fetchFrame && !bufferFull && self.fetchQueue.operationCount == 0) {
    ...
    UIImage<ABI37_0_0RCTAnimatedImage> *animatedImage = self.animatedImage;
...
- (void)calculateMaxBufferCount
{
  ...
  if (self.maxBufferSize > 0) {
    ...
    NSUInteger total = ABI37_0_0RCTDeviceTotalMemory();
    NSUInteger free = ABI37_0_0RCTDeviceFreeMemory();
