 ...
 * are also bridge modules, so should be registered using ABI37_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI37_0_0RCTImageDataDecoder <ABI37_0_0RCTBridgeModule>
...
/**
 * If more than one ABI37_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
