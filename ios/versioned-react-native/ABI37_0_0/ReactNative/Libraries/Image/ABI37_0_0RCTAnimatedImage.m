...
@interface ABI37_0_0RCTGIFCoderFrame : NSObject
...
@implementation ABI37_0_0RCTGIFCoderFrame
@end

@implementation ABI37_0_0RCTAnimatedImage {
  CGImageSourceRef _imageSource;
  CGFloat _scale;
  NSUInteger _loopCount;
  NSUInteger _frameCount;
  NSArray<ABI37_0_0RCTGIFCoderFrame *> *_frames;
}
...
- (BOOL)scanAndCheckFramesValidWithSource:(CGImageSourceRef)imageSource
{
  ...
  NSMutableArray<ABI37_0_0RCTGIFCoderFrame *> *frames = [NSMutableArray array];

  for (size_t i = 0; i < frameCount; i++) {
    ABI37_0_0RCTGIFCoderFrame *frame = [[ABI37_0_0RCTGIFCoderFrame alloc] init];
    frame.index = i;
