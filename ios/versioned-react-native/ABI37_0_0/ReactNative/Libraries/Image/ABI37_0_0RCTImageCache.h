...
@interface UIImage (ABI37_0_0React)
 ...
 */
@property (nonatomic, assign) NSInteger ABI37_0_0ReactDecodedImageBytes;
 ...
 */
@protocol ABI37_0_0RCTImageCache <NSObject>
...
@interface ABI37_0_0RCTImageCache : NSObject <ABI37_0_0RCTImageCache>
@end
