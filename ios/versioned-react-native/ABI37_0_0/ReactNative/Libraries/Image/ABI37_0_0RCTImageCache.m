...
static const NSUInteger ABI37_0_0RCTMaxCachableDecodedImageSizeInBytes = 2097152; // 2 MB

static NSString *ABI37_0_0RCTCacheKeyForImage(NSString *imageTag, CGSize size, CGFloat scale,
...
@implementation ABI37_0_0RCTImageCache
{
                 ...
                 forKey:(NSString *)cacheKey
{
  ...
  NSInteger bytes = image.ABI37_0_0ReactDecodedImageBytes;
  if (bytes <= ABI37_0_0RCTMaxCachableDecodedImageSizeInBytes) {
...
{
  NSString *cacheKey = ABI37_0_0RCTCacheKeyForImage(url, size, scale, resizeMode);
  @synchronized(_cacheStaleTimes) {
