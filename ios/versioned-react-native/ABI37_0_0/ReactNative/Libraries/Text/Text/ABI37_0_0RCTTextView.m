...
@implementation ABI37_0_0RCTTextView
{
...
- (NSString *)description
{
  ...
  NSString *replacement = [NSString stringWithFormat:@"; ABI37_0_0ReactTag: %@; text: %@", self.ABI37_0_0ReactTag, _textStorage.string];
...
- (void)drawRect:(CGRect)rect
{
  ...
  [_textStorage enumerateAttribute:ABI37_0_0RCTTextAttributesIsHighlightedAttributeName
...
- (NSNumber *)ABI37_0_0ReactTagAtPoint:(CGPoint)point
{
  ...
  if (_textStorage.length > 0 && (fraction > 0 || characterIndex > 0) && (fraction < 1 || characterIndex < _textStorage.length - 1)) {
    ABI37_0_0ReactTag = [_textStorage attribute:ABI37_0_0RCTTextAttributesTagAttributeName atIndex:characterIndex effectiveRange:NULL];
  }

  return ABI37_0_0ReactTag;
}
