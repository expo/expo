...
NSString *const ABI37_0_0RCTTextAttributesIsHighlightedAttributeName = @"ABI37_0_0RCTTextAttributesIsHighlightedAttributeName";
NSString *const ABI37_0_0RCTTextAttributesTagAttributeName = @"ABI37_0_0RCTTextAttributesTagAttributeName";

@implementation ABI37_0_0RCTTextAttributes
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _opacity = NAN;
    _textTransform = ABI37_0_0RCTTextTransformUndefined;
  }

  return self;
}

- (void)applyTextAttributes:(ABI37_0_0RCTTextAttributes *)textAttributes
{
  ...
  _textDecorationLine = textAttributes->_textDecorationLine != ABI37_0_0RCTTextDecorationLineTypeNone ? textAttributes->_textDecorationLine : _textDecorationLine; // *
  ...
  _textTransform = textAttributes->_textTransform != ABI37_0_0RCTTextTransformUndefined ? textAttributes->_textTransform : _textTransform;
}
...
- (NSDictionary<NSAttributedStringKey, id> *)effectiveTextAttributes
{
  ...
  if (_textDecorationLine == ABI37_0_0RCTTextDecorationLineTypeUnderline ||
      _textDecorationLine == ABI37_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    isTextDecorationEnabled = YES;
    attributes[NSUnderlineStyleAttributeName] = @(_textDecorationStyle);
  }

  if (_textDecorationLine == ABI37_0_0RCTTextDecorationLineTypeStrikethrough ||
      _textDecorationLine == ABI37_0_0RCTTextDecorationLineTypeUnderlineStrikethrough){
    isTextDecorationEnabled = YES;
  ...
  // Special
  if (_isHighlighted) {
    attributes[ABI37_0_0RCTTextAttributesIsHighlightedAttributeName] = @YES;
  }

  if (_tag) {
    attributes[ABI37_0_0RCTTextAttributesTagAttributeName] = _tag;
  }
...
{
  // FIXME: ABI37_0_0RCTFont has thread-safety issues and must be rewritten.
  return [ABI37_0_0RCTFont updateFont:nil
...
{
  bool fontScalingEnabled = !ABI37_0_0RCTHasFontHandlerSet() && _allowFontScaling;
...
- (NSString *)applyTextAttributesToText:(NSString *)text
{
  switch (_textTransform) {
    case ABI37_0_0RCTTextTransformUndefined:
    case ABI37_0_0RCTTextTransformNone:
      return text;
    case ABI37_0_0RCTTextTransformLowercase:
      return [text lowercaseString];
    case ABI37_0_0RCTTextTransformUppercase:
      return [text uppercaseString];
    case ABI37_0_0RCTTextTransformCapitalize:
      return [text capitalizedString];
  }
}

- (ABI37_0_0RCTTextAttributes *)copyWithZone:(NSZone *)zone
{
  ABI37_0_0RCTTextAttributes *textAttributes = [ABI37_0_0RCTTextAttributes new];
...
- (BOOL)isEqual:(ABI37_0_0RCTTextAttributes *)textAttributes
{
  if (!textAttributes) {
    return NO;
  }
...
#define ABI37_0_0RCTTextAttributesCompareFloats(a) ((a == textAttributes->a) || (isnan(a) && isnan(textAttributes->a)))
#define ABI37_0_0RCTTextAttributesCompareSize(a) CGSizeEqualToSize(a, textAttributes->a)
#define ABI37_0_0RCTTextAttributesCompareObjects(a) ((a == textAttributes->a) || [a isEqual:textAttributes->a])
#define ABI37_0_0RCTTextAttributesCompareStrings(a) ((a == textAttributes->a) || [a isEqualToString:textAttributes->a])
#define ABI37_0_0RCTTextAttributesCompareOthers(a) (a == textAttributes->a)

  return
    ABI37_0_0RCTTextAttributesCompareObjects(_foregroundColor) &&
    ABI37_0_0RCTTextAttributesCompareObjects(_backgroundColor) &&
    ABI37_0_0RCTTextAttributesCompareFloats(_opacity) &&
    // Font
    ABI37_0_0RCTTextAttributesCompareObjects(_fontFamily) &&
    ABI37_0_0RCTTextAttributesCompareFloats(_fontSize) &&
    ABI37_0_0RCTTextAttributesCompareFloats(_fontSizeMultiplier) &&
    ABI37_0_0RCTTextAttributesCompareFloats(_maxFontSizeMultiplier) &&
    ABI37_0_0RCTTextAttributesCompareStrings(_fontWeight) &&
    ABI37_0_0RCTTextAttributesCompareObjects(_fontStyle) &&
    ABI37_0_0RCTTextAttributesCompareObjects(_fontVariant) &&
    ABI37_0_0RCTTextAttributesCompareOthers(_allowFontScaling) &&
    ABI37_0_0RCTTextAttributesCompareFloats(_letterSpacing) &&
    // Paragraph Styles
    ABI37_0_0RCTTextAttributesCompareFloats(_lineHeight) &&
    ABI37_0_0RCTTextAttributesCompareFloats(_alignment) &&
    ABI37_0_0RCTTextAttributesCompareOthers(_baseWritingDirection) &&
    // Decoration
    ABI37_0_0RCTTextAttributesCompareObjects(_textDecorationColor) &&
    ABI37_0_0RCTTextAttributesCompareOthers(_textDecorationStyle) &&
    ABI37_0_0RCTTextAttributesCompareOthers(_textDecorationLine) &&
    // Shadow
    ABI37_0_0RCTTextAttributesCompareSize(_textShadowOffset) &&
    ABI37_0_0RCTTextAttributesCompareFloats(_textShadowRadius) &&
    ABI37_0_0RCTTextAttributesCompareObjects(_textShadowColor) &&
    // Special
    ABI37_0_0RCTTextAttributesCompareOthers(_isHighlighted) &&
    ABI37_0_0RCTTextAttributesCompareObjects(_tag) &&
    ABI37_0_0RCTTextAttributesCompareOthers(_layoutDirection) &&
    ABI37_0_0RCTTextAttributesCompareOthers(_textTransform);
}
