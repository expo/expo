...
@implementation ABI37_0_0RCTBaseTextInputView {
...
ABI37_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithCoder:(NSCoder *)decoder)
ABI37_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithFrame:(CGRect)frame)

- (UIView<ABI37_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  ABI37_0_0RCTAssert(NO, @"-[ABI37_0_0RCTBaseTextInputView backedTextInputView] must be implemented in subclass.");
  return nil;
}

#pragma mark - ABI37_0_0RCTComponent
...
- (void)setTextAttributes:(ABI37_0_0RCTTextAttributes *)textAttributes
{
...
{
  id<ABI37_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
  backedTextInputView.ABI37_0_0ReactTextAttributes = _textAttributes;
}

- (void)setABI37_0_0ReactPaddingInsets:(UIEdgeInsets)ABI37_0_0ReactPaddingInsets
{
  _ABI37_0_0ReactPaddingInsets = ABI37_0_0ReactPaddingInsets;
  // We apply `paddingInsets` as `backedTextInputView`'s `textContainerInset`.
  self.backedTextInputView.textContainerInset = ABI37_0_0ReactPaddingInsets;
  [self setNeedsLayout];
}

- (void)setABI37_0_0ReactBorderInsets:(UIEdgeInsets)ABI37_0_0ReactBorderInsets
{
  _ABI37_0_0ReactBorderInsets = ABI37_0_0ReactBorderInsets;
  // We apply `borderInsets` as `backedTextInputView` layout offset.
  self.backedTextInputView.frame = UIEdgeInsetsInsetRect(self.bounds, ABI37_0_0ReactBorderInsets);
  [self setNeedsLayout];
}
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  [backedTextInputViewTextCopy removeAttribute:ABI37_0_0RCTTextAttributesTagAttributeName
                                         range:NSMakeRange(0, backedTextInputViewTextCopy.length)];

  [attributedTextCopy removeAttribute:ABI37_0_0RCTTextAttributesTagAttributeName
  ...
  } else if (eventLag > ABI37_0_0RCTTextUpdateLagWarningThreshold) {
    ABI37_0_0RCTLog(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", self.backedTextInputView.attributedText.string, (long long)eventLag);
  }
}

- (ABI37_0_0RCTTextSelection *)selection
{
  id<ABI37_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
  UITextRange *selectedTextRange = backedTextInputView.selectedTextRange;
  return [[ABI37_0_0RCTTextSelection new] initWithStart:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.start]
                                           end:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.end]];
}

- (void)setSelection:(ABI37_0_0RCTTextSelection *)selection
{
  if (!selection) {
    return;
  }
  ...
  if (eventLag == 0 && ![previousSelectedTextRange isEqual:selectedTextRange]) {
    ...
    ABI37_0_0RCTLog(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", backedTextInputView.attributedText.string, (long long)eventLag);
  }
}
...
{
  UIView<ABI37_0_0RCTBackedTextInputViewProtocol> *textInputView = self.backedTextInputView;
...
#pragma mark - ABI37_0_0RCTBackedTextInputDelegate
...
- (void)textInputDidBeginEditing
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI37_0_0RCTTextEventTypeFocus
...
{
  [_eventDispatcher sendTextEventWithType:ABI37_0_0RCTTextEventTypeEnd
                                 ABI37_0_0ReactTag:self.ABI37_0_0ReactTag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];

  [_eventDispatcher sendTextEventWithType:ABI37_0_0RCTTextEventTypeBlur
                                 ABI37_0_0ReactTag:self.ABI37_0_0ReactTag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldReturn
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI37_0_0RCTTextEventTypeSubmit
                                 ABI37_0_0ReactTag:self.ABI37_0_0ReactTag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text
{
  ...
  if (!backedTextInputView.textWasPasted) {
    [_eventDispatcher sendTextEventWithType:ABI37_0_0RCTTextEventTypeKeyPress
                                   ABI37_0_0ReactTag:self.ABI37_0_0ReactTag
                                       text:nil
                                        key:text
                                 eventCount:_nativeEventCount];
...
- (void)textInputDidChangeSelection
{
  ...
  ABI37_0_0RCTTextSelection *selection = self.selection;
...
- (CGSize)intrinsicContentSize
{
  ...
  size.width += _ABI37_0_0ReactBorderInsets.left + _ABI37_0_0ReactBorderInsets.right;
  size.height += _ABI37_0_0ReactBorderInsets.top + _ABI37_0_0ReactBorderInsets.bottom;
...
{
  CGFloat compoundHorizontalBorderInset = _ABI37_0_0ReactBorderInsets.left + _ABI37_0_0ReactBorderInsets.right;
  CGFloat compoundVerticalBorderInset = _ABI37_0_0ReactBorderInsets.top + _ABI37_0_0ReactBorderInsets.bottom;
...
{
  [self.backedTextInputView ABI37_0_0ReactFocus];
}

- (void)ABI37_0_0ReactBlur
{
  [self.backedTextInputView ABI37_0_0ReactBlur];
}

- (void)didMoveToWindow
{
  [self.backedTextInputView ABI37_0_0ReactFocusIfNeeded];
}
...
{
  #if !TARGET_OS_TV
  __weak ABI37_0_0RCTBaseTextInputView *weakSelf = self;
  [_bridge.uiManager rootViewForABI37_0_0ReactTag:self.ABI37_0_0ReactTag withCompletion:^(UIView *rootView) {
    ABI37_0_0RCTBaseTextInputView *strongSelf = weakSelf;
    if (rootView) {
      UIView *accessoryView = [strongSelf->_bridge.uiManager viewForNativeID:nativeID
                                                                 withRootTag:rootView.ABI37_0_0ReactTag];
      if (accessoryView && [accessoryView isKindOfClass:[ABI37_0_0RCTInputAccessoryView class]]) {
        strongSelf.backedTextInputView.inputAccessoryView = ((ABI37_0_0RCTInputAccessoryView *)accessoryView).inputAccessoryView;
