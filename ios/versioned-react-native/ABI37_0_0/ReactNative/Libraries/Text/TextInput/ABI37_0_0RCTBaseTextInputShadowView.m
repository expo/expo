...
@implementation ABI37_0_0RCTBaseTextInputShadowView
{
...
- (instancetype)initWithBridge:(ABI37_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI37_0_0YGNodeSetMeasureFunc(self.yogaNode, ABI37_0_0RCTBaseTextInputShadowViewMeasure);
    ABI37_0_0YGNodeSetBaselineFunc(self.yogaNode, ABI37_0_0RCTTextInputShadowViewBaseline);
  }
...
- (void)uiManagerWillPerformMounting
{
  ...
  ABI37_0_0RCTTextAttributes *textAttributes = [self.textAttributes copy];
  ...
  [attributedText removeAttribute:ABI37_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                            range:NSMakeRange(0, attributedText.length)];

  [attributedText removeAttribute:ABI37_0_0RCTTextAttributesTagAttributeName
                            range:NSMakeRange(0, attributedText.length)];
  ...
  [_bridge.uiManager addUIBlock:^(ABI37_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI37_0_0RCTBaseTextInputView *baseTextInputView = (ABI37_0_0RCTBaseTextInputView *)viewRegistry[tag];
    if (!baseTextInputView) {
      return;
    }

    baseTextInputView.textAttributes = textAttributes;
    baseTextInputView.ABI37_0_0ReactBorderInsets = borderInsets;
    baseTextInputView.ABI37_0_0ReactPaddingInsets = paddingInsets;
...
- (CGSize)sizeThatFitsMinimumSize:(CGSize)minimumSize maximumSize:(CGSize)maximumSize
{
  ...
  return (CGSize){
    MAX(minimumSize.width, MIN(ABI37_0_0RCTCeilPixelValue(size.width), maximumSize.width)),
    MAX(minimumSize.height, MIN(ABI37_0_0RCTCeilPixelValue(size.height), maximumSize.height))
  };
}
...
static ABI37_0_0YGSize ABI37_0_0RCTBaseTextInputShadowViewMeasure(ABI37_0_0YGNodeRef node, float width, ABI37_0_0YGMeasureMode widthMode, float height, ABI37_0_0YGMeasureMode heightMode)
{
  ...
  return (ABI37_0_0YGSize){
    ABI37_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.width),
    ABI37_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.height)
  };
}

static float ABI37_0_0RCTTextInputShadowViewBaseline(ABI37_0_0YGNodeRef node, const float width, const float height)
{
  ABI37_0_0RCTBaseTextInputShadowView *shadowTextView = (__bridge ABI37_0_0RCTBaseTextInputShadowView *)ABI37_0_0YGNodeGetContext(node);
