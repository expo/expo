...
@implementation ABI37_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI37_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI37_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
  }
...
- (void)setABI37_0_0ReactTextAttributes:(ABI37_0_0RCTTextAttributes *)ABI37_0_0ReactTextAttributes
{
  ...
  self.typingAttributes = ABI37_0_0ReactTextAttributes.effectiveTextAttributes;
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  // see: https://github.com/facebook/ABI37_0_0React-native/issues/19339
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI37_0_0RCTCeilPixelValue(placeholderSize.width), ABI37_0_0RCTCeilPixelValue(placeholderSize.height));
...
- (NSDictionary<NSAttributedStringKey, id> *)placeholderEffectiveTextAttributes
{
  NSMutableDictionary<NSAttributedStringKey, id> *effectiveTextAttributes = [NSMutableDictionary dictionaryWithDictionary:@{
                                                                                                                            NSFontAttributeName: _ABI37_0_0ReactTextAttributes.effectiveFont ?: defaultPlaceholderFont(),
                                                                                                                            NSForegroundColorAttributeName: self.placeholderColor ?: defaultPlaceholderColor(),
                                                                                                                            NSKernAttributeName:isnan(_ABI37_0_0ReactTextAttributes.letterSpacing) ? @0 : @(_ABI37_0_0ReactTextAttributes.letterSpacing)
                                                                                                                            }];
