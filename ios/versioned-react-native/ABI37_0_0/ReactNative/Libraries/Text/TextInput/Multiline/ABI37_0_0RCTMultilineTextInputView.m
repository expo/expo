...
@implementation ABI37_0_0RCTMultilineTextInputView
{
  ABI37_0_0RCTUITextView *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI37_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI37_0_0RCTUITextView alloc] initWithFrame:self.bounds];
...
- (id<ABI37_0_0RCTBackedTextInputViewProtocol>)backedTextInputView
{
...
{
  ABI37_0_0RCTDirectEventBlock onScroll = self.onScroll;
