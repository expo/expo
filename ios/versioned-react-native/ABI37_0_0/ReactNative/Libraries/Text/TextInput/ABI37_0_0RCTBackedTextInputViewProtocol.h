...
@protocol ABI37_0_0RCTBackedTextInputDelegate;
@class ABI37_0_0RCTTextAttributes;

NS_ASSUME_NONNULL_BEGIN

@protocol ABI37_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI37_0_0RCTBackedTextInputDelegate> textInputDelegate;
@property (nonatomic, readonly) CGSize contentSize;
@property (nonatomic, strong, nullable) ABI37_0_0RCTTextAttributes *ABI37_0_0ReactTextAttributes;
