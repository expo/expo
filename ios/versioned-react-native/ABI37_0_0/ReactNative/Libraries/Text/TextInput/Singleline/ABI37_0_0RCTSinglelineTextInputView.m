...
@implementation ABI37_0_0RCTSinglelineTextInputView
{
  ABI37_0_0RCTUITextField *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI37_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI37_0_0RCTUITextField alloc] initWithFrame:self.bounds];
