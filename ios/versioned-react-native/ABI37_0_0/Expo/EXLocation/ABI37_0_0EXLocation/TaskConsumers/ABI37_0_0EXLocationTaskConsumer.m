...
@interface ABI37_0_0EXLocationTaskConsumer ()
...
@implementation ABI37_0_0EXLocationTaskConsumer
...
# pragma mark - ABI37_0_0UMTaskConsumerInterface
...
- (void)setOptions:(NSDictionary *)options
{
  [ABI37_0_0UMUtilities performSynchronouslyOnMainThread:^{
    ...
    locationManager.desiredAccuracy = [ABI37_0_0EXLocation CLLocationAccuracyFromOption:accuracy];
    locationManager.distanceFilter = [options[@"distanceInterval"] doubleValue] ?: kCLDistanceFilterNone;
    locationManager.activityType = [ABI37_0_0EXLocation CLActivityTypeFromOption:[options[@"activityType"] integerValue]];
...
- (void)executeTaskWithDeferredLocations
{
  ...
  NSDictionary *data = @{ @"locations": [ABI37_0_0EXLocationTaskConsumer _exportLocations:_deferredLocations] };
...
+ (NSArray<NSDictionary *> *)_exportLocations:(NSArray<CLLocation *> *)locations
{
  ...
  for (CLLocation *location in locations) {
    [result addObject:[ABI37_0_0EXLocation exportLocation:location]];
  }
  return result;
}
