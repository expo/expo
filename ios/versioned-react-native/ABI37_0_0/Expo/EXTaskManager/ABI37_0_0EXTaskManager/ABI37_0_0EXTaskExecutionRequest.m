...
@interface ABI37_0_0EXTaskExecutionRequest ()

@property (nonatomic, strong, nullable) NSMutableSet<id<ABI37_0_0UMTaskInterface>> *tasks;
...
@implementation ABI37_0_0EXTaskExecutionRequest
...
- (void)_maybeExecuteCallback
{
  if (_callback) {
    ...
    __strong ABI37_0_0EXTaskExecutionRequest *strongSelf = self;
