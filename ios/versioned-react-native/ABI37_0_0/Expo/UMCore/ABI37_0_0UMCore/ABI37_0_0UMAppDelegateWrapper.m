...
@implementation ABI37_0_0UMAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitialized {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI37_0_0UMSingletonModule*> * singletonModules = [[ABI37_0_0UMModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI37_0_0UMSingletonModule *singletonModule in singletonModules) {
