...
@interface ABI37_0_0UMNativeModulesProxy ()

@property (nonatomic, strong) NSRegularExpression *regexp;
@property (nonatomic, strong) ABI37_0_0UMModuleRegistry *moduleRegistry;
...
@implementation ABI37_0_0UMNativeModulesProxy
...
# pragma mark - ABI37_0_0React API
...
- (NSDictionary *)constantsToExport
{
  ...
  NSArray<ABI37_0_0UMViewManager *> *viewManagers = [_moduleRegistry getAllViewManagers];
  NSMutableArray<NSString *> *viewManagersNames = [NSMutableArray arrayWithCapacity:[viewManagers count]];
  for (ABI37_0_0UMViewManager *viewManager in viewManagers) {
...
ABI37_0_0RCT_EXPORT_METHOD(callMethod:(NSString *)moduleName methodNameOrKey:(id)methodNameOrKey arguments:(NSArray *)arguments resolver:(ABI37_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI37_0_0RCTPromiseRejectBlock)reject)
{
