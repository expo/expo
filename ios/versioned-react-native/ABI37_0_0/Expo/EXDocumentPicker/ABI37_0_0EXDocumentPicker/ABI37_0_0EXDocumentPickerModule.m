...
#import <ABI37_0_0EXDocumentPicker/ABI37_0_0EXDocumentPickerModule.h>
...
static NSString * ABI37_0_0EXConvertMimeTypeToUTI(NSString *mimeType)
{
  CFStringRef uti;
...
@interface ABI37_0_0EXDocumentPickerModule () <UIDocumentMenuDelegate, UIDocumentPickerDelegate>
...
@implementation ABI37_0_0EXDocumentPickerModule

ABI37_0_0UM_EXPORT_MODULE(ExpoDocumentPicker);
...
ABI37_0_0UM_EXPORT_METHOD_AS(getDocumentAsync,
                    ...
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSString *type = ABI37_0_0EXConvertMimeTypeToUTI(options[@"type"] ?: @"*/*");
