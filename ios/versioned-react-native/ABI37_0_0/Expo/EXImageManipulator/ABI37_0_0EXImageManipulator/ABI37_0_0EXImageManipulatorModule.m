...
#import <ABI37_0_0EXImageManipulator/ABI37_0_0EXImageManipulatorModule.h>
...
@interface ABI37_0_0EXImageManipulatorModule ()
...
@implementation ABI37_0_0EXImageManipulatorModule

ABI37_0_0UM_EXPORT_MODULE(ExpoImageManipulator);
...
ABI37_0_0UM_EXPORT_METHOD_AS(manipulateAsync,
                    uri:(NSString *)uri
                    ...
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (!([_fileSystem permissionsForURI:url] & ABI37_0_0UMFileSystemPermissionRead)) {
