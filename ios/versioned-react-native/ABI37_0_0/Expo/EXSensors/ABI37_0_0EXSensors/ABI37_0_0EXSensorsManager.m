...
#import <ABI37_0_0EXSensors/ABI37_0_0EXSensorsManager.h>
#import <CoreMotion/CoreMotion.h>

@interface ABI37_0_0EXSensorsManager ()
...
@implementation ABI37_0_0EXSensorsManager

ABI37_0_0UM_REGISTER_MODULE();

+ (const NSArray<Protocol *> *)exportedInterfaces
{
  return @[@protocol(ABI37_0_0UMAccelerometerInterface), @protocol(ABI37_0_0UMBarometerInterface), @protocol(ABI37_0_0UMDeviceMotionInterface), @protocol(ABI37_0_0UMGyroscopeInterface), @protocol(ABI37_0_0UMMagnetometerInterface), @protocol(ABI37_0_0UMMagnetometerUncalibratedInterface)];
}
                                            ...
                                            withHandler:(void (^)(NSDictionary *event))handlerBlock
{
  ...
  if (![[self manager] isAccelerometerActive]) {
    ...
    __weak ABI37_0_0EXSensorsManager *weakSelf = self;
    [[self manager] startAccelerometerUpdatesToQueue:[NSOperationQueue mainQueue] withHandler:^(CMAccelerometerData *data, NSError *error) {
      __strong ABI37_0_0EXSensorsManager *strongSelf = weakSelf;
      if (strongSelf) {
...
- (void)activateDeviceMotionUpdates
{
  ...
  [[self manager] startDeviceMotionUpdatesUsingReferenceFrame:CMAttitudeReferenceFrameXArbitraryCorrectedZVertical toQueue:[NSOperationQueue mainQueue] withHandler:^(CMDeviceMotion *data, NSError *error) {
    ...
    NSDictionary *result = @{
                             @"acceleration": @{
                                 @"x": @(data.userAcceleration.x * ABI37_0_0EXGravity),
                                 @"y": @(data.userAcceleration.y * ABI37_0_0EXGravity),
                                 @"z": @(data.userAcceleration.z * ABI37_0_0EXGravity)
                                 },
                             @"accelerationIncludingGravity": @{
                                 @"x": @((data.userAcceleration.x + data.gravity.x) * ABI37_0_0EXGravity),
                                 @"y": @((data.userAcceleration.y + data.gravity.y) * ABI37_0_0EXGravity),
                                 @"z": @((data.userAcceleration.z + data.gravity.z) * ABI37_0_0EXGravity)
                                 },
                             @"rotation": @{
