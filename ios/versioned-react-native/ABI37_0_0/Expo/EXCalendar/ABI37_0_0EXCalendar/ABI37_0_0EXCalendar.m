...
#import <ABI37_0_0EXCalendar/ABI37_0_0EXCalendar.h>
...
@implementation ABI37_0_0EXCalendar

ABI37_0_0UM_EXPORT_MODULE(ExpoCalendar);
...
- (void)setModuleRegistry:(ABI37_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  [ABI37_0_0UMPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI37_0_0EXCalendarPermissionRequester new],
                                                    [ABI37_0_0EXRemindersPermissionRequester new]
                                                    ]
...
ABI37_0_0UM_EXPORT_METHOD_AS(getCalendarsAsync,
                    ...
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI37_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI37_0_0UM_EXPORT_METHOD_AS(getDefaultCalendarAsync,
                    getDefaultCalendarAsync:(ABI37_0_0UMPromiseResolveBlock)resolve
                    rejector:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI37_0_0EXCalendarConverter serializeCalendar:defaultCalendar]);
}

ABI37_0_0UM_EXPORT_METHOD_AS(saveCalendarAsync,
                    ...
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (color) {
    calendar.CGColor = [ABI37_0_0UMUtilities UIColor:color].CGColor;
...
ABI37_0_0UM_EXPORT_METHOD_AS(deleteCalendarAsync,
...
ABI37_0_0UM_EXPORT_METHOD_AS(getEventsAsync,
                    ...
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI37_0_0UMUtilities NSDate:startDateStr];
  NSDate *endDate = [ABI37_0_0UMUtilities NSDate:endDateStr];
  ...
  if (calendarEvents) {
    resolve([ABI37_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI37_0_0UM_EXPORT_METHOD_AS(getEventByIdAsync,
                    ...
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (calendarEvent) {
    resolve([ABI37_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI37_0_0UM_EXPORT_METHOD_AS(saveEventAsync,
                    ...
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI37_0_0UMUtilities NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI37_0_0UMUtilities NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI37_0_0UMUtilities NSDate:details[@"instanceStartDate"]];
...
ABI37_0_0UM_EXPORT_METHOD_AS(deleteEventAsync,
                    ...
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *instanceStartDate = [ABI37_0_0UMUtilities NSDate:event[@"instanceStartDate"]];
...
ABI37_0_0UM_EXPORT_METHOD_AS(getAttendeesForEventAsync,
                    ...
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (item.hasAttendees) {
    resolve([ABI37_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI37_0_0UM_EXPORT_METHOD_AS(getRemindersAsync,
                    ...
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI37_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI37_0_0UM_EXPORT_METHOD_AS(getReminderByIdAsync,
                    ...
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (reminder) {
    ...
    resolve([ABI37_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI37_0_0UM_EXPORT_METHOD_AS(saveReminderAsync,
                    ...
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI37_0_0UMUtilities NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI37_0_0UMUtilities NSDate:details[@"dueDate"]];
  NSDate *completionDate = [ABI37_0_0UMUtilities NSDate:details[@"completionDate"]];
...
ABI37_0_0UM_EXPORT_METHOD_AS(deleteReminderAsync,
...
ABI37_0_0UM_EXPORT_METHOD_AS(getSourcesAsync,
                    getSourcesAsync:(ABI37_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI37_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI37_0_0UM_EXPORT_METHOD_AS(getSourceByIdAsync,
                    ...
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI37_0_0EXCalendarConverter serializeSource:source]);
}

ABI37_0_0UM_EXPORT_METHOD_AS(getCalendarPermissionsAsync,
                    getCalendarPermissionsAsync:(ABI37_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  [ABI37_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI37_0_0EXCalendarPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI37_0_0UM_EXPORT_METHOD_AS(requestCalendarPermissionsAsync,
                    requestCalendarPermissionsAsync:(ABI37_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
...
ABI37_0_0UM_EXPORT_METHOD_AS(getRemindersPermissionsAsync,
                    getRemindersPermissionsAsync:(ABI37_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  [ABI37_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI37_0_0EXRemindersPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI37_0_0UM_EXPORT_METHOD_AS(requestRemindersPermissionsAsync,
                    requestRemindersPermissionsAsync:(ABI37_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  [ABI37_0_0UMPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI37_0_0EXRemindersPermissionRequester class]
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI37_0_0UMUtilities NSDate:alarm[@"absoluteDate"]];
...
- (EKRecurrenceRule *)_createRecurrenceRule:(NSDictionary *)recurrenceRule
{
  ...
  if (recurrenceRule[@"endDate"]) {
      endDate = [ABI37_0_0UMUtilities NSDate:recurrenceRule[@"endDate"]];
  }
...
- (BOOL)_checkPermissions:(Class)permissionsRequester reject:(ABI37_0_0UMPromiseRejectBlock)reject
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI37_0_0EXCalendarPermissionRequester class]]) {
...
- (BOOL)_checkCalendarPermissions:(ABI37_0_0UMPromiseRejectBlock)reject
{
  return [self _checkPermissions:[ABI37_0_0EXCalendarPermissionRequester class] reject:reject];
}

- (BOOL)_checkRemindersPermissions:(ABI37_0_0UMPromiseRejectBlock)reject
{
  return [self _checkPermissions:[ABI37_0_0EXRemindersPermissionRequester class] reject:reject];
}
