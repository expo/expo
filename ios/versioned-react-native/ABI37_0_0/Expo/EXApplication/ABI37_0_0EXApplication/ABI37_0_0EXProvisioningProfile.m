...
@implementation ABI37_0_0EXProvisioningProfile {
  NSDictionary *_plist;
}

+ (instancetype)mainProvisioningProfile
{
  static ABI37_0_0EXProvisioningProfile *profile;
...
- (ABI37_0_0EXAppReleaseType)appReleaseType {
  ...
  if (!provisioningPath) {
    ...
    return ABI37_0_0EXAppReleaseSimulator;
#else
    return ABI37_0_0EXAppReleaseAppStore;
#endif
  }
  ...
  if (!mobileProvision) {
    ...
    return ABI37_0_0EXAppReleaseTypeUnknown;
    ...
    return ABI37_0_0EXAppReleaseEnterprise;
    ...
    if ([[entitlements objectForKey:@"get-task-allow"] boolValue]) {
      return ABI37_0_0EXAppReleaseDev;
    } else {
      return ABI37_0_0EXAppReleaseAdHoc;
    }
  } else {
