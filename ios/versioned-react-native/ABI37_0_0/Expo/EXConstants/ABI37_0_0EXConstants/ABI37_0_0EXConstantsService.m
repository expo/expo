...
static const NSString *kEXDeviceInstallationUUIDKey = @"EXDeviceInstallUUIDKey";

@interface ABI37_0_0EXConstantsService ()

@property (nonatomic, strong) NSString *sessionId;

@end

@implementation ABI37_0_0EXConstantsService

ABI37_0_0UM_REGISTER_MODULE();

+ (const NSArray<Protocol *> *)exportedInterfaces
{
  return @[@protocol(ABI37_0_0UMConstantsInterface)];
}
