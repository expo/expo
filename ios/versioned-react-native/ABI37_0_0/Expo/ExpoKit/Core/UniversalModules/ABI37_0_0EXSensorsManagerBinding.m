...
@interface ABI37_0_0EXSensorsManagerBinding ()

@property (nonatomic, strong) NSString *experienceId;
@property (nonatomic, weak) id<ABI37_0_0EXSensorsManagerBindingDelegate> kernelService;

@end

@implementation ABI37_0_0EXSensorsManagerBinding
