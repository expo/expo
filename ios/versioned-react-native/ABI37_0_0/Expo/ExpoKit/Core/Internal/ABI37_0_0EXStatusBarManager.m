...
#if !TARGET_OS_TV
@implementation ABI37_0_0RCTConvert (ABI37_0_0EXStatusBar)

ABI37_0_0RCT_ENUM_CONVERTER(UIStatusBarStyle, (@{
  @"default": @(UIStatusBarStyleDefault),
  @"light-content": @(UIStatusBarStyleLightContent),
  @"dark-content": @(UIStatusBarStyleDefault),
}), UIStatusBarStyleDefault, integerValue);

ABI37_0_0RCT_ENUM_CONVERTER(UIStatusBarAnimation, (@{
...
@interface ABI37_0_0EXStatusBarManager ()

@property (nonatomic, strong) NSMutableDictionary *capturedStatusBarProperties;

@end

@implementation ABI37_0_0EXStatusBarManager

+ (NSString *)moduleName { return @"ABI37_0_0RCTStatusBarManager"; }
...
ABI37_0_0RCT_EXPORT_METHOD(setStyle:(UIStatusBarStyle)statusBarStyle
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ABI37_0_0RCTSharedApplication() setStatusBarStyle:statusBarStyle
                                     animated:animated];
...
ABI37_0_0RCT_EXPORT_METHOD(setHidden:(BOOL)hidden
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ABI37_0_0RCTSharedApplication() setStatusBarHidden:hidden
 ...
 */
ABI37_0_0RCT_REMAP_METHOD(_captureProperties,
                 _capturePropertiesWithResolver:(ABI37_0_0RCTPromiseResolveBlock)resolve
 ...
 *  Normally nobody should use this method because it bypasses the JS state used by the StatusBar component.
 */
ABI37_0_0RCT_EXPORT_METHOD(_applyPropertiesAndForget:(NSDictionary *)properties)
{
...
{
  UIApplication *currentApplication = ABI37_0_0RCTSharedApplication();
  return @{
