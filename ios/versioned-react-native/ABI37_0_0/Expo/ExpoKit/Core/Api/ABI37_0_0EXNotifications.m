...
@interface ABI37_0_0EXNotifications ()

// unversioned ABI37_0_0EXRemoteNotificationManager instance
@property (nonatomic, weak) id <ABI37_0_0EXNotificationsScopedModuleDelegate> remoteNotificationsDelegate;
@property (nonatomic, weak) id <ABI37_0_0EXNotificationsIdentifiersManager> notificationsIdentifiersManager;
@property (nonatomic, weak) id <ABI37_0_0EXUserNotificationCenterService> userNotificationCenter;

@end

@implementation ABI37_0_0EXNotifications

ABI37_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentNotifications, @"RemoteNotificationManager", @"UserNotificationManager", @"UserNotificationCenter");
...
ABI37_0_0RCT_REMAP_METHOD(getDevicePushTokenAsync,
...
{
  ABI37_0_0EXConstantsBinding *constants = [[[self.bridge moduleForClass:[ABI37_0_0UMModuleRegistryHolderReactModule class]] moduleRegistry] getModuleImplementingProtocol:@protocol(ABI37_0_0UMConstantsInterface)];
...
ABI37_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
                 getExponentPushTokenAsyncWithResolver:(ABI37_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI37_0_0RCTPromiseRejectBlock)reject)
{
...
ABI37_0_0RCT_EXPORT_METHOD(presentLocalNotification:(NSDictionary *)payload
                  resolver:(ABI37_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI37_0_0RCTPromiseRejectBlock)reject)
{
  ...
  ABI37_0_0RCT_EXPORT_METHOD(scheduleNotificationWithTimer:(NSDictionary *)payload
...
ABI37_0_0RCT_EXPORT_METHOD(scheduleNotificationWithCalendar:(NSDictionary *)payload
                 withOptions:(NSDictionary *)options
                 resolver:(ABI37_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI37_0_0RCTPromiseRejectBlock)reject)
{
...
ABI37_0_0RCT_EXPORT_METHOD(scheduleLocalNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI37_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI37_0_0RCTPromiseRejectBlock)reject)
{
...
ABI37_0_0RCT_EXPORT_METHOD(legacyScheduleLocalRepeatingNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI37_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI37_0_0RCTPromiseRejectBlock)reject)
{
  ...
  localNotification.applicationIconBadgeNumber = [ABI37_0_0RCTConvert NSInteger:payload[@"count"]] ?: 0;
  localNotification.userInfo = @{
                                 @"body": payload[@"data"],
                                 @"experienceId": self.experienceId,
                                 @"id": uniqueId
                                 };
  localNotification.fireDate = [ABI37_0_0RCTConvert NSDate:options[@"time"]] ?: [NSDate new];
  localNotification.repeatInterval = [ABI37_0_0RCTConvert NSCalendarUnit:options[@"repeat"]] ?: 0;

  __weak typeof(self) weakSelf = self;
  [ABI37_0_0EXUtil performSynchronouslyOnMainThread:^{
    [ABI37_0_0RCTSharedApplication() scheduleLocalNotification:localNotification];
...
ABI37_0_0RCT_REMAP_METHOD(cancelScheduledNotificationAsync,
                 cancelScheduledNotificationAsync:(NSString *)uniqueId
                 withResolver:(ABI37_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI37_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI37_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
...
ABI37_0_0RCT_REMAP_METHOD(cancelAllScheduledNotificationsAsync,
                 cancelAllScheduledNotificationsAsyncWithResolver:(ABI37_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(__unused ABI37_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI37_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
  [_userNotificationCenter getPendingNotificationRequestsWithCompletionHandler:^(NSArray<UNNotificationRequest *> * _Nonnull requests) {
...
ABI37_0_0RCT_REMAP_METHOD(getBadgeNumberAsync,
                 getBadgeNumberAsyncWithResolver:(ABI37_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI37_0_0RCTPromiseRejectBlock)reject)
{
  __block NSInteger badgeNumber;
  [ABI37_0_0EXUtil performSynchronouslyOnMainThread:^{
    badgeNumber = ABI37_0_0RCTSharedApplication().applicationIconBadgeNumber;
  }];
  resolve(@(badgeNumber));
}

ABI37_0_0RCT_EXPORT_METHOD(setBadgeNumberAsync:(nonnull NSNumber *)number
                  resolver:(ABI37_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI37_0_0RCTPromiseRejectBlock)reject)
{
  [ABI37_0_0EXUtil performSynchronouslyOnMainThread:^{
    ABI37_0_0RCTSharedApplication().applicationIconBadgeNumber = number.integerValue;
  }];
  resolve(nil);
}
...
ABI37_0_0RCT_REMAP_METHOD(createCategoryAsync,
...
ABI37_0_0RCT_REMAP_METHOD(deleteCategoryAsync,
...
- (NSDateComponents *)dateComponentsFrom:(NSNumber * _Nullable)unixTime {
  ...
  NSDate *triggerDate = [ABI37_0_0RCTConvert NSDate:unixTime] ?: [NSDate new];
