...
@interface ABI37_0_0RNSVGBrush : NSObject
 ...
 * be clipped.
 */
- (void)paint:(CGContextRef)context opacity:(CGFloat)opacity painter:(ABI37_0_0RNSVGPainter *)painter bounds:(CGRect)bounds;
