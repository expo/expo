...
@implementation ABI37_0_0RNSVGBezierElement
- (instancetype) init
{
    self = [super init];
    if (self)
    {
        ...
        _point = ABI37_0_0RNSVGNULLPOINT;
        _controlPoint1 = ABI37_0_0RNSVGNULLPOINT;
        _controlPoint2 = ABI37_0_0RNSVGNULLPOINT;
    }
    return self;
}
...
{
    ABI37_0_0RNSVGBezierElement *newElement = [[self alloc] init];
...
// Convert one element to ABI37_0_0RNSVGBezierElement and save to array
void ABI37_0_0RNSVGBezierElement_getBezierElements(void *info, const CGPathElement *element)
{
    NSMutableArray *bezierElements = (__bridge NSMutableArray *)info;
    if (element)
        [bezierElements addObject:[ABI37_0_0RNSVGBezierElement elementWithPathElement:*element]];
}
...
+ (NSArray *) elementsFromCGPath:(CGPathRef)path
{
    ...
    CGPathApply(path, (__bridge void *)elements, ABI37_0_0RNSVGBezierElement_getBezierElements);
    return elements;
}
