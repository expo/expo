//
//  ABI37_0_0RCTConvert+GMSMapViewType.m
//
...
@implementation ABI37_0_0RCTConvert (GMSMapViewType)
  ABI37_0_0RCT_ENUM_CONVERTER(GMSMapViewType,
  (
    @{
...
+ (GMSCameraPosition*)GMSCameraPosition:(id)json
{
    ...
    return [ABI37_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:nil];
}
