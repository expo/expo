...
@implementation ABI37_0_0RNSVGSolidColorBrush
{
    CGColorRef _color;
}

- (instancetype)initWithArray:(NSArray<ABI37_0_0RNSVGLength *> *)array
{
    if ((self = [super initWithArray:array])) {
        _color = CGColorRetain([ABI37_0_0RCTConvert ABI37_0_0RNSVGCGColor:array offset:1]);
    }
    return self;
}
...
{
    if ((self = [super init])) {
        _color = CGColorRetain([ABI37_0_0RCTConvert CGColor:number]);
    }
    return self;
}
