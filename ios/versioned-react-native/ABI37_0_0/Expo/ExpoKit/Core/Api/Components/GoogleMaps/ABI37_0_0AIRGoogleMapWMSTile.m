//
//  ABI37_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI37_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI37_0_0WMSTileOverlay *tile = [[ABI37_0_0WMSTileOverlay alloc] init];
...
@implementation ABI37_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
