...
@implementation ABI37_0_0RNSVGContextBrush
{
    BOOL _isStroke;
}
...
{
    ABI37_0_0RNSVGRenderable *element = ABI37_0_0RNSVGRenderable.contextElement;
    if (!element) {
        return NO;
    }

    ABI37_0_0RNSVGBrush *brush = _isStroke ? element.stroke : element.fill;

    BOOL fillColor;

    if (brush.class == ABI37_0_0RNSVGBrush.class) {
