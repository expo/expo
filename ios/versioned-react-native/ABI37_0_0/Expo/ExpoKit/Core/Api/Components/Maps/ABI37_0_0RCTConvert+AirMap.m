...
@implementation ABI37_0_0RCTConvert (AirMap)
...
{
    json = [self NSDictionary:json];
    return [ABI37_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:nil];
}
...
ABI37_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI37_0_0AIRMapCoordinate *)ABI37_0_0AIRMapCoordinate:(id)json
{
    ABI37_0_0AIRMapCoordinate *coord = [ABI37_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI37_0_0RCT_ARRAY_CONVERTER(ABI37_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI37_0_0AIRMapCoordinate *> *> *)ABI37_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI37_0_0RCTConvertArrayValue(@selector(ABI37_0_0AIRMapCoordinateArray:), json);
}
