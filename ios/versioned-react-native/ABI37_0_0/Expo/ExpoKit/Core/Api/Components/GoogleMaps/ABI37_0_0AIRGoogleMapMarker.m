...
@interface ABI37_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI37_0_0AIRGMSMarker*)marker;
@end

@implementation ABI37_0_0AIRGoogleMapMarker {
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI37_0_0AIRGMSMarker alloc] init];
...
- (void)insertABI37_0_0ReactSubview:(id<ABI37_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI37_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI37_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI37_0_0AIRDummyView *dummySubview = [[ABI37_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertABI37_0_0ReactSubview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeABI37_0_0ReactSubview:(id<ABI37_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI37_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeABI37_0_0ReactSubview:(UIView*)dummySubview];
}
...
- (ABI37_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/ABI37_0_0React-native-community/ABI37_0_0React-native-maps/issues/738)
  ...
  _reloadImageCancellationBlock = [_bridge.imageLoader loadImageWithURLRequest:[ABI37_0_0RCTConvert NSURLRequest:_imageSrc]
                                                                          size:self.bounds.size
                                                                         scale:ABI37_0_0RCTScreenScale()
                                                                       clipped:YES
                                                                    resizeMode:ABI37_0_0RCTResizeModeCenter
                                                                 progressBlock:nil
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI37_0_0RN?
...
- (void)setIconSrc:(NSString *)iconSrc
{
  ...
  _reloadImageCancellationBlock =
  [_bridge.imageLoader loadImageWithURLRequest:[ABI37_0_0RCTConvert NSURLRequest:_iconSrc]
                                          size:self.bounds.size
                                         scale:ABI37_0_0RCTScreenScale()
                                       clipped:YES
                                    resizeMode:ABI37_0_0RCTResizeModeCenter
