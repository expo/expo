...
@implementation ABI37_0_0RNSVGRenderable
{
    NSMutableDictionary *_originProperties;
    NSArray<NSString *> *_lastMergedList;
    NSArray<NSString *> *_attributeList;
    NSArray<ABI37_0_0RNSVGLength *> *_sourceStrokeDashArray;
    CGFloat *_strokeDashArrayData;
    CGPathRef _srcHitPath;
}

static ABI37_0_0RNSVGRenderable * _contextElement;
+ (ABI37_0_0RNSVGRenderable *)contextElement { return _contextElement; }
+ (void)setContextElement:(ABI37_0_0RNSVGRenderable *)contextElement { _contextElement = contextElement; }
...
- (id)init
{
    if (self = [super init]) {
        _fillOpacity = 1;
        _strokeOpacity = 1;
        _strokeWidth = [ABI37_0_0RNSVGLength lengthWithNumber:1];
...
- (void)setFill:(ABI37_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI37_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI37_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)setStrokeWidth:(ABI37_0_0RNSVGLength*)strokeWidth
{
...
- (void)setStrokeDasharray:(NSArray<ABI37_0_0RNSVGLength *> *)strokeDasharray
{
...
- (void)setVectorEffect:(ABI37_0_0RNSVGVectorEffect)vectorEffect
{
...
UInt32 ABI37_0_0saturate(CGFloat value) {
...
- (void)renderTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    if (self.mask) {
        ...
        ABI37_0_0RNSVGMask *_maskNode = (ABI37_0_0RNSVGMask*)[self.svgView getDefinedMask:self.mask];
        ...
        for (NSUInteger i = 0; i < npixels; i++) {
            ...
            *currentPixel = ABI37_0_0saturate(luma) << 24;
            currentPixel++;
        }
...
- (void)prepareStrokeDash:(NSUInteger)count strokeDasharray:(NSArray<ABI37_0_0RNSVGLength *> *)strokeDasharray {
...
- (void)renderMarkers:(CGContextRef)context path:(CGPathRef)path rect:(const CGRect *)rect {
    ABI37_0_0RNSVGMarker *markerStart = (ABI37_0_0RNSVGMarker*)[self.svgView getDefinedMarker:self.markerStart];
    ABI37_0_0RNSVGMarker *markerMid = (ABI37_0_0RNSVGMarker*)[self.svgView getDefinedMarker:self.markerMid];
    ABI37_0_0RNSVGMarker *markerEnd = (ABI37_0_0RNSVGMarker*)[self.svgView getDefinedMarker:self.markerEnd];
    if (markerStart || markerMid || markerEnd) {
        _contextElement = self;
        NSArray<ABI37_0_0RNSVGMarkerPosition*>* positions = [ABI37_0_0RNSVGMarkerPosition fromCGPath:path];
        ...
        for (ABI37_0_0RNSVGMarkerPosition* position in positions) {
            ABI37_0_0RNSVGMarkerType type = [position type];
            ABI37_0_0RNSVGMarker *marker;
            switch (type) {
                case kStartMarker:
                    marker = markerStart;
                    break;
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    if (self.fill) {
        if (self.fill.class == ABI37_0_0RNSVGBrush.class) {
    ...
    if (self.stroke) {
        ...
        NSArray<ABI37_0_0RNSVGLength *>* strokeDasharray = self.strokeDasharray;
        ...
        if (self.stroke.class == ABI37_0_0RNSVGBrush.class) {
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    if (self.clipPath) {
        ABI37_0_0RNSVGClipPath *clipNode = (ABI37_0_0RNSVGClipPath*)[self.svgView getDefinedClipPath:self.clipPath];
        if ([clipNode isSimpleClipPath]) {
            ...
            ABI37_0_0RNSVGRenderable *clipGroup = (ABI37_0_0RNSVGRenderable*)clipNode;
...
- (void)mergeProperties:(__kindof ABI37_0_0RNSVGRenderable *)target
{
