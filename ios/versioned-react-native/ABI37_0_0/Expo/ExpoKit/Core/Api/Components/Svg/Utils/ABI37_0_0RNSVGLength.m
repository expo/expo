...
@implementation ABI37_0_0RNSVGLength
...
{
    ABI37_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype) lengthWithString: (NSString *) lengthString {
    ...
    ABI37_0_0RNSVGLength *output = [ABI37_0_0RNSVGLength alloc];
    if (stringLength == 0) {
        ...
        ABI37_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
...
- (BOOL) isEqualTo: (ABI37_0_0RNSVGLength *)other {
