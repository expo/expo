//
//  ABI37_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI37_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI37_0_0RNGestureHandler *otherHandler = [ABI37_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI37_0_0RCTTouchHandler class]];
}
