...
#else
#import <ABI37_0_0React/ABI37_0_0RCTUIKit.h>
#endif // !TARGET_OS_OSX

#import "objc/runtime.h"

static NSTimer *keyboardTimer;
static NSString *const HistoryShimName = @"ABI37_0_0ReactNativeHistoryShim";
...
@interface ABI37_0_0_SwizzleHelperWK : UIView
@property (nonatomic, copy) WKWebView *webView;
@end
@implementation ABI37_0_0_SwizzleHelperWK
...
#if TARGET_OS_OSX
@interface ABI37_0_0RNCWKWebView : WKWebView
@end
@implementation ABI37_0_0RNCWKWebView
- (void)scrollWheel:(NSEvent *)theEvent {
  ABI37_0_0RNCWebView *rncWebView = (ABI37_0_0RNCWebView *)[self superview];
  ABI37_0_0RCTAssert([rncWebView isKindOfClass:[rncWebView class]], @"superview must be an ABI37_0_0RNCWebView");
...
@interface ABI37_0_0RNCWebView () <WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler,
#if !TARGET_OS_OSX
    UIScrollViewDelegate,
#endif // !TARGET_OS_OSX
    ABI37_0_0RCTAutoInsetsProtocol>
@property (nonatomic, copy) ABI37_0_0RCTDirectEventBlock onLoadingStart;
@property (nonatomic, copy) ABI37_0_0RCTDirectEventBlock onLoadingFinish;
@property (nonatomic, copy) ABI37_0_0RCTDirectEventBlock onLoadingError;
@property (nonatomic, copy) ABI37_0_0RCTDirectEventBlock onLoadingProgress;
@property (nonatomic, copy) ABI37_0_0RCTDirectEventBlock onShouldStartLoadWithRequest;
@property (nonatomic, copy) ABI37_0_0RCTDirectEventBlock onHttpError;
@property (nonatomic, copy) ABI37_0_0RCTDirectEventBlock onMessage;
@property (nonatomic, copy) ABI37_0_0RCTDirectEventBlock onScroll;
@property (nonatomic, copy) ABI37_0_0RCTDirectEventBlock onContentProcessDidTerminate;
#if !TARGET_OS_OSX
@property (nonatomic, copy) WKWebView *webView;
#else
@property (nonatomic, copy) ABI37_0_0RNCWKWebView *webView;
#endif // !TARGET_OS_OSX
@end

@implementation ABI37_0_0RNCWebView
{
#if !TARGET_OS_OSX
  UIColor * _savedBackgroundColor;
#else
  ABI37_0_0RCTUIColor * _savedBackgroundColor;
#endif // !TARGET_OS_OSX
  BOOL _savedHideKeyboardAccessoryView;
  BOOL _savedKeyboardDisplayRequiresUserAction;

  // Workaround for StatusBar appearance bug for iOS 12
  // https://github.com/ABI37_0_0React-native-community/ABI37_0_0React-native-webview/issues/62
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if ((self = [super initWithFrame:frame])) {
    ...
    #else
    super.backgroundColor = [ABI37_0_0RCTUIColor clearColor];
    #endif // !TARGET_OS_OSX
    _bounces = YES;
    _scrollEnabled = YES;
...
#if !TARGET_OS_OSX
    _savedStatusBarStyle = ABI37_0_0RCTSharedApplication().statusBarStyle;
    _savedStatusBarHidden = ABI37_0_0RCTSharedApplication().statusBarHidden;
#endif // !TARGET_OS_OSX
...
- (WKWebViewConfiguration *)setUpWkWebViewConfig
{
  ...
  [wkWebViewConfig.userContentController addScriptMessageHandler:[[ABI37_0_0RNCWeakScriptMessageDelegate alloc] initWithDelegate:self]
      ...
      */
      ...
      for (NSHTTPCookie *cookie in [[NSHTTPCookieStorage sharedHTTPCookieStorage] cookies]) {
        [script appendFormat:@"document.cookie = %@ + '=' + %@",
          ABI37_0_0RCTJSONStringify(cookie.name, NULL),
          ABI37_0_0RCTJSONStringify(cookie.value, NULL)];
        if (cookie.path) {
          [script appendFormat:@" + '; Path=' + %@", ABI37_0_0RCTJSONStringify(cookie.path, NULL)];
        }
...
#else
    _webView = [[ABI37_0_0RNCWKWebView alloc] initWithFrame:self.bounds configuration: wkWebViewConfig];
#endif // !TARGET_OS_OSX
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    ...
    ABI37_0_0RCTUnsafeExecuteOnMainQueueSync(^{
      [ABI37_0_0RCTSharedApplication() setStatusBarStyle:UIStatusBarStyleLightContent animated:YES];
    });
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    ...
    ABI37_0_0RCTUnsafeExecuteOnMainQueueSync(^{
      [ABI37_0_0RCTSharedApplication() setStatusBarHidden:self->_savedStatusBarHidden animated:YES];
      [ABI37_0_0RCTSharedApplication() setStatusBarStyle:self->_savedStatusBarStyle animated:YES];
    });
#pragma clang diagnostic pop
}
...
#else
- (void)setBackgroundColor:(ABI37_0_0RCTUIColor *)backgroundColor
#endif // !TARGET_OS_OSX
{
...
- (void)visitSource
{
    ...
    NSString *html = [ABI37_0_0RCTConvert NSString:_source[@"html"]];
    if (html) {
        NSURL *baseURL = [ABI37_0_0RCTConvert NSURL:_source[@"baseUrl"]];
        if (!baseURL) {
    ...
    // Because of the way ABI37_0_0React works, as pages redirect, we actually end up
    ...
    if (request.URL.host) {
        ...
        NSURL* readAccessUrl = _allowingReadAccessToURL ? [ABI37_0_0RCTConvert NSURL:_allowingReadAccessToURL] : request.URL;
...
-(void)setHideKeyboardAccessoryView:(BOOL)hideKeyboardAccessoryView
{
    ...
    NSString* name = [NSString stringWithFormat:@"%@ABI37_0_0_SwizzleHelperWK", subview.class.superclass];
    ...
    if(newClass == nil)
    {
        ...
        Method method = class_getInstanceMethod([ABI37_0_0_SwizzleHelperWK class], @selector(inputAccessoryView));
...
- (void)postMessage:(NSString *)message
{
  ...
  NSString *source = [NSString
    ...
    ABI37_0_0RCTJSONStringify(eventInitDict, NULL)
  ];
...
- (void)layoutSubviews
{
  ...
  // Ensure webview takes the position and dimensions of ABI37_0_0RNCWebView
...
- (void)webView:(WKWebView *)webView runJavaScriptTextInputPanelWithPrompt:(NSString *)prompt defaultText:(NSString *)defaultText initiatedByFrame:(WKFrameInfo *)frame completionHandler:(void (^)(NSString *))completionHandler{
  ...
  const NSRect ABI37_0_0RCTSingleTextFieldFrame = NSMakeRect(0.0, 0.0, 275.0, 22.0);
  NSTextField *textField = [[NSTextField alloc] initWithFrame:ABI37_0_0RCTSingleTextFieldFrame];
...
{
  ABI37_0_0RCTLogWarn(@"Webview Process Terminated");
          ...
          thenCall: (void (^)(NSString*)) callback
{
  [self.webView evaluateJavaScript: js completionHandler: ^(id result, NSError *error) {
    ...
    if (error != nil) {
      ABI37_0_0RCTLogWarn(@"%@", [NSString stringWithFormat:@"Error evaluating injectedJavaScript: This is possibly due to an unsupported return type. Try adding true to the end of your injectedJavaScript string. %@", error]);
    }
  }];
}
...
- (NSURLRequest *)requestForSource:(id)json {
  NSURLRequest *request = [ABI37_0_0RCTConvert NSURLRequest:self.source];
...
@implementation ABI37_0_0RNCWeakScriptMessageDelegate
