//
//  ABI37_0_0AIRGoogleMapWMSTile.h
//  AirMaps
//
...
@interface ABI37_0_0WMSTileOverlay : GMSSyncTileLayer
...
@interface ABI37_0_0AIRGoogleMapWMSTile : UIView
@property (nonatomic, strong) ABI37_0_0WMSTileOverlay *tileLayer;
