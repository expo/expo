...
@interface ABI37_0_0RNForceTouchGestureRecognizer : UIGestureRecognizer
...
@implementation ABI37_0_0RNForceTouchGestureRecognizer {
...
@implementation ABI37_0_0RNForceTouchHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI37_0_0RNForceTouchGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI37_0_0RNForceTouchGestureRecognizer *recognizer = (ABI37_0_0RNForceTouchGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    recognizer.feedbackOnActivation = [ABI37_0_0RCTConvert BOOL:prop];
  }
}

- (ABI37_0_0RNGestureHandlerEventExtraData *)eventExtraData:(ABI37_0_0RNForceTouchGestureRecognizer *)recognizer
{
