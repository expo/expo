#if canImport(ABI37_0_0React)
import ABI37_0_0React
#endif

import Lottie

class ContainerView: ABI37_0_0RCTView {
    ...
    @objc var onAnimationFinish: ABI37_0_0RCTBubblingEventBlock?
    ...
    override func abi37_0_0ReactSetFrame(_ frame: CGRect) {
        super.abi37_0_0ReactSetFrame(frame)
        animationView?.abi37_0_0ReactSetFrame(frame)
    }
