//
//  ABI37_0_0AIRGoogleMapPolyline.m
//
...
@implementation ABI37_0_0AIRGoogleMapPolyline

- (instancetype)init
{
  if (self = [super init]) {
    _polyline = [[ABI37_0_0AIRGMSPolyline alloc] init];
  }
  return self;
}

-(void)setCoordinates:(NSArray<ABI37_0_0AIRMapCoordinate *> *)coordinates
{
...
- (void)setOnPress:(ABI37_0_0RCTBubblingEventBlock)onPress {
