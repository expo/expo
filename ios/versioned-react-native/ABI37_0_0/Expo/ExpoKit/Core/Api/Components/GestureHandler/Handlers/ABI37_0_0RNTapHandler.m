...
// ABI37_0_0RNBetterTapGestureRecognizer extends UIGestureRecognizer instead of UITapGestureRecognizer 
...
@interface ABI37_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
- (id)initWithGestureHandler:(ABI37_0_0RNGestureHandler*)gestureHandler;

@end

@implementation ABI37_0_0RNBetterTapGestureRecognizer {
  __weak ABI37_0_0RNGestureHandler *_gestureHandler;
...
@implementation ABI37_0_0RNTapGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI37_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI37_0_0RNBetterTapGestureRecognizer *recognizer = (ABI37_0_0RNBetterTapGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    recognizer.maxDelay = [ABI37_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDurationMs"];
  if (prop != nil) {
    recognizer.maxDuration = [ABI37_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDist"];
  if (prop != nil) {
    CGFloat dist = [ABI37_0_0RCTConvert CGFloat:prop];
