...
@implementation ABI37_0_0RNSVGMarker
...
- (void)setX:(ABI37_0_0RNSVGLength *)refX
{
...
- (void)setY:(ABI37_0_0RNSVGLength *)refY
{
...
- (void)setMarkerWidth:(ABI37_0_0RNSVGLength *)markerWidth
{
...
- (void)setMarkerHeight:(ABI37_0_0RNSVGLength *)markerHeight
{
...
static CGFloat ABI37_0_0RNSVG_degToRad = (CGFloat)M_PI / 180;

double ABI37_0_0deg2rad(CGFloat deg) {
    return deg * ABI37_0_0RNSVG_degToRad;
}
...
- (void)renderMarker:(CGContextRef)context rect:(CGRect)rect position:(ABI37_0_0RNSVGMarkerPosition*)position strokeWidth:(CGFloat)strokeWidth
{
    ...
    float rad = ABI37_0_0deg2rad(angle);
    ...
    if (self.align) {
        CGAffineTransform viewBoxTransform = [ABI37_0_0RNSVGViewBox getTransform:CGRectMake(self.minX, self.minY, self.vbWidth, self.vbHeight)
                                                                  eRect:eRect
                                                                  align:self.align
