...
@implementation ABI37_0_0RNSVGGroupManager

ABI37_0_0RCT_EXPORT_MODULE()

- (ABI37_0_0RNSVGNode *)node
{
  return [ABI37_0_0RNSVGGroup new];
}

ABI37_0_0RCT_EXPORT_VIEW_PROPERTY(font, NSDictionary)

ABI37_0_0RCT_CUSTOM_VIEW_PROPERTY(fontSize, id, ABI37_0_0RNSVGGroup)
{
...
ABI37_0_0RCT_CUSTOM_VIEW_PROPERTY(fontWeight, id, ABI37_0_0RNSVGGroup)
{
    if ([json isKindOfClass:[NSString class]]) {
        NSString *stringValue = (NSString *)json;
