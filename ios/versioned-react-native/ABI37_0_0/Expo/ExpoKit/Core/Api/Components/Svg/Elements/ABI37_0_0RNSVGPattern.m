...
@implementation ABI37_0_0RNSVGPattern
...
{
    self.dirty = false;
    NSArray<ABI37_0_0RNSVGLength *> *points = @[self.x, self.y, self.patternwidth, self.patternheight];
...
- (void)setPatternwidth:(ABI37_0_0RNSVGLength *)patternwidth
{
...
- (void)setPatternheight:(ABI37_0_0RNSVGLength *)patternheight
{
...
- (void)setPatternUnits:(ABI37_0_0RNSVGUnits)patternUnits
{
...
- (void)setPatternContentUnits:(ABI37_0_0RNSVGUnits)patternContentUnits
{
