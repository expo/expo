...
@implementation ABI37_0_0REAPropsNode
{
  NSNumber *_connectedViewTag;
  NSString *_connectedViewName;
  NSMutableDictionary<NSString *, ABI37_0_0REANodeID> *_propsConfig;
}
...
- (id)evaluate
{
  ...
  for (NSString *prop in _propsConfig) {
    ABI37_0_0REANode *propNode = [self.nodesManager findNodeByID:_propsConfig[prop]];
    
    if ([propNode isKindOfClass:[ABI37_0_0REAStyleNode class]]) {
