...
CGFloat ABI37_0_0SimAnimationDragCoefficient()
{
#if TARGET_IPHONE_SIMULATOR
...
@implementation ABI37_0_0REATransitionAnimation {
...
{
  ABI37_0_0REATransitionAnimation *anim = [ABI37_0_0REATransitionAnimation new];
...
- (void)play
{
  ...
  */
  if (_delay > 0){
    _animation.beginTime = CACurrentMediaTime() + _delay * ABI37_0_0SimAnimationDragCoefficient();
  }
  _animation.duration = self.duration * ABI37_0_0SimAnimationDragCoefficient();
