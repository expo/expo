...
@implementation ABI37_0_0REABezierNode {
...
- (instancetype)initWithID:(ABI37_0_0REANodeID)nodeID config:(NSDictionary<NSString *,id> *)config
{
  if ((self = [super initWithID:nodeID config:config])) {
    _inputNodeID = [ABI37_0_0RCTConvert NSNumber:config[@"input"]];
    ABI37_0_0REA_LOG_ERROR_IF_NIL(_inputNodeID, @"Reanimated: First argument passed to bezier node is either of wrong type or is missing.");
