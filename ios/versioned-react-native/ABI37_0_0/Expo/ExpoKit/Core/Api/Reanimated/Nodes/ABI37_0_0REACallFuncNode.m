...
@implementation ABI37_0_0REACallFuncNode {
...
- (instancetype)initWithID:(ABI37_0_0REANodeID)nodeID config:(NSDictionary<NSString *,id> *)config
{
  if ((self = [super initWithID:nodeID config:config])) {
    ...
    ABI37_0_0REA_LOG_ERROR_IF_NIL(_whatNodeID, @"Reanimated: First argument passed to callFunc node is either of wrong type or is missing.");
    _args = config[@"args"];
...
- (void)beginContext
{
  ...
  for (NSUInteger i = 0; i < _params.count; i++) {
    ...
    ABI37_0_0REAParamNode *param = (ABI37_0_0REAParamNode *)[self.nodesManager findNodeByID:paramID];
...
{
  [self beginContext];
  ABI37_0_0REAFunctionNode *what = (ABI37_0_0REAFunctionNode *)[self.nodesManager findNodeByID:_whatNodeID];
