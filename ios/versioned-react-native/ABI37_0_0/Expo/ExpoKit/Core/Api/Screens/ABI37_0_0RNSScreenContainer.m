...
- (UIViewController*)findChildControllerForScreen:(ABI37_0_0RNSScreenView*)screen
{
...
- (void)prepareDetach:(ABI37_0_0RNSScreenView *)screen
{
...
- (void)attachScreen:(ABI37_0_0RNSScreenView *)screen atIndex:(NSInteger)index
{
