...
@interface ABI37_0_0EXAdsDFPBannerView : UIView <GADBannerViewDelegate, GADAppEventDelegate>
...
@property (nonatomic, copy) ABI37_0_0UMDirectEventBlock onAdmobDispatchAppEvent;
