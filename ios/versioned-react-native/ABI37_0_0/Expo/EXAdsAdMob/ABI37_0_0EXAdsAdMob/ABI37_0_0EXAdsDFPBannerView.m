...
@implementation ABI37_0_0EXAdsDFPBannerView {
  DFPBannerView *_bannerView;
  id<ABI37_0_0UMEventEmitterService> _eventEmitter;
}
...
- (void)setOnSizeChange:(ABI37_0_0UMDirectEventBlock)block
{
  _onSizeChange = block;
  [self loadBanner];
}

- (void)setOnDidFailToReceiveAdWithError:(ABI37_0_0UMDirectEventBlock)block
{
