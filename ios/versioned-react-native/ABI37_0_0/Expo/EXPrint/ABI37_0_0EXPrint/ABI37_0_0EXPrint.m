...
#import <ABI37_0_0EXPrint/ABI37_0_0EXPrint.h>
...
NSString *const ABI37_0_0EXPrintOrientationPortrait = @"portrait";
NSString *const ABI37_0_0EXPrintOrientationLandscape = @"landscape";

@interface ABI37_0_0EXPrint () <UIPrintInteractionControllerDelegate, UIPrinterPickerControllerDelegate>
...
@implementation ABI37_0_0EXPrint

ABI37_0_0UM_EXPORT_MODULE(ExponentPrint);
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"Orientation": @{
               @"portrait": ABI37_0_0EXPrintOrientationPortrait,
               @"landscape": ABI37_0_0EXPrintOrientationLandscape,
               },
           };
}

ABI37_0_0UM_EXPORT_METHOD_AS(print,
                    ...
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  [self _getPrintingDataForOptions:options callback:^(NSData *printingData, NSDictionary *errorDetails) {
    if (errorDetails != nil) {
      reject(errorDetails[@"code"], errorDetails[@"message"], ABI37_0_0UMErrorWithMessage(errorDetails[@"message"]));
      return;
    }
    ...
    if (printingData == nil) {
      ...
      if (options[@"markupFormatterIOS"] && [options[@"markupFormatterIOS"] isKindOfClass:[NSString class]]) {
        ...
        if (htmlString != nil) {
          ...
          reject(@"E_HTML_INVALID", message, ABI37_0_0UMErrorWithMessage(message));
          return;
        }
      } else {
...
ABI37_0_0UM_EXPORT_METHOD_AS(selectPrinter,selectPrinter:(ABI37_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
...
ABI37_0_0UM_EXPORT_METHOD_AS(printToFileAsync,
                    ...
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI37_0_0EXWKPDFRenderer *renderTask = [ABI37_0_0EXWKPDFRenderer new];
...
{
  id<ABI37_0_0UMUtilitiesInterface> utils = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI37_0_0UMUtilitiesInterface)];
...
{
  if ([orientation isEqualToString:ABI37_0_0EXPrintOrientationLandscape]) {
