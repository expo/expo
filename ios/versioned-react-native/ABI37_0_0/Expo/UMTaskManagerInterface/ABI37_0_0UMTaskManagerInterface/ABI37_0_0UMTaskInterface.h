...
@protocol ABI37_0_0UMTaskConsumerInterface;

@protocol ABI37_0_0UMTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI37_0_0UMTaskConsumerInterface> __nonnull consumer;
