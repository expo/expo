...
// Interface for ABI37_0_0UMTaskManager module.

@protocol ABI37_0_0UMTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI37_0_0UMTaskConsumerInterface protocol.
 */
