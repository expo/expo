...
NSString *const ABI37_0_0EXAssetMediaTypeAudio = @"audio";
NSString *const ABI37_0_0EXAssetMediaTypePhoto = @"photo";
NSString *const ABI37_0_0EXAssetMediaTypeVideo = @"video";
NSString *const ABI37_0_0EXAssetMediaTypeUnknown = @"unknown";
NSString *const ABI37_0_0EXAssetMediaTypeAll = @"all";

NSString *const ABI37_0_0EXMediaLibraryDidChangeEvent = @"mediaLibraryDidChange";

@interface ABI37_0_0EXMediaLibrary ()
...
@implementation ABI37_0_0EXMediaLibrary

ABI37_0_0UM_EXPORT_MODULE(ExponentMediaLibrary);
...
- (void)setModuleRegistry:(ABI37_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  [ABI37_0_0UMPermissionsMethodsDelegate registerRequesters:@[[ABI37_0_0EXMediaLibraryCameraRollRequester new]] withPermissionsManager:_permissionsManager];
}
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"MediaType": @{
               @"audio": ABI37_0_0EXAssetMediaTypeAudio,
               @"photo": ABI37_0_0EXAssetMediaTypePhoto,
               @"video": ABI37_0_0EXAssetMediaTypeVideo,
               @"unknown": ABI37_0_0EXAssetMediaTypeUnknown,
               @"all": ABI37_0_0EXAssetMediaTypeAll,
               },
           @"SortBy": @{
               @"default": @"default",
           ...
           @"CHANGE_LISTENER_NAME": ABI37_0_0EXMediaLibraryDidChangeEvent,
           };
}

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI37_0_0EXMediaLibraryDidChangeEvent];
}
                    ...
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  [ABI37_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI37_0_0EXMediaLibraryCameraRollRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
...
ABI37_0_0UM_EXPORT_METHOD_AS(createAssetAsync,
                    ...
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  PHAssetMediaType assetType = [ABI37_0_0EXMediaLibrary _assetTypeForUri:localUri];
  ...
  if (!([_fileSystem permissionsForURI:assetUrl] & ABI37_0_0UMFileSystemPermissionRead)) {
  ...
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    ...
    if (success) {
      PHAsset *asset = [ABI37_0_0EXMediaLibrary _getAssetById:assetPlaceholder.localIdentifier];
      resolve([ABI37_0_0EXMediaLibrary _exportAsset:asset]);
    } else {
...
ABI37_0_0UM_EXPORT_METHOD_AS(saveToLibraryAsync,
                    ...
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI37_0_0EXSaveToLibraryDelegate *delegate = [ABI37_0_0EXSaveToLibraryDelegate new];
  [_saveToLibraryDelegates addObject:delegate];
  ABI37_0_0EXSaveToLibraryCallback callback = ^(id asset, NSError *error){
...
ABI37_0_0UM_EXPORT_METHOD_AS(addAssetsToAlbumAsync,
                    ...
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  [ABI37_0_0EXMediaLibrary _addAssets:assetIds toAlbum:albumId withCallback:^(BOOL success, NSError *error) {
    if (error) {
...
ABI37_0_0UM_EXPORT_METHOD_AS(removeAssetsFromAlbumAsync,
                    ...
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    PHAssetCollection *collection = [ABI37_0_0EXMediaLibrary _getAlbumById:albumId];
    PHFetchResult *assets = [ABI37_0_0EXMediaLibrary _getAssetsByIds:assetIds];
...
ABI37_0_0UM_EXPORT_METHOD_AS(deleteAssetsAsync,
...
ABI37_0_0UM_EXPORT_METHOD_AS(getAlbumsAsync,
                    ...
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  [albums addObjectsFromArray:[ABI37_0_0EXMediaLibrary _exportCollections:userAlbumsFetchResult withFetchOptions:fetchOptions inFolder:nil]];
  ...
  if ([options[@"includeSmartAlbums"] boolValue]) {
    ...
    [albums addObjectsFromArray:[ABI37_0_0EXMediaLibrary _exportCollections:smartAlbumsFetchResult withFetchOptions:fetchOptions inFolder:nil]];
  }
  
  resolve(albums);
}

ABI37_0_0UM_EXPORT_METHOD_AS(getMomentsAsync,
                    getMoments:(ABI37_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  if (![self _checkPermissions:reject]) {
    return;
  ...
  NSArray<NSDictionary *> *albums = [ABI37_0_0EXMediaLibrary _exportCollections:fetchResult withFetchOptions:options inFolder:nil];
  
  resolve(albums);
}

ABI37_0_0UM_EXPORT_METHOD_AS(getAlbumAsync,
                    ...
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  PHAssetCollection *collection = [ABI37_0_0EXMediaLibrary _getAlbumWithTitle:title];
  resolve(ABI37_0_0UMNullIfNil([ABI37_0_0EXMediaLibrary _exportCollection:collection]));
}

ABI37_0_0UM_EXPORT_METHOD_AS(createAlbumAsync,
                    ...
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  [ABI37_0_0EXMediaLibrary _createAlbumWithTitle:title completion:^(PHAssetCollection *collection, NSError *error) {
    if (collection) {
      if (assetId) {
        [ABI37_0_0EXMediaLibrary _addAssets:@[assetId] toAlbum:collection.localIdentifier withCallback:^(BOOL success, NSError *error) {
          if (success) {
            resolve(ABI37_0_0UMNullIfNil([ABI37_0_0EXMediaLibrary _exportCollection:collection]));
          } else {
...
ABI37_0_0UM_EXPORT_METHOD_AS(deleteAlbumsAsync,
                    ...
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  PHFetchResult *collections = [ABI37_0_0EXMediaLibrary _getAlbumsById:albumIds];
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    if (assetRemove) {
...
ABI37_0_0UM_EXPORT_METHOD_AS(getAssetInfoAsync,
                    ...
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  PHAsset *asset = [ABI37_0_0EXMediaLibrary _getAssetById:assetId];
  
  if (asset) {
    NSMutableDictionary *result = [ABI37_0_0EXMediaLibrary _exportAssetInfo:asset];
...
ABI37_0_0UM_EXPORT_METHOD_AS(getAssetsAsync,
                    ...
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *createdAfter = [ABI37_0_0UMUtilities NSDate:options[@"createdAfter"]];
  NSDate *createdBefore = [ABI37_0_0UMUtilities NSDate:options[@"createdBefore"]];
  
  PHAssetCollection *collection;
  PHAsset *cursor;
  
  if (after) {
    cursor = [ABI37_0_0EXMediaLibrary _getAssetById:after];
  ...
  if (albumId) {
    collection = [ABI37_0_0EXMediaLibrary _getAlbumById:albumId];
  ...
  if (mediaType && [mediaType count] > 0) {
    NSMutableArray<NSNumber *> *assetTypes = [ABI37_0_0EXMediaLibrary _convertMediaTypes:mediaType];
  ...
  if (sortBy && sortBy.count > 0) {
    fetchOptions.sortDescriptors = [ABI37_0_0EXMediaLibrary _prepareSortDescriptors:sortBy];
  }
  ...
  if (fetchOptions.sortDescriptors.count == 0) {
    ...
    for (NSInteger i = startIndex; i >= endIndex; i--) {
      ...
      [assets addObject:[ABI37_0_0EXMediaLibrary _exportAsset:asset]];
    }
...
- (void)startObserving
{
  _allAssetsFetchResult = [ABI37_0_0EXMediaLibrary _getAllAssets];
    ...
    if (changeDetails != nil) {
      ...
      if (changeDetails.hasIncrementalChanges && (changeDetails.insertedObjects.count > 0 || changeDetails.removedObjects.count > 0)) {
        ...
        for (PHAsset *asset in changeDetails.insertedObjects) {
          [insertedAssets addObject:[ABI37_0_0EXMediaLibrary _exportAsset:asset]];
        }
        for (PHAsset *asset in changeDetails.removedObjects) {
          [deletedAssets addObject:[ABI37_0_0EXMediaLibrary _exportAsset:asset]];
        }
        
        [_eventEmitter sendEventWithName:ABI37_0_0EXMediaLibraryDidChangeEvent body:body];
      }
    }
  }
}
...
{
  if (assetId) {
    return [ABI37_0_0EXMediaLibrary _getAssetsByIds:@[assetId]].firstObject;
  }
  return nil;
}
...
+ (void)_ensureAlbumWithTitle:(nonnull NSString *)title completion:(void(^)(PHAssetCollection *collection, NSError *error))completion
{
  ...
  [ABI37_0_0EXMediaLibrary _createAlbumWithTitle:title completion:completion];
}
...
+ (NSDictionary *)_exportAsset:(PHAsset *)asset
{
  if (asset) {
    ...
    return @{
             ...
             @"filename": fileName,
             @"uri": [ABI37_0_0EXMediaLibrary _assetUriForLocalId:asset.localIdentifier andExtension:assetExtension],
             @"mediaType": [ABI37_0_0EXMediaLibrary _stringifyMediaType:asset.mediaType],
             @"mediaSubtypes": [ABI37_0_0EXMediaLibrary _stringifyMediaSubtypes:asset.mediaSubtypes],
             @"width": @(asset.pixelWidth),
             @"height": @(asset.pixelHeight),
             @"creationTime": [ABI37_0_0EXMediaLibrary _exportDate:asset.creationDate],
             @"modificationTime": [ABI37_0_0EXMediaLibrary _exportDate:asset.modificationDate],
...
{
  NSMutableDictionary *assetDict = [[ABI37_0_0EXMediaLibrary _exportAsset:asset] mutableCopy];
  
  if (assetDict) {
    assetDict[@"location"] = [ABI37_0_0EXMediaLibrary _exportLocation:asset.location];
...
{
  return [ABI37_0_0EXMediaLibrary _exportCollection:collection inFolder:nil];
}
...
+ (nullable NSDictionary *)_exportCollection:(PHAssetCollection *)collection inFolder:(nullable NSString *)folderName
{
  if (collection) {
    return @{
             @"id": [ABI37_0_0EXMediaLibrary _assetIdFromLocalId:collection.localIdentifier],
             @"title": ABI37_0_0UMNullIfNil(collection.localizedTitle),
             @"folderName": ABI37_0_0UMNullIfNil(folderName),
             @"type": [ABI37_0_0EXMediaLibrary _stringifyAlbumType:collection.assetCollectionType],
             @"assetCount": [ABI37_0_0EXMediaLibrary _assetCountOfCollection:collection],
             @"startTime": [ABI37_0_0EXMediaLibrary _exportDate:collection.startDate],
             @"endTime": [ABI37_0_0EXMediaLibrary _exportDate:collection.endDate],
             @"approximateLocation": [ABI37_0_0EXMediaLibrary _exportLocation:collection.approximateLocation],
             @"locationNames": ABI37_0_0UMNullIfNil(collection.localizedLocationNames),
             };
  }
  return nil;
}
                       ...
                       inFolder:(nullable NSString *)folderName
{
  ...
  for (PHCollection *collection in collections) {
    if ([collection isKindOfClass:[PHAssetCollection class]]) {
      [albums addObject:[ABI37_0_0EXMediaLibrary _exportCollection:(PHAssetCollection *)collection inFolder:folderName]];
      ...
      [albums addObjectsFromArray:[ABI37_0_0EXMediaLibrary _exportCollections:collectionsInFolder withFetchOptions:options inFolder:collection.localizedTitle]];
    }
  }
  return [albums copy];
}
...
{
  NSString *assetId = [ABI37_0_0EXMediaLibrary _assetIdFromLocalId:localId];
...
+ (NSString *)_stringifyMediaType:(PHAssetMediaType)mediaType
{
  switch (mediaType) {
    case PHAssetMediaTypeAudio:
      return ABI37_0_0EXAssetMediaTypeAudio;
    case PHAssetMediaTypeImage:
      return ABI37_0_0EXAssetMediaTypePhoto;
    case PHAssetMediaTypeVideo:
      return ABI37_0_0EXAssetMediaTypeVideo;
    default:
      return ABI37_0_0EXAssetMediaTypeUnknown;
  }
}

+ (PHAssetMediaType)_convertMediaType:(NSString *)mediaType
{
  if ([mediaType isEqualToString:ABI37_0_0EXAssetMediaTypeAudio]) {
    return PHAssetMediaTypeAudio;
  }
  if ([mediaType isEqualToString:ABI37_0_0EXAssetMediaTypePhoto]) {
    return PHAssetMediaTypeImage;
  }
  if ([mediaType isEqualToString:ABI37_0_0EXAssetMediaTypeVideo]) {
    return PHAssetMediaTypeVideo;
  }
  return PHAssetMediaTypeUnknown;
}
...
+ (NSMutableArray<NSNumber *> *)_convertMediaTypes:(NSArray<NSString *> *)mediaTypes
{
  ...
  [mediaTypes enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
    if ([obj isEqualToString:ABI37_0_0EXAssetMediaTypeAll]) {
      *stop = YES;
      assetTypes = nil;
      return;
    }
    PHAssetMediaType assetType = [ABI37_0_0EXMediaLibrary _convertMediaType:obj];
...
+ (NSString *)_convertSortByKey:(NSString *)key
{
  ...
  if (value == nil) {
    ...
    @throw [NSException exceptionWithName:@"ABI37_0_0EXMediaLibrary.UNSUPPORTED_SORTBY_KEY" reason:reason userInfo:nil];
  }
  return value;
}
...
+ (NSSortDescriptor *)_sortDescriptorFrom:(id)config
{
  if ([config isKindOfClass:[NSString class]]) {
    NSString *key = [ABI37_0_0EXMediaLibrary _convertSortByKey:config];
  ...
  if ([config isKindOfClass:[NSArray class]]) {
    ...
    NSString *key = [ABI37_0_0EXMediaLibrary _convertSortByKey:sortArray[0]];
...
+ (NSArray *)_prepareSortDescriptors:(NSArray *)sortBy
{
  ...
  for (id config in sortByArray) {
    NSSortDescriptor *sortDescriptor = [ABI37_0_0EXMediaLibrary _sortDescriptorFrom:config];
...
- (BOOL)_checkPermissions:(ABI37_0_0UMPromiseRejectBlock)reject
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI37_0_0EXMediaLibraryCameraRollRequester class]]) {
