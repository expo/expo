...
#import <ABI37_0_0EXBattery/ABI37_0_0EXBattery.h>
#import <ABI37_0_0UMCore/ABI37_0_0UMUtilities.h>

@interface ABI37_0_0EXBattery ()
...
@property (nonatomic, readonly) ABI37_0_0EXBatteryState batteryState;

@end

@implementation ABI37_0_0EXBattery

ABI37_0_0UM_EXPORT_MODULE(ExpoBattery);
...
ABI37_0_0UM_EXPORT_METHOD_AS(getBatteryLevelAsync,
                    getBatteryLevelAsyncWithResolver:(ABI37_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  resolve(@(UIDevice.currentDevice.batteryLevel));
}

ABI37_0_0UM_EXPORT_METHOD_AS(getBatteryStateAsync,
                    getBatteryStateAsyncWithResolver:(ABI37_0_0UMPromiseResolveBlock)resolve rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  resolve(@([self batteryState]));
}

ABI37_0_0UM_EXPORT_METHOD_AS(isLowPowerModeEnabledAsync,
                    isLowPowerModeEnabledAsyncWithResolver:(ABI37_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  resolve(@(NSProcessInfo.processInfo.isLowPowerModeEnabled));
}

- (ABI37_0_0EXBatteryState)batteryState
{
  switch (UIDevice.currentDevice.batteryState) {
    case UIDeviceBatteryStateUnknown:
      return ABI37_0_0EXBatteryStateUnknown;
    case UIDeviceBatteryStateUnplugged:
      return ABI37_0_0EXBatteryStateUnplugged;
    case UIDeviceBatteryStateCharging:
      return ABI37_0_0EXBatteryStateCharging;
    case UIDeviceBatteryStateFull:
      return ABI37_0_0EXBatteryStateFull;
    default:
      return ABI37_0_0EXBatteryStateUnknown;
  }
}
