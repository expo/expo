...
#import <ABI37_0_0EXMailComposer/ABI37_0_0EXMailComposer.h>
...
@interface ABI37_0_0EXMailComposer ()
...
@implementation ABI37_0_0EXMailComposer

ABI37_0_0UM_EXPORT_MODULE(ExpoMailComposer);
...
ABI37_0_0UM_EXPORT_METHOD_AS(composeAsync,
                    ...
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  self.reject = reject;
  id<ABI37_0_0UMUtilitiesInterface> utilities = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI37_0_0UMUtilitiesInterface)];
