#import <ABI37_0_0EXAdsFacebook/ABI37_0_0EXNativeAdManager.h>
...
@interface ABI37_0_0EXNativeAdManager () <FBNativeAdsManagerDelegate>
...
@implementation ABI37_0_0EXNativeAdManager

ABI37_0_0UM_EXPORT_MODULE(CTKNativeAdManager)
...
ABI37_0_0UM_EXPORT_METHOD_AS(registerViewsForInteraction,
                    ...
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  [uiManager executeUIBlock:^(NSDictionary<id,UIView *> * viewRegistry) {
    ...
    if (![nativeAdView isKindOfClass:[ABI37_0_0EXNativeAdView class]]) {
      reject(@"E_INVALID_VIEW_CLASS", @"View returned for passed native ad view tag is not an instance of ABI37_0_0EXNativeAdView", nil);
      return;
    }
    ...
    [(ABI37_0_0EXNativeAdView *)nativeAdView registerViewsForInteraction:(FBMediaView *)mediaView adIcon:(FBAdIconView *)adIconView clickableViews:clickableViews];
    resolve(@[]);
  }];
}

ABI37_0_0UM_EXPORT_METHOD_AS(init,
...
ABI37_0_0UM_EXPORT_METHOD_AS(setMediaCachePolicy,
...
ABI37_0_0UM_EXPORT_METHOD_AS(disableAutoRefresh,
...
- (void)nativeAdsLoaded
{
  ...
  [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI37_0_0UMEventEmitterService)] sendEventWithName:@"CTKNativeAdsManagersChanged" body:adsManagersState];
}
...
- (UIView *)view
{
  return [[ABI37_0_0EXNativeAdView alloc] initWithModuleRegistry:_moduleRegistry];
}

ABI37_0_0UM_VIEW_PROPERTY(adsManager, NSString *, ABI37_0_0EXNativeAdView)
{
