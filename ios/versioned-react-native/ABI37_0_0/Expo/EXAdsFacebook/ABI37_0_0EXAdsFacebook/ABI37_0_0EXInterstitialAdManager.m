#import <ABI37_0_0EXAdsFacebook/ABI37_0_0EXInterstitialAdManager.h>
#import <ABI37_0_0UMCore/ABI37_0_0UMUtilities.h>

#import <FBAudienceNetwork/FBAudienceNetwork.h>

@interface ABI37_0_0EXInterstitialAdManager () <FBInterstitialAdDelegate>
...
@implementation ABI37_0_0EXInterstitialAdManager

ABI37_0_0UM_EXPORT_MODULE(CTKInterstitialAdManager)
...
{
  [_interstitialAd showAdFromRootViewController:[[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI37_0_0UMUtilitiesInterface)] currentViewController]];
}
...
- (void)bridgeDidForeground:(NSNotification *)notification
{
  ...
  if (_adViewController) {
    [[[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI37_0_0UMUtilitiesInterface)] currentViewController] presentViewController:_adViewController animated:NO completion:nil];
...
- (void)bridgeDidBackground:(NSNotification *)notification
{
  ...
  if (_interstitialAd) {
    _adViewController = [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI37_0_0UMUtilitiesInterface)] currentViewController];
