...
#import <ABI37_0_0EXHaptics/ABI37_0_0EXHapticsModule.h>

@interface ABI37_0_0EXHapticsModule ()

@end

@implementation ABI37_0_0EXHapticsModule

ABI37_0_0UM_EXPORT_MODULE(ExpoHaptics);
...
ABI37_0_0UM_EXPORT_METHOD_AS(notificationAsync,
...
ABI37_0_0UM_EXPORT_METHOD_AS(impactAsync,
...
ABI37_0_0UM_EXPORT_METHOD_AS(selectionAsync,
                    resolve:(ABI37_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
