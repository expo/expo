...
@interface ABI37_0_0EXBackgroundFetch ()

@property (nonatomic, weak) id<ABI37_0_0UMTaskManagerInterface> taskManager;

@end

@implementation ABI37_0_0EXBackgroundFetch

ABI37_0_0UM_EXPORT_MODULE(ExpoBackgroundFetch);

- (void)setModuleRegistry:(ABI37_0_0UMModuleRegistry *)moduleRegistry
{
  _taskManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI37_0_0UMTaskManagerInterface)];
}

ABI37_0_0UM_EXPORT_METHOD_AS(getStatusAsync,
                    getStatus:(ABI37_0_0UMPromiseResolveBlock)resolve
...
ABI37_0_0UM_EXPORT_METHOD_AS(setMinimumIntervalAsync,
...
ABI37_0_0UM_EXPORT_METHOD_AS(registerTaskAsync,
                    ...
                    reject:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_taskManager registerTaskWithName:taskName
                              consumer:ABI37_0_0EXBackgroundFetchTaskConsumer.class
                               options:options];
  }
  @catch (NSException *e) {
...
{
  @try {
    [_taskManager unregisterTaskWithName:taskName consumerClass:[ABI37_0_0EXBackgroundFetchTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
- (ABI37_0_0EXBackgroundFetchStatus)_getStatus
{
  UIBackgroundRefreshStatus refreshStatus = [[UIApplication sharedApplication] backgroundRefreshStatus];

  switch (refreshStatus) {
    case UIBackgroundRefreshStatusRestricted:
      return ABI37_0_0EXBackgroundFetchStatusRestricted;
    case UIBackgroundRefreshStatusDenied:
      return ABI37_0_0EXBackgroundFetchStatusDenied;
    case UIBackgroundRefreshStatusAvailable:
      return ABI37_0_0EXBackgroundFetchStatusAvailable;
  }
}
