...
@implementation UIFont (ABI37_0_0EXFontLoader)

- (UIFont *)ABI37_0_0EXFontWithSize:(CGFloat)fontSize
{
  for (id<ABI37_0_0UMFontScalerInterface> fontScaler in currentFontScalers) {
  ...
  return [self ABI37_0_0EXFontWithSize:fontSize];
}
...
@implementation ABI37_0_0EXFontScalersManager

ABI37_0_0UM_REGISTER_SINGLETON_MODULE(FontScalersManager);
...
+ (void)initialize
{
  ...
  dispatch_once(&initializeCurrentFontScalersOnce, ^{
    ...
    SEL exUpdate = @selector(ABI37_0_0EXFontWithSize:);
...
- (void)registerFontScaler:(id<ABI37_0_0UMFontScalerInterface>)fontScaler
{
