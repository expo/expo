...
@interface ABI37_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI37_0_0EXBarCodeScanner *barCodeScanner;
...
@implementation ABI37_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI37_0_0UMModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI37_0_0UMAppLifecycleListener)];
...
{
  ABI37_0_0UM_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI37_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI37_0_0EXBareCodeCameraRequester class]]) {
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI37_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI37_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI37_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI37_0_0EXBarCodeScanner *barCodeScanner = [ABI37_0_0EXBarCodeScanner new];
