...
@implementation ABI37_0_0EXAppleAuthenticationMappings
...
{
  return @{
           @"namePrefix": ABI37_0_0UMNullIfNil(nameComponents.namePrefix),
           @"givenName": ABI37_0_0UMNullIfNil(nameComponents.givenName),
           @"middleName": ABI37_0_0UMNullIfNil(nameComponents.middleName),
           @"familyName": ABI37_0_0UMNullIfNil(nameComponents.familyName),
           @"nameSuffix": ABI37_0_0UMNullIfNil(nameComponents.nameSuffix),
           @"nickname": ABI37_0_0UMNullIfNil(nameComponents.nickname)
           };
}
