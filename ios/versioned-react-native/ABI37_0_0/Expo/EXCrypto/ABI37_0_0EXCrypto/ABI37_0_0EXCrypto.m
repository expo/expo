...
#import <ABI37_0_0EXCrypto/ABI37_0_0EXCrypto.h>
#import <CommonCrypto/CommonDigest.h>

@implementation ABI37_0_0EXCrypto

ABI37_0_0UM_EXPORT_MODULE(ExpoCrypto);

ABI37_0_0UM_EXPORT_METHOD_AS(digestStringAsync,
                    ...
                    rejecter:(ABI37_0_0UMPromiseRejectBlock)reject)
{
  ...
  int digestLength = [ABI37_0_0EXCrypto digestLengthForJSAlgorithm:algorithm];
  if (digestLength == -1) {
