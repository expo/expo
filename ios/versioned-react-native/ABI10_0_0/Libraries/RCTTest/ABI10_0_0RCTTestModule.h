...
typedef NS_ENUM(NSInteger, ABI10_0_0RCTTestStatus) {
  ABI10_0_0RCTTestStatusPending = 0,
  ABI10_0_0RCTTestStatusPassed,
  ABI10_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI10_0_0RCTTestModule : NSObject <ABI10_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI10_0_0RCTTestStatus status;
