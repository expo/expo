...
#import "ABI10_0_0RCTTextSelection.h"
#import "UIView+ReactABI10_0_0.h"

@implementation ABI10_0_0RCTTextField
{
...
- (instancetype)initWithEventDispatcher:(ABI10_0_0RCTEventDispatcher *)eventDispatcher
{
  if ((self = [super initWithFrame:CGRectZero])) {
    ABI10_0_0RCTAssert(eventDispatcher, @"eventDispatcher is a required parameter");
...
{
  [_eventDispatcher sendTextEventWithType:ABI10_0_0RCTTextEventTypeKeyPress
...
- (void)setSelection:(ABI10_0_0RCTTextSelection *)selection
{
  if (!selection) {
    return;
  }
  ...
  } else if (eventLag > ABI10_0_0RCTTextUpdateLagWarningThreshold) {
    ABI10_0_0RCTLogWarn(@"Native TextInput(%@) is %zd events ahead of JS - try to make your JS faster.", self.text, eventLag);
  }
}
...
static void ABI10_0_0RCTUpdatePlaceholder(ABI10_0_0RCTTextField *self)
{
...
- (void)setPlaceholderTextColor:(UIColor *)placeholderTextColor
{
  ...
  ABI10_0_0RCTUpdatePlaceholder(self);
}
...
{
  _nativeEventCount++;
  [_eventDispatcher sendTextEventWithType:ABI10_0_0RCTTextEventTypeChange
                                 ReactABI10_0_0Tag:self.ReactABI10_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
{
  [_eventDispatcher sendTextEventWithType:ABI10_0_0RCTTextEventTypeEnd
                                 ReactABI10_0_0Tag:self.ReactABI10_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
{
  _submitted = YES;
  [_eventDispatcher sendTextEventWithType:ABI10_0_0RCTTextEventTypeSubmit
                                 ReactABI10_0_0Tag:self.ReactABI10_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
{
  [_eventDispatcher sendTextEventWithType:ABI10_0_0RCTTextEventTypeFocus
                                 ReactABI10_0_0Tag:self.ReactABI10_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (void)observeValueForKeyPath:(NSString *)keyPath
                      ofObject:(ABI10_0_0RCTTextField *)textField
...
- (BOOL)resignFirstResponder
{
  ...
  if (result)
  {
    [_eventDispatcher sendTextEventWithType:ABI10_0_0RCTTextEventTypeBlur
                                   ReactABI10_0_0Tag:self.ReactABI10_0_0Tag
                                       text:self.text
                                        key:nil
                                 eventCount:_nativeEventCount];
