...
static void collectNonTextDescendants(ABI10_0_0RCTText *view, NSMutableArray *nonTextDescendants)
{
  for (UIView *child in view.ReactABI10_0_0Subviews) {
    if ([child isKindOfClass:[ABI10_0_0RCTText class]]) {
      collectNonTextDescendants((ABI10_0_0RCTText *)child, nonTextDescendants);
...
@implementation ABI10_0_0RCTText
{
...
- (NSString *)description
{
  ...
  NSString *replacement = [NSString stringWithFormat:@"; ReactABI10_0_0Tag: %@; text: %@", self.ReactABI10_0_0Tag, self.textStorage.string];
...
- (void)drawRect:(CGRect)rect
{
  ...
  [layoutManager.textStorage enumerateAttribute:ABI10_0_0RCTIsHighlightedAttributeName inRange:characterRange options:0 usingBlock:^(NSNumber *value, NSRange range, BOOL *_) {
    if (!value.boolValue) {
      return;
    }
...
{
  NSNumber *ReactABI10_0_0Tag = self.ReactABI10_0_0Tag;
  ...
  if (_textStorage.length > 0 && (fraction > 0 || characterIndex > 0) && (fraction < 1 || characterIndex < _textStorage.length - 1)) {
    ReactABI10_0_0Tag = [_textStorage attribute:ABI10_0_0RCTReactABI10_0_0TagAttributeName atIndex:characterIndex effectiveRange:NULL];
  }
  return ReactABI10_0_0Tag;
}
