...
@implementation ABI10_0_0RCTDiffClampAnimatedNode
{
...
{
  ABI10_0_0RCTValueAnimatedNode *inputNode = (ABI10_0_0RCTValueAnimatedNode *)self.parentNodes[_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI10_0_0RCTValueAnimatedNode class]]) {
    ABI10_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
