...
@implementation ABI10_0_0RCTStyleAnimatedNode
{
...
- (void)performUpdate
{
  ...
  [style enumerateKeysAndObjectsUsingBlock:^(NSString *property, NSNumber *nodeTag, __unused BOOL *stop) {
    ...
    if (node && node.hasUpdated) {
      ...
      } else if ([node isKindOfClass:[ABI10_0_0RCTTransformAnimatedNode class]]) {
        ABI10_0_0RCTTransformAnimatedNode *parentNode = (ABI10_0_0RCTTransformAnimatedNode *)node;
