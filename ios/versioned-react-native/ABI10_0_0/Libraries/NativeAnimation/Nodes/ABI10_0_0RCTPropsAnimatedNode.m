...
@implementation ABI10_0_0RCTPropsAnimatedNode
{
  ABI10_0_0RCTStyleAnimatedNode *_parentNode;
}

- (void)onAttachedToNode:(ABI10_0_0RCTAnimatedNode *)parent
{
  [super onAttachedToNode:parent];
  if ([parent isKindOfClass:[ABI10_0_0RCTStyleAnimatedNode class]]) {
    _parentNode = (ABI10_0_0RCTStyleAnimatedNode *)parent;
  }
}
...
{
  _propertyMapper = [[ABI10_0_0RCTViewPropertyMapper alloc] initWithViewTag:viewTag animationModule:animationModule];
}
