...
@interface ABI10_0_0RCTAnimationDriverNode : NSObject
...
- (instancetype)initWithId:(NSNumber *)animationId
                   ...
                   forNode:(ABI10_0_0RCTValueAnimatedNode *)valueNode
                  callBack:(nullable ABI10_0_0RCTResponseSenderBlock)callback NS_DESIGNATED_INITIALIZER;
