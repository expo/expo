...
@implementation ABI10_0_0RCTTransformAnimatedNode
{
...
- (void)performUpdate
{
  ...
  for (NSDictionary *transformConfig in transformConfigs) {
    ...
    ABI10_0_0RCTAnimatedNode *node = self.parentNodes[nodeTag];
    if (node.hasUpdated && [node isKindOfClass:[ABI10_0_0RCTValueAnimatedNode class]]) {
      ABI10_0_0RCTValueAnimatedNode *parentNode = (ABI10_0_0RCTValueAnimatedNode *)node;
