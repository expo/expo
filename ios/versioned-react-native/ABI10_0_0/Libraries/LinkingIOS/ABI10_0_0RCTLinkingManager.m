...
#import "ABI10_0_0RCTLinkingManager.h"

#import "ABI10_0_0RCTBridge.h"
#import "ABI10_0_0RCTEventDispatcher.h"
#import "ABI10_0_0RCTUtils.h"

NSString *const ABI10_0_0RCTOpenURLNotification = @"ABI10_0_0RCTOpenURLNotification";

@implementation ABI10_0_0RCTLinkingManager
...
- (void)startObserving
{
  [[NSNotificationCenter defaultCenter] addObserver:self
                                           selector:@selector(handleOpenURLNotification:)
                                               name:ABI10_0_0RCTOpenURLNotification
                                             object:nil];
}
         ...
         annotation:(id)annotation
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI10_0_0RCTOpenURLNotification
                                                      object:self
                                                    userInfo:payload];
  return YES;
}
                  ...
                  reject:(__unused ABI10_0_0RCTPromiseRejectBlock)reject)
{
  ...
  BOOL canOpen = [ABI10_0_0RCTSharedApplication() canOpenURL:URL];
  resolve(@(canOpen));
}
                  ...
                  reject:(__unused ABI10_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve(ABI10_0_0RCTNullIfNil(initialURL.absoluteString));
}
