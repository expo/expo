...
@implementation ABI10_0_0ARTText
...
static void ABI10_0_0ARTFreeTextFrame(ABI10_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI10_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI10_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI10_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI10_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
