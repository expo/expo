...
#import "ABI10_0_0RCTPhotoLibraryImageLoader.h"
...
@implementation ABI10_0_0RCTPhotoLibraryImageLoader

ABI10_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI10_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI10_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI10_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI10_0_0RCTResizeModeContain) {
