...
typedef void (^ABI10_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI10_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI10_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI10_0_0RCTImageCache <NSObject>
...
@interface UIImage (ReactABI10_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI10_0_0KeyframeAnimation;

@end

@interface ABI10_0_0RCTImageLoader : NSObject <ABI10_0_0RCTBridgeModule, ABI10_0_0RCTURLRequestHandler>
 ...
 */
- (ABI10_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                           clipped:(BOOL)clipped
                                        resizeMode:(ABI10_0_0RCTResizeMode)resizeMode
 ...
 * decoded images as long as it conforms to the ABI10_0_0RCTImageCacheDelegate
...
@interface ABI10_0_0RCTBridge (ABI10_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI10_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI10_0_0RCTImageURLLoader <ABI10_0_0RCTBridgeModule>
...
/**
 * If more than one ABI10_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI10_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 * are also bridge modules, so should be registered using ABI10_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI10_0_0RCTImageDataDecoder <ABI10_0_0RCTBridgeModule>
...
/**
 * If more than one ABI10_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
