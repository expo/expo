...
@interface ABI10_0_0RCTImageStoreManager : NSObject <ABI10_0_0RCTURLRequestHandler>
...
@interface ABI10_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI10_0_0RCTBridge (ABI10_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI10_0_0RCTImageStoreManager *imageStoreManager;
