...
@implementation ABI10_0_0RCTDevMenu (Device)
...
- (NSArray *)menuItems: (NSArray *)items notContainingPattern: (NSString *)pattern
{
  ...
  NSIndexSet *indexes = [items indexesOfObjectsWithOptions:NSEnumerationConcurrent passingTest:^BOOL(ABI10_0_0RCTDevMenuItem *menuItem, NSUInteger index, BOOL *stop) {
