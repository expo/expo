#import "ABI10_0_0EXImagePicker.h"
...
@interface ABI10_0_0EXImagePicker ()
...
@implementation ABI10_0_0EXImagePicker

ABI10_0_0RCT_EXPORT_MODULE(ExponentImagePicker);
...
ABI10_0_0RCT_EXPORT_METHOD(launchCameraAsync:(NSDictionary *)options
...
ABI10_0_0RCT_EXPORT_METHOD(launchImageLibraryAsync:(NSDictionary *)options
                  resolver:(ABI10_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI10_0_0RCTPromiseRejectBlock)reject)
{
    self.resolve = resolve;
...
- (void)launchImagePicker:(RNImagePickerTarget)target
{
    ...
    if (target == RNImagePickerTargetCamera) {
        ...
        self.reject(ABI10_0_0RCTErrorUnspecified, @"Camera not available on simulator", nil);
        return;
#else
        ...
        if ([self.options objectForKey:@"storageOptions"] && [[self.options objectForKey:@"storageOptions"] isKindOfClass:[NSDictionary class]]) {
            ...
            if ([storageOptions objectForKey:@"path"]) {
                ...
                if (error) {
                    ...
                    self.reject(ABI10_0_0RCTErrorUnspecified, error.localizedFailureReason, error);
                    return;
                }
                else {
