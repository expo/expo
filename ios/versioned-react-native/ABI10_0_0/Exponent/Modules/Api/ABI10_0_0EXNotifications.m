...
@interface ABI10_0_0EXNotifications ()

@property (nonatomic, strong) NSString *experienceId;

@end

@implementation ABI10_0_0EXNotifications
...
ABI10_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
                 getExponentPushTokenAsyncWithResolver:(ABI10_0_0RCTPromiseResolveBlock)resolve
