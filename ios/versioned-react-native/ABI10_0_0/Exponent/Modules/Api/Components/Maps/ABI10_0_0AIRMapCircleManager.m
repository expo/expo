...
#import "ABI10_0_0AIRMapCircleManager.h"
...
@interface ABI10_0_0AIRMapCircleManager()

@end

@implementation ABI10_0_0AIRMapCircleManager

ABI10_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI10_0_0AIRMapCircle *circle = [ABI10_0_0AIRMapCircle new];
    return circle;
}

ABI10_0_0RCT_REMAP_VIEW_PROPERTY(center, centerCoordinate, CLLocationCoordinate2D)
ABI10_0_0RCT_EXPORT_VIEW_PROPERTY(radius, CLLocationDistance)
