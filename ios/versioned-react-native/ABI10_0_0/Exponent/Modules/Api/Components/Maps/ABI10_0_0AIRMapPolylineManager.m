...
#import "ABI10_0_0AIRMapPolylineManager.h"
...
@interface ABI10_0_0AIRMapPolylineManager()

@end

@implementation ABI10_0_0AIRMapPolylineManager

ABI10_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI10_0_0AIRMapPolyline *polyline = [ABI10_0_0AIRMapPolyline new];
    return polyline;
}
