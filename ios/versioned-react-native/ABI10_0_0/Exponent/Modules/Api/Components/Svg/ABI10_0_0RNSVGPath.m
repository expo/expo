...
@implementation ABI10_0_0RNSVGPath
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    if (self.fill) {
        mode = self.fillRule == kABI10_0_0RNSVGCGFCRuleEvenodd ? kCGPathEOFill : kCGPathFill;
        ...
        if (!fillColor) {
            ...
            ABI10_0_0RNSVGBrushConverter *brushConverter = [[self getSvgView] getDefinedBrushConverter:[self.fill brushRef]];
    ...
    if (self.stroke) {
        ...
        ABI10_0_0RNSVGCGFloatArray dash = self.strokeDasharray;
        ...
        if ([self.stroke applyStrokeColor:context opacity:self.strokeOpacity]) {
            ...
            CGContextReplacePathWithStrokedPath(context);
            CGContextClip(context);
            ABI10_0_0RNSVGBrushConverter *brushConverter = [[self getSvgView] getDefinedBrushConverter:[self.stroke brushRef]];
