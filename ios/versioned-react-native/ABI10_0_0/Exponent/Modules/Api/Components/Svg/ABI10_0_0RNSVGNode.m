...
@implementation ABI10_0_0RNSVGNode
{
    BOOL _transparent;
}
...
- (void)invalidate
{
    id<ABI10_0_0RNSVGContainer> container = (id<ABI10_0_0RNSVGContainer>)self.superview;
...
- (void)clip:(CGContextRef)context
{
    ...
    if (clipPath) {
        ...
        if (self.clipRule == kABI10_0_0RNSVGCGFCRuleEvenodd) {
...
- (ABI10_0_0RNSVGSvgView *)getSvgView
{
    UIView *parent = self.superview;
    while (parent && [parent class] != [ABI10_0_0RNSVGSvgView class]) {
        parent = parent.superview;
    }

    return (ABI10_0_0RNSVGSvgView *)parent;
}

- (void)saveDefinition
{
    if (self.name) {
        ABI10_0_0RNSVGSvgView* svg = [self getSvgView];
