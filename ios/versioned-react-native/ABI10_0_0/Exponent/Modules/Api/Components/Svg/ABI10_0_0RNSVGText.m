...
#import "ABI10_0_0RNSVGBezierPath.h"
#import <CoreText/CoreText.h>

@implementation ABI10_0_0RNSVGText

static void ABI10_0_0RNSVGFreeTextFrame(ABI10_0_0RNSVGTextFrame frame)
{
    if (frame.count) {
...
- (void)setTextFrame:(ABI10_0_0RNSVGTextFrame)textFrame
{
    ABI10_0_0RNSVGFreeTextFrame(_textFrame);
    [self invalidate];
...
- (CGPathRef)getPath:(CGContextRef)context
{
    ...
    ABI10_0_0RNSVGTextFrame frame = self.textFrame;
    for (int i = 0; i < frame.count; i++) {
        CGFloat shift;
...
- (CGMutablePathRef)setLinePath:(CTLineRef)line
{
    ...
    ABI10_0_0RNSVGBezierPath *bezierPath = [[ABI10_0_0RNSVGBezierPath alloc] initWithBezierCurves:self.path];
