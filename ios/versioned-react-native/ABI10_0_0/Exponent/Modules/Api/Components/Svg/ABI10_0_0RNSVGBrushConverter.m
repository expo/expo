...
@implementation ABI10_0_0RNSVGBrushConverter

- (void)drawLinearGradient:(CGContextRef)context
{
    
    CGGradientRef gradient = CGGradientRetain([ABI10_0_0RCTConvert CGGradient:self.colors offset:0]);
    ...
    ABI10_0_0RNSVGPercentageConverter* convert = [[ABI10_0_0RNSVGPercentageConverter alloc] init];
