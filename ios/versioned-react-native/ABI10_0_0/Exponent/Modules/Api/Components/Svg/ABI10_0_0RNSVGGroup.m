...
@implementation ABI10_0_0RNSVGGroup
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    [self traverseSubviews:^(ABI10_0_0RNSVGNode *node) {
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event withTransform:(CGAffineTransform)transform
{
    ...
    for (ABI10_0_0RNSVGNode *node in [self.subviews reverseObjectEnumerator]) {
...
- (void)traverseSubviews:(BOOL (^)(ABI10_0_0RNSVGNode *node))block
{
