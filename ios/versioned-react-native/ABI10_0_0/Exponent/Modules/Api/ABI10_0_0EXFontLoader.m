...
#import "ABI10_0_0EXFontLoader.h"
...
static NSMutableDictionary *ABI10_0_0EXFonts = nil;

@interface ABI10_0_0EXFont : NSObject
...
@implementation ABI10_0_0EXFont
       ...
       scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  if ([family hasPrefix:exponentPrefix] && ABI10_0_0EXFonts) {
    ...
    if (ABI10_0_0EXFonts[suffix]) {
      return [ABI10_0_0EXFonts[suffix] UIFontWithSize:[ABI10_0_0RCTConvert CGFloat:size] ?: defaultFontSize];
    }
  }
...
{
  if (ABI10_0_0EXFonts && ABI10_0_0EXFonts[fontFamilyName]) {
  ...
  if (!ABI10_0_0EXFonts) {
    ABI10_0_0EXFonts = [NSMutableDictionary dictionary];
  }
  ABI10_0_0EXFonts[fontFamilyName] = [[ABI10_0_0EXFont alloc] initWithCGFont:font];
  resolve(nil);
}
