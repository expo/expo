...
@interface ABI10_0_0EXConstants ()
...
@implementation ABI10_0_0EXConstants
...
{
  NSString *exponentClientVersion = [[[NSBundle mainBundle] infoDictionary] objectForKey:@"ABI10_0_0EXClientVersion"];
