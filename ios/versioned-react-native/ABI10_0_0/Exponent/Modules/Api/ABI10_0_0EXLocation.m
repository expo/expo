...
NSString * const ABI10_0_0EXLocationChangedEventName = @"Exponent.locationChanged";

@interface ABI10_0_0EXLocationDelegate : NSObject <CLLocationManagerDelegate>
...
@implementation ABI10_0_0EXLocationDelegate
...
@interface ABI10_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI10_0_0EXLocationDelegate*> *delegates;

@end

@implementation ABI10_0_0EXLocation

ABI10_0_0RCT_EXPORT_MODULE(ExponentLocation)
...
{
  return @[ABI10_0_0EXLocationChangedEventName];
}


ABI10_0_0RCT_REMAP_METHOD(getCurrentPositionAsync,
...
ABI10_0_0RCT_REMAP_METHOD(watchPositionImplAsync,
                 ...
                 rejecter:(ABI10_0_0RCTPromiseRejectBlock)reject)
{
  ...
  locMgr.distanceFilter = options[@"distanceInterval"] ? [ABI10_0_0RCTConvert double:options[@"distanceInterval"]] ?: kCLDistanceFilterNone : kCLLocationAccuracyHundredMeters;
  locMgr.desiredAccuracy = [ABI10_0_0RCTConvert BOOL:options[@"enableHighAccuracy"]] ? kCLLocationAccuracyBest : kCLLocationAccuracyHundredMeters;

  __weak typeof(self) weakSelf = self;
  ABI10_0_0EXLocationDelegate *delegate = [[ABI10_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject) {
      ...
      [weakSelf sendEventWithName:ABI10_0_0EXLocationChangedEventName body:body];
    }
...
ABI10_0_0RCT_REMAP_METHOD(removeWatchAsync,
                 watchId:(nonnull NSNumber *)watchId
                 resolver:(ABI10_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI10_0_0RCTPromiseRejectBlock)reject)
{
  ABI10_0_0EXLocationDelegate *delegate = _delegates[watchId];
  if (delegate) {
