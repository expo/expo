...
#import "ABI10_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI10_0_0EXFingerprint

ABI10_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI10_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI10_0_0RCTPromiseResolveBlock)resolve
...
ABI10_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI10_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI10_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI10_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
