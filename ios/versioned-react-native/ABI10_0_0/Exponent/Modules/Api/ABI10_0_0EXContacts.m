...
#import "ABI10_0_0EXContacts.h"

@import AddressBook;

@interface ABI10_0_0EXContacts ()

@property (nonatomic, assign) ABAddressBookRef addressBookRef;

@end

@implementation ABI10_0_0EXContacts

ABI10_0_0RCT_EXPORT_MODULE(ExponentContacts);
 ...
 */
ABI10_0_0RCT_EXPORT_METHOD(getContactsAsync:(NSArray *)fields resolver:(ABI10_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI10_0_0RCTPromiseRejectBlock)reject)
{
...
- (void)_getContactsWithPermissionGrantedAsync: (NSArray *)fields addressBook:(ABAddressBookRef)addressBook resolver:(ABI10_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI10_0_0RCTPromiseRejectBlock)reject
{
