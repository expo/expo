...
+ (void)initialize
{
  ...
  ABI10_0_0RCTSwapInstanceMethods([UIWindow class], @selector(motionEnded:withEvent:), @selector(ABI10_0_0RCT_motionEnded:withEvent:));
}
...
#pragma clang diagnostic pop
    ...
    ABI10_0_0RCTKeyCommands *commands = [ABI10_0_0RCTKeyCommands sharedInstance];
