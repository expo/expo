...
#import "ABI10_0_0RCTPointerEvents.h"

@protocol ABI10_0_0RCTAutoInsetsProtocol;

@class ABI10_0_0RCTView;

@interface ABI10_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI10_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI10_0_0RCTDirectEventBlock onMagicTap;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI10_0_0RCTPointerEvents pointerEvents;
...
/**
 * z-index, used to override sibling order in didUpdateReactABI10_0_0Subviews. This is
 * inherited from UIView+ReactABI10_0_0, but we override it here to reduce the boxing
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI10_0_0RCTBorderStyle borderStyle;
