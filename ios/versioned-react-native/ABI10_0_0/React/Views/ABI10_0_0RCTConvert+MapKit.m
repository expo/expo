...
@implementation ABI10_0_0RCTConvert(MapKit)
...
ABI10_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
{
  json = [self NSDictionary:json];
  ABI10_0_0RCTMapAnnotation *annotation = [ABI10_0_0RCTMapAnnotation new];
...
ABI10_0_0RCT_ARRAY_CONVERTER(ABI10_0_0RCTMapAnnotation)
...
+ (ABI10_0_0RCTMapOverlay *)ABI10_0_0RCTMapOverlay:(id)json
{
  ...
  ABI10_0_0RCTMapOverlay *overlay = [ABI10_0_0RCTMapOverlay polylineWithCoordinates:coordinates
...
ABI10_0_0RCT_ARRAY_CONVERTER(ABI10_0_0RCTMapOverlay)
