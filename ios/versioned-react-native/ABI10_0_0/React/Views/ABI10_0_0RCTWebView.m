...
NSString *const ABI10_0_0RCTJSNavigationScheme = @"ReactABI10_0_0-js-navigation";

@interface ABI10_0_0RCTWebView () <UIWebViewDelegate, ABI10_0_0RCTAutoInsetsProtocol>
...
@property (nonatomic, copy) ABI10_0_0RCTDirectEventBlock onShouldStartLoadWithRequest;

@end

@implementation ABI10_0_0RCTWebView
{
  UIWebView *_webView;
...
- (void)reload
{
  NSURLRequest *request = [ABI10_0_0RCTConvert NSURLRequest:self.source];
...
- (void)setSource:(NSDictionary *)source
{
  if (![_source isEqualToDictionary:source]) {
    ...
    NSString *html = [ABI10_0_0RCTConvert NSString:source[@"html"]];
    if (html) {
      NSURL *baseURL = [ABI10_0_0RCTConvert NSURL:source[@"baseUrl"]];
      if (!baseURL) {
    ...
    NSURLRequest *request = [ABI10_0_0RCTConvert NSURLRequest:source];
    // Because of the way ReactABI10_0_0 works, as pages redirect, we actually end up
...
{
  BOOL isJSNavigation = [request.URL.scheme isEqualToString:ABI10_0_0RCTJSNavigationScheme];
