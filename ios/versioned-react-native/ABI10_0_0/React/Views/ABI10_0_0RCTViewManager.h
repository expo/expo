...
@class ABI10_0_0RCTSparseArray;
@class ABI10_0_0RCTUIManager;

typedef void (^ABI10_0_0RCTViewManagerUIBlock)(ABI10_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry);

@interface ABI10_0_0RCTViewManager : NSObject <ABI10_0_0RCTBridgeModule>

/**
 * The bridge can be used to access both the ABI10_0_0RCTUIIManager and the ABI10_0_0RCTEventDispatcher,
 ...
 * an ordinary ABI10_0_0RCTShadowView instance will be created, which is typically fine for
...
/**
 * DEPRECATED: declare properties of type ABI10_0_0RCTBubblingEventBlock instead
 *
 ...
 */
- (NSArray<NSString *> *)customBubblingEventTypes __deprecated_msg("Use ABI10_0_0RCTBubblingEventBlock props instead.");

/**
 * DEPRECATED: declare properties of type ABI10_0_0RCTDirectEventBlock instead
 *
 * Returns an array of names of events that can be sent by native views. This
 ...
 */
- (NSArray<NSString *> *)customDirectEventTypes __deprecated_msg("Use ABI10_0_0RCTDirectEventBlock props instead.");
 ...
 */
#define ABI10_0_0RCT_CUSTOM_VIEW_PROPERTY(name, type, viewClass) \
ABI10_0_0RCT_REMAP_VIEW_PROPERTY(name, __custom__, type)         \
- (void)set_##name:(id)json forView:(viewClass *)view withDefaultView:(viewClass *)defaultView

/**
 * This macro is used to map properties to the shadow view, instead of the view.
 */
#define ABI10_0_0RCT_EXPORT_SHADOW_PROPERTY(name, type) \
