...
@interface ABI10_0_0RCTNavigator : UIView <ABI10_0_0RCTFrameUpdateObserver>

@property (nonatomic, strong) UIView *ReactABI10_0_0NavSuperviewLink;
@property (nonatomic, assign) NSInteger requestedTopOfStack;
@property (nonatomic, assign) BOOL interactivePopGestureEnabled;

- (instancetype)initWithBridge:(ABI10_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;
