...
@implementation ABI10_0_0RCTConvert (UITabBarSystemItem)

ABI10_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI10_0_0RCTTabBarItem
...
{
  return self.superview.ReactABI10_0_0ViewController;
}
