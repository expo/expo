...
@interface ABI10_0_0RCTPicker() <UIPickerViewDataSource, UIPickerViewDelegate>
@end

@implementation ABI10_0_0RCTPicker
...
{
  return [ABI10_0_0RCTConvert NSString:_items[row][@"label"]];
}
      ...
      didSelectRow:(NSInteger)row inComponent:(__unused NSInteger)component
{
  ...
  if (_onChange) {
    _onChange(@{
      @"newIndex": @(row),
      @"newValue": ABI10_0_0RCTNullIfNil(_items[row][@"value"]),
    });
  }
}
