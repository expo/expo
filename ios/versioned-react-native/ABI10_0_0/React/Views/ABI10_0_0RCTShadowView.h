...
typedef NS_ENUM(NSUInteger, ABI10_0_0RCTUpdateLifecycle) {
  ABI10_0_0RCTUpdateLifecycleUninitialized = 0,
  ABI10_0_0RCTUpdateLifecycleComputed,
  ABI10_0_0RCTUpdateLifecycleDirtied,
};

typedef void (^ABI10_0_0RCTApplierBlock)(NSDictionary<NSNumber *, UIView *> *viewRegistry);

/**
 * ShadowView tree mirrors ABI10_0_0RCT view tree. Every node is highly stateful.
 * 1. A node is in one of three lifecycles: uninitialized, computed, dirtied.
 * 1. ABI10_0_0RCTBridge may call any of the padding/margin/width/height/top/left setters. A setter would dirty
 ...
 */
@interface ABI10_0_0RCTShadowView : NSObject <ABI10_0_0RCTComponent>

/**
 * ABI10_0_0RCTComponent interface.
 */
- (NSArray<ABI10_0_0RCTShadowView *> *)ReactABI10_0_0Subviews NS_REQUIRES_SUPER;
- (ABI10_0_0RCTShadowView *)ReactABI10_0_0Superview NS_REQUIRES_SUPER;
- (void)insertReactABI10_0_0Subview:(ABI10_0_0RCTShadowView *)subview atIndex:(NSInteger)atIndex NS_REQUIRES_SUPER;
- (void)removeReactABI10_0_0Subview:(ABI10_0_0RCTShadowView *)subview NS_REQUIRES_SUPER;

@property (nonatomic, weak, readonly) ABI10_0_0RCTShadowView *superview;
@property (nonatomic, assign, readonly) ABI10_0_0CSSNodeRef cssNode;
@property (nonatomic, copy) NSString *viewName;
@property (nonatomic, strong) UIColor *backgroundColor; // Used to propagate to children
@property (nonatomic, copy) ABI10_0_0RCTDirectEventBlock onLayout;

/**
 * isNewView - Used to track the first time the view is introduced into the hierarchy.  It is initialized YES, then is
 * set to NO in ABI10_0_0RCTUIManager after the layout pass is done and all frames have been extracted to be applied to the
 * corresponding UIViews.
 */
@property (nonatomic, assign, getter=isNewView) BOOL newView;

/**
 * isHidden - ABI10_0_0RCTUIManager uses this to determine whether or not the UIView should be hidden. Useful if the
 ...
 */
@property (nonatomic, assign) ABI10_0_0CSSFlexDirection flexDirection;
@property (nonatomic, assign) ABI10_0_0CSSJustify justifyContent;
@property (nonatomic, assign) ABI10_0_0CSSAlign alignSelf;
@property (nonatomic, assign) ABI10_0_0CSSAlign alignItems;
@property (nonatomic, assign) ABI10_0_0CSSPositionType position;
@property (nonatomic, assign) ABI10_0_0CSSWrapType flexWrap;
 ...
 * The applierBlocks set contains ABI10_0_0RCTApplierBlock functions that must be applied
...
/**
 * Return whether or not this node acts as a leaf node in the eyes of ABI10_0_0CSSLayout. For example
 * ABI10_0_0RCTShadowText has children which it does not want ABI10_0_0CSSLayout to lay out so in the eyes of
 * ABI10_0_0CSSLayout it is a leaf node.
 */
...
/**
 * As described in ABI10_0_0RCTComponent protocol.
 */
- (void)didUpdateReactABI10_0_0Subviews NS_REQUIRES_SUPER;
