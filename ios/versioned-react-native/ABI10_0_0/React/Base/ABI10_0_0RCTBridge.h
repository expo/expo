...
#import "ABI10_0_0RCTBridgeDelegate.h"
...
@class ABI10_0_0RCTPerformanceLogger;

/**
 * This notification triggers a reload of all bridges currently running.
 */
ABI10_0_0RCT_EXTERN NSString *const ABI10_0_0RCTReloadNotification;

/**
 * This notification fires when the bridge starts loading the JS bundle.
 */
ABI10_0_0RCT_EXTERN NSString *const ABI10_0_0RCTJavaScriptWillStartLoadingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI10_0_0RCT_EXTERN NSString *const ABI10_0_0RCTJavaScriptDidLoadNotification;

/**
 * This notification fires when the bridge failed to load the JS bundle. The
 * `error` key can be used to determine the error that occured.
 */
ABI10_0_0RCT_EXTERN NSString *const ABI10_0_0RCTJavaScriptDidFailToLoadNotification;
 ...
 */
ABI10_0_0RCT_EXTERN NSString *const ABI10_0_0RCTDidInitializeModuleNotification;
 ...
 */
typedef NSArray<id<ABI10_0_0RCTBridgeModule>> *(^ABI10_0_0RCTBridgeModuleProviderBlock)(void);

/**
 * This function returns the module name for a given class.
 */
ABI10_0_0RCT_EXTERN NSString *ABI10_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI10_0_0RCTBridge : NSObject <ABI10_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI10_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI10_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 */
@property (nonatomic, weak, readonly) id<ABI10_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ReactABI10_0_0 Native perf events.
 */
@property (nonatomic, readonly, strong) ABI10_0_0RCTPerformanceLogger *performanceLogger;
...
/**
 * A reference to the root ABI10_0_0RCTBridge instance. Used to scope NSNotifications
