...
@protocol ABI10_0_0RCTBridgeMethod;

/**
 * The type of a block that is capable of sending a response to a bridged
 * operation. Use this for returning callback methods to JS.
 */
typedef void (^ABI10_0_0RCTResponseSenderBlock)(NSArray *response);
 ...
 */
typedef void (^ABI10_0_0RCTResponseErrorBlock)(NSError *error);

/**
 * Block that bridge modules use to resolve the JS promise waiting for a result.
 * Nil results are supported and are converted to JS's undefined value.
 */
typedef void (^ABI10_0_0RCTPromiseResolveBlock)(id result);
 ...
 */
typedef void (^ABI10_0_0RCTPromiseRejectBlock)(NSString *code, NSString *message, NSError *error);
 ...
 * you need.
 *
 * NOTE: ABI10_0_0RCTJSThread is not a real libdispatch queue
 */
extern dispatch_queue_t ABI10_0_0RCTJSThread;

/**
 * Provides the interface needed to register a bridge module.
 */
@protocol ABI10_0_0RCTBridgeModule <NSObject>
 ...
 */
#define ABI10_0_0RCT_EXPORT_MODULE(js_name) \
ABI10_0_0RCT_EXTERN void ABI10_0_0RCTRegisterModule(Class); \
+ (NSString *)moduleName { return @#js_name; } \
+ (void)load { ABI10_0_0RCTRegisterModule(self); }

// Implemented by ABI10_0_0RCT_EXPORT_MODULE
+ (NSString *)moduleName;

@optional

/**
 * A reference to the ABI10_0_0RCTBridge. Useful for modules that require access
 * to bridge features, such as sending events or making JS calls. This
 * will be set automatically by the bridge when it initializes the module.
 * To implement this in your module, just add `@synthesize bridge = _bridge;`
 */
@property (nonatomic, weak, readonly) ABI10_0_0RCTBridge *bridge;
 ...
 * thread-only. You can tell ReactABI10_0_0 Native to call your module methods on the
 ...
 * ABI10_0_0RCT_REMAP_METHOD to specify the JS name of the method.
 *
 ...
 * becomes
 *
 * ABI10_0_0RCT_EXPORT_METHOD(doSomething:(NSString *)aString
 *                   withA:(NSInteger)a
 *                   andB:(NSInteger)b)
 * { ... }
 *
 ...
 * For example:
 *
 * ABI10_0_0RCT_EXPORT_METHOD(doSomethingAsync:(NSString *)aString
 ...
 *
 */
#define ABI10_0_0RCT_EXPORT_METHOD(method) \
  ABI10_0_0RCT_REMAP_METHOD(, method)

/**
 * Similar to ABI10_0_0RCT_EXPORT_METHOD but lets you set the JS name of the exported
 * method. Example usage:
 *
 * ABI10_0_0RCT_REMAP_METHOD(executeQueryWithParameters,
 *   executeQuery:(NSString *)query parameters:(NSDictionary *)parameters)
 * { ... }
 */
#define ABI10_0_0RCT_REMAP_METHOD(js_name, method) \
  ABI10_0_0RCT_EXTERN_REMAP_METHOD(js_name, method) \
  - (void)method
 ...
 *
 *   @interface ABI10_0_0RCT_EXTERN_MODULE(MyModule, NSObject)
 *
 *   ABI10_0_0RCT_EXTERN_METHOD(doSomething:(NSString *)string withFoo:(NSInteger)a bar:(NSInteger)b)
 *
 *   @end
 *
 ...
 */
#define ABI10_0_0RCT_EXTERN_MODULE(objc_name, objc_supername) \
  ABI10_0_0RCT_EXTERN_REMAP_MODULE(, objc_name, objc_supername)

/**
 * Like ABI10_0_0RCT_EXTERN_MODULE, but allows setting a custom JavaScript name.
 */
#define ABI10_0_0RCT_EXTERN_REMAP_MODULE(js_name, objc_name, objc_supername) \
  objc_name : objc_supername \
  @end \
  @interface objc_name (ABI10_0_0RCTExternModule) <ABI10_0_0RCTBridgeModule> \
  @end \
  @implementation objc_name (ABI10_0_0RCTExternModule) \
  ABI10_0_0RCT_EXPORT_MODULE(js_name)

/**
 * Use this macro in accordance with ABI10_0_0RCT_EXTERN_MODULE to export methods
 * of an external module.
 */
#define ABI10_0_0RCT_EXTERN_METHOD(method) \
  ABI10_0_0RCT_EXTERN_REMAP_METHOD(, method)

/**
 * Like ABI10_0_0RCT_EXTERN_REMAP_METHOD, but allows setting a custom JavaScript name.
 */
#define ABI10_0_0RCT_EXTERN_REMAP_METHOD(js_name, method) \
  + (NSArray<NSString *> *)ABI10_0_0RCT_CONCAT(__rct_export__, \
    ABI10_0_0RCT_CONCAT(js_name, ABI10_0_0RCT_CONCAT(__LINE__, __COUNTER__))) { \
 ...
 * before registration.
 */
- (NSArray<id<ABI10_0_0RCTBridgeMethod>> *)methodsToExport;
 ...
 * part of a reload of the entire ReactABI10_0_0 application.
 */
