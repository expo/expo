 ...
 */
@interface ABI10_0_0RCTImageSource : NSObject
...
@interface ABI10_0_0RCTImageSource (Deprecated)
...
@interface ABI10_0_0RCTConvert (ImageSource)

+ (ABI10_0_0RCTImageSource *)ABI10_0_0RCTImageSource:(id)json;
+ (NSArray<ABI10_0_0RCTImageSource *> *)ABI10_0_0RCTImageSourceArray:(id)json;
