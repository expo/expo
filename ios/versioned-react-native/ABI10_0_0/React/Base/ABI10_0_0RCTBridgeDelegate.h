...
@protocol ABI10_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI10_0_0RCTBridge *)bridge;
 ...
 */
- (NSURL *)fallbackSourceURLForBridge:(ABI10_0_0RCTBridge *)bridge;

/**
 * The bridge initializes any registered ABI10_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI10_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI10_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (NSArray<Class> *)whitelistedModulesForBridge:(ABI10_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeInitializeNativeModulesSynchronously:(ABI10_0_0RCTBridge *)bridge;
 ...
 */
- (void)loadSourceForBridge:(ABI10_0_0RCTBridge *)bridge
                  withBlock:(ABI10_0_0RCTSourceLoadBlock)loadCallback;
