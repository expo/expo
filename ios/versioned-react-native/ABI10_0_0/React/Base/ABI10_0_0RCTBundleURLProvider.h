...
extern NSString *const ABI10_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI10_0_0RCTBundleURLProviderDefaultPort;

@interface ABI10_0_0RCTBundleURLProvider : NSObject
