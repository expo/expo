...
@protocol ABI10_0_0RCTBridgeModule;
@class ABI10_0_0RCTBridge;

@interface ABI10_0_0RCTModuleData : NSObject <ABI10_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI10_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI10_0_0RCTBridgeModule> instance;
