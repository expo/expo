...
ABI23_0_0RCT_EXPORT_MODULE(ExponentSQLite)
...
ABI23_0_0RCT_EXPORT_METHOD(exec:(NSString *)dbName
                 ...
                 withDb:(sqlite3*)db withReadOnly:(BOOL)readOnly
{
  ...
  if (sqlite3_prepare_v2(db, [sql UTF8String], -1, &statement, NULL) != SQLITE_OK) {
    error = [ABI23_0_0EXSQLite convertSQLiteErrorToString:db];
    return @[error];
  }
