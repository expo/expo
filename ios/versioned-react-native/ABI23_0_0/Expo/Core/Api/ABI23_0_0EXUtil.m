...
@property (nonatomic, weak) id<ABI23_0_0EXUtilScopedModuleDelegate> kernelUpdatesServiceDelegate;
@property (nonatomic, weak) id<ABI23_0_0EXUtilService> kernelUtilService;

@end

ABI23_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI23_0_0EXUtil, util)
...
ABI23_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentUtil, @"UpdatesManager", @"UtilService");
