...
@implementation ABI23_0_0EXContacts

ABI23_0_0EX_EXPORT_SCOPED_MODULE(ExponentContacts, PermissionsManager);
 ...
 */
ABI23_0_0RCT_EXPORT_METHOD(getContactsAsync:(NSDictionary *)options resolver:(ABI23_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI23_0_0RCTPromiseRejectBlock)reject)
{
  if (!_contactStore) {
    _contactStore = [[CNContactStore alloc] init];
  }

  if ([ABI23_0_0EXPermissions statusForPermissions:[ABI23_0_0EXContactsRequester permissions]] != ABI23_0_0EXPermissionStatusGranted ||
