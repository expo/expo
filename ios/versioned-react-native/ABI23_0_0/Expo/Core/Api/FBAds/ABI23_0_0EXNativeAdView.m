...
@interface ABI23_0_0EXNativeAdView ()
...
@implementation ABI23_0_0EXNativeAdView
...
- (void)setNativeAd:(FBNativeAd *)nativeAd
{
  ...
  [_nativeAd registerViewForInteraction:self mediaView:_mediaView iconView:nil viewController:ABI23_0_0RCTPresentedViewController() clickableViews:@[self]];
}
