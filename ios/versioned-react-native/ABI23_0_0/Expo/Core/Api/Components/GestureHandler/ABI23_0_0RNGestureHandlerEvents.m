...
@implementation ABI23_0_0RNGestureHandlerEventExtraData
...
{
    return [[ABI23_0_0RNGestureHandlerEventExtraData alloc]
            initWithData:@{
                           @"x": @(position.x),
                           @"y": @(position.y),
...
{
    return [[ABI23_0_0RNGestureHandlerEventExtraData alloc] initWithData:@{@"pointerInside": @(pointerInside)}];
}

@end


@implementation ABI23_0_0RNGestureHandlerEvent
{
    NSNumber *_handlerTag;
    ABI23_0_0RNGestureHandlerState _state;
    ABI23_0_0RNGestureHandlerEventExtraData *_extraData;
}
...
- (instancetype)initWithRactTag:(NSNumber *)ReactABI23_0_0Tag
                     handlerTag:(NSNumber *)handlerTag
                      ...
                      extraData:(ABI23_0_0RNGestureHandlerEventExtraData *)extraData
{
...
@implementation ABI23_0_0RNGestureHandlerStateChange
{
    NSNumber *_handlerTag;
    ABI23_0_0RNGestureHandlerState _state;
    ABI23_0_0RNGestureHandlerState _prevState;
    ABI23_0_0RNGestureHandlerEventExtraData *_extraData;
}
