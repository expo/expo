...
@interface ABI23_0_0AIRMapMarker : MKAnnotationView <MKAnnotation>

@property (nonatomic, strong) ABI23_0_0AIRMapCallout *calloutView;
...
@property (nonatomic, copy) ABI23_0_0RCTDirectEventBlock onSelect;
@property (nonatomic, copy) ABI23_0_0RCTDirectEventBlock onDeselect;
...
@interface ABI23_0_0AIREmptyCalloutBackgroundView : ABI23_0_0SMCalloutBackgroundView
@end
