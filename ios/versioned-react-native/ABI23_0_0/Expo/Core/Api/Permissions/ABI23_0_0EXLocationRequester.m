...
+ (NSDictionary *)permissions
{
  ...
  if (whenInUseUsageDescription) {
    ABI23_0_0RCTFatal(ABI23_0_0RCTErrorWithMessage(@"This app is missing NSLocationWhenInUseUsageDescription, so location services will fail. Add one of these keys to your bundle's Info.plist."));
