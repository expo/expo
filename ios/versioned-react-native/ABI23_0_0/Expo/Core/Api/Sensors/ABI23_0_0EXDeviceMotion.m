...
@implementation ABI23_0_0EXDeviceMotion

ABI23_0_0EX_EXPORT_SCOPED_MODULE(ExponentDeviceMotion, SensorManager);
...
{
  return @{ @"Gravity" : @(ABI23_0_0EXGravity) };
}
...
ABI23_0_0RCT_EXPORT_METHOD(setUpdateInterval:(nonnull NSNumber *)intervalMs) {
