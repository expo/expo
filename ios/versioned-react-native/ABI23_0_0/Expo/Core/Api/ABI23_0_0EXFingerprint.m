...
#import "ABI23_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI23_0_0EXFingerprint

ABI23_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI23_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI23_0_0RCTPromiseResolveBlock)resolve
...
ABI23_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI23_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI23_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI23_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
