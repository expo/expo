#import "ABI23_0_0RNAdMobInterstitial.h"

@implementation ABI23_0_0RNAdMobInterstitial {
...
ABI23_0_0RCT_EXPORT_METHOD(requestAd:(ABI23_0_0RCTResponseSenderBlock)callback)
{
  if ([_interstitial hasBeenUsed] || _interstitial == nil) {
    ...
    callback(@[@"Ad is already loaded."]); // TODO: make proper error via ABI23_0_0RCTUtils.h
  }
}
