...
@interface ABI23_0_0EXGLARSessionManager ()
{
...
@property (nonatomic, assign) ABI23_0_0EXGLView *glView;
@property (atomic, strong) ARSession *arSession;

@end

@implementation ABI23_0_0EXGLARSessionManager
...
- (NSDictionary *)startARSessionWithGLView:(ABI23_0_0EXGLView *)glView
{
  ...
  // Create camera texture output ABI23_0_0EXGLObject
...
- (NSDictionary *)arMatricesForViewportSize:(CGSize)viewportSize zNear:(CGFloat)zNear zFar:(CGFloat)zFar
{
  ...
  return @{
    @"transform": [ABI23_0_0EXGLARSessionManager nsArrayForMatrix:transform],
    @"viewMatrix": [ABI23_0_0EXGLARSessionManager nsArrayForMatrix:viewMat],
    @"projectionMatrix": [ABI23_0_0EXGLARSessionManager nsArrayForMatrix:projMat],
  };
}
