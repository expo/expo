...
@implementation ABI23_0_0RNSVGImage
{
    CGImageRef _image;
    CGFloat _imageRatio;
}
...
- (void)setSrc:(id)src
{
    ...
    ABI23_0_0RCTImageSource *source = [ABI23_0_0RCTConvert ABI23_0_0RCTImageSource:src];
    ...
    _image = CGImageRetain([ABI23_0_0RCTConvert CGImage:src]);
    [self invalidate];
}
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    CGAffineTransform transform = [ABI23_0_0RNSVGViewBox getTransform:vbRect eRect:eRect align:self.align meetOrSlice:self.meetOrSlice fromSymbol:NO];
