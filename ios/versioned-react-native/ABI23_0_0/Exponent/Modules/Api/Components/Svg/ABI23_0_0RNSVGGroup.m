...
@implementation ABI23_0_0RNSVGGroup
...
- (void)renderGroupTo:(CGContextRef)context
{
    ...
    [self traverseSubviews:^(ABI23_0_0RNSVGNode *node) {
        ...
        if ([node isKindOfClass:[ABI23_0_0RNSVGRenderable class]]) {
            [(ABI23_0_0RNSVGRenderable*)node mergeProperties:self];
        }
        
        [node renderTo:context];
        
        if ([node isKindOfClass:[ABI23_0_0RNSVGRenderable class]]) {
            [(ABI23_0_0RNSVGRenderable*)node resetProperties];
        }
...
- (void)parseReference
{
    ...
    [self traverseSubviews:^(__kindof ABI23_0_0RNSVGNode *node) {
        [node parseReference];
        return YES;
    }];
}
