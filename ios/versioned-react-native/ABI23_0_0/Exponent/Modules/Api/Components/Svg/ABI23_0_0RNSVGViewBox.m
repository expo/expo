...
@implementation ABI23_0_0RNSVGViewBox

+ (CGAffineTransform)getTransform:(CGRect)vbRect eRect:(CGRect)eRect align:(NSString *)align meetOrSlice:(ABI23_0_0RNSVGVBMOS)meetOrSlice fromSymbol:(BOOL)fromSymbol
{
