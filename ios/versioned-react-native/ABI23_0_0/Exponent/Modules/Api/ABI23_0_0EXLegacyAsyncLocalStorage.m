...
static NSString *const ABI23_0_0RCTStorageDirectory = @"RCTAsyncLocalStorage_V1";
...
#endif
    storageDirectory = [storageDirectory stringByAppendingPathComponent:ABI23_0_0RCTStorageDirectory];
  });
