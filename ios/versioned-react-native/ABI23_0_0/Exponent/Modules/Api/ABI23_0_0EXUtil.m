...
ABI23_0_0RCT_REMAP_METHOD(getCurrentLocaleAsync,
                 getCurrentLocaleWithResolver:(ABI23_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI23_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (preferredLanguages.count > 0) {
    ...
    reject(@"E_NO_PREFERRED_LOCALE", errMsg, ABI23_0_0RCTErrorWithMessage(errMsg));
  }
}

ABI23_0_0RCT_REMAP_METHOD(getCurrentDeviceCountryAsync,
                 getCurrentDeviceCountryWithResolver:(ABI23_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI23_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (countryCode) {
    ...
    reject(@"E_NO_DEVICE_COUNTRY", errMsg, ABI23_0_0RCTErrorWithMessage(errMsg));
  }
}

ABI23_0_0RCT_REMAP_METHOD(getCurrentTimeZoneAsync,
                 getCurrentTimeZoneWithResolver:(ABI23_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI23_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (currentTimeZone) {
    ...
    reject(@"E_NO_DEVICE_TIMEZONE", errMsg, ABI23_0_0RCTErrorWithMessage(errMsg));
  }
}
