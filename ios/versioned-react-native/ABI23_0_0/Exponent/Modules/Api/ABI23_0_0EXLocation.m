...
NSString * const ABI23_0_0EXLocationChangedEventName = @"Exponent.locationChanged";
NSString * const ABI23_0_0EXHeadingChangedEventName = @"Exponent.headingChanged";

@interface ABI23_0_0EXLocationDelegate : NSObject <CLLocationManagerDelegate>
...
@implementation ABI23_0_0EXLocationDelegate
...
@interface ABI23_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI23_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) CLGeocoder *geocoder;
@property (nonatomic, assign, getter=isPaused) BOOL paused;

@end

@implementation ABI23_0_0EXLocation

ABI23_0_0RCT_EXPORT_MODULE(ExponentLocation)
...
{
  return @[ABI23_0_0EXLocationChangedEventName, ABI23_0_0EXHeadingChangedEventName];
}

ABI23_0_0RCT_REMAP_METHOD(getProviderStatusAsync,
...
ABI23_0_0RCT_REMAP_METHOD(getCurrentPositionAsync,
...
ABI23_0_0RCT_REMAP_METHOD(watchPositionImplAsync,
                 ...
                 rejecter:(ABI23_0_0RCTPromiseRejectBlock)reject)
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    locMgr.distanceFilter = options[@"distanceInterval"] ? [ABI23_0_0RCTConvert double:options[@"distanceInterval"]] ?: kCLDistanceFilterNone : kCLLocationAccuracyHundredMeters;
    locMgr.desiredAccuracy = [ABI23_0_0RCTConvert BOOL:options[@"enableHighAccuracy"]] ? kCLLocationAccuracyBest : kCLLocationAccuracyHundredMeters;
    
    ABI23_0_0EXLocationDelegate *delegate = [[ABI23_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
      if (locations.lastObject) {
        ...
        [weakSelf sendEventWithName:ABI23_0_0EXLocationChangedEventName body:body];
      }
...
ABI23_0_0RCT_REMAP_METHOD(watchDeviceHeading,
                 watchId:(nonnull NSNumber *)watchId
                 watchDeviceHeading_resolver:(ABI23_0_0RCTPromiseResolveBlock)resolve
                 watchDeviceHeading_rejecter:(ABI23_0_0RCTPromiseRejectBlock)reject) {
  __weak typeof(self) weakSelf = self;
  dispatch_async(dispatch_get_main_queue(), ^{
    CLLocationManager *locMgr = [[CLLocationManager alloc] init];
    locMgr.distanceFilter = kCLDistanceFilterNone;
    locMgr.desiredAccuracy = kCLLocationAccuracyBest;
    ABI23_0_0EXLocationDelegate *delegate = [[ABI23_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
      if (newHeading) {
        NSNumber *accuracy;
        ...
        [weakSelf sendEventWithName:ABI23_0_0EXHeadingChangedEventName body:body];
      }
...
ABI23_0_0RCT_REMAP_METHOD(removeWatchAsync,
                 watchId:(nonnull NSNumber *)watchId
                 resolver:(ABI23_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI23_0_0RCTPromiseRejectBlock)reject)
{
  ABI23_0_0EXLocationDelegate *delegate = _delegates[watchId];
  if (delegate) {
    __weak typeof(self) weakSelf = self;
    dispatch_async(dispatch_get_main_queue(), ^{
...
ABI23_0_0RCT_REMAP_METHOD(geocodeAsync,
...
ABI23_0_0RCT_REMAP_METHOD(reverseGeocodeAsync,
