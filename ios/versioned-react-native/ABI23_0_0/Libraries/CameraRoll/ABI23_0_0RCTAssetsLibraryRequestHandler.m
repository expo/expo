...
#import "ABI23_0_0RCTAssetsLibraryRequestHandler.h"
...
@implementation ABI23_0_0RCTAssetsLibraryRequestHandler
{
...
- (id)sendRequest:(NSURLRequest *)request
     withDelegate:(id<ABI23_0_0RCTURLRequestDelegate>)delegate
{
  ...
  [[self assetsLibrary] assetForURL:request.URL resultBlock:^(ALAsset *asset) {
    ...
    if (asset) {
      ...
      NSError *error = ABI23_0_0RCTErrorWithMessage(errorMessage);
      [delegate URLRequest:cancellationBlock didCompleteWithError:error];
    }
...
@implementation ABI23_0_0RCTBridge (ABI23_0_0RCTAssetsLibraryImageLoader)

- (ALAssetsLibrary *)assetsLibrary
{
  return [[self moduleForClass:[ABI23_0_0RCTAssetsLibraryRequestHandler class]] assetsLibrary];
}
