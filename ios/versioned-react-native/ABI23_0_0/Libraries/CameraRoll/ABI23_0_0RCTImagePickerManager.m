...
#import "ABI23_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI23_0_0/ABI23_0_0RCTConvert.h>
#import <ReactABI23_0_0/ABI23_0_0RCTImageStoreManager.h>
#import <ReactABI23_0_0/ABI23_0_0RCTRootView.h>
#import <ReactABI23_0_0/ABI23_0_0RCTUtils.h>

@interface ABI23_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI23_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI23_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI23_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI23_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI23_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI23_0_0RCTResponseSenderBlock)callback)
{
...
ABI23_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI23_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI23_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI23_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI23_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI23_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI23_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI23_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI23_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI23_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI23_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI23_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI23_0_0RCTNullIfNil(height), ABI23_0_0RCTNullIfNil(width)]];
    return;
  }
        ...
        cancelCallback:(ABI23_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI23_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI23_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI23_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
