...
@implementation ABI23_0_0RCTTextSelection
...
@implementation ABI23_0_0RCTConvert (ABI23_0_0RCTTextSelection)
...
+ (ABI23_0_0RCTTextSelection *)ABI23_0_0RCTTextSelection:(id)json
{
  if ([json isKindOfClass:[NSDictionary class]]) {
    ...
    return [[ABI23_0_0RCTTextSelection alloc] initWithStart:start end:end];
  }
