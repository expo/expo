...
@protocol ABI23_0_0RCTBackedTextInputDelegate;

@protocol ABI23_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI23_0_0RCTBackedTextInputDelegate> textInputDelegate;
