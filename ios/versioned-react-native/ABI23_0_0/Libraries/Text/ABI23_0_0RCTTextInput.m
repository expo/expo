...
@implementation ABI23_0_0RCTTextInput {
...
- (instancetype)initWithBridge:(ABI23_0_0RCTBridge *)bridge
{
  ...
  if (self = [super initWithFrame:CGRectZero]) {
    ...
    _fontAttributes = [[ABI23_0_0RCTFontAttributes alloc] initWithAccessibilityManager:bridge.accessibilityManager];
...
{
  ABI23_0_0RCTAssert(NO, @"-[ABI23_0_0RCTTextInput backedTextInputView] must be implemented in subclass.");
  return nil;
}
...
- (void)setReactABI23_0_0PaddingInsets:(UIEdgeInsets)ReactABI23_0_0PaddingInsets
{
  _ReactABI23_0_0PaddingInsets = ReactABI23_0_0PaddingInsets;
  // We apply `paddingInsets` as `backedTextInputView`'s `textContainerInset`.
  self.backedTextInputView.textContainerInset = ReactABI23_0_0PaddingInsets;
  [self setNeedsLayout];
}

- (void)setReactABI23_0_0BorderInsets:(UIEdgeInsets)ReactABI23_0_0BorderInsets
{
  _ReactABI23_0_0BorderInsets = ReactABI23_0_0BorderInsets;
  // We apply `borderInsets` as `backedTextInputView` layout offset.
  self.backedTextInputView.frame = UIEdgeInsetsInsetRect(self.bounds, ReactABI23_0_0BorderInsets);
  [self setNeedsLayout];
}

- (ABI23_0_0RCTTextSelection *)selection
{
  id<ABI23_0_0RCTBackedTextInputViewProtocol> backedTextInput = self.backedTextInputView;
  UITextRange *selectedTextRange = backedTextInput.selectedTextRange;
  return [[ABI23_0_0RCTTextSelection new] initWithStart:[backedTextInput offsetFromPosition:backedTextInput.beginningOfDocument toPosition:selectedTextRange.start]
                                           end:[backedTextInput offsetFromPosition:backedTextInput.beginningOfDocument toPosition:selectedTextRange.end]];
}

- (void)setSelection:(ABI23_0_0RCTTextSelection *)selection
{
  if (!selection) {
    return;
  }
  ...
  if (eventLag == 0 && ![previousSelectedTextRange isEqual:selectedTextRange]) {
    ...
    ABI23_0_0RCTLogWarn(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", backedTextInput.text, (long long)eventLag);
  }
}
...
- (void)textInputDidBeginEditing
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI23_0_0RCTTextEventTypeFocus
...
- (BOOL)textInputShouldReturn
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI23_0_0RCTTextEventTypeSubmit
                                 ReactABI23_0_0Tag:self.ReactABI23_0_0Tag
                                     text:self.backedTextInputView.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (void)textInputDidChangeSelection
{
  ...
  ABI23_0_0RCTTextSelection *selection = self.selection;
  _onSelectionChange(@{
    @"selection": @{
...
{
  [_eventDispatcher sendTextEventWithType:ABI23_0_0RCTTextEventTypeEnd
                                 ReactABI23_0_0Tag:self.ReactABI23_0_0Tag
                                     text:self.backedTextInputView.text
                                      key:nil
                               eventCount:_nativeEventCount];

  [_eventDispatcher sendTextEventWithType:ABI23_0_0RCTTextEventTypeBlur
                                 ReactABI23_0_0Tag:self.ReactABI23_0_0Tag
                                     text:self.backedTextInputView.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (CGSize)contentSize
{
  ...
  UIEdgeInsets ReactABI23_0_0PaddingInsets = self.ReactABI23_0_0PaddingInsets;
  contentSize.width -= ReactABI23_0_0PaddingInsets.left + ReactABI23_0_0PaddingInsets.right;
  contentSize.height -= ReactABI23_0_0PaddingInsets.top + ReactABI23_0_0PaddingInsets.bottom;
...
- (CGSize)intrinsicContentSize
{
  ...
  size.width += _ReactABI23_0_0BorderInsets.left + _ReactABI23_0_0BorderInsets.right;
  size.height += _ReactABI23_0_0BorderInsets.top + _ReactABI23_0_0BorderInsets.bottom;
...
{
  CGFloat compoundHorizontalBorderInset = _ReactABI23_0_0BorderInsets.left + _ReactABI23_0_0BorderInsets.right;
  CGFloat compoundVerticalBorderInset = _ReactABI23_0_0BorderInsets.top + _ReactABI23_0_0BorderInsets.bottom;
...
{
  [self.backedTextInputView ReactABI23_0_0Focus];
}

- (void)ReactABI23_0_0Blur
{
  [self.backedTextInputView ReactABI23_0_0Blur];
}

- (void)didMoveToWindow
{
  [self.backedTextInputView ReactABI23_0_0FocusIfNeeded];
}
...
{
#if !TARGET_OS_TV
  UIView<ABI23_0_0RCTBackedTextInputViewProtocol> *textInputView = self.backedTextInputView;
