...
@interface ABI23_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI23_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI23_0_0RCTBackedTextInputViewProtocol> *_backedTextInput;
...
@interface ABI23_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI23_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI23_0_0RCTBackedTextInputViewProtocol> *_backedTextInput;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}
