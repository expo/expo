...
#import <ReactABI23_0_0/ABI23_0_0RCTURLRequestHandler.h>

typedef void (^ABI23_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI23_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI23_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI23_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI23_0_0RCTImageCache <NSObject>
...
@interface UIImage (ReactABI23_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI23_0_0KeyframeAnimation;

@end

@interface ABI23_0_0RCTImageLoader : NSObject <ABI23_0_0RCTBridgeModule, ABI23_0_0RCTURLRequestHandler>
 ...
 */
- (ABI23_0_0RCTImageLoaderCancellationBlock)loadImageWithURLRequest:(NSURLRequest *)imageURLRequest
                                                  callback:(ABI23_0_0RCTImageLoaderCompletionBlock)callback;
...
- (ABI23_0_0RCTImageLoaderCancellationBlock)loadImageWithURLRequest:(NSURLRequest *)imageURLRequest
                                                ...
                                                resizeMode:(ABI23_0_0RCTResizeMode)resizeMode
                                             progressBlock:(ABI23_0_0RCTImageLoaderProgressBlock)progressBlock
                                          partialLoadBlock:(ABI23_0_0RCTImageLoaderPartialLoadBlock)partialLoadBlock
                                           completionBlock:(ABI23_0_0RCTImageLoaderCompletionBlock)completionBlock;
 ...
 */
- (ABI23_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                           clipped:(BOOL)clipped
                                        resizeMode:(ABI23_0_0RCTResizeMode)resizeMode
 ...
 */
- (ABI23_0_0RCTImageLoaderCancellationBlock)getImageSizeForURLRequest:(NSURLRequest *)imageURLRequest
                                                       block:(void(^)(NSError *error, CGSize size))completionBlock;

/**
 * Allows developers to set their own caching implementation for
 * decoded images as long as it conforms to the ABI23_0_0RCTImageCacheDelegate
 * protocol. This method should be called in bridgeDidInitializeModule.
 */
- (void)setImageCache:(id<ABI23_0_0RCTImageCache>)cache;

@end

@interface ABI23_0_0RCTBridge (ABI23_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI23_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI23_0_0RCTImageURLLoader <ABI23_0_0RCTBridgeModule>
...
/**
 * If more than one ABI23_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI23_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 * are also bridge modules, so should be registered using ABI23_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI23_0_0RCTImageDataDecoder <ABI23_0_0RCTBridgeModule>
...
/**
 * If more than one ABI23_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
