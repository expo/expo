...
@interface ABI23_0_0RCTImageStoreManager : NSObject <ABI23_0_0RCTURLRequestHandler>
...
@interface ABI23_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI23_0_0RCTBridge (ABI23_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI23_0_0RCTImageStoreManager *imageStoreManager;
