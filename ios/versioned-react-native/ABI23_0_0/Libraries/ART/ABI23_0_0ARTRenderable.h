...
@interface ABI23_0_0ARTRenderable : ABI23_0_0ARTNode

@property (nonatomic, strong) ABI23_0_0ARTBrush *fill;
...
@property (nonatomic, assign) ABI23_0_0ARTCGFloatArray strokeDash;
