...
@implementation ABI23_0_0ARTText
...
static void ABI23_0_0ARTFreeTextFrame(ABI23_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI23_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI23_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI23_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI23_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
