...
typedef NS_ENUM(NSInteger, ABI23_0_0RCTTestStatus) {
  ABI23_0_0RCTTestStatusPending = 0,
  ABI23_0_0RCTTestStatusPassed,
  ABI23_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI23_0_0RCTTestModule : NSObject <ABI23_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI23_0_0RCTTestStatus status;
