...
@implementation ABI23_0_0RCTDiffClampAnimatedNode
{
...
{
  ABI23_0_0RCTValueAnimatedNode *inputNode = (ABI23_0_0RCTValueAnimatedNode *)self.parentNodes[_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI23_0_0RCTValueAnimatedNode class]]) {
    ABI23_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
