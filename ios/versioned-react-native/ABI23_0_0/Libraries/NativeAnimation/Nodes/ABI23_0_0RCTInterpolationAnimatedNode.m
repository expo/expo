...
@implementation ABI23_0_0RCTInterpolationAnimatedNode
{
  __weak ABI23_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI23_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI23_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI23_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI23_0_0RCTInterpolateValueInRange(inputValue,
                                          _inputRange,
                                          _outputRange,
                                          _extrapolateLeft,
                                          _extrapolateRight);
