...
@interface ABI23_0_0RCTSpringAnimation ()

@property (nonatomic, strong) NSNumber *animationId;
@property (nonatomic, strong) ABI23_0_0RCTValueAnimatedNode *valueNode;
...
@implementation ABI23_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
  ...
  ABI23_0_0RCTResponseSenderBlock _callback;
...
- (instancetype)initWithId:(NSNumber *)animationId
                   ...
                   forNode:(ABI23_0_0RCTValueAnimatedNode *)valueNode
                  callBack:(nullable ABI23_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    NSNumber *iterations = [ABI23_0_0RCTConvert NSNumber:config[@"iterations"]] ?: @1;

    _animationId = animationId;
    _toValue = [ABI23_0_0RCTConvert CGFloat:config[@"toValue"]];
    _fromValue = valueNode.value;
    _lastPosition = 0;
    _valueNode = valueNode;
    _overshootClamping = [ABI23_0_0RCTConvert BOOL:config[@"overshootClamping"]];
    _restDisplacementThreshold = [ABI23_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
    _restSpeedThreshold = [ABI23_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
    _stiffness = [ABI23_0_0RCTConvert CGFloat:config[@"stiffness"]];
    _damping = [ABI23_0_0RCTConvert CGFloat:config[@"damping"]];
    _mass = [ABI23_0_0RCTConvert CGFloat:config[@"mass"]];
