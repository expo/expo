...
@interface ABI23_0_0RCTDecayAnimation ()
...
@implementation ABI23_0_0RCTDecayAnimation
{
  CGFloat _velocity;
                  ...
                  callBack:(nullable ABI23_0_0RCTResponseSenderBlock)callback;
{
  if ((self = [super init])) {
    ...
    _velocity = [ABI23_0_0RCTConvert CGFloat:config[@"velocity"]];
    _deceleration = [ABI23_0_0RCTConvert CGFloat:config[@"deceleration"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  if (_frameStartTime == -1) {
    ...
    _frameStartTime = currentTime - ABI23_0_0RCTSingleFrameInterval;
