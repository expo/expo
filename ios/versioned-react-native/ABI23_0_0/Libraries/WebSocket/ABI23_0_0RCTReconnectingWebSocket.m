...
#import "ABI23_0_0RCTReconnectingWebSocket.h"
...
@interface ABI23_0_0RCTReconnectingWebSocket () <ABI23_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI23_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  __weak ABI23_0_0RCTSRWebSocket *socket = _socket;
