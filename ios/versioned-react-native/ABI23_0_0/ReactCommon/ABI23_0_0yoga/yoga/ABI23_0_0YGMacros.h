...
#ifdef __cplusplus
#define ABI23_0_0YG_EXTERN_C_BEGIN extern "C" {
#define ABI23_0_0YG_EXTERN_C_END }
#else
#define ABI23_0_0YG_EXTERN_C_BEGIN
#define ABI23_0_0YG_EXTERN_C_END
#endif
...
#define ABI23_0_0YG_ENUM_BEGIN(name) NS_ENUM(int, name)
#define ABI23_0_0YG_ENUM_END(name)
#else
#define ABI23_0_0YG_ENUM_BEGIN(name) enum name
#define ABI23_0_0YG_ENUM_END(name) name
#endif
