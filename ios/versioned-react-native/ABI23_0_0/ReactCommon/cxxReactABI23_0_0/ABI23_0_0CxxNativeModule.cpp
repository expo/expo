...
#include "ABI23_0_0CxxNativeModule.h"
#include "ABI23_0_0Instance.h"

#include <iterator>

#include <folly/json.h>

#include "ABI23_0_0JsArgumentHelpers.h"
#include "ABI23_0_0SystraceSection.h"
#include "ABI23_0_0MessageQueueThread.h"
...
void CxxNativeModule::invoke(unsigned int ReactABI23_0_0MethodId, folly::dynamic&& params, int callId) {
  if (ReactABI23_0_0MethodId >= methods_.size()) {
    throw std::invalid_argument(folly::to<std::string>("methodId ", ReactABI23_0_0MethodId,
  ...
  const auto& method = methods_[ReactABI23_0_0MethodId];
