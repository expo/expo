...
#include "ABI23_0_0JSCExecutor.h"
...
#include "ABI23_0_0JSCUtils.h"
#include "ABI23_0_0JSModulesUnbundle.h"
#include "ABI23_0_0ModuleRegistry.h"
#include "ABI23_0_0Platform.h"
#include "ABI23_0_0RAMBundleRegistry.h"
#include "ABI23_0_0RecoverableError.h"
...
namespace facebook {
  namespace ReactABI23_0_0 {
    ...
    void JSCExecutor::loadApplicationScript(std::unique_ptr<const JSBigString> script, std::string sourceURL) {
      ...
      ReactABI23_0_0Marker::logTaggedMarker(ReactABI23_0_0Marker::RUN_JS_BUNDLE_START, scriptName.c_str());
      ...
      if (auto fileStr = dynamic_cast<const JSBigFileString *>(script.get())) {
        ...
        switch (jsStatus) {
          case JSLoadSourceIsCompiled:
            ...
            ReactABI23_0_0Marker::logMarker(ReactABI23_0_0Marker::CREATE_REACT_CONTEXT_STOP);
            ReactABI23_0_0Marker::logTaggedMarker(ReactABI23_0_0Marker::RUN_JS_BUNDLE_STOP, scriptName.c_str());
            return;
...
#endif
      {
        ...
        JSContextLock lock(m_context);
        {
          ...
          ReactABI23_0_0Marker::logMarker(ReactABI23_0_0Marker::JS_BUNDLE_STRING_CONVERT_START);
          jsScript = adoptString(std::move(script));
          ReactABI23_0_0Marker::logMarker(ReactABI23_0_0Marker::JS_BUNDLE_STRING_CONVERT_STOP);
        }
    ...
    JSValueRef JSCExecutor::nativeRequire(
      ...
      ReactABI23_0_0Marker::logMarker(ReactABI23_0_0Marker::NATIVE_REQUIRE_START);
      loadModule(bundleId, moduleId);
      ReactABI23_0_0Marker::logMarker(ReactABI23_0_0Marker::NATIVE_REQUIRE_STOP);
