...
#import <ReactABI23_0_0/ABI23_0_0RCTPointerEvents.h>
#import <ReactABI23_0_0/ABI23_0_0RCTView.h>

@protocol ABI23_0_0RCTAutoInsetsProtocol;

@class ABI23_0_0RCTView;

@interface ABI23_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI23_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI23_0_0RCTDirectEventBlock onMagicTap;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI23_0_0RCTPointerEvents pointerEvents;

+ (void)autoAdjustInsetsForView:(UIView<ABI23_0_0RCTAutoInsetsProtocol> *)parentView
 ...
 * This is inherited from UIView+ReactABI23_0_0, but we override it here
 * to improve perfomance and make subclassing/overriding possible/easier.
 */
@property (nonatomic, assign) UIUserInterfaceLayoutDirection ReactABI23_0_0LayoutDirection;
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI23_0_0RCTBorderStyle borderStyle;
