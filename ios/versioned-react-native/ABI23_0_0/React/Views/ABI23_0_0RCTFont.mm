...
// These constants can only be removed when ReactABI23_0_0 Native drops iOS8 support.
...
typedef CGFloat ABI23_0_0RCTFontWeight;
static ABI23_0_0RCTFontWeight weightOfFont(UIFont *font)
{
  ...
  for (NSInteger i = 0; i < fontNames.count; i++) {
    if ([font.fontName.lowercaseString hasSuffix:fontNames[i]]) {
      return (ABI23_0_0RCTFontWeight)[fontWeights[i] doubleValue];
    }
  }

  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  return (ABI23_0_0RCTFontWeight)[traits[UIFontWeightTrait] doubleValue];
}
...
static UIFont *cachedSystemFont(CGFloat size, ABI23_0_0RCTFontWeight weight)
{
...
@implementation ABI23_0_0RCTConvert (ABI23_0_0RCTFont)

+ (UIFont *)UIFont:(id)json
{
  json = [self NSDictionary:json];
  return [ABI23_0_0RCTFont updateFont:nil
                  withFamily:[ABI23_0_0RCTConvert NSString:json[@"fontFamily"]]
                        size:[ABI23_0_0RCTConvert NSNumber:json[@"fontSize"]]
                      weight:[ABI23_0_0RCTConvert NSString:json[@"fontWeight"]]
                       style:[ABI23_0_0RCTConvert NSString:json[@"fontStyle"]]
                     variant:[ABI23_0_0RCTConvert NSStringArray:json[@"fontVariant"]]
             scaleMultiplier:1];
}

ABI23_0_0RCT_ENUM_CONVERTER(ABI23_0_0RCTFontWeight, (@{
...
typedef BOOL ABI23_0_0RCTFontStyle;
ABI23_0_0RCT_ENUM_CONVERTER(ABI23_0_0RCTFontStyle, (@{
                                    @"normal": @NO,
                                    @"italic": @YES,
                                    @"oblique": @YES,
                                    }), NO, boolValue)

typedef NSDictionary ABI23_0_0RCTFontVariantDescriptor;
+ (ABI23_0_0RCTFontVariantDescriptor *)ABI23_0_0RCTFontVariantDescriptor:(id)json
{
  ...
  ABI23_0_0RCTFontVariantDescriptor *value = mapping[json];
  if (ABI23_0_0RCT_DEBUG && !value && [json description].length > 0) {
    ABI23_0_0RCTLogError(@"Invalid ABI23_0_0RCTFontVariantDescriptor '%@'. should be one of: %@", json,
                [[mapping allKeys] sortedArrayUsingSelector:@selector(caseInsensitiveCompare:)]);
  }
  return value;
}

ABI23_0_0RCT_ARRAY_CONVERTER(ABI23_0_0RCTFontVariantDescriptor)

@end

@implementation ABI23_0_0RCTFont
...
+ (UIFont *)updateFont:(UIFont *)font
            withFamily:(NSString *)family
               ...
               variant:(NSArray<ABI23_0_0RCTFontVariantDescriptor *> *)variant
       scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  const ABI23_0_0RCTFontWeight defaultFontWeight = UIFontWeightRegular;
  const CGFloat defaultFontSize = 14;

  // Initialize properties to defaults
  CGFloat fontSize = defaultFontSize;
  ABI23_0_0RCTFontWeight fontWeight = defaultFontWeight;
  ...
  // Get font attributes
  fontSize = [ABI23_0_0RCTConvert CGFloat:size] ?: fontSize;
  if (scaleMultiplier > 0.0 && scaleMultiplier != 1.0) {
    fontSize = round(fontSize * scaleMultiplier);
  }
  familyName = [ABI23_0_0RCTConvert NSString:family] ?: familyName;
  isItalic = style ? [ABI23_0_0RCTConvert ABI23_0_0RCTFontStyle:style] : isItalic;
  fontWeight = weight ? [ABI23_0_0RCTConvert ABI23_0_0RCTFontWeight:weight] : fontWeight;
  ...
  if (!didFindFont && [UIFont fontNamesForFamilyName:familyName].count == 0) {
    ...
    if (font) {
      ...
      ABI23_0_0RCTLogError(@"Unrecognized font family '%@'", familyName);
      if ([UIFont respondsToSelector:@selector(systemFontOfSize:weight:)]) {
  ...
  if (variant) {
    NSArray *fontFeatures = [ABI23_0_0RCTConvert ABI23_0_0RCTFontVariantDescriptorArray:variant];
