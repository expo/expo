...
@implementation ABI23_0_0RCTConvert (UITabBarSystemItem)

ABI23_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI23_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI23_0_0ViewController;
}
