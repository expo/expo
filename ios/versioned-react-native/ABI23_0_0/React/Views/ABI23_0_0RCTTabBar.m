...
@interface ABI23_0_0RCTTabBar() <UITabBarControllerDelegate>

@end

@implementation ABI23_0_0RCTTabBar
{
  BOOL _tabsChanged;
...
- (void)insertReactABI23_0_0Subview:(ABI23_0_0RCTTabBarItem *)subview atIndex:(NSInteger)atIndex
{
  if (![subview isKindOfClass:[ABI23_0_0RCTTabBarItem class]]) {
    ABI23_0_0RCTLogError(@"subview should be of type ABI23_0_0RCTTabBarItem");
    return;
  }
...
- (void)removeReactABI23_0_0Subview:(ABI23_0_0RCTTabBarItem *)subview
{
  if (self.ReactABI23_0_0Subviews.count == 0) {
    ABI23_0_0RCTLogError(@"should have at least one view to remove a subview");
    return;
  }
...
- (void)layoutSubviews
{
  ...
  [self ReactABI23_0_0AddControllerToClosestParent:_tabController];
...
- (void)ReactABI23_0_0BridgeDidFinishTransaction
{
  ...
  if (_tabsChanged) {
    ...
    for (ABI23_0_0RCTTabBarItem *tab in [self ReactABI23_0_0Subviews]) {
      UIViewController *controller = tab.ReactABI23_0_0ViewController;
      if (!controller) {
        controller = [[ABI23_0_0RCTWrapperViewController alloc] initWithContentView:tab];
      }
  ...
  [self.ReactABI23_0_0Subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger index, __unused BOOL *stop) {

    ABI23_0_0RCTTabBarItem *tab = (ABI23_0_0RCTTabBarItem *)view;
...
- (void)tabBarController:(UITabBarController *)tabBarController didSelectViewController:(nonnull UIViewController *)viewController
{
  ...
  ABI23_0_0RCTTabBarItem *tab = (ABI23_0_0RCTTabBarItem *)self.ReactABI23_0_0Subviews[index];
