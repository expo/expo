...
@interface UIView (ReactABI23_0_0) <ABI23_0_0RCTComponent>

/**
 * ABI23_0_0RCTComponent interface.
 */
- (NSArray<UIView *> *)ReactABI23_0_0Subviews NS_REQUIRES_SUPER;
- (UIView *)ReactABI23_0_0Superview NS_REQUIRES_SUPER;
- (void)insertReactABI23_0_0Subview:(UIView *)subview atIndex:(NSInteger)atIndex NS_REQUIRES_SUPER;
- (void)removeReactABI23_0_0Subview:(UIView *)subview NS_REQUIRES_SUPER;
 ...
 */
@property (nonatomic, assign) ABI23_0_0YGDisplay ReactABI23_0_0Display;

/**
 * The z-index of the view.
 */
@property (nonatomic, assign) NSInteger ReactABI23_0_0ZIndex;
...
/**
 * Updates the subviews array based on the ReactABI23_0_0Subviews. Default behavior is
 * to insert the sortedReactABI23_0_0Subviews into the UIView.
 */
 ...
 */
@property (nonatomic, readonly) UIEdgeInsets ReactABI23_0_0BorderInsets;
@property (nonatomic, readonly) UIEdgeInsets ReactABI23_0_0PaddingInsets;
@property (nonatomic, readonly) UIEdgeInsets ReactABI23_0_0CompoundInsets;
@property (nonatomic, readonly) CGRect ReactABI23_0_0ContentFrame;
 ...
 * Defaults to `self`.
 */
@property (nonatomic, readonly) UIView *ReactABI23_0_0AccessibilityElement;
...
@property (nonatomic, strong, setter=_DEBUG_setReactABI23_0_0ShadowView:) ABI23_0_0RCTShadowView *_DEBUG_ReactABI23_0_0ShadowView;
