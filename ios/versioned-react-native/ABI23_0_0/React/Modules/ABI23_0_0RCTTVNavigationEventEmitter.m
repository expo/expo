...
NSString *const ABI23_0_0RCTTVNavigationEventNotification = @"ABI23_0_0RCTTVNavigationEventNotification";

static NSString *const TVNavigationEventName = @"onTVNavEvent";

@implementation ABI23_0_0RCTTVNavigationEventEmitter
  ...
  if (self = [super init]) {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(handleTVNavigationEventNotification:)
                                                 name:ABI23_0_0RCTTVNavigationEventNotification
                                               object:nil];
