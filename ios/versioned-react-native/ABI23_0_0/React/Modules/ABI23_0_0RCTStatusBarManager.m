...
#import "ABI23_0_0RCTStatusBarManager.h"
...
#if !TARGET_OS_TV
@implementation ABI23_0_0RCTConvert (UIStatusBar)
...
@implementation ABI23_0_0RCTStatusBarManager

static BOOL ABI23_0_0RCTViewControllerBasedStatusBarAppearance()
{
  static BOOL value;
...
{
  callback(@[@{
    @"height": @(ABI23_0_0RCTSharedApplication().statusBarFrame.size.height),
  }]);
}
...
{
  if (ABI23_0_0RCTViewControllerBasedStatusBarAppearance()) {
