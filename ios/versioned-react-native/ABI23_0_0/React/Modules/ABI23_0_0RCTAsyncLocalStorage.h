 ...
 */
@interface ABI23_0_0RCTAsyncLocalStorage : NSObject <ABI23_0_0RCTBridgeModule,ABI23_0_0RCTInvalidating>
...
// Clear the ABI23_0_0RCTAsyncLocalStorage data from native code
- (void)clearAllData;
