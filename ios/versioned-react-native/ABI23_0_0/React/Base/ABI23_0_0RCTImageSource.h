 ...
 */
@interface ABI23_0_0RCTImageSource : NSObject
...
@interface ABI23_0_0RCTConvert (ImageSource)

+ (ABI23_0_0RCTImageSource *)ABI23_0_0RCTImageSource:(id)json;
+ (NSArray<ABI23_0_0RCTImageSource *> *)ABI23_0_0RCTImageSourceArray:(id)json;
