...
typedef id<ABI23_0_0RCTBridgeModule>(^ABI23_0_0RCTBridgeModuleProvider)(void);

@interface ABI23_0_0RCTModuleData : NSObject <ABI23_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI23_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI23_0_0RCTBridgeModule> instance;
