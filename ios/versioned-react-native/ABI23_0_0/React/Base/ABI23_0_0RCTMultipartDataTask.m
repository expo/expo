...
#import "ABI23_0_0RCTMultipartDataTask.h"

@interface ABI23_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI23_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI23_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI23_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI23_0_0RCTMultipartStreamReader *reader = [[ABI23_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI23_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
