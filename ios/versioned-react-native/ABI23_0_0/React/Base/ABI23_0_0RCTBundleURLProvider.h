...
extern NSString *const ABI23_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI23_0_0RCTBundleURLProviderDefaultPort;

@interface ABI23_0_0RCTBundleURLProvider : NSObject
