...
/**
 ...
 - The JS exception's unsymbolicated stack trace is available via the NSError userInfo's ABI23_0_0RCTJSExceptionUnsymbolicatedStackTraceKey
 */
ABI23_0_0RCT_EXTERN NSError *ABI23_0_0RCTNSErrorFromJSError(JSValue *exception);

/**
 Translates a given exception into an NSError.

 @see ABI23_0_0RCTNSErrorFromJSError for details
 */
ABI23_0_0RCT_EXTERN NSError *ABI23_0_0RCTNSErrorFromJSErrorRef(JSValueRef exceptionRef, JSGlobalContextRef ctx);
