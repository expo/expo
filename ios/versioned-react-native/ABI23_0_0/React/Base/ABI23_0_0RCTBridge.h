...
@class ABI23_0_0RCTPerformanceLogger;

/**
 * This notification fires when the bridge starts loading the JS bundle.
 */
ABI23_0_0RCT_EXTERN NSString *const ABI23_0_0RCTJavaScriptWillStartLoadingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI23_0_0RCT_EXTERN NSString *const ABI23_0_0RCTJavaScriptDidLoadNotification;

/**
 * This notification fires when the bridge failed to load the JS bundle. The
 * `error` key can be used to determine the error that occured.
 */
ABI23_0_0RCT_EXTERN NSString *const ABI23_0_0RCTJavaScriptDidFailToLoadNotification;
 ...
 */
ABI23_0_0RCT_EXTERN NSString *const ABI23_0_0RCTDidInitializeModuleNotification;

/**
 * This notification fires just before the bridge starts processing a request to
 * reload.
 */
ABI23_0_0RCT_EXTERN NSString *const ABI23_0_0RCTBridgeWillReloadNotification;

/**
 * This notification fires just before the bridge begins downloading a script
 * from the packager.
 */
ABI23_0_0RCT_EXTERN NSString *const ABI23_0_0RCTBridgeWillDownloadScriptNotification;

/**
 * This notification fires just after the bridge finishes downloading a script
 * from the packager.
 */
ABI23_0_0RCT_EXTERN NSString *const ABI23_0_0RCTBridgeDidDownloadScriptNotification;

/**
 * Key for the ABI23_0_0RCTSource object in the ABI23_0_0RCTBridgeDidDownloadScriptNotification
 * userInfo dictionary.
 */
ABI23_0_0RCT_EXTERN NSString *const ABI23_0_0RCTBridgeDidDownloadScriptNotificationSourceKey;
 ...
 */
typedef NSArray<id<ABI23_0_0RCTBridgeModule>> *(^ABI23_0_0RCTBridgeModuleListProvider)(void);

/**
 * This function returns the module name for a given class.
 */
ABI23_0_0RCT_EXTERN NSString *ABI23_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI23_0_0RCTBridge : NSObject <ABI23_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI23_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI23_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 * See also -[ABI23_0_0RCTBridgeDelgate shouldBridgeLoadJavaScriptSynchronously], which
 ...
 */
@property (nonatomic, weak, readonly) id<ABI23_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ReactABI23_0_0 Native perf events.
 */
@property (nonatomic, readonly, strong) ABI23_0_0RCTPerformanceLogger *performanceLogger;
