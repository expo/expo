...
#import <ReactABI23_0_0/ABI23_0_0RCTCxxBridgeDelegate.h>
#import <ReactABI23_0_0/ABI23_0_0RCTCxxModule.h>
#import <ReactABI23_0_0/ABI23_0_0RCTCxxUtils.h>
#import <ReactABI23_0_0/ABI23_0_0RCTDevSettings.h>
#import <ReactABI23_0_0/ABI23_0_0RCTDisplayLink.h>
...
#import <cxxReactABI23_0_0/ABI23_0_0Instance.h>
#import <cxxReactABI23_0_0/ABI23_0_0JSBundleType.h>
#import <cxxReactABI23_0_0/ABI23_0_0JSCExecutor.h>
#import <cxxReactABI23_0_0/ABI23_0_0JSIndexedRAMBundle.h>
#include <cxxReactABI23_0_0/ABI23_0_0JSIndexedRAMBundleRegistry.h>
#import <cxxReactABI23_0_0/ABI23_0_0Platform.h>
#import <ABI23_0_0jschelpers/ABI23_0_0Value.h>

#import "ABI23_0_0NSDataBigString.h"
#import "ABI23_0_0RCTJSCHelpers.h"
#import "ABI23_0_0RCTMessageThread.h"
#import "ABI23_0_0RCTObjcExecutor.h"

#ifdef WITH_FBSYSTRACE
#import <ReactABI23_0_0/ABI23_0_0RCTFBSystrace.h>
#endif
...
@interface ABI23_0_0RCTCxxBridge : ABI23_0_0RCTBridge
@end

#define ABI23_0_0RCTAssertJSThread() \
  ABI23_0_0RCTAssert(self.executorClass || self->_jsThread == [NSThread currentThread], \
            @"This method must be called on JS thread")

static NSString *const ABI23_0_0RCTJSThreadName = @"com.facebook.ReactABI23_0_0.JavaScript";
...
public:
  GetDescAdapter(ABI23_0_0RCTCxxBridge *bridge, std::shared_ptr<JSExecutorFactory> factory)
    : bridge_(bridge)
    , factory_(factory) {}
  std::unique_ptr<JSExecutor> createJSExecutor(
    ...
    bridge_.bridgeDescription =
      [NSString stringWithFormat:@"ABI23_0_0RCTCxxBridge %s",
                ret->getDescription().c_str()];
    return std::move(ret);
  }

private:
  ABI23_0_0RCTCxxBridge *bridge_;
...
static void registerPerformanceLoggerHooks(ABI23_0_0RCTPerformanceLogger *performanceLogger) {
  __weak ABI23_0_0RCTPerformanceLogger *weakPerformanceLogger = performanceLogger;
  ReactABI23_0_0Marker::logTaggedMarker = [weakPerformanceLogger](const ReactABI23_0_0Marker::ReactABI23_0_0MarkerId markerId, const char *tag) {
    switch (markerId) {
      case ReactABI23_0_0Marker::RUN_JS_BUNDLE_START:
        [weakPerformanceLogger markStartForTag:ABI23_0_0RCTPLScriptExecution];
        break;
      case ReactABI23_0_0Marker::RUN_JS_BUNDLE_STOP:
        [weakPerformanceLogger markStopForTag:ABI23_0_0RCTPLScriptExecution];
        break;
      case ReactABI23_0_0Marker::NATIVE_REQUIRE_START:
        [weakPerformanceLogger appendStartForTag:ABI23_0_0RCTPLRAMNativeRequires];
        break;
      case ReactABI23_0_0Marker::NATIVE_REQUIRE_STOP:
        [weakPerformanceLogger appendStopForTag:ABI23_0_0RCTPLRAMNativeRequires];
        [weakPerformanceLogger addValue:1 forTag:ABI23_0_0RCTPLRAMNativeRequiresCount];
        break;
      case ReactABI23_0_0Marker::CREATE_REACT_CONTEXT_STOP:
      case ReactABI23_0_0Marker::JS_BUNDLE_STRING_CONVERT_START:
      case ReactABI23_0_0Marker::JS_BUNDLE_STRING_CONVERT_STOP:
      case ReactABI23_0_0Marker::NATIVE_MODULE_SETUP_START:
      case ReactABI23_0_0Marker::NATIVE_MODULE_SETUP_STOP:
...
@interface ABI23_0_0RCTCxxBridge ()
...
struct ABI23_0_0RCTInstanceCallback : public InstanceCallback {
  __weak ABI23_0_0RCTCxxBridge *bridge_;
  ABI23_0_0RCTInstanceCallback(ABI23_0_0RCTCxxBridge *bridge): bridge_(bridge) {};
...
@implementation ABI23_0_0RCTCxxBridge
{
  ...
  // Native modules
  NSMutableDictionary<NSString *, ABI23_0_0RCTModuleData *> *_moduleDataByName;
  NSMutableArray<ABI23_0_0RCTModuleData *> *_moduleDataByID;
  ...
  NSThread *_jsThread;
  std::shared_ptr<ABI23_0_0RCTMessageThread> _jsMessageThread;

  // This is uniquely owned, but weak_ptr is used.
  std::shared_ptr<Instance> _ReactABI23_0_0Instance;
}
...
+ (void)initialize
{
  if (self == [ABI23_0_0RCTCxxBridge class]) {
    ABI23_0_0RCTPrepareJSCExecutor();
  }
}
...
{
  return (JSGlobalContextRef)(self->_ReactABI23_0_0Instance ? self->_ReactABI23_0_0Instance->getJavaScriptContext() : nullptr);
}
...
{
  @autoreleasepool {
    ABI23_0_0RCT_PROFILE_BEGIN_EVENT(ABI23_0_0RCTProfileTagAlways, @"-[ABI23_0_0RCTCxxBridge runJSRunLoop] setup", nil);
...
{
  ABI23_0_0RCTAssert(_jsThread, @"This method must not be called before the JS thread is created");
...
- (void)start
{
  ABI23_0_0RCT_PROFILE_BEGIN_EVENT(ABI23_0_0RCTProfileTagAlways, @"-[ABI23_0_0RCTCxxBridge start]", nil);
  ...
  _jsThread = [[NSThread alloc] initWithTarget:[self class]
                                      selector:@selector(runRunLoop)
                                        object:nil];
  _jsThread.name = ABI23_0_0RCTJSThreadName;
  ...
  [self _initModules:ABI23_0_0RCTGetModuleClasses() withDispatchGroup:prepareBridge lazilyDiscovered:NO];
  ...
  _ReactABI23_0_0Instance.reset(new Instance);

  __weak ABI23_0_0RCTCxxBridge *weakSelf = self;

  // Prepare executor factory (shared_ptr for copy into block)
  std::shared_ptr<JSExecutorFactory> executorFactory;
  if (!self.executorClass) {
    if ([self.delegate conformsToProtocol:@protocol(ABI23_0_0RCTCxxBridgeDelegate)]) {
      id<ABI23_0_0RCTCxxBridgeDelegate> cxxDelegate = (id<ABI23_0_0RCTCxxBridgeDelegate>) self.delegate;
    ...
    if (!executorFactory) {
      ...
      executorFactory.reset(new JSCExecutorFactory(folly::dynamic::object
        ("OwnerIdentity", "ReactABI23_0_0Native")
    ...
    id<ABI23_0_0RCTJavaScriptExecutor> objcExecutor = [self moduleForClass:self.executorClass];
    executorFactory.reset(new ABI23_0_0RCTObjcExecutorFactory(objcExecutor, ^(NSError *error) {
      if (error) {
  ...
  if (!self.executorClass &&
    ...
    NSData *sourceCode = [ABI23_0_0RCTJavaScriptLoader attemptSynchronousLoadOfBundleAtURL:self.bundleURL
    ...
    dispatch_group_notify(prepareBridge, dispatch_get_global_queue(QOS_CLASS_USER_INTERACTIVE, 0), ^{
      ABI23_0_0RCTCxxBridge *strongSelf = weakSelf;
...
- (void)loadSource:(ABI23_0_0RCTSourceLoadBlock)_onSourceLoad onProgress:(ABI23_0_0RCTSourceLoadProgressBlock)onProgress
{
  ...
  [center postNotificationName:ABI23_0_0RCTBridgeWillDownloadScriptNotification object:_parentBridge];
  [_performanceLogger markStartForTag:ABI23_0_0RCTPLScriptDownload];
  NSUInteger cookie = ABI23_0_0RCTProfileBeginAsyncEvent(0, @"JavaScript download", nil);

  // Suppress a warning if ABI23_0_0RCTProfileBeginAsyncEvent gets compiled out
  (void)cookie;
  ...
  ABI23_0_0RCTSourceLoadBlock onSourceLoad = ^(NSError *error, ABI23_0_0RCTSource *source) {
    ABI23_0_0RCTProfileEndAsyncEvent(0, @"native", cookie, @"JavaScript download", @"JS async");
    ...
    NSDictionary *userInfo = source ? @{ ABI23_0_0RCTBridgeDidDownloadScriptNotificationSourceKey: source } : nil;
    [center postNotificationName:ABI23_0_0RCTBridgeDidDownloadScriptNotification object:self->_parentBridge userInfo:userInfo];
...
- (std::shared_ptr<ModuleRegistry>)_buildModuleRegistry
{
  ...
  [_performanceLogger markStartForTag:ABI23_0_0RCTPLNativeModulePrepareConfig];
  ABI23_0_0RCT_PROFILE_BEGIN_EVENT(ABI23_0_0RCTProfileTagAlways, @"-[ABI23_0_0RCTCxxBridge buildModuleRegistry]", nil);
  ...
  auto registry = std::make_shared<ModuleRegistry>(
         createNativeModules(_moduleDataByID, self, _ReactABI23_0_0Instance),
         moduleNotFoundCallback);

  [_performanceLogger markStopForTag:ABI23_0_0RCTPLNativeModulePrepareConfig];
  ABI23_0_0RCT_PROFILE_END_EVENT(ABI23_0_0RCTProfileTagAlways, @"");
...
- (void)_initializeBridge:(std::shared_ptr<JSExecutorFactory>)executorFactory
{
  ...
  __weak ABI23_0_0RCTCxxBridge *weakSelf = self;
  _jsMessageThread = std::make_shared<ABI23_0_0RCTMessageThread>([NSRunLoop currentRunLoop], ^(NSError *error) {
    if (error) {
      [weakSelf handleError:error];
    }
  });

  ABI23_0_0RCT_PROFILE_BEGIN_EVENT(ABI23_0_0RCTProfileTagAlways, @"-[ABI23_0_0RCTCxxBridge initializeBridge:]", nil);
  // This can only be false if the bridge was invalidated before startup completed
  if (_ReactABI23_0_0Instance) {
#if ABI23_0_0RCT_DEV
    executorFactory = std::make_shared<GetDescAdapter>(self, executorFactory);
#endif

    // This is async, but any calls into JS are blocked by the m_syncReady CV in Instance
    _ReactABI23_0_0Instance->initializeBridge(
      std::make_unique<ABI23_0_0RCTInstanceCallback>(self),
      executorFactory,
      _jsMessageThread,
    ...
    if (ABI23_0_0RCTProfileIsProfiling()) {
      _ReactABI23_0_0Instance->setGlobalVariable(
        "__ABI23_0_0RCTProfileIsProfiling",
...
- (NSArray<ABI23_0_0RCTModuleData *> *)registerModulesForClasses:(NSArray<Class> *)moduleClasses
{
  ABI23_0_0RCT_PROFILE_BEGIN_EVENT(ABI23_0_0RCTProfileTagAlways,
                          @"-[ABI23_0_0RCTCxxBridge initModulesWithDispatchGroup:] autoexported moduleData", nil);

  NSMutableArray<ABI23_0_0RCTModuleData *> *moduleDataByID = [NSMutableArray arrayWithCapacity:moduleClasses.count];
  for (Class moduleClass in moduleClasses) {
    ...
    if ([moduleName isEqualToString:@"ABI23_0_0RCTJSCExecutor"]) {
      continue;
    }
    ...
    moduleData = [[ABI23_0_0RCTModuleData alloc] initWithModuleClass:moduleClass bridge:self];
...
{
  ABI23_0_0RCT_PROFILE_BEGIN_EVENT(ABI23_0_0RCTProfileTagAlways,
                          @"-[ABI23_0_0RCTCxxBridge initModulesWithDispatchGroup:] extraModules", nil);
  ...
  ABI23_0_0RCT_PROFILE_BEGIN_EVENT(ABI23_0_0RCTProfileTagAlways,
                          @"-[ABI23_0_0RCTCxxBridge initModulesWithDispatchGroup:] preinitialized moduleData", nil);
  ...
  for (id<ABI23_0_0RCTBridgeModule> module in extraModules) {
    ...
    ABI23_0_0RCTModuleData *moduleData = [[ABI23_0_0RCTModuleData alloc] initWithModuleInstance:module bridge:self];
    _moduleDataByName[moduleName] = moduleData;
    [_moduleClassesByID addObject:moduleClass];
...
- (void)_initModules:(NSArray<id<ABI23_0_0RCTBridgeModule>> *)modules
   withDispatchGroup:(dispatch_group_t)dispatchGroup
    lazilyDiscovered:(BOOL)lazilyDiscovered
{
  ABI23_0_0RCTAssert(!(ABI23_0_0RCTIsMainQueue() && lazilyDiscovered), @"Lazy discovery can only happen off the Main Queue");

  // Set up moduleData for automatically-exported modules
  NSArray<ABI23_0_0RCTModuleData *> *moduleDataById = [self registerModulesForClasses:modules];
  ...
  if (lazilyDiscovered) {
    ...
    for (ABI23_0_0RCTModuleData *moduleData in moduleDataById) {
      ABI23_0_0RCTAssert(!(moduleData.requiresMainQueueSetup || moduleData.hasInstance),
  ...
  {
    ABI23_0_0RCT_PROFILE_BEGIN_EVENT(ABI23_0_0RCTProfileTagAlways,
                            @"-[ABI23_0_0RCTCxxBridge initModulesWithDispatchGroup:] moduleData.hasInstance", nil);
    ...
    for (ABI23_0_0RCTModuleData *moduleData in _moduleDataByID) {
      if (moduleData.hasInstance && (!moduleData.requiresMainQueueSetup || ABI23_0_0RCTIsMainQueue())) {
  ...
  if (ABI23_0_0RCTProfileIsProfiling()) {
    ...
    ABI23_0_0RCTProfileHookModules(self);
  }
#endif
}
...
- (void)_prepareModulesWithDispatchGroup:(dispatch_group_t)dispatchGroup
{
  ...
  [_performanceLogger setValue:0 forTag:ABI23_0_0RCTPLNativeModuleMainThread];
  ...
  for (ABI23_0_0RCTModuleData *moduleData in _moduleDataByID) {
    ...
    if (moduleData.requiresMainQueueSetup) {
      ...
      dispatch_block_t block = ^{
        if (self.valid && ![moduleData.moduleClass isSubclassOfClass:[ABI23_0_0RCTCxxModule class]]) {
...
- (void)handleError:(NSError *)error
{
  ...
  // through this method, but through ABI23_0_0RCTExceptionManager.
  ...
  // In state 1: on main queue, move to state 2, reset the bridge, and ABI23_0_0RCTFatal.
  // In state 2: go directly to ABI23_0_0RCTFatal.  Do not enqueue, do not collect $200.
  // In state 3: do nothing.

  if (self->_valid && !self->_loading) {
    if ([error userInfo][ABI23_0_0RCTJSRawStackTraceKey]) {
      [self.redBox showErrorMessage:[error localizedDescription]
                       withRawStack:[error userInfo][ABI23_0_0RCTJSRawStackTraceKey]];
    }
  ...
  ABI23_0_0RCTRedBox *redBox = [self redBox];
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    self->_ReactABI23_0_0Instance.reset();
...
- (void)invalidate
{
  ...
  ABI23_0_0RCTAssertMainQueue();
  ABI23_0_0RCTLogInfo(@"Invalidating %@ (parent: %@, executor: %@)", self, _parentBridge, [self executorClass]);
  ...
  [self ensureOnJavaScriptThread:^{
    ...
    for (ABI23_0_0RCTModuleData *moduleData in self->_moduleDataByID) {
      ...
      if ([moduleData.instance respondsToSelector:@selector(invalidate)]) {
        ...
        [self dispatchBlock:^{
          [(id<ABI23_0_0RCTInvalidating>)moduleData.instance invalidate];
    ...
    if (dispatch_group_wait(moduleInvalidation, dispatch_time(DISPATCH_TIME_NOW, 10 * NSEC_PER_SEC))) {
      ABI23_0_0RCTLogError(@"Timed out waiting for modules to be invalidated");
    }
...
- (void)_flushPendingCalls
{
  ...
  [_performanceLogger setValue:nativeRequiresCount forTag:ABI23_0_0RCTPLRAMStartupNativeRequiresCount];
  uint64_t nativeRequires = [self->_performanceLogger valueForTag:ABI23_0_0RCTPLRAMNativeRequires];
  [_performanceLogger setValue:nativeRequires forTag:ABI23_0_0RCTPLRAMStartupNativeRequires];

  [_performanceLogger markStopForTag:ABI23_0_0RCTPLBridgeStartup];

  ABI23_0_0RCT_PROFILE_BEGIN_EVENT(0, @"Processing pendingCalls", @{ @"count": [@(_pendingCalls.count) stringValue] });
...
- (void)enqueueJSCall:(NSString *)module method:(NSString *)method args:(NSArray *)args completion:(dispatch_block_t)completion
{
   ...
   * AnyThread
   */
  ABI23_0_0RCT_PROFILE_BEGIN_EVENT(ABI23_0_0RCTProfileTagAlways, @"-[ABI23_0_0RCTCxxBridge enqueueJSCall:]", nil);

  ABI23_0_0RCTProfileBeginFlowEvent();
  [self _runAfterLoad:^{
    ABI23_0_0RCTProfileEndFlowEvent();

    if (self->_ReactABI23_0_0Instance) {
      self->_ReactABI23_0_0Instance->callJSFunction([module UTF8String], [method UTF8String],
      ...
      if (completion) {
        if (self->_jsMessageThread) {
          ...
          ABI23_0_0RCTLogWarn(@"Can't invoke completion without messageThread");
        }
      }
    }
  }];
...
- (void)enqueueCallback:(NSNumber *)cbID args:(NSArray *)args
{
  ...
  [self _runAfterLoad:^{
    ...
    if (self->_ReactABI23_0_0Instance) {
      self->_ReactABI23_0_0Instance->callJSCallback([cbID unsignedLongLongValue], convertIdToFollyDynamic(args ?: @[]));
    }
  }];
}
...
- (void)_immediatelyCallTimer:(NSNumber *)timer
{
  ...
  if (_ReactABI23_0_0Instance) {
    _ReactABI23_0_0Instance->callJSFunction("JSTimers", "callTimers",
...
{
  ABI23_0_0RCT_PROFILE_BEGIN_EVENT(ABI23_0_0RCTProfileTagAlways, @"-[ABI23_0_0RCTCxxBridge enqueueApplicationScript]", nil);
  ...
  if (onComplete) {
    ABI23_0_0RCTAssert(_jsMessageThread != nullptr, @"Cannot invoke completion without jsMessageThread");
                           ...
                           async:(BOOL)async
{
  [self _tryAndHandleError:^{
    ...
    if (isRAMBundle(script)) {
      [self->_performanceLogger markStartForTag:ABI23_0_0RCTPLRAMBundleLoad];
      auto ramBundle = std::make_unique<JSIndexedRAMBundle>(sourceUrlStr.UTF8String);
      std::unique_ptr<const JSBigString> scriptStr = ramBundle->getStartupCode();
      [self->_performanceLogger markStopForTag:ABI23_0_0RCTPLRAMBundleLoad];
      [self->_performanceLogger setValue:scriptStr->size() forTag:ABI23_0_0RCTPLRAMStartupCodeSize];
      if (self->_ReactABI23_0_0Instance) {
        auto registry = std::make_unique<JSIndexedRAMBundleRegistry>(std::move(ramBundle), sourceUrlStr.UTF8String);
        self->_ReactABI23_0_0Instance->loadRAMBundle(std::move(registry), std::move(scriptStr),
                                            sourceUrlStr.UTF8String, !async);
      }
    } else if (self->_ReactABI23_0_0Instance) {
      self->_ReactABI23_0_0Instance->loadScriptFromString(std::make_unique<NSDataBigString>(script),
                                                 sourceUrlStr.UTF8String, !async);
    } else {
                            ...
                            error:(NSError **)error
{
  if (!_ReactABI23_0_0Instance) {
    if (error) {
      *error = ABI23_0_0RCTErrorWithMessage(
  ...
  NSError *errorObj = tryAndReturnError(^{
    Value result = self->_ReactABI23_0_0Instance->callFunctionSync([module UTF8String], [method UTF8String], (id)arguments);
...
- (void)batchDidComplete
{
  // TODO #12592471: batchDidComplete is only used by ABI23_0_0RCTUIManager,
...
- (void)startProfiling
{
  ...
  [self ensureOnJavaScriptThread:^{
    #if WITH_FBSYSTRACE
    [ABI23_0_0RCTFBSystrace registerCallbacks];
    #endif
...
- (void)stopProfiling:(void (^)(NSData *))callback
{
  ...
  [self ensureOnJavaScriptThread:^{
    ...
    ABI23_0_0RCTProfileEnd(self, ^(NSString *log) {
      ...
      callback(logData);
      #if WITH_FBSYSTRACE
      [ABI23_0_0RCTFBSystrace unregisterCallbacks];
      #endif
    });
  }];
}
