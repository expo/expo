...
#import <cxxReactABI23_0_0/ABI23_0_0JSBigString.h>
#import <cxxReactABI23_0_0/ABI23_0_0JSExecutor.h>
#import <cxxReactABI23_0_0/ABI23_0_0MessageQueueThread.h>
#import <cxxReactABI23_0_0/ABI23_0_0ModuleRegistry.h>
#import <folly/json.h>
...
class ABI23_0_0RCTObjcExecutor : public JSExecutor {
public:
  ABI23_0_0RCTObjcExecutor(id<ABI23_0_0RCTJavaScriptExecutor> jse,
                  ABI23_0_0RCTJavaScriptCompleteBlock errorBlock,
  ...
  void setBundleRegistry(std::unique_ptr<RAMBundleRegistry>) override {
    ABI23_0_0RCTAssert(NO, @"RAM bundles are not supported in ABI23_0_0RCTObjcExecutor");
  }
...
private:
  ...
  ABI23_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI23_0_0RCTObjcExecutorFactory::ABI23_0_0RCTObjcExecutorFactory(
  id<ABI23_0_0RCTJavaScriptExecutor> jse, ABI23_0_0RCTJavaScriptCompleteBlock errorBlock)
  : m_jse(jse)
  , m_errorBlock(errorBlock) {}

std::unique_ptr<JSExecutor> ABI23_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue) {
  return std::unique_ptr<JSExecutor>(
    new ABI23_0_0RCTObjcExecutor(m_jse, m_errorBlock, jsQueue, delegate));
}
