...
@implementation ABI12_0_0RCTTextField
{
...
- (instancetype)initWithEventDispatcher:(ABI12_0_0RCTEventDispatcher *)eventDispatcher
{
  if ((self = [super initWithFrame:CGRectZero])) {
    ABI12_0_0RCTAssert(eventDispatcher, @"eventDispatcher is a required parameter");
...
static void ABI12_0_0RCTUpdatePlaceholder(ABI12_0_0RCTTextField *self)
{
...
- (void)setPlaceholderTextColor:(UIColor *)placeholderTextColor
{
  ...
  ABI12_0_0RCTUpdatePlaceholder(self);
}
...
{
  _nativeEventCount++;
  [_eventDispatcher sendTextEventWithType:ABI12_0_0RCTTextEventTypeChange
                                 ReactABI12_0_0Tag:self.ReactABI12_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (void)observeValueForKeyPath:(NSString *)keyPath
                      ofObject:(ABI12_0_0RCTTextField *)textField
