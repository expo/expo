...
#import "ABI12_0_0RCTLocalAssetImageLoader.h"

#import <libkern/OSAtomic.h>

#import "ABI12_0_0RCTUtils.h"

@implementation ABI12_0_0RCTLocalAssetImageLoader

ABI12_0_0RCT_EXPORT_MODULE()

- (BOOL)canLoadImageURL:(NSURL *)requestURL
{
  return ABI12_0_0RCTIsLocalAssetURL(requestURL);
}
                                  ...
                                  completionHandler:(ABI12_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  ABI12_0_0RCTExecuteOnMainQueue(^{
    ...
    NSString *imageName = ABI12_0_0RCTBundlePathForURL(imageURL);
    ...
    if (image) {
      ...
      completionHandler(ABI12_0_0RCTErrorWithMessage(message), nil);
    }
  });
