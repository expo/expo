...
typedef void (^ABI12_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI12_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI12_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI12_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI12_0_0RCTImageCache <NSObject>

- (UIImage *)imageForUrl:(NSString *)url
                    size:(CGSize)size
                   scale:(CGFloat)scale
              resizeMode:(ABI12_0_0RCTResizeMode)resizeMode
...
@interface UIImage (ReactABI12_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI12_0_0KeyframeAnimation;

@end

@interface ABI12_0_0RCTImageLoader : NSObject <ABI12_0_0RCTBridgeModule, ABI12_0_0RCTURLRequestHandler>
 ...
 */
- (ABI12_0_0RCTImageLoaderCancellationBlock)loadImageWithURLRequest:(NSURLRequest *)imageURLRequest
                                                  callback:(ABI12_0_0RCTImageLoaderCompletionBlock)callback;
...
- (ABI12_0_0RCTImageLoaderCancellationBlock)loadImageWithURLRequest:(NSURLRequest *)imageURLRequest
                                                ...
                                                resizeMode:(ABI12_0_0RCTResizeMode)resizeMode
                                             progressBlock:(ABI12_0_0RCTImageLoaderProgressBlock)progressBlock
                                          partialLoadBlock:(ABI12_0_0RCTImageLoaderPartialLoadBlock)partialLoadBlock
                                           completionBlock:(ABI12_0_0RCTImageLoaderCompletionBlock)completionBlock;
 ...
 */
- (ABI12_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                           clipped:(BOOL)clipped
                                        resizeMode:(ABI12_0_0RCTResizeMode)resizeMode
 ...
 */
- (ABI12_0_0RCTImageLoaderCancellationBlock)getImageSizeForURLRequest:(NSURLRequest *)imageURLRequest
                                                       block:(void(^)(NSError *error, CGSize size))completionBlock;

/**
 * Allows developers to set their own caching implementation for
 * decoded images as long as it conforms to the ABI12_0_0RCTImageCacheDelegate
 * protocol. This method should be called in bridgeDidInitializeModule.
 */
- (void)setImageCache:(id<ABI12_0_0RCTImageCache>)cache;

@end

@interface ABI12_0_0RCTBridge (ABI12_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI12_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI12_0_0RCTImageURLLoader <ABI12_0_0RCTBridgeModule>
 ...
 * applicable.
 */
- (ABI12_0_0RCTImageLoaderCancellationBlock)loadImageForURL:(NSURL *)imageURL
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                        resizeMode:(ABI12_0_0RCTResizeMode)resizeMode
                                   progressHandler:(ABI12_0_0RCTImageLoaderProgressBlock)progressHandler
                                partialLoadHandler:(ABI12_0_0RCTImageLoaderPartialLoadBlock)partialLoadHandler
                                 completionHandler:(ABI12_0_0RCTImageLoaderCompletionBlock)completionHandler;

@optional

/**
 * If more than one ABI12_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI12_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 */
@protocol ABI12_0_0RCTImageDataDecoder <ABI12_0_0RCTBridgeModule>
...
/**
 * If more than one ABI12_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
