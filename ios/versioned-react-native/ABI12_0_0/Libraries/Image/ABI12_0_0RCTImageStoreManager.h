...
@interface ABI12_0_0RCTImageStoreManager : NSObject <ABI12_0_0RCTURLRequestHandler>
...
@interface ABI12_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI12_0_0RCTBridge (ABI12_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI12_0_0RCTImageStoreManager *imageStoreManager;
