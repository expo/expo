...
@implementation ABI12_0_0RCTDiffClampAnimatedNode
{
...
{
  ABI12_0_0RCTValueAnimatedNode *inputNode = (ABI12_0_0RCTValueAnimatedNode *)self.parentNodes[_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI12_0_0RCTValueAnimatedNode class]]) {
    ABI12_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
