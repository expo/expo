...
@implementation ABI12_0_0RCTInterpolationAnimatedNode
{
  __weak ABI12_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI12_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI12_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI12_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI12_0_0RCTInterpolateValue(inputValue,
