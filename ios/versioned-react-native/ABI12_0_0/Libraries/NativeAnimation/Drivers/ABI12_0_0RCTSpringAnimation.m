...
@implementation ABI12_0_0RCTSpringAnimation
{
  ...
  ABI12_0_0RCTResponseSenderBlock _callback;
                  ...
                  callBack:(nullable ABI12_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _toValue = [ABI12_0_0RCTConvert CGFloat:config[@"toValue"]];
    _fromValue = valueNode.value;
    _valueNode = valueNode;
    _overshootClamping = [ABI12_0_0RCTConvert BOOL:config[@"overshootClamping"]];
    _restDisplacementThreshold = [ABI12_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
    _restSpeedThreshold = [ABI12_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
    _tension = [ABI12_0_0RCTConvert CGFloat:config[@"tension"]];
    _friction = [ABI12_0_0RCTConvert CGFloat:config[@"friction"]];
