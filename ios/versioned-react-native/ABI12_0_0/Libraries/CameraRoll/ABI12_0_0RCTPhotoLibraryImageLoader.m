...
#import "ABI12_0_0RCTPhotoLibraryImageLoader.h"
...
@implementation ABI12_0_0RCTPhotoLibraryImageLoader

ABI12_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI12_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI12_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI12_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI12_0_0RCTResizeModeContain) {
