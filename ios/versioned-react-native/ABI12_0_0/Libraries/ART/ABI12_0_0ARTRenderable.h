...
@interface ABI12_0_0ARTRenderable : ABI12_0_0ARTNode

@property (nonatomic, strong) ABI12_0_0ARTBrush *fill;
...
@property (nonatomic, assign) ABI12_0_0ARTCGFloatArray strokeDash;
