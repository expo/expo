...
@implementation ABI12_0_0ARTText
...
static void ABI12_0_0ARTFreeTextFrame(ABI12_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI12_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI12_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI12_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI12_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
