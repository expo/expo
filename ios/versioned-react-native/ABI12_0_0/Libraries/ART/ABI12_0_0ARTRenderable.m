...
#import "ABI12_0_0ARTRenderable.h"

@implementation ABI12_0_0ARTRenderable

- (void)setFill:(ABI12_0_0ARTBrush *)fill
{
  [self invalidate];
  _fill = fill;
}
...
- (void)setStrokeDash:(ABI12_0_0ARTCGFloatArray)strokeDash
{
