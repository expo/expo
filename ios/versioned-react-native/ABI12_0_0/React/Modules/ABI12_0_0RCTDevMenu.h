 ...
 */
@interface ABI12_0_0RCTDevMenu : NSObject

/**
 * Is the menu enabled. The menu is enabled by default if ABI12_0_0RCT_DEV=1, but
 ...
 */
@interface ABI12_0_0RCTDevMenuItem : NSObject
 ...
 * ABI12_0_0RCTBridge, which is useful for any class that needs to access the menu.
 */
@interface ABI12_0_0RCTBridge (ABI12_0_0RCTDevMenu)

@property (nonatomic, readonly) ABI12_0_0RCTDevMenu *devMenu;
