...
@implementation ABI12_0_0RCTExceptionsManager
{
                  ...
                  exceptionId:(nonnull NSNumber *)exceptionId)
{
  ...
  if (!ABI12_0_0RCT_DEBUG && reloadRetries < _maxReloadAttempts) {
    reloadRetries++;
    [_bridge requestReload];
  } else {
    NSString *description = [@"Unhandled JS Exception: " stringByAppendingString:message];
    NSDictionary *errorInfo = @{ NSLocalizedDescriptionKey: description, ABI12_0_0RCTJSStackTraceKey: stack };
    ABI12_0_0RCTFatal([NSError errorWithDomain:ABI12_0_0RCTErrorDomain code:0 userInfo:errorInfo]);
  }
}
...
ABI12_0_0RCT_EXPORT_METHOD(reportUnhandledException:(NSString *)message
                  stack:(NSArray<NSDictionary *> *)stack)
{
