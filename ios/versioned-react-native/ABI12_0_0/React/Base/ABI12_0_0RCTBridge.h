...
#import "ABI12_0_0RCTBridgeDelegate.h"
...
@class ABI12_0_0RCTPerformanceLogger;

/**
 * This notification triggers a reload of all bridges currently running.
 * Deprecated, use ABI12_0_0RCTBridge::requestReload instead.
 */
ABI12_0_0RCT_EXTERN NSString *const ABI12_0_0RCTReloadNotification DEPRECATED_ATTRIBUTE;

/**
 * This notification fires when the bridge starts loading the JS bundle.
 */
ABI12_0_0RCT_EXTERN NSString *const ABI12_0_0RCTJavaScriptWillStartLoadingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI12_0_0RCT_EXTERN NSString *const ABI12_0_0RCTJavaScriptDidLoadNotification;

/**
 * This notification fires when the bridge failed to load the JS bundle. The
 * `error` key can be used to determine the error that occured.
 */
ABI12_0_0RCT_EXTERN NSString *const ABI12_0_0RCTJavaScriptDidFailToLoadNotification;
 ...
 */
ABI12_0_0RCT_EXTERN NSString *const ABI12_0_0RCTDidInitializeModuleNotification;
 ...
 */
typedef NSArray<id<ABI12_0_0RCTBridgeModule>> *(^ABI12_0_0RCTBridgeModuleProviderBlock)(void);

/**
 * This function returns the module name for a given class.
 */
ABI12_0_0RCT_EXTERN NSString *ABI12_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI12_0_0RCTBridge : NSObject <ABI12_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI12_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI12_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 * See also -[ABI12_0_0RCTBridgeDelgate shouldBridgeLoadJavaScriptSynchronously], which
 ...
 */
@property (nonatomic, weak, readonly) id<ABI12_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ReactABI12_0_0 Native perf events.
 */
@property (nonatomic, readonly, strong) ABI12_0_0RCTPerformanceLogger *performanceLogger;
