...
@interface ABI12_0_0RCTModuleData : NSObject <ABI12_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI12_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI12_0_0RCTBridgeModule> instance;
