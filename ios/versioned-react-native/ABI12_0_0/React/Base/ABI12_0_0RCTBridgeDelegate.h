...
@protocol ABI12_0_0RCTBridgeModule;

@protocol ABI12_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI12_0_0RCTBridge *)bridge;
 ...
 */
- (NSURL *)fallbackSourceURLForBridge:(ABI12_0_0RCTBridge *)bridge;

/**
 * The bridge initializes any registered ABI12_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI12_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI12_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (NSArray<Class> *)whitelistedModulesForBridge:(ABI12_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeLoadJavaScriptSynchronously:(ABI12_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeInitializeNativeModulesSynchronously:(ABI12_0_0RCTBridge *)bridge;
 ...
 */
- (void)loadSourceForBridge:(ABI12_0_0RCTBridge *)bridge
                 onProgress:(ABI12_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI12_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI12_0_0RCTBridge *)bridge
                  withBlock:(ABI12_0_0RCTSourceLoadBlock)loadCallback;
