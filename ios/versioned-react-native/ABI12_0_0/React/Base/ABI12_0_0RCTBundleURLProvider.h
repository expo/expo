...
extern NSString *const ABI12_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI12_0_0RCTBundleURLProviderDefaultPort;

@interface ABI12_0_0RCTBundleURLProvider : NSObject
