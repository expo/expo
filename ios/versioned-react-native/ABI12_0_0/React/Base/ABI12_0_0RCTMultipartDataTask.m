...
@interface ABI12_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI12_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI12_0_0RCTMultipartDataTaskCallback _partHandler;
...
- (instancetype)initWithURL:(NSURL *)url partHandler:(ABI12_0_0RCTMultipartDataTaskCallback)partHandler
{
  if (self = [super init]) {
    _url = url;
...
{
  ABI12_0_0RCTMultipartStreamReader *reader = [[ABI12_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI12_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
