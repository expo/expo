...
@interface ABI12_0_0RCTImageSource ()

@property (nonatomic, assign) BOOL packagerAsset;

@end

@implementation ABI12_0_0RCTImageSource
...
{
  ABI12_0_0RCTImageSource *imageSource = [[ABI12_0_0RCTImageSource alloc] initWithURLRequest:_request
                                                                      size:size
                                                                     scale:scale];
...
- (BOOL)isEqual:(ABI12_0_0RCTImageSource *)object
{
  if (![object isKindOfClass:[ABI12_0_0RCTImageSource class]]) {
    return NO;
  }
...
{
  return [NSString stringWithFormat:@"<ABI12_0_0RCTImageSource: %p URL=%@, size=%@, scale=%0.f>",
          self, _request.URL, NSStringFromCGSize(_size), _scale];
}

@end

@implementation ABI12_0_0RCTConvert (ImageSource)

+ (ABI12_0_0RCTImageSource *)ABI12_0_0RCTImageSource:(id)json
{
  if (!json) {
    return nil;
  }
  ...
  if ([json isKindOfClass:[NSDictionary class]]) {
    ...
    ABI12_0_0RCTLogConvertError(json, @"an image. Did you forget to call resolveAssetSource() on the JS side?");
    return nil;
  }

  ABI12_0_0RCTImageSource *imageSource = [[ABI12_0_0RCTImageSource alloc] initWithURLRequest:request
                                                                      size:size
                                                                     scale:scale];
...
ABI12_0_0RCT_ARRAY_CONVERTER(ABI12_0_0RCTImageSource)
