 ...
 */
@interface ABI12_0_0RCTImageSource : NSObject
...
@interface ABI12_0_0RCTConvert (ImageSource)

+ (ABI12_0_0RCTImageSource *)ABI12_0_0RCTImageSource:(id)json;
+ (NSArray<ABI12_0_0RCTImageSource *> *)ABI12_0_0RCTImageSourceArray:(id)json;
