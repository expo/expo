...
@implementation ABI12_0_0RCTConvert(MapKit)
...
ABI12_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
{
  json = [self NSDictionary:json];
  ABI12_0_0RCTMapAnnotation *annotation = [ABI12_0_0RCTMapAnnotation new];
...
ABI12_0_0RCT_ARRAY_CONVERTER(ABI12_0_0RCTMapAnnotation)
...
+ (ABI12_0_0RCTMapOverlay *)ABI12_0_0RCTMapOverlay:(id)json
{
  ...
  ABI12_0_0RCTMapOverlay *overlay = [ABI12_0_0RCTMapOverlay polylineWithCoordinates:coordinates
...
ABI12_0_0RCT_ARRAY_CONVERTER(ABI12_0_0RCTMapOverlay)
