...
@interface ABI12_0_0RCTTabBar() <UITabBarControllerDelegate>

@end

@implementation ABI12_0_0RCTTabBar
{
  BOOL _tabsChanged;
...
- (void)insertReactABI12_0_0Subview:(ABI12_0_0RCTTabBarItem *)subview atIndex:(NSInteger)atIndex
{
  if (![subview isKindOfClass:[ABI12_0_0RCTTabBarItem class]]) {
    ABI12_0_0RCTLogError(@"subview should be of type ABI12_0_0RCTTabBarItem");
    return;
  }
...
- (void)removeReactABI12_0_0Subview:(ABI12_0_0RCTTabBarItem *)subview
{
  if (self.ReactABI12_0_0Subviews.count == 0) {
    ABI12_0_0RCTLogError(@"should have at least one view to remove a subview");
    return;
  }
...
- (void)layoutSubviews
{
  ...
  [self ReactABI12_0_0AddControllerToClosestParent:_tabController];
...
- (void)ReactABI12_0_0BridgeDidFinishTransaction
{
  ...
  if (_tabsChanged) {
    ...
    for (ABI12_0_0RCTTabBarItem *tab in [self ReactABI12_0_0Subviews]) {
      UIViewController *controller = tab.ReactABI12_0_0ViewController;
      if (!controller) {
        controller = [[ABI12_0_0RCTWrapperViewController alloc] initWithContentView:tab];
      }
  ...
  [self.ReactABI12_0_0Subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger index, __unused BOOL *stop) {

    ABI12_0_0RCTTabBarItem *tab = (ABI12_0_0RCTTabBarItem *)view;
...
- (BOOL)tabBarController:(UITabBarController *)tabBarController shouldSelectViewController:(UIViewController *)viewController
{
  ...
  ABI12_0_0RCTTabBarItem *tab = (ABI12_0_0RCTTabBarItem *)self.ReactABI12_0_0Subviews[index];
