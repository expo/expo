...
@implementation ABI12_0_0RCTModalHostViewController
{
...
- (UIInterfaceOrientationMask)supportedInterfaceOrientations
{
  ...
  if (!(_supportedInterfaceOrientations & appSupportedOrientationsMask)) {
    ABI12_0_0RCTLogError(@"Modal was presented with 0x%x orientations mask but the application only supports 0x%x."
