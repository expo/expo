...
@implementation ABI12_0_0RCTConvert (UITabBarSystemItem)

ABI12_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI12_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI12_0_0ViewController;
}
