...
// These constants can only be removed when ReactABI12_0_0 Native drops iOS8 support.
...
typedef CGFloat ABI12_0_0RCTFontWeight;
static ABI12_0_0RCTFontWeight weightOfFont(UIFont *font)
{
  ...
  ABI12_0_0RCTFontWeight weight = [traits[UIFontWeightTrait] doubleValue];
  if (weight == 0.0) {
...
static UIFont *cachedSystemFont(CGFloat size, ABI12_0_0RCTFontWeight weight)
{
...
@implementation ABI12_0_0RCTConvert (ABI12_0_0RCTFont)

+ (UIFont *)UIFont:(id)json
{
  json = [self NSDictionary:json];
  return [ABI12_0_0RCTFont updateFont:nil
                  withFamily:[ABI12_0_0RCTConvert NSString:json[@"fontFamily"]]
                        size:[ABI12_0_0RCTConvert NSNumber:json[@"fontSize"]]
                      weight:[ABI12_0_0RCTConvert NSString:json[@"fontWeight"]]
                       style:[ABI12_0_0RCTConvert NSString:json[@"fontStyle"]]
                     variant:[ABI12_0_0RCTConvert NSStringArray:json[@"fontVariant"]]
             scaleMultiplier:1];
}

ABI12_0_0RCT_ENUM_CONVERTER(ABI12_0_0RCTFontWeight, (@{
                                     @"normal": @(UIFontWeightRegular),
                                     @"bold": @(UIFontWeightBold),
...
typedef BOOL ABI12_0_0RCTFontStyle;
ABI12_0_0RCT_ENUM_CONVERTER(ABI12_0_0RCTFontStyle, (@{
                                    @"normal": @NO,
                                    @"italic": @YES,
                                    @"oblique": @YES,
                                    }), NO, boolValue)

typedef NSDictionary ABI12_0_0RCTFontVariantDescriptor;
+ (ABI12_0_0RCTFontVariantDescriptor *)ABI12_0_0RCTFontVariantDescriptor:(id)json
{
  ...
  ABI12_0_0RCTFontVariantDescriptor *value = mapping[json];
  if (ABI12_0_0RCT_DEBUG && !value && [json description].length > 0) {
    ABI12_0_0RCTLogError(@"Invalid ABI12_0_0RCTFontVariantDescriptor '%@'. should be one of: %@", json,
                [[mapping allKeys] sortedArrayUsingSelector:@selector(caseInsensitiveCompare:)]);
  }
  return value;
}

ABI12_0_0RCT_ARRAY_CONVERTER(ABI12_0_0RCTFontVariantDescriptor)

@end

@implementation ABI12_0_0RCTFont
...
+ (UIFont *)updateFont:(UIFont *)font
            withFamily:(NSString *)family
               ...
               variant:(NSArray<ABI12_0_0RCTFontVariantDescriptor *> *)variant
       scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  const ABI12_0_0RCTFontWeight defaultFontWeight = UIFontWeightRegular;
  const CGFloat defaultFontSize = 14;

  // Initialize properties to defaults
  CGFloat fontSize = defaultFontSize;
  ABI12_0_0RCTFontWeight fontWeight = defaultFontWeight;
  ...
  // Get font attributes
  fontSize = [ABI12_0_0RCTConvert CGFloat:size] ?: fontSize;
  if (scaleMultiplier > 0.0 && scaleMultiplier != 1.0) {
    fontSize = round(fontSize * scaleMultiplier);
  }
  familyName = [ABI12_0_0RCTConvert NSString:family] ?: familyName;
  isItalic = style ? [ABI12_0_0RCTConvert ABI12_0_0RCTFontStyle:style] : isItalic;
  fontWeight = weight ? [ABI12_0_0RCTConvert ABI12_0_0RCTFontWeight:weight] : fontWeight;
  ...
  if (!didFindFont && [UIFont fontNamesForFamilyName:familyName].count == 0) {
    ...
    if (font) {
      ...
      ABI12_0_0RCTLogError(@"Unrecognized font family '%@'", familyName);
      if ([UIFont respondsToSelector:@selector(systemFontOfSize:weight:)]) {
  ...
  if (variant) {
    NSArray *fontFeatures = [ABI12_0_0RCTConvert ABI12_0_0RCTFontVariantDescriptorArray:variant];
