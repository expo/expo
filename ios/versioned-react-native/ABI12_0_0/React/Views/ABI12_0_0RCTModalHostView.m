...
@implementation ABI12_0_0RCTModalHostView
{
  __weak ABI12_0_0RCTBridge *_bridge;
  BOOL _isPresented;
  ABI12_0_0RCTModalHostViewController *_modalViewController;
  ABI12_0_0RCTTouchHandler *_touchHandler;
  UIView *_ReactABI12_0_0Subview;
#if !TARGET_OS_TV
...
ABI12_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithCoder:coder)

- (instancetype)initWithBridge:(ABI12_0_0RCTBridge *)bridge
{
  if ((self = [super initWithFrame:CGRectZero])) {
    _bridge = bridge;
    _modalViewController = [ABI12_0_0RCTModalHostViewController new];
    UIView *containerView = [UIView new];
    containerView.autoresizingMask = UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
    _modalViewController.view = containerView;
    _touchHandler = [[ABI12_0_0RCTTouchHandler alloc] initWithBridge:bridge];
    _isPresented = NO;
...
{
  if (_ReactABI12_0_0Subview && _isPresented) {
    [_bridge.uiManager setFrame:newBounds forView:_ReactABI12_0_0Subview];
...
{
  ABI12_0_0RCTAssert(_ReactABI12_0_0Subview == nil, @"Modal view can only have one subview");
  ...
  _ReactABI12_0_0Subview = subview;
}

- (void)removeReactABI12_0_0Subview:(UIView *)subview
{
  ABI12_0_0RCTAssert(subview == _ReactABI12_0_0Subview, @"Cannot remove view other than modal view");
  [super removeReactABI12_0_0Subview:subview];
  [subview removeGestureRecognizer:_touchHandler];
  _ReactABI12_0_0Subview = nil;
}

- (void)didUpdateReactABI12_0_0Subviews
{
  // Do nothing, as subview (singular) is managed by `insertReactABI12_0_0Subview:atIndex:`
}
...
- (void)didMoveToWindow
{
  ...
  if (!_isPresented && self.window) {
    ABI12_0_0RCTAssert(self.ReactABI12_0_0ViewController, @"Can't present modal view controller without a presenting view controller");
