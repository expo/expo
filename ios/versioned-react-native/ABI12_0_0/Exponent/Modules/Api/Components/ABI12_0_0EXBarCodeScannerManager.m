...
@implementation ABI12_0_0EXBarCodeScannerManager

ABI12_0_0RCT_EXPORT_MODULE(ExponentBarCodeScannerManager);
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(onBarCodeRead, ABI12_0_0RCTDirectEventBlock);
...
- (UIView *)view
{
  ...
  if (!self.camera) {
    self.camera = [[ABI12_0_0EXBarCodeScanner alloc] initWithManager:self bridge:self.bridge];
  }
  return self.camera;
}
...
- (NSDictionary *)constantsToExport
{
  return @{
    ...
    @"Type" :
        @{@"front" : @(ABI12_0_0EXBarCodeScannerTypeFront), @"back" : @(ABI12_0_0EXBarCodeScannerTypeBack)},
    @"TorchMode" : @{
      @"off" : @(ABI12_0_0EXBarCodeScannerTorchModeOff),
      @"on" : @(ABI12_0_0EXBarCodeScannerTorchModeOn),
      @"auto" : @(ABI12_0_0EXBarCodeScannerTorchModeAuto)
    }
  };
}

ABI12_0_0RCT_CUSTOM_VIEW_PROPERTY(type, NSInteger, ABI12_0_0EXBarCodeScanner)
{
  NSInteger type = [ABI12_0_0RCTConvert NSInteger:json];
...
ABI12_0_0RCT_CUSTOM_VIEW_PROPERTY(torchMode, NSInteger, ABI12_0_0EXBarCodeScanner)
{
  dispatch_async(self.sessionQueue, ^{
    NSInteger torchMode = [ABI12_0_0RCTConvert NSInteger:json];
...
ABI12_0_0RCT_CUSTOM_VIEW_PROPERTY(barCodeTypes, NSArray, ABI12_0_0EXBarCodeScanner)
{
  self.barCodeTypes = [ABI12_0_0RCTConvert NSArray:json];
}
...
- (void)startSession
{
  ...
  dispatch_async(self.sessionQueue, ^{
    ...
    __weak ABI12_0_0EXBarCodeScannerManager *weakSelf = self;
              ...
              [NSNotificationCenter.defaultCenter
                  addObserverForName:AVCaptureSessionRuntimeErrorNotification
                          ...
                          usingBlock:^(NSNotification *note) {
                            ABI12_0_0EXBarCodeScannerManager *strongSelf = weakSelf;
