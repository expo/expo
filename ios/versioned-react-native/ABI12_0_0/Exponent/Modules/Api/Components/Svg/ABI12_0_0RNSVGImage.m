...
@implementation ABI12_0_0RNSVGImage
{
    CGImageRef _image;
    CGFloat _imageRatio;
}
...
- (void)setSrc:(id)src
{
    ...
    ABI12_0_0RCTImageSource *source = [ABI12_0_0RCTConvert ABI12_0_0RCTImageSource:src];
    _imageRatio = source.size.width / source.size.height;
    _image = CGImageRetain([ABI12_0_0RCTConvert CGImage:src]);
    [self invalidate];
}
...
- (void)setMeetOrSlice:(ABI12_0_0RNSVGVBMOS)meetOrSlice
{
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    ABI12_0_0RNSVGViewBox *viewBox = [[ABI12_0_0RNSVGViewBox alloc] init];
