...
#import "ABI12_0_0RNSVGBaseBrush.h"
#import "ABI12_0_0RCTConvert+RNSVG.h"
#import "ABI12_0_0RCTLog.h"

@implementation ABI12_0_0RNSVGBaseBrush

- (instancetype)initWithArray:(NSArray *)array
{
    if ((self = [super initWithArray:array])) {
        if (array.count != 2) {
            ABI12_0_0RCTLogError(@"-[%@ %@] expects 2 elements, received %@",
...
- (void)paint:(CGContextRef)context opacity:(CGFloat)opacity brushConverter:(ABI12_0_0RNSVGBrushConverter *)brushConverter
{
    ...
    if (brushConverter.type == kABI12_0_0RNSVGLinearGradient) {
        [brushConverter drawLinearGradient:context];
    } else if (brushConverter.type == kABI12_0_0RNSVGRadialGradient) {
        [brushConverter drawRidialGradient:context];
    } else if (brushConverter.type == kABI12_0_0RNSVGPattern) {
        // todo:
    }
