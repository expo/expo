...
@implementation ABI12_0_0RNSVGRadialGradient
...
- (void)saveDefinition
{
    ABI12_0_0RNSVGBrushConverter *converter = [[ABI12_0_0RNSVGBrushConverter alloc] init];
    converter.colors = self.gradient;
    converter.points = @[self.fx, self.fy, self.rx, self.ry, self.cx, self.cy];
    converter.type = kABI12_0_0RNSVGRadialGradient;
