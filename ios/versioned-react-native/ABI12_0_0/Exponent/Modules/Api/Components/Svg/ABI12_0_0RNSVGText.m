...
@implementation ABI12_0_0RNSVGText

static void ABI12_0_0RNSVGFreeTextFrame(ABI12_0_0RNSVGTextFrame frame)
{
    if (frame.count) {
...
- (void)setTextFrame:(ABI12_0_0RNSVGTextFrame)textFrame
{
    ABI12_0_0RNSVGFreeTextFrame(_textFrame);
    [self invalidate];
...
- (CGPathRef)getPath:(CGContextRef)context
{
    ...
    ABI12_0_0RNSVGTextFrame frame = self.textFrame;
    for (int i = 0; i < frame.count; i++) {
        CGFloat shift;
...
- (CGMutablePathRef)setLinePath:(CTLineRef)line
{
    ...
    ABI12_0_0RNSVGBezierPath *bezierPath = [[ABI12_0_0RNSVGBezierPath alloc] initWithBezierCurves:self.path];
