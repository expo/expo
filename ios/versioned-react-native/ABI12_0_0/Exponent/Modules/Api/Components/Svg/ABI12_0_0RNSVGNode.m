...
@implementation ABI12_0_0RNSVGNode
{
    BOOL _transparent;
}
...
- (void)invalidate
{
    id<ABI12_0_0RNSVGContainer> container = (id<ABI12_0_0RNSVGContainer>)self.superview;
...
- (void)clip:(CGContextRef)context
{
    ...
    if (clipPath) {
        ...
        if (self.clipRule == kABI12_0_0RNSVGCGFCRuleEvenodd) {
...
- (ABI12_0_0RNSVGSvgView *)getSvgView
{
    UIView *parent = self.superview;
    while (parent && [parent class] != [ABI12_0_0RNSVGSvgView class]) {
        parent = parent.superview;
    }

    return (ABI12_0_0RNSVGSvgView *)parent;
}

- (void)saveDefinition
{
    if (self.name) {
        ABI12_0_0RNSVGSvgView* svg = [self getSvgView];
        [svg defineTemplate:self templateRef:self.name];
    }
}

- (void)mergeProperties:(__kindof ABI12_0_0RNSVGNode *)target mergeList:(NSArray<NSString *> *)mergeList
{
    // abstract
}

- (void)mergeProperties:(__kindof ABI12_0_0RNSVGNode *)target mergeList:(NSArray<NSString *> *)mergeList inherited:(BOOL)inherited
{
    // abstract
}
