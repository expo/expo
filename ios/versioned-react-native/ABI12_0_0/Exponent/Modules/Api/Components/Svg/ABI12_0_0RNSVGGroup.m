...
@implementation ABI12_0_0RNSVGGroup
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    [self traverseSubviews:^(ABI12_0_0RNSVGNode *node) {
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event withTransform:(CGAffineTransform)transform
{
    ...
    for (ABI12_0_0RNSVGNode *node in [self.subviews reverseObjectEnumerator]) {
...
- (void)traverseSubviews:(BOOL (^)(ABI12_0_0RNSVGNode *node))block
{
