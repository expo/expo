...
@interface ABI12_0_0RNSVGRenderable : ABI12_0_0RNSVGNode

@property (nonatomic, strong) ABI12_0_0RNSVGBrush *fill;
@property (nonatomic, assign) CGFloat fillOpacity;
@property (nonatomic, assign) ABI12_0_0RNSVGCGFCRule fillRule;
@property (nonatomic, strong) ABI12_0_0RNSVGBrush *stroke;
...
@property (nonatomic, assign) ABI12_0_0RNSVGCGFloatArray strokeDasharray;
