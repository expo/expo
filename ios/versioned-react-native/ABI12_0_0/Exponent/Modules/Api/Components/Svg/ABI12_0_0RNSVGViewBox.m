...
@implementation ABI12_0_0RNSVGViewBox
{
    BOOL _fromSymbol;
}
...
- (CGAffineTransform)getTransform
{
    ...
    ABI12_0_0RNSVGVBMOS meetOrSlice = self.meetOrSlice;
    ...
    // If align is 'none'
    if (meetOrSlice == kABI12_0_0RNSVGVBMOSNone) {
        ...
        if (![align isEqualToString: @"none"] && meetOrSlice == kABI12_0_0RNSVGVBMOSMeet) {
            scaleX = scaleY = fmin(scaleX, scaleY);
        } else if (![align isEqualToString: @"none"] && meetOrSlice == kABI12_0_0RNSVGVBMOSSlice) {
...
{
    if ([target isKindOfClass:[ABI12_0_0RNSVGUse class]]) {
        ABI12_0_0RNSVGUse *use = target;
        _fromSymbol = YES;
