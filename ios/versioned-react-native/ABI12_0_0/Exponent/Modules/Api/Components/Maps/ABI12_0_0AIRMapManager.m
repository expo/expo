...
#import "ABI12_0_0AIRMapManager.h"
...
#import "ABI12_0_0AIRMapSnapshot.h"
...
@interface ABI12_0_0AIRMapManager() <MKMapViewDelegate>

@end

@implementation ABI12_0_0AIRMapManager

ABI12_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI12_0_0AIRMap *map = [ABI12_0_0AIRMap new];
    map.delegate = self;
...
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(showsPointsOfInterest, BOOL)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(showsTraffic, BOOL)
...
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(cacheEnabled, BOOL)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
...
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(onPanDrag, ABI12_0_0RCTBubblingEventBlock)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(onPress, ABI12_0_0RCTBubblingEventBlock)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(onLongPress, ABI12_0_0RCTBubblingEventBlock)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerPress, ABI12_0_0RCTDirectEventBlock)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI12_0_0RCTDirectEventBlock)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI12_0_0RCTDirectEventBlock)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI12_0_0RCTDirectEventBlock)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI12_0_0RCTDirectEventBlock)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI12_0_0RCTDirectEventBlock)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(onCalloutPress, ABI12_0_0RCTDirectEventBlock)
ABI12_0_0RCT_EXPORT_VIEW_PROPERTY(initialRegion, MKCoordinateRegion)

ABI12_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI12_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setRegion:[ABI12_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
...
ABI12_0_0RCT_EXPORT_METHOD(animateToRegion:(nonnull NSNumber *)ReactABI12_0_0Tag
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI12_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI12_0_0AIRMap class]]) {
            ABI12_0_0RCTLogError(@"Invalid view returned from registry, expecting ABI12_0_0AIRMap, got: %@", view);
        } else {
            [ABI12_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI12_0_0AIRMap *)view setRegion:region animated:YES];
            }];
        }
    }];
}

ABI12_0_0RCT_EXPORT_METHOD(animateToCoordinate:(nonnull NSNumber *)ReactABI12_0_0Tag
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI12_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI12_0_0AIRMap class]]) {
            ...
            ABI12_0_0AIRMap *mapView = (ABI12_0_0AIRMap *)view;
...
ABI12_0_0RCT_EXPORT_METHOD(fitToElements:(nonnull NSNumber *)ReactABI12_0_0Tag
...
ABI12_0_0RCT_EXPORT_METHOD(fitToSuppliedMarkers:(nonnull NSNumber *)ReactABI12_0_0Tag
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI12_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI12_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ABI12_0_0AIRMapMarker *marker = (ABI12_0_0AIRMapMarker *)evaluatedObject;
                return [marker isKindOfClass:[ABI12_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
...
ABI12_0_0RCT_EXPORT_METHOD(fitToCoordinates:(nonnull NSNumber *)ReactABI12_0_0Tag
                  coordinates:(nonnull NSArray<ABI12_0_0AIRMapCoordinate *> *)coordinates
                  ...
                  animated:(BOOL)animated)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI12_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI12_0_0AIRMap class]]) {
            ...
            // Set Map viewport
            CGFloat top = [ABI12_0_0RCTConvert CGFloat:edgePadding[@"top"]];
            CGFloat right = [ABI12_0_0RCTConvert CGFloat:edgePadding[@"right"]];
            CGFloat bottom = [ABI12_0_0RCTConvert CGFloat:edgePadding[@"bottom"]];
            CGFloat left = [ABI12_0_0RCTConvert CGFloat:edgePadding[@"left"]];
...
ABI12_0_0RCT_EXPORT_METHOD(takeSnapshot:(nonnull NSNumber *)ReactABI12_0_0Tag
...
- (void)takeMapSnapshot:(ABI12_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI12_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI12_0_0AIRMap *map = (ABI12_0_0AIRMap *)recognizer.view;
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI12_0_0AIRMapPolyline class]]) {
        return ((ABI12_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI12_0_0AIRMapPolygon class]]) {
        return ((ABI12_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI12_0_0AIRMapCircle class]]) {
        return ((ABI12_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI12_0_0AIRMapUrlTile class]]) {
        return ((ABI12_0_0AIRMapUrlTile *)overlay).renderer;
    } else {
        return nil;
    }
}
...
- (void)mapView:(ABI12_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI12_0_0AIRMapMarker class]]) {
        [(ABI12_0_0AIRMapMarker *)view.annotation showCalloutView];
    }
}

- (void)mapView:(ABI12_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI12_0_0AIRMapMarker class]]) {
        [(ABI12_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI12_0_0AIRMap *)mapView viewForAnnotation:(ABI12_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI12_0_0AIRMapMarker class]]) {
        return nil;
    }
...
- (void)mapView:(ABI12_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI12_0_0AIRMapMarker class]]) return;
    ABI12_0_0AIRMapMarker *marker = (ABI12_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI12_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI12_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI12_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI12_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI12_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    [self _regionChanged:mapView];

    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI12_0_0AIRMapRegionChangeObserveInterval
                                                               target:self
...
- (void)mapView:(ABI12_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI12_0_0AIRMap *)mapView
{
...
- (void)mapViewDidFinishRenderingMap:(ABI12_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
- (void)_regionChanged:(ABI12_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI12_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI12_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI12_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
