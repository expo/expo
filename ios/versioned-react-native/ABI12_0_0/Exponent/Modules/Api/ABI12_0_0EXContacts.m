...
#import "ABI12_0_0EXContacts.h"

@import AddressBook;

@interface ABI12_0_0EXContacts ()

@property (nonatomic, assign) ABAddressBookRef addressBookRef;

@end

@implementation ABI12_0_0EXContacts

ABI12_0_0RCT_EXPORT_MODULE(ExponentContacts);
 ...
 */
ABI12_0_0RCT_EXPORT_METHOD(getContactsAsync:(NSArray *)fields resolver:(ABI12_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI12_0_0RCTPromiseRejectBlock)reject)
{
...
- (void)_getContactsWithPermissionGrantedAsync:(NSArray *)fields addressBook:(ABAddressBookRef)addressBook resolver:(ABI12_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI12_0_0RCTPromiseRejectBlock)reject
{
