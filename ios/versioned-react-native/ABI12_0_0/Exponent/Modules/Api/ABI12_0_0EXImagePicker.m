#import "ABI12_0_0EXImagePicker.h"
...
@interface ABI12_0_0EXImagePicker ()
...
@implementation ABI12_0_0EXImagePicker

ABI12_0_0RCT_EXPORT_MODULE(ExponentImagePicker);
...
ABI12_0_0RCT_EXPORT_METHOD(launchCameraAsync:(NSDictionary *)options
...
ABI12_0_0RCT_EXPORT_METHOD(launchImageLibraryAsync:(NSDictionary *)options
                  resolver:(ABI12_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI12_0_0RCTPromiseRejectBlock)reject)
{
    self.resolve = resolve;
...
- (void)launchImagePicker:(RNImagePickerTarget)target
{
    ...
    if (target == RNImagePickerTargetCamera) {
        ...
        self.reject(ABI12_0_0RCTErrorUnspecified, @"Camera not available on simulator", nil);
        return;
#else
        ...
        if ([self.options objectForKey:@"storageOptions"] && [[self.options objectForKey:@"storageOptions"] isKindOfClass:[NSDictionary class]]) {
            ...
            if ([storageOptions objectForKey:@"path"]) {
                ...
                if (error) {
                    ...
                    self.reject(ABI12_0_0RCTErrorUnspecified, error.localizedFailureReason, error);
                    return;
                }
                else {
