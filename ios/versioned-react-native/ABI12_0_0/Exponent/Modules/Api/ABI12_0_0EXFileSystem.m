...
@implementation NSData (ABI12_0_0EXFileSystem)
...
@interface ABI12_0_0EXFileSystem ()
...
@implementation ABI12_0_0EXFileSystem
...
{
  if (self = [super init]) {
    NSString *subdir = [ABI12_0_0EXVersionManager escapedResourceName:experienceId];
...
ABI12_0_0RCT_REMAP_METHOD(downloadAsync,
...
ABI12_0_0RCT_REMAP_METHOD(getInfoAsync,
...
ABI12_0_0RCT_REMAP_METHOD(deleteAsync,
...
- (NSString *)scopedPathWithPath:(NSString *)path withOptions:(NSDictionary *)options
{
  ...
  if (![ABI12_0_0EXFileSystem ensureDirExistsWithPath:prefix]) {
    return nil;
  }
