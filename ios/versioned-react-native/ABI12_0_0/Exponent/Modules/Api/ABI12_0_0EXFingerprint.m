...
#import "ABI12_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI12_0_0EXFingerprint

ABI12_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI12_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI12_0_0RCTPromiseResolveBlock)resolve
...
ABI12_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI12_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI12_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI12_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
