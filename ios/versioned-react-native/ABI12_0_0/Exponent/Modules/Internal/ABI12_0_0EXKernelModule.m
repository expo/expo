...
@interface ABI12_0_0EXKernelModule ()
...
@implementation ABI12_0_0EXKernelModule
...
- (void)sendEventWithName:(NSString *)eventName body:(id)body
{
  ...
  [self.bridge enqueueJSCall:@"ABI12_0_0RCTDeviceEventEmitter.emit"
...
ABI12_0_0RCT_EXPORT_METHOD(addDevMenu)
{
...
ABI12_0_0RCT_REMAP_METHOD(routeDidForeground,
...
ABI12_0_0RCT_REMAP_METHOD(onEventSuccess,
...
ABI12_0_0RCT_REMAP_METHOD(onEventFailure,
                 eventId:(NSString *)eventId
