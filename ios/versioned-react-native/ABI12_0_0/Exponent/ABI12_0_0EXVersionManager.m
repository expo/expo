...
#if ABI12_0_0RCT_DEV
  // key commands
  SEL ABI12_0_0RCTCommandsSelector = NSSelectorFromString(@"ABI12_0_0RCT_keyCommands");
  SEL ABI12_0_0RCTSendActionSelector = NSSelectorFromString(@"ABI12_0_0RCT_sendAction:to:from:forEvent:");
  if ([UIDevice currentDevice].systemVersion.floatValue < 9) {
    ABI12_0_0RCTSwapInstanceMethods([UIApplication class],
                           @selector(keyCommands),
                           ABI12_0_0RCTCommandsSelector);
    
    ABI12_0_0RCTSwapInstanceMethods([UIApplication class],
                           @selector(sendAction:to:from:forEvent:),
                           ABI12_0_0RCTSendActionSelector);
  } else {
    ABI12_0_0RCTSwapInstanceMethods([UIResponder class],
                           @selector(keyCommands),
                           ABI12_0_0RCTCommandsSelector);
  }
  
  // shake gesture
  SEL ABI12_0_0RCTMotionSelector = NSSelectorFromString(@"ABI12_0_0RCT_motionEnded:withEvent:");
  ABI12_0_0RCTSwapInstanceMethods([UIWindow class], @selector(motionEnded:withEvent:), ABI12_0_0RCTMotionSelector);
#endif
}
...
- (void)setSystemMethods
{
  ...
  SEL ABI12_0_0RCTCommandsSelector = NSSelectorFromString(@"ABI12_0_0RCT_keyCommands");
  if ([UIDevice currentDevice].systemVersion.floatValue < 9) {
    ABI12_0_0EXSetInstanceMethod([UIApplication class],
                           @selector(keyCommands),
                           ABI12_0_0RCTCommandsSelector);
    ...
    ABI12_0_0EXSetInstanceMethod([UIResponder class],
                           @selector(keyCommands),
                           ABI12_0_0RCTCommandsSelector);
  }
  ...
  // shake gesture
  SEL ABI12_0_0RCTMotionSelector = NSSelectorFromString(@"ABI12_0_0RCT_motionEnded:withEvent:");
  ABI12_0_0EXSetInstanceMethod([UIWindow class], @selector(motionEnded:withEvent:), ABI12_0_0RCTMotionSelector);
#endif
}
