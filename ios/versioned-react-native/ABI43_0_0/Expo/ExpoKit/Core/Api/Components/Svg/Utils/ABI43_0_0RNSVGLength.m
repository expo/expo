...
@implementation ABI43_0_0RNSVGLength
...
{
    ABI43_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype) lengthWithString: (NSString *) lengthString {
    ...
    ABI43_0_0RNSVGLength *output = [ABI43_0_0RNSVGLength alloc];
    if (stringLength == 0) {
        ...
        ABI43_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
