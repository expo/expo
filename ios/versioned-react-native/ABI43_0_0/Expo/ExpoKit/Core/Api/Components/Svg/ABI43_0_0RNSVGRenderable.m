...
#import "ABI43_0_0RNSVGVectorEffect.h"
#import "ABI43_0_0RNSVGBezierElement.h"
#import "ABI43_0_0RNSVGMarker.h"
#import "ABI43_0_0RNSVGMarkerPosition.h"

@implementation ABI43_0_0RNSVGRenderable
{
    NSMutableDictionary *_originProperties;
    NSArray<NSString *> *_lastMergedList;
    NSArray<NSString *> *_attributeList;
    NSArray<ABI43_0_0RNSVGLength *> *_sourceStrokeDashArray;
    CGFloat *_strokeDashArrayData;
    CGPathRef _srcHitPath;
}

static ABI43_0_0RNSVGRenderable * _contextElement;
+ (ABI43_0_0RNSVGRenderable *)contextElement { return _contextElement; }
+ (void)setContextElement:(ABI43_0_0RNSVGRenderable *)contextElement { _contextElement = contextElement; }
...
- (id)init
{
    if (self = [super init]) {
        _fillOpacity = 1;
        _strokeOpacity = 1;
        _strokeWidth = [ABI43_0_0RNSVGLength lengthWithNumber:1];
...
- (void)setFill:(ABI43_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI43_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI43_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)setStrokeWidth:(ABI43_0_0RNSVGLength*)strokeWidth
{
...
- (void)setStrokeDasharray:(NSArray<ABI43_0_0RNSVGLength *> *)strokeDasharray
{
...
- (void)setVectorEffect:(ABI43_0_0RNSVGVectorEffect)vectorEffect
{
...
UInt32 ABI43_0_0saturate(CGFloat value) {
...
- (void)renderTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    if (self.mask) {
        ...
        ABI43_0_0RNSVGMask *_maskNode = (ABI43_0_0RNSVGMask*)[self.svgView getDefinedMask:self.mask];
        ...
        for (NSUInteger i = 0; i < npixels; i++) {
            ...
            *currentPixel = ABI43_0_0saturate(luma) << 24;
            currentPixel++;
        }
...
- (void)prepareStrokeDash:(NSUInteger)count strokeDasharray:(NSArray<ABI43_0_0RNSVGLength *> *)strokeDasharray {
...
- (void)renderMarkers:(CGContextRef)context path:(CGPathRef)path rect:(const CGRect *)rect {
    ABI43_0_0RNSVGMarker *markerStart = (ABI43_0_0RNSVGMarker*)[self.svgView getDefinedMarker:self.markerStart];
    ABI43_0_0RNSVGMarker *markerMid = (ABI43_0_0RNSVGMarker*)[self.svgView getDefinedMarker:self.markerMid];
    ABI43_0_0RNSVGMarker *markerEnd = (ABI43_0_0RNSVGMarker*)[self.svgView getDefinedMarker:self.markerEnd];
    if (markerStart || markerMid || markerEnd) {
        _contextElement = self;
        NSArray<ABI43_0_0RNSVGMarkerPosition*>* positions = [ABI43_0_0RNSVGMarkerPosition fromCGPath:path];
        ...
        for (ABI43_0_0RNSVGMarkerPosition* position in positions) {
            ABI43_0_0RNSVGMarkerType type = [position type];
            ABI43_0_0RNSVGMarker *marker;
            switch (type) {
                case kStartMarker:
                    marker = markerStart;
                    break;
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    if (self.stroke) {
        ...
        NSArray<ABI43_0_0RNSVGLength *>* strokeDasharray = self.strokeDasharray;
...
- (ABI43_0_0RNSVGPlatformView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    BOOL canReceiveTouchEvents = (self.pointerEvents != ABI43_0_0RCTPointerEventsNone && ![self isHidden]);
    ...
    if (self.clipPath) {
        ABI43_0_0RNSVGClipPath *clipNode = (ABI43_0_0RNSVGClipPath*)[self.svgView getDefinedClipPath:self.clipPath];
        if ([clipNode isSimpleClipPath]) {
            ...
            ABI43_0_0RNSVGRenderable *clipGroup = (ABI43_0_0RNSVGRenderable*)clipNode;
...
- (void)mergeProperties:(__kindof ABI43_0_0RNSVGRenderable *)target
{
