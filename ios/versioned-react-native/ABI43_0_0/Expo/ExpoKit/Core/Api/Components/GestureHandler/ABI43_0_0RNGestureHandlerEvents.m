#import "ABI43_0_0RNGestureHandlerEvents.h"

#define SAFE_VELOCITY(velocity) @(isnan(velocity) ? 0 : velocity)

@implementation ABI43_0_0RNGestureHandlerEventExtraData
...
{
    return [[ABI43_0_0RNGestureHandlerEventExtraData alloc]
            initWithData:@{
                           @"x": @(position.x),
                           @"y": @(position.y),
...
@implementation ABI43_0_0RNGestureHandlerEvent
{
    NSNumber *_handlerTag;
    ABI43_0_0RNGestureHandlerState _state;
    ABI43_0_0RNGestureHandlerEventExtraData *_extraData;
}
...
@implementation ABI43_0_0RNGestureHandlerStateChange
{
    NSNumber *_handlerTag;
    ABI43_0_0RNGestureHandlerState _state;
    ABI43_0_0RNGestureHandlerState _prevState;
    ABI43_0_0RNGestureHandlerEventExtraData *_extraData;
}
