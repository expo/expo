...
#import "ABI43_0_0AIRMapLocalTileOverlay.h"

@implementation ABI43_0_0AIRMapLocalTile {
...
- (void) createTileOverlayAndRendererIfPossible
{
    ...
    self.tileOverlay = [[ABI43_0_0AIRMapLocalTileOverlay alloc] initWithURLTemplate:self.pathTemplate];
