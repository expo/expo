//
//  ABI43_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI43_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI43_0_0WMSTileOverlay *tile = [[ABI43_0_0WMSTileOverlay alloc] init];
...
@implementation ABI43_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
