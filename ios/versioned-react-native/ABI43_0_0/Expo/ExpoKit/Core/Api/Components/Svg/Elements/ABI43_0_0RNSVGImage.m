...
#if __has_include(<ABI43_0_0React/ABI43_0_0RCTImageLoader.h>)
...
@implementation ABI43_0_0RNSVGImage
{
    CGImageRef _image;
    CGSize _imageSize;
...
- (void)setSrc:(id)src
{
    ...
    _image = nil;
    ABI43_0_0RCTImageSource *source = [ABI43_0_0RCTConvert ABI43_0_0RCTImageSource:src];
    ...
    ABI43_0_0RCTImageLoaderCancellationBlock previousCancellationBlock = _reloadImageCancellationBlock;
    if (previousCancellationBlock) {
        previousCancellationBlock();
        _reloadImageCancellationBlock = nil;
    }

    _reloadImageCancellationBlock = [[self.bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI43_0_0RCTConvert NSURLRequest:src] callback:^(NSError *error, UIImage *image) {
...
- (void)setImagewidth:(ABI43_0_0RNSVGLength *)width
{
...
- (void)setImageheight:(ABI43_0_0RNSVGLength *)height
{
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    CGAffineTransform viewbox = [ABI43_0_0RNSVGViewBox getTransform:imageBounds eRect:hitArea align:self.align meetOrSlice:self.meetOrSlice];
