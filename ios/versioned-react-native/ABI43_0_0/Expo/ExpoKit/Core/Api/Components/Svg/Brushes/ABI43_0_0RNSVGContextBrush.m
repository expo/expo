...
@implementation ABI43_0_0RNSVGContextBrush
{
    BOOL _isStroke;
}
...
{
    ABI43_0_0RNSVGRenderable *element = ABI43_0_0RNSVGRenderable.contextElement;
    if (!element) {
        return NO;
    }

    ABI43_0_0RNSVGBrush *brush = _isStroke ? element.stroke : element.fill;

    BOOL fillColor;

    if (brush.class == ABI43_0_0RNSVGBrush.class) {
