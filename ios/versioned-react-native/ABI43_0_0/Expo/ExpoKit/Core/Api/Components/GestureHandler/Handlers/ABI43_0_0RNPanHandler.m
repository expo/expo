...
#import "ABI43_0_0RNPanHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

@interface ABI43_0_0RNBetterPanGestureRecognizer : UIPanGestureRecognizer
...
@implementation ABI43_0_0RNBetterPanGestureRecognizer {
...
@implementation ABI43_0_0RNPanGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI43_0_0RNBetterPanGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI43_0_0RNBetterPanGestureRecognizer *recognizer = (ABI43_0_0RNBetterPanGestureRecognizer *)_recognizer;
  ...
  if (@available(iOS 13.4, *)) {
    bool enableTrackpadTwoFingerGesture = [ABI43_0_0RCTConvert BOOL:config[@"enableTrackpadTwoFingerGesture"]];
  ...
  if (prop != nil) {
    CGFloat velocity = [ABI43_0_0RCTConvert CGFloat:prop];
    recognizer.minVelocitySq = velocity * velocity;
  }
  [recognizer updateHasCustomActivationCriteria];
}

- (ABI43_0_0RNGestureHandlerEventExtraData *)eventExtraData:(UIPanGestureRecognizer *)recognizer
{
