//
//  ABI43_0_0RCTConvert+GMSMapViewType.m
//
...
@implementation ABI43_0_0RCTConvert (GMSMapViewType)
  ABI43_0_0RCT_ENUM_CONVERTER(GMSMapViewType,
  (
    @{
...
+ (GMSCameraPosition*)GMSCameraPosition:(id)json
{
    ...
    return [ABI43_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:nil];
}
