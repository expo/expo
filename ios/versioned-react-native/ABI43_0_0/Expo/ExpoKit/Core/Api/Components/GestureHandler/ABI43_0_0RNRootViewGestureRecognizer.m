//
//  ABI43_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI43_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI43_0_0RNGestureHandler *otherHandler = [ABI43_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI43_0_0RCTTouchHandler class]];
}
