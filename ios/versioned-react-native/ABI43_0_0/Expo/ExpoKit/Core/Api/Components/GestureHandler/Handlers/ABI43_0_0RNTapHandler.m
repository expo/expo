...
#import "ABI43_0_0RNTapHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI43_0_0React/ABI43_0_0RCTConvert.h>

// ABI43_0_0RNBetterTapGestureRecognizer extends UIGestureRecognizer instead of UITapGestureRecognizer 
...
@interface ABI43_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
@implementation ABI43_0_0RNBetterTapGestureRecognizer {
...
@implementation ABI43_0_0RNTapGestureHandler {
    ABI43_0_0RNGestureHandlerEventExtraData * _lastData;
}

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI43_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI43_0_0RNBetterTapGestureRecognizer *recognizer = (ABI43_0_0RNBetterTapGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    recognizer.maxDelay = [ABI43_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDurationMs"];
  if (prop != nil) {
    recognizer.maxDuration = [ABI43_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDist"];
  if (prop != nil) {
    CGFloat dist = [ABI43_0_0RCTConvert CGFloat:prop];
