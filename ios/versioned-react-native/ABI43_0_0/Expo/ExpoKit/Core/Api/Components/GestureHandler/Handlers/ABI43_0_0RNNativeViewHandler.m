//
//  ABI43_0_0RNNativeViewHandler.m
...
#import "ABI43_0_0RNNativeViewHandler.h"
...
#pragma mark ABI43_0_0RNDummyGestureRecognizer

@implementation ABI43_0_0RNDummyGestureRecognizer
...
#pragma mark ABI43_0_0RNNativeViewgestureHandler

@implementation ABI43_0_0RNNativeViewGestureHandler {
...
- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI43_0_0RNDummyGestureRecognizer alloc] init];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    _shouldActivateOnStart = [ABI43_0_0RCTConvert BOOL:config[@"shouldActivateOnStart"]];
    _disallowInterruption = [ABI43_0_0RCTConvert BOOL:config[@"disallowInterruption"]];
}
...
- (void)bindToView:(UIView *)view
{
    ...
    // is set
    if ([view isKindOfClass:[ABI43_0_0RCTScrollView class]]) {
        // This part of the code is coupled with ABI43_0_0RN implementation of ScrollView native wrapper and
        // we expect for ABI43_0_0RCTScrollView component to contain a subclass of UIScrollview as the only
        // subview
...
- (void)handleTouchDown:(UIView *)sender forEvent:(UIEvent *)event
{
    ...
    [self sendEventsInState:ABI43_0_0RNGestureHandlerStateActive
             forViewWithTag:sender.ABI43_0_0ReactTag
              withExtraData:[ABI43_0_0RNGestureHandlerEventExtraData forPointerInside:YES]];
}

- (void)handleTouchUpOutside:(UIView *)sender forEvent:(UIEvent *)event
{
    [self sendEventsInState:ABI43_0_0RNGestureHandlerStateEnd
             forViewWithTag:sender.ABI43_0_0ReactTag
              withExtraData:[ABI43_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
...
{
    [self sendEventsInState:ABI43_0_0RNGestureHandlerStateCancelled
             forViewWithTag:sender.ABI43_0_0ReactTag
              withExtraData:[ABI43_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
