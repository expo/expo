...
@interface ABI43_0_0EXSecureStore (Protected)
...
@interface ABI43_0_0EXScopedSecureStore ()
...
@implementation ABI43_0_0EXScopedSecureStore
         ...
         withOptions:(NSDictionary *)options
{
  ...
  if (setValue) {
    ...
    ABI43_0_0EXLogWarn(@"Encountered an error while saving SecureStore data: %@.", [[super class] _messageForError:error]);
  }
}
