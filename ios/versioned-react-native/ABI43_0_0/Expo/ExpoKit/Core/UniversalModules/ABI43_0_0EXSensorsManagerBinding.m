...
@interface ABI43_0_0EXSensorsManagerBinding ()

@property (nonatomic, strong) NSString *scopeKey;
@property (nonatomic, weak) id<ABI43_0_0EXSensorsManagerBindingDelegate> kernelService;

@end

@implementation ABI43_0_0EXSensorsManagerBinding
