...
@interface ABI43_0_0EXServerRegistrationModule (Protected)
...
@interface ABI43_0_0EXScopedServerRegistrationModule ()

@property (nonatomic, strong) NSString *scopeKey;

@end

@implementation ABI43_0_0EXScopedServerRegistrationModule
