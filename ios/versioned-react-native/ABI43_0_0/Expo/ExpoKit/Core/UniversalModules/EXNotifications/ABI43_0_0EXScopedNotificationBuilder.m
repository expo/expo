...
@interface ABI43_0_0EXScopedNotificationBuilder ()
...
@implementation ABI43_0_0EXScopedNotificationBuilder
...
- (UNNotificationContent *)notificationContentFromRequest:(NSDictionary *)request
{
  ...
  if (content.categoryIdentifier && _isInExpoGo) {
    NSString *scopedCategoryIdentifier = [ABI43_0_0EXScopedNotificationsUtils scopedIdentifierFromId:content.categoryIdentifier
