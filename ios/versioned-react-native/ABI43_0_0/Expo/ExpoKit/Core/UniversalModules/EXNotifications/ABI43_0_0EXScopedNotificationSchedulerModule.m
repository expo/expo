...
@interface ABI43_0_0EXScopedNotificationSchedulerModule ()

@property (nonatomic, strong) NSString *scopeKey;

@end

@implementation ABI43_0_0EXScopedNotificationSchedulerModule
...
{
  NSString *scopedIdentifier = [ABI43_0_0EXScopedNotificationsUtils scopedIdentifierFromId:identifier
...
- (NSArray * _Nonnull)serializeNotificationRequests:(NSArray<UNNotificationRequest *> * _Nonnull) requests;
{
  ...
  for (UNNotificationRequest *request in requests) {
    if ([ABI43_0_0EXScopedNotificationsUtils isId:request.identifier scopedByExperience:_scopeKey]) {
      [serializedRequests addObject:[ABI43_0_0EXScopedNotificationSerializer serializedNotificationRequest:request]];
    }
  }
...
- (void)cancelAllNotificationsWithResolver:(ABI43_0_0EXPromiseResolveBlock)resolve rejecting:(ABI43_0_0EXPromiseRejectBlock)reject
{
  ...
  [[UNUserNotificationCenter currentNotificationCenter] getPendingNotificationRequestsWithCompletionHandler:^(NSArray<UNNotificationRequest *> * _Nonnull requests) {
    ...
    for (UNNotificationRequest *request in requests) {
      if ([ABI43_0_0EXScopedNotificationsUtils isId:request.identifier scopedByExperience:scopeKey]) {
