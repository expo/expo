...
/**
 * The image loader (i.e. ABI43_0_0RCTImageLoader) implement this to declare whether image performance should be logged.
 */
@protocol ABI43_0_0RCTImageLoaderLoggableProtocol
 ...
 */
@protocol ABI43_0_0RCTImageLoaderLoggable
