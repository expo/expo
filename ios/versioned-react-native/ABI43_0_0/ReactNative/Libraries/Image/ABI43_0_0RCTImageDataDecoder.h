 ...
 * are also bridge modules, so should be registered using ABI43_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI43_0_0RCTImageDataDecoder <ABI43_0_0RCTBridgeModule>
...
/**
 * If more than one ABI43_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
