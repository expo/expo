...
@interface ABI43_0_0RCTImageStoreManager : NSObject <ABI43_0_0RCTURLRequestHandler>
...
@interface ABI43_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI43_0_0RCTBridge (ABI43_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI43_0_0RCTImageStoreManager *imageStoreManager;
