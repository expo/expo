...
@interface ABI43_0_0RCTFileRequestHandler() <ABI43_0_0RCTTurboModule>
@end

@implementation ABI43_0_0RCTFileRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  && !ABI43_0_0RCTIsBundleAssetURL(request.URL);
}

- (NSOperation *)sendRequest:(NSURLRequest *)request
                withDelegate:(id<ABI43_0_0RCTURLRequestDelegate>)delegate
{
  // Lazy setup
  if (!_fileQueue) {
...
Class ABI43_0_0RCTFileRequestHandlerCls(void) {
  return ABI43_0_0RCTFileRequestHandler.class;
}
