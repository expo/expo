...
#import "ABI43_0_0NSTextStorage+FontScaling.h"
#import <ABI43_0_0React/ABI43_0_0RCTTextView.h>

@implementation ABI43_0_0RCTTextShadowView
{
...
- (instancetype)initWithBridge:(ABI43_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI43_0_0YGNodeSetMeasureFunc(self.yogaNode, ABI43_0_0RCTTextShadowViewMeasure);
    ABI43_0_0YGNodeSetBaselineFunc(self.yogaNode, ABI43_0_0RCTTextShadowViewBaseline);
  }
...
- (void)didSetProps:(NSArray<NSString *> *)changedProps
{
  ...
  // because the background color is drawn on the ABI43_0_0RCTTextView itself, as well
  // as on the glphy background draw step. By setting this to nil, we allow
  // the ABI43_0_0RCTTextView backgroundColor to be used, without affecting nested Text
  // components.
...
{
  if (ABI43_0_0YGNodeIsDirty(self.yogaNode)) {
    return;
  }
  ...
  NSNumber *tag = self.ABI43_0_0ReactTag;
  NSMutableArray<NSNumber *> *descendantViewTags = [NSMutableArray new];
  [textStorage enumerateAttribute:ABI43_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                          inRange:NSMakeRange(0, textStorage.length)
                          options:0
                       usingBlock:
   ^(ABI43_0_0RCTShadowView *shadowView, NSRange range, __unused BOOL *stop) {
     if (!shadowView) {
       return;
     }

     [descendantViewTags addObject:shadowView.ABI43_0_0ReactTag];
   }
  ];

  [_bridge.uiManager addUIBlock:^(ABI43_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI43_0_0RCTTextView *textView = (ABI43_0_0RCTTextView *)viewRegistry[tag];
    if (!textView) {
      return;
    }
    ...
    [textStorage removeAttribute:ABI43_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName range:NSMakeRange(0, textStorage.length)];
...
- (NSAttributedString *)attributedTextWithMeasuredAttachmentsThatFitSize:(CGSize)size
{
  ...
  [attributedText enumerateAttribute:ABI43_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                               inRange:NSMakeRange(0, attributedText.length)
                               options:0
                            usingBlock:
    ^(ABI43_0_0RCTShadowView *shadowView, NSRange range, __unused BOOL *stop) {
                                        ...
                                        exclusiveOwnership:(BOOL)exclusiveOwnership
{
  ...
  if (_adjustsFontSizeToFit) {
    ...
    [textStorage abi43_0_0_rct_scaleFontSizeToFitSize:size
...
- (void)layoutWithMetrics:(ABI43_0_0RCTLayoutMetrics)layoutMetrics
...
- (void)layoutSubviewsWithContext:(ABI43_0_0RCTLayoutContext)layoutContext
{
  ...
  [textStorage enumerateAttribute:ABI43_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                          ...
                          options:0
                       usingBlock:
    ^(ABI43_0_0RCTShadowView *shadowView, NSRange range, BOOL *stop) {
      if (!shadowView) {
        return;
      }
      ...
      CGRect frame = {{
        ABI43_0_0RCTRoundPixelValue(glyphRect.origin.x),
        ABI43_0_0RCTRoundPixelValue(glyphRect.origin.y + glyphRect.size.height - attachmentSize.height + font.descender)
      }, {
        ABI43_0_0RCTRoundPixelValue(attachmentSize.width),
        ABI43_0_0RCTRoundPixelValue(attachmentSize.height)
      }};
      
      NSRange truncatedGlyphRange = [layoutManager truncatedGlyphRangeInLineFragmentForGlyphAtIndex:range.location];
      BOOL viewIsTruncated = NSIntersectionRange(range, truncatedGlyphRange).length != 0;

      ABI43_0_0RCTLayoutContext localLayoutContext = layoutContext;
      ...
      ABI43_0_0RCTLayoutMetrics localLayoutMetrics = shadowView.layoutMetrics;
      localLayoutMetrics.frame.origin = frame.origin; // Reinforcing a proper frame origin for the Shadow View.
      if (viewIsTruncated) {
        localLayoutMetrics.displayType = ABI43_0_0RCTDisplayTypeNone;
      }
...
static ABI43_0_0YGSize ABI43_0_0RCTTextShadowViewMeasure(ABI43_0_0YGNodeRef node, float width, ABI43_0_0YGMeasureMode widthMode, float height, ABI43_0_0YGMeasureMode heightMode)
{
  CGSize maximumSize = (CGSize){
    widthMode == ABI43_0_0YGMeasureModeUndefined ? CGFLOAT_MAX : ABI43_0_0RCTCoreGraphicsFloatFromYogaFloat(width),
    heightMode == ABI43_0_0YGMeasureModeUndefined ? CGFLOAT_MAX : ABI43_0_0RCTCoreGraphicsFloatFromYogaFloat(height),
  };

  ABI43_0_0RCTTextShadowView *shadowTextView = (__bridge ABI43_0_0RCTTextShadowView *)ABI43_0_0YGNodeGetContext(node);
  ...
  size = (CGSize){
    MIN(ABI43_0_0RCTCeilPixelValue(size.width), maximumSize.width),
    MIN(ABI43_0_0RCTCeilPixelValue(size.height), maximumSize.height)
  };
  ...
  return (ABI43_0_0YGSize){
    ABI43_0_0RCTYogaFloatFromCoreGraphicsFloat(size.width + epsilon),
    ABI43_0_0RCTYogaFloatFromCoreGraphicsFloat(size.height + epsilon)
  };
}

static float ABI43_0_0RCTTextShadowViewBaseline(ABI43_0_0YGNodeRef node, const float width, const float height)
{
  ABI43_0_0RCTTextShadowView *shadowTextView = (__bridge ABI43_0_0RCTTextShadowView *)ABI43_0_0YGNodeGetContext(node);

  CGSize size = (CGSize){
    ABI43_0_0RCTCoreGraphicsFloatFromYogaFloat(width),
    ABI43_0_0RCTCoreGraphicsFloatFromYogaFloat(height)
  };

  CGFloat lastBaseline = [shadowTextView lastBaselineForSize:size];

  return ABI43_0_0RCTYogaFloatFromCoreGraphicsFloat(lastBaseline);
}
