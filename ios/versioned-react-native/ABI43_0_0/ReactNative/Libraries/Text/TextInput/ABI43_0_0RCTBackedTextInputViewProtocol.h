...
@protocol ABI43_0_0RCTBackedTextInputDelegate;
@class ABI43_0_0RCTTextAttributes;

NS_ASSUME_NONNULL_BEGIN

@protocol ABI43_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI43_0_0RCTBackedTextInputDelegate> textInputDelegate;
