...
@implementation ABI43_0_0RCTBaseTextInputShadowView
{
...
- (instancetype)initWithBridge:(ABI43_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI43_0_0YGNodeSetMeasureFunc(self.yogaNode, ABI43_0_0RCTBaseTextInputShadowViewMeasure);
    ABI43_0_0YGNodeSetBaselineFunc(self.yogaNode, ABI43_0_0RCTTextInputShadowViewBaseline);
  }
...
- (void)uiManagerWillPerformMounting
{
  ...
  ABI43_0_0RCTTextAttributes *textAttributes = [self.textAttributes copy];
  ...
  [attributedText removeAttribute:ABI43_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                            range:NSMakeRange(0, attributedText.length)];

  [attributedText removeAttribute:ABI43_0_0RCTTextAttributesTagAttributeName
                            range:NSMakeRange(0, attributedText.length)];
  ...
  [_bridge.uiManager addUIBlock:^(ABI43_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI43_0_0RCTBaseTextInputView *baseTextInputView = (ABI43_0_0RCTBaseTextInputView *)viewRegistry[tag];
    if (!baseTextInputView) {
      return;
    }

    baseTextInputView.textAttributes = textAttributes;
    baseTextInputView.ABI43_0_0ReactBorderInsets = borderInsets;
    baseTextInputView.ABI43_0_0ReactPaddingInsets = paddingInsets;
...
- (CGSize)sizeThatFitsMinimumSize:(CGSize)minimumSize maximumSize:(CGSize)maximumSize
{
  ...
  return (CGSize){
    MAX(minimumSize.width, MIN(ABI43_0_0RCTCeilPixelValue(size.width), maximumSize.width)),
    MAX(minimumSize.height, MIN(ABI43_0_0RCTCeilPixelValue(size.height), maximumSize.height))
  };
}
...
static ABI43_0_0YGSize ABI43_0_0RCTBaseTextInputShadowViewMeasure(ABI43_0_0YGNodeRef node, float width, ABI43_0_0YGMeasureMode widthMode, float height, ABI43_0_0YGMeasureMode heightMode)
{
  ...
  return (ABI43_0_0YGSize){
    ABI43_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.width),
    ABI43_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.height)
  };
}

static float ABI43_0_0RCTTextInputShadowViewBaseline(ABI43_0_0YGNodeRef node, const float width, const float height)
{
  ABI43_0_0RCTBaseTextInputShadowView *shadowTextView = (__bridge ABI43_0_0RCTBaseTextInputShadowView *)ABI43_0_0YGNodeGetContext(node);
