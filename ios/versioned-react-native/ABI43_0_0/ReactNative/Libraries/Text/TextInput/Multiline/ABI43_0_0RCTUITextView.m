...
@implementation ABI43_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI43_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI43_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
...
- (void)setDelegate:(id<UITextViewDelegate>)delegate {
  // Delegate is set inside `[ABI43_0_0RCTBackedTextViewDelegateAdapter initWithTextView]` and
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  // see: https://github.com/facebook/ABI43_0_0React-native/issues/19339
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI43_0_0RCTCeilPixelValue(placeholderSize.width), ABI43_0_0RCTCeilPixelValue(placeholderSize.height));
