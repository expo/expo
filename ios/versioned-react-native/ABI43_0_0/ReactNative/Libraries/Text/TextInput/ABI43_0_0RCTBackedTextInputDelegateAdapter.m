...
#import <ABI43_0_0React/ABI43_0_0RCTBackedTextInputDelegateAdapter.h>
...
@interface ABI43_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI43_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI43_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
...
@interface ABI43_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI43_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI43_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}
