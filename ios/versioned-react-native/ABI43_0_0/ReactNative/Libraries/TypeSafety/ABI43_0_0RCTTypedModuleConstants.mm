...
#import "ABI43_0_0RCTTypedModuleConstants.h"

#import <ABI43_0_0React/ABI43_0_0RCTDefines.h>

@implementation _ABI43_0_0RCTTypedModuleConstants {
  NSDictionary *_dictionary;
}

+ (instancetype)newWithUnsafeDictionary:(NSDictionary<NSString *, id> *)dictionary
{
  _ABI43_0_0RCTTypedModuleConstants *constants = [self new];
  if (constants) {
...
ABI43_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithObjects:(id  _Nonnull const [])objects
