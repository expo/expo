...
#import <ABI43_0_0React/ABI43_0_0RCTNativeAnimatedModule.h>
...
@implementation ABI43_0_0RCTNativeAnimatedModule
{
...
- (void)setBridge:(ABI43_0_0RCTBridge *)bridge
{
  ...
  _nodesManager = [[ABI43_0_0RCTNativeAnimatedNodesManager alloc] initWithBridge:self.bridge surfacePresenter:bridge.surfacePresenter];
...
{
  ABI43_0_0RCTLogWarn(@"setSurfacePresenter should only be invoked in ABI43_0_0RCTNativeAnimatedTurboModule");
}
...
Class ABI43_0_0RCTNativeAnimatedModuleCls(void) {
  return ABI43_0_0RCTNativeAnimatedModule.class;
}
