...
@interface ABI43_0_0RCTSpringAnimation ()
...
const NSTimeInterval ABI43_0_0MAX_DELTA_TIME = 0.064;

@implementation ABI43_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
                  ...
                  callBack:(nullable ABI43_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _lastVelocity = [ABI43_0_0RCTConvert CGFloat:config[@"initialVelocity"]];
...
- (void)resetAnimationConfig:(NSDictionary *)config
{
  ...
  _toValue = [ABI43_0_0RCTConvert CGFloat:config[@"toValue"]];
  _overshootClamping = [ABI43_0_0RCTConvert BOOL:config[@"overshootClamping"]];
  _restDisplacementThreshold = [ABI43_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
  _restSpeedThreshold = [ABI43_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
  _stiffness = [ABI43_0_0RCTConvert CGFloat:config[@"stiffness"]];
  _damping = [ABI43_0_0RCTConvert CGFloat:config[@"damping"]];
  _mass = [ABI43_0_0RCTConvert CGFloat:config[@"mass"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  if(_animationStartTime == -1) {
    ...
    // Handle frame drops, and only advance dt by a max of ABI43_0_0MAX_DELTA_TIME
    NSTimeInterval deltaTime = MIN(ABI43_0_0MAX_DELTA_TIME, currentTime - _animationCurrentTime);
    _t = _t + deltaTime / ABI43_0_0RCTAnimationDragCoefficient();
  }
