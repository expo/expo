...
@implementation ABI43_0_0RCTTrackingAnimatedNode {
...
- (void)performUpdate
{
  ...
  ABI43_0_0RCTValueAnimatedNode *node = (ABI43_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
