...
@implementation ABI43_0_0RCTDiffClampAnimatedNode
{
...
{
  ABI43_0_0RCTValueAnimatedNode *inputNode = (ABI43_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI43_0_0RCTValueAnimatedNode class]]) {
    ABI43_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
