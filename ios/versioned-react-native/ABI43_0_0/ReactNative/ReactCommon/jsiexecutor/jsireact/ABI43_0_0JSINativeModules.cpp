...
#include "ABI43_0_0jsireact/ABI43_0_0JSINativeModules.h"
...
folly::Optional<Object> JSINativeModules::createModule(
  ...
  if (hasLogger) {
    ABI43_0_0ReactMarker::logTaggedMarker(
        ABI43_0_0ReactMarker::NATIVE_MODULE_SETUP_START, name.c_str());
  }
  ...
  if (hasLogger) {
    ABI43_0_0ReactMarker::logTaggedMarker(
        ABI43_0_0ReactMarker::NATIVE_MODULE_SETUP_STOP, name.c_str());
  }
