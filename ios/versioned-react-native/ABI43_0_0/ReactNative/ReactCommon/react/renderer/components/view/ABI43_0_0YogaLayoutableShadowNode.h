...
#include <ABI43_0_0React/ABI43_0_0renderer/core/Sealable.h>
...
#pragma mark - Mutating Methods
   ...
   */
  void setPositionType(ABI43_0_0YGPositionType positionType) const;
...
#pragma mark - LayoutableShadowNode
 ...
 protected:
   ...
   * all the time.
   */
  mutable ABI43_0_0YGNode yogaNode_;
 ...
 private:
  ...
  static ABI43_0_0YGConfig &initializeYogaConfig(ABI43_0_0YGConfig &config);
  static ABI43_0_0YGNode *yogaNodeCloneCallbackConnector(
      ABI43_0_0YGNode *oldYogaNode,
      ABI43_0_0YGNode *parentYogaNode,
      int childIndex);
  static ABI43_0_0YGSize yogaNodeMeasureCallbackConnector(
