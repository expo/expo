...
AttributedString AndroidTextInputShadowNode::getMostRecentAttributedString()
  ...
  auto ABI43_0_0ReactTreeAttributedString = getAttributedString();
  ...
  bool treeAttributedStringChanged =
      !state.ABI43_0_0ReactTreeAttributedString.compareTextAttributesWithoutFrame(
          ABI43_0_0ReactTreeAttributedString);
...
void AndroidTextInputShadowNode::updateStateIfNeeded() {
  ...
  if (state.ABI43_0_0ReactTreeAttributedString == ABI43_0_0ReactTreeAttributedString &&
  ...
  auto newEventCount =
      (state.ABI43_0_0ReactTreeAttributedString == ABI43_0_0ReactTreeAttributedString
           ? 0
