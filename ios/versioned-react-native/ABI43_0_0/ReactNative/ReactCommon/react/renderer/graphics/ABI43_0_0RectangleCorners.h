...
template <typename T>
struct hash<ABI43_0_0facebook::ABI43_0_0React::RectangleCorners<T>> {
  size_t operator()(ABI43_0_0facebook::ABI43_0_0React::RectangleCorners<T> const &corners) const
      noexcept {
