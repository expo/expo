...
TextMeasurement TextLayoutManager::measureCachedSpannableById(
  ...
  local_ref<JString> componentName = make_jstring("ABI43_0_0RCTText");
  ...
  if (attachmentsCount > 0) {
    ...
    for (int i = 0; i < fragments.size(); i++) {
      ...
      if (fragment["isAttachment"] == true) {
        ...
        auto rect = ABI43_0_0facebook::ABI43_0_0React::Rect{{left, top},
                                          ABI43_0_0facebook::ABI43_0_0React::Size{width, height}};
