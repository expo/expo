...
Scheduler::Scheduler(
  ...
  ABI43_0_0ReactNativeConfig_ =
      schedulerToolbox.contextContainer
          ->at<std::shared_ptr<const ABI43_0_0ReactNativeConfig>>("ABI43_0_0ReactNativeConfig");
...
#ifdef ANDROID
  enableReparentingDetection_ = ABI43_0_0ReactNativeConfig_->getBool(
      "ABI43_0_0React_fabric:enable_reparenting_detection_android");
  removeOutstandingSurfacesOnDestruction_ = ABI43_0_0ReactNativeConfig_->getBool(
      "ABI43_0_0React_fabric:remove_outstanding_surfaces_on_destruction_android");
  uiManager_->experimentEnableStateUpdateWithAutorepeat =
      ABI43_0_0ReactNativeConfig_->getBool(
          "ABI43_0_0React_fabric:enable_state_update_with_autorepeat_android");
#else
  enableReparentingDetection_ = ABI43_0_0ReactNativeConfig_->getBool(
      "ABI43_0_0React_fabric:enable_reparenting_detection_ios");
  removeOutstandingSurfacesOnDestruction_ = ABI43_0_0ReactNativeConfig_->getBool(
      "ABI43_0_0React_fabric:remove_outstanding_surfaces_on_destruction_ios");
  uiManager_->experimentEnableStateUpdateWithAutorepeat =
      ABI43_0_0ReactNativeConfig_->getBool(
          "ABI43_0_0React_fabric:enable_state_update_with_autorepeat_ios");
#endif
}
...
void Scheduler::renderTemplateToSurface(
  ...
  try {
    ...
    LOG(ERROR) << "    >>>> ABI43_0_0EXCEPTION <<<  rendering uiTemplate in "
...
void Scheduler::stopSurface(SurfaceId surfaceId) const {
  ...
  // We execute JavaScript/ABI43_0_0React part of the process at the very end to minimize
