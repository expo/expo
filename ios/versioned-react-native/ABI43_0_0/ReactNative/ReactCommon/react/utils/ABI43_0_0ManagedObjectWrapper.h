...
@interface ABI43_0_0RCTInternalGenericWeakWrapper : NSObject
...
{
  ABI43_0_0RCTInternalGenericWeakWrapper *weakWrapper = [ABI43_0_0RCTInternalGenericWeakWrapper new];
...
{
  ABI43_0_0RCTInternalGenericWeakWrapper *weakWrapper = (ABI43_0_0RCTInternalGenericWeakWrapper *)unwrapManagedObject(object);
  assert(weakWrapper && "`ABI43_0_0RCTInternalGenericWeakWrapper` instance must not be `nil`.");
