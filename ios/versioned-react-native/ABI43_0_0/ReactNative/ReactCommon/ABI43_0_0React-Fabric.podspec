...
Pod::Spec.new do |s|
  ...
  s.dependency "ABI43_0_0React-graphics", version
  s.dependency "ABI43_0_0React-jsiexecutor", version
  ...
  s.subspec "animations" do |ss|
    ...
    ss.header_dir           = "ABI43_0_0react/renderer/animations"
  ...
  s.subspec "attributedstring" do |ss|
    ...
    ss.header_dir           = "ABI43_0_0react/renderer/attributedstring"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
  end
  ...
  s.subspec "better" do |ss|
    ...
    ss.header_dir           = "ABI43_0_0better"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
  end

  s.subspec "config" do |ss|
    ss.source_files         = "react/config/*.{m,mm,cpp,h}"
    ss.header_dir           = "ABI43_0_0react/config"
  ...
  s.subspec "core" do |ss|
    ...
    ss.header_dir           = "ABI43_0_0react/renderer/core"
  ...
  s.subspec "componentregistry" do |ss|
    ...
    ss.header_dir           = "ABI43_0_0react/renderer/componentregistry"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
  end
  ...
  s.subspec "components" do |ss|
    ss.subspec "activityindicator" do |sss|
      ...
      sss.header_dir           = "ABI43_0_0react/renderer/components/activityindicator"
    ...
    ss.subspec "image" do |sss|
      ...
      sss.header_dir           = "ABI43_0_0react/renderer/components/image"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
    end
    ...
    ss.subspec "inputaccessory" do |sss|
      ...
      sss.header_dir           = "ABI43_0_0react/renderer/components/inputaccessory"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
    end
    ...
    ss.subspec "legacyviewmanagerinterop" do |sss|
      ...
      sss.header_dir           = "ABI43_0_0react/renderer/components/legacyviewmanagerinterop"
    ...
    ss.subspec "modal" do |sss|
      ...
      sss.header_dir           = "ABI43_0_0react/renderer/components/modal"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
    end
    ...
    ss.subspec "picker" do |sss|
      ...
      sss.header_dir           = "ABI43_0_0react/renderer/components/iospicker"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
    end
    ...
    ss.subspec "rncore" do |sss|
      ...
      sss.header_dir           = "ABI43_0_0react/renderer/components/rncore"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
    end
    ...
    ss.subspec "root" do |sss|
      ...
      sss.header_dir           = "ABI43_0_0react/renderer/components/root"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
    end
    ...
    ss.subspec "safeareaview" do |sss|
      ...
      sss.header_dir           = "ABI43_0_0react/renderer/components/safeareaview"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
    end
    ...
    ss.subspec "scrollview" do |sss|
      ...
      sss.header_dir           = "ABI43_0_0react/renderer/components/scrollview"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
    end
    ...
    ss.subspec "slider" do |sss|
      ...
      sss.header_dir           = "ABI43_0_0react/renderer/components/slider"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
    end
    ...
    ss.subspec "text" do |sss|
      ...
      sss.header_dir           = "ABI43_0_0react/renderer/components/text"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
    end
    ...
    ss.subspec "textinput" do |sss|
      ...
      sss.header_dir           = "ABI43_0_0react/renderer/components/iostextinput"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
    end
    ...
    ss.subspec "unimplementedview" do |sss|
      ...
      sss.header_dir           = "ABI43_0_0react/renderer/components/unimplementedview"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
    end

    ss.subspec "view" do |sss|
      sss.dependency             folly_dep_name, folly_version
      sss.dependency             "ABI43_0_0Yoga"
      sss.compiler_flags       = folly_compiler_flags
      sss.source_files         = "react/renderer/components/view/**/*.{m,mm,cpp,h}"
      sss.exclude_files        = "react/renderer/components/view/tests"
      sss.header_dir           = "ABI43_0_0react/renderer/components/view"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
    end
  end
  ...
  s.subspec "debug" do |ss|
    ...
    ss.header_dir           = "ABI43_0_0react/renderer/debug"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
  end

  s.subspec "imagemanager" do |ss|
    ss.dependency             "ABI43_0_0React-RCTImage", version
    ss.dependency             folly_dep_name, folly_version
    ss.compiler_flags       = folly_compiler_flags
    ...
    ss.header_dir           = "ABI43_0_0react/renderer/imagemanager"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
  end
  ...
  s.subspec "mounting" do |ss|
    ...
    ss.header_dir           = "ABI43_0_0react/renderer/mounting"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
  end
  ...
  s.subspec "scheduler" do |ss|
    ...
    ss.header_dir           = "ABI43_0_0react/renderer/scheduler"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
  end
  ...
  s.subspec "templateprocessor" do |ss|
    ...
    ss.header_dir           = "ABI43_0_0react/renderer/templateprocessor"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
  end

  s.subspec "textlayoutmanager" do |ss|
    ss.dependency             folly_dep_name, folly_version
    ss.dependency             "ABI43_0_0React-Fabric/uimanager"
    ss.compiler_flags       = folly_compiler_flags
    ...
    ss.header_dir           = "ABI43_0_0react/renderer/textlayoutmanager"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
  end
  ...
  s.subspec "uimanager" do |ss|
    ...
    ss.header_dir           = "ABI43_0_0react/renderer/uimanager"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
  end

  s.subspec "utils" do |ss|
    ss.source_files         = "react/utils/*.{m,mm,cpp,h}"
    ss.header_dir           = "ABI43_0_0react/utils"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
  end
end
