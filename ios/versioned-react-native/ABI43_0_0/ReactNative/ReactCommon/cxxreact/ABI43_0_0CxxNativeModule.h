...
#include <ABI43_0_0cxxreact/ABI43_0_0NativeModule.h>
...
class ABI43_0_0RN_EXPORT CxxNativeModule : public NativeModule {
 public:
  CxxNativeModule(
      std::weak_ptr<Instance> instance,
      std::string name,
  ...
  void invoke(unsigned int ABI43_0_0ReactMethodId, folly::dynamic &&params, int callId)
      override;
