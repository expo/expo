...
#include "ABI43_0_0SampleCxxModule.h"
#include <ABI43_0_0cxxreact/ABI43_0_0JsArgumentHelpers.h>
...
ABI43_0_0facebook::xplat::module::CxxModule *SampleCxxModule() {
  return new ABI43_0_0facebook::xplat::samples::SampleCxxModule(
      std::make_unique<ABI43_0_0facebook::xplat::samples::Sample>());
}
