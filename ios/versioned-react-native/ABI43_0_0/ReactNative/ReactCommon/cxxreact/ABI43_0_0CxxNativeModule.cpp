...
#include "ABI43_0_0CxxNativeModule.h"
...
#include "ABI43_0_0JsArgumentHelpers.h"
...
std::string CxxNativeModule::getSyncMethodName(unsigned int ABI43_0_0ReactMethodId) {
  if (ABI43_0_0ReactMethodId >= methods_.size()) {
    throw std::invalid_argument(folly::to<std::string>(
        "methodId ",
        ABI43_0_0ReactMethodId,
        " out of range [0..",
        methods_.size(),
        "]"));
  }
  return methods_[ABI43_0_0ReactMethodId].name;
}
...
void CxxNativeModule::invoke(
  ...
  const auto &method = methods_[ABI43_0_0ReactMethodId];
