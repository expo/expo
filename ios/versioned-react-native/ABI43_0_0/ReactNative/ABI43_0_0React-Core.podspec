...
header_subspecs = {
  ...
  'RCTBlobHeaders'              => 'Libraries/Blob/{ABI43_0_0RCTBlobManager,ABI43_0_0RCTFileReaderModule}.h',
...
Pod::Spec.new do |s|
  ...
  s.user_target_xcconfig   = { "HEADER_SEARCH_PATHS" => "\"$(PODS_ROOT)/Headers/Private/ABI43_0_0React-Core\""}
  ...
  s.subspec "DevSupport" do |ss|
    ...
    ss.dependency "ABI43_0_0React-Core/Default", version
    ss.dependency "ABI43_0_0React-Core/RCTWebSocket", version
    ss.dependency "ABI43_0_0React-jsinspector", version
  end
  ...
  header_subspecs.each do |name, headers|
    s.subspec name do |ss|
      ...
      ss.dependency "ABI43_0_0React-Core/Default"
    end
  end
