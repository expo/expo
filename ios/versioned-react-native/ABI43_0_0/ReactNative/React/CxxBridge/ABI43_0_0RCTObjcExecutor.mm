...
#import <ABI43_0_0cxxreact/ABI43_0_0JSBigString.h>
...
class ABI43_0_0RCTObjcExecutor : public JSExecutor {
 public:
  ABI43_0_0RCTObjcExecutor(
  ...
  {
    ABI43_0_0RCTAssert(NO, @"RAM bundles are not supported in ABI43_0_0RCTObjcExecutor");
  }
 ...
 private:
  ...
  ABI43_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI43_0_0RCTObjcExecutorFactory::ABI43_0_0RCTObjcExecutorFactory(id<ABI43_0_0RCTJavaScriptExecutor> jse, ABI43_0_0RCTJavaScriptCompleteBlock errorBlock)
    : m_jse(jse), m_errorBlock(errorBlock)
{
}

std::unique_ptr<JSExecutor> ABI43_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue)
{
  return std::unique_ptr<JSExecutor>(new ABI43_0_0RCTObjcExecutor(m_jse, m_errorBlock, jsQueue, delegate));
}
