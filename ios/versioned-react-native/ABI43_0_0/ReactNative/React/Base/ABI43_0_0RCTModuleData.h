...
typedef id<ABI43_0_0RCTBridgeModule> (^ABI43_0_0RCTBridgeModuleProvider)(void);

@interface ABI43_0_0RCTModuleData : NSObject <ABI43_0_0RCTInvalidating>
...
- (instancetype)initWithModuleClass:(Class)moduleClass
                     moduleProvider:(ABI43_0_0RCTBridgeModuleProvider)moduleProvider
                             bridge:(ABI43_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;

- (instancetype)initWithModuleInstance:(id<ABI43_0_0RCTBridgeModule>)instance
                                bridge:(ABI43_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI43_0_0RCTBridgeMethod>> *methods;

/**
 * Returns a map of the module methods. Note that this will gather the methods the first
 * time it is called and then memoize the results.
 */
@property (nonatomic, copy, readonly) NSDictionary<NSString *, id<ABI43_0_0RCTBridgeMethod>> *methodsByName;
 ...
 */
@property (nonatomic, strong, readwrite) id<ABI43_0_0RCTBridgeModule> instance;
...
ABI43_0_0RCT_EXTERN void ABI43_0_0RCTSetIsMainQueueExecutionOfConstantsToExportDisabled(BOOL val);
ABI43_0_0RCT_EXTERN BOOL ABI43_0_0RCTIsMainQueueExecutionOfConstantsToExportDisabled(void);
