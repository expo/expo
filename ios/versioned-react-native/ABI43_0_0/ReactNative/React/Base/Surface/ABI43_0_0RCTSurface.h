 ...
 */
@interface ABI43_0_0RCTSurface : NSObject <ABI43_0_0RCTSurfaceProtocol>
 ...
 *  - Calling on the main queue with `ABI43_0_0RCTSurfaceStageSurfaceDidInitialMounting`
 *    stage temporary is not supported; in this case the stage will be
 *    downgraded to `ABI43_0_0RCTSurfaceStageSurfaceDidInitialLayout`.
 */
...
/**
 * Mount the ABI43_0_0React component specified by the given moduleName. This is typically
...
/**
 * Unmount the ABI43_0_0React component specified by the given rootViewTag, called from native.
 */
