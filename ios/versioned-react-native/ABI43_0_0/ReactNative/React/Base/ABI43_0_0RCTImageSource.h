 ...
 */
@interface ABI43_0_0RCTImageSource : NSObject
...
@interface ABI43_0_0RCTConvert (ImageSource)

+ (ABI43_0_0RCTImageSource *)ABI43_0_0RCTImageSource:(id)json;
+ (NSArray<ABI43_0_0RCTImageSource *> *)ABI43_0_0RCTImageSourceArray:(id)json;
