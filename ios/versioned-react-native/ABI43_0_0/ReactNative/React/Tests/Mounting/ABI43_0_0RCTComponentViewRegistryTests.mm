...
@interface ABI43_0_0RCTComponentViewRegistryTests : XCTestCase
@end

using namespace ABI43_0_0facebook::ABI43_0_0React;

@implementation ABI43_0_0RCTComponentViewRegistryTests {
  ABI43_0_0RCTComponentViewRegistry *_componentViewRegistry;
}

- (void)setUp
{
  [super setUp];
  _componentViewRegistry = [ABI43_0_0RCTComponentViewRegistry new];
}
...
- (void)testComponentViewDescriptorWithTag
{
  ...
  auto newViewDescriptor = [_componentViewRegistry
      dequeueComponentViewWithComponentHandle:[ABI43_0_0RCTViewComponentView componentDescriptorProvider].handle
                                          tag:existingTag];
...
- (void)testDequeueAndEnqueue
{
  ...
  XCTAssertThrows(
      ^{
        Tag nonExistingTag = 12;
        [self->_componentViewRegistry
            enqueueComponentViewWithComponentHandle:[ABI43_0_0RCTViewComponentView componentDescriptorProvider].handle
                                                tag:nonExistingTag
