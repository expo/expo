...
#import <ABI43_0_0React/ABI43_0_0renderer/componentregistry/ComponentDescriptorProvider.h>
...
#import <ABI43_0_0React/ABI43_0_0renderer/core/State.h>
 ...
 */
typedef NS_OPTIONS(NSInteger, ABI43_0_0RNComponentViewUpdateMask) {
  ABI43_0_0RNComponentViewUpdateMaskNone = 0,
  ABI43_0_0RNComponentViewUpdateMaskProps = 1 << 0,
  ABI43_0_0RNComponentViewUpdateMaskEventEmitter = 1 << 1,
  ABI43_0_0RNComponentViewUpdateMaskState = 1 << 3,
  ABI43_0_0RNComponentViewUpdateMaskLayoutMetrics = 1 << 4,

  ABI43_0_0RNComponentViewUpdateMaskAll = ABI43_0_0RNComponentViewUpdateMaskProps | ABI43_0_0RNComponentViewUpdateMaskEventEmitter |
      ABI43_0_0RNComponentViewUpdateMaskState | ABI43_0_0RNComponentViewUpdateMaskLayoutMetrics
};

/*
 * Represents a `UIView` instance managed by ABI43_0_0React.
 * All methods are non-@optional.
 * `UIView+ComponentViewProtocol` category provides default implementation
 * for all of them.
 */
@protocol ABI43_0_0RCTComponentViewProtocol <NSObject>

/*
 * Returns a `ComponentDescriptorProvider` of a particular `ComponentDescriptor` which this component view
 * represents.
 */
+ (ABI43_0_0facebook::ABI43_0_0React::ComponentDescriptorProvider)componentDescriptorProvider;
