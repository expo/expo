...
#import "ABI43_0_0RCTScrollViewComponentView.h"
...
#import <ABI43_0_0React/ABI43_0_0RCTScrollEvent.h>

#import <ABI43_0_0React/ABI43_0_0renderer/components/scrollview/ABI43_0_0RCTComponentViewHelpers.h>
#import <ABI43_0_0React/ABI43_0_0renderer/components/scrollview/ScrollViewComponentDescriptor.h>
#import <ABI43_0_0React/ABI43_0_0renderer/components/scrollview/ScrollViewEventEmitter.h>
#import <ABI43_0_0React/ABI43_0_0renderer/components/scrollview/ScrollViewProps.h>
#import <ABI43_0_0React/ABI43_0_0renderer/components/scrollview/ScrollViewState.h>
#import <ABI43_0_0React/ABI43_0_0renderer/components/scrollview/conversions.h>
...
static UIScrollViewKeyboardDismissMode ABI43_0_0RCTUIKeyboardDismissModeFromProps(ScrollViewProps const &props)
{
...
static void ABI43_0_0RCTSendPaperScrollEvent_DEPRECATED(UIScrollView *scrollView, NSInteger tag)
{
  static uint16_t coalescingKey = 0;
  ABI43_0_0RCTScrollEvent *scrollEvent = [[ABI43_0_0RCTScrollEvent alloc] initWithEventName:@"onScroll"
                                                                 ABI43_0_0ReactTag:[NSNumber numberWithInt:tag]
  ...
  [[ABI43_0_0RCTBridge currentBridge].eventDispatcher sendEvent:scrollEvent];
}

@interface ABI43_0_0RCTScrollViewComponentView () <
    UIScrollViewDelegate,
    ABI43_0_0RCTScrollViewProtocol,
    ABI43_0_0RCTScrollableProtocol,
    ABI43_0_0RCTEnhancedScrollViewOverridingDelegate>

@end

@implementation ABI43_0_0RCTScrollViewComponentView {
  ...
  NSMutableArray<UIView<ABI43_0_0RCTComponentViewProtocol> *> *_childComponentViews;
}
...
+ (ABI43_0_0RCTScrollViewComponentView *_Nullable)findScrollViewComponentViewForView:(UIView *)view
{
  do {
    view = view.superview;
  } while (view != nil && ![view isKindOfClass:[ABI43_0_0RCTScrollViewComponentView class]]);
  return (ABI43_0_0RCTScrollViewComponentView *)view;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _isOnDemandViewMountingEnabled = ABI43_0_0RCTExperimentGetOnDemandViewMounting();
    _childComponentViews = [[NSMutableArray alloc] init];

    _scrollView = [[ABI43_0_0RCTEnhancedScrollView alloc] initWithFrame:self.bounds];
    _scrollView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
    _scrollView.delaysContentTouches = NO;
    ((ABI43_0_0RCTEnhancedScrollView *)_scrollView).overridingDelegate = self;
...
{
  return ((ABI43_0_0RCTEnhancedScrollView *)_scrollView).delegateSplitter;
}

#pragma mark - ABI43_0_0RCTMountingTransactionObserving
...
#define REMAP_PROP(ABI43_0_0ReactName, localName, target)                      \
  if (oldScrollViewProps.ABI43_0_0ReactName != newScrollViewProps.ABI43_0_0ReactName) { \
    target.localName = newScrollViewProps.ABI43_0_0ReactName;                  \
  }

#define REMAP_VIEW_PROP(ABI43_0_0ReactName, localName) REMAP_PROP(ABI43_0_0ReactName, localName, self)
#define MAP_VIEW_PROP(name) REMAP_VIEW_PROP(name, name)
#define REMAP_SCROLL_VIEW_PROP(ABI43_0_0ReactName, localName) \
  REMAP_PROP(ABI43_0_0ReactName, localName, ((ABI43_0_0RCTEnhancedScrollView *)_scrollView))
#define MAP_SCROLL_VIEW_PROP(name) REMAP_SCROLL_VIEW_PROP(name, name)
  ...
  if (oldScrollViewProps.contentInset != newScrollViewProps.contentInset) {
    _scrollView.contentInset = ABI43_0_0RCTUIEdgeInsetsFromEdgeInsets(newScrollViewProps.contentInset);
  }

  ABI43_0_0RCTEnhancedScrollView *scrollView = (ABI43_0_0RCTEnhancedScrollView *)_scrollView;
  if (oldScrollViewProps.contentOffset != newScrollViewProps.contentOffset) {
    _scrollView.contentOffset = ABI43_0_0RCTCGPointFromPoint(newScrollViewProps.contentOffset);
  }

  if (oldScrollViewProps.snapToAlignment != newScrollViewProps.snapToAlignment) {
    scrollView.snapToAlignment = ABI43_0_0RCTNSStringFromString(toString(newScrollViewProps.snapToAlignment));
  }
  ...
  if (oldScrollViewProps.keyboardDismissMode != newScrollViewProps.keyboardDismissMode) {
    scrollView.keyboardDismissMode = ABI43_0_0RCTUIKeyboardDismissModeFromProps(newScrollViewProps);
  }
...
- (void)updateState:(State::Shared const &)state oldState:(State::Shared const &)oldState
{
  ...
  auto contentOffset = ABI43_0_0RCTCGPointFromPoint(data.contentOffset);
  if (!oldState && !CGPointEqualToPoint(contentOffset, CGPointZero)) {
    _scrollView.contentOffset = contentOffset;
  }

  CGSize contentSize = ABI43_0_0RCTCGSizeFromSize(data.getContentSize());
...
- (void)unmountChildComponentView:(UIView<ABI43_0_0RCTComponentViewProtocol> *)childComponentView index:(NSInteger)index
{
  if (_isOnDemandViewMountingEnabled) {
    ...
    ABI43_0_0RCTAssert(childComponentView.superview == _containerView, @"Attempt to unmount improperly mounted component view.");
    [childComponentView removeFromSuperview];
  }
}
...
- (ScrollViewMetrics)_scrollViewMetrics
{
  ...
  metrics.contentSize = ABI43_0_0RCTSizeFromCGSize(_scrollView.contentSize);
  metrics.contentOffset = ABI43_0_0RCTPointFromCGPoint(_scrollView.contentOffset);
  metrics.contentInset = ABI43_0_0RCTEdgeInsetsFromUIEdgeInsets(_scrollView.contentInset);
  metrics.containerSize = ABI43_0_0RCTSizeFromCGSize(_scrollView.bounds.size);
...
{
  auto contentOffset = ABI43_0_0RCTPointFromCGPoint(_scrollView.contentOffset);
...
- (void)prepareForRecycle
{
  ...
  _scrollView.contentOffset = ABI43_0_0RCTCGPointFromPoint(props.contentOffset);
...
{
  // Historically, `UIScrollView`s in ABI43_0_0React Native do not cancel touches
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
  ...
  if ((_lastScrollEventDispatchTime == 0) || (now - _lastScrollEventDispatchTime > _scrollEventThrottle)) {
    ...
    ABI43_0_0RCTSendPaperScrollEvent_DEPRECATED(scrollView, self.tag);
  }
...
{
  ABI43_0_0RCTScrollViewHandleCommand(self, commandName, args);
}
...
- (void)_remountChildren
{
...
#ifndef NDEBUG
  NSMutableArray<UIView<ABI43_0_0RCTComponentViewProtocol> *> *expectedSubviews = [NSMutableArray new];
#endif
  ...
  for (UIView *componentView in _childComponentViews) {
    ...
    // It's simpler and faster to not mess with views that are not `ABI43_0_0RCTViewComponentView` subclasses.
    if ([componentView isKindOfClass:[ABI43_0_0RCTViewComponentView class]]) {
      ABI43_0_0RCTViewComponentView *viewComponentView = (ABI43_0_0RCTViewComponentView *)componentView;
  ...
  ABI43_0_0RCTAssert(
      ...
      @"-[ABI43_0_0RCTScrollViewComponentView _remountChildren]: Inconsistency detected.");
...
#pragma mark - ABI43_0_0RCTScrollableProtocol
...
Class<ABI43_0_0RCTComponentViewProtocol> ABI43_0_0RCTScrollViewCls(void)
{
  return ABI43_0_0RCTScrollViewComponentView.class;
}
