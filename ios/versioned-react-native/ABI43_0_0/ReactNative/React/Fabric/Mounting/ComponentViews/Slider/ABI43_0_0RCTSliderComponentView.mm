...
#import "ABI43_0_0RCTSliderComponentView.h"
...
#import <ABI43_0_0React/ABI43_0_0renderer/components/slider/SliderComponentDescriptor.h>

#import "ABI43_0_0RCTFabricComponentsPlugins.h"

using namespace ABI43_0_0facebook::ABI43_0_0React;

@interface ABI43_0_0RCTSliderComponentView () <ABI43_0_0RCTImageResponseDelegate>
@end

@implementation ABI43_0_0RCTSliderComponentView {
  ...
  ABI43_0_0RCTImageResponseObserverProxy _trackImageResponseObserverProxy;
  ABI43_0_0RCTImageResponseObserverProxy _minimumTrackImageResponseObserverProxy;
  ABI43_0_0RCTImageResponseObserverProxy _maximumTrackImageResponseObserverProxy;
  ABI43_0_0RCTImageResponseObserverProxy _thumbImageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _trackImageResponseObserverProxy = ABI43_0_0RCTImageResponseObserverProxy(self);
    _minimumTrackImageResponseObserverProxy = ABI43_0_0RCTImageResponseObserverProxy(self);
    _maximumTrackImageResponseObserverProxy = ABI43_0_0RCTImageResponseObserverProxy(self);
    _thumbImageResponseObserverProxy = ABI43_0_0RCTImageResponseObserverProxy(self);
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldSliderProps.thumbTintColor != newSliderProps.thumbTintColor) {
    _sliderView.thumbTintColor = ABI43_0_0RCTUIColorFromSharedColor(newSliderProps.thumbTintColor);
  }

  // `minimumTrackTintColor`
  if (oldSliderProps.minimumTrackTintColor != newSliderProps.minimumTrackTintColor) {
    _sliderView.minimumTrackTintColor = ABI43_0_0RCTUIColorFromSharedColor(newSliderProps.minimumTrackTintColor);
  }

  // `maximumTrackTintColor`
  if (oldSliderProps.maximumTrackTintColor != newSliderProps.maximumTrackTintColor) {
    _sliderView.maximumTrackTintColor = ABI43_0_0RCTUIColorFromSharedColor(newSliderProps.maximumTrackTintColor);
  }
...
Class<ABI43_0_0RCTComponentViewProtocol> ABI43_0_0RCTSliderCls(void)
{
  return ABI43_0_0RCTSliderComponentView.class;
}
