...
#import <ABI43_0_0React/ABI43_0_0RCTGenericDelegateSplitter.h>
 ...
 */
@interface ABI43_0_0RCTScrollViewComponentView : ABI43_0_0RCTViewComponentView <ABI43_0_0RCTMountingTransactionObserving>

/*
 * Finds and returns the closet ABI43_0_0RCTScrollViewComponentView component to the given view
 */
+ (ABI43_0_0RCTScrollViewComponentView *_Nullable)findScrollViewComponentViewForView:(UIView *)view;
...
@property (nonatomic, strong, readonly)
    ABI43_0_0RCTGenericDelegateSplitter<id<UIScrollViewDelegate>> *scrollViewDelegateSplitter;

@end

/*
 * ABI43_0_0RCTScrollableProtocol is a protocol which ABI43_0_0RCTScrollViewManager uses to communicate with all kinds of `UIScrollView`s.
 ...
 */
@interface ABI43_0_0RCTScrollViewComponentView (ScrollableProtocol) <ABI43_0_0RCTScrollableProtocol>
