...
#import "ABI43_0_0RCTModalHostViewComponentView.h"

#import <ABI43_0_0React/ABI43_0_0UIView+React.h>
#import <ABI43_0_0React/ABI43_0_0renderer/components/modal/ModalHostViewComponentDescriptor.h>
#import <ABI43_0_0React/ABI43_0_0renderer/components/modal/ModalHostViewState.h>
...
@interface ABI43_0_0RCTModalHostViewComponentView () <ABI43_0_0RCTFabricModalHostViewControllerDelegate>

@end

@implementation ABI43_0_0RCTModalHostViewComponentView {
  ABI43_0_0RCTFabricModalHostViewController *_viewController;
...
- (ABI43_0_0RCTFabricModalHostViewController *)viewController
{
  if (!_viewController) {
    _viewController = [ABI43_0_0RCTFabricModalHostViewController new];
...
{
  UIViewController *controller = [self ABI43_0_0ReactViewController];
...
#pragma mark - ABI43_0_0RCTFabricModalHostViewControllerDelegate
...
- (void)boundsDidChange:(CGRect)newBounds
{
  ...
  auto newState = ModalHostViewState{ABI43_0_0RCTSizeFromCGSize(newBounds.size)};
