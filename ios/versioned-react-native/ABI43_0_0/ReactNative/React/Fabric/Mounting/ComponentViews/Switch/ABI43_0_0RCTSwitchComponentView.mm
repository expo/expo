...
#import "ABI43_0_0RCTSwitchComponentView.h"

#import <ABI43_0_0React/ABI43_0_0RCTConversions.h>

#import <ABI43_0_0React/ABI43_0_0renderer/components/rncore/ComponentDescriptors.h>
#import <ABI43_0_0React/ABI43_0_0renderer/components/rncore/EventEmitters.h>
#import <ABI43_0_0React/ABI43_0_0renderer/components/rncore/Props.h>
#import <ABI43_0_0React/ABI43_0_0renderer/components/rncore/ABI43_0_0RCTComponentViewHelpers.h>

#import "ABI43_0_0RCTFabricComponentsPlugins.h"

using namespace ABI43_0_0facebook::ABI43_0_0React;

@interface ABI43_0_0RCTSwitchComponentView () <ABI43_0_0RCTSwitchViewProtocol>
@end

@implementation ABI43_0_0RCTSwitchComponentView {
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldSwitchProps.tintColor != newSwitchProps.tintColor) {
    _switchView.tintColor = ABI43_0_0RCTUIColorFromSharedColor(newSwitchProps.tintColor);
  }

  // `onTintColor
  if (oldSwitchProps.onTintColor != newSwitchProps.onTintColor) {
    _switchView.onTintColor = ABI43_0_0RCTUIColorFromSharedColor(newSwitchProps.onTintColor);
  }

  // `thumbTintColor`
  if (oldSwitchProps.thumbTintColor != newSwitchProps.thumbTintColor) {
    _switchView.thumbTintColor = ABI43_0_0RCTUIColorFromSharedColor(newSwitchProps.thumbTintColor);
  }
...
{
  ABI43_0_0RCTSwitchHandleCommand(self, commandName, args);
}
...
Class<ABI43_0_0RCTComponentViewProtocol> ABI43_0_0RCTSwitchCls(void)
{
  return ABI43_0_0RCTSwitchComponentView.class;
}
