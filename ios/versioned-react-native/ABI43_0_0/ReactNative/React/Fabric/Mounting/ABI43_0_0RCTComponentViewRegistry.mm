...
const NSInteger ABI43_0_0RCTComponentViewRegistryRecyclePoolMaxSize = 1024;

@implementation ABI43_0_0RCTComponentViewRegistry {
  better::map<Tag, ABI43_0_0RCTComponentViewDescriptor> _registry;
  better::map<ComponentHandle, std::vector<ABI43_0_0RCTComponentViewDescriptor>> _recyclePool;
}

- (instancetype)init
{
  if (self = [super init]) {
    _componentViewFactory = [ABI43_0_0RCTComponentViewFactory standardComponentViewFactory];
...
{
  if (ABI43_0_0RCTExperimentGetPreemptiveViewAllocationDisabled()) {
    return;
  }
  ...
  std::vector<std::pair<ComponentHandle, float>> componentMagnitudes = {
      {[ABI43_0_0RCTViewComponentView componentDescriptorProvider].handle, 1},
      {[ABI43_0_0RCTImageComponentView componentDescriptorProvider].handle, 0.3},
      {[ABI43_0_0RCTParagraphComponentView componentDescriptorProvider].handle, 0.3},
  };
...
- (ABI43_0_0RCTComponentViewDescriptor const &)dequeueComponentViewWithComponentHandle:(ComponentHandle)componentHandle
                                                                          tag:(Tag)tag
{
  ...
  ABI43_0_0RCTAssert(
      ...
      @"ABI43_0_0RCTComponentViewRegistry: Attempt to dequeue already registered component.");
                        ...
                        componentViewDescriptor:(ABI43_0_0RCTComponentViewDescriptor)componentViewDescriptor
{
  ...
  ABI43_0_0RCTAssert(
      _registry.find(tag) != _registry.end(), @"ABI43_0_0RCTComponentViewRegistry: Attempt to enqueue unregistered component.");
...
- (ABI43_0_0RCTComponentViewDescriptor const &)componentViewDescriptorWithTag:(Tag)tag
{
  ABI43_0_0RCTAssertMainQueue();
  auto iterator = _registry.find(tag);
  ABI43_0_0RCTAssert(iterator != _registry.end(), @"ABI43_0_0RCTComponentViewRegistry: Attempt to query unregistered component.");
  return iterator->second;
}

- (nullable UIView<ABI43_0_0RCTComponentViewProtocol> *)findComponentViewWithTag:(Tag)tag
{
  ABI43_0_0RCTAssertMainQueue();
  auto iterator = _registry.find(tag);
...
- (ABI43_0_0RCTComponentViewDescriptor)_dequeueComponentViewWithComponentHandle:(ComponentHandle)componentHandle
{
  ABI43_0_0RCTAssertMainQueue();
                         ...
                         componentViewDescriptor:(ABI43_0_0RCTComponentViewDescriptor)componentViewDescriptor
{
  ...
  if (recycledViews.size() > ABI43_0_0RCTComponentViewRegistryRecyclePoolMaxSize) {
    return;
  }

  ABI43_0_0RCTAssert(
      componentViewDescriptor.view.superview == nil, @"ABI43_0_0RCTComponentViewRegistry: Attempt to recycle a mounted view.");
