 ...
 */
class ABI43_0_0RCTComponentViewDescriptor final {
 public:
  /*
   * Associated (and owned) native view instance.
   */
  __strong UIView<ABI43_0_0RCTComponentViewProtocol> *view = nil;

  /*
   * Indicates a requirement to call on the view methods from
   * `ABI43_0_0RCTMountingTransactionObserving` protocol.
   */
  bool observesMountingTransactionWillMount{false};
  bool observesMountingTransactionDidMount{false};
};

inline bool operator==(ABI43_0_0RCTComponentViewDescriptor const &lhs, ABI43_0_0RCTComponentViewDescriptor const &rhs)
{
...
template <>
struct std::hash<ABI43_0_0RCTComponentViewDescriptor> {
  size_t operator()(ABI43_0_0RCTComponentViewDescriptor const &componentViewDescriptor) const
  {
