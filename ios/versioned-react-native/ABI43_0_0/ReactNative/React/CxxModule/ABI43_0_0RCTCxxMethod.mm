...
#import <ABI43_0_0cxxreact/ABI43_0_0JsArgumentHelpers.h>

#import "ABI43_0_0RCTCxxUtils.h"

#import <memory>

using ABI43_0_0facebook::xplat::module::CxxModule;
using namespace ABI43_0_0facebook::ABI43_0_0React;

@implementation ABI43_0_0RCTCxxMethod {
...
- (id)invokeWithBridge:(ABI43_0_0RCTBridge *)bridge module:(id)module arguments:(NSArray *)arguments
{
  ...
  if (arguments.count < _method->callbacks) {
    ABI43_0_0RCTLogError(
        ...
        ABI43_0_0RCTBridgeModuleNameForClass([module class]),
        _method->name.c_str(),
        _method->callbacks,
        arguments.count);
    return nil;
  ...
  } catch (const ABI43_0_0facebook::xplat::JsArgumentException &ex) {
    ABI43_0_0RCTLogError(
