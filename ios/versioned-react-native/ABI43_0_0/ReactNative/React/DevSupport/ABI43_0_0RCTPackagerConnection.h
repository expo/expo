...
@protocol ABI43_0_0RCTPackagerClientMethod;
@class ABI43_0_0RCTPackagerClientResponder;

typedef uint32_t ABI43_0_0RCTHandlerToken;
typedef void (^ABI43_0_0RCTNotificationHandler)(NSDictionary<NSString *, id> *);
typedef void (^ABI43_0_0RCTRequestHandler)(NSDictionary<NSString *, id> *, ABI43_0_0RCTPackagerClientResponder *);
typedef void (^ABI43_0_0RCTConnectedHandler)(void);

/** Encapsulates singleton connection to ABI43_0_0React Native packager. */
@interface ABI43_0_0RCTPackagerConnection : NSObject
 ...
 */
- (void)addHandler:(id<ABI43_0_0RCTPackagerClientMethod>)handler
