...
/**
 * An abstraction for a key-value store to manage ABI43_0_0RCTDevSettings behavior.
 * The default implementation persists settings using NSUserDefaults.
 */
@protocol ABI43_0_0RCTDevSettingsDataSource <NSObject>
...
@interface ABI43_0_0RCTDevSettings : ABI43_0_0RCTEventEmitter
...
/*
 * Whether shaking will show ABI43_0_0RCTDevMenu. The menu is enabled by default if ABI43_0_0RCT_DEV=1, but
...
- (void)addHandler:(id<ABI43_0_0RCTPackagerClientMethod>)handler
    forPackagerMethod:(NSString *)name __deprecated_msg("Use ABI43_0_0RCTPackagerConnection directly instead");
#endif

@end

@interface ABI43_0_0RCTBridge (ABI43_0_0RCTDevSettings)

@property (nonatomic, readonly) ABI43_0_0RCTDevSettings *devSettings;
...
// (i.e. ABI43_0_0RCT_DEV or ABI43_0_0RCT_DEV_MENU is set)
ABI43_0_0RCT_EXTERN void ABI43_0_0RCTDevSettingsSetEnabled(BOOL enabled);
