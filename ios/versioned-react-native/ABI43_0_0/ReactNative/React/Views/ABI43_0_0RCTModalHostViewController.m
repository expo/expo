...
@implementation ABI43_0_0RCTModalHostViewController {
...
- (instancetype)init
{
  ...
  _preferredStatusBarStyle = [ABI43_0_0RCTSharedApplication() statusBarStyle];
  _preferredStatusBarHidden = [ABI43_0_0RCTSharedApplication() isStatusBarHidden];
