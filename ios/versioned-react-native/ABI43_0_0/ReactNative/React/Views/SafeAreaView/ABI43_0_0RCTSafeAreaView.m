...
@implementation ABI43_0_0RCTSafeAreaView {
...
{
  UIViewController *vc = self.ABI43_0_0ReactViewController;
...
{
  if (UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI43_0_0RCTScreenScale())) {
    return;
  }

  _currentSafeAreaInsets = safeAreaInsets;

  ABI43_0_0RCTSafeAreaViewLocalData *localData = [[ABI43_0_0RCTSafeAreaViewLocalData alloc] initWithInsets:safeAreaInsets];
