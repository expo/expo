...
#import "ABI43_0_0RCTRedBoxExtraDataViewController.h"

@interface ABI43_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI43_0_0RCTRedBoxExtraDataCell
...
@interface ABI43_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI43_0_0RCTRedBoxExtraDataViewController {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  ABI43_0_0RCTRedBoxExtraDataCell *cell =
      (ABI43_0_0RCTRedBoxExtraDataCell *)[tableView dequeueReusableCellWithIdentifier:reuseIdentifier];

  if (cell == nil) {
    cell = [[ABI43_0_0RCTRedBoxExtraDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
  }
