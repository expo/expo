...
@interface ABI46_0_0EXSensorsManagerBinding ()

@property (nonatomic, strong) NSString *scopeKey;
@property (nonatomic, weak) id<ABI46_0_0EXSensorsManagerBindingDelegate> kernelService;

@end

@implementation ABI46_0_0EXSensorsManagerBinding

- (instancetype)initWithScopeKey:(NSString *)scopeKey andKernelService:(id<ABI46_0_0EXSensorsManagerBindingDelegate>)kernelService
{
  if (self = [super init]) {
    _scopeKey = scopeKey;
