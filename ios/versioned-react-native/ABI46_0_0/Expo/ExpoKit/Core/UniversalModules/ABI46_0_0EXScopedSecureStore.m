...
@interface ABI46_0_0EXSecureStore (Protected)
...
@interface ABI46_0_0EXScopedSecureStore ()
...
@implementation ABI46_0_0EXScopedSecureStore
         ...
         withOptions:(NSDictionary *)options
{
  ...
  if (setValue) {
    ...
    ABI46_0_0EXLogWarn(@"Encountered an error while saving SecureStore data: %@.", [[super class] _messageForError:error]);
  }
}
