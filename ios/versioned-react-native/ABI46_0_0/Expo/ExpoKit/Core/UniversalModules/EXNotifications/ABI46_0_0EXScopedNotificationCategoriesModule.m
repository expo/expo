...
#import "ABI46_0_0EXScopedNotificationCategoryMigrator.h"
...
@implementation ABI46_0_0EXScopedNotificationCategoriesModule
...
- (void)getNotificationCategoriesAsyncWithResolver:(ABI46_0_0EXPromiseResolveBlock)resolve reject:(ABI46_0_0EXPromiseRejectBlock)reject
{
  [[UNUserNotificationCenter currentNotificationCenter] getNotificationCategoriesWithCompletionHandler:^(NSSet<UNNotificationCategory *> *categories) {
    ...
    for (UNNotificationCategory *category in categories) {
      if ([ABI46_0_0EXScopedNotificationsUtils isId:category.identifier scopedByExperience:self->_scopeKey]) {
...
{
  NSString *scopedCategoryIdentifier = [ABI46_0_0EXScopedNotificationsUtils scopedIdentifierFromId:categoryId
...
- (NSMutableDictionary *)serializeCategory:(UNNotificationCategory *)category
{
  ...
  serializedCategory[@"identifier"] = [ABI46_0_0EXScopedNotificationsUtils getScopeAndIdentifierFromScopedIdentifier:serializedCategory[@"identifier"]].identifier;
                                                                         ...
                                                                         isInExpoGo:(BOOL)isInExpoGo __deprecated_msg("To be removed once SDK 43 is phased out")
{
  if (isInExpoGo) {
    ...
    [ABI46_0_0EXScopedNotificationCategoryMigrator migrateLegacyScopedCategoryIdentifiersForProjectWithScopeKey:scopeKey];
  } else {
    // Used to prefix with "experienceId-" even in standalone apps in SDKs <= 40, so we need to unscope those
    [ABI46_0_0EXScopedNotificationCategoryMigrator unscopeLegacyCategoryIdentifiersForProjectWithScopeKey:scopeKey];
  }
}
