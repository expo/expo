...
@interface ABI46_0_0EXScopedNotificationBuilder ()
...
@implementation ABI46_0_0EXScopedNotificationBuilder
...
- (UNNotificationContent *)notificationContentFromRequest:(NSDictionary *)request
{
  ...
  if (content.categoryIdentifier && _isInExpoGo) {
    NSString *scopedCategoryIdentifier = [ABI46_0_0EXScopedNotificationsUtils scopedIdentifierFromId:content.categoryIdentifier
