...
@interface ABI46_0_0EXAppState ()

@property (nonatomic, assign) BOOL isObserving;

@end

@implementation ABI46_0_0EXAppState

+ (NSString *)moduleName { return @"ABI46_0_0RCTAppState"; }
...
- (void)setState:(NSString *)state
{
  if (![state isEqualToString:_lastKnownState]) {
    ...
    // TODO: just make ABI46_0_0EXAppState an expo module implementing ABI46_0_0EXAppLifecycleService
    id<ABI46_0_0EXAppLifecycleService> lifeCycleManager = [[[self.bridge moduleForClass:[ABI46_0_0EXModuleRegistryHolderReactModule class]] exModuleRegistry] getModuleImplementingProtocol:@protocol(ABI46_0_0EXAppLifecycleService)];
...
ABI46_0_0RCT_EXPORT_METHOD(getCurrentAppState:(ABI46_0_0RCTResponseSenderBlock)callback
                  error:(__unused ABI46_0_0RCTResponseSenderBlock)error)
{
