...
@interface ABI46_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI46_0_0AIRGMSMarker*)marker;
@end

@implementation ABI46_0_0AIRGoogleMapMarker {
  ABI46_0_0RCTImageLoaderCancellationBlock _reloadImageCancellationBlock;
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI46_0_0AIRGMSMarker alloc] init];
...
- (void)insertABI46_0_0ReactSubview:(id<ABI46_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI46_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI46_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI46_0_0AIRDummyView *dummySubview = [[ABI46_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertABI46_0_0ReactSubview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeABI46_0_0ReactSubview:(id<ABI46_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI46_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeABI46_0_0ReactSubview:(UIView*)dummySubview];
}
...
- (ABI46_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/ABI46_0_0React-native-maps/ABI46_0_0React-native-maps/issues/738)
  ...
  _reloadImageCancellationBlock = [[_bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI46_0_0RCTConvert NSURLRequest:_imageSrc]
                                                                          size:self.bounds.size
                                                                         scale:ABI46_0_0RCTScreenScale()
                                                                       clipped:YES
                                                                    resizeMode:ABI46_0_0RCTResizeModeCenter
                                                                 progressBlock:nil
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI46_0_0RN?
...
- (void)setIconSrc:(NSString *)iconSrc
{
  ...
  _reloadImageCancellationBlock =
  [[_bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI46_0_0RCTConvert NSURLRequest:_iconSrc]
                                          size:self.bounds.size
                                         scale:ABI46_0_0RCTScreenScale()
                                       clipped:YES
                                    resizeMode:ABI46_0_0RCTResizeModeCenter
