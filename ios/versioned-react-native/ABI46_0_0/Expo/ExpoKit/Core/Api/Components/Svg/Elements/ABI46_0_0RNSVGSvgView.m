...
@implementation ABI46_0_0RNSVGSvgView
{
    NSMutableDictionary<NSString *, ABI46_0_0RNSVGNode *> *_clipPaths;
    NSMutableDictionary<NSString *, ABI46_0_0RNSVGNode *> *_templates;
    NSMutableDictionary<NSString *, ABI46_0_0RNSVGPainter *> *_painters;
    NSMutableDictionary<NSString *, ABI46_0_0RNSVGNode *> *_markers;
    NSMutableDictionary<NSString *, ABI46_0_0RNSVGNode *> *_masks;
...
- (void)invalidate
{
    ...
    if ([parent isKindOfClass:[ABI46_0_0RNSVGNode class]]) {
        ...
        ABI46_0_0RNSVGNode* svgNode = (ABI46_0_0RNSVGNode*)parent;
        [svgNode invalidate];
        rendered = false;
        return;
    }
...
- (void)setBbWidth:(ABI46_0_0RNSVGLength *)bbWidth
{
...
- (void)setBbHeight:(ABI46_0_0RNSVGLength *)bbHeight
{
...
- (void)drawToContext:(CGContextRef)context withRect:(CGRect)rect {
    ...
    if (self.align) {
        ...
        _viewBoxTransform = [ABI46_0_0RNSVGViewBox getTransform:tRect
                                                 eRect:rect
                                                 align:self.align
    ...
    for (ABI46_0_0RNSVGView *node in self.subviews) {
        if ([node isKindOfClass:[ABI46_0_0RNSVGNode class]]) {
            ABI46_0_0RNSVGNode *svg = (ABI46_0_0RNSVGNode *)node;
...
- (void)drawRect:(CGRect)rect
{
    ...
    for (ABI46_0_0RNSVGPlatformView *node in self.subviews) {
        if ([node isKindOfClass:[ABI46_0_0RNSVGNode class]]) {
            ABI46_0_0RNSVGNode *svg = (ABI46_0_0RNSVGNode *)node;
...
- (ABI46_0_0RNSVGPlatformView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    for (ABI46_0_0RNSVGNode *node in [self.subviews reverseObjectEnumerator]) {
        if (![node isKindOfClass:[ABI46_0_0RNSVGNode class]]) {
            continue;
        }
        ...
        ABI46_0_0RNSVGPlatformView *hitChild = [node hitTest:transformed withEvent:event];
...
- (void)defineTemplate:(ABI46_0_0RNSVGNode *)template templateName:(NSString *)templateName
{
    if (!_templates) {
