...
@implementation ABI46_0_0RNSVGLength
...
{
    ABI46_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype) lengthWithString: (NSString *) lengthString {
    ...
    ABI46_0_0RNSVGLength *output = [ABI46_0_0RNSVGLength alloc];
    if (stringLength == 0) {
        ...
        ABI46_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
