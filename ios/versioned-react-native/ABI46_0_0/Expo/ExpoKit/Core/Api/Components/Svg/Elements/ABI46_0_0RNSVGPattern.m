...
#import "ABI46_0_0RNSVGBrushType.h"
#import "ABI46_0_0RNSVGNode.h"

@implementation ABI46_0_0RNSVGPattern
...
{
    self.dirty = false;
    NSArray<ABI46_0_0RNSVGLength *> *points = @[self.x, self.y, self.patternwidth, self.patternheight];
    ABI46_0_0RNSVGPainter *painter = [[ABI46_0_0RNSVGPainter alloc] initWithPointsArray:points];
...
- (void)setPatternwidth:(ABI46_0_0RNSVGLength *)patternwidth
{
...
- (void)setPatternheight:(ABI46_0_0RNSVGLength *)patternheight
{
...
- (void)setPatternUnits:(ABI46_0_0RNSVGUnits)patternUnits
{
...
- (void)setPatternContentUnits:(ABI46_0_0RNSVGUnits)patternContentUnits
{
...
- (void)setMeetOrSlice:(ABI46_0_0RNSVGVBMOS)meetOrSlice
{
