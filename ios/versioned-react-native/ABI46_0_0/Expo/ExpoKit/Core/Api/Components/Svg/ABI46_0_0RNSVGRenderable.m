...
#import <ABI46_0_0React/ABI46_0_0RCTPointerEvents.h>
#import "ABI46_0_0RNSVGRenderable.h"
#import "ABI46_0_0RNSVGClipPath.h"
#import "ABI46_0_0RNSVGMask.h"
#import "ABI46_0_0RNSVGViewBox.h"
#import "ABI46_0_0RNSVGVectorEffect.h"
#import "ABI46_0_0RNSVGBezierElement.h"
#import "ABI46_0_0RNSVGMarker.h"
#import "ABI46_0_0RNSVGMarkerPosition.h"

@implementation ABI46_0_0RNSVGRenderable
{
    NSMutableDictionary *_originProperties;
    NSArray<NSString *> *_lastMergedList;
    NSArray<NSString *> *_attributeList;
    NSArray<ABI46_0_0RNSVGLength *> *_sourceStrokeDashArray;
    CGFloat *_strokeDashArrayData;
    CGPathRef _srcHitPath;
}

static ABI46_0_0RNSVGRenderable * _contextElement;
+ (ABI46_0_0RNSVGRenderable *)contextElement { return _contextElement; }
+ (void)setContextElement:(ABI46_0_0RNSVGRenderable *)contextElement { _contextElement = contextElement; }
...
- (id)init
{
    if (self = [super init]) {
        _fillOpacity = 1;
        _strokeOpacity = 1;
        _strokeWidth = [ABI46_0_0RNSVGLength lengthWithNumber:1];
...
- (void)setFill:(ABI46_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI46_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI46_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)setStrokeWidth:(ABI46_0_0RNSVGLength*)strokeWidth
{
...
- (void)setStrokeDasharray:(NSArray<ABI46_0_0RNSVGLength *> *)strokeDasharray
{
...
- (void)setVectorEffect:(ABI46_0_0RNSVGVectorEffect)vectorEffect
{
...
UInt32 ABI46_0_0saturate(CGFloat value) {
...
- (void)renderTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    if (self.mask) {
        ...
        ABI46_0_0RNSVGMask *_maskNode = (ABI46_0_0RNSVGMask*)[self.svgView getDefinedMask:self.mask];
        ...
        for (NSUInteger i = 0; i < npixels; i++) {
            ...
            *currentPixel = ABI46_0_0saturate(luma) << 24;
            currentPixel++;
        }
...
- (void)prepareStrokeDash:(NSUInteger)count strokeDasharray:(NSArray<ABI46_0_0RNSVGLength *> *)strokeDasharray {
...
- (void)renderMarkers:(CGContextRef)context path:(CGPathRef)path rect:(const CGRect *)rect {
    ABI46_0_0RNSVGMarker *markerStart = (ABI46_0_0RNSVGMarker*)[self.svgView getDefinedMarker:self.markerStart];
    ABI46_0_0RNSVGMarker *markerMid = (ABI46_0_0RNSVGMarker*)[self.svgView getDefinedMarker:self.markerMid];
    ABI46_0_0RNSVGMarker *markerEnd = (ABI46_0_0RNSVGMarker*)[self.svgView getDefinedMarker:self.markerEnd];
    if (markerStart || markerMid || markerEnd) {
        _contextElement = self;
        NSArray<ABI46_0_0RNSVGMarkerPosition*>* positions = [ABI46_0_0RNSVGMarkerPosition fromCGPath:path];
        ...
        for (ABI46_0_0RNSVGMarkerPosition* position in positions) {
            ABI46_0_0RNSVGMarkerType type = [position type];
            ABI46_0_0RNSVGMarker *marker;
            switch (type) {
                case kStartMarker:
                    marker = markerStart;
                    break;
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    if (self.stroke) {
        ...
        NSArray<ABI46_0_0RNSVGLength *>* strokeDasharray = self.strokeDasharray;
...
- (ABI46_0_0RNSVGPlatformView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    BOOL canReceiveTouchEvents = (self.pointerEvents != ABI46_0_0RCTPointerEventsNone && ![self isHidden]);
    ...
    if (self.clipPath) {
        ABI46_0_0RNSVGClipPath *clipNode = (ABI46_0_0RNSVGClipPath*)[self.svgView getDefinedClipPath:self.clipPath];
        if ([clipNode isSimpleClipPath]) {
            ...
            ABI46_0_0RNSVGRenderable *clipGroup = (ABI46_0_0RNSVGRenderable*)clipNode;
...
- (void)mergeProperties:(__kindof ABI46_0_0RNSVGRenderable *)target
{
