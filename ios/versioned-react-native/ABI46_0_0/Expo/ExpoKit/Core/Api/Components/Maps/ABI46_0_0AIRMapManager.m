...
#import "ABI46_0_0AIRMapManager.h"
...
#import "ABI46_0_0AIRMapSnapshot.h"
#import "ABI46_0_0RCTConvert+AirMap.h"
#import "ABI46_0_0AIRMapOverlay.h"
#import "ABI46_0_0AIRWeakTimerReference.h"
#import "ABI46_0_0AIRWeakMapReference.h"
#import <MapKit/MapKit.h>

static NSString *const ABI46_0_0RCTMapViewKey = @"MapView";


@interface ABI46_0_0AIRMapManager() <MKMapViewDelegate, UIGestureRecognizerDelegate>

- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer;

@end

@implementation ABI46_0_0AIRMapManager{
   BOOL _hasObserver;
}
...
- (UIView *)view
{
    ABI46_0_0AIRMap *map = [ABI46_0_0AIRMap new];
    map.delegate = self;
...
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(userLocationAnnotationTitle, NSString)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(userInterfaceStyle, NSString)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(userLocationCalloutEnabled, BOOL)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(showsPointsOfInterest, BOOL)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
...
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(maxDelta, CGFloat)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(minDelta, CGFloat)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(compassOffset, CGPoint)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(legalLabelInsets, UIEdgeInsets)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(mapPadding, UIEdgeInsets)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, MKMapType)
...
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onDoublePress, ABI46_0_0RCTBubblingEventBlock)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerPress, ABI46_0_0RCTDirectEventBlock)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI46_0_0RCTDirectEventBlock)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI46_0_0RCTDirectEventBlock)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI46_0_0RCTDirectEventBlock)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI46_0_0RCTDirectEventBlock)
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI46_0_0RCTDirectEventBlock)
...
ABI46_0_0RCT_CUSTOM_VIEW_PROPERTY(initialRegion, MKCoordinateRegion, ABI46_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setInitialRegion:[ABI46_0_0RCTConvert MKCoordinateRegion:json]];
    view.ignoreRegionChanges = originalIgnore;
}
ABI46_0_0RCT_CUSTOM_VIEW_PROPERTY(initialCamera, MKMapCamera, ABI46_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setInitialCamera:[ABI46_0_0RCTConvert MKMapCamera:json]];
    view.ignoreRegionChanges = originalIgnore;
}
...
ABI46_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI46_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setRegion:[ABI46_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}

ABI46_0_0RCT_CUSTOM_VIEW_PROPERTY(camera, MKMapCamera*, ABI46_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setCamera:[ABI46_0_0RCTConvert MKMapCamera:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}
                  ...
                  rejecter:(ABI46_0_0RCTPromiseRejectBlock)reject)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI46_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI46_0_0AIRMap class]]) {
                  ...
                  rejecter:(ABI46_0_0RCTPromiseRejectBlock)reject)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI46_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        id view = viewRegistry[ABI46_0_0ReactTag];
        ABI46_0_0AIRMap *mapView = (ABI46_0_0AIRMap *)view;
        if (![view isKindOfClass:[ABI46_0_0AIRMap class]]) {
            reject(@"Invalid argument", [NSString stringWithFormat:@"Invalid view returned from registry, expecting ABI46_0_0AIRMap, got: %@", view], NULL);
        } else {
                  ...
                  camera:(id)json)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI46_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI46_0_0AIRMap class]]) {
            ...
            MKMapCamera *camera = [ABI46_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:[mapView camera]];
                  ...
                  withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI46_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI46_0_0AIRMap class]]) {
            ...
            BOOL originalIgnore = mapView.ignoreRegionChanges;
            mapView.ignoreRegionChanges = YES;
            [ABI46_0_0AIRMap animateWithDuration:duration/1000 animations:^{
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI46_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI46_0_0AIRMap class]]) {
            ...
            [ABI46_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI46_0_0AIRMap *)view setRegion:region animated:YES];
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI46_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI46_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ABI46_0_0AIRMapMarker *marker = (ABI46_0_0AIRMapMarker *)evaluatedObject;
                return [marker isKindOfClass:[ABI46_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
...
ABI46_0_0RCT_EXPORT_METHOD(getAddressFromCoordinates:(nonnull NSNumber *)ABI46_0_0ReactTag
                                 coordinate: (NSDictionary *)coordinate
                                   resolver: (ABI46_0_0RCTPromiseResolveBlock)resolve
                                   rejecter:(ABI46_0_0RCTPromiseRejectBlock)reject)
{
...
- (void)takeMapSnapshot:(ABI46_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI46_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI46_0_0AIRMap *map = (ABI46_0_0AIRMap *)recognizer.view;
    ...
    ABI46_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI46_0_0AIRMapPolygon class]]){
            ABI46_0_0AIRMapPolygon *polygon = (ABI46_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI46_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI46_0_0AIRMapPolyline class]]){
            ABI46_0_0AIRMapPolyline *polyline = (ABI46_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
        ...
        if ([overlay isKindOfClass:[ABI46_0_0AIRMapOverlay class]]) {
            ABI46_0_0AIRMapOverlay *imageOverlay = (ABI46_0_0AIRMapOverlay*) overlay;
    ...
    if (nearestDistance <= maxMeters) {
        ABI46_0_0AIRMapCoordinate *firstCoord = nearestPolyline.coordinates.firstObject;
        id event = @{
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI46_0_0AIRMapPolyline class]]) {
        return ((ABI46_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI46_0_0AIRMapPolygon class]]) {
        return ((ABI46_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI46_0_0AIRMapCircle class]]) {
        return ((ABI46_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI46_0_0AIRMapUrlTile class]]) {
        return ((ABI46_0_0AIRMapUrlTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI46_0_0AIRMapWMSTile class]]) {
        return ((ABI46_0_0AIRMapWMSTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI46_0_0AIRMapLocalTile class]]) {
        return ((ABI46_0_0AIRMapLocalTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI46_0_0AIRMapOverlay class]]) {
        return ((ABI46_0_0AIRMapOverlay *)overlay).renderer;
...
- (void)mapView:(ABI46_0_0AIRMap *)mapView didAddAnnotationViews:(NSArray<MKAnnotationView *> *)views
{
...
- (void)mapView:(ABI46_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI46_0_0AIRMapMarker class]]) {
        [(ABI46_0_0AIRMapMarker *)view.annotation showCalloutView];
...
- (void)mapView:(ABI46_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI46_0_0AIRMapMarker class]]) {
        [(ABI46_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI46_0_0AIRMap *)mapView viewForAnnotation:(ABI46_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI46_0_0AIRMapMarker class]]) {
...
- (void)mapView:(ABI46_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI46_0_0AIRMapMarker class]]) return;
    ABI46_0_0AIRMapMarker *marker = (ABI46_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI46_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI46_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    id event = @{@"coordinate": @{
    ...
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI46_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI46_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI46_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    ...
    ABI46_0_0AIRWeakTimerReference *weakTarget = [[ABI46_0_0AIRWeakTimerReference alloc] initWithTarget:self andSelector:@selector(_onTick:)];
    
    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI46_0_0AIRMapRegionChangeObserveInterval
                                                               target:weakTarget
                                                             selector:@selector(timerDidFire:)
                                                             userInfo:@{ ABI46_0_0RCTMapViewKey: [[ABI46_0_0AIRWeakMapReference alloc] initWithMapView: mapView] }
                                                              repeats:YES];

    [[NSRunLoop mainRunLoop] addTimer:mapView.regionChangeObserveTimer forMode:NSRunLoopCommonModes];
}

- (void)mapView:(ABI46_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI46_0_0AIRMap *)mapView
{
    if (!mapView.hasStartedRendering) {
      mapView.onMapReady(@{});
...
- (void)mapViewDidFinishRenderingMap:(ABI46_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
{
    ABI46_0_0AIRWeakMapReference *weakRef = timer.userInfo[ABI46_0_0RCTMapViewKey];
    [self _regionChanged:weakRef.mapView];
}

- (void)_regionChanged:(ABI46_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI46_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI46_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI46_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI46_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI46_0_0AIRMap *)mapView
{
...
- (MKCoordinateSpan)coordinateSpanWithMapView:(ABI46_0_0AIRMap *)mapView
                             centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                 andZoomLevel:(double)zoomLevel
{
    // convert center coordiate to pixel space
    double centerPixelX = [ABI46_0_0AIRMapManager longitudeToPixelSpaceX:centerCoordinate.longitude];
    double centerPixelY = [ABI46_0_0AIRMapManager latitudeToPixelSpaceY:centerCoordinate.latitude];

    // determine the scale value from the zoom level
    double zoomExponent = ABI46_0_0AIRMapMaxZoomLevel - zoomLevel;
    ...
    CLLocationDegrees minLng = [ABI46_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX];
    CLLocationDegrees maxLng = [ABI46_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX + scaledMapWidth];
    CLLocationDegrees longitudeDelta = maxLng - minLng;

    // find delta between top and bottom latitudes
    CLLocationDegrees minLat = [ABI46_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY];
    CLLocationDegrees maxLat = [ABI46_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY + scaledMapHeight];
                    ...
                    mapView:(ABI46_0_0AIRMap *)mapView
{
    ...
    zoomLevel = MIN(zoomLevel, ABI46_0_0AIRMapMaxZoomLevel);
                                    ...
                                    andZoomLevel:(double)zoomLevel
{
	...
	// find delta between top and bottom latitudes
	CLLocationDegrees minLat = [ABI46_0_0AIRMapManager pixelSpaceYToLatitude:topPixelY];
	CLLocationDegrees maxLat = [ABI46_0_0AIRMapManager pixelSpaceYToLatitude:bottomPixelY];
	CLLocationDegrees latitudeDelta = -1 * (maxLat - minLat);
	...
	if (adjustedCenterPoint) {
		region.center.latitude = [ABI46_0_0AIRMapManager pixelSpaceYToLatitude:((bottomPixelY + topPixelY) / 2.0)];
	}
...
- (double) zoomLevel:(ABI46_0_0AIRMap *)mapView {
    ...
    double centerPixelX = [ABI46_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude];
    double topLeftPixelX = [ABI46_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude - region.span.longitudeDelta / 2];

    double scaledMapWidth = (centerPixelX - topLeftPixelX) * 2;
    CGSize mapSizeInPixels = mapView.bounds.size;
    double zoomScale = scaledMapWidth / mapSizeInPixels.width;
    double zoomExponent = log(zoomScale) / log(2);
    double zoomLevel = ABI46_0_0AIRMapMaxZoomLevel - zoomExponent;
...
- (void)mapView:(ABI46_0_0AIRMap *)mapView didFailToLocateUserWithError:(NSError *)error {
