//
//  ABI46_0_0AIRGoogleMapWMSTile.h
//  AirMaps
//
...
@interface ABI46_0_0WMSTileOverlay : GMSSyncTileLayer
...
@interface ABI46_0_0AIRGoogleMapWMSTile : UIView
@property (nonatomic, strong) ABI46_0_0WMSTileOverlay *tileLayer;
