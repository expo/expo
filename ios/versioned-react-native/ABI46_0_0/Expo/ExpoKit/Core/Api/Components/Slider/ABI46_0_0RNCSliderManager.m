...
- (UIView *)view
{
  ABI46_0_0RNCSlider *slider = [ABI46_0_0RNCSlider new];
...
- (void)tapHandler:(UITapGestureRecognizer *)gesture {
  if ([gesture.view class] != [ABI46_0_0RNCSlider class]) {
    return;
  }
  ABI46_0_0RNCSlider *slider = (ABI46_0_0RNCSlider *)gesture.view;
  ...
  // Trigger onValueChange to address https://github.com/ABI46_0_0React-native-community/ABI46_0_0React-native-slider/issues/212
...
static float discreteValue(ABI46_0_0RNCSlider *sender, float value) {
...
static void ABI46_0_0RNCSendSliderEvent(ABI46_0_0RNCSlider *sender, BOOL continuous, BOOL isSlidingStart)
{
...
- (void)sliderValueChanged:(ABI46_0_0RNCSlider *)sender
{
  ABI46_0_0RNCSendSliderEvent(sender, YES, NO);
}

- (void)sliderTouchStart:(ABI46_0_0RNCSlider *)sender
{
  ABI46_0_0RNCSendSliderEvent(sender, NO, YES);
  _isSliding = YES;
  sender.isSliding = YES;
}

- (void)sliderTouchEnd:(ABI46_0_0RNCSlider *)sender
{
  ABI46_0_0RNCSendSliderEvent(sender, NO, NO);
  _isSliding = NO;
  sender.isSliding = NO;
}

ABI46_0_0RCT_CUSTOM_VIEW_PROPERTY(value, float, ABI46_0_0RNCSlider)
{
  if (!view.isSliding) {
    view.value = [ABI46_0_0RCTConvert float:json];
  }
}
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(step, float);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(trackImage, UIImage);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(minimumTrackImage, UIImage);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(maximumTrackImage, UIImage);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(minimumValue, float);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(maximumValue, float);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(minimumTrackTintColor, UIColor);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(maximumTrackTintColor, UIColor);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onRNCSliderValueChange, ABI46_0_0RCTBubblingEventBlock);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onRNCSliderSlidingStart, ABI46_0_0RCTBubblingEventBlock);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(onRNCSliderSlidingComplete, ABI46_0_0RCTBubblingEventBlock);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(thumbTintColor, UIColor);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(thumbImage, UIImage);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(inverted, BOOL);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(tapToSeek, BOOL);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(accessibilityUnits, NSString);
ABI46_0_0RCT_EXPORT_VIEW_PROPERTY(accessibilityIncrements, NSArray);

ABI46_0_0RCT_CUSTOM_VIEW_PROPERTY(disabled, BOOL, ABI46_0_0RNCSlider)
{
  if (json) {
