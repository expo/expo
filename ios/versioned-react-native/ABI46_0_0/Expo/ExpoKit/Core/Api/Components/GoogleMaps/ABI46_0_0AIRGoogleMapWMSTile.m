//
//  ABI46_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI46_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI46_0_0WMSTileOverlay *tile = [[ABI46_0_0WMSTileOverlay alloc] init];
...
@implementation ABI46_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
