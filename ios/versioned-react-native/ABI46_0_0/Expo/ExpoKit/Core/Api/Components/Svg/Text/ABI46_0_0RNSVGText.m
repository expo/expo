...
@implementation ABI46_0_0RNSVGText
{
    ABI46_0_0RNSVGGlyphContext *_glyphContext;
...
- (void)setInlineSize:(ABI46_0_0RNSVGLength *)inlineSize
{
...
- (void)setTextLength:(ABI46_0_0RNSVGLength *)textLength
{
...
- (void)setDeltaX:(NSArray<ABI46_0_0RNSVGLength *> *)deltaX
{
    if (deltaX == _deltaX) {
        return;
    }
...
- (void)setDeltaY:(NSArray<ABI46_0_0RNSVGLength *> *)deltaY
{
    if (deltaY == _deltaY) {
        return;
    }
...
- (void)setPositionX:(NSArray<ABI46_0_0RNSVGLength *>*)positionX
{
...
- (void)setPositionY:(NSArray<ABI46_0_0RNSVGLength *>*)positionY
{
...
- (void)setRotate:(NSArray<ABI46_0_0RNSVGLength *> *)rotate
{
    if (rotate == _rotate) {
        return;
    }
...
- (void)setupGlyphContext:(CGContextRef)context
{
    ...
    _glyphContext = [[ABI46_0_0RNSVGGlyphContext alloc] initWithWidth:size.width
                                                      height:size.height];
}
...
- (ABI46_0_0RNSVGText *)textRoot
{
    ABI46_0_0RNSVGText *root = self;
    while (root && [root class] != [ABI46_0_0RNSVGText class]) {
        if (![root isKindOfClass:[ABI46_0_0RNSVGText class]]) {
            //todo: throw exception here
            break;
        }
        root = (ABI46_0_0RNSVGText*)[root superview];
    }
...
- (NSString *)alignmentBaseline
{
    ...
    ABI46_0_0RNSVGPlatformView* parent = self.superview;
    while (parent != nil) {
        if ([parent isKindOfClass:[ABI46_0_0RNSVGText class]]) {
            ABI46_0_0RNSVGText* node = (ABI46_0_0RNSVGText*)parent;
    ...
    if (_alignmentBaseline == nil) {
        _alignmentBaseline = ABI46_0_0RNSVGAlignmentBaselineStrings[0];
    }
    return _alignmentBaseline;
}
...
- (ABI46_0_0RNSVGGlyphContext *)getGlyphContext
{
...
- (ABI46_0_0RNSVGText*)getTextAnchorRoot
{
    ...
    ABI46_0_0RNSVGText* node = self;
    ABI46_0_0RNSVGPlatformView* parent = [self superview];
    for (NSInteger i = [font count] - 1; i >= 0; i--) {
        ABI46_0_0RNSVGFontData* fontData = [font objectAtIndex:i];
        if (![parent isKindOfClass:[ABI46_0_0RNSVGText class]] ||
            fontData->textAnchor == ABI46_0_0RNSVGTextAnchorStart ||
            node.positionX != nil) {
            return node;
        }
        node = (ABI46_0_0RNSVGText*) parent;
