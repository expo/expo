//
//  ABI46_0_0RCTConvert+GMSMapViewType.m
//
...
@implementation ABI46_0_0RCTConvert (GMSMapViewType)
  ABI46_0_0RCT_ENUM_CONVERTER(GMSMapViewType,
  (
    @{
...
+ (GMSCameraPosition*)GMSCameraPosition:(id)json
{
    ...
    return [ABI46_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:nil];
}
