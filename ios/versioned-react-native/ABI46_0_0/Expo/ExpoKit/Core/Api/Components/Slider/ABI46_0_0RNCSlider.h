...
@property (nonatomic, copy) ABI46_0_0RCTBubblingEventBlock onRNCSliderSlidingStart;
@property (nonatomic, copy) ABI46_0_0RCTBubblingEventBlock onRNCSliderSlidingComplete;
