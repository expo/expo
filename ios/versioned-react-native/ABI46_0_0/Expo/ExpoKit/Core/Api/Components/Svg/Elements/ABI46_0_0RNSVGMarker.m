...
@implementation ABI46_0_0RNSVGMarker
...
- (void)setX:(ABI46_0_0RNSVGLength *)refX
{
...
- (void)setY:(ABI46_0_0RNSVGLength *)refY
{
...
- (void)setMarkerHeight:(ABI46_0_0RNSVGLength *)markerHeight
{
...
static CGFloat ABI46_0_0RNSVG_degToRad = (CGFloat)M_PI / 180;

double ABI46_0_0deg2rad(CGFloat deg) {
    return deg * ABI46_0_0RNSVG_degToRad;
}
...
- (void)renderMarker:(CGContextRef)context rect:(CGRect)rect position:(ABI46_0_0RNSVGMarkerPosition*)position strokeWidth:(CGFloat)strokeWidth
{
    ...
    float rad = ABI46_0_0deg2rad(angle);
    ...
    if (self.align) {
        CGAffineTransform viewBoxTransform = [ABI46_0_0RNSVGViewBox getTransform:CGRectMake(self.minX, self.minY, self.vbWidth, self.vbHeight)
                                                                  eRect:eRect
                                                                  align:self.align
