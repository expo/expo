...
@implementation ABI46_0_0RNSVGSolidColorBrush
{
    ABI46_0_0RNSVGColor *_color;
}

- (instancetype)initWithArray:(NSArray<ABI46_0_0RNSVGLength *> *)array
{
    if ((self = [super initWithArray:array])) {
        _color = [ABI46_0_0RCTConvert ABI46_0_0RNSVGColor:array offset:1];
    }
    return self;
}
...
{
    if ((self = [super init])) {
        _color = [ABI46_0_0RCTConvert ABI46_0_0RNSVGColor:number];
    }
    return self;
}
