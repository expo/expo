...
/**
 * ABI46_0_0RNSVG nodes are implemented as base NSViews/UIViews. They should be implementation for all basic
 ＊interfaces for all non-definition nodes.
 */

@interface ABI46_0_0RNSVGNode : ABI46_0_0RNSVGView
 ...
 */
extern CGFloat const ABI46_0_0RNSVG_M_SQRT1_2l;
extern CGFloat const ABI46_0_0RNSVG_DEFAULT_FONT_SIZE;

@property (nonatomic, strong) NSString *name;
@property (nonatomic, strong) NSString *display;
@property (nonatomic, assign) CGFloat opacity;
@property (nonatomic, assign) ABI46_0_0RNSVGCGFCRule clipRule;
 ...
 */
@property (nonatomic, assign) ABI46_0_0RCTPointerEvents pointerEvents;
...
/**
 * ABI46_0_0RNSVGSvgView which ownes current ABI46_0_0RNSVGNode
 */
@property (nonatomic, readonly, weak) ABI46_0_0RNSVGSvgView *svgView;
@property (nonatomic, readonly, weak) ABI46_0_0RNSVGGroup *textRoot;

- (void)invalidate;

- (ABI46_0_0RNSVGGroup *)getParentTextRoot;
...
- (CGFloat)relativeOn:(ABI46_0_0RNSVGLength *)length relative:(CGFloat)relative;

- (CGFloat)relativeOnWidth:(ABI46_0_0RNSVGLength *)length;

- (CGFloat)relativeOnHeight:(ABI46_0_0RNSVGLength *)length;

- (CGFloat)relativeOnOther:(ABI46_0_0RNSVGLength *)length;
...
- (void)traverseSubviews:(BOOL (^)(__kindof ABI46_0_0RNSVGView *node))block;
