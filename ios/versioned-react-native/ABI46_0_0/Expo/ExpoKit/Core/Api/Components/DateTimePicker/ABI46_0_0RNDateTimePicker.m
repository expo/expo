...
@property (nonatomic, assign) NSInteger ABI46_0_0ReactMinuteInterval;

@end

@implementation ABI46_0_0RNDateTimePicker
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if ((self = [super initWithFrame:frame])) {
    ...
    _ABI46_0_0ReactMinuteInterval = 1;
  }
  return self;
}
...
- (void)setDatePickerMode:(UIDatePickerMode)datePickerMode
{
  ...
  self.minuteInterval = _ABI46_0_0ReactMinuteInterval;
}

- (void)setMinuteInterval:(NSInteger)minuteInterval
{
  [super setMinuteInterval:minuteInterval];
  _ABI46_0_0ReactMinuteInterval = minuteInterval;
}
