//
//  ABI46_0_0RNSharedElementTransitionItem.m
...
@implementation ABI46_0_0RNSharedElementTransitionItem {
...
- (void) setNode:(ABI46_0_0RNSharedElementNode *)node
{
  if (_node == node) {
...
- (CGRect) contentLayoutForContent:(ABI46_0_0RNSharedElementContent*)content
{
  ...
  return [ABI46_0_0RNSharedElementContent layoutForRect:_style.layout content:content contentMode:_style.contentMode reverse:NO];
}
