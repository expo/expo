...
@implementation ABI46_0_0RCTConvert (AirMap)
...
{
    json = [self NSDictionary:json];
    return [ABI46_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:nil];
}
...
ABI46_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI46_0_0AIRMapCoordinate *)ABI46_0_0AIRMapCoordinate:(id)json
{
    ABI46_0_0AIRMapCoordinate *coord = [ABI46_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI46_0_0RCT_ARRAY_CONVERTER(ABI46_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI46_0_0AIRMapCoordinate *> *> *)ABI46_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI46_0_0RCTConvertArrayValue(@selector(ABI46_0_0AIRMapCoordinateArray:), json);
}
