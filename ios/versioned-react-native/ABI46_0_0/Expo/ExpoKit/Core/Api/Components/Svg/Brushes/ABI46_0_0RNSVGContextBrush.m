...
@implementation ABI46_0_0RNSVGContextBrush
{
    BOOL _isStroke;
}
...
{
    ABI46_0_0RNSVGRenderable *element = ABI46_0_0RNSVGRenderable.contextElement;
    if (!element) {
        return NO;
    }

    ABI46_0_0RNSVGBrush *brush = _isStroke ? element.stroke : element.fill;

    BOOL fillColor;

    if (brush.class == ABI46_0_0RNSVGBrush.class) {
