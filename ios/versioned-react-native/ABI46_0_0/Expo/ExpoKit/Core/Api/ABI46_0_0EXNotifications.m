...
#import "ABI46_0_0EXNotifications.h"
...
@interface ABI46_0_0EXNotifications ()

// unversioned ABI46_0_0EXRemoteNotificationManager instance
@property (nonatomic, weak) id <ABI46_0_0EXNotificationsScopedModuleDelegate> remoteNotificationsDelegate;
@property (nonatomic, weak) id <ABI46_0_0EXNotificationsIdentifiersManager> notificationsIdentifiersManager;
@property (nonatomic, weak) id <ABI46_0_0EXUserNotificationCenterService> userNotificationCenter;

@end

@implementation ABI46_0_0EXNotifications

ABI46_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentNotifications, @"RemoteNotificationManager", @"UserNotificationManager", @"UserNotificationCenter");
...
ABI46_0_0RCT_REMAP_METHOD(getDevicePushTokenAsync,
...
{
  ABI46_0_0EXConstantsBinding *constants = [[[self.bridge moduleForClass:[ABI46_0_0EXModuleRegistryHolderReactModule class]] exModuleRegistry] getModuleImplementingProtocol:@protocol(ABI46_0_0EXConstantsInterface)];
...
ABI46_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
                 getExponentPushTokenAsyncWithResolver:(ABI46_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI46_0_0RCTPromiseRejectBlock)reject)
{
...
ABI46_0_0RCT_EXPORT_METHOD(presentLocalNotification:(NSDictionary *)payload
                  resolver:(ABI46_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI46_0_0RCTPromiseRejectBlock)reject)
{
  ...
  ABI46_0_0RCT_EXPORT_METHOD(scheduleNotificationWithTimer:(NSDictionary *)payload
...
ABI46_0_0RCT_EXPORT_METHOD(scheduleNotificationWithCalendar:(NSDictionary *)payload
                 withOptions:(NSDictionary *)options
                 resolver:(ABI46_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI46_0_0RCTPromiseRejectBlock)reject)
{
...
ABI46_0_0RCT_EXPORT_METHOD(scheduleLocalNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI46_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI46_0_0RCTPromiseRejectBlock)reject)
{
...
ABI46_0_0RCT_EXPORT_METHOD(legacyScheduleLocalRepeatingNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI46_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI46_0_0RCTPromiseRejectBlock)reject)
{
  ...
  localNotification.applicationIconBadgeNumber = [ABI46_0_0RCTConvert NSInteger:payload[@"count"]] ?: 0;
  ...
  localNotification.fireDate = [ABI46_0_0RCTConvert NSDate:options[@"time"]] ?: [NSDate new];
  localNotification.repeatInterval = [ABI46_0_0RCTConvert NSCalendarUnit:options[@"repeat"]] ?: 0;

  __weak typeof(self) weakSelf = self;
  [ABI46_0_0EXUtil performSynchronouslyOnMainThread:^{
    [ABI46_0_0RCTSharedApplication() scheduleLocalNotification:localNotification];
...
ABI46_0_0RCT_REMAP_METHOD(cancelScheduledNotificationAsync,
                 cancelScheduledNotificationAsync:(NSString *)uniqueId
                 withResolver:(ABI46_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI46_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI46_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
...
ABI46_0_0RCT_REMAP_METHOD(cancelAllScheduledNotificationsAsync,
                 cancelAllScheduledNotificationsAsyncWithResolver:(ABI46_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(__unused ABI46_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI46_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
  [_userNotificationCenter getPendingNotificationRequestsWithCompletionHandler:^(NSArray<UNNotificationRequest *> * _Nonnull requests) {
...
ABI46_0_0RCT_REMAP_METHOD(getBadgeNumberAsync,
                 getBadgeNumberAsyncWithResolver:(ABI46_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI46_0_0RCTPromiseRejectBlock)reject)
{
  __block NSInteger badgeNumber;
  [ABI46_0_0EXUtil performSynchronouslyOnMainThread:^{
    badgeNumber = ABI46_0_0RCTSharedApplication().applicationIconBadgeNumber;
  }];
  resolve(@(badgeNumber));
}

ABI46_0_0RCT_EXPORT_METHOD(setBadgeNumberAsync:(nonnull NSNumber *)number
                  resolver:(ABI46_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI46_0_0RCTPromiseRejectBlock)reject)
{
  [ABI46_0_0EXUtil performSynchronouslyOnMainThread:^{
    ABI46_0_0RCTSharedApplication().applicationIconBadgeNumber = number.integerValue;
  }];
  resolve(nil);
}
...
ABI46_0_0RCT_REMAP_METHOD(createCategoryAsync,
...
ABI46_0_0RCT_REMAP_METHOD(deleteCategoryAsync,
...
- (NSDateComponents *)dateComponentsFrom:(NSNumber * _Nullable)unixTime {
  ...
  NSDate *triggerDate = [ABI46_0_0RCTConvert NSDate:unixTime] ?: [NSDate new];
