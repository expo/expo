...
#include "ABI46_0_0SampleCxxModule.h"
...
ABI46_0_0facebook::xplat::module::CxxModule *SampleCxxModule() {
  return new ABI46_0_0facebook::xplat::samples::SampleCxxModule(
      std::make_unique<ABI46_0_0facebook::xplat::samples::Sample>());
}
