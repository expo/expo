...
#include "ABI46_0_0HermesExecutorFactory.h"
...
#include <hermes/inspector/chrome/ABI46_0_0Registration.h>
#endif

#include "ABI46_0_0JSITracing.h"

using namespace ABI46_0_0facebook::ABI46_0_0hermes;
...
std::unique_ptr<HermesRuntime> makeHermesRuntimeSystraced(
    const ::ABI46_0_0hermes::vm::RuntimeConfig &runtimeConfig) {
  SystraceSection s("HermesExecutorFactory::makeHermesRuntimeSystraced");
  return ABI46_0_0hermes::makeHermesRuntime(runtimeConfig);
}

#ifdef HERMES_ENABLE_DEBUGGER

class HermesExecutorRuntimeAdapter
    : public ABI46_0_0facebook::ABI46_0_0hermes::inspector::RuntimeAdapter {
 public:
...
class DecoratedRuntime : public jsi::WithRuntimeDecorator<ReentrancyCheck> {
 public:
  ...
  DecoratedRuntime(
    ...
    ABI46_0_0facebook::ABI46_0_0hermes::inspector::chrome::enableDebugging(
        std::move(adapter), "Hermes ABI46_0_0React Native");
#else
    (void)hermesRuntime_;
#endif
  }
  ...
  ~DecoratedRuntime() {
#ifdef HERMES_ENABLE_DEBUGGER
    ABI46_0_0facebook::ABI46_0_0hermes::inspector::chrome::disableDebugging(hermesRuntime_);
#endif
  }
