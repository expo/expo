...
#include <ABI46_0_0hermes/ABI46_0_0hermes.h>
#include <ABI46_0_0hermes/ABI46_0_0inspector/chrome/ConnectionDemux.h>
...
using ::ABI46_0_0facebook::ABI46_0_0React::InspectorPage;
...
void expectPages(
  ...
  ABI46_0_0EXPECT_EQ(pages, expected);
}
  ...
  class Data {
   public:
    void expectDisconnected() {
      ...
      ABI46_0_0EXPECT_FALSE(connected_);
    }
...
TEST(ConnectionDemuxTests, TestEnableDisable) {
  std::shared_ptr<HermesRuntime> runtime1(
      ABI46_0_0facebook::ABI46_0_0hermes::makeHermesRuntime());
  std::shared_ptr<HermesRuntime> runtime2(
      ABI46_0_0facebook::ABI46_0_0hermes::makeHermesRuntime());
  auto inspector = ABI46_0_0facebook::ABI46_0_0React::makeTestInspectorInstance();
  ...
  ABI46_0_0EXPECT_NE(localConn1.get(), nullptr);

  {
    ...
    ABI46_0_0EXPECT_EQ(localConn.get(), nullptr);
  }
  ...
  ABI46_0_0EXPECT_NE(localConn2.get(), nullptr);
...

  {
    ...
    auto remoteConn = std::make_unique<TestRemoteConnection>();
    auto localConn = inspector->connect(id1, std::move(remoteConn));
    ABI46_0_0EXPECT_NE(localConn.get(), nullptr);
  }
}
