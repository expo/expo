...
#include <hermes/inspector/ABI46_0_0Inspector.h>
#include <hermes/inspector/chrome/ABI46_0_0MessageConverters.h>
#include <hermes/inspector/chrome/ABI46_0_0RemoteObjectsTable.h>
#include <hermes/inspector/detail/ABI46_0_0CallbackOStream.h>
#include <hermes/inspector/detail/ABI46_0_0SerialExecutor.h>
#include <hermes/inspector/detail/ABI46_0_0Thread.h>
#include <ABI46_0_0jsi/ABI46_0_0instrumentation.h>
...
namespace debugger = ::ABI46_0_0facebook::ABI46_0_0hermes::debugger;
namespace inspector = ::ABI46_0_0facebook::ABI46_0_0hermes::inspector;
namespace m = ::ABI46_0_0facebook::ABI46_0_0hermes::inspector::chrome::message;
...
void Connection::Impl::onMessageAdded(
    ABI46_0_0facebook::ABI46_0_0hermes::inspector::Inspector &inspector,
      ...
      ->evaluate(
          ...
          [this,
           ...
           byValue = req.returnByValue.value_or(false)](
              const ABI46_0_0facebook::ABI46_0_0hermes::debugger::EvalResult
                  &evalResult) mutable {
...
class CallFunctionOnRunner {
 public:
  ...
  // N.B.: constexpr char[] broke ABI46_0_0React-native-oss-android.
  ...
  jsi::Value operator()(
      jsi::Runtime &rt,
      RemoteObjectsTable &objTable,
      const ABI46_0_0facebook::ABI46_0_0hermes::debugger::EvalResult &evalResult) {
  ...
  inspector_
      ->evaluate(
          ...
          [this,
           ...
           byValue = req.returnByValue.value_or(false),
           runner =
               std::move(runner)](const ABI46_0_0facebook::ABI46_0_0hermes::debugger::EvalResult
                                      &evalResult) mutable {
