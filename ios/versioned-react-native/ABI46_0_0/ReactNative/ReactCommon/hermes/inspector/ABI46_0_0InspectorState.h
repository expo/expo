...
using CommandPtr = std::unique_ptr<ABI46_0_0facebook::ABI46_0_0hermes::debugger::Command>;
 ...
 * JS. For instance, ABI46_0_0React Native could be blocked in a native message queue
