...
#include <ABI46_0_0hermes/ABI46_0_0inspector/detail/CallbackOStream.h>
...
using namespace ABI46_0_0facebook::ABI46_0_0hermes::inspector::detail;
...
TEST(CallbackOStreamTests, Chunking) {
  ...
  ABI46_0_0EXPECT_THAT(recvd, ElementsAre("1234", "1234", "1234"));
}
...
TEST(CallbackOStreamTests, SyncOnDestruction) {
  ...
  ABI46_0_0EXPECT_THAT(recvd, ElementsAre("1234", "1234", "1234", "123"));
}
...
TEST(CallbackOStreamTests, FailingCallback) {
  ...
  cos << "123412341234";
  ABI46_0_0EXPECT_THAT(recvd, ElementsAre("1234", "1234"));
  ABI46_0_0EXPECT_THAT(!cos, Eq(true));
}
