...
@interface ABI46_0_0RCTInternalGenericWeakWrapper : NSObject
...
{
  ABI46_0_0RCTInternalGenericWeakWrapper *weakWrapper = [ABI46_0_0RCTInternalGenericWeakWrapper new];
...
{
  ABI46_0_0RCTInternalGenericWeakWrapper *weakWrapper = (ABI46_0_0RCTInternalGenericWeakWrapper *)unwrapManagedObject(object);
  ABI46_0_0React_native_assert(weakWrapper && "`ABI46_0_0RCTInternalGenericWeakWrapper` instance must not be `nil`.");
