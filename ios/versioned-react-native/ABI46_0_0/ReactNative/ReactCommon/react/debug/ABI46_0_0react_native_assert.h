...
// than once with and without ABI46_0_0REACT_NATIVE_DEBUG.

// ABI46_0_0React_native_assert allows us to opt-in to specific asserts on Android and
...
#include "ABI46_0_0flags.h"

#undef ABI46_0_0React_native_assert

#ifndef ABI46_0_0REACT_NATIVE_DEBUG

#define ABI46_0_0React_native_assert(e) ((void)0)

#else // ABI46_0_0REACT_NATIVE_DEBUG
...
extern "C" {
#endif // __cplusplus
void ABI46_0_0React_native_assert_fail(
    const char *func,
    const char *file,
    int line,
    const char *expr);
...
#define ABI46_0_0React_native_assert(e) \
  ((e) ? (void)0 : ABI46_0_0React_native_assert_fail(__func__, __FILE__, __LINE__, #e))
...
#define ABI46_0_0React_native_assert(cond)                           \
  if (!(cond)) {                                            \
    LOG(ERROR) << "ABI46_0_0React_native_assert failure: " << #cond; \
...
#endif // ABI46_0_0REACT_NATIVE_DEBUG
