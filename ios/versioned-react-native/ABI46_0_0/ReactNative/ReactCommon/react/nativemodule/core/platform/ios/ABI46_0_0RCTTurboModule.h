...
#import <ABI46_0_0React/ABI46_0_0RCTModuleMethod.h>
#import <ABI46_0_0ReactCommon/ABI46_0_0CallInvoker.h>
#import <ABI46_0_0ReactCommon/ABI46_0_0TurboModule.h>
#import <string>
#import <unordered_map>

#define ABI46_0_0RCT_IS_TURBO_MODULE_CLASS(klass) \
  ((ABI46_0_0RCTTurboModuleEnabled() && [(klass) conformsToProtocol:@protocol(ABI46_0_0RCTTurboModule)]))
#define ABI46_0_0RCT_IS_TURBO_MODULE_INSTANCE(module) ABI46_0_0RCT_IS_TURBO_MODULE_CLASS([(module) class])
...
typedef std::weak_ptr<CallbackWrapper> (
    ^ABI46_0_0RCTRetainJSCallback)(jsi::Function &&callback, jsi::Runtime &runtime, std::shared_ptr<CallInvoker> jsInvoker);
...
class JSI_EXPORT ObjCTurboModule : public TurboModule {
 public:
  ...
  struct InitParams {
    ...
    id<ABI46_0_0RCTTurboModule> instance;
    std::shared_ptr<CallInvoker> jsInvoker;
    std::shared_ptr<CallInvoker> nativeInvoker;
    bool isSyncModule;
    ABI46_0_0RCTRetainJSCallback retainJSCallback;
  };
  ...
  id<ABI46_0_0RCTTurboModule> instance_;
 ...
 private:
  ...
  ABI46_0_0RCTRetainJSCallback retainJSCallback_;
...
@protocol ABI46_0_0RCTTurboModule <NSObject>
...
/**
 * These methods are all implemented by ABI46_0_0RCTCxxBridge, which subclasses ABI46_0_0RCTBridge. Hence, they must only be used in
 * contexts where the concrete class of an ABI46_0_0RCTBridge instance is ABI46_0_0RCTCxxBridge. This happens, for example, when
 * [ABI46_0_0RCTCxxBridgeDelegate jsExecutorFactoryForBridge:(ABI46_0_0RCTBridge *)] is invoked by ABI46_0_0RCTCxxBridge.
 *
 * TODO: Consolidate this extension with the one in ABI46_0_0RCTSurfacePresenter.
 */
@interface ABI46_0_0RCTBridge (ABI46_0_0RCTTurboModule)
- (std::shared_ptr<ABI46_0_0facebook::ABI46_0_0React::CallInvoker>)jsCallInvoker;
- (std::shared_ptr<ABI46_0_0facebook::ABI46_0_0React::CallInvoker>)decorateNativeCallInvoker:
    (std::shared_ptr<ABI46_0_0facebook::ABI46_0_0React::CallInvoker>)nativeInvoker;
@end
