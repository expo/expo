...
#include "ABI46_0_0EventQueue.h"

#include "ABI46_0_0EventEmitter.h"
#include "ABI46_0_0ShadowNodeFamily.h"
...
void EventQueueProcessor::flushEvents(
  ...
  for (auto const &event : events) {
    ...
    auto ABI46_0_0ReactPriority = hasContinuousEventStarted_
        ? ABI46_0_0ReactEventPriority::Default
        : ABI46_0_0ReactEventPriority::Discrete;

    if (event.category == RawEvent::Category::Continuous) {
      ABI46_0_0ReactPriority = ABI46_0_0ReactEventPriority::Default;
    }

    if (event.category == RawEvent::Category::Discrete) {
      ABI46_0_0ReactPriority = ABI46_0_0ReactEventPriority::Discrete;
    }
