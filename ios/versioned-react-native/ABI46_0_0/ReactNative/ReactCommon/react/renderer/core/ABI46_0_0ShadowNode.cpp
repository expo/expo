...
#include "ABI46_0_0ShadowNode.h"
#include "ABI46_0_0DynamicPropsUtilities.h"
#include "ABI46_0_0ShadowNodeFragment.h"

#include <butter/small_vector.h>

#include <ABI46_0_0React/ABI46_0_0debug/ABI46_0_0React_native_assert.h>
#include <ABI46_0_0React/ABI46_0_0renderer/core/ComponentDescriptor.h>
...
ShadowNode::ShadowNode(
    ...
    :
      ...
      traits_(traits) {
  ABI46_0_0React_native_assert(props_);
  ABI46_0_0React_native_assert(children_);
...
void ShadowNode::replaceChild(
  ...
  ABI46_0_0React_native_assert(false && "Child to replace was not found.");
}
