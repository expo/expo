...
#include "ABI46_0_0TestComponent.h"
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetrics) {
  ...
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 100);
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 200);
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 10);
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 20);
}
...
TEST(LayoutableShadowNodeTest, contentOriginOffset) {
  ...
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 0);
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 10);
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetricsOnTransformedNode) {
  ...
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 35);
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 70);
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 50);
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 100);
}
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetricsOnTransformedParent) {
  ...
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 45);
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 45);

  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 25);
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 25);
}
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetricsOnSameNode) {
  ...
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 0);
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 0);
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 100);
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 200);
}
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetricsOnSameTransformedNode) {
  ...
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 0);
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 0);
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 200);
  ABI46_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 400);
}
...
TEST(LayoutableShadowNodeTest, relativeLayourMetricsOnClonedNode) {
  ...
  auto newRelativeLayoutMetrics =
      LayoutableShadowNode::computeRelativeLayoutMetrics(
          childShadowNode->getFamily(), *parentShadowNode, {});
  ABI46_0_0EXPECT_EQ(newRelativeLayoutMetrics.frame.size.width, 50);
  ABI46_0_0EXPECT_EQ(newRelativeLayoutMetrics.frame.size.height, 60);
}
...
TEST(LayoutableShadowNodeTest, includeViewportOffset) {
  ...
  ABI46_0_0EXPECT_EQ(layoutMetrics.frame.origin.x, 10);
  ABI46_0_0EXPECT_EQ(layoutMetrics.frame.origin.y, 20);
