...
TEST(StateReconciliationTest, testStateReconciliation) {
  ...
  ABI46_0_0EXPECT_EQ(state1->getMostRecentState(), state1);
  ...
  ABI46_0_0EXPECT_EQ(state1->getMostRecentState(), state2);
  ABI46_0_0EXPECT_EQ(state2->getMostRecentState(), state2);
  ...
  ABI46_0_0EXPECT_EQ(findDescendantNode(shadowTree, family)->getState(), state3);

  ABI46_0_0EXPECT_EQ(state1->getMostRecentState(), state3);
  ABI46_0_0EXPECT_EQ(state2->getMostRecentState(), state3);
  ABI46_0_0EXPECT_EQ(state3->getMostRecentState(), state3);
