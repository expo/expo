...
#include <ABI46_0_0React/ABI46_0_0renderer/core/LayoutPrimitives.h>
...
#include "ABI46_0_0ShadowTreeDelegate.h"
...
CommitStatus ShadowTree::commit(
  ...
  while (true) {
    ...
    ABI46_0_0React_native_assert(attempts < 1024);
  }
}
