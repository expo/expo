  ...
  for (auto const &mutation : mutations) {
    switch (mutation.type) {
      case ShadowViewMutation::Create: {
        ABI46_0_0React_native_assert(mutation.parentShadowView == ShadowView{});
        ABI46_0_0React_native_assert(mutation.oldChildShadowView == ShadowView{});
        ABI46_0_0React_native_assert(mutation.newChildShadowView.props);
        ...
        ABI46_0_0React_native_assert(registry.find(tag) == registry.end());
      ...
      case ShadowViewMutation::Delete: {
        ...
        ABI46_0_0React_native_assert(mutation.parentShadowView == ShadowView{});
        ABI46_0_0React_native_assert(mutation.newChildShadowView == ShadowView{});
        ...
        if ((ShadowView)(*stubView) != mutation.oldChildShadowView) {
          LOG(ERROR)
              ...
              << " old mutation hash: ##"
              << std::hash<ShadowView>{}(mutation.oldChildShadowView);
#ifdef ABI46_0_0RN_DEBUG_STRING_CONVERTIBLE
          LOG(ERROR) << "StubView: "
      ...
      case ShadowViewMutation::Insert: {
        if (!mutation.mutatedViewIsVirtual()) {
          ...
          ABI46_0_0React_native_assert(registry.find(parentTag) != registry.end());
          auto parentStubView = registry[parentTag];
          ABI46_0_0React_native_assert(registry.find(childTag) != registry.end());
          ...
          ABI46_0_0React_native_assert(childStubView->parentTag == NO_VIEW_TAG);
          ABI46_0_0React_native_assert(
              mutation.index >= 0 &&
      ...
      case ShadowViewMutation::Remove: {
        if (!mutation.mutatedViewIsVirtual()) {
          ...
          ABI46_0_0React_native_assert(childStubView->parentTag == parentTag);
          STUB_VIEW_LOG({
      ...
      case ShadowViewMutation::Update: {
        ...
        ABI46_0_0React_native_assert(mutation.oldChildShadowView.tag != 0);
        ABI46_0_0React_native_assert(mutation.newChildShadowView.tag != 0);
        ABI46_0_0React_native_assert(mutation.newChildShadowView.props);
        ABI46_0_0React_native_assert(
        ...
        ABI46_0_0React_native_assert(oldStubView->tag != 0);
