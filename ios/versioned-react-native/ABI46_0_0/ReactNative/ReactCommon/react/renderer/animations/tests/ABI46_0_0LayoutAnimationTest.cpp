...
#include <ABI46_0_0React/ABI46_0_0renderer/componentregistry/ComponentDescriptorProvider.h>
...
#include <ABI46_0_0React/ABI46_0_0test_utils/Entropy.h>
#include <ABI46_0_0React/ABI46_0_0test_utils/MockClock.h>
...
#include "ABI46_0_0LayoutAnimationDriver.h"
    ...
    for (int j = 0; j < stages; j++) {
      ...
      for (int k = 0; k < animation_frames + 2; k++) {
        ...
        if (k != (animation_frames + 1)) {
          ABI46_0_0EXPECT_TRUE(animationDriver->shouldOverridePullTransaction());
        } else if (!commits_conflicting_mutations) {
          ABI46_0_0EXPECT_FALSE(animationDriver->shouldOverridePullTransaction());
        }
        ...
        ABI46_0_0EXPECT_TRUE(transaction.has_value() || k == animation_frames);
