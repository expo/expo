...
#include "ABI46_0_0RuntimeSchedulerBinding.h"
#include "ABI46_0_0SchedulerPriority.h"
#include "ABI46_0_0primitives.h"
...
jsi::Value RuntimeSchedulerBinding::get(
  ...
  ABI46_0_0React_native_assert(false && "undefined property");
  return jsi::Value::undefined();
}
