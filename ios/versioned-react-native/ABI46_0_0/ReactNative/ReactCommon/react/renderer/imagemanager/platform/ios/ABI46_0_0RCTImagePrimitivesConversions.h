...
#import <ABI46_0_0React/ABI46_0_0renderer/imagemanager/primitives.h>

using namespace ABI46_0_0facebook::ABI46_0_0React;

inline static UIViewContentMode ABI46_0_0RCTContentModeFromImageResizeMode(ImageResizeMode imageResizeMode)
{
...
inline static NSURLRequest *NSURLRequestFromImageSource(const ImageSource &imageSource)
{
  ...
  if (!url) {
    ABI46_0_0RCTLogError(@"URI parsing error.");
    return nil;
  }
