...
#import <ABI46_0_0React/ABI46_0_0utils/SharedFunction.h>
...
#import "ABI46_0_0RCTImagePrimitivesConversions.h"

using namespace ABI46_0_0facebook::ABI46_0_0React;

@implementation ABI46_0_0RCTSyncImageManager {
  id<ABI46_0_0RCTImageLoaderWithAttributionProtocol> _imageLoader;
}

- (instancetype)initWithImageLoader:(id<ABI46_0_0RCTImageLoaderWithAttributionProtocol>)imageLoader
{
  if (self = [super init]) {
    ABI46_0_0RCTAssert(ABI46_0_0RCTRunningInTestEnvironment(), @"This class is only meant to be used in test environment");
...
- (ImageRequest)requestImage:(ImageSource)imageSource surfaceId:(SurfaceId)surfaceId
{
  ...
  ABI46_0_0RCTImageURLLoaderRequest *loaderRequest =
  ...
  ABI46_0_0RCTImageLoaderCancellationBlock cancelationBlock = loaderRequest.cancellationBlock;
  ...
  if (result != 0) {
    ABI46_0_0RCTLogError(@"Image timed out in test environment for url: %@", loaderRequest.imageURL);
  }
  return imageRequest;
}
