...
#include "ABI46_0_0Scheduler.h"

#include <glog/logging.h>
#include <ABI46_0_0jsi/ABI46_0_0jsi.h>

#include <ABI46_0_0React/ABI46_0_0debug/ABI46_0_0React_native_assert.h>
#include <ABI46_0_0React/ABI46_0_0renderer/componentregistry/ComponentDescriptorRegistry.h>
...
#include <ABI46_0_0React/ABI46_0_0renderer/mounting/MountingOverrideDelegate.h>
...
#include <ABI46_0_0React/ABI46_0_0renderer/templateprocessor/UITemplateProcessor.h>
#include <ABI46_0_0React/ABI46_0_0renderer/uimanager/UIManager.h>
#include <ABI46_0_0React/ABI46_0_0renderer/uimanager/UIManagerBinding.h>

#ifdef ABI46_0_0RN_SHADOW_TREE_INTROSPECTION
...
Scheduler::Scheduler(
  ...
  ABI46_0_0ReactNativeConfig_ =
      contextContainer_->at<std::shared_ptr<const ABI46_0_0ReactNativeConfig>>(
...
#ifdef ANDROID
  auto enableCallImmediates = ABI46_0_0ReactNativeConfig_->getBool(
      "ABI46_0_0React_native_new_architecture:enable_call_immediates_android");
#else
  auto enableCallImmediates = ABI46_0_0ReactNativeConfig_->getBool(
      "ABI46_0_0React_native_new_architecture:enable_call_immediates_ios");
#endif
...
#else
  removeOutstandingSurfacesOnDestruction_ = ABI46_0_0ReactNativeConfig_->getBool(
      "ABI46_0_0React_fabric:remove_outstanding_surfaces_on_destruction_ios");
#endif
}
...
void Scheduler::renderTemplateToSurface(
  ...
  try {
    ...
    LOG(ERROR) << "    >>>> ABI46_0_0EXCEPTION <<<  rendering uiTemplate in "
