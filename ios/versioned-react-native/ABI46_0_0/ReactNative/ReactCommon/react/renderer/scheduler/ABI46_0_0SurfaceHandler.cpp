...
#include "ABI46_0_0SurfaceHandler.h"
...
#include <ABI46_0_0React/ABI46_0_0renderer/scheduler/Scheduler.h>
...
void SurfaceHandler::stop() const noexcept {
  ...
  ABI46_0_0React_native_assert(shadowTree && "`shadowTree` must not be null.");
