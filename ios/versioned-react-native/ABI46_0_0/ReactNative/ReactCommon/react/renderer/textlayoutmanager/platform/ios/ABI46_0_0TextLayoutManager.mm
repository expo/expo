...
#include "ABI46_0_0TextLayoutManager.h"
...
#import "ABI46_0_0RCTTextLayoutManager.h"
...
{
  self_ = wrapManagedObject([ABI46_0_0RCTTextLayoutManager new]);
}
...
{
  ABI46_0_0RCTTextLayoutManager *textLayoutManager = (ABI46_0_0RCTTextLayoutManager *)unwrapManagedObject(self_);
