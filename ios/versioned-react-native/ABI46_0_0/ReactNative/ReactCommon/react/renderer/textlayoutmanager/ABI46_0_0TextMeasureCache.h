...
#include <ABI46_0_0React/ABI46_0_0utils/SimpleThreadSafeCache.h>
...
template <>
struct hash<ABI46_0_0facebook::ABI46_0_0React::TextMeasureCacheKey> {
  size_t operator()(ABI46_0_0facebook::ABI46_0_0React::TextMeasureCacheKey const &key) const {
    return folly::hash::hash_combine(
        0,
