...
#include <ABI46_0_0React/ABI46_0_0common/mapbuffer/JReadableMapBuffer.h>
...
Size measureAndroidComponent(
  ...
  static auto measure =
      jni::findClassStatic("com/facebook/ABI46_0_0React/fabric/FabricUIManager")
          ->getMethod<jlong(
              jint,
              jstring,
    ...
    for (auto const &fragment : fragments) {
      ...
      if (isAttachment != fragment.items().end() &&
        ...
        auto rect = ABI46_0_0facebook::ABI46_0_0React::Rect{
            {left, top}, ABI46_0_0facebook::ABI46_0_0React::Size{width, height}};
