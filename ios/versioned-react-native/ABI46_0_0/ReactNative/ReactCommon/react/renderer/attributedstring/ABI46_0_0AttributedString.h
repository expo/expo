...
#include <ABI46_0_0React/ABI46_0_0renderer/mounting/ShadowView.h>
...
/*
 * Simple, cross-platfrom, ABI46_0_0React-specific implementation of attributed string
 * (aka spanned string).
...
namespace std {
template <>
struct hash<ABI46_0_0facebook::ABI46_0_0React::AttributedString::Fragment> {
  size_t operator()(
      const ABI46_0_0facebook::ABI46_0_0React::AttributedString::Fragment &fragment) const {
...
template <>
struct hash<ABI46_0_0facebook::ABI46_0_0React::AttributedString> {
  size_t operator()(
      const ABI46_0_0facebook::ABI46_0_0React::AttributedString &attributedString) const {
    auto seed = size_t{0};
