...
#include <ABI46_0_0React/ABI46_0_0renderer/core/conversions.h>
...
#ifdef ANDROID
#include <ABI46_0_0React/ABI46_0_0renderer/mapbuffer/MapBuffer.h>
#include <ABI46_0_0React/ABI46_0_0renderer/mapbuffer/MapBufferBuilder.h>
#endif
...
inline void fromRawValue(
  ...
  ABI46_0_0React_native_assert(value.hasType<std::string>());
...
inline void fromRawValue(
    ...
    const RawValue &value,
    FontVariant &result) {
  ABI46_0_0React_native_assert(value.hasType<std::vector<std::string>>());
...
inline folly::dynamic toDynamic(const AttributedString &attributedString) {
  ...
  for (auto fragment : attributedString.getFragments()) {
    ...
    if (fragment.parentShadowView.componentHandle) {
      dynamicFragment["ABI46_0_0ReactTag"] = fragment.parentShadowView.tag;
    }
  ...
  value(
      "hash", std::hash<ABI46_0_0facebook::ABI46_0_0React::AttributedString>{}(attributedString));
...
inline MapBuffer toMapBuffer(const AttributedString &attributedString) {
  ...
  builder.putInt(
      AS_KEY_HASH,
      std::hash<ABI46_0_0facebook::ABI46_0_0React::AttributedString>{}(attributedString));
