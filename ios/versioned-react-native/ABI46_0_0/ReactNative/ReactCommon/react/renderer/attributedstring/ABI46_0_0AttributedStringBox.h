...
template <>
struct std::hash<ABI46_0_0facebook::ABI46_0_0React::AttributedStringBox> {
  size_t operator()(
      ABI46_0_0facebook::ABI46_0_0React::AttributedStringBox const &attributedStringBox) const {
    switch (attributedStringBox.getMode()) {
      case ABI46_0_0facebook::ABI46_0_0React::AttributedStringBox::Mode::Value:
        return std::hash<ABI46_0_0facebook::ABI46_0_0React::AttributedString>()(
            attributedStringBox.getValue());
      case ABI46_0_0facebook::ABI46_0_0React::AttributedStringBox::Mode::OpaquePointer:
