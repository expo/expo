...
TEST(AttributedStringBoxTest, testDefaultConstructor) {
  ...
  ABI46_0_0EXPECT_EQ(attributedStringBox.getMode(), AttributedStringBox::Mode::Value);
  ABI46_0_0EXPECT_EQ(attributedStringBox.getValue(), AttributedString{});
}
...
TEST(AttributedStringBoxTest, testOpaquePointerConstructor) {
  ...
  ABI46_0_0EXPECT_EQ(attributedStringBox.getOpaquePointer(), string);
  ABI46_0_0EXPECT_EQ(string.use_count(), 2);
}
...
TEST(AttributedStringBoxTest, testMoveConstructor) {
  {
    ...
    ABI46_0_0EXPECT_EQ(moveToAttributedStringBox.getOpaquePointer(), string);
    ABI46_0_0EXPECT_EQ(string.use_count(), 2);
  }
  {
    auto attributedString = AttributedString{};
    ...
    ABI46_0_0EXPECT_EQ(moveToAttributedStringBox.getValue(), attributedString);
  }
}
...
TEST(AttributedStringBoxTest, testMoveAssignment) {
  {
    ...
    ABI46_0_0EXPECT_EQ(
        ...
        AttributedStringBox::Mode::OpaquePointer);
    ABI46_0_0EXPECT_EQ(movedToAttributedStringBox.getOpaquePointer(), string);
    ABI46_0_0EXPECT_EQ(string.use_count(), 2);
  }
  {
    auto attributedString = AttributedString{};
