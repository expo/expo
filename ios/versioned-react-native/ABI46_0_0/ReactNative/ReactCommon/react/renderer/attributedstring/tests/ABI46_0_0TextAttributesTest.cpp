...
TEST(TextAttributesTest, testToDynamic) {
  ...
  ABI46_0_0EXPECT_EQ(result["opacity"], textAttributes.opacity);
  ABI46_0_0EXPECT_EQ(result["fontStyle"], toString(textAttributes.fontStyle.value()));
  ABI46_0_0EXPECT_EQ(result["fontWeight"], toString(textAttributes.fontWeight.value()));
}
