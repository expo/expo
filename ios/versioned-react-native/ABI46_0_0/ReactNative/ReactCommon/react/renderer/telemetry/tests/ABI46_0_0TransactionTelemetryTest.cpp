...
#include <ABI46_0_0React/ABI46_0_0renderer/telemetry/TransactionTelemetry.h>
...
TEST(TransactionTelemetryTest, timepoints) {
  ...
  ABI46_0_0EXPECT_GE(duration, 100);
}
...
TEST(TransactionTelemetryTest, normalUseCase) {
  ...
  ABI46_0_0EXPECT_EQ(commitDuration, 1000);
  ABI46_0_0EXPECT_EQ(layoutDuration, 800);
  ABI46_0_0EXPECT_EQ(mountDuration, 100);

  ABI46_0_0EXPECT_EQ(telemetry.getNumberOfTextMeasurements(), 3);
  ABI46_0_0EXPECT_EQ(
      telemetryDurationToMilliseconds(telemetry.getTextMeasureTime()), 600);
  ABI46_0_0EXPECT_EQ(telemetry.getRevisionNumber(), 42);
}
...
TEST(TransactionTelemetryTest, defaultImplementation) {
  ...
  ABI46_0_0EXPECT_GE(commitDuration, 500);
  ABI46_0_0EXPECT_GE(layoutDuration, 300);
  ABI46_0_0EXPECT_GE(mountDuration, 100);
}
