...
#include <ABI46_0_0React/ABI46_0_0renderer/components/view/YogaLayoutableShadowNode.h>
...
#pragma mark - DebugStringConvertible
 ...
 private:
  void initialize() noexcept {
    ...
    if (props.yogaStyle.display() == ABI46_0_0YGDisplayNone) {
    ...
    if (props.yogaStyle.positionType() != ABI46_0_0YGPositionTypeStatic) {
