...
#include <ABI46_0_0React/ABI46_0_0renderer/componentregistry/ComponentDescriptorProviderRegistry.h>
    ...
    auto element =
        Element<RootShadowNode>()
          ...
          .props([] {
            ...
            yogaStyle.dimensions()[ABI46_0_0YGDimensionWidth] = ABI46_0_0YGValue{200, ABI46_0_0YGUnitPoint};
            yogaStyle.dimensions()[ABI46_0_0YGDimensionHeight] = ABI46_0_0YGValue{200, ABI46_0_0YGUnitPoint};
            return sharedProps;
          })
          .children({
            Element<ViewShadowNode>()
              ...
              .props([] {
                ...
                auto &props = *sharedProps;
                auto &yogaStyle = props.yogaStyle;
                yogaStyle.positionType() = ABI46_0_0YGPositionTypeAbsolute;
                yogaStyle.dimensions()[ABI46_0_0YGDimensionWidth] = ABI46_0_0YGValue{50, ABI46_0_0YGUnitPoint};
                yogaStyle.dimensions()[ABI46_0_0YGDimensionHeight] = ABI46_0_0YGValue{50, ABI46_0_0YGUnitPoint};
                return sharedProps;
              })
              .children({
                Element<ViewShadowNode>()
                  ...
                  .props([=] {
                    ...
                    auto &yogaStyle = props.yogaStyle;
                    yogaStyle.positionType() = ABI46_0_0YGPositionTypeAbsolute;
                    yogaStyle.position()[ABI46_0_0YGEdgeLeft] = ABI46_0_0YGValue{10, ABI46_0_0YGUnitPoint};
                    yogaStyle.position()[ABI46_0_0YGEdgeTop] = ABI46_0_0YGValue{10, ABI46_0_0YGUnitPoint};
                    yogaStyle.dimensions()[ABI46_0_0YGDimensionWidth] = ABI46_0_0YGValue{30, ABI46_0_0YGUnitPoint};
                    yogaStyle.dimensions()[ABI46_0_0YGDimensionHeight] = ABI46_0_0YGValue{90, ABI46_0_0YGUnitPoint};
                    ...
                    Element<ViewShadowNode>()
                      ...
                      .props([=] {
                        ...
                        if (testCase == CLIPPING) {
                          yogaStyle.overflow() = ABI46_0_0YGOverflowHidden;
                        }

                        yogaStyle.positionType() = ABI46_0_0YGPositionTypeAbsolute;
                        yogaStyle.position()[ABI46_0_0YGEdgeLeft] = ABI46_0_0YGValue{10, ABI46_0_0YGUnitPoint};
                        yogaStyle.position()[ABI46_0_0YGEdgeTop] = ABI46_0_0YGValue{10, ABI46_0_0YGUnitPoint};
                        yogaStyle.dimensions()[ABI46_0_0YGDimensionWidth] = ABI46_0_0YGValue{110, ABI46_0_0YGUnitPoint};
                        yogaStyle.dimensions()[ABI46_0_0YGDimensionHeight] = ABI46_0_0YGValue{20, ABI46_0_0YGUnitPoint};
                        return sharedProps;
                      })
                      .children({
                        Element<ViewShadowNode>()
                          ...
                          .props([] {
                            ...
                            auto &yogaStyle = props.yogaStyle;
                            yogaStyle.positionType() = ABI46_0_0YGPositionTypeAbsolute;
                            yogaStyle.position()[ABI46_0_0YGEdgeLeft] = ABI46_0_0YGValue{70, ABI46_0_0YGUnitPoint};
                            yogaStyle.position()[ABI46_0_0YGEdgeTop] = ABI46_0_0YGValue{-50, ABI46_0_0YGUnitPoint};
                            yogaStyle.dimensions()[ABI46_0_0YGDimensionWidth] = ABI46_0_0YGValue{30, ABI46_0_0YGUnitPoint};
                            yogaStyle.dimensions()[ABI46_0_0YGDimensionHeight] = ABI46_0_0YGValue{60, ABI46_0_0YGUnitPoint};
                            return sharedProps;
                          })
                      }),
                    Element<ViewShadowNode>()
                      ...
                      .props([] {
                        ...
                        auto &yogaStyle = props.yogaStyle;
                        yogaStyle.positionType() = ABI46_0_0YGPositionTypeAbsolute;
                        yogaStyle.position()[ABI46_0_0YGEdgeLeft] = ABI46_0_0YGValue{-60, ABI46_0_0YGUnitPoint};
                        yogaStyle.position()[ABI46_0_0YGEdgeTop] = ABI46_0_0YGValue{50, ABI46_0_0YGUnitPoint};
                        yogaStyle.dimensions()[ABI46_0_0YGDimensionWidth] = ABI46_0_0YGValue{70, ABI46_0_0YGUnitPoint};
                        yogaStyle.dimensions()[ABI46_0_0YGDimensionHeight] = ABI46_0_0YGValue{20, ABI46_0_0YGUnitPoint};
                        return sharedProps;
                      })
                  })
...
TEST_F(LayoutTest, overflowInsetTest) {
  ...
  ABI46_0_0EXPECT_EQ(layoutMetricsA.frame.size.width, 50);
  ABI46_0_0EXPECT_EQ(layoutMetricsA.frame.size.height, 50);

  ABI46_0_0EXPECT_EQ(layoutMetricsA.overflowInset.left, -50);
  ABI46_0_0EXPECT_EQ(layoutMetricsA.overflowInset.top, -30);
  ABI46_0_0EXPECT_EQ(layoutMetricsA.overflowInset.right, -80);
  ABI46_0_0EXPECT_EQ(layoutMetricsA.overflowInset.bottom, -50);

  auto layoutMetricsABC = viewShadowNodeABC_->getLayoutMetrics();

  ABI46_0_0EXPECT_EQ(layoutMetricsABC.frame.size.width, 110);
  ABI46_0_0EXPECT_EQ(layoutMetricsABC.frame.size.height, 20);

  ABI46_0_0EXPECT_EQ(layoutMetricsABC.overflowInset.left, 0);
  ABI46_0_0EXPECT_EQ(layoutMetricsABC.overflowInset.top, -50);
  ABI46_0_0EXPECT_EQ(layoutMetricsABC.overflowInset.right, 0);
  ABI46_0_0EXPECT_EQ(layoutMetricsABC.overflowInset.bottom, 0);
}
...
TEST_F(LayoutTest, overflowInsetWithClippingTest) {
  ...
  ABI46_0_0EXPECT_EQ(layoutMetricsA.overflowInset.left, -50);
  ABI46_0_0EXPECT_EQ(layoutMetricsA.overflowInset.top, 0);
  ABI46_0_0EXPECT_EQ(layoutMetricsA.overflowInset.right, -80);
  ABI46_0_0EXPECT_EQ(layoutMetricsA.overflowInset.bottom, -50);
  ...
  ABI46_0_0EXPECT_EQ(layoutMetricsABC.overflowInset.left, 0);
  ABI46_0_0EXPECT_EQ(layoutMetricsABC.overflowInset.top, 0);
  ABI46_0_0EXPECT_EQ(layoutMetricsABC.overflowInset.right, 0);
  ABI46_0_0EXPECT_EQ(layoutMetricsABC.overflowInset.bottom, 0);
}
...
TEST_F(LayoutTest, overflowInsetTransformTranslateTest) {
  ...
  ABI46_0_0EXPECT_EQ(layoutMetricsA.overflowInset.left, -50);
  ABI46_0_0EXPECT_EQ(layoutMetricsA.overflowInset.top, -30);
  ABI46_0_0EXPECT_EQ(layoutMetricsA.overflowInset.right, -90);
  ABI46_0_0EXPECT_EQ(layoutMetricsA.overflowInset.bottom, -60);

  auto layoutMetricsAB = viewShadowNodeAB_->getLayoutMetrics();

  ABI46_0_0EXPECT_EQ(layoutMetricsAB.frame.size.width, 30);
  ABI46_0_0EXPECT_EQ(layoutMetricsAB.frame.size.height, 90);

  // No change on self node with translate transform
  ABI46_0_0EXPECT_EQ(layoutMetricsAB.overflowInset.left, -60);
  ABI46_0_0EXPECT_EQ(layoutMetricsAB.overflowInset.top, -40);
  ABI46_0_0EXPECT_EQ(layoutMetricsAB.overflowInset.right, -90);
  ABI46_0_0EXPECT_EQ(layoutMetricsAB.overflowInset.bottom, 0);
...
TEST_F(LayoutTest, overflowInsetTransformScaleTest) {
  ...
  ABI46_0_0EXPECT_EQ(layoutMetricsA.overflowInset.left, -125);
  ABI46_0_0EXPECT_EQ(layoutMetricsA.overflowInset.top, -115);
  ABI46_0_0EXPECT_EQ(layoutMetricsA.overflowInset.right, -185);
  ABI46_0_0EXPECT_EQ(layoutMetricsA.overflowInset.bottom, -95);
