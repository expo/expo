...
#include <ABI46_0_0React/ABI46_0_0renderer/components/text/BaseTextShadowNode.h>
...
using namespace ABI46_0_0facebook::jni;
...
AttributedString AndroidTextInputShadowNode::getMostRecentAttributedString()
  ...
  auto ABI46_0_0ReactTreeAttributedString = getAttributedString();
  ...
  bool treeAttributedStringChanged =
      !state.ABI46_0_0ReactTreeAttributedString.compareTextAttributesWithoutFrame(
          ABI46_0_0ReactTreeAttributedString);
...
void AndroidTextInputShadowNode::updateStateIfNeeded() {
  ...
  if (state.ABI46_0_0ReactTreeAttributedString == ABI46_0_0ReactTreeAttributedString) {
    return;
  }
  ...
  auto newEventCount =
      (state.ABI46_0_0ReactTreeAttributedString == ABI46_0_0ReactTreeAttributedString
           ? 0
