...
@protocol ABI46_0_0RCTScrollViewProtocol <NSObject>
...
ABI46_0_0RCT_EXTERN inline void
ABI46_0_0RCTScrollViewHandleCommand(id<ABI46_0_0RCTScrollViewProtocol> componentView, NSString const *commandName, NSArray const *args)
{
...
#if ABI46_0_0RCT_DEBUG
    if (!ABI46_0_0RCTValidateTypeOfViewCommandArgument(arg0, [NSNumber class], @"float", @"ScrollView", commandName, @"1st")) {
      return;
    }
#endif
    NSObject *arg1 = args[1];
#if ABI46_0_0RCT_DEBUG
    if (!ABI46_0_0RCTValidateTypeOfViewCommandArgument(arg1, [NSNumber class], @"float", @"ScrollView", commandName, @"2nd")) {
      return;
    }
#endif
    NSObject *arg2 = args[2];
#if ABI46_0_0RCT_DEBUG
    if (!ABI46_0_0RCTValidateTypeOfViewCommandArgument(arg2, [NSNumber class], @"boolean", @"ScrollView", commandName, @"3rd")) {
      return;
    }
#endif
  ...
  if ([commandName isEqualToString:@"scrollToEnd"]) {
    ...
    NSObject *arg0 = args[0];
#if ABI46_0_0RCT_DEBUG
    if (!ABI46_0_0RCTValidateTypeOfViewCommandArgument(arg0, [NSNumber class], @"boolean", @"ScrollView", commandName, @"1st")) {
      return;
    }
#endif
  ...
  if ([commandName isEqualToString:@"zoomToRect"]) {
...
#if ABI46_0_0RCT_DEBUG
    if (!ABI46_0_0RCTValidateTypeOfViewCommandArgument(
    ...
    NSObject *arg1 = args[1];
#if ABI46_0_0RCT_DEBUG
    if (!ABI46_0_0RCTValidateTypeOfViewCommandArgument(arg1, [NSNumber class], @"boolean", @"ScrollView", commandName, @"2nd")) {
      return;
    }
#endif
