...
#include "ABI46_0_0TextInputShadowNode.h"
...
void TextInputShadowNode::updateStateIfNeeded(
  ...
  auto ABI46_0_0ReactTreeAttributedString = getAttributedString(layoutContext);
  auto const &state = getStateData();

  ABI46_0_0React_native_assert(textLayoutManager_);
  ...
  newState.attributedStringBox = AttributedStringBox{ABI46_0_0ReactTreeAttributedString};
  newState.paragraphAttributes = getConcreteProps().paragraphAttributes;
  newState.ABI46_0_0ReactTreeAttributedString = ABI46_0_0ReactTreeAttributedString;
