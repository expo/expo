...
TEST(ParagraphLocalDataTest, testSomething) {
  ...
  ABI46_0_0React_native_assert(result["string"] == fragment.string);
  ...
  ABI46_0_0React_native_assert(textAttribute["opacity"] == text.opacity);
  ABI46_0_0React_native_assert(textAttribute["fontStyle"] == toString(*text.fontStyle));
  ABI46_0_0React_native_assert(
