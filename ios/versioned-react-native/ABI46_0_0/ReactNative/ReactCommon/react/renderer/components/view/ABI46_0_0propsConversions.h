...
static inline ABI46_0_0YGStyle::Dimensions convertRawProp(
    const PropsParserContext &context,
    RawProps const &rawProps,
    char const *widthName,
    char const *heightName,
    ABI46_0_0YGStyle::Dimensions const &sourceValue,
    ABI46_0_0YGStyle::Dimensions const &defaultValue) {
  auto dimensions = defaultValue;
  dimensions[ABI46_0_0YGDimensionWidth] = convertRawProp(
      context,
      rawProps,
      widthName,
      sourceValue[ABI46_0_0YGDimensionWidth],
      defaultValue[ABI46_0_0YGDimensionWidth]);
  dimensions[ABI46_0_0YGDimensionHeight] = convertRawProp(
      context,
      rawProps,
      heightName,
      sourceValue[ABI46_0_0YGDimensionHeight],
      defaultValue[ABI46_0_0YGDimensionWidth]);
  return dimensions;
}

static inline ABI46_0_0YGStyle::Edges convertRawProp(
    const PropsParserContext &context,
    RawProps const &rawProps,
    char const *prefix,
    char const *suffix,
    ABI46_0_0YGStyle::Edges const &sourceValue,
    ABI46_0_0YGStyle::Edges const &defaultValue) {
  auto result = defaultValue;
  result[ABI46_0_0YGEdgeLeft] = convertRawProp(
      context,
      rawProps,
      "Left",
      sourceValue[ABI46_0_0YGEdgeLeft],
      defaultValue[ABI46_0_0YGEdgeLeft],
      prefix,
      suffix);
  result[ABI46_0_0YGEdgeTop] = convertRawProp(
      context,
      rawProps,
      "Top",
      sourceValue[ABI46_0_0YGEdgeTop],
      defaultValue[ABI46_0_0YGEdgeTop],
      prefix,
      suffix);
  result[ABI46_0_0YGEdgeRight] = convertRawProp(
      context,
      rawProps,
      "Right",
      sourceValue[ABI46_0_0YGEdgeRight],
      defaultValue[ABI46_0_0YGEdgeRight],
      prefix,
      suffix);
  result[ABI46_0_0YGEdgeBottom] = convertRawProp(
      context,
      rawProps,
      "Bottom",
      sourceValue[ABI46_0_0YGEdgeBottom],
      defaultValue[ABI46_0_0YGEdgeBottom],
      prefix,
      suffix);
  result[ABI46_0_0YGEdgeStart] = convertRawProp(
      context,
      rawProps,
      "Start",
      sourceValue[ABI46_0_0YGEdgeStart],
      defaultValue[ABI46_0_0YGEdgeStart],
      prefix,
      suffix);
  result[ABI46_0_0YGEdgeEnd] = convertRawProp(
      context,
      rawProps,
      "End",
      sourceValue[ABI46_0_0YGEdgeEnd],
      defaultValue[ABI46_0_0YGEdgeEnd],
      prefix,
      suffix);
  result[ABI46_0_0YGEdgeHorizontal] = convertRawProp(
      context,
      rawProps,
      "Horizontal",
      sourceValue[ABI46_0_0YGEdgeHorizontal],
      defaultValue[ABI46_0_0YGEdgeHorizontal],
      prefix,
      suffix);
  result[ABI46_0_0YGEdgeVertical] = convertRawProp(
      context,
      rawProps,
      "Vertical",
      sourceValue[ABI46_0_0YGEdgeVertical],
      defaultValue[ABI46_0_0YGEdgeVertical],
      prefix,
      suffix);
  result[ABI46_0_0YGEdgeAll] = convertRawProp(
      context,
      rawProps,
      "",
      sourceValue[ABI46_0_0YGEdgeAll],
      defaultValue[ABI46_0_0YGEdgeAll],
      prefix,
      suffix);
  return result;
}
...
static inline ABI46_0_0YGStyle convertRawProp(
    const PropsParserContext &context,
    RawProps const &rawProps,
    ABI46_0_0YGStyle const &sourceValue) {
  auto yogaStyle = ABI46_0_0YGStyle{};
...
static inline void fromRawValue(
  ...
  if (type == "ThemeAttrAndroid") {
    ...
    ABI46_0_0React_native_assert(false);
  }
}
