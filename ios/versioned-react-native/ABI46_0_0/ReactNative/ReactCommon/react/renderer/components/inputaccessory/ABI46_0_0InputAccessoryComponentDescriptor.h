...
#include <ABI46_0_0React/ABI46_0_0renderer/components/inputaccessory/InputAccessoryShadowNode.h>
...
class InputAccessoryComponentDescriptor final
 ...
 public:
  ...
  void adopt(ShadowNode::Unshared const &shadowNode) const override {
    ...
    layoutableShadowNode->setPositionType(ABI46_0_0YGPositionTypeAbsolute);
