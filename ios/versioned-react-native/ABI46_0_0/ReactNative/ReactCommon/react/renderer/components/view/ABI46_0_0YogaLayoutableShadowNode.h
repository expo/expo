...
#include <ABI46_0_0React/ABI46_0_0renderer/components/view/YogaStylableProps.h>
...
#pragma mark - Mutating Methods
   ...
   */
  void setPositionType(ABI46_0_0YGPositionType positionType) const;
...
#pragma mark - LayoutableShadowNode
 ...
 protected:
   ...
   * all the time.
   */
  mutable ABI46_0_0YGNode yogaNode_;
 ...
 private:
  ...
  static ABI46_0_0YGConfig &initializeYogaConfig(ABI46_0_0YGConfig &config);
  static ABI46_0_0YGNode *yogaNodeCloneCallbackConnector(
      ABI46_0_0YGNode *oldYogaNode,
      ABI46_0_0YGNode *parentYogaNode,
      int childIndex);
  static ABI46_0_0YGSize yogaNodeMeasureCallbackConnector(
