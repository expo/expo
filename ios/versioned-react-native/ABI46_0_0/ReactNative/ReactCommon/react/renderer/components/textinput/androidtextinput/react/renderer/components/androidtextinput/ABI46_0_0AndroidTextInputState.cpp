...
#include "ABI46_0_0AndroidTextInputState.h"
...
AndroidTextInputState::AndroidTextInputState(
    ...
    : mostRecentEventCount(mostRecentEventCount),
      ...
      ABI46_0_0ReactTreeAttributedString(std::move(ABI46_0_0ReactTreeAttributedString)),
...
AndroidTextInputState::AndroidTextInputState(
    ...
    : mostRecentEventCount(data.getDefault(
      ...
      ABI46_0_0ReactTreeAttributedString(previousState.ABI46_0_0ReactTreeAttributedString),
