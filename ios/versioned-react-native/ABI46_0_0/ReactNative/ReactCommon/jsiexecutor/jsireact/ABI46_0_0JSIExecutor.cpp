...
void JSIExecutor::initializeRuntime() {
  ...
  bool hasLogger(ABI46_0_0ReactMarker::logTaggedMarker);
  if (hasLogger) {
    ABI46_0_0ReactMarker::logMarker(ABI46_0_0ReactMarker::CREATE_REACT_CONTEXT_STOP);
  }
}
...
void JSIExecutor::loadBundle(
  ...
  if (hasLogger) {
    ABI46_0_0ReactMarker::logTaggedMarker(
        ABI46_0_0ReactMarker::RUN_JS_BUNDLE_START, scriptName.c_str());
  }
  ...
  if (hasLogger) {
    ABI46_0_0ReactMarker::logTaggedMarker(
        ABI46_0_0ReactMarker::RUN_JS_BUNDLE_STOP, scriptName.c_str());
  }
}
        ...
        *runtime_,
        ...
        Function::createFromHostFunction(
            *runtime_,
            ...
            [this](
                __unused Runtime &rt,
                const ABI46_0_0facebook::jsi::Value &,
...
void JSIExecutor::registerBundle(
  ...
  ABI46_0_0ReactMarker::logTaggedMarker(
      ABI46_0_0ReactMarker::REGISTER_JS_SEGMENT_START, tag.c_str());
  if (bundleRegistry_) {
  ...
  ABI46_0_0ReactMarker::logTaggedMarker(
      ABI46_0_0ReactMarker::REGISTER_JS_SEGMENT_STOP, tag.c_str());
}
...
Value JSIExecutor::nativeRequire(const Value *args, size_t count) {
  ...
  return ABI46_0_0facebook::jsi::Value();
}
...
Value JSIExecutor::nativeCallSyncHook(const Value *args, size_t count) {
  ...
  /**
   * Note:
   * In ABI46_0_0RCTNativeModule, folly::none is returned from callSerializableNativeHook
