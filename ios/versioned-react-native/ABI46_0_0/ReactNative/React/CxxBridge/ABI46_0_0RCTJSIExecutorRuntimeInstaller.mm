...
#include "ABI46_0_0RCTJSIExecutorRuntimeInstaller.h"
...
JSIExecutor::RuntimeInstaller ABI46_0_0RCTJSIExecutorRuntimeInstaller(JSIExecutor::RuntimeInstaller runtimeInstallerToWrap)
{
  return [runtimeInstaller = runtimeInstallerToWrap](jsi::Runtime &runtime) {
    Logger iosLoggingBinder = [](const std::string &message, unsigned int logLevel) {
      _ABI46_0_0RCTLogJavaScriptInternal(static_cast<ABI46_0_0RCTLogLevel>(logLevel), [NSString stringWithUTF8String:message.c_str()]);
    };
