...
#import "ABI46_0_0RCTObjcExecutor.h"
...
#import <ABI46_0_0cxxreact/ABI46_0_0JSBigString.h>
#import <ABI46_0_0cxxreact/ABI46_0_0JSExecutor.h>
#import <ABI46_0_0cxxreact/ABI46_0_0MessageQueueThread.h>
#import <ABI46_0_0cxxreact/ABI46_0_0ModuleRegistry.h>
#import <ABI46_0_0cxxreact/ABI46_0_0RAMBundleRegistry.h>
#import <folly/json.h>
...
class ABI46_0_0RCTObjcExecutor : public JSExecutor {
 public:
  ABI46_0_0RCTObjcExecutor(
  ...
  {
    ABI46_0_0RCTProfileBeginFlowEvent();
    [m_jse executeApplicationScript:[NSData dataWithBytes:script->c_str() length:script->size()]
                         ...
                         onComplete:^(NSError *error) {
                           ABI46_0_0RCTProfileEndFlowEvent();
  ...
  {
    ABI46_0_0RCTAssert(NO, @"RAM bundles are not supported in ABI46_0_0RCTObjcExecutor");
  }
 ...
 private:
  ...
  ABI46_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI46_0_0RCTObjcExecutorFactory::ABI46_0_0RCTObjcExecutorFactory(id<ABI46_0_0RCTJavaScriptExecutor> jse, ABI46_0_0RCTJavaScriptCompleteBlock errorBlock)
    : m_jse(jse), m_errorBlock(errorBlock)
{
}

std::unique_ptr<JSExecutor> ABI46_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue)
{
  return std::unique_ptr<JSExecutor>(new ABI46_0_0RCTObjcExecutor(m_jse, m_errorBlock, jsQueue, delegate));
}
