...
@interface ABI46_0_0RCTConvert (ABI46_0_0RCTModalHostView)

+ (UIModalPresentationStyle)UIModalPresentationStyle:(id)json;

@end

typedef void (^ABI46_0_0RCTModalViewInteractionBlock)(
    UIViewController *ABI46_0_0ReactViewController,
    UIViewController *viewController,
    BOOL animated,
    dispatch_block_t completionBlock);

@interface ABI46_0_0RCTModalHostViewManager : ABI46_0_0RCTViewManager <ABI46_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, strong) ABI46_0_0RCTModalViewInteractionBlock presentationBlock;
@property (nonatomic, strong) ABI46_0_0RCTModalViewInteractionBlock dismissalBlock;
