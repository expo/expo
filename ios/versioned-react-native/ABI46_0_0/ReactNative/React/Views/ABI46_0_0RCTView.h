...
@interface ABI46_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI46_0_0RCTDirectEventBlock onAccessibilityAction;
@property (nonatomic, copy) ABI46_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI46_0_0RCTDirectEventBlock onMagicTap;
@property (nonatomic, copy) ABI46_0_0RCTDirectEventBlock onAccessibilityEscape;
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI46_0_0RCTBorderStyle borderStyle;
 ...
 */
@property (nonatomic, assign) ABI46_0_0RCTBubblingEventBlock onPointerCancel;
@property (nonatomic, assign) ABI46_0_0RCTBubblingEventBlock onPointerDown;
@property (nonatomic, assign) ABI46_0_0RCTBubblingEventBlock onPointerMove2;
@property (nonatomic, assign) ABI46_0_0RCTBubblingEventBlock onPointerUp;
@property (nonatomic, assign) ABI46_0_0RCTCapturingEventBlock onPointerEnter2;
@property (nonatomic, assign) ABI46_0_0RCTCapturingEventBlock onPointerLeave2;
