...
@implementation ABI46_0_0RCTModalHostViewController {
...
- (instancetype)init
{
  ...
  _preferredStatusBarStyle = [ABI46_0_0RCTSharedApplication() statusBarStyle];
  _preferredStatusBarHidden = [ABI46_0_0RCTSharedApplication() isStatusBarHidden];
