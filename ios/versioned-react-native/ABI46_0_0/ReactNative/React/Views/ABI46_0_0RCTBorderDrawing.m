...
static const CGFloat ABI46_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI46_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return ABS(borderInsets.left - borderInsets.right) < ABI46_0_0RCTViewBorderThreshold &&
      ABS(borderInsets.left - borderInsets.bottom) < ABI46_0_0RCTViewBorderThreshold &&
      ABS(borderInsets.left - borderInsets.top) < ABI46_0_0RCTViewBorderThreshold;
}

BOOL ABI46_0_0RCTCornerRadiiAreEqual(ABI46_0_0RCTCornerRadii cornerRadii)
{
  return ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI46_0_0RCTViewBorderThreshold &&
      ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI46_0_0RCTViewBorderThreshold &&
      ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI46_0_0RCTViewBorderThreshold;
}

BOOL ABI46_0_0RCTBorderColorsAreEqual(ABI46_0_0RCTBorderColors borderColors)
{
...
ABI46_0_0RCTCornerInsets ABI46_0_0RCTGetCornerInsets(ABI46_0_0RCTCornerRadii cornerRadii, UIEdgeInsets edgeInsets)
{
  return (ABI46_0_0RCTCornerInsets){
      {
...
static UIEdgeInsets ABI46_0_0RCTRoundInsetsToPixel(UIEdgeInsets edgeInsets)
{
  edgeInsets.top = ABI46_0_0RCTRoundPixelValue(edgeInsets.top);
  edgeInsets.bottom = ABI46_0_0RCTRoundPixelValue(edgeInsets.bottom);
  edgeInsets.left = ABI46_0_0RCTRoundPixelValue(edgeInsets.left);
  edgeInsets.right = ABI46_0_0RCTRoundPixelValue(edgeInsets.right);

  return edgeInsets;
}

static void ABI46_0_0RCTPathAddEllipticArc(
...
CGPathRef ABI46_0_0RCTPathCreateWithRoundedRect(CGRect bounds, ABI46_0_0RCTCornerInsets cornerInsets, const CGAffineTransform *transform)
{
  ...
  ABI46_0_0RCTPathAddEllipticArc(
...
static void
ABI46_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds, CGPoint lineStart, CGPoint lineEnd, CGPoint intersections[2])
{
...
NS_INLINE BOOL ABI46_0_0RCTCornerRadiiAreAboveThreshold(ABI46_0_0RCTCornerRadii cornerRadii)
{
  return (
      cornerRadii.topLeft > ABI46_0_0RCTViewBorderThreshold || cornerRadii.topRight > ABI46_0_0RCTViewBorderThreshold ||
      cornerRadii.bottomLeft > ABI46_0_0RCTViewBorderThreshold || cornerRadii.bottomRight > ABI46_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI46_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI46_0_0RCTCornerRadii cornerRadii)
{
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI46_0_0RCTPathCreateWithRoundedRect(rect, ABI46_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static UIGraphicsImageRenderer *
ABI46_0_0RCTUIGraphicsImageRenderer(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge)
{
...
static UIImage *ABI46_0_0RCTGetSolidBorderImage(
    ...
    BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI46_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI46_0_0RCTCornerInsets cornerInsets = ABI46_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  borderInsets = ABI46_0_0RCTRoundInsetsToPixel(borderInsets);
  ...
  UIGraphicsImageRenderer *const imageRenderer =
      ABI46_0_0RCTUIGraphicsImageRenderer(size, backgroundColor, hasCornerRadii, drawToEdge);
  UIImage *image = [imageRenderer imageWithActions:^(UIGraphicsImageRendererContext *_Nonnull rendererContext) {
    const CGContextRef context = rendererContext.CGContext;
    const CGRect rect = {.size = size};
    CGPathRef path = ABI46_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
    ...
    CGPathRef insetPath = ABI46_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

    CGContextAddPath(context, insetPath);
    CGContextEOClip(context);

    BOOL hasEqualColors = ABI46_0_0RCTBorderColorsAreEqual(borderColors);
    if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
      ...
      if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
        CGPoint points[2];
        ABI46_0_0RCTEllipseGetIntersectionsWithLine(
...
static UIImage *ABI46_0_0RCTGetDashedOrDottedBorderImage(
    ...
    BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI46_0_0RCTBorderStyleDashed || borderStyle == ABI46_0_0RCTBorderStyleDotted);

  if (!ABI46_0_0RCTBorderColorsAreEqual(borderColors) || !ABI46_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI46_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI46_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  UIGraphicsImageRenderer *const imageRenderer =
      ABI46_0_0RCTUIGraphicsImageRenderer(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  return [imageRenderer imageWithActions:^(UIGraphicsImageRendererContext *_Nonnull rendererContext) {
    ...
    if (backgroundColor) {
      CGPathRef outerPath = ABI46_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
    ...
    CGPathRef path = ABI46_0_0RCTPathCreateWithRoundedRect(pathRect, ABI46_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

    CGFloat dashLengths[2];
    dashLengths[0] = dashLengths[1] = (borderStyle == ABI46_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
...
UIImage *ABI46_0_0RCTGetBorderImage(
    ABI46_0_0RCTBorderStyle borderStyle,
    CGSize viewSize,
    ABI46_0_0RCTCornerRadii cornerRadii,
    UIEdgeInsets borderInsets,
...
{
  switch (borderStyle) {
    case ABI46_0_0RCTBorderStyleSolid:
      return ABI46_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI46_0_0RCTBorderStyleDashed:
    case ABI46_0_0RCTBorderStyleDotted:
      return ABI46_0_0RCTGetDashedOrDottedBorderImage(
          borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI46_0_0RCTBorderStyleUnset:
      break;
  }
