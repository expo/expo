...
#import "ABI46_0_0RCTWrapperViewController.h"

#import <UIKit/UIScrollView.h>

#import "ABI46_0_0RCTAutoInsetsProtocol.h"
#import "ABI46_0_0RCTUtils.h"
#import "ABI46_0_0UIView+React.h"

@implementation ABI46_0_0RCTWrapperViewController {
  UIView *_wrapperView;
  UIView *_contentView;
...
{
  ABI46_0_0RCTAssertParam(contentView);
...
ABI46_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithNibName : (NSString *)nn bundle : (NSBundle *)nb)
...
static BOOL ABI46_0_0RCTFindScrollViewAndRefreshContentInsetInView(UIView *view)
{
  if ([view conformsToProtocol:@protocol(ABI46_0_0RCTAutoInsetsProtocol)]) {
    [(id<ABI46_0_0RCTAutoInsetsProtocol>)view refreshContentInset];
    return YES;
  }
  for (UIView *subview in view.subviews) {
    if (ABI46_0_0RCTFindScrollViewAndRefreshContentInsetInView(subview)) {
      return YES;
    }
  }
  return NO;
...
- (void)viewDidLayoutSubviews
{
  ...
  if (_previousTopLayoutLength != _currentTopLayoutGuide.length ||
    ...
    ABI46_0_0RCTFindScrollViewAndRefreshContentInsetInView(_contentView);
...
- (void)loadView
{
  ...
  //`contentView` which is a ABI46_0_0React-managed view.
