...
/**
 * Contains any methods related to scrolling. Any `ABI46_0_0RCTView` that has scrolling
 * features should implement these methods.
 */
@protocol ABI46_0_0RCTScrollableProtocol
 ...
 */
@protocol ABI46_0_0RCTCustomRefreshContolProtocol

@property (nonatomic, copy) ABI46_0_0RCTDirectEventBlock onRefresh;
