...
typedef UIFont * (^ABI46_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ABI46_0_0React Native will use the System font for rendering by default. If you want to
 ...
 */
ABI46_0_0RCT_EXTERN void ABI46_0_0RCTSetDefaultFontHandler(ABI46_0_0RCTFontHandler handler);
ABI46_0_0RCT_EXTERN BOOL ABI46_0_0RCTHasFontHandlerSet(void);

@interface ABI46_0_0RCTFont : NSObject
...
@interface ABI46_0_0RCTConvert (ABI46_0_0RCTFont)
