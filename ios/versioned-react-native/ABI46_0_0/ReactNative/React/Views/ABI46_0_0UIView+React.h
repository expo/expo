...
@interface UIView (ABI46_0_0React) <ABI46_0_0RCTComponent>

/**
 * ABI46_0_0RCTComponent interface.
 */
- (NSArray<UIView *> *)ABI46_0_0ReactSubviews NS_REQUIRES_SUPER;
- (UIView *)ABI46_0_0ReactSuperview NS_REQUIRES_SUPER;
- (void)insertABI46_0_0ReactSubview:(UIView *)subview atIndex:(NSInteger)atIndex NS_REQUIRES_SUPER;
- (void)removeABI46_0_0ReactSubview:(UIView *)subview NS_REQUIRES_SUPER;
 ...
 */
@property (nonatomic, assign) UIUserInterfaceLayoutDirection ABI46_0_0ReactLayoutDirection;
 ...
 */
@property (nonatomic, assign) ABI46_0_0YGDisplay ABI46_0_0ReactDisplay;

/**
 * The z-index of the view.
 */
@property (nonatomic, assign) NSInteger ABI46_0_0ReactZIndex;
...
/**
 * Updates the subviews array based on the ABI46_0_0ReactSubviews. Default behavior is
 * to insert the sortedABI46_0_0ReactSubviews into the UIView.
 */
 ...
 */
@property (nonatomic, readonly) UIEdgeInsets ABI46_0_0ReactBorderInsets;
@property (nonatomic, readonly) UIEdgeInsets ABI46_0_0ReactPaddingInsets;
@property (nonatomic, readonly) UIEdgeInsets ABI46_0_0ReactCompoundInsets;
@property (nonatomic, readonly) CGRect ABI46_0_0ReactContentFrame;
 ...
 * Defaults to `self`.
 */
@property (nonatomic, readonly) UIView *ABI46_0_0ReactAccessibilityElement;
