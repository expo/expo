...
#import "ABI46_0_0RCTRedBoxExtraDataViewController.h"

@interface ABI46_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI46_0_0RCTRedBoxExtraDataCell
...
@interface ABI46_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI46_0_0RCTRedBoxExtraDataViewController {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  ABI46_0_0RCTRedBoxExtraDataCell *cell =
      (ABI46_0_0RCTRedBoxExtraDataCell *)[tableView dequeueReusableCellWithIdentifier:reuseIdentifier];

  if (cell == nil) {
    cell = [[ABI46_0_0RCTRedBoxExtraDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
  }
