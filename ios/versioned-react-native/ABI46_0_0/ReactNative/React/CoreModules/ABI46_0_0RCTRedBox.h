...
#import <ABI46_0_0React/ABI46_0_0RCTErrorCustomizer.h>

@class ABI46_0_0RCTJSStackFrame;

typedef void (^ABI46_0_0RCTRedBoxButtonPressHandler)(void);

@interface ABI46_0_0RCTRedBox : NSObject <ABI46_0_0RCTBridgeModule>
...
/**
 * This category makes the red box instance available via the ABI46_0_0RCTBridge, which
 * is useful for any class that needs to access the red box or error log.
 */
@interface ABI46_0_0RCTBridge (ABI46_0_0RCTRedBox)

@property (nonatomic, readonly) ABI46_0_0RCTRedBox *redBox;
