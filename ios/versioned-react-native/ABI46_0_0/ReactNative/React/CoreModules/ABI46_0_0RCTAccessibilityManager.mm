...
#import "ABI46_0_0RCTAccessibilityManager+Internal.h"
...
NSString *const ABI46_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification =
    @"ABI46_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification";

@interface ABI46_0_0RCTAccessibilityManager () <ABI46_0_0NativeAccessibilityManagerSpec>
...
@implementation ABI46_0_0RCTAccessibilityManager
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    self.contentSizeCategory = ABI46_0_0RCTSharedApplication().preferredContentSizeCategory;
...
- (void)invalidateMultiplier
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI46_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification
                                                      object:self];
}
...
- (CGFloat)multiplierForContentSizeCategory:(NSString *)category
{
  ...
  if (m.doubleValue <= 0.0) {
    ABI46_0_0RCTLogError(@"Can't determine multiplier for category %@. Using 1.0.", category);
    m = @1.0;
  }
...
ABI46_0_0RCT_EXPORT_METHOD(setAccessibilityContentSizeMultipliers
                  : (ABI46_0_0JS::NativeAccessibilityManager::SpecSetAccessibilityContentSizeMultipliersJSMultipliers &)
                      JSMultipliers)
{
...
ABI46_0_0RCT_EXPORT_METHOD(setAccessibilityFocus : (double)ABI46_0_0ReactTag)
{
  dispatch_async(dispatch_get_main_queue(), ^{
    UIView *view = [self.viewRegistry_DEPRECATED viewForABI46_0_0ReactTag:@(ABI46_0_0ReactTag)];
    UIAccessibilityPostNotification(UIAccessibilityLayoutChangedNotification, view);
  });
}

ABI46_0_0RCT_EXPORT_METHOD(announceForAccessibility : (NSString *)announcement)
{
  UIAccessibilityPostNotification(UIAccessibilityAnnouncementNotification, announcement);
}

ABI46_0_0RCT_EXPORT_METHOD(announceForAccessibilityWithOptions
                  : (NSString *)announcement options
                  : (ABI46_0_0JS::NativeAccessibilityManager::SpecAnnounceForAccessibilityWithOptionsOptions &)options)
{
...
ABI46_0_0RCT_EXPORT_METHOD(getMultiplier : (ABI46_0_0RCTResponseSenderBlock)callback)
{
  if (callback) {
...
ABI46_0_0RCT_EXPORT_METHOD(getCurrentBoldTextState
                  : (ABI46_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI46_0_0RCTResponseSenderBlock)onError)
{
  onSuccess(@[ @(_isBoldTextEnabled) ]);
}

ABI46_0_0RCT_EXPORT_METHOD(getCurrentGrayscaleState
                  : (ABI46_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI46_0_0RCTResponseSenderBlock)onError)
{
...
ABI46_0_0RCT_EXPORT_METHOD(getCurrentInvertColorsState
                  : (ABI46_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI46_0_0RCTResponseSenderBlock)onError)
{
...
ABI46_0_0RCT_EXPORT_METHOD(getCurrentReduceMotionState
                  : (ABI46_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI46_0_0RCTResponseSenderBlock)onError)
{
...
ABI46_0_0RCT_EXPORT_METHOD(getCurrentReduceTransparencyState
                  : (ABI46_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI46_0_0RCTResponseSenderBlock)onError)
{
...
ABI46_0_0RCT_EXPORT_METHOD(getCurrentVoiceOverState
                  : (ABI46_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI46_0_0RCTResponseSenderBlock)onError)
{
...
{
  return std::make_shared<ABI46_0_0facebook::ABI46_0_0React::NativeAccessibilityManagerSpecJSI>(params);
}
...
@implementation ABI46_0_0RCTBridge (ABI46_0_0RCTAccessibilityManager)

- (ABI46_0_0RCTAccessibilityManager *)accessibilityManager
{
  return [self moduleForClass:[ABI46_0_0RCTAccessibilityManager class]];
}

@end

Class ABI46_0_0RCTAccessibilityManagerCls(void)
{
  return ABI46_0_0RCTAccessibilityManager.class;
}
