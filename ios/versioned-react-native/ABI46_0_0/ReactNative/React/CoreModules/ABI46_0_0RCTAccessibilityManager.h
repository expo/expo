...
extern NSString *const ABI46_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification; // posted when multiplier is changed

@interface ABI46_0_0RCTAccessibilityManager : NSObject <ABI46_0_0RCTBridgeModule>
...
@interface ABI46_0_0RCTBridge (ABI46_0_0RCTAccessibilityManager)

@property (nonatomic, readonly) ABI46_0_0RCTAccessibilityManager *accessibilityManager;
