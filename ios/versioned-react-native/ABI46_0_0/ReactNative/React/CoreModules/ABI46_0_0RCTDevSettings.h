...
/**
 * An abstraction for a key-value store to manage ABI46_0_0RCTDevSettings behavior.
 * The default implementation persists settings using NSUserDefaults.
 */
@protocol ABI46_0_0RCTDevSettingsDataSource <NSObject>
...
@protocol ABI46_0_0RCTDevSettingsInspectable <NSObject>
...
@interface ABI46_0_0RCTDevSettings : ABI46_0_0RCTEventEmitter <ABI46_0_0RCTInitializing>
...
/*
 * Whether shaking will show ABI46_0_0RCTDevMenu. The menu is enabled by default if ABI46_0_0RCT_DEV=1, but
...
- (void)addHandler:(id<ABI46_0_0RCTPackagerClientMethod>)handler
    forPackagerMethod:(NSString *)name __deprecated_msg("Use ABI46_0_0RCTPackagerConnection directly instead");
#endif

@end

@interface ABI46_0_0RCTBridge (ABI46_0_0RCTDevSettings)

@property (nonatomic, readonly) ABI46_0_0RCTDevSettings *devSettings;
...
// (i.e. ABI46_0_0RCT_DEV or ABI46_0_0RCT_DEV_MENU is set)
ABI46_0_0RCT_EXTERN void ABI46_0_0RCTDevSettingsSetEnabled(BOOL enabled);
