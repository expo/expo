...
#import "ABI46_0_0RCTExceptionsManager.h"
...
@interface ABI46_0_0RCTExceptionsManager () <ABI46_0_0NativeExceptionsManagerSpec>

@end

@implementation ABI46_0_0RCTExceptionsManager
...
{
  ABI46_0_0RCTRedBox *redbox = [_moduleRegistry moduleForName:"RedBox"];
    ...
    extraDataAsJSON:(nullable NSString *)extraDataAsJSON
{
  ...
  if (!ABI46_0_0RCT_DEBUG && reloadRetries < _maxReloadAttempts) {
    reloadRetries++;
    ABI46_0_0RCTTriggerReloadCommandListeners(@"JS Crash Reload");
  } else if (!ABI46_0_0RCT_DEV) {
    NSString *description = [@"Unhandled JS Exception: " stringByAppendingString:message];
    NSDictionary *errorInfo =
        @{NSLocalizedDescriptionKey : description, ABI46_0_0RCTJSStackTraceKey : stack, ABI46_0_0RCTJSExtraDataKey : extraDataAsJSON};
    ABI46_0_0RCTFatal([NSError errorWithDomain:ABI46_0_0RCTErrorDomain code:0 userInfo:errorInfo]);
  }
}

ABI46_0_0RCT_EXPORT_METHOD(reportSoftException
...
ABI46_0_0RCT_EXPORT_METHOD(reportFatalException
                  : (NSString *)message stack
                  : (NSArray<NSDictionary *> *)stack exceptionId
                  : (double)exceptionId)
{
...
ABI46_0_0RCT_EXPORT_METHOD(updateExceptionMessage
                  : (NSString *)message stack
                  : (NSArray<NSDictionary *> *)stack exceptionId
                  : (double)exceptionId)
{
...
ABI46_0_0RCT_EXPORT_METHOD(reportUnhandledException : (NSString *)message stack : (NSArray<NSDictionary *> *)stack)
{
  [self reportFatalException:message stack:stack exceptionId:-1];
}

ABI46_0_0RCT_EXPORT_METHOD(dismissRedbox) {}

ABI46_0_0RCT_EXPORT_METHOD(reportException : (ABI46_0_0JS::NativeExceptionsManager::ExceptionData &)data)
{
  ...
  NSString *extraDataAsJSON = ABI46_0_0RCTJSONStringify(extraData, NULL);
...
{
  return std::make_shared<ABI46_0_0facebook::ABI46_0_0React::NativeExceptionsManagerSpecJSI>(params);
}

@end

Class ABI46_0_0RCTExceptionsManagerCls(void)
{
  return ABI46_0_0RCTExceptionsManager.class;
}
