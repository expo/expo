 ...
 * are also bridge modules, so should be registered using ABI46_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI46_0_0RCTURLRequestHandler <ABI46_0_0RCTBridgeModule>
...
/**
 * If more than one ABI46_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
