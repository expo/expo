 ...
 */
@interface ABI46_0_0RCTImageSource : NSObject
...
@interface ABI46_0_0RCTConvert (ImageSource)

+ (ABI46_0_0RCTImageSource *)ABI46_0_0RCTImageSource:(id)json;
+ (NSArray<ABI46_0_0RCTImageSource *> *)ABI46_0_0RCTImageSourceArray:(id)json;
