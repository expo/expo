...
ABI46_0_0RCT_EXTERN NSString *const ABI46_0_0RCTBundleURLProviderUpdatedNotification;
ABI46_0_0RCT_EXTERN const NSUInteger kABI46_0_0RCTBundleURLProviderDefaultPort;
 ...
 * by calling this function before initializing ABI46_0_0React Native (ABI46_0_0RCTBridge etc).
 * By default the access is enabled.
 */
ABI46_0_0RCT_EXTERN void ABI46_0_0RCTBundleURLProviderAllowPackagerServerAccess(BOOL allowed);
#endif

@interface ABI46_0_0RCTBundleURLProvider : NSObject
 ...
 * The port is optional, if not specified, kABI46_0_0RCTBundleURLProviderDefaultPort will be used
 */
