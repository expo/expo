 ...
 * classes to change the ABI46_0_0RCTRootViews's internal state.
 */
@interface ABI46_0_0RCTRootView ()

/**
 * This setter should be used only by ABI46_0_0RCTUIManager on ABI46_0_0React root view
