...
@protocol ABI46_0_0RCTBridgeDelegate <NSObject>
...
/**
 * The bridge initializes any registered ABI46_0_0RCTBridgeModules automatically, however
 ...
 * previously called ABI46_0_0facebook::ABI46_0_0React::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI46_0_0RCTBridge *)bridge;
 ...
 */
- (BOOL)bridge:(ABI46_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI46_0_0RCTBridge *)bridge
                 onProgress:(ABI46_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI46_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Similar to loadSourceForBridge:onProgress:onComplete: but without progress
 * reporting.
 */
- (void)loadSourceForBridge:(ABI46_0_0RCTBridge *)bridge withBlock:(ABI46_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Retrieve the list of lazy-native-modules names for the given bridge.
 */
- (NSDictionary<NSString *, Class> *)extraLazyModuleClassesForBridge:(ABI46_0_0RCTBridge *)bridge;
