...
#import "ABI46_0_0RCTMultipartDataTask.h"

@interface ABI46_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>

@end

@implementation ABI46_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI46_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI46_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI46_0_0RCTMultipartStreamReader *reader = [[ABI46_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream
                                                                                  boundary:_boundary];
  ABI46_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
