...
#import <ABI46_0_0React/ABI46_0_0RCTSurfaceSizeMeasureMode.h>
#import <ABI46_0_0React/ABI46_0_0RCTSurfaceStage.h>

@class ABI46_0_0RCTBridge;
@class ABI46_0_0RCTSurface;

typedef UIView *_Nullable (^ABI46_0_0RCTSurfaceHostingViewActivityIndicatorViewFactory)(void);
 ...
 * of ABI46_0_0ReactNative-powered experiences in UIKit based apps.
 */
@interface ABI46_0_0RCTSurfaceHostingView : UIView <ABI46_0_0RCTSurfaceDelegate>

/**
 * Create an instance of ABI46_0_0RCTSurface to be hosted.
 */
+ (ABI46_0_0RCTSurface *)createSurfaceWithBridge:(ABI46_0_0RCTBridge *)bridge
...
- (instancetype)initWithSurface:(id<ABI46_0_0RCTSurfaceProtocol>)surface
                sizeMeasureMode:(ABI46_0_0RCTSurfaceSizeMeasureMode)sizeMeasureMode NS_DESIGNATED_INITIALIZER;
...
/**
 * Size measure mode which are defining relationship between UIKit and ABI46_0_0ReactNative
 * layout approaches.
 * Defaults to `ABI46_0_0RCTSurfaceSizeMeasureModeWidthAtMost | ABI46_0_0RCTSurfaceSizeMeasureModeHeightAtMost`.
 */
@property (nonatomic, assign) ABI46_0_0RCTSurfaceSizeMeasureMode sizeMeasureMode;
 ...
 */
@property (nonatomic, copy, nullable) ABI46_0_0RCTSurfaceHostingViewActivityIndicatorViewFactory activityIndicatorViewFactory;
