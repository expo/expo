...
#import "ABI46_0_0UIView+ComponentViewProtocol.h"
...
{
  ABI46_0_0RCTAssert(NO, @"`-[ABI46_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented in a concrete class.");
  return {};
}
...
{
  ABI46_0_0RCTAssert(NO, @"props access should be implemented by ABI46_0_0RCTViewComponentView.");
  return nullptr;
}
