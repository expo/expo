...
#import <ABI46_0_0React/ABI46_0_0RCTImageResponseObserverProxy.h>
#import <ABI46_0_0React/ABI46_0_0renderer/components/image/ImageComponentDescriptor.h>
#import <ABI46_0_0React/ABI46_0_0renderer/components/image/ImageEventEmitter.h>
#import <ABI46_0_0React/ABI46_0_0renderer/components/image/ImageProps.h>
#import <ABI46_0_0React/ABI46_0_0renderer/imagemanager/ImageRequest.h>
#import <ABI46_0_0React/ABI46_0_0renderer/imagemanager/ABI46_0_0RCTImagePrimitivesConversions.h>

using namespace ABI46_0_0facebook::ABI46_0_0React;

@implementation ABI46_0_0RCTImageComponentView {
  ImageShadowNode::ConcreteState::Shared _state;
  ABI46_0_0RCTImageResponseObserverProxy _imageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _imageView.contentMode = ABI46_0_0RCTContentModeFromImageResizeMode(defaultProps->resizeMode);
    _imageView.layer.minificationFilter = kCAFilterTrilinear;
    _imageView.layer.magnificationFilter = kCAFilterTrilinear;

    _imageResponseObserverProxy = ABI46_0_0RCTImageResponseObserverProxy(self);
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldImageProps.resizeMode != newImageProps.resizeMode) {
    _imageView.contentMode = ABI46_0_0RCTContentModeFromImageResizeMode(newImageProps.resizeMode);
  }

  // `tintColor`
  if (oldImageProps.tintColor != newImageProps.tintColor) {
    _imageView.tintColor = ABI46_0_0RCTUIColorFromSharedColor(newImageProps.tintColor);
  }
...
{
  ABI46_0_0RCTAssert(state, @"`state` must not be null.");
  ABI46_0_0RCTAssert(
...
#pragma mark - ABI46_0_0RCTImageResponseDelegate
...
- (void)didReceiveImage:(UIImage *)image metadata:(id)metadata fromObserver:(void const *)observer
{
  ...
  if (imageProps.resizeMode == ImageResizeMode::Repeat) {
    image = [image resizableImageWithCapInsets:ABI46_0_0RCTUIEdgeInsetsFromEdgeInsets(imageProps.capInsets)
  ...
  if (imageProps.blurRadius > __FLT_EPSILON__) {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
      UIImage *blurredImage = ABI46_0_0RCTBlurredImageWithRadius(image, blurRadius);
...
Class<ABI46_0_0RCTComponentViewProtocol> ABI46_0_0RCTImageCls(void);
...
Class<ABI46_0_0RCTComponentViewProtocol> ABI46_0_0RCTImageCls(void)
{
  return ABI46_0_0RCTImageComponentView.class;
}
