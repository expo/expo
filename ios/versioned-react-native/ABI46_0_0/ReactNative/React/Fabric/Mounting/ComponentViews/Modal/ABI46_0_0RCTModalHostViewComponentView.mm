...
#import "ABI46_0_0RCTModalHostViewComponentView.h"

#import <ABI46_0_0React/ABI46_0_0RCTBridge+Private.h>
#import <ABI46_0_0React/ABI46_0_0RCTModalManager.h>
#import <ABI46_0_0React/ABI46_0_0UIView+React.h>
#import <ABI46_0_0React/ABI46_0_0renderer/components/modal/ModalHostViewComponentDescriptor.h>
#import <ABI46_0_0React/ABI46_0_0renderer/components/modal/ModalHostViewState.h>
...
@interface ABI46_0_0RCTModalHostViewComponentView () <ABI46_0_0RCTFabricModalHostViewControllerDelegate>

@end

@implementation ABI46_0_0RCTModalHostViewComponentView {
  ABI46_0_0RCTFabricModalHostViewController *_viewController;
...
- (ABI46_0_0RCTFabricModalHostViewController *)viewController
{
  if (!_viewController) {
    _viewController = [ABI46_0_0RCTFabricModalHostViewController new];
...
{
  UIViewController *controller = [self ABI46_0_0ReactViewController];
...
#pragma mark - ABI46_0_0RCTFabricModalHostViewControllerDelegate
...
- (void)boundsDidChange:(CGRect)newBounds
{
  ...
  if (_state != nullptr) {
    auto newState = ModalHostViewState{ABI46_0_0RCTSizeFromCGSize(newBounds.size)};
...
Class<ABI46_0_0RCTComponentViewProtocol> ABI46_0_0RCTModalHostViewCls(void);
...
Class<ABI46_0_0RCTComponentViewProtocol> ABI46_0_0RCTModalHostViewCls(void)
{
  return ABI46_0_0RCTModalHostViewComponentView.class;
}
