...
#import "ABI46_0_0RCTParagraphComponentAccessibilityProvider.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <ABI46_0_0React/ABI46_0_0renderer/components/text/ParagraphComponentDescriptor.h>
#import <ABI46_0_0React/ABI46_0_0renderer/components/text/ParagraphProps.h>
#import <ABI46_0_0React/ABI46_0_0renderer/components/text/ParagraphState.h>
#import <ABI46_0_0React/ABI46_0_0renderer/components/text/RawTextComponentDescriptor.h>
#import <ABI46_0_0React/ABI46_0_0renderer/components/text/TextComponentDescriptor.h>
...
@implementation ABI46_0_0RCTParagraphComponentView {
  ParagraphShadowNode::ConcreteState::Shared _state;
  ParagraphAttributes _paragraphAttributes;
  ABI46_0_0RCTParagraphComponentAccessibilityProvider *_accessibilityProvider;
...
- (NSAttributedString *_Nullable)attributedText
{
  ...
  return ABI46_0_0RCTNSAttributedStringFromAttributedString(_state->getData().attributedString);
}
...
- (void)drawRect:(CGRect)rect
{
  ...
  ABI46_0_0RCTTextLayoutManager *nativeTextLayoutManager =
      (ABI46_0_0RCTTextLayoutManager *)unwrapManagedObject(textLayoutManager->getNativeTextLayoutManager());

  CGRect frame = ABI46_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
  ...
  if (![_accessibilityProvider isUpToDate:data.attributedString]) {
    ...
    if (textLayoutManager) {
      ...
      _accessibilityProvider =
          [[ABI46_0_0RCTParagraphComponentAccessibilityProvider alloc] initWithString:data.attributedString
...
#pragma mark - ABI46_0_0RCTTouchableComponentViewProtocol
...
Class<ABI46_0_0RCTComponentViewProtocol> ABI46_0_0RCTParagraphCls(void)
{
  return ABI46_0_0RCTParagraphComponentView.class;
}
