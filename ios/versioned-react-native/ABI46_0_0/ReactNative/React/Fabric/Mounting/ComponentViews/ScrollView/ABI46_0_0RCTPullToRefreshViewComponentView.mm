...
#import "ABI46_0_0RCTPullToRefreshViewComponentView.h"
...
#import <ABI46_0_0React/ABI46_0_0RCTRefreshableProtocol.h>
#import <ABI46_0_0React/ABI46_0_0RCTScrollViewComponentView.h>

#import "ABI46_0_0RCTFabricComponentsPlugins.h"

using namespace ABI46_0_0facebook::ABI46_0_0React;

@interface ABI46_0_0RCTPullToRefreshViewComponentView () <ABI46_0_0RCTPullToRefreshViewViewProtocol, ABI46_0_0RCTRefreshableProtocol>
@end

@implementation ABI46_0_0RCTPullToRefreshViewComponentView {
  UIRefreshControl *_refreshControl;
  ABI46_0_0RCTScrollViewComponentView *_scrollViewComponentView;
}
...
- (void)_updateTitle
{
  ...
  if (concreteProps.titleColor) {
    attributes[NSForegroundColorAttributeName] = ABI46_0_0RCTUIColorFromSharedColor(concreteProps.titleColor);
  }

  _refreshControl.attributedTitle =
      [[NSAttributedString alloc] initWithString:ABI46_0_0RCTNSStringFromString(concreteProps.title) attributes:attributes];
}
...
- (void)_attach
{
  ...
  _scrollViewComponentView = [ABI46_0_0RCTScrollViewComponentView findScrollViewComponentViewForView:self];
  if (!_scrollViewComponentView) {
    return;
  }
...
{
  ABI46_0_0RCTPullToRefreshViewHandleCommand(self, commandName, args);
}
...
#pragma mark - ABI46_0_0RCTRefreshableProtocol
...
Class<ABI46_0_0RCTComponentViewProtocol> ABI46_0_0RCTPullToRefreshViewCls(void)
{
  return ABI46_0_0RCTPullToRefreshViewComponentView.class;
}
