...
#import "ABI46_0_0RCTEnhancedScrollView.h"
#import <ABI46_0_0React/ABI46_0_0RCTUtils.h>

@interface ABI46_0_0RCTEnhancedScrollView () <UIScrollViewDelegate>
@end

@implementation ABI46_0_0RCTEnhancedScrollView {
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _delegateSplitter = [[ABI46_0_0RCTGenericDelegateSplitter alloc] initWithDelegateUpdateBlock:^(id delegate) {
...
- (void)setContentOffset:(CGPoint)contentOffset
{
  ...
  super.contentOffset = CGPointMake(
      ABI46_0_0RCTSanitizeNaNValue(contentOffset.x, @"scrollView.contentOffset.x"),
      ABI46_0_0RCTSanitizeNaNValue(contentOffset.y, @"scrollView.contentOffset.y"));
}
...
#pragma mark - ABI46_0_0RCTGenericDelegateSplitter
