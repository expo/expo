...
#import "ABI46_0_0RCTSwitchComponentView.h"

#import <ABI46_0_0React/ABI46_0_0RCTConversions.h>

#import <ABI46_0_0React/ABI46_0_0renderer/components/rncore/ComponentDescriptors.h>
#import <ABI46_0_0React/ABI46_0_0renderer/components/rncore/EventEmitters.h>
#import <ABI46_0_0React/ABI46_0_0renderer/components/rncore/Props.h>
#import <ABI46_0_0React/ABI46_0_0renderer/components/rncore/ABI46_0_0RCTComponentViewHelpers.h>

#import "ABI46_0_0RCTFabricComponentsPlugins.h"

using namespace ABI46_0_0facebook::ABI46_0_0React;

@interface ABI46_0_0RCTSwitchComponentView () <ABI46_0_0RCTSwitchViewProtocol>
@end

@implementation ABI46_0_0RCTSwitchComponentView {
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldSwitchProps.tintColor != newSwitchProps.tintColor) {
    _switchView.tintColor = ABI46_0_0RCTUIColorFromSharedColor(newSwitchProps.tintColor);
  }

  // `onTintColor
  if (oldSwitchProps.onTintColor != newSwitchProps.onTintColor) {
    _switchView.onTintColor = ABI46_0_0RCTUIColorFromSharedColor(newSwitchProps.onTintColor);
  }

  // `thumbTintColor`
  if (oldSwitchProps.thumbTintColor != newSwitchProps.thumbTintColor) {
    _switchView.thumbTintColor = ABI46_0_0RCTUIColorFromSharedColor(newSwitchProps.thumbTintColor);
  }
...
{
  ABI46_0_0RCTSwitchHandleCommand(self, commandName, args);
}
...
Class<ABI46_0_0RCTComponentViewProtocol> ABI46_0_0RCTSwitchCls(void)
{
  return ABI46_0_0RCTSwitchComponentView.class;
}
