...
#import <ABI46_0_0React/ABI46_0_0RCTTouchableComponentViewProtocol.h>
#import <ABI46_0_0React/ABI46_0_0UIView+ComponentViewProtocol.h>
#import <ABI46_0_0React/ABI46_0_0renderer/components/view/ViewEventEmitter.h>
#import <ABI46_0_0React/ABI46_0_0renderer/components/view/ViewProps.h>
#import <ABI46_0_0React/ABI46_0_0renderer/core/EventEmitter.h>
#import <ABI46_0_0React/ABI46_0_0renderer/core/LayoutMetrics.h>
#import <ABI46_0_0React/ABI46_0_0renderer/core/Props.h>
 ...
 */
@interface ABI46_0_0RCTViewComponentView : UIView <ABI46_0_0RCTComponentViewProtocol, ABI46_0_0RCTTouchableComponentViewProtocol> {
 @protected
  ABI46_0_0facebook::ABI46_0_0React::LayoutMetrics _layoutMetrics;
  ABI46_0_0facebook::ABI46_0_0React::SharedViewProps _props;
  ABI46_0_0facebook::ABI46_0_0React::SharedViewEventEmitter _eventEmitter;
}
...
/**
 * Enforcing `call super` semantic for overridden methods from `ABI46_0_0RCTComponentViewProtocol`.
 * The methods update the instance variables.
 */
- (void)updateProps:(ABI46_0_0facebook::ABI46_0_0React::Props::Shared const &)props
           oldProps:(ABI46_0_0facebook::ABI46_0_0React::Props::Shared const &)oldProps NS_REQUIRES_SUPER;
- (void)updateEventEmitter:(ABI46_0_0facebook::ABI46_0_0React::EventEmitter::Shared const &)eventEmitter NS_REQUIRES_SUPER;
- (void)updateLayoutMetrics:(ABI46_0_0facebook::ABI46_0_0React::LayoutMetrics const &)layoutMetrics
           oldLayoutMetrics:(ABI46_0_0facebook::ABI46_0_0React::LayoutMetrics const &)oldLayoutMetrics NS_REQUIRES_SUPER;
- (void)finalizeUpdates:(ABI46_0_0RNComponentViewUpdateMask)updateMask NS_REQUIRES_SUPER;
