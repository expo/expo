 ...
 */
@interface ABI46_0_0RCTModalHostViewComponentView : ABI46_0_0RCTViewComponentView <ABI46_0_0RCTMountingTransactionObserving>

/**
 * Subclasses may override this method and present the modal on different view controller.
 * Default implementation presents the modal on `[self ABI46_0_0ReactViewController]`.
 */
