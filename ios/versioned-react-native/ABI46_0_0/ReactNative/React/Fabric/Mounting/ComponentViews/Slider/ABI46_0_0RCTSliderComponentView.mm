...
#import "ABI46_0_0RCTSliderComponentView.h"
...
#import <ABI46_0_0React/ABI46_0_0renderer/components/slider/SliderComponentDescriptor.h>

#import "ABI46_0_0RCTFabricComponentsPlugins.h"

using namespace ABI46_0_0facebook::ABI46_0_0React;

@interface ABI46_0_0RCTSliderComponentView () <ABI46_0_0RCTImageResponseDelegate>
@end

@implementation ABI46_0_0RCTSliderComponentView {
  ...
  ABI46_0_0RCTImageResponseObserverProxy _trackImageResponseObserverProxy;
  ABI46_0_0RCTImageResponseObserverProxy _minimumTrackImageResponseObserverProxy;
  ABI46_0_0RCTImageResponseObserverProxy _maximumTrackImageResponseObserverProxy;
  ABI46_0_0RCTImageResponseObserverProxy _thumbImageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _trackImageResponseObserverProxy = ABI46_0_0RCTImageResponseObserverProxy(self);
    _minimumTrackImageResponseObserverProxy = ABI46_0_0RCTImageResponseObserverProxy(self);
    _maximumTrackImageResponseObserverProxy = ABI46_0_0RCTImageResponseObserverProxy(self);
    _thumbImageResponseObserverProxy = ABI46_0_0RCTImageResponseObserverProxy(self);
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldSliderProps.thumbTintColor != newSliderProps.thumbTintColor) {
    _sliderView.thumbTintColor = ABI46_0_0RCTUIColorFromSharedColor(newSliderProps.thumbTintColor);
  }

  // `minimumTrackTintColor`
  if (oldSliderProps.minimumTrackTintColor != newSliderProps.minimumTrackTintColor) {
    _sliderView.minimumTrackTintColor = ABI46_0_0RCTUIColorFromSharedColor(newSliderProps.minimumTrackTintColor);
  }

  // `maximumTrackTintColor`
  if (oldSliderProps.maximumTrackTintColor != newSliderProps.maximumTrackTintColor) {
    _sliderView.maximumTrackTintColor = ABI46_0_0RCTUIColorFromSharedColor(newSliderProps.maximumTrackTintColor);
  }
...
Class<ABI46_0_0RCTComponentViewProtocol> ABI46_0_0RCTSliderCls(void)
{
  return ABI46_0_0RCTSliderComponentView.class;
}
