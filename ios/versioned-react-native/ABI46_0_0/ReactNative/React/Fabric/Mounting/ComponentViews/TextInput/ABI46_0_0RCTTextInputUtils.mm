...
static NSAttributedString *ABI46_0_0RCTSanitizeAttributedString(NSAttributedString *attributedString)
{
...
{
  toTextInput.attributedText = ABI46_0_0RCTSanitizeAttributedString(fromTextInput.attributedText);
...
UIKeyboardAppearance ABI46_0_0RCTUIKeyboardAppearanceFromKeyboardAppearance(KeyboardAppearance keyboardAppearance)
{
...
UIKeyboardType ABI46_0_0RCTUIKeyboardTypeFromKeyboardType(KeyboardType keyboardType)
{
  switch (keyboardType) {
    // Universal
...
UIReturnKeyType ABI46_0_0RCTUIReturnKeyTypeFromReturnKeyType(ReturnKeyType returnKeyType)
{
...
UITextContentType ABI46_0_0RCTUITextContentTypeFromString(std::string const &contentType)
{
  ...
  return contentTypeMap[ABI46_0_0RCTNSStringFromString(contentType)] ?: @"";
}

API_AVAILABLE(ios(12.0))
UITextInputPasswordRules *ABI46_0_0RCTUITextInputPasswordRulesFromString(std::string const &passwordRules)
{
  return [UITextInputPasswordRules passwordRulesWithDescriptor:ABI46_0_0RCTNSStringFromStringNilIfEmpty(passwordRules)];
}
