...
#import <ABI46_0_0React/ABI46_0_0RCTGenericDelegateSplitter.h>
#import <ABI46_0_0React/ABI46_0_0RCTMountingTransactionObserving.h>
 ...
 */
@interface ABI46_0_0RCTScrollViewComponentView : ABI46_0_0RCTViewComponentView <ABI46_0_0RCTMountingTransactionObserving>

/*
 * Finds and returns the closet ABI46_0_0RCTScrollViewComponentView component to the given view
 */
+ (nullable ABI46_0_0RCTScrollViewComponentView *)findScrollViewComponentViewForView:(UIView *)view;
...
@property (nonatomic, strong, readonly)
    ABI46_0_0RCTGenericDelegateSplitter<id<UIScrollViewDelegate>> *scrollViewDelegateSplitter;

@end

/*
 * ABI46_0_0RCTScrollableProtocol is a protocol which ABI46_0_0RCTScrollViewManager uses to communicate with all kinds of `UIScrollView`s.
 ...
 */
@interface ABI46_0_0RCTScrollViewComponentView (ScrollableProtocol) <ABI46_0_0RCTScrollableProtocol>
