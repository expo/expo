...
@implementation ABI46_0_0RCTLegacyViewManagerInteropCoordinatorAdapter {
  ABI46_0_0RCTLegacyViewManagerInteropCoordinator *_coordinator;
  NSInteger _tag;
}

- (instancetype)initWithCoordinator:(ABI46_0_0RCTLegacyViewManagerInteropCoordinator *)coordinator ABI46_0_0ReactTag:(NSInteger)tag
{
  if (self = [super init]) {
...
{
  [_coordinator handleCommand:commandName args:args ABI46_0_0ReactTag:_tag];
}
