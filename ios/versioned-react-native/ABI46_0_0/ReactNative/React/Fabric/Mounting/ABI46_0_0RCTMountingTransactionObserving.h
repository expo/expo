 ...
 *
 * # Usecases
 * ABI46_0_0React Native platform-specific mounting layer has limitations when it comes to notifying view components about
 ...
 * required.
 * - Alternatively, an observer can be registered explicitly via `ABI46_0_0RCTSurface`.
 *
 ...
 */
@protocol ABI46_0_0RCTMountingTransactionObserving <NSObject>
 ...
 */
- (void)mountingTransactionWillMount:(ABI46_0_0facebook::ABI46_0_0React::MountingTransaction const &)transaction
                withSurfaceTelemetry:(ABI46_0_0facebook::ABI46_0_0React::SurfaceTelemetry const &)surfaceTelemetry;
 ...
 */
- (void)mountingTransactionDidMount:(ABI46_0_0facebook::ABI46_0_0React::MountingTransaction const &)transaction
               withSurfaceTelemetry:(ABI46_0_0facebook::ABI46_0_0React::SurfaceTelemetry const &)surfaceTelemetry;
