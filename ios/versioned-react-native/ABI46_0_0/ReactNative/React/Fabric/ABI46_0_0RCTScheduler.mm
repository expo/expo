...
#import "ABI46_0_0RCTScheduler.h"

#import <ABI46_0_0React/ABI46_0_0renderer/animations/LayoutAnimationDriver.h>
...
#import <ABI46_0_0React/ABI46_0_0renderer/scheduler/Scheduler.h>
#import <ABI46_0_0React/ABI46_0_0renderer/scheduler/SchedulerDelegate.h>
...
class SchedulerDelegateProxy : public SchedulerDelegate {
 public:
  ...
  {
    ABI46_0_0RCTScheduler *scheduler = (__bridge ABI46_0_0RCTScheduler *)scheduler_;
...
@implementation ABI46_0_0RCTScheduler {
...
{
  if (self = [super init]) {
    auto ABI46_0_0ReactNativeConfig =
        toolbox.contextContainer->at<std::shared_ptr<const ABI46_0_0ReactNativeConfig>>("ABI46_0_0ReactNativeConfig");

    _delegateProxy = std::make_shared<SchedulerDelegateProxy>((__bridge void *)self);

    if (ABI46_0_0ReactNativeConfig->getBool("ABI46_0_0React_fabric:enabled_layout_animations_ios")) {
      ...
      if (ABI46_0_0ReactNativeConfig->getBool("ABI46_0_0React_fabric:enabled_skip_invalidated_key_frames_ios")) {
        _animationDriver->enableSkipInvalidatedKeyFrames();
      }
      if (ABI46_0_0ReactNativeConfig->getBool("ABI46_0_0React_fabric:enable_crash_on_missing_component_descriptor")) {
        _animationDriver->enableCrashOnMissingComponentDescriptor();
      }
      if (ABI46_0_0ReactNativeConfig->getBool("ABI46_0_0React_fabric:enable_simulate_image_props_memory_access")) {
...
- (std::shared_ptr<ABI46_0_0facebook::ABI46_0_0React::UIManager> const)uiManager
{
