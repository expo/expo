...
@class ABI46_0_0RCTSurfaceView;
@class ABI46_0_0RCTSurfacePresenter;

/**
 * (This is Fabric-compatible ABI46_0_0RCTSurface implementation.)
 *
 * ABI46_0_0RCTSurface instance represents ABI46_0_0React Native-powered piece of a user interface
 * which can be a full-screen app, separate modal view controller,
 * or even small widget.
 * It is called "Surface".
 *
 * The ABI46_0_0RCTSurface instance is completely thread-safe by design;
 ...
 *
 * The primary goals of the ABI46_0_0RCTSurface are:
 ...
 */
@interface ABI46_0_0RCTFabricSurface : NSObject <ABI46_0_0RCTSurfaceProtocol>

- (instancetype)initWithSurfacePresenter:(ABI46_0_0RCTSurfacePresenter *)surfacePresenter
 ...
 * ABI46_0_0RCTSurface does not control (or influence in any way) the size or origin
...
/**
 * Simple shortcut to `-[ABI46_0_0RCTSurface setMinimumSize:size maximumSize:size]`.
 */
...
@interface ABI46_0_0RCTFabricSurface (Internal)

- (ABI46_0_0facebook::ABI46_0_0React::SurfaceHandler const &)surfaceHandler;

@end

@interface ABI46_0_0RCTFabricSurface (Deprecated)
