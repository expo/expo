...
#import "ABI46_0_0RCTCxxMethod.h"
...
#import <ABI46_0_0cxxreact/ABI46_0_0JsArgumentHelpers.h>

#import "ABI46_0_0RCTCxxUtils.h"
...
@implementation ABI46_0_0RCTCxxMethod {
...
- (ABI46_0_0RCTFunctionType)functionType
{
  std::string type(_method->getType());
  if (type == "sync") {
    return ABI46_0_0RCTFunctionTypeSync;
  } else if (type == "async") {
    return ABI46_0_0RCTFunctionTypeNormal;
  } else {
    return ABI46_0_0RCTFunctionTypePromise;
  }
}
...
- (id)invokeWithBridge:(ABI46_0_0RCTBridge *)bridge module:(id)module arguments:(NSArray *)arguments
{
  ...
  if (arguments.count < _method->callbacks) {
    ABI46_0_0RCTLogError(
        ...
        ABI46_0_0RCTBridgeModuleNameForClass([module class]),
        _method->name.c_str(),
        _method->callbacks,
        arguments.count);
    return nil;
