...
@protocol ABI46_0_0RCTPackagerClientMethod;
@class ABI46_0_0RCTPackagerClientResponder;

typedef uint32_t ABI46_0_0RCTHandlerToken;
typedef void (^ABI46_0_0RCTNotificationHandler)(NSDictionary<NSString *, id> *);
typedef void (^ABI46_0_0RCTRequestHandler)(NSDictionary<NSString *, id> *, ABI46_0_0RCTPackagerClientResponder *);
typedef void (^ABI46_0_0RCTConnectedHandler)(void);

/** Encapsulates singleton connection to ABI46_0_0React Native packager. */
@interface ABI46_0_0RCTPackagerConnection : NSObject
 ...
 */
- (void)addHandler:(id<ABI46_0_0RCTPackagerClientMethod>)handler
