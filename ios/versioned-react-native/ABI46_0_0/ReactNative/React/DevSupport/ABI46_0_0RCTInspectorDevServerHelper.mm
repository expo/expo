...
{
  NSNumber *port = @8081;
  NSString *portStr = [[[NSProcessInfo processInfo] environment] objectForKey:@"ABI46_0_0RCT_METRO_PORT"];
...
@implementation ABI46_0_0RCTInspectorDevServerHelper

ABI46_0_0RCT_NOT_IMPLEMENTED(-(instancetype)init)

static NSMutableDictionary<NSString *, ABI46_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
...
+ (ABI46_0_0RCTInspectorPackagerConnection *)connectWithBundleURL:(NSURL *)bundleURL
{
  ...
  ABI46_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection || !connection.isConnected) {
    connection = [[ABI46_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
