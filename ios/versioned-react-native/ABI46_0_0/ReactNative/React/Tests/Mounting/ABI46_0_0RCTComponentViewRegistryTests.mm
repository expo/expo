...
@interface ABI46_0_0RCTComponentViewRegistryTests : XCTestCase
@end

using namespace ABI46_0_0facebook::ABI46_0_0React;

@implementation ABI46_0_0RCTComponentViewRegistryTests {
  ABI46_0_0RCTComponentViewRegistry *_componentViewRegistry;
}
...
- (void)testComponentViewDescriptorWithTag
{
  ...
  auto newViewDescriptor = [_componentViewRegistry
      dequeueComponentViewWithComponentHandle:[ABI46_0_0RCTViewComponentView componentDescriptorProvider].handle
                                          tag:existingTag];
...
- (void)testDequeueAndEnqueue
{
  ...
  XCTAssertThrows(
      ^{
        Tag nonExistingTag = 12;
        [self->_componentViewRegistry
            enqueueComponentViewWithComponentHandle:[ABI46_0_0RCTViewComponentView componentDescriptorProvider].handle
                                                tag:nonExistingTag
