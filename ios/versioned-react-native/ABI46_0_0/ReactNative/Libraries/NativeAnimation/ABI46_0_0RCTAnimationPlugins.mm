...
Class ABI46_0_0RCTAnimationClassProvider(const char *name) {
  // Intentionally leak to avoid crashing after static destructors are run.
  static const auto sCoreModuleClassMap = new const std::unordered_map<std::string, Class (*)(void)>{
    {"NativeAnimatedModule", ABI46_0_0RCTNativeAnimatedModuleCls},
    {"NativeAnimatedTurboModule", ABI46_0_0RCTNativeAnimatedTurboModuleCls},
  };
