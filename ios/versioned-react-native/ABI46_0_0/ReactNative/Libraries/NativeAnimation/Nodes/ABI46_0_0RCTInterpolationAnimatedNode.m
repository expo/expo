...
@implementation ABI46_0_0RCTInterpolationAnimatedNode
{
  __weak ABI46_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI46_0_0RCTAnimatedNode *)parent
{
  [super onAttachedToNode:parent];
  if ([parent isKindOfClass:[ABI46_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI46_0_0RCTValueAnimatedNode *)parent;
  }
}

- (void)onDetachedFromNode:(ABI46_0_0RCTAnimatedNode *)parent
{
...
- (void)performUpdate
{
  ...
  CGFloat interpolated = ABI46_0_0RCTInterpolateValueInRange(inputValue,
                                                    _inputRange,
                                                    _outputRange,
                                                    _extrapolateLeft,
                                                    _extrapolateRight);
  ...
  if (_hasStringOutput) {
    ...
    if (_numVals > 1) {
      ...
      for (NSTextCheckingResult *match in [_matches reverseObjectEnumerator]) {
        CGFloat val = ABI46_0_0RCTInterpolateValueInRange(inputValue,
                                                          _inputRange,
                                                          _outputs[--i],
                                                          _extrapolateLeft,
                                                          _extrapolateRight);
