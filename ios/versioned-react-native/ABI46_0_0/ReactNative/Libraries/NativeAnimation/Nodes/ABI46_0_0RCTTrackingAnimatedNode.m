...
@implementation ABI46_0_0RCTTrackingAnimatedNode {
...
- (void)performUpdate
{
  ...
  ABI46_0_0RCTValueAnimatedNode *node = (ABI46_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
