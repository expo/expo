...
@protocol ABI46_0_0RCTValueAnimatedNodeObserver;

NS_ASSUME_NONNULL_BEGIN

@interface ABI46_0_0RCTNativeAnimatedNodesManager : NSObject

- (nonnull instancetype)initWithBridge:(nullable ABI46_0_0RCTBridge *)bridge
...
- (void)getValue:(NSNumber *)nodeTag
        saveCallback:(ABI46_0_0RCTResponseSenderBlock)saveCallback;
