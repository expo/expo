...
Pod::Spec.new do |s|
  s.name                   = "ABI46_0_0React-RCTPushNotification"
  s.version                = version
  ...
  s.header_dir             = "ABI46_0_0RCTPushNotification"
  ...
  s.dependency "ABI46_0_0React-Codegen", version
  s.dependency "ABI46_0_0RCTTypeSafety", version
  s.dependency "ABI46_0_0React-Core/RCTPushNotificationHeaders", version
