...
@class ABI46_0_0RCTReconnectingWebSocket;

@protocol ABI46_0_0RCTReconnectingWebSocketDelegate
- (void)reconnectingWebSocketDidOpen:(ABI46_0_0RCTReconnectingWebSocket *)webSocket;
...
- (void)reconnectingWebSocketDidClose:(ABI46_0_0RCTReconnectingWebSocket *)webSocket;
@end

@interface ABI46_0_0RCTReconnectingWebSocket : NSObject

/** Delegate will be messaged on the given queue (required). */
- (instancetype)initWithURL:(NSURL *)url queue:(dispatch_queue_t)queue;

@property (nonatomic, weak) id<ABI46_0_0RCTReconnectingWebSocketDelegate> delegate;
- (void)send:(id)data;
- (void)start;
- (void)stop;
