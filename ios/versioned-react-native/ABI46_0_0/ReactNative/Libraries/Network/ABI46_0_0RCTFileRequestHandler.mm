...
@interface ABI46_0_0RCTFileRequestHandler() <ABI46_0_0RCTTurboModule>
@end

@implementation ABI46_0_0RCTFileRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  && !ABI46_0_0RCTIsBundleAssetURL(request.URL);
}
...
Class ABI46_0_0RCTFileRequestHandlerCls(void) {
  return ABI46_0_0RCTFileRequestHandler.class;
}
