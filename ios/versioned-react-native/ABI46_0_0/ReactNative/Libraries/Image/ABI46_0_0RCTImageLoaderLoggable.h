...
/**
 * The image loader (i.e. ABI46_0_0RCTImageLoader) implement this to declare whether image performance should be logged.
 */
@protocol ABI46_0_0RCTImageLoaderLoggableProtocol
 ...
 */
@protocol ABI46_0_0RCTImageLoaderLoggable
