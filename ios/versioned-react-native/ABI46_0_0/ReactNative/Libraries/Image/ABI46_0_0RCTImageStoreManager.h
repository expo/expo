...
@interface ABI46_0_0RCTImageStoreManager : NSObject <ABI46_0_0RCTURLRequestHandler>
...
@interface ABI46_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI46_0_0RCTBridge (ABI46_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI46_0_0RCTImageStoreManager *imageStoreManager;
