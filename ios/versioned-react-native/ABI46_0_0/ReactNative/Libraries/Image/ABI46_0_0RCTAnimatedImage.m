...
@interface ABI46_0_0RCTGIFCoderFrame : NSObject
...
@implementation ABI46_0_0RCTGIFCoderFrame
@end

@implementation ABI46_0_0RCTAnimatedImage {
  CGImageSourceRef _imageSource;
  CGFloat _scale;
  NSUInteger _loopCount;
  NSUInteger _frameCount;
  NSArray<ABI46_0_0RCTGIFCoderFrame *> *_frames;
}
...
- (BOOL)scanAndCheckFramesValidWithSource:(CGImageSourceRef)imageSource
{
  ...
  NSMutableArray<ABI46_0_0RCTGIFCoderFrame *> *frames = [NSMutableArray array];

  for (size_t i = 0; i < frameCount; i++) {
    ABI46_0_0RCTGIFCoderFrame *frame = [ABI46_0_0RCTGIFCoderFrame new];
    frame.index = i;
