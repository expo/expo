...
#import "ABI46_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI46_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ABI46_0_0ReactViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ABI46_0_0ReactViewController detachChildViewController:self.contentViewController];
}
