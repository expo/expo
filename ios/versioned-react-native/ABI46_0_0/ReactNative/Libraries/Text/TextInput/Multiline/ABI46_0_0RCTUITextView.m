...
#import <ABI46_0_0React/ABI46_0_0RCTBackedTextInputDelegateAdapter.h>
#import <ABI46_0_0React/ABI46_0_0RCTTextAttributes.h>

@implementation ABI46_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI46_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI46_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
...
- (void)setDelegate:(id<UITextViewDelegate>)delegate {
  // Delegate is set inside `[ABI46_0_0RCTBackedTextViewDelegateAdapter initWithTextView]` and
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI46_0_0RCTCeilPixelValue(placeholderSize.width), ABI46_0_0RCTCeilPixelValue(placeholderSize.height));
