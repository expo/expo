...
@implementation ABI46_0_0RCTMultilineTextInputView
{
  ABI46_0_0RCTUITextView *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI46_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI46_0_0RCTUITextView alloc] initWithFrame:self.bounds];
...
{
  ABI46_0_0RCTDirectEventBlock onScroll = self.onScroll;
