...
NSString *const ABI46_0_0RCTTextAttributesIsHighlightedAttributeName = @"ABI46_0_0RCTTextAttributesIsHighlightedAttributeName";
NSString *const ABI46_0_0RCTTextAttributesTagAttributeName = @"ABI46_0_0RCTTextAttributesTagAttributeName";

@implementation ABI46_0_0RCTTextAttributes
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _opacity = NAN;
    _textTransform = ABI46_0_0RCTTextTransformUndefined;
  }
...
- (void)applyTextAttributes:(ABI46_0_0RCTTextAttributes *)textAttributes
{
  ...
  _textDecorationLine = textAttributes->_textDecorationLine != ABI46_0_0RCTTextDecorationLineTypeNone ? textAttributes->_textDecorationLine : _textDecorationLine; // *
  ...
  _textTransform = textAttributes->_textTransform != ABI46_0_0RCTTextTransformUndefined ? textAttributes->_textTransform : _textTransform;
}
...
- (NSDictionary<NSAttributedStringKey, id> *)effectiveTextAttributes
{
  ...
  if (_textDecorationLine == ABI46_0_0RCTTextDecorationLineTypeUnderline ||
      _textDecorationLine == ABI46_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    isTextDecorationEnabled = YES;
    attributes[NSUnderlineStyleAttributeName] = @(_textDecorationStyle);
  }

  if (_textDecorationLine == ABI46_0_0RCTTextDecorationLineTypeStrikethrough ||
      _textDecorationLine == ABI46_0_0RCTTextDecorationLineTypeUnderlineStrikethrough){
    isTextDecorationEnabled = YES;
  ...
  // Special
  if (_isHighlighted) {
    attributes[ABI46_0_0RCTTextAttributesIsHighlightedAttributeName] = @YES;
  }

  if (_tag) {
    attributes[ABI46_0_0RCTTextAttributesTagAttributeName] = _tag;
  }
...
{
  // FIXME: ABI46_0_0RCTFont has thread-safety issues and must be rewritten.
...
{
  bool fontScalingEnabled = !ABI46_0_0RCTHasFontHandlerSet() && _allowFontScaling;
...
- (NSString *)applyTextAttributesToText:(NSString *)text
{
  switch (_textTransform) {
    case ABI46_0_0RCTTextTransformUndefined:
    case ABI46_0_0RCTTextTransformNone:
      return text;
    case ABI46_0_0RCTTextTransformLowercase:
      return [text lowercaseString];
    case ABI46_0_0RCTTextTransformUppercase:
      return [text uppercaseString];
    case ABI46_0_0RCTTextTransformCapitalize:
      return capitalizeText(text);
  }
}

- (ABI46_0_0RCTTextAttributes *)copyWithZone:(NSZone *)zone
{
  ABI46_0_0RCTTextAttributes *textAttributes = [ABI46_0_0RCTTextAttributes new];
...
- (BOOL)isEqual:(ABI46_0_0RCTTextAttributes *)textAttributes
{
  if (!textAttributes) {
    return NO;
  }
...
#define ABI46_0_0RCTTextAttributesCompareFloats(a) ((a == textAttributes->a) || (isnan(a) && isnan(textAttributes->a)))
#define ABI46_0_0RCTTextAttributesCompareSize(a) CGSizeEqualToSize(a, textAttributes->a)
#define ABI46_0_0RCTTextAttributesCompareObjects(a) ((a == textAttributes->a) || [a isEqual:textAttributes->a])
#define ABI46_0_0RCTTextAttributesCompareStrings(a) ((a == textAttributes->a) || [a isEqualToString:textAttributes->a])
#define ABI46_0_0RCTTextAttributesCompareOthers(a) (a == textAttributes->a)

  return
    ABI46_0_0RCTTextAttributesCompareObjects(_foregroundColor) &&
    ABI46_0_0RCTTextAttributesCompareObjects(_backgroundColor) &&
    ABI46_0_0RCTTextAttributesCompareFloats(_opacity) &&
    // Font
    ABI46_0_0RCTTextAttributesCompareObjects(_fontFamily) &&
    ABI46_0_0RCTTextAttributesCompareFloats(_fontSize) &&
    ABI46_0_0RCTTextAttributesCompareFloats(_fontSizeMultiplier) &&
    ABI46_0_0RCTTextAttributesCompareFloats(_maxFontSizeMultiplier) &&
    ABI46_0_0RCTTextAttributesCompareStrings(_fontWeight) &&
    ABI46_0_0RCTTextAttributesCompareObjects(_fontStyle) &&
    ABI46_0_0RCTTextAttributesCompareObjects(_fontVariant) &&
    ABI46_0_0RCTTextAttributesCompareOthers(_allowFontScaling) &&
    ABI46_0_0RCTTextAttributesCompareFloats(_letterSpacing) &&
    // Paragraph Styles
    ABI46_0_0RCTTextAttributesCompareFloats(_lineHeight) &&
    ABI46_0_0RCTTextAttributesCompareFloats(_alignment) &&
    ABI46_0_0RCTTextAttributesCompareOthers(_baseWritingDirection) &&
    // Decoration
    ABI46_0_0RCTTextAttributesCompareObjects(_textDecorationColor) &&
    ABI46_0_0RCTTextAttributesCompareOthers(_textDecorationStyle) &&
    ABI46_0_0RCTTextAttributesCompareOthers(_textDecorationLine) &&
    // Shadow
    ABI46_0_0RCTTextAttributesCompareSize(_textShadowOffset) &&
    ABI46_0_0RCTTextAttributesCompareFloats(_textShadowRadius) &&
    ABI46_0_0RCTTextAttributesCompareObjects(_textShadowColor) &&
    // Special
    ABI46_0_0RCTTextAttributesCompareOthers(_isHighlighted) &&
    ABI46_0_0RCTTextAttributesCompareObjects(_tag) &&
    ABI46_0_0RCTTextAttributesCompareOthers(_layoutDirection) &&
    ABI46_0_0RCTTextAttributesCompareOthers(_textTransform);
}
