...
@protocol ABI19_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI19_0_0RCTBridge *)bridge;
 ...
 */
- (NSURL *)fallbackSourceURLForBridge:(ABI19_0_0RCTBridge *)bridge;

/**
 * The bridge initializes any registered ABI19_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI19_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI19_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (NSArray<Class> *)whitelistedModulesForBridge:(ABI19_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeLoadJavaScriptSynchronously:(ABI19_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeInitializeNativeModulesSynchronously:(ABI19_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI19_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI19_0_0RCTBridge *)bridge;

/**
 * Configure whether the legacy ABI19_0_0RCTBatchedBridge or new ABI19_0_0RCTCxxBridge
 ...
 * implemented, the implementation will default to ABI19_0_0RCTBatchedBridge,
 * but if it is not linked in, will try ABI19_0_0RCTCxxBridge instead.  If
 ...
 * @experimental
 */
- (BOOL)shouldBridgeUseCxxBridge:(ABI19_0_0RCTBridge *)bridge;
 ...
 */
- (void)loadSourceForBridge:(ABI19_0_0RCTBridge *)bridge
                 onProgress:(ABI19_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI19_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI19_0_0RCTBridge *)bridge
                  withBlock:(ABI19_0_0RCTSourceLoadBlock)loadCallback;
