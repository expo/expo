...
typedef id<ABI19_0_0RCTBridgeModule>(^ABI19_0_0RCTBridgeModuleProvider)(void);

@interface ABI19_0_0RCTModuleData : NSObject <ABI19_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI19_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI19_0_0RCTBridgeModule> instance;
