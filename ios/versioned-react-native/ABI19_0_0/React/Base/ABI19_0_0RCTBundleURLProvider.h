...
extern NSString *const ABI19_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI19_0_0RCTBundleURLProviderDefaultPort;

@interface ABI19_0_0RCTBundleURLProvider : NSObject
