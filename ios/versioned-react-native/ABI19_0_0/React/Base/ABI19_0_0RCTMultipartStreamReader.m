...
#import "ABI19_0_0RCTMultipartStreamReader.h"

#define CRLF @"\r\n"

@implementation ABI19_0_0RCTMultipartStreamReader {
...
- (void)emitChunk:(NSData *)data callback:(ABI19_0_0RCTMultipartCallback)callback done:(BOOL)done
{
...
- (BOOL)readAllParts:(ABI19_0_0RCTMultipartCallback)callback
{
