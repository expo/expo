...
@interface ABI19_0_0RCTJSStackFrame : NSObject
...
+ (NSArray<ABI19_0_0RCTJSStackFrame *> *)stackFramesWithLines:(NSString *)lines;
+ (NSArray<ABI19_0_0RCTJSStackFrame *> *)stackFramesWithDictionaries:(NSArray<NSDictionary *> *)dicts;
