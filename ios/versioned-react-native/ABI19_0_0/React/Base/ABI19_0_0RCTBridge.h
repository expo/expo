...
#import <ReactABI19_0_0/ABI19_0_0RCTBridgeDelegate.h>
#import <ReactABI19_0_0/ABI19_0_0RCTBridgeModule.h>
#import <ReactABI19_0_0/ABI19_0_0RCTDefines.h>
#import <ReactABI19_0_0/ABI19_0_0RCTFrameUpdate.h>
#import <ReactABI19_0_0/ABI19_0_0RCTInvalidating.h>

@class JSValue;
@class ABI19_0_0RCTBridge;
@class ABI19_0_0RCTEventDispatcher;
@class ABI19_0_0RCTPerformanceLogger;

/**
 * This notification fires when the bridge starts loading the JS bundle.
 */
ABI19_0_0RCT_EXTERN NSString *const ABI19_0_0RCTJavaScriptWillStartLoadingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI19_0_0RCT_EXTERN NSString *const ABI19_0_0RCTJavaScriptDidLoadNotification;

/**
 * This notification fires when the bridge failed to load the JS bundle. The
 * `error` key can be used to determine the error that occured.
 */
ABI19_0_0RCT_EXTERN NSString *const ABI19_0_0RCTJavaScriptDidFailToLoadNotification;
 ...
 */
ABI19_0_0RCT_EXTERN NSString *const ABI19_0_0RCTDidInitializeModuleNotification;
 ...
 */
typedef NSArray<id<ABI19_0_0RCTBridgeModule>> *(^ABI19_0_0RCTBridgeModuleListProvider)(void);

/**
 * This function returns the module name for a given class.
 */
ABI19_0_0RCT_EXTERN NSString *ABI19_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI19_0_0RCTBridge : NSObject <ABI19_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI19_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI19_0_0RCTBridgeModules. Modules will be automatically instantiated
 * using the default contructor, but you can optionally pass in an array of
 * pre-initialized module instances if they require additional init parameters
 * or configuration.
 */
- (instancetype)initWithDelegate:(id<ABI19_0_0RCTBridgeDelegate>)delegate
...
- (instancetype)initWithBundleURL:(NSURL *)bundleURL
                   moduleProvider:(ABI19_0_0RCTBridgeModuleListProvider)block
                    launchOptions:(NSDictionary *)launchOptions;
 ...
 * See also -[ABI19_0_0RCTBridgeDelgate shouldBridgeLoadJavaScriptSynchronously], which
 ...
 */
@property (nonatomic, weak, readonly) id<ABI19_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ReactABI19_0_0 Native perf events.
 */
@property (nonatomic, readonly, strong) ABI19_0_0RCTPerformanceLogger *performanceLogger;
