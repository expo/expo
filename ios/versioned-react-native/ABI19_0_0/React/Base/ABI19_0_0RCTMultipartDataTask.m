...
@interface ABI19_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI19_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI19_0_0RCTMultipartDataTaskCallback _partHandler;
...
{
  ABI19_0_0RCTMultipartStreamReader *reader = [[ABI19_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI19_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
