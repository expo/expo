...
/**
 ...
 - The JS exception's unsymbolicated stack trace is available via the NSError userInfo's ABI19_0_0RCTJSExceptionUnsymbolicatedStackTraceKey
 */
ABI19_0_0RCT_EXTERN NSError *ABI19_0_0RCTNSErrorFromJSError(JSValue *exception);

/**
 Translates a given exception into an NSError.

 @see ABI19_0_0RCTNSErrorFromJSError for details
 */
ABI19_0_0RCT_EXTERN NSError *ABI19_0_0RCTNSErrorFromJSErrorRef(JSValueRef exceptionRef, JSGlobalContextRef ctx);
