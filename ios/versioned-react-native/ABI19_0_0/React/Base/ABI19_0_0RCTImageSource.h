 ...
 */
@interface ABI19_0_0RCTImageSource : NSObject
...
@interface ABI19_0_0RCTConvert (ImageSource)

+ (ABI19_0_0RCTImageSource *)ABI19_0_0RCTImageSource:(id)json;
+ (NSArray<ABI19_0_0RCTImageSource *> *)ABI19_0_0RCTImageSourceArray:(id)json;
