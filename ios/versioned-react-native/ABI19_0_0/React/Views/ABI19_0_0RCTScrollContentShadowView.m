...
@interface ABI19_0_0RCTShadowView () {
...
@implementation ABI19_0_0RCTScrollContentShadowView
       ...
       absolutePosition:(CGPoint)absolutePosition
{
  ...
  CGFloat xCompensation = ABI19_0_0YGNodeLayoutGetRight(node) - ABI19_0_0YGNodeLayoutGetLeft(node);
  ...
  _frame.origin.x = ABI19_0_0RCTRoundPixelValue(ABI19_0_0YGNodeLayoutGetRight(node));
}
