...
@class ABI19_0_0RCTView;

@interface ABI19_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI19_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI19_0_0RCTDirectEventBlock onMagicTap;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI19_0_0RCTPointerEvents pointerEvents;
 ...
 * This is inherited from UIView+ReactABI19_0_0, but we override it here
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI19_0_0RCTBorderStyle borderStyle;
