...
// These constants can only be removed when ReactABI19_0_0 Native drops iOS8 support.
...
typedef CGFloat ABI19_0_0RCTFontWeight;
static ABI19_0_0RCTFontWeight weightOfFont(UIFont *font)
{
  ...
  ABI19_0_0RCTFontWeight weight = [traits[UIFontWeightTrait] doubleValue];
  if (weight == 0.0) {
...
static UIFont *cachedSystemFont(CGFloat size, ABI19_0_0RCTFontWeight weight)
{
...
@implementation ABI19_0_0RCTConvert (ABI19_0_0RCTFont)

+ (UIFont *)UIFont:(id)json
{
  json = [self NSDictionary:json];
  return [ABI19_0_0RCTFont updateFont:nil
                  withFamily:[ABI19_0_0RCTConvert NSString:json[@"fontFamily"]]
                        size:[ABI19_0_0RCTConvert NSNumber:json[@"fontSize"]]
                      weight:[ABI19_0_0RCTConvert NSString:json[@"fontWeight"]]
                       style:[ABI19_0_0RCTConvert NSString:json[@"fontStyle"]]
                     variant:[ABI19_0_0RCTConvert NSStringArray:json[@"fontVariant"]]
             scaleMultiplier:1];
}

ABI19_0_0RCT_ENUM_CONVERTER(ABI19_0_0RCTFontWeight, (@{
                                     @"normal": @(UIFontWeightRegular),
                                     @"bold": @(UIFontWeightBold),
...
typedef BOOL ABI19_0_0RCTFontStyle;
ABI19_0_0RCT_ENUM_CONVERTER(ABI19_0_0RCTFontStyle, (@{
                                    @"normal": @NO,
                                    @"italic": @YES,
                                    @"oblique": @YES,
                                    }), NO, boolValue)

typedef NSDictionary ABI19_0_0RCTFontVariantDescriptor;
+ (ABI19_0_0RCTFontVariantDescriptor *)ABI19_0_0RCTFontVariantDescriptor:(id)json
{
  ...
  ABI19_0_0RCTFontVariantDescriptor *value = mapping[json];
  if (ABI19_0_0RCT_DEBUG && !value && [json description].length > 0) {
    ABI19_0_0RCTLogError(@"Invalid ABI19_0_0RCTFontVariantDescriptor '%@'. should be one of: %@", json,
                [[mapping allKeys] sortedArrayUsingSelector:@selector(caseInsensitiveCompare:)]);
  }
  return value;
}

ABI19_0_0RCT_ARRAY_CONVERTER(ABI19_0_0RCTFontVariantDescriptor)

@end

@implementation ABI19_0_0RCTFont
...
+ (UIFont *)updateFont:(UIFont *)font
            withFamily:(NSString *)family
               ...
               variant:(NSArray<ABI19_0_0RCTFontVariantDescriptor *> *)variant
       scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  const ABI19_0_0RCTFontWeight defaultFontWeight = UIFontWeightRegular;
  const CGFloat defaultFontSize = 14;

  // Initialize properties to defaults
  CGFloat fontSize = defaultFontSize;
  ABI19_0_0RCTFontWeight fontWeight = defaultFontWeight;
  ...
  // Get font attributes
  fontSize = [ABI19_0_0RCTConvert CGFloat:size] ?: fontSize;
  if (scaleMultiplier > 0.0 && scaleMultiplier != 1.0) {
    fontSize = round(fontSize * scaleMultiplier);
  }
  familyName = [ABI19_0_0RCTConvert NSString:family] ?: familyName;
  isItalic = style ? [ABI19_0_0RCTConvert ABI19_0_0RCTFontStyle:style] : isItalic;
  fontWeight = weight ? [ABI19_0_0RCTConvert ABI19_0_0RCTFontWeight:weight] : fontWeight;
  ...
  if (!didFindFont && [UIFont fontNamesForFamilyName:familyName].count == 0) {
    ...
    if (font) {
      ...
      ABI19_0_0RCTLogError(@"Unrecognized font family '%@'", familyName);
      if ([UIFont respondsToSelector:@selector(systemFontOfSize:weight:)]) {
  ...
  if (variant) {
    NSArray *fontFeatures = [ABI19_0_0RCTConvert ABI19_0_0RCTFontVariantDescriptorArray:variant];
