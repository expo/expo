...
@implementation ABI19_0_0RCTConvert (UITabBarSystemItem)

ABI19_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI19_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI19_0_0ViewController;
}
