...
@interface ABI19_0_0RCTTabBar() <UITabBarControllerDelegate>

@end

@implementation ABI19_0_0RCTTabBar
{
  BOOL _tabsChanged;
...
- (void)insertReactABI19_0_0Subview:(ABI19_0_0RCTTabBarItem *)subview atIndex:(NSInteger)atIndex
{
  if (![subview isKindOfClass:[ABI19_0_0RCTTabBarItem class]]) {
    ABI19_0_0RCTLogError(@"subview should be of type ABI19_0_0RCTTabBarItem");
    return;
  }
...
- (void)removeReactABI19_0_0Subview:(ABI19_0_0RCTTabBarItem *)subview
{
  if (self.ReactABI19_0_0Subviews.count == 0) {
    ABI19_0_0RCTLogError(@"should have at least one view to remove a subview");
    return;
  }
...
- (void)layoutSubviews
{
  ...
  [self ReactABI19_0_0AddControllerToClosestParent:_tabController];
...
- (void)ReactABI19_0_0BridgeDidFinishTransaction
{
  ...
  if (_tabsChanged) {
    ...
    for (ABI19_0_0RCTTabBarItem *tab in [self ReactABI19_0_0Subviews]) {
      UIViewController *controller = tab.ReactABI19_0_0ViewController;
      if (!controller) {
        controller = [[ABI19_0_0RCTWrapperViewController alloc] initWithContentView:tab];
      }
  ...
  [self.ReactABI19_0_0Subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger index, __unused BOOL *stop) {

    ABI19_0_0RCTTabBarItem *tab = (ABI19_0_0RCTTabBarItem *)view;
...
- (BOOL)tabBarController:(UITabBarController *)tabBarController shouldSelectViewController:(UIViewController *)viewController
{
  ...
  ABI19_0_0RCTTabBarItem *tab = (ABI19_0_0RCTTabBarItem *)self.ReactABI19_0_0Subviews[index];
