...
#import <ReactABI19_0_0/ABI19_0_0RCTModalHostViewManager.h>
#import <ReactABI19_0_0/ABI19_0_0RCTView.h>

@class ABI19_0_0RCTBridge;
@class ABI19_0_0RCTModalHostViewController;

@protocol ABI19_0_0RCTModalHostViewInteractor;

@interface ABI19_0_0RCTModalHostView : UIView <ABI19_0_0RCTInvalidating>

@property (nonatomic, copy) NSString *animationType;
@property (nonatomic, assign, getter=isTransparent) BOOL transparent;

@property (nonatomic, copy) ABI19_0_0RCTDirectEventBlock onShow;

@property (nonatomic, weak) id<ABI19_0_0RCTModalHostViewInteractor> delegate;

@property (nonatomic, copy) NSArray<NSString *> *supportedOrientations;
@property (nonatomic, copy) ABI19_0_0RCTDirectEventBlock onOrientationChange;

- (instancetype)initWithBridge:(ABI19_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;

@end

@protocol ABI19_0_0RCTModalHostViewInteractor <NSObject>
