...
/**
 * An abstraction for a key-value store to manage ABI19_0_0RCTDevSettings behavior.
 * The default implementation persists settings using NSUserDefaults.
 */
@protocol ABI19_0_0RCTDevSettingsDataSource <NSObject>
...
@interface ABI19_0_0RCTDevSettings : NSObject
...
/*
 * Whether shaking will show ABI19_0_0RCTDevMenu. The menu is enabled by default if ABI19_0_0RCT_DEV=1, but
...
@interface ABI19_0_0RCTBridge (ABI19_0_0RCTDevSettings)

@property (nonatomic, readonly) ABI19_0_0RCTDevSettings *devSettings;
