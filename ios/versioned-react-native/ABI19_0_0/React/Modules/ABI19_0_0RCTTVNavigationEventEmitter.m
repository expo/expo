...
#import "ABI19_0_0RCTTVNavigationEventEmitter.h"

NSString *const ABI19_0_0RCTTVNavigationEventNotification = @"ABI19_0_0RCTTVNavigationEventNotification";

static NSString *const TVNavigationEventName = @"onTVNavEvent";

@implementation ABI19_0_0RCTTVNavigationEventEmitter
  ...
  if (self = [super init]) {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(handleTVNavigationEventNotification:)
                                                 name:ABI19_0_0RCTTVNavigationEventNotification
                                               object:nil];
