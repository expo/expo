...
@protocol ABI19_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI19_0_0RCTExceptionsManager : NSObject <ABI19_0_0RCTBridgeModule>

- (instancetype)initWithDelegate:(id<ABI19_0_0RCTExceptionsManagerDelegate>)delegate;

@property (nonatomic, weak) id<ABI19_0_0RCTExceptionsManagerDelegate> delegate;
