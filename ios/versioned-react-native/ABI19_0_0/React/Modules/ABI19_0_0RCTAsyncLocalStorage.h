 ...
 */
@interface ABI19_0_0RCTAsyncLocalStorage : NSObject <ABI19_0_0RCTBridgeModule,ABI19_0_0RCTInvalidating>
...
// Clear the ABI19_0_0RCTAsyncLocalStorage data from native code
- (void)clearAllData;
