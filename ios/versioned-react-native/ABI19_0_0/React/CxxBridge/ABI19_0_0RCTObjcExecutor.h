...
class ABI19_0_0RCTObjcExecutorFactory : public JSExecutorFactory {
public:
  ABI19_0_0RCTObjcExecutorFactory(id<ABI19_0_0RCTJavaScriptExecutor> jse, ABI19_0_0RCTJavaScriptCompleteBlock errorBlock);
