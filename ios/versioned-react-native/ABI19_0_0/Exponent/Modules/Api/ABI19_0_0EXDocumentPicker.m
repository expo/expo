...
#import "ABI19_0_0EXDocumentPicker.h"

#import <MobileCoreServices/MobileCoreServices.h>
#import <UIKit/UIKit.h>
#import <ReactABI19_0_0/ABI19_0_0RCTUtils.h>

static NSString * ABI19_0_0EXConvertMimeTypeToUTI(NSString *mimeType)
{
  CFStringRef uti;
...
@interface ABI19_0_0EXDocumentPicker () <UIDocumentMenuDelegate, UIDocumentPickerDelegate>
...
@implementation ABI19_0_0EXDocumentPicker

ABI19_0_0RCT_EXPORT_MODULE(ExponentDocumentPicker)

ABI19_0_0RCT_EXPORT_METHOD(getDocumentAsync:(NSDictionary *)options resolver:(ABI19_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI19_0_0RCTPromiseRejectBlock)reject) {
  _resolve = resolve;
  _reject = reject;

  NSString *type = ABI19_0_0EXConvertMimeTypeToUTI(options[@"type"] ?: @"*/*");
  ...
  [ABI19_0_0RCTPresentedViewController() presentViewController:documentMenuVC animated:YES completion:nil];
}

- (void)documentMenu:(UIDocumentMenuViewController *)documentMenu didPickDocumentPicker:(UIDocumentPickerViewController *)documentPicker
{
  documentPicker.delegate = self;
  [ABI19_0_0RCTPresentedViewController() presentViewController:documentPicker animated:YES completion:nil];
}
