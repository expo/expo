...
ABI19_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI19_0_0EXConstants, constants)

@import UIKit.UIApplication;

@interface ABI19_0_0EXConstants ()
...
@implementation ABI19_0_0EXConstants

ABI19_0_0EX_EXPORT_SCOPED_MODULE(ExponentConstants, nil)
...
{
  NSString *expoClientVersion = [[[NSBundle mainBundle] infoDictionary] objectForKey:@"ABI19_0_0EXClientVersion"];
...
ABI19_0_0RCT_REMAP_METHOD(getWebViewUserAgentAsync,
                 getWebViewUserAgentWithResolver:(ABI19_0_0RCTPromiseResolveBlock)resolve
