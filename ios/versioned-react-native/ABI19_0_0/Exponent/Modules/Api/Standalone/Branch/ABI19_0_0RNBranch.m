...
#import "ABI19_0_0RNBranch.h"
#import "ABI19_0_0BranchLinkProperties+RNBranch.h"
#import "ABI19_0_0BranchUniversalObject+RNBranch.h"
#import "ABI19_0_0RNBranchAgingDictionary.h"
#import "ABI19_0_0RNBranchEventEmitter.h"

#import "ABI19_0_0EXConstants.h"

NSString * const ABI19_0_0RNBranchLinkOpenedNotification = @"ABI19_0_0RNBranchLinkOpenedNotification";
NSString * const ABI19_0_0RNBranchLinkOpenedNotificationErrorKey = @"error";
NSString * const ABI19_0_0RNBranchLinkOpenedNotificationParamsKey = @"params";
NSString * const ABI19_0_0RNBranchLinkOpenedNotificationUriKey = @"uri";
NSString * const ABI19_0_0RNBranchLinkOpenedNotificationBranchUniversalObjectKey = @"branch_universal_object";
NSString * const ABI19_0_0RNBranchLinkOpenedNotificationLinkPropertiesKey = @"link_properties";
...
static NSString * const ABI19_0_0RNBranchErrorDomain = @"ABI19_0_0RNBranchErrorDomain";
static NSInteger const ABI19_0_0RNBranchUniversalObjectNotFoundError = 1;

#pragma mark - Private ABI19_0_0RNBranch declarations

@interface ABI19_0_0RNBranch()
@property (nonatomic, readonly) UIViewController *currentViewController;
@property (nonatomic) ABI19_0_0RNBranchAgingDictionary<NSString *, BranchUniversalObject *> *universalObjectMap;
@end

#pragma mark - ABI19_0_0RNBranch implementation

@implementation ABI19_0_0RNBranch
...
- (NSDictionary<NSString *, NSString *> *)constantsToExport {
    return @{
             // ABI19_0_0RN events transmitted to JS by event emitter
             @"INIT_SESSION_SUCCESS": ABI19_0_0RNBranchInitSessionSuccess,
             @"INIT_SESSION_ERROR": ABI19_0_0RNBranchInitSessionError,
...
//Called by AppDelegate.m -- stores initSession result in static variables and raises initSessionFinished event that's captured by the ABI19_0_0RNBranch instance to emit it to ReactABI19_0_0 Native
+ (void)initSessionWithLaunchOptions:(NSDictionary *)launchOptions isReferrable:(BOOL)isReferrable {
    ...
    [branchInstance initSessionWithLaunchOptions:launchOptions isReferrable:isReferrable andRegisterDeepLinkHandler:^(NSDictionary *params, NSError *error) {
        ...
        if (error) result[ABI19_0_0RNBranchLinkOpenedNotificationErrorKey] = error;
        if (params) {
            result[ABI19_0_0RNBranchLinkOpenedNotificationParamsKey] = params;

            if (params[@"~id"]) {
                BranchUniversalObject *branchUniversalObject = [BranchUniversalObject getBranchUniversalObjectFromDictionary:params];
                if (branchUniversalObject) result[ABI19_0_0RNBranchLinkOpenedNotificationBranchUniversalObjectKey] = branchUniversalObject;

                BranchLinkProperties *linkProperties = [BranchLinkProperties getBranchLinkPropertiesFromDictionary:params];
                if (linkProperties) result[ABI19_0_0RNBranchLinkOpenedNotificationLinkPropertiesKey] = linkProperties;
            }
        }
        if (sourceUrl) result[ABI19_0_0RNBranchLinkOpenedNotificationUriKey] = sourceUrl;

        [[NSNotificationCenter defaultCenter] postNotificationName:ABI19_0_0RNBranchLinkOpenedNotification object:nil userInfo:result];
    }];
}
...
- (void) onInitSessionFinished:(NSNotification*) notification {
    NSURL *uri = notification.userInfo[ABI19_0_0RNBranchLinkOpenedNotificationUriKey];
    NSError *error = notification.userInfo[ABI19_0_0RNBranchLinkOpenedNotificationErrorKey];
    NSDictionary *params = notification.userInfo[ABI19_0_0RNBranchLinkOpenedNotificationParamsKey];

    initSessionWithLaunchOptionsResult = @{
                                         ABI19_0_0RNBranchLinkOpenedNotificationErrorKey: error.localizedDescription ?: NSNull.null,
                                         ABI19_0_0RNBranchLinkOpenedNotificationParamsKey: params[@"~id"] ? params : NSNull.null,
                                         ABI19_0_0RNBranchLinkOpenedNotificationUriKey: uri.absoluteString ?: NSNull.null
                                         };

    // If there is an error, fire error event
    if (error) {
        [ABI19_0_0RNBranchEventEmitter initSessionDidEncounterErrorWithPayload:initSessionWithLaunchOptionsResult];
    }

    // otherwise notify the session is finished
    else {
        [ABI19_0_0RNBranchEventEmitter initSessionDidSucceedWithPayload:initSessionWithLaunchOptionsResult];
    }
}
...
- (BranchUniversalObject *)findUniversalObjectWithIdent:(NSString *)ident rejecter:(ABI19_0_0RCTPromiseRejectBlock)reject
{
    ...
    if (!universalObject) {
        ...
        NSError *error = [NSError errorWithDomain:ABI19_0_0RNBranchErrorDomain
                                             code:ABI19_0_0RNBranchUniversalObjectNotFoundError
...
#pragma mark - Methods exported to ReactABI19_0_0 Native

#pragma mark redeemInitSessionResult
ABI19_0_0RCT_EXPORT_METHOD(
                  redeemInitSessionResult:(ABI19_0_0RCTPromiseResolveBlock)resolve
...
ABI19_0_0RCT_EXPORT_METHOD(
                  getLatestReferringParams:(ABI19_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI19_0_0RCTPromiseRejectBlock)reject
                  ) {
...
ABI19_0_0RCT_EXPORT_METHOD(
                  getFirstReferringParams:(ABI19_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI19_0_0RCTPromiseRejectBlock)reject
                  ) {
...
ABI19_0_0RCT_EXPORT_METHOD(
    ...
    [branchUniversalObject getShortUrlWithLinkProperties:linkProperties andCallback:^(NSString *url, NSError *error) {
        if (!error) {
            ABI19_0_0RCTLogInfo(@"ABI19_0_0RNBranch Success");
            resolve(@{ @"url": url });
        } else {
            reject([NSString stringWithFormat: @"%lu", (long)error.code], error.localizedDescription, error);
        }
...
ABI19_0_0RCT_EXPORT_METHOD(
    ...
    [branchInstance getShortURLWithParams:linkPropertiesMap
                              ...
                              andCallback:^(NSString *url, NSError *error) {
                                  if (error) {
                                      ABI19_0_0RCTLogError(@"ABI19_0_0RNBranch::Error: %@", error.localizedDescription);
                                      reject(@"ABI19_0_0RNBranch::Error", @"getShortURLWithParams", error);
                                  }
                                  resolve(url);
                              }];
}
...
ABI19_0_0RCT_EXPORT_METHOD(
                  loadRewards:(ABI19_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI19_0_0RCTPromiseRejectBlock)reject
                  ) {
    [branchInstance loadRewardsWithCallback:^(BOOL changed, NSError *error) {
        if(!error) {
            ...
            ABI19_0_0RCTLogError(@"Load Rewards Error: %@", error.localizedDescription);
            reject(@"ABI19_0_0RNBranch::Error::loadRewardsWithCallback", @"loadRewardsWithCallback", error);
        }
    }];
}
    ...
    if (bucket) {
        [branchInstance redeemRewards:amount forBucket:bucket callback:^(BOOL changed, NSError *error) {
            if (!error) {
                ...
                ABI19_0_0RCTLogError(@"Redeem Rewards Error: %@", error.localizedDescription);
                reject(@"ABI19_0_0RNBranch::Error::redeemRewards", error.localizedDescription, error);
            }
        }];
    } else {
...
ABI19_0_0RCT_EXPORT_METHOD(
                  getCreditHistory:(ABI19_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI19_0_0RCTPromiseRejectBlock)reject
                  ) {
    [branchInstance getCreditHistoryWithCallback:^(NSArray *list, NSError *error) {
        if (!error) {
            ...
            ABI19_0_0RCTLogError(@"Credit History Error: %@", error.localizedDescription);
            reject(@"ABI19_0_0RNBranch::Error::getCreditHistory", error.localizedDescription, error);
        }
    }];
}
