...
#import "ABI19_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI19_0_0EXFingerprint

ABI19_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI19_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI19_0_0RCTPromiseResolveBlock)resolve
...
ABI19_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI19_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI19_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI19_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
