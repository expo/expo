...
ABI19_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI19_0_0EXFileSystem, fileSystem)

@implementation NSData (ABI19_0_0EXFileSystem)
...
@implementation ABI19_0_0EXFileSystem

ABI19_0_0EX_EXPORT_SCOPED_MODULE(ExponentFileSystem, nil);
...
- (instancetype)initWithExperienceId:(NSString *)experienceId kernelServiceDelegate:(id)kernelServiceInstance params:(NSDictionary *)params
{
  if (self = [super initWithExperienceId:experienceId kernelServiceDelegate:kernelServiceInstance params:params]) {
    ...
    [ABI19_0_0EXFileSystem ensureDirExistsWithPath:_documentDirectory];
    [ABI19_0_0EXFileSystem ensureDirExistsWithPath:_cachesDirectory];
  }
  return self;
}
...
ABI19_0_0RCT_REMAP_METHOD(getInfoAsync,
...
ABI19_0_0RCT_REMAP_METHOD(readAsStringAsync,
...
ABI19_0_0RCT_REMAP_METHOD(writeAsStringAsync,
...
ABI19_0_0RCT_REMAP_METHOD(deleteAsync,
...
ABI19_0_0RCT_REMAP_METHOD(moveAsync,
...
ABI19_0_0RCT_REMAP_METHOD(copyAsync,
...
ABI19_0_0RCT_REMAP_METHOD(makeDirectoryAsync,
...
ABI19_0_0RCT_REMAP_METHOD(readDirectoryAsync,
...
ABI19_0_0RCT_REMAP_METHOD(downloadAsync,
...
{
  NSString *subdir = [ABI19_0_0EXUtil escapedResourceName:experienceId];
