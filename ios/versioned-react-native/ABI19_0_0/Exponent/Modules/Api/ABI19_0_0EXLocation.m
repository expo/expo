...
NSString * const ABI19_0_0EXLocationChangedEventName = @"Exponent.locationChanged";
NSString * const ABI19_0_0EXHeadingChangedEventName = @"Exponent.headingChanged";

@interface ABI19_0_0EXLocationDelegate : NSObject <CLLocationManagerDelegate>
...
@implementation ABI19_0_0EXLocationDelegate
...
@interface ABI19_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI19_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) CLGeocoder *geocoder;
@property (nonatomic, assign, getter=isPaused) BOOL paused;

@end

@implementation ABI19_0_0EXLocation

ABI19_0_0RCT_EXPORT_MODULE(ExponentLocation)
...
{
  return @[ABI19_0_0EXLocationChangedEventName, ABI19_0_0EXHeadingChangedEventName];
}

ABI19_0_0RCT_REMAP_METHOD(getProviderStatusAsync,
...
ABI19_0_0RCT_REMAP_METHOD(getCurrentPositionAsync,
...
ABI19_0_0RCT_REMAP_METHOD(watchPositionImplAsync,
                 ...
                 rejecter:(ABI19_0_0RCTPromiseRejectBlock)reject)
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    locMgr.distanceFilter = options[@"distanceInterval"] ? [ABI19_0_0RCTConvert double:options[@"distanceInterval"]] ?: kCLDistanceFilterNone : kCLLocationAccuracyHundredMeters;
    locMgr.desiredAccuracy = [ABI19_0_0RCTConvert BOOL:options[@"enableHighAccuracy"]] ? kCLLocationAccuracyBest : kCLLocationAccuracyHundredMeters;
    
    ABI19_0_0EXLocationDelegate *delegate = [[ABI19_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
      if (locations.lastObject) {
        ...
        [weakSelf sendEventWithName:ABI19_0_0EXLocationChangedEventName body:body];
      }
...
ABI19_0_0RCT_REMAP_METHOD(watchDeviceHeading,
                 watchId:(nonnull NSNumber *)watchId
                 watchDeviceHeading_resolver:(ABI19_0_0RCTPromiseResolveBlock)resolve
                 watchDeviceHeading_rejecter:(ABI19_0_0RCTPromiseRejectBlock)reject) {
  __weak typeof(self) weakSelf = self;
  dispatch_async(dispatch_get_main_queue(), ^{
    CLLocationManager *locMgr = [[CLLocationManager alloc] init];
    locMgr.distanceFilter = kCLDistanceFilterNone;
    locMgr.desiredAccuracy = kCLLocationAccuracyBest;
    ABI19_0_0EXLocationDelegate *delegate = [[ABI19_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
      if (newHeading) {
        NSNumber *accuracy;
        ...
        [weakSelf sendEventWithName:ABI19_0_0EXHeadingChangedEventName body:body];
      }
...
ABI19_0_0RCT_REMAP_METHOD(removeWatchAsync,
                 watchId:(nonnull NSNumber *)watchId
                 resolver:(ABI19_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI19_0_0RCTPromiseRejectBlock)reject)
{
  ABI19_0_0EXLocationDelegate *delegate = _delegates[watchId];
  if (delegate) {
    __weak typeof(self) weakSelf = self;
    dispatch_async(dispatch_get_main_queue(), ^{
...
ABI19_0_0RCT_REMAP_METHOD(geocodeAsync,
...
ABI19_0_0RCT_REMAP_METHOD(reverseGeocodeAsync,
