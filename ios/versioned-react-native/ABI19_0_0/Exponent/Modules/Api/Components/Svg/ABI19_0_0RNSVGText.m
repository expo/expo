...
@implementation ABI19_0_0RNSVGText
{
    ABI19_0_0RNSVGText *_textRoot;
    ABI19_0_0RNSVGGlyphContext *_glyphContext;
}

- (void)setTextAnchor:(ABI19_0_0RNSVGTextAnchor)textAnchor
{
    [self invalidate];
...
{
    _glyphContext = [[ABI19_0_0RNSVGGlyphContext alloc] initWithDimensions:[self getContextWidth]
                                                  height:[self getContextHeight]];
}

// release the cached CGPathRef for ABI19_0_0RNSVGTSpan
- (void)releaseCachedPath
{
    [self traverseSubviews:^BOOL(__kindof ABI19_0_0RNSVGNode *node) {
        ABI19_0_0RNSVGText *text = node;
...
- (ABI19_0_0RNSVGTextAnchor)getComputedTextAnchor
{
    ABI19_0_0RNSVGTextAnchor anchor = self.textAnchor;
    if (self.subviews.count > 0) {
        ABI19_0_0RNSVGText *child = [self.subviews firstObject];
...
- (ABI19_0_0RNSVGText *)getTextRoot
{
    if (!_textRoot) {
        _textRoot = self;
        while (_textRoot && [_textRoot class] != [ABI19_0_0RNSVGText class]) {
            if (![_textRoot isKindOfClass:[ABI19_0_0RNSVGText class]]) {
                //todo: throw exception here
                break;
            }
            _textRoot = (ABI19_0_0RNSVGText*)[_textRoot superview];
        }
    }
