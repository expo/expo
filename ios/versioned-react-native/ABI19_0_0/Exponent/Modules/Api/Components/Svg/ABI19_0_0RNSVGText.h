...
#import "ABI19_0_0RNSVGGlyphContext.h"

@interface ABI19_0_0RNSVGText : ABI19_0_0RNSVGGroup

@property (nonatomic, assign) ABI19_0_0RNSVGTextAnchor textAnchor;
...
- (ABI19_0_0RNSVGText *)getTextRoot;
- (void)releaseCachedPath;
- (CGPathRef)getGroupPath:(CGContextRef)context;

- (ABI19_0_0RNSVGGlyphContext *)getGlyphContext;
