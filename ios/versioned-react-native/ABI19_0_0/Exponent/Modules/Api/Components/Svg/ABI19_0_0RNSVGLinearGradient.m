...
#import "ABI19_0_0RNSVGBrushType.h"

@implementation ABI19_0_0RNSVGLinearGradient
...
- (void)parseReference
{
    ...
    ABI19_0_0RNSVGPainter *painter = [[ABI19_0_0RNSVGPainter alloc] initWithPointsArray:points];
