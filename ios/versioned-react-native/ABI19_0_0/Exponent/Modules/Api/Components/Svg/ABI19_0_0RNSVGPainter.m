...
@implementation ABI19_0_0RNSVGPainter
{
    NSArray<NSString *> *_points;
    NSArray<NSNumber *> *_colors;
    ABI19_0_0RNSVGBrushType _type;
...
- (void)setUnits:(ABI19_0_0RNSVGUnits)unit
{
...
- (void)paintLinearGradient:(CGContextRef)context
{
    ...
    CGGradientRef gradient = CGGradientRetain([ABI19_0_0RCTConvert ABI19_0_0RNSVGCGGradient:_colors offset:0]);
    ...
    CGFloat x1 = [ABI19_0_0RNSVGPercentageConverter stringToFloat:(NSString *)[_points objectAtIndex:0]
                                                relative:width
                                                  offset:offsetX];
    CGFloat y1 = [ABI19_0_0RNSVGPercentageConverter stringToFloat:(NSString *)[_points objectAtIndex:1]
                                                relative:height
                                                  offset:offsetY];
    CGFloat x2 = [ABI19_0_0RNSVGPercentageConverter stringToFloat:(NSString *)[_points objectAtIndex:2]
                                                relative:width
                                                  offset:offsetX];
    CGFloat y2 = [ABI19_0_0RNSVGPercentageConverter stringToFloat:(NSString *)[_points objectAtIndex:3]
                                                relative:height
                                                  offset:offsetY];
...
- (void)paintRidialGradient:(CGContextRef)context
{
    ...
    CGFloat rx = [ABI19_0_0RNSVGPercentageConverter stringToFloat:(NSString *)[_points objectAtIndex:2]
                                                relative:width
                                                  offset:0];
    CGFloat ry = [ABI19_0_0RNSVGPercentageConverter stringToFloat:(NSString *)[_points objectAtIndex:3]
                                                relative:height
                                                  offset:0];
    CGFloat fx = [ABI19_0_0RNSVGPercentageConverter stringToFloat:(NSString *)[_points objectAtIndex:0]
                                                relative:width
                                                  offset:offsetX];
    CGFloat fy = [ABI19_0_0RNSVGPercentageConverter stringToFloat:(NSString *)[_points objectAtIndex:1]
                                                relative:height
                                                  offset:offsetY] / (ry / rx);
    CGFloat cx = [ABI19_0_0RNSVGPercentageConverter stringToFloat:(NSString *)[_points objectAtIndex:4]
                                                relative:width
                                                  offset:offsetX];
    CGFloat cy = [ABI19_0_0RNSVGPercentageConverter stringToFloat:(NSString *)[_points objectAtIndex:5]
                                                relative:height
                                                  offset:offsetY] / (ry / rx);
