//
//  ABI19_0_0AIRGoogleMapPolygon.m
//
...
@implementation ABI19_0_0AIRGoogleMapPolygon

- (instancetype)init
{
  if (self = [super init]) {
    _polygon = [[ABI19_0_0AIRGMSPolygon alloc] init];
  }

  return self;
}

- (void)setCoordinates:(NSArray<ABI19_0_0AIRMapCoordinate *> *)coordinates
{
...
- (void)setHoles:(NSArray<NSArray<ABI19_0_0AIRMapCoordinate *> *> *)holes
{
  _holes = holes;
