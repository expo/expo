...
@interface ABI19_0_0EXNativeAdView ()

@end

@implementation ABI19_0_0EXNativeAdView
...
- (void)setNativeAd:(FBNativeAd *)nativeAd
{
  ...
  [_nativeAd registerViewForInteraction:self withViewController:ABI19_0_0RCTKeyWindow().rootViewController];
}
