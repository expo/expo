#import "ABI19_0_0EXImagePicker.h"
...
@interface ABI19_0_0EXImagePicker ()
...
@implementation ABI19_0_0EXImagePicker

ABI19_0_0RCT_EXPORT_MODULE(ExponentImagePicker);
...
ABI19_0_0RCT_EXPORT_METHOD(launchCameraAsync:(NSDictionary *)options
                  resolver:(ABI19_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI19_0_0RCTPromiseRejectBlock)reject)
{
  self.resolve = resolve;
  self.reject = reject;
  [self launchImagePicker:ABI19_0_0RNImagePickerTargetCamera options:options];
}

ABI19_0_0RCT_EXPORT_METHOD(launchImageLibraryAsync:(NSDictionary *)options
                  resolver:(ABI19_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI19_0_0RCTPromiseRejectBlock)reject)
{
  self.resolve = resolve;
  self.reject = reject;
  [self launchImagePicker:ABI19_0_0RNImagePickerTargetLibrarySingleImage options:options];
}

- (void)launchImagePicker:(ABI19_0_0RNImagePickerTarget)target options:(NSDictionary *)options
{
...
- (void)launchImagePicker:(ABI19_0_0RNImagePickerTarget)target
{
  self.picker = [[UIImagePickerController alloc] init];

  if (target == ABI19_0_0RNImagePickerTargetCamera) {
#if TARGET_IPHONE_SIMULATOR
    self.reject(ABI19_0_0RCTErrorUnspecified, @"Camera not available on simulator", nil);
    return;
#else
...
#endif
  } else { // ABI19_0_0RNImagePickerTargetLibrarySingleImage
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
  dispatch_block_t dismissCompletionBlock = ^{
    ...
    ABI19_0_0RCTAssert([mediaType isEqualToString:(NSString *)kUTTypeImage], @"Expected image response from `UIImagePickerController`");
    ...
    [ABI19_0_0EXFileSystem ensureDirExistsWithPath:directory];
