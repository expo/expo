...
// Read-only access to legacy (unscoped) `ABI19_0_0RCTAsyncLocalStorage` backing for
 ...
 * being atomic, unless someone bypasses the `ABI19_0_0RCTAsyncLocalStorage` API.
 *
 * Keys and values must always be strings or an error is returned.
 */
@interface ABI19_0_0EXLegacyAsyncLocalStorage : NSObject <ABI19_0_0RCTBridgeModule,ABI19_0_0RCTInvalidating>
