...
@interface ABI19_0_0EXAppState ()

@property (nonatomic, assign) BOOL isObserving;

@end

@implementation ABI19_0_0EXAppState

+ (NSString *)moduleName { return @"ABI19_0_0RCTAppState"; }
...
ABI19_0_0RCT_EXPORT_METHOD(getCurrentAppState:(ABI19_0_0RCTResponseSenderBlock)callback
