...
@interface ABI19_0_0EXKernelModule ()
...
@property (nonatomic, weak) id<ABI19_0_0EXKernelModuleDelegate> delegate;


@end

@implementation ABI19_0_0EXKernelModule
...
- (void)sendEventWithName:(NSString *)eventName body:(id)body
{
  ...
  [self.bridge enqueueJSCall:@"ABI19_0_0RCTDeviceEventEmitter.emit"
...
ABI19_0_0RCT_REMAP_METHOD(doesCurrentTaskEnableDevtools,
                 doesCurrentTaskEnableDevtoolsWithResolver:(ABI19_0_0RCTPromiseResolveBlock)resolve
...
ABI19_0_0RCT_REMAP_METHOD(shouldCurrentTaskAutoReload,
                 shouldCurrentTaskAutoReloadWithResolver:(ABI19_0_0RCTPromiseResolveBlock)resolve
                 reject:(ABI19_0_0RCTPromiseRejectBlock)reject)
{
  if (_delegate) {
...
ABI19_0_0RCT_REMAP_METHOD(isLegacyMenuBehaviorEnabledAsync,
                 isLegacyMenuBehaviorEnabledWithResolver:(ABI19_0_0RCTPromiseResolveBlock)resolve
...
ABI19_0_0RCT_EXPORT_METHOD(setIsLegacyMenuBehaviorEnabledAsync:(BOOL)isEnabled)
{
  if (_delegate) {
...
ABI19_0_0RCT_REMAP_METHOD(getDevMenuItemsToShow,
                 getDevMenuItemsToShowWithResolver:(ABI19_0_0RCTPromiseResolveBlock)resolve
                 reject:(ABI19_0_0RCTPromiseRejectBlock)reject)
{
...
ABI19_0_0RCT_EXPORT_METHOD(selectDevMenuItemWithKey:(NSString *)key)
{
  if (_delegate) {
...
ABI19_0_0RCT_EXPORT_METHOD(addDevMenu)
{
...
ABI19_0_0RCT_REMAP_METHOD(routeDidForeground,
...
ABI19_0_0RCT_REMAP_METHOD(onEventSuccess,
...
ABI19_0_0RCT_REMAP_METHOD(onEventFailure,
                 eventId:(NSString *)eventId
