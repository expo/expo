...
#if !TARGET_OS_TV
@implementation ABI19_0_0RCTConvert (ABI19_0_0EXStatusBar)
...
@interface ABI19_0_0EXStatusBarManager ()

@property (nonatomic, strong) NSMutableDictionary *capturedStatusBarProperties;

@end

@implementation ABI19_0_0EXStatusBarManager

+ (NSString *)moduleName { return @"ABI19_0_0RCTStatusBarManager"; }
 ...
 */
ABI19_0_0RCT_REMAP_METHOD(_captureProperties,
                 _capturePropertiesWithResolver:(ABI19_0_0RCTPromiseResolveBlock)resolve
 ...
 *  Normally nobody should use this method because it bypasses the JS state used by the StatusBar component.
 */
ABI19_0_0RCT_EXPORT_METHOD(_applyPropertiesAndForget:(NSDictionary *)properties)
{
...
{
  UIApplication *currentApplication = ABI19_0_0RCTSharedApplication();
  return @{
