...
#import "ABI19_0_0ARTRenderable.h"

@implementation ABI19_0_0ARTRenderable

- (void)setFill:(ABI19_0_0ARTBrush *)fill
{
  [self invalidate];
  _fill = fill;
}
...
- (void)setStrokeDash:(ABI19_0_0ARTCGFloatArray)strokeDash
{
