...
@implementation ABI19_0_0ARTText
...
static void ABI19_0_0ARTFreeTextFrame(ABI19_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI19_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI19_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI19_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI19_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
