...
@interface ABI19_0_0ARTRenderable : ABI19_0_0ARTNode

@property (nonatomic, strong) ABI19_0_0ARTBrush *fill;
...
@property (nonatomic, assign) ABI19_0_0ARTCGFloatArray strokeDash;
