...
#import "ABI19_0_0ARTRadialGradient.h"
#import "ABI19_0_0ARTSolidColor.h"

@implementation ABI19_0_0RCTConvert (ABI19_0_0ART)
...
#define NEXT_VALUE [self double:arr[i++]]
    ...
    while (i < count) {
      ...
      switch (type) {
        ...
        case 4:
          ...
          break;
        default:
          ABI19_0_0RCTLogError(@"Invalid CGPath type %zd at element %zd of %@", type, i, arr);
          CGPathRelease(path);
          return NULL;
      }
    }
  ...
  @catch (NSException *exception) {
    ABI19_0_0RCTLogError(@"Invalid CGPath format: %@", arr);
    CGPathRelease(path);
    return NULL;
  }
...
ABI19_0_0RCT_ENUM_CONVERTER(CTTextAlignment, (@{
...
// This prepares everything for rendering a frame of text in ABI19_0_0ARTText.
+ (ABI19_0_0ARTTextFrame)ABI19_0_0ARTTextFrame:(id)json
{
  NSDictionary *dict = [self NSDictionary:json];
  ABI19_0_0ARTTextFrame frame;
  frame.count = 0;
  ...
  frame.lineHeight = size * 1.1; // Base on ABI19_0_0ART canvas line height estimate
...
+ (ABI19_0_0ARTCGFloatArray)ABI19_0_0ARTCGFloatArray:(id)json
{
  ...
  ABI19_0_0ARTCGFloatArray array;
  array.count = count;
  array.array = NULL;
...
+ (ABI19_0_0ARTBrush *)ABI19_0_0ARTBrush:(id)json
{
  ...
  switch (type) {
    case 0: // solid color
      ...
      return [[ABI19_0_0ARTSolidColor alloc] initWithArray:arr];
    case 1: // linear gradient
      return [[ABI19_0_0ARTLinearGradient alloc] initWithArray:arr];
    case 2: // radial gradient
      return [[ABI19_0_0ARTRadialGradient alloc] initWithArray:arr];
    case 3: // pattern
      return [[ABI19_0_0ARTPattern alloc] initWithArray:arr];
    default:
...
+ (CGPoint)CGPoint:(id)json offset:(NSUInteger)offset
{
  ...
  if (arr.count < offset + 2) {
    ABI19_0_0RCTLogError(@"Too few elements in array (expected at least %zd): %@", 2 + offset, arr);
    return CGPointZero;
  }
  return (CGPoint){
...
+ (CGGradientRef)CGGradient:(id)json offset:(NSUInteger)offset
{
  ...
  ABI19_0_0ARTCGFloatArray colorsAndOffsets = [self ABI19_0_0ARTCGFloatArray:arr];
