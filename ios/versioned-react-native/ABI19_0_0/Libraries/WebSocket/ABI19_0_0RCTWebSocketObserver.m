...
#import "ABI19_0_0RCTWebSocketObserver.h"
...
#import "ABI19_0_0RCTReconnectingWebSocket.h"

#if ABI19_0_0RCT_DEV // Only supported in dev mode

@interface ABI19_0_0RCTWebSocketObserver () <ABI19_0_0RCTWebSocketProtocolDelegate>
@end

@implementation ABI19_0_0RCTWebSocketObserver {
...
{
  if (self = [super init]) {
    _socket = [[ABI19_0_0RCTReconnectingWebSocket alloc] initWithURL:url];
...
- (void)webSocket:(ABI19_0_0RCTSRWebSocket *)webSocket didReceiveMessage:(id)message
{
  if (_delegate) {
    ...
    if (!error) {
      ...
      ABI19_0_0RCTLogError(@"WebSocketManager failed to parse message with error %@\n<message>\n%@\n</message>", error, message);
    }
  }
}
