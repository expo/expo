...
@interface ABI19_0_0RCTReconnectingWebSocket () <ABI19_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI19_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  __weak ABI19_0_0RCTSRWebSocket *socket = _socket;
