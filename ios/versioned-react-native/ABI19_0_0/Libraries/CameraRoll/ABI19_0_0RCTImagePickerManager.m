...
#import "ABI19_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI19_0_0/ABI19_0_0RCTConvert.h>
#import <ReactABI19_0_0/ABI19_0_0RCTImageStoreManager.h>
#import <ReactABI19_0_0/ABI19_0_0RCTRootView.h>
#import <ReactABI19_0_0/ABI19_0_0RCTUtils.h>

@interface ABI19_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI19_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI19_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI19_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI19_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI19_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI19_0_0RCTResponseSenderBlock)callback)
{
...
ABI19_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI19_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI19_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI19_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI19_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI19_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI19_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI19_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI19_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI19_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI19_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI19_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI19_0_0RCTNullIfNil(height), ABI19_0_0RCTNullIfNil(width)]];
    return;
  }
        ...
        cancelCallback:(ABI19_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI19_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI19_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI19_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
