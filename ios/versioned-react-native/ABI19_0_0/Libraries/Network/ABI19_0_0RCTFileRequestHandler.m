...
#import "ABI19_0_0RCTFileRequestHandler.h"

#import <MobileCoreServices/MobileCoreServices.h>

#import <ReactABI19_0_0/ABI19_0_0RCTUtils.h>

@implementation ABI19_0_0RCTFileRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  && !ABI19_0_0RCTIsLocalAssetURL(request.URL);
}

- (NSOperation *)sendRequest:(NSURLRequest *)request
                withDelegate:(id<ABI19_0_0RCTURLRequestDelegate>)delegate
{
  // Lazy setup
  if (!_fileQueue) {
