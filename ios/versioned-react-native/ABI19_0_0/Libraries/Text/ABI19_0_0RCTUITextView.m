...
@implementation ABI19_0_0RCTUITextView
{
...
- (CGSize)sizeThatFits:(CGSize)size
{
  ...
  placeholderSize = CGSizeMake(ABI19_0_0RCTCeilPixelValue(placeholderSize.width), ABI19_0_0RCTCeilPixelValue(placeholderSize.height));
