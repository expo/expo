...
#define ABI19_0_0RCT_RUN_RUNLOOP_WHILE(CONDITION) \
{ \
...
/**
 * Use the ABI19_0_0RCTInitRunnerForApp macro for typical usage. See FBSnapshotTestCase.h for more information
 * on how to configure the snapshotting system.
 */
#define ABI19_0_0RCTInitRunnerForApp(app__, moduleProvider__) \
[[ABI19_0_0RCTTestRunner alloc] initWithApp:(app__) \
...
@class ABI19_0_0RCTRootView;

@interface ABI19_0_0RCTTestRunner : NSObject
...
/**
 * Initialize a runner.  It's recommended that you use the ABI19_0_0RCTInitRunnerForApp
...
- (instancetype)initWithApp:(NSString *)app
         referenceDirectory:(NSString *)referenceDirectory
             moduleProvider:(ABI19_0_0RCTBridgeModuleListProvider)block NS_DESIGNATED_INITIALIZER;

/**
 * Simplest runTest function simply mounts the specified JS module with no
 * initialProps and waits for it to call
 *
 *   ABI19_0_0RCTTestModule.markTestCompleted()
 *
 * JS errors/exceptions and timeouts will fail the test.  Snapshot tests call
 * ABI19_0_0RCTTestModule.verifySnapshot whenever they want to verify what has been
...
configurationBlock:(void(^)(ABI19_0_0RCTRootView *rootView))configurationBlock;
