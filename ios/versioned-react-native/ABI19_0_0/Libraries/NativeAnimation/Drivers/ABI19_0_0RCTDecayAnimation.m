...
@interface ABI19_0_0RCTDecayAnimation ()
...
@implementation ABI19_0_0RCTDecayAnimation
{
  CGFloat _velocity;
                  ...
                  callBack:(nullable ABI19_0_0RCTResponseSenderBlock)callback;
{
  if ((self = [super init])) {
    ...
    _velocity = [ABI19_0_0RCTConvert CGFloat:config[@"velocity"]];
    _deceleration = [ABI19_0_0RCTConvert CGFloat:config[@"deceleration"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  if (_frameStartTime == -1) {
    ...
    _frameStartTime = currentTime - ABI19_0_0RCTSingleFrameInterval;
