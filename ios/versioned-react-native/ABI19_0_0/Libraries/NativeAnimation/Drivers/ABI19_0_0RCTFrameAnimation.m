...
@implementation ABI19_0_0RCTFrameAnimation
{
  ...
  ABI19_0_0RCTResponseSenderBlock _callback;
...
{
  if ((self = [super init])) {
    NSNumber *toValue = [ABI19_0_0RCTConvert NSNumber:config[@"toValue"]] ?: @1;
    NSArray<NSNumber *> *frames = [ABI19_0_0RCTConvert NSNumberArray:config[@"frames"]];
    NSNumber *iterations = [ABI19_0_0RCTConvert NSNumber:config[@"iterations"]] ?: @1;
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  NSUInteger startIndex = floor(currentDuration / ABI19_0_0RCTSingleFrameInterval);
  ...
  NSTimeInterval fromInterval = startIndex * ABI19_0_0RCTSingleFrameInterval;
  NSTimeInterval toInterval = nextIndex * ABI19_0_0RCTSingleFrameInterval;
  ...
  CGFloat frameOutput = ABI19_0_0RCTInterpolateValue(currentDuration,
                                            fromInterval,
                                            toInterval,
                                            fromFrameValue.doubleValue,
                                            toFrameValue.doubleValue,
                                            ABI19_0_0EXTRAPOLATE_TYPE_EXTEND,
                                            ABI19_0_0EXTRAPOLATE_TYPE_EXTEND);
...
{
  CGFloat outputValue = ABI19_0_0RCTInterpolateValue(frameOutput,
                                            0,
                                            1,
                                            _fromValue,
                                            _toValue,
