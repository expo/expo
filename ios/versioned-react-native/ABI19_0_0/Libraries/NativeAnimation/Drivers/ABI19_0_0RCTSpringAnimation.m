...
@interface ABI19_0_0RCTSpringAnimation ()
...
@implementation ABI19_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
                  ...
                  callBack:(nullable ABI19_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _toValue = [ABI19_0_0RCTConvert CGFloat:config[@"toValue"]];
    _fromValue = valueNode.value;
    _valueNode = valueNode;
    _overshootClamping = [ABI19_0_0RCTConvert BOOL:config[@"overshootClamping"]];
    _restDisplacementThreshold = [ABI19_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
    _restSpeedThreshold = [ABI19_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
    _tension = [ABI19_0_0RCTConvert CGFloat:config[@"tension"]];
    _friction = [ABI19_0_0RCTConvert CGFloat:config[@"friction"]];
