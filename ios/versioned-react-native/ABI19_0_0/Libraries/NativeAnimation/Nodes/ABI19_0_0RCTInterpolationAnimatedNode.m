...
@implementation ABI19_0_0RCTInterpolationAnimatedNode
{
  __weak ABI19_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI19_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI19_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI19_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI19_0_0RCTInterpolateValueInRange(inputValue,
                                          _inputRange,
                                          _outputRange,
                                          _extrapolateLeft,
                                          _extrapolateRight);
