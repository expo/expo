...
@implementation ABI19_0_0RCTDiffClampAnimatedNode
{
...
{
  ABI19_0_0RCTValueAnimatedNode *inputNode = (ABI19_0_0RCTValueAnimatedNode *)self.parentNodes[_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI19_0_0RCTValueAnimatedNode class]]) {
    ABI19_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
