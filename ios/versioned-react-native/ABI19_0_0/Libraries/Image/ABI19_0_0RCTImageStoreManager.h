...
@interface ABI19_0_0RCTImageStoreManager : NSObject <ABI19_0_0RCTURLRequestHandler>
...
@interface ABI19_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI19_0_0RCTBridge (ABI19_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI19_0_0RCTImageStoreManager *imageStoreManager;
