...
#include "ABI19_0_0Executor.h"
#include "ABI19_0_0MethodCall.h"
...
void Instance::loadApplication(
  ...
  SystraceSection s("ReactABI19_0_0bridge_xplat_loadApplication", "sourceURL", sourceURL);
...
void Instance::loadApplicationSync(
  ...
  SystraceSection s("ReactABI19_0_0bridge_xplat_loadApplicationSync", "sourceURL", sourceURL);
  nativeToJsBridge_->loadApplicationSync(std::move(unbundle), std::move(string), std::move(sourceURL));
}

void Instance::setSourceURL(std::string sourceURL) {
  callback_->incrementPendingJSCalls();
  SystraceSection s("ReactABI19_0_0bridge_xplat_setSourceURL", "sourceURL", sourceURL);
...
void Instance::loadScriptFromString(std::unique_ptr<const JSBigString> string,
  ...
  SystraceSection s("ReactABI19_0_0bridge_xplat_loadScriptFromString", "sourceURL", sourceURL);
