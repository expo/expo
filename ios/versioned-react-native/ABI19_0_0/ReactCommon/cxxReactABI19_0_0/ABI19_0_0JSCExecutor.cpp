...
#include "ABI19_0_0JSCExecutor.h"
...
#include <ABI19_0_0jschelpers/ABI19_0_0InspectorInterfaces.h>
#endif

#include "ABI19_0_0JSBundleType.h"
#include "ABI19_0_0Platform.h"
#include "ABI19_0_0SystraceSection.h"
#include "ABI19_0_0JSCNativeModules.h"
#include "ABI19_0_0JSCSamplingProfiler.h"
#include "ABI19_0_0JSCUtils.h"
#include "JSModulesUnbundle.h"
#include "ABI19_0_0ModuleRegistry.h"
#include "ABI19_0_0RecoverableError.h"

#if defined(WITH_JSC_EXTRA_TRACING) || (DEBUG && defined(WITH_FBSYSTRACE))
#include "ABI19_0_0JSCTracing.h"
#endif

#ifdef WITH_JSC_EXTRA_TRACING
#include "ABI19_0_0JSCLegacyProfiler.h"
#include "ABI19_0_0JSCLegacyTracing.h"
#endif
...
void JSCExecutor::loadApplicationScript(std::unique_ptr<const JSBigString> script, std::string sourceURL) {
  ...
  ReactABI19_0_0Marker::logTaggedMarker(ReactABI19_0_0Marker::RUN_JS_BUNDLE_START, scriptName.c_str());
  ...
  if (auto fileStr = dynamic_cast<const JSBigFileString *>(script.get())) {
    ...
    case JSLoadSourceIsCompiled:
      ...
      ReactABI19_0_0Marker::logMarker(ReactABI19_0_0Marker::CREATE_REACT_CONTEXT_STOP);
      ReactABI19_0_0Marker::logMarker(ReactABI19_0_0Marker::RUN_JS_BUNDLE_STOP);
      return;
...
#endif
  {
    String jsScript;
    {
      ...
      ReactABI19_0_0Marker::logMarker(ReactABI19_0_0Marker::JS_BUNDLE_STRING_CONVERT_START);
      jsScript = adoptString(std::move(script));
      ReactABI19_0_0Marker::logMarker(ReactABI19_0_0Marker::JS_BUNDLE_STRING_CONVERT_STOP);
    }
...
void JSCExecutor::stopProfiler(const std::string &titleString, const std::string& filename) {
  #ifdef WITH_JSC_EXTRA_TRACING
  String title(m_context, titleString.c_str());
  facebook::ReactABI19_0_0::stopAndOutputProfilingFile(m_context, title, filename.c_str());
  #endif
}
...
JSValueRef JSCExecutor::nativeRequire(
  ...
  ReactABI19_0_0Marker::logMarker(ReactABI19_0_0Marker::NATIVE_REQUIRE_START);
  loadModule(moduleId);
  ReactABI19_0_0Marker::logMarker(ReactABI19_0_0Marker::NATIVE_REQUIRE_STOP);
