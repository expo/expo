...
Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |ss|
    ss.dependency      'ReactABI13_0_0/ABI13_0_0yoga'
    ss.dependency      'ReactABI13_0_0/cxxReactABI13_0_0'
    ss.source_files  = "React/**/*.{c,h,m,mm,S}"
    ss.exclude_files = "**/__tests__/*", "IntegrationTests/*", "ReactCommon/ABI13_0_0yoga/*"
    ss.frameworks    = "JavaScriptCore"
    ss.libraries     = "stdc++"
  end

    s.subspec 'Exponent' do |ss|
    ss.dependency         'ReactABI13_0_0/Core'
    ss.source_files     = "Exponent/**/*.{h,m}"
    end

  s.subspec 'ABI13_0_0jschelpers' do |ss|
    ss.source_files = 'ReactCommon/ABI13_0_0jschelpers/{ABI13_0_0JavaScriptCore,ABI13_0_0JSCWrapper}.{cpp,h}'
    ss.header_dir   = 'ABI13_0_0jschelpers'
  end

  s.subspec 'cxxReactABI13_0_0' do |ss|
    ss.dependency     'ReactABI13_0_0/ABI13_0_0jschelpers'
    ss.source_files = 'ReactCommon/cxxReactABI13_0_0/{ABI13_0_0JSBundleType,ABI13_0_0oss-compat-util}.{cpp,h}'
    ss.header_dir   = 'cxxReactABI13_0_0'
  end

  s.subspec 'ABI13_0_0yoga' do |ss|
    ss.source_files = 'ReactCommon/ABI13_0_0yoga/**/*.{c,h}'
    ss.header_dir   = 'ABI13_0_0yoga'
  end
  ...
  s.subspec 'RCTCameraRoll' do |ss|
    ss.dependency       'ReactABI13_0_0/Core'
    ss.dependency       'ReactABI13_0_0/RCTImage'
  ...
  s.subspec 'RCTImage' do |ss|
    ss.dependency       'ReactABI13_0_0/Core'
    ss.dependency       'ReactABI13_0_0/RCTNetwork'
