...
#include "ABI13_0_0Instance.h"

#include "ABI13_0_0Executor.h"
#include "ABI13_0_0MethodCall.h"
...
void Instance::loadScriptFromString(std::unique_ptr<const JSBigString> string,
  ...
  SystraceSection s("ReactABI13_0_0bridge_xplat_loadScriptFromString",
                    "sourceURL", sourceURL);
...
void Instance::loadScriptFromFile(const std::string& filename,
  ...
  // TODO mhorowitz: ReactABI13_0_0Marker around file read
  std::unique_ptr<JSBigBufferString> buf;
  {
    SystraceSection s("ReactABI13_0_0bridge_xplat_loadScriptFromFile",
                      "fileName", filename);
...
void Instance::loadScriptFromOptimizedBundle(std::string bundlePath,
                                             std::string sourceURL,
                                             int flags) {
  SystraceSection s("ReactABI13_0_0bridge_xplat_loadScriptFromOptimizedBundle",
...
void Instance::loadUnbundleSync(std::unique_ptr<JSModulesUnbundle> unbundle,
  ...
  SystraceSection s("ReactABI13_0_0bridge_xplat_loadApplicationSync");
