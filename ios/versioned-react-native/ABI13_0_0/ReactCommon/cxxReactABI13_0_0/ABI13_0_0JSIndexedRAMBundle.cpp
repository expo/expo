...
#include "ABI13_0_0JSIndexedRAMBundle.h"
#include "ABI13_0_0oss-compat-util.h"
...
std::unique_ptr<const facebook::ReactABI13_0_0::JSBigString> JSIndexedRAMBundle::getStartupCode() {
