...
#include "ABI13_0_0JSCExecutor.h"
...
#include <ABI13_0_0jschelpers/ABI13_0_0JSCHelpers.h>
...
#include "ABI13_0_0SystraceSection.h"
#include "ABI13_0_0JSCNativeModules.h"
#include "ABI13_0_0JSCSamplingProfiler.h"
#include "ABI13_0_0JSCUtils.h"
#include "JSModulesUnbundle.h"
#include "ABI13_0_0ModuleRegistry.h"

#if defined(WITH_JSC_EXTRA_TRACING) || DEBUG
#include "ABI13_0_0JSCTracing.h"
#endif

#ifdef WITH_JSC_EXTRA_TRACING
#include "ABI13_0_0JSCLegacyProfiler.h"
#include "ABI13_0_0JSCLegacyTracing.h"
...
#include "ABI13_0_0JSCPerfStats.h"
#endif
...
void JSCExecutor::loadApplicationScript(
  ...
  ReactABI13_0_0Marker::logMarker("RUN_JS_BUNDLE_START");
  ...
  flush();
  ReactABI13_0_0Marker::logMarker("CREATE_REACT_CONTEXT_END");
  ReactABI13_0_0Marker::logMarker("RUN_JS_BUNDLE_END");
}
#endif
...
void JSCExecutor::loadApplicationScript(std::unique_ptr<const JSBigString> script, std::string sourceURL) throw(JSException) {
  ...
  ReactABI13_0_0Marker::logMarker("loadApplicationScript_startStringConvert");
  String jsScript = jsStringFromBigString(m_context, *script);
  ReactABI13_0_0Marker::logMarker("loadApplicationScript_endStringConvert");
...
void JSCExecutor::stopProfiler(const std::string &titleString, const std::string& filename) {
  #ifdef WITH_JSC_EXTRA_TRACING
  String title(m_context, titleString.c_str());
  facebook::ReactABI13_0_0::stopAndOutputProfilingFile(m_context, title, filename.c_str());
  #endif
}
