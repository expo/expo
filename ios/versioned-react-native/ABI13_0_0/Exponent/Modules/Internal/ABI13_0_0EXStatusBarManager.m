...
#if !TARGET_OS_TV
@implementation ABI13_0_0RCTConvert (ABI13_0_0EXStatusBar)
...
@interface ABI13_0_0EXStatusBarManager ()

@property (nonatomic, strong) NSDictionary *capturedStatusBarProperties;

@end

@implementation ABI13_0_0EXStatusBarManager

+ (NSString *)moduleName { return @"ABI13_0_0RCTStatusBarManager"; }
 ...
 */
ABI13_0_0RCT_REMAP_METHOD(_captureProperties,
                 _capturePropertiesWithResolver:(ABI13_0_0RCTPromiseResolveBlock)resolve
 ...
 *  Normally nobody should use this method because it bypasses the JS state used by the StatusBar component.
 */
ABI13_0_0RCT_EXPORT_METHOD(_applyPropertiesAndForget:(NSDictionary *)properties)
{
...
{
  UIApplication *currentApplication = ABI13_0_0RCTSharedApplication();
  return @{
