...
#import <ReactABI13_0_0/ABI13_0_0RCTRedBox.h>

@implementation ABI13_0_0EXFrameExceptionsManager {
  __weak id<ABI13_0_0RCTExceptionsManagerDelegate> _delegate;
}

@synthesize bridge = _bridge;

+ (NSString *)moduleName { return @"ABI13_0_0RCTExceptionsManager"; }
...
{
  // this will hit ABI13_0_0EXDisabledRedBox when not debugging
