...
@interface ABI13_0_0EXAppState ()

@property (nonatomic, assign) BOOL isObserving;

@end

@implementation ABI13_0_0EXAppState

+ (NSString *)moduleName { return @"ABI13_0_0RCTAppState"; }
...
ABI13_0_0RCT_EXPORT_METHOD(getCurrentAppState:(ABI13_0_0RCTResponseSenderBlock)callback
                  error:(__unused ABI13_0_0RCTResponseSenderBlock)error)
{
