...
@interface ABI13_0_0EXKernelModule ()
...
@implementation ABI13_0_0EXKernelModule
...
- (void)sendEventWithName:(NSString *)eventName body:(id)body
{
  ...
  [self.bridge enqueueJSCall:@"ABI13_0_0RCTDeviceEventEmitter.emit"
...
ABI13_0_0RCT_EXPORT_METHOD(addDevMenu)
{
...
ABI13_0_0RCT_REMAP_METHOD(routeDidForeground,
...
ABI13_0_0RCT_REMAP_METHOD(onEventSuccess,
...
ABI13_0_0RCT_REMAP_METHOD(onEventFailure,
                 eventId:(NSString *)eventId
