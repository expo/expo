...
@implementation NSData (ABI13_0_0EXFileSystem)
...
@interface ABI13_0_0EXFileSystem ()
...
@implementation ABI13_0_0EXFileSystem
...
{
  if (self = [super init]) {
    NSString *subdir = [ABI13_0_0EXVersionManager escapedResourceName:experienceId];
...
ABI13_0_0RCT_REMAP_METHOD(downloadAsync,
...
ABI13_0_0RCT_REMAP_METHOD(getInfoAsync,
...
ABI13_0_0RCT_REMAP_METHOD(deleteAsync,
...
- (NSString *)scopedPathWithPath:(NSString *)path withOptions:(NSDictionary *)options
{
  ...
  if (![ABI13_0_0EXFileSystem ensureDirExistsWithPath:prefix]) {
    return nil;
  }
