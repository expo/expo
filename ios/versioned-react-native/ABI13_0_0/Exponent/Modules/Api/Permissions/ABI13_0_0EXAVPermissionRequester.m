...
@interface ABI13_0_0EXAVPermissionRequester ()

@property (nonatomic, weak) id<ABI13_0_0EXPermissionRequesterDelegate> delegate;

@end

@implementation ABI13_0_0EXAVPermissionRequester
...
+ (NSDictionary *)permissions
{
  ...
  if (!(cameraUsageDescription && microphoneUsageDescription)) {
    ABI13_0_0RCTFatal(ABI13_0_0RCTErrorWithMessage(@"This app is missing either NSCameraUsageDescription or NSMicrophoneUsageDescription, so audio/video services will fail. Add one of these keys to your bundle's Info.plist."));
