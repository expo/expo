...
@interface ABI13_0_0EXLocationRequester () <CLLocationManagerDelegate>
...
@implementation ABI13_0_0EXLocationRequester

+ (NSDictionary *)permissions
{
  ABI13_0_0EXPermissionStatus status;
  NSString *scope = @"none";
  ...
  if (!(alwaysUsageDescription || whenInUseUsageDescription)) {
    ABI13_0_0RCTFatal(ABI13_0_0RCTErrorWithMessage(@"This app is missing NSLocationAlwaysUsageDescription or NSLocationWhenInUseUsageDescription, so location services will fail. Add one of these keys to your bundle's Info.plist."));
  ...
  switch (systemStatus) {
    case kCLAuthorizationStatusAuthorizedWhenInUse: {
      status = ABI13_0_0EXPermissionStatusGranted;
      scope = @"whenInUse";
      break;
    }
    ...
    case kCLAuthorizationStatusDenied: case kCLAuthorizationStatusRestricted: {
      status = ABI13_0_0EXPermissionStatusDenied;
      break;
    }
    case kCLAuthorizationStatusNotDetermined: default: {
      status = ABI13_0_0EXPermissionStatusUndetermined;
      break;
    }
  }
...
- (void)requestPermissionsWithResolver:(ABI13_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI13_0_0RCTPromiseRejectBlock)reject
{
  ...
  if (existingPermissions && ![existingPermissions[@"status"] isEqualToString:[ABI13_0_0EXPermissions permissionStringForStatus:ABI13_0_0EXPermissionStatusUndetermined]]) {
