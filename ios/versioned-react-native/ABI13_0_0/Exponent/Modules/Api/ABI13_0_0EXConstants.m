...
@interface ABI13_0_0EXConstants ()
...
@implementation ABI13_0_0EXConstants
...
{
  NSString *exponentClientVersion = [[[NSBundle mainBundle] infoDictionary] objectForKey:@"ABI13_0_0EXClientVersion"];
