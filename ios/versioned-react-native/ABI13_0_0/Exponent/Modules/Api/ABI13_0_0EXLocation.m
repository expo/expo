...
NSString * const ABI13_0_0EXLocationChangedEventName = @"Exponent.locationChanged";

@interface ABI13_0_0EXLocationDelegate : NSObject <CLLocationManagerDelegate>
...
@implementation ABI13_0_0EXLocationDelegate
...
@interface ABI13_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI13_0_0EXLocationDelegate*> *delegates;

@end

@implementation ABI13_0_0EXLocation

ABI13_0_0RCT_EXPORT_MODULE(ExponentLocation)
...
{
  return @[ABI13_0_0EXLocationChangedEventName];
}


ABI13_0_0RCT_REMAP_METHOD(getCurrentPositionAsync,
...
ABI13_0_0RCT_REMAP_METHOD(watchPositionImplAsync,
                 ...
                 rejecter:(ABI13_0_0RCTPromiseRejectBlock)reject)
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    locMgr.distanceFilter = options[@"distanceInterval"] ? [ABI13_0_0RCTConvert double:options[@"distanceInterval"]] ?: kCLDistanceFilterNone : kCLLocationAccuracyHundredMeters;
    locMgr.desiredAccuracy = [ABI13_0_0RCTConvert BOOL:options[@"enableHighAccuracy"]] ? kCLLocationAccuracyBest : kCLLocationAccuracyHundredMeters;
    
    ABI13_0_0EXLocationDelegate *delegate = [[ABI13_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
      if (locations.lastObject) {
        ...
        [weakSelf sendEventWithName:ABI13_0_0EXLocationChangedEventName body:body];
      }
...
ABI13_0_0RCT_REMAP_METHOD(removeWatchAsync,
                 watchId:(nonnull NSNumber *)watchId
                 resolver:(ABI13_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI13_0_0RCTPromiseRejectBlock)reject)
{
  ABI13_0_0EXLocationDelegate *delegate = _delegates[watchId];
  if (delegate) {
    __weak typeof(self) weakSelf = self;
    dispatch_async(dispatch_get_main_queue(), ^{
