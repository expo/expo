...
@implementation ABI13_0_0EXBarCodeScannerManager

ABI13_0_0RCT_EXPORT_MODULE(ExponentBarCodeScannerManager);
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(onBarCodeRead, ABI13_0_0RCTDirectEventBlock);
...
- (UIView *)view
{
  ...
  if (!self.camera) {
    self.camera = [[ABI13_0_0EXBarCodeScanner alloc] initWithManager:self bridge:self.bridge];
  }
  return self.camera;
}
...
- (NSDictionary *)constantsToExport
{
  return @{
    ...
    @"Type" :
        @{@"front" : @(ABI13_0_0EXBarCodeScannerTypeFront), @"back" : @(ABI13_0_0EXBarCodeScannerTypeBack)},
    @"TorchMode" : @{
      @"off" : @(ABI13_0_0EXBarCodeScannerTorchModeOff),
      @"on" : @(ABI13_0_0EXBarCodeScannerTorchModeOn),
      @"auto" : @(ABI13_0_0EXBarCodeScannerTorchModeAuto)
    }
  };
}

ABI13_0_0RCT_CUSTOM_VIEW_PROPERTY(type, NSInteger, ABI13_0_0EXBarCodeScanner)
{
  NSInteger type = [ABI13_0_0RCTConvert NSInteger:json];
...
ABI13_0_0RCT_CUSTOM_VIEW_PROPERTY(torchMode, NSInteger, ABI13_0_0EXBarCodeScanner)
{
  dispatch_async(self.sessionQueue, ^{
    NSInteger torchMode = [ABI13_0_0RCTConvert NSInteger:json];
...
ABI13_0_0RCT_CUSTOM_VIEW_PROPERTY(barCodeTypes, NSArray, ABI13_0_0EXBarCodeScanner)
{
  self.barCodeTypes = [ABI13_0_0RCTConvert NSArray:json];
}
...
- (void)startSession
{
  ...
  dispatch_async(self.sessionQueue, ^{
    ...
    __weak ABI13_0_0EXBarCodeScannerManager *weakSelf = self;
              ...
              [NSNotificationCenter.defaultCenter
                  addObserverForName:AVCaptureSessionRuntimeErrorNotification
                          ...
                          usingBlock:^(NSNotification *note) {
                            ABI13_0_0EXBarCodeScannerManager *strongSelf = weakSelf;
