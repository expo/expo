...
const CLLocationDegrees ABI13_0_0AIRMapDefaultSpan = 0.005;
const NSTimeInterval ABI13_0_0AIRMapRegionChangeObserveInterval = 0.1;
const CGFloat ABI13_0_0AIRMapZoomBoundBuffer = 0.01;
...
@implementation ABI13_0_0AIRMap
{
    UIView *_legalLabel;
    ...
    //
    // ABI13_0_0AIRMap implicitly creates subviews that aren't regular RN children
    // (ABI13_0_0SMCalloutView injects an overlay subview), which otherwise confuses RN
    // during component re-renders:
    // https://github.com/facebook/ReactABI13_0_0-native/blob/v0.16.0/ReactABI13_0_0/Modules/ABI13_0_0RCTUIManager.m#L657
    //
    // Implementation based on ABI13_0_0RCTTextField, another component with indirect children
    // https://github.com/facebook/ReactABI13_0_0-native/blob/v0.16.0/Libraries/Text/ABI13_0_0RCTTextField.m#L20
    NSMutableArray<UIView *> *_ReactABI13_0_0Subviews;
}
...
- (instancetype)init
{
    if ((self = [super init])) {
        ...
        _ReactABI13_0_0Subviews = [NSMutableArray new];
        ...
        self.calloutView = [ABI13_0_0SMCalloutView platformCalloutView];
...
- (void)insertReactABI13_0_0Subview:(id<ABI13_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
    ...
    if ([subview isKindOfClass:[ABI13_0_0AIRMapMarker class]]) {
        [self addAnnotation:(id <MKAnnotation>) subview];
    } else if ([subview isKindOfClass:[ABI13_0_0AIRMapPolyline class]]) {
        ((ABI13_0_0AIRMapPolyline *)subview).map = self;
        [self addOverlay:(id<MKOverlay>)subview];
    } else if ([subview isKindOfClass:[ABI13_0_0AIRMapPolygon class]]) {
        ((ABI13_0_0AIRMapPolygon *)subview).map = self;
        [self addOverlay:(id<MKOverlay>)subview];
    } else if ([subview isKindOfClass:[ABI13_0_0AIRMapCircle class]]) {
        [self addOverlay:(id<MKOverlay>)subview];
    } else if ([subview isKindOfClass:[ABI13_0_0AIRMapUrlTile class]]) {
        [self addOverlay:(id<MKOverlay>)subview];
    }
    [_ReactABI13_0_0Subviews insertObject:(UIView *)subview atIndex:(NSUInteger) atIndex];
}
...
- (void)removeReactABI13_0_0Subview:(id<ABI13_0_0RCTComponent>)subview {
    ...
    [_ReactABI13_0_0Subviews removeObject:(UIView *)subview];
}
#pragma clang diagnostic pop

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wobjc-missing-super-calls"
- (NSArray<id<ABI13_0_0RCTComponent>> *)ReactABI13_0_0Subviews {
...
#pragma mark ABI13_0_0SMCalloutViewDelegate
