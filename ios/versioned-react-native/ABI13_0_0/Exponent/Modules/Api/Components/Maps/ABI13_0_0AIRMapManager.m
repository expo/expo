...
#import "ABI13_0_0AIRMapManager.h"
...
#import "ABI13_0_0AIRMapSnapshot.h"
...
@interface ABI13_0_0AIRMapManager() <MKMapViewDelegate>

@end

@implementation ABI13_0_0AIRMapManager

ABI13_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI13_0_0AIRMap *map = [ABI13_0_0AIRMap new];
    map.delegate = self;
...
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(showsPointsOfInterest, BOOL)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(showsTraffic, BOOL)
...
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(cacheEnabled, BOOL)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
...
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(onPanDrag, ABI13_0_0RCTBubblingEventBlock)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(onPress, ABI13_0_0RCTBubblingEventBlock)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(onLongPress, ABI13_0_0RCTBubblingEventBlock)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerPress, ABI13_0_0RCTDirectEventBlock)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI13_0_0RCTDirectEventBlock)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI13_0_0RCTDirectEventBlock)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI13_0_0RCTDirectEventBlock)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI13_0_0RCTDirectEventBlock)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI13_0_0RCTDirectEventBlock)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(onCalloutPress, ABI13_0_0RCTDirectEventBlock)
ABI13_0_0RCT_EXPORT_VIEW_PROPERTY(initialRegion, MKCoordinateRegion)

ABI13_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI13_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setRegion:[ABI13_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
...
ABI13_0_0RCT_EXPORT_METHOD(animateToRegion:(nonnull NSNumber *)ReactABI13_0_0Tag
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI13_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI13_0_0AIRMap class]]) {
            ABI13_0_0RCTLogError(@"Invalid view returned from registry, expecting ABI13_0_0AIRMap, got: %@", view);
        } else {
            [ABI13_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI13_0_0AIRMap *)view setRegion:region animated:YES];
            }];
        }
    }];
}

ABI13_0_0RCT_EXPORT_METHOD(animateToCoordinate:(nonnull NSNumber *)ReactABI13_0_0Tag
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI13_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI13_0_0AIRMap class]]) {
            ...
            ABI13_0_0AIRMap *mapView = (ABI13_0_0AIRMap *)view;
...
ABI13_0_0RCT_EXPORT_METHOD(fitToElements:(nonnull NSNumber *)ReactABI13_0_0Tag
...
ABI13_0_0RCT_EXPORT_METHOD(fitToSuppliedMarkers:(nonnull NSNumber *)ReactABI13_0_0Tag
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI13_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI13_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ABI13_0_0AIRMapMarker *marker = (ABI13_0_0AIRMapMarker *)evaluatedObject;
                return [marker isKindOfClass:[ABI13_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
...
ABI13_0_0RCT_EXPORT_METHOD(fitToCoordinates:(nonnull NSNumber *)ReactABI13_0_0Tag
                  coordinates:(nonnull NSArray<ABI13_0_0AIRMapCoordinate *> *)coordinates
                  ...
                  animated:(BOOL)animated)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI13_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI13_0_0AIRMap class]]) {
            ...
            // Set Map viewport
            CGFloat top = [ABI13_0_0RCTConvert CGFloat:edgePadding[@"top"]];
            CGFloat right = [ABI13_0_0RCTConvert CGFloat:edgePadding[@"right"]];
            CGFloat bottom = [ABI13_0_0RCTConvert CGFloat:edgePadding[@"bottom"]];
            CGFloat left = [ABI13_0_0RCTConvert CGFloat:edgePadding[@"left"]];
...
ABI13_0_0RCT_EXPORT_METHOD(takeSnapshot:(nonnull NSNumber *)ReactABI13_0_0Tag
...
- (void)takeMapSnapshot:(ABI13_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI13_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI13_0_0AIRMap *map = (ABI13_0_0AIRMap *)recognizer.view;
    ...
    ABI13_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI13_0_0AIRMapPolygon class]]){
            ABI13_0_0AIRMapPolygon *polygon = (ABI13_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI13_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI13_0_0AIRMapPolyline class]]){
            ABI13_0_0AIRMapPolyline *polyline = (ABI13_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI13_0_0AIRMapPolyline class]]) {
        return ((ABI13_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI13_0_0AIRMapPolygon class]]) {
        return ((ABI13_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI13_0_0AIRMapCircle class]]) {
        return ((ABI13_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI13_0_0AIRMapUrlTile class]]) {
        return ((ABI13_0_0AIRMapUrlTile *)overlay).renderer;
    } else {
        return nil;
    }
}
...
- (void)mapView:(ABI13_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI13_0_0AIRMapMarker class]]) {
        [(ABI13_0_0AIRMapMarker *)view.annotation showCalloutView];
    }
}

- (void)mapView:(ABI13_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI13_0_0AIRMapMarker class]]) {
        [(ABI13_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI13_0_0AIRMap *)mapView viewForAnnotation:(ABI13_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI13_0_0AIRMapMarker class]]) {
        return nil;
    }
...
- (void)mapView:(ABI13_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI13_0_0AIRMapMarker class]]) return;
    ABI13_0_0AIRMapMarker *marker = (ABI13_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI13_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI13_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI13_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI13_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI13_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    [self _regionChanged:mapView];

    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI13_0_0AIRMapRegionChangeObserveInterval
                                                               target:self
...
- (void)mapView:(ABI13_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI13_0_0AIRMap *)mapView
{
...
- (void)mapViewDidFinishRenderingMap:(ABI13_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
- (void)_regionChanged:(ABI13_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI13_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI13_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI13_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI13_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI13_0_0AIRMap *)mapView
{
