...
#import "ABI13_0_0AIRMapPolylineManager.h"
...
#import "ABI13_0_0AIRMapPolyline.h"

@interface ABI13_0_0AIRMapPolylineManager()

@end

@implementation ABI13_0_0AIRMapPolylineManager

ABI13_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI13_0_0AIRMapPolyline *polyline = [ABI13_0_0AIRMapPolyline new];
    return polyline;
}
