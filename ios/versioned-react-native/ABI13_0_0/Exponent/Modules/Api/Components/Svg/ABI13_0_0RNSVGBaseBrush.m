...
#import "ABI13_0_0RNSVGBaseBrush.h"
#import "ABI13_0_0RCTConvert+RNSVG.h"
#import <ReactABI13_0_0/ABI13_0_0RCTLog.h>

@implementation ABI13_0_0RNSVGBaseBrush

- (instancetype)initWithArray:(NSArray *)array
{
    if ((self = [super initWithArray:array])) {
        if (array.count != 2) {
            ABI13_0_0RCTLogError(@"-[%@ %@] expects 2 elements, received %@",
...
- (void)paint:(CGContextRef)context opacity:(CGFloat)opacity brushConverter:(ABI13_0_0RNSVGBrushConverter *)brushConverter
{
    ...
    if (brushConverter.type == kABI13_0_0RNSVGLinearGradient) {
        [brushConverter drawLinearGradient:context];
    } else if (brushConverter.type == kABI13_0_0RNSVGRadialGradient) {
        [brushConverter drawRidialGradient:context];
    } else if (brushConverter.type == kABI13_0_0RNSVGPattern) {
        // todo:
    }
