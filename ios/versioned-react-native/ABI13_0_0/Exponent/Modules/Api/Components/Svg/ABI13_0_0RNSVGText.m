...
@implementation ABI13_0_0RNSVGText

static void ABI13_0_0RNSVGFreeTextFrame(ABI13_0_0RNSVGTextFrame frame)
{
    if (frame.count) {
...
- (void)setTextFrame:(ABI13_0_0RNSVGTextFrame)textFrame
{
    ABI13_0_0RNSVGFreeTextFrame(_textFrame);
    [self invalidate];
...
- (CGPathRef)getPath:(CGContextRef)context
{
    ...
    ABI13_0_0RNSVGTextFrame frame = self.textFrame;
    for (int i = 0; i < frame.count; i++) {
        CGFloat shift;
...
- (CGMutablePathRef)setLinePath:(CTLineRef)line
{
    ...
    ABI13_0_0RNSVGBezierPath *bezierPath = [[ABI13_0_0RNSVGBezierPath alloc] initWithBezierCurves:self.path];
