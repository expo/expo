...
@implementation ABI13_0_0RNSVGNode
{
    BOOL _transparent;
}
...
- (void)invalidate
{
    id<ABI13_0_0RNSVGContainer> container = (id<ABI13_0_0RNSVGContainer>)self.superview;
...
- (void)clip:(CGContextRef)context
{
    ...
    if (clipPath) {
        ...
        if (self.clipRule == kABI13_0_0RNSVGCGFCRuleEvenodd) {
...
- (ABI13_0_0RNSVGSvgView *)getSvgView
{
    UIView *parent = self.superview;
    while (parent && [parent class] != [ABI13_0_0RNSVGSvgView class]) {
        parent = parent.superview;
    }

    return (ABI13_0_0RNSVGSvgView *)parent;
}

- (void)saveDefinition
{
    if (self.name) {
        ABI13_0_0RNSVGSvgView* svg = [self getSvgView];
...
- (void)traverseSubviews:(BOOL (^)(ABI13_0_0RNSVGNode *node))block
{
