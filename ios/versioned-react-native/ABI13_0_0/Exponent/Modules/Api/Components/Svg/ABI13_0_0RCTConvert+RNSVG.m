...
@implementation ABI13_0_0RCTConvert (ABI13_0_0RNSVG)
...
ABI13_0_0RCT_ENUM_CONVERTER(ABI13_0_0RNSVGCGFCRule, (@{
                                     @"evenodd": @(kABI13_0_0RNSVGCGFCRuleEvenodd),
                                     @"nonzero": @(kABI13_0_0RNSVGCGFCRuleNonzero),
                                     }), kABI13_0_0RNSVGCGFCRuleNonzero, intValue)

ABI13_0_0RCT_ENUM_CONVERTER(ABI13_0_0RNSVGVBMOS, (@{
                                  @"meet": @(kABI13_0_0RNSVGVBMOSMeet),
                                  @"slice": @(kABI13_0_0RNSVGVBMOSSlice),
                                  @"none": @(kABI13_0_0RNSVGVBMOSNone)
                                  }), kABI13_0_0RNSVGVBMOSMeet, intValue)


// This takes a tuple of text lines and a font to generate a CTLine for each text line.
// This prepares everything for rendering a frame of text in ABI13_0_0RNSVGText.
+ (ABI13_0_0RNSVGTextFrame)ABI13_0_0RNSVGTextFrame:(id)json
{
    NSDictionary *dict = [self NSDictionary:json];
    ABI13_0_0RNSVGTextFrame frame;
    frame.count = 0;
    ...
    CTFontRef font = (__bridge CTFontRef)[ABI13_0_0RCTFont updateFont:nil withFamily:fontFamily size:fontDict[@"fontSize"] weight:fontDict[@"fontWeight"] style:fontDict[@"fontStyle"]
    ...
    frame.lineHeight = size * 1.1; // Base on ABI13_0_0RNSVG canvas line height estimate
...
+ (ABI13_0_0RNSVGCGFloatArray)ABI13_0_0RNSVGCGFloatArray:(id)json
{
    ...
    ABI13_0_0RNSVGCGFloatArray array;
    array.count = count;
    array.array = nil;
...
+ (ABI13_0_0RNSVGBrush *)ABI13_0_0RNSVGBrush:(id)json
{
    ...
    switch (type) {
        case 0: // solid color
            ...
            return [[ABI13_0_0RNSVGSolidColorBrush alloc] initWithArray:arr];
        case 1: // brush
            return [[ABI13_0_0RNSVGBaseBrush alloc] initWithArray:arr];
        default:
        ...
        while (i < count) {
            ...
            switch (type) {
                ...
                case 3:
                    ...
                    break;
                default:
                    ABI13_0_0RCTLogError(@"Invalid ABI13_0_0RNSVGBezier type %zd at element %zd of %@", type, i, arr);
                    return nil;
            }
        }
    }
    @catch (NSException *exception) {
        ABI13_0_0RCTLogError(@"Invalid ABI13_0_0RNSVGBezier format: %@", arr);
        return nil;
    }
...
+ (CGGradientRef)CGGradient:(id)json offset:(NSUInteger)offset
{
    ...
    ABI13_0_0RNSVGCGFloatArray colorsAndOffsets = [self ABI13_0_0RNSVGCGFloatArray:arr];
