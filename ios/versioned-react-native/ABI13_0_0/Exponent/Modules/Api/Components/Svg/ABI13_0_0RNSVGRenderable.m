...
#import "ABI13_0_0RNSVGRenderable.h"
#import "ABI13_0_0RNSVGPercentageConverter.h"

@implementation ABI13_0_0RNSVGRenderable
{
    NSMutableDictionary *_originProperties;
    NSArray *_changedList;
    ABI13_0_0RNSVGPercentageConverter *_widthConverter;
    ABI13_0_0RNSVGPercentageConverter *_heightConverter;
...
- (void)setFill:(ABI13_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI13_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI13_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)setStrokeDasharray:(ABI13_0_0RNSVGCGFloatArray)strokeDasharray
{
...
- (void)setBoundingBox:(CGRect)boundingBox
{
    ...
    _widthConverter = [[ABI13_0_0RNSVGPercentageConverter alloc] initWithRelativeAndOffset:boundingBox.size.width offset:0];
    _heightConverter = [[ABI13_0_0RNSVGPercentageConverter alloc] initWithRelativeAndOffset:boundingBox.size.height offset:0];
}
...
- (void)mergeProperties:(__kindof ABI13_0_0RNSVGNode *)target mergeList:(NSArray<NSString *> *)mergeList
{

    [self mergeProperties:target mergeList:mergeList inherited:NO];
}

- (void)mergeProperties:(__kindof ABI13_0_0RNSVGNode *)target mergeList:(NSArray<NSString *> *)mergeList inherited:(BOOL)inherited
{
...
- (void)inheritProperty:(__kindof ABI13_0_0RNSVGNode *)parent propName:(NSString *)propName
{
