...
#import "ABI13_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI13_0_0EXFingerprint

ABI13_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI13_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI13_0_0RCTPromiseResolveBlock)resolve
...
ABI13_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI13_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI13_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI13_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
