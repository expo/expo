...
#import "ABI13_0_0EXFontLoader.h"
...
static NSMutableDictionary *ABI13_0_0EXFonts = nil;

@interface ABI13_0_0EXFont : NSObject
...
@implementation ABI13_0_0EXFont
...
@implementation ABI13_0_0RCTFont (ABI13_0_0EXFontLoader)

// Will swap this with +[ABI13_0_0RCTFont updateFont: ...]
          ...
          scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  if ([family hasPrefix:exponentPrefix] && ABI13_0_0EXFonts) {
    NSString *suffix = [family substringFromIndex:exponentPrefix.length];
    if (ABI13_0_0EXFonts[suffix]) {
      return [ABI13_0_0EXFonts[suffix] UIFontWithSize:[ABI13_0_0RCTConvert CGFloat:size] ?: font.pointSize ?: defaultFontSize];
    }
  }
...
@implementation ABI13_0_0EXFontLoader

ABI13_0_0RCT_EXPORT_MODULE(ExponentFontLoader);
...
+ (void)initialize {
  ...
  method_exchangeImplementations(class_getClassMethod([ABI13_0_0RCTFont class], a),
                                 class_getClassMethod([ABI13_0_0RCTFont class], b));
}

ABI13_0_0RCT_REMAP_METHOD(loadAsync,
...
{
  if (ABI13_0_0EXFonts && ABI13_0_0EXFonts[fontFamilyName]) {
  ...
  if (!ABI13_0_0EXFonts) {
    ABI13_0_0EXFonts = [NSMutableDictionary dictionary];
  }
  ABI13_0_0EXFonts[fontFamilyName] = [[ABI13_0_0EXFont alloc] initWithCGFont:font];
  resolve(nil);
}
