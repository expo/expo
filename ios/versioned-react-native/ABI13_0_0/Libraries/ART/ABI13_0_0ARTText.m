...
@implementation ABI13_0_0ARTText
...
static void ABI13_0_0ARTFreeTextFrame(ABI13_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI13_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI13_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI13_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI13_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
