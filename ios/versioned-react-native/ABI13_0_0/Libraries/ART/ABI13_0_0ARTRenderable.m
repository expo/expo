...
#import "ABI13_0_0ARTRenderable.h"

@implementation ABI13_0_0ARTRenderable

- (void)setFill:(ABI13_0_0ARTBrush *)fill
{
  [self invalidate];
  _fill = fill;
}
...
- (void)setStrokeDash:(ABI13_0_0ARTCGFloatArray)strokeDash
{
