...
@interface ABI13_0_0ARTRenderable : ABI13_0_0ARTNode

@property (nonatomic, strong) ABI13_0_0ARTBrush *fill;
...
@property (nonatomic, assign) ABI13_0_0ARTCGFloatArray strokeDash;
