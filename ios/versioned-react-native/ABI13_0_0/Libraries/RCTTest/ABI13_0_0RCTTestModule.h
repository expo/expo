...
typedef NS_ENUM(NSInteger, ABI13_0_0RCTTestStatus) {
  ABI13_0_0RCTTestStatusPending = 0,
  ABI13_0_0RCTTestStatusPassed,
  ABI13_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI13_0_0RCTTestModule : NSObject <ABI13_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI13_0_0RCTTestStatus status;
