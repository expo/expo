...
@interface ABI13_0_0RCTImageStoreManager : NSObject <ABI13_0_0RCTURLRequestHandler>
...
@interface ABI13_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI13_0_0RCTBridge (ABI13_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI13_0_0RCTImageStoreManager *imageStoreManager;
