...
#import "ABI13_0_0RCTLocalAssetImageLoader.h"

#import <libkern/OSAtomic.h>

#import <ReactABI13_0_0/ABI13_0_0RCTUtils.h>

@implementation ABI13_0_0RCTLocalAssetImageLoader

ABI13_0_0RCT_EXPORT_MODULE()

- (BOOL)canLoadImageURL:(NSURL *)requestURL
{
  return ABI13_0_0RCTIsLocalAssetURL(requestURL);
}
...
static NSBundle *bundleForPath(NSString *key)
{
 ...
 - (ABI13_0_0RCTImageLoaderCancellationBlock)loadImageForURL:(NSURL *)imageURL
                                               size:(CGSize)size
                                              scale:(CGFloat)scale
                                         resizeMode:(ABI13_0_0RCTResizeMode)resizeMode
                                    progressHandler:(ABI13_0_0RCTImageLoaderProgressBlock)progressHandler
                                 partialLoadHandler:(ABI13_0_0RCTImageLoaderPartialLoadBlock)partialLoadHandler
                                  completionHandler:(ABI13_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  ABI13_0_0RCTExecuteOnMainQueue(^{
    ...
    NSString *imageName = ABI13_0_0RCTBundlePathForURL(imageURL);
    ...
    if (image) {
      ...
      completionHandler(ABI13_0_0RCTErrorWithMessage(message), nil);
    }
  });
