...
typedef void (^ABI13_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI13_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI13_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI13_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI13_0_0RCTImageCache <NSObject>
...
@interface UIImage (ReactABI13_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI13_0_0KeyframeAnimation;

@end

@interface ABI13_0_0RCTImageLoader : NSObject <ABI13_0_0RCTBridgeModule, ABI13_0_0RCTURLRequestHandler>
 ...
 */
- (ABI13_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                           clipped:(BOOL)clipped
                                        resizeMode:(ABI13_0_0RCTResizeMode)resizeMode
 ...
 * decoded images as long as it conforms to the ABI13_0_0RCTImageCacheDelegate
...
@interface ABI13_0_0RCTBridge (ABI13_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI13_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI13_0_0RCTImageURLLoader <ABI13_0_0RCTBridgeModule>
...
/**
 * If more than one ABI13_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI13_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 * are also bridge modules, so should be registered using ABI13_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI13_0_0RCTImageDataDecoder <ABI13_0_0RCTBridgeModule>
...
/**
 * If more than one ABI13_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
