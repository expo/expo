...
#import "ABI13_0_0RCTPhotoLibraryImageLoader.h"

#import <Photos/Photos.h>

#import <ReactABI13_0_0/ABI13_0_0RCTUtils.h>

@implementation ABI13_0_0RCTPhotoLibraryImageLoader

ABI13_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI13_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI13_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI13_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI13_0_0RCTResizeModeContain) {
