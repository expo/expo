...
#import "ABI13_0_0RCTTextSelection.h"

@implementation ABI13_0_0RCTTextField
{
  ABI13_0_0RCTEventDispatcher *_eventDispatcher;
...
- (instancetype)initWithEventDispatcher:(ABI13_0_0RCTEventDispatcher *)eventDispatcher
{
  if ((self = [super initWithFrame:CGRectZero])) {
    ABI13_0_0RCTAssert(eventDispatcher, @"eventDispatcher is a required parameter");
...
{
  [_eventDispatcher sendTextEventWithType:ABI13_0_0RCTTextEventTypeKeyPress
...
- (void)setSelection:(ABI13_0_0RCTTextSelection *)selection
{
  if (!selection) {
    return;
  }
  ...
  } else if (eventLag > ABI13_0_0RCTTextUpdateLagWarningThreshold) {
    ABI13_0_0RCTLogWarn(@"Native TextInput(%@) is %zd events ahead of JS - try to make your JS faster.", self.text, eventLag);
  }
}
...
static void ABI13_0_0RCTUpdatePlaceholder(ABI13_0_0RCTTextField *self)
{
...
- (void)setPlaceholderTextColor:(UIColor *)placeholderTextColor
{
  ...
  ABI13_0_0RCTUpdatePlaceholder(self);
}
...
{
  _nativeEventCount++;
  [_eventDispatcher sendTextEventWithType:ABI13_0_0RCTTextEventTypeChange
                                 ReactABI13_0_0Tag:self.ReactABI13_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
{
  [_eventDispatcher sendTextEventWithType:ABI13_0_0RCTTextEventTypeEnd
                                 ReactABI13_0_0Tag:self.ReactABI13_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
{
  _submitted = YES;
  [_eventDispatcher sendTextEventWithType:ABI13_0_0RCTTextEventTypeSubmit
                                 ReactABI13_0_0Tag:self.ReactABI13_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
{
  [_eventDispatcher sendTextEventWithType:ABI13_0_0RCTTextEventTypeFocus
                                 ReactABI13_0_0Tag:self.ReactABI13_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (void)observeValueForKeyPath:(NSString *)keyPath
                      ofObject:(ABI13_0_0RCTTextField *)textField
...
- (BOOL)resignFirstResponder
{
  ...
  if (result)
  {
    [_eventDispatcher sendTextEventWithType:ABI13_0_0RCTTextEventTypeBlur
                                   ReactABI13_0_0Tag:self.ReactABI13_0_0Tag
                                       text:self.text
                                        key:nil
                                 eventCount:_nativeEventCount];
