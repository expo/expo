...
@implementation ABI13_0_0RCTSpringAnimation
{
  ...
  ABI13_0_0RCTResponseSenderBlock _callback;
                  ...
                  callBack:(nullable ABI13_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _toValue = [ABI13_0_0RCTConvert CGFloat:config[@"toValue"]];
    _fromValue = valueNode.value;
    _valueNode = valueNode;
    _overshootClamping = [ABI13_0_0RCTConvert BOOL:config[@"overshootClamping"]];
    _restDisplacementThreshold = [ABI13_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
    _restSpeedThreshold = [ABI13_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
    _tension = [ABI13_0_0RCTConvert CGFloat:config[@"tension"]];
    _friction = [ABI13_0_0RCTConvert CGFloat:config[@"friction"]];
