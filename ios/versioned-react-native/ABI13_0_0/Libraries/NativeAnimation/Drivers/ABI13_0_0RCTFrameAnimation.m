...
@interface ABI13_0_0RCTFrameAnimation ()
...
@implementation ABI13_0_0RCTFrameAnimation
{
...
{
  if ((self = [super init])) {
    NSNumber *toValue = [ABI13_0_0RCTConvert NSNumber:config[@"toValue"]] ?: @1;
    NSTimeInterval delay = [ABI13_0_0RCTConvert double:config[@"delay"]];
    NSArray<NSNumber *> *frames = [ABI13_0_0RCTConvert NSNumberArray:config[@"frames"]];
...
- (void)stepAnimation
{
  ...
  CGFloat frameOutput = ABI13_0_0RCTInterpolateValue(currentDuration,
                                            fromInterval,
                                            toInterval,
                                            fromFrameValue.doubleValue,
                                            toFrameValue.doubleValue,
                                            ABI13_0_0EXTRAPOLATE_TYPE_EXTEND,
                                            ABI13_0_0EXTRAPOLATE_TYPE_EXTEND);
...
{
  CGFloat outputValue = ABI13_0_0RCTInterpolateValue(frameOutput,
                                            0,
                                            1,
                                            _fromValue,
                                            _toValue,
