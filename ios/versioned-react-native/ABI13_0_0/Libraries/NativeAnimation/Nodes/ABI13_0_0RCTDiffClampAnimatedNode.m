...
@implementation ABI13_0_0RCTDiffClampAnimatedNode
{
...
{
  ABI13_0_0RCTValueAnimatedNode *inputNode = (ABI13_0_0RCTValueAnimatedNode *)self.parentNodes[_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI13_0_0RCTValueAnimatedNode class]]) {
    ABI13_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
