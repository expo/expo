...
@implementation ABI13_0_0RCTInterpolationAnimatedNode
{
  __weak ABI13_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI13_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI13_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI13_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI13_0_0RCTInterpolateValue(inputValue,
