...
#import "ABI13_0_0RCTMultipartStreamReader.h"

#define CRLF @"\r\n"

@implementation ABI13_0_0RCTMultipartStreamReader {
...
- (void)emitChunk:(NSData *)data callback:(ABI13_0_0RCTMultipartCallback)callback done:(BOOL)done
{
...
- (BOOL)readAllParts:(ABI13_0_0RCTMultipartCallback)callback
{
