 ...
 */
@interface ABI13_0_0RCTImageSource : NSObject
...
@interface ABI13_0_0RCTConvert (ImageSource)

+ (ABI13_0_0RCTImageSource *)ABI13_0_0RCTImageSource:(id)json;
+ (NSArray<ABI13_0_0RCTImageSource *> *)ABI13_0_0RCTImageSourceArray:(id)json;
