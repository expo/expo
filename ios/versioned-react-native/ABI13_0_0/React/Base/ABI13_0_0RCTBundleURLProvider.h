...
extern NSString *const ABI13_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI13_0_0RCTBundleURLProviderDefaultPort;

@interface ABI13_0_0RCTBundleURLProvider : NSObject
