...
@interface ABI13_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI13_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI13_0_0RCTMultipartDataTaskCallback _partHandler;
...
- (instancetype)initWithURL:(NSURL *)url partHandler:(ABI13_0_0RCTMultipartDataTaskCallback)partHandler
{
  if (self = [super init]) {
    _url = url;
...
{
  ABI13_0_0RCTMultipartStreamReader *reader = [[ABI13_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI13_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
