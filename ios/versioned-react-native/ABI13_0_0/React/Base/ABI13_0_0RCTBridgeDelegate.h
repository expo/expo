...
#import <ReactABI13_0_0/ABI13_0_0RCTJavaScriptLoader.h>

@class ABI13_0_0RCTBridge;
@protocol ABI13_0_0RCTBridgeModule;

@protocol ABI13_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI13_0_0RCTBridge *)bridge;
 ...
 */
- (NSURL *)fallbackSourceURLForBridge:(ABI13_0_0RCTBridge *)bridge;

/**
 * The bridge initializes any registered ABI13_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI13_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI13_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (NSArray<Class> *)whitelistedModulesForBridge:(ABI13_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeLoadJavaScriptSynchronously:(ABI13_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeInitializeNativeModulesSynchronously:(ABI13_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI13_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI13_0_0RCTBridge *)bridge;
 ...
 */
- (void)loadSourceForBridge:(ABI13_0_0RCTBridge *)bridge
                 onProgress:(ABI13_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI13_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI13_0_0RCTBridge *)bridge
                  withBlock:(ABI13_0_0RCTSourceLoadBlock)loadCallback;
