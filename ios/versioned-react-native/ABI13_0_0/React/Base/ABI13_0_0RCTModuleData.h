...
@interface ABI13_0_0RCTModuleData : NSObject <ABI13_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI13_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI13_0_0RCTBridgeModule> instance;
