...
@protocol ABI13_0_0RCTRootViewDelegate;
 ...
 * rootViewDidChangeIntrinsicSize method of the ABI13_0_0RCTRootViewDelegate will be called.
 */
typedef NS_ENUM(NSInteger, ABI13_0_0RCTRootViewSizeFlexibility) {
  ABI13_0_0RCTRootViewSizeFlexibilityNone = 0,
  ABI13_0_0RCTRootViewSizeFlexibilityWidth,
  ABI13_0_0RCTRootViewSizeFlexibilityHeight,
  ABI13_0_0RCTRootViewSizeFlexibilityWidthAndHeight,
};
 ...
 */
extern NSString *const ABI13_0_0RCTContentDidAppearNotification;

/**
 * Native view used to host ReactABI13_0_0-managed views within the app. Can be used just
 * like any ordinary UIView. You can have multiple ABI13_0_0RCTRootViews on screen at
 * once, all controlled by the same JavaScript application.
 */
@interface ABI13_0_0RCTRootView : UIView
 ...
 * This initializer is intended to be used when the app has a single ABI13_0_0RCTRootView,
 * otherwise create an `ABI13_0_0RCTBridge` and pass it in via `initWithBridge:moduleName:`
 ...
 * root views, so you can use this property to initialize another ABI13_0_0RCTRootView.
 */
@property (nonatomic, strong, readonly) ABI13_0_0RCTBridge *bridge;
 ...
 */
@property (nonatomic, assign) ABI13_0_0RCTRootViewSizeFlexibility sizeFlexibility;

/**
 * The size of the root view's content. This is set right before the
 * rootViewDidChangeIntrinsicSize method of ABI13_0_0RCTRootViewDelegate is called.
 */
 ...
 */
@property (nonatomic, weak) id<ABI13_0_0RCTRootViewDelegate> delegate;

/**
 * The backing view controller of the root view.
 */
@property (nonatomic, weak) UIViewController *ReactABI13_0_0ViewController;

/**
 * The ReactABI13_0_0-managed contents view of the root view.
 */
...
/**
 * When set, any touches on the ABI13_0_0RCTRootView that are not matched up to any of the child
 * views will be passed to siblings of the ABI13_0_0RCTRootView. See -[UIView hitTest:withEvent:]
