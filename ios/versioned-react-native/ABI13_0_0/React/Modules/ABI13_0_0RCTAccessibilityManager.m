...
NSString *const ABI13_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification = @"ABI13_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification";

@interface ABI13_0_0RCTAccessibilityManager ()
...
@implementation ABI13_0_0RCTAccessibilityManager
...
- (void)invalidateMultiplier
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI13_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification object:self];
}
...
- (CGFloat)multiplierForContentSizeCategory:(NSString *)category
{
  ...
  if (m.doubleValue <= 0.0) {
    ABI13_0_0RCTLogError(@"Can't determinte multiplier for category %@. Using 1.0.", category);
    m = @1.0;
  }
...
ABI13_0_0RCT_EXPORT_METHOD(setAccessibilityContentSizeMultipliers:(NSDictionary *)JSMultipliers)
{
  ...
  for (NSString *__nonnull JSCategory in JSMultipliers) {
    NSNumber *m = [ABI13_0_0RCTConvert NSNumber:JSMultipliers[JSCategory]];
...
ABI13_0_0RCT_EXPORT_METHOD(getMultiplier:(ABI13_0_0RCTResponseSenderBlock)callback)
{
  if (callback) {
...
ABI13_0_0RCT_EXPORT_METHOD(getCurrentVoiceOverState:(ABI13_0_0RCTResponseSenderBlock)callback
...
@implementation ABI13_0_0RCTBridge (ABI13_0_0RCTAccessibilityManager)

- (ABI13_0_0RCTAccessibilityManager *)accessibilityManager
{
  return [self moduleForClass:[ABI13_0_0RCTAccessibilityManager class]];
}
