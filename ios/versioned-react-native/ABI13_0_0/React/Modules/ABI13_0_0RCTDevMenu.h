 ...
 */
@interface ABI13_0_0RCTDevMenu : NSObject

/**
 * Is the menu enabled. The menu is enabled by default if ABI13_0_0RCT_DEV=1, but
 ...
 */
@property (nonatomic, copy, readonly) NSArray<ABI13_0_0RCTDevMenuItem *> *presentedItems;
 ...
 */
@interface ABI13_0_0RCTDevMenuItem : NSObject
 ...
 * ABI13_0_0RCTBridge, which is useful for any class that needs to access the menu.
 */
@interface ABI13_0_0RCTBridge (ABI13_0_0RCTDevMenu)

@property (nonatomic, readonly) ABI13_0_0RCTDevMenu *devMenu;
