...
static const CGFloat ABI13_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI13_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return
  ABS(borderInsets.left - borderInsets.right) < ABI13_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.bottom) < ABI13_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.top) < ABI13_0_0RCTViewBorderThreshold;
}

BOOL ABI13_0_0RCTCornerRadiiAreEqual(ABI13_0_0RCTCornerRadii cornerRadii)
{
  return
  ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI13_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI13_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI13_0_0RCTViewBorderThreshold;
}

BOOL ABI13_0_0RCTBorderColorsAreEqual(ABI13_0_0RCTBorderColors borderColors)
{
  return
...
ABI13_0_0RCTCornerInsets ABI13_0_0RCTGetCornerInsets(ABI13_0_0RCTCornerRadii cornerRadii,
                                   UIEdgeInsets edgeInsets)
{
  return (ABI13_0_0RCTCornerInsets) {
    {
...
static void ABI13_0_0RCTPathAddEllipticArc(CGMutablePathRef path,
...
CGPathRef ABI13_0_0RCTPathCreateWithRoundedRect(CGRect bounds,
                                       ABI13_0_0RCTCornerInsets cornerInsets,
                                       const CGAffineTransform *transform)
{
  ...
  ABI13_0_0RCTPathAddEllipticArc(path, transform, (CGPoint){
...
static void ABI13_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds,
                                               CGPoint lineStart,
                                               CGPoint lineEnd,
...
NS_INLINE BOOL ABI13_0_0RCTCornerRadiiAreAboveThreshold(ABI13_0_0RCTCornerRadii cornerRadii) {
  return (cornerRadii.topLeft > ABI13_0_0RCTViewBorderThreshold ||
    cornerRadii.topRight > ABI13_0_0RCTViewBorderThreshold      ||
    cornerRadii.bottomLeft > ABI13_0_0RCTViewBorderThreshold    ||
    cornerRadii.bottomRight > ABI13_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI13_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI13_0_0RCTCornerRadii cornerRadii) {
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI13_0_0RCTPathCreateWithRoundedRect(rect, ABI13_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef ABI13_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge) {
...
static UIImage *ABI13_0_0RCTGetSolidBorderImage(ABI13_0_0RCTCornerRadii cornerRadii,
                                       CGSize viewSize,
                                       ...
                                       BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI13_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI13_0_0RCTCornerInsets cornerInsets = ABI13_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  CGContextRef ctx = ABI13_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI13_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI13_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI13_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI13_0_0RCTEllipseGetIntersectionsWithLine((CGRect){
...
static UIImage *ABI13_0_0RCTGetDashedOrDottedBorderImage(ABI13_0_0RCTBorderStyle borderStyle,
                                                ...
                                                BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI13_0_0RCTBorderStyleDashed || borderStyle == ABI13_0_0RCTBorderStyleDotted);

  if (!ABI13_0_0RCTBorderColorsAreEqual(borderColors) || !ABI13_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI13_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI13_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI13_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI13_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI13_0_0RCTPathCreateWithRoundedRect(pathRect, ABI13_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI13_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
...
UIImage *ABI13_0_0RCTGetBorderImage(ABI13_0_0RCTBorderStyle borderStyle,
                           CGSize viewSize,
                           ABI13_0_0RCTCornerRadii cornerRadii,
                           UIEdgeInsets borderInsets,
                           ABI13_0_0RCTBorderColors borderColors,
                           ...
                           BOOL drawToEdge)
{
  ...
  switch (borderStyle) {
    case ABI13_0_0RCTBorderStyleSolid:
      return ABI13_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI13_0_0RCTBorderStyleDashed:
    case ABI13_0_0RCTBorderStyleDotted:
      return ABI13_0_0RCTGetDashedOrDottedBorderImage(borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI13_0_0RCTBorderStyleUnset:
      break;
  }
