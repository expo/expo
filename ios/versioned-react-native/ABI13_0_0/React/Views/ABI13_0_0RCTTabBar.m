...
@interface ABI13_0_0RCTTabBar() <UITabBarControllerDelegate>

@end

@implementation ABI13_0_0RCTTabBar
{
  BOOL _tabsChanged;
...
- (void)insertReactABI13_0_0Subview:(ABI13_0_0RCTTabBarItem *)subview atIndex:(NSInteger)atIndex
{
  if (![subview isKindOfClass:[ABI13_0_0RCTTabBarItem class]]) {
    ABI13_0_0RCTLogError(@"subview should be of type ABI13_0_0RCTTabBarItem");
    return;
  }
...
- (void)removeReactABI13_0_0Subview:(ABI13_0_0RCTTabBarItem *)subview
{
  if (self.ReactABI13_0_0Subviews.count == 0) {
    ABI13_0_0RCTLogError(@"should have at least one view to remove a subview");
    return;
  }
...
- (void)layoutSubviews
{
  ...
  [self ReactABI13_0_0AddControllerToClosestParent:_tabController];
...
- (void)ReactABI13_0_0BridgeDidFinishTransaction
{
  ...
  if (_tabsChanged) {
    ...
    for (ABI13_0_0RCTTabBarItem *tab in [self ReactABI13_0_0Subviews]) {
      UIViewController *controller = tab.ReactABI13_0_0ViewController;
      if (!controller) {
        controller = [[ABI13_0_0RCTWrapperViewController alloc] initWithContentView:tab];
      }
  ...
  [self.ReactABI13_0_0Subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger index, __unused BOOL *stop) {

    ABI13_0_0RCTTabBarItem *tab = (ABI13_0_0RCTTabBarItem *)view;
...
- (BOOL)tabBarController:(UITabBarController *)tabBarController shouldSelectViewController:(UIViewController *)viewController
{
  ...
  ABI13_0_0RCTTabBarItem *tab = (ABI13_0_0RCTTabBarItem *)self.ReactABI13_0_0Subviews[index];
