...
@implementation ABI13_0_0RCTConvert(MapKit)
...
ABI13_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
{
  json = [self NSDictionary:json];
  ABI13_0_0RCTMapAnnotation *annotation = [ABI13_0_0RCTMapAnnotation new];
...
ABI13_0_0RCT_ARRAY_CONVERTER(ABI13_0_0RCTMapAnnotation)
...
+ (ABI13_0_0RCTMapOverlay *)ABI13_0_0RCTMapOverlay:(id)json
{
  ...
  ABI13_0_0RCTMapOverlay *overlay = [ABI13_0_0RCTMapOverlay polylineWithCoordinates:coordinates
...
ABI13_0_0RCT_ARRAY_CONVERTER(ABI13_0_0RCTMapOverlay)
