...
@implementation ABI13_0_0RCTConvert (UITabBarSystemItem)

ABI13_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI13_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI13_0_0ViewController;
}
