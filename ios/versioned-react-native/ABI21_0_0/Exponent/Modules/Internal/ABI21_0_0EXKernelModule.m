...
@interface ABI21_0_0EXKernelModule ()
...
@property (nonatomic, weak) id<ABI21_0_0EXKernelModuleDelegate> delegate;


@end

@implementation ABI21_0_0EXKernelModule
...
- (void)sendEventWithName:(NSString *)eventName body:(id)body
{
  ...
  [self.bridge enqueueJSCall:@"ABI21_0_0RCTDeviceEventEmitter.emit"
...
ABI21_0_0RCT_REMAP_METHOD(doesCurrentTaskEnableDevtools,
                 doesCurrentTaskEnableDevtoolsWithResolver:(ABI21_0_0RCTPromiseResolveBlock)resolve
...
ABI21_0_0RCT_REMAP_METHOD(shouldCurrentTaskAutoReload,
                 shouldCurrentTaskAutoReloadWithResolver:(ABI21_0_0RCTPromiseResolveBlock)resolve
                 reject:(ABI21_0_0RCTPromiseRejectBlock)reject)
{
  if (_delegate) {
...
ABI21_0_0RCT_REMAP_METHOD(isLegacyMenuBehaviorEnabledAsync,
                 isLegacyMenuBehaviorEnabledWithResolver:(ABI21_0_0RCTPromiseResolveBlock)resolve
...
ABI21_0_0RCT_EXPORT_METHOD(setIsLegacyMenuBehaviorEnabledAsync:(BOOL)isEnabled)
{
  if (_delegate) {
...
ABI21_0_0RCT_REMAP_METHOD(getDevMenuItemsToShow,
                 getDevMenuItemsToShowWithResolver:(ABI21_0_0RCTPromiseResolveBlock)resolve
                 reject:(ABI21_0_0RCTPromiseRejectBlock)reject)
{
...
ABI21_0_0RCT_EXPORT_METHOD(selectDevMenuItemWithKey:(NSString *)key)
{
  if (_delegate) {
...
ABI21_0_0RCT_EXPORT_METHOD(addDevMenu)
{
...
ABI21_0_0RCT_REMAP_METHOD(routeDidForeground,
...
ABI21_0_0RCT_EXPORT_METHOD(onLoaded)
{
  [[NSNotificationCenter defaultCenter] postNotificationName:@"EXKernelJSIsLoadedNotification" object:self];
}

ABI21_0_0RCT_EXPORT_METHOD(splashLoadingDidDisplay)
{
  [[NSNotificationCenter defaultCenter] postNotificationName:@"EXKernelSplashLoadingDidDisplay" object:self];
}

ABI21_0_0RCT_REMAP_METHOD(getManifestAsync,
...
ABI21_0_0RCT_REMAP_METHOD(onEventSuccess,
...
ABI21_0_0RCT_REMAP_METHOD(onEventFailure,
                 eventId:(NSString *)eventId
