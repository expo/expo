...
@implementation ABI21_0_0EXFrameExceptionsManager {
  __weak id<ABI21_0_0RCTExceptionsManagerDelegate> _delegate;
}

@synthesize bridge = _bridge;

+ (NSString *)moduleName { return @"ABI21_0_0RCTExceptionsManager"; }
...
{
  // this will hit ABI21_0_0EXDisabledRedBox when not debugging
