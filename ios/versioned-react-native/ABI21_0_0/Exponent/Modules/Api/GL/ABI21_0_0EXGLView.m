...
- (NSDictionary *)startARSession
{
  ...
  // Create camera texture outpout ABI21_0_0EXGLObject
...
- (NSDictionary *)arMatricesForViewportSize:(CGSize)viewportSize zNear:(CGFloat)zNear zFar:(CGFloat)zFar
{
  ...
  return @{
    @"transform": [ABI21_0_0EXGLView nsArrayForMatrix:transform],
    @"viewMatrix": [ABI21_0_0EXGLView nsArrayForMatrix:viewMat],
    @"projectionMatrix": [ABI21_0_0EXGLView nsArrayForMatrix:projMat],
  };
}
