...
@implementation ABI21_0_0RNSVGCircle
...
- (CGPathRef)getPath:(CGContextRef)context
{
    ...
    if ([ABI21_0_0RNSVGPercentageConverter isPercentage:self.r]) {
        CGFloat radiusPercent = [ABI21_0_0RNSVGPercentageConverter percentageToFloat:self.r relative:1 offset:0];
