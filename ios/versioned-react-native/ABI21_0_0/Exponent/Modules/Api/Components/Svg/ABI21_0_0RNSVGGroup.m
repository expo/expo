...
@implementation ABI21_0_0RNSVGGroup
...
- (void)renderGroupTo:(CGContextRef)context
{
    ...
    [self traverseSubviews:^(ABI21_0_0RNSVGNode *node) {
        ...
        if ([node isKindOfClass:[ABI21_0_0RNSVGRenderable class]]) {
            [(ABI21_0_0RNSVGRenderable*)node mergeProperties:self];
        }
        
        [node renderTo:context];
        
        if ([node isKindOfClass:[ABI21_0_0RNSVGRenderable class]]) {
            [(ABI21_0_0RNSVGRenderable*)node resetProperties];
        }
...
- (void)parseReference
{
    ...
    [self traverseSubviews:^(__kindof ABI21_0_0RNSVGNode *node) {
        [node parseReference];
        return YES;
    }];
}
