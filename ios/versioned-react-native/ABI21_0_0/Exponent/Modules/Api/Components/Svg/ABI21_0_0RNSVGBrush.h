...
#import "ABI21_0_0RNSVGPainter.h"

@interface ABI21_0_0RNSVGBrush : NSObject
 ...
 * @abstract
 */
- (void)paint:(CGContextRef)context opacity:(CGFloat)opacity painter:(ABI21_0_0RNSVGPainter *)painter;
