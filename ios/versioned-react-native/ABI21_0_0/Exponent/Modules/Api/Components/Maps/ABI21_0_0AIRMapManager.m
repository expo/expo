...
#import "ABI21_0_0AIRMapManager.h"
...
#import "ABI21_0_0AIRMapSnapshot.h"
...
@interface ABI21_0_0AIRMapManager() <MKMapViewDelegate>

@end

@implementation ABI21_0_0AIRMapManager

ABI21_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI21_0_0AIRMap *map = [ABI21_0_0AIRMap new];
    map.delegate = self;
...
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(userLocationAnnotationTitle, NSString)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(showsPointsOfInterest, BOOL)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
...
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(cacheEnabled, BOOL)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(maxDelta, CGFloat)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(minDelta, CGFloat)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(legalLabelInsets, UIEdgeInsets)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, MKMapType)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(onChange, ABI21_0_0RCTBubblingEventBlock)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(onPanDrag, ABI21_0_0RCTBubblingEventBlock)
...
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI21_0_0RCTDirectEventBlock)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI21_0_0RCTDirectEventBlock)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI21_0_0RCTDirectEventBlock)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI21_0_0RCTDirectEventBlock)
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI21_0_0RCTDirectEventBlock)
...
ABI21_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI21_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setRegion:[ABI21_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI21_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI21_0_0AIRMap class]]) {
            ABI21_0_0RCTLogError(@"Invalid view returned from registry, expecting ABI21_0_0AIRMap, got: %@", view);
        } else {
            [ABI21_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI21_0_0AIRMap *)view setRegion:region animated:YES];
            }];
        }
    }];
}
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI21_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI21_0_0AIRMap class]]) {
            ...
            ABI21_0_0AIRMap *mapView = (ABI21_0_0AIRMap *)view;
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI21_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI21_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ABI21_0_0AIRMapMarker *marker = (ABI21_0_0AIRMapMarker *)evaluatedObject;
                return [marker isKindOfClass:[ABI21_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
...
- (void)takeMapSnapshot:(ABI21_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI21_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI21_0_0AIRMap *map = (ABI21_0_0AIRMap *)recognizer.view;
    ...
    ABI21_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI21_0_0AIRMapPolygon class]]){
            ABI21_0_0AIRMapPolygon *polygon = (ABI21_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI21_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI21_0_0AIRMapPolyline class]]){
            ABI21_0_0AIRMapPolyline *polyline = (ABI21_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI21_0_0AIRMapPolyline class]]) {
        return ((ABI21_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI21_0_0AIRMapPolygon class]]) {
        return ((ABI21_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI21_0_0AIRMapCircle class]]) {
        return ((ABI21_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI21_0_0AIRMapUrlTile class]]) {
        return ((ABI21_0_0AIRMapUrlTile *)overlay).renderer;
    } else {
        return nil;
    }
}
...
- (void)mapView:(ABI21_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI21_0_0AIRMapMarker class]]) {
        [(ABI21_0_0AIRMapMarker *)view.annotation showCalloutView];
...
- (void)mapView:(ABI21_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI21_0_0AIRMapMarker class]]) {
        [(ABI21_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI21_0_0AIRMap *)mapView viewForAnnotation:(ABI21_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI21_0_0AIRMapMarker class]]) {
...
- (void)mapView:(ABI21_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI21_0_0AIRMapMarker class]]) return;
    ABI21_0_0AIRMapMarker *marker = (ABI21_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI21_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI21_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI21_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI21_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI21_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    [self _regionChanged:mapView];

    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI21_0_0AIRMapRegionChangeObserveInterval
                                                               target:self
                                                             selector:@selector(_onTick:)
                                                             userInfo:@{ ABI21_0_0RCTMapViewKey: mapView }
                                                              repeats:YES];

    [[NSRunLoop mainRunLoop] addTimer:mapView.regionChangeObserveTimer forMode:NSRunLoopCommonModes];
}

- (void)mapView:(ABI21_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI21_0_0AIRMap *)mapView
{
...
- (void)mapViewDidFinishRenderingMap:(ABI21_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
{
    [self _regionChanged:timer.userInfo[ABI21_0_0RCTMapViewKey]];
}

- (void)_regionChanged:(ABI21_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI21_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI21_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI21_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI21_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI21_0_0AIRMap *)mapView
{
