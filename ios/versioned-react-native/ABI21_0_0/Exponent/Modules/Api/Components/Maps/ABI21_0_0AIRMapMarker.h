...
@interface ABI21_0_0AIRMapMarker : MKAnnotationView <MKAnnotation>

@property (nonatomic, strong) ABI21_0_0AIRMapCallout *calloutView;
...
@property (nonatomic, copy) ABI21_0_0RCTDirectEventBlock onSelect;
@property (nonatomic, copy) ABI21_0_0RCTDirectEventBlock onDeselect;
...
@interface ABI21_0_0AIREmptyCalloutBackgroundView : ABI21_0_0SMCalloutBackgroundView
@end
