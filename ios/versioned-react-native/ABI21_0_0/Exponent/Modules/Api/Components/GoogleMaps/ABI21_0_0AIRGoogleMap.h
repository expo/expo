...
@interface ABI21_0_0AIRGoogleMap : GMSMapView
...
@property (nonatomic, copy) ABI21_0_0RCTBubblingEventBlock onMarkerPress;
...
@property (nonatomic, copy) ABI21_0_0RCTDirectEventBlock onRegionChangeComplete;
