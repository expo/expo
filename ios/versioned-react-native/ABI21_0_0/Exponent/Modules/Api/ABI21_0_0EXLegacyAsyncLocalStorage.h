...
// Read-only access to legacy (unscoped) `ABI21_0_0RCTAsyncLocalStorage` backing for
 ...
 * being atomic, unless someone bypasses the `ABI21_0_0RCTAsyncLocalStorage` API.
 *
 * Keys and values must always be strings or an error is returned.
 */
@interface ABI21_0_0EXLegacyAsyncLocalStorage : NSObject <ABI21_0_0RCTBridgeModule,ABI21_0_0RCTInvalidating>
