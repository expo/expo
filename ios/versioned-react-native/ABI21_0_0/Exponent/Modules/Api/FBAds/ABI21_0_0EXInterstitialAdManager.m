#import "ABI21_0_0EXInterstitialAdManager.h"
#import "ABI21_0_0EXUnversioned.h"

#import <FBAudienceNetwork/FBAudienceNetwork.h>
#import <ReactABI21_0_0/ABI21_0_0RCTUtils.h>

@interface ABI21_0_0EXInterstitialAdManager () <FBInterstitialAdDelegate>
...
@implementation ABI21_0_0EXInterstitialAdManager

@synthesize bridge = _bridge;

ABI21_0_0RCT_EXPORT_MODULE(CTKInterstitialAdManager)
...
{
  ABI21_0_0RCTAssert(_resolve == nil && _reject == nil, @"Only one `showAd` can be called at once");
  ABI21_0_0RCTAssert(_isBackground == false, @"`showAd` can be called only when experience is running in foreground");
...
{
  [_interstitialAd showAdFromRootViewController:ABI21_0_0RCTPresentedViewController()];
}
...
- (void)bridgeDidForeground:(NSNotification *)notification
{
  ...
  if (_adViewController) {
    [ABI21_0_0RCTPresentedViewController() presentViewController:_adViewController animated:NO completion:nil];
...
- (void)bridgeDidBackground:(NSNotification *)notification
{
  ...
  if (_interstitialAd) {
    _adViewController = ABI21_0_0RCTPresentedViewController();
