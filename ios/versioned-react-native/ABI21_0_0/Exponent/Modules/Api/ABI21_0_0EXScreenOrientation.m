...
#import "ABI21_0_0EXScreenOrientation.h"
#import "ABI21_0_0EXScopedModuleRegistry.h"

#import <UIKit/UIKit.h>

@interface ABI21_0_0EXScreenOrientation ()

@property (nonatomic, weak) id kernelOrientationServiceDelegate;

@end

@implementation ABI21_0_0EXScreenOrientation

ABI21_0_0EX_EXPORT_SCOPED_MODULE(ExponentScreenOrientation, ScreenOrientationManager);
...
ABI21_0_0RCT_EXPORT_METHOD(allow:(NSString *)orientation)
{
