...
ABI21_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI21_0_0EXConstants, constants)

@import UIKit.UIApplication;

@interface ABI21_0_0EXConstants ()
...
@implementation ABI21_0_0EXConstants

ABI21_0_0EX_EXPORT_SCOPED_MODULE(ExponentConstants, nil)
...
{
  NSString *expoClientVersion = [[[NSBundle mainBundle] infoDictionary] objectForKey:@"ABI21_0_0EXClientVersion"];
...
ABI21_0_0RCT_REMAP_METHOD(getWebViewUserAgentAsync,
                 getWebViewUserAgentWithResolver:(ABI21_0_0RCTPromiseResolveBlock)resolve
