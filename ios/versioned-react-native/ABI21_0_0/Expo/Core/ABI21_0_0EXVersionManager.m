...
static NSMutableDictionary<NSString *, NSDictionary *> *ABI21_0_0EXScopedModuleClasses;
void ABI21_0_0EXRegisterScopedModule(Class, ...);
void ABI21_0_0EXRegisterScopedModule(Class moduleClass, ...)
{
  ...
  while ((kernelServiceClassName = va_arg(argumentList, NSString*))) {
    if ([kernelServiceClassName isEqualToString:@"nil"]) {
      unversionedKernelServiceClassNames[kernelServiceClassName] = ABI21_0_0EX_KERNEL_SERVICE_NONE;
    } else {
  ...
  if (moduleClassName) {
    ABI21_0_0EXScopedModuleClasses[moduleClassName] = unversionedKernelServiceClassNames;
  }
}
...
- (NSArray *)_newScopedModulesWithExperienceId: (NSString *)experienceId services:(NSDictionary *)services params:(NSDictionary *)params
{
  ...
  if (ABI21_0_0EXScopedModuleClasses) {
    [ABI21_0_0EXScopedModuleClasses enumerateKeysAndObjectsUsingBlock:^(NSString * _Nonnull scopedModuleClassName, NSDictionary * _Nonnull kernelServiceClassNames, BOOL * _Nonnull stop) {
      ...
      for (id kernelServiceClassName in kernelServiceClassNames) {
        ...
        id service = ([kernelSerivceName isEqualToString:ABI21_0_0EX_KERNEL_SERVICE_NONE]) ? [NSNull null] : services[kernelSerivceName];
