...
ABI21_0_0RCT_EXTERN void ABI21_0_0EXRegisterScopedModule(Class, ...); \
+ (NSString *)moduleName { return @#js_name; } \
+ (void)load { ABI21_0_0EXRegisterScopedModule(self, @#kernel_service_class, nil); }
 ...
 *         e.g. @"MyKernelService" -> an instance of EXMyKernelService
 */
#define ABI21_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(js_name, ...) \
ABI21_0_0RCT_EXTERN void ABI21_0_0EXRegisterScopedModule(Class, ...); \
+ (NSString *)moduleName { return @#js_name; } \
+ (void)load { ABI21_0_0EXRegisterScopedModule(self, __VA_ARGS__, nil); }
