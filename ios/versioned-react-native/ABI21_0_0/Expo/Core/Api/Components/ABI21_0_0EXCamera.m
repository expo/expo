...
@interface ABI21_0_0EXCamera ()

@property (nonatomic, weak) ABI21_0_0EXCameraManager *manager;
@property (nonatomic, weak) ABI21_0_0RCTBridge *bridge;
@property (nonatomic, copy) ABI21_0_0RCTDirectEventBlock onCameraReady;

@end

@implementation ABI21_0_0EXCamera
