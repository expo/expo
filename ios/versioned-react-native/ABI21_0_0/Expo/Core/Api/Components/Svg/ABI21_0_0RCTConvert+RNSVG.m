...
#import "ABI21_0_0RNSVGPainterBrush.h"
#import "ABI21_0_0RNSVGSolidColorBrush.h"
#import <ReactABI21_0_0/ABI21_0_0RCTLog.h>
#import <ReactABI21_0_0/ABI21_0_0RCTFont.h>

@implementation ABI21_0_0RCTConvert (ABI21_0_0RNSVG)

ABI21_0_0RCT_ENUM_CONVERTER(ABI21_0_0RNSVGCGFCRule, (@{
                                     @"evenodd": @(kRNSVGCGFCRuleEvenodd),
                                     @"nonzero": @(kRNSVGCGFCRuleNonzero),
                                     }), kRNSVGCGFCRuleNonzero, intValue)

ABI21_0_0RCT_ENUM_CONVERTER(ABI21_0_0RNSVGVBMOS, (@{
                                  @"meet": @(kRNSVGVBMOSMeet),
                                  @"slice": @(kRNSVGVBMOSSlice),
                                  @"none": @(kRNSVGVBMOSNone)
                                  }), kRNSVGVBMOSMeet, intValue)

ABI21_0_0RCT_ENUM_CONVERTER(ABI21_0_0RNSVGTextAnchor, (@{
...
ABI21_0_0RCT_ENUM_CONVERTER(ABI21_0_0RNSVGUnits, (@{
...
+ (ABI21_0_0RNSVGCGFloatArray)ABI21_0_0RNSVGCGFloatArray:(id)json
{
    ...
    ABI21_0_0RNSVGCGFloatArray array;
    array.count = count;
    array.array = nil;
...
+ (ABI21_0_0RNSVGBrush *)ABI21_0_0RNSVGBrush:(id)json
{
    ...
    switch (type) {
        case 0: // solid color
            ...
            return [[ABI21_0_0RNSVGSolidColorBrush alloc] initWithArray:arr];
        case 1: // brush
            return [[ABI21_0_0RNSVGPainterBrush alloc] initWithArray:arr];
        default:
            ABI21_0_0RCTLogError(@"Unknown brush type: %zd", type);
            return nil;
    }
}
...
{
    return [[ABI21_0_0RNSVGPathParser alloc] initWithPathString: d];
}
...
+ (CGRect)ABI21_0_0RNSVGCGRect:(id)json offset:(NSUInteger)offset
{
    ...
    if (arr.count < offset + 4) {
        ABI21_0_0RCTLogError(@"Too few elements in array (expected at least %zd): %@", 4 + offset, arr);
        return CGRectZero;
    }
    return (CGRect){
...
+ (CGGradientRef)ABI21_0_0RNSVGCGGradient:(id)json offset:(NSUInteger)offset
{
    NSArray *arr = [self NSArray:json];
    if (arr.count < offset) {
        ABI21_0_0RCTLogError(@"Too few elements in array (expected at least %zd): %@", offset, arr);
        return nil;
    }
    arr = [arr subarrayWithRange:(NSRange){offset, arr.count - offset}];
    ABI21_0_0RNSVGCGFloatArray colorsAndOffsets = [self ABI21_0_0RNSVGCGFloatArray:arr];
