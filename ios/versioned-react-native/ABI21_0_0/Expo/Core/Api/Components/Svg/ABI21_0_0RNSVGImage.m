...
#import <ReactABI21_0_0/ABI21_0_0RCTImageSource.h>
#import <ReactABI21_0_0/ABI21_0_0RCTLog.h>
#import "ABI21_0_0RNSVGViewBox.h"

@implementation ABI21_0_0RNSVGImage
{
    CGImageRef _image;
    CGFloat _imageRatio;
}
...
- (void)setSrc:(id)src
{
    ...
    ABI21_0_0RCTImageSource *source = [ABI21_0_0RCTConvert ABI21_0_0RCTImageSource:src];
    ...
    _image = CGImageRetain([ABI21_0_0RCTConvert CGImage:src]);
    [self invalidate];
}
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    CGAffineTransform transform = [ABI21_0_0RNSVGViewBox getTransform:vbRect eRect:eRect align:self.align meetOrSlice:self.meetOrSlice fromSymbol:NO];
