...
@interface ABI21_0_0RNSVGSvgView : UIView <ABI21_0_0RNSVGContainer>
...
- (void)defineTemplate:(__kindof ABI21_0_0RNSVGNode *)template templateName:(NSString *)templateName;
