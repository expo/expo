...
#if __has_include(<ReactABI21_0_0/UIView+ReactABI21_0_0.h>)
#import <ReactABI21_0_0/UIView+ReactABI21_0_0.h>
#elif __has_include("UIView+ReactABI21_0_0.h")
#import "UIView+ReactABI21_0_0.h"
#else
#import "ReactABI21_0_0/UIView+ReactABI21_0_0.h"
#endif

@implementation ABI21_0_0EXContainerView {
  LOTAnimationView *_animationView;
}

- (void)ReactABI21_0_0SetFrame:(CGRect)frame
{
  [super ReactABI21_0_0SetFrame:frame];
  if (_animationView != nil) {
    [_animationView ReactABI21_0_0SetFrame:frame];
  }
}
...
- (void)replaceAnimationView:(LOTAnimationView *)next {
  ...
  [_animationView ReactABI21_0_0SetFrame:self.frame];
