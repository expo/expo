...
#import "ABI21_0_0AIRDummyView.h"
...
@interface ABI21_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI21_0_0AIRGMSMarker*)marker;
@end

@implementation ABI21_0_0AIRGoogleMapMarker {
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI21_0_0AIRGMSMarker alloc] init];
...
- (void)insertReactABI21_0_0Subview:(id<ABI21_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI21_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI21_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI21_0_0AIRDummyView *dummySubview = [[ABI21_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertReactABI21_0_0Subview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeReactABI21_0_0Subview:(id<ABI21_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI21_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeReactABI21_0_0Subview:(UIView*)dummySubview];
}
...
- (void)setOnPress:(ABI21_0_0RCTBubblingEventBlock)onPress {
  _realMarker.onPress = onPress;
}

- (ABI21_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/airbnb/ReactABI21_0_0-native-maps/issues/738)
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI21_0_0RN?
