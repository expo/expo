//
//  ABI21_0_0AIRGoogleMapPolygon.m
//
...
@implementation ABI21_0_0AIRGoogleMapPolygon

- (instancetype)init
{
  if (self = [super init]) {
    _polygon = [[ABI21_0_0AIRGMSPolygon alloc] init];
  }

  return self;
}

- (void)setCoordinates:(NSArray<ABI21_0_0AIRMapCoordinate *> *)coordinates
{
...
- (void)setHoles:(NSArray<NSArray<ABI21_0_0AIRMapCoordinate *> *> *)holes
{
  _holes = holes;
