#import "ABI21_0_0RNAdMobDFPManager.h"
#import "ABI21_0_0RNDFPBannerView.h"
...
@implementation ABI21_0_0RNAdMobDFPManager
...
- (UIView *)view
{
  return [[ABI21_0_0RNDFPBannerView alloc] init];
}
...
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(onAdmobDispatchAppEvent, ABI21_0_0RCTBubblingEventBlock)
