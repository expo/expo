...
#import "ABI21_0_0EXPedometer.h"
#import "ABI21_0_0EXUnversioned.h"

#import <CoreMotion/CoreMotion.h>

NSString * const ABI21_0_0EXPedometerUpdateEventName = @"Exponent.pedometerUpdate";

@implementation ABI21_0_0EXPedometer
{
...
- (void)setBridge:(ABI21_0_0RCTBridge *)bridge
{
  ...
  _watchHandler = ^(CMPedometerData * _Nullable pedometerData, NSError * _Nullable error) {
    ...
    [weakSelf sendEventWithName:ABI21_0_0EXPedometerUpdateEventName
...
ABI21_0_0RCT_EXPORT_MODULE(ExponentPedometer)

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI21_0_0EXPedometerUpdateEventName];
}

ABI21_0_0RCT_EXPORT_METHOD(getStepCountAsync:(nonnull NSNumber *)startTime
...
ABI21_0_0RCT_EXPORT_METHOD(watchStepCount)
{
  if (!_pedometer) {
    _pedometer = [CMPedometer new];
  }
...
ABI21_0_0RCT_EXPORT_METHOD(stopWatchingStepCount)
{
  _watchStartDate = nil;
  _isWatching = NO;
  [_pedometer stopPedometerUpdates];
...
ABI21_0_0RCT_EXPORT_METHOD(isAvailableAsync:(ABI21_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI21_0_0RCTPromiseRejectBlock)reject)
{
