#import "ABI21_0_0EXAdSettingsManager.h"
...
ABI21_0_0RCT_ENUM_CONVERTER(FBAdLogLevel, (@{
...
@interface ABI21_0_0EXAdSettingsManager ()
...
@implementation ABI21_0_0EXAdSettingsManager

@synthesize bridge = _bridge;

ABI21_0_0RCT_EXPORT_MODULE(CTKAdSettingsManager)
...
ABI21_0_0RCT_EXPORT_METHOD(addTestDevice:(NSString *)deviceHash)
{
  [FBAdSettings addTestDevice:deviceHash];
  [_testDevices addObject:deviceHash];
}

ABI21_0_0RCT_EXPORT_METHOD(clearTestDevices)
{
  [FBAdSettings clearTestDevices];
  [_testDevices removeAllObjects];
}

ABI21_0_0RCT_EXPORT_METHOD(setLogLevel:(FBAdLogLevel)logLevel)
{
  [FBAdSettings setLogLevel:logLevel];
  _logLevel = logLevel;
}

ABI21_0_0RCT_EXPORT_METHOD(setIsChildDirected:(BOOL)isDirected)
{
  [FBAdSettings setIsChildDirected:isDirected];
  _isChildDirected = isDirected;
}

ABI21_0_0RCT_EXPORT_METHOD(setMediationService:(NSString *)mediationService)
{
  [FBAdSettings setMediationService:mediationService];
  _mediationService = mediationService;
}

ABI21_0_0RCT_EXPORT_METHOD(setUrlPrefix:(NSString *)urlPrefix)
{
