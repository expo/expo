...
@interface ABI21_0_0EXLocationRequester () <CLLocationManagerDelegate>
...
@implementation ABI21_0_0EXLocationRequester
...
+ (NSDictionary *)permissions
{
  ...
  if (!(alwaysUsageDescription || whenInUseUsageDescription)) {
    ABI21_0_0RCTFatal(ABI21_0_0RCTErrorWithMessage(@"This app is missing NSLocationAlwaysUsageDescription or NSLocationWhenInUseUsageDescription, so location services will fail. Add one of these keys to your bundle's Info.plist."));
...
- (void)requestPermissionsWithResolver:(ABI21_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI21_0_0RCTPromiseRejectBlock)reject
{
  ...
  if (existingPermissions && ![existingPermissions[@"status"] isEqualToString:[ABI21_0_0EXPermissions permissionStringForStatus:ABI21_0_0EXPermissionStatusUndetermined]]) {
