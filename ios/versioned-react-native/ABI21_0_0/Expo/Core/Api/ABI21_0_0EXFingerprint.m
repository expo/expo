...
#import "ABI21_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI21_0_0EXFingerprint

ABI21_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI21_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI21_0_0RCTPromiseResolveBlock)resolve
...
ABI21_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI21_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI21_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI21_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
