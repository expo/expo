#import "ABI21_0_0EXGLARSessionManager.h"
...
@interface ABI21_0_0EXGLARSessionManager ()
{
...
@property (nonatomic, assign) ABI21_0_0EXGLView *glView;
@property (atomic, strong) ARSession *arSession;

@end

@implementation ABI21_0_0EXGLARSessionManager
...
- (NSDictionary *)startARSessionWithGLView:(ABI21_0_0EXGLView *)glView
{
  ...
  // Create camera texture output ABI21_0_0EXGLObject
...
- (NSDictionary *)arMatricesForViewportSize:(CGSize)viewportSize zNear:(CGFloat)zNear zFar:(CGFloat)zFar
{
  ...
  return @{
    @"transform": [ABI21_0_0EXGLARSessionManager nsArrayForMatrix:transform],
    @"viewMatrix": [ABI21_0_0EXGLARSessionManager nsArrayForMatrix:viewMat],
    @"projectionMatrix": [ABI21_0_0EXGLARSessionManager nsArrayForMatrix:projMat],
  };
}
