...
@protocol ABI21_0_0RCTWebSocketProtocolDelegate

- (void)webSocket:(ABI21_0_0RCTSRWebSocket *)webSocket didReceiveMessage:(id)message;

@end

@interface ABI21_0_0RCTReconnectingWebSocket : NSObject

- (instancetype)initWithURL:(NSURL *)url;
@property (nonatomic, weak) id<ABI21_0_0RCTWebSocketProtocolDelegate> delegate;
- (void)send:(id)data;
- (void)start;
- (void)stop;
