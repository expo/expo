...
@interface ABI21_0_0RCTReconnectingWebSocket () <ABI21_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI21_0_0RCTReconnectingWebSocket {
  NSURL *_url;
  ABI21_0_0RCTSRWebSocket *_socket;
}
...
{
  [self stop];
  _socket = [[ABI21_0_0RCTSRWebSocket alloc] initWithURL:_url];
...
- (void)reconnect
{
  __weak ABI21_0_0RCTSRWebSocket *socket = _socket;
