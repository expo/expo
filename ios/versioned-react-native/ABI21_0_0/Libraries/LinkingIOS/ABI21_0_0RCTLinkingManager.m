...
#import "ABI21_0_0RCTLinkingManager.h"
...
static NSString *const kOpenURLNotification = @"ABI21_0_0RCTOpenURLNotification";
...
@implementation ABI21_0_0RCTLinkingManager
                  ...
                  reject:(__unused ABI21_0_0RCTPromiseRejectBlock)reject)
{
  ...
  BOOL canOpen = [ABI21_0_0RCTSharedApplication() canOpenURL:URL];
  resolve(@(canOpen));
}
                  ...
                  reject:(__unused ABI21_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve(ABI21_0_0RCTNullIfNil(initialURL.absoluteString));
}
