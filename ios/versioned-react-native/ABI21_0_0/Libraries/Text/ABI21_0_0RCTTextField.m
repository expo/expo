...
@interface ABI21_0_0RCTTextField () <ABI21_0_0RCTBackedTextInputDelegate>

@end

@implementation ABI21_0_0RCTTextField
{
  ABI21_0_0RCTUITextField *_backedTextInput;
  BOOL _submitted;
...
- (instancetype)initWithBridge:(ABI21_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInput = [[ABI21_0_0RCTUITextField alloc] initWithFrame:self.bounds];
...
{
  [_eventDispatcher sendTextEventWithType:ABI21_0_0RCTTextEventTypeKeyPress
...
- (void)setText:(NSString *)text
{
  ...
  if (eventLag == 0 && ![text isEqualToString:self.text]) {
    ...
    ABI21_0_0RCTLogWarn(@"Native TextInput(%@) is %zd events ahead of JS - try to make your JS faster.", _backedTextInput.text, eventLag);
  }
}
...
{
  _nativeEventCount++;
  [_eventDispatcher sendTextEventWithType:ABI21_0_0RCTTextEventTypeChange
                                 ReactABI21_0_0Tag:self.ReactABI21_0_0Tag
