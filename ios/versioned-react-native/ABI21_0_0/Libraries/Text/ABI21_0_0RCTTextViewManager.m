...
#import "ABI21_0_0RCTTextViewManager.h"
...
#import "ABI21_0_0RCTShadowTextView.h"
#import "ABI21_0_0RCTTextView.h"

@implementation ABI21_0_0RCTTextViewManager

ABI21_0_0RCT_EXPORT_MODULE()

- (ABI21_0_0RCTShadowView *)shadowView
{
  return [ABI21_0_0RCTShadowTextView new];
}

- (UIView *)view
{
  return [[ABI21_0_0RCTTextView alloc] initWithBridge:self.bridge];
}
...
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(onContentSizeChange, ABI21_0_0RCTBubblingEventBlock)
...
ABI21_0_0RCT_EXPORT_VIEW_PROPERTY(onTextInput, ABI21_0_0RCTDirectEventBlock)

ABI21_0_0RCT_CUSTOM_VIEW_PROPERTY(fontSize, NSNumber, ABI21_0_0RCTTextView)
{
  view.font = [ABI21_0_0RCTFont updateFont:view.font withSize:json ?: @(defaultView.font.pointSize)];
}
ABI21_0_0RCT_CUSTOM_VIEW_PROPERTY(fontWeight, NSString, __unused ABI21_0_0RCTTextView)
{
  view.font = [ABI21_0_0RCTFont updateFont:view.font withWeight:json]; // defaults to normal
}
ABI21_0_0RCT_CUSTOM_VIEW_PROPERTY(fontStyle, NSString, __unused ABI21_0_0RCTTextView)
{
  view.font = [ABI21_0_0RCTFont updateFont:view.font withStyle:json]; // defaults to normal
}
ABI21_0_0RCT_CUSTOM_VIEW_PROPERTY(fontFamily, NSString, ABI21_0_0RCTTextView)
{
...
#if !TARGET_OS_TV
ABI21_0_0RCT_REMAP_VIEW_PROPERTY(dataDetectorTypes, backedTextInputView.dataDetectorTypes, UIDataDetectorTypes)
#endif
