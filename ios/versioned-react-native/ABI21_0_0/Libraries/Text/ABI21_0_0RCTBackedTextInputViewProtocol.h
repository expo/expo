...
@protocol ABI21_0_0RCTBackedTextInputDelegate;

@protocol ABI21_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI21_0_0RCTBackedTextInputDelegate> textInputDelegate;
