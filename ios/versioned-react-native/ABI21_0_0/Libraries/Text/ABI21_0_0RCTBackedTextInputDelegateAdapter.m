...
#import "ABI21_0_0RCTBackedTextInputDelegateAdapter.h"

#pragma mark - ABI21_0_0RCTBackedTextFieldDelegateAdapter (for UITextField)

static void *TextFieldSelectionObservingContext = &TextFieldSelectionObservingContext;

@interface ABI21_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI21_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI21_0_0RCTBackedTextInputViewProtocol> *_backedTextInput;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}

- (instancetype)initWithTextField:(UITextField<ABI21_0_0RCTBackedTextInputViewProtocol> *)backedTextInput
{
  if (self = [super init]) {
...
#pragma mark - ABI21_0_0RCTBackedTextViewDelegateAdapter (for UITextView)

@interface ABI21_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI21_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI21_0_0RCTBackedTextInputViewProtocol> *_backedTextInput;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}

- (instancetype)initWithTextView:(UITextView<ABI21_0_0RCTBackedTextInputViewProtocol> *)backedTextInput
{
  if (self = [super init]) {
    _backedTextInput = backedTextInput;
    backedTextInput.delegate = self;
