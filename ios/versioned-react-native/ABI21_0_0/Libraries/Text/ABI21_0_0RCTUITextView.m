...
#import "ABI21_0_0RCTUITextView.h"
...
@implementation ABI21_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI21_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI21_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
  }
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI21_0_0RCTCeilPixelValue(placeholderSize.width), ABI21_0_0RCTCeilPixelValue(placeholderSize.height));
