...
@implementation ABI21_0_0RCTInterpolationAnimatedNode
{
  __weak ABI21_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI21_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI21_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI21_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI21_0_0RCTInterpolateValueInRange(inputValue,
                                          _inputRange,
                                          _outputRange,
                                          _extrapolateLeft,
                                          _extrapolateRight);
