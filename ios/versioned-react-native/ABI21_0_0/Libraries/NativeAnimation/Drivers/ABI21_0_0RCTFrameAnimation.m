...
@interface ABI21_0_0RCTFrameAnimation ()
...
@implementation ABI21_0_0RCTFrameAnimation
{
...
{
  if ((self = [super init])) {
    NSNumber *toValue = [ABI21_0_0RCTConvert NSNumber:config[@"toValue"]] ?: @1;
    NSArray<NSNumber *> *frames = [ABI21_0_0RCTConvert NSNumberArray:config[@"frames"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  NSUInteger startIndex = floor(currentDuration / ABI21_0_0RCTSingleFrameInterval);
  ...
  NSTimeInterval fromInterval = startIndex * ABI21_0_0RCTSingleFrameInterval;
  NSTimeInterval toInterval = nextIndex * ABI21_0_0RCTSingleFrameInterval;
  ...
  CGFloat frameOutput = ABI21_0_0RCTInterpolateValue(currentDuration,
                                            fromInterval,
                                            toInterval,
                                            fromFrameValue.doubleValue,
                                            toFrameValue.doubleValue,
                                            ABI21_0_0EXTRAPOLATE_TYPE_EXTEND,
                                            ABI21_0_0EXTRAPOLATE_TYPE_EXTEND);
...
{
  CGFloat outputValue = ABI21_0_0RCTInterpolateValue(frameOutput,
                                            0,
                                            1,
                                            _fromValue,
                                            _toValue,
