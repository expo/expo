...
#import "ABI21_0_0RCTSpringAnimation.h"
...
@implementation ABI21_0_0RCTSpringAnimation
{
  ...
  ABI21_0_0RCTResponseSenderBlock _callback;
...
- (instancetype)initWithId:(NSNumber *)animationId
                   ...
                   forNode:(ABI21_0_0RCTValueAnimatedNode *)valueNode
                  callBack:(nullable ABI21_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    NSNumber *iterations = [ABI21_0_0RCTConvert NSNumber:config[@"iterations"]] ?: @1;

    _animationId = animationId;
    _toValue = [ABI21_0_0RCTConvert CGFloat:config[@"toValue"]];
    _fromValue = valueNode.value;
    _valueNode = valueNode;
    _overshootClamping = [ABI21_0_0RCTConvert BOOL:config[@"overshootClamping"]];
    _restDisplacementThreshold = [ABI21_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
    _restSpeedThreshold = [ABI21_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
    _tension = [ABI21_0_0RCTConvert CGFloat:config[@"tension"]];
    _friction = [ABI21_0_0RCTConvert CGFloat:config[@"friction"]];
    _initialVelocity = [ABI21_0_0RCTConvert CGFloat:config[@"initialVelocity"]];
