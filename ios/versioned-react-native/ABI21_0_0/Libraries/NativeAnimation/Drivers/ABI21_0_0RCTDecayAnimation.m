...
#import "ABI21_0_0RCTDecayAnimation.h"
...
@interface ABI21_0_0RCTDecayAnimation ()
...
@implementation ABI21_0_0RCTDecayAnimation
{
  CGFloat _velocity;
                  ...
                  callBack:(nullable ABI21_0_0RCTResponseSenderBlock)callback;
{
  if ((self = [super init])) {
    ...
    _velocity = [ABI21_0_0RCTConvert CGFloat:config[@"velocity"]];
    _deceleration = [ABI21_0_0RCTConvert CGFloat:config[@"deceleration"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  if (_frameStartTime == -1) {
    ...
    _frameStartTime = currentTime - ABI21_0_0RCTSingleFrameInterval;
