...
typedef NS_ENUM(NSInteger, ABI21_0_0RCTTestStatus) {
  ABI21_0_0RCTTestStatusPending = 0,
  ABI21_0_0RCTTestStatusPassed,
  ABI21_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI21_0_0RCTTestModule : NSObject <ABI21_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI21_0_0RCTTestStatus status;
