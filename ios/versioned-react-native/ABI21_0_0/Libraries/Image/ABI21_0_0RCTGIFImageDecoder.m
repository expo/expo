...
#import "ABI21_0_0RCTGIFImageDecoder.h"
...
@implementation ABI21_0_0RCTGIFImageDecoder
...
- (ABI21_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
