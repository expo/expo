...
@interface ABI21_0_0RCTImageStoreManager : NSObject <ABI21_0_0RCTURLRequestHandler>
...
@interface ABI21_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI21_0_0RCTBridge (ABI21_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI21_0_0RCTImageStoreManager *imageStoreManager;
