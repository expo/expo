...
@interface ABI21_0_0ARTRenderable : ABI21_0_0ARTNode

@property (nonatomic, strong) ABI21_0_0ARTBrush *fill;
...
@property (nonatomic, assign) ABI21_0_0ARTCGFloatArray strokeDash;
