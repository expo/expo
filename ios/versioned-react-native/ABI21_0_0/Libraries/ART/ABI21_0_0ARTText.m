...
@implementation ABI21_0_0ARTText
...
static void ABI21_0_0ARTFreeTextFrame(ABI21_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI21_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI21_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI21_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI21_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
