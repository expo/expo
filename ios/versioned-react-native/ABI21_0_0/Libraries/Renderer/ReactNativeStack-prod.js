...
var warning = require("fbjs/lib/warning"), RCTEventEmitter = require('../EventEmitter/RCTEventEmitter'), emptyFunction = require("fbjs/lib/emptyFunction"), UIManager = require('../ReactNative/UIManager'), React = require("react"), emptyObject = require("fbjs/lib/emptyObject");

require("prop-types/checkPropTypes");

var shallowEqual = require("fbjs/lib/shallowEqual"), deepDiffer = require('../Utilities/differ/deepDiffer'), flattenStyle = require('../StyleSheet/flattenStyle'), TextInputState = require('../Components/TextInput/TextInputState');
...
var instantiateReactComponent_1 = instantiateReactComponent, DevOnlyStubShim = null, ReactNativeFeatureFlags = require('./shims/ReactNativeFeatureFlags'), injectedFindNode = ReactNativeFeatureFlags.useFiber ? function(fiber) {
...
var ReactNativeComponent_1 = ReactNativeComponent, ReactNativeFeatureFlags$2 = require('./shims/ReactNativeFeatureFlags'), mountSafeCallback$2 = NativeMethodsMixinUtils.mountSafeCallback, findNumericNodeHandle$1 = ReactNativeFeatureFlags$2.useFiber ? DevOnlyStubShim : findNumericNodeHandleStack, NativeMethodsMixin = {
