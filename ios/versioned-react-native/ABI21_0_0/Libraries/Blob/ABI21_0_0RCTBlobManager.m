...
#import "ABI21_0_0RCTBlobManager.h"

#import <ReactABI21_0_0/ABI21_0_0RCTConvert.h>
#import <ReactABI21_0_0/ABI21_0_0RCTWebSocketModule.h>

static NSString *const kBlobUriScheme = @"blob";

@interface _ABI21_0_0RCTBlobContentHandler : NSObject <ABI21_0_0RCTWebSocketContentHandler>

- (instancetype)initWithBlobManager:(ABI21_0_0RCTBlobManager *)blobManager;

@end


@implementation ABI21_0_0RCTBlobManager
{
  NSMutableDictionary<NSString *, NSData *> *_blobs;
  _ABI21_0_0RCTBlobContentHandler *_contentHandler;
  NSOperationQueue *_queue;
}

ABI21_0_0RCT_EXPORT_MODULE(BlobModule)
...
{
  NSString *blobId = [ABI21_0_0RCTConvert NSString:blob[@"blobId"]];
  NSNumber *offset = [ABI21_0_0RCTConvert NSNumber:blob[@"offset"]];
  NSNumber *size = [ABI21_0_0RCTConvert NSNumber:blob[@"size"]];
...
ABI21_0_0RCT_EXPORT_METHOD(enableBlobSupport:(nonnull NSNumber *)socketID)
{
  if (!_contentHandler) {
    _contentHandler = [[_ABI21_0_0RCTBlobContentHandler alloc] initWithBlobManager:self];
  }
  [[_bridge webSocketModule] setContentHandler:_contentHandler forSocketID:socketID];
}

ABI21_0_0RCT_EXPORT_METHOD(disableBlobSupport:(nonnull NSNumber *)socketID)
{
  [[_bridge webSocketModule] setContentHandler:nil forSocketID:socketID];
}

ABI21_0_0RCT_EXPORT_METHOD(sendBlob:(NSDictionary *)blob socketID:(nonnull NSNumber *)socketID)
{
  [[_bridge webSocketModule] sendData:[self resolve:blob] forSocketID:socketID];
}

ABI21_0_0RCT_EXPORT_METHOD(createFromParts:(NSArray<NSDictionary<NSString *, id> *> *)parts withId:(NSString *)blobId)
{
...
ABI21_0_0RCT_EXPORT_METHOD(release:(NSString *)blobId)
{
  [_blobs removeObjectForKey:blobId];
}

#pragma mark - ABI21_0_0RCTURLRequestHandler methods
...
@implementation _ABI21_0_0RCTBlobContentHandler {
  __weak ABI21_0_0RCTBlobManager *_blobManager;
}
