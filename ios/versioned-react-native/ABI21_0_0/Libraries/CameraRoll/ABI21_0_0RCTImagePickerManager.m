...
#import "ABI21_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI21_0_0/ABI21_0_0RCTConvert.h>
#import <ReactABI21_0_0/ABI21_0_0RCTImageStoreManager.h>
#import <ReactABI21_0_0/ABI21_0_0RCTRootView.h>
#import <ReactABI21_0_0/ABI21_0_0RCTUtils.h>

@interface ABI21_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI21_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI21_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI21_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI21_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI21_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI21_0_0RCTResponseSenderBlock)callback)
{
...
ABI21_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI21_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI21_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI21_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI21_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI21_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI21_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI21_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI21_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI21_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI21_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI21_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI21_0_0RCTNullIfNil(height), ABI21_0_0RCTNullIfNil(width)]];
    return;
  }
        ...
        cancelCallback:(ABI21_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI21_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI21_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI21_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
