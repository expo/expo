 ...
 */
@interface ABI21_0_0RCTAsyncLocalStorage : NSObject <ABI21_0_0RCTBridgeModule,ABI21_0_0RCTInvalidating>
...
// Clear the ABI21_0_0RCTAsyncLocalStorage data from native code
- (void)clearAllData;
