...
@protocol ABI21_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI21_0_0RCTExceptionsManager : NSObject <ABI21_0_0RCTBridgeModule>

- (instancetype)initWithDelegate:(id<ABI21_0_0RCTExceptionsManagerDelegate>)delegate;

@property (nonatomic, weak) id<ABI21_0_0RCTExceptionsManagerDelegate> delegate;
