...
#import "ABI21_0_0RCTKeyboardObserver.h"

#import "ABI21_0_0RCTEventDispatcher.h"

static NSDictionary *ABI21_0_0RCTParseKeyboardNotification(NSNotification *notification);

@implementation ABI21_0_0RCTKeyboardObserver
...
{ \
  [self sendEventWithName:@#EVENT \
    body:ABI21_0_0RCTParseKeyboardNotification(notification)]; \
}
...
NS_INLINE NSDictionary *ABI21_0_0RCTRectDictionaryValue(CGRect rect)
{
  return @{
...
static NSString *ABI21_0_0RCTAnimationNameForCurve(UIViewAnimationCurve curve)
{
  switch (curve) {
...
static NSDictionary *ABI21_0_0RCTParseKeyboardNotification(NSNotification *notification)
{
  ...
  return @{
    @"startCoordinates": ABI21_0_0RCTRectDictionaryValue(beginFrame),
    @"endCoordinates": ABI21_0_0RCTRectDictionaryValue(endFrame),
    @"duration": @(duration * 1000.0), // ms
    @"easing": ABI21_0_0RCTAnimationNameForCurve(curve),
  };
#endif
}
