...
/**
 * An abstraction for a key-value store to manage ABI21_0_0RCTDevSettings behavior.
 * The default implementation persists settings using NSUserDefaults.
 */
@protocol ABI21_0_0RCTDevSettingsDataSource <NSObject>
...
@interface ABI21_0_0RCTDevSettings : NSObject
...
/*
 * Whether shaking will show ABI21_0_0RCTDevMenu. The menu is enabled by default if ABI21_0_0RCT_DEV=1, but
...
@interface ABI21_0_0RCTBridge (ABI21_0_0RCTDevSettings)

@property (nonatomic, readonly) ABI21_0_0RCTDevSettings *devSettings;
