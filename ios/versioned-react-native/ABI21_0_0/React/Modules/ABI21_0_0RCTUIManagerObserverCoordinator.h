 ...
 */
@protocol ABI21_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ReactABI21_0_0-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI21_0_0RCTUIManager's observers.
 */
@interface ABI21_0_0RCTUIManagerObserverCoordinator : NSObject <ABI21_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI21_0_0RCTUIManagerObserver` protocol for more info.
