...
#import "ABI21_0_0RCTTVNavigationEventEmitter.h"

NSString *const ABI21_0_0RCTTVNavigationEventNotification = @"ABI21_0_0RCTTVNavigationEventNotification";

static NSString *const TVNavigationEventName = @"onTVNavEvent";

@implementation ABI21_0_0RCTTVNavigationEventEmitter
  ...
  if (self = [super init]) {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(handleTVNavigationEventNotification:)
                                                 name:ABI21_0_0RCTTVNavigationEventNotification
                                               object:nil];
