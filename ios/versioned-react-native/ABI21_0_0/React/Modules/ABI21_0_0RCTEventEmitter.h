...
/**
 * ABI21_0_0RCTEventEmitter is an abstract base class to be used for modules that emit
 * events to be observed by JS.
 */
@interface ABI21_0_0RCTEventEmitter : NSObject <ABI21_0_0RCTBridgeModule>
