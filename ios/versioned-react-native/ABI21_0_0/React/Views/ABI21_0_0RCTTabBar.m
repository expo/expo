...
#import "ABI21_0_0RCTViewControllerProtocol.h"
#import "ABI21_0_0RCTWrapperViewController.h"
#import "UIView+ReactABI21_0_0.h"

@interface ABI21_0_0RCTTabBar() <UITabBarControllerDelegate>

@end

@implementation ABI21_0_0RCTTabBar
{
  BOOL _tabsChanged;
...
- (void)insertReactABI21_0_0Subview:(ABI21_0_0RCTTabBarItem *)subview atIndex:(NSInteger)atIndex
{
  if (![subview isKindOfClass:[ABI21_0_0RCTTabBarItem class]]) {
    ABI21_0_0RCTLogError(@"subview should be of type ABI21_0_0RCTTabBarItem");
    return;
  }
...
- (void)removeReactABI21_0_0Subview:(ABI21_0_0RCTTabBarItem *)subview
{
  if (self.ReactABI21_0_0Subviews.count == 0) {
    ABI21_0_0RCTLogError(@"should have at least one view to remove a subview");
    return;
  }
...
{
  // Do nothing, as subviews are managed by `ReactABI21_0_0BridgeDidFinishTransaction`
}

- (void)layoutSubviews
{
  [super layoutSubviews];
  [self ReactABI21_0_0AddControllerToClosestParent:_tabController];
...
- (void)ReactABI21_0_0BridgeDidFinishTransaction
{
  ...
  if (_tabsChanged) {
    ...
    for (ABI21_0_0RCTTabBarItem *tab in [self ReactABI21_0_0Subviews]) {
      UIViewController *controller = tab.ReactABI21_0_0ViewController;
      if (!controller) {
        controller = [[ABI21_0_0RCTWrapperViewController alloc] initWithContentView:tab];
      }
  ...
  [self.ReactABI21_0_0Subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger index, __unused BOOL *stop) {

    ABI21_0_0RCTTabBarItem *tab = (ABI21_0_0RCTTabBarItem *)view;
...
- (BOOL)tabBarController:(UITabBarController *)tabBarController shouldSelectViewController:(UIViewController *)viewController
{
  ...
  ABI21_0_0RCTTabBarItem *tab = (ABI21_0_0RCTTabBarItem *)self.ReactABI21_0_0Subviews[index];
