...
@interface ABI21_0_0RCTRootShadowView : ABI21_0_0RCTShadowView
 ...
 */
@property (nonatomic, assign) ABI21_0_0YGDirection baseDirection;

/**
 * Calculate all views whose frame needs updating after layout has been calculated.
 * Returns a set contains the shadowviews that need updating.
 */
- (NSSet<ABI21_0_0RCTShadowView *> *)collectViewsWithUpdatedFrames;
