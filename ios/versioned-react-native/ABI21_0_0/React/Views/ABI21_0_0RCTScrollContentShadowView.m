...
@interface ABI21_0_0RCTShadowView () {
...
@implementation ABI21_0_0RCTScrollContentShadowView
       ...
       absolutePosition:(CGPoint)absolutePosition
{
  ...
  CGFloat xCompensation = ABI21_0_0YGNodeLayoutGetRight(node) - ABI21_0_0YGNodeLayoutGetLeft(node);
  ...
  _frame.origin.x = ABI21_0_0RCTRoundPixelValue(ABI21_0_0YGNodeLayoutGetRight(node));
}
