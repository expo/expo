...
#import "ABI21_0_0RCTMultipartDataTask.h"

@interface ABI21_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI21_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI21_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI21_0_0RCTMultipartProgressCallback _progressHandler;
...
- (instancetype)initWithURL:(NSURL *)url
                partHandler:(ABI21_0_0RCTMultipartDataTaskCallback)partHandler
            progressHandler:(ABI21_0_0RCTMultipartProgressCallback)progressHandler
{
  if (self = [super init]) {
    _url = url;
...
{
  ABI21_0_0RCTMultipartStreamReader *reader = [[ABI21_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI21_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
