...
#import "ABI21_0_0RCTMultipartStreamReader.h"

#import <QuartzCore/CAAnimation.h>

#define CRLF @"\r\n"

@implementation ABI21_0_0RCTMultipartStreamReader {
...
- (void)emitChunk:(NSData *)data headers:(NSDictionary *)headers callback:(ABI21_0_0RCTMultipartCallback)callback done:(BOOL)done
{
...
- (void)emitProgress:(NSDictionary *)headers
       contentLength:(NSUInteger)contentLength
               final:(BOOL)final
            callback:(ABI21_0_0RCTMultipartProgressCallback)callback
{
  if (headers == nil) {
    return;
  }
