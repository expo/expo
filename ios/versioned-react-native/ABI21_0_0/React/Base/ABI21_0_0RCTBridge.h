...
@class ABI21_0_0RCTPerformanceLogger;

/**
 * This notification fires when the bridge starts loading the JS bundle.
 */
ABI21_0_0RCT_EXTERN NSString *const ABI21_0_0RCTJavaScriptWillStartLoadingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI21_0_0RCT_EXTERN NSString *const ABI21_0_0RCTJavaScriptDidLoadNotification;

/**
 * This notification fires when the bridge failed to load the JS bundle. The
 * `error` key can be used to determine the error that occured.
 */
ABI21_0_0RCT_EXTERN NSString *const ABI21_0_0RCTJavaScriptDidFailToLoadNotification;
 ...
 */
ABI21_0_0RCT_EXTERN NSString *const ABI21_0_0RCTDidInitializeModuleNotification;
 ...
 */
typedef NSArray<id<ABI21_0_0RCTBridgeModule>> *(^ABI21_0_0RCTBridgeModuleListProvider)(void);

/**
 * This function returns the module name for a given class.
 */
ABI21_0_0RCT_EXTERN NSString *ABI21_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI21_0_0RCTBridge : NSObject <ABI21_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI21_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI21_0_0RCTBridgeModules. Modules will be automatically instantiated
 * using the default contructor, but you can optionally pass in an array of
 * pre-initialized module instances if they require additional init parameters
 * or configuration.
 */
- (instancetype)initWithDelegate:(id<ABI21_0_0RCTBridgeDelegate>)delegate
 ...
 * See also -[ABI21_0_0RCTBridgeDelgate shouldBridgeLoadJavaScriptSynchronously], which
 ...
 */
@property (nonatomic, weak, readonly) id<ABI21_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ReactABI21_0_0 Native perf events.
 */
@property (nonatomic, readonly, strong) ABI21_0_0RCTPerformanceLogger *performanceLogger;
