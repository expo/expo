...
#import "ABI21_0_0RCTBundleURLProvider.h"

#import "ABI21_0_0RCTConvert.h"
#import "ABI21_0_0RCTDefines.h"

NSString *const ABI21_0_0RCTBundleURLProviderUpdatedNotification = @"ABI21_0_0RCTBundleURLProviderUpdatedNotification";

const NSUInteger kABI21_0_0RCTBundleURLProviderDefaultPort = 8081;

static NSString *const kABI21_0_0RCTJsLocationKey = @"ABI21_0_0RCT_jsLocation";
static NSString *const kABI21_0_0RCTEnableLiveReloadKey = @"ABI21_0_0RCT_enableLiveReload";
static NSString *const kABI21_0_0RCTEnableDevKey = @"ABI21_0_0RCT_enableDev";
static NSString *const kABI21_0_0RCTEnableMinificationKey = @"ABI21_0_0RCT_enableMinification";

@implementation ABI21_0_0RCTBundleURLProvider
...
{
  return @{
    kABI21_0_0RCTEnableLiveReloadKey: @NO,
    kABI21_0_0RCTEnableDevKey: @YES,
    kABI21_0_0RCTEnableMinificationKey: @NO,
  };
}

- (void)settingsUpdated
{
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI21_0_0RCTBundleURLProviderUpdatedNotification object:self];
}
...
static NSURL *serverRootWithHost(NSString *host)
{
  return [NSURL URLWithString:
          [NSString stringWithFormat:@"http://%@:%lu/",
           host, (unsigned long)kABI21_0_0RCTBundleURLProviderDefaultPort]];
}
...
- (BOOL)enableDev
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI21_0_0RCTEnableDevKey];
}

- (BOOL)enableLiveReload
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI21_0_0RCTEnableLiveReloadKey];
}

- (BOOL)enableMinification
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI21_0_0RCTEnableMinificationKey];
}

- (NSString *)jsLocation
{
  return [[NSUserDefaults standardUserDefaults] stringForKey:kABI21_0_0RCTJsLocationKey];
}

- (void)setEnableDev:(BOOL)enableDev
{
  [self updateValue:@(enableDev) forKey:kABI21_0_0RCTEnableDevKey];
}

- (void)setEnableLiveReload:(BOOL)enableLiveReload
{
  [self updateValue:@(enableLiveReload) forKey:kABI21_0_0RCTEnableLiveReloadKey];
}

- (void)setJsLocation:(NSString *)jsLocation
{
  [self updateValue:jsLocation forKey:kABI21_0_0RCTJsLocationKey];
}

- (void)setEnableMinification:(BOOL)enableMinification
{
  [self updateValue:@(enableMinification) forKey:kABI21_0_0RCTEnableMinificationKey];
}

+ (instancetype)sharedSettings
{
  static ABI21_0_0RCTBundleURLProvider *sharedInstance;
  static dispatch_once_t once_token;
  dispatch_once(&once_token, ^{
    sharedInstance = [ABI21_0_0RCTBundleURLProvider new];
  });
