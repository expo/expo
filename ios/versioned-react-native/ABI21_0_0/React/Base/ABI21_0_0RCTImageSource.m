...
@interface ABI21_0_0RCTImageSource ()

@property (nonatomic, assign) BOOL packagerAsset;

@end

@implementation ABI21_0_0RCTImageSource
...
{
  ABI21_0_0RCTImageSource *imageSource = [[ABI21_0_0RCTImageSource alloc] initWithURLRequest:_request
                                                                      size:size
                                                                     scale:scale];
...
- (BOOL)isEqual:(ABI21_0_0RCTImageSource *)object
{
  if (![object isKindOfClass:[ABI21_0_0RCTImageSource class]]) {
    return NO;
  }
...
{
  return [NSString stringWithFormat:@"<ABI21_0_0RCTImageSource: %p URL=%@, size=%@, scale=%0.f>",
          self, _request.URL, NSStringFromCGSize(_size), _scale];
}

@end

@implementation ABI21_0_0RCTConvert (ImageSource)

+ (ABI21_0_0RCTImageSource *)ABI21_0_0RCTImageSource:(id)json
{
  if (!json) {
    return nil;
  }
  ...
  if ([json isKindOfClass:[NSDictionary class]]) {
    ...
    ABI21_0_0RCTLogConvertError(json, @"an image. Did you forget to call resolveAssetSource() on the JS side?");
    return nil;
  }

  ABI21_0_0RCTImageSource *imageSource = [[ABI21_0_0RCTImageSource alloc] initWithURLRequest:request
                                                                      size:size
                                                                     scale:scale];
...
ABI21_0_0RCT_ARRAY_CONVERTER(ABI21_0_0RCTImageSource)
