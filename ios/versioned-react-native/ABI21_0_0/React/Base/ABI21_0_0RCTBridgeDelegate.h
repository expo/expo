...
@protocol ABI21_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI21_0_0RCTBridge *)bridge;
 ...
 */
- (NSURL *)fallbackSourceURLForBridge:(ABI21_0_0RCTBridge *)bridge;

/**
 * The bridge initializes any registered ABI21_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI21_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI21_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (NSArray<Class> *)whitelistedModulesForBridge:(ABI21_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeLoadJavaScriptSynchronously:(ABI21_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeInitializeNativeModulesSynchronously:(ABI21_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI21_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI21_0_0RCTBridge *)bridge;

/**
 * Configure whether the legacy ABI21_0_0RCTBatchedBridge or new ABI21_0_0RCTCxxBridge
 ...
 * implemented, the implementation will default to ABI21_0_0RCTBatchedBridge,
 * but if it is not linked in, will try ABI21_0_0RCTCxxBridge instead.  If
 ...
 * @experimental
 */
- (BOOL)shouldBridgeUseCxxBridge:(ABI21_0_0RCTBridge *)bridge;
 ...
 */
- (void)loadSourceForBridge:(ABI21_0_0RCTBridge *)bridge
                 onProgress:(ABI21_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI21_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI21_0_0RCTBridge *)bridge
                  withBlock:(ABI21_0_0RCTSourceLoadBlock)loadCallback;
