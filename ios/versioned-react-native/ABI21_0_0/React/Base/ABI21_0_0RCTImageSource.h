 ...
 */
@interface ABI21_0_0RCTImageSource : NSObject
...
@interface ABI21_0_0RCTConvert (ImageSource)

+ (ABI21_0_0RCTImageSource *)ABI21_0_0RCTImageSource:(id)json;
+ (NSArray<ABI21_0_0RCTImageSource *> *)ABI21_0_0RCTImageSourceArray:(id)json;
