...
extern NSString *const ABI21_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI21_0_0RCTBundleURLProviderDefaultPort;

@interface ABI21_0_0RCTBundleURLProvider : NSObject
