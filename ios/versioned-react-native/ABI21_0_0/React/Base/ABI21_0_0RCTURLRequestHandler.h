 ...
 * are also bridge modules, so should be registered using ABI21_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI21_0_0RCTURLRequestHandler <ABI21_0_0RCTBridgeModule>
...
- (id)sendRequest:(NSURLRequest *)request
     withDelegate:(id<ABI21_0_0RCTURLRequestDelegate>)delegate;
...
/**
 * If more than one ABI21_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
