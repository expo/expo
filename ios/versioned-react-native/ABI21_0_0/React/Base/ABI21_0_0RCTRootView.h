...
@protocol ABI21_0_0RCTRootViewDelegate;
 ...
 * rootViewDidChangeIntrinsicSize method of the ABI21_0_0RCTRootViewDelegate will be called.
 */
typedef NS_ENUM(NSInteger, ABI21_0_0RCTRootViewSizeFlexibility) {
  ABI21_0_0RCTRootViewSizeFlexibilityNone           = 0,
  ABI21_0_0RCTRootViewSizeFlexibilityWidth          = 1 << 0,
  ABI21_0_0RCTRootViewSizeFlexibilityHeight         = 1 << 1,
  ABI21_0_0RCTRootViewSizeFlexibilityWidthAndHeight = ABI21_0_0RCTRootViewSizeFlexibilityWidth | ABI21_0_0RCTRootViewSizeFlexibilityHeight,
};
 ...
 */
extern NSString *const ABI21_0_0RCTContentDidAppearNotification;

/**
 * Native view used to host ReactABI21_0_0-managed views within the app. Can be used just
 * like any ordinary UIView. You can have multiple ABI21_0_0RCTRootViews on screen at
 * once, all controlled by the same JavaScript application.
 */
@interface ABI21_0_0RCTRootView : UIView
 ...
 * This initializer is intended to be used when the app has a single ABI21_0_0RCTRootView,
 * otherwise create an `ABI21_0_0RCTBridge` and pass it in via `initWithBridge:moduleName:`
 ...
 * root views, so you can use this property to initialize another ABI21_0_0RCTRootView.
 */
@property (nonatomic, strong, readonly) ABI21_0_0RCTBridge *bridge;
 ...
 */
@property (nonatomic, weak) id<ABI21_0_0RCTRootViewDelegate> delegate;

/**
 * The backing view controller of the root view.
 */
@property (nonatomic, weak) UIViewController *ReactABI21_0_0ViewController;

/**
 * The ReactABI21_0_0-managed contents view of the root view.
 */
...
/**
 * When set, any touches on the ABI21_0_0RCTRootView that are not matched up to any of the child
 * views will be passed to siblings of the ABI21_0_0RCTRootView. See -[UIView hitTest:withEvent:]
...
@interface ABI21_0_0RCTRootView (Deprecated)

/**
 * The intrinsic size of the root view's content. This is set right before the
 * `rootViewDidChangeIntrinsicSize` method of `ABI21_0_0RCTRootViewDelegate` is called.
