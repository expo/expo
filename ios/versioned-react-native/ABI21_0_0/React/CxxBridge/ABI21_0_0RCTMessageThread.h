...
class ABI21_0_0RCTMessageThread : public MessageQueueThread {
 public:
  ABI21_0_0RCTMessageThread(NSRunLoop *runLoop, ABI21_0_0RCTJavaScriptCompleteBlock errorBlock);
  ~ABI21_0_0RCTMessageThread() override;
