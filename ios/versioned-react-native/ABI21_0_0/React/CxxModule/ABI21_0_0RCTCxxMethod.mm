...
#import <cxxReactABI21_0_0/ABI21_0_0JsArgumentHelpers.h>
#import <folly/Memory.h>

#import "ABI21_0_0RCTCxxUtils.h"

using facebook::xplat::module::CxxModule;
using namespace facebook::ReactABI21_0_0;

@implementation ABI21_0_0RCTCxxMethod
{
             ...
             arguments:(NSArray *)arguments
{
  ...
  if (arguments.count < _method->callbacks) {
    ABI21_0_0RCTLogError(@"Method %@.%s expects at least %lu arguments, but got %tu",
                ABI21_0_0RCTBridgeModuleNameForClass([module class]), _method->name.c_str(),
  ...
  if (_method->callbacks >= 1) {
    if (![arguments[arguments.count - 1] isKindOfClass:[NSNumber class]]) {
      ABI21_0_0RCTLogError(@"Argument %tu (%@) of %@.%s should be a function",
  ...
  try {
    ...
    ABI21_0_0RCTLogError(@"Method %@.%s argument error: %s",
                ABI21_0_0RCTBridgeModuleNameForClass([module class]), _method->name.c_str(),
                ex.what());
    return nil;
  }
