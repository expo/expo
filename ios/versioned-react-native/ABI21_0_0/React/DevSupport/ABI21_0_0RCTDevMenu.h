...
ABI21_0_0RCT_EXTERN NSString *const ABI21_0_0RCTShowDevMenuNotification;

#endif


@class ABI21_0_0RCTDevMenuItem;

/**
 * Developer menu, useful for exposing extra functionality when debugging.
 */
@interface ABI21_0_0RCTDevMenu : NSObject

/**
 * Deprecated, use ABI21_0_0RCTDevSettings instead.
 */
 ...
 */
@property (nonatomic, copy, readonly) NSArray<ABI21_0_0RCTDevMenuItem *> *presentedItems;
...
/**
 * Deprecated, use -[ABI21_0_0RCTBRidge reload] instead.
 */
...
typedef NSString *(^ABI21_0_0RCTDevMenuItemTitleBlock)(void);

/**
 * Developer menu item, used to expose additional functionality via the menu.
 */
@interface ABI21_0_0RCTDevMenuItem : NSObject
 ...
 */
+ (instancetype)buttonItemWithTitleBlock:(ABI21_0_0RCTDevMenuItemTitleBlock)titleBlock
                                 handler:(dispatch_block_t)handler;
 ...
 * ABI21_0_0RCTBridge, which is useful for any class that needs to access the menu.
 */
@interface ABI21_0_0RCTBridge (ABI21_0_0RCTDevMenu)

@property (nonatomic, readonly) ABI21_0_0RCTDevMenu *devMenu;
