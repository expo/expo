...
@implementation ABI21_0_0RCTSamplingProfilerPackagerMethod {
  __weak id<ABI21_0_0RCTJSEnvironment> _jsEnvironment;
}

- (instancetype)initWithJSEnvironment:(id<ABI21_0_0RCTJSEnvironment>)jsEnvironment
{
  if (self = [super init]) {
...
- (void)handleRequest:(__unused id)params withResponder:(ABI21_0_0RCTPackagerClientResponder *)responder
{
...
{
  ABI21_0_0RCTLogError(@"%@ does not implement onNotification", [self class]);
}
