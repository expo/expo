...
#include <ABI21_0_0jschelpers/ABI21_0_0InspectorInterfaces.h>
...
// ReactABI21_0_0-native-github/ReactABI21_0_0Android/src/main/java/com/facebook/ReactABI21_0_0/bridge/Inspector.java
// ReactABI21_0_0-native-github/ReactABI21_0_0Android/src/main/jni/ReactABI21_0_0/jni/JInspector.cpp
// please keep consistent :)

class RemoteConnection : public IRemoteConnection {
public:
RemoteConnection(ABI21_0_0RCTInspectorRemoteConnection *connection) :
...
private:
  const ABI21_0_0RCTInspectorRemoteConnection *_connection;
};

@interface ABI21_0_0RCTInspectorPage () {
  NSInteger _id;
  NSString *_title;
}
...
@interface ABI21_0_0RCTInspectorLocalConnection () {
...
@implementation ABI21_0_0RCTInspector
...
+ (NSArray<ABI21_0_0RCTInspectorPage *> *)pages
{
  ...
  NSMutableArray<ABI21_0_0RCTInspectorPage *> *array = [NSMutableArray arrayWithCapacity:pages.size()];
  for (size_t i = 0; i < pages.size(); i++) {
    ABI21_0_0RCTInspectorPage *pageWrapper = [[ABI21_0_0RCTInspectorPage alloc] initWithId:pages[i].id
                         ...
                         forRemoteConnection:(ABI21_0_0RCTInspectorRemoteConnection *)remote
{
  ...
  return [[ABI21_0_0RCTInspectorLocalConnection alloc] initWithConnection:std::move(localConnection)];
}

@end

@implementation ABI21_0_0RCTInspectorPage
...
@implementation ABI21_0_0RCTInspectorLocalConnection
