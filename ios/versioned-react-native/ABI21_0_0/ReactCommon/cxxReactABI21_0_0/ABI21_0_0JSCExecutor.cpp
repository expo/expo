...
#include "ABI21_0_0JSCExecutor.h"
...
#include "ABI21_0_0JSCTracing.h"
#include "ABI21_0_0JSCUtils.h"
#include "JSModulesUnbundle.h"
#include "ABI21_0_0ModuleRegistry.h"
...
void JSCExecutor::loadApplicationScript(std::unique_ptr<const JSBigString> script, std::string sourceURL) {
  ...
  ReactABI21_0_0Marker::logTaggedMarker(ReactABI21_0_0Marker::RUN_JS_BUNDLE_START, scriptName.c_str());
  ...
  if (auto fileStr = dynamic_cast<const JSBigFileString *>(script.get())) {
    ...
    case JSLoadSourceIsCompiled:
      ...
      ReactABI21_0_0Marker::logMarker(ReactABI21_0_0Marker::CREATE_REACT_CONTEXT_STOP);
      ReactABI21_0_0Marker::logMarker(ReactABI21_0_0Marker::RUN_JS_BUNDLE_STOP);
      return;
...
#endif
  {
    String jsScript;
    {
      ...
      ReactABI21_0_0Marker::logMarker(ReactABI21_0_0Marker::JS_BUNDLE_STRING_CONVERT_START);
      jsScript = adoptString(std::move(script));
      ReactABI21_0_0Marker::logMarker(ReactABI21_0_0Marker::JS_BUNDLE_STRING_CONVERT_STOP);
    }
...
JSValueRef JSCExecutor::nativeRequire(
  ...
  ReactABI21_0_0Marker::logMarker(ReactABI21_0_0Marker::NATIVE_REQUIRE_START);
  loadModule(moduleId);
  ReactABI21_0_0Marker::logMarker(ReactABI21_0_0Marker::NATIVE_REQUIRE_STOP);
