...
#include "ABI21_0_0CxxNativeModule.h"
...
#include "ABI21_0_0JsArgumentHelpers.h"
...
void CxxNativeModule::invoke(unsigned int ReactABI21_0_0MethodId, folly::dynamic&& params, int callId) {
  if (ReactABI21_0_0MethodId >= methods_.size()) {
    throw std::invalid_argument(folly::to<std::string>("methodId ", ReactABI21_0_0MethodId,
  ...
  const auto& method = methods_[ReactABI21_0_0MethodId];
