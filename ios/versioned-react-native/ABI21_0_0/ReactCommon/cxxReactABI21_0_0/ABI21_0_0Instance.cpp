...
#include "ABI21_0_0Instance.h"

#include "ABI21_0_0JSExecutor.h"
#include "ABI21_0_0MethodCall.h"
#include "ABI21_0_0RecoverableError.h"
#include "ABI21_0_0SystraceSection.h"
#include "ABI21_0_0MessageQueueThread.h"
#include "ABI21_0_0NativeToJsBridge.h"
#include "ABI21_0_0JSBigString.h"
...
void Instance::loadApplication(
  ...
  SystraceSection s("ReactABI21_0_0bridge_xplat_loadApplication", "sourceURL", sourceURL);
...
void Instance::loadApplicationSync(
  ...
  SystraceSection s("ReactABI21_0_0bridge_xplat_loadApplicationSync", "sourceURL", sourceURL);
  nativeToJsBridge_->loadApplicationSync(std::move(unbundle), std::move(string), std::move(sourceURL));
}

void Instance::setSourceURL(std::string sourceURL) {
  callback_->incrementPendingJSCalls();
  SystraceSection s("ReactABI21_0_0bridge_xplat_setSourceURL", "sourceURL", sourceURL);
...
void Instance::loadScriptFromString(std::unique_ptr<const JSBigString> string,
  ...
  SystraceSection s("ReactABI21_0_0bridge_xplat_loadScriptFromString", "sourceURL", sourceURL);
