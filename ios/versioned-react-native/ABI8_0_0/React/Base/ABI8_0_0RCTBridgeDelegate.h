...
@protocol ABI8_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI8_0_0RCTBridge *)bridge;
 ...
 */
- (NSURL *)fallbackSourceURLForBridge:(ABI8_0_0RCTBridge *)bridge;

/**
 * The bridge initializes any registered ABI8_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray *)extraModulesForBridge:(ABI8_0_0RCTBridge *)bridge;
 ...
 */
- (void)loadSourceForBridge:(ABI8_0_0RCTBridge *)bridge
                  withBlock:(ABI8_0_0RCTSourceLoadBlock)loadCallback;
