...
@interface ABI8_0_0RCTImageSource ()

@property (nonatomic, assign) BOOL packagerAsset;

@end

@implementation ABI8_0_0RCTImageSource
...
{
  ABI8_0_0RCTImageSource *imageSource = [[ABI8_0_0RCTImageSource alloc] initWithURLRequest:_request
                                                                      size:size
                                                                     scale:scale];
...
- (BOOL)isEqual:(ABI8_0_0RCTImageSource *)object
{
  if (![object isKindOfClass:[ABI8_0_0RCTImageSource class]]) {
    return NO;
  }
...
@implementation ABI8_0_0RCTImageSource (Deprecated)
...
@implementation ABI8_0_0RCTConvert (ImageSource)

+ (ABI8_0_0RCTImageSource *)ABI8_0_0RCTImageSource:(id)json
{
  if (!json) {
    return nil;
  }
  ...
  if ([json isKindOfClass:[NSDictionary class]]) {
    ...
    ABI8_0_0RCTLogConvertError(json, @"an image. Did you forget to call resolveAssetSource() on the JS side?");
    return nil;
  }

  ABI8_0_0RCTImageSource *imageSource = [[ABI8_0_0RCTImageSource alloc] initWithURLRequest:request
                                                               size:size
                                                              scale:scale];
