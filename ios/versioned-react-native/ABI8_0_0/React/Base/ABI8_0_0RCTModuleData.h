...
@protocol ABI8_0_0RCTBridgeMethod;
@protocol ABI8_0_0RCTBridgeModule;
@class ABI8_0_0RCTBridge;

@interface ABI8_0_0RCTModuleData : NSObject <ABI8_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI8_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI8_0_0RCTBridgeModule> instance;
