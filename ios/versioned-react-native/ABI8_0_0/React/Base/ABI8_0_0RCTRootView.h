...
@protocol ABI8_0_0RCTRootViewDelegate;
 ...
 * rootViewDidChangeIntrinsicSize method of the ABI8_0_0RCTRootViewDelegate will be called.
 */
typedef NS_ENUM(NSInteger, ABI8_0_0RCTRootViewSizeFlexibility) {
  ABI8_0_0RCTRootViewSizeFlexibilityNone = 0,
  ABI8_0_0RCTRootViewSizeFlexibilityWidth,
  ABI8_0_0RCTRootViewSizeFlexibilityHeight,
  ABI8_0_0RCTRootViewSizeFlexibilityWidthAndHeight,
};
 ...
 */
extern NSString *const ABI8_0_0RCTContentDidAppearNotification;

/**
 * Native view used to host ReactABI8_0_0-managed views within the app. Can be used just
 * like any ordinary UIView. You can have multiple ABI8_0_0RCTRootViews on screen at
 * once, all controlled by the same JavaScript application.
 */
@interface ABI8_0_0RCTRootView : UIView
 ...
 * This initializer is intended to be used when the app has a single ABI8_0_0RCTRootView,
 * otherwise create an `ABI8_0_0RCTBridge` and pass it in via `initWithBridge:moduleName:`
 ...
 * root views, so you can use this property to initialize another ABI8_0_0RCTRootView.
 */
@property (nonatomic, strong, readonly) ABI8_0_0RCTBridge *bridge;
 ...
 * rootViewDidChangeIntrinsicSize method of ABI8_0_0RCTRootViewDelegate is called.
 */
 ...
 */
@property (nonatomic, weak) id<ABI8_0_0RCTRootViewDelegate> delegate;

/**
 * The backing view controller of the root view.
 */
@property (nonatomic, weak) UIViewController *ReactABI8_0_0ViewController;

/**
 * The ReactABI8_0_0-managed contents view of the root view.
 */
