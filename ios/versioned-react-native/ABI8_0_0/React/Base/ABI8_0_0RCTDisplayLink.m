...
#define ABI8_0_0RCTAssertRunLoop() \
  ABI8_0_0RCTAssert(_runLoop == [NSRunLoop currentRunLoop], \
  @"This method must be called on the CADisplayLink run loop")

@implementation ABI8_0_0RCTDisplayLink
{
  CADisplayLink *_jsDisplayLink;
  NSMutableSet<ABI8_0_0RCTModuleData *> *_frameUpdateObservers;
  NSRunLoop *_runLoop;
}
...
{
  if (![moduleData.moduleClass conformsToProtocol:@protocol(ABI8_0_0RCTFrameUpdateObserver)] ||
  ...
  id<ABI8_0_0RCTFrameUpdateObserver> observer = (id<ABI8_0_0RCTFrameUpdateObserver>)module;
...
{
  ABI8_0_0RCTAssertRunLoop();

  ABI8_0_0RCT_PROFILE_BEGIN_EVENT(ABI8_0_0RCTProfileTagAlways, @"-[ABI8_0_0RCTDisplayLink _jsThreadUpdate:]", nil);

  ABI8_0_0RCTFrameUpdate *frameUpdate = [[ABI8_0_0RCTFrameUpdate alloc] initWithDisplayLink:displayLink];
  for (ABI8_0_0RCTModuleData *moduleData in _frameUpdateObservers) {
    id<ABI8_0_0RCTFrameUpdateObserver> observer = (id<ABI8_0_0RCTFrameUpdateObserver>)moduleData.instance;
    if (!observer.paused) {
  ...
  ABI8_0_0RCTProfileImmediateEvent(ABI8_0_0RCTProfileTagAlways, @"JS Thread Tick", displayLink.timestamp, 'g');

  ABI8_0_0RCT_PROFILE_END_EVENT(ABI8_0_0RCTProfileTagAlways, @"objc_call", nil);
}
