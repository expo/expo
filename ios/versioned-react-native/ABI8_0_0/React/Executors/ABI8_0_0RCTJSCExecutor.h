...
typedef void (^ABI8_0_0RCTJavaScriptValueCallback)(JSValue *result, NSError *error);

/**
 * Default name for the JS thread
 */
ABI8_0_0RCT_EXTERN NSString *const ABI8_0_0RCTJSCThreadName;
 ...
 */
ABI8_0_0RCT_EXTERN NSString *const ABI8_0_0RCTJavaScriptContextCreatedNotification;

/**
 * @experimental
 * May be used to pre-create the JSContext to make ABI8_0_0RCTJSCExecutor creation less costly.
 * Avoid using this; it's experimental and is not likely to be supported long-term.
 */
@interface ABI8_0_0RCTJSContextProvider : NSObject
 ...
 */
@interface ABI8_0_0RCTJSCExecutor : NSObject <ABI8_0_0RCTJavaScriptExecutor>

/**
 * Returns whether executor uses custom JSC library.
 * This value is used to initialize ABI8_0_0RCTJSCWrapper.
 * @default is NO.
 */
 ...
 * to initialize ABI8_0_0RCTJSCWrapper.
 */
- (instancetype)initWithUseCustomJSCLibrary:(BOOL)useCustomJSCLibrary;
 ...
 * the ABI8_0_0RCTJSStackTraceKey key.
 */
- (NSError *)errorForJSError:(JSValue *)jsError;

/**
 * @experimental
 * Pass a ABI8_0_0RCTJSContextProvider object to use an NSThread/JSContext pair that have already been created.
 ...
 */
+ (instancetype)initializedExecutorWithContextProvider:(ABI8_0_0RCTJSContextProvider *)JSContextProvider
...
- (void)callFunctionOnModule:(NSString *)module
             ...
             jsValueCallback:(ABI8_0_0RCTJavaScriptValueCallback)onComplete;
