...
#import "ABI8_0_0RCTTabBarManager.h"

#import "ABI8_0_0RCTBridge.h"
#import "ABI8_0_0RCTTabBar.h"

@implementation ABI8_0_0RCTConvert (UITabBar)

ABI8_0_0RCT_ENUM_CONVERTER(UITabBarItemPositioning, (@{
...
@implementation ABI8_0_0RCTTabBarManager

ABI8_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
  return [ABI8_0_0RCTTabBar new];
}

ABI8_0_0RCT_EXPORT_VIEW_PROPERTY(unselectedTintColor, UIColor)
...
ABI8_0_0RCT_EXPORT_VIEW_PROPERTY(itemPositioning, UITabBarItemPositioning)
