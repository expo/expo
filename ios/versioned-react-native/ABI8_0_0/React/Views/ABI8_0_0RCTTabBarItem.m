...
@implementation ABI8_0_0RCTConvert (UITabBarSystemItem)

ABI8_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI8_0_0RCTTabBarItem
...
{
  return self.superview.ReactABI8_0_0ViewController;
}
