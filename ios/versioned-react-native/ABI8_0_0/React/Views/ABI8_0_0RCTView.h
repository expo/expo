...
@protocol ABI8_0_0RCTAutoInsetsProtocol;

@class ABI8_0_0RCTView;

@interface ABI8_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI8_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI8_0_0RCTDirectEventBlock onMagicTap;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI8_0_0RCTPointerEvents pointerEvents;

+ (void)autoAdjustInsetsForView:(UIView<ABI8_0_0RCTAutoInsetsProtocol> *)parentView
...
/**
 * z-index, used to override sibling order in didUpdateReactABI8_0_0Subviews. This is
 * inherited from UIView+ReactABI8_0_0, but we override it here to reduce the boxing
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI8_0_0RCTBorderStyle borderStyle;
