...
#import "ABI8_0_0RCTMap.h"

#import "ABI8_0_0RCTEventDispatcher.h"
#import "ABI8_0_0RCTLog.h"
#import "ABI8_0_0RCTMapAnnotation.h"
#import "ABI8_0_0RCTMapOverlay.h"
#import "ABI8_0_0RCTUtils.h"
#import "UIView+ReactABI8_0_0.h"

const CLLocationDegrees ABI8_0_0RCTMapDefaultSpan = 0.005;
const NSTimeInterval ABI8_0_0RCTMapRegionChangeObserveInterval = 0.1;
const CGFloat ABI8_0_0RCTMapZoomBoundBuffer = 0.01;

@implementation ABI8_0_0RCTMap
{
  UIView *_legalLabel;
...
- (void)setAnnotations:(NSArray<ABI8_0_0RCTMapAnnotation *> *)annotations
{
  ...
  NSMutableArray<ABI8_0_0RCTMapAnnotation *> *annotationsToDelete = [NSMutableArray new];
  NSMutableArray<ABI8_0_0RCTMapAnnotation *> *annotationsToAdd = [NSMutableArray new];

  for (ABI8_0_0RCTMapAnnotation *annotation in annotations) {
    if (![annotation isKindOfClass:[ABI8_0_0RCTMapAnnotation class]]) {
      continue;
    }
  ...
  for (ABI8_0_0RCTMapAnnotation *annotation in self.annotations) {
    if (![annotation isKindOfClass:[ABI8_0_0RCTMapAnnotation class]]) {
      continue;
    }
...
- (void)setOverlays:(NSArray<ABI8_0_0RCTMapOverlay *> *)overlays
{
  ...
  for (ABI8_0_0RCTMapOverlay *overlay in overlays) {
    if (![overlay isKindOfClass:[ABI8_0_0RCTMapOverlay class]]) {
      continue;
    }
  ...
  for (ABI8_0_0RCTMapOverlay *overlay in self.overlays) {
    if (![overlay isKindOfClass:[ABI8_0_0RCTMapOverlay class]]) {
      continue;
    }
