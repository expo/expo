...
#import "ABI8_0_0RCTConvert+CoreLocation.h"
#import "ABI8_0_0RCTMapAnnotation.h"
#import "ABI8_0_0RCTMapOverlay.h"

@implementation ABI8_0_0RCTConvert(MapKit)
...
ABI8_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
{
  json = [self NSDictionary:json];
  ABI8_0_0RCTMapAnnotation *annotation = [ABI8_0_0RCTMapAnnotation new];
...
ABI8_0_0RCT_ARRAY_CONVERTER(ABI8_0_0RCTMapAnnotation)
...
+ (ABI8_0_0RCTMapOverlay *)ABI8_0_0RCTMapOverlay:(id)json
{
  ...
  ABI8_0_0RCTMapOverlay *overlay = [ABI8_0_0RCTMapOverlay polylineWithCoordinates:coordinates
...
ABI8_0_0RCT_ARRAY_CONVERTER(ABI8_0_0RCTMapOverlay)
