...
@implementation ABI8_0_0RCTI18nUtil

+ (id)sharedInstance {
   static ABI8_0_0RCTI18nUtil *sharedABI8_0_0RCTI18nUtilInstance = nil;
   @synchronized(self) {
     if (sharedABI8_0_0RCTI18nUtilInstance == nil)
      sharedABI8_0_0RCTI18nUtilInstance = [self new];
   }
   return sharedABI8_0_0RCTI18nUtilInstance;
}
...
- (BOOL)allowRTL
{
  BOOL rtlStatus = [[NSUserDefaults standardUserDefaults]
                            boolForKey:@"ABI8_0_0RCTI18nUtil_allowRTL"];
  return rtlStatus;
}

- (void)setAllowRTL:(BOOL)rtlStatus
{
  [[NSUserDefaults standardUserDefaults] setBool:rtlStatus forKey:@"ABI8_0_0RCTI18nUtil_allowRTL"];
