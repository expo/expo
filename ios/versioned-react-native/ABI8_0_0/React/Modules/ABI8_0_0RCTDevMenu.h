...
@class ABI8_0_0RCTDevMenuItem;

/**
 * Developer menu, useful for exposing extra functionality when debugging.
 */
@interface ABI8_0_0RCTDevMenu : NSObject

/**
 * Is the menu enabled. The menu is enabled by default if ABI8_0_0RCT_DEV=1, but
 ...
 */
@interface ABI8_0_0RCTDevMenuItem : NSObject
 ...
 * ABI8_0_0RCTBridge, which is useful for any class that needs to access the menu.
 */
@interface ABI8_0_0RCTBridge (ABI8_0_0RCTDevMenu)

@property (nonatomic, readonly) ABI8_0_0RCTDevMenu *devMenu;
