...
@implementation ABI8_0_0RCTExceptionsManager
{
                  ...
                  exceptionId:(nonnull NSNumber *)exceptionId)
{
  ...
  if (!ABI8_0_0RCT_DEBUG && reloadRetries < _maxReloadAttempts) {
    reloadRetries++;
    [[NSNotificationCenter defaultCenter] postNotificationName:ABI8_0_0RCTReloadNotification object:_bridge.baseBridge];
  } else {
    NSString *description = [@"Unhandled JS Exception: " stringByAppendingString:message];
    NSDictionary *errorInfo = @{ NSLocalizedDescriptionKey: description, ABI8_0_0RCTJSStackTraceKey: stack };
    ABI8_0_0RCTFatal([NSError errorWithDomain:ABI8_0_0RCTErrorDomain code:0 userInfo:errorInfo]);
  }
}
...
ABI8_0_0RCT_EXPORT_METHOD(reportUnhandledException:(NSString *)message
                  stack:(NSArray<NSDictionary *> *)stack)
{
