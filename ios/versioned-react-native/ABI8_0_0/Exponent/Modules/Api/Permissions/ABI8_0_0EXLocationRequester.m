...
@interface ABI8_0_0EXLocationRequester () <CLLocationManagerDelegate>
...
@implementation ABI8_0_0EXLocationRequester

+ (NSDictionary *)permissions
{
  ABI8_0_0EXPermissionStatus status;
  NSString *scope = @"none";
  
  CLAuthorizationStatus systemStatus = [CLLocationManager authorizationStatus];
  switch (systemStatus) {
    case kCLAuthorizationStatusAuthorizedWhenInUse: {
      status = ABI8_0_0EXPermissionStatusGranted;
      scope = @"whenInUse";
      break;
    }
    ...
    case kCLAuthorizationStatusDenied: case kCLAuthorizationStatusRestricted: {
      status = ABI8_0_0EXPermissionStatusDenied;
      break;
    }
    case kCLAuthorizationStatusNotDetermined: default: {
      status = ABI8_0_0EXPermissionStatusUndetermined;
      break;
    }
  }
...
- (void)requestPermissionsWithResolver:(ABI8_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI8_0_0RCTPromiseRejectBlock)reject
{
  ...
  if (existingPermissions && ![existingPermissions[@"status"] isEqualToString:[ABI8_0_0EXPermissions permissionStringForStatus:ABI8_0_0EXPermissionStatusUndetermined]]) {
