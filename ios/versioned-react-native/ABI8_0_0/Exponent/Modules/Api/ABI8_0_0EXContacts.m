...
#import "ABI8_0_0EXContacts.h"

@import AddressBook;

@interface ABI8_0_0EXContacts ()

@property (nonatomic, assign) ABAddressBookRef addressBookRef;

@end

@implementation ABI8_0_0EXContacts

ABI8_0_0RCT_EXPORT_MODULE(ExponentContacts);
 ...
 */
ABI8_0_0RCT_EXPORT_METHOD(getContactsAsync:(NSArray *)fields resolver:(ABI8_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI8_0_0RCTPromiseRejectBlock)reject)
{
...
- (void)_getContactsWithPermissionGrantedAsync: (NSArray *)fields addressBook:(ABAddressBookRef)addressBook resolver:(ABI8_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI8_0_0RCTPromiseRejectBlock)reject
{
