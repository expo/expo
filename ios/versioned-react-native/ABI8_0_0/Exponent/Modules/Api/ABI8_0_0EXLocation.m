...
NSString * const ABI8_0_0EXLocationChangedEventName = @"Exponent.locationChanged";

@interface ABI8_0_0EXLocationDelegate : NSObject <CLLocationManagerDelegate>
...
@implementation ABI8_0_0EXLocationDelegate
...
@interface ABI8_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI8_0_0EXLocationDelegate*> *delegates;

@end

@implementation ABI8_0_0EXLocation

ABI8_0_0RCT_EXPORT_MODULE(ExponentLocation)
...
{
  return @[ABI8_0_0EXLocationChangedEventName];
}


ABI8_0_0RCT_REMAP_METHOD(getCurrentPositionAsync,
...
ABI8_0_0RCT_REMAP_METHOD(watchPositionImplAsync,
                 ...
                 rejecter:(ABI8_0_0RCTPromiseRejectBlock)reject)
{
  ...
  locMgr.distanceFilter = options[@"distanceInterval"] ? [ABI8_0_0RCTConvert double:options[@"distanceInterval"]] ?: kCLDistanceFilterNone : kCLLocationAccuracyHundredMeters;
  locMgr.desiredAccuracy = [ABI8_0_0RCTConvert BOOL:options[@"enableHighAccuracy"]] ? kCLLocationAccuracyBest : kCLLocationAccuracyHundredMeters;

  __weak typeof(self) weakSelf = self;
  ABI8_0_0EXLocationDelegate *delegate = [[ABI8_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject) {
      ...
      [weakSelf sendEventWithName:ABI8_0_0EXLocationChangedEventName body:body];
    }
...
ABI8_0_0RCT_REMAP_METHOD(removeWatchAsync,
                 watchId:(nonnull NSNumber *)watchId
                 resolver:(ABI8_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI8_0_0RCTPromiseRejectBlock)reject)
{
  ABI8_0_0EXLocationDelegate *delegate = _delegates[watchId];
  if (delegate) {
