...
#import "ABI8_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI8_0_0EXFingerprint

ABI8_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI8_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI8_0_0RCTPromiseResolveBlock)resolve
...
ABI8_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI8_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI8_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI8_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
