...
@interface ABI8_0_0EXNotifications ()

@property (nonatomic, strong) NSString *experienceId;

@end

@implementation ABI8_0_0EXNotifications
...
ABI8_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
                 getExponentPushTokenAsyncWithResolver:(ABI8_0_0RCTPromiseResolveBlock)resolve
