...
Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |ss|
    ss.dependency            'ReactABI8_0_0/CSSLayout'
  ...
  s.subspec 'Exponent' do |ss|
    ss.dependency         'ReactABI8_0_0/Core'
  ...
  s.subspec 'RCTCameraRoll' do |ss|
    ss.dependency       'ReactABI8_0_0/Core'
    ss.dependency       'ReactABI8_0_0/RCTImage'
  ...
  s.subspec 'RCTImage' do |ss|
    ss.dependency       'ReactABI8_0_0/Core'
    ss.dependency       'ReactABI8_0_0/RCTNetwork'
