...
@implementation ABI8_0_0ARTText
...
static void ABI8_0_0ARTFreeTextFrame(ABI8_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI8_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI8_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI8_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI8_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
