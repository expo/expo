...
#import "ABI8_0_0RCTAssetsLibraryRequestHandler.h"
...
@implementation ABI8_0_0RCTAssetsLibraryRequestHandler
{
...
- (id)sendRequest:(NSURLRequest *)request
     withDelegate:(id<ABI8_0_0RCTURLRequestDelegate>)delegate
{
  ...
  [[self assetsLibrary] assetForURL:request.URL resultBlock:^(ALAsset *asset) {
    ...
    if (asset) {
      ...
      NSError *error = ABI8_0_0RCTErrorWithMessage(errorMessage);
      [delegate URLRequest:cancellationBlock didCompleteWithError:error];
    }
...
@implementation ABI8_0_0RCTBridge (ABI8_0_0RCTAssetsLibraryImageLoader)

- (ALAssetsLibrary *)assetsLibrary
{
  return [[self moduleForClass:[ABI8_0_0RCTAssetsLibraryRequestHandler class]] assetsLibrary];
}
