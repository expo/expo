...
#import "ABI8_0_0RCTPhotoLibraryImageLoader.h"
...
@implementation ABI8_0_0RCTPhotoLibraryImageLoader

ABI8_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI8_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI8_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI8_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI8_0_0RCTResizeModeContain) {
