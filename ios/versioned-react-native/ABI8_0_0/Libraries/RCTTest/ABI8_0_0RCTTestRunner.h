...
/**
 * Use the ABI8_0_0RCTInitRunnerForApp macro for typical usage. See FBSnapshotTestCase.h for more information
 * on how to configure the snapshotting system.
 */
#define ABI8_0_0RCTInitRunnerForApp(app__, moduleProvider__) \
[[ABI8_0_0RCTTestRunner alloc] initWithApp:(app__) \
...
@class ABI8_0_0RCTRootView;

@interface ABI8_0_0RCTTestRunner : NSObject
...
/**
 * Initialize a runner.  It's recommended that you use the ABI8_0_0RCTInitRunnerForApp
...
- (instancetype)initWithApp:(NSString *)app
         referenceDirectory:(NSString *)referenceDirectory
             moduleProvider:(NSArray<id<ABI8_0_0RCTBridgeModule>> *(^)(void))block NS_DESIGNATED_INITIALIZER;

/**
 * Simplest runTest function simply mounts the specified JS module with no
 * initialProps and waits for it to call
 *
 *   ABI8_0_0RCTTestModule.markTestCompleted()
 *
 * JS errors/exceptions and timeouts will fail the test.  Snapshot tests call
 * ABI8_0_0RCTTestModule.verifySnapshot whenever they want to verify what has been
