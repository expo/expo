...
typedef NS_ENUM(NSInteger, ABI8_0_0RCTTestStatus) {
  ABI8_0_0RCTTestStatusPending = 0,
  ABI8_0_0RCTTestStatusPassed,
  ABI8_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI8_0_0RCTTestModule : NSObject <ABI8_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI8_0_0RCTTestStatus status;
