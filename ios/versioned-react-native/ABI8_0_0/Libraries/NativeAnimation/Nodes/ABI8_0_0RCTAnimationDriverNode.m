...
@implementation ABI8_0_0RCTAnimationDriverNode
{
  ...
  ABI8_0_0RCTValueAnimatedNode *_valueNode;
  ABI8_0_0RCTResponseSenderBlock _callback;
}
...
- (instancetype)initWithId:(nonnull NSNumber *)animationId
                   ...
                   forNode:(nonnull ABI8_0_0RCTValueAnimatedNode *)valueNode
                  callBack:(nullable ABI8_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
...
- (void)stepAnimation
{
  ...
  CGFloat frameOutput = ABI8_0_0RCTInterpolateValue(currentDuration,
                                            fromInterval,
                                            toInterval,
...
{
  CGFloat outputValue = ABI8_0_0RCTInterpolateValue(frameOutput, 0, 1, _fromValue, _toValue);
