...
@interface ABI8_0_0RCTAnimatedNode : NSObject
...
@property (nonatomic, copy, readonly) NSDictionary<NSNumber *, ABI8_0_0RCTAnimatedNode *> *childNodes;
@property (nonatomic, copy, readonly) NSDictionary<NSNumber *, ABI8_0_0RCTAnimatedNode *> *parentNodes;
...
- (void)addChild:(ABI8_0_0RCTAnimatedNode *)child NS_REQUIRES_SUPER;
- (void)removeChild:(ABI8_0_0RCTAnimatedNode *)child NS_REQUIRES_SUPER;

- (void)onAttachedToNode:(ABI8_0_0RCTAnimatedNode *)parent NS_REQUIRES_SUPER;
- (void)onDetachedFromNode:(ABI8_0_0RCTAnimatedNode *)parent NS_REQUIRES_SUPER;
