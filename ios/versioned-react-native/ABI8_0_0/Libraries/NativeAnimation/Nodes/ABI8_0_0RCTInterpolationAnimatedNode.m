...
@implementation ABI8_0_0RCTInterpolationAnimatedNode
{
  __weak ABI8_0_0RCTValueAnimatedNode *_parentNode;
    ...
    for (id value in config[@"outputRange"]) {
      if ([value isKindOfClass:[NSNumber class]]) {
        ...
        if ([str hasSuffix:@"deg"]) {
          ...
          [outputRange addObject:@(ABI8_0_0RCTDegreesToRadians(degrees))];
        } else {
          // Assume radians
...
- (void)onAttachedToNode:(ABI8_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI8_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI8_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  CGFloat outputValue = ABI8_0_0RCTInterpolateValue(_parentNode.value,
