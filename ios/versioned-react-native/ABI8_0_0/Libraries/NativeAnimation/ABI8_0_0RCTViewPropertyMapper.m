...
@implementation ABI8_0_0RCTViewPropertyMapper
{
  CGFloat _translateX;
  CGFloat _translateY;
  CGFloat _scaleX;
  CGFloat _scaleY;
  CGFloat _rotation;
  ABI8_0_0RCTNativeAnimatedModule *_animationModule;
}

- (instancetype)initWithViewTag:(NSNumber *)viewTag
                animationModule:(ABI8_0_0RCTNativeAnimatedModule *)animationModule
{
  if ((self = [super init])) {
...
{
  if (updates.count) {
    UIView *view = [_animationModule.bridge.uiManager viewForReactABI8_0_0Tag:_viewTag];
    if (!view) {
      return;
    }
