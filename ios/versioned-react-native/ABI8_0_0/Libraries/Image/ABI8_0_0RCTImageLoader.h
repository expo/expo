...
typedef void (^ABI8_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI8_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI8_0_0RCTImageLoaderCancellationBlock;

@interface UIImage (ReactABI8_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI8_0_0KeyframeAnimation;

@end

@interface ABI8_0_0RCTImageLoader : NSObject <ABI8_0_0RCTBridgeModule, ABI8_0_0RCTURLRequestHandler>
...
@interface ABI8_0_0RCTImageLoader (Deprecated)
...
- (ABI8_0_0RCTImageLoaderCancellationBlock)decodeImageDataWithoutClipping:(NSData *)data
                                                             size:(CGSize)size
                                                            scale:(CGFloat)scale
                                                       resizeMode:(ABI8_0_0RCTResizeMode)resizeMode
                                                  completionBlock:(ABI8_0_0RCTImageLoaderCompletionBlock)completionBlock
...
@interface ABI8_0_0RCTBridge (ABI8_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI8_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI8_0_0RCTImageURLLoader <ABI8_0_0RCTBridgeModule>
...
/**
 * If more than one ABI8_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 * are also bridge modules, so should be registered using ABI8_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI8_0_0RCTImageDataDecoder <ABI8_0_0RCTBridgeModule>
...
/**
 * If more than one ABI8_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
