...
typedef void (^ABI9_0_0RCTJavaScriptValueCallback)(JSValue *result, NSError *error);

/**
 * Default name for the JS thread
 */
ABI9_0_0RCT_EXTERN NSString *const ABI9_0_0RCTJSCThreadName;
 ...
 */
ABI9_0_0RCT_EXTERN NSString *const ABI9_0_0RCTJavaScriptContextCreatedNotification;

/**
 * @experimental
 * May be used to pre-create the JSContext to make ABI9_0_0RCTJSCExecutor creation less costly.
 * Avoid using this; it's experimental and is not likely to be supported long-term.
 */
@interface ABI9_0_0RCTJSContextProvider : NSObject
 ...
 */
@interface ABI9_0_0RCTJSCExecutor : NSObject <ABI9_0_0RCTJavaScriptExecutor>

/**
 * Returns whether executor uses custom JSC library.
 * This value is used to initialize ABI9_0_0RCTJSCWrapper.
 * @default is NO.
 */
 ...
 * to initialize ABI9_0_0RCTJSCWrapper.
 */
- (instancetype)initWithUseCustomJSCLibrary:(BOOL)useCustomJSCLibrary;
 ...
 * the ABI9_0_0RCTJSStackTraceKey key.
 */
- (NSError *)errorForJSError:(JSValue *)jsError;

/**
 * @experimental
 * Pass a ABI9_0_0RCTJSContextProvider object to use an NSThread/JSContext pair that have already been created.
...
- (void)callFunctionOnModule:(NSString *)module
             ...
             jsValueCallback:(ABI9_0_0RCTJavaScriptValueCallback)onComplete;
