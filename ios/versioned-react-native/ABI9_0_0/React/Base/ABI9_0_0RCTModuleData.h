...
@interface ABI9_0_0RCTModuleData : NSObject <ABI9_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI9_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI9_0_0RCTBridgeModule> instance;
