...
@interface ABI9_0_0RCTImageSource ()

@property (nonatomic, assign) BOOL packagerAsset;

@end

@implementation ABI9_0_0RCTImageSource
...
{
  ABI9_0_0RCTImageSource *imageSource = [[ABI9_0_0RCTImageSource alloc] initWithURLRequest:_request
                                                                      size:size
                                                                     scale:scale];
...
- (BOOL)isEqual:(ABI9_0_0RCTImageSource *)object
{
  if (![object isKindOfClass:[ABI9_0_0RCTImageSource class]]) {
    return NO;
  }
...
@implementation ABI9_0_0RCTImageSource (Deprecated)
...
@implementation ABI9_0_0RCTConvert (ImageSource)
...
+ (ABI9_0_0RCTImageSource *)ABI9_0_0RCTImageSource:(id)json
{
  ...
  if ([json isKindOfClass:[NSDictionary class]]) {
    ...
    ABI9_0_0RCTLogConvertError(json, @"an image. Did you forget to call resolveAssetSource() on the JS side?");
    return nil;
  }

  ABI9_0_0RCTImageSource *imageSource = [[ABI9_0_0RCTImageSource alloc] initWithURLRequest:request
                                                               size:size
                                                              scale:scale];
