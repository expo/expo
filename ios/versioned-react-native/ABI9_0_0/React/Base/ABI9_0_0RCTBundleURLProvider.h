...
extern NSString *const ABI9_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI9_0_0RCTBundleURLProviderDefaultPort;

@interface ABI9_0_0RCTBundleURLProvider : NSObject
