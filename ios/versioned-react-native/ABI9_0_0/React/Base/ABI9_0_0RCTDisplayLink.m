...
#define ABI9_0_0RCTAssertRunLoop() \
  ABI9_0_0RCTAssert(_runLoop == [NSRunLoop currentRunLoop], \
  @"This method must be called on the CADisplayLink run loop")

@implementation ABI9_0_0RCTDisplayLink
{
  CADisplayLink *_jsDisplayLink;
  NSMutableSet<ABI9_0_0RCTModuleData *> *_frameUpdateObservers;
  NSRunLoop *_runLoop;
}
...
{
  if (![moduleData.moduleClass conformsToProtocol:@protocol(ABI9_0_0RCTFrameUpdateObserver)] ||
  ...
  id<ABI9_0_0RCTFrameUpdateObserver> observer = (id<ABI9_0_0RCTFrameUpdateObserver>)module;
...
{
  ABI9_0_0RCTAssertRunLoop();

  ABI9_0_0RCT_PROFILE_BEGIN_EVENT(ABI9_0_0RCTProfileTagAlways, @"-[ABI9_0_0RCTDisplayLink _jsThreadUpdate:]", nil);

  ABI9_0_0RCTFrameUpdate *frameUpdate = [[ABI9_0_0RCTFrameUpdate alloc] initWithDisplayLink:displayLink];
  for (ABI9_0_0RCTModuleData *moduleData in _frameUpdateObservers) {
    id<ABI9_0_0RCTFrameUpdateObserver> observer = (id<ABI9_0_0RCTFrameUpdateObserver>)moduleData.instance;
    if (!observer.paused) {
  ...
  ABI9_0_0RCTProfileImmediateEvent(ABI9_0_0RCTProfileTagAlways, @"JS Thread Tick", displayLink.timestamp, 'g');

  ABI9_0_0RCT_PROFILE_END_EVENT(ABI9_0_0RCTProfileTagAlways, @"objc_call", nil);
}
