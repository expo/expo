...
@protocol ABI9_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI9_0_0RCTBridge *)bridge;
 ...
 */
- (NSURL *)fallbackSourceURLForBridge:(ABI9_0_0RCTBridge *)bridge;

/**
 * The bridge initializes any registered ABI9_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray *)extraModulesForBridge:(ABI9_0_0RCTBridge *)bridge;
 ...
 */
- (void)loadSourceForBridge:(ABI9_0_0RCTBridge *)bridge
                  withBlock:(ABI9_0_0RCTSourceLoadBlock)loadCallback;
