...
@implementation ABI9_0_0RCTExceptionsManager
{
                  ...
                  exceptionId:(nonnull NSNumber *)exceptionId)
{
  ...
  if (!ABI9_0_0RCT_DEBUG && reloadRetries < _maxReloadAttempts) {
    reloadRetries++;
    [[NSNotificationCenter defaultCenter] postNotificationName:ABI9_0_0RCTReloadNotification object:_bridge.baseBridge];
  } else {
    NSString *description = [@"Unhandled JS Exception: " stringByAppendingString:message];
    NSDictionary *errorInfo = @{ NSLocalizedDescriptionKey: description, ABI9_0_0RCTJSStackTraceKey: stack };
    ABI9_0_0RCTFatal([NSError errorWithDomain:ABI9_0_0RCTErrorDomain code:0 userInfo:errorInfo]);
  }
}
...
ABI9_0_0RCT_EXPORT_METHOD(reportUnhandledException:(NSString *)message
                  stack:(NSArray<NSDictionary *> *)stack)
{
