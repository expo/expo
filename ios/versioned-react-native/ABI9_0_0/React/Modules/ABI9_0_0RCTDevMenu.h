 ...
 */
@interface ABI9_0_0RCTDevMenu : NSObject

/**
 * Is the menu enabled. The menu is enabled by default if ABI9_0_0RCT_DEV=1, but
 ...
 */
@interface ABI9_0_0RCTDevMenuItem : NSObject
 ...
 * ABI9_0_0RCTBridge, which is useful for any class that needs to access the menu.
 */
@interface ABI9_0_0RCTBridge (ABI9_0_0RCTDevMenu)

@property (nonatomic, readonly) ABI9_0_0RCTDevMenu *devMenu;
