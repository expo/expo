...
@interface ABI9_0_0RCTPicker() <UIPickerViewDataSource, UIPickerViewDelegate>
@end

@implementation ABI9_0_0RCTPicker
...
{
  return [ABI9_0_0RCTConvert NSString:_items[row][@"label"]];
}
      ...
      didSelectRow:(NSInteger)row inComponent:(__unused NSInteger)component
{
  ...
  if (_onChange) {
    _onChange(@{
      @"newIndex": @(row),
      @"newValue": ABI9_0_0RCTNullIfNil(_items[row][@"value"]),
    });
  }
}
