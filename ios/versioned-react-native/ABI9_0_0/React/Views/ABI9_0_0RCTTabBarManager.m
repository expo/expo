...
#import "ABI9_0_0RCTTabBarManager.h"

#import "ABI9_0_0RCTBridge.h"
#import "ABI9_0_0RCTTabBar.h"

@implementation ABI9_0_0RCTConvert (UITabBar)

ABI9_0_0RCT_ENUM_CONVERTER(UITabBarItemPositioning, (@{
...
@implementation ABI9_0_0RCTTabBarManager

ABI9_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
  return [ABI9_0_0RCTTabBar new];
}

ABI9_0_0RCT_EXPORT_VIEW_PROPERTY(unselectedTintColor, UIColor)
...
ABI9_0_0RCT_EXPORT_VIEW_PROPERTY(itemPositioning, UITabBarItemPositioning)
