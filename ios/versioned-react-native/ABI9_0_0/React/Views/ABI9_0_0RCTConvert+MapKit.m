...
#import "ABI9_0_0RCTConvert+MapKit.h"
#import "ABI9_0_0RCTConvert+CoreLocation.h"
#import "ABI9_0_0RCTMapAnnotation.h"
#import "ABI9_0_0RCTMapOverlay.h"

@implementation ABI9_0_0RCTConvert(MapKit)
...
ABI9_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
  @"standard": @(MKMapTypeStandard),
  @"satellite": @(MKMapTypeSatellite),
  @"hybrid": @(MKMapTypeHybrid),
}), MKMapTypeStandard, integerValue)

+ (ABI9_0_0RCTMapAnnotation *)ABI9_0_0RCTMapAnnotation:(id)json
{
  json = [self NSDictionary:json];
  ABI9_0_0RCTMapAnnotation *annotation = [ABI9_0_0RCTMapAnnotation new];
...
ABI9_0_0RCT_ARRAY_CONVERTER(ABI9_0_0RCTMapAnnotation)

+ (ABI9_0_0RCTMapOverlay *)ABI9_0_0RCTMapOverlay:(id)json
{
  json = [self NSDictionary:json];
  ...
  ABI9_0_0RCTMapOverlay *overlay = [ABI9_0_0RCTMapOverlay polylineWithCoordinates:coordinates
...
ABI9_0_0RCT_ARRAY_CONVERTER(ABI9_0_0RCTMapOverlay)
