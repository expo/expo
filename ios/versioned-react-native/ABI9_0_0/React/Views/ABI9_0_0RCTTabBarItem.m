...
@implementation ABI9_0_0RCTConvert (UITabBarSystemItem)

ABI9_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI9_0_0RCTTabBarItem
...
{
  return self.superview.ReactABI9_0_0ViewController;
}
