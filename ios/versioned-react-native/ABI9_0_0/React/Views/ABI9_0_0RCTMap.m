...
const CLLocationDegrees ABI9_0_0RCTMapDefaultSpan = 0.005;
const NSTimeInterval ABI9_0_0RCTMapRegionChangeObserveInterval = 0.1;
const CGFloat ABI9_0_0RCTMapZoomBoundBuffer = 0.01;

@implementation ABI9_0_0RCTMap
{
  UIView *_legalLabel;
...
- (void)setAnnotations:(NSArray<ABI9_0_0RCTMapAnnotation *> *)annotations
{
  ...
  NSMutableArray<ABI9_0_0RCTMapAnnotation *> *annotationsToDelete = [NSMutableArray new];
  NSMutableArray<ABI9_0_0RCTMapAnnotation *> *annotationsToAdd = [NSMutableArray new];

  for (ABI9_0_0RCTMapAnnotation *annotation in annotations) {
  ...
  for (ABI9_0_0RCTMapAnnotation *annotation in self.annotations) {
    if (![annotation isKindOfClass:[ABI9_0_0RCTMapAnnotation class]]) {
      continue;
    }
...
- (void)setOverlays:(NSArray<ABI9_0_0RCTMapOverlay *> *)overlays
{
  ...
  for (ABI9_0_0RCTMapOverlay *overlay in overlays) {
  ...
  for (ABI9_0_0RCTMapOverlay *overlay in self.overlays) {
    if (![overlay isKindOfClass:[ABI9_0_0RCTMapOverlay class]]) {
      continue;
    }
