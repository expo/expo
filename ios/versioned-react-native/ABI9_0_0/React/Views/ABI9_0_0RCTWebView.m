...
@property (nonatomic, copy) ABI9_0_0RCTDirectEventBlock onLoadingStart;
@property (nonatomic, copy) ABI9_0_0RCTDirectEventBlock onLoadingFinish;
@property (nonatomic, copy) ABI9_0_0RCTDirectEventBlock onLoadingError;
@property (nonatomic, copy) ABI9_0_0RCTDirectEventBlock onShouldStartLoadWithRequest;

@end

@implementation ABI9_0_0RCTWebView
{
  UIWebView *_webView;
...
- (void)reload
{
  NSURLRequest *request = [ABI9_0_0RCTConvert NSURLRequest:self.source];
...
- (void)setSource:(NSDictionary *)source
{
  if (![_source isEqualToDictionary:source]) {
    ...
    NSString *html = [ABI9_0_0RCTConvert NSString:source[@"html"]];
    if (html) {
      NSURL *baseURL = [ABI9_0_0RCTConvert NSURL:source[@"baseUrl"]];
      if (!baseURL) {
    ...
    NSURLRequest *request = [ABI9_0_0RCTConvert NSURLRequest:source];
    // Because of the way ReactABI9_0_0 works, as pages redirect, we actually end up
...
{
  BOOL isJSNavigation = [request.URL.scheme isEqualToString:ABI9_0_0RCTJSNavigationScheme];
