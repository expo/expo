...
#import "ABI9_0_0RCTHTTPRequestHandler.h"

@interface ABI9_0_0RCTHTTPRequestHandler () <NSURLSessionDataDelegate>

@end

@implementation ABI9_0_0RCTHTTPRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  dispatch_once(&onceToken, ^{
    // technically, ABI9_0_0RCTHTTPRequestHandler can handle file:// as well,
    // but it's less efficient than using ABI9_0_0RCTFileRequestHandler
...
- (NSURLSessionDataTask *)sendRequest:(NSURLRequest *)request
                         withDelegate:(id<ABI9_0_0RCTURLRequestDelegate>)delegate
{
  // Lazy setup
