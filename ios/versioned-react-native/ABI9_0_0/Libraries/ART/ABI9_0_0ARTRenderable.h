...
@interface ABI9_0_0ARTRenderable : ABI9_0_0ARTNode

@property (nonatomic, strong) ABI9_0_0ARTBrush *fill;
...
@property (nonatomic, assign) ABI9_0_0ARTCGFloatArray strokeDash;
