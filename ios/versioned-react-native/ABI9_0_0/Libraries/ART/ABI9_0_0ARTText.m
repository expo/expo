...
@implementation ABI9_0_0ARTText
...
static void ABI9_0_0ARTFreeTextFrame(ABI9_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI9_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI9_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI9_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI9_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
