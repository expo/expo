...
typedef NS_ENUM(NSInteger, ABI9_0_0RCTTestStatus) {
  ABI9_0_0RCTTestStatusPending = 0,
  ABI9_0_0RCTTestStatusPassed,
  ABI9_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI9_0_0RCTTestModule : NSObject <ABI9_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI9_0_0RCTTestStatus status;
