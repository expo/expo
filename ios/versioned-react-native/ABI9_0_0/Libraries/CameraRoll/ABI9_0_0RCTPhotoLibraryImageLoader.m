...
#import "ABI9_0_0RCTPhotoLibraryImageLoader.h"
...
@implementation ABI9_0_0RCTPhotoLibraryImageLoader

ABI9_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI9_0_0RCTImageLoader
...
- (ABI9_0_0RCTImageLoaderCancellationBlock)loadImageForURL:(NSURL *)imageURL
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                        resizeMode:(ABI9_0_0RCTResizeMode)resizeMode
                                   progressHandler:(ABI9_0_0RCTImageLoaderProgressBlock)progressHandler
                                 completionHandler:(ABI9_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI9_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI9_0_0RCTResizeModeContain) {
