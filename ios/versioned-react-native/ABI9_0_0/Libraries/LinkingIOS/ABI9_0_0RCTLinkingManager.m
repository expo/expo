...
#import "ABI9_0_0RCTLinkingManager.h"

#import "ABI9_0_0RCTBridge.h"
#import "ABI9_0_0RCTEventDispatcher.h"
#import "ABI9_0_0RCTUtils.h"

NSString *const ABI9_0_0RCTOpenURLNotification = @"ABI9_0_0RCTOpenURLNotification";

@implementation ABI9_0_0RCTLinkingManager
...
- (void)startObserving
{
  [[NSNotificationCenter defaultCenter] addObserver:self
                                           selector:@selector(handleOpenURLNotification:)
                                               name:ABI9_0_0RCTOpenURLNotification
                                             object:nil];
}
         ...
         annotation:(id)annotation
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI9_0_0RCTOpenURLNotification
                                                      object:self
                                                    userInfo:payload];
  return YES;
}
                  ...
                  reject:(__unused ABI9_0_0RCTPromiseRejectBlock)reject)
{
  ...
  BOOL canOpen = [ABI9_0_0RCTSharedApplication() canOpenURL:URL];
  resolve(@(canOpen));
}
                  ...
                  reject:(__unused ABI9_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve(ABI9_0_0RCTNullIfNil(initialURL.absoluteString));
}
