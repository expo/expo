...
typedef void (^ABI9_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI9_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI9_0_0RCTImageLoaderCancellationBlock;

@interface UIImage (ReactABI9_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI9_0_0KeyframeAnimation;

@end

@interface ABI9_0_0RCTImageLoader : NSObject <ABI9_0_0RCTBridgeModule, ABI9_0_0RCTURLRequestHandler>
...
@interface ABI9_0_0RCTImageLoader (Deprecated)
...
- (ABI9_0_0RCTImageLoaderCancellationBlock)decodeImageDataWithoutClipping:(NSData *)data
                                                             size:(CGSize)size
                                                            scale:(CGFloat)scale
                                                       resizeMode:(ABI9_0_0RCTResizeMode)resizeMode
                                                  completionBlock:(ABI9_0_0RCTImageLoaderCompletionBlock)completionBlock
...
@interface ABI9_0_0RCTBridge (ABI9_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI9_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI9_0_0RCTImageURLLoader <ABI9_0_0RCTBridgeModule>
...
/**
 * If more than one ABI9_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 * are also bridge modules, so should be registered using ABI9_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI9_0_0RCTImageDataDecoder <ABI9_0_0RCTBridgeModule>
...
/**
 * If more than one ABI9_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
