...
@class ABI9_0_0RCTValueAnimatedNode;

NS_ASSUME_NONNULL_BEGIN

@interface ABI9_0_0RCTAnimationDriverNode : NSObject
...
- (instancetype)initWithId:(NSNumber *)animationId
                   ...
                   forNode:(ABI9_0_0RCTValueAnimatedNode *)valueNode
                  callBack:(nullable ABI9_0_0RCTResponseSenderBlock)callback NS_DESIGNATED_INITIALIZER;
