...
@implementation ABI9_0_0RNSVGImage
{
    CGImageRef _image;
    CGFloat _imageRatio;
}
...
- (void)setSrc:(id)src
{
    ...
    ABI9_0_0RCTImageSource *source = [ABI9_0_0RCTConvert ABI9_0_0RCTImageSource:src];
    _imageRatio = source.size.width / source.size.height;
    _image = CGImageRetain([ABI9_0_0RCTConvert CGImage:src]);
    [self invalidate];
}
...
- (void)setMeetOrSlice:(ABI9_0_0RNSVGVBMOS)meetOrSlice
{
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    ABI9_0_0RNSVGViewBox *viewBox = [[ABI9_0_0RNSVGViewBox alloc] init];
