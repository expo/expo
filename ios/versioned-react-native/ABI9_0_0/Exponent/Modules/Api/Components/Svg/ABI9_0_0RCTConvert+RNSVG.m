...
ABI9_0_0RCT_ENUM_CONVERTER(ABI9_0_0RNSVGCGFCRule, (@{
                                     @"evenodd": @(kABI9_0_0RNSVGCGFCRuleEvenodd),
                                     @"nonzero": @(kABI9_0_0RNSVGCGFCRuleNonzero),
                                     }), kABI9_0_0RNSVGCGFCRuleNonzero, intValue)

ABI9_0_0RCT_ENUM_CONVERTER(ABI9_0_0RNSVGVBMOS, (@{
                                  @"meet": @(kABI9_0_0RNSVGVBMOSMeet),
                                  @"slice": @(kABI9_0_0RNSVGVBMOSSlice),
                                  @"none": @(kABI9_0_0RNSVGVBMOSNone)
                                  }), kABI9_0_0RNSVGVBMOSMeet, intValue)


// This takes a tuple of text lines and a font to generate a CTLine for each text line.
// This prepares everything for rendering a frame of text in ABI9_0_0RNSVGText.
+ (ABI9_0_0RNSVGTextFrame)ABI9_0_0RNSVGTextFrame:(id)json
{
    NSDictionary *dict = [self NSDictionary:json];
    ABI9_0_0RNSVGTextFrame frame;
    frame.count = 0;
    ...
    frame.lineHeight = size * 1.1; // Base on ABI9_0_0RNSVG canvas line height estimate
...
+ (ABI9_0_0RNSVGCGFloatArray)ABI9_0_0RNSVGCGFloatArray:(id)json
{
    ...
    ABI9_0_0RNSVGCGFloatArray array;
    array.count = count;
    array.array = nil;
...
+ (ABI9_0_0RNSVGBrush *)ABI9_0_0RNSVGBrush:(id)json
{
    ...
    switch (type) {
        case 0: // solid color
            ...
            return [[ABI9_0_0RNSVGSolidColorBrush alloc] initWithArray:arr];
        case 1: // brush
            return [[ABI9_0_0RNSVGBaseBrush alloc] initWithArray:arr];
        default:
        ...
        while (i < count) {
            ...
            switch (type) {
                ...
                case 3:
                    ...
                    break;
                default:
                    ABI9_0_0RCTLogError(@"Invalid ABI9_0_0RNSVGBezier type %zd at element %zd of %@", type, i, arr);
                    return nil;
            }
        }
    }
    @catch (NSException *exception) {
        ABI9_0_0RCTLogError(@"Invalid ABI9_0_0RNSVGBezier format: %@", arr);
        return nil;
    }
...
+ (CGGradientRef)CGGradient:(id)json offset:(NSUInteger)offset
{
    ...
    ABI9_0_0RNSVGCGFloatArray colorsAndOffsets = [self ABI9_0_0RNSVGCGFloatArray:arr];
