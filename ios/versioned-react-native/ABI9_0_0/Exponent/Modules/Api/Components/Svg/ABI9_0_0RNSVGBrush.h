...
@interface ABI9_0_0RNSVGBrush : NSObject
{
    NSArray *_points;
}
 ...
 * @abstract
 */
- (void)paint:(CGContextRef)context opacity:(CGFloat)opacity brushConverter:(ABI9_0_0RNSVGBrushConverter *)brushConverter;
