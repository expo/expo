...
#import "ABI9_0_0RNSVGBrushConverter.h"
#import "ABI9_0_0RNSVGPercentageConverter.h"

@implementation ABI9_0_0RNSVGBrushConverter

- (void)drawLinearGradient:(CGContextRef)context
{
    
    CGGradientRef gradient = CGGradientRetain([ABI9_0_0RCTConvert CGGradient:self.colors offset:0]);
    ...
    ABI9_0_0RNSVGPercentageConverter* convert = [[ABI9_0_0RNSVGPercentageConverter alloc] init];
