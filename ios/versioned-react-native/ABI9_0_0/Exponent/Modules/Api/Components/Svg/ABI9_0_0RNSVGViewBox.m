...
@implementation ABI9_0_0RNSVGViewBox
{
    BOOL _fromSymbol;
}
...
- (CGAffineTransform)getTransform
{
    ...
    ABI9_0_0RNSVGVBMOS meetOrSlice = self.meetOrSlice;
    ...
    // If align is 'none'
    if (meetOrSlice == kABI9_0_0RNSVGVBMOSNone) {
        ...
        if (![align isEqualToString: @"none"] && meetOrSlice == kABI9_0_0RNSVGVBMOSMeet) {
            scaleX = scaleY = fmin(scaleX, scaleY);
        } else if (![align isEqualToString: @"none"] && meetOrSlice == kABI9_0_0RNSVGVBMOSSlice) {
...
{
    if ([target isKindOfClass:[ABI9_0_0RNSVGUse class]]) {
        ABI9_0_0RNSVGUse *use = target;
        _fromSymbol = YES;
