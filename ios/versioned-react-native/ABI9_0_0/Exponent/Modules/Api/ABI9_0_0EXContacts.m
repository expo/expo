...
#import "ABI9_0_0EXContacts.h"

@import AddressBook;

@interface ABI9_0_0EXContacts ()

@property (nonatomic, assign) ABAddressBookRef addressBookRef;

@end

@implementation ABI9_0_0EXContacts

ABI9_0_0RCT_EXPORT_MODULE(ExponentContacts);
 ...
 */
ABI9_0_0RCT_EXPORT_METHOD(getContactsAsync:(NSArray *)fields resolver:(ABI9_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI9_0_0RCTPromiseRejectBlock)reject)
{
...
- (void)_getContactsWithPermissionGrantedAsync: (NSArray *)fields addressBook:(ABAddressBookRef)addressBook resolver:(ABI9_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI9_0_0RCTPromiseRejectBlock)reject
{
