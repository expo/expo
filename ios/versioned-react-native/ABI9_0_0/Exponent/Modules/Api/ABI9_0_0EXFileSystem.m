...
@implementation NSData (ABI9_0_0EXFileSystem)
...
@interface ABI9_0_0EXFileSystem ()
...
@implementation ABI9_0_0EXFileSystem
...
{
  if (self = [super init]) {
    NSString *subdir = [ABI9_0_0EXVersionManager escapedResourceName:experienceId];
...
ABI9_0_0RCT_REMAP_METHOD(downloadAsync,
...
ABI9_0_0RCT_REMAP_METHOD(getInfoAsync,
...
ABI9_0_0RCT_REMAP_METHOD(deleteAsync,
...
- (NSString *)scopedPathWithPath:(NSString *)path withOptions:(NSDictionary *)options
{
  ...
  if (![ABI9_0_0EXFileSystem ensureDirExistsWithPath:prefix]) {
    return nil;
  }
