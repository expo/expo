...
#import "ABI9_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI9_0_0EXFingerprint

ABI9_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI9_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI9_0_0RCTPromiseResolveBlock)resolve
...
ABI9_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI9_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI9_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI9_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
