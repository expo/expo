...
#if ABI9_0_0RCT_DEV
  // key commands
  SEL ABI9_0_0RCTCommandsSelector = NSSelectorFromString(@"ABI9_0_0RCT_keyCommands");
  SEL ABI9_0_0RCTSendActionSelector = NSSelectorFromString(@"ABI9_0_0RCT_sendAction:to:from:forEvent:");
...
- (void)setSystemMethods
{
  ...
  SEL ABI9_0_0RCTCommandsSelector = NSSelectorFromString(@"ABI9_0_0RCT_keyCommands");
  if ([UIDevice currentDevice].systemVersion.floatValue < 9) {
    ABI9_0_0EXSetInstanceMethod([UIApplication class],
                           @selector(keyCommands),
                           ABI9_0_0RCTCommandsSelector);
    ...
    ABI9_0_0EXSetInstanceMethod([UIResponder class],
                           @selector(keyCommands),
                           ABI9_0_0RCTCommandsSelector);
  }
