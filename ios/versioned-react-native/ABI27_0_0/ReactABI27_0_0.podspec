...
Pod::Spec.new do |s|
  ...
  s.subspec "Core" do |ss|
    ss.dependency             "yogaABI27_0_0", "#{package["version"]}.React"
    ss.dependency             "ReactABI27_0_0/ABI27_0_0fabric"
  ...
  s.subspec "DevSupport" do |ss|
    ss.dependency             "ReactABI27_0_0/Core"
    ss.dependency             "ReactABI27_0_0/RCTWebSocket"
  ...
  s.subspec "ABI27_0_0jschelpers" do |ss|
    ...
    ss.private_header_files = "ReactCommon/ABI27_0_0jschelpers/*.h"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\"" }
    ss.framework            = "JavaScriptCore"
  end

  s.subspec "ABI27_0_0jsinspector" do |ss|
    ss.source_files         = "ReactCommon/ABI27_0_0jsinspector/*.{cpp,h}"
    ss.private_header_files = "ReactCommon/ABI27_0_0jsinspector/*.h"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\"" }
  end

  s.subspec "ABI27_0_0PrivateDatabase" do |ss|
    ss.source_files         = "ReactCommon/ABI27_0_0privatedata/*.{cpp,h}"
    ss.private_header_files = "ReactCommon/ABI27_0_0privatedata/*.h"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\"" }
  end

  s.subspec "cxxReactABI27_0_0" do |ss|
    ...
    ss.private_header_files = "ReactCommon/cxxReactABI27_0_0/*.h"
  ...
  s.subspec "RCTAnimation" do |ss|
    ...
    ss.header_dir           = "ABI27_0_0RCTAnimation"
  end
  ...
  s.subspec "RCTImage" do |ss|
    ss.dependency             "ReactABI27_0_0/Core"
    ss.dependency             "ReactABI27_0_0/RCTNetwork"
  ...
  s.subspec "RCTWebSocket" do |ss|
    ss.dependency             "ReactABI27_0_0/Core"
    ss.dependency             "ReactABI27_0_0/RCTBlob"
    ss.dependency             "ReactABI27_0_0/fishhook"
  ...
  s.subspec "_ignore_me_subspec_for_linting_" do |ss|
    ss.dependency             "ReactABI27_0_0/Core"
    ss.dependency             "ReactABI27_0_0/CxxBridge"
  end
end
