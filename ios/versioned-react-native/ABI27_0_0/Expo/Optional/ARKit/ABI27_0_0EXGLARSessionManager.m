...
@interface ABI27_0_0EXGLARSessionManager ()
{
...
@property (nonatomic, assign) ABI27_0_0EXGLView *glView;
...
@implementation ABI27_0_0EXGLARSessionManager
...
- (NSDictionary *)startARSessionWithGLView:(ABI27_0_0EXGLView *)glView
{
  ...
  [_glView.glContext runAsync:^{
    ...
    // Create camera texture output ABI27_0_0EXGLObject
...
- (NSDictionary *)arMatricesForViewportSize:(CGSize)viewportSize zNear:(CGFloat)zNear zFar:(CGFloat)zFar
{
  ...
  return @{
    @"transform": [ABI27_0_0EXGLARSessionManager nsArrayForMatrix:transform],
    @"viewMatrix": [ABI27_0_0EXGLARSessionManager nsArrayForMatrix:viewMat],
    @"projectionMatrix": [ABI27_0_0EXGLARSessionManager nsArrayForMatrix:projMat],
  };
}
    ...
    for (int i = 0; i < anchors.count; i++) {
      if ([anchors[i] isKindOfClass:[ARPlaneAnchor class]]){
        ...
        [planes addObject:@{
                            ...
                            @"transform": [ABI27_0_0EXGLARSessionManager nsArrayForMatrix: planeAnchor.transform]
                            }];
      }
    }
