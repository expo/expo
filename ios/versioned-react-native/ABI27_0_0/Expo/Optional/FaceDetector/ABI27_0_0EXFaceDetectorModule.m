...
#import "ABI27_0_0EXFaceDetectorModule.h"
#import "ABI27_0_0EXFaceEncoder.h"
...
@implementation ABI27_0_0EXFaceDetectorModule
...
ABI27_0_0RCT_EXPORT_MODULE(ExpoFaceDetector);
...
{
  return [ABI27_0_0EXFaceDetectorUtils constantsToExport];
}

ABI27_0_0RCT_EXPORT_METHOD(detectFaces:(nonnull NSDictionary *)options
                     ...
                     rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  ...
  @try {
    ...
    ABI27_0_0EXFaceEncoder *faceEncoder = [[ABI27_0_0EXFaceEncoder alloc] init];
    ...
    resolve(@{
              ...
              @"image" : @{
                  ...
                  @"orientation" : @([ABI27_0_0EXFaceDetectorModule exifOrientationFor:image.imageOrientation])
                  }
              });
...
// the value of GMVImageOrientation is the same as the value defined by ABI27_0_0EXIF specifications, so we can adapt
