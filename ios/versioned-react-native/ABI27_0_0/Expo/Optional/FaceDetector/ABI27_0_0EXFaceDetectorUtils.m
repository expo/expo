//
//  ABI27_0_0EXFaceDetectorUtils.m
//  Exponent
//
...
#import "ABI27_0_0EXCameraUtils.h"
#import "ABI27_0_0EXFaceDetectorUtils.h"
#import "ABI27_0_0EXFaceDetectorPointTransformCalculator.h"

NSString *const ABI27_0_0EXGMVDataOutputWidthKey = @"Width";
NSString *const ABI27_0_0EXGMVDataOutputHeightKey = @"Height";

@implementation ABI27_0_0EXFaceDetectorUtils

+ (NSDictionary *)constantsToExport
{
  return @{
           @"Mode" : @{
               @"fast" : @(ABI27_0_0EXFaceDetectionFastMode),
               @"accurate" : @(ABI27_0_0EXFaceDetectionAccurateMode)
               },
           @"Landmarks" : @{
               @"all" : @(ABI27_0_0EXFaceDetectAllLandmarks),
               @"none" : @(ABI27_0_0EXFaceDetectNoLandmarks)
               },
           @"Classifications" : @{
               @"all" : @(ABI27_0_0EXFaceRunAllClassifications),
               @"none" : @(ABI27_0_0EXFaceRunNoClassifications)
               }
           };
}
...
{
  ABI27_0_0EXFaceDetectorPointTransformCalculator *calculator = [[ABI27_0_0EXFaceDetectorPointTransformCalculator alloc] initToTransformFromOrientation:deviceVideoOrientation toOrientation:interfaceVideoOrientation forVideoWidth:[width floatValue] andVideoHeight:[height floatValue]];
...
+ (CGAffineTransform)transformFromDeviceOutput:(GMVDataOutput *)dataOutput withInterfaceOrientation:(AVCaptureVideoOrientation)interfaceVideoOrientation
{
  ...
  CGFloat xScale = interfaceWidth / [(NSNumber *)dataOutput.videoSettings[ABI27_0_0EXGMVDataOutputHeightKey] floatValue];
  CGFloat yScale = interfaceHeight / [(NSNumber *)dataOutput.videoSettings[ABI27_0_0EXGMVDataOutputWidthKey] floatValue];
...
+ (CGAffineTransform)transformFromDeviceOutput:(GMVDataOutput *)dataOutput toInterfaceVideoOrientation:(AVCaptureVideoOrientation)interfaceVideoOrientation
{
  ...
  AVCaptureVideoOrientation deviceVideoOrientation = [ABI27_0_0EXCameraUtils videoOrientationForDeviceOrientation:currentDeviceOrientation];
  
  NSNumber *videoWidth = dataOutput.videoSettings[ABI27_0_0EXGMVDataOutputWidthKey];
  NSNumber *videoHeight = dataOutput.videoSettings[ABI27_0_0EXGMVDataOutputHeightKey];
