...
#if !TARGET_OS_TV
@implementation ABI27_0_0RCTConvert (ABI27_0_0EXStatusBar)

ABI27_0_0RCT_ENUM_CONVERTER(UIStatusBarStyle, (@{
  @"default": @(UIStatusBarStyleDefault),
  @"light-content": @(UIStatusBarStyleLightContent),
  @"dark-content": @(UIStatusBarStyleDefault),
}), UIStatusBarStyleDefault, integerValue);

ABI27_0_0RCT_ENUM_CONVERTER(UIStatusBarAnimation, (@{
...
@interface ABI27_0_0EXStatusBarManager ()

@property (nonatomic, strong) NSMutableDictionary *capturedStatusBarProperties;

@end

@implementation ABI27_0_0EXStatusBarManager

+ (NSString *)moduleName { return @"ABI27_0_0RCTStatusBarManager"; }
...
ABI27_0_0RCT_EXPORT_METHOD(getHeight:(ABI27_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@{
...
ABI27_0_0RCT_EXPORT_METHOD(setStyle:(UIStatusBarStyle)statusBarStyle
                  animated:(BOOL)animated)
{
  if ([[self class] _viewControllerBasedStatusBarAppearance]) {
    ABI27_0_0RCTLogError(@"ABI27_0_0RCTStatusBarManager module requires that the \
                UIViewControllerBasedStatusBarAppearance key in the Info.plist is set to NO");
  } else {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ABI27_0_0RCTSharedApplication() setStatusBarStyle:statusBarStyle
                                     animated:animated];
...
ABI27_0_0RCT_EXPORT_METHOD(setHidden:(BOOL)hidden
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ABI27_0_0RCTSharedApplication() setStatusBarHidden:hidden
...
ABI27_0_0RCT_EXPORT_METHOD(setNetworkActivityIndicatorVisible:(BOOL)visible)
{
  ABI27_0_0RCTSharedApplication().networkActivityIndicatorVisible = visible;
 ...
 */
ABI27_0_0RCT_REMAP_METHOD(_captureProperties,
                 _capturePropertiesWithResolver:(ABI27_0_0RCTPromiseResolveBlock)resolve
 ...
 *  Normally nobody should use this method because it bypasses the JS state used by the StatusBar component.
 */
ABI27_0_0RCT_EXPORT_METHOD(_applyPropertiesAndForget:(NSDictionary *)properties)
{
...
{
  UIApplication *currentApplication = ABI27_0_0RCTSharedApplication();
  return @{
