...
#import "ABI27_0_0EXImageManipulator.h"
#import "ABI27_0_0EXFileSystem.h"
#import "ABI27_0_0EXImageUtils.h"
#import <ReactABI27_0_0/ABI27_0_0RCTLog.h>

@implementation ABI27_0_0EXImageManipulator

ABI27_0_0RCT_EXPORT_MODULE(ExponentImageManipulator);
...
ABI27_0_0RCT_EXPORT_METHOD(manipulate:(NSString *)uri
                  ...
                  rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (!([self.bridge.scopedModules.fileSystem permissionsForURI:url] & ABI27_0_0EXFileSystemPermissionRead)) {
  ...
  for (NSDictionary *options in actions) {
    if (options[@"resize"]) {
      ...
      image = [ABI27_0_0EXImageUtils cropImage:image toRect:cropDimensions];
    }
  }
  ...
  if ([format isEqualToString:@"jpeg"]) {
    ...
    ABI27_0_0RCTLogWarn(@"Unsupported format: %@, using JPEG instead.", format);
    imageData = UIImageJPEGRepresentation(image, compressionValue);
    extension = @".jpg";
  }
