                             ...
                             rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  ...
  [_kernelUpdatesServiceDelegate updatesModule:self didRequestManifestWithCacheBehavior:ABI27_0_0EXCachedResourceNoCache success:^(NSDictionary * _Nonnull manifest) {
                          ...
                          rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  ...
  [_kernelUpdatesServiceDelegate updatesModule:self didRequestManifestWithCacheBehavior:ABI27_0_0EXCachedResourceWriteToCache success:^(NSDictionary * _Nonnull manifest) {
    NSString *currentRevisionId = _manifest[@"revisionId"];
    NSString *newRevisionId = manifest[@"revisionId"];
