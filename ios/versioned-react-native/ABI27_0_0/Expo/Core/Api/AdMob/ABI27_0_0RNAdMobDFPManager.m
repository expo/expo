#import "ABI27_0_0RNAdMobDFPManager.h"
...
@implementation ABI27_0_0RNAdMobDFPManager
...
- (UIView *)view
{
  return [[ABI27_0_0RNDFPBannerView alloc] init];
}
...
ABI27_0_0RCT_EXPORT_VIEW_PROPERTY(onAdmobDispatchAppEvent, ABI27_0_0RCTBubblingEventBlock)
