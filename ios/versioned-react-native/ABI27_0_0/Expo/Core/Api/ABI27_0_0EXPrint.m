...
#import "ABI27_0_0EXPrint.h"
#import <ReactABI27_0_0/ABI27_0_0RCTConvert.h>
#import <ReactABI27_0_0/ABI27_0_0RCTUtils.h>

@interface ABI27_0_0EXPrint () <UIPrintInteractionControllerDelegate, UIPrinterPickerControllerDelegate>

@end

@implementation ABI27_0_0EXPrint
...
ABI27_0_0RCT_EXPORT_MODULE(ExponentPrint);

ABI27_0_0RCT_EXPORT_METHOD(print:(NSDictionary *)options
                  ...
                  rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (options[@"uri"]) {
    NSString *uri = [ABI27_0_0RCTConvert NSString:options[@"uri"]];
    ...
    if (printData) {
      ...
      reject(@"E_URL_INVALID", message, ABI27_0_0RCTErrorWithMessage(message));
      return;
    }
  }
  
  if (options[@"html"]) {
    NSString *htmlString = [ABI27_0_0RCTConvert NSString:options[@"html"]];
    if (htmlString != nil) {
      ...
      reject(@"E_HTML_INVALID", message, ABI27_0_0RCTErrorWithMessage(message));
      return;
    }
  }
  ...
  if (options[@"printerUrl"]){
    printerURL = [NSURL URLWithString:[ABI27_0_0RCTConvert NSString:options[@"printerUrl"]]];
...
ABI27_0_0RCT_EXPORT_METHOD(selectPrinter:(ABI27_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
...
{
  return ABI27_0_0RCTPresentedViewController();
}
