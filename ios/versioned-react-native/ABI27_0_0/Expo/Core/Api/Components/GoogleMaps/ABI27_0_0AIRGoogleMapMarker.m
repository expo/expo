...
#import "ABI27_0_0AIRDummyView.h"
...
@interface ABI27_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI27_0_0AIRGMSMarker*)marker;
@end

@implementation ABI27_0_0AIRGoogleMapMarker {
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI27_0_0AIRGMSMarker alloc] init];
...
- (void)insertReactABI27_0_0Subview:(id<ABI27_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI27_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI27_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI27_0_0AIRDummyView *dummySubview = [[ABI27_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertReactABI27_0_0Subview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeReactABI27_0_0Subview:(id<ABI27_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI27_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeReactABI27_0_0Subview:(UIView*)dummySubview];
}
...
- (ABI27_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/airbnb/ReactABI27_0_0-native-maps/issues/738)
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI27_0_0RN?
