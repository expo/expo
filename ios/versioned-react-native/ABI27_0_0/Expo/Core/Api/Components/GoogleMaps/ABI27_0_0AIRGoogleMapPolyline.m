//
//  ABI27_0_0AIRGoogleMapPolyline.m
//
//  Created by Nick Italiano on 10/22/16.
//
#import <UIKit/UIKit.h>
#import "ABI27_0_0AIRGoogleMapPolyline.h"
#import "ABI27_0_0AIRGMSPolyline.h"
...
@implementation ABI27_0_0AIRGoogleMapPolyline

- (instancetype)init
{
  if (self = [super init]) {
    _polyline = [[ABI27_0_0AIRGMSPolyline alloc] init];
  }
  return self;
}
...
- (void)setOnPress:(ABI27_0_0RCTBubblingEventBlock)onPress {
