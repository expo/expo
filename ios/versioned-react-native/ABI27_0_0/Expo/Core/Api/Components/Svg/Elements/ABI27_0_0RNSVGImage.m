...
@implementation ABI27_0_0RNSVGImage
{
    CGImageRef _image;
    CGSize _imageSize;
}
...
- (void)setSrc:(id)src
{
    ...
    _image = CGImageRetain([ABI27_0_0RCTConvert CGImage:src]);
    ABI27_0_0RCTImageSource *source = [ABI27_0_0RCTConvert ABI27_0_0RCTImageSource:src];
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    CGAffineTransform viewbox = [ABI27_0_0RNSVGViewBox getTransform:imageBounds eRect:hitArea align:self.align meetOrSlice:self.meetOrSlice];
