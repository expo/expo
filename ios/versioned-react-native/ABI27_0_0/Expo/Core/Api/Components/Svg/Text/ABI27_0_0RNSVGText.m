...
@implementation ABI27_0_0RNSVGText
{
    ABI27_0_0RNSVGText *_textRoot;
    ABI27_0_0RNSVGGlyphContext *_glyphContext;
}
...
{
    _glyphContext = [[ABI27_0_0RNSVGGlyphContext alloc] initWithScale:1 width:[self getContextWidth]
                                                   height:[self getContextHeight]];
}

// release the cached CGPathRef for ABI27_0_0RNSVGTSpan
- (void)releaseCachedPath
{
    [self traverseSubviews:^BOOL(__kindof ABI27_0_0RNSVGNode *node) {
        ABI27_0_0RNSVGText *text = node;
...
- (ABI27_0_0RNSVGText *)getTextRoot
{
    if (!_textRoot) {
        _textRoot = self;
        while (_textRoot && [_textRoot class] != [ABI27_0_0RNSVGText class]) {
            if (![_textRoot isKindOfClass:[ABI27_0_0RNSVGText class]]) {
                //todo: throw exception here
                break;
            }
            _textRoot = (ABI27_0_0RNSVGText*)[_textRoot superview];
        }
    }
...
- (NSString*) getAlignmentBaseline
{
    ...
    while (parent != nil) {
        if ([parent isKindOfClass:[ABI27_0_0RNSVGText class]]) {
            ABI27_0_0RNSVGText* node = (ABI27_0_0RNSVGText*)parent;
    ...
    if (self.alignmentBaseline == nil) {
        self.alignmentBaseline = ABI27_0_0RNSVGAlignmentBaselineStrings[0];
    }
    return self.alignmentBaseline;
}
