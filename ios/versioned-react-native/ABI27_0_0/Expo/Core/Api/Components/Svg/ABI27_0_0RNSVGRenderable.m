...
@implementation ABI27_0_0RNSVGRenderable
{
...
- (void)setFill:(ABI27_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI27_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI27_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    if (self.stroke) {
        ...
        ABI27_0_0RNSVGCGFloatArray dash = self.strokeDasharrayData;
...
- (void)mergeProperties:(__kindof ABI27_0_0RNSVGRenderable *)target
{
