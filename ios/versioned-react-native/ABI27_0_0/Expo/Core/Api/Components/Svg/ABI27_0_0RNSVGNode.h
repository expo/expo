...
/**
 * ABI27_0_0RNSVG nodes are implemented as base UIViews. They should be implementation for all basic
 ＊interfaces for all non-defination nodes.
 */

@interface ABI27_0_0RNSVGNode : UIView
 ...
 */
extern CGFloat const ReactABI27_0_0M_SQRT1_2l;
extern CGFloat const ABI27_0_0RNSVG_DEFAULT_FONT_SIZE;

@property (nonatomic, strong) NSString *name;
@property (nonatomic, assign) CGFloat opacity;
@property (nonatomic, assign) ABI27_0_0RNSVGCGFCRule clipRule;
...
/**
 * get ABI27_0_0RNSVGSvgView which ownes current ABI27_0_0RNSVGNode
 */
