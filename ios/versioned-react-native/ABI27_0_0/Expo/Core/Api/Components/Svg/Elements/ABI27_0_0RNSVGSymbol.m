...
@implementation ABI27_0_0RNSVGSymbol
...
- (void)renderSymbolTo:(CGContextRef)context width:(CGFloat)width height:(CGFloat)height
{
    if (self.align) {
        ...
        CGAffineTransform viewBoxTransform = [ABI27_0_0RNSVGViewBox getTransform:CGRectMake(self.minX, self.minY, self.vbWidth, self.vbHeight)
                                                                  eRect:eRect
                                                                  align:self.align
