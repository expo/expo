...
@implementation ABI27_0_0RNSVGBezierElement
- (instancetype) init
{
    self = [super init];
    if (self)
    {
        ...
        _point = ABI27_0_0RNSVGNULLPOINT;
        _controlPoint1 = ABI27_0_0RNSVGNULLPOINT;
        _controlPoint2 = ABI27_0_0RNSVGNULLPOINT;
    }
    return self;
}
...
{
    ABI27_0_0RNSVGBezierElement *newElement = [[self alloc] init];
...
// Convert one element to ABI27_0_0RNSVGBezierElement and save to array
void ReactABI27_0_0GetBezierElements(void *info, const CGPathElement *element)
{
    NSMutableArray *bezierElements = (__bridge NSMutableArray *)info;
    if (element)
        [bezierElements addObject:[ABI27_0_0RNSVGBezierElement elementWithPathElement:*element]];
}
...
+ (NSArray *) elementsFromCGPath:(CGPathRef)path
{
    ...
    CGPathApply(path, (__bridge void *)elements, ReactABI27_0_0GetBezierElements);
    return elements;
}
