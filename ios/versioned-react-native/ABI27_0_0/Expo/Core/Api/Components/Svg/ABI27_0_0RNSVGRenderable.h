...
@interface ABI27_0_0RNSVGRenderable : ABI27_0_0RNSVGNode

@property (nonatomic, strong) ABI27_0_0RNSVGBrush *fill;
@property (nonatomic, assign) CGFloat fillOpacity;
@property (nonatomic, assign) ABI27_0_0RNSVGCGFCRule fillRule;
@property (nonatomic, strong) ABI27_0_0RNSVGBrush *stroke;
...
@property (nonatomic, assign) ABI27_0_0RNSVGCGFloatArray strokeDasharrayData;
