...
#import "ABI27_0_0RNLongPressHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ReactABI27_0_0/ABI27_0_0RCTConvert.h>

@interface ABI27_0_0RNBetterLongPressGestureRecognizer : UILongPressGestureRecognizer

- (id)initWithGestureHandler:(ABI27_0_0RNGestureHandler*)gestureHandler;

@end

@implementation ABI27_0_0RNBetterLongPressGestureRecognizer {
...
@implementation ABI27_0_0RNLongPressGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI27_0_0RNBetterLongPressGestureRecognizer alloc] initWithGestureHandler:self];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    if (prop != nil) {
        recognizer.minimumPressDuration = [ABI27_0_0RCTConvert CGFloat:prop] / 1000.0;
    }

    prop = config[@"maxDist"];
    if (prop != nil) {
        recognizer.allowableMovement = [ABI27_0_0RCTConvert CGFloat:prop];
    }
}

- (ABI27_0_0RNGestureHandlerState)state
{
    ...
    if (_recognizer.state == UIGestureRecognizerStateBegan) {
        return ABI27_0_0RNGestureHandlerStateActive;
    }
    return [super state];
}
