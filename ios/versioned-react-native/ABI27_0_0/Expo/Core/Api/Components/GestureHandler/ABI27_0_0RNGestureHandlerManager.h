...
@interface ABI27_0_0RNGestureHandlerManager : NSObject

- (nonnull instancetype)initWithUIManager:(nonnull ABI27_0_0RCTUIManager *)uiManager
                          eventDispatcher:(nonnull ABI27_0_0RCTEventDispatcher *)eventDispatcher;
