#import "ABI27_0_0RNGestureHandlerEvents.h"

#define SAFE_VELOCITY(velocity) @(isnan(velocity) ? 0 : velocity)

@implementation ABI27_0_0RNGestureHandlerEventExtraData
...
{
    return [[ABI27_0_0RNGestureHandlerEventExtraData alloc]
            initWithData:@{
                           @"x": @(position.x),
                           @"y": @(position.y),
...
{
    return [[ABI27_0_0RNGestureHandlerEventExtraData alloc] initWithData:@{@"pointerInside": @(pointerInside)}];
}

@end


@implementation ABI27_0_0RNGestureHandlerEvent
{
    NSNumber *_handlerTag;
    ABI27_0_0RNGestureHandlerState _state;
    ABI27_0_0RNGestureHandlerEventExtraData *_extraData;
}
...
- (instancetype)initWithRactTag:(NSNumber *)ReactABI27_0_0Tag
                     handlerTag:(NSNumber *)handlerTag
                      ...
                      extraData:(ABI27_0_0RNGestureHandlerEventExtraData *)extraData
{
...
{
    return @"ABI27_0_0RCTEventEmitter.receiveEvent";
}
...
@implementation ABI27_0_0RNGestureHandlerStateChange
{
    NSNumber *_handlerTag;
    ABI27_0_0RNGestureHandlerState _state;
    ABI27_0_0RNGestureHandlerState _prevState;
    ABI27_0_0RNGestureHandlerEventExtraData *_extraData;
}
