...
@implementation ABI27_0_0RCTConvert (AirMap)
...
ABI27_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI27_0_0AIRMapCoordinate *)ABI27_0_0AIRMapCoordinate:(id)json
{
    ABI27_0_0AIRMapCoordinate *coord = [ABI27_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI27_0_0RCT_ARRAY_CONVERTER(ABI27_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI27_0_0AIRMapCoordinate *> *> *)ABI27_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI27_0_0RCTConvertArrayValue(@selector(ABI27_0_0AIRMapCoordinateArray:), json);
}
