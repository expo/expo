...
@interface ABI27_0_0AIRMapMarker : MKAnnotationView <MKAnnotation>

@property (nonatomic, strong) ABI27_0_0AIRMapCallout *calloutView;
...
@property (nonatomic, copy) ABI27_0_0RCTDirectEventBlock onSelect;
@property (nonatomic, copy) ABI27_0_0RCTDirectEventBlock onDeselect;
@property (nonatomic, copy) ABI27_0_0RCTDirectEventBlock onCalloutPress;
...
- (void)fillCalloutView:(ABI27_0_0SMCalloutView *)calloutView;
...
@interface ABI27_0_0AIREmptyCalloutBackgroundView : ABI27_0_0SMCalloutBackgroundView
@end
