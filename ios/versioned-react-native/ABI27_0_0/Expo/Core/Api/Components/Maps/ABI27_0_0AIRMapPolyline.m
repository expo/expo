...
#import "ABI27_0_0AIRMapPolylineRenderer.h"
#import <ReactABI27_0_0/UIView+ReactABI27_0_0.h>


@implementation ABI27_0_0AIRMapPolyline {
...
- (void)setStrokeColors:(NSArray<UIColor *> *)strokeColors {
    ...
    if ((self.renderer != nil) && ![_renderer isKindOfClass:[ABI27_0_0AIRMapPolylineRenderer class]]) {
...
- (void)setCoordinates:(NSArray<ABI27_0_0AIRMapCoordinate *> *)coordinates {
...
- (MKOverlayPathRenderer*)createRenderer {
    ...
    if (self.strokeColors == nil) {
        ...
        return [[ABI27_0_0AIRMapPolylineRenderer alloc] initWithOverlay:self polyline:self.polyline];
    }
}
...
- (void) updateRenderer:(MKOverlayPathRenderer*)renderer {
    ...
    if ([renderer isKindOfClass:[ABI27_0_0AIRMapPolylineRenderer class]]) {
        ((ABI27_0_0AIRMapPolylineRenderer*)renderer).strokeColors = _strokeColors;
    }
}
...
#pragma mark ABI27_0_0AIRMapSnapshot implementation

- (void) drawToSnapshot:(MKMapSnapshot *) snapshot context:(CGContextRef) context
{
    ABI27_0_0AIRMapPolylineRenderer* renderer = [[ABI27_0_0AIRMapPolylineRenderer alloc] initWithSnapshot:snapshot overlay:self polyline:self.polyline];
