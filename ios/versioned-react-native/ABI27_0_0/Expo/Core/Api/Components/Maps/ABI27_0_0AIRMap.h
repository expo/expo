...
extern const CLLocationDegrees ABI27_0_0AIRMapDefaultSpan;
extern const NSTimeInterval ABI27_0_0AIRMapRegionChangeObserveInterval;
extern const CGFloat ABI27_0_0AIRMapZoomBoundBuffer;
extern const NSInteger ABI27_0_0AIRMapMaxZoomLevel;

@interface ABI27_0_0AIRMap: MKMapView<ABI27_0_0SMCalloutViewDelegate>

@property (nonatomic, strong) ABI27_0_0SMCalloutView *calloutView;
...
@property (nonatomic, copy) ABI27_0_0RCTBubblingEventBlock onPanDrag;
@property (nonatomic, copy) ABI27_0_0RCTBubblingEventBlock onLongPress;
@property (nonatomic, copy) ABI27_0_0RCTDirectEventBlock onMarkerPress;
@property (nonatomic, copy) ABI27_0_0RCTDirectEventBlock onMarkerSelect;
@property (nonatomic, copy) ABI27_0_0RCTDirectEventBlock onMarkerDeselect;
@property (nonatomic, copy) ABI27_0_0RCTDirectEventBlock onMarkerDragStart;
@property (nonatomic, copy) ABI27_0_0RCTDirectEventBlock onMarkerDrag;
@property (nonatomic, copy) ABI27_0_0RCTDirectEventBlock onMarkerDragEnd;
