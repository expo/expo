...
#if __has_include("ABI27_0_0EXGLARSessionManager.h")
#import "ABI27_0_0EXGLARSessionManager.h"
#else
#import "ABI27_0_0EXGLARSessionManagerStub.h"
#endif

@interface ABI27_0_0EXGLView ()

@property (nonatomic, weak) ABI27_0_0EXGLViewManager *viewManager;
...
@implementation ABI27_0_0EXGLView
...
- (instancetype)initWithManager:(ABI27_0_0EXGLViewManager *)viewManager
{
  if ((self = [super init])) {
    ...
    self.contentScaleFactor = ABI27_0_0RCTScreenScale();
    ...
    ABI27_0_0EXGLObjectManager *objectManager = [viewManager.bridge moduleForClass:[ABI27_0_0EXGLObjectManager class]];
    _glContext = [[ABI27_0_0EXGLContext alloc] initWithDelegate:self andManager:objectManager];
...
- (void)setOnSurfaceCreate:(ABI27_0_0RCTDirectEventBlock)onSurfaceCreate
{
...
- (void)draw
{
  ...
  // called on the JS thread to create the ABI27_0_0EXGL context and save its id (see ABI27_0_0EXGLContext.initializeContextWithBridge method).
...
#pragma mark - ABI27_0_0EXGLContextDelegate
...
{
  Class sessionManagerClass = NSClassFromString(@"ABI27_0_0EXGLARSessionManager");
