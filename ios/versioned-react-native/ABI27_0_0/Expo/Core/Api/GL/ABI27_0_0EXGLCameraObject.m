...
@interface ABI27_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) ABI27_0_0EXCamera *camera;
...
@implementation ABI27_0_0EXGLCameraObject

- (instancetype)initWithView:(ABI27_0_0EXGLView *)glView andCamera:(ABI27_0_0EXCamera *)camera
{
