...
#import "ABI27_0_0EXPedometer.h"
#import "ABI27_0_0EXUnversioned.h"

#import <CoreMotion/CoreMotion.h>

NSString * const ABI27_0_0EXPedometerUpdateEventName = @"Exponent.pedometerUpdate";

@implementation ABI27_0_0EXPedometer
{
...
- (void)setBridge:(ABI27_0_0RCTBridge *)bridge
{
  ...
  _watchHandler = ^(CMPedometerData * _Nullable pedometerData, NSError * _Nullable error) {
    ...
    [weakSelf sendEventWithName:ABI27_0_0EXPedometerUpdateEventName
...
ABI27_0_0RCT_EXPORT_MODULE(ExponentPedometer)

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI27_0_0EXPedometerUpdateEventName];
}

ABI27_0_0RCT_EXPORT_METHOD(getStepCountAsync:(nonnull NSNumber *)startTime
...
ABI27_0_0RCT_EXPORT_METHOD(watchStepCount)
{
  if (!_pedometer) {
    _pedometer = [CMPedometer new];
  }
...
ABI27_0_0RCT_EXPORT_METHOD(stopWatchingStepCount)
{
  _watchStartDate = nil;
  _isWatching = NO;
  [_pedometer stopPedometerUpdates];
...
ABI27_0_0RCT_EXPORT_METHOD(isAvailableAsync:(ABI27_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
