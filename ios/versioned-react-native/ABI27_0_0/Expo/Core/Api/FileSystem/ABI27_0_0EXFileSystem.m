...
NSString * const ABI27_0_0EXDownloadProgressEventName = @"Exponent.downloadProgress";

@interface ABI27_0_0EXDownloadResumable : NSObject

@property (nonatomic, strong) NSString *uuid;
@property (nonatomic, strong) NSURLSession *session;
@property (nonatomic, strong) ABI27_0_0EXDownloadDelegate *delegate;

@end

@implementation ABI27_0_0EXDownloadResumable

- (instancetype)initWithId:(NSString *)uuid
               withSession:(NSURLSession *)session
              withDelegate:(ABI27_0_0EXDownloadDelegate *)delegate;
  {
    if ((self = [super init])) {
      _uuid = uuid;
      _session = session;
...
@interface ABI27_0_0EXFileSystem ()

@property (nonatomic, strong) NSMutableDictionary<NSString *, ABI27_0_0EXDownloadResumable*> *downloadObjects;
@property (nonatomic, weak) id<ABI27_0_0EXFileSystemScopedModuleDelegate> kernelFileSystemDelegate;

@end

ABI27_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI27_0_0EXFileSystem, fileSystem)

@implementation NSData (ABI27_0_0EXFileSystem)
...
@implementation ABI27_0_0EXFileSystem

ABI27_0_0EX_EXPORT_SCOPED_MODULE(ExponentFileSystem, FileSystemManager);
...
- (instancetype)initWithExperienceId:(NSString *)experienceId kernelServiceDelegate:(id)kernelServiceInstance params:(NSDictionary *)params
{
  if (self = [super initWithExperienceId:experienceId kernelServiceDelegate:kernelServiceInstance params:params]) {
    ...
    [ABI27_0_0EXFileSystem ensureDirExistsWithPath:_documentDirectory];
    [ABI27_0_0EXFileSystem ensureDirExistsWithPath:_cachesDirectory];
  }
  return self;
}
...
{
  return @[ABI27_0_0EXDownloadProgressEventName];
}

ABI27_0_0RCT_REMAP_METHOD(getInfoAsync,
...
{
  if (!([self permissionsForURI:uri] & ABI27_0_0EXFileSystemPermissionRead)) {
  ...
  if ([uri.scheme isEqualToString:@"file"]) {
    [ABI27_0_0EXFileSystemLocalFileHandler getInfoForFile:uri withOptions:options resolver:resolve rejecter:reject];
  } else if ([uri.scheme isEqualToString:@"assets-library"]) {
    [ABI27_0_0EXFileSystemAssetLibraryHandler getInfoForFile:uri withOptions:options resolver:resolve rejecter:reject];
  } else {
...
ABI27_0_0RCT_REMAP_METHOD(readAsStringAsync,
...
ABI27_0_0RCT_REMAP_METHOD(writeAsStringAsync,
                 ...
                 rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  if (!([self permissionsForURI:uri] & ABI27_0_0EXFileSystemPermissionWrite)) {
    reject(@"E_FILESYSTEM_PERMISSIONS",
...
ABI27_0_0RCT_REMAP_METHOD(deleteAsync,
                 deleteAsyncWithURI:(NSURL *)uri
                 withOptions:(NSDictionary *)options
                 resolver:(ABI27_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  if (!([self permissionsForURI:[uri URLByAppendingPathComponent:@".."]] & ABI27_0_0EXFileSystemPermissionWrite)) {
    reject(@"E_FILESYSTEM_PERMISSIONS",
...
ABI27_0_0RCT_REMAP_METHOD(moveAsync,
                 ...
                 rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:[from URLByAppendingPathComponent:@".."]] & ABI27_0_0EXFileSystemPermissionWrite)) {
    reject(@"E_FILESYSTEM_PERMISSIONS",
  ...
  if (!([self permissionsForURI:to] & ABI27_0_0EXFileSystemPermissionWrite)) {
    reject(@"E_FILESYSTEM_PERMISSIONS",
...
ABI27_0_0RCT_REMAP_METHOD(copyAsync,
                 ...
                 rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:from] & ABI27_0_0EXFileSystemPermissionRead)) {
    reject(@"E_FILESYSTEM_PERMISSIONS",
  ...
  if ([from.scheme isEqualToString:@"file"]) {
    [ABI27_0_0EXFileSystemLocalFileHandler copyFrom:from to:to resolver:resolve rejecter:reject];
  } else if ([from.scheme isEqualToString:@"assets-library"]) {
    [ABI27_0_0EXFileSystemAssetLibraryHandler copyFrom:from to:to resolver:resolve rejecter:reject];
  } else {
    reject(@"E_FILESYSTEM_INVALID_URI",
           [NSString stringWithFormat:@"Unsupported URI scheme for '%@'", from],
           nil);
...
ABI27_0_0RCT_REMAP_METHOD(makeDirectoryAsync,
...
ABI27_0_0RCT_REMAP_METHOD(readDirectoryAsync,
...
ABI27_0_0RCT_REMAP_METHOD(downloadAsync,
                 ...
                 rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  if (!([self permissionsForURI:localUri] & ABI27_0_0EXFileSystemPermissionWrite)) {
    reject(@"E_FILESYSTEM_PERMISSIONS",
...
ABI27_0_0RCT_REMAP_METHOD(downloadResumableStartAsync,
                 ...
                 rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (!([self _permissionsForPath:path] & ABI27_0_0EXFileSystemPermissionWrite)) {
    reject(@"E_FILESYSTEM_PERMISSIONS",
  ...
  NSData *resumeData = data ? [ABI27_0_0RCTConvert NSData:data]:nil;
...
ABI27_0_0RCT_REMAP_METHOD(downloadResumablePauseAsync,
                 downloadResumablePauseAsyncWithUUID:(NSString *)uuid
                 resolver:(ABI27_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  ABI27_0_0EXDownloadResumable *downloadResumable = (ABI27_0_0EXDownloadResumable *)self.downloadObjects[uuid];
...
- (void)_downloadResumableCreateSessionWithUrl:(NSURL *)url withScopedPath:(NSString *)scopedPath withUUID:(NSString *)uuid withOptions:(NSDictionary *)options withResumeData:(NSData * _Nullable)resumeData withResolver:(ABI27_0_0RCTPromiseResolveBlock)resolve withRejecter:(ABI27_0_0RCTPromiseRejectBlock)reject
{
  NSURLSessionConfiguration *sessionConfiguration = [NSURLSessionConfiguration defaultSessionConfiguration];
  sessionConfiguration.requestCachePolicy = NSURLRequestReloadIgnoringLocalCacheData;
  sessionConfiguration.URLCache = nil;
  ...
  ABI27_0_0EXDownloadDelegate *downloadDelegate = [[ABI27_0_0EXDownloadDelegate alloc] initWithId:uuid
                                                                        onWrite:^(NSURLSessionDownloadTask *task, int64_t bytesWritten, int64_t totalBytesWritten, int64_t totalBytesExpectedToWrite) {
    if(bytesWritten > 0)
      [weakSelf sendEventWithName:ABI27_0_0EXDownloadProgressEventName
                             body:@{@"uuid":uuid,
                                    @"data":@{
    ...
    if (!data) {
      reject(@"E_UNABLE_TO_SAVE",
             nil,
             ABI27_0_0RCTErrorWithMessage(@"Unable to save file to local URI"));
      return;
    }
    NSMutableDictionary *result = [NSMutableDictionary dictionary];
  ...
  ABI27_0_0EXDownloadResumable *downloadResumable = [[ABI27_0_0EXDownloadResumable alloc] initWithId:uuid
                                                                       withSession:session
...
- (ABI27_0_0EXFileSystemPermissionFlags)_permissionsForPath:(NSString *)path
{
  path = [path stringByStandardizingPath];
  if ([path hasPrefix:[_documentDirectory stringByAppendingString:@"/"]]) {
    return ABI27_0_0EXFileSystemPermissionRead | ABI27_0_0EXFileSystemPermissionWrite;
  }
  ...
  if (bundleDirectory != nil && [path hasPrefix:[bundleDirectory stringByAppendingString:@"/"]]) {
    return ABI27_0_0EXFileSystemPermissionRead;
  }
  return ABI27_0_0EXFileSystemPermissionNone;
}
...
{
  NSString *subdir = [ABI27_0_0EXUtil escapedResourceName:experienceId];
