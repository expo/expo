...
#import "ABI27_0_0EXMailComposer.h"
...
@interface ABI27_0_0EXMailComposer ()
...
@implementation ABI27_0_0EXMailComposer

ABI27_0_0RCT_EXPORT_MODULE(ExponentMailComposer);
...
ABI27_0_0RCT_EXPORT_METHOD(composeAsync:(NSDictionary *)options
                  ...
                  rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    [ABI27_0_0RCTPresentedViewController() presentViewController:composeController animated:YES completion:nil];
  });
}
