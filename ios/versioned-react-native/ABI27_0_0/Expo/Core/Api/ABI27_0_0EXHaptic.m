...
#import "ABI27_0_0EXHaptic.h"

#if !TARGET_OS_TV
@implementation ABI27_0_0RCTConvert (UINotificationFeedback)

ABI27_0_0RCT_ENUM_CONVERTER(UINotificationFeedbackType, (@{
...
@implementation ABI27_0_0RCTConvert (UIImpactFeedback)
ABI27_0_0RCT_ENUM_CONVERTER(UIImpactFeedbackStyle, (@{
...
@implementation ABI27_0_0EXHaptic

ABI27_0_0RCT_EXPORT_MODULE(ExponentHaptic);
