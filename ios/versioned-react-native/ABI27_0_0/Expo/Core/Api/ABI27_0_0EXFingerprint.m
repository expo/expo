...
#import "ABI27_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI27_0_0EXFingerprint

ABI27_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI27_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI27_0_0RCTPromiseResolveBlock)resolve
...
ABI27_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI27_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI27_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
