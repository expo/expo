...
@implementation ABI27_0_0EXContacts

ABI27_0_0EX_EXPORT_SCOPED_MODULE(ExponentContacts, PermissionsManager);
 ...
 */
ABI27_0_0RCT_EXPORT_METHOD(getContactsAsync:(NSDictionary *)options resolver:(ABI27_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  if (!_contactStore) {
    _contactStore = [[CNContactStore alloc] init];
  }

  if ([ABI27_0_0EXPermissions statusForPermissions:[ABI27_0_0EXContactsRequester permissions]] != ABI27_0_0EXPermissionStatusGranted ||
