#import "ABI27_0_0RNAWSCognito.h"
...
@implementation ABI27_0_0RNAWSCognito
...
ABI27_0_0RCT_EXPORT_METHOD(computeModPow:(NSDictionary *)values
    ...
    if (result) {
        ...
        callback(@[@[ABI27_0_0RCTMakeError(@"computeModPow error", nil, nil)], [NSNull null]]);
    }
}

ABI27_0_0RCT_EXPORT_METHOD(computeS:(NSDictionary *)values
                  callback:(ABI27_0_0RCTResponseSenderBlock)callback) {
    ...
    if (result) {
        ...
        callback(@[@[ABI27_0_0RCTMakeError(@"computeS error", nil, nil)], [NSNull null]]);
    }
}
