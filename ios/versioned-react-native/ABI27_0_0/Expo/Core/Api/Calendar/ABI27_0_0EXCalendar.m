...
#import "ABI27_0_0EXCalendar.h"
#import "ABI27_0_0EXCalendarConverter.h"
...
@implementation ABI27_0_0EXCalendar

@synthesize bridge = _bridge;

ABI27_0_0EX_EXPORT_SCOPED_MODULE(ExponentCalendar, PermissionsManager);
...
ABI27_0_0RCT_EXPORT_METHOD(getCalendarsAsync:(NSString *)typeString resolver:(ABI27_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI27_0_0EXPermissions statusForPermissions:[ABI27_0_0EXCalendarRequester permissions]] != ABI27_0_0EXPermissionStatusGranted ||
  ...
  resolve([ABI27_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI27_0_0RCT_EXPORT_METHOD(saveCalendarAsync:(NSDictionary *)details resolver:(ABI27_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI27_0_0EXPermissions statusForPermissions:[ABI27_0_0EXCalendarRequester permissions]] != ABI27_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  NSString *title = [ABI27_0_0RCTConvert NSString:details[@"title"]];
  NSNumber *color = [ABI27_0_0RCTConvert NSNumber:details[@"color"]];
  NSString *sourceId = [ABI27_0_0RCTConvert NSString:details[@"sourceId"]];
  NSString *type = [ABI27_0_0RCTConvert NSString:details[@"entityType"]];
  NSString *calendarId = [ABI27_0_0RCTConvert NSString:details[@"id"]];
  ...
  if (color) {
    calendar.CGColor = [ABI27_0_0RCTConvert UIColor:color].CGColor;
...
ABI27_0_0RCT_EXPORT_METHOD(deleteCalendarAsync:(NSString *)calendarId resolver:(ABI27_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI27_0_0EXPermissions statusForPermissions:[ABI27_0_0EXCalendarRequester permissions]] != ABI27_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
...
ABI27_0_0RCT_EXPORT_METHOD(getEventsAsync:(NSDate *)startDate endDate:(NSDate *)endDate calendars:(NSArray *)calendars resolver:(ABI27_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI27_0_0EXPermissions statusForPermissions:[ABI27_0_0EXCalendarRequester permissions]] != ABI27_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  if (calendarEvents) {
    resolve([ABI27_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI27_0_0RCT_EXPORT_METHOD(getEventByIdAsync:(NSString *)eventId startDate:(NSDate *)startDate resolver:(ABI27_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI27_0_0EXPermissions statusForPermissions:[ABI27_0_0EXCalendarRequester permissions]] != ABI27_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  if (calendarEvent) {
    resolve([ABI27_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI27_0_0RCT_EXPORT_METHOD(saveEventAsync:(NSDictionary *)details options:(NSDictionary *)options resolver:(ABI27_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI27_0_0EXPermissions statusForPermissions:[ABI27_0_0EXCalendarRequester permissions]] != ABI27_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  if (details[@"calendarId"]) {
    calendarId = [ABI27_0_0RCTConvert NSString:details[@"calendarId"]];
  }
  NSString *eventId = [ABI27_0_0RCTConvert NSString:details[@"id"]];
  NSString *title = [ABI27_0_0RCTConvert NSString:details[@"title"]];
  NSString *location = [ABI27_0_0RCTConvert NSString:details[@"location"]];
  NSDate *startDate = [ABI27_0_0RCTConvert NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI27_0_0RCTConvert NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI27_0_0RCTConvert NSDate:details[@"instanceStartDate"]];
  NSNumber *allDay = [ABI27_0_0RCTConvert NSNumber:details[@"allDay"]];
  NSString *notes = [ABI27_0_0RCTConvert NSString:details[@"notes"]];
  NSString *timeZone = [ABI27_0_0RCTConvert NSString:details[@"timeZone"]];
  NSString *url = [ABI27_0_0RCTConvert NSString:details[@"url"]];
  NSArray *alarms = [ABI27_0_0RCTConvert NSArray:details[@"alarms"]];
  NSDictionary *recurrenceRule = [ABI27_0_0RCTConvert NSDictionary:details[@"recurrenceRule"]];
  NSString *availability = [ABI27_0_0RCTConvert NSString:details[@"availability"]];
  ...
  if (recurrenceRule) {
    NSString *frequency = [ABI27_0_0RCTConvert NSString:recurrenceRule[@"frequency"]];
    NSInteger interval = [ABI27_0_0RCTConvert NSInteger:recurrenceRule[@"interval"]];
    NSInteger occurrence = [ABI27_0_0RCTConvert NSInteger:recurrenceRule[@"occurrence"]];
    NSDate *endDate = nil;
    if (recurrenceRule[@"endDate"]) {
      endDate = [ABI27_0_0RCTConvert NSDate:recurrenceRule[@"endDate"]];
    }
...
ABI27_0_0RCT_EXPORT_METHOD(deleteEventAsync:(NSDictionary *)event options:(NSDictionary *)options resolver:(ABI27_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI27_0_0EXPermissions statusForPermissions:[ABI27_0_0EXCalendarRequester permissions]] != ABI27_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  NSDate *instanceStartDate = [ABI27_0_0RCTConvert NSDate:event[@"instanceStartDate"]];
...
ABI27_0_0RCT_EXPORT_METHOD(getAttendeesForEventAsync:(NSDictionary *)event resolver:(ABI27_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI27_0_0EXPermissions statusForPermissions:[ABI27_0_0EXCalendarRequester permissions]] != ABI27_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  if (item.hasAttendees) {
    resolve([ABI27_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI27_0_0RCT_EXPORT_METHOD(getRemindersAsync:(NSDate * _Nullable)startDate endDate:(NSDate * _Nullable)endDate calendars:(NSArray *)calendars status:(NSString * _Nullable)status resolver:(ABI27_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI27_0_0EXPermissions statusForPermissions:[ABI27_0_0EXRemindersRequester permissions]] != ABI27_0_0EXPermissionStatusGranted ||
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI27_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI27_0_0RCT_EXPORT_METHOD(getReminderByIdAsync:(NSString *)reminderId resolver:(ABI27_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI27_0_0EXPermissions statusForPermissions:[ABI27_0_0EXRemindersRequester permissions]] != ABI27_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"reminders" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing reminders permission.", nil);
  ...
  if (reminder) {
    ...
    resolve([ABI27_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI27_0_0RCT_EXPORT_METHOD(saveReminderAsync:(NSDictionary *)details resolver:(ABI27_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI27_0_0EXPermissions statusForPermissions:[ABI27_0_0EXRemindersRequester permissions]] != ABI27_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"reminders" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing reminders permission.", nil);
  ...
  NSString *reminderId = [ABI27_0_0RCTConvert NSString:details[@"id"]];
  NSDate *startDate = [ABI27_0_0RCTConvert NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI27_0_0RCTConvert NSDate:details[@"dueDate"]];
  NSNumber *completed = [ABI27_0_0RCTConvert NSNumber:details[@"completed"]];
  NSDate *completionDate = [ABI27_0_0RCTConvert NSDate:details[@"completionDate"]];
  NSString *title = [ABI27_0_0RCTConvert NSString:details[@"title"]];
  NSString *location = [ABI27_0_0RCTConvert NSString:details[@"location"]];
  NSString *notes = [ABI27_0_0RCTConvert NSString:details[@"notes"]];
  NSString *timeZone = [ABI27_0_0RCTConvert NSString:details[@"timeZone"]];
...
ABI27_0_0RCT_EXPORT_METHOD(deleteReminderAsync:(NSString *)reminderId resolver:(ABI27_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI27_0_0EXPermissions statusForPermissions:[ABI27_0_0EXRemindersRequester permissions]] != ABI27_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"reminders" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing reminders permission.", nil);
...
ABI27_0_0RCT_EXPORT_METHOD(getSourcesAsync:(ABI27_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI27_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI27_0_0RCT_EXPORT_METHOD(getSourceByIdAsync:(NSString *)sourceId resolver:(ABI27_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI27_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve([ABI27_0_0EXCalendarConverter serializeSource:source]);
}
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI27_0_0RCTConvert NSDate:alarm[@"absoluteDate"]];
  NSNumber *relativeOffset = [ABI27_0_0RCTConvert NSNumber:alarm[@"relativeOffset"]];
