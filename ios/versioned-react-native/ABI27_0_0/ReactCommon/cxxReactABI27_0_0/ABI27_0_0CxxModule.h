...
public:
   ...
   */
  void setInstance(std::weak_ptr<ReactABI27_0_0::Instance> instance) {
    instance_ = instance;
  }
   ...
   */
  std::weak_ptr<ReactABI27_0_0::Instance> getInstance() {
    return instance_;
  }

private:
  std::weak_ptr<ReactABI27_0_0::Instance> instance_;
};
