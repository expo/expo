...
struct ABI27_0_0YGCollectFlexItemsRowValues {
  uint32_t itemsOnLine;
  float sizeConsumedOnCurrentLine;
  float totalFlexGrowFactors;
  float totalFlexShrinkScaledFactors;
  float endOfLineIndex;
  std::vector<ABI27_0_0YGNodeRef> relativeChildren;
...
// ABI27_0_0YGUndefined then the max funtion should return the other argument as the max
// value. We wouldn't have needed a custom max function if ABI27_0_0YGUndefined was NAN
...
// ABI27_0_0YGUndefined then the min funtion should return the other argument as the min
// value. We wouldn't have needed a custom min function if ABI27_0_0YGUndefined was NAN
...
// ABI27_0_0YGFloatsEqual, as the default float comparision operator will not work(Look
// at the comments of ABI27_0_0YGFloatsEqual function).
template <std::size_t size>
bool ABI27_0_0YGFloatArrayEqual(
    const std::array<float, size>& val1,
    const std::array<float, size>& val2) {
  bool areEqual = true;
  for (std::size_t i = 0; i < size && areEqual; ++i) {
    areEqual = ABI27_0_0YGFloatsEqual(val1[i], val2[i]);
  }
  return areEqual;
}
...
inline bool ABI27_0_0YGFlexDirectionIsRow(const ABI27_0_0YGFlexDirection flexDirection) {
  return flexDirection == ABI27_0_0YGFlexDirectionRow ||
      flexDirection == ABI27_0_0YGFlexDirectionRowReverse;
}

inline float ABI27_0_0YGResolveValue(const ABI27_0_0YGValue value, const float parentSize) {
  switch (value.unit) {
...
inline bool ABI27_0_0YGFlexDirectionIsColumn(const ABI27_0_0YGFlexDirection flexDirection) {
  return flexDirection == ABI27_0_0YGFlexDirectionColumn ||
      flexDirection == ABI27_0_0YGFlexDirectionColumnReverse;
}

inline ABI27_0_0YGFlexDirection ABI27_0_0YGResolveFlexDirection(
    const ABI27_0_0YGFlexDirection flexDirection,
    const ABI27_0_0YGDirection direction) {
  if (direction == ABI27_0_0YGDirectionRTL) {
    if (flexDirection == ABI27_0_0YGFlexDirectionRow) {
      return ABI27_0_0YGFlexDirectionRowReverse;
    } else if (flexDirection == ABI27_0_0YGFlexDirectionRowReverse) {
      return ABI27_0_0YGFlexDirectionRow;
    }
  }
...
static inline float ABI27_0_0YGResolveValueMargin(
    const ABI27_0_0YGValue value,
    const float parentSize) {
  return value.unit == ABI27_0_0YGUnitAuto ? 0 : ABI27_0_0YGResolveValue(value, parentSize);
}
