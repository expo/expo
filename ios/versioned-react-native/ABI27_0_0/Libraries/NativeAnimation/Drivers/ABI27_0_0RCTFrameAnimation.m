...
@interface ABI27_0_0RCTFrameAnimation ()
...
@implementation ABI27_0_0RCTFrameAnimation
{
...
{
  NSNumber *toValue = [ABI27_0_0RCTConvert NSNumber:config[@"toValue"]] ?: @1;
  NSArray<NSNumber *> *frames = [ABI27_0_0RCTConvert NSNumberArray:config[@"frames"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  NSUInteger startIndex = floor(currentDuration / ABI27_0_0RCTSingleFrameInterval);
  ...
  NSTimeInterval fromInterval = startIndex * ABI27_0_0RCTSingleFrameInterval;
  NSTimeInterval toInterval = nextIndex * ABI27_0_0RCTSingleFrameInterval;
  ...
  CGFloat frameOutput = ABI27_0_0RCTInterpolateValue(currentDuration,
                                            fromInterval,
                                            toInterval,
                                            fromFrameValue.doubleValue,
                                            toFrameValue.doubleValue,
                                            ABI27_0_0EXTRAPOLATE_TYPE_EXTEND,
                                            ABI27_0_0EXTRAPOLATE_TYPE_EXTEND);
...
{
  CGFloat outputValue = ABI27_0_0RCTInterpolateValue(frameOutput,
                                            0,
                                            1,
                                            _fromValue,
                                            _toValue,
