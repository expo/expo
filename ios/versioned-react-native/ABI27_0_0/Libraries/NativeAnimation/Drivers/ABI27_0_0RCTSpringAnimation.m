...
#import "ABI27_0_0RCTSpringAnimation.h"
...
@interface ABI27_0_0RCTSpringAnimation ()
...
@implementation ABI27_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
                  ...
                  callBack:(nullable ABI27_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _lastVelocity = [ABI27_0_0RCTConvert CGFloat:config[@"initialVelocity"]];
...
- (void)resetAnimationConfig:(NSDictionary *)config
{
  ...
  _toValue = [ABI27_0_0RCTConvert CGFloat:config[@"toValue"]];
  _overshootClamping = [ABI27_0_0RCTConvert BOOL:config[@"overshootClamping"]];
  _restDisplacementThreshold = [ABI27_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
  _restSpeedThreshold = [ABI27_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
  _stiffness = [ABI27_0_0RCTConvert CGFloat:config[@"stiffness"]];
  _damping = [ABI27_0_0RCTConvert CGFloat:config[@"damping"]];
  _mass = [ABI27_0_0RCTConvert CGFloat:config[@"mass"]];
