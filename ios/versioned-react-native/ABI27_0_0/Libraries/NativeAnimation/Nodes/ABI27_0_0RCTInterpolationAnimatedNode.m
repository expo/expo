...
#import "ABI27_0_0RCTInterpolationAnimatedNode.h"

#import "ABI27_0_0RCTAnimationUtils.h"

@implementation ABI27_0_0RCTInterpolationAnimatedNode
{
  __weak ABI27_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI27_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI27_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI27_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI27_0_0RCTInterpolateValueInRange(inputValue,
                                          _inputRange,
                                          _outputRange,
                                          _extrapolateLeft,
                                          _extrapolateRight);
