...
@implementation ABI27_0_0RCTAnimatedNode
{
  NSMapTable<NSNumber *, ABI27_0_0RCTAnimatedNode *> *_childNodes;
  NSMapTable<NSNumber *, ABI27_0_0RCTAnimatedNode *> *_parentNodes;
}
...
- (NSMapTable<NSNumber *, ABI27_0_0RCTAnimatedNode *> *)childNodes
{
  return _childNodes;
}

- (NSMapTable<NSNumber *, ABI27_0_0RCTAnimatedNode *> *)parentNodes
{
  return _parentNodes;
}

- (void)addChild:(ABI27_0_0RCTAnimatedNode *)child
{
  if (!_childNodes) {
...
- (void)removeChild:(ABI27_0_0RCTAnimatedNode *)child
{
  if (!_childNodes) {
    return;
  }
...
- (void)onAttachedToNode:(ABI27_0_0RCTAnimatedNode *)parent
{
  if (!_parentNodes) {
...
- (void)onDetachedFromNode:(ABI27_0_0RCTAnimatedNode *)parent
{
  if (!_parentNodes) {
    return;
  }
...
- (void)detachNode
{
  for (ABI27_0_0RCTAnimatedNode *parent in _parentNodes.objectEnumerator) {
    [parent removeChild:self];
  }
  for (ABI27_0_0RCTAnimatedNode *child in _childNodes.objectEnumerator) {
