...
#import "ABI27_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI27_0_0/ABI27_0_0RCTConvert.h>
#import <ReactABI27_0_0/ABI27_0_0RCTImageStoreManager.h>
#import <ReactABI27_0_0/ABI27_0_0RCTRootView.h>
#import <ReactABI27_0_0/ABI27_0_0RCTUtils.h>

@interface ABI27_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI27_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI27_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI27_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI27_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI27_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI27_0_0RCTResponseSenderBlock)callback)
{
...
ABI27_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI27_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI27_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI27_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI27_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI27_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI27_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI27_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI27_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI27_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI27_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI27_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI27_0_0RCTNullIfNil(height), ABI27_0_0RCTNullIfNil(width)]];
    return;
  }
        ...
        cancelCallback:(ABI27_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI27_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI27_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI27_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
