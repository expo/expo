...
@implementation ABI27_0_0ARTText
...
static void ABI27_0_0ARTFreeTextFrame(ABI27_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI27_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI27_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI27_0_0ARTTextFrame frame = self.textFrame;
