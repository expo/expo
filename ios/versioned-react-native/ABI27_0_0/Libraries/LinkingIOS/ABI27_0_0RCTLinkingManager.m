...
#import "ABI27_0_0RCTLinkingManager.h"
...
static NSString *const kOpenURLNotification = @"ABI27_0_0RCTOpenURLNotification";
...
@implementation ABI27_0_0RCTLinkingManager
...
{
  BOOL opened = [ABI27_0_0RCTSharedApplication() openURL:URL];
  if (opened) {
    resolve(nil);
  } else {
                  ...
                  reject:(__unused ABI27_0_0RCTPromiseRejectBlock)reject)
{
  ...
  BOOL canOpen = [ABI27_0_0RCTSharedApplication() canOpenURL:URL];
  resolve(@(canOpen));
}
                  ...
                  reject:(__unused ABI27_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve(ABI27_0_0RCTNullIfNil(initialURL.absoluteString));
}
