...
#import "ABI27_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI27_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI27_0_0ViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI27_0_0ViewController detachChildViewController:self.contentViewController];
}
