...
#import <ABI27_0_0RCTWrapper/ABI27_0_0RCTWrapperViewManager.h>

// Umbrella header with macros

// ABI27_0_0RCT_WRAPPER_FOR_VIEW
#define ABI27_0_0RCT_WRAPPER_FOR_VIEW(ClassName)                                        \
                                                                               \
NS_ASSUME_NONNULL_BEGIN                                                        \
                                                                               \
@interface ClassName##Manager : ABI27_0_0RCTWrapperViewManager                          \
                                                                               \
@end                                                                           \
                                                                               \
...
// ABI27_0_0RCT_WRAPPER_FOR_VIEW_CONTROLLER
#define ABI27_0_0RCT_WRAPPER_FOR_VIEW_CONTROLLER(ClassName)                             \
                                                                               \
NS_ASSUME_NONNULL_BEGIN                                                        \
                                                                               \
@interface ClassName##Manager : ABI27_0_0RCTWrapperViewManager                          \
