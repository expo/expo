...
#import "ABI27_0_0RCTReconnectingWebSocket.h"
...
@interface ABI27_0_0RCTReconnectingWebSocket () <ABI27_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI27_0_0RCTReconnectingWebSocket {
  NSURL *_url;
  ABI27_0_0RCTSRWebSocket *_socket;
}
...
{
  [self stop];
  _socket = [[ABI27_0_0RCTSRWebSocket alloc] initWithURL:_url];
...
- (void)reconnect
{
  __weak ABI27_0_0RCTSRWebSocket *socket = _socket;
