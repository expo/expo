...
@interface ABI27_0_0RCTSurfaceHostingComponentController() <ABI27_0_0RCTSurfaceDelegate>
@end

@implementation ABI27_0_0RCTSurfaceHostingComponentController {
  ABI27_0_0RCTSurface *_surface;
}

- (instancetype)initWithComponent:(ABI27_0_0RCTSurfaceHostingComponent *)component
{
...
- (void)didUpdateComponent
{
  ...
  [self updateSurfaceWithComponent:(ABI27_0_0RCTSurfaceHostingComponent *)self.component];
}
...
- (void)updateSurfaceWithComponent:(ABI27_0_0RCTSurfaceHostingComponent *)component
{
  // Updating `surface`
  ABI27_0_0RCTSurface *const surface = component.surface;
  if (surface != _surface) {
...
{
  [self.component updateState:^(ABI27_0_0RCTSurfaceHostingComponentState *state) {
    return [ABI27_0_0RCTSurfaceHostingComponentState newWithStage:state.stage
...
{
  [self.component updateState:^(ABI27_0_0RCTSurfaceHostingComponentState *state) {
    return [ABI27_0_0RCTSurfaceHostingComponentState newWithStage:stage
...
{
  return ((ABI27_0_0RCTSurfaceHostingComponent *)self.component).options.synchronousStateUpdates && ABI27_0_0RCTIsMainQueue() ? CKUpdateModeSynchronous : CKUpdateModeAsynchronous;
}
...
- (void)mountSurfaceView
{
  ...
  ABI27_0_0RCTAssert([superview.subviews count] <= 1, @"Should never have more than a single stateful subview.");
