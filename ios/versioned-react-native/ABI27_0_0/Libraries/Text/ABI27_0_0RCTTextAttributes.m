...
NSString *const ABI27_0_0RCTTextAttributesIsHighlightedAttributeName = @"ABI27_0_0RCTTextAttributesIsHighlightedAttributeName";
NSString *const ABI27_0_0RCTTextAttributesTagAttributeName = @"ABI27_0_0RCTTextAttributesTagAttributeName";

@implementation ABI27_0_0RCTTextAttributes
...
- (void)applyTextAttributes:(ABI27_0_0RCTTextAttributes *)textAttributes
{
  ...
  _textDecorationLine = textAttributes->_textDecorationLine != ABI27_0_0RCTTextDecorationLineTypeNone ? textAttributes->_textDecorationLine : _textDecorationLine; // *
...
- (NSDictionary<NSAttributedStringKey, id> *)effectiveTextAttributes
{
  ...
  if (_textDecorationLine == ABI27_0_0RCTTextDecorationLineTypeUnderline ||
      _textDecorationLine == ABI27_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    isTextDecorationEnabled = YES;
    attributes[NSUnderlineStyleAttributeName] = @(_textDecorationStyle);
  }

  if (_textDecorationLine == ABI27_0_0RCTTextDecorationLineTypeStrikethrough ||
      _textDecorationLine == ABI27_0_0RCTTextDecorationLineTypeUnderlineStrikethrough){
    isTextDecorationEnabled = YES;
  ...
  // Special
  if (_isHighlighted) {
    attributes[ABI27_0_0RCTTextAttributesIsHighlightedAttributeName] = @YES;
  }

  if (_tag) {
    attributes[ABI27_0_0RCTTextAttributesTagAttributeName] = _tag;
  }
...
{
  // FIXME: ABI27_0_0RCTFont has thread-safety issues and must be rewritten.
  return [ABI27_0_0RCTFont updateFont:nil
...
{
  return !ABI27_0_0RCTHasFontHandlerSet() && _allowFontScaling && !isnan(_fontSizeMultiplier) ? _fontSizeMultiplier : 1.0;
}
...
- (ABI27_0_0RCTTextAttributes *)copyWithZone:(NSZone *)zone
{
  ABI27_0_0RCTTextAttributes *textAttributes = [ABI27_0_0RCTTextAttributes new];
...
- (BOOL)isEqual:(ABI27_0_0RCTTextAttributes *)textAttributes
{
  if (self == textAttributes) {
    return YES;
  }

#define ABI27_0_0RCTTextAttributesCompareFloats(a) ((a == textAttributes->a) || (isnan(a) && isnan(textAttributes->a)))
#define ABI27_0_0RCTTextAttributesCompareSize(a) CGSizeEqualToSize(a, textAttributes->a)
#define ABI27_0_0RCTTextAttributesCompareObjects(a) ((a == textAttributes->a) || [a isEqual:textAttributes->a])
#define ABI27_0_0RCTTextAttributesCompareStrings(a) ((a == textAttributes->a) || [a isEqualToString:textAttributes->a])
#define ABI27_0_0RCTTextAttributesCompareOthers(a) (a == textAttributes->a)

  return
    ABI27_0_0RCTTextAttributesCompareObjects(_foregroundColor) &&
    ABI27_0_0RCTTextAttributesCompareObjects(_backgroundColor) &&
    ABI27_0_0RCTTextAttributesCompareFloats(_opacity) &&
    // Font
    ABI27_0_0RCTTextAttributesCompareObjects(_fontFamily) &&
    ABI27_0_0RCTTextAttributesCompareFloats(_fontSize) &&
    ABI27_0_0RCTTextAttributesCompareFloats(_fontSizeMultiplier) &&
    ABI27_0_0RCTTextAttributesCompareStrings(_fontWeight) &&
    ABI27_0_0RCTTextAttributesCompareObjects(_fontStyle) &&
    ABI27_0_0RCTTextAttributesCompareObjects(_fontVariant) &&
    ABI27_0_0RCTTextAttributesCompareOthers(_allowFontScaling) &&
    ABI27_0_0RCTTextAttributesCompareFloats(_letterSpacing) &&
    // Paragraph Styles
    ABI27_0_0RCTTextAttributesCompareFloats(_lineHeight) &&
    ABI27_0_0RCTTextAttributesCompareFloats(_alignment) &&
    ABI27_0_0RCTTextAttributesCompareOthers(_baseWritingDirection) &&
    // Decoration
    ABI27_0_0RCTTextAttributesCompareObjects(_textDecorationColor) &&
    ABI27_0_0RCTTextAttributesCompareOthers(_textDecorationStyle) &&
    ABI27_0_0RCTTextAttributesCompareOthers(_textDecorationLine) &&
    // Shadow
    ABI27_0_0RCTTextAttributesCompareSize(_textShadowOffset) &&
    ABI27_0_0RCTTextAttributesCompareFloats(_textShadowRadius) &&
    ABI27_0_0RCTTextAttributesCompareObjects(_textShadowColor) &&
    // Special
    ABI27_0_0RCTTextAttributesCompareOthers(_isHighlighted) &&
    ABI27_0_0RCTTextAttributesCompareObjects(_tag) &&
    ABI27_0_0RCTTextAttributesCompareOthers(_layoutDirection);
}
