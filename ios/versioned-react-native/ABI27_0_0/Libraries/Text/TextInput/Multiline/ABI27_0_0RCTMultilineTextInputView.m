...
@implementation ABI27_0_0RCTMultilineTextInputView
{
  ABI27_0_0RCTUITextView *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI27_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI27_0_0RCTUITextView alloc] initWithFrame:self.bounds];
...
ABI27_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithCoder:(NSCoder *)coder)

- (id<ABI27_0_0RCTBackedTextInputViewProtocol>)backedTextInputView
{
...
{
  ABI27_0_0RCTDirectEventBlock onScroll = self.onScroll;
