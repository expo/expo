...
#import "ABI27_0_0RCTUITextView.h"

#import <ReactABI27_0_0/ABI27_0_0RCTUtils.h>
#import <ReactABI27_0_0/UIView+ReactABI27_0_0.h>

#import "ABI27_0_0RCTBackedTextInputDelegateAdapter.h"

@implementation ABI27_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI27_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI27_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
  }
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI27_0_0RCTCeilPixelValue(placeholderSize.width), ABI27_0_0RCTCeilPixelValue(placeholderSize.height));
