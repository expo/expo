...
#import "ABI27_0_0RCTUITextField.h"
...
@implementation ABI27_0_0RCTUITextField {
  ABI27_0_0RCTBackedTextFieldDelegateAdapter *_textInputDelegateAdapter;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI27_0_0RCTBackedTextFieldDelegateAdapter alloc] initWithTextField:self];
  }
...
- (CGSize)intrinsicContentSize
{
  ...
  size = CGSizeMake(ABI27_0_0RCTCeilPixelValue(size.width), ABI27_0_0RCTCeilPixelValue(size.height));
