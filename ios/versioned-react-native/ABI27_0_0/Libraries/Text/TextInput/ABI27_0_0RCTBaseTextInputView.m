...
@implementation ABI27_0_0RCTBaseTextInputView {
...
ABI27_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithCoder:(NSCoder *)decoder)
ABI27_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithFrame:(CGRect)frame)

- (UIView<ABI27_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  ABI27_0_0RCTAssert(NO, @"-[ABI27_0_0RCTBaseTextInputView backedTextInputView] must be implemented in subclass.");
  return nil;
}

#pragma mark - ABI27_0_0RCTComponent
...
- (void)setTextAttributes:(ABI27_0_0RCTTextAttributes *)textAttributes
{
...
{
  id<ABI27_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
...
- (void)setReactABI27_0_0PaddingInsets:(UIEdgeInsets)ReactABI27_0_0PaddingInsets
{
  _ReactABI27_0_0PaddingInsets = ReactABI27_0_0PaddingInsets;
  // We apply `paddingInsets` as `backedTextInputView`'s `textContainerInset`.
  self.backedTextInputView.textContainerInset = ReactABI27_0_0PaddingInsets;
  [self setNeedsLayout];
}

- (void)setReactABI27_0_0BorderInsets:(UIEdgeInsets)ReactABI27_0_0BorderInsets
{
  _ReactABI27_0_0BorderInsets = ReactABI27_0_0BorderInsets;
  // We apply `borderInsets` as `backedTextInputView` layout offset.
  self.backedTextInputView.frame = UIEdgeInsetsInsetRect(self.bounds, ReactABI27_0_0BorderInsets);
  [self setNeedsLayout];
}
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  } else if (eventLag > ABI27_0_0RCTTextUpdateLagWarningThreshold) {
    ABI27_0_0RCTLogWarn(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", self.backedTextInputView.attributedText.string, (long long)eventLag);
  }
}

- (ABI27_0_0RCTTextSelection *)selection
{
  id<ABI27_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
  UITextRange *selectedTextRange = backedTextInputView.selectedTextRange;
  return [[ABI27_0_0RCTTextSelection new] initWithStart:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.start]
                                           end:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.end]];
}

- (void)setSelection:(ABI27_0_0RCTTextSelection *)selection
{
  if (!selection) {
    return;
  }
  ...
  if (eventLag == 0 && ![previousSelectedTextRange isEqual:selectedTextRange]) {
    ...
    ABI27_0_0RCTLogWarn(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", backedTextInputView.attributedText.string, (long long)eventLag);
  }
}

#pragma mark - ABI27_0_0RCTBackedTextInputDelegate
...
- (void)textInputDidBeginEditing
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI27_0_0RCTTextEventTypeFocus
...
{
  [_eventDispatcher sendTextEventWithType:ABI27_0_0RCTTextEventTypeEnd
                                 ReactABI27_0_0Tag:self.ReactABI27_0_0Tag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];

  [_eventDispatcher sendTextEventWithType:ABI27_0_0RCTTextEventTypeBlur
                                 ReactABI27_0_0Tag:self.ReactABI27_0_0Tag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldReturn
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI27_0_0RCTTextEventTypeSubmit
                                 ReactABI27_0_0Tag:self.ReactABI27_0_0Tag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text
{
  ...
  if (!backedTextInputView.textWasPasted) {
    [_eventDispatcher sendTextEventWithType:ABI27_0_0RCTTextEventTypeKeyPress
                                   ReactABI27_0_0Tag:self.ReactABI27_0_0Tag
                                       text:nil
                                        key:text
                                 eventCount:_nativeEventCount];
...
- (void)textInputDidChangeSelection
{
  ...
  ABI27_0_0RCTTextSelection *selection = self.selection;
...
- (CGSize)intrinsicContentSize
{
  ...
  size.width += _ReactABI27_0_0BorderInsets.left + _ReactABI27_0_0BorderInsets.right;
  size.height += _ReactABI27_0_0BorderInsets.top + _ReactABI27_0_0BorderInsets.bottom;
...
{
  CGFloat compoundHorizontalBorderInset = _ReactABI27_0_0BorderInsets.left + _ReactABI27_0_0BorderInsets.right;
  CGFloat compoundVerticalBorderInset = _ReactABI27_0_0BorderInsets.top + _ReactABI27_0_0BorderInsets.bottom;
...
{
  [self.backedTextInputView ReactABI27_0_0Focus];
}

- (void)ReactABI27_0_0Blur
{
  [self.backedTextInputView ReactABI27_0_0Blur];
}

- (void)didMoveToWindow
{
  [self.backedTextInputView ReactABI27_0_0FocusIfNeeded];
}
...
{
  #if !TARGET_OS_TV
  __weak ABI27_0_0RCTBaseTextInputView *weakSelf = self;
  [_bridge.uiManager rootViewForReactABI27_0_0Tag:self.ReactABI27_0_0Tag withCompletion:^(UIView *rootView) {
    ABI27_0_0RCTBaseTextInputView *strongSelf = weakSelf;
    if (rootView) {
      UIView *accessoryView = [strongSelf->_bridge.uiManager viewForNativeID:nativeID
                                                                 withRootTag:rootView.ReactABI27_0_0Tag];
      if (accessoryView && [accessoryView isKindOfClass:[ABI27_0_0RCTInputAccessoryView class]]) {
        strongSelf.backedTextInputView.inputAccessoryView = ((ABI27_0_0RCTInputAccessoryView *)accessoryView).content.inputAccessoryView;
...
{
  #if !TARGET_OS_TV
  UIView<ABI27_0_0RCTBackedTextInputViewProtocol> *textInputView = self.backedTextInputView;
