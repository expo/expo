...
#pragma mark - ABI27_0_0RCTBackedTextFieldDelegateAdapter (for UITextField)

static void *TextFieldSelectionObservingContext = &TextFieldSelectionObservingContext;

@interface ABI27_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI27_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI27_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}

- (instancetype)initWithTextField:(UITextField<ABI27_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  if (self = [super init]) {
...
#pragma mark - ABI27_0_0RCTBackedTextViewDelegateAdapter (for UITextView)

@interface ABI27_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI27_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI27_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}

- (instancetype)initWithTextView:(UITextView<ABI27_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  if (self = [super init]) {
    _backedTextInputView = backedTextInputView;
    backedTextInputView.delegate = self;
