...
@implementation ABI27_0_0RCTBaseTextInputShadowView
{
...
- (instancetype)initWithBridge:(ABI27_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI27_0_0YGNodeSetMeasureFunc(self.yogaNode, ABI27_0_0RCTBaseTextInputShadowViewMeasure);
    ABI27_0_0YGNodeSetBaselineFunc(self.yogaNode, ABI27_0_0RCTTextInputShadowViewBaseline);
  }
...
- (void)uiManagerWillPerformMounting
{
  ...
  ABI27_0_0RCTTextAttributes *textAttributes = [self.textAttributes copy];
  ...
  [attributedText removeAttribute:ABI27_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                            range:NSMakeRange(0, attributedText.length)];

  [attributedText removeAttribute:ABI27_0_0RCTTextAttributesTagAttributeName
                            range:NSMakeRange(0, attributedText.length)];
  ...
  [_bridge.uiManager addUIBlock:^(ABI27_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI27_0_0RCTBaseTextInputView *baseTextInputView = (ABI27_0_0RCTBaseTextInputView *)viewRegistry[tag];
    if (!baseTextInputView) {
      return;
    }

    baseTextInputView.textAttributes = textAttributes;
    baseTextInputView.ReactABI27_0_0BorderInsets = borderInsets;
    baseTextInputView.ReactABI27_0_0PaddingInsets = paddingInsets;
...
- (CGSize)sizeThatFitsMinimumSize:(CGSize)minimumSize maximumSize:(CGSize)maximumSize
{
  ...
  return (CGSize){
    MAX(minimumSize.width, MIN(ABI27_0_0RCTCeilPixelValue(size.width), maximumSize.width)),
    MAX(minimumSize.height, MIN(ABI27_0_0RCTCeilPixelValue(size.height), maximumSize.height))
  };
}
...
static ABI27_0_0YGSize ABI27_0_0RCTBaseTextInputShadowViewMeasure(ABI27_0_0YGNodeRef node, float width, ABI27_0_0YGMeasureMode widthMode, float height, ABI27_0_0YGMeasureMode heightMode)
{
  ...
  return (ABI27_0_0YGSize){
    ABI27_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.width),
    ABI27_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.height)
  };
}

static float ABI27_0_0RCTTextInputShadowViewBaseline(ABI27_0_0YGNodeRef node, const float width, const float height)
{
  ABI27_0_0RCTBaseTextInputShadowView *shadowTextView = (__bridge ABI27_0_0RCTBaseTextInputShadowView *)ABI27_0_0YGNodeGetContext(node);
