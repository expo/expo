...
typedef void (^ABI27_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI27_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI27_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI27_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI27_0_0RCTImageCache <NSObject>
...
/**
 * If available, ABI27_0_0RCTImageRedirectProtocol is invoked before loading an asset.
 * Implementation should return either a new URL or nil when redirection is
 * not needed.
 */

@protocol ABI27_0_0RCTImageRedirectProtocol

- (NSURL *)redirectAssetsURL:(NSURL *)URL;

@end

@interface UIImage (ReactABI27_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI27_0_0KeyframeAnimation;

@end

@interface ABI27_0_0RCTImageLoader : NSObject <ABI27_0_0RCTBridgeModule, ABI27_0_0RCTURLRequestHandler>
...
- (instancetype)init;
- (instancetype)initWithRedirectDelegate:(id<ABI27_0_0RCTImageRedirectProtocol>)redirectDelegate NS_DESIGNATED_INITIALIZER;
 ...
 */
- (ABI27_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                           clipped:(BOOL)clipped
                                        resizeMode:(ABI27_0_0RCTResizeMode)resizeMode
 ...
 * decoded images as long as it conforms to the ABI27_0_0RCTImageCacheDelegate
...
@interface ABI27_0_0RCTBridge (ABI27_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI27_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI27_0_0RCTImageURLLoader <ABI27_0_0RCTBridgeModule>
...
/**
 * If more than one ABI27_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI27_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 * are also bridge modules, so should be registered using ABI27_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI27_0_0RCTImageDataDecoder <ABI27_0_0RCTBridgeModule>
...
/**
 * If more than one ABI27_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
