...
@interface ABI27_0_0RCTImageStoreManager : NSObject <ABI27_0_0RCTURLRequestHandler>
...
@interface ABI27_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI27_0_0RCTBridge (ABI27_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI27_0_0RCTImageStoreManager *imageStoreManager;
