...
static const NSUInteger ABI27_0_0RCTMaxCachableDecodedImageSizeInBytes = 1048576; // 1MB

static NSString *ABI27_0_0RCTCacheKeyForImage(NSString *imageTag, CGSize size, CGFloat scale,
                                     ABI27_0_0RCTResizeMode resizeMode, NSString *responseDate)
{
    return [NSString stringWithFormat:@"%@|%g|%g|%g|%lld|%@",
            imageTag, size.width, size.height, scale, (long long)resizeMode, responseDate];
}

@implementation ABI27_0_0RCTImageCache
{
                 ...
                 forKey:(NSString *)cacheKey
{
  ...
  if (bytes <= ABI27_0_0RCTMaxCachableDecodedImageSizeInBytes) {
...
{
  NSString *cacheKey = ABI27_0_0RCTCacheKeyForImage(url, size, scale, resizeMode, responseDate);
