...
typedef dispatch_block_t ABI27_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI27_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ReactABI27_0_0-independent state can compute and cache
 * own intrinsic content size (which will be used by Yoga) at this point.
 */
- (void)uiManagerWillPerformLayout:(ABI27_0_0RCTUIManager *)manager;
 ...
 */
- (void)uiManagerDidPerformLayout:(ABI27_0_0RCTUIManager *)manager;
 ...
 */
- (void)uiManagerWillPerformMounting:(ABI27_0_0RCTUIManager *)manager;
...
/**
 * Simple helper which take care of ABI27_0_0RCTUIManager's observers.
 */
@interface ABI27_0_0RCTUIManagerObserverCoordinator : NSObject <ABI27_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI27_0_0RCTUIManagerObserver` protocol for more info.
 * References to observers are held weakly.
 * This method can be called safely from any queue.
 */
- (void)addObserver:(id<ABI27_0_0RCTUIManagerObserver>)observer;

/**
 * Remove a `UIManagerObserver`.
 * This method can be called safely from any queue.
 */
- (void)removeObserver:(id<ABI27_0_0RCTUIManagerObserver>)observer;
