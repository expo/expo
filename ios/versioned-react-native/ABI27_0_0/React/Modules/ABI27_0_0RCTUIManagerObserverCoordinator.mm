...
@implementation ABI27_0_0RCTUIManagerObserverCoordinator {
  NSHashTable<id<ABI27_0_0RCTUIManagerObserver>> *_observers;
  std::mutex _mutex;
}
...
- (void)uiManagerWillPerformLayout:(ABI27_0_0RCTUIManager *)manager
{
  ...
  for (id<ABI27_0_0RCTUIManagerObserver> observer in _observers) {
