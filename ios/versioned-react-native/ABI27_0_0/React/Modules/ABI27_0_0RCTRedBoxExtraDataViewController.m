...
@interface ABI27_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI27_0_0RCTRedBoxExtraDataCell
...
@interface ABI27_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI27_0_0RCTRedBoxExtraDataViewController
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ABI27_0_0RCTRedBoxExtraDataCell *cell =
            (ABI27_0_0RCTRedBoxExtraDataCell *)[tableView
            dequeueReusableCellWithIdentifier:reuseIdentifier];

    if (cell == nil) {
        cell = [[ABI27_0_0RCTRedBoxExtraDataCell alloc]
