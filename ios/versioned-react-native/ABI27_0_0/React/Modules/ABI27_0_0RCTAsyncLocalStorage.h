 ...
 * being atomic, unless someone bypasses the `ABI27_0_0RCTAsyncLocalStorage` API.
 *
 * Keys and values must always be strings or an error is returned.
 */
@interface ABI27_0_0RCTAsyncLocalStorage : NSObject <ABI27_0_0RCTBridgeModule,ABI27_0_0RCTInvalidating>
...
// Clear the ABI27_0_0RCTAsyncLocalStorage data from native code
- (void)clearAllData;
