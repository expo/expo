...
#import "ABI27_0_0RCTAccessibilityManager.h"
...
NSString *const ABI27_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification = @"ABI27_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification";
...
@interface ABI27_0_0RCTAccessibilityManager ()
...
@implementation ABI27_0_0RCTAccessibilityManager
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    self.contentSizeCategory = ABI27_0_0RCTSharedApplication().preferredContentSizeCategory;
...
- (void)invalidateMultiplier
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI27_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification object:self];
}
...
- (CGFloat)multiplierForContentSizeCategory:(NSString *)category
{
  ...
  if (m.doubleValue <= 0.0) {
    ABI27_0_0RCTLogError(@"Can't determinte multiplier for category %@. Using 1.0.", category);
    m = @1.0;
  }
...
ABI27_0_0RCT_EXPORT_METHOD(setAccessibilityContentSizeMultipliers:(NSDictionary *)JSMultipliers)
{
  ...
  for (NSString *__nonnull JSCategory in JSMultipliers) {
    NSNumber *m = [ABI27_0_0RCTConvert NSNumber:JSMultipliers[JSCategory]];
...
ABI27_0_0RCT_EXPORT_METHOD(setAccessibilityFocus:(nonnull NSNumber *)ReactABI27_0_0Tag)
{
...
ABI27_0_0RCT_EXPORT_METHOD(announceForAccessibility:(NSString *)announcement)
{
  UIAccessibilityPostNotification(UIAccessibilityAnnouncementNotification, announcement);
}

ABI27_0_0RCT_EXPORT_METHOD(getMultiplier:(ABI27_0_0RCTResponseSenderBlock)callback)
{
  if (callback) {
...
ABI27_0_0RCT_EXPORT_METHOD(getCurrentVoiceOverState:(ABI27_0_0RCTResponseSenderBlock)callback
...
@implementation ABI27_0_0RCTBridge (ABI27_0_0RCTAccessibilityManager)

- (ABI27_0_0RCTAccessibilityManager *)accessibilityManager
{
  return [self moduleForClass:[ABI27_0_0RCTAccessibilityManager class]];
}
