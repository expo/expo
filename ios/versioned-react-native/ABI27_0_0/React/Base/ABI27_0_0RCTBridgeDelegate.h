...
@protocol ABI27_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI27_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI27_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI27_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI27_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI27_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI27_0_0RCTBridge *)bridge;
...
*/
- (BOOL)bridge:(ABI27_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI27_0_0RCTBridge *)bridge
                 onProgress:(ABI27_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI27_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI27_0_0RCTBridge *)bridge
                  withBlock:(ABI27_0_0RCTSourceLoadBlock)loadCallback;
