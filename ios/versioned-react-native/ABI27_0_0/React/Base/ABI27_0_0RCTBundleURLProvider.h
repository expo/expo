...
extern NSString *const ABI27_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI27_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI27_0_0RCTBundleURLProvider : NSObject
