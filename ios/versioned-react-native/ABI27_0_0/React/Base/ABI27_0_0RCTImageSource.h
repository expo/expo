 ...
 */
@interface ABI27_0_0RCTImageSource : NSObject
...
@interface ABI27_0_0RCTConvert (ImageSource)

+ (ABI27_0_0RCTImageSource *)ABI27_0_0RCTImageSource:(id)json;
+ (NSArray<ABI27_0_0RCTImageSource *> *)ABI27_0_0RCTImageSourceArray:(id)json;
