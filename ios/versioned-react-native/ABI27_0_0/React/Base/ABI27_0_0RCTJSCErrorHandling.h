...
/**
 ...
 - The JS exception's unsymbolicated stack trace is available via the NSError userInfo's ABI27_0_0RCTJSExceptionUnsymbolicatedStackTraceKey
 */
ABI27_0_0RCT_EXTERN NSError *ABI27_0_0RCTNSErrorFromJSError(JSValue *exception);

/**
 Translates a given exception into an NSError.

 @see ABI27_0_0RCTNSErrorFromJSError for details
 */
ABI27_0_0RCT_EXTERN NSError *ABI27_0_0RCTNSErrorFromJSErrorRef(JSValueRef exceptionRef, JSGlobalContextRef ctx);
