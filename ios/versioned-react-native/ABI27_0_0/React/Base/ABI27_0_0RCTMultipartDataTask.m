...
#import "ABI27_0_0RCTMultipartDataTask.h"

@interface ABI27_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI27_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI27_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI27_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI27_0_0RCTMultipartStreamReader *reader = [[ABI27_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI27_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
