...
@class ABI27_0_0RCTPerformanceLogger;

/**
 * This notification fires when the bridge initializes.
 */
ABI27_0_0RCT_EXTERN NSString *const ABI27_0_0RCTJavaScriptWillStartLoadingNotification;


/**
 * This notification fires when the bridge starts executing the JS bundle.
 */
ABI27_0_0RCT_EXTERN NSString *const ABI27_0_0RCTJavaScriptWillStartExecutingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI27_0_0RCT_EXTERN NSString *const ABI27_0_0RCTJavaScriptDidLoadNotification;

/**
 * This notification fires when the bridge failed to load the JS bundle. The
 * `error` key can be used to determine the error that occurred.
 */
ABI27_0_0RCT_EXTERN NSString *const ABI27_0_0RCTJavaScriptDidFailToLoadNotification;
 ...
 */
ABI27_0_0RCT_EXTERN NSString *const ABI27_0_0RCTDidInitializeModuleNotification;

/**
 * This notification fires just before the bridge starts processing a request to
 * reload.
 */
ABI27_0_0RCT_EXTERN NSString *const ABI27_0_0RCTBridgeWillReloadNotification;

/**
 * This notification fires just before the bridge begins downloading a script
 * from the packager.
 */
ABI27_0_0RCT_EXTERN NSString *const ABI27_0_0RCTBridgeWillDownloadScriptNotification;

/**
 * This notification fires just after the bridge finishes downloading a script
 * from the packager.
 */
ABI27_0_0RCT_EXTERN NSString *const ABI27_0_0RCTBridgeDidDownloadScriptNotification;

/**
 * Key for the ABI27_0_0RCTSource object in the ABI27_0_0RCTBridgeDidDownloadScriptNotification
 * userInfo dictionary.
 */
ABI27_0_0RCT_EXTERN NSString *const ABI27_0_0RCTBridgeDidDownloadScriptNotificationSourceKey;
 ...
 */
typedef NSArray<id<ABI27_0_0RCTBridgeModule>> *(^ABI27_0_0RCTBridgeModuleListProvider)(void);

/**
 * This function returns the module name for a given class.
 */
ABI27_0_0RCT_EXTERN NSString *ABI27_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI27_0_0RCTBridge : NSObject <ABI27_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI27_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI27_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 */
@property (nonatomic, weak, readonly) id<ABI27_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ReactABI27_0_0 Native perf events.
 */
@property (nonatomic, readonly, strong) ABI27_0_0RCTPerformanceLogger *performanceLogger;
