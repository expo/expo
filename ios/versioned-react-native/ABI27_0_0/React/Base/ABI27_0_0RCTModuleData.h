...
@protocol ABI27_0_0RCTBridgeMethod;
@protocol ABI27_0_0RCTBridgeModule;
@class ABI27_0_0RCTBridge;

typedef id<ABI27_0_0RCTBridgeModule>(^ABI27_0_0RCTBridgeModuleProvider)(void);

@interface ABI27_0_0RCTModuleData : NSObject <ABI27_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI27_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI27_0_0RCTBridgeModule> instance;
