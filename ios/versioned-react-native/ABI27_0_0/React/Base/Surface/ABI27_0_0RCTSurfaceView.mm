...
@implementation ABI27_0_0RCTSurfaceView {
  ABI27_0_0RCTSurfaceRootView *_Nullable _rootView;
...
- (void)setRootView:(ABI27_0_0RCTSurfaceRootView *)rootView
{
...
- (void)_updateStage
{
  if (ABI27_0_0RCTSurfaceStageIsRunning(_stage)) {
