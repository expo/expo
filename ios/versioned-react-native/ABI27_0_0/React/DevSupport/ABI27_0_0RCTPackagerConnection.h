...
@protocol ABI27_0_0RCTPackagerClientMethod;
@class ABI27_0_0RCTPackagerClientResponder;

typedef uint32_t ABI27_0_0RCTHandlerToken;
typedef void (^ABI27_0_0RCTNotificationHandler)(NSDictionary<NSString *, id> *);
typedef void (^ABI27_0_0RCTRequestHandler)(NSDictionary<NSString *, id> *, ABI27_0_0RCTPackagerClientResponder *);
typedef void (^ABI27_0_0RCTConnectedHandler)(void);

/** Encapsulates singleton connection to ReactABI27_0_0 Native packager. */
@interface ABI27_0_0RCTPackagerConnection : NSObject
 ...
 */
- (ABI27_0_0RCTHandlerToken)addNotificationHandler:(ABI27_0_0RCTNotificationHandler)handler
 ...
 */
- (ABI27_0_0RCTHandlerToken)addRequestHandler:(ABI27_0_0RCTRequestHandler)handler
                               queue:(dispatch_queue_t)queue
                           forMethod:(NSString *)method;
 ...
 */
- (ABI27_0_0RCTHandlerToken)addConnectedHandler:(ABI27_0_0RCTConnectedHandler)handler
                                 queue:(dispatch_queue_t)queue;
 ...
 */
- (void)addHandler:(id<ABI27_0_0RCTPackagerClientMethod>)handler
