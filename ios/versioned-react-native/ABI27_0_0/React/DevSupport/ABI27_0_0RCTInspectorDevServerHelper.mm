...
#import <ABI27_0_0jschelpers/ABI27_0_0JSCWrapper.h>
...
@implementation ABI27_0_0RCTInspectorDevServerHelper

ABI27_0_0RCT_NOT_IMPLEMENTED(- (instancetype)init)

static NSMutableDictionary<NSString *, ABI27_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
...
+ (ABI27_0_0RCTInspectorPackagerConnection *)connectWithBundleURL:(NSURL *)bundleURL
{
  ...
  ABI27_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection) {
    connection = [[ABI27_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
