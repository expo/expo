...
@implementation ABI27_0_0RCTSafeAreaView {
...
- (void)safeAreaInsetsDidChange
{
  ...
  if (UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI27_0_0RCTScreenScale())) {
    return;
  }

  _currentSafeAreaInsets = safeAreaInsets;

  ABI27_0_0RCTSafeAreaViewLocalData *localData =
    [[ABI27_0_0RCTSafeAreaViewLocalData alloc] initWithInsets:safeAreaInsets];
