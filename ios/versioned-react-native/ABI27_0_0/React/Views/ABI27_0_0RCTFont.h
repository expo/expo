...
typedef UIFont *(^ABI27_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ReactABI27_0_0 Native will use the System font for rendering by default. If you want to
 ...
 */
ABI27_0_0RCT_EXTERN void ABI27_0_0RCTSetDefaultFontHandler(ABI27_0_0RCTFontHandler handler);
ABI27_0_0RCT_EXTERN BOOL ABI27_0_0RCTHasFontHandlerSet();

@interface ABI27_0_0RCTFont : NSObject
...
@interface ABI27_0_0RCTConvert (ABI27_0_0RCTFont)
