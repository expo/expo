...
@implementation ABI27_0_0RCTConvert (UITabBarSystemItem)

ABI27_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI27_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI27_0_0ViewController;
}
