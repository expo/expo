...
@interface ABI44_0_0EXSecureStore (Protected)
...
@interface ABI44_0_0EXScopedSecureStore ()
...
@implementation ABI44_0_0EXScopedSecureStore
         ...
         withOptions:(NSDictionary *)options
{
  ...
  if (setValue) {
    ...
    ABI44_0_0EXLogWarn(@"Encountered an error while saving SecureStore data: %@.", [[super class] _messageForError:error]);
  }
}
