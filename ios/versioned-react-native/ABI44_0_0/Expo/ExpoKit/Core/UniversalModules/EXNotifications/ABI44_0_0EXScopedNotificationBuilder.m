...
@interface ABI44_0_0EXScopedNotificationBuilder ()
...
@implementation ABI44_0_0EXScopedNotificationBuilder
...
- (UNNotificationContent *)notificationContentFromRequest:(NSDictionary *)request
{
  ...
  if (content.categoryIdentifier && _isInExpoGo) {
    NSString *scopedCategoryIdentifier = [ABI44_0_0EXScopedNotificationsUtils scopedIdentifierFromId:content.categoryIdentifier
