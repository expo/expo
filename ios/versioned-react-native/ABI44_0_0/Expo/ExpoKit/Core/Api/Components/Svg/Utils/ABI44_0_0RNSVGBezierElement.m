...
@implementation ABI44_0_0RNSVGBezierElement
- (instancetype) init
{
    self = [super init];
    if (self)
    {
        ...
        _point = ABI44_0_0RNSVGNULLPOINT;
        _controlPoint1 = ABI44_0_0RNSVGNULLPOINT;
        _controlPoint2 = ABI44_0_0RNSVGNULLPOINT;
    }
    return self;
}
...
{
    ABI44_0_0RNSVGBezierElement *newElement = [[self alloc] init];
...
// Convert one element to ABI44_0_0RNSVGBezierElement and save to array
void ABI44_0_0RNSVGBezierElement_getBezierElements(void *info, const CGPathElement *element)
{
    NSMutableArray *bezierElements = (__bridge NSMutableArray *)info;
    if (element)
        [bezierElements addObject:[ABI44_0_0RNSVGBezierElement elementWithPathElement:*element]];
}
...
+ (NSArray *) elementsFromCGPath:(CGPathRef)path
{
    ...
    CGPathApply(path, (__bridge void *)elements, ABI44_0_0RNSVGBezierElement_getBezierElements);
    return elements;
}
