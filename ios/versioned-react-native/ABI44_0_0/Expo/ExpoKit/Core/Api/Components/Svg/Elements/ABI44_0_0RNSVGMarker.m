...
@implementation ABI44_0_0RNSVGMarker
...
- (void)setX:(ABI44_0_0RNSVGLength *)refX
{
...
- (void)setY:(ABI44_0_0RNSVGLength *)refY
{
...
- (void)setMarkerWidth:(ABI44_0_0RNSVGLength *)markerWidth
{
...
- (void)setMarkerHeight:(ABI44_0_0RNSVGLength *)markerHeight
{
...
static CGFloat ABI44_0_0RNSVG_degToRad = (CGFloat)M_PI / 180;

double ABI44_0_0deg2rad(CGFloat deg) {
    return deg * ABI44_0_0RNSVG_degToRad;
}
...
- (void)renderMarker:(CGContextRef)context rect:(CGRect)rect position:(ABI44_0_0RNSVGMarkerPosition*)position strokeWidth:(CGFloat)strokeWidth
{
    ...
    float rad = ABI44_0_0deg2rad(angle);
    ...
    if (self.align) {
        CGAffineTransform viewBoxTransform = [ABI44_0_0RNSVGViewBox getTransform:CGRectMake(self.minX, self.minY, self.vbWidth, self.vbHeight)
                                                                  eRect:eRect
                                                                  align:self.align
