...
@implementation ABI44_0_0RNSVGSvgView
{
    NSMutableDictionary<NSString *, ABI44_0_0RNSVGNode *> *_clipPaths;
    NSMutableDictionary<NSString *, ABI44_0_0RNSVGNode *> *_templates;
    NSMutableDictionary<NSString *, ABI44_0_0RNSVGPainter *> *_painters;
    NSMutableDictionary<NSString *, ABI44_0_0RNSVGNode *> *_markers;
    NSMutableDictionary<NSString *, ABI44_0_0RNSVGNode *> *_masks;
...
- (void)invalidate
{
    ABI44_0_0RNSVGPlatformView* parent = self.superview;
    if ([parent isKindOfClass:[ABI44_0_0RNSVGNode class]]) {
        if (!rendered) {
            return;
        }
        ABI44_0_0RNSVGNode* svgNode = (ABI44_0_0RNSVGNode*)parent;
        [svgNode invalidate];
        rendered = false;
        return;
    }
...
- (void)setBbWidth:(ABI44_0_0RNSVGLength *)bbWidth
{
...
- (void)setBbHeight:(ABI44_0_0RNSVGLength *)bbHeight
{
...
- (void)setMeetOrSlice:(ABI44_0_0RNSVGVBMOS)meetOrSlice
{
...
- (void)drawToContext:(CGContextRef)context withRect:(CGRect)rect {
    ...
    if (self.align) {
        ...
        _viewBoxTransform = [ABI44_0_0RNSVGViewBox getTransform:tRect
                                                 eRect:rect
                                                 align:self.align
    ...
    for (ABI44_0_0RNSVGView *node in self.subviews) {
        if ([node isKindOfClass:[ABI44_0_0RNSVGNode class]]) {
            ABI44_0_0RNSVGNode *svg = (ABI44_0_0RNSVGNode *)node;
...
- (void)drawRect:(CGRect)rect
{
    ...
    for (ABI44_0_0RNSVGPlatformView *node in self.subviews) {
        if ([node isKindOfClass:[ABI44_0_0RNSVGNode class]]) {
            ABI44_0_0RNSVGNode *svg = (ABI44_0_0RNSVGNode *)node;
...
- (ABI44_0_0RNSVGPlatformView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    for (ABI44_0_0RNSVGNode *node in [self.subviews reverseObjectEnumerator]) {
        if (![node isKindOfClass:[ABI44_0_0RNSVGNode class]]) {
            continue;
        }
        ...
        ABI44_0_0RNSVGPlatformView *hitChild = [node hitTest:transformed withEvent:event];
...
- (void)defineTemplate:(ABI44_0_0RNSVGNode *)template templateName:(NSString *)templateName
{
    if (!_templates) {
