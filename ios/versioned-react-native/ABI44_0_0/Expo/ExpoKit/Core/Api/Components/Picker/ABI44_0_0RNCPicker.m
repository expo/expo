...
@interface ABI44_0_0RNCPicker() <UIPickerViewDataSource, UIPickerViewDelegate>
@end

@implementation ABI44_0_0RNCPicker
           ...
           reusingView:(UIView *)view
{
  if (!view) {
      ...
      ABI44_0_0RNCPickerLabel* label = [[ABI44_0_0RNCPickerLabel alloc] initWithFrame:(CGRect) {
          CGPointZero,
          {
              rowWidth,
              rowHeight,
  ...
  ABI44_0_0RNCPickerLabel* label = view.subviews[0];
  label.font = _font;
