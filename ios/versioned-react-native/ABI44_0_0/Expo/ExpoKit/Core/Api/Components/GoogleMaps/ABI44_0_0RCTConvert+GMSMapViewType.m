//
//  ABI44_0_0RCTConvert+GMSMapViewType.m
//
...
@implementation ABI44_0_0RCTConvert (GMSMapViewType)
  ABI44_0_0RCT_ENUM_CONVERTER(GMSMapViewType,
  (
    @{
...
+ (GMSCameraPosition*)GMSCameraPosition:(id)json
{
    ...
    return [ABI44_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:nil];
}
