//
//  ABI44_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI44_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI44_0_0WMSTileOverlay *tile = [[ABI44_0_0WMSTileOverlay alloc] init];
...
@implementation ABI44_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
