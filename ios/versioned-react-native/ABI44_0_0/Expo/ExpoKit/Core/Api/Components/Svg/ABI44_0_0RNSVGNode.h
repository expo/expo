...
/**
 * ABI44_0_0RNSVG nodes are implemented as base NSViews/UIViews. They should be implementation for all basic
 ＊interfaces for all non-definition nodes.
 */

@interface ABI44_0_0RNSVGNode : ABI44_0_0RNSVGView
 ...
 */
extern CGFloat const ABI44_0_0RNSVG_M_SQRT1_2l;
extern CGFloat const ABI44_0_0RNSVG_DEFAULT_FONT_SIZE;

@property (nonatomic, strong) NSString *name;
@property (nonatomic, strong) NSString *display;
@property (nonatomic, assign) CGFloat opacity;
@property (nonatomic, assign) ABI44_0_0RNSVGCGFCRule clipRule;
 ...
 */
@property (nonatomic, assign) ABI44_0_0RCTPointerEvents pointerEvents;
...
@property (nonatomic, copy) ABI44_0_0RCTDirectEventBlock onLayout;


/**
 * ABI44_0_0RNSVGSvgView which ownes current ABI44_0_0RNSVGNode
 */
@property (nonatomic, readonly, weak) ABI44_0_0RNSVGSvgView *svgView;
@property (nonatomic, readonly, weak) ABI44_0_0RNSVGGroup *textRoot;
