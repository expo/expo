...
@implementation ABI44_0_0RCTConvert (AirMap)
...
{
    json = [self NSDictionary:json];
    return [ABI44_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:nil];
}
...
ABI44_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI44_0_0AIRMapCoordinate *)ABI44_0_0AIRMapCoordinate:(id)json
{
    ABI44_0_0AIRMapCoordinate *coord = [ABI44_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI44_0_0RCT_ARRAY_CONVERTER(ABI44_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI44_0_0AIRMapCoordinate *> *> *)ABI44_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI44_0_0RCTConvertArrayValue(@selector(ABI44_0_0AIRMapCoordinateArray:), json);
}
