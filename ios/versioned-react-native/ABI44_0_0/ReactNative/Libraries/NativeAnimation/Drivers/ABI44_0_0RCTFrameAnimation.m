...
@implementation ABI44_0_0RCTFrameAnimation
{
  ...
  ABI44_0_0RCTResponseSenderBlock _callback;
...
{
  NSNumber *toValue = [ABI44_0_0RCTConvert NSNumber:config[@"toValue"]] ?: @1;
  NSArray<NSNumber *> *frames = [ABI44_0_0RCTConvert NSNumberArray:config[@"frames"]];
  NSNumber *iterations = [ABI44_0_0RCTConvert NSNumber:config[@"iterations"]] ?: @1;
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  NSTimeInterval currentDuration = (_animationCurrentTime - _animationStartTime) / ABI44_0_0RCTAnimationDragCoefficient();

  // Determine how many frames have passed since last update.
  // Get index of frames that surround the current interval
  NSUInteger startIndex = floor(currentDuration / ABI44_0_0RCTSingleFrameInterval);
  ...
  NSTimeInterval fromInterval = startIndex * ABI44_0_0RCTSingleFrameInterval;
  NSTimeInterval toInterval = nextIndex * ABI44_0_0RCTSingleFrameInterval;
  ...
  CGFloat frameOutput = ABI44_0_0RCTInterpolateValue(currentDuration,
                                            fromInterval,
                                            toInterval,
                                            fromFrameValue.doubleValue,
                                            toFrameValue.doubleValue,
                                            ABI44_0_0EXTRAPOLATE_TYPE_EXTEND,
                                            ABI44_0_0EXTRAPOLATE_TYPE_EXTEND);
...
{
  CGFloat outputValue = ABI44_0_0RCTInterpolateValue(frameOutput,
                                            0,
                                            1,
                                            _fromValue,
                                            _toValue,
