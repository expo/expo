...
// NOTE: This module is temporarily forked (see ABI44_0_0RCTNativeAnimatedModule).
// When making any changes, be sure to apply them to the fork as well.
@interface ABI44_0_0RCTNativeAnimatedTurboModule: ABI44_0_0RCTEventEmitter <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTValueAnimatedNodeObserver, ABI44_0_0RCTEventDispatcherObserver, ABI44_0_0RCTUIManagerObserver, ABI44_0_0RCTSurfacePresenterObserver>
