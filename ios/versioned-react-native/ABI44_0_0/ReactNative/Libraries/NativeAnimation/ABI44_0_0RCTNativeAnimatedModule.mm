...
#import <ABI44_0_0React/ABI44_0_0RCTNativeAnimatedModule.h>
...
@implementation ABI44_0_0RCTNativeAnimatedModule
{
...
- (void)setBridge:(ABI44_0_0RCTBridge *)bridge
{
  ...
  _nodesManager = [[ABI44_0_0RCTNativeAnimatedNodesManager alloc] initWithBridge:self.bridge surfacePresenter:bridge.surfacePresenter];
...
{
  ABI44_0_0RCTLogWarn(@"setSurfacePresenter should only be invoked in ABI44_0_0RCTNativeAnimatedTurboModule");
}
...
Class ABI44_0_0RCTNativeAnimatedModuleCls(void) {
  return ABI44_0_0RCTNativeAnimatedModule.class;
}
