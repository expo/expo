...
@implementation ABI44_0_0RCTBaseTextInputView {
...
{
  ABI44_0_0RCTAssert(NO, @"-[ABI44_0_0RCTBaseTextInputView backedTextInputView] must be implemented in subclass.");
  return nil;
}

#pragma mark - ABI44_0_0RCTComponent
...
- (void)setTextAttributes:(ABI44_0_0RCTTextAttributes *)textAttributes
{
...
{
  id<ABI44_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
...
- (void)setABI44_0_0ReactPaddingInsets:(UIEdgeInsets)ABI44_0_0ReactPaddingInsets
{
  _ABI44_0_0ReactPaddingInsets = ABI44_0_0ReactPaddingInsets;
  // We apply `paddingInsets` as `backedTextInputView`'s `textContainerInset`.
  self.backedTextInputView.textContainerInset = ABI44_0_0ReactPaddingInsets;
  [self setNeedsLayout];
}

- (void)setABI44_0_0ReactBorderInsets:(UIEdgeInsets)ABI44_0_0ReactBorderInsets
{
  _ABI44_0_0ReactBorderInsets = ABI44_0_0ReactBorderInsets;
  // We apply `borderInsets` as `backedTextInputView` layout offset.
  self.backedTextInputView.frame = UIEdgeInsetsInsetRect(self.bounds, ABI44_0_0ReactBorderInsets);
  [self setNeedsLayout];
}
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  [backedTextInputViewTextCopy removeAttribute:ABI44_0_0RCTTextAttributesTagAttributeName
                                         range:NSMakeRange(0, backedTextInputViewTextCopy.length)];

  [attributedTextCopy removeAttribute:ABI44_0_0RCTTextAttributesTagAttributeName
  ...
  } else if (eventLag > ABI44_0_0RCTTextUpdateLagWarningThreshold) {
    ABI44_0_0RCTLog(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", self.backedTextInputView.attributedText.string, (long long)eventLag);
  }
}

- (ABI44_0_0RCTTextSelection *)selection
{
  id<ABI44_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
  UITextRange *selectedTextRange = backedTextInputView.selectedTextRange;
  return [[ABI44_0_0RCTTextSelection new] initWithStart:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.start]
                                           end:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.end]];
}

- (void)setSelection:(ABI44_0_0RCTTextSelection *)selection
{
  if (!selection) {
    return;
  }
  ...
  if (eventLag == 0 && ![previousSelectedTextRange isEqual:selectedTextRange]) {
    ...
    ABI44_0_0RCTLog(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", backedTextInputView.attributedText.string, (long long)eventLag);
  }
}
...
{
  UIView<ABI44_0_0RCTBackedTextInputViewProtocol> *textInputView = self.backedTextInputView;
...
- (void)textInputDidBeginEditing
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI44_0_0RCTTextEventTypeFocus
...
{
  [_eventDispatcher sendTextEventWithType:ABI44_0_0RCTTextEventTypeEnd
                                 ABI44_0_0ReactTag:self.ABI44_0_0ReactTag
                                     text:[self.backedTextInputView.attributedText.string copy]
                                      key:nil
                               eventCount:_nativeEventCount];

  [_eventDispatcher sendTextEventWithType:ABI44_0_0RCTTextEventTypeBlur
                                 ABI44_0_0ReactTag:self.ABI44_0_0ReactTag
                                     text:[self.backedTextInputView.attributedText.string copy]
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldReturn
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI44_0_0RCTTextEventTypeSubmit
                                 ABI44_0_0ReactTag:self.ABI44_0_0ReactTag
                                     text:[self.backedTextInputView.attributedText.string copy]
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (NSString *)textInputShouldChangeText:(NSString *)text inRange:(NSRange)range
{
  ...
  if (!backedTextInputView.textWasPasted) {
    [_eventDispatcher sendTextEventWithType:ABI44_0_0RCTTextEventTypeKeyPress
                                   ABI44_0_0ReactTag:self.ABI44_0_0ReactTag
                                       text:nil
                                        key:text
                                 eventCount:_nativeEventCount];
...
- (void)textInputDidChangeSelection
{
  ...
  ABI44_0_0RCTTextSelection *selection = self.selection;
...
- (CGSize)intrinsicContentSize
{
  ...
  size.width += _ABI44_0_0ReactBorderInsets.left + _ABI44_0_0ReactBorderInsets.right;
  size.height += _ABI44_0_0ReactBorderInsets.top + _ABI44_0_0ReactBorderInsets.bottom;
...
{
  CGFloat compoundHorizontalBorderInset = _ABI44_0_0ReactBorderInsets.left + _ABI44_0_0ReactBorderInsets.right;
  CGFloat compoundVerticalBorderInset = _ABI44_0_0ReactBorderInsets.top + _ABI44_0_0ReactBorderInsets.bottom;
...
{
  [self.backedTextInputView ABI44_0_0ReactFocus];
}

- (void)ABI44_0_0ReactBlur
{
  [self.backedTextInputView ABI44_0_0ReactBlur];
}
...
- (void)didMoveToWindow
{
  if (self.autoFocus && !_didMoveToWindow) {
    ...
    [self.backedTextInputView ABI44_0_0ReactFocusIfNeeded];
  }
...
{
  __weak ABI44_0_0RCTBaseTextInputView *weakSelf = self;
  [_bridge.uiManager rootViewForABI44_0_0ReactTag:self.ABI44_0_0ReactTag withCompletion:^(UIView *rootView) {
    ABI44_0_0RCTBaseTextInputView *strongSelf = weakSelf;
    if (rootView) {
      UIView *accessoryView = [strongSelf->_bridge.uiManager viewForNativeID:nativeID
                                                                 withRootTag:rootView.ABI44_0_0ReactTag];
      if (accessoryView && [accessoryView isKindOfClass:[ABI44_0_0RCTInputAccessoryView class]]) {
        strongSelf.backedTextInputView.inputAccessoryView = ((ABI44_0_0RCTInputAccessoryView *)accessoryView).inputAccessoryView;
