...
@implementation ABI44_0_0RCTSinglelineTextInputView
{
  ABI44_0_0RCTUITextField *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI44_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI44_0_0RCTUITextField alloc] initWithFrame:self.bounds];
