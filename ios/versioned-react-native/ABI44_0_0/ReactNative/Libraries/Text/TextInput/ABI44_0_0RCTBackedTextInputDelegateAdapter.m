...
#import <ABI44_0_0React/ABI44_0_0RCTBackedTextInputDelegateAdapter.h>
...
@interface ABI44_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI44_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI44_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
...
@interface ABI44_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI44_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI44_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}
