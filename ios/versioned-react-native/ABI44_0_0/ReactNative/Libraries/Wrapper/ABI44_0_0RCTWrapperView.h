...
typedef CGSize (^ABI44_0_0RCTWrapperMeasureBlock)(CGSize minimumSize, CGSize maximumSize);

@class ABI44_0_0RCTBridge;

NS_ASSUME_NONNULL_BEGIN

@interface ABI44_0_0RCTWrapperView : UIView

@property (nonatomic, retain, nullable) UIView *contentView;
@property (nonatomic, readonly) ABI44_0_0RCTWrapperMeasureBlock measureBlock;
