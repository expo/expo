...
static const NSUInteger ABI44_0_0RCTMaxCachableDecodedImageSizeInBytes = 2097152; // 2 MB

static NSString *ABI44_0_0RCTCacheKeyForImage(NSString *imageTag, CGSize size, CGFloat scale,
...
@implementation ABI44_0_0RCTImageCache
{
                 ...
                 forKey:(NSString *)cacheKey
{
  ...
  NSInteger bytes = image.ABI44_0_0ReactDecodedImageBytes;
  if (bytes <= ABI44_0_0RCTMaxCachableDecodedImageSizeInBytes) {
...
{
  NSString *cacheKey = ABI44_0_0RCTCacheKeyForImage(url, size, scale, resizeMode);
  @synchronized(_cacheStaleTimes) {
