...
/**
 * If available, ABI44_0_0RCTImageRedirectProtocol is invoked before loading an asset.
 * Implementation should return either a new URL or nil when redirection is
 * not needed.
 */

@protocol ABI44_0_0RCTImageRedirectProtocol
 ...
 * The priority logic is up to each @ABI44_0_0RCTImageLoaderProtocol implementation
 */
typedef NS_ENUM(NSUInteger, ABI44_0_0RCTImageLoaderPriority) {
  ABI44_0_0RCTImageLoaderPriorityImmediate,
  ABI44_0_0RCTImageLoaderPriorityPrefetch
};

@protocol ABI44_0_0RCTImageLoaderProtocol<ABI44_0_0RCTURLRequestHandler>
 ...
 */
- (nullable ABI44_0_0RCTImageLoaderCancellationBlock)loadImageWithURLRequest:(NSURLRequest *)imageURLRequest
                                                           callback:(ABI44_0_0RCTImageLoaderCompletionBlock)callback;
/**
...
* `partialLoadBlock` is meant for custom image loaders that do not ship with the core ABI44_0_0RN library.
...
- (nullable ABI44_0_0RCTImageLoaderCancellationBlock)loadImageWithURLRequest:(NSURLRequest *)imageURLRequest
                                                   ...
                                                   partialLoadBlock:(ABI44_0_0RCTImageLoaderPartialLoadBlock)partialLoadBlock
                                                    completionBlock:(ABI44_0_0RCTImageLoaderCompletionBlock)completionBlock;
 ...
 */
- (ABI44_0_0RCTImageLoaderCancellationBlock)getImageSizeForURLRequest:(NSURLRequest *)imageURLRequest
 ...
 * decoded images as long as it conforms to the ABI44_0_0RCTImageCache
 * protocol. This method should be called in bridgeDidInitializeModule.
 */
- (void)setImageCache:(id<ABI44_0_0RCTImageCache>)cache;
