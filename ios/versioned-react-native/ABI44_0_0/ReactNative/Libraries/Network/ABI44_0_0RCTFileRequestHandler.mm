...
#import "ABI44_0_0RCTNetworkPlugins.h"

@interface ABI44_0_0RCTFileRequestHandler() <ABI44_0_0RCTTurboModule>
@end

@implementation ABI44_0_0RCTFileRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  && !ABI44_0_0RCTIsBundleAssetURL(request.URL);
}

- (NSOperation *)sendRequest:(NSURLRequest *)request
                withDelegate:(id<ABI44_0_0RCTURLRequestDelegate>)delegate
{
  // Lazy setup
  if (!_fileQueue) {
...
Class ABI44_0_0RCTFileRequestHandlerCls(void) {
  return ABI44_0_0RCTFileRequestHandler.class;
}
