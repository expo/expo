...
#include "ABI44_0_0ViewShadowNode.h"
...
void ViewShadowNode::initialize() noexcept {
  ...
  bool formsStackingContext = !viewProps.collapsable ||
      ...
      (viewProps.zIndex.has_value() &&
       viewProps.yogaStyle.positionType() != ABI44_0_0YGPositionTypeStatic) ||
      viewProps.yogaStyle.display() == ABI44_0_0YGDisplayNone ||
  ...
  bool formsView = isColorMeaningful(viewProps.backgroundColor) ||
      ...
      !(viewProps.yogaStyle.border() == ABI44_0_0YGStyle::Edges{});
