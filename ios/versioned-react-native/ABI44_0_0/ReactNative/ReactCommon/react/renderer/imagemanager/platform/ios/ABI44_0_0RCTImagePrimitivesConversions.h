...
#import <ABI44_0_0React/ABI44_0_0renderer/imagemanager/primitives.h>

using namespace ABI44_0_0facebook::ABI44_0_0React;

inline static ABI44_0_0RCTResizeMode ABI44_0_0RCTResizeModeFromImageResizeMode(ImageResizeMode imageResizeMode)
{
  switch (imageResizeMode) {
    case ImageResizeMode::Cover:
      return ABI44_0_0RCTResizeModeCover;
    case ImageResizeMode::Contain:
      return ABI44_0_0RCTResizeModeContain;
    case ImageResizeMode::Stretch:
      return ABI44_0_0RCTResizeModeStretch;
    case ImageResizeMode::Center:
      return ABI44_0_0RCTResizeModeCenter;
    case ImageResizeMode::Repeat:
      return ABI44_0_0RCTResizeModeRepeat;
  }
}
...
inline static NSURLRequest *NSURLRequestFromImageSource(const ImageSource &imageSource)
{
  ...
  if (!url) {
    ABI44_0_0RCTLogError(@"URI parsing error.");
    return nil;
  }
