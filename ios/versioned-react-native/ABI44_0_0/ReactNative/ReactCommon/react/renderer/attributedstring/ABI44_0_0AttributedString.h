...
/*
 * Simple, cross-platfrom, ABI44_0_0React-specific implementation of attributed string
 * (aka spanned string).
...
namespace std {
template <>
struct hash<ABI44_0_0facebook::ABI44_0_0React::AttributedString::Fragment> {
  size_t operator()(
      const ABI44_0_0facebook::ABI44_0_0React::AttributedString::Fragment &fragment) const {
...
template <>
struct hash<ABI44_0_0facebook::ABI44_0_0React::AttributedString> {
  size_t operator()(
      const ABI44_0_0facebook::ABI44_0_0React::AttributedString &attributedString) const {
    auto seed = size_t{0};
