...
TEST(LayoutableShadowNodeTest, relativeLayoutMetrics) {
  ...
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 100);
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 200);
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 10);
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 20);
}
...
TEST(LayoutableShadowNodeTest, contentOriginOffset) {
  ...
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 0);
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 10);
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetricsOnTransformedNode) {
  ...
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 35);
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 70);
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 50);
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 100);
}
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetricsOnTransformedParent) {
  ...
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 45);
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 45);

  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 25);
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 25);
}
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetricsOnSameNode) {
  ...
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 0);
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 0);
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 100);
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 200);
}
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetricsOnSameTransformedNode) {
  ...
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 0);
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 0);
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 200);
  ABI44_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 400);
}
...
TEST(LayoutableShadowNodeTest, relativeLayourMetricsOnClonedNode) {
  ...
  auto newRelativeLayoutMetrics =
      childShadowNode->getRelativeLayoutMetrics(*parentShadowNode, {});
  ABI44_0_0EXPECT_EQ(newRelativeLayoutMetrics.frame.size.width, 50);
  ABI44_0_0EXPECT_EQ(newRelativeLayoutMetrics.frame.size.height, 60);
}
...
TEST(LayoutableShadowNodeTest, includeViewportOffset) {
  ...
  ABI44_0_0EXPECT_EQ(layoutMetrics.frame.origin.x, 10);
  ABI44_0_0EXPECT_EQ(layoutMetrics.frame.origin.y, 20);
