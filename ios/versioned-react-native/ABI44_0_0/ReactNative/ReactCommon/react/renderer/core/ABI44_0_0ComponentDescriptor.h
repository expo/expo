...
#include <ABI44_0_0React/ABI44_0_0renderer/core/EventDispatcher.h>
#include <ABI44_0_0React/ABI44_0_0renderer/core/Props.h>
#include <ABI44_0_0React/ABI44_0_0renderer/core/RawPropsParser.h>
#include <ABI44_0_0React/ABI44_0_0renderer/core/ShadowNode.h>
#include <ABI44_0_0React/ABI44_0_0renderer/core/State.h>
...
class ComponentDescriptor {
 public:
   ...
   * ABI44_0_0React uses a `name` to refer to particular kind of components in
   * `create` requests.
   */
