...
#include <ABI44_0_0React/ABI44_0_0utils/FloatComparison.h>
#include <ABI44_0_0React/ABI44_0_0utils/SimpleThreadSafeCache.h>
...
template <>
struct hash<ABI44_0_0facebook::ABI44_0_0React::TextMeasureCacheKey> {
  size_t operator()(ABI44_0_0facebook::ABI44_0_0React::TextMeasureCacheKey const &key) const {
    return folly::hash::hash_combine(
        0,
