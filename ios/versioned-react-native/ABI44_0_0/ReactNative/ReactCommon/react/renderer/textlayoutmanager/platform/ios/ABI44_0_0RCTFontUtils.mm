...
#import "ABI44_0_0RCTFontUtils.h"
...
static ABI44_0_0RCTFontProperties ABI44_0_0RCTDefaultFontProperties()
{
  static ABI44_0_0RCTFontProperties defaultFontProperties;
  ...
  dispatch_once(&onceToken, ^{
    ...
    defaultFontProperties.style = ABI44_0_0RCTFontStyleNormal;
    defaultFontProperties.variant = ABI44_0_0RCTFontVariantDefault;
...
static ABI44_0_0RCTFontProperties ABI44_0_0RCTResolveFontProperties(
    ABI44_0_0RCTFontProperties fontProperties,
    ABI44_0_0RCTFontProperties baseFontProperties)
{
  ...
  fontProperties.style =
      fontProperties.style != ABI44_0_0RCTFontStyleUndefined ? fontProperties.style : baseFontProperties.style;
  fontProperties.variant =
      fontProperties.variant != ABI44_0_0RCTFontVariantUndefined ? fontProperties.variant : baseFontProperties.variant;
  return fontProperties;
}

static UIFontWeight ABI44_0_0RCTGetFontWeight(UIFont *font)
{
  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  return [traits[UIFontWeightTrait] doubleValue];
}

static ABI44_0_0RCTFontStyle ABI44_0_0RCTGetFontStyle(UIFont *font)
{
  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
...
static NSArray *ABI44_0_0RCTFontFeatures(ABI44_0_0RCTFontVariant fontVariant)
{
  // FIXME:
  return @[];
}

static UIFont *ABI44_0_0RCTDefaultFontWithFontProperties(ABI44_0_0RCTFontProperties fontProperties)
{
  ...
  if (!font) {
    ...
    if (fontProperties.variant == ABI44_0_0RCTFontStyleItalic) {
...
UIFont *ABI44_0_0RCTFontWithFontProperties(ABI44_0_0RCTFontProperties fontProperties)
{
  ABI44_0_0RCTFontProperties defaultFontProperties = ABI44_0_0RCTDefaultFontProperties();
  fontProperties = ABI44_0_0RCTResolveFontProperties(fontProperties, defaultFontProperties);
  ...
  if ([fontProperties.family isEqualToString:defaultFontProperties.family]) {
    ...
    font = ABI44_0_0RCTDefaultFontWithFontProperties(fontProperties);
  } else {
    ...
    if (fontNames.count == 0) {
      ...
      for (NSString *name in fontNames) {
        ...
        if (ABI44_0_0RCTGetFontStyle(fontMatch) != fontProperties.style) {
          continue;
        }

        CGFloat testWeight = ABI44_0_0RCTGetFontWeight(fontMatch);
  ...
  if (fontProperties.variant != ABI44_0_0RCTFontVariantDefault) {
    NSArray *fontFeatures = ABI44_0_0RCTFontFeatures(fontProperties.variant);
    UIFontDescriptor *fontDescriptor = [font.fontDescriptor
