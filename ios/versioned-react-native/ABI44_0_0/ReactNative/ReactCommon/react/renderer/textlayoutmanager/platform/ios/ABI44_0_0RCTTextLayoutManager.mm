...
#import <ABI44_0_0React/ABI44_0_0utils/SimpleThreadSafeCache.h>

using namespace ABI44_0_0facebook::ABI44_0_0React;

@implementation ABI44_0_0RCTTextLayoutManager {
  SimpleThreadSafeCache<AttributedString, std::shared_ptr<void>, 256> _cache;
}

static NSLineBreakMode ABI44_0_0RCTNSLineBreakModeFromEllipsizeMode(EllipsizeMode ellipsizeMode)
{
                           ...
                           layoutConstraints:(LayoutConstraints)layoutConstraints
{
  ...
  size = (CGSize){ABI44_0_0RCTCeilPixelValue(size.width), ABI44_0_0RCTCeilPixelValue(size.height)};
  ...
  [textStorage
      enumerateAttribute:NSAttachmentAttributeName
              ...
              usingBlock:^(NSTextAttachment *attachment, NSRange range, BOOL *stop) {
                ...
                auto rect = ABI44_0_0facebook::ABI44_0_0React::Rect{ABI44_0_0facebook::ABI44_0_0React::Point{frame.origin.x, frame.origin.y},
                                                  ABI44_0_0facebook::ABI44_0_0React::Size{frame.size.width, frame.size.height}};
...
- (LinesMeasurements)getLinesForAttributedString:(ABI44_0_0facebook::ABI44_0_0React::AttributedString)attributedString
                                          ...
                                          usingBlock:^(
                                            ...
                                            UIFont *font = [[textStorage attributedSubstringFromRange:range]
                                                     attribute:NSFontAttributeName
                                                       atIndex:0
                                                effectiveRange:nil];
                                            auto rect = ABI44_0_0facebook::ABI44_0_0React::Rect{
                                                ABI44_0_0facebook::ABI44_0_0React::Point{usedRect.origin.x, usedRect.origin.y},
                                                ABI44_0_0facebook::ABI44_0_0React::Size{usedRect.size.width, usedRect.size.height}};
                                                               ...
                                                               size:(CGSize)size
{
  ...
  textContainer.lineBreakMode = paragraphAttributes.maximumNumberOfLines > 0
      ? ABI44_0_0RCTNSLineBreakModeFromEllipsizeMode(paragraphAttributes.ellipsizeMode)
                                                 ...
                                                 atPoint:(CGPoint)point
{
  ...
  if (textStorage.length > 0 && (fraction > 0 || characterIndex > 0) &&
    ...
    ABI44_0_0RCTWeakEventEmitterWrapper *eventEmitterWrapper =
        (ABI44_0_0RCTWeakEventEmitterWrapper *)[textStorage attribute:ABI44_0_0RCTAttributedStringEventEmitterKey
...
- (NSAttributedString *)_nsAttributedStringFromAttributedString:(AttributedString)attributedString
{
  auto sharedNSAttributedString = _cache.get(attributedString, [](AttributedString attributedString) {
    return wrapManagedObject(ABI44_0_0RCTNSAttributedStringFromAttributedString(attributedString));
  });
