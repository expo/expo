...
#include <ABI44_0_0ReactCommon/ABI44_0_0TurboModulePerfLogger.h>
#include <ABI44_0_0jsi/ABI44_0_0JSIDynamic.h>
#include <ABI44_0_0React/ABI44_0_0jni/NativeMap.h>
#include <ABI44_0_0React/ABI44_0_0jni/ReadableNativeMap.h>
#include <ABI44_0_0React/ABI44_0_0jni/WritableNativeMap.h>

#include "ABI44_0_0JavaTurboModule.h"

namespace TMPL = ABI44_0_0facebook::ABI44_0_0React::TurboModulePerfLogger;
...
jni::local_ref<JCxxCallbackImpl::JavaPart> createJavaCallbackFromJSIFunction(
  ...
  auto weakWrapper =
      ABI44_0_0React::CallbackWrapper::createWeak(std::move(function), rt, jsInvoker);
...
JNIArgs JavaTurboModule::convertJSIArgsToJNIArgs(
  ...
  for (unsigned int argIndex = 0; argIndex < count; argIndex += 1) {
    ...
    if (!(type == "Ljava/lang/Double;" || type == "Ljava/lang/Boolean;" ||
          ...
          type == "Lcom/facebook/ABI44_0_0React/bridge/ReadableArray;" ||
          type == "Lcom/facebook/ABI44_0_0React/bridge/Callback;" ||
          type == "Lcom/facebook/ABI44_0_0React/bridge/ReadableMap;")) {
    ...
    if (type == "Lcom/facebook/ABI44_0_0React/bridge/ReadableArray;") {
    ...
    if (type == "Lcom/facebook/ABI44_0_0React/bridge/Callback;") {
    ...
    if (type == "Lcom/facebook/ABI44_0_0React/bridge/ReadableMap;") {
      if (!(arg->isObject())) {
        throw JavaTurboModuleArgumentConversionException(
...
jsi::Value convertFromJMapToValue(JNIEnv *env, jsi::Runtime &rt, jobject arg) {
  ...
  jclass jArguments = env->FindClass("com/facebook/ABI44_0_0React/bridge/Arguments");
  static jmethodID jMakeNativeMap = env->GetStaticMethodID(
      jArguments,
      "makeNativeMap",
      "(Ljava/util/Map;)Lcom/facebook/ABI44_0_0React/bridge/WritableNativeMap;");
  auto constants =
      ...
      jsi::Function promiseConstructorArg = jsi::Function::createFromHostFunction(
          ...
          [this,
           ...
           env](
            ...
            jclass jPromiseImpl =
                env->FindClass("com/facebook/ABI44_0_0React/bridge/PromiseImpl");
            jmethodID jPromiseImplConstructor = env->GetMethodID(
                jPromiseImpl,
                "<init>",
                "(Lcom/facebook/ABI44_0_0React/bridge/Callback;Lcom/facebook/ABI44_0_0React/bridge/Callback;)V");
