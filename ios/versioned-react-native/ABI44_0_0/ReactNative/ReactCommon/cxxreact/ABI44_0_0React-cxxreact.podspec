...
Pod::Spec.new do |s|
  s.name                   = "ABI44_0_0React-cxxreact"
  s.version                = version
  s.summary                = "-"  # TODO
  ...
  s.exclude_files          = "ABI44_0_0SampleCxxModule.*"
  ...
  s.header_dir             = "ABI44_0_0cxxreact"

  s.dependency "boost-for-react-native", "1.63.0"
  s.dependency "DoubleConversion"
  s.dependency "RCT-Folly", folly_version
  s.dependency "glog"
  s.dependency "ABI44_0_0React-jsinspector", version
  s.dependency "ABI44_0_0React-callinvoker", version
  s.dependency "ABI44_0_0React-runtimeexecutor", version
