...
#include "ABI44_0_0SampleCxxModule.h"
...
ABI44_0_0facebook::xplat::module::CxxModule *SampleCxxModule() {
  return new ABI44_0_0facebook::xplat::samples::SampleCxxModule(
      std::make_unique<ABI44_0_0facebook::xplat::samples::Sample>());
}
