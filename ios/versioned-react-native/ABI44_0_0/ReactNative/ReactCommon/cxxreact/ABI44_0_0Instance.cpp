...
#include "ABI44_0_0Instance.h"

#include "ABI44_0_0JSBigString.h"
#include "ABI44_0_0JSBundleType.h"
#include "ABI44_0_0JSExecutor.h"
#include "ABI44_0_0MessageQueueThread.h"
#include "ABI44_0_0MethodCall.h"
#include "ABI44_0_0NativeToJsBridge.h"
#include "ABI44_0_0RAMBundleRegistry.h"
#include "ABI44_0_0RecoverableError.h"
#include "ABI44_0_0SystraceSection.h"

#include <ABI44_0_0cxxreact/ABI44_0_0JSIndexedRAMBundle.h>
...
void Instance::JSCallInvoker::invokeAsync(std::function<void()> &&work) {
   ...
   *    is initialized. ABI44_0_0RCTDevLoadingView shows bundle download progress.
