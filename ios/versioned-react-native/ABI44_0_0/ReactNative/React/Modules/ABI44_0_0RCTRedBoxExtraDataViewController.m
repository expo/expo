...
#import "ABI44_0_0RCTRedBoxExtraDataViewController.h"

@interface ABI44_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI44_0_0RCTRedBoxExtraDataCell
...
@interface ABI44_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI44_0_0RCTRedBoxExtraDataViewController {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  ABI44_0_0RCTRedBoxExtraDataCell *cell =
      (ABI44_0_0RCTRedBoxExtraDataCell *)[tableView dequeueReusableCellWithIdentifier:reuseIdentifier];

  if (cell == nil) {
    cell = [[ABI44_0_0RCTRedBoxExtraDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
  }
