...
typedef dispatch_block_t ABI44_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI44_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ABI44_0_0React-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI44_0_0RCTUIManager's observers.
 */
@interface ABI44_0_0RCTUIManagerObserverCoordinator : NSObject <ABI44_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI44_0_0RCTUIManagerObserver` protocol for more info.
