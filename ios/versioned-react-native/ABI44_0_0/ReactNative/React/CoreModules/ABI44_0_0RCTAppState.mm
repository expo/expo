...
static NSString *ABI44_0_0RCTCurrentAppState()
{
  ...
  return states[@(ABI44_0_0RCTSharedApplication().applicationState)] ?: @"unknown";
}

@interface ABI44_0_0RCTAppState () <ABI44_0_0NativeAppStateSpec>
@end

@implementation ABI44_0_0RCTAppState {
...
- (void)handleAppStateDidChange:(NSNotification *)notification
{
  ...
  if ([notification.name isEqualToString:UIApplicationWillResignActiveNotification]) {
    ...
    newState = ABI44_0_0RCTCurrentAppState();
  }
 ...
 */
ABI44_0_0RCT_EXPORT_METHOD(getCurrentAppState : (ABI44_0_0RCTResponseSenderBlock)callback error : (__unused ABI44_0_0RCTResponseSenderBlock)error)
{
  callback(@[ @{@"app_state" : ABI44_0_0RCTCurrentAppState()} ]);
}
...
{
  return std::make_shared<ABI44_0_0facebook::ABI44_0_0React::NativeAppStateSpecJSI>(params);
}

@end

Class ABI44_0_0RCTAppStateCls(void)
{
  return ABI44_0_0RCTAppState.class;
}
