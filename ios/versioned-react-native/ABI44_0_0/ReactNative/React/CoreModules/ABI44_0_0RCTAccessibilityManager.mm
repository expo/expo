...
#import "ABI44_0_0RCTAccessibilityManager.h"
...
NSString *const ABI44_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification =
    @"ABI44_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification";

@interface ABI44_0_0RCTAccessibilityManager () <ABI44_0_0NativeAccessibilityManagerSpec>
...
@implementation ABI44_0_0RCTAccessibilityManager
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    self.contentSizeCategory = ABI44_0_0RCTSharedApplication().preferredContentSizeCategory;
...
- (void)invalidateMultiplier
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI44_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification
                                                      object:self];
}
...
- (CGFloat)multiplierForContentSizeCategory:(NSString *)category
{
  ...
  if (m.doubleValue <= 0.0) {
    ABI44_0_0RCTLogError(@"Can't determine multiplier for category %@. Using 1.0.", category);
    m = @1.0;
  }
...
ABI44_0_0RCT_EXPORT_METHOD(setAccessibilityFocus : (double)ABI44_0_0ReactTag)
{
  dispatch_async(dispatch_get_main_queue(), ^{
    UIView *view = [self.bridge.uiManager viewForABI44_0_0ReactTag:@(ABI44_0_0ReactTag)];
    UIAccessibilityPostNotification(UIAccessibilityLayoutChangedNotification, view);
  });
}

ABI44_0_0RCT_EXPORT_METHOD(announceForAccessibility : (NSString *)announcement)
{
  UIAccessibilityPostNotification(UIAccessibilityAnnouncementNotification, announcement);
}

ABI44_0_0RCT_EXPORT_METHOD(getMultiplier : (ABI44_0_0RCTResponseSenderBlock)callback)
{
  if (callback) {
...
ABI44_0_0RCT_EXPORT_METHOD(getCurrentBoldTextState
                  : (ABI44_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI44_0_0RCTResponseSenderBlock)onError)
{
  onSuccess(@[ @(_isBoldTextEnabled) ]);
}

ABI44_0_0RCT_EXPORT_METHOD(getCurrentGrayscaleState
                  : (ABI44_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI44_0_0RCTResponseSenderBlock)onError)
{
...
ABI44_0_0RCT_EXPORT_METHOD(getCurrentInvertColorsState
                  : (ABI44_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI44_0_0RCTResponseSenderBlock)onError)
{
...
ABI44_0_0RCT_EXPORT_METHOD(getCurrentReduceMotionState
                  : (ABI44_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI44_0_0RCTResponseSenderBlock)onError)
{
...
ABI44_0_0RCT_EXPORT_METHOD(getCurrentReduceTransparencyState
                  : (ABI44_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI44_0_0RCTResponseSenderBlock)onError)
{
...
ABI44_0_0RCT_EXPORT_METHOD(getCurrentVoiceOverState
                  : (ABI44_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI44_0_0RCTResponseSenderBlock)onError)
{
...
{
  return std::make_shared<ABI44_0_0facebook::ABI44_0_0React::NativeAccessibilityManagerSpecJSI>(params);
}

@end

@implementation ABI44_0_0RCTBridge (ABI44_0_0RCTAccessibilityManager)

- (ABI44_0_0RCTAccessibilityManager *)accessibilityManager
{
  return [self moduleForClass:[ABI44_0_0RCTAccessibilityManager class]];
}

@end

Class ABI44_0_0RCTAccessibilityManagerCls(void)
{
  return ABI44_0_0RCTAccessibilityManager.class;
}
