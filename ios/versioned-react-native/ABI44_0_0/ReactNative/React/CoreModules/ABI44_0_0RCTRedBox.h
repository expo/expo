...
#import <ABI44_0_0React/ABI44_0_0RCTErrorCustomizer.h>

@class ABI44_0_0RCTJSStackFrame;

typedef void (^ABI44_0_0RCTRedBoxButtonPressHandler)(void);

@interface ABI44_0_0RCTRedBox : NSObject <ABI44_0_0RCTBridgeModule>

- (void)registerErrorCustomizer:(id<ABI44_0_0RCTErrorCustomizer>)errorCustomizer;
...
- (void)showErrorMessage:(NSString *)message withParsedStack:(NSArray<ABI44_0_0RCTJSStackFrame *> *)stack;
- (void)updateErrorMessage:(NSString *)message withParsedStack:(NSArray<ABI44_0_0RCTJSStackFrame *> *)stack;
- (void)showErrorMessage:(NSString *)message
         withParsedStack:(NSArray<ABI44_0_0RCTJSStackFrame *> *)stack
...
- (void)addCustomButton:(NSString *)title onPressHandler:(ABI44_0_0RCTRedBoxButtonPressHandler)handler;
...
/**
 * This category makes the red box instance available via the ABI44_0_0RCTBridge, which
 * is useful for any class that needs to access the red box or error log.
 */
@interface ABI44_0_0RCTBridge (ABI44_0_0RCTRedBox)

@property (nonatomic, readonly) ABI44_0_0RCTRedBox *redBox;
