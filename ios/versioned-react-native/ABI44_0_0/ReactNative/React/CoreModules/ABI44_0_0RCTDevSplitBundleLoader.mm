...
#import <ABI44_0_0React/ABI44_0_0RCTDevSplitBundleLoader.h>
...
@interface ABI44_0_0RCTDevSplitBundleLoader () <ABI44_0_0NativeDevSplitBundleLoaderSpec>
@end

#if ABI44_0_0RCT_DEV_MENU

@implementation ABI44_0_0RCTDevSplitBundleLoader
...
ABI44_0_0RCT_EXPORT_METHOD(loadBundle
                  : (NSString *)bundlePath resolve
                  : (ABI44_0_0RCTPromiseResolveBlock)resolve reject
                  : (ABI44_0_0RCTPromiseRejectBlock)reject)
{
  NSURL *sourceURL = [[ABI44_0_0RCTBundleURLProvider sharedSettings] jsBundleURLForSplitBundleRoot:bundlePath];
  if (_bridge) {
    ...
    [ABI44_0_0RCTJavaScriptLoader loadBundleAtURL:sourceURL
        ...
        onComplete:^(NSError *error, ABI44_0_0RCTSource *source) {
          ...
          ABI44_0_0RCTDevSettings *devSettings = [strongSelf->_turboModuleRegistry moduleForName:"ABI44_0_0RCTDevSettings"];
...
- (void)loadBundle:(NSString *)bundlePath resolve:(ABI44_0_0RCTPromiseResolveBlock)resolve reject:(ABI44_0_0RCTPromiseRejectBlock)reject;
{
}
- (std::shared_ptr<TurboModule>)getTurboModule:(const ObjCTurboModule::InitParams &)params
{
...
Class ABI44_0_0RCTDevSplitBundleLoaderCls(void)
{
  return ABI44_0_0RCTDevSplitBundleLoader.class;
}
