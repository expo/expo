...
typedef uint32_t ABI44_0_0RCTHandlerToken;
typedef void (^ABI44_0_0RCTNotificationHandler)(NSDictionary<NSString *, id> *);
typedef void (^ABI44_0_0RCTRequestHandler)(NSDictionary<NSString *, id> *, ABI44_0_0RCTPackagerClientResponder *);
typedef void (^ABI44_0_0RCTConnectedHandler)(void);

/** Encapsulates singleton connection to ABI44_0_0React Native packager. */
@interface ABI44_0_0RCTPackagerConnection : NSObject
