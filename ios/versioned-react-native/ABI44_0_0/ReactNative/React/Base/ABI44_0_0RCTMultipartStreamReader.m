...
#import "ABI44_0_0RCTMultipartStreamReader.h"

#import <QuartzCore/CAAnimation.h>

#define CRLF @"\r\n"

@implementation ABI44_0_0RCTMultipartStreamReader {
...
- (void)emitChunk:(NSData *)data headers:(NSDictionary *)headers callback:(ABI44_0_0RCTMultipartCallback)callback done:(BOOL)done
{
...
- (void)emitProgress:(NSDictionary *)headers
       contentLength:(NSUInteger)contentLength
               final:(BOOL)final
            callback:(ABI44_0_0RCTMultipartProgressCallback)callback
{
  if (headers == nil) {
    return;
  }
...
- (BOOL)readAllPartsWithCompletionCallback:(ABI44_0_0RCTMultipartCallback)callback
                          progressCallback:(ABI44_0_0RCTMultipartProgressCallback)progressCallback
{
