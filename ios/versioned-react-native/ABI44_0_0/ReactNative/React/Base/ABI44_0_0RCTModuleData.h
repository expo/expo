...
@protocol ABI44_0_0RCTBridgeMethod;
@protocol ABI44_0_0RCTBridgeModule;
@class ABI44_0_0RCTBridge;

typedef id<ABI44_0_0RCTBridgeModule> (^ABI44_0_0RCTBridgeModuleProvider)(void);

@interface ABI44_0_0RCTModuleData : NSObject <ABI44_0_0RCTInvalidating>

- (instancetype)initWithModuleClass:(Class)moduleClass bridge:(ABI44_0_0RCTBridge *)bridge;

- (instancetype)initWithModuleClass:(Class)moduleClass
                     moduleProvider:(ABI44_0_0RCTBridgeModuleProvider)moduleProvider
                             bridge:(ABI44_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;

- (instancetype)initWithModuleInstance:(id<ABI44_0_0RCTBridgeModule>)instance
                                bridge:(ABI44_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI44_0_0RCTBridgeMethod>> *methods;

/**
 * Returns a map of the module methods. Note that this will gather the methods the first
 * time it is called and then memoize the results.
 */
@property (nonatomic, copy, readonly) NSDictionary<NSString *, id<ABI44_0_0RCTBridgeMethod>> *methodsByName;
 ...
 */
@property (nonatomic, strong, readwrite) id<ABI44_0_0RCTBridgeModule> instance;
...
ABI44_0_0RCT_EXTERN void ABI44_0_0RCTSetIsMainQueueExecutionOfConstantsToExportDisabled(BOOL val);
ABI44_0_0RCT_EXTERN BOOL ABI44_0_0RCTIsMainQueueExecutionOfConstantsToExportDisabled(void);
