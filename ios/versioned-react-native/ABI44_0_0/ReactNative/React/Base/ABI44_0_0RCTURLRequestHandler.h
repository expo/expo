 ...
 * are also bridge modules, so should be registered using ABI44_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI44_0_0RCTURLRequestHandler <ABI44_0_0RCTBridgeModule>
...
/**
 * If more than one ABI44_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
