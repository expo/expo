...
extern NSString *const ABI44_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI44_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI44_0_0RCTBundleURLProvider : NSObject
 ...
 * The port is optional, if not specified, kABI44_0_0RCTBundleURLProviderDefaultPort will be used
 */
