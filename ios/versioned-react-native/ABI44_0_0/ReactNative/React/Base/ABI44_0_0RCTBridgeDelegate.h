...
@protocol ABI44_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI44_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI44_0_0RCTBridgeModules automatically, however
 ...
 * previously called ABI44_0_0facebook::ABI44_0_0React::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI44_0_0RCTBridge *)bridge;
 ...
 */
- (BOOL)bridge:(ABI44_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI44_0_0RCTBridge *)bridge
                 onProgress:(ABI44_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI44_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Similar to loadSourceForBridge:onProgress:onComplete: but without progress
 * reporting.
 */
- (void)loadSourceForBridge:(ABI44_0_0RCTBridge *)bridge withBlock:(ABI44_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Retrieve the list of lazy-native-modules names for the given bridge.
 */
- (NSDictionary<NSString *, Class> *)extraLazyModuleClassesForBridge:(ABI44_0_0RCTBridge *)bridge;
