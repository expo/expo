...
@interface ABI44_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>

@end

@implementation ABI44_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI44_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI44_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI44_0_0RCTMultipartStreamReader *reader = [[ABI44_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream
                                                                                  boundary:_boundary];
  ABI44_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
