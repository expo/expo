 ...
 */
@interface ABI44_0_0RCTImageSource : NSObject
...
@interface ABI44_0_0RCTConvert (ImageSource)

+ (ABI44_0_0RCTImageSource *)ABI44_0_0RCTImageSource:(id)json;
+ (NSArray<ABI44_0_0RCTImageSource *> *)ABI44_0_0RCTImageSourceArray:(id)json;
