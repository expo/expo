 ...
 * classes to change the ABI44_0_0RCTRootViews's internal state.
 */
@interface ABI44_0_0RCTRootView ()

/**
 * This setter should be used only by ABI44_0_0RCTUIManager on ABI44_0_0React root view
