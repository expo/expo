...
#import <ABI44_0_0RCTRequired/ABI44_0_0RCTRequired.h>
#import <ABI44_0_0RCTTypeSafety/ABI44_0_0RCTConvertHelpers.h>
#import <ABI44_0_0RCTTypeSafety/ABI44_0_0RCTTypedModuleConstants.h>
...
@protocol ABI44_0_0NativeAccessibilityInfoSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>

- (void)isReduceMotionEnabled:(ABI44_0_0RCTResponseSenderBlock)onSuccess;
- (void)isTouchExplorationEnabled:(ABI44_0_0RCTResponseSenderBlock)onSuccess;
...
- (void)getCurrentBoldTextState:(ABI44_0_0RCTResponseSenderBlock)onSuccess
                        onError:(ABI44_0_0RCTResponseSenderBlock)onError;
- (void)getCurrentGrayscaleState:(ABI44_0_0RCTResponseSenderBlock)onSuccess
                         onError:(ABI44_0_0RCTResponseSenderBlock)onError;
- (void)getCurrentInvertColorsState:(ABI44_0_0RCTResponseSenderBlock)onSuccess
                            onError:(ABI44_0_0RCTResponseSenderBlock)onError;
- (void)getCurrentReduceMotionState:(ABI44_0_0RCTResponseSenderBlock)onSuccess
                            onError:(ABI44_0_0RCTResponseSenderBlock)onError;
- (void)getCurrentReduceTransparencyState:(ABI44_0_0RCTResponseSenderBlock)onSuccess
                                  onError:(ABI44_0_0RCTResponseSenderBlock)onError;
...
namespace JS {
  namespace NativeActionSheetManager {
    struct SpecShowActionSheetWithOptionsOptions {
      ...
      folly::Optional<ABI44_0_0facebook::ABI44_0_0React::LazyVector<NSString *>> options() const;
      folly::Optional<ABI44_0_0facebook::ABI44_0_0React::LazyVector<double>> destructiveButtonIndices() const;
      ...
      folly::Optional<ABI44_0_0facebook::ABI44_0_0React::LazyVector<double>> disabledButtonIndices() const;
...
namespace JS {
  namespace NativeActionSheetManager {
    struct SpecShowShareActionSheetWithOptionsOptions {
      ...
      folly::Optional<double> anchor() const;
      folly::Optional<double> tintColor() const;
      folly::Optional<ABI44_0_0facebook::ABI44_0_0React::LazyVector<NSString *>> excludedActivityTypes() const;
      NSString *userInterfaceStyle() const;
...
namespace JS {
  namespace NativeAlertManager {
    struct Args {
      NSString *title() const;
      NSString *message() const;
      folly::Optional<ABI44_0_0facebook::ABI44_0_0React::LazyVector<id<NSObject> >> buttons() const;
      NSString *type() const;
...
saveValueCallback:(ABI44_0_0RCTResponseSenderBlock)saveValueCallback;
...
- (void)startAnimatingNode:(double)animationId
                   nodeTag:(double)nodeTag
                    config:(NSDictionary *)config
               endCallback:(ABI44_0_0RCTResponseSenderBlock)endCallback;
...
@protocol ABI44_0_0NativeAnimationsDebugModuleSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
namespace JS {
  namespace NativeAppState {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI44_0_0RCTRequired<NSString *> initialAppState;
        };
...
@protocol ABI44_0_0NativeAppStateSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>

- (void)getCurrentAppState:(ABI44_0_0RCTResponseSenderBlock)success
...
@protocol ABI44_0_0NativeAppearanceSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeAsyncLocalStorageSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
- (void)multiRemove:(NSArray *)keys
           callback:(ABI44_0_0RCTResponseSenderBlock)callback;
- (void)clear:(ABI44_0_0RCTResponseSenderBlock)callback;
- (void)getAllKeys:(ABI44_0_0RCTResponseSenderBlock)callback;
...
@protocol ABI44_0_0NativeAsyncSQLiteDBStorageSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
namespace JS {
  namespace NativeBlobModule {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI44_0_0RCTRequired<NSString *> BLOB_URI_SCHEME;
          ABI44_0_0RCTRequired<NSString *> BLOB_URI_HOST;
        };
...
@protocol ABI44_0_0NativeBlobModuleSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeBugReportingSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeClipboardSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>

- (void)getString:(ABI44_0_0RCTPromiseResolveBlock)resolve
...
@protocol ABI44_0_0NativeDevLoadingViewSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeDevMenuSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeDevSettingsSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeDevSplitBundleLoaderSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeDeviceEventManagerSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
namespace JS {
  namespace NativeDeviceInfo {
    struct DisplayMetrics {
      ...
      struct Builder {
        struct Input {
          ABI44_0_0RCTRequired<double> width;
          ABI44_0_0RCTRequired<double> height;
          ABI44_0_0RCTRequired<double> scale;
          ABI44_0_0RCTRequired<double> fontScale;
        };
    ...
    struct DisplayMetricsAndroid {
      ...
      struct Builder {
        struct Input {
          ...
          ABI44_0_0RCTRequired<double> scale;
          ABI44_0_0RCTRequired<double> fontScale;
          ABI44_0_0RCTRequired<double> densityDpi;
        };
...
@protocol ABI44_0_0NativeFileReaderModuleSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeHeadlessJsTaskSupportSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
namespace JS {
  namespace NativeI18nManager {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI44_0_0RCTRequired<bool> isRTL;
          ABI44_0_0RCTRequired<bool> doLeftAndRightSwapInRTL;
        };
...
@protocol ABI44_0_0NativeI18nManagerSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeImageLoaderIOSSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeImageStoreIOSSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeJSCHeapCaptureSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeJSCSamplingProfilerSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
namespace JS {
  namespace NativeJSDevSupport {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI44_0_0RCTRequired<double> ERROR_CODE_EXCEPTION;
          ABI44_0_0RCTRequired<double> ERROR_CODE_VIEW_NOT_FOUND;
        };
...
@protocol ABI44_0_0NativeJSDevSupportSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeKeyboardObserverSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeLinkingManagerSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>

- (void)getInitialURL:(ABI44_0_0RCTPromiseResolveBlock)resolve
               reject:(ABI44_0_0RCTPromiseRejectBlock)reject;
...
- (void)openURL:(NSString *)url
        resolve:(ABI44_0_0RCTPromiseResolveBlock)resolve
         reject:(ABI44_0_0RCTPromiseRejectBlock)reject;
- (void)openSettings:(ABI44_0_0RCTPromiseResolveBlock)resolve
              reject:(ABI44_0_0RCTPromiseRejectBlock)reject;
- (void)addListener:(NSString *)eventName;
- (void)removeListeners:(double)count;
...
@protocol ABI44_0_0NativeLogBoxSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeModalManagerSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
namespace JS {
  namespace NativePlatformConstantsIOS {
    struct ConstantsreactNativeVersion {
      ...
      struct Builder {
        struct Input {
          ABI44_0_0RCTRequired<double> major;
          ABI44_0_0RCTRequired<double> minor;
          ABI44_0_0RCTRequired<double> patch;
          ABI44_0_0RCTRequired<folly::Optional<double>> prerelease;
        };
    ...
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ...
          ABI44_0_0RCTRequired<NSString *> interfaceIdiom;
        };
...
- (void)getInitialNotification:(ABI44_0_0RCTPromiseResolveBlock)resolve
                        reject:(ABI44_0_0RCTPromiseRejectBlock)reject;
- (void)getScheduledLocalNotifications:(ABI44_0_0RCTResponseSenderBlock)callback;
- (void)removeAllDeliveredNotifications;
- (void)removeDeliveredNotifications:(NSArray *)identifiers;
- (void)getDeliveredNotifications:(ABI44_0_0RCTResponseSenderBlock)callback;
...
@protocol ABI44_0_0NativeRedBoxSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeSegmentFetcherSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
namespace JS {
  namespace NativeSettingsManager {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI44_0_0RCTRequired<id<NSObject> > settings;
        };
...
@protocol ABI44_0_0NativeSettingsManagerSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeSoundManagerSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
namespace JS {
  namespace NativeSourceCode {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI44_0_0RCTRequired<NSString *> scriptURL;
        };
...
@protocol ABI44_0_0NativeStatusBarManagerIOSSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>

- (void)getHeight:(ABI44_0_0RCTResponseSenderBlock)callback;
...
@protocol ABI44_0_0NativeTimingSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
...
@protocol ABI44_0_0NativeVibrationSpec <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTTurboModule>
