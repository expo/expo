...
#import <ABI44_0_0React/ABI44_0_0RCTMountingTransactionObserving.h>
#import <ABI44_0_0React/ABI44_0_0RCTViewComponentView.h>

/**
 * UIView class for root <ModalHostView> component.
 */
@interface ABI44_0_0RCTModalHostViewComponentView : ABI44_0_0RCTViewComponentView <ABI44_0_0RCTMountingTransactionObserving>

/**
 * Subclasses may override this method and present the modal on different view controller.
 * Default implementation presents the modal on `[self ABI44_0_0ReactViewController]`.
 */
