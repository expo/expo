...
#import <ABI44_0_0React/ABI44_0_0RCTTouchableComponentViewProtocol.h>
#import <ABI44_0_0React/ABI44_0_0UIView+ComponentViewProtocol.h>
 ...
 */
@interface ABI44_0_0RCTViewComponentView : UIView <ABI44_0_0RCTComponentViewProtocol, ABI44_0_0RCTTouchableComponentViewProtocol> {
 @protected
  ABI44_0_0facebook::ABI44_0_0React::LayoutMetrics _layoutMetrics;
  ABI44_0_0facebook::ABI44_0_0React::SharedViewProps _props;
  ABI44_0_0facebook::ABI44_0_0React::SharedViewEventEmitter _eventEmitter;
}
...
/**
 * Enforcing `call super` semantic for overridden methods from `ABI44_0_0RCTComponentViewProtocol`.
 * The methods update the instance variables.
 */
- (void)updateProps:(ABI44_0_0facebook::ABI44_0_0React::Props::Shared const &)props
           oldProps:(ABI44_0_0facebook::ABI44_0_0React::Props::Shared const &)oldProps NS_REQUIRES_SUPER;
- (void)updateEventEmitter:(ABI44_0_0facebook::ABI44_0_0React::EventEmitter::Shared const &)eventEmitter NS_REQUIRES_SUPER;
- (void)updateLayoutMetrics:(ABI44_0_0facebook::ABI44_0_0React::LayoutMetrics const &)layoutMetrics
           oldLayoutMetrics:(ABI44_0_0facebook::ABI44_0_0React::LayoutMetrics const &)oldLayoutMetrics NS_REQUIRES_SUPER;
