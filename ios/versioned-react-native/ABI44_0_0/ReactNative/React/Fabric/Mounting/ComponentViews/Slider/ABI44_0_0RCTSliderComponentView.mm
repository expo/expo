...
#import <ABI44_0_0React/ABI44_0_0renderer/components/slider/SliderComponentDescriptor.h>

#import "ABI44_0_0RCTFabricComponentsPlugins.h"

using namespace ABI44_0_0facebook::ABI44_0_0React;

@interface ABI44_0_0RCTSliderComponentView () <ABI44_0_0RCTImageResponseDelegate>
@end

@implementation ABI44_0_0RCTSliderComponentView {
  ...
  ABI44_0_0RCTImageResponseObserverProxy _trackImageResponseObserverProxy;
  ABI44_0_0RCTImageResponseObserverProxy _minimumTrackImageResponseObserverProxy;
  ABI44_0_0RCTImageResponseObserverProxy _maximumTrackImageResponseObserverProxy;
  ABI44_0_0RCTImageResponseObserverProxy _thumbImageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _trackImageResponseObserverProxy = ABI44_0_0RCTImageResponseObserverProxy(self);
    _minimumTrackImageResponseObserverProxy = ABI44_0_0RCTImageResponseObserverProxy(self);
    _maximumTrackImageResponseObserverProxy = ABI44_0_0RCTImageResponseObserverProxy(self);
    _thumbImageResponseObserverProxy = ABI44_0_0RCTImageResponseObserverProxy(self);
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldSliderProps.thumbTintColor != newSliderProps.thumbTintColor) {
    _sliderView.thumbTintColor = ABI44_0_0RCTUIColorFromSharedColor(newSliderProps.thumbTintColor);
  }

  // `minimumTrackTintColor`
  if (oldSliderProps.minimumTrackTintColor != newSliderProps.minimumTrackTintColor) {
    _sliderView.minimumTrackTintColor = ABI44_0_0RCTUIColorFromSharedColor(newSliderProps.minimumTrackTintColor);
  }

  // `maximumTrackTintColor`
  if (oldSliderProps.maximumTrackTintColor != newSliderProps.maximumTrackTintColor) {
    _sliderView.maximumTrackTintColor = ABI44_0_0RCTUIColorFromSharedColor(newSliderProps.maximumTrackTintColor);
  }
...
#pragma mark - ABI44_0_0RCTImageResponseDelegate
...
Class<ABI44_0_0RCTComponentViewProtocol> ABI44_0_0RCTSliderCls(void)
{
  return ABI44_0_0RCTSliderComponentView.class;
}
