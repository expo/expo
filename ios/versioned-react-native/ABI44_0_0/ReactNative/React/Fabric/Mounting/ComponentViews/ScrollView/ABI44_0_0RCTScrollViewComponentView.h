 ...
 */
@interface ABI44_0_0RCTScrollViewComponentView : ABI44_0_0RCTViewComponentView <ABI44_0_0RCTMountingTransactionObserving>

/*
 * Finds and returns the closet ABI44_0_0RCTScrollViewComponentView component to the given view
 */
...
/*
 * ABI44_0_0RCTScrollableProtocol is a protocol which ABI44_0_0RCTScrollViewManager uses to communicate with all kinds of `UIScrollView`s.
 ...
 */
@interface ABI44_0_0RCTScrollViewComponentView (ScrollableProtocol) <ABI44_0_0RCTScrollableProtocol>
