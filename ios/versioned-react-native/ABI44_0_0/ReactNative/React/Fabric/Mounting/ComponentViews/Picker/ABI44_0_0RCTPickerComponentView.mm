...
#import "ABI44_0_0RCTPickerComponentView.h"

#import <ABI44_0_0React/ABI44_0_0RCTConvert.h>
#import <ABI44_0_0React/ABI44_0_0RCTLog.h>
#import <UIKit/UIKit.h>
#import <ABI44_0_0React/ABI44_0_0renderer/components/iospicker/PickerComponentDescriptor.h>
#import <ABI44_0_0React/ABI44_0_0renderer/components/iospicker/PickerEventEmitter.h>
#import <ABI44_0_0React/ABI44_0_0renderer/components/iospicker/PickerProps.h>
...
@interface ABI44_0_0RCTPickerComponentView () <UIPickerViewAccessibilityDelegate, UIPickerViewDelegate, UIPickerViewDataSource>

@end

@implementation ABI44_0_0RCTPickerComponentView {
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldPickerProps.textAttributes != newPickerProps.textAttributes) {
    _textAttributes = ABI44_0_0RCTNSTextAttributesFromTextAttributes(newPickerProps.getEffectiveTextAttributes());
    needsToReload = true;
  }
...
- (void)handleCommand:(const NSString *)commandName args:(const NSArray *)args
{
  if ([commandName isEqualToString:@"setNativeSelectedIndex"] && [args objectAtIndex:0]) {
    ...
    ABI44_0_0RCTLogWarn(@"Attempting to send unknown command to Picker component: %@", commandName);
  }
}
           ...
           reusingView:(UILabel *)label
{
  ...
  if (ABI44_0_0RCTUIColorFromSharedColor(_items[row].textColor)) {
    attributes[NSForegroundColorAttributeName] = ABI44_0_0RCTUIColorFromSharedColor(_items[row].textColor);
  }
...
Class<ABI44_0_0RCTComponentViewProtocol> ABI44_0_0RCTPickerCls(void)
{
  return ABI44_0_0RCTPickerComponentView.class;
}
