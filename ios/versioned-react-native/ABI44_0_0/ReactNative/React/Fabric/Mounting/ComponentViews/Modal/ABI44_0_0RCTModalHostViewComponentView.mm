...
#import "ABI44_0_0RCTModalHostViewComponentView.h"

#import <ABI44_0_0React/ABI44_0_0UIView+React.h>
#import <ABI44_0_0React/ABI44_0_0renderer/components/modal/ModalHostViewComponentDescriptor.h>
#import <ABI44_0_0React/ABI44_0_0renderer/components/modal/ModalHostViewState.h>
...
@interface ABI44_0_0RCTModalHostViewComponentView () <ABI44_0_0RCTFabricModalHostViewControllerDelegate>

@end

@implementation ABI44_0_0RCTModalHostViewComponentView {
  ABI44_0_0RCTFabricModalHostViewController *_viewController;
...
- (ABI44_0_0RCTFabricModalHostViewController *)viewController
{
  if (!_viewController) {
    _viewController = [ABI44_0_0RCTFabricModalHostViewController new];
...
{
  UIViewController *controller = [self ABI44_0_0ReactViewController];
...
#pragma mark - ABI44_0_0RCTFabricModalHostViewControllerDelegate
...
- (void)boundsDidChange:(CGRect)newBounds
{
  ...
  auto newState = ModalHostViewState{ABI44_0_0RCTSizeFromCGSize(newBounds.size)};
