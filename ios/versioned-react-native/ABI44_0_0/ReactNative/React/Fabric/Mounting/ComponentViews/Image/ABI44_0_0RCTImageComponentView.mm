...
#import <ABI44_0_0React/ABI44_0_0RCTImageBlurUtils.h>
#import <ABI44_0_0React/ABI44_0_0RCTImageResponseObserverProxy.h>
#import <ABI44_0_0React/ABI44_0_0renderer/components/image/ImageComponentDescriptor.h>
#import <ABI44_0_0React/ABI44_0_0renderer/components/image/ImageEventEmitter.h>
#import <ABI44_0_0React/ABI44_0_0renderer/components/image/ImageProps.h>
#import <ABI44_0_0React/ABI44_0_0renderer/imagemanager/ImageRequest.h>
#import <ABI44_0_0React/ABI44_0_0renderer/imagemanager/ABI44_0_0RCTImagePrimitivesConversions.h>

using namespace ABI44_0_0facebook::ABI44_0_0React;

@interface ABI44_0_0RCTImageComponentView ()
@end

@implementation ABI44_0_0RCTImageComponentView {
  ImageShadowNode::ConcreteStateTeller _stateTeller;
  ImageResponseObserverCoordinator const *_coordinator;
  ABI44_0_0RCTImageResponseObserverProxy _imageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _imageView.contentMode = (UIViewContentMode)ABI44_0_0RCTResizeModeFromImageResizeMode(defaultProps->resizeMode);
    _imageView.layer.minificationFilter = kCAFilterTrilinear;
    _imageView.layer.magnificationFilter = kCAFilterTrilinear;

    _imageResponseObserverProxy = ABI44_0_0RCTImageResponseObserverProxy(self);
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldImageProps.resizeMode != newImageProps.resizeMode) {
    if (newImageProps.resizeMode == ImageResizeMode::Repeat) {
      ...
      _imageView.contentMode = (UIViewContentMode)ABI44_0_0RCTResizeModeFromImageResizeMode(newImageProps.resizeMode);
    }
  }

  // `tintColor`
  if (oldImageProps.tintColor != newImageProps.tintColor) {
    _imageView.tintColor = ABI44_0_0RCTUIColorFromSharedColor(newImageProps.tintColor);
  }
...
- (void)didReceiveImage:(UIImage *)image metadata:(id)metadata fromObserver:(void const *)observer
{
  ...
  if (imageProps.resizeMode == ImageResizeMode::Repeat) {
    image = [image resizableImageWithCapInsets:ABI44_0_0RCTUIEdgeInsetsFromEdgeInsets(imageProps.capInsets)
  ...
  if (imageProps.blurRadius > __FLT_EPSILON__) {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
      UIImage *blurredImage = ABI44_0_0RCTBlurredImageWithRadius(image, blurRadius);
...
Class<ABI44_0_0RCTComponentViewProtocol> ABI44_0_0RCTImageCls(void);
...
Class<ABI44_0_0RCTComponentViewProtocol> ABI44_0_0RCTImageCls(void)
{
  return ABI44_0_0RCTImageComponentView.class;
}
