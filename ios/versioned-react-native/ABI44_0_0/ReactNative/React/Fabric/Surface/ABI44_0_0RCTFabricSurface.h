...
@class ABI44_0_0RCTSurfacePresenter;
@protocol ABI44_0_0RCTSurfaceDelegate;

/**
 * (This is Fabric-compatible ABI44_0_0RCTSurface implementation.)
 *
 ...
 */
@interface ABI44_0_0RCTFabricSurface : NSObject <ABI44_0_0RCTSurfaceProtocol>
 ...
 * ABI44_0_0RCTSurface does not control (or influence in any way) the size or origin
 ...
 * The starting process includes initializing all underlying ABI44_0_0React Native
 * infrastructure and running ABI44_0_0React app.
...
@interface ABI44_0_0RCTFabricSurface (Internal)
...
@interface ABI44_0_0RCTFabricSurface (Deprecated)
