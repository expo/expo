...
#import "ABI44_0_0RCTRootShadowView.h"

#import "ABI44_0_0RCTI18nUtil.h"
#import "ABI44_0_0RCTShadowView+Layout.h"

@implementation ABI44_0_0RCTRootShadowView

- (instancetype)init
{
  if (self = [super init]) {
    _baseDirection = [[ABI44_0_0RCTI18nUtil sharedInstance] isRTL] ? ABI44_0_0YGDirectionRTL : ABI44_0_0YGDirectionLTR;
...
- (void)layoutWithAffectedShadowViews:(NSHashTable<ABI44_0_0RCTShadowView *> *)affectedShadowViews
{
  ...
  ABI44_0_0RCTLayoutContext layoutContext = {};
  ...
  [self layoutWithMinimumSize:_minimumSize
              ...
              layoutDirection:ABI44_0_0RCTUIKitLayoutDirectionFromYogaLayoutDirection(_baseDirection)
