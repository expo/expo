...
static const CGFloat ABI44_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI44_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return ABS(borderInsets.left - borderInsets.right) < ABI44_0_0RCTViewBorderThreshold &&
      ABS(borderInsets.left - borderInsets.bottom) < ABI44_0_0RCTViewBorderThreshold &&
      ABS(borderInsets.left - borderInsets.top) < ABI44_0_0RCTViewBorderThreshold;
}

BOOL ABI44_0_0RCTCornerRadiiAreEqual(ABI44_0_0RCTCornerRadii cornerRadii)
{
  return ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI44_0_0RCTViewBorderThreshold &&
      ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI44_0_0RCTViewBorderThreshold &&
      ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI44_0_0RCTViewBorderThreshold;
}

BOOL ABI44_0_0RCTBorderColorsAreEqual(ABI44_0_0RCTBorderColors borderColors)
{
...
ABI44_0_0RCTCornerInsets ABI44_0_0RCTGetCornerInsets(ABI44_0_0RCTCornerRadii cornerRadii, UIEdgeInsets edgeInsets)
{
  return (ABI44_0_0RCTCornerInsets){{
...
static UIEdgeInsets ABI44_0_0RCTRoundInsetsToPixel(UIEdgeInsets edgeInsets)
{
  edgeInsets.top = ABI44_0_0RCTRoundPixelValue(edgeInsets.top);
  edgeInsets.bottom = ABI44_0_0RCTRoundPixelValue(edgeInsets.bottom);
  edgeInsets.left = ABI44_0_0RCTRoundPixelValue(edgeInsets.left);
  edgeInsets.right = ABI44_0_0RCTRoundPixelValue(edgeInsets.right);

  return edgeInsets;
}

static void ABI44_0_0RCTPathAddEllipticArc(
...
CGPathRef ABI44_0_0RCTPathCreateWithRoundedRect(CGRect bounds, ABI44_0_0RCTCornerInsets cornerInsets, const CGAffineTransform *transform)
{
  ...
  ABI44_0_0RCTPathAddEllipticArc(
...
static void
ABI44_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds, CGPoint lineStart, CGPoint lineEnd, CGPoint intersections[2])
{
...
NS_INLINE BOOL ABI44_0_0RCTCornerRadiiAreAboveThreshold(ABI44_0_0RCTCornerRadii cornerRadii)
{
  return (
      cornerRadii.topLeft > ABI44_0_0RCTViewBorderThreshold || cornerRadii.topRight > ABI44_0_0RCTViewBorderThreshold ||
      cornerRadii.bottomLeft > ABI44_0_0RCTViewBorderThreshold || cornerRadii.bottomRight > ABI44_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI44_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI44_0_0RCTCornerRadii cornerRadii)
{
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI44_0_0RCTPathCreateWithRoundedRect(rect, ABI44_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef
ABI44_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge)
{
...
static UIImage *ABI44_0_0RCTGetSolidBorderImage(
    ...
    BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI44_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI44_0_0RCTCornerInsets cornerInsets = ABI44_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  borderInsets = ABI44_0_0RCTRoundInsetsToPixel(borderInsets);
  ...
  CGContextRef ctx = ABI44_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI44_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI44_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI44_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI44_0_0RCTEllipseGetIntersectionsWithLine(
...
static UIImage *ABI44_0_0RCTGetDashedOrDottedBorderImage(
    ...
    BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI44_0_0RCTBorderStyleDashed || borderStyle == ABI44_0_0RCTBorderStyleDotted);

  if (!ABI44_0_0RCTBorderColorsAreEqual(borderColors) || !ABI44_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI44_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI44_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI44_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI44_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI44_0_0RCTPathCreateWithRoundedRect(pathRect, ABI44_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI44_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
...
UIImage *ABI44_0_0RCTGetBorderImage(
    ABI44_0_0RCTBorderStyle borderStyle,
    CGSize viewSize,
    ABI44_0_0RCTCornerRadii cornerRadii,
    UIEdgeInsets borderInsets,
...
{
  switch (borderStyle) {
    case ABI44_0_0RCTBorderStyleSolid:
      return ABI44_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI44_0_0RCTBorderStyleDashed:
    case ABI44_0_0RCTBorderStyleDotted:
      return ABI44_0_0RCTGetDashedOrDottedBorderImage(
          borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI44_0_0RCTBorderStyleUnset:
      break;
  }
