...
@implementation ABI44_0_0RCTSafeAreaView {
...
{
  UIViewController *vc = self.ABI44_0_0ReactViewController;
...
{
  if (UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI44_0_0RCTScreenScale())) {
    return;
  }

  _currentSafeAreaInsets = safeAreaInsets;

  ABI44_0_0RCTSafeAreaViewLocalData *localData = [[ABI44_0_0RCTSafeAreaViewLocalData alloc] initWithInsets:safeAreaInsets];
