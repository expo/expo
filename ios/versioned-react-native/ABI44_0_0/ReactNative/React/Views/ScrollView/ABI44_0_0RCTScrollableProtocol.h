...
/**
 * Contains any methods related to scrolling. Any `ABI44_0_0RCTView` that has scrolling
 * features should implement these methods.
 */
@protocol ABI44_0_0RCTScrollableProtocol
 ...
 */
@protocol ABI44_0_0RCTCustomRefreshContolProtocol
