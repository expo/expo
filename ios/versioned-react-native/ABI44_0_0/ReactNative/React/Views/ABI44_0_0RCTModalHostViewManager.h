...
@interface ABI44_0_0RCTConvert (ABI44_0_0RCTModalHostView)

+ (UIModalPresentationStyle)UIModalPresentationStyle:(id)json;

@end

typedef void (^ABI44_0_0RCTModalViewInteractionBlock)(
    UIViewController *ABI44_0_0ReactViewController,
    UIViewController *viewController,
    BOOL animated,
    dispatch_block_t completionBlock);

@interface ABI44_0_0RCTModalHostViewManager : ABI44_0_0RCTViewManager <ABI44_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, strong) ABI44_0_0RCTModalViewInteractionBlock presentationBlock;
@property (nonatomic, strong) ABI44_0_0RCTModalViewInteractionBlock dismissalBlock;
