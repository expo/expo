...
#import "ABI25_0_0RCTUITextView.h"

#import <ReactABI25_0_0/ABI25_0_0RCTUtils.h>
#import <ReactABI25_0_0/UIView+ReactABI25_0_0.h>

#import "ABI25_0_0RCTBackedTextInputDelegateAdapter.h"

@implementation ABI25_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI25_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI25_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
  }
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI25_0_0RCTCeilPixelValue(placeholderSize.width), ABI25_0_0RCTCeilPixelValue(placeholderSize.height));
