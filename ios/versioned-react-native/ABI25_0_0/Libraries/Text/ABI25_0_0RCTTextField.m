...
@interface ABI25_0_0RCTTextField () <ABI25_0_0RCTBackedTextInputDelegate>

@end

@implementation ABI25_0_0RCTTextField
{
  ABI25_0_0RCTUITextField *_backedTextInput;
  BOOL _submitted;
...
- (instancetype)initWithBridge:(ABI25_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInput = [[ABI25_0_0RCTUITextField alloc] initWithFrame:self.bounds];
...
- (void)setText:(NSString *)text
{
  ...
  if (eventLag == 0 && ![text isEqualToString:self.text]) {
    ...
    ABI25_0_0RCTLogWarn(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", _backedTextInput.text, (long long)eventLag);
  }
}
...
{
  _nativeEventCount++;
  [_eventDispatcher sendTextEventWithType:ABI25_0_0RCTTextEventTypeChange
                                 ReactABI25_0_0Tag:self.ReactABI25_0_0Tag
