...
@interface ABI25_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI25_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI25_0_0RCTBackedTextInputViewProtocol> *_backedTextInput;
...
@interface ABI25_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI25_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI25_0_0RCTBackedTextInputViewProtocol> *_backedTextInput;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}
