...
@protocol ABI25_0_0RCTBackedTextInputDelegate;

@protocol ABI25_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI25_0_0RCTBackedTextInputDelegate> textInputDelegate;
