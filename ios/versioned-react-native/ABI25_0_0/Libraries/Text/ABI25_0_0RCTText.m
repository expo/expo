...
static void collectNonTextDescendants(ABI25_0_0RCTText *view, NSMutableArray *nonTextDescendants)
{
  for (UIView *child in view.ReactABI25_0_0Subviews) {
    if ([child isKindOfClass:[ABI25_0_0RCTText class]]) {
      collectNonTextDescendants((ABI25_0_0RCTText *)child, nonTextDescendants);
...
@implementation ABI25_0_0RCTText
{
...
- (NSString *)description
{
  ...
  NSString *replacement = [NSString stringWithFormat:@"; ReactABI25_0_0Tag: %@; text: %@", self.ReactABI25_0_0Tag, self.textStorage.string];
...
- (void)drawRect:(CGRect)rect
{
  ...
  [layoutManager.textStorage enumerateAttribute:ABI25_0_0RCTIsHighlightedAttributeName inRange:characterRange options:0 usingBlock:^(NSNumber *value, NSRange range, BOOL *_) {
    if (!value.boolValue) {
      return;
    }
...
- (NSNumber *)ReactABI25_0_0TagAtPoint:(CGPoint)point
{
  ...
  if (_textStorage.length > 0 && (fraction > 0 || characterIndex > 0) && (fraction < 1 || characterIndex < _textStorage.length - 1)) {
    ReactABI25_0_0Tag = [_textStorage attribute:ABI25_0_0RCTReactABI25_0_0TagAttributeName atIndex:characterIndex effectiveRange:NULL];
  }
  return ReactABI25_0_0Tag;
}
