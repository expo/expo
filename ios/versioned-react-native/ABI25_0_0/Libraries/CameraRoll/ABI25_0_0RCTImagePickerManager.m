...
#import "ABI25_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI25_0_0/ABI25_0_0RCTConvert.h>
#import <ReactABI25_0_0/ABI25_0_0RCTImageStoreManager.h>
#import <ReactABI25_0_0/ABI25_0_0RCTRootView.h>
#import <ReactABI25_0_0/ABI25_0_0RCTUtils.h>

@interface ABI25_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI25_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI25_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI25_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI25_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI25_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI25_0_0RCTResponseSenderBlock)callback)
{
...
ABI25_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI25_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI25_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI25_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI25_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI25_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI25_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI25_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI25_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI25_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI25_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI25_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI25_0_0RCTNullIfNil(height), ABI25_0_0RCTNullIfNil(width)]];
    return;
  }
        ...
        cancelCallback:(ABI25_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI25_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI25_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI25_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
