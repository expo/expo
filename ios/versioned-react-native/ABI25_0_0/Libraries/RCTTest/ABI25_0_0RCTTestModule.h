...
typedef NS_ENUM(NSInteger, ABI25_0_0RCTTestStatus) {
  ABI25_0_0RCTTestStatusPending = 0,
  ABI25_0_0RCTTestStatusPassed,
  ABI25_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI25_0_0RCTTestModule : NSObject <ABI25_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI25_0_0RCTTestStatus status;
