...
@implementation ABI25_0_0RCTStyleAnimatedNode
{
...
- (void)performUpdate
{
  ...
  [style enumerateKeysAndObjectsUsingBlock:^(NSString *property, NSNumber *nodeTag, __unused BOOL *stop) {
    ABI25_0_0RCTAnimatedNode *node = [self.parentNodes objectForKey:nodeTag];
    if (node) {
      if ([node isKindOfClass:[ABI25_0_0RCTValueAnimatedNode class]]) {
        ABI25_0_0RCTValueAnimatedNode *parentNode = (ABI25_0_0RCTValueAnimatedNode *)node;
        [self->_propsDictionary setObject:@(parentNode.value) forKey:property];
      } else if ([node isKindOfClass:[ABI25_0_0RCTTransformAnimatedNode class]]) {
        ABI25_0_0RCTTransformAnimatedNode *parentNode = (ABI25_0_0RCTTransformAnimatedNode *)node;
