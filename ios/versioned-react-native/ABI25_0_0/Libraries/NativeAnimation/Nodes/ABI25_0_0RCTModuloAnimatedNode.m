...
@implementation ABI25_0_0RCTModuloAnimatedNode
...
- (void)performUpdate
{
  ...
  ABI25_0_0RCTValueAnimatedNode *parent = (ABI25_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:inputNode];
