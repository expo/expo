...
@implementation ABI25_0_0RCTInterpolationAnimatedNode
{
  __weak ABI25_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI25_0_0RCTAnimatedNode *)parent
{
  [super onAttachedToNode:parent];
  if ([parent isKindOfClass:[ABI25_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI25_0_0RCTValueAnimatedNode *)parent;
  }
}

- (void)onDetachedFromNode:(ABI25_0_0RCTAnimatedNode *)parent
{
...
- (void)performUpdate
{
  ...
  self.value = ABI25_0_0RCTInterpolateValueInRange(inputValue,
                                          _inputRange,
                                          _outputRange,
                                          _extrapolateLeft,
                                          _extrapolateRight);
