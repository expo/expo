...
@implementation ABI25_0_0RCTDiffClampAnimatedNode
{
...
{
  ABI25_0_0RCTValueAnimatedNode *inputNode = (ABI25_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI25_0_0RCTValueAnimatedNode class]]) {
    ABI25_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
