...
@interface ABI25_0_0RCTAnimatedNode : NSObject
...
@property (nonatomic, copy, readonly) NSMapTable<NSNumber *, ABI25_0_0RCTAnimatedNode *> *childNodes;
@property (nonatomic, copy, readonly) NSMapTable<NSNumber *, ABI25_0_0RCTAnimatedNode *> *parentNodes;
...
- (void)addChild:(ABI25_0_0RCTAnimatedNode *)child NS_REQUIRES_SUPER;
- (void)removeChild:(ABI25_0_0RCTAnimatedNode *)child NS_REQUIRES_SUPER;

- (void)onAttachedToNode:(ABI25_0_0RCTAnimatedNode *)parent NS_REQUIRES_SUPER;
- (void)onDetachedFromNode:(ABI25_0_0RCTAnimatedNode *)parent NS_REQUIRES_SUPER;
