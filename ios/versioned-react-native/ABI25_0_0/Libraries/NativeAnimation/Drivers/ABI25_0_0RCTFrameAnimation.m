...
@interface ABI25_0_0RCTFrameAnimation ()
...
@implementation ABI25_0_0RCTFrameAnimation
{
...
{
  if ((self = [super init])) {
    NSNumber *toValue = [ABI25_0_0RCTConvert NSNumber:config[@"toValue"]] ?: @1;
    NSArray<NSNumber *> *frames = [ABI25_0_0RCTConvert NSNumberArray:config[@"frames"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  NSUInteger startIndex = floor(currentDuration / ABI25_0_0RCTSingleFrameInterval);
  ...
  NSTimeInterval fromInterval = startIndex * ABI25_0_0RCTSingleFrameInterval;
  NSTimeInterval toInterval = nextIndex * ABI25_0_0RCTSingleFrameInterval;
  ...
  CGFloat frameOutput = ABI25_0_0RCTInterpolateValue(currentDuration,
                                            fromInterval,
                                            toInterval,
                                            fromFrameValue.doubleValue,
                                            toFrameValue.doubleValue,
                                            ABI25_0_0EXTRAPOLATE_TYPE_EXTEND,
                                            ABI25_0_0EXTRAPOLATE_TYPE_EXTEND);
...
{
  CGFloat outputValue = ABI25_0_0RCTInterpolateValue(frameOutput,
                                            0,
                                            1,
                                            _fromValue,
                                            _toValue,
