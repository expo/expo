...
@interface ABI25_0_0RCTSpringAnimation ()
...
@implementation ABI25_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
                  ...
                  callBack:(nullable ABI25_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _toValue = [ABI25_0_0RCTConvert CGFloat:config[@"toValue"]];
    _fromValue = valueNode.value;
    _lastPosition = 0;
    _valueNode = valueNode;
    _overshootClamping = [ABI25_0_0RCTConvert BOOL:config[@"overshootClamping"]];
    _restDisplacementThreshold = [ABI25_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
    _restSpeedThreshold = [ABI25_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
    _stiffness = [ABI25_0_0RCTConvert CGFloat:config[@"stiffness"]];
    _damping = [ABI25_0_0RCTConvert CGFloat:config[@"damping"]];
    _mass = [ABI25_0_0RCTConvert CGFloat:config[@"mass"]];
