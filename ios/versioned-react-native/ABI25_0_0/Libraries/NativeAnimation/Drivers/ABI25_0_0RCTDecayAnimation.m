...
@implementation ABI25_0_0RCTDecayAnimation
{
  ...
  ABI25_0_0RCTResponseSenderBlock _callback;
}

- (instancetype)initWithId:(NSNumber *)animationId
                    config:(NSDictionary *)config
                   forNode:(ABI25_0_0RCTValueAnimatedNode *)valueNode
                  callBack:(nullable ABI25_0_0RCTResponseSenderBlock)callback;
{
  if ((self = [super init])) {
    NSNumber *iterations = [ABI25_0_0RCTConvert NSNumber:config[@"iterations"]] ?: @1;
    ...
    _velocity = [ABI25_0_0RCTConvert CGFloat:config[@"velocity"]];
    _deceleration = [ABI25_0_0RCTConvert CGFloat:config[@"deceleration"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  if (_frameStartTime == -1) {
    ...
    _frameStartTime = currentTime - ABI25_0_0RCTSingleFrameInterval;
