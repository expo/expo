...
#import <ABI25_0_0RCTAnimation/ABI25_0_0RCTValueAnimatedNode.h>
#import <ReactABI25_0_0/ABI25_0_0RCTBridgeModule.h>
#import <ReactABI25_0_0/ABI25_0_0RCTUIManager.h>

@interface ABI25_0_0RCTNativeAnimatedNodesManager : NSObject
...
- (void)startAnimatingNode:(nonnull NSNumber *)animationId
                   nodeTag:(nonnull NSNumber *)nodeTag
                    config:(NSDictionary<NSString *, id> *__nonnull)config
               endCallback:(nullable ABI25_0_0RCTResponseSenderBlock)callBack;
...
- (void)handleAnimatedEvent:(nonnull id<ABI25_0_0RCTEvent>)event;

// listeners

- (void)startListeningToAnimatedNodeValue:(nonnull NSNumber *)tag
                            valueObserver:(nonnull id<ABI25_0_0RCTValueAnimatedNodeObserver>)valueObserver;
