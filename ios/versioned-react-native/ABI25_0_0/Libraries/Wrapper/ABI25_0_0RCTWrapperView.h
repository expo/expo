...
typedef CGSize (^ABI25_0_0RCTWrapperMeasureBlock)(CGSize minimumSize, CGSize maximumSize);

@class ABI25_0_0RCTBridge;

NS_ASSUME_NONNULL_BEGIN

@interface ABI25_0_0RCTWrapperView : UIView

@property (nonatomic, retain, nullable) UIView *contentView;
@property (nonatomic, readonly) ABI25_0_0RCTWrapperMeasureBlock measureBlock;
