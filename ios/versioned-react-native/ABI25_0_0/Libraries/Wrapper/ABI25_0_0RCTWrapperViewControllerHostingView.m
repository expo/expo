...
#import "ABI25_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI25_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI25_0_0ViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI25_0_0ViewController detachChildViewController:self.contentViewController];
}
