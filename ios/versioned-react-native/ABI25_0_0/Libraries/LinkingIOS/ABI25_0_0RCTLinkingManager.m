...
#import "ABI25_0_0RCTLinkingManager.h"
...
static NSString *const kOpenURLNotification = @"ABI25_0_0RCTOpenURLNotification";
...
@implementation ABI25_0_0RCTLinkingManager
                  ...
                  reject:(__unused ABI25_0_0RCTPromiseRejectBlock)reject)
{
  ...
  BOOL canOpen = [ABI25_0_0RCTSharedApplication() canOpenURL:URL];
  resolve(@(canOpen));
}
                  ...
                  reject:(__unused ABI25_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve(ABI25_0_0RCTNullIfNil(initialURL.absoluteString));
}
