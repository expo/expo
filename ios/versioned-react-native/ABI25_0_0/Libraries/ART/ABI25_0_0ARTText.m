...
@implementation ABI25_0_0ARTText
...
static void ABI25_0_0ARTFreeTextFrame(ABI25_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI25_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI25_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI25_0_0ARTTextFrame frame = self.textFrame;
