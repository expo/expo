...
#import "ABI25_0_0ARTRenderable.h"

@implementation ABI25_0_0ARTRenderable

- (void)setFill:(ABI25_0_0ARTBrush *)fill
{
  [self invalidate];
  _fill = fill;
}
...
- (void)setStrokeDash:(ABI25_0_0ARTCGFloatArray)strokeDash
{
