...
@interface ABI25_0_0ARTRenderable : ABI25_0_0ARTNode

@property (nonatomic, strong) ABI25_0_0ARTBrush *fill;
...
@property (nonatomic, assign) ABI25_0_0ARTCGFloatArray strokeDash;
