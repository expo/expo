...
typedef void (^ABI25_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI25_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI25_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI25_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI25_0_0RCTImageCache <NSObject>
...
/**
 * If available, ABI25_0_0RCTImageRedirectProtocol is invoked before loading an asset.
 * Implementation should return either a new URL or nil when redirection is
 * not needed.
 */

@protocol ABI25_0_0RCTImageRedirectProtocol

- (NSURL *)redirectAssetsURL:(NSURL *)URL;

@end

@interface UIImage (ReactABI25_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI25_0_0KeyframeAnimation;

@end

@interface ABI25_0_0RCTImageLoader : NSObject <ABI25_0_0RCTBridgeModule, ABI25_0_0RCTURLRequestHandler>
...
- (instancetype)init;
- (instancetype)initWithRedirectDelegate:(id<ABI25_0_0RCTImageRedirectProtocol>)redirectDelegate NS_DESIGNATED_INITIALIZER;
 ...
 */
- (ABI25_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                           clipped:(BOOL)clipped
                                        resizeMode:(ABI25_0_0RCTResizeMode)resizeMode
 ...
 * decoded images as long as it conforms to the ABI25_0_0RCTImageCacheDelegate
...
@interface ABI25_0_0RCTBridge (ABI25_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI25_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI25_0_0RCTImageURLLoader <ABI25_0_0RCTBridgeModule>
 ...
 * applicable.
 */
- (ABI25_0_0RCTImageLoaderCancellationBlock)loadImageForURL:(NSURL *)imageURL
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                        resizeMode:(ABI25_0_0RCTResizeMode)resizeMode
                                   progressHandler:(ABI25_0_0RCTImageLoaderProgressBlock)progressHandler
                                partialLoadHandler:(ABI25_0_0RCTImageLoaderPartialLoadBlock)partialLoadHandler
                                 completionHandler:(ABI25_0_0RCTImageLoaderCompletionBlock)completionHandler;

@optional

/**
 * If more than one ABI25_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI25_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 * are also bridge modules, so should be registered using ABI25_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI25_0_0RCTImageDataDecoder <ABI25_0_0RCTBridgeModule>
...
/**
 * If more than one ABI25_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
