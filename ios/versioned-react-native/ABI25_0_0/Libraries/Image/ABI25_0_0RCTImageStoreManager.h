...
@interface ABI25_0_0RCTImageStoreManager : NSObject <ABI25_0_0RCTURLRequestHandler>
...
@interface ABI25_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI25_0_0RCTBridge (ABI25_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI25_0_0RCTImageStoreManager *imageStoreManager;
