...
#import "ABI25_0_0RCTReconnectingWebSocket.h"
...
@interface ABI25_0_0RCTReconnectingWebSocket () <ABI25_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI25_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  __weak ABI25_0_0RCTSRWebSocket *socket = _socket;
