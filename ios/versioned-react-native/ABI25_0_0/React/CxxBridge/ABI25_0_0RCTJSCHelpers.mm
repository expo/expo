...
#include "ABI25_0_0RCTJSCHelpers.h"
...
JSValueRef nativeLoggingHook(
  ...
  ABI25_0_0RCTLogLevel level = ABI25_0_0RCTLogLevelInfo;
  if (argumentCount > 1) {
    level = MAX(level, (ABI25_0_0RCTLogLevel)Value(ctx, arguments[1]).asNumber());
  }
  if (argumentCount > 0) {
    ...
    _ABI25_0_0RCTLogJavaScriptInternal(level, [msg toString]);
  }
...
void ABI25_0_0RCTPrepareJSCExecutor() {
  ReactABI25_0_0Marker::logTaggedMarker = [](const ReactABI25_0_0Marker::ReactABI25_0_0MarkerId, const char *tag) {};
  JSCNativeHooks::loggingHook = nativeLoggingHook;
  JSCNativeHooks::nowHook = nativePerformanceNow;
  JSCNativeHooks::installPerfHooks = ABI25_0_0RCTFBQuickPerformanceLoggerConfigureHooks;
}
