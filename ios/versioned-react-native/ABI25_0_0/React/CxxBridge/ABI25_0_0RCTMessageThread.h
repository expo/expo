...
class ABI25_0_0RCTMessageThread : public MessageQueueThread {
 public:
  ABI25_0_0RCTMessageThread(NSRunLoop *runLoop, ABI25_0_0RCTJavaScriptCompleteBlock errorBlock);
  ~ABI25_0_0RCTMessageThread() override;
