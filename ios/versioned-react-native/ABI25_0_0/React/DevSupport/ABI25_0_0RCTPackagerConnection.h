...
@protocol ABI25_0_0RCTPackagerClientMethod;
@class ABI25_0_0RCTPackagerClientResponder;

typedef uint32_t ABI25_0_0RCTHandlerToken;
typedef void (^ABI25_0_0RCTNotificationHandler)(NSDictionary<NSString *, id> *);
typedef void (^ABI25_0_0RCTRequestHandler)(NSDictionary<NSString *, id> *, ABI25_0_0RCTPackagerClientResponder *);
typedef void (^ABI25_0_0RCTConnectedHandler)(void);

/** Encapsulates singleton connection to ReactABI25_0_0 Native packager. */
@interface ABI25_0_0RCTPackagerConnection : NSObject
 ...
 */
- (ABI25_0_0RCTHandlerToken)addNotificationHandler:(ABI25_0_0RCTNotificationHandler)handler
 ...
 */
- (ABI25_0_0RCTHandlerToken)addRequestHandler:(ABI25_0_0RCTRequestHandler)handler
                               queue:(dispatch_queue_t)queue
                           forMethod:(NSString *)method;
 ...
 */
- (ABI25_0_0RCTHandlerToken)addConnectedHandler:(ABI25_0_0RCTConnectedHandler)handler
                                 queue:(dispatch_queue_t)queue;
 ...
 */
- (void)addHandler:(id<ABI25_0_0RCTPackagerClientMethod>)handler
