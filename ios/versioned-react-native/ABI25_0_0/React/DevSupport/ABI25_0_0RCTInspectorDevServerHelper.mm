...
@implementation ABI25_0_0RCTInspectorDevServerHelper

ABI25_0_0RCT_NOT_IMPLEMENTED(- (instancetype)init)

static NSMutableDictionary<NSString *, ABI25_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
            ...
            withBundleURL:(NSURL *)bundleURL
{
  ...
  ABI25_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection) {
    connection = [[ABI25_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
