...
@protocol ABI25_0_0RCTAutoInsetsProtocol;

@class ABI25_0_0RCTView;

@interface ABI25_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI25_0_0RCTDirectEventBlock onAccessibilityAction;
@property (nonatomic, copy) ABI25_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI25_0_0RCTDirectEventBlock onMagicTap;
 ...
 */
@property (nonatomic, assign) ABI25_0_0RCTPointerEvents pointerEvents;
 ...
 * This is inherited from UIView+ReactABI25_0_0, but we override it here
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI25_0_0RCTBorderStyle borderStyle;
