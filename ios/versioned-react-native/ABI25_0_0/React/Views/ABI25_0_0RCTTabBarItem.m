...
@implementation ABI25_0_0RCTConvert (UITabBarSystemItem)

ABI25_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI25_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI25_0_0ViewController;
}
