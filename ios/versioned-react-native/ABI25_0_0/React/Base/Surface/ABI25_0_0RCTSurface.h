...
@class ABI25_0_0RCTSurfaceView;
@protocol ABI25_0_0RCTSurfaceDelegate;

/**
 * ABI25_0_0RCTSurface instance represents ReactABI25_0_0 Native-powered piece of a user interface
 * which can be a full-screen app, separate modal view controller,
 * or even small widget.
 * It is called "Surface".
 *
 * The ABI25_0_0RCTSurface instance is completely thread-safe by design;
 ...
 *
 * The primary goals of the ABI25_0_0RCTSurface are:
 ...
 */
@interface ABI25_0_0RCTSurface : NSObject

@property (atomic, readonly) ABI25_0_0RCTSurfaceStage stage;
@property (atomic, readonly) ABI25_0_0RCTBridge *bridge;
@property (atomic, readonly) NSString *moduleName;
@property (atomic, readonly) NSNumber *rootViewTag;

@property (atomic, readwrite, weak, nullable) id<ABI25_0_0RCTSurfaceDelegate> delegate;
 ...
 * ABI25_0_0RCTSurface does not control (or influence in any way) the size or origin
...
/**
 * Simple shortcut to `-[ABI25_0_0RCTSurface setMinimumSize:size maximumSize:size]`.
 */
