...
typedef id<ABI25_0_0RCTBridgeModule>(^ABI25_0_0RCTBridgeModuleProvider)(void);

@interface ABI25_0_0RCTModuleData : NSObject <ABI25_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI25_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI25_0_0RCTBridgeModule> instance;
