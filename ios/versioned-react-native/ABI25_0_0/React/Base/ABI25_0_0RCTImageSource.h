 ...
 */
@interface ABI25_0_0RCTImageSource : NSObject
...
@interface ABI25_0_0RCTConvert (ImageSource)

+ (ABI25_0_0RCTImageSource *)ABI25_0_0RCTImageSource:(id)json;
+ (NSArray<ABI25_0_0RCTImageSource *> *)ABI25_0_0RCTImageSourceArray:(id)json;
