...
#if __has_include("ABI25_0_0RCTDevMenu.h")
#import "ABI25_0_0RCTDevMenu.h"
#endif

NSString *const ABI25_0_0RCTTVRemoteEventMenu = @"menu";
NSString *const ABI25_0_0RCTTVRemoteEventPlayPause = @"playPause";
NSString *const ABI25_0_0RCTTVRemoteEventSelect = @"select";

NSString *const ABI25_0_0RCTTVRemoteEventLongPlayPause = @"longPlayPause";
NSString *const ABI25_0_0RCTTVRemoteEventLongSelect = @"longSelect";

NSString *const ABI25_0_0RCTTVRemoteEventLeft = @"left";
NSString *const ABI25_0_0RCTTVRemoteEventRight = @"right";
NSString *const ABI25_0_0RCTTVRemoteEventUp = @"up";
NSString *const ABI25_0_0RCTTVRemoteEventDown = @"down";

NSString *const ABI25_0_0RCTTVRemoteEventSwipeLeft = @"swipeLeft";
NSString *const ABI25_0_0RCTTVRemoteEventSwipeRight = @"swipeRight";
NSString *const ABI25_0_0RCTTVRemoteEventSwipeUp = @"swipeUp";
NSString *const ABI25_0_0RCTTVRemoteEventSwipeDown = @"swipeDown";


@implementation ABI25_0_0RCTTVRemoteHandler {
...
- (instancetype)init
{
  if ((self = [super init])) {
    ...
    [self addLongPressGestureRecognizerWithSelector:@selector(longPlayPausePressed:)
                                          pressType:UIPressTypePlayPause
                                               name:ABI25_0_0RCTTVRemoteEventLongPlayPause];

    [self addLongPressGestureRecognizerWithSelector:@selector(longSelectPressed:)
                                          pressType:UIPressTypeSelect
                                               name:ABI25_0_0RCTTVRemoteEventLongSelect];
...
{
  [self sendAppleTVEvent:ABI25_0_0RCTTVRemoteEventPlayPause toView:r.view];
}

- (void)menuPressed:(UIGestureRecognizer *)r
{
  [self sendAppleTVEvent:ABI25_0_0RCTTVRemoteEventMenu toView:r.view];
}

- (void)selectPressed:(UIGestureRecognizer *)r
{
  [self sendAppleTVEvent:ABI25_0_0RCTTVRemoteEventSelect toView:r.view];
}

- (void)longPlayPausePressed:(UIGestureRecognizer *)r
{
  [self sendAppleTVEvent:ABI25_0_0RCTTVRemoteEventLongPlayPause toView:r.view];

#if __has_include("ABI25_0_0RCTDevMenu.h") && ABI25_0_0RCT_DEV
...
{
  [self sendAppleTVEvent:ABI25_0_0RCTTVRemoteEventLongSelect toView:r.view];
}

- (void)swipedUp:(UIGestureRecognizer *)r
{
  [self sendAppleTVEvent:ABI25_0_0RCTTVRemoteEventUp toView:r.view];
}

- (void)swipedDown:(UIGestureRecognizer *)r
{
  [self sendAppleTVEvent:ABI25_0_0RCTTVRemoteEventDown toView:r.view];
}

- (void)swipedLeft:(UIGestureRecognizer *)r
{
  [self sendAppleTVEvent:ABI25_0_0RCTTVRemoteEventLeft toView:r.view];
}

- (void)swipedRight:(UIGestureRecognizer *)r
{
  [self sendAppleTVEvent:ABI25_0_0RCTTVRemoteEventRight toView:r.view];
}
...
{
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI25_0_0RCTTVNavigationEventNotification
