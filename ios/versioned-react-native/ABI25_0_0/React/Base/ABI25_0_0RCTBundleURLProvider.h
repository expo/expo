...
extern NSString *const ABI25_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI25_0_0RCTBundleURLProviderDefaultPort;

@interface ABI25_0_0RCTBundleURLProvider : NSObject
