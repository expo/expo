...
@interface ABI25_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI25_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI25_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI25_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI25_0_0RCTMultipartStreamReader *reader = [[ABI25_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI25_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
