...
@protocol ABI25_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI25_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI25_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI25_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI25_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI25_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI25_0_0RCTBridge *)bridge;

/**
 * Configure whether the legacy ABI25_0_0RCTBatchedBridge or new ABI25_0_0RCTCxxBridge
 ...
 * implemented, the implementation will default to ABI25_0_0RCTBatchedBridge,
 * but if it is not linked in, will try ABI25_0_0RCTCxxBridge instead.  If
 ...
 * @experimental
 */
- (BOOL)shouldBridgeUseCxxBridge:(ABI25_0_0RCTBridge *)bridge;
...
*/
- (BOOL)bridge:(ABI25_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI25_0_0RCTBridge *)bridge
                 onProgress:(ABI25_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI25_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI25_0_0RCTBridge *)bridge
                  withBlock:(ABI25_0_0RCTSourceLoadBlock)loadCallback;
