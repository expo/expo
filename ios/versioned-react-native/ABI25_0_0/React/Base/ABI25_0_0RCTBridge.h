 ...
 */
ABI25_0_0RCT_EXTERN NSString *const ABI25_0_0RCTDidInitializeModuleNotification;

/**
 * This notification fires just before the bridge starts processing a request to
 * reload.
 */
ABI25_0_0RCT_EXTERN NSString *const ABI25_0_0RCTBridgeWillReloadNotification;

/**
 * This notification fires just before the bridge begins downloading a script
 * from the packager.
 */
ABI25_0_0RCT_EXTERN NSString *const ABI25_0_0RCTBridgeWillDownloadScriptNotification;

/**
 * This notification fires just after the bridge finishes downloading a script
 * from the packager.
 */
ABI25_0_0RCT_EXTERN NSString *const ABI25_0_0RCTBridgeDidDownloadScriptNotification;

/**
 * Key for the ABI25_0_0RCTSource object in the ABI25_0_0RCTBridgeDidDownloadScriptNotification
 * userInfo dictionary.
 */
ABI25_0_0RCT_EXTERN NSString *const ABI25_0_0RCTBridgeDidDownloadScriptNotificationSourceKey;
 ...
 */
typedef NSArray<id<ABI25_0_0RCTBridgeModule>> *(^ABI25_0_0RCTBridgeModuleListProvider)(void);

/**
 * This function returns the module name for a given class.
 */
ABI25_0_0RCT_EXTERN NSString *ABI25_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI25_0_0RCTBridge : NSObject <ABI25_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI25_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI25_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 * See also -[ABI25_0_0RCTBridgeDelgate shouldBridgeLoadJavaScriptSynchronously], which
 ...
 */
@property (nonatomic, weak, readonly) id<ABI25_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ReactABI25_0_0 Native perf events.
 */
@property (nonatomic, readonly, strong) ABI25_0_0RCTPerformanceLogger *performanceLogger;
