...
#import "ABI25_0_0RCTExceptionsManager.h"
...
@implementation ABI25_0_0RCTExceptionsManager
                  ...
                  exceptionId:(nonnull NSNumber *)exceptionId)
{
  ...
  if (!ABI25_0_0RCT_DEBUG && reloadRetries < _maxReloadAttempts) {
    reloadRetries++;
    [_bridge reload];
  } else {
    NSString *description = [@"Unhandled JS Exception: " stringByAppendingString:message];
    NSDictionary *errorInfo = @{ NSLocalizedDescriptionKey: description, ABI25_0_0RCTJSStackTraceKey: stack };
    ABI25_0_0RCTFatal([NSError errorWithDomain:ABI25_0_0RCTErrorDomain code:0 userInfo:errorInfo]);
  }
}
...
ABI25_0_0RCT_EXPORT_METHOD(reportUnhandledException:(NSString *)message
                  stack:(NSArray<NSDictionary *> *)stack)
{
