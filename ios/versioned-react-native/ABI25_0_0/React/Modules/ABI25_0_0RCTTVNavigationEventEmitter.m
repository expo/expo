...
NSString *const ABI25_0_0RCTTVNavigationEventNotification = @"ABI25_0_0RCTTVNavigationEventNotification";

static NSString *const TVNavigationEventName = @"onTVNavEvent";

@implementation ABI25_0_0RCTTVNavigationEventEmitter
  ...
  if (self = [super init]) {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(handleTVNavigationEventNotification:)
                                                 name:ABI25_0_0RCTTVNavigationEventNotification
                                               object:nil];
