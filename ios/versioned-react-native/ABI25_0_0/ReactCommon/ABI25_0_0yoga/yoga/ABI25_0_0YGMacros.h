...
#ifdef __cplusplus
#define ABI25_0_0YG_EXTERN_C_BEGIN extern "C" {
#define ABI25_0_0YG_EXTERN_C_END }
#else
#define ABI25_0_0YG_EXTERN_C_BEGIN
#define ABI25_0_0YG_EXTERN_C_END
#endif
...
#define ABI25_0_0YG_ENUM_BEGIN(name) NS_ENUM(int, name)
#define ABI25_0_0YG_ENUM_END(name)
#else
#define ABI25_0_0YG_ENUM_BEGIN(name) enum name
#define ABI25_0_0YG_ENUM_END(name) name
#endif
