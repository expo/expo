...
static NSMutableDictionary<NSString *, NSDictionary *> *ABI25_0_0EXScopedModuleClasses;
void ABI25_0_0EXRegisterScopedModule(Class, ...);
void ABI25_0_0EXRegisterScopedModule(Class moduleClass, ...)
{
  ...
  while ((kernelServiceClassName = va_arg(argumentList, NSString*))) {
    if ([kernelServiceClassName isEqualToString:@"nil"]) {
      unversionedKernelServiceClassNames[kernelServiceClassName] = ABI25_0_0EX_KERNEL_SERVICE_NONE;
    } else {
  ...
  if (moduleClassName) {
    ABI25_0_0EXScopedModuleClasses[moduleClassName] = unversionedKernelServiceClassNames;
  }
}
...
- (NSArray *)_newScopedModulesWithExperienceId: (NSString *)experienceId services:(NSDictionary *)services params:(NSDictionary *)params
{
  ...
  if (ABI25_0_0EXScopedModuleClasses) {
    [ABI25_0_0EXScopedModuleClasses enumerateKeysAndObjectsUsingBlock:^(NSString * _Nonnull scopedModuleClassName, NSDictionary * _Nonnull kernelServiceClassNames, BOOL * _Nonnull stop) {
      ...
      for (id kernelServiceClassName in kernelServiceClassNames) {
        ...
        id service = ([kernelSerivceName isEqualToString:ABI25_0_0EX_KERNEL_SERVICE_NONE]) ? [NSNull null] : services[kernelSerivceName];
