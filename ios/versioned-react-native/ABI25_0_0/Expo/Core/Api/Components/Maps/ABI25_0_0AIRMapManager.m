...
#import "ABI25_0_0AIRMapManager.h"
...
#import "ABI25_0_0AIRMapSnapshot.h"
...
@interface ABI25_0_0AIRMapManager() <MKMapViewDelegate>

@end

@implementation ABI25_0_0AIRMapManager
{
...
- (UIView *)view
{
    ABI25_0_0AIRMap *map = [ABI25_0_0AIRMap new];
    map.delegate = self;
...
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(userLocationAnnotationTitle, NSString)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(showsPointsOfInterest, BOOL)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
...
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(cacheEnabled, BOOL)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(maxDelta, CGFloat)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(minDelta, CGFloat)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(legalLabelInsets, UIEdgeInsets)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, MKMapType)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(onMapReady, ABI25_0_0RCTBubblingEventBlock)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(onChange, ABI25_0_0RCTBubblingEventBlock)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(onPanDrag, ABI25_0_0RCTBubblingEventBlock)
...
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI25_0_0RCTDirectEventBlock)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI25_0_0RCTDirectEventBlock)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI25_0_0RCTDirectEventBlock)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI25_0_0RCTDirectEventBlock)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI25_0_0RCTDirectEventBlock)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(onCalloutPress, ABI25_0_0RCTDirectEventBlock)
ABI25_0_0RCT_CUSTOM_VIEW_PROPERTY(initialRegion, MKCoordinateRegion, ABI25_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setInitialRegion:[ABI25_0_0RCTConvert MKCoordinateRegion:json]];
    view.ignoreRegionChanges = originalIgnore;
}

ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(minZoomLevel, CGFloat)
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(maxZoomLevel, CGFloat)


ABI25_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI25_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setRegion:[ABI25_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI25_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI25_0_0AIRMap class]]) {
            ABI25_0_0RCTLogError(@"Invalid view returned from registry, expecting ABI25_0_0AIRMap, got: %@", view);
        } else {
            [ABI25_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI25_0_0AIRMap *)view setRegion:region animated:YES];
            }];
        }
    }];
}
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI25_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI25_0_0AIRMap class]]) {
            ...
            ABI25_0_0AIRMap *mapView = (ABI25_0_0AIRMap *)view;
...
ABI25_0_0RCT_EXPORT_METHOD(animateToViewingAngle:(nonnull NSNumber *)ReactABI25_0_0Tag
...
ABI25_0_0RCT_EXPORT_METHOD(animateToBearing:(nonnull NSNumber *)ReactABI25_0_0Tag
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI25_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI25_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ABI25_0_0AIRMapMarker *marker = (ABI25_0_0AIRMapMarker *)evaluatedObject;
                return [marker isKindOfClass:[ABI25_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
...
- (void)takeMapSnapshot:(ABI25_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI25_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI25_0_0AIRMap *map = (ABI25_0_0AIRMap *)recognizer.view;
    ...
    ABI25_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI25_0_0AIRMapPolygon class]]){
            ABI25_0_0AIRMapPolygon *polygon = (ABI25_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI25_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI25_0_0AIRMapPolyline class]]){
            ABI25_0_0AIRMapPolyline *polyline = (ABI25_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI25_0_0AIRMapPolyline class]]) {
        return ((ABI25_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI25_0_0AIRMapPolygon class]]) {
        return ((ABI25_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI25_0_0AIRMapCircle class]]) {
        return ((ABI25_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI25_0_0AIRMapUrlTile class]]) {
        return ((ABI25_0_0AIRMapUrlTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI25_0_0AIRMapLocalTile class]]) {
        return ((ABI25_0_0AIRMapLocalTile *)overlay).renderer;
...
- (void)mapView:(ABI25_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI25_0_0AIRMapMarker class]]) {
        [(ABI25_0_0AIRMapMarker *)view.annotation showCalloutView];
...
- (void)mapView:(ABI25_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI25_0_0AIRMapMarker class]]) {
        [(ABI25_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI25_0_0AIRMap *)mapView viewForAnnotation:(ABI25_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI25_0_0AIRMapMarker class]]) {
...
- (void)mapView:(ABI25_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI25_0_0AIRMapMarker class]]) return;
    ABI25_0_0AIRMapMarker *marker = (ABI25_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI25_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI25_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI25_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI25_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI25_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    [self _regionChanged:mapView];

    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI25_0_0AIRMapRegionChangeObserveInterval
                                                               target:self
                                                             selector:@selector(_onTick:)
                                                             userInfo:@{ ABI25_0_0RCTMapViewKey: mapView }
                                                              repeats:YES];

    [[NSRunLoop mainRunLoop] addTimer:mapView.regionChangeObserveTimer forMode:NSRunLoopCommonModes];
}

- (void)mapView:(ABI25_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI25_0_0AIRMap *)mapView
{
...
- (void)mapViewDidFinishRenderingMap:(ABI25_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
{
    [self _regionChanged:timer.userInfo[ABI25_0_0RCTMapViewKey]];
}

- (void)_regionChanged:(ABI25_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI25_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI25_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI25_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI25_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI25_0_0AIRMap *)mapView
{
...
- (MKCoordinateSpan)coordinateSpanWithMapView:(ABI25_0_0AIRMap *)mapView
                             centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                 andZoomLevel:(double)zoomLevel
{
    // convert center coordiate to pixel space
    double centerPixelX = [ABI25_0_0AIRMapManager longitudeToPixelSpaceX:centerCoordinate.longitude];
    double centerPixelY = [ABI25_0_0AIRMapManager latitudeToPixelSpaceY:centerCoordinate.latitude];

    // determine the scale value from the zoom level
    double zoomExponent = ABI25_0_0AIRMapMaxZoomLevel - zoomLevel;
    ...
    CLLocationDegrees minLng = [ABI25_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX];
    CLLocationDegrees maxLng = [ABI25_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX + scaledMapWidth];
    CLLocationDegrees longitudeDelta = maxLng - minLng;

    // find delta between top and bottom latitudes
    CLLocationDegrees minLat = [ABI25_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY];
    CLLocationDegrees maxLat = [ABI25_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY + scaledMapHeight];
...
- (void)setCenterCoordinate:(CLLocationCoordinate2D)centerCoordinate
                  zoomLevel:(double)zoomLevel
                   animated:(BOOL)animated
                    mapView:(ABI25_0_0AIRMap *)mapView
{
    // clamp large numbers to 28
    zoomLevel = MIN(zoomLevel, ABI25_0_0AIRMapMaxZoomLevel);
...
-(MKCoordinateRegion)coordinateRegionWithMapView:(ABI25_0_0AIRMap *)mapView
                                centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                    andZoomLevel:(double)zoomLevel
{
	...
	// find delta between top and bottom latitudes
	CLLocationDegrees minLat = [ABI25_0_0AIRMapManager pixelSpaceYToLatitude:topPixelY];
	CLLocationDegrees maxLat = [ABI25_0_0AIRMapManager pixelSpaceYToLatitude:bottomPixelY];
	CLLocationDegrees latitudeDelta = -1 * (maxLat - minLat);
	...
	if (adjustedCenterPoint) {
		region.center.latitude = [ABI25_0_0AIRMapManager pixelSpaceYToLatitude:((bottomPixelY + topPixelY) / 2.0)];
	}

	return region;
}

- (double) zoomLevel:(ABI25_0_0AIRMap *)mapView {
    MKCoordinateRegion region = mapView.region;

    double centerPixelX = [ABI25_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude];
    double topLeftPixelX = [ABI25_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude - region.span.longitudeDelta / 2];

    double scaledMapWidth = (centerPixelX - topLeftPixelX) * 2;
    CGSize mapSizeInPixels = mapView.bounds.size;
    double zoomScale = scaledMapWidth / mapSizeInPixels.width;
    double zoomExponent = log(zoomScale) / log(2);
    double zoomLevel = ABI25_0_0AIRMapMaxZoomLevel - zoomExponent;
