...
@interface ABI25_0_0AIRMapMarker : MKAnnotationView <MKAnnotation>

@property (nonatomic, strong) ABI25_0_0AIRMapCallout *calloutView;
...
@property (nonatomic, copy) ABI25_0_0RCTDirectEventBlock onSelect;
@property (nonatomic, copy) ABI25_0_0RCTDirectEventBlock onDeselect;
@property (nonatomic, copy) ABI25_0_0RCTDirectEventBlock onCalloutPress;
...
- (void)fillCalloutView:(ABI25_0_0SMCalloutView *)calloutView;
...
@interface ABI25_0_0AIREmptyCalloutBackgroundView : ABI25_0_0SMCalloutBackgroundView
@end
