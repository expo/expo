...
@implementation ABI25_0_0RNSVGSvgView
{
    NSMutableDictionary<NSString *, ABI25_0_0RNSVGNode *> *_clipPaths;
    NSMutableDictionary<NSString *, ABI25_0_0RNSVGNode *> *_templates;
    NSMutableDictionary<NSString *, ABI25_0_0RNSVGPainter *> *_painters;
    CGRect _boundingBox;
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.align) {
        _viewBoxTransform = [ABI25_0_0RNSVGViewBox getTransform:CGRectMake(self.minX, self.minY, self.vbWidth, self.vbHeight)
                                                 eRect:rect
                                                 align:self.align
    ...
    for (ABI25_0_0RNSVGNode *node in self.subviews) {
        if ([node isKindOfClass:[ABI25_0_0RNSVGNode class]]) {
...
{
    if (self.align) {
        for (ABI25_0_0RNSVGNode *node in [self.subviews reverseObjectEnumerator]) {
            if (![node isKindOfClass:[ABI25_0_0RNSVGNode class]]) {
                continue;
            }
...
- (void)defineTemplate:(ABI25_0_0RNSVGNode *)template templateName:(NSString *)templateName
{
    if (!_templates) {
