...
@implementation ABI25_0_0RNSVGRenderable
{
...
- (void)setFill:(ABI25_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI25_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI25_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)setStrokeDasharray:(ABI25_0_0RNSVGCGFloatArray)strokeDasharray
{
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    if (self.stroke) {
        ...
        ABI25_0_0RNSVGCGFloatArray dash = self.strokeDasharray;
...
- (void)mergeProperties:(__kindof ABI25_0_0RNSVGRenderable *)target
{
