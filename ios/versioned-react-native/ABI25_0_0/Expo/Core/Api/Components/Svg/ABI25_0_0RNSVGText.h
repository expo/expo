...
#import "ABI25_0_0RNSVGGlyphContext.h"

@interface ABI25_0_0RNSVGText : ABI25_0_0RNSVGGroup

@property (nonatomic, assign) ABI25_0_0RNSVGTextAnchor textAnchor;
...
- (ABI25_0_0RNSVGText *)getTextRoot;
- (void)releaseCachedPath;
- (CGPathRef)getGroupPath:(CGContextRef)context;

- (ABI25_0_0RNSVGGlyphContext *)getGlyphContext;
