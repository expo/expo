...
@implementation ABI25_0_0RNSVGGlyphContext
{
...
- (void)pushContext:(NSDictionary *)font deltaX:(NSArray<NSNumber *> *)deltaX deltaY:(NSArray<NSNumber *> *)deltaY positionX:(NSString *)positionX positionY:(NSString *)positionY
{
    ...
    if (positionX) {
        location.x = [ABI25_0_0RNSVGPercentageConverter stringToFloat:positionX relative:_width offset:0];
    }
    
    if (positionY) {
        location.y = [ABI25_0_0RNSVGPercentageConverter stringToFloat:positionY relative:_height offset:0];
    }
...
- (CTFontRef)getGlyphFont
{
    ...
    return (__bridge CTFontRef)[ABI25_0_0RCTFont updateFont:nil
