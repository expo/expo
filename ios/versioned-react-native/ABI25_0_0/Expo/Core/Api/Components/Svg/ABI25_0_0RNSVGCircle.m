...
@implementation ABI25_0_0RNSVGCircle
...
- (CGPathRef)getPath:(CGContextRef)context
{
    ...
    if ([ABI25_0_0RNSVGPercentageConverter isPercentage:self.r]) {
        CGFloat radiusPercent = [ABI25_0_0RNSVGPercentageConverter percentageToFloat:self.r relative:1 offset:0];
