...
@interface ABI25_0_0AIRGoogleMap : GMSMapView
...
@property (nonatomic, copy) ABI25_0_0RCTBubblingEventBlock onLongPress;
@property (nonatomic, copy) ABI25_0_0RCTBubblingEventBlock onMarkerPress;
@property (nonatomic, copy) ABI25_0_0RCTBubblingEventBlock onChange;
@property (nonatomic, copy) ABI25_0_0RCTDirectEventBlock onRegionChange;
@property (nonatomic, copy) ABI25_0_0RCTDirectEventBlock onRegionChangeComplete;
