//
//  ABI25_0_0AIRGoogleMapPolygon.m
//
...
@implementation ABI25_0_0AIRGoogleMapPolygon

- (instancetype)init
{
  if (self = [super init]) {
    _polygon = [[ABI25_0_0AIRGMSPolygon alloc] init];
  }

  return self;
}

- (void)setCoordinates:(NSArray<ABI25_0_0AIRMapCoordinate *> *)coordinates
{
...
- (void)setHoles:(NSArray<NSArray<ABI25_0_0AIRMapCoordinate *> *> *)holes
{
  _holes = holes;
...
- (void)setOnPress:(ABI25_0_0RCTBubblingEventBlock)onPress {
