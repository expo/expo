...
#import "ABI25_0_0RNTapHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ReactABI25_0_0/ABI25_0_0RCTConvert.h>

@interface ABI25_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
@implementation ABI25_0_0RNBetterTapGestureRecognizer {
...
@implementation ABI25_0_0RNTapGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI25_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    ABI25_0_0RNBetterTapGestureRecognizer *recognizer = (ABI25_0_0RNBetterTapGestureRecognizer *)_recognizer;

    APPLY_INT_PROP(numberOfTaps);

    id prop = config[@"maxDelayMs"];
    if (prop != nil) {
        recognizer.maxDelay = [ABI25_0_0RCTConvert CGFloat:prop] / 1000.0;
    }

    prop = config[@"maxDurationMs"];
    if (prop != nil) {
        recognizer.maxDuration = [ABI25_0_0RCTConvert CGFloat:prop] / 1000.0;
    }
}
