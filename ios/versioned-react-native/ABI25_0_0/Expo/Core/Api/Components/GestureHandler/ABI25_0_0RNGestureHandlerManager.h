...
@interface ABI25_0_0RNGestureHandlerManager : NSObject

- (nonnull instancetype)initWithUIManager:(nonnull ABI25_0_0RCTUIManager *)uiManager
                          eventDispatcher:(nonnull ABI25_0_0RCTEventDispatcher *)eventDispatcher;
