...
@implementation ABI25_0_0RNGestureHandlerEventExtraData
...
{
    return [[ABI25_0_0RNGestureHandlerEventExtraData alloc]
            initWithData:@{
                           @"x": @(position.x),
                           @"y": @(position.y),
...
{
    return [[ABI25_0_0RNGestureHandlerEventExtraData alloc] initWithData:@{@"pointerInside": @(pointerInside)}];
}

@end


@implementation ABI25_0_0RNGestureHandlerEvent
{
    NSNumber *_handlerTag;
    ABI25_0_0RNGestureHandlerState _state;
    ABI25_0_0RNGestureHandlerEventExtraData *_extraData;
}
...
- (instancetype)initWithRactTag:(NSNumber *)ReactABI25_0_0Tag
                     handlerTag:(NSNumber *)handlerTag
                      ...
                      extraData:(ABI25_0_0RNGestureHandlerEventExtraData *)extraData
{
...
@implementation ABI25_0_0RNGestureHandlerStateChange
{
    NSNumber *_handlerTag;
    ABI25_0_0RNGestureHandlerState _state;
    ABI25_0_0RNGestureHandlerState _prevState;
    ABI25_0_0RNGestureHandlerEventExtraData *_extraData;
}
