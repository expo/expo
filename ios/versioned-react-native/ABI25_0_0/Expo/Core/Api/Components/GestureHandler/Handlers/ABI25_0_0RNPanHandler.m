...
#import "ABI25_0_0RNPanHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

@interface ABI25_0_0RNBetterPanGestureRecognizer : UIPanGestureRecognizer
...
- (id)initWithGestureHandler:(ABI25_0_0RNGestureHandler*)gestureHandler;

@end


@implementation ABI25_0_0RNBetterPanGestureRecognizer {
    __weak ABI25_0_0RNGestureHandler *_gestureHandler;
...
@implementation ABI25_0_0RNPanGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI25_0_0RNBetterPanGestureRecognizer alloc] initWithGestureHandler:self];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    ABI25_0_0RNBetterPanGestureRecognizer *recognizer = (ABI25_0_0RNBetterPanGestureRecognizer *)_recognizer;
    ...
    if (prop != nil) {
        CGFloat dist = [ABI25_0_0RCTConvert CGFloat:prop];
        recognizer.minDistSq = dist * dist;
    }

    prop = config[@"minVelocity"];
    if (prop != nil) {
        CGFloat velocity = [ABI25_0_0RCTConvert CGFloat:prop];
        recognizer.minVelocitySq = velocity * velocity;
    }
    [recognizer updateHasCustomActivationCriteria];
}

- (ABI25_0_0RNGestureHandlerEventExtraData *)eventExtraData:(UIPanGestureRecognizer *)recognizer
{
