...
ABI25_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI25_0_0EXConstants, constants)

@import UIKit.UIApplication;

@interface ABI25_0_0EXConstants ()
...
@implementation ABI25_0_0EXConstants

ABI25_0_0EX_EXPORT_SCOPED_MODULE(ExponentConstants, nil)
...
ABI25_0_0RCT_REMAP_METHOD(getWebViewUserAgentAsync,
                 getWebViewUserAgentWithResolver:(ABI25_0_0RCTPromiseResolveBlock)resolve
