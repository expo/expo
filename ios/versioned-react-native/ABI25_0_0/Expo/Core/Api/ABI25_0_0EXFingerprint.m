...
#import "ABI25_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI25_0_0EXFingerprint

ABI25_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI25_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI25_0_0RCTPromiseResolveBlock)resolve
...
ABI25_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI25_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI25_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI25_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
