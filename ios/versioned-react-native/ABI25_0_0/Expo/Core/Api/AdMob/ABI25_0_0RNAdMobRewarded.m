#import "ABI25_0_0RNAdMobRewarded.h"

@implementation ABI25_0_0RNAdMobRewarded {
  NSString *_adUnitID;
  NSString *_testDeviceID;
  ABI25_0_0RCTResponseSenderBlock _requestAdCallback;
  ABI25_0_0RCTResponseSenderBlock _showAdCallback;
}
...
ABI25_0_0RCT_EXPORT_METHOD(setAdUnitID:(NSString *)adUnitID)
{
  _adUnitID = adUnitID;
}

ABI25_0_0RCT_EXPORT_METHOD(setTestDeviceID:(NSString *)testDeviceID)
{
  _testDeviceID = testDeviceID;
}

ABI25_0_0RCT_EXPORT_METHOD(requestAd:(ABI25_0_0RCTResponseSenderBlock)callback)
{
...
ABI25_0_0RCT_EXPORT_METHOD(showAd:(ABI25_0_0RCTResponseSenderBlock)callback)
{
  if ([[GADRewardBasedVideoAd sharedInstance] isReady]) {
    ...
    callback(@[@"Ad is not ready."]); // TODO: make proper error via ABI25_0_0RCTUtils.h
  }
}

ABI25_0_0RCT_EXPORT_METHOD(isReady:(ABI25_0_0RCTResponseSenderBlock)callback)
{
