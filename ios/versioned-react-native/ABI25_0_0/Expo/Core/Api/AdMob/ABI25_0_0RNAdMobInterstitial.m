#import "ABI25_0_0RNAdMobInterstitial.h"

@implementation ABI25_0_0RNAdMobInterstitial {
...
ABI25_0_0RCT_EXPORT_METHOD(requestAd:(ABI25_0_0RCTResponseSenderBlock)callback)
{
  if ([_interstitial hasBeenUsed] || _interstitial == nil) {
    ...
    callback(@[@"Ad is already loaded."]); // TODO: make proper error via ABI25_0_0RCTUtils.h
  }
}
