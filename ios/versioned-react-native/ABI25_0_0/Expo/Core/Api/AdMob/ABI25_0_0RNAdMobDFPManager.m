#import "ABI25_0_0RNAdMobDFPManager.h"
#import "ABI25_0_0RNDFPBannerView.h"
...
@implementation ABI25_0_0RNAdMobDFPManager
...
- (UIView *)view
{
  return [[ABI25_0_0RNDFPBannerView alloc] init];
}
...
ABI25_0_0RCT_EXPORT_VIEW_PROPERTY(onAdmobDispatchAppEvent, ABI25_0_0RCTBubblingEventBlock)
