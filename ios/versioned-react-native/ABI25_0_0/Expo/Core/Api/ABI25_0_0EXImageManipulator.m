...
#import "ABI25_0_0EXImageManipulator.h"
#import "ABI25_0_0EXFileSystem.h"
#import "ABI25_0_0EXImageUtils.h"
#import <ReactABI25_0_0/ABI25_0_0RCTLog.h>

@implementation ABI25_0_0EXImageManipulator

ABI25_0_0RCT_EXPORT_MODULE(ExponentImageManipulator);
...
ABI25_0_0RCT_EXPORT_METHOD(manipulate:(NSString *)uri
                  ...
                  rejecter:(ABI25_0_0RCTPromiseRejectBlock)reject)
{
  ...
  for (NSDictionary *options in actions) {
    if (options[@"resize"]) {
      ...
      image = [ABI25_0_0EXImageUtils cropImage:image toRect:cropDimensions];
    }
  }
  ...
  if ([format isEqualToString:@"jpeg"]) {
    ...
    ABI25_0_0RCTLogWarn(@"Unsupported format: %@, using JPEG instead.", format);
    imageData = UIImageJPEGRepresentation(image, compressionValue);
    extension = @".jpg";
  }
