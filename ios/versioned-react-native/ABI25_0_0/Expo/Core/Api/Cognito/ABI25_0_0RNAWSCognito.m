#import "ABI25_0_0RNAWSCognito.h"
...
@implementation ABI25_0_0RNAWSCognito
...
ABI25_0_0RCT_EXPORT_METHOD(computeModPow:(NSDictionary *)values
    ...
    if (result) {
        ...
        callback(@[@[ABI25_0_0RCTMakeError(@"computeModPow error", nil, nil)], [NSNull null]]);
    }
}

ABI25_0_0RCT_EXPORT_METHOD(computeS:(NSDictionary *)values
                  callback:(ABI25_0_0RCTResponseSenderBlock)callback) {
    ...
    if (result) {
        ...
        callback(@[@[ABI25_0_0RCTMakeError(@"computeS error", nil, nil)], [NSNull null]]);
    }
}
