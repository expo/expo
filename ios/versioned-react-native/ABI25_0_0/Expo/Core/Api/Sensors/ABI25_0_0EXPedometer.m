...
#import "ABI25_0_0EXPedometer.h"
#import "ABI25_0_0EXUnversioned.h"

#import <CoreMotion/CoreMotion.h>

NSString * const ABI25_0_0EXPedometerUpdateEventName = @"Exponent.pedometerUpdate";

@implementation ABI25_0_0EXPedometer
{
...
- (void)setBridge:(ABI25_0_0RCTBridge *)bridge
{
  ...
  _watchHandler = ^(CMPedometerData * _Nullable pedometerData, NSError * _Nullable error) {
    ...
    [weakSelf sendEventWithName:ABI25_0_0EXPedometerUpdateEventName
...
ABI25_0_0RCT_EXPORT_MODULE(ExponentPedometer)

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI25_0_0EXPedometerUpdateEventName];
}

ABI25_0_0RCT_EXPORT_METHOD(getStepCountAsync:(nonnull NSNumber *)startTime
...
ABI25_0_0RCT_EXPORT_METHOD(watchStepCount)
{
  if (!_pedometer) {
    _pedometer = [CMPedometer new];
  }
...
ABI25_0_0RCT_EXPORT_METHOD(stopWatchingStepCount)
{
  _watchStartDate = nil;
  _isWatching = NO;
  [_pedometer stopPedometerUpdates];
...
ABI25_0_0RCT_EXPORT_METHOD(isAvailableAsync:(ABI25_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI25_0_0RCTPromiseRejectBlock)reject)
{
