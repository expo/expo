...
@implementation ABI25_0_0EXDeviceMotion

ABI25_0_0EX_EXPORT_SCOPED_MODULE(ExponentDeviceMotion, SensorManager);
...
{
  return @{ @"Gravity" : @(ABI25_0_0EXGravity) };
}
...
ABI25_0_0RCT_EXPORT_METHOD(setUpdateInterval:(nonnull NSNumber *)intervalMs) {
