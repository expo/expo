...
- (NSError *)_updateAudioSessionCategory:(AVAudioSession *)audioSession forAudioSessionMode:(ABI25_0_0EXAVAudioSessionMode)audioSessionMode
{
  NSError *error;
...
ABI25_0_0RCT_EXPORT_MODULE(ExponentAV);
