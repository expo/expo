...
@implementation ABI25_0_0EXContacts

ABI25_0_0EX_EXPORT_SCOPED_MODULE(ExponentContacts, PermissionsManager);
 ...
 */
ABI25_0_0RCT_EXPORT_METHOD(getContactsAsync:(NSDictionary *)options resolver:(ABI25_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI25_0_0RCTPromiseRejectBlock)reject)
{
  if (!_contactStore) {
    _contactStore = [[CNContactStore alloc] init];
  }

  if ([ABI25_0_0EXPermissions statusForPermissions:[ABI25_0_0EXContactsRequester permissions]] != ABI25_0_0EXPermissionStatusGranted ||
