...
@interface ABI25_0_0EXGLObject : NSObject

@property (nonatomic, assign) UEXGLContextId exglCtxId;
@property (nonatomic, assign) UEXGLObjectId exglObjId;

// Create an `ABI25_0_0EXGLObject` of the correct type given `config`, returns `nil` if
// bad `config`
+ (instancetype)createWithConfig:(NSDictionary *)config;

// For internal use by children -- use `[ABI25_0_0EXGLObject createWithConfig:...]` above to
// create the `ABI25_0_0EXGLObject` of the right type
