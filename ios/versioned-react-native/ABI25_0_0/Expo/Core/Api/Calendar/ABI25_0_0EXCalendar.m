...
@implementation ABI25_0_0EXCalendar
...
ABI25_0_0RCT_EXPORT_METHOD(getCalendarsAsync:(NSString *)typeString resolver:(ABI25_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI25_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve([ABI25_0_0EXCalendarConverter serializeCalendars:calendars]);
}
...
ABI25_0_0RCT_EXPORT_METHOD(saveCalendarAsync:(NSDictionary *)details resolver:(ABI25_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI25_0_0RCTPromiseRejectBlock)reject)
{
  ...
  NSString *sourceId = [ABI25_0_0RCTConvert NSString:details[@"sourceId"]];
  NSString *type = [ABI25_0_0RCTConvert NSString:details[@"entityType"]];
  NSString *calendarId = [ABI25_0_0RCTConvert NSString:details[@"id"]];
  ...
  if (color) {
    calendar.CGColor = [ABI25_0_0RCTConvert UIColor:color].CGColor;
...
ABI25_0_0RCT_EXPORT_METHOD(getEventsAsync:(NSDate *)startDate endDate:(NSDate *)endDate calendars:(NSArray *)calendars resolver:(ABI25_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI25_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (calendarEvents) {
    resolve([ABI25_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI25_0_0RCT_EXPORT_METHOD(getEventByIdAsync:(NSString *)eventId startDate:(NSDate *)startDate resolver:(ABI25_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI25_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (calendarEvent) {
    resolve([ABI25_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI25_0_0RCT_EXPORT_METHOD(saveEventAsync:(NSDictionary *)details options:(NSDictionary *)options resolver:(ABI25_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI25_0_0RCTPromiseRejectBlock)reject)
{
  ...
  NSString *title = [ABI25_0_0RCTConvert NSString:details[@"title"]];
  NSString *location = [ABI25_0_0RCTConvert NSString:details[@"location"]];
  NSDate *startDate = [ABI25_0_0RCTConvert NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI25_0_0RCTConvert NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI25_0_0RCTConvert NSDate:details[@"instanceStartDate"]];
  NSNumber *allDay = [ABI25_0_0RCTConvert NSNumber:details[@"allDay"]];
  NSString *notes = [ABI25_0_0RCTConvert NSString:details[@"notes"]];
  NSString *timeZone = [ABI25_0_0RCTConvert NSString:details[@"timeZone"]];
  NSString *url = [ABI25_0_0RCTConvert NSString:details[@"url"]];
  NSArray *alarms = [ABI25_0_0RCTConvert NSArray:details[@"alarms"]];
  NSDictionary *recurrenceRule = [ABI25_0_0RCTConvert NSDictionary:details[@"recurrenceRule"]];
  NSString *availability = [ABI25_0_0RCTConvert NSString:details[@"availability"]];
  ...
  if (recurrenceRule) {
    NSString *frequency = [ABI25_0_0RCTConvert NSString:recurrenceRule[@"frequency"]];
    NSInteger interval = [ABI25_0_0RCTConvert NSInteger:recurrenceRule[@"interval"]];
    NSInteger occurrence = [ABI25_0_0RCTConvert NSInteger:recurrenceRule[@"occurrence"]];
    NSDate *endDate = nil;
    if (recurrenceRule[@"endDate"]) {
      endDate = [ABI25_0_0RCTConvert NSDate:recurrenceRule[@"endDate"]];
    }
...
ABI25_0_0RCT_EXPORT_METHOD(getAttendeesForEventAsync:(NSDictionary *)event resolver:(ABI25_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI25_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (item.hasAttendees) {
    resolve([ABI25_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
...
ABI25_0_0RCT_EXPORT_METHOD(getRemindersAsync:(NSDate * _Nullable)startDate endDate:(NSDate * _Nullable)endDate calendars:(NSArray *)calendars status:(NSString * _Nullable)status resolver:(ABI25_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI25_0_0RCTPromiseRejectBlock)reject)
{
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI25_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}
...
ABI25_0_0RCT_EXPORT_METHOD(getReminderByIdAsync:(NSString *)reminderId resolver:(ABI25_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI25_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (reminder) {
    ...
    resolve([ABI25_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI25_0_0RCT_EXPORT_METHOD(saveReminderAsync:(NSDictionary *)details resolver:(ABI25_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI25_0_0RCTPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI25_0_0RCTConvert NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI25_0_0RCTConvert NSDate:details[@"dueDate"]];
  NSNumber *completed = [ABI25_0_0RCTConvert NSNumber:details[@"completed"]];
  NSDate *completionDate = [ABI25_0_0RCTConvert NSDate:details[@"completionDate"]];
  NSString *title = [ABI25_0_0RCTConvert NSString:details[@"title"]];
  NSString *location = [ABI25_0_0RCTConvert NSString:details[@"location"]];
  NSString *notes = [ABI25_0_0RCTConvert NSString:details[@"notes"]];
  NSString *timeZone = [ABI25_0_0RCTConvert NSString:details[@"timeZone"]];
...
ABI25_0_0RCT_EXPORT_METHOD(getSourcesAsync:(ABI25_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI25_0_0RCTPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI25_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI25_0_0RCT_EXPORT_METHOD(getSourceByIdAsync:(NSString *)sourceId resolver:(ABI25_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI25_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve([ABI25_0_0EXCalendarConverter serializeSource:source]);
}
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI25_0_0RCTConvert NSDate:alarm[@"absoluteDate"]];
  NSNumber *relativeOffset = [ABI25_0_0RCTConvert NSNumber:alarm[@"relativeOffset"]];
