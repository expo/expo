...
@implementation ABI25_0_0EXFaceDetectorModule
...
ABI25_0_0RCT_EXPORT_MODULE(ExpoFaceDetector);
...
ABI25_0_0RCT_EXPORT_METHOD(detectFaces:(nonnull NSDictionary *)options
                     ...
                     rejecter:(ABI25_0_0RCTPromiseRejectBlock)reject)
{
  ...
  @try {
    ...
    ABI25_0_0EXFaceEncoder *faceEncoder = [[ABI25_0_0EXFaceEncoder alloc] init];
    ...
    resolve(@{
              ...
              @"image" : @{
                  ...
                  @"orientation" : @([ABI25_0_0EXFaceDetectorModule exifOrientationFor:image.imageOrientation])
                  }
              });
...
// the value of GMVImageOrientation is the same as the value defined by ABI25_0_0EXIF specifications, so we can adapt
