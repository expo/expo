//
//  ABI25_0_0EXFaceDetectorPointTransformCalculator.m
//  Exponent
//
...
typedef NS_ENUM(NSInteger, ABI25_0_0EXTranslationEnum) {
  ABI25_0_0EXTranslateYNegativeWidth,
  ABI25_0_0EXTranslateXNegativeHeight,
  ABI25_0_0EXTranslateXYNegative,
  ABI25_0_0EXTranslateYXNegative
};

@interface ABI25_0_0EXFaceDetectorPointTransformCalculator()
...
@implementation ABI25_0_0EXFaceDetectorPointTransformCalculator
...
- (CGPoint)translation
{
  ...
  AVCaptureVideoOrientation firstOrientation = MIN(_fromOrientation, _toOrientation);
  AVCaptureVideoOrientation secondOrientation = MAX(_fromOrientation, _toOrientation);
  ABI25_0_0EXTranslationEnum enumValue = [[[self class] getTranslationDictionary][@(firstOrientation)][@(secondOrientation)] intValue];
...
- (CGPoint)translationForEnum:(ABI25_0_0EXTranslationEnum)enumValue
{
  switch (enumValue) {
    case ABI25_0_0EXTranslateXNegativeHeight:
      return CGPointMake(-_videoHeight, 0);
    case ABI25_0_0EXTranslateYNegativeWidth:
      return CGPointMake(0, -_videoWidth);
    case ABI25_0_0EXTranslateXYNegative:
      return CGPointMake(-_videoWidth, -_videoHeight);
    case ABI25_0_0EXTranslateYXNegative:
...
+ (void)initTranslationDictionary
{
  translationDictionary = @{
                            @(AVCaptureVideoOrientationPortrait): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI25_0_0EXTranslateYNegativeWidth),
                                @(AVCaptureVideoOrientationLandscapeRight) : @(ABI25_0_0EXTranslateXNegativeHeight),
                                @(AVCaptureVideoOrientationPortraitUpsideDown) : @(ABI25_0_0EXTranslateYXNegative)
                                },
                            @(AVCaptureVideoOrientationPortraitUpsideDown): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI25_0_0EXTranslateXNegativeHeight),
                                @(AVCaptureVideoOrientationLandscapeRight) : @(ABI25_0_0EXTranslateYNegativeWidth)
                                },
                            @(AVCaptureVideoOrientationLandscapeRight): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI25_0_0EXTranslateXYNegative)
                                }
                            };
}
