//
//  ABI34_0_0EXFaceDetectorUtils.m
//  Exponent
//
...
NSString *const ABI34_0_0EXGMVDataOutputWidthKey = @"Width";
NSString *const ABI34_0_0EXGMVDataOutputHeightKey = @"Height";
...
@implementation ABI34_0_0EXFaceDetectorUtils
...
+ (ABI34_0_0EXFaceDetectionAngleTransformBlock)angleTransformerFromTransform:(CGAffineTransform)transform
{
  return ^(float angle) {
