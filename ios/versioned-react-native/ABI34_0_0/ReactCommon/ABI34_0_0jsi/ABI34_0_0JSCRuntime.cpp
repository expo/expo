...
#define JSC_LIKELY(ABI34_0_0EXPR) __builtin_expect((bool)(ABI34_0_0EXPR), true)
#define JSC_UNLIKELY(ABI34_0_0EXPR) __builtin_expect((bool)(ABI34_0_0EXPR), false)
#else
#define JSC_LIKELY(ABI34_0_0EXPR) (ABI34_0_0EXPR)
#define JSC_UNLIKELY(ABI34_0_0EXPR) (ABI34_0_0EXPR)
#endif
