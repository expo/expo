...
#include <jsiReactABI34_0_0/ABI34_0_0JSINativeModules.h>
...
folly::Optional<Object> JSINativeModules::createModule(
  ...
  if (hasLogger) {
    ReactABI34_0_0Marker::logTaggedMarker(
        ReactABI34_0_0Marker::NATIVE_MODULE_SETUP_START, name.c_str());
  }
  ...
  if (hasLogger) {
    ReactABI34_0_0Marker::logTaggedMarker(
        ReactABI34_0_0Marker::NATIVE_MODULE_SETUP_STOP, name.c_str());
  }
