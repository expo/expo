...
#include <cxxReactABI34_0_0/ReactABI34_0_0Marker.h>
#include <cxxReactABI34_0_0/ABI34_0_0SystraceSection.h>
...
void JSIExecutor::loadApplicationScript(
  ...
  bool hasLogger(ReactABI34_0_0Marker::logTaggedMarker);
  std::string scriptName = simpleBasename(sourceURL);
  if (hasLogger) {
    ReactABI34_0_0Marker::logTaggedMarker(
        ReactABI34_0_0Marker::RUN_JS_BUNDLE_START, scriptName.c_str());
  }
  runtime_->evaluateJavaScript(
      std::make_unique<BigStringBuffer>(std::move(script)), sourceURL);
  flush();
  if (hasLogger) {
    ReactABI34_0_0Marker::logMarker(ReactABI34_0_0Marker::CREATE_REACT_CONTEXT_STOP);
    ReactABI34_0_0Marker::logTaggedMarker(
        ReactABI34_0_0Marker::RUN_JS_BUNDLE_STOP, scriptName.c_str());
  }
}
...
void JSIExecutor::registerBundle(
  ...
  ReactABI34_0_0Marker::logTaggedMarker(
      ReactABI34_0_0Marker::REGISTER_JS_SEGMENT_START, tag.c_str());
  if (bundleRegistry_) {
  ...
  ReactABI34_0_0Marker::logTaggedMarker(
      ReactABI34_0_0Marker::REGISTER_JS_SEGMENT_STOP, tag.c_str());
}
