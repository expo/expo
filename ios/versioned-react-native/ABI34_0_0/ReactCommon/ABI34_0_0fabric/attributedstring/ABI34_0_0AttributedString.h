...
/*
 * Simple, cross-platfrom, ReactABI34_0_0-specific implementation of attributed string
 * (aka spanned string).
...
namespace std {
template <>
struct hash<facebook::ReactABI34_0_0::AttributedString::Fragment> {
  size_t operator()(
      const facebook::ReactABI34_0_0::AttributedString::Fragment &fragment) const {
    auto seed = size_t{0};
...
template <>
struct hash<facebook::ReactABI34_0_0::AttributedString> {
  size_t operator()(
      const facebook::ReactABI34_0_0::AttributedString &attributedString) const {
    auto seed = size_t{0};
