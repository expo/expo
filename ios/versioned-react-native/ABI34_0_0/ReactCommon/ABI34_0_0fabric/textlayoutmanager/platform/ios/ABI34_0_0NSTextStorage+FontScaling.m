...
- (void)abi34_0_0_rct_scaleFontSizeToFitSize:(CGSize)size
  ...
  while (true) {
    ...
    ABI34_0_0RCTTextSizeComparisonOptions comparsion = [self abi34_0_0_rct_compareToSize:size
                                                   thresholdRatio:0.01];

    if ((comparsion & ABI34_0_0RCTTextSizeComparisonWithinRange) &&
...
- (ABI34_0_0RCTTextSizeComparisonOptions)abi34_0_0_rct_compareToSize:(CGSize)size
  ...
  result |=
      (fitsSize) ? ABI34_0_0RCTTextSizeComparisonSmaller : ABI34_0_0RCTTextSizeComparisonLarger;
