...
#include <ReactABI34_0_0/uimanager/TimeUtils.h>
...
Scheduler::Scheduler(
  ...
  ReactABI34_0_0NativeConfig_ =
      contextContainer->getInstance<std::shared_ptr<const ReactABI34_0_0NativeConfig>>(
...
void Scheduler::renderTemplateToSurface(
  ...
  try {
    ...
    LOG(ERROR) << "    >>>> ABI34_0_0EXCEPTION <<<  rendering uiTemplate in "
