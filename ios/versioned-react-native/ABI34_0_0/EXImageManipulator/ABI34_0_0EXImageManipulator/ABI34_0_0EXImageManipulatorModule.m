...
#import <ABI34_0_0EXImageManipulator/ABI34_0_0EXImageManipulatorModule.h>
...
@interface ABI34_0_0EXImageManipulatorModule ()
...
@implementation ABI34_0_0EXImageManipulatorModule

ABI34_0_0UM_EXPORT_MODULE(ExpoImageManipulator);
...
ABI34_0_0UM_EXPORT_METHOD_AS(manipulateAsync,
                    uri:(NSString *)uri
                    ...
                    reject:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (!([_fileSystem permissionsForURI:url] & ABI34_0_0UMFileSystemPermissionRead)) {
