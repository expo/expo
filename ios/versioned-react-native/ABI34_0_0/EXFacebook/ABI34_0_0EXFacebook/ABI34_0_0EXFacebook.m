...
@implementation FBSDKInternalUtility (ABI34_0_0EXFacebook)
...
NSString * const ABI34_0_0EXFacebookLoginBehaviorErrorDomain = @"E_FBLOGIN_BEHAVIOR";
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    if (loginMgr.loginBehavior != FBSDKLoginBehaviorWeb) {
      if (![[self class] facebookAppIdFromNSBundle]) {
        ...
        reject(ABI34_0_0EXFacebookLoginBehaviorErrorDomain, message, ABI34_0_0UMErrorWithMessage(message));
        return;
      }
    }
