...
@implementation ABI34_0_0RCTAssetsLibraryRequestHandler
     ...
     withDelegate:(id<ABI34_0_0RCTURLRequestDelegate>)delegate
{
  ...
  if (!request.URL) {
    ...
    [delegate URLRequest:cancellationBlock didCompleteWithError:ABI34_0_0RCTErrorWithMessage(msg)];
  ...
  if (![fetchResult firstObject]) {
    ...
    NSError *error = ABI34_0_0RCTErrorWithMessage(errorMessage);
