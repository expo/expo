...
#import "ABI34_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI34_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI34_0_0ViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI34_0_0ViewController detachChildViewController:self.contentViewController];
}
