...
#import <ABI34_0_0RCTWrapper/ABI34_0_0RCTWrapperViewManager.h>

// Umbrella header with macros

// ABI34_0_0RCT_WRAPPER_FOR_VIEW
#define ABI34_0_0RCT_WRAPPER_FOR_VIEW(ClassName)                                        \
                                                                               \
NS_ASSUME_NONNULL_BEGIN                                                        \
                                                                               \
@interface ClassName##Manager : ABI34_0_0RCTWrapperViewManager                          \
                                                                               \
@end                                                                           \
                                                                               \
...
// ABI34_0_0RCT_WRAPPER_FOR_VIEW_CONTROLLER
#define ABI34_0_0RCT_WRAPPER_FOR_VIEW_CONTROLLER(ClassName)                             \
                                                                               \
NS_ASSUME_NONNULL_BEGIN                                                        \
                                                                               \
@interface ClassName##Manager : ABI34_0_0RCTWrapperViewManager                          \
