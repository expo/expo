...
#import "ABI34_0_0RCTReconnectingWebSocket.h"

#import <ReactABI34_0_0/ABI34_0_0RCTConvert.h>
#import <ReactABI34_0_0/ABI34_0_0RCTDefines.h>

#if __has_include(<ReactABI34_0_0/fishhook.h>)
#import <ReactABI34_0_0/fishhook.h>
#else
...
@interface ABI34_0_0RCTReconnectingWebSocket () <ABI34_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI34_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  __weak ABI34_0_0RCTSRWebSocket *socket = _socket;
