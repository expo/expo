...
@implementation ABI34_0_0ARTText
...
static void ABI34_0_0ARTFreeTextFrame(ABI34_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI34_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI34_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI34_0_0ARTTextFrame frame = self.textFrame;
