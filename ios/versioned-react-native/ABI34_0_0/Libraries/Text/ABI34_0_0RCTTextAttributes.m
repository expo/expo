...
NSString *const ABI34_0_0RCTTextAttributesIsHighlightedAttributeName = @"ABI34_0_0RCTTextAttributesIsHighlightedAttributeName";
NSString *const ABI34_0_0RCTTextAttributesTagAttributeName = @"ABI34_0_0RCTTextAttributesTagAttributeName";

@implementation ABI34_0_0RCTTextAttributes
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _opacity = NAN;
    _textTransform = ABI34_0_0RCTTextTransformUndefined;
  }
...
- (void)applyTextAttributes:(ABI34_0_0RCTTextAttributes *)textAttributes
{
  ...
  _textDecorationLine = textAttributes->_textDecorationLine != ABI34_0_0RCTTextDecorationLineTypeNone ? textAttributes->_textDecorationLine : _textDecorationLine; // *
  ...
  _textTransform = textAttributes->_textTransform != ABI34_0_0RCTTextTransformUndefined ? textAttributes->_textTransform : _textTransform;
}
...
- (NSDictionary<NSAttributedStringKey, id> *)effectiveTextAttributes
{
  ...
  if (_textDecorationLine == ABI34_0_0RCTTextDecorationLineTypeUnderline ||
      _textDecorationLine == ABI34_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    isTextDecorationEnabled = YES;
    attributes[NSUnderlineStyleAttributeName] = @(_textDecorationStyle);
  }

  if (_textDecorationLine == ABI34_0_0RCTTextDecorationLineTypeStrikethrough ||
      _textDecorationLine == ABI34_0_0RCTTextDecorationLineTypeUnderlineStrikethrough){
    isTextDecorationEnabled = YES;
  ...
  // Special
  if (_isHighlighted) {
    attributes[ABI34_0_0RCTTextAttributesIsHighlightedAttributeName] = @YES;
  }

  if (_tag) {
    attributes[ABI34_0_0RCTTextAttributesTagAttributeName] = _tag;
  }
...
{
  // FIXME: ABI34_0_0RCTFont has thread-safety issues and must be rewritten.
...
{
  bool fontScalingEnabled = !ABI34_0_0RCTHasFontHandlerSet() && _allowFontScaling;
...
- (NSString *)applyTextAttributesToText:(NSString *)text
{
  switch (_textTransform) {
    case ABI34_0_0RCTTextTransformUndefined:
    case ABI34_0_0RCTTextTransformNone:
      return text;
    case ABI34_0_0RCTTextTransformLowercase:
      return [text lowercaseString];
    case ABI34_0_0RCTTextTransformUppercase:
      return [text uppercaseString];
    case ABI34_0_0RCTTextTransformCapitalize:
      return [text capitalizedString];
  }
}

- (ABI34_0_0RCTTextAttributes *)copyWithZone:(NSZone *)zone
{
  ABI34_0_0RCTTextAttributes *textAttributes = [ABI34_0_0RCTTextAttributes new];
...
- (BOOL)isEqual:(ABI34_0_0RCTTextAttributes *)textAttributes
{
  if (self == textAttributes) {
    return YES;
  }

#define ABI34_0_0RCTTextAttributesCompareFloats(a) ((a == textAttributes->a) || (isnan(a) && isnan(textAttributes->a)))
#define ABI34_0_0RCTTextAttributesCompareSize(a) CGSizeEqualToSize(a, textAttributes->a)
#define ABI34_0_0RCTTextAttributesCompareObjects(a) ((a == textAttributes->a) || [a isEqual:textAttributes->a])
#define ABI34_0_0RCTTextAttributesCompareStrings(a) ((a == textAttributes->a) || [a isEqualToString:textAttributes->a])
#define ABI34_0_0RCTTextAttributesCompareOthers(a) (a == textAttributes->a)

  return
    ABI34_0_0RCTTextAttributesCompareObjects(_foregroundColor) &&
    ABI34_0_0RCTTextAttributesCompareObjects(_backgroundColor) &&
    ABI34_0_0RCTTextAttributesCompareFloats(_opacity) &&
    // Font
    ABI34_0_0RCTTextAttributesCompareObjects(_fontFamily) &&
    ABI34_0_0RCTTextAttributesCompareFloats(_fontSize) &&
    ABI34_0_0RCTTextAttributesCompareFloats(_fontSizeMultiplier) &&
    ABI34_0_0RCTTextAttributesCompareFloats(_maxFontSizeMultiplier) &&
    ABI34_0_0RCTTextAttributesCompareStrings(_fontWeight) &&
    ABI34_0_0RCTTextAttributesCompareObjects(_fontStyle) &&
    ABI34_0_0RCTTextAttributesCompareObjects(_fontVariant) &&
    ABI34_0_0RCTTextAttributesCompareOthers(_allowFontScaling) &&
    ABI34_0_0RCTTextAttributesCompareFloats(_letterSpacing) &&
    // Paragraph Styles
    ABI34_0_0RCTTextAttributesCompareFloats(_lineHeight) &&
    ABI34_0_0RCTTextAttributesCompareFloats(_alignment) &&
    ABI34_0_0RCTTextAttributesCompareOthers(_baseWritingDirection) &&
    // Decoration
    ABI34_0_0RCTTextAttributesCompareObjects(_textDecorationColor) &&
    ABI34_0_0RCTTextAttributesCompareOthers(_textDecorationStyle) &&
    ABI34_0_0RCTTextAttributesCompareOthers(_textDecorationLine) &&
    // Shadow
    ABI34_0_0RCTTextAttributesCompareSize(_textShadowOffset) &&
    ABI34_0_0RCTTextAttributesCompareFloats(_textShadowRadius) &&
    ABI34_0_0RCTTextAttributesCompareObjects(_textShadowColor) &&
    // Special
    ABI34_0_0RCTTextAttributesCompareOthers(_isHighlighted) &&
    ABI34_0_0RCTTextAttributesCompareObjects(_tag) &&
    ABI34_0_0RCTTextAttributesCompareOthers(_layoutDirection) &&
    ABI34_0_0RCTTextAttributesCompareOthers(_textTransform);
}
