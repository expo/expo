...
@implementation ABI34_0_0RCTTextShadowView
{
...
- (instancetype)initWithBridge:(ABI34_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI34_0_0YGNodeSetMeasureFunc(self.ABI34_0_0yogaNode, ABI34_0_0RCTTextShadowViewMeasure);
    ABI34_0_0YGNodeSetBaselineFunc(self.ABI34_0_0yogaNode, ABI34_0_0RCTTextShadowViewBaseline);
  }
...
- (void)uiManagerWillPerformMounting
{
  ...
  [textStorage enumerateAttribute:ABI34_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                          inRange:NSMakeRange(0, textStorage.length)
                          options:0
                       usingBlock:
   ^(ABI34_0_0RCTShadowView *shadowView, NSRange range, __unused BOOL *stop) {
     if (!shadowView) {
       return;
     }

     [descendantViewTags addObject:shadowView.ReactABI34_0_0Tag];
   }
  ];

  [_bridge.uiManager addUIBlock:^(ABI34_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI34_0_0RCTTextView *textView = (ABI34_0_0RCTTextView *)viewRegistry[tag];
    if (!textView) {
      return;
    }
    ...
    [textStorage removeAttribute:ABI34_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName range:NSMakeRange(0, textStorage.length)];
...
- (NSAttributedString *)attributedTextWithMeasuredAttachmentsThatFitSize:(CGSize)size
{
  ...
  [attributedText enumerateAttribute:ABI34_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                               inRange:NSMakeRange(0, attributedText.length)
                               options:0
                            usingBlock:
    ^(ABI34_0_0RCTShadowView *shadowView, NSRange range, __unused BOOL *stop) {
                                        ...
                                        exclusiveOwnership:(BOOL)exclusiveOwnership
{
  ...
  if (_adjustsFontSizeToFit) {
    ...
    [textStorage abi34_0_0_rct_scaleFontSizeToFitSize:size
...
- (void)layoutSubviewsWithContext:(ABI34_0_0RCTLayoutContext)layoutContext
{
  ...
  [textStorage enumerateAttribute:ABI34_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                          ...
                          options:0
                       usingBlock:
    ^(ABI34_0_0RCTShadowView *shadowView, NSRange range, BOOL *stop) {
      if (!shadowView) {
        return;
      }
      ...
      CGRect frame = {{
        ABI34_0_0RCTRoundPixelValue(glyphRect.origin.x),
        ABI34_0_0RCTRoundPixelValue(glyphRect.origin.y + glyphRect.size.height - attachmentSize.height + font.descender)
      }, {
        ABI34_0_0RCTRoundPixelValue(attachmentSize.width),
        ABI34_0_0RCTRoundPixelValue(attachmentSize.height)
      }};
      
      NSRange truncatedGlyphRange = [layoutManager truncatedGlyphRangeInLineFragmentForGlyphAtIndex:range.location];
      BOOL viewIsTruncated = NSIntersectionRange(range, truncatedGlyphRange).length != 0;

      ABI34_0_0RCTLayoutContext localLayoutContext = layoutContext;
      ...
      ABI34_0_0RCTLayoutMetrics localLayoutMetrics = shadowView.layoutMetrics;
      localLayoutMetrics.frame.origin = frame.origin; // Reinforcing a proper frame origin for the Shadow View.
      if (viewIsTruncated) {
        localLayoutMetrics.displayType = ABI34_0_0RCTDisplayTypeNone;
      }
...
static ABI34_0_0YGSize ABI34_0_0RCTTextShadowViewMeasure(ABI34_0_0YGNodeRef node, float width, ABI34_0_0YGMeasureMode widthMode, float height, ABI34_0_0YGMeasureMode heightMode)
{
  CGSize maximumSize = (CGSize){
    widthMode == ABI34_0_0YGMeasureModeUndefined ? CGFLOAT_MAX : ABI34_0_0RCTCoreGraphicsFloatFromYogaFloat(width),
    heightMode == ABI34_0_0YGMeasureModeUndefined ? CGFLOAT_MAX : ABI34_0_0RCTCoreGraphicsFloatFromYogaFloat(height),
  };

  ABI34_0_0RCTTextShadowView *shadowTextView = (__bridge ABI34_0_0RCTTextShadowView *)ABI34_0_0YGNodeGetContext(node);
  ...
  size = (CGSize){
    MIN(ABI34_0_0RCTCeilPixelValue(size.width), maximumSize.width),
    MIN(ABI34_0_0RCTCeilPixelValue(size.height), maximumSize.height)
  };
  ...
  return (ABI34_0_0YGSize){
    ABI34_0_0RCTYogaFloatFromCoreGraphicsFloat(size.width + epsilon),
    ABI34_0_0RCTYogaFloatFromCoreGraphicsFloat(size.height + epsilon)
  };
}

static float ABI34_0_0RCTTextShadowViewBaseline(ABI34_0_0YGNodeRef node, const float width, const float height)
{
  ABI34_0_0RCTTextShadowView *shadowTextView = (__bridge ABI34_0_0RCTTextShadowView *)ABI34_0_0YGNodeGetContext(node);
