...
@implementation ABI34_0_0RCTBaseTextInputShadowView
{
...
- (instancetype)initWithBridge:(ABI34_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI34_0_0YGNodeSetMeasureFunc(self.ABI34_0_0yogaNode, ABI34_0_0RCTBaseTextInputShadowViewMeasure);
    ABI34_0_0YGNodeSetBaselineFunc(self.ABI34_0_0yogaNode, ABI34_0_0RCTTextInputShadowViewBaseline);
  }
...
- (void)dirtyLayout
{
  [super dirtyLayout];
  _needsUpdateView = YES;
  ABI34_0_0YGNodeMarkDirty(self.ABI34_0_0yogaNode);
...
{
  if (ABI34_0_0YGNodeIsDirty(self.ABI34_0_0yogaNode)) {
    return;
  }
  ...
  ABI34_0_0RCTTextAttributes *textAttributes = [self.textAttributes copy];
  ...
  [attributedText removeAttribute:ABI34_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                            range:NSMakeRange(0, attributedText.length)];

  [attributedText removeAttribute:ABI34_0_0RCTTextAttributesTagAttributeName
                            range:NSMakeRange(0, attributedText.length)];
  ...
  NSNumber *tag = self.ReactABI34_0_0Tag;

  [_bridge.uiManager addUIBlock:^(ABI34_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI34_0_0RCTBaseTextInputView *baseTextInputView = (ABI34_0_0RCTBaseTextInputView *)viewRegistry[tag];
    if (!baseTextInputView) {
      return;
    }

    baseTextInputView.textAttributes = textAttributes;
    baseTextInputView.ReactABI34_0_0BorderInsets = borderInsets;
    baseTextInputView.ReactABI34_0_0PaddingInsets = paddingInsets;
...
- (CGSize)sizeThatFitsMinimumSize:(CGSize)minimumSize maximumSize:(CGSize)maximumSize
{
  ...
  return (CGSize){
    MAX(minimumSize.width, MIN(ABI34_0_0RCTCeilPixelValue(size.width), maximumSize.width)),
    MAX(minimumSize.height, MIN(ABI34_0_0RCTCeilPixelValue(size.height), maximumSize.height))
  };
}
...
static ABI34_0_0YGSize ABI34_0_0RCTBaseTextInputShadowViewMeasure(ABI34_0_0YGNodeRef node, float width, ABI34_0_0YGMeasureMode widthMode, float height, ABI34_0_0YGMeasureMode heightMode)
{
  ...
  CGSize size = {
    ABI34_0_0RCTCoreGraphicsFloatFromYogaFloat(width),
    ABI34_0_0RCTCoreGraphicsFloatFromYogaFloat(height)
  };
  ...
  return (ABI34_0_0YGSize){
    ABI34_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.width),
    ABI34_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.height)
  };
}

static float ABI34_0_0RCTTextInputShadowViewBaseline(ABI34_0_0YGNodeRef node, const float width, const float height)
{
  ABI34_0_0RCTBaseTextInputShadowView *shadowTextView = (__bridge ABI34_0_0RCTBaseTextInputShadowView *)ABI34_0_0YGNodeGetContext(node);
  ...
  return ABI34_0_0RCTYogaFloatFromCoreGraphicsFloat(lastBaseline);
}
