...
#import "ABI34_0_0RCTUITextView.h"

#import <ReactABI34_0_0/ABI34_0_0RCTUtils.h>
#import <ReactABI34_0_0/UIView+ReactABI34_0_0.h>

#import "ABI34_0_0RCTBackedTextInputDelegateAdapter.h"

@implementation ABI34_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI34_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI34_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
  }
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  // see: https://github.com/facebook/ReactABI34_0_0-native/issues/19339
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI34_0_0RCTCeilPixelValue(placeholderSize.width), ABI34_0_0RCTCeilPixelValue(placeholderSize.height));
