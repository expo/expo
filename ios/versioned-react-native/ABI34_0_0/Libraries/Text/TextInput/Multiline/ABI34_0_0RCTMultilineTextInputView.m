...
@implementation ABI34_0_0RCTMultilineTextInputView
{
  ABI34_0_0RCTUITextView *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI34_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI34_0_0RCTUITextView alloc] initWithFrame:self.bounds];
...
{
  ABI34_0_0RCTDirectEventBlock onScroll = self.onScroll;
