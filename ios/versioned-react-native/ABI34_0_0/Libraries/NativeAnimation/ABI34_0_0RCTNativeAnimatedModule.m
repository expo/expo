 ...
 */
#import "ABI34_0_0RCTNativeAnimatedModule.h"

#import "ABI34_0_0RCTNativeAnimatedNodesManager.h"

typedef void (^AnimatedOperation)(ABI34_0_0RCTNativeAnimatedNodesManager *nodesManager);

@implementation ABI34_0_0RCTNativeAnimatedModule
{
  ABI34_0_0RCTNativeAnimatedNodesManager *_nodesManager;
...
- (void)setBridge:(ABI34_0_0RCTBridge *)bridge
{
  ...
  _nodesManager = [[ABI34_0_0RCTNativeAnimatedNodesManager alloc] initWithUIManager:self.bridge.uiManager];
...
ABI34_0_0RCT_EXPORT_METHOD(createAnimatedNode:(nonnull NSNumber *)tag
                  config:(NSDictionary<NSString *, id> *)config)
{
  [self addOperationBlock:^(ABI34_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager createAnimatedNode:tag config:config];
  }];
}

ABI34_0_0RCT_EXPORT_METHOD(connectAnimatedNodes:(nonnull NSNumber *)parentTag
...
ABI34_0_0RCT_EXPORT_METHOD(disconnectAnimatedNodes:(nonnull NSNumber *)parentTag
                  childTag:(nonnull NSNumber *)childTag)
{
  [self addOperationBlock:^(ABI34_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI34_0_0RCT_EXPORT_METHOD(startAnimatingNode:(nonnull NSNumber *)animationId
...
ABI34_0_0RCT_EXPORT_METHOD(stopAnimation:(nonnull NSNumber *)animationId)
{
  [self addOperationBlock:^(ABI34_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI34_0_0RCT_EXPORT_METHOD(setAnimatedNodeValue:(nonnull NSNumber *)nodeTag
...
ABI34_0_0RCT_EXPORT_METHOD(setAnimatedNodeOffset:(nonnull NSNumber *)nodeTag
...
ABI34_0_0RCT_EXPORT_METHOD(flattenAnimatedNodeOffset:(nonnull NSNumber *)nodeTag)
{
  [self addOperationBlock:^(ABI34_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI34_0_0RCT_EXPORT_METHOD(extractAnimatedNodeOffset:(nonnull NSNumber *)nodeTag)
{
  [self addOperationBlock:^(ABI34_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI34_0_0RCT_EXPORT_METHOD(connectAnimatedNodeToView:(nonnull NSNumber *)nodeTag
...
ABI34_0_0RCT_EXPORT_METHOD(disconnectAnimatedNodeFromView:(nonnull NSNumber *)nodeTag
                  viewTag:(nonnull NSNumber *)viewTag)
{
  [self addPreOperationBlock:^(ABI34_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI34_0_0RCT_EXPORT_METHOD(dropAnimatedNode:(nonnull NSNumber *)tag)
{
  [self addOperationBlock:^(ABI34_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI34_0_0RCT_EXPORT_METHOD(startListeningToAnimatedNodeValue:(nonnull NSNumber *)tag)
{
  __weak id<ABI34_0_0RCTValueAnimatedNodeObserver> valueObserver = self;
  [self addOperationBlock:^(ABI34_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager startListeningToAnimatedNodeValue:tag valueObserver:valueObserver];
  }];
}

ABI34_0_0RCT_EXPORT_METHOD(stopListeningToAnimatedNodeValue:(nonnull NSNumber *)tag)
{
  [self addOperationBlock:^(ABI34_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI34_0_0RCT_EXPORT_METHOD(addAnimatedEventToView:(nonnull NSNumber *)viewTag
...
ABI34_0_0RCT_EXPORT_METHOD(removeAnimatedEventFromView:(nonnull NSNumber *)viewTag
                  eventName:(nonnull NSString *)eventName
...
- (void)uiManagerWillPerformMounting:(ABI34_0_0RCTUIManager *)uiManager
{
  ...
  [uiManager prependUIBlock:^(__unused ABI34_0_0RCTUIManager *manager, __unused NSDictionary<NSNumber *, UIView *> *viewRegistry) {
