...
@implementation ABI34_0_0RCTModuloAnimatedNode
...
- (void)performUpdate
{
  ...
  ABI34_0_0RCTValueAnimatedNode *parent = (ABI34_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:inputNode];
