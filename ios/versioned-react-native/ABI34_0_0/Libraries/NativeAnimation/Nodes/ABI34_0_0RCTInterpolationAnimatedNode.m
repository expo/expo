...
@implementation ABI34_0_0RCTInterpolationAnimatedNode
{
  __weak ABI34_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI34_0_0RCTAnimatedNode *)parent
{
  [super onAttachedToNode:parent];
  if ([parent isKindOfClass:[ABI34_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI34_0_0RCTValueAnimatedNode *)parent;
  }
}

- (void)onDetachedFromNode:(ABI34_0_0RCTAnimatedNode *)parent
{
...
- (void)performUpdate
{
  ...
  self.value = ABI34_0_0RCTInterpolateValueInRange(inputValue,
                                          _inputRange,
                                          _outputRange,
                                          _extrapolateLeft,
                                          _extrapolateRight);
