...
@implementation ABI34_0_0RCTTrackingAnimatedNode {
...
- (void)performUpdate
{
  ...
  ABI34_0_0RCTValueAnimatedNode *node = (ABI34_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
