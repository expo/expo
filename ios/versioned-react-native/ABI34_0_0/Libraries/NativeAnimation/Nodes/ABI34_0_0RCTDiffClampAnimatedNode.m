...
@implementation ABI34_0_0RCTDiffClampAnimatedNode
{
...
{
  ABI34_0_0RCTValueAnimatedNode *inputNode = (ABI34_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI34_0_0RCTValueAnimatedNode class]]) {
    ABI34_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
