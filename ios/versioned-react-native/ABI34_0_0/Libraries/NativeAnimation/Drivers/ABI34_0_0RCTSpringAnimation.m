...
@interface ABI34_0_0RCTSpringAnimation ()
...
@implementation ABI34_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
                  ...
                  callBack:(nullable ABI34_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _lastVelocity = [ABI34_0_0RCTConvert CGFloat:config[@"initialVelocity"]];
...
- (void)resetAnimationConfig:(NSDictionary *)config
{
  ...
  _toValue = [ABI34_0_0RCTConvert CGFloat:config[@"toValue"]];
  _overshootClamping = [ABI34_0_0RCTConvert BOOL:config[@"overshootClamping"]];
  _restDisplacementThreshold = [ABI34_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
  _restSpeedThreshold = [ABI34_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
  _stiffness = [ABI34_0_0RCTConvert CGFloat:config[@"stiffness"]];
  _damping = [ABI34_0_0RCTConvert CGFloat:config[@"damping"]];
  _mass = [ABI34_0_0RCTConvert CGFloat:config[@"mass"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  if(_animationStartTime == -1) {
    ...
    _t = _t + deltaTime / ABI34_0_0RCTAnimationDragCoefficient();
  }
