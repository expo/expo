...
#import "ABI34_0_0RCTFileRequestHandler.h"

#import <MobileCoreServices/MobileCoreServices.h>

#import <ReactABI34_0_0/ABI34_0_0RCTUtils.h>

@implementation ABI34_0_0RCTFileRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  && !ABI34_0_0RCTIsBundleAssetURL(request.URL);
}

- (NSOperation *)sendRequest:(NSURLRequest *)request
                withDelegate:(id<ABI34_0_0RCTURLRequestDelegate>)delegate
{
  // Lazy setup
  if (!_fileQueue) {
