...
typedef void (^ABI34_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI34_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI34_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI34_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI34_0_0RCTImageCache <NSObject>
...
/**
 * If available, ABI34_0_0RCTImageRedirectProtocol is invoked before loading an asset.
 * Implementation should return either a new URL or nil when redirection is
 * not needed.
 */

@protocol ABI34_0_0RCTImageRedirectProtocol

- (NSURL *)redirectAssetsURL:(NSURL *)URL;

@end

@interface UIImage (ReactABI34_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI34_0_0KeyframeAnimation;
 ...
 */
@property (nonatomic, assign) NSInteger ReactABI34_0_0DecodedImageBytes;

@end

@interface ABI34_0_0RCTImageLoader : NSObject <ABI34_0_0RCTBridgeModule, ABI34_0_0RCTURLRequestHandler>
...
- (instancetype)init;
- (instancetype)initWithRedirectDelegate:(id<ABI34_0_0RCTImageRedirectProtocol>)redirectDelegate NS_DESIGNATED_INITIALIZER;
 ...
 */
- (ABI34_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                           clipped:(BOOL)clipped
                                        resizeMode:(ABI34_0_0RCTResizeMode)resizeMode
 ...
 * decoded images as long as it conforms to the ABI34_0_0RCTImageCache
...
@interface ABI34_0_0RCTBridge (ABI34_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI34_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI34_0_0RCTImageURLLoader <ABI34_0_0RCTBridgeModule>
...
/**
 * If more than one ABI34_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI34_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 */
@protocol ABI34_0_0RCTImageDataDecoder <ABI34_0_0RCTBridgeModule>
...
/**
 * If more than one ABI34_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
