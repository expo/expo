...
@interface ABI34_0_0RCTImageStoreManager : NSObject <ABI34_0_0RCTURLRequestHandler>
...
@interface ABI34_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI34_0_0RCTBridge (ABI34_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI34_0_0RCTImageStoreManager *imageStoreManager;
