...
@interface ABI34_0_0EXNativeAdView ()

@property (nonatomic, weak) ABI34_0_0UMModuleRegistry *moduleRegistry;

@end

@implementation ABI34_0_0EXNativeAdView
...
- (void)setOnAdLoaded:(ABI34_0_0UMDirectEventBlock)onAdLoaded
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    if (strongSelf) {
      [strongSelf.nativeAd registerViewForInteraction:strongSelf
                                            mediaView:mediaView
                                             iconView:adIconView
                                       viewController:[[strongSelf.moduleRegistry getModuleImplementingProtocol:@protocol(ABI34_0_0UMUtilitiesInterface)] currentViewController]
