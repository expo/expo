...
#import <ABI34_0_0EXWebBrowser/ABI34_0_0EXWebBrowser.h>
...
@interface ABI34_0_0EXWebBrowser () <SFSafariViewControllerDelegate>

@property (nonatomic, copy) ABI34_0_0UMPromiseResolveBlock redirectResolve;
@property (nonatomic, copy) ABI34_0_0UMPromiseRejectBlock redirectReject;
...
@implementation ABI34_0_0EXWebBrowser
{
  UIStatusBarStyle _initialStatusBarStyle;
}

ABI34_0_0UM_EXPORT_MODULE(ExpoWebBrowser)
...
ABI34_0_0UM_EXPORT_METHOD_AS(openAuthSessionAsync,
...
ABI34_0_0UM_EXPORT_METHOD_AS(openBrowserAsync,
                    ...
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  if([[arguments allKeys] containsObject:WebBrowserToolbarColorKey]) {
    safariVC.preferredBarTintColor = [ABI34_0_0EXWebBrowser convertHexColorString:arguments[WebBrowserToolbarColorKey]];
  }
  if([[arguments allKeys] containsObject:WebBrowserControlsColorKey]) {
    safariVC.preferredControlTintColor = [ABI34_0_0EXWebBrowser convertHexColorString:arguments[WebBrowserControlsColorKey]];
  }
...
ABI34_0_0UM_EXPORT_METHOD_AS(dismissBrowser,
                    dismissBrowserWithResolver:(ABI34_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  __weak typeof(self) weakSelf = self;
  UIViewController *currentViewController = [UIApplication sharedApplication].keyWindow.rootViewController;
...
ABI34_0_0UM_EXPORT_METHOD_AS(dismissAuthSession,
                    dismissAuthSessionWithResolver:(ABI34_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  if (@available(iOS 11, *)) {
    [_authSession cancel];
...
ABI34_0_0UM_EXPORT_METHOD_AS(warmUpAsync,
...
ABI34_0_0UM_EXPORT_METHOD_AS(coolDownAsync,
...
ABI34_0_0UM_EXPORT_METHOD_AS(getCustomTabsSupportingBrowsers,
                    getCustomTabsSupportingBrowsersWithPackage:(ABI34_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  // stub for jest-expo-mock-generator
}

ABI34_0_0UM_EXPORT_METHOD_AS(mayInitWithUrlAsync,
 ...
 */
- (BOOL)initializeWebBrowserWithResolver:(ABI34_0_0UMPromiseResolveBlock)resolve andRejecter:(ABI34_0_0UMPromiseRejectBlock)reject {
  if (_redirectResolve) {
...
+ (UIColor *)convertHexColorString:(NSString *)stringToConvert {
  ...
  return [ABI34_0_0EXWebBrowser colorWithRGBHex:hexNum];
}
