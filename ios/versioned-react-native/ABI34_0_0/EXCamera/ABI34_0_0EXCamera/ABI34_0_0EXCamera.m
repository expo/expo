...
#import <ABI34_0_0UMBarCodeScannerInterface/ABI34_0_0UMBarCodeScannerProviderInterface.h>
...
#import <ABI34_0_0UMFaceDetectorInterface/ABI34_0_0UMFaceDetectorManagerProvider.h>
...
@property (nonatomic, strong) id<ABI34_0_0UMFaceDetectorManager> faceDetectorManager;
@property (nonatomic, strong) id<ABI34_0_0UMBarCodeScannerInterface> barCodeScanner;
...
@property (nonatomic, strong) ABI34_0_0UMPromiseResolveBlock photoCapturedResolve;
@property (nonatomic, strong) ABI34_0_0UMPromiseRejectBlock photoCapturedReject;

@property (nonatomic, strong) ABI34_0_0UMPromiseResolveBlock videoRecordedResolve;
@property (nonatomic, strong) ABI34_0_0UMPromiseRejectBlock videoRecordedReject;

@property (nonatomic, copy) ABI34_0_0UMDirectEventBlock onCameraReady;
@property (nonatomic, copy) ABI34_0_0UMDirectEventBlock onMountError;
@property (nonatomic, copy) ABI34_0_0UMDirectEventBlock onPictureSaved;

@property (nonatomic, copy) ABI34_0_0UMDirectEventBlock onBarCodeScanned;
@property (nonatomic, copy) ABI34_0_0UMDirectEventBlock onFacesDetected;

@end

@implementation ABI34_0_0EXCamera
...
- (void)updateFlashMode
{
  ...
  if (_flashMode == ABI34_0_0EXCameraFlashModeTorch) {
    if (![device hasTorch]) {
      return;
    }
    ...
    if (![device lockForConfiguration:&error]) {
      if (error) {
        ABI34_0_0UMLogInfo(@"%s: %@", __func__, error);
      }
      return;
    }
...
- (void)updateFocusDepth
{
  ...
  if (device == nil || device.focusMode != ABI34_0_0EXCameraAutoFocusOff) {
    return;
  }
  ...
  if ([device isLockingFocusWithCustomLensPositionSupported]) {
    ...
    ABI34_0_0UM_WEAKIFY(device);
    [device setFocusModeLockedWithLensPosition:_focusDepth completionHandler:^(CMTime syncTime) {
      ABI34_0_0UM_ENSURE_STRONGIFY(device);
      [device unlockForConfiguration];
    }];
    return;
  }
  
  ABI34_0_0UMLogInfo(@"%s: Setting focusDepth isn't supported for this camera device", __func__);
  return;
}
...
- (void)updateWhiteBalance
{
  ...
  if (_whiteBalance == ABI34_0_0EXCameraWhiteBalanceAuto) {
    [device setWhiteBalanceMode:AVCaptureWhiteBalanceModeContinuousAutoWhiteBalance];
    [device unlockForConfiguration];
  } else {
    AVCaptureWhiteBalanceTemperatureAndTintValues temperatureAndTint = {
      .temperature = [ABI34_0_0EXCameraUtils temperatureForWhiteBalance:_whiteBalance],
      .tint = 0,
    };
...
- (void)takePicture:(NSDictionary *)options resolve:(ABI34_0_0UMPromiseResolveBlock)resolve reject:(ABI34_0_0UMPromiseRejectBlock)reject
{
  ...
  [connection setVideoOrientation:[ABI34_0_0EXCameraUtils videoOrientationForDeviceOrientation:[[UIDevice currentDevice] orientation]]];
  ...
  switch (_flashMode) {
    case ABI34_0_0EXCameraFlashModeOff:
      requestedFlashMode = AVCaptureFlashModeOff;
      break;
    case ABI34_0_0EXCameraFlashModeAuto:
      requestedFlashMode = AVCaptureFlashModeAuto;
      break;
    case ABI34_0_0EXCameraFlashModeOn:
    case ABI34_0_0EXCameraFlashModeTorch:
                ...
                error:(NSError *)error
{
  ...
  ABI34_0_0UMPromiseRejectBlock reject = _photoCapturedReject;
  ABI34_0_0UMPromiseResolveBlock resolve = _photoCapturedResolve;
...
- (void)handleCapturedImageData:(NSData *)imageData exifMetadata:(NSDictionary *)exifMetadata options:(NSDictionary *)options resolver:(ABI34_0_0UMPromiseResolveBlock)resolve
{
  ...
  takenImage = [ABI34_0_0EXCameraUtils cropImage:takenImage toRect:croppedSize];
  ...
  response[@"uri"] = [ABI34_0_0EXCameraUtils writeImage:takenImageData toPath:path];
  ...
  if ([options[@"exif"] boolValue]) {
    ...
    [ABI34_0_0EXCameraUtils updateExifMetadata:exifMetadata withAdditionalData:@{ @"Orientation": @(imageRotation) } inResponse:response]; // TODO
  }
...
- (void)record:(NSDictionary *)options resolve:(ABI34_0_0UMPromiseResolveBlock)resolve reject:(ABI34_0_0UMPromiseRejectBlock)reject
{
  ...
  if (_movieFileOutput != nil && !_movieFileOutput.isRecording && _videoRecordedResolve == nil && _videoRecordedReject == nil) {
    ...
    if (options[@"quality"]) {
      ABI34_0_0EXCameraVideoResolution resolution = [options[@"quality"] integerValue];
      preset = [ABI34_0_0EXCameraUtils captureSessionPresetForVideoResolution:resolution];
    ...
    if (connection.isVideoStabilizationSupported == NO) {
      ABI34_0_0UMLogWarn(@"%s: Video Stabilization is not supported on this device.", __func__);
    } else {
...
- (void)initializeCaptureSessionInput
{
  ...
  AVCaptureVideoOrientation orientation = [ABI34_0_0EXCameraUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI34_0_0EXCameraUtils deviceWithMediaType:AVMediaTypeVideo preferringPosition:self.presetCamera];
...
{
  ABI34_0_0UM_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI34_0_0EXCameraUtils videoOrientationForInterfaceOrientation:orientation];
  [ABI34_0_0UMUtilities performSynchronouslyOnMainThread:^{
    ABI34_0_0UM_ENSURE_STRONGIFY(self);
...
{
  id <ABI34_0_0UMFaceDetectorManagerProvider> faceDetectorProvider = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI34_0_0UMFaceDetectorManagerProvider)];
  
  if (faceDetectorProvider) {
    id <ABI34_0_0UMFaceDetectorManager> faceDetector = [faceDetectorProvider createFaceDetectorManager];
    if (faceDetector) {
      ABI34_0_0UM_WEAKIFY(self);
...
{
  id<ABI34_0_0UMBarCodeScannerProviderInterface> barCodeScannerProvider = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI34_0_0UMBarCodeScannerProviderInterface)];
  if (barCodeScannerProvider) {
    id<ABI34_0_0UMBarCodeScannerInterface> barCodeScanner = [barCodeScannerProvider createBarCodeScanner];
    if (barCodeScanner) {
      ABI34_0_0UM_WEAKIFY(self);
