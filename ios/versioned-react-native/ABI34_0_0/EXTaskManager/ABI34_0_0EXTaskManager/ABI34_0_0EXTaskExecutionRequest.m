...
@interface ABI34_0_0EXTaskExecutionRequest ()

@property (nonatomic, strong, nullable) NSMutableSet<id<ABI34_0_0UMTaskInterface>> *tasks;
...
@implementation ABI34_0_0EXTaskExecutionRequest
...
- (void)_maybeExecuteCallback
{
  if (_callback) {
    ...
    __strong ABI34_0_0EXTaskExecutionRequest *strongSelf = self;
