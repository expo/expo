...
@interface ABI34_0_0EXUtil ()

@property (nonatomic, weak) id<ABI34_0_0EXUtilService> kernelUtilService;

@end

ABI34_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI34_0_0EXUtil, util)

@implementation ABI34_0_0EXUtil

ABI34_0_0EX_EXPORT_SCOPED_MODULE(ExponentUtil, UtilService);

- (instancetype)initWithExperienceId:(NSString *)experienceId kernelServiceDelegate:(id<ABI34_0_0EXUtilService>)kernelServiceInstance params:(NSDictionary *)params
{
