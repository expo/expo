...
@implementation ABI34_0_0RCTConvert (AirMap)
...
{
    json = [self NSDictionary:json];
    return [ABI34_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:nil];
}
...
ABI34_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI34_0_0AIRMapCoordinate *)ABI34_0_0AIRMapCoordinate:(id)json
{
    ABI34_0_0AIRMapCoordinate *coord = [ABI34_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI34_0_0RCT_ARRAY_CONVERTER(ABI34_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI34_0_0AIRMapCoordinate *> *> *)ABI34_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI34_0_0RCTConvertArrayValue(@selector(ABI34_0_0AIRMapCoordinateArray:), json);
}
