...
#import "ABI34_0_0AIRMapOverlayRenderer.h"

@class ABI34_0_0RCTBridge;

@interface ABI34_0_0AIRMapOverlay : UIView <MKOverlay>

@property (nonatomic, strong) ABI34_0_0AIRMapOverlayRenderer *renderer;
