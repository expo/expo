#import "ABI34_0_0RNForceTouchHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ReactABI34_0_0/ABI34_0_0RCTConvert.h>

@interface ABI34_0_0RNForceTouchGestureRecognizer : UIGestureRecognizer
...
@implementation ABI34_0_0RNForceTouchGestureRecognizer {
...
@implementation ABI34_0_0RNForceTouchHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI34_0_0RNForceTouchGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI34_0_0RNForceTouchGestureRecognizer *recognizer = (ABI34_0_0RNForceTouchGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    recognizer.feedbackOnActivation = [ABI34_0_0RCTConvert BOOL:prop];
  }
}

- (ABI34_0_0RNGestureHandlerEventExtraData *)eventExtraData:(ABI34_0_0RNForceTouchGestureRecognizer *)recognizer
{
