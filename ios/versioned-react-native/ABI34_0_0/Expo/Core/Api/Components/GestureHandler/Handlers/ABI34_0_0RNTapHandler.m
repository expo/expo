...
#import "ABI34_0_0RNTapHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ReactABI34_0_0/ABI34_0_0RCTConvert.h>

// ABI34_0_0RNBetterTapGestureRecognizer extends UIGestureRecognizer instead of UITapGestureRecognizer 
...
@interface ABI34_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
- (id)initWithGestureHandler:(ABI34_0_0RNGestureHandler*)gestureHandler;

@end

@implementation ABI34_0_0RNBetterTapGestureRecognizer {
  __weak ABI34_0_0RNGestureHandler *_gestureHandler;
...
@implementation ABI34_0_0RNTapGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI34_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI34_0_0RNBetterTapGestureRecognizer *recognizer = (ABI34_0_0RNBetterTapGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    recognizer.maxDelay = [ABI34_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDurationMs"];
  if (prop != nil) {
    recognizer.maxDuration = [ABI34_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDist"];
  if (prop != nil) {
    CGFloat dist = [ABI34_0_0RCTConvert CGFloat:prop];
