//
//  ABI34_0_0RNNativeViewHandler.m
...
#import "ABI34_0_0RNNativeViewHandler.h"
...
#pragma mark ABI34_0_0RNDummyGestureRecognizer

@implementation ABI34_0_0RNDummyGestureRecognizer
...
#pragma mark ABI34_0_0RNNativeViewgestureHandler

@implementation ABI34_0_0RNNativeViewGestureHandler {
...
- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI34_0_0RNDummyGestureRecognizer alloc] init];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    _shouldActivateOnStart = [ABI34_0_0RCTConvert BOOL:config[@"shouldActivateOnStart"]];
    _disallowInterruption = [ABI34_0_0RCTConvert BOOL:config[@"disallowInterruption"]];
}
...
- (void)bindToView:(UIView *)view
{
    ...
    if ([view isKindOfClass:[ABI34_0_0RCTScrollView class]]) {
        // This part of the code is coupled with ABI34_0_0RN implementation of ScrollView native wrapper and
        // we expect for ABI34_0_0RCTScrollView component to contain a subclass of UIScrollview as the only
        // subview
...
- (void)handleTouchDown:(UIView *)sender forEvent:(UIEvent *)event
{
    ...
    [self sendEventsInState:ABI34_0_0RNGestureHandlerStateActive
             forViewWithTag:sender.ReactABI34_0_0Tag
              withExtraData:[ABI34_0_0RNGestureHandlerEventExtraData forPointerInside:YES]];
}

- (void)handleTouchUpOutside:(UIView *)sender forEvent:(UIEvent *)event
{
    [self sendEventsInState:ABI34_0_0RNGestureHandlerStateEnd
             forViewWithTag:sender.ReactABI34_0_0Tag
              withExtraData:[ABI34_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
...
{
    [self sendEventsInState:ABI34_0_0RNGestureHandlerStateCancelled
             forViewWithTag:sender.ReactABI34_0_0Tag
              withExtraData:[ABI34_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
