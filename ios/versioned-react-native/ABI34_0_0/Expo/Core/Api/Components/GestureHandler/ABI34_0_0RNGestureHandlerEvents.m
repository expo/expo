#import "ABI34_0_0RNGestureHandlerEvents.h"

#define SAFE_VELOCITY(velocity) @(isnan(velocity) ? 0 : velocity)

@implementation ABI34_0_0RNGestureHandlerEventExtraData
...
{
    return [[ABI34_0_0RNGestureHandlerEventExtraData alloc]
            initWithData:@{
                           @"x": @(position.x),
                           @"y": @(position.y),
...
@implementation ABI34_0_0RNGestureHandlerEvent
{
    NSNumber *_handlerTag;
    ABI34_0_0RNGestureHandlerState _state;
    ABI34_0_0RNGestureHandlerEventExtraData *_extraData;
}
...
- (instancetype)initWithRactTag:(NSNumber *)ReactABI34_0_0Tag
                     handlerTag:(NSNumber *)handlerTag
                      ...
                      extraData:(ABI34_0_0RNGestureHandlerEventExtraData *)extraData
{
...
@implementation ABI34_0_0RNGestureHandlerStateChange
{
    NSNumber *_handlerTag;
    ABI34_0_0RNGestureHandlerState _state;
    ABI34_0_0RNGestureHandlerState _prevState;
    ABI34_0_0RNGestureHandlerEventExtraData *_extraData;
}
