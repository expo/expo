//
//  ABI34_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI34_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI34_0_0RNGestureHandler *otherHandler = [ABI34_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI34_0_0RCTTouchHandler class]];
}
