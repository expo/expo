...
@class ABI34_0_0RNCWKWebView;

@protocol ABI34_0_0RNCWKWebViewDelegate <NSObject>
...
@interface ABI34_0_0RNCWKWebView : ABI34_0_0RCTView

@property (nonatomic, strong) NSString *experienceId;

@property (nonatomic, weak) id<ABI34_0_0RNCWKWebViewDelegate> delegate;
