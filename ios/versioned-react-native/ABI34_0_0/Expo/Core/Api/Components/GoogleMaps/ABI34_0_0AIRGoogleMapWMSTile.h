//
//  ABI34_0_0AIRGoogleMapWMSTile.h
//  AirMaps
//
...
@interface ABI34_0_0WMSTileOverlay : GMSSyncTileLayer
...
@interface ABI34_0_0AIRGoogleMapWMSTile : UIView
@property (nonatomic, strong) ABI34_0_0WMSTileOverlay *tileLayer;
