...
@interface ABI34_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI34_0_0AIRGMSMarker*)marker;
@end

@implementation ABI34_0_0AIRGoogleMapMarker {
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI34_0_0AIRGMSMarker alloc] init];
...
- (void)insertReactABI34_0_0Subview:(id<ABI34_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI34_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI34_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI34_0_0AIRDummyView *dummySubview = [[ABI34_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertReactABI34_0_0Subview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeReactABI34_0_0Subview:(id<ABI34_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI34_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeReactABI34_0_0Subview:(UIView*)dummySubview];
}
...
- (void)setOnPress:(ABI34_0_0RCTBubblingEventBlock)onPress {
  _realMarker.onPress = onPress;
}

- (ABI34_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/ReactABI34_0_0-native-community/ReactABI34_0_0-native-maps/issues/738)
  ...
  _reloadImageCancellationBlock = [_bridge.imageLoader loadImageWithURLRequest:[ABI34_0_0RCTConvert NSURLRequest:_imageSrc]
                                                                          size:self.bounds.size
                                                                         scale:ABI34_0_0RCTScreenScale()
                                                                       clipped:YES
                                                                    resizeMode:ABI34_0_0RCTResizeModeCenter
                                                                 progressBlock:nil
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI34_0_0RN?
...
- (void)setIconSrc:(NSString *)iconSrc
{
  ...
  _reloadImageCancellationBlock =
  [_bridge.imageLoader loadImageWithURLRequest:[ABI34_0_0RCTConvert NSURLRequest:_iconSrc]
                                          size:self.bounds.size
                                         scale:ABI34_0_0RCTScreenScale()
                                       clipped:YES
                                    resizeMode:ABI34_0_0RCTResizeModeCenter
