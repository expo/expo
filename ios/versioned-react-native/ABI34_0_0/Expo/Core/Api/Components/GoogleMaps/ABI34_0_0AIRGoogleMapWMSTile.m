//
//  ABI34_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI34_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI34_0_0WMSTileOverlay *tile = [[ABI34_0_0WMSTileOverlay alloc] init];
...
@implementation ABI34_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
