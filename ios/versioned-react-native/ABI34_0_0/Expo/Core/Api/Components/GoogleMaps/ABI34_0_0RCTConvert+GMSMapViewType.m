//
//  ABI34_0_0RCTConvert+GMSMapViewType.m
//
...
@implementation ABI34_0_0RCTConvert (GMSMapViewType)
  ABI34_0_0RCT_ENUM_CONVERTER(GMSMapViewType,
  (
    @{
...
+ (GMSCameraPosition*)GMSCameraPosition:(id)json
{
    ...
    return [ABI34_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:nil];
}
