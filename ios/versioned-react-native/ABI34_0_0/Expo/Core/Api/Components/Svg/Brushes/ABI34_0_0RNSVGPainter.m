...
@implementation ABI34_0_0RNSVGPainter
{
    NSArray<ABI34_0_0RNSVGLength *> *_points;
    NSArray<NSNumber *> *_colors;
    ABI34_0_0RNSVGBrushType _type;
...
- (instancetype)initWithPointsArray:(NSArray<ABI34_0_0RNSVGLength *> *)pointsArray
{
    if ((self = [super init])) {
        _points = pointsArray;
    }
...
- (void)setPattern:(ABI34_0_0RNSVGPattern *)pattern
{
...
void ABI34_0_0PatternFunction(void* info, CGContextRef context)
{
    ABI34_0_0RNSVGPainter *_painter = (__bridge ABI34_0_0RNSVGPainter *)info;
    ABI34_0_0RNSVGPattern *_pattern = [_painter pattern];
    ...
    if (vbWidth > 0 && vbHeight > 0) {
        ...
        CGAffineTransform _viewBoxTransform = [ABI34_0_0RNSVGViewBox
                                               getTransform:vbRect
                                               eRect:rect
...
- (CGFloat)getVal:(ABI34_0_0RNSVGLength*)length relative:(CGFloat)relative
{
    ABI34_0_0RNSVGLengthUnitType unit = [length unit];
...
- (void)paintPattern:(CGContextRef)context bounds:(CGRect)bounds
{
    ...
    const CGPatternCallbacks callbacks = { 0, &ABI34_0_0PatternFunction, NULL };
...
- (void)paintLinearGradient:(CGContextRef)context bounds:(CGRect)bounds
{
    ...
    CGGradientRef gradient = CGGradientRetain([ABI34_0_0RCTConvert ABI34_0_0RNSVGCGGradient:_colors]);
    ...
    CGFloat x1 = [ABI34_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:0]
                                                relative:width
                                                  offset:offsetX];
    CGFloat y1 = [ABI34_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:1]
                                                relative:height
                                                  offset:offsetY];
    CGFloat x2 = [ABI34_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:2]
                                                relative:width
                                                  offset:offsetX];
    CGFloat y2 = [ABI34_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:3]
                                                relative:height
                                                  offset:offsetY];
...
- (void)paintRadialGradient:(CGContextRef)context bounds:(CGRect)bounds
{
    ...
    CGFloat rx = [ABI34_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:2]
                                                relative:width
                                                  offset:0];
    CGFloat ry = [ABI34_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:3]
                                                relative:height
                                                  offset:0];
    CGFloat fx = [ABI34_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:0]
                                                relative:width
                                                  offset:offsetX];
    CGFloat fy = [ABI34_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:1]
                                                relative:height
                                                  offset:offsetY] / (ry / rx);
    CGFloat cx = [ABI34_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:4]
                                                relative:width
                                                  offset:offsetX];
    CGFloat cy = [ABI34_0_0RNSVGPercentageConverter lengthToFloat:[_points objectAtIndex:5]
                                                relative:height
                                                  offset:offsetY] / (ry / rx);
