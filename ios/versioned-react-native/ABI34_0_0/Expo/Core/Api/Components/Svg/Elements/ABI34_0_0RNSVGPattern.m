...
@implementation ABI34_0_0RNSVGPattern
...
{
    self.dirty = false;
    NSArray<ABI34_0_0RNSVGLength *> *points = @[self.x, self.y, self.patternwidth, self.patternheight];
...
- (void)setPatternwidth:(ABI34_0_0RNSVGLength *)patternwidth
{
...
- (void)setPatternheight:(ABI34_0_0RNSVGLength *)patternheight
{
...
- (void)setPatternUnits:(ABI34_0_0RNSVGUnits)patternUnits
{
...
- (void)setPatternContentUnits:(ABI34_0_0RNSVGUnits)patternContentUnits
{
