...
@implementation ABI34_0_0RNSVGRadialGradient

- (void)setFx:(ABI34_0_0RNSVGLength *)fx
{
    if ([fx isEqualTo:_fx]) {
        return;
    }
...
- (void)setFy:(ABI34_0_0RNSVGLength *)fy
{
    if ([fy isEqualTo:_fy]) {
        return;
    }
...
- (void)setCx:(ABI34_0_0RNSVGLength *)cx
{
    if ([cx isEqualTo:_cx]) {
        return;
    }
...
- (void)setCy:(ABI34_0_0RNSVGLength *)cy
{
    if ([cy isEqualTo:_cy]) {
        return;
    }
...
- (void)setGradientUnits:(ABI34_0_0RNSVGUnits)gradientUnits
{
...
{
    self.dirty = false;
    NSArray<ABI34_0_0RNSVGLength *> *points = @[self.fx, self.fy, self.rx, self.ry, self.cx, self.cy];
    ABI34_0_0RNSVGPainter *painter = [[ABI34_0_0RNSVGPainter alloc] initWithPointsArray:points];
