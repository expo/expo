...
static NSCharacterSet *ABI34_0_0RNSVGTSpan_separators = nil;
static CGFloat ABI34_0_0RNSVGTSpan_radToDeg = 180 / (CGFloat)M_PI;

@implementation ABI34_0_0RNSVGTSpan
{
    CGFloat startOffset;
    CGFloat _pathLength;
    ABI34_0_0RNSVGTextPath *textPath;
    NSArray *lengths;
    NSArray *lines;
...
- (id)init
{
    ...
    if (ABI34_0_0RNSVGTSpan_separators == nil) {
        ABI34_0_0RNSVGTSpan_separators = [NSCharacterSet whitespaceCharacterSet];
    }
...
- (CGFloat)getSubtreeTextChunksTotalAdvance
{
    ...
    ABI34_0_0RNSVGGlyphContext* gc = [self.textRoot getGlyphContext];
    ABI34_0_0RNSVGFontData* font = [gc getFont];

    CGFloat letterSpacing = font->letterSpacing;
    CGFloat kerning = font->kerning;

    bool allowOptionalLigatures = letterSpacing == 0 && font->fontVariantLigatures == ABI34_0_0RNSVGFontVariantLigaturesNormal;
...
- (CGPathRef)getLinePath:(NSString *)str context:(CGContextRef)context
{
     ...
     */
    enum ABI34_0_0RNSVGTextAnchor textAnchor = font->textAnchor;
    ABI34_0_0RNSVGText *anchorRoot = [self getTextAnchorRoot];
    CGFloat textMeasure = [anchorRoot getSubtreeTextChunksTotalAdvance];
    CGFloat offset = [ABI34_0_0RNSVGTSpan getTextAnchorOffset:textAnchor width:textMeasure];
    ...
    if (hasTextPath) {
        //sharpMidLine = ABI34_0_0RNSVGTextPathMidLineFromString([textPath midLine]) == ABI34_0_0RNSVGTextPathMidLineSharp;
        /*
         Name
         side
         Value
         ...
         */
        side = ABI34_0_0RNSVGTextPathSideFromString([textPath side]) == ABI34_0_0RNSVGTextPathSideRight ? -1 : 1;
        /*
         Name
         startOffset
         Value
         ...
         the path is reached.
         */
        CGFloat absoluteStartOffset = [ABI34_0_0RNSVGPropHelper fromRelative:textPath.startOffset
                                                          relative:_pathLength
                                                          fontSize:fontSize];
        offset += absoluteStartOffset;
        if (isClosed) {
            CGFloat halfPathDistance = _pathLength / 2;
            startOfRendering = absoluteStartOffset + (textAnchor == ABI34_0_0RNSVGTextAnchorMiddle ? -halfPathDistance : 0);
            endOfRendering = startOfRendering + _pathLength;
        }
        /*
         ABI34_0_0RNSVGTextPathSpacing spacing = textPath.getSpacing();
         if (spacing == ABI34_0_0RNSVGTextPathSpacing.auto) {
         // Hmm, what to do here?
    ...
    ABI34_0_0RNSVGLength *mTextLength = [self textLength];
    enum ABI34_0_0RNSVGTextLengthAdjust mLengthAdjust = ABI34_0_0RNSVGTextLengthAdjustFromString([self lengthAdjust]);
    if (mTextLength != nil) {
        CGFloat author = [ABI34_0_0RNSVGPropHelper fromRelative:mTextLength
        ...
        switch (mLengthAdjust) {
            default:
            case ABI34_0_0RNSVGTextLengthAdjustSpacing:
                // TODO account for ligatures
                letterSpacing += (author - textMeasure) / (n - 1);
                break;
            case ABI34_0_0RNSVGTextLengthAdjustSpacingAndGlyphs:
    ...
    */
    ...
    enum ABI34_0_0RNSVGAlignmentBaseline baseline = ABI34_0_0RNSVGAlignmentBaselineFromString(self.alignmentBaseline);
    if (baseline != ABI34_0_0RNSVGAlignmentBaselineBaseline) {
        ...
        switch (baseline) {
            ...
            default:
            case ABI34_0_0RNSVGAlignmentBaselineBaseline:
                // Use the dominant baseline choice of the parent.
                // Match the box’s corresponding baseline to that of its parent.
                baselineShift = 0;
                break;

            case ABI34_0_0RNSVGAlignmentBaselineTextBottom:
            case ABI34_0_0RNSVGAlignmentBaselineAfterEdge:
            case ABI34_0_0RNSVGAlignmentBaselineTextAfterEdge:
            ...
            case ABI34_0_0RNSVGAlignmentBaselineCentral:
            ...
            case ABI34_0_0RNSVGAlignmentBaselineMathematical:
            ...
            case ABI34_0_0RNSVGAlignmentBaselineHanging:
                baselineShift = (CGFloat)0.8 * ascenderHeight;
                break;

            case ABI34_0_0RNSVGAlignmentBaselineTextTop:
            case ABI34_0_0RNSVGAlignmentBaselineBeforeEdge:
            case ABI34_0_0RNSVGAlignmentBaselineTextBeforeEdge:
            ...
            case ABI34_0_0RNSVGAlignmentBaselineBottom:
                // Align the top of the aligned subtree with the top of the line box.
                baselineShift = bottom;
                break;

            case ABI34_0_0RNSVGAlignmentBaselineCenter:
                // Align the center of the aligned subtree with the center of the line box.
                baselineShift = totalHeight / 2;
                break;

            case ABI34_0_0RNSVGAlignmentBaselineTop:
        ...
        switch (baseline) {
            ...
            default:
                if (fontData != nil && [baselineShiftString isEqualToString:@"sub"]) {
                    ...
                    baselineShift -= [ABI34_0_0RNSVGPropHelper fromRelativeWithNSString:baselineShiftString
                                                                   relative:fontSize
                                                                   fontSize:fontSize];
                }
                break;
    ...
    for (CFIndex r = 0; r < runEnd; r++) {
        ...
        for(CFIndex g = 0; g < runGlyphCount; g++) {
            ...
            bool isWordSeparator = [ABI34_0_0RNSVGTSpan_separators characterIsMember:currentChar];
            ...
            CGFloat r = [gc nextRotation] / ABI34_0_0RNSVGTSpan_radToDeg;
...
+ (CGFloat)getTextAnchorOffset:(ABI34_0_0RNSVGTextAnchor)textAnchor width:(CGFloat) width
{
    switch (textAnchor) {
        case ABI34_0_0RNSVGTextAnchorStart:
            return 0;
        case ABI34_0_0RNSVGTextAnchorMiddle:
            return -width / 2;
        case ABI34_0_0RNSVGTextAnchorEnd:
            return -width;
    }
...
- (void)setupTextPath:(CGContextRef)context
{
    ...
    lengths = nil;
    textPath = nil;
    ABI34_0_0RNSVGText *parent = (ABI34_0_0RNSVGText*)[self superview];

    while (parent) {
        if ([parent class] == [ABI34_0_0RNSVGTextPath class]) {
            textPath = (ABI34_0_0RNSVGTextPath*) parent;
            [textPath getPathLength:&_pathLength
                          lineCount:&lineCount
                           ...
                           isClosed:&isClosed];
            break;
        } else if (![parent isKindOfClass:[ABI34_0_0RNSVGText class]]) {
            break;
        }

        parent = (ABI34_0_0RNSVGText*)[parent superview];
    }
}
