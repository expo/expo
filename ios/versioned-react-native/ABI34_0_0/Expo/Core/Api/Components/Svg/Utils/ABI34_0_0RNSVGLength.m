...
@implementation ABI34_0_0RNSVGLength
...
{
    ABI34_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype) lengthWithString: (NSString *) lengthString {
    ...
    ABI34_0_0RNSVGLength *output = [ABI34_0_0RNSVGLength alloc];
    if (stringLength == 0) {
        ...
        ABI34_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
