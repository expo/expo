#import "ABI34_0_0REAClockNodes.h"
#import "ABI34_0_0REANodesManager.h"

@interface ABI34_0_0REAClockNode ()
...
@implementation ABI34_0_0REAClockNode
...
- (void)start
{
  ...
  __weak ABI34_0_0REAClockNode *weakSelf = self;
...
@implementation ABI34_0_0REAClockOpNode {
...
- (ABI34_0_0REAClockNode*)clockNode
{
  return (ABI34_0_0REAClockNode*)[self.nodesManager findNodeByID:_clockNodeID];
}

@end

@implementation ABI34_0_0REAClockStartNode
...
@implementation ABI34_0_0REAClockStopNode
...
@implementation ABI34_0_0REAClockTestNode
