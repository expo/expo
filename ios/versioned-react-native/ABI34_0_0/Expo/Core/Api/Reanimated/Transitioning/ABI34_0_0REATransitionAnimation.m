...
CGFloat ABI34_0_0SimAnimationDragCoefficient()
{
#if TARGET_IPHONE_SIMULATOR
...
@implementation ABI34_0_0REATransitionAnimation {
  NSTimeInterval _delay;
}

+ (ABI34_0_0REATransitionAnimation *)transitionWithAnimation:(CAAnimation *)animation
                                              layer:(CALayer *)layer
                                         andKeyPath:(NSString*)keyPath;
{
  ABI34_0_0REATransitionAnimation *anim = [ABI34_0_0REATransitionAnimation new];
...
- (void)play
{
  _animation.duration = self.duration * ABI34_0_0SimAnimationDragCoefficient();
  _animation.beginTime = CACurrentMediaTime() + _delay * ABI34_0_0SimAnimationDragCoefficient();
