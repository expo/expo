...
@interface ABI34_0_0EXSensorsManagerBinding ()

@property (nonatomic, strong) NSString *experienceId;
@property (nonatomic, weak) id<ABI34_0_0EXSensorsManagerBindingDelegate> kernelService;

@end

@implementation ABI34_0_0EXSensorsManagerBinding
