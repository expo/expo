...
@interface ABI34_0_0EXExpoUserNotificationCenterProxy ()

@property (nonatomic, weak) id<ABI34_0_0UMUserNotificationCenterProxyInterface> userNotificationCenter;

@end

@implementation ABI34_0_0EXExpoUserNotificationCenterProxy
