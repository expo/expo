...
@interface ABI34_0_0EXGLARSessionManager : NSObject

@property (nonatomic, weak) id<ABI34_0_0EXGLARSessionManagerDelegate> delegate;
...
- (NSDictionary *)startWithGLView:(ABI34_0_0EXGLView *)glView trackingConfiguration:(NSString *) trackingConfiguration;
