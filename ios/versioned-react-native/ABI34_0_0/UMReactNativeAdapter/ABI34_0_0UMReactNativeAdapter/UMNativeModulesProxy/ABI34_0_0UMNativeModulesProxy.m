...
@interface ABI34_0_0UMNativeModulesProxy ()

@property (nonatomic, strong) NSRegularExpression *regexp;
@property (nonatomic, strong) ABI34_0_0UMModuleRegistry *moduleRegistry;
...
@implementation ABI34_0_0UMNativeModulesProxy
...
# pragma mark - ReactABI34_0_0 API
...
- (NSDictionary *)constantsToExport
{
  ...
  NSArray<ABI34_0_0UMViewManager *> *viewManagers = [_moduleRegistry getAllViewManagers];
...
ABI34_0_0RCT_EXPORT_METHOD(callMethod:(NSString *)moduleName methodNameOrKey:(id)methodNameOrKey arguments:(NSArray *)arguments resolver:(ABI34_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI34_0_0RCTPromiseRejectBlock)reject)
{
