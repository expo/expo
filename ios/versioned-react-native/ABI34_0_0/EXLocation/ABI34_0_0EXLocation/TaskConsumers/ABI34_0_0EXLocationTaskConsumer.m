...
@interface ABI34_0_0EXLocationTaskConsumer ()
...
@implementation ABI34_0_0EXLocationTaskConsumer
...
# pragma mark - ABI34_0_0UMTaskConsumerInterface
...
- (void)setOptions:(NSDictionary *)options
{
  [ABI34_0_0UMUtilities performSynchronouslyOnMainThread:^{
    ...
    locationManager.desiredAccuracy = [ABI34_0_0EXLocation CLLocationAccuracyFromOption:accuracy];
    locationManager.distanceFilter = [options[@"distanceInterval"] doubleValue] ?: kCLDistanceFilterNone;
    locationManager.activityType = [ABI34_0_0EXLocation CLActivityTypeFromOption:[options[@"activityType"] integerValue]];
...
- (void)executeTaskWithDeferredLocations
{
  ...
  NSDictionary *data = @{ @"locations": [ABI34_0_0EXLocationTaskConsumer _exportLocations:_deferredLocations] };
...
+ (NSArray<NSDictionary *> *)_exportLocations:(NSArray<CLLocation *> *)locations
{
  ...
  for (CLLocation *location in locations) {
    [result addObject:[ABI34_0_0EXLocation exportLocation:location]];
  }
  return result;
}
