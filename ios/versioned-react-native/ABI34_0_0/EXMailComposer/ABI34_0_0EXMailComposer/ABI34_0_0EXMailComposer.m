...
#import <ABI34_0_0EXMailComposer/ABI34_0_0EXMailComposer.h>
...
@interface ABI34_0_0EXMailComposer ()
...
@implementation ABI34_0_0EXMailComposer

ABI34_0_0UM_EXPORT_MODULE(ExpoMailComposer);
...
ABI34_0_0UM_EXPORT_METHOD_AS(composeAsync,
                    ...
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  self.reject = reject;
  id<ABI34_0_0UMUtilitiesInterface> utilities = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI34_0_0UMUtilitiesInterface)];
