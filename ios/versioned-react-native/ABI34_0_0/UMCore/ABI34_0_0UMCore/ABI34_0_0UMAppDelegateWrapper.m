...
@implementation ABI34_0_0UMAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitialized {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI34_0_0UMSingletonModule*> * singletonModules = [[ABI34_0_0UMModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI34_0_0UMSingletonModule *singletonModule in singletonModules) {
