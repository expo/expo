...
#import <ABI34_0_0EXCrypto/ABI34_0_0EXCrypto.h>
#import <CommonCrypto/CommonDigest.h>

@implementation ABI34_0_0EXCrypto

ABI34_0_0UM_EXPORT_MODULE(ExpoCrypto);

ABI34_0_0UM_EXPORT_METHOD_AS(digestStringAsync,
                    ...
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  int digestLength = [ABI34_0_0EXCrypto digestLengthForJSAlgorithm:algorithm];
  if (digestLength == -1) {
