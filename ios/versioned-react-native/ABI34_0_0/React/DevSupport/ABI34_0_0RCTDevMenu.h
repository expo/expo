...
ABI34_0_0RCT_EXTERN NSString *const ABI34_0_0RCTShowDevMenuNotification;

#endif


@class ABI34_0_0RCTDevMenuItem;

/**
 * Developer menu, useful for exposing extra functionality when debugging.
 */
@interface ABI34_0_0RCTDevMenu : NSObject

/**
 * Deprecated, use ABI34_0_0RCTDevSettings instead.
 */
 ...
 */
@property (nonatomic, copy, readonly) NSArray<ABI34_0_0RCTDevMenuItem *> *presentedItems;
...
/**
 * Deprecated, use -[ABI34_0_0RCTBRidge reload] instead.
 */
...
typedef NSString *(^ABI34_0_0RCTDevMenuItemTitleBlock)(void);

/**
 * Developer menu item, used to expose additional functionality via the menu.
 */
@interface ABI34_0_0RCTDevMenuItem : NSObject
 ...
 */
+ (instancetype)buttonItemWithTitleBlock:(ABI34_0_0RCTDevMenuItemTitleBlock)titleBlock
                                 handler:(dispatch_block_t)handler;
 ...
 * ABI34_0_0RCTBridge, which is useful for any class that needs to access the menu.
 */
@interface ABI34_0_0RCTBridge (ABI34_0_0RCTDevMenu)

@property (nonatomic, readonly) ABI34_0_0RCTDevMenu *devMenu;
