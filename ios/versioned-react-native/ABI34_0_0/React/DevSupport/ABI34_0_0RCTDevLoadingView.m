...
#import "ABI34_0_0RCTDevLoadingView.h"
...
#if ABI34_0_0RCT_DEV | ABI34_0_0RCT_ENABLE_LOADING_VIEW

static BOOL isEnabled = YES;

@implementation ABI34_0_0RCTDevLoadingView
{
  UIWindow *_window;
  UILabel *_label;
  NSDate *_showDate;
...
- (void)setBridge:(ABI34_0_0RCTBridge *)bridge
{
  ...
  [[NSNotificationCenter defaultCenter] addObserver:self
                                           selector:@selector(hide)
                                               name:ABI34_0_0RCTJavaScriptDidFailToLoadNotification
                                             object:nil];
...
ABI34_0_0RCT_EXPORT_METHOD(showMessage:(NSString *)message color:(UIColor *)color backgroundColor:(UIColor *)backgroundColor)
{
  if (!isEnabled) {
    return;
  }
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    if (!self->_window && !ABI34_0_0RCTRunningInTestEnvironment()) {
