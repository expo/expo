...
#import "ABI34_0_0RCTWrapperViewController.h"
...
#import "ABI34_0_0RCTAutoInsetsProtocol.h"

@implementation ABI34_0_0RCTWrapperViewController
{
  UIView *_wrapperView;
  UIView *_contentView;
  ABI34_0_0RCTEventDispatcher *_eventDispatcher;
...
{
  ABI34_0_0RCTAssertParam(contentView);
...
ABI34_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithNibName:(NSString *)nn bundle:(NSBundle *)nb)
...
static BOOL ABI34_0_0RCTFindScrollViewAndRefreshContentInsetInView(UIView *view)
{
  if ([view conformsToProtocol:@protocol(ABI34_0_0RCTAutoInsetsProtocol)]) {
    [(id <ABI34_0_0RCTAutoInsetsProtocol>) view refreshContentInset];
    return YES;
  }
  for (UIView *subview in view.subviews) {
    if (ABI34_0_0RCTFindScrollViewAndRefreshContentInsetInView(subview)) {
      return YES;
    }
  }
  return NO;
...
- (void)viewDidLayoutSubviews
{
  ...
  if (_previousTopLayoutLength != _currentTopLayoutGuide.length ||
    ...
    ABI34_0_0RCTFindScrollViewAndRefreshContentInsetInView(_contentView);
...
- (void)loadView
{
  ...
  //`contentView` which is a ReactABI34_0_0-managed view.
