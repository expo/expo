...
NSString *const ABI34_0_0RCTJSNavigationScheme = @"react-js-navigation";

static NSString *const kPostMessageHost = @"postMessage";

@interface ABI34_0_0RCTWebView () <UIWebViewDelegate, ABI34_0_0RCTAutoInsetsProtocol>
...
@implementation ABI34_0_0RCTWebView
{
  UIWebView *_webView;
...
{
  BOOL isJSNavigation = [request.URL.scheme isEqualToString:ABI34_0_0RCTJSNavigationScheme];
    ...
    NSString *source = [NSString stringWithFormat:
      @"(function() {"
        ...
        "document.addEventListener('message:received', function(e) {"
          ...
          "processQueue();"
        "});"
      "})();", ABI34_0_0RCTJSNavigationScheme, kPostMessageHost
    ];
