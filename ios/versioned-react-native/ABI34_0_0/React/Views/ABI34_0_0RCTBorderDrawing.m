...
#import "ABI34_0_0RCTBorderDrawing.h"
#import "ABI34_0_0RCTLog.h"

static const CGFloat ABI34_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI34_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return
  ABS(borderInsets.left - borderInsets.right) < ABI34_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.bottom) < ABI34_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.top) < ABI34_0_0RCTViewBorderThreshold;
}

BOOL ABI34_0_0RCTCornerRadiiAreEqual(ABI34_0_0RCTCornerRadii cornerRadii)
{
  return
  ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI34_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI34_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI34_0_0RCTViewBorderThreshold;
}

BOOL ABI34_0_0RCTBorderColorsAreEqual(ABI34_0_0RCTBorderColors borderColors)
{
  return
...
ABI34_0_0RCTCornerInsets ABI34_0_0RCTGetCornerInsets(ABI34_0_0RCTCornerRadii cornerRadii,
                                   UIEdgeInsets edgeInsets)
{
  return (ABI34_0_0RCTCornerInsets) {
    {
...
static UIEdgeInsets ABI34_0_0RCTRoundInsetsToPixel(UIEdgeInsets edgeInsets) {
    edgeInsets.top = ABI34_0_0RCTRoundPixelValue(edgeInsets.top);
    edgeInsets.bottom = ABI34_0_0RCTRoundPixelValue(edgeInsets.bottom);
    edgeInsets.left = ABI34_0_0RCTRoundPixelValue(edgeInsets.left);
    edgeInsets.right = ABI34_0_0RCTRoundPixelValue(edgeInsets.right);

    return edgeInsets;
}

static void ABI34_0_0RCTPathAddEllipticArc(CGMutablePathRef path,
...
CGPathRef ABI34_0_0RCTPathCreateWithRoundedRect(CGRect bounds,
                                       ...
                                       const CGAffineTransform *transform)
{
  ...
  ABI34_0_0RCTPathAddEllipticArc(path, transform, (CGPoint){
...
static void ABI34_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds,
                                               CGPoint lineStart,
                                               CGPoint lineEnd,
...
NS_INLINE BOOL ABI34_0_0RCTCornerRadiiAreAboveThreshold(ABI34_0_0RCTCornerRadii cornerRadii) {
  return (cornerRadii.topLeft > ABI34_0_0RCTViewBorderThreshold ||
    cornerRadii.topRight > ABI34_0_0RCTViewBorderThreshold      ||
    cornerRadii.bottomLeft > ABI34_0_0RCTViewBorderThreshold    ||
    cornerRadii.bottomRight > ABI34_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI34_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI34_0_0RCTCornerRadii cornerRadii) {
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI34_0_0RCTPathCreateWithRoundedRect(rect, ABI34_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef ABI34_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge) {
...
static UIImage *ABI34_0_0RCTGetSolidBorderImage(ABI34_0_0RCTCornerRadii cornerRadii,
                                       CGSize viewSize,
                                       ...
                                       BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI34_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI34_0_0RCTCornerInsets cornerInsets = ABI34_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  borderInsets = ABI34_0_0RCTRoundInsetsToPixel(borderInsets);
  ...
  CGContextRef ctx = ABI34_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI34_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI34_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI34_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI34_0_0RCTEllipseGetIntersectionsWithLine((CGRect){
...
static UIImage *ABI34_0_0RCTGetDashedOrDottedBorderImage(ABI34_0_0RCTBorderStyle borderStyle,
                                                ...
                                                BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI34_0_0RCTBorderStyleDashed || borderStyle == ABI34_0_0RCTBorderStyleDotted);

  if (!ABI34_0_0RCTBorderColorsAreEqual(borderColors) || !ABI34_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI34_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI34_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI34_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI34_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI34_0_0RCTPathCreateWithRoundedRect(pathRect, ABI34_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI34_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
...
UIImage *ABI34_0_0RCTGetBorderImage(ABI34_0_0RCTBorderStyle borderStyle,
                           CGSize viewSize,
                           ABI34_0_0RCTCornerRadii cornerRadii,
                           UIEdgeInsets borderInsets,
                           ABI34_0_0RCTBorderColors borderColors,
                           ...
                           BOOL drawToEdge)
{
  ...
  switch (borderStyle) {
    case ABI34_0_0RCTBorderStyleSolid:
      return ABI34_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI34_0_0RCTBorderStyleDashed:
    case ABI34_0_0RCTBorderStyleDotted:
      return ABI34_0_0RCTGetDashedOrDottedBorderImage(borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI34_0_0RCTBorderStyleUnset:
      break;
  }
