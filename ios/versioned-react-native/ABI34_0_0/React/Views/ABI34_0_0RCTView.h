...
@class ABI34_0_0RCTView;

@interface ABI34_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI34_0_0RCTDirectEventBlock onAccessibilityAction;
@property (nonatomic, copy) ABI34_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI34_0_0RCTDirectEventBlock onMagicTap;
@property (nonatomic, copy) ABI34_0_0RCTDirectEventBlock onAccessibilityEscape;
 ...
 */
@property (nonatomic, assign) ABI34_0_0RCTPointerEvents pointerEvents;
 ...
 * This is inherited from UIView+ReactABI34_0_0, but we override it here
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI34_0_0RCTBorderStyle borderStyle;
