...
@interface ABI34_0_0RCTWebViewManager () <ABI34_0_0RCTWebViewDelegate>
...
- (UIView *)view
{
  ABI34_0_0RCTWebView *webView = [ABI34_0_0RCTWebView new];
...
{
  [self.bridge.uiManager addUIBlock:^(__unused ABI34_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, ABI34_0_0RCTWebView *> *viewRegistry) {
    ABI34_0_0RCTWebView *view = viewRegistry[ReactABI34_0_0Tag];
    if (![view isKindOfClass:[ABI34_0_0RCTWebView class]]) {
...
- (BOOL)webView:(__unused ABI34_0_0RCTWebView *)webView
