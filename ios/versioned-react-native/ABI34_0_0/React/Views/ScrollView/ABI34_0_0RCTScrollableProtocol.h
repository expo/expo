...
/**
 * Contains any methods related to scrolling. Any `ABI34_0_0RCTView` that has scrolling
 * features should implement these methods.
 */
@protocol ABI34_0_0RCTScrollableProtocol
 ...
 */
@protocol ABI34_0_0RCTCustomRefreshContolProtocol
