...
static NSString *const MessageHanderName = @"ReactABI34_0_0Native";
static NSURLCredential* clientAuthenticationCredential;


@interface ABI34_0_0RCTWKWebView () <WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler, UIScrollViewDelegate, ABI34_0_0RCTAutoInsetsProtocol>
...
@implementation ABI34_0_0RCTWKWebView
{
...
- (void)visitSource
{
  ...
  NSURLRequest *request = [ABI34_0_0RCTConvert NSURLRequest:_source];
...
- (void)layoutSubviews
{
  ...
  // Ensure webview takes the position and dimensions of ABI34_0_0RCTWKWebView
  ...
  if (_messagingEnabled) {
    ...
    [self evaluateJS: isPostMessageNative thenCall: ^(NSString *result) {
      if (! [result isEqualToString:@"true"]) {
        ABI34_0_0RCTLogError(@"Setting onMessage on a WebView overrides existing values of window.postMessage, but a previous value was defined");
      }
    }];
    #endif
