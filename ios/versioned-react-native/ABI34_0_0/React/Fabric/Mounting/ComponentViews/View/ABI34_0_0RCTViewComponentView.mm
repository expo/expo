...
#import <ReactABI34_0_0/components/view/ViewShadowNode.h>
...
#import <ReactABI34_0_0/ABI34_0_0RCTBorderDrawing.h>

#import "ABI34_0_0RCTConversions.h"

using namespace facebook::ReactABI34_0_0;

@implementation ABI34_0_0RCTViewComponentView
{
...
- (void)layoutSubviews
{
  ...
  if (_contentView) {
    _contentView.frame = ABI34_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
  }
}
...
{
  ABI34_0_0RCTAssert(
    self == [ABI34_0_0RCTViewComponentView class],
    @"`+[ABI34_0_0RCTComponentViewProtocol componentHandle]` must be implemented for all subclasses (and `%@` particularly).", NSStringFromClass([self class]));
           ...
           oldProps:(SharedProps)oldProps
{
  ...
  ABI34_0_0RCTAssert(
    propsRawPtr &&
    (
      [self class] == [ABI34_0_0RCTViewComponentView class] ||
      typeid(*propsRawPtr).hash_code() != typeid(const ViewProps).hash_code()
    ),
    @"`ABI34_0_0RCTViewComponentView` subclasses (and `%@` particularly) must setup `_props`"
  ...
  if (oldViewProps.backgroundColor != newViewProps.backgroundColor) {
    _backgroundColor = ABI34_0_0RCTUIColorFromSharedColor(newViewProps.backgroundColor);
    needsInvalidateLayer = YES;
  }

  // `foregroundColor`
  if (oldViewProps.foregroundColor != newViewProps.foregroundColor) {
    self.foregroundColor = ABI34_0_0RCTUIColorFromSharedColor(newViewProps.foregroundColor);
  }

  // `shadowColor`
  if (oldViewProps.shadowColor != newViewProps.shadowColor) {
    CGColorRef shadowColor = ABI34_0_0RCTCGColorRefFromSharedColor(newViewProps.shadowColor);
  ...
  if (oldViewProps.shadowOffset != newViewProps.shadowOffset) {
    self.layer.shadowOffset = ABI34_0_0RCTCGSizeFromSize(newViewProps.shadowOffset);
    needsInvalidateLayer = YES;
  }
  ...
  if (oldViewProps.transform != newViewProps.transform) {
    self.layer.transform = ABI34_0_0RCTCATransform3DFromTransformMatrix(newViewProps.transform);
    self.layer.allowsEdgeAntialiasing = newViewProps.transform != Transform::Identity();
  }

  // `hitSlop`
  if (oldViewProps.hitSlop != newViewProps.hitSlop) {
    self.hitTestEdgeInsets = ABI34_0_0RCTUIEdgeInsetsFromEdgeInsets(newViewProps.hitSlop);
  }

  // `overflow`
  if (oldViewProps.ABI34_0_0yogaStyle.overflow != newViewProps.ABI34_0_0yogaStyle.overflow) {
    self.clipsToBounds = newViewProps.ABI34_0_0yogaStyle.overflow != ABI34_0_0YGOverflowVisible;
    needsInvalidateLayer = YES;
  }
  ...
  if (oldViewProps.nativeId != newViewProps.nativeId) {
    self.nativeId = ABI34_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.nativeId);
  }
  ...
  if (oldViewProps.accessibilityLabel != newViewProps.accessibilityLabel) {
    self.accessibilityElement.accessibilityLabel = ABI34_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityLabel);
  }

  // `accessibilityHint`
  if (oldViewProps.accessibilityHint != newViewProps.accessibilityHint) {
    self.accessibilityElement.accessibilityHint = ABI34_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityHint);
  }

  // `accessibilityTraits`
  if (oldViewProps.accessibilityTraits != newViewProps.accessibilityTraits) {
    self.accessibilityElement.accessibilityTraits = ABI34_0_0RCTUIAccessibilityTraitsFromAccessibilityTraits(newViewProps.accessibilityTraits);
  }
...
static ABI34_0_0RCTCornerRadii ABI34_0_0RCTCornerRadiiFromBorderRadii(BorderRadii borderRadii) {
...
static ABI34_0_0RCTBorderColors ABI34_0_0RCTBorderColorsFromBorderColors(BorderColors borderColors) {
  return ABI34_0_0RCTBorderColors {
    .left = ABI34_0_0RCTCGColorRefFromSharedColor(borderColors.left),
    .top = ABI34_0_0RCTCGColorRefFromSharedColor(borderColors.top),
    .bottom = ABI34_0_0RCTCGColorRefFromSharedColor(borderColors.bottom),
    .right = ABI34_0_0RCTCGColorRefFromSharedColor(borderColors.right)
  };
}
...
static ABI34_0_0RCTBorderStyle ABI34_0_0RCTBorderStyleFromBorderStyle(BorderStyle borderStyle) {
  switch (borderStyle) {
    case BorderStyle::Solid:
      return ABI34_0_0RCTBorderStyleSolid;
    case BorderStyle::Dotted:
      return ABI34_0_0RCTBorderStyleDotted;
    case BorderStyle::Dashed:
      return ABI34_0_0RCTBorderStyleDashed;
  }
}
...
- (void)invalidateLayer
{
  ...
  if (layerHasShadow) {
    if (CGColorGetAlpha(_backgroundColor.CGColor) > 0.999) {
      ...
      const ABI34_0_0RCTCornerInsets cornerInsets =
        ABI34_0_0RCTGetCornerInsets(ABI34_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero);
      CGPathRef shadowPath = ABI34_0_0RCTPathCreateWithRoundedRect(self.bounds, cornerInsets, nil);
  ...
  if (useCoreAnimationBorderRendering) {
    ...
    layer.borderColor = ABI34_0_0RCTCGColorRefFromSharedColor(borderMetrics.borderColors.left);
    ...
    UIImage *image = ABI34_0_0RCTGetBorderImage(
      ABI34_0_0RCTBorderStyleFromBorderStyle(borderMetrics.borderStyles.left),
      layer.bounds.size,
      ABI34_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii),
      UIEdgeInsetsFromBorderInsets(borderMetrics.borderWidths),
      ABI34_0_0RCTBorderColorsFromBorderColors(borderMetrics.borderColors),
    ...
    if (self.clipsToBounds) {
      if (borderMetrics.borderRadii.isUniform()) {
        ...
        CGPathRef path = ABI34_0_0RCTPathCreateWithRoundedRect(
          self.bounds,
          ABI34_0_0RCTGetCornerInsets(ABI34_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero),
          nil
        );
...
- (NSArray<UIAccessibilityCustomAction *> *)accessibilityCustomActions
{
  ...
  for (const auto &accessibilityAction : accessibilityActions) {
    [customActions addObject:[[UIAccessibilityCustomAction alloc] initWithName:ABI34_0_0RCTNSStringFromString(accessibilityAction)
                                                                        target:self
...
{
  _eventEmitter->onAccessibilityAction(ABI34_0_0RCTStringFromNSString(action.name));
  return YES;
}
