...
#import <ReactABI34_0_0/components/scrollview/ScrollViewShadowNode.h>
#import <ReactABI34_0_0/components/scrollview/ScrollViewLocalData.h>
#import <ReactABI34_0_0/components/scrollview/ScrollViewProps.h>
#import <ReactABI34_0_0/components/scrollview/ScrollViewEventEmitter.h>
#import <ReactABI34_0_0/graphics/Geometry.h>

#import "ABI34_0_0RCTConversions.h"
#import "ABI34_0_0RCTEnhancedScrollView.h"

using namespace facebook::ReactABI34_0_0;

@interface ABI34_0_0RCTScrollViewComponentView () <UIScrollViewDelegate>

@property (nonatomic, assign) CGFloat scrollEventThrottle;

@end

@implementation ABI34_0_0RCTScrollViewComponentView {
  ABI34_0_0RCTEnhancedScrollView *_Nonnull _scrollView;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _scrollView = [[ABI34_0_0RCTEnhancedScrollView alloc] initWithFrame:self.bounds];
...
#define REMAP_PROP(ReactABI34_0_0Name, localName, target) \
  if (oldScrollViewProps.ReactABI34_0_0Name != newScrollViewProps.ReactABI34_0_0Name) { \
    target.localName = newScrollViewProps.ReactABI34_0_0Name; \
  }

#define REMAP_VIEW_PROP(ReactABI34_0_0Name, localName) REMAP_PROP(ReactABI34_0_0Name, localName, self)
#define MAP_VIEW_PROP(name) REMAP_VIEW_PROP(name, name)
#define REMAP_SCROLL_VIEW_PROP(ReactABI34_0_0Name, localName) REMAP_PROP(ReactABI34_0_0Name, localName, _scrollView)
           ...
           oldLocalData:(SharedLocalData)oldLocalData
{
  ...
  CGSize contentSize = ABI34_0_0RCTCGSizeFromSize(_scrollViewLocalData->getContentSize());
  _contentView.frame = CGRect {CGPointZero, contentSize};
  _scrollView.contentSize = contentSize;
}

- (void)mountChildComponentView:(UIView<ABI34_0_0RCTComponentViewProtocol> *)childComponentView
                          index:(NSInteger)index
{
  [_contentView insertSubview:childComponentView atIndex:index];
}

- (void)unmountChildComponentView:(UIView<ABI34_0_0RCTComponentViewProtocol> *)childComponentView
                            index:(NSInteger)index
{
  ABI34_0_0RCTAssert(childComponentView.superview == _contentView, @"Attempt to unmount improperly mounted component view.");
...
- (ScrollViewMetrics)_scrollViewMetrics
{
  ...
  metrics.contentSize = ABI34_0_0RCTSizeFromCGSize(_scrollView.contentSize);
  metrics.contentOffset = ABI34_0_0RCTPointFromCGPoint(_scrollView.contentOffset);
  metrics.contentInset = ABI34_0_0RCTEdgeInsetsFromUIEdgeInsets(_scrollView.contentInset);
  metrics.containerSize = ABI34_0_0RCTSizeFromCGSize(_scrollView.bounds.size);
