...
@implementation ABI34_0_0RCTInsertMountItem {
  ReactABI34_0_0Tag _childTag;
  ReactABI34_0_0Tag _parentTag;
  NSInteger _index;
}
...
{
  UIView<ABI34_0_0RCTComponentViewProtocol> *childComponentView = [registry componentViewByTag:_childTag];
  UIView<ABI34_0_0RCTComponentViewProtocol> *parentComponentView = [registry componentViewByTag:_parentTag];
