...
@class ABI34_0_0RCTSurfacePresenter;
@protocol ABI34_0_0RCTSurfaceDelegate;

/**
 * (This is Fabric-compatible ABI34_0_0RCTSurface implementation.)
 *
 ...
 * The starting process includes initializing all underlying ReactABI34_0_0 Native
 * infrastructure and running ReactABI34_0_0 app.
...
@interface ABI34_0_0RCTFabricSurface (Internal)
...
@interface ABI34_0_0RCTFabricSurface (Deprecated)
