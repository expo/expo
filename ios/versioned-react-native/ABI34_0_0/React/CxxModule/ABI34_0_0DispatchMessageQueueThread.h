...
// is not the JS thread.  C++ modules don't use ABI34_0_0RCTNativeModule, so this little
// adapter does the work.

class DispatchMessageQueueThread : public MessageQueueThread {
public:
  DispatchMessageQueueThread(ABI34_0_0RCTModuleData *moduleData)
  ...
  void runOnQueue(std::function<void()>&& func) override {
    ...
    ABI34_0_0RCTAssert(block != nullptr, @"Invalid block generated in call to %@", moduleData_);
    if (queue && block) {
...
private:
  ABI34_0_0RCTModuleData *moduleData_;
};
