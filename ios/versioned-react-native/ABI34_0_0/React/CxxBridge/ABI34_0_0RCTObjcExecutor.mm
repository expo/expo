...
#import <cxxReactABI34_0_0/ABI34_0_0JSBigString.h>
...
class ABI34_0_0RCTObjcExecutor : public JSExecutor {
public:
  ABI34_0_0RCTObjcExecutor(id<ABI34_0_0RCTJavaScriptExecutor> jse,
                  ABI34_0_0RCTJavaScriptCompleteBlock errorBlock,
  ...
  void setBundleRegistry(std::unique_ptr<RAMBundleRegistry>) override {
    ABI34_0_0RCTAssert(NO, @"RAM bundles are not supported in ABI34_0_0RCTObjcExecutor");
  }
...
private:
  ...
  ABI34_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI34_0_0RCTObjcExecutorFactory::ABI34_0_0RCTObjcExecutorFactory(
  id<ABI34_0_0RCTJavaScriptExecutor> jse, ABI34_0_0RCTJavaScriptCompleteBlock errorBlock)
  : m_jse(jse)
  , m_errorBlock(errorBlock) {}

std::unique_ptr<JSExecutor> ABI34_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue) {
  return std::unique_ptr<JSExecutor>(
    new ABI34_0_0RCTObjcExecutor(m_jse, m_errorBlock, jsQueue, delegate));
}
