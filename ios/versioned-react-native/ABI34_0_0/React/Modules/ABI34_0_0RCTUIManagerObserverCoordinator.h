...
typedef dispatch_block_t ABI34_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI34_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ReactABI34_0_0-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI34_0_0RCTUIManager's observers.
 */
@interface ABI34_0_0RCTUIManagerObserverCoordinator : NSObject <ABI34_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI34_0_0RCTUIManagerObserver` protocol for more info.
