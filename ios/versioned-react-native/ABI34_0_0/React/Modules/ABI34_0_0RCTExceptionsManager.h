...
@protocol ABI34_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI34_0_0RCTExceptionsManager : NSObject <ABI34_0_0RCTBridgeModule>
...
@property (nonatomic, weak) id<ABI34_0_0RCTExceptionsManagerDelegate> delegate;
