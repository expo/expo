 ...
 * being atomic, unless someone bypasses the `ABI34_0_0RCTAsyncLocalStorage` API.
 *
 * Keys and values must always be strings or an error is returned.
 */
@interface ABI34_0_0RCTAsyncLocalStorage : NSObject <ABI34_0_0RCTBridgeModule,ABI34_0_0RCTInvalidating>
...
// Clear the ABI34_0_0RCTAsyncLocalStorage data from native code
- (void)clearAllData;
...
- (void)multiGet:(NSArray<NSString *> *)keys callback:(ABI34_0_0RCTResponseSenderBlock)callback;

// Add multiple key value pairs to the cache.
- (void)multiSet:(NSArray<NSArray<NSString *> *> *)kvPairs callback:(ABI34_0_0RCTResponseSenderBlock)callback;
