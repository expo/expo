...
@interface ABI34_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI34_0_0RCTRedBoxExtraDataCell
...
@interface ABI34_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI34_0_0RCTRedBoxExtraDataViewController
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ABI34_0_0RCTRedBoxExtraDataCell *cell =
            (ABI34_0_0RCTRedBoxExtraDataCell *)[tableView
            dequeueReusableCellWithIdentifier:reuseIdentifier];

    if (cell == nil) {
        cell = [[ABI34_0_0RCTRedBoxExtraDataCell alloc]
