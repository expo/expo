...
extern NSString *const ABI34_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI34_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI34_0_0RCTBundleURLProvider : NSObject
