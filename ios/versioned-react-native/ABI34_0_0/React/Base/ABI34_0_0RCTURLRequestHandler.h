 ...
 * are also bridge modules, so should be registered using ABI34_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI34_0_0RCTURLRequestHandler <ABI34_0_0RCTBridgeModule>
...
/**
 * If more than one ABI34_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
