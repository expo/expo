 ...
 */
@interface ABI34_0_0RCTImageSource : NSObject
...
@interface ABI34_0_0RCTConvert (ImageSource)

+ (ABI34_0_0RCTImageSource *)ABI34_0_0RCTImageSource:(id)json;
+ (NSArray<ABI34_0_0RCTImageSource *> *)ABI34_0_0RCTImageSourceArray:(id)json;
