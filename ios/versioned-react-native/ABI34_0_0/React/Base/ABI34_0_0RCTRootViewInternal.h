 ...
 * classes to change the ABI34_0_0RCTRootViews's internal state.
 */
@interface ABI34_0_0RCTRootView ()

/**
 * This setter should be used only by ABI34_0_0RCTUIManager on ReactABI34_0_0 root view
...
@property (nonatomic, strong) UIView *ReactABI34_0_0PreferredFocusedView;
#endif
