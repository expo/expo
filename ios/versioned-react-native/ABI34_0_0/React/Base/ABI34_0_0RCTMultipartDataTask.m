...
@interface ABI34_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI34_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI34_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI34_0_0RCTMultipartProgressCallback _progressHandler;
...
- (instancetype)initWithURL:(NSURL *)url
                partHandler:(ABI34_0_0RCTMultipartDataTaskCallback)partHandler
            progressHandler:(ABI34_0_0RCTMultipartProgressCallback)progressHandler
{
  if (self = [super init]) {
    _url = url;
...
{
  ABI34_0_0RCTMultipartStreamReader *reader = [[ABI34_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI34_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
