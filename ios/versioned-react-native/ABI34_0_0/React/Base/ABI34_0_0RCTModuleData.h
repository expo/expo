...
typedef id<ABI34_0_0RCTBridgeModule>(^ABI34_0_0RCTBridgeModuleProvider)(void);

@interface ABI34_0_0RCTModuleData : NSObject <ABI34_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI34_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readwrite) id<ABI34_0_0RCTBridgeModule> instance;
