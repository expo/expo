...
#import <ABI34_0_0EXGoogleSignIn/ABI34_0_0EXGoogleSignIn.h>
#import <ABI34_0_0EXGoogleSignIn/ABI34_0_0EXAuthTask.h>
...
@interface ABI34_0_0EXGoogleSignIn ()
...
@property (nonatomic, strong) ABI34_0_0EXAuthTask *authTask;

@end

@implementation ABI34_0_0EXGoogleSignIn

ABI34_0_0UM_EXPORT_MODULE(ExpoGoogleSignIn);

- (instancetype)init
{
  if (self = [super init]) {
    _authTask = [[ABI34_0_0EXAuthTask alloc] init];
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"ERRORS": @{
               ...
               @"TASK_IN_PROGRESS": ABI34_0_0EX_E_CONCURRENT_TASK_IN_PROGRESS,
               @"SIGN_IN_EXCEPTION": ABI34_0_0EX_E_EXCEPTION
               },
           @"TYPES": @{},
           @"SCOPES": @{
               @"PROFILE": @"profile",
               ...
               @"FITNESS_OXABI34_0_0YGEN_SATURATION_READ": @"https://www.googleapis.com/auth/fitness.oxygen_saturation.read",
               @"FITNESS_OXABI34_0_0YGEN_SATURATION_READ_WRITE": @"https://www.googleapis.com/auth/fitness.oxygen_saturation.write",
...
- (NSString *)_getNativeClientIdOrReject:(ABI34_0_0UMPromiseRejectBlock)reject
{
  NSString *path = [[NSBundle mainBundle] pathForResource:@"GoogleService-Info" ofType:@"plist"];
  
  if (!path) {
    reject(ABI34_0_0EX_E_EXCEPTION, @"Missing GoogleService-Info.plist", nil);
    return nil;
  }
  NSDictionary *plist = [[NSDictionary alloc] initWithContentsOfFile:path];
  NSString *clientId = plist[@"CLIENT_ID"];
  if (clientId != nil && ![clientId isEqualToString:@""]) return clientId;
  reject(ABI34_0_0EX_E_EXCEPTION, @"GoogleService-Info.plist `CLIENT_ID` is invalid", nil);
  return nil;
}
...
ABI34_0_0UM_EXPORT_METHOD_AS(initAsync,
...
ABI34_0_0UM_EXPORT_METHOD_AS(signInSilentlyAsync,
                    signInSilentlyAsync:(ABI34_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
...
ABI34_0_0UM_EXPORT_METHOD_AS(signInAsync,
                    signInAsync:(ABI34_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
...
ABI34_0_0UM_EXPORT_METHOD_AS(signOutAsync,
                    signOutAsync:(ABI34_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
...
ABI34_0_0UM_EXPORT_METHOD_AS(isConnectedAsync,
                    isConnectedAsync:(ABI34_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  resolve(@([[GIDSignIn sharedInstance] hasAuthInKeychain]));
}

ABI34_0_0UM_EXPORT_METHOD_AS(getCurrentUserAsync,
                    getCurrentUserAsync:(ABI34_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  GIDGoogleUser *currentUser = [GIDSignIn sharedInstance].currentUser;
  resolve(ABI34_0_0UMNullIfNil([ABI34_0_0EXGoogleSignIn jsonFromGIDGoogleUser:currentUser]));
}

ABI34_0_0UM_EXPORT_METHOD_AS(getPhotoAsync,
...
ABI34_0_0UM_EXPORT_METHOD_AS(getTokensAsync,
                    ...
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  GIDGoogleUser *currentUser = [GIDSignIn sharedInstance].currentUser;
  if (currentUser == nil) {
    reject(ABI34_0_0EX_E_EXCEPTION, @"getTokens requires a user to be signed in", nil);
    return;
  }

  GIDAuthenticationHandler handler = ^void(GIDAuthentication *authentication, NSError *error) {
    if (error) {
      reject(ABI34_0_0EX_E_EXCEPTION, error.localizedDescription, nil);
    } else {
      resolve(@{
...
- (void)signIn:(GIDSignIn *)signIn didSignInForUser:(GIDGoogleUser *)user withError:(NSError *)error {
  [self.authTask parse:[ABI34_0_0EXGoogleSignIn jsonFromGIDGoogleUser:user] error:error];
}
...
- (void)signIn:(GIDSignIn *)signIn presentViewController:(UIViewController *)viewController {
  __weak ABI34_0_0EXGoogleSignIn *weakSelf = self;
  
  [ABI34_0_0UMUtilities performSynchronouslyOnMainThread:^{
    __strong ABI34_0_0EXGoogleSignIn *strongSelf = weakSelf;
    if (strongSelf == nil) {
      return;
    }
