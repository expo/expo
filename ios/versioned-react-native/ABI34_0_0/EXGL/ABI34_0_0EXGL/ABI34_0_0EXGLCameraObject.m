...
@interface ABI34_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) id<ABI34_0_0UMCameraInterface> camera;
...
@implementation ABI34_0_0EXGLCameraObject
