...
@interface ABI34_0_0EXFontLoaderProcessor ()
...
@implementation ABI34_0_0EXFontLoaderProcessor
         ...
         scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  ABI34_0_0EXFont *exFont = nil;

  // Did we get a new family, and if so, is it associated with an ABI34_0_0EXFont?
  ...
  // Did the passed-in UIFont come from an ABI34_0_0EXFont?
  if (!exFont && uiFont) {
    exFont = objc_getAssociatedObject(uiFont, ABI34_0_0EXFontAssocKey);
  }

  // If it's an ABI34_0_0EXFont, generate the corresponding UIFont, else fallback to ReactABI34_0_0 Native's built-in method
  if (exFont) {
