...
#import <ABI34_0_0EXSensors/ABI34_0_0EXPedometer.h>
...
NSString * const ABI34_0_0EXPedometerUpdateEventName = @"Exponent.pedometerUpdate";
NSString * const ABI34_0_0EXPedometerModuleName = @"ExponentPedometer";

@interface ABI34_0_0EXPedometer () <ABI34_0_0UMAppLifecycleListener>
...
@implementation ABI34_0_0EXPedometer
...
{
  if (self = [super init]) {
    __weak ABI34_0_0EXPedometer *weakSelf = self;
    _watchHandler = ^(CMPedometerData * _Nullable pedometerData, NSError * _Nullable error) {
      ...
      __strong ABI34_0_0EXPedometer *strongSelf = weakSelf;
      if (strongSelf) {
        __strong id<ABI34_0_0UMEventEmitterService> eventEmitter = strongSelf.eventEmitter;
        if (eventEmitter) {
          [eventEmitter sendEventWithName:ABI34_0_0EXPedometerUpdateEventName
...
{
  return ABI34_0_0EXPedometerModuleName;
}
...
{
  return @[ABI34_0_0EXPedometerUpdateEventName];
}
...
ABI34_0_0UM_EXPORT_METHOD_AS(getStepCountAsync,
