...
#import <ABI34_0_0EXSensors/ABI34_0_0EXSensorsManager.h>
#import <CoreMotion/CoreMotion.h>

@interface ABI34_0_0EXSensorsManager ()
...
@implementation ABI34_0_0EXSensorsManager

ABI34_0_0UM_REGISTER_MODULE();

+ (const NSArray<Protocol *> *)exportedInterfaces
{
  return @[@protocol(ABI34_0_0UMAccelerometerInterface), @protocol(ABI34_0_0UMBarometerInterface), @protocol(ABI34_0_0UMDeviceMotionInterface), @protocol(ABI34_0_0UMGyroscopeInterface), @protocol(ABI34_0_0UMMagnetometerInterface), @protocol(ABI34_0_0UMMagnetometerUncalibratedInterface)];
}
                                            ...
                                            withHandler:(void (^)(NSDictionary *event))handlerBlock
{
  ...
  if (![[self manager] isAccelerometerActive]) {
    ...
    __weak ABI34_0_0EXSensorsManager *weakSelf = self;
    [[self manager] startAccelerometerUpdatesToQueue:[NSOperationQueue mainQueue] withHandler:^(CMAccelerometerData *data, NSError *error) {
      __strong ABI34_0_0EXSensorsManager *strongSelf = weakSelf;
      if (strongSelf) {
...
- (void)activateDeviceMotionUpdates
{
  ...
  [[self manager] startDeviceMotionUpdatesUsingReferenceFrame:CMAttitudeReferenceFrameXArbitraryCorrectedZVertical toQueue:[NSOperationQueue mainQueue] withHandler:^(CMDeviceMotion *data, NSError *error) {
    ...
    NSDictionary *result = @{
                             @"acceleration": @{
                                 @"x": @(data.userAcceleration.x * ABI34_0_0EXGravity),
                                 @"y": @(data.userAcceleration.y * ABI34_0_0EXGravity),
                                 @"z": @(data.userAcceleration.z * ABI34_0_0EXGravity)
                                 },
                             @"accelerationIncludingGravity": @{
                                 @"x": @((data.userAcceleration.x + data.gravity.x) * ABI34_0_0EXGravity),
                                 @"y": @((data.userAcceleration.y + data.gravity.y) * ABI34_0_0EXGravity),
                                 @"z": @((data.userAcceleration.z + data.gravity.z) * ABI34_0_0EXGravity)
                                 },
                             @"rotation": @{
