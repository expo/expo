...
#import <ABI34_0_0EXSpeech/ABI34_0_0EXSpeech.h>

@interface ABI34_0_0EXSpeechUtteranceWithId : AVSpeechUtterance
...
@implementation ABI34_0_0EXSpeechUtteranceWithId
...
@interface ABI34_0_0EXSpeech () <AVSpeechSynthesizerDelegate>
...
@implementation ABI34_0_0EXSpeech

ABI34_0_0UM_EXPORT_MODULE(ExponentSpeech)
...
{
  id<ABI34_0_0UMEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI34_0_0UMEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStarted" body:@{ @"id": ((ABI34_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didCancelSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI34_0_0UMEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI34_0_0UMEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStopped" body:@{ @"id": ((ABI34_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didFinishSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI34_0_0UMEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI34_0_0UMEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingDone" body:@{ @"id": ((ABI34_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}


ABI34_0_0UM_EXPORT_METHOD_AS(speak,
  ...
  AVSpeechUtterance *utterance = [[ABI34_0_0EXSpeechUtteranceWithId alloc] initWithString:text utteranceId:utteranceId];
...
ABI34_0_0UM_EXPORT_METHOD_AS(getVoices,
                    getVoices:(ABI34_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject) {
...
ABI34_0_0UM_EXPORT_METHOD_AS(stop,
                    stop:(ABI34_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject) {
  [_synthesizer stopSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI34_0_0UM_EXPORT_METHOD_AS(pause,
                    pause:(ABI34_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject) {
  [_synthesizer pauseSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI34_0_0UM_EXPORT_METHOD_AS(resume,
                    resume:(ABI34_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject) {
  [_synthesizer continueSpeaking];
  resolve(nil);
}

ABI34_0_0UM_EXPORT_METHOD_AS(isSpeaking,
                    isSpeaking:(ABI34_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject) {
