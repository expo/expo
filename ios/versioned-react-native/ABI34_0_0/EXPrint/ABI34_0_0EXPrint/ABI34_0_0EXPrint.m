...
#import <ABI34_0_0EXPrint/ABI34_0_0EXPrint.h>
...
NSString *const ABI34_0_0EXPrintOrientationPortrait = @"portrait";
NSString *const ABI34_0_0EXPrintOrientationLandscape = @"landscape";

@interface ABI34_0_0EXPrint () <UIPrintInteractionControllerDelegate, UIPrinterPickerControllerDelegate>
...
@implementation ABI34_0_0EXPrint

ABI34_0_0UM_EXPORT_MODULE(ExponentPrint);
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"Orientation": @{
               @"portrait": ABI34_0_0EXPrintOrientationPortrait,
               @"landscape": ABI34_0_0EXPrintOrientationLandscape,
               },
           };
}

ABI34_0_0UM_EXPORT_METHOD_AS(print,
                    ...
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  [self _getPrintingDataForOptions:options callback:^(NSData *printingData, NSDictionary *errorDetails) {
    if (errorDetails != nil) {
      reject(errorDetails[@"code"], errorDetails[@"message"], ABI34_0_0UMErrorWithMessage(errorDetails[@"message"]));
      return;
    }
    ...
    if (printingData == nil) {
      ...
      if (options[@"markupFormatterIOS"] && [options[@"markupFormatterIOS"] isKindOfClass:[NSString class]]) {
        ...
        if (htmlString != nil) {
          ...
          reject(@"E_HTML_INVALID", message, ABI34_0_0UMErrorWithMessage(message));
          return;
        }
      } else {
...
ABI34_0_0UM_EXPORT_METHOD_AS(selectPrinter,selectPrinter:(ABI34_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
...
ABI34_0_0UM_EXPORT_METHOD_AS(printToFileAsync,
                    ...
                    reject:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  ABI34_0_0EXPrintPDFRenderTask *renderTask = [ABI34_0_0EXPrintPDFRenderTask new];
...
{
  id<ABI34_0_0UMUtilitiesInterface> utils = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI34_0_0UMUtilitiesInterface)];
...
- (void)_getPrintingDataForOptions:(nonnull NSDictionary *)options callback:(void(^)(NSData *, NSDictionary *))callback
{
  ...
  if (options[@"html"]) {
    __block ABI34_0_0EXPrintPDFRenderTask *renderTask = [ABI34_0_0EXPrintPDFRenderTask new];
...
{
  if ([orientation isEqualToString:ABI34_0_0EXPrintOrientationLandscape]) {
