...
#import <ABI34_0_0EXPrint/ABI34_0_0EXWKSnapshotPDFRenderer.h>
#import <ABI34_0_0UMCore/ABI34_0_0UMDefines.h>

@interface ABI34_0_0EXWKSnapshotPDFRenderer ()

@end

@implementation ABI34_0_0EXWKSnapshotPDFRenderer
...
- (void)takeSnapshotForPage:(int)pageIndex ofPages:(int)pagesCount ofWebView:(WKWebView *)webView withScrollHeight:(CGFloat)scrollHeight withCompletionHandler:(void (^ _Nullable)(NSError * _Nullable error))completionHandler
{
  ...
  if (@available(iOS 11.0, *)) {
    ...
    NSError *error = ABI34_0_0UMErrorWithMessage(@"Unexpected error occurred - on iOS under 11.0 use ABI34_0_0EXWKViewPDFRenderer.");
    completionHandler(error);
  }
}
