...
#import <ABI34_0_0EXPrint/ABI34_0_0EXWKViewPDFRenderer.h>

@interface ABI34_0_0EXWKPDFRenderer () <WKNavigationDelegate>

@property (nonatomic, assign) CGSize pageSize;
@property (nonatomic, strong) WKWebView *webView;
@property (nonatomic, strong) id<ABI34_0_0EXPDFRenderer> renderer;
...
@implementation ABI34_0_0EXWKPDFRenderer
...
- (void)PDFWithHtml:(NSString *)htmlString pageSize:(CGSize)pageSize completionHandler:(void (^)(NSError * _Nullable, NSData * _Nullable, int))handler
{
  ...
  if (@available(iOS 11.0, *)) {
    _renderer = [[ABI34_0_0EXWKSnapshotPDFRenderer alloc] init];
  } else {
    _renderer = [[ABI34_0_0EXWKViewPDFRenderer alloc] init];
  }
