...
@interface ABI34_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI34_0_0EXBarCodeScanner *barCodeScanner;
...
@implementation ABI34_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI34_0_0UMModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI34_0_0UMAppLifecycleListener)];
...
{
  ABI34_0_0UM_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI34_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI34_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI34_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI34_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI34_0_0EXBarCodeScanner *barCodeScanner = [ABI34_0_0EXBarCodeScanner new];
