...
#import <ABI34_0_0EXCalendar/ABI34_0_0EXCalendar.h>
...
@implementation ABI34_0_0EXCalendar

ABI34_0_0UM_EXPORT_MODULE(ExpoCalendar);
...
ABI34_0_0UM_EXPORT_METHOD_AS(getCalendarsAsync,
                    ...
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI34_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI34_0_0UM_EXPORT_METHOD_AS(saveCalendarAsync,
                    ...
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (color) {
    calendar.CGColor = [ABI34_0_0UMUtilities UIColor:color].CGColor;
...
ABI34_0_0UM_EXPORT_METHOD_AS(deleteCalendarAsync,
...
ABI34_0_0UM_EXPORT_METHOD_AS(getEventsAsync,
                    ...
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI34_0_0UMUtilities NSDate:startDateStr];
  NSDate *endDate = [ABI34_0_0UMUtilities NSDate:endDateStr];
  ...
  if (calendarEvents) {
    resolve([ABI34_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI34_0_0UM_EXPORT_METHOD_AS(getEventByIdAsync,
                    ...
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (calendarEvent) {
    resolve([ABI34_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI34_0_0UM_EXPORT_METHOD_AS(saveEventAsync,
                    ...
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI34_0_0UMUtilities NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI34_0_0UMUtilities NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI34_0_0UMUtilities NSDate:details[@"instanceStartDate"]];
  ...
  if (recurrenceRule) {
    ...
    if (recurrenceRule[@"endDate"]) {
      endDate = [ABI34_0_0UMUtilities NSDate:recurrenceRule[@"endDate"]];
    }
...
ABI34_0_0UM_EXPORT_METHOD_AS(deleteEventAsync,
                    ...
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *instanceStartDate = [ABI34_0_0UMUtilities NSDate:event[@"instanceStartDate"]];
...
ABI34_0_0UM_EXPORT_METHOD_AS(getAttendeesForEventAsync,
                    ...
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (item.hasAttendees) {
    resolve([ABI34_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI34_0_0UM_EXPORT_METHOD_AS(getRemindersAsync,
                    ...
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI34_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI34_0_0UM_EXPORT_METHOD_AS(getReminderByIdAsync,
                    ...
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (reminder) {
    ...
    resolve([ABI34_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI34_0_0UM_EXPORT_METHOD_AS(saveReminderAsync,
                    ...
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI34_0_0UMUtilities NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI34_0_0UMUtilities NSDate:details[@"dueDate"]];
  NSDate *completionDate = [ABI34_0_0UMUtilities NSDate:details[@"completionDate"]];
...
ABI34_0_0UM_EXPORT_METHOD_AS(deleteReminderAsync,
...
ABI34_0_0UM_EXPORT_METHOD_AS(getSourcesAsync,
                    getSourcesAsync:(ABI34_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI34_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI34_0_0UM_EXPORT_METHOD_AS(getSourceByIdAsync,
                    ...
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI34_0_0EXCalendarConverter serializeSource:source]);
}

ABI34_0_0UM_EXPORT_METHOD_AS(requestPermissionsAsync,
                    requestPermissionsAsync:(ABI34_0_0UMPromiseResolveBlock)resolve
...
ABI34_0_0UM_EXPORT_METHOD_AS(requestRemindersPermissionsAsync,
                    requestRemindersPermissionsAsync:(ABI34_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  if (!_permissionsManager) {
    return reject(@"E_NO_PERMISSIONS", @"Permissions module not found. Are you sure that Expo modules are properly linked?", nil);
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI34_0_0UMUtilities NSDate:alarm[@"absoluteDate"]];
...
- (BOOL)_checkPermissions:(NSString *)permissionType reject:(ABI34_0_0UMPromiseRejectBlock)reject
{
...
- (BOOL)_checkCalendarPermissions:(ABI34_0_0UMPromiseRejectBlock)reject
{
  return [self _checkPermissions:@"calendar" reject:reject];
}

- (BOOL)_checkRemindersPermissions:(ABI34_0_0UMPromiseRejectBlock)reject
{
