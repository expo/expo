...
#import <ABI34_0_0EXSharing/ABI34_0_0EXSharingModule.h>
...
@interface ABI34_0_0EXSharingModule ()

@property (nonatomic, weak) ABI34_0_0UMModuleRegistry *moduleRegistry;
@property (nonatomic, strong) UIDocumentInteractionController *documentInteractionController;

@property (nonatomic, strong) ABI34_0_0UMPromiseResolveBlock pendingResolver;

@end

@implementation ABI34_0_0EXSharingModule

ABI34_0_0UM_EXPORT_MODULE(ExpoSharing);
...
ABI34_0_0UM_EXPORT_METHOD_AS(shareAsync,
                    ...
                    reject:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  if (_documentInteractionController) {
    ...
    reject(@"E_SHARING_MUL", errorMessage, ABI34_0_0UMErrorWithMessage(errorMessage));
    return;
  }

  NSURL *url = [NSURL URLWithString:fileUrl];

  id<ABI34_0_0UMFilePermissionModuleInterface> filePermissionsModule = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI34_0_0UMFilePermissionModuleInterface)];
  if (filePermissionsModule && !([filePermissionsModule getPathPermissions:url.path] & ABI34_0_0UMFileSystemPermissionRead)) {
    NSString *errorMessage = @"You don't have access to provided file.";
    reject(@"E_SHARING_PERM", errorMessage, ABI34_0_0UMErrorWithMessage(errorMessage));
    return;
  }
  ...
  UIViewController *viewController = [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI34_0_0UMUtilitiesInterface)] currentViewController];
