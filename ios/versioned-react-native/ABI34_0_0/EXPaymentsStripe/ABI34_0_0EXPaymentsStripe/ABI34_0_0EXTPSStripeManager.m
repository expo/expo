...
#import <ABI34_0_0EXPaymentsStripe/ABI34_0_0EXTPSStripeManager.h>
...
@interface ABI34_0_0EXTPSStripeManager ()
...
@implementation ABI34_0_0EXTPSStripeManager
{
    NSString *publishableKey;
    NSString *merchantId;
    NSDictionary *errorCodes;

    ABI34_0_0UMPromiseResolveBlock promiseResolver;
    ABI34_0_0UMPromiseRejectBlock promiseRejector;
...
ABI34_0_0UM_EXPORT_METHOD_AS(init, init:(NSDictionary *)options
...
ABI34_0_0UM_EXPORT_METHOD_AS(deviceSupportsApplePay, deviceSupportsApplePay:(ABI34_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI34_0_0UMPromiseRejectBlock)reject) {
    resolve(@([PKPaymentAuthorizationViewController canMakePayments]));
}

ABI34_0_0UM_EXPORT_METHOD_AS(canMakeApplePayPayments, canMakeApplePayPayments:(NSDictionary *)options
                  resolver:(ABI34_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI34_0_0UMPromiseRejectBlock)reject) {
    NSArray <NSString *> *paymentNetworksStrings =
    options[@"networks"] ?: [ABI34_0_0EXTPSStripeManager supportedPaymentNetworksStrings];
...
ABI34_0_0UM_EXPORT_METHOD_AS(completeApplePayRequest, completeApplePayRequest:(ABI34_0_0UMPromiseResolveBlock)resolve
                                 rejecter:(ABI34_0_0UMPromiseRejectBlock)reject) {
...
ABI34_0_0UM_EXPORT_METHOD_AS(cancelApplePayRequest, cancelApplePayRequest:(ABI34_0_0UMPromiseResolveBlock)resolve
                               rejecter:(ABI34_0_0UMPromiseRejectBlock)reject) {
    if (applePayCompletion) {
        promiseResolver = resolve;
...
ABI34_0_0UM_EXPORT_METHOD_AS(createTokenWithCard, createTokenWithCard:(NSDictionary *)params
                             resolver:(ABI34_0_0UMPromiseResolveBlock)resolve
                             rejecter:(ABI34_0_0UMPromiseRejectBlock)reject) {
...
ABI34_0_0UM_EXPORT_METHOD_AS(createTokenWithBankAccount, createTokenWithBankAccount:(NSDictionary *)params
                  resolver:(ABI34_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI34_0_0UMPromiseRejectBlock)reject) {
    if(!requestIsCompleted) {
        NSDictionary *error = [errorCodes valueForKey:kErrorKeyBusy];
    ...
    [ABI34_0_0EXTPSConvert holderType:params[@"accountHolderType"]];
...
ABI34_0_0UM_EXPORT_METHOD_AS(createSourceWithParams, createSourceWithParams:(NSDictionary *)params
                  resolver:(ABI34_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI34_0_0UMPromiseRejectBlock)reject) {
    if(!requestIsCompleted) {
        NSDictionary *error = [errorCodes valueForKey:kErrorKeyBusy];
...
ABI34_0_0UM_EXPORT_METHOD_AS(paymentRequestWithCardForm, paymentRequestWithCardForm:(NSDictionary *)options
                                    resolver:(ABI34_0_0UMPromiseResolveBlock)resolve
                                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject) {
    if(!requestIsCompleted) {
        NSDictionary *error = [errorCodes valueForKey:kErrorKeyBusy];
...
ABI34_0_0UM_EXPORT_METHOD_AS(paymentRequestWithApplePay, paymentRequestWithApplePay:(NSArray *)items
...
ABI34_0_0UM_EXPORT_METHOD_AS(openApplePaySetup, openApplePaySetup:(ABI34_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI34_0_0UMPromiseRejectBlock)reject) {
...
-(UIViewController*) getViewController {
  return [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI34_0_0UMUtilitiesInterface)] currentViewController];
}
...
- (BOOL)canSubmitPaymentRequest:(PKPaymentRequest *)paymentRequest rejecter:(ABI34_0_0UMPromiseRejectBlock)reject {
...
- (NSDictionary *)convertTokenObject:(STPToken*)token {
    ...
    if (token.bankAccount) {
        ...
        [ABI34_0_0EXTPSConvert STPBankAccountStatusToString:token.bankAccount.status];
        ...
        [ABI34_0_0EXTPSConvert STPBankAccountHolderTypeToString:token.bankAccount.accountHolderType];
...
- (STPTheme *)formTheme:(NSDictionary*)options {
    ...
    [theme setPrimaryBackgroundColor:[ABI34_0_0EXTPSConvert UIColor:options[@"primaryBackgroundColor"]]];
    [theme setSecondaryBackgroundColor:[ABI34_0_0EXTPSConvert UIColor:options[@"secondaryBackgroundColor"]]];
    [theme setPrimaryForegroundColor:[ABI34_0_0EXTPSConvert UIColor:options[@"primaryForegroundColor"]]];
    [theme setSecondaryForegroundColor:[ABI34_0_0EXTPSConvert UIColor:options[@"secondaryForegroundColor"]]];
    [theme setAccentColor:[ABI34_0_0EXTPSConvert UIColor:options[@"accentColor"]]];
    [theme setErrorColor:[ABI34_0_0EXTPSConvert UIColor:options[@"errorColor"]]];
    [theme setErrorColor:[ABI34_0_0EXTPSConvert UIColor:options[@"errorColor"]]];
