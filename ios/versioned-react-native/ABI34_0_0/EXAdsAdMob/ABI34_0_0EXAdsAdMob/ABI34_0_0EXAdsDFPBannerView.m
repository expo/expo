...
@implementation ABI34_0_0EXAdsDFPBannerView {
  DFPBannerView *_bannerView;
  id<ABI34_0_0UMEventEmitterService> _eventEmitter;
}
...
- (void)setOnSizeChange:(ABI34_0_0UMDirectEventBlock)block
{
  _onSizeChange = block;
  [self loadBanner];
}

- (void)setOnDidFailToReceiveAdWithError:(ABI34_0_0UMDirectEventBlock)block
{
