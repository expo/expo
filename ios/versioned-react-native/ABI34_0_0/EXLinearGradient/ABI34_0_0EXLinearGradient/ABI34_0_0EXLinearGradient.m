...
@interface ABI34_0_0EXLinearGradient ()

@end

@implementation ABI34_0_0EXLinearGradient

+ (Class)layerClass
{
  return [ABI34_0_0EXLinearGradientLayer class];
}

- (ABI34_0_0EXLinearGradientLayer *)gradientLayer
{
  return (ABI34_0_0EXLinearGradientLayer *)self.layer;
}
...
- (void)setColors:(NSArray *)colorStrings
{
  ...
  for (NSString *colorString in colorStrings) {
    UIColor *convertedColor = [ABI34_0_0UMUtilities UIColor:colorString];
    if (convertedColor) {
