...
// Interface for ABI34_0_0UMTaskManager module.

@protocol ABI34_0_0UMTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI34_0_0UMTaskConsumerInterface protocol.
 */
