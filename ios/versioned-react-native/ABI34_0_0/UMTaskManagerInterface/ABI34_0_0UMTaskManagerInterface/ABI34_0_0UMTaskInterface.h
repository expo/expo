...
@protocol ABI34_0_0UMTaskConsumerInterface;

@protocol ABI34_0_0UMTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI34_0_0UMTaskConsumerInterface> __nonnull consumer;
