...
#import <ABI34_0_0EXDocumentPicker/ABI34_0_0EXDocumentPickerModule.h>
...
static NSString * ABI34_0_0EXConvertMimeTypeToUTI(NSString *mimeType)
{
  CFStringRef uti;
...
@interface ABI34_0_0EXDocumentPickerModule () <UIDocumentMenuDelegate, UIDocumentPickerDelegate>
...
@implementation ABI34_0_0EXDocumentPickerModule

ABI34_0_0UM_EXPORT_MODULE(ExpoDocumentPicker);
...
ABI34_0_0UM_EXPORT_METHOD_AS(getDocumentAsync,
                    ...
                    reject:(ABI34_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSString *type = ABI34_0_0EXConvertMimeTypeToUTI(options[@"type"] ?: @"*/*");
