...
@interface ABI33_0_0EXTaskExecutionRequest ()

@property (nonatomic, strong, nullable) NSMutableSet<id<ABI33_0_0UMTaskInterface>> *tasks;
...
@implementation ABI33_0_0EXTaskExecutionRequest
...
- (void)_maybeExecuteCallback
{
  if (_callback) {
    ...
    __strong ABI33_0_0EXTaskExecutionRequest *strongSelf = self;
