...
NSString * const ABI33_0_0EXTaskManagerEventName = @"TaskManager.executeTask";

@interface ABI33_0_0EXTaskManager ()
...
@property (nonatomic, weak) id<ABI33_0_0UMTaskServiceInterface> taskService;

@end

@implementation ABI33_0_0EXTaskManager

ABI33_0_0UM_EXPORT_MODULE(ExpoTaskManager);

+ (const NSArray<Protocol *> *)exportedInterfaces
{
  return @[@protocol(ABI33_0_0UMTaskManagerInterface)];
}
...
// TODO: Remove when adding bare ReactABI33_0_0 Native support
...
{
  return @{
           @"EVENT_NAME": ABI33_0_0EXTaskManagerEventName,
           };
}
...
{
  return @[ABI33_0_0EXTaskManagerEventName];
}
...
- (void)startObserving
{
  if (_eventsQueue && _eventsQueue.count > 0) {
    ...
    for (NSDictionary *eventBody in _eventsQueue) {
      [_eventEmitter sendEventWithName:ABI33_0_0EXTaskManagerEventName body:eventBody];
    }
  }
  _eventsQueue = nil;
}
...
ABI33_0_0UM_EXPORT_METHOD_AS(notifyTaskFinishedAsync,
...
ABI33_0_0UM_EXPORT_METHOD_AS(isTaskRegisteredAsync,
...
ABI33_0_0UM_EXPORT_METHOD_AS(getRegisteredTasksAsync,
                    getRegisteredTasks:(ABI33_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  resolve([_taskService getRegisteredTasksForAppId:_appId]);
}

ABI33_0_0UM_EXPORT_METHOD_AS(getTaskOptionsAsync,
                    getConfigurationForTaskName:(nonnull NSString *)taskName
                    resolve:(ABI33_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  resolve(ABI33_0_0UMNullIfNil([_taskService getOptionsForTaskName:taskName forAppId:_appId]));
}
...
ABI33_0_0UM_EXPORT_METHOD_AS(unregisterAllTasksAsync,
                    unregisterAllTasks:(ABI33_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
...
# pragma mark - ABI33_0_0UMTaskManagerInterface
...
{
  return [ABI33_0_0EXTaskService hasBackgroundModeEnabled:backgroundMode];
}
...
- (void)executeWithBody:(NSDictionary *)body
{
  if (!_eventsQueue) {
    ...
    [_eventEmitter sendEventWithName:ABI33_0_0EXTaskManagerEventName body:body];
  } else {
