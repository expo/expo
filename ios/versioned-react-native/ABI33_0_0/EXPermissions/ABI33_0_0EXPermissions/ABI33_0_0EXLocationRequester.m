...
@interface ABI33_0_0EXLocationRequester () <CLLocationManagerDelegate>
...
@implementation ABI33_0_0EXLocationRequester
...
- (void)requestPermissionsWithResolver:(ABI33_0_0UMPromiseResolveBlock)resolve rejecter:(ABI33_0_0UMPromiseRejectBlock)reject
{
  ...
  if (existingPermissions && ![existingPermissions[@"status"] isEqualToString:[ABI33_0_0EXPermissions permissionStringForStatus:ABI33_0_0EXPermissionStatusUndetermined]]) {
