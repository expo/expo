...
#import <ABI33_0_0EXMailComposer/ABI33_0_0EXMailComposer.h>
...
@interface ABI33_0_0EXMailComposer ()
...
@implementation ABI33_0_0EXMailComposer

ABI33_0_0UM_EXPORT_MODULE(ExpoMailComposer);
...
ABI33_0_0UM_EXPORT_METHOD_AS(composeAsync,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  self.reject = reject;
  id<ABI33_0_0UMUtilitiesInterface> utilities = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI33_0_0UMUtilitiesInterface)];
