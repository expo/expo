...
#import <ABI33_0_0EXLocation/ABI33_0_0EXLocation.h>
#import <ABI33_0_0EXLocation/ABI33_0_0EXLocationDelegate.h>
#import <ABI33_0_0EXLocation/ABI33_0_0EXLocationTaskConsumer.h>
#import <ABI33_0_0EXLocation/ABI33_0_0EXGeofencingTaskConsumer.h>
...
NSString * const ABI33_0_0EXLocationChangedEventName = @"Expo.locationChanged";
NSString * const ABI33_0_0EXHeadingChangedEventName = @"Expo.headingChanged";

@interface ABI33_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI33_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) NSMutableSet<ABI33_0_0EXLocationDelegate *> *retainedDelegates;
@property (nonatomic, assign, getter=isPaused) BOOL paused;
@property (nonatomic, weak) id<ABI33_0_0UMEventEmitterService> eventEmitter;
@property (nonatomic, weak) id<ABI33_0_0UMPermissionsInterface> permissions;
@property (nonatomic, weak) id<ABI33_0_0UMAppLifecycleService> lifecycleService;
@property (nonatomic, weak) id<ABI33_0_0UMTaskManagerInterface> tasksManager;

@end

@implementation ABI33_0_0EXLocation

ABI33_0_0UM_EXPORT_MODULE(ExpoLocation);
...
- (void)setModuleRegistry:(ABI33_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  _permissions = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI33_0_0UMPermissionsInterface)];
  _lifecycleService = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI33_0_0UMAppLifecycleService)];
  _tasksManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI33_0_0UMTaskManagerInterface)];
...
{
  return @[ABI33_0_0EXLocationChangedEventName, ABI33_0_0EXHeadingChangedEventName];
}
...
ABI33_0_0UM_EXPORT_METHOD_AS(getProviderStatusAsync,
...
ABI33_0_0UM_EXPORT_METHOD_AS(getCurrentPositionAsync,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI33_0_0EXLocationDelegate *delegate;

  delegate = [[ABI33_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (delegate != nil) {
      if (locations.lastObject != nil) {
        resolve([ABI33_0_0EXLocation exportLocation:locations.lastObject]);
      } else {
...
ABI33_0_0UM_EXPORT_METHOD_AS(watchPositionImplAsync,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  ABI33_0_0EXLocationDelegate *delegate = [[ABI33_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject != nil && weakSelf != nil) {
      ...
      NSDictionary *body = @{
                             @"watchId": watchId,
                             @"location": [ABI33_0_0EXLocation exportLocation:loc],
                             };

      [strongSelf->_eventEmitter sendEventWithName:ABI33_0_0EXLocationChangedEventName body:body];
    }
  } onUpdateHeadings:nil onError:^(NSError *error) {
    // TODO: report errors
...
ABI33_0_0UM_EXPORT_METHOD_AS(watchDeviceHeading,
  ...
  ABI33_0_0EXLocationDelegate *delegate = [[ABI33_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
    if (newHeading != nil && weakSelf != nil) {
      ...
      [strongSelf->_eventEmitter sendEventWithName:ABI33_0_0EXHeadingChangedEventName body:body];
    }
...
ABI33_0_0UM_EXPORT_METHOD_AS(removeWatchAsync,
                    watchId:(nonnull NSNumber *)watchId
                    resolver:(ABI33_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ABI33_0_0EXLocationDelegate *delegate = _delegates[watchId];
...
ABI33_0_0UM_EXPORT_METHOD_AS(geocodeAsync,
...
ABI33_0_0UM_EXPORT_METHOD_AS(reverseGeocodeAsync,
...
ABI33_0_0UM_EXPORT_METHOD_AS(requestPermissionsAsync,
                    requestPermissionsResolver:(ABI33_0_0UMPromiseResolveBlock)resolve
                                      rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  if (!_permissions) {
...
ABI33_0_0UM_EXPORT_METHOD_AS(hasServicesEnabledAsync,
                    hasServicesEnabled:(ABI33_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
...
ABI33_0_0UM_EXPORT_METHOD_AS(startLocationUpdatesAsync,
                    ...
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI33_0_0EXLocationTaskConsumer class] options:options];
  }
  @catch (NSException *e) {
...
ABI33_0_0UM_EXPORT_METHOD_AS(stopLocationUpdatesAsync,
                    ...
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI33_0_0EXLocationTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI33_0_0UM_EXPORT_METHOD_AS(hasStartedLocationUpdatesAsync,
                    ...
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI33_0_0EXLocationTaskConsumer class]]));
}

# pragma mark - Geofencing

ABI33_0_0UM_EXPORT_METHOD_AS(startGeofencingAsync,
                    ...
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI33_0_0EXGeofencingTaskConsumer class] options:options];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI33_0_0UM_EXPORT_METHOD_AS(stopGeofencingAsync,
                    ...
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI33_0_0EXGeofencingTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI33_0_0UM_EXPORT_METHOD_AS(hasStartedGeofencingAsync,
                    ...
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI33_0_0EXGeofencingTaskConsumer class]]));
}
...
- (CLLocationManager *)locationManagerWithOptions:(NSDictionary *)options
{
  ...
  if (options[@"accuracy"]) {
    ABI33_0_0EXLocationAccuracy accuracy = [options[@"accuracy"] unsignedIntegerValue] ?: ABI33_0_0EXLocationAccuracyBalanced;
    locMgr.desiredAccuracy = [self.class CLLocationAccuracyFromOption:accuracy];
  }
  return locMgr;
}

- (BOOL)checkPermissions:(ABI33_0_0UMPromiseRejectBlock)reject
{
...
- (BOOL)checkTaskManagerExists:(ABI33_0_0UMPromiseRejectBlock)reject
{
...
- (BOOL)checkBackgroundServices:(ABI33_0_0UMPromiseRejectBlock)reject
{
...
{
  switch (accuracy) {
    case ABI33_0_0EXLocationAccuracyLowest:
      return kCLLocationAccuracyThreeKilometers;
    case ABI33_0_0EXLocationAccuracyLow:
      return kCLLocationAccuracyKilometer;
    case ABI33_0_0EXLocationAccuracyBalanced:
      return kCLLocationAccuracyHundredMeters;
    case ABI33_0_0EXLocationAccuracyHigh:
      return kCLLocationAccuracyNearestTenMeters;
    case ABI33_0_0EXLocationAccuracyHighest:
      return kCLLocationAccuracyBest;
    case ABI33_0_0EXLocationAccuracyBestForNavigation:
