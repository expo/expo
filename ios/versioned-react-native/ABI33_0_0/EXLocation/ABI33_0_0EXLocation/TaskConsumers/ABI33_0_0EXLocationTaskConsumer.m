...
@interface ABI33_0_0EXLocationTaskConsumer ()
...
@implementation ABI33_0_0EXLocationTaskConsumer
...
# pragma mark - ABI33_0_0UMTaskConsumerInterface
...
- (void)setOptions:(NSDictionary *)options
{
  [ABI33_0_0UMUtilities performSynchronouslyOnMainThread:^{
    ...
    locationManager.desiredAccuracy = [ABI33_0_0EXLocation CLLocationAccuracyFromOption:accuracy];
    locationManager.distanceFilter = [options[@"distanceInterval"] doubleValue] ?: kCLDistanceFilterNone;
    locationManager.activityType = [ABI33_0_0EXLocation CLActivityTypeFromOption:[options[@"activityType"] integerValue]];
...
- (void)executeTaskWithDeferredLocations
{
  ...
  NSDictionary *data = @{ @"locations": [ABI33_0_0EXLocationTaskConsumer _exportLocations:_deferredLocations] };
...
+ (NSArray<NSDictionary *> *)_exportLocations:(NSArray<CLLocation *> *)locations
{
  ...
  for (CLLocation *location in locations) {
    [result addObject:[ABI33_0_0EXLocation exportLocation:location]];
  }
  return result;
}
