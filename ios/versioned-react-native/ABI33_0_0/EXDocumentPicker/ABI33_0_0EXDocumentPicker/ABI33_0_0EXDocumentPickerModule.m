...
#import <ABI33_0_0EXDocumentPicker/ABI33_0_0EXDocumentPickerModule.h>
...
static NSString * ABI33_0_0EXConvertMimeTypeToUTI(NSString *mimeType)
{
  CFStringRef uti;
...
@interface ABI33_0_0EXDocumentPickerModule () <UIDocumentMenuDelegate, UIDocumentPickerDelegate>
...
@implementation ABI33_0_0EXDocumentPickerModule

ABI33_0_0UM_EXPORT_MODULE(ExpoDocumentPicker);
...
ABI33_0_0UM_EXPORT_METHOD_AS(getDocumentAsync,
                    ...
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSString *type = ABI33_0_0EXConvertMimeTypeToUTI(options[@"type"] ?: @"*/*");
