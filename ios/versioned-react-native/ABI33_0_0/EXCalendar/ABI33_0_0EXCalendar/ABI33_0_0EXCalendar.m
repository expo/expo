...
#import <ABI33_0_0EXCalendar/ABI33_0_0EXCalendar.h>
#import <ABI33_0_0EXCalendar/ABI33_0_0EXCalendarConverter.h>

#import <ABI33_0_0UMPermissionsInterface/ABI33_0_0UMPermissionsInterface.h>

@interface ABI33_0_0EXCalendar ()
...
@implementation ABI33_0_0EXCalendar

ABI33_0_0UM_EXPORT_MODULE(ExpoCalendar);
...
ABI33_0_0UM_EXPORT_METHOD_AS(getCalendarsAsync,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI33_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI33_0_0UM_EXPORT_METHOD_AS(saveCalendarAsync,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (color) {
    calendar.CGColor = [ABI33_0_0UMUtilities UIColor:color].CGColor;
...
ABI33_0_0UM_EXPORT_METHOD_AS(deleteCalendarAsync,
...
ABI33_0_0UM_EXPORT_METHOD_AS(getEventsAsync,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI33_0_0UMUtilities NSDate:startDateStr];
  NSDate *endDate = [ABI33_0_0UMUtilities NSDate:endDateStr];
  ...
  if (calendarEvents) {
    resolve([ABI33_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI33_0_0UM_EXPORT_METHOD_AS(getEventByIdAsync,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (calendarEvent) {
    resolve([ABI33_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI33_0_0UM_EXPORT_METHOD_AS(saveEventAsync,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI33_0_0UMUtilities NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI33_0_0UMUtilities NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI33_0_0UMUtilities NSDate:details[@"instanceStartDate"]];
  ...
  if (recurrenceRule) {
    ...
    if (recurrenceRule[@"endDate"]) {
      endDate = [ABI33_0_0UMUtilities NSDate:recurrenceRule[@"endDate"]];
    }
...
ABI33_0_0UM_EXPORT_METHOD_AS(deleteEventAsync,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *instanceStartDate = [ABI33_0_0UMUtilities NSDate:event[@"instanceStartDate"]];
...
ABI33_0_0UM_EXPORT_METHOD_AS(getAttendeesForEventAsync,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (item.hasAttendees) {
    resolve([ABI33_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI33_0_0UM_EXPORT_METHOD_AS(getRemindersAsync,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI33_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI33_0_0UM_EXPORT_METHOD_AS(getReminderByIdAsync,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (reminder) {
    ...
    resolve([ABI33_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI33_0_0UM_EXPORT_METHOD_AS(saveReminderAsync,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI33_0_0UMUtilities NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI33_0_0UMUtilities NSDate:details[@"dueDate"]];
  NSDate *completionDate = [ABI33_0_0UMUtilities NSDate:details[@"completionDate"]];
...
ABI33_0_0UM_EXPORT_METHOD_AS(deleteReminderAsync,
...
ABI33_0_0UM_EXPORT_METHOD_AS(getSourcesAsync,
                    getSourcesAsync:(ABI33_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI33_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI33_0_0UM_EXPORT_METHOD_AS(getSourceByIdAsync,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI33_0_0EXCalendarConverter serializeSource:source]);
}

ABI33_0_0UM_EXPORT_METHOD_AS(requestPermissionsAsync,
                    requestPermissionsAsync:(ABI33_0_0UMPromiseResolveBlock)resolve
...
ABI33_0_0UM_EXPORT_METHOD_AS(requestRemindersPermissionsAsync,
                    requestRemindersPermissionsAsync:(ABI33_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  if (!_permissionsManager) {
    return reject(@"E_NO_PERMISSIONS", @"Permissions module not found. Are you sure that Expo modules are properly linked?", nil);
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI33_0_0UMUtilities NSDate:alarm[@"absoluteDate"]];
...
- (BOOL)_checkPermissions:(NSString *)permissionType reject:(ABI33_0_0UMPromiseRejectBlock)reject
{
...
- (BOOL)_checkCalendarPermissions:(ABI33_0_0UMPromiseRejectBlock)reject
{
  return [self _checkPermissions:@"calendar" reject:reject];
}

- (BOOL)_checkRemindersPermissions:(ABI33_0_0UMPromiseRejectBlock)reject
{
