...
#import <ABI33_0_0EXPrint/ABI33_0_0EXPrint.h>
#import <ABI33_0_0EXPrint/ABI33_0_0EXPrintPDFRenderTask.h>
...
NSString *const ABI33_0_0EXPrintOrientationPortrait = @"portrait";
NSString *const ABI33_0_0EXPrintOrientationLandscape = @"landscape";

@interface ABI33_0_0EXPrint () <UIPrintInteractionControllerDelegate, UIPrinterPickerControllerDelegate>
...
@implementation ABI33_0_0EXPrint

ABI33_0_0UM_EXPORT_MODULE(ExponentPrint);
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"Orientation": @{
               @"portrait": ABI33_0_0EXPrintOrientationPortrait,
               @"landscape": ABI33_0_0EXPrintOrientationLandscape,
               },
           };
}

ABI33_0_0UM_EXPORT_METHOD_AS(print,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  [self _getPrintingDataForOptions:options callback:^(NSData *printingData, NSDictionary *errorDetails) {
    if (errorDetails != nil) {
      reject(errorDetails[@"code"], errorDetails[@"message"], ABI33_0_0UMErrorWithMessage(errorDetails[@"message"]));
      return;
    }
    ...
    if (printingData == nil) {
      ...
      if (options[@"markupFormatterIOS"] && [options[@"markupFormatterIOS"] isKindOfClass:[NSString class]]) {
        ...
        if (htmlString != nil) {
          ...
          reject(@"E_HTML_INVALID", message, ABI33_0_0UMErrorWithMessage(message));
          return;
        }
      } else {
...
ABI33_0_0UM_EXPORT_METHOD_AS(selectPrinter,selectPrinter:(ABI33_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
...
ABI33_0_0UM_EXPORT_METHOD_AS(printToFileAsync,
                    ...
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  ABI33_0_0EXPrintPDFRenderTask *renderTask = [ABI33_0_0EXPrintPDFRenderTask new];
...
{
  id<ABI33_0_0UMUtilitiesInterface> utils = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI33_0_0UMUtilitiesInterface)];
...
- (void)_getPrintingDataForOptions:(nonnull NSDictionary *)options callback:(void(^)(NSData *, NSDictionary *))callback
{
  ...
  if (options[@"html"]) {
    __block ABI33_0_0EXPrintPDFRenderTask *renderTask = [ABI33_0_0EXPrintPDFRenderTask new];
...
{
  if ([orientation isEqualToString:ABI33_0_0EXPrintOrientationLandscape]) {
