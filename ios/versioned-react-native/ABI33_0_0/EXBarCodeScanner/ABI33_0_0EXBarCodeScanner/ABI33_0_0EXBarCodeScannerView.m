...
@interface ABI33_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI33_0_0EXBarCodeScanner *barCodeScanner;
...
@property (nonatomic, copy) ABI33_0_0UMDirectEventBlock onCameraReady;
@property (nonatomic, copy) ABI33_0_0UMDirectEventBlock onMountError;
@property (nonatomic, copy) ABI33_0_0UMDirectEventBlock onBarCodeScanned;

@end

@implementation ABI33_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI33_0_0UMModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI33_0_0UMAppLifecycleListener)];
...
{
  ABI33_0_0UM_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI33_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI33_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI33_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI33_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI33_0_0EXBarCodeScanner *barCodeScanner = [ABI33_0_0EXBarCodeScanner new];
