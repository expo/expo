...
#import <ABI33_0_0EXImageManipulator/ABI33_0_0EXImageManipulatorModule.h>
...
@interface ABI33_0_0EXImageManipulatorModule ()
...
@implementation ABI33_0_0EXImageManipulatorModule

ABI33_0_0UM_EXPORT_MODULE(ExpoImageManipulator);
...
ABI33_0_0UM_EXPORT_METHOD_AS(manipulateAsync,
                    uri:(NSString *)uri
                    ...
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (!([_fileSystem permissionsForURI:url] & ABI33_0_0UMFileSystemPermissionRead)) {
