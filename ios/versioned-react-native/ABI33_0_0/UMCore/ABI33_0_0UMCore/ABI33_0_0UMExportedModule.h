...
// Register a subclass of this class in ABI33_0_0UMModuleRegistryProvider
...
@interface ABI33_0_0UMExportedModule : NSObject <ABI33_0_0UMInternalModule, NSCopying>

- (NSDictionary *)constantsToExport;
+ (const NSString *)exportedModuleName;
- (NSDictionary<NSString *, NSString *> *)getExportedMethods;
- (void)callExportedMethod:(NSString *)methodName withArguments:(NSArray *)arguments resolver:(ABI33_0_0UMPromiseResolveBlock)resolver rejecter:(ABI33_0_0UMPromiseRejectBlock)rejecter;
