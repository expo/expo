...
@implementation ABI33_0_0UMAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitialized {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI33_0_0UMSingletonModule*> * singletonModules = [[ABI33_0_0UMModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI33_0_0UMSingletonModule *singletonModule in singletonModules) {
