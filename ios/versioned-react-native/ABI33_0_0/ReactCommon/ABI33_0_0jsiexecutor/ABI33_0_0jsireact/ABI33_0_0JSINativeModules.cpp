...
#include <ABI33_0_0jsireact/ABI33_0_0JSINativeModules.h>
...
ABI33_0_0JSINativeModules::ABI33_0_0JSINativeModules(
    std::shared_ptr<ModuleRegistry> moduleRegistry)
    : m_moduleRegistry(std::move(moduleRegistry)) {}

Value ABI33_0_0JSINativeModules::getModule(Runtime& rt, const PropNameID& name) {
  if (!m_moduleRegistry) {
    return nullptr;
  }
...
void ABI33_0_0JSINativeModules::reset() {
  m_genNativeModuleJS = folly::none;
  m_objects.clear();
}

folly::Optional<Object> ABI33_0_0JSINativeModules::createModule(
    Runtime& rt,
