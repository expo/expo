...
#include "ABI33_0_0CxxNativeModule.h"
#include "ABI33_0_0Instance.h"

#include <iterator>
#include <glog/logging.h>
#include <folly/json.h>

#include "ABI33_0_0JsArgumentHelpers.h"
...
void CxxNativeModule::invoke(unsigned int ReactABI33_0_0MethodId, folly::dynamic&& params, int callId) {
  if (ReactABI33_0_0MethodId >= methods_.size()) {
    throw std::invalid_argument(folly::to<std::string>("methodId ", ReactABI33_0_0MethodId,
  ...
  const auto& method = methods_[ReactABI33_0_0MethodId];
