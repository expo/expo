...
#include <ReactABI33_0_0/uimanager/ComponentDescriptorFactory.h>
#include <ReactABI33_0_0/uimanager/UITemplateProcessor.h>

using namespace facebook::ReactABI33_0_0;

#include <ReactABI33_0_0/components/activityindicator/ActivityIndicatorViewComponentDescriptor.h>
#include <ReactABI33_0_0/components/image/ImageComponentDescriptor.h>
#include <ReactABI33_0_0/components/scrollview/ScrollViewComponentDescriptor.h>
#include <ReactABI33_0_0/components/text/ParagraphComponentDescriptor.h>
#include <ReactABI33_0_0/components/text/RawTextComponentDescriptor.h>
#include <ReactABI33_0_0/components/text/TextComponentDescriptor.h>
...
class MockReactABI33_0_0NativeConfig : public ReactABI33_0_0NativeConfig {
 public:
  MockReactABI33_0_0NativeConfig() {}
...
std::shared_ptr<const ReactABI33_0_0NativeConfig> mockReactABI33_0_0NativeConfig_ =
    std::make_shared<const MockReactABI33_0_0NativeConfig>();
...
TEST(UITemplateProcessorTest, testSimpleBytecode) {
  ...
  auto bytecode = R"delim({"version":0.1,"commands":[
    ["createNode",2,"ABI33_0_0RCTView",-1,{"opacity": 0.5, "testId": "root"}],
    ["createNode",4,"ABI33_0_0RCTView",2,{"testId": "child"}],
    ["returnRoot",2]
  ]})delim";
  ...
  auto root1 = UITemplateProcessor::buildShadowTree(
      ...
      *componentDescriptorRegistry,
      ...
      mockReactABI33_0_0NativeConfig_);
#ifndef NDEBUG
...
TEST(UITemplateProcessorTest, testConditionalBytecode) {
  ...
  auto bytecode = R"delim({"version":0.1,"commands":[
    ["createNode",2,"ABI33_0_0RCTView",-1,{"testId": "root"}],
    ["loadNativeBool",1,"MobileConfig","getBool",["qe:simple_test"]],
    ["conditional",1,
      [["createNode",4,"ABI33_0_0RCTView",2,{"testId": "cond_true"}]],
      [["createNode",4,"ABI33_0_0RCTView",2,{"testId": "cond_false"}]]
    ],
    ["returnRoot",2]
  ]})delim";
