...
#include "ABI33_0_0UITemplateProcessor.h"

#include <folly/json.h>
#include <glog/logging.h>
#include <ReactABI33_0_0/components/view/ViewComponentDescriptor.h>
#include <ReactABI33_0_0/components/view/ViewProps.h>
#include <ReactABI33_0_0/components/view/ViewShadowNode.h>
#include <ReactABI33_0_0/core/ComponentDescriptor.h>
#include <ReactABI33_0_0/core/LayoutContext.h>
#include <ReactABI33_0_0/core/ShadowNodeFragment.h>
...
SharedShadowNode UITemplateProcessor::runCommand(
    ...
    const ComponentDescriptorRegistry &componentDescriptorRegistry,
    const NativeModuleRegistry &nativeModuleRegistry,
    const std::shared_ptr<const ReactABI33_0_0NativeConfig> ReactABI33_0_0NativeConfig) {
  ...
  if (opcode == "createNode") {
    ...
    registers[registerNumber] = ReactABI33_0_0NativeConfig->getBool(param);
...
SharedShadowNode UITemplateProcessor::buildShadowTree(
  ...
  LOG(ERROR) << "ReactABI33_0_0 ui template missing returnRoot command :(";
