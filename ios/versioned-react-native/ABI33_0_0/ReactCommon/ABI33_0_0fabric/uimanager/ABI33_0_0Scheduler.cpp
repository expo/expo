...
#include <ReactABI33_0_0/uimanager/ComponentDescriptorRegistry.h>
#include <ReactABI33_0_0/uimanager/TimeUtils.h>
#include <ReactABI33_0_0/uimanager/UIManager.h>
#include <ReactABI33_0_0/uimanager/UIManagerBinding.h>
#include <ReactABI33_0_0/uimanager/UITemplateProcessor.h>
...
Scheduler::Scheduler(
  ...
  ReactABI33_0_0NativeConfig_ =
      contextContainer->getInstance<std::shared_ptr<const ReactABI33_0_0NativeConfig>>(
...
void Scheduler::renderTemplateToSurface(
  ...
  try {
    ...
    LOG(ERROR) << "    >>>> ABI33_0_0EXCEPTION <<<  rendering uiTemplate in "
