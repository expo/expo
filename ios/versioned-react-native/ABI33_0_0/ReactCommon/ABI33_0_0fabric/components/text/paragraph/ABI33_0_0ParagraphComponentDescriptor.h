...
#include "ABI33_0_0ParagraphMeasurementCache.h"
#include "ABI33_0_0ParagraphShadowNode.h"
...
class ParagraphComponentDescriptor final
 ...
 public:
  ParagraphComponentDescriptor(
    ...
    // measurements.
#ifdef ANDROID
    auto paramName = "ReactABI33_0_0_fabric:enabled_paragraph_measure_cache_android";
#else
    auto paramName = "ReactABI33_0_0_fabric:enabled_paragraph_measure_cache_ios";
#endif
    // TODO: T39927960 - get rid of this if statement
    bool enableCache =
        (contextContainer != nullptr
             ? contextContainer
                   ->getInstance<std::shared_ptr<const ReactABI33_0_0NativeConfig>>(
