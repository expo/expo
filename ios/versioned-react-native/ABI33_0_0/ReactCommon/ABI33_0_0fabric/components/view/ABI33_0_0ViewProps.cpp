...
ViewProps::ViewProps(const ABI33_0_0YGStyle &ABI33_0_0yogaStyle) : YogaStylableProps(ABI33_0_0yogaStyle) {}
...
BorderMetrics ViewProps::resolveBorderMetrics(bool isRTL) const {
  auto borderWidths = CascadedBorderWidths{
      .left = optionalFloatFromYogaValue(ABI33_0_0yogaStyle.border[ABI33_0_0YGEdgeLeft]),
      .top = optionalFloatFromYogaValue(ABI33_0_0yogaStyle.border[ABI33_0_0YGEdgeTop]),
      .right = optionalFloatFromYogaValue(ABI33_0_0yogaStyle.border[ABI33_0_0YGEdgeRight]),
      .bottom = optionalFloatFromYogaValue(ABI33_0_0yogaStyle.border[ABI33_0_0YGEdgeBottom]),
      .start = optionalFloatFromYogaValue(ABI33_0_0yogaStyle.border[ABI33_0_0YGEdgeStart]),
      .end = optionalFloatFromYogaValue(ABI33_0_0yogaStyle.border[ABI33_0_0YGEdgeEnd]),
      .horizontal =
          optionalFloatFromYogaValue(ABI33_0_0yogaStyle.border[ABI33_0_0YGEdgeHorizontal]),
      .vertical = optionalFloatFromYogaValue(ABI33_0_0yogaStyle.border[ABI33_0_0YGEdgeVertical]),
      .all = optionalFloatFromYogaValue(ABI33_0_0yogaStyle.border[ABI33_0_0YGEdgeAll])};
