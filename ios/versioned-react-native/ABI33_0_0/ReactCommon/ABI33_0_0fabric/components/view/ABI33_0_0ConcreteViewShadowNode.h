...
#include <ReactABI33_0_0/components/view/AccessibleShadowNode.h>
...
class ConcreteViewShadowNode : public ConcreteShadowNode<
 ...
 public:
  ...
  void appendChild(const SharedShadowNode &child) {
    ...
    auto ABI33_0_0yogaLayoutableChild =
        dynamic_cast<YogaLayoutableShadowNode *>(nonConstChild);
    if (ABI33_0_0yogaLayoutableChild) {
      YogaLayoutableShadowNode::appendChild(ABI33_0_0yogaLayoutableChild);
    }
  }
