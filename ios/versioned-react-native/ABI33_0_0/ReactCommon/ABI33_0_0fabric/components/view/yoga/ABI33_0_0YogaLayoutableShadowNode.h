...
#include <ReactABI33_0_0/components/view/YogaStylableProps.h>
#include <ReactABI33_0_0/core/LayoutableShadowNode.h>
...
#pragma mark - LayoutableShadowNode
 ...
 protected:
   ...
   * all the time.
   */
  mutable ABI33_0_0YGNode ABI33_0_0yogaNode_;

  /*
   * Yoga config associated (only) with this particular node.
   */
  ABI33_0_0YGConfig ABI33_0_0yogaConfig_;

 private:
  static void initializeYogaConfig(ABI33_0_0YGConfig &config);
  static ABI33_0_0YGNode *ABI33_0_0yogaNodeCloneCallbackConnector(
      ABI33_0_0YGNode *oldYogaNode,
      ABI33_0_0YGNode *parentYogaNode,
      int childIndex);
  static ABI33_0_0YGSize ABI33_0_0yogaNodeMeasureCallbackConnector(
