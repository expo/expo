...
#include <ReactABI33_0_0/core/LayoutPrimitives.h>
...
namespace std {
template <>
struct hash<facebook::ReactABI33_0_0::LayoutConstraints> {
  size_t operator()(
      const facebook::ReactABI33_0_0::LayoutConstraints &constraints) const {
    auto seed = size_t{0};
