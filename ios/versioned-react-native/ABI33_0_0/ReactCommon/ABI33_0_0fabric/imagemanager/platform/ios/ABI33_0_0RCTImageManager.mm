...
#import "ABI33_0_0RCTImagePrimitivesConversions.h"

using namespace facebook::ReactABI33_0_0;

@implementation ABI33_0_0RCTImageManager {
  ABI33_0_0RCTImageLoader *_imageLoader;
}
...
- (ImageRequest)requestImage:(const ImageSource &)imageSource {
  ...
  ABI33_0_0RCTImageLoaderCancellationBlock cancelationBlock =
