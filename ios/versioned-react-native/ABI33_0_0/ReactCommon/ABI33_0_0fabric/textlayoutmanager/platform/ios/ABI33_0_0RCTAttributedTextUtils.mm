...
#include <ReactABI33_0_0/textlayoutmanager/ABI33_0_0RCTFontProperties.h>
#include <ReactABI33_0_0/textlayoutmanager/ABI33_0_0RCTFontUtils.h>
#include <ReactABI33_0_0/textlayoutmanager/ABI33_0_0RCTTextPrimitivesConversions.h>

using namespace facebook::ReactABI33_0_0;

@implementation ABI33_0_0RCTWeakEventEmitterWrapper {
...
inline static UIFont *ABI33_0_0RCTEffectiveFontFromTextAttributes(
  ...
  fontProperties.style = textAttributes.fontStyle.hasValue()
      ? ABI33_0_0RCTFontStyleFromFontStyle(textAttributes.fontStyle.value())
      : ABI33_0_0RCTFontStyleUndefined;
  fontProperties.variant = textAttributes.fontVariant.hasValue()
      ? ABI33_0_0RCTFontVariantFromFontVariant(textAttributes.fontVariant.value())
      : ABI33_0_0RCTFontVariantDefault;
  ...
  return ABI33_0_0RCTFontWithFontProperties(fontProperties);
}

inline static CGFloat ABI33_0_0RCTEffectiveFontSizeMultiplierFromTextAttributes(
    const TextAttributes &textAttributes) {
...
inline static UIColor *ABI33_0_0RCTEffectiveForegroundColorFromTextAttributes(
    const TextAttributes &textAttributes) {
  UIColor *effectiveForegroundColor =
      ABI33_0_0RCTUIColorFromSharedColor(textAttributes.foregroundColor)
      ?: [UIColor blackColor];
...
inline static UIColor *ABI33_0_0RCTEffectiveBackgroundColorFromTextAttributes(
    const TextAttributes &textAttributes) {
  UIColor *effectiveBackgroundColor =
      ABI33_0_0RCTUIColorFromSharedColor(textAttributes.backgroundColor);
...
ABI33_0_0RCTNSTextAttributesFromTextAttributes(const TextAttributes &textAttributes) {
  NSMutableDictionary<NSAttributedStringKey, id> *attributes =
      [NSMutableDictionary dictionaryWithCapacity:10];

  // Font
  UIFont *font = ABI33_0_0RCTEffectiveFontFromTextAttributes(textAttributes);
  if (font) {
  ...
  // Colors
  UIColor *effectiveForegroundColor =
      ABI33_0_0RCTEffectiveForegroundColorFromTextAttributes(textAttributes);
  ...
  if (textAttributes.backgroundColor || !isnan(textAttributes.opacity)) {
    attributes[NSBackgroundColorAttributeName] =
        ABI33_0_0RCTEffectiveBackgroundColorFromTextAttributes(textAttributes);
  }
  ...
  if (textAttributes.alignment.hasValue()) {
    ...
    paragraphStyle.alignment =
        ABI33_0_0RCTNSTextAlignmentFromTextAlignment(textAlignment);
    isParagraphStyleUsed = YES;
  }

  if (textAttributes.baseWritingDirection.hasValue()) {
    paragraphStyle.baseWritingDirection =
        ABI33_0_0RCTNSWritingDirectionFromWritingDirection(
  ...
  if (!isnan(textAttributes.lineHeight)) {
    CGFloat lineHeight = textAttributes.lineHeight *
        ABI33_0_0RCTEffectiveFontSizeMultiplierFromTextAttributes(textAttributes);
  ...
  if (textAttributes.textDecorationLineType.value_or(
    ...
    NSUnderlineStyle style = ABI33_0_0RCTNSUnderlineStyleFromStyleAndPattern(
    ...
    UIColor *textDecorationColor =
        ABI33_0_0RCTUIColorFromSharedColor(textAttributes.textDecorationColor);
  ...
  if (textAttributes.textShadowOffset.hasValue()) {
    ...
    shadow.shadowColor =
        ABI33_0_0RCTUIColorFromSharedColor(textAttributes.textShadowColor);
    attributes[NSShadowAttributeName] = shadow;
  }

  // Special
  if (textAttributes.isHighlighted) {
    attributes[ABI33_0_0RCTAttributedStringIsHighlightedAttributeName] = @YES;
  }
  ...
  for (auto fragment : attributedString.getFragments()) {
    ...
    if (layoutMetrics != EmptyLayoutMetrics) {
      ...
      nsAttributedStringFragment = [[NSAttributedString alloc]
          initWithString:string
              attributes:ABI33_0_0RCTNSTextAttributesFromTextAttributes(
    ...
    if (fragment.parentShadowView.componentHandle) {
      ABI33_0_0RCTWeakEventEmitterWrapper *eventEmitterWrapper =
          [ABI33_0_0RCTWeakEventEmitterWrapper new];
      eventEmitterWrapper.eventEmitter = fragment.parentShadowView.eventEmitter;

      NSDictionary<NSAttributedStringKey, id> *additionalTextAttributes =
          @{ABI33_0_0RCTAttributedStringEventEmitterKey : eventEmitterWrapper};
