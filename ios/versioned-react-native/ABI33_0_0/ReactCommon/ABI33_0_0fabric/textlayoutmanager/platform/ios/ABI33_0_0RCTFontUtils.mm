...
#import "ABI33_0_0RCTFontUtils.h"

#import <cmath>
#import <mutex>

static ABI33_0_0RCTFontProperties ABI33_0_0RCTDefaultFontProperties() {
  static ABI33_0_0RCTFontProperties defaultFontProperties;
  ...
  dispatch_once(&onceToken, ^{
    ...
    defaultFontProperties.style = ABI33_0_0RCTFontStyleNormal;
    defaultFontProperties.variant = ABI33_0_0RCTFontVariantDefault;
...
static ABI33_0_0RCTFontProperties ABI33_0_0RCTResolveFontProperties(
    ABI33_0_0RCTFontProperties fontProperties) {
  ABI33_0_0RCTFontProperties defaultFontProperties = ABI33_0_0RCTDefaultFontProperties();
  ...
  fontProperties.style = fontProperties.style != ABI33_0_0RCTFontStyleUndefined
      ? fontProperties.style
      : defaultFontProperties.style;
  fontProperties.variant = fontProperties.variant != ABI33_0_0RCTFontVariantUndefined
      ? fontProperties.variant
      : defaultFontProperties.variant;
  return fontProperties;
}

static UIFontWeight ABI33_0_0RCTGetFontWeight(UIFont *font) {
  NSDictionary *traits =
      [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  return [traits[UIFontWeightTrait] doubleValue];
}

static ABI33_0_0RCTFontStyle ABI33_0_0RCTGetFontStyle(UIFont *font) {
  NSDictionary *traits =
      [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  ...
  if (symbolicTraits & UIFontDescriptorTraitItalic) {
    return ABI33_0_0RCTFontStyleItalic;
  }

  return ABI33_0_0RCTFontStyleNormal;
}

static NSArray *ABI33_0_0RCTFontFeatures(ABI33_0_0RCTFontVariant fontVariant) {
  // FIXME:
  return @[];
}

static UIFontWeight ABI33_0_0RCTUIFontWeightFromFloat(CGFloat fontWeight) {
...
static UIFont *ABI33_0_0RCTDefaultFontWithFontProperties(
    ABI33_0_0RCTFontProperties fontProperties) {
  ...
  if (!font) {
    font = [UIFont
        systemFontOfSize:fontProperties.size
                  weight:ABI33_0_0RCTUIFontWeightFromFloat(fontProperties.weight)];

    if (fontProperties.variant == ABI33_0_0RCTFontStyleItalic) {
...
UIFont *ABI33_0_0RCTFontWithFontProperties(ABI33_0_0RCTFontProperties fontProperties) {
  ABI33_0_0RCTFontProperties defaultFontProperties = ABI33_0_0RCTDefaultFontProperties();
  fontProperties = ABI33_0_0RCTResolveFontProperties(fontProperties);
  ...
  if ([fontProperties.family isEqualToString:defaultFontProperties.family]) {
    ...
    font = ABI33_0_0RCTDefaultFontWithFontProperties(fontProperties);
  } else {
    ...
    if (fontNames.count == 0) {
      ...
      for (NSString *name in fontNames) {
        ...
        if (ABI33_0_0RCTGetFontStyle(fontMatch) != fontProperties.style) {
          continue;
        }

        CGFloat testWeight = ABI33_0_0RCTGetFontWeight(fontMatch);
  ...
  if (fontProperties.variant != ABI33_0_0RCTFontVariantDefault) {
    NSArray *fontFeatures = ABI33_0_0RCTFontFeatures(fontProperties.variant);
