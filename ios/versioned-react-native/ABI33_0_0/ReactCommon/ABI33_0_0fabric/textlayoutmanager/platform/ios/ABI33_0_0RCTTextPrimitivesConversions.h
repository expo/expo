...
inline static NSTextAlignment ABI33_0_0RCTNSTextAlignmentFromTextAlignment(
...
inline static NSWritingDirection ABI33_0_0RCTNSWritingDirectionFromWritingDirection(
...
inline static ABI33_0_0RCTFontStyle ABI33_0_0RCTFontStyleFromFontStyle(FontStyle fontStyle) {
  switch (fontStyle) {
    ...
    case FontStyle::Oblique:
      return ABI33_0_0RCTFontStyleOblique;
  }
}

inline static ABI33_0_0RCTFontVariant ABI33_0_0RCTFontVariantFromFontVariant(
    FontVariant fontVariant) {
  return (ABI33_0_0RCTFontVariant)fontVariant;
}

inline static NSUnderlineStyle ABI33_0_0RCTNSUnderlineStyleFromStyleAndPattern(
...
inline static UIColor *ABI33_0_0RCTUIColorFromSharedColor(const SharedColor &color) {
