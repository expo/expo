...
#import "ABI33_0_0RCTAttributedTextUtils.h"

using namespace facebook::ReactABI33_0_0;

@implementation ABI33_0_0RCTTextLayoutManager

static NSLineBreakMode ABI33_0_0RCTNSLineBreakModeFromWritingDirection(
...
- (facebook::ReactABI33_0_0::Size)
  ...
  NSTextStorage *textStorage =
      [self _textStorageAndLayoutManagerWithAttributesString:
                ABI33_0_0RCTNSAttributedStringFromAttributedString(attributedString)
  ...
  return facebook::ReactABI33_0_0::Size{size.width, size.height};
}
...
- (NSTextStorage *)
  ...
  textContainer.lineBreakMode = paragraphAttributes.maximumNumberOfLines > 0
      ? ABI33_0_0RCTNSLineBreakModeFromWritingDirection(
...
- (SharedEventEmitter)
  ...
  if (textStorage.length > 0 && (fraction > 0 || characterIndex > 0) &&
    ...
    ABI33_0_0RCTWeakEventEmitterWrapper *eventEmitterWrapper =
        (ABI33_0_0RCTWeakEventEmitterWrapper *)[textStorage
                 attribute:ABI33_0_0RCTAttributedStringEventEmitterKey
