...
- (void)abi33_0_0_rct_scaleFontSizeToFitSize:(CGSize)size
  ...
  while (true) {
    ...
    ABI33_0_0RCTTextSizeComparisonOptions comparsion = [self abi33_0_0_rct_compareToSize:size
                                                   thresholdRatio:0.01];

    if ((comparsion & ABI33_0_0RCTTextSizeComparisonWithinRange) &&
...
- (ABI33_0_0RCTTextSizeComparisonOptions)abi33_0_0_rct_compareToSize:(CGSize)size
  ...
  result |=
      (fitsSize) ? ABI33_0_0RCTTextSizeComparisonSmaller : ABI33_0_0RCTTextSizeComparisonLarger;
