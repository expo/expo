...
#include <ReactABI33_0_0/core/conversions.h>
#include <ReactABI33_0_0/jni/ReadableNativeMap.h>
...
Size TextLayoutManager::measure(
  ...
  static auto measure =
      jni::findClassStatic("com/facebook/ReactABI33_0_0/fabric/FabricUIManager")
          ->getMethod<jlong(
              jstring,
  ...
  local_ref<JString> componentName = make_jstring("ABI33_0_0RCTText");
  return ABI33_0_0yogaMeassureToSize(measure(
      fabricUIManager,
      componentName.get(),
