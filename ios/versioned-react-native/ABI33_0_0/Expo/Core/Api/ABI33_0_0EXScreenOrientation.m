...
#import "ABI33_0_0EXScreenOrientation.h"
#import "ABI33_0_0EXScopedModuleRegistry.h"

#import <UIKit/UIKit.h>
#import <sys/utsname.h>

@interface ABI33_0_0EXScreenOrientation ()

@property (nonatomic, weak) id<ABI33_0_0EXScreenOrientationScopedModuleDelegate> kernelOrientationServiceDelegate;

@end

static int INVALID_MASK = 0;

@implementation ABI33_0_0RCTConvert (OrientationLock)
ABI33_0_0RCT_ENUM_CONVERTER(ABI33_0_0EXOrientationLock, [ABI33_0_0EXScreenOrientation getStringToOrientationLockJSDict],
                   ABI33_0_0EXOrientationDefaultLock, integerValue)
@end


@implementation ABI33_0_0EXScreenOrientation {
  bool hasListeners;
}

ABI33_0_0EX_EXPORT_SCOPED_MODULE(ExpoScreenOrientation, ScreenOrientationManager);
...
ABI33_0_0RCT_EXPORT_METHOD(lockAsync:(ABI33_0_0EXOrientationLock)orientationLock
...
ABI33_0_0RCT_EXPORT_METHOD(lockPlatformAsync:(NSArray <NSString *> *)allowedOrientations
                  resolver:(ABI33_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI33_0_0RCTPromiseRejectBlock)reject)
{
...
ABI33_0_0RCT_REMAP_METHOD(unlockAsync,
                 unlockAsyncWithResolver:(ABI33_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI33_0_0RCTPromiseRejectBlock)reject)
{
  [self lockAsync:ABI33_0_0EXOrientationDefaultLock resolver:resolve rejecter:reject];
}

ABI33_0_0RCT_REMAP_METHOD(getOrientationLockAsync,
                 getOrientationLockAsyncWithResolver:(ABI33_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI33_0_0RCTPromiseRejectBlock)reject)
{
  UIInterfaceOrientationMask orientationMask = [_kernelOrientationServiceDelegate supportedInterfaceOrientationsForVisibleApp];
  ABI33_0_0EXOrientationLock orientationLock = [self orientationLockNativeToJS:orientationMask];
  resolve([self orientationLockToString:orientationLock]);
}

ABI33_0_0RCT_REMAP_METHOD(getPlatformOrientationLockAsync,
                 getPlatformOrientationLockAsyncResolver:(ABI33_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI33_0_0RCTPromiseRejectBlock)reject)
{
  UIInterfaceOrientationMask orientationMask = [_kernelOrientationServiceDelegate supportedInterfaceOrientationsForVisibleApp];
  ...
  for (NSNumber *wrappedSingleOrientation in singleOrientations) {
    ...
    if (supportedOrientation == singleOrientationMask){
      ABI33_0_0EXOrientation orientation = [self orientationNativeToJS: (UIInterfaceOrientationMask) singleOrientationMask];
...
ABI33_0_0RCT_EXPORT_METHOD(doesSupportAsync:(ABI33_0_0EXOrientationLock)orientationLock
                  resolver:(ABI33_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI33_0_0RCTPromiseRejectBlock)reject)
{
...
ABI33_0_0RCT_EXPORT_METHOD(supportsOrientationLockAsync:(ABI33_0_0EXOrientationLock)orientationLock
                  resolver:(ABI33_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI33_0_0RCTPromiseRejectBlock)reject)
{
  UIInterfaceOrientationMask orientationMask = [self orientationLockJSToNative:orientationLock];
...
ABI33_0_0RCT_REMAP_METHOD(getOrientationAsync,
                 getOrientationAsyncResolver:(ABI33_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI33_0_0RCTPromiseRejectBlock)reject)
{
...
+ (NSDictionary *)getStringToOrientationJSDict
{
  ...
  dispatch_once(&onceToken, ^{
    strToOrientationDict = @{@"PORTRAIT" : @(ABI33_0_0EXOrientationPortrait),
                             @"PORTRAIT_UP" : @(ABI33_0_0EXOrientationPortraitUp),
                             @"PORTRAIT_DOWN" : @(ABI33_0_0EXOrientationPortraitDown),
                             @"LANDSCAPE" : @(ABI33_0_0EXOrientationLandscape),
                             @"LANDSCAPE_LEFT" : @(ABI33_0_0EXOrientationLandscapeLeft),
                             @"LANDSCAPE_RIGHT" : @(ABI33_0_0EXOrientationLandscapeRight),
                             @"UNKNOWN": @(ABI33_0_0EXOrientationUnknown)
                             };
  });
...
+ (NSDictionary *)getOrientationJSToStringDict
{
  ...
  dispatch_once(&onceToken, ^{
    ...
    NSDictionary *strToOrientation = [ABI33_0_0EXScreenOrientation getStringToOrientationJSDict];
...
+ (NSDictionary *)getStringToOrientationLockJSDict
{
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    strToOrientationLockDict = @{ @"DEFAULT" : @(ABI33_0_0EXOrientationDefaultLock),
                                  @"ALL" : @(ABI33_0_0EXOrientationAllLock),
                                  @"PORTRAIT" : @(ABI33_0_0EXOrientationPortraitLock),
                                  @"PORTRAIT_UP" : @(ABI33_0_0EXOrientationPortraitUpLock),
                                  @"PORTRAIT_DOWN" : @(ABI33_0_0EXOrientationPortraitDownLock),
                                  @"LANDSCAPE" : @(ABI33_0_0EXOrientationLandscapeLock),
                                  @"LANDSCAPE_LEFT" : @(ABI33_0_0EXOrientationLandscapeLeftLock),
                                  @"LANDSCAPE_RIGHT" : @(ABI33_0_0EXOrientationLandscapeRightLock),
                                  @"OTHER" : @(ABI33_0_0EXOrientationOtherLock),
                                  @"ALL_BUT_UPSIDE_DOWN": @(ABI33_0_0EXOrientationAllButUpsideDownLock)
                                  };
  });
...
+ (NSDictionary *)getOrientationLockJSToStringDict
{
  ...
  dispatch_once(&onceToken, ^{
    ...
    NSDictionary *strToOrientationLock = [ABI33_0_0EXScreenOrientation getStringToOrientationLockJSDict];
...
{
  ABI33_0_0EXOrientation orientation = [self traitCollectionToOrientation:traitCollection];
  return @{
...
- (ABI33_0_0EXOrientation)traitCollectionToOrientation:(UITraitCollection *)traitCollection
{
  ...
  if (verticalSizeClass == UIUserInterfaceSizeClassRegular && horizontalSizeClass == UIUserInterfaceSizeClassCompact){
    return ABI33_0_0EXOrientationPortrait;
  } else if (verticalSizeClass == UIUserInterfaceSizeClassCompact && horizontalSizeClass == UIUserInterfaceSizeClassCompact){
    return ABI33_0_0EXOrientationLandscape;
  } else if (verticalSizeClass == UIUserInterfaceSizeClassCompact && horizontalSizeClass == UIUserInterfaceSizeClassRegular) {
    return ABI33_0_0EXOrientationLandscape; // iPhone 7 plus
  } else {
    return ABI33_0_0EXOrientationUnknown;
  }
}

- (ABI33_0_0EXOrientation)orientationNativeToJS:(UIInterfaceOrientationMask)orientationMask
{
  if (orientationMask == (UIInterfaceOrientationMaskPortrait | UIInterfaceOrientationMaskPortraitUpsideDown)) {
    ...
    return ABI33_0_0EXOrientationPortraitUp;
  } else if (orientationMask == UIInterfaceOrientationMaskPortraitUpsideDown) {
    return ABI33_0_0EXOrientationPortraitDown;
    ...
    return ABI33_0_0EXOrientationLandscapeLeft;
  } else if (orientationMask == UIInterfaceOrientationMaskLandscapeRight) {
    return ABI33_0_0EXOrientationLandscapeRight;
  } else {
    return ABI33_0_0EXOrientationUnknown;
  }
}

- (ABI33_0_0EXOrientationLock)orientationLockNativeToJS:(UIInterfaceOrientationMask)orientationMask
{
  if (orientationMask == UIInterfaceOrientationMaskAllButUpsideDown){
    return ABI33_0_0EXOrientationDefaultLock;
  } else if (orientationMask == UIInterfaceOrientationMaskAll) {
    return ABI33_0_0EXOrientationAllLock;
  } else if (orientationMask == (UIInterfaceOrientationMaskPortrait | UIInterfaceOrientationMaskPortraitUpsideDown)) {
    return ABI33_0_0EXOrientationPortraitLock;
  } else if (orientationMask == UIInterfaceOrientationMaskPortrait) {
    return ABI33_0_0EXOrientationPortraitUpLock;
  } else if (orientationMask == UIInterfaceOrientationMaskPortraitUpsideDown) {
    return ABI33_0_0EXOrientationPortraitDownLock;
  } else if (orientationMask == UIInterfaceOrientationMaskLandscape) {
    return ABI33_0_0EXOrientationLandscapeLock;
  } else if (orientationMask == UIInterfaceOrientationMaskLandscapeLeft) {
    return ABI33_0_0EXOrientationLandscapeLeftLock;
  } else if (orientationMask == UIInterfaceOrientationMaskLandscapeRight) {
    return ABI33_0_0EXOrientationLandscapeRightLock;
  } else {
    return ABI33_0_0EXOrientationOtherLock;
  }
}

- (UIInterfaceOrientationMask)orientationJSToNative:(ABI33_0_0EXOrientation)orientation
{
  if (orientation == ABI33_0_0EXOrientationPortrait) {
    return UIInterfaceOrientationMaskPortrait | UIInterfaceOrientationMaskPortraitUpsideDown;
  } else if (orientation == ABI33_0_0EXOrientationPortraitUp) {
    return UIInterfaceOrientationMaskPortrait;
  } else if (orientation == ABI33_0_0EXOrientationPortraitDown) {
    return UIInterfaceOrientationMaskPortraitUpsideDown;
  } else if (orientation == ABI33_0_0EXOrientationLandscape) {
    return UIInterfaceOrientationMaskLandscape;
  } else if (orientation == ABI33_0_0EXOrientationLandscapeLeft) {
    return UIInterfaceOrientationMaskLandscapeLeft;
  } else if (orientation == ABI33_0_0EXOrientationLandscapeRight) {
...
- (UIInterfaceOrientationMask)orientationLockJSToNative:(ABI33_0_0EXOrientationLock)orientationLock
{
  if (orientationLock == ABI33_0_0EXOrientationDefaultLock) {
    return UIInterfaceOrientationMaskAllButUpsideDown;
  } else if (orientationLock == ABI33_0_0EXOrientationAllLock) {
    return UIInterfaceOrientationMaskAll;
  } else if (orientationLock == ABI33_0_0EXOrientationPortraitLock) {
    return UIInterfaceOrientationMaskPortrait | UIInterfaceOrientationMaskPortraitUpsideDown;
  } else if (orientationLock == ABI33_0_0EXOrientationPortraitUpLock) {
    return UIInterfaceOrientationMaskPortrait;
  } else if (orientationLock == ABI33_0_0EXOrientationPortraitDownLock) {
    return UIInterfaceOrientationMaskPortraitUpsideDown;
  } else if (orientationLock == ABI33_0_0EXOrientationLandscapeLock) {
    return UIInterfaceOrientationMaskLandscape;
  } else if (orientationLock == ABI33_0_0EXOrientationLandscapeLeftLock) {
    return UIInterfaceOrientationMaskLandscapeLeft;
  } else if (orientationLock == ABI33_0_0EXOrientationLandscapeRightLock) {
    return UIInterfaceOrientationMaskLandscapeRight;
  } else if (orientationLock == ABI33_0_0EXOrientationAllButUpsideDownLock) { // legacy
    return UIInterfaceOrientationMaskAllButUpsideDown;
  }else {
    return INVALID_MASK;
  }
...
- (ABI33_0_0EXOrientation)stringToOrientation:(NSString *)orientationString
{
  return [[[ABI33_0_0EXScreenOrientation getStringToOrientationJSDict] objectForKey:orientationString] intValue];
}

- (NSString *)orientationToString:(ABI33_0_0EXOrientation)orientation
{
  return [[ABI33_0_0EXScreenOrientation getOrientationJSToStringDict] objectForKey:@(orientation)];
}


- (ABI33_0_0EXOrientationLock)stringToOrientationLock:(NSString *)orientationLockString
{
  return [[[ABI33_0_0EXScreenOrientation getStringToOrientationLockJSDict] objectForKey:orientationLockString] intValue];
}

- (NSString *)orientationLockToString:(ABI33_0_0EXOrientationLock)orientationLock
{
  return [[ABI33_0_0EXScreenOrientation getOrientationLockJSToStringDict] objectForKey:@(orientationLock)];
}
