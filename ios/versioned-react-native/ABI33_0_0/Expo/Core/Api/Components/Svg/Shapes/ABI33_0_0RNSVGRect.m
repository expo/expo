...
@implementation ABI33_0_0RNSVGRect
...
- (void)setRectwidth:(ABI33_0_0RNSVGLength *)rectwidth
{
...
- (void)setRectheight:(ABI33_0_0RNSVGLength *)rectheight
{
...
- (void)setRx:(ABI33_0_0RNSVGLength *)rx
{
    if ([rx isEqualTo:_rx]) {
        return;
    }
...
- (void)setRy:(ABI33_0_0RNSVGLength *)ry
{
    if ([ry isEqualTo:_ry]) {
        return;
    }
