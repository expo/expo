...
- (id)init
{
    if (self = [super init]) {
        _fillOpacity = 1;
        _strokeOpacity = 1;
        _strokeWidth = [ABI33_0_0RNSVGLength lengthWithNumber:1];
...
- (void)setFill:(ABI33_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI33_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI33_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)setStrokeWidth:(ABI33_0_0RNSVGLength*)strokeWidth
{
...
- (void)setStrokeDasharray:(NSArray<ABI33_0_0RNSVGLength *> *)strokeDasharray
{
...
- (void)setVectorEffect:(ABI33_0_0RNSVGVectorEffect)vectorEffect
{
...
UInt32 ABI33_0_0saturate(CGFloat value) {
...
- (void)renderTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    if (self.mask) {
        ...
        ABI33_0_0RNSVGMask *_maskNode = (ABI33_0_0RNSVGMask*)[self.svgView getDefinedMask:self.mask];
        ...
        for (NSUInteger i = 0; i < npixels; i++) {
            ...
            *currentPixel = ABI33_0_0saturate(luma) << 24;
            currentPixel++;
        }
...
- (void)prepareStrokeDash:(NSUInteger)count strokeDasharray:(NSArray<ABI33_0_0RNSVGLength *> *)strokeDasharray {
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    if (self.fill) {
        if (self.fill.class == ABI33_0_0RNSVGBrush.class) {
    ...
    if (self.stroke) {
        ...
        NSArray<ABI33_0_0RNSVGLength *>* strokeDasharray = self.strokeDasharray;
        ...
        if (self.stroke.class == ABI33_0_0RNSVGBrush.class) {
