...
@implementation ABI33_0_0RNSVGPattern
...
{
    self.dirty = false;
    NSArray<ABI33_0_0RNSVGLength *> *points = @[self.x, self.y, self.patternwidth, self.patternheight];
...
- (void)setPatternwidth:(ABI33_0_0RNSVGLength *)patternwidth
{
...
- (void)setPatternheight:(ABI33_0_0RNSVGLength *)patternheight
{
...
- (void)setPatternUnits:(ABI33_0_0RNSVGUnits)patternUnits
{
...
- (void)setPatternContentUnits:(ABI33_0_0RNSVGUnits)patternContentUnits
{
