...
- (void)setSrc:(id)src
{
    ...
    ABI33_0_0RCTImageSource *source = [ABI33_0_0RCTConvert ABI33_0_0RCTImageSource:src];
    ...
    ABI33_0_0RCTImageLoaderCancellationBlock previousCancellationBlock = _reloadImageCancellationBlock;
    if (previousCancellationBlock) {
        previousCancellationBlock();
        _reloadImageCancellationBlock = nil;
    }

    _reloadImageCancellationBlock = [self.bridge.imageLoader loadImageWithURLRequest:[ABI33_0_0RCTConvert NSURLRequest:src] callback:^(NSError *error, UIImage *image) {
...
- (void)setImagewidth:(ABI33_0_0RNSVGLength *)width
{
...
- (void)setImageheight:(ABI33_0_0RNSVGLength *)height
{
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    CGAffineTransform viewbox = [ABI33_0_0RNSVGViewBox getTransform:imageBounds eRect:hitArea align:self.align meetOrSlice:self.meetOrSlice];
