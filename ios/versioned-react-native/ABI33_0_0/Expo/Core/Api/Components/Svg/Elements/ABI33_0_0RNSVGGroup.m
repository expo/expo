...
#import "ABI33_0_0RNSVGClipPath.h"
#import "ABI33_0_0RNSVGMask.h"

@implementation ABI33_0_0RNSVGGroup
{
...
- (void)renderGroupTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    [self traverseSubviews:^(UIView *node) {
        if ([node isKindOfClass:[ABI33_0_0RNSVGMask class]]) {
            // no-op
        } else if ([node isKindOfClass:[ABI33_0_0RNSVGNode class]]) {
            ABI33_0_0RNSVGNode* svgNode = (ABI33_0_0RNSVGNode*)node;
            if (svgNode.responsible && !self.svgView.responsible) {
                self.svgView.responsible = YES;
            }

            if ([node isKindOfClass:[ABI33_0_0RNSVGRenderable class]]) {
                [(ABI33_0_0RNSVGRenderable*)node mergeProperties:self];
            }
            ...
            if ([node isKindOfClass:[ABI33_0_0RNSVGRenderable class]]) {
                [(ABI33_0_0RNSVGRenderable*)node resetProperties];
            }
        } else if ([node isKindOfClass:[ABI33_0_0RNSVGSvgView class]]) {
            ABI33_0_0RNSVGSvgView* svgView = (ABI33_0_0RNSVGSvgView*)node;
...
- (void)setupGlyphContext:(CGContextRef)context
{
    ...
    _glyphContext = [[ABI33_0_0RNSVGGlyphContext alloc] initWithWidth:width
                                                      height:height];
}
...
- (CGPathRef)getPath:(CGContextRef)context
{
    ...
    [self traverseSubviews:^(ABI33_0_0RNSVGNode *node) {
        if ([node isKindOfClass:[ABI33_0_0RNSVGNode class]] && ![node isKindOfClass:[ABI33_0_0RNSVGMask class]]) {
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    if (self.clipPath) {
        ABI33_0_0RNSVGClipPath *clipNode = (ABI33_0_0RNSVGClipPath*)[self.svgView getDefinedClipPath:self.clipPath];
        if ([clipNode isSimpleClipPath]) {
            ...
            ABI33_0_0RNSVGRenderable *clipGroup = (ABI33_0_0RNSVGRenderable*)clipNode;
    ...
    if (!event) {
        NSPredicate *const anyActive = [NSPredicate predicateWithFormat:@"self isKindOfClass: %@ AND active == TRUE", [ABI33_0_0RNSVGNode class]];
    ...
    for (UIView *node in [self.subviews reverseObjectEnumerator]) {
        if ([node isKindOfClass:[ABI33_0_0RNSVGNode class]]) {
            if ([node isKindOfClass:[ABI33_0_0RNSVGMask class]]) {
                continue;
            }
            ABI33_0_0RNSVGNode* svgNode = (ABI33_0_0RNSVGNode*)node;
...
{
    [self traverseSubviews:^(__kindof ABI33_0_0RNSVGNode *node) {
        if ([node isKindOfClass:[ABI33_0_0RNSVGRenderable class]]) {
            [(ABI33_0_0RNSVGRenderable*)node resetProperties];
        }
        return YES;
