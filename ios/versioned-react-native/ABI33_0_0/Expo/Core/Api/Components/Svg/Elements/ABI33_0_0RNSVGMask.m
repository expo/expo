...
@implementation ABI33_0_0RNSVGMask
...
- (void)setX:(ABI33_0_0RNSVGLength *)x
{
    if ([x isEqualTo:_x]) {
        return;
    }
...
- (void)setY:(ABI33_0_0RNSVGLength *)y
{
    if ([y isEqualTo:_y]) {
        return;
    }
...
- (void)setMaskwidth:(ABI33_0_0RNSVGLength *)maskwidth
{
...
- (void)setMaskheight:(ABI33_0_0RNSVGLength *)maskheight
{
...
- (void)setMaskUnits:(ABI33_0_0RNSVGUnits)maskUnits
{
...
- (void)setMaskContentUnits:(ABI33_0_0RNSVGUnits)maskContentUnits
{
