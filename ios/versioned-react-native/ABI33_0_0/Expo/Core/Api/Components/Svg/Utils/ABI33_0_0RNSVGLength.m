...
@implementation ABI33_0_0RNSVGLength
...
{
    ABI33_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype) lengthWithString: (NSString *) lengthString {
    ...
    ABI33_0_0RNSVGLength *output = [ABI33_0_0RNSVGLength alloc];
    if (stringLength == 0) {
        ...
        ABI33_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
