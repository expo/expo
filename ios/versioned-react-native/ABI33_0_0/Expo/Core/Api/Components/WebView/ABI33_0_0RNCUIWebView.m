...
NSString *const ABI33_0_0RNCJSNavigationScheme = @"ReactABI33_0_0-js-navigation";

static NSString *const MessageHandlerName = @"ReactABI33_0_0NativeWebView";

@interface ABI33_0_0RNCUIWebView () <UIWebViewDelegate, ABI33_0_0RCTAutoInsetsProtocol>
...
@implementation ABI33_0_0RNCUIWebView
{
  UIWebView *_webView;
...
{
  BOOL isJSNavigation = [request.URL.scheme isEqualToString:ABI33_0_0RNCJSNavigationScheme];
  ...
  if (_messagingEnabled) {
    NSString *source = [NSString stringWithFormat:
      @"(function() {"
       ...
       "    }"
       "  };"
       "})();", ABI33_0_0RNCJSNavigationScheme, MessageHandlerName, MessageHandlerName
    ];
