//
//  ABI33_0_0RCTConvert+GMSMapViewType.m
//
...
@implementation ABI33_0_0RCTConvert (GMSMapViewType)
  ABI33_0_0RCT_ENUM_CONVERTER(GMSMapViewType,
  (
    @{
...
+ (GMSCameraPosition*)GMSCameraPosition:(id)json
{
    ...
    return [ABI33_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:nil];
}
