//
//  ABI33_0_0AIRGoogleMapWMSTile.h
//  AirMaps
//
...
@interface ABI33_0_0WMSTileOverlay : GMSSyncTileLayer
...
@interface ABI33_0_0AIRGoogleMapWMSTile : UIView
@property (nonatomic, strong) ABI33_0_0WMSTileOverlay *tileLayer;
