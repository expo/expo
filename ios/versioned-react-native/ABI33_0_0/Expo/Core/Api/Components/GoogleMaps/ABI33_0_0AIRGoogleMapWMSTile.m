//
//  ABI33_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI33_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI33_0_0WMSTileOverlay *tile = [[ABI33_0_0WMSTileOverlay alloc] init];
...
@implementation ABI33_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
