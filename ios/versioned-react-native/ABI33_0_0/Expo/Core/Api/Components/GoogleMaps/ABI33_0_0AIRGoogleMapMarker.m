...
#import "ABI33_0_0AIRDummyView.h"
...
@interface ABI33_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI33_0_0AIRGMSMarker*)marker;
@end

@implementation ABI33_0_0AIRGoogleMapMarker {
  ABI33_0_0RCTImageLoaderCancellationBlock _reloadImageCancellationBlock;
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI33_0_0AIRGMSMarker alloc] init];
...
- (void)insertReactABI33_0_0Subview:(id<ABI33_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI33_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI33_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI33_0_0AIRDummyView *dummySubview = [[ABI33_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertReactABI33_0_0Subview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeReactABI33_0_0Subview:(id<ABI33_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI33_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeReactABI33_0_0Subview:(UIView*)dummySubview];
}
...
- (void)setOnPress:(ABI33_0_0RCTBubblingEventBlock)onPress {
  _realMarker.onPress = onPress;
}

- (ABI33_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/ReactABI33_0_0-native-community/ReactABI33_0_0-native-maps/issues/738)
  ...
  _reloadImageCancellationBlock = [_bridge.imageLoader loadImageWithURLRequest:[ABI33_0_0RCTConvert NSURLRequest:_imageSrc]
                                                                          size:self.bounds.size
                                                                         scale:ABI33_0_0RCTScreenScale()
                                                                       clipped:YES
                                                                    resizeMode:ABI33_0_0RCTResizeModeCenter
                                                                 progressBlock:nil
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI33_0_0RN?
...
- (void)setIconSrc:(NSString *)iconSrc
{
  ...
  _reloadImageCancellationBlock =
  [_bridge.imageLoader loadImageWithURLRequest:[ABI33_0_0RCTConvert NSURLRequest:_iconSrc]
                                          size:self.bounds.size
                                         scale:ABI33_0_0RCTScreenScale()
                                       clipped:YES
                                    resizeMode:ABI33_0_0RCTResizeModeCenter
