//
//  ABI33_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI33_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI33_0_0RNGestureHandler *otherHandler = [ABI33_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI33_0_0RCTTouchHandler class]];
}
