...
@interface ABI33_0_0RNGestureHandlerManager : NSObject

- (nonnull instancetype)initWithUIManager:(nonnull ABI33_0_0RCTUIManager *)uiManager
                          eventDispatcher:(nonnull ABI33_0_0RCTEventDispatcher *)eventDispatcher;
