...
#import "ABI33_0_0RNPanHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

@interface ABI33_0_0RNBetterPanGestureRecognizer : UIPanGestureRecognizer
...
@implementation ABI33_0_0RNBetterPanGestureRecognizer {
...
@implementation ABI33_0_0RNPanGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI33_0_0RNBetterPanGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI33_0_0RNBetterPanGestureRecognizer *recognizer = (ABI33_0_0RNBetterPanGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    CGFloat velocity = [ABI33_0_0RCTConvert CGFloat:prop];
    recognizer.minVelocitySq = velocity * velocity;
  }
  [recognizer updateHasCustomActivationCriteria];
}

- (ABI33_0_0RNGestureHandlerEventExtraData *)eventExtraData:(UIPanGestureRecognizer *)recognizer
{
