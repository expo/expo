#import "ABI33_0_0RNForceTouchHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ReactABI33_0_0/ABI33_0_0RCTConvert.h>

@interface ABI33_0_0RNForceTouchGestureRecognizer : UIGestureRecognizer
...
@implementation ABI33_0_0RNForceTouchGestureRecognizer {
...
@implementation ABI33_0_0RNForceTouchHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI33_0_0RNForceTouchGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI33_0_0RNForceTouchGestureRecognizer *recognizer = (ABI33_0_0RNForceTouchGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    recognizer.feedbackOnActivation = [ABI33_0_0RCTConvert BOOL:prop];
  }
}

- (ABI33_0_0RNGestureHandlerEventExtraData *)eventExtraData:(ABI33_0_0RNForceTouchGestureRecognizer *)recognizer
{
