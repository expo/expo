...
@interface ABI33_0_0AIRMapMarker : MKAnnotationView <MKAnnotation>

@property (nonatomic, strong) ABI33_0_0AIRMapCallout *calloutView;
...
@property (nonatomic, copy) ABI33_0_0RCTDirectEventBlock onSelect;
@property (nonatomic, copy) ABI33_0_0RCTDirectEventBlock onDeselect;
...
@interface ABI33_0_0AIREmptyCalloutBackgroundView : ABI33_0_0SMCalloutBackgroundView
@end
