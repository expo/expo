...
@interface ABI33_0_0RNSScreenContainerManager : ABI33_0_0RCTViewManager

- (void)markUpdated:(ABI33_0_0RNSScreenContainerView *)screen;

@end

@interface ABI33_0_0RNSScreenContainerView ()

@property (nonatomic, retain) UIViewController *controller;
@property (nonatomic, retain) NSMutableSet<ABI33_0_0RNSScreenView *> *activeScreens;
@property (nonatomic, retain) NSMutableArray<ABI33_0_0RNSScreenView *> *ReactABI33_0_0Subviews;

- (void)updateContainer;

@end

@implementation ABI33_0_0RNSScreenContainerView {
  BOOL _needUpdate;
  __weak ABI33_0_0RNSScreenContainerManager *_manager;
}

- (instancetype)initWithManager:(ABI33_0_0RNSScreenContainerManager *)manager
{
  if (self = [super init]) {
...
- (void)insertReactABI33_0_0Subview:(ABI33_0_0RNSScreenView *)subview atIndex:(NSInteger)atIndex
{
  subview.ReactABI33_0_0Superview = self;
  [_ReactABI33_0_0Subviews insertObject:subview atIndex:atIndex];
}

- (void)removeReactABI33_0_0Subview:(ABI33_0_0RNSScreenView *)subview
{
  subview.ReactABI33_0_0Superview = nil;
...
- (void)detachScreen:(ABI33_0_0RNSScreenView *)screen
{
...
- (void)attachScreen:(ABI33_0_0RNSScreenView *)screen
{
...
- (void)updateContainer
{
  ...
  for (ABI33_0_0RNSScreenView *screen in _ReactABI33_0_0Subviews) {
  ...
  for (ABI33_0_0RNSScreenView *screen in orphaned) {
    activeScreenRemoved = YES;
    [self detachScreen:screen];
  }
  ...
  if ((activeScreenRemoved || activeScreenAdded) && _activeScreens.count == 1) {
    ABI33_0_0RNSScreenView *singleActiveScreen = [_activeScreens anyObject];
...
- (void)layoutSubviews
{
  ...
  [self ReactABI33_0_0AddControllerToClosestParent:_controller];
...
@implementation ABI33_0_0RNSScreenContainerManager {
  NSMutableArray<ABI33_0_0RNSScreenContainerView *> *_markedContainers;
}
...
- (UIView *)view
{
  ...
  return [[ABI33_0_0RNSScreenContainerView alloc] initWithManager:self];
}
...
- (void)markUpdated:(ABI33_0_0RNSScreenContainerView *)screen
{
  ...
  if ([_markedContainers count] == 1) {
    ...
    ABI33_0_0RCTExecuteOnMainQueue(^{
      for (ABI33_0_0RNSScreenContainerView *container in _markedContainers) {
