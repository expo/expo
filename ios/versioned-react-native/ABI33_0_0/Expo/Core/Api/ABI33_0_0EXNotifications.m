...
#import "ABI33_0_0EXNotifications.h"
...
@interface ABI33_0_0EXNotifications ()

// unversioned ABI33_0_0EXRemoteNotificationManager instance
@property (nonatomic, weak) id <ABI33_0_0EXNotificationsScopedModuleDelegate> remoteNotificationsDelegate;
@property (nonatomic, weak) id <ABI33_0_0EXNotificationsIdentifiersManager> notificationsIdentifiersManager;
@property (nonatomic, weak) id <ABI33_0_0EXUserNotificationCenterService> userNotificationCenter;

@end

@implementation ABI33_0_0EXNotifications

ABI33_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentNotifications, @"RemoteNotificationManager", @"UserNotificationManager", @"UserNotificationCenter");
...
ABI33_0_0RCT_REMAP_METHOD(getDevicePushTokenAsync,
...
ABI33_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
                 getExponentPushTokenAsyncWithResolver:(ABI33_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI33_0_0RCTPromiseRejectBlock)reject)
{
...
ABI33_0_0RCT_EXPORT_METHOD(presentLocalNotification:(NSDictionary *)payload
                  resolver:(ABI33_0_0RCTPromiseResolveBlock)resolve
...
ABI33_0_0RCT_EXPORT_METHOD(scheduleLocalNotification:(NSDictionary *)payload
...
ABI33_0_0RCT_EXPORT_METHOD(legacyScheduleLocalRepeatingNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI33_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI33_0_0RCTPromiseRejectBlock)reject)
{
  ...
  localNotification.applicationIconBadgeNumber = [ABI33_0_0RCTConvert NSInteger:payload[@"count"]] ?: 0;
  localNotification.userInfo = @{
                                 @"body": payload[@"data"],
                                 @"experienceId": self.experienceId,
                                 @"id": uniqueId
                                 };
  localNotification.fireDate = [ABI33_0_0RCTConvert NSDate:options[@"time"]] ?: [NSDate new];
  localNotification.repeatInterval = [ABI33_0_0RCTConvert NSCalendarUnit:options[@"repeat"]] ?: 0;

  __weak typeof(self) weakSelf = self;
  [ABI33_0_0EXUtil performSynchronouslyOnMainThread:^{
    [ABI33_0_0RCTSharedApplication() scheduleLocalNotification:localNotification];
...
ABI33_0_0RCT_REMAP_METHOD(cancelScheduledNotificationAsync,
                 cancelScheduledNotificationAsync:(NSString *)uniqueId
                 withResolver:(ABI33_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI33_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI33_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
...
ABI33_0_0RCT_REMAP_METHOD(cancelAllScheduledNotificationsAsync,
                 cancelAllScheduledNotificationsAsyncWithResolver:(ABI33_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(__unused ABI33_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI33_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
  [_userNotificationCenter getPendingNotificationRequestsWithCompletionHandler:^(NSArray<UNNotificationRequest *> * _Nonnull requests) {
...
ABI33_0_0RCT_REMAP_METHOD(getBadgeNumberAsync,
                 getBadgeNumberAsyncWithResolver:(ABI33_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI33_0_0RCTPromiseRejectBlock)reject)
{
  __block NSInteger badgeNumber;
  [ABI33_0_0EXUtil performSynchronouslyOnMainThread:^{
    badgeNumber = ABI33_0_0RCTSharedApplication().applicationIconBadgeNumber;
  }];
  resolve(@(badgeNumber));
}

ABI33_0_0RCT_EXPORT_METHOD(setBadgeNumberAsync:(nonnull NSNumber *)number
                  resolver:(ABI33_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI33_0_0RCTPromiseRejectBlock)reject)
{
  [ABI33_0_0EXUtil performSynchronouslyOnMainThread:^{
    ABI33_0_0RCTSharedApplication().applicationIconBadgeNumber = number.integerValue;
  }];
  resolve(nil);
}
...
ABI33_0_0RCT_REMAP_METHOD(createCategoryAsync,
...
ABI33_0_0RCT_REMAP_METHOD(deleteCategoryAsync,
...
- (NSDateComponents *)dateComponentsFrom:(NSNumber * _Nullable)unixTime {
  ...
  NSDate *triggerDate = [ABI33_0_0RCTConvert NSDate:unixTime] ?: [NSDate new];
