#import "ABI33_0_0REAPropsNode.h"
...
#import "ReactABI33_0_0/ABI33_0_0RCTComponentData.h"

@implementation ABI33_0_0REAPropsNode
{
  NSNumber *_connectedViewTag;
  NSString *_connectedViewName;
  NSMutableDictionary<NSString *, ABI33_0_0REANodeID> *_propsConfig;
}
...
- (id)evaluate
{
  ...
  for (NSString *prop in _propsConfig) {
    ABI33_0_0REANode *propNode = [self.nodesManager findNodeByID:_propsConfig[prop]];
    
    if ([propNode isKindOfClass:[ABI33_0_0REAStyleNode class]]) {
