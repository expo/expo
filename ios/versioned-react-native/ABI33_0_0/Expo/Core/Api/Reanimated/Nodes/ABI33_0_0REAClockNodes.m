#import "ABI33_0_0REAClockNodes.h"
#import "ABI33_0_0REANodesManager.h"

@interface ABI33_0_0REAClockNode ()
...
@implementation ABI33_0_0REAClockNode
...
- (void)start
{
  ...
  __weak ABI33_0_0REAClockNode *weakSelf = self;
...
@implementation ABI33_0_0REAClockOpNode {
...
- (ABI33_0_0REAClockNode*)clockNode
{
  return (ABI33_0_0REAClockNode*)[self.nodesManager findNodeByID:_clockNodeID];
}

@end

@implementation ABI33_0_0REAClockStartNode
...
@implementation ABI33_0_0REAClockStopNode
...
@implementation ABI33_0_0REAClockTestNode
