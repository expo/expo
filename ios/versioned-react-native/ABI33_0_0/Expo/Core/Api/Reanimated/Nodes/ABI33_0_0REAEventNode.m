#import "ABI33_0_0REAEventNode.h"
#import "ABI33_0_0REANodesManager.h"
#import "ABI33_0_0REAValueNode.h"

@implementation ABI33_0_0REAEventNode {
  NSArray *_argMapping;
}
...
- (void)processEvent:(id<ABI33_0_0RCTEvent>)event
{
  ...
  for (NSArray *eventPath in _argMapping) {
    ...
    for (NSUInteger i = 0; i < eventPath.count; i++) {
      if (i < eventPath.count - 1) {
        ...
        ABI33_0_0REAValueNode *node = (ABI33_0_0REAValueNode *)[self.nodesManager findNodeByID:eventPath[i]];
        [node setValue:value];
      }
    }
  }
