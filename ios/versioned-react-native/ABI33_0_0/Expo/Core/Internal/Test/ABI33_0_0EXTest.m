...
NSNotificationName ABI33_0_0EXTestSuiteCompletedNotification = @"ABI33_0_0EXTestSuiteCompletedNotification";

@interface ABI33_0_0EXTest ()

@property (class, nonatomic, assign, readonly) os_log_t log;
@property (nonatomic, assign) ABI33_0_0EXTestEnvironment environment;
...
- (instancetype)initWithEnvironment:(ABI33_0_0EXTestEnvironment)environment
{
  if (self = [super init]) {
...
{
  os_log(ABI33_0_0EXTest.log, "%{public}@", message);
}

ABI33_0_0RCT_EXPORT_METHOD(completed:(NSString *)jsonStringifiedResult)
{
  ...
  os_log(ABI33_0_0EXTest.log, "[TEST-SUITE-END] %{public}@", jsonStringifiedResult);
}

ABI33_0_0RCT_REMAP_METHOD(action,
...
ABI33_0_0RCT_REMAP_METHOD(shouldSkipTestsRequiringPermissionsAsync,
                 shouldSkipTestsRequiringPermissionsWithResolver:(ABI33_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(__unused ABI33_0_0RCTPromiseRejectBlock)reject)
{
  resolve(@(_environment == ABI33_0_0EXTestEnvironmentCI));
}
...
+ (ABI33_0_0EXTestEnvironment)testEnvironmentFromString:(NSString *)testEnvironmentString
{
  if ([testEnvironmentString isEqualToString:@"local"]) {
    return ABI33_0_0EXTestEnvironmentLocal;
  } else if ([testEnvironmentString isEqualToString:@"ci"]) {
    return ABI33_0_0EXTestEnvironmentCI;
  }
  return ABI33_0_0EXTestEnvironmentNone;
}
