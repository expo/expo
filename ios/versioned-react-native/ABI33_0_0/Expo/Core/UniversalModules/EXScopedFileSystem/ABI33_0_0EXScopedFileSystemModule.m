...
NSString * const ABI33_0_0EXShellManifestResourceName = @"shell-app-manifest";

@implementation ABI33_0_0EXScopedFileSystemModule

- (instancetype)initWithExperienceId:(NSString *)experienceId andConstantsBinding:(ABI33_0_0EXConstantsBinding *)constantsBinding
{
  NSString *escapedExperienceId = [ABI33_0_0EXScopedFileSystemModule escapedResourceName:experienceId];
...
- (NSArray<NSString *> *)bundledAssets
{
  ...
  dispatch_once(&once, ^{
    NSString *manifestBundlePath = [[NSBundle mainBundle] pathForResource:ABI33_0_0EXShellManifestResourceName ofType:@"json"];
    ...
    if (error) {
      ABI33_0_0UMLogError(@"Error parsing bundled manifest: %@", error);
      return;
    }
