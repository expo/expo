...
@implementation ABI33_0_0EXScopedEventEmitter

+ (NSString *)moduleName
{
  NSAssert(NO, @"ABI33_0_0EXScopedEventEmitter is abstract, you should only export subclasses to the bridge.");
...
{
  if (eventEmitter) {
    return ((ABI33_0_0EXScopedEventEmitter *)eventEmitter).experienceId;
  }
  return nil;
}
