...
#import <ABI33_0_0EXSensors/ABI33_0_0EXSensorsManager.h>
#import <CoreMotion/CoreMotion.h>

@interface ABI33_0_0EXSensorsManager ()
...
@implementation ABI33_0_0EXSensorsManager

ABI33_0_0UM_REGISTER_MODULE();

+ (const NSArray<Protocol *> *)exportedInterfaces
{
  return @[@protocol(ABI33_0_0UMAccelerometerInterface), @protocol(ABI33_0_0UMBarometerInterface), @protocol(ABI33_0_0UMDeviceMotionInterface), @protocol(ABI33_0_0UMGyroscopeInterface), @protocol(ABI33_0_0UMMagnetometerInterface), @protocol(ABI33_0_0UMMagnetometerUncalibratedInterface)];
}
                                            ...
                                            withHandler:(void (^)(NSDictionary *event))handlerBlock
{
  ...
  if (![[self manager] isAccelerometerActive]) {
    ...
    __weak ABI33_0_0EXSensorsManager *weakSelf = self;
    [[self manager] startAccelerometerUpdatesToQueue:[NSOperationQueue mainQueue] withHandler:^(CMAccelerometerData *data, NSError *error) {
      __strong ABI33_0_0EXSensorsManager *strongSelf = weakSelf;
      if (strongSelf) {
...
- (void)activateDeviceMotionUpdates
{
  ...
  [[self manager] startDeviceMotionUpdatesUsingReferenceFrame:CMAttitudeReferenceFrameXArbitraryCorrectedZVertical toQueue:[NSOperationQueue mainQueue] withHandler:^(CMDeviceMotion *data, NSError *error) {
    ...
    NSDictionary *result = @{
                             @"acceleration": @{
                                 @"x": @(data.userAcceleration.x * ABI33_0_0EXGravity),
                                 @"y": @(data.userAcceleration.y * ABI33_0_0EXGravity),
                                 @"z": @(data.userAcceleration.z * ABI33_0_0EXGravity)
                                 },
                             @"accelerationIncludingGravity": @{
                                 @"x": @((data.userAcceleration.x + data.gravity.x) * ABI33_0_0EXGravity),
                                 @"y": @((data.userAcceleration.y + data.gravity.y) * ABI33_0_0EXGravity),
                                 @"z": @((data.userAcceleration.z + data.gravity.z) * ABI33_0_0EXGravity)
                                 },
                             @"rotation": @{
