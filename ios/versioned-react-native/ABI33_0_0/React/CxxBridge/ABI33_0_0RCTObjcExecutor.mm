...
#import <cxxReactABI33_0_0/ABI33_0_0JSBigString.h>
...
class ABI33_0_0RCTObjcExecutor : public JSExecutor {
public:
  ABI33_0_0RCTObjcExecutor(id<ABI33_0_0RCTJavaScriptExecutor> jse,
                  ABI33_0_0RCTJavaScriptCompleteBlock errorBlock,
  ...
  void setBundleRegistry(std::unique_ptr<RAMBundleRegistry>) override {
    ABI33_0_0RCTAssert(NO, @"RAM bundles are not supported in ABI33_0_0RCTObjcExecutor");
  }
...
private:
  ...
  ABI33_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI33_0_0RCTObjcExecutorFactory::ABI33_0_0RCTObjcExecutorFactory(
  id<ABI33_0_0RCTJavaScriptExecutor> jse, ABI33_0_0RCTJavaScriptCompleteBlock errorBlock)
  : m_jse(jse)
  , m_errorBlock(errorBlock) {}

std::unique_ptr<JSExecutor> ABI33_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue) {
  return std::unique_ptr<JSExecutor>(
    new ABI33_0_0RCTObjcExecutor(m_jse, m_errorBlock, jsQueue, delegate));
}
