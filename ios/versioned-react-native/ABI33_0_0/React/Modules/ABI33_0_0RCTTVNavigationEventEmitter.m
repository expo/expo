...
NSString *const ABI33_0_0RCTTVNavigationEventNotification = @"ABI33_0_0RCTTVNavigationEventNotification";

static NSString *const TVNavigationEventName = @"onHWKeyEvent";

@implementation ABI33_0_0RCTTVNavigationEventEmitter
  ...
  if (self = [super init]) {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(handleTVNavigationEventNotification:)
                                                 name:ABI33_0_0RCTTVNavigationEventNotification
                                               object:nil];
