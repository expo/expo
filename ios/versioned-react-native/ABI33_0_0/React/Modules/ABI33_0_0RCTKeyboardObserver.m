...
#import "ABI33_0_0RCTKeyboardObserver.h"

#import "ABI33_0_0RCTEventDispatcher.h"

static NSDictionary *ABI33_0_0RCTParseKeyboardNotification(NSNotification *notification);

@implementation ABI33_0_0RCTKeyboardObserver
...
{ \
  ...
  [self sendEventWithName:@#EVENT \
    body:ABI33_0_0RCTParseKeyboardNotification(notification)]; \
}
...
NS_INLINE NSDictionary *ABI33_0_0RCTRectDictionaryValue(CGRect rect)
{
  return @{
...
static NSString *ABI33_0_0RCTAnimationNameForCurve(UIViewAnimationCurve curve)
{
  switch (curve) {
...
static NSDictionary *ABI33_0_0RCTParseKeyboardNotification(NSNotification *notification)
{
  ...
  return @{
    @"startCoordinates": ABI33_0_0RCTRectDictionaryValue(beginFrame),
    @"endCoordinates": ABI33_0_0RCTRectDictionaryValue(endFrame),
    @"duration": @(duration * 1000.0), // ms
    @"easing": ABI33_0_0RCTAnimationNameForCurve(curve),
