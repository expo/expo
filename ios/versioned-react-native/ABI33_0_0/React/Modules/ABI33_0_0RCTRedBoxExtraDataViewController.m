...
@interface ABI33_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI33_0_0RCTRedBoxExtraDataCell
...
@interface ABI33_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI33_0_0RCTRedBoxExtraDataViewController
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ABI33_0_0RCTRedBoxExtraDataCell *cell =
            (ABI33_0_0RCTRedBoxExtraDataCell *)[tableView
            dequeueReusableCellWithIdentifier:reuseIdentifier];

    if (cell == nil) {
        cell = [[ABI33_0_0RCTRedBoxExtraDataCell alloc]
