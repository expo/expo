...
typedef dispatch_block_t ABI33_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI33_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ReactABI33_0_0-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI33_0_0RCTUIManager's observers.
 */
@interface ABI33_0_0RCTUIManagerObserverCoordinator : NSObject <ABI33_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI33_0_0RCTUIManagerObserver` protocol for more info.
