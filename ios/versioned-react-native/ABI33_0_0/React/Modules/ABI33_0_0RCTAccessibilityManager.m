...
@implementation ABI33_0_0RCTAccessibilityManager
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    self.contentSizeCategory = ABI33_0_0RCTSharedApplication().preferredContentSizeCategory;
...
- (void)invalidateMultiplier
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI33_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification object:self];
}
...
- (CGFloat)multiplierForContentSizeCategory:(NSString *)category
{
  ...
  if (m.doubleValue <= 0.0) {
    ABI33_0_0RCTLogError(@"Can't determinte multiplier for category %@. Using 1.0.", category);
    m = @1.0;
  }
...
ABI33_0_0RCT_EXPORT_METHOD(setAccessibilityFocus:(nonnull NSNumber *)ReactABI33_0_0Tag)
{
  dispatch_async(dispatch_get_main_queue(), ^{
    UIView *view = [self.bridge.uiManager viewForReactABI33_0_0Tag:ReactABI33_0_0Tag];
    UIAccessibilityPostNotification(UIAccessibilityLayoutChangedNotification, view);
  });
}

ABI33_0_0RCT_EXPORT_METHOD(announceForAccessibility:(NSString *)announcement)
{
  UIAccessibilityPostNotification(UIAccessibilityAnnouncementNotification, announcement);
}

ABI33_0_0RCT_EXPORT_METHOD(getMultiplier:(ABI33_0_0RCTResponseSenderBlock)callback)
{
  if (callback) {
...
ABI33_0_0RCT_EXPORT_METHOD(getCurrentVoiceOverState:(ABI33_0_0RCTResponseSenderBlock)callback
...
@implementation ABI33_0_0RCTBridge (ABI33_0_0RCTAccessibilityManager)

- (ABI33_0_0RCTAccessibilityManager *)accessibilityManager
{
  return [self moduleForClass:[ABI33_0_0RCTAccessibilityManager class]];
}
