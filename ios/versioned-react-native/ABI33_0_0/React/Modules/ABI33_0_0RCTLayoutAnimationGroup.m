...
@implementation ABI33_0_0RCTLayoutAnimationGroup
                      ...
                      callback:(ABI33_0_0RCTResponseSenderBlock)callback
{
  ...
  if (self = [super init]) {
    NSTimeInterval duration = [ABI33_0_0RCTConvert NSTimeInterval:config[@"duration"]];
    ...
    _creatingLayoutAnimation = [[ABI33_0_0RCTLayoutAnimation alloc] initWithDuration:duration config:config[@"create"]];
    _updatingLayoutAnimation = [[ABI33_0_0RCTLayoutAnimation alloc] initWithDuration:duration config:config[@"update"]];
    _deletingLayoutAnimation = [[ABI33_0_0RCTLayoutAnimation alloc] initWithDuration:duration config:config[@"delete"]];
    _callback = callback;
  }
...
- (BOOL)isEqual:(ABI33_0_0RCTLayoutAnimationGroup *)layoutAnimation
{
  ABI33_0_0RCTLayoutAnimation *creatingLayoutAnimation = layoutAnimation.creatingLayoutAnimation;
  ABI33_0_0RCTLayoutAnimation *updatingLayoutAnimation = layoutAnimation.updatingLayoutAnimation;
  ABI33_0_0RCTLayoutAnimation *deletingLayoutAnimation = layoutAnimation.deletingLayoutAnimation;
