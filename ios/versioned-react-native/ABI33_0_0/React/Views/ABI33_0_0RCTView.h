...
#import <ReactABI33_0_0/ABI33_0_0RCTPointerEvents.h>
#import <ReactABI33_0_0/ABI33_0_0RCTView.h>

@protocol ABI33_0_0RCTAutoInsetsProtocol;

@class ABI33_0_0RCTView;

@interface ABI33_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI33_0_0RCTDirectEventBlock onAccessibilityAction;
@property (nonatomic, copy) ABI33_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI33_0_0RCTDirectEventBlock onMagicTap;
@property (nonatomic, copy) ABI33_0_0RCTDirectEventBlock onAccessibilityEscape;
 ...
 */
@property (nonatomic, assign) ABI33_0_0RCTPointerEvents pointerEvents;

+ (void)autoAdjustInsetsForView:(UIView<ABI33_0_0RCTAutoInsetsProtocol> *)parentView
 ...
 * This is inherited from UIView+ReactABI33_0_0, but we override it here
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI33_0_0RCTBorderStyle borderStyle;
