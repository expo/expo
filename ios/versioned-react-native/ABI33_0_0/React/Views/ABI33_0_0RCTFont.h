...
typedef UIFont *(^ABI33_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ReactABI33_0_0 Native will use the System font for rendering by default. If you want to
 ...
 */
ABI33_0_0RCT_EXTERN void ABI33_0_0RCTSetDefaultFontHandler(ABI33_0_0RCTFontHandler handler);
ABI33_0_0RCT_EXTERN BOOL ABI33_0_0RCTHasFontHandlerSet(void);

@interface ABI33_0_0RCTFont : NSObject
...
@interface ABI33_0_0RCTConvert (ABI33_0_0RCTFont)
