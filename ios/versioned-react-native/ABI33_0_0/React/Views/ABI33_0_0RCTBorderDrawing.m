...
static const CGFloat ABI33_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI33_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return
  ABS(borderInsets.left - borderInsets.right) < ABI33_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.bottom) < ABI33_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.top) < ABI33_0_0RCTViewBorderThreshold;
}

BOOL ABI33_0_0RCTCornerRadiiAreEqual(ABI33_0_0RCTCornerRadii cornerRadii)
{
  return
  ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI33_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI33_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI33_0_0RCTViewBorderThreshold;
}

BOOL ABI33_0_0RCTBorderColorsAreEqual(ABI33_0_0RCTBorderColors borderColors)
{
  return
...
ABI33_0_0RCTCornerInsets ABI33_0_0RCTGetCornerInsets(ABI33_0_0RCTCornerRadii cornerRadii,
                                   UIEdgeInsets edgeInsets)
{
  return (ABI33_0_0RCTCornerInsets) {
    {
...
static UIEdgeInsets ABI33_0_0RCTRoundInsetsToPixel(UIEdgeInsets edgeInsets) {
    edgeInsets.top = ABI33_0_0RCTRoundPixelValue(edgeInsets.top);
    edgeInsets.bottom = ABI33_0_0RCTRoundPixelValue(edgeInsets.bottom);
    edgeInsets.left = ABI33_0_0RCTRoundPixelValue(edgeInsets.left);
    edgeInsets.right = ABI33_0_0RCTRoundPixelValue(edgeInsets.right);

    return edgeInsets;
}

static void ABI33_0_0RCTPathAddEllipticArc(CGMutablePathRef path,
...
CGPathRef ABI33_0_0RCTPathCreateWithRoundedRect(CGRect bounds,
                                       ...
                                       const CGAffineTransform *transform)
{
  ...
  ABI33_0_0RCTPathAddEllipticArc(path, transform, (CGPoint){
...
static void ABI33_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds,
                                               CGPoint lineStart,
                                               CGPoint lineEnd,
...
NS_INLINE BOOL ABI33_0_0RCTCornerRadiiAreAboveThreshold(ABI33_0_0RCTCornerRadii cornerRadii) {
  return (cornerRadii.topLeft > ABI33_0_0RCTViewBorderThreshold ||
    cornerRadii.topRight > ABI33_0_0RCTViewBorderThreshold      ||
    cornerRadii.bottomLeft > ABI33_0_0RCTViewBorderThreshold    ||
    cornerRadii.bottomRight > ABI33_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI33_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI33_0_0RCTCornerRadii cornerRadii) {
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI33_0_0RCTPathCreateWithRoundedRect(rect, ABI33_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef ABI33_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge) {
...
static UIImage *ABI33_0_0RCTGetSolidBorderImage(ABI33_0_0RCTCornerRadii cornerRadii,
                                       CGSize viewSize,
                                       ...
                                       BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI33_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI33_0_0RCTCornerInsets cornerInsets = ABI33_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  borderInsets = ABI33_0_0RCTRoundInsetsToPixel(borderInsets);
  ...
  CGContextRef ctx = ABI33_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI33_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI33_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI33_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI33_0_0RCTEllipseGetIntersectionsWithLine((CGRect){
...
static UIImage *ABI33_0_0RCTGetDashedOrDottedBorderImage(ABI33_0_0RCTBorderStyle borderStyle,
                                                ...
                                                BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI33_0_0RCTBorderStyleDashed || borderStyle == ABI33_0_0RCTBorderStyleDotted);

  if (!ABI33_0_0RCTBorderColorsAreEqual(borderColors) || !ABI33_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI33_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI33_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI33_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI33_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI33_0_0RCTPathCreateWithRoundedRect(pathRect, ABI33_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI33_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
...
UIImage *ABI33_0_0RCTGetBorderImage(ABI33_0_0RCTBorderStyle borderStyle,
                           CGSize viewSize,
                           ABI33_0_0RCTCornerRadii cornerRadii,
                           UIEdgeInsets borderInsets,
                           ABI33_0_0RCTBorderColors borderColors,
                           ...
                           BOOL drawToEdge)
{
  ...
  switch (borderStyle) {
    case ABI33_0_0RCTBorderStyleSolid:
      return ABI33_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI33_0_0RCTBorderStyleDashed:
    case ABI33_0_0RCTBorderStyleDotted:
      return ABI33_0_0RCTGetDashedOrDottedBorderImage(borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI33_0_0RCTBorderStyleUnset:
      break;
  }
