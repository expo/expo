...
#import "ABI33_0_0RCTSafeAreaView.h"
...
@implementation ABI33_0_0RCTSafeAreaView {
...
ABI33_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithCoder:(NSCoder *)decoder)
...
{
  UIViewController* vc = self.ReactABI33_0_0ViewController;
...
{
  if (UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI33_0_0RCTScreenScale())) {
    return;
  }

  _currentSafeAreaInsets = safeAreaInsets;

  ABI33_0_0RCTSafeAreaViewLocalData *localData = [[ABI33_0_0RCTSafeAreaViewLocalData alloc] initWithInsets:safeAreaInsets];
