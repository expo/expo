...
@implementation ABI33_0_0RCTRootContentView

- (instancetype)initWithFrame:(CGRect)frame
                       bridge:(ABI33_0_0RCTBridge *)bridge
                     ReactABI33_0_0Tag:(NSNumber *)ReactABI33_0_0Tag
               sizeFlexiblity:(ABI33_0_0RCTRootViewSizeFlexibility)sizeFlexibility
{
  if ((self = [super initWithFrame:frame])) {
    _bridge = bridge;
    self.ReactABI33_0_0Tag = ReactABI33_0_0Tag;
    _sizeFlexibility = sizeFlexibility;
    _touchHandler = [[ABI33_0_0RCTTouchHandler alloc] initWithBridge:_bridge];
...
ABI33_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithCoder:(nonnull NSCoder *)aDecoder)
...
- (CGSize)availableSize
{
  ...
  return CGSizeMake(
      _sizeFlexibility & ABI33_0_0RCTRootViewSizeFlexibilityWidth ? INFINITY : size.width,
      _sizeFlexibility & ABI33_0_0RCTRootViewSizeFlexibilityHeight ? INFINITY : size.height
    );
}

- (void)updateAvailableSize
{
  if (!self.ReactABI33_0_0Tag || !_bridge.isValid) {
    return;
  }
