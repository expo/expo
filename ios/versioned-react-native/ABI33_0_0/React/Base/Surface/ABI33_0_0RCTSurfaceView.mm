...
@implementation ABI33_0_0RCTSurfaceView {
  ABI33_0_0RCTSurfaceRootView *_Nullable _rootView;
...
- (void)setRootView:(ABI33_0_0RCTSurfaceRootView *)rootView
{
...
- (void)_updateStage
{
  if (ABI33_0_0RCTSurfaceStageIsRunning(_stage)) {
