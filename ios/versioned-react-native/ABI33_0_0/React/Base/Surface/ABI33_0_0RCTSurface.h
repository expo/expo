 ...
 */
@interface ABI33_0_0RCTSurface : NSObject
 ...
 *  - Calling on the main queue with `ABI33_0_0RCTSurfaceStageSurfaceDidInitialMounting`
 *    stage temporary is not supported; in this case the stage will be
 *    downgraded to `ABI33_0_0RCTSurfaceStageSurfaceDidInitialLayout`.
 */
 ...
 * Those methods are a no-op for regular ABI33_0_0RCTSurface (for now), but all call sites must call them appropriately.
 */
- (BOOL)start;
- (BOOL)stop;

#pragma mark - Mounting/Unmounting of ReactABI33_0_0 components

/**
 * Mount the ReactABI33_0_0 component specified by the given moduleName. This is typically
...
/**
 * Unmount the ReactABI33_0_0 component specified by the given rootViewTag, called from native.
 */
