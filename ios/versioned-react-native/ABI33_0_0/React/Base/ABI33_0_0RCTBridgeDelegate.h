...
@protocol ABI33_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI33_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI33_0_0RCTBridgeModules automatically, however
...
*/
- (BOOL)bridge:(ABI33_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI33_0_0RCTBridge *)bridge
                 onProgress:(ABI33_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI33_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI33_0_0RCTBridge *)bridge
                  withBlock:(ABI33_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Retrieve the list of lazy-native-modules names for the given bridge.
 */
- (NSDictionary<NSString *, Class> *)extraLazyModuleClassesForBridge:(ABI33_0_0RCTBridge *)bridge;
