 ...
 */
@interface ABI33_0_0RCTImageSource : NSObject
...
@interface ABI33_0_0RCTConvert (ImageSource)

+ (ABI33_0_0RCTImageSource *)ABI33_0_0RCTImageSource:(id)json;
+ (NSArray<ABI33_0_0RCTImageSource *> *)ABI33_0_0RCTImageSourceArray:(id)json;
