...
#import "ABI33_0_0RCTMultipartDataTask.h"

@interface ABI33_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI33_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI33_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI33_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI33_0_0RCTMultipartStreamReader *reader = [[ABI33_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI33_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
