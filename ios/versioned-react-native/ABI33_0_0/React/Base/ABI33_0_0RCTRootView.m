...
NSString *const ABI33_0_0RCTContentDidAppearNotification = @"ABI33_0_0RCTContentDidAppearNotification";

@interface ABI33_0_0RCTUIManager (ABI33_0_0RCTRootView)

- (NSNumber *)allocateRootTag;

@end

@implementation ABI33_0_0RCTRootView
{
  ABI33_0_0RCTBridge *_bridge;
  NSString *_moduleName;
  ABI33_0_0RCTRootContentView *_contentView;
             ...
             initialProperties:(NSDictionary *)initialProperties
{
  ...
  ABI33_0_0RCTAssert(bridge, @"A bridge instance is required to create an ABI33_0_0RCTRootView");
  ABI33_0_0RCTAssert(moduleName, @"A moduleName is required to create an ABI33_0_0RCTRootView");

  ABI33_0_0RCT_PROFILE_BEGIN_EVENT(ABI33_0_0RCTProfileTagAlways, @"-[ABI33_0_0RCTRootView init]", nil);
  if (!bridge.isLoading) {
  ...
  if (self = [super initWithFrame:CGRectZero]) {
    ...
    _sizeFlexibility = ABI33_0_0RCTRootViewSizeFlexibilityNone;

    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(bridgeDidReload)
                                                 name:ABI33_0_0RCTJavaScriptWillStartLoadingNotification
                                               object:_bridge];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(hideLoadingView)
                                                 name:ABI33_0_0RCTContentDidAppearNotification
                                               object:self];
...
{
  if (self.ReactABI33_0_0PreferredFocusedView) {
    return self.ReactABI33_0_0PreferredFocusedView;
  }
...
- (CGSize)sizeThatFits:(CGSize)size
{
  ...
  fitSize = CGSizeMake(
      _sizeFlexibility & ABI33_0_0RCTRootViewSizeFlexibilityWidth ? fitSize.width : currentSize.width,
      _sizeFlexibility & ABI33_0_0RCTRootViewSizeFlexibilityHeight ? fitSize.height : currentSize.height
    );
...
{
  ABI33_0_0RCTAssertMainQueue();
  if (!super.ReactABI33_0_0Tag) {
    /**
     * Every root view that is created must have a unique ReactABI33_0_0 tag.
     * Numbering of these tags goes from 1, 11, 21, 31, etc
     *
     * NOTE: Since the bridge persists, the RootViews might be reused, so the
     * ReactABI33_0_0 tag must be re-assigned every time a new UIManager is created.
     */
    self.ReactABI33_0_0Tag = ABI33_0_0RCTAllocateRootViewTag();
  }
  return super.ReactABI33_0_0Tag;
}

- (void)bridgeDidReload
{
  ABI33_0_0RCTAssertMainQueue();
  // Clear the ReactABI33_0_0Tag so it can be re-assigned
  self.ReactABI33_0_0Tag = nil;
}
...
- (void)javaScriptDidLoad:(NSNotification *)notification
{
  ...
  // ABI33_0_0RCTRootContentView is scoped to the right bridge
...
- (void)bundleFinishedLoading:(ABI33_0_0RCTBridge *)bridge
{
  ABI33_0_0RCTAssert(bridge != nil, @"Bridge cannot be nil");
  if (!bridge.valid) {
    return;
  }

  [_contentView removeFromSuperview];
  _contentView = [[ABI33_0_0RCTRootContentView alloc] initWithFrame:self.bounds
                                                    bridge:bridge
  ...
  if (_sizeFlexibility == ABI33_0_0RCTRootViewSizeFlexibilityNone) {
    self.intrinsicContentSize = self.bounds.size;
  }
}

- (void)runApplication:(ABI33_0_0RCTBridge *)bridge
{
  NSString *moduleName = _moduleName ?: @"";
  NSDictionary *appParameters = @{
    @"rootTag": _contentView.ReactABI33_0_0Tag,
...
@implementation ABI33_0_0RCTRootView (Deprecated)

- (CGSize)intrinsicSize
{
  ABI33_0_0RCTLogWarn(@"Calling deprecated `[-ABI33_0_0RCTRootView intrinsicSize]`.");
