...
typedef id<ABI33_0_0RCTBridgeModule>(^ABI33_0_0RCTBridgeModuleProvider)(void);

@interface ABI33_0_0RCTModuleData : NSObject <ABI33_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI33_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readwrite) id<ABI33_0_0RCTBridgeModule> instance;
