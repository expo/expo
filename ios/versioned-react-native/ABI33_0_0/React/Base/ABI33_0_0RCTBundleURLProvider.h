...
extern NSString *const ABI33_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI33_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI33_0_0RCTBundleURLProvider : NSObject
