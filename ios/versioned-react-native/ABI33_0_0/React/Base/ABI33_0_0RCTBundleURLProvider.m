...
#import "ABI33_0_0RCTBundleURLProvider.h"

#import "ABI33_0_0RCTConvert.h"
#import "ABI33_0_0RCTDefines.h"

NSString *const ABI33_0_0RCTBundleURLProviderUpdatedNotification = @"ABI33_0_0RCTBundleURLProviderUpdatedNotification";

const NSUInteger kABI33_0_0RCTBundleURLProviderDefaultPort = ABI33_0_0RCT_METRO_PORT;

static NSString *const kABI33_0_0RCTJsLocationKey = @"ABI33_0_0RCT_jsLocation";
static NSString *const kABI33_0_0RCTEnableLiveReloadKey = @"ABI33_0_0RCT_enableLiveReload";
static NSString *const kABI33_0_0RCTEnableDevKey = @"ABI33_0_0RCT_enableDev";
static NSString *const kABI33_0_0RCTEnableMinificationKey = @"ABI33_0_0RCT_enableMinification";

@implementation ABI33_0_0RCTBundleURLProvider
...
{
  return @{
    kABI33_0_0RCTEnableLiveReloadKey: @NO,
    kABI33_0_0RCTEnableDevKey: @YES,
    kABI33_0_0RCTEnableMinificationKey: @NO,
  };
}

- (void)settingsUpdated
{
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI33_0_0RCTBundleURLProviderUpdatedNotification object:self];
}
...
static NSURL *serverRootWithHost(NSString *host)
{
  return [NSURL URLWithString:
          [NSString stringWithFormat:@"http://%@:%lu/",
           host, (unsigned long)kABI33_0_0RCTBundleURLProviderDefaultPort]];
}
...
- (NSURL *)jsBundleURLForBundleRoot:(NSString *)bundleRoot fallbackResource:(NSString *)resourceName fallbackExtension:(NSString *)extension
{
  ...
  if (!packagerServerHost) {
    ...
    return [ABI33_0_0RCTBundleURLProvider jsBundleURLForBundleRoot:bundleRoot
...
- (BOOL)enableDev
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI33_0_0RCTEnableDevKey];
}

- (BOOL)enableLiveReload
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI33_0_0RCTEnableLiveReloadKey];
}

- (BOOL)enableMinification
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI33_0_0RCTEnableMinificationKey];
}

- (NSString *)jsLocation
{
  return [[NSUserDefaults standardUserDefaults] stringForKey:kABI33_0_0RCTJsLocationKey];
}

- (void)setEnableDev:(BOOL)enableDev
{
  [self updateValue:@(enableDev) forKey:kABI33_0_0RCTEnableDevKey];
}

- (void)setEnableLiveReload:(BOOL)enableLiveReload
{
  [self updateValue:@(enableLiveReload) forKey:kABI33_0_0RCTEnableLiveReloadKey];
}

- (void)setJsLocation:(NSString *)jsLocation
{
  [self updateValue:jsLocation forKey:kABI33_0_0RCTJsLocationKey];
}

- (void)setEnableMinification:(BOOL)enableMinification
{
  [self updateValue:@(enableMinification) forKey:kABI33_0_0RCTEnableMinificationKey];
}

+ (instancetype)sharedSettings
{
  static ABI33_0_0RCTBundleURLProvider *sharedInstance;
  static dispatch_once_t once_token;
  dispatch_once(&once_token, ^{
    sharedInstance = [ABI33_0_0RCTBundleURLProvider new];
  });
