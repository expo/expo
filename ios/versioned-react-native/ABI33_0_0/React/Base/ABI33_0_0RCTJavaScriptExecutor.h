...
typedef void (^ABI33_0_0RCTJavaScriptCompleteBlock)(NSError *error);
typedef void (^ABI33_0_0RCTJavaScriptCallback)(id result, NSError *error);
...
- (void)executeApplicationScript:(NSData *)script
                      ...
                      onComplete:(ABI33_0_0RCTJavaScriptCompleteBlock)onComplete;

- (void)injectJSONText:(NSString *)script
   asGlobalObjectNamed:(NSString *)objectName
              callback:(ABI33_0_0RCTJavaScriptCompleteBlock)onComplete;
