...
#import "ABI33_0_0RCTScheduler.h"

#import <ReactABI33_0_0/debug/SystraceSection.h>
#import <ReactABI33_0_0/uimanager/ComponentDescriptorFactory.h>
#import <ReactABI33_0_0/uimanager/ContextContainer.h>
#import <ReactABI33_0_0/uimanager/Scheduler.h>
#import <ReactABI33_0_0/uimanager/SchedulerDelegate.h>
...
public:
  ...
  void schedulerDidFinishTransaction(Tag rootTag, const ShadowViewMutationList &mutations, const long commitStartTime, const long layoutTime) override {
    ABI33_0_0RCTScheduler *scheduler = (__bridge ABI33_0_0RCTScheduler *)scheduler_;
...
@implementation ABI33_0_0RCTScheduler {
...
{
  SystraceSection s("-[ABI33_0_0RCTScheduler startSurfaceWithSurfaceId:...]");

  auto props = convertIdToFollyDynamic(initialProps);
  _scheduler->startSurface(
      surfaceId,
      ABI33_0_0RCTStringFromNSString(moduleName),
      props,
      layoutConstraints,
      layoutContext);
...
{
  SystraceSection s("-[ABI33_0_0RCTScheduler stopSurfaceWithSurfaceId:]");
...
{
  SystraceSection s("-[ABI33_0_0RCTScheduler measureSurfaceWithLayoutConstraints:]");
  return ABI33_0_0RCTCGSizeFromSize(_scheduler->measureSurface(surfaceId, layoutConstraints, layoutContext));
}
...
- (void)constraintSurfaceLayoutWithLayoutConstraints:(LayoutConstraints)layoutConstraints
                                       layoutContext:(LayoutContext)layoutContext
                                           surfaceId:(SurfaceId)surfaceId
{
  SystraceSection s("-[ABI33_0_0RCTScheduler constraintSurfaceLayoutWithLayoutConstraints:]");
