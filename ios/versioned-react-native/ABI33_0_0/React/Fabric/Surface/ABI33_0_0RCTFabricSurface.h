...
@class ABI33_0_0RCTSurfaceView;
@class ABI33_0_0RCTSurfacePresenter;
@protocol ABI33_0_0RCTSurfaceDelegate;

/**
 * (This is Fabric-compatible ABI33_0_0RCTSurface implementation.)
 *
 * ABI33_0_0RCTSurface instance represents ReactABI33_0_0 Native-powered piece of a user interface
 * which can be a full-screen app, separate modal view controller,
 * or even small widget.
 * It is called "Surface".
 *
 * The ABI33_0_0RCTSurface instance is completely thread-safe by design;
 ...
 *
 * The primary goals of the ABI33_0_0RCTSurface are:
 ...
 */
@interface ABI33_0_0RCTFabricSurface : NSObject

@property (atomic, readonly) ABI33_0_0RCTSurfaceStage stage;
@property (atomic, readonly) NSString *moduleName;
@property (atomic, readonly) ReactABI33_0_0Tag rootTag;

@property (atomic, readwrite, weak, nullable) id<ABI33_0_0RCTSurfaceDelegate> delegate;
 ...
 * ABI33_0_0RCTSurface does not control (or influence in any way) the size or origin
 ...
 * The starting process includes initializing all underlying ReactABI33_0_0 Native
 * infrastructure and running ReactABI33_0_0 app.
...
/**
 * Simple shortcut to `-[ABI33_0_0RCTSurface setMinimumSize:size maximumSize:size]`.
 */
...
@interface ABI33_0_0RCTFabricSurface (Internal)
...
@interface ABI33_0_0RCTFabricSurface (Deprecated)
