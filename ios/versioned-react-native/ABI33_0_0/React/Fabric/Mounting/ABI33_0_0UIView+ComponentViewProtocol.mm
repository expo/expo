...
#import "ABI33_0_0UIView+ComponentViewProtocol.h"
...
{
  ABI33_0_0RCTAssert(childComponentView.superview == self, @"Attempt to unmount improperly mounted component view.");
...
- (void)updateLayoutMetrics:(LayoutMetrics)layoutMetrics oldLayoutMetrics:(LayoutMetrics)oldLayoutMetrics
{
  if (layoutMetrics.frame != oldLayoutMetrics.frame) {
    self.frame = ABI33_0_0RCTCGRectFromRect(layoutMetrics.frame);
  }
