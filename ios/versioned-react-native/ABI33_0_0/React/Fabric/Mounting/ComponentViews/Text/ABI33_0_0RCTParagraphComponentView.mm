...
#import <ReactABI33_0_0/components/text/ParagraphLocalData.h>
#import <ReactABI33_0_0/components/text/ParagraphProps.h>
#import <ReactABI33_0_0/components/text/ParagraphShadowNode.h>
#import <ReactABI33_0_0/core/LocalData.h>
#import <ReactABI33_0_0/graphics/Geometry.h>
#import <ReactABI33_0_0/textlayoutmanager/TextLayoutManager.h>
#import <ReactABI33_0_0/textlayoutmanager/ABI33_0_0RCTTextLayoutManager.h>
#import "ABI33_0_0RCTConversions.h"

using namespace facebook::ReactABI33_0_0;

@implementation ABI33_0_0RCTParagraphComponentView {
...
- (void)drawRect:(CGRect)rect
{
  ...
  ABI33_0_0RCTTextLayoutManager *nativeTextLayoutManager =
    (__bridge ABI33_0_0RCTTextLayoutManager *)textLayoutManager->getNativeTextLayoutManager();

  CGRect frame = ABI33_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
...
- (NSString *)accessibilityLabel
{
  NSString *superAccessibilityLabel =
    ABI33_0_0RCTNSStringFromStringNilIfEmpty(_props->accessibilityLabel);
  ...
  return ABI33_0_0RCTNSStringFromString(_paragraphLocalData->getAttributedString().getString());
}
...
- (SharedTouchEventEmitter)touchEventEmitterAtPoint:(CGPoint)point
{
  ...
  ABI33_0_0RCTTextLayoutManager *nativeTextLayoutManager = (__bridge ABI33_0_0RCTTextLayoutManager *)textLayoutManager->getNativeTextLayoutManager();
  CGRect frame = ABI33_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
