...
#import <ReactABI33_0_0/components/scrollview/ScrollViewShadowNode.h>
#import <ReactABI33_0_0/components/scrollview/ScrollViewLocalData.h>
#import <ReactABI33_0_0/components/scrollview/ScrollViewProps.h>
#import <ReactABI33_0_0/components/scrollview/ScrollViewEventEmitter.h>
#import <ReactABI33_0_0/graphics/Geometry.h>

#import "ABI33_0_0RCTConversions.h"
#import "ABI33_0_0RCTEnhancedScrollView.h"

using namespace facebook::ReactABI33_0_0;

@interface ABI33_0_0RCTScrollViewComponentView () <UIScrollViewDelegate>

@property (nonatomic, assign) CGFloat scrollEventThrottle;

@end

@implementation ABI33_0_0RCTScrollViewComponentView {
  ABI33_0_0RCTEnhancedScrollView *_Nonnull _scrollView;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _scrollView = [[ABI33_0_0RCTEnhancedScrollView alloc] initWithFrame:self.bounds];
...
#define REMAP_PROP(ReactABI33_0_0Name, localName, target) \
  if (oldScrollViewProps.ReactABI33_0_0Name != newScrollViewProps.ReactABI33_0_0Name) { \
    target.localName = newScrollViewProps.ReactABI33_0_0Name; \
  }

#define REMAP_VIEW_PROP(ReactABI33_0_0Name, localName) REMAP_PROP(ReactABI33_0_0Name, localName, self)
#define MAP_VIEW_PROP(name) REMAP_VIEW_PROP(name, name)
#define REMAP_SCROLL_VIEW_PROP(ReactABI33_0_0Name, localName) REMAP_PROP(ReactABI33_0_0Name, localName, _scrollView)
           ...
           oldLocalData:(SharedLocalData)oldLocalData
{
  ...
  CGSize contentSize = ABI33_0_0RCTCGSizeFromSize(_scrollViewLocalData->getContentSize());
  _contentView.frame = CGRect {CGPointZero, contentSize};
  _scrollView.contentSize = contentSize;
}

- (void)mountChildComponentView:(UIView<ABI33_0_0RCTComponentViewProtocol> *)childComponentView
                          index:(NSInteger)index
{
  [_contentView insertSubview:childComponentView atIndex:index];
}

- (void)unmountChildComponentView:(UIView<ABI33_0_0RCTComponentViewProtocol> *)childComponentView
                            index:(NSInteger)index
{
  ABI33_0_0RCTAssert(childComponentView.superview == _contentView, @"Attempt to unmount improperly mounted component view.");
...
- (ScrollViewMetrics)_scrollViewMetrics
{
  ...
  metrics.contentSize = ABI33_0_0RCTSizeFromCGSize(_scrollView.contentSize);
  metrics.contentOffset = ABI33_0_0RCTPointFromCGPoint(_scrollView.contentOffset);
  metrics.contentInset = ABI33_0_0RCTEdgeInsetsFromUIEdgeInsets(_scrollView.contentInset);
  metrics.containerSize = ABI33_0_0RCTSizeFromCGSize(_scrollView.bounds.size);
