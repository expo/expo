...
#import <ReactABI33_0_0/components/view/ViewShadowNode.h>
#import <ReactABI33_0_0/components/view/ViewProps.h>
#import <ReactABI33_0_0/components/view/ViewEventEmitter.h>
#import <objc/runtime.h>
#import <ReactABI33_0_0/ABI33_0_0RCTAssert.h>
#import <ReactABI33_0_0/ABI33_0_0RCTBorderDrawing.h>

#import "ABI33_0_0RCTConversions.h"

using namespace facebook::ReactABI33_0_0;

@implementation ABI33_0_0RCTViewComponentView
{
...
- (void)layoutSubviews
{
  ...
  if (_contentView) {
    _contentView.frame = ABI33_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
  }
}
...
#pragma mark - ABI33_0_0RCTComponentViewProtocol

+ (ComponentHandle)componentHandle
{
  ABI33_0_0RCTAssert(
    self == [ABI33_0_0RCTViewComponentView class],
    @"`+[ABI33_0_0RCTComponentViewProtocol componentHandle]` must be implemented for all subclasses (and `%@` particularly).", NSStringFromClass([self class]));
           ...
           oldProps:(SharedProps)oldProps
{
  ...
  ABI33_0_0RCTAssert(
    propsRawPtr &&
    (
      [self class] == [ABI33_0_0RCTViewComponentView class] ||
      typeid(*propsRawPtr).hash_code() != typeid(const ViewProps).hash_code()
    ),
    @"`ABI33_0_0RCTViewComponentView` subclasses (and `%@` particularly) must setup `_props`"
  ...
  if (oldViewProps.backgroundColor != newViewProps.backgroundColor) {
    _backgroundColor = ABI33_0_0RCTUIColorFromSharedColor(newViewProps.backgroundColor);
    needsInvalidateLayer = YES;
  }

  // `foregroundColor`
  if (oldViewProps.foregroundColor != newViewProps.foregroundColor) {
    self.foregroundColor = ABI33_0_0RCTUIColorFromSharedColor(newViewProps.foregroundColor);
  }

  // `shadowColor`
  if (oldViewProps.shadowColor != newViewProps.shadowColor) {
    CGColorRef shadowColor = ABI33_0_0RCTCGColorRefFromSharedColor(newViewProps.shadowColor);
  ...
  if (oldViewProps.shadowOffset != newViewProps.shadowOffset) {
    self.layer.shadowOffset = ABI33_0_0RCTCGSizeFromSize(newViewProps.shadowOffset);
    needsInvalidateLayer = YES;
  }
  ...
  if (oldViewProps.transform != newViewProps.transform) {
    self.layer.transform = ABI33_0_0RCTCATransform3DFromTransformMatrix(newViewProps.transform);
    self.layer.allowsEdgeAntialiasing = newViewProps.transform != Transform::Identity();
  }

  // `hitSlop`
  if (oldViewProps.hitSlop != newViewProps.hitSlop) {
    self.hitTestEdgeInsets = ABI33_0_0RCTUIEdgeInsetsFromEdgeInsets(newViewProps.hitSlop);
  }

  // `overflow`
  if (oldViewProps.ABI33_0_0yogaStyle.overflow != newViewProps.ABI33_0_0yogaStyle.overflow) {
    self.clipsToBounds = newViewProps.ABI33_0_0yogaStyle.overflow != ABI33_0_0YGOverflowVisible;
    needsInvalidateLayer = YES;
  }
  ...
  if (oldViewProps.nativeId != newViewProps.nativeId) {
    self.nativeId = ABI33_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.nativeId);
  }
  ...
  if (oldViewProps.accessibilityLabel != newViewProps.accessibilityLabel) {
    self.accessibilityElement.accessibilityLabel = ABI33_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityLabel);
  }

  // `accessibilityHint`
  if (oldViewProps.accessibilityHint != newViewProps.accessibilityHint) {
    self.accessibilityElement.accessibilityHint = ABI33_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityHint);
  }

  // `accessibilityTraits`
  if (oldViewProps.accessibilityTraits != newViewProps.accessibilityTraits) {
    self.accessibilityElement.accessibilityTraits = ABI33_0_0RCTUIAccessibilityTraitsFromAccessibilityTraits(newViewProps.accessibilityTraits);
  }
...
static ABI33_0_0RCTCornerRadii ABI33_0_0RCTCornerRadiiFromBorderRadii(BorderRadii borderRadii) {
  return ABI33_0_0RCTCornerRadii {
...
static ABI33_0_0RCTBorderColors ABI33_0_0RCTBorderColorsFromBorderColors(BorderColors borderColors) {
  return ABI33_0_0RCTBorderColors {
    .left = ABI33_0_0RCTCGColorRefFromSharedColor(borderColors.left),
    .top = ABI33_0_0RCTCGColorRefFromSharedColor(borderColors.top),
    .bottom = ABI33_0_0RCTCGColorRefFromSharedColor(borderColors.bottom),
    .right = ABI33_0_0RCTCGColorRefFromSharedColor(borderColors.right)
  };
}
...
static ABI33_0_0RCTBorderStyle ABI33_0_0RCTBorderStyleFromBorderStyle(BorderStyle borderStyle) {
  switch (borderStyle) {
    case BorderStyle::Solid:
      return ABI33_0_0RCTBorderStyleSolid;
    case BorderStyle::Dotted:
      return ABI33_0_0RCTBorderStyleDotted;
    case BorderStyle::Dashed:
      return ABI33_0_0RCTBorderStyleDashed;
  }
}
...
- (void)invalidateLayer
{
  ...
  if (layerHasShadow) {
    if (CGColorGetAlpha(_backgroundColor.CGColor) > 0.999) {
      ...
      const ABI33_0_0RCTCornerInsets cornerInsets =
        ABI33_0_0RCTGetCornerInsets(ABI33_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero);
      CGPathRef shadowPath = ABI33_0_0RCTPathCreateWithRoundedRect(self.bounds, cornerInsets, nil);
  ...
  if (useCoreAnimationBorderRendering) {
    ...
    layer.borderColor = ABI33_0_0RCTCGColorRefFromSharedColor(borderMetrics.borderColors.left);
    ...
    UIImage *image = ABI33_0_0RCTGetBorderImage(
      ABI33_0_0RCTBorderStyleFromBorderStyle(borderMetrics.borderStyles.left),
      layer.bounds.size,
      ABI33_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii),
      UIEdgeInsetsFromBorderInsets(borderMetrics.borderWidths),
      ABI33_0_0RCTBorderColorsFromBorderColors(borderMetrics.borderColors),
    ...
    if (self.clipsToBounds) {
      if (borderMetrics.borderRadii.isUniform()) {
        ...
        CGPathRef path = ABI33_0_0RCTPathCreateWithRoundedRect(
          self.bounds,
          ABI33_0_0RCTGetCornerInsets(ABI33_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero),
          nil
        );
...
static NSString *ABI33_0_0RCTRecursiveAccessibilityLabel(UIView *view)
{
  NSMutableString *result = [NSMutableString stringWithString:@""];
  for (UIView *subview in view.subviews) {
    NSString *label = subview.accessibilityLabel;
    if (!label) {
      label = ABI33_0_0RCTRecursiveAccessibilityLabel(subview);
    }
...
- (NSString *)accessibilityLabel
{
  ...
  return ABI33_0_0RCTRecursiveAccessibilityLabel(self);
}
...
- (NSArray<UIAccessibilityCustomAction *> *)accessibilityCustomActions
{
  ...
  for (const auto &accessibilityAction : accessibilityActions) {
    [customActions addObject:[[UIAccessibilityCustomAction alloc] initWithName:ABI33_0_0RCTNSStringFromString(accessibilityAction)
                                                                        target:self
...
{
  _eventEmitter->onAccessibilityAction(ABI33_0_0RCTStringFromNSString(action.name));
  return YES;
}
