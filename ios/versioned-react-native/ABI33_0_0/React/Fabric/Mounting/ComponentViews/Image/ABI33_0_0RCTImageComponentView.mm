...
#import <ReactABI33_0_0/components/image/ImageEventEmitter.h>
#import <ReactABI33_0_0/components/image/ImageLocalData.h>
#import <ReactABI33_0_0/components/image/ImageProps.h>
#import <ReactABI33_0_0/components/image/ImageShadowNode.h>
#import <ReactABI33_0_0/imagemanager/ImageRequest.h>
#import <ReactABI33_0_0/imagemanager/ABI33_0_0RCTImagePrimitivesConversions.h>
...
@implementation ABI33_0_0RCTImageComponentView {
  UIImageView *_imageView;
  SharedImageLocalData _imageLocalData;
  const ImageResponseObserverCoordinator *_coordinator;
  std::unique_ptr<ABI33_0_0RCTImageResponseObserverProxy> _imageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _imageView.contentMode = (UIViewContentMode)ABI33_0_0RCTResizeModeFromImageResizeMode(defaultProps->resizeMode);
      
    _imageResponseObserverProxy = std::make_unique<ABI33_0_0RCTImageResponseObserverProxy>((__bridge void *)self);
...
- (void)updateProps:(SharedProps)props oldProps:(SharedProps)oldProps
{
  ...
  if (oldImageProps.resizeMode != newImageProps.resizeMode) {
    if (newImageProps.resizeMode == ImageResizeMode::Repeat) {
      ...
      _imageView.contentMode = (UIViewContentMode)ABI33_0_0RCTResizeModeFromImageResizeMode(newImageProps.resizeMode);
    }
  }
...
- (void)didReceiveImage:(UIImage *)image fromObserver:(void*)observer
{
  ...
  if (imageProps.resizeMode == ImageResizeMode::Repeat) {
    image = [image resizableImageWithCapInsets:ABI33_0_0RCTUIEdgeInsetsFromEdgeInsets(imageProps.capInsets)
