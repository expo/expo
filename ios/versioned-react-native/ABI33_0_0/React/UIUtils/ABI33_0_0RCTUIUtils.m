...
ABI33_0_0RCTDimensions ABI33_0_0RCTGetDimensions(CGFloat fontScale)
{
  UIScreen *mainScreen = UIScreen.mainScreen;
  CGSize screenSize = mainScreen.bounds.size;

  UIView *mainWindow;
  mainWindow = ABI33_0_0RCTKeyWindow();
  CGSize windowSize = mainWindow.bounds.size;

  ABI33_0_0RCTDimensions result;
...
CGFloat ABI33_0_0RCTGetMultiplierForContentSizeCategory(UIContentSizeCategory category)
{
