...
@implementation ABI33_0_0RCTInspectorDevServerHelper

ABI33_0_0RCT_NOT_IMPLEMENTED(- (instancetype)init)

static NSMutableDictionary<NSString *, ABI33_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
...
+ (ABI33_0_0RCTInspectorPackagerConnection *)connectWithBundleURL:(NSURL *)bundleURL
{
  ...
  ABI33_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection) {
    connection = [[ABI33_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
