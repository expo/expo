...
#import <ABI33_0_0UMBarCodeScannerInterface/ABI33_0_0UMBarCodeScannerProviderInterface.h>
...
#import <ABI33_0_0UMFaceDetectorInterface/ABI33_0_0UMFaceDetectorManagerProvider.h>
...
@property (nonatomic, strong) id<ABI33_0_0UMFaceDetectorManager> faceDetectorManager;
@property (nonatomic, strong) id<ABI33_0_0UMBarCodeScannerInterface> barCodeScanner;
...
@property (nonatomic, strong) ABI33_0_0UMPromiseResolveBlock videoRecordedResolve;
@property (nonatomic, strong) ABI33_0_0UMPromiseRejectBlock videoRecordedReject;
...
@property (nonatomic, copy) ABI33_0_0UMDirectEventBlock onPictureSaved;

@property (nonatomic, copy) ABI33_0_0UMDirectEventBlock onBarCodeScanned;
@property (nonatomic, copy) ABI33_0_0UMDirectEventBlock onFacesDetected;

@end

@implementation ABI33_0_0EXCamera
...
- (void)updateFlashMode
{
  ...
  if (_flashMode == ABI33_0_0EXCameraFlashModeTorch) {
    if (![device hasTorch]) {
      return;
    }
    ...
    if (![device lockForConfiguration:&error]) {
      if (error) {
        ABI33_0_0UMLogInfo(@"%s: %@", __func__, error);
      }
      return;
    }
...
- (void)updateFocusDepth
{
  ...
  if (device == nil || device.focusMode != ABI33_0_0EXCameraAutoFocusOff) {
    return;
  }
  ...
  if ([device isLockingFocusWithCustomLensPositionSupported]) {
    ...
    ABI33_0_0UM_WEAKIFY(device);
    [device setFocusModeLockedWithLensPosition:_focusDepth completionHandler:^(CMTime syncTime) {
      ABI33_0_0UM_ENSURE_STRONGIFY(device);
      [device unlockForConfiguration];
    }];
    return;
  }

  ABI33_0_0UMLogInfo(@"%s: Setting focusDepth isn't supported for this camera device", __func__);
  return;
}
...
- (void)updateWhiteBalance
{
  ...
  if (_whiteBalance == ABI33_0_0EXCameraWhiteBalanceAuto) {
    [device setWhiteBalanceMode:AVCaptureWhiteBalanceModeContinuousAutoWhiteBalance];
    [device unlockForConfiguration];
  } else {
    AVCaptureWhiteBalanceTemperatureAndTintValues temperatureAndTint = {
      .temperature = [ABI33_0_0EXCameraUtils temperatureForWhiteBalance:_whiteBalance],
      .tint = 0,
    };
...
- (void)takePicture:(NSDictionary *)options resolve:(ABI33_0_0UMPromiseResolveBlock)resolve reject:(ABI33_0_0UMPromiseRejectBlock)reject
{
  ...
  [_stillImageOutput captureStillImageAsynchronouslyFromConnection:connection completionHandler: ^(CMSampleBufferRef imageSampleBuffer, NSError *error) {
    ...
    takenImage = [ABI33_0_0EXCameraUtils cropImage:takenImage toRect:croppedSize];
    ...
    response[@"uri"] = [ABI33_0_0EXCameraUtils writeImage:takenImageData toPath:path];
    ...
    if ([options[@"exif"] boolValue]) {
      ...
      [ABI33_0_0EXCameraUtils updatePhotoMetadata:imageSampleBuffer withAdditionalData:@{ @"Orientation": @(imageRotation) } inResponse:response]; // TODO
    }
...
- (void)record:(NSDictionary *)options resolve:(ABI33_0_0UMPromiseResolveBlock)resolve reject:(ABI33_0_0UMPromiseRejectBlock)reject
{
  ...
  if (_movieFileOutput != nil && !_movieFileOutput.isRecording && _videoRecordedResolve == nil && _videoRecordedReject == nil) {
    ...
    if (options[@"quality"]) {
      ABI33_0_0EXCameraVideoResolution resolution = [options[@"quality"] integerValue];
      preset = [ABI33_0_0EXCameraUtils captureSessionPresetForVideoResolution:resolution];
    ...
    if (self.videoStabilizationMode != nil) {
      if (connection.isVideoStabilizationSupported == NO) {
        ABI33_0_0UMLogWarn(@"%s: Video Stabilization is not supported on this device.", __func__);
      } else {
...
- (void)initializeCaptureSessionInput
{
  ...
  AVCaptureVideoOrientation orientation = [ABI33_0_0EXCameraUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI33_0_0EXCameraUtils deviceWithMediaType:AVMediaTypeVideo preferringPosition:self.presetCamera];
...
{
  ABI33_0_0UM_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI33_0_0EXCameraUtils videoOrientationForInterfaceOrientation:orientation];
  [ABI33_0_0UMUtilities performSynchronouslyOnMainThread:^{
    ABI33_0_0UM_ENSURE_STRONGIFY(self);
...
{
  id <ABI33_0_0UMFaceDetectorManagerProvider> faceDetectorProvider = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI33_0_0UMFaceDetectorManagerProvider)];

  if (faceDetectorProvider) {
    id <ABI33_0_0UMFaceDetectorManager> faceDetector = [faceDetectorProvider createFaceDetectorManager];
    if (faceDetector) {
      ABI33_0_0UM_WEAKIFY(self);
...
{
  id<ABI33_0_0UMBarCodeScannerProviderInterface> barCodeScannerProvider = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI33_0_0UMBarCodeScannerProviderInterface)];
  if (barCodeScannerProvider) {
    id<ABI33_0_0UMBarCodeScannerInterface> barCodeScanner = [barCodeScannerProvider createBarCodeScanner];
    if (barCodeScanner) {
      ABI33_0_0UM_WEAKIFY(self);
