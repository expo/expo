...
// Interface for ABI33_0_0UMTaskManager module.

@protocol ABI33_0_0UMTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI33_0_0UMTaskConsumerInterface protocol.
 */
