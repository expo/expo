...
typedef NS_OPTIONS(NSUInteger, ABI33_0_0EXAudioInterruptionMode)
{
  ABI33_0_0EXAudioInterruptionModeMixWithOthers = 0,
  ABI33_0_0EXAudioInterruptionModeDoNotMix      = 1,
  ABI33_0_0EXAudioInterruptionModeDuckOthers    = 2
};

typedef NS_OPTIONS(NSUInteger, ABI33_0_0EXAudioRecordingOptionBitRateStrategy)
{
  ABI33_0_0EXAudioRecordingOptionBitRateStrategyConstant            = 0,
  ABI33_0_0EXAudioRecordingOptionBitRateStrategyLongTermAverage     = 1,
  ABI33_0_0EXAudioRecordingOptionBitRateStrategyVariableConstrained = 2,
  ABI33_0_0EXAudioRecordingOptionBitRateStrategyVariable            = 3
};

@protocol ABI33_0_0EXAVScopedModuleDelegate
...
@protocol ABI33_0_0EXAVInterface
...
@interface ABI33_0_0EXAV : ABI33_0_0UMExportedModule <ABI33_0_0UMEventEmitter, ABI33_0_0UMAppLifecycleListener, ABI33_0_0UMModuleRegistryConsumer, ABI33_0_0EXAVInterface>
