...
#import <ABI33_0_0EXHaptics/ABI33_0_0EXHapticsModule.h>

@interface ABI33_0_0EXHapticsModule ()

@end

@implementation ABI33_0_0EXHapticsModule

ABI33_0_0UM_EXPORT_MODULE(ExpoHaptics);
...
ABI33_0_0UM_EXPORT_METHOD_AS(notificationAsync,
...
ABI33_0_0UM_EXPORT_METHOD_AS(impactAsync,
...
ABI33_0_0UM_EXPORT_METHOD_AS(selectionAsync,
                    resolve:(ABI33_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
