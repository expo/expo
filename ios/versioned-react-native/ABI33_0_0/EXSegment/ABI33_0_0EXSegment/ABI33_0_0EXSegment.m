...
#import <ABI33_0_0EXSegment/ABI33_0_0EXSegment.h>
#import <ABI33_0_0UMConstantsInterface/ABI33_0_0UMConstantsInterface.h>
#import <Analytics/SEGAnalytics.h>

static NSString *const ABI33_0_0EXSegmentOptOutKey = @"ABI33_0_0EXSegmentOptOutKey";

@interface ABI33_0_0EXSegment ()

@property (nonatomic, strong) SEGAnalytics *instance;

@end

@implementation ABI33_0_0EXSegment

ABI33_0_0UM_EXPORT_MODULE(ExponentSegment)

ABI33_0_0UM_EXPORT_METHOD_AS(initializeIOS,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSNumber *optOutSetting = [[NSUserDefaults standardUserDefaults] objectForKey:ABI33_0_0EXSegmentOptOutKey];
...
ABI33_0_0UM_EXPORT_METHOD_AS(initializeAndroid,
...
ABI33_0_0UM_EXPORT_METHOD_AS(identify,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
 ...
 ABI33_0_0UM_EXPORT_METHOD_AS(identifyWithTraits,
...
ABI33_0_0UM_EXPORT_METHOD_AS(track,
...
ABI33_0_0UM_EXPORT_METHOD_AS(trackWithProperties,
...
ABI33_0_0UM_EXPORT_METHOD_AS(group,
...
ABI33_0_0UM_EXPORT_METHOD_AS(groupWithTraits,
...
ABI33_0_0UM_EXPORT_METHOD_AS(alias,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (analytics) {
    ...
    resolve(ABI33_0_0UMNullIfNil(nil));
  } else {
...
ABI33_0_0UM_EXPORT_METHOD_AS(screen,
...
ABI33_0_0UM_EXPORT_METHOD_AS(screenWithProperties,
...
ABI33_0_0UM_EXPORT_METHOD_AS(reset,
                    resetWithResolver:(ABI33_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  if (_instance) {
    [_instance reset];
...
ABI33_0_0UM_EXPORT_METHOD_AS(flush,
                    flushWithResolver:(ABI33_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  if (_instance) {
    [_instance flush];
...
ABI33_0_0UM_EXPORT_METHOD_AS(getEnabledAsync,
                    getEnabledWithResolver:(ABI33_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  NSNumber *optOutSetting = [[NSUserDefaults standardUserDefaults] objectForKey:ABI33_0_0EXSegmentOptOutKey];
...
ABI33_0_0UM_EXPORT_METHOD_AS(setEnabledAsync,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  [[NSUserDefaults standardUserDefaults] setBool:enabled forKey:ABI33_0_0EXSegmentOptOutKey];
  if (_instance) {
    if (enabled) {
      [_instance enable];
    } else {
