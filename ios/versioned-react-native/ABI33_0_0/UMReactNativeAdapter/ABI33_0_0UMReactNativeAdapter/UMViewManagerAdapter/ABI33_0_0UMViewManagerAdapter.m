...
@interface ABI33_0_0UMViewManagerAdapter ()

@property ABI33_0_0UMViewManager *viewManager;

@end

@implementation ABI33_0_0UMViewManagerAdapter
...
// in runtime by ABI33_0_0UMNativeModulesProxy for each exported view manager.
// Each created class has different class name, conforming to convention.
// This way we can provide ReactABI33_0_0 Native with different ABI33_0_0RCTViewManagers
...
ABI33_0_0RCT_CUSTOM_VIEW_PROPERTY(proxiedProperties, NSDictionary, UIView)
{
  __weak ABI33_0_0UMViewManagerAdapter *weakSelf = self;
  [json enumerateKeysAndObjectsUsingBlock:^(id  _Nonnull key, id  _Nonnull obj, BOOL * _Nonnull stop) {
    __strong ABI33_0_0UMViewManagerAdapter *strongSelf = weakSelf;
