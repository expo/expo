...
@interface ABI33_0_0UMNativeModulesProxy ()

@property (nonatomic, strong) NSRegularExpression *regexp;
@property (nonatomic, strong) ABI33_0_0UMModuleRegistry *moduleRegistry;
...
@implementation ABI33_0_0UMNativeModulesProxy
...
# pragma mark - ReactABI33_0_0 API
...
- (NSDictionary *)constantsToExport
{
  ...
  NSArray<ABI33_0_0UMViewManager *> *viewManagers = [_moduleRegistry getAllViewManagers];
  NSMutableArray<NSString *> *viewManagersNames = [NSMutableArray arrayWithCapacity:[viewManagers count]];
  for (ABI33_0_0UMViewManager *viewManager in viewManagers) {
...
ABI33_0_0RCT_EXPORT_METHOD(callMethod:(NSString *)moduleName methodNameOrKey:(id)methodNameOrKey arguments:(NSArray *)arguments resolver:(ABI33_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI33_0_0RCTPromiseRejectBlock)reject)
{
