...
@implementation ABI33_0_0EXAdsDFPBannerView {
  DFPBannerView *_bannerView;
  id<ABI33_0_0UMEventEmitterService> _eventEmitter;
}
...
- (void)setOnSizeChange:(ABI33_0_0UMDirectEventBlock)block
{
  _onSizeChange = block;
  [self loadBanner];
}

- (void)setOnDidFailToReceiveAdWithError:(ABI33_0_0UMDirectEventBlock)block
{
