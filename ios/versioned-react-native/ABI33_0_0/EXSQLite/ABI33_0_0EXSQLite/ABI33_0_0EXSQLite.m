...
#import <ABI33_0_0EXSQLite/ABI33_0_0EXSQLite.h>

#import <ABI33_0_0UMFileSystemInterface/ABI33_0_0UMFileSystemInterface.h>

#import <sqlite3.h>

@interface ABI33_0_0EXSQLite ()
...
@implementation ABI33_0_0EXSQLite
...
ABI33_0_0UM_EXPORT_MODULE(ExponentSQLite);
...
- (NSString *)pathForDatabaseName:(NSString *)name
{
  ...
  if (!fileSystem) {
    ABI33_0_0UMLogError(@"No FileSystem module.");
    return nil;
  }
...
ABI33_0_0UM_EXPORT_METHOD_AS(exec,
...
ABI33_0_0UM_EXPORT_METHOD_AS(close,
                 ...
                 withDb:(sqlite3*)db withReadOnly:(BOOL)readOnly
{
  ...
  if (sqlite3_prepare_v2(db, [sql UTF8String], -1, &statement, NULL) != SQLITE_OK) {
    error = [ABI33_0_0EXSQLite convertSQLiteErrorToString:db];
    return @[error];
  }
