...
#import <ABI33_0_0EXLocalAuthentication/ABI33_0_0EXLocalAuthentication.h>

typedef NS_ENUM(NSInteger, ABI33_0_0EXAuthenticationType) {
  ABI33_0_0EXAuthenticationTypeFingerprint = 1,
  ABI33_0_0EXAuthenticationTypeFacialRecognition = 2,
};

@implementation ABI33_0_0EXLocalAuthentication

ABI33_0_0UM_EXPORT_MODULE(ExpoLocalAuthentication)

ABI33_0_0UM_EXPORT_METHOD_AS(supportedAuthenticationTypesAsync,
                    supportedAuthenticationTypesAsync:(ABI33_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  NSMutableArray *results = [NSMutableArray array];
  if ([[self class] isTouchIdDevice]) {
    [results addObject:@(ABI33_0_0EXAuthenticationTypeFingerprint)];
  }
  if ([[self class] isFaceIdDevice]) {
    [results addObject:@(ABI33_0_0EXAuthenticationTypeFacialRecognition)];
  }
  resolve(results);
}

ABI33_0_0UM_EXPORT_METHOD_AS(hasHardwareAsync,
                    hasHardwareAsync:(ABI33_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
...
ABI33_0_0UM_EXPORT_METHOD_AS(isEnrolledAsync,
                    isEnrolledAsync:(ABI33_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
          ...
          localizedReason:reason
                    reply:^(BOOL success, NSError *error) {
                      resolve(@{
                                ...
                                @"warning": ABI33_0_0UMNullIfNil(warningMessage),
                                });
                    }];
}
