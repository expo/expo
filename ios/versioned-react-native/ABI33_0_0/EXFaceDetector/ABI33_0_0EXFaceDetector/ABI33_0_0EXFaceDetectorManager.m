...
@interface ABI33_0_0EXFaceDetectorManager() <GMVDataOutputDelegate>
...
- (void)setIsEnabled:(BOOL)newFaceDetecting
{
  ...
  if ([self isDetectingFaces] != newFaceDetecting) {
    ...
    __weak ABI33_0_0EXFaceDetectorManager *weakSelf = self;
    [self _runBlockIfQueueIsPresent:^{
      __strong ABI33_0_0EXFaceDetectorManager *strongSelf = weakSelf;
      if (strongSelf) {
...
- (void)dataOutput:(GMVDataOutput *)dataOutput didFinishedDetection:(NSArray<__kindof GMVFeature *> *)results
{
  ...
  // width or height started happen after refactor: moving face detection logic from ABI33_0_0EXCameraManager to ABI33_0_0EXFaceDetectorManager.
  ...
  CGAffineTransform transform = [ABI33_0_0EXFaceDetectorUtils transformFromDeviceOutput:dataOutput toInterfaceVideoOrientation:interfaceVideoOrientation];
  
  ABI33_0_0EXFaceEncoder *faceEncoder = [[ABI33_0_0EXFaceEncoder alloc] initWithTransform:transform];
