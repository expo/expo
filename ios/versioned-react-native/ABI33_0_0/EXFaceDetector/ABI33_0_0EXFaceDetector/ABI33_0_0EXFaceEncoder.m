...
@interface ABI33_0_0EXFaceEncoder()

@property (assign, nonatomic) BOOL swapWidthAndHeight;
@property CGAffineTransform transform;
@property ABI33_0_0EXFaceDetectionAngleTransformBlock angleTransformer;

@end

@implementation ABI33_0_0EXFaceEncoder
...
{
  ABI33_0_0EXFaceDetectionAngleTransformBlock transformer = ^(float angle) {return angle;};
  return [self initWithTransform:pointTransformer withRotationTransform:transformer];
}

- (instancetype)initWithRotationTransform:(ABI33_0_0EXFaceDetectionAngleTransformBlock)rotationTransform
{
