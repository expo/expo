...
typedef NS_ENUM(NSInteger, ABI33_0_0EXTranslationEnum) {
  ABI33_0_0EXTranslateYNegativeWidth,
  ABI33_0_0EXTranslateXNegativeHeight,
  ABI33_0_0EXTranslateXYNegative,
  ABI33_0_0EXTranslateYXNegative
};

@interface ABI33_0_0EXFaceDetectorPointTransformCalculator()
...
@implementation ABI33_0_0EXFaceDetectorPointTransformCalculator
...
- (CGPoint)translation
{
  ...
  AVCaptureVideoOrientation firstOrientation = MIN(_fromOrientation, _toOrientation);
  AVCaptureVideoOrientation secondOrientation = MAX(_fromOrientation, _toOrientation);
  ABI33_0_0EXTranslationEnum enumValue = [[[self class] getTranslationDictionary][@(firstOrientation)][@(secondOrientation)] intValue];
...
- (CGPoint)translationForEnum:(ABI33_0_0EXTranslationEnum)enumValue
{
  switch (enumValue) {
    case ABI33_0_0EXTranslateXNegativeHeight:
      return CGPointMake(-_videoHeight, 0);
    case ABI33_0_0EXTranslateYNegativeWidth:
      return CGPointMake(0, -_videoWidth);
    case ABI33_0_0EXTranslateXYNegative:
      return CGPointMake(-_videoWidth, -_videoHeight);
    case ABI33_0_0EXTranslateYXNegative:
...
+ (void)initTranslationDictionary
{
  translationDictionary = @{
                            @(AVCaptureVideoOrientationPortrait): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI33_0_0EXTranslateYNegativeWidth),
                                @(AVCaptureVideoOrientationLandscapeRight) : @(ABI33_0_0EXTranslateXNegativeHeight),
                                @(AVCaptureVideoOrientationPortraitUpsideDown) : @(ABI33_0_0EXTranslateYXNegative)
                                },
                            @(AVCaptureVideoOrientationPortraitUpsideDown): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI33_0_0EXTranslateXNegativeHeight),
                                @(AVCaptureVideoOrientationLandscapeRight) : @(ABI33_0_0EXTranslateYNegativeWidth)
                                },
                            @(AVCaptureVideoOrientationLandscapeRight): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI33_0_0EXTranslateXYNegative)
                                }
                            };
}
