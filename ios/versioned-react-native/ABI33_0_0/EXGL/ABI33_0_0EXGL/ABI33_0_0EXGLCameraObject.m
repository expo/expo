...
@interface ABI33_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) id<ABI33_0_0UMCameraInterface> camera;
...
@implementation ABI33_0_0EXGLCameraObject
