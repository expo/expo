...
@implementation ABI33_0_0EXGLView
...
- (instancetype)initWithModuleRegistry:(ABI33_0_0UMModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    self.contentScaleFactor = [ABI33_0_0UMUtilities screenScale];
    ...
    _glContext = [[ABI33_0_0EXGLContext alloc] initWithDelegate:self andModuleRegistry:moduleRegistry];
...
- (void)setOnSurfaceCreate:(ABI33_0_0UMDirectEventBlock)onSurfaceCreate
{
...
- (void)draw
{
  ...
  // called on the JS thread to create the ABI33_0_0EXGL context and save its id (see ABI33_0_0EXGLContext.initializeContextWithBridge method).
...
#pragma mark - ABI33_0_0EXGLContextDelegate
