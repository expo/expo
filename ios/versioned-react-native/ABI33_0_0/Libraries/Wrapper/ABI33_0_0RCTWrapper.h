...
#import <ABI33_0_0RCTWrapper/ABI33_0_0RCTWrapperViewManager.h>

// Umbrella header with macros

// ABI33_0_0RCT_WRAPPER_FOR_VIEW
#define ABI33_0_0RCT_WRAPPER_FOR_VIEW(ClassName)                                        \
                                                                               \
NS_ASSUME_NONNULL_BEGIN                                                        \
                                                                               \
@interface ClassName##Manager : ABI33_0_0RCTWrapperViewManager                          \
                                                                               \
@end                                                                           \
                                                                               \
...
// ABI33_0_0RCT_WRAPPER_FOR_VIEW_CONTROLLER
#define ABI33_0_0RCT_WRAPPER_FOR_VIEW_CONTROLLER(ClassName)                             \
                                                                               \
NS_ASSUME_NONNULL_BEGIN                                                        \
                                                                               \
@interface ClassName##Manager : ABI33_0_0RCTWrapperViewManager                          \
