...
#import "ABI33_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI33_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI33_0_0ViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI33_0_0ViewController detachChildViewController:self.contentViewController];
}
