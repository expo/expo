...
@implementation ABI33_0_0RCTTextShadowView
{
...
- (instancetype)initWithBridge:(ABI33_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI33_0_0YGNodeSetMeasureFunc(self.ABI33_0_0yogaNode, ABI33_0_0RCTTextShadowViewMeasure);
    ABI33_0_0YGNodeSetBaselineFunc(self.ABI33_0_0yogaNode, ABI33_0_0RCTTextShadowViewBaseline);
  }
...
- (void)uiManagerWillPerformMounting
{
  ...
  [textStorage enumerateAttribute:ABI33_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                          inRange:NSMakeRange(0, textStorage.length)
                          options:0
                       usingBlock:
   ^(ABI33_0_0RCTShadowView *shadowView, NSRange range, __unused BOOL *stop) {
     if (!shadowView) {
       return;
     }

     [descendantViewTags addObject:shadowView.ReactABI33_0_0Tag];
   }
  ];

  [_bridge.uiManager addUIBlock:^(ABI33_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI33_0_0RCTTextView *textView = (ABI33_0_0RCTTextView *)viewRegistry[tag];
    if (!textView) {
      return;
    }
    ...
    [textStorage removeAttribute:ABI33_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName range:NSMakeRange(0, textStorage.length)];
...
- (NSAttributedString *)attributedTextWithMeasuredAttachmentsThatFitSize:(CGSize)size
{
  ...
  [attributedText enumerateAttribute:ABI33_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                               inRange:NSMakeRange(0, attributedText.length)
                               options:0
                            usingBlock:
    ^(ABI33_0_0RCTShadowView *shadowView, NSRange range, __unused BOOL *stop) {
                                        ...
                                        exclusiveOwnership:(BOOL)exclusiveOwnership
{
  ...
  if (_adjustsFontSizeToFit) {
    ...
    [textStorage abi33_0_0_rct_scaleFontSizeToFitSize:size
...
- (void)layoutSubviewsWithContext:(ABI33_0_0RCTLayoutContext)layoutContext
{
  ...
  [textStorage enumerateAttribute:ABI33_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                          ...
                          options:0
                       usingBlock:
    ^(ABI33_0_0RCTShadowView *shadowView, NSRange range, BOOL *stop) {
      if (!shadowView) {
        return;
      }
      ...
      CGRect frame = {{
        ABI33_0_0RCTRoundPixelValue(glyphRect.origin.x),
        ABI33_0_0RCTRoundPixelValue(glyphRect.origin.y + glyphRect.size.height - attachmentSize.height + font.descender)
      }, {
        ABI33_0_0RCTRoundPixelValue(attachmentSize.width),
        ABI33_0_0RCTRoundPixelValue(attachmentSize.height)
      }};
      
      NSRange truncatedGlyphRange = [layoutManager truncatedGlyphRangeInLineFragmentForGlyphAtIndex:range.location];
      BOOL viewIsTruncated = NSIntersectionRange(range, truncatedGlyphRange).length != 0;

      ABI33_0_0RCTLayoutContext localLayoutContext = layoutContext;
      ...
      ABI33_0_0RCTLayoutMetrics localLayoutMetrics = shadowView.layoutMetrics;
      localLayoutMetrics.frame.origin = frame.origin; // Reinforcing a proper frame origin for the Shadow View.
      if (viewIsTruncated) {
        localLayoutMetrics.displayType = ABI33_0_0RCTDisplayTypeNone;
      }
...
static ABI33_0_0YGSize ABI33_0_0RCTTextShadowViewMeasure(ABI33_0_0YGNodeRef node, float width, ABI33_0_0YGMeasureMode widthMode, float height, ABI33_0_0YGMeasureMode heightMode)
{
  CGSize maximumSize = (CGSize){
    widthMode == ABI33_0_0YGMeasureModeUndefined ? CGFLOAT_MAX : ABI33_0_0RCTCoreGraphicsFloatFromYogaFloat(width),
    heightMode == ABI33_0_0YGMeasureModeUndefined ? CGFLOAT_MAX : ABI33_0_0RCTCoreGraphicsFloatFromYogaFloat(height),
  };

  ABI33_0_0RCTTextShadowView *shadowTextView = (__bridge ABI33_0_0RCTTextShadowView *)ABI33_0_0YGNodeGetContext(node);
  ...
  size = (CGSize){
    MIN(ABI33_0_0RCTCeilPixelValue(size.width), maximumSize.width),
    MIN(ABI33_0_0RCTCeilPixelValue(size.height), maximumSize.height)
  };
  ...
  return (ABI33_0_0YGSize){
    ABI33_0_0RCTYogaFloatFromCoreGraphicsFloat(size.width + epsilon),
    ABI33_0_0RCTYogaFloatFromCoreGraphicsFloat(size.height + epsilon)
  };
}

static float ABI33_0_0RCTTextShadowViewBaseline(ABI33_0_0YGNodeRef node, const float width, const float height)
{
  ABI33_0_0RCTTextShadowView *shadowTextView = (__bridge ABI33_0_0RCTTextShadowView *)ABI33_0_0YGNodeGetContext(node);
