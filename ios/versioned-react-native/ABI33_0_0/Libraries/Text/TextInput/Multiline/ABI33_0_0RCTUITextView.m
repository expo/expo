...
@implementation ABI33_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI33_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI33_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
  }
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  // see: https://github.com/facebook/ReactABI33_0_0-native/issues/19339
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI33_0_0RCTCeilPixelValue(placeholderSize.width), ABI33_0_0RCTCeilPixelValue(placeholderSize.height));
