...
#pragma mark - ABI33_0_0RCTBackedTextFieldDelegateAdapter (for UITextField)

static void *TextFieldSelectionObservingContext = &TextFieldSelectionObservingContext;

@interface ABI33_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI33_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI33_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}

- (instancetype)initWithTextField:(UITextField<ABI33_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  if (self = [super init]) {
...
#pragma mark - ABI33_0_0RCTBackedTextViewDelegateAdapter (for UITextView)

@interface ABI33_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI33_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI33_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}

- (instancetype)initWithTextView:(UITextView<ABI33_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  if (self = [super init]) {
    _backedTextInputView = backedTextInputView;
    backedTextInputView.delegate = self;
