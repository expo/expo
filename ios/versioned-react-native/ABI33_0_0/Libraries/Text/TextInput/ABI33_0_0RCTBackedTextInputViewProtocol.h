...
@protocol ABI33_0_0RCTBackedTextInputDelegate;

NS_ASSUME_NONNULL_BEGIN

@protocol ABI33_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI33_0_0RCTBackedTextInputDelegate> textInputDelegate;
