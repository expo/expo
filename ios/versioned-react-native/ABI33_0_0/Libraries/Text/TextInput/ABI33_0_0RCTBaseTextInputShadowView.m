...
#import "ABI33_0_0NSTextStorage+FontScaling.h"
#import "ABI33_0_0RCTBaseTextInputView.h"

@implementation ABI33_0_0RCTBaseTextInputShadowView
{
...
- (instancetype)initWithBridge:(ABI33_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI33_0_0YGNodeSetMeasureFunc(self.ABI33_0_0yogaNode, ABI33_0_0RCTBaseTextInputShadowViewMeasure);
    ABI33_0_0YGNodeSetBaselineFunc(self.ABI33_0_0yogaNode, ABI33_0_0RCTTextInputShadowViewBaseline);
  }
...
{
  if (ABI33_0_0YGNodeIsDirty(self.ABI33_0_0yogaNode)) {
    return;
  }
  ...
  ABI33_0_0RCTTextAttributes *textAttributes = [self.textAttributes copy];
  ...
  [attributedText removeAttribute:ABI33_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                            range:NSMakeRange(0, attributedText.length)];

  [attributedText removeAttribute:ABI33_0_0RCTTextAttributesTagAttributeName
                            range:NSMakeRange(0, attributedText.length)];
  ...
  NSNumber *tag = self.ReactABI33_0_0Tag;

  [_bridge.uiManager addUIBlock:^(ABI33_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI33_0_0RCTBaseTextInputView *baseTextInputView = (ABI33_0_0RCTBaseTextInputView *)viewRegistry[tag];
    if (!baseTextInputView) {
      return;
    }

    baseTextInputView.textAttributes = textAttributes;
    baseTextInputView.ReactABI33_0_0BorderInsets = borderInsets;
    baseTextInputView.ReactABI33_0_0PaddingInsets = paddingInsets;
...
- (CGSize)sizeThatFitsMinimumSize:(CGSize)minimumSize maximumSize:(CGSize)maximumSize
{
  ...
  return (CGSize){
    MAX(minimumSize.width, MIN(ABI33_0_0RCTCeilPixelValue(size.width), maximumSize.width)),
    MAX(minimumSize.height, MIN(ABI33_0_0RCTCeilPixelValue(size.height), maximumSize.height))
  };
}
...
static ABI33_0_0YGSize ABI33_0_0RCTBaseTextInputShadowViewMeasure(ABI33_0_0YGNodeRef node, float width, ABI33_0_0YGMeasureMode widthMode, float height, ABI33_0_0YGMeasureMode heightMode)
{
  ...
  CGSize size = {
    ABI33_0_0RCTCoreGraphicsFloatFromYogaFloat(width),
    ABI33_0_0RCTCoreGraphicsFloatFromYogaFloat(height)
  };
  ...
  return (ABI33_0_0YGSize){
    ABI33_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.width),
    ABI33_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.height)
  };
}

static float ABI33_0_0RCTTextInputShadowViewBaseline(ABI33_0_0YGNodeRef node, const float width, const float height)
{
  ABI33_0_0RCTBaseTextInputShadowView *shadowTextView = (__bridge ABI33_0_0RCTBaseTextInputShadowView *)ABI33_0_0YGNodeGetContext(node);
  ...
  return ABI33_0_0RCTYogaFloatFromCoreGraphicsFloat(lastBaseline);
}
