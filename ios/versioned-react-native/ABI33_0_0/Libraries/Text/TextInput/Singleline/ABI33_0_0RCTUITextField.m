...
#import "ABI33_0_0RCTBackedTextInputDelegateAdapter.h"

@implementation ABI33_0_0RCTUITextField {
  ABI33_0_0RCTBackedTextFieldDelegateAdapter *_textInputDelegateAdapter;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI33_0_0RCTBackedTextFieldDelegateAdapter alloc] initWithTextField:self];
  }
...
- (CGSize)intrinsicContentSize
{
  ...
  size = CGSizeMake(ABI33_0_0RCTCeilPixelValue(size.width), ABI33_0_0RCTCeilPixelValue(size.height));
