...
@implementation ABI33_0_0RCTBaseTextInputView {
...
- (UIView<ABI33_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  ABI33_0_0RCTAssert(NO, @"-[ABI33_0_0RCTBaseTextInputView backedTextInputView] must be implemented in subclass.");
  return nil;
}

#pragma mark - ABI33_0_0RCTComponent
...
- (void)setTextAttributes:(ABI33_0_0RCTTextAttributes *)textAttributes
{
...
{
  id<ABI33_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
...
- (void)setReactABI33_0_0PaddingInsets:(UIEdgeInsets)ReactABI33_0_0PaddingInsets
{
  _ReactABI33_0_0PaddingInsets = ReactABI33_0_0PaddingInsets;
  // We apply `paddingInsets` as `backedTextInputView`'s `textContainerInset`.
  self.backedTextInputView.textContainerInset = ReactABI33_0_0PaddingInsets;
  [self setNeedsLayout];
}

- (void)setReactABI33_0_0BorderInsets:(UIEdgeInsets)ReactABI33_0_0BorderInsets
{
  _ReactABI33_0_0BorderInsets = ReactABI33_0_0BorderInsets;
  // We apply `borderInsets` as `backedTextInputView` layout offset.
  self.backedTextInputView.frame = UIEdgeInsetsInsetRect(self.bounds, ReactABI33_0_0BorderInsets);
  [self setNeedsLayout];
}
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  [backedTextInputViewTextCopy removeAttribute:ABI33_0_0RCTTextAttributesTagAttributeName
                                         range:NSMakeRange(0, backedTextInputViewTextCopy.length)];

  [attributedTextCopy removeAttribute:ABI33_0_0RCTTextAttributesTagAttributeName
  ...
  } else if (eventLag > ABI33_0_0RCTTextUpdateLagWarningThreshold) {
    ABI33_0_0RCTLogWarn(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", self.backedTextInputView.attributedText.string, (long long)eventLag);
  }
}

- (ABI33_0_0RCTTextSelection *)selection
{
  id<ABI33_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
  UITextRange *selectedTextRange = backedTextInputView.selectedTextRange;
  return [[ABI33_0_0RCTTextSelection new] initWithStart:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.start]
                                           end:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.end]];
}

- (void)setSelection:(ABI33_0_0RCTTextSelection *)selection
{
  if (!selection) {
    return;
  }
  ...
  if (eventLag == 0 && ![previousSelectedTextRange isEqual:selectedTextRange]) {
    ...
    ABI33_0_0RCTLogWarn(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", backedTextInputView.attributedText.string, (long long)eventLag);
  }
}
...
{
  UIView<ABI33_0_0RCTBackedTextInputViewProtocol> *textInputView = self.backedTextInputView;
...
#pragma mark - ABI33_0_0RCTBackedTextInputDelegate
...
- (void)textInputDidBeginEditing
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI33_0_0RCTTextEventTypeFocus
...
{
  [_eventDispatcher sendTextEventWithType:ABI33_0_0RCTTextEventTypeEnd
                                 ReactABI33_0_0Tag:self.ReactABI33_0_0Tag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];

  [_eventDispatcher sendTextEventWithType:ABI33_0_0RCTTextEventTypeBlur
                                 ReactABI33_0_0Tag:self.ReactABI33_0_0Tag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldReturn
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI33_0_0RCTTextEventTypeSubmit
                                 ReactABI33_0_0Tag:self.ReactABI33_0_0Tag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text
{
  ...
  if (!backedTextInputView.textWasPasted) {
    [_eventDispatcher sendTextEventWithType:ABI33_0_0RCTTextEventTypeKeyPress
                                   ReactABI33_0_0Tag:self.ReactABI33_0_0Tag
                                       text:nil
                                        key:text
                                 eventCount:_nativeEventCount];
...
- (void)textInputDidChangeSelection
{
  ...
  ABI33_0_0RCTTextSelection *selection = self.selection;
...
- (CGSize)intrinsicContentSize
{
  ...
  size.width += _ReactABI33_0_0BorderInsets.left + _ReactABI33_0_0BorderInsets.right;
  size.height += _ReactABI33_0_0BorderInsets.top + _ReactABI33_0_0BorderInsets.bottom;
...
{
  CGFloat compoundHorizontalBorderInset = _ReactABI33_0_0BorderInsets.left + _ReactABI33_0_0BorderInsets.right;
  CGFloat compoundVerticalBorderInset = _ReactABI33_0_0BorderInsets.top + _ReactABI33_0_0BorderInsets.bottom;
...
{
  [self.backedTextInputView ReactABI33_0_0Focus];
}

- (void)ReactABI33_0_0Blur
{
  [self.backedTextInputView ReactABI33_0_0Blur];
}

- (void)didMoveToWindow
{
  [self.backedTextInputView ReactABI33_0_0FocusIfNeeded];
}
...
{
  #if !TARGET_OS_TV
  __weak ABI33_0_0RCTBaseTextInputView *weakSelf = self;
  [_bridge.uiManager rootViewForReactABI33_0_0Tag:self.ReactABI33_0_0Tag withCompletion:^(UIView *rootView) {
    ABI33_0_0RCTBaseTextInputView *strongSelf = weakSelf;
    if (rootView) {
      UIView *accessoryView = [strongSelf->_bridge.uiManager viewForNativeID:nativeID
                                                                 withRootTag:rootView.ReactABI33_0_0Tag];
      if (accessoryView && [accessoryView isKindOfClass:[ABI33_0_0RCTInputAccessoryView class]]) {
        strongSelf.backedTextInputView.inputAccessoryView = ((ABI33_0_0RCTInputAccessoryView *)accessoryView).inputAccessoryView;
