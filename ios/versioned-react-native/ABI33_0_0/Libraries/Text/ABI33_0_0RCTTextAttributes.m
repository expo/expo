...
NSString *const ABI33_0_0RCTTextAttributesIsHighlightedAttributeName = @"ABI33_0_0RCTTextAttributesIsHighlightedAttributeName";
NSString *const ABI33_0_0RCTTextAttributesTagAttributeName = @"ABI33_0_0RCTTextAttributesTagAttributeName";

@implementation ABI33_0_0RCTTextAttributes
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _opacity = NAN;
    _textTransform = ABI33_0_0RCTTextTransformUndefined;
  }

  return self;
}

- (void)applyTextAttributes:(ABI33_0_0RCTTextAttributes *)textAttributes
{
  ...
  _textDecorationLine = textAttributes->_textDecorationLine != ABI33_0_0RCTTextDecorationLineTypeNone ? textAttributes->_textDecorationLine : _textDecorationLine; // *
  ...
  _textTransform = textAttributes->_textTransform != ABI33_0_0RCTTextTransformUndefined ? textAttributes->_textTransform : _textTransform;
}
...
- (NSDictionary<NSAttributedStringKey, id> *)effectiveTextAttributes
{
  ...
  if (_textDecorationLine == ABI33_0_0RCTTextDecorationLineTypeUnderline ||
      _textDecorationLine == ABI33_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    isTextDecorationEnabled = YES;
    attributes[NSUnderlineStyleAttributeName] = @(_textDecorationStyle);
  }

  if (_textDecorationLine == ABI33_0_0RCTTextDecorationLineTypeStrikethrough ||
      _textDecorationLine == ABI33_0_0RCTTextDecorationLineTypeUnderlineStrikethrough){
    isTextDecorationEnabled = YES;
  ...
  // Special
  if (_isHighlighted) {
    attributes[ABI33_0_0RCTTextAttributesIsHighlightedAttributeName] = @YES;
  }

  if (_tag) {
    attributes[ABI33_0_0RCTTextAttributesTagAttributeName] = _tag;
  }
...
{
  // FIXME: ABI33_0_0RCTFont has thread-safety issues and must be rewritten.
  return [ABI33_0_0RCTFont updateFont:nil
...
{
  bool fontScalingEnabled = !ABI33_0_0RCTHasFontHandlerSet() && _allowFontScaling;
...
- (NSString *)applyTextAttributesToText:(NSString *)text
{
  switch (_textTransform) {
    case ABI33_0_0RCTTextTransformUndefined:
    case ABI33_0_0RCTTextTransformNone:
      return text;
    case ABI33_0_0RCTTextTransformLowercase:
      return [text lowercaseString];
    case ABI33_0_0RCTTextTransformUppercase:
      return [text uppercaseString];
    case ABI33_0_0RCTTextTransformCapitalize:
      return [text capitalizedString];
  }
}

- (ABI33_0_0RCTTextAttributes *)copyWithZone:(NSZone *)zone
{
  ABI33_0_0RCTTextAttributes *textAttributes = [ABI33_0_0RCTTextAttributes new];
...
- (BOOL)isEqual:(ABI33_0_0RCTTextAttributes *)textAttributes
{
  if (self == textAttributes) {
    return YES;
  }

#define ABI33_0_0RCTTextAttributesCompareFloats(a) ((a == textAttributes->a) || (isnan(a) && isnan(textAttributes->a)))
#define ABI33_0_0RCTTextAttributesCompareSize(a) CGSizeEqualToSize(a, textAttributes->a)
#define ABI33_0_0RCTTextAttributesCompareObjects(a) ((a == textAttributes->a) || [a isEqual:textAttributes->a])
#define ABI33_0_0RCTTextAttributesCompareStrings(a) ((a == textAttributes->a) || [a isEqualToString:textAttributes->a])
#define ABI33_0_0RCTTextAttributesCompareOthers(a) (a == textAttributes->a)

  return
    ABI33_0_0RCTTextAttributesCompareObjects(_foregroundColor) &&
    ABI33_0_0RCTTextAttributesCompareObjects(_backgroundColor) &&
    ABI33_0_0RCTTextAttributesCompareFloats(_opacity) &&
    // Font
    ABI33_0_0RCTTextAttributesCompareObjects(_fontFamily) &&
    ABI33_0_0RCTTextAttributesCompareFloats(_fontSize) &&
    ABI33_0_0RCTTextAttributesCompareFloats(_fontSizeMultiplier) &&
    ABI33_0_0RCTTextAttributesCompareFloats(_maxFontSizeMultiplier) &&
    ABI33_0_0RCTTextAttributesCompareStrings(_fontWeight) &&
    ABI33_0_0RCTTextAttributesCompareObjects(_fontStyle) &&
    ABI33_0_0RCTTextAttributesCompareObjects(_fontVariant) &&
    ABI33_0_0RCTTextAttributesCompareOthers(_allowFontScaling) &&
    ABI33_0_0RCTTextAttributesCompareFloats(_letterSpacing) &&
    // Paragraph Styles
    ABI33_0_0RCTTextAttributesCompareFloats(_lineHeight) &&
    ABI33_0_0RCTTextAttributesCompareFloats(_alignment) &&
    ABI33_0_0RCTTextAttributesCompareOthers(_baseWritingDirection) &&
    // Decoration
    ABI33_0_0RCTTextAttributesCompareObjects(_textDecorationColor) &&
    ABI33_0_0RCTTextAttributesCompareOthers(_textDecorationStyle) &&
    ABI33_0_0RCTTextAttributesCompareOthers(_textDecorationLine) &&
    // Shadow
    ABI33_0_0RCTTextAttributesCompareSize(_textShadowOffset) &&
    ABI33_0_0RCTTextAttributesCompareFloats(_textShadowRadius) &&
    ABI33_0_0RCTTextAttributesCompareObjects(_textShadowColor) &&
    // Special
    ABI33_0_0RCTTextAttributesCompareOthers(_isHighlighted) &&
    ABI33_0_0RCTTextAttributesCompareObjects(_tag) &&
    ABI33_0_0RCTTextAttributesCompareOthers(_layoutDirection) &&
    ABI33_0_0RCTTextAttributesCompareOthers(_textTransform);
}
