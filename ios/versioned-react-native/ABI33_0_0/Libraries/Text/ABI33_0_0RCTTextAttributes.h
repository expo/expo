...
extern NSString *const ABI33_0_0RCTTextAttributesIsHighlightedAttributeName;
extern NSString *const ABI33_0_0RCTTextAttributesTagAttributeName;
 ...
 * and <TextInput>.
 */
@interface ABI33_0_0RCTTextAttributes : NSObject <NSCopying>
...
@property (nonatomic, assign) ABI33_0_0RCTTextDecorationLineType textDecorationLine;
// Shadow
...
@property (nonatomic, assign) ABI33_0_0RCTTextTransform textTransform;
