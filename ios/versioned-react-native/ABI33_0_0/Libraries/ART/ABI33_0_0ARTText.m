...
@implementation ABI33_0_0ARTText
...
static void ABI33_0_0ARTFreeTextFrame(ABI33_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI33_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI33_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI33_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI33_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
