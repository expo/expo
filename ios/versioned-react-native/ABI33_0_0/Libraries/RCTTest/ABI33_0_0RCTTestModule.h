...
typedef NS_ENUM(NSInteger, ABI33_0_0RCTTestStatus) {
  ABI33_0_0RCTTestStatusPending = 0,
  ABI33_0_0RCTTestStatusPassed,
  ABI33_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI33_0_0RCTTestModule : NSObject <ABI33_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI33_0_0RCTTestStatus status;
