...
#define ABI33_0_0RCT_RUN_RUNLOOP_WHILE(CONDITION)                                                          \
{                                                                                                 \
...
/**
 * Use the ABI33_0_0RCTInitRunnerForApp macro for typical usage. See FBSnapshotTestCase.h for more information
 * on how to configure the snapshotting system.
 */
#define ABI33_0_0RCTInitRunnerForApp(app__, moduleProvider__, scriptURL__) \
[[ABI33_0_0RCTTestRunner alloc] initWithApp:(app__) \
                referenceDirectory:@FB_REFERENCE_IMAGE_DIR \
                    moduleProvider:(moduleProvider__) \
                         scriptURL: scriptURL__]

#define ABI33_0_0RCTInitRunnerForAppWithDelegate(app__, bridgeDelegate__) \
[[ABI33_0_0RCTTestRunner alloc] initWithApp:(app__) \
                referenceDirectory:@FB_REFERENCE_IMAGE_DIR \
...
@class ABI33_0_0RCTRootView;

@interface ABI33_0_0RCTTestRunner : NSObject
...
/**
 * Initialize a runner.  It's recommended that you use the ABI33_0_0RCTInitRunnerForApp
...
- (instancetype)initWithApp:(NSString *)app
         referenceDirectory:(NSString *)referenceDirectory
             ...
             bridgeDelegate:(id<ABI33_0_0RCTBridgeDelegate>)bridgeDelegate NS_DESIGNATED_INITIALIZER;
 ...
 *
 *   ABI33_0_0RCTTestModule.markTestCompleted()
 *
 * JS errors/exceptions and timeouts will fail the test.  Snapshot tests call
 * ABI33_0_0RCTTestModule.verifySnapshot whenever they want to verify what has been
