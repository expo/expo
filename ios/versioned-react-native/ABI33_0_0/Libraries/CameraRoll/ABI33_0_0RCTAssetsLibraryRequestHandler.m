...
@implementation ABI33_0_0RCTAssetsLibraryRequestHandler
     ...
     withDelegate:(id<ABI33_0_0RCTURLRequestDelegate>)delegate
{
  ...
  if (!request.URL) {
    ...
    [delegate URLRequest:cancellationBlock didCompleteWithError:ABI33_0_0RCTErrorWithMessage(msg)];
  ...
  if (![fetchResult firstObject]) {
    ...
    NSError *error = ABI33_0_0RCTErrorWithMessage(errorMessage);
