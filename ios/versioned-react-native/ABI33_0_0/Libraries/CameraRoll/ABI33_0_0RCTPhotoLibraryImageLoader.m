...
#import "ABI33_0_0RCTPhotoLibraryImageLoader.h"

#import <Photos/Photos.h>

#import <ReactABI33_0_0/ABI33_0_0RCTUtils.h>

@implementation ABI33_0_0RCTPhotoLibraryImageLoader

ABI33_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI33_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI33_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (!imageURL) {
    completionHandler(ABI33_0_0RCTErrorWithMessage(@"Cannot load a photo library asset with no URL"), nil);
    return ^{};
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI33_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI33_0_0RCTResizeModeContain) {
