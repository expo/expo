...
#import "ABI33_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI33_0_0/ABI33_0_0RCTConvert.h>
#import <ReactABI33_0_0/ABI33_0_0RCTImageStoreManager.h>
#import <ReactABI33_0_0/ABI33_0_0RCTRootView.h>
#import <ReactABI33_0_0/ABI33_0_0RCTUtils.h>

@interface ABI33_0_0RCTImagePickerController : UIImagePickerController

@property (nonatomic, assign) BOOL unmirrorFrontFacingCamera;

@end

@implementation ABI33_0_0RCTImagePickerController

@end

@interface ABI33_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI33_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI33_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI33_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI33_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI33_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI33_0_0RCTResponseSenderBlock)callback)
{
...
ABI33_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI33_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI33_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI33_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI33_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  ABI33_0_0RCTImagePickerController *imagePicker = [ABI33_0_0RCTImagePickerController new];
  imagePicker.delegate = self;
  imagePicker.sourceType = UIImagePickerControllerSourceTypeCamera;
  imagePicker.unmirrorFrontFacingCamera = [ABI33_0_0RCTConvert BOOL:config[@"unmirrorFrontFacingCamera"]];

  if ([ABI33_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI33_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI33_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI33_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI33_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI33_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI33_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI33_0_0RCTNullIfNil(height), ABI33_0_0RCTNullIfNil(width)]];
    return;
  }
  ...
  [_bridge.imageStoreManager storeImage:originalImage withBlock:^(NSString *tempImageTag) {
    [self _dismissPicker:picker args:tempImageTag ? @[tempImageTag, ABI33_0_0RCTNullIfNil(height), ABI33_0_0RCTNullIfNil(width)] : nil];
  }];
}
        ...
        cancelCallback:(ABI33_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI33_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI33_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI33_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
...
- (void)cameraChanged:(NSNotification *)notification
{
  for (UIImagePickerController *picker in _pickers) {
    if ([picker isKindOfClass:[ABI33_0_0RCTImagePickerController class]]
      && ((ABI33_0_0RCTImagePickerController *)picker).unmirrorFrontFacingCamera
