...
@implementation ABI33_0_0RCTSurfaceHostingComponentState
...
- (instancetype)initWithStage:(ABI33_0_0RCTSurfaceStage)stage
                intrinsicSize:(CGSize)intrinsicSize
{
  if (self = [super init]) {
    _stage = stage;
...
- (BOOL)isEqual:(ABI33_0_0RCTSurfaceHostingComponentState *)other
{
  if (other == self) {
    return YES;
  }
