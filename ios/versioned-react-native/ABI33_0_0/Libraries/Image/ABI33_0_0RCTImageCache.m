...
static const NSUInteger ABI33_0_0RCTMaxCachableDecodedImageSizeInBytes = 2097152; // 2 MB

static NSString *ABI33_0_0RCTCacheKeyForImage(NSString *imageTag, CGSize size, CGFloat scale,
...
@implementation ABI33_0_0RCTImageCache
{
                 ...
                 forKey:(NSString *)cacheKey
{
  ...
  NSInteger bytes = image.ReactABI33_0_0DecodedImageBytes;
  if (bytes <= ABI33_0_0RCTMaxCachableDecodedImageSizeInBytes) {
...
{
  NSString *cacheKey = ABI33_0_0RCTCacheKeyForImage(url, size, scale, resizeMode);
  @synchronized(_cacheStaleTimes) {
