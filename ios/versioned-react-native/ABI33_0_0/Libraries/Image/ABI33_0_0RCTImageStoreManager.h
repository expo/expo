...
#import <ReactABI33_0_0/ABI33_0_0RCTURLRequestHandler.h>

@interface ABI33_0_0RCTImageStoreManager : NSObject <ABI33_0_0RCTURLRequestHandler>
...
@interface ABI33_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI33_0_0RCTBridge (ABI33_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI33_0_0RCTImageStoreManager *imageStoreManager;
