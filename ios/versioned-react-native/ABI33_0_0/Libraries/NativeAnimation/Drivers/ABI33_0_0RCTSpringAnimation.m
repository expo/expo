...
@interface ABI33_0_0RCTSpringAnimation ()
...
@implementation ABI33_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
                  ...
                  callBack:(nullable ABI33_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _lastVelocity = [ABI33_0_0RCTConvert CGFloat:config[@"initialVelocity"]];
...
- (void)resetAnimationConfig:(NSDictionary *)config
{
  ...
  _toValue = [ABI33_0_0RCTConvert CGFloat:config[@"toValue"]];
  _overshootClamping = [ABI33_0_0RCTConvert BOOL:config[@"overshootClamping"]];
  _restDisplacementThreshold = [ABI33_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
  _restSpeedThreshold = [ABI33_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
  _stiffness = [ABI33_0_0RCTConvert CGFloat:config[@"stiffness"]];
  _damping = [ABI33_0_0RCTConvert CGFloat:config[@"damping"]];
  _mass = [ABI33_0_0RCTConvert CGFloat:config[@"mass"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  if(_animationStartTime == -1) {
    ...
    _t = _t + deltaTime / ABI33_0_0RCTAnimationDragCoefficient();
  }
