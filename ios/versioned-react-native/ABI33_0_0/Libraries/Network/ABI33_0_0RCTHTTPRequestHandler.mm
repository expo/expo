...
#import "ABI33_0_0RCTHTTPRequestHandler.h"

#import <mutex>

#import "ABI33_0_0RCTNetworking.h"

@interface ABI33_0_0RCTHTTPRequestHandler () <NSURLSessionDataDelegate>

@end

@implementation ABI33_0_0RCTHTTPRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  dispatch_once(&onceToken, ^{
    // technically, ABI33_0_0RCTHTTPRequestHandler can handle file:// as well,
    // but it's less efficient than using ABI33_0_0RCTFileRequestHandler
...
- (NSURLSessionDataTask *)sendRequest:(NSURLRequest *)request
                         withDelegate:(id<ABI33_0_0RCTURLRequestDelegate>)delegate
{
  // Lazy setup
...
{
  id<ABI33_0_0RCTURLRequestDelegate> delegate;
  {
    std::lock_guard<std::mutex> lock(_mutex);
