#import <ABI33_0_0EXAdsFacebook/ABI33_0_0EXBannerView.h>
#import <FBAudienceNetwork/FBAudienceNetwork.h>
#import <ABI33_0_0UMCore/ABI33_0_0UMUtilitiesInterface.h>

@interface ABI33_0_0EXBannerView () <FBAdViewDelegate>
...
@implementation ABI33_0_0EXBannerView
...
- (void)createViewIfCan
{
  ...
  UIViewController *rootViewController = [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI33_0_0UMUtilitiesInterface)] currentViewController];
...
- (void)adView:(FBAdView *)adView didFailWithError:(NSError *)error
{
  if (_onAdError) {
    ...
    ABI33_0_0UMLogError(@"%@: %@", error.localizedDescription, error.userInfo);
  }
}
