...
#import <ABI33_0_0EXAdsFacebook/ABI33_0_0EXFacebookAdHelper.h>
#import <ABI33_0_0EXAdsFacebook/ABI33_0_0EXNativeAdManager.h>
...
@interface ABI33_0_0EXNativeAdManager () <FBNativeAdsManagerDelegate>
...
@implementation ABI33_0_0EXNativeAdManager

ABI33_0_0UM_EXPORT_MODULE(CTKNativeAdManager)
...
ABI33_0_0UM_EXPORT_METHOD_AS(registerViewsForInteraction,
                    ...
                    reject:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  [uiManager executeUIBlock:^(NSDictionary<id,UIView *> * viewRegistry) {
    ...
    if (![nativeAdView isKindOfClass:[ABI33_0_0EXNativeAdView class]]) {
      reject(@"E_INVALID_VIEW_CLASS", @"View returned for passed native ad view tag is not an instance of ABI33_0_0EXNativeAdView", nil);
      return;
    }
    ...
    [(ABI33_0_0EXNativeAdView *)nativeAdView registerViewsForInteraction:(FBMediaView *)mediaView adIcon:(FBAdIconView *)adIconView clickableViews:clickableViews];
    resolve(@[]);
  }];
}

ABI33_0_0UM_EXPORT_METHOD_AS(init,
...
ABI33_0_0UM_EXPORT_METHOD_AS(setMediaCachePolicy,
...
ABI33_0_0UM_EXPORT_METHOD_AS(disableAutoRefresh,
...
- (void)nativeAdsLoaded
{
  ...
  [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI33_0_0UMEventEmitterService)] sendEventWithName:@"CTKNativeAdsManagersChanged" body:adsManagersState];
}
...
- (UIView *)view
{
  return [[ABI33_0_0EXNativeAdView alloc] initWithModuleRegistry:_moduleRegistry];
}

ABI33_0_0UM_VIEW_PROPERTY(adsManager, NSString *, ABI33_0_0EXNativeAdView)
{
