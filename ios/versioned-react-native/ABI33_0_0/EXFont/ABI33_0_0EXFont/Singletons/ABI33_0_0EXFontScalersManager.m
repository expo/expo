...
@implementation UIFont (ABI33_0_0EXFontLoader)

- (UIFont *)ABI33_0_0EXFontWithSize:(CGFloat)fontSize
{
  for (id<ABI33_0_0UMFontScalerInterface> fontScaler in currentFontScalers) {
  ...
  return [self ABI33_0_0EXFontWithSize:fontSize];
}
...
@implementation ABI33_0_0EXFontScalersManager

ABI33_0_0UM_REGISTER_SINGLETON_MODULE(FontScalersManager);
...
+ (void)initialize
{
  ...
  dispatch_once(&initializeCurrentFontScalersOnce, ^{
    ...
    SEL exUpdate = @selector(ABI33_0_0EXFontWithSize:);
...
- (void)registerFontScaler:(id<ABI33_0_0UMFontScalerInterface>)fontScaler
{
