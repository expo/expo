...
#import <ABI33_0_0EXCrypto/ABI33_0_0EXCrypto.h>
#import <CommonCrypto/CommonDigest.h>

@implementation ABI33_0_0EXCrypto

ABI33_0_0UM_EXPORT_MODULE(ExpoCrypto);

ABI33_0_0UM_EXPORT_METHOD_AS(digestStringAsync,
                    ...
                    rejecter:(ABI33_0_0UMPromiseRejectBlock)reject)
{
  ...
  int digestLength = [ABI33_0_0EXCrypto digestLengthForJSAlgorithm:algorithm];
  if (digestLength == -1) {
