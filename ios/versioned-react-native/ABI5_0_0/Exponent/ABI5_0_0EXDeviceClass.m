...
#import "ABI5_0_0EXDeviceClass.h"

#include <sys/types.h>
#include <sys/sysctl.h>

@implementation ABI5_0_0EXDeviceClass

ABI5_0_0RCT_EXPORT_MODULE(ExponentDeviceClassModule);

- (NSDictionary *)constantsToExport
{
  return @{
           @"year": [self _deviceYear],
           @"platformIOS": [self _devicePlatform],
           @"modelIOS": [self _deviceModel],
           };
}
