...
typedef void (^ABI5_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI5_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef void (^ABI5_0_0RCTImageLoaderCancellationBlock)(void);

@interface UIImage (ReactABI5_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI5_0_0KeyframeAnimation;

@end

@interface ABI5_0_0RCTImageLoader : NSObject <ABI5_0_0RCTBridgeModule, ABI5_0_0RCTURLRequestHandler>
...
- (ABI5_0_0RCTImageLoaderCancellationBlock)loadImageWithTag:(NSString *)imageTag
                                      ...
                                      progressBlock:(ABI5_0_0RCTImageLoaderProgressBlock)progressBlock
                                    completionBlock:(ABI5_0_0RCTImageLoaderCompletionBlock)completionBlock;

/**
 * Loads an image without clipping the result to fit - used by ABI5_0_0RCTImageView.
 */
 ...
 */
- (ABI5_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                        resizeMode:(ABI5_0_0RCTResizeMode)resizeMode
                                   completionBlock:(ABI5_0_0RCTImageLoaderCompletionBlock)completionBlock;
...
@interface ABI5_0_0RCTBridge (ABI5_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI5_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI5_0_0RCTImageURLLoader <ABI5_0_0RCTBridgeModule>
 ...
 * applicable.
 */
- (ABI5_0_0RCTImageLoaderCancellationBlock)loadImageForURL:(NSURL *)imageURL
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                        resizeMode:(ABI5_0_0RCTResizeMode)resizeMode
                                   progressHandler:(ABI5_0_0RCTImageLoaderProgressBlock)progressHandler
                                 completionHandler:(ABI5_0_0RCTImageLoaderCompletionBlock)completionHandler;

@optional

/**
 * If more than one ABI5_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 * are also bridge modules, so should be registered using ABI5_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI5_0_0RCTImageDataDecoder <ABI5_0_0RCTBridgeModule>
...
/**
 * If more than one ABI5_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
