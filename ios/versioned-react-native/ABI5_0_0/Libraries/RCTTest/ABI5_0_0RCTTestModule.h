...
typedef NS_ENUM(NSInteger, ABI5_0_0RCTTestStatus) {
  ABI5_0_0RCTTestStatusPending = 0,
  ABI5_0_0RCTTestStatusPassed,
  ABI5_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI5_0_0RCTTestModule : NSObject <ABI5_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI5_0_0RCTTestStatus status;
