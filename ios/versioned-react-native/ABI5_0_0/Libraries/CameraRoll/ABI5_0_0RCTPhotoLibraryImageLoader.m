...
#import "ABI5_0_0RCTPhotoLibraryImageLoader.h"
...
@implementation ABI5_0_0RCTPhotoLibraryImageLoader

ABI5_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI5_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI5_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI5_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI5_0_0RCTResizeModeContain) {
