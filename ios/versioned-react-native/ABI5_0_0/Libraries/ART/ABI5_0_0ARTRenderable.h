...
@interface ABI5_0_0ARTRenderable : ABI5_0_0ARTNode

@property (nonatomic, strong) ABI5_0_0ARTBrush *fill;
...
@property (nonatomic, assign) ABI5_0_0ARTCGFloatArray strokeDash;
