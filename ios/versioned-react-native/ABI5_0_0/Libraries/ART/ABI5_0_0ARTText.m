...
@implementation ABI5_0_0ARTText
...
static void ABI5_0_0ARTFreeTextFrame(ABI5_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI5_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI5_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI5_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI5_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
