...
@implementation ABI5_0_0RCTTextField
{
...
- (instancetype)initWithEventDispatcher:(ABI5_0_0RCTEventDispatcher *)eventDispatcher
{
  if ((self = [super initWithFrame:CGRectZero])) {
    ABI5_0_0RCTAssert(eventDispatcher, @"eventDispatcher is a required parameter");
...
static void ABI5_0_0RCTUpdatePlaceholder(ABI5_0_0RCTTextField *self)
{
...
- (void)setPlaceholderTextColor:(UIColor *)placeholderTextColor
{
  ...
  ABI5_0_0RCTUpdatePlaceholder(self);
}
...
{
  // TODO: do we support subviews of textfield in ReactABI5_0_0?
...
- (void)removeReactABI5_0_0Subview:(UIView *)subview
{
  ...
  // its own views below or between ReactABI5_0_0's, the indices won't match
...
{
  _nativeEventCount++;
  [_eventDispatcher sendTextEventWithType:ABI5_0_0RCTTextEventTypeChange
                                 ReactABI5_0_0Tag:self.ReactABI5_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (void)observeValueForKeyPath:(NSString *)keyPath
                      ofObject:(ABI5_0_0RCTTextField *)textField
