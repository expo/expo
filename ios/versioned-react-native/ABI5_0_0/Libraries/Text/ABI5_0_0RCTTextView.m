...
@interface ABI5_0_0RCTUITextView : UITextView

@property (nonatomic, assign) BOOL textWasPasted;

@end

@implementation ABI5_0_0RCTUITextView
{
...
@implementation ABI5_0_0RCTTextView
{
...
- (instancetype)initWithEventDispatcher:(ABI5_0_0RCTEventDispatcher *)eventDispatcher
{
  ...
  if ((self = [super initWithFrame:CGRectZero])) {
    ...
    _textView = [[ABI5_0_0RCTUITextView alloc] initWithFrame:CGRectZero];
...
- (void)insertReactABI5_0_0Subview:(UIView *)subview atIndex:(NSInteger)index
{
  if ([subview isKindOfClass:[ABI5_0_0RCTText class]]) {
    if (_richTextView) {
      ABI5_0_0RCTLogError(@"Tried to insert a second <Text> into <TextInput> - there can only be one.");
    }
    _richTextView = (ABI5_0_0RCTText *)subview;
...
- (void)updateFrames
{
  ...
  // ABI5_0_0RCTTextField defaults, using the system defaults of font size 17 and a
  // height of 31 points.
  //
...
- (BOOL)textView:(ABI5_0_0RCTUITextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text
{
  ...
  if (textView.textWasPasted) {
    ...
    [_eventDispatcher sendTextEventWithType:ABI5_0_0RCTTextEventTypeKeyPress
    ...
    if (_blurOnSubmit && [text isEqualToString:@"\n"]) {
      ...
      // TODO: the purpose of blurOnSubmit on ABI5_0_0RCTextField is to decide if the
      // field should lose focus when return is pressed or not. We're cheating a
      // bit here by using it on ABI5_0_0RCTextView to decide if return character should
      ...
      [_eventDispatcher sendTextEventWithType:ABI5_0_0RCTTextEventTypeSubmit
                                     ReactABI5_0_0Tag:self.ReactABI5_0_0Tag
                                         text:self.text
                                          key:nil
                                   eventCount:_nativeEventCount];
...
- (void)textViewDidChangeSelection:(ABI5_0_0RCTUITextView *)textView
{
...
- (void)setText:(NSString *)text
{
  ...
  } else if (eventLag > ABI5_0_0RCTTextUpdateLagWarningThreshold) {
    ABI5_0_0RCTLogWarn(@"Native TextInput(%@) is %zd events ahead of JS - try to make your JS faster.", self.text, eventLag);
  }
}
...
- (void)textViewDidBeginEditing:(UITextView *)textView
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI5_0_0RCTTextEventTypeFocus
                                 ReactABI5_0_0Tag:self.ReactABI5_0_0Tag
                                     text:nil
                                      key:nil
                               eventCount:_nativeEventCount];
...
{
  [_eventDispatcher sendTextEventWithType:ABI5_0_0RCTTextEventTypeEnd
                                 ReactABI5_0_0Tag:self.ReactABI5_0_0Tag
                                     text:textView.text
                                      key:nil
                               eventCount:_nativeEventCount];

  [_eventDispatcher sendTextEventWithType:ABI5_0_0RCTTextEventTypeBlur
                                 ReactABI5_0_0Tag:self.ReactABI5_0_0Tag
                                     text:nil
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (void)ReactABI5_0_0WillMakeFirstResponder
{
  [_textView ReactABI5_0_0WillMakeFirstResponder];
}
...
- (void)ReactABI5_0_0DidMakeFirstResponder
{
  [_textView ReactABI5_0_0DidMakeFirstResponder];
}
