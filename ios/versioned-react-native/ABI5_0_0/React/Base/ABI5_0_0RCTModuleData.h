...
@protocol ABI5_0_0RCTBridgeMethod;
@protocol ABI5_0_0RCTBridgeModule;
@class ABI5_0_0RCTBridge;

@interface ABI5_0_0RCTModuleData : NSObject <ABI5_0_0RCTInvalidating>

- (instancetype)initWithModuleClass:(Class)moduleClass
                             bridge:(ABI5_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI5_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI5_0_0RCTBridgeModule> instance;
