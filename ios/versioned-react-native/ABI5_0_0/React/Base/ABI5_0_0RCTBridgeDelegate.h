...
typedef void (^ABI5_0_0RCTSourceLoadBlock)(NSError *error, NSData *source);

@class ABI5_0_0RCTBridge;

@protocol ABI5_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI5_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI5_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray *)extraModulesForBridge:(ABI5_0_0RCTBridge *)bridge;
 ...
 */
- (void)loadSourceForBridge:(ABI5_0_0RCTBridge *)bridge
                  withBlock:(ABI5_0_0RCTSourceLoadBlock)loadCallback;
