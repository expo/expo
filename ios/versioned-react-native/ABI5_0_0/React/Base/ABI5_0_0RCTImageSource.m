...
@interface ABI5_0_0RCTImageSource ()

@property (nonatomic, assign) BOOL packagerAsset;

@end

@implementation ABI5_0_0RCTImageSource
...
{
  ABI5_0_0RCTImageSource *imageSource = [[ABI5_0_0RCTImageSource alloc] initWithURL:_imageURL
                                                               size:size
                                                              scale:scale];
...
- (BOOL)isEqual:(ABI5_0_0RCTImageSource *)object
{
  if (![object isKindOfClass:[ABI5_0_0RCTImageSource class]]) {
    return NO;
  }
...
@implementation ABI5_0_0RCTConvert (ImageSource)

+ (ABI5_0_0RCTImageSource *)ABI5_0_0RCTImageSource:(id)json
{
  if (!json) {
    return nil;
  }
  ...
  if ([json isKindOfClass:[NSDictionary class]]) {
    if (!(imageURL = [self NSURL:ABI5_0_0RCTNilIfNull(json[@"uri"])])) {
      return nil;
    }
    ...
    ABI5_0_0RCTLogConvertError(json, @"an image. Did you forget to call resolveAssetSource() on the JS side?");
    return nil;
  }

  ABI5_0_0RCTImageSource *imageSource = [[ABI5_0_0RCTImageSource alloc] initWithURL:imageURL
                                                               size:size
                                                              scale:scale];
