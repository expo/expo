 ...
 */
ABI5_0_0RCT_EXTERN NSString *const ABI5_0_0RCTReloadNotification;

/**
 * This notification fires when the bridge starts loading the JS bundle.
 */
ABI5_0_0RCT_EXTERN NSString *const ABI5_0_0RCTJavaScriptWillStartLoadingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI5_0_0RCT_EXTERN NSString *const ABI5_0_0RCTJavaScriptDidLoadNotification;

/**
 * This notification fires when the bridge failed to load the JS bundle. The
 * `error` key can be used to determine the error that occured.
 */
ABI5_0_0RCT_EXTERN NSString *const ABI5_0_0RCTJavaScriptDidFailToLoadNotification;
 ...
 */
ABI5_0_0RCT_EXTERN NSString *const ABI5_0_0RCTDidInitializeModuleNotification;
 ...
 */
typedef NSArray<id<ABI5_0_0RCTBridgeModule>> *(^ABI5_0_0RCTBridgeModuleProviderBlock)(void);

/**
 * This function returns the module name for a given class.
 */
ABI5_0_0RCT_EXTERN NSString *ABI5_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI5_0_0RCTBridge : NSObject <ABI5_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI5_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI5_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 */
@property (nonatomic, weak, readonly) id<ABI5_0_0RCTBridgeDelegate> delegate;
 ...
 *
 * NOTE: ABI5_0_0RCTEventDispatcher is now a bridge module, this is implemented as a
 * category but remains declared in the bridge to avoid breaking changes
 *
 * To be moved.
 */
@property (nonatomic, readonly) ABI5_0_0RCTEventDispatcher *eventDispatcher;
