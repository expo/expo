...
@implementation ABI5_0_0RCTConvert(MapKit)
...
ABI5_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
{
  json = [self NSDictionary:json];
  ABI5_0_0RCTMapAnnotation *annotation = [ABI5_0_0RCTMapAnnotation new];
...
ABI5_0_0RCT_ARRAY_CONVERTER(ABI5_0_0RCTMapAnnotation)
...
+ (ABI5_0_0RCTMapOverlay *)ABI5_0_0RCTMapOverlay:(id)json
{
  ...
  ABI5_0_0RCTMapOverlay *overlay = [ABI5_0_0RCTMapOverlay polylineWithCoordinates:coordinates
...
ABI5_0_0RCT_ARRAY_CONVERTER(ABI5_0_0RCTMapOverlay)
