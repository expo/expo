...
@protocol ABI5_0_0RCTAutoInsetsProtocol;

@class ABI5_0_0RCTView;

@interface ABI5_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI5_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI5_0_0RCTDirectEventBlock onMagicTap;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI5_0_0RCTPointerEvents pointerEvents;

+ (void)autoAdjustInsetsForView:(UIView<ABI5_0_0RCTAutoInsetsProtocol> *)parentView
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI5_0_0RCTBorderStyle borderStyle;
