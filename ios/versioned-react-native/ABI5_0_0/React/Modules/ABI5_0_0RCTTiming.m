...
@interface ABI5_0_0RCTTimer : NSObject
...
@implementation ABI5_0_0RCTTimer
...
@implementation ABI5_0_0RCTTiming
{
  NSMutableDictionary<NSNumber *, ABI5_0_0RCTTimer *> *_timers;
}
...
- (void)didUpdateFrame:(__unused ABI5_0_0RCTFrameUpdate *)update
{
  NSMutableArray<NSNumber *> *timersToCall = [NSMutableArray new];
  for (ABI5_0_0RCTTimer *timer in _timers.allValues) {
 ...
 */
ABI5_0_0RCT_EXPORT_METHOD(createTimer:(nonnull NSNumber *)callbackID
                  ...
                  repeats:(BOOL)repeats)
{
  ...
  ABI5_0_0RCTTimer *timer = [[ABI5_0_0RCTTimer alloc] initWithCallbackID:callbackID
                                                interval:jsDuration
...
ABI5_0_0RCT_EXPORT_METHOD(deleteTimer:(nonnull NSNumber *)timerID)
{
