...
#import "ABI5_0_0RCTDevLoadingView.h"
...
@implementation ABI5_0_0RCTDevLoadingView
{
  UIWindow *_window;
  UILabel *_label;
  NSDate *_showDate;
...
- (void)setBridge:(ABI5_0_0RCTBridge *)bridge
{
  ...
  [[NSNotificationCenter defaultCenter] addObserver:self
                                           selector:@selector(hide)
                                               name:ABI5_0_0RCTJavaScriptDidFailToLoadNotification
                                             object:nil];
...
ABI5_0_0RCT_EXPORT_METHOD(showMessage:(NSString *)message color:(UIColor *)color backgroundColor:(UIColor *)backgroundColor)
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    if (!_window && !ABI5_0_0RCTRunningInTestEnvironment()) {
