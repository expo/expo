...
@implementation ABI5_0_0RCTExceptionsManager
{
  __weak id<ABI5_0_0RCTExceptionsManagerDelegate> _delegate;
...
ABI5_0_0RCT_EXPORT_METHOD(reportSoftException:(NSString *)message
...
ABI5_0_0RCT_EXPORT_METHOD(reportFatalException:(NSString *)message
                  stack:(NSArray<NSDictionary *> *)stack
                  exceptionId:(nonnull NSNumber *)exceptionId)
{
  [_bridge.redBox showErrorMessage:message withStack:stack];
  ...
  if (!ABI5_0_0RCT_DEBUG && reloadRetries < _maxReloadAttempts) {
    reloadRetries++;
    [[NSNotificationCenter defaultCenter] postNotificationName:ABI5_0_0RCTReloadNotification object:_bridge.baseBridge];
  } else {
    NSString *description = [@"Unhandled JS Exception: " stringByAppendingString:message];
    NSDictionary *errorInfo = @{ NSLocalizedDescriptionKey: description, ABI5_0_0RCTJSStackTraceKey: stack };
    ABI5_0_0RCTFatal([NSError errorWithDomain:ABI5_0_0RCTErrorDomain code:0 userInfo:errorInfo]);
  }
}

ABI5_0_0RCT_EXPORT_METHOD(updateExceptionMessage:(NSString *)message
                  stack:(NSArray<NSDictionary *> *)stack
                  exceptionId:(nonnull NSNumber *)exceptionId)
{
...
ABI5_0_0RCT_EXPORT_METHOD(reportUnhandledException:(NSString *)message
                  stack:(NSArray<NSDictionary *> *)stack)
{
