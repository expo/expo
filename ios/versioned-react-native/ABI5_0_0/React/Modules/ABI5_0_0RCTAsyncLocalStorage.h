 ...
 * being atomic, unless someone bypasses the `ABI5_0_0RCTAsyncLocalStorage` API.
 *
 * Keys and values must always be strings or an error is returned.
 */
@interface ABI5_0_0RCTAsyncLocalStorage : NSObject <ABI5_0_0RCTBridgeModule,ABI5_0_0RCTInvalidating>

@property (nonatomic, assign) BOOL clearOnInvalidate;

@property (nonatomic, readonly, getter=isValid) BOOL valid;

// Clear the ABI5_0_0RCTAsyncLocalStorage data from native code
- (void)clearAllData;
