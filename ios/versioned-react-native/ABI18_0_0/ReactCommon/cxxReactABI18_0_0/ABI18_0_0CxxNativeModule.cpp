...
#include "ABI18_0_0CxxNativeModule.h"
#include "ABI18_0_0Instance.h"
...
void CxxNativeModule::invoke(unsigned int ReactABI18_0_0MethodId, folly::dynamic&& params) {
  if (ReactABI18_0_0MethodId >= methods_.size()) {
    throw std::invalid_argument(folly::to<std::string>("methodId ", ReactABI18_0_0MethodId,
  ...
  const auto& method = methods_[ReactABI18_0_0MethodId];
