...
#include <cxxReactABI18_0_0/ABI18_0_0RecoverableError.h>

using namespace facebook::ReactABI18_0_0::detail;
...
TEST(RecoverableError, RunRethrowingAsRecoverableRecoverTest) {
  try {
    ...
    ASSERT_STREQ(err.what(), "facebook::ReactABI18_0_0::Recoverable: catch me");
  } catch (...) {
