...
#include "ABI18_0_0JSCExecutor.h"
...
#include <ABI18_0_0jschelpers/ABI18_0_0JSCHelpers.h>
#include <ABI18_0_0jschelpers/ABI18_0_0Value.h>

#ifdef WITH_INSPECTOR
#include <ABI18_0_0jschelpers/ABI18_0_0InspectorInterfaces.h>
#endif

#include "ABI18_0_0JSBundleType.h"
#include "ABI18_0_0Platform.h"
#include "ABI18_0_0SystraceSection.h"
#include "ABI18_0_0JSCNativeModules.h"
#include "ABI18_0_0JSCSamplingProfiler.h"
#include "ABI18_0_0JSCUtils.h"
#include "JSModulesUnbundle.h"
#include "ABI18_0_0ModuleRegistry.h"
#include "ABI18_0_0RecoverableError.h"

#if defined(WITH_JSC_EXTRA_TRACING) || (DEBUG && defined(WITH_FBSYSTRACE))
#include "ABI18_0_0JSCTracing.h"
#endif

#ifdef WITH_JSC_EXTRA_TRACING
#include "ABI18_0_0JSCLegacyProfiler.h"
#include "ABI18_0_0JSCLegacyTracing.h"
#endif
...
#include "ABI18_0_0JSCPerfStats.h"
#endif
...
void JSCExecutor::loadApplicationScript(std::unique_ptr<const JSBigString> script, std::string sourceURL) {
  ...
  ReactABI18_0_0Marker::logMarker(ReactABI18_0_0Marker::RUN_JS_BUNDLE_START);
  ...
  if (auto fileStr = dynamic_cast<const JSBigFileString *>(script.get())) {
    ...
    case JSLoadSourceIsCompiled:
      ...
      ReactABI18_0_0Marker::logMarker(ReactABI18_0_0Marker::CREATE_REACT_CONTEXT_STOP);
      ReactABI18_0_0Marker::logMarker(ReactABI18_0_0Marker::RUN_JS_BUNDLE_STOP);
      return;
...
#endif
  {
    ...
    ReactABI18_0_0Marker::logMarker(ReactABI18_0_0Marker::JS_BUNDLE_STRING_CONVERT_START);
    String jsScript = jsStringFromBigString(m_context, *script);
    ReactABI18_0_0Marker::logMarker(ReactABI18_0_0Marker::JS_BUNDLE_STRING_CONVERT_STOP);
...
void JSCExecutor::stopProfiler(const std::string &titleString, const std::string& filename) {
  #ifdef WITH_JSC_EXTRA_TRACING
  String title(m_context, titleString.c_str());
  facebook::ReactABI18_0_0::stopAndOutputProfilingFile(m_context, title, filename.c_str());
  #endif
}
...
JSValueRef JSCExecutor::nativeRequire(
  ...
  ReactABI18_0_0Marker::logMarker(ReactABI18_0_0Marker::NATIVE_REQUIRE_START);
  loadModule(moduleId);
  ReactABI18_0_0Marker::logMarker(ReactABI18_0_0Marker::NATIVE_REQUIRE_STOP);
