...
void Instance::setSourceURL(std::string sourceURL) {
  ...
  SystraceSection s("ReactABI18_0_0bridge_xplat_setSourceURL",
                    "sourceURL", sourceURL);
...
void Instance::loadScriptFromString(std::unique_ptr<const JSBigString> string,
  ...
  callback_->incrementPendingJSCalls();
  SystraceSection s("ReactABI18_0_0bridge_xplat_loadScriptFromString",
                    "sourceURL", sourceURL);
...
void Instance::loadScriptFromFile(const std::string& filename,
  ...
  callback_->incrementPendingJSCalls();
  SystraceSection s("ReactABI18_0_0bridge_xplat_loadScriptFromFile",
                    "fileName", filename);
...
void Instance::loadUnbundleSync(std::unique_ptr<JSModulesUnbundle> unbundle,
  ...
  SystraceSection s("ReactABI18_0_0bridge_xplat_loadApplicationSync");
