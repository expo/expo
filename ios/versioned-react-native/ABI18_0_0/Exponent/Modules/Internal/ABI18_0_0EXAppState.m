...
@interface ABI18_0_0EXAppState ()

@property (nonatomic, assign) BOOL isObserving;

@end

@implementation ABI18_0_0EXAppState

+ (NSString *)moduleName { return @"ABI18_0_0RCTAppState"; }
...
ABI18_0_0RCT_EXPORT_METHOD(getCurrentAppState:(ABI18_0_0RCTResponseSenderBlock)callback
