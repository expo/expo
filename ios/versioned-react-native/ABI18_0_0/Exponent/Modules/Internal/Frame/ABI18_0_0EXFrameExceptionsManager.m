...
@implementation ABI18_0_0EXFrameExceptionsManager {
  __weak id<ABI18_0_0RCTExceptionsManagerDelegate> _delegate;
}

@synthesize bridge = _bridge;

+ (NSString *)moduleName { return @"ABI18_0_0RCTExceptionsManager"; }
...
{
  // this will hit ABI18_0_0EXDisabledRedBox when not debugging
