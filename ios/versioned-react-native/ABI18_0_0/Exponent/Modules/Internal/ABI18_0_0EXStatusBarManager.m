...
#if !TARGET_OS_TV
@implementation ABI18_0_0RCTConvert (ABI18_0_0EXStatusBar)

ABI18_0_0RCT_ENUM_CONVERTER(UIStatusBarStyle, (@{
  @"default": @(UIStatusBarStyleDefault),
  @"light-content": @(UIStatusBarStyleLightContent),
  @"dark-content": @(UIStatusBarStyleDefault),
}), UIStatusBarStyleDefault, integerValue);

ABI18_0_0RCT_ENUM_CONVERTER(UIStatusBarAnimation, (@{
...
@interface ABI18_0_0EXStatusBarManager ()

@property (nonatomic, strong) NSMutableDictionary *capturedStatusBarProperties;

@end

@implementation ABI18_0_0EXStatusBarManager

+ (NSString *)moduleName { return @"ABI18_0_0RCTStatusBarManager"; }
...
ABI18_0_0RCT_EXPORT_METHOD(getHeight:(ABI18_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@{
...
ABI18_0_0RCT_EXPORT_METHOD(setStyle:(UIStatusBarStyle)statusBarStyle
                  animated:(BOOL)animated)
{
  if ([[self class] _viewControllerBasedStatusBarAppearance]) {
    ABI18_0_0RCTLogError(@"ABI18_0_0RCTStatusBarManager module requires that the \
                UIViewControllerBasedStatusBarAppearance key in the Info.plist is set to NO");
  } else {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ABI18_0_0RCTSharedApplication() setStatusBarStyle:statusBarStyle
                                     animated:animated];
...
ABI18_0_0RCT_EXPORT_METHOD(setHidden:(BOOL)hidden
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ABI18_0_0RCTSharedApplication() setStatusBarHidden:hidden
...
ABI18_0_0RCT_EXPORT_METHOD(setNetworkActivityIndicatorVisible:(BOOL)visible)
{
  ABI18_0_0RCTSharedApplication().networkActivityIndicatorVisible = visible;
 ...
 */
ABI18_0_0RCT_REMAP_METHOD(_captureProperties,
                 _capturePropertiesWithResolver:(ABI18_0_0RCTPromiseResolveBlock)resolve
 ...
 *  Normally nobody should use this method because it bypasses the JS state used by the StatusBar component.
 */
ABI18_0_0RCT_EXPORT_METHOD(_applyPropertiesAndForget:(NSDictionary *)properties)
{
...
{
  UIApplication *currentApplication = ABI18_0_0RCTSharedApplication();
  return @{
