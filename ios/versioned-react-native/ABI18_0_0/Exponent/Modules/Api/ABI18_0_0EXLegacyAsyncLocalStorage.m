...
static NSString *const ABI18_0_0RCTStorageDirectory = @"RCTAsyncLocalStorage_V1";
...
#endif
    storageDirectory = [storageDirectory stringByAppendingPathComponent:ABI18_0_0RCTStorageDirectory];
  });
