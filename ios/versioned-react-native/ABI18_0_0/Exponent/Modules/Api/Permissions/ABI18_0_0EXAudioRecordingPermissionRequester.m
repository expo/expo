...
@interface ABI18_0_0EXAudioRecordingPermissionRequester ()

@property (nonatomic, weak) id<ABI18_0_0EXPermissionRequesterDelegate> delegate;

@end

@implementation ABI18_0_0EXAudioRecordingPermissionRequester
...
+ (NSDictionary *)permissions
{
  ...
  if (!microphoneUsageDescription) {
    ABI18_0_0RCTFatal(ABI18_0_0RCTErrorWithMessage(@"This app is missing NSMicrophoneUsageDescription, so audio services will fail. Add one of these keys to your bundle's Info.plist."));
