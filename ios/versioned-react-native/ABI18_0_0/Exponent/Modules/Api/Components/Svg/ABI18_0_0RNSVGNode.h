...
/**
 * ABI18_0_0RNSVG nodes are implemented as base UIViews. They should be implementation for all basic
 ＊interfaces for all non-defination nodes.
 */

@interface ABI18_0_0RNSVGNode : UIView

@property (nonatomic, strong) NSString *name;
@property (nonatomic, assign) CGFloat opacity;
@property (nonatomic, assign) ABI18_0_0RNSVGCGFCRule clipRule;
...
/**
 * get ABI18_0_0RNSVGSvgView which ownes current ABI18_0_0RNSVGNode
 */
