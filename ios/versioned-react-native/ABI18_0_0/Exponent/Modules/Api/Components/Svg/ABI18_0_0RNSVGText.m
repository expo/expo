...
#import "ABI18_0_0RNSVGGlyphContext.h"

@implementation ABI18_0_0RNSVGText
{
    ABI18_0_0RNSVGText *_textRoot;
    ABI18_0_0RNSVGGlyphContext *_glyphContext;
}

- (void)setTextAnchor:(ABI18_0_0RNSVGTextAnchor)textAnchor
{
    [self invalidate];
...
{
    _glyphContext = [[ABI18_0_0RNSVGGlyphContext alloc] initWithDimensions:[self getContextWidth]
                                                  height:[self getContextHeight]];
}

// release the cached CGPathRef for ABI18_0_0RNSVGTSpan
- (void)releaseCachedPath
{
    [self traverseSubviews:^BOOL(__kindof ABI18_0_0RNSVGNode *node) {
        ABI18_0_0RNSVGText *text = node;
...
- (ABI18_0_0RNSVGTextAnchor)getComputedTextAnchor
{
    ABI18_0_0RNSVGTextAnchor anchor = self.textAnchor;
    if (self.subviews.count > 0) {
        ABI18_0_0RNSVGText *child = [self.subviews firstObject];
...
- (ABI18_0_0RNSVGText *)getTextRoot
{
    if (!_textRoot) {
        _textRoot = self;
        while (_textRoot && [_textRoot class] != [ABI18_0_0RNSVGText class]) {
            if (![_textRoot isKindOfClass:[ABI18_0_0RNSVGText class]]) {
                //todo: throw exception here
                break;
            }
            _textRoot = (ABI18_0_0RNSVGText*)[_textRoot superview];
        }
    }
...
- (ABI18_0_0RNSVGGlyphContext *)getGlyphContext
{
