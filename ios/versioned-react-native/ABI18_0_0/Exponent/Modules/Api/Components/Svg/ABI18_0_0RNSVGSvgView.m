...
@implementation ABI18_0_0RNSVGSvgView
{
    NSMutableDictionary<NSString *, ABI18_0_0RNSVGNode *> *_clipPaths;
    NSMutableDictionary<NSString *, ABI18_0_0RNSVGNode *> *_templates;
    NSMutableDictionary<NSString *, ABI18_0_0RNSVGPainter *> *_painters;
    CGRect _boundingBox;
...
- (void)setMeetOrSlice:(ABI18_0_0RNSVGVBMOS)meetOrSlice
{
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.align) {
        _viewBoxTransform = [ABI18_0_0RNSVGViewBox getTransform:CGRectMake(self.minX, self.minY, self.vbWidth, self.vbHeight)
                                                 eRect:rect
                                                 align:self.align
...
- (void)defineTemplate:(ABI18_0_0RNSVGNode *)template templateName:(NSString *)templateName
{
    if (!_templates) {
