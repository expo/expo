...
#import "ABI18_0_0AIRMapManager.h"
...
#import "ABI18_0_0AIRMapSnapshot.h"
...
@interface ABI18_0_0AIRMapManager() <MKMapViewDelegate>

@end

@implementation ABI18_0_0AIRMapManager

ABI18_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI18_0_0AIRMap *map = [ABI18_0_0AIRMap new];
    map.delegate = self;
...
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(userLocationAnnotationTitle, NSString)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(showsPointsOfInterest, BOOL)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
...
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(cacheEnabled, BOOL)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(maxDelta, CGFloat)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(minDelta, CGFloat)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(legalLabelInsets, UIEdgeInsets)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, MKMapType)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(onChange, ABI18_0_0RCTBubblingEventBlock)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(onPanDrag, ABI18_0_0RCTBubblingEventBlock)
...
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI18_0_0RCTDirectEventBlock)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI18_0_0RCTDirectEventBlock)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI18_0_0RCTDirectEventBlock)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI18_0_0RCTDirectEventBlock)
ABI18_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI18_0_0RCTDirectEventBlock)
...
ABI18_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI18_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setRegion:[ABI18_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI18_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI18_0_0AIRMap class]]) {
            ABI18_0_0RCTLogError(@"Invalid view returned from registry, expecting ABI18_0_0AIRMap, got: %@", view);
        } else {
            [ABI18_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI18_0_0AIRMap *)view setRegion:region animated:YES];
            }];
        }
    }];
}
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI18_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI18_0_0AIRMap class]]) {
            ...
            ABI18_0_0AIRMap *mapView = (ABI18_0_0AIRMap *)view;
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI18_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI18_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ABI18_0_0AIRMapMarker *marker = (ABI18_0_0AIRMapMarker *)evaluatedObject;
                return [marker isKindOfClass:[ABI18_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
...
- (void)takeMapSnapshot:(ABI18_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI18_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI18_0_0AIRMap *map = (ABI18_0_0AIRMap *)recognizer.view;
    ...
    ABI18_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI18_0_0AIRMapPolygon class]]){
            ABI18_0_0AIRMapPolygon *polygon = (ABI18_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI18_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI18_0_0AIRMapPolyline class]]){
            ABI18_0_0AIRMapPolyline *polyline = (ABI18_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI18_0_0AIRMapPolyline class]]) {
        return ((ABI18_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI18_0_0AIRMapPolygon class]]) {
        return ((ABI18_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI18_0_0AIRMapCircle class]]) {
        return ((ABI18_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI18_0_0AIRMapUrlTile class]]) {
        return ((ABI18_0_0AIRMapUrlTile *)overlay).renderer;
    } else {
        return nil;
    }
}
...
- (void)mapView:(ABI18_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI18_0_0AIRMapMarker class]]) {
        [(ABI18_0_0AIRMapMarker *)view.annotation showCalloutView];
...
- (void)mapView:(ABI18_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI18_0_0AIRMapMarker class]]) {
        [(ABI18_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI18_0_0AIRMap *)mapView viewForAnnotation:(ABI18_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI18_0_0AIRMapMarker class]]) {
...
- (void)mapView:(ABI18_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI18_0_0AIRMapMarker class]]) return;
    ABI18_0_0AIRMapMarker *marker = (ABI18_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI18_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI18_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI18_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI18_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI18_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    [self _regionChanged:mapView];

    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI18_0_0AIRMapRegionChangeObserveInterval
                                                               target:self
                                                             selector:@selector(_onTick:)
                                                             userInfo:@{ ABI18_0_0RCTMapViewKey: mapView }
                                                              repeats:YES];

    [[NSRunLoop mainRunLoop] addTimer:mapView.regionChangeObserveTimer forMode:NSRunLoopCommonModes];
}

- (void)mapView:(ABI18_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI18_0_0AIRMap *)mapView
{
...
- (void)mapViewDidFinishRenderingMap:(ABI18_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
{
    [self _regionChanged:timer.userInfo[ABI18_0_0RCTMapViewKey]];
}

- (void)_regionChanged:(ABI18_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI18_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI18_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI18_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI18_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI18_0_0AIRMap *)mapView
{
