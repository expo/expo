...
@interface ABI18_0_0AIRMapPolygon: MKAnnotationView <MKOverlay>
...
@property (nonatomic, strong) NSArray<ABI18_0_0AIRMapCoordinate *> *coordinates;
@property (nonatomic, strong) NSArray<NSArray<ABI18_0_0AIRMapCoordinate *> *> *holes;
