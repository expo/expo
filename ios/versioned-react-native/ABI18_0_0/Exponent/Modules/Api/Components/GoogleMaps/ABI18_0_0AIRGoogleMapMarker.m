...
@interface ABI18_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI18_0_0AIRGMSMarker*)marker;
@end

@implementation ABI18_0_0AIRGoogleMapMarker {
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI18_0_0AIRGMSMarker alloc] init];
...
- (void)insertReactABI18_0_0Subview:(id<ABI18_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI18_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI18_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI18_0_0AIRDummyView *dummySubview = [[ABI18_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertReactABI18_0_0Subview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeReactABI18_0_0Subview:(id<ABI18_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI18_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeReactABI18_0_0Subview:(UIView*)dummySubview];
}
...
- (ABI18_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/airbnb/ReactABI18_0_0-native-maps/issues/738)
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI18_0_0RN?
