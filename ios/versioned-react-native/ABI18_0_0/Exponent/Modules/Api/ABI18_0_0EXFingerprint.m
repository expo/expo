...
#import "ABI18_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI18_0_0EXFingerprint

ABI18_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI18_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI18_0_0RCTPromiseResolveBlock)resolve
...
ABI18_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI18_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI18_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI18_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
