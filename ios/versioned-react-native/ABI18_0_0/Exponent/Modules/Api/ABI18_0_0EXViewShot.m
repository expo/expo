...
@implementation ABI18_0_0EXViewShot

ABI18_0_0RCT_EXPORT_MODULE(ABI18_0_0RNViewShot)
...
// forked from ABI18_0_0RN implementation
// https://github.com/facebook/ReactABI18_0_0-native/blob/f35b372883a76b5666b016131d59268b42f3c40d/ReactABI18_0_0/Modules/ABI18_0_0RCTUIManager.m#L1367

ABI18_0_0RCT_EXPORT_METHOD(takeSnapshot:(nonnull NSNumber *)target
                  ...
                  reject:(ABI18_0_0RCTPromiseRejectBlock)reject)
{
  [self.bridge.uiManager addUIBlock:^(__unused ABI18_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ...
    if (!view) {
      reject(ABI18_0_0RCTErrorUnspecified, [NSString stringWithFormat:@"No view found with ReactABI18_0_0Tag: %@", target], nil);
      return;
    }
    ...
    NSString *result = [ABI18_0_0RCTConvert NSString:options[@"result"] ?: @"file"];
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
      ...
      if ([format isEqualToString:@"png"]) {
        ...
        reject(ABI18_0_0RCTErrorUnspecified, [NSString stringWithFormat:@"Unsupported image format: %@. Try one of: png | jpg | jpeg", format], nil);
        return;
      }
      ...
      if ([result isEqualToString:@"file"]) {
        ...
        reject(ABI18_0_0RCTErrorUnspecified, [NSString stringWithFormat:@"Unsupported result: %@. Try one of: file | base64 | data-uri", result], nil);
        return;
      }
      if (res != nil) {
        resolve(res);
      ...
      if (error != nil) reject(ABI18_0_0RCTErrorUnspecified, error.localizedDescription, error);
      else reject(ABI18_0_0RCTErrorUnspecified, @"viewshot unknown error", nil);
    });
  }];
}
