#import "ABI18_0_0EXAdSettingsManager.h"
...
ABI18_0_0RCT_ENUM_CONVERTER(FBAdLogLevel, (@{
...
@interface ABI18_0_0EXAdSettingsManager ()
...
@implementation ABI18_0_0EXAdSettingsManager

@synthesize bridge = _bridge;

ABI18_0_0RCT_EXPORT_MODULE(CTKAdSettingsManager)
...
ABI18_0_0RCT_EXPORT_METHOD(addTestDevice:(NSString *)deviceHash)
{
  [FBAdSettings addTestDevice:deviceHash];
  [_testDevices addObject:deviceHash];
}

ABI18_0_0RCT_EXPORT_METHOD(clearTestDevices)
{
  [FBAdSettings clearTestDevices];
  [_testDevices removeAllObjects];
}

ABI18_0_0RCT_EXPORT_METHOD(setLogLevel:(FBAdLogLevel)logLevel)
{
  [FBAdSettings setLogLevel:logLevel];
  _logLevel = logLevel;
}

ABI18_0_0RCT_EXPORT_METHOD(setIsChildDirected:(BOOL)isDirected)
{
  [FBAdSettings setIsChildDirected:isDirected];
  _isChildDirected = isDirected;
}

ABI18_0_0RCT_EXPORT_METHOD(setMediationService:(NSString *)mediationService)
{
  [FBAdSettings setMediationService:mediationService];
  _mediationService = mediationService;
}

ABI18_0_0RCT_EXPORT_METHOD(setUrlPrefix:(NSString *)urlPrefix)
{
