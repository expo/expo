 ...
 * UIManager queue
 */
ABI18_0_0RCT_EXTERN dispatch_queue_t ABI18_0_0RCTGetUIManagerQueue(void);

/**
 * Default name for the UIManager queue
 */
ABI18_0_0RCT_EXTERN char *const ABI18_0_0RCTUIManagerQueueName;

/**
 * Check if we are currently on UIManager queue.
 */
ABI18_0_0RCT_EXTERN BOOL ABI18_0_0RCTIsUIManagerQueue(void);

/**
 * Convenience macro for asserting that we're running on UIManager queue.
 */
#define ABI18_0_0RCTAssertUIManagerQueue() ABI18_0_0RCTAssert(ABI18_0_0RCTIsUIManagerQueue(), \
 ...
 */
ABI18_0_0RCT_EXTERN NSString *const ABI18_0_0RCTUIManagerWillUpdateViewsDueToContentSizeMultiplierChangeNotification;

/**
 * Posted whenever a new root view is registered with ABI18_0_0RCTUIManager. The userInfo property
 * will contain a ABI18_0_0RCTUIManagerRootViewKey with the registered root view.
 */
ABI18_0_0RCT_EXTERN NSString *const ABI18_0_0RCTUIManagerDidRegisterRootViewNotification;

/**
 * Posted whenever a root view is removed from the ABI18_0_0RCTUIManager. The userInfo property
 * will contain a ABI18_0_0RCTUIManagerRootViewKey with the removed root view.
 */
ABI18_0_0RCT_EXTERN NSString *const ABI18_0_0RCTUIManagerDidRemoveRootViewNotification;

/**
 * Key for the root view property in the above notifications
 */
ABI18_0_0RCT_EXTERN NSString *const ABI18_0_0RCTUIManagerRootViewKey;

@class ABI18_0_0RCTUIManagerObserverCoordinator;

/**
 * The ABI18_0_0RCTUIManager is the module responsible for updating the view hierarchy.
 */
@interface ABI18_0_0RCTUIManager : NSObject <ABI18_0_0RCTBridgeModule, ABI18_0_0RCTInvalidating>

/**
 * Register a root view with the ABI18_0_0RCTUIManager.
 */
- (void)registerRootView:(UIView *)rootView;

/**
 * Gets the view name associated with a ReactABI18_0_0Tag.
 */
- (NSString *)viewNameForReactABI18_0_0Tag:(NSNumber *)ReactABI18_0_0Tag;

/**
 * Gets the view associated with a ReactABI18_0_0Tag.
 */
 ...
 * or some other layout event outside of the ReactABI18_0_0-managed view hierarchy.
 */
...
/**
 * Given a ReactABI18_0_0Tag from a component, find its root view, if possible.
 * Otherwise, this will give back nil.
 *
 * @param ReactABI18_0_0Tag the component tag
 ...
 * ReactABI18_0_0 won't be aware of this, so we need to make sure it happens.
 */
- (void)setNeedsLayout;

/**
 * Dedicated object for subscribing for UIManager events.
 * See `ABI18_0_0RCTUIManagerObserver` protocol for more details.
 */
@property (atomic, retain, readonly) ABI18_0_0RCTUIManagerObserverCoordinator *observerCoordinator;

@end

@interface ABI18_0_0RCTUIManager (Deprecated)
 ...
 */
- (void)registerRootView:(UIView *)rootView withSizeFlexibility:(ABI18_0_0RCTRootViewSizeFlexibility)sizeFlexibility
__deprecated_msg("Use `registerRootView:` instead.");

@end

/**
 * This category makes the current ABI18_0_0RCTUIManager instance available via the
 * ABI18_0_0RCTBridge, which is useful for ABI18_0_0RCTBridgeModules or ABI18_0_0RCTViewManagers that
 * need to access the ABI18_0_0RCTUIManager.
 */
@interface ABI18_0_0RCTBridge (ABI18_0_0RCTUIManager)

@property (nonatomic, readonly) ABI18_0_0RCTUIManager *uiManager;
