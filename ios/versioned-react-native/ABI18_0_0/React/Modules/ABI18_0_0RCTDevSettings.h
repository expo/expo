...
/**
 * An abstraction for a key-value store to manage ABI18_0_0RCTDevSettings behavior.
 * The default implementation persists settings using NSUserDefaults.
 */
@protocol ABI18_0_0RCTDevSettingsDataSource <NSObject>
...
@interface ABI18_0_0RCTDevSettings : NSObject
...
/*
 * Whether shaking will show ABI18_0_0RCTDevMenu. The menu is enabled by default if ABI18_0_0RCT_DEV=1, but
...
@interface ABI18_0_0RCTBridge (ABI18_0_0RCTDevSettings)

@property (nonatomic, readonly) ABI18_0_0RCTDevSettings *devSettings;
