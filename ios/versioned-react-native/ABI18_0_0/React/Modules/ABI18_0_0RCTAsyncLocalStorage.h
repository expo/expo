 ...
 */
@interface ABI18_0_0RCTAsyncLocalStorage : NSObject <ABI18_0_0RCTBridgeModule,ABI18_0_0RCTInvalidating>
...
// Clear the ABI18_0_0RCTAsyncLocalStorage data from native code
- (void)clearAllData;
