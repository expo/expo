...
#import "ABI18_0_0RCTKeyboardObserver.h"

#import "ABI18_0_0RCTEventDispatcher.h"

static NSDictionary *ABI18_0_0RCTParseKeyboardNotification(NSNotification *notification);

@implementation ABI18_0_0RCTKeyboardObserver
...
{ \
  [self sendEventWithName:@#EVENT \
    body:ABI18_0_0RCTParseKeyboardNotification(notification)]; \
}
...
NS_INLINE NSDictionary *ABI18_0_0RCTRectDictionaryValue(CGRect rect)
{
  return @{
...
static NSString *ABI18_0_0RCTAnimationNameForCurve(UIViewAnimationCurve curve)
{
  switch (curve) {
...
static NSDictionary *ABI18_0_0RCTParseKeyboardNotification(NSNotification *notification)
{
  ...
  return @{
    @"startCoordinates": ABI18_0_0RCTRectDictionaryValue(beginFrame),
    @"endCoordinates": ABI18_0_0RCTRectDictionaryValue(endFrame),
    @"duration": @(duration * 1000.0), // ms
    @"easing": ABI18_0_0RCTAnimationNameForCurve(curve),
  };
#endif
}
