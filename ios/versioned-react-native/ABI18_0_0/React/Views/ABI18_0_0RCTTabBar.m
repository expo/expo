...
@interface ABI18_0_0RCTTabBar() <UITabBarControllerDelegate>

@end

@implementation ABI18_0_0RCTTabBar
{
  BOOL _tabsChanged;
...
- (void)insertReactABI18_0_0Subview:(ABI18_0_0RCTTabBarItem *)subview atIndex:(NSInteger)atIndex
{
  if (![subview isKindOfClass:[ABI18_0_0RCTTabBarItem class]]) {
    ABI18_0_0RCTLogError(@"subview should be of type ABI18_0_0RCTTabBarItem");
    return;
  }
...
- (void)removeReactABI18_0_0Subview:(ABI18_0_0RCTTabBarItem *)subview
{
  if (self.ReactABI18_0_0Subviews.count == 0) {
    ABI18_0_0RCTLogError(@"should have at least one view to remove a subview");
    return;
  }
...
- (void)layoutSubviews
{
  ...
  [self ReactABI18_0_0AddControllerToClosestParent:_tabController];
...
- (void)ReactABI18_0_0BridgeDidFinishTransaction
{
  ...
  if (_tabsChanged) {
    ...
    for (ABI18_0_0RCTTabBarItem *tab in [self ReactABI18_0_0Subviews]) {
      UIViewController *controller = tab.ReactABI18_0_0ViewController;
      if (!controller) {
        controller = [[ABI18_0_0RCTWrapperViewController alloc] initWithContentView:tab];
      }
  ...
  [self.ReactABI18_0_0Subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger index, __unused BOOL *stop) {

    ABI18_0_0RCTTabBarItem *tab = (ABI18_0_0RCTTabBarItem *)view;
...
- (BOOL)tabBarController:(UITabBarController *)tabBarController shouldSelectViewController:(UIViewController *)viewController
{
  ...
  ABI18_0_0RCTTabBarItem *tab = (ABI18_0_0RCTTabBarItem *)self.ReactABI18_0_0Subviews[index];
