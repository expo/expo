...
static const CGFloat ABI18_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI18_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return
  ABS(borderInsets.left - borderInsets.right) < ABI18_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.bottom) < ABI18_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.top) < ABI18_0_0RCTViewBorderThreshold;
}

BOOL ABI18_0_0RCTCornerRadiiAreEqual(ABI18_0_0RCTCornerRadii cornerRadii)
{
  return
  ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI18_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI18_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI18_0_0RCTViewBorderThreshold;
}
...
{
  return (ABI18_0_0RCTCornerInsets) {
    {
...
static void ABI18_0_0RCTPathAddEllipticArc(CGMutablePathRef path,
                                       ...
                                       const CGAffineTransform *transform)
{
  ...
  ABI18_0_0RCTPathAddEllipticArc(path, transform, (CGPoint){
...
static void ABI18_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds,
                                               CGPoint lineStart,
                                               CGPoint lineEnd,
...
NS_INLINE BOOL ABI18_0_0RCTCornerRadiiAreAboveThreshold(ABI18_0_0RCTCornerRadii cornerRadii) {
  return (cornerRadii.topLeft > ABI18_0_0RCTViewBorderThreshold ||
    cornerRadii.topRight > ABI18_0_0RCTViewBorderThreshold      ||
    cornerRadii.bottomLeft > ABI18_0_0RCTViewBorderThreshold    ||
    cornerRadii.bottomRight > ABI18_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI18_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI18_0_0RCTCornerRadii cornerRadii) {
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI18_0_0RCTPathCreateWithRoundedRect(rect, ABI18_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef ABI18_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge) {
...
static UIImage *ABI18_0_0RCTGetSolidBorderImage(ABI18_0_0RCTCornerRadii cornerRadii,
                                       CGSize viewSize,
                                       ...
                                       BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI18_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI18_0_0RCTCornerInsets cornerInsets = ABI18_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  CGContextRef ctx = ABI18_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI18_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI18_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI18_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI18_0_0RCTEllipseGetIntersectionsWithLine((CGRect){
...
static UIImage *ABI18_0_0RCTGetDashedOrDottedBorderImage(ABI18_0_0RCTBorderStyle borderStyle,
                                                ...
                                                BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI18_0_0RCTBorderStyleDashed || borderStyle == ABI18_0_0RCTBorderStyleDotted);

  if (!ABI18_0_0RCTBorderColorsAreEqual(borderColors) || !ABI18_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI18_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI18_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI18_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI18_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI18_0_0RCTPathCreateWithRoundedRect(pathRect, ABI18_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI18_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
                           ...
                           BOOL drawToEdge)
{
  ...
  switch (borderStyle) {
    case ABI18_0_0RCTBorderStyleSolid:
      return ABI18_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI18_0_0RCTBorderStyleDashed:
    case ABI18_0_0RCTBorderStyleDotted:
      return ABI18_0_0RCTGetDashedOrDottedBorderImage(borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI18_0_0RCTBorderStyleUnset:
      break;
  }
