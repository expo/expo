...
@implementation ABI18_0_0RCTConvert (UITabBarSystemItem)

ABI18_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI18_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI18_0_0ViewController;
}
