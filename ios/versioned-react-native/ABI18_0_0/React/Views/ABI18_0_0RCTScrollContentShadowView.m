...
@interface ABI18_0_0RCTShadowView () {
...
@implementation ABI18_0_0RCTScrollContentShadowView
       ...
       absolutePosition:(CGPoint)absolutePosition
{
  ...
  CGFloat xCompensation = ABI18_0_0YGNodeLayoutGetRight(node) - ABI18_0_0YGNodeLayoutGetLeft(node);
  ...
  _frame.origin.x = ABI18_0_0RCTRoundPixelValue(ABI18_0_0YGNodeLayoutGetRight(node));
}
