...
// These constants can only be removed when ReactABI18_0_0 Native drops iOS8 support.
...
typedef CGFloat ABI18_0_0RCTFontWeight;
static ABI18_0_0RCTFontWeight weightOfFont(UIFont *font)
{
  ...
  ABI18_0_0RCTFontWeight weight = [traits[UIFontWeightTrait] doubleValue];
  if (weight == 0.0) {
...
static UIFont *cachedSystemFont(CGFloat size, ABI18_0_0RCTFontWeight weight)
{
...
@implementation ABI18_0_0RCTConvert (ABI18_0_0RCTFont)

+ (UIFont *)UIFont:(id)json
{
  json = [self NSDictionary:json];
  return [ABI18_0_0RCTFont updateFont:nil
                  withFamily:[ABI18_0_0RCTConvert NSString:json[@"fontFamily"]]
                        size:[ABI18_0_0RCTConvert NSNumber:json[@"fontSize"]]
                      weight:[ABI18_0_0RCTConvert NSString:json[@"fontWeight"]]
                       style:[ABI18_0_0RCTConvert NSString:json[@"fontStyle"]]
                     variant:[ABI18_0_0RCTConvert NSStringArray:json[@"fontVariant"]]
             scaleMultiplier:1];
}

ABI18_0_0RCT_ENUM_CONVERTER(ABI18_0_0RCTFontWeight, (@{
                                     @"normal": @(UIFontWeightRegular),
                                     @"bold": @(UIFontWeightBold),
...
typedef BOOL ABI18_0_0RCTFontStyle;
ABI18_0_0RCT_ENUM_CONVERTER(ABI18_0_0RCTFontStyle, (@{
                                    @"normal": @NO,
                                    @"italic": @YES,
                                    @"oblique": @YES,
                                    }), NO, boolValue)

typedef NSDictionary ABI18_0_0RCTFontVariantDescriptor;
+ (ABI18_0_0RCTFontVariantDescriptor *)ABI18_0_0RCTFontVariantDescriptor:(id)json
{
  ...
  ABI18_0_0RCTFontVariantDescriptor *value = mapping[json];
  if (ABI18_0_0RCT_DEBUG && !value && [json description].length > 0) {
    ABI18_0_0RCTLogError(@"Invalid ABI18_0_0RCTFontVariantDescriptor '%@'. should be one of: %@", json,
                [[mapping allKeys] sortedArrayUsingSelector:@selector(caseInsensitiveCompare:)]);
  }
  return value;
}

ABI18_0_0RCT_ARRAY_CONVERTER(ABI18_0_0RCTFontVariantDescriptor)

@end

@implementation ABI18_0_0RCTFont
...
+ (UIFont *)updateFont:(UIFont *)font
            withFamily:(NSString *)family
               ...
               variant:(NSArray<ABI18_0_0RCTFontVariantDescriptor *> *)variant
       scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  const ABI18_0_0RCTFontWeight defaultFontWeight = UIFontWeightRegular;
  const CGFloat defaultFontSize = 14;

  // Initialize properties to defaults
  CGFloat fontSize = defaultFontSize;
  ABI18_0_0RCTFontWeight fontWeight = defaultFontWeight;
  ...
  // Get font attributes
  fontSize = [ABI18_0_0RCTConvert CGFloat:size] ?: fontSize;
  if (scaleMultiplier > 0.0 && scaleMultiplier != 1.0) {
    fontSize = round(fontSize * scaleMultiplier);
  }
  familyName = [ABI18_0_0RCTConvert NSString:family] ?: familyName;
  isItalic = style ? [ABI18_0_0RCTConvert ABI18_0_0RCTFontStyle:style] : isItalic;
  fontWeight = weight ? [ABI18_0_0RCTConvert ABI18_0_0RCTFontWeight:weight] : fontWeight;
  ...
  if (!didFindFont && [UIFont fontNamesForFamilyName:familyName].count == 0) {
    ...
    if (font) {
      ...
      ABI18_0_0RCTLogError(@"Unrecognized font family '%@'", familyName);
      if ([UIFont respondsToSelector:@selector(systemFontOfSize:weight:)]) {
  ...
  if (variant) {
    NSArray *fontFeatures = [ABI18_0_0RCTConvert ABI18_0_0RCTFontVariantDescriptorArray:variant];
