...
#import <ReactABI18_0_0/ABI18_0_0RCTURLRequestDelegate.h>

/**
 * Provides the interface needed to register a request handler. Request handlers
 * are also bridge modules, so should be registered using ABI18_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI18_0_0RCTURLRequestHandler <ABI18_0_0RCTBridgeModule>
...
/**
 * If more than one ABI18_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
