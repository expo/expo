 ...
 */
@interface ABI18_0_0RCTImageSource : NSObject
...
@interface ABI18_0_0RCTConvert (ImageSource)

+ (ABI18_0_0RCTImageSource *)ABI18_0_0RCTImageSource:(id)json;
+ (NSArray<ABI18_0_0RCTImageSource *> *)ABI18_0_0RCTImageSourceArray:(id)json;
