...
#import "ABI18_0_0RCTMultipartStreamReader.h"

#define CRLF @"\r\n"

@implementation ABI18_0_0RCTMultipartStreamReader {
...
- (void)emitChunk:(NSData *)data callback:(ABI18_0_0RCTMultipartCallback)callback done:(BOOL)done
{
