...
#import "ABI18_0_0RCTBundleURLProvider.h"

#import "ABI18_0_0RCTConvert.h"
#import "ABI18_0_0RCTDefines.h"

NSString *const ABI18_0_0RCTBundleURLProviderUpdatedNotification = @"ABI18_0_0RCTBundleURLProviderUpdatedNotification";

const NSUInteger kABI18_0_0RCTBundleURLProviderDefaultPort = 8081;

static NSString *const kABI18_0_0RCTJsLocationKey = @"ABI18_0_0RCT_jsLocation";
static NSString *const kABI18_0_0RCTEnableLiveReloadKey = @"ABI18_0_0RCT_enableLiveReload";
static NSString *const kABI18_0_0RCTEnableDevKey = @"ABI18_0_0RCT_enableDev";
static NSString *const kABI18_0_0RCTEnableMinificationKey = @"ABI18_0_0RCT_enableMinification";

@implementation ABI18_0_0RCTBundleURLProvider
...
{
  return @{
    kABI18_0_0RCTEnableLiveReloadKey: @NO,
    kABI18_0_0RCTEnableDevKey: @YES,
    kABI18_0_0RCTEnableMinificationKey: @NO,
  };
}

- (void)settingsUpdated
{
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI18_0_0RCTBundleURLProviderUpdatedNotification object:self];
}
...
static NSURL *serverRootWithHost(NSString *host)
{
  return [NSURL URLWithString:
          [NSString stringWithFormat:@"http://%@:%lu/",
           host, (unsigned long)kABI18_0_0RCTBundleURLProviderDefaultPort]];
}
...
- (BOOL)enableDev
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI18_0_0RCTEnableDevKey];
}

- (BOOL)enableLiveReload
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI18_0_0RCTEnableLiveReloadKey];
}

- (BOOL)enableMinification
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI18_0_0RCTEnableMinificationKey];
}

- (NSString *)jsLocation
{
  return [[NSUserDefaults standardUserDefaults] stringForKey:kABI18_0_0RCTJsLocationKey];
}

- (void)setEnableDev:(BOOL)enableDev
{
  [self updateValue:@(enableDev) forKey:kABI18_0_0RCTEnableDevKey];
}

- (void)setEnableLiveReload:(BOOL)enableLiveReload
{
  [self updateValue:@(enableLiveReload) forKey:kABI18_0_0RCTEnableLiveReloadKey];
}

- (void)setJsLocation:(NSString *)jsLocation
{
  [self updateValue:jsLocation forKey:kABI18_0_0RCTJsLocationKey];
}

- (void)setEnableMinification:(BOOL)enableMinification
{
  [self updateValue:@(enableMinification) forKey:kABI18_0_0RCTEnableMinificationKey];
}

+ (instancetype)sharedSettings
{
  static ABI18_0_0RCTBundleURLProvider *sharedInstance;
  static dispatch_once_t once_token;
  dispatch_once(&once_token, ^{
    sharedInstance = [ABI18_0_0RCTBundleURLProvider new];
  });
