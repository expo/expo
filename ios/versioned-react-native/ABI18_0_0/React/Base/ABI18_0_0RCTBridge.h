...
#import <ReactABI18_0_0/ABI18_0_0RCTBridgeDelegate.h>
...
@class ABI18_0_0RCTPerformanceLogger;

/**
 * This notification fires when the bridge starts loading the JS bundle.
 */
ABI18_0_0RCT_EXTERN NSString *const ABI18_0_0RCTJavaScriptWillStartLoadingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI18_0_0RCT_EXTERN NSString *const ABI18_0_0RCTJavaScriptDidLoadNotification;

/**
 * This notification fires when the bridge failed to load the JS bundle. The
 * `error` key can be used to determine the error that occured.
 */
ABI18_0_0RCT_EXTERN NSString *const ABI18_0_0RCTJavaScriptDidFailToLoadNotification;
 ...
 */
ABI18_0_0RCT_EXTERN NSString *const ABI18_0_0RCTDidInitializeModuleNotification;
 ...
 */
typedef NSArray<id<ABI18_0_0RCTBridgeModule>> *(^ABI18_0_0RCTBridgeModuleListProvider)(void);

/**
 * This function returns the module name for a given class.
 */
ABI18_0_0RCT_EXTERN NSString *ABI18_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI18_0_0RCTBridge : NSObject <ABI18_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI18_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI18_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 * See also -[ABI18_0_0RCTBridgeDelgate shouldBridgeLoadJavaScriptSynchronously], which
 ...
 */
@property (nonatomic, weak, readonly) id<ABI18_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ReactABI18_0_0 Native perf events.
 */
@property (nonatomic, readonly, strong) ABI18_0_0RCTPerformanceLogger *performanceLogger;
