...
@interface ABI18_0_0RCTImageSource ()

@property (nonatomic, assign) BOOL packagerAsset;

@end

@implementation ABI18_0_0RCTImageSource
...
{
  ABI18_0_0RCTImageSource *imageSource = [[ABI18_0_0RCTImageSource alloc] initWithURLRequest:_request
                                                                      size:size
                                                                     scale:scale];
...
- (BOOL)isEqual:(ABI18_0_0RCTImageSource *)object
{
  if (![object isKindOfClass:[ABI18_0_0RCTImageSource class]]) {
    return NO;
  }
...
{
  return [NSString stringWithFormat:@"<ABI18_0_0RCTImageSource: %p URL=%@, size=%@, scale=%0.f>",
          self, _request.URL, NSStringFromCGSize(_size), _scale];
}

@end

@implementation ABI18_0_0RCTConvert (ImageSource)
...
+ (ABI18_0_0RCTImageSource *)ABI18_0_0RCTImageSource:(id)json
{
  ...
  if ([json isKindOfClass:[NSDictionary class]]) {
    ...
    ABI18_0_0RCTLogConvertError(json, @"an image. Did you forget to call resolveAssetSource() on the JS side?");
    return nil;
  }

  ABI18_0_0RCTImageSource *imageSource = [[ABI18_0_0RCTImageSource alloc] initWithURLRequest:request
                                                                      size:size
                                                                     scale:scale];
...
ABI18_0_0RCT_ARRAY_CONVERTER(ABI18_0_0RCTImageSource)
