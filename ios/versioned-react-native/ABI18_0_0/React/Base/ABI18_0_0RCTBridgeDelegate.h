...
@protocol ABI18_0_0RCTBridgeModule;

@protocol ABI18_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI18_0_0RCTBridge *)bridge;
 ...
 */
- (NSURL *)fallbackSourceURLForBridge:(ABI18_0_0RCTBridge *)bridge;

/**
 * The bridge initializes any registered ABI18_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI18_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI18_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (NSArray<Class> *)whitelistedModulesForBridge:(ABI18_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeLoadJavaScriptSynchronously:(ABI18_0_0RCTBridge *)bridge;
 ...
 * @experimental
 */
- (BOOL)shouldBridgeInitializeNativeModulesSynchronously:(ABI18_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI18_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI18_0_0RCTBridge *)bridge;

/**
 * Configure whether the legacy ABI18_0_0RCTBatchedBridge or new ABI18_0_0RCTCxxBridge
 ...
 * implemented, the implementation will default to ABI18_0_0RCTBatchedBridge,
 * but if it is not linked in, will try ABI18_0_0RCTCxxBridge instead.  If
 ...
 * @experimental
 */
- (BOOL)shouldBridgeUseCxxBridge:(ABI18_0_0RCTBridge *)bridge;
 ...
 */
- (void)loadSourceForBridge:(ABI18_0_0RCTBridge *)bridge
                 onProgress:(ABI18_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI18_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI18_0_0RCTBridge *)bridge
                  withBlock:(ABI18_0_0RCTSourceLoadBlock)loadCallback;
