...
@protocol ABI18_0_0RCTBridgeMethod;
@protocol ABI18_0_0RCTBridgeModule;
@class ABI18_0_0RCTBridge;

typedef id<ABI18_0_0RCTBridgeModule>(^ABI18_0_0RCTBridgeModuleProvider)(void);

@interface ABI18_0_0RCTModuleData : NSObject <ABI18_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI18_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI18_0_0RCTBridgeModule> instance;
