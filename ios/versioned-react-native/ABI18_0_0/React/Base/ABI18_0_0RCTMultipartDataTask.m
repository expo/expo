...
@interface ABI18_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI18_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI18_0_0RCTMultipartDataTaskCallback _partHandler;
...
- (instancetype)initWithURL:(NSURL *)url partHandler:(ABI18_0_0RCTMultipartDataTaskCallback)partHandler
{
  if (self = [super init]) {
    _url = url;
...
{
  ABI18_0_0RCTMultipartStreamReader *reader = [[ABI18_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI18_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
