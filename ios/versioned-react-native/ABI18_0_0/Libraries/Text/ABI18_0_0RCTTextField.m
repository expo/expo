...
@interface ABI18_0_0RCTTextField()
...
@interface ABI18_0_0RCTTextFieldDelegateProxy: NSObject <UITextFieldDelegate>
@end

@implementation ABI18_0_0RCTTextFieldDelegateProxy

- (BOOL)textField:(ABI18_0_0RCTTextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string
{
  return [textField shouldChangeCharactersInRange:range replacementString:string];
}

- (BOOL)keyboardInputShouldDelete:(ABI18_0_0RCTTextField *)textField
{
  return [textField keyboardInputShouldDelete];
}

- (BOOL)textFieldShouldEndEditing:(ABI18_0_0RCTTextField *)textField {
  return [textField textFieldShouldEndEditing];
}

@end

@implementation ABI18_0_0RCTTextField
{
  ...
  BOOL _textWasPasted;
  NSString *_finalText;
  ABI18_0_0RCTTextFieldDelegateProxy *_delegateProxy;
}

- (instancetype)initWithEventDispatcher:(ABI18_0_0RCTEventDispatcher *)eventDispatcher
{
  if ((self = [super initWithFrame:CGRectZero])) {
    ABI18_0_0RCTAssert(eventDispatcher, @"eventDispatcher is a required parameter");
    ...
    _delegateProxy = [ABI18_0_0RCTTextFieldDelegateProxy new];
...
static void ABI18_0_0RCTUpdatePlaceholder(ABI18_0_0RCTTextField *self)
{
...
- (void)setPlaceholderTextColor:(UIColor *)placeholderTextColor
{
  ...
  ABI18_0_0RCTUpdatePlaceholder(self);
}
...
{
  _nativeEventCount++;
  [_eventDispatcher sendTextEventWithType:ABI18_0_0RCTTextEventTypeChange
                                 ReactABI18_0_0Tag:self.ReactABI18_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (void)observeValueForKeyPath:(NSString *)keyPath
                      ofObject:(ABI18_0_0RCTTextField *)textField
...
{
  [self ReactABI18_0_0FocusIfNeeded];
}
