...
@interface ABI18_0_0RCTImageStoreManager : NSObject <ABI18_0_0RCTURLRequestHandler>
...
@interface ABI18_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI18_0_0RCTBridge (ABI18_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI18_0_0RCTImageStoreManager *imageStoreManager;
