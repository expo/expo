...
#import <ReactABI18_0_0/ABI18_0_0RCTResizeMode.h>
#import <ReactABI18_0_0/ABI18_0_0RCTURLRequestHandler.h>

typedef void (^ABI18_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI18_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI18_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI18_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI18_0_0RCTImageCache <NSObject>
...
@interface UIImage (ReactABI18_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI18_0_0KeyframeAnimation;

@end

@interface ABI18_0_0RCTImageLoader : NSObject <ABI18_0_0RCTBridgeModule, ABI18_0_0RCTURLRequestHandler>
 ...
 * decoded images as long as it conforms to the ABI18_0_0RCTImageCacheDelegate
...
@interface ABI18_0_0RCTBridge (ABI18_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI18_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI18_0_0RCTImageURLLoader <ABI18_0_0RCTBridgeModule>
 ...
 * applicable.
 */
- (ABI18_0_0RCTImageLoaderCancellationBlock)loadImageForURL:(NSURL *)imageURL
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                        resizeMode:(ABI18_0_0RCTResizeMode)resizeMode
                                   progressHandler:(ABI18_0_0RCTImageLoaderProgressBlock)progressHandler
                                partialLoadHandler:(ABI18_0_0RCTImageLoaderPartialLoadBlock)partialLoadHandler
                                 completionHandler:(ABI18_0_0RCTImageLoaderCompletionBlock)completionHandler;

@optional

/**
 * If more than one ABI18_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI18_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 */
@protocol ABI18_0_0RCTImageDataDecoder <ABI18_0_0RCTBridgeModule>
...
/**
 * If more than one ABI18_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
