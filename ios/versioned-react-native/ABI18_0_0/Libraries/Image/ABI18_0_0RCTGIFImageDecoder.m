...
#import "ABI18_0_0RCTGIFImageDecoder.h"
...
@implementation ABI18_0_0RCTGIFImageDecoder
...
- (ABI18_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                        resizeMode:(ABI18_0_0RCTResizeMode)resizeMode
                                 completionHandler:(ABI18_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (imageCount > 1) {
    ...
    image.ReactABI18_0_0KeyframeAnimation = animation;
