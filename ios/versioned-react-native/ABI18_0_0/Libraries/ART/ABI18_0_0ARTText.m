...
@implementation ABI18_0_0ARTText
...
static void ABI18_0_0ARTFreeTextFrame(ABI18_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI18_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI18_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI18_0_0ARTTextFrame frame = self.textFrame;
