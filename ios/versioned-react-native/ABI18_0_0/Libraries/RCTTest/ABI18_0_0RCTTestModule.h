...
typedef NS_ENUM(NSInteger, ABI18_0_0RCTTestStatus) {
  ABI18_0_0RCTTestStatusPending = 0,
  ABI18_0_0RCTTestStatusPassed,
  ABI18_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI18_0_0RCTTestModule : NSObject <ABI18_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI18_0_0RCTTestStatus status;
