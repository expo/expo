...
#import "ABI18_0_0RCTAssetsLibraryRequestHandler.h"
...
@implementation ABI18_0_0RCTAssetsLibraryRequestHandler
{
...
#pragma mark - ABI18_0_0RCTURLRequestHandler
...
- (id)sendRequest:(NSURLRequest *)request
     withDelegate:(id<ABI18_0_0RCTURLRequestDelegate>)delegate
{
  ...
  [[self assetsLibrary] assetForURL:request.URL resultBlock:^(ALAsset *asset) {
    ...
    if (asset) {
      ...
      NSError *error = ABI18_0_0RCTErrorWithMessage(errorMessage);
      [delegate URLRequest:cancellationBlock didCompleteWithError:error];
    }
...
@implementation ABI18_0_0RCTBridge (ABI18_0_0RCTAssetsLibraryImageLoader)

- (ALAssetsLibrary *)assetsLibrary
{
  return [[self moduleForClass:[ABI18_0_0RCTAssetsLibraryRequestHandler class]] assetsLibrary];
}
