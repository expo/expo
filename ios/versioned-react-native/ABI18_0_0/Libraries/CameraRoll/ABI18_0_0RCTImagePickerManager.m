...
#import "ABI18_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI18_0_0/ABI18_0_0RCTConvert.h>
#import <ReactABI18_0_0/ABI18_0_0RCTImageStoreManager.h>
#import <ReactABI18_0_0/ABI18_0_0RCTRootView.h>
#import <ReactABI18_0_0/ABI18_0_0RCTUtils.h>

@interface ABI18_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI18_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI18_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI18_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI18_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI18_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI18_0_0RCTResponseSenderBlock)callback)
{
...
ABI18_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI18_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI18_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI18_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI18_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI18_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI18_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI18_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI18_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI18_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI18_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI18_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI18_0_0RCTNullIfNil(height), ABI18_0_0RCTNullIfNil(width)]];
    return;
  }
        ...
        cancelCallback:(ABI18_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI18_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI18_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI18_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
