...
@interface ABI18_0_0RCTDecayAnimation ()
...
@implementation ABI18_0_0RCTDecayAnimation
{
  CGFloat _velocity;
...
{
  if ((self = [super init])) {
    NSNumber *iterations = [ABI18_0_0RCTConvert NSNumber:config[@"iterations"]] ?: @1;
    ...
    _velocity = [ABI18_0_0RCTConvert CGFloat:config[@"velocity"]];
    _deceleration = [ABI18_0_0RCTConvert CGFloat:config[@"deceleration"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  if (_frameStartTime == -1) {
    ...
    _frameStartTime = currentTime - ABI18_0_0RCTSingleFrameInterval;
