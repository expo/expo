...
@interface ABI18_0_0RCTSpringAnimation ()
...
@implementation ABI18_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
                  ...
                  callBack:(nullable ABI18_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _toValue = [ABI18_0_0RCTConvert CGFloat:config[@"toValue"]];
    _fromValue = valueNode.value;
    _valueNode = valueNode;
    _overshootClamping = [ABI18_0_0RCTConvert BOOL:config[@"overshootClamping"]];
    _restDisplacementThreshold = [ABI18_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
    _restSpeedThreshold = [ABI18_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
    _tension = [ABI18_0_0RCTConvert CGFloat:config[@"tension"]];
    _friction = [ABI18_0_0RCTConvert CGFloat:config[@"friction"]];
