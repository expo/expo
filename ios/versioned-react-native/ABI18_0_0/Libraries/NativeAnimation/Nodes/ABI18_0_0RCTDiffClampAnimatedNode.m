...
@implementation ABI18_0_0RCTDiffClampAnimatedNode
{
...
{
  ABI18_0_0RCTValueAnimatedNode *inputNode = (ABI18_0_0RCTValueAnimatedNode *)self.parentNodes[_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI18_0_0RCTValueAnimatedNode class]]) {
    ABI18_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
