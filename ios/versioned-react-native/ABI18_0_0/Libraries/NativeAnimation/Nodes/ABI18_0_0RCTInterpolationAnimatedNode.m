...
@implementation ABI18_0_0RCTInterpolationAnimatedNode
{
  __weak ABI18_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI18_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI18_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI18_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI18_0_0RCTInterpolateValueInRange(inputValue,
                                          _inputRange,
                                          _outputRange,
                                          _extrapolateLeft,
                                          _extrapolateRight);
