...
@interface ABI18_0_0RCTReconnectingWebSocket () <ABI18_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI18_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  __weak ABI18_0_0RCTSRWebSocket *socket = _socket;
