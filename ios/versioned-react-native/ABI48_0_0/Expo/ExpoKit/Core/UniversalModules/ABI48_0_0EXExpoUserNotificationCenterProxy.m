...
@interface ABI48_0_0EXExpoUserNotificationCenterProxy ()

@property (nonatomic, weak) id<ABI48_0_0EXUserNotificationCenterProxyInterface> userNotificationCenter;

@end

@implementation ABI48_0_0EXExpoUserNotificationCenterProxy
...
{
  return @[@protocol(ABI48_0_0EXUserNotificationCenterProxyInterface)];
}
