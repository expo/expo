...
@interface ABI48_0_0EXSecureStore (Protected)
...
@interface ABI48_0_0EXScopedSecureStore ()
...
@implementation ABI48_0_0EXScopedSecureStore
         ...
         withOptions:(NSDictionary *)options
{
  ...
  if (setValue) {
    ...
    ABI48_0_0EXLogWarn(@"Encountered an error while saving SecureStore data: %@.", [[super class] _messageForError:error]);
  }
}
