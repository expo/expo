...
@interface ABI48_0_0EXScopedNotificationBuilder ()
...
@implementation ABI48_0_0EXScopedNotificationBuilder
...
- (UNNotificationContent *)notificationContentFromRequest:(NSDictionary *)request
{
  ...
  if (content.categoryIdentifier && _isInExpoGo) {
    NSString *scopedCategoryIdentifier = [ABI48_0_0EXScopedNotificationsUtils scopedIdentifierFromId:content.categoryIdentifier
