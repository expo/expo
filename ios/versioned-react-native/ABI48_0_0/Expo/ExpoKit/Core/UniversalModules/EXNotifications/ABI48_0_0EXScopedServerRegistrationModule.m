...
@interface ABI48_0_0EXServerRegistrationModule (Protected)
...
@interface ABI48_0_0EXScopedServerRegistrationModule ()

@property (nonatomic, strong) NSString *scopeKey;

@end

@implementation ABI48_0_0EXScopedServerRegistrationModule
