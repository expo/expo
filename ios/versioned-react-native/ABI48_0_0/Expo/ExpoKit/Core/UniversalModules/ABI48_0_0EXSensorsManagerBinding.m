...
@interface ABI48_0_0EXSensorsManagerBinding ()

@property (nonatomic, strong) NSString *scopeKey;
@property (nonatomic, weak) id<ABI48_0_0EXSensorsManagerBindingDelegate> kernelService;

@end

@implementation ABI48_0_0EXSensorsManagerBinding
