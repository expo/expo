//
//  ABI48_0_0RNSharedElementTransitionItem.m
...
@implementation ABI48_0_0RNSharedElementTransitionItem {
...
- (void) setNode:(ABI48_0_0RNSharedElementNode *)node
{
  if (_node == node) {
...
- (CGRect) contentLayoutForContent:(ABI48_0_0RNSharedElementContent*)content
{
  ...
  return [ABI48_0_0RNSharedElementContent layoutForRect:_style.layout content:content contentMode:_style.contentMode reverse:NO];
}
