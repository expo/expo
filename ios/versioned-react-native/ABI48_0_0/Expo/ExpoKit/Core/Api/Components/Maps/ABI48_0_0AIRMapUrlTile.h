...
#import "ABI48_0_0AIRMapUrlTileCachedOverlay.h"

@interface ABI48_0_0AIRMapUrlTile : MKAnnotationView <MKOverlay> {
...
@property (nonatomic, strong) ABI48_0_0AIRMapUrlTileCachedOverlay *tileOverlay;
