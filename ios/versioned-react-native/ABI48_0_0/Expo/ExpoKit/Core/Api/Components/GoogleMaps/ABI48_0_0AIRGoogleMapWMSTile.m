//
//  ABI48_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI48_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI48_0_0WMSTileOverlay *tile = [[ABI48_0_0WMSTileOverlay alloc] init];
...
@implementation ABI48_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
