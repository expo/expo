//
//  ABI48_0_0AIRGoogleMapWMSTile.h
//  AirMaps
//
...
@interface ABI48_0_0WMSTileOverlay : GMSSyncTileLayer
...
@interface ABI48_0_0AIRGoogleMapWMSTile : UIView
@property (nonatomic, strong) ABI48_0_0WMSTileOverlay *tileLayer;
