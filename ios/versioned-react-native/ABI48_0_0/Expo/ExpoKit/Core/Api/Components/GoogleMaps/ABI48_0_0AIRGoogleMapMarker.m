...
@interface ABI48_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI48_0_0AIRGMSMarker*)marker;
@end

@implementation ABI48_0_0AIRGoogleMapMarker {
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI48_0_0AIRGMSMarker alloc] init];
...
- (void)insertABI48_0_0ReactSubview:(id<ABI48_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI48_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI48_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI48_0_0AIRDummyView *dummySubview = [[ABI48_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertABI48_0_0ReactSubview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeABI48_0_0ReactSubview:(id<ABI48_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI48_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeABI48_0_0ReactSubview:(UIView*)dummySubview];
}
...
- (ABI48_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/ABI48_0_0React-native-maps/ABI48_0_0React-native-maps/issues/738)
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI48_0_0RN?
...
- (void)setIconSrc:(NSString *)iconSrc
{
  ...
  if (!_realMarker.icon) {
    // prevent glitch with marker (cf. https://github.com/ABI48_0_0React-native-maps/ABI48_0_0React-native-maps/issues/3657)
    UIImage *emptyImage = [[UIImage alloc] init];
    _realMarker.icon = emptyImage;
  }

  _reloadImageCancellationBlock =
  [[_bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI48_0_0RCTConvert NSURLRequest:_iconSrc]
                                          size:self.bounds.size
                                         scale:ABI48_0_0RCTScreenScale()
                                       clipped:YES
                                    resizeMode:ABI48_0_0RCTResizeModeCenter
