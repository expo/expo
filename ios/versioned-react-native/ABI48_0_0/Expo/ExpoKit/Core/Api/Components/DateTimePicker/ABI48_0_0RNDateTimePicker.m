...
@interface ABI48_0_0RNDateTimePicker ()

@property (nonatomic, copy) ABI48_0_0RCTBubblingEventBlock onChange;
@property (nonatomic, copy) ABI48_0_0RCTBubblingEventBlock onPickerDismiss;
@property (nonatomic, assign) NSInteger ABI48_0_0ReactMinuteInterval;

@end

@implementation ABI48_0_0RNDateTimePicker

- (instancetype)initWithFrame:(CGRect)frame
{
  if ((self = [super initWithFrame:frame])) {
    #ifndef ABI48_0_0RCT_NEW_ARCH_ENABLED
      // somehow, with Fabric, the callbacks are executed here as well as in ABI48_0_0RNDateTimePickerComponentView
...
- (void)onDismiss:(ABI48_0_0RNDateTimePicker *)sender
{
  if (_onPickerDismiss) {
    _onPickerDismiss(@{});
  }
