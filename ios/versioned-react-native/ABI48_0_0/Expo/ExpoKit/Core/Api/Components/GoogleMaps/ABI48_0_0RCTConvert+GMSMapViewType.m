//
//  ABI48_0_0RCTConvert+GMSMapViewType.m
//
...
@implementation ABI48_0_0RCTConvert (GMSMapViewType)
  ABI48_0_0RCT_ENUM_CONVERTER(GMSMapViewType,
  (
    @{
...
+ (GMSCameraPosition*)GMSCameraPosition:(id)json
{
    ...
    return [ABI48_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:nil];
}
