...
#import "ABI48_0_0AIRMapManager.h"
...
#import "ABI48_0_0AIRMapSnapshot.h"
...
@interface ABI48_0_0AIRMapManager() <MKMapViewDelegate, UIGestureRecognizerDelegate>

- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer;

@end

@implementation ABI48_0_0AIRMapManager{
   BOOL _hasObserver;
}
...
- (UIView *)view
{
    ABI48_0_0AIRMap *map = [ABI48_0_0AIRMap new];
    map.delegate = self;
...
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(userLocationAnnotationTitle, NSString)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(userInterfaceStyle, NSString)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(userLocationCalloutEnabled, BOOL)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(showsPointsOfInterest, BOOL)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
...
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(maxDelta, CGFloat)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(minDelta, CGFloat)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(compassOffset, CGPoint)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(legalLabelInsets, UIEdgeInsets)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(mapPadding, UIEdgeInsets)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, MKMapType)
...
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(onDoublePress, ABI48_0_0RCTBubblingEventBlock)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerPress, ABI48_0_0RCTDirectEventBlock)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI48_0_0RCTDirectEventBlock)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI48_0_0RCTDirectEventBlock)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI48_0_0RCTDirectEventBlock)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI48_0_0RCTDirectEventBlock)
ABI48_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI48_0_0RCTDirectEventBlock)
...
ABI48_0_0RCT_CUSTOM_VIEW_PROPERTY(initialRegion, MKCoordinateRegion, ABI48_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setInitialRegion:[ABI48_0_0RCTConvert MKCoordinateRegion:json]];
    view.ignoreRegionChanges = originalIgnore;
}
ABI48_0_0RCT_CUSTOM_VIEW_PROPERTY(initialCamera, MKMapCamera, ABI48_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setInitialCamera:[ABI48_0_0RCTConvert MKMapCamera:json]];
    view.ignoreRegionChanges = originalIgnore;
}
...
ABI48_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI48_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setRegion:[ABI48_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}

ABI48_0_0RCT_CUSTOM_VIEW_PROPERTY(camera, MKMapCamera*, ABI48_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setCamera:[ABI48_0_0RCTConvert MKMapCamera:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}
                  ...
                  rejecter:(ABI48_0_0RCTPromiseRejectBlock)reject)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI48_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI48_0_0AIRMap class]]) {
                  ...
                  rejecter:(ABI48_0_0RCTPromiseRejectBlock)reject)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI48_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        id view = viewRegistry[ABI48_0_0ReactTag];
        ABI48_0_0AIRMap *mapView = (ABI48_0_0AIRMap *)view;
        if (![view isKindOfClass:[ABI48_0_0AIRMap class]]) {
            reject(@"Invalid argument", [NSString stringWithFormat:@"Invalid view returned from registry, expecting ABI48_0_0AIRMap, got: %@", view], NULL);
        } else {
                  ...
                  camera:(id)json)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI48_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI48_0_0AIRMap class]]) {
            ...
            MKMapCamera *camera = [ABI48_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:[mapView camera]];
                  ...
                  withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI48_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI48_0_0AIRMap class]]) {
            ...
            BOOL originalIgnore = mapView.ignoreRegionChanges;
            mapView.ignoreRegionChanges = YES;
            [ABI48_0_0AIRMap animateWithDuration:duration/1000 animations:^{
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI48_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI48_0_0AIRMap class]]) {
            ...
            [ABI48_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI48_0_0AIRMap *)view setRegion:region animated:YES];
            }];
        }
    }];
}
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI48_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI48_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ABI48_0_0AIRMapMarker *marker = (ABI48_0_0AIRMapMarker *)evaluatedObject;
                return [marker isKindOfClass:[ABI48_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
...
ABI48_0_0RCT_EXPORT_METHOD(getAddressFromCoordinates:(nonnull NSNumber *)ABI48_0_0ReactTag
                                 coordinate: (NSDictionary *)coordinate
                                   resolver: (ABI48_0_0RCTPromiseResolveBlock)resolve
                                   rejecter:(ABI48_0_0RCTPromiseRejectBlock)reject)
{
...
- (void)takeMapSnapshot:(ABI48_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI48_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI48_0_0AIRMap *map = (ABI48_0_0AIRMap *)recognizer.view;
    ...
    ABI48_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI48_0_0AIRMapPolygon class]]){
            ABI48_0_0AIRMapPolygon *polygon = (ABI48_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI48_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI48_0_0AIRMapPolyline class]]){
            ABI48_0_0AIRMapPolyline *polyline = (ABI48_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
        ...
        if ([overlay isKindOfClass:[ABI48_0_0AIRMapOverlay class]]) {
            ABI48_0_0AIRMapOverlay *imageOverlay = (ABI48_0_0AIRMapOverlay*) overlay;
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI48_0_0AIRMapPolyline class]]) {
        return ((ABI48_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI48_0_0AIRMapPolygon class]]) {
        return ((ABI48_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI48_0_0AIRMapCircle class]]) {
        return ((ABI48_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI48_0_0AIRMapUrlTile class]]) {
        return ((ABI48_0_0AIRMapUrlTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI48_0_0AIRMapWMSTile class]]) {
        return ((ABI48_0_0AIRMapWMSTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI48_0_0AIRMapLocalTile class]]) {
        return ((ABI48_0_0AIRMapLocalTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI48_0_0AIRMapOverlay class]]) {
        return ((ABI48_0_0AIRMapOverlay *)overlay).renderer;
...
- (void)mapView:(ABI48_0_0AIRMap *)mapView didAddAnnotationViews:(NSArray<MKAnnotationView *> *)views
{
...
- (void)mapView:(ABI48_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI48_0_0AIRMapMarker class]]) {
        [(ABI48_0_0AIRMapMarker *)view.annotation showCalloutView];
...
- (void)mapView:(ABI48_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI48_0_0AIRMapMarker class]]) {
        [(ABI48_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI48_0_0AIRMap *)mapView viewForAnnotation:(ABI48_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI48_0_0AIRMapMarker class]]) {
...
- (void)mapView:(ABI48_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI48_0_0AIRMapMarker class]]) return;
    ABI48_0_0AIRMapMarker *marker = (ABI48_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI48_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI48_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    id event = @{@"coordinate": @{
    ...
    if (mapView.followUserLocation) {
        ...
        region.span.latitudeDelta = ABI48_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI48_0_0AIRMapDefaultSpan;
...
- (void)mapViewDidChangeVisibleRegion:(ABI48_0_0AIRMap *)mapView
{
    [self _regionChanged:mapView];
}

- (void)mapView:(ABI48_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI48_0_0AIRMap *)mapView
{
    if (!mapView.hasStartedRendering) {
      mapView.onMapReady(@{});
...
- (void)mapViewDidFinishRenderingMap:(ABI48_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
- (void)_regionChanged:(ABI48_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI48_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI48_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI48_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI48_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI48_0_0AIRMap *)mapView
{
...
- (MKCoordinateSpan)coordinateSpanWithMapView:(ABI48_0_0AIRMap *)mapView
                             centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                 andZoomLevel:(double)zoomLevel
{
    // convert center coordiate to pixel space
    double centerPixelX = [ABI48_0_0AIRMapManager longitudeToPixelSpaceX:centerCoordinate.longitude];
    double centerPixelY = [ABI48_0_0AIRMapManager latitudeToPixelSpaceY:centerCoordinate.latitude];

    // determine the scale value from the zoom level
    double zoomExponent = ABI48_0_0AIRMapMaxZoomLevel - zoomLevel;
    ...
    CLLocationDegrees minLng = [ABI48_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX];
    CLLocationDegrees maxLng = [ABI48_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX + scaledMapWidth];
    CLLocationDegrees longitudeDelta = maxLng - minLng;

    // find delta between top and bottom latitudes
    CLLocationDegrees minLat = [ABI48_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY];
    CLLocationDegrees maxLat = [ABI48_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY + scaledMapHeight];
...
- (void)setCenterCoordinate:(CLLocationCoordinate2D)centerCoordinate
                  zoomLevel:(double)zoomLevel
                   animated:(BOOL)animated
                    mapView:(ABI48_0_0AIRMap *)mapView
{
    // clamp large numbers to 28
    zoomLevel = MIN(zoomLevel, ABI48_0_0AIRMapMaxZoomLevel);
...
-(MKCoordinateRegion)coordinateRegionWithMapView:(ABI48_0_0AIRMap *)mapView
                                centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                    andZoomLevel:(double)zoomLevel
{
	...
	// find delta between top and bottom latitudes
	CLLocationDegrees minLat = [ABI48_0_0AIRMapManager pixelSpaceYToLatitude:topPixelY];
	CLLocationDegrees maxLat = [ABI48_0_0AIRMapManager pixelSpaceYToLatitude:bottomPixelY];
	CLLocationDegrees latitudeDelta = -1 * (maxLat - minLat);
	...
	if (adjustedCenterPoint) {
		region.center.latitude = [ABI48_0_0AIRMapManager pixelSpaceYToLatitude:((bottomPixelY + topPixelY) / 2.0)];
	}

	return region;
}

- (double) zoomLevel:(ABI48_0_0AIRMap *)mapView {
    MKCoordinateRegion region = mapView.region;

    double centerPixelX = [ABI48_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude];
    double topLeftPixelX = [ABI48_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude - region.span.longitudeDelta / 2];

    double scaledMapWidth = (centerPixelX - topLeftPixelX) * 2;
    CGSize mapSizeInPixels = mapView.bounds.size;
    double zoomScale = scaledMapWidth / mapSizeInPixels.width;
    double zoomExponent = log(zoomScale) / log(2);
    double zoomLevel = ABI48_0_0AIRMapMaxZoomLevel - zoomExponent;
...
- (void)mapView:(ABI48_0_0AIRMap *)mapView didFailToLocateUserWithError:(NSError *)error {
