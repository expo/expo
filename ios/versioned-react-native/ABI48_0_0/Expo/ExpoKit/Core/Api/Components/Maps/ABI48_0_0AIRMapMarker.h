...
@interface ABI48_0_0AIRMapMarker : MKAnnotationView <MKAnnotation>

@property (nonatomic, strong) ABI48_0_0AIRMapCallout *calloutView;
...
@property (nonatomic, copy) ABI48_0_0RCTDirectEventBlock onSelect;
@property (nonatomic, copy) ABI48_0_0RCTDirectEventBlock onDeselect;
...
- (void)fillCalloutView:(ABI48_0_0SMCalloutView *)calloutView;
...
@interface ABI48_0_0AIREmptyCalloutBackgroundView : ABI48_0_0SMCalloutBackgroundView
@end
