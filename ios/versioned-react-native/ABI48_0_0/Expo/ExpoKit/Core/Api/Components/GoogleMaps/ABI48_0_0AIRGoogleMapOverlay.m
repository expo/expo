//
//  ABI48_0_0AIRGoogleMapOverlay.m
...
@interface ABI48_0_0AIRGoogleMapOverlay()
...
@implementation ABI48_0_0AIRGoogleMapOverlay {
  ABI48_0_0RCTImageLoaderCancellationBlock _reloadImageCancellationBlock;
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  _reloadImageCancellationBlock = [[_bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI48_0_0RCTConvert NSURLRequest:_imageSrc]
                                                                          size:weakSelf.bounds.size
                                                                         scale:ABI48_0_0RCTScreenScale()
                                                                       clipped:YES
                                                                    resizeMode:ABI48_0_0RCTResizeModeCenter
                                                                 progressBlock:nil
