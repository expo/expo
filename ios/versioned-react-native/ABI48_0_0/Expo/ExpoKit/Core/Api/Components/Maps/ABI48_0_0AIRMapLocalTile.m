...
#import "ABI48_0_0AIRMapLocalTileOverlay.h"

@implementation ABI48_0_0AIRMapLocalTile {
...
- (void) createTileOverlayAndRendererIfPossible
{
    ...
    self.tileOverlay = [[ABI48_0_0AIRMapLocalTileOverlay alloc] initWithURLTemplate:self.pathTemplate];
