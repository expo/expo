...
Pod::Spec.new do |s|
  s.name                   = "ABI48_0_0ReactCommon"
  s.module_name            = "ABI48_0_0ReactCommon"
  s.version                = version
  s.summary                = "-"  # TODO
  ...
  s.source                 = { :path => "." }
  s.header_dir             = "ABI48_0_0ReactCommon" # Use global header_dir for all subspecs for use_frameworks! compatibility
  s.compiler_flags         = folly_compiler_flags + ' ' + boost_compiler_flags
  s.pod_target_xcconfig    = { "HEADER_SEARCH_PATHS" => "\"$(PODS_ROOT)/boost\" \"$(PODS_ROOT)/RCT-Folly\" \"$(PODS_ROOT)/DoubleConversion\" \"$(PODS_ROOT)/Headers/Private/ABI48_0_0React-Core\"",
  ...
  s.subspec "turbomodule" do |ss|
    ss.dependency "ABI48_0_0React-callinvoker", version
    ss.dependency "ABI48_0_0React-perflogger", version
    ss.dependency "ABI48_0_0React-Core", version
    ss.dependency "ABI48_0_0React-cxxreact", version
    ss.dependency "ABI48_0_0React-jsi", version
    ss.dependency "RCT-Folly", folly_version
    s.dependency "ABI48_0_0React-logger", version
    ss.dependency "DoubleConversion"
    ss.dependency "glog"
    if using_hermes
      ss.dependency "ABI48_0_0hermes-engine"
    end

    ss.subspec "bridging" do |sss|
      sss.dependency           "ABI48_0_0React-jsi", version
      sss.source_files         = "react/bridging/**/*.{cpp,h}"
      sss.exclude_files        = "react/bridging/tests"
      sss.header_dir           = "ABI48_0_0react/bridging"
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/RCT-Folly\"" }
      if using_hermes
        sss.dependency "ABI48_0_0hermes-engine"
      end
    end
    ...
    ss.subspec "samples" do |sss|
      ...
      sss.dependency "ABI48_0_0ReactCommon/turbomodule/core", version
    end
  end
end
