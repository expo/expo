...
#include <hermes/ABI48_0_0DebuggerAPI.h>
#include <hermes/ABI48_0_0hermes.h>
#include <hermes/inspector/ABI48_0_0AsyncPauseState.h>
...
class InspectorObserver {
 public:
  ...
  virtual void onBreakpointResolved(
      Inspector &inspector,
      const ABI48_0_0facebook::ABI48_0_0hermes::debugger::BreakpointInfo &info) = 0;
  ...
  virtual void onPause(
      Inspector &inspector,
      const ABI48_0_0facebook::ABI48_0_0hermes::debugger::ProgramState &state) = 0;
 ...
 * debugging API.
 */
class Inspector : public ABI48_0_0facebook::ABI48_0_0hermes::debugger::EventObserver,
 ...
 public:
  ...
  folly::Future<folly::Unit> executeIfEnabled(
      ...
      folly::Function<void(const ABI48_0_0facebook::ABI48_0_0hermes::debugger::ProgramState &)>
          func);
   ...
   * execution.
   */
  folly::Future<ABI48_0_0facebook::ABI48_0_0hermes::debugger::BreakpointInfo> setBreakpoint(
      ABI48_0_0facebook::ABI48_0_0hermes::debugger::SourceLocation loc,
      folly::Optional<std::string> condition = folly::none);

  folly::Future<folly::Unit> removeBreakpoint(
      ABI48_0_0facebook::ABI48_0_0hermes::debugger::BreakpointID loc);
   ...
   * otherwise.
   */
  folly::Future<ABI48_0_0facebook::ABI48_0_0hermes::debugger::EvalResult> evaluate(
      uint32_t frameIndex,
  ...
  folly::Future<folly::Unit> setPauseOnExceptions(
      const ABI48_0_0facebook::ABI48_0_0hermes::debugger::PauseOnThrowMode &mode);
   ...
   * on the JS thread.
   */
  ABI48_0_0facebook::ABI48_0_0hermes::debugger::Command didPause(
      ABI48_0_0facebook::ABI48_0_0hermes::debugger::Debugger &debugger) override;

  /**
   * breakpointResolved implements the breakpointResolved callback from Hermes.
   */
  void breakpointResolved(
      ABI48_0_0facebook::ABI48_0_0hermes::debugger::Debugger &debugger,
      ABI48_0_0facebook::ABI48_0_0hermes::debugger::BreakpointID breakpointId) override;
 ...
 private:
  ...
  void setBreakpointOnExecutor(
      ...
      std::shared_ptr<
          folly::Promise<ABI48_0_0facebook::ABI48_0_0hermes::debugger::BreakpointInfo>> promise);
  ...
  void setPendingCommandOnExecutor(
      ABI48_0_0facebook::ABI48_0_0hermes::debugger::Command command,
      std::shared_ptr<folly::Promise<folly::Unit>> promise);
  ...
  ABI48_0_0facebook::ABI48_0_0hermes::debugger::Debugger &debugger_;
