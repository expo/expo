...
#include <hermes/inspector/ABI48_0_0Exceptions.h>
...
using CommandPtr = std::unique_ptr<ABI48_0_0facebook::ABI48_0_0hermes::debugger::Command>;
...
class InspectorState {
 public:
  ...
  virtual void pushPendingEval(
      ...
      std::shared_ptr<folly::Promise<ABI48_0_0facebook::ABI48_0_0hermes::debugger::EvalResult>>
          promise,
      folly::Function<void(const ABI48_0_0facebook::ABI48_0_0hermes::debugger::EvalResult &)>
          resultTransformer) {
 ...
 * JS. For instance, ABI48_0_0React Native could be blocked in a native message queue
