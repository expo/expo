...
#include "ABI48_0_0MessageConverters.h"
...
namespace h = ::ABI48_0_0facebook::ABI48_0_0hermes;
...
m::debugger::CallFrame m::debugger::makeCallFrame(
    ...
    jsi::Runtime &runtime,
    const ABI48_0_0facebook::ABI48_0_0hermes::debugger::ProgramState &state) {
...
std::vector<m::runtime::CallFrame> m::runtime::makeCallFrames(
    const ABI48_0_0facebook::ABI48_0_0hermes::debugger::StackTrace &stackTrace) {
