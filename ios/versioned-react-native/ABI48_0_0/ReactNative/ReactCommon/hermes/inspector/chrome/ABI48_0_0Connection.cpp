...
#include <hermes/inspector/ABI48_0_0Inspector.h>
#include <hermes/inspector/chrome/ABI48_0_0MessageConverters.h>
#include <hermes/inspector/chrome/ABI48_0_0RemoteObjectsTable.h>
#include <hermes/inspector/detail/ABI48_0_0CallbackOStream.h>
#include <hermes/inspector/detail/ABI48_0_0SerialExecutor.h>
#include <hermes/inspector/detail/ABI48_0_0Thread.h>
#include <ABI48_0_0jsi/ABI48_0_0instrumentation.h>
...
using ::ABI48_0_0facebook::ABI48_0_0React::ILocalConnection;
using ::ABI48_0_0facebook::ABI48_0_0React::IRemoteConnection;
using ::folly::Unit;

namespace debugger = ::ABI48_0_0facebook::ABI48_0_0hermes::debugger;
namespace inspector = ::ABI48_0_0facebook::ABI48_0_0hermes::inspector;
namespace m = ::ABI48_0_0facebook::ABI48_0_0hermes::inspector::chrome::message;
...
void Connection::Impl::onMessageAdded(
    ABI48_0_0facebook::ABI48_0_0hermes::inspector::Inspector &inspector,
      ...
      ->evaluate(
          ...
          [this,
           ...
           byValue = req.returnByValue.value_or(false)](
              const ABI48_0_0facebook::ABI48_0_0hermes::debugger::EvalResult
                  &evalResult) mutable {
...
class CallFunctionOnRunner {
 public:
  ...
  // N.B.: constexpr char[] broke ABI48_0_0React-native-oss-android.
  ...
  jsi::Value operator()(
      jsi::Runtime &rt,
      RemoteObjectsTable &objTable,
      const ABI48_0_0facebook::ABI48_0_0hermes::debugger::EvalResult &evalResult) {
  ...
  inspector_
      ->evaluate(
          ...
          [this,
           ...
           byValue = req.returnByValue.value_or(false),
           runner =
               std::move(runner)](const ABI48_0_0facebook::ABI48_0_0hermes::debugger::EvalResult
                                      &evalResult) mutable {
  ...
  inspector_
      ->executeIfEnabled(
          ...
          [this, req, resp](const debugger::ProgramState &state) {
            ...
            } catch (const ABI48_0_0facebook::jsi::JSIException &err) {
