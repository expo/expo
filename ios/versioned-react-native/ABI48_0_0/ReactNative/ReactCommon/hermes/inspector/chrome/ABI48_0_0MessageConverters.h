...
#include <hermes/inspector/chrome/ABI48_0_0MessageTypes.h>
...
void setHermesLocation(
    ABI48_0_0facebook::ABI48_0_0hermes::debugger::SourceLocation &hermesLoc,
    const T &chromeLoc,
  ...
  if (chromeLoc.columnNumber.hasValue()) {
    if (chromeLoc.columnNumber.value() == 0) {
      ...
      hermesLoc.column = ::ABI48_0_0facebook::ABI48_0_0hermes::debugger::kInvalidLocation;
    } else {
...
void setChromeLocation(
    T &chromeLoc,
    const ABI48_0_0facebook::ABI48_0_0hermes::debugger::SourceLocation &hermesLoc) {
  if (hermesLoc.line != ABI48_0_0facebook::ABI48_0_0hermes::debugger::kInvalidLocation) {
    chromeLoc.lineNumber = hermesLoc.line - 1;
  }

  if (hermesLoc.column != ABI48_0_0facebook::ABI48_0_0hermes::debugger::kInvalidLocation) {
...
Location makeLocation(const ABI48_0_0facebook::ABI48_0_0hermes::debugger::SourceLocation &loc);

CallFrame makeCallFrame(
    uint32_t callFrameIndex,
    const ABI48_0_0facebook::ABI48_0_0hermes::debugger::CallFrameInfo &callFrameInfo,
    const ABI48_0_0facebook::ABI48_0_0hermes::debugger::LexicalInfo &lexicalInfo,
    ABI48_0_0facebook::ABI48_0_0hermes::inspector::chrome::RemoteObjectsTable &objTable,
    jsi::Runtime &runtime,
...
CallFrame makeCallFrame(const ABI48_0_0facebook::ABI48_0_0hermes::debugger::CallFrameInfo &info);

std::vector<CallFrame> makeCallFrames(
    const ABI48_0_0facebook::ABI48_0_0hermes::debugger::StackTrace &stackTrace);

ExceptionDetails makeExceptionDetails(
    const ABI48_0_0facebook::ABI48_0_0hermes::debugger::ExceptionDetails &details);
