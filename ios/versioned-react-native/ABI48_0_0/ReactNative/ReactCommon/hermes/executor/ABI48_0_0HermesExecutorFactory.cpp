...
#include "ABI48_0_0HermesExecutorFactory.h"
...
#include <ABI48_0_0jsi/ABI48_0_0decorator.h>
...
#include "ABI48_0_0JSITracing.h"

using namespace ABI48_0_0facebook::ABI48_0_0hermes;
...
std::unique_ptr<HermesRuntime> makeHermesRuntimeSystraced(
    const ::ABI48_0_0hermes::vm::RuntimeConfig &runtimeConfig) {
  SystraceSection s("HermesExecutorFactory::makeHermesRuntimeSystraced");
  return ABI48_0_0hermes::makeHermesRuntime(runtimeConfig);
}

#ifdef HERMES_ENABLE_DEBUGGER

class HermesExecutorRuntimeAdapter
    : public ABI48_0_0facebook::ABI48_0_0hermes::inspector::RuntimeAdapter {
 public:
...
class DecoratedRuntime : public jsi::WithRuntimeDecorator<ReentrancyCheck> {
 public:
  ...
  DecoratedRuntime(
    ...
    if (enableDebugger_) {
      ...
      debugToken_ = ABI48_0_0facebook::ABI48_0_0hermes::inspector::chrome::enableDebugging(
...
#ifdef HERMES_ENABLE_DEBUGGER
    if (enableDebugger_) {
      ABI48_0_0facebook::ABI48_0_0hermes::inspector::chrome::disableDebugging(debugToken_);
    }
#endif
  }
 ...
 private:
  ...
  ABI48_0_0facebook::ABI48_0_0hermes::inspector::chrome::DebugSessionToken debugToken_;
#endif
};
...
::ABI48_0_0hermes::vm::RuntimeConfig HermesExecutorFactory::defaultRuntimeConfig() {
  return ::ABI48_0_0hermes::vm::RuntimeConfig::Builder()
