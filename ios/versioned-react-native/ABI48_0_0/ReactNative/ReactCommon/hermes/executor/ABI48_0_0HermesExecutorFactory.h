...
class HermesExecutorFactory : public JSExecutorFactory {
 public:
  explicit HermesExecutorFactory(
      ...
      ::ABI48_0_0hermes::vm::RuntimeConfig runtimeConfig = defaultRuntimeConfig())
 ...
 private:
  static ::ABI48_0_0hermes::vm::RuntimeConfig defaultRuntimeConfig();

  JSIExecutor::RuntimeInstaller runtimeInstaller_;
  JSIScopedTimeoutInvoker timeoutInvoker_;
  ::ABI48_0_0hermes::vm::RuntimeConfig runtimeConfig_;
  bool enableDebugger_ = true;
  std::string debuggerName_ = "Hermes ABI48_0_0React Native";
};
