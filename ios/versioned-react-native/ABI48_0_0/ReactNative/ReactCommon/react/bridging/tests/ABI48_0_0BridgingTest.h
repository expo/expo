...
#include <ABI48_0_0React/bridging/ABI48_0_0Bridging.h>

#define ABI48_0_0EXPECT_JSI_THROW(expr) ABI48_0_0EXPECT_THROW((expr), ABI48_0_0facebook::jsi::JSIException)
 ...
 protected:
  BridgingTest()
      : invoker(std::make_shared<TestCallInvoker>()),
        runtime(ABI48_0_0hermes::makeHermesRuntime(
            ::ABI48_0_0hermes::vm::RuntimeConfig::Builder()
  ...
  void TearDown() override {
    ...
    ABI48_0_0EXPECT_EQ(0, LongLivedObjectCollection::get().size());
  }
