...
#include <ABI48_0_0React/ABI48_0_0utils/SimpleThreadSafeCache.h>
...
template <>
struct hash<ABI48_0_0facebook::ABI48_0_0React::TextMeasureCacheKey> {
  size_t operator()(ABI48_0_0facebook::ABI48_0_0React::TextMeasureCacheKey const &key) const {
    return folly::hash::hash_combine(
        0,
