...
#include <ABI48_0_0React/ABI48_0_0common/mapbuffer/JReadableMapBuffer.h>
...
Size measureAndroidComponent(
  ...
  static auto measure =
      jni::findClassStatic("com/facebook/ABI48_0_0React/fabric/FabricUIManager")
          ->getMethod<jlong(
              jint,
              jstring,
  ...
  if (attachmentsCount > 0) {
    ...
    for (auto const &fragment : fragments) {
      ...
      if (isAttachment != fragment.items().end() &&
        ...
        auto rect = ABI48_0_0facebook::ABI48_0_0React::Rect{
            {left, top}, ABI48_0_0facebook::ABI48_0_0React::Size{width, height}};
