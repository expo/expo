...
#import "ABI48_0_0RCTFontUtils.h"
...
static ABI48_0_0RCTFontProperties ABI48_0_0RCTDefaultFontProperties()
{
  static ABI48_0_0RCTFontProperties defaultFontProperties;
  ...
  dispatch_once(&onceToken, ^{
    ...
    defaultFontProperties.style = ABI48_0_0RCTFontStyleNormal;
    defaultFontProperties.variant = ABI48_0_0RCTFontVariantDefault;
...
static ABI48_0_0RCTFontProperties ABI48_0_0RCTResolveFontProperties(
    ABI48_0_0RCTFontProperties fontProperties,
    ABI48_0_0RCTFontProperties baseFontProperties)
{
  ...
  fontProperties.style =
      fontProperties.style != ABI48_0_0RCTFontStyleUndefined ? fontProperties.style : baseFontProperties.style;
  fontProperties.variant =
      fontProperties.variant != ABI48_0_0RCTFontVariantUndefined ? fontProperties.variant : baseFontProperties.variant;
  return fontProperties;
}

static UIFontWeight ABI48_0_0RCTGetFontWeight(UIFont *font)
{
  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  return [traits[UIFontWeightTrait] doubleValue];
}

static ABI48_0_0RCTFontStyle ABI48_0_0RCTGetFontStyle(UIFont *font)
{
  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
...
static NSArray *ABI48_0_0RCTFontFeatures(ABI48_0_0RCTFontVariant fontVariant)
{
  // FIXME:
  return @[];
}

static UIFont *ABI48_0_0RCTDefaultFontWithFontProperties(ABI48_0_0RCTFontProperties fontProperties)
{
  ...
  if (!font) {
    ...
    if (fontProperties.variant == ABI48_0_0RCTFontStyleItalic) {
...
UIFont *ABI48_0_0RCTFontWithFontProperties(ABI48_0_0RCTFontProperties fontProperties)
{
  ABI48_0_0RCTFontProperties defaultFontProperties = ABI48_0_0RCTDefaultFontProperties();
  fontProperties = ABI48_0_0RCTResolveFontProperties(fontProperties, defaultFontProperties);
  ...
  if ([fontProperties.family isEqualToString:defaultFontProperties.family]) {
    ...
    font = ABI48_0_0RCTDefaultFontWithFontProperties(fontProperties);
  } else {
    ...
    if (fontNames.count == 0) {
      ...
      for (NSString *name in fontNames) {
        ...
        if (ABI48_0_0RCTGetFontStyle(fontMatch) != fontProperties.style) {
          continue;
        }

        CGFloat testWeight = ABI48_0_0RCTGetFontWeight(fontMatch);
  ...
  if (fontProperties.variant != ABI48_0_0RCTFontVariantDefault) {
    NSArray *fontFeatures = ABI48_0_0RCTFontFeatures(fontProperties.variant);
    UIFontDescriptor *fontDescriptor = [font.fontDescriptor
