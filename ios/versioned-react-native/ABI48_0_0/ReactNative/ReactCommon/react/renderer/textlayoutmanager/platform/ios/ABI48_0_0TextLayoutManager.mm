...
#import "ABI48_0_0RCTTextLayoutManager.h"
...
{
  self_ = wrapManagedObject([ABI48_0_0RCTTextLayoutManager new]);
}
...
{
  ABI48_0_0RCTTextLayoutManager *textLayoutManager = (ABI48_0_0RCTTextLayoutManager *)unwrapManagedObject(self_);
