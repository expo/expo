...
#include <ABI48_0_0React/ABI48_0_0renderer/graphics/ABI48_0_0RCTPlatformColorUtils.h>
...
inline ColorComponents parsePlatformColor(
  ...
  if (value.hasType<butter::map<std::string, RawValue>>()) {
    ...
    if (items.find("semantic") != items.end() &&
      ...
      return ABI48_0_0RCTPlatformColorComponentsFromSemanticItems(semanticItems);
    }
  }
