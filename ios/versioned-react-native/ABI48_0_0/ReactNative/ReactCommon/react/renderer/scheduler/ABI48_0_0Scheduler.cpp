...
#include <ABI48_0_0React/ABI48_0_0renderer/templateprocessor/UITemplateProcessor.h>
...
#include <ABI48_0_0React/ABI48_0_0renderer/mounting/stubs.h>
#include <iostream>
#endif
...
Scheduler::Scheduler(
  ...
  ABI48_0_0ReactNativeConfig_ =
      contextContainer_->at<std::shared_ptr<const ABI48_0_0ReactNativeConfig>>(
...
#else
  removeOutstandingSurfacesOnDestruction_ = ABI48_0_0ReactNativeConfig_->getBool(
      "ABI48_0_0React_fabric:remove_outstanding_surfaces_on_destruction_ios");
#endif
}
...
void Scheduler::renderTemplateToSurface(
  ...
  try {
    ...
    LOG(ERROR) << "    >>>> ABI48_0_0EXCEPTION <<<  rendering uiTemplate in "
