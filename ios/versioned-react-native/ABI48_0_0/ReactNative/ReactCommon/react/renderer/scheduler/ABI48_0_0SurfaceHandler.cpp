...
#include "ABI48_0_0SurfaceHandler.h"
...
#include <ABI48_0_0React/ABI48_0_0renderer/scheduler/Scheduler.h>
...
void SurfaceHandler::stop() const noexcept {
  ...
  ABI48_0_0React_native_assert(shadowTree && "`shadowTree` must not be null.");
