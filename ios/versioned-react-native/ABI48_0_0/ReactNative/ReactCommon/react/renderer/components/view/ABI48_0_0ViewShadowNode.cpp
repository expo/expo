...
#include "ABI48_0_0ViewShadowNode.h"
#include <ABI48_0_0React/ABI48_0_0config/ABI48_0_0ReactNativeConfig.h>
#include <ABI48_0_0React/ABI48_0_0renderer/components/view/primitives.h>
...
void ViewShadowNode::initialize() noexcept {
  ...
  bool formsStackingContext = !viewProps.collapsable ||
      ...
      (viewProps.zIndex.has_value() &&
       viewProps.yogaStyle.positionType() != ABI48_0_0YGPositionTypeStatic) ||
      viewProps.yogaStyle.display() == ABI48_0_0YGDisplayNone ||
  ...
  bool formsView = formsStackingContext ||
      ...
      !(viewProps.yogaStyle.border() == ABI48_0_0YGStyle::Edges{}) ||
