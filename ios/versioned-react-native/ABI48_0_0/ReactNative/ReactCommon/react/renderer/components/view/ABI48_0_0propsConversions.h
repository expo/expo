...
static inline ABI48_0_0YGStyle::Dimensions convertRawProp(
    const PropsParserContext &context,
    RawProps const &rawProps,
    char const *widthName,
    char const *heightName,
    ABI48_0_0YGStyle::Dimensions const &sourceValue,
    ABI48_0_0YGStyle::Dimensions const &defaultValue) {
  auto dimensions = defaultValue;
  dimensions[ABI48_0_0YGDimensionWidth] = convertRawProp(
      context,
      rawProps,
      widthName,
      sourceValue[ABI48_0_0YGDimensionWidth],
      defaultValue[ABI48_0_0YGDimensionWidth]);
  dimensions[ABI48_0_0YGDimensionHeight] = convertRawProp(
      context,
      rawProps,
      heightName,
      sourceValue[ABI48_0_0YGDimensionHeight],
      defaultValue[ABI48_0_0YGDimensionHeight]);
  return dimensions;
}

static inline ABI48_0_0YGStyle::Edges convertRawProp(
    const PropsParserContext &context,
    RawProps const &rawProps,
    char const *prefix,
    char const *suffix,
    ABI48_0_0YGStyle::Edges const &sourceValue,
    ABI48_0_0YGStyle::Edges const &defaultValue) {
  auto result = defaultValue;
  result[ABI48_0_0YGEdgeLeft] = convertRawProp(
      context,
      rawProps,
      "Left",
      sourceValue[ABI48_0_0YGEdgeLeft],
      defaultValue[ABI48_0_0YGEdgeLeft],
      prefix,
      suffix);
  result[ABI48_0_0YGEdgeTop] = convertRawProp(
      context,
      rawProps,
      "Top",
      sourceValue[ABI48_0_0YGEdgeTop],
      defaultValue[ABI48_0_0YGEdgeTop],
      prefix,
      suffix);
  result[ABI48_0_0YGEdgeRight] = convertRawProp(
      context,
      rawProps,
      "Right",
      sourceValue[ABI48_0_0YGEdgeRight],
      defaultValue[ABI48_0_0YGEdgeRight],
      prefix,
      suffix);
  result[ABI48_0_0YGEdgeBottom] = convertRawProp(
      context,
      rawProps,
      "Bottom",
      sourceValue[ABI48_0_0YGEdgeBottom],
      defaultValue[ABI48_0_0YGEdgeBottom],
      prefix,
      suffix);
  result[ABI48_0_0YGEdgeStart] = convertRawProp(
      context,
      rawProps,
      "Start",
      sourceValue[ABI48_0_0YGEdgeStart],
      defaultValue[ABI48_0_0YGEdgeStart],
      prefix,
      suffix);
  result[ABI48_0_0YGEdgeEnd] = convertRawProp(
      context,
      rawProps,
      "End",
      sourceValue[ABI48_0_0YGEdgeEnd],
      defaultValue[ABI48_0_0YGEdgeEnd],
      prefix,
      suffix);
  result[ABI48_0_0YGEdgeHorizontal] = convertRawProp(
      context,
      rawProps,
      "Horizontal",
      sourceValue[ABI48_0_0YGEdgeHorizontal],
      defaultValue[ABI48_0_0YGEdgeHorizontal],
      prefix,
      suffix);
  result[ABI48_0_0YGEdgeVertical] = convertRawProp(
      context,
      rawProps,
      "Vertical",
      sourceValue[ABI48_0_0YGEdgeVertical],
      defaultValue[ABI48_0_0YGEdgeVertical],
      prefix,
      suffix);
  result[ABI48_0_0YGEdgeAll] = convertRawProp(
      context,
      rawProps,
      "",
      sourceValue[ABI48_0_0YGEdgeAll],
      defaultValue[ABI48_0_0YGEdgeAll],
      prefix,
      suffix);
  return result;
}
...
static inline ABI48_0_0YGStyle convertRawProp(
    const PropsParserContext &context,
    RawProps const &rawProps,
    ABI48_0_0YGStyle const &sourceValue) {
  auto yogaStyle = ABI48_0_0YGStyle{};
  ...
  yogaStyle.gap()[ABI48_0_0YGGutterRow] = convertRawProp(
      context,
      rawProps,
      "rowGap",
      sourceValue.gap()[ABI48_0_0YGGutterRow],
      yogaStyle.gap()[ABI48_0_0YGGutterRow]);

  yogaStyle.gap()[ABI48_0_0YGGutterColumn] = convertRawProp(
      context,
      rawProps,
      "columnGap",
      sourceValue.gap()[ABI48_0_0YGGutterColumn],
      yogaStyle.gap()[ABI48_0_0YGGutterColumn]);

  yogaStyle.gap()[ABI48_0_0YGGutterAll] = convertRawProp(
      context,
      rawProps,
      "gap",
      sourceValue.gap()[ABI48_0_0YGGutterAll],
