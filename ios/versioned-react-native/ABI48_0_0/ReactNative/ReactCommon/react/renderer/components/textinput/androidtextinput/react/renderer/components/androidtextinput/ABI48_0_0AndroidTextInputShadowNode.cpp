...
AttributedString AndroidTextInputShadowNode::getMostRecentAttributedString()
  ...
  auto ABI48_0_0ReactTreeAttributedString = getAttributedString();
  ...
  bool treeAttributedStringChanged =
      !state.ABI48_0_0ReactTreeAttributedString.compareTextAttributesWithoutFrame(
          ABI48_0_0ReactTreeAttributedString);
...
void AndroidTextInputShadowNode::updateStateIfNeeded() {
  ...
  auto newEventCount =
      state.ABI48_0_0ReactTreeAttributedString.isContentEqual(ABI48_0_0ReactTreeAttributedString)
      ? 0
