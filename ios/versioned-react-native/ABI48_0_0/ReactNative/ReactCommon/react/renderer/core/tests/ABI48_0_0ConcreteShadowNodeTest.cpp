...
TEST(ConcreteShadowNodeTest, testSetStateData) {
  ...
  ABI48_0_0EXPECT_EQ(stateData.contentOffset.x, 10);
  ABI48_0_0EXPECT_EQ(stateData.contentOffset.y, 11);

  ABI48_0_0EXPECT_EQ(stateData.contentBoundingRect.origin.x, 21);
  ABI48_0_0EXPECT_EQ(stateData.contentBoundingRect.origin.y, 22);

  ABI48_0_0EXPECT_EQ(stateData.contentBoundingRect.size.width, 301);
  ABI48_0_0EXPECT_EQ(stateData.contentBoundingRect.size.height, 302);
}
