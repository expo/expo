...
TEST(LayoutableShadowNodeTest, relativeLayoutMetrics) {
  ...
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 100);
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 200);
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 10);
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 20);
}
...
TEST(LayoutableShadowNodeTest, contentOriginOffset) {
  ...
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 0);
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 10);
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetricsOnTransformedNode) {
  ...
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 35);
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 70);
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 50);
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 100);
}
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetricsOnTransformedParent) {
  ...
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 45);
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 45);

  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 25);
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 25);
}
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetricsOnSameNode) {
  ...
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 0);
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 0);
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 100);
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 200);
}
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetricsOnSameTransformedNode) {
  ...
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 0);
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 0);
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 200);
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 400);
}
...
TEST(LayoutableShadowNodeTest, relativeLayourMetricsOnClonedNode) {
  ...
  auto newRelativeLayoutMetrics =
      LayoutableShadowNode::computeRelativeLayoutMetrics(
          childShadowNode->getFamily(), *parentShadowNode, {});
  ABI48_0_0EXPECT_EQ(newRelativeLayoutMetrics.frame.size.width, 50);
  ABI48_0_0EXPECT_EQ(newRelativeLayoutMetrics.frame.size.height, 60);
}
...
TEST(LayoutableShadowNodeTest, includeViewportOffset) {
  ...
  ABI48_0_0EXPECT_EQ(layoutMetrics.frame.origin.x, 10);
  ABI48_0_0EXPECT_EQ(layoutMetrics.frame.origin.y, 20);
...
TEST(LayoutableShadowNodeTest, invertedVerticalView) {
  ...
  ABI48_0_0EXPECT_EQ(firstItemRelativeLayoutMetrics.frame.origin.x, 0);
  ABI48_0_0EXPECT_EQ(firstItemRelativeLayoutMetrics.frame.origin.y, 100);
  ABI48_0_0EXPECT_EQ(firstItemRelativeLayoutMetrics.frame.size.width, 100);
  ABI48_0_0EXPECT_EQ(firstItemRelativeLayoutMetrics.frame.size.height, 100);

  auto secondItemRelativeLayoutMetrics =
      LayoutableShadowNode::computeRelativeLayoutMetrics(
          childShadowNode2->getFamily(), *scrollShadowNode, {});

  ABI48_0_0EXPECT_EQ(secondItemRelativeLayoutMetrics.frame.origin.x, 0);
  ABI48_0_0EXPECT_EQ(secondItemRelativeLayoutMetrics.frame.origin.y, 0);
  ABI48_0_0EXPECT_EQ(secondItemRelativeLayoutMetrics.frame.size.width, 100);
  ABI48_0_0EXPECT_EQ(secondItemRelativeLayoutMetrics.frame.size.height, 100);
}
...
TEST(LayoutableShadowNodeTest, nestedInvertedVerticalView) {
  ...
  ABI48_0_0EXPECT_EQ(firstItemRelativeLayoutMetrics.frame.origin.x, 100);
  ABI48_0_0EXPECT_EQ(firstItemRelativeLayoutMetrics.frame.origin.y, 250);
  ABI48_0_0EXPECT_EQ(firstItemRelativeLayoutMetrics.frame.size.width, 100);
  ABI48_0_0EXPECT_EQ(firstItemRelativeLayoutMetrics.frame.size.height, 100);
  ...
  ABI48_0_0EXPECT_EQ(secondItemRelativeLayoutMetrics.frame.origin.x, 100);
  ABI48_0_0EXPECT_EQ(secondItemRelativeLayoutMetrics.frame.origin.y, 150);
  ABI48_0_0EXPECT_EQ(secondItemRelativeLayoutMetrics.frame.size.width, 100);
  ABI48_0_0EXPECT_EQ(secondItemRelativeLayoutMetrics.frame.size.height, 100);
}
...
TEST(LayoutableShadowNodeTest, invertedHorizontalView) {
  ...
  ABI48_0_0EXPECT_EQ(firstItemRelativeLayoutMetrics.frame.origin.x, 100);
  ABI48_0_0EXPECT_EQ(firstItemRelativeLayoutMetrics.frame.origin.y, 0);
  ABI48_0_0EXPECT_EQ(firstItemRelativeLayoutMetrics.frame.size.width, 100);
  ABI48_0_0EXPECT_EQ(firstItemRelativeLayoutMetrics.frame.size.height, 100);
...
TEST(LayoutableShadowNodeTest, nestedInvertedHorizontalView) {
  ...
  ABI48_0_0EXPECT_EQ(firstItemRelativeLayoutMetrics.frame.origin.x, 250);
  ABI48_0_0EXPECT_EQ(firstItemRelativeLayoutMetrics.frame.origin.y, 100);
  ABI48_0_0EXPECT_EQ(firstItemRelativeLayoutMetrics.frame.size.width, 100);
  ABI48_0_0EXPECT_EQ(firstItemRelativeLayoutMetrics.frame.size.height, 100);
  ...
  ABI48_0_0EXPECT_EQ(secondItemRelativeLayoutMetrics.frame.origin.x, 150);
  ABI48_0_0EXPECT_EQ(secondItemRelativeLayoutMetrics.frame.origin.y, 100);
  ABI48_0_0EXPECT_EQ(secondItemRelativeLayoutMetrics.frame.size.width, 100);
  ABI48_0_0EXPECT_EQ(secondItemRelativeLayoutMetrics.frame.size.height, 100);
}
...
TEST(LayoutableShadowNodeTest, inversedContentOriginOffset) {
  ...
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 180);
  ABI48_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 130);
}
