...
#include <ABI48_0_0React/ABI48_0_0renderer/components/scrollview/ScrollViewComponentDescriptor.h>
#include <ABI48_0_0React/ABI48_0_0renderer/components/text/ParagraphComponentDescriptor.h>
#include <ABI48_0_0React/ABI48_0_0renderer/components/text/RawTextComponentDescriptor.h>
#include <ABI48_0_0React/ABI48_0_0renderer/components/text/TextComponentDescriptor.h>
...
TEST(traitCastTest, testOne) {
  ...
  ABI48_0_0EXPECT_FALSE(traitCast<LayoutableShadowNode const *>(nullptr));
  ABI48_0_0EXPECT_FALSE(traitCast<YogaLayoutableShadowNode const *>(nullptr));

  // `ViewShadowNode` is `LayoutableShadowNode` and `YogaLayoutableShadowNode`.
  ABI48_0_0EXPECT_TRUE(traitCast<LayoutableShadowNode const *>(viewShadowNode.get()));
  ABI48_0_0EXPECT_TRUE(
      traitCast<YogaLayoutableShadowNode const *>(viewShadowNode.get()));
  ABI48_0_0EXPECT_NO_FATAL_FAILURE(
  ...
  // `YogaLayoutableShadowNode`.
  ABI48_0_0EXPECT_FALSE(traitCast<LayoutableShadowNode const *>(textShadowNode.get()));
  ABI48_0_0EXPECT_FALSE(
  ...
  ABI48_0_0EXPECT_TRUE(traitCast<RawTextShadowNode const *>(
  ...
  ABI48_0_0EXPECT_FALSE(traitCast<RawTextShadowNode const *>(viewShadowNode.get()));
  ABI48_0_0EXPECT_DEATH_IF_SUPPORTED(
  ...
  ABI48_0_0EXPECT_FALSE(traitCast<TextShadowNode const *>(viewShadowNode.get()));
  ABI48_0_0EXPECT_DEATH_IF_SUPPORTED(
