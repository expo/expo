...
TEST(FindNodeAtPointTest, withoutTransform) {
  ...
  ABI48_0_0EXPECT_EQ(LayoutableShadowNode::findNodeAtPoint(parentShadowNode, {105, 105})->getTag(), 2);
  ABI48_0_0EXPECT_EQ(LayoutableShadowNode::findNodeAtPoint(parentShadowNode, {900, 900})->getTag(), 1);
  ABI48_0_0EXPECT_EQ(
...
TEST(FindNodeAtPointTest, viewIsTranslated) {
  ...
  ABI48_0_0EXPECT_EQ(
      ...
      3);
  ABI48_0_0EXPECT_EQ(LayoutableShadowNode::findNodeAtPoint(parentShadowNode, {5, 5})->getTag(), 2);
}
