...
#include "ABI48_0_0UIManagerBinding.h"
...
#include <ABI48_0_0React/ABI48_0_0renderer/runtimescheduler/RuntimeSchedulerBinding.h>
...
void UIManagerBinding::dispatchEvent(
  ...
  auto instanceHandle = eventTarget != nullptr
    ? [&]() {
      ...
      ABI48_0_0React_native_assert(payload.isObject());
  ...
  eventHandlerWrapper.callback.call(
      ...
      {std::move(instanceHandle),
       ...
       std::move(payload)});
  currentEventPriority_ = ABI48_0_0ReactEventPriority::Default;
}
...
jsi::Value UIManagerBinding::get(
  ...
  if (methodName == "unstable_DefaultEventPriority") {
    return {serialize(ABI48_0_0ReactEventPriority::Default)};
  }

  if (methodName == "unstable_DiscreteEventPriority") {
    return {serialize(ABI48_0_0ReactEventPriority::Discrete)};
  }
