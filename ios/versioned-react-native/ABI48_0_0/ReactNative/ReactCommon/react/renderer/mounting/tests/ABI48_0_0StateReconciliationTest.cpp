...
#include <ABI48_0_0React/ABI48_0_0renderer/mounting/ShadowTree.h>
...
TEST(StateReconciliationTest, testStateReconciliation) {
  ...
  ABI48_0_0EXPECT_EQ(state1->getMostRecentState(), state1);
  ...
  ABI48_0_0EXPECT_EQ(state1->getMostRecentState(), state2);
  ABI48_0_0EXPECT_EQ(state2->getMostRecentState(), state2);
  ...
  ABI48_0_0EXPECT_EQ(findDescendantNode(shadowTree, family)->getState(), state3);

  ABI48_0_0EXPECT_EQ(state1->getMostRecentState(), state3);
  ABI48_0_0EXPECT_EQ(state2->getMostRecentState(), state3);
  ABI48_0_0EXPECT_EQ(state3->getMostRecentState(), state3);
