...
#include <ABI48_0_0React/ABI48_0_0test_utils/MockClock.h>
...
TEST(TransactionTelemetryTest, timepoints) {
  ...
  ABI48_0_0EXPECT_GE(duration, 100);
}
...
TEST(TransactionTelemetryTest, normalUseCase) {
  ...
  ABI48_0_0EXPECT_EQ(commitDuration, 1000);
  ABI48_0_0EXPECT_EQ(layoutDuration, 800);
  ABI48_0_0EXPECT_EQ(mountDuration, 100);

  ABI48_0_0EXPECT_EQ(telemetry.getNumberOfTextMeasurements(), 3);
  ABI48_0_0EXPECT_EQ(
      telemetryDurationToMilliseconds(telemetry.getTextMeasureTime()), 600);
  ABI48_0_0EXPECT_EQ(telemetry.getRevisionNumber(), 42);
}
...
TEST(TransactionTelemetryTest, defaultImplementation) {
  ...
  ABI48_0_0EXPECT_GE(commitDuration, 500);
  ABI48_0_0EXPECT_GE(layoutDuration, 300);
  ABI48_0_0EXPECT_GE(mountDuration, 100);
}
