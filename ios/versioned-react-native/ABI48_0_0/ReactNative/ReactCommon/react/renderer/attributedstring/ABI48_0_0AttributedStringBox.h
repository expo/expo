...
template <>
struct std::hash<ABI48_0_0facebook::ABI48_0_0React::AttributedStringBox> {
  size_t operator()(
      ABI48_0_0facebook::ABI48_0_0React::AttributedStringBox const &attributedStringBox) const {
    switch (attributedStringBox.getMode()) {
      case ABI48_0_0facebook::ABI48_0_0React::AttributedStringBox::Mode::Value:
        return std::hash<ABI48_0_0facebook::ABI48_0_0React::AttributedString>()(
            attributedStringBox.getValue());
      case ABI48_0_0facebook::ABI48_0_0React::AttributedStringBox::Mode::OpaquePointer:
