...
#include "ABI48_0_0UITemplateProcessor.h"
...
ShadowNode::Shared UITemplateProcessor::runCommand(
  ...
  if (opcode == "createNode") {
    ...
    registers[registerNumber] = ABI48_0_0ReactNativeConfig->getBool(param);
...
ShadowNode::Shared UITemplateProcessor::buildShadowTree(
  ...
  LOG(ERROR) << "ABI48_0_0React ui template missing returnRoot command :(";
