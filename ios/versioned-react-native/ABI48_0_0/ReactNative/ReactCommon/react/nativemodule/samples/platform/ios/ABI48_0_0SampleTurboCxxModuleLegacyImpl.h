...
class SampleTurboCxxModuleLegacyImpl
    : public ABI48_0_0facebook::xplat::module::CxxModule {
 public:
  SampleTurboCxxModuleLegacyImpl();

  std::string getName() override;
  std::map<std::string, folly::dynamic> getConstants() override;
  std::vector<ABI48_0_0facebook::xplat::module::CxxModule::Method> getMethods() override;
  ...
  void getValueWithCallback(
      const ABI48_0_0facebook::xplat::module::CxxModule::Callback &callback);
  void getValueWithPromise(
      bool error,
      const ABI48_0_0facebook::xplat::module::CxxModule::Callback &resolve,
      const ABI48_0_0facebook::xplat::module::CxxModule::Callback &reject);
};
