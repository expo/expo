 ...
 */
class JSI_EXPORT TurboModule : public ABI48_0_0facebook::jsi::HostObject {
 public:
  ...
  ABI48_0_0facebook::jsi::Value get(
      ...
      const ABI48_0_0facebook::jsi::PropNameID &propName) override {
    {
      ...
      if (p == methodMap_.end()) {
        ...
        return ABI48_0_0facebook::jsi::Value::undefined();
      } else {
 ...
 protected:
  ...
  struct MethodMetadata {
    size_t argCount;
    ABI48_0_0facebook::jsi::Value (*invoker)(
 ...
 private:
  ...
  ABI48_0_0facebook::jsi::Value get(
      ABI48_0_0facebook::jsi::Runtime &runtime,
      const ABI48_0_0facebook::jsi::PropNameID &propName,
