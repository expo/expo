...
#include "ABI48_0_0jsireact/ABI48_0_0JSINativeModules.h"
...
folly::Optional<Object> JSINativeModules::createModule(
  ...
  if (hasLogger) {
    ABI48_0_0ReactMarker::logTaggedMarker(
        ABI48_0_0ReactMarker::NATIVE_MODULE_SETUP_START, name.c_str());
  }
  ...
  if (hasLogger) {
    ABI48_0_0ReactMarker::logTaggedMarker(
        ABI48_0_0ReactMarker::NATIVE_MODULE_SETUP_STOP, name.c_str());
  }
