...
#include "ABI48_0_0SampleCxxModule.h"
...
ABI48_0_0facebook::xplat::module::CxxModule *SampleCxxModule() {
  return new ABI48_0_0facebook::xplat::samples::SampleCxxModule(
      std::make_unique<ABI48_0_0facebook::xplat::samples::Sample>());
}
