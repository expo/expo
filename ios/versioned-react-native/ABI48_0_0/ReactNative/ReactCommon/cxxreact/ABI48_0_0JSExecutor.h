...
#include <ABI48_0_0cxxreact/ABI48_0_0NativeModule.h>
...
class ABI48_0_0RN_EXPORT JSExecutor {
 public:
  /**
   * Prepares the JS runtime for ABI48_0_0React Native by installing global variables.
