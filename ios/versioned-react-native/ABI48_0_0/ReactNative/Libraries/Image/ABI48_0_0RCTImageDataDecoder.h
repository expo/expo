 ...
 * are also bridge modules, so should be registered using ABI48_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI48_0_0RCTImageDataDecoder <ABI48_0_0RCTBridgeModule>
...
/**
 * If more than one ABI48_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
