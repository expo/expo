...
@interface ABI48_0_0RCTImageStoreManager : NSObject <ABI48_0_0RCTURLRequestHandler>
...
@interface ABI48_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI48_0_0RCTBridge (ABI48_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI48_0_0RCTImageStoreManager *imageStoreManager;
