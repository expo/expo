...
@interface ABI48_0_0RCTLocalAssetImageLoader () <ABI48_0_0RCTTurboModule>
@end

@implementation ABI48_0_0RCTLocalAssetImageLoader

ABI48_0_0RCT_EXPORT_MODULE()

- (BOOL)canLoadImageURL:(NSURL *)requestURL
{
  return ABI48_0_0RCTIsLocalAssetURL(requestURL);
}
...
{
  UIImage *image = ABI48_0_0RCTImageFromLocalAssetURL(imageURL);
  if (image) {
    if (progressHandler) {
      progressHandler(1, 1);
    }
    ...
    completionHandler(ABI48_0_0RCTErrorWithMessage(message), nil);
  }
...
Class ABI48_0_0RCTLocalAssetImageLoaderCls(void)
{
  return ABI48_0_0RCTLocalAssetImageLoader.class;
}
