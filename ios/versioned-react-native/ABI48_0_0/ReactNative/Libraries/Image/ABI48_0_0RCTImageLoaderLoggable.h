...
/**
 * The image loader (i.e. ABI48_0_0RCTImageLoader) implement this to declare whether image performance should be logged.
 */
@protocol ABI48_0_0RCTImageLoaderLoggableProtocol
 ...
 */
@protocol ABI48_0_0RCTImageLoaderLoggable
