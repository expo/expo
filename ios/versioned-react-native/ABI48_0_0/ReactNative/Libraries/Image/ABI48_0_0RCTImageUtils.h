 ...
 */
ABI48_0_0RCT_EXTERN CGRect ABI48_0_0RCTTargetRect(CGSize sourceSize, CGSize destSize, CGFloat destScale, ABI48_0_0RCTResizeMode resizeMode);
 ...
 */
ABI48_0_0RCT_EXTERN CGAffineTransform ABI48_0_0RCTTransformFromTargetRect(CGSize sourceSize, CGRect targetRect);
 ...
 */
ABI48_0_0RCT_EXTERN CGSize ABI48_0_0RCTTargetSize(
    CGSize sourceSize,
    CGFloat sourceScale,
    CGSize destSize,
    CGFloat destScale,
    ABI48_0_0RCTResizeMode resizeMode,
    BOOL allowUpscaling);
 ...
 */
ABI48_0_0RCT_EXTERN BOOL ABI48_0_0RCTUpscalingRequired(
    CGSize sourceSize,
    CGFloat sourceScale,
    CGSize destSize,
    CGFloat destScale,
 ...
 */
ABI48_0_0RCT_EXTERN UIImage *__nullable
ABI48_0_0RCTDecodeImageWithData(NSData *data, CGSize destSize, CGFloat destScale, ABI48_0_0RCTResizeMode resizeMode);

/**
 * This function takes the source data for an image and decodes just the
 * metadata, without decompressing the image itself.
 */
ABI48_0_0RCT_EXTERN NSDictionary<NSString *, id> *__nullable ABI48_0_0RCTGetImageMetadata(NSData *data);
 ...
 */
ABI48_0_0RCT_EXTERN NSData *__nullable ABI48_0_0RCTGetImageData(UIImage *image, float quality);
 ...
 */
ABI48_0_0RCT_EXTERN UIImage *__nullable
ABI48_0_0RCTTransformImage(UIImage *image, CGSize destSize, CGFloat destScale, CGAffineTransform transform);

/*
 * Return YES if image has an alpha component
 */
ABI48_0_0RCT_EXTERN BOOL ABI48_0_0RCTImageHasAlpha(CGImageRef image);
