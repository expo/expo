...
#import "ABI48_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI48_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ABI48_0_0ReactViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ABI48_0_0ReactViewController detachChildViewController:self.contentViewController];
}
