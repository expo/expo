...
#import <ABI48_0_0React/ABI48_0_0RCTLinkingManager.h>
...
#import "ABI48_0_0RCTLinkingPlugins.h"

static NSString *const kOpenURLNotification = @"ABI48_0_0RCTOpenURLNotification";
...
@interface ABI48_0_0RCTLinkingManager () <ABI48_0_0NativeLinkingManagerSpec>
@end

@implementation ABI48_0_0RCTLinkingManager
      ...
      completionHandler:^(BOOL success) {
        if (success) {
          ...
          if ([URL.absoluteString hasPrefix:@"tel:"]) {
            ABI48_0_0RCTLogWarn(@"Unable to open the Phone app in the simulator for telephone URLs. URL:  %@", URL);
            resolve(@NO);
          } else {
...
ABI48_0_0RCT_EXPORT_METHOD(canOpenURL
                  : (NSURL *)URL resolve
                  : (ABI48_0_0RCTPromiseResolveBlock)resolve reject
                  : (__unused ABI48_0_0RCTPromiseRejectBlock)reject)
{
  ...
  BOOL canOpen = [ABI48_0_0RCTSharedApplication() canOpenURL:URL];
...
ABI48_0_0RCT_EXPORT_METHOD(getInitialURL : (ABI48_0_0RCTPromiseResolveBlock)resolve reject : (__unused ABI48_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve(ABI48_0_0RCTNullIfNil(initialURL.absoluteString));
}

ABI48_0_0RCT_EXPORT_METHOD(openSettings : (ABI48_0_0RCTPromiseResolveBlock)resolve reject : (__unused ABI48_0_0RCTPromiseRejectBlock)reject)
{
...
ABI48_0_0RCT_EXPORT_METHOD(sendIntent
                  : (NSString *)action extras
                  : (NSArray *_Nullable)extras resolve
                  : (ABI48_0_0RCTPromiseResolveBlock)resolve reject
                  : (ABI48_0_0RCTPromiseRejectBlock)reject)
{
  ABI48_0_0RCTLogError(@"Not implemented: %@", NSStringFromSelector(_cmd));
}
...
{
  return std::make_shared<ABI48_0_0facebook::ABI48_0_0React::NativeLinkingManagerSpecJSI>(params);
}

@end

Class ABI48_0_0RCTLinkingManagerCls(void)
{
  return ABI48_0_0RCTLinkingManager.class;
}
