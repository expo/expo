...
@protocol ABI48_0_0RCTNetworkingRequestHandler <NSObject>
...
@protocol ABI48_0_0RCTNetworkingResponseHandler <NSObject>
...
@interface ABI48_0_0RCTNetworking : ABI48_0_0RCTEventEmitter

/**
 * Allows ABI48_0_0RCTNetworking instances to be initialized with handlers.
 * The handlers will be requested via the bridge's moduleForName method when required.
 */
- (instancetype)initWithHandlersProvider:(NSArray<id<ABI48_0_0RCTURLRequestHandler>> * (^)(ABI48_0_0RCTModuleRegistry *))getHandlers;
...
/**
 * Return an ABI48_0_0RCTNetworkTask for the specified request. This is useful for
 * invoking the ABI48_0_0React Native networking stack from within native code.
 */
...
@interface ABI48_0_0RCTBridge (ABI48_0_0RCTNetworking)

@property (nonatomic, readonly) ABI48_0_0RCTNetworking *networking;
...
extern NSString *const ABI48_0_0RCTNetworkingPHUploadHackScheme;
