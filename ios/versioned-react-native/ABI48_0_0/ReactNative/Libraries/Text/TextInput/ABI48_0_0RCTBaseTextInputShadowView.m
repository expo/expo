...
@implementation ABI48_0_0RCTBaseTextInputShadowView {
...
- (instancetype)initWithBridge:(ABI48_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI48_0_0YGNodeSetMeasureFunc(self.yogaNode, ABI48_0_0RCTBaseTextInputShadowViewMeasure);
    ABI48_0_0YGNodeSetBaselineFunc(self.yogaNode, ABI48_0_0RCTTextInputShadowViewBaseline);
  }
...
- (void)uiManagerWillPerformMounting
{
  ...
  ABI48_0_0RCTTextAttributes *textAttributes = [self.textAttributes copy];
  ...
  [attributedText removeAttribute:ABI48_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                            range:NSMakeRange(0, attributedText.length)];

  [attributedText removeAttribute:ABI48_0_0RCTTextAttributesTagAttributeName range:NSMakeRange(0, attributedText.length)];
  ...
  [_bridge.uiManager addUIBlock:^(ABI48_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI48_0_0RCTBaseTextInputView *baseTextInputView = (ABI48_0_0RCTBaseTextInputView *)viewRegistry[tag];
    if (!baseTextInputView) {
      return;
    }

    baseTextInputView.textAttributes = textAttributes;
    baseTextInputView.ABI48_0_0ReactBorderInsets = borderInsets;
    baseTextInputView.ABI48_0_0ReactPaddingInsets = paddingInsets;
...
- (CGSize)sizeThatFitsMinimumSize:(CGSize)minimumSize maximumSize:(CGSize)maximumSize
{
  ...
  return (CGSize){
      MAX(minimumSize.width, MIN(ABI48_0_0RCTCeilPixelValue(size.width), maximumSize.width)),
      MAX(minimumSize.height, MIN(ABI48_0_0RCTCeilPixelValue(size.height), maximumSize.height))};
}
...
static ABI48_0_0YGSize ABI48_0_0RCTBaseTextInputShadowViewMeasure(
    ...
    ABI48_0_0YGMeasureMode heightMode)
{
  ...
  CGSize size = {ABI48_0_0RCTCoreGraphicsFloatFromYogaFloat(width), ABI48_0_0RCTCoreGraphicsFloatFromYogaFloat(height)};
  ...
  return (ABI48_0_0YGSize){
      ABI48_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.width), ABI48_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.height)};
}

static float ABI48_0_0RCTTextInputShadowViewBaseline(ABI48_0_0YGNodeRef node, const float width, const float height)
{
  ABI48_0_0RCTBaseTextInputShadowView *shadowTextView = (__bridge ABI48_0_0RCTBaseTextInputShadowView *)ABI48_0_0YGNodeGetContext(node);
