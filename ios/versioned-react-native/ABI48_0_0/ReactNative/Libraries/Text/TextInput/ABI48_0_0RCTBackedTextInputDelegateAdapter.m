...
#import <ABI48_0_0React/ABI48_0_0RCTBackedTextInputDelegateAdapter.h>
...
@interface ABI48_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI48_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI48_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
...
@interface ABI48_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI48_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI48_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
