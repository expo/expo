...
@implementation ABI48_0_0RCTBaseTextInputView {
...
- (UIView<ABI48_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  ABI48_0_0RCTAssert(NO, @"-[ABI48_0_0RCTBaseTextInputView backedTextInputView] must be implemented in subclass.");
  return nil;
}

#pragma mark - ABI48_0_0RCTComponent
...
- (void)setTextAttributes:(ABI48_0_0RCTTextAttributes *)textAttributes
{
...
{
  id<ABI48_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
...
- (void)setABI48_0_0ReactPaddingInsets:(UIEdgeInsets)ABI48_0_0ReactPaddingInsets
{
  _ABI48_0_0ReactPaddingInsets = ABI48_0_0ReactPaddingInsets;
  // We apply `paddingInsets` as `backedTextInputView`'s `textContainerInset`.
  self.backedTextInputView.textContainerInset = ABI48_0_0ReactPaddingInsets;
  [self setNeedsLayout];
}

- (void)setABI48_0_0ReactBorderInsets:(UIEdgeInsets)ABI48_0_0ReactBorderInsets
{
  _ABI48_0_0ReactBorderInsets = ABI48_0_0ReactBorderInsets;
  // We apply `borderInsets` as `backedTextInputView` layout offset.
  self.backedTextInputView.frame = UIEdgeInsetsInsetRect(self.bounds, ABI48_0_0ReactBorderInsets);
  [self setNeedsLayout];
}
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  [backedTextInputViewTextCopy removeAttribute:ABI48_0_0RCTTextAttributesTagAttributeName
                                         range:NSMakeRange(0, backedTextInputViewTextCopy.length)];

  [attributedTextCopy removeAttribute:ABI48_0_0RCTTextAttributesTagAttributeName
  ...
  } else if (eventLag > ABI48_0_0RCTTextUpdateLagWarningThreshold) {
    ABI48_0_0RCTLog(
...
- (ABI48_0_0RCTTextSelection *)selection
{
  id<ABI48_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
  UITextRange *selectedTextRange = backedTextInputView.selectedTextRange;
  return [[ABI48_0_0RCTTextSelection new]
...
- (void)setSelection:(ABI48_0_0RCTTextSelection *)selection
{
  if (!selection) {
    return;
  }
...
{
  UIView<ABI48_0_0RCTBackedTextInputViewProtocol> *textInputView = self.backedTextInputView;
...
- (void)textInputDidBeginEditing
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI48_0_0RCTTextEventTypeFocus
...
{
  [_eventDispatcher sendTextEventWithType:ABI48_0_0RCTTextEventTypeEnd
                                 ABI48_0_0ReactTag:self.ABI48_0_0ReactTag
                                     text:[self.backedTextInputView.attributedText.string copy]
                                      key:nil
                               eventCount:_nativeEventCount];

  [_eventDispatcher sendTextEventWithType:ABI48_0_0RCTTextEventTypeBlur
                                 ABI48_0_0ReactTag:self.ABI48_0_0ReactTag
                                     text:[self.backedTextInputView.attributedText.string copy]
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldSubmitOnReturn
{
  ...
  if (shouldSubmit) {
    ...
    [_eventDispatcher sendTextEventWithType:ABI48_0_0RCTTextEventTypeSubmit
                                   ABI48_0_0ReactTag:self.ABI48_0_0ReactTag
                                       text:[self.backedTextInputView.attributedText.string copy]
                                        key:nil
                                 eventCount:_nativeEventCount];
...
- (NSString *)textInputShouldChangeText:(NSString *)text inRange:(NSRange)range
{
  ...
  if (!backedTextInputView.textWasPasted) {
    [_eventDispatcher sendTextEventWithType:ABI48_0_0RCTTextEventTypeKeyPress
                                   ABI48_0_0ReactTag:self.ABI48_0_0ReactTag
                                       text:nil
                                        key:text
                                 eventCount:_nativeEventCount];
...
- (void)textInputDidChangeSelection
{
  ...
  ABI48_0_0RCTTextSelection *selection = self.selection;
...
- (CGSize)intrinsicContentSize
{
  ...
  size.width += _ABI48_0_0ReactBorderInsets.left + _ABI48_0_0ReactBorderInsets.right;
  size.height += _ABI48_0_0ReactBorderInsets.top + _ABI48_0_0ReactBorderInsets.bottom;
...
{
  CGFloat compoundHorizontalBorderInset = _ABI48_0_0ReactBorderInsets.left + _ABI48_0_0ReactBorderInsets.right;
  CGFloat compoundVerticalBorderInset = _ABI48_0_0ReactBorderInsets.top + _ABI48_0_0ReactBorderInsets.bottom;
...
{
  [self.backedTextInputView ABI48_0_0ReactFocus];
}

- (void)ABI48_0_0ReactBlur
{
  [self.backedTextInputView ABI48_0_0ReactBlur];
}
...
- (void)didMoveToWindow
{
  if (self.autoFocus && !_didMoveToWindow) {
    ...
    [self.backedTextInputView ABI48_0_0ReactFocusIfNeeded];
  }
...
{
  __weak ABI48_0_0RCTBaseTextInputView *weakSelf = self;
  [_bridge.uiManager rootViewForABI48_0_0ReactTag:self.ABI48_0_0ReactTag
                          withCompletion:^(UIView *rootView) {
                            ABI48_0_0RCTBaseTextInputView *strongSelf = weakSelf;
                            if (rootView) {
                              UIView *accessoryView = [strongSelf->_bridge.uiManager viewForNativeID:nativeID
                                                                                         withRootTag:rootView.ABI48_0_0ReactTag];
                              if (accessoryView && [accessoryView isKindOfClass:[ABI48_0_0RCTInputAccessoryView class]]) {
                                strongSelf.backedTextInputView.inputAccessoryView =
                                    ((ABI48_0_0RCTInputAccessoryView *)accessoryView).inputAccessoryView;
