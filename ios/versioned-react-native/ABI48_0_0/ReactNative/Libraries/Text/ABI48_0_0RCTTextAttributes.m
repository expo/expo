...
NSString *const ABI48_0_0RCTTextAttributesIsHighlightedAttributeName = @"ABI48_0_0RCTTextAttributesIsHighlightedAttributeName";
NSString *const ABI48_0_0RCTTextAttributesTagAttributeName = @"ABI48_0_0RCTTextAttributesTagAttributeName";

@implementation ABI48_0_0RCTTextAttributes
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _opacity = NAN;
    _textTransform = ABI48_0_0RCTTextTransformUndefined;
  }
...
- (void)applyTextAttributes:(ABI48_0_0RCTTextAttributes *)textAttributes
{
  ...
  _dynamicTypeRamp = textAttributes->_dynamicTypeRamp != ABI48_0_0RCTDynamicTypeRampUndefined ? textAttributes->_dynamicTypeRamp
                                                                                     : _dynamicTypeRamp;
  ...
  _textDecorationLine = textAttributes->_textDecorationLine != ABI48_0_0RCTTextDecorationLineTypeNone
  ...
  _layoutDirection = textAttributes->_layoutDirection != UIUserInterfaceLayoutDirectionLeftToRight
      ...
      : _layoutDirection;
  _textTransform =
      textAttributes->_textTransform != ABI48_0_0RCTTextTransformUndefined ? textAttributes->_textTransform : _textTransform;
}
...
- (NSDictionary<NSAttributedStringKey, id> *)effectiveTextAttributes
{
  ...
  if (_textDecorationLine == ABI48_0_0RCTTextDecorationLineTypeUnderline ||
      _textDecorationLine == ABI48_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    isTextDecorationEnabled = YES;
    attributes[NSUnderlineStyleAttributeName] = @(_textDecorationStyle);
  }

  if (_textDecorationLine == ABI48_0_0RCTTextDecorationLineTypeStrikethrough ||
      _textDecorationLine == ABI48_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    isTextDecorationEnabled = YES;
  ...
  // Special
  if (_isHighlighted) {
    attributes[ABI48_0_0RCTTextAttributesIsHighlightedAttributeName] = @YES;
  }

  if (_tag) {
    attributes[ABI48_0_0RCTTextAttributesTagAttributeName] = _tag;
  }
...
{
  // FIXME: ABI48_0_0RCTFont has thread-safety issues and must be rewritten.
...
{
  bool fontScalingEnabled = !ABI48_0_0RCTHasFontHandlerSet() && _allowFontScaling;

  if (fontScalingEnabled) {
    CGFloat fontSizeMultiplier = !isnan(_fontSizeMultiplier) ? _fontSizeMultiplier : 1.0;
    if (_dynamicTypeRamp != ABI48_0_0RCTDynamicTypeRampUndefined) {
      UIFontMetrics *fontMetrics = ABI48_0_0RCTUIFontMetricsForDynamicTypeRamp(_dynamicTypeRamp);
      // Using a specific font size reduces rounding errors from -scaledValueForValue:
      CGFloat requestedSize = isnan(_fontSize) ? ABI48_0_0RCTBaseSizeForDynamicTypeRamp(_dynamicTypeRamp) : _fontSize;
...
- (NSString *)applyTextAttributesToText:(NSString *)text
{
  switch (_textTransform) {
    case ABI48_0_0RCTTextTransformUndefined:
    case ABI48_0_0RCTTextTransformNone:
      return text;
    case ABI48_0_0RCTTextTransformLowercase:
      return [text lowercaseString];
    case ABI48_0_0RCTTextTransformUppercase:
      return [text uppercaseString];
    case ABI48_0_0RCTTextTransformCapitalize:
      return capitalizeText(text);
  }
}

- (ABI48_0_0RCTTextAttributes *)copyWithZone:(NSZone *)zone
{
  ABI48_0_0RCTTextAttributes *textAttributes = [ABI48_0_0RCTTextAttributes new];
...
- (BOOL)isEqual:(ABI48_0_0RCTTextAttributes *)textAttributes
{
  if (!textAttributes) {
    return NO;
  }
...
#define ABI48_0_0RCTTextAttributesCompareFloats(a) ((a == textAttributes->a) || (isnan(a) && isnan(textAttributes->a)))
#define ABI48_0_0RCTTextAttributesCompareSize(a) CGSizeEqualToSize(a, textAttributes->a)
#define ABI48_0_0RCTTextAttributesCompareObjects(a) ((a == textAttributes->a) || [a isEqual:textAttributes->a])
#define ABI48_0_0RCTTextAttributesCompareStrings(a) ((a == textAttributes->a) || [a isEqualToString:textAttributes->a])
#define ABI48_0_0RCTTextAttributesCompareOthers(a) (a == textAttributes->a)

  return ABI48_0_0RCTTextAttributesCompareObjects(_foregroundColor) && ABI48_0_0RCTTextAttributesCompareObjects(_backgroundColor) &&
      ABI48_0_0RCTTextAttributesCompareFloats(_opacity) &&
      // Font
      ABI48_0_0RCTTextAttributesCompareObjects(_fontFamily) && ABI48_0_0RCTTextAttributesCompareFloats(_fontSize) &&
      ABI48_0_0RCTTextAttributesCompareFloats(_fontSizeMultiplier) && ABI48_0_0RCTTextAttributesCompareFloats(_maxFontSizeMultiplier) &&
      ABI48_0_0RCTTextAttributesCompareStrings(_fontWeight) && ABI48_0_0RCTTextAttributesCompareObjects(_fontStyle) &&
      ABI48_0_0RCTTextAttributesCompareObjects(_fontVariant) && ABI48_0_0RCTTextAttributesCompareOthers(_allowFontScaling) &&
      ABI48_0_0RCTTextAttributesCompareOthers(_dynamicTypeRamp) && ABI48_0_0RCTTextAttributesCompareFloats(_letterSpacing) &&
      // Paragraph Styles
      ABI48_0_0RCTTextAttributesCompareFloats(_lineHeight) && ABI48_0_0RCTTextAttributesCompareFloats(_alignment) &&
      ABI48_0_0RCTTextAttributesCompareOthers(_baseWritingDirection) && ABI48_0_0RCTTextAttributesCompareOthers(_lineBreakStrategy) &&
      // Decoration
      ABI48_0_0RCTTextAttributesCompareObjects(_textDecorationColor) && ABI48_0_0RCTTextAttributesCompareOthers(_textDecorationStyle) &&
      ABI48_0_0RCTTextAttributesCompareOthers(_textDecorationLine) &&
      // Shadow
      ABI48_0_0RCTTextAttributesCompareSize(_textShadowOffset) && ABI48_0_0RCTTextAttributesCompareFloats(_textShadowRadius) &&
      ABI48_0_0RCTTextAttributesCompareObjects(_textShadowColor) &&
      // Special
      ABI48_0_0RCTTextAttributesCompareOthers(_isHighlighted) && ABI48_0_0RCTTextAttributesCompareObjects(_tag) &&
      ABI48_0_0RCTTextAttributesCompareOthers(_layoutDirection) && ABI48_0_0RCTTextAttributesCompareOthers(_textTransform);
}
