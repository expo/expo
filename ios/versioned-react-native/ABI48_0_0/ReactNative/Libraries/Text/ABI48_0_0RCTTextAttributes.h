...
#import <ABI48_0_0React/ABI48_0_0RCTDynamicTypeRamp.h>
#import <ABI48_0_0React/ABI48_0_0RCTTextDecorationLineType.h>

#import "ABI48_0_0RCTTextTransform.h"

NS_ASSUME_NONNULL_BEGIN

extern NSString *const ABI48_0_0RCTTextAttributesIsHighlightedAttributeName;
extern NSString *const ABI48_0_0RCTTextAttributesTagAttributeName;
 ...
 * and <TextInput>.
 */
@interface ABI48_0_0RCTTextAttributes : NSObject <NSCopying>
...
@property (nonatomic, assign) ABI48_0_0RCTDynamicTypeRamp dynamicTypeRamp;
...
@property (nonatomic, assign) ABI48_0_0RCTTextDecorationLineType textDecorationLine;
// Shadow
...
@property (nonatomic, assign) ABI48_0_0RCTTextTransform textTransform;

#pragma mark - Inheritance

- (void)applyTextAttributes:(ABI48_0_0RCTTextAttributes *)textAttributes;
