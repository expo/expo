...
@implementation ABI48_0_0RCTTextView {
...
- (NSString *)description
{
  ...
  NSString *replacement = [NSString stringWithFormat:@"; ABI48_0_0ReactTag: %@; text: %@>", self.ABI48_0_0ReactTag, _textStorage.string];
...
- (void)drawRect:(CGRect)rect
{
  ...
  [_textStorage
      enumerateAttribute:ABI48_0_0RCTTextAttributesIsHighlightedAttributeName
...
- (NSNumber *)ABI48_0_0ReactTagAtPoint:(CGPoint)point
{
  ...
  if (_textStorage.length > 0 && (fraction > 0 || characterIndex > 0) &&
    ...
    ABI48_0_0ReactTag = [_textStorage attribute:ABI48_0_0RCTTextAttributesTagAttributeName atIndex:characterIndex effectiveRange:NULL];
  }

  return ABI48_0_0ReactTag;
}
