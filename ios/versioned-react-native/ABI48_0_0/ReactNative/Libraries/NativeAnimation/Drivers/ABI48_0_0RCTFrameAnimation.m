...
@interface ABI48_0_0RCTFrameAnimation ()
...
@implementation ABI48_0_0RCTFrameAnimation {
...
{
  NSNumber *toValue = [ABI48_0_0RCTConvert NSNumber:config[@"toValue"]] ?: @1;
  NSArray<NSNumber *> *frames = [ABI48_0_0RCTConvert NSNumberArray:config[@"frames"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  NSTimeInterval currentDuration = (_animationCurrentTime - _animationStartTime) / ABI48_0_0RCTAnimationDragCoefficient();

  // Determine how many frames have passed since last update.
  // Get index of frames that surround the current interval
  NSUInteger startIndex = floor(currentDuration / ABI48_0_0RCTSingleFrameInterval);
  ...
  NSTimeInterval fromInterval = (double)startIndex * ABI48_0_0RCTSingleFrameInterval;
  NSTimeInterval toInterval = (double)nextIndex * ABI48_0_0RCTSingleFrameInterval;
  ...
  CGFloat frameOutput = ABI48_0_0RCTInterpolateValue(
      currentDuration,
      fromInterval,
      toInterval,
      fromFrameValue.doubleValue,
      toFrameValue.doubleValue,
      ABI48_0_0EXTRAPOLATE_TYPE_EXTEND,
      ABI48_0_0EXTRAPOLATE_TYPE_EXTEND);
...
{
  CGFloat outputValue =
      ABI48_0_0RCTInterpolateValue(frameOutput, 0, 1, _fromValue, _toValue, ABI48_0_0EXTRAPOLATE_TYPE_EXTEND, ABI48_0_0EXTRAPOLATE_TYPE_EXTEND);
