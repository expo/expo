...
#import <ABI48_0_0React/ABI48_0_0RCTNativeAnimatedModule.h>
...
@interface ABI48_0_0RCTNativeAnimatedModule () <ABI48_0_0RCTInitializing>
@end

@implementation ABI48_0_0RCTNativeAnimatedModule {
...
- (void)setBridge:(ABI48_0_0RCTBridge *)bridge
{
  ...
  _nodesManager = [[ABI48_0_0RCTNativeAnimatedNodesManager alloc] initWithBridge:self.bridge
...
{
  ABI48_0_0RCTLogWarn(@"setSurfacePresenter should only be invoked in ABI48_0_0RCTNativeAnimatedTurboModule");
}
...
{
  NSString *viewName = [self.bridge.uiManager viewNameForABI48_0_0ReactTag:[NSNumber numberWithDouble:viewTag]];
  [self addOperationBlock:^(ABI48_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
- (void)uiManagerWillPerformMounting:(ABI48_0_0RCTUIManager *)uiManager
{
  ...
  [uiManager
      prependUIBlock:^(__unused ABI48_0_0RCTUIManager *manager, __unused NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        for (AnimatedOperation operation in preOperations) {
          operation(self->_nodesManager);
        }
      }];
...
Class ABI48_0_0RCTNativeAnimatedModuleCls(void)
{
  return ABI48_0_0RCTNativeAnimatedModule.class;
}
