...
@protocol ABI48_0_0RCTValueAnimatedNodeObserver;

NS_ASSUME_NONNULL_BEGIN

@interface ABI48_0_0RCTNativeAnimatedNodesManager : NSObject

- (nonnull instancetype)initWithBridge:(nullable ABI48_0_0RCTBridge *)bridge
