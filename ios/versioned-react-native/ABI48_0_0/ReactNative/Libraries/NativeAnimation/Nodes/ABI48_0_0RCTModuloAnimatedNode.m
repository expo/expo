...
@implementation ABI48_0_0RCTModuloAnimatedNode
...
- (void)performUpdate
{
  ...
  ABI48_0_0RCTValueAnimatedNode *parent = (ABI48_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:inputNode];
