...
@implementation ABI48_0_0RCTAnimatedNode {
  NSMapTable<NSNumber *, ABI48_0_0RCTAnimatedNode *> *_childNodes;
  NSMapTable<NSNumber *, ABI48_0_0RCTAnimatedNode *> *_parentNodes;
}
...
- (NSMapTable<NSNumber *, ABI48_0_0RCTAnimatedNode *> *)childNodes
{
  return _childNodes;
}

- (NSMapTable<NSNumber *, ABI48_0_0RCTAnimatedNode *> *)parentNodes
{
  return _parentNodes;
}

- (void)addChild:(ABI48_0_0RCTAnimatedNode *)child
{
  if (!_childNodes) {
...
- (void)removeChild:(ABI48_0_0RCTAnimatedNode *)child
{
  if (!_childNodes) {
    return;
  }
...
- (void)detachNode
{
  for (ABI48_0_0RCTAnimatedNode *parent in _parentNodes.objectEnumerator) {
    [parent removeChild:self];
  }
  for (ABI48_0_0RCTAnimatedNode *child in _childNodes.objectEnumerator) {
