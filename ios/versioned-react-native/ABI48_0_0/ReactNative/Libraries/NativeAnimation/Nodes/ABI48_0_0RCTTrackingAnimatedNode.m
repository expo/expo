...
@implementation ABI48_0_0RCTTrackingAnimatedNode {
...
- (void)performUpdate
{
  ...
  ABI48_0_0RCTValueAnimatedNode *node = (ABI48_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
