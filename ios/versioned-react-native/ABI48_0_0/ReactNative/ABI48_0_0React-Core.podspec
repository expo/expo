...
header_subspecs = {
  ...
  'RCTBlobHeaders'              => 'Libraries/Blob/{ABI48_0_0RCTBlobManager,ABI48_0_0RCTFileReaderModule}.h',
...
header_search_paths = [
  ...
  "$(PODS_ROOT)/Headers/Public/ABI48_0_0React-hermes",
  "$(PODS_ROOT)/Headers/Public/ABI48_0_0hermes-engine"
] : []).map{|p| "\"#{p}\""}.join(" ")

Pod::Spec.new do |s|
  s.name                   = "ABI48_0_0React-Core"
  s.version                = version
  ...
  s.source                 = { :path => "." }
  s.resource_bundle        = { "ABI48_0_0AccessibilityResources" => ["React/AccessibilityResources/*.lproj"]}
  ...
  s.pod_target_xcconfig    = {
                               ...
                               "FRAMEWORK_SEARCH_PATHS" => "\"$(PODS_CONFIGURATION_BUILD_DIR)/ABI48_0_0React-hermes\""
                             } : {})
  s.user_target_xcconfig   = { "HEADER_SEARCH_PATHS" => "\"$(PODS_ROOT)/Headers/Private/ABI48_0_0React-Core\""}
  ...
  s.subspec "DevSupport" do |ss|
    ...
    ss.dependency "ABI48_0_0React-Core/Default", version
    ss.dependency "ABI48_0_0React-Core/RCTWebSocket", version
    ss.dependency "ABI48_0_0React-jsinspector", version
  end
  ...
  header_subspecs.each do |name, headers|
    s.subspec name do |ss|
      ...
      ss.dependency "ABI48_0_0React-Core/Default"
    end
  end
  ...
  s.dependency "ABI48_0_0Yoga"
  s.dependency "glog"

  if ENV['USE_HERMES'] == "0"
    s.dependency 'ABI48_0_0React-jsc'
  else
    s.dependency 'ABI48_0_0React-hermes'
