...
Pod::Spec.new do |spec|
  spec.name        = "ABI48_0_0hermes-engine"
  ...
  if source[:http] then
    ...
    spec.subspec 'Pre-built' do |ss|
      ...
      ss.ios.vendored_frameworks = "destroot/Library/Frameworks/universal/ABI48_0_0hermes.xcframework"
