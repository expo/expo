...
class FabricTest < Test::Unit::TestCase
    ...
    def check_installed_pods(prefix)
        ...
        check_pod("React-Fabric", :path => "#{prefix}/ReactCommon", :project_name => 'ABI48_0_0')
        check_pod("React-rncore", :path => "#{prefix}/ReactCommon", :project_name => 'ABI48_0_0')
        check_pod("React-graphics", :path => "#{prefix}/ReactCommon/react/renderer/graphics", :project_name => 'ABI48_0_0')
        check_pod("React-RCTFabric", :path => "#{prefix}/React", :project_name => 'ABI48_0_0', :modular_headers => true)
