...
#import <ABI48_0_0cxxreact/ABI48_0_0JSBigString.h>
...
class ABI48_0_0RCTObjcExecutor : public JSExecutor {
 public:
  ABI48_0_0RCTObjcExecutor(
  ...
  {
    ABI48_0_0RCTAssert(NO, @"RAM bundles are not supported in ABI48_0_0RCTObjcExecutor");
  }
 ...
 private:
  ...
  ABI48_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI48_0_0RCTObjcExecutorFactory::ABI48_0_0RCTObjcExecutorFactory(id<ABI48_0_0RCTJavaScriptExecutor> jse, ABI48_0_0RCTJavaScriptCompleteBlock errorBlock)
    : m_jse(jse), m_errorBlock(errorBlock)
{
}

std::unique_ptr<JSExecutor> ABI48_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue)
{
  return std::unique_ptr<JSExecutor>(new ABI48_0_0RCTObjcExecutor(m_jse, m_errorBlock, jsQueue, delegate));
}
