...
@interface ABI48_0_0RCTComponentViewRegistryTests : XCTestCase
@end

using namespace ABI48_0_0facebook::ABI48_0_0React;

@implementation ABI48_0_0RCTComponentViewRegistryTests {
  ABI48_0_0RCTComponentViewRegistry *_componentViewRegistry;
}
...
- (void)setUp
{
  ...
  [_componentViewRegistry.componentViewFactory registerComponentViewClass:[ABI48_0_0RCTViewComponentView class]];
}
...
- (void)testComponentViewDescriptorWithTag
{
  ...
  auto newViewDescriptor = [_componentViewRegistry
      dequeueComponentViewWithComponentHandle:[ABI48_0_0RCTViewComponentView componentDescriptorProvider].handle
                                          tag:existingTag];
...
- (void)testDequeueAndEnqueue
{
  ...
  XCTAssertThrows(
      ^{
        Tag nonExistingTag = 12;
        [self->_componentViewRegistry
            enqueueComponentViewWithComponentHandle:[ABI48_0_0RCTViewComponentView componentDescriptorProvider].handle
                                                tag:nonExistingTag
