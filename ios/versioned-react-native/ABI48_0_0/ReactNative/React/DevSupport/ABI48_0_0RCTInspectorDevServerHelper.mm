...
{
  NSNumber *port = @8081;
  NSString *portStr = [[[NSProcessInfo processInfo] environment] objectForKey:@"ABI48_0_0RCT_METRO_PORT"];
...
@implementation ABI48_0_0RCTInspectorDevServerHelper

ABI48_0_0RCT_NOT_IMPLEMENTED(-(instancetype)init)

static NSMutableDictionary<NSString *, ABI48_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
...
+ (ABI48_0_0RCTInspectorPackagerConnection *)connectWithBundleURL:(NSURL *)bundleURL
{
  ...
  ABI48_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection || !connection.isConnected) {
    connection = [[ABI48_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
