...
Pod::Spec.new do |s|
  s.name                   = "ABI48_0_0React-RCTFabric"
  s.version                = version
  ...
  s.header_dir             = "ABI48_0_0React"
  s.module_name            = "ABI48_0_0RCTFabric"
  ...
  s.dependency "ABI48_0_0React-Core", version
  s.dependency "ABI48_0_0React-Fabric", version
  s.dependency "ABI48_0_0React-RCTImage", version
