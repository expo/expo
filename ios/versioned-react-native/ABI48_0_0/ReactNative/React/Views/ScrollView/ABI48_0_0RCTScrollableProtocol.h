...
/**
 * Contains any methods related to scrolling. Any `ABI48_0_0RCTView` that has scrolling
 * features should implement these methods.
 */
@protocol ABI48_0_0RCTScrollableProtocol
 ...
 */
@protocol ABI48_0_0RCTCustomRefreshContolProtocol
