...
@implementation ABI48_0_0RCTModalHostViewController {
...
- (instancetype)init
{
  ...
  _preferredStatusBarStyle = [ABI48_0_0RCTSharedApplication() statusBarStyle];
  _preferredStatusBarHidden = [ABI48_0_0RCTSharedApplication() isStatusBarHidden];
