...
@interface ABI48_0_0RCTConvert (ABI48_0_0RCTModalHostView)

+ (UIModalPresentationStyle)UIModalPresentationStyle:(id)json;

@end

typedef void (^ABI48_0_0RCTModalViewInteractionBlock)(
    UIViewController *ABI48_0_0ReactViewController,
    UIViewController *viewController,
    BOOL animated,
    dispatch_block_t completionBlock);

@interface ABI48_0_0RCTModalHostViewManager : ABI48_0_0RCTViewManager <ABI48_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, strong) ABI48_0_0RCTModalViewInteractionBlock presentationBlock;
@property (nonatomic, strong) ABI48_0_0RCTModalViewInteractionBlock dismissalBlock;
