...
/**
 * An abstraction for a key-value store to manage ABI48_0_0RCTDevSettings behavior.
 * The default implementation persists settings using NSUserDefaults.
 */
@protocol ABI48_0_0RCTDevSettingsDataSource <NSObject>
...
@protocol ABI48_0_0RCTDevSettingsInspectable <NSObject>
...
@interface ABI48_0_0RCTDevSettings : ABI48_0_0RCTEventEmitter <ABI48_0_0RCTInitializing>
...
/*
 * Whether shaking will show ABI48_0_0RCTDevMenu. The menu is enabled by default if ABI48_0_0RCT_DEV=1, but
...
- (void)addHandler:(id<ABI48_0_0RCTPackagerClientMethod>)handler
    forPackagerMethod:(NSString *)name __deprecated_msg("Use ABI48_0_0RCTPackagerConnection directly instead");
#endif

@end

@interface ABI48_0_0RCTBridge (ABI48_0_0RCTDevSettings)

@property (nonatomic, readonly) ABI48_0_0RCTDevSettings *devSettings;
...
// (i.e. ABI48_0_0RCT_DEV or ABI48_0_0RCT_DEV_MENU is set)
ABI48_0_0RCT_EXTERN void ABI48_0_0RCTDevSettingsSetEnabled(BOOL enabled);
