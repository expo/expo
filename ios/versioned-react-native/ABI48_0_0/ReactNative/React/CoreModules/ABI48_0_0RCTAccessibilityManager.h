...
extern NSString *const ABI48_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification; // posted when multiplier is changed

@interface ABI48_0_0RCTAccessibilityManager : NSObject <ABI48_0_0RCTBridgeModule>
...
@interface ABI48_0_0RCTBridge (ABI48_0_0RCTAccessibilityManager)

@property (nonatomic, readonly) ABI48_0_0RCTAccessibilityManager *accessibilityManager;
