...
ABI48_0_0RCT_EXTERN NSString *const ABI48_0_0RCTShowDevMenuNotification;

#endif

@class ABI48_0_0RCTDevMenuItem;

/**
 * Developer menu, useful for exposing extra functionality when debugging.
 */
@interface ABI48_0_0RCTDevMenu : NSObject

/**
 * Deprecated, use ABI48_0_0RCTDevSettings instead.
 */
 ...
 */
@property (nonatomic, copy, readonly) NSArray<ABI48_0_0RCTDevMenuItem *> *presentedItems;
...
/**
 * Deprecated, use `ABI48_0_0RCTReloadCommand` instead.
 */
...
typedef NSString * (^ABI48_0_0RCTDevMenuItemTitleBlock)(void);

/**
 * Developer menu item, used to expose additional functionality via the menu.
 */
@interface ABI48_0_0RCTDevMenuItem : NSObject
 ...
 */
+ (instancetype)buttonItemWithTitleBlock:(ABI48_0_0RCTDevMenuItemTitleBlock)titleBlock handler:(dispatch_block_t)handler;

@end

/**
 * This category makes the developer menu instance available via the
 * ABI48_0_0RCTBridge, which is useful for any class that needs to access the menu.
 */
@interface ABI48_0_0RCTBridge (ABI48_0_0RCTDevMenu)

@property (nonatomic, readonly) ABI48_0_0RCTDevMenu *devMenu;
