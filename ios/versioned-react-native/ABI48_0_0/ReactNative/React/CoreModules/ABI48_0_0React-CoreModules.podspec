...
Pod::Spec.new do |s|
  s.name                   = "ABI48_0_0React-CoreModules"
  s.version                = version
  s.summary                = "-"  # TODO
  ...
  s.header_dir             = "ABI48_0_0CoreModules"
  ...
  s.dependency "ABI48_0_0React-Core/CoreModulesHeaders", version
  ...
  s.dependency 'ABI48_0_0React-RCTBlob'
end
