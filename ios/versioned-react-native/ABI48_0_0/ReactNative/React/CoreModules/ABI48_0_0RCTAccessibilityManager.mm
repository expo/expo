...
#import "ABI48_0_0RCTAccessibilityManager+Internal.h"
...
NSString *const ABI48_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification =
    @"ABI48_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification";

@interface ABI48_0_0RCTAccessibilityManager () <ABI48_0_0NativeAccessibilityManagerSpec>
...
@implementation ABI48_0_0RCTAccessibilityManager
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    self.contentSizeCategory = ABI48_0_0RCTSharedApplication().preferredContentSizeCategory;
...
- (void)invalidateMultiplier
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI48_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification
                                                      object:self];
}
...
- (CGFloat)multiplierForContentSizeCategory:(NSString *)category
{
  ...
  if (m.doubleValue <= 0.0) {
    ABI48_0_0RCTLogError(@"Can't determine multiplier for category %@. Using 1.0.", category);
    m = @1.0;
  }
...
ABI48_0_0RCT_EXPORT_METHOD(setAccessibilityContentSizeMultipliers
                  : (ABI48_0_0JS::NativeAccessibilityManager::SpecSetAccessibilityContentSizeMultipliersJSMultipliers &)
                      JSMultipliers)
{
...
ABI48_0_0RCT_EXPORT_METHOD(setAccessibilityFocus : (double)ABI48_0_0ReactTag)
{
  dispatch_async(dispatch_get_main_queue(), ^{
    UIView *view = [self.viewRegistry_DEPRECATED viewForABI48_0_0ReactTag:@(ABI48_0_0ReactTag)];
    UIAccessibilityPostNotification(UIAccessibilityLayoutChangedNotification, view);
  });
}

ABI48_0_0RCT_EXPORT_METHOD(announceForAccessibility : (NSString *)announcement)
{
  UIAccessibilityPostNotification(UIAccessibilityAnnouncementNotification, announcement);
}

ABI48_0_0RCT_EXPORT_METHOD(announceForAccessibilityWithOptions
                  : (NSString *)announcement options
                  : (ABI48_0_0JS::NativeAccessibilityManager::SpecAnnounceForAccessibilityWithOptionsOptions &)options)
{
...
ABI48_0_0RCT_EXPORT_METHOD(getMultiplier : (ABI48_0_0RCTResponseSenderBlock)callback)
{
  if (callback) {
...
ABI48_0_0RCT_EXPORT_METHOD(getCurrentBoldTextState
                  : (ABI48_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI48_0_0RCTResponseSenderBlock)onError)
{
  onSuccess(@[ @(_isBoldTextEnabled) ]);
}

ABI48_0_0RCT_EXPORT_METHOD(getCurrentGrayscaleState
                  : (ABI48_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI48_0_0RCTResponseSenderBlock)onError)
{
...
ABI48_0_0RCT_EXPORT_METHOD(getCurrentInvertColorsState
                  : (ABI48_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI48_0_0RCTResponseSenderBlock)onError)
{
...
ABI48_0_0RCT_EXPORT_METHOD(getCurrentReduceMotionState
                  : (ABI48_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI48_0_0RCTResponseSenderBlock)onError)
{
...
ABI48_0_0RCT_EXPORT_METHOD(getCurrentPrefersCrossFadeTransitionsState
                  : (ABI48_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI48_0_0RCTResponseSenderBlock)onError)
{
...
ABI48_0_0RCT_EXPORT_METHOD(getCurrentReduceTransparencyState
                  : (ABI48_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI48_0_0RCTResponseSenderBlock)onError)
{
...
ABI48_0_0RCT_EXPORT_METHOD(getCurrentVoiceOverState
                  : (ABI48_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI48_0_0RCTResponseSenderBlock)onError)
{
...
{
  return std::make_shared<ABI48_0_0facebook::ABI48_0_0React::NativeAccessibilityManagerSpecJSI>(params);
}
...
@implementation ABI48_0_0RCTBridge (ABI48_0_0RCTAccessibilityManager)

- (ABI48_0_0RCTAccessibilityManager *)accessibilityManager
{
  return [self moduleForClass:[ABI48_0_0RCTAccessibilityManager class]];
}

@end

Class ABI48_0_0RCTAccessibilityManagerCls(void)
{
  return ABI48_0_0RCTAccessibilityManager.class;
}
