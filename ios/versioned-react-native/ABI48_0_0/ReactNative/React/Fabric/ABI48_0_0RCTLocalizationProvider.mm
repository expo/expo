...
static id<ABI48_0_0RCTLocalizationProtocol> _delegate = nil;
static NSDictionary<NSString *, NSString *> *_languagePack = nil;

void setLocalizationDelegate(id<ABI48_0_0RCTLocalizationProtocol> delegate)
{
  _delegate = delegate;
}
...
@implementation ABI48_0_0RCTLocalizationProvider
