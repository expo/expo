 ...
 */
@protocol ABI48_0_0RCTMountingManagerDelegate <NSObject>
 ...
 */
- (void)mountingManager:(ABI48_0_0RCTMountingManager *)mountingManager willMountComponentsWithRootTag:(ABI48_0_0ReactTag)MountingManager;
