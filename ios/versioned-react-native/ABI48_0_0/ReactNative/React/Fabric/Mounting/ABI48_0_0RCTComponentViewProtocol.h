...
#import <ABI48_0_0React/ABI48_0_0renderer/componentregistry/ComponentDescriptorProvider.h>
...
#import <ABI48_0_0React/ABI48_0_0renderer/core/State.h>
 ...
 */
typedef NS_OPTIONS(NSInteger, ABI48_0_0RNComponentViewUpdateMask) {
  ABI48_0_0RNComponentViewUpdateMaskNone = 0,
  ABI48_0_0RNComponentViewUpdateMaskProps = 1 << 0,
  ABI48_0_0RNComponentViewUpdateMaskEventEmitter = 1 << 1,
  ABI48_0_0RNComponentViewUpdateMaskState = 1 << 3,
  ABI48_0_0RNComponentViewUpdateMaskLayoutMetrics = 1 << 4,

  ABI48_0_0RNComponentViewUpdateMaskAll = ABI48_0_0RNComponentViewUpdateMaskProps | ABI48_0_0RNComponentViewUpdateMaskEventEmitter |
      ABI48_0_0RNComponentViewUpdateMaskState | ABI48_0_0RNComponentViewUpdateMaskLayoutMetrics
};

/*
 * Represents a `UIView` instance managed by ABI48_0_0React.
 * All methods are non-@optional.
 * `UIView+ComponentViewProtocol` category provides default implementation
 * for all of them.
 */
@protocol ABI48_0_0RCTComponentViewProtocol <NSObject>
