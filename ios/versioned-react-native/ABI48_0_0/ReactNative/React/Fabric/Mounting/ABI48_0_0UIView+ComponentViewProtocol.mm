...
#import "ABI48_0_0UIView+ComponentViewProtocol.h"
...
{
  ABI48_0_0RCTAssert(NO, @"`-[ABI48_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented in a concrete class.");
  return {};
}
...
{
  ABI48_0_0RCTAssert(NO, @"props access should be implemented by ABI48_0_0RCTViewComponentView.");
  return nullptr;
}
