...
static NSAttributedString *ABI48_0_0RCTSanitizeAttributedString(NSAttributedString *attributedString)
{
...
{
  toTextInput.attributedText = ABI48_0_0RCTSanitizeAttributedString(fromTextInput.attributedText);
...
UIKeyboardAppearance ABI48_0_0RCTUIKeyboardAppearanceFromKeyboardAppearance(KeyboardAppearance keyboardAppearance)
{
...
UIKeyboardType ABI48_0_0RCTUIKeyboardTypeFromKeyboardType(KeyboardType keyboardType)
{
  switch (keyboardType) {
    // Universal
...
UIReturnKeyType ABI48_0_0RCTUIReturnKeyTypeFromReturnKeyType(ReturnKeyType returnKeyType)
{
...
UITextContentType ABI48_0_0RCTUITextContentTypeFromString(std::string const &contentType)
{
  ...
  return contentTypeMap[ABI48_0_0RCTNSStringFromString(contentType)] ?: @"";
}

API_AVAILABLE(ios(12.0))
UITextInputPasswordRules *ABI48_0_0RCTUITextInputPasswordRulesFromString(std::string const &passwordRules)
{
  return [UITextInputPasswordRules passwordRulesWithDescriptor:ABI48_0_0RCTNSStringFromStringNilIfEmpty(passwordRules)];
}
