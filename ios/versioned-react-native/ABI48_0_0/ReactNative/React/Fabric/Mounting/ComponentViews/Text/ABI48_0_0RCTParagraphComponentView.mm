...
@implementation ABI48_0_0RCTParagraphComponentView {
  ParagraphShadowNode::ConcreteState::Shared _state;
  ParagraphAttributes _paragraphAttributes;
  ABI48_0_0RCTParagraphComponentAccessibilityProvider *_accessibilityProvider;
...
- (NSAttributedString *_Nullable)attributedText
{
  ...
  return ABI48_0_0RCTNSAttributedStringFromAttributedString(_state->getData().attributedString);
}
...
- (void)drawRect:(CGRect)rect
{
  ...
  ABI48_0_0RCTTextLayoutManager *nativeTextLayoutManager =
      (ABI48_0_0RCTTextLayoutManager *)unwrapManagedObject(textLayoutManager->getNativeTextLayoutManager());

  CGRect frame = ABI48_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
  ...
  if (![_accessibilityProvider isUpToDate:data.attributedString]) {
    ...
    if (textLayoutManager) {
      ...
      _accessibilityProvider =
          [[ABI48_0_0RCTParagraphComponentAccessibilityProvider alloc] initWithString:data.attributedString
...
#pragma mark - ABI48_0_0RCTTouchableComponentViewProtocol
...
Class<ABI48_0_0RCTComponentViewProtocol> ABI48_0_0RCTParagraphCls(void)
{
  return ABI48_0_0RCTParagraphComponentView.class;
}
