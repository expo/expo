...
@interface ABI48_0_0RCTEnhancedScrollView () <UIScrollViewDelegate>
@end

@implementation ABI48_0_0RCTEnhancedScrollView {
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _delegateSplitter = [[ABI48_0_0RCTGenericDelegateSplitter alloc] initWithDelegateUpdateBlock:^(id delegate) {
...
#pragma mark - ABI48_0_0RCTGenericDelegateSplitter
