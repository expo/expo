...
#import "ABI48_0_0RCTModalHostViewComponentView.h"

#import <ABI48_0_0React/ABI48_0_0RCTBridge+Private.h>
#import <ABI48_0_0React/ABI48_0_0RCTModalManager.h>
#import <ABI48_0_0React/ABI48_0_0UIView+React.h>
#import <ABI48_0_0React/ABI48_0_0renderer/components/modal/ModalHostViewComponentDescriptor.h>
#import <ABI48_0_0React/ABI48_0_0renderer/components/modal/ModalHostViewState.h>
...
@interface ABI48_0_0RCTModalHostViewComponentView () <ABI48_0_0RCTFabricModalHostViewControllerDelegate>

@end

@implementation ABI48_0_0RCTModalHostViewComponentView {
  ABI48_0_0RCTFabricModalHostViewController *_viewController;
...
- (ABI48_0_0RCTFabricModalHostViewController *)viewController
{
  if (!_viewController) {
    _viewController = [ABI48_0_0RCTFabricModalHostViewController new];
...
{
  UIViewController *controller = [self ABI48_0_0ReactViewController];
...
#pragma mark - ABI48_0_0RCTFabricModalHostViewControllerDelegate
...
- (void)boundsDidChange:(CGRect)newBounds
{
  ...
  if (_state != nullptr) {
    auto newState = ModalHostViewState{ABI48_0_0RCTSizeFromCGSize(newBounds.size)};
...
Class<ABI48_0_0RCTComponentViewProtocol> ABI48_0_0RCTModalHostViewCls(void);
...
Class<ABI48_0_0RCTComponentViewProtocol> ABI48_0_0RCTModalHostViewCls(void)
{
  return ABI48_0_0RCTModalHostViewComponentView.class;
}
