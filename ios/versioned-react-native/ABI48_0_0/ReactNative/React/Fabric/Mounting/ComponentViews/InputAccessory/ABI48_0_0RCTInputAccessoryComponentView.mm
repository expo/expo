...
#import "ABI48_0_0RCTInputAccessoryComponentView.h"
...
#import <ABI48_0_0React/ABI48_0_0renderer/components/inputaccessory/InputAccessoryComponentDescriptor.h>
#import <ABI48_0_0React/ABI48_0_0renderer/components/rncore/Props.h>
#import "ABI48_0_0RCTInputAccessoryContentView.h"

#import "ABI48_0_0RCTFabricComponentsPlugins.h"

using namespace ABI48_0_0facebook::ABI48_0_0React;

static UIView<ABI48_0_0RCTBackedTextInputViewProtocol> *_Nullable ABI48_0_0RCTFindTextInputWithNativeId(UIView *view, NSString *nativeId)
{
  if ([view respondsToSelector:@selector(inputAccessoryViewID)] &&
      [view respondsToSelector:@selector(setInputAccessoryView:)]) {
    UIView<ABI48_0_0RCTBackedTextInputViewProtocol> *typed = (UIView<ABI48_0_0RCTBackedTextInputViewProtocol> *)view;
  ...
  for (UIView *subview in view.subviews) {
    UIView<ABI48_0_0RCTBackedTextInputViewProtocol> *result = ABI48_0_0RCTFindTextInputWithNativeId(subview, nativeId);
    if (result) {
      return result;
    }
  }
...
@implementation ABI48_0_0RCTInputAccessoryComponentView {
  InputAccessoryShadowNode::ConcreteState::Shared _state;
  ABI48_0_0RCTInputAccessoryContentView *_contentView;
  ABI48_0_0RCTSurfaceTouchHandler *_touchHandler;
  UIView<ABI48_0_0RCTBackedTextInputViewProtocol> __weak *_textInput;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _props = defaultProps;
    _contentView = [ABI48_0_0RCTInputAccessoryContentView new];
...
- (void)didMoveToWindow
{
  ...
  if (self.window && !_textInput) {
    if (self.nativeId) {
      _textInput = ABI48_0_0RCTFindTextInputWithNativeId(self.window, self.nativeId);
      _textInput.inputAccessoryView = _contentView;
    } else {
      _textInput = ABI48_0_0RCTFindTextInputWithNativeId(_contentView, nil);
    }
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (newInputAccessoryProps.backgroundColor != oldInputAccessoryProps.backgroundColor) {
    _contentView.backgroundColor = ABI48_0_0RCTUIColorFromSharedColor(newInputAccessoryProps.backgroundColor);
  }
...
- (void)updateState:(const ABI48_0_0facebook::ABI48_0_0React::State::Shared &)state
           oldState:(const ABI48_0_0facebook::ABI48_0_0React::State::Shared &)oldState
{
  _state = std::static_pointer_cast<InputAccessoryShadowNode::ConcreteState const>(state);
  CGSize oldScreenSize = ABI48_0_0RCTCGSizeFromSize(_state->getData().viewportSize);
  CGSize viewportSize = ABI48_0_0RCTViewportSize();
  viewportSize.height = std::nan("");
  if (oldScreenSize.width != viewportSize.width) {
    auto stateData = InputAccessoryState{ABI48_0_0RCTSizeFromCGSize(viewportSize)};
           ...
           oldLayoutMetrics:(LayoutMetrics const &)oldLayoutMetrics
{
  ...
  [_contentView setFrame:ABI48_0_0RCTCGRectFromRect(layoutMetrics.getContentFrame())];
}
...
Class<ABI48_0_0RCTComponentViewProtocol> ABI48_0_0RCTInputAccessoryCls(void)
{
  return ABI48_0_0RCTInputAccessoryComponentView.class;
}
