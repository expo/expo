...
#import "ABI48_0_0RCTPullToRefreshViewComponentView.h"
...
#import <ABI48_0_0React/ABI48_0_0renderer/components/rncore/ABI48_0_0RCTComponentViewHelpers.h>

#import <ABI48_0_0React/ABI48_0_0RCTConversions.h>
#import <ABI48_0_0React/ABI48_0_0RCTRefreshableProtocol.h>
...
@interface ABI48_0_0RCTPullToRefreshViewComponentView () <ABI48_0_0RCTPullToRefreshViewViewProtocol, ABI48_0_0RCTRefreshableProtocol>
@end

@implementation ABI48_0_0RCTPullToRefreshViewComponentView {
  UIRefreshControl *_refreshControl;
  ABI48_0_0RCTScrollViewComponentView *__weak _scrollViewComponentView;
}
...
- (void)_updateTitle
{
  ...
  if (concreteProps.titleColor) {
    attributes[NSForegroundColorAttributeName] = ABI48_0_0RCTUIColorFromSharedColor(concreteProps.titleColor);
  }

  _refreshControl.attributedTitle =
      [[NSAttributedString alloc] initWithString:ABI48_0_0RCTNSStringFromString(concreteProps.title) attributes:attributes];
}
...
- (void)_attach
{
  ...
  _scrollViewComponentView = [ABI48_0_0RCTScrollViewComponentView findScrollViewComponentViewForView:self];
  if (!_scrollViewComponentView) {
    return;
  }
...
{
  ABI48_0_0RCTPullToRefreshViewHandleCommand(self, commandName, args);
}
...
#pragma mark - ABI48_0_0RCTRefreshableProtocol
...
Class<ABI48_0_0RCTComponentViewProtocol> ABI48_0_0RCTPullToRefreshViewCls(void)
{
  return ABI48_0_0RCTPullToRefreshViewComponentView.class;
}
