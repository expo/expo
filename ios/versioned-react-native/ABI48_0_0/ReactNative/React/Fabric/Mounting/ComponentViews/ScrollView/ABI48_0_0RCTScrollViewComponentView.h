 ...
 */
@interface ABI48_0_0RCTScrollViewComponentView : ABI48_0_0RCTViewComponentView <ABI48_0_0RCTMountingTransactionObserving>

/*
 * Finds and returns the closet ABI48_0_0RCTScrollViewComponentView component to the given view
 */
+ (nullable ABI48_0_0RCTScrollViewComponentView *)findScrollViewComponentViewForView:(UIView *)view;
...
/*
 * ABI48_0_0RCTScrollableProtocol is a protocol which ABI48_0_0RCTScrollViewManager uses to communicate with all kinds of `UIScrollView`s.
 ...
 */
@interface ABI48_0_0RCTScrollViewComponentView (ScrollableProtocol) <ABI48_0_0RCTScrollableProtocol>
