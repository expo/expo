...
#import "ABI48_0_0RCTSwitchComponentView.h"
...
@interface ABI48_0_0RCTSwitchComponentView () <ABI48_0_0RCTSwitchViewProtocol>
@end

@implementation ABI48_0_0RCTSwitchComponentView {
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldSwitchProps.tintColor != newSwitchProps.tintColor) {
    _switchView.tintColor = ABI48_0_0RCTUIColorFromSharedColor(newSwitchProps.tintColor);
  }

  // `onTintColor
  if (oldSwitchProps.onTintColor != newSwitchProps.onTintColor) {
    _switchView.onTintColor = ABI48_0_0RCTUIColorFromSharedColor(newSwitchProps.onTintColor);
  }

  // `thumbTintColor`
  if (oldSwitchProps.thumbTintColor != newSwitchProps.thumbTintColor) {
    _switchView.thumbTintColor = ABI48_0_0RCTUIColorFromSharedColor(newSwitchProps.thumbTintColor);
  }
...
{
  ABI48_0_0RCTSwitchHandleCommand(self, commandName, args);
}
...
Class<ABI48_0_0RCTComponentViewProtocol> ABI48_0_0RCTSwitchCls(void)
{
  return ABI48_0_0RCTSwitchComponentView.class;
}
