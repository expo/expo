...
#import "ABI48_0_0RCTActivityIndicatorViewComponentView.h"
...
@implementation ABI48_0_0RCTActivityIndicatorViewComponentView {
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _activityIndicatorView.color = ABI48_0_0RCTUIColorFromSharedColor(defaultProps->color);
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldViewProps.color != newViewProps.color) {
    _activityIndicatorView.color = ABI48_0_0RCTUIColorFromSharedColor(newViewProps.color);
  }
...
Class<ABI48_0_0RCTComponentViewProtocol> ABI48_0_0RCTActivityIndicatorViewCls(void)
{
  return ABI48_0_0RCTActivityIndicatorViewComponentView.class;
}
