...
/**
 * (This is Fabric-compatible ABI48_0_0RCTSurface implementation.)
 *
 * ABI48_0_0RCTSurface instance represents ABI48_0_0React Native-powered piece of a user interface
 * which can be a full-screen app, separate modal view controller,
 * or even small widget.
 * It is called "Surface".
 *
 * The ABI48_0_0RCTSurface instance is completely thread-safe by design;
 ...
 *
 * The primary goals of the ABI48_0_0RCTSurface are:
 ...
 */
@interface ABI48_0_0RCTFabricSurface : NSObject <ABI48_0_0RCTSurfaceProtocol>

- (instancetype)initWithSurfacePresenter:(ABI48_0_0RCTSurfacePresenter *)surfacePresenter
...
/**
 * Simple shortcut to `-[ABI48_0_0RCTSurface setMinimumSize:size maximumSize:size]`.
 */
...
@interface ABI48_0_0RCTFabricSurface (Internal)

- (ABI48_0_0facebook::ABI48_0_0React::SurfaceHandler const &)surfaceHandler;

@end

@interface ABI48_0_0RCTFabricSurface (Deprecated)
