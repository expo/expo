...
#import "ABI48_0_0RCTRedBoxExtraDataViewController.h"

@interface ABI48_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI48_0_0RCTRedBoxExtraDataCell
...
@interface ABI48_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI48_0_0RCTRedBoxExtraDataViewController {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  ABI48_0_0RCTRedBoxExtraDataCell *cell =
      (ABI48_0_0RCTRedBoxExtraDataCell *)[tableView dequeueReusableCellWithIdentifier:reuseIdentifier];

  if (cell == nil) {
    cell = [[ABI48_0_0RCTRedBoxExtraDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
  }
