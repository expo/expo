 ...
 */
ABI48_0_0RCT_EXTERN NSString *const ABI48_0_0RCTUIManagerWillUpdateViewsDueToContentSizeMultiplierChangeNotification;

@class ABI48_0_0RCTLayoutAnimationGroup;
@class ABI48_0_0RCTUIManagerObserverCoordinator;

/**
 * The ABI48_0_0RCTUIManager is the module responsible for updating the view hierarchy.
 */
@interface ABI48_0_0RCTUIManager : NSObject <ABI48_0_0RCTBridgeModule, ABI48_0_0RCTInvalidating>
...
/**
 * Register a root view with the ABI48_0_0RCTUIManager.
 */
- (void)registerRootView:(UIView *)rootView;

/**
 * Gets the view name associated with a ABI48_0_0ReactTag.
 */
- (NSString *)viewNameForABI48_0_0ReactTag:(NSNumber *)ABI48_0_0ReactTag;

/**
 * Gets the view associated with a ABI48_0_0ReactTag.
 */
- (UIView *)viewForABI48_0_0ReactTag:(NSNumber *)ABI48_0_0ReactTag;

/**
 * Gets the shadow view associated with a ABI48_0_0ReactTag.
 */
 ...
 * the shadow view.
 * Please respect one-directional data flow of ABI48_0_0React.
 */
 ...
 * or some other layout event outside of the ABI48_0_0React-managed view hierarchy.
 */
 ...
 */
- (void)synchronouslyUpdateViewOnUIThread:(NSNumber *)ABI48_0_0ReactTag
                                 viewName:(NSString *)viewName
                                    props:(NSDictionary *)props;

/**
 * Given a ABI48_0_0ReactTag from a component, find its root view, if possible.
 * Otherwise, this will give back nil.
 *
 * @param ABI48_0_0ReactTag the component tag
 ...
 * @param rootTag the ABI48_0_0React tag of root view hierarchy from which to find the view.
 */
 ...
 * ABI48_0_0React won't be aware of this, so we need to make sure it happens.
 */
- (void)setNeedsLayout;

/**
 * Dedicated object for subscribing for UIManager events.
 * See `ABI48_0_0RCTUIManagerObserver` protocol for more details.
 */
@property (atomic, retain, readonly) ABI48_0_0RCTUIManagerObserverCoordinator *observerCoordinator;

@end

/**
 * This category makes the current ABI48_0_0RCTUIManager instance available via the
 * ABI48_0_0RCTBridge, which is useful for ABI48_0_0RCTBridgeModules or ABI48_0_0RCTViewManagers that
 * need to access the ABI48_0_0RCTUIManager.
 */
@interface ABI48_0_0RCTBridge (ABI48_0_0RCTUIManager)

@property (nonatomic, readonly) ABI48_0_0RCTUIManager *uiManager;
