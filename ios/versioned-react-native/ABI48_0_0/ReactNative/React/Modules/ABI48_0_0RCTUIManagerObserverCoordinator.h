...
typedef dispatch_block_t ABI48_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI48_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ABI48_0_0React-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI48_0_0RCTUIManager's observers.
 */
@interface ABI48_0_0RCTUIManagerObserverCoordinator : NSObject <ABI48_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI48_0_0RCTUIManagerObserver` protocol for more info.
