...
@interface ABI48_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>

@end

@implementation ABI48_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI48_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI48_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI48_0_0RCTMultipartStreamReader *reader = [[ABI48_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream
                                                                                  boundary:_boundary];
  ABI48_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
