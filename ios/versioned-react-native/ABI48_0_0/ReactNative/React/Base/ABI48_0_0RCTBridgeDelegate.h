...
@protocol ABI48_0_0RCTBridgeDelegate <NSObject>
...
/**
 * The bridge initializes any registered ABI48_0_0RCTBridgeModules automatically, however
 ...
 * previously called ABI48_0_0facebook::ABI48_0_0React::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI48_0_0RCTBridge *)bridge;
 ...
 */
- (BOOL)bridge:(ABI48_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI48_0_0RCTBridge *)bridge
                 onProgress:(ABI48_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI48_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Similar to loadSourceForBridge:onProgress:onComplete: but without progress
 * reporting.
 */
- (void)loadSourceForBridge:(ABI48_0_0RCTBridge *)bridge withBlock:(ABI48_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Retrieve the list of lazy-native-modules names for the given bridge.
 */
- (NSDictionary<NSString *, Class> *)extraLazyModuleClassesForBridge:(ABI48_0_0RCTBridge *)bridge;
