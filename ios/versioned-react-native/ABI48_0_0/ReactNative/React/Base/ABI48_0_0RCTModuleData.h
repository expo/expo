...
typedef id<ABI48_0_0RCTBridgeModule> (^ABI48_0_0RCTBridgeModuleProvider)(void);

@interface ABI48_0_0RCTModuleData : NSObject <ABI48_0_0RCTInvalidating>

- (instancetype)initWithModuleClass:(Class)moduleClass
                             bridge:(ABI48_0_0RCTBridge *)bridge
                     moduleRegistry:(ABI48_0_0RCTModuleRegistry *)moduleRegistry
            viewRegistry_DEPRECATED:(ABI48_0_0RCTViewRegistry *)viewRegistry_DEPRECATED
                      bundleManager:(ABI48_0_0RCTBundleManager *)bundleManager
                  callableJSModules:(ABI48_0_0RCTCallableJSModules *)callableJSModules;

- (instancetype)initWithModuleClass:(Class)moduleClass
                     moduleProvider:(ABI48_0_0RCTBridgeModuleProvider)moduleProvider
                             bridge:(ABI48_0_0RCTBridge *)bridge
                     moduleRegistry:(ABI48_0_0RCTModuleRegistry *)moduleRegistry
            viewRegistry_DEPRECATED:(ABI48_0_0RCTViewRegistry *)viewRegistry_DEPRECATED
                      bundleManager:(ABI48_0_0RCTBundleManager *)bundleManager
                  callableJSModules:(ABI48_0_0RCTCallableJSModules *)callableJSModules NS_DESIGNATED_INITIALIZER;

- (instancetype)initWithModuleInstance:(id<ABI48_0_0RCTBridgeModule>)instance
                                bridge:(ABI48_0_0RCTBridge *)bridge
                        moduleRegistry:(ABI48_0_0RCTModuleRegistry *)moduleRegistry
               viewRegistry_DEPRECATED:(ABI48_0_0RCTViewRegistry *)viewRegistry_DEPRECATED
                         bundleManager:(ABI48_0_0RCTBundleManager *)bundleManager
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI48_0_0RCTBridgeMethod>> *methods;

/**
 * Returns a map of the module methods. Note that this will gather the methods the first
 * time it is called and then memoize the results.
 */
@property (nonatomic, copy, readonly) NSDictionary<NSString *, id<ABI48_0_0RCTBridgeMethod>> *methodsByName;
 ...
 */
@property (nonatomic, strong, readwrite) id<ABI48_0_0RCTBridgeModule> instance;
...
ABI48_0_0RCT_EXTERN void ABI48_0_0RCTSetIsMainQueueExecutionOfConstantsToExportDisabled(BOOL val);
ABI48_0_0RCT_EXTERN BOOL ABI48_0_0RCTIsMainQueueExecutionOfConstantsToExportDisabled(void);
