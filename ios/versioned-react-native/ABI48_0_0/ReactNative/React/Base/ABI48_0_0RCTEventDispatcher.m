...
const NSInteger ABI48_0_0RCTTextUpdateLagWarningThreshold = 3;

NSString *ABI48_0_0RCTNormalizeInputEventName(NSString *eventName)
{
...
@implementation ABI48_0_0RCTBridge (ABI48_0_0RCTEventDispatcher)
