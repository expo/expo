 ...
 */
@interface ABI48_0_0RCTImageSource : NSObject
...
@interface ABI48_0_0RCTConvert (ImageSource)

+ (ABI48_0_0RCTImageSource *)ABI48_0_0RCTImageSource:(id)json;
+ (NSArray<ABI48_0_0RCTImageSource *> *)ABI48_0_0RCTImageSourceArray:(id)json;
