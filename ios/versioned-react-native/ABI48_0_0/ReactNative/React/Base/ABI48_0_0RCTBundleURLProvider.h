...
ABI48_0_0RCT_EXTERN NSString *const ABI48_0_0RCTBundleURLProviderUpdatedNotification;
ABI48_0_0RCT_EXTERN const NSUInteger kABI48_0_0RCTBundleURLProviderDefaultPort;
 ...
 * by calling this function before initializing ABI48_0_0React Native (ABI48_0_0RCTBridge etc).
 * By default the access is enabled.
 */
ABI48_0_0RCT_EXTERN void ABI48_0_0RCTBundleURLProviderAllowPackagerServerAccess(BOOL allowed);
#endif

@interface ABI48_0_0RCTBundleURLProvider : NSObject
 ...
 * The port is optional, if not specified, kABI48_0_0RCTBundleURLProviderDefaultPort will be used
 */
