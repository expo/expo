...
static void collectNonTextDescendants(ABI7_0_0RCTText *view, NSMutableArray *nonTextDescendants)
{
  for (UIView *child in view.ReactABI7_0_0Subviews) {
    if ([child isKindOfClass:[ABI7_0_0RCTText class]]) {
      collectNonTextDescendants((ABI7_0_0RCTText *)child, nonTextDescendants);
    } else {
...
@implementation ABI7_0_0RCTText
{
...
- (NSString *)description
{
  ...
  NSString *replacement = [NSString stringWithFormat:@"; ReactABI7_0_0Tag: %@; text: %@", self.ReactABI7_0_0Tag, self.textStorage.string];
...
- (void)ReactABI7_0_0SetInheritedBackgroundColor:(UIColor *)inheritedBackgroundColor
{
...
- (void)drawRect:(CGRect)rect
{
  ...
  [layoutManager.textStorage enumerateAttribute:ABI7_0_0RCTIsHighlightedAttributeName inRange:characterRange options:0 usingBlock:^(NSNumber *value, NSRange range, BOOL *_) {
    if (!value.boolValue) {
      return;
    }
...
{
  NSNumber *ReactABI7_0_0Tag = self.ReactABI7_0_0Tag;
  ...
  if (_textStorage.length > 0 && (fraction > 0 || characterIndex > 0) && (fraction < 1 || characterIndex < _textStorage.length - 1)) {
    ReactABI7_0_0Tag = [_textStorage attribute:ABI7_0_0RCTReactABI7_0_0TagAttributeName atIndex:characterIndex effectiveRange:NULL];
  }
  return ReactABI7_0_0Tag;
}
