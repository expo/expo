...
@interface ABI7_0_0ARTRenderable : ABI7_0_0ARTNode

@property (nonatomic, strong) ABI7_0_0ARTBrush *fill;
...
@property (nonatomic, assign) ABI7_0_0ARTCGFloatArray strokeDash;
