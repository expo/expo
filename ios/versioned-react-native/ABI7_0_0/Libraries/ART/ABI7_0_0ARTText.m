...
@implementation ABI7_0_0ARTText
...
static void ABI7_0_0ARTFreeTextFrame(ABI7_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI7_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI7_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI7_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI7_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
