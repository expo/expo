...
#import "ABI7_0_0RCTXCAssetImageLoader.h"

#import <libkern/OSAtomic.h>

#import "ABI7_0_0RCTUtils.h"

@implementation ABI7_0_0RCTXCAssetImageLoader

ABI7_0_0RCT_EXPORT_MODULE()

- (BOOL)canLoadImageURL:(NSURL *)requestURL
{
  return ABI7_0_0RCTIsXCAssetURL(requestURL);
}
                                  ...
                                  completionHandler:(ABI7_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    NSString *imageName = ABI7_0_0RCTBundlePathForURL(imageURL);
    ...
    if (image) {
      ...
      completionHandler(ABI7_0_0RCTErrorWithMessage(message), nil);
    }
  });
