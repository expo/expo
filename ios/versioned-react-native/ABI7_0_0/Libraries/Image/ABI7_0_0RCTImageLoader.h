...
typedef void (^ABI7_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI7_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef void (^ABI7_0_0RCTImageLoaderCancellationBlock)(void);

@interface UIImage (ReactABI7_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI7_0_0KeyframeAnimation;

@end

@interface ABI7_0_0RCTImageLoader : NSObject <ABI7_0_0RCTBridgeModule, ABI7_0_0RCTURLRequestHandler>
...
- (ABI7_0_0RCTImageLoaderCancellationBlock)loadImageWithTag:(NSString *)imageTag
                                      ...
                                      progressBlock:(ABI7_0_0RCTImageLoaderProgressBlock)progressBlock
                                    completionBlock:(ABI7_0_0RCTImageLoaderCompletionBlock)completionBlock;

/**
 * Loads an image without clipping the result to fit - used by ABI7_0_0RCTImageView.
 */
...
@interface ABI7_0_0RCTBridge (ABI7_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI7_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI7_0_0RCTImageURLLoader <ABI7_0_0RCTBridgeModule>
...
/**
 * If more than one ABI7_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 */
@protocol ABI7_0_0RCTImageDataDecoder <ABI7_0_0RCTBridgeModule>
...
/**
 * If more than one ABI7_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
