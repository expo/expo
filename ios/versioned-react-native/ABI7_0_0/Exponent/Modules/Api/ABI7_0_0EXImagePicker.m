#import "ABI7_0_0EXImagePicker.h"
...
@interface ABI7_0_0EXImagePicker ()

@property (nonatomic, strong) UIAlertController *alertController;
@property (nonatomic, strong) UIImagePickerController *picker;
@property (nonatomic, strong) ABI7_0_0RCTPromiseResolveBlock resolve;
@property (nonatomic, strong) ABI7_0_0RCTPromiseRejectBlock reject;
...
@implementation ABI7_0_0EXImagePicker

ABI7_0_0RCT_EXPORT_MODULE(ExponentImagePicker);
...
ABI7_0_0RCT_EXPORT_METHOD(launchCameraAsync:(NSDictionary *)options
...
ABI7_0_0RCT_EXPORT_METHOD(launchImageLibraryAsync:(NSDictionary *)options
                  resolver:(ABI7_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI7_0_0RCTPromiseRejectBlock)reject)
{
    self.resolve = resolve;
...
- (void)launchImagePicker:(RNImagePickerTarget)target
{
    ...
    if (target == RNImagePickerTargetCamera) {
        ...
        self.reject(ABI7_0_0RCTErrorUnspecified, @"Camera not available on simulator", nil);
        return;
#else
        ...
        if ([self.options objectForKey:@"storageOptions"] && [[self.options objectForKey:@"storageOptions"] isKindOfClass:[NSDictionary class]]) {
            ...
            if ([storageOptions objectForKey:@"path"]) {
                ...
                if (error) {
                    ...
                    self.reject(ABI7_0_0RCTErrorUnspecified, error.localizedFailureReason, error);
                    return;
                }
                else {
