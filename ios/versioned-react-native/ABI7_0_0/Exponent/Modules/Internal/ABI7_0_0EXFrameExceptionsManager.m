...
@implementation ABI7_0_0EXFrameExceptionsManager {
  __weak id<ABI7_0_0RCTExceptionsManagerDelegate> _delegate;
}

@synthesize bridge = _bridge;

+ (NSString *)moduleName { return @"ABI7_0_0RCTExceptionsManager"; }
...
{
  // this will hit ABI7_0_0EXDisabledRedBox when not debugging
