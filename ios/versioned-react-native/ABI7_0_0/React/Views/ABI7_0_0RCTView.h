...
@protocol ABI7_0_0RCTAutoInsetsProtocol;

@class ABI7_0_0RCTView;

@interface ABI7_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI7_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI7_0_0RCTDirectEventBlock onMagicTap;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI7_0_0RCTPointerEvents pointerEvents;

+ (void)autoAdjustInsetsForView:(UIView<ABI7_0_0RCTAutoInsetsProtocol> *)parentView
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI7_0_0RCTBorderStyle borderStyle;
