...
@implementation ABI7_0_0RCTConvert (UITabBarSystemItem)

ABI7_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI7_0_0RCTTabBarItem
...
{
  return self.superview.ReactABI7_0_0ViewController;
}
