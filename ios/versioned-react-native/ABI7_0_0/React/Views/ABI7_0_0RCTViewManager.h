...
@class ABI7_0_0RCTShadowView;
@class ABI7_0_0RCTSparseArray;
@class ABI7_0_0RCTUIManager;

typedef void (^ABI7_0_0RCTViewManagerUIBlock)(ABI7_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry);

@interface ABI7_0_0RCTViewManager : NSObject <ABI7_0_0RCTBridgeModule>

/**
 * The bridge can be used to access both the ABI7_0_0RCTUIIManager and the ABI7_0_0RCTEventDispatcher,
 * allowing the manager (or the views that it manages) to manipulate the view
 * hierarchy and send events back to the JS context.
 */
@property (nonatomic, weak) ABI7_0_0RCTBridge *bridge;
 ...
 * an ordinary ABI7_0_0RCTShadowView instance will be created, which is typically fine for
...
/**
 * DEPRECATED: declare properties of type ABI7_0_0RCTBubblingEventBlock instead
 *
 ...
 */
- (NSArray<NSString *> *)customBubblingEventTypes __deprecated_msg("Use ABI7_0_0RCTBubblingEventBlock props instead.");

/**
 * DEPRECATED: declare properties of type ABI7_0_0RCTDirectEventBlock instead
 *
 * Returns an array of names of events that can be sent by native views. This
 ...
 */
- (NSArray<NSString *> *)customDirectEventTypes __deprecated_msg("Use ABI7_0_0RCTDirectEventBlock props instead.");
 ...
 */
#define ABI7_0_0RCT_CUSTOM_VIEW_PROPERTY(name, type, viewClass) \
ABI7_0_0RCT_REMAP_VIEW_PROPERTY(name, __custom__, type)         \
- (void)set_##name:(id)json forView:(viewClass *)view withDefaultView:(viewClass *)defaultView

/**
 * This macro is used to map properties to the shadow view, instead of the view.
 */
#define ABI7_0_0RCT_EXPORT_SHADOW_PROPERTY(name, type) \
