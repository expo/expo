...
static const CGFloat ABI7_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI7_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return
  ABS(borderInsets.left - borderInsets.right) < ABI7_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.bottom) < ABI7_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.top) < ABI7_0_0RCTViewBorderThreshold;
}

BOOL ABI7_0_0RCTCornerRadiiAreEqual(ABI7_0_0RCTCornerRadii cornerRadii)
{
  return
  ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI7_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI7_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI7_0_0RCTViewBorderThreshold;
}
...
{
  return (ABI7_0_0RCTCornerInsets) {
    {
...
static void ABI7_0_0RCTPathAddEllipticArc(CGMutablePathRef path,
                                       ...
                                       const CGAffineTransform *transform)
{
  ...
  ABI7_0_0RCTPathAddEllipticArc(path, transform, (CGPoint){
...
static void ABI7_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds,
                                               CGPoint lineStart,
                                               CGPoint lineEnd,
...
NS_INLINE BOOL ABI7_0_0RCTCornerRadiiAreAboveThreshold(ABI7_0_0RCTCornerRadii cornerRadii) {
  return (cornerRadii.topLeft > ABI7_0_0RCTViewBorderThreshold ||
    cornerRadii.topRight > ABI7_0_0RCTViewBorderThreshold      ||
    cornerRadii.bottomLeft > ABI7_0_0RCTViewBorderThreshold    ||
    cornerRadii.bottomRight > ABI7_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI7_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI7_0_0RCTCornerRadii cornerRadii) {
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI7_0_0RCTPathCreateWithRoundedRect(rect, ABI7_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef ABI7_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge) {
...
static UIImage *ABI7_0_0RCTGetSolidBorderImage(ABI7_0_0RCTCornerRadii cornerRadii,
                                       CGSize viewSize,
                                       ...
                                       BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI7_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI7_0_0RCTCornerInsets cornerInsets = ABI7_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  CGContextRef ctx = ABI7_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI7_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI7_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI7_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI7_0_0RCTEllipseGetIntersectionsWithLine((CGRect){
...
static UIImage *ABI7_0_0RCTGetDashedOrDottedBorderImage(ABI7_0_0RCTBorderStyle borderStyle,
                                                ...
                                                BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI7_0_0RCTBorderStyleDashed || borderStyle == ABI7_0_0RCTBorderStyleDotted);

  if (!ABI7_0_0RCTBorderColorsAreEqual(borderColors) || !ABI7_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI7_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI7_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI7_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI7_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI7_0_0RCTPathCreateWithRoundedRect(pathRect, ABI7_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI7_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
                           ...
                           BOOL drawToEdge)
{
  ...
  switch (borderStyle) {
    case ABI7_0_0RCTBorderStyleSolid:
      return ABI7_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI7_0_0RCTBorderStyleDashed:
    case ABI7_0_0RCTBorderStyleDotted:
      return ABI7_0_0RCTGetDashedOrDottedBorderImage(borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI7_0_0RCTBorderStyleUnset:
      break;
  }
