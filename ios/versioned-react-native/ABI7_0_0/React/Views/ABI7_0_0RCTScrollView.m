...
@property (nonatomic, strong) ABI7_0_0RCTRefreshControl *refreshControl;
...
- (void)setRefreshControl:(ABI7_0_0RCTRefreshControl *)refreshControl
{
  if (_refreshControl) {
...
- (void)insertReactABI7_0_0Subview:(UIView *)view atIndex:(__unused NSInteger)atIndex
{
  if ([view isKindOfClass:[ABI7_0_0RCTRefreshControl class]]) {
    _scrollView.refreshControl = (ABI7_0_0RCTRefreshControl*)view;
  } else {
...
- (void)layoutSubviews
{
  ...
  ABI7_0_0RCTRefreshControl *refreshControl = _scrollView.refreshControl;
