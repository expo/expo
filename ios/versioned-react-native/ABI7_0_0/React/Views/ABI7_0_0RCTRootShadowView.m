...
#import "ABI7_0_0RCTRootShadowView.h"

@implementation ABI7_0_0RCTRootShadowView

- (void)applySizeConstraints
{
  switch (_sizeFlexibility) {
    case ABI7_0_0RCTRootViewSizeFlexibilityNone:
      break;
    case ABI7_0_0RCTRootViewSizeFlexibilityWidth:
      self.cssNode->style.dimensions[CSS_WIDTH] = CSS_UNDEFINED;
      break;
    case ABI7_0_0RCTRootViewSizeFlexibilityHeight:
      self.cssNode->style.dimensions[CSS_HEIGHT] = CSS_UNDEFINED;
      break;
    case ABI7_0_0RCTRootViewSizeFlexibilityWidthAndHeight:
      self.cssNode->style.dimensions[CSS_WIDTH] = CSS_UNDEFINED;
      self.cssNode->style.dimensions[CSS_HEIGHT] = CSS_UNDEFINED;
      break;
  }
...
- (NSSet<ABI7_0_0RCTShadowView *> *)collectViewsWithUpdatedFrames
{
  ...
  NSMutableSet<ABI7_0_0RCTShadowView *> *viewsWithNewFrame = [NSMutableSet set];
