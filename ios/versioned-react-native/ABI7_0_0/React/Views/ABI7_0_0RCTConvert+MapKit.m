...
@implementation ABI7_0_0RCTConvert(MapKit)
...
ABI7_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
{
  json = [self NSDictionary:json];
  ABI7_0_0RCTMapAnnotation *annotation = [ABI7_0_0RCTMapAnnotation new];
...
ABI7_0_0RCT_ARRAY_CONVERTER(ABI7_0_0RCTMapAnnotation)
...
+ (ABI7_0_0RCTMapOverlay *)ABI7_0_0RCTMapOverlay:(id)json
{
  ...
  ABI7_0_0RCTMapOverlay *overlay = [ABI7_0_0RCTMapOverlay polylineWithCoordinates:coordinates
...
ABI7_0_0RCT_ARRAY_CONVERTER(ABI7_0_0RCTMapOverlay)
