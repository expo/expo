...
@interface UIView (ReactABI7_0_0) <ABI7_0_0RCTComponent>
...
- (BOOL)ReactABI7_0_0RespondsToTouch:(UITouch *)touch;

/**
 Tools for debugging
 */
#if ABI7_0_0RCT_DEV
@property (nonatomic, strong, setter=_DEBUG_setReactABI7_0_0ShadowView:) ABI7_0_0RCTShadowView *_DEBUG_ReactABI7_0_0ShadowView;
#endif
