...
static NSString *ABI7_0_0RCTCurrentAppBackgroundState()
{
  ...
  return states[@(ABI7_0_0RCTSharedApplication().applicationState)] ?: @"unknown";
}

@implementation ABI7_0_0RCTAppState
{
...
- (instancetype)init
{
  if ((self = [super init])) {
    ...
    _lastKnownState = ABI7_0_0RCTCurrentAppBackgroundState();
  }
  return self;
}
...
- (void)handleAppStateDidChange:(NSNotification *)notification
{
  ...
  if ([notification.name isEqualToString:UIApplicationWillResignActiveNotification]) {
    ...
    newState = ABI7_0_0RCTCurrentAppBackgroundState();
  }
 ...
 */
ABI7_0_0RCT_EXPORT_METHOD(getCurrentAppState:(ABI7_0_0RCTResponseSenderBlock)callback
