...
#import "ABI7_0_0RCTKeyboardObserver.h"

#import "ABI7_0_0RCTEventDispatcher.h"

static NSDictionary *ABI7_0_0RCTParseKeyboardNotification(NSNotification *notification);

@implementation ABI7_0_0RCTKeyboardObserver
...
{ \
  [self sendEventWithName:@#EVENT \
    body:ABI7_0_0RCTParseKeyboardNotification(notification)]; \
}
...
NS_INLINE NSDictionary *ABI7_0_0RCTRectDictionaryValue(CGRect rect)
{
  return @{
...
static NSString *ABI7_0_0RCTAnimationNameForCurve(UIViewAnimationCurve curve)
{
  switch (curve) {
...
static NSDictionary *ABI7_0_0RCTParseKeyboardNotification(NSNotification *notification)
{
  ...
  return @{
    @"startCoordinates": ABI7_0_0RCTRectDictionaryValue(beginFrame),
    @"endCoordinates": ABI7_0_0RCTRectDictionaryValue(endFrame),
    @"duration": @(duration * 1000.0), // ms
    @"easing": ABI7_0_0RCTAnimationNameForCurve(curve),
  };
}
