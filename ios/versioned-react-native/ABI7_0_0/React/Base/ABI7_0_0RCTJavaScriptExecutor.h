...
typedef void (^ABI7_0_0RCTJavaScriptCompleteBlock)(NSError *error);
typedef void (^ABI7_0_0RCTJavaScriptCallback)(id json, NSError *error);

/**
 * Abstracts away a JavaScript execution context - we may be running code in a
 * web view (for debugging purposes), or may be running code in a `JSContext`.
 */
@protocol ABI7_0_0RCTJavaScriptExecutor <ABI7_0_0RCTInvalidating, ABI7_0_0RCTBridgeModule>
...
- (void)injectJSONText:(NSString *)script
   asGlobalObjectNamed:(NSString *)objectName
              callback:(ABI7_0_0RCTJavaScriptCompleteBlock)onComplete;
