...
@protocol ABI7_0_0RCTRootViewDelegate;
 ...
 * rootViewDidChangeIntrinsicSize method of the ABI7_0_0RCTRootViewDelegate will be called.
 */
typedef NS_ENUM(NSInteger, ABI7_0_0RCTRootViewSizeFlexibility) {
  ABI7_0_0RCTRootViewSizeFlexibilityNone = 0,
  ABI7_0_0RCTRootViewSizeFlexibilityWidth,
  ABI7_0_0RCTRootViewSizeFlexibilityHeight,
  ABI7_0_0RCTRootViewSizeFlexibilityWidthAndHeight,
};
 ...
 */
extern NSString *const ABI7_0_0RCTContentDidAppearNotification;

/**
 * Native view used to host ReactABI7_0_0-managed views within the app. Can be used just
 * like any ordinary UIView. You can have multiple ABI7_0_0RCTRootViews on screen at
 * once, all controlled by the same JavaScript application.
 */
@interface ABI7_0_0RCTRootView : UIView
 ...
 * This initializer is intended to be used when the app has a single ABI7_0_0RCTRootView,
 * otherwise create an `ABI7_0_0RCTBridge` and pass it in via `initWithBridge:moduleName:`
 ...
 * root views, so you can use this property to initialize another ABI7_0_0RCTRootView.
 */
@property (nonatomic, strong, readonly) ABI7_0_0RCTBridge *bridge;
 ...
 * rootViewDidChangeIntrinsicSize method of ABI7_0_0RCTRootViewDelegate is called.
 */
 ...
 */
@property (nonatomic, weak) id<ABI7_0_0RCTRootViewDelegate> delegate;

/**
 * The backing view controller of the root view.
 */
@property (nonatomic, weak) UIViewController *ReactABI7_0_0ViewController;

/**
 * The ReactABI7_0_0-managed contents view of the root view.
 */
