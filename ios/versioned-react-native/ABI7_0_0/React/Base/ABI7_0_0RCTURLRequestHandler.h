...
#import "ABI7_0_0RCTURLRequestDelegate.h"

/**
 * Provides the interface needed to register a request handler. Request handlers
 * are also bridge modules, so should be registered using ABI7_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI7_0_0RCTURLRequestHandler <ABI7_0_0RCTBridgeModule>
...
- (id)sendRequest:(NSURLRequest *)request
     withDelegate:(id<ABI7_0_0RCTURLRequestDelegate>)delegate;
...
/**
 * If more than one ABI7_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
