...
typedef NS_ENUM(NSInteger, ABI7_0_0RCTTextEventType)
{
  ABI7_0_0RCTTextEventTypeFocus,
  ABI7_0_0RCTTextEventTypeBlur,
  ABI7_0_0RCTTextEventTypeChange,
  ABI7_0_0RCTTextEventTypeSubmit,
  ABI7_0_0RCTTextEventTypeEnd,
  ABI7_0_0RCTTextEventTypeKeyPress
};
 ...
 */
ABI7_0_0RCT_EXTERN const NSInteger ABI7_0_0RCTTextUpdateLagWarningThreshold;
 ...
 */
ABI7_0_0RCT_EXTERN NSString *ABI7_0_0RCTNormalizeInputEventName(NSString *eventName);

@protocol ABI7_0_0RCTEvent <NSObject>
...
/**
 * This class wraps the -[ABI7_0_0RCTBridge enqueueJSCall:args:] method, and
 * provides some convenience methods for generating event calls.
 */
@interface ABI7_0_0RCTEventDispatcher : NSObject <ABI7_0_0RCTBridgeModule>
 ...
 * parameter, representing the ReactABI7_0_0 tag of the view sending the event
 */
 ...
 */
- (void)sendTextEventWithType:(ABI7_0_0RCTTextEventType)type
                     ReactABI7_0_0Tag:(NSNumber *)ReactABI7_0_0Tag
                         text:(NSString *)text
                          key:(NSString *)key
 ...
 */
- (void)sendEvent:(id<ABI7_0_0RCTEvent>)event;

@end

@interface ABI7_0_0RCTBridge (ABI7_0_0RCTEventDispatcher)

- (ABI7_0_0RCTEventDispatcher *)eventDispatcher;
