...
typedef void (^ABI7_0_0RCTSourceLoadBlock)(NSError *error, NSData *source);

@class ABI7_0_0RCTBridge;

@protocol ABI7_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI7_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI7_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray *)extraModulesForBridge:(ABI7_0_0RCTBridge *)bridge;
 ...
 */
- (void)loadSourceForBridge:(ABI7_0_0RCTBridge *)bridge
                  withBlock:(ABI7_0_0RCTSourceLoadBlock)loadCallback;
