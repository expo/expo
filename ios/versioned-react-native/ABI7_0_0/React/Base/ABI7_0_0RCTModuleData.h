...
@protocol ABI7_0_0RCTBridgeMethod;
@protocol ABI7_0_0RCTBridgeModule;
@class ABI7_0_0RCTBridge;

@interface ABI7_0_0RCTModuleData : NSObject <ABI7_0_0RCTInvalidating>

- (instancetype)initWithModuleClass:(Class)moduleClass
                             bridge:(ABI7_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI7_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI7_0_0RCTBridgeModule> instance;
