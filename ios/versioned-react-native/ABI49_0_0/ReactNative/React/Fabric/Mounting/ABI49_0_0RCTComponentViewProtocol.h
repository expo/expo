...
#import <ABI49_0_0React/renderer/componentregistry/ABI49_0_0ComponentDescriptorProvider.h>
...
#import <ABI49_0_0React/renderer/core/ABI49_0_0State.h>
 ...
 */
typedef NS_OPTIONS(NSInteger, ABI49_0_0RNComponentViewUpdateMask) {
  ABI49_0_0RNComponentViewUpdateMaskNone = 0,
  ABI49_0_0RNComponentViewUpdateMaskProps = 1 << 0,
  ABI49_0_0RNComponentViewUpdateMaskEventEmitter = 1 << 1,
  ABI49_0_0RNComponentViewUpdateMaskState = 1 << 3,
  ABI49_0_0RNComponentViewUpdateMaskLayoutMetrics = 1 << 4,

  ABI49_0_0RNComponentViewUpdateMaskAll = ABI49_0_0RNComponentViewUpdateMaskProps | ABI49_0_0RNComponentViewUpdateMaskEventEmitter |
      ABI49_0_0RNComponentViewUpdateMaskState | ABI49_0_0RNComponentViewUpdateMaskLayoutMetrics
};

/*
 * Represents a `UIView` instance managed by ABI49_0_0React.
 * All methods are non-@optional.
 * `UIView+ComponentViewProtocol` category provides default implementation
 * for all of them.
 */
@protocol ABI49_0_0RCTComponentViewProtocol <NSObject>
