 ...
 *
 * # Usecases
 * ABI49_0_0React Native platform-specific mounting layer has limitations when it comes to notifying view components about
 ...
 * required.
 * - Alternatively, an observer can be registered explicitly via `ABI49_0_0RCTSurface`.
 *
 ...
 */
@protocol ABI49_0_0RCTMountingTransactionObserving <NSObject>
 ...
 */
- (void)mountingTransactionDidMount:(ABI49_0_0facebook::ABI49_0_0React::MountingTransaction const &)transaction
               withSurfaceTelemetry:(ABI49_0_0facebook::ABI49_0_0React::SurfaceTelemetry const &)surfaceTelemetry;
