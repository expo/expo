 ...
 */
class ABI49_0_0RCTComponentViewDescriptor final {
 public:
  /*
   * Associated (and owned) native view instance.
   */
  __strong UIView<ABI49_0_0RCTComponentViewProtocol> *view = nil;
...
inline bool operator==(ABI49_0_0RCTComponentViewDescriptor const &lhs, ABI49_0_0RCTComponentViewDescriptor const &rhs)
{
...
template <>
struct std::hash<ABI49_0_0RCTComponentViewDescriptor> {
  size_t operator()(ABI49_0_0RCTComponentViewDescriptor const &componentViewDescriptor) const
  {
