...
#import <ABI49_0_0React/ABI49_0_0RCTGenericDelegateSplitter.h>
 ...
 * `ABI49_0_0RCTEnhancedScrollView` has a delegate (conforming to this protocol) that allows customizing such behaviors without
 * creating a subclass.
 */
@protocol ABI49_0_0RCTEnhancedScrollViewOverridingDelegate <NSObject>
 ...
 * which are not directly related to ABI49_0_0React Native.
 */
@interface ABI49_0_0RCTEnhancedScrollView : UIScrollView
 ...
 */
@property (nonatomic, strong, readonly) ABI49_0_0RCTGenericDelegateSplitter<id<UIScrollViewDelegate>> *delegateSplitter;

@property (nonatomic, weak) id<ABI49_0_0RCTEnhancedScrollViewOverridingDelegate> overridingDelegate;
