...
#import <ABI49_0_0React/ABI49_0_0RCTTouchableComponentViewProtocol.h>
#import <ABI49_0_0React/ABI49_0_0UIView+ComponentViewProtocol.h>
...
#import <ABI49_0_0React/renderer/core/ABI49_0_0EventEmitter.h>
#import <ABI49_0_0React/renderer/core/ABI49_0_0LayoutMetrics.h>
#import <ABI49_0_0React/renderer/core/ABI49_0_0Props.h>
 ...
 */
@interface ABI49_0_0RCTViewComponentView : UIView <ABI49_0_0RCTComponentViewProtocol, ABI49_0_0RCTTouchableComponentViewProtocol> {
 @protected
  ABI49_0_0facebook::ABI49_0_0React::LayoutMetrics _layoutMetrics;
  ABI49_0_0facebook::ABI49_0_0React::SharedViewProps _props;
  ABI49_0_0facebook::ABI49_0_0React::SharedViewEventEmitter _eventEmitter;
}
...
/**
 * Enforcing `call super` semantic for overridden methods from `ABI49_0_0RCTComponentViewProtocol`.
 * The methods update the instance variables.
 */
- (void)updateProps:(ABI49_0_0facebook::ABI49_0_0React::Props::Shared const &)props
           oldProps:(ABI49_0_0facebook::ABI49_0_0React::Props::Shared const &)oldProps NS_REQUIRES_SUPER;
- (void)updateEventEmitter:(ABI49_0_0facebook::ABI49_0_0React::EventEmitter::Shared const &)eventEmitter NS_REQUIRES_SUPER;
- (void)updateLayoutMetrics:(ABI49_0_0facebook::ABI49_0_0React::LayoutMetrics const &)layoutMetrics
           oldLayoutMetrics:(ABI49_0_0facebook::ABI49_0_0React::LayoutMetrics const &)oldLayoutMetrics NS_REQUIRES_SUPER;
- (void)finalizeUpdates:(ABI49_0_0RNComponentViewUpdateMask)updateMask NS_REQUIRES_SUPER;
