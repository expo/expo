...
#import "ABI49_0_0RCTParagraphComponentAccessibilityProvider.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <ABI49_0_0React/ABI49_0_0renderer/components/text/ParagraphComponentDescriptor.h>
#import <ABI49_0_0React/ABI49_0_0renderer/components/text/ParagraphProps.h>
#import <ABI49_0_0React/ABI49_0_0renderer/components/text/ParagraphState.h>
#import <ABI49_0_0React/ABI49_0_0renderer/components/text/RawTextComponentDescriptor.h>
#import <ABI49_0_0React/ABI49_0_0renderer/components/text/TextComponentDescriptor.h>
...
@implementation ABI49_0_0RCTParagraphComponentView {
  ParagraphShadowNode::ConcreteState::Shared _state;
  ParagraphAttributes _paragraphAttributes;
  ABI49_0_0RCTParagraphComponentAccessibilityProvider *_accessibilityProvider;
...
- (NSAttributedString *_Nullable)attributedText
{
  ...
  return ABI49_0_0RCTNSAttributedStringFromAttributedString(_state->getData().attributedString);
}
...
- (void)drawRect:(CGRect)rect
{
  ...
  ABI49_0_0RCTTextLayoutManager *nativeTextLayoutManager =
      (ABI49_0_0RCTTextLayoutManager *)unwrapManagedObject(textLayoutManager->getNativeTextLayoutManager());

  CGRect frame = ABI49_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
...
- (NSArray *)accessibilityElements
{
  ...
  if (![_accessibilityProvider isUpToDate:data.attributedString]) {
    ...
    ABI49_0_0RCTTextLayoutManager *nativeTextLayoutManager =
        (ABI49_0_0RCTTextLayoutManager *)unwrapManagedObject(textLayoutManager->getNativeTextLayoutManager());
    CGRect frame = ABI49_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
    _accessibilityProvider = [[ABI49_0_0RCTParagraphComponentAccessibilityProvider alloc] initWithString:data.attributedString
...
#pragma mark - ABI49_0_0RCTTouchableComponentViewProtocol
...
Class<ABI49_0_0RCTComponentViewProtocol> ABI49_0_0RCTParagraphCls(void)
{
  return ABI49_0_0RCTParagraphComponentView.class;
}
