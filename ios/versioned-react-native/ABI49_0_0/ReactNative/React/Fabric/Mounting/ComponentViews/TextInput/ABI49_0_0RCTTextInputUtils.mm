...
static NSAttributedString *ABI49_0_0RCTSanitizeAttributedString(NSAttributedString *attributedString)
{
...
{
  toTextInput.attributedText = ABI49_0_0RCTSanitizeAttributedString(fromTextInput.attributedText);
...
UIKeyboardAppearance ABI49_0_0RCTUIKeyboardAppearanceFromKeyboardAppearance(KeyboardAppearance keyboardAppearance)
{
...
UIKeyboardType ABI49_0_0RCTUIKeyboardTypeFromKeyboardType(KeyboardType keyboardType)
{
  switch (keyboardType) {
    // Universal
...
UIReturnKeyType ABI49_0_0RCTUIReturnKeyTypeFromReturnKeyType(ReturnKeyType returnKeyType)
{
...
UITextContentType ABI49_0_0RCTUITextContentTypeFromString(std::string const &contentType)
{
  ...
  return contentTypeMap[ABI49_0_0RCTNSStringFromString(contentType)] ?: @"";
}

UITextInputPasswordRules *ABI49_0_0RCTUITextInputPasswordRulesFromString(std::string const &passwordRules)
{
  return [UITextInputPasswordRules passwordRulesWithDescriptor:ABI49_0_0RCTNSStringFromStringNilIfEmpty(passwordRules)];
}
