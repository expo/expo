 ...
 */
@interface ABI49_0_0RCTModalHostViewComponentView : ABI49_0_0RCTViewComponentView <ABI49_0_0RCTMountingTransactionObserving>

/**
 * Subclasses may override this method and present the modal on different view controller.
 * Default implementation presents the modal on `[self ABI49_0_0ReactViewController]`.
 */
