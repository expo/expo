...
#import "ABI49_0_0RCTModalHostViewComponentView.h"

#import <ABI49_0_0React/ABI49_0_0RCTBridge+Private.h>
#import <ABI49_0_0React/ABI49_0_0RCTModalManager.h>
#import <ABI49_0_0React/ABI49_0_0UIView+React.h>
#import <ABI49_0_0React/ABI49_0_0renderer/components/modal/ModalHostViewComponentDescriptor.h>
#import <ABI49_0_0React/ABI49_0_0renderer/components/modal/ModalHostViewState.h>
...
@interface ABI49_0_0RCTModalHostViewComponentView () <ABI49_0_0RCTFabricModalHostViewControllerDelegate>

@end

@implementation ABI49_0_0RCTModalHostViewComponentView {
  ABI49_0_0RCTFabricModalHostViewController *_viewController;
...
- (ABI49_0_0RCTFabricModalHostViewController *)viewController
{
  if (!_viewController) {
    _viewController = [ABI49_0_0RCTFabricModalHostViewController new];
...
{
  UIViewController *controller = [self ABI49_0_0ReactViewController];
...
#pragma mark - ABI49_0_0RCTFabricModalHostViewControllerDelegate
...
- (void)boundsDidChange:(CGRect)newBounds
{
  ...
  if (_state != nullptr) {
    auto newState = ModalHostViewState{ABI49_0_0RCTSizeFromCGSize(newBounds.size)};
...
Class<ABI49_0_0RCTComponentViewProtocol> ABI49_0_0RCTModalHostViewCls(void);
...
Class<ABI49_0_0RCTComponentViewProtocol> ABI49_0_0RCTModalHostViewCls(void)
{
  return ABI49_0_0RCTModalHostViewComponentView.class;
}
