 ...
 */
@interface ABI49_0_0RCTScrollViewComponentView : ABI49_0_0RCTViewComponentView <ABI49_0_0RCTMountingTransactionObserving>

/*
 * Finds and returns the closet ABI49_0_0RCTScrollViewComponentView component to the given view
 */
+ (nullable ABI49_0_0RCTScrollViewComponentView *)findScrollViewComponentViewForView:(UIView *)view;
...
/*
 * ABI49_0_0RCTScrollableProtocol is a protocol which ABI49_0_0RCTScrollViewManager uses to communicate with all kinds of `UIScrollView`s.
 ...
 */
@interface ABI49_0_0RCTScrollViewComponentView (ScrollableProtocol) <ABI49_0_0RCTScrollableProtocol>
