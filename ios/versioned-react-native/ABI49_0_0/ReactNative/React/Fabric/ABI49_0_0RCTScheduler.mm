...
#import "ABI49_0_0RCTScheduler.h"

#import <ABI49_0_0React/renderer/animations/ABI49_0_0LayoutAnimationDriver.h>
...
#import <ABI49_0_0React/renderer/scheduler/ABI49_0_0Scheduler.h>
#import <ABI49_0_0React/renderer/scheduler/ABI49_0_0SchedulerDelegate.h>
...
class SchedulerDelegateProxy : public SchedulerDelegate {
 public:
  ...
  {
    ABI49_0_0RCTScheduler *scheduler = (__bridge ABI49_0_0RCTScheduler *)scheduler_;
...
@implementation ABI49_0_0RCTScheduler {
...
{
  if (self = [super init]) {
    auto ABI49_0_0ReactNativeConfig =
        toolbox.contextContainer->at<std::shared_ptr<const ABI49_0_0ReactNativeConfig>>("ABI49_0_0ReactNativeConfig");

    _delegateProxy = std::make_shared<SchedulerDelegateProxy>((__bridge void *)self);

    if (ABI49_0_0ReactNativeConfig->getBool("ABI49_0_0React_fabric:enabled_layout_animations_ios")) {
...
- (std::shared_ptr<ABI49_0_0facebook::ABI49_0_0React::UIManager> const)uiManager
{
