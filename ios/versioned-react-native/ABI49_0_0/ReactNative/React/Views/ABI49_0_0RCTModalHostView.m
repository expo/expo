...
@implementation ABI49_0_0RCTModalHostView {
  __weak ABI49_0_0RCTBridge *_bridge;
  BOOL _isPresented;
  ABI49_0_0RCTModalHostViewController *_modalViewController;
  ABI49_0_0RCTTouchHandler *_touchHandler;
  UIView *_ABI49_0_0ReactSubview;
  UIInterfaceOrientation _lastKnownOrientation;
  ABI49_0_0RCTDirectEventBlock _onRequestClose;
}

ABI49_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithFrame : (CGRect)frame)
ABI49_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithCoder : coder)

- (instancetype)initWithBridge:(ABI49_0_0RCTBridge *)bridge
{
  if ((self = [super initWithFrame:CGRectZero])) {
    _bridge = bridge;
    _modalViewController = [ABI49_0_0RCTModalHostViewController new];
    UIView *containerView = [UIView new];
    containerView.autoresizingMask = UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
    _modalViewController.view = containerView;
    _touchHandler = [[ABI49_0_0RCTTouchHandler alloc] initWithBridge:bridge];
    _isPresented = NO;
...
{
  if (_ABI49_0_0ReactSubview && _isPresented) {
    [_bridge.uiManager setSize:newBounds.size forView:_ABI49_0_0ReactSubview];
    [self notifyForOrientationChange];
  }
}

- (void)setOnRequestClose:(ABI49_0_0RCTDirectEventBlock)onRequestClose
{
...
- (void)notifyForOrientationChange
{
  ...
  UIInterfaceOrientation currentOrientation = [ABI49_0_0RCTSharedApplication() statusBarOrientation];
...
{
  ABI49_0_0RCTAssert(_ABI49_0_0ReactSubview == nil, @"Modal view can only have one subview");
  [super insertABI49_0_0ReactSubview:subview atIndex:atIndex];
  [_touchHandler attachToView:subview];

  [_modalViewController.view insertSubview:subview atIndex:0];
  _ABI49_0_0ReactSubview = subview;
}

- (void)removeABI49_0_0ReactSubview:(UIView *)subview
{
  ABI49_0_0RCTAssert(subview == _ABI49_0_0ReactSubview, @"Cannot remove view other than modal view");
  // Superclass (category) removes the `subview` from actual `superview`.
  [super removeABI49_0_0ReactSubview:subview];
  [_touchHandler detachFromView:subview];
  _ABI49_0_0ReactSubview = nil;
}

- (void)didUpdateABI49_0_0ReactSubviews
{
  // Do nothing, as subview (singular) is managed by `insertABI49_0_0ReactSubview:atIndex:`
}
...
- (void)didMoveToWindow
{
  ...
  if (!self.userInteractionEnabled && ![self.superview.ABI49_0_0ReactSubviews containsObject:self]) {
    return;
  }
...
- (void)ensurePresentedOnlyIfNeeded
{
  ...
  if (shouldBePresented) {
    ABI49_0_0RCTAssert(self.ABI49_0_0ReactViewController, @"Can't present modal view controller without a presenting view controller");
