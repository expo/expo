...
typedef UIFont * (^ABI49_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ABI49_0_0React Native will use the System font for rendering by default. If you want to
 ...
 */
ABI49_0_0RCT_EXTERN void ABI49_0_0RCTSetDefaultFontHandler(ABI49_0_0RCTFontHandler handler);
ABI49_0_0RCT_EXTERN BOOL ABI49_0_0RCTHasFontHandlerSet(void);

@interface ABI49_0_0RCTFont : NSObject
...
@interface ABI49_0_0RCTConvert (ABI49_0_0RCTFont)
