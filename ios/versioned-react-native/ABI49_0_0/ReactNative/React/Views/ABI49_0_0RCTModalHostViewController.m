...
@implementation ABI49_0_0RCTModalHostViewController {
...
- (instancetype)init
{
  ...
  _preferredStatusBarStyle = [ABI49_0_0RCTSharedApplication() statusBarStyle];
  _preferredStatusBarHidden = [ABI49_0_0RCTSharedApplication() isStatusBarHidden];
