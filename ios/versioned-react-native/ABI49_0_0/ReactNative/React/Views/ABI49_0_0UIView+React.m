...
@implementation UIView (ABI49_0_0React)
...
{
  objc_setAssociatedObject(self, @selector(ABI49_0_0ReactTag), ABI49_0_0ReactTag, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
...
- (NSNumber *)ABI49_0_0ReactTagAtPoint:(CGPoint)point
{
  ...
  while (view && !view.ABI49_0_0ReactTag) {
    view = view.superview;
  }
  return view.ABI49_0_0ReactTag;
}
...
- (void)insertABI49_0_0ReactSubview:(UIView *)subview atIndex:(NSInteger)atIndex
{
  ...
  // the `ABI49_0_0ReactSubviews` getter method and returns an immutable array.
  NSMutableArray *subviews = objc_getAssociatedObject(self, @selector(ABI49_0_0ReactSubviews));
  if (!subviews) {
    subviews = [NSMutableArray new];
    objc_setAssociatedObject(self, @selector(ABI49_0_0ReactSubviews), subviews, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
  }
...
- (ABI49_0_0YGDisplay)ABI49_0_0ReactDisplay
{
  return self.isHidden ? ABI49_0_0YGDisplayNone : ABI49_0_0YGDisplayFlex;
}

- (void)setABI49_0_0ReactDisplay:(ABI49_0_0YGDisplay)display
{
  self.hidden = display == ABI49_0_0YGDisplayNone;
}

#pragma mark - Layout Direction

- (UIUserInterfaceLayoutDirection)ABI49_0_0ReactLayoutDirection
{
  if ([self respondsToSelector:@selector(semanticContentAttribute)]) {
    return [UIView userInterfaceLayoutDirectionForSemanticContentAttribute:self.semanticContentAttribute];
  } else {
    return [objc_getAssociatedObject(self, @selector(ABI49_0_0ReactLayoutDirection)) integerValue];
  }
}
...
- (void)setABI49_0_0ReactLayoutDirection:(UIUserInterfaceLayoutDirection)layoutDirection
{
  if ([self respondsToSelector:@selector(setSemanticContentAttribute:)]) {
    ...
    objc_setAssociatedObject(
        self, @selector(ABI49_0_0ReactLayoutDirection), @(layoutDirection), OBJC_ASSOCIATION_RETAIN_NONATOMIC);
  }
}

#pragma mark - zIndex

- (NSInteger)ABI49_0_0ReactZIndex
{
  return self.layer.zPosition;
}

- (void)setABI49_0_0ReactZIndex:(NSInteger)ABI49_0_0ReactZIndex
{
  self.layer.zPosition = ABI49_0_0ReactZIndex;
}
...
- (NSArray<UIView *> *)ABI49_0_0ReactZIndexSortedSubviews
{
  ...
  for (UIView *subview in self.subviews) {
    if (subview.ABI49_0_0ReactZIndex != 0) {
      sortingRequired = YES;
      break;
    }
  }
  return sortingRequired ? [self.ABI49_0_0ReactSubviews sortedArrayUsingComparator:^NSComparisonResult(UIView *a, UIView *b) {
    if (a.ABI49_0_0ReactZIndex > b.ABI49_0_0ReactZIndex) {
...
{
  for (UIView *subview in self.ABI49_0_0ReactSubviews) {
 ...
 * Focus manipulation.
 */
- (BOOL)ABI49_0_0ReactIsFocusNeeded
{
  return [(NSNumber *)objc_getAssociatedObject(self, @selector(ABI49_0_0ReactIsFocusNeeded)) boolValue];
}

- (void)setABI49_0_0ReactIsFocusNeeded:(BOOL)isFocusNeeded
{
  objc_setAssociatedObject(self, @selector(ABI49_0_0ReactIsFocusNeeded), @(isFocusNeeded), OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (void)ABI49_0_0ReactFocus
{
  if (![self becomeFirstResponder]) {
    self.ABI49_0_0ReactIsFocusNeeded = YES;
  }
}

- (void)ABI49_0_0ReactFocusIfNeeded
{
  if (self.ABI49_0_0ReactIsFocusNeeded) {
    if ([self becomeFirstResponder]) {
      self.ABI49_0_0ReactIsFocusNeeded = NO;
    }
  }
}
...
- (UIEdgeInsets)ABI49_0_0ReactBorderInsets
{
  CGFloat borderWidth = self.layer.borderWidth;
  return UIEdgeInsetsMake(borderWidth, borderWidth, borderWidth, borderWidth);
}

- (UIEdgeInsets)ABI49_0_0ReactPaddingInsets
{
  return UIEdgeInsetsZero;
}

- (UIEdgeInsets)ABI49_0_0ReactCompoundInsets
{
  UIEdgeInsets borderInsets = self.ABI49_0_0ReactBorderInsets;
  UIEdgeInsets paddingInsets = self.ABI49_0_0ReactPaddingInsets;
...
- (CGRect)ABI49_0_0ReactContentFrame
{
  return UIEdgeInsetsInsetRect(self.bounds, self.ABI49_0_0ReactCompoundInsets);
}
...
#pragma mark - Debug
- (void)ABI49_0_0React_addRecursiveDescriptionToString:(NSMutableString *)string atLevel:(NSUInteger)level
{
  ...
  for (UIView *subview in self.subviews) {
    [subview ABI49_0_0React_addRecursiveDescriptionToString:string atLevel:level + 1];
  }
}
...
- (NSString *)ABI49_0_0React_recursiveDescription
{
  ...
  [self ABI49_0_0React_addRecursiveDescriptionToString:description atLevel:0];
  return description;
}
