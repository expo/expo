...
@interface ABI49_0_0RCTConvert (ABI49_0_0RCTModalHostView)

+ (UIModalPresentationStyle)UIModalPresentationStyle:(id)json;

@end

typedef void (^ABI49_0_0RCTModalViewInteractionBlock)(
    UIViewController *ABI49_0_0ReactViewController,
    UIViewController *viewController,
    BOOL animated,
    dispatch_block_t completionBlock);

@interface ABI49_0_0RCTModalHostViewManager : ABI49_0_0RCTViewManager <ABI49_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, strong) ABI49_0_0RCTModalViewInteractionBlock presentationBlock;
@property (nonatomic, strong) ABI49_0_0RCTModalViewInteractionBlock dismissalBlock;
