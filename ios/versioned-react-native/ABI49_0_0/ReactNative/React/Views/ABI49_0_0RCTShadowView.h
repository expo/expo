...
// Keeps ABI49_0_0RCTConvert.h here before yoga for clang module to generate correct header imports.
#import <ABI49_0_0React/ABI49_0_0RCTConvert.h>
#import <ABI49_0_0React/ABI49_0_0RCTLayout.h>
#import <ABI49_0_0React/ABI49_0_0RCTRootView.h>
#import <ABI49_0_0yoga/ABI49_0_0Yoga.h>

@class ABI49_0_0RCTRootShadowView;
@class ABI49_0_0RCTSparseArray;

typedef void (^ABI49_0_0RCTApplierBlock)(NSDictionary<NSNumber *, UIView *> *viewRegistry);

/**
 * ShadowView tree mirrors ABI49_0_0RCT view tree. Every node is highly stateful.
 * 1. A node is in one of three lifecycles: uninitialized, computed, dirtied.
 * 1. ABI49_0_0RCTBridge may call any of the padding/margin/width/height/top/left setters. A setter would dirty
 ...
 */
@interface ABI49_0_0RCTShadowView : NSObject <ABI49_0_0RCTComponent>
 ...
 */
- (NSArray<ABI49_0_0RCTShadowView *> *)ABI49_0_0ReactSubviews NS_REQUIRES_SUPER;
- (ABI49_0_0RCTShadowView *)ABI49_0_0ReactSuperview NS_REQUIRES_SUPER;
- (void)insertABI49_0_0ReactSubview:(ABI49_0_0RCTShadowView *)subview atIndex:(NSInteger)atIndex NS_REQUIRES_SUPER;
- (void)removeABI49_0_0ReactSubview:(ABI49_0_0RCTShadowView *)subview NS_REQUIRES_SUPER;

@property (nonatomic, weak, readonly) ABI49_0_0RCTRootShadowView *rootView;
@property (nonatomic, weak, readonly) ABI49_0_0RCTShadowView *superview;
@property (nonatomic, assign, readonly) ABI49_0_0YGNodeRef yogaNode;
 ...
 */
@property (nonatomic, assign) ABI49_0_0RCTLayoutMetrics layoutMetrics;
 ...
 * Use `-[ABI49_0_0RCTUIManager setLocalData:forView:]` to set this property
 ...
 * set to NO in ABI49_0_0RCTUIManager after the layout pass is done and all frames have been extracted to be applied to the
 ...
 */
@property (nonatomic, assign) ABI49_0_0YGValue top;
@property (nonatomic, assign) ABI49_0_0YGValue left;
@property (nonatomic, assign) ABI49_0_0YGValue bottom;
@property (nonatomic, assign) ABI49_0_0YGValue right;
@property (nonatomic, assign) ABI49_0_0YGValue start;
@property (nonatomic, assign) ABI49_0_0YGValue end;

@property (nonatomic, assign) ABI49_0_0YGValue width;
@property (nonatomic, assign) ABI49_0_0YGValue height;

@property (nonatomic, assign) ABI49_0_0YGValue minWidth;
@property (nonatomic, assign) ABI49_0_0YGValue maxWidth;
@property (nonatomic, assign) ABI49_0_0YGValue minHeight;
@property (nonatomic, assign) ABI49_0_0YGValue maxHeight;
 ...
 */
@property (nonatomic, assign) ABI49_0_0YGValue margin;
@property (nonatomic, assign) ABI49_0_0YGValue marginVertical;
@property (nonatomic, assign) ABI49_0_0YGValue marginHorizontal;
@property (nonatomic, assign) ABI49_0_0YGValue marginTop;
@property (nonatomic, assign) ABI49_0_0YGValue marginLeft;
@property (nonatomic, assign) ABI49_0_0YGValue marginBottom;
@property (nonatomic, assign) ABI49_0_0YGValue marginRight;
@property (nonatomic, assign) ABI49_0_0YGValue marginStart;
@property (nonatomic, assign) ABI49_0_0YGValue marginEnd;

/**
 * Padding. Defaults to { 0, 0, 0, 0 }.
 */
@property (nonatomic, assign) ABI49_0_0YGValue padding;
@property (nonatomic, assign) ABI49_0_0YGValue paddingVertical;
@property (nonatomic, assign) ABI49_0_0YGValue paddingHorizontal;
@property (nonatomic, assign) ABI49_0_0YGValue paddingTop;
@property (nonatomic, assign) ABI49_0_0YGValue paddingLeft;
@property (nonatomic, assign) ABI49_0_0YGValue paddingBottom;
@property (nonatomic, assign) ABI49_0_0YGValue paddingRight;
@property (nonatomic, assign) ABI49_0_0YGValue paddingStart;
@property (nonatomic, assign) ABI49_0_0YGValue paddingEnd;

/**
 * Flexbox properties. All zero/disabled by default
 */
@property (nonatomic, assign) ABI49_0_0YGFlexDirection flexDirection;
@property (nonatomic, assign) ABI49_0_0YGJustify justifyContent;
@property (nonatomic, assign) ABI49_0_0YGAlign alignSelf;
@property (nonatomic, assign) ABI49_0_0YGAlign alignItems;
@property (nonatomic, assign) ABI49_0_0YGAlign alignContent;
@property (nonatomic, assign) ABI49_0_0YGPositionType position;
@property (nonatomic, assign) ABI49_0_0YGWrap flexWrap;
@property (nonatomic, assign) ABI49_0_0YGDisplay display;
...
@property (nonatomic, assign) ABI49_0_0YGValue flexBasis;
 ...
 */
@property (nonatomic, assign) ABI49_0_0YGDirection direction;

/**
 * Clipping properties
 */
@property (nonatomic, assign) ABI49_0_0YGOverflow overflow;
 ...
 * For example `ABI49_0_0RCTTextShadowView` has children which it does not want Yoga
...
/**
 * As described in ABI49_0_0RCTComponent protocol.
 */
- (void)didUpdateABI49_0_0ReactSubviews NS_REQUIRES_SUPER;
