...
#import "ABI49_0_0RCTScrollEvent.h"
#import <ABI49_0_0React/ABI49_0_0RCTAssert.h>

@implementation ABI49_0_0RCTScrollEvent {
...
- (ABI49_0_0RCTScrollEvent *)coalesceWithEvent:(ABI49_0_0RCTScrollEvent *)newEvent
{
...
- (NSArray *)arguments
{
  return @[ self.viewTag, ABI49_0_0RCTNormalizeInputEventName(self.eventName), [self body] ];
}
