...
extern NSString *const ABI49_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification; // posted when multiplier is changed

@interface ABI49_0_0RCTAccessibilityManager : NSObject <ABI49_0_0RCTBridgeModule>
...
@interface ABI49_0_0RCTBridge (ABI49_0_0RCTAccessibilityManager)

@property (nonatomic, readonly) ABI49_0_0RCTAccessibilityManager *accessibilityManager;
