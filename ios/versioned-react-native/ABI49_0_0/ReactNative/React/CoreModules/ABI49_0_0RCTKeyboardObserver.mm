...
#import "ABI49_0_0RCTKeyboardObserver.h"
...
static NSDictionary *ABI49_0_0RCTParseKeyboardNotification(NSNotification *notification);

@interface ABI49_0_0RCTKeyboardObserver () <ABI49_0_0NativeKeyboardObserverSpec>
@end

@implementation ABI49_0_0RCTKeyboardObserver
...
#define IMPLEMENT_KEYBOARD_HANDLER(EVENT)                                              \
  ...
  {                                                                                    \
    ...
    [self sendEventWithName:@ #EVENT body:ABI49_0_0RCTParseKeyboardNotification(notification)]; \
  }
...
{
  return std::make_shared<ABI49_0_0facebook::ABI49_0_0React::NativeKeyboardObserverSpecJSI>(params);
}

@end

NS_INLINE NSDictionary *ABI49_0_0RCTRectDictionaryValue(CGRect rect)
{
  return @{
...
static NSString *ABI49_0_0RCTAnimationNameForCurve(UIViewAnimationCurve curve)
{
  switch (curve) {
...
static NSDictionary *ABI49_0_0RCTParseKeyboardNotification(NSNotification *notification)
{
  ...
  return @{
    @"startCoordinates" : ABI49_0_0RCTRectDictionaryValue(beginFrame),
    @"endCoordinates" : ABI49_0_0RCTRectDictionaryValue(endFrame),
    @"duration" : @(duration * 1000.0), // ms
    @"easing" : ABI49_0_0RCTAnimationNameForCurve(curve),
    @"isEventFromThisApp" : isLocalUserInfoKey == 1 ? @YES : @NO,
  };
}

Class ABI49_0_0RCTKeyboardObserverCls(void)
{
  return ABI49_0_0RCTKeyboardObserver.class;
}
