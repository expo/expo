...
#import "ABI49_0_0RCTDeviceInfo.h"

#import <ABI49_0_0FBReactNativeSpec/ABI49_0_0FBReactNativeSpec.h>
#import <ABI49_0_0React/ABI49_0_0RCTAccessibilityManager.h>
...
#import <ABI49_0_0React/ABI49_0_0RCTUIUtils.h>
...
@interface ABI49_0_0RCTDeviceInfo () <ABI49_0_0NativeDeviceInfoSpec, ABI49_0_0RCTInitializing>
@end

@implementation ABI49_0_0RCTDeviceInfo {
...
- (void)initialize
{
  ...
  _currentInterfaceOrientation = [ABI49_0_0RCTSharedApplication() statusBarOrientation];
  ...
  _currentInterfaceDimensions = ABI49_0_0RCTExportedDimensions(_moduleRegistry, _bridge);
...
static BOOL ABI49_0_0RCTIsIPhoneX()
{
...
static NSDictionary *ABI49_0_0RCTExportedDimensions(ABI49_0_0RCTModuleRegistry *moduleRegistry, ABI49_0_0RCTBridge *bridge)
{
  ABI49_0_0RCTAssertMainQueue();
  ABI49_0_0RCTDimensions dimensions;
  if (moduleRegistry) {
    ABI49_0_0RCTAccessibilityManager *accessibilityManager =
        (ABI49_0_0RCTAccessibilityManager *)[moduleRegistry moduleForName:"AccessibilityManager"];
    dimensions = ABI49_0_0RCTGetDimensions(accessibilityManager ? accessibilityManager.multiplier : 1.0);
  } else {
    ABI49_0_0RCTAssert(false, @"ModuleRegistry must be set to properly init dimensions. Bridge exists: %d", bridge != nil);
  }
...
- (NSDictionary<NSString *, id> *)getConstants
{
  ...
  ABI49_0_0RCTModuleRegistry *moduleRegistry = _moduleRegistry;
  ABI49_0_0RCTBridge *bridge = _bridge;
  ABI49_0_0RCTUnsafeExecuteOnMainQueueSync(^{
    constants = @{
      @"Dimensions" : ABI49_0_0RCTExportedDimensions(moduleRegistry, bridge),
      // Note:
      // This prop is deprecated and will be removed in a future release.
      // Please use this only for a quick and temporary solution.
      // Use <SafeAreaView> instead.
      @"isIPhoneX_deprecated" : @(ABI49_0_0RCTIsIPhoneX()),
    };
  });
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [[moduleRegistry moduleForName:"EventDispatcher"]
        sendDeviceEventWithName:@"didUpdateDimensions"
                           body:ABI49_0_0RCTExportedDimensions(moduleRegistry, bridge)];
...
{
  UIApplication *application = ABI49_0_0RCTSharedApplication();
  ...
  if ((isOrientationChanging || isResizingOrChangingToFullscreen) && ABI49_0_0RCTIsAppActive()) {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [[_moduleRegistry moduleForName:"EventDispatcher"]
        sendDeviceEventWithName:@"didUpdateDimensions"
                           body:ABI49_0_0RCTExportedDimensions(_moduleRegistry, _bridge)];
...
{
  NSDictionary *nextInterfaceDimensions = ABI49_0_0RCTExportedDimensions(_moduleRegistry, _bridge);

  // update and publish the even only when the app is in active state
  if (!([nextInterfaceDimensions isEqual:_currentInterfaceDimensions]) && ABI49_0_0RCTIsAppActive()) {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
...
Class ABI49_0_0RCTDeviceInfoCls(void)
{
  return ABI49_0_0RCTDeviceInfo.class;
}
