...
#import "ABI49_0_0RCTExceptionsManager.h"
...
@interface ABI49_0_0RCTExceptionsManager () <ABI49_0_0NativeExceptionsManagerSpec>

@end

@implementation ABI49_0_0RCTExceptionsManager

@synthesize moduleRegistry = _moduleRegistry;

ABI49_0_0RCT_EXPORT_MODULE()

- (instancetype)initWithDelegate:(id<ABI49_0_0RCTExceptionsManagerDelegate>)delegate
{
  if ((self = [self init])) {
    _delegate = delegate;
  }
    ...
    extraDataAsJSON:(nullable NSString *)extraDataAsJSON
{
  if (ABI49_0_0RCTRedBoxGetEnabled()) {
    ABI49_0_0RCTRedBox *redbox = [_moduleRegistry moduleForName:"RedBox"];
    ...
    extraDataAsJSON:(nullable NSString *)extraDataAsJSON
{
  ...
  if (!ABI49_0_0RCT_DEBUG && reloadRetries < _maxReloadAttempts) {
    reloadRetries++;
    ABI49_0_0RCTTriggerReloadCommandListeners(@"JS Crash Reload");
  } else if (!ABI49_0_0RCT_DEV) {
    NSString *description = [@"Unhandled JS Exception: " stringByAppendingString:message];
    NSDictionary *errorInfo =
        @{NSLocalizedDescriptionKey : description, ABI49_0_0RCTJSStackTraceKey : stack, ABI49_0_0RCTJSExtraDataKey : extraDataAsJSON};
    ABI49_0_0RCTFatal([NSError errorWithDomain:ABI49_0_0RCTErrorDomain code:0 userInfo:errorInfo]);
  }
}

ABI49_0_0RCT_EXPORT_METHOD(reportSoftException
...
ABI49_0_0RCT_EXPORT_METHOD(reportFatalException
                  : (NSString *)message stack
                  : (NSArray<NSDictionary *> *)stack exceptionId
                  : (double)exceptionId)
{
...
ABI49_0_0RCT_EXPORT_METHOD(updateExceptionMessage
                  : (NSString *)message stack
                  : (NSArray<NSDictionary *> *)stack exceptionId
                  : (double)exceptionId)
{
...
ABI49_0_0RCT_EXPORT_METHOD(reportUnhandledException : (NSString *)message stack : (NSArray<NSDictionary *> *)stack)
{
  [self reportFatalException:message stack:stack exceptionId:-1];
}

ABI49_0_0RCT_EXPORT_METHOD(dismissRedbox) {}

ABI49_0_0RCT_EXPORT_METHOD(reportException : (ABI49_0_0JS::NativeExceptionsManager::ExceptionData &)data)
{
  ...
  NSString *extraDataAsJSON = ABI49_0_0RCTJSONStringify(extraData, NULL);
...
{
  return std::make_shared<ABI49_0_0facebook::ABI49_0_0React::NativeExceptionsManagerSpecJSI>(params);
}

@end

Class ABI49_0_0RCTExceptionsManagerCls(void)
{
  return ABI49_0_0RCTExceptionsManager.class;
}
