...
#import <ABI49_0_0React/ABI49_0_0RCTErrorCustomizer.h>

@class ABI49_0_0RCTJSStackFrame;

typedef void (^ABI49_0_0RCTRedBoxButtonPressHandler)(void);

@interface ABI49_0_0RCTRedBox : NSObject <ABI49_0_0RCTBridgeModule>
...
/**
 * This category makes the red box instance available via the ABI49_0_0RCTBridge, which
 * is useful for any class that needs to access the red box or error log.
 */
@interface ABI49_0_0RCTBridge (ABI49_0_0RCTRedBox)

@property (nonatomic, readonly) ABI49_0_0RCTRedBox *redBox;
