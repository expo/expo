...
@protocol ABI49_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI49_0_0RCTExceptionsManager : NSObject <ABI49_0_0RCTBridgeModule>
...
@property (nonatomic, weak) id<ABI49_0_0RCTExceptionsManagerDelegate> delegate;
