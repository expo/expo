...
@interface ABI49_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>

@end

@implementation ABI49_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI49_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI49_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI49_0_0RCTMultipartStreamReader *reader = [[ABI49_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream
                                                                                  boundary:_boundary];
  ABI49_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
