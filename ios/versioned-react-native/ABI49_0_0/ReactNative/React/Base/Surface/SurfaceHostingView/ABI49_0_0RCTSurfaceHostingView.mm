...
#import "ABI49_0_0RCTSurfaceDelegate.h"
#import "ABI49_0_0RCTSurfaceView.h"
#import "ABI49_0_0RCTUtils.h"

@interface ABI49_0_0RCTSurfaceHostingView ()
...
@implementation ABI49_0_0RCTSurfaceHostingView {
...
{
  return [[ABI49_0_0RCTSurface alloc] initWithBridge:bridge moduleName:moduleName initialProperties:initialProperties];
}
...
{
  id<ABI49_0_0RCTSurfaceProtocol> surface = [[self class] createSurfaceWithBridge:bridge
                ...
                sizeMeasureMode:(ABI49_0_0RCTSurfaceSizeMeasureMode)sizeMeasureMode
{
  if (self = [super initWithFrame:CGRectZero]) {
    ...
    // For backward compatibility with ABI49_0_0RCTRootView, set a color here instead of transparent (OS default).
...
- (void)setFrame:(CGRect)frame
{
  ...
  ABI49_0_0RCTSurfaceMinimumSizeAndMaximumSizeFromSizeAndSizeMeasureMode(
...
{
  if (ABI49_0_0RCTSurfaceStageIsPreparing(_stage)) {
...
- (CGSize)sizeThatFits:(CGSize)size
{
  ...
  ABI49_0_0RCTSurfaceMinimumSizeAndMaximumSizeFromSizeAndSizeMeasureMode(size, _sizeMeasureMode, &minimumSize, &maximumSize);
...
- (void)setStage:(ABI49_0_0RCTSurfaceStage)stage
{
  ...
  BOOL shouldInvalidateLayout = ABI49_0_0RCTSurfaceStageIsRunning(stage) != ABI49_0_0RCTSurfaceStageIsRunning(_stage) ||
      ABI49_0_0RCTSurfaceStageIsPreparing(stage) != ABI49_0_0RCTSurfaceStageIsPreparing(_stage);
...
- (void)setSizeMeasureMode:(ABI49_0_0RCTSurfaceSizeMeasureMode)sizeMeasureMode
{
...
- (void)setActivityIndicatorViewFactory:(ABI49_0_0RCTSurfaceHostingViewActivityIndicatorViewFactory)activityIndicatorViewFactory
{
...
- (void)traitCollectionDidChange:(UITraitCollection *)previousTraitCollection
{
  ...
  [[NSNotificationCenter defaultCenter]
      postNotificationName:ABI49_0_0RCTUserInterfaceStyleDidChangeNotification
                    object:self
                  userInfo:@{
                    ABI49_0_0RCTUserInterfaceStyleDidChangeNotificationTraitCollectionKey : self.traitCollection,
                  }];
}
...
- (void)_updateViews
{
  self.isSurfaceViewVisible = ABI49_0_0RCTSurfaceStageIsRunning(_stage);
  self.isActivityIndicatorViewVisible = ABI49_0_0RCTSurfaceStageIsPreparing(_stage);
}
...
- (void)surface:(__unused ABI49_0_0RCTSurface *)surface didChangeStage:(ABI49_0_0RCTSurfaceStage)stage
{
...
- (void)surface:(__unused ABI49_0_0RCTSurface *)surface didChangeIntrinsicSize:(__unused CGSize)intrinsicSize
{
  ABI49_0_0RCTExecuteOnMainQueue(^{
    [self _invalidateLayout];
  });
