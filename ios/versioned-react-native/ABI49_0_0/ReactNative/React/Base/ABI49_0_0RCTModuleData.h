...
typedef id<ABI49_0_0RCTBridgeModule> (^ABI49_0_0RCTBridgeModuleProvider)(void);

@interface ABI49_0_0RCTModuleData : NSObject <ABI49_0_0RCTInvalidating>
...
- (instancetype)initWithModuleClass:(Class)moduleClass
            ...
            viewRegistry_DEPRECATED:(ABI49_0_0RCTViewRegistry *)viewRegistry_DEPRECATED
                      bundleManager:(ABI49_0_0RCTBundleManager *)bundleManager
                  callableJSModules:(ABI49_0_0RCTCallableJSModules *)callableJSModules NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI49_0_0RCTBridgeMethod>> *methods;

/**
 * Returns a map of the module methods. Note that this will gather the methods the first
 * time it is called and then memoize the results.
 */
@property (nonatomic, copy, readonly) NSDictionary<NSString *, id<ABI49_0_0RCTBridgeMethod>> *methodsByName;
 ...
 */
@property (nonatomic, strong, readwrite) id<ABI49_0_0RCTBridgeModule> instance;
...
ABI49_0_0RCT_EXTERN void ABI49_0_0RCTSetIsMainQueueExecutionOfConstantsToExportDisabled(BOOL val);
ABI49_0_0RCT_EXTERN BOOL ABI49_0_0RCTIsMainQueueExecutionOfConstantsToExportDisabled(void);
