...
@interface ABI49_0_0RCTImageSource ()

@property (nonatomic, assign) BOOL packagerAsset;

@end

@implementation ABI49_0_0RCTImageSource
...
{
  ABI49_0_0RCTImageSource *imageSource = [[ABI49_0_0RCTImageSource alloc] initWithURLRequest:_request size:size scale:scale];
  imageSource.packagerAsset = _packagerAsset;
  return imageSource;
}

- (BOOL)isEqual:(ABI49_0_0RCTImageSource *)object
{
  if (![object isKindOfClass:[ABI49_0_0RCTImageSource class]]) {
    return NO;
  }
...
{
  return [NSString stringWithFormat:@"<ABI49_0_0RCTImageSource: %p URL=%@, size=%@, scale=%0.f>",
                                    self,
                                    _request.URL,
...
@implementation ABI49_0_0RCTConvert (ImageSource)
...
+ (ABI49_0_0RCTImageSource *)ABI49_0_0RCTImageSource:(id)json
{
  ...
  if ([json isKindOfClass:[NSDictionary class]]) {
    ...
    ABI49_0_0RCTLogConvertError(json, @"an image. Did you forget to call resolveAssetSource() on the JS side?");
    return nil;
  }

  ABI49_0_0RCTImageSource *imageSource = [[ABI49_0_0RCTImageSource alloc] initWithURLRequest:request size:size scale:scale];
  imageSource.packagerAsset = packagerAsset;
  return imageSource;
}

ABI49_0_0RCT_ARRAY_CONVERTER(ABI49_0_0RCTImageSource)
