...
#import "ABI49_0_0RCTBridgeConstants.h"
#import "ABI49_0_0RCTConstants.h"

@class JSValue;
@class ABI49_0_0RCTBridge;
@class ABI49_0_0RCTPerformanceLogger;
 ...
 */
typedef NSArray<id<ABI49_0_0RCTBridgeModule>> * (^ABI49_0_0RCTBridgeModuleListProvider)(void);

/**
 * These blocks are used to report whether an additional bundle
 * fails or succeeds loading.
 */
typedef void (^ABI49_0_0RCTLoadAndExecuteErrorBlock)(NSError *error);

/**
 * This function returns the module name for a given class.
 */
ABI49_0_0RCT_EXTERN NSString *ABI49_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Experimental.
 * Check/set if JSI-bound NativeModule is enabled. By default it's off.
 */
ABI49_0_0RCT_EXTERN BOOL ABI49_0_0RCTTurboModuleEnabled(void);
ABI49_0_0RCT_EXTERN void ABI49_0_0RCTEnableTurboModule(BOOL enabled);

// Turn on TurboModule eager initialization
ABI49_0_0RCT_EXTERN BOOL ABI49_0_0RCTTurboModuleEagerInitEnabled(void);
ABI49_0_0RCT_EXTERN void ABI49_0_0RCTEnableTurboModuleEagerInit(BOOL enabled);

// Turn off TurboModule delegate locking
ABI49_0_0RCT_EXTERN BOOL ABI49_0_0RCTTurboModuleManagerDelegateLockingDisabled(void);
ABI49_0_0RCT_EXTERN void ABI49_0_0RCTDisableTurboModuleManagerDelegateLocking(BOOL enabled);

typedef enum {
  kABI49_0_0RCTGlobalScope,
  kABI49_0_0RCTGlobalScopeUsingRetainJSCallback,
  kABI49_0_0RCTTurboModuleManagerScope,
} ABI49_0_0RCTTurboModuleCleanupMode;

ABI49_0_0RCT_EXTERN ABI49_0_0RCTTurboModuleCleanupMode ABI49_0_0RCTGetTurboModuleCleanupMode(void);
ABI49_0_0RCT_EXTERN void ABI49_0_0RCTSetTurboModuleCleanupMode(ABI49_0_0RCTTurboModuleCleanupMode mode);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI49_0_0RCTBridge : NSObject <ABI49_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI49_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI49_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 */
@property (nonatomic, weak, readonly) id<ABI49_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ABI49_0_0React Native perf events.
 */
@property (nonatomic, readonly, strong) ABI49_0_0RCTPerformanceLogger *performanceLogger;

/**
 * Reload the bundle and reset executor & modules. Safe to call from any thread.
 */
- (void)reload __deprecated_msg("Use ABI49_0_0RCTReloadCommand instead");

/**
 * Reload the bundle and reset executor & modules. Safe to call from any thread.
 */
- (void)reloadWithReason:(NSString *)reason __deprecated_msg("Use ABI49_0_0RCTReloadCommand instead");
 ...
 */
- (void)requestReload __deprecated_msg("Use ABI49_0_0RCTReloadCommand instead");
