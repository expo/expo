...
typedef dispatch_block_t ABI49_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI49_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ABI49_0_0React-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI49_0_0RCTUIManager's observers.
 */
@interface ABI49_0_0RCTUIManagerObserverCoordinator : NSObject <ABI49_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI49_0_0RCTUIManagerObserver` protocol for more info.
