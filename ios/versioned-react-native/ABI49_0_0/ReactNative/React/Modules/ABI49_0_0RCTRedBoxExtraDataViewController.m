...
#import "ABI49_0_0RCTRedBoxExtraDataViewController.h"

@interface ABI49_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI49_0_0RCTRedBoxExtraDataCell
...
@interface ABI49_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI49_0_0RCTRedBoxExtraDataViewController {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  ABI49_0_0RCTRedBoxExtraDataCell *cell =
      (ABI49_0_0RCTRedBoxExtraDataCell *)[tableView dequeueReusableCellWithIdentifier:reuseIdentifier];

  if (cell == nil) {
    cell = [[ABI49_0_0RCTRedBoxExtraDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
  }
