...
{
  NSNumber *port = @8081;
  NSString *portStr = [[[NSProcessInfo processInfo] environment] objectForKey:@"ABI49_0_0RCT_METRO_PORT"];
...
@implementation ABI49_0_0RCTInspectorDevServerHelper

ABI49_0_0RCT_NOT_IMPLEMENTED(-(instancetype)init)

static NSMutableDictionary<NSString *, ABI49_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
...
+ (ABI49_0_0RCTInspectorPackagerConnection *)connectWithBundleURL:(NSURL *)bundleURL
{
  ...
  ABI49_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection || !connection.isConnected) {
    connection = [[ABI49_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
