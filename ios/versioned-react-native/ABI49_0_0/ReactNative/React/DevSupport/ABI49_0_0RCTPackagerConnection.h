...
typedef uint32_t ABI49_0_0RCTHandlerToken;
typedef void (^ABI49_0_0RCTNotificationHandler)(NSDictionary<NSString *, id> *);
typedef void (^ABI49_0_0RCTRequestHandler)(NSDictionary<NSString *, id> *, ABI49_0_0RCTPackagerClientResponder *);
typedef void (^ABI49_0_0RCTConnectedHandler)(void);

/** Encapsulates singleton connection to ABI49_0_0React Native packager. */
@interface ABI49_0_0RCTPackagerConnection : NSObject
