...
#include <ABI49_0_0cxxreact/ABI49_0_0ErrorUtils.h>
#include <ABI49_0_0cxxreact/ABI49_0_0JSBigString.h>
#include <ABI49_0_0cxxreact/ABI49_0_0ModuleRegistry.h>
#include <ABI49_0_0cxxreact/ABI49_0_0ReactMarker.h>
#include <ABI49_0_0cxxreact/ABI49_0_0SystraceSection.h>
...
void JSIExecutor::initializeRuntime() {
  ...
  if (hasLogger) {
    ABI49_0_0ReactMarker::logMarker(ABI49_0_0ReactMarker::CREATE_REACT_CONTEXT_STOP);
  }
}
...
void JSIExecutor::loadBundle(
  ...
  if (hasLogger) {
    ABI49_0_0ReactMarker::logTaggedMarker(
        ABI49_0_0ReactMarker::RUN_JS_BUNDLE_START, scriptName.c_str());
  }
  ...
  if (hasLogger) {
    ABI49_0_0ReactMarker::logTaggedMarker(
        ABI49_0_0ReactMarker::RUN_JS_BUNDLE_STOP, scriptName.c_str());
  }
}
        ...
        Function::createFromHostFunction(
            *runtime_,
            ...
            [this](
                ...
                const ABI49_0_0facebook::jsi::Value &,
...
void JSIExecutor::registerBundle(
  ...
  ABI49_0_0ReactMarker::logTaggedMarker(
      ABI49_0_0ReactMarker::REGISTER_JS_SEGMENT_START, tag.c_str());
  if (bundleRegistry_) {
  ...
  ABI49_0_0ReactMarker::logTaggedMarker(
      ABI49_0_0ReactMarker::REGISTER_JS_SEGMENT_STOP, tag.c_str());
}
...
Value JSIExecutor::nativeRequire(const Value *args, size_t count) {
  ...
  return ABI49_0_0facebook::jsi::Value();
}
...
Value JSIExecutor::nativeCallSyncHook(const Value *args, size_t count) {
  ...
  /**
   * Note:
   * In ABI49_0_0RCTNativeModule, std::nullopt is returned from
