...
#include <ABI49_0_0ReactCommon/ABI49_0_0TurboModulePerfLogger.h>
...
#include <ABI49_0_0React/jni/ABI49_0_0NativeMap.h>
#include <ABI49_0_0React/jni/ABI49_0_0ReadableNativeMap.h>
#include <ABI49_0_0React/jni/ABI49_0_0WritableNativeMap.h>

#include "ABI49_0_0JavaTurboModule.h"
...
std::string stringifyJSIValue(const jsi::Value &v, jsi::Runtime *rt = nullptr) {
  ...
  ABI49_0_0React_native_assert(v.isObject() && "Expecting object.");
...
JNIArgs convertJSIArgsToJNIArgs(
  ...
  for (unsigned int argIndex = 0; argIndex < count; argIndex += 1) {
    ...
    if (arg->isNull() || arg->isUndefined()) {
    ...
    } else if (type == "Lcom/facebook/ABI49_0_0React/bridge/Callback;") {
      ...
      jarg->l = makeGlobalIfNecessary(
          createJavaCallbackFromJSIFunction(std::move(fn), rt, jsInvoker)
              .release());
    } else if (type == "Lcom/facebook/ABI49_0_0React/bridge/ReadableArray;") {
    ...
    } else if (type == "Lcom/facebook/ABI49_0_0React/bridge/ReadableMap;") {
      if (!(arg->isObject())) {
        throw JavaTurboModuleArgumentConversionException(
...
jsi::Value convertFromJMapToValue(JNIEnv *env, jsi::Runtime &rt, jobject arg) {
  ...
  jclass jArguments = env->FindClass("com/facebook/ABI49_0_0React/bridge/Arguments");
  static jmethodID jMakeNativeMap = env->GetStaticMethodID(
      jArguments,
      "makeNativeMap",
      "(Ljava/util/Map;)Lcom/facebook/ABI49_0_0React/bridge/WritableNativeMap;");
      ...
      jsi::Function promiseConstructorArg = jsi::Function::createFromHostFunction(
          ...
          [this,
           ...
           env](
            ...
            jclass jPromiseImpl =
                env->FindClass("com/facebook/ABI49_0_0React/bridge/PromiseImpl");
            jmethodID jPromiseImplConstructor = env->GetMethodID(
                jPromiseImpl,
                "<init>",
                "(Lcom/facebook/ABI49_0_0React/bridge/Callback;Lcom/facebook/ABI49_0_0React/bridge/Callback;)V");
