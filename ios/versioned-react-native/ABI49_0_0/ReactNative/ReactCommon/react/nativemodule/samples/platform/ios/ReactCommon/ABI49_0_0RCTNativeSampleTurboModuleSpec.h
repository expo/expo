 ...
 */
@protocol ABI49_0_0NativeSampleTurboModuleSpec <ABI49_0_0RCTBridgeModule, ABI49_0_0RCTTurboModule>
...
- (void)getValueWithCallback:(ABI49_0_0RCTResponseSenderBlock)callback;
- (void)getValueWithPromise:(BOOL)error resolve:(ABI49_0_0RCTPromiseResolveBlock)resolve reject:(ABI49_0_0RCTPromiseRejectBlock)reject;
