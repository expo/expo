...
#include "ABI49_0_0Entropy.h"

namespace ABI49_0_0facebook {
namespace ABI49_0_0React {

static Tag generateABI49_0_0ReactTag() {
  static Tag tag = 1000;
  return tag++;
}
...
static inline ShadowNode::Unshared messWithYogaStyles(
  ...
  ABI49_0_0EXPECT_EQ(properties.size(), 20);
...
static inline ShadowNode::Shared generateShadowNodeTree(
  ...
  if (size <= 1) {
    auto family = componentDescriptor.createFamily(
        {generateABI49_0_0ReactTag(), SurfaceId(1), nullptr}, nullptr);
