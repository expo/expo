...
#include <ABI49_0_0React/utils/ABI49_0_0SimpleThreadSafeCache.h>
...
template <>
struct hash<ABI49_0_0facebook::ABI49_0_0React::TextMeasureCacheKey> {
  size_t operator()(ABI49_0_0facebook::ABI49_0_0React::TextMeasureCacheKey const &key) const {
    return folly::hash::hash_combine(
        0,
