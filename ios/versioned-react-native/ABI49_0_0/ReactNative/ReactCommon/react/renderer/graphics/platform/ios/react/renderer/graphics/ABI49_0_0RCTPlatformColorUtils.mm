...
#import "ABI49_0_0RCTPlatformColorUtils.h"
...
static inline ABI49_0_0facebook::ABI49_0_0React::ColorComponents _ColorComponentsFromUIColor(UIColor *color)
{
  CGFloat rgba[4];
...
ABI49_0_0facebook::ABI49_0_0React::ColorComponents ABI49_0_0RCTPlatformColorComponentsFromSemanticItems(std::vector<std::string> &semanticItems)
{
