...
#include <ABI49_0_0React/renderer/graphics/ABI49_0_0Vector.h>
...
template <>
struct hash<ABI49_0_0facebook::ABI49_0_0React::Transform> {
  size_t operator()(const ABI49_0_0facebook::ABI49_0_0React::Transform &transform) const {
