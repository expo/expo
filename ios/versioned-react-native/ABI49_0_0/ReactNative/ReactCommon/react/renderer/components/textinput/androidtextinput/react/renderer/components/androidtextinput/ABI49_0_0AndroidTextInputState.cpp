...
AndroidTextInputState::AndroidTextInputState(
    ...
    : mostRecentEventCount(mostRecentEventCount),
      ...
      ABI49_0_0ReactTreeAttributedString(std::move(ABI49_0_0ReactTreeAttributedString)),
...
AndroidTextInputState::AndroidTextInputState(
    ...
    : mostRecentEventCount(data.getDefault(
      ...
      ABI49_0_0ReactTreeAttributedString(previousState.ABI49_0_0ReactTreeAttributedString),
