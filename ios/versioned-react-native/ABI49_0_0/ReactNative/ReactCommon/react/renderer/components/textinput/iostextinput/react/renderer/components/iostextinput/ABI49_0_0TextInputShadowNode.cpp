...
#include "ABI49_0_0TextInputShadowNode.h"
...
void TextInputShadowNode::updateStateIfNeeded(
  ...
  auto ABI49_0_0ReactTreeAttributedString = getAttributedString(layoutContext);
  auto const &state = getStateData();

  ABI49_0_0React_native_assert(textLayoutManager_);
  ...
  newState.attributedStringBox = AttributedStringBox{ABI49_0_0ReactTreeAttributedString};
  newState.paragraphAttributes = getConcreteProps().paragraphAttributes;
  newState.ABI49_0_0ReactTreeAttributedString = ABI49_0_0ReactTreeAttributedString;
