...
static inline ABI49_0_0YGStyle::Dimensions convertRawProp(
    const PropsParserContext &context,
    RawProps const &rawProps,
    char const *widthName,
    char const *heightName,
    ABI49_0_0YGStyle::Dimensions const &sourceValue,
    ABI49_0_0YGStyle::Dimensions const &defaultValue) {
  auto dimensions = defaultValue;
  dimensions[ABI49_0_0YGDimensionWidth] = convertRawProp(
      context,
      rawProps,
      widthName,
      sourceValue[ABI49_0_0YGDimensionWidth],
      defaultValue[ABI49_0_0YGDimensionWidth]);
  dimensions[ABI49_0_0YGDimensionHeight] = convertRawProp(
      context,
      rawProps,
      heightName,
      sourceValue[ABI49_0_0YGDimensionHeight],
      defaultValue[ABI49_0_0YGDimensionHeight]);
  return dimensions;
}

static inline ABI49_0_0YGStyle::Edges convertRawProp(
    const PropsParserContext &context,
    RawProps const &rawProps,
    char const *prefix,
    char const *suffix,
    ABI49_0_0YGStyle::Edges const &sourceValue,
    ABI49_0_0YGStyle::Edges const &defaultValue) {
  auto result = defaultValue;
  result[ABI49_0_0YGEdgeLeft] = convertRawProp(
      context,
      rawProps,
      "Left",
      sourceValue[ABI49_0_0YGEdgeLeft],
      defaultValue[ABI49_0_0YGEdgeLeft],
      prefix,
      suffix);
  result[ABI49_0_0YGEdgeTop] = convertRawProp(
      context,
      rawProps,
      "Top",
      sourceValue[ABI49_0_0YGEdgeTop],
      defaultValue[ABI49_0_0YGEdgeTop],
      prefix,
      suffix);
  result[ABI49_0_0YGEdgeRight] = convertRawProp(
      context,
      rawProps,
      "Right",
      sourceValue[ABI49_0_0YGEdgeRight],
      defaultValue[ABI49_0_0YGEdgeRight],
      prefix,
      suffix);
  result[ABI49_0_0YGEdgeBottom] = convertRawProp(
      context,
      rawProps,
      "Bottom",
      sourceValue[ABI49_0_0YGEdgeBottom],
      defaultValue[ABI49_0_0YGEdgeBottom],
      prefix,
      suffix);
  result[ABI49_0_0YGEdgeStart] = convertRawProp(
      context,
      rawProps,
      "Start",
      sourceValue[ABI49_0_0YGEdgeStart],
      defaultValue[ABI49_0_0YGEdgeStart],
      prefix,
      suffix);
  result[ABI49_0_0YGEdgeEnd] = convertRawProp(
      context,
      rawProps,
      "End",
      sourceValue[ABI49_0_0YGEdgeEnd],
      defaultValue[ABI49_0_0YGEdgeEnd],
      prefix,
      suffix);
  result[ABI49_0_0YGEdgeHorizontal] = convertRawProp(
      context,
      rawProps,
      "Horizontal",
      sourceValue[ABI49_0_0YGEdgeHorizontal],
      defaultValue[ABI49_0_0YGEdgeHorizontal],
      prefix,
      suffix);
  result[ABI49_0_0YGEdgeVertical] = convertRawProp(
      context,
      rawProps,
      "Vertical",
      sourceValue[ABI49_0_0YGEdgeVertical],
      defaultValue[ABI49_0_0YGEdgeVertical],
      prefix,
      suffix);
  result[ABI49_0_0YGEdgeAll] = convertRawProp(
      context,
      rawProps,
      "",
      sourceValue[ABI49_0_0YGEdgeAll],
      defaultValue[ABI49_0_0YGEdgeAll],
      prefix,
      suffix);
  return result;
}
...
static inline ABI49_0_0YGStyle convertRawProp(
    const PropsParserContext &context,
    RawProps const &rawProps,
    ABI49_0_0YGStyle const &sourceValue) {
  auto yogaStyle = ABI49_0_0YGStyle{};
  ...
  yogaStyle.gap()[ABI49_0_0YGGutterRow] = convertRawProp(
      context,
      rawProps,
      "rowGap",
      sourceValue.gap()[ABI49_0_0YGGutterRow],
      yogaStyle.gap()[ABI49_0_0YGGutterRow]);

  yogaStyle.gap()[ABI49_0_0YGGutterColumn] = convertRawProp(
      context,
      rawProps,
      "columnGap",
      sourceValue.gap()[ABI49_0_0YGGutterColumn],
      yogaStyle.gap()[ABI49_0_0YGGutterColumn]);

  yogaStyle.gap()[ABI49_0_0YGGutterAll] = convertRawProp(
      context,
      rawProps,
      "gap",
      sourceValue.gap()[ABI49_0_0YGGutterAll],
