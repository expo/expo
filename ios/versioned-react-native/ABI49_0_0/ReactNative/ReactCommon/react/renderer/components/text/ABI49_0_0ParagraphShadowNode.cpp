...
#include "ABI49_0_0ParagraphShadowNode.h"
...
#include <ABI49_0_0React/renderer/graphics/ABI49_0_0rounding.h>
...
Content const &ParagraphShadowNode::getContent(
  ...
  textAttributes.layoutDirection =
      ABI49_0_0YGNodeLayoutGetDirection(&yogaNode_) == ABI49_0_0YGDirectionRTL
...
void ParagraphShadowNode::updateStateIfNeeded(Content const &content) {
  ...
  ABI49_0_0React_native_assert(state.paragraphLayoutManager.getTextLayoutManager());
