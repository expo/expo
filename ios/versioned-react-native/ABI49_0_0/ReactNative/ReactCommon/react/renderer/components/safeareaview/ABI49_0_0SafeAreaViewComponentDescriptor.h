...
#include <ABI49_0_0React/ABI49_0_0renderer/components/safeareaview/SafeAreaViewShadowNode.h>
...
class SafeAreaViewComponentDescriptor final
  ...
  void adopt(ShadowNode::Unshared const &shadowNode) const override {
    ...
    ABI49_0_0React_native_assert(std::dynamic_pointer_cast<YogaLayoutableShadowNode>(
