  ...
  for (auto const &mutation : mutations) {
    switch (mutation.type) {
      case ShadowViewMutation::Create: {
        ABI49_0_0React_native_assert(mutation.parentShadowView == ShadowView{});
        ABI49_0_0React_native_assert(mutation.oldChildShadowView == ShadowView{});
        ABI49_0_0React_native_assert(mutation.newChildShadowView.props);
        ...
        ABI49_0_0React_native_assert(registry.find(tag) == registry.end());
      ...
      case ShadowViewMutation::Delete: {
        ...
        ABI49_0_0React_native_assert(mutation.parentShadowView == ShadowView{});
        ABI49_0_0React_native_assert(mutation.newChildShadowView == ShadowView{});
      ...
      case ShadowViewMutation::Insert: {
        if (!mutation.mutatedViewIsVirtual()) {
          ...
          ABI49_0_0React_native_assert(registry.find(parentTag) != registry.end());
          auto parentStubView = registry[parentTag];
          ABI49_0_0React_native_assert(registry.find(childTag) != registry.end());
          ...
          ABI49_0_0React_native_assert(childStubView->parentTag == NO_VIEW_TAG);
          ABI49_0_0React_native_assert(
              mutation.index >= 0 &&
      ...
      case ShadowViewMutation::Remove: {
        if (!mutation.mutatedViewIsVirtual()) {
          ...
          ABI49_0_0React_native_assert(childStubView->parentTag == parentTag);
          STUB_VIEW_LOG({
      ...
      case ShadowViewMutation::Update: {
        ...
        ABI49_0_0React_native_assert(mutation.oldChildShadowView.tag != 0);
        ABI49_0_0React_native_assert(mutation.newChildShadowView.tag != 0);
        ABI49_0_0React_native_assert(mutation.newChildShadowView.props);
        ABI49_0_0React_native_assert(
        ...
        ABI49_0_0React_native_assert(oldStubView->tag != 0);
