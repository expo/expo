...
TEST(FindNodeAtPointTest, withoutTransform) {
  ...
  ABI49_0_0EXPECT_EQ(LayoutableShadowNode::findNodeAtPoint(parentShadowNode, {105, 105})->getTag(), 2);
  ABI49_0_0EXPECT_EQ(LayoutableShadowNode::findNodeAtPoint(parentShadowNode, {900, 900})->getTag(), 1);
  ABI49_0_0EXPECT_EQ(
...
TEST(FindNodeAtPointTest, viewIsTranslated) {
  ...
  ABI49_0_0EXPECT_EQ(
      ...
      3);
  ABI49_0_0EXPECT_EQ(LayoutableShadowNode::findNodeAtPoint(parentShadowNode, {5, 5})->getTag(), 2);
}
