...
#include "ABI49_0_0UIManagerBinding.h"
...
#include <ABI49_0_0React/renderer/runtimescheduler/ABI49_0_0RuntimeSchedulerBinding.h>
...
void UIManagerBinding::dispatchEvent(
  ...
  auto instanceHandle = eventTarget != nullptr
    ? [&]() {
      ...
      ABI49_0_0React_native_assert(payload.isObject());
  ...
  eventHandlerWrapper.callback.call(
      ...
      {std::move(instanceHandle),
       ...
       std::move(payload)});
  currentEventPriority_ = ABI49_0_0ReactEventPriority::Default;
}
...
jsi::Value UIManagerBinding::get(
  ...
  if (methodName == "unstable_DefaultEventPriority") {
    return {serialize(ABI49_0_0ReactEventPriority::Default)};
  }

  if (methodName == "unstable_DiscreteEventPriority") {
    return {serialize(ABI49_0_0ReactEventPriority::Discrete)};
  }
