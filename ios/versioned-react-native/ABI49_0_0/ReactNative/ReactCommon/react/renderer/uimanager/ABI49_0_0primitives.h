...
#include <ABI49_0_0React/renderer/core/ABI49_0_0EventHandler.h>
...
inline static SharedEventTarget eventTargetFromValue(
  ...
  ABI49_0_0React_native_assert(!eventTargetValue.isNull());
...
inline static int displayModeToInt(DisplayMode const value) {
  ...
  // Libraries/ABI49_0_0ReactNative/DisplayMode.js
  switch (value) {
