...
#include <ABI49_0_0React/renderer/uimanager/ABI49_0_0SurfaceRegistryBinding.h>
...
ShadowTree::Unique UIManager::stopSurface(SurfaceId surfaceId) const {
  ...
  // We execute JavaScript/ABI49_0_0React part of the process at the very end to minimize
...
void UIManager::unregisterCommitHook(
  ...
  auto iterator =
      std::find(commitHooks_.begin(), commitHooks_.end(), &commitHook);
  ABI49_0_0React_native_assert(iterator != commitHooks_.end());
