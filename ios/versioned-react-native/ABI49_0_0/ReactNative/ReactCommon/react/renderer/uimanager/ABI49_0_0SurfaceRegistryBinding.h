...
class SurfaceRegistryBinding final {
 public:
  ...
  /*
   * Starts ABI49_0_0React Native Surface with given id, moduleName, and props.
  ...
  /*
   * Updates the ABI49_0_0React Native Surface identified with surfaceId and moduleName
  ...
  /*
   * Stops ABI49_0_0React Native Surface with given id.
   * Thread synchronization must be enforced externally.
   */
