...
@interface ABI49_0_0RCTInternalGenericWeakWrapper : NSObject
...
{
  ABI49_0_0RCTInternalGenericWeakWrapper *weakWrapper = [ABI49_0_0RCTInternalGenericWeakWrapper new];
...
{
  ABI49_0_0RCTInternalGenericWeakWrapper *weakWrapper = (ABI49_0_0RCTInternalGenericWeakWrapper *)unwrapManagedObject(object);
  ABI49_0_0React_native_assert(weakWrapper && "`ABI49_0_0RCTInternalGenericWeakWrapper` instance must not be `nil`.");
