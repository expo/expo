...
// When building a cross-platform module for ABI49_0_0React Native, arguments passed
...
// they can be caught and reported to ABI49_0_0RN consistently.  The goal is to make the
...
#include <ABI49_0_0cxxreact/ABI49_0_0JsArgumentHelpers-inl.h>
