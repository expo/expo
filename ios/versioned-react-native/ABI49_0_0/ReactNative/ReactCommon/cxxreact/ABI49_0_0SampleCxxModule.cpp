...
#include "ABI49_0_0SampleCxxModule.h"
...
ABI49_0_0facebook::xplat::module::CxxModule *SampleCxxModule() {
  return new ABI49_0_0facebook::xplat::samples::SampleCxxModule(
      std::make_unique<ABI49_0_0facebook::xplat::samples::Sample>());
}
