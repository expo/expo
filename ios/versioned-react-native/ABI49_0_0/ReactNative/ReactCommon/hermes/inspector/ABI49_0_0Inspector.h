...
#include <hermes/inspector/ABI49_0_0AsyncPauseState.h>
...
class InspectorObserver {
 public:
  ...
  virtual void onBreakpointResolved(
      Inspector &inspector,
      const ABI49_0_0facebook::ABI49_0_0hermes::debugger::BreakpointInfo &info) = 0;
  ...
  virtual void onPause(
      Inspector &inspector,
      const ABI49_0_0facebook::ABI49_0_0hermes::debugger::ProgramState &state) = 0;
 ...
 * debugging API.
 */
class Inspector : public ABI49_0_0facebook::ABI49_0_0hermes::debugger::EventObserver,
 ...
 public:
  ...
  folly::Future<folly::Unit> executeIfEnabled(
      ...
      folly::Function<void(const ABI49_0_0facebook::ABI49_0_0hermes::debugger::ProgramState &)>
          func);
   ...
   * execution.
   */
  folly::Future<ABI49_0_0facebook::ABI49_0_0hermes::debugger::BreakpointInfo> setBreakpoint(
      ABI49_0_0facebook::ABI49_0_0hermes::debugger::SourceLocation loc,
      std::optional<std::string> condition = std::nullopt);

  folly::Future<folly::Unit> removeBreakpoint(
      ABI49_0_0facebook::ABI49_0_0hermes::debugger::BreakpointID loc);
   ...
   * otherwise.
   */
  folly::Future<ABI49_0_0facebook::ABI49_0_0hermes::debugger::EvalResult> evaluate(
      uint32_t frameIndex,
  ...
  folly::Future<folly::Unit> setPauseOnExceptions(
      const ABI49_0_0facebook::ABI49_0_0hermes::debugger::PauseOnThrowMode &mode);
   ...
   * on the JS thread.
   */
  ABI49_0_0facebook::ABI49_0_0hermes::debugger::Command didPause(
      ABI49_0_0facebook::ABI49_0_0hermes::debugger::Debugger &debugger) override;

  /**
   * breakpointResolved implements the breakpointResolved callback from Hermes.
   */
  void breakpointResolved(
      ABI49_0_0facebook::ABI49_0_0hermes::debugger::Debugger &debugger,
      ABI49_0_0facebook::ABI49_0_0hermes::debugger::BreakpointID breakpointId) override;
 ...
 private:
  ...
  void setBreakpointOnExecutor(
      ...
      std::shared_ptr<
          folly::Promise<ABI49_0_0facebook::ABI49_0_0hermes::debugger::BreakpointInfo>> promise);
  ...
  void setPendingCommandOnExecutor(
      ABI49_0_0facebook::ABI49_0_0hermes::debugger::Command command,
      std::shared_ptr<folly::Promise<folly::Unit>> promise);
  ...
  ABI49_0_0facebook::ABI49_0_0hermes::debugger::Debugger &debugger_;
