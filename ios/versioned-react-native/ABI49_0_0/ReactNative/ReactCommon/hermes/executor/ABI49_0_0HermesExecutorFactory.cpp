...
#include "ABI49_0_0HermesExecutorFactory.h"
...
#include "ABI49_0_0JSITracing.h"

using namespace ABI49_0_0facebook::ABI49_0_0hermes;
...
class DecoratedRuntime : public jsi::WithRuntimeDecorator<ReentrancyCheck> {
 ...
 private:
  ...
  ABI49_0_0facebook::ABI49_0_0hermes::inspector::chrome::DebugSessionToken debugToken_;
};
...
std::unique_ptr<JSExecutor> HermesExecutorFactory::createJSExecutor(
  ...
  std::unique_ptr<HermesRuntime> hermesRuntime;
  {
    ...
    hermesRuntime = ABI49_0_0hermes::makeHermesRuntime(runtimeConfig_);
  }
...
::ABI49_0_0hermes::vm::RuntimeConfig HermesExecutorFactory::defaultRuntimeConfig() {
  return ::ABI49_0_0hermes::vm::RuntimeConfig::Builder()
