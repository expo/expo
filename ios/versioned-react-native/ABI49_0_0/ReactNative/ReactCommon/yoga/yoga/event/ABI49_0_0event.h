...
struct YOGA_EXPORT Event {
  ...
  class Data;
  using Subscriber = void(const ABI49_0_0YGNode&, Type, Data);
  ...
  template <Type E>
  static void publish(const ABI49_0_0YGNode& node, const TypedData<E>& eventData = {}) {
...
private:
  static void publish(const ABI49_0_0YGNode&, Type, const Data&);
};
