...
class CodegenUtils
    ...
    def generate_react_codegen_podspec!(spec, codegen_output_dir, file_manager: File)
        ...
        if @@REACT_CODEGEN_PODSPEC_GENERATED
          Pod::UI.puts "[Codegen] Skipping ABI49_0_0React-Codegen podspec generation."
          return
        end
        ...
        podspec_path = file_manager.join(output_dir, 'ABI49_0_0React-Codegen.podspec.json')
    ...
    # It generates the podspec object that represents the `ABI49_0_0React-Codegen.podspec` file
    #
    # Parameters
    ...
    def get_react_codegen_spec(package_json_file, folly_version: '2021.07.22.00', fabric_enabled: false, hermes_enabled: true, script_phases: nil, file_manager: File)
        ...
        if script_phases
          Pod::UI.puts "[Codegen] Adding script_phases to ABI49_0_0React-Codegen."
    ...
    def use_react_native_codegen_discovery!(
      ...
      # Generate ABI49_0_0React-Codegen podspec here to add the script phases.
