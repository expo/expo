...
def install_flipper_dependencies(pathToReactNative)
    pod 'ABI49_0_0React-Core/DevSupport', :path => "#{pathToReactNative}/", :project_name => 'ABI49_0_0'
end
...
def use_flipper_pods(versions = {}, configurations: ['Debug'])
    ...
    pod 'ABI49_0_0FlipperKit', versions['Flipper'], :configurations => configurations
    pod 'ABI49_0_0FlipperKit/FlipperKitLayoutPlugin', versions['Flipper'], :configurations => configurations
    pod 'ABI49_0_0FlipperKit/SKIOSNetworkPlugin', versions['Flipper'], :configurations => configurations
    pod 'ABI49_0_0FlipperKit/FlipperKitUserDefaultsPlugin', versions['Flipper'], :configurations => configurations
    pod 'ABI49_0_0FlipperKit/FlipperKitReactPlugin', versions['Flipper'], :configurations => configurations
    # List all transitive dependencies for FlipperKit pods
    # to avoid them being linked in Release builds
    pod 'ABI49_0_0Flipper', versions['Flipper'], :configurations => configurations
    pod 'ABI49_0_0Flipper-Boost-iOSX', versions['Flipper-Boost-iOSX'], :configurations => configurations
    pod 'ABI49_0_0Flipper-DoubleConversion', versions['Flipper-DoubleConversion'], :configurations => configurations
    pod 'ABI49_0_0Flipper-Fmt', versions['Flipper-Fmt'], :configurations => configurations
    pod 'ABI49_0_0Flipper-Folly', versions['Flipper-Folly'], :configurations => configurations
    pod 'ABI49_0_0Flipper-Glog', versions['Flipper-Glog'], :configurations => configurations
    pod 'ABI49_0_0Flipper-PeerTalk', versions['Flipper-PeerTalk'], :configurations => configurations
    pod 'ABI49_0_0FlipperKit/Core', versions['Flipper'], :configurations => configurations
    pod 'ABI49_0_0FlipperKit/CppBridge', versions['Flipper'], :configurations => configurations
    pod 'ABI49_0_0FlipperKit/FBCxxFollyDynamicConvert', versions['Flipper'], :configurations => configurations
    pod 'ABI49_0_0FlipperKit/FBDefines', versions['Flipper'], :configurations => configurations
    pod 'ABI49_0_0FlipperKit/FKPortForwarding', versions['Flipper'], :configurations => configurations
    pod 'ABI49_0_0FlipperKit/FlipperKitHighlightOverlay', versions['Flipper'], :configurations => configurations
    pod 'ABI49_0_0FlipperKit/FlipperKitLayoutTextSearchable', versions['Flipper'], :configurations => configurations
    pod 'ABI49_0_0FlipperKit/FlipperKitNetworkPlugin', versions['Flipper'], :configurations => configurations
    pod 'ABI49_0_0OpenSSL-Universal', versions['OpenSSL-Universal'], :configurations => configurations
end
