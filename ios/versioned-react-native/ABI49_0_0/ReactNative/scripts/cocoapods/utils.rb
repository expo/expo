...
class ReactNativePodsUtils
    ...
    def self.set_codegen_search_paths(target_installation_result)
        ReactNativePodsUtils.update_header_paths_if_depends_on(target_installation_result, "ABI49_0_0React-Codegen", [
            "\"${PODS_CONFIGURATION_BUILD_DIR}/ABI49_0_0React-Codegen/React_Codegen.framework/Headers\"",
        ])
    end
