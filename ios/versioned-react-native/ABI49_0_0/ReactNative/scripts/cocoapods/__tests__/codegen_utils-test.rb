...
class CodegenUtilsTests < Test::Unit::TestCase
    ...
    def testGenerateReactCodegenPodspec_whenItHasBeenAlreadyGenerated_doesNothing
        ...
        # Assert
        assert_equal(Pod::UI.collected_messages, ["[Codegen] Skipping ABI49_0_0React-Codegen podspec generation."])
    ...
    def testGenerateReactCodegenPodspec_whenItHasNotBeenAlreadyGenerated_generatesIt
        ...
        assert_equal(Pod::UI.collected_messages, ["[Codegen] Generating ~/app/ios/build/ABI49_0_0React-Codegen.podspec.json"])
        assert_equal(FileMock.open_files_with_mode["~/app/ios/build/ABI49_0_0React-Codegen.podspec.json"], 'w')
    ...
    def testGetReactCodegenSpec_whenFabricEnabledAndScriptPhases_generatesAPodspec
        ...
        assert_equal(Pod::UI.collected_messages, ["[Codegen] Adding script_phases to ABI49_0_0React-Codegen."])
    end
    ...
    def testUseReactCodegenDiscovery_whenParametersAreGood_executeCodegen
        ...
        codegen_spec = {"name" => "ABI49_0_0React-Codegen"}
        ...
        assert_equal(codegen_utils_mock.generate_react_codegen_spec_params,  [{
            ...
            :react_codegen_spec=>{"name"=>"ABI49_0_0React-Codegen"}
        }])
        assert_equal(Pod::Executable.executed_commands, [
            {
                "command" => "node",
        ...
        spec = {
          ...
          'pod_target_xcconfig' => {
            ...
            [
              "\"$(PODS_ROOT)/boost\"",
              "\"$(PODS_ROOT)/RCT-Folly\"",
              "\"${PODS_ROOT}/Headers/Public/ABI49_0_0React-Codegen/react/renderer/components\"",
              "\"$(PODS_ROOT)/Headers/Private/ABI49_0_0React-Fabric\"",
              "\"$(PODS_ROOT)/Headers/Private/ABI49_0_0React-RCTFabric\"",
            ].join(' ')
          },
          'dependencies': {
            "DoubleConversion": [],
