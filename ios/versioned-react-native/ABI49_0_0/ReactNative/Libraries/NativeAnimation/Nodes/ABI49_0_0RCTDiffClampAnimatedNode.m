...
@implementation ABI49_0_0RCTDiffClampAnimatedNode {
...
- (CGFloat)inputNodeValue
{
  if (self.parentNodes == nil) {
    ABI49_0_0RCTLogWarn(@"Animated.DiffClamp node has not been fully initialised.");
    return 0;
  }

  ABI49_0_0RCTValueAnimatedNode *inputNode = (ABI49_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI49_0_0RCTValueAnimatedNode class]]) {
    ABI49_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
