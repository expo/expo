...
// NOTE: This module is temporarily forked (see ABI49_0_0RCTNativeAnimatedTurboModule).
// When making any changes, be sure to apply them to the fork as well.
@interface ABI49_0_0RCTNativeAnimatedModule : ABI49_0_0RCTEventEmitter <
                                         ABI49_0_0RCTBridgeModule,
                                         ABI49_0_0RCTValueAnimatedNodeObserver,
                                         ABI49_0_0RCTEventDispatcherObserver,
                                         ABI49_0_0RCTUIManagerObserver,
