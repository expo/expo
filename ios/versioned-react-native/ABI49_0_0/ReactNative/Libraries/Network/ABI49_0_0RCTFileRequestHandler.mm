...
@interface ABI49_0_0RCTFileRequestHandler () <ABI49_0_0RCTTurboModule>
@end

@implementation ABI49_0_0RCTFileRequestHandler {
...
{
  return [request.URL.scheme caseInsensitiveCompare:@"file"] == NSOrderedSame && !ABI49_0_0RCTIsBundleAssetURL(request.URL);
}
...
Class ABI49_0_0RCTFileRequestHandlerCls(void)
{
  return ABI49_0_0RCTFileRequestHandler.class;
}
