...
@interface ABI49_0_0RCTImageStoreManager : NSObject <ABI49_0_0RCTURLRequestHandler>
...
@interface ABI49_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI49_0_0RCTBridge (ABI49_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI49_0_0RCTImageStoreManager *imageStoreManager;
