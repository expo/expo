...
@class ABI49_0_0RCTImageSource;

@interface ABI49_0_0RCTImageView : ABI49_0_0RCTView
...
@property (nonatomic, copy) NSArray<ABI49_0_0RCTImageSource *> *imageSources;
@property (nonatomic, assign) CGFloat blurRadius;
@property (nonatomic, assign) ABI49_0_0RCTResizeMode resizeMode;
