 ...
 */
ABI49_0_0RCT_EXTERN CGRect ABI49_0_0RCTTargetRect(CGSize sourceSize, CGSize destSize, CGFloat destScale, ABI49_0_0RCTResizeMode resizeMode);
 ...
 */
ABI49_0_0RCT_EXTERN CGAffineTransform ABI49_0_0RCTTransformFromTargetRect(CGSize sourceSize, CGRect targetRect);
 ...
 */
ABI49_0_0RCT_EXTERN CGSize ABI49_0_0RCTTargetSize(
    CGSize sourceSize,
    CGFloat sourceScale,
    CGSize destSize,
    CGFloat destScale,
    ABI49_0_0RCTResizeMode resizeMode,
    BOOL allowUpscaling);
 ...
 */
ABI49_0_0RCT_EXTERN BOOL ABI49_0_0RCTUpscalingRequired(
    CGSize sourceSize,
    CGFloat sourceScale,
    CGSize destSize,
    CGFloat destScale,
 ...
 */
ABI49_0_0RCT_EXTERN UIImage *__nullable
ABI49_0_0RCTDecodeImageWithData(NSData *data, CGSize destSize, CGFloat destScale, ABI49_0_0RCTResizeMode resizeMode);

/**
 * This function takes the source data for an image and decodes just the
 * metadata, without decompressing the image itself.
 */
ABI49_0_0RCT_EXTERN NSDictionary<NSString *, id> *__nullable ABI49_0_0RCTGetImageMetadata(NSData *data);
 ...
 */
ABI49_0_0RCT_EXTERN NSData *__nullable ABI49_0_0RCTGetImageData(UIImage *image, float quality);
 ...
 */
ABI49_0_0RCT_EXTERN UIImage *__nullable
ABI49_0_0RCTTransformImage(UIImage *image, CGSize destSize, CGFloat destScale, CGAffineTransform transform);

/*
 * Return YES if image has an alpha component
 */
ABI49_0_0RCT_EXTERN BOOL ABI49_0_0RCTImageHasAlpha(CGImageRef image);
