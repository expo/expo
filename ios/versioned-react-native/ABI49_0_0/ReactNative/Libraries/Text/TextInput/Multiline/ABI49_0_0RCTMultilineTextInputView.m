...
@implementation ABI49_0_0RCTMultilineTextInputView {
  ABI49_0_0RCTUITextView *_backedTextInputView;
}

- (instancetype)initWithBridge:(ABI49_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    _backedTextInputView = [[ABI49_0_0RCTUITextView alloc] initWithFrame:self.bounds];
...
{
  ABI49_0_0RCTDirectEventBlock onScroll = self.onScroll;
