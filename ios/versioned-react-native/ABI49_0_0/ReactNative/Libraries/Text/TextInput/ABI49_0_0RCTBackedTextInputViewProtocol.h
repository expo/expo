...
@protocol ABI49_0_0RCTBackedTextInputDelegate;
@class ABI49_0_0RCTTextAttributes;

NS_ASSUME_NONNULL_BEGIN

@protocol ABI49_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI49_0_0RCTBackedTextInputDelegate> textInputDelegate;
