...
@implementation ABI49_0_0RCTBaseTextInputView {
...
- (UIView<ABI49_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  ABI49_0_0RCTAssert(NO, @"-[ABI49_0_0RCTBaseTextInputView backedTextInputView] must be implemented in subclass.");
  return nil;
}

#pragma mark - ABI49_0_0RCTComponent
...
- (void)setTextAttributes:(ABI49_0_0RCTTextAttributes *)textAttributes
{
...
{
  id<ABI49_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
...
- (void)setABI49_0_0ReactPaddingInsets:(UIEdgeInsets)ABI49_0_0ReactPaddingInsets
{
  _ABI49_0_0ReactPaddingInsets = ABI49_0_0ReactPaddingInsets;
  // We apply `paddingInsets` as `backedTextInputView`'s `textContainerInset`.
  self.backedTextInputView.textContainerInset = ABI49_0_0ReactPaddingInsets;
  [self setNeedsLayout];
}

- (void)setABI49_0_0ReactBorderInsets:(UIEdgeInsets)ABI49_0_0ReactBorderInsets
{
  _ABI49_0_0ReactBorderInsets = ABI49_0_0ReactBorderInsets;
  // We apply `borderInsets` as `backedTextInputView` layout offset.
  self.backedTextInputView.frame = UIEdgeInsetsInsetRect(self.bounds, ABI49_0_0ReactBorderInsets);
  [self setNeedsLayout];
}
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  [backedTextInputViewTextCopy removeAttribute:ABI49_0_0RCTTextAttributesTagAttributeName
                                         range:NSMakeRange(0, backedTextInputViewTextCopy.length)];

  [attributedTextCopy removeAttribute:ABI49_0_0RCTTextAttributesTagAttributeName
  ...
  } else if (eventLag > ABI49_0_0RCTTextUpdateLagWarningThreshold) {
    ABI49_0_0RCTLog(
...
- (ABI49_0_0RCTTextSelection *)selection
{
  id<ABI49_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
  UITextRange *selectedTextRange = backedTextInputView.selectedTextRange;
  return [[ABI49_0_0RCTTextSelection new]
...
- (void)setSelection:(ABI49_0_0RCTTextSelection *)selection
{
  if (!selection) {
    return;
  }
...
{
  UIView<ABI49_0_0RCTBackedTextInputViewProtocol> *textInputView = self.backedTextInputView;
...
{
  [_eventDispatcher sendTextEventWithType:ABI49_0_0RCTTextEventTypeEnd
                                 ABI49_0_0ReactTag:self.ABI49_0_0ReactTag
                                     text:[self.backedTextInputView.attributedText.string copy]
                                      key:nil
                               eventCount:_nativeEventCount];

  [_eventDispatcher sendTextEventWithType:ABI49_0_0RCTTextEventTypeBlur
                                 ABI49_0_0ReactTag:self.ABI49_0_0ReactTag
                                     text:[self.backedTextInputView.attributedText.string copy]
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldSubmitOnReturn
{
  ...
  if (shouldSubmit) {
    ...
    [_eventDispatcher sendTextEventWithType:ABI49_0_0RCTTextEventTypeSubmit
                                   ABI49_0_0ReactTag:self.ABI49_0_0ReactTag
                                       text:[self.backedTextInputView.attributedText.string copy]
                                        key:nil
                                 eventCount:_nativeEventCount];
...
- (NSString *)textInputShouldChangeText:(NSString *)text inRange:(NSRange)range
{
  ...
  if (!backedTextInputView.textWasPasted) {
    [_eventDispatcher sendTextEventWithType:ABI49_0_0RCTTextEventTypeKeyPress
                                   ABI49_0_0ReactTag:self.ABI49_0_0ReactTag
                                       text:nil
                                        key:text
                                 eventCount:_nativeEventCount];
...
- (void)textInputDidChangeSelection
{
  ...
  ABI49_0_0RCTTextSelection *selection = self.selection;
...
- (CGSize)intrinsicContentSize
{
  ...
  size.width += _ABI49_0_0ReactBorderInsets.left + _ABI49_0_0ReactBorderInsets.right;
  size.height += _ABI49_0_0ReactBorderInsets.top + _ABI49_0_0ReactBorderInsets.bottom;
...
{
  CGFloat compoundHorizontalBorderInset = _ABI49_0_0ReactBorderInsets.left + _ABI49_0_0ReactBorderInsets.right;
  CGFloat compoundVerticalBorderInset = _ABI49_0_0ReactBorderInsets.top + _ABI49_0_0ReactBorderInsets.bottom;
...
{
  [self.backedTextInputView ABI49_0_0ReactFocus];
}

- (void)ABI49_0_0ReactBlur
{
  [self.backedTextInputView ABI49_0_0ReactBlur];
}
...
- (void)didMoveToWindow
{
  if (self.autoFocus && !_didMoveToWindow) {
    ...
    [self.backedTextInputView ABI49_0_0ReactFocusIfNeeded];
  }
...
{
  __weak ABI49_0_0RCTBaseTextInputView *weakSelf = self;
  [_bridge.uiManager rootViewForABI49_0_0ReactTag:self.ABI49_0_0ReactTag
                          withCompletion:^(UIView *rootView) {
                            ABI49_0_0RCTBaseTextInputView *strongSelf = weakSelf;
                            if (rootView) {
                              UIView *accessoryView = [strongSelf->_bridge.uiManager viewForNativeID:nativeID
                                                                                         withRootTag:rootView.ABI49_0_0ReactTag];
                              if (accessoryView && [accessoryView isKindOfClass:[ABI49_0_0RCTInputAccessoryView class]]) {
                                strongSelf.backedTextInputView.inputAccessoryView =
                                    ((ABI49_0_0RCTInputAccessoryView *)accessoryView).inputAccessoryView;
