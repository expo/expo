...
#import <ABI49_0_0React/ABI49_0_0RCTBackedTextInputDelegateAdapter.h>
...
@interface ABI49_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI49_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI49_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
...
@interface ABI49_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI49_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI49_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
