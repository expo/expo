...
extern NSString *const ABI49_0_0RCTTextAttributesIsHighlightedAttributeName;
extern NSString *const ABI49_0_0RCTTextAttributesTagAttributeName;
 ...
 * and <TextInput>.
 */
@interface ABI49_0_0RCTTextAttributes : NSObject <NSCopying>
...
@property (nonatomic, assign) ABI49_0_0RCTDynamicTypeRamp dynamicTypeRamp;
...
@property (nonatomic, assign) ABI49_0_0RCTTextDecorationLineType textDecorationLine;
// Shadow
...
@property (nonatomic, assign) ABI49_0_0RCTTextTransform textTransform;
