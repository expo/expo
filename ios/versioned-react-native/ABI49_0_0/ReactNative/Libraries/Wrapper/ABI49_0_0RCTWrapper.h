...
#import <ABI49_0_0RCTWrapper/ABI49_0_0RCTWrapperViewManager.h>

// Umbrella header with macros

// ABI49_0_0RCT_WRAPPER_FOR_VIEW
#define ABI49_0_0RCT_WRAPPER_FOR_VIEW(ClassName)         \
                                                \
  NS_ASSUME_NONNULL_BEGIN                       \
                                                \
  @interface ClassName                          \
  ##Manager : ABI49_0_0RCTWrapperViewManager             \
                                                \
              @end                              \
                                                \
...
// ABI49_0_0RCT_WRAPPER_FOR_VIEW_CONTROLLER
