...
#import "ABI49_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI49_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ABI49_0_0ReactViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ABI49_0_0ReactViewController detachChildViewController:self.contentViewController];
}
