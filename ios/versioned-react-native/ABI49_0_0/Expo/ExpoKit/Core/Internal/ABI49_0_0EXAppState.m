...
@interface ABI49_0_0EXAppState ()

@property (nonatomic, assign) BOOL isObserving;

@end

@implementation ABI49_0_0EXAppState

+ (NSString *)moduleName { return @"ABI49_0_0RCTAppState"; }
...
- (void)setState:(NSString *)state
{
  if (![state isEqualToString:_lastKnownState]) {
    ...
    // TODO: just make ABI49_0_0EXAppState an expo module implementing ABI49_0_0EXAppLifecycleService
    id<ABI49_0_0EXAppLifecycleService> lifeCycleManager = [[[self.bridge moduleForClass:[ABI49_0_0EXModuleRegistryHolderReactModule class]] exModuleRegistry] getModuleImplementingProtocol:@protocol(ABI49_0_0EXAppLifecycleService)];
...
ABI49_0_0RCT_EXPORT_METHOD(getCurrentAppState:(ABI49_0_0RCTResponseSenderBlock)callback
                  error:(__unused ABI49_0_0RCTResponseSenderBlock)error)
{
