...
@interface ABI49_0_0EXSensorsManagerBinding ()

@property (nonatomic, strong) NSString *scopeKey;
@property (nonatomic, weak) id<ABI49_0_0EXSensorsManagerBindingDelegate> kernelService;

@end

@implementation ABI49_0_0EXSensorsManagerBinding

- (instancetype)initWithScopeKey:(NSString *)scopeKey andKernelService:(id<ABI49_0_0EXSensorsManagerBindingDelegate>)kernelService
{
  if (self = [super init]) {
    _scopeKey = scopeKey;
...
+ (const NSArray<Protocol *> *)exportedInterfaces {
  return @[@protocol(ABI49_0_0EXAccelerometerInterface), @protocol(ABI49_0_0EXBarometerInterface),  @protocol(ABI49_0_0EXDeviceMotionInterface), @protocol(ABI49_0_0EXGyroscopeInterface), @protocol(ABI49_0_0EXMagnetometerInterface), @protocol(ABI49_0_0EXMagnetometerUncalibratedInterface)];
}
