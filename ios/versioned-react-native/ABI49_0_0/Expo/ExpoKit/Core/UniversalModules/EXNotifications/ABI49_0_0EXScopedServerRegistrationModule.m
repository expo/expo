...
@interface ABI49_0_0EXServerRegistrationModule (Protected)
...
@interface ABI49_0_0EXScopedServerRegistrationModule ()

@property (nonatomic, strong) NSString *scopeKey;

@end

@implementation ABI49_0_0EXScopedServerRegistrationModule
