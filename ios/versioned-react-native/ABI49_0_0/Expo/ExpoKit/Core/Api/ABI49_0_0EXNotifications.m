...
#import "ABI49_0_0EXNotifications.h"
...
ABI49_0_0RCT_ENUM_CONVERTER(NSCalendarUnit,
                   (@{
...
@interface ABI49_0_0EXNotifications ()

// unversioned ABI49_0_0EXRemoteNotificationManager instance
@property (nonatomic, weak) id <ABI49_0_0EXNotificationsScopedModuleDelegate> remoteNotificationsDelegate;
@property (nonatomic, weak) id <ABI49_0_0EXNotificationsIdentifiersManager> notificationsIdentifiersManager;
@property (nonatomic, weak) id <ABI49_0_0EXUserNotificationCenterService> userNotificationCenter;

@end

@implementation ABI49_0_0EXNotifications

ABI49_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentNotifications, @"RemoteNotificationManager", @"UserNotificationManager", @"UserNotificationCenter");
...
ABI49_0_0RCT_REMAP_METHOD(getDevicePushTokenAsync,
...
{
  ABI49_0_0EXConstantsBinding *constants = [[[self.bridge moduleForClass:[ABI49_0_0EXModuleRegistryHolderReactModule class]] exModuleRegistry] getModuleImplementingProtocol:@protocol(ABI49_0_0EXConstantsInterface)];
...
ABI49_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
                 getExponentPushTokenAsyncWithResolver:(ABI49_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI49_0_0RCTPromiseRejectBlock)reject)
{
...
ABI49_0_0RCT_EXPORT_METHOD(presentLocalNotification:(NSDictionary *)payload
                  resolver:(ABI49_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI49_0_0RCTPromiseRejectBlock)reject)
{
  if (!payload[@"data"]) {
  ...
  ABI49_0_0RCT_EXPORT_METHOD(scheduleNotificationWithTimer:(NSDictionary *)payload
...
ABI49_0_0RCT_EXPORT_METHOD(scheduleNotificationWithCalendar:(NSDictionary *)payload
                 withOptions:(NSDictionary *)options
                 resolver:(ABI49_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI49_0_0RCTPromiseRejectBlock)reject)
{
...
ABI49_0_0RCT_EXPORT_METHOD(scheduleLocalNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI49_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI49_0_0RCTPromiseRejectBlock)reject)
{
...
ABI49_0_0RCT_EXPORT_METHOD(legacyScheduleLocalRepeatingNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI49_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI49_0_0RCTPromiseRejectBlock)reject)
{
  ...
  localNotification.applicationIconBadgeNumber = [ABI49_0_0RCTConvert NSInteger:payload[@"count"]] ?: 0;
  ...
  localNotification.fireDate = [ABI49_0_0RCTConvert NSDate:options[@"time"]] ?: [NSDate new];
  localNotification.repeatInterval = [ABI49_0_0RCTConvert NSCalendarUnit:options[@"repeat"]] ?: 0;

  __weak typeof(self) weakSelf = self;
  [ABI49_0_0EXUtil performSynchronouslyOnMainThread:^{
    [ABI49_0_0RCTSharedApplication() scheduleLocalNotification:localNotification];
...
ABI49_0_0RCT_REMAP_METHOD(cancelScheduledNotificationAsync,
                 cancelScheduledNotificationAsync:(NSString *)uniqueId
                 withResolver:(ABI49_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI49_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI49_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
...
ABI49_0_0RCT_REMAP_METHOD(cancelAllScheduledNotificationsAsync,
                 cancelAllScheduledNotificationsAsyncWithResolver:(ABI49_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(__unused ABI49_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI49_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
  [_userNotificationCenter getPendingNotificationRequestsWithCompletionHandler:^(NSArray<UNNotificationRequest *> * _Nonnull requests) {
...
ABI49_0_0RCT_REMAP_METHOD(getBadgeNumberAsync,
                 getBadgeNumberAsyncWithResolver:(ABI49_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI49_0_0RCTPromiseRejectBlock)reject)
{
  __block NSInteger badgeNumber;
  [ABI49_0_0EXUtil performSynchronouslyOnMainThread:^{
    badgeNumber = ABI49_0_0RCTSharedApplication().applicationIconBadgeNumber;
  }];
  resolve(@(badgeNumber));
}

ABI49_0_0RCT_EXPORT_METHOD(setBadgeNumberAsync:(nonnull NSNumber *)number
                  resolver:(ABI49_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI49_0_0RCTPromiseRejectBlock)reject)
{
  [ABI49_0_0EXUtil performSynchronouslyOnMainThread:^{
    ABI49_0_0RCTSharedApplication().applicationIconBadgeNumber = number.integerValue;
  }];
  resolve(nil);
}
...
ABI49_0_0RCT_REMAP_METHOD(createCategoryAsync,
...
ABI49_0_0RCT_REMAP_METHOD(deleteCategoryAsync,
...
- (NSDateComponents *)dateComponentsFrom:(NSNumber * _Nullable)unixTime {
  ...
  NSDate *triggerDate = [ABI49_0_0RCTConvert NSDate:unixTime] ?: [NSDate new];
