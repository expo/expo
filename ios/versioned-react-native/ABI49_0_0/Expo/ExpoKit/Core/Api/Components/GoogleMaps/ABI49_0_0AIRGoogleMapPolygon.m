//
//  ABI49_0_0AIRGoogleMapPolygon.m
//
...
@implementation ABI49_0_0AIRGoogleMapPolygon
{
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _polygon = [[ABI49_0_0AIRGMSPolygon alloc] init];
  }
...
- (void)setCoordinates:(NSArray<ABI49_0_0AIRMapCoordinate *> *)coordinates
{
...
- (void)setHoles:(NSArray<NSArray<ABI49_0_0AIRMapCoordinate *> *> *)holes
{
  _holes = holes;
