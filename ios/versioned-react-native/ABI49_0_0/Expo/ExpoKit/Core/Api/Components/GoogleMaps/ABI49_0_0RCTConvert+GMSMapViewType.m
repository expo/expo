//
//  ABI49_0_0RCTConvert+GMSMapViewType.m
//
...
@implementation ABI49_0_0RCTConvert (GMSMapViewType)
  ABI49_0_0RCT_ENUM_CONVERTER(GMSMapViewType,
  (
    @{
...
+ (GMSCameraPosition*)GMSCameraPosition:(id)json
{
    ...
    return [ABI49_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:nil];
}
