...
#import "ABI49_0_0AIRMapLocalTileOverlay.h"

@implementation ABI49_0_0AIRMapLocalTile {
...
- (void) createTileOverlayAndRendererIfPossible
{
    ...
    self.tileOverlay = [[ABI49_0_0AIRMapLocalTileOverlay alloc] initWithURLTemplate:self.pathTemplate];
