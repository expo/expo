//
//  ABI49_0_0AIRGoogleMapPolyline.m
//
...
#import "ABI49_0_0AIRGMSPolyline.h"
...
@implementation ABI49_0_0AIRGoogleMapPolyline

- (instancetype)init
{
  if (self = [super init]) {
    _polyline = [[ABI49_0_0AIRGMSPolyline alloc] init];
  }
  return self;
}
