...
@class ABI49_0_0AIRMapMarker;

extern const NSTimeInterval ABI49_0_0AIRMapRegionChangeObserveInterval;
extern const CGFloat ABI49_0_0AIRMapZoomBoundBuffer;
extern const NSInteger ABI49_0_0AIRMapMaxZoomLevel;

@interface ABI49_0_0AIRMap: MKMapView<ABI49_0_0SMCalloutViewDelegate>

@property (nonatomic, strong) ABI49_0_0SMCalloutView *calloutView;
...
@property (nonatomic, copy) ABI49_0_0RCTBubblingEventBlock onDoublePress;
@property (nonatomic, copy) ABI49_0_0RCTBubblingEventBlock onLongPress;
@property (nonatomic, copy) ABI49_0_0RCTDirectEventBlock onMarkerPress;
@property (nonatomic, copy) ABI49_0_0RCTDirectEventBlock onMarkerSelect;
@property (nonatomic, copy) ABI49_0_0RCTDirectEventBlock onMarkerDeselect;
@property (nonatomic, copy) ABI49_0_0RCTDirectEventBlock onMarkerDragStart;
@property (nonatomic, copy) ABI49_0_0RCTDirectEventBlock onMarkerDrag;
@property (nonatomic, copy) ABI49_0_0RCTDirectEventBlock onMarkerDragEnd;
