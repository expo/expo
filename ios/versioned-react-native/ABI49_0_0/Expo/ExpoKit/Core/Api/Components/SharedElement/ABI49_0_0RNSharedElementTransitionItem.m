//
//  ABI49_0_0RNSharedElementTransitionItem.m
//  ABI49_0_0React-native-shared-element
//

#import <Foundation/Foundation.h>
#import <UIKit/UIKit.h>
#import "ABI49_0_0RNSharedElementTransitionItem.h"
...
@implementation ABI49_0_0RNSharedElementTransitionItem {
...
- (void) setNode:(ABI49_0_0RNSharedElementNode *)node
{
  if (_node == node) {
...
- (CGRect) contentLayoutForContent:(ABI49_0_0RNSharedElementContent*)content
{
  ...
  return [ABI49_0_0RNSharedElementContent layoutForRect:_style.layout content:content contentMode:_style.contentMode reverse:NO];
}
