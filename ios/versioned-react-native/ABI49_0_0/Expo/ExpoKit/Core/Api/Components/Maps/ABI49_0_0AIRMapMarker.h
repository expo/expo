...
@interface ABI49_0_0AIRMapMarker : MKAnnotationView <MKAnnotation>

@property (nonatomic, strong) ABI49_0_0AIRMapCallout *calloutView;
@property (nonatomic, weak) ABI49_0_0AIRMap *map;
...
@property (nonatomic, copy) ABI49_0_0RCTDirectEventBlock onSelect;
@property (nonatomic, copy) ABI49_0_0RCTDirectEventBlock onDeselect;
@property (nonatomic, copy) ABI49_0_0RCTDirectEventBlock onCalloutPress;
...
@interface ABI49_0_0AIREmptyCalloutBackgroundView : ABI49_0_0SMCalloutBackgroundView
@end
