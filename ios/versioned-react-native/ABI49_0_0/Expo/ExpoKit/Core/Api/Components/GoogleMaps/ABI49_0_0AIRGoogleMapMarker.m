...
@interface ABI49_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI49_0_0AIRGMSMarker*)marker;
@end

@implementation ABI49_0_0AIRGoogleMapMarker {
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI49_0_0AIRGMSMarker alloc] init];
...
- (void)insertABI49_0_0ReactSubview:(id<ABI49_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI49_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI49_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI49_0_0AIRDummyView *dummySubview = [[ABI49_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertABI49_0_0ReactSubview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeABI49_0_0ReactSubview:(id<ABI49_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI49_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeABI49_0_0ReactSubview:(UIView*)dummySubview];
}
...
- (void)setOnPress:(ABI49_0_0RCTBubblingEventBlock)onPress {
  _realMarker.onPress = onPress;
}

- (ABI49_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/ABI49_0_0React-native-maps/ABI49_0_0React-native-maps/issues/738)
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI49_0_0RN?
...
- (void)setIconSrc:(NSString *)iconSrc
{
  ...
  if (!_realMarker.icon) {
    // prevent glitch with marker (cf. https://github.com/ABI49_0_0React-native-maps/ABI49_0_0React-native-maps/issues/3657)
    UIImage *emptyImage = [[UIImage alloc] init];
    _realMarker.icon = emptyImage;
  }

  _reloadImageCancellationBlock =
  [[_bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI49_0_0RCTConvert NSURLRequest:_iconSrc]
                                          size:self.bounds.size
                                         scale:ABI49_0_0RCTScreenScale()
                                       clipped:YES
                                    resizeMode:ABI49_0_0RCTResizeModeCenter
