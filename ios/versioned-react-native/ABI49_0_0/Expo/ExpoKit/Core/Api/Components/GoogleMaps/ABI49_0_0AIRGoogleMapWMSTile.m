//
//  ABI49_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI49_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI49_0_0WMSTileOverlay *tile = [[ABI49_0_0WMSTileOverlay alloc] init];
...
@implementation ABI49_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
