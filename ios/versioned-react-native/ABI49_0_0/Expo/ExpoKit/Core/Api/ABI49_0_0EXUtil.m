...
@interface ABI49_0_0EXUtil ()

@property (nonatomic, weak) id<ABI49_0_0EXUtilService> kernelUtilService;

@end

ABI49_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI49_0_0EXUtil, util)

@implementation ABI49_0_0EXUtil

ABI49_0_0EX_EXPORT_SCOPED_MODULE(ExponentUtil, UtilService);

- (instancetype)initWithExperienceStableLegacyId:(NSString *)experienceStableLegacyId
                                        scopeKey:(NSString *)scopeKey
                                    easProjectId:(NSString *)easProjectId
                           kernelServiceDelegate:(id<ABI49_0_0EXUtilService>)kernelServiceInstance
