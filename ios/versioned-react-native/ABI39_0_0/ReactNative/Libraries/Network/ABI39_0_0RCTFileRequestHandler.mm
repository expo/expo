...
@interface ABI39_0_0RCTFileRequestHandler() <ABI39_0_0RCTTurboModule>
@end

@implementation ABI39_0_0RCTFileRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  && !ABI39_0_0RCTIsBundleAssetURL(request.URL);
}

- (NSOperation *)sendRequest:(NSURLRequest *)request
                withDelegate:(id<ABI39_0_0RCTURLRequestDelegate>)delegate
{
  // Lazy setup
  if (!_fileQueue) {
...
Class ABI39_0_0RCTFileRequestHandlerCls(void) {
  return ABI39_0_0RCTFileRequestHandler.class;
}
