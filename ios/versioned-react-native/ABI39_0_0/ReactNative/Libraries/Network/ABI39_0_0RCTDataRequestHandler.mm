...
@interface ABI39_0_0RCTDataRequestHandler() <ABI39_0_0RCTTurboModule>
@end

@implementation ABI39_0_0RCTDataRequestHandler
{
...
Class ABI39_0_0RCTDataRequestHandlerCls(void) {
  return ABI39_0_0RCTDataRequestHandler.class;
}
