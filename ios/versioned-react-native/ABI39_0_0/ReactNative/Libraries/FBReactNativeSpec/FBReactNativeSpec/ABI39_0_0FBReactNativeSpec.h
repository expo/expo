...
#import <ABI39_0_0RCTRequired/ABI39_0_0RCTRequired.h>
...
@protocol ABI39_0_0NativeAccessibilityInfoSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>

- (void)isReduceMotionEnabled:(ABI39_0_0RCTResponseSenderBlock)onSuccess;
- (void)isTouchExplorationEnabled:(ABI39_0_0RCTResponseSenderBlock)onSuccess;
- (void)setAccessibilityFocus:(double)ABI39_0_0ReactTag;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeAccessibilityInfoSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeAccessibilityManager_SpecSetAccessibilityContentSizeMultipliersJSMultipliers)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeAccessibilityManager_SpecSetAccessibilityContentSizeMultipliersJSMultipliers:(id)json;
@end
@protocol ABI39_0_0NativeAccessibilityManagerSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>

- (void)getCurrentBoldTextState:(ABI39_0_0RCTResponseSenderBlock)onSuccess
                        onError:(ABI39_0_0RCTResponseSenderBlock)onError;
- (void)getCurrentGrayscaleState:(ABI39_0_0RCTResponseSenderBlock)onSuccess
                         onError:(ABI39_0_0RCTResponseSenderBlock)onError;
- (void)getCurrentInvertColorsState:(ABI39_0_0RCTResponseSenderBlock)onSuccess
                            onError:(ABI39_0_0RCTResponseSenderBlock)onError;
- (void)getCurrentReduceMotionState:(ABI39_0_0RCTResponseSenderBlock)onSuccess
                            onError:(ABI39_0_0RCTResponseSenderBlock)onError;
- (void)getCurrentReduceTransparencyState:(ABI39_0_0RCTResponseSenderBlock)onSuccess
                                  onError:(ABI39_0_0RCTResponseSenderBlock)onError;
- (void)getCurrentVoiceOverState:(ABI39_0_0RCTResponseSenderBlock)onSuccess
                         onError:(ABI39_0_0RCTResponseSenderBlock)onError;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeAccessibilityManagerSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
namespace JS {
  namespace NativeActionSheetManager {
    struct SpecShowActionSheetWithOptionsOptions {
      ...
      folly::Optional<ABI39_0_0facebook::ABI39_0_0React::LazyVector<NSString *>> options() const;
      folly::Optional<ABI39_0_0facebook::ABI39_0_0React::LazyVector<double>> destructiveButtonIndices() const;
...
@interface ABI39_0_0RCTCxxConvert (NativeActionSheetManager_SpecShowActionSheetWithOptionsOptions)
...
namespace JS {
  namespace NativeActionSheetManager {
    struct SpecShowShareActionSheetWithOptionsOptions {
      ...
      folly::Optional<double> anchor() const;
      folly::Optional<double> tintColor() const;
      folly::Optional<ABI39_0_0facebook::ABI39_0_0React::LazyVector<NSString *>> excludedActivityTypes() const;
      NSString *userInterfaceStyle() const;
...
@interface ABI39_0_0RCTCxxConvert (NativeActionSheetManager_SpecShowShareActionSheetWithOptionsOptions)
...
@interface ABI39_0_0RCTCxxConvert (NativeActionSheetManager_SpecShowShareActionSheetWithOptionsFailureCallbackError)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeActionSheetManager_SpecShowShareActionSheetWithOptionsFailureCallbackError:(id)json;
@end
@protocol ABI39_0_0NativeActionSheetManagerSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
- (void)showShareActionSheetWithOptions:(JS::NativeActionSheetManager::SpecShowShareActionSheetWithOptionsOptions &)options
                        failureCallback:(ABI39_0_0RCTResponseSenderBlock)failureCallback
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeActionSheetManagerSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
namespace JS {
  namespace NativeAlertManager {
    struct Args {
      NSString *title() const;
      NSString *message() const;
      folly::Optional<ABI39_0_0facebook::ABI39_0_0React::LazyVector<id<NSObject>>> buttons() const;
      NSString *type() const;
...
@interface ABI39_0_0RCTCxxConvert (NativeAlertManager_Args)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeAlertManager_Args:(id)json;
@end
@protocol ABI39_0_0NativeAlertManagerSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeAlertManagerSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeAnimatedModule_EndResult)
...
namespace JS {
  namespace NativeAnimatedModule {
    struct EventMapping {
      ABI39_0_0facebook::ABI39_0_0React::LazyVector<NSString *> nativeEventPath() const;
...
@interface ABI39_0_0RCTCxxConvert (NativeAnimatedModule_EventMapping)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeAnimatedModule_EventMapping:(id)json;
@end
@protocol ABI39_0_0NativeAnimatedModuleSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
- (void)startAnimatingNode:(double)animationId
                   nodeTag:(double)nodeTag
                    config:(NSDictionary *)config
               endCallback:(ABI39_0_0RCTResponseSenderBlock)endCallback;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeAnimatedModuleSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeAnimationsDebugModuleSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeAnimationsDebugModuleSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeAppState_SpecGetCurrentAppStateSuccessAppState)
...
namespace JS {
  namespace NativeAppState {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI39_0_0RCTRequired<NSString *> initialAppState;
        };
...
@protocol ABI39_0_0NativeAppStateSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>

- (void)getCurrentAppState:(ABI39_0_0RCTResponseSenderBlock)success
                     error:(ABI39_0_0RCTResponseSenderBlock)error;
- (void)addListener:(NSString *)eventName;
- (void)removeListeners:(double)count;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeAppState::Constants::Builder>)constantsToExport;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeAppState::Constants::Builder>)getConstants;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeAppStateSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeAppearanceSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeAppearanceSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeAppearance_AppearancePreferences)
...
@interface ABI39_0_0RCTCxxConvert (NativeAsyncStorage_SpecMultiGetCallbackErrorsElement)
...
@interface ABI39_0_0RCTCxxConvert (NativeAsyncStorage_SpecMultiSetCallbackErrorsElement)
...
@interface ABI39_0_0RCTCxxConvert (NativeAsyncStorage_SpecMultiMergeCallbackErrorsElement)
...
@interface ABI39_0_0RCTCxxConvert (NativeAsyncStorage_SpecMultiRemoveCallbackErrorsElement)
...
@interface ABI39_0_0RCTCxxConvert (NativeAsyncStorage_SpecClearCallbackError)
...
@interface ABI39_0_0RCTCxxConvert (NativeAsyncStorage_SpecGetAllKeysCallbackError)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeAsyncStorage_SpecGetAllKeysCallbackError:(id)json;
@end
@protocol ABI39_0_0NativeAsyncStorageSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
- (void)multiRemove:(NSArray *)keys
           callback:(ABI39_0_0RCTResponseSenderBlock)callback;
- (void)clear:(ABI39_0_0RCTResponseSenderBlock)callback;
- (void)getAllKeys:(ABI39_0_0RCTResponseSenderBlock)callback;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeAsyncStorageSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
namespace JS {
  namespace NativeBlobModule {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI39_0_0RCTRequired<NSString *> BLOB_URI_SCHEME;
          ABI39_0_0RCTRequired<NSString *> BLOB_URI_HOST;
        };
...
@protocol ABI39_0_0NativeBlobModuleSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeBlobModule::Constants::Builder>)constantsToExport;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeBlobModule::Constants::Builder>)getConstants;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeBlobModuleSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeBugReportingSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeBugReportingSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
namespace JS {
  namespace NativeCameraRollManager {
    struct GetPhotosParams {
      ...
      folly::Optional<ABI39_0_0facebook::ABI39_0_0React::LazyVector<NSString *>> mimeTypes() const;
...
@interface ABI39_0_0RCTCxxConvert (NativeCameraRollManager_GetPhotosParams)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeCameraRollManager_GetPhotosParams:(id)json;
@end
@protocol ABI39_0_0NativeCameraRollManagerSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeCameraRollManagerSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeCameraRollManager_PhotoIdentifierNodeImage)
...
@interface ABI39_0_0RCTCxxConvert (NativeCameraRollManager_PhotoIdentifierNodeLocation)
...
@interface ABI39_0_0RCTCxxConvert (NativeCameraRollManager_PhotoIdentifierNode)
...
@interface ABI39_0_0RCTCxxConvert (NativeCameraRollManager_PhotoIdentifier)
...
@interface ABI39_0_0RCTCxxConvert (NativeCameraRollManager_PhotoIdentifiersPagePage_info)
...
namespace JS {
  namespace NativeCameraRollManager {
    struct PhotoIdentifiersPage {
      ABI39_0_0facebook::ABI39_0_0React::LazyVector<JS::NativeCameraRollManager::PhotoIdentifier> edges() const;
...
@interface ABI39_0_0RCTCxxConvert (NativeCameraRollManager_PhotoIdentifiersPage)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeCameraRollManager_PhotoIdentifiersPage:(id)json;
@end
@protocol ABI39_0_0NativeClipboardSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>

- (void)getString:(ABI39_0_0RCTPromiseResolveBlock)resolve
           reject:(ABI39_0_0RCTPromiseRejectBlock)reject;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeClipboardSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeDatePickerAndroidSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeDatePickerAndroidSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeDevLoadingViewSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeDevLoadingViewSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeDevMenuSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeDevMenuSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeDevSettingsSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeDevSettingsSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeDeviceEventManagerSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeDeviceEventManagerSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
namespace JS {
  namespace NativeDeviceInfo {
    struct DisplayMetrics {
      ...
      struct Builder {
        struct Input {
          ABI39_0_0RCTRequired<double> width;
          ABI39_0_0RCTRequired<double> height;
          ABI39_0_0RCTRequired<double> scale;
          ABI39_0_0RCTRequired<double> fontScale;
        };
    ...
    struct DisplayMetricsAndroid {
      ...
      struct Builder {
        struct Input {
          ...
          ABI39_0_0RCTRequired<double> scale;
          ABI39_0_0RCTRequired<double> fontScale;
          ABI39_0_0RCTRequired<double> densityDpi;
        };
...
namespace JS {
  namespace NativeDeviceInfo {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI39_0_0RCTRequired<JS::NativeDeviceInfo::DimensionsPayload::Builder> Dimensions;
...
@protocol ABI39_0_0NativeDeviceInfoSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>

- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeDeviceInfo::Constants::Builder>)constantsToExport;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeDeviceInfo::Constants::Builder>)getConstants;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeDeviceInfoSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
namespace JS {
  namespace NativeDialogManagerAndroid {
    struct DialogOptions {
      ...
      folly::Optional<ABI39_0_0facebook::ABI39_0_0React::LazyVector<NSString *>> items() const;
...
@interface ABI39_0_0RCTCxxConvert (NativeDialogManagerAndroid_DialogOptions)
...
namespace JS {
  namespace NativeDialogManagerAndroid {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI39_0_0RCTRequired<NSString *> buttonClicked;
          ABI39_0_0RCTRequired<NSString *> dismissed;
          ABI39_0_0RCTRequired<double> buttonPositive;
          ABI39_0_0RCTRequired<double> buttonNegative;
          ABI39_0_0RCTRequired<double> buttonNeutral;
        };
...
@protocol ABI39_0_0NativeDialogManagerAndroidSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>

- (void)showAlert:(JS::NativeDialogManagerAndroid::DialogOptions &)config
          onError:(ABI39_0_0RCTResponseSenderBlock)onError
         onAction:(ABI39_0_0RCTResponseSenderBlock)onAction;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeDialogManagerAndroid::Constants::Builder>)constantsToExport;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeDialogManagerAndroid::Constants::Builder>)getConstants;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeDialogManagerAndroidSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeExceptionsManager_StackFrame)
...
namespace JS {
  namespace NativeExceptionsManager {
    struct ExceptionData {
      ...
      ABI39_0_0facebook::ABI39_0_0React::LazyVector<JS::NativeExceptionsManager::StackFrame> stack() const;
      double id_() const;
      bool isFatal() const;
...
@interface ABI39_0_0RCTCxxConvert (NativeExceptionsManager_ExceptionData)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeExceptionsManager_ExceptionData:(id)json;
@end
@protocol ABI39_0_0NativeExceptionsManagerSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeExceptionsManagerSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeFileReaderModuleSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeFileReaderModuleSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeFrameRateLogger_SpecSetGlobalOptionsOptions)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeFrameRateLogger_SpecSetGlobalOptionsOptions:(id)json;
@end
@protocol ABI39_0_0NativeFrameRateLoggerSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeFrameRateLoggerSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeHeadlessJsTaskSupportSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeHeadlessJsTaskSupportSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
namespace JS {
  namespace NativeI18nManager {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI39_0_0RCTRequired<bool> isRTL;
          ABI39_0_0RCTRequired<bool> doLeftAndRightSwapInRTL;
        };
...
@protocol ABI39_0_0NativeI18nManagerSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>

- (void)allowRTL:(BOOL)allowRTL;
- (void)forceRTL:(BOOL)forceRTL;
- (void)swapLeftAndRightInRTL:(BOOL)flipStyles;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeI18nManager::Constants::Builder>)constantsToExport;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeI18nManager::Constants::Builder>)getConstants;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeI18nManagerSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeImageEditor_OptionsOffset)
...
@interface ABI39_0_0RCTCxxConvert (NativeImageEditor_OptionsSize)
...
@interface ABI39_0_0RCTCxxConvert (NativeImageEditor_OptionsDisplaySize)
...
@interface ABI39_0_0RCTCxxConvert (NativeImageEditor_Options)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeImageEditor_Options:(id)json;
@end
@protocol ABI39_0_0NativeImageEditorSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeImageEditorSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeImageLoaderAndroidSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeImageLoaderAndroidSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeImageLoaderIOSSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeImageLoaderIOSSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeImagePickerIOS_SpecOpenCameraDialogConfig)
...
@interface ABI39_0_0RCTCxxConvert (NativeImagePickerIOS_SpecOpenSelectDialogConfig)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeImagePickerIOS_SpecOpenSelectDialogConfig:(id)json;
@end
@protocol ABI39_0_0NativeImagePickerIOSSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>

- (void)canRecordVideos:(ABI39_0_0RCTResponseSenderBlock)callback;
- (void)canUseCamera:(ABI39_0_0RCTResponseSenderBlock)callback;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeImagePickerIOSSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeImageStore_SpecAddImageFromBase64ErrorCallbackError)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeImageStore_SpecAddImageFromBase64ErrorCallbackError:(id)json;
@end
@protocol ABI39_0_0NativeImageStoreSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeImageStoreSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeJSCHeapCaptureSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeJSCHeapCaptureSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeJSCSamplingProfilerSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeJSCSamplingProfilerSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
namespace JS {
  namespace NativeJSDevSupport {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI39_0_0RCTRequired<double> ERROR_CODE_EXCEPTION;
          ABI39_0_0RCTRequired<double> ERROR_CODE_VIEW_NOT_FOUND;
        };
...
@protocol ABI39_0_0NativeJSDevSupportSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>

- (void)onSuccess:(NSString *)data;
- (void)onFailure:(double)errorCode
            error:(NSString *)error;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeJSDevSupport::Constants::Builder>)constantsToExport;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeJSDevSupport::Constants::Builder>)getConstants;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeJSDevSupportSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeKeyboardObserverSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeKeyboardObserverSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeLinking_SpecSendIntentExtrasElement)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeLinking_SpecSendIntentExtrasElement:(id)json;
@end
@protocol ABI39_0_0NativeLinkingSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>

- (void)getInitialURL:(ABI39_0_0RCTPromiseResolveBlock)resolve
               reject:(ABI39_0_0RCTPromiseRejectBlock)reject;
...
- (void)openURL:(NSString *)url
        resolve:(ABI39_0_0RCTPromiseResolveBlock)resolve
         reject:(ABI39_0_0RCTPromiseRejectBlock)reject;
- (void)openSettings:(ABI39_0_0RCTPromiseResolveBlock)resolve
              reject:(ABI39_0_0RCTPromiseRejectBlock)reject;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeLinkingSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeLogBoxSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeLogBoxSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeModalManagerSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeModalManagerSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeNetworkingAndroidSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
- (void)abortRequest:(double)requestId;
- (void)clearCookies:(ABI39_0_0RCTResponseSenderBlock)callback;
- (void)addListener:(NSString *)eventName;
- (void)removeListeners:(double)count;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeNetworkingAndroidSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeNetworkingIOS_SpecSendRequestQuery)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeNetworkingIOS_SpecSendRequestQuery:(id)json;
@end
@protocol ABI39_0_0NativeNetworkingIOSSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeNetworkingIOSSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativePermissionsAndroidSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativePermissionsAndroidSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
namespace JS {
  namespace NativePlatformConstantsAndroid {
    struct ConstantsreactNativeVersion {
      ...
      struct Builder {
        struct Input {
          ABI39_0_0RCTRequired<double> major;
          ABI39_0_0RCTRequired<double> minor;
          ABI39_0_0RCTRequired<double> patch;
          ABI39_0_0RCTRequired<folly::Optional<double>> prerelease;
        };
...
namespace JS {
  namespace NativePlatformConstantsAndroid {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI39_0_0RCTRequired<bool> isTesting;
          ABI39_0_0RCTRequired<JS::NativePlatformConstantsAndroid::ConstantsreactNativeVersion::Builder> reactNativeVersion;
          ABI39_0_0RCTRequired<double> Version;
          ABI39_0_0RCTRequired<NSString *> Release;
          ABI39_0_0RCTRequired<NSString *> Serial;
          ABI39_0_0RCTRequired<NSString *> Fingerprint;
          ABI39_0_0RCTRequired<NSString *> Model;
          NSString *ServerHost;
          ABI39_0_0RCTRequired<NSString *> uiMode;
        };
...
@protocol ABI39_0_0NativePlatformConstantsAndroidSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>

- (NSString *)getAndroidID;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativePlatformConstantsAndroid::Constants::Builder>)constantsToExport;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativePlatformConstantsAndroid::Constants::Builder>)getConstants;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativePlatformConstantsAndroidSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
  ...
  namespace NativePlatformConstantsIOS {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI39_0_0RCTRequired<bool> isTesting;
          ABI39_0_0RCTRequired<JS::NativePlatformConstantsIOS::ConstantsreactNativeVersion::Builder> reactNativeVersion;
          ABI39_0_0RCTRequired<bool> forceTouchAvailable;
          ABI39_0_0RCTRequired<NSString *> osVersion;
          ABI39_0_0RCTRequired<NSString *> systemName;
          ABI39_0_0RCTRequired<NSString *> interfaceIdiom;
        };
...
@protocol ABI39_0_0NativePlatformConstantsIOSSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>

- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativePlatformConstantsIOS::Constants::Builder>)constantsToExport;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativePlatformConstantsIOS::Constants::Builder>)getConstants;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativePlatformConstantsIOSSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativePushNotificationManagerIOS_SpecRequestPermissionsPermission)
...
@interface ABI39_0_0RCTCxxConvert (NativePushNotificationManagerIOS_Permissions)
...
@interface ABI39_0_0RCTCxxConvert (NativePushNotificationManagerIOS_Notification)
+ (ABI39_0_0RCTManagedPointer *)JS_NativePushNotificationManagerIOS_Notification:(id)json;
@end
@protocol ABI39_0_0NativePushNotificationManagerIOSSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
- (void)getApplicationIconBadgeNumber:(ABI39_0_0RCTResponseSenderBlock)callback;
- (void)requestPermissions:(JS::NativePushNotificationManagerIOS::SpecRequestPermissionsPermission &)permission
                   resolve:(ABI39_0_0RCTPromiseResolveBlock)resolve
                    reject:(ABI39_0_0RCTPromiseRejectBlock)reject;
- (void)abandonPermissions;
- (void)checkPermissions:(ABI39_0_0RCTResponseSenderBlock)callback;
...
- (void)getInitialNotification:(ABI39_0_0RCTPromiseResolveBlock)resolve
                        reject:(ABI39_0_0RCTPromiseRejectBlock)reject;
- (void)getScheduledLocalNotifications:(ABI39_0_0RCTResponseSenderBlock)callback;
- (void)removeAllDeliveredNotifications;
- (void)removeDeliveredNotifications:(NSArray *)identifiers;
- (void)getDeliveredNotifications:(ABI39_0_0RCTResponseSenderBlock)callback;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativePushNotificationManagerIOSSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeRedBoxSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeRedBoxSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeSegmentFetcherSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeSegmentFetcherSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
namespace JS {
  namespace NativeSettingsManager {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI39_0_0RCTRequired<id<NSObject>> settings;
        };
...
@protocol ABI39_0_0NativeSettingsManagerSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>

- (void)setValues:(NSDictionary *)values;
- (void)deleteValues:(NSArray *)values;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeSettingsManager::Constants::Builder>)constantsToExport;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeSettingsManager::Constants::Builder>)getConstants;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeSettingsManagerSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeShareModule_SpecShareContent)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeShareModule_SpecShareContent:(id)json;
@end
@protocol ABI39_0_0NativeShareModuleSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeShareModuleSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeSoundManagerSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeSoundManagerSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
namespace JS {
  namespace NativeSourceCode {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI39_0_0RCTRequired<NSString *> scriptURL;
        };
...
@protocol ABI39_0_0NativeSourceCodeSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>

- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeSourceCode::Constants::Builder>)constantsToExport;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeSourceCode::Constants::Builder>)getConstants;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeSourceCodeSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
  ...
  namespace NativeStatusBarManagerAndroid {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI39_0_0RCTRequired<double> HEIGHT;
          ABI39_0_0RCTRequired<double> DEFAULT_BACKGROUND_COLOR;
        };
...
@protocol ABI39_0_0NativeStatusBarManagerAndroidSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeStatusBarManagerAndroid::Constants::Builder>)constantsToExport;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeStatusBarManagerAndroid::Constants::Builder>)getConstants;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeStatusBarManagerAndroidSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeStatusBarManagerIOS_SpecGetHeightCallbackResult)
...
@protocol ABI39_0_0NativeStatusBarManagerIOSSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>

- (void)getHeight:(ABI39_0_0RCTResponseSenderBlock)callback;
...
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeStatusBarManagerIOS::Constants::Builder>)constantsToExport;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeStatusBarManagerIOS::Constants::Builder>)getConstants;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeStatusBarManagerIOSSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeTVNavigationEventEmitterSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeTVNavigationEventEmitterSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeTimePickerAndroid_TimePickerOptions)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeTimePickerAndroid_TimePickerOptions:(id)json;
@end
@protocol ABI39_0_0NativeTimePickerAndroidSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeTimePickerAndroidSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeTimePickerAndroid_TimePickerResult)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeTimePickerAndroid_TimePickerResult:(id)json;
@end
@protocol ABI39_0_0NativeTimingSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeTimingSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
namespace JS {
  namespace NativeToastAndroid {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI39_0_0RCTRequired<double> SHORT;
          ABI39_0_0RCTRequired<double> LONG;
          ABI39_0_0RCTRequired<double> TOP;
          ABI39_0_0RCTRequired<double> BOTTOM;
          ABI39_0_0RCTRequired<double> CENTER;
        };
...
@protocol ABI39_0_0NativeToastAndroidSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeToastAndroid::Constants::Builder>)constantsToExport;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeToastAndroid::Constants::Builder>)getConstants;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeToastAndroidSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@protocol ABI39_0_0NativeUIManagerSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
- (void)createView:(NSNumber *)ABI39_0_0ReactTag
          viewName:(NSString *)viewName
           rootTag:(double)rootTag
             props:(NSDictionary *)props;
- (void)updateView:(double)ABI39_0_0ReactTag
          viewName:(NSString *)viewName
             props:(NSDictionary *)props;
- (void)focus:(NSNumber *)ABI39_0_0ReactTag;
- (void)blur:(NSNumber *)ABI39_0_0ReactTag;
- (void)findSubviewIn:(NSNumber *)ABI39_0_0ReactTag
                point:(NSArray *)point
             callback:(ABI39_0_0RCTResponseSenderBlock)callback;
- (void)dispatchViewManagerCommand:(NSNumber *)ABI39_0_0ReactTag
                         commandID:(double)commandID
                       commandArgs:(NSArray *_Nullable)commandArgs;
- (void)measure:(NSNumber *)ABI39_0_0ReactTag
       callback:(ABI39_0_0RCTResponseSenderBlock)callback;
- (void)measureInWindow:(NSNumber *)ABI39_0_0ReactTag
               callback:(ABI39_0_0RCTResponseSenderBlock)callback;
- (void)viewIsDescendantOf:(NSNumber *)ABI39_0_0ReactTag
          ancestorABI39_0_0ReactTag:(NSNumber *)ancestorABI39_0_0ReactTag
                  callback:(ABI39_0_0RCTResponseSenderBlock)callback;
- (void)measureLayout:(NSNumber *)ABI39_0_0ReactTag
     ancestorABI39_0_0ReactTag:(NSNumber *)ancestorABI39_0_0ReactTag
        errorCallback:(ABI39_0_0RCTResponseSenderBlock)errorCallback
             callback:(ABI39_0_0RCTResponseSenderBlock)callback;
- (void)measureLayoutRelativeToParent:(NSNumber *)ABI39_0_0ReactTag
                        errorCallback:(ABI39_0_0RCTResponseSenderBlock)errorCallback
                             callback:(ABI39_0_0RCTResponseSenderBlock)callback;
- (void)setJSResponder:(NSNumber *)ABI39_0_0ReactTag
...
- (void)replaceExistingNonRootView:(NSNumber *)ABI39_0_0ReactTag
                       newABI39_0_0ReactTag:(NSNumber *)newABI39_0_0ReactTag;
- (void)setChildren:(NSNumber *)containerTag
          ABI39_0_0ReactTags:(NSArray *)ABI39_0_0ReactTags;
- (void)manageChildren:(NSNumber *)containerTag
       moveFromIndices:(NSArray *)moveFromIndices
         moveToIndices:(NSArray *)moveToIndices
     addChildABI39_0_0ReactTags:(NSArray *)addChildABI39_0_0ReactTags
          addAtIndices:(NSArray *)addAtIndices
       removeAtIndices:(NSArray *)removeAtIndices;
- (void)setLayoutAnimationEnabledExperimental:(BOOL)enabled;
- (void)sendAccessibilityEvent:(NSNumber *)ABI39_0_0ReactTag
                     eventType:(double)eventType;
- (void)showPopupMenu:(NSNumber *)ABI39_0_0ReactTag
                items:(NSArray *)items
                error:(ABI39_0_0RCTResponseSenderBlock)error
              success:(ABI39_0_0RCTResponseSenderBlock)success;
- (void)dismissPopupMenu;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeUIManager::Constants::Builder>)constantsToExport;
- (ABI39_0_0facebook::ABI39_0_0React::ModuleConstants<JS::NativeUIManager::Constants::Builder>)getConstants;
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeUIManagerSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);

    };
  } // namespace ABI39_0_0React
} // namespace ABI39_0_0facebook
@protocol ABI39_0_0NativeVibrationSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeVibrationSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
@interface ABI39_0_0RCTCxxConvert (NativeWebSocketModule_SpecConnectOptions)
+ (ABI39_0_0RCTManagedPointer *)JS_NativeWebSocketModule_SpecConnectOptions:(id)json;
@end
@protocol ABI39_0_0NativeWebSocketModuleSpec <ABI39_0_0RCTBridgeModule, ABI39_0_0RCTTurboModule>
...
namespace ABI39_0_0facebook {
  namespace ABI39_0_0React {
    ...
    public:
      NativeWebSocketModuleSpecJSI(id<ABI39_0_0RCTTurboModule> instance, std::shared_ptr<CallInvoker> jsInvoker, std::shared_ptr<CallInvoker> nativeInvoker, id<ABI39_0_0RCTTurboModulePerformanceLogger> perfLogger);
...
inline folly::Optional<double> JS::NativeAccessibilityManager::SpecSetAccessibilityContentSizeMultipliersJSMultipliers::extraSmall() const
{
  ...
  return ABI39_0_0RCTBridgingToOptionalDouble(p);
}
...
{
  id const p = _v[@"title"];
  return ABI39_0_0RCTBridgingToString(p);
}
...
inline folly::Optional<ABI39_0_0facebook::ABI39_0_0React::LazyVector<NSString *>> JS::NativeActionSheetManager::SpecShowActionSheetWithOptionsOptions::options() const
{
  id const p = _v[@"options"];
  return ABI39_0_0RCTBridgingToOptionalVec(p, ^NSString *(id itemValue_0) { return ABI39_0_0RCTBridgingToString(itemValue_0); });
}
inline folly::Optional<ABI39_0_0facebook::ABI39_0_0React::LazyVector<double>> JS::NativeActionSheetManager::SpecShowActionSheetWithOptionsOptions::destructiveButtonIndices() const
{
  id const p = _v[@"destructiveButtonIndices"];
  return ABI39_0_0RCTBridgingToOptionalVec(p, ^double(id itemValue_0) { return ABI39_0_0RCTBridgingToDouble(itemValue_0); });
}
...
inline folly::Optional<ABI39_0_0facebook::ABI39_0_0React::LazyVector<NSString *>> JS::NativeActionSheetManager::SpecShowShareActionSheetWithOptionsOptions::excludedActivityTypes() const
{
...
inline folly::Optional<ABI39_0_0facebook::ABI39_0_0React::LazyVector<id<NSObject>>> JS::NativeAlertManager::Args::buttons() const
{
  id const p = _v[@"buttons"];
  return ABI39_0_0RCTBridgingToOptionalVec(p, ^id<NSObject>(id itemValue_0) { return itemValue_0; });
}
...
inline bool JS::NativeAnimatedModule::EndResult::finished() const
{
  ...
  return ABI39_0_0RCTBridgingToBool(p);
}
inline ABI39_0_0facebook::ABI39_0_0React::LazyVector<NSString *> JS::NativeAnimatedModule::EventMapping::nativeEventPath() const
{
  id const p = _v[@"nativeEventPath"];
  return ABI39_0_0RCTBridgingToVec(p, ^NSString *(id itemValue_0) { return ABI39_0_0RCTBridgingToString(itemValue_0); });
}
...
{
  id const p = _v[@"first"];
  return ABI39_0_0RCTBridgingToDouble(p);
}
...
inline folly::Optional<ABI39_0_0facebook::ABI39_0_0React::LazyVector<NSString *>> JS::NativeCameraRollManager::GetPhotosParams::mimeTypes() const
{
...
inline folly::Optional<bool> JS::NativeCameraRollManager::PhotoIdentifierNodeImage::isStored() const
{
  ...
  return ABI39_0_0RCTBridgingToOptionalBool(p);
}
...
inline ABI39_0_0facebook::ABI39_0_0React::LazyVector<JS::NativeCameraRollManager::PhotoIdentifier> JS::NativeCameraRollManager::PhotoIdentifiersPage::edges() const
{
  id const p = _v[@"edges"];
  return ABI39_0_0RCTBridgingToVec(p, ^JS::NativeCameraRollManager::PhotoIdentifier(id itemValue_0) { return JS::NativeCameraRollManager::PhotoIdentifier(itemValue_0); });
}
...
inline folly::Optional<ABI39_0_0facebook::ABI39_0_0React::LazyVector<NSString *>> JS::NativeDialogManagerAndroid::DialogOptions::items() const
{
  id const p = _v[@"items"];
  return ABI39_0_0RCTBridgingToOptionalVec(p, ^NSString *(id itemValue_0) { return ABI39_0_0RCTBridgingToString(itemValue_0); });
}
...
inline ABI39_0_0facebook::ABI39_0_0React::LazyVector<JS::NativeExceptionsManager::StackFrame> JS::NativeExceptionsManager::ExceptionData::stack() const
{
  id const p = _v[@"stack"];
  return ABI39_0_0RCTBridgingToVec(p, ^JS::NativeExceptionsManager::StackFrame(id itemValue_0) { return JS::NativeExceptionsManager::StackFrame(itemValue_0); });
}
