...
#import "ABI39_0_0RCTPhotoLibraryImageLoader.h"
...
@interface ABI39_0_0RCTPhotoLibraryImageLoader () <ABI39_0_0RCTTurboModule>
@end

@implementation ABI39_0_0RCTPhotoLibraryImageLoader

ABI39_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI39_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI39_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (!imageURL) {
    completionHandler(ABI39_0_0RCTErrorWithMessage(@"Cannot load a photo library asset with no URL"), nil);
    return ^{};
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI39_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI39_0_0RCTResizeModeContain) {
...
Class ABI39_0_0RCTPhotoLibraryImageLoaderCls(void) {
  return ABI39_0_0RCTPhotoLibraryImageLoader.class;
}
