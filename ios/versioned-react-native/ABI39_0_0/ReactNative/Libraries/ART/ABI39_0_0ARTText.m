...
@implementation ABI39_0_0ARTText
...
static void ABI39_0_0ARTFreeTextFrame(ABI39_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI39_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI39_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI39_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI39_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
