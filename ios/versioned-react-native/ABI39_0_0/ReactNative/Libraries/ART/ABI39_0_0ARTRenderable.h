...
@interface ABI39_0_0ARTRenderable : ABI39_0_0ARTNode

@property (nonatomic, strong) ABI39_0_0ARTBrush *fill;
...
@property (nonatomic, assign) ABI39_0_0ARTCGFloatArray strokeDash;
