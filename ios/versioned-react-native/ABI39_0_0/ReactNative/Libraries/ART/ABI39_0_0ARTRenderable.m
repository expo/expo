...
#import <ABI39_0_0React/ABI39_0_0ARTRenderable.h>

@implementation ABI39_0_0ARTRenderable

- (void)setFill:(ABI39_0_0ARTBrush *)fill
{
  [self invalidate];
  _fill = fill;
}
...
- (void)setStrokeDash:(ABI39_0_0ARTCGFloatArray)strokeDash
{
