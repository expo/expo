...
@interface ABI39_0_0RCTGIFCoderFrame : NSObject
...
@implementation ABI39_0_0RCTGIFCoderFrame
@end

@implementation ABI39_0_0RCTAnimatedImage {
  CGImageSourceRef _imageSource;
  CGFloat _scale;
  NSUInteger _loopCount;
  NSUInteger _frameCount;
  NSArray<ABI39_0_0RCTGIFCoderFrame *> *_frames;
}
...
- (BOOL)scanAndCheckFramesValidWithSource:(CGImageSourceRef)imageSource
{
  ...
  NSMutableArray<ABI39_0_0RCTGIFCoderFrame *> *frames = [NSMutableArray array];

  for (size_t i = 0; i < frameCount; i++) {
    ABI39_0_0RCTGIFCoderFrame *frame = [[ABI39_0_0RCTGIFCoderFrame alloc] init];
    frame.index = i;
