...
@interface ABI39_0_0RCTImageStoreManager : NSObject <ABI39_0_0RCTURLRequestHandler>
...
@interface ABI39_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI39_0_0RCTBridge (ABI39_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI39_0_0RCTImageStoreManager *imageStoreManager;
