...
typedef void (^ABI39_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI39_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI39_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI39_0_0RCTImageLoaderCancellationBlock;
 ...
 */
@protocol ABI39_0_0RCTImageURLLoader <ABI39_0_0RCTBridgeModule>
...
/**
 * If more than one ABI39_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI39_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
