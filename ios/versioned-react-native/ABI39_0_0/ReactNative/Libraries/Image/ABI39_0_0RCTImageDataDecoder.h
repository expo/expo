 ...
 * are also bridge modules, so should be registered using ABI39_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI39_0_0RCTImageDataDecoder <ABI39_0_0RCTBridgeModule>
...
/**
 * If more than one ABI39_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
