...
@interface UIImage (ABI39_0_0React)
 ...
 */
@property (nonatomic, assign) NSInteger ABI39_0_0ReactDecodedImageBytes;
 ...
 */
@protocol ABI39_0_0RCTImageCache <NSObject>
...
@interface ABI39_0_0RCTImageCache : NSObject <ABI39_0_0RCTImageCache>
@end
