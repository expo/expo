...
@implementation ABI39_0_0RCTBaseTextInputView {
...
- (UIView<ABI39_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  ABI39_0_0RCTAssert(NO, @"-[ABI39_0_0RCTBaseTextInputView backedTextInputView] must be implemented in subclass.");
  return nil;
}

#pragma mark - ABI39_0_0RCTComponent
...
- (void)setTextAttributes:(ABI39_0_0RCTTextAttributes *)textAttributes
{
...
{
  id<ABI39_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
...
- (void)setABI39_0_0ReactPaddingInsets:(UIEdgeInsets)ABI39_0_0ReactPaddingInsets
{
  _ABI39_0_0ReactPaddingInsets = ABI39_0_0ReactPaddingInsets;
  // We apply `paddingInsets` as `backedTextInputView`'s `textContainerInset`.
  self.backedTextInputView.textContainerInset = ABI39_0_0ReactPaddingInsets;
  [self setNeedsLayout];
}

- (void)setABI39_0_0ReactBorderInsets:(UIEdgeInsets)ABI39_0_0ReactBorderInsets
{
  _ABI39_0_0ReactBorderInsets = ABI39_0_0ReactBorderInsets;
  // We apply `borderInsets` as `backedTextInputView` layout offset.
  self.backedTextInputView.frame = UIEdgeInsetsInsetRect(self.bounds, ABI39_0_0ReactBorderInsets);
  [self setNeedsLayout];
}
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  [backedTextInputViewTextCopy removeAttribute:ABI39_0_0RCTTextAttributesTagAttributeName
                                         range:NSMakeRange(0, backedTextInputViewTextCopy.length)];

  [attributedTextCopy removeAttribute:ABI39_0_0RCTTextAttributesTagAttributeName
  ...
  } else if (eventLag > ABI39_0_0RCTTextUpdateLagWarningThreshold) {
    ABI39_0_0RCTLog(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", self.backedTextInputView.attributedText.string, (long long)eventLag);
  }
}

- (ABI39_0_0RCTTextSelection *)selection
{
  id<ABI39_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
  UITextRange *selectedTextRange = backedTextInputView.selectedTextRange;
  return [[ABI39_0_0RCTTextSelection new] initWithStart:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.start]
                                           end:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.end]];
}

- (void)setSelection:(ABI39_0_0RCTTextSelection *)selection
{
  if (!selection) {
    return;
  }
  ...
  if (eventLag == 0 && ![previousSelectedTextRange isEqual:selectedTextRange]) {
    ...
    ABI39_0_0RCTLog(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", backedTextInputView.attributedText.string, (long long)eventLag);
  }
}
...
{
  UIView<ABI39_0_0RCTBackedTextInputViewProtocol> *textInputView = self.backedTextInputView;
...
#pragma mark - ABI39_0_0RCTBackedTextInputDelegate
...
- (void)textInputDidBeginEditing
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI39_0_0RCTTextEventTypeFocus
...
{
  [_eventDispatcher sendTextEventWithType:ABI39_0_0RCTTextEventTypeEnd
                                 ABI39_0_0ReactTag:self.ABI39_0_0ReactTag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];

  [_eventDispatcher sendTextEventWithType:ABI39_0_0RCTTextEventTypeBlur
                                 ABI39_0_0ReactTag:self.ABI39_0_0ReactTag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldReturn
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI39_0_0RCTTextEventTypeSubmit
                                 ABI39_0_0ReactTag:self.ABI39_0_0ReactTag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (NSString *)textInputShouldChangeText:(NSString *)text inRange:(NSRange)range
{
  ...
  if (!backedTextInputView.textWasPasted) {
    [_eventDispatcher sendTextEventWithType:ABI39_0_0RCTTextEventTypeKeyPress
                                   ABI39_0_0ReactTag:self.ABI39_0_0ReactTag
                                       text:nil
                                        key:text
                                 eventCount:_nativeEventCount];
...
- (void)textInputDidChangeSelection
{
  ...
  ABI39_0_0RCTTextSelection *selection = self.selection;
...
- (CGSize)intrinsicContentSize
{
  ...
  size.width += _ABI39_0_0ReactBorderInsets.left + _ABI39_0_0ReactBorderInsets.right;
  size.height += _ABI39_0_0ReactBorderInsets.top + _ABI39_0_0ReactBorderInsets.bottom;
...
{
  CGFloat compoundHorizontalBorderInset = _ABI39_0_0ReactBorderInsets.left + _ABI39_0_0ReactBorderInsets.right;
  CGFloat compoundVerticalBorderInset = _ABI39_0_0ReactBorderInsets.top + _ABI39_0_0ReactBorderInsets.bottom;
...
- (void)ABI39_0_0ReactFocus
{
  [self.backedTextInputView ABI39_0_0ReactFocus];
}

- (void)ABI39_0_0ReactBlur
{
  [self.backedTextInputView ABI39_0_0ReactBlur];
}
...
- (void)didMoveToWindow
{
  if (self.autoFocus && !_didMoveToWindow) {
    ...
    [self.backedTextInputView ABI39_0_0ReactFocusIfNeeded];
  }
...
{
  #if !TARGET_OS_TV
  __weak ABI39_0_0RCTBaseTextInputView *weakSelf = self;
  [_bridge.uiManager rootViewForABI39_0_0ReactTag:self.ABI39_0_0ReactTag withCompletion:^(UIView *rootView) {
    ABI39_0_0RCTBaseTextInputView *strongSelf = weakSelf;
    if (rootView) {
      UIView *accessoryView = [strongSelf->_bridge.uiManager viewForNativeID:nativeID
                                                                 withRootTag:rootView.ABI39_0_0ReactTag];
      if (accessoryView && [accessoryView isKindOfClass:[ABI39_0_0RCTInputAccessoryView class]]) {
        strongSelf.backedTextInputView.inputAccessoryView = ((ABI39_0_0RCTInputAccessoryView *)accessoryView).inputAccessoryView;
