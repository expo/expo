...
@protocol ABI39_0_0RCTBackedTextInputDelegate;
@class ABI39_0_0RCTTextAttributes;

NS_ASSUME_NONNULL_BEGIN

@protocol ABI39_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI39_0_0RCTBackedTextInputDelegate> textInputDelegate;
