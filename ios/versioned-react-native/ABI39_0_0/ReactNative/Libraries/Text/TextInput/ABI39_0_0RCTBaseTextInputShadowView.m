...
#import "ABI39_0_0NSTextStorage+FontScaling.h"
#import <ABI39_0_0React/ABI39_0_0RCTBaseTextInputView.h>

@implementation ABI39_0_0RCTBaseTextInputShadowView
{
...
- (instancetype)initWithBridge:(ABI39_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI39_0_0YGNodeSetMeasureFunc(self.yogaNode, ABI39_0_0RCTBaseTextInputShadowViewMeasure);
    ABI39_0_0YGNodeSetBaselineFunc(self.yogaNode, ABI39_0_0RCTTextInputShadowViewBaseline);
  }
...
{
  if (ABI39_0_0YGNodeIsDirty(self.yogaNode)) {
    return;
  }
  ...
  ABI39_0_0RCTTextAttributes *textAttributes = [self.textAttributes copy];
  ...
  [attributedText removeAttribute:ABI39_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                            range:NSMakeRange(0, attributedText.length)];

  [attributedText removeAttribute:ABI39_0_0RCTTextAttributesTagAttributeName
                            range:NSMakeRange(0, attributedText.length)];
  ...
  NSNumber *tag = self.ABI39_0_0ReactTag;

  [_bridge.uiManager addUIBlock:^(ABI39_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI39_0_0RCTBaseTextInputView *baseTextInputView = (ABI39_0_0RCTBaseTextInputView *)viewRegistry[tag];
    if (!baseTextInputView) {
      return;
    }

    baseTextInputView.textAttributes = textAttributes;
    baseTextInputView.ABI39_0_0ReactBorderInsets = borderInsets;
    baseTextInputView.ABI39_0_0ReactPaddingInsets = paddingInsets;
...
- (CGSize)sizeThatFitsMinimumSize:(CGSize)minimumSize maximumSize:(CGSize)maximumSize
{
  ...
  return (CGSize){
    MAX(minimumSize.width, MIN(ABI39_0_0RCTCeilPixelValue(size.width), maximumSize.width)),
    MAX(minimumSize.height, MIN(ABI39_0_0RCTCeilPixelValue(size.height), maximumSize.height))
  };
}
...
static ABI39_0_0YGSize ABI39_0_0RCTBaseTextInputShadowViewMeasure(ABI39_0_0YGNodeRef node, float width, ABI39_0_0YGMeasureMode widthMode, float height, ABI39_0_0YGMeasureMode heightMode)
{
  ABI39_0_0RCTShadowView *shadowView = (__bridge ABI39_0_0RCTShadowView *)ABI39_0_0YGNodeGetContext(node);

  CGSize minimumSize = CGSizeMake(0, 0);
  CGSize maximumSize = CGSizeMake(CGFLOAT_MAX, CGFLOAT_MAX);

  CGSize size = {
    ABI39_0_0RCTCoreGraphicsFloatFromYogaFloat(width),
    ABI39_0_0RCTCoreGraphicsFloatFromYogaFloat(height)
  };
  ...
  return (ABI39_0_0YGSize){
    ABI39_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.width),
    ABI39_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.height)
  };
}

static float ABI39_0_0RCTTextInputShadowViewBaseline(ABI39_0_0YGNodeRef node, const float width, const float height)
{
  ABI39_0_0RCTBaseTextInputShadowView *shadowTextView = (__bridge ABI39_0_0RCTBaseTextInputShadowView *)ABI39_0_0YGNodeGetContext(node);
  ...
  return ABI39_0_0RCTYogaFloatFromCoreGraphicsFloat(lastBaseline);
}
