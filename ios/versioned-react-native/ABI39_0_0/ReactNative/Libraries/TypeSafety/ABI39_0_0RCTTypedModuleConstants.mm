...
#import "ABI39_0_0RCTTypedModuleConstants.h"

#import <ABI39_0_0React/ABI39_0_0RCTDefines.h>

@implementation _ABI39_0_0RCTTypedModuleConstants {
  NSDictionary *_dictionary;
}

+ (instancetype)newWithUnsafeDictionary:(NSDictionary<NSString *, id> *)dictionary
{
  _ABI39_0_0RCTTypedModuleConstants *constants = [self new];
  if (constants) {
...
ABI39_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithObjects:(id  _Nonnull const [])objects
