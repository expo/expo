...
@implementation ABI39_0_0RCTTrackingAnimatedNode {
...
- (void)onDetachedFromNode:(ABI39_0_0RCTAnimatedNode *)parent
{
...
- (void)performUpdate
{
  ...
  ABI39_0_0RCTValueAnimatedNode *node = (ABI39_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
