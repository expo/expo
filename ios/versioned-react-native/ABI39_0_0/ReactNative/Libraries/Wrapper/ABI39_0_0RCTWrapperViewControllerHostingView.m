...
#import "ABI39_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI39_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ABI39_0_0ReactViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ABI39_0_0ReactViewController detachChildViewController:self.contentViewController];
}
