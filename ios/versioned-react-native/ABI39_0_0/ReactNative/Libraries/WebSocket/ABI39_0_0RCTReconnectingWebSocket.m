...
@interface ABI39_0_0RCTReconnectingWebSocket () <ABI39_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI39_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  ...
  __weak ABI39_0_0RCTSRWebSocket *socket = _socket;
