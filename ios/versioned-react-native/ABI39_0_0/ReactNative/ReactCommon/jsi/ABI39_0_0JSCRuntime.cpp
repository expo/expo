...
#ifdef ABI39_0_0RN_FABRIC_ENABLED
...
#define JSC_LIKELY(ABI39_0_0EXPR) __builtin_expect((bool)(ABI39_0_0EXPR), true)
#define JSC_UNLIKELY(ABI39_0_0EXPR) __builtin_expect((bool)(ABI39_0_0EXPR), false)
#else
#define JSC_LIKELY(ABI39_0_0EXPR) (ABI39_0_0EXPR)
#define JSC_UNLIKELY(ABI39_0_0EXPR) (ABI39_0_0EXPR)
#endif
