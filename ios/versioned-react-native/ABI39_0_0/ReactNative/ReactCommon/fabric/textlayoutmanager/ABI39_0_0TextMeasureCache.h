...
#include <ABI39_0_0React/utils/SimpleThreadSafeCache.h>
...
template <>
struct hash<ABI39_0_0facebook::ABI39_0_0React::TextMeasureCacheKey> {
  size_t operator()(ABI39_0_0facebook::ABI39_0_0React::TextMeasureCacheKey const &key) const {
    return folly::hash::hash_combine(
        0,
