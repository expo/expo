...
#import "ABI39_0_0RCTFontUtils.h"
...
static ABI39_0_0RCTFontProperties ABI39_0_0RCTDefaultFontProperties()
{
  static ABI39_0_0RCTFontProperties defaultFontProperties;
  ...
  dispatch_once(&onceToken, ^{
    ...
    defaultFontProperties.style = ABI39_0_0RCTFontStyleNormal;
    defaultFontProperties.variant = ABI39_0_0RCTFontVariantDefault;
...
static ABI39_0_0RCTFontProperties ABI39_0_0RCTResolveFontProperties(
    ABI39_0_0RCTFontProperties fontProperties,
    ABI39_0_0RCTFontProperties baseFontProperties)
{
  ...
  fontProperties.style =
      fontProperties.style != ABI39_0_0RCTFontStyleUndefined ? fontProperties.style : baseFontProperties.style;
  fontProperties.variant =
      fontProperties.variant != ABI39_0_0RCTFontVariantUndefined ? fontProperties.variant : baseFontProperties.variant;
  return fontProperties;
}

static UIFontWeight ABI39_0_0RCTGetFontWeight(UIFont *font)
{
  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  return [traits[UIFontWeightTrait] doubleValue];
}

static ABI39_0_0RCTFontStyle ABI39_0_0RCTGetFontStyle(UIFont *font)
{
  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  ...
  if (symbolicTraits & UIFontDescriptorTraitItalic) {
    return ABI39_0_0RCTFontStyleItalic;
  }

  return ABI39_0_0RCTFontStyleNormal;
}

static NSArray *ABI39_0_0RCTFontFeatures(ABI39_0_0RCTFontVariant fontVariant)
{
  // FIXME:
  return @[];
}

static UIFont *ABI39_0_0RCTDefaultFontWithFontProperties(ABI39_0_0RCTFontProperties fontProperties)
{
  ...
  if (!font) {
    ...
    if (fontProperties.variant == ABI39_0_0RCTFontStyleItalic) {
...
UIFont *ABI39_0_0RCTFontWithFontProperties(ABI39_0_0RCTFontProperties fontProperties)
{
  ABI39_0_0RCTFontProperties defaultFontProperties = ABI39_0_0RCTDefaultFontProperties();
  fontProperties = ABI39_0_0RCTResolveFontProperties(fontProperties, defaultFontProperties);
  ...
  if ([fontProperties.family isEqualToString:defaultFontProperties.family]) {
    ...
    font = ABI39_0_0RCTDefaultFontWithFontProperties(fontProperties);
  } else {
    ...
    if (fontNames.count == 0) {
      ...
      for (NSString *name in fontNames) {
        ...
        if (ABI39_0_0RCTGetFontStyle(fontMatch) != fontProperties.style) {
          continue;
        }

        CGFloat testWeight = ABI39_0_0RCTGetFontWeight(fontMatch);
  ...
  if (fontProperties.variant != ABI39_0_0RCTFontVariantDefault) {
    NSArray *fontFeatures = ABI39_0_0RCTFontFeatures(fontProperties.variant);
    UIFontDescriptor *fontDescriptor = [font.fontDescriptor
