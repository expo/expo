...
#include "ABI39_0_0TextLayoutManager.h"
...
{
  self_ = wrapManagedObject([ABI39_0_0RCTTextLayoutManager new]);
}
...
{
  ABI39_0_0RCTTextLayoutManager *textLayoutManager = (ABI39_0_0RCTTextLayoutManager *)unwrapManagedObject(self_);
