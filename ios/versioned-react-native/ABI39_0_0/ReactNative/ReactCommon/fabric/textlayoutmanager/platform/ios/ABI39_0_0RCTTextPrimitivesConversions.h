...
inline static NSTextAlignment ABI39_0_0RCTNSTextAlignmentFromTextAlignment(TextAlignment textAlignment)
{
...
inline static NSWritingDirection ABI39_0_0RCTNSWritingDirectionFromWritingDirection(WritingDirection writingDirection)
{
...
inline static ABI39_0_0RCTFontStyle ABI39_0_0RCTFontStyleFromFontStyle(FontStyle fontStyle)
{
  switch (fontStyle) {
    ...
    case FontStyle::Oblique:
      return ABI39_0_0RCTFontStyleOblique;
  }
}

inline static ABI39_0_0RCTFontVariant ABI39_0_0RCTFontVariantFromFontVariant(FontVariant fontVariant)
{
  return (ABI39_0_0RCTFontVariant)fontVariant;
}

inline static NSUnderlineStyle ABI39_0_0RCTNSUnderlineStyleFromStyleAndPattern(
...
inline static UIColor *ABI39_0_0RCTUIColorFromSharedColor(const SharedColor &color)
{
