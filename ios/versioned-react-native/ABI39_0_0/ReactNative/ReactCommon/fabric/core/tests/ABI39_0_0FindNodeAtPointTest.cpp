...
class FindNodeAtPointTest : public ::testing::Test {
 protected:
  FindNodeAtPointTest()
    ...
    layoutMetrics.frame = ABI39_0_0facebook::ABI39_0_0React::Rect{
        ABI39_0_0facebook::ABI39_0_0React::Point{0, 0}, ABI39_0_0facebook::ABI39_0_0React::Size{1000, 1000}};
    nodeA_->setLayoutMetrics(layoutMetrics);

    layoutMetrics.frame = ABI39_0_0facebook::ABI39_0_0React::Rect{
        ABI39_0_0facebook::ABI39_0_0React::Point{100, 100}, ABI39_0_0facebook::ABI39_0_0React::Size{100, 100}};
    nodeAA_->setLayoutMetrics(layoutMetrics);

    layoutMetrics.frame = ABI39_0_0facebook::ABI39_0_0React::Rect{ABI39_0_0facebook::ABI39_0_0React::Point{10, 10},
                                                ABI39_0_0facebook::ABI39_0_0React::Size{10, 10}};
...
TEST_F(FindNodeAtPointTest, withoutTransform) {
  ...
  ABI39_0_0EXPECT_EQ(LayoutableShadowNode::findNodeAtPoint(nodeA_, {105, 105}), nodeAA_);
  ABI39_0_0EXPECT_EQ(LayoutableShadowNode::findNodeAtPoint(nodeA_, {900, 900}), nodeA_);
  ABI39_0_0EXPECT_EQ(
...
TEST_F(FindNodeAtPointTest, viewIsTranslated) {
  ...
  ABI39_0_0EXPECT_EQ(
      ...
      nodeAAA_->getTag());
  ABI39_0_0EXPECT_EQ(LayoutableShadowNode::findNodeAtPoint(nodeA_, {5, 5}), nodeAA_);
}

TEST_F(FindNodeAtPointTest, viewIsScaled) {
  nodeAAA_->_transform = Transform::Identity() * Transform::Scale(0.5, 0.5, 0);

  ABI39_0_0EXPECT_EQ(LayoutableShadowNode::findNodeAtPoint(nodeA_, {119, 119}), nodeAA_);
}
