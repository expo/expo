...
#include <ABI39_0_0React/core/EventDispatcher.h>
#include <ABI39_0_0React/core/Props.h>
#include <ABI39_0_0React/core/RawPropsParser.h>
#include <ABI39_0_0React/core/ShadowNode.h>
#include <ABI39_0_0React/core/State.h>
...
class ComponentDescriptor {
 public:
   ...
   * ABI39_0_0React uses a `name` to refer to particular kind of components in
   * `create` requests.
   */
