...
/*
 * Simple, cross-platfrom, ABI39_0_0React-specific implementation of attributed string
 * (aka spanned string).
...
namespace std {
template <>
struct hash<ABI39_0_0facebook::ABI39_0_0React::AttributedString::Fragment> {
  size_t operator()(
      const ABI39_0_0facebook::ABI39_0_0React::AttributedString::Fragment &fragment) const {
...
template <>
struct hash<ABI39_0_0facebook::ABI39_0_0React::AttributedString> {
  size_t operator()(
      const ABI39_0_0facebook::ABI39_0_0React::AttributedString &attributedString) const {
    auto seed = size_t{0};
