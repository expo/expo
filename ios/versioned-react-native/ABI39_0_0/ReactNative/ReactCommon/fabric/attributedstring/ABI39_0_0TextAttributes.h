...
#include <ABI39_0_0React/attributedstring/primitives.h>
...
template <>
struct hash<ABI39_0_0facebook::ABI39_0_0React::TextAttributes> {
  size_t operator()(
      const ABI39_0_0facebook::ABI39_0_0React::TextAttributes &textAttributes) const {
