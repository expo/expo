...
template <>
struct std::hash<ABI39_0_0facebook::ABI39_0_0React::AttributedStringBox> {
  size_t operator()(
      ABI39_0_0facebook::ABI39_0_0React::AttributedStringBox const &attributedStringBox) const {
    switch (attributedStringBox.getMode()) {
      case ABI39_0_0facebook::ABI39_0_0React::AttributedStringBox::Mode::Value:
        return std::hash<ABI39_0_0facebook::ABI39_0_0React::AttributedString>()(
