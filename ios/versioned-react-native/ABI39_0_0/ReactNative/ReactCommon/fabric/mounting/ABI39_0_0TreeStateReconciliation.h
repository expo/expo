...
/**
 * Problem Description: because of C++ State, the ABI39_0_0React Native C++ ShadowTree
 * can diverge from the ABI39_0_0ReactJS ShadowTree; ABI39_0_0ReactJS communicates all tree
 * changes to C++, but C++ state commits are not propagated to ABI39_0_0ReactJS (ABI39_0_0ReactJS
