...
#include <ABI39_0_0React/components/text/RawTextProps.h>
#include <ABI39_0_0React/core/ConcreteShadowNode.h>
 ...
 * object in ABI39_0_0React. In a code fragment `<Text>Hello!</Text>`, "Hello!" part
