...
#include <ABI39_0_0React/core/propsConversions.h>

namespace ABI39_0_0facebook {
namespace ABI39_0_0React {

static inline ABI39_0_0YGStyle::Dimensions convertRawProp(
    RawProps const &rawProps,
    char const *widthName,
    char const *heightName,
    ABI39_0_0YGStyle::Dimensions const &sourceValue,
    ABI39_0_0YGStyle::Dimensions const &defaultValue) {
  auto dimensions = defaultValue;
  dimensions[ABI39_0_0YGDimensionWidth] = convertRawProp(
      rawProps,
      widthName,
      sourceValue[ABI39_0_0YGDimensionWidth],
      defaultValue[ABI39_0_0YGDimensionWidth]);
  dimensions[ABI39_0_0YGDimensionHeight] = convertRawProp(
      rawProps,
      heightName,
      sourceValue[ABI39_0_0YGDimensionHeight],
      defaultValue[ABI39_0_0YGDimensionWidth]);
  return dimensions;
}

static inline ABI39_0_0YGStyle::Edges convertRawProp(
    RawProps const &rawProps,
    char const *prefix,
    char const *suffix,
    ABI39_0_0YGStyle::Edges const &sourceValue,
    ABI39_0_0YGStyle::Edges const &defaultValue) {
  auto result = defaultValue;
  result[ABI39_0_0YGEdgeLeft] = convertRawProp(
      rawProps,
      "Left",
      sourceValue[ABI39_0_0YGEdgeLeft],
      defaultValue[ABI39_0_0YGEdgeLeft],
      prefix,
      suffix);
  result[ABI39_0_0YGEdgeTop] = convertRawProp(
      rawProps,
      "Top",
      sourceValue[ABI39_0_0YGEdgeTop],
      defaultValue[ABI39_0_0YGEdgeTop],
      prefix,
      suffix);
  result[ABI39_0_0YGEdgeRight] = convertRawProp(
      rawProps,
      "Right",
      sourceValue[ABI39_0_0YGEdgeRight],
      defaultValue[ABI39_0_0YGEdgeRight],
      prefix,
      suffix);
  result[ABI39_0_0YGEdgeBottom] = convertRawProp(
      rawProps,
      "Bottom",
      sourceValue[ABI39_0_0YGEdgeBottom],
      defaultValue[ABI39_0_0YGEdgeBottom],
      prefix,
      suffix);
  result[ABI39_0_0YGEdgeStart] = convertRawProp(
      rawProps,
      "Start",
      sourceValue[ABI39_0_0YGEdgeStart],
      defaultValue[ABI39_0_0YGEdgeStart],
      prefix,
      suffix);
  result[ABI39_0_0YGEdgeEnd] = convertRawProp(
      rawProps,
      "End",
      sourceValue[ABI39_0_0YGEdgeEnd],
      defaultValue[ABI39_0_0YGEdgeEnd],
      prefix,
      suffix);
  result[ABI39_0_0YGEdgeHorizontal] = convertRawProp(
      rawProps,
      "Horizontal",
      sourceValue[ABI39_0_0YGEdgeHorizontal],
      defaultValue[ABI39_0_0YGEdgeHorizontal],
      prefix,
      suffix);
  result[ABI39_0_0YGEdgeVertical] = convertRawProp(
      rawProps,
      "Vertical",
      sourceValue[ABI39_0_0YGEdgeVertical],
      defaultValue[ABI39_0_0YGEdgeVertical],
      prefix,
      suffix);
  result[ABI39_0_0YGEdgeAll] = convertRawProp(
      rawProps,
      "",
      sourceValue[ABI39_0_0YGEdgeAll],
      defaultValue[ABI39_0_0YGEdgeAll],
      prefix,
      suffix);
  return result;
}
...
static inline ABI39_0_0YGStyle::Edges convertRawProp(
  ...
  auto result = defaultValue;
  result[ABI39_0_0YGEdgeLeft] = convertRawProp(
      rawProps, "left", sourceValue[ABI39_0_0YGEdgeLeft], defaultValue[ABI39_0_0YGEdgeLeft]);
  result[ABI39_0_0YGEdgeTop] = convertRawProp(
      rawProps, "top", sourceValue[ABI39_0_0YGEdgeTop], defaultValue[ABI39_0_0YGEdgeTop]);
  result[ABI39_0_0YGEdgeRight] = convertRawProp(
      rawProps, "right", sourceValue[ABI39_0_0YGEdgeRight], defaultValue[ABI39_0_0YGEdgeRight]);
  result[ABI39_0_0YGEdgeBottom] = convertRawProp(
      rawProps,
      "bottom",
      sourceValue[ABI39_0_0YGEdgeBottom],
      defaultValue[ABI39_0_0YGEdgeBottom]);
  result[ABI39_0_0YGEdgeStart] = convertRawProp(
      rawProps, "start", sourceValue[ABI39_0_0YGEdgeStart], defaultValue[ABI39_0_0YGEdgeStart]);
  result[ABI39_0_0YGEdgeEnd] = convertRawProp(
      rawProps, "end", sourceValue[ABI39_0_0YGEdgeEnd], defaultValue[ABI39_0_0YGEdgeEnd]);
  return result;
}

static inline ABI39_0_0YGStyle convertRawProp(
    RawProps const &rawProps,
    ABI39_0_0YGStyle const &sourceValue) {
  auto yogaStyle = ABI39_0_0YGStyle{};
