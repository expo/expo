...
#include <ABI39_0_0React/components/view/YogaStylableProps.h>
...
#pragma mark - Mutating Methods
   ...
   */
  void setPositionType(ABI39_0_0YGPositionType positionType) const;
...
#pragma mark - LayoutableShadowNode
 ...
 protected:
   ...
   * all the time.
   */
  mutable ABI39_0_0YGNode yogaNode_;
 ...
 private:
  ...
  static ABI39_0_0YGConfig &initializeYogaConfig(ABI39_0_0YGConfig &config);
  static ABI39_0_0YGNode *yogaNodeCloneCallbackConnector(
      ABI39_0_0YGNode *oldYogaNode,
      ABI39_0_0YGNode *parentYogaNode,
      int childIndex);
  static ABI39_0_0YGSize yogaNodeMeasureCallbackConnector(
