...
#include <ABI39_0_0yoga/ABI39_0_0CompactValue.h>
#include <ABI39_0_0yoga/ABI39_0_0YGEnums.h>
#include <ABI39_0_0yoga/ABI39_0_0YGValue.h>
...
class AndroidTextInputComponentDescriptor final
 ...
 public:
  ...
  virtual State::Shared createInitialState(
    ...
    if (surfaceIdToThemePaddingMap_.find(surfaceId) !=
      ...
      ABI39_0_0YGStyle::Edges theme = surfaceIdToThemePaddingMap_[surfaceId];
      defaultThemePaddingStart = ((ABI39_0_0YGValue)theme[ABI39_0_0YGEdgeStart]).value;
      defaultThemePaddingEnd = ((ABI39_0_0YGValue)theme[ABI39_0_0YGEdgeEnd]).value;
      defaultThemePaddingTop = ((ABI39_0_0YGValue)theme[ABI39_0_0YGEdgeTop]).value;
      defaultThemePaddingBottom = ((ABI39_0_0YGValue)theme[ABI39_0_0YGEdgeBottom]).value;
    }
 ...
 protected:
  void adopt(UnsharedShadowNode shadowNode) const override {
    ...
    if (surfaceIdToThemePaddingMap_.find(surfaceId) ==
      ...
      ABI39_0_0YGStyle::Edges result;
      result[ABI39_0_0YGEdgeStart] =
          (ABI39_0_0YGValue){state.defaultThemePaddingStart, ABI39_0_0YGUnitPoint};
      result[ABI39_0_0YGEdgeEnd] = (ABI39_0_0YGValue){state.defaultThemePaddingEnd, ABI39_0_0YGUnitPoint};
      result[ABI39_0_0YGEdgeTop] = (ABI39_0_0YGValue){state.defaultThemePaddingTop, ABI39_0_0YGUnitPoint};
      result[ABI39_0_0YGEdgeBottom] =
          (ABI39_0_0YGValue){state.defaultThemePaddingBottom, ABI39_0_0YGUnitPoint};
    ...
    if (surfaceIdToThemePaddingMap_.find(surfaceId) !=
      ...
      if (!textInputShadowNode->getConcreteProps().hasPadding &&
        ...
        changedPadding = true;
        result[ABI39_0_0YGEdgeStart] = theme[ABI39_0_0YGEdgeStart];
      }
      if (!textInputShadowNode->getConcreteProps().hasPadding &&
      ...
      if ((textInputShadowNode->getConcreteProps().hasPadding ||
           ...
           textInputShadowNode->getConcreteProps().hasPaddingHorizontal) &&
          !textInputShadowNode->getConcreteProps().hasPaddingStart) {
        result[ABI39_0_0YGEdgeStart] = ABI39_0_0YGValueUndefined;
      }
      if ((textInputShadowNode->getConcreteProps().hasPadding ||
           textInputShadowNode->getConcreteProps().hasPaddingRight ||
           textInputShadowNode->getConcreteProps().hasPaddingHorizontal) &&
          !textInputShadowNode->getConcreteProps().hasPaddingEnd) {
        result[ABI39_0_0YGEdgeEnd] = ABI39_0_0YGValueUndefined;
      }
 ...
 private:
  ...
  mutable better::map<int, ABI39_0_0YGStyle::Edges> surfaceIdToThemePaddingMap_;
};
