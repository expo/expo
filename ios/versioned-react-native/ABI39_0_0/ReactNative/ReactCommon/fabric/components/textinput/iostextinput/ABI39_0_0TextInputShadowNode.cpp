...
#include "ABI39_0_0TextInputShadowNode.h"
...
void TextInputShadowNode::updateStateIfNeeded() {
  ...
  newState.attributedStringBox = AttributedStringBox{ABI39_0_0ReactTreeAttributedString};
  newState.paragraphAttributes = getConcreteProps().paragraphAttributes;
  newState.ABI39_0_0ReactTreeAttributedString = ABI39_0_0ReactTreeAttributedString;
