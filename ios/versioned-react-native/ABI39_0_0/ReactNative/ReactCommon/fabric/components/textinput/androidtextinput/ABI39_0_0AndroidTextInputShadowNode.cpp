...
#include "ABI39_0_0AndroidTextInputShadowNode.h"
...
#include <ABI39_0_0React/components/text/BaseTextShadowNode.h>
#include <ABI39_0_0React/core/LayoutConstraints.h>
#include <ABI39_0_0React/core/LayoutContext.h>
#include <ABI39_0_0React/core/conversions.h>
#include <ABI39_0_0React/jni/ReadableNativeMap.h>

using namespace ABI39_0_0facebook::jni;
...
AttributedString AndroidTextInputShadowNode::getMostRecentAttributedString()
  ...
  auto ABI39_0_0ReactTreeAttributedString = getAttributedString();
  ...
  bool treeAttributedStringChanged =
      !state.ABI39_0_0ReactTreeAttributedString.compareTextAttributesWithoutFrame(
          ABI39_0_0ReactTreeAttributedString);
...
void AndroidTextInputShadowNode::updateStateIfNeeded() {
  ...
  if (state.ABI39_0_0ReactTreeAttributedString == ABI39_0_0ReactTreeAttributedString &&
  ...
  auto newEventCount =
      (state.ABI39_0_0ReactTreeAttributedString == ABI39_0_0ReactTreeAttributedString
           ? 0
