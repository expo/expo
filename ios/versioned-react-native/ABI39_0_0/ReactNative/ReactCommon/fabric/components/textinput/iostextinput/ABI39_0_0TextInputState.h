...
#include <ABI39_0_0React/attributedstring/ParagraphAttributes.h>
...
class TextInputState final {
 public:
   ...
   * This stores the previous computed *from the ABI39_0_0React tree*. This usually
   ...
   */
  AttributedString ABI39_0_0ReactTreeAttributedString{};
