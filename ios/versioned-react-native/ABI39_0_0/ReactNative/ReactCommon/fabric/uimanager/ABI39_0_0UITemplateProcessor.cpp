...
#include "ABI39_0_0UITemplateProcessor.h"
...
#include <ABI39_0_0React/components/view/ViewShadowNode.h>
#include <ABI39_0_0React/core/ComponentDescriptor.h>
#include <ABI39_0_0React/core/LayoutContext.h>
#include <ABI39_0_0React/core/ShadowNodeFragment.h>
#include <ABI39_0_0React/debug/DebugStringConvertible.h>
#include <ABI39_0_0React/debug/DebugStringConvertibleItem.h>
...
SharedShadowNode UITemplateProcessor::runCommand(
    ...
    const ComponentDescriptorRegistry &componentDescriptorRegistry,
    const NativeModuleRegistry &nativeModuleRegistry,
    const std::shared_ptr<const ABI39_0_0ReactNativeConfig> ABI39_0_0ReactNativeConfig) {
  ...
  if (opcode == "createNode") {
    ...
    registers[registerNumber] = ABI39_0_0ReactNativeConfig->getBool(param);
...
SharedShadowNode UITemplateProcessor::buildShadowTree(
  ...
  LOG(ERROR) << "ABI39_0_0React ui template missing returnRoot command :(";
