...
#include <ABI39_0_0React/uimanager/UIManager.h>
#include <ABI39_0_0React/uimanager/primitives.h>
...
class UIManagerBinding : public jsi::HostObject {
 public:
  ...
  /*
   * Starts ABI39_0_0React Native Surface with given id, moduleName, and props.
   * Thread synchronization must be enforced externally.
   */
  void startSurface(
      jsi::Runtime &runtime,
  ...
  /*
   * Stops ABI39_0_0React Native Surface with given id.
   * Thread synchronization must be enforced externally.
   */
