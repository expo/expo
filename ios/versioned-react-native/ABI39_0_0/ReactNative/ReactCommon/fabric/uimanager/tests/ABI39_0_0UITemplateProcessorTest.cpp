...
#include <ABI39_0_0React/uimanager/ComponentDescriptorFactory.h>
#include <ABI39_0_0React/uimanager/UITemplateProcessor.h>

using namespace ABI39_0_0facebook::ABI39_0_0React;

#include <ABI39_0_0React/components/rncore/ComponentDescriptors.h>
...
#include <ABI39_0_0React/config/ABI39_0_0ReactNativeConfig.h>
#include <ABI39_0_0React/uimanager/ComponentDescriptorFactory.h>
#include <ABI39_0_0React/uimanager/ComponentDescriptorProviderRegistry.h>
#include <ABI39_0_0React/uimanager/ComponentDescriptorRegistry.h>
...
class MockABI39_0_0ReactNativeConfig : public ABI39_0_0ReactNativeConfig {
 public:
  MockABI39_0_0ReactNativeConfig() {}
...
std::shared_ptr<const ABI39_0_0ReactNativeConfig> mockABI39_0_0ReactNativeConfig_ =
    std::make_shared<const MockABI39_0_0ReactNativeConfig>();
...
TEST(UITemplateProcessorTest, testSimpleBytecode) {
  ...
  auto bytecode = R"delim({"version":0.1,"commands":[
    ["createNode",2,"ABI39_0_0RCTView",-1,{"opacity": 0.5, "testId": "root"}],
    ["createNode",4,"ABI39_0_0RCTView",2,{"testId": "child"}],
    ["returnRoot",2]
  ]})delim";
...
TEST(UITemplateProcessorTest, testConditionalBytecode) {
  ...
  auto bytecode = R"delim({"version":0.1,"commands":[
    ["createNode",2,"ABI39_0_0RCTView",-1,{"testId": "root"}],
    ["loadNativeBool",1,"MobileConfig","getBool",["qe:simple_test"]],
    ["conditional",1,
      [["createNode",4,"ABI39_0_0RCTView",2,{"testId": "cond_true"}]],
      [["createNode",4,"ABI39_0_0RCTView",2,{"testId": "cond_false"}]]
    ],
    ["returnRoot",2]
  ]})delim";
