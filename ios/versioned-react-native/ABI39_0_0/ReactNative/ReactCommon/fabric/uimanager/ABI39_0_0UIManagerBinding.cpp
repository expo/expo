...
#include "ABI39_0_0UIManagerBinding.h"

#include <ABI39_0_0React/debug/SystraceSection.h>

#include <glog/logging.h>
#include <ABI39_0_0jsi/ABI39_0_0JSIDynamic.h>
...
void UIManagerBinding::startSurface(
  ...
  if (runtime.global().hasProperty(runtime, "ABI39_0_0RN$SurfaceRegistry")) {
    auto registry =
        runtime.global().getPropertyAsObject(runtime, "ABI39_0_0RN$SurfaceRegistry");
...
void UIManagerBinding::stopSurface(jsi::Runtime &runtime, SurfaceId surfaceId)
    const {
  if (runtime.global().hasProperty(runtime, "ABI39_0_0RN$stopSurface")) {
    auto method =
        runtime.global().getPropertyAsFunction(runtime, "ABI39_0_0RN$stopSurface");
    method.call(runtime, {jsi::Value{surfaceId}});
  } else {
    auto module = getModule(runtime, "ABI39_0_0ReactFabric");
    auto method =
