...
#include <ABI39_0_0React/uimanager/UIManagerBinding.h>
...
Scheduler::Scheduler(
  ...
  ABI39_0_0ReactNativeConfig_ =
      schedulerToolbox.contextContainer
          ->at<std::shared_ptr<const ABI39_0_0ReactNativeConfig>>("ABI39_0_0ReactNativeConfig");
...
void Scheduler::renderTemplateToSurface(
  ...
  try {
    ...
    LOG(ERROR) << "    >>>> ABI39_0_0EXCEPTION <<<  rendering uiTemplate in "
...
void Scheduler::stopSurface(SurfaceId surfaceId) const {
  ...
  // We execute JavaScript/ABI39_0_0React part of the process at the very end to minimize
