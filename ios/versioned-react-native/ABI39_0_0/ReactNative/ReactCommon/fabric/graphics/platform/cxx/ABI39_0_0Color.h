...
#include <ABI39_0_0React/graphics/ColorComponents.h>
...
namespace std {
template <>
struct hash<ABI39_0_0facebook::ABI39_0_0React::SharedColor> {
  size_t operator()(const ABI39_0_0facebook::ABI39_0_0React::SharedColor &sharedColor) const {
