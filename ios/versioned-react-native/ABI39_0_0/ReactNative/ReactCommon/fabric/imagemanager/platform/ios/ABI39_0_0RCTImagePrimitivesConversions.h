...
#import <ABI39_0_0React/imagemanager/primitives.h>

using namespace ABI39_0_0facebook::ABI39_0_0React;

inline static ABI39_0_0RCTResizeMode ABI39_0_0RCTResizeModeFromImageResizeMode(ImageResizeMode imageResizeMode)
{
  switch (imageResizeMode) {
    case ImageResizeMode::Cover:
      return ABI39_0_0RCTResizeModeCover;
    case ImageResizeMode::Contain:
      return ABI39_0_0RCTResizeModeContain;
    case ImageResizeMode::Stretch:
      return ABI39_0_0RCTResizeModeStretch;
    case ImageResizeMode::Center:
      return ABI39_0_0RCTResizeModeCenter;
    case ImageResizeMode::Repeat:
      return ABI39_0_0RCTResizeModeRepeat;
  }
}
...
inline static NSURLRequest *NSURLRequestFromImageSource(const ImageSource &imageSource)
{
  ...
  if (!url) {
    ABI39_0_0RCTLogError(@"URI parsing error.");
    return nil;
  }
