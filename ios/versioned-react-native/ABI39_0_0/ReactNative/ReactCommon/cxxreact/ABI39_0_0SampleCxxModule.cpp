...
#include "ABI39_0_0SampleCxxModule.h"
...
ABI39_0_0facebook::xplat::module::CxxModule *SampleCxxModule() {
  return new ABI39_0_0facebook::xplat::samples::SampleCxxModule(
      std::make_unique<ABI39_0_0facebook::xplat::samples::Sample>());
}
