...
#include "ABI39_0_0NativeToJsBridge.h"
#include "ABI39_0_0RAMBundleRegistry.h"
#include "ABI39_0_0RecoverableError.h"
#include "ABI39_0_0SystraceSection.h"

#include <ABI39_0_0cxxreact/ABI39_0_0JSIndexedRAMBundle.h>
...
void Instance::JSCallInvoker::invokeAsync(std::function<void()> &&work) {
   ...
   *    is initialized. ABI39_0_0RCTDevLoadingView shows bundle download progress.
