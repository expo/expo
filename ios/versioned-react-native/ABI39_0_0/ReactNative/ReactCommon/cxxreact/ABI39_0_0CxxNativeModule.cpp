...
#include "ABI39_0_0CxxNativeModule.h"
#include "ABI39_0_0Instance.h"

#include <folly/json.h>
#include <glog/logging.h>
#include <iterator>

#include "ABI39_0_0JsArgumentHelpers.h"
#include "ABI39_0_0MessageQueueThread.h"
#include "ABI39_0_0SystraceSection.h"
...
void CxxNativeModule::invoke(
    ...
    int callId) {
  if (ABI39_0_0ReactMethodId >= methods_.size()) {
    throw std::invalid_argument(folly::to<std::string>(
        "methodId ",
        ABI39_0_0ReactMethodId,
        " out of range [0..",
        methods_.size(),
        "]"));
  }
  ...
  const auto &method = methods_[ABI39_0_0ReactMethodId];
