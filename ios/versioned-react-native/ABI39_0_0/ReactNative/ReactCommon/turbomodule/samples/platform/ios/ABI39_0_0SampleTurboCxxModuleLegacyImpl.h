...
class SampleTurboCxxModuleLegacyImpl
    : public ABI39_0_0facebook::xplat::module::CxxModule {
 public:
  SampleTurboCxxModuleLegacyImpl();

  std::string getName() override;
  std::map<std::string, folly::dynamic> getConstants() override;
  std::vector<ABI39_0_0facebook::xplat::module::CxxModule::Method> getMethods() override;
  ...
  void getValueWithCallback(
      const ABI39_0_0facebook::xplat::module::CxxModule::Callback &callback);
  void getValueWithPromise(
      bool error,
      const ABI39_0_0facebook::xplat::module::CxxModule::Callback &resolve,
      const ABI39_0_0facebook::xplat::module::CxxModule::Callback &reject);
};
