...
#include <ABI39_0_0cxxreact/ABI39_0_0CxxModule.h>
...
class JSI_EXPORT TurboCxxModule : public TurboModule {
 public:
  TurboCxxModule(
      std::unique_ptr<ABI39_0_0facebook::xplat::module::CxxModule> cxxModule,
      std::shared_ptr<CallInvoker> jsInvoker);

  virtual ABI39_0_0facebook::jsi::Value get(
      ABI39_0_0facebook::jsi::Runtime &runtime,
      const ABI39_0_0facebook::jsi::PropNameID &propName) override;
 ...
 private:
  std::vector<ABI39_0_0facebook::xplat::module::CxxModule::Method> cxxMethods_;
  std::unique_ptr<ABI39_0_0facebook::xplat::module::CxxModule> cxxModule_;
};
