...
#include <ABI39_0_0React/jni/NativeMap.h>
#include <ABI39_0_0React/jni/ReadableNativeMap.h>
#include <ABI39_0_0React/jni/WritableNativeMap.h>

#include "ABI39_0_0JavaTurboModule.h"
...
jni::local_ref<JCxxCallbackImpl::JavaPart> createJavaCallbackFromJSIFunction(
    ...
    std::shared_ptr<CallInvoker> jsInvoker) {
  auto weakWrapper =
      ABI39_0_0React::CallbackWrapper::createWeak(std::move(function), rt, jsInvoker);
...
JNIArgs JavaTurboModule::convertJSIArgsToJNIArgs(
  ...
  for (unsigned int argIndex = 0; argIndex < count; argIndex += 1) {
    ...
    if (!(type == "Ljava/lang/Double;" || type == "Ljava/lang/Boolean;" ||
          ...
          type == "Lcom/facebook/ABI39_0_0React/bridge/ReadableArray;" ||
          type == "Lcom/facebook/ABI39_0_0React/bridge/Callback;" ||
          type == "Lcom/facebook/ABI39_0_0React/bridge/ReadableMap;")) {
    ...
    if (type == "Lcom/facebook/ABI39_0_0React/bridge/ReadableArray;") {
    ...
    if (type == "Lcom/facebook/ABI39_0_0React/bridge/Callback;") {
    ...
    if (type == "Lcom/facebook/ABI39_0_0React/bridge/ReadableMap;") {
      if (!(arg->isObject())) {
        throw JavaTurboModuleArgumentConversionException(
...
jsi::Value convertFromJMapToValue(JNIEnv *env, jsi::Runtime &rt, jobject arg) {
  ...
  jclass jArguments = env->FindClass("com/facebook/ABI39_0_0React/bridge/Arguments");
  static jmethodID jMakeNativeMap = env->GetStaticMethodID(
      jArguments,
      "makeNativeMap",
      "(Ljava/util/Map;)Lcom/facebook/ABI39_0_0React/bridge/WritableNativeMap;");
  auto constants =
    ...
    case PromiseKind: {
      ...
      jsi::Function promiseConstructorArg = jsi::Function::createFromHostFunction(
          ...
          [this, &jargs, argCount, instance, methodID, env](
            ...
            jclass jPromiseImpl =
                env->FindClass("com/facebook/ABI39_0_0React/bridge/PromiseImpl");
            jmethodID jPromiseImplConstructor = env->GetMethodID(
                jPromiseImpl,
                "<init>",
                "(Lcom/facebook/ABI39_0_0React/bridge/Callback;Lcom/facebook/ABI39_0_0React/bridge/Callback;)V");
