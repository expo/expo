...
#include <vector>
#include <array>
#include <ABI39_0_0yoga/ABI39_0_0YGEnums.h>
...
struct YOGA_EXPORT Event {
  ...
  class Data;
  using Subscriber = void(const ABI39_0_0YGNode&, Type, Data);
  ...
  template <Type E>
  static void publish(const ABI39_0_0YGNode& node, const TypedData<E>& eventData = {}) {
#ifdef ABI39_0_0YG_ENABLE_EVENTS
...
private:
  static void publish(const ABI39_0_0YGNode&, Type, const Data&);
};
