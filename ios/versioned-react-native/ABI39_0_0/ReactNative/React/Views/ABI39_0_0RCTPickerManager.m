...
#import "ABI39_0_0RCTPickerManager.h"

#import <ABI39_0_0React/ABI39_0_0RCTUIManager.h>
#import "ABI39_0_0RCTBridge.h"
#import "ABI39_0_0RCTFont.h"
#import "ABI39_0_0RCTPicker.h"

@implementation ABI39_0_0RCTPickerManager

ABI39_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
  return [ABI39_0_0RCTPicker new];
}
...
ABI39_0_0RCT_CUSTOM_VIEW_PROPERTY(fontSize, NSNumber, ABI39_0_0RCTPicker)
{
  view.font = [ABI39_0_0RCTFont updateFont:view.font withSize:json ?: @(defaultView.font.pointSize)];
}
ABI39_0_0RCT_CUSTOM_VIEW_PROPERTY(fontWeight, NSString, __unused ABI39_0_0RCTPicker)
{
  view.font = [ABI39_0_0RCTFont updateFont:view.font withWeight:json]; // defaults to normal
}
ABI39_0_0RCT_CUSTOM_VIEW_PROPERTY(fontStyle, NSString, __unused ABI39_0_0RCTPicker)
{
  view.font = [ABI39_0_0RCTFont updateFont:view.font withStyle:json]; // defaults to normal
}
ABI39_0_0RCT_CUSTOM_VIEW_PROPERTY(fontFamily, NSString, ABI39_0_0RCTPicker)
{
  view.font = [ABI39_0_0RCTFont updateFont:view.font withFamily:json ?: defaultView.font.familyName];
}

ABI39_0_0RCT_EXPORT_METHOD(setNativeSelectedIndex : (nonnull NSNumber *)viewTag toIndex : (nonnull NSNumber *)index)
{
  [self.bridge.uiManager addUIBlock:^(ABI39_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    UIView *view = viewRegistry[viewTag];

    if ([view isKindOfClass:[ABI39_0_0RCTPicker class]]) {
      [(ABI39_0_0RCTPicker *)view setSelectedIndex:index.integerValue];
    } else {
      ...
      if ([subview isKindOfClass:[ABI39_0_0RCTPicker class]]) {
        [(ABI39_0_0RCTPicker *)subview setSelectedIndex:index.integerValue];
      } else {
