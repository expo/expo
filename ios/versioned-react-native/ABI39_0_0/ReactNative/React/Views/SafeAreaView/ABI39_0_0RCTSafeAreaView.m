...
@implementation ABI39_0_0RCTSafeAreaView {
...
{
  UIViewController *vc = self.ABI39_0_0ReactViewController;
...
{
  if (UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI39_0_0RCTScreenScale())) {
    return;
  }

  _currentSafeAreaInsets = safeAreaInsets;

  ABI39_0_0RCTSafeAreaViewLocalData *localData = [[ABI39_0_0RCTSafeAreaViewLocalData alloc] initWithInsets:safeAreaInsets];
