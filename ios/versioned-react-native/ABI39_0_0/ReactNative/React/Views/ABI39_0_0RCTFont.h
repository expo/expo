...
typedef UIFont * (^ABI39_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ABI39_0_0React Native will use the System font for rendering by default. If you want to
 ...
 */
ABI39_0_0RCT_EXTERN void ABI39_0_0RCTSetDefaultFontHandler(ABI39_0_0RCTFontHandler handler);
ABI39_0_0RCT_EXTERN BOOL ABI39_0_0RCTHasFontHandlerSet(void);

@interface ABI39_0_0RCTFont : NSObject
...
@interface ABI39_0_0RCTConvert (ABI39_0_0RCTFont)
