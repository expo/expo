...
typedef CGFloat ABI39_0_0RCTFontWeight;
static ABI39_0_0RCTFontWeight weightOfFont(UIFont *font)
{
  ...
  for (NSInteger i = 0; i < 0 || i < (unsigned)fontNames.count; i++) {
    if ([font.fontName.lowercaseString hasSuffix:fontNames[i]]) {
      return (ABI39_0_0RCTFontWeight)[fontWeights[i] doubleValue];
    }
  }

  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  return (ABI39_0_0RCTFontWeight)[traits[UIFontWeightTrait] doubleValue];
}
...
static ABI39_0_0RCTFontHandler defaultFontHandler;

void ABI39_0_0RCTSetDefaultFontHandler(ABI39_0_0RCTFontHandler handler)
{
  defaultFontHandler = handler;
}

BOOL ABI39_0_0RCTHasFontHandlerSet()
{
...
static NSString *FontWeightDescriptionFromUIFontWeight(UIFontWeight fontWeight)
{
  ...
  ABI39_0_0RCTAssert(NO, @"Unknown UIFontWeight passed in: %f", fontWeight);
  return @"regular";
}

static UIFont *cachedSystemFont(CGFloat size, ABI39_0_0RCTFontWeight weight)
{
...
@implementation ABI39_0_0RCTConvert (ABI39_0_0RCTFont)

+ (UIFont *)UIFont:(id)json
{
  json = [self NSDictionary:json];
  return [ABI39_0_0RCTFont updateFont:nil
                  withFamily:[ABI39_0_0RCTConvert NSString:json[@"fontFamily"]]
                        size:[ABI39_0_0RCTConvert NSNumber:json[@"fontSize"]]
                      weight:[ABI39_0_0RCTConvert NSString:json[@"fontWeight"]]
                       style:[ABI39_0_0RCTConvert NSString:json[@"fontStyle"]]
                     variant:[ABI39_0_0RCTConvert NSStringArray:json[@"fontVariant"]]
             scaleMultiplier:1];
}

ABI39_0_0RCT_ENUM_CONVERTER(
    ABI39_0_0RCTFontWeight,
    (@{
...
typedef BOOL ABI39_0_0RCTFontStyle;
ABI39_0_0RCT_ENUM_CONVERTER(
    ABI39_0_0RCTFontStyle,
    (@{
      @"normal" : @NO,
      @"italic" : @YES,
      @"oblique" : @YES,
...
typedef NSDictionary ABI39_0_0RCTFontVariantDescriptor;
+ (ABI39_0_0RCTFontVariantDescriptor *)ABI39_0_0RCTFontVariantDescriptor:(id)json
{
  ...
  ABI39_0_0RCTFontVariantDescriptor *value = mapping[json];
  if (ABI39_0_0RCT_DEBUG && !value && [json description].length > 0) {
    ABI39_0_0RCTLogError(
        @"Invalid ABI39_0_0RCTFontVariantDescriptor '%@'. should be one of: %@",
        json,
...
ABI39_0_0RCT_ARRAY_CONVERTER(ABI39_0_0RCTFontVariantDescriptor)

@end

@implementation ABI39_0_0RCTFont
...
+ (UIFont *)updateFont:(UIFont *)font
            withFamily:(NSString *)family
               ...
               variant:(NSArray<ABI39_0_0RCTFontVariantDescriptor *> *)variant
       scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  const ABI39_0_0RCTFontWeight defaultFontWeight = UIFontWeightRegular;
  const CGFloat defaultFontSize = 14;

  // Initialize properties to defaults
  CGFloat fontSize = defaultFontSize;
  ABI39_0_0RCTFontWeight fontWeight = defaultFontWeight;
  ...
  // Get font attributes
  fontSize = [ABI39_0_0RCTConvert CGFloat:size] ?: fontSize;
  if (scaleMultiplier > 0.0 && scaleMultiplier != 1.0) {
    fontSize = round(fontSize * scaleMultiplier);
  }
  familyName = [ABI39_0_0RCTConvert NSString:family] ?: familyName;
  isItalic = style ? [ABI39_0_0RCTConvert ABI39_0_0RCTFontStyle:style] : isItalic;
  fontWeight = weight ? [ABI39_0_0RCTConvert ABI39_0_0RCTFontWeight:weight] : fontWeight;
  ...
  if (!didFindFont && [UIFont fontNamesForFamilyName:familyName].count == 0) {
    ...
    if (font) {
      ...
      ABI39_0_0RCTLogError(@"Unrecognized font family '%@'", familyName);
  ...
  if (variant) {
    NSArray *fontFeatures = [ABI39_0_0RCTConvert ABI39_0_0RCTFontVariantDescriptorArray:variant];
    UIFontDescriptor *fontDescriptor = [font.fontDescriptor
