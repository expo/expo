...
/**
 * Contains any methods related to scrolling. Any `ABI39_0_0RCTView` that has scrolling
 * features should implement these methods.
 */
@protocol ABI39_0_0RCTScrollableProtocol
 ...
 */
@protocol ABI39_0_0RCTCustomRefreshContolProtocol
