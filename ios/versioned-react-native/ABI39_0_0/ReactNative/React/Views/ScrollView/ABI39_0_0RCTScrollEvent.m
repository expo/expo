...
@implementation ABI39_0_0RCTScrollEvent {
...
- (ABI39_0_0RCTScrollEvent *)coalesceWithEvent:(ABI39_0_0RCTScrollEvent *)newEvent
{
...
- (NSArray *)arguments
{
  return @[ self.viewTag, ABI39_0_0RCTNormalizeInputEventName(self.eventName), [self body] ];
}
