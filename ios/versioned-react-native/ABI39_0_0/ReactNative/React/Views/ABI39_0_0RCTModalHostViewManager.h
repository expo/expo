...
@interface ABI39_0_0RCTConvert (ABI39_0_0RCTModalHostView)

+ (UIModalPresentationStyle)UIModalPresentationStyle:(id)json;

@end

typedef void (^ABI39_0_0RCTModalViewInteractionBlock)(
    UIViewController *ABI39_0_0ReactViewController,
    UIViewController *viewController,
    BOOL animated,
    dispatch_block_t completionBlock);

@interface ABI39_0_0RCTModalHostViewManager : ABI39_0_0RCTViewManager <ABI39_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, strong) ABI39_0_0RCTModalViewInteractionBlock presentationBlock;
@property (nonatomic, strong) ABI39_0_0RCTModalViewInteractionBlock dismissalBlock;
