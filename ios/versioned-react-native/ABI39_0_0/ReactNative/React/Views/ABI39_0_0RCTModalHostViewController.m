...
@implementation ABI39_0_0RCTModalHostViewController {
...
#if !TARGET_OS_TV
  _preferredStatusBarStyle = [ABI39_0_0RCTSharedApplication() statusBarStyle];
  _preferredStatusBarHidden = [ABI39_0_0RCTSharedApplication() isStatusBarHidden];
#endif
