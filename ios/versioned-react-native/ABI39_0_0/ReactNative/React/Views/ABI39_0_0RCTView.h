...
@protocol ABI39_0_0RCTAutoInsetsProtocol;

@class ABI39_0_0RCTView;

@interface ABI39_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI39_0_0RCTDirectEventBlock onAccessibilityAction;
@property (nonatomic, copy) ABI39_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI39_0_0RCTDirectEventBlock onMagicTap;
@property (nonatomic, copy) ABI39_0_0RCTDirectEventBlock onAccessibilityEscape;
...
+ (void)autoAdjustInsetsForView:(UIView<ABI39_0_0RCTAutoInsetsProtocol> *)parentView
 ...
 */
@property (nonatomic, assign) UIUserInterfaceLayoutDirection ABI39_0_0ReactLayoutDirection;
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI39_0_0RCTBorderStyle borderStyle;
