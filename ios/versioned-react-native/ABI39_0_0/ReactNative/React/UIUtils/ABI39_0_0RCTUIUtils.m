...
#import "ABI39_0_0RCTUIUtils.h"

#import "ABI39_0_0RCTUtils.h"

ABI39_0_0RCTDimensions ABI39_0_0RCTGetDimensions(CGFloat fontScale)
{
  UIScreen *mainScreen = UIScreen.mainScreen;
  CGSize screenSize = mainScreen.bounds.size;

  UIView *mainWindow;
  mainWindow = ABI39_0_0RCTKeyWindow();
  CGSize windowSize = mainWindow.bounds.size;

  ABI39_0_0RCTDimensions result;
...
CGFloat ABI39_0_0RCTGetMultiplierForContentSizeCategory(UIContentSizeCategory category)
{
