 ...
 */
@interface ABI39_0_0RCTImageSource : NSObject
...
@interface ABI39_0_0RCTConvert (ImageSource)

+ (ABI39_0_0RCTImageSource *)ABI39_0_0RCTImageSource:(id)json;
+ (NSArray<ABI39_0_0RCTImageSource *> *)ABI39_0_0RCTImageSourceArray:(id)json;
