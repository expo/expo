...
extern NSString *const ABI39_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI39_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI39_0_0RCTBundleURLProvider : NSObject
