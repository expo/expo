 ...
 */
typedef void (^ABI39_0_0RCTResponseSenderBlock)(NSArray *response);
 ...
 */
typedef void (^ABI39_0_0RCTResponseErrorBlock)(NSError *error);

/**
 * Block that bridge modules use to resolve the JS promise waiting for a result.
 * Nil results are supported and are converted to JS's undefined value.
 */
typedef void (^ABI39_0_0RCTPromiseResolveBlock)(id result);
 ...
 */
typedef void (^ABI39_0_0RCTPromiseRejectBlock)(NSString *code, NSString *message, NSError *error);
 ...
 * you need.
 *
 * NOTE: ABI39_0_0RCTJSThread is not a real libdispatch queue
 */
ABI39_0_0RCT_EXTERN dispatch_queue_t ABI39_0_0RCTJSThread;

ABI39_0_0RCT_EXTERN_C_BEGIN

typedef struct ABI39_0_0RCTMethodInfo {
  const char *const jsName;
  const char *const objcName;
  const BOOL isSync;
} ABI39_0_0RCTMethodInfo;
 ...
 */
@protocol ABI39_0_0RCTBridgeModule <NSObject>
 ...
 */
#define ABI39_0_0RCT_EXPORT_MODULE(js_name)          \
...
/**
 * Same as ABI39_0_0RCT_EXPORT_MODULE, but uses __attribute__((constructor)) for module
 * registration. Useful for registering swift classes that forbids use of load
 * Used in ABI39_0_0RCT_EXTERN_REMAP_MODULE
 */
#define ABI39_0_0RCT_EXPORT_MODULE_NO_LOAD(js_name, objc_name)                           \
  ABI39_0_0RCT_EXTERN void ABI39_0_0RCTRegisterModule(Class);                                     \
  +(NSString *)moduleName                                                       \
  {                                                                             \
    return @ #js_name;                                                          \
  }                                                                             \
  __attribute__((constructor)) static void ABI39_0_0RCT_CONCAT(initialize_, objc_name)() \
  {                                                                             \
    ABI39_0_0RCTRegisterModule([objc_name class]);                                       \
  }
 ...
 *
 */
#define ABI39_0_0RCT_EXPORT_PRE_REGISTERED_MODULE(js_name) \
  +(NSString *)moduleName                         \
  {                                               \
    return @ #js_name;                            \
  }

// Implemented by ABI39_0_0RCT_EXPORT_MODULE
+ (NSString *)moduleName;

@optional

/**
 * A reference to the ABI39_0_0RCTBridge. Useful for modules that require access
 * to bridge features, such as sending events or making JS calls. This
 * will be set automatically by the bridge when it initializes the module.
 * To implement this in your module, just add `@synthesize bridge = _bridge;`
 * If using Swift, add `@objc var bridge: ABI39_0_0RCTBridge!` to your module.
 */
@property (nonatomic, weak, readonly) ABI39_0_0RCTBridge *bridge;
 ...
 * thread-only. You can tell ABI39_0_0React Native to call your module methods on the
 ...
 * ABI39_0_0RCT_REMAP_METHOD to specify the JS name of the method.
 *
 ...
 * becomes
 *
 * ABI39_0_0RCT_EXPORT_METHOD(doSomething:(NSString *)aString
 *                   withA:(NSInteger)a
 *                   andB:(NSInteger)b)
 * { ... }
 *
 ...
 * For example:
 *
 * ABI39_0_0RCT_EXPORT_METHOD(doSomethingAsync:(NSString *)aString
 ...
 *
 */
#define ABI39_0_0RCT_EXPORT_METHOD(method) ABI39_0_0RCT_REMAP_METHOD(, method)

/**
 * Same as ABI39_0_0RCT_EXPORT_METHOD but the method is called from JS
 * synchronously **on the JS thread**, possibly returning a result.
 *
 * WARNING: in the vast majority of cases, you should use ABI39_0_0RCT_EXPORT_METHOD which
 ...
 */
#define ABI39_0_0RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(method) ABI39_0_0RCT_EXPORT_SYNCHRONOUS_TYPED_METHOD(id, method)

#define ABI39_0_0RCT_EXPORT_SYNCHRONOUS_TYPED_METHOD(returnType, method) \
  ABI39_0_0RCT_REMAP_BLOCKING_SYNCHRONOUS_METHOD(, returnType, method)

/**
 * Similar to ABI39_0_0RCT_EXPORT_METHOD but lets you set the JS name of the exported
 * method. Example usage:
 *
 * ABI39_0_0RCT_REMAP_METHOD(executeQueryWithParameters,
 *   executeQuery:(NSString *)query parameters:(NSDictionary *)parameters)
 * { ... }
 */
#define ABI39_0_0RCT_REMAP_METHOD(js_name, method)       \
  _ABI39_0_0RCT_EXTERN_REMAP_METHOD(js_name, method, NO) \
  -(void)method ABI39_0_0RCT_DYNAMIC;

/**
 * Similar to ABI39_0_0RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD but lets you set
 * the JS name of the exported method. Example usage:
 *
 * ABI39_0_0RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(executeQueryWithParameters,
 *   executeQuery:(NSString *)query parameters:(NSDictionary *)parameters)
 * { ... }
 */
#define ABI39_0_0RCT_REMAP_BLOCKING_SYNCHRONOUS_METHOD(js_name, returnType, method) \
  _ABI39_0_0RCT_EXTERN_REMAP_METHOD(js_name, method, YES)                           \
  -(returnType)method ABI39_0_0RCT_DYNAMIC;
 ...
 *
 *   @interface ABI39_0_0RCT_EXTERN_MODULE(MyModule, NSObject)
 *
 *   ABI39_0_0RCT_EXTERN_METHOD(doSomething:(NSString *)string withFoo:(NSInteger)a bar:(NSInteger)b)
 *
 *   @end
 *
 ...
 */
#define ABI39_0_0RCT_EXTERN_MODULE(objc_name, objc_supername) ABI39_0_0RCT_EXTERN_REMAP_MODULE(, objc_name, objc_supername)

/**
 * Like ABI39_0_0RCT_EXTERN_MODULE, but allows setting a custom JavaScript name.
 */
#define ABI39_0_0RCT_EXTERN_REMAP_MODULE(js_name, objc_name, objc_supername) \
  objc_name:                                                        \
  objc_supername @                                                  \
  end @interface objc_name(ABI39_0_0RCTExternModule)<ABI39_0_0RCTBridgeModule>        \
  @end                                                              \
  @implementation objc_name (ABI39_0_0RCTExternModule)                       \
  ABI39_0_0RCT_EXPORT_MODULE_NO_LOAD(js_name, objc_name)

/**
 * Use this macro in accordance with ABI39_0_0RCT_EXTERN_MODULE to export methods
 * of an external module.
 */
#define ABI39_0_0RCT_EXTERN_METHOD(method) _ABI39_0_0RCT_EXTERN_REMAP_METHOD(, method, NO)

/**
 * Use this macro in accordance with ABI39_0_0RCT_EXTERN_MODULE to export methods
 * of an external module that should be invoked synchronously.
 */
#define ABI39_0_0RCT_EXTERN__BLOCKING_SYNCHRONOUS_METHOD(method) _ABI39_0_0RCT_EXTERN_REMAP_METHOD(, method, YES)

/**
 * Like ABI39_0_0RCT_EXTERN_REMAP_METHOD, but allows setting a custom JavaScript name
 * and also whether this method is synchronous.
 */
#define _ABI39_0_0RCT_EXTERN_REMAP_METHOD(js_name, method, is_blocking_synchronous_method)                            \
  +(const ABI39_0_0RCTMethodInfo *)ABI39_0_0RCT_CONCAT(__rct_export__, ABI39_0_0RCT_CONCAT(js_name, ABI39_0_0RCT_CONCAT(__LINE__, __COUNTER__))) \
  {                                                                                                          \
    static ABI39_0_0RCTMethodInfo config = {#js_name, #method, is_blocking_synchronous_method};                       \
    return &config;                                                                                          \
  }
 ...
 * before registration.
 */
- (NSArray<id<ABI39_0_0RCTBridgeMethod>> *)methodsToExport;
 ...
 * values such as session keys, that are regenerated only as part of a reload of the entire ABI39_0_0React application.
 *
 ...
 */
@protocol ABI39_0_0RCTTurboModuleLookupDelegate <NSObject>
 ...
 * See ABI39_0_0RCTTurboModule.h for actual signature.
 */
@protocol ABI39_0_0RCTTurboModule;
