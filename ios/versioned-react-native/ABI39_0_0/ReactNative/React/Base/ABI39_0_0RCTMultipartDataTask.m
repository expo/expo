...
@interface ABI39_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>

@end

@implementation ABI39_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI39_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI39_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI39_0_0RCTMultipartStreamReader *reader = [[ABI39_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream
                                                                                  boundary:_boundary];
  ABI39_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
