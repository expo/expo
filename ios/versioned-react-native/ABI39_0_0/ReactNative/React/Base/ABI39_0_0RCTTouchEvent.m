...
@implementation ABI39_0_0RCTTouchEvent {
  NSArray<NSDictionary *> *_ABI39_0_0ReactTouches;
                    ...
                    coalescingKey:(uint16_t)coalescingKey
{
  if (self = [super init]) {
    ...
    _ABI39_0_0ReactTouches = ABI39_0_0ReactTouches;
...
{
  ABI39_0_0RCTAssert(
      [newEvent isKindOfClass:[ABI39_0_0RCTTouchEvent class]],
      @"Touch event cannot be coalesced with any other type of event, such as provided %@",
      newEvent);
  ABI39_0_0RCTTouchEvent *newTouchEvent = (ABI39_0_0RCTTouchEvent *)newEvent;
  ABI39_0_0RCTAssert(
      [_ABI39_0_0ReactTouches count] == [newTouchEvent->_ABI39_0_0ReactTouches count],
  ...
  NSInteger count = _ABI39_0_0ReactTouches.count;
  for (int i = 0; i < count; i++) {
    NSDictionary *touch = _ABI39_0_0ReactTouches[i];
    NSDictionary *newTouch = newTouchEvent->_ABI39_0_0ReactTouches[i];
    ABI39_0_0RCTAssert(
  ...
  ABI39_0_0RCTAssert(
      ...
      _ABI39_0_0ReactTouches,
      newTouchEvent->_ABI39_0_0ReactTouches);
  return newEventIsMoreRecent ? newEvent : self;
}

+ (NSString *)moduleDotMethod
{
  return @"ABI39_0_0RCTEventEmitter.receiveTouches";
}

- (NSArray *)arguments
{
  return @[ ABI39_0_0RCTNormalizeInputEventName(_eventName), _ABI39_0_0ReactTouches, _changedIndexes ];
}
