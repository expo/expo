...
typedef UIView *_Nullable (^ABI39_0_0RCTSurfaceHostingViewActivityIndicatorViewFactory)(void);
 ...
 * of ABI39_0_0ReactNative-powered experiences in UIKit based apps.
 */
@interface ABI39_0_0RCTSurfaceHostingView : UIView <ABI39_0_0RCTSurfaceDelegate>

/**
 * Create an instance of ABI39_0_0RCTSurface to be hosted.
 */
...
- (instancetype)initWithSurface:(ABI39_0_0RCTSurface *)surface
                sizeMeasureMode:(ABI39_0_0RCTSurfaceSizeMeasureMode)sizeMeasureMode NS_DESIGNATED_INITIALIZER;
 ...
 * Read-only.
 */
@property (nonatomic, strong, readonly) ABI39_0_0RCTSurface *surface;

/**
 * Size measure mode which are defining relationship between UIKit and ABI39_0_0ReactNative
 * layout approaches.
 * Defaults to `ABI39_0_0RCTSurfaceSizeMeasureModeWidthAtMost | ABI39_0_0RCTSurfaceSizeMeasureModeHeightAtMost`.
 */
@property (nonatomic, assign) ABI39_0_0RCTSurfaceSizeMeasureMode sizeMeasureMode;
 ...
 */
@property (nonatomic, copy, nullable) ABI39_0_0RCTSurfaceHostingViewActivityIndicatorViewFactory activityIndicatorViewFactory;
