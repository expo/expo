...
#import "ABI39_0_0RCTSurfaceDelegate.h"
#import "ABI39_0_0RCTSurfaceView.h"
#import "ABI39_0_0RCTUtils.h"

@interface ABI39_0_0RCTSurfaceHostingView ()
...
@implementation ABI39_0_0RCTSurfaceHostingView {
  UIView *_Nullable _activityIndicatorView;
  UIView *_Nullable _surfaceView;
  ABI39_0_0RCTSurfaceStage _stage;
}
...
{
  return [[ABI39_0_0RCTSurface alloc] initWithBridge:bridge moduleName:moduleName initialProperties:initialProperties];
}

ABI39_0_0RCT_NOT_IMPLEMENTED(-(instancetype)init)
ABI39_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithFrame : (CGRect)frame)
ABI39_0_0RCT_NOT_IMPLEMENTED(-(nullable instancetype)initWithCoder : (NSCoder *)coder)
...
- (instancetype)initWithSurface:(ABI39_0_0RCTSurface *)surface sizeMeasureMode:(ABI39_0_0RCTSurfaceSizeMeasureMode)sizeMeasureMode
{
...
- (void)setFrame:(CGRect)frame
{
  ...
  ABI39_0_0RCTSurfaceMinimumSizeAndMaximumSizeFromSizeAndSizeMeasureMode(
...
{
  if (ABI39_0_0RCTSurfaceStageIsPreparing(_stage)) {
...
- (CGSize)sizeThatFits:(CGSize)size
{
  ...
  ABI39_0_0RCTSurfaceMinimumSizeAndMaximumSizeFromSizeAndSizeMeasureMode(size, _sizeMeasureMode, &minimumSize, &maximumSize);

  return [_surface sizeThatFitsMinimumSize:minimumSize maximumSize:maximumSize];
}

- (void)setStage:(ABI39_0_0RCTSurfaceStage)stage
{
  if (stage == _stage) {
    return;
  }

  BOOL shouldInvalidateLayout = ABI39_0_0RCTSurfaceStageIsRunning(stage) != ABI39_0_0RCTSurfaceStageIsRunning(_stage) ||
      ABI39_0_0RCTSurfaceStageIsPreparing(stage) != ABI39_0_0RCTSurfaceStageIsPreparing(_stage);
...
- (void)setSizeMeasureMode:(ABI39_0_0RCTSurfaceSizeMeasureMode)sizeMeasureMode
{
...
- (void)setActivityIndicatorViewFactory:(ABI39_0_0RCTSurfaceHostingViewActivityIndicatorViewFactory)activityIndicatorViewFactory
{
...
- (void)_updateViews
{
  self.isSurfaceViewVisible = ABI39_0_0RCTSurfaceStageIsRunning(_stage);
  self.isActivityIndicatorViewVisible = ABI39_0_0RCTSurfaceStageIsPreparing(_stage);
}
...
#pragma mark - ABI39_0_0RCTSurfaceDelegate

- (void)surface:(__unused ABI39_0_0RCTSurface *)surface didChangeStage:(ABI39_0_0RCTSurfaceStage)stage
{
...
- (void)surface:(__unused ABI39_0_0RCTSurface *)surface didChangeIntrinsicSize:(__unused CGSize)intrinsicSize
{
  ABI39_0_0RCTExecuteOnMainQueue(^{
    [self _invalidateLayout];
  });
