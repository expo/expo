...
@protocol ABI39_0_0RCTBridgeMethod;
@protocol ABI39_0_0RCTBridgeModule;
@class ABI39_0_0RCTBridge;

typedef id<ABI39_0_0RCTBridgeModule> (^ABI39_0_0RCTBridgeModuleProvider)(void);

@interface ABI39_0_0RCTModuleData : NSObject <ABI39_0_0RCTInvalidating>
...
- (instancetype)initWithModuleClass:(Class)moduleClass
                     moduleProvider:(ABI39_0_0RCTBridgeModuleProvider)moduleProvider
                             bridge:(ABI39_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;

- (instancetype)initWithModuleInstance:(id<ABI39_0_0RCTBridgeModule>)instance
                                bridge:(ABI39_0_0RCTBridge *)bridge NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI39_0_0RCTBridgeMethod>> *methods;

/**
 * Returns a map of the module methods. Note that this will gather the methods the first
 * time it is called and then memoize the results.
 */
@property (nonatomic, copy, readonly) NSDictionary<NSString *, id<ABI39_0_0RCTBridgeMethod>> *methodsByName;
 ...
 */
@property (nonatomic, strong, readwrite) id<ABI39_0_0RCTBridgeModule> instance;
