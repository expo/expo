...
@protocol ABI39_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI39_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI39_0_0RCTBridgeModules automatically, however
 ...
 * previously called ABI39_0_0facebook::ABI39_0_0React::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI39_0_0RCTBridge *)bridge;
 ...
 */
- (BOOL)bridge:(ABI39_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI39_0_0RCTBridge *)bridge
                 onProgress:(ABI39_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI39_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Similar to loadSourceForBridge:onProgress:onComplete: but without progress
 * reporting.
 */
- (void)loadSourceForBridge:(ABI39_0_0RCTBridge *)bridge withBlock:(ABI39_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Retrieve the list of lazy-native-modules names for the given bridge.
 */
- (NSDictionary<NSString *, Class> *)extraLazyModuleClassesForBridge:(ABI39_0_0RCTBridge *)bridge;
