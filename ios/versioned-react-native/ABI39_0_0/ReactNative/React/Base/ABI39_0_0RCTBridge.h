...
@class ABI39_0_0RCTPerformanceLogger;

/**
 * This notification fires when the bridge initializes.
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTJavaScriptWillStartLoadingNotification;

/**
 * This notification fires when the bridge starts executing the JS bundle.
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTJavaScriptWillStartExecutingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTJavaScriptDidLoadNotification;

/**
 * This notification fires when the bridge failed to load the JS bundle. The
 * `error` key can be used to determine the error that occurred.
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTJavaScriptDidFailToLoadNotification;
 ...
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTDidInitializeModuleNotification;

/**
 * This notification fires each time a module is setup after it is initialized. The
 * `ABI39_0_0RCTDidSetupModuleNotificationModuleNameKey` key will contain a reference to the module name and
 * `ABI39_0_0RCTDidSetupModuleNotificationSetupTimeKey` will contain the setup time in ms.
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTDidSetupModuleNotification;

/**
 * Key for the module name (NSString) in the
 * ABI39_0_0RCTDidSetupModuleNotification userInfo dictionary.
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTDidSetupModuleNotificationModuleNameKey;

/**
 * Key for the setup time (NSNumber) in the
 * ABI39_0_0RCTDidSetupModuleNotification userInfo dictionary.
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTDidSetupModuleNotificationSetupTimeKey;

/**
 * DEPRECATED - Use ABI39_0_0RCTReloadCommand instead. This notification fires just before the bridge starts
 * processing a request to reload.
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTBridgeWillReloadNotification;

/**
 * This notification fires whenever a fast refresh happens.
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTBridgeFastRefreshNotification;

/**
 * This notification fires just before the bridge begins downloading a script
 * from the packager.
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTBridgeWillDownloadScriptNotification;

/**
 * This notification fires just after the bridge finishes downloading a script
 * from the packager.
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTBridgeDidDownloadScriptNotification;
 ...
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTBridgeWillInvalidateModulesNotification;

/**
 * This notification fires right after the bridge finishes invalidating NativeModule
 * instances during teardown. Handle this notification to perform additional invalidation.
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTBridgeDidInvalidateModulesNotification;
 ...
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTBridgeWillBeInvalidatedNotification;

/**
 * Key for the ABI39_0_0RCTSource object in the ABI39_0_0RCTBridgeDidDownloadScriptNotification
 * userInfo dictionary.
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTBridgeDidDownloadScriptNotificationSourceKey;

/**
 * Key for the reload reason in the ABI39_0_0RCTBridgeWillReloadNotification userInfo dictionary.
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTBridgeDidDownloadScriptNotificationReasonKey;

/**
 * Key for the bridge description (NSString_ in the
 * ABI39_0_0RCTBridgeDidDownloadScriptNotification userInfo dictionary.
 */
ABI39_0_0RCT_EXTERN NSString *const ABI39_0_0RCTBridgeDidDownloadScriptNotificationBridgeDescriptionKey;
 ...
 */
typedef NSArray<id<ABI39_0_0RCTBridgeModule>> * (^ABI39_0_0RCTBridgeModuleListProvider)(void);

/**
 * This function returns the module name for a given class.
 */
ABI39_0_0RCT_EXTERN NSString *ABI39_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Experimental.
 * Check/set if JSI-bound NativeModule is enabled. By default it's off.
 */
ABI39_0_0RCT_EXTERN BOOL ABI39_0_0RCTTurboModuleEnabled(void);
ABI39_0_0RCT_EXTERN void ABI39_0_0RCTEnableTurboModule(BOOL enabled);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI39_0_0RCTBridge : NSObject <ABI39_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI39_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI39_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 */
@property (nonatomic, weak, readonly) id<ABI39_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ABI39_0_0React Native perf events.
 */
@property (nonatomic, readonly, strong) ABI39_0_0RCTPerformanceLogger *performanceLogger;

/**
 * Reload the bundle and reset executor & modules. Safe to call from any thread.
 */
- (void)reload __deprecated_msg("Use ABI39_0_0RCTReloadCommand instead");

/**
 * Reload the bundle and reset executor & modules. Safe to call from any thread.
 */
- (void)reloadWithReason:(NSString *)reason __deprecated_msg("Use ABI39_0_0RCTReloadCommand instead");
 ...
 */
- (void)requestReload __deprecated_msg("Use ABI39_0_0RCTReloadCommand instead");
