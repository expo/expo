...
static NSURL *getInspectorDeviceUrl(NSURL *bundleURL)
{
  ...
  NSString *inspectorProxyPortStr = [[[NSProcessInfo processInfo] environment] objectForKey:@"ABI39_0_0RCT_METRO_PORT"];
...
@implementation ABI39_0_0RCTInspectorDevServerHelper

ABI39_0_0RCT_NOT_IMPLEMENTED(-(instancetype)init)

static NSMutableDictionary<NSString *, ABI39_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
...
+ (ABI39_0_0RCTInspectorPackagerConnection *)connectWithBundleURL:(NSURL *)bundleURL
{
  ...
  ABI39_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection || !connection.isConnected) {
    connection = [[ABI39_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
