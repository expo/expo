...
@class ABI39_0_0RCTPackagerClientResponder;

typedef uint32_t ABI39_0_0RCTHandlerToken;
typedef void (^ABI39_0_0RCTNotificationHandler)(NSDictionary<NSString *, id> *);
typedef void (^ABI39_0_0RCTRequestHandler)(NSDictionary<NSString *, id> *, ABI39_0_0RCTPackagerClientResponder *);
typedef void (^ABI39_0_0RCTConnectedHandler)(void);

/** Encapsulates singleton connection to ABI39_0_0React Native packager. */
@interface ABI39_0_0RCTPackagerConnection : NSObject
