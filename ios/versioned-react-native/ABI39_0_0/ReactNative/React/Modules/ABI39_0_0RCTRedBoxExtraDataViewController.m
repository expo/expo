...
#import "ABI39_0_0RCTRedBoxExtraDataViewController.h"

@interface ABI39_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI39_0_0RCTRedBoxExtraDataCell
...
@interface ABI39_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI39_0_0RCTRedBoxExtraDataViewController {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  ABI39_0_0RCTRedBoxExtraDataCell *cell =
      (ABI39_0_0RCTRedBoxExtraDataCell *)[tableView dequeueReusableCellWithIdentifier:reuseIdentifier];

  if (cell == nil) {
    cell = [[ABI39_0_0RCTRedBoxExtraDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
  }
