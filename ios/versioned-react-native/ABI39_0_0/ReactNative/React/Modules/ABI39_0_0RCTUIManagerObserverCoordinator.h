...
typedef dispatch_block_t ABI39_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI39_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ABI39_0_0React-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI39_0_0RCTUIManager's observers.
 */
@interface ABI39_0_0RCTUIManagerObserverCoordinator : NSObject <ABI39_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI39_0_0RCTUIManagerObserver` protocol for more info.
