...
@implementation ABI39_0_0RCTLayoutAnimationGroup
...
- (instancetype)initWithConfig:(NSDictionary *)config callback:(ABI39_0_0RCTResponseSenderBlock)callback
{
  ...
  if (self = [super init]) {
    NSTimeInterval duration = [ABI39_0_0RCTConvert NSTimeInterval:config[@"duration"]];
    ...
    _creatingLayoutAnimation = [[ABI39_0_0RCTLayoutAnimation alloc] initWithDuration:duration config:config[@"create"]];
    _updatingLayoutAnimation = [[ABI39_0_0RCTLayoutAnimation alloc] initWithDuration:duration config:config[@"update"]];
    _deletingLayoutAnimation = [[ABI39_0_0RCTLayoutAnimation alloc] initWithDuration:duration config:config[@"delete"]];
    _callback = callback;
  }
...
- (BOOL)isEqual:(ABI39_0_0RCTLayoutAnimationGroup *)layoutAnimation
{
  ABI39_0_0RCTLayoutAnimation *creatingLayoutAnimation = layoutAnimation.creatingLayoutAnimation;
  ABI39_0_0RCTLayoutAnimation *updatingLayoutAnimation = layoutAnimation.updatingLayoutAnimation;
  ABI39_0_0RCTLayoutAnimation *deletingLayoutAnimation = layoutAnimation.deletingLayoutAnimation;
