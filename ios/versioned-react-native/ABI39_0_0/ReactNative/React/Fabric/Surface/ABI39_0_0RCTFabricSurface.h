...
/**
 * (This is Fabric-compatible ABI39_0_0RCTSurface implementation.)
 *
 ...
 * The starting process includes initializing all underlying ABI39_0_0React Native
 * infrastructure and running ABI39_0_0React app.
...
@interface ABI39_0_0RCTFabricSurface (Internal)
...
@interface ABI39_0_0RCTFabricSurface (Deprecated)
