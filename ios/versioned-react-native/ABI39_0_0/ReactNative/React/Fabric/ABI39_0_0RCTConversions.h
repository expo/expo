...
#import <ABI39_0_0React/components/view/AccessibilityPrimitives.h>
#import <ABI39_0_0React/components/view/primitives.h>
#import <ABI39_0_0React/core/LayoutPrimitives.h>
#import <ABI39_0_0React/graphics/Color.h>
#import <ABI39_0_0React/graphics/Geometry.h>
#import <ABI39_0_0React/graphics/Transform.h>

NS_ASSUME_NONNULL_BEGIN

inline NSString *ABI39_0_0RCTNSStringFromString(
...
inline NSString *_Nullable ABI39_0_0RCTNSStringFromStringNilIfEmpty(
    const std::string &string,
    const NSStringEncoding &encoding = NSUTF8StringEncoding)
{
  return string.empty() ? nil : ABI39_0_0RCTNSStringFromString(string, encoding);
}

inline std::string ABI39_0_0RCTStringFromNSString(NSString *string, const NSStringEncoding &encoding = NSUTF8StringEncoding)
{
  return [string cStringUsingEncoding:encoding];
}

inline UIColor *_Nullable ABI39_0_0RCTUIColorFromSharedColor(const ABI39_0_0facebook::ABI39_0_0React::SharedColor &sharedColor)
{
  return sharedColor ? [UIColor colorWithCGColor:sharedColor.get()] : nil;
}

inline CF_RETURNS_NOT_RETAINED CGColorRef
ABI39_0_0RCTCGColorRefUnretainedFromSharedColor(const ABI39_0_0facebook::ABI39_0_0React::SharedColor &sharedColor)
{
  return sharedColor ? sharedColor.get() : nil;
}

inline CF_RETURNS_RETAINED CGColorRef ABI39_0_0RCTCGColorRefFromSharedColor(const ABI39_0_0facebook::ABI39_0_0React::SharedColor &sharedColor)
{
  return sharedColor ? CGColorCreateCopy(sharedColor.get()) : nil;
}

inline CGPoint ABI39_0_0RCTCGPointFromPoint(const ABI39_0_0facebook::ABI39_0_0React::Point &point)
{
  return {point.x, point.y};
}

inline CGSize ABI39_0_0RCTCGSizeFromSize(const ABI39_0_0facebook::ABI39_0_0React::Size &size)
{
  return {size.width, size.height};
}

inline CGRect ABI39_0_0RCTCGRectFromRect(const ABI39_0_0facebook::ABI39_0_0React::Rect &rect)
{
  return {ABI39_0_0RCTCGPointFromPoint(rect.origin), ABI39_0_0RCTCGSizeFromSize(rect.size)};
}

inline UIEdgeInsets ABI39_0_0RCTUIEdgeInsetsFromEdgeInsets(const ABI39_0_0facebook::ABI39_0_0React::EdgeInsets &edgeInsets)
{
  return {edgeInsets.top, edgeInsets.left, edgeInsets.bottom, edgeInsets.right};
}

inline UIAccessibilityTraits ABI39_0_0RCTUIAccessibilityTraitsFromAccessibilityTraits(
    ABI39_0_0facebook::ABI39_0_0React::AccessibilityTraits accessibilityTraits)
{
  using AccessibilityTraits = ABI39_0_0facebook::ABI39_0_0React::AccessibilityTraits;
...
inline CATransform3D ABI39_0_0RCTCATransform3DFromTransformMatrix(const ABI39_0_0facebook::ABI39_0_0React::Transform &transformMatrix)
{
...
inline ABI39_0_0facebook::ABI39_0_0React::Point ABI39_0_0RCTPointFromCGPoint(const CGPoint &point)
{
  return {point.x, point.y};
}

inline ABI39_0_0facebook::ABI39_0_0React::Size ABI39_0_0RCTSizeFromCGSize(const CGSize &size)
{
  return {size.width, size.height};
}

inline ABI39_0_0facebook::ABI39_0_0React::Rect ABI39_0_0RCTRectFromCGRect(const CGRect &rect)
{
  return {ABI39_0_0RCTPointFromCGPoint(rect.origin), ABI39_0_0RCTSizeFromCGSize(rect.size)};
}

inline ABI39_0_0facebook::ABI39_0_0React::EdgeInsets ABI39_0_0RCTEdgeInsetsFromUIEdgeInsets(const UIEdgeInsets &edgeInsets)
{
  return {edgeInsets.left, edgeInsets.top, edgeInsets.right, edgeInsets.bottom};
}

inline ABI39_0_0facebook::ABI39_0_0React::LayoutDirection ABI39_0_0RCTLayoutDirection(BOOL isRTL)
{
  return isRTL ? ABI39_0_0facebook::ABI39_0_0React::LayoutDirection::RightToLeft : ABI39_0_0facebook::ABI39_0_0React::LayoutDirection::LeftToRight;
}
