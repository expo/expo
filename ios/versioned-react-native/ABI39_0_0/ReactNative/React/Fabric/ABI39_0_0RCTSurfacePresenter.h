...
@class ABI39_0_0RCTFabricSurface;
@class ABI39_0_0RCTImageLoader;
@class ABI39_0_0RCTMountingManager;

/**
 * Coordinates presenting of ABI39_0_0React Native Surfaces and represents application
 * facing interface of running ABI39_0_0React Native core.
 */
@interface ABI39_0_0RCTSurfacePresenter : NSObject

- (instancetype)initWithContextContainer:(ABI39_0_0facebook::ABI39_0_0React::ContextContainer::Shared)contextContainer
                         runtimeExecutor:(ABI39_0_0facebook::ABI39_0_0React::RuntimeExecutor)runtimeExecutor;

@property (nonatomic) ABI39_0_0facebook::ABI39_0_0React::ContextContainer::Shared contextContainer;
@property (nonatomic) ABI39_0_0facebook::ABI39_0_0React::RuntimeExecutor runtimeExecutor;
...
@interface ABI39_0_0RCTSurfacePresenter (Surface) <ABI39_0_0RCTSurfacePresenterStub>
...
- (nullable ABI39_0_0RCTFabricSurface *)surfaceForRootTag:(ABI39_0_0ReactTag)rootTag;
