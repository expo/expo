...
#import <ABI39_0_0React/core/EventEmitter.h>
#import <ABI39_0_0React/core/LayoutMetrics.h>
#import <ABI39_0_0React/core/Props.h>
#import <ABI39_0_0React/core/State.h>
 ...
 */
typedef NS_OPTIONS(NSInteger, ABI39_0_0RNComponentViewUpdateMask) {
  ABI39_0_0RNComponentViewUpdateMaskNone = 0,
  ABI39_0_0RNComponentViewUpdateMaskProps = 1 << 0,
  ABI39_0_0RNComponentViewUpdateMaskEventEmitter = 1 << 1,
  ABI39_0_0RNComponentViewUpdateMaskState = 1 << 3,
  ABI39_0_0RNComponentViewUpdateMaskLayoutMetrics = 1 << 4,

  ABI39_0_0RNComponentViewUpdateMaskAll = ABI39_0_0RNComponentViewUpdateMaskProps | ABI39_0_0RNComponentViewUpdateMaskEventEmitter |
      ABI39_0_0RNComponentViewUpdateMaskState | ABI39_0_0RNComponentViewUpdateMaskLayoutMetrics
};

/*
 * Represents a `UIView` instance managed by ABI39_0_0React.
 * All methods are non-@optional.
 * `UIView+ComponentViewProtocol` category provides default implementation
 * for all of them.
 */
@protocol ABI39_0_0RCTComponentViewProtocol <NSObject>

/*
 * Returns a `ComponentDescriptorProvider` of a particular `ComponentDescriptor` which this component view
 * represents.
 */
+ (ABI39_0_0facebook::ABI39_0_0React::ComponentDescriptorProvider)componentDescriptorProvider;
