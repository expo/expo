 ...
 * which are not directly related to ABI39_0_0React Native.
 */
@interface ABI39_0_0RCTEnhancedScrollView : UIScrollView
 ...
 */
@property (nonatomic, strong, readonly) ABI39_0_0RCTGenericDelegateSplitter<id<UIScrollViewDelegate>> *delegateSplitter;
