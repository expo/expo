...
@protocol ABI39_0_0RCTTextInputViewProtocol <NSObject>
- (void)focus;
- (void)blur;
...
ABI39_0_0RCTTextInputHandleCommand(id<ABI39_0_0RCTTextInputViewProtocol> componentView, NSString const *commandName, NSArray const *args)
{
  ...
  if ([commandName isEqualToString:@"setTextAndSelection"]) {
...
#if ABI39_0_0RCT_DEBUG
    if (!ABI39_0_0RCTValidateTypeOfViewCommandArgument(arg0, [NSNumber class], @"number", @"TextInput", commandName, @"1st")) {
      return;
    }
#endif
    ...
    if (![arg1 isKindOfClass:[NSNull class]] &&
        !ABI39_0_0RCTValidateTypeOfViewCommandArgument(arg1, [NSString class], @"string", @"TextInput", commandName, @"2nd")) {
      return;
    }
#endif
...
#if ABI39_0_0RCT_DEBUG
    if (!ABI39_0_0RCTValidateTypeOfViewCommandArgument(arg2, [NSNumber class], @"number", @"TextInput", commandName, @"3rd")) {
      return;
    }
#endif
...
#if ABI39_0_0RCT_DEBUG
    if (!ABI39_0_0RCTValidateTypeOfViewCommandArgument(arg3, [NSNumber class], @"number", @"TextInput", commandName, @"4th")) {
      return;
    }
#endif
...
#if ABI39_0_0RCT_DEBUG
  ABI39_0_0RCTLogError(@"%@ received command %@, which is not a supported command.", @"TextInput", commandName);
#endif
}
