...
#import "ABI39_0_0RCTModalHostViewComponentView.h"

#import <ABI39_0_0React/ABI39_0_0UIView+React.h>
#import <ABI39_0_0React/components/modal/ModalHostViewComponentDescriptor.h>
#import <ABI39_0_0React/components/modal/ModalHostViewState.h>
#import <ABI39_0_0React/components/rncore/EventEmitters.h>
#import <ABI39_0_0React/components/rncore/Props.h>
...
@interface ABI39_0_0RCTModalHostViewComponentView () <ABI39_0_0RCTFabricModalHostViewControllerDelegate>

@end

@implementation ABI39_0_0RCTModalHostViewComponentView {
  ABI39_0_0RCTFabricModalHostViewController *_viewController;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _viewController = [ABI39_0_0RCTFabricModalHostViewController new];
...
- (void)ensurePresentedOnlyIfNeeded
{
  ...
  if (shouldBePresented) {
    UIViewController *controller = [self ABI39_0_0ReactViewController];
    _isPresented = YES;
    return [controller
...
#pragma mark - ABI39_0_0RCTFabricModalHostViewControllerDelegate
...
- (void)boundsDidChange:(CGRect)newBounds
{
  ...
  if (_state != nullptr) {
    auto newState = ModalHostViewState{ABI39_0_0RCTSizeFromCGSize(newBounds.size)};
...
Class<ABI39_0_0RCTComponentViewProtocol> ABI39_0_0RCTModalHostViewCls(void)
{
  return ABI39_0_0RCTModalHostViewComponentView.class;
}
