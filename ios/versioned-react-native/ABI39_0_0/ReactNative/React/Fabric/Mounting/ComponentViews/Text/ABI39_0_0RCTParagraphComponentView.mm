...
#import <ABI39_0_0React/components/text/ParagraphComponentDescriptor.h>
#import <ABI39_0_0React/components/text/ParagraphProps.h>
#import <ABI39_0_0React/components/text/ParagraphState.h>
#import <ABI39_0_0React/components/text/RawTextComponentDescriptor.h>
#import <ABI39_0_0React/components/text/TextComponentDescriptor.h>
#import <ABI39_0_0React/graphics/Geometry.h>
#import <ABI39_0_0React/textlayoutmanager/ABI39_0_0RCTAttributedTextUtils.h>
#import <ABI39_0_0React/textlayoutmanager/ABI39_0_0RCTTextLayoutManager.h>
#import <ABI39_0_0React/textlayoutmanager/TextLayoutManager.h>
...
@implementation ABI39_0_0RCTParagraphComponentView {
...
- (NSAttributedString *_Nullable)attributedText
{
  ...
  return ABI39_0_0RCTNSAttributedStringFromAttributedString(_state->getData().attributedString);
}
...
- (void)drawRect:(CGRect)rect
{
  ...
  ABI39_0_0RCTTextLayoutManager *nativeTextLayoutManager =
      (ABI39_0_0RCTTextLayoutManager *)unwrapManagedObject(textLayoutManager->getNativeTextLayoutManager());

  CGRect frame = ABI39_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
...
{
  NSString *superAccessibilityLabel = ABI39_0_0RCTNSStringFromStringNilIfEmpty(_props->accessibilityLabel);
  ...
  return ABI39_0_0RCTNSStringFromString(_state->getData().attributedString.getString());
}
