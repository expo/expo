...
#import <ABI39_0_0React/ABI39_0_0RCTTouchableComponentViewProtocol.h>
#import <ABI39_0_0React/ABI39_0_0UIView+ComponentViewProtocol.h>
 ...
 */
@interface ABI39_0_0RCTViewComponentView : UIView <ABI39_0_0RCTComponentViewProtocol, ABI39_0_0RCTTouchableComponentViewProtocol> {
 @protected
  ABI39_0_0facebook::ABI39_0_0React::LayoutMetrics _layoutMetrics;
  ABI39_0_0facebook::ABI39_0_0React::SharedViewProps _props;
  ABI39_0_0facebook::ABI39_0_0React::SharedViewEventEmitter _eventEmitter;
}
...
/**
 * Enforcing `call super` semantic for overridden methods from `ABI39_0_0RCTComponentViewProtocol`.
 * The methods update the instance variables.
 */
- (void)updateProps:(ABI39_0_0facebook::ABI39_0_0React::Props::Shared const &)props
           oldProps:(ABI39_0_0facebook::ABI39_0_0React::Props::Shared const &)oldProps NS_REQUIRES_SUPER;
- (void)updateEventEmitter:(ABI39_0_0facebook::ABI39_0_0React::EventEmitter::Shared const &)eventEmitter NS_REQUIRES_SUPER;
- (void)updateLayoutMetrics:(ABI39_0_0facebook::ABI39_0_0React::LayoutMetrics const &)layoutMetrics
           oldLayoutMetrics:(ABI39_0_0facebook::ABI39_0_0React::LayoutMetrics const &)oldLayoutMetrics NS_REQUIRES_SUPER;
