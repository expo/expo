...
#import "ABI39_0_0RCTLegacyViewManagerInteropCoordinatorAdapter.h"
#import <ABI39_0_0React/ABI39_0_0UIView+React.h>

@implementation ABI39_0_0RCTLegacyViewManagerInteropCoordinatorAdapter {
  ABI39_0_0RCTLegacyViewManagerInteropCoordinator *_coordinator;
  NSInteger _tag;
}
...
- (UIView *)paperView
{
  if (!_paperView) {
    ...
    _paperView.ABI39_0_0ReactTag = [NSNumber numberWithInteger:_tag];
...
{
  [_coordinator handleCommand:commandName args:args ABI39_0_0ReactTag:_tag];
}
