...
#import "ABI39_0_0RCTSliderComponentView.h"
...
#import <ABI39_0_0React/components/slider/SliderComponentDescriptor.h>

#import "ABI39_0_0FBABI39_0_0RCTFabricComponentsPlugins.h"

using namespace ABI39_0_0facebook::ABI39_0_0React;

@interface ABI39_0_0RCTSliderComponentView () <ABI39_0_0RCTImageResponseDelegate>
@end

@implementation ABI39_0_0RCTSliderComponentView {
  ...
  ABI39_0_0RCTImageResponseObserverProxy _trackImageResponseObserverProxy;
  ABI39_0_0RCTImageResponseObserverProxy _minimumTrackImageResponseObserverProxy;
  ABI39_0_0RCTImageResponseObserverProxy _maximumTrackImageResponseObserverProxy;
  ABI39_0_0RCTImageResponseObserverProxy _thumbImageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _trackImageResponseObserverProxy = ABI39_0_0RCTImageResponseObserverProxy(self);
    _minimumTrackImageResponseObserverProxy = ABI39_0_0RCTImageResponseObserverProxy(self);
    _maximumTrackImageResponseObserverProxy = ABI39_0_0RCTImageResponseObserverProxy(self);
    _thumbImageResponseObserverProxy = ABI39_0_0RCTImageResponseObserverProxy(self);
...
Class<ABI39_0_0RCTComponentViewProtocol> ABI39_0_0RCTSliderCls(void)
{
  return ABI39_0_0RCTSliderComponentView.class;
}
