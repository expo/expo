...
#import "ABI39_0_0RCTTextInputUtils.h"

#import <ABI39_0_0React/ABI39_0_0RCTConversions.h>

using namespace ABI39_0_0facebook::ABI39_0_0React;

static NSAttributedString *ABI39_0_0RCTSanitizeAttributedString(NSAttributedString *attributedString)
{
...
{
  toTextInput.attributedText = ABI39_0_0RCTSanitizeAttributedString(fromTextInput.attributedText);
...
UIKeyboardAppearance ABI39_0_0RCTUIKeyboardAppearanceFromKeyboardAppearance(KeyboardAppearance keyboardAppearance)
{
...
UIKeyboardType ABI39_0_0RCTUIKeyboardTypeFromKeyboardType(KeyboardType keyboardType)
{
  switch (keyboardType) {
    // Universal
...
UIReturnKeyType ABI39_0_0RCTUIReturnKeyTypeFromReturnKeyType(ReturnKeyType returnKeyType)
{
...
UITextContentType ABI39_0_0RCTUITextContentTypeFromString(std::string const &contentType)
{
  ...
  return ABI39_0_0RCTNSStringFromStringNilIfEmpty(contentType);
}

API_AVAILABLE(ios(12.0))
UITextInputPasswordRules *ABI39_0_0RCTUITextInputPasswordRulesFromString(std::string const &passwordRules)
{
  return [UITextInputPasswordRules passwordRulesWithDescriptor:ABI39_0_0RCTNSStringFromStringNilIfEmpty(passwordRules)];
}
