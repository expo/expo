...
#import "ABI39_0_0RCTPullToRefreshViewComponentView.h"
...
#import <ABI39_0_0React/ABI39_0_0RCTScrollViewComponentView.h>

#import "ABI39_0_0FBABI39_0_0RCTFabricComponentsPlugins.h"

using namespace ABI39_0_0facebook::ABI39_0_0React;

@interface ABI39_0_0RCTPullToRefreshViewComponentView () <ABI39_0_0RCTPullToRefreshViewViewProtocol, ABI39_0_0RCTRefreshableProtocol>
@end

@implementation ABI39_0_0RCTPullToRefreshViewComponentView {
  UIRefreshControl *_refreshControl;
  ABI39_0_0RCTScrollViewComponentView *_scrollViewComponentView;
}
...
- (void)_updateTitle
{
  ...
  if (concreteProps.titleColor) {
    attributes[NSForegroundColorAttributeName] = ABI39_0_0RCTUIColorFromSharedColor(concreteProps.titleColor);
  }

  _refreshControl.attributedTitle =
      [[NSAttributedString alloc] initWithString:ABI39_0_0RCTNSStringFromString(concreteProps.title) attributes:attributes];
}
...
- (void)_attach
{
  ...
  _scrollViewComponentView = [ABI39_0_0RCTScrollViewComponentView findScrollViewComponentViewForView:self];
  if (!_scrollViewComponentView) {
    return;
  }
...
{
  ABI39_0_0RCTPullToRefreshViewHandleCommand(self, commandName, args);
}
...
#pragma mark - ABI39_0_0RCTRefreshableProtocol
...
Class<ABI39_0_0RCTComponentViewProtocol> ABI39_0_0RCTPullToRefreshViewCls(void)
{
  return ABI39_0_0RCTPullToRefreshViewComponentView.class;
}
