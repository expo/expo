...
#import <ABI39_0_0React/ABI39_0_0RCTGenericDelegateSplitter.h>
 ...
 */
@interface ABI39_0_0RCTScrollViewComponentView : ABI39_0_0RCTViewComponentView

/*
 * Finds and returns the closet ABI39_0_0RCTScrollViewComponentView component to the given view
 */
+ (ABI39_0_0RCTScrollViewComponentView *_Nullable)findScrollViewComponentViewForView:(UIView *)view;
...
@property (nonatomic, strong, readonly)
    ABI39_0_0RCTGenericDelegateSplitter<id<UIScrollViewDelegate>> *scrollViewDelegateSplitter;

@end

/*
 * ABI39_0_0RCTScrollableProtocol is a protocol which ABI39_0_0RCTScrollViewManager uses to communicate with all kinds of `UIScrollView`s.
 ...
 */
@interface ABI39_0_0RCTScrollViewComponentView (ScrollableProtocol) <ABI39_0_0RCTScrollableProtocol>
