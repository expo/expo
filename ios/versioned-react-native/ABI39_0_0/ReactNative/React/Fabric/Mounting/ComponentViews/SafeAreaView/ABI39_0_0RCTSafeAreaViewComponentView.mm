...
#import "ABI39_0_0RCTSafeAreaViewComponentView.h"

#import <ABI39_0_0React/ABI39_0_0RCTUtils.h>
#import <ABI39_0_0React/components/safeareaview/SafeAreaViewComponentDescriptor.h>
#import <ABI39_0_0React/components/safeareaview/SafeAreaViewState.h>
...
@implementation ABI39_0_0RCTSafeAreaViewComponentView {
...
- (void)_updateStateIfNecessary
{
  ...
  insets.left = ABI39_0_0RCTRoundPixelValue(insets.left);
  insets.top = ABI39_0_0RCTRoundPixelValue(insets.top);
  insets.right = ABI39_0_0RCTRoundPixelValue(insets.right);
  insets.bottom = ABI39_0_0RCTRoundPixelValue(insets.bottom);

  auto oldPadding = _state->getData().padding;
  auto newPadding = ABI39_0_0RCTEdgeInsetsFromUIEdgeInsets(insets);
  auto threshold = 1.0 / ABI39_0_0RCTScreenScale() + 0.01; // Size of a pixel plus some small threshold.
...
Class<ABI39_0_0RCTComponentViewProtocol> ABI39_0_0RCTSafeAreaViewCls(void)
{
  return ABI39_0_0RCTSafeAreaViewComponentView.class;
}
