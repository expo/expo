...
#import "ABI39_0_0RCTFabricModalHostViewController.h"

#import <ABI39_0_0React/ABI39_0_0RCTLog.h>
#import <ABI39_0_0React/ABI39_0_0RCTSurfaceTouchHandler.h>

@implementation ABI39_0_0RCTFabricModalHostViewController {
  CGRect _lastViewBounds;
  ABI39_0_0RCTSurfaceTouchHandler *_touchHandler;
}
...
- (instancetype)init
{
  ...
  _touchHandler = [ABI39_0_0RCTSurfaceTouchHandler new];
...
{
  return [ABI39_0_0RCTSharedApplication() statusBarStyle];
}
...
{
  return [ABI39_0_0RCTSharedApplication() isStatusBarHidden];
}
...
- (UIInterfaceOrientationMask)supportedInterfaceOrientations
{
  UIInterfaceOrientationMask appSupportedOrientationsMask =
      [ABI39_0_0RCTSharedApplication() supportedInterfaceOrientationsForWindow:[ABI39_0_0RCTSharedApplication() keyWindow]];
