 ...
 */
@interface ABI39_0_0RCTComponentViewRegistry : NSObject

@property (nonatomic, strong, readonly) ABI39_0_0RCTComponentViewFactory *componentViewFactory;
 ...
 * #RefuseSingleUse
 */
- (ABI39_0_0RCTComponentViewDescriptor)dequeueComponentViewWithComponentHandle:(ABI39_0_0facebook::ABI39_0_0React::ComponentHandle)componentHandle
                                                                  tag:(ABI39_0_0facebook::ABI39_0_0React::Tag)tag;

/**
 * Puts a given native component view to the recycle pool.
 * #RefuseSingleUse
 */
- (void)enqueueComponentViewWithComponentHandle:(ABI39_0_0facebook::ABI39_0_0React::ComponentHandle)componentHandle
                                            tag:(ABI39_0_0facebook::ABI39_0_0React::Tag)tag
 ...
 */
- (ABI39_0_0RCTComponentViewDescriptor const &)componentViewDescriptorWithTag:(ABI39_0_0facebook::ABI39_0_0React::Tag)tag;

/**
 * Finds a native component view by given `tag`.
 * Returns `nil` if there is no registered component with the `tag`.
 */
- (nullable UIView<ABI39_0_0RCTComponentViewProtocol> *)findComponentViewWithTag:(ABI39_0_0facebook::ABI39_0_0React::Tag)tag;

/**
 * Creates a component view with a given type and puts it to the recycle pool.
 */
- (void)optimisticallyCreateComponentViewWithComponentHandle:(ABI39_0_0facebook::ABI39_0_0React::ComponentHandle)componentHandle;
