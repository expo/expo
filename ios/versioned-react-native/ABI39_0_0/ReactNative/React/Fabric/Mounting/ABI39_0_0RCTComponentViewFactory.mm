...
#import "ABI39_0_0RCTComponentViewFactory.h"
...
#import <ABI39_0_0React/uimanager/ComponentDescriptorProviderRegistry.h>

#ifdef ABI39_0_0RN_DISABLE_OSS_PLUGIN_HEADER
#import <ABI39_0_0RCTFabricComponentPlugin/ABI39_0_0RCTFabricPluginProvider.h>
#else
#import "ABI39_0_0RCTFabricComponentsPlugins.h"
#endif

#import "ABI39_0_0RCTComponentViewClassDescriptor.h"
#import "ABI39_0_0RCTFabricComponentsPlugins.h"
#import "ABI39_0_0RCTImageComponentView.h"
#import "ABI39_0_0RCTLegacyViewManagerInteropComponentView.h"
#import "ABI39_0_0RCTMountingTransactionObserving.h"
#import "ABI39_0_0RCTParagraphComponentView.h"
#import "ABI39_0_0RCTRootComponentView.h"
#import "ABI39_0_0RCTTextInputComponentView.h"
#import "ABI39_0_0RCTUnimplementedViewComponentView.h"
...
static Class<ABI39_0_0RCTComponentViewProtocol> ABI39_0_0RCTComponentViewClassWithName(const char *componentName)
{
  return ABI39_0_0RCTFabricComponentsProvider(componentName);
}

@implementation ABI39_0_0RCTComponentViewFactory {
  better::map<ComponentHandle, ABI39_0_0RCTComponentViewClassDescriptor> _componentViewClasses;
...
{
  ABI39_0_0RCTComponentViewFactory *componentViewFactory = [[ABI39_0_0RCTComponentViewFactory alloc] init];

  [componentViewFactory registerComponentViewClass:[ABI39_0_0RCTRootComponentView class]];
  [componentViewFactory registerComponentViewClass:[ABI39_0_0RCTViewComponentView class]];
  [componentViewFactory registerComponentViewClass:[ABI39_0_0RCTParagraphComponentView class]];
  [componentViewFactory registerComponentViewClass:[ABI39_0_0RCTTextInputComponentView class]];

  Class<ABI39_0_0RCTComponentViewProtocol> imageClass = ABI39_0_0RCTComponentViewClassWithName("Image");
  ...
  providerRegistry->setComponentDescriptorProviderRequest(
      [providerRegistry, componentViewFactory](ComponentName requestedComponentName) {
        ...
        Class<ABI39_0_0RCTComponentViewProtocol> klass = ABI39_0_0RCTComponentViewClassWithName(requestedComponentName);
        if (klass) {
        ...
        if ([ABI39_0_0RCTLegacyViewManagerInteropComponentView isSupported:ABI39_0_0RCTNSStringFromString(requestedComponentName)]) {
          auto flavor = std::make_shared<std::string const>(requestedComponentName);
          auto componentName = ComponentName{flavor->c_str()};
          auto componentHandle = reinterpret_cast<ComponentHandle>(componentName);
          auto constructor = [ABI39_0_0RCTLegacyViewManagerInteropComponentView componentDescriptorProvider].constructor;
          ...
          componentViewFactory->_componentViewClasses[componentHandle] = [componentViewFactory
              _componentViewClassDescriptorFromClass:[ABI39_0_0RCTLegacyViewManagerInteropComponentView class]];
          return;
        }
        ...
        auto componentName = ComponentName{flavor->c_str()};
        auto componentHandle = reinterpret_cast<ComponentHandle>(componentName);
        auto constructor = [ABI39_0_0RCTUnimplementedViewComponentView componentDescriptorProvider].constructor;

        providerRegistry->add(ComponentDescriptorProvider{componentHandle, componentName, flavor, constructor});

        componentViewFactory->_componentViewClasses[componentHandle] =
            [componentViewFactory _componentViewClassDescriptorFromClass:[ABI39_0_0RCTUnimplementedViewComponentView class]];
      });

  return componentViewFactory;
}

- (ABI39_0_0RCTComponentViewClassDescriptor)_componentViewClassDescriptorFromClass:(Class<ABI39_0_0RCTComponentViewProtocol>)viewClass
{
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wundeclared-selector"
  return ABI39_0_0RCTComponentViewClassDescriptor
  {
    .viewClass = viewClass,
...
- (ABI39_0_0RCTComponentViewDescriptor)createComponentViewWithComponentHandle:(ABI39_0_0facebook::ABI39_0_0React::ComponentHandle)componentHandle
{
  ...
  return ABI39_0_0RCTComponentViewDescriptor{
