...
#import "ABI39_0_0UIView+ComponentViewProtocol.h"
...
{
  ABI39_0_0RCTAssert(NO, @"`-[ABI39_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented in a concrete class.");
  return {};
}
...
{
  ABI39_0_0RCTAssert(childComponentView.superview == self, @"Attempt to unmount improperly mounted component view.");
           ...
           oldLayoutMetrics:(LayoutMetrics const &)oldLayoutMetrics
{
  ...
  if (forceUpdate || (layoutMetrics.frame != oldLayoutMetrics.frame)) {
    CGRect frame = ABI39_0_0RCTCGRectFromRect(layoutMetrics.frame);
...
{
  ABI39_0_0RCTAssert(NO, @"props access should be implemented by ABI39_0_0RCTViewComponentView.");
  return nullptr;
}
