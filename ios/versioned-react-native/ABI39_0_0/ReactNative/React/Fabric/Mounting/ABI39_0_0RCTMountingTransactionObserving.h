 ...
 *
 * # Usecases
 * ABI39_0_0React Native platform-specific mounting layer has limitations when it comes to notifying view components about
 ...
 * required.
 * - Alternatively, an observer can be registered explicitly via `ABI39_0_0RCTSurface`.
 *
 ...
 */
@protocol ABI39_0_0RCTMountingTransactionObserving <NSObject>
 ...
 */
- (void)mountingTransactionWillMountWithMetadata:(ABI39_0_0facebook::ABI39_0_0React::MountingTransactionMetadata const &)metadata;
 ...
 */
- (void)mountingTransactionDidMountWithMetadata:(ABI39_0_0facebook::ABI39_0_0React::MountingTransactionMetadata const &)metadata;
