...
@class ABI39_0_0RCTSurfacePresenter;
 ...
 */
@interface ABI39_0_0RCTSurfacePresenterBridgeAdapter : NSObject

- (instancetype)initWithBridge:(ABI39_0_0RCTBridge *)bridge
              contextContainer:(ABI39_0_0facebook::ABI39_0_0React::ContextContainer::Shared)contextContainer;

/*
 * Returns a stored instance of Surface Presenter which is managed by a bridge.
 */
@property (nonatomic, readonly) ABI39_0_0RCTSurfacePresenter *surfacePresenter;
