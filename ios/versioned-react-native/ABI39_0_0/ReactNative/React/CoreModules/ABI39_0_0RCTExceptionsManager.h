...
@protocol ABI39_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI39_0_0RCTExceptionsManager : NSObject <ABI39_0_0RCTBridgeModule>
...
@property (nonatomic, weak) id<ABI39_0_0RCTExceptionsManagerDelegate> delegate;
