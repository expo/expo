...
#import "ABI39_0_0RCTDeviceInfo.h"
...
@interface ABI39_0_0RCTDeviceInfo () <ABI39_0_0NativeDeviceInfoSpec>
@end

@implementation ABI39_0_0RCTDeviceInfo {
#if !TARGET_OS_TV
...
- (void)setBridge:(ABI39_0_0RCTBridge *)bridge
{
...
#if !TARGET_OS_TV
  _currentInterfaceOrientation = [ABI39_0_0RCTSharedApplication() statusBarOrientation];
  ...
  _currentInterfaceDimensions = ABI39_0_0RCTExportedDimensions(_bridge);
...
static BOOL ABI39_0_0RCTIsIPhoneX()
{
...
static NSDictionary *ABI39_0_0RCTExportedDimensions(ABI39_0_0RCTBridge *bridge)
{
  ABI39_0_0RCTAssertMainQueue();
  ABI39_0_0RCTDimensions dimensions = ABI39_0_0RCTGetDimensions(bridge.accessibilityManager.multiplier);
...
{
  return @{
    @"Dimensions" : ABI39_0_0RCTExportedDimensions(_bridge),
    // Note:
    // This prop is deprecated and will be removed in a future release.
    // Please use this only for a quick and temporary solution.
    // Use <SafeAreaView> instead.
    @"isIPhoneX_deprecated" : @(ABI39_0_0RCTIsIPhoneX()),
  };
}
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [bridge.eventDispatcher sendDeviceEventWithName:@"didUpdateDimensions" body:ABI39_0_0RCTExportedDimensions(bridge)];
...
{
  UIInterfaceOrientation nextOrientation = [ABI39_0_0RCTSharedApplication() statusBarOrientation];
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [_bridge.eventDispatcher sendDeviceEventWithName:@"didUpdateDimensions" body:ABI39_0_0RCTExportedDimensions(_bridge)];
#pragma clang diagnostic pop
  }
...
{
  NSDictionary *nextInterfaceDimensions = ABI39_0_0RCTExportedDimensions(_bridge);
...
Class ABI39_0_0RCTDeviceInfoCls(void)
{
  return ABI39_0_0RCTDeviceInfo.class;
}
