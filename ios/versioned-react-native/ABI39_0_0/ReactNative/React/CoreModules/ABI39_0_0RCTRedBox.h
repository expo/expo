...
typedef void (^ABI39_0_0RCTRedBoxButtonPressHandler)(void);

@interface ABI39_0_0RCTRedBox : NSObject <ABI39_0_0RCTBridgeModule>

- (void)registerErrorCustomizer:(id<ABI39_0_0RCTErrorCustomizer>)errorCustomizer;
...
- (void)showErrorMessage:(NSString *)message withParsedStack:(NSArray<ABI39_0_0RCTJSStackFrame *> *)stack;
- (void)updateErrorMessage:(NSString *)message withParsedStack:(NSArray<ABI39_0_0RCTJSStackFrame *> *)stack;
- (void)showErrorMessage:(NSString *)message
         withParsedStack:(NSArray<ABI39_0_0RCTJSStackFrame *> *)stack
...
- (void)addCustomButton:(NSString *)title onPressHandler:(ABI39_0_0RCTRedBoxButtonPressHandler)handler;
...
/**
 * This category makes the red box instance available via the ABI39_0_0RCTBridge, which
 * is useful for any class that needs to access the red box or error log.
 */
@interface ABI39_0_0RCTBridge (ABI39_0_0RCTRedBox)

@property (nonatomic, readonly) ABI39_0_0RCTRedBox *redBox;
