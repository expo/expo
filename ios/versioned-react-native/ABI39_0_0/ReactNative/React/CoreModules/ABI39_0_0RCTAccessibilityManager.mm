...
#import "ABI39_0_0RCTAccessibilityManager.h"
...
NSString *const ABI39_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification =
    @"ABI39_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification";

@interface ABI39_0_0RCTAccessibilityManager () <ABI39_0_0NativeAccessibilityManagerSpec>
...
@implementation ABI39_0_0RCTAccessibilityManager
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    self.contentSizeCategory = ABI39_0_0RCTSharedApplication().preferredContentSizeCategory;
...
- (void)invalidateMultiplier
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI39_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification
                                                      object:self];
}
...
- (CGFloat)multiplierForContentSizeCategory:(NSString *)category
{
  ...
  if (m.doubleValue <= 0.0) {
    ABI39_0_0RCTLogError(@"Can't determine multiplier for category %@. Using 1.0.", category);
    m = @1.0;
  }
...
ABI39_0_0RCT_EXPORT_METHOD(setAccessibilityContentSizeMultipliers
...
ABI39_0_0RCT_EXPORT_METHOD(setAccessibilityFocus : (double)ABI39_0_0ReactTag)
{
  dispatch_async(dispatch_get_main_queue(), ^{
    UIView *view = [self.bridge.uiManager viewForABI39_0_0ReactTag:@(ABI39_0_0ReactTag)];
    UIAccessibilityPostNotification(UIAccessibilityLayoutChangedNotification, view);
  });
}

ABI39_0_0RCT_EXPORT_METHOD(announceForAccessibility : (NSString *)announcement)
{
  UIAccessibilityPostNotification(UIAccessibilityAnnouncementNotification, announcement);
}

ABI39_0_0RCT_EXPORT_METHOD(getMultiplier : (ABI39_0_0RCTResponseSenderBlock)callback)
{
  if (callback) {
...
ABI39_0_0RCT_EXPORT_METHOD(getCurrentBoldTextState
                  : (ABI39_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI39_0_0RCTResponseSenderBlock)onError)
{
  onSuccess(@[ @(_isBoldTextEnabled) ]);
}

ABI39_0_0RCT_EXPORT_METHOD(getCurrentGrayscaleState
                  : (ABI39_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI39_0_0RCTResponseSenderBlock)onError)
{
...
ABI39_0_0RCT_EXPORT_METHOD(getCurrentInvertColorsState
                  : (ABI39_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI39_0_0RCTResponseSenderBlock)onError)
{
...
ABI39_0_0RCT_EXPORT_METHOD(getCurrentReduceMotionState
                  : (ABI39_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI39_0_0RCTResponseSenderBlock)onError)
{
...
ABI39_0_0RCT_EXPORT_METHOD(getCurrentReduceTransparencyState
                  : (ABI39_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI39_0_0RCTResponseSenderBlock)onError)
{
...
ABI39_0_0RCT_EXPORT_METHOD(getCurrentVoiceOverState
                  : (ABI39_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI39_0_0RCTResponseSenderBlock)onError)
{
...
{
  return std::make_shared<ABI39_0_0facebook::ABI39_0_0React::NativeAccessibilityManagerSpecJSI>(
      self, jsInvoker, nativeInvoker, perfLogger);
}

@end

@implementation ABI39_0_0RCTBridge (ABI39_0_0RCTAccessibilityManager)

- (ABI39_0_0RCTAccessibilityManager *)accessibilityManager
{
  return [self moduleForClass:[ABI39_0_0RCTAccessibilityManager class]];
}

@end

Class ABI39_0_0RCTAccessibilityManagerCls(void)
{
  return ABI39_0_0RCTAccessibilityManager.class;
}
