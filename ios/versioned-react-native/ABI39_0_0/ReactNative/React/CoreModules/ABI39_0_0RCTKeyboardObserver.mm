...
#import "ABI39_0_0RCTKeyboardObserver.h"
...
static NSDictionary *ABI39_0_0RCTParseKeyboardNotification(NSNotification *notification);

@interface ABI39_0_0RCTKeyboardObserver () <ABI39_0_0NativeKeyboardObserverSpec>
@end

@implementation ABI39_0_0RCTKeyboardObserver
...
#define IMPLEMENT_KEYBOARD_HANDLER(EVENT)                                              \
  ...
  {                                                                                    \
    ...
    [self sendEventWithName:@ #EVENT body:ABI39_0_0RCTParseKeyboardNotification(notification)]; \
  }
...
{
  return std::make_shared<ABI39_0_0facebook::ABI39_0_0React::NativeKeyboardObserverSpecJSI>(self, jsInvoker, nativeInvoker, perfLogger);
}

@end

NS_INLINE NSDictionary *ABI39_0_0RCTRectDictionaryValue(CGRect rect)
{
  return @{
...
static NSString *ABI39_0_0RCTAnimationNameForCurve(UIViewAnimationCurve curve)
{
  switch (curve) {
...
static NSDictionary *ABI39_0_0RCTParseKeyboardNotification(NSNotification *notification)
{
  ...
  return @{
    @"startCoordinates" : ABI39_0_0RCTRectDictionaryValue(beginFrame),
    @"endCoordinates" : ABI39_0_0RCTRectDictionaryValue(endFrame),
    @"duration" : @(duration * 1000.0), // ms
    @"easing" : ABI39_0_0RCTAnimationNameForCurve(curve),
    @"isEventFromThisApp" : isLocalUserInfoKey == 1 ? @YES : @NO,
  };
#endif
}

Class ABI39_0_0RCTKeyboardObserverCls(void)
{
  return ABI39_0_0RCTKeyboardObserver.class;
}
