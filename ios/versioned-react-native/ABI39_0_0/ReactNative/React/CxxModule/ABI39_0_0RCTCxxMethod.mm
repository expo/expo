...
#import "ABI39_0_0RCTCxxUtils.h"

#import <memory>

using ABI39_0_0facebook::xplat::module::CxxModule;
using namespace ABI39_0_0facebook::ABI39_0_0React;

@implementation ABI39_0_0RCTCxxMethod {
...
- (id)invokeWithBridge:(ABI39_0_0RCTBridge *)bridge module:(id)module arguments:(NSArray *)arguments
{
  ...
  if (arguments.count < _method->callbacks) {
    ABI39_0_0RCTLogError(
        ...
        ABI39_0_0RCTBridgeModuleNameForClass([module class]),
        _method->name.c_str(),
        _method->callbacks,
        arguments.count);
    return nil;
  ...
  } catch (const ABI39_0_0facebook::xplat::JsArgumentException &ex) {
    ABI39_0_0RCTLogError(
