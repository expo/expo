...
class ABI39_0_0RCTObjcExecutor : public JSExecutor {
 public:
  ABI39_0_0RCTObjcExecutor(
  ...
  {
    ABI39_0_0RCTAssert(NO, @"RAM bundles are not supported in ABI39_0_0RCTObjcExecutor");
  }
 ...
 private:
  ...
  ABI39_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI39_0_0RCTObjcExecutorFactory::ABI39_0_0RCTObjcExecutorFactory(id<ABI39_0_0RCTJavaScriptExecutor> jse, ABI39_0_0RCTJavaScriptCompleteBlock errorBlock)
    : m_jse(jse), m_errorBlock(errorBlock)
{
}

std::unique_ptr<JSExecutor> ABI39_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue)
{
  return std::unique_ptr<JSExecutor>(new ABI39_0_0RCTObjcExecutor(m_jse, m_errorBlock, jsQueue, delegate));
}
