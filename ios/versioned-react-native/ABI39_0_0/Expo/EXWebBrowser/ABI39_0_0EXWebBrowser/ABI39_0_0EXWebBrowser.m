...
#import <ABI39_0_0EXWebBrowser/ABI39_0_0EXWebBrowser.h>
...
@interface ABI39_0_0EXWebBrowser () <SFSafariViewControllerDelegate>

@property (nonatomic, copy) ABI39_0_0UMPromiseResolveBlock redirectResolve;
@property (nonatomic, copy) ABI39_0_0UMPromiseRejectBlock redirectReject;
...
@implementation ABI39_0_0EXWebBrowser
{
  UIStatusBarStyle _initialStatusBarStyle;
}

ABI39_0_0UM_EXPORT_MODULE(ExpoWebBrowser)
...
ABI39_0_0UM_EXPORT_METHOD_AS(openAuthSessionAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(openBrowserAsync,
                    ...
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  if([[arguments allKeys] containsObject:WebBrowserToolbarColorKey]) {
    safariVC.preferredBarTintColor = [ABI39_0_0EXWebBrowser convertHexColorString:arguments[WebBrowserToolbarColorKey]];
  }
  if([[arguments allKeys] containsObject:WebBrowserControlsColorKey]) {
    safariVC.preferredControlTintColor = [ABI39_0_0EXWebBrowser convertHexColorString:arguments[WebBrowserControlsColorKey]];
  }
...
ABI39_0_0UM_EXPORT_METHOD_AS(dismissBrowser,
                    dismissBrowserWithResolver:(ABI39_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  __weak typeof(self) weakSelf = self;
  UIViewController *currentViewController = [UIApplication sharedApplication].keyWindow.rootViewController;
...
ABI39_0_0UM_EXPORT_METHOD_AS(dismissAuthSession,
                    dismissAuthSessionWithResolver:(ABI39_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  if (@available(iOS 11, *)) {
    [_authSession cancel];
...
ABI39_0_0UM_EXPORT_METHOD_AS(warmUpAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(coolDownAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(getCustomTabsSupportingBrowsers,
                    getCustomTabsSupportingBrowsersWithPackage:(ABI39_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  // stub for jest-expo-mock-generator
}

ABI39_0_0UM_EXPORT_METHOD_AS(mayInitWithUrlAsync,
 ...
 */
- (BOOL)initializeWebBrowserWithResolver:(ABI39_0_0UMPromiseResolveBlock)resolve andRejecter:(ABI39_0_0UMPromiseRejectBlock)reject {
  if (_redirectResolve) {
...
+ (UIColor *)convertHexColorString:(NSString *)stringToConvert {
  ...
  return [ABI39_0_0EXWebBrowser colorWithRGBHex:hexNum];
}
