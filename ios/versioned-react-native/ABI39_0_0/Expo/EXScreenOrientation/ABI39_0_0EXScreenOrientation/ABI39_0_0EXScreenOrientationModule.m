...
#import <ABI39_0_0EXScreenOrientation/ABI39_0_0EXScreenOrientationUtilities.h>
#import <ABI39_0_0EXScreenOrientation/ABI39_0_0EXScreenOrientationRegistry.h>

#import <UIKit/UIKit.h>

static NSString *const ABI39_0_0EXScreenOrientationDidUpdateDimensions = @"expoDidUpdateDimensions";

@interface ABI39_0_0EXScreenOrientationModule ()

@property (nonatomic, weak) ABI39_0_0EXScreenOrientationRegistry *screenOrientationRegistry;
@property (nonatomic, weak) id<ABI39_0_0UMEventEmitterService> eventEmitter;

@end

@implementation ABI39_0_0EXScreenOrientationModule

ABI39_0_0UM_EXPORT_MODULE(ExpoScreenOrientation);
...
ABI39_0_0UM_EXPORT_METHOD_AS(lockAsync,
...
{
  UIInterfaceOrientationMask orientationMask = [ABI39_0_0EXScreenOrientationUtilities importOrientationLock:orientationLock];
  ...
  if (![ABI39_0_0EXScreenOrientationUtilities doesDeviceSupportOrientationMask:orientationMask]) {
...
ABI39_0_0UM_EXPORT_METHOD_AS(lockPlatformAsync,
                    ...
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  for (NSNumber *allowedOrientation in allowedOrientations) {
    UIInterfaceOrientation orientation = [ABI39_0_0EXScreenOrientationUtilities importOrientation:allowedOrientation];
    UIInterfaceOrientationMask orientationMask = [ABI39_0_0EXScreenOrientationUtilities maskFromOrientation:orientation];
    if (!orientationMask) {
  ...
  if (![ABI39_0_0EXScreenOrientationUtilities doesDeviceSupportOrientationMask:allowedOrientationsMask]) {
...
ABI39_0_0UM_EXPORT_METHOD_AS(getOrientationLockAsync,
                    getOrientationLockAsyncWithResolver:(ABI39_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  resolve([ABI39_0_0EXScreenOrientationUtilities exportOrientationLock:[_screenOrientationRegistry currentOrientationMask]]);
}

ABI39_0_0UM_EXPORT_METHOD_AS(getPlatformOrientationLockAsync,
                    getPlatformOrientationLockAsyncResolver:(ABI39_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  for (NSNumber *wrappedSingleOrientation in [maskToOrienationMap allKeys]) {
    ...
    if (supportedOrientationMask) {
      ...
      [allowedOrientations addObject:[ABI39_0_0EXScreenOrientationUtilities exportOrientation:supportedOrientation]];
    }
  }
  resolve(allowedOrientations);
}

ABI39_0_0UM_EXPORT_METHOD_AS(supportsOrientationLockAsync,
                    ...
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (orientationMask && [ABI39_0_0EXScreenOrientationUtilities doesDeviceSupportOrientationMask:orientationMask]) {
    return resolve(@YES);
  }
...
ABI39_0_0UM_EXPORT_METHOD_AS(getOrientationAsync,
                    getOrientationAsyncResolver:(ABI39_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  resolve([ABI39_0_0EXScreenOrientationUtilities exportOrientation:[_screenOrientationRegistry currentOrientation]]);
}
...
- (void)screenOrientationDidChange:(UIInterfaceOrientation)orientation
{
  ...
  [_eventEmitter sendEventWithName:ABI39_0_0EXScreenOrientationDidUpdateDimensions body:@{
    @"orientationLock": [ABI39_0_0EXScreenOrientationUtilities exportOrientationLock:[_screenOrientationRegistry currentOrientationMask]],
    @"orientationInfo": @{
      @"orientation": [ABI39_0_0EXScreenOrientationUtilities exportOrientation:orientation],
      @"verticalSizeClass": ABI39_0_0UMNullIfNil(@(currentTraitCollection.verticalSizeClass)),
      @"horizontalSizeClass": ABI39_0_0UMNullIfNil(@(currentTraitCollection.horizontalSizeClass)),
    }
  }];
}

- (NSArray<NSString *> *)supportedEvents {
  return @[ABI39_0_0EXScreenOrientationDidUpdateDimensions];
}
