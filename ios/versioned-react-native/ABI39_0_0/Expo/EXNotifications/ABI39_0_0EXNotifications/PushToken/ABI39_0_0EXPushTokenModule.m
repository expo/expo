...
#import <ABI39_0_0EXNotifications/ABI39_0_0EXPushTokenModule.h>
#import <ABI39_0_0EXNotifications/ABI39_0_0EXPushTokenManager.h>
...
@interface ABI39_0_0EXPushTokenModule ()

@property (nonatomic, weak) id<ABI39_0_0EXPushTokenManager> pushTokenManager;
...
@property (nonatomic, strong) ABI39_0_0UMPromiseResolveBlock getDevicePushTokenResolver;
@property (nonatomic, strong) ABI39_0_0UMPromiseRejectBlock getDevicePushTokenRejecter;

@end

@implementation ABI39_0_0EXPushTokenModule

ABI39_0_0UM_EXPORT_MODULE(ExpoPushTokenManager);

# pragma mark - Exported methods

ABI39_0_0UM_EXPORT_METHOD_AS(getDevicePushTokenAsync,
                    getDevicePushTokenResolving:(ABI39_0_0UMPromiseResolveBlock)resolve rejecting:(ABI39_0_0UMPromiseRejectBlock)reject)
{
...
# pragma mark - ABI39_0_0EXPushTokenListener
