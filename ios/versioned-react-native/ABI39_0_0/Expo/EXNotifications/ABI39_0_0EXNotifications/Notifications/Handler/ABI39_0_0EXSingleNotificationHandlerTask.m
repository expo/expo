...
static NSString * const ABI39_0_0EXNotificationHandlerErrorDomain = @"expo.notifications.handler";

@interface ABI39_0_0EXSingleNotificationHandlerTask ()
...
@property (nonatomic, weak) id<ABI39_0_0EXSingleNotificationHandlerTaskDelegate> delegate;

@property (nonatomic, strong) NSTimer *timer;

@end

@implementation ABI39_0_0EXSingleNotificationHandlerTask
...
- (instancetype)initWithEventEmitter:(id<ABI39_0_0UMEventEmitterService>)eventEmitter
                   ...
                   completionHandler:(void (^)(UNNotificationPresentationOptions))completionHandler
                            delegate:(nonnull id<ABI39_0_0EXSingleNotificationHandlerTaskDelegate>)delegate
{
  if (self = [super init]) {
...
- (void)start
{
  [_eventEmitter sendEventWithName:onHandleNotification body:@{
    ...
    @"notification": [ABI39_0_0EXNotificationSerializer serializedNotification:_notification]
  }];
...
- (nullable NSError *)callCompletionHandlerWithOptions:(UNNotificationPresentationOptions)options
{
  if (_completionHandler) {
    ...
    return [NSError errorWithDomain:ABI39_0_0EXNotificationHandlerErrorDomain code:-1 userInfo:@{
