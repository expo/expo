...
static NSString * const ABI39_0_0EXNotificationResponseDefaultActionIdentifier = @"expo.modules.notifications.actions.DEFAULT";

@implementation ABI39_0_0EXNotificationSerializer
...
+ (NSDictionary *)serializedNotificationResponse:(UNNotificationResponse *)response
{
  ...
  if ([UNNotificationDefaultActionIdentifier isEqualToString:actionIdentifier]) {
    actionIdentifier = ABI39_0_0EXNotificationResponseDefaultActionIdentifier;
  }
