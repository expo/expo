...
@interface ABI39_0_0EXNotificationPresentationModule ()

@property (nonatomic, weak) id<ABI39_0_0EXNotificationBuilder> notificationBuilder;
...
@implementation ABI39_0_0EXNotificationPresentationModule

ABI39_0_0UM_EXPORT_MODULE(ExpoNotificationPresenter);
...
// Remove once presentNotificationAsync is removed
ABI39_0_0UM_EXPORT_METHOD_AS(presentNotificationAsync,
                    ...
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  __weak ABI39_0_0EXNotificationPresentationModule *weakSelf = self;
...
ABI39_0_0UM_EXPORT_METHOD_AS(getPresentedNotificationsAsync,
                    getPresentedNotificationsAsyncWithResolve:(ABI39_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
...
ABI39_0_0UM_EXPORT_METHOD_AS(dismissNotificationAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(dismissAllNotificationsAsync,
                    dismissAllNotificationsWithResolver:(ABI39_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
...
{
  _notificationBuilder = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI39_0_0EXNotificationBuilder)];

  // Remove once presentNotificationAsync is removed
  id<ABI39_0_0EXNotificationCenterDelegate> notificationCenterDelegate = (id<ABI39_0_0EXNotificationCenterDelegate>)[moduleRegistry getSingletonModuleForName:@"NotificationCenterDelegate"];
...
- (NSArray * _Nonnull)serializeNotifications:(NSArray<UNNotification *> * _Nonnull)notifications
{
  ...
  for (UNNotification *notification in notifications) {
    [serializedNotifications addObject:[ABI39_0_0EXNotificationSerializer serializedNotification:notification]];
  }
