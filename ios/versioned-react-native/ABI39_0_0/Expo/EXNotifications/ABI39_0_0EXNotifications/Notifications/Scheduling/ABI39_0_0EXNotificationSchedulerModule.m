...
#import <ABI39_0_0EXNotifications/ABI39_0_0NSDictionary+EXNotificationsVerifyingClass.h>
...
@interface ABI39_0_0EXNotificationSchedulerModule ()

@property (nonatomic, weak) id<ABI39_0_0EXNotificationBuilder> builder;

@end

@implementation ABI39_0_0EXNotificationSchedulerModule

ABI39_0_0UM_EXPORT_MODULE(ExpoNotificationScheduler);

- (void)setModuleRegistry:(ABI39_0_0UMModuleRegistry *)moduleRegistry
{
  _builder = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI39_0_0EXNotificationBuilder)];
}

# pragma mark - Exported methods

ABI39_0_0UM_EXPORT_METHOD_AS(getAllScheduledNotificationsAsync,
                    getAllScheduledNotifications:(ABI39_0_0UMPromiseResolveBlock)resolve reject:(ABI39_0_0UMPromiseRejectBlock)reject
                    )
{
...
ABI39_0_0UM_EXPORT_METHOD_AS(scheduleNotificationAsync,
                     scheduleNotification:(NSString *)identifier notificationSpec:(NSDictionary *)notificationSpec triggerSpec:(NSDictionary *)triggerSpec resolve:(ABI39_0_0UMPromiseResolveBlock)resolve rejecting:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  @try {
...
ABI39_0_0UM_EXPORT_METHOD_AS(cancelScheduledNotificationAsync,
                     cancelNotification:(NSString *)identifier resolve:(ABI39_0_0UMPromiseResolveBlock)resolve rejecting:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  [[UNUserNotificationCenter currentNotificationCenter] removePendingNotificationRequestsWithIdentifiers:@[identifier]];
  resolve(nil);
}

ABI39_0_0UM_EXPORT_METHOD_AS(cancelAllScheduledNotificationsAsync,
                     cancelAllNotificationsWithResolver:(ABI39_0_0UMPromiseResolveBlock)resolve rejecting:(ABI39_0_0UMPromiseRejectBlock)reject)
{
...
- (NSArray * _Nonnull)serializeNotificationRequests:(NSArray<UNNotificationRequest *> * _Nonnull) requests
{
  ...
  for (UNNotificationRequest *request in requests) {
    [serializedRequests addObject:[ABI39_0_0EXNotificationSerializer serializedNotificationRequest:request]];
  }
