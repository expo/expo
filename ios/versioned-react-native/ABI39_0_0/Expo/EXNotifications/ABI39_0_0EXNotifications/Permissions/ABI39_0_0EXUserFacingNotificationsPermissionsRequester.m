...
@interface ABI39_0_0EXUserFacingNotificationsPermissionsRequester ()

@property (nonatomic, assign) dispatch_queue_t methodQueue;

@end

@implementation ABI39_0_0EXUserFacingNotificationsPermissionsRequester
...
- (NSDictionary *)getPermissions
{
  ...
  __block ABI39_0_0UMPermissionStatus generalStatus = ABI39_0_0UMPermissionStatusUndetermined;

  [[UNUserNotificationCenter currentNotificationCenter] getNotificationSettingsWithCompletionHandler:^(UNNotificationSettings *settings) {
    if (settings.authorizationStatus == UNAuthorizationStatusAuthorized) {
      generalStatus = ABI39_0_0UMPermissionStatusGranted;
    } else if (settings.authorizationStatus == UNAuthorizationStatusDenied) {
      generalStatus = ABI39_0_0UMPermissionStatusDenied;
    }
...
- (void)requestPermissions:(NSDictionary *)permissions withResolver:(ABI39_0_0UMPromiseResolveBlock)resolve rejecter:(ABI39_0_0UMPromiseRejectBlock)reject
{
...
- (void)requestAuthorizationOptions:(UNAuthorizationOptions)options withResolver:(ABI39_0_0UMPromiseResolveBlock)resolve rejecter:(ABI39_0_0UMPromiseRejectBlock)reject
{
