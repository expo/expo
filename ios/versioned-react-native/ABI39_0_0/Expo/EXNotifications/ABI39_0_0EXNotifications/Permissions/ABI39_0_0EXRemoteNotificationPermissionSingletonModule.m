...
@interface ABI39_0_0EXRemoteNotificationPermissionSingletonModule ()

@property (nonatomic, strong) NSPointerArray *delegates;

@end

@implementation ABI39_0_0EXRemoteNotificationPermissionSingletonModule

ABI39_0_0UM_REGISTER_SINGLETON_MODULE(RemoteNotificationPermissionPublisher);
