...
@implementation ABI39_0_0EXBackgroundFetchTaskConsumer

+ (BOOL)supportsLaunchReason:(ABI39_0_0UMTaskLaunchReason)launchReason
{
  return launchReason == ABI39_0_0UMTaskLaunchReasonBackgroundFetch;
}
...
- (NSUInteger)normalizeTaskResult:(id)result
{
  ...
  switch ([result unsignedIntegerValue]) {
    case ABI39_0_0EXBackgroundFetchResultNewData:
      return UIBackgroundFetchResultNewData;
    case ABI39_0_0EXBackgroundFetchResultFailed:
      return UIBackgroundFetchResultFailed;
    case ABI39_0_0EXBackgroundFetchResultNoData:
    default:
      return UIBackgroundFetchResultNoData;
  }
}
