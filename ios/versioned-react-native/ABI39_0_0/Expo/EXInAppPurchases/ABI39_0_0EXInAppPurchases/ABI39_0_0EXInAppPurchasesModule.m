...
#import <ABI39_0_0EXInAppPurchases/ABI39_0_0EXInAppPurchasesModule.h>

@interface ABI39_0_0EXInAppPurchasesModule ()
...
@implementation ABI39_0_0EXInAppPurchasesModule

ABI39_0_0UM_EXPORT_MODULE(ExpoInAppPurchases);
...
ABI39_0_0UM_EXPORT_METHOD_AS(connectAsync,
                    connectAsync:(ABI39_0_0UMPromiseResolveBlock)resolve
...
ABI39_0_0UM_EXPORT_METHOD_AS(getProductsAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(purchaseItemAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(finishTransactionAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(getPurchaseHistoryAsync,
...
- (BOOL)setPromise:(NSString*)key resolve:(ABI39_0_0UMPromiseResolveBlock)resolve reject:(ABI39_0_0UMPromiseRejectBlock)reject
{
...
- (void)resolvePromise:(NSString*)key value:(id)value
{
  ...
  if (currentPromise != nil) {
    ABI39_0_0UMPromiseResolveBlock resolve = currentPromise[0];
    _promises[key] = nil;
...
- (void)rejectPromise:(NSString*)key code:(NSString*)code message:(NSString*)message error:(NSError*) error
{
  ...
  if (currentPromise != nil) {
    ABI39_0_0UMPromiseRejectBlock reject = currentPromise[1];
    _promises[key] = nil;
