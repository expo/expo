...
@interface ABI39_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) id<ABI39_0_0UMCameraInterface> camera;
...
@implementation ABI39_0_0EXGLCameraObject
