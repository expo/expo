...
#import <ABI39_0_0EXHaptics/ABI39_0_0EXHapticsModule.h>

@interface ABI39_0_0EXHapticsModule ()

@end

@implementation ABI39_0_0EXHapticsModule

ABI39_0_0UM_EXPORT_MODULE(ExpoHaptics);
...
ABI39_0_0UM_EXPORT_METHOD_AS(notificationAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(impactAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(selectionAsync,
                    resolve:(ABI39_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
