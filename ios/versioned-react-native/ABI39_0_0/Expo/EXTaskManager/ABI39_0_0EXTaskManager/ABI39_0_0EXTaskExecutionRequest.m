...
@interface ABI39_0_0EXTaskExecutionRequest ()

@property (nonatomic, strong, nullable) NSMutableSet<id<ABI39_0_0UMTaskInterface>> *tasks;
...
@implementation ABI39_0_0EXTaskExecutionRequest
...
- (void)addTask:(nonnull id<ABI39_0_0UMTaskInterface>)task
{
  [_tasks addObject:task];
}

- (void)task:(nonnull id<ABI39_0_0UMTaskInterface>)task didFinishWithResult:(id)result
{
...
- (BOOL)isIncludingTask:(nullable id<ABI39_0_0UMTaskInterface>)task
{
...
- (void)_maybeExecuteCallback
{
  if (_callback) {
    ...
    __strong ABI39_0_0EXTaskExecutionRequest *strongSelf = self;
