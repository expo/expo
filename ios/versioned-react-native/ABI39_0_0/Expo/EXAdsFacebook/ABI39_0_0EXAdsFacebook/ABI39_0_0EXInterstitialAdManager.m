#import <ABI39_0_0EXAdsFacebook/ABI39_0_0EXInterstitialAdManager.h>
#import <ABI39_0_0UMCore/ABI39_0_0UMUtilities.h>

#import <FBAudienceNetwork/FBAudienceNetwork.h>

@interface ABI39_0_0EXInterstitialAdManager () <FBInterstitialAdDelegate>
...
@implementation ABI39_0_0EXInterstitialAdManager

ABI39_0_0UM_EXPORT_MODULE(CTKInterstitialAdManager)
...
{
  [_interstitialAd showAdFromRootViewController:[[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI39_0_0UMUtilitiesInterface)] currentViewController]];
}
...
- (void)bridgeDidForeground:(NSNotification *)notification
{
  ...
  if (_adViewController) {
    [[[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI39_0_0UMUtilitiesInterface)] currentViewController] presentViewController:_adViewController animated:NO completion:nil];
...
- (void)bridgeDidBackground:(NSNotification *)notification
{
  ...
  if (_interstitialAd) {
    _adViewController = [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI39_0_0UMUtilitiesInterface)] currentViewController];
