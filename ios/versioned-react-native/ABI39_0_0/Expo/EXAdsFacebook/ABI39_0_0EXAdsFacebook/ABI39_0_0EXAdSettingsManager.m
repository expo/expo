#import <ABI39_0_0EXAdsFacebook/ABI39_0_0EXAdSettingsManager.h>
#import <FBAudienceNetwork/FBAudienceNetwork.h>
#import <ABI39_0_0UMCore/ABI39_0_0UMAppLifecycleService.h>

@interface ABI39_0_0EXAdSettingsManager ()
...
@implementation ABI39_0_0EXAdSettingsManager

ABI39_0_0UM_EXPORT_MODULE(CTKAdSettingsManager)
...
ABI39_0_0UM_EXPORT_METHOD_AS(addTestDevice,
...
ABI39_0_0UM_EXPORT_METHOD_AS(clearTestDevices,
                    clearTestDevicesWithResolver:(ABI39_0_0UMPromiseResolveBlock)resolver
                    reject:(ABI39_0_0UMPromiseRejectBlock)rejecter)
{
...
ABI39_0_0UM_EXPORT_METHOD_AS(setLogLevel,
...
ABI39_0_0UM_EXPORT_METHOD_AS(setIsChildDirected,
...
ABI39_0_0UM_EXPORT_METHOD_AS(setMeditationService,
...
ABI39_0_0UM_EXPORT_METHOD_AS(setUrlPrefix,
