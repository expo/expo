#import <ABI39_0_0EXAdsFacebook/ABI39_0_0EXNativeAdView.h>
#import <FBAudienceNetwork/FBAudienceNetwork.h>
#import <ABI39_0_0UMCore/ABI39_0_0UMUtilitiesInterface.h>

@interface ABI39_0_0EXNativeAdView ()

@property (nonatomic, weak) ABI39_0_0UMModuleRegistry *moduleRegistry;

@end

@implementation ABI39_0_0EXNativeAdView
...
- (void)setOnAdLoaded:(ABI39_0_0UMDirectEventBlock)onAdLoaded
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    if (strongSelf) {
      [strongSelf.nativeAd registerViewForInteraction:strongSelf
                                            mediaView:mediaView
                                             iconView:adIconView
                                       viewController:[[strongSelf.moduleRegistry getModuleImplementingProtocol:@protocol(ABI39_0_0UMUtilitiesInterface)] currentViewController]
