...
#import <ABI39_0_0EXCrypto/ABI39_0_0EXCrypto.h>
#import <CommonCrypto/CommonDigest.h>

@implementation ABI39_0_0EXCrypto

ABI39_0_0UM_EXPORT_MODULE(ExpoCrypto);

ABI39_0_0UM_EXPORT_METHOD_AS(digestStringAsync,
                    ...
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  int digestLength = [ABI39_0_0EXCrypto digestLengthForJSAlgorithm:algorithm];
  if (digestLength == -1) {
