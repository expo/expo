...
@implementation ABI39_0_0EXErrorRecoveryModule

ABI39_0_0UM_EXPORT_MODULE(ExpoErrorRecovery);

ABI39_0_0UM_EXPORT_METHOD_AS(saveRecoveryProps,
...
{
  return @{
           @"recoveredProps": ABI39_0_0UMNullIfNil([self consumeRecoveryProps])
           };
}
