...
@implementation ABI39_0_0UMAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitializedAndSorted {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI39_0_0UMSingletonModule*> * singletonModules = [[ABI39_0_0UMModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI39_0_0UMSingletonModule *singletonModule in singletonModules) {
