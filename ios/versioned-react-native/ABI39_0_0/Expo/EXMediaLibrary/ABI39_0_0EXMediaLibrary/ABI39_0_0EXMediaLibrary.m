...
NSString *const ABI39_0_0EXAssetMediaTypeAudio = @"audio";
NSString *const ABI39_0_0EXAssetMediaTypePhoto = @"photo";
NSString *const ABI39_0_0EXAssetMediaTypeVideo = @"video";
NSString *const ABI39_0_0EXAssetMediaTypeUnknown = @"unknown";
NSString *const ABI39_0_0EXAssetMediaTypeAll = @"all";

NSString *const ABI39_0_0EXMediaLibraryDidChangeEvent = @"mediaLibraryDidChange";

NSString *const ABI39_0_0EXMediaLibraryCachesDirectory = @"MediaLibrary";

NSString *const ABI39_0_0EXMediaLibraryShouldDownloadFromNetworkKey = @"shouldDownloadFromNetwork";

@interface ABI39_0_0EXMediaLibrary ()
...
@implementation ABI39_0_0EXMediaLibrary

ABI39_0_0UM_EXPORT_MODULE(ExponentMediaLibrary);
...
- (void)setModuleRegistry:(ABI39_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  [ABI39_0_0UMPermissionsMethodsDelegate registerRequesters:@[[ABI39_0_0EXMediaLibraryCameraRollRequester new]] withPermissionsManager:_permissionsManager];
}
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"MediaType": @{
               @"audio": ABI39_0_0EXAssetMediaTypeAudio,
               @"photo": ABI39_0_0EXAssetMediaTypePhoto,
               @"video": ABI39_0_0EXAssetMediaTypeVideo,
               @"unknown": ABI39_0_0EXAssetMediaTypeUnknown,
               @"all": ABI39_0_0EXAssetMediaTypeAll,
               },
           @"SortBy": @{
               @"default": @"default",
           ...
           @"CHANGE_LISTENER_NAME": ABI39_0_0EXMediaLibraryDidChangeEvent,
           };
}

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI39_0_0EXMediaLibraryDidChangeEvent];
}
                    ...
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  [ABI39_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI39_0_0EXMediaLibraryCameraRollRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
...
ABI39_0_0UM_EXPORT_METHOD_AS(createAssetAsync,
                    ...
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  PHAssetMediaType assetType = [ABI39_0_0EXMediaLibrary _assetTypeForUri:localUri];
  ...
  if (!([_fileSystem permissionsForURI:assetUrl] & ABI39_0_0UMFileSystemPermissionRead)) {
  ...
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    ...
    if (success) {
      PHAsset *asset = [ABI39_0_0EXMediaLibrary _getAssetById:assetPlaceholder.localIdentifier];
      resolve([ABI39_0_0EXMediaLibrary _exportAsset:asset]);
    } else {
...
ABI39_0_0UM_EXPORT_METHOD_AS(saveToLibraryAsync,
                    ...
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI39_0_0EXSaveToLibraryDelegate *delegate = [ABI39_0_0EXSaveToLibraryDelegate new];
  [_saveToLibraryDelegates addObject:delegate];
  ABI39_0_0EXSaveToLibraryCallback callback = ^(id asset, NSError *error){
...
ABI39_0_0UM_EXPORT_METHOD_AS(addAssetsToAlbumAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(removeAssetsFromAlbumAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(deleteAssetsAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(getAlbumsAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(getMomentsAsync,
                    getMoments:(ABI39_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  if (![self _checkPermissions:reject]) {
    return;
  ...
  NSArray<NSDictionary *> *albums = [ABI39_0_0EXMediaLibrary _exportCollections:fetchResult withFetchOptions:options inFolder:nil];
  
  resolve(albums);
}

ABI39_0_0UM_EXPORT_METHOD_AS(getAlbumAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(deleteAlbumsAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(getAssetInfoAsync,
                    ...
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  PHAsset *asset = [ABI39_0_0EXMediaLibrary _getAssetById:assetId];
    
  BOOL shouldDownloadFromNetwork = [[options objectForKey:ABI39_0_0EXMediaLibraryShouldDownloadFromNetworkKey] boolValue] ?: YES;
  
  if (asset) {
    NSMutableDictionary *result = [ABI39_0_0EXMediaLibrary _exportAssetInfo:asset];
    if (asset.mediaType == PHAssetMediaTypeImage) {
      ...
      [[PHImageManager defaultManager] requestAVAssetForVideo:asset
        ...
        if ([asset isKindOfClass:[AVComposition class]]) {
            NSString *directory = [self.fileSystem.cachesDirectory stringByAppendingPathComponent:ABI39_0_0EXMediaLibraryCachesDirectory];
...
ABI39_0_0UM_EXPORT_METHOD_AS(getAssetsAsync,
                     ...
                     reject:(ABI39_0_0UMPromiseRejectBlock)reject
{
  ...
  if (mediaType && [mediaType count] > 0) {
    NSMutableArray<NSNumber *> *assetTypes = [ABI39_0_0EXMediaLibrary _convertMediaTypes:mediaType];
  ...
  if (sortBy && sortBy.count > 0) {
    fetchOptions.sortDescriptors = [ABI39_0_0EXMediaLibrary _prepareSortDescriptors:sortBy];
  }
  ...
  if (fetchOptions.sortDescriptors.count == 0) {
    ...
    for (NSInteger i = startIndex; i >= endIndex; i--) {
      ...
      [assets addObject:[ABI39_0_0EXMediaLibrary _exportAsset:asset]];
    }
...
{
  if (assetId) {
    return [ABI39_0_0EXMediaLibrary _getAssetsByIds:@[assetId]].firstObject;
  }
  return nil;
}
...
+ (void)_ensureAlbumWithTitle:(nonnull NSString *)title completion:(void(^)(PHAssetCollection *collection, NSError *error))completion
{
  ...
  [ABI39_0_0EXMediaLibrary _createAlbumWithTitle:title completion:completion];
}
...
+ (NSDictionary *)_exportAsset:(PHAsset *)asset
{
  if (asset) {
    ...
    return @{
             ...
             @"filename": fileName,
             @"uri": [ABI39_0_0EXMediaLibrary _assetUriForLocalId:asset.localIdentifier andExtension:assetExtension],
             @"mediaType": [ABI39_0_0EXMediaLibrary _stringifyMediaType:asset.mediaType],
             @"mediaSubtypes": [ABI39_0_0EXMediaLibrary _stringifyMediaSubtypes:asset.mediaSubtypes],
             @"width": @(asset.pixelWidth),
             @"height": @(asset.pixelHeight),
             @"creationTime": [ABI39_0_0EXMediaLibrary _exportDate:asset.creationDate],
             @"modificationTime": [ABI39_0_0EXMediaLibrary _exportDate:asset.modificationDate],
...
{
  NSMutableDictionary *assetDict = [[ABI39_0_0EXMediaLibrary _exportAsset:asset] mutableCopy];
  
  if (assetDict) {
    assetDict[@"location"] = [ABI39_0_0EXMediaLibrary _exportLocation:asset.location];
...
{
  return [ABI39_0_0EXMediaLibrary _exportCollection:collection inFolder:nil];
}
...
+ (nullable NSDictionary *)_exportCollection:(PHAssetCollection *)collection inFolder:(nullable NSString *)folderName
{
  if (collection) {
    return @{
             @"id": [ABI39_0_0EXMediaLibrary _assetIdFromLocalId:collection.localIdentifier],
             @"title": ABI39_0_0UMNullIfNil(collection.localizedTitle),
             @"folderName": ABI39_0_0UMNullIfNil(folderName),
             @"type": [ABI39_0_0EXMediaLibrary _stringifyAlbumType:collection.assetCollectionType],
             @"assetCount": [ABI39_0_0EXMediaLibrary _assetCountOfCollection:collection],
             @"startTime": [ABI39_0_0EXMediaLibrary _exportDate:collection.startDate],
             @"endTime": [ABI39_0_0EXMediaLibrary _exportDate:collection.endDate],
             @"approximateLocation": [ABI39_0_0EXMediaLibrary _exportLocation:collection.approximateLocation],
             @"locationNames": ABI39_0_0UMNullIfNil(collection.localizedLocationNames),
             };
  }
  return nil;
}
                       ...
                       inFolder:(nullable NSString *)folderName
{
  ...
  for (PHCollection *collection in collections) {
    if ([collection isKindOfClass:[PHAssetCollection class]]) {
      [albums addObject:[ABI39_0_0EXMediaLibrary _exportCollection:(PHAssetCollection *)collection inFolder:folderName]];
      ...
      [albums addObjectsFromArray:[ABI39_0_0EXMediaLibrary _exportCollections:collectionsInFolder withFetchOptions:options inFolder:collection.localizedTitle]];
    }
  }
  return [albums copy];
}
...
{
  NSString *assetId = [ABI39_0_0EXMediaLibrary _assetIdFromLocalId:localId];
...
+ (NSString *)_stringifyMediaType:(PHAssetMediaType)mediaType
{
  switch (mediaType) {
    case PHAssetMediaTypeAudio:
      return ABI39_0_0EXAssetMediaTypeAudio;
    case PHAssetMediaTypeImage:
      return ABI39_0_0EXAssetMediaTypePhoto;
    case PHAssetMediaTypeVideo:
      return ABI39_0_0EXAssetMediaTypeVideo;
    default:
      return ABI39_0_0EXAssetMediaTypeUnknown;
  }
}

+ (PHAssetMediaType)_convertMediaType:(NSString *)mediaType
{
  if ([mediaType isEqualToString:ABI39_0_0EXAssetMediaTypeAudio]) {
    return PHAssetMediaTypeAudio;
  }
  if ([mediaType isEqualToString:ABI39_0_0EXAssetMediaTypePhoto]) {
    return PHAssetMediaTypeImage;
  }
  if ([mediaType isEqualToString:ABI39_0_0EXAssetMediaTypeVideo]) {
    return PHAssetMediaTypeVideo;
  }
  return PHAssetMediaTypeUnknown;
}
...
+ (NSMutableArray<NSNumber *> *)_convertMediaTypes:(NSArray<NSString *> *)mediaTypes
{
  ...
  [mediaTypes enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
    if ([obj isEqualToString:ABI39_0_0EXAssetMediaTypeAll]) {
      *stop = YES;
      assetTypes = nil;
      return;
    }
    PHAssetMediaType assetType = [ABI39_0_0EXMediaLibrary _convertMediaType:obj];
...
+ (NSString *)_convertSortByKey:(NSString *)key
{
  ...
  if (value == nil) {
    ...
    @throw [NSException exceptionWithName:@"ABI39_0_0EXMediaLibrary.UNSUPPORTED_SORTBY_KEY" reason:reason userInfo:nil];
  }
  return value;
}
...
+ (NSSortDescriptor *)_sortDescriptorFrom:(id)config
{
  if ([config isKindOfClass:[NSString class]]) {
    NSString *key = [ABI39_0_0EXMediaLibrary _convertSortByKey:config];
  ...
  if ([config isKindOfClass:[NSArray class]]) {
    ...
    NSString *key = [ABI39_0_0EXMediaLibrary _convertSortByKey:sortArray[0]];
...
+ (NSArray *)_prepareSortDescriptors:(NSArray *)sortBy
{
  ...
  for (id config in sortByArray) {
    NSSortDescriptor *sortDescriptor = [ABI39_0_0EXMediaLibrary _sortDescriptorFrom:config];
...
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI39_0_0EXMediaLibraryCameraRollRequester class]]) {
    reject(@"E_NO_PERMISSIONS", @"CAMERA_ROLL permission is required to do this operation.", nil);
    return NO;
  }
  return YES;
