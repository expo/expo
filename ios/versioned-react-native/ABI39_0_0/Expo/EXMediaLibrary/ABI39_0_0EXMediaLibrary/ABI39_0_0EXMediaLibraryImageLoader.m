...
// Prior to ABI39_0_0React Native 0.61, it contained `ABI39_0_0RCTAssetsLibraryRequestHandler` that handles loading data from URLs
// with `assets-library://` or `ph://` schemes. Due to lean core project, it's been moved to `@ABI39_0_0React-native-community/cameraroll`
// and that made it impossible to render assets using URLs returned by MediaLibrary without installing CameraRoll.
// Because it's still a unimodule and we need to export bare ABI39_0_0React Native module, we should make sure ABI39_0_0React Native is installed.
#if __has_include(<ABI39_0_0React/ABI39_0_0RCTImageURLLoader.h>)

#import <Photos/Photos.h>
#import <ABI39_0_0React/ABI39_0_0RCTUtils.h>
#import <ABI39_0_0EXMediaLibrary/ABI39_0_0EXMediaLibraryImageLoader.h>

@implementation ABI39_0_0EXMediaLibraryImageLoader

ABI39_0_0RCT_EXPORT_MODULE()

#pragma mark - ABI39_0_0RCTImageURLLoader
