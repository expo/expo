...
@interface ABI39_0_0EXSessionResumableDownloadTaskDelegate ()

@property (strong, nonatomic, readonly) ABI39_0_0EXDownloadDelegateOnWriteCallback onWriteCallback;
@property (weak, nonatomic) ABI39_0_0EXResumablesManager *manager;
@property (strong, nonatomic) NSString *uuid;

@end

@implementation ABI39_0_0EXSessionResumableDownloadTaskDelegate
