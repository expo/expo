...
#import <ABI39_0_0EXFileSystem/ABI39_0_0EXSessionUploadTaskDelegate.h>

@interface ABI39_0_0EXSessionUploadTaskDelegate ()

@property (strong, nonatomic) NSMutableData *responseData;

@end

@implementation ABI39_0_0EXSessionUploadTaskDelegate

- (instancetype)initWithResolve:(ABI39_0_0UMPromiseResolveBlock)resolve reject:(ABI39_0_0UMPromiseRejectBlock)reject
{
...
- (void)URLSession:(NSURLSession *)session task:(NSURLSessionTask *)task didCompleteWithError:(NSError *)error
{
  ...
  // We only set ABI39_0_0EXSessionUploadTaskDelegates as delegates of upload tasks
...
- (NSDictionary *)parseServerResponse:(NSURLResponse *)response
{
  ...
  result[@"body"] = ABI39_0_0UMNullIfNil([[NSString alloc] initWithData:_responseData encoding:NSUTF8StringEncoding]);
  return result;
}
