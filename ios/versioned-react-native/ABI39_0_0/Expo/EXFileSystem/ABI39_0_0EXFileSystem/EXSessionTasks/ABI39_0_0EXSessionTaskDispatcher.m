...
#import <ABI39_0_0EXFileSystem/ABI39_0_0EXSessionTaskDispatcher.h>
#import <ABI39_0_0EXFileSystem/ABI39_0_0EXSessionResumableDownloadTaskDelegate.h>

@interface ABI39_0_0EXSessionTaskDispatcher ()

@property (nonatomic, strong) NSMutableDictionary<NSURLSessionTask *, ABI39_0_0EXSessionTaskDelegate *> *tasks;
@property (nonatomic) BOOL isActive;
@property (nonatomic, weak) id<ABI39_0_0EXSessionHandler> sessionHandler;

@end

@implementation ABI39_0_0EXSessionTaskDispatcher
...
{
  if (_isActive) {
    ABI39_0_0EXSessionTaskDelegate *exTask = _tasks[downloadTask];
    if (exTask) {
...
{
  if (_isActive) {
    ABI39_0_0EXSessionTaskDelegate *exTask = _tasks[task];
    if (exTask) {
...
{
  if (_isActive) {
    ABI39_0_0EXSessionTaskDelegate *exTask = _tasks[dataTask];
