...
@interface ABI39_0_0EXSessionTaskDelegate : NSObject

@property (nonatomic, strong, readonly) ABI39_0_0UMPromiseResolveBlock resolve;
@property (nonatomic, strong, readonly) ABI39_0_0UMPromiseRejectBlock reject;
