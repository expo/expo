...
@interface ABI39_0_0UMNativeModulesProxy ()

@property (nonatomic, strong) NSRegularExpression *regexp;
@property (nonatomic, strong) ABI39_0_0UMModuleRegistry *moduleRegistry;
...
@implementation ABI39_0_0UMNativeModulesProxy
...
# pragma mark - ABI39_0_0React API
...
- (NSDictionary *)constantsToExport
{
  ...
  NSArray<ABI39_0_0UMViewManager *> *viewManagers = [_moduleRegistry getAllViewManagers];
...
ABI39_0_0RCT_EXPORT_METHOD(callMethod:(NSString *)moduleName methodNameOrKey:(id)methodNameOrKey arguments:(NSArray *)arguments resolver:(ABI39_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI39_0_0RCTPromiseRejectBlock)reject)
{
