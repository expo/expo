...
@protocol ABI39_0_0EXConstantsDeviceInstallUUIDManager <NSObject>
...
- (instancetype)initWithExperienceId:(NSString *)experienceId andParams:(NSDictionary *)params deviceInstallUUIDManager:(id<ABI39_0_0EXConstantsDeviceInstallUUIDManager>)deviceInstallUUIDManager;
