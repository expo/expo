...
@interface ABI39_0_0EXExpoUserNotificationCenterProxy ()

@property (nonatomic, weak) id<ABI39_0_0UMUserNotificationCenterProxyInterface> userNotificationCenter;

@end

@implementation ABI39_0_0EXExpoUserNotificationCenterProxy
