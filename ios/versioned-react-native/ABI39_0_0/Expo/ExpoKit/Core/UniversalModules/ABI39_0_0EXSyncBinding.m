...
#import "ABI39_0_0EXSyncBinding.h"

NS_ASSUME_NONNULL_BEGIN

@interface ABI39_0_0EXSyncBinding ()

@property (nonatomic, strong) NSString *experienceId;
@property (nonatomic, weak) id<ABI39_0_0EXSyncBindingDelegate> updatesKernelService;
@property (nonatomic, weak) id<ABI39_0_0EXSyncDatabaseBindingDelegate> databaseKernelService;

@end

@implementation ABI39_0_0EXSyncBinding : ABI39_0_0EXSyncService
