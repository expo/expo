...
static NSMutableDictionary<NSString *, NSDictionary *> *ABI39_0_0EXScopedModuleClasses;

NSDictionary<NSString *, NSDictionary *> * ABI39_0_0EXGetScopedModuleClasses(void);
NSDictionary<NSString *, NSDictionary *> * ABI39_0_0EXGetScopedModuleClasses()
{
  return ABI39_0_0EXScopedModuleClasses;
}

void ABI39_0_0EXRegisterScopedModule(Class, ...);
void ABI39_0_0EXRegisterScopedModule(Class moduleClass, ...)
{
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    ABI39_0_0EXScopedModuleClasses = [NSMutableDictionary dictionary];
  });
  ...
  while ((kernelServiceClassName = va_arg(argumentList, NSString*))) {
    if ([kernelServiceClassName isEqualToString:@"nil"]) {
      unversionedKernelServiceClassNames[kernelServiceClassName] = ABI39_0_0EX_KERNEL_SERVICE_NONE;
    } else {
  ...
  if (moduleClassName) {
    ABI39_0_0EXScopedModuleClasses[moduleClassName] = unversionedKernelServiceClassNames;
  }
}
