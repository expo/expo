...
@implementation ABI39_0_0RNCSafeAreaProvider
{
...
{
  // This gets called before the view size is set by ABI39_0_0React-native so
  ...
  if (
    _initialInsetsSent &&
    ABI39_0_0UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI39_0_0RCTScreenScale()) &&
