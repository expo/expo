...
@implementation ABI39_0_0AIRMapPolyline {
...
- (void)setStrokeColors:(NSArray<UIColor *> *)strokeColors {
    ...
    if ((self.renderer != nil) && ![_renderer isKindOfClass:[ABI39_0_0AIRMapPolylineRenderer class]]) {
...
- (void)setCoordinates:(NSArray<ABI39_0_0AIRMapCoordinate *> *)coordinates {
...
- (MKOverlayPathRenderer*)createRenderer {
    ...
    if (self.strokeColors == nil) {
        ...
        return [[ABI39_0_0AIRMapPolylineRenderer alloc] initWithOverlay:self polyline:self.polyline];
    }
}
...
- (void) updateRenderer:(MKOverlayPathRenderer*)renderer {
    ...
    if ([renderer isKindOfClass:[ABI39_0_0AIRMapPolylineRenderer class]]) {
        ((ABI39_0_0AIRMapPolylineRenderer*)renderer).strokeColors = _strokeColors;
    }
}
...
#pragma mark ABI39_0_0AIRMapSnapshot implementation

- (void) drawToSnapshot:(MKMapSnapshot *) snapshot context:(CGContextRef) context
{
    ABI39_0_0AIRMapPolylineRenderer* renderer = [[ABI39_0_0AIRMapPolylineRenderer alloc] initWithSnapshot:snapshot overlay:self polyline:self.polyline];
