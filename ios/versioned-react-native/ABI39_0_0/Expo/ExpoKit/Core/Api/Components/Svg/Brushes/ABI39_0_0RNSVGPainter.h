...
@class ABI39_0_0RNSVGPattern;

@interface ABI39_0_0RNSVGPainter : NSObject

@property (nonatomic, assign) ABI39_0_0RNSVGPattern* pattern;
@property (nonatomic, assign) CGRect paintBounds;
@property (nonatomic, assign) bool useObjectBoundingBoxForContentUnits;
@property (nonatomic, assign) CGRect bounds;

- (instancetype)initWithPointsArray:(NSArray<ABI39_0_0RNSVGLength *> *)pointsArray NS_DESIGNATED_INITIALIZER;
