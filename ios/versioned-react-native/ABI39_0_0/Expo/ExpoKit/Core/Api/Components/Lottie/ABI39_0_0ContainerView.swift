#if canImport(ABI39_0_0React)
import ABI39_0_0React
#endif

import Lottie

class ContainerView: ABI39_0_0RCTView {
    ...
    @objc var onAnimationFinish: ABI39_0_0RCTBubblingEventBlock?
  ...
  override func abi39_0_0ReactSetFrame(_ frame: CGRect) {
        super.abi39_0_0ReactSetFrame(frame)
        animationView?.abi39_0_0ReactSetFrame(frame)
    }
