...
@implementation ABI39_0_0RNSVGEllipse

- (void)setCx:(ABI39_0_0RNSVGLength *)cx
{
    if ([cx isEqualTo:_cx]) {
        return;
    }
...
- (void)setCy:(ABI39_0_0RNSVGLength *)cy
{
    if ([cy isEqualTo:_cy]) {
        return;
    }
...
- (void)setRx:(ABI39_0_0RNSVGLength *)rx
{
    if ([rx isEqualTo:_rx]) {
        return;
    }
...
- (void)setRy:(ABI39_0_0RNSVGLength *)ry
{
    if ([ry isEqualTo:_ry]) {
        return;
    }
