...
@implementation ABI39_0_0RNSVGSvgView
{
    NSMutableDictionary<NSString *, ABI39_0_0RNSVGNode *> *_clipPaths;
    NSMutableDictionary<NSString *, ABI39_0_0RNSVGNode *> *_templates;
    NSMutableDictionary<NSString *, ABI39_0_0RNSVGPainter *> *_painters;
    NSMutableDictionary<NSString *, ABI39_0_0RNSVGNode *> *_markers;
    NSMutableDictionary<NSString *, ABI39_0_0RNSVGNode *> *_masks;
...
- (void)invalidate
{
    ...
    if ([parent isKindOfClass:[ABI39_0_0RNSVGNode class]]) {
        ...
        ABI39_0_0RNSVGNode* svgNode = (ABI39_0_0RNSVGNode*)parent;
        [svgNode invalidate];
        rendered = false;
        return;
    }
...
- (void)setBbWidth:(ABI39_0_0RNSVGLength *)bbWidth
{
...
- (void)setBbHeight:(ABI39_0_0RNSVGLength *)bbHeight
{
...
- (void)drawToContext:(CGContextRef)context withRect:(CGRect)rect {
    ...
    if (self.align) {
        ...
        _viewBoxTransform = [ABI39_0_0RNSVGViewBox getTransform:tRect
                                                 eRect:rect
                                                 align:self.align
    ...
    for (UIView *node in self.subviews) {
        if ([node isKindOfClass:[ABI39_0_0RNSVGNode class]]) {
            ABI39_0_0RNSVGNode *svg = (ABI39_0_0RNSVGNode *)node;
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    for (ABI39_0_0RNSVGNode *node in [self.subviews reverseObjectEnumerator]) {
        if (![node isKindOfClass:[ABI39_0_0RNSVGNode class]]) {
            continue;
        }
...
- (void)defineTemplate:(ABI39_0_0RNSVGNode *)template templateName:(NSString *)templateName
{
    if (!_templates) {
