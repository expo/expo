...
@interface ABI39_0_0RNForceTouchGestureRecognizer : UIGestureRecognizer
...
@implementation ABI39_0_0RNForceTouchGestureRecognizer {
...
@implementation ABI39_0_0RNForceTouchHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI39_0_0RNForceTouchGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI39_0_0RNForceTouchGestureRecognizer *recognizer = (ABI39_0_0RNForceTouchGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    recognizer.feedbackOnActivation = [ABI39_0_0RCTConvert BOOL:prop];
  }
}

- (ABI39_0_0RNGestureHandlerEventExtraData *)eventExtraData:(ABI39_0_0RNForceTouchGestureRecognizer *)recognizer
{
