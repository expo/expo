//
//  ABI39_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI39_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI39_0_0RNGestureHandler *otherHandler = [ABI39_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI39_0_0RCTTouchHandler class]];
}
