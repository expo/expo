...
#define ABI39_0_0RNSVG_DEFAULT_KERNING 0.0
#define ABI39_0_0RNSVG_DEFAULT_WORD_SPACING 0.0
#define ABI39_0_0RNSVG_DEFAULT_LETTER_SPACING 0.0
...
ABI39_0_0RNSVGFontData *ABI39_0_0RNSVGFontData_Defaults;

@implementation ABI39_0_0RNSVGFontData

+ (instancetype)Defaults {
    if (!ABI39_0_0RNSVGFontData_Defaults) {
        ABI39_0_0RNSVGFontData *self = [ABI39_0_0RNSVGFontData alloc];
        self->fontData = nil;
        self->fontFamily = @"";
        self->fontStyle = ABI39_0_0RNSVGFontStyleNormal;
        self->fontWeight = ABI39_0_0RNSVGFontWeightNormal;
        self->absoluteFontWeight = 400;
        self->fontFeatureSettings = @"";
        self->fontVariantLigatures = ABI39_0_0RNSVGFontVariantLigaturesNormal;
        self->textAnchor = ABI39_0_0RNSVGTextAnchorStart;
        self->textDecoration = ABI39_0_0RNSVGTextDecorationNone;
        self->manualKerning = false;
        self->kerning = ABI39_0_0RNSVG_DEFAULT_KERNING;
        self->fontSize = ABI39_0_0RNSVG_DEFAULT_FONT_SIZE;
        self->wordSpacing = ABI39_0_0RNSVG_DEFAULT_WORD_SPACING;
        self->letterSpacing = ABI39_0_0RNSVG_DEFAULT_LETTER_SPACING;
        ABI39_0_0RNSVGFontData_Defaults = self;
    }
    return ABI39_0_0RNSVGFontData_Defaults;
}

+ (CGFloat)toAbsoluteWithNSString:(NSString *)string
                        fontSize:(CGFloat)fontSize {
    return [ABI39_0_0RNSVGPropHelper fromRelativeWithNSString:string
                                         relative:0
                                         fontSize:fontSize];
}

- (void)setInheritedWeight:(ABI39_0_0RNSVGFontData*) parent {
    absoluteFontWeight = parent->absoluteFontWeight;
    fontWeight = parent->fontWeight;
}

ABI39_0_0RNSVGFontWeight ABI39_0_0nearestFontWeight(int absoluteFontWeight) {
    return ABI39_0_0RNSVGFontWeights[(int)round(absoluteFontWeight / 100.0)];
}

- (void)handleNumericWeight:(ABI39_0_0RNSVGFontData*)parent weight:(double)weight {
    long roundWeight = round(weight);
    if (roundWeight >= 1 && roundWeight <= 1000) {
        absoluteFontWeight = (int)roundWeight;
        fontWeight = ABI39_0_0nearestFontWeight(absoluteFontWeight);
    } else {
...
int ABI39_0_0AbsoluteFontWeight(ABI39_0_0RNSVGFontWeight fontWeight, ABI39_0_0RNSVGFontData* parent) {
    if (fontWeight == ABI39_0_0RNSVGFontWeightBolder) {
        return ABI39_0_0bolder(parent->absoluteFontWeight);
    } else if (fontWeight == ABI39_0_0RNSVGFontWeightLighter) {
        return ABI39_0_0lighter(parent->absoluteFontWeight);
    } else {
        return ABI39_0_0RNSVGAbsoluteFontWeights[fontWeight];
    }
}

int ABI39_0_0bolder(int inherited) {
    if (inherited < 350) {
        return 400;
...
int ABI39_0_0lighter(int inherited) {
    if (inherited < 100) {
        return inherited;
    } else if (inherited < 550) {
        return 100;
...
+ (instancetype)initWithNSDictionary:(NSDictionary *)font
    ...
    ABI39_0_0RNSVGFontData *data = [ABI39_0_0RNSVGFontData alloc];
    ...
    if ([font objectForKey:FONT_SIZE]) {
        ...
        if ([fontSize isKindOfClass:NSNumber.class]) {
            ...
            data->fontSize = [ABI39_0_0RNSVGPropHelper fromRelativeWithNSString:fontSize
    ...
    if ([font objectForKey:FONT_WEIGHT]) {
        ...
        if ([fontWeight isKindOfClass:NSNumber.class]) {
            ...
            NSInteger fw = ABI39_0_0RNSVGFontWeightFromString(weight);
            if (fw != -1) {
                data->absoluteFontWeight = ABI39_0_0AbsoluteFontWeight(fw, parent);
                data->fontWeight = ABI39_0_0nearestFontWeight(data->absoluteFontWeight);
    ...
    data->fontStyle = style ? ABI39_0_0RNSVGFontStyleFromString(style) : parent->fontStyle;
    ...
    data->fontVariantLigatures = variant ? ABI39_0_0RNSVGFontVariantLigaturesFromString(variant) : parent->fontVariantLigatures;
    NSString* anchor = [font objectForKey:TEXT_ANCHOR];
    data->textAnchor = anchor ? ABI39_0_0RNSVGTextAnchorFromString(anchor) : parent->textAnchor;
    NSString* decoration = [font objectForKey:TEXT_DECORATION];
    data->textDecoration = decoration ? ABI39_0_0RNSVGTextDecorationFromString(decoration) : parent->textDecoration;
    ...
    if ([kerning isKindOfClass:NSNumber.class]) {
        ...
        [ABI39_0_0RNSVGFontData toAbsoluteWithNSString:kerning
                                     fontSize:fontSize]
        : parent->kerning;
    }
    ...
    if ([wordSpacing isKindOfClass:NSNumber.class]) {
        ...
        [ABI39_0_0RNSVGFontData toAbsoluteWithNSString:wordSpacing
                                     fontSize:fontSize]
        : parent->wordSpacing;
    }
    ...
    if ([letterSpacing isKindOfClass:NSNumber.class]) {
        ...
        [ABI39_0_0RNSVGFontData toAbsoluteWithNSString:letterSpacing
                                     fontSize:fontSize]
