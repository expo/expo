...
@implementation ABI39_0_0RNSVGForeignObject
...
- (void)renderGroupTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    [self traverseSubviews:^(UIView *node) {
        if ([node isKindOfClass:[ABI39_0_0RNSVGMask class]] || [node isKindOfClass:[ABI39_0_0RNSVGClipPath class]]) {
            // no-op
        } else if ([node isKindOfClass:[ABI39_0_0RNSVGNode class]]) {
            ABI39_0_0RNSVGNode* svgNode = (ABI39_0_0RNSVGNode*)node;
            ...
            if ([node isKindOfClass:[ABI39_0_0RNSVGRenderable class]]) {
                [(ABI39_0_0RNSVGRenderable*)node mergeProperties:self];
            }
            ...
            if ([node isKindOfClass:[ABI39_0_0RNSVGRenderable class]]) {
                [(ABI39_0_0RNSVGRenderable*)node resetProperties];
            }
        } else if ([node isKindOfClass:[ABI39_0_0RNSVGSvgView class]]) {
            ABI39_0_0RNSVGSvgView* svgView = (ABI39_0_0RNSVGSvgView*)node;
...
- (void)setForeignObjectwidth:(ABI39_0_0RNSVGLength *)foreignObjectwidth
{
...
- (void)setForeignObjectheight:(ABI39_0_0RNSVGLength *)foreignObjectheight
{
