...
#if __has_include(<ABI39_0_0React/ABI39_0_0UIView+React.h>)
...
@implementation ABI39_0_0EXContainerView {
...
- (void)ABI39_0_0ReactSetFrame:(CGRect)frame
{
  ...
  if (_animationView != nil) {
    [_animationView ABI39_0_0ReactSetFrame:frame];
  }
}
...
- (void)replaceAnimationView:(LOTAnimationView *)next {
  ...
  [_animationView ABI39_0_0ReactSetFrame:self.frame];
