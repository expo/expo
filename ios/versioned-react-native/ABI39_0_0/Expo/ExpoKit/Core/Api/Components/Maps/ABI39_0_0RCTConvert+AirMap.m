...
@implementation ABI39_0_0RCTConvert (AirMap)
...
{
    json = [self NSDictionary:json];
    return [ABI39_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:nil];
}
...
ABI39_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI39_0_0AIRMapCoordinate *)ABI39_0_0AIRMapCoordinate:(id)json
{
    ABI39_0_0AIRMapCoordinate *coord = [ABI39_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI39_0_0RCT_ARRAY_CONVERTER(ABI39_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI39_0_0AIRMapCoordinate *> *> *)ABI39_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI39_0_0RCTConvertArrayValue(@selector(ABI39_0_0AIRMapCoordinateArray:), json);
}
