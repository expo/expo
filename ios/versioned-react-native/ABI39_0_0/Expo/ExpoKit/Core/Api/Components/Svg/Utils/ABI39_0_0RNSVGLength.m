...
@implementation ABI39_0_0RNSVGLength
...
{
    ABI39_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype) lengthWithString: (NSString *) lengthString {
    ...
    ABI39_0_0RNSVGLength *output = [ABI39_0_0RNSVGLength alloc];
    if (stringLength == 0) {
        ...
        ABI39_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
