//
//  ABI39_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI39_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI39_0_0WMSTileOverlay *tile = [[ABI39_0_0WMSTileOverlay alloc] init];
...
@implementation ABI39_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
