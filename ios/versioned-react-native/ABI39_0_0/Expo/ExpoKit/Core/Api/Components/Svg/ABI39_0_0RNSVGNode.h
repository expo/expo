...
/**
 * ABI39_0_0RNSVG nodes are implemented as base UIViews. They should be implementation for all basic
 ＊interfaces for all non-definition nodes.
 */

@interface ABI39_0_0RNSVGNode : UIView
 ...
 */
extern CGFloat const ABI39_0_0RNSVG_M_SQRT1_2l;
extern CGFloat const ABI39_0_0RNSVG_DEFAULT_FONT_SIZE;

@property (nonatomic, strong) NSString *name;
@property (nonatomic, strong) NSString *display;
@property (nonatomic, assign) CGFloat opacity;
@property (nonatomic, assign) ABI39_0_0RNSVGCGFCRule clipRule;
 ...
 */
@property (nonatomic, assign) ABI39_0_0RCTPointerEvents pointerEvents;
...
/**
 * ABI39_0_0RNSVGSvgView which ownes current ABI39_0_0RNSVGNode
 */
@property (nonatomic, readonly, weak) ABI39_0_0RNSVGSvgView *svgView;
@property (nonatomic, readonly, weak) ABI39_0_0RNSVGGroup *textRoot;

- (void)invalidate;

- (ABI39_0_0RNSVGGroup *)getParentTextRoot;
...
- (CGFloat)relativeOn:(ABI39_0_0RNSVGLength *)length relative:(CGFloat)relative;

- (CGFloat)relativeOnWidth:(ABI39_0_0RNSVGLength *)length;

- (CGFloat)relativeOnHeight:(ABI39_0_0RNSVGLength *)length;

- (CGFloat)relativeOnOther:(ABI39_0_0RNSVGLength *)length;
