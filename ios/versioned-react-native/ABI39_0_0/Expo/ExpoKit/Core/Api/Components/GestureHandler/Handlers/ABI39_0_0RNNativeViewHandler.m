//
//  ABI39_0_0RNNativeViewHandler.m
...
#pragma mark ABI39_0_0RNDummyGestureRecognizer

@implementation ABI39_0_0RNDummyGestureRecognizer
...
#pragma mark ABI39_0_0RNNativeViewgestureHandler

@implementation ABI39_0_0RNNativeViewGestureHandler {
...
- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI39_0_0RNDummyGestureRecognizer alloc] init];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    _shouldActivateOnStart = [ABI39_0_0RCTConvert BOOL:config[@"shouldActivateOnStart"]];
    _disallowInterruption = [ABI39_0_0RCTConvert BOOL:config[@"disallowInterruption"]];
}
...
- (void)bindToView:(UIView *)view
{
    ...
    if ([view isKindOfClass:[ABI39_0_0RCTScrollView class]]) {
        // This part of the code is coupled with ABI39_0_0RN implementation of ScrollView native wrapper and
        // we expect for ABI39_0_0RCTScrollView component to contain a subclass of UIScrollview as the only
        // subview
...
- (void)handleTouchDown:(UIView *)sender forEvent:(UIEvent *)event
{
    ...
    [self sendEventsInState:ABI39_0_0RNGestureHandlerStateActive
             forViewWithTag:sender.ABI39_0_0ReactTag
              withExtraData:[ABI39_0_0RNGestureHandlerEventExtraData forPointerInside:YES]];
}

- (void)handleTouchUpOutside:(UIView *)sender forEvent:(UIEvent *)event
{
    [self sendEventsInState:ABI39_0_0RNGestureHandlerStateEnd
             forViewWithTag:sender.ABI39_0_0ReactTag
              withExtraData:[ABI39_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
...
{
    [self sendEventsInState:ABI39_0_0RNGestureHandlerStateCancelled
             forViewWithTag:sender.ABI39_0_0ReactTag
              withExtraData:[ABI39_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
