...
@interface ABI39_0_0RNBetterPanGestureRecognizer : UIPanGestureRecognizer
...
@implementation ABI39_0_0RNBetterPanGestureRecognizer {
...
@implementation ABI39_0_0RNPanGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI39_0_0RNBetterPanGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI39_0_0RNBetterPanGestureRecognizer *recognizer = (ABI39_0_0RNBetterPanGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    CGFloat velocity = [ABI39_0_0RCTConvert CGFloat:prop];
    recognizer.minVelocitySq = velocity * velocity;
  }
  [recognizer updateHasCustomActivationCriteria];
}

- (ABI39_0_0RNGestureHandlerEventExtraData *)eventExtraData:(UIPanGestureRecognizer *)recognizer
{
