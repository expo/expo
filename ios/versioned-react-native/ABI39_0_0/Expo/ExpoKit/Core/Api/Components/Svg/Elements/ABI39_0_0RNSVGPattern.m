...
@implementation ABI39_0_0RNSVGPattern
...
{
    self.dirty = false;
    NSArray<ABI39_0_0RNSVGLength *> *points = @[self.x, self.y, self.patternwidth, self.patternheight];
    ABI39_0_0RNSVGPainter *painter = [[ABI39_0_0RNSVGPainter alloc] initWithPointsArray:points];
...
- (void)setPatternwidth:(ABI39_0_0RNSVGLength *)patternwidth
{
...
- (void)setPatternheight:(ABI39_0_0RNSVGLength *)patternheight
{
...
- (void)setPatternUnits:(ABI39_0_0RNSVGUnits)patternUnits
{
...
- (void)setPatternContentUnits:(ABI39_0_0RNSVGUnits)patternContentUnits
{
