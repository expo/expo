//
//  ABI39_0_0RCTConvert+GMSMapViewType.m
//
...
@implementation ABI39_0_0RCTConvert (GMSMapViewType)
  ABI39_0_0RCT_ENUM_CONVERTER(GMSMapViewType,
  (
    @{
...
+ (GMSCameraPosition*)GMSCameraPosition:(id)json
{
    ...
    return [ABI39_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:nil];
}
