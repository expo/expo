...
@interface ABI39_0_0ReactNativePageView () <UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate>

@property(nonatomic, strong) UIPageViewController *ABI39_0_0ReactPageViewController;
@property(nonatomic, strong) UIPageControl *ABI39_0_0ReactPageIndicatorView;
@property(nonatomic, strong) ABI39_0_0RCTEventDispatcher *eventDispatcher;
...
@implementation ABI39_0_0ReactNativePageView {
...
- (void)layoutSubviews {
    ...
    if (self.ABI39_0_0ReactPageViewController) {
...
- (void)embed {
    ...
    self.ABI39_0_0ReactPageViewController = pageViewController;
        
    UIPageControl *pageIndicatorView = [self createPageIndicator];
    
    pageIndicatorView.numberOfPages = self.ABI39_0_0ReactSubviews.count;
    pageIndicatorView.currentPage = self.initialPage;
    pageIndicatorView.hidden = !self.showPageIndicator;
    
    self.ABI39_0_0ReactPageIndicatorView = pageIndicatorView;
    
    [self ABI39_0_0ReactAddControllerToClosestParent:pageViewController];
...
- (void)shouldScroll:(BOOL)scrollEnabled {
    ...
    if (self.ABI39_0_0ReactPageViewController.view) {
...
- (void)setupInitialController {
    UIView *initialView = self.ABI39_0_0ReactSubviews[self.initialPage];
    if (initialView) {
        ...
        [self setABI39_0_0ReactViewControllers:self.initialPage
...
- (void)setABI39_0_0ReactViewControllers:(NSInteger)index
                           with:(UIViewController *)controller
                      direction:(UIPageViewControllerNavigationDirection)direction
                       animated:(BOOL)animated {
    __weak ABI39_0_0ReactNativePageView *weakSelf = self;
    uint16_t coalescingKey = _coalescingKey++;
    
    [self.ABI39_0_0ReactPageViewController setViewControllers:@[controller]
                                           direction:direction
                                            animated:animated
        ...
        if (weakSelf.eventDispatcher) {
            [weakSelf.eventDispatcher sendEvent:[[ABI39_0_0RCTOnPageSelected alloc] initWithABI39_0_0ReactTag:weakSelf.ABI39_0_0ReactTag position:@(index) coalescingKey:coalescingKey]];
        }
...
- (UIViewController *)currentlyDisplayed {
    return self.ABI39_0_0ReactPageViewController.viewControllers.firstObject;
}

- (UIViewController *)findCachedControllerForView:(UIView *)view {
    for (UIViewController *controller in self.cachedControllers) {
        if (controller.view.ABI39_0_0ReactTag == view.ABI39_0_0ReactTag) {
            return controller;
        }
    }
    return nil;
...
- (void)updateDataSource {
    ...
    NSInteger newIndex = [self.ABI39_0_0ReactSubviews indexOfObject:self.currentView];
...
- (void)goTo:(NSInteger)index animated:(BOOL)animated {
    NSInteger numberOfPages = self.ABI39_0_0ReactSubviews.count;
    ...
    UIView *viewToDisplay = self.ABI39_0_0ReactSubviews[indexToDisplay];
    UIViewController *controllerToDisplay = [self findAndCacheControllerForView:viewToDisplay];

    self.ABI39_0_0ReactPageIndicatorView.numberOfPages = numberOfPages;
    self.ABI39_0_0ReactPageIndicatorView.currentPage = indexToDisplay;
        
    [self setABI39_0_0ReactViewControllers:indexToDisplay
...
- (UIViewController *)findAndCacheControllerForView:(UIView *)viewToDisplay {
    ...
    if (!controllerToDisplay && current.view.ABI39_0_0ReactTag == viewToDisplay.ABI39_0_0ReactTag) {
...
- (UIViewController *)nextControllerForController:(UIViewController *)controller
    ...
    NSUInteger numberOfPages = self.ABI39_0_0ReactSubviews.count;
    NSInteger index = [self.ABI39_0_0ReactSubviews indexOfObject:controller.view];
    ...
    UIView *viewToDisplay = self.ABI39_0_0ReactSubviews[index];
...
- (void)pageViewController:(UIPageViewController *)pageViewController
   ...
   previousViewControllers:(nonnull NSArray<UIViewController *> *)previousViewControllers
    ...
    if (completed) {
        ...
        NSUInteger currentIndex = [self.ABI39_0_0ReactSubviews indexOfObject:currentVC.view];
        
        self.currentIndex = currentIndex;
        
        self.currentView = currentVC.view;
        self.ABI39_0_0ReactPageIndicatorView.currentPage = currentIndex;
        
        [self.eventDispatcher sendEvent:[[ABI39_0_0RCTOnPageSelected alloc] initWithABI39_0_0ReactTag:self.ABI39_0_0ReactTag position:@(currentIndex) coalescingKey:_coalescingKey++]];
        [self.eventDispatcher sendEvent:[[ABI39_0_0RCTOnPageScrollEvent alloc] initWithABI39_0_0ReactTag:self.ABI39_0_0ReactTag position:@(currentIndex) offset:@(0.0)]];
    }
}
...
- (void)shouldShowPageIndicator:(BOOL)showPageIndicator {
    ...
    if (self.ABI39_0_0ReactPageIndicatorView) {
        self.ABI39_0_0ReactPageIndicatorView.hidden = !showPageIndicator;
    }
}
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView {
    [self.eventDispatcher sendEvent:[[ABI39_0_0RCTOnPageScrollStateChanged alloc] initWithABI39_0_0ReactTag:self.ABI39_0_0ReactTag state:@"dragging" coalescingKey:_coalescingKey++]];
}

- (void)scrollViewWillEndDragging:(UIScrollView *)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(inout CGPoint *)targetContentOffset {
    [self.eventDispatcher sendEvent:[[ABI39_0_0RCTOnPageScrollStateChanged alloc] initWithABI39_0_0ReactTag:self.ABI39_0_0ReactTag state:@"settling" coalescingKey:_coalescingKey++]];
}

- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    [self.eventDispatcher sendEvent:[[ABI39_0_0RCTOnPageScrollStateChanged alloc] initWithABI39_0_0ReactTag:self.ABI39_0_0ReactTag state:@"idle" coalescingKey:_coalescingKey++]];
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    [self.eventDispatcher sendEvent:[[ABI39_0_0RCTOnPageScrollEvent alloc] initWithABI39_0_0ReactTag:self.ABI39_0_0ReactTag position:@(self.currentIndex) offset:@(offset)]];
}
