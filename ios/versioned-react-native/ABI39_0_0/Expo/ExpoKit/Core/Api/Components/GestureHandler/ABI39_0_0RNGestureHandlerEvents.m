...
@implementation ABI39_0_0RNGestureHandlerEventExtraData
...
{
    return [[ABI39_0_0RNGestureHandlerEventExtraData alloc]
            initWithData:@{
                           @"x": @(position.x),
                           @"y": @(position.y),
...
@implementation ABI39_0_0RNGestureHandlerEvent
{
    NSNumber *_handlerTag;
    ABI39_0_0RNGestureHandlerState _state;
    ABI39_0_0RNGestureHandlerEventExtraData *_extraData;
}
...
@implementation ABI39_0_0RNGestureHandlerStateChange
{
    NSNumber *_handlerTag;
    ABI39_0_0RNGestureHandlerState _state;
    ABI39_0_0RNGestureHandlerState _prevState;
    ABI39_0_0RNGestureHandlerEventExtraData *_extraData;
}
