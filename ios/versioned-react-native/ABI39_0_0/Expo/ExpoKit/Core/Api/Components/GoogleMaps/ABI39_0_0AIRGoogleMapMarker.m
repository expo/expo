...
@interface ABI39_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI39_0_0AIRGMSMarker*)marker;
@end

@implementation ABI39_0_0AIRGoogleMapMarker {
  ABI39_0_0RCTImageLoaderCancellationBlock _reloadImageCancellationBlock;
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI39_0_0AIRGMSMarker alloc] init];
...
- (void)insertABI39_0_0ReactSubview:(id<ABI39_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI39_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI39_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI39_0_0AIRDummyView *dummySubview = [[ABI39_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertABI39_0_0ReactSubview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeABI39_0_0ReactSubview:(id<ABI39_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI39_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeABI39_0_0ReactSubview:(UIView*)dummySubview];
}
...
- (void)didTapInfoWindowOfMarker:(ABI39_0_0AIRGMSMarker *)marker point:(CGPoint)point frame:(CGRect)frame {
...
- (void)didTapInfoWindowOfMarker:(ABI39_0_0AIRGMSMarker *)marker {
    [self didTapInfoWindowOfMarker:marker point:CGPointMake(-1, -1) frame:CGRectZero];
}

- (void)didTapInfoWindowOfMarker:(ABI39_0_0AIRGMSMarker *)marker subview:(ABI39_0_0AIRGoogleMapCalloutSubview*)subview point:(CGPoint)point frame:(CGRect)frame {
...
- (void)didBeginDraggingMarker:(ABI39_0_0AIRGMSMarker *)marker {
  if (!self.onDragStart) return;
  self.onDragStart([self eventFromMarker:marker]);
}

- (void)didEndDraggingMarker:(ABI39_0_0AIRGMSMarker *)marker {
  if (!self.onDragEnd) return;
  self.onDragEnd([self eventFromMarker:marker]);
}

- (void)didDragMarker:(ABI39_0_0AIRGMSMarker *)marker {
...
- (void)setOnPress:(ABI39_0_0RCTBubblingEventBlock)onPress {
  _realMarker.onPress = onPress;
}

- (ABI39_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/ABI39_0_0React-native-community/ABI39_0_0React-native-maps/issues/738)
  ...
  _reloadImageCancellationBlock = [[_bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI39_0_0RCTConvert NSURLRequest:_imageSrc]
                                                                          size:self.bounds.size
                                                                         scale:ABI39_0_0RCTScreenScale()
                                                                       clipped:YES
                                                                    resizeMode:ABI39_0_0RCTResizeModeCenter
                                                                 progressBlock:nil
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI39_0_0RN?
...
- (void)setIconSrc:(NSString *)iconSrc
{
  ...
  _reloadImageCancellationBlock =
  [[_bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI39_0_0RCTConvert NSURLRequest:_iconSrc]
                                          size:self.bounds.size
                                         scale:ABI39_0_0RCTScreenScale()
                                       clipped:YES
                                    resizeMode:ABI39_0_0RCTResizeModeCenter
