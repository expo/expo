//
//  ABI39_0_0AIRGoogleMapWMSTile.h
//  AirMaps
//
...
@interface ABI39_0_0WMSTileOverlay : GMSSyncTileLayer
...
@interface ABI39_0_0AIRGoogleMapWMSTile : UIView
@property (nonatomic, strong) ABI39_0_0WMSTileOverlay *tileLayer;
