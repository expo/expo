...
@implementation ABI39_0_0RNSVGContextBrush
{
    BOOL _isStroke;
}
...
{
    ABI39_0_0RNSVGRenderable *element = ABI39_0_0RNSVGRenderable.contextElement;
    if (!element) {
        return NO;
    }

    ABI39_0_0RNSVGBrush *brush = _isStroke ? element.stroke : element.fill;

    BOOL fillColor;

    if (brush.class == ABI39_0_0RNSVGBrush.class) {
