...
@interface ABI39_0_0RNCNetInfo () <ABI39_0_0RNCConnectionStateWatcherDelegate>

@property (nonatomic, strong) ABI39_0_0RNCConnectionStateWatcher *connectionStateWatcher;
@property (nonatomic) BOOL isObserving;

@end

@implementation ABI39_0_0RNCNetInfo

#pragma mark - Module setup

ABI39_0_0RCT_EXPORT_MODULE()

// We need ABI39_0_0RNCReachabilityCallback's and module methods to be called on the same thread so that we can have
...
- (instancetype)init
{
  self = [super init];
  if (self) {
    _connectionStateWatcher = [[ABI39_0_0RNCConnectionStateWatcher alloc] initWithDelegate:self];
  }
  return self;
}
...
#pragma mark - ABI39_0_0RNCConnectionStateWatcherDelegate
...
ABI39_0_0RCT_EXPORT_METHOD(getCurrentState:(nullable NSString *)requestedInterface resolve:(ABI39_0_0RCTPromiseResolveBlock)resolve
                  reject:(__unused ABI39_0_0RCTPromiseRejectBlock)reject)
{
  ABI39_0_0RNCConnectionState *state = [self.connectionStateWatcher currentState];
...
- (NSDictionary *)currentDictionaryFromUpdateState:(ABI39_0_0RNCConnectionState *)state withInterface:(nullable NSString *)requestedInterface
{
...
- (NSMutableDictionary *)detailsFromInterface:(nonnull NSString *)requestedInterface withState:(ABI39_0_0RNCConnectionState *)state
{
  NSMutableDictionary *details = [NSMutableDictionary new];
  if ([requestedInterface isEqualToString: ABI39_0_0RNCConnectionTypeCellular]) {
    details[@"cellularGeneration"] = state.cellularGeneration ?: NSNull.null;
    details[@"carrier"] = [self carrier] ?: NSNull.null;
  } else if ([requestedInterface isEqualToString: ABI39_0_0RNCConnectionTypeWifi] || [requestedInterface isEqualToString: ABI39_0_0RNCConnectionTypeEthernet]) {
