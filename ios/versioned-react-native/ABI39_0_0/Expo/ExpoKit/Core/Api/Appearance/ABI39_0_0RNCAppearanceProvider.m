...
@interface ABI39_0_0RNCAppearanceProvider ()

@property (nonatomic, weak) ABI39_0_0RCTBridge *bridge;

@end

@implementation ABI39_0_0RNCAppearanceProvider

- (instancetype)initWithBridge:(nonnull ABI39_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    _bridge = bridge;
  }
...
- (void)notifyUserInterfaceStyleChanged
{
  ...
  if (self.bridge) {
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ABI39_0_0RNCUserInterfaceStyleDidChangeNotification"
                                                        object:self.bridge
