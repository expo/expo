...
#include "ABI39_0_0SpeedChecker.h"
#include "ABI39_0_0ShareableValue.h"
#include "ABI39_0_0MapperRegistry.h"
#include "ABI39_0_0Mapper.h"
#include "ABI39_0_0RuntimeDecorator.h"
#include "ABI39_0_0EventHandlerRegistry.h"
...
NativeReanimatedModule::NativeReanimatedModule(std::shared_ptr<CallInvoker> jsInvoker,
                                               ...
                                               PlatformDepMethodsHolder platformDepMethodsHolder) : ABI39_0_0NativeReanimatedModuleSpec(jsInvoker),
                                                  runtime(std::move(rt)),
