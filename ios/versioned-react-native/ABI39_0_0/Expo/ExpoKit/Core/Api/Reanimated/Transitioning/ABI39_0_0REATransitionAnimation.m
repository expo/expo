...
CGFloat ABI39_0_0SimAnimationDragCoefficient()
{
#if TARGET_IPHONE_SIMULATOR
...
@implementation ABI39_0_0REATransitionAnimation {
...
{
  ABI39_0_0REATransitionAnimation *anim = [ABI39_0_0REATransitionAnimation new];
...
- (void)play
{
  ...
  */
  if (_delay > 0){
    _animation.beginTime = CACurrentMediaTime() + _delay * ABI39_0_0SimAnimationDragCoefficient();
  }
  _animation.duration = self.duration * ABI39_0_0SimAnimationDragCoefficient();
