#include "ABI39_0_0NativeReanimatedModuleSpec.h"
...
static jsi::Value __hostFunction_NativeReanimatedModuleSpec_installCoreFunctions(
    ...
    size_t count) {
  static_cast<ABI39_0_0NativeReanimatedModuleSpec *>(&turboModule)
...
static jsi::Value __hostFunction_NativeReanimatedModuleSpec_makeShareable(
    ...
    const jsi::Value *args,
    size_t count) {
  return static_cast<ABI39_0_0NativeReanimatedModuleSpec *>(&turboModule)
...
ABI39_0_0NativeReanimatedModuleSpec::ABI39_0_0NativeReanimatedModuleSpec(std::shared_ptr<CallInvoker> jsInvoker)
