...
// same functionality in ABI39_0_0EXWKSnapshotPDFRenderer. This renderer should only be used in iOS < 11.

// This renderer mounts given web view in view hierarchy outside of visible area.

@interface ABI39_0_0EXWKViewPDFRenderer : NSObject <ABI39_0_0EXPDFRenderer>
