...
#import <ABI39_0_0EXPrint/ABI39_0_0EXPrint.h>
#import <ABI39_0_0EXPrint/ABI39_0_0EXWKPDFRenderer.h>
...
NSString *const ABI39_0_0EXPrintOrientationPortrait = @"portrait";
NSString *const ABI39_0_0EXPrintOrientationLandscape = @"landscape";

@interface ABI39_0_0EXPrint () <UIPrintInteractionControllerDelegate, UIPrinterPickerControllerDelegate>
...
@implementation ABI39_0_0EXPrint

ABI39_0_0UM_EXPORT_MODULE(ExponentPrint);
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"Orientation": @{
               @"portrait": ABI39_0_0EXPrintOrientationPortrait,
               @"landscape": ABI39_0_0EXPrintOrientationLandscape,
               },
           };
}

ABI39_0_0UM_EXPORT_METHOD_AS(print,
                    ...
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  [self _getPrintingDataForOptions:options callback:^(NSData *printingData, NSDictionary *errorDetails) {
    if (errorDetails != nil) {
      reject(errorDetails[@"code"], errorDetails[@"message"], ABI39_0_0UMErrorWithMessage(errorDetails[@"message"]));
      return;
    }
    ...
    if (printingData == nil) {
      ...
      if (options[@"markupFormatterIOS"] && [options[@"markupFormatterIOS"] isKindOfClass:[NSString class]]) {
        ...
        if (htmlString != nil) {
          ...
          reject(@"E_HTML_INVALID", message, ABI39_0_0UMErrorWithMessage(message));
          return;
        }
      } else {
...
ABI39_0_0UM_EXPORT_METHOD_AS(selectPrinter,selectPrinter:(ABI39_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
...
ABI39_0_0UM_EXPORT_METHOD_AS(printToFileAsync,
                    ...
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI39_0_0EXWKPDFRenderer *renderTask = [ABI39_0_0EXWKPDFRenderer new];
...
{
  id<ABI39_0_0UMUtilitiesInterface> utils = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI39_0_0UMUtilitiesInterface)];
...
{
  if ([orientation isEqualToString:ABI39_0_0EXPrintOrientationLandscape]) {
