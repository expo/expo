...
#import <ABI39_0_0EXLocation/ABI39_0_0EXGeofencingTaskConsumer.h>
#import <ABI39_0_0UMTaskManagerInterface/ABI39_0_0UMTaskInterface.h>

@interface ABI39_0_0EXGeofencingTaskConsumer ()
...
@implementation ABI39_0_0EXGeofencingTaskConsumer
...
- (void)startMonitoringRegionsForTask:(id<ABI39_0_0UMTaskInterface>)task
{
  [ABI39_0_0UMUtilities performSynchronouslyOnMainThread:^{
...
- (void)executeTaskWithRegion:(nonnull CLRegion *)region eventType:(ABI39_0_0EXGeofencingEventType)eventType
{
...
- (void)locationManager:(CLLocationManager *)manager didEnterRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != CLRegionStateInside) {
    ...
    [self executeTaskWithRegion:region eventType:ABI39_0_0EXGeofencingEventTypeEnter];
  }
}
...
- (void)locationManager:(CLLocationManager *)manager didExitRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != CLRegionStateOutside) {
    ...
    [self executeTaskWithRegion:region eventType:ABI39_0_0EXGeofencingEventTypeExit];
  }
}
...
- (void)locationManager:(CLLocationManager *)manager didDetermineState:(CLRegionState)state forRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != state) {
    ABI39_0_0EXGeofencingEventType eventType = state == CLRegionStateInside ? ABI39_0_0EXGeofencingEventTypeEnter : ABI39_0_0EXGeofencingEventTypeExit;
...
+ (ABI39_0_0EXGeofencingRegionState)exportRegionState:(CLRegionState)regionState
{
  switch (regionState) {
    case CLRegionStateUnknown:
      return ABI39_0_0EXGeofencingRegionStateUnknown;
    case CLRegionStateInside:
      return ABI39_0_0EXGeofencingRegionStateInside;
    case CLRegionStateOutside:
      return ABI39_0_0EXGeofencingRegionStateOutside;
  }
}
