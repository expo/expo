...
#import <ABI39_0_0EXLocation/ABI39_0_0EXLocation.h>
#import <ABI39_0_0EXLocation/ABI39_0_0EXLocationTaskConsumer.h>
#import <ABI39_0_0UMTaskManagerInterface/ABI39_0_0UMTaskInterface.h>

@interface ABI39_0_0EXLocationTaskConsumer ()
...
@implementation ABI39_0_0EXLocationTaskConsumer
...
# pragma mark - ABI39_0_0UMTaskConsumerInterface
...
- (void)didRegisterTask:(id<ABI39_0_0UMTaskInterface>)task
{
...
- (void)setOptions:(NSDictionary *)options
{
  [ABI39_0_0UMUtilities performSynchronouslyOnMainThread:^{
    ...
    ABI39_0_0EXLocationAccuracy accuracy = [options[@"accuracy"] unsignedIntegerValue] ?: ABI39_0_0EXLocationAccuracyBalanced;

    locationManager.desiredAccuracy = [ABI39_0_0EXLocation CLLocationAccuracyFromOption:accuracy];
    locationManager.distanceFilter = [options[@"distanceInterval"] doubleValue] ?: kCLDistanceFilterNone;
    locationManager.activityType = [ABI39_0_0EXLocation CLActivityTypeFromOption:[options[@"activityType"] integerValue]];
...
- (void)executeTaskWithDeferredLocations
{
  ...
  NSDictionary *data = @{ @"locations": [ABI39_0_0EXLocationTaskConsumer _exportLocations:_deferredLocations] };
...
+ (NSArray<NSDictionary *> *)_exportLocations:(NSArray<CLLocation *> *)locations
{
  ...
  for (CLLocation *location in locations) {
    [result addObject:[ABI39_0_0EXLocation exportLocation:location]];
  }
  return result;
}
