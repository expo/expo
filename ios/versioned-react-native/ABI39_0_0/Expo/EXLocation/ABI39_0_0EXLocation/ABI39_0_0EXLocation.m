...
NSString * const ABI39_0_0EXLocationChangedEventName = @"Expo.locationChanged";
NSString * const ABI39_0_0EXHeadingChangedEventName = @"Expo.headingChanged";

@interface ABI39_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI39_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) NSMutableSet<ABI39_0_0EXLocationDelegate *> *retainedDelegates;
...
@property (nonatomic, weak) id<ABI39_0_0UMTaskManagerInterface> tasksManager;

@end

@implementation ABI39_0_0EXLocation

ABI39_0_0UM_EXPORT_MODULE(ExpoLocation);
...
- (void)setModuleRegistry:(ABI39_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  [ABI39_0_0UMPermissionsMethodsDelegate registerRequesters:@[[ABI39_0_0EXLocationPermissionRequester new]] withPermissionsManager:_permissionsManager];
  _tasksManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI39_0_0UMTaskManagerInterface)];
}
...
{
  return @[ABI39_0_0EXLocationChangedEventName, ABI39_0_0EXHeadingChangedEventName];
}
...
ABI39_0_0UM_EXPORT_METHOD_AS(getProviderStatusAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(getCurrentPositionAsync,
                    ...
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI39_0_0EXLocationDelegate *delegate;

  delegate = [[ABI39_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (delegate != nil) {
      if (locations.lastObject != nil) {
        resolve([ABI39_0_0EXLocation exportLocation:locations.lastObject]);
      } else {
...
ABI39_0_0UM_EXPORT_METHOD_AS(watchPositionImplAsync,
                    ...
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  ABI39_0_0EXLocationDelegate *delegate = [[ABI39_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject != nil && weakSelf != nil) {
      ...
      NSDictionary *body = @{
                             @"watchId": watchId,
                             @"location": [ABI39_0_0EXLocation exportLocation:loc],
                             };

      [strongSelf->_eventEmitter sendEventWithName:ABI39_0_0EXLocationChangedEventName body:body];
    }
  } onUpdateHeadings:nil onError:^(NSError *error) {
    // TODO: report errors
...
ABI39_0_0UM_EXPORT_METHOD_AS(getLastKnownPositionAsync,
                    ...
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  if ([self.class isLocation:location validWithOptions:options]) {
    resolve([ABI39_0_0EXLocation exportLocation:location]);
  } else {
    resolve([NSNull null]);
  }
}
...
ABI39_0_0UM_EXPORT_METHOD_AS(watchDeviceHeading,
                    watchHeadingWithWatchId:(nonnull NSNumber *)watchId
                    resolve:(ABI39_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject) {
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI39_0_0EXLocationPermissionRequester class]]) {
  ...
  ABI39_0_0EXLocationDelegate *delegate = [[ABI39_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
    if (newHeading != nil && weakSelf != nil) {
      ...
      [strongSelf->_eventEmitter sendEventWithName:ABI39_0_0EXHeadingChangedEventName body:body];
    }
...
ABI39_0_0UM_EXPORT_METHOD_AS(removeWatchAsync,
                    watchId:(nonnull NSNumber *)watchId
                    resolver:(ABI39_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ABI39_0_0EXLocationDelegate *delegate = _delegates[watchId];
...
ABI39_0_0UM_EXPORT_METHOD_AS(geocodeAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(reverseGeocodeAsync,
    ...
    if (!error) {
      ...
      for (CLPlacemark* placemark in placemarks) {
        NSDictionary *address = @{
                                  @"city": ABI39_0_0UMNullIfNil(placemark.locality),
                                  @"district": ABI39_0_0UMNullIfNil(placemark.subLocality),
                                  @"street": ABI39_0_0UMNullIfNil(placemark.thoroughfare),
                                  @"region": ABI39_0_0UMNullIfNil(placemark.administrativeArea),
                                  @"subregion": ABI39_0_0UMNullIfNil(placemark.subAdministrativeArea),
                                  @"country": ABI39_0_0UMNullIfNil(placemark.country),
                                  @"postalCode": ABI39_0_0UMNullIfNil(placemark.postalCode),
                                  @"name": ABI39_0_0UMNullIfNil(placemark.name),
                                  @"isoCountryCode": ABI39_0_0UMNullIfNil(placemark.ISOcountryCode),
                                  @"timezone": ABI39_0_0UMNullIfNil(placemark.timeZone.name),
                                  };
                    ...
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  [ABI39_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI39_0_0EXLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
...
ABI39_0_0UM_EXPORT_METHOD_AS(hasServicesEnabledAsync,
                    hasServicesEnabled:(ABI39_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
...
ABI39_0_0UM_EXPORT_METHOD_AS(startLocationUpdatesAsync,
                    ...
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI39_0_0EXLocationTaskConsumer class] options:options];
  }
  @catch (NSException *e) {
...
ABI39_0_0UM_EXPORT_METHOD_AS(stopLocationUpdatesAsync,
                    ...
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI39_0_0EXLocationTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI39_0_0UM_EXPORT_METHOD_AS(hasStartedLocationUpdatesAsync,
                    ...
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI39_0_0EXLocationTaskConsumer class]]));
}

# pragma mark - Geofencing

ABI39_0_0UM_EXPORT_METHOD_AS(startGeofencingAsync,
                    ...
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI39_0_0EXGeofencingTaskConsumer class] options:options];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI39_0_0UM_EXPORT_METHOD_AS(stopGeofencingAsync,
                    ...
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI39_0_0EXGeofencingTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI39_0_0UM_EXPORT_METHOD_AS(hasStartedGeofencingAsync,
                    ...
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI39_0_0EXGeofencingTaskConsumer class]]));
}
...
- (BOOL)checkPermissions:(ABI39_0_0UMPromiseRejectBlock)reject
{
...
- (BOOL)checkTaskManagerExists:(ABI39_0_0UMPromiseRejectBlock)reject
{
...
- (BOOL)checkBackgroundServices:(ABI39_0_0UMPromiseRejectBlock)reject
{
...
{
  switch (accuracy) {
    case ABI39_0_0EXLocationAccuracyLowest:
      return kCLLocationAccuracyThreeKilometers;
    case ABI39_0_0EXLocationAccuracyLow:
      return kCLLocationAccuracyKilometer;
    case ABI39_0_0EXLocationAccuracyBalanced:
      return kCLLocationAccuracyHundredMeters;
    case ABI39_0_0EXLocationAccuracyHigh:
      return kCLLocationAccuracyNearestTenMeters;
    case ABI39_0_0EXLocationAccuracyHighest:
      return kCLLocationAccuracyBest;
    case ABI39_0_0EXLocationAccuracyBestForNavigation:
