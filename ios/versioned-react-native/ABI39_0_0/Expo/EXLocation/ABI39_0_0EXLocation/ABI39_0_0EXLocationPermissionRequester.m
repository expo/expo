...
#import <ABI39_0_0EXLocation/ABI39_0_0EXLocationPermissionRequester.h>
...
@interface ABI39_0_0EXLocationPermissionRequester () <CLLocationManagerDelegate>
...
@implementation ABI39_0_0EXLocationPermissionRequester
...
- (void)requestPermissionsWithResolver:(ABI39_0_0UMPromiseResolveBlock)resolve rejecter:(ABI39_0_0UMPromiseRejectBlock)reject
{
  ...
  if (existingPermissions && [existingPermissions[@"status"] intValue] != ABI39_0_0UMPermissionStatusUndetermined) {
