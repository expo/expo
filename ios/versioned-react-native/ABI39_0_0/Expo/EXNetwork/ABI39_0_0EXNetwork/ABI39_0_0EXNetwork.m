...
#import <ABI39_0_0EXNetwork/ABI39_0_0EXNetwork.h>
...
@implementation ABI39_0_0EXNetwork
...
- (instancetype)init
{
  self = [super init];
  if (self) {
    _type = ABI39_0_0EXNetworkTypeUnknown;
  }
  return self;
}

ABI39_0_0UM_EXPORT_MODULE(ExpoNetwork);
...
ABI39_0_0UM_EXPORT_METHOD_AS(getMacAddressAsync,
...
ABI39_0_0UM_EXPORT_METHOD_AS(getIpAddressAsync,
                    getIpAddressAsyncWithResolver:(ABI39_0_0UMPromiseResolveBlock)resolve rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
...
ABI39_0_0UM_EXPORT_METHOD_AS(getNetworkStateAsync,
                    getNetworkStateAsyncWithResolver:(ABI39_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  if ((flags & kSCNetworkReachabilityFlagsReachable) == 0 ||
    ...
    _type = ABI39_0_0EXNetworkTypeNone;
  }
  
#if !TARGET_OS_TV
  else if ((flags & kSCNetworkReachabilityFlagsIsWWAN) != 0) {
    _type = ABI39_0_0EXNetworkTypeCellular;
  }
#endif
  else {
    _type = ABI39_0_0EXNetworkTypeWifi;
  }
...
- (BOOL)connected
{
  return ![self.type isEqualToString:ABI39_0_0EXNetworkTypeUnknown] && ![self.type isEqualToString:ABI39_0_0EXNetworkTypeNone];
}
