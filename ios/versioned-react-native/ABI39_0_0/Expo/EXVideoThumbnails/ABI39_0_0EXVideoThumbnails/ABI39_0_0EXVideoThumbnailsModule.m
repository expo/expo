...
#import <ABI39_0_0EXVideoThumbnails/ABI39_0_0EXVideoThumbnailsModule.h>
...
@implementation ABI39_0_0EXVideoThumbnailsModule

ABI39_0_0UM_EXPORT_MODULE(ExpoVideoThumbnails);
...
ABI39_0_0UM_EXPORT_METHOD_AS(getThumbnail,
                    ...
                    reject:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  if ([url isFileURL]) {
    ...
    if (!([_fileSystem permissionsForURI:url] & ABI39_0_0UMFileSystemPermissionRead)) {
