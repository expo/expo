...
// Interface for ABI39_0_0UMTaskManager module.

@protocol ABI39_0_0UMTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI39_0_0UMTaskConsumerInterface protocol.
 */
