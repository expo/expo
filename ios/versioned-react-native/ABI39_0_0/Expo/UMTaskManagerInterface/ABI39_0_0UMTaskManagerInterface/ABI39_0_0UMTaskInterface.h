...
@protocol ABI39_0_0UMTaskConsumerInterface;

@protocol ABI39_0_0UMTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI39_0_0UMTaskConsumerInterface> __nonnull consumer;
