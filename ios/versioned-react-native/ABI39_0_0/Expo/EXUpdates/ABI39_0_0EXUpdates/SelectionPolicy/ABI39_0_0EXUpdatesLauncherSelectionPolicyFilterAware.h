...
/**
 * An ABI39_0_0EXUpdatesLauncherSelectionPolicy which chooses an update to launch based on the manifest filters
 ...
 */
@interface ABI39_0_0EXUpdatesLauncherSelectionPolicyFilterAware : NSObject <ABI39_0_0EXUpdatesLauncherSelectionPolicy>
