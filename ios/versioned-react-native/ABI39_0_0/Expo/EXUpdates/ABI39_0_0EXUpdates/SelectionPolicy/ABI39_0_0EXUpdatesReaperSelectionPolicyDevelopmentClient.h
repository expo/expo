...
/**
 * An ABI39_0_0EXUpdatesReaperSelectionPolicy which keeps a predefined maximum number of updates across all scopes,
 ...
 */
@interface ABI39_0_0EXUpdatesReaperSelectionPolicyDevelopmentClient : NSObject <ABI39_0_0EXUpdatesReaperSelectionPolicy>
