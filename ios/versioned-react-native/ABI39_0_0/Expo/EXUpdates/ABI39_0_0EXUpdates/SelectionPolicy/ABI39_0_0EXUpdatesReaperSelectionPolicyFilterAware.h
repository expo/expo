...
/**
 * An ABI39_0_0EXUpdatesReaperSelectionPolicy which chooses which updates to delete taking into account manifest filters
 ...
 */
@interface ABI39_0_0EXUpdatesReaperSelectionPolicyFilterAware : NSObject <ABI39_0_0EXUpdatesReaperSelectionPolicy>
