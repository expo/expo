...
@implementation ABI39_0_0EXUpdatesReaperSelectionPolicyFilterAware
...
- (NSArray<ABI39_0_0EXUpdatesUpdate *> *)updatesToDeleteWithLaunchedUpdate:(ABI39_0_0EXUpdatesUpdate *)launchedUpdate updates:(NSArray<ABI39_0_0EXUpdatesUpdate *> *)updates filters:(nullable NSDictionary *)filters
{
  ...
  ABI39_0_0EXUpdatesUpdate *nextNewestUpdate;
  ABI39_0_0EXUpdatesUpdate *nextNewestUpdateMatchingFilters;
  for (ABI39_0_0EXUpdatesUpdate *update in updates) {
    ...
    if ([launchedUpdate.commitTime compare:update.commitTime] == NSOrderedDescending) {
      ...
      if ([ABI39_0_0EXUpdatesSelectionPolicies doesUpdate:update matchFilters:filters] &&
