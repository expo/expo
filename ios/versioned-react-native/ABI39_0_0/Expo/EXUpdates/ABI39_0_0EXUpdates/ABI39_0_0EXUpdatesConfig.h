...
typedef NS_ENUM(NSInteger, ABI39_0_0EXUpdatesCheckAutomaticallyConfig) {
  ABI39_0_0EXUpdatesCheckAutomaticallyConfigAlways = 0,
  ABI39_0_0EXUpdatesCheckAutomaticallyConfigWifiOnly = 1,
  ABI39_0_0EXUpdatesCheckAutomaticallyConfigNever = 2
};

@interface ABI39_0_0EXUpdatesConfig : NSObject
...
@property (nonatomic, readonly) ABI39_0_0EXUpdatesCheckAutomaticallyConfig checkOnLaunch;
