...
@class ABI39_0_0EXSyncController;

@protocol ABI39_0_0EXSyncControllerDelegate <NSObject>

- (void)appController:(ABI39_0_0EXSyncController *)appController didStartWithSuccess:(BOOL)success;

@end

@interface ABI39_0_0EXSyncController : NSObject <ABI39_0_0EXSyncLoaderTaskDelegate>

/**
 Delegate which will be notified when ABI39_0_0EXUpdates has an update ready to launch and
 `launchAssetUrl` is nonnull.
 */
@property (nonatomic, weak) id<ABI39_0_0EXSyncControllerDelegate> delegate;
...
/**
 ...
 Will be null until the ABI39_0_0EXSyncController delegate method is called.
...
/**
 ...
 shared instance of ABI39_0_0EXSyncController.
 */
