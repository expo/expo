...
typedef void (^ABI39_0_0EXUpdatesAppLoaderAssetBlock) (ABI39_0_0EXUpdatesAsset *asset, NSUInteger successfulAssetCount, NSUInteger failedAssetCount, NSUInteger totalAssetCount);
