...
#import <ABI39_0_0EXUpdates/ABI39_0_0EXSyncLauncherNoDatabase.h>
#import <ABI39_0_0EXUpdates/ABI39_0_0EXSyncEmbeddedLoader.h>

NS_ASSUME_NONNULL_BEGIN

static NSString * const ABI39_0_0EXSyncErrorLogFile = @"expo-error.log";

@interface ABI39_0_0EXSyncLauncherNoDatabase ()
...
@implementation ABI39_0_0EXSyncLauncherNoDatabase

- (void)launchUpdateWithConfig:(ABI39_0_0EXSyncConfig *)config
{
  _launchedUpdate = [ABI39_0_0EXSyncEmbeddedLoader embeddedManifestWithConfig:config database:nil];
  if (_launchedUpdate) {
    if (_launchedUpdate.status == ABI39_0_0EXSyncManifestStatusEmbedded) {
      ...
      _launchAssetUrl = [[NSBundle mainBundle] URLForResource:ABI39_0_0EXSyncEmbeddedBundleFilename withExtension:ABI39_0_0EXSyncEmbeddedBundleFileType];
...
+ (NSString *)_errorLogFilePath
{
  ...
  return [[applicationDocumentsDirectory URLByAppendingPathComponent:ABI39_0_0EXSyncErrorLogFile] path];
}
