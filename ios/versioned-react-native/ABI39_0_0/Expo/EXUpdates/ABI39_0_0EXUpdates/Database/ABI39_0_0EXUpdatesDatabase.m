...
static NSString * const ABI39_0_0EXUpdatesDatabaseErrorDomain = @"ABI39_0_0EXUpdatesDatabase";
static NSString * const ABI39_0_0EXUpdatesDatabaseFilename = @"expo-v3.db";
...
{
  sqlite3 *db;
  NSURL *dbUrl = [directory URLByAppendingPathComponent:ABI39_0_0EXUpdatesDatabaseFilename];
  ...
  if (resultCode != SQLITE_OK) {
    ...
    if (resultCode == SQLITE_CORRUPT || resultCode == SQLITE_NOTADB) {
      NSString *archivedDbFilename = [NSString stringWithFormat:@"%f-%@", [[NSDate date] timeIntervalSince1970], ABI39_0_0EXUpdatesDatabaseFilename];
      ...
      if ([[NSFileManager defaultManager] moveItemAtURL:dbUrl toURL:destinationUrl error:&err]) {
        ...
        if (error != nil) {
          *error = [NSError errorWithDomain:ABI39_0_0EXUpdatesDatabaseErrorDomain
                                       code:1004
...
- (NSError *)_errorFromSqlite:(struct sqlite3 *)db
{
  ...
  return [NSError errorWithDomain:ABI39_0_0EXUpdatesDatabaseErrorDomain
                              code:extendedCode
...
- (ABI39_0_0EXUpdatesAsset *)_assetWithRow:(NSDictionary *)row
{
  ...
  ABI39_0_0EXUpdatesAsset *asset = [[ABI39_0_0EXUpdatesAsset alloc] initWithKey:row[@"key"] type:row[@"type"]];
  asset.url = url;
