...
static NSString * const ABI39_0_0EXUpdatesDatabaseUtilsErrorDomain = @"ABI39_0_0EXUpdatesDatabase";

@implementation ABI39_0_0EXUpdatesDatabaseUtils
...
+ (NSError *)errorFromSqlite:(struct sqlite3 *)db
{
  ...
  return [NSError errorWithDomain:ABI39_0_0EXUpdatesDatabaseUtilsErrorDomain
                             code:extendedCode
