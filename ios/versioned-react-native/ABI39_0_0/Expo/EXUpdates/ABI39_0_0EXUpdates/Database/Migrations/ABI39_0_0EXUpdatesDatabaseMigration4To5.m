...
static NSString * const ABI39_0_0EXUpdatesDatabaseV4Filename = @"expo-v4.db";

@implementation ABI39_0_0EXUpdatesDatabaseMigration4To5

- (NSString *)filename
{
  return ABI39_0_0EXUpdatesDatabaseV4Filename;
}
