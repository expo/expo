...
typedef NS_ENUM(NSInteger, ABI39_0_0EXSyncCheckAutomaticallyConfig) {
  ABI39_0_0EXSyncCheckAutomaticallyConfigAlways = 0,
  ABI39_0_0EXSyncCheckAutomaticallyConfigWifiOnly = 1,
  ABI39_0_0EXSyncCheckAutomaticallyConfigNever = 2
};

@interface ABI39_0_0EXSyncConfig : NSObject
...
@property (nonatomic, readonly) ABI39_0_0EXSyncCheckAutomaticallyConfig checkOnLaunch;
