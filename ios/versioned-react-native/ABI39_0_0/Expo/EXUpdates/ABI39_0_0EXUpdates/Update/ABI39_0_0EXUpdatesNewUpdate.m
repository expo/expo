                                  ...
                                  database:(ABI39_0_0EXUpdatesDatabase *)database
{
  ...
  update.commitTime = [ABI39_0_0RCTConvert NSDate:(NSString *)commitTime];
...
+ (nullable NSDictionary *)dictionaryWithStructuredHeader:(NSString *)headerString
{
  ...
  ABI39_0_0EXStructuredHeadersParser *parser = [[ABI39_0_0EXStructuredHeadersParser alloc] initWithRawInput:headerString fieldType:ABI39_0_0EXStructuredHeadersParserFieldTypeDictionary ignoringParameters:YES];
  NSError *error;
