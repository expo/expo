...
+ (ABI39_0_0EXUpdatesUpdate *)updateWithLegacyManifest:(NSDictionary *)manifest
...
+ (NSURL *)bundledAssetBaseUrlWithManifest:(NSDictionary *)manifest config:(ABI39_0_0EXUpdatesConfig *)config
{
