...
static NSString * const ABI39_0_0EXSyncExpoAssetBaseUrl = @"https://d1wp6m56sqw74a.cloudfront.net/~assets/";
static NSString * const ABI39_0_0EXSyncExpoIoDomain = @"expo.io";
static NSString * const ABI39_0_0EXSyncExpHostDomain = @"exp.host";
static NSString * const ABI39_0_0EXSyncExpoTestDomain = @"expo.test";

@implementation ABI39_0_0EXSyncLegacyManifest
                                     ...
                                     database:(ABI39_0_0EXSyncDatabase *)database
{
  ...
  if ([[self class] isDevelopmentModeManifest:manifest]) {
    ...
    update.status = ABI39_0_0EXSyncManifestStatusDevelopment;
  } else {
    update.status = ABI39_0_0EXSyncManifestStatusPending;
  }
  ...
  ABI39_0_0EXSyncAsset *jsBundleAsset = [[ABI39_0_0EXSyncAsset alloc] initWithKey:bundleKey type:ABI39_0_0EXSyncEmbeddedBundleFileType];
  jsBundleAsset.url = bundleUrl;
  jsBundleAsset.isLaunchAsset = YES;
  jsBundleAsset.mainBundleFilename = ABI39_0_0EXSyncEmbeddedBundleFilename;
...
+ (NSURL *)bundledAssetBaseUrlWithManifest:(NSDictionary *)manifest config:(ABI39_0_0EXSyncConfig *)config
{
  NSURL *manifestUrl = config.updateUrl;
  NSString *host = manifestUrl.host;
  if (!host ||
      [host containsString:ABI39_0_0EXSyncExpoIoDomain] ||
      [host containsString:ABI39_0_0EXSyncExpHostDomain] ||
      [host containsString:ABI39_0_0EXSyncExpoTestDomain]) {
    return [NSURL URLWithString:ABI39_0_0EXSyncExpoAssetBaseUrl];
  } else {
