...
@implementation ABI39_0_0EXAppleAuthenticationMappings
...
{
  return @{
           @"namePrefix": ABI39_0_0UMNullIfNil(nameComponents.namePrefix),
           @"givenName": ABI39_0_0UMNullIfNil(nameComponents.givenName),
           @"middleName": ABI39_0_0UMNullIfNil(nameComponents.middleName),
           @"familyName": ABI39_0_0UMNullIfNil(nameComponents.familyName),
           @"nameSuffix": ABI39_0_0UMNullIfNil(nameComponents.nameSuffix),
           @"nickname": ABI39_0_0UMNullIfNil(nameComponents.nickname)
           };
}
