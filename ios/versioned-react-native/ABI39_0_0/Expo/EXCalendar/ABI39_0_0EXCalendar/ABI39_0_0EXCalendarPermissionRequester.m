#import <ABI39_0_0EXCalendar/ABI39_0_0EXCalendarPermissionRequester.h>
#import <EventKit/EventKit.h>
#import <ABI39_0_0UMCore/ABI39_0_0UMDefines.h>

@implementation ABI39_0_0EXCalendarPermissionRequester
...
- (NSDictionary *)getPermissions
{
  ...
  if (!calendarUsageDescription) {
    ABI39_0_0UMFatal(ABI39_0_0UMErrorWithMessage(@"This app is missing NSCalendarsUsageDescription, so calendar methods will fail. Add this key to your bundle's Info.plist."));
