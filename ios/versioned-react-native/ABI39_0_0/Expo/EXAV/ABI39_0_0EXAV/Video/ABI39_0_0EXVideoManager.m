...
#import <ABI39_0_0EXAV/ABI39_0_0EXVideoManager.h>
#import <ABI39_0_0EXAV/ABI39_0_0EXVideoView.h>
#import <ABI39_0_0UMCore/ABI39_0_0UMUIManager.h>

@interface ABI39_0_0EXVideoManager ()

@property (nonatomic, weak) ABI39_0_0UMModuleRegistry *moduleRegistry;

@end

@implementation ABI39_0_0EXVideoManager

ABI39_0_0UM_EXPORT_MODULE(ExpoVideoManager);
...
- (UIView *)view
{
  return [[ABI39_0_0EXVideoView alloc] initWithModuleRegistry:_moduleRegistry];
}
...
ABI39_0_0UM_VIEW_PROPERTY(status, NSDictionary *, ABI39_0_0EXVideoView)
{
  [view setStatus:value];
}

ABI39_0_0UM_VIEW_PROPERTY(useNativeControls, BOOL, ABI39_0_0EXVideoView)
{
  [view setUseNativeControls:value];
}

// Native only props -- set by Video.js
ABI39_0_0UM_VIEW_PROPERTY(source, NSDictionary *, ABI39_0_0EXVideoView)
{
  [view setSource:value];
}
ABI39_0_0UM_VIEW_PROPERTY(resizeMode, NSString *, ABI39_0_0EXVideoView)
{
     ...
     withRejecter:(ABI39_0_0UMPromiseRejectBlock)reject
{
  ...
  [uiManager executeUIBlock:^(id view) {
    if ([view isKindOfClass:[ABI39_0_0EXVideoView class]]) {
      block((ABI39_0_0EXVideoView *)view);
    } else {
  ...
  } forView:viewTag ofClass:[ABI39_0_0EXVideoView class]];
}

ABI39_0_0UM_EXPORT_METHOD_AS(setFullscreen,
