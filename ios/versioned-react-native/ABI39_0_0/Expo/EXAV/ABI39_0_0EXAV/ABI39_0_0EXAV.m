     ...
     withRejecter:(ABI39_0_0UMPromiseRejectBlock)reject
{
  ...
  [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI39_0_0UMUIManager)] executeUIBlock:^(id view) {
    if ([view isKindOfClass:[ABI39_0_0EXVideoView class]]) {
      ...
      reject(@"E_VIDEO_TAGINCORRECT", [NSString stringWithFormat:@"Invalid view returned from registry, expecting ABI39_0_0EXVideo, got: %@", view], nil);
    }
...
{
  if (_audioRecorder) {
    return ABI39_0_0UMErrorWithMessage(@"Recorder is already prepared.");
  }
