...
#import <ABI39_0_0EXFirebaseCore/ABI39_0_0UMFirebaseCoreInterface.h>
#import <ABI39_0_0EXFirebaseAnalytics/ABI39_0_0EXFirebaseAnalytics.h>
...
@interface ABI39_0_0EXFirebaseAnalytics ()

@property (nonatomic, weak) ABI39_0_0UMModuleRegistry *moduleRegistry;
@property (nonatomic, weak) id<ABI39_0_0UMFirebaseCoreInterface> firebaseCore;

@end

@implementation ABI39_0_0EXFirebaseAnalytics

ABI39_0_0UM_EXPORT_MODULE(ExpoFirebaseAnalytics);
...
- (void)reject:(ABI39_0_0UMPromiseRejectBlock)reject withException:(NSException *)exception {
...
- (void)setModuleRegistry:(ABI39_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  _firebaseCore = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI39_0_0UMFirebaseCoreInterface)];
}

- (nullable FIRApp *)getAppOrReject:(ABI39_0_0UMPromiseRejectBlock)reject
{
  if (!_firebaseCore) {
    reject(@"ERR_FIREBASE_ANALYTICS", @"ABI39_0_0EXFirebaseCore could not be found. Ensure that your app has correctly linked 'expo-firebase-core' and your project has ABI39_0_0React-native-unimodules installed.", nil);
    return nil;
  }
...
ABI39_0_0UM_EXPORT_METHOD_AS(setAnalyticsCollectionEnabled,
...
ABI39_0_0UM_EXPORT_METHOD_AS(setCurrentScreen,
...
ABI39_0_0UM_EXPORT_METHOD_AS(resetAnalyticsData,
                    resetAnalyticsData:(ABI39_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject) {
  if ([self getAppOrReject:reject] == nil) return;
  @try {
