#import <ABI39_0_0EXImagePicker/ABI39_0_0EXImagePicker.h>
...
const CGFloat ABI39_0_0EXDefaultImageQuality = 0.2;

@interface ABI39_0_0EXImagePicker ()
...
@implementation ABI39_0_0EXImagePicker

ABI39_0_0UM_EXPORT_MODULE(ExponentImagePicker);
...
- (void)setModuleRegistry:(ABI39_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  _permissionsManager = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI39_0_0UMPermissionsInterface)];
  [ABI39_0_0UMPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI39_0_0EXImagePickerCameraPermissionRequester new],
                                                    [ABI39_0_0EXImagePickerCameraRollPermissionRequester new]
                                                    ]
                           withPermissionsManager:_permissionsManager];
}

ABI39_0_0UM_EXPORT_METHOD_AS(getCameraPermissionsAsync,
                    getCameraPermissionsAsync:(ABI39_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  [ABI39_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI39_0_0EXImagePickerCameraPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI39_0_0UM_EXPORT_METHOD_AS(getCameraRollPermissionsAsync,
                    getPermissionsAsync:(ABI39_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  [ABI39_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI39_0_0EXImagePickerCameraRollPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI39_0_0UM_EXPORT_METHOD_AS(requestCameraPermissionsAsync,
                    requestCameraPermissionsAsync:(ABI39_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
...
ABI39_0_0UM_EXPORT_METHOD_AS(requestCameraRollPermissionsAsync,
                    requestCameraRollPermissionsAsync:(ABI39_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  [ABI39_0_0UMPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI39_0_0EXImagePickerCameraRollPermissionRequester class]
...
ABI39_0_0UM_EXPORT_METHOD_AS(launchCameraAsync, launchCameraAsync:(NSDictionary *)options
                  ...
                  rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  BOOL permissionsAreGranted = [self hasCameraRollPermission] &&
                               [self.permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI39_0_0EXImagePickerCameraPermissionRequester class]];
  ...
  self.reject = reject;
  [self launchImagePicker:ABI39_0_0EXImagePickerTargetCamera options:options];
}

ABI39_0_0UM_EXPORT_METHOD_AS(launchImageLibraryAsync, launchImageLibraryAsync:(NSDictionary *)options
                  resolver:(ABI39_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  if (!_permissionsManager) {
  ...
  self.resolve = resolve;
  self.reject = reject;
  [self launchImagePicker:ABI39_0_0EXImagePickerTargetLibrarySingleImage options:options];
}

- (void)launchImagePicker:(ABI39_0_0EXImagePickerTarget)target options:(NSDictionary *)options
{
...
- (void)launchImagePicker:(ABI39_0_0EXImagePickerTarget)target
{
  dispatch_async(dispatch_get_main_queue(), ^{
    self.picker = [UIImagePickerController new];

    if (target == ABI39_0_0EXImagePickerTargetCamera) {
  ...
  #endif
    } else { // ABI39_0_0RNImagePickerTargetLibrarySingleImage
    ...
    id<ABI39_0_0UMUtilitiesInterface> utils = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI39_0_0UMUtilitiesInterface)];
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
  dispatch_block_t dismissCompletionBlock = ^{
    ...
    id<ABI39_0_0UMFileSystemInterface> fileSystem = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI39_0_0UMFileSystemInterface)];
    if (!fileSystem) {
          ...
          completionHandler:(void (^)(void))completionHandler
{
  ...
  NSData *data = UIImageJPEGRepresentation(image, quality == nil ? ABI39_0_0EXDefaultImageQuality : [quality floatValue]);
  ...
  if ([[self.options objectForKey:@"exif"] boolValue]) {
    ...
    if (metadata) {
      ...
      if (!asset) {
        ABI39_0_0UMLogInfo(@"Could not fetch metadata for image %@", [imageURL absoluteString]);
        completionHandler();
      }
...
- (BOOL)hasCameraRollPermission
{
  ...
  return [_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI39_0_0EXImagePickerCameraRollPermissionRequester class]];
}
