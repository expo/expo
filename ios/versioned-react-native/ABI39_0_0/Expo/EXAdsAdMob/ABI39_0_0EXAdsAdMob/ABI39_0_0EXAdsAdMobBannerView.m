...
@implementation ABI39_0_0EXAdsAdMobBannerView {
...
- (void)setOnSizeChange:(ABI39_0_0UMDirectEventBlock)block
{
  _onSizeChange = block;
  [self loadBanner];
}

- (void)setOnDidFailToReceiveAdWithError:(ABI39_0_0UMDirectEventBlock)block
{
