...
#import <ABI39_0_0EXDevice/ABI39_0_0EXDevice.h>
...
@interface ABI39_0_0EXDevice()

@end

@implementation ABI39_0_0EXDevice

ABI39_0_0UM_EXPORT_MODULE(ExpoDevice);
...
- (NSDictionary *)constantsToExport
{
  ...
  return @{
           ...
           @"brand": @"Apple",
           @"manufacturer": @"Apple",
           @"modelId": ABI39_0_0UMNullIfNil([[self class] modelId]),
           @"deviceYearClass": [[self class] deviceYear],
           @"totalMemory": @(NSProcessInfo.processInfo.physicalMemory),
           @"supportedCpuArchitectures": ABI39_0_0UMNullIfNil([[self class] cpuArchitectures]),
...
ABI39_0_0UM_EXPORT_METHOD_AS(getDeviceTypeAsync,
                    getDeviceTypeAsyncWithResolver:(ABI39_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  resolve(@([[self class] deviceType]));
}

ABI39_0_0UM_EXPORT_METHOD_AS(getUptimeAsync,
                    getUptimeAsyncWithResolver:(ABI39_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
...
ABI39_0_0UM_EXPORT_METHOD_AS(isRootedExperimentalAsync,
                    isRootedExperimentalAsyncWithResolver:(ABI39_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
...
+ (ABI39_0_0EXDeviceType)deviceType
{
  switch (UIDevice.currentDevice.userInterfaceIdiom) {
    case UIUserInterfaceIdiomPhone:
      return ABI39_0_0EXDeviceTypePhone;
    case UIUserInterfaceIdiomPad:
      return ABI39_0_0EXDeviceTypeTablet;
    case UIUserInterfaceIdiomTV:
      return ABI39_0_0EXDeviceTypeTV;
    default:
      // NOTE: in the future for macOS, return Desktop
      return ABI39_0_0EXDeviceTypeUnknown;
  }
}
