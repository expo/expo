...
#import <ABI39_0_0EXMailComposer/ABI39_0_0EXMailComposer.h>
...
@interface ABI39_0_0EXMailComposer ()
...
@implementation ABI39_0_0EXMailComposer

ABI39_0_0UM_EXPORT_MODULE(ExpoMailComposer);
...
ABI39_0_0UM_EXPORT_METHOD_AS(composeAsync,
                    ...
                    rejecter:(ABI39_0_0UMPromiseRejectBlock)reject)
{
  ...
  self.reject = reject;
  id<ABI39_0_0UMUtilitiesInterface> utilities = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI39_0_0UMUtilitiesInterface)];
