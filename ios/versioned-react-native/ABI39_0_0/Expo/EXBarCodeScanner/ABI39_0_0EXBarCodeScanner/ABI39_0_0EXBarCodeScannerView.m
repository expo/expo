...
@interface ABI39_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI39_0_0EXBarCodeScanner *barCodeScanner;
...
@property (nonatomic, copy) ABI39_0_0UMDirectEventBlock onCameraReady;
@property (nonatomic, copy) ABI39_0_0UMDirectEventBlock onMountError;
@property (nonatomic, copy) ABI39_0_0UMDirectEventBlock onBarCodeScanned;

@end

@implementation ABI39_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI39_0_0UMModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI39_0_0UMAppLifecycleListener)];
...
{
  ABI39_0_0UM_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI39_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI39_0_0EXBareCodeCameraRequester class]]) {
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI39_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI39_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI39_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI39_0_0EXBarCodeScanner *barCodeScanner = [ABI39_0_0EXBarCodeScanner new];
