...
@implementation ABI39_0_0EXScreenCaptureModule {
  UIView *_blockView;
}

ABI39_0_0UM_EXPORT_MODULE(ExpoScreenCapture);
...
ABI39_0_0UM_EXPORT_METHOD_AS(preventScreenCapture,
                    preventScreenCaptureWithResolver:(ABI39_0_0UMPromiseResolveBlock)resolve
...
ABI39_0_0UM_EXPORT_METHOD_AS(allowScreenCapture,
                    allowScreenCaptureWithResolver:(ABI39_0_0UMPromiseResolveBlock)resolve
