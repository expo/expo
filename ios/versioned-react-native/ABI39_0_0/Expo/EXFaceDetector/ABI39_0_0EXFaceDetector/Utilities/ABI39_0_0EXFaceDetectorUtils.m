//
//  ABI39_0_0EXFaceDetectorUtils.m
//  Exponent
//
...
NSString *const ABI39_0_0EXGMVDataOutputWidthKey = @"Width";
NSString *const ABI39_0_0EXGMVDataOutputHeightKey = @"Height";
...
@implementation ABI39_0_0EXFaceDetectorUtils
...
+ (ABI39_0_0EXFaceDetectionAngleTransformBlock)angleTransformerFromTransform:(CGAffineTransform)transform
{
  return ^(float angle) {
