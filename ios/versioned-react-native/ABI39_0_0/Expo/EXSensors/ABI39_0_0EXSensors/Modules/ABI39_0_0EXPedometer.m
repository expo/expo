...
#import <ABI39_0_0EXSensors/ABI39_0_0EXPedometer.h>
...
NSString * const ABI39_0_0EXPedometerUpdateEventName = @"Exponent.pedometerUpdate";
NSString * const ABI39_0_0EXPedometerModuleName = @"ExponentPedometer";

@interface ABI39_0_0EXPedometer () <ABI39_0_0UMAppLifecycleListener>
...
@implementation ABI39_0_0EXPedometer
...
{
  if (self = [super init]) {
    __weak ABI39_0_0EXPedometer *weakSelf = self;
    _watchHandler = ^(CMPedometerData * _Nullable pedometerData, NSError * _Nullable error) {
      ...
      __strong ABI39_0_0EXPedometer *strongSelf = weakSelf;
      if (strongSelf) {
        __strong id<ABI39_0_0UMEventEmitterService> eventEmitter = strongSelf.eventEmitter;
        if (eventEmitter) {
          [eventEmitter sendEventWithName:ABI39_0_0EXPedometerUpdateEventName
...
{
  return ABI39_0_0EXPedometerModuleName;
}
...
{
  return @[ABI39_0_0EXPedometerUpdateEventName];
}
...
ABI39_0_0UM_EXPORT_METHOD_AS(getStepCountAsync,
