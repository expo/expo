...
@interface ABI31_0_0EXUtilities ()

@property (nonatomic, nullable, weak) ABI31_0_0EXModuleRegistry *moduleRegistry;
...
@implementation ABI31_0_0EXUtilities

ABI31_0_0EX_REGISTER_MODULE();

+ (const NSArray<Protocol *> *)exportedInterfaces
{
  return @[@protocol(ABI31_0_0EXUtilitiesInterface)];
}
...
- (nullable NSDictionary *)launchOptions
{
  id<ABI31_0_0EXUtilService> utilService = [_moduleRegistry getSingletonModuleForName:@"Util"];
  
  if (utilService != nil) {
    // Uses launchOptions from ABI31_0_0EXUtilService that is a part of ExpoKit
...
- (UIViewController *)currentViewController
{
  ...
  if (utilService != nil) {
    // Uses currentViewController from ABI31_0_0EXUtilService that is a part of ExpoKit
    return [utilService currentViewController];
  }
  
  // If the app doesn't have ExpoKit - then do the same as ABI31_0_0RCTPresentedViewController() does
