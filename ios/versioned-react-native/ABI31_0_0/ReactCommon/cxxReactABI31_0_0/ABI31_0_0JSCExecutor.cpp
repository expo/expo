...
#include "ABI31_0_0JSCExecutor.h"
...
#include "ABI31_0_0JSCMemory.h"
#include "ABI31_0_0JSCPerfStats.h"
#include "ABI31_0_0JSCSamplingProfiler.h"
#include "ABI31_0_0JSCTracing.h"
#include "ABI31_0_0JSCUtils.h"
#include "ABI31_0_0JSModulesUnbundle.h"
...
#include "ABI31_0_0RecoverableError.h"
...
void JSCExecutor::initOnJSVMThread() throw(JSException) {
  ...
  if (canUseInspector(m_context)) {
    ...
    auto& globalInspector = facebook::ReactABI31_0_0::getInspectorInstance();
...
void JSCExecutor::loadApplicationScript(
  ...
  ReactABI31_0_0Marker::logTaggedMarker(
      ReactABI31_0_0Marker::RUN_JS_BUNDLE_START, scriptName.c_str());
...
// TODO t15069155: reduce the number of overrides here
  ...
  if (auto fileStr = dynamic_cast<const JSBigFileString*>(script.get())) {
    ...
    switch (jsStatus) {
      case JSLoadSourceIsCompiled:
        ...
        ReactABI31_0_0Marker::logMarker(ReactABI31_0_0Marker::CREATE_REACT_CONTEXT_STOP);
        ReactABI31_0_0Marker::logTaggedMarker(
            ReactABI31_0_0Marker::RUN_JS_BUNDLE_STOP, scriptName.c_str());
        return;
...
#endif
  {
    ...
    JSContextLock lock(m_context);
    {
      ...
      ReactABI31_0_0Marker::logMarker(ReactABI31_0_0Marker::JS_BUNDLE_STRING_CONVERT_START);
      jsScript = adoptString(std::move(script));
      ReactABI31_0_0Marker::logMarker(ReactABI31_0_0Marker::JS_BUNDLE_STRING_CONVERT_STOP);
    }
...
JSValueRef JSCExecutor::nativeRequire(
  ...
  ReactABI31_0_0Marker::logMarker(ReactABI31_0_0Marker::NATIVE_REQUIRE_START);
  loadModule(bundleId, moduleId);
  ReactABI31_0_0Marker::logMarker(ReactABI31_0_0Marker::NATIVE_REQUIRE_STOP);
