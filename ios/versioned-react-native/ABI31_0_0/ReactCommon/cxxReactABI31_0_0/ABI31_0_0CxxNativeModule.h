...
#include <cxxReactABI31_0_0/ABI31_0_0CxxModule.h>
#include <cxxReactABI31_0_0/ABI31_0_0NativeModule.h>
...
public:
  ...
  void invoke(unsigned int ReactABI31_0_0MethodId, folly::dynamic&& params, int callId) override;
