...
inline static ABI31_0_0RCTResizeMode ABI31_0_0RCTResizeModeFromImageResizeMode(ImageResizeMode imageResizeMode) {
  switch (imageResizeMode) {
    case ImageResizeMode::Cover: return ABI31_0_0RCTResizeModeCover;
    case ImageResizeMode::Contain: return ABI31_0_0RCTResizeModeContain;
    case ImageResizeMode::Stretch: return ABI31_0_0RCTResizeModeStretch;
    case ImageResizeMode::Center: return ABI31_0_0RCTResizeModeCenter;
    case ImageResizeMode::Repeat: return ABI31_0_0RCTResizeModeRepeat;
  }
}
...
inline static NSURLRequest *NSURLRequestFromImageSource(const ImageSource &imageSource) {
  ...
  if (!url) {
    ABI31_0_0RCTLogError(@"URI parsing error.");
    return nil;
  }
