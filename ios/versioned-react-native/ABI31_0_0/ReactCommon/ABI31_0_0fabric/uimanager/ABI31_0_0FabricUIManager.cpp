...
#include "ABI31_0_0FabricUIManager.h"

#include <glog/logging.h>

#include <ABI31_0_0fabric/ABI31_0_0components/view/ViewComponentDescriptor.h>
#include <ABI31_0_0fabric/ABI31_0_0components/view/ViewProps.h>
#include <ABI31_0_0fabric/ABI31_0_0components/view/ViewShadowNode.h>
#include <ABI31_0_0fabric/ABI31_0_0core/componentDescriptor.h>
#include <ABI31_0_0fabric/ABI31_0_0core/LayoutContext.h>
#include <ABI31_0_0fabric/ABI31_0_0core/ShadowNodeFragment.h>
...
SharedShadowNode FabricUIManager::createNode(int tag, std::string viewName, int rootTag, folly::dynamic props, EventTarget eventTarget) {
  ...
  ComponentName componentName = componentNameByReactABI31_0_0ViewName(viewName);
