...
#pragma mark - JavaScript/ReactABI31_0_0-facing Interface

  SharedShadowNode createNode(Tag ReactABI31_0_0Tag, std::string viewName, Tag rootTag, folly::dynamic props, EventTarget eventTarget);
