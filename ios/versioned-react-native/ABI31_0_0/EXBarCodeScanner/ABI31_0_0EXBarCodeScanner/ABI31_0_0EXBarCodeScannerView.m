...
@interface ABI31_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI31_0_0EXBarCodeScanner *barCodeScanner;
...
@implementation ABI31_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI31_0_0EXModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI31_0_0EXAppLifecycleListener)];
...
{
  ABI31_0_0EX_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI31_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI31_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI31_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI31_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI31_0_0EXBarCodeScanner *barCodeScanner = [ABI31_0_0EXBarCodeScanner new];
