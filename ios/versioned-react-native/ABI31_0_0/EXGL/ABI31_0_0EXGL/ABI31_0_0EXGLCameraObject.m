...
@interface ABI31_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) id<ABI31_0_0EXCameraInterface> camera;
...
@implementation ABI31_0_0EXGLCameraObject
