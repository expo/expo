...
@implementation ABI31_0_0EXAdsDFPBannerView {
  DFPBannerView *_bannerView;
  id<ABI31_0_0EXEventEmitterService> _eventEmitter;
}
...
- (void)setOnSizeChange:(ABI31_0_0EXDirectEventBlock)block
{
  _onSizeChange = block;
  [self loadBanner];
}

- (void)setOnDidFailToReceiveAdWithError:(ABI31_0_0EXDirectEventBlock)block
{
