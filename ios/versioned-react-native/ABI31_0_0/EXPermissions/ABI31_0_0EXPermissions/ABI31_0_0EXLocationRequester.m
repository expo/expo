...
@interface ABI31_0_0EXLocationRequester () <CLLocationManagerDelegate>
...
@implementation ABI31_0_0EXLocationRequester
...
+ (NSDictionary *)permissions
{
  ...
  if (![self isConfiguredForAlwaysAuthorization] && ![self isConfiguredForWhenInUseAuthorization]) {
    ABI31_0_0EXFatal(ABI31_0_0EXErrorWithMessage(@"This app is missing usage descriptions, so location services will fail. Add one of the `NSLocation*UsageDescription` keys to your bundle's Info.plist. See https://bit.ly/2P5fEbG (https://docs.expo.io/versions/latest/guides/app-stores.html#system-permissions-dialogs-on-ios) for more information."));
...
- (void)requestPermissionsWithResolver:(ABI31_0_0EXPromiseResolveBlock)resolve rejecter:(ABI31_0_0EXPromiseRejectBlock)reject
{
  ...
  if (existingPermissions && ![existingPermissions[@"status"] isEqualToString:[ABI31_0_0EXPermissions permissionStringForStatus:ABI31_0_0EXPermissionStatusUndetermined]]) {
