...
#import "ABI31_0_0EXScopedModuleRegistryDelegate.h"

@implementation ABI31_0_0EXScopedModuleRegistryDelegate
...
- (id<ABI31_0_0EXInternalModule>)pickInternalModuleImplementingInterface:(Protocol *)interface fromAmongModules:(NSArray<id<ABI31_0_0EXInternalModule>> *)internalModules
{
  ...
  // in ABI31_0_0EXScopedModuleRegistryAdapter at the last moment before conflict resolution,
