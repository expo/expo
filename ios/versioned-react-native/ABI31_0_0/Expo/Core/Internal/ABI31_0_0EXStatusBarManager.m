...
#import "ABI31_0_0EXStatusBarManager.h"
...
#if !TARGET_OS_TV
@implementation ABI31_0_0RCTConvert (ABI31_0_0EXStatusBar)
...
@interface ABI31_0_0EXStatusBarManager ()

@property (nonatomic, strong) NSMutableDictionary *capturedStatusBarProperties;

@end

@implementation ABI31_0_0EXStatusBarManager

+ (NSString *)moduleName { return @"ABI31_0_0RCTStatusBarManager"; }
 ...
 */
ABI31_0_0RCT_REMAP_METHOD(_captureProperties,
                 _capturePropertiesWithResolver:(ABI31_0_0RCTPromiseResolveBlock)resolve
 ...
 *  Normally nobody should use this method because it bypasses the JS state used by the StatusBar component.
 */
ABI31_0_0RCT_EXPORT_METHOD(_applyPropertiesAndForget:(NSDictionary *)properties)
{
...
{
  UIApplication *currentApplication = ABI31_0_0RCTSharedApplication();
  return @{
