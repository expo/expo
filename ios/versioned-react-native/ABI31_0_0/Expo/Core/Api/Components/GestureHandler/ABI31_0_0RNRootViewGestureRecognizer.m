//
//  ABI31_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI31_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI31_0_0RNGestureHandler *otherHandler = [ABI31_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI31_0_0RCTTouchHandler class]];
}
