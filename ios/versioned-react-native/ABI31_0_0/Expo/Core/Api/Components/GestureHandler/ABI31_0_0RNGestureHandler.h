...
#import "ABI31_0_0RNGestureHandlerEvents.h"
...
if (value != nil) recognizer.prop = [ABI31_0_0RCTConvert type:value]; \
} while(0)
...
@protocol ABI31_0_0RNGestureHandlerEventEmitter

- (void)sendTouchEvent:(nonnull ABI31_0_0RNGestureHandlerEvent *)event;

- (void)sendStateChangeEvent:(nonnull ABI31_0_0RNGestureHandlerStateChange *)event;

@end


@protocol ABI31_0_0RNRootViewGestureRecognizerDelegate <UIGestureRecognizerDelegate>
...
@interface ABI31_0_0RNGestureHandler : NSObject <UIGestureRecognizerDelegate> {

@protected UIGestureRecognizer *_recognizer;
@protected ABI31_0_0RNGestureHandlerState _lastState;

}

+ (nullable ABI31_0_0RNGestureHandler *)findGestureHandlerByRecognizer:(nonnull UIGestureRecognizer *)recognizer;

- (nonnull instancetype)initWithTag:(nonnull NSNumber *)tag;

@property (nonatomic, readonly, nonnull) NSNumber *tag;
@property (nonatomic, weak, nullable) id<ABI31_0_0RNGestureHandlerEventEmitter> emitter;
...
- (nullable ABI31_0_0RNGestureHandlerEventExtraData *)eventExtraData:(nonnull id)recognizer;
