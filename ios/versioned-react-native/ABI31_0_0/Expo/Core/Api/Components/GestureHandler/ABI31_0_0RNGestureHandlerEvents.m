...
@implementation ABI31_0_0RNGestureHandlerEventExtraData
...
{
    return [[ABI31_0_0RNGestureHandlerEventExtraData alloc]
            initWithData:@{
                           @"x": @(position.x),
                           @"y": @(position.y),
...
@implementation ABI31_0_0RNGestureHandlerEvent
{
    NSNumber *_handlerTag;
    ABI31_0_0RNGestureHandlerState _state;
    ABI31_0_0RNGestureHandlerEventExtraData *_extraData;
}
...
- (instancetype)initWithRactTag:(NSNumber *)ReactABI31_0_0Tag
                     handlerTag:(NSNumber *)handlerTag
                      ...
                      extraData:(ABI31_0_0RNGestureHandlerEventExtraData *)extraData
{
...
@implementation ABI31_0_0RNGestureHandlerStateChange
{
    NSNumber *_handlerTag;
    ABI31_0_0RNGestureHandlerState _state;
    ABI31_0_0RNGestureHandlerState _prevState;
    ABI31_0_0RNGestureHandlerEventExtraData *_extraData;
}
