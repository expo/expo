...
#import "ABI31_0_0AIRMapLocalTileOverlay.h"

@implementation ABI31_0_0AIRMapLocalTile {
...
- (void) createTileOverlayAndRendererIfPossible
{
    ...
    self.tileOverlay = [[ABI31_0_0AIRMapLocalTileOverlay alloc] initWithURLTemplate:self.pathTemplate];
