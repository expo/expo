...
#import "ABI31_0_0AIRMapManager.h"
...
#import "ABI31_0_0AIRMapSnapshot.h"
...
@interface ABI31_0_0AIRMapManager() <MKMapViewDelegate>

@end

@implementation ABI31_0_0AIRMapManager{
   BOOL _hasObserver;
}
...
- (UIView *)view
{
    ABI31_0_0AIRMap *map = [ABI31_0_0AIRMap new];
    map.delegate = self;
...
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(userLocationAnnotationTitle, NSString)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(showsPointsOfInterest, BOOL)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
...
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(cacheEnabled, BOOL)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(maxDelta, CGFloat)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(minDelta, CGFloat)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(legalLabelInsets, UIEdgeInsets)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, MKMapType)
...
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(onPanDrag, ABI31_0_0RCTBubblingEventBlock)
...
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI31_0_0RCTDirectEventBlock)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI31_0_0RCTDirectEventBlock)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI31_0_0RCTDirectEventBlock)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI31_0_0RCTDirectEventBlock)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI31_0_0RCTDirectEventBlock)
ABI31_0_0RCT_EXPORT_VIEW_PROPERTY(onCalloutPress, ABI31_0_0RCTDirectEventBlock)
ABI31_0_0RCT_CUSTOM_VIEW_PROPERTY(initialRegion, MKCoordinateRegion, ABI31_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setInitialRegion:[ABI31_0_0RCTConvert MKCoordinateRegion:json]];
...
ABI31_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI31_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setRegion:[ABI31_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI31_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI31_0_0AIRMap class]]) {
            ABI31_0_0RCTLogError(@"Invalid view returned from registry, expecting ABI31_0_0AIRMap, got: %@", view);
        } else {
            ABI31_0_0AIRMap *mapView = (ABI31_0_0AIRMap *)view;
            MKMapCamera *mapCamera = [[mapView camera] copy];
             [mapCamera setPitch:angle];
             [mapCamera setHeading:bearing];

            [ABI31_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI31_0_0AIRMap *)view setRegion:region animated:YES];
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI31_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI31_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ABI31_0_0AIRMapMarker *marker = (ABI31_0_0AIRMapMarker *)evaluatedObject;
                return [marker isKindOfClass:[ABI31_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
                  ...
                  rejecter:(ABI31_0_0RCTPromiseRejectBlock)reject)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI31_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        ABI31_0_0AIRMap *mapView = (ABI31_0_0AIRMap *)view;
        if (![view isKindOfClass:[ABI31_0_0AIRMap class]]) {
            reject(@"Invalid argument", [NSString stringWithFormat:@"Invalid view returned from registry, expecting ABI31_0_0AIRMap, got: %@", view], NULL);
        } else {
...
- (void)takeMapSnapshot:(ABI31_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI31_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI31_0_0AIRMap *map = (ABI31_0_0AIRMap *)recognizer.view;
    ...
    ABI31_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI31_0_0AIRMapPolygon class]]){
            ABI31_0_0AIRMapPolygon *polygon = (ABI31_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI31_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI31_0_0AIRMapPolyline class]]){
            ABI31_0_0AIRMapPolyline *polyline = (ABI31_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
        ...
        if ([overlay isKindOfClass:[ABI31_0_0AIRMapOverlay class]]) {
            ABI31_0_0AIRMapOverlay *imageOverlay = (ABI31_0_0AIRMapOverlay*) overlay;
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI31_0_0AIRMapPolyline class]]) {
        return ((ABI31_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI31_0_0AIRMapPolygon class]]) {
        return ((ABI31_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI31_0_0AIRMapCircle class]]) {
        return ((ABI31_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI31_0_0AIRMapUrlTile class]]) {
        return ((ABI31_0_0AIRMapUrlTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI31_0_0AIRMapLocalTile class]]) {
        return ((ABI31_0_0AIRMapLocalTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI31_0_0AIRMapOverlay class]]) {
        return ((ABI31_0_0AIRMapOverlay *)overlay).renderer;
...
- (void)mapView:(ABI31_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI31_0_0AIRMapMarker class]]) {
        [(ABI31_0_0AIRMapMarker *)view.annotation showCalloutView];
...
- (void)mapView:(ABI31_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI31_0_0AIRMapMarker class]]) {
        [(ABI31_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI31_0_0AIRMap *)mapView viewForAnnotation:(ABI31_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI31_0_0AIRMapMarker class]]) {
...
- (void)mapView:(ABI31_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI31_0_0AIRMapMarker class]]) return;
    ABI31_0_0AIRMapMarker *marker = (ABI31_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI31_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI31_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI31_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI31_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI31_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    [self _regionChanged:mapView];

    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI31_0_0AIRMapRegionChangeObserveInterval
                                                               target:self
                                                             selector:@selector(_onTick:)
                                                             userInfo:@{ ABI31_0_0RCTMapViewKey: mapView }
                                                              repeats:YES];

    [[NSRunLoop mainRunLoop] addTimer:mapView.regionChangeObserveTimer forMode:NSRunLoopCommonModes];
}

- (void)mapView:(ABI31_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI31_0_0AIRMap *)mapView
{
    if (!mapView.hasStartedRendering) {
      mapView.onMapReady(@{}); 
...
- (void)mapViewDidFinishRenderingMap:(ABI31_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
{
    [self _regionChanged:timer.userInfo[ABI31_0_0RCTMapViewKey]];
}

- (void)_regionChanged:(ABI31_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI31_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI31_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI31_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI31_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI31_0_0AIRMap *)mapView
{
...
- (MKCoordinateSpan)coordinateSpanWithMapView:(ABI31_0_0AIRMap *)mapView
                             centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                 andZoomLevel:(double)zoomLevel
{
    // convert center coordiate to pixel space
    double centerPixelX = [ABI31_0_0AIRMapManager longitudeToPixelSpaceX:centerCoordinate.longitude];
    double centerPixelY = [ABI31_0_0AIRMapManager latitudeToPixelSpaceY:centerCoordinate.latitude];

    // determine the scale value from the zoom level
    double zoomExponent = ABI31_0_0AIRMapMaxZoomLevel - zoomLevel;
    ...
    CLLocationDegrees minLng = [ABI31_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX];
    CLLocationDegrees maxLng = [ABI31_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX + scaledMapWidth];
    CLLocationDegrees longitudeDelta = maxLng - minLng;

    // find delta between top and bottom latitudes
    CLLocationDegrees minLat = [ABI31_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY];
    CLLocationDegrees maxLat = [ABI31_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY + scaledMapHeight];
                    ...
                    mapView:(ABI31_0_0AIRMap *)mapView
{
    ...
    zoomLevel = MIN(zoomLevel, ABI31_0_0AIRMapMaxZoomLevel);
                                    ...
                                    andZoomLevel:(double)zoomLevel
{
	...
	// find delta between top and bottom latitudes
	CLLocationDegrees minLat = [ABI31_0_0AIRMapManager pixelSpaceYToLatitude:topPixelY];
	CLLocationDegrees maxLat = [ABI31_0_0AIRMapManager pixelSpaceYToLatitude:bottomPixelY];
	CLLocationDegrees latitudeDelta = -1 * (maxLat - minLat);
	...
	if (adjustedCenterPoint) {
		region.center.latitude = [ABI31_0_0AIRMapManager pixelSpaceYToLatitude:((bottomPixelY + topPixelY) / 2.0)];
	}
...
- (double) zoomLevel:(ABI31_0_0AIRMap *)mapView {
    ...
    double centerPixelX = [ABI31_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude];
    double topLeftPixelX = [ABI31_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude - region.span.longitudeDelta / 2];

    double scaledMapWidth = (centerPixelX - topLeftPixelX) * 2;
    CGSize mapSizeInPixels = mapView.bounds.size;
    double zoomScale = scaledMapWidth / mapSizeInPixels.width;
    double zoomExponent = log(zoomScale) / log(2);
    double zoomLevel = ABI31_0_0AIRMapMaxZoomLevel - zoomExponent;
