...
@interface ABI31_0_0AIRMapOverlay()
@property (nonatomic, strong, readwrite) UIImage *overlayImage;
@end

@implementation ABI31_0_0AIRMapOverlay {
...
- (void)setImageSrc:(NSString *)imageSrc
{
    ...
    _reloadImageCancellationBlock = [_bridge.imageLoader loadImageWithURLRequest:[ABI31_0_0RCTConvert NSURLRequest:_imageSrc]
                                                                            size:weakSelf.bounds.size
                                                                           scale:ABI31_0_0RCTScreenScale()
                                                                         clipped:YES
                                                                      resizeMode:ABI31_0_0RCTResizeModeCenter
                                                                   progressBlock:nil
...
- (void)createOverlayRendererIfPossible
{
    ...
    __weak typeof(self) weakSelf = self;
    self.renderer = [[ABI31_0_0AIRMapOverlayRenderer alloc] initWithOverlay:weakSelf];
}
