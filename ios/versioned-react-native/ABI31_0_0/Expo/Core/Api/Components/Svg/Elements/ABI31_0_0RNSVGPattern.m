...
@implementation ABI31_0_0RNSVGPattern
...
- (void)parseReference
{
    NSArray<ABI31_0_0RNSVGLength *> *points = @[self.x, self.y, self.patternwidth, self.patternheight];
...
- (void)setPatternwidth:(ABI31_0_0RNSVGLength *)patternwidth
{
...
- (void)setPatternheight:(ABI31_0_0RNSVGLength *)patternheight
{
...
- (void)setPatternUnits:(ABI31_0_0RNSVGUnits)patternUnits
{
...
- (void)setPatternContentUnits:(ABI31_0_0RNSVGUnits)patternContentUnits
{
