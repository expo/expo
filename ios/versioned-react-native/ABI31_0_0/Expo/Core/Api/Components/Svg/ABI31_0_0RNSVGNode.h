...
/**
 * ABI31_0_0RNSVG nodes are implemented as base UIViews. They should be implementation for all basic
 ＊interfaces for all non-defination nodes.
 */

@interface ABI31_0_0RNSVGNode : UIView
 ...
 */
extern CGFloat const ABI31_0_0RNSVG_M_SQRT1_2l;
extern CGFloat const ABI31_0_0RNSVG_DEFAULT_FONT_SIZE;

@property (nonatomic, strong) NSString *name;
@property (nonatomic, assign) CGFloat opacity;
@property (nonatomic, assign) ABI31_0_0RNSVGCGFCRule clipRule;
...
/**
 * ABI31_0_0RNSVGSvgView which ownes current ABI31_0_0RNSVGNode
 */
@property (nonatomic, readonly, weak) ABI31_0_0RNSVGSvgView *svgView;
@property (nonatomic, readonly, weak) ABI31_0_0RNSVGGroup *textRoot;
