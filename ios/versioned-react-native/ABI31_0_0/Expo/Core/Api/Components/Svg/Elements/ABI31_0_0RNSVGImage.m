...
#import <ReactABI31_0_0/ABI31_0_0RCTImageSource.h>
#import <ReactABI31_0_0/ABI31_0_0RCTImageLoader.h>
#import <ReactABI31_0_0/ABI31_0_0RCTLog.h>
#import "ABI31_0_0RNSVGViewBox.h"

@implementation ABI31_0_0RNSVGImage
{
    CGImageRef _image;
    CGSize _imageSize;
    ABI31_0_0RCTImageLoaderCancellationBlock _reloadImageCancellationBlock;
}
...
- (void)setSrc:(id)src
{
    ...
    ABI31_0_0RCTImageSource *source = [ABI31_0_0RCTConvert ABI31_0_0RCTImageSource:src];
    ...
    ABI31_0_0RCTImageLoaderCancellationBlock previousCancellationBlock = _reloadImageCancellationBlock;
    if (previousCancellationBlock) {
        previousCancellationBlock();
        _reloadImageCancellationBlock = nil;
    }

    _reloadImageCancellationBlock = [self.bridge.imageLoader loadImageWithURLRequest:[ABI31_0_0RCTConvert NSURLRequest:src] callback:^(NSError *error, UIImage *image) {
...
- (void)setImagewidth:(ABI31_0_0RNSVGLength *)width
{
...
- (void)setImageheight:(ABI31_0_0RNSVGLength *)height
{
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    CGAffineTransform viewbox = [ABI31_0_0RNSVGViewBox getTransform:imageBounds eRect:hitArea align:self.align meetOrSlice:self.meetOrSlice];
