...
@implementation ABI31_0_0RNSVGLength
...
{
    ABI31_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype) lengthWithString: (NSString *) lengthString {
    ...
    ABI31_0_0RNSVGLength *output = [ABI31_0_0RNSVGLength alloc];
    if (stringLength == 0) {
        ...
        ABI31_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
