...
@implementation ABI31_0_0RNSVGMask
...
- (void)setX:(ABI31_0_0RNSVGLength *)x
{
    if ([x isEqualTo:_x]) {
        return;
    }
...
- (void)setY:(ABI31_0_0RNSVGLength *)y
{
    if ([y isEqualTo:_y]) {
        return;
    }
...
- (void)setMaskwidth:(ABI31_0_0RNSVGLength *)maskwidth
{
...
- (void)setMaskheight:(ABI31_0_0RNSVGLength *)maskheight
{
...
- (void)setMaskUnits:(ABI31_0_0RNSVGUnits)maskUnits
{
...
- (void)setMaskContentUnits:(ABI31_0_0RNSVGUnits)maskContentUnits
{
