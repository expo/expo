...
#import "ABI31_0_0RNSVGBezierElement.h"

#pragma mark - Bezier Element -

@implementation ABI31_0_0RNSVGBezierElement
- (instancetype) init
{
    self = [super init];
    if (self)
    {
        ...
        _point = ABI31_0_0RNSVGNULLPOINT;
        _controlPoint1 = ABI31_0_0RNSVGNULLPOINT;
        _controlPoint2 = ABI31_0_0RNSVGNULLPOINT;
    }
    return self;
}
...
{
    ABI31_0_0RNSVGBezierElement *newElement = [[self alloc] init];
...
// Convert one element to ABI31_0_0RNSVGBezierElement and save to array
void ABI31_0_0RNSVGBezierElement_getBezierElements(void *info, const CGPathElement *element)
{
    NSMutableArray *bezierElements = (__bridge NSMutableArray *)info;
    if (element)
        [bezierElements addObject:[ABI31_0_0RNSVGBezierElement elementWithPathElement:*element]];
}
...
+ (NSArray *) elementsFromCGPath:(CGPathRef)path
{
    ...
    CGPathApply(path, (__bridge void *)elements, ABI31_0_0RNSVGBezierElement_getBezierElements);
    return elements;
}
