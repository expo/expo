...
- (id)init
{
    if (self = [super init]) {
        _fillOpacity = 1;
        _strokeOpacity = 1;
        _strokeWidth = [ABI31_0_0RNSVGLength lengthWithNumber:1];
...
- (void)setFill:(ABI31_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI31_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI31_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)setStrokeWidth:(ABI31_0_0RNSVGLength*)strokeWidth
{
...
- (void)setStrokeDasharray:(NSArray<ABI31_0_0RNSVGLength *> *)strokeDasharray
{
...
UInt32 ABI31_0_0saturate(CGFloat value) {
...
- (void)renderTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    if (self.mask) {
        ...
        ABI31_0_0RNSVGMask *_maskNode = (ABI31_0_0RNSVGMask*)[self.svgView getDefinedMask:self.mask];
        ...
        for (NSUInteger i = 0; i < npixels; i++) {
            ...
            *currentPixel = ABI31_0_0saturate(luma) << 24;
            currentPixel++;
        }
...
- (void)prepareStrokeDash:(NSUInteger)count strokeDasharray:(NSArray<ABI31_0_0RNSVGLength *> *)strokeDasharray {
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    if (self.fill) {
        if (self.fill.class == ABI31_0_0RNSVGBrush.class) {
    ...
    if (self.stroke) {
        ...
        NSArray<ABI31_0_0RNSVGLength *>* strokeDasharray = self.strokeDasharray;
        ...
        if (self.stroke.class == ABI31_0_0RNSVGBrush.class) {
