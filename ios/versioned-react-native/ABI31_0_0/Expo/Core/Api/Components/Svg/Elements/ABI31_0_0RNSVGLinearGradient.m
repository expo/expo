...
#import "ABI31_0_0RNSVGBrushType.h"

@implementation ABI31_0_0RNSVGLinearGradient


- (void)setX1:(ABI31_0_0RNSVGLength *)x1
{
    if ([x1 isEqualTo:_x1]) {
        return;
    }
...
- (void)setY1:(ABI31_0_0RNSVGLength *)y1
{
    if ([y1 isEqualTo:_y1]) {
        return;
    }
...
- (void)setX2:(ABI31_0_0RNSVGLength *)x2
{
    if ([x2 isEqualTo:_x2]) {
        return;
    }
...
- (void)setY2:(ABI31_0_0RNSVGLength *)y2
{
    if ([y2 isEqualTo:_y2]) {
        return;
    }
...
- (void)parseReference
{
    NSArray<ABI31_0_0RNSVGLength *> *points = @[self.x1, self.y1, self.x2, self.y2];
