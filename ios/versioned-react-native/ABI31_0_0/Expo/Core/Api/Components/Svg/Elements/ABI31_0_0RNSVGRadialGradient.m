...
@implementation ABI31_0_0RNSVGRadialGradient

- (void)setFx:(ABI31_0_0RNSVGLength *)fx
{
    if ([fx isEqualTo:_fx]) {
        return;
    }
...
- (void)setFy:(ABI31_0_0RNSVGLength *)fy
{
    if ([fy isEqualTo:_fy]) {
        return;
    }
...
- (void)setRx:(ABI31_0_0RNSVGLength *)rx
{
    if ([rx isEqualTo:_rx]) {
        return;
    }
...
- (void)setRy:(ABI31_0_0RNSVGLength *)ry
{
    if ([ry isEqualTo:_ry]) {
        return;
    }
...
- (void)setCx:(ABI31_0_0RNSVGLength *)cx
{
    if ([cx isEqualTo:_cx]) {
        return;
    }
...
- (void)setCy:(ABI31_0_0RNSVGLength *)cy
{
    if ([cy isEqualTo:_cy]) {
        return;
    }
...
- (void)setGradientUnits:(ABI31_0_0RNSVGUnits)gradientUnits
{
...
- (void)parseReference
{
    NSArray<ABI31_0_0RNSVGLength *> *points = @[self.fx, self.fy, self.rx, self.ry, self.cx, self.cy];
    ABI31_0_0RNSVGPainter *painter = [[ABI31_0_0RNSVGPainter alloc] initWithPointsArray:points];
