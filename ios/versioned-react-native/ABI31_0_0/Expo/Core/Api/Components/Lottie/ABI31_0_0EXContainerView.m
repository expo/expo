...
#if __has_include(<ReactABI31_0_0/UIView+ReactABI31_0_0.h>)
#import <ReactABI31_0_0/UIView+ReactABI31_0_0.h>
#elif __has_include("UIView+ReactABI31_0_0.h")
#import "UIView+ReactABI31_0_0.h"
#else
#import "ReactABI31_0_0/UIView+ReactABI31_0_0.h"
#endif

@implementation ABI31_0_0EXContainerView {
...
- (void)ReactABI31_0_0SetFrame:(CGRect)frame
{
  ...
  if (_animationView != nil) {
    [_animationView ReactABI31_0_0SetFrame:frame];
  }
}
...
- (void)replaceAnimationView:(LOTAnimationView *)next {
  ...
  [_animationView ReactABI31_0_0SetFrame:self.frame];
  [_animationView setContentMode:UIViewContentModeScaleAspectFit];
