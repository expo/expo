//
//  ABI31_0_0AIRGoogleMapPolygon.m
//
...
@implementation ABI31_0_0AIRGoogleMapPolygon

- (instancetype)init
{
  if (self = [super init]) {
    _polygon = [[ABI31_0_0AIRGMSPolygon alloc] init];
  }
...
- (void)setHoles:(NSArray<NSArray<ABI31_0_0AIRMapCoordinate *> *> *)holes
{
  _holes = holes;
...
- (void)setOnPress:(ABI31_0_0RCTBubblingEventBlock)onPress {
