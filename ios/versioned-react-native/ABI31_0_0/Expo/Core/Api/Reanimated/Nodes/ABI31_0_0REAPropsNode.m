#import "ABI31_0_0REAPropsNode.h"

#import "ABI31_0_0REANodesManager.h"
#import "ABI31_0_0REAStyleNode.h"
#import "ABI31_0_0REAModule.h"

#import <ReactABI31_0_0/ABI31_0_0RCTLog.h>
#import <ReactABI31_0_0/ABI31_0_0RCTUIManager.h>
#import "ReactABI31_0_0/ABI31_0_0RCTComponentData.h"

@implementation ABI31_0_0REAPropsNode
{
  NSNumber *_connectedViewTag;
  NSString *_connectedViewName;
  NSMutableDictionary<NSString *, ABI31_0_0REANodeID> *_propsConfig;
}
...
- (id)evaluate
{
  ...
  for (NSString *prop in _propsConfig) {
    ABI31_0_0REANode *propNode = [self.nodesManager findNodeByID:_propsConfig[prop]];
    
    if ([propNode isKindOfClass:[ABI31_0_0REAStyleNode class]]) {
