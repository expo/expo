#import "ABI31_0_0REAClockNodes.h"
#import "ABI31_0_0REANodesManager.h"

@interface ABI31_0_0REAClockNode ()
...
@implementation ABI31_0_0REAClockNode
...
- (void)start
{
  ...
  __weak ABI31_0_0REAClockNode *weakSelf = self;
...
@implementation ABI31_0_0REAClockOpNode {
...
- (ABI31_0_0REAClockNode*)clockNode
{
  return (ABI31_0_0REAClockNode*)[self.nodesManager findNodeByID:_clockNodeID];
}

@end

@implementation ABI31_0_0REAClockStartNode
...
@implementation ABI31_0_0REAClockStopNode
...
@implementation ABI31_0_0REAClockTestNode
