...
#if !TARGET_OS_TV
@interface ABI31_0_0RCTConvert (UINotificationFeedback)

+ (UINotificationFeedbackType)UINotificationFeedbackType:(id)json;

@end

@interface ABI31_0_0RCTConvert (UIImpactFeedback)
...
@interface ABI31_0_0EXHaptic : NSObject <ABI31_0_0RCTBridgeModule>
