...
#import "ABI31_0_0EXScreenOrientation.h"
#import "ABI31_0_0EXScopedModuleRegistry.h"

#import <UIKit/UIKit.h>
#import <sys/utsname.h>

@interface ABI31_0_0EXScreenOrientation ()

@property (nonatomic, weak) id<ABI31_0_0EXScreenOrientationScopedModuleDelegate> kernelOrientationServiceDelegate;

@end

static int INVALID_MASK = 0;

@implementation ABI31_0_0EXScreenOrientation

ABI31_0_0EX_EXPORT_SCOPED_MODULE(ExponentScreenOrientation, ScreenOrientationManager);
...
ABI31_0_0RCT_EXPORT_METHOD(allowAsync:(NSString *)orientation
...
ABI31_0_0RCT_EXPORT_METHOD(doesSupportAsync:(NSString *)orientation
                  resolver:(ABI31_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI31_0_0RCTPromiseRejectBlock)reject)
{
  UIInterfaceOrientationMask orientationMask = [self orientationMaskFromOrientation:orientation];
