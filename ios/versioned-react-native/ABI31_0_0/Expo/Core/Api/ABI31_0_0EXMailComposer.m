...
#import "ABI31_0_0EXMailComposer.h"
...
@interface ABI31_0_0EXMailComposer ()

@property (nonatomic, strong) ABI31_0_0RCTPromiseResolveBlock resolve;
@property (nonatomic, strong) ABI31_0_0RCTPromiseRejectBlock reject;

@end

@implementation ABI31_0_0EXMailComposer

ABI31_0_0RCT_EXPORT_MODULE(ExponentMailComposer);
...
ABI31_0_0RCT_EXPORT_METHOD(composeAsync:(NSDictionary *)options
                  ...
                  rejecter:(ABI31_0_0RCTPromiseRejectBlock)reject)
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    [ABI31_0_0RCTPresentedViewController() presentViewController:composeController animated:YES completion:nil];
  });
}
