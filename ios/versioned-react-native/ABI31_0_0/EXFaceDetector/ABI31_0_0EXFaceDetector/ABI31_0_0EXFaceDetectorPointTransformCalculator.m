//
//  ABI31_0_0EXFaceDetectorPointTransformCalculator.m
//  Exponent
//
...
#import <ABI31_0_0EXFaceDetector/ABI31_0_0EXFaceDetectorPointTransformCalculator.h>
...
typedef NS_ENUM(NSInteger, ABI31_0_0EXTranslationEnum) {
  ABI31_0_0EXTranslateYNegativeWidth,
  ABI31_0_0EXTranslateXNegativeHeight,
  ABI31_0_0EXTranslateXYNegative,
  ABI31_0_0EXTranslateYXNegative
};

@interface ABI31_0_0EXFaceDetectorPointTransformCalculator()
...
@implementation ABI31_0_0EXFaceDetectorPointTransformCalculator
...
- (CGPoint)translation
{
  ...
  AVCaptureVideoOrientation firstOrientation = MIN(_fromOrientation, _toOrientation);
  AVCaptureVideoOrientation secondOrientation = MAX(_fromOrientation, _toOrientation);
  ABI31_0_0EXTranslationEnum enumValue = [[[self class] getTranslationDictionary][@(firstOrientation)][@(secondOrientation)] intValue];
...
- (CGPoint)translationForEnum:(ABI31_0_0EXTranslationEnum)enumValue
{
  switch (enumValue) {
    case ABI31_0_0EXTranslateXNegativeHeight:
      return CGPointMake(-_videoHeight, 0);
    case ABI31_0_0EXTranslateYNegativeWidth:
      return CGPointMake(0, -_videoWidth);
    case ABI31_0_0EXTranslateXYNegative:
      return CGPointMake(-_videoWidth, -_videoHeight);
    case ABI31_0_0EXTranslateYXNegative:
...
+ (void)initTranslationDictionary
{
  translationDictionary = @{
                            @(AVCaptureVideoOrientationPortrait): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI31_0_0EXTranslateYNegativeWidth),
                                @(AVCaptureVideoOrientationLandscapeRight) : @(ABI31_0_0EXTranslateXNegativeHeight),
                                @(AVCaptureVideoOrientationPortraitUpsideDown) : @(ABI31_0_0EXTranslateYXNegative)
                                },
                            @(AVCaptureVideoOrientationPortraitUpsideDown): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI31_0_0EXTranslateXNegativeHeight),
                                @(AVCaptureVideoOrientationLandscapeRight) : @(ABI31_0_0EXTranslateYNegativeWidth)
                                },
                            @(AVCaptureVideoOrientationLandscapeRight): @{
                                @(AVCaptureVideoOrientationLandscapeLeft) : @(ABI31_0_0EXTranslateXYNegative)
                                }
                            };
}
