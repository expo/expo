...
#import "ABI31_0_0CSBufferOrientationCalculator.h"
...
@implementation ABI31_0_0CSBufferOrientationCalculator
                                               ...
                                               andMirrored:(BOOL)mirrored
{
  CGAffineTransform rotationTransform = CGAffineTransformConcat(
                                                                [ABI31_0_0CSBufferOrientationCalculator rotationTransformForOrientation:orientation],
                                                                [ABI31_0_0CSBufferOrientationCalculator transformForMirror:orientation forMirrored:mirrored]);
  CGAffineTransform rotationWithTranslation = [ABI31_0_0CSBufferOrientationCalculator rotationWithTranslation:rotationTransform forVideoWidth:videoWidth forVideoHeight:videoHeight];
  
  CGFloat scaleFactor = [ABI31_0_0CSBufferOrientationCalculator scaleForCropWithPreservingAspectRatioforBufferWidth:bufferWidth andBufferHeight:bufferHeight andVideoWidth:videoWidth andVideoHeight:videoHeight];
  
  CGAffineTransform cropTranslation = [ABI31_0_0CSBufferOrientationCalculator cropTranslationsTransformationForRotation:rotationWithTranslation andScale:scaleFactor andBufferWidth:bufferWidth andBufferHeight:bufferHeight andVideoWidth:videoWidth andVideoHeight:videoHeight];
