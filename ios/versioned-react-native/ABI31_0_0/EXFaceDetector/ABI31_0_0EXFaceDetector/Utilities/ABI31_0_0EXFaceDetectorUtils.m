//
//  ABI31_0_0EXFaceDetectorUtils.m
//  Exponent
//
...
NSString *const ABI31_0_0EXGMVDataOutputWidthKey = @"Width";
NSString *const ABI31_0_0EXGMVDataOutputHeightKey = @"Height";

@implementation ABI31_0_0EXFaceDetectorUtils

+ (NSDictionary *)constantsToExport
{
  return @{
           @"Mode" : @{
               @"fast" : @(ABI31_0_0EXFaceDetectionFastMode),
               @"accurate" : @(ABI31_0_0EXFaceDetectionAccurateMode)
               },
           @"Landmarks" : @{
               @"all" : @(ABI31_0_0EXFaceDetectAllLandmarks),
               @"none" : @(ABI31_0_0EXFaceDetectNoLandmarks)
               },
           @"Classifications" : @{
               @"all" : @(ABI31_0_0EXFaceRunAllClassifications),
               @"none" : @(ABI31_0_0EXFaceRunNoClassifications)
               }
           };
}
...
{
  ABI31_0_0EXFaceDetectorPointTransformCalculator *calculator = [[ABI31_0_0EXFaceDetectorPointTransformCalculator alloc] initToTransformFromOrientation:deviceVideoOrientation toOrientation:interfaceVideoOrientation forVideoWidth:[width floatValue] andVideoHeight:[height floatValue]];
...
+ (CGAffineTransform)transformFromDeviceOutput:(GMVDataOutput *)dataOutput withInterfaceOrientation:(AVCaptureVideoOrientation)interfaceVideoOrientation
{
  ...
  CGFloat xScale = interfaceWidth / [(NSNumber *)dataOutput.videoSettings[ABI31_0_0EXGMVDataOutputHeightKey] floatValue];
  CGFloat yScale = interfaceHeight / [(NSNumber *)dataOutput.videoSettings[ABI31_0_0EXGMVDataOutputWidthKey] floatValue];
...
+ (CGAffineTransform)transformFromDeviceOutput:(GMVDataOutput *)dataOutput toInterfaceVideoOrientation:(AVCaptureVideoOrientation)interfaceVideoOrientation
{
  ...
  NSNumber *videoWidth = dataOutput.videoSettings[ABI31_0_0EXGMVDataOutputWidthKey];
  NSNumber *videoHeight = dataOutput.videoSettings[ABI31_0_0EXGMVDataOutputHeightKey];
