...
#import <ABI31_0_0EXLocation/ABI31_0_0EXLocation.h>
#import <ABI31_0_0EXLocation/ABI31_0_0EXLocationDelegate.h>
...
NSString * const ABI31_0_0EXLocationChangedEventName = @"Exponent.locationChanged";
NSString * const ABI31_0_0EXHeadingChangedEventName = @"Exponent.headingChanged";

@interface ABI31_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI31_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) NSMutableSet<ABI31_0_0EXLocationDelegate *> *retainedDelegates;
@property (nonatomic, assign, getter=isPaused) BOOL paused;
@property (nonatomic, weak) id<ABI31_0_0EXEventEmitterService> eventEmitter;
@property (nonatomic, weak) id<ABI31_0_0EXPermissionsInterface> permissions;
@property (nonatomic, weak) id<ABI31_0_0EXAppLifecycleService> lifecycleService;

@end

@implementation ABI31_0_0EXLocation

ABI31_0_0EX_EXPORT_MODULE(ExpoLocation);
...
- (void)setModuleRegistry:(ABI31_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  _permissions = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI31_0_0EXPermissionsInterface)];
  _lifecycleService = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI31_0_0EXAppLifecycleService)];
...
{
  return @[ABI31_0_0EXLocationChangedEventName, ABI31_0_0EXHeadingChangedEventName];
}
...
ABI31_0_0EX_EXPORT_METHOD_AS(getProviderStatusAsync,
...
ABI31_0_0EX_EXPORT_METHOD_AS(getCurrentPositionAsync,
                    ...
                    rejecter:(ABI31_0_0EXPromiseRejectBlock)reject)
{
  ...
  __block ABI31_0_0EXLocationDelegate *delegate;

  delegate = [[ABI31_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (delegate != nil) {
      if (locations.lastObject != nil) {
        resolve([ABI31_0_0EXLocation exportLocation:locations.lastObject]);
      } else {
...
ABI31_0_0EX_EXPORT_METHOD_AS(watchPositionImplAsync,
                    ...
                    rejecter:(ABI31_0_0EXPromiseRejectBlock)reject)
{
  ...
  ABI31_0_0EXLocationDelegate *delegate = [[ABI31_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject != nil && weakSelf != nil) {
      ...
      NSDictionary *body = @{
                             @"watchId": watchId,
                             @"location": [ABI31_0_0EXLocation exportLocation:loc],
                             };

      [strongSelf->_eventEmitter sendEventWithName:ABI31_0_0EXLocationChangedEventName body:body];
    }
...
ABI31_0_0EX_EXPORT_METHOD_AS(watchDeviceHeading,
  ...
  ABI31_0_0EXLocationDelegate *delegate = [[ABI31_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
    if (newHeading != nil && weakSelf != nil) {
      ...
      [strongSelf->_eventEmitter sendEventWithName:ABI31_0_0EXHeadingChangedEventName body:body];
    }
...
ABI31_0_0EX_EXPORT_METHOD_AS(removeWatchAsync,
                    watchId:(nonnull NSNumber *)watchId
                    resolver:(ABI31_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI31_0_0EXPromiseRejectBlock)reject)
{
  ABI31_0_0EXLocationDelegate *delegate = _delegates[watchId];
...
ABI31_0_0EX_EXPORT_METHOD_AS(geocodeAsync,
...
ABI31_0_0EX_EXPORT_METHOD_AS(reverseGeocodeAsync,
...
ABI31_0_0EX_EXPORT_METHOD_AS(requestPermissionsAsync,
                    requestPermissionsResolver:(ABI31_0_0EXPromiseResolveBlock)resolve
                                      rejecter:(ABI31_0_0EXPromiseRejectBlock)reject)
{
  if (_permissions == nil) {
...
- (BOOL)checkPermissions:(ABI31_0_0EXPromiseRejectBlock)reject
{
