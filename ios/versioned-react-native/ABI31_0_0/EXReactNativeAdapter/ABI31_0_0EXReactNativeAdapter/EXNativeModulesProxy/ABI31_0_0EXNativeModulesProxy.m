...
@interface ABI31_0_0EXNativeModulesProxy ()

@property (nonatomic, strong) NSRegularExpression *regexp;
@property (nonatomic, strong) ABI31_0_0EXModuleRegistry *moduleRegistry;
...
@implementation ABI31_0_0EXNativeModulesProxy
...
# pragma mark - ReactABI31_0_0 API
...
- (NSDictionary *)constantsToExport
{
  ...
  NSArray<ABI31_0_0EXViewManager *> *viewManagers = [_moduleRegistry getAllViewManagers];
...
ABI31_0_0RCT_EXPORT_METHOD(callMethod:(NSString *)moduleName methodNameOrKey:(id)methodNameOrKey arguments:(NSArray *)arguments resolver:(ABI31_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI31_0_0RCTPromiseRejectBlock)reject)
{
