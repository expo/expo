...
#import <ABI31_0_0EXPrint/ABI31_0_0EXPrint.h>
#import <ABI31_0_0EXPrint/ABI31_0_0EXPrintPDFRenderTask.h>
...
NSString *const ABI31_0_0EXPrintOrientationPortrait = @"portrait";
NSString *const ABI31_0_0EXPrintOrientationLandscape = @"landscape";

@interface ABI31_0_0EXPrint () <UIPrintInteractionControllerDelegate, UIPrinterPickerControllerDelegate>
...
@implementation ABI31_0_0EXPrint

ABI31_0_0EX_EXPORT_MODULE(ExponentPrint);
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"Orientation": @{
               @"portrait": ABI31_0_0EXPrintOrientationPortrait,
               @"landscape": ABI31_0_0EXPrintOrientationLandscape,
               },
           };
}

ABI31_0_0EX_EXPORT_METHOD_AS(print,
                    ...
                    rejecter:(ABI31_0_0EXPromiseRejectBlock)reject)
{
  [self _getPrintingDataForOptions:options callback:^(NSData *printingData, NSDictionary *errorDetails) {
    if (errorDetails != nil) {
      reject(errorDetails[@"code"], errorDetails[@"message"], ABI31_0_0EXErrorWithMessage(errorDetails[@"message"]));
      return;
    }
    ...
    if (printingData == nil) {
      ...
      if (options[@"markupFormatterIOS"] && [options[@"markupFormatterIOS"] isKindOfClass:[NSString class]]) {
        ...
        if (htmlString != nil) {
          ...
          reject(@"E_HTML_INVALID", message, ABI31_0_0EXErrorWithMessage(message));
          return;
        }
      } else {
...
ABI31_0_0EX_EXPORT_METHOD_AS(selectPrinter,selectPrinter:(ABI31_0_0EXPromiseResolveBlock)resolve
                  rejecter:(ABI31_0_0EXPromiseRejectBlock)reject)
{
...
ABI31_0_0EX_EXPORT_METHOD_AS(printToFileAsync,
                    ...
                    reject:(ABI31_0_0EXPromiseRejectBlock)reject)
{
  ...
  ABI31_0_0EXPrintPDFRenderTask *renderTask = [ABI31_0_0EXPrintPDFRenderTask new];
...
{
  id<ABI31_0_0EXUtilitiesInterface> utils = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI31_0_0EXUtilitiesInterface)];
...
- (void)_getPrintingDataForOptions:(nonnull NSDictionary *)options callback:(void(^)(NSData *, NSDictionary *))callback
{
  ...
  if (options[@"html"]) {
    __block ABI31_0_0EXPrintPDFRenderTask *renderTask = [ABI31_0_0EXPrintPDFRenderTask new];
...
{
  if ([orientation isEqualToString:ABI31_0_0EXPrintOrientationLandscape]) {
