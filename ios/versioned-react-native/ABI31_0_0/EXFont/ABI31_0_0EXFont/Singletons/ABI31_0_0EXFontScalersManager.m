...
@implementation UIFont (ABI31_0_0EXFontLoader)

- (UIFont *)ABI31_0_0EXFontWithSize:(CGFloat)fontSize
{
  for (id<ABI31_0_0EXFontScalerInterface> fontScaler in currentFontScalers) {
  ...
  return [self ABI31_0_0EXFontWithSize:fontSize];
}
...
@implementation ABI31_0_0EXFontScalersManager

ABI31_0_0EX_REGISTER_SINGLETON_MODULE(FontScalersManager);
...
+ (void)initialize
{
  ...
  dispatch_once(&initializeCurrentFontScalersOnce, ^{
    ...
    SEL exUpdate = @selector(ABI31_0_0EXFontWithSize:);
...
- (void)registerFontScaler:(id<ABI31_0_0EXFontScalerInterface>)fontScaler
{
