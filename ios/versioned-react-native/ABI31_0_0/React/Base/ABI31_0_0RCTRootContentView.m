...
#import "ABI31_0_0RCTTouchHandler.h"
#import "ABI31_0_0RCTUIManager.h"
#import "UIView+ReactABI31_0_0.h"

@implementation ABI31_0_0RCTRootContentView

- (instancetype)initWithFrame:(CGRect)frame
                       bridge:(ABI31_0_0RCTBridge *)bridge
                     ReactABI31_0_0Tag:(NSNumber *)ReactABI31_0_0Tag
               sizeFlexiblity:(ABI31_0_0RCTRootViewSizeFlexibility)sizeFlexibility
{
  if ((self = [super initWithFrame:frame])) {
    _bridge = bridge;
    self.ReactABI31_0_0Tag = ReactABI31_0_0Tag;
    _sizeFlexibility = sizeFlexibility;
    _touchHandler = [[ABI31_0_0RCTTouchHandler alloc] initWithBridge:_bridge];
...
ABI31_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithCoder:(nonnull NSCoder *)aDecoder)
...
- (CGSize)availableSize
{
  ...
  return CGSizeMake(
      _sizeFlexibility & ABI31_0_0RCTRootViewSizeFlexibilityWidth ? INFINITY : size.width,
      _sizeFlexibility & ABI31_0_0RCTRootViewSizeFlexibilityHeight ? INFINITY : size.height
    );
}

- (void)updateAvailableSize
{
  if (!self.ReactABI31_0_0Tag || !_bridge.isValid) {
    return;
  }
...
- (void)invalidate
{
  if (self.userInteractionEnabled) {
    ...
    [(ABI31_0_0RCTRootView *)self.superview contentViewInvalidated];

    [_bridge enqueueJSCall:@"AppRegistry"
                    method:@"unmountApplicationComponentAtRootTag"
                      args:@[self.ReactABI31_0_0Tag]
                completion:NULL];
  }
}
