 ...
 */
@interface ABI31_0_0RCTImageSource : NSObject
...
@interface ABI31_0_0RCTConvert (ImageSource)

+ (ABI31_0_0RCTImageSource *)ABI31_0_0RCTImageSource:(id)json;
+ (NSArray<ABI31_0_0RCTImageSource *> *)ABI31_0_0RCTImageSourceArray:(id)json;
