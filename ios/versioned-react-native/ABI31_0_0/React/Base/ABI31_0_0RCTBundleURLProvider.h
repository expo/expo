...
extern NSString *const ABI31_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI31_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI31_0_0RCTBundleURLProvider : NSObject
