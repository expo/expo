...
@interface ABI31_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI31_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI31_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI31_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI31_0_0RCTMultipartStreamReader *reader = [[ABI31_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI31_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
