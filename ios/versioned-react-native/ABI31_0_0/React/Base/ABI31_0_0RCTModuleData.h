...
typedef id<ABI31_0_0RCTBridgeModule>(^ABI31_0_0RCTBridgeModuleProvider)(void);

@interface ABI31_0_0RCTModuleData : NSObject <ABI31_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI31_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI31_0_0RCTBridgeModule> instance;
