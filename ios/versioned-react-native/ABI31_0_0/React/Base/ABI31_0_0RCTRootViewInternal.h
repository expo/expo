 ...
 * classes to change the ABI31_0_0RCTRootViews's internal state.
 */
@interface ABI31_0_0RCTRootView ()

/**
 * This setter should be used only by ABI31_0_0RCTUIManager on ReactABI31_0_0 root view
...
@property (nonatomic, strong) UIView *ReactABI31_0_0PreferredFocusedView;
#endif
