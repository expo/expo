...
#import <ReactABI31_0_0/ABI31_0_0RCTJavaScriptLoader.h>

@class ABI31_0_0RCTBridge;
@protocol ABI31_0_0RCTBridgeModule;

@protocol ABI31_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI31_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI31_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI31_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI31_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI31_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI31_0_0RCTBridge *)bridge;
...
*/
- (BOOL)bridge:(ABI31_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI31_0_0RCTBridge *)bridge
                 onProgress:(ABI31_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI31_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI31_0_0RCTBridge *)bridge
                  withBlock:(ABI31_0_0RCTSourceLoadBlock)loadCallback;
