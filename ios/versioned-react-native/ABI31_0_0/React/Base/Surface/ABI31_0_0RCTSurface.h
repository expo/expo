...
@class ABI31_0_0RCTSurfaceView;
@protocol ABI31_0_0RCTSurfaceDelegate;

/**
 * ABI31_0_0RCTSurface instance represents ReactABI31_0_0 Native-powered piece of a user interface
 * which can be a full-screen app, separate modal view controller,
 * or even small widget.
 * It is called "Surface".
 *
 * The ABI31_0_0RCTSurface instance is completely thread-safe by design;
 ...
 *
 * The primary goals of the ABI31_0_0RCTSurface are:
 ...
 */
@interface ABI31_0_0RCTSurface : NSObject

@property (atomic, readonly) ABI31_0_0RCTSurfaceStage stage;
@property (atomic, readonly) NSString *moduleName;
@property (atomic, readonly) NSNumber *rootViewTag;

@property (atomic, readwrite, weak, nullable) id<ABI31_0_0RCTSurfaceDelegate> delegate;
 ...
 * ABI31_0_0RCTSurface does not control (or influence in any way) the size or origin
...
/**
 * Simple shortcut to `-[ABI31_0_0RCTSurface setMinimumSize:size maximumSize:size]`.
 */
 ...
 *  - Calling on the main queue with `ABI31_0_0RCTSurfaceStageSurfaceDidInitialMounting`
 *    stage temporary is not supported; in this case the stage will be
 *    downgraded to `ABI31_0_0RCTSurfaceStageSurfaceDidInitialLayout`.
 */
- (BOOL)synchronouslyWaitForStage:(ABI31_0_0RCTSurfaceStage)stage timeout:(NSTimeInterval)timeout;

#pragma mark - Mounting/Unmounting of ReactABI31_0_0 components

/**
 * Mount the ReactABI31_0_0 component specified by the given moduleName. This is typically
 * calling runApplication.js from the native side.
 */
- (void)mountReactABI31_0_0ComponentWithBridge:(ABI31_0_0RCTBridge *)bridge moduleName:(NSString *)moduleName params:(NSDictionary *)params;

/**
 * Unmount the ReactABI31_0_0 component specified by the given rootViewTag, called from native.
 */
- (void)unmountReactABI31_0_0ComponentWithBridge:(ABI31_0_0RCTBridge *)bridge rootViewTag:(NSNumber *)rootViewTag;
