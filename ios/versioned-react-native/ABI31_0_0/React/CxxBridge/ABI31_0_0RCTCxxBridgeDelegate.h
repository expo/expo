...
@protocol ABI31_0_0RCTCxxBridgeDelegate <ABI31_0_0RCTBridgeDelegate>

/**
 * In the ABI31_0_0RCTCxxBridge, if this method is implemented, return a
 ...
 * will be used.
 */
- (std::unique_ptr<facebook::ReactABI31_0_0::JSExecutorFactory>)jsExecutorFactoryForBridge:(ABI31_0_0RCTBridge *)bridge;
