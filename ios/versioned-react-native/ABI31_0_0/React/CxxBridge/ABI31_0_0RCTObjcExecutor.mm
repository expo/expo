...
#import "ABI31_0_0RCTObjcExecutor.h"
...
#import <ReactABI31_0_0/ABI31_0_0RCTProfile.h>
#import <ReactABI31_0_0/ABI31_0_0RCTUtils.h>
#import <cxxReactABI31_0_0/ABI31_0_0JSBigString.h>
#import <cxxReactABI31_0_0/ABI31_0_0JSExecutor.h>
#import <cxxReactABI31_0_0/ABI31_0_0MessageQueueThread.h>
#import <cxxReactABI31_0_0/ABI31_0_0ModuleRegistry.h>
#import <cxxReactABI31_0_0/ABI31_0_0RAMBundleRegistry.h>
#import <folly/json.h>
...
class ABI31_0_0RCTObjcExecutor : public JSExecutor {
public:
  ABI31_0_0RCTObjcExecutor(id<ABI31_0_0RCTJavaScriptExecutor> jse,
                  ABI31_0_0RCTJavaScriptCompleteBlock errorBlock,
  ...
  void setBundleRegistry(std::unique_ptr<RAMBundleRegistry>) override {
    ABI31_0_0RCTAssert(NO, @"RAM bundles are not supported in ABI31_0_0RCTObjcExecutor");
  }
...
private:
  ...
  ABI31_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI31_0_0RCTObjcExecutorFactory::ABI31_0_0RCTObjcExecutorFactory(
  id<ABI31_0_0RCTJavaScriptExecutor> jse, ABI31_0_0RCTJavaScriptCompleteBlock errorBlock)
  : m_jse(jse)
  , m_errorBlock(errorBlock) {}

std::unique_ptr<JSExecutor> ABI31_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue) {
  return std::unique_ptr<JSExecutor>(
    new ABI31_0_0RCTObjcExecutor(m_jse, m_errorBlock, jsQueue, delegate));
}
