...
@implementation ABI31_0_0RCTRootShadowView

- (instancetype)init
{
  if (self = [super init]) {
    _baseDirection = [[ABI31_0_0RCTI18nUtil sharedInstance] isRTL] ? ABI31_0_0YGDirectionRTL : ABI31_0_0YGDirectionLTR;
...
- (void)layoutWithAffectedShadowViews:(NSHashTable<ABI31_0_0RCTShadowView *> *)affectedShadowViews
{
  ...
  ABI31_0_0RCTLayoutContext layoutContext = {};
  ...
  [self layoutWithMinimumSize:CGSizeZero
              ...
              layoutDirection:ABI31_0_0RCTUIKitLayoutDirectionFromYogaLayoutDirection(_baseDirection)
