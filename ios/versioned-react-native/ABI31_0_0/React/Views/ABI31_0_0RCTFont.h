...
typedef UIFont *(^ABI31_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ReactABI31_0_0 Native will use the System font for rendering by default. If you want to
 ...
 */
ABI31_0_0RCT_EXTERN void ABI31_0_0RCTSetDefaultFontHandler(ABI31_0_0RCTFontHandler handler);
ABI31_0_0RCT_EXTERN BOOL ABI31_0_0RCTHasFontHandlerSet(void);

@interface ABI31_0_0RCTFont : NSObject
...
@interface ABI31_0_0RCTConvert (ABI31_0_0RCTFont)
