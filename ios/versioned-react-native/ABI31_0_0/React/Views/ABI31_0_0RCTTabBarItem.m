...
@implementation ABI31_0_0RCTConvert (UITabBarSystemItem)

ABI31_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI31_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI31_0_0ViewController;
}
