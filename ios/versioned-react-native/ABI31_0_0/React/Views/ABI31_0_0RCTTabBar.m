...
@interface ABI31_0_0RCTTabBar() <UITabBarControllerDelegate>

@end

@implementation ABI31_0_0RCTTabBar
{
  BOOL _tabsChanged;
...
- (void)insertReactABI31_0_0Subview:(ABI31_0_0RCTTabBarItem *)subview atIndex:(NSInteger)atIndex
{
  if (![subview isKindOfClass:[ABI31_0_0RCTTabBarItem class]]) {
    ABI31_0_0RCTLogError(@"subview should be of type ABI31_0_0RCTTabBarItem");
    return;
  }
...
- (void)removeReactABI31_0_0Subview:(ABI31_0_0RCTTabBarItem *)subview
{
  if (self.ReactABI31_0_0Subviews.count == 0) {
    ABI31_0_0RCTLogError(@"should have at least one view to remove a subview");
    return;
  }
...
- (void)layoutSubviews
{
  ...
  [self ReactABI31_0_0AddControllerToClosestParent:_tabController];
...
- (void)uiManagerDidPerformMounting
{
  ...
  if (_tabsChanged) {
    ...
    for (ABI31_0_0RCTTabBarItem *tab in [self ReactABI31_0_0Subviews]) {
      UIViewController *controller = tab.ReactABI31_0_0ViewController;
      if (!controller) {
        controller = [[ABI31_0_0RCTWrapperViewController alloc] initWithContentView:tab];
      }
  ...
  [self.ReactABI31_0_0Subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger index, __unused BOOL *stop) {

    ABI31_0_0RCTTabBarItem *tab = (ABI31_0_0RCTTabBarItem *)view;
...
- (void)tabBarController:(UITabBarController *)tabBarController didSelectViewController:(nonnull UIViewController *)viewController
{
  ...
  ABI31_0_0RCTTabBarItem *tab = (ABI31_0_0RCTTabBarItem *)self.ReactABI31_0_0Subviews[index];
