...
@class ABI31_0_0RCTView;

@interface ABI31_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI31_0_0RCTDirectEventBlock onAccessibilityAction;
@property (nonatomic, copy) ABI31_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI31_0_0RCTDirectEventBlock onMagicTap;
 ...
 */
@property (nonatomic, assign) ABI31_0_0RCTPointerEvents pointerEvents;
 ...
 * This is inherited from UIView+ReactABI31_0_0, but we override it here
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI31_0_0RCTBorderStyle borderStyle;
