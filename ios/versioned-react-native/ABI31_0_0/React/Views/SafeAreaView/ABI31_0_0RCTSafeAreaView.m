...
@implementation ABI31_0_0RCTSafeAreaView {
...
- (void)safeAreaInsetsDidChange
{
  ...
  if (UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI31_0_0RCTScreenScale())) {
    return;
  }

  _currentSafeAreaInsets = safeAreaInsets;

  ABI31_0_0RCTSafeAreaViewLocalData *localData =
    [[ABI31_0_0RCTSafeAreaViewLocalData alloc] initWithInsets:safeAreaInsets];
