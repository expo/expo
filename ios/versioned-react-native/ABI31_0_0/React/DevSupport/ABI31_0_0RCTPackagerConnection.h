...
@protocol ABI31_0_0RCTPackagerClientMethod;
@class ABI31_0_0RCTPackagerClientResponder;

typedef uint32_t ABI31_0_0RCTHandlerToken;
typedef void (^ABI31_0_0RCTNotificationHandler)(NSDictionary<NSString *, id> *);
typedef void (^ABI31_0_0RCTRequestHandler)(NSDictionary<NSString *, id> *, ABI31_0_0RCTPackagerClientResponder *);
typedef void (^ABI31_0_0RCTConnectedHandler)(void);

/** Encapsulates singleton connection to ReactABI31_0_0 Native packager. */
@interface ABI31_0_0RCTPackagerConnection : NSObject
 ...
 */
- (ABI31_0_0RCTHandlerToken)addNotificationHandler:(ABI31_0_0RCTNotificationHandler)handler
 ...
 */
- (ABI31_0_0RCTHandlerToken)addRequestHandler:(ABI31_0_0RCTRequestHandler)handler
                               queue:(dispatch_queue_t)queue
                           forMethod:(NSString *)method;
 ...
 */
- (ABI31_0_0RCTHandlerToken)addConnectedHandler:(ABI31_0_0RCTConnectedHandler)handler
                                 queue:(dispatch_queue_t)queue;

/** Removes a handler. Silently does nothing if the token is not valid. */
- (void)removeHandler:(ABI31_0_0RCTHandlerToken)token;
 ...
 */
- (void)addHandler:(id<ABI31_0_0RCTPackagerClientMethod>)handler
