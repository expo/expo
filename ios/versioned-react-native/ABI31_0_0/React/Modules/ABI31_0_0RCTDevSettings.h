...
/**
 * An abstraction for a key-value store to manage ABI31_0_0RCTDevSettings behavior.
 * The default implementation persists settings using NSUserDefaults.
 */
@protocol ABI31_0_0RCTDevSettingsDataSource <NSObject>
...
@interface ABI31_0_0RCTDevSettings : NSObject
...
/*
 * Whether shaking will show ABI31_0_0RCTDevMenu. The menu is enabled by default if ABI31_0_0RCT_DEV=1, but
...
#if ABI31_0_0RCT_DEV
- (void)addHandler:(id<ABI31_0_0RCTPackagerClientMethod>)handler forPackagerMethod:(NSString *)name __deprecated_msg("Use ABI31_0_0RCTPackagerConnection directly instead");
#endif

@end

@interface ABI31_0_0RCTBridge (ABI31_0_0RCTDevSettings)

@property (nonatomic, readonly) ABI31_0_0RCTDevSettings *devSettings;
