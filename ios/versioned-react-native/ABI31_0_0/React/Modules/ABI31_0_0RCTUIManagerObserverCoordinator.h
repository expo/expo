...
typedef dispatch_block_t ABI31_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI31_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ReactABI31_0_0-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI31_0_0RCTUIManager's observers.
 */
@interface ABI31_0_0RCTUIManagerObserverCoordinator : NSObject <ABI31_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI31_0_0RCTUIManagerObserver` protocol for more info.
