...
NSString *const ABI31_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification = @"ABI31_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification";
...
@interface ABI31_0_0RCTAccessibilityManager ()
...
@implementation ABI31_0_0RCTAccessibilityManager
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    self.contentSizeCategory = ABI31_0_0RCTSharedApplication().preferredContentSizeCategory;
...
- (void)invalidateMultiplier
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI31_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification object:self];
}
...
- (CGFloat)multiplierForContentSizeCategory:(NSString *)category
{
  ...
  if (m.doubleValue <= 0.0) {
    ABI31_0_0RCTLogError(@"Can't determinte multiplier for category %@. Using 1.0.", category);
    m = @1.0;
  }
...
ABI31_0_0RCT_EXPORT_METHOD(setAccessibilityContentSizeMultipliers:(NSDictionary *)JSMultipliers)
{
  ...
  for (NSString *__nonnull JSCategory in JSMultipliers) {
    NSNumber *m = [ABI31_0_0RCTConvert NSNumber:JSMultipliers[JSCategory]];
...
ABI31_0_0RCT_EXPORT_METHOD(setAccessibilityFocus:(nonnull NSNumber *)ReactABI31_0_0Tag)
{
...
ABI31_0_0RCT_EXPORT_METHOD(announceForAccessibility:(NSString *)announcement)
{
  UIAccessibilityPostNotification(UIAccessibilityAnnouncementNotification, announcement);
}

ABI31_0_0RCT_EXPORT_METHOD(getMultiplier:(ABI31_0_0RCTResponseSenderBlock)callback)
{
  if (callback) {
...
ABI31_0_0RCT_EXPORT_METHOD(getCurrentVoiceOverState:(ABI31_0_0RCTResponseSenderBlock)callback
...
@implementation ABI31_0_0RCTBridge (ABI31_0_0RCTAccessibilityManager)

- (ABI31_0_0RCTAccessibilityManager *)accessibilityManager
{
  return [self moduleForClass:[ABI31_0_0RCTAccessibilityManager class]];
}
