...
#import "ABI31_0_0RCTKeyboardObserver.h"

#import "ABI31_0_0RCTEventDispatcher.h"

static NSDictionary *ABI31_0_0RCTParseKeyboardNotification(NSNotification *notification);

@implementation ABI31_0_0RCTKeyboardObserver
...
{ \
  ...
  [self sendEventWithName:@#EVENT \
    body:ABI31_0_0RCTParseKeyboardNotification(notification)]; \
}
...
NS_INLINE NSDictionary *ABI31_0_0RCTRectDictionaryValue(CGRect rect)
{
  return @{
...
static NSString *ABI31_0_0RCTAnimationNameForCurve(UIViewAnimationCurve curve)
{
  switch (curve) {
...
static NSDictionary *ABI31_0_0RCTParseKeyboardNotification(NSNotification *notification)
{
  ...
  return @{
    @"startCoordinates": ABI31_0_0RCTRectDictionaryValue(beginFrame),
    @"endCoordinates": ABI31_0_0RCTRectDictionaryValue(endFrame),
    @"duration": @(duration * 1000.0), // ms
    @"easing": ABI31_0_0RCTAnimationNameForCurve(curve),
  };
#endif
}
