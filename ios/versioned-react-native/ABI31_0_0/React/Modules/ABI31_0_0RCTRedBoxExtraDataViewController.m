...
@interface ABI31_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI31_0_0RCTRedBoxExtraDataCell
...
@interface ABI31_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI31_0_0RCTRedBoxExtraDataViewController
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ABI31_0_0RCTRedBoxExtraDataCell *cell =
            (ABI31_0_0RCTRedBoxExtraDataCell *)[tableView
            dequeueReusableCellWithIdentifier:reuseIdentifier];

    if (cell == nil) {
        cell = [[ABI31_0_0RCTRedBoxExtraDataCell alloc]
