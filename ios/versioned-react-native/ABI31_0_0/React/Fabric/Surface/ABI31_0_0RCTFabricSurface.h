...
@class ABI31_0_0RCTSurfacePresenter;
@protocol ABI31_0_0RCTSurfaceDelegate;

/**
 * (This is Fabric-compatible ABI31_0_0RCTSurface implementation.)
 *
...
@interface ABI31_0_0RCTFabricSurface (Internal)

- (void)_setStage:(ABI31_0_0RCTSurfaceStage)stage;

@end

@interface ABI31_0_0RCTFabricSurface (Deprecated)
