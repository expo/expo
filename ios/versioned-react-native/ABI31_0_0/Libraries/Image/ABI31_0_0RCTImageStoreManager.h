...
@interface ABI31_0_0RCTImageStoreManager : NSObject <ABI31_0_0RCTURLRequestHandler>
...
@interface ABI31_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI31_0_0RCTBridge (ABI31_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI31_0_0RCTImageStoreManager *imageStoreManager;
