...
typedef void (^ABI31_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI31_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI31_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI31_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI31_0_0RCTImageCache <NSObject>

- (UIImage *)imageForUrl:(NSString *)url
                    size:(CGSize)size
                   scale:(CGFloat)scale
              resizeMode:(ABI31_0_0RCTResizeMode)resizeMode
...
/**
 * If available, ABI31_0_0RCTImageRedirectProtocol is invoked before loading an asset.
 * Implementation should return either a new URL or nil when redirection is
 * not needed.
 */

@protocol ABI31_0_0RCTImageRedirectProtocol

- (NSURL *)redirectAssetsURL:(NSURL *)URL;

@end

@interface UIImage (ReactABI31_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI31_0_0KeyframeAnimation;

@end

@interface ABI31_0_0RCTImageLoader : NSObject <ABI31_0_0RCTBridgeModule, ABI31_0_0RCTURLRequestHandler>
...
- (instancetype)init;
- (instancetype)initWithRedirectDelegate:(id<ABI31_0_0RCTImageRedirectProtocol>)redirectDelegate NS_DESIGNATED_INITIALIZER;

/**
 * Loads the specified image at the highest available resolution.
 * Can be called from any thread, will call back on an unspecified thread.
 */
- (ABI31_0_0RCTImageLoaderCancellationBlock)loadImageWithURLRequest:(NSURLRequest *)imageURLRequest
                                                  callback:(ABI31_0_0RCTImageLoaderCompletionBlock)callback;
...
- (ABI31_0_0RCTImageLoaderCancellationBlock)loadImageWithURLRequest:(NSURLRequest *)imageURLRequest
                                                ...
                                                resizeMode:(ABI31_0_0RCTResizeMode)resizeMode
                                             progressBlock:(ABI31_0_0RCTImageLoaderProgressBlock)progressBlock
                                          partialLoadBlock:(ABI31_0_0RCTImageLoaderPartialLoadBlock)partialLoadBlock
                                           completionBlock:(ABI31_0_0RCTImageLoaderCompletionBlock)completionBlock;
 ...
 */
- (ABI31_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                           clipped:(BOOL)clipped
                                        resizeMode:(ABI31_0_0RCTResizeMode)resizeMode
 ...
 */
- (ABI31_0_0RCTImageLoaderCancellationBlock)getImageSizeForURLRequest:(NSURLRequest *)imageURLRequest
                                                       block:(void(^)(NSError *error, CGSize size))completionBlock;

/**
 * Allows developers to set their own caching implementation for
 * decoded images as long as it conforms to the ABI31_0_0RCTImageCacheDelegate
 * protocol. This method should be called in bridgeDidInitializeModule.
 */
- (void)setImageCache:(id<ABI31_0_0RCTImageCache>)cache;

@end

@interface ABI31_0_0RCTBridge (ABI31_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI31_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI31_0_0RCTImageURLLoader <ABI31_0_0RCTBridgeModule>
 ...
 * applicable.
 */
- (ABI31_0_0RCTImageLoaderCancellationBlock)loadImageForURL:(NSURL *)imageURL
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                        resizeMode:(ABI31_0_0RCTResizeMode)resizeMode
                                   progressHandler:(ABI31_0_0RCTImageLoaderProgressBlock)progressHandler
                                partialLoadHandler:(ABI31_0_0RCTImageLoaderPartialLoadBlock)partialLoadHandler
                                 completionHandler:(ABI31_0_0RCTImageLoaderCompletionBlock)completionHandler;

@optional

/**
 * If more than one ABI31_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI31_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 * are also bridge modules, so should be registered using ABI31_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI31_0_0RCTImageDataDecoder <ABI31_0_0RCTBridgeModule>
...
/**
 * If more than one ABI31_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
