...
#import "ABI31_0_0RCTImageCache.h"
...
#import "ABI31_0_0RCTImageUtils.h"

static const NSUInteger ABI31_0_0RCTMaxCachableDecodedImageSizeInBytes = 1048576; // 1MB

static NSString *ABI31_0_0RCTCacheKeyForImage(NSString *imageTag, CGSize size, CGFloat scale,
                                     ABI31_0_0RCTResizeMode resizeMode, NSString *responseDate)
{
  return [NSString stringWithFormat:@"%@|%g|%g|%g|%lld|%@",
          imageTag, size.width, size.height, scale, (long long)resizeMode, responseDate];
}

@implementation ABI31_0_0RCTImageCache
{
                 ...
                 forKey:(NSString *)cacheKey
{
  ...
  if (bytes <= ABI31_0_0RCTMaxCachableDecodedImageSizeInBytes) {
...
{
  NSString *cacheKey = ABI31_0_0RCTCacheKeyForImage(url, size, scale, resizeMode, responseDate);
