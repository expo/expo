...
#import "ABI31_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI31_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI31_0_0ViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI31_0_0ViewController detachChildViewController:self.contentViewController];
}
