...
typedef CGSize (^ABI31_0_0RCTWrapperMeasureBlock)(CGSize minimumSize, CGSize maximumSize);

@class ABI31_0_0RCTBridge;

NS_ASSUME_NONNULL_BEGIN

@interface ABI31_0_0RCTWrapperView : UIView

@property (nonatomic, retain, nullable) UIView *contentView;
@property (nonatomic, readonly) ABI31_0_0RCTWrapperMeasureBlock measureBlock;
