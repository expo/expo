...
@implementation ABI31_0_0RCTAssetsLibraryRequestHandler
{
...
#pragma mark - ABI31_0_0RCTURLRequestHandler
     ...
     withDelegate:(id<ABI31_0_0RCTURLRequestDelegate>)delegate
{
  ...
  [[self assetsLibrary] assetForURL:request.URL resultBlock:^(ALAsset *asset) {
    ...
    if (asset) {
      ...
      NSError *error = ABI31_0_0RCTErrorWithMessage(errorMessage);
      [delegate URLRequest:cancellationBlock didCompleteWithError:error];
    }
...
@implementation ABI31_0_0RCTBridge (ABI31_0_0RCTAssetsLibraryImageLoader)

- (ALAssetsLibrary *)assetsLibrary
{
  return [[self moduleForClass:[ABI31_0_0RCTAssetsLibraryRequestHandler class]] assetsLibrary];
}
