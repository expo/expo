...
#import "ABI31_0_0RCTReconnectingWebSocket.h"

#import <ReactABI31_0_0/ABI31_0_0RCTConvert.h>
#import <ReactABI31_0_0/ABI31_0_0RCTDefines.h>

#if __has_include(<ReactABI31_0_0/fishhook.h>)
#import <ReactABI31_0_0/fishhook.h>
#else
...
@interface ABI31_0_0RCTReconnectingWebSocket () <ABI31_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI31_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  __weak ABI31_0_0RCTSRWebSocket *socket = _socket;
