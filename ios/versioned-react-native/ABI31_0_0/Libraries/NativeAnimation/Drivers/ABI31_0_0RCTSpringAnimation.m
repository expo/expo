...
@interface ABI31_0_0RCTSpringAnimation ()
...
@implementation ABI31_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
                  ...
                  callBack:(nullable ABI31_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _lastVelocity = [ABI31_0_0RCTConvert CGFloat:config[@"initialVelocity"]];
...
- (void)resetAnimationConfig:(NSDictionary *)config
{
  ...
  _toValue = [ABI31_0_0RCTConvert CGFloat:config[@"toValue"]];
  _overshootClamping = [ABI31_0_0RCTConvert BOOL:config[@"overshootClamping"]];
  _restDisplacementThreshold = [ABI31_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
  _restSpeedThreshold = [ABI31_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
  _stiffness = [ABI31_0_0RCTConvert CGFloat:config[@"stiffness"]];
  _damping = [ABI31_0_0RCTConvert CGFloat:config[@"damping"]];
  _mass = [ABI31_0_0RCTConvert CGFloat:config[@"mass"]];
