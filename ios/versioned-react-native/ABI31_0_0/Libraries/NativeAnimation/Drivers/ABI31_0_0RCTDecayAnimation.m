...
@implementation ABI31_0_0RCTDecayAnimation
{
  ...
  ABI31_0_0RCTResponseSenderBlock _callback;
}
                  ...
                  callBack:(nullable ABI31_0_0RCTResponseSenderBlock)callback;
{
  if ((self = [super init])) {
    ...
    _fromValue = 0;
    _lastValue = 0;
    _velocity = [ABI31_0_0RCTConvert CGFloat:config[@"velocity"]]; // initial velocity
...
{
  NSNumber *iterations = [ABI31_0_0RCTConvert NSNumber:config[@"iterations"]] ?: @1;
  _fromValue = _lastValue;
  _deceleration = [ABI31_0_0RCTConvert CGFloat:config[@"deceleration"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  if (_frameStartTime == -1) {
    ...
    _frameStartTime = currentTime - ABI31_0_0RCTSingleFrameInterval;
