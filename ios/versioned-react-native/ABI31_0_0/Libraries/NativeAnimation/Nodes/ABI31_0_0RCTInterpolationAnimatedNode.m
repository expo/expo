...
@implementation ABI31_0_0RCTInterpolationAnimatedNode
{
  __weak ABI31_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI31_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI31_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI31_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI31_0_0RCTInterpolateValueInRange(inputValue,
                                          _inputRange,
                                          _outputRange,
                                          _extrapolateLeft,
                                          _extrapolateRight);
