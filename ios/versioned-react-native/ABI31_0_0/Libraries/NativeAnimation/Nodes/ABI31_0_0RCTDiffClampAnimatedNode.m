...
@implementation ABI31_0_0RCTDiffClampAnimatedNode
{
...
- (void)onAttachedToNode:(ABI31_0_0RCTAnimatedNode *)parent
{
...
{
  ABI31_0_0RCTValueAnimatedNode *inputNode = (ABI31_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI31_0_0RCTValueAnimatedNode class]]) {
    ABI31_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
