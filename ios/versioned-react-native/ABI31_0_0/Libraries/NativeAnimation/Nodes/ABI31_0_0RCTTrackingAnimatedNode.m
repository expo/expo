...
@implementation ABI31_0_0RCTTrackingAnimatedNode {
...
- (void)onDetachedFromNode:(ABI31_0_0RCTAnimatedNode *)parent
{
...
- (void)performUpdate
{
  ...
  ABI31_0_0RCTValueAnimatedNode *node = (ABI31_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
