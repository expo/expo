...
@protocol ABI31_0_0RCTValueAnimatedNodeObserver;

@interface ABI31_0_0RCTNativeAnimatedNodesManager : NSObject
...
- (void)startAnimatingNode:(nonnull NSNumber *)animationId
                   nodeTag:(nonnull NSNumber *)nodeTag
                    config:(NSDictionary<NSString *, id> *__nonnull)config
               endCallback:(nullable ABI31_0_0RCTResponseSenderBlock)callBack;
...
- (void)handleAnimatedEvent:(nonnull id<ABI31_0_0RCTEvent>)event;

// listeners

- (void)startListeningToAnimatedNodeValue:(nonnull NSNumber *)tag
                            valueObserver:(nonnull id<ABI31_0_0RCTValueAnimatedNodeObserver>)valueObserver;
