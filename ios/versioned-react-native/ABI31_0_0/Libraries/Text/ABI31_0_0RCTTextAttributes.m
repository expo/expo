...
NSString *const ABI31_0_0RCTTextAttributesIsHighlightedAttributeName = @"ABI31_0_0RCTTextAttributesIsHighlightedAttributeName";
NSString *const ABI31_0_0RCTTextAttributesTagAttributeName = @"ABI31_0_0RCTTextAttributesTagAttributeName";

@implementation ABI31_0_0RCTTextAttributes
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _opacity = NAN;
    _textTransform = ABI31_0_0RCTTextTransformUndefined;
  }
...
- (void)applyTextAttributes:(ABI31_0_0RCTTextAttributes *)textAttributes
{
  ...
  _textDecorationLine = textAttributes->_textDecorationLine != ABI31_0_0RCTTextDecorationLineTypeNone ? textAttributes->_textDecorationLine : _textDecorationLine; // *
  ...
  _textTransform = textAttributes->_textTransform != ABI31_0_0RCTTextTransformUndefined ? textAttributes->_textTransform : _textTransform;
}
...
- (NSDictionary<NSAttributedStringKey, id> *)effectiveTextAttributes
{
  ...
  if (_textDecorationLine == ABI31_0_0RCTTextDecorationLineTypeUnderline ||
      _textDecorationLine == ABI31_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    isTextDecorationEnabled = YES;
    attributes[NSUnderlineStyleAttributeName] = @(_textDecorationStyle);
  }

  if (_textDecorationLine == ABI31_0_0RCTTextDecorationLineTypeStrikethrough ||
      _textDecorationLine == ABI31_0_0RCTTextDecorationLineTypeUnderlineStrikethrough){
    isTextDecorationEnabled = YES;
  ...
  // Special
  if (_isHighlighted) {
    attributes[ABI31_0_0RCTTextAttributesIsHighlightedAttributeName] = @YES;
  }

  if (_tag) {
    attributes[ABI31_0_0RCTTextAttributesTagAttributeName] = _tag;
  }
...
{
  // FIXME: ABI31_0_0RCTFont has thread-safety issues and must be rewritten.
...
{
  return !ABI31_0_0RCTHasFontHandlerSet() && _allowFontScaling && !isnan(_fontSizeMultiplier) ? _fontSizeMultiplier : 1.0;
}
...
- (NSString *)applyTextAttributesToText:(NSString *)text
{
  switch (_textTransform) {
    case ABI31_0_0RCTTextTransformUndefined:
    case ABI31_0_0RCTTextTransformNone:
      return text;
    case ABI31_0_0RCTTextTransformLowercase:
      return [text lowercaseString];
    case ABI31_0_0RCTTextTransformUppercase:
      return [text uppercaseString];
    case ABI31_0_0RCTTextTransformCapitalize:
      return [text capitalizedString];
  }
}

- (ABI31_0_0RCTTextAttributes *)copyWithZone:(NSZone *)zone
{
  ABI31_0_0RCTTextAttributes *textAttributes = [ABI31_0_0RCTTextAttributes new];
...
- (BOOL)isEqual:(ABI31_0_0RCTTextAttributes *)textAttributes
{
  if (self == textAttributes) {
    return YES;
  }

#define ABI31_0_0RCTTextAttributesCompareFloats(a) ((a == textAttributes->a) || (isnan(a) && isnan(textAttributes->a)))
#define ABI31_0_0RCTTextAttributesCompareSize(a) CGSizeEqualToSize(a, textAttributes->a)
#define ABI31_0_0RCTTextAttributesCompareObjects(a) ((a == textAttributes->a) || [a isEqual:textAttributes->a])
#define ABI31_0_0RCTTextAttributesCompareStrings(a) ((a == textAttributes->a) || [a isEqualToString:textAttributes->a])
#define ABI31_0_0RCTTextAttributesCompareOthers(a) (a == textAttributes->a)

  return
    ABI31_0_0RCTTextAttributesCompareObjects(_foregroundColor) &&
    ABI31_0_0RCTTextAttributesCompareObjects(_backgroundColor) &&
    ABI31_0_0RCTTextAttributesCompareFloats(_opacity) &&
    // Font
    ABI31_0_0RCTTextAttributesCompareObjects(_fontFamily) &&
    ABI31_0_0RCTTextAttributesCompareFloats(_fontSize) &&
    ABI31_0_0RCTTextAttributesCompareFloats(_fontSizeMultiplier) &&
    ABI31_0_0RCTTextAttributesCompareStrings(_fontWeight) &&
    ABI31_0_0RCTTextAttributesCompareObjects(_fontStyle) &&
    ABI31_0_0RCTTextAttributesCompareObjects(_fontVariant) &&
    ABI31_0_0RCTTextAttributesCompareOthers(_allowFontScaling) &&
    ABI31_0_0RCTTextAttributesCompareFloats(_letterSpacing) &&
    // Paragraph Styles
    ABI31_0_0RCTTextAttributesCompareFloats(_lineHeight) &&
    ABI31_0_0RCTTextAttributesCompareFloats(_alignment) &&
    ABI31_0_0RCTTextAttributesCompareOthers(_baseWritingDirection) &&
    // Decoration
    ABI31_0_0RCTTextAttributesCompareObjects(_textDecorationColor) &&
    ABI31_0_0RCTTextAttributesCompareOthers(_textDecorationStyle) &&
    ABI31_0_0RCTTextAttributesCompareOthers(_textDecorationLine) &&
    // Shadow
    ABI31_0_0RCTTextAttributesCompareSize(_textShadowOffset) &&
    ABI31_0_0RCTTextAttributesCompareFloats(_textShadowRadius) &&
    ABI31_0_0RCTTextAttributesCompareObjects(_textShadowColor) &&
    // Special
    ABI31_0_0RCTTextAttributesCompareOthers(_isHighlighted) &&
    ABI31_0_0RCTTextAttributesCompareObjects(_tag) &&
    ABI31_0_0RCTTextAttributesCompareOthers(_layoutDirection) &&
    ABI31_0_0RCTTextAttributesCompareOthers(_textTransform);
}
