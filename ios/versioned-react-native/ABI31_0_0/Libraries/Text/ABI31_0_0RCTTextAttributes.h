...
extern NSString *const ABI31_0_0RCTTextAttributesIsHighlightedAttributeName;
extern NSString *const ABI31_0_0RCTTextAttributesTagAttributeName;
 ...
 * and <TextInput>.
 */
@interface ABI31_0_0RCTTextAttributes : NSObject <NSCopying>
...
@property (nonatomic, assign) ABI31_0_0RCTTextDecorationLineType textDecorationLine;
// Shadow
...
@property (nonatomic, assign) ABI31_0_0RCTTextTransform textTransform;

#pragma mark - Inheritance

- (void)applyTextAttributes:(ABI31_0_0RCTTextAttributes *)textAttributes;
