...
#import "ABI31_0_0RCTUITextField.h"

#import <ReactABI31_0_0/ABI31_0_0RCTUtils.h>
#import <ReactABI31_0_0/UIView+ReactABI31_0_0.h>

#import "ABI31_0_0RCTBackedTextInputDelegateAdapter.h"

@implementation ABI31_0_0RCTUITextField {
  ABI31_0_0RCTBackedTextFieldDelegateAdapter *_textInputDelegateAdapter;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI31_0_0RCTBackedTextFieldDelegateAdapter alloc] initWithTextField:self];
  }
...
- (CGSize)intrinsicContentSize
{
  ...
  size = CGSizeMake(ABI31_0_0RCTCeilPixelValue(size.width), ABI31_0_0RCTCeilPixelValue(size.height));
