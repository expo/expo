...
#import "ABI31_0_0RCTMultilineTextInputView.h"

#import <ReactABI31_0_0/ABI31_0_0RCTUtils.h>

#import "ABI31_0_0RCTUITextView.h"

@implementation ABI31_0_0RCTMultilineTextInputView
{
  ABI31_0_0RCTUITextView *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI31_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI31_0_0RCTUITextView alloc] initWithFrame:self.bounds];
...
- (id<ABI31_0_0RCTBackedTextInputViewProtocol>)backedTextInputView
{
...
{
  ABI31_0_0RCTDirectEventBlock onScroll = self.onScroll;
