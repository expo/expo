...
#import "ABI31_0_0RCTSurfaceHostingComponentController.h"
...
#import "ABI31_0_0RCTSurfaceHostingComponent+Internal.h"
#import "ABI31_0_0RCTSurfaceHostingComponent.h"
#import "ABI31_0_0RCTSurfaceHostingComponentState.h"

@interface ABI31_0_0RCTSurfaceHostingComponentController() <ABI31_0_0RCTSurfaceDelegate>
@end

@implementation ABI31_0_0RCTSurfaceHostingComponentController {
  ABI31_0_0RCTSurface *_surface;
}

- (instancetype)initWithComponent:(ABI31_0_0RCTSurfaceHostingComponent *)component
{
...
- (void)didUpdateComponent
{
  ...
  [self updateSurfaceWithComponent:(ABI31_0_0RCTSurfaceHostingComponent *)self.component];
}
...
- (void)updateSurfaceWithComponent:(ABI31_0_0RCTSurfaceHostingComponent *)component
{
  // Updating `surface`
  ABI31_0_0RCTSurface *const surface = component.surface;
  if (surface != _surface) {
...
{
  [self.component updateState:^(ABI31_0_0RCTSurfaceHostingComponentState *state) {
    return [ABI31_0_0RCTSurfaceHostingComponentState newWithStage:state.stage
...
{
  [self.component updateState:^(ABI31_0_0RCTSurfaceHostingComponentState *state) {
    return [ABI31_0_0RCTSurfaceHostingComponentState newWithStage:stage
...
{
  return ((ABI31_0_0RCTSurfaceHostingComponent *)self.component).options.synchronousStateUpdates && ABI31_0_0RCTIsMainQueue() ? CKUpdateModeSynchronous : CKUpdateModeAsynchronous;
}
...
- (void)mountSurfaceView
{
  ...
  ABI31_0_0RCTAssert([superview.subviews count] <= 1, @"Should never have more than a single stateful subview.");
