...
@implementation ABI31_0_0ARTText
...
static void ABI31_0_0ARTFreeTextFrame(ABI31_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI31_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI31_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI31_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI31_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
