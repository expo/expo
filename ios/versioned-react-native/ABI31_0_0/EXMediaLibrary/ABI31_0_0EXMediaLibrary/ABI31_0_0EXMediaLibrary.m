...
#import <ABI31_0_0EXMediaLibrary/ABI31_0_0EXMediaLibrary.h>
...
NSString *const ABI31_0_0EXAssetMediaTypeAudio = @"audio";
NSString *const ABI31_0_0EXAssetMediaTypePhoto = @"photo";
NSString *const ABI31_0_0EXAssetMediaTypeVideo = @"video";
NSString *const ABI31_0_0EXAssetMediaTypeUnknown = @"unknown";
NSString *const ABI31_0_0EXAssetMediaTypeAll = @"all";

NSString *const ABI31_0_0EXMediaLibraryDidChangeEvent = @"mediaLibraryDidChange";

@interface ABI31_0_0EXMediaLibrary ()

@property (nonatomic, weak) id<ABI31_0_0EXPermissionsScopedModuleDelegate> kernelPermissionsServiceDelegate;
...
@implementation ABI31_0_0EXMediaLibrary

ABI31_0_0EX_EXPORT_MODULE(ExponentMediaLibrary);
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"MediaType": @{
               @"audio": ABI31_0_0EXAssetMediaTypeAudio,
               @"photo": ABI31_0_0EXAssetMediaTypePhoto,
               @"video": ABI31_0_0EXAssetMediaTypeVideo,
               @"unknown": ABI31_0_0EXAssetMediaTypeUnknown,
               @"all": ABI31_0_0EXAssetMediaTypeAll,
               },
           @"SortBy": @{
               @"default": @"default",
               @"id": @"id",
           ...
           @"CHANGE_LISTENER_NAME": ABI31_0_0EXMediaLibraryDidChangeEvent,
           };
}

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI31_0_0EXMediaLibraryDidChangeEvent];
}

ABI31_0_0EX_EXPORT_METHOD_AS(createAssetAsync,
                    ...
                    reject:(ABI31_0_0EXPromiseRejectBlock)reject)
{
  ...
  PHAssetMediaType assetType = [ABI31_0_0EXMediaLibrary _assetTypeForUri:localUri];
  ...
  if (!([_fileSystem permissionsForURI:assetUrl] & ABI31_0_0EXFileSystemPermissionRead)) {
  ...
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    ...
    if (success) {
      PHAsset *asset = [ABI31_0_0EXMediaLibrary _getAssetById:assetPlaceholder.localIdentifier];
      resolve([ABI31_0_0EXMediaLibrary _exportAsset:asset]);
    } else {
...
ABI31_0_0EX_EXPORT_METHOD_AS(addAssetsToAlbumAsync,
                    ...
                    reject:(ABI31_0_0EXPromiseRejectBlock)reject)
{
  ...
  [ABI31_0_0EXMediaLibrary _addAssets:assetIds toAlbum:albumId withCallback:^(BOOL success, NSError *error) {
    if (error) {
...
ABI31_0_0EX_EXPORT_METHOD_AS(removeAssetsFromAlbumAsync,
                    ...
                    reject:(ABI31_0_0EXPromiseRejectBlock)reject)
{
  ...
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    PHAssetCollection *collection = [ABI31_0_0EXMediaLibrary _getAlbumById:albumId];
    PHFetchResult *assets = [ABI31_0_0EXMediaLibrary _getAssetsByIds:assetIds];
...
ABI31_0_0EX_EXPORT_METHOD_AS(deleteAssetsAsync,
...
ABI31_0_0EX_EXPORT_METHOD_AS(getAlbumsAsync,
                    getAlbums:(ABI31_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI31_0_0EXPromiseRejectBlock)reject)
{
  if (![self _checkPermissions:reject]) {
    return;
  ...
  NSArray<NSDictionary *> *albums = [ABI31_0_0EXMediaLibrary _exportCollections:fetchResult];
  
  resolve(albums);
}

ABI31_0_0EX_EXPORT_METHOD_AS(getMomentsAsync,
                    getMoments:(ABI31_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI31_0_0EXPromiseRejectBlock)reject)
{
  if (![self _checkPermissions:reject]) {
    return;
...
ABI31_0_0EX_EXPORT_METHOD_AS(getAlbumAsync,
                    ...
                    reject:(ABI31_0_0EXPromiseRejectBlock)reject)
{
  ...
  PHAssetCollection *collection = [ABI31_0_0EXMediaLibrary _getAlbumWithTitle:title];
  resolve(ABI31_0_0EXNullIfNil([ABI31_0_0EXMediaLibrary _exportCollection:collection]));
}

ABI31_0_0EX_EXPORT_METHOD_AS(createAlbumAsync,
                    ...
                    reject:(ABI31_0_0EXPromiseRejectBlock)reject)
{
  ...
  [ABI31_0_0EXMediaLibrary _createAlbumWithTitle:title completion:^(PHAssetCollection *collection, NSError *error) {
    if (collection) {
      if (assetId) {
        [ABI31_0_0EXMediaLibrary _addAssets:@[assetId] toAlbum:collection.localIdentifier withCallback:^(BOOL success, NSError *error) {
          if (success) {
            resolve(ABI31_0_0EXNullIfNil([ABI31_0_0EXMediaLibrary _exportCollection:collection]));
          } else {
...
ABI31_0_0EX_EXPORT_METHOD_AS(deleteAlbumsAsync,
                    ...
                    reject:(ABI31_0_0EXPromiseRejectBlock)reject)
{
  ...
  PHFetchResult *collections = [ABI31_0_0EXMediaLibrary _getAlbumsById:albumIds];
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    if (assetRemove) {
...
ABI31_0_0EX_EXPORT_METHOD_AS(getAssetInfoAsync,
                    ...
                    reject:(ABI31_0_0EXPromiseRejectBlock)reject)
{
  ...
  PHAsset *asset = [ABI31_0_0EXMediaLibrary _getAssetById:assetId];
  
  if (asset) {
    NSMutableDictionary *result = [ABI31_0_0EXMediaLibrary _exportAssetInfo:asset];
...
ABI31_0_0EX_EXPORT_METHOD_AS(getAssetsAsync,
                    ...
                    reject:(ABI31_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (after) {
    cursor = [ABI31_0_0EXMediaLibrary _getAssetById:after];
  ...
  if (albumId) {
    collection = [ABI31_0_0EXMediaLibrary _getAlbumById:albumId];
  ...
  if (mediaType && [mediaType count] > 0) {
    NSMutableArray<NSNumber *> *assetTypes = [ABI31_0_0EXMediaLibrary _convertMediaTypes:mediaType];
  ...
  if (sortBy && sortBy.count > 0) {
    fetchOptions.sortDescriptors = [ABI31_0_0EXMediaLibrary _prepareSortDescriptors:sortBy];
  }
  ...
  if (fetchOptions.sortDescriptors.count == 0) {
    ...
    for (NSInteger i = startIndex; i >= endIndex; i--) {
      ...
      [assets addObject:[ABI31_0_0EXMediaLibrary _exportAsset:asset]];
    }
...
- (void)startObserving
{
  _allAssetsFetchResult = [ABI31_0_0EXMediaLibrary _getAllAssets];
    ...
    if (changeDetails != nil) {
      ...
      if (changeDetails.hasIncrementalChanges && (changeDetails.insertedObjects.count > 0 || changeDetails.removedObjects.count > 0)) {
        ...
        for (PHAsset *asset in changeDetails.insertedObjects) {
          [insertedAssets addObject:[ABI31_0_0EXMediaLibrary _exportAsset:asset]];
        }
        for (PHAsset *asset in changeDetails.removedObjects) {
          [deletedAssets addObject:[ABI31_0_0EXMediaLibrary _exportAsset:asset]];
        }
        
        [_eventEmitter sendEventWithName:ABI31_0_0EXMediaLibraryDidChangeEvent body:body];
      }
    }
  }
}
...
{
  if (assetId) {
    return [ABI31_0_0EXMediaLibrary _getAssetsByIds:@[assetId]].firstObject;
  }
  return nil;
}
...
+ (void)_ensureAlbumWithTitle:(nonnull NSString *)title completion:(void(^)(PHAssetCollection *collection, NSError *error))completion
{
  ...
  [ABI31_0_0EXMediaLibrary _createAlbumWithTitle:title completion:completion];
}
...
+ (NSDictionary *)_exportAsset:(PHAsset *)asset
{
  if (asset) {
    ...
    return @{
             ...
             @"filename": fileName,
             @"uri": [ABI31_0_0EXMediaLibrary _assetUriForLocalId:asset.localIdentifier andExtension:assetExtension],
             @"mediaType": [ABI31_0_0EXMediaLibrary _stringifyMediaType:asset.mediaType],
             @"mediaSubtypes": [ABI31_0_0EXMediaLibrary _stringifyMediaSubtypes:asset.mediaSubtypes],
             @"width": @(asset.pixelWidth),
             @"height": @(asset.pixelHeight),
             @"creationTime": [ABI31_0_0EXMediaLibrary _exportDate:asset.creationDate],
             @"modificationTime": [ABI31_0_0EXMediaLibrary _exportDate:asset.modificationDate],
...
{
  NSMutableDictionary *assetDict = [[ABI31_0_0EXMediaLibrary _exportAsset:asset] mutableCopy];
  
  if (assetDict) {
    assetDict[@"location"] = [ABI31_0_0EXMediaLibrary _exportLocation:asset.location];
...
+ (nullable NSDictionary *)_exportCollection:(PHAssetCollection *)collection
{
  if (collection) {
    return @{
             @"id": [ABI31_0_0EXMediaLibrary _assetIdFromLocalId:collection.localIdentifier],
             @"title": collection.localizedTitle ?: [NSNull null],
             @"type": [ABI31_0_0EXMediaLibrary _stringifyAlbumType:collection.assetCollectionType],
             @"assetCount": [ABI31_0_0EXMediaLibrary _assetCountOfCollection:collection],
             @"startTime": [ABI31_0_0EXMediaLibrary _exportDate:collection.startDate],
             @"endTime": [ABI31_0_0EXMediaLibrary _exportDate:collection.endDate],
             @"approximateLocation": [ABI31_0_0EXMediaLibrary _exportLocation:collection.approximateLocation],
...
+ (NSArray *)_exportCollections:(PHFetchResult *)collections
{
  ...
  for (PHAssetCollection *collection in collections) {
    [albums addObject:[ABI31_0_0EXMediaLibrary _exportCollection:collection]];
  }
  return [albums copy];
}
...
{
  NSString *assetId = [ABI31_0_0EXMediaLibrary _assetIdFromLocalId:localId];
...
+ (NSString *)_stringifyMediaType:(PHAssetMediaType)mediaType
{
  switch (mediaType) {
    case PHAssetMediaTypeAudio:
      return ABI31_0_0EXAssetMediaTypeAudio;
    case PHAssetMediaTypeImage:
      return ABI31_0_0EXAssetMediaTypePhoto;
    case PHAssetMediaTypeVideo:
      return ABI31_0_0EXAssetMediaTypeVideo;
    default:
      return ABI31_0_0EXAssetMediaTypeUnknown;
  }
}

+ (PHAssetMediaType)_convertMediaType:(NSString *)mediaType
{
  if ([mediaType isEqualToString:ABI31_0_0EXAssetMediaTypeAudio]) {
    return PHAssetMediaTypeAudio;
  }
  if ([mediaType isEqualToString:ABI31_0_0EXAssetMediaTypePhoto]) {
    return PHAssetMediaTypeImage;
  }
  if ([mediaType isEqualToString:ABI31_0_0EXAssetMediaTypeVideo]) {
    return PHAssetMediaTypeVideo;
  }
  return PHAssetMediaTypeUnknown;
}
...
+ (NSMutableArray<NSNumber *> *)_convertMediaTypes:(NSArray<NSString *> *)mediaTypes
{
  ...
  [mediaTypes enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
    if ([obj isEqualToString:ABI31_0_0EXAssetMediaTypeAll]) {
      *stop = YES;
      assetTypes = nil;
      return;
    }
    PHAssetMediaType assetType = [ABI31_0_0EXMediaLibrary _convertMediaType:obj];
...
+ (NSString *)_convertSortByKey:(NSString *)key
{
  ...
  if (value == nil) {
    ...
    @throw [NSException exceptionWithName:@"ABI31_0_0EXMediaLibrary.UNSUPPORTED_SORTBY_KEY" reason:reason userInfo:nil];
  }
  return value;
}
...
+ (NSSortDescriptor *)_sortDescriptorFrom:(id)config
{
  if ([config isKindOfClass:[NSString class]]) {
    NSString *key = [ABI31_0_0EXMediaLibrary _convertSortByKey:config];
  ...
  if ([config isKindOfClass:[NSArray class]]) {
    ...
    NSString *key = [ABI31_0_0EXMediaLibrary _convertSortByKey:sortArray[0]];
...
+ (NSArray *)_prepareSortDescriptors:(NSArray *)sortBy
{
  ...
  for (id config in sortByArray) {
    NSSortDescriptor *sortDescriptor = [ABI31_0_0EXMediaLibrary _sortDescriptorFrom:config];
...
- (BOOL)_checkPermissions:(ABI31_0_0EXPromiseRejectBlock)reject
{
