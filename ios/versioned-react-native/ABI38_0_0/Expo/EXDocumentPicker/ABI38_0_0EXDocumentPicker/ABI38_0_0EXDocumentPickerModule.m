...
#import <ABI38_0_0EXDocumentPicker/ABI38_0_0EXDocumentPickerModule.h>
...
static NSString * ABI38_0_0EXConvertMimeTypeToUTI(NSString *mimeType)
{
  CFStringRef uti;
...
@interface ABI38_0_0EXDocumentPickerModule () <UIDocumentMenuDelegate, UIDocumentPickerDelegate>
...
@implementation ABI38_0_0EXDocumentPickerModule

ABI38_0_0UM_EXPORT_MODULE(ExpoDocumentPicker);
...
ABI38_0_0UM_EXPORT_METHOD_AS(getDocumentAsync,
                    ...
                    reject:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSString *type = ABI38_0_0EXConvertMimeTypeToUTI(options[@"type"] ?: @"*/*");
