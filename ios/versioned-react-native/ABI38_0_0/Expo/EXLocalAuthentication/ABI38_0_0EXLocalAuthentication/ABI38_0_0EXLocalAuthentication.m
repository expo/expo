...
#import <ABI38_0_0EXLocalAuthentication/ABI38_0_0EXLocalAuthentication.h>

typedef NS_ENUM(NSInteger, ABI38_0_0EXAuthenticationType) {
  ABI38_0_0EXAuthenticationTypeFingerprint = 1,
  ABI38_0_0EXAuthenticationTypeFacialRecognition = 2,
};

@implementation ABI38_0_0EXLocalAuthentication

ABI38_0_0UM_EXPORT_MODULE(ExpoLocalAuthentication)

ABI38_0_0UM_EXPORT_METHOD_AS(supportedAuthenticationTypesAsync,
                    supportedAuthenticationTypesAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  NSMutableArray *results = [NSMutableArray array];
  if ([[self class] isTouchIdDevice]) {
    [results addObject:@(ABI38_0_0EXAuthenticationTypeFingerprint)];
  }
  if ([[self class] isFaceIdDevice]) {
    [results addObject:@(ABI38_0_0EXAuthenticationTypeFacialRecognition)];
  }
  resolve(results);
}

ABI38_0_0UM_EXPORT_METHOD_AS(hasHardwareAsync,
                    hasHardwareAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI38_0_0UMPromiseRejectBlock)reject)
{
...
ABI38_0_0UM_EXPORT_METHOD_AS(isEnrolledAsync,
                    isEnrolledAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
          ...
          localizedReason:reason
                    reply:^(BOOL success, NSError *error) {
                      resolve(@{
                                ...
                                @"warning": ABI38_0_0UMNullIfNil(warningMessage),
                                });
                    }];
  } else {
