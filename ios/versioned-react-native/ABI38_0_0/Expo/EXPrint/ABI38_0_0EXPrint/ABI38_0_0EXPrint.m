...
#import <ABI38_0_0EXPrint/ABI38_0_0EXPrint.h>
...
NSString *const ABI38_0_0EXPrintOrientationPortrait = @"portrait";
NSString *const ABI38_0_0EXPrintOrientationLandscape = @"landscape";

@interface ABI38_0_0EXPrint () <UIPrintInteractionControllerDelegate, UIPrinterPickerControllerDelegate>
...
@implementation ABI38_0_0EXPrint

ABI38_0_0UM_EXPORT_MODULE(ExponentPrint);
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"Orientation": @{
               @"portrait": ABI38_0_0EXPrintOrientationPortrait,
               @"landscape": ABI38_0_0EXPrintOrientationLandscape,
               },
           };
}

ABI38_0_0UM_EXPORT_METHOD_AS(print,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  [self _getPrintingDataForOptions:options callback:^(NSData *printingData, NSDictionary *errorDetails) {
    if (errorDetails != nil) {
      reject(errorDetails[@"code"], errorDetails[@"message"], ABI38_0_0UMErrorWithMessage(errorDetails[@"message"]));
      return;
    }
    ...
    if (printingData == nil) {
      ...
      if (options[@"markupFormatterIOS"] && [options[@"markupFormatterIOS"] isKindOfClass:[NSString class]]) {
        ...
        if (htmlString != nil) {
          ...
          reject(@"E_HTML_INVALID", message, ABI38_0_0UMErrorWithMessage(message));
          return;
        }
      } else {
...
ABI38_0_0UM_EXPORT_METHOD_AS(selectPrinter,selectPrinter:(ABI38_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
...
ABI38_0_0UM_EXPORT_METHOD_AS(printToFileAsync,
                    ...
                    reject:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI38_0_0EXWKPDFRenderer *renderTask = [ABI38_0_0EXWKPDFRenderer new];
...
{
  id<ABI38_0_0UMUtilitiesInterface> utils = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI38_0_0UMUtilitiesInterface)];
...
{
  if ([orientation isEqualToString:ABI38_0_0EXPrintOrientationLandscape]) {
