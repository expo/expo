#import <ABI38_0_0EXImagePicker/ABI38_0_0EXImagePicker.h>
#import <ABI38_0_0EXImagePicker/ABI38_0_0EXImagePickerCameraPermissionRequester.h>
#import <ABI38_0_0EXImagePicker/ABI38_0_0EXImagePickerCameraRollPermissionRequester.h>
...
const CGFloat ABI38_0_0EXDefaultImageQuality = 0.2;

@interface ABI38_0_0EXImagePicker ()

@property (nonatomic, strong) UIAlertController *alertController;
@property (nonatomic, strong) UIImagePickerController *picker;
@property (nonatomic, strong) ABI38_0_0UMPromiseResolveBlock resolve;
@property (nonatomic, strong) ABI38_0_0UMPromiseRejectBlock reject;
...
@implementation ABI38_0_0EXImagePicker

ABI38_0_0UM_EXPORT_MODULE(ExponentImagePicker);
...
- (void)setModuleRegistry:(ABI38_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  _permissionsManager = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI38_0_0UMPermissionsInterface)];
  [ABI38_0_0UMPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI38_0_0EXImagePickerCameraPermissionRequester new],
                                                    [ABI38_0_0EXImagePickerCameraRollPermissionRequester new]
                                                    ]
                           withPermissionsManager:_permissionsManager];
}

ABI38_0_0UM_EXPORT_METHOD_AS(getCameraPermissionsAsync,
                    getCameraPermissionsAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  [ABI38_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI38_0_0EXImagePickerCameraPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI38_0_0UM_EXPORT_METHOD_AS(getCameraRollPermissionsAsync,
                    getPermissionsAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  [ABI38_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI38_0_0EXImagePickerCameraRollPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI38_0_0UM_EXPORT_METHOD_AS(requestCameraPermissionsAsync,
                    requestCameraPermissionsAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
...
ABI38_0_0UM_EXPORT_METHOD_AS(requestCameraRollPermissionsAsync,
                    requestCameraRollPermissionsAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  [ABI38_0_0UMPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI38_0_0EXImagePickerCameraRollPermissionRequester class]
...
ABI38_0_0UM_EXPORT_METHOD_AS(launchCameraAsync, launchCameraAsync:(NSDictionary *)options
                  ...
                  rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  BOOL permissionsAreGranted = [self hasCameraRollPermission] &&
                               [self.permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI38_0_0EXImagePickerCameraPermissionRequester class]];
  ...
  self.reject = reject;
  [self launchImagePicker:ABI38_0_0EXImagePickerTargetCamera options:options];
}

ABI38_0_0UM_EXPORT_METHOD_AS(launchImageLibraryAsync, launchImageLibraryAsync:(NSDictionary *)options
                  resolver:(ABI38_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  if (!_permissionsManager) {
  ...
  self.resolve = resolve;
  self.reject = reject;
  [self launchImagePicker:ABI38_0_0EXImagePickerTargetLibrarySingleImage options:options];
}

- (void)launchImagePicker:(ABI38_0_0EXImagePickerTarget)target options:(NSDictionary *)options
{
...
- (void)launchImagePicker:(ABI38_0_0EXImagePickerTarget)target
{
  dispatch_async(dispatch_get_main_queue(), ^{
    self.picker = [[UIImagePickerController alloc] init];

    if (target == ABI38_0_0EXImagePickerTargetCamera) {
  ...
  #endif
    } else { // ABI38_0_0RNImagePickerTargetLibrarySingleImage
    ...
    id<ABI38_0_0UMUtilitiesInterface> utils = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI38_0_0UMUtilitiesInterface)];
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
  dispatch_block_t dismissCompletionBlock = ^{
    ...
    id<ABI38_0_0UMFileSystemInterface> fileSystem = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI38_0_0UMFileSystemInterface)];
    if (!fileSystem) {
          ...
          completionHandler:(void (^)(void))completionHandler
{
  ...
  NSData *data = UIImageJPEGRepresentation(image, quality == nil ? ABI38_0_0EXDefaultImageQuality : [quality floatValue]);
  ...
  if ([[self.options objectForKey:@"exif"] boolValue]) {
    ...
    if (metadata) {
      ...
      if (!asset) {
        ABI38_0_0UMLogInfo(@"Could not fetch metadata for image %@", [imageURL absoluteString]);
        completionHandler();
      }
...
- (BOOL)hasCameraRollPermission
{
  ...
  return [_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI38_0_0EXImagePickerCameraRollPermissionRequester class]];
}
