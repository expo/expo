...
@implementation ABI38_0_0UMAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitializedAndSorted {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI38_0_0UMSingletonModule*> * singletonModules = [[ABI38_0_0UMModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI38_0_0UMSingletonModule *singletonModule in singletonModules) {
