...
// Register a subclass of this class in ABI38_0_0UMModuleRegistryProvider
...
@interface ABI38_0_0UMExportedModule : NSObject <ABI38_0_0UMInternalModule, NSCopying>

- (NSDictionary *)constantsToExport;
+ (const NSString *)exportedModuleName;
- (NSDictionary<NSString *, NSString *> *)getExportedMethods;
- (void)callExportedMethod:(NSString *)methodName withArguments:(NSArray *)arguments resolver:(ABI38_0_0UMPromiseResolveBlock)resolver rejecter:(ABI38_0_0UMPromiseRejectBlock)rejecter;
