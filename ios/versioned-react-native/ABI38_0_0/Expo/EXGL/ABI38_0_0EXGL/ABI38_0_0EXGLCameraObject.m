...
@interface ABI38_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) id<ABI38_0_0UMCameraInterface> camera;
...
@implementation ABI38_0_0EXGLCameraObject
