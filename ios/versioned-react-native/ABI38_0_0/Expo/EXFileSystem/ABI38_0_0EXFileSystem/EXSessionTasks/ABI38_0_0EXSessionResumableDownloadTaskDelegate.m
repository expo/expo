...
@interface ABI38_0_0EXSessionResumableDownloadTaskDelegate ()

@property (strong, nonatomic, readonly) ABI38_0_0EXDownloadDelegateOnWriteCallback onWriteCallback;
@property (weak, nonatomic) ABI38_0_0EXResumablesManager *manager;
@property (strong, nonatomic) NSString *uuid;

@end

@implementation ABI38_0_0EXSessionResumableDownloadTaskDelegate
