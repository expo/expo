...
#import <ABI38_0_0EXGoogleSignIn/ABI38_0_0EXAuthTask.h>
...
@interface ABI38_0_0EXGoogleSignIn ()
...
@property (nonatomic, strong) ABI38_0_0EXAuthTask *authTask;

@end

@implementation ABI38_0_0EXGoogleSignIn

ABI38_0_0UM_EXPORT_MODULE(ExpoGoogleSignIn);

- (instancetype)init
{
  if (self = [super init]) {
    _authTask = [[ABI38_0_0EXAuthTask alloc] init];
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"ERRORS": @{
               ...
               @"TASK_IN_PROGRESS": ABI38_0_0EX_E_CONCURRENT_TASK_IN_PROGRESS,
               @"SIGN_IN_EXCEPTION": ABI38_0_0EX_E_EXCEPTION
               },
           @"TYPES": @{},
           @"SCOPES": @{
               @"PROFILE": @"profile",
               ...
               @"FITNESS_OXABI38_0_0YGEN_SATURATION_READ": @"https://www.googleapis.com/auth/fitness.oxygen_saturation.read",
               @"FITNESS_OXABI38_0_0YGEN_SATURATION_READ_WRITE": @"https://www.googleapis.com/auth/fitness.oxygen_saturation.write",
...
- (NSString *)_getNativeClientIdOrReject:(ABI38_0_0UMPromiseRejectBlock)reject
{
  NSString *path = [[NSBundle mainBundle] pathForResource:@"GoogleService-Info" ofType:@"plist"];
  
  if (!path) {
    reject(ABI38_0_0EX_E_EXCEPTION, @"Missing GoogleService-Info.plist", nil);
    return nil;
  }
  NSDictionary *plist = [[NSDictionary alloc] initWithContentsOfFile:path];
  NSString *clientId = plist[@"CLIENT_ID"];
  if (clientId != nil && ![clientId isEqualToString:@""]) return clientId;
  reject(ABI38_0_0EX_E_EXCEPTION, @"GoogleService-Info.plist `CLIENT_ID` is invalid", nil);
  return nil;
}
...
ABI38_0_0UM_EXPORT_METHOD_AS(initAsync,
...
ABI38_0_0UM_EXPORT_METHOD_AS(signInSilentlyAsync,
                    signInSilentlyAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
...
ABI38_0_0UM_EXPORT_METHOD_AS(signInAsync,
                    signInAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
...
ABI38_0_0UM_EXPORT_METHOD_AS(signOutAsync,
                    signOutAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
...
ABI38_0_0UM_EXPORT_METHOD_AS(disconnectAsync,
                    disconnectAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
...
ABI38_0_0UM_EXPORT_METHOD_AS(isConnectedAsync,
                    isConnectedAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  resolve(@([[GIDSignIn sharedInstance] hasPreviousSignIn]));
}

ABI38_0_0UM_EXPORT_METHOD_AS(getCurrentUserAsync,
                    getCurrentUserAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  GIDGoogleUser *currentUser = [GIDSignIn sharedInstance].currentUser;
  resolve(ABI38_0_0UMNullIfNil([ABI38_0_0EXGoogleSignIn jsonFromGIDGoogleUser:currentUser]));
}

ABI38_0_0UM_EXPORT_METHOD_AS(getPhotoAsync,
...
ABI38_0_0UM_EXPORT_METHOD_AS(getTokensAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  GIDGoogleUser *currentUser = [GIDSignIn sharedInstance].currentUser;
  if (currentUser == nil) {
    reject(ABI38_0_0EX_E_EXCEPTION, @"getTokens requires a user to be signed in", nil);
    return;
  }

  GIDAuthenticationHandler handler = ^void(GIDAuthentication *authentication, NSError *error) {
    if (error) {
      reject(ABI38_0_0EX_E_EXCEPTION, error.localizedDescription, nil);
    } else {
      resolve(@{
...
- (void)signIn:(GIDSignIn *)signIn didSignInForUser:(GIDGoogleUser *)user withError:(NSError *)error {
  [self.authTask parse:[ABI38_0_0EXGoogleSignIn jsonFromGIDGoogleUser:user] error:error];
}
