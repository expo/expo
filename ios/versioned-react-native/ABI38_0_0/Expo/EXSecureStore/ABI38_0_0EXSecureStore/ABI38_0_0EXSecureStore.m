...
@implementation ABI38_0_0EXSecureStore
...
- (CFStringRef)_accessibilityAttributeWithOptions:(NSDictionary *)options
{
  ...
  switch (accessibility) {
    case ABI38_0_0EXSecureStoreAccessibleAfterFirstUnlock:
      return kSecAttrAccessibleAfterFirstUnlock;
    case ABI38_0_0EXSecureStoreAccessibleAfterFirstUnlockThisDeviceOnly:
      return kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly;
    case ABI38_0_0EXSecureStoreAccessibleAlways:
      return kSecAttrAccessibleAlways;
    case ABI38_0_0EXSecureStoreAccessibleWhenPasscodeSetThisDeviceOnly:
      return kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly;
    case ABI38_0_0EXSecureStoreAccessibleWhenUnlocked:
      return kSecAttrAccessibleWhenUnlocked;
    case ABI38_0_0EXSecureStoreAccessibleAlwaysThisDeviceOnly:
      return kSecAttrAccessibleAlwaysThisDeviceOnly;
    case ABI38_0_0EXSecureStoreAccessibleWhenUnlockedThisDeviceOnly:
      return kSecAttrAccessibleAlwaysThisDeviceOnly;
    default:
      return kSecAttrAccessibleWhenUnlocked;
  }
...
{
  return @{
           @"AFTER_FIRST_UNLOCK":@(ABI38_0_0EXSecureStoreAccessibleAfterFirstUnlock),
           @"AFTER_FIRST_UNLOCK_THIS_DEVICE_ONLY":@(ABI38_0_0EXSecureStoreAccessibleAfterFirstUnlockThisDeviceOnly),
           @"ALWAYS":@(ABI38_0_0EXSecureStoreAccessibleAlways),
           @"WHEN_PASSCODE_SET_THIS_DEVICE_ONLY":@(ABI38_0_0EXSecureStoreAccessibleWhenPasscodeSetThisDeviceOnly),
           @"ALWAYS_THIS_DEVICE_ONLY":@(ABI38_0_0EXSecureStoreAccessibleAlwaysThisDeviceOnly),
           @"WHEN_UNLOCKED":@(ABI38_0_0EXSecureStoreAccessibleWhenUnlocked),
           @"WHEN_UNLOCKED_THIS_DEVICE_ONLY":@(ABI38_0_0EXSecureStoreAccessibleWhenUnlockedThisDeviceOnly)
           };
};

ABI38_0_0UM_EXPORT_MODULE(ExpoSecureStore);

ABI38_0_0UM_EXPORT_METHOD_AS(setValueWithKeyAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (!validatedKey) {
    reject(@"E_SECURESTORE_SETVALUEFAIL", nil, ABI38_0_0UMErrorWithMessage(@"Invalid key."));
  } else {
    NSError *error;
    ...
    if (setValue) {
      ...
      reject(@"E_SECURESTORE_SETVALUEFAIL", nil, ABI38_0_0UMErrorWithMessage([[self class] _messageForError:error]));
    }
  }
}

ABI38_0_0UM_EXPORT_METHOD_AS(getValueWithKeyAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  NSString *validatedKey = [self validatedKey:key];
  if (!validatedKey) {
    reject(@"E_SECURESTORE_GETVALUEFAIL", nil, ABI38_0_0UMErrorWithMessage(@"Invalid key."));
  } else {
    NSError *error;
    ...
    if (error) {
      if (error.code == errSecItemNotFound) {
        ...
        reject(@"E_SECURESTORE_GETVALUEFAIL", nil, ABI38_0_0UMErrorWithMessage([[self class] _messageForError:error]));
      }
    } else {
      resolve(value);
    }
...
ABI38_0_0UM_EXPORT_METHOD_AS(deleteValueWithKeyAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  NSString *validatedKey = [self validatedKey:key];
  if (!validatedKey) {
    reject(@"E_SECURESTORE_DELETEVALUEFAIL", nil, ABI38_0_0UMErrorWithMessage(@"Invalid key."));
  } else {
