...
@interface ABI38_0_0EXRemoteNotificationPermissionSingletonModule ()

@property (nonatomic, strong) NSPointerArray *delegates;

@end

@implementation ABI38_0_0EXRemoteNotificationPermissionSingletonModule

ABI38_0_0UM_REGISTER_SINGLETON_MODULE(RemoteNotificationPermissionPublisher);
