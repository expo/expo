...
#import <ABI38_0_0EXNotifications/ABI38_0_0EXPushTokenModule.h>
#import <ABI38_0_0EXNotifications/ABI38_0_0EXPushTokenManager.h>
...
@interface ABI38_0_0EXPushTokenModule ()

@property (nonatomic, weak) id<ABI38_0_0EXPushTokenManager> pushTokenManager;
...
@property (nonatomic, strong) ABI38_0_0UMPromiseResolveBlock getDevicePushTokenResolver;
@property (nonatomic, strong) ABI38_0_0UMPromiseRejectBlock getDevicePushTokenRejecter;

@end

@implementation ABI38_0_0EXPushTokenModule

ABI38_0_0UM_EXPORT_MODULE(ExpoPushTokenManager);

# pragma mark - Exported methods

ABI38_0_0UM_EXPORT_METHOD_AS(getDevicePushTokenAsync,
                    getDevicePushTokenResolving:(ABI38_0_0UMPromiseResolveBlock)resolve rejecting:(ABI38_0_0UMPromiseRejectBlock)reject)
{
...
# pragma mark - ABI38_0_0EXPushTokenListener
