...
#import <ABI38_0_0EXLocation/ABI38_0_0EXLocationDelegate.h>
...
NSString * const ABI38_0_0EXLocationChangedEventName = @"Expo.locationChanged";
NSString * const ABI38_0_0EXHeadingChangedEventName = @"Expo.headingChanged";

@interface ABI38_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI38_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) NSMutableSet<ABI38_0_0EXLocationDelegate *> *retainedDelegates;
...
@property (nonatomic, weak) id<ABI38_0_0UMAppLifecycleService> lifecycleService;
@property (nonatomic, weak) id<ABI38_0_0UMTaskManagerInterface> tasksManager;

@end

@implementation ABI38_0_0EXLocation

ABI38_0_0UM_EXPORT_MODULE(ExpoLocation);
...
- (void)setModuleRegistry:(ABI38_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  [ABI38_0_0UMPermissionsMethodsDelegate registerRequesters:@[[ABI38_0_0EXLocationPermissionRequester new]] withPermissionsManager:_permissionsManager];
  _lifecycleService = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI38_0_0UMAppLifecycleService)];
  _tasksManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI38_0_0UMTaskManagerInterface)];
...
{
  return @[ABI38_0_0EXLocationChangedEventName, ABI38_0_0EXHeadingChangedEventName];
}
...
ABI38_0_0UM_EXPORT_METHOD_AS(getProviderStatusAsync,
...
ABI38_0_0UM_EXPORT_METHOD_AS(getCurrentPositionAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI38_0_0EXLocationDelegate *delegate;

  delegate = [[ABI38_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (delegate != nil) {
      if (locations.lastObject != nil) {
        resolve([ABI38_0_0EXLocation exportLocation:locations.lastObject]);
      } else {
...
ABI38_0_0UM_EXPORT_METHOD_AS(watchPositionImplAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  ABI38_0_0EXLocationDelegate *delegate = [[ABI38_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject != nil && weakSelf != nil) {
      ...
      NSDictionary *body = @{
                             @"watchId": watchId,
                             @"location": [ABI38_0_0EXLocation exportLocation:loc],
                             };

      [strongSelf->_eventEmitter sendEventWithName:ABI38_0_0EXLocationChangedEventName body:body];
    }
  } onUpdateHeadings:nil onError:^(NSError *error) {
    // TODO: report errors
...
ABI38_0_0UM_EXPORT_METHOD_AS(getLastKnownPositionAsync,
                    getLastKnownPositionAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  if (![self checkPermissions:reject]) {
    return;
  ...
  delegate = [[ABI38_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:lockMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (lockMgr) {
...
ABI38_0_0UM_EXPORT_METHOD_AS(watchDeviceHeading,
  ...
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI38_0_0EXLocationPermissionRequester class]]) {
  ...
  ABI38_0_0EXLocationDelegate *delegate = [[ABI38_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
    if (newHeading != nil && weakSelf != nil) {
      ...
      [strongSelf->_eventEmitter sendEventWithName:ABI38_0_0EXHeadingChangedEventName body:body];
    }
...
ABI38_0_0UM_EXPORT_METHOD_AS(removeWatchAsync,
                    watchId:(nonnull NSNumber *)watchId
                    resolver:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ABI38_0_0EXLocationDelegate *delegate = _delegates[watchId];
...
ABI38_0_0UM_EXPORT_METHOD_AS(geocodeAsync,
...
ABI38_0_0UM_EXPORT_METHOD_AS(reverseGeocodeAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  [ABI38_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI38_0_0EXLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
...
ABI38_0_0UM_EXPORT_METHOD_AS(hasServicesEnabledAsync,
                    hasServicesEnabled:(ABI38_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI38_0_0UMPromiseRejectBlock)reject)
{
...
ABI38_0_0UM_EXPORT_METHOD_AS(startLocationUpdatesAsync,
                    ...
                    reject:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI38_0_0EXLocationTaskConsumer class] options:options];
  }
  @catch (NSException *e) {
...
ABI38_0_0UM_EXPORT_METHOD_AS(stopLocationUpdatesAsync,
                    ...
                    reject:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI38_0_0EXLocationTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI38_0_0UM_EXPORT_METHOD_AS(hasStartedLocationUpdatesAsync,
                    ...
                    reject:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI38_0_0EXLocationTaskConsumer class]]));
}

# pragma mark - Geofencing

ABI38_0_0UM_EXPORT_METHOD_AS(startGeofencingAsync,
                    ...
                    reject:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI38_0_0EXGeofencingTaskConsumer class] options:options];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI38_0_0UM_EXPORT_METHOD_AS(stopGeofencingAsync,
                    ...
                    reject:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI38_0_0EXGeofencingTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI38_0_0UM_EXPORT_METHOD_AS(hasStartedGeofencingAsync,
                    ...
                    reject:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI38_0_0EXGeofencingTaskConsumer class]]));
}
...
- (BOOL)checkPermissions:(ABI38_0_0UMPromiseRejectBlock)reject
{
...
- (BOOL)checkTaskManagerExists:(ABI38_0_0UMPromiseRejectBlock)reject
{
...
- (BOOL)checkBackgroundServices:(ABI38_0_0UMPromiseRejectBlock)reject
{
...
{
  switch (accuracy) {
    case ABI38_0_0EXLocationAccuracyLowest:
      return kCLLocationAccuracyThreeKilometers;
    case ABI38_0_0EXLocationAccuracyLow:
      return kCLLocationAccuracyKilometer;
    case ABI38_0_0EXLocationAccuracyBalanced:
      return kCLLocationAccuracyHundredMeters;
    case ABI38_0_0EXLocationAccuracyHigh:
      return kCLLocationAccuracyNearestTenMeters;
    case ABI38_0_0EXLocationAccuracyHighest:
      return kCLLocationAccuracyBest;
    case ABI38_0_0EXLocationAccuracyBestForNavigation:
