...
#import <ABI38_0_0EXLocation/ABI38_0_0EXLocationPermissionRequester.h>
...
@interface ABI38_0_0EXLocationPermissionRequester () <CLLocationManagerDelegate>
...
@implementation ABI38_0_0EXLocationPermissionRequester
...
- (void)requestPermissionsWithResolver:(ABI38_0_0UMPromiseResolveBlock)resolve rejecter:(ABI38_0_0UMPromiseRejectBlock)reject
{
  ...
  if (existingPermissions && [existingPermissions[@"status"] intValue] != ABI38_0_0UMPermissionStatusUndetermined) {
