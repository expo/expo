...
#import <ABI38_0_0EXLocation/ABI38_0_0EXLocationTaskConsumer.h>
#import <ABI38_0_0UMTaskManagerInterface/ABI38_0_0UMTaskInterface.h>

@interface ABI38_0_0EXLocationTaskConsumer ()
...
@implementation ABI38_0_0EXLocationTaskConsumer
...
- (void)setOptions:(NSDictionary *)options
{
  [ABI38_0_0UMUtilities performSynchronouslyOnMainThread:^{
    ...
    ABI38_0_0EXLocationAccuracy accuracy = [options[@"accuracy"] unsignedIntegerValue] ?: ABI38_0_0EXLocationAccuracyBalanced;

    locationManager.desiredAccuracy = [ABI38_0_0EXLocation CLLocationAccuracyFromOption:accuracy];
    locationManager.distanceFilter = [options[@"distanceInterval"] doubleValue] ?: kCLDistanceFilterNone;
    locationManager.activityType = [ABI38_0_0EXLocation CLActivityTypeFromOption:[options[@"activityType"] integerValue]];
...
- (void)executeTaskWithDeferredLocations
{
  ...
  NSDictionary *data = @{ @"locations": [ABI38_0_0EXLocationTaskConsumer _exportLocations:_deferredLocations] };
...
+ (NSArray<NSDictionary *> *)_exportLocations:(NSArray<CLLocation *> *)locations
{
  ...
  for (CLLocation *location in locations) {
    [result addObject:[ABI38_0_0EXLocation exportLocation:location]];
  }
  return result;
}
