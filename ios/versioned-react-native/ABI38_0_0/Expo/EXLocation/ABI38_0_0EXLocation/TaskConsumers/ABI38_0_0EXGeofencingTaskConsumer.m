...
#import <ABI38_0_0EXLocation/ABI38_0_0EXLocation.h>
#import <ABI38_0_0EXLocation/ABI38_0_0EXGeofencingTaskConsumer.h>
#import <ABI38_0_0UMTaskManagerInterface/ABI38_0_0UMTaskInterface.h>

@interface ABI38_0_0EXGeofencingTaskConsumer ()
...
@implementation ABI38_0_0EXGeofencingTaskConsumer
...
# pragma mark - ABI38_0_0UMTaskConsumerInterface
...
- (void)startMonitoringRegionsForTask:(id<ABI38_0_0UMTaskInterface>)task
{
  [ABI38_0_0UMUtilities performSynchronouslyOnMainThread:^{
...
- (void)executeTaskWithRegion:(nonnull CLRegion *)region eventType:(ABI38_0_0EXGeofencingEventType)eventType
{
...
- (void)locationManager:(CLLocationManager *)manager didEnterRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != CLRegionStateInside) {
    ...
    [self executeTaskWithRegion:region eventType:ABI38_0_0EXGeofencingEventTypeEnter];
  }
}
...
- (void)locationManager:(CLLocationManager *)manager didExitRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != CLRegionStateOutside) {
    ...
    [self executeTaskWithRegion:region eventType:ABI38_0_0EXGeofencingEventTypeExit];
  }
}
...
- (void)locationManager:(CLLocationManager *)manager didDetermineState:(CLRegionState)state forRegion:(CLRegion *)region
{
  if ([self regionStateForIdentifier:region.identifier] != state) {
    ABI38_0_0EXGeofencingEventType eventType = state == CLRegionStateInside ? ABI38_0_0EXGeofencingEventTypeEnter : ABI38_0_0EXGeofencingEventTypeExit;
...
+ (ABI38_0_0EXGeofencingRegionState)exportRegionState:(CLRegionState)regionState
{
  switch (regionState) {
    case CLRegionStateUnknown:
      return ABI38_0_0EXGeofencingRegionStateUnknown;
    case CLRegionStateInside:
      return ABI38_0_0EXGeofencingRegionStateInside;
    case CLRegionStateOutside:
      return ABI38_0_0EXGeofencingRegionStateOutside;
  }
}
