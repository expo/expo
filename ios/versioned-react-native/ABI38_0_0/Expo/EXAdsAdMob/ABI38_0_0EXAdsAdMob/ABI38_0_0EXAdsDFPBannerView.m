...
@implementation ABI38_0_0EXAdsDFPBannerView {
  DFPBannerView *_bannerView;
  id<ABI38_0_0UMEventEmitterService> _eventEmitter;
}
...
- (void)setOnSizeChange:(ABI38_0_0UMDirectEventBlock)block
{
  _onSizeChange = block;
  [self loadBanner];
}

- (void)setOnDidFailToReceiveAdWithError:(ABI38_0_0UMDirectEventBlock)block
{
