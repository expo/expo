...
@interface ABI38_0_0EXScreenOrientationRegistry ()
...
@implementation ABI38_0_0EXScreenOrientationRegistry

ABI38_0_0UM_REGISTER_SINGLETON_MODULE(ScreenOrientationRegistry)
...
- (void)enforceDesiredDeviceOrientationWithOrientationMask:(UIInterfaceOrientationMask)orientationMask
{
  ...
  if (![ABI38_0_0EXScreenOrientationUtilities doesOrientationMask:orientationMask containOrientation:_currentScreenOrientation]) {
    __block UIInterfaceOrientation newOrientation = [ABI38_0_0EXScreenOrientationUtilities defaultOrientationForOrientationMask:orientationMask];
...
{
  UIInterfaceOrientation newScreenOrientation = [ABI38_0_0EXScreenOrientationUtilities interfaceOrientationFromDeviceOrientation:[notification.object orientation]];
...
- (void)interfaceOrientationDidChange:(UIInterfaceOrientation)newScreenOrientation
{
  ...
  if ([ABI38_0_0EXScreenOrientationUtilities doesOrientationMask:currentOrientationMask containOrientation:newScreenOrientation]) {
    ...
    if ([ABI38_0_0EXScreenOrientationUtilities isIPad] &&
...
- (void)traitCollectionDidChangeTo:(UITraitCollection *)traitCollection
{
  ...
  UIInterfaceOrientation currentDeviceOrientation = [ABI38_0_0EXScreenOrientationUtilities interfaceOrientationFromDeviceOrientation:[[UIDevice currentDevice] orientation]];
