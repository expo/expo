...
#import <ABI38_0_0EXSplashScreen/ABI38_0_0EXSplashScreenViewNativeProvider.h>
#import <ABI38_0_0UMCore/ABI38_0_0UMLogManager.h>

@implementation ABI38_0_0EXSplashScreenViewNativeProvider
...
- (nonnull UIView *)createSplashScreenView
{
  ...
  @try {
    ...
    ABI38_0_0UMLogInfo(@"'SplashScreen.storyboard' file is missing. Fallbacking to 'SplashScreen.xib' file.");
  }
  if (storyboard) {
    @try {
  ...
  @try {
    ...
    ABI38_0_0UMLogInfo(@"'SplashScreen.xib' file is missing - 'expo-splash-screen' would not work as expected.");
  }
  if (views) {
