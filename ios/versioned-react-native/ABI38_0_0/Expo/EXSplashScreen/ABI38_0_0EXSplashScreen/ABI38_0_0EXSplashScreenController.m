...
#import <ABI38_0_0EXSplashScreen/ABI38_0_0EXSplashScreenController.h>
#import <ABI38_0_0UMCore/ABI38_0_0UMDefines.h>

@interface ABI38_0_0EXSplashScreenController ()
...
@implementation ABI38_0_0EXSplashScreenController

- (instancetype)initWithViewController:(UIViewController *)viewController
              splashScreenViewProvider:(id<ABI38_0_0EXSplashScreenViewProvider>)splashScreenViewProvider
{
  if (self = [super init]) {
