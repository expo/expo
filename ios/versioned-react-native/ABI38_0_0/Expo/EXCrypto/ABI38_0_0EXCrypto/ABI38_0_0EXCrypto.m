...
#import <ABI38_0_0EXCrypto/ABI38_0_0EXCrypto.h>
#import <CommonCrypto/CommonDigest.h>

@implementation ABI38_0_0EXCrypto

ABI38_0_0UM_EXPORT_MODULE(ExpoCrypto);

ABI38_0_0UM_EXPORT_METHOD_AS(digestStringAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  int digestLength = [ABI38_0_0EXCrypto digestLengthForJSAlgorithm:algorithm];
  if (digestLength == -1) {
