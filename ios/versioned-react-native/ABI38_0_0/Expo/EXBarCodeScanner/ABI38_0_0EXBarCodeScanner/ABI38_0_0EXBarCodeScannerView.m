...
@interface ABI38_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI38_0_0EXBarCodeScanner *barCodeScanner;
...
@implementation ABI38_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI38_0_0UMModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI38_0_0UMAppLifecycleListener)];
...
{
  ABI38_0_0UM_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI38_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI38_0_0EXBareCodeCameraRequester class]]) {
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI38_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI38_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI38_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI38_0_0EXBarCodeScanner *barCodeScanner = [ABI38_0_0EXBarCodeScanner new];
