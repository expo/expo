...
#import <ABI38_0_0EXMailComposer/ABI38_0_0EXMailComposer.h>
...
@interface ABI38_0_0EXMailComposer ()
...
@implementation ABI38_0_0EXMailComposer

ABI38_0_0UM_EXPORT_MODULE(ExpoMailComposer);
...
ABI38_0_0UM_EXPORT_METHOD_AS(composeAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  self.reject = reject;
  id<ABI38_0_0UMUtilitiesInterface> utilities = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI38_0_0UMUtilitiesInterface)];
