...
#import <ABI38_0_0EXSMS/ABI38_0_0EXSMSModule.h>
...
@interface ABI38_0_0EXSMSModule () <MFMessageComposeViewControllerDelegate>

@property (nonatomic, weak) id<ABI38_0_0UMUtilitiesInterface> utils;
...
@implementation ABI38_0_0EXSMSModule

ABI38_0_0UM_EXPORT_MODULE(ExpoSMS);
...
{
  _utils = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI38_0_0UMUtilitiesInterface)];
}

ABI38_0_0UM_EXPORT_METHOD_AS(isAvailableAsync,
                    isAvailable:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  resolve(@([MFMessageComposeViewController canSendText]));
}

ABI38_0_0UM_EXPORT_METHOD_AS(sendSMSAsync,
