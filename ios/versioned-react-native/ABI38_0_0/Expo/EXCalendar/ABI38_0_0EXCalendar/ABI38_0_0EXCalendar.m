...
#import <ABI38_0_0EXCalendar/ABI38_0_0EXCalendar.h>
#import <ABI38_0_0EXCalendar/ABI38_0_0EXCalendarConverter.h>
#import <ABI38_0_0EXCalendar/ABI38_0_0EXCalendarPermissionRequester.h>
...
@implementation ABI38_0_0EXCalendar
...
ABI38_0_0UM_EXPORT_MODULE(ExpoCalendar);
...
- (void)setModuleRegistry:(ABI38_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  [ABI38_0_0UMPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI38_0_0EXCalendarPermissionRequester new],
                                                    [ABI38_0_0EXRemindersPermissionRequester new]
                                                    ]
...
ABI38_0_0UM_EXPORT_METHOD_AS(getCalendarsAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI38_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI38_0_0UM_EXPORT_METHOD_AS(getDefaultCalendarAsync,
                    getDefaultCalendarAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejector:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  if (![self _checkCalendarPermissions:reject]) {
    return;
  }
  ...
  resolve([ABI38_0_0EXCalendarConverter serializeCalendar:defaultCalendar]);
}

ABI38_0_0UM_EXPORT_METHOD_AS(saveCalendarAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (color) {
    calendar.CGColor = [ABI38_0_0UMUtilities UIColor:color].CGColor;
...
ABI38_0_0UM_EXPORT_METHOD_AS(deleteCalendarAsync,
...
ABI38_0_0UM_EXPORT_METHOD_AS(getEventsAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI38_0_0UMUtilities NSDate:startDateStr];
  NSDate *endDate = [ABI38_0_0UMUtilities NSDate:endDateStr];
  ...
  if (calendarEvents) {
    resolve([ABI38_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI38_0_0UM_EXPORT_METHOD_AS(getEventByIdAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (calendarEvent) {
    resolve([ABI38_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI38_0_0UM_EXPORT_METHOD_AS(saveEventAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI38_0_0UMUtilities NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI38_0_0UMUtilities NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI38_0_0UMUtilities NSDate:details[@"instanceStartDate"]];
...
ABI38_0_0UM_EXPORT_METHOD_AS(deleteEventAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *instanceStartDate = [ABI38_0_0UMUtilities NSDate:event[@"instanceStartDate"]];
...
ABI38_0_0UM_EXPORT_METHOD_AS(getAttendeesForEventAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (item.hasAttendees) {
    resolve([ABI38_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI38_0_0UM_EXPORT_METHOD_AS(getRemindersAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI38_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI38_0_0UM_EXPORT_METHOD_AS(getReminderByIdAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (reminder) {
    ...
    resolve([ABI38_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI38_0_0UM_EXPORT_METHOD_AS(saveReminderAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI38_0_0UMUtilities NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI38_0_0UMUtilities NSDate:details[@"dueDate"]];
  NSDate *completionDate = [ABI38_0_0UMUtilities NSDate:details[@"completionDate"]];
...
ABI38_0_0UM_EXPORT_METHOD_AS(deleteReminderAsync,
...
ABI38_0_0UM_EXPORT_METHOD_AS(getSourcesAsync,
                    getSourcesAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI38_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI38_0_0UM_EXPORT_METHOD_AS(getSourceByIdAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI38_0_0EXCalendarConverter serializeSource:source]);
}

ABI38_0_0UM_EXPORT_METHOD_AS(getCalendarPermissionsAsync,
                    getCalendarPermissionsAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  [ABI38_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI38_0_0EXCalendarPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI38_0_0UM_EXPORT_METHOD_AS(requestCalendarPermissionsAsync,
                    requestCalendarPermissionsAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
...
ABI38_0_0UM_EXPORT_METHOD_AS(getRemindersPermissionsAsync,
                    getRemindersPermissionsAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  [ABI38_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI38_0_0EXRemindersPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI38_0_0UM_EXPORT_METHOD_AS(requestRemindersPermissionsAsync,
                    requestRemindersPermissionsAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  [ABI38_0_0UMPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI38_0_0EXRemindersPermissionRequester class]
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI38_0_0UMUtilities NSDate:alarm[@"absoluteDate"]];
...
- (EKRecurrenceRule *)_createRecurrenceRule:(NSDictionary *)recurrenceRule
{
  ...
  if (recurrenceRule[@"endDate"]) {
      endDate = [ABI38_0_0UMUtilities NSDate:recurrenceRule[@"endDate"]];
  }
...
- (BOOL)_checkPermissions:(EKEntityType)entity reject:(ABI38_0_0UMPromiseRejectBlock)reject
{
  ...
  switch (entity) {
    case EKEntityTypeEvent:
      requesterClass = [ABI38_0_0EXCalendarPermissionRequester class];
      break;
    case EKEntityTypeReminder:
      requesterClass = [ABI38_0_0EXRemindersPermissionRequester class];
      break;
    default: {
...
- (BOOL)_checkCalendarPermissions:(ABI38_0_0UMPromiseRejectBlock)reject
{
  return [self _checkPermissions:EKEntityTypeEvent reject:reject];
}

- (BOOL)_checkRemindersPermissions:(ABI38_0_0UMPromiseRejectBlock)reject
{
...
- (void)_initializePermittedEntities
{
  ...
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI38_0_0EXCalendarPermissionRequester class]]) {
    permittedEntities |= EKEntityMaskEvent;
  }
  
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI38_0_0EXRemindersPermissionRequester class]]) {
