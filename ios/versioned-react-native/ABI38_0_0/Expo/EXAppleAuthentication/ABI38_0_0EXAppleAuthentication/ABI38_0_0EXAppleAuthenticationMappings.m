...
@implementation ABI38_0_0EXAppleAuthenticationMappings
...
{
  return @{
           @"namePrefix": ABI38_0_0UMNullIfNil(nameComponents.namePrefix),
           @"givenName": ABI38_0_0UMNullIfNil(nameComponents.givenName),
           @"middleName": ABI38_0_0UMNullIfNil(nameComponents.middleName),
           @"familyName": ABI38_0_0UMNullIfNil(nameComponents.familyName),
           @"nameSuffix": ABI38_0_0UMNullIfNil(nameComponents.nameSuffix),
           @"nickname": ABI38_0_0UMNullIfNil(nameComponents.nickname)
           };
}
