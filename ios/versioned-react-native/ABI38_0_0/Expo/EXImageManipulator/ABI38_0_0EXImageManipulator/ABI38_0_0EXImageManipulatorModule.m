...
#import <ABI38_0_0EXImageManipulator/ABI38_0_0EXImageManipulatorModule.h>
...
@interface ABI38_0_0EXImageManipulatorModule ()
...
@implementation ABI38_0_0EXImageManipulatorModule

ABI38_0_0UM_EXPORT_MODULE(ExpoImageManipulator);
...
ABI38_0_0UM_EXPORT_METHOD_AS(manipulateAsync,
                    uri:(NSString *)uri
                    ...
                    reject:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (!([_fileSystem permissionsForURI:url] & ABI38_0_0UMFileSystemPermissionRead)) {
