...
// Interface for ABI38_0_0UMTaskManager module.

@protocol ABI38_0_0UMTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI38_0_0UMTaskConsumerInterface protocol.
 */
