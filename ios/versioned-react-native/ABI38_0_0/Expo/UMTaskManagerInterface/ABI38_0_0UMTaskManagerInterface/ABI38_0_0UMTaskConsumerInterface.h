...
#import <ABI38_0_0UMTaskManagerInterface/ABI38_0_0UMTaskLaunchReason.h>
...
@protocol ABI38_0_0UMTaskConsumerInterface <NSObject>

@property (nonatomic, strong) id<ABI38_0_0UMTaskInterface> __nullable task;
...
/**
 *  Called by ABI38_0_0UMTaskService when the task is created and associated with the consumer.
 */
- (void)didRegisterTask:(nonnull id<ABI38_0_0UMTaskInterface>)task;
...
/**
 *  Called by ABI38_0_0UMTaskService to inform the consumer that the associated task is ready to be executed.
 */
...
/**
 *  Called by ABI38_0_0UMTaskManager when the task has been completed and we received a result from JS app.
 */
- (void)didFinish;
