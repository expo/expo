...
@protocol ABI38_0_0UMTaskConsumerInterface;

@protocol ABI38_0_0UMTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI38_0_0UMTaskConsumerInterface> __nonnull consumer;
