...
@implementation UIFont (ABI38_0_0EXFontLoader)

- (UIFont *)ABI38_0_0EXFontWithSize:(CGFloat)fontSize
{
  for (id<ABI38_0_0UMFontScalerInterface> fontScaler in currentFontScalers) {
  ...
  return [self ABI38_0_0EXFontWithSize:fontSize];
}
...
@implementation ABI38_0_0EXFontScalersManager

ABI38_0_0UM_REGISTER_SINGLETON_MODULE(FontScalersManager);
...
+ (void)initialize
{
  ...
  dispatch_once(&initializeCurrentFontScalersOnce, ^{
    ...
    SEL exUpdate = @selector(ABI38_0_0EXFontWithSize:);
...
- (void)registerFontScaler:(id<ABI38_0_0UMFontScalerInterface>)fontScaler
{
