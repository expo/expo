...
@interface ABI38_0_0UMNativeModulesProxy ()

@property (nonatomic, strong) NSRegularExpression *regexp;
@property (nonatomic, strong) ABI38_0_0UMModuleRegistry *moduleRegistry;
...
@implementation ABI38_0_0UMNativeModulesProxy
...
# pragma mark - ABI38_0_0React API
...
- (NSDictionary *)constantsToExport
{
  ...
  NSArray<ABI38_0_0UMViewManager *> *viewManagers = [_moduleRegistry getAllViewManagers];
...
ABI38_0_0RCT_EXPORT_METHOD(callMethod:(NSString *)moduleName methodNameOrKey:(id)methodNameOrKey arguments:(NSArray *)arguments resolver:(ABI38_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI38_0_0RCTPromiseRejectBlock)reject)
{
