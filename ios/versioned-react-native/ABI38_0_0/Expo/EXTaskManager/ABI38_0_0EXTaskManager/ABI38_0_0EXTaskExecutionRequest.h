...
@interface ABI38_0_0EXTaskExecutionRequest : NSObject
...
- (void)addTask:(nonnull id<ABI38_0_0UMTaskInterface>)task;
- (void)task:(nonnull id<ABI38_0_0UMTaskInterface>)task didFinishWithResult:(id)result;
- (BOOL)isIncludingTask:(nullable id<ABI38_0_0UMTaskInterface>)task;
- (void)maybeEvaluate;
