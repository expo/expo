...
@interface ABI38_0_0EXTaskExecutionRequest ()

@property (nonatomic, strong, nullable) NSMutableSet<id<ABI38_0_0UMTaskInterface>> *tasks;
...
@implementation ABI38_0_0EXTaskExecutionRequest
...
- (void)_maybeExecuteCallback
{
  if (_callback) {
    ...
    __strong ABI38_0_0EXTaskExecutionRequest *strongSelf = self;
