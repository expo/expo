...
#import <ABI38_0_0EXInAppPurchases/ABI38_0_0EXInAppPurchasesModule.h>

@interface ABI38_0_0EXInAppPurchasesModule ()
...
@implementation ABI38_0_0EXInAppPurchasesModule

ABI38_0_0UM_EXPORT_MODULE(ExpoInAppPurchases);
...
ABI38_0_0UM_EXPORT_METHOD_AS(connectAsync,
                    connectAsync:(ABI38_0_0UMPromiseResolveBlock)resolve
...
ABI38_0_0UM_EXPORT_METHOD_AS(getProductsAsync,
...
ABI38_0_0UM_EXPORT_METHOD_AS(purchaseItemAsync,
...
ABI38_0_0UM_EXPORT_METHOD_AS(finishTransactionAsync,
...
ABI38_0_0UM_EXPORT_METHOD_AS(getPurchaseHistoryAsync,
...
- (BOOL)setPromise:(NSString*)key resolve:(ABI38_0_0UMPromiseResolveBlock)resolve reject:(ABI38_0_0UMPromiseRejectBlock)reject
{
...
- (void)resolvePromise:(NSString*)key value:(id)value
{
  ...
  if (currentPromise != nil) {
    ABI38_0_0UMPromiseResolveBlock resolve = currentPromise[0];
    _promises[key] = nil;
...
- (void)rejectPromise:(NSString*)key code:(NSString*)code message:(NSString*)message error:(NSError*) error
{
  ...
  if (currentPromise != nil) {
    ABI38_0_0UMPromiseRejectBlock reject = currentPromise[1];
    _promises[key] = nil;
