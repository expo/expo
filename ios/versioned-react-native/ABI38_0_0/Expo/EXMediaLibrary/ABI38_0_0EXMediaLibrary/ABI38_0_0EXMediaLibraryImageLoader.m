...
// Prior to ABI38_0_0React Native 0.61, it contained `ABI38_0_0RCTAssetsLibraryRequestHandler` that handles loading data from URLs
// with `assets-library://` or `ph://` schemes. Due to lean core project, it's been moved to `@ABI38_0_0React-native-community/cameraroll`
// and that made it impossible to render assets using URLs returned by MediaLibrary without installing CameraRoll.
// Because it's still a unimodule and we need to export bare ABI38_0_0React Native module, we should make sure ABI38_0_0React Native is installed.
#if __has_include(<ABI38_0_0React/ABI38_0_0RCTImageURLLoader.h>)

#import <Photos/Photos.h>
#import <ABI38_0_0React/ABI38_0_0RCTUtils.h>
#import <ABI38_0_0EXMediaLibrary/ABI38_0_0EXMediaLibraryImageLoader.h>

@implementation ABI38_0_0EXMediaLibraryImageLoader

ABI38_0_0RCT_EXPORT_MODULE()

#pragma mark - ABI38_0_0RCTImageURLLoader
