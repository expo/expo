...
@interface ABI38_0_0EXSaveToLibraryDelegate ()

@property (nonatomic, strong) ABI38_0_0EXSaveToLibraryCallback callback;

@end

@implementation ABI38_0_0EXSaveToLibraryDelegate : NSObject
