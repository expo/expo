...
NSString *const ABI38_0_0EXAVPlayerDataStatusIsLoadedKeyPath = @"isLoaded";
NSString *const ABI38_0_0EXAVPlayerDataStatusURIKeyPath = @"uri";
NSString *const ABI38_0_0EXAVPlayerDataStatusHeadersKeyPath = @"headers";
NSString *const ABI38_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath = @"progressUpdateIntervalMillis";
NSString *const ABI38_0_0EXAVPlayerDataStatusDurationMillisKeyPath = @"durationMillis";
NSString *const ABI38_0_0EXAVPlayerDataStatusPositionMillisKeyPath = @"positionMillis";
NSString *const ABI38_0_0EXAVPlayerDataStatusSeekMillisToleranceBeforeKeyPath = @"seekMillisToleranceBefore";
NSString *const ABI38_0_0EXAVPlayerDataStatusSeekMillisToleranceAfterKeyPath = @"seekMillisToleranceAfter";
NSString *const ABI38_0_0EXAVPlayerDataStatusPlayableDurationMillisKeyPath = @"playableDurationMillis";
NSString *const ABI38_0_0EXAVPlayerDataStatusShouldPlayKeyPath = @"shouldPlay";
NSString *const ABI38_0_0EXAVPlayerDataStatusIsPlayingKeyPath = @"isPlaying";
NSString *const ABI38_0_0EXAVPlayerDataStatusIsBufferingKeyPath = @"isBuffering";
NSString *const ABI38_0_0EXAVPlayerDataStatusRateKeyPath = @"rate";
NSString *const ABI38_0_0EXAVPlayerDataStatusPitchCorrectionQualityKeyPath = @"pitchCorrectionQuality";
NSString *const ABI38_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath = @"shouldCorrectPitch";
NSString *const ABI38_0_0EXAVPlayerDataStatusVolumeKeyPath = @"volume";
NSString *const ABI38_0_0EXAVPlayerDataStatusIsMutedKeyPath = @"isMuted";
NSString *const ABI38_0_0EXAVPlayerDataStatusIsLoopingKeyPath = @"isLooping";
NSString *const ABI38_0_0EXAVPlayerDataStatusDidJustFinishKeyPath = @"didJustFinish";
NSString *const ABI38_0_0EXAVPlayerDataStatusHasJustBeenInterruptedKeyPath = @"hasJustBeenInterrupted";

NSString *const ABI38_0_0EXAVPlayerDataObserverStatusKeyPath = @"status";
NSString *const ABI38_0_0EXAVPlayerDataObserverRateKeyPath = @"rate";
NSString *const ABI38_0_0EXAVPlayerDataObserverCurrentItemKeyPath = @"currentItem";
NSString *const ABI38_0_0EXAVPlayerDataObserverTimeControlStatusPath = @"timeControlStatus";
NSString *const ABI38_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath = @"playbackBufferEmpty";

@interface ABI38_0_0EXAVPlayerData ()
...
@property (nonatomic, strong) ABI38_0_0UMPromiseResolveBlock replayResolve;

@end

@implementation ABI38_0_0EXAVPlayerData

#pragma mark - Static methods

+ (NSDictionary *)getUnloadedStatus
{
  return @{ABI38_0_0EXAVPlayerDataStatusIsLoadedKeyPath: @(NO)};
}
         ...
         withLoadFinishBlock:(void (^)(BOOL success, NSDictionary *successStatus, NSString *error))loadFinishBlock
{
  if ((self = [super init])) {
    ...
    _url = [NSURL URLWithString:[source objectForKey:ABI38_0_0EXAVPlayerDataStatusURIKeyPath]];
    _headers = [self validatedRequestHeaders:source[ABI38_0_0EXAVPlayerDataStatusHeadersKeyPath]];
...
- (void)_loadNewPlayer
{
  ...
  [avAsset loadValuesAsynchronouslyForKeys:@[ @"duration" ] completionHandler:^{
    __weak ABI38_0_0EXAVPlayerData *strongSelf = weakSelf;
    if (strongSelf) {
      ...
      if (strongSelf.player) {
        [strongSelf.player addObserver:strongSelf forKeyPath:ABI38_0_0EXAVPlayerDataObserverStatusKeyPath options:0 context:nil];
        [strongSelf.player.currentItem addObserver:strongSelf forKeyPath:ABI38_0_0EXAVPlayerDataObserverStatusKeyPath options:0 context:nil];
      } else {
...
- (void)_finishLoadingNewPlayer
{
  ...
  [_player seekToTime:_currentPosition completionHandler:^(BOOL finished) {
    __strong ABI38_0_0EXAVPlayerData *strongSelf = weakSelf;
    __strong ABI38_0_0EXAV *strongEXAV = strongSelf ? strongSelf.exAV : nil;
    if (strongEXAV) {
      dispatch_async(strongEXAV.methodQueue, ^{
        __strong ABI38_0_0EXAVPlayerData *strongSelfInner = weakSelf;
        if (strongSelfInner) {
         ...
         rejecter:(ABI38_0_0UMPromiseRejectBlock)reject
{
  ...
  if ([parameters objectForKey:ABI38_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath] != nil) {
    NSNumber *progressUpdateIntervalMillis = parameters[ABI38_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath];
  ...
  if ([parameters objectForKey:ABI38_0_0EXAVPlayerDataStatusPositionMillisKeyPath] != nil) {
    NSNumber *currentPositionMillis = parameters[ABI38_0_0EXAVPlayerDataStatusPositionMillisKeyPath];
  ...
  if (mustSeek && [parameters objectForKey:ABI38_0_0EXAVPlayerDataStatusSeekMillisToleranceBeforeKeyPath] != nil) {
    NSNumber *seekMillisToleranceBefore = parameters[ABI38_0_0EXAVPlayerDataStatusSeekMillisToleranceBeforeKeyPath];
  ...
  if (mustSeek && [parameters objectForKey:ABI38_0_0EXAVPlayerDataStatusSeekMillisToleranceAfterKeyPath] != nil) {
    NSNumber *seekMillisToleranceAfter = parameters[ABI38_0_0EXAVPlayerDataStatusSeekMillisToleranceAfterKeyPath];
    toleranceAfter = CMTimeMakeWithSeconds(seekMillisToleranceAfter.floatValue / 1000, NSEC_PER_SEC);
  }
  
  if ([parameters objectForKey:ABI38_0_0EXAVPlayerDataStatusShouldPlayKeyPath] != nil) {
    NSNumber *shouldPlay = parameters[ABI38_0_0EXAVPlayerDataStatusShouldPlayKeyPath];
    _shouldPlay = shouldPlay.boolValue;
  }
  
  if ([parameters objectForKey:ABI38_0_0EXAVPlayerDataStatusRateKeyPath] != nil) {
    NSNumber *rate = parameters[ABI38_0_0EXAVPlayerDataStatusRateKeyPath];
    _rate = rate;
  }
  
  if (parameters[ABI38_0_0EXAVPlayerDataStatusPitchCorrectionQualityKeyPath] != nil) {
    _pitchCorrectionQuality = parameters[ABI38_0_0EXAVPlayerDataStatusPitchCorrectionQualityKeyPath];
  }
  
  if ([parameters objectForKey:ABI38_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath] != nil) {
    NSNumber *shouldCorrectPitch = parameters[ABI38_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath];
    _shouldCorrectPitch = shouldCorrectPitch.boolValue;
  }
  if ([parameters objectForKey:ABI38_0_0EXAVPlayerDataStatusVolumeKeyPath] != nil) {
    NSNumber *volume = parameters[ABI38_0_0EXAVPlayerDataStatusVolumeKeyPath];
    _volume = volume;
  }
  if ([parameters objectForKey:ABI38_0_0EXAVPlayerDataStatusIsMutedKeyPath] != nil) {
    NSNumber *isMuted = parameters[ABI38_0_0EXAVPlayerDataStatusIsMutedKeyPath];
    _isMuted = isMuted.boolValue;
  }
  if ([parameters objectForKey:ABI38_0_0EXAVPlayerDataStatusIsLoopingKeyPath] != nil) {
    NSNumber *isLooping = parameters[ABI38_0_0EXAVPlayerDataStatusIsLoopingKeyPath];
    ...
    void (^applyPostSeekParameters)(BOOL) = ^(BOOL seekSucceeded) {
      ...
      if (strongSelf) {
        ...
        if (audioSessionError) {
          ...
          if (reject) {
            reject(@"E_AV_SEEKING", nil, ABI38_0_0UMErrorWithMessage(@"Seeking interrupted."));
          }
        } else if (resolve) {
...
- (NSDictionary *)getStatus
{
  ...
  // TODO : ABI38_0_0React-native-video includes the iOS-only keys seekableDuration and canReverse (etc) flags.
  //        Consider adding these.
  NSMutableDictionary *mutableStatus = [@{ABI38_0_0EXAVPlayerDataStatusIsLoadedKeyPath: @(YES),
                                          
                                          ABI38_0_0EXAVPlayerDataStatusURIKeyPath: [_url absoluteString],
                                          
                                          ABI38_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath: _progressUpdateIntervalMillis,
                                          // positionMillis, playableDurationMillis, and durationMillis may be nil and are added after this definition.
                                          
                                          ABI38_0_0EXAVPlayerDataStatusShouldPlayKeyPath: @(_shouldPlay),
                                          ABI38_0_0EXAVPlayerDataStatusIsPlayingKeyPath: @(isPlaying),
                                          ABI38_0_0EXAVPlayerDataStatusIsBufferingKeyPath: @(isBuffering),
                                          
                                          ABI38_0_0EXAVPlayerDataStatusRateKeyPath: _rate,
                                          ABI38_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath: @(_shouldCorrectPitch),
                                          ABI38_0_0EXAVPlayerDataStatusPitchCorrectionQualityKeyPath: _pitchCorrectionQuality,
                                          ABI38_0_0EXAVPlayerDataStatusVolumeKeyPath: @(_player.volume),
                                          ABI38_0_0EXAVPlayerDataStatusIsMutedKeyPath: @(_player.muted),
                                          ABI38_0_0EXAVPlayerDataStatusIsLoopingKeyPath: @(_isLooping),
                                          
                                          ABI38_0_0EXAVPlayerDataStatusDidJustFinishKeyPath: @(NO),
                                          ABI38_0_0EXAVPlayerDataStatusHasJustBeenInterruptedKeyPath: @(NO),
                                          } mutableCopy];
  
  mutableStatus[ABI38_0_0EXAVPlayerDataStatusPlayableDurationMillisKeyPath] = playableDurationMillis;
  mutableStatus[ABI38_0_0EXAVPlayerDataStatusDurationMillisKeyPath] = durationMillis;
  mutableStatus[ABI38_0_0EXAVPlayerDataStatusPositionMillisKeyPath] = positionMillis;
                ...
                rejecter:(ABI38_0_0UMPromiseRejectBlock)reject
{
  [self _callStatusUpdateCallbackWithExtraFields:@{
                                                   ABI38_0_0EXAVPlayerDataStatusHasJustBeenInterruptedKeyPath: @([self _isPlayerPlaying]),
                                                   }];
...
{
  [self _tryRemoveObserver:_player forKeyPath:ABI38_0_0EXAVPlayerDataObserverStatusKeyPath];
  
  for (AVPlayerItem *item in _items) {
    [self _removeObserversForPlayerItem:item];
  }
  
  [self _tryRemoveObserver:_player forKeyPath:ABI38_0_0EXAVPlayerDataObserverRateKeyPath];
  [self _tryRemoveObserver:_player forKeyPath:ABI38_0_0EXAVPlayerDataObserverCurrentItemKeyPath];
  [self _tryRemoveObserver:_player forKeyPath:ABI38_0_0EXAVPlayerDataObserverTimeControlStatusPath];
}
...
{
  [self _tryRemoveObserver:playerItem forKeyPath:ABI38_0_0EXAVPlayerDataObserverStatusKeyPath];
  ...
  [self _tryRemoveObserver:playerItem forKeyPath:ABI38_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath];
}
...
- (void)_addObserversForPlayerItem:(AVPlayerItem *)playerItem
{
  ...
  void (^didPlayToEndTimeObserverBlock)(NSNotification *note) = ^(NSNotification *note) {
    ...
    if (strongEXAV) {
      dispatch_async(strongEXAV.methodQueue, ^{
        ...
        if (strongSelfInner) {
          [strongSelfInner _callStatusUpdateCallbackWithExtraFields:@{ABI38_0_0EXAVPlayerDataStatusDidJustFinishKeyPath: @(YES)}];
          ...
          if (!strongSelfInner.isLooping) {
            ...
            __strong ABI38_0_0EXAV *strongEXAVInner = strongSelfInner.exAV;
            if (strongEXAVInner) {
  ...
  [self _tryRemoveObserver:playerItem forKeyPath:ABI38_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath];
  [playerItem addObserver:self forKeyPath:ABI38_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath options:0 context:nil];
  
  [self _tryRemoveObserver:playerItem forKeyPath:ABI38_0_0EXAVPlayerDataObserverStatusKeyPath];
  [playerItem addObserver:self forKeyPath:ABI38_0_0EXAVPlayerDataObserverStatusKeyPath options:0 context:nil];
}
...
- (void)_updateTimeObserver
{
  ...
  void (^timeObserverBlock)(CMTime time) = ^(CMTime time) {
    ...
    __strong ABI38_0_0EXAV *strongEXAV = strongSelfOuter ? strongSelfOuter.exAV : nil;
...
- (void)_addObserversForNewPlayer
{
  ...
  [_player addObserver:self forKeyPath:ABI38_0_0EXAVPlayerDataObserverRateKeyPath options:0 context:nil];
  NSUInteger currentItemObservationOptions = NSKeyValueObservingOptionOld | NSKeyValueObservingOptionNew;
  [_player addObserver:self forKeyPath:ABI38_0_0EXAVPlayerDataObserverCurrentItemKeyPath options:currentItemObservationOptions context:nil];
  [_player addObserver:self forKeyPath:ABI38_0_0EXAVPlayerDataObserverTimeControlStatusPath options:0 context:nil]; // Only available after iOS 10
                       ...
                       context:(void *)context
{
  ...
  __weak ABI38_0_0EXAVPlayerData *weakSelf = nil;
  ...
  // as the ABI38_0_0EXAVPlayerData is being deallocated, so let's early return.
  //
  ...
  __strong ABI38_0_0EXAV *strongEXAV = _exAV;
  if (strongEXAV == nil) {
    return;
  }
  ...
  dispatch_async(strongEXAV.methodQueue, ^{
    ...
    if (strongSelf) {
      if (object == strongSelf.player) {
        if ([keyPath isEqualToString:ABI38_0_0EXAVPlayerDataObserverStatusKeyPath]) {
        ...
        } else if ([keyPath isEqualToString:ABI38_0_0EXAVPlayerDataObserverRateKeyPath]) {
        ...
        } else if ([keyPath isEqualToString:ABI38_0_0EXAVPlayerDataObserverTimeControlStatusPath]) {
        ...
        } else if ([keyPath isEqualToString:ABI38_0_0EXAVPlayerDataObserverCurrentItemKeyPath]) {
        ...
        if ([keyPath isEqualToString:ABI38_0_0EXAVPlayerDataObserverStatusKeyPath]) {
          ...
          [strongSelf _callStatusUpdateCallback];
        } else if ([keyPath isEqualToString:ABI38_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath]) {
          [strongSelf _callStatusUpdateCallback];
        }
      }
    }
...
- (ABI38_0_0EXAVAudioSessionMode)getAudioSessionModeRequired
{
  if (_player && ([self _isPlayerPlaying] || [self _shouldPlayerPlay])) {
    return _isMuted ? ABI38_0_0EXAVAudioSessionModeActiveMuted : ABI38_0_0EXAVAudioSessionModeActive;
  }
  return ABI38_0_0EXAVAudioSessionModeInactive;
}
...
{
  // ABI38_0_0EXAudio already forced pause.
}
