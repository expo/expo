#import "ABI38_0_0REAPropsNode.h"

#import "ABI38_0_0REANodesManager.h"
#import "ABI38_0_0REAStyleNode.h"
#import "ABI38_0_0REAModule.h"

#import <ABI38_0_0React/ABI38_0_0RCTLog.h>
#import <ABI38_0_0React/ABI38_0_0RCTUIManager.h>
#import "ABI38_0_0React/ABI38_0_0RCTComponentData.h"

@implementation ABI38_0_0REAPropsNode
{
  NSNumber *_connectedViewTag;
  NSString *_connectedViewName;
  NSMutableDictionary<NSString *, ABI38_0_0REANodeID> *_propsConfig;
}
...
- (id)evaluate
{
  ...
  for (NSString *prop in _propsConfig) {
    ABI38_0_0REANode *propNode = [self.nodesManager findNodeByID:_propsConfig[prop]];
    
    if ([propNode isKindOfClass:[ABI38_0_0REAStyleNode class]]) {
