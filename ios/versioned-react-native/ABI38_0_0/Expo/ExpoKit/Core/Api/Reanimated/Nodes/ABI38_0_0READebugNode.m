#import "ABI38_0_0READebugNode.h"
...
@implementation ABI38_0_0READebugNode {
...
- (instancetype)initWithID:(ABI38_0_0REANodeID)nodeID config:(NSDictionary<NSString *,id> *)config
{
  if ((self = [super initWithID:nodeID config:config])) {
    _message = [ABI38_0_0RCTConvert NSString:config[@"message"]];
    _valueNodeID = [ABI38_0_0RCTConvert NSNumber:config[@"value"]];
    ABI38_0_0REA_LOG_ERROR_IF_NIL(_valueNodeID, @"Reanimated: Second argument passed to debug node is either of wrong type or is missing.");
  }
  return self;
}
