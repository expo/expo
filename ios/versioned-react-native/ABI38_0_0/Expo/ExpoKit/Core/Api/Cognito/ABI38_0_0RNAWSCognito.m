...
@implementation ABI38_0_0RNAWSCognito
...
ABI38_0_0RCT_EXPORT_METHOD(computeModPow:(NSDictionary *)values
    ...
    if (result) {
        ...
        callback(@[@[ABI38_0_0RCTMakeError(@"computeModPow error", nil, nil)], [NSNull null]]);
    }
}

ABI38_0_0RCT_EXPORT_METHOD(computeS:(NSDictionary *)values
                  callback:(ABI38_0_0RCTResponseSenderBlock)callback) {
    ...
    if (result) {
        ...
        callback(@[@[ABI38_0_0RCTMakeError(@"computeS error", nil, nil)], [NSNull null]]);
    }
}
