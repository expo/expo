...
#import "ABI38_0_0EXNotifications.h"
...
@interface ABI38_0_0EXNotifications ()

// unversioned ABI38_0_0EXRemoteNotificationManager instance
@property (nonatomic, weak) id <ABI38_0_0EXNotificationsScopedModuleDelegate> remoteNotificationsDelegate;
@property (nonatomic, weak) id <ABI38_0_0EXNotificationsIdentifiersManager> notificationsIdentifiersManager;
@property (nonatomic, weak) id <ABI38_0_0EXUserNotificationCenterService> userNotificationCenter;

@end

@implementation ABI38_0_0EXNotifications

ABI38_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentNotifications, @"RemoteNotificationManager", @"UserNotificationManager", @"UserNotificationCenter");
...
ABI38_0_0RCT_REMAP_METHOD(getDevicePushTokenAsync,
...
{
  ABI38_0_0EXConstantsBinding *constants = [[[self.bridge moduleForClass:[ABI38_0_0UMModuleRegistryHolderReactModule class]] moduleRegistry] getModuleImplementingProtocol:@protocol(ABI38_0_0UMConstantsInterface)];
...
ABI38_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
                 getExponentPushTokenAsyncWithResolver:(ABI38_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI38_0_0RCTPromiseRejectBlock)reject)
{
...
ABI38_0_0RCT_EXPORT_METHOD(presentLocalNotification:(NSDictionary *)payload
                  resolver:(ABI38_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI38_0_0RCTPromiseRejectBlock)reject)
{
  if (!payload[@"data"]) {
  ...
  ABI38_0_0RCT_EXPORT_METHOD(scheduleNotificationWithTimer:(NSDictionary *)payload
...
ABI38_0_0RCT_EXPORT_METHOD(scheduleNotificationWithCalendar:(NSDictionary *)payload
                 withOptions:(NSDictionary *)options
                 resolver:(ABI38_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI38_0_0RCTPromiseRejectBlock)reject)
{
...
ABI38_0_0RCT_EXPORT_METHOD(scheduleLocalNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI38_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI38_0_0RCTPromiseRejectBlock)reject)
{
...
ABI38_0_0RCT_EXPORT_METHOD(legacyScheduleLocalRepeatingNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI38_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI38_0_0RCTPromiseRejectBlock)reject)
{
  ...
  localNotification.applicationIconBadgeNumber = [ABI38_0_0RCTConvert NSInteger:payload[@"count"]] ?: 0;
  localNotification.userInfo = @{
                                 @"body": payload[@"data"],
                                 @"experienceId": self.experienceId,
                                 @"id": uniqueId
                                 };
  localNotification.fireDate = [ABI38_0_0RCTConvert NSDate:options[@"time"]] ?: [NSDate new];
  localNotification.repeatInterval = [ABI38_0_0RCTConvert NSCalendarUnit:options[@"repeat"]] ?: 0;

  __weak typeof(self) weakSelf = self;
  [ABI38_0_0EXUtil performSynchronouslyOnMainThread:^{
    [ABI38_0_0RCTSharedApplication() scheduleLocalNotification:localNotification];
...
ABI38_0_0RCT_REMAP_METHOD(cancelScheduledNotificationAsync,
                 cancelScheduledNotificationAsync:(NSString *)uniqueId
                 withResolver:(ABI38_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI38_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI38_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
...
ABI38_0_0RCT_REMAP_METHOD(cancelAllScheduledNotificationsAsync,
                 cancelAllScheduledNotificationsAsyncWithResolver:(ABI38_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(__unused ABI38_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI38_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
  [_userNotificationCenter getPendingNotificationRequestsWithCompletionHandler:^(NSArray<UNNotificationRequest *> * _Nonnull requests) {
...
ABI38_0_0RCT_REMAP_METHOD(getBadgeNumberAsync,
                 getBadgeNumberAsyncWithResolver:(ABI38_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI38_0_0RCTPromiseRejectBlock)reject)
{
  __block NSInteger badgeNumber;
  [ABI38_0_0EXUtil performSynchronouslyOnMainThread:^{
    badgeNumber = ABI38_0_0RCTSharedApplication().applicationIconBadgeNumber;
  }];
  resolve(@(badgeNumber));
}

ABI38_0_0RCT_EXPORT_METHOD(setBadgeNumberAsync:(nonnull NSNumber *)number
                  resolver:(ABI38_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI38_0_0RCTPromiseRejectBlock)reject)
{
  [ABI38_0_0EXUtil performSynchronouslyOnMainThread:^{
    ABI38_0_0RCTSharedApplication().applicationIconBadgeNumber = number.integerValue;
  }];
  resolve(nil);
}
...
ABI38_0_0RCT_REMAP_METHOD(createCategoryAsync,
...
ABI38_0_0RCT_REMAP_METHOD(deleteCategoryAsync,
...
- (NSDateComponents *)dateComponentsFrom:(NSNumber * _Nullable)unixTime {
  ...
  NSDate *triggerDate = [ABI38_0_0RCTConvert NSDate:unixTime] ?: [NSDate new];
