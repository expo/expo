...
@interface ABI38_0_0RNCAppearanceProvider ()

@property (nonatomic, weak) ABI38_0_0RCTBridge *bridge;

@end

@implementation ABI38_0_0RNCAppearanceProvider
...
- (void)notifyUserInterfaceStyleChanged
{
  ...
  if (self.bridge) {
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ABI38_0_0RNCUserInterfaceStyleDidChangeNotification"
                                                        object:self.bridge
