...
// Some ABI38_0_0RN private method hacking below. Couldn't figure out better way to access image data
// of a given ABI38_0_0RCTImageView. See more comments in the code section processing SubviewTypeBackButton
@interface ABI38_0_0RCTImageView (Private)
- (UIImage*)image;
@end

@interface ABI38_0_0RCTImageLoader (Private)
- (id<ABI38_0_0RCTImageCache>)imageCache;
@end


@interface ABI38_0_0RNSScreenStackHeaderSubview : UIView

@property (nonatomic, weak) ABI38_0_0RCTBridge *bridge;
@property (nonatomic, weak) UIView *ABI38_0_0ReactSuperview;
...
@implementation ABI38_0_0RNSScreenStackHeaderSubview
...
@implementation ABI38_0_0RNSScreenStackHeaderConfig {
  NSMutableArray<ABI38_0_0RNSScreenStackHeaderSubview *> *_ABI38_0_0ReactSubviews;
}
...
- (void)insertABI38_0_0ReactSubview:(ABI38_0_0RNSScreenStackHeaderSubview *)subview atIndex:(NSInteger)atIndex
{
  [_ABI38_0_0ReactSubviews insertObject:subview atIndex:atIndex];
  subview.ABI38_0_0ReactSuperview = self;
}

- (void)removeABI38_0_0ReactSubview:(ABI38_0_0RNSScreenStackHeaderSubview *)subview
{
...
- (void)updateViewControllerIfNeeded
{
  ...
  if (vc != nil && nextVC == vc) {
    [ABI38_0_0RNSScreenStackHeaderConfig updateViewController:self.screenView.controller
                                          withConfig:self
                                            animated:YES];
  }
}
...
+ (void)setAnimatedConfig:(UIViewController *)vc withConfig:(ABI38_0_0RNSScreenStackHeaderConfig *)config
{
...
#endif
  {
    ...
    if (config.titleFontFamily || config.titleFontSize || config.titleColor) {
      ...
      if (config.titleFontFamily) {
        attrs[NSFontAttributeName] = [ABI38_0_0RCTFont updateFont:nil withFamily:config.titleFontFamily size:size weight:nil style:nil variant:nil scaleMultiplier:1.0];
      } else {
    ...
    if (@available(iOS 11.0, *)) {
      if (config.largeTitle && (config.largeTitleFontFamily || config.largeTitleFontSize || config.largeTitleColor || config.titleColor)) {
        ...
        if (config.largeTitleFontFamily) {
          largeAttrs[NSFontAttributeName] = [ABI38_0_0RCTFont updateFont:nil withFamily:config.largeTitleFontFamily size:largeSize weight:nil style:nil variant:nil scaleMultiplier:1.0];
        } else {
...
+ (UIImage*)loadBackButtonImageInViewController:(UIViewController *)vc
                                     withConfig:(ABI38_0_0RNSScreenStackHeaderConfig *)config
{
  BOOL hasBackButtonImage = NO;
  for (ABI38_0_0RNSScreenStackHeaderSubview *subview in config.ABI38_0_0ReactSubviews) {
    if (subview.type == ABI38_0_0RNSScreenStackHeaderSubviewTypeBackButton && subview.subviews.count > 0) {
      hasBackButtonImage = YES;
      ABI38_0_0RCTImageView *imageView = subview.subviews[0];
      if (imageView.image == nil) {
        ...
        ABI38_0_0RCTImageSource *source = imageView.imageSources[0];
        [imageView ABI38_0_0ReactSetFrame:CGRectMake(imageView.frame.origin.x,
...
#ifdef __IPHONE_13_0
+ (UINavigationBarAppearance*)buildAppearance:(UIViewController *)vc withConfig:(ABI38_0_0RNSScreenStackHeaderConfig *)config
{
...
+ (void)updateViewController:(UIViewController *)vc withConfig:(ABI38_0_0RNSScreenStackHeaderConfig *)config animated:(BOOL)animated
{
  ...
  if (config.backTitle != nil || config.backTitleFontFamily || config.backTitleFontSize) {
    ...
    if (config.backTitleFontFamily || config.backTitleFontSize) {
      ...
      if (config.backTitleFontFamily) {
        attrs[NSFontAttributeName] = [ABI38_0_0RCTFont updateFont:nil withFamily:config.backTitleFontFamily size:size weight:nil style:nil variant:nil scaleMultiplier:1.0];
      } else {
        attrs[NSFontAttributeName] = [UIFont boldSystemFontOfSize:[size floatValue]];
      }
  ...
  for (ABI38_0_0RNSScreenStackHeaderSubview *subview in config.ABI38_0_0ReactSubviews) {
    switch (subview.type) {
      case ABI38_0_0RNSScreenStackHeaderSubviewTypeLeft: {
        navitem.leftItemsSupplementBackButton = config.backButtonInCustomView;
        UIBarButtonItem *buttonItem = [[UIBarButtonItem alloc] initWithCustomView:subview];
        navitem.leftBarButtonItem = buttonItem;
        break;
      }
      case ABI38_0_0RNSScreenStackHeaderSubviewTypeRight: {
        UIBarButtonItem *buttonItem = [[UIBarButtonItem alloc] initWithCustomView:subview];
        navitem.rightBarButtonItem = buttonItem;
        break;
      }
      case ABI38_0_0RNSScreenStackHeaderSubviewTypeCenter:
      case ABI38_0_0RNSScreenStackHeaderSubviewTypeTitle: {
  ...
  if (animated
    ...
    [vc.transitionCoordinator animateAlongsideTransition:^(id<UIViewControllerTransitionCoordinatorContext>  _Nonnull context) {
      ...
      if ([context isCancelled]) {
        ...
        for (UIView *subview in fromVC.view.ABI38_0_0ReactSubviews) {
...
@implementation ABI38_0_0RNSScreenStackHeaderConfigManager

ABI38_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
  return [ABI38_0_0RNSScreenStackHeaderConfig new];
}

ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(title, NSString)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(titleFontFamily, NSString)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(titleFontSize, NSNumber)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(titleColor, UIColor)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(backTitle, NSString)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(backTitleFontFamily, NSString)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(backTitleFontSize, NSNumber)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(backgroundColor, UIColor)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(color, UIColor)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(largeTitle, BOOL)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(largeTitleFontFamily, NSString)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(largeTitleFontSize, NSNumber)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(largeTitleColor, UIColor)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(largeTitleBackgroundColor, UIColor)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(largeTitleHideShadow, BOOL)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(hideBackButton, BOOL)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(hideShadow, BOOL)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(backButtonInCustomView, BOOL)
// `hidden` is an UIView property, we need to use different name internally
ABI38_0_0RCT_REMAP_VIEW_PROPERTY(hidden, hide, BOOL)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(translucent, BOOL)

@end

@implementation ABI38_0_0RCTConvert (ABI38_0_0RNSScreenStackHeader)

ABI38_0_0RCT_ENUM_CONVERTER(ABI38_0_0RNSScreenStackHeaderSubviewType, (@{
   @"back": @(ABI38_0_0RNSScreenStackHeaderSubviewTypeBackButton),
   @"left": @(ABI38_0_0RNSScreenStackHeaderSubviewTypeLeft),
   @"right": @(ABI38_0_0RNSScreenStackHeaderSubviewTypeRight),
   @"title": @(ABI38_0_0RNSScreenStackHeaderSubviewTypeTitle),
   @"center": @(ABI38_0_0RNSScreenStackHeaderSubviewTypeCenter),
   }), ABI38_0_0RNSScreenStackHeaderSubviewTypeTitle, integerValue)

@end

@implementation ABI38_0_0RNSScreenStackHeaderSubviewManager

ABI38_0_0RCT_EXPORT_MODULE()

ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(type, ABI38_0_0RNSScreenStackHeaderSubviewType)

- (UIView *)view
{
  return [[ABI38_0_0RNSScreenStackHeaderSubview alloc] initWithBridge:self.bridge];
}
