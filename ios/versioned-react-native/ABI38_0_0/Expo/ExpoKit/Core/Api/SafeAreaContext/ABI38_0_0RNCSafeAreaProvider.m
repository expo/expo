...
@implementation ABI38_0_0RNCSafeAreaProvider
{
...
{
  // This gets called before the view size is set by ABI38_0_0React-native so
  ...
  if (
    _initialInsetsSent &&
    ABI38_0_0UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI38_0_0RCTScreenScale()) &&
