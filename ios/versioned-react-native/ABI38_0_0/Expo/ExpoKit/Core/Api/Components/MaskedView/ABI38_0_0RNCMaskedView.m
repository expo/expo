...
@implementation ABI38_0_0RNCMaskedView

- (void)didUpdateABI38_0_0ReactSubviews
{
  // ABI38_0_0RNCMaskedView expects that the first subview rendered is the mask.
...
- (void)displayLayer:(CALayer *)layer
{
  ...
  // We don't need to do that in ABI38_0_0RNCMaskedView, so we
