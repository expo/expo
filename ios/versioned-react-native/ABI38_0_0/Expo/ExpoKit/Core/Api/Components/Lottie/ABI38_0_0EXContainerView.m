...
#if __has_include(<ABI38_0_0React/ABI38_0_0UIView+React.h>)
...
@implementation ABI38_0_0EXContainerView {
...
- (void)ABI38_0_0ReactSetFrame:(CGRect)frame
{
  ...
  if (_animationView != nil) {
    [_animationView ABI38_0_0ReactSetFrame:frame];
  }
}
...
- (void)replaceAnimationView:(LOTAnimationView *)next {
  ...
  [_animationView ABI38_0_0ReactSetFrame:self.frame];
