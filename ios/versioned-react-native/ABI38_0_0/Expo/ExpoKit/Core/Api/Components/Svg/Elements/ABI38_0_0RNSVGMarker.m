...
@implementation ABI38_0_0RNSVGMarker
...
- (void)setX:(ABI38_0_0RNSVGLength *)refX
{
...
- (void)setY:(ABI38_0_0RNSVGLength *)refY
{
...
- (void)setMarkerWidth:(ABI38_0_0RNSVGLength *)markerWidth
{
...
- (void)setMarkerHeight:(ABI38_0_0RNSVGLength *)markerHeight
{
...
static CGFloat ABI38_0_0RNSVG_degToRad = (CGFloat)M_PI / 180;

double ABI38_0_0deg2rad(CGFloat deg) {
    return deg * ABI38_0_0RNSVG_degToRad;
}

- (void)renderMarker:(CGContextRef)context rect:(CGRect)rect position:(ABI38_0_0RNSVGMarkerPosition*)position strokeWidth:(CGFloat)strokeWidth
{
    ...
    float rad = ABI38_0_0deg2rad(angle);
