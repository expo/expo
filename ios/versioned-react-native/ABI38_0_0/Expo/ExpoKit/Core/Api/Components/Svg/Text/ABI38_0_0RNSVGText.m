...
#import "ABI38_0_0RNSVGGlyphContext.h"
#import "ABI38_0_0RNSVGTextProperties.h"

@implementation ABI38_0_0RNSVGText
{
    ABI38_0_0RNSVGGlyphContext *_glyphContext;
...
- (void)setInlineSize:(ABI38_0_0RNSVGLength *)inlineSize
{
...
- (void)setTextLength:(ABI38_0_0RNSVGLength *)textLength
{
...
- (void)setDeltaX:(NSArray<ABI38_0_0RNSVGLength *> *)deltaX
{
    if (deltaX == _deltaX) {
        return;
    }
...
- (void)setDeltaY:(NSArray<ABI38_0_0RNSVGLength *> *)deltaY
{
    if (deltaY == _deltaY) {
        return;
    }
...
- (void)setPositionX:(NSArray<ABI38_0_0RNSVGLength *>*)positionX
{
...
- (void)setPositionY:(NSArray<ABI38_0_0RNSVGLength *>*)positionY
{
...
- (void)setRotate:(NSArray<ABI38_0_0RNSVGLength *> *)rotate
{
    if (rotate == _rotate) {
        return;
    }
...
- (void)setupGlyphContext:(CGContextRef)context
{
    ...
    _glyphContext = [[ABI38_0_0RNSVGGlyphContext alloc] initWithWidth:size.width
                                                      height:size.height];
}
...
- (ABI38_0_0RNSVGText *)textRoot
{
    ABI38_0_0RNSVGText *root = self;
    while (root && [root class] != [ABI38_0_0RNSVGText class]) {
        if (![root isKindOfClass:[ABI38_0_0RNSVGText class]]) {
            //todo: throw exception here
            break;
        }
        root = (ABI38_0_0RNSVGText*)[root superview];
    }
...
- (NSString *)alignmentBaseline
{
    ...
    while (parent != nil) {
        if ([parent isKindOfClass:[ABI38_0_0RNSVGText class]]) {
            ABI38_0_0RNSVGText* node = (ABI38_0_0RNSVGText*)parent;
    ...
    if (_alignmentBaseline == nil) {
        _alignmentBaseline = ABI38_0_0RNSVGAlignmentBaselineStrings[0];
    }
    return _alignmentBaseline;
}
...
- (ABI38_0_0RNSVGGlyphContext *)getGlyphContext
{
...
{
    ABI38_0_0RNSVGGlyphContext* gc = [self.textRoot getGlyphContext];
    NSArray* font = [gc getFontContext];
    ABI38_0_0RNSVGText* node = self;
    UIView* parent = [self superview];
    for (NSInteger i = [font count] - 1; i >= 0; i--) {
        ABI38_0_0RNSVGFontData* fontData = [font objectAtIndex:i];
        if (![parent isKindOfClass:[ABI38_0_0RNSVGText class]] ||
            fontData->textAnchor == ABI38_0_0RNSVGTextAnchorStart ||
            node.positionX != nil) {
            return node;
        }
        node = (ABI38_0_0RNSVGText*) parent;
...
- (CGFloat)getSubtreeTextChunksTotalAdvance
{
    ...
    for (UIView *node in self.subviews) {
        if ([node isKindOfClass:[ABI38_0_0RNSVGText class]]) {
            ABI38_0_0RNSVGText *text = (ABI38_0_0RNSVGText*)node;
