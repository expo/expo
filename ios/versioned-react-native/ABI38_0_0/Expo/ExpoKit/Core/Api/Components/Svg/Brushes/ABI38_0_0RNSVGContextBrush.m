/**
 * Copyright (c) 2015-present, ABI38_0_0React-native-community.
 * All rights reserved.
 *
...
#import "ABI38_0_0RNSVGContextBrush.h"
...
@implementation ABI38_0_0RNSVGContextBrush
{
    BOOL _isStroke;
}
...
{
    ABI38_0_0RNSVGRenderable *element = ABI38_0_0RNSVGRenderable.contextElement;
    if (!element) {
        return NO;
    }

    ABI38_0_0RNSVGBrush *brush = _isStroke ? element.stroke : element.fill;

    BOOL fillColor;

    if (brush.class == ABI38_0_0RNSVGBrush.class) {
