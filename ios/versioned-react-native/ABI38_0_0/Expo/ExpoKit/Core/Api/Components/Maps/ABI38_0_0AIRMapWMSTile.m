...
@implementation ABI38_0_0AIRMapWMSTile {
...
- (void) createTileOverlayAndRendererIfPossible
{
    ...
    self.tileOverlay  = [[ABI38_0_0TileOverlay alloc] initWithURLTemplate:self.urlTemplate];
...
- (void) update
{
    ...
    for (id<MKOverlay> overlay in _map.overlays) {
        if ([overlay isKindOfClass:[ABI38_0_0AIRMapWMSTile class]]) {
            continue;
        }
...
@implementation ABI38_0_0TileOverlay
@synthesize MapX;
@synthesize MapY;
@synthesize FULL;
