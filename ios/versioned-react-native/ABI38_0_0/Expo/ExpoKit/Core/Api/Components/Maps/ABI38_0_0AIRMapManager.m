...
@interface ABI38_0_0AIRMapManager() <MKMapViewDelegate, UIGestureRecognizerDelegate>

- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer;

@end

@implementation ABI38_0_0AIRMapManager{
   BOOL _hasObserver;
}
...
- (UIView *)view
{
    ABI38_0_0AIRMap *map = [ABI38_0_0AIRMap new];
    map.delegate = self;
...
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(userLocationAnnotationTitle, NSString)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(showsPointsOfInterest, BOOL)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
...
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(maxDelta, CGFloat)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(minDelta, CGFloat)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(compassOffset, CGPoint)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(legalLabelInsets, UIEdgeInsets)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(mapPadding, UIEdgeInsets)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, MKMapType)
...
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(onDoublePress, ABI38_0_0RCTBubblingEventBlock)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerPress, ABI38_0_0RCTDirectEventBlock)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI38_0_0RCTDirectEventBlock)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI38_0_0RCTDirectEventBlock)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI38_0_0RCTDirectEventBlock)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI38_0_0RCTDirectEventBlock)
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI38_0_0RCTDirectEventBlock)
...
ABI38_0_0RCT_CUSTOM_VIEW_PROPERTY(initialRegion, MKCoordinateRegion, ABI38_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setInitialRegion:[ABI38_0_0RCTConvert MKCoordinateRegion:json]];
    view.ignoreRegionChanges = originalIgnore;
}
ABI38_0_0RCT_CUSTOM_VIEW_PROPERTY(initialCamera, MKMapCamera, ABI38_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setInitialCamera:[ABI38_0_0RCTConvert MKMapCamera:json]];
    view.ignoreRegionChanges = originalIgnore;
}
...
ABI38_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI38_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setRegion:[ABI38_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}

ABI38_0_0RCT_CUSTOM_VIEW_PROPERTY(camera, MKMapCamera*, ABI38_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setCamera:[ABI38_0_0RCTConvert MKMapCamera:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}
                  ...
                  rejecter:(ABI38_0_0RCTPromiseRejectBlock)reject)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI38_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI38_0_0AIRMap class]]) {
                  ...
                  rejecter:(ABI38_0_0RCTPromiseRejectBlock)reject)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI38_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        id view = viewRegistry[ABI38_0_0ReactTag];
        ABI38_0_0AIRMap *mapView = (ABI38_0_0AIRMap *)view;
        if (![view isKindOfClass:[ABI38_0_0AIRMap class]]) {
            reject(@"Invalid argument", [NSString stringWithFormat:@"Invalid view returned from registry, expecting ABI38_0_0AIRMap, got: %@", view], NULL);
        } else {
                  ...
                  camera:(id)json)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI38_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI38_0_0AIRMap class]]) {
            ...
            MKMapCamera *camera = [ABI38_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:[mapView camera]];
                  ...
                  withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI38_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI38_0_0AIRMap class]]) {
            ...
            BOOL originalIgnore = mapView.ignoreRegionChanges;
            mapView.ignoreRegionChanges = YES;
            [ABI38_0_0AIRMap animateWithDuration:duration/1000 animations:^{
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI38_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI38_0_0AIRMap class]]) {
            ...
            [ABI38_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI38_0_0AIRMap *)view setRegion:region animated:YES];
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI38_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI38_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ...
                return [marker isKindOfClass:[ABI38_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
...
- (void)takeMapSnapshot:(ABI38_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI38_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI38_0_0AIRMap *map = (ABI38_0_0AIRMap *)recognizer.view;
    ...
    ABI38_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI38_0_0AIRMapPolygon class]]){
            ABI38_0_0AIRMapPolygon *polygon = (ABI38_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI38_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI38_0_0AIRMapPolyline class]]){
            ABI38_0_0AIRMapPolyline *polyline = (ABI38_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
        ...
        if ([overlay isKindOfClass:[ABI38_0_0AIRMapOverlay class]]) {
            ABI38_0_0AIRMapOverlay *imageOverlay = (ABI38_0_0AIRMapOverlay*) overlay;
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI38_0_0AIRMapPolyline class]]) {
        return ((ABI38_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI38_0_0AIRMapPolygon class]]) {
        return ((ABI38_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI38_0_0AIRMapCircle class]]) {
        return ((ABI38_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI38_0_0AIRMapUrlTile class]]) {
        return ((ABI38_0_0AIRMapUrlTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI38_0_0AIRMapWMSTile class]]) {
        return ((ABI38_0_0AIRMapWMSTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI38_0_0AIRMapLocalTile class]]) {
        return ((ABI38_0_0AIRMapLocalTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI38_0_0AIRMapOverlay class]]) {
        return ((ABI38_0_0AIRMapOverlay *)overlay).renderer;
...
- (void)mapView:(ABI38_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI38_0_0AIRMapMarker class]]) {
        [(ABI38_0_0AIRMapMarker *)view.annotation showCalloutView];
...
- (void)mapView:(ABI38_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI38_0_0AIRMapMarker class]]) {
        [(ABI38_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI38_0_0AIRMap *)mapView viewForAnnotation:(ABI38_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI38_0_0AIRMapMarker class]]) {
...
- (void)mapView:(ABI38_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI38_0_0AIRMapMarker class]]) return;
    ABI38_0_0AIRMapMarker *marker = (ABI38_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI38_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI38_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    id event = @{@"coordinate": @{
    ...
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI38_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI38_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI38_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    [self _regionChanged:mapView];

    ABI38_0_0AIRWeakTimerReference *weakTarget = [[ABI38_0_0AIRWeakTimerReference alloc] initWithTarget:self andSelector:@selector(_onTick:)];
    
    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI38_0_0AIRMapRegionChangeObserveInterval
                                                               target:weakTarget
                                                             selector:@selector(timerDidFire:)
                                                             userInfo:@{ ABI38_0_0RCTMapViewKey: [[ABI38_0_0AIRWeakMapReference alloc] initWithMapView: mapView] }
                                                              repeats:YES];

    [[NSRunLoop mainRunLoop] addTimer:mapView.regionChangeObserveTimer forMode:NSRunLoopCommonModes];
}

- (void)mapView:(ABI38_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI38_0_0AIRMap *)mapView
{
    if (!mapView.hasStartedRendering) {
      mapView.onMapReady(@{});
...
- (void)mapViewDidFinishRenderingMap:(ABI38_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
{
    ABI38_0_0AIRWeakMapReference *weakRef = timer.userInfo[ABI38_0_0RCTMapViewKey];
    [self _regionChanged:weakRef.mapView];
}

- (void)_regionChanged:(ABI38_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI38_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI38_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI38_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI38_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI38_0_0AIRMap *)mapView
{
...
- (MKCoordinateSpan)coordinateSpanWithMapView:(ABI38_0_0AIRMap *)mapView
                             centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                 andZoomLevel:(double)zoomLevel
{
    // convert center coordiate to pixel space
    double centerPixelX = [ABI38_0_0AIRMapManager longitudeToPixelSpaceX:centerCoordinate.longitude];
    double centerPixelY = [ABI38_0_0AIRMapManager latitudeToPixelSpaceY:centerCoordinate.latitude];

    // determine the scale value from the zoom level
    double zoomExponent = ABI38_0_0AIRMapMaxZoomLevel - zoomLevel;
    ...
    CLLocationDegrees minLng = [ABI38_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX];
    CLLocationDegrees maxLng = [ABI38_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX + scaledMapWidth];
    CLLocationDegrees longitudeDelta = maxLng - minLng;

    // find delta between top and bottom latitudes
    CLLocationDegrees minLat = [ABI38_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY];
    CLLocationDegrees maxLat = [ABI38_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY + scaledMapHeight];
                    ...
                    mapView:(ABI38_0_0AIRMap *)mapView
{
    ...
    zoomLevel = MIN(zoomLevel, ABI38_0_0AIRMapMaxZoomLevel);
                                    ...
                                    andZoomLevel:(double)zoomLevel
{
	...
	// find delta between top and bottom latitudes
	CLLocationDegrees minLat = [ABI38_0_0AIRMapManager pixelSpaceYToLatitude:topPixelY];
	CLLocationDegrees maxLat = [ABI38_0_0AIRMapManager pixelSpaceYToLatitude:bottomPixelY];
	CLLocationDegrees latitudeDelta = -1 * (maxLat - minLat);
	...
	if (adjustedCenterPoint) {
		region.center.latitude = [ABI38_0_0AIRMapManager pixelSpaceYToLatitude:((bottomPixelY + topPixelY) / 2.0)];
	}
...
- (double) zoomLevel:(ABI38_0_0AIRMap *)mapView {
    ...
    double centerPixelX = [ABI38_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude];
    double topLeftPixelX = [ABI38_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude - region.span.longitudeDelta / 2];

    double scaledMapWidth = (centerPixelX - topLeftPixelX) * 2;
    CGSize mapSizeInPixels = mapView.bounds.size;
    double zoomScale = scaledMapWidth / mapSizeInPixels.width;
    double zoomExponent = log(zoomScale) / log(2);
    double zoomLevel = ABI38_0_0AIRMapMaxZoomLevel - zoomExponent;
...
- (void)mapView:(ABI38_0_0AIRMap *)mapView didFailToLocateUserWithError:(NSError *)error {
