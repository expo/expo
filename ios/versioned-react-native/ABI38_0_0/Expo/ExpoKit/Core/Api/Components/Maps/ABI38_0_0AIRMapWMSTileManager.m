//
//  ABI38_0_0AIRMapWMSTileManager.m
//  AirMaps
//
...
@interface ABI38_0_0AIRMapWMSTileManager()

@end

@implementation ABI38_0_0AIRMapWMSTileManager
...
- (UIView *)view
{
    ABI38_0_0AIRMapWMSTile *tile = [ABI38_0_0AIRMapWMSTile new];
    return tile;
}
...
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(tileSize, NSInteger)
