...
@implementation ABI38_0_0RNSVGLength
...
{
    ABI38_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype) lengthWithString: (NSString *) lengthString {
    ...
    ABI38_0_0RNSVGLength *output = [ABI38_0_0RNSVGLength alloc];
    if (stringLength == 0) {
        ...
        ABI38_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
