//
//  ABI38_0_0RCTConvert+GMSMapViewType.m
//
...
@implementation ABI38_0_0RCTConvert (GMSMapViewType)
  ABI38_0_0RCT_ENUM_CONVERTER(GMSMapViewType,
  (
    @{
...
+ (GMSCameraPosition*)GMSCameraPosition:(id)json
{
    ...
    return [ABI38_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:nil];
}
