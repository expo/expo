...
@interface ABI38_0_0RNGestureHandlerManager : NSObject

- (nonnull instancetype)initWithUIManager:(nonnull ABI38_0_0RCTUIManager *)uiManager
                          eventDispatcher:(nonnull ABI38_0_0RCTEventDispatcher *)eventDispatcher;
