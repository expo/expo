//
//  ABI38_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI38_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI38_0_0WMSTileOverlay *tile = [[ABI38_0_0WMSTileOverlay alloc] init];
...
@implementation ABI38_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
