...
@implementation ABI38_0_0RNSVGPattern
...
{
    self.dirty = false;
    NSArray<ABI38_0_0RNSVGLength *> *points = @[self.x, self.y, self.patternwidth, self.patternheight];
...
- (void)setPatternwidth:(ABI38_0_0RNSVGLength *)patternwidth
{
...
- (void)setPatternheight:(ABI38_0_0RNSVGLength *)patternheight
{
...
- (void)setPatternUnits:(ABI38_0_0RNSVGUnits)patternUnits
{
...
- (void)setPatternContentUnits:(ABI38_0_0RNSVGUnits)patternContentUnits
{
