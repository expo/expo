//
//  ABI38_0_0AIRGoogleMapPolyline.m
//
...
#import "ABI38_0_0AIRGMSPolyline.h"
...
@implementation ABI38_0_0AIRGoogleMapPolyline

- (instancetype)init
{
  if (self = [super init]) {
    _polyline = [[ABI38_0_0AIRGMSPolyline alloc] init];
  }
  return self;
}
