...
@interface ABI38_0_0RNSVGBrush : NSObject
 ...
 * be clipped.
 */
- (void)paint:(CGContextRef)context opacity:(CGFloat)opacity painter:(ABI38_0_0RNSVGPainter *)painter bounds:(CGRect)bounds;
