...
#import "ABI38_0_0RNSVGPainter.h"
#import "ABI38_0_0RNSVGPattern.h"
#import "ABI38_0_0RNSVGViewBox.h"

@implementation ABI38_0_0RNSVGPainter
{
    NSArray<ABI38_0_0RNSVGLength *> *_points;
    NSArray<NSNumber *> *_colors;
    ABI38_0_0RNSVGBrushType _type;
...
- (instancetype)initWithPointsArray:(NSArray<ABI38_0_0RNSVGLength *> *)pointsArray
{
    if ((self = [super init])) {
        _points = pointsArray;
    }
...
- (void)setUnits:(ABI38_0_0RNSVGUnits)unit
{
    _useObjectBoundingBox = unit == kRNSVGUnitsObjectBoundingBox;
}

- (void)setContentUnits:(ABI38_0_0RNSVGUnits)unit
{
...
- (void)setPattern:(ABI38_0_0RNSVGPattern *)pattern
{
...
void ABI38_0_0PatternFunction(void* info, CGContextRef context)
{
    ABI38_0_0RNSVGPainter *_painter = (__bridge ABI38_0_0RNSVGPainter *)info;
    ABI38_0_0RNSVGPattern *_pattern = [_painter pattern];
    ...
    if (vbWidth > 0 && vbHeight > 0) {
        ...
        CGAffineTransform _viewBoxTransform = [ABI38_0_0RNSVGViewBox
                                               getTransform:vbRect
                                               eRect:rect
...
- (CGFloat)getVal:(ABI38_0_0RNSVGLength*)length relative:(CGFloat)relative
{
    ABI38_0_0RNSVGLengthUnitType unit = [length unit];
    CGFloat val = [ABI38_0_0RNSVGPropHelper fromRelative:length
                                       relative:relative];
...
- (void)paintPattern:(CGContextRef)context bounds:(CGRect)bounds
{
    ...
    const CGPatternCallbacks callbacks = { 0, &ABI38_0_0PatternFunction, NULL };
...
{
    if ([_colors count] == 0) {
        ABI38_0_0RCTLogWarn(@"No stops in gradient");
        return;
    }
    CGGradientRef gradient = CGGradientRetain([ABI38_0_0RCTConvert ABI38_0_0RNSVGCGGradient:_colors]);
