...
#import <ABI38_0_0React/ABI38_0_0RCTPointerEvents.h>
#import "ABI38_0_0RNSVGCGFCRule.h"
#import "ABI38_0_0RNSVGSvgView.h"
@class ABI38_0_0RNSVGGroup;

/**
 * ABI38_0_0RNSVG nodes are implemented as base UIViews. They should be implementation for all basic
 ＊interfaces for all non-definition nodes.
 */

@interface ABI38_0_0RNSVGNode : UIView
 ...
 */
extern CGFloat const ABI38_0_0RNSVG_M_SQRT1_2l;
extern CGFloat const ABI38_0_0RNSVG_DEFAULT_FONT_SIZE;

@property (nonatomic, strong) NSString *name;
@property (nonatomic, strong) NSString *display;
@property (nonatomic, assign) CGFloat opacity;
@property (nonatomic, assign) ABI38_0_0RNSVGCGFCRule clipRule;
 ...
 */
@property (nonatomic, assign) ABI38_0_0RCTPointerEvents pointerEvents;
...
@property (nonatomic, copy) ABI38_0_0RCTDirectEventBlock onLayout;


/**
 * ABI38_0_0RNSVGSvgView which ownes current ABI38_0_0RNSVGNode
 */
@property (nonatomic, readonly, weak) ABI38_0_0RNSVGSvgView *svgView;
@property (nonatomic, readonly, weak) ABI38_0_0RNSVGGroup *textRoot;

- (void)invalidate;

- (ABI38_0_0RNSVGGroup *)getParentTextRoot;
...
- (CGFloat)relativeOn:(ABI38_0_0RNSVGLength *)length relative:(CGFloat)relative;

- (CGFloat)relativeOnWidth:(ABI38_0_0RNSVGLength *)length;

- (CGFloat)relativeOnHeight:(ABI38_0_0RNSVGLength *)length;

- (CGFloat)relativeOnOther:(ABI38_0_0RNSVGLength *)length;
