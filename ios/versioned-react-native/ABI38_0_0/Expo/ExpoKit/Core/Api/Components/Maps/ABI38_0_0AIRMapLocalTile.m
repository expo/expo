...
#import "ABI38_0_0AIRMapLocalTileOverlay.h"

@implementation ABI38_0_0AIRMapLocalTile {
...
- (void) createTileOverlayAndRendererIfPossible
{
    ...
    self.tileOverlay = [[ABI38_0_0AIRMapLocalTileOverlay alloc] initWithURLTemplate:self.pathTemplate];
