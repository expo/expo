...
#import "ABI38_0_0RNTapHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI38_0_0React/ABI38_0_0RCTConvert.h>

// ABI38_0_0RNBetterTapGestureRecognizer extends UIGestureRecognizer instead of UITapGestureRecognizer 
...
@interface ABI38_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
- (id)initWithGestureHandler:(ABI38_0_0RNGestureHandler*)gestureHandler;

@end

@implementation ABI38_0_0RNBetterTapGestureRecognizer {
  __weak ABI38_0_0RNGestureHandler *_gestureHandler;
...
@implementation ABI38_0_0RNTapGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI38_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI38_0_0RNBetterTapGestureRecognizer *recognizer = (ABI38_0_0RNBetterTapGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    recognizer.maxDelay = [ABI38_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDurationMs"];
  if (prop != nil) {
    recognizer.maxDuration = [ABI38_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
  
  prop = config[@"maxDist"];
  if (prop != nil) {
    CGFloat dist = [ABI38_0_0RCTConvert CGFloat:prop];
