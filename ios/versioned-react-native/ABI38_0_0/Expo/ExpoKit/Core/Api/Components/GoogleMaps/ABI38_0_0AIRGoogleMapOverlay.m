//
//  ABI38_0_0AIRGoogleMapOverlay.m
...
@interface ABI38_0_0AIRGoogleMapOverlay()
  @property (nonatomic, strong, readwrite) UIImage *overlayImage;
  @property (nonatomic, readwrite) GMSCoordinateBounds *overlayBounds;
@end

@implementation ABI38_0_0AIRGoogleMapOverlay {
  ABI38_0_0RCTImageLoaderCancellationBlock _reloadImageCancellationBlock;
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  _reloadImageCancellationBlock = [[_bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI38_0_0RCTConvert NSURLRequest:_imageSrc]
                                                                          size:weakSelf.bounds.size
                                                                         scale:ABI38_0_0RCTScreenScale()
                                                                       clipped:YES
                                                                    resizeMode:ABI38_0_0RCTResizeModeCenter
                                                                 progressBlock:nil
