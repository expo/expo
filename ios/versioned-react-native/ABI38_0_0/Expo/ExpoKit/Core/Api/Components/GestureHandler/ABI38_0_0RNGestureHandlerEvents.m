#import "ABI38_0_0RNGestureHandlerEvents.h"

#define SAFE_VELOCITY(velocity) @(isnan(velocity) ? 0 : velocity)

@implementation ABI38_0_0RNGestureHandlerEventExtraData
...
{
    return [[ABI38_0_0RNGestureHandlerEventExtraData alloc]
            initWithData:@{
                           @"x": @(position.x),
                           @"y": @(position.y),
...
@implementation ABI38_0_0RNGestureHandlerEvent
{
    NSNumber *_handlerTag;
    ABI38_0_0RNGestureHandlerState _state;
    ABI38_0_0RNGestureHandlerEventExtraData *_extraData;
}
...
- (instancetype)initWithRactTag:(NSNumber *)ABI38_0_0ReactTag
                     handlerTag:(NSNumber *)handlerTag
                      ...
                      extraData:(ABI38_0_0RNGestureHandlerEventExtraData *)extraData
{
...
{
    return @"ABI38_0_0RCTEventEmitter.receiveEvent";
}
...
@implementation ABI38_0_0RNGestureHandlerStateChange
{
    NSNumber *_handlerTag;
    ABI38_0_0RNGestureHandlerState _state;
    ABI38_0_0RNGestureHandlerState _prevState;
    ABI38_0_0RNGestureHandlerEventExtraData *_extraData;
}
