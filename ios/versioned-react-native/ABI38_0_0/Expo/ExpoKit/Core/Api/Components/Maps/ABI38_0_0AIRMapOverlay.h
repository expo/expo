...
#import "ABI38_0_0AIRMapOverlayRenderer.h"

@class ABI38_0_0RCTBridge;

@interface ABI38_0_0AIRMapOverlay : UIView <MKOverlay>

@property (nonatomic, strong) ABI38_0_0AIRMapOverlayRenderer *renderer;
