...
@interface ABI38_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI38_0_0AIRGMSMarker*)marker;
@end

@implementation ABI38_0_0AIRGoogleMapMarker {
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI38_0_0AIRGMSMarker alloc] init];
...
- (void)insertABI38_0_0ReactSubview:(id<ABI38_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI38_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI38_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI38_0_0AIRDummyView *dummySubview = [[ABI38_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertABI38_0_0ReactSubview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeABI38_0_0ReactSubview:(id<ABI38_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI38_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeABI38_0_0ReactSubview:(UIView*)dummySubview];
}
...
- (ABI38_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/ABI38_0_0React-native-community/ABI38_0_0React-native-maps/issues/738)
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI38_0_0RN?
...
- (void)setIconSrc:(NSString *)iconSrc
{
  ...
  _reloadImageCancellationBlock =
  [[_bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI38_0_0RCTConvert NSURLRequest:_iconSrc]
                                          size:self.bounds.size
                                         scale:ABI38_0_0RCTScreenScale()
                                       clipped:YES
                                    resizeMode:ABI38_0_0RCTResizeModeCenter
