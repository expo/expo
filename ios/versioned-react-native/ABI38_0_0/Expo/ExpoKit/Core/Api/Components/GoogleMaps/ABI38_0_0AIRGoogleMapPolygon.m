//
//  ABI38_0_0AIRGoogleMapPolygon.m
//
...
#import "ABI38_0_0AIRGMSPolygon.h"
#import <GoogleMaps/GoogleMaps.h>

@implementation ABI38_0_0AIRGoogleMapPolygon

- (instancetype)init
{
  if (self = [super init]) {
    _polygon = [[ABI38_0_0AIRGMSPolygon alloc] init];
  }

  return self;
}

- (void)setCoordinates:(NSArray<ABI38_0_0AIRMapCoordinate *> *)coordinates
{
...
- (void)setHoles:(NSArray<NSArray<ABI38_0_0AIRMapCoordinate *> *> *)holes
{
  _holes = holes;
...
- (void)setOnPress:(ABI38_0_0RCTBubblingEventBlock)onPress {
