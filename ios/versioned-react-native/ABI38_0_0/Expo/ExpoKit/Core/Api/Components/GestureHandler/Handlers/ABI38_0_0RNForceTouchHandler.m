...
@interface ABI38_0_0RNForceTouchGestureRecognizer : UIGestureRecognizer
...
@implementation ABI38_0_0RNForceTouchGestureRecognizer {
...
@implementation ABI38_0_0RNForceTouchHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI38_0_0RNForceTouchGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  ABI38_0_0RNForceTouchGestureRecognizer *recognizer = (ABI38_0_0RNForceTouchGestureRecognizer *)_recognizer;
  ...
  if (prop != nil) {
    recognizer.feedbackOnActivation = [ABI38_0_0RCTConvert BOOL:prop];
  }
}

- (ABI38_0_0RNGestureHandlerEventExtraData *)eventExtraData:(ABI38_0_0RNForceTouchGestureRecognizer *)recognizer
{
