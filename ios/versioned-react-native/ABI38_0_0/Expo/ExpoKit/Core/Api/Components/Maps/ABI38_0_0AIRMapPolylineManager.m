...
#import "ABI38_0_0AIRMapPolylineManager.h"
...
@interface ABI38_0_0AIRMapPolylineManager()

@end

@implementation ABI38_0_0AIRMapPolylineManager

ABI38_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI38_0_0AIRMapPolyline *polyline = [ABI38_0_0AIRMapPolyline new];
    return polyline;
}
