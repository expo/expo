//
//  ABI38_0_0RNNativeViewHandler.m
...
#pragma mark ABI38_0_0RNDummyGestureRecognizer

@implementation ABI38_0_0RNDummyGestureRecognizer
...
#pragma mark ABI38_0_0RNNativeViewgestureHandler

@implementation ABI38_0_0RNNativeViewGestureHandler {
...
- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI38_0_0RNDummyGestureRecognizer alloc] init];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    _shouldActivateOnStart = [ABI38_0_0RCTConvert BOOL:config[@"shouldActivateOnStart"]];
    _disallowInterruption = [ABI38_0_0RCTConvert BOOL:config[@"disallowInterruption"]];
}
...
- (void)bindToView:(UIView *)view
{
    ...
    if ([view isKindOfClass:[ABI38_0_0RCTScrollView class]]) {
        // This part of the code is coupled with ABI38_0_0RN implementation of ScrollView native wrapper and
        // we expect for ABI38_0_0RCTScrollView component to contain a subclass of UIScrollview as the only
        // subview
...
- (void)handleTouchDown:(UIView *)sender forEvent:(UIEvent *)event
{
    ...
    [self sendEventsInState:ABI38_0_0RNGestureHandlerStateActive
             forViewWithTag:sender.ABI38_0_0ReactTag
              withExtraData:[ABI38_0_0RNGestureHandlerEventExtraData forPointerInside:YES]];
}

- (void)handleTouchUpOutside:(UIView *)sender forEvent:(UIEvent *)event
{
    [self sendEventsInState:ABI38_0_0RNGestureHandlerStateEnd
             forViewWithTag:sender.ABI38_0_0ReactTag
              withExtraData:[ABI38_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
...
{
    [self sendEventsInState:ABI38_0_0RNGestureHandlerStateCancelled
             forViewWithTag:sender.ABI38_0_0ReactTag
              withExtraData:[ABI38_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
