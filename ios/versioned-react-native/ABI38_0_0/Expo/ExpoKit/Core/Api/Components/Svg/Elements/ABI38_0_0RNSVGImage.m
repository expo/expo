...
#if __has_include(<ABI38_0_0React/ABI38_0_0RCTImageLoader.h>)
...
@implementation ABI38_0_0RNSVGImage
{
    CGImageRef _image;
    CGSize _imageSize;
...
- (void)setSrc:(id)src
{
    ...
    _image = nil;
    ABI38_0_0RCTImageSource *source = [ABI38_0_0RCTConvert ABI38_0_0RCTImageSource:src];
    ...
    _reloadImageCancellationBlock = [[self.bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI38_0_0RCTConvert NSURLRequest:src] callback:^(NSError *error, UIImage *image) {
...
- (void)setImagewidth:(ABI38_0_0RNSVGLength *)width
{
...
- (void)setImageheight:(ABI38_0_0RNSVGLength *)height
{
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    CGAffineTransform viewbox = [ABI38_0_0RNSVGViewBox getTransform:imageBounds eRect:hitArea align:self.align meetOrSlice:self.meetOrSlice];
