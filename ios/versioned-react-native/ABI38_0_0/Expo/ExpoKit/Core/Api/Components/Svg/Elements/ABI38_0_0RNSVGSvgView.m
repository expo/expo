...
@implementation ABI38_0_0RNSVGSvgView
{
    NSMutableDictionary<NSString *, ABI38_0_0RNSVGNode *> *_clipPaths;
    NSMutableDictionary<NSString *, ABI38_0_0RNSVGNode *> *_templates;
    NSMutableDictionary<NSString *, ABI38_0_0RNSVGPainter *> *_painters;
    NSMutableDictionary<NSString *, ABI38_0_0RNSVGNode *> *_markers;
    NSMutableDictionary<NSString *, ABI38_0_0RNSVGNode *> *_masks;
...
- (void)invalidate
{
    ...
    if ([parent isKindOfClass:[ABI38_0_0RNSVGNode class]]) {
        ...
        ABI38_0_0RNSVGNode* svgNode = (ABI38_0_0RNSVGNode*)parent;
        [svgNode invalidate];
        rendered = false;
        return;
    }
...
- (void)setBbWidth:(ABI38_0_0RNSVGLength *)bbWidth
{
...
- (void)setBbHeight:(ABI38_0_0RNSVGLength *)bbHeight
{
...
- (void)drawToContext:(CGContextRef)context withRect:(CGRect)rect {
    ...
    if (self.align) {
        ...
        _viewBoxTransform = [ABI38_0_0RNSVGViewBox getTransform:tRect
                                                 eRect:rect
                                                 align:self.align
    ...
    for (UIView *node in self.subviews) {
        if ([node isKindOfClass:[ABI38_0_0RNSVGNode class]]) {
            ABI38_0_0RNSVGNode *svg = (ABI38_0_0RNSVGNode *)node;
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    for (ABI38_0_0RNSVGNode *node in [self.subviews reverseObjectEnumerator]) {
        if (![node isKindOfClass:[ABI38_0_0RNSVGNode class]]) {
            continue;
        }
...
- (void)defineTemplate:(ABI38_0_0RNSVGNode *)template templateName:(NSString *)templateName
{
    if (!_templates) {
