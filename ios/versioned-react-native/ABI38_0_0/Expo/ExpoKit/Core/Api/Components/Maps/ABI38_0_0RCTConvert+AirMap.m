...
@implementation ABI38_0_0RCTConvert (AirMap)
...
{
    json = [self NSDictionary:json];
    return [ABI38_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:nil];
}
...
ABI38_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI38_0_0AIRMapCoordinate *)ABI38_0_0AIRMapCoordinate:(id)json
{
    ABI38_0_0AIRMapCoordinate *coord = [ABI38_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI38_0_0RCT_ARRAY_CONVERTER(ABI38_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI38_0_0AIRMapCoordinate *> *> *)ABI38_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI38_0_0RCTConvertArrayValue(@selector(ABI38_0_0AIRMapCoordinateArray:), json);
}
