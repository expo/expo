...
@class ABI38_0_0RNCWebView;

@protocol ABI38_0_0RNCWebViewDelegate <NSObject>

- (BOOL)webView:(ABI38_0_0RNCWebView *_Nonnull)webView
   shouldStartLoadForRequest:(NSMutableDictionary<NSString *, id> *_Nonnull)request
   withCallback:(ABI38_0_0RCTDirectEventBlock _Nonnull)callback;

@end

@interface ABI38_0_0RNCWeakScriptMessageDelegate : NSObject<WKScriptMessageHandler>
@property (nonatomic, weak) id<WKScriptMessageHandler> scriptDelegate;
- (instancetype)initWithDelegate:(id<WKScriptMessageHandler>)scriptDelegate;
@end

@interface ABI38_0_0RNCWebView : ABI38_0_0RCTView

@property (nonatomic, strong) NSString *experienceId;
@property (nonatomic, weak) id<ABI38_0_0RNCWebViewDelegate> _Nullable delegate;
