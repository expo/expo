...
if (value != nil) recognizer.prop = [ABI38_0_0RCTConvert type:value]; \
} while(0)
...
@protocol ABI38_0_0RNGestureHandlerEventEmitter

- (void)sendTouchEvent:(nonnull ABI38_0_0RNGestureHandlerEvent *)event;

- (void)sendStateChangeEvent:(nonnull ABI38_0_0RNGestureHandlerStateChange *)event;

@end


@protocol ABI38_0_0RNRootViewGestureRecognizerDelegate <UIGestureRecognizerDelegate>
...
@interface ABI38_0_0RNGestureHandler : NSObject <UIGestureRecognizerDelegate> {

@protected UIGestureRecognizer *_recognizer;
@protected ABI38_0_0RNGestureHandlerState _lastState;

}

+ (nullable ABI38_0_0RNGestureHandler *)findGestureHandlerByRecognizer:(nonnull UIGestureRecognizer *)recognizer;

- (nonnull instancetype)initWithTag:(nonnull NSNumber *)tag;

@property (nonatomic, readonly, nonnull) NSNumber *tag;
@property (nonatomic, weak, nullable) id<ABI38_0_0RNGestureHandlerEventEmitter> emitter;
...
- (nullable ABI38_0_0RNGestureHandlerEventExtraData *)eventExtraData:(nonnull id)recognizer;
