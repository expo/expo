//
//  ABI38_0_0AIRGoogleMapWMSTile.h
//  AirMaps
//
...
@interface ABI38_0_0WMSTileOverlay : GMSSyncTileLayer
...
@interface ABI38_0_0AIRGoogleMapWMSTile : UIView
@property (nonatomic, strong) ABI38_0_0WMSTileOverlay *tileLayer;
