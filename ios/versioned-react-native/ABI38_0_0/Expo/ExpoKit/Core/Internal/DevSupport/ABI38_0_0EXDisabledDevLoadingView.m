...
@implementation ABI38_0_0EXDisabledDevLoadingView {
  BOOL _isObserving;
}

+ (NSString *)moduleName { return @"ABI38_0_0RCTDevLoadingView"; }


ABI38_0_0RCT_EXPORT_METHOD(hide)
{
  ABI38_0_0RCTDevSettings *settings = [[super bridge] devSettings];
