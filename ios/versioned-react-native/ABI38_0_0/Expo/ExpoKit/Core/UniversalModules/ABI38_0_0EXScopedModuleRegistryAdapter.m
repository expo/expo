...
- (ABI38_0_0UMModuleRegistry *)moduleRegistryForParams:(NSDictionary *)params forExperienceId:(NSString *)experienceId withKernelServices:(NSDictionary *)kernelServices
{
  ...
  ABI38_0_0EXConstantsBinding *constantsBinding = [[ABI38_0_0EXConstantsBinding alloc] initWithExperienceId:experienceId andParams:params deviceInstallUUIDManager:kernelServices[@"EXDeviceInstallUUIDManager"]];
