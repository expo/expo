...
@property (nonatomic, weak) id<ABI38_0_0EXConstantsDeviceInstallUUIDManager> deviceInstallUUIDManager;

@end

@implementation ABI38_0_0EXConstantsBinding : ABI38_0_0EXConstantsService

- (instancetype)initWithExperienceId:(NSString *)experienceId andParams:(NSDictionary *)params deviceInstallUUIDManager:(id<ABI38_0_0EXConstantsDeviceInstallUUIDManager>)deviceInstallUUIDManager
{
  if (self = [super init]) {
