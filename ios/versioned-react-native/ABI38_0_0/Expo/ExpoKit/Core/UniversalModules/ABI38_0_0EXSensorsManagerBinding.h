...
@protocol ABI38_0_0EXSensorsManagerBindingDelegate
...
@interface ABI38_0_0EXSensorsManagerBinding : NSObject <ABI38_0_0UMInternalModule, ABI38_0_0UMAccelerometerInterface, ABI38_0_0UMBarometerInterface, ABI38_0_0UMDeviceMotionInterface, ABI38_0_0UMGyroscopeInterface, ABI38_0_0UMMagnetometerInterface, ABI38_0_0UMMagnetometerUncalibratedInterface>

- (instancetype)initWithExperienceId:(NSString *)experienceId andKernelService:(id<ABI38_0_0EXSensorsManagerBindingDelegate>)kernelService;
