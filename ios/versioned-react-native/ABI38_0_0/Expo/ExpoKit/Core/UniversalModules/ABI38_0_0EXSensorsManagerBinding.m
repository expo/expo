...
@interface ABI38_0_0EXSensorsManagerBinding ()

@property (nonatomic, strong) NSString *experienceId;
@property (nonatomic, weak) id<ABI38_0_0EXSensorsManagerBindingDelegate> kernelService;

@end

@implementation ABI38_0_0EXSensorsManagerBinding
