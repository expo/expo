...
#import <ABI38_0_0EXSpeech/ABI38_0_0EXSpeech.h>

@interface ABI38_0_0EXSpeechUtteranceWithId : AVSpeechUtterance
...
@implementation ABI38_0_0EXSpeechUtteranceWithId
...
@interface ABI38_0_0EXSpeech () <AVSpeechSynthesizerDelegate>
...
@implementation ABI38_0_0EXSpeech

ABI38_0_0UM_EXPORT_MODULE(ExponentSpeech)
...
{
  id<ABI38_0_0UMEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI38_0_0UMEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStarted" body:@{ @"id": ((ABI38_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didCancelSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI38_0_0UMEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI38_0_0UMEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStopped" body:@{ @"id": ((ABI38_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didFinishSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<ABI38_0_0UMEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI38_0_0UMEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingDone" body:@{ @"id": ((ABI38_0_0EXSpeechUtteranceWithId *) utterance).utteranceId }];
  }
}


ABI38_0_0UM_EXPORT_METHOD_AS(speak,
  ...
  AVSpeechUtterance *utterance = [[ABI38_0_0EXSpeechUtteranceWithId alloc] initWithString:text utteranceId:utteranceId];
...
ABI38_0_0UM_EXPORT_METHOD_AS(getVoices,
                    getVoices:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject) {
...
ABI38_0_0UM_EXPORT_METHOD_AS(stop,
                    stop:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject) {
  [_synthesizer stopSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI38_0_0UM_EXPORT_METHOD_AS(pause,
                    pause:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject) {
  [_synthesizer pauseSpeakingAtBoundary:AVSpeechBoundaryImmediate];
  resolve(nil);
}

ABI38_0_0UM_EXPORT_METHOD_AS(resume,
                    resume:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject) {
  [_synthesizer continueSpeaking];
  resolve(nil);
}

ABI38_0_0UM_EXPORT_METHOD_AS(isSpeaking,
                    isSpeaking:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject) {
