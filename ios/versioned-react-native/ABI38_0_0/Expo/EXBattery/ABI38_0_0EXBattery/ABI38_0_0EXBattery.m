...
#import <ABI38_0_0EXBattery/ABI38_0_0EXBattery.h>
#import <ABI38_0_0UMCore/ABI38_0_0UMUtilities.h>

@interface ABI38_0_0EXBattery ()
...
@property (nonatomic, readonly) ABI38_0_0EXBatteryState batteryState;

@end

@implementation ABI38_0_0EXBattery

ABI38_0_0UM_EXPORT_MODULE(ExpoBattery);
...
ABI38_0_0UM_EXPORT_METHOD_AS(getBatteryLevelAsync,
                    getBatteryLevelAsyncWithResolver:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  resolve(@(UIDevice.currentDevice.batteryLevel));
}

ABI38_0_0UM_EXPORT_METHOD_AS(getBatteryStateAsync,
                    getBatteryStateAsyncWithResolver:(ABI38_0_0UMPromiseResolveBlock)resolve rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  resolve(@([self batteryState]));
}

ABI38_0_0UM_EXPORT_METHOD_AS(isLowPowerModeEnabledAsync,
                    isLowPowerModeEnabledAsyncWithResolver:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  resolve(@(NSProcessInfo.processInfo.isLowPowerModeEnabled));
}

- (ABI38_0_0EXBatteryState)batteryState
{
  switch (UIDevice.currentDevice.batteryState) {
    case UIDeviceBatteryStateUnknown:
      return ABI38_0_0EXBatteryStateUnknown;
    case UIDeviceBatteryStateUnplugged:
      return ABI38_0_0EXBatteryStateUnplugged;
    case UIDeviceBatteryStateCharging:
      return ABI38_0_0EXBatteryStateCharging;
    case UIDeviceBatteryStateFull:
      return ABI38_0_0EXBatteryStateFull;
    default:
      return ABI38_0_0EXBatteryStateUnknown;
  }
}
