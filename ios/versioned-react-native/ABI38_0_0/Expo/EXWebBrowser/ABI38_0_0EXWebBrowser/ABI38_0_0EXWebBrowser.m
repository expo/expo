...
#import <ABI38_0_0EXWebBrowser/ABI38_0_0EXWebBrowser.h>
...
@interface ABI38_0_0EXWebBrowser () <SFSafariViewControllerDelegate>

@property (nonatomic, copy) ABI38_0_0UMPromiseResolveBlock redirectResolve;
@property (nonatomic, copy) ABI38_0_0UMPromiseRejectBlock redirectReject;
...
@implementation ABI38_0_0EXWebBrowser
{
  UIStatusBarStyle _initialStatusBarStyle;
}

ABI38_0_0UM_EXPORT_MODULE(ExpoWebBrowser)
...
ABI38_0_0UM_EXPORT_METHOD_AS(openAuthSessionAsync,
...
ABI38_0_0UM_EXPORT_METHOD_AS(openBrowserAsync,
                    ...
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  if([[arguments allKeys] containsObject:WebBrowserToolbarColorKey]) {
    safariVC.preferredBarTintColor = [ABI38_0_0EXWebBrowser convertHexColorString:arguments[WebBrowserToolbarColorKey]];
  }
  if([[arguments allKeys] containsObject:WebBrowserControlsColorKey]) {
    safariVC.preferredControlTintColor = [ABI38_0_0EXWebBrowser convertHexColorString:arguments[WebBrowserControlsColorKey]];
  }
...
ABI38_0_0UM_EXPORT_METHOD_AS(dismissBrowser,
                    dismissBrowserWithResolver:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  __weak typeof(self) weakSelf = self;
  UIViewController *currentViewController = [UIApplication sharedApplication].keyWindow.rootViewController;
...
ABI38_0_0UM_EXPORT_METHOD_AS(dismissAuthSession,
                    dismissAuthSessionWithResolver:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  if (@available(iOS 11, *)) {
    [_authSession cancel];
...
ABI38_0_0UM_EXPORT_METHOD_AS(warmUpAsync,
...
ABI38_0_0UM_EXPORT_METHOD_AS(coolDownAsync,
...
ABI38_0_0UM_EXPORT_METHOD_AS(getCustomTabsSupportingBrowsers,
                    getCustomTabsSupportingBrowsersWithPackage:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  // stub for jest-expo-mock-generator
}

ABI38_0_0UM_EXPORT_METHOD_AS(mayInitWithUrlAsync,
 ...
 */
- (BOOL)initializeWebBrowserWithResolver:(ABI38_0_0UMPromiseResolveBlock)resolve andRejecter:(ABI38_0_0UMPromiseRejectBlock)reject {
  if (_redirectResolve) {
...
+ (UIColor *)convertHexColorString:(NSString *)stringToConvert {
  ...
  return [ABI38_0_0EXWebBrowser colorWithRGBHex:hexNum];
}
