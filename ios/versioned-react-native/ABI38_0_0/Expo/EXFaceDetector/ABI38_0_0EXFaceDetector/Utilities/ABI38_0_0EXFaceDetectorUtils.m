//
//  ABI38_0_0EXFaceDetectorUtils.m
//  Exponent
//
...
#import <ABI38_0_0EXFaceDetector/ABI38_0_0EXCSBufferOrientationCalculator.h>

NSString *const ABI38_0_0EXGMVDataOutputWidthKey = @"Width";
NSString *const ABI38_0_0EXGMVDataOutputHeightKey = @"Height";
...
@implementation ABI38_0_0EXFaceDetectorUtils
...
+ (ABI38_0_0EXFaceDetectionAngleTransformBlock)angleTransformerFromTransform:(CGAffineTransform)transform
{
  return ^(float angle) {
