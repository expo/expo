...
@interface ABI38_0_0EXFaceEncoder()

@property (assign, nonatomic) BOOL swapWidthAndHeight;
@property CGAffineTransform transform;
@property ABI38_0_0EXFaceDetectionAngleTransformBlock angleTransformer;

@end

@implementation ABI38_0_0EXFaceEncoder
...
{
  ABI38_0_0EXFaceDetectionAngleTransformBlock transformer = ^(float angle) {return angle;};
  return [self initWithTransform:pointTransformer withRotationTransform:transformer];
}

- (instancetype)initWithRotationTransform:(ABI38_0_0EXFaceDetectionAngleTransformBlock)rotationTransform
{
