...
{
  MLKFaceDetectorOptions* newOptions = [ABI38_0_0EXFaceDetectorUtils newOptions:self.faceDetectorOptions withValues:settings];
...
- (void)_notifyOfFaces:(NSArray<MLKFace *> *)faces
           withEncoder:(ABI38_0_0EXFaceEncoder*)encoder
{
       ...
       fromConnection:(AVCaptureConnection *)connection
{
  ...
  if (timePassedMillis > self.timeIntervalMillis) {
    ...
    UIImageOrientation orientation = [ABI38_0_0EXFaceDetectorManager imageOrientationFrom:_interfaceOrientation
                                                                     andMirrored:_mirroredImageSession];
    ...
    [_faceDetector detectFromBuffer:sampleBuffer
      ...
      if (error != nil) {
        ...
        [self _notifyOfFaces:faces
                 withEncoder:[[ABI38_0_0EXFaceEncoder alloc] initWithTransform:transformation
