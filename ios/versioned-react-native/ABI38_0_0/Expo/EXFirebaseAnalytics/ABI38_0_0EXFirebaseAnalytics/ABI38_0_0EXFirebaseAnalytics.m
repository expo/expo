...
#import <ABI38_0_0EXFirebaseCore/ABI38_0_0UMFirebaseCoreInterface.h>
#import <ABI38_0_0EXFirebaseAnalytics/ABI38_0_0EXFirebaseAnalytics.h>
...
@interface ABI38_0_0EXFirebaseAnalytics ()

@property (nonatomic, weak) ABI38_0_0UMModuleRegistry *moduleRegistry;
@property (nonatomic, weak) id<ABI38_0_0UMFirebaseCoreInterface> firebaseCore;

@end

@implementation ABI38_0_0EXFirebaseAnalytics

ABI38_0_0UM_EXPORT_MODULE(ExpoFirebaseAnalytics);
...
- (void)reject:(ABI38_0_0UMPromiseRejectBlock)reject withException:(NSException *)exception {
...
- (void)setModuleRegistry:(ABI38_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  _firebaseCore = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI38_0_0UMFirebaseCoreInterface)];
}

- (nullable FIRApp *)getAppOrReject:(ABI38_0_0UMPromiseRejectBlock)reject
{
  if (!_firebaseCore) {
    reject(@"ERR_FIREBASE_ANALYTICS", @"ABI38_0_0EXFirebaseCore could not be found. Ensure that your app has correctly linked 'expo-firebase-core' and your project has ABI38_0_0React-native-unimodules installed.", nil);
    return nil;
  }
...
ABI38_0_0UM_EXPORT_METHOD_AS(setAnalyticsCollectionEnabled,
...
ABI38_0_0UM_EXPORT_METHOD_AS(setCurrentScreen,
...
ABI38_0_0UM_EXPORT_METHOD_AS(resetAnalyticsData,
                    resetAnalyticsData:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject) {
  if ([self getAppOrReject:reject] == nil) return;
  @try {
