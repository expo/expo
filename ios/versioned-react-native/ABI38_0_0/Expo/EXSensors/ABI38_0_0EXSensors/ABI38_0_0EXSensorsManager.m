...
#import <ABI38_0_0EXSensors/ABI38_0_0EXSensorsManager.h>
#import <CoreMotion/CoreMotion.h>

@interface ABI38_0_0EXSensorsManager ()
...
@implementation ABI38_0_0EXSensorsManager

ABI38_0_0UM_REGISTER_MODULE();

+ (const NSArray<Protocol *> *)exportedInterfaces
{
  return @[@protocol(ABI38_0_0UMAccelerometerInterface), @protocol(ABI38_0_0UMBarometerInterface), @protocol(ABI38_0_0UMDeviceMotionInterface), @protocol(ABI38_0_0UMGyroscopeInterface), @protocol(ABI38_0_0UMMagnetometerInterface), @protocol(ABI38_0_0UMMagnetometerUncalibratedInterface)];
}
                                            ...
                                            withHandler:(void (^)(NSDictionary *event))handlerBlock
{
  ...
  if (![[self manager] isAccelerometerActive]) {
    ...
    __weak ABI38_0_0EXSensorsManager *weakSelf = self;
    [[self manager] startAccelerometerUpdatesToQueue:[NSOperationQueue mainQueue] withHandler:^(CMAccelerometerData *data, NSError *error) {
      __strong ABI38_0_0EXSensorsManager *strongSelf = weakSelf;
      if (strongSelf) {
  ...
  [[self manager] startDeviceMotionUpdatesUsingReferenceFrame:CMAttitudeReferenceFrameXArbitraryCorrectedZVertical toQueue:[NSOperationQueue mainQueue] withHandler:^(CMDeviceMotion *data, NSError *error) {
    ...
    NSMutableDictionary *result = [NSMutableDictionary dictionaryWithDictionary:@{
                             ...
                             @"accelerationIncludingGravity": @{
                                 @"x": @((data.userAcceleration.x + data.gravity.x) * ABI38_0_0EXGravity),
                                 @"y": @((data.userAcceleration.y + data.gravity.y) * ABI38_0_0EXGravity),
                                 @"z": @((data.userAcceleration.z + data.gravity.z) * ABI38_0_0EXGravity)
                                 },
                             @"rotation": @{
    ...
    if ([[strongSelf manager] isGyroAvailable]) {
      result[@"acceleration"] = @{
        @"x": @(data.userAcceleration.x * ABI38_0_0EXGravity),
        @"y": @(data.userAcceleration.y * ABI38_0_0EXGravity),
        @"z": @(data.userAcceleration.z * ABI38_0_0EXGravity)
      };
