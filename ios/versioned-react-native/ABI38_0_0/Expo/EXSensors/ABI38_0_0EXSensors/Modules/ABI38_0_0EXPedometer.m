...
#import <ABI38_0_0EXSensors/ABI38_0_0EXPedometer.h>
...
NSString * const ABI38_0_0EXPedometerUpdateEventName = @"Exponent.pedometerUpdate";
NSString * const ABI38_0_0EXPedometerModuleName = @"ExponentPedometer";

@interface ABI38_0_0EXPedometer () <ABI38_0_0UMAppLifecycleListener>
...
@implementation ABI38_0_0EXPedometer
...
{
  if (self = [super init]) {
    __weak ABI38_0_0EXPedometer *weakSelf = self;
    _watchHandler = ^(CMPedometerData * _Nullable pedometerData, NSError * _Nullable error) {
      ...
      __strong ABI38_0_0EXPedometer *strongSelf = weakSelf;
      if (strongSelf) {
        __strong id<ABI38_0_0UMEventEmitterService> eventEmitter = strongSelf.eventEmitter;
        if (eventEmitter) {
          [eventEmitter sendEventWithName:ABI38_0_0EXPedometerUpdateEventName
...
{
  return ABI38_0_0EXPedometerModuleName;
}
...
{
  return @[ABI38_0_0EXPedometerUpdateEventName];
}
...
ABI38_0_0UM_EXPORT_METHOD_AS(getStepCountAsync,
