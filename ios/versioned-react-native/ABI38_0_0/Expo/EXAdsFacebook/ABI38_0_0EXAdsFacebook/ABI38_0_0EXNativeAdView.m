...
@interface ABI38_0_0EXNativeAdView ()

@property (nonatomic, weak) ABI38_0_0UMModuleRegistry *moduleRegistry;

@end

@implementation ABI38_0_0EXNativeAdView
...
- (void)setOnAdLoaded:(ABI38_0_0UMDirectEventBlock)onAdLoaded
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    if (strongSelf) {
      [strongSelf.nativeAd registerViewForInteraction:strongSelf
                                            mediaView:mediaView
                                             iconView:adIconView
                                       viewController:[[strongSelf.moduleRegistry getModuleImplementingProtocol:@protocol(ABI38_0_0UMUtilitiesInterface)] currentViewController]
