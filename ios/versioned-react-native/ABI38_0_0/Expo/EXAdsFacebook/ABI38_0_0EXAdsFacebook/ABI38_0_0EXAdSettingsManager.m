#import <ABI38_0_0EXAdsFacebook/ABI38_0_0EXAdSettingsManager.h>
#import <FBAudienceNetwork/FBAudienceNetwork.h>
#import <ABI38_0_0UMCore/ABI38_0_0UMAppLifecycleService.h>

@interface ABI38_0_0EXAdSettingsManager ()
...
@implementation ABI38_0_0EXAdSettingsManager

ABI38_0_0UM_EXPORT_MODULE(CTKAdSettingsManager)
...
ABI38_0_0UM_EXPORT_METHOD_AS(addTestDevice,
...
ABI38_0_0UM_EXPORT_METHOD_AS(clearTestDevices,
                    clearTestDevicesWithResolver:(ABI38_0_0UMPromiseResolveBlock)resolver
                    reject:(ABI38_0_0UMPromiseRejectBlock)rejecter)
{
...
ABI38_0_0UM_EXPORT_METHOD_AS(setLogLevel,
...
ABI38_0_0UM_EXPORT_METHOD_AS(setIsChildDirected,
...
ABI38_0_0UM_EXPORT_METHOD_AS(setMeditationService,
...
ABI38_0_0UM_EXPORT_METHOD_AS(setUrlPrefix,
