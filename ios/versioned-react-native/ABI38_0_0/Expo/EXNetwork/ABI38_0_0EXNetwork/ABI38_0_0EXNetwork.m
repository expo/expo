...
#import <ABI38_0_0EXNetwork/ABI38_0_0EXNetwork.h>
...
@implementation ABI38_0_0EXNetwork
...
- (instancetype)init
{
  self = [super init];
  if (self) {
    _type = ABI38_0_0EXNetworkTypeUnknown;
  }
  return self;
}

ABI38_0_0UM_EXPORT_MODULE(ExpoNetwork);
...
ABI38_0_0UM_EXPORT_METHOD_AS(getMacAddressAsync,
...
ABI38_0_0UM_EXPORT_METHOD_AS(getIpAddressAsync,
                    getIpAddressAsyncWithResolver:(ABI38_0_0UMPromiseResolveBlock)resolve rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
...
ABI38_0_0UM_EXPORT_METHOD_AS(getNetworkStateAsync,
                    getNetworkStateAsyncWithResolver:(ABI38_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI38_0_0UMPromiseRejectBlock)reject)
{
  ...
  if ((flags & kSCNetworkReachabilityFlagsReachable) == 0 ||
    ...
    _type = ABI38_0_0EXNetworkTypeNone;
  }
  
#if !TARGET_OS_TV
  else if ((flags & kSCNetworkReachabilityFlagsIsWWAN) != 0) {
    _type = ABI38_0_0EXNetworkTypeCellular;
  }
#endif
  else {
    _type = ABI38_0_0EXNetworkTypeWifi;
  }
...
- (BOOL)connected
{
  return ![self.type isEqualToString:ABI38_0_0EXNetworkTypeUnknown] && ![self.type isEqualToString:ABI38_0_0EXNetworkTypeNone];
}
