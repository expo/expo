...
#import <ABI38_0_0ReactCommon/ABI38_0_0LongLivedObject.h>
...
static NSArray *
convertJSIArrayToNSArray(jsi::Runtime &runtime, const jsi::Array &value, std::shared_ptr<ABI38_0_0React::CallInvoker> jsInvoker)
{
...
static ABI38_0_0RCTResponseSenderBlock convertJSIFunctionToCallback(
    jsi::Runtime &runtime,
...
static ABI38_0_0RCTResponseSenderBlock convertJSIFunctionToCallback(
    ...
    std::shared_ptr<ABI38_0_0React::CallInvoker> jsInvoker)
{
  auto weakWrapper = ABI38_0_0React::CallbackWrapper::createWeak(value.getFunction(runtime), runtime, jsInvoker);
  ...
  jsi::Function fn = jsi::Function::createFromHostFunction(
      ...
      [invokeCopy, jsInvoker](jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args, size_t count) {
        ...
        auto weakResolveWrapper =
            ABI38_0_0React::CallbackWrapper::createWeak(args[0].getObject(rt).getFunction(rt), rt, jsInvoker);
        auto weakRejectWrapper =
            ABI38_0_0React::CallbackWrapper::createWeak(args[1].getObject(rt).getFunction(rt), rt, jsInvoker);

        __block BOOL resolveWasCalled = NO;
        __block BOOL rejectWasCalled = NO;

        ABI38_0_0RCTPromiseResolveBlock resolveBlock = ^(id result) {
          if (rejectWasCalled) {
        ...
        ABI38_0_0RCTPromiseRejectBlock rejectBlock = ^(NSString *code, NSString *message, NSError *error) {
          if (resolveWasCalled) {
          ...
          NSDictionary *jsError = ABI38_0_0RCTJSErrorFromCodeMessageAndNSError(code, message, error);
 ...
 * This serves as a backward-compatible support for ABI38_0_0RCTBridgeModule's methodQueue API.
 *
 * In the future:
    ...
    NSMutableArray *retainedObjectsForInvocation)
{
  ...
  if ([module conformsToProtocol:@protocol(ABI38_0_0RCTBridgeModule)] && [module respondsToSelector:@selector(methodQueue)]) {
    methodQueue = [module performSelector:@selector(methodQueue)];
  }

  if (methodQueue == NULL || methodQueue == ABI38_0_0RCTJSThread) {
    ...
    if (valueKind == VoidKind) {
      ...
      ABI38_0_0RCTExecuteOnMainQueue(block);
    } else {
      ...
      ABI38_0_0RCTUnsafeExecuteOnMainQueueSync(block);
    }
  } else {
    if (valueKind == VoidKind) {
  ...
  if (!methodArgumentTypeNames_) {
    ...
    if (methods) {
      for (unsigned int i = 0; i < numberOfMethods; i++) {
        ...
        ABI38_0_0RCTMethodInfo *(*getMethodInfo)(id, SEL) = (__typeof__(getMethodInfo))objc_msgSend;
        ABI38_0_0RCTMethodInfo *methodInfo = getMethodInfo(cls, s);

        NSArray<ABI38_0_0RCTMethodArgument *> *arguments;
        NSString *otherMethodName = ABI38_0_0RCTParseMethodSignature(methodInfo->objcName, &arguments);
    ...
    NSMutableArray *retainedObjectsForInvocation)
{
  ...
  for (size_t i = 0; i < count; i++) {
    ...
    if (objCArg) {
      ...
      /**
       * Convert objects using ABI38_0_0RCTConvert.
       */
      if (objCArgType == @encode(id)) {
        ...
        if (argumentType != nil) {
          ...
          if ([ABI38_0_0RCTConvert respondsToSelector:rctConvertSelector]) {
            // Message dispatch logic from old infra
            id (*convert)(id, SEL, id) = (__typeof__(convert))objc_msgSend;
            id convertedObjCArg = convert([ABI38_0_0RCTConvert class], rctConvertSelector, objCArg);
      ...
      /**
       * Convert objects using ABI38_0_0RCTCxxConvert to structs.
       */
      if ([objCArg isKindOfClass:[NSDictionary class]] && hasMethodArgConversionSelector(methodNameNSString, i)) {
        ...
        ABI38_0_0RCTManagedPointer *box = convert([ABI38_0_0RCTCxxConvert class], methodArgConversionSelector, objCArg);
    ...
    size_t count)
{
  ...
  if (valueKind == PromiseKind) {
    ...
    return createPromise(
        runtime,
        jsInvoker_,
        ^(jsi::Runtime &rt, ABI38_0_0RCTPromiseResolveBlock resolveBlock, ABI38_0_0RCTPromiseRejectBlock rejectBlock) {
