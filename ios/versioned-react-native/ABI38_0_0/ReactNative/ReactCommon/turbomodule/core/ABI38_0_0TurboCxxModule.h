...
#include <ABI38_0_0cxxreact/ABI38_0_0CxxModule.h>

#include "ABI38_0_0TurboModule.h"
...
class JSI_EXPORT TurboCxxModule : public TurboModule {
 public:
  TurboCxxModule(
      std::unique_ptr<ABI38_0_0facebook::xplat::module::CxxModule> cxxModule,
 ...
 private:
  std::vector<ABI38_0_0facebook::xplat::module::CxxModule::Method> cxxMethods_;
  std::unique_ptr<ABI38_0_0facebook::xplat::module::CxxModule> cxxModule_;
};
