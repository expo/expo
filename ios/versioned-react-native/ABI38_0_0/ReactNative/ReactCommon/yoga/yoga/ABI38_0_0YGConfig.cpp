...
ABI38_0_0YGConfig::ABI38_0_0YGConfig(ABI38_0_0YGLogger logger) : cloneNodeCallback_{nullptr} {
  logger_.noContext = logger;
  loggerUsesContext_ = false;
}

void ABI38_0_0YGConfig::log(
    ABI38_0_0YGConfig* config,
    ABI38_0_0YGNode* node,
    ABI38_0_0YGLogLevel logLevel,
    void* logContext,
    const char* format,
    va_list args) {
...
ABI38_0_0YGNodeRef ABI38_0_0YGConfig::cloneNode(
    ABI38_0_0YGNodeRef node,
    ABI38_0_0YGNodeRef owner,
    int childIndex,
    void* cloneContext) {
  ABI38_0_0YGNodeRef clone = nullptr;
  ...
  if (clone == nullptr) {
    clone = ABI38_0_0YGNodeClone(node);
  }
  return clone;
}
