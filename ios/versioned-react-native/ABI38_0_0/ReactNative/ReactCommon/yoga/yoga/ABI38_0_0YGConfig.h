...
struct YOGA_EXPORT ABI38_0_0YGConfig {
  using LogWithContextFn = int (*)(
      ...
      const char* format,
      va_list args);
  using CloneWithContextFn = ABI38_0_0YGNodeRef (*)(
      ABI38_0_0YGNodeRef node,
...
private:
  union {
    ...
    ABI38_0_0YGCloneNodeFunc noContext;
  } cloneNodeCallback_;
  union {
    LogWithContextFn withContext;
    ABI38_0_0YGLogger noContext;
  } logger_;
...
public:
  ...
  std::array<bool, ABI38_0_0facebook::yoga::enums::count<ABI38_0_0YGExperimentalFeature>()>
      experimentalFeatures = {};
  void* context = nullptr;

  ABI38_0_0YGConfig(ABI38_0_0YGLogger logger);
  void log(ABI38_0_0YGConfig*, ABI38_0_0YGNode*, ABI38_0_0YGLogLevel, void*, const char*, va_list);
  void setLogger(ABI38_0_0YGLogger logger) {
  ...
  void setLogger(std::nullptr_t) { setLogger(ABI38_0_0YGLogger{nullptr}); }

  ABI38_0_0YGNodeRef cloneNode(
      ABI38_0_0YGNodeRef node,
      ABI38_0_0YGNodeRef owner,
      int childIndex,
      void* cloneContext);
  void setCloneNodeCallback(ABI38_0_0YGCloneNodeFunc cloneNode) {
  ...
  void setCloneNodeCallback(std::nullptr_t) {
    setCloneNodeCallback(ABI38_0_0YGCloneNodeFunc{nullptr});
  }
};
