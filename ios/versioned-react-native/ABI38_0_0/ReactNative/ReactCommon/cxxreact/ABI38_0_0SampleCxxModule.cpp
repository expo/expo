...
#include "ABI38_0_0SampleCxxModule.h"
...
ABI38_0_0facebook::xplat::module::CxxModule *SampleCxxModule() {
  return new ABI38_0_0facebook::xplat::samples::SampleCxxModule(
      std::make_unique<ABI38_0_0facebook::xplat::samples::Sample>());
}
