...
#ifndef ABI38_0_0RN_EXPORT
#ifdef _MSC_VER
#define ABI38_0_0RN_EXPORT
#else
#define ABI38_0_0RN_EXPORT __attribute__((visibility("default")))
#endif
#endif
...
// file.
class ABI38_0_0RN_EXPORT JSBigBufferString : public JSBigString {
 public:
...
class ABI38_0_0RN_EXPORT JSBigFileString : public JSBigString {
 public:
