...
#include "ABI38_0_0CxxNativeModule.h"
#include "ABI38_0_0Instance.h"

#include <iterator>
#include <glog/logging.h>
#include <folly/json.h>

#include "ABI38_0_0JsArgumentHelpers.h"
#include "ABI38_0_0SystraceSection.h"
#include "ABI38_0_0MessageQueueThread.h"

using ABI38_0_0facebook::xplat::module::CxxModule;
...
void CxxNativeModule::invoke(unsigned int ABI38_0_0ReactMethodId, folly::dynamic&& params, int callId) {
  if (ABI38_0_0ReactMethodId >= methods_.size()) {
    throw std::invalid_argument(folly::to<std::string>("methodId ", ABI38_0_0ReactMethodId,
  ...
  const auto& method = methods_[ABI38_0_0ReactMethodId];
  ...
  messageQueueThread_->runOnQueue([method, params=std::move(params), first, second, callId] () {
    ...
    } catch (const ABI38_0_0facebook::xplat::JsArgumentException& ex) {
      throw;
