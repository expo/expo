...
#include <ABI38_0_0React/graphics/ColorComponents.h>
...
namespace std {
template <>
struct hash<ABI38_0_0facebook::ABI38_0_0React::SharedColor> {
  size_t operator()(const ABI38_0_0facebook::ABI38_0_0React::SharedColor &sharedColor) const {
