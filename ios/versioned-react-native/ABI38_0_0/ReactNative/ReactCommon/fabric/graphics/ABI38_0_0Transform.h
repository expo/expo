...
#include <ABI38_0_0React/graphics/Float.h>
...
template <>
struct hash<ABI38_0_0facebook::ABI38_0_0React::Transform> {
  size_t operator()(const ABI38_0_0facebook::ABI38_0_0React::Transform &transform) const {
