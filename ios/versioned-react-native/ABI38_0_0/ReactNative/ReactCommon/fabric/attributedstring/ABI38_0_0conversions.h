...
#include <ABI38_0_0React/attributedstring/primitives.h>
...
#include <ABI38_0_0React/graphics/conversions.h>
#include <cmath>
...
inline folly::dynamic toDynamic(const AttributedString &attributedString) {
  ...
  for (auto fragment : attributedString.getFragments()) {
    ...
    if (fragment.parentShadowView.componentHandle) {
      dynamicFragment["ABI38_0_0ReactTag"] = fragment.parentShadowView.tag;
    }
  ...
  value(
      "hash", std::hash<ABI38_0_0facebook::ABI38_0_0React::AttributedString>{}(attributedString));
