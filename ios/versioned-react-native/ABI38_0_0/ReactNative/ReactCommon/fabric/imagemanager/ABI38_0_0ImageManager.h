...
#include <ABI38_0_0React/imagemanager/ImageRequest.h>
#include <ABI38_0_0React/imagemanager/primitives.h>
...
/*
 * Cross platform facade for iOS-specific ABI38_0_0RCTImageManager.
 */
class ImageManager {
 public:
