...
#include <ABI38_0_0React/uimanager/UIManager.h>
#include <ABI38_0_0React/uimanager/UIManagerBinding.h>
#include <ABI38_0_0React/uimanager/UITemplateProcessor.h>
...
Scheduler::Scheduler(
  ...
  ABI38_0_0ReactNativeConfig_ =
      schedulerToolbox.contextContainer
          ->at<std::shared_ptr<const ABI38_0_0ReactNativeConfig>>("ABI38_0_0ReactNativeConfig");
...
void Scheduler::renderTemplateToSurface(
  ...
  try {
    ...
    LOG(ERROR) << "    >>>> ABI38_0_0EXCEPTION <<<  rendering uiTemplate in "
...
void Scheduler::stopSurface(SurfaceId surfaceId) const {
  ...
  // We execute JavaScript/ABI38_0_0React part of the process at the very end to minimize
