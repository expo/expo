...
#include <ABI38_0_0React/uimanager/ComponentDescriptorFactory.h>
#include <ABI38_0_0React/uimanager/UITemplateProcessor.h>

using namespace ABI38_0_0facebook::ABI38_0_0React;

#include <ABI38_0_0React/components/rncore/ComponentDescriptors.h>
#include <ABI38_0_0React/components/scrollview/ScrollViewComponentDescriptor.h>
...
#include <ABI38_0_0React/uimanager/ComponentDescriptorFactory.h>
#include <ABI38_0_0React/uimanager/ComponentDescriptorProviderRegistry.h>
...
class MockABI38_0_0ReactNativeConfig : public ABI38_0_0ReactNativeConfig {
 public:
  MockABI38_0_0ReactNativeConfig() {}
...
std::shared_ptr<const ABI38_0_0ReactNativeConfig> mockABI38_0_0ReactNativeConfig_ =
    std::make_shared<const MockABI38_0_0ReactNativeConfig>();
...
TEST(UITemplateProcessorTest, testSimpleBytecode) {
  ...
  auto bytecode = R"delim({"version":0.1,"commands":[
    ["createNode",2,"ABI38_0_0RCTView",-1,{"opacity": 0.5, "testId": "root"}],
    ["createNode",4,"ABI38_0_0RCTView",2,{"testId": "child"}],
    ["returnRoot",2]
  ]})delim";
  ...
  auto root1 = UITemplateProcessor::buildShadowTree(
      ...
      *componentDescriptorRegistry,
      ...
      mockABI38_0_0ReactNativeConfig_);
#ifndef NDEBUG
...
TEST(UITemplateProcessorTest, testConditionalBytecode) {
  ...
  auto bytecode = R"delim({"version":0.1,"commands":[
    ["createNode",2,"ABI38_0_0RCTView",-1,{"testId": "root"}],
    ["loadNativeBool",1,"MobileConfig","getBool",["qe:simple_test"]],
    ["conditional",1,
      [["createNode",4,"ABI38_0_0RCTView",2,{"testId": "cond_true"}]],
      [["createNode",4,"ABI38_0_0RCTView",2,{"testId": "cond_false"}]]
    ],
    ["returnRoot",2]
  ]})delim";
