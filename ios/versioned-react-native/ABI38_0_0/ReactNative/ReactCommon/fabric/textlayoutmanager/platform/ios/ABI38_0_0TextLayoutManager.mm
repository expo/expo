...
{
  self_ = (__bridge_retained void *)[ABI38_0_0RCTTextLayoutManager new];
}
...
{
  ABI38_0_0RCTTextLayoutManager *textLayoutManager = (__bridge ABI38_0_0RCTTextLayoutManager *)self_;
