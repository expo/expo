...
#import "ABI38_0_0RCTTextLayoutManager.h"

#import "ABI38_0_0NSTextStorage+FontScaling.h"
#import "ABI38_0_0RCTAttributedTextUtils.h"

#import <ABI38_0_0React/utils/SimpleThreadSafeCache.h>

using namespace ABI38_0_0facebook::ABI38_0_0React;

@implementation ABI38_0_0RCTTextLayoutManager {
  SimpleThreadSafeCache<AttributedString, std::shared_ptr<const void>, 256> _cache;
}

static NSLineBreakMode ABI38_0_0RCTNSLineBreakModeFromEllipsizeMode(EllipsizeMode ellipsizeMode)
{
...
- (ABI38_0_0facebook::ABI38_0_0React::Size)measureAttributedString:(AttributedString)attributedString
                             paragraphAttributes:(ParagraphAttributes)paragraphAttributes
                               layoutConstraints:(LayoutConstraints)layoutConstraints
{
...
- (NSTextStorage *)
  ...
  textContainer.lineBreakMode = paragraphAttributes.maximumNumberOfLines > 0
      ? ABI38_0_0RCTNSLineBreakModeFromEllipsizeMode(paragraphAttributes.ellipsizeMode)
...
- (SharedEventEmitter)
  ...
  if (textStorage.length > 0 && (fraction > 0 || characterIndex > 0) &&
    ...
    ABI38_0_0RCTWeakEventEmitterWrapper *eventEmitterWrapper =
        (ABI38_0_0RCTWeakEventEmitterWrapper *)[textStorage
                 attribute:ABI38_0_0RCTAttributedStringEventEmitterKey
...
- (NSAttributedString *)_nsAttributedStringFromAttributedString:(AttributedString)attributedString
{
  auto sharedNSAttributedString = _cache.get(attributedString, [](const AttributedString attributedString) {
    return std::shared_ptr<void>(
        (__bridge_retained void *)ABI38_0_0RCTNSAttributedStringFromAttributedString(attributedString), CFRelease);
  });
