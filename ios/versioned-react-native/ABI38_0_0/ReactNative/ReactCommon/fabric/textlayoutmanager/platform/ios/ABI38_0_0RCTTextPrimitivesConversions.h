...
inline static NSTextAlignment ABI38_0_0RCTNSTextAlignmentFromTextAlignment(
...
inline static NSWritingDirection ABI38_0_0RCTNSWritingDirectionFromWritingDirection(
...
inline static ABI38_0_0RCTFontStyle ABI38_0_0RCTFontStyleFromFontStyle(FontStyle fontStyle) {
  switch (fontStyle) {
    case FontStyle::Normal:
      return ABI38_0_0RCTFontStyleNormal;
    case FontStyle::Italic:
      return ABI38_0_0RCTFontStyleItalic;
    case FontStyle::Oblique:
      return ABI38_0_0RCTFontStyleOblique;
  }
}

inline static ABI38_0_0RCTFontVariant ABI38_0_0RCTFontVariantFromFontVariant(
    FontVariant fontVariant) {
  return (ABI38_0_0RCTFontVariant)fontVariant;
}

inline static NSUnderlineStyle ABI38_0_0RCTNSUnderlineStyleFromStyleAndPattern(
...
inline static UIColor *ABI38_0_0RCTUIColorFromSharedColor(const SharedColor &color) {
