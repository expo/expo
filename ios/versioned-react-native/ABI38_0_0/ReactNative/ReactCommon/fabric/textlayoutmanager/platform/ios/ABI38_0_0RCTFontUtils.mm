...
#import "ABI38_0_0RCTFontUtils.h"
...
static ABI38_0_0RCTFontProperties ABI38_0_0RCTDefaultFontProperties()
{
  static ABI38_0_0RCTFontProperties defaultFontProperties;
  ...
  dispatch_once(&onceToken, ^{
    ...
    defaultFontProperties.style = ABI38_0_0RCTFontStyleNormal;
    defaultFontProperties.variant = ABI38_0_0RCTFontVariantDefault;
...
static ABI38_0_0RCTFontProperties ABI38_0_0RCTResolveFontProperties(
    ABI38_0_0RCTFontProperties fontProperties,
    ABI38_0_0RCTFontProperties baseFontProperties)
{
  ...
  fontProperties.style =
      fontProperties.style != ABI38_0_0RCTFontStyleUndefined ? fontProperties.style : baseFontProperties.style;
  fontProperties.variant =
      fontProperties.variant != ABI38_0_0RCTFontVariantUndefined ? fontProperties.variant : baseFontProperties.variant;
  return fontProperties;
}

static UIFontWeight ABI38_0_0RCTGetFontWeight(UIFont *font)
{
  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  return [traits[UIFontWeightTrait] doubleValue];
}

static ABI38_0_0RCTFontStyle ABI38_0_0RCTGetFontStyle(UIFont *font)
{
  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
...
static NSArray *ABI38_0_0RCTFontFeatures(ABI38_0_0RCTFontVariant fontVariant)
{
  // FIXME:
  return @[];
}

static UIFont *ABI38_0_0RCTDefaultFontWithFontProperties(ABI38_0_0RCTFontProperties fontProperties)
{
  ...
  if (!font) {
    ...
    if (fontProperties.variant == ABI38_0_0RCTFontStyleItalic) {
...
UIFont *ABI38_0_0RCTFontWithFontProperties(ABI38_0_0RCTFontProperties fontProperties)
{
  ABI38_0_0RCTFontProperties defaultFontProperties = ABI38_0_0RCTDefaultFontProperties();
  fontProperties = ABI38_0_0RCTResolveFontProperties(fontProperties, defaultFontProperties);
  ...
  if ([fontProperties.family isEqualToString:defaultFontProperties.family]) {
    ...
    font = ABI38_0_0RCTDefaultFontWithFontProperties(fontProperties);
  } else {
    ...
    if (fontNames.count == 0) {
      ...
      for (NSString *name in fontNames) {
        ...
        if (ABI38_0_0RCTGetFontStyle(fontMatch) != fontProperties.style) {
          continue;
        }

        CGFloat testWeight = ABI38_0_0RCTGetFontWeight(fontMatch);
  ...
  if (fontProperties.variant != ABI38_0_0RCTFontVariantDefault) {
    NSArray *fontFeatures = ABI38_0_0RCTFontFeatures(fontProperties.variant);
    UIFontDescriptor *fontDescriptor = [font.fontDescriptor
