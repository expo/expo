...
#include <ABI38_0_0React/utils/FloatComparison.h>
#include <ABI38_0_0React/utils/SimpleThreadSafeCache.h>
...
template <>
struct hash<ABI38_0_0facebook::ABI38_0_0React::TextMeasureCacheKey> {
  size_t operator()(ABI38_0_0facebook::ABI38_0_0React::TextMeasureCacheKey const &key) const {
    return folly::hash::hash_combine(
        0,
