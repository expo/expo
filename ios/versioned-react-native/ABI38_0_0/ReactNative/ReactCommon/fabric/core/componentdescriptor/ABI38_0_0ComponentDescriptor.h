...
#include <ABI38_0_0React/core/EventDispatcher.h>
#include <ABI38_0_0React/core/Props.h>
#include <ABI38_0_0React/core/RawPropsParser.h>
...
class ComponentDescriptor {
 public:
   ...
   * ABI38_0_0React uses a `name` to refer to particular kind of components in
   * `create` requests.
   */
