...
@protocol ABI38_0_0RCTScrollViewProtocol <NSObject>
- (void)flashScrollIndicators;
- (void)scrollTo:(double)x y:(double)y animated:(BOOL)animated;
- (void)scrollToEnd:(BOOL)animated;
@end

ABI38_0_0RCT_EXTERN inline void
ABI38_0_0RCTScrollViewHandleCommand(id<ABI38_0_0RCTScrollViewProtocol> componentView, NSString const *commandName, NSArray const *args)
{
...
#if ABI38_0_0RCT_DEBUG
    if (!ABI38_0_0RCTValidateTypeOfViewCommandArgument(arg0, [NSNumber class], @"float", @"ScrollView", commandName, @"1st")) {
      return;
    }
#endif
    NSObject *arg1 = args[1];
#if ABI38_0_0RCT_DEBUG
    if (!ABI38_0_0RCTValidateTypeOfViewCommandArgument(arg1, [NSNumber class], @"float", @"ScrollView", commandName, @"2nd")) {
      return;
    }
#endif
    NSObject *arg2 = args[2];
#if ABI38_0_0RCT_DEBUG
    if (!ABI38_0_0RCTValidateTypeOfViewCommandArgument(arg2, [NSNumber class], @"boolean", @"ScrollView", commandName, @"3rd")) {
      return;
    }
#endif
  ...
  if ([commandName isEqualToString:@"scrollToEnd"]) {
    ...
    NSObject *arg0 = args[0];
#if ABI38_0_0RCT_DEBUG
    if (!ABI38_0_0RCTValidateTypeOfViewCommandArgument(arg0, [NSNumber class], @"boolean", @"ScrollView", commandName, @"1st")) {
      return;
    }
#endif
