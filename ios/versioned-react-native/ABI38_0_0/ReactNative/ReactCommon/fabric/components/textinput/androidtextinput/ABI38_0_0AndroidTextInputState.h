...
class AndroidTextInputState final {
 public:
  ...
  /*
   * All content of <TextInput> component represented as an `AttributedString`.
   * This stores the previous computed *from the ABI38_0_0React tree*. This usually
   ...
   */
  AttributedString ABI38_0_0ReactTreeAttributedString{};
  ...
  AndroidTextInputState(
      ...
      AttributedString const &ABI38_0_0ReactTreeAttributedString,
      ...
      : mostRecentEventCount(mostRecentEventCount),
        attributedString(attributedString),
        ABI38_0_0ReactTreeAttributedString(ABI38_0_0ReactTreeAttributedString),
        paragraphAttributes(paragraphAttributes),
  ...
  AndroidTextInputState(
      ...
      : mostRecentEventCount((int64_t)data["mostRecentEventCount"].getInt()),
        attributedString(updateAttributedString(
            ...
            data)),
        ABI38_0_0ReactTreeAttributedString(previousState.ABI38_0_0ReactTreeAttributedString),
