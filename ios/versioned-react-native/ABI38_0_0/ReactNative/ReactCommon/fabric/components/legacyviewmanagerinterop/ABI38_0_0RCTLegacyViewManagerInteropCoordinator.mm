...
#include <ABI38_0_0React/ABI38_0_0RCTBridge+Private.h>
#include <ABI38_0_0React/ABI38_0_0RCTBridgeMethod.h>
#include <ABI38_0_0React/ABI38_0_0RCTComponentData.h>
#include <ABI38_0_0React/ABI38_0_0RCTFollyConvert.h>
#include <ABI38_0_0React/ABI38_0_0RCTModuleData.h>
#include <ABI38_0_0React/ABI38_0_0RCTUIManager.h>
#include <ABI38_0_0React/ABI38_0_0RCTUIManagerUtils.h>
#include <ABI38_0_0React/ABI38_0_0RCTUtils.h>
#include <folly/json.h>

using namespace ABI38_0_0facebook::ABI38_0_0React;

@implementation ABI38_0_0RCTLegacyViewManagerInteropCoordinator {
  ABI38_0_0RCTComponentData *_componentData;
  ABI38_0_0RCTBridge *_bridge;
  /*
   Each instnace of `ABI38_0_0RCTLegacyViewManagerInteropComponentView` registers a block to which events are dispatched.
...
- (instancetype)initWithComponentData:(ABI38_0_0RCTComponentData *)componentData bridge:(ABI38_0_0RCTBridge *)bridge;
{
  if (self = [super init]) {
    ...
    _componentData.eventInterceptor = ^(NSString *eventName, NSDictionary *event, NSNumber *ABI38_0_0ReactTag) {
      __typeof(self) strongSelf = weakSelf;
      InterceptorBlock block = [strongSelf->_eventInterceptors objectForKey:ABI38_0_0ReactTag];
      if (block) {
        block(std::string([ABI38_0_0RCTNormalizeInputEventName(eventName) UTF8String]), convertIdToFollyDynamic(event));
      }
    };
  }
  return self;
...
{
  return ABI38_0_0RCTDropABI38_0_0ReactPrefixes(_componentData.name);
}

- (void)handleCommand:(NSString *)commandName args:(NSArray *)args ABI38_0_0ReactTag:(NSInteger)tag
{
  Class managerClass = _componentData.managerClass;
  ABI38_0_0RCTModuleData *moduleData = [_bridge.batchedBridge moduleDataForName:ABI38_0_0RCTBridgeModuleNameForClass(managerClass)];
  ...
  if ([commandName isKindOfClass:[NSNumber class]]) {
    ...
    if (method == nil) {
      ABI38_0_0RCTLogError(@"No command found with name \"%@\"", commandName);
    }
  } else {
  ...
  [_bridge.batchedBridge
      dispatchBlock:^{
        ...
        [self->_bridge.uiManager setNeedsLayout];
              ...
              queue:ABI38_0_0RCTGetUIManagerQueue()];
}
