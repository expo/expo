 ...
 */
@interface ABI38_0_0RCTSurfacePresenterBridgeAdapter : NSObject

- (instancetype)initWithBridge:(ABI38_0_0RCTBridge *)bridge
              contextContainer:(ABI38_0_0facebook::ABI38_0_0React::ContextContainer::Shared)contextContainer;

/*
 * Returns a stored instance of Surface Presenter which is managed by a bridge.
 */
@property (nonatomic, readonly) ABI38_0_0RCTSurfacePresenter *surfacePresenter;
