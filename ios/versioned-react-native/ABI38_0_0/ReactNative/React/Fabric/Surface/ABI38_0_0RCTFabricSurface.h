...
@class ABI38_0_0RCTSurfacePresenter;
@protocol ABI38_0_0RCTSurfaceDelegate;

/**
 * (This is Fabric-compatible ABI38_0_0RCTSurface implementation.)
 *
 ...
 * The starting process includes initializing all underlying ABI38_0_0React Native
 * infrastructure and running ABI38_0_0React app.
...
@interface ABI38_0_0RCTFabricSurface (Internal)
...
@interface ABI38_0_0RCTFabricSurface (Deprecated)
