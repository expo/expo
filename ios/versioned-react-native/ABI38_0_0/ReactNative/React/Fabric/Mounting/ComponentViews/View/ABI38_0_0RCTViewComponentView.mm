...
#import <ABI38_0_0React/components/view/ViewComponentDescriptor.h>
...
@implementation ABI38_0_0RCTViewComponentView {
...
- (void)layoutSubviews
{
  ...
  if (_contentView) {
    _contentView.frame = ABI38_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
  }
}
...
{
  ABI38_0_0RCTAssert(
      self == [ABI38_0_0RCTViewComponentView class],
      @"`+[ABI38_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented for all subclasses (and `%@` particularly).",
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  ABI38_0_0RCTAssert(
      propsRawPtr &&
          ([self class] == [ABI38_0_0RCTViewComponentView class] ||
           typeid(*propsRawPtr).hash_code() != typeid(ViewProps const).hash_code()),
      @"`ABI38_0_0RCTViewComponentView` subclasses (and `%@` particularly) must setup `_props`"
  ...
  if (oldViewProps.backgroundColor != newViewProps.backgroundColor) {
    self.backgroundColor = ABI38_0_0RCTUIColorFromSharedColor(newViewProps.backgroundColor);
    needsInvalidateLayer = YES;
  }

  // `foregroundColor`
  if (oldViewProps.foregroundColor != newViewProps.foregroundColor) {
    self.foregroundColor = ABI38_0_0RCTUIColorFromSharedColor(newViewProps.foregroundColor);
  }

  // `shadowColor`
  if (oldViewProps.shadowColor != newViewProps.shadowColor) {
    CGColorRef shadowColor = ABI38_0_0RCTCGColorRefFromSharedColor(newViewProps.shadowColor);
  ...
  if (oldViewProps.shadowOffset != newViewProps.shadowOffset) {
    self.layer.shadowOffset = ABI38_0_0RCTCGSizeFromSize(newViewProps.shadowOffset);
    needsInvalidateLayer = YES;
  }
  ...
  if (oldViewProps.transform != newViewProps.transform) {
    self.layer.transform = ABI38_0_0RCTCATransform3DFromTransformMatrix(newViewProps.transform);
    self.layer.allowsEdgeAntialiasing = newViewProps.transform != Transform::Identity();
  }

  // `hitSlop`
  if (oldViewProps.hitSlop != newViewProps.hitSlop) {
    self.hitTestEdgeInsets = ABI38_0_0RCTUIEdgeInsetsFromEdgeInsets(newViewProps.hitSlop);
  }
  ...
  if (oldViewProps.nativeId != newViewProps.nativeId) {
    self.nativeId = ABI38_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.nativeId);
  }
  ...
  if (oldViewProps.accessibilityLabel != newViewProps.accessibilityLabel) {
    self.accessibilityElement.accessibilityLabel = ABI38_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityLabel);
  }

  // `accessibilityHint`
  if (oldViewProps.accessibilityHint != newViewProps.accessibilityHint) {
    self.accessibilityElement.accessibilityHint = ABI38_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityHint);
  }
  ...
  if (oldViewProps.accessibilityTraits != newViewProps.accessibilityTraits) {
    self.accessibilityElement.accessibilityTraits =
        ABI38_0_0RCTUIAccessibilityTraitsFromAccessibilityTraits(newViewProps.accessibilityTraits);
  }
...
static ABI38_0_0RCTCornerRadii ABI38_0_0RCTCornerRadiiFromBorderRadii(BorderRadii borderRadii)
{
  return ABI38_0_0RCTCornerRadii{.topLeft = (CGFloat)borderRadii.topLeft,
...
static ABI38_0_0RCTBorderColors ABI38_0_0RCTBorderColorsFromBorderColors(BorderColors borderColors)
{
  return ABI38_0_0RCTBorderColors{.left = ABI38_0_0RCTCGColorRefUnretainedFromSharedColor(borderColors.left),
                         .top = ABI38_0_0RCTCGColorRefUnretainedFromSharedColor(borderColors.top),
                         .bottom = ABI38_0_0RCTCGColorRefUnretainedFromSharedColor(borderColors.bottom),
                         .right = ABI38_0_0RCTCGColorRefUnretainedFromSharedColor(borderColors.right)};
}

static ABI38_0_0RCTBorderStyle ABI38_0_0RCTBorderStyleFromBorderStyle(BorderStyle borderStyle)
{
  switch (borderStyle) {
    case BorderStyle::Solid:
      return ABI38_0_0RCTBorderStyleSolid;
    case BorderStyle::Dotted:
      return ABI38_0_0RCTBorderStyleDotted;
    case BorderStyle::Dashed:
      return ABI38_0_0RCTBorderStyleDashed;
  }
}
...
- (void)invalidateLayer
{
  ...
  if (layerHasShadow) {
    if (CGColorGetAlpha(_backgroundColor.CGColor) > 0.999) {
      ...
      ABI38_0_0RCTCornerInsets const cornerInsets =
          ABI38_0_0RCTGetCornerInsets(ABI38_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero);
      CGPathRef shadowPath = ABI38_0_0RCTPathCreateWithRoundedRect(self.bounds, cornerInsets, nil);
  ...
  if (useCoreAnimationBorderRendering) {
    ...
    CGColorRef borderColor = ABI38_0_0RCTCGColorRefFromSharedColor(borderMetrics.borderColors.left);
    ...
    UIImage *image = ABI38_0_0RCTGetBorderImage(
        ABI38_0_0RCTBorderStyleFromBorderStyle(borderMetrics.borderStyles.left),
        layer.bounds.size,
        ABI38_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii),
        ABI38_0_0RCTUIEdgeInsetsFromEdgeInsets(borderMetrics.borderWidths),
        ABI38_0_0RCTBorderColorsFromBorderColors(borderMetrics.borderColors),
    ...
    if (self.clipsToBounds) {
      if (borderMetrics.borderRadii.isUniform()) {
        ...
        CGPathRef path = ABI38_0_0RCTPathCreateWithRoundedRect(
            self.bounds,
            ABI38_0_0RCTGetCornerInsets(ABI38_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero),
            nil);
...
- (NSArray<UIAccessibilityCustomAction *> *)accessibilityCustomActions
{
  ...
  for (auto const &accessibilityAction : accessibilityActions) {
    [customActions
        addObject:[[UIAccessibilityCustomAction alloc] initWithName:ABI38_0_0RCTNSStringFromString(accessibilityAction)
                                                             target:self
...
- (BOOL)didActivateAccessibilityCustomAction:(UIAccessibilityCustomAction *)action
{
  if (_eventEmitter && _props->onAccessibilityAction) {
    _eventEmitter->onAccessibilityAction(ABI38_0_0RCTStringFromNSString(action.name));
    return YES;
  } else {
    return NO;
  }
...
{
  return ABI38_0_0RCTNSStringFromString([[self class] componentDescriptorProvider].name);
}
