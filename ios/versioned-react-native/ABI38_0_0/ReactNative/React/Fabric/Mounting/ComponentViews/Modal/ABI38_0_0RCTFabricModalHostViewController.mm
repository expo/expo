...
@implementation ABI38_0_0RCTFabricModalHostViewController {
  CGRect _lastViewBounds;
  ABI38_0_0RCTSurfaceTouchHandler *_touchHandler;
}
...
{
  return [ABI38_0_0RCTSharedApplication() statusBarStyle];
}
...
{
  return [ABI38_0_0RCTSharedApplication() isStatusBarHidden];
}
...
- (UIInterfaceOrientationMask)supportedInterfaceOrientations
{
  UIInterfaceOrientationMask appSupportedOrientationsMask =
      [ABI38_0_0RCTSharedApplication() supportedInterfaceOrientationsForWindow:[ABI38_0_0RCTSharedApplication() keyWindow]];
