 ...
 * which are not directly related to ABI38_0_0React Native.
 */
@interface ABI38_0_0RCTEnhancedScrollView : UIScrollView
 ...
 */
@property (nonatomic, strong, readonly) ABI38_0_0RCTGenericDelegateSplitter<id<UIScrollViewDelegate>> *delegateSplitter;
