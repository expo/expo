...
#import <ABI38_0_0React/components/slider/SliderComponentDescriptor.h>
#import <ABI38_0_0React/components/slider/SliderLocalData.h>

using namespace ABI38_0_0facebook::ABI38_0_0React;

@interface ABI38_0_0RCTSliderComponentView () <ABI38_0_0RCTImageResponseDelegate>
@end

@implementation ABI38_0_0RCTSliderComponentView {
  ...
  ABI38_0_0RCTImageResponseObserverProxy _trackImageResponseObserverProxy;
  ABI38_0_0RCTImageResponseObserverProxy _minimumTrackImageResponseObserverProxy;
  ABI38_0_0RCTImageResponseObserverProxy _maximumTrackImageResponseObserverProxy;
  ABI38_0_0RCTImageResponseObserverProxy _thumbImageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _trackImageResponseObserverProxy = ABI38_0_0RCTImageResponseObserverProxy(self);
    _minimumTrackImageResponseObserverProxy = ABI38_0_0RCTImageResponseObserverProxy(self);
    _maximumTrackImageResponseObserverProxy = ABI38_0_0RCTImageResponseObserverProxy(self);
    _thumbImageResponseObserverProxy = ABI38_0_0RCTImageResponseObserverProxy(self);
