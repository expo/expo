...
@interface ABI38_0_0RCTSwitchComponentView () <ABI38_0_0RCTSwitchViewProtocol>
@end

@implementation ABI38_0_0RCTSwitchComponentView {
...
{
  ABI38_0_0RCTSwitchHandleCommand(self, commandName, args);
}
