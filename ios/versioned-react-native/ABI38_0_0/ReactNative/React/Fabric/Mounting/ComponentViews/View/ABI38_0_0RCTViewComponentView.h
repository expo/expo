...
#import <ABI38_0_0React/ABI38_0_0RCTTouchableComponentViewProtocol.h>
#import <ABI38_0_0React/ABI38_0_0UIView+ComponentViewProtocol.h>
#import <ABI38_0_0React/components/view/ViewEventEmitter.h>
#import <ABI38_0_0React/components/view/ViewProps.h>
#import <ABI38_0_0React/core/EventEmitter.h>
#import <ABI38_0_0React/core/LayoutMetrics.h>
#import <ABI38_0_0React/core/Props.h>
 ...
 */
@interface ABI38_0_0RCTViewComponentView : UIView <ABI38_0_0RCTComponentViewProtocol, ABI38_0_0RCTTouchableComponentViewProtocol> {
 @protected
  ABI38_0_0facebook::ABI38_0_0React::LayoutMetrics _layoutMetrics;
  ABI38_0_0facebook::ABI38_0_0React::SharedViewProps _props;
  ABI38_0_0facebook::ABI38_0_0React::SharedViewEventEmitter _eventEmitter;
}
...
/**
 * Enforcing `call super` semantic for overridden methods from `ABI38_0_0RCTComponentViewProtocol`.
 * The methods update the instance variables.
 */
- (void)updateProps:(ABI38_0_0facebook::ABI38_0_0React::Props::Shared const &)props
           oldProps:(ABI38_0_0facebook::ABI38_0_0React::Props::Shared const &)oldProps NS_REQUIRES_SUPER;
- (void)updateEventEmitter:(ABI38_0_0facebook::ABI38_0_0React::EventEmitter::Shared const &)eventEmitter NS_REQUIRES_SUPER;
- (void)updateLayoutMetrics:(ABI38_0_0facebook::ABI38_0_0React::LayoutMetrics const &)layoutMetrics
           oldLayoutMetrics:(ABI38_0_0facebook::ABI38_0_0React::LayoutMetrics const &)oldLayoutMetrics NS_REQUIRES_SUPER;
- (void)finalizeUpdates:(ABI38_0_0RNComponentViewUpdateMask)updateMask NS_REQUIRES_SUPER;
