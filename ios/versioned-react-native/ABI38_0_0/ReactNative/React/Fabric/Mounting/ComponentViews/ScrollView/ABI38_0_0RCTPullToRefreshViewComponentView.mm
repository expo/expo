...
#import <ABI38_0_0React/components/rncore/ABI38_0_0RCTComponentViewHelpers.h>

#import <ABI38_0_0React/ABI38_0_0RCTConversions.h>
#import <ABI38_0_0React/ABI38_0_0RCTRefreshableProtocol.h>
#import <ABI38_0_0React/ABI38_0_0RCTScrollViewComponentView.h>

using namespace ABI38_0_0facebook::ABI38_0_0React;

@interface ABI38_0_0RCTPullToRefreshViewComponentView () <ABI38_0_0RCTPullToRefreshViewViewProtocol, ABI38_0_0RCTRefreshableProtocol>
@end

@implementation ABI38_0_0RCTPullToRefreshViewComponentView {
  UIRefreshControl *_refreshControl;
  ABI38_0_0RCTScrollViewComponentView *_scrollViewComponentView;
}
...
- (void)_updateTitle
{
  ...
  if (concreteProps.titleColor) {
    attributes[NSForegroundColorAttributeName] = ABI38_0_0RCTUIColorFromSharedColor(concreteProps.titleColor);
  }

  _refreshControl.attributedTitle =
      [[NSAttributedString alloc] initWithString:ABI38_0_0RCTNSStringFromString(concreteProps.title) attributes:attributes];
}
...
- (void)_attach
{
  ...
  _scrollViewComponentView = [ABI38_0_0RCTScrollViewComponentView findScrollViewComponentViewForView:self];
  if (!_scrollViewComponentView) {
    return;
  }
...
{
  ABI38_0_0RCTPullToRefreshViewHandleCommand(self, commandName, args);
}
...
#pragma mark - ABI38_0_0RCTRefreshableProtocol
