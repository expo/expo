 ...
 */
@protocol ABI38_0_0RCTMountingManagerDelegate <NSObject>
 ...
 */
- (void)mountingManager:(ABI38_0_0RCTMountingManager *)mountingManager willMountComponentsWithRootTag:(ABI38_0_0ReactTag)MountingManager;
