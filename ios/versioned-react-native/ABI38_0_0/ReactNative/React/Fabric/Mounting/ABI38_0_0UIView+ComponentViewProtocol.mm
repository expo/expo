...
#import "ABI38_0_0UIView+ComponentViewProtocol.h"
...
{
  ABI38_0_0RCTAssert(NO, @"`-[ABI38_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented in a concrete class.");
  return {};
}
...
{
  ABI38_0_0RCTAssert(childComponentView.superview == self, @"Attempt to unmount improperly mounted component view.");
           ...
           oldLayoutMetrics:(LayoutMetrics const &)oldLayoutMetrics
{
  if (layoutMetrics.frame != oldLayoutMetrics.frame) {
    CGRect frame = ABI38_0_0RCTCGRectFromRect(layoutMetrics.frame);
...
{
  ABI38_0_0RCTAssert(NO, @"props access should be implemented by ABI38_0_0RCTViewComponentView.");
  return nullptr;
}
