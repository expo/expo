...
#import <ABI38_0_0React/core/State.h>
 ...
 */
typedef NS_OPTIONS(NSInteger, ABI38_0_0RNComponentViewUpdateMask) {
  ABI38_0_0RNComponentViewUpdateMaskNone = 0,
  ABI38_0_0RNComponentViewUpdateMaskProps = 1 << 0,
  ABI38_0_0RNComponentViewUpdateMaskEventEmitter = 1 << 1,
  ABI38_0_0RNComponentViewUpdateMaskLocalData = 1 << 2,
  ABI38_0_0RNComponentViewUpdateMaskState = 1 << 3,
  ABI38_0_0RNComponentViewUpdateMaskLayoutMetrics = 1 << 4,

  ABI38_0_0RNComponentViewUpdateMaskAll = ABI38_0_0RNComponentViewUpdateMaskProps | ABI38_0_0RNComponentViewUpdateMaskEventEmitter |
      ABI38_0_0RNComponentViewUpdateMaskLocalData | ABI38_0_0RNComponentViewUpdateMaskState | ABI38_0_0RNComponentViewUpdateMaskLayoutMetrics
};

/*
 * Represents a `UIView` instance managed by ABI38_0_0React.
 * All methods are non-@optional.
 * `UIView+ComponentViewProtocol` category provides default implementation
 * for all of them.
 */
@protocol ABI38_0_0RCTComponentViewProtocol <NSObject>

/*
 * Returns a `ComponentDescriptorProvider` of a particular `ComponentDescriptor` which this component view
 * represents.
 */
+ (ABI38_0_0facebook::ABI38_0_0React::ComponentDescriptorProvider)componentDescriptorProvider;
