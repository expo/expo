...
#import <ABI38_0_0React/components/view/AccessibilityPrimitives.h>
#import <ABI38_0_0React/components/view/primitives.h>
#import <ABI38_0_0React/graphics/Color.h>
#import <ABI38_0_0React/graphics/Geometry.h>
#import <ABI38_0_0React/graphics/Transform.h>

NS_ASSUME_NONNULL_BEGIN

inline NSString *ABI38_0_0RCTNSStringFromString(const std::string &string, const NSStringEncoding &encoding = NSUTF8StringEncoding) {
  return [NSString stringWithCString:string.c_str() encoding:encoding];
}

inline NSString *_Nullable ABI38_0_0RCTNSStringFromStringNilIfEmpty(const std::string &string, const NSStringEncoding &encoding = NSUTF8StringEncoding) {
  return string.empty() ? nil : ABI38_0_0RCTNSStringFromString(string, encoding);
}

inline std::string ABI38_0_0RCTStringFromNSString(NSString *string, const NSStringEncoding &encoding = NSUTF8StringEncoding) {
  return [string cStringUsingEncoding:encoding];
}

inline UIColor *_Nullable ABI38_0_0RCTUIColorFromSharedColor(const ABI38_0_0facebook::ABI38_0_0React::SharedColor &sharedColor) {
  return sharedColor ? [UIColor colorWithCGColor:sharedColor.get()] : nil;
}

inline CF_RETURNS_NOT_RETAINED CGColorRef ABI38_0_0RCTCGColorRefUnretainedFromSharedColor(const ABI38_0_0facebook::ABI38_0_0React::SharedColor &sharedColor) {
  return sharedColor ? sharedColor.get() : nil;
}

inline CF_RETURNS_RETAINED CGColorRef ABI38_0_0RCTCGColorRefFromSharedColor(const ABI38_0_0facebook::ABI38_0_0React::SharedColor &sharedColor) {
  return sharedColor ? CGColorCreateCopy(sharedColor.get()) : nil;
}

inline CGPoint ABI38_0_0RCTCGPointFromPoint(const ABI38_0_0facebook::ABI38_0_0React::Point &point) {
  return {point.x, point.y};
}

inline CGSize ABI38_0_0RCTCGSizeFromSize(const ABI38_0_0facebook::ABI38_0_0React::Size &size) {
  return {size.width, size.height};
}

inline CGRect ABI38_0_0RCTCGRectFromRect(const ABI38_0_0facebook::ABI38_0_0React::Rect &rect) {
  return {ABI38_0_0RCTCGPointFromPoint(rect.origin), ABI38_0_0RCTCGSizeFromSize(rect.size)};
}

inline UIEdgeInsets ABI38_0_0RCTUIEdgeInsetsFromEdgeInsets(const ABI38_0_0facebook::ABI38_0_0React::EdgeInsets &edgeInsets) {
  return {edgeInsets.top, edgeInsets.left, edgeInsets.bottom, edgeInsets.right};
}

inline UIAccessibilityTraits ABI38_0_0RCTUIAccessibilityTraitsFromAccessibilityTraits(ABI38_0_0facebook::ABI38_0_0React::AccessibilityTraits accessibilityTraits) {
  using AccessibilityTraits = ABI38_0_0facebook::ABI38_0_0React::AccessibilityTraits;
...
inline CATransform3D ABI38_0_0RCTCATransform3DFromTransformMatrix(const ABI38_0_0facebook::ABI38_0_0React::Transform &transformMatrix) {
  return {
...
inline ABI38_0_0facebook::ABI38_0_0React::Point ABI38_0_0RCTPointFromCGPoint(const CGPoint &point) {
  return {point.x, point.y};
}

inline ABI38_0_0facebook::ABI38_0_0React::Size ABI38_0_0RCTSizeFromCGSize(const CGSize &size) {
  return {size.width, size.height};
}

inline ABI38_0_0facebook::ABI38_0_0React::Rect ABI38_0_0RCTRectFromCGRect(const CGRect &rect) {
  return {ABI38_0_0RCTPointFromCGPoint(rect.origin), ABI38_0_0RCTSizeFromCGSize(rect.size)};
}

inline ABI38_0_0facebook::ABI38_0_0React::EdgeInsets ABI38_0_0RCTEdgeInsetsFromUIEdgeInsets(const UIEdgeInsets &edgeInsets) {
