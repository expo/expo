...
static NSURL *getInspectorDeviceUrl(NSURL *bundleURL)
{
  ...
  NSString *inspectorProxyPortStr = [[[NSProcessInfo processInfo] environment] objectForKey:@"ABI38_0_0RCT_METRO_PORT"];
...
static NSURL *getAttachDeviceUrl(NSURL *bundleURL, NSString *title)
{
  ...
  NSString *metroBundlerPortStr = [[[NSProcessInfo processInfo] environment] objectForKey:@"ABI38_0_0RCT_METRO_PORT"];
...
@implementation ABI38_0_0RCTInspectorDevServerHelper

ABI38_0_0RCT_NOT_IMPLEMENTED(-(instancetype)init)

static NSMutableDictionary<NSString *, ABI38_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
...
+ (ABI38_0_0RCTInspectorPackagerConnection *)connectWithBundleURL:(NSURL *)bundleURL
{
  ...
  ABI38_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection || !connection.isConnected) {
    connection = [[ABI38_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
