...
typedef uint32_t ABI38_0_0RCTHandlerToken;
typedef void (^ABI38_0_0RCTNotificationHandler)(NSDictionary<NSString *, id> *);
typedef void (^ABI38_0_0RCTRequestHandler)(NSDictionary<NSString *, id> *, ABI38_0_0RCTPackagerClientResponder *);
typedef void (^ABI38_0_0RCTConnectedHandler)(void);

/** Encapsulates singleton connection to ABI38_0_0React Native packager. */
@interface ABI38_0_0RCTPackagerConnection : NSObject
 ...
 */
- (ABI38_0_0RCTHandlerToken)addNotificationHandler:(ABI38_0_0RCTNotificationHandler)handler
 ...
 */
- (ABI38_0_0RCTHandlerToken)addRequestHandler:(ABI38_0_0RCTRequestHandler)handler
                               queue:(dispatch_queue_t)queue
                           forMethod:(NSString *)method;
 ...
 */
- (ABI38_0_0RCTHandlerToken)addConnectedHandler:(ABI38_0_0RCTConnectedHandler)handler
                                 queue:(dispatch_queue_t)queue;
