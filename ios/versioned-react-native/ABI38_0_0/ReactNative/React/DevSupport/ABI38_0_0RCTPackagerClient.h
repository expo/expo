...
@class ABI38_0_0RCTPackagerClientResponder;
...
extern const int ABI38_0_0RCT_PACKAGER_CLIENT_PROTOCOL_VERSION;

#if defined(__cplusplus)
}
#endif

@protocol ABI38_0_0RCTPackagerClientMethod <NSObject>

- (void)handleRequest:(NSDictionary<NSString *, id> *)params withResponder:(ABI38_0_0RCTPackagerClientResponder *)responder;
...
@interface ABI38_0_0RCTPackagerClientResponder : NSObject
