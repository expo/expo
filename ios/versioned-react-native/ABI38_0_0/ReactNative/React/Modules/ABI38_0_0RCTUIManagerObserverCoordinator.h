...
typedef dispatch_block_t ABI38_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI38_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ABI38_0_0React-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI38_0_0RCTUIManager's observers.
 */
@interface ABI38_0_0RCTUIManagerObserverCoordinator : NSObject <ABI38_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI38_0_0RCTUIManagerObserver` protocol for more info.
