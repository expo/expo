...
#import "ABI38_0_0RCTRedBoxExtraDataViewController.h"

@interface ABI38_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI38_0_0RCTRedBoxExtraDataCell
...
@interface ABI38_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI38_0_0RCTRedBoxExtraDataViewController
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ABI38_0_0RCTRedBoxExtraDataCell *cell =
            (ABI38_0_0RCTRedBoxExtraDataCell *)[tableView
            dequeueReusableCellWithIdentifier:reuseIdentifier];

    if (cell == nil) {
        cell = [[ABI38_0_0RCTRedBoxExtraDataCell alloc]
