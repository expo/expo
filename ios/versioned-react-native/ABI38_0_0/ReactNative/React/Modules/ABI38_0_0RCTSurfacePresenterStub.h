...
// TODO: Eventually this should go away and files should just include ABI38_0_0RCTSurfacePresenter.h, but
...
@protocol ABI38_0_0RCTSurfacePresenterObserver <NSObject>
...
@protocol ABI38_0_0RCTSurfacePresenterStub <NSObject>
...
@interface ABI38_0_0RCTBridge (ABI38_0_0RCTSurfacePresenterStub)

- (id<ABI38_0_0RCTSurfacePresenterStub>)surfacePresenter;
- (void)setSurfacePresenter:(id<ABI38_0_0RCTSurfacePresenterStub>)presenter;
