...
#import <ABI38_0_0cxxreact/ABI38_0_0JSBigString.h>
...
class ABI38_0_0RCTObjcExecutor : public JSExecutor {
public:
  ABI38_0_0RCTObjcExecutor(id<ABI38_0_0RCTJavaScriptExecutor> jse,
                  ABI38_0_0RCTJavaScriptCompleteBlock errorBlock,
  ...
  void setBundleRegistry(std::unique_ptr<RAMBundleRegistry>) override {
    ABI38_0_0RCTAssert(NO, @"RAM bundles are not supported in ABI38_0_0RCTObjcExecutor");
  }
...
private:
  ...
  ABI38_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI38_0_0RCTObjcExecutorFactory::ABI38_0_0RCTObjcExecutorFactory(
  id<ABI38_0_0RCTJavaScriptExecutor> jse, ABI38_0_0RCTJavaScriptCompleteBlock errorBlock)
  : m_jse(jse)
  , m_errorBlock(errorBlock) {}

std::unique_ptr<JSExecutor> ABI38_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue) {
  return std::unique_ptr<JSExecutor>(
    new ABI38_0_0RCTObjcExecutor(m_jse, m_errorBlock, jsQueue, delegate));
}
