...
#import "ABI38_0_0RCTUIUtils.h"

#import "ABI38_0_0RCTUtils.h"

ABI38_0_0RCTDimensions ABI38_0_0RCTGetDimensions(CGFloat fontScale)
{
  UIScreen *mainScreen = UIScreen.mainScreen;
  CGSize screenSize = mainScreen.bounds.size;

  UIView *mainWindow;
  mainWindow = ABI38_0_0RCTKeyWindow();
  CGSize windowSize = mainWindow.bounds.size;

  ABI38_0_0RCTDimensions result;
...
CGFloat ABI38_0_0RCTGetMultiplierForContentSizeCategory(UIContentSizeCategory category)
{
