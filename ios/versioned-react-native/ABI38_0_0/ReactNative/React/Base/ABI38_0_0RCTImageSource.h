 ...
 */
@interface ABI38_0_0RCTImageSource : NSObject
...
@interface ABI38_0_0RCTConvert (ImageSource)

+ (ABI38_0_0RCTImageSource *)ABI38_0_0RCTImageSource:(id)json;
+ (NSArray<ABI38_0_0RCTImageSource *> *)ABI38_0_0RCTImageSourceArray:(id)json;
