...
@interface ABI38_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>

@end

@implementation ABI38_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI38_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI38_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI38_0_0RCTMultipartStreamReader *reader = [[ABI38_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI38_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
