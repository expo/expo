...
@protocol ABI38_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI38_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI38_0_0RCTBridgeModules automatically, however
 ...
 * previously called ABI38_0_0facebook::ABI38_0_0React::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI38_0_0RCTBridge *)bridge;
...
*/
- (BOOL)bridge:(ABI38_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI38_0_0RCTBridge *)bridge
                 onProgress:(ABI38_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI38_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI38_0_0RCTBridge *)bridge
                  withBlock:(ABI38_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Retrieve the list of lazy-native-modules names for the given bridge.
 */
- (NSDictionary<NSString *, Class> *)extraLazyModuleClassesForBridge:(ABI38_0_0RCTBridge *)bridge;
