...
typedef id<ABI38_0_0RCTBridgeModule>(^ABI38_0_0RCTBridgeModuleProvider)(void);

@interface ABI38_0_0RCTModuleData : NSObject <ABI38_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI38_0_0RCTBridgeMethod>> *methods;

/**
 * Returns a map of the module methods. Note that this will gather the methods the first
 * time it is called and then memoize the results.
 */
@property (nonatomic, copy, readonly) NSDictionary<NSString *, id<ABI38_0_0RCTBridgeMethod>> *methodsByName;
 ...
 */
@property (nonatomic, strong, readwrite) id<ABI38_0_0RCTBridgeModule> instance;
