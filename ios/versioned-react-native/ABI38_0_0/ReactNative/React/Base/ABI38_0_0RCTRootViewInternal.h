 ...
 * classes to change the ABI38_0_0RCTRootViews's internal state.
 */
@interface ABI38_0_0RCTRootView ()

/**
 * This setter should be used only by ABI38_0_0RCTUIManager on ABI38_0_0React root view
...
@property (nonatomic, strong) UIView *ABI38_0_0ReactPreferredFocusedView;
#endif
