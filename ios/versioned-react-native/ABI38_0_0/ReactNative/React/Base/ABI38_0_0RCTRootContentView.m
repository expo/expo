...
@implementation ABI38_0_0RCTRootContentView

- (instancetype)initWithFrame:(CGRect)frame
                       bridge:(ABI38_0_0RCTBridge *)bridge
                     ABI38_0_0ReactTag:(NSNumber *)ABI38_0_0ReactTag
               sizeFlexiblity:(ABI38_0_0RCTRootViewSizeFlexibility)sizeFlexibility
{
  if ((self = [super initWithFrame:frame])) {
    _bridge = bridge;
    self.ABI38_0_0ReactTag = ABI38_0_0ReactTag;
...
ABI38_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithCoder:(nonnull NSCoder *)aDecoder)
...
- (CGSize)availableSize
{
  ...
  return CGSizeMake(
      _sizeFlexibility & ABI38_0_0RCTRootViewSizeFlexibilityWidth ? INFINITY : size.width,
      _sizeFlexibility & ABI38_0_0RCTRootViewSizeFlexibilityHeight ? INFINITY : size.height
    );
}

- (void)updateAvailableSize
{
  if (!self.ABI38_0_0ReactTag || !_bridge.isValid) {
    return;
  }
...
- (void)invalidate
{
  if (self.userInteractionEnabled) {
    ...
    [(ABI38_0_0RCTRootView *)self.superview contentViewInvalidated];

    [_bridge enqueueJSCall:@"AppRegistry"
                    method:@"unmountApplicationComponentAtRootTag"
                      args:@[self.ABI38_0_0ReactTag]
                completion:NULL];
  }
}
