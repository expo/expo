...
@implementation ABI38_0_0RCTSurfaceHostingView {
...
{
  return [[ABI38_0_0RCTSurface alloc] initWithBridge:bridge moduleName:moduleName initialProperties:initialProperties];
}
...
- (instancetype)initWithSurface:(ABI38_0_0RCTSurface *)surface sizeMeasureMode:(ABI38_0_0RCTSurfaceSizeMeasureMode)sizeMeasureMode
{
...
- (void)setFrame:(CGRect)frame
{
  ...
  ABI38_0_0RCTSurfaceMinimumSizeAndMaximumSizeFromSizeAndSizeMeasureMode(
    self.bounds.size,
    _sizeMeasureMode,
    &minimumSize,
    &maximumSize
...
{
  if (ABI38_0_0RCTSurfaceStageIsPreparing(_stage)) {
...
- (void)setStage:(ABI38_0_0RCTSurfaceStage)stage
{
  ...
  BOOL shouldInvalidateLayout =
    ABI38_0_0RCTSurfaceStageIsRunning(stage) != ABI38_0_0RCTSurfaceStageIsRunning(_stage) ||
    ABI38_0_0RCTSurfaceStageIsPreparing(stage) != ABI38_0_0RCTSurfaceStageIsPreparing(_stage);
...
- (void)setSizeMeasureMode:(ABI38_0_0RCTSurfaceSizeMeasureMode)sizeMeasureMode
{
...
- (void)setActivityIndicatorViewFactory:(ABI38_0_0RCTSurfaceHostingViewActivityIndicatorViewFactory)activityIndicatorViewFactory
{
...
- (void)traitCollectionDidChange:(UITraitCollection *)previousTraitCollection
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI38_0_0RCTUserInterfaceStyleDidChangeNotification
                                                      object:self
                                                    userInfo:@{
                                                      ABI38_0_0RCTUserInterfaceStyleDidChangeNotificationTraitCollectionKey: self.traitCollection,
                                                    }];
}
...
- (void)_updateViews
{
  self.isSurfaceViewVisible = ABI38_0_0RCTSurfaceStageIsRunning(_stage);
  self.isActivityIndicatorViewVisible = ABI38_0_0RCTSurfaceStageIsPreparing(_stage);
}
...
#pragma mark - ABI38_0_0RCTSurfaceDelegate

- (void)surface:(__unused ABI38_0_0RCTSurface *)surface didChangeStage:(ABI38_0_0RCTSurfaceStage)stage
{
...
- (void)surface:(__unused ABI38_0_0RCTSurface *)surface didChangeIntrinsicSize:(__unused CGSize)intrinsicSize
{
  ABI38_0_0RCTExecuteOnMainQueue(^{
    [self _invalidateLayout];
  });
