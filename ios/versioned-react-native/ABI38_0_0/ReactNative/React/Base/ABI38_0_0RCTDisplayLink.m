...
#import "ABI38_0_0RCTDisplayLink.h"
...
#define ABI38_0_0RCTAssertRunLoop() \
  ABI38_0_0RCTAssert(_runLoop == [NSRunLoop currentRunLoop], \
  @"This method must be called on the CADisplayLink run loop")

@implementation ABI38_0_0RCTDisplayLink
{
  CADisplayLink *_jsDisplayLink;
  NSMutableSet<ABI38_0_0RCTModuleData *> *_frameUpdateObservers;
  NSRunLoop *_runLoop;
}
...
{
  if (![moduleData.moduleClass conformsToProtocol:@protocol(ABI38_0_0RCTFrameUpdateObserver)] ||
  ...
  id<ABI38_0_0RCTFrameUpdateObserver> observer = (id<ABI38_0_0RCTFrameUpdateObserver>)module;
...
{
  ABI38_0_0RCTAssertRunLoop();

  ABI38_0_0RCT_PROFILE_BEGIN_EVENT(ABI38_0_0RCTProfileTagAlways, @"-[ABI38_0_0RCTDisplayLink _jsThreadUpdate:]", nil);

  ABI38_0_0RCTFrameUpdate *frameUpdate = [[ABI38_0_0RCTFrameUpdate alloc] initWithDisplayLink:displayLink];
  for (ABI38_0_0RCTModuleData *moduleData in _frameUpdateObservers) {
    id<ABI38_0_0RCTFrameUpdateObserver> observer = (id<ABI38_0_0RCTFrameUpdateObserver>)moduleData.instance;
    if (!observer.paused) {
  ...
  ABI38_0_0RCTProfileImmediateEvent(ABI38_0_0RCTProfileTagAlways, @"JS Thread Tick", displayLink.timestamp, 'g');

  ABI38_0_0RCT_PROFILE_END_EVENT(ABI38_0_0RCTProfileTagAlways, @"objc_call");
}
