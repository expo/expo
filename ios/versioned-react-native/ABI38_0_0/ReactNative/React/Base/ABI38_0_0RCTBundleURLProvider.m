...
#import "ABI38_0_0RCTBundleURLProvider.h"

#import "ABI38_0_0RCTConvert.h"
#import "ABI38_0_0RCTDefines.h"

NSString *const ABI38_0_0RCTBundleURLProviderUpdatedNotification = @"ABI38_0_0RCTBundleURLProviderUpdatedNotification";

const NSUInteger kABI38_0_0RCTBundleURLProviderDefaultPort = ABI38_0_0RCT_METRO_PORT;

static NSString *const kABI38_0_0RCTJsLocationKey = @"ABI38_0_0RCT_jsLocation";
...
static NSString *const kABI38_0_0RCTEnableLiveReloadKey = @"ABI38_0_0RCT_enableLiveReload_LEGACY";
static NSString *const kABI38_0_0RCTEnableDevKey = @"ABI38_0_0RCT_enableDev";
static NSString *const kABI38_0_0RCTEnableMinificationKey = @"ABI38_0_0RCT_enableMinification";

@implementation ABI38_0_0RCTBundleURLProvider
...
{
  return @{
    kABI38_0_0RCTEnableLiveReloadKey: @NO,
    kABI38_0_0RCTEnableDevKey: @YES,
    kABI38_0_0RCTEnableMinificationKey: @NO,
  };
}

- (void)settingsUpdated
{
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI38_0_0RCTBundleURLProviderUpdatedNotification object:self];
}
...
static NSURL *serverRootWithHostPort(NSString *hostPort)
{
  ...
  return [NSURL URLWithString:
          [NSString stringWithFormat:@"http://%@:%lu/",
           hostPort, (unsigned long)kABI38_0_0RCTBundleURLProviderDefaultPort]];
}
...
- (NSURL *)jsBundleURLForBundleRoot:(NSString *)bundleRoot fallbackURLProvider:(NSURL *(^)(void))fallbackURLProvider
{
  ...
  if (!packagerServerHost) {
    ...
    return [ABI38_0_0RCTBundleURLProvider jsBundleURLForBundleRoot:bundleRoot
...
- (BOOL)enableDev
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI38_0_0RCTEnableDevKey];
}

- (BOOL)enableLiveReload
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI38_0_0RCTEnableLiveReloadKey];
}

- (BOOL)enableMinification
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:kABI38_0_0RCTEnableMinificationKey];
}

- (NSString *)jsLocation
{
  return [[NSUserDefaults standardUserDefaults] stringForKey:kABI38_0_0RCTJsLocationKey];
}

- (void)setEnableDev:(BOOL)enableDev
{
  [self updateValue:@(enableDev) forKey:kABI38_0_0RCTEnableDevKey];
}

- (void)setEnableLiveReload:(BOOL)enableLiveReload
{
  [self updateValue:@(enableLiveReload) forKey:kABI38_0_0RCTEnableLiveReloadKey];
}

- (void)setJsLocation:(NSString *)jsLocation
{
  [self updateValue:jsLocation forKey:kABI38_0_0RCTJsLocationKey];
}

- (void)setEnableMinification:(BOOL)enableMinification
{
  [self updateValue:@(enableMinification) forKey:kABI38_0_0RCTEnableMinificationKey];
}

+ (instancetype)sharedSettings
{
  static ABI38_0_0RCTBundleURLProvider *sharedInstance;
  static dispatch_once_t once_token;
  dispatch_once(&once_token, ^{
    sharedInstance = [ABI38_0_0RCTBundleURLProvider new];
  });
