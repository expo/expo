...
extern NSString *const ABI38_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI38_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI38_0_0RCTBundleURLProvider : NSObject
