...
@interface ABI38_0_0RCTDatePicker ()

@property (nonatomic, copy) ABI38_0_0RCTBubblingEventBlock onChange;
@property (nonatomic, assign) NSInteger ABI38_0_0ReactMinuteInterval;

@end

@implementation ABI38_0_0RCTDatePicker
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if ((self = [super initWithFrame:frame])) {
    ...
    _ABI38_0_0ReactMinuteInterval = 1;
  }
  return self;
}
...
- (void)setDatePickerMode:(UIDatePickerMode)datePickerMode
{
  ...
  self.minuteInterval = _ABI38_0_0ReactMinuteInterval;
}

- (void)setMinuteInterval:(NSInteger)minuteInterval
{
  [super setMinuteInterval:minuteInterval];
  _ABI38_0_0ReactMinuteInterval = minuteInterval;
}
