...
typedef UIFont *(^ABI38_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ABI38_0_0React Native will use the System font for rendering by default. If you want to
 ...
 */
ABI38_0_0RCT_EXTERN void ABI38_0_0RCTSetDefaultFontHandler(ABI38_0_0RCTFontHandler handler);
ABI38_0_0RCT_EXTERN BOOL ABI38_0_0RCTHasFontHandlerSet(void);

@interface ABI38_0_0RCTFont : NSObject
...
@interface ABI38_0_0RCTConvert (ABI38_0_0RCTFont)
