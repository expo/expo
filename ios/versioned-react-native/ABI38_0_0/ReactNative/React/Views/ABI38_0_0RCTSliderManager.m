...
#import "ABI38_0_0RCTSliderManager.h"
...
@implementation ABI38_0_0RCTSliderManager

ABI38_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
  ABI38_0_0RCTSlider *slider = [ABI38_0_0RCTSlider new];
...
static void ABI38_0_0RCTSendSliderEvent(ABI38_0_0RCTSlider *sender, BOOL continuous)
{
...
- (void)sliderValueChanged:(ABI38_0_0RCTSlider *)sender
{
  ABI38_0_0RCTSendSliderEvent(sender, YES);
}

- (void)sliderTouchEnd:(ABI38_0_0RCTSlider *)sender
{
  ABI38_0_0RCTSendSliderEvent(sender, NO);
}
...
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(onValueChange, ABI38_0_0RCTBubblingEventBlock);
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(onSlidingComplete, ABI38_0_0RCTDirectEventBlock);
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(thumbTintColor, UIColor);
ABI38_0_0RCT_EXPORT_VIEW_PROPERTY(thumbImage, UIImage);
ABI38_0_0RCT_CUSTOM_VIEW_PROPERTY(disabled, BOOL, ABI38_0_0RCTSlider)
{
  if (json) {
