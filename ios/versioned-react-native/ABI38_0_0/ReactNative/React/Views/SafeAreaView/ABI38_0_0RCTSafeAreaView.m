...
#import "ABI38_0_0RCTSafeAreaView.h"
...
@implementation ABI38_0_0RCTSafeAreaView {
...
{
  UIViewController* vc = self.ABI38_0_0ReactViewController;
...
{
  if (UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI38_0_0RCTScreenScale())) {
    return;
  }

  _currentSafeAreaInsets = safeAreaInsets;

  ABI38_0_0RCTSafeAreaViewLocalData *localData = [[ABI38_0_0RCTSafeAreaViewLocalData alloc] initWithInsets:safeAreaInsets];
