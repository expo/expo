...
UIAccessibilityTraits const ABI38_0_0SwitchAccessibilityTrait = 0x20000000000001;

@implementation UIView (ABI38_0_0RCTViewUnmounting)
...
- (void)ABI38_0_0React_remountAllSubviews
{
  ...
  for (UIView *subview in self.subviews) {
    [subview ABI38_0_0React_remountAllSubviews];
  }
}
...
- (void)ABI38_0_0React_updateClippedSubviewsWithClipRect:(CGRect)clipRect relativeToView:(UIView *)clipView
{
  ...
  for (UIView *subview in self.subviews) {
    [subview ABI38_0_0React_updateClippedSubviewsWithClipRect:clipRect relativeToView:clipView];
  }
}
...
- (UIView *)ABI38_0_0React_findClipView
{
  ...
  while (testView) {
    ...
    if ([testView isABI38_0_0ReactRootView]) {
      break;
    }
...
static NSString *ABI38_0_0RCTRecursiveAccessibilityLabel(UIView *view)
{
  NSMutableString *str = [NSMutableString stringWithString:@""];
  for (UIView *subview in view.subviews) {
    NSString *label = subview.accessibilityLabel;
    if (!label) {
      label = ABI38_0_0RCTRecursiveAccessibilityLabel(subview);
    }
...
@implementation ABI38_0_0RCTView
{
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if ((self = [super initWithFrame:frame])) {
    ...
    _borderStyle = ABI38_0_0RCTBorderStyleSolid;
...
{
  if (_ABI38_0_0ReactLayoutDirection != layoutDirection) {
    _ABI38_0_0ReactLayoutDirection = layoutDirection;
...
- (NSString *)accessibilityLabel
{
  ...
  return ABI38_0_0RCTRecursiveAccessibilityLabel(self);
}
...
- (BOOL)didActivateAccessibilityCustomAction:(UIAccessibilityCustomAction *)action
{
  ...
  if (actionObject) {
    _onAccessibilityAction(@{
      ...
      @"actionTarget": self.ABI38_0_0ReactTag
    });
  }
  return YES;
}
...
{
  if ((self.accessibilityTraits & ABI38_0_0SwitchAccessibilityTrait) == ABI38_0_0SwitchAccessibilityTrait) {
...
- (void)setPointerEvents:(ABI38_0_0RCTPointerEvents)pointerEvents
{
  ...
  self.userInteractionEnabled = (pointerEvents != ABI38_0_0RCTPointerEventsNone);
  if (pointerEvents == ABI38_0_0RCTPointerEventsBoxNone) {
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
  ...
  BOOL needsHitSubview = !(_pointerEvents == ABI38_0_0RCTPointerEventsNone || _pointerEvents == ABI38_0_0RCTPointerEventsBoxOnly);
  if (needsHitSubview && (![self clipsToBounds] || isPointInside)) {
    // Take z-index into account when calculating the touch target.
    NSArray<UIView *> *sortedSubviews = [self ABI38_0_0ReactZIndexSortedSubviews];
  ...
  switch (_pointerEvents) {
    ...
    case ABI38_0_0RCTPointerEventsBoxOnly:
      return hitView;
    case ABI38_0_0RCTPointerEventsBoxNone:
      return hitSubview;
    default:
      ABI38_0_0RCTLogError(@"Invalid pointer-events specified %lld on %@", (long long)_pointerEvents, self);
      return hitSubview ?: hitView;
  }
}
...
{
  if (self.ABI38_0_0ReactAccessibilityElement == self) {
...
- (NSString *)description
{
  ...
  NSString *replacement = [NSString stringWithFormat:@"; ABI38_0_0ReactTag: %@;", self.ABI38_0_0ReactTag];
  return [superDescription stringByReplacingCharactersInRange:semicolonRange withString:replacement];
}

#pragma mark - Statics for dealing with layoutGuides

+ (void)autoAdjustInsetsForView:(UIView<ABI38_0_0RCTAutoInsetsProtocol> *)parentView
...
{
  while (view) {
    UIViewController *controller = view.ABI38_0_0ReactViewController;
    if (controller) {
      return (UIEdgeInsets){
...
- (void)ABI38_0_0React_remountAllSubviews
{
  if (_removeClippedSubviews) {
    for (UIView *view in self.ABI38_0_0ReactSubviews) {
      if (view.superview != self) {
        [self addSubview:view];
        [view ABI38_0_0React_remountAllSubviews];
      }
    }
  } else {
    // If _removeClippedSubviews is false, we must already be showing all subviews
    [super ABI38_0_0React_remountAllSubviews];
  }
}
...
- (void)ABI38_0_0React_updateClippedSubviewsWithClipRect:(CGRect)clipRect relativeToView:(UIView *)clipView
{
  ...
  if (!_removeClippedSubviews) {
    ...
    return [super ABI38_0_0React_updateClippedSubviewsWithClipRect:clipRect relativeToView:clipView];
  }

  if (self.ABI38_0_0ReactSubviews.count == 0) {
  ...
  for (UIView *view in self.ABI38_0_0ReactSubviews) {
    if (!CGSizeEqualToSize(CGRectIntersection(clipRect, view.frame).size, CGSizeZero)) {
      ...
      if (CGRectContainsRect(clipRect, view.frame)) {
        ...
        [view ABI38_0_0React_updateClippedSubviewsWithClipRect:clipRect relativeToView:clipView];
      }
...
- (void)setRemoveClippedSubviews:(BOOL)removeClippedSubviews
{
  if (!removeClippedSubviews && _removeClippedSubviews) {
    [self ABI38_0_0React_remountAllSubviews];
  }
...
- (void)updateClippedSubviews
{
  ...
  if (clipView) {
    [self ABI38_0_0React_updateClippedSubviewsWithClipRect:clipView.bounds relativeToView:clipView];
  }
}
...
static CGFloat ABI38_0_0RCTDefaultIfNegativeTo(CGFloat defaultValue, CGFloat x) {
...
- (UIEdgeInsets)bordersAsInsets
{
  ...
  const BOOL isRTL = _ABI38_0_0ReactLayoutDirection == UIUserInterfaceLayoutDirectionRightToLeft;

  if ([[ABI38_0_0RCTI18nUtil sharedInstance] doLeftAndRightSwapInRTL]) {
    const CGFloat borderStartWidth = ABI38_0_0RCTDefaultIfNegativeTo(_borderLeftWidth, _borderStartWidth);
    const CGFloat borderEndWidth = ABI38_0_0RCTDefaultIfNegativeTo(_borderRightWidth, _borderEndWidth);
    ...
    return (UIEdgeInsets) {
      ABI38_0_0RCTDefaultIfNegativeTo(borderWidth, _borderTopWidth),
      ABI38_0_0RCTDefaultIfNegativeTo(borderWidth, directionAwareBorderLeftWidth),
      ABI38_0_0RCTDefaultIfNegativeTo(borderWidth, _borderBottomWidth),
      ABI38_0_0RCTDefaultIfNegativeTo(borderWidth, directionAwareBorderRightWidth),
    };
  }
  ...
  return (UIEdgeInsets) {
    ABI38_0_0RCTDefaultIfNegativeTo(borderWidth, _borderTopWidth),
    ABI38_0_0RCTDefaultIfNegativeTo(borderWidth, ABI38_0_0RCTDefaultIfNegativeTo(_borderLeftWidth, directionAwareBorderLeftWidth)),
    ABI38_0_0RCTDefaultIfNegativeTo(borderWidth, _borderBottomWidth),
    ABI38_0_0RCTDefaultIfNegativeTo(borderWidth, ABI38_0_0RCTDefaultIfNegativeTo(_borderRightWidth, directionAwareBorderRightWidth)),
  };
}
...
- (ABI38_0_0RCTCornerRadii)cornerRadii
{
  ...
  if ([[ABI38_0_0RCTI18nUtil sharedInstance] doLeftAndRightSwapInRTL]) {
    const CGFloat topStartRadius = ABI38_0_0RCTDefaultIfNegativeTo(_borderTopLeftRadius, _borderTopStartRadius);
    const CGFloat topEndRadius = ABI38_0_0RCTDefaultIfNegativeTo(_borderTopRightRadius, _borderTopEndRadius);
    const CGFloat bottomStartRadius = ABI38_0_0RCTDefaultIfNegativeTo(_borderBottomLeftRadius, _borderBottomStartRadius);
    const CGFloat bottomEndRadius = ABI38_0_0RCTDefaultIfNegativeTo(_borderBottomRightRadius, _borderBottomEndRadius);
    ...
    topLeftRadius = ABI38_0_0RCTDefaultIfNegativeTo(radius, directionAwareTopLeftRadius);
    topRightRadius = ABI38_0_0RCTDefaultIfNegativeTo(radius, directionAwareTopRightRadius);
    bottomLeftRadius = ABI38_0_0RCTDefaultIfNegativeTo(radius, directionAwareBottomLeftRadius);
    bottomRightRadius = ABI38_0_0RCTDefaultIfNegativeTo(radius, directionAwareBottomRightRadius);
  } else {
    ...
    topLeftRadius = ABI38_0_0RCTDefaultIfNegativeTo(radius, ABI38_0_0RCTDefaultIfNegativeTo(_borderTopLeftRadius, directionAwareTopLeftRadius));
    topRightRadius = ABI38_0_0RCTDefaultIfNegativeTo(radius, ABI38_0_0RCTDefaultIfNegativeTo(_borderTopRightRadius, directionAwareTopRightRadius));
    bottomLeftRadius = ABI38_0_0RCTDefaultIfNegativeTo(radius, ABI38_0_0RCTDefaultIfNegativeTo(_borderBottomLeftRadius, directionAwareBottomLeftRadius));
    bottomRightRadius = ABI38_0_0RCTDefaultIfNegativeTo(radius, ABI38_0_0RCTDefaultIfNegativeTo(_borderBottomRightRadius, directionAwareBottomRightRadius));
  }

  // Get scale factors required to prevent radii from overlapping
  const CGSize size = self.bounds.size;
  const CGFloat topScaleFactor = ABI38_0_0RCTZeroIfNaN(MIN(1, size.width / (topLeftRadius + topRightRadius)));
  const CGFloat bottomScaleFactor = ABI38_0_0RCTZeroIfNaN(MIN(1, size.width / (bottomLeftRadius + bottomRightRadius)));
  const CGFloat rightScaleFactor = ABI38_0_0RCTZeroIfNaN(MIN(1, size.height / (topRightRadius + bottomRightRadius)));
  const CGFloat leftScaleFactor = ABI38_0_0RCTZeroIfNaN(MIN(1, size.height / (topLeftRadius + bottomLeftRadius)));

  // Return scaled radii
  return (ABI38_0_0RCTCornerRadii){
...
- (ABI38_0_0RCTBorderColors)borderColors
{
  ...
  if ([[ABI38_0_0RCTI18nUtil sharedInstance] doLeftAndRightSwapInRTL]) {
    ...
    return (ABI38_0_0RCTBorderColors){
...
- (void)displayLayer:(CALayer *)layer
{
  ...
  ABI38_0_0RCTUpdateShadowPathForView(self);

  const ABI38_0_0RCTCornerRadii cornerRadii = [self cornerRadii];
  const UIEdgeInsets borderInsets = [self bordersAsInsets];
  const ABI38_0_0RCTBorderColors borderColors = [self borderColors];

  BOOL useIOSBorderRendering =
  ABI38_0_0RCTCornerRadiiAreEqual(cornerRadii) &&
  ABI38_0_0RCTBorderInsetsAreEqual(borderInsets) &&
  ABI38_0_0RCTBorderColorsAreEqual(borderColors) &&
  _borderStyle == ABI38_0_0RCTBorderStyleSolid &&
  ...
  UIImage *image = ABI38_0_0RCTGetBorderImage(_borderStyle,
                                     layer.bounds.size,
                                     cornerRadii,
                                     borderInsets,
                                     borderColors,
...
static BOOL ABI38_0_0RCTLayerHasShadow(CALayer *layer)
{
  return layer.shadowOpacity * CGColorGetAlpha(layer.shadowColor) > 0;
}

static void ABI38_0_0RCTUpdateShadowPathForView(ABI38_0_0RCTView *view)
{
  if (ABI38_0_0RCTLayerHasShadow(view.layer)) {
    if (CGColorGetAlpha(view.backgroundColor.CGColor) > 0.999) {

      // If view has a solid background color, calculate shadow path from border
      const ABI38_0_0RCTCornerRadii cornerRadii = [view cornerRadii];
      const ABI38_0_0RCTCornerInsets cornerInsets = ABI38_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero);
      CGPathRef shadowPath = ABI38_0_0RCTPathCreateWithRoundedRect(view.bounds, cornerInsets, NULL);
      ...
      ABI38_0_0RCTLogAdvice(@"View #%@ of type %@ has a shadow set but cannot calculate "
        "shadow efficiently. Consider setting a background color to "
        "fix this, or apply the shadow to a more specific component.",
        view.ABI38_0_0ReactTag, [view class]);
    }
  }
}
...
- (void)updateClippingForLayer:(CALayer *)layer
{
  ...
  if (self.clipsToBounds) {
    ...
    const ABI38_0_0RCTCornerRadii cornerRadii = [self cornerRadii];
    if (ABI38_0_0RCTCornerRadiiAreEqual(cornerRadii)) {
      ...
      CGPathRef path = ABI38_0_0RCTPathCreateWithRoundedRect(self.bounds, ABI38_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
...
#define setBorderStyle(side)                           \
  - (void)setBorder##side##Style:(ABI38_0_0RCTBorderStyle)style \
  {                                                    \
