...
/**
 * Contains any methods related to scrolling. Any `ABI38_0_0RCTView` that has scrolling
 * features should implement these methods.
 */
@protocol ABI38_0_0RCTScrollableProtocol
 ...
 */
@protocol ABI38_0_0RCTCustomRefreshContolProtocol
