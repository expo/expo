...
@implementation ABI38_0_0RCTScrollEvent
{
...
{
  ABI38_0_0RCTAssertParam(ABI38_0_0ReactTag);
...
- (ABI38_0_0RCTScrollEvent *)coalesceWithEvent:(ABI38_0_0RCTScrollEvent *)newEvent
{
...
- (NSArray *)arguments
{
  return @[self.viewTag, ABI38_0_0RCTNormalizeInputEventName(self.eventName), [self body]];
}
