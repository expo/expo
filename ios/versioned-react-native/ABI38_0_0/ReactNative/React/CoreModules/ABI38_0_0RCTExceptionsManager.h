...
@protocol ABI38_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI38_0_0RCTExceptionsManager : NSObject <ABI38_0_0RCTBridgeModule>
...
@property (nonatomic, weak) id<ABI38_0_0RCTExceptionsManagerDelegate> delegate;
