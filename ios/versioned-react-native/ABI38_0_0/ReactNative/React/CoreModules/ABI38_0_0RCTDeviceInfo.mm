...
#import "ABI38_0_0RCTDeviceInfo.h"

#import <ABI38_0_0FBReactNativeSpec/ABI38_0_0FBReactNativeSpec.h>
#import <ABI38_0_0React/ABI38_0_0RCTAccessibilityManager.h>
...
#import <ABI38_0_0React/ABI38_0_0RCTUIUtils.h>
...
- (void)setBridge:(ABI38_0_0RCTBridge *)bridge
{
...
#if !TARGET_OS_TV
  _currentInterfaceOrientation = [ABI38_0_0RCTSharedApplication() statusBarOrientation];
  ...
  _currentInterfaceDimensions = ABI38_0_0RCTExportedDimensions(_bridge);
...
static BOOL ABI38_0_0RCTIsIPhoneX() {
...
static NSDictionary *ABI38_0_0RCTExportedDimensions(ABI38_0_0RCTBridge *bridge)
{
  ABI38_0_0RCTAssertMainQueue();
  ABI38_0_0RCTDimensions dimensions = ABI38_0_0RCTGetDimensions(bridge.accessibilityManager.multiplier);
...
{
  return @{
    @"Dimensions": ABI38_0_0RCTExportedDimensions(_bridge),
    // Note:
    // This prop is deprecated and will be removed in a future release.
    // Please use this only for a quick and temporary solution.
    // Use <SafeAreaView> instead.
    @"isIPhoneX_deprecated": @(ABI38_0_0RCTIsIPhoneX()),
  };
}
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [bridge.eventDispatcher sendDeviceEventWithName:@"didUpdateDimensions"
                                        body:ABI38_0_0RCTExportedDimensions(bridge)];
...
{
  UIInterfaceOrientation nextOrientation = [ABI38_0_0RCTSharedApplication() statusBarOrientation];
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
        [_bridge.eventDispatcher sendDeviceEventWithName:@"didUpdateDimensions"
                                                    body:ABI38_0_0RCTExportedDimensions(_bridge)];
#pragma clang diagnostic pop
      }
...
{
  NSDictionary *nextInterfaceDimensions = ABI38_0_0RCTExportedDimensions(_bridge);
...
Class ABI38_0_0RCTDeviceInfoCls(void) {
  return ABI38_0_0RCTDeviceInfo.class;
}
