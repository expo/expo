...
#import "ABI38_0_0RCTKeyboardObserver.h"
...
{ \
  ...
  [self sendEventWithName:@#EVENT \
    body:ABI38_0_0RCTParseKeyboardNotification(notification)]; \
}
...
{
  return std::make_shared<ABI38_0_0facebook::ABI38_0_0React::NativeKeyboardObserverSpecJSI>(self, jsInvoker);
}

@end

NS_INLINE NSDictionary *ABI38_0_0RCTRectDictionaryValue(CGRect rect)
{
  return @{
...
static NSString *ABI38_0_0RCTAnimationNameForCurve(UIViewAnimationCurve curve)
{
  switch (curve) {
...
static NSDictionary *ABI38_0_0RCTParseKeyboardNotification(NSNotification *notification)
{
  ...
  return @{
    @"startCoordinates": ABI38_0_0RCTRectDictionaryValue(beginFrame),
    @"endCoordinates": ABI38_0_0RCTRectDictionaryValue(endFrame),
    @"duration": @(duration * 1000.0), // ms
    @"easing": ABI38_0_0RCTAnimationNameForCurve(curve),
    @"isEventFromThisApp": isLocalUserInfoKey == 1 ? @YES : @NO,
  };
#endif
}

Class ABI38_0_0RCTKeyboardObserverCls(void) {
  return ABI38_0_0RCTKeyboardObserver.class;
}
