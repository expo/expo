...
@protocol ABI38_0_0RCTPackagerClientMethod;

/**
 * An abstraction for a key-value store to manage ABI38_0_0RCTDevSettings behavior.
 * The default implementation persists settings using NSUserDefaults.
 */
@protocol ABI38_0_0RCTDevSettingsDataSource <NSObject>
...
@interface ABI38_0_0RCTDevSettings : ABI38_0_0RCTEventEmitter
...
/*
 * Whether shaking will show ABI38_0_0RCTDevMenu. The menu is enabled by default if ABI38_0_0RCT_DEV=1, but
...
- (void)addHandler:(id<ABI38_0_0RCTPackagerClientMethod>)handler
    forPackagerMethod:(NSString *)name __deprecated_msg("Use ABI38_0_0RCTPackagerConnection directly instead");
#endif

@end

@interface ABI38_0_0RCTBridge (ABI38_0_0RCTDevSettings)

@property (nonatomic, readonly) ABI38_0_0RCTDevSettings *devSettings;
...
// (i.e. ABI38_0_0RCT_DEV or ABI38_0_0RCT_DEV_MENU is set)
ABI38_0_0RCT_EXTERN void ABI38_0_0RCTDevSettingsSetEnabled(BOOL enabled);
