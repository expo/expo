...
#import <ABI38_0_0React/ABI38_0_0RCTBackedTextInputDelegateAdapter.h>
...
@interface ABI38_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI38_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI38_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
...
@interface ABI38_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI38_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI38_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}
