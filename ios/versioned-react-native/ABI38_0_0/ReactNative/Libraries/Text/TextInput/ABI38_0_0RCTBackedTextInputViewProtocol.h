...
@protocol ABI38_0_0RCTBackedTextInputDelegate;
@class ABI38_0_0RCTTextAttributes;

NS_ASSUME_NONNULL_BEGIN

@protocol ABI38_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI38_0_0RCTBackedTextInputDelegate> textInputDelegate;
