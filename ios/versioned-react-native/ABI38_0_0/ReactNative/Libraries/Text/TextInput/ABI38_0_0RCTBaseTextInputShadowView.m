...
#import "ABI38_0_0NSTextStorage+FontScaling.h"
#import <ABI38_0_0React/ABI38_0_0RCTBaseTextInputView.h>

@implementation ABI38_0_0RCTBaseTextInputShadowView
{
...
- (instancetype)initWithBridge:(ABI38_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI38_0_0YGNodeSetMeasureFunc(self.yogaNode, ABI38_0_0RCTBaseTextInputShadowViewMeasure);
    ABI38_0_0YGNodeSetBaselineFunc(self.yogaNode, ABI38_0_0RCTTextInputShadowViewBaseline);
  }
...
- (void)layoutSubviewsWithContext:(ABI38_0_0RCTLayoutContext)layoutContext
{
  // Do nothing.
}
...
- (void)dirtyLayout
{
  [super dirtyLayout];
  _needsUpdateView = YES;
  ABI38_0_0YGNodeMarkDirty(self.yogaNode);
...
{
  if (ABI38_0_0YGNodeIsDirty(self.yogaNode)) {
    return;
  }
  ...
  ABI38_0_0RCTTextAttributes *textAttributes = [self.textAttributes copy];
  ...
  [attributedText removeAttribute:ABI38_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                            range:NSMakeRange(0, attributedText.length)];

  [attributedText removeAttribute:ABI38_0_0RCTTextAttributesTagAttributeName
                            range:NSMakeRange(0, attributedText.length)];
  ...
  NSNumber *tag = self.ABI38_0_0ReactTag;

  [_bridge.uiManager addUIBlock:^(ABI38_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI38_0_0RCTBaseTextInputView *baseTextInputView = (ABI38_0_0RCTBaseTextInputView *)viewRegistry[tag];
    if (!baseTextInputView) {
      return;
    }

    baseTextInputView.textAttributes = textAttributes;
    baseTextInputView.ABI38_0_0ReactBorderInsets = borderInsets;
    baseTextInputView.ABI38_0_0ReactPaddingInsets = paddingInsets;
...
- (CGSize)sizeThatFitsMinimumSize:(CGSize)minimumSize maximumSize:(CGSize)maximumSize
{
  ...
  return (CGSize){
    MAX(minimumSize.width, MIN(ABI38_0_0RCTCeilPixelValue(size.width), maximumSize.width)),
    MAX(minimumSize.height, MIN(ABI38_0_0RCTCeilPixelValue(size.height), maximumSize.height))
  };
}
...
static ABI38_0_0YGSize ABI38_0_0RCTBaseTextInputShadowViewMeasure(ABI38_0_0YGNodeRef node, float width, ABI38_0_0YGMeasureMode widthMode, float height, ABI38_0_0YGMeasureMode heightMode)
{
  ABI38_0_0RCTShadowView *shadowView = (__bridge ABI38_0_0RCTShadowView *)ABI38_0_0YGNodeGetContext(node);

  CGSize minimumSize = CGSizeMake(0, 0);
  CGSize maximumSize = CGSizeMake(CGFLOAT_MAX, CGFLOAT_MAX);

  CGSize size = {
    ABI38_0_0RCTCoreGraphicsFloatFromYogaFloat(width),
    ABI38_0_0RCTCoreGraphicsFloatFromYogaFloat(height)
  };
  ...
  return (ABI38_0_0YGSize){
    ABI38_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.width),
    ABI38_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.height)
  };
}

static float ABI38_0_0RCTTextInputShadowViewBaseline(ABI38_0_0YGNodeRef node, const float width, const float height)
{
  ABI38_0_0RCTBaseTextInputShadowView *shadowTextView = (__bridge ABI38_0_0RCTBaseTextInputShadowView *)ABI38_0_0YGNodeGetContext(node);
  ...
  return ABI38_0_0RCTYogaFloatFromCoreGraphicsFloat(lastBaseline);
}
