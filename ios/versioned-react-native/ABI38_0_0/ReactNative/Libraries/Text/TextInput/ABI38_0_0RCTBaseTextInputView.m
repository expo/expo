...
#import <ABI38_0_0React/ABI38_0_0RCTTextAttributes.h>
#import <ABI38_0_0React/ABI38_0_0RCTTextSelection.h>

@implementation ABI38_0_0RCTBaseTextInputView {
  __weak ABI38_0_0RCTBridge *_bridge;
  __weak ABI38_0_0RCTEventDispatcher *_eventDispatcher;
...
- (UIView<ABI38_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  ABI38_0_0RCTAssert(NO, @"-[ABI38_0_0RCTBaseTextInputView backedTextInputView] must be implemented in subclass.");
  return nil;
}

#pragma mark - ABI38_0_0RCTComponent
...
- (void)setTextAttributes:(ABI38_0_0RCTTextAttributes *)textAttributes
{
...
{
  id<ABI38_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
  backedTextInputView.defaultTextAttributes = [_textAttributes effectiveTextAttributes];
}

- (void)setABI38_0_0ReactPaddingInsets:(UIEdgeInsets)ABI38_0_0ReactPaddingInsets
{
  _ABI38_0_0ReactPaddingInsets = ABI38_0_0ReactPaddingInsets;
  // We apply `paddingInsets` as `backedTextInputView`'s `textContainerInset`.
  self.backedTextInputView.textContainerInset = ABI38_0_0ReactPaddingInsets;
  [self setNeedsLayout];
}

- (void)setABI38_0_0ReactBorderInsets:(UIEdgeInsets)ABI38_0_0ReactBorderInsets
{
  _ABI38_0_0ReactBorderInsets = ABI38_0_0ReactBorderInsets;
  // We apply `borderInsets` as `backedTextInputView` layout offset.
  self.backedTextInputView.frame = UIEdgeInsetsInsetRect(self.bounds, ABI38_0_0ReactBorderInsets);
  [self setNeedsLayout];
}
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  [backedTextInputViewTextCopy removeAttribute:ABI38_0_0RCTTextAttributesTagAttributeName
                                         range:NSMakeRange(0, backedTextInputViewTextCopy.length)];

  [attributedTextCopy removeAttribute:ABI38_0_0RCTTextAttributesTagAttributeName
  ...
  } else if (eventLag > ABI38_0_0RCTTextUpdateLagWarningThreshold) {
    ABI38_0_0RCTLog(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", self.backedTextInputView.attributedText.string, (long long)eventLag);
  }
}

- (ABI38_0_0RCTTextSelection *)selection
{
  id<ABI38_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
  UITextRange *selectedTextRange = backedTextInputView.selectedTextRange;
  return [[ABI38_0_0RCTTextSelection new] initWithStart:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.start]
                                           end:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.end]];
}

- (void)setSelection:(ABI38_0_0RCTTextSelection *)selection
{
  if (!selection) {
    return;
  }
  ...
  if (eventLag == 0 && ![previousSelectedTextRange isEqual:selectedTextRange]) {
    ...
    ABI38_0_0RCTLog(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", backedTextInputView.attributedText.string, (long long)eventLag);
  }
}
...
{
  UIView<ABI38_0_0RCTBackedTextInputViewProtocol> *textInputView = self.backedTextInputView;
...
#pragma mark - ABI38_0_0RCTBackedTextInputDelegate
...
- (void)textInputDidBeginEditing
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI38_0_0RCTTextEventTypeFocus
...
{
  [_eventDispatcher sendTextEventWithType:ABI38_0_0RCTTextEventTypeEnd
                                 ABI38_0_0ReactTag:self.ABI38_0_0ReactTag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];

  [_eventDispatcher sendTextEventWithType:ABI38_0_0RCTTextEventTypeBlur
                                 ABI38_0_0ReactTag:self.ABI38_0_0ReactTag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldReturn
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI38_0_0RCTTextEventTypeSubmit
                                 ABI38_0_0ReactTag:self.ABI38_0_0ReactTag
                                     text:self.backedTextInputView.attributedText.string
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (NSString *)textInputShouldChangeText:(NSString *)text inRange:(NSRange)range
{
  ...
  if (!backedTextInputView.textWasPasted) {
    [_eventDispatcher sendTextEventWithType:ABI38_0_0RCTTextEventTypeKeyPress
                                   ABI38_0_0ReactTag:self.ABI38_0_0ReactTag
                                       text:nil
                                        key:text
                                 eventCount:_nativeEventCount];
...
- (void)textInputDidChangeSelection
{
  ...
  ABI38_0_0RCTTextSelection *selection = self.selection;
...
- (CGSize)intrinsicContentSize
{
  ...
  size.width += _ABI38_0_0ReactBorderInsets.left + _ABI38_0_0ReactBorderInsets.right;
  size.height += _ABI38_0_0ReactBorderInsets.top + _ABI38_0_0ReactBorderInsets.bottom;
...
{
  CGFloat compoundHorizontalBorderInset = _ABI38_0_0ReactBorderInsets.left + _ABI38_0_0ReactBorderInsets.right;
  CGFloat compoundVerticalBorderInset = _ABI38_0_0ReactBorderInsets.top + _ABI38_0_0ReactBorderInsets.bottom;
...
- (UIView *)ABI38_0_0ReactAccessibilityElement
{
...
- (void)ABI38_0_0ReactFocus
{
  [self.backedTextInputView ABI38_0_0ReactFocus];
}

- (void)ABI38_0_0ReactBlur
{
  [self.backedTextInputView ABI38_0_0ReactBlur];
}
...
- (void)didMoveToWindow
{
  if (self.autoFocus && !_didMoveToWindow) {
    ...
    [self.backedTextInputView ABI38_0_0ReactFocusIfNeeded];
  }
...
{
  #if !TARGET_OS_TV
  __weak ABI38_0_0RCTBaseTextInputView *weakSelf = self;
  [_bridge.uiManager rootViewForABI38_0_0ReactTag:self.ABI38_0_0ReactTag withCompletion:^(UIView *rootView) {
    ABI38_0_0RCTBaseTextInputView *strongSelf = weakSelf;
    if (rootView) {
      UIView *accessoryView = [strongSelf->_bridge.uiManager viewForNativeID:nativeID
                                                                 withRootTag:rootView.ABI38_0_0ReactTag];
      if (accessoryView && [accessoryView isKindOfClass:[ABI38_0_0RCTInputAccessoryView class]]) {
        strongSelf.backedTextInputView.inputAccessoryView = ((ABI38_0_0RCTInputAccessoryView *)accessoryView).inputAccessoryView;
