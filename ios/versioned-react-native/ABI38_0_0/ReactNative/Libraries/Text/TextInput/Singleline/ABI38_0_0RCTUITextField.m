...
#import <ABI38_0_0React/ABI38_0_0RCTUITextField.h>
...
@implementation ABI38_0_0RCTUITextField {
  ABI38_0_0RCTBackedTextFieldDelegateAdapter *_textInputDelegateAdapter;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI38_0_0RCTBackedTextFieldDelegateAdapter alloc] initWithTextField:self];
  }
...
- (CGSize)intrinsicContentSize
{
  ...
  size = CGSizeMake(ABI38_0_0RCTCeilPixelValue(size.width), ABI38_0_0RCTCeilPixelValue(size.height));
