...
#import <ABI38_0_0React/ABI38_0_0RCTTextDecorationLineType.h>

#import "ABI38_0_0RCTTextTransform.h"

NS_ASSUME_NONNULL_BEGIN

extern NSString *const ABI38_0_0RCTTextAttributesIsHighlightedAttributeName;
extern NSString *const ABI38_0_0RCTTextAttributesTagAttributeName;
 ...
 * and <TextInput>.
 */
@interface ABI38_0_0RCTTextAttributes : NSObject <NSCopying>
...
@property (nonatomic, assign) ABI38_0_0RCTTextDecorationLineType textDecorationLine;
// Shadow
...
@property (nonatomic, assign) ABI38_0_0RCTTextTransform textTransform;

#pragma mark - Inheritance

- (void)applyTextAttributes:(ABI38_0_0RCTTextAttributes *)textAttributes;
