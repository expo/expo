...
NSString *const ABI38_0_0RCTTextAttributesIsHighlightedAttributeName = @"ABI38_0_0RCTTextAttributesIsHighlightedAttributeName";
NSString *const ABI38_0_0RCTTextAttributesTagAttributeName = @"ABI38_0_0RCTTextAttributesTagAttributeName";

@implementation ABI38_0_0RCTTextAttributes
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _opacity = NAN;
    _textTransform = ABI38_0_0RCTTextTransformUndefined;
  }
...
- (void)applyTextAttributes:(ABI38_0_0RCTTextAttributes *)textAttributes
{
  ...
  _textDecorationLine = textAttributes->_textDecorationLine != ABI38_0_0RCTTextDecorationLineTypeNone ? textAttributes->_textDecorationLine : _textDecorationLine; // *
  ...
  _textTransform = textAttributes->_textTransform != ABI38_0_0RCTTextTransformUndefined ? textAttributes->_textTransform : _textTransform;
}
...
- (NSDictionary<NSAttributedStringKey, id> *)effectiveTextAttributes
{
  ...
  if (_textDecorationLine == ABI38_0_0RCTTextDecorationLineTypeUnderline ||
      _textDecorationLine == ABI38_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    isTextDecorationEnabled = YES;
    attributes[NSUnderlineStyleAttributeName] = @(_textDecorationStyle);
  }

  if (_textDecorationLine == ABI38_0_0RCTTextDecorationLineTypeStrikethrough ||
      _textDecorationLine == ABI38_0_0RCTTextDecorationLineTypeUnderlineStrikethrough){
    isTextDecorationEnabled = YES;
  ...
  // Special
  if (_isHighlighted) {
    attributes[ABI38_0_0RCTTextAttributesIsHighlightedAttributeName] = @YES;
  }

  if (_tag) {
    attributes[ABI38_0_0RCTTextAttributesTagAttributeName] = _tag;
  }
...
{
  // FIXME: ABI38_0_0RCTFont has thread-safety issues and must be rewritten.
  return [ABI38_0_0RCTFont updateFont:nil
...
{
  bool fontScalingEnabled = !ABI38_0_0RCTHasFontHandlerSet() && _allowFontScaling;
...
- (NSString *)applyTextAttributesToText:(NSString *)text
{
  switch (_textTransform) {
    case ABI38_0_0RCTTextTransformUndefined:
    case ABI38_0_0RCTTextTransformNone:
      return text;
    case ABI38_0_0RCTTextTransformLowercase:
      return [text lowercaseString];
    case ABI38_0_0RCTTextTransformUppercase:
      return [text uppercaseString];
    case ABI38_0_0RCTTextTransformCapitalize:
      return [text capitalizedString];
  }
}

- (ABI38_0_0RCTTextAttributes *)copyWithZone:(NSZone *)zone
{
  ABI38_0_0RCTTextAttributes *textAttributes = [ABI38_0_0RCTTextAttributes new];
...
- (BOOL)isEqual:(ABI38_0_0RCTTextAttributes *)textAttributes
{
  if (!textAttributes) {
    return NO;
  }
...
#define ABI38_0_0RCTTextAttributesCompareFloats(a) ((a == textAttributes->a) || (isnan(a) && isnan(textAttributes->a)))
#define ABI38_0_0RCTTextAttributesCompareSize(a) CGSizeEqualToSize(a, textAttributes->a)
#define ABI38_0_0RCTTextAttributesCompareObjects(a) ((a == textAttributes->a) || [a isEqual:textAttributes->a])
#define ABI38_0_0RCTTextAttributesCompareStrings(a) ((a == textAttributes->a) || [a isEqualToString:textAttributes->a])
#define ABI38_0_0RCTTextAttributesCompareOthers(a) (a == textAttributes->a)

  return
    ABI38_0_0RCTTextAttributesCompareObjects(_foregroundColor) &&
    ABI38_0_0RCTTextAttributesCompareObjects(_backgroundColor) &&
    ABI38_0_0RCTTextAttributesCompareFloats(_opacity) &&
    // Font
    ABI38_0_0RCTTextAttributesCompareObjects(_fontFamily) &&
    ABI38_0_0RCTTextAttributesCompareFloats(_fontSize) &&
    ABI38_0_0RCTTextAttributesCompareFloats(_fontSizeMultiplier) &&
    ABI38_0_0RCTTextAttributesCompareFloats(_maxFontSizeMultiplier) &&
    ABI38_0_0RCTTextAttributesCompareStrings(_fontWeight) &&
    ABI38_0_0RCTTextAttributesCompareObjects(_fontStyle) &&
    ABI38_0_0RCTTextAttributesCompareObjects(_fontVariant) &&
    ABI38_0_0RCTTextAttributesCompareOthers(_allowFontScaling) &&
    ABI38_0_0RCTTextAttributesCompareFloats(_letterSpacing) &&
    // Paragraph Styles
    ABI38_0_0RCTTextAttributesCompareFloats(_lineHeight) &&
    ABI38_0_0RCTTextAttributesCompareFloats(_alignment) &&
    ABI38_0_0RCTTextAttributesCompareOthers(_baseWritingDirection) &&
    // Decoration
    ABI38_0_0RCTTextAttributesCompareObjects(_textDecorationColor) &&
    ABI38_0_0RCTTextAttributesCompareOthers(_textDecorationStyle) &&
    ABI38_0_0RCTTextAttributesCompareOthers(_textDecorationLine) &&
    // Shadow
    ABI38_0_0RCTTextAttributesCompareSize(_textShadowOffset) &&
    ABI38_0_0RCTTextAttributesCompareFloats(_textShadowRadius) &&
    ABI38_0_0RCTTextAttributesCompareObjects(_textShadowColor) &&
    // Special
    ABI38_0_0RCTTextAttributesCompareOthers(_isHighlighted) &&
    ABI38_0_0RCTTextAttributesCompareObjects(_tag) &&
    ABI38_0_0RCTTextAttributesCompareOthers(_layoutDirection) &&
    ABI38_0_0RCTTextAttributesCompareOthers(_textTransform);
}
