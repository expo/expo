...
@interface ABI38_0_0RCTImageStoreManager : NSObject <ABI38_0_0RCTURLRequestHandler>
...
@interface ABI38_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI38_0_0RCTBridge (ABI38_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI38_0_0RCTImageStoreManager *imageStoreManager;
