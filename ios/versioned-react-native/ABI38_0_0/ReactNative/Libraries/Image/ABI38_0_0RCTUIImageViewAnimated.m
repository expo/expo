...
#import <ABI38_0_0React/ABI38_0_0RCTUIImageViewAnimated.h>
#import <ABI38_0_0React/ABI38_0_0RCTWeakProxy.h>

#import <mach/mach.h>
#import <objc/runtime.h>

static NSUInteger ABI38_0_0RCTDeviceTotalMemory() {
  return (NSUInteger)[[NSProcessInfo processInfo] physicalMemory];
}

static NSUInteger ABI38_0_0RCTDeviceFreeMemory() {
...
@interface ABI38_0_0RCTUIImageViewAnimated () <CALayerDelegate>
...
@property (nonatomic, strong) UIImage<ABI38_0_0RCTAnimatedImage> *animatedImage;
...
@implementation ABI38_0_0RCTUIImageViewAnimated
...
- (void)setImage:(UIImage *)image
{
  ...
  if ([image respondsToSelector:@selector(animatedImageFrameAtIndex:)]) {
    NSUInteger animatedImageFrameCount = ((UIImage<ABI38_0_0RCTAnimatedImage> *)image).animatedImageFrameCount;
    ...
    self.animatedImage = (UIImage<ABI38_0_0RCTAnimatedImage> *)image;
...
- (CADisplayLink *)displayLink
{
  ...
  // Since this class is used for all ABI38_0_0RCTImageView's, this is especially important.
  if (!_animatedImage) {
    return nil;
  }

  if (!_displayLink) {
    _displayLink = [CADisplayLink displayLinkWithTarget:[ABI38_0_0RCTWeakProxy weakProxyWithTarget:self] selector:@selector(displayDidRefresh:)];
...
- (void)displayDidRefresh:(CADisplayLink *)displayLink
{
  ...
  if (!fetchFrame && !bufferFull && self.fetchQueue.operationCount == 0) {
    ...
    UIImage<ABI38_0_0RCTAnimatedImage> *animatedImage = self.animatedImage;
...
- (void)calculateMaxBufferCount
{
  ...
  if (self.maxBufferSize > 0) {
    ...
    NSUInteger total = ABI38_0_0RCTDeviceTotalMemory();
    NSUInteger free = ABI38_0_0RCTDeviceFreeMemory();
