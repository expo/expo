...
@interface UIImage (ABI38_0_0React)
 ...
 */
@property (nonatomic, assign) NSInteger ABI38_0_0ReactDecodedImageBytes;
 ...
 */
@protocol ABI38_0_0RCTImageCache <NSObject>
...
@interface ABI38_0_0RCTImageCache : NSObject <ABI38_0_0RCTImageCache>
@end
