 ...
 * are also bridge modules, so should be registered using ABI38_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI38_0_0RCTImageDataDecoder <ABI38_0_0RCTBridgeModule>
...
/**
 * If more than one ABI38_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
