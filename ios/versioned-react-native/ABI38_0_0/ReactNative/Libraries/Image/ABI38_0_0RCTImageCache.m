...
static const NSUInteger ABI38_0_0RCTMaxCachableDecodedImageSizeInBytes = 2097152; // 2 MB

static NSString *ABI38_0_0RCTCacheKeyForImage(NSString *imageTag, CGSize size, CGFloat scale,
...
@implementation ABI38_0_0RCTImageCache
{
                 ...
                 forKey:(NSString *)cacheKey
{
  ...
  NSInteger bytes = image.ABI38_0_0ReactDecodedImageBytes;
  if (bytes <= ABI38_0_0RCTMaxCachableDecodedImageSizeInBytes) {
...
{
  NSString *cacheKey = ABI38_0_0RCTCacheKeyForImage(url, size, scale, resizeMode);
  @synchronized(_cacheStaleTimes) {
