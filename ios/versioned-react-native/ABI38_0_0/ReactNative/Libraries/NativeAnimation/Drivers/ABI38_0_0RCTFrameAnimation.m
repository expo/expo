...
#import <ABI38_0_0React/ABI38_0_0RCTFrameAnimation.h>
...
#import <ABI38_0_0React/ABI38_0_0RCTAnimationUtils.h>
#import <ABI38_0_0React/ABI38_0_0RCTValueAnimatedNode.h>

@interface ABI38_0_0RCTFrameAnimation ()

@property (nonatomic, strong) NSNumber *animationId;
@property (nonatomic, strong) ABI38_0_0RCTValueAnimatedNode *valueNode;
@property (nonatomic, assign) BOOL animationHasBegun;
@property (nonatomic, assign) BOOL animationHasFinished;

@end

@implementation ABI38_0_0RCTFrameAnimation
{
  ...
  ABI38_0_0RCTResponseSenderBlock _callback;
...
- (instancetype)initWithId:(NSNumber *)animationId
                   ...
                   forNode:(ABI38_0_0RCTValueAnimatedNode *)valueNode
                  callBack:(nullable ABI38_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
...
{
  NSNumber *toValue = [ABI38_0_0RCTConvert NSNumber:config[@"toValue"]] ?: @1;
  NSArray<NSNumber *> *frames = [ABI38_0_0RCTConvert NSNumberArray:config[@"frames"]];
  NSNumber *iterations = [ABI38_0_0RCTConvert NSNumber:config[@"iterations"]] ?: @1;
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  NSTimeInterval currentDuration = (_animationCurrentTime - _animationStartTime) / ABI38_0_0RCTAnimationDragCoefficient();

  // Determine how many frames have passed since last update.
  // Get index of frames that surround the current interval
  NSUInteger startIndex = floor(currentDuration / ABI38_0_0RCTSingleFrameInterval);
  ...
  NSTimeInterval fromInterval = startIndex * ABI38_0_0RCTSingleFrameInterval;
  NSTimeInterval toInterval = nextIndex * ABI38_0_0RCTSingleFrameInterval;
  ...
  CGFloat frameOutput = ABI38_0_0RCTInterpolateValue(currentDuration,
                                            fromInterval,
                                            toInterval,
                                            fromFrameValue.doubleValue,
                                            toFrameValue.doubleValue,
                                            ABI38_0_0EXTRAPOLATE_TYPE_EXTEND,
                                            ABI38_0_0EXTRAPOLATE_TYPE_EXTEND);
...
{
  CGFloat outputValue = ABI38_0_0RCTInterpolateValue(frameOutput,
                                            0,
                                            1,
                                            _fromValue,
                                            _toValue,
