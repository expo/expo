...
@implementation ABI38_0_0RCTTrackingAnimatedNode {
...
- (void)performUpdate
{
  ...
  ABI38_0_0RCTValueAnimatedNode *node = (ABI38_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
