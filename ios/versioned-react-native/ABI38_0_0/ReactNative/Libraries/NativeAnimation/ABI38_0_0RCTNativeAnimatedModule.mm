...
#import <ABI38_0_0React/ABI38_0_0RCTNativeAnimatedModule.h>
#import <ABI38_0_0React/ABI38_0_0RCTNativeAnimatedNodesManager.h>

#import <ABI38_0_0RCTTypeSafety/ABI38_0_0RCTConvertHelpers.h>

#import "ABI38_0_0RCTAnimationPlugins.h"

typedef void (^AnimatedOperation)(ABI38_0_0RCTNativeAnimatedNodesManager *nodesManager);

@implementation ABI38_0_0RCTNativeAnimatedModule
{
  ABI38_0_0RCTNativeAnimatedNodesManager *_nodesManager;
...
- (void)setBridge:(ABI38_0_0RCTBridge *)bridge
{
  ...
  _nodesManager = [[ABI38_0_0RCTNativeAnimatedNodesManager alloc] initWithBridge:self.bridge];
...
ABI38_0_0RCT_EXPORT_METHOD(createAnimatedNode:(double)tag
                  config:(NSDictionary<NSString *, id> *)config)
{
  [self addOperationBlock:^(ABI38_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager createAnimatedNode:[NSNumber numberWithDouble:tag] config:config];
  }];
}

ABI38_0_0RCT_EXPORT_METHOD(connectAnimatedNodes:(double)parentTag
...
ABI38_0_0RCT_EXPORT_METHOD(disconnectAnimatedNodes:(double)parentTag
                  childTag:(double)childTag)
{
  [self addOperationBlock:^(ABI38_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI38_0_0RCT_EXPORT_METHOD(startAnimatingNode:(double)animationId
...
ABI38_0_0RCT_EXPORT_METHOD(stopAnimation:(double)animationId)
{
  [self addOperationBlock:^(ABI38_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI38_0_0RCT_EXPORT_METHOD(setAnimatedNodeValue:(double)nodeTag
                  value:(double)value)
{
  [self addOperationBlock:^(ABI38_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI38_0_0RCT_EXPORT_METHOD(setAnimatedNodeOffset:(double)nodeTag
...
ABI38_0_0RCT_EXPORT_METHOD(flattenAnimatedNodeOffset:(double)nodeTag)
{
  [self addOperationBlock:^(ABI38_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI38_0_0RCT_EXPORT_METHOD(extractAnimatedNodeOffset:(double)nodeTag)
{
  [self addOperationBlock:^(ABI38_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI38_0_0RCT_EXPORT_METHOD(connectAnimatedNodeToView:(double)nodeTag
                  viewTag:(double)viewTag)
{
  NSString *viewName = [self.bridge.uiManager viewNameForABI38_0_0ReactTag:[NSNumber numberWithDouble:viewTag]];
  [self addOperationBlock:^(ABI38_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI38_0_0RCT_EXPORT_METHOD(disconnectAnimatedNodeFromView:(double)nodeTag
                  viewTag:(double)viewTag)
{
  [self addOperationBlock:^(ABI38_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI38_0_0RCT_EXPORT_METHOD(restoreDefaultValues:(double)nodeTag)
{
  [self addPreOperationBlock:^(ABI38_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager restoreDefaultValues:[NSNumber numberWithDouble:nodeTag]];
  }];
}

ABI38_0_0RCT_EXPORT_METHOD(dropAnimatedNode:(double)tag)
{
  [self addOperationBlock:^(ABI38_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI38_0_0RCT_EXPORT_METHOD(startListeningToAnimatedNodeValue:(double)tag)
{
  __weak id<ABI38_0_0RCTValueAnimatedNodeObserver> valueObserver = self;
  [self addOperationBlock:^(ABI38_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager startListeningToAnimatedNodeValue:[NSNumber numberWithDouble:tag] valueObserver:valueObserver];
  }];
}

ABI38_0_0RCT_EXPORT_METHOD(stopListeningToAnimatedNodeValue:(double)tag)
{
  [self addOperationBlock:^(ABI38_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI38_0_0RCT_EXPORT_METHOD(addAnimatedEventToView:(double)viewTag
                  ...
                  eventMapping:(JS::NativeAnimatedModule::EventMapping &)eventMapping)
{
  ...
  eventMappingDict[@"nativeEventPath"] = ABI38_0_0RCTConvertVecToArray(eventMapping.nativeEventPath());
...
ABI38_0_0RCT_EXPORT_METHOD(removeAnimatedEventFromView:(double)viewTag
                  eventName:(nonnull NSString *)eventName
...
#pragma mark - ABI38_0_0RCTSurfacePresenterObserver
...
- (void)uiManagerWillPerformMounting:(ABI38_0_0RCTUIManager *)uiManager
{
  ...
  [uiManager prependUIBlock:^(__unused ABI38_0_0RCTUIManager *manager, __unused NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    for (AnimatedOperation operation in preOperations) {
      operation(self->_nodesManager);
    }
  }];
...
- (void)animatedNode:(ABI38_0_0RCTValueAnimatedNode *)node didUpdateValue:(CGFloat)value
{
...
Class ABI38_0_0RCTNativeAnimatedModuleCls(void) {
  return ABI38_0_0RCTNativeAnimatedModule.class;
}
