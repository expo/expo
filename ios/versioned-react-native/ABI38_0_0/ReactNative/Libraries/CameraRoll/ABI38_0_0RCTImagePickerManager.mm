...
#import "ABI38_0_0RCTImagePickerManager.h"
...
#import "ABI38_0_0RCTCameraRollPlugins.h"

@interface ABI38_0_0RCTImagePickerController : UIImagePickerController

@property (nonatomic, assign) BOOL unmirrorFrontFacingCamera;

@end

@implementation ABI38_0_0RCTImagePickerController
...
@implementation ABI38_0_0RCTImagePickerManager
{
  ...
  NSMutableArray<ABI38_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI38_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
  NSMutableDictionary<NSString *, NSDictionary<NSString *, id> *> *_pendingVideoInfo;
}

ABI38_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI38_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI38_0_0RCTResponseSenderBlock)callback)
{
...
ABI38_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI38_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI38_0_0RCT_EXPORT_METHOD(openCameraDialog:(JS::NativeImagePickerIOS::SpecOpenCameraDialogConfig &)config
                  successCallback:(ABI38_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI38_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  ABI38_0_0RCTImagePickerController *imagePicker = [ABI38_0_0RCTImagePickerController new];
...
ABI38_0_0RCT_EXPORT_METHOD(openSelectDialog:(JS::NativeImagePickerIOS::SpecOpenSelectDialogConfig &)config
                  successCallback:(ABI38_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI38_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI38_0_0RCTRunningInAppExtension()) {
...
ABI38_0_0RCT_EXPORT_METHOD(clearAllPendingVideos)
{
...
ABI38_0_0RCT_EXPORT_METHOD(removePendingVideo:(NSString *)url)
{
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    ...
    [self _dismissPicker:picker args:@[imageURLString, ABI38_0_0RCTNullIfNil(height), ABI38_0_0RCTNullIfNil(width)]];
    return;
  }
  ...
  [_bridge.imageStoreManager storeImage:originalImage withBlock:^(NSString *tempImageTag) {
    [self _dismissPicker:picker args:tempImageTag ? @[tempImageTag, ABI38_0_0RCTNullIfNil(height), ABI38_0_0RCTNullIfNil(width)] : nil];
  }];
}
        ...
        cancelCallback:(ABI38_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI38_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI38_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI38_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
...
- (void)cameraChanged:(NSNotification *)notification
{
  for (UIImagePickerController *picker in _pickers) {
    if ([picker isKindOfClass:[ABI38_0_0RCTImagePickerController class]]
      && ((ABI38_0_0RCTImagePickerController *)picker).unmirrorFrontFacingCamera
...
{
  return std::make_shared<ABI38_0_0facebook::ABI38_0_0React::NativeImagePickerIOSSpecJSI>(self, jsInvoker);
}

@end

Class ABI38_0_0RCTImagePickerManagerCls(void) {
  return ABI38_0_0RCTImagePickerManager.class;
}
