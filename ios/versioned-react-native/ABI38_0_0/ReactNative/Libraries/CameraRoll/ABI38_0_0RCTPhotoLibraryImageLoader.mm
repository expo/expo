...
#import "ABI38_0_0RCTPhotoLibraryImageLoader.h"
...
@interface ABI38_0_0RCTPhotoLibraryImageLoader () <ABI38_0_0RCTTurboModule>
@end

@implementation ABI38_0_0RCTPhotoLibraryImageLoader

ABI38_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI38_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI38_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (!imageURL) {
    completionHandler(ABI38_0_0RCTErrorWithMessage(@"Cannot load a photo library asset with no URL"), nil);
    return ^{};
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI38_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI38_0_0RCTResizeModeContain) {
...
Class ABI38_0_0RCTPhotoLibraryImageLoaderCls(void) {
  return ABI38_0_0RCTPhotoLibraryImageLoader.class;
}
