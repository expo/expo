...
#import <ABI38_0_0React/ABI38_0_0RCTFileRequestHandler.h>
...
#import "ABI38_0_0RCTNetworkPlugins.h"

@interface ABI38_0_0RCTFileRequestHandler() <ABI38_0_0RCTTurboModule>
@end

@implementation ABI38_0_0RCTFileRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  && !ABI38_0_0RCTIsBundleAssetURL(request.URL);
}
...
Class ABI38_0_0RCTFileRequestHandlerCls(void) {
  return ABI38_0_0RCTFileRequestHandler.class;
}
