...
@implementation ABI38_0_0ARTText
...
static void ABI38_0_0ARTFreeTextFrame(ABI38_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI38_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI38_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI38_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI38_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
