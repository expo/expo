...
#import <ABI38_0_0React/ABI38_0_0ARTRenderable.h>

@implementation ABI38_0_0ARTRenderable

- (void)setFill:(ABI38_0_0ARTBrush *)fill
{
  [self invalidate];
  _fill = fill;
}
...
- (void)setStrokeDash:(ABI38_0_0ARTCGFloatArray)strokeDash
{
