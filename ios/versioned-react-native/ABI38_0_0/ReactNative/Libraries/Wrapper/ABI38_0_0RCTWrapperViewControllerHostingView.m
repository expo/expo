...
#import "ABI38_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI38_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ABI38_0_0ReactViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ABI38_0_0ReactViewController detachChildViewController:self.contentViewController];
}
