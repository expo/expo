...
#import "ABI38_0_0RCTWrapperABI38_0_0ReactRootViewController.h"
...
@implementation ABI38_0_0RCTWrapperABI38_0_0ReactRootViewController {
...
- (void)loadView
{
  ABI38_0_0RCTRootView *rootView =
    [[ABI38_0_0RCTRootView alloc] initWithBridge:_bridge
  ...
  rootView.sizeFlexibility = ABI38_0_0RCTRootViewSizeFlexibilityWidthAndHeight;
  self.view = rootView;
}
