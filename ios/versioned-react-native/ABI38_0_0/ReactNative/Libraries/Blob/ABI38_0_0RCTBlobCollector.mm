...
ABI38_0_0RCTBlobCollector::ABI38_0_0RCTBlobCollector(ABI38_0_0RCTBlobManager *blobManager, const std::string &blobId)
: blobId_(blobId), blobManager_(blobManager) {}

ABI38_0_0RCTBlobCollector::~ABI38_0_0RCTBlobCollector() {
  ABI38_0_0RCTBlobManager *blobManager = blobManager_;
...
void ABI38_0_0RCTBlobCollector::install(ABI38_0_0RCTBlobManager *blobManager) {
  __weak ABI38_0_0RCTCxxBridge *cxxBridge = (ABI38_0_0RCTCxxBridge *)blobManager.bridge;
    ...
    runtime.global().setProperty(
      ...
      jsi::Function::createFromHostFunction(
        ...
        [blobManager](jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count) {
          ...
          auto blobCollector = std::make_shared<ABI38_0_0RCTBlobCollector>(blobManager, blobId);
