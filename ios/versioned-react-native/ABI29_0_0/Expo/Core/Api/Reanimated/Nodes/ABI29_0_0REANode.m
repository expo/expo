...
@interface ABI29_0_0REAUpdateContext ()

@property (nonatomic, nonnull) NSMutableArray<ABI29_0_0REANode *> *updatedNodes;
@property (nonatomic) NSUInteger loopID;

@end

@implementation ABI29_0_0REAUpdateContext
...
@interface ABI29_0_0REANode ()

@property (nonatomic) NSUInteger lastLoopID;
@property (nonatomic) id memoizedValue;
@property (nonatomic, nullable) NSMutableArray<ABI29_0_0REANode *> *childNodes;

@end

@implementation ABI29_0_0REANode
...
- (void)addChild:(ABI29_0_0REANode *)child
{
  if (!_childNodes) {
...
- (void)removeChild:(ABI29_0_0REANode *)child
{
  if (child) {
...
+ (NSMutableArray<ABI29_0_0REANode *> *)updatedNodes
{
  static NSMutableArray<ABI29_0_0REANode *> *updatedNodes;
...
+ (void)findAndUpdateNodes:(nonnull ABI29_0_0REANode *)node
            withVisitedSet:(NSMutableSet<ABI29_0_0REANode *> *)visitedNodes
{
  ...
  if ([node respondsToSelector:@selector(update)]) {
    ...
    for (ABI29_0_0REANode *child in node.childNodes) {
      [self findAndUpdateNodes:child withVisitedSet:visitedNodes];
    }
  }
}

+ (void)runPropUpdates:(ABI29_0_0REAUpdateContext *)context
{
  NSMutableSet<ABI29_0_0REANode *> *visitedNodes = [NSMutableSet new];
