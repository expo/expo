#import "ABI29_0_0REATransformNode.h"

#import "ABI29_0_0REANodesManager.h"

@implementation ABI29_0_0REATransformNode
{
...
- (id)evaluate
{
  ...
  for (NSDictionary *transformConfig in _transformConfigs) {
    ...
    ABI29_0_0REANodeID nodeID = transformConfig[@"nodeID"];
    NSNumber *value;
    if (nodeID) {
      ABI29_0_0REANode *node = [self.nodesManager findNodeByID:nodeID];
      value = [node value];
    } else {
