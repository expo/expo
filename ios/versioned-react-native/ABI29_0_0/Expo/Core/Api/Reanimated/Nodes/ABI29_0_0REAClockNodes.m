#import "ABI29_0_0REAClockNodes.h"
#import "ABI29_0_0REANodesManager.h"

@interface ABI29_0_0REAClockNode ()
...
@implementation ABI29_0_0REAClockNode
...
- (void)start
{
  ...
  __weak ABI29_0_0REAClockNode *weakSelf = self;
...
@implementation ABI29_0_0REAClockOpNode {
...
- (ABI29_0_0REAClockNode*)clockNode
{
  return (ABI29_0_0REAClockNode*)[self.nodesManager findNodeByID:_clockNodeID];
}

@end

@implementation ABI29_0_0REAClockStartNode
...
@implementation ABI29_0_0REAClockStopNode
...
@implementation ABI29_0_0REAClockTestNode
