...
@interface ABI29_0_0RNSVGRenderable : ABI29_0_0RNSVGNode

@property (nonatomic, strong) ABI29_0_0RNSVGBrush *fill;
@property (nonatomic, assign) CGFloat fillOpacity;
@property (nonatomic, assign) ABI29_0_0RNSVGCGFCRule fillRule;
@property (nonatomic, strong) ABI29_0_0RNSVGBrush *stroke;
...
@property (nonatomic, assign) ABI29_0_0RNSVGCGFloatArray strokeDasharrayData;
...
- (void)mergeProperties:(__kindof ABI29_0_0RNSVGRenderable *)target;
