...
#import "ABI29_0_0RNSVGViewBox.h"
#import "ABI29_0_0RNSVGNode.h"
#import <ReactABI29_0_0/ABI29_0_0RCTLog.h>

@implementation ABI29_0_0RNSVGSvgView
{
    NSMutableDictionary<NSString *, ABI29_0_0RNSVGNode *> *_clipPaths;
    NSMutableDictionary<NSString *, ABI29_0_0RNSVGNode *> *_templates;
    NSMutableDictionary<NSString *, ABI29_0_0RNSVGPainter *> *_painters;
    CGRect _boundingBox;
...
- (void)setMeetOrSlice:(ABI29_0_0RNSVGVBMOS)meetOrSlice
{
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.align) {
        _viewBoxTransform = [ABI29_0_0RNSVGViewBox getTransform:CGRectMake(self.minX, self.minY, self.vbWidth, self.vbHeight)
                                                 eRect:rect
                                                 align:self.align
    ...
    for (ABI29_0_0RNSVGNode *node in self.subviews) {
        if ([node isKindOfClass:[ABI29_0_0RNSVGNode class]]) {
...
{
    if (self.align) {
        for (ABI29_0_0RNSVGNode *node in [self.subviews reverseObjectEnumerator]) {
            if (![node isKindOfClass:[ABI29_0_0RNSVGNode class]]) {
                continue;
            }
...
- (void)ReactABI29_0_0SetInheritedBackgroundColor:(UIColor *)inheritedBackgroundColor
{
...
- (void)defineTemplate:(ABI29_0_0RNSVGNode *)template templateName:(NSString *)templateName
{
    if (!_templates) {
