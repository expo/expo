...
@implementation ABI29_0_0RNSVGImage
{
    CGImageRef _image;
    CGSize _imageSize;
}
...
- (void)setSrc:(id)src
{
    ...
    _image = CGImageRetain([ABI29_0_0RCTConvert CGImage:src]);
    ABI29_0_0RCTImageSource *source = [ABI29_0_0RCTConvert ABI29_0_0RCTImageSource:src];
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    CGAffineTransform viewbox = [ABI29_0_0RNSVGViewBox getTransform:imageBounds eRect:hitArea align:self.align meetOrSlice:self.meetOrSlice];
