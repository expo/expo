...
@implementation ABI29_0_0RNSVGNode
{
    ABI29_0_0RNSVGGroup *_textRoot;
    ABI29_0_0RNSVGGlyphContext *glyphContext;
    BOOL _transparent;
    CGPathRef _cachedClipPath;
    ABI29_0_0RNSVGSvgView *_svgView;
}

CGFloat const ABI29_0_0M_SQRT1_2l = 0.707106781186547524400844362104849039;
CGFloat const ABI29_0_0RNSVG_DEFAULT_FONT_SIZE = 12;
...
- (void)invalidate
{
    id<ABI29_0_0RNSVGContainer> container = (id<ABI29_0_0RNSVGContainer>)self.superview;
    [container invalidate];
}

- (ABI29_0_0RNSVGGroup *)getTextRoot
{
    ABI29_0_0RNSVGNode* node = self;
    if (_textRoot == nil) {
        while (node != nil) {
            if ([node isKindOfClass:[ABI29_0_0RNSVGGroup class]] && [((ABI29_0_0RNSVGGroup*) node) getGlyphContext] != nil) {
                _textRoot = (ABI29_0_0RNSVGGroup*)node;
                break;
            }
            ...
            if (![node isKindOfClass:[ABI29_0_0RNSVGNode class]]) {
                ...
                node = (ABI29_0_0RNSVGNode*)parent;
            }
        }
    }
...
{
    ABI29_0_0RNSVGNode* parent = (ABI29_0_0RNSVGGroup*)[self superview];
    if (![parent isKindOfClass:[ABI29_0_0RNSVGGroup class]]) {
        return nil;
    } else {
...
{
    ABI29_0_0RNSVGGroup* root = [self getTextRoot];
    if (root == nil) {
        return ABI29_0_0RNSVG_DEFAULT_FONT_SIZE;
    }
...
- (ABI29_0_0RNSVGSvgView *)getSvgView
{
    ...
    if ([parent class] == [ABI29_0_0RNSVGSvgView class]) {
        _svgView = parent;
    } else if ([parent isKindOfClass:[ABI29_0_0RNSVGNode class]]) {
        ABI29_0_0RNSVGNode *node = parent;
        _svgView = [node getSvgView];
    } else {
        ABI29_0_0RCTLogError(@"ABI29_0_0RNSVG: %@ should be descendant of a SvgViewShadow.", NSStringFromClass(self.class));
    }
...
{
    return [ABI29_0_0RNSVGPropHelper fromRelativeWithNSString:length
...
- (CGFloat)relativeOnOther:(NSString *)length
{
    ...
    CGFloat r = sqrt(powX + powY) * ABI29_0_0M_SQRT1_2l;
    return [ABI29_0_0RNSVGPropHelper fromRelativeWithNSString:length
                                         relative:r
                                           offset:0
                                            scale:1
...
{
    ABI29_0_0RNSVGGroup * root = [self getTextRoot];
    ABI29_0_0RNSVGGlyphContext * gc = [root getGlyphContext];
    if (root == nil || gc == nil) {
