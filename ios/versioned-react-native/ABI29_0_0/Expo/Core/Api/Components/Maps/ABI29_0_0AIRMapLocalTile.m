...
#import "ABI29_0_0AIRMapLocalTileOverlay.h"

@implementation ABI29_0_0AIRMapLocalTile {
...
- (void) createTileOverlayAndRendererIfPossible
{
    ...
    self.tileOverlay = [[ABI29_0_0AIRMapLocalTileOverlay alloc] initWithURLTemplate:self.pathTemplate];
