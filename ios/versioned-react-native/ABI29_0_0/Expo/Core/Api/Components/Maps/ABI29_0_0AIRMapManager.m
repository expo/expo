...
#import "ABI29_0_0AIRMapManager.h"
...
#import "ABI29_0_0AIRMapSnapshot.h"
...
@interface ABI29_0_0AIRMapManager() <MKMapViewDelegate>

@end

@implementation ABI29_0_0AIRMapManager
  
ABI29_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI29_0_0AIRMap *map = [ABI29_0_0AIRMap new];
    map.delegate = self;
...
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(userLocationAnnotationTitle, NSString)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(showsPointsOfInterest, BOOL)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
...
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(cacheEnabled, BOOL)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(maxDelta, CGFloat)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(minDelta, CGFloat)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(legalLabelInsets, UIEdgeInsets)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, MKMapType)
...
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(onPanDrag, ABI29_0_0RCTBubblingEventBlock)
...
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI29_0_0RCTDirectEventBlock)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI29_0_0RCTDirectEventBlock)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI29_0_0RCTDirectEventBlock)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI29_0_0RCTDirectEventBlock)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI29_0_0RCTDirectEventBlock)
ABI29_0_0RCT_EXPORT_VIEW_PROPERTY(onCalloutPress, ABI29_0_0RCTDirectEventBlock)
ABI29_0_0RCT_CUSTOM_VIEW_PROPERTY(initialRegion, MKCoordinateRegion, ABI29_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setInitialRegion:[ABI29_0_0RCTConvert MKCoordinateRegion:json]];
...
ABI29_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI29_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setRegion:[ABI29_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI29_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI29_0_0AIRMap class]]) {
            ABI29_0_0RCTLogError(@"Invalid view returned from registry, expecting ABI29_0_0AIRMap, got: %@", view);
        } else {
            [ABI29_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI29_0_0AIRMap *)view setRegion:region animated:YES];
            }];
        }
    }];
}
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI29_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI29_0_0AIRMap class]]) {
            ...
            ABI29_0_0AIRMap *mapView = (ABI29_0_0AIRMap *)view;
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI29_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI29_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ABI29_0_0AIRMapMarker *marker = (ABI29_0_0AIRMapMarker *)evaluatedObject;
                return [marker isKindOfClass:[ABI29_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
                  ...
                  rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI29_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        ABI29_0_0AIRMap *mapView = (ABI29_0_0AIRMap *)view;
        if (![view isKindOfClass:[ABI29_0_0AIRMap class]]) {
            reject(@"Invalid argument", [NSString stringWithFormat:@"Invalid view returned from registry, expecting ABI29_0_0AIRMap, got: %@", view], NULL);
        } else {
...
- (void)takeMapSnapshot:(ABI29_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI29_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI29_0_0AIRMap *map = (ABI29_0_0AIRMap *)recognizer.view;
    ...
    ABI29_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI29_0_0AIRMapPolygon class]]){
            ABI29_0_0AIRMapPolygon *polygon = (ABI29_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI29_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI29_0_0AIRMapPolyline class]]){
            ABI29_0_0AIRMapPolyline *polyline = (ABI29_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
        ...
        if ([overlay isKindOfClass:[ABI29_0_0AIRMapOverlay class]]) {
            ABI29_0_0AIRMapOverlay *imageOverlay = (ABI29_0_0AIRMapOverlay*) overlay;
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI29_0_0AIRMapPolyline class]]) {
        return ((ABI29_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI29_0_0AIRMapPolygon class]]) {
        return ((ABI29_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI29_0_0AIRMapCircle class]]) {
        return ((ABI29_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI29_0_0AIRMapUrlTile class]]) {
        return ((ABI29_0_0AIRMapUrlTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI29_0_0AIRMapLocalTile class]]) {
        return ((ABI29_0_0AIRMapLocalTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI29_0_0AIRMapOverlay class]]) {
        return ((ABI29_0_0AIRMapOverlay *)overlay).renderer;
...
- (void)mapView:(ABI29_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI29_0_0AIRMapMarker class]]) {
        [(ABI29_0_0AIRMapMarker *)view.annotation showCalloutView];
...
- (void)mapView:(ABI29_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI29_0_0AIRMapMarker class]]) {
        [(ABI29_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI29_0_0AIRMap *)mapView viewForAnnotation:(ABI29_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI29_0_0AIRMapMarker class]]) {
...
- (void)mapView:(ABI29_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI29_0_0AIRMapMarker class]]) return;
    ABI29_0_0AIRMapMarker *marker = (ABI29_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI29_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI29_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI29_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI29_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI29_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    [self _regionChanged:mapView];

    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI29_0_0AIRMapRegionChangeObserveInterval
                                                               target:self
                                                             selector:@selector(_onTick:)
                                                             userInfo:@{ ABI29_0_0RCTMapViewKey: mapView }
                                                              repeats:YES];

    [[NSRunLoop mainRunLoop] addTimer:mapView.regionChangeObserveTimer forMode:NSRunLoopCommonModes];
}

- (void)mapView:(ABI29_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI29_0_0AIRMap *)mapView
{
    if (!mapView.hasStartedRendering) {
      mapView.onMapReady(@{}); 
...
- (void)mapViewDidFinishRenderingMap:(ABI29_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
{
    [self _regionChanged:timer.userInfo[ABI29_0_0RCTMapViewKey]];
}

- (void)_regionChanged:(ABI29_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI29_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI29_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI29_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI29_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI29_0_0AIRMap *)mapView
{
...
- (MKCoordinateSpan)coordinateSpanWithMapView:(ABI29_0_0AIRMap *)mapView
                             centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                 andZoomLevel:(double)zoomLevel
{
    // convert center coordiate to pixel space
    double centerPixelX = [ABI29_0_0AIRMapManager longitudeToPixelSpaceX:centerCoordinate.longitude];
    double centerPixelY = [ABI29_0_0AIRMapManager latitudeToPixelSpaceY:centerCoordinate.latitude];

    // determine the scale value from the zoom level
    double zoomExponent = ABI29_0_0AIRMapMaxZoomLevel - zoomLevel;
    ...
    CLLocationDegrees minLng = [ABI29_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX];
    CLLocationDegrees maxLng = [ABI29_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX + scaledMapWidth];
    CLLocationDegrees longitudeDelta = maxLng - minLng;

    // find delta between top and bottom latitudes
    CLLocationDegrees minLat = [ABI29_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY];
    CLLocationDegrees maxLat = [ABI29_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY + scaledMapHeight];
                    ...
                    mapView:(ABI29_0_0AIRMap *)mapView
{
    ...
    zoomLevel = MIN(zoomLevel, ABI29_0_0AIRMapMaxZoomLevel);
                                    ...
                                    andZoomLevel:(double)zoomLevel
{
	...
	// find delta between top and bottom latitudes
	CLLocationDegrees minLat = [ABI29_0_0AIRMapManager pixelSpaceYToLatitude:topPixelY];
	CLLocationDegrees maxLat = [ABI29_0_0AIRMapManager pixelSpaceYToLatitude:bottomPixelY];
	CLLocationDegrees latitudeDelta = -1 * (maxLat - minLat);
	...
	if (adjustedCenterPoint) {
		region.center.latitude = [ABI29_0_0AIRMapManager pixelSpaceYToLatitude:((bottomPixelY + topPixelY) / 2.0)];
	}
...
- (double) zoomLevel:(ABI29_0_0AIRMap *)mapView {
    ...
    double centerPixelX = [ABI29_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude];
    double topLeftPixelX = [ABI29_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude - region.span.longitudeDelta / 2];

    double scaledMapWidth = (centerPixelX - topLeftPixelX) * 2;
    CGSize mapSizeInPixels = mapView.bounds.size;
    double zoomScale = scaledMapWidth / mapSizeInPixels.width;
    double zoomExponent = log(zoomScale) / log(2);
    double zoomLevel = ABI29_0_0AIRMapMaxZoomLevel - zoomExponent;
