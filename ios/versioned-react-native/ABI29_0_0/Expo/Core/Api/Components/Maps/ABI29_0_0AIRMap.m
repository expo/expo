...
const CLLocationDegrees ABI29_0_0AIRMapDefaultSpan = 0.005;
const NSTimeInterval ABI29_0_0AIRMapRegionChangeObserveInterval = 0.1;
const CGFloat ABI29_0_0AIRMapZoomBoundBuffer = 0.01;
const NSInteger ABI29_0_0AIRMapMaxZoomLevel = 20;
...
@implementation ABI29_0_0AIRMap
{
    UIView *_legalLabel;
    CLLocationManager *_locationManager;
    BOOL _initialRegionSet;

    // Array to manually track ABI29_0_0RN subviews
    //
    // ABI29_0_0AIRMap implicitly creates subviews that aren't regular ABI29_0_0RN children
    // (ABI29_0_0SMCalloutView injects an overlay subview), which otherwise confuses ABI29_0_0RN
    // during component re-renders:
    // https://github.com/facebook/ReactABI29_0_0-native/blob/v0.16.0/ReactABI29_0_0/Modules/ABI29_0_0RCTUIManager.m#L657
    //
    // Implementation based on ABI29_0_0RCTTextField, another component with indirect children
    // https://github.com/facebook/ReactABI29_0_0-native/blob/v0.16.0/Libraries/Text/ABI29_0_0RCTTextField.m#L20
...
- (instancetype)init
{
    if ((self = [super init])) {
        ...
        self.calloutView = [ABI29_0_0SMCalloutView platformCalloutView];
        self.calloutView.delegate = self;

        self.minZoomLevel = 0;
        self.maxZoomLevel = ABI29_0_0AIRMapMaxZoomLevel;
    }
    return self;
}
...
- (void)insertReactABI29_0_0Subview:(id<ABI29_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
    ...
    if ([subview isKindOfClass:[ABI29_0_0AIRMapMarker class]]) {
        [self addAnnotation:(id <MKAnnotation>) subview];
    } else if ([subview isKindOfClass:[ABI29_0_0AIRMapPolyline class]]) {
        ((ABI29_0_0AIRMapPolyline *)subview).map = self;
        [self addOverlay:(id<MKOverlay>)subview];
    } else if ([subview isKindOfClass:[ABI29_0_0AIRMapPolygon class]]) {
        ((ABI29_0_0AIRMapPolygon *)subview).map = self;
        [self addOverlay:(id<MKOverlay>)subview];
    } else if ([subview isKindOfClass:[ABI29_0_0AIRMapCircle class]]) {
        ((ABI29_0_0AIRMapCircle *)subview).map = self;
        [self addOverlay:(id<MKOverlay>)subview];
    } else if ([subview isKindOfClass:[ABI29_0_0AIRMapUrlTile class]]) {
        ((ABI29_0_0AIRMapUrlTile *)subview).map = self;
        [self addOverlay:(id<MKOverlay>)subview];
    } else if ([subview isKindOfClass:[ABI29_0_0AIRMapLocalTile class]]) {
        ((ABI29_0_0AIRMapLocalTile *)subview).map = self;
        [self addOverlay:(id<MKOverlay>)subview];
    } else if ([subview isKindOfClass:[ABI29_0_0AIRMapOverlay class]]) {
        ((ABI29_0_0AIRMapOverlay *)subview).map = self;
        [self addOverlay:(id<MKOverlay>)subview];
    } else {
...
#pragma mark ABI29_0_0SMCalloutViewDelegate
