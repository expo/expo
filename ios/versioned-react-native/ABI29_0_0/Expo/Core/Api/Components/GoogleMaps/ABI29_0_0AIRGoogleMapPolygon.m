//
//  ABI29_0_0AIRGoogleMapPolygon.m
//
...
@implementation ABI29_0_0AIRGoogleMapPolygon

- (instancetype)init
{
  if (self = [super init]) {
    _polygon = [[ABI29_0_0AIRGMSPolygon alloc] init];
  }
...
- (void)setHoles:(NSArray<NSArray<ABI29_0_0AIRMapCoordinate *> *> *)holes
{
  _holes = holes;
