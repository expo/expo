...
#import "ABI29_0_0AIRDummyView.h"
...
@interface ABI29_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI29_0_0AIRGMSMarker*)marker;
@end

@implementation ABI29_0_0AIRGoogleMapMarker {
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI29_0_0AIRGMSMarker alloc] init];
...
- (void)insertReactABI29_0_0Subview:(id<ABI29_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI29_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI29_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI29_0_0AIRDummyView *dummySubview = [[ABI29_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertReactABI29_0_0Subview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeReactABI29_0_0Subview:(id<ABI29_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI29_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeReactABI29_0_0Subview:(UIView*)dummySubview];
}
...
- (void)setOnPress:(ABI29_0_0RCTBubblingEventBlock)onPress {
  _realMarker.onPress = onPress;
}

- (ABI29_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/airbnb/ReactABI29_0_0-native-maps/issues/738)
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI29_0_0RN?
