...
#import "ABI29_0_0EXImageManipulator.h"
#import "ABI29_0_0EXFileSystem.h"
#import "ABI29_0_0EXImageUtils.h"
...
@implementation ABI29_0_0EXImageManipulator

ABI29_0_0RCT_EXPORT_MODULE(ExponentImageManipulator);
...
ABI29_0_0RCT_EXPORT_METHOD(manipulate:(NSString *)uri
              ...
              rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject
{
  for (NSDictionary *options in actions) {
    if (options[@"resize"]) {
      ...
      image = [ABI29_0_0EXImageUtils cropImage:image toRect:cropDimensions];
    }
  }
  ...
  if ([format isEqualToString:@"jpeg"]) {
    ...
    ABI29_0_0RCTLogWarn(@"Unsupported format: %@, using JPEG instead.", format);
    imageData = UIImageJPEGRepresentation(image, compressionValue);
    extension = @".jpg";
  }
