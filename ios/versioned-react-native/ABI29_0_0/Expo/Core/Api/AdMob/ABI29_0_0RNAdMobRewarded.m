#import "ABI29_0_0RNAdMobRewarded.h"

static NSString *const ABI29_0_0EXAdMobRewardedDidRewardUser = @"rewardedVideoDidRewardUser";
static NSString *const ABI29_0_0EXAdMobRewardedDidLoad = @"rewardedVideoDidLoad";
static NSString *const ABI29_0_0EXAdMobRewardedDidFailToLoad = @"rewardedVideoDidFailToLoad";
static NSString *const ABI29_0_0EXAdMobRewardedDidOpen = @"rewardedVideoDidOpen";
static NSString *const ABI29_0_0EXAdMobRewardedDidStart = @"rewardedVideoDidStart";
static NSString *const ABI29_0_0EXAdMobRewardedDidClose = @"rewardedVideoDidClose";
static NSString *const ABI29_0_0EXAdMobRewardedWillLeaveApplication = @"rewardedVideoWillLeaveApplication";

@implementation ABI29_0_0RNAdMobRewarded {
  NSString *_adUnitID;
...
{
  return @[
           ABI29_0_0EXAdMobRewardedDidRewardUser,
           ABI29_0_0EXAdMobRewardedDidLoad,
           ABI29_0_0EXAdMobRewardedDidFailToLoad,
           ABI29_0_0EXAdMobRewardedDidOpen,
           ABI29_0_0EXAdMobRewardedDidStart,
           ABI29_0_0EXAdMobRewardedDidClose,
           ABI29_0_0EXAdMobRewardedWillLeaveApplication,
           ];
}
...
- (void)rewardBasedVideoAd:(GADRewardBasedVideoAd *)rewardBasedVideoAd didRewardUserWithReward:(GADAdReward *)reward {
  [self _maybeSendEventWithName:ABI29_0_0EXAdMobRewardedDidRewardUser body:@{ @"type": reward.type, @"amount": reward.amount }];
}

- (void)rewardBasedVideoAdDidReceiveAd:(GADRewardBasedVideoAd *)rewardBasedVideoAd {
  [self _maybeSendEventWithName:ABI29_0_0EXAdMobRewardedDidLoad body:nil];
  _requestAdResolver(nil);
  [self _cleanupRequestAdPromise];
}

- (void)rewardBasedVideoAdDidOpen:(GADRewardBasedVideoAd *)rewardBasedVideoAd {
  [self _maybeSendEventWithName:ABI29_0_0EXAdMobRewardedDidOpen body:nil];
  _showAdResolver(nil);
  _showAdResolver = nil;
}

- (void)rewardBasedVideoAdDidStartPlaying:(GADRewardBasedVideoAd *)rewardBasedVideoAd {
  [self _maybeSendEventWithName:ABI29_0_0EXAdMobRewardedDidStart body:nil];
}

- (void)rewardBasedVideoAdDidClose:(GADRewardBasedVideoAd *)rewardBasedVideoAd {
  [self _maybeSendEventWithName:ABI29_0_0EXAdMobRewardedDidClose body:nil];
}

- (void)rewardBasedVideoAdWillLeaveApplication:(GADRewardBasedVideoAd *)rewardBasedVideoAd {
  [self _maybeSendEventWithName:ABI29_0_0EXAdMobRewardedWillLeaveApplication body:nil];
}

- (void)rewardBasedVideoAd:(GADRewardBasedVideoAd *)rewardBasedVideoAd didFailToLoadWithError:(NSError *)error {
  [self _maybeSendEventWithName:ABI29_0_0EXAdMobRewardedDidFailToLoad body:@{ @"name": [error description] }];
