...
@interface ABI29_0_0RNDFPBannerView : UIView <GADBannerViewDelegate, GADAppEventDelegate>
...
@property (nonatomic, copy) ABI29_0_0RCTBubblingEventBlock onAdmobDispatchAppEvent;
