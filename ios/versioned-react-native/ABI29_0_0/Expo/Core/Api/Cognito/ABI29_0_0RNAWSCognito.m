#import "ABI29_0_0RNAWSCognito.h"
...
@implementation ABI29_0_0RNAWSCognito
...
ABI29_0_0RCT_EXPORT_METHOD(computeModPow:(NSDictionary *)values
    ...
    if (result) {
        ...
        callback(@[@[ABI29_0_0RCTMakeError(@"computeModPow error", nil, nil)], [NSNull null]]);
    }
}

ABI29_0_0RCT_EXPORT_METHOD(computeS:(NSDictionary *)values
                  callback:(ABI29_0_0RCTResponseSenderBlock)callback) {
    ...
    if (result) {
        ...
        callback(@[@[ABI29_0_0RCTMakeError(@"computeS error", nil, nil)], [NSNull null]]);
    }
}
