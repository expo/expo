...
#import "ABI29_0_0EXCalendar.h"
#import "ABI29_0_0EXCalendarConverter.h"
#import "ABI29_0_0EXScopedModuleRegistry.h"
#import "ABI29_0_0EXCalendarRequester.h"
#import "ABI29_0_0EXRemindersRequester.h"
...
@implementation ABI29_0_0EXCalendar

@synthesize bridge = _bridge;

ABI29_0_0EX_EXPORT_SCOPED_MODULE(ExponentCalendar, PermissionsManager);
...
ABI29_0_0RCT_EXPORT_METHOD(getCalendarsAsync:(NSString *)typeString resolver:(ABI29_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI29_0_0EXPermissions statusForPermissions:[ABI29_0_0EXCalendarRequester permissions]] != ABI29_0_0EXPermissionStatusGranted ||
  ...
  resolve([ABI29_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI29_0_0RCT_EXPORT_METHOD(saveCalendarAsync:(NSDictionary *)details resolver:(ABI29_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI29_0_0EXPermissions statusForPermissions:[ABI29_0_0EXCalendarRequester permissions]] != ABI29_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  NSString *title = [ABI29_0_0RCTConvert NSString:details[@"title"]];
  NSNumber *color = [ABI29_0_0RCTConvert NSNumber:details[@"color"]];
  NSString *sourceId = [ABI29_0_0RCTConvert NSString:details[@"sourceId"]];
  NSString *type = [ABI29_0_0RCTConvert NSString:details[@"entityType"]];
  NSString *calendarId = [ABI29_0_0RCTConvert NSString:details[@"id"]];
  ...
  if (color) {
    calendar.CGColor = [ABI29_0_0RCTConvert UIColor:color].CGColor;
...
ABI29_0_0RCT_EXPORT_METHOD(deleteCalendarAsync:(NSString *)calendarId resolver:(ABI29_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI29_0_0EXPermissions statusForPermissions:[ABI29_0_0EXCalendarRequester permissions]] != ABI29_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
...
ABI29_0_0RCT_EXPORT_METHOD(getEventsAsync:(NSDate *)startDate endDate:(NSDate *)endDate calendars:(NSArray *)calendars resolver:(ABI29_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI29_0_0EXPermissions statusForPermissions:[ABI29_0_0EXCalendarRequester permissions]] != ABI29_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  if (calendarEvents) {
    resolve([ABI29_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI29_0_0RCT_EXPORT_METHOD(getEventByIdAsync:(NSString *)eventId startDate:(NSDate *)startDate resolver:(ABI29_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI29_0_0EXPermissions statusForPermissions:[ABI29_0_0EXCalendarRequester permissions]] != ABI29_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  if (calendarEvent) {
    resolve([ABI29_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI29_0_0RCT_EXPORT_METHOD(saveEventAsync:(NSDictionary *)details options:(NSDictionary *)options resolver:(ABI29_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI29_0_0EXPermissions statusForPermissions:[ABI29_0_0EXCalendarRequester permissions]] != ABI29_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  if (details[@"calendarId"]) {
    calendarId = [ABI29_0_0RCTConvert NSString:details[@"calendarId"]];
  }
  NSString *eventId = [ABI29_0_0RCTConvert NSString:details[@"id"]];
  NSString *title = [ABI29_0_0RCTConvert NSString:details[@"title"]];
  NSString *location = [ABI29_0_0RCTConvert NSString:details[@"location"]];
  NSDate *startDate = [ABI29_0_0RCTConvert NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI29_0_0RCTConvert NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI29_0_0RCTConvert NSDate:details[@"instanceStartDate"]];
  NSNumber *allDay = [ABI29_0_0RCTConvert NSNumber:details[@"allDay"]];
  NSString *notes = [ABI29_0_0RCTConvert NSString:details[@"notes"]];
  NSString *timeZone = [ABI29_0_0RCTConvert NSString:details[@"timeZone"]];
  NSString *url = [ABI29_0_0RCTConvert NSString:details[@"url"]];
  NSArray *alarms = [ABI29_0_0RCTConvert NSArray:details[@"alarms"]];
  NSDictionary *recurrenceRule = [ABI29_0_0RCTConvert NSDictionary:details[@"recurrenceRule"]];
  NSString *availability = [ABI29_0_0RCTConvert NSString:details[@"availability"]];
  ...
  if (recurrenceRule) {
    NSString *frequency = [ABI29_0_0RCTConvert NSString:recurrenceRule[@"frequency"]];
    NSInteger interval = [ABI29_0_0RCTConvert NSInteger:recurrenceRule[@"interval"]];
    NSInteger occurrence = [ABI29_0_0RCTConvert NSInteger:recurrenceRule[@"occurrence"]];
    NSDate *endDate = nil;
    if (recurrenceRule[@"endDate"]) {
      endDate = [ABI29_0_0RCTConvert NSDate:recurrenceRule[@"endDate"]];
    }
...
ABI29_0_0RCT_EXPORT_METHOD(deleteEventAsync:(NSDictionary *)event options:(NSDictionary *)options resolver:(ABI29_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI29_0_0EXPermissions statusForPermissions:[ABI29_0_0EXCalendarRequester permissions]] != ABI29_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  NSDate *instanceStartDate = [ABI29_0_0RCTConvert NSDate:event[@"instanceStartDate"]];
...
ABI29_0_0RCT_EXPORT_METHOD(getAttendeesForEventAsync:(NSDictionary *)event resolver:(ABI29_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI29_0_0EXPermissions statusForPermissions:[ABI29_0_0EXCalendarRequester permissions]] != ABI29_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"calendar" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing calendar permission.", nil);
  ...
  if (item.hasAttendees) {
    resolve([ABI29_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI29_0_0RCT_EXPORT_METHOD(getRemindersAsync:(NSDate * _Nullable)startDate endDate:(NSDate * _Nullable)endDate calendars:(NSArray *)calendars status:(NSString * _Nullable)status resolver:(ABI29_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI29_0_0EXPermissions statusForPermissions:[ABI29_0_0EXRemindersRequester permissions]] != ABI29_0_0EXPermissionStatusGranted ||
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI29_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI29_0_0RCT_EXPORT_METHOD(getReminderByIdAsync:(NSString *)reminderId resolver:(ABI29_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI29_0_0EXPermissions statusForPermissions:[ABI29_0_0EXRemindersRequester permissions]] != ABI29_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"reminders" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing reminders permission.", nil);
  ...
  if (reminder) {
    ...
    resolve([ABI29_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI29_0_0RCT_EXPORT_METHOD(saveReminderAsync:(NSDictionary *)details resolver:(ABI29_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI29_0_0EXPermissions statusForPermissions:[ABI29_0_0EXRemindersRequester permissions]] != ABI29_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"reminders" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing reminders permission.", nil);
  ...
  NSString *reminderId = [ABI29_0_0RCTConvert NSString:details[@"id"]];
  NSDate *startDate = [ABI29_0_0RCTConvert NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI29_0_0RCTConvert NSDate:details[@"dueDate"]];
  NSNumber *completed = [ABI29_0_0RCTConvert NSNumber:details[@"completed"]];
  NSDate *completionDate = [ABI29_0_0RCTConvert NSDate:details[@"completionDate"]];
  NSString *title = [ABI29_0_0RCTConvert NSString:details[@"title"]];
  NSString *location = [ABI29_0_0RCTConvert NSString:details[@"location"]];
  NSString *notes = [ABI29_0_0RCTConvert NSString:details[@"notes"]];
  NSString *timeZone = [ABI29_0_0RCTConvert NSString:details[@"timeZone"]];
...
ABI29_0_0RCT_EXPORT_METHOD(deleteReminderAsync:(NSString *)reminderId resolver:(ABI29_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI29_0_0EXPermissions statusForPermissions:[ABI29_0_0EXRemindersRequester permissions]] != ABI29_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"reminders" forExperience:self.experienceId]) {
    reject(@"E_MISSING_PERMISSION", @"Missing reminders permission.", nil);
...
ABI29_0_0RCT_EXPORT_METHOD(getSourcesAsync:(ABI29_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI29_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI29_0_0RCT_EXPORT_METHOD(getSourceByIdAsync:(NSString *)sourceId resolver:(ABI29_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve([ABI29_0_0EXCalendarConverter serializeSource:source]);
}
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI29_0_0RCTConvert NSDate:alarm[@"absoluteDate"]];
  NSNumber *relativeOffset = [ABI29_0_0RCTConvert NSNumber:alarm[@"relativeOffset"]];
