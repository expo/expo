...
#import "ABI29_0_0EXDocumentPicker.h"
...
static NSString * ABI29_0_0EXConvertMimeTypeToUTI(NSString *mimeType)
{
  CFStringRef uti;
...
@interface ABI29_0_0EXDocumentPicker () <UIDocumentMenuDelegate, UIDocumentPickerDelegate>
...
@implementation ABI29_0_0EXDocumentPicker

@synthesize bridge = _bridge;

ABI29_0_0RCT_EXPORT_MODULE(ExponentDocumentPicker)

ABI29_0_0RCT_EXPORT_METHOD(getDocumentAsync:(NSDictionary *)options resolver:(ABI29_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI29_0_0RCTPromiseRejectBlock)reject) {
  _resolve = resolve;
  _reject = reject;

  NSString *type = ABI29_0_0EXConvertMimeTypeToUTI(options[@"type"] ?: @"*/*");

  if (options[@"copyToCacheDirectory"] && [ABI29_0_0RCTConvert BOOL:options[@"copyToCacheDirectory"]] == NO) {
  ...
  if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
    documentMenuVC.popoverPresentationController.sourceRect = CGRectMake(CGRectGetMidX([ABI29_0_0RCTPresentedViewController().view frame]), CGRectGetMaxY([ABI29_0_0RCTPresentedViewController().view frame]), 0, 0);
    documentMenuVC.popoverPresentationController.sourceView = ABI29_0_0RCTPresentedViewController().view;
