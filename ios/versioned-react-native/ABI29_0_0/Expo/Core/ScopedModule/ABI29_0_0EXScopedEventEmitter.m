...
@implementation ABI29_0_0EXScopedEventEmitter

+ (NSString *)moduleName
{
  NSAssert(NO, @"ABI29_0_0EXScopedEventEmitter is abstract, you should only export subclasses to the bridge.");
...
{
  if (eventEmitter) {
    return ((ABI29_0_0EXScopedEventEmitter *)eventEmitter).experienceId;
  }
  return nil;
}
