...
#if !TARGET_OS_TV
@implementation ABI29_0_0RCTConvert (ABI29_0_0EXStatusBar)

ABI29_0_0RCT_ENUM_CONVERTER(UIStatusBarStyle, (@{
  @"default": @(UIStatusBarStyleDefault),
  @"light-content": @(UIStatusBarStyleLightContent),
  @"dark-content": @(UIStatusBarStyleDefault),
}), UIStatusBarStyleDefault, integerValue);

ABI29_0_0RCT_ENUM_CONVERTER(UIStatusBarAnimation, (@{
...
@interface ABI29_0_0EXStatusBarManager ()

@property (nonatomic, strong) NSMutableDictionary *capturedStatusBarProperties;

@end

@implementation ABI29_0_0EXStatusBarManager

+ (NSString *)moduleName { return @"ABI29_0_0RCTStatusBarManager"; }
...
ABI29_0_0RCT_EXPORT_METHOD(getHeight:(ABI29_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@{
...
ABI29_0_0RCT_EXPORT_METHOD(setStyle:(UIStatusBarStyle)statusBarStyle
                  animated:(BOOL)animated)
{
  if ([[self class] _viewControllerBasedStatusBarAppearance]) {
    ABI29_0_0RCTLogError(@"ABI29_0_0RCTStatusBarManager module requires that the \
                UIViewControllerBasedStatusBarAppearance key in the Info.plist is set to NO");
  } else {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ABI29_0_0RCTSharedApplication() setStatusBarStyle:statusBarStyle
                                     animated:animated];
...
ABI29_0_0RCT_EXPORT_METHOD(setHidden:(BOOL)hidden
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ABI29_0_0RCTSharedApplication() setStatusBarHidden:hidden
...
ABI29_0_0RCT_EXPORT_METHOD(setNetworkActivityIndicatorVisible:(BOOL)visible)
{
  ABI29_0_0RCTSharedApplication().networkActivityIndicatorVisible = visible;
 ...
 */
ABI29_0_0RCT_REMAP_METHOD(_captureProperties,
                 _capturePropertiesWithResolver:(ABI29_0_0RCTPromiseResolveBlock)resolve
 ...
 *  Normally nobody should use this method because it bypasses the JS state used by the StatusBar component.
 */
ABI29_0_0RCT_EXPORT_METHOD(_applyPropertiesAndForget:(NSDictionary *)properties)
{
...
{
  UIApplication *currentApplication = ABI29_0_0RCTSharedApplication();
  return @{
