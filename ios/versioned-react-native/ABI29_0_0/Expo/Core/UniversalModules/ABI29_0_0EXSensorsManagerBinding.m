...
@interface ABI29_0_0EXSensorsManagerBinding ()

@property (nonatomic, strong) NSString *experienceId;
@property (nonatomic, weak) id<ABI29_0_0EXSensorsManagerBindingDelegate> kernelService;

@end

@implementation ABI29_0_0EXSensorsManagerBinding
