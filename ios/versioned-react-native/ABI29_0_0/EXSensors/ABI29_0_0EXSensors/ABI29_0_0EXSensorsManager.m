...
#import <ABI29_0_0EXSensors/ABI29_0_0EXSensorsManager.h>
#import <CoreMotion/CoreMotion.h>

@interface ABI29_0_0EXSensorsManager ()
...
@implementation ABI29_0_0EXSensorsManager

ABI29_0_0EX_REGISTER_MODULE();

+ (const NSArray<Protocol *> *)exportedInterfaces
{
  return @[@protocol(ABI29_0_0EXAccelerometerInterface), @protocol(ABI29_0_0EXDeviceMotionInterface), @protocol(ABI29_0_0EXGyroscopeInterface), @protocol(ABI29_0_0EXMagnetometerInterface), @protocol(ABI29_0_0EXMagnetometerUncalibratedInterface)];
}
                                            ...
                                            withHandler:(void (^)(NSDictionary *event))handlerBlock
{
  ...
  if (![[self manager] isAccelerometerActive]) {
    ...
    __weak ABI29_0_0EXSensorsManager *weakSelf = self;
    [[self manager] startAccelerometerUpdatesToQueue:[NSOperationQueue mainQueue] withHandler:^(CMAccelerometerData *data, NSError *error) {
      __strong ABI29_0_0EXSensorsManager *strongSelf = weakSelf;
      if (strongSelf) {
...
- (void)activateDeviceMotionUpdates
{
  ...
  [[self manager] startDeviceMotionUpdatesUsingReferenceFrame:CMAttitudeReferenceFrameXArbitraryCorrectedZVertical toQueue:[NSOperationQueue mainQueue] withHandler:^(CMDeviceMotion *data, NSError *error) {
    ...
    NSDictionary *result = @{
                             @"acceleration": @{
                                 @"x": @(data.userAcceleration.x * ABI29_0_0EXGravity),
                                 @"y": @(data.userAcceleration.y * ABI29_0_0EXGravity),
                                 @"z": @(data.userAcceleration.z * ABI29_0_0EXGravity)
                                 },
                             @"accelerationIncludingGravity": @{
                                 @"x": @((data.userAcceleration.x + data.gravity.x) * ABI29_0_0EXGravity),
                                 @"y": @((data.userAcceleration.y + data.gravity.y) * ABI29_0_0EXGravity),
                                 @"z": @((data.userAcceleration.z + data.gravity.z) * ABI29_0_0EXGravity)
                                 },
                             @"rotation": @{
