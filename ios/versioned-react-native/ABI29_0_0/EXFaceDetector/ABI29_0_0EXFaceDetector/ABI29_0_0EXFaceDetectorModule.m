...
#import <ABI29_0_0EXFaceDetector/ABI29_0_0EXFaceDetectorModule.h>
#import <ABI29_0_0EXFaceDetector/ABI29_0_0EXFaceEncoder.h>
...
@interface ABI29_0_0EXFaceDetectorModule ()

@property (nonatomic, weak) ABI29_0_0EXModuleRegistry *moduleRegistry;

@end

@implementation ABI29_0_0EXFaceDetectorModule
...
ABI29_0_0EX_EXPORT_MODULE(ExpoFaceDetector);

- (NSDictionary *)constantsToExport
{
  return [ABI29_0_0EXFaceDetectorUtils constantsToExport];
}
...
ABI29_0_0EX_EXPORT_METHOD_AS(detectFaces, detectFaces:(nonnull NSDictionary *)options resolver:(ABI29_0_0EXPromiseResolveBlock)resolve rejecter:(ABI29_0_0EXPromiseRejectBlock)reject) {
...
//    }
    ...
    ABI29_0_0EXFaceEncoder *faceEncoder = [[ABI29_0_0EXFaceEncoder alloc] init];
    ...
    resolve(@{
              ...
              @"image" : @{
                  ...
                  @"orientation" : @([ABI29_0_0EXFaceDetectorModule exifOrientationFor:image.imageOrientation])
                  }
              });
...
// the value of GMVImageOrientation is the same as the value defined by ABI29_0_0EXIF specifications, so we can adapt
