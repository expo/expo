//
//  ABI29_0_0EXFaceDetectorManager.m
//  Exponent
//
...
#import <ABI29_0_0EXFaceDetector/ABI29_0_0EXFaceDetectorManager.h>
...
@interface ABI29_0_0EXFaceDetectorManager() <GMVDataOutputDelegate>
...
@implementation ABI29_0_0EXFaceDetectorManager

ABI29_0_0EX_REGISTER_MODULE();

+ (const NSArray<Protocol *> *)exportedInterfaces {
  return @[@protocol(ABI29_0_0EXFaceDetectorManager)];
}
...
- (void)tryEnablingFaceDetection
{
  ...
  if ([self isDetectingFaces]) {
    @try {
      ...
      ABI29_0_0EXLogWarn(@"%@", [exception description]);
    }
  }
...
- (void)dataOutput:(GMVDataOutput *)dataOutput didFinishedDetection:(NSArray<__kindof GMVFeature *> *)results
{
  ...
  // width or height started happen after refactor: moving face detection logic from ABI29_0_0EXCameraManager to ABI29_0_0EXFaceDetectorManager.
  ...
  CGAffineTransform transform = [ABI29_0_0EXFaceDetectorUtils transformFromDeviceOutput:dataOutput toInterfaceVideoOrientation:interfaceVideoOrientation];
  
  ABI29_0_0EXFaceEncoder *faceEncoder = [[ABI29_0_0EXFaceEncoder alloc] initWithTransform:transform];
