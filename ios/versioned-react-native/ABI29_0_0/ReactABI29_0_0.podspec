...
Pod::Spec.new do |s|
  ...
  s.subspec "Core" do |ss|
    ss.dependency             "yogaABI29_0_0", "#{package["version"]}.React"
    ...
    ss.exclude_files        = "**/__tests__/*",
                              ...
                              "React/Cxx*/*",
                              "React/Fabric/*",
    ss.ios.exclude_files    = "React/**/ABI29_0_0RCTTV*.*"
  ...
  s.subspec "Expo" do |ss|
    ...
    ss.dependency         "ABI29_0_0EXGL"
    ss.dependency         "ABI29_0_0EXCore"
    ss.dependency         "ABI29_0_0EXCamera"
    ss.dependency         "ABI29_0_0EXSensors"
    ss.dependency         "ABI29_0_0EXConstants"
    ss.dependency         "ABI29_0_0EXFileSystem"
    ss.dependency         "ABI29_0_0EXPermissions"
    ss.dependency         "ABI29_0_0EXCameraInterface"
    ss.dependency         "ABI29_0_0EXSensorsInterface"
    ss.dependency         "ABI29_0_0EXConstantsInterface"
    ss.dependency         "ABI29_0_0EXReactNativeAdapter"
    ss.dependency         "ABI29_0_0EXFileSystemInterface"
  ...
  s.subspec "ExpoOptional" do |ss|
    ss.dependency         "ReactABI29_0_0/Expo"
  ...
  s.subspec "DevSupport" do |ss|
    ss.dependency             "ReactABI29_0_0/Core"
    ss.dependency             "ReactABI29_0_0/RCTWebSocket"
  ...
  s.subspec "ABI29_0_0jschelpers" do |ss|
    ...
    ss.private_header_files = "ReactCommon/ABI29_0_0jschelpers/*.h"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\"" }
    ss.framework            = "JavaScriptCore"
  end

  s.subspec "ABI29_0_0jsinspector" do |ss|
    ss.source_files         = "ReactCommon/ABI29_0_0jsinspector/*.{cpp,h}"
    ss.private_header_files = "ReactCommon/ABI29_0_0jsinspector/*.h"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\"" }
  end

  s.subspec "ABI29_0_0PrivateDatabase" do |ss|
    ss.source_files         = "ReactCommon/ABI29_0_0privatedata/*.{cpp,h}"
    ss.private_header_files = "ReactCommon/ABI29_0_0privatedata/*.h"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\"" }
  end

  s.subspec "cxxReactABI29_0_0" do |ss|
    ...
    ss.private_header_files = "ReactCommon/cxxReactABI29_0_0/*.h"
  ...
  s.subspec "RCTAnimation" do |ss|
    ...
    ss.header_dir           = "ABI29_0_0RCTAnimation"
  end
  ...
  s.subspec "RCTImage" do |ss|
    ss.dependency             "ReactABI29_0_0/Core"
    ss.dependency             "ReactABI29_0_0/RCTNetwork"
  ...
  s.subspec "RCTWebSocket" do |ss|
    ss.dependency             "ReactABI29_0_0/Core"
    ss.dependency             "ReactABI29_0_0/RCTBlob"
    ss.dependency             "ReactABI29_0_0/fishhook"
  ...
  s.subspec "_ignore_me_subspec_for_linting_" do |ss|
    ss.dependency             "ReactABI29_0_0/Core"
    ss.dependency             "ReactABI29_0_0/CxxBridge"
  end
end
