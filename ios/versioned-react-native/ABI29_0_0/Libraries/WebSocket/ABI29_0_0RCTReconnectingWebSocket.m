...
#import "ABI29_0_0RCTReconnectingWebSocket.h"
...
@interface ABI29_0_0RCTReconnectingWebSocket () <ABI29_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI29_0_0RCTReconnectingWebSocket {
  NSURL *_url;
  ABI29_0_0RCTSRWebSocket *_socket;
}
...
{
  [self stop];
  _socket = [[ABI29_0_0RCTSRWebSocket alloc] initWithURL:_url];
...
- (void)reconnect
{
  __weak ABI29_0_0RCTSRWebSocket *socket = _socket;
...
- (void)webSocket:(ABI29_0_0RCTSRWebSocket *)webSocket didCloseWithCode:(NSInteger)code reason:(NSString *)reason wasClean:(BOOL)wasClean
{
  [_delegate reconnectingWebSocketDidClose:self];
  [self reconnect];
}
