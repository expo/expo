...
#import "ABI29_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI29_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI29_0_0ViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI29_0_0ViewController detachChildViewController:self.contentViewController];
}
