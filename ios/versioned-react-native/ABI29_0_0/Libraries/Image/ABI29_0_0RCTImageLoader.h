...
typedef void (^ABI29_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI29_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI29_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI29_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI29_0_0RCTImageCache <NSObject>
...
/**
 * If available, ABI29_0_0RCTImageRedirectProtocol is invoked before loading an asset.
 * Implementation should return either a new URL or nil when redirection is
 * not needed.
 */

@protocol ABI29_0_0RCTImageRedirectProtocol

- (NSURL *)redirectAssetsURL:(NSURL *)URL;

@end

@interface UIImage (ReactABI29_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI29_0_0KeyframeAnimation;

@end

@interface ABI29_0_0RCTImageLoader : NSObject <ABI29_0_0RCTBridgeModule, ABI29_0_0RCTURLRequestHandler>
...
- (instancetype)init;
- (instancetype)initWithRedirectDelegate:(id<ABI29_0_0RCTImageRedirectProtocol>)redirectDelegate NS_DESIGNATED_INITIALIZER;
 ...
 * decoded images as long as it conforms to the ABI29_0_0RCTImageCacheDelegate
...
@interface ABI29_0_0RCTBridge (ABI29_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI29_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI29_0_0RCTImageURLLoader <ABI29_0_0RCTBridgeModule>
...
/**
 * If more than one ABI29_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI29_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 * are also bridge modules, so should be registered using ABI29_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI29_0_0RCTImageDataDecoder <ABI29_0_0RCTBridgeModule>
...
/**
 * If more than one ABI29_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
