...
@interface ABI29_0_0RCTImageStoreManager : NSObject <ABI29_0_0RCTURLRequestHandler>
...
@interface ABI29_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI29_0_0RCTBridge (ABI29_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI29_0_0RCTImageStoreManager *imageStoreManager;
