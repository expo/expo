...
#import "ABI29_0_0RCTPhotoLibraryImageLoader.h"

#import <Photos/Photos.h>

#import <ReactABI29_0_0/ABI29_0_0RCTUtils.h>

@implementation ABI29_0_0RCTPhotoLibraryImageLoader

ABI29_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI29_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI29_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (!imageURL) {
    completionHandler(ABI29_0_0RCTErrorWithMessage(@"Cannot load a photo library asset with no URL"), nil);
    return ^{};
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI29_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI29_0_0RCTResizeModeContain) {
