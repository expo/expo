...
#import "ABI29_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI29_0_0/ABI29_0_0RCTConvert.h>
#import <ReactABI29_0_0/ABI29_0_0RCTImageStoreManager.h>
#import <ReactABI29_0_0/ABI29_0_0RCTRootView.h>
#import <ReactABI29_0_0/ABI29_0_0RCTUtils.h>

@interface ABI29_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI29_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI29_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI29_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI29_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI29_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI29_0_0RCTResponseSenderBlock)callback)
{
...
ABI29_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI29_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI29_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI29_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI29_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI29_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI29_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI29_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI29_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI29_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI29_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI29_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI29_0_0RCTNullIfNil(height), ABI29_0_0RCTNullIfNil(width)]];
    return;
  }
        ...
        cancelCallback:(ABI29_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI29_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI29_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI29_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
