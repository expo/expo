...
#define ABI29_0_0RCT_RUN_RUNLOOP_WHILE(CONDITION)                                                          \
{                                                                                                 \
...
/**
 * Use the ABI29_0_0RCTInitRunnerForApp macro for typical usage. See FBSnapshotTestCase.h for more information
 * on how to configure the snapshotting system.
 */
#define ABI29_0_0RCTInitRunnerForApp(app__, moduleProvider__, scriptURL__) \
[[ABI29_0_0RCTTestRunner alloc] initWithApp:(app__) \
...
@class ABI29_0_0RCTRootView;

@interface ABI29_0_0RCTTestRunner : NSObject
...
/**
 * Initialize a runner.  It's recommended that you use the ABI29_0_0RCTInitRunnerForApp
 ...
 *
 *   ABI29_0_0RCTTestModule.markTestCompleted()
 *
 * JS errors/exceptions and timeouts will fail the test.  Snapshot tests call
 * ABI29_0_0RCTTestModule.verifySnapshot whenever they want to verify what has been
