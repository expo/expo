...
@implementation ABI29_0_0RCTBaseTextInputShadowView
{
...
- (instancetype)initWithBridge:(ABI29_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI29_0_0YGNodeSetMeasureFunc(self.yogaNode, ABI29_0_0RCTBaseTextInputShadowViewMeasure);
    ABI29_0_0YGNodeSetBaselineFunc(self.yogaNode, ABI29_0_0RCTTextInputShadowViewBaseline);
  }
...
- (void)uiManagerWillPerformMounting
{
  ...
  ABI29_0_0RCTTextAttributes *textAttributes = [self.textAttributes copy];
  ...
  [attributedText removeAttribute:ABI29_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                            range:NSMakeRange(0, attributedText.length)];

  [attributedText removeAttribute:ABI29_0_0RCTTextAttributesTagAttributeName
                            range:NSMakeRange(0, attributedText.length)];
  ...
  [_bridge.uiManager addUIBlock:^(ABI29_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI29_0_0RCTBaseTextInputView *baseTextInputView = (ABI29_0_0RCTBaseTextInputView *)viewRegistry[tag];
    if (!baseTextInputView) {
      return;
    }

    baseTextInputView.textAttributes = textAttributes;
    baseTextInputView.ReactABI29_0_0BorderInsets = borderInsets;
    baseTextInputView.ReactABI29_0_0PaddingInsets = paddingInsets;
...
- (CGSize)sizeThatFitsMinimumSize:(CGSize)minimumSize maximumSize:(CGSize)maximumSize
{
  ...
  return (CGSize){
    MAX(minimumSize.width, MIN(ABI29_0_0RCTCeilPixelValue(size.width), maximumSize.width)),
    MAX(minimumSize.height, MIN(ABI29_0_0RCTCeilPixelValue(size.height), maximumSize.height))
  };
}
...
static ABI29_0_0YGSize ABI29_0_0RCTBaseTextInputShadowViewMeasure(ABI29_0_0YGNodeRef node, float width, ABI29_0_0YGMeasureMode widthMode, float height, ABI29_0_0YGMeasureMode heightMode)
{
  ...
  return (ABI29_0_0YGSize){
    ABI29_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.width),
    ABI29_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.height)
  };
}

static float ABI29_0_0RCTTextInputShadowViewBaseline(ABI29_0_0YGNodeRef node, const float width, const float height)
{
  ABI29_0_0RCTBaseTextInputShadowView *shadowTextView = (__bridge ABI29_0_0RCTBaseTextInputShadowView *)ABI29_0_0YGNodeGetContext(node);
