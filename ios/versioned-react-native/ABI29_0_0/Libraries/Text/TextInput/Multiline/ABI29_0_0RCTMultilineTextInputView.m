...
@implementation ABI29_0_0RCTMultilineTextInputView
{
  ABI29_0_0RCTUITextView *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI29_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI29_0_0RCTUITextView alloc] initWithFrame:self.bounds];
...
{
  ABI29_0_0RCTDirectEventBlock onScroll = self.onScroll;
