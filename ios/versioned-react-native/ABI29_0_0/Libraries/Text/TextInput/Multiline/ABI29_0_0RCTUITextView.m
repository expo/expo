...
#import "ABI29_0_0RCTUITextView.h"
...
@implementation ABI29_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI29_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI29_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
  }
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI29_0_0RCTCeilPixelValue(placeholderSize.width), ABI29_0_0RCTCeilPixelValue(placeholderSize.height));
