...
#import <ReactABI29_0_0/ABI29_0_0RCTValueAnimatedNode.h>
#import <ReactABI29_0_0/ABI29_0_0RCTBridgeModule.h>
#import <ReactABI29_0_0/ABI29_0_0RCTUIManager.h>

@interface ABI29_0_0RCTNativeAnimatedNodesManager : NSObject
...
- (void)startAnimatingNode:(nonnull NSNumber *)animationId
                   nodeTag:(nonnull NSNumber *)nodeTag
                    config:(NSDictionary<NSString *, id> *__nonnull)config
               endCallback:(nullable ABI29_0_0RCTResponseSenderBlock)callBack;
...
- (void)handleAnimatedEvent:(nonnull id<ABI29_0_0RCTEvent>)event;

// listeners

- (void)startListeningToAnimatedNodeValue:(nonnull NSNumber *)tag
                            valueObserver:(nonnull id<ABI29_0_0RCTValueAnimatedNodeObserver>)valueObserver;
