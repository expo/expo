...
@implementation ABI29_0_0RCTInterpolationAnimatedNode
{
  __weak ABI29_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI29_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI29_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI29_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  self.value = ABI29_0_0RCTInterpolateValueInRange(inputValue,
                                          _inputRange,
                                          _outputRange,
                                          _extrapolateLeft,
                                          _extrapolateRight);
