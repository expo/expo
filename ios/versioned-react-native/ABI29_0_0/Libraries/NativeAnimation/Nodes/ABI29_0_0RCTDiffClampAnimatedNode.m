...
@implementation ABI29_0_0RCTDiffClampAnimatedNode
{
...
{
  ABI29_0_0RCTValueAnimatedNode *inputNode = (ABI29_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI29_0_0RCTValueAnimatedNode class]]) {
    ABI29_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
