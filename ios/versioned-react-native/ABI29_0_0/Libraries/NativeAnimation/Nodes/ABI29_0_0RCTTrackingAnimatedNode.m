...
@implementation ABI29_0_0RCTTrackingAnimatedNode {
...
- (void)performUpdate
{
  ...
  ABI29_0_0RCTValueAnimatedNode *node = (ABI29_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
