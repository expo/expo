...
@implementation ABI29_0_0RCTDecayAnimation
{
  ...
  ABI29_0_0RCTResponseSenderBlock _callback;
}

- (instancetype)initWithId:(NSNumber *)animationId
                    config:(NSDictionary *)config
                   forNode:(ABI29_0_0RCTValueAnimatedNode *)valueNode
                  callBack:(nullable ABI29_0_0RCTResponseSenderBlock)callback;
{
  if ((self = [super init])) {
    ...
    _fromValue = 0;
    _lastValue = 0;
    _velocity = [ABI29_0_0RCTConvert CGFloat:config[@"velocity"]]; // initial velocity
...
{
  NSNumber *iterations = [ABI29_0_0RCTConvert NSNumber:config[@"iterations"]] ?: @1;
  _fromValue = _lastValue;
  _deceleration = [ABI29_0_0RCTConvert CGFloat:config[@"deceleration"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  if (_frameStartTime == -1) {
    ...
    _frameStartTime = currentTime - ABI29_0_0RCTSingleFrameInterval;
