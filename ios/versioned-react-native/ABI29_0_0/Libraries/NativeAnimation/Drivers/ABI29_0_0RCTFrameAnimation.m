...
@interface ABI29_0_0RCTFrameAnimation ()
...
@implementation ABI29_0_0RCTFrameAnimation
{
...
{
  NSNumber *toValue = [ABI29_0_0RCTConvert NSNumber:config[@"toValue"]] ?: @1;
  NSArray<NSNumber *> *frames = [ABI29_0_0RCTConvert NSNumberArray:config[@"frames"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  NSUInteger startIndex = floor(currentDuration / ABI29_0_0RCTSingleFrameInterval);
  ...
  NSTimeInterval fromInterval = startIndex * ABI29_0_0RCTSingleFrameInterval;
  NSTimeInterval toInterval = nextIndex * ABI29_0_0RCTSingleFrameInterval;
  ...
  CGFloat frameOutput = ABI29_0_0RCTInterpolateValue(currentDuration,
                                            fromInterval,
                                            toInterval,
                                            fromFrameValue.doubleValue,
                                            toFrameValue.doubleValue,
                                            ABI29_0_0EXTRAPOLATE_TYPE_EXTEND,
                                            ABI29_0_0EXTRAPOLATE_TYPE_EXTEND);
...
{
  CGFloat outputValue = ABI29_0_0RCTInterpolateValue(frameOutput,
                                            0,
                                            1,
                                            _fromValue,
                                            _toValue,
