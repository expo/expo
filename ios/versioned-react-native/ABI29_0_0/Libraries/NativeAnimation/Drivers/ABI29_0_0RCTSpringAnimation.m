...
@interface ABI29_0_0RCTSpringAnimation ()
...
@implementation ABI29_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
                  ...
                  callBack:(nullable ABI29_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _lastVelocity = [ABI29_0_0RCTConvert CGFloat:config[@"initialVelocity"]];
...
- (void)resetAnimationConfig:(NSDictionary *)config
{
  ...
  _toValue = [ABI29_0_0RCTConvert CGFloat:config[@"toValue"]];
  _overshootClamping = [ABI29_0_0RCTConvert BOOL:config[@"overshootClamping"]];
  _restDisplacementThreshold = [ABI29_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
  _restSpeedThreshold = [ABI29_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
  _stiffness = [ABI29_0_0RCTConvert CGFloat:config[@"stiffness"]];
  _damping = [ABI29_0_0RCTConvert CGFloat:config[@"damping"]];
  _mass = [ABI29_0_0RCTConvert CGFloat:config[@"mass"]];
