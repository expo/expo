...
@property (nonatomic, strong) id<ABI29_0_0EXFaceDetectorManager> faceDetectorManager;
...
@property (nonatomic, strong) ABI29_0_0EXPromiseResolveBlock videoRecordedResolve;
@property (nonatomic, strong) ABI29_0_0EXPromiseRejectBlock videoRecordedReject;

@property (nonatomic, copy) ABI29_0_0EXDirectEventBlock onCameraReady;
@property (nonatomic, copy) ABI29_0_0EXDirectEventBlock onMountError;
@property (nonatomic, copy) ABI29_0_0EXDirectEventBlock onBarCodeRead;
@property (nonatomic, copy) ABI29_0_0EXDirectEventBlock onFacesDetected;
@property (nonatomic, copy) ABI29_0_0EXDirectEventBlock onPictureSaved;

@end

@implementation ABI29_0_0EXCamera
...
- (void)updateType
{
  __weak ABI29_0_0EXCamera *weakSelf = self;
  dispatch_async(_sessionQueue, ^{
    __strong ABI29_0_0EXCamera *strongSelf = weakSelf;
    if (strongSelf) {
...
- (void)updateFlashMode
{
  ...
  if (_flashMode == ABI29_0_0EXCameraFlashModeTorch) {
    if (![device hasTorch]) {
      return;
    }
    ...
    if (![device lockForConfiguration:&error]) {
      if (error) {
        ABI29_0_0EXLogError(@"%s: %@", __func__, error);
      }
      return;
    }
...
- (void)updateFocusDepth
{
  ...
  if (device == nil || device.focusMode != ABI29_0_0EXCameraAutoFocusOff) {
    return;
  }
  ...
  ABI29_0_0EXLogWarn(@"%s: Setting focusDepth isn't supported for this camera device", __func__);
  return;
}
...
- (void)updateWhiteBalance
{
  ...
  if (_whiteBalance == ABI29_0_0EXCameraWhiteBalanceAuto) {
    [device setWhiteBalanceMode:AVCaptureWhiteBalanceModeContinuousAutoWhiteBalance];
    [device unlockForConfiguration];
  } else {
    AVCaptureWhiteBalanceTemperatureAndTintValues temperatureAndTint = {
      .temperature = [ABI29_0_0EXCameraUtils temperatureForWhiteBalance:_whiteBalance],
      .tint = 0,
    };
...
- (void)takePicture:(NSDictionary *)options resolve:(ABI29_0_0EXPromiseResolveBlock)resolve reject:(ABI29_0_0EXPromiseRejectBlock)reject
{
  ...
  [connection setVideoOrientation:[ABI29_0_0EXCameraUtils videoOrientationForDeviceOrientation:[[UIDevice currentDevice] orientation]]];
  ...
  [_stillImageOutput captureStillImageAsynchronouslyFromConnection:connection completionHandler: ^(CMSampleBufferRef imageSampleBuffer, NSError *error) {
    ...
    takenImage = [ABI29_0_0EXCameraUtils cropImage:takenImage toRect:croppedSize];
    ...
    response[@"uri"] = [ABI29_0_0EXCameraUtils writeImage:takenImageData toPath:path];
    ...
    if ([options[@"exif"] boolValue]) {
      ...
      [ABI29_0_0EXCameraUtils updatePhotoMetadata:imageSampleBuffer withAdditionalData:@{ @"Orientation": @(imageRotation) } inResponse:response]; // TODO
    }
...
- (void)record:(NSDictionary *)options resolve:(ABI29_0_0EXPromiseResolveBlock)resolve reject:(ABI29_0_0EXPromiseRejectBlock)reject
{
  ...
  if (_movieFileOutput != nil && !_movieFileOutput.isRecording && _videoRecordedResolve == nil && _videoRecordedReject == nil) {
    ...
    if (options[@"quality"]) {
      ABI29_0_0EXCameraVideoResolution resolution = [options[@"quality"] integerValue];
      preset = [ABI29_0_0EXCameraUtils captureSessionPresetForVideoResolution:resolution];
    ...
    [connection setVideoOrientation:[ABI29_0_0EXCameraUtils videoOrientationForInterfaceOrientation:[[UIApplication sharedApplication] statusBarOrientation]]];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    [strongSelf setRuntimeErrorHandlingObserver:
     [[NSNotificationCenter defaultCenter] addObserverForName:AVCaptureSessionRuntimeErrorNotification object:strongSelf.session queue:nil usingBlock:^(NSNotification *note) {
      __strong ABI29_0_0EXCamera *innerStrongSelf = weakSelf;
      if (innerStrongSelf) {
        dispatch_async(innerStrongSelf.sessionQueue, ^{
          __strong ABI29_0_0EXCamera *innerInnerStrongSelf = weakSelf;
...
- (void)initializeCaptureSessionInput
{
  ...
  AVCaptureVideoOrientation orientation = [ABI29_0_0EXCameraUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI29_0_0EXCameraUtils deviceWithMediaType:AVMediaTypeVideo preferringPosition:strongSelf.presetCamera];
    ...
    if (strongSelf) {
      ...
      if (!isMuted) {
        ...
        if (error || audioDeviceInput == nil) {
          ABI29_0_0EXLogWarn(@"%s: %@", __func__, error);
          return;
        }
...
{
  __weak ABI29_0_0EXCamera *weakSelf = self;
  AVCaptureVideoOrientation videoOrientation = [ABI29_0_0EXCameraUtils videoOrientationForInterfaceOrientation:orientation];
  [ABI29_0_0EXUtilities performSynchronouslyOnMainThread:^{
    __strong ABI29_0_0EXCamera *strongSelf = weakSelf;
...
{
  id <ABI29_0_0EXFaceDetectorManager> faceDetector = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI29_0_0EXFaceDetectorManager)];
  if (faceDetector) {
    __weak ABI29_0_0EXCamera *weakSelf = self;
