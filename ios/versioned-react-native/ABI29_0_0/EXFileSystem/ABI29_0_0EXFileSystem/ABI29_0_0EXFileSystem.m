...
#import <ABI29_0_0EXFileSystem/ABI29_0_0EXFileSystemLocalFileHandler.h>
#import <ABI29_0_0EXFileSystem/ABI29_0_0EXFileSystemAssetLibraryHandler.h>
...
NSString * const ABI29_0_0EXDownloadProgressEventName = @"Exponent.downloadProgress";

@interface ABI29_0_0EXDownloadResumable : NSObject

@property (nonatomic, strong) NSString *uuid;
@property (nonatomic, strong) NSURLSession *session;
@property (nonatomic, strong) ABI29_0_0EXDownloadDelegate *delegate;

@end

@implementation ABI29_0_0EXDownloadResumable

- (instancetype)initWithId:(NSString *)uuid
               withSession:(NSURLSession *)session
              withDelegate:(ABI29_0_0EXDownloadDelegate *)delegate;
{
  if ((self = [super init])) {
    _uuid = uuid;
    _session = session;
...
@interface ABI29_0_0EXFileSystem ()

@property (nonatomic, strong) NSMutableDictionary<NSString *, ABI29_0_0EXDownloadResumable*> *downloadObjects;
...
@property (nonatomic, weak) id<ABI29_0_0EXFileSystemManager> fileSystemManager;

@end

@implementation NSData (ABI29_0_0EXFileSystem)
...
@implementation ABI29_0_0EXFileSystem
...
{
  return @[@protocol(ABI29_0_0EXFileSystemInterface)];
}
...
- (instancetype)initWithExperienceId:(NSString *)experienceId
{
  if (self = [super init]) {
    ...
    [ABI29_0_0EXFileSystem ensureDirExistsWithPath:_documentDirectory];
    [ABI29_0_0EXFileSystem ensureDirExistsWithPath:_cachesDirectory];
  }
  return self;
}
...
- (void)setModuleRegistry:(ABI29_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  _eventEmitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI29_0_0EXEventEmitterService)];
  _fileSystemManager = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI29_0_0EXFileSystemManager)];
}
...
{
  return @[ABI29_0_0EXDownloadProgressEventName];
}
...
ABI29_0_0EX_EXPORT_METHOD_AS(getInfoAsync,
                    ...
                    rejecter:(ABI29_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:uri] & ABI29_0_0EXFileSystemPermissionRead)) {
  ...
  if ([uri.scheme isEqualToString:@"file"]) {
    [ABI29_0_0EXFileSystemLocalFileHandler getInfoForFile:uri withOptions:options resolver:resolve rejecter:reject];
  } else if ([uri.scheme isEqualToString:@"assets-library"]) {
    [ABI29_0_0EXFileSystemAssetLibraryHandler getInfoForFile:uri withOptions:options resolver:resolve rejecter:reject];
  } else {
...
ABI29_0_0EX_EXPORT_METHOD_AS(readAsStringAsync,
...
ABI29_0_0EX_EXPORT_METHOD_AS(writeAsStringAsync,
...
{
  NSURL *uri = [NSURL URLWithString:uriString];
  if (!([self permissionsForURI:uri] & ABI29_0_0EXFileSystemPermissionWrite)) {
    reject(@"E_FILESYSTEM_PERMISSIONS",
...
ABI29_0_0EX_EXPORT_METHOD_AS(deleteAsync,
...
{
  NSURL *uri = [NSURL URLWithString:uriString];
  if (!([self permissionsForURI:[uri URLByAppendingPathComponent:@".."]] & ABI29_0_0EXFileSystemPermissionWrite)) {
    reject(@"E_FILESYSTEM_PERMISSIONS",
...
ABI29_0_0EX_EXPORT_METHOD_AS(moveAsync,
                    ...
                    rejecter:(ABI29_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:[from URLByAppendingPathComponent:@".."]] & ABI29_0_0EXFileSystemPermissionWrite)) {
    reject(@"E_FILESYSTEM_PERMISSIONS",
  ...
  if (!([self permissionsForURI:to] & ABI29_0_0EXFileSystemPermissionWrite)) {
    reject(@"E_FILESYSTEM_PERMISSIONS",
...
ABI29_0_0EX_EXPORT_METHOD_AS(copyAsync,
                    ...
                    rejecter:(ABI29_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:from] & ABI29_0_0EXFileSystemPermissionRead)) {
    reject(@"E_FILESYSTEM_PERMISSIONS",
  ...
  if ([from.scheme isEqualToString:@"file"]) {
    [ABI29_0_0EXFileSystemLocalFileHandler copyFrom:from to:to resolver:resolve rejecter:reject];
  } else if ([from.scheme isEqualToString:@"assets-library"]) {
    [ABI29_0_0EXFileSystemAssetLibraryHandler copyFrom:from to:to resolver:resolve rejecter:reject];
  } else {
    reject(@"E_FILESYSTEM_INVALID_URI",
           [NSString stringWithFormat:@"Unsupported URI scheme for '%@'", from],
           nil);
...
ABI29_0_0EX_EXPORT_METHOD_AS(makeDirectoryAsync,
...
ABI29_0_0EX_EXPORT_METHOD_AS(readDirectoryAsync,
...
ABI29_0_0EX_EXPORT_METHOD_AS(downloadAsync,
                    ...
                    rejecter:(ABI29_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:localUri] & ABI29_0_0EXFileSystemPermissionWrite)) {
    reject(@"E_FILESYSTEM_PERMISSIONS",
...
ABI29_0_0EX_EXPORT_METHOD_AS(downloadResumableStartAsync,
                    ...
                    rejecter:(ABI29_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([self _permissionsForPath:path] & ABI29_0_0EXFileSystemPermissionWrite)) {
    reject(@"E_FILESYSTEM_PERMISSIONS",
...
ABI29_0_0EX_EXPORT_METHOD_AS(downloadResumablePauseAsync,
                    downloadResumablePauseAsyncWithUUID:(NSString *)uuid
                    resolver:(ABI29_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI29_0_0EXPromiseRejectBlock)reject)
{
  ABI29_0_0EXDownloadResumable *downloadResumable = (ABI29_0_0EXDownloadResumable *)self.downloadObjects[uuid];
...
- (void)_downloadResumableCreateSessionWithUrl:(NSURL *)url withScopedPath:(NSString *)scopedPath withUUID:(NSString *)uuid withOptions:(NSDictionary *)options withResumeData:(NSData * _Nullable)resumeData withResolver:(ABI29_0_0EXPromiseResolveBlock)resolve withRejecter:(ABI29_0_0EXPromiseRejectBlock)reject
{
  NSURLSessionConfiguration *sessionConfiguration = [NSURLSessionConfiguration defaultSessionConfiguration];
  sessionConfiguration.requestCachePolicy = NSURLRequestReloadIgnoringLocalCacheData;
  sessionConfiguration.URLCache = nil;
  ...
  ABI29_0_0EXDownloadDelegateOnWriteCallback onWrite = ^(NSURLSessionDownloadTask *task, int64_t bytesWritten, int64_t totalBytesWritten, int64_t totalBytesExpectedToWrite) {
    __strong ABI29_0_0EXFileSystem *strongSelf = weakSelf;
    if (strongSelf && bytesWritten > 0) {
      [strongSelf sendEventWithName:ABI29_0_0EXDownloadProgressEventName
                               body:@{@"uuid":uuid,
                                      @"data":@{
  ...
  ABI29_0_0EXDownloadDelegateOnDownloadCallback onDownload = ^(NSURLSessionDownloadTask *task, NSURL *location) {
  ...
  ABI29_0_0EXDownloadDelegateOnErrorCallback onError = ^(NSError *error) {
  ...
  ABI29_0_0EXDownloadDelegate *downloadDelegate = [[ABI29_0_0EXDownloadDelegate alloc] initWithId:uuid
                                                                        onWrite:onWrite
  ...
  ABI29_0_0EXDownloadResumable *downloadResumable = [[ABI29_0_0EXDownloadResumable alloc] initWithId:uuid
                                                                       withSession:session
...
- (ABI29_0_0EXFileSystemPermissionFlags)_permissionsForPath:(NSString *)path
{
  path = [path stringByStandardizingPath];
  if ([path hasPrefix:[_documentDirectory stringByAppendingString:@"/"]]) {
    return ABI29_0_0EXFileSystemPermissionRead | ABI29_0_0EXFileSystemPermissionWrite;
  }
  ...
  if (bundleDirectory != nil && [path hasPrefix:[bundleDirectory stringByAppendingString:@"/"]]) {
    return ABI29_0_0EXFileSystemPermissionRead;
  }
  return ABI29_0_0EXFileSystemPermissionNone;
}
...
{
  return [ABI29_0_0EXFileSystem ensureDirExistsWithPath:path];
}
...
{
  return [ABI29_0_0EXFileSystem documentDirectoryForExperienceId:experienceId];
}
...
{
  return [ABI29_0_0EXFileSystem cachesDirectoryForExperienceId:experienceId];
}
...
{
  return [ABI29_0_0EXFileSystem generatePathInDirectory:directory withExtension:extension];
}
...
+ (NSString *)generatePathInDirectory:(NSString *)directory withExtension:(NSString *)extension
{
  ...
  [ABI29_0_0EXFileSystem ensureDirExistsWithPath:directory];
