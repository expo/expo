...
struct ABI29_0_0YGLayout {
  ...
  ABI29_0_0YGDirection lastParentDirection;

  uint32_t nextCachedMeasurementsIndex;
  std::array<ABI29_0_0YGCachedMeasurement, ABI29_0_0YG_MAX_CACHED_RESULT_COUNT>
      cachedMeasurements;
  std::array<float, 2> measuredDimensions;

  ABI29_0_0YGCachedMeasurement cachedLayout;
  bool didUseLegacyFlag;
  bool doesLegacyStretchFlagAffectsLayout;

  ABI29_0_0YGLayout();

  bool operator==(ABI29_0_0YGLayout layout) const;
  bool operator!=(ABI29_0_0YGLayout layout) const;
};
