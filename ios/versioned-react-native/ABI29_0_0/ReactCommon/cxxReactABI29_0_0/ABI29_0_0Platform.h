...
#ifdef __APPLE__
using LogTaggedMarker = std::function<void(const ReactABI29_0_0MarkerId, const char* tag)>;
#else
typedef void(*LogTaggedMarker)(const ReactABI29_0_0MarkerId, const char* tag);
#endif
extern RN_EXPORT LogTaggedMarker logTaggedMarker;

extern void logMarker(const ReactABI29_0_0MarkerId markerId);
