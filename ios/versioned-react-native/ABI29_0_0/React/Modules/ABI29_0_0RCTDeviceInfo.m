...
#if !TARGET_OS_TV
  _currentInterfaceOrientation = [ABI29_0_0RCTSharedApplication() statusBarOrientation];
...
static BOOL ABI29_0_0RCTIsIPhoneX() {
...
static NSDictionary *ABI29_0_0RCTExportedDimensions(ABI29_0_0RCTBridge *bridge)
{
  ABI29_0_0RCTAssertMainQueue();

  ABI29_0_0RCTDimensions dimensions = ABI29_0_0RCTGetDimensions(bridge.accessibilityManager.multiplier);
...
{
  return @{
    @"Dimensions": ABI29_0_0RCTExportedDimensions(_bridge),
    // Note:
    // This prop is deprecated and will be removed right after June 01, 2018.
    // Please use this only for a quick and temporary solution.
    // Use <SafeAreaView> instead.
    @"isIPhoneX_deprecated": @(ABI29_0_0RCTIsIPhoneX()),
  };
}
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [bridge.eventDispatcher sendDeviceEventWithName:@"didUpdateDimensions"
                                        body:ABI29_0_0RCTExportedDimensions(bridge)];
...
{
  UIInterfaceOrientation nextOrientation = [ABI29_0_0RCTSharedApplication() statusBarOrientation];
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
        [_bridge.eventDispatcher sendDeviceEventWithName:@"didUpdateDimensions"
                                                    body:ABI29_0_0RCTExportedDimensions(_bridge)];
#pragma clang diagnostic pop
      }
