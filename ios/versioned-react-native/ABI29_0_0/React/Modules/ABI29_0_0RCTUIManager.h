 ...
 */
ABI29_0_0RCT_EXTERN NSString *const ABI29_0_0RCTUIManagerWillUpdateViewsDueToContentSizeMultiplierChangeNotification;

@class ABI29_0_0RCTLayoutAnimationGroup;
@class ABI29_0_0RCTUIManagerObserverCoordinator;

/**
 * The ABI29_0_0RCTUIManager is the module responsible for updating the view hierarchy.
 */
@interface ABI29_0_0RCTUIManager : NSObject <ABI29_0_0RCTBridgeModule, ABI29_0_0RCTInvalidating>
...
/**
 * Register a root view with the ABI29_0_0RCTUIManager.
 */
- (void)registerRootView:(UIView *)rootView;

/**
 * Gets the view name associated with a ReactABI29_0_0Tag.
 */
- (NSString *)viewNameForReactABI29_0_0Tag:(NSNumber *)ReactABI29_0_0Tag;

/**
 * Gets the view associated with a ReactABI29_0_0Tag.
 */
- (UIView *)viewForReactABI29_0_0Tag:(NSNumber *)ReactABI29_0_0Tag;

/**
 * Gets the shadow view associated with a ReactABI29_0_0Tag.
 */
 ...
 * or some other layout event outside of the ReactABI29_0_0-managed view hierarchy.
 */
...
/**
 * Given a ReactABI29_0_0Tag from a component, find its root view, if possible.
 * Otherwise, this will give back nil.
 *
 * @param ReactABI29_0_0Tag the component tag
 ...
 * @param rootTag the ReactABI29_0_0 tag of root view hierarchy from which to find the view.
 */
 ...
 * ReactABI29_0_0 won't be aware of this, so we need to make sure it happens.
 */
- (void)setNeedsLayout;

/**
 * Dedicated object for subscribing for UIManager events.
 * See `ABI29_0_0RCTUIManagerObserver` protocol for more details.
 */
@property (atomic, retain, readonly) ABI29_0_0RCTUIManagerObserverCoordinator *observerCoordinator;

@end

/**
 * This category makes the current ABI29_0_0RCTUIManager instance available via the
 * ABI29_0_0RCTBridge, which is useful for ABI29_0_0RCTBridgeModules or ABI29_0_0RCTViewManagers that
 * need to access the ABI29_0_0RCTUIManager.
 */
@interface ABI29_0_0RCTBridge (ABI29_0_0RCTUIManager)

@property (nonatomic, readonly) ABI29_0_0RCTUIManager *uiManager;
