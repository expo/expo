...
#import "ABI29_0_0RCTRedBoxExtraDataViewController.h"

@interface ABI29_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI29_0_0RCTRedBoxExtraDataCell
...
@interface ABI29_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI29_0_0RCTRedBoxExtraDataViewController
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ABI29_0_0RCTRedBoxExtraDataCell *cell =
            (ABI29_0_0RCTRedBoxExtraDataCell *)[tableView
            dequeueReusableCellWithIdentifier:reuseIdentifier];

    if (cell == nil) {
        cell = [[ABI29_0_0RCTRedBoxExtraDataCell alloc]
