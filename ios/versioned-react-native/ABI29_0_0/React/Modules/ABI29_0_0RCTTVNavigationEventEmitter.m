...
NSString *const ABI29_0_0RCTTVNavigationEventNotification = @"ABI29_0_0RCTTVNavigationEventNotification";

static NSString *const TVNavigationEventName = @"onHWKeyEvent";

@implementation ABI29_0_0RCTTVNavigationEventEmitter
  ...
  if (self = [super init]) {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(handleTVNavigationEventNotification:)
                                                 name:ABI29_0_0RCTTVNavigationEventNotification
                                               object:nil];
