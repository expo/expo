...
@protocol ABI29_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI29_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI29_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI29_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI29_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI29_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI29_0_0RCTBridge *)bridge;
...
*/
- (BOOL)bridge:(ABI29_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI29_0_0RCTBridge *)bridge
                 onProgress:(ABI29_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI29_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI29_0_0RCTBridge *)bridge
                  withBlock:(ABI29_0_0RCTSourceLoadBlock)loadCallback;
