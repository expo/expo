...
@interface ABI29_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI29_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI29_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI29_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI29_0_0RCTMultipartStreamReader *reader = [[ABI29_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI29_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
