...
extern NSString *const ABI29_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI29_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI29_0_0RCTBundleURLProvider : NSObject
