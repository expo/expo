...
typedef id<ABI29_0_0RCTBridgeModule>(^ABI29_0_0RCTBridgeModuleProvider)(void);

@interface ABI29_0_0RCTModuleData : NSObject <ABI29_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI29_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI29_0_0RCTBridgeModule> instance;
