 ...
 */
@interface ABI29_0_0RCTImageSource : NSObject
...
@interface ABI29_0_0RCTConvert (ImageSource)

+ (ABI29_0_0RCTImageSource *)ABI29_0_0RCTImageSource:(id)json;
+ (NSArray<ABI29_0_0RCTImageSource *> *)ABI29_0_0RCTImageSourceArray:(id)json;
