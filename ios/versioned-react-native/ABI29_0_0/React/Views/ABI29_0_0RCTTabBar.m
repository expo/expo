...
@interface ABI29_0_0RCTTabBar() <UITabBarControllerDelegate>

@end

@implementation ABI29_0_0RCTTabBar
{
  BOOL _tabsChanged;
...
- (void)insertReactABI29_0_0Subview:(ABI29_0_0RCTTabBarItem *)subview atIndex:(NSInteger)atIndex
{
  if (![subview isKindOfClass:[ABI29_0_0RCTTabBarItem class]]) {
    ABI29_0_0RCTLogError(@"subview should be of type ABI29_0_0RCTTabBarItem");
    return;
  }
...
- (void)removeReactABI29_0_0Subview:(ABI29_0_0RCTTabBarItem *)subview
{
  if (self.ReactABI29_0_0Subviews.count == 0) {
    ABI29_0_0RCTLogError(@"should have at least one view to remove a subview");
    return;
  }
...
- (void)layoutSubviews
{
  ...
  [self ReactABI29_0_0AddControllerToClosestParent:_tabController];
...
- (void)uiManagerDidPerformMounting
{
  ...
  if (_tabsChanged) {
    ...
    for (ABI29_0_0RCTTabBarItem *tab in [self ReactABI29_0_0Subviews]) {
      UIViewController *controller = tab.ReactABI29_0_0ViewController;
      if (!controller) {
        controller = [[ABI29_0_0RCTWrapperViewController alloc] initWithContentView:tab];
      }
  ...
  [self.ReactABI29_0_0Subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger index, __unused BOOL *stop) {

    ABI29_0_0RCTTabBarItem *tab = (ABI29_0_0RCTTabBarItem *)view;
...
- (void)tabBarController:(UITabBarController *)tabBarController didSelectViewController:(nonnull UIViewController *)viewController
{
  ...
  ABI29_0_0RCTTabBarItem *tab = (ABI29_0_0RCTTabBarItem *)self.ReactABI29_0_0Subviews[index];
