...
@interface UIView (ReactABI29_0_0) <ABI29_0_0RCTComponent>

/**
 * ABI29_0_0RCTComponent interface.
 */
- (NSArray<UIView *> *)ReactABI29_0_0Subviews NS_REQUIRES_SUPER;
- (UIView *)ReactABI29_0_0Superview NS_REQUIRES_SUPER;
- (void)insertReactABI29_0_0Subview:(UIView *)subview atIndex:(NSInteger)atIndex NS_REQUIRES_SUPER;
- (void)removeReactABI29_0_0Subview:(UIView *)subview NS_REQUIRES_SUPER;
 ...
 */
@property (nonatomic, assign) ABI29_0_0YGDisplay ReactABI29_0_0Display;

/**
 * The z-index of the view.
 */
@property (nonatomic, assign) NSInteger ReactABI29_0_0ZIndex;
...
/**
 * Updates the subviews array based on the ReactABI29_0_0Subviews. Default behavior is
 * to insert the sortedReactABI29_0_0Subviews into the UIView.
 */
 ...
 */
@property (nonatomic, readonly) UIEdgeInsets ReactABI29_0_0BorderInsets;
@property (nonatomic, readonly) UIEdgeInsets ReactABI29_0_0PaddingInsets;
@property (nonatomic, readonly) UIEdgeInsets ReactABI29_0_0CompoundInsets;
@property (nonatomic, readonly) CGRect ReactABI29_0_0ContentFrame;
 ...
 * Defaults to `self`.
 */
@property (nonatomic, readonly) UIView *ReactABI29_0_0AccessibilityElement;
