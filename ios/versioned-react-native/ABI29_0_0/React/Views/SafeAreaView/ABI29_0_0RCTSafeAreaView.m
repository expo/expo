...
@implementation ABI29_0_0RCTSafeAreaView {
...
- (void)safeAreaInsetsDidChange
{
  ...
  if (UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI29_0_0RCTScreenScale())) {
    return;
  }

  _currentSafeAreaInsets = safeAreaInsets;

  ABI29_0_0RCTSafeAreaViewLocalData *localData =
    [[ABI29_0_0RCTSafeAreaViewLocalData alloc] initWithInsets:safeAreaInsets];
