...
#import <ReactABI29_0_0/ABI29_0_0RCTPointerEvents.h>
#import <ReactABI29_0_0/ABI29_0_0RCTView.h>

@protocol ABI29_0_0RCTAutoInsetsProtocol;

@class ABI29_0_0RCTView;

@interface ABI29_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI29_0_0RCTDirectEventBlock onAccessibilityAction;
@property (nonatomic, copy) ABI29_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI29_0_0RCTDirectEventBlock onMagicTap;
 ...
 */
@property (nonatomic, assign) ABI29_0_0RCTPointerEvents pointerEvents;
 ...
 * This is inherited from UIView+ReactABI29_0_0, but we override it here
 * to improve performance and make subclassing/overriding possible/easier.
 */
@property (nonatomic, assign) UIUserInterfaceLayoutDirection ReactABI29_0_0LayoutDirection;
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI29_0_0RCTBorderStyle borderStyle;
