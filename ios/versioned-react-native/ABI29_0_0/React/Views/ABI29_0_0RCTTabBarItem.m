...
@implementation ABI29_0_0RCTConvert (UITabBarSystemItem)

ABI29_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI29_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI29_0_0ViewController;
}
