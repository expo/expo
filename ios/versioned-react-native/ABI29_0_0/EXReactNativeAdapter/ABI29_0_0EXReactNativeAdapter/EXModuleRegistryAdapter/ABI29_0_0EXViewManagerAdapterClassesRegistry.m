...
@interface ABI29_0_0EXViewManagerAdapterClassesRegistry ()

@property (nonatomic, strong) NSMutableDictionary<Class, Class> *viewManagerAdaptersClasses;

@end

@implementation ABI29_0_0EXViewManagerAdapterClassesRegistry
...
- (Class)_createViewManagerAdapterClassForViewManager:(ABI29_0_0EXViewManager *)viewManager
{
  ...
  Class viewManagerAdapterClass = objc_allocateClassPair([ABI29_0_0EXViewManagerAdapter class], viewManagerClassName, 0);
...
- (void)_ensureDirectEventBlockImplementationIsPresent
{
  dispatch_once(&directEventBlockImplementationOnceToken, ^{
    directEventBlockImplementation = imp_implementationWithBlock(^{
      return @[@"ABI29_0_0RCTDirectEventBlock"];
    });
  });
}
