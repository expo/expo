...
@interface ABI29_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) id<ABI29_0_0EXCameraInterface> camera;
...
@implementation ABI29_0_0EXGLCameraObject
