...
#import "ABI47_0_0EXScopedSecureStore.h"

@interface ABI47_0_0EXSecureStore (Protected)
...
@interface ABI47_0_0EXScopedSecureStore ()
...
@implementation ABI47_0_0EXScopedSecureStore
         ...
         withOptions:(NSDictionary *)options
{
  ...
  if (setValue) {
    ...
    ABI47_0_0EXLogWarn(@"Encountered an error while saving SecureStore data: %@.", [[super class] _messageForError:error]);
  }
}
