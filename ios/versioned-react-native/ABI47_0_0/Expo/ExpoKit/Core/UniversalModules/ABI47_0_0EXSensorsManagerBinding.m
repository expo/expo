...
#import "ABI47_0_0EXSensorsManagerBinding.h"

@interface ABI47_0_0EXSensorsManagerBinding ()

@property (nonatomic, strong) NSString *scopeKey;
@property (nonatomic, weak) id<ABI47_0_0EXSensorsManagerBindingDelegate> kernelService;

@end

@implementation ABI47_0_0EXSensorsManagerBinding
