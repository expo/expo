//
//  ABI47_0_0AIRGoogleMapManager.m
//  AirMaps
//
...
#import "ABI47_0_0AIRGoogleMapManager.h"
...
@interface ABI47_0_0AIRGoogleMapManager() <GMSMapViewDelegate>
{
  BOOL didCallOnMapReady;
}
@end

@implementation ABI47_0_0AIRGoogleMapManager
...
- (UIView *)view
{
  ...
  ABI47_0_0AIRGoogleMap *map = [ABI47_0_0AIRGoogleMap new];
...
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(initialCamera, GMSCameraPosition)
ABI47_0_0RCT_REMAP_VIEW_PROPERTY(camera, cameraProp, GMSCameraPosition)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(initialRegion, MKCoordinateRegion)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(region, MKCoordinateRegion)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
//ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)  // Not supported by GoogleMaps
...
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(scrollDuringRotateOrZoomEnabled, BOOL)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(pitchEnabled, BOOL)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(zoomTapEnabled, BOOL)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(showsUserLocation, BOOL)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(showsMyLocationButton, BOOL)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(showsIndoors, BOOL)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(showsIndoorLevelPicker, BOOL)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(customMapStyleString, NSString)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(mapPadding, UIEdgeInsets)
ABI47_0_0RCT_REMAP_VIEW_PROPERTY(paddingAdjustmentBehavior, paddingAdjustmentBehaviorString, NSString)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(onMapReady, ABI47_0_0RCTBubblingEventBlock)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(onMapLoaded, ABI47_0_0RCTBubblingEventBlock)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(onKmlReady, ABI47_0_0RCTBubblingEventBlock)
...
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(onRegionChange, ABI47_0_0RCTDirectEventBlock)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(onRegionChangeComplete, ABI47_0_0RCTDirectEventBlock)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(onPoiClick, ABI47_0_0RCTDirectEventBlock)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(onIndoorLevelActivated, ABI47_0_0RCTDirectEventBlock)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(onIndoorBuildingFocused, ABI47_0_0RCTDirectEventBlock)
ABI47_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, GMSMapViewType)
                  ...
                  rejecter:(ABI47_0_0RCTPromiseRejectBlock)reject)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI47_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI47_0_0AIRGoogleMap class]]) {
            reject(@"Invalid argument", [NSString stringWithFormat:@"Invalid view returned from registry, expecting ABI47_0_0AIRGoogleMap, got: %@", view], NULL);
        } else {
            ABI47_0_0AIRGoogleMap *mapView = (ABI47_0_0AIRGoogleMap *)view;
            resolve(@{
                      @"center": @{
                  ...
                  camera:(id)json)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI47_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        id view = viewRegistry[ABI47_0_0ReactTag];
        if (![view isKindOfClass:[ABI47_0_0AIRGoogleMap class]]) {
            ABI47_0_0RCTLogError(@"Invalid view returned from registry, expecting ABI47_0_0AIRGoogleMap, got: %@", view);
        } else {
            ABI47_0_0AIRGoogleMap *mapView = (ABI47_0_0AIRGoogleMap *)view;
            GMSCameraPosition *camera = [ABI47_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:[mapView camera]];
                  ...
                  withDuration:(CGFloat)duration)
{
  [self.bridge.uiManager addUIBlock:^(__unused ABI47_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ...
    if (![view isKindOfClass:[ABI47_0_0AIRGoogleMap class]]) {
      ...
      [CATransaction setAnimationDuration:duration/1000];
      ABI47_0_0AIRGoogleMap *mapView = (ABI47_0_0AIRGoogleMap *)view;
      GMSCameraPosition *camera = [ABI47_0_0AIRGoogleMap makeGMSCameraPositionFromMap:mapView andMKCoordinateRegion:region];
      [mapView animateToCameraPosition:camera];
      [CATransaction commit];
    }
  }];
                  ...
                  animated:(BOOL)animated)
{
  [self.bridge.uiManager addUIBlock:^(__unused ABI47_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ...
    if (![view isKindOfClass:[ABI47_0_0AIRGoogleMap class]]) {
      ...
      CLLocationCoordinate2D myLocation = ((ABI47_0_0AIRGoogleMapMarker *)(mapView.markers.firstObject)).realMarker.position;
      GMSCoordinateBounds *bounds = [[GMSCoordinateBounds alloc] initWithCoordinate:myLocation coordinate:myLocation];

      for (ABI47_0_0AIRGoogleMapMarker *marker in mapView.markers)
  ...
  [self.bridge.uiManager addUIBlock:^(__unused ABI47_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ...
    if (![view isKindOfClass:[ABI47_0_0AIRGoogleMap class]]) {
      ...
      NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
        ABI47_0_0AIRGoogleMapMarker *marker = (ABI47_0_0AIRGoogleMapMarker *)evaluatedObject;
        return [marker isKindOfClass:[ABI47_0_0AIRGoogleMapMarker class]] && [markers containsObject:marker.identifier];
      }];

      NSArray *filteredMarkers = [mapView.markers filteredArrayUsingPredicate:filterMarkers];

      CLLocationCoordinate2D myLocation = ((ABI47_0_0AIRGoogleMapMarker *)(filteredMarkers.firstObject)).realMarker.position;
      GMSCoordinateBounds *bounds = [[GMSCoordinateBounds alloc] initWithCoordinate:myLocation coordinate:myLocation];

      for (ABI47_0_0AIRGoogleMapMarker *marker in filteredMarkers)
        bounds = [bounds includingCoordinate:marker.realMarker.position];
                  ...
                  animated:(BOOL)animated)
{
  [self.bridge.uiManager addUIBlock:^(__unused ABI47_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ...
    if (![view isKindOfClass:[ABI47_0_0AIRGoogleMap class]]) {
      ...
      for (ABI47_0_0AIRMapCoordinate *coordinate in coordinates)
...
ABI47_0_0RCT_EXPORT_METHOD(takeSnapshot:(nonnull NSNumber *)ABI47_0_0ReactTag
                  ...
                  withCallback:(ABI47_0_0RCTResponseSenderBlock)callback)
{
...
ABI47_0_0RCT_EXPORT_METHOD(setMapBoundaries:(nonnull NSNumber *)ABI47_0_0ReactTag
...
ABI47_0_0RCT_EXPORT_METHOD(setIndoorActiveLevelIndex:(nonnull NSNumber *)ABI47_0_0ReactTag
...
- (void)mapViewDidStartTileRendering:(GMSMapView *)mapView {
  ABI47_0_0AIRGoogleMap *googleMapView = (ABI47_0_0AIRGoogleMap *)mapView;
...
- (UIView *)mapView:(GMSMapView *)mapView markerInfoWindow:(GMSMarker *)marker {
  ABI47_0_0AIRGMSMarker *aMarker = (ABI47_0_0AIRGMSMarker *)marker;
...
- (void)handleMapDrag:(UIPanGestureRecognizer*)recognizer {
  ABI47_0_0AIRGoogleMap *map = (ABI47_0_0AIRGoogleMap *)recognizer.view;
