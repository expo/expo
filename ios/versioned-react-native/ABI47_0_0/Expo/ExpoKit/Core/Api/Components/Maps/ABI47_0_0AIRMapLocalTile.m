...
#import "ABI47_0_0AIRMapLocalTileOverlay.h"

@implementation ABI47_0_0AIRMapLocalTile {
...
- (void) createTileOverlayAndRendererIfPossible
{
    ...
    self.tileOverlay = [[ABI47_0_0AIRMapLocalTileOverlay alloc] initWithURLTemplate:self.pathTemplate];
