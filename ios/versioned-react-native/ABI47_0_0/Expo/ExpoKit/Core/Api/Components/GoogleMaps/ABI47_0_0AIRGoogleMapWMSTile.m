//
//  ABI47_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI47_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI47_0_0WMSTileOverlay *tile = [[ABI47_0_0WMSTileOverlay alloc] init];
...
@implementation ABI47_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
