...
@implementation ABI47_0_0RCTConvert (AirMap)
...
{
    json = [self NSDictionary:json];
    return [ABI47_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:nil];
}
...
ABI47_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI47_0_0AIRMapCoordinate *)ABI47_0_0AIRMapCoordinate:(id)json
{
    ABI47_0_0AIRMapCoordinate *coord = [ABI47_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI47_0_0RCT_ARRAY_CONVERTER(ABI47_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI47_0_0AIRMapCoordinate *> *> *)ABI47_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI47_0_0RCTConvertArrayValue(@selector(ABI47_0_0AIRMapCoordinateArray:), json);
}
