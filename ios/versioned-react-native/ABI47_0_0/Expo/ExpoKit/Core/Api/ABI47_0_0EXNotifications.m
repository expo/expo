...
#import "ABI47_0_0EXNotifications.h"
...
@interface ABI47_0_0EXNotifications ()

// unversioned ABI47_0_0EXRemoteNotificationManager instance
@property (nonatomic, weak) id <ABI47_0_0EXNotificationsScopedModuleDelegate> remoteNotificationsDelegate;
@property (nonatomic, weak) id <ABI47_0_0EXNotificationsIdentifiersManager> notificationsIdentifiersManager;
@property (nonatomic, weak) id <ABI47_0_0EXUserNotificationCenterService> userNotificationCenter;

@end

@implementation ABI47_0_0EXNotifications

ABI47_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentNotifications, @"RemoteNotificationManager", @"UserNotificationManager", @"UserNotificationCenter");
...
ABI47_0_0RCT_REMAP_METHOD(getDevicePushTokenAsync,
...
{
  ABI47_0_0EXConstantsBinding *constants = [[[self.bridge moduleForClass:[ABI47_0_0EXModuleRegistryHolderReactModule class]] exModuleRegistry] getModuleImplementingProtocol:@protocol(ABI47_0_0EXConstantsInterface)];
...
ABI47_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
                 getExponentPushTokenAsyncWithResolver:(ABI47_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI47_0_0RCTPromiseRejectBlock)reject)
{
...
ABI47_0_0RCT_EXPORT_METHOD(presentLocalNotification:(NSDictionary *)payload
                  resolver:(ABI47_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI47_0_0RCTPromiseRejectBlock)reject)
{
  ...
  ABI47_0_0RCT_EXPORT_METHOD(scheduleNotificationWithTimer:(NSDictionary *)payload
...
ABI47_0_0RCT_EXPORT_METHOD(scheduleNotificationWithCalendar:(NSDictionary *)payload
                 withOptions:(NSDictionary *)options
                 resolver:(ABI47_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI47_0_0RCTPromiseRejectBlock)reject)
{
...
ABI47_0_0RCT_EXPORT_METHOD(scheduleLocalNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI47_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI47_0_0RCTPromiseRejectBlock)reject)
{
...
ABI47_0_0RCT_EXPORT_METHOD(legacyScheduleLocalRepeatingNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI47_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI47_0_0RCTPromiseRejectBlock)reject)
{
  ...
  localNotification.applicationIconBadgeNumber = [ABI47_0_0RCTConvert NSInteger:payload[@"count"]] ?: 0;
  ...
  localNotification.fireDate = [ABI47_0_0RCTConvert NSDate:options[@"time"]] ?: [NSDate new];
  localNotification.repeatInterval = [ABI47_0_0RCTConvert NSCalendarUnit:options[@"repeat"]] ?: 0;

  __weak typeof(self) weakSelf = self;
  [ABI47_0_0EXUtil performSynchronouslyOnMainThread:^{
    [ABI47_0_0RCTSharedApplication() scheduleLocalNotification:localNotification];
...
ABI47_0_0RCT_REMAP_METHOD(cancelScheduledNotificationAsync,
                 cancelScheduledNotificationAsync:(NSString *)uniqueId
                 withResolver:(ABI47_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI47_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI47_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
...
ABI47_0_0RCT_REMAP_METHOD(cancelAllScheduledNotificationsAsync,
                 cancelAllScheduledNotificationsAsyncWithResolver:(ABI47_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(__unused ABI47_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI47_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
  [_userNotificationCenter getPendingNotificationRequestsWithCompletionHandler:^(NSArray<UNNotificationRequest *> * _Nonnull requests) {
...
ABI47_0_0RCT_REMAP_METHOD(getBadgeNumberAsync,
                 getBadgeNumberAsyncWithResolver:(ABI47_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI47_0_0RCTPromiseRejectBlock)reject)
{
  __block NSInteger badgeNumber;
  [ABI47_0_0EXUtil performSynchronouslyOnMainThread:^{
    badgeNumber = ABI47_0_0RCTSharedApplication().applicationIconBadgeNumber;
  }];
  resolve(@(badgeNumber));
}

ABI47_0_0RCT_EXPORT_METHOD(setBadgeNumberAsync:(nonnull NSNumber *)number
                  resolver:(ABI47_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI47_0_0RCTPromiseRejectBlock)reject)
{
  [ABI47_0_0EXUtil performSynchronouslyOnMainThread:^{
    ABI47_0_0RCTSharedApplication().applicationIconBadgeNumber = number.integerValue;
  }];
  resolve(nil);
}
...
ABI47_0_0RCT_REMAP_METHOD(createCategoryAsync,
...
ABI47_0_0RCT_REMAP_METHOD(deleteCategoryAsync,
...
- (NSDateComponents *)dateComponentsFrom:(NSNumber * _Nullable)unixTime {
  ...
  NSDate *triggerDate = [ABI47_0_0RCTConvert NSDate:unixTime] ?: [NSDate new];
