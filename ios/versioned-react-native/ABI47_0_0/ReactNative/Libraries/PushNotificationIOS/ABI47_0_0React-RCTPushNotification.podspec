...
Pod::Spec.new do |s|
  s.name                   = "ABI47_0_0React-RCTPushNotification"
  s.version                = version
  ...
  s.header_dir             = "ABI47_0_0RCTPushNotification"
  ...
  s.dependency "ABI47_0_0React-Codegen", version
  s.dependency "ABI47_0_0RCTTypeSafety", version
  s.dependency "ABI47_0_0React-Core/RCTPushNotificationHeaders", version
