...
@implementation ABI47_0_0RCTTrackingAnimatedNode {
...
- (void)performUpdate
{
  ...
  ABI47_0_0RCTValueAnimatedNode *node = (ABI47_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
