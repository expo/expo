...
@implementation ABI47_0_0RCTPropsAnimatedNode
{
     ...
     surfacePresenter:(id<ABI47_0_0RCTSurfacePresenterStub> )surfacePresenter
{
  ...
  _managedByFabric = ABI47_0_0RCTUIManagerTypeForTagIsFabric(viewTag);
}
...
- (void)performUpdate
{
  ...
  for (NSNumber *parentTag in self.parentNodes.keyEnumerator) {
    ABI47_0_0RCTAnimatedNode *parentNode = [self.parentNodes objectForKey:parentTag];
    if ([parentNode isKindOfClass:[ABI47_0_0RCTStyleAnimatedNode class]]) {
      ABI47_0_0RCTStyleAnimatedNode *styleAnimatedNode = (ABI47_0_0RCTStyleAnimatedNode *)parentNode;
      [_propsDictionary addEntriesFromDictionary:styleAnimatedNode.propsDictionary];
    } else if ([parentNode isKindOfClass:[ABI47_0_0RCTValueAnimatedNode class]]) {
      ABI47_0_0RCTValueAnimatedNode *valueAnimatedNode = (ABI47_0_0RCTValueAnimatedNode *)parentNode;
    ...
    } else if ([parentNode isKindOfClass:[ABI47_0_0RCTColorAnimatedNode class]]) {
      ABI47_0_0RCTColorAnimatedNode *colorAnimatedNode = (ABI47_0_0RCTColorAnimatedNode *)parentNode;
      NSString *property = [self propertyNameForParentTag:parentTag];
