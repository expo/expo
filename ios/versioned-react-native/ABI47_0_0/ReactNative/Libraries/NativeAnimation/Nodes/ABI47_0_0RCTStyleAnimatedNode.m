...
@implementation ABI47_0_0RCTStyleAnimatedNode
{
...
- (void)performUpdate
{
  ...
  [style enumerateKeysAndObjectsUsingBlock:^(NSString *property, NSNumber *nodeTag, __unused BOOL *stop) {
    ABI47_0_0RCTAnimatedNode *node = [self.parentNodes objectForKey:nodeTag];
    if (node) {
      if ([node isKindOfClass:[ABI47_0_0RCTValueAnimatedNode class]]) {
        ABI47_0_0RCTValueAnimatedNode *valueAnimatedNode = (ABI47_0_0RCTValueAnimatedNode *)node;
        _propsDictionary[property] = @(valueAnimatedNode.value);
      } else if ([node isKindOfClass:[ABI47_0_0RCTTransformAnimatedNode class]]) {
        ABI47_0_0RCTTransformAnimatedNode *transformAnimatedNode = (ABI47_0_0RCTTransformAnimatedNode *)node;
        [_propsDictionary addEntriesFromDictionary:transformAnimatedNode.propsDictionary];
      } else if ([node isKindOfClass:[ABI47_0_0RCTColorAnimatedNode class]]) {
        ABI47_0_0RCTColorAnimatedNode *colorAnimatedNode = (ABI47_0_0RCTColorAnimatedNode *)node;
