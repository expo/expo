...
@implementation ABI47_0_0RCTInterpolationAnimatedNode
{
  __weak ABI47_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI47_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI47_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI47_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  CGFloat interpolated = ABI47_0_0RCTInterpolateValueInRange(inputValue,
                                                    _inputRange,
                                                    _outputRange,
                                                    _extrapolateLeft,
                                                    _extrapolateRight);
  ...
  if (_hasStringOutput) {
    ...
    if (_numVals > 1) {
      ...
      for (NSTextCheckingResult *match in [_matches reverseObjectEnumerator]) {
        CGFloat val = ABI47_0_0RCTInterpolateValueInRange(inputValue,
                                                          _inputRange,
                                                          _outputs[--i],
                                                          _extrapolateLeft,
                                                          _extrapolateRight);
