...
#import <ABI47_0_0React/ABI47_0_0RCTNativeAnimatedModule.h>
...
@interface ABI47_0_0RCTNativeAnimatedModule () <ABI47_0_0RCTInitializing>
@end

@implementation ABI47_0_0RCTNativeAnimatedModule
{
...
- (void)setBridge:(ABI47_0_0RCTBridge *)bridge
{
  ...
  _nodesManager = [[ABI47_0_0RCTNativeAnimatedNodesManager alloc] initWithBridge:self.bridge surfacePresenter:bridge.surfacePresenter];
...
{
  ABI47_0_0RCTLogWarn(@"setSurfacePresenter should only be invoked in ABI47_0_0RCTNativeAnimatedTurboModule");
}
...
{
  NSString *viewName = [self.bridge.uiManager viewNameForABI47_0_0ReactTag:[NSNumber numberWithDouble:viewTag]];
  [self addOperationBlock:^(ABI47_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
- (void)uiManagerWillPerformMounting:(ABI47_0_0RCTUIManager *)uiManager
{
  ...
  [uiManager prependUIBlock:^(__unused ABI47_0_0RCTUIManager *manager, __unused NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    for (AnimatedOperation operation in preOperations) {
      operation(self->_nodesManager);
    }
  }];
...
Class ABI47_0_0RCTNativeAnimatedModuleCls(void) {
  return ABI47_0_0RCTNativeAnimatedModule.class;
}
