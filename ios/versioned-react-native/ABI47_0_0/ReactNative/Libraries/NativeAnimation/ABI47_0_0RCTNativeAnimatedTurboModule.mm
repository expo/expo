...
#import <ABI47_0_0React/ABI47_0_0RCTNativeAnimatedTurboModule.h>
#import <ABI47_0_0React/ABI47_0_0RCTNativeAnimatedNodesManager.h>
#import <ABI47_0_0React/ABI47_0_0RCTInitializing.h>

#import "ABI47_0_0RCTAnimationPlugins.h"

typedef void (^AnimatedOperation)(ABI47_0_0RCTNativeAnimatedNodesManager *nodesManager);

@interface ABI47_0_0RCTNativeAnimatedTurboModule() <ABI47_0_0NativeAnimatedModuleSpec, ABI47_0_0RCTInitializing>
@end

@implementation ABI47_0_0RCTNativeAnimatedTurboModule
{
  ABI47_0_0RCTNativeAnimatedNodesManager *_nodesManager;
...
- (void)initialize
{
  ...
  _nodesManager = [[ABI47_0_0RCTNativeAnimatedNodesManager alloc] initWithBridge:nil surfacePresenter:_surfacePresenter];
...
ABI47_0_0RCT_EXPORT_METHOD(startOperationBatch)
{
  // TODO T71377585
}

ABI47_0_0RCT_EXPORT_METHOD(finishOperationBatch)
{
  // TODO T71377585
}

ABI47_0_0RCT_EXPORT_METHOD(createAnimatedNode:(double)tag
                  config:(NSDictionary<NSString *, id> *)config)
{
  [self addOperationBlock:^(ABI47_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager createAnimatedNode:[NSNumber numberWithDouble:tag] config:config];
  }];
}

ABI47_0_0RCT_EXPORT_METHOD(updateAnimatedNodeConfig:(double)tag
                  config:(NSDictionary<NSString *, id> *)config)
{
  [self addOperationBlock:^(ABI47_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI47_0_0RCT_EXPORT_METHOD(connectAnimatedNodes:(double)parentTag
...
ABI47_0_0RCT_EXPORT_METHOD(disconnectAnimatedNodes:(double)parentTag
                  childTag:(double)childTag)
{
  [self addOperationBlock:^(ABI47_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI47_0_0RCT_EXPORT_METHOD(startAnimatingNode:(double)animationId
                  nodeTag:(double)nodeTag
                  config:(NSDictionary<NSString *, id> *)config
                  endCallback:(ABI47_0_0RCTResponseSenderBlock)callBack)
{
  [self addOperationBlock:^(ABI47_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI47_0_0RCT_EXPORT_METHOD(stopAnimation:(double)animationId)
{
  [self addOperationBlock:^(ABI47_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI47_0_0RCT_EXPORT_METHOD(setAnimatedNodeValue:(double)nodeTag
                  value:(double)value)
{
  [self addOperationBlock:^(ABI47_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager setAnimatedNodeValue:[NSNumber numberWithDouble:nodeTag] value:[NSNumber numberWithDouble:value]];
  }];
  // In Bridge, flushing of native animations is done from ABI47_0_0RCTCxxBridge batchDidComplete().
  // Since ABI47_0_0RCTCxxBridge doesn't exist in Bridgeless, and components are not remounted in Fabric for native animations,
  // flush here for changes in Animated.Value for Animated.event.
  [self flushOperationQueues];
}

ABI47_0_0RCT_EXPORT_METHOD(setAnimatedNodeOffset:(double)nodeTag
...
ABI47_0_0RCT_EXPORT_METHOD(flattenAnimatedNodeOffset:(double)nodeTag)
{
  [self addOperationBlock:^(ABI47_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI47_0_0RCT_EXPORT_METHOD(extractAnimatedNodeOffset:(double)nodeTag)
{
  [self addOperationBlock:^(ABI47_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI47_0_0RCT_EXPORT_METHOD(connectAnimatedNodeToView:(double)nodeTag
                  viewTag:(double)viewTag)
{
  if (ABI47_0_0RCTUIManagerTypeForTagIsFabric(@(viewTag))) {
...
ABI47_0_0RCT_EXPORT_METHOD(disconnectAnimatedNodeFromView:(double)nodeTag
                  viewTag:(double)viewTag)
{
  [self addOperationBlock:^(ABI47_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI47_0_0RCT_EXPORT_METHOD(restoreDefaultValues:(double)nodeTag)
{
  [self addPreOperationBlock:^(ABI47_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager restoreDefaultValues:[NSNumber numberWithDouble:nodeTag]];
  }];
}

ABI47_0_0RCT_EXPORT_METHOD(dropAnimatedNode:(double)tag)
{
  [self addOperationBlock:^(ABI47_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI47_0_0RCT_EXPORT_METHOD(startListeningToAnimatedNodeValue:(double)tag)
{
  __weak id<ABI47_0_0RCTValueAnimatedNodeObserver> valueObserver = self;
  [self addOperationBlock:^(ABI47_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager startListeningToAnimatedNodeValue:[NSNumber numberWithDouble:tag] valueObserver:valueObserver];
  }];
}

ABI47_0_0RCT_EXPORT_METHOD(stopListeningToAnimatedNodeValue:(double)tag)
{
  [self addOperationBlock:^(ABI47_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI47_0_0RCT_EXPORT_METHOD(addAnimatedEventToView:(double)viewTag
                  ...
                  eventMapping:(ABI47_0_0JS::NativeAnimatedModule::EventMapping &)eventMapping)
{
  ...
  eventMappingDict[@"nativeEventPath"] = ABI47_0_0RCTConvertVecToArray(eventMapping.nativeEventPath());
...
ABI47_0_0RCT_EXPORT_METHOD(removeAnimatedEventFromView:(double)viewTag
                  eventName:(nonnull NSString *)eventName
...
ABI47_0_0RCT_EXPORT_METHOD(getValue:(double)nodeTag saveValueCallback:(ABI47_0_0RCTResponseSenderBlock)saveValueCallback) {
  [self addOperationBlock:^(ABI47_0_0RCTNativeAnimatedNodesManager *nodesManager) {
      [nodesManager getValue:[NSNumber numberWithDouble:nodeTag] saveCallback:saveValueCallback];
  }];
}

ABI47_0_0RCT_EXPORT_METHOD(queueAndExecuteBatchedOperations:(NSArray *)operationsAndArgs) {
...
- (void)animatedNode:(ABI47_0_0RCTValueAnimatedNode *)node didUpdateValue:(CGFloat)value
{
...
{
  return std::make_shared<ABI47_0_0facebook::ABI47_0_0React::NativeAnimatedModuleSpecJSI>(params);
}

@end

Class ABI47_0_0RCTNativeAnimatedTurboModuleCls(void) {
  return ABI47_0_0RCTNativeAnimatedTurboModule.class;
}
