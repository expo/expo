...
// NOTE: This module is temporarily forked (see ABI47_0_0RCTNativeAnimatedModule).
// When making any changes, be sure to apply them to the fork as well.
@interface ABI47_0_0RCTNativeAnimatedTurboModule: ABI47_0_0RCTEventEmitter <ABI47_0_0RCTBridgeModule, ABI47_0_0RCTValueAnimatedNodeObserver, ABI47_0_0RCTEventDispatcherObserver, ABI47_0_0RCTSurfacePresenterObserver>
