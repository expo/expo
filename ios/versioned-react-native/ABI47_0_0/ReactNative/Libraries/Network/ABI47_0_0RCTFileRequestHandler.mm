...
@interface ABI47_0_0RCTFileRequestHandler() <ABI47_0_0RCTTurboModule>
@end

@implementation ABI47_0_0RCTFileRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  && !ABI47_0_0RCTIsBundleAssetURL(request.URL);
}
...
Class ABI47_0_0RCTFileRequestHandlerCls(void) {
  return ABI47_0_0RCTFileRequestHandler.class;
}
