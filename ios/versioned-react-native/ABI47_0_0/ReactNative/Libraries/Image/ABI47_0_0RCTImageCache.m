...
static NSUInteger ABI47_0_0RCTMaxCachableDecodedImageSizeInBytes = 2*1024*1024;
static NSUInteger ABI47_0_0RCTImageCacheTotalCostLimit = 20*1024*1024;

void ABI47_0_0RCTSetImageCacheLimits(NSUInteger maxCachableDecodedImageSizeInBytes, NSUInteger imageCacheTotalCostLimit) {
  ABI47_0_0RCTMaxCachableDecodedImageSizeInBytes = maxCachableDecodedImageSizeInBytes;
  ABI47_0_0RCTImageCacheTotalCostLimit = imageCacheTotalCostLimit;
}

static NSString *ABI47_0_0RCTCacheKeyForImage(NSString *imageTag, CGSize size, CGFloat scale,
...
@implementation ABI47_0_0RCTImageCache
{
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _decodedImageCache.totalCostLimit = ABI47_0_0RCTImageCacheTotalCostLimit;
                 ...
                 forKey:(NSString *)cacheKey
{
  ...
  NSInteger bytes = image.ABI47_0_0ReactDecodedImageBytes;
  if (bytes <= ABI47_0_0RCTMaxCachableDecodedImageSizeInBytes) {
...
{
  NSString *cacheKey = ABI47_0_0RCTCacheKeyForImage(url, size, scale, resizeMode);
  @synchronized(_cacheStaleTimes) {
