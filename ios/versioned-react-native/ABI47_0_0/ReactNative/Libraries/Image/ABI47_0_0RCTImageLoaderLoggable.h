...
/**
 * The image loader (i.e. ABI47_0_0RCTImageLoader) implement this to declare whether image performance should be logged.
 */
@protocol ABI47_0_0RCTImageLoaderLoggableProtocol
 ...
 */
@protocol ABI47_0_0RCTImageLoaderLoggable
