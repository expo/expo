...
@interface ABI47_0_0RCTGIFCoderFrame : NSObject
...
@implementation ABI47_0_0RCTGIFCoderFrame
@end

@implementation ABI47_0_0RCTAnimatedImage {
  CGImageSourceRef _imageSource;
  CGFloat _scale;
  NSUInteger _loopCount;
  NSUInteger _frameCount;
  NSArray<ABI47_0_0RCTGIFCoderFrame *> *_frames;
}
...
- (BOOL)scanAndCheckFramesValidWithSource:(CGImageSourceRef)imageSource
{
  ...
  NSMutableArray<ABI47_0_0RCTGIFCoderFrame *> *frames = [NSMutableArray array];

  for (size_t i = 0; i < frameCount; i++) {
    ABI47_0_0RCTGIFCoderFrame *frame = [ABI47_0_0RCTGIFCoderFrame new];
    frame.index = i;
