...
@interface ABI47_0_0RCTImageStoreManager : NSObject <ABI47_0_0RCTURLRequestHandler>
...
@interface ABI47_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI47_0_0RCTBridge (ABI47_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI47_0_0RCTImageStoreManager *imageStoreManager;
