...
#import "ABI47_0_0RCTSurfaceHostingComponentController.h"
...
#import "ABI47_0_0RCTSurfaceHostingComponent+Internal.h"
#import "ABI47_0_0RCTSurfaceHostingComponent.h"
#import "ABI47_0_0RCTSurfaceHostingComponentState.h"

@interface ABI47_0_0RCTSurfaceHostingComponentController() <ABI47_0_0RCTSurfaceDelegate>
@end

@implementation ABI47_0_0RCTSurfaceHostingComponentController {
  id<ABI47_0_0RCTSurfaceProtocol> _surface;
}

- (instancetype)initWithComponent:(ABI47_0_0RCTSurfaceHostingComponent *)component
{
...
- (void)didUpdateComponent
{
  ...
  [self updateSurfaceWithComponent:(ABI47_0_0RCTSurfaceHostingComponent *)self.component];
}
...
- (void)updateSurfaceWithComponent:(ABI47_0_0RCTSurfaceHostingComponent *)component
{
  // Updating `surface`
  id<ABI47_0_0RCTSurfaceProtocol> const surface = component.surface;
  if (surface != _surface) {
...
- (void)setIntrinsicSize:(CGSize)intrinsicSize
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    [strongSelf.component updateState:^(ABI47_0_0RCTSurfaceHostingComponentState *state) {
      return [ABI47_0_0RCTSurfaceHostingComponentState newWithStage:state.stage
...
- (void)setStage:(ABI47_0_0RCTSurfaceStage)stage
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    [strongSelf.component updateState:^(ABI47_0_0RCTSurfaceHostingComponentState *state) {
      return [ABI47_0_0RCTSurfaceHostingComponentState newWithStage:stage
...
{
  return ((ABI47_0_0RCTSurfaceHostingComponent *)self.component).options.synchronousStateUpdates && ABI47_0_0RCTIsMainQueue() ? CKUpdateModeSynchronous : CKUpdateModeAsynchronous;
}
...
- (void)mountSurfaceView
{
  ...
  ABI47_0_0RCTAssert([superview.subviews count] <= 1, @"Should never have more than a single stateful subview.");
