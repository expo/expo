...
@protocol ABI47_0_0RCTBackedTextInputDelegate;
@class ABI47_0_0RCTTextAttributes;

NS_ASSUME_NONNULL_BEGIN

@protocol ABI47_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI47_0_0RCTBackedTextInputDelegate> textInputDelegate;
