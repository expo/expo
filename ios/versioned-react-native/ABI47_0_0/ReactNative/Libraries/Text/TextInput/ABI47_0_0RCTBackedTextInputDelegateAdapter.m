...
#import <ABI47_0_0React/ABI47_0_0RCTBackedTextInputDelegateAdapter.h>
...
@interface ABI47_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI47_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI47_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
...
@interface ABI47_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI47_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI47_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}
