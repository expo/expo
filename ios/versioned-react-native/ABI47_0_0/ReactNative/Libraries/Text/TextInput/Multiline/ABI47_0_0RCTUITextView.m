...
@implementation ABI47_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI47_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI47_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
...
- (void)setDelegate:(id<UITextViewDelegate>)delegate {
  // Delegate is set inside `[ABI47_0_0RCTBackedTextViewDelegateAdapter initWithTextView]` and
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI47_0_0RCTCeilPixelValue(placeholderSize.width), ABI47_0_0RCTCeilPixelValue(placeholderSize.height));
