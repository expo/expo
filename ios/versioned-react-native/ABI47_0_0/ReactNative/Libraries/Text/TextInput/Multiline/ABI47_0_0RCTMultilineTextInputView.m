...
@implementation ABI47_0_0RCTMultilineTextInputView
{
  ABI47_0_0RCTUITextView *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI47_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI47_0_0RCTUITextView alloc] initWithFrame:self.bounds];
...
{
  ABI47_0_0RCTDirectEventBlock onScroll = self.onScroll;
