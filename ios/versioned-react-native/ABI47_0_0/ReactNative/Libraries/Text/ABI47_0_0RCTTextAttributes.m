...
NSString *const ABI47_0_0RCTTextAttributesIsHighlightedAttributeName = @"ABI47_0_0RCTTextAttributesIsHighlightedAttributeName";
NSString *const ABI47_0_0RCTTextAttributesTagAttributeName = @"ABI47_0_0RCTTextAttributesTagAttributeName";

@implementation ABI47_0_0RCTTextAttributes
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _opacity = NAN;
    _textTransform = ABI47_0_0RCTTextTransformUndefined;
  }

  return self;
}

- (void)applyTextAttributes:(ABI47_0_0RCTTextAttributes *)textAttributes
{
  ...
  _textDecorationLine = textAttributes->_textDecorationLine != ABI47_0_0RCTTextDecorationLineTypeNone ? textAttributes->_textDecorationLine : _textDecorationLine; // *
  ...
  _textTransform = textAttributes->_textTransform != ABI47_0_0RCTTextTransformUndefined ? textAttributes->_textTransform : _textTransform;
}
...
- (NSDictionary<NSAttributedStringKey, id> *)effectiveTextAttributes
{
  ...
  if (_textDecorationLine == ABI47_0_0RCTTextDecorationLineTypeUnderline ||
      _textDecorationLine == ABI47_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    isTextDecorationEnabled = YES;
    attributes[NSUnderlineStyleAttributeName] = @(_textDecorationStyle);
  }

  if (_textDecorationLine == ABI47_0_0RCTTextDecorationLineTypeStrikethrough ||
      _textDecorationLine == ABI47_0_0RCTTextDecorationLineTypeUnderlineStrikethrough){
    isTextDecorationEnabled = YES;
  ...
  // Special
  if (_isHighlighted) {
    attributes[ABI47_0_0RCTTextAttributesIsHighlightedAttributeName] = @YES;
  }

  if (_tag) {
    attributes[ABI47_0_0RCTTextAttributesTagAttributeName] = _tag;
  }
...
{
  // FIXME: ABI47_0_0RCTFont has thread-safety issues and must be rewritten.
  return [ABI47_0_0RCTFont updateFont:nil
...
{
  bool fontScalingEnabled = !ABI47_0_0RCTHasFontHandlerSet() && _allowFontScaling;
...
- (NSString *)applyTextAttributesToText:(NSString *)text
{
  switch (_textTransform) {
    case ABI47_0_0RCTTextTransformUndefined:
    case ABI47_0_0RCTTextTransformNone:
      return text;
    case ABI47_0_0RCTTextTransformLowercase:
      return [text lowercaseString];
    case ABI47_0_0RCTTextTransformUppercase:
      return [text uppercaseString];
    case ABI47_0_0RCTTextTransformCapitalize:
      return capitalizeText(text);
  }
}

- (ABI47_0_0RCTTextAttributes *)copyWithZone:(NSZone *)zone
{
  ABI47_0_0RCTTextAttributes *textAttributes = [ABI47_0_0RCTTextAttributes new];
...
- (BOOL)isEqual:(ABI47_0_0RCTTextAttributes *)textAttributes
{
  if (!textAttributes) {
    return NO;
  }
...
#define ABI47_0_0RCTTextAttributesCompareFloats(a) ((a == textAttributes->a) || (isnan(a) && isnan(textAttributes->a)))
#define ABI47_0_0RCTTextAttributesCompareSize(a) CGSizeEqualToSize(a, textAttributes->a)
#define ABI47_0_0RCTTextAttributesCompareObjects(a) ((a == textAttributes->a) || [a isEqual:textAttributes->a])
#define ABI47_0_0RCTTextAttributesCompareStrings(a) ((a == textAttributes->a) || [a isEqualToString:textAttributes->a])
#define ABI47_0_0RCTTextAttributesCompareOthers(a) (a == textAttributes->a)

  return
    ABI47_0_0RCTTextAttributesCompareObjects(_foregroundColor) &&
    ABI47_0_0RCTTextAttributesCompareObjects(_backgroundColor) &&
    ABI47_0_0RCTTextAttributesCompareFloats(_opacity) &&
    // Font
    ABI47_0_0RCTTextAttributesCompareObjects(_fontFamily) &&
    ABI47_0_0RCTTextAttributesCompareFloats(_fontSize) &&
    ABI47_0_0RCTTextAttributesCompareFloats(_fontSizeMultiplier) &&
    ABI47_0_0RCTTextAttributesCompareFloats(_maxFontSizeMultiplier) &&
    ABI47_0_0RCTTextAttributesCompareStrings(_fontWeight) &&
    ABI47_0_0RCTTextAttributesCompareObjects(_fontStyle) &&
    ABI47_0_0RCTTextAttributesCompareObjects(_fontVariant) &&
    ABI47_0_0RCTTextAttributesCompareOthers(_allowFontScaling) &&
    ABI47_0_0RCTTextAttributesCompareFloats(_letterSpacing) &&
    // Paragraph Styles
    ABI47_0_0RCTTextAttributesCompareFloats(_lineHeight) &&
    ABI47_0_0RCTTextAttributesCompareFloats(_alignment) &&
    ABI47_0_0RCTTextAttributesCompareOthers(_baseWritingDirection) &&
    // Decoration
    ABI47_0_0RCTTextAttributesCompareObjects(_textDecorationColor) &&
    ABI47_0_0RCTTextAttributesCompareOthers(_textDecorationStyle) &&
    ABI47_0_0RCTTextAttributesCompareOthers(_textDecorationLine) &&
    // Shadow
    ABI47_0_0RCTTextAttributesCompareSize(_textShadowOffset) &&
    ABI47_0_0RCTTextAttributesCompareFloats(_textShadowRadius) &&
    ABI47_0_0RCTTextAttributesCompareObjects(_textShadowColor) &&
    // Special
    ABI47_0_0RCTTextAttributesCompareOthers(_isHighlighted) &&
    ABI47_0_0RCTTextAttributesCompareObjects(_tag) &&
    ABI47_0_0RCTTextAttributesCompareOthers(_layoutDirection) &&
    ABI47_0_0RCTTextAttributesCompareOthers(_textTransform);
}
