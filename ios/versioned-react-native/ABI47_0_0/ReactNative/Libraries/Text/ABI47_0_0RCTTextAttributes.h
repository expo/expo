...
#import <ABI47_0_0React/ABI47_0_0RCTTextDecorationLineType.h>

#import "ABI47_0_0RCTTextTransform.h"

NS_ASSUME_NONNULL_BEGIN

extern NSString *const ABI47_0_0RCTTextAttributesIsHighlightedAttributeName;
extern NSString *const ABI47_0_0RCTTextAttributesTagAttributeName;
 ...
 * and <TextInput>.
 */
@interface ABI47_0_0RCTTextAttributes : NSObject <NSCopying>
...
@property (nonatomic, assign) ABI47_0_0RCTTextDecorationLineType textDecorationLine;
// Shadow
...
@property (nonatomic, assign) ABI47_0_0RCTTextTransform textTransform;
