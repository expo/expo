...
/**
 * An abstraction for a key-value store to manage ABI47_0_0RCTDevSettings behavior.
 * The default implementation persists settings using NSUserDefaults.
 */
@protocol ABI47_0_0RCTDevSettingsDataSource <NSObject>
...
@protocol ABI47_0_0RCTDevSettingsInspectable <NSObject>
...
@interface ABI47_0_0RCTDevSettings : ABI47_0_0RCTEventEmitter <ABI47_0_0RCTInitializing>
...
/*
 * Whether shaking will show ABI47_0_0RCTDevMenu. The menu is enabled by default if ABI47_0_0RCT_DEV=1, but
...
- (void)addHandler:(id<ABI47_0_0RCTPackagerClientMethod>)handler
    forPackagerMethod:(NSString *)name __deprecated_msg("Use ABI47_0_0RCTPackagerConnection directly instead");
#endif

@end

@interface ABI47_0_0RCTBridge (ABI47_0_0RCTDevSettings)

@property (nonatomic, readonly) ABI47_0_0RCTDevSettings *devSettings;
...
// (i.e. ABI47_0_0RCT_DEV or ABI47_0_0RCT_DEV_MENU is set)
ABI47_0_0RCT_EXTERN void ABI47_0_0RCTDevSettingsSetEnabled(BOOL enabled);
