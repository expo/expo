...
typedef UIFont * (^ABI47_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ABI47_0_0React Native will use the System font for rendering by default. If you want to
 ...
 */
ABI47_0_0RCT_EXTERN void ABI47_0_0RCTSetDefaultFontHandler(ABI47_0_0RCTFontHandler handler);
ABI47_0_0RCT_EXTERN BOOL ABI47_0_0RCTHasFontHandlerSet(void);

@interface ABI47_0_0RCTFont : NSObject
...
@interface ABI47_0_0RCTConvert (ABI47_0_0RCTFont)
