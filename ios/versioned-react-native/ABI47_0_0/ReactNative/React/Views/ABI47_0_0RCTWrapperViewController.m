...
#import "ABI47_0_0RCTWrapperViewController.h"
...
@implementation ABI47_0_0RCTWrapperViewController {
  UIView *_wrapperView;
  UIView *_contentView;
...
{
  ABI47_0_0RCTAssertParam(contentView);
...
ABI47_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithNibName : (NSString *)nn bundle : (NSBundle *)nb)
...
static BOOL ABI47_0_0RCTFindScrollViewAndRefreshContentInsetInView(UIView *view)
{
  if ([view conformsToProtocol:@protocol(ABI47_0_0RCTAutoInsetsProtocol)]) {
    [(id<ABI47_0_0RCTAutoInsetsProtocol>)view refreshContentInset];
    return YES;
  }
  for (UIView *subview in view.subviews) {
    if (ABI47_0_0RCTFindScrollViewAndRefreshContentInsetInView(subview)) {
      return YES;
    }
  }
  return NO;
...
- (void)viewDidLayoutSubviews
{
  ...
  if (_previousTopInset != _currentTopInset || _previousBottomInset != _currentBottomInset) {
    ABI47_0_0RCTFindScrollViewAndRefreshContentInsetInView(_contentView);
...
- (void)loadView
{
  ...
  //`contentView` which is a ABI47_0_0React-managed view.
