...
/**
 * Contains any methods related to scrolling. Any `ABI47_0_0RCTView` that has scrolling
 * features should implement these methods.
 */
@protocol ABI47_0_0RCTScrollableProtocol
 ...
 */
@protocol ABI47_0_0RCTCustomRefreshContolProtocol
