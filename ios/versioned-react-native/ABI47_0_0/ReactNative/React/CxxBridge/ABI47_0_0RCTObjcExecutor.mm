...
#import <ABI47_0_0cxxreact/ABI47_0_0JSBigString.h>
...
class ABI47_0_0RCTObjcExecutor : public JSExecutor {
 public:
  ABI47_0_0RCTObjcExecutor(
  ...
  {
    ABI47_0_0RCTAssert(NO, @"RAM bundles are not supported in ABI47_0_0RCTObjcExecutor");
  }
 ...
 private:
  ...
  ABI47_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI47_0_0RCTObjcExecutorFactory::ABI47_0_0RCTObjcExecutorFactory(id<ABI47_0_0RCTJavaScriptExecutor> jse, ABI47_0_0RCTJavaScriptCompleteBlock errorBlock)
    : m_jse(jse), m_errorBlock(errorBlock)
{
}

std::unique_ptr<JSExecutor> ABI47_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue)
{
  return std::unique_ptr<JSExecutor>(new ABI47_0_0RCTObjcExecutor(m_jse, m_errorBlock, jsQueue, delegate));
}
