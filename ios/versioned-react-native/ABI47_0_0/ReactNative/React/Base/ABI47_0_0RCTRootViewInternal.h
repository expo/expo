 ...
 * classes to change the ABI47_0_0RCTRootViews's internal state.
 */
@interface ABI47_0_0RCTRootView ()

/**
 * This setter should be used only by ABI47_0_0RCTUIManager on ABI47_0_0React root view
