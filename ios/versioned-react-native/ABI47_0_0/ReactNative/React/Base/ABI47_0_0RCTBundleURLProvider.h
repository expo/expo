...
ABI47_0_0RCT_EXTERN NSString *const ABI47_0_0RCTBundleURLProviderUpdatedNotification;
ABI47_0_0RCT_EXTERN const NSUInteger kABI47_0_0RCTBundleURLProviderDefaultPort;
 ...
 * by calling this function before initializing ABI47_0_0React Native (ABI47_0_0RCTBridge etc).
 * By default the access is enabled.
 */
ABI47_0_0RCT_EXTERN void ABI47_0_0RCTBundleURLProviderAllowPackagerServerAccess(BOOL allowed);
#endif

@interface ABI47_0_0RCTBundleURLProvider : NSObject
 ...
 * The port is optional, if not specified, kABI47_0_0RCTBundleURLProviderDefaultPort will be used
 */
