 ...
 */
@interface ABI47_0_0RCTImageSource : NSObject
...
@interface ABI47_0_0RCTConvert (ImageSource)

+ (ABI47_0_0RCTImageSource *)ABI47_0_0RCTImageSource:(id)json;
+ (NSArray<ABI47_0_0RCTImageSource *> *)ABI47_0_0RCTImageSourceArray:(id)json;
