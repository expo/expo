...
@interface ABI47_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>

@end

@implementation ABI47_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI47_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI47_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI47_0_0RCTMultipartStreamReader *reader = [[ABI47_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream
                                                                                  boundary:_boundary];
  ABI47_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
