 ...
 * are also bridge modules, so should be registered using ABI47_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI47_0_0RCTURLRequestHandler <ABI47_0_0RCTBridgeModule>
...
/**
 * If more than one ABI47_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
