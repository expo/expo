...
@protocol ABI47_0_0RCTBridgeDelegate <NSObject>
...
/**
 * The bridge initializes any registered ABI47_0_0RCTBridgeModules automatically, however
 ...
 * previously called ABI47_0_0facebook::ABI47_0_0React::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI47_0_0RCTBridge *)bridge;
 ...
 */
- (BOOL)bridge:(ABI47_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI47_0_0RCTBridge *)bridge
                 onProgress:(ABI47_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI47_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Similar to loadSourceForBridge:onProgress:onComplete: but without progress
 * reporting.
 */
- (void)loadSourceForBridge:(ABI47_0_0RCTBridge *)bridge withBlock:(ABI47_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Retrieve the list of lazy-native-modules names for the given bridge.
 */
- (NSDictionary<NSString *, Class> *)extraLazyModuleClassesForBridge:(ABI47_0_0RCTBridge *)bridge;
