...
typedef dispatch_block_t ABI47_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI47_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ABI47_0_0React-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI47_0_0RCTUIManager's observers.
 */
@interface ABI47_0_0RCTUIManagerObserverCoordinator : NSObject <ABI47_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI47_0_0RCTUIManagerObserver` protocol for more info.
