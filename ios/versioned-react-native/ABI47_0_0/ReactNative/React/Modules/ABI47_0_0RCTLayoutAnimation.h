...
#import <ABI47_0_0React/ABI47_0_0RCTAnimationType.h>

@interface ABI47_0_0RCTLayoutAnimation : NSObject
...
@property (nonatomic, readonly) ABI47_0_0RCTAnimationType animationType;
...
- (instancetype)initWithDuration:(NSTimeInterval)duration
                 ...
                 initialVelocity:(CGFloat)initialVelocity
                   animationType:(ABI47_0_0RCTAnimationType)animationType;
