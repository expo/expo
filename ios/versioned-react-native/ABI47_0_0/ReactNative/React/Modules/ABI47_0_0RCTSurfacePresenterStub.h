...
@protocol ABI47_0_0RCTSurfaceProtocol;

NS_ASSUME_NONNULL_BEGIN

// TODO: Eventually this should go away and files should just include ABI47_0_0RCTSurfacePresenter.h, but
...
@protocol ABI47_0_0RCTSurfacePresenterObserver <NSObject>
...
@protocol ABI47_0_0RCTSurfacePresenterStub <NSObject>
...
@interface ABI47_0_0RCTBridge (ABI47_0_0RCTSurfacePresenterStub)

- (id<ABI47_0_0RCTSurfacePresenterStub>)surfacePresenter;
- (void)setSurfacePresenter:(id<ABI47_0_0RCTSurfacePresenterStub>)presenter;
