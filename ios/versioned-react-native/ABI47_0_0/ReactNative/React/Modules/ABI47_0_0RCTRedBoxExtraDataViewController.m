...
#import "ABI47_0_0RCTRedBoxExtraDataViewController.h"

@interface ABI47_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI47_0_0RCTRedBoxExtraDataCell
...
@interface ABI47_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI47_0_0RCTRedBoxExtraDataViewController {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  ABI47_0_0RCTRedBoxExtraDataCell *cell =
      (ABI47_0_0RCTRedBoxExtraDataCell *)[tableView dequeueReusableCellWithIdentifier:reuseIdentifier];

  if (cell == nil) {
    cell = [[ABI47_0_0RCTRedBoxExtraDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
  }
