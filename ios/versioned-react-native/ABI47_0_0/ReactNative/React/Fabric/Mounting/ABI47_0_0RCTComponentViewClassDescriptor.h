 ...
 */
class ABI47_0_0RCTComponentViewClassDescriptor final {
 public:
  /*
   * Associated (and owned) native view class.
   */
  Class<ABI47_0_0RCTComponentViewProtocol> viewClass;

  /*
   * Indicates a requirement to call on the view methods from
   * `ABI47_0_0RCTMountingTransactionObserving` protocol.
   */
