...
#import "ABI47_0_0UIView+ComponentViewProtocol.h"
...
{
  ABI47_0_0RCTAssert(NO, @"`-[ABI47_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented in a concrete class.");
  return {};
}
...
{
  ABI47_0_0RCTAssert(NO, @"props access should be implemented by ABI47_0_0RCTViewComponentView.");
  return nullptr;
}
