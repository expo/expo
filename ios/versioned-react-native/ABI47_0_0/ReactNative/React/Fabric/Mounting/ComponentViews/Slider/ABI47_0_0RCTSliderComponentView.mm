...
#import <ABI47_0_0React/ABI47_0_0renderer/components/slider/SliderComponentDescriptor.h>

#import "ABI47_0_0RCTFabricComponentsPlugins.h"

using namespace ABI47_0_0facebook::ABI47_0_0React;

@interface ABI47_0_0RCTSliderComponentView () <ABI47_0_0RCTImageResponseDelegate>
@end

@implementation ABI47_0_0RCTSliderComponentView {
  ...
  ABI47_0_0RCTImageResponseObserverProxy _trackImageResponseObserverProxy;
  ABI47_0_0RCTImageResponseObserverProxy _minimumTrackImageResponseObserverProxy;
  ABI47_0_0RCTImageResponseObserverProxy _maximumTrackImageResponseObserverProxy;
  ABI47_0_0RCTImageResponseObserverProxy _thumbImageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _trackImageResponseObserverProxy = ABI47_0_0RCTImageResponseObserverProxy(self);
    _minimumTrackImageResponseObserverProxy = ABI47_0_0RCTImageResponseObserverProxy(self);
    _maximumTrackImageResponseObserverProxy = ABI47_0_0RCTImageResponseObserverProxy(self);
    _thumbImageResponseObserverProxy = ABI47_0_0RCTImageResponseObserverProxy(self);
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldSliderProps.thumbTintColor != newSliderProps.thumbTintColor) {
    _sliderView.thumbTintColor = ABI47_0_0RCTUIColorFromSharedColor(newSliderProps.thumbTintColor);
  }

  // `minimumTrackTintColor`
  if (oldSliderProps.minimumTrackTintColor != newSliderProps.minimumTrackTintColor) {
    _sliderView.minimumTrackTintColor = ABI47_0_0RCTUIColorFromSharedColor(newSliderProps.minimumTrackTintColor);
  }

  // `maximumTrackTintColor`
  if (oldSliderProps.maximumTrackTintColor != newSliderProps.maximumTrackTintColor) {
    _sliderView.maximumTrackTintColor = ABI47_0_0RCTUIColorFromSharedColor(newSliderProps.maximumTrackTintColor);
  }
...
#pragma mark - ABI47_0_0RCTImageResponseDelegate
...
Class<ABI47_0_0RCTComponentViewProtocol> ABI47_0_0RCTSliderCls(void)
{
  return ABI47_0_0RCTSliderComponentView.class;
}
