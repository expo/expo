...
#import <ABI47_0_0React/ABI47_0_0RCTTouchableComponentViewProtocol.h>
#import <ABI47_0_0React/ABI47_0_0UIView+ComponentViewProtocol.h>
 ...
 */
@interface ABI47_0_0RCTViewComponentView : UIView <ABI47_0_0RCTComponentViewProtocol, ABI47_0_0RCTTouchableComponentViewProtocol> {
 @protected
  ABI47_0_0facebook::ABI47_0_0React::LayoutMetrics _layoutMetrics;
  ABI47_0_0facebook::ABI47_0_0React::SharedViewProps _props;
  ABI47_0_0facebook::ABI47_0_0React::SharedViewEventEmitter _eventEmitter;
}
...
/**
 * Enforcing `call super` semantic for overridden methods from `ABI47_0_0RCTComponentViewProtocol`.
 * The methods update the instance variables.
 */
- (void)updateProps:(ABI47_0_0facebook::ABI47_0_0React::Props::Shared const &)props
           oldProps:(ABI47_0_0facebook::ABI47_0_0React::Props::Shared const &)oldProps NS_REQUIRES_SUPER;
- (void)updateEventEmitter:(ABI47_0_0facebook::ABI47_0_0React::EventEmitter::Shared const &)eventEmitter NS_REQUIRES_SUPER;
- (void)updateLayoutMetrics:(ABI47_0_0facebook::ABI47_0_0React::LayoutMetrics const &)layoutMetrics
           oldLayoutMetrics:(ABI47_0_0facebook::ABI47_0_0React::LayoutMetrics const &)oldLayoutMetrics NS_REQUIRES_SUPER;
- (void)finalizeUpdates:(ABI47_0_0RNComponentViewUpdateMask)updateMask NS_REQUIRES_SUPER;
