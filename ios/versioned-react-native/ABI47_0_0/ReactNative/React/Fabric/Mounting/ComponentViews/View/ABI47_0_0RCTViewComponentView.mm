...
#import <ABI47_0_0React/ABI47_0_0renderer/components/view/ViewEventEmitter.h>
#import <ABI47_0_0React/ABI47_0_0renderer/components/view/ViewProps.h>

using namespace ABI47_0_0facebook::ABI47_0_0React;

@implementation ABI47_0_0RCTViewComponentView {
...
- (void)setContentView:(UIView *)contentView
{
  ...
  if (_contentView) {
    ...
    _contentView.frame = ABI47_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
  }
}
...
{
  ABI47_0_0RCTAssert(
      self == [ABI47_0_0RCTViewComponentView class],
      @"`+[ABI47_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented for all subclasses (and `%@` particularly).",
...
{
  if (_removeClippedSubviews) {
    [_ABI47_0_0ReactSubviews removeObjectAtIndex:index];
  } else {
    ABI47_0_0RCTAssert(
...
- (void)updateClippedSubviewsWithClipRect:(CGRect)clipRect relativeToView:(UIView *)clipView
{
  ...
  if (_ABI47_0_0ReactSubviews.count == 0) {
  ...
  // Mount / unmount views
  for (UIView *view in _ABI47_0_0ReactSubviews) {
...
{
  ABI47_0_0RCTAssert(props, @"`props` must not be `null`.");

#ifndef NS_BLOCK_ASSERTIONS
  auto propsRawPtr = _props.get();
  ABI47_0_0RCTAssert(
      propsRawPtr &&
          ([self class] == [ABI47_0_0RCTViewComponentView class] ||
           typeid(*propsRawPtr).hash_code() != typeid(ViewProps const).hash_code()),
      @"`ABI47_0_0RCTViewComponentView` subclasses (and `%@` particularly) must setup `_props`"
  ...
  if (oldViewProps.removeClippedSubviews != newViewProps.removeClippedSubviews) {
    ...
    if (_removeClippedSubviews && self.subviews.count > 0) {
      _ABI47_0_0ReactSubviews = [NSMutableArray arrayWithArray:self.subviews];
    }
  }

  // `backgroundColor`
  if (oldViewProps.backgroundColor != newViewProps.backgroundColor) {
    self.backgroundColor = ABI47_0_0RCTUIColorFromSharedColor(newViewProps.backgroundColor);
    needsInvalidateLayer = YES;
  }

  // `foregroundColor`
  if (oldViewProps.foregroundColor != newViewProps.foregroundColor) {
    self.foregroundColor = ABI47_0_0RCTUIColorFromSharedColor(newViewProps.foregroundColor);
  }

  // `shadowColor`
  if (oldViewProps.shadowColor != newViewProps.shadowColor) {
    CGColorRef shadowColor = ABI47_0_0RCTCreateCGColorRefFromSharedColor(newViewProps.shadowColor);
  ...
  if (oldViewProps.shadowOffset != newViewProps.shadowOffset) {
    self.layer.shadowOffset = ABI47_0_0RCTCGSizeFromSize(newViewProps.shadowOffset);
    needsInvalidateLayer = YES;
  }
  ...
  if (oldViewProps.transform != newViewProps.transform &&
    ...
    self.layer.transform = ABI47_0_0RCTCATransform3DFromTransformMatrix(newViewProps.transform);
  ...
  if (oldViewProps.nativeId != newViewProps.nativeId) {
    self.nativeId = ABI47_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.nativeId);
  }
  ...
  if (oldViewProps.accessibilityLabel != newViewProps.accessibilityLabel) {
    self.accessibilityElement.accessibilityLabel = ABI47_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityLabel);
  }
  ...
  if (oldViewProps.accessibilityLanguage != newViewProps.accessibilityLanguage) {
    self.accessibilityElement.accessibilityLanguage =
        ABI47_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityLanguage);
  }

  // `accessibilityHint`
  if (oldViewProps.accessibilityHint != newViewProps.accessibilityHint) {
    self.accessibilityElement.accessibilityHint = ABI47_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityHint);
  }
  ...
  if (oldViewProps.accessibilityTraits != newViewProps.accessibilityTraits) {
    self.accessibilityElement.accessibilityTraits =
        ABI47_0_0RCTUIAccessibilityTraitsFromAccessibilityTraits(newViewProps.accessibilityTraits);
  }
  ...
  if (oldViewProps.accessibilityValue != newViewProps.accessibilityValue) {
    if (newViewProps.accessibilityValue.text.has_value()) {
      self.accessibilityElement.accessibilityValue =
          ABI47_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityValue.text.value());
    } else if (
  ...
  if (oldViewProps.testId != newViewProps.testId) {
    self.accessibilityIdentifier = ABI47_0_0RCTNSStringFromString(newViewProps.testId);
  }
...
- (void)prepareForRecycle
{
  ...
  if ([_propKeysManagedByAnimated_DO_NOT_USE_THIS_IS_BROKEN containsObject:@"transform"]) {
    self.layer.transform = ABI47_0_0RCTCATransform3DFromTransformMatrix(props.transform);
  }
...
static ABI47_0_0RCTCornerRadii ABI47_0_0RCTCornerRadiiFromBorderRadii(BorderRadii borderRadii)
{
...
static ABI47_0_0RCTBorderColors ABI47_0_0RCTCreateABI47_0_0RCTBorderColorsFromBorderColors(BorderColors borderColors)
{
  return ABI47_0_0RCTBorderColors{
      .top = ABI47_0_0RCTCreateCGColorRefFromSharedColor(borderColors.top),
      .left = ABI47_0_0RCTCreateCGColorRefFromSharedColor(borderColors.left),
      .bottom = ABI47_0_0RCTCreateCGColorRefFromSharedColor(borderColors.bottom),
      .right = ABI47_0_0RCTCreateCGColorRefFromSharedColor(borderColors.right)};
}

static void ABI47_0_0RCTReleaseABI47_0_0RCTBorderColors(ABI47_0_0RCTBorderColors borderColors)
{
...
static ABI47_0_0RCTBorderStyle ABI47_0_0RCTBorderStyleFromBorderStyle(BorderStyle borderStyle)
{
  switch (borderStyle) {
    case BorderStyle::Solid:
      return ABI47_0_0RCTBorderStyleSolid;
    case BorderStyle::Dotted:
      return ABI47_0_0RCTBorderStyleDotted;
    case BorderStyle::Dashed:
      return ABI47_0_0RCTBorderStyleDashed;
  }
}
...
- (void)invalidateLayer
{
  ...
  if (layerHasShadow) {
    if (CGColorGetAlpha(_backgroundColor.CGColor) > 0.999) {
      ...
      ABI47_0_0RCTCornerInsets const cornerInsets =
          ABI47_0_0RCTGetCornerInsets(ABI47_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero);
      CGPathRef shadowPath = ABI47_0_0RCTPathCreateWithRoundedRect(self.bounds, cornerInsets, nil);
  ...
  if (useCoreAnimationBorderRendering) {
    ...
    CGColorRef borderColor = ABI47_0_0RCTCreateCGColorRefFromSharedColor(borderMetrics.borderColors.left);
    ...
    ABI47_0_0RCTBorderColors borderColors = ABI47_0_0RCTCreateABI47_0_0RCTBorderColorsFromBorderColors(borderMetrics.borderColors);

    UIImage *image = ABI47_0_0RCTGetBorderImage(
        ABI47_0_0RCTBorderStyleFromBorderStyle(borderMetrics.borderStyles.left),
        layer.bounds.size,
        ABI47_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii),
        ABI47_0_0RCTUIEdgeInsetsFromEdgeInsets(borderMetrics.borderWidths),
        borderColors,
        _backgroundColor.CGColor,
        self.clipsToBounds);

    ABI47_0_0RCTReleaseABI47_0_0RCTBorderColors(borderColors);
    ...
    if (self.clipsToBounds) {
      if (borderMetrics.borderRadii.isUniform()) {
        ...
        CGPathRef path = ABI47_0_0RCTPathCreateWithRoundedRect(
            self.bounds,
            ABI47_0_0RCTGetCornerInsets(ABI47_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero),
            nil);
...
- (NSArray<UIAccessibilityCustomAction *> *)accessibilityCustomActions
{
  ...
  for (auto const &accessibilityAction : accessibilityActions) {
    [customActions
        addObject:[[UIAccessibilityCustomAction alloc] initWithName:ABI47_0_0RCTNSStringFromString(accessibilityAction.name)
                                                             target:self
...
- (BOOL)didActivateAccessibilityCustomAction:(UIAccessibilityCustomAction *)action
{
  if (_eventEmitter && _props->onAccessibilityAction) {
    _eventEmitter->onAccessibilityAction(ABI47_0_0RCTStringFromNSString(action.name));
    return YES;
  } else {
    return NO;
  }
...
{
  return ABI47_0_0RCTNSStringFromString([[self class] componentDescriptorProvider].name);
}
...
Class<ABI47_0_0RCTComponentViewProtocol> ABI47_0_0RCTViewCls(void);
...
Class<ABI47_0_0RCTComponentViewProtocol> ABI47_0_0RCTViewCls(void)
{
  return ABI47_0_0RCTViewComponentView.class;
}
