...
#import <ABI47_0_0React/ABI47_0_0renderer/components/image/ImageComponentDescriptor.h>
#import <ABI47_0_0React/ABI47_0_0renderer/components/image/ImageEventEmitter.h>
#import <ABI47_0_0React/ABI47_0_0renderer/components/image/ImageProps.h>
#import <ABI47_0_0React/ABI47_0_0renderer/imagemanager/ImageRequest.h>
#import <ABI47_0_0React/ABI47_0_0renderer/imagemanager/ABI47_0_0RCTImagePrimitivesConversions.h>

using namespace ABI47_0_0facebook::ABI47_0_0React;

@implementation ABI47_0_0RCTImageComponentView {
  ImageShadowNode::ConcreteState::Shared _state;
  ABI47_0_0RCTImageResponseObserverProxy _imageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _imageView.contentMode = ABI47_0_0RCTContentModeFromImageResizeMode(defaultProps->resizeMode);
    _imageView.layer.minificationFilter = kCAFilterTrilinear;
    _imageView.layer.magnificationFilter = kCAFilterTrilinear;

    _imageResponseObserverProxy = ABI47_0_0RCTImageResponseObserverProxy(self);
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldImageProps.resizeMode != newImageProps.resizeMode) {
    _imageView.contentMode = ABI47_0_0RCTContentModeFromImageResizeMode(newImageProps.resizeMode);
  }

  // `tintColor`
  if (oldImageProps.tintColor != newImageProps.tintColor) {
    _imageView.tintColor = ABI47_0_0RCTUIColorFromSharedColor(newImageProps.tintColor);
  }
...
{
  ABI47_0_0RCTAssert(state, @"`state` must not be null.");
  ABI47_0_0RCTAssert(
...
- (void)didReceiveImage:(UIImage *)image metadata:(id)metadata fromObserver:(void const *)observer
{
  ...
  if (imageProps.resizeMode == ImageResizeMode::Repeat) {
    image = [image resizableImageWithCapInsets:ABI47_0_0RCTUIEdgeInsetsFromEdgeInsets(imageProps.capInsets)
  ...
  if (imageProps.blurRadius > __FLT_EPSILON__) {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
      UIImage *blurredImage = ABI47_0_0RCTBlurredImageWithRadius(image, blurRadius);
...
Class<ABI47_0_0RCTComponentViewProtocol> ABI47_0_0RCTImageCls(void);
...
Class<ABI47_0_0RCTComponentViewProtocol> ABI47_0_0RCTImageCls(void)
{
  return ABI47_0_0RCTImageComponentView.class;
}
