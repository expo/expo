 ...
 */
@interface ABI47_0_0RCTScrollViewComponentView : ABI47_0_0RCTViewComponentView <ABI47_0_0RCTMountingTransactionObserving>

/*
 * Finds and returns the closet ABI47_0_0RCTScrollViewComponentView component to the given view
 */
+ (nullable ABI47_0_0RCTScrollViewComponentView *)findScrollViewComponentViewForView:(UIView *)view;
...
/*
 * ABI47_0_0RCTScrollableProtocol is a protocol which ABI47_0_0RCTScrollViewManager uses to communicate with all kinds of `UIScrollView`s.
 ...
 */
@interface ABI47_0_0RCTScrollViewComponentView (ScrollableProtocol) <ABI47_0_0RCTScrollableProtocol>
