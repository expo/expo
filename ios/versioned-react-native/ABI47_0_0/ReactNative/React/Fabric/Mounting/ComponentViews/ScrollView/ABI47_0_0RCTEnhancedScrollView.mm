...
@interface ABI47_0_0RCTEnhancedScrollView () <UIScrollViewDelegate>
@end

@implementation ABI47_0_0RCTEnhancedScrollView {
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _delegateSplitter = [[ABI47_0_0RCTGenericDelegateSplitter alloc] initWithDelegateUpdateBlock:^(id delegate) {
...
#pragma mark - ABI47_0_0RCTGenericDelegateSplitter
