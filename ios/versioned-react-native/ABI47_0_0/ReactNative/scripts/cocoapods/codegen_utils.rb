...
class CodegenUtils
    ...
    def generate_react_codegen_podspec!(spec, codegen_output_dir)
        ...
        if @@REACT_CODEGEN_PODSPEC_GENERATED
          Pod::UI.puts "[Codegen] Skipping ABI47_0_0React-Codegen podspec generation."
          return
        end
        ...
        podspec_path = File.join(output_dir, 'ABI47_0_0React-Codegen.podspec.json')
    ...
    # It generates the podspec object that represents the `ABI47_0_0React-Codegen.podspec` file
    #
    # Parameters
        ...
        spec = {
          ...
          'pod_target_xcconfig' => { "HEADER_SEARCH_PATHS" =>
            [
              "\"$(PODS_ROOT)/boost\"",
              "\"$(PODS_ROOT)/RCT-Folly\"",
              "\"${PODS_ROOT}/Headers/Public/ABI47_0_0React-Codegen/react/renderer/components\"",
              "\"$(PODS_ROOT)/Headers/Private/ABI47_0_0React-Fabric\"",
              "\"$(PODS_ROOT)/Headers/Private/ABI47_0_0React-RCTFabric\"",
            ].join(' ')
          },
          'dependencies': {
            "ABI47_0_0FBReactNativeSpec":  [version],
            "ABI47_0_0React-jsiexecutor":  [version],
            "RCT-Folly": [folly_version],
            "ABI47_0_0RCTRequired": [version],
            "ABI47_0_0RCTTypeSafety": [version],
            "ABI47_0_0React-Core": [version],
            "ABI47_0_0React-jsi": [version],
            "ABI47_0_0ReactCommon/turbomodule/core": [version]
          }
        }

        if fabric_enabled
          spec[:'dependencies'].merge!({
            "ABI47_0_0React-graphics": [version],
            "ABI47_0_0React-rncore":  [version],
          });
        end

        if script_phases
          Pod::UI.puts "[Codegen] Adding script_phases to ABI47_0_0React-Codegen."
    ...
    def use_react_native_codegen_discovery!(
      ...
      # Generate ABI47_0_0React-Codegen podspec here to add the script phases.
