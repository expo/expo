...
#include <ABI47_0_0ReactCommon/ABI47_0_0TurboModulePerfLogger.h>
#include <ABI47_0_0ReactCommon/ABI47_0_0TurboModuleUtils.h>
#include <ABI47_0_0jsi/ABI47_0_0JSIDynamic.h>
#include <ABI47_0_0React/ABI47_0_0debug/ABI47_0_0React_native_assert.h>
#include <ABI47_0_0React/ABI47_0_0jni/NativeMap.h>
#include <ABI47_0_0React/ABI47_0_0jni/ReadableNativeMap.h>
#include <ABI47_0_0React/ABI47_0_0jni/WritableNativeMap.h>

#include "ABI47_0_0JavaTurboModule.h"
...
jni::local_ref<JCxxCallbackImpl::JavaPart> createJavaCallbackFromJSIFunction(
  ...
  auto weakWrapper = retainJSCallback != nullptr
      ...
      : ABI47_0_0React::CallbackWrapper::createWeak(std::move(function), rt, jsInvoker);
...
std::string stringifyJSIValue(const jsi::Value &v, jsi::Runtime *rt = nullptr) {
  ...
  ABI47_0_0React_native_assert(v.isObject() && "Expecting object.");
...
JNIArgs convertJSIArgsToJNIArgs(
  ...
  for (unsigned int argIndex = 0; argIndex < count; argIndex += 1) {
    ...
    if (arg->isNull() || arg->isUndefined()) {
    ...
    } else if (type == "Lcom/facebook/ABI47_0_0React/bridge/Callback;") {
      ...
      jarg->l = makeGlobalIfNecessary(
          createJavaCallbackFromJSIFunction(
              ...
              .release());
    } else if (type == "Lcom/facebook/ABI47_0_0React/bridge/ReadableArray;") {
    ...
    } else if (type == "Lcom/facebook/ABI47_0_0React/bridge/ReadableMap;") {
      if (!(arg->isObject())) {
        throw JavaTurboModuleArgumentConversionException(
...
jsi::Value convertFromJMapToValue(JNIEnv *env, jsi::Runtime &rt, jobject arg) {
  ...
  jclass jArguments = env->FindClass("com/facebook/ABI47_0_0React/bridge/Arguments");
  static jmethodID jMakeNativeMap = env->GetStaticMethodID(
      jArguments,
      "makeNativeMap",
      "(Ljava/util/Map;)Lcom/facebook/ABI47_0_0React/bridge/WritableNativeMap;");
  auto constants =
      ...
      jsi::Function promiseConstructorArg = jsi::Function::createFromHostFunction(
          ...
          [this,
           ...
           retainJSCallback = retainJSCallback_](
            ...
            jclass jPromiseImpl =
                env->FindClass("com/facebook/ABI47_0_0React/bridge/PromiseImpl");
            jmethodID jPromiseImplConstructor = env->GetMethodID(
                jPromiseImpl,
                "<init>",
                "(Lcom/facebook/ABI47_0_0React/bridge/Callback;Lcom/facebook/ABI47_0_0React/bridge/Callback;)V");
