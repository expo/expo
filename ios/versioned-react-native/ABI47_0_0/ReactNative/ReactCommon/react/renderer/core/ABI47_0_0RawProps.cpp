...
#include "ABI47_0_0RawProps.h"

#include <ABI47_0_0React/ABI47_0_0debug/ABI47_0_0React_native_assert.h>
#include <ABI47_0_0React/ABI47_0_0renderer/core/RawPropsKey.h>
#include <ABI47_0_0React/ABI47_0_0renderer/core/RawPropsParser.h>
...
void RawProps::parse(RawPropsParser const &parser, const PropsParserContext &)
    const noexcept {
  ABI47_0_0React_native_assert(parser_ == nullptr && "A parser was already assigned.");
  parser_ = &parser;
