...
class EventQueueProcessorTest : public testing::Test {
 protected:
  ...
  std::vector<ABI47_0_0ReactEventPriority> eventPriorities_;
...
TEST_F(EventQueueProcessorTest, singleUnspecifiedEvent) {
  ...
  ABI47_0_0EXPECT_EQ(eventPriorities_.size(), 1);
  ABI47_0_0EXPECT_EQ(eventTypes_[0], "my type");
  ABI47_0_0EXPECT_EQ(eventPriorities_[0], ABI47_0_0ReactEventPriority::Discrete);
}
...
TEST_F(EventQueueProcessorTest, continiousEvent) {
  ...
  ABI47_0_0EXPECT_EQ(eventPriorities_.size(), 4);

  ABI47_0_0EXPECT_EQ(eventTypes_[0], "touchStart");
  ABI47_0_0EXPECT_EQ(eventPriorities_[0], ABI47_0_0ReactEventPriority::Discrete);

  ABI47_0_0EXPECT_EQ(eventTypes_[1], "touchMove");
  ABI47_0_0EXPECT_EQ(eventPriorities_[1], ABI47_0_0ReactEventPriority::Default);

  ABI47_0_0EXPECT_EQ(eventTypes_[2], "touchEnd");
  ABI47_0_0EXPECT_EQ(eventPriorities_[2], ABI47_0_0ReactEventPriority::Discrete);

  ABI47_0_0EXPECT_EQ(eventTypes_[3], "custom event");
  ABI47_0_0EXPECT_EQ(eventPriorities_[3], ABI47_0_0ReactEventPriority::Discrete);
}
...
TEST_F(EventQueueProcessorTest, alwaysContinuousEvent) {
  ...
  ABI47_0_0EXPECT_EQ(eventTypes_[0], "onScroll");
  ABI47_0_0EXPECT_EQ(eventPriorities_[0], ABI47_0_0ReactEventPriority::Default);
}
...
TEST_F(EventQueueProcessorTest, alwaysDiscreteEvent) {
  ...
  ABI47_0_0EXPECT_EQ(eventTypes_[0], "onChange");
  ABI47_0_0EXPECT_EQ(eventPriorities_[0], ABI47_0_0ReactEventPriority::Discrete);
}
