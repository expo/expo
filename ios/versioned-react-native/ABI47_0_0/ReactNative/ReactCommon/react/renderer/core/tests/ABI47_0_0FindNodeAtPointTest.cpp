...
TEST(FindNodeAtPointTest, withoutTransform) {
  ...
  ABI47_0_0EXPECT_EQ(LayoutableShadowNode::findNodeAtPoint(parentShadowNode, {105, 105})->getTag(), 2);
  ABI47_0_0EXPECT_EQ(LayoutableShadowNode::findNodeAtPoint(parentShadowNode, {900, 900})->getTag(), 1);
  ABI47_0_0EXPECT_EQ(
...
TEST(FindNodeAtPointTest, viewIsTranslated) {
  ...
  ABI47_0_0EXPECT_EQ(
      ...
      3);
  ABI47_0_0EXPECT_EQ(LayoutableShadowNode::findNodeAtPoint(parentShadowNode, {5, 5})->getTag(), 2);
}
