...
#include <ABI47_0_0React/ABI47_0_0renderer/core/EventHandler.h>
...
inline static SharedEventTarget eventTargetFromValue(
  ...
  ABI47_0_0React_native_assert(!eventTargetValue.isNull());
...
inline static int displayModeToInt(DisplayMode const value) {
  ...
  // Libraries/ABI47_0_0ReactNative/DisplayMode.js
  switch (value) {
