...
#include "ABI47_0_0LayoutAnimationKeyFrameManager.h"

#include <algorithm>
#include <sstream>
#include <utility>

#include <ABI47_0_0React/ABI47_0_0debug/flags.h>
#include <ABI47_0_0React/ABI47_0_0debug/ABI47_0_0React_native_assert.h>

#include <ABI47_0_0logger/ABI47_0_0React_native_log.h>
#include <ABI47_0_0React/ABI47_0_0renderer/animations/conversions.h>
#include <ABI47_0_0React/ABI47_0_0renderer/animations/utils.h>
  ...
  if (!mutations.empty()) {
    ...
    if (currentAnimation.has_value()) {
      ...
      for (auto const &mutation : mutations) {
        ...
        ABI47_0_0React_native_assert(baselineShadowView.tag > 0);
          ...
          if (mutation.type == ShadowViewMutation::Type::Insert) {
            for (auto &keyframe : keyFramesToAnimate) {
              if (keyframe.tag == baselineShadowView.tag) {
                ...
                // "newChildShadowView"
                ABI47_0_0React_native_assert(mutation.newChildShadowView.tag > 0);
            ...
            for (auto &keyframe : keyFramesToAnimate) {
              if (keyframe.tag == baselineShadowView.tag) {
                ...
                // "oldChildShadowView"
                ABI47_0_0React_native_assert(mutation.oldChildShadowView.tag > 0);
        ...
        if (!wasInsertedTagRemoved && !isRemoveReinserted && !isReparented &&
          ...
          ShadowView viewStart = ShadowView(
              mutation.type == ShadowViewMutation::Type::Insert
                  ? mutation.newChildShadowView
                  : mutation.oldChildShadowView);
          ABI47_0_0React_native_assert(viewStart.tag > 0);
          ShadowView viewFinal = ShadowView(
              mutation.type == ShadowViewMutation::Type::Update
                  ? mutation.newChildShadowView
                  : viewStart);
          ABI47_0_0React_native_assert(viewFinal.tag > 0);
          ...
          if (mutation.type == ShadowViewMutation::Type::Insert) {
            if (mutationConfig.animationProperty ==
              ...
              ABI47_0_0React_native_assert(props != nullptr);
              if (props != nullptr) {
...
/*            Tag deleteTag = mutation.oldChildShadowView.tag;
            ...
            ABI47_0_0React_native_assert(correspondingRemoveIt != mutations.end());
*/
#endif
#endif
            continue;
            ...
            if (correspondingInsertIt == mutations.end()) {
              ...
              ABI47_0_0React_native_assert(correspondingDeleteIt != mutations.end());
          ...
          for (auto &conflictingKeyFrame : conflictingAnimations) {
            ...
            if (conflictingMutationBaselineShadowView.tag == tag) {
              ...
              ABI47_0_0React_native_assert(keyFrame.viewStart.tag > 0);
...
#endif
          ABI47_0_0React_native_assert(keyFrame.viewStart.tag > 0);
          ABI47_0_0React_native_assert(keyFrame.viewEnd.tag > 0);
          ABI47_0_0React_native_assert(keyFrame.viewPrev.tag > 0);
...
ShadowView LayoutAnimationKeyFrameManager::createInterpolatedShadowView(
  ...
  ABI47_0_0React_native_assert(startingView.tag > 0);
  ABI47_0_0React_native_assert(finalView.tag > 0);
  ...
  ABI47_0_0React_native_assert(mutatedShadowView.tag > 0);

  ABI47_0_0React_native_assert(startingView.props != nullptr);
  ABI47_0_0React_native_assert(finalView.props != nullptr);
  ...
  ABI47_0_0React_native_assert(mutatedShadowView.props != nullptr);
...
void LayoutAnimationKeyFrameManager::queueFinalMutationsForCompletedKeyFrame(
  ...
  if (keyframe.finalMutationsForKeyFrame.size() > 0) {
    ...
    if (interrupted) {
      ...
      ABI47_0_0React_native_assert(generatedMutation.oldChildShadowView.tag > 0);
      ABI47_0_0React_native_assert(generatedMutation.newChildShadowView.tag > 0);
      PrintMutationInstruction(
...
void LayoutAnimationKeyFrameManager::adjustDelayedMutationIndicesForMutation(
  ...
  auto tag = isRemoveMutation ? mutation.oldChildShadowView.tag
                              : mutation.newChildShadowView.tag;
  ABI47_0_0React_native_assert(isRemoveMutation || isInsertMutation);
