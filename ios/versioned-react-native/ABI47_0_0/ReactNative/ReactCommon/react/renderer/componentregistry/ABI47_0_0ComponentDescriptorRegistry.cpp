...
#include "ABI47_0_0componentNameByABI47_0_0ReactViewName.h"
...
ComponentDescriptor const &ComponentDescriptorRegistry::at(
  ...
  auto unifiedComponentName = componentNameByABI47_0_0ReactViewName(componentName);
...
ShadowNode::Shared ComponentDescriptorRegistry::createNode(
  ...
  auto unifiedComponentName = componentNameByABI47_0_0ReactViewName(viewName);
