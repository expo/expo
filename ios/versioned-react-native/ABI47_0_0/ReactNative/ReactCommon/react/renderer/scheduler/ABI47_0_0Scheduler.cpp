...
#include <ABI47_0_0React/ABI47_0_0renderer/uimanager/UIManager.h>
#include <ABI47_0_0React/ABI47_0_0renderer/uimanager/UIManagerBinding.h>
...
Scheduler::Scheduler(
  ...
  ABI47_0_0ReactNativeConfig_ =
      contextContainer_->at<std::shared_ptr<const ABI47_0_0ReactNativeConfig>>(
...
#ifdef ANDROID
  auto enableCallImmediates = ABI47_0_0ReactNativeConfig_->getBool(
      "ABI47_0_0React_native_new_architecture:enable_call_immediates_android");
#else
  auto enableCallImmediates = ABI47_0_0ReactNativeConfig_->getBool(
      "ABI47_0_0React_native_new_architecture:enable_call_immediates_ios");
#endif
...
#else
  removeOutstandingSurfacesOnDestruction_ = ABI47_0_0ReactNativeConfig_->getBool(
      "ABI47_0_0React_fabric:remove_outstanding_surfaces_on_destruction_ios");
#endif
}
...
void Scheduler::renderTemplateToSurface(
  ...
  try {
    ...
    LOG(ERROR) << "    >>>> ABI47_0_0EXCEPTION <<<  rendering uiTemplate in "
