...
#include "ABI47_0_0AttributedStringBox.h"
...
AttributedString const &AttributedStringBox::getValue() const {
  ABI47_0_0React_native_assert(mode_ == AttributedStringBox::Mode::Value);
  ABI47_0_0React_native_assert(value_);
  return *value_;
}

std::shared_ptr<void> AttributedStringBox::getOpaquePointer() const {
  ABI47_0_0React_native_assert(mode_ == AttributedStringBox::Mode::OpaquePointer);
  ABI47_0_0React_native_assert(opaquePointer_);
