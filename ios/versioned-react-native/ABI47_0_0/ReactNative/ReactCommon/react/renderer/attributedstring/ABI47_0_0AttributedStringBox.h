...
template <>
struct std::hash<ABI47_0_0facebook::ABI47_0_0React::AttributedStringBox> {
  size_t operator()(
      ABI47_0_0facebook::ABI47_0_0React::AttributedStringBox const &attributedStringBox) const {
    switch (attributedStringBox.getMode()) {
      case ABI47_0_0facebook::ABI47_0_0React::AttributedStringBox::Mode::Value:
        return std::hash<ABI47_0_0facebook::ABI47_0_0React::AttributedString>()(
            attributedStringBox.getValue());
      case ABI47_0_0facebook::ABI47_0_0React::AttributedStringBox::Mode::OpaquePointer:
