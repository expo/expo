...
#include "ABI47_0_0TransactionTelemetry.h"
...
void TransactionTelemetry::willCommit() {
  ABI47_0_0React_native_assert(commitStartTime_ == kTelemetryUndefinedTimePoint);
  ABI47_0_0React_native_assert(commitEndTime_ == kTelemetryUndefinedTimePoint);
...
void TransactionTelemetry::willDiff() {
  ABI47_0_0React_native_assert(diffStartTime_ == kTelemetryUndefinedTimePoint);
  ABI47_0_0React_native_assert(diffEndTime_ == kTelemetryUndefinedTimePoint);
  diffStartTime_ = now_();
}
...
void TransactionTelemetry::willLayout() {
  ABI47_0_0React_native_assert(layoutStartTime_ == kTelemetryUndefinedTimePoint);
  ABI47_0_0React_native_assert(layoutEndTime_ == kTelemetryUndefinedTimePoint);
...
void TransactionTelemetry::willMount() {
  ABI47_0_0React_native_assert(mountStartTime_ == kTelemetryUndefinedTimePoint);
  ABI47_0_0React_native_assert(mountEndTime_ == kTelemetryUndefinedTimePoint);
