...
#include <ABI47_0_0React/ABI47_0_0utils/SimpleThreadSafeCache.h>
...
template <>
struct hash<ABI47_0_0facebook::ABI47_0_0React::TextMeasureCacheKey> {
  size_t operator()(ABI47_0_0facebook::ABI47_0_0React::TextMeasureCacheKey const &key) const {
    return folly::hash::hash_combine(
        0,
