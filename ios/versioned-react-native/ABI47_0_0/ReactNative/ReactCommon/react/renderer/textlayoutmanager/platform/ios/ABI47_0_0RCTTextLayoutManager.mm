...
#import <ABI47_0_0React/ABI47_0_0utils/SimpleThreadSafeCache.h>

using namespace ABI47_0_0facebook::ABI47_0_0React;

@implementation ABI47_0_0RCTTextLayoutManager {
  SimpleThreadSafeCache<AttributedString, std::shared_ptr<void>, 256> _cache;
}

static NSLineBreakMode ABI47_0_0RCTNSLineBreakModeFromEllipsizeMode(EllipsizeMode ellipsizeMode)
{
                           ...
                           layoutConstraints:(LayoutConstraints)layoutConstraints
{
  ...
  size = (CGSize){ABI47_0_0RCTCeilPixelValue(size.width), ABI47_0_0RCTCeilPixelValue(size.height)};
      ...
      enumerateAttribute:NSAttachmentAttributeName
              ...
              usingBlock:^(NSTextAttachment *attachment, NSRange range, BOOL *stop) {
                ...
                auto rect = ABI47_0_0facebook::ABI47_0_0React::Rect{
                    ABI47_0_0facebook::ABI47_0_0React::Point{frame.origin.x, frame.origin.y},
                    ABI47_0_0facebook::ABI47_0_0React::Size{frame.size.width, frame.size.height}};
...
- (LinesMeasurements)getLinesForAttributedString:(ABI47_0_0facebook::ABI47_0_0React::AttributedString)attributedString
  ...
  [layoutManager enumerateLineFragmentsForGlyphRange:glyphRange
                                          usingBlock:^(
                                            ...
                                            UIFont *font = [[textStorage attributedSubstringFromRange:range]
                                                ...
                                                effectiveRange:nil];
                                            auto rect = ABI47_0_0facebook::ABI47_0_0React::Rect{
                                                ABI47_0_0facebook::ABI47_0_0React::Point{usedRect.origin.x, usedRect.origin.y},
                                                ABI47_0_0facebook::ABI47_0_0React::Size{usedRect.size.width, usedRect.size.height}};
                                                               ...
                                                               size:(CGSize)size
{
  ...
  textContainer.lineBreakMode = paragraphAttributes.maximumNumberOfLines > 0
      ? ABI47_0_0RCTNSLineBreakModeFromEllipsizeMode(paragraphAttributes.ellipsizeMode)
                                                 ...
                                                 atPoint:(CGPoint)point
{
  ...
  if (textStorage.length > 0 && (fraction > 0 || characterIndex > 0) &&
    ...
    ABI47_0_0RCTWeakEventEmitterWrapper *eventEmitterWrapper =
        (ABI47_0_0RCTWeakEventEmitterWrapper *)[textStorage attribute:ABI47_0_0RCTAttributedStringEventEmitterKey
...
- (NSAttributedString *)_nsAttributedStringFromAttributedString:(AttributedString)attributedString
{
  auto sharedNSAttributedString = _cache.get(attributedString, [](AttributedString attributedString) {
    return wrapManagedObject(ABI47_0_0RCTNSAttributedStringFromAttributedString(attributedString));
  });
