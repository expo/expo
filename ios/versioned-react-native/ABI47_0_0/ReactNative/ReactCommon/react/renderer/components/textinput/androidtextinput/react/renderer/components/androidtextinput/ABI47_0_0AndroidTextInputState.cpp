...
#include "ABI47_0_0AndroidTextInputState.h"
...
AndroidTextInputState::AndroidTextInputState(
    ...
    : mostRecentEventCount(mostRecentEventCount),
      ...
      ABI47_0_0ReactTreeAttributedString(std::move(ABI47_0_0ReactTreeAttributedString)),
...
AndroidTextInputState::AndroidTextInputState(
    ...
    : mostRecentEventCount(data.getDefault(
      ...
      ABI47_0_0ReactTreeAttributedString(previousState.ABI47_0_0ReactTreeAttributedString),
