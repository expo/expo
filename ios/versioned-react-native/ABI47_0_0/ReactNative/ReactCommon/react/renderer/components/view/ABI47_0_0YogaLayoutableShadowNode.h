...
#pragma mark - Mutating Methods
   ...
   */
  void setPositionType(ABI47_0_0YGPositionType positionType) const;
...
#pragma mark - LayoutableShadowNode
 ...
 protected:
   ...
   * all the time.
   */
  mutable ABI47_0_0YGNode yogaNode_;
 ...
 private:
  ...
  static ABI47_0_0YGConfig &initializeYogaConfig(ABI47_0_0YGConfig &config);
  static ABI47_0_0YGNode *yogaNodeCloneCallbackConnector(
      ABI47_0_0YGNode *oldYogaNode,
      ABI47_0_0YGNode *parentYogaNode,
      int childIndex);
  static ABI47_0_0YGSize yogaNodeMeasureCallbackConnector(
      ABI47_0_0YGNode *yogaNode,
      float width,
...
traitCast<YogaLayoutableShadowNode const &>(ShadowNode const &shadowNode) {
  ...
  ABI47_0_0React_native_assert(castable);
  (void)castable;
