...
AttributedString AndroidTextInputShadowNode::getMostRecentAttributedString()
  ...
  auto ABI47_0_0ReactTreeAttributedString = getAttributedString();
  ...
  bool treeAttributedStringChanged =
      !state.ABI47_0_0ReactTreeAttributedString.compareTextAttributesWithoutFrame(
          ABI47_0_0ReactTreeAttributedString);
...
void AndroidTextInputShadowNode::updateStateIfNeeded() {
  ...
  auto newEventCount =
      (state.ABI47_0_0ReactTreeAttributedString == ABI47_0_0ReactTreeAttributedString
           ? 0
