...
#include "ABI47_0_0AndroidTextInputShadowNode.h"

#include <fbjni/fbjni.h>

#include <ABI47_0_0yoga/ABI47_0_0CompactValue.h>
#include <ABI47_0_0yoga/ABI47_0_0YGEnums.h>
#include <ABI47_0_0yoga/ABI47_0_0YGValue.h>
...
class AndroidTextInputComponentDescriptor final
  ...
  virtual State::Shared createInitialState(
    ...
    if (surfaceIdToThemePaddingMap_.find(surfaceId) !=
      ...
      if (getThemeData(
        ...
        theme[ABI47_0_0YGEdgeStart] = (ABI47_0_0YGValue){defaultTextInputPadding[0], ABI47_0_0YGUnitPoint};
        theme[ABI47_0_0YGEdgeEnd] = (ABI47_0_0YGValue){defaultTextInputPadding[1], ABI47_0_0YGUnitPoint};
        theme[ABI47_0_0YGEdgeTop] = (ABI47_0_0YGValue){defaultTextInputPadding[2], ABI47_0_0YGUnitPoint};
        theme[ABI47_0_0YGEdgeBottom] =
            (ABI47_0_0YGValue){defaultTextInputPadding[3], ABI47_0_0YGUnitPoint};
    ...
    return std::make_shared<AndroidTextInputShadowNode::ConcreteState>(
        std::make_shared<AndroidTextInputState const>(AndroidTextInputState(
            ...
            {},
            {},
            ((ABI47_0_0YGValue)theme[ABI47_0_0YGEdgeStart]).value,
            ((ABI47_0_0YGValue)theme[ABI47_0_0YGEdgeEnd]).value,
            ((ABI47_0_0YGValue)theme[ABI47_0_0YGEdgeTop]).value,
            ((ABI47_0_0YGValue)theme[ABI47_0_0YGEdgeBottom]).value)),
        family);
  }
 ...
 protected:
  void adopt(ShadowNode::Unshared const &shadowNode) const override {
    ...
    if (surfaceIdToThemePaddingMap_.find(surfaceId) !=
        surfaceIdToThemePaddingMap_.end()) {
      ABI47_0_0YGStyle::Edges theme = surfaceIdToThemePaddingMap_[surfaceId];
      ...
      if (!textInputShadowNode->getConcreteProps().hasPadding &&
        ...
        changedPadding = true;
        result[ABI47_0_0YGEdgeStart] = theme[ABI47_0_0YGEdgeStart];
      }
      if (!textInputShadowNode->getConcreteProps().hasPadding &&
      ...
      if ((textInputShadowNode->getConcreteProps().hasPadding ||
           ...
           textInputShadowNode->getConcreteProps().hasPaddingHorizontal) &&
          !textInputShadowNode->getConcreteProps().hasPaddingStart) {
        result[ABI47_0_0YGEdgeStart] = ABI47_0_0YGValueUndefined;
      }
      if ((textInputShadowNode->getConcreteProps().hasPadding ||
           textInputShadowNode->getConcreteProps().hasPaddingRight ||
           textInputShadowNode->getConcreteProps().hasPaddingHorizontal) &&
          !textInputShadowNode->getConcreteProps().hasPaddingEnd) {
        result[ABI47_0_0YGEdgeEnd] = ABI47_0_0YGValueUndefined;
      }
 ...
 private:
  ...
  mutable butter::map<int, ABI47_0_0YGStyle::Edges> surfaceIdToThemePaddingMap_;
};
