...
TEST(ParagraphLocalDataTest, testSomething) {
  ...
  ABI47_0_0React_native_assert(result["string"] == fragment.string);
  ...
  ABI47_0_0React_native_assert(textAttribute["opacity"] == text.opacity);
  ABI47_0_0React_native_assert(textAttribute["fontStyle"] == toString(*text.fontStyle));
  ABI47_0_0React_native_assert(
