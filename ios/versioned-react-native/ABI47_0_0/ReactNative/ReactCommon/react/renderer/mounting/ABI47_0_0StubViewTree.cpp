  ...
  for (auto const &mutation : mutations) {
    switch (mutation.type) {
      case ShadowViewMutation::Create: {
        ABI47_0_0React_native_assert(mutation.parentShadowView == ShadowView{});
        ABI47_0_0React_native_assert(mutation.oldChildShadowView == ShadowView{});
        ABI47_0_0React_native_assert(mutation.newChildShadowView.props);
        ...
        ABI47_0_0React_native_assert(registry.find(tag) == registry.end());
      ...
      case ShadowViewMutation::Delete: {
        ...
        ABI47_0_0React_native_assert(mutation.parentShadowView == ShadowView{});
        ABI47_0_0React_native_assert(mutation.newChildShadowView == ShadowView{});
      ...
      case ShadowViewMutation::Insert: {
        if (!mutation.mutatedViewIsVirtual()) {
          ...
          ABI47_0_0React_native_assert(registry.find(parentTag) != registry.end());
          auto parentStubView = registry[parentTag];
          ABI47_0_0React_native_assert(registry.find(childTag) != registry.end());
          ...
          ABI47_0_0React_native_assert(childStubView->parentTag == NO_VIEW_TAG);
          ABI47_0_0React_native_assert(
              mutation.index >= 0 &&
      ...
      case ShadowViewMutation::Remove: {
        if (!mutation.mutatedViewIsVirtual()) {
          ...
          ABI47_0_0React_native_assert(childStubView->parentTag == parentTag);
          STUB_VIEW_LOG({
      ...
      case ShadowViewMutation::Update: {
        ...
        ABI47_0_0React_native_assert(oldStubView->tag != 0);
