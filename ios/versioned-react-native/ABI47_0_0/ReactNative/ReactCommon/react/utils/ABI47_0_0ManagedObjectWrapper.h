...
@interface ABI47_0_0RCTInternalGenericWeakWrapper : NSObject
...
{
  ABI47_0_0RCTInternalGenericWeakWrapper *weakWrapper = [ABI47_0_0RCTInternalGenericWeakWrapper new];
...
{
  ABI47_0_0RCTInternalGenericWeakWrapper *weakWrapper = (ABI47_0_0RCTInternalGenericWeakWrapper *)unwrapManagedObject(object);
  ABI47_0_0React_native_assert(weakWrapper && "`ABI47_0_0RCTInternalGenericWeakWrapper` instance must not be `nil`.");
