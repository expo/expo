...
#define JSC_LIKELY(ABI47_0_0EXPR) __builtin_expect((bool)(ABI47_0_0EXPR), true)
#define JSC_UNLIKELY(ABI47_0_0EXPR) __builtin_expect((bool)(ABI47_0_0EXPR), false)
#else
#define JSC_LIKELY(ABI47_0_0EXPR) (ABI47_0_0EXPR)
#define JSC_UNLIKELY(ABI47_0_0EXPR) (ABI47_0_0EXPR)
#endif
