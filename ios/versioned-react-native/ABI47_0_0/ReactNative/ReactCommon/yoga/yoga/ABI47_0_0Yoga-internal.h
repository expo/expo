...
using ABI47_0_0YGVector = std::vector<ABI47_0_0YGNodeRef>;

ABI47_0_0YG_EXTERN_C_BEGIN

void ABI47_0_0YGNodeCalculateLayoutWithContext(
...
extern const std::array<ABI47_0_0YGEdge, 4> trailing;
extern const std::array<ABI47_0_0YGEdge, 4> leading;
extern const ABI47_0_0YGValue ABI47_0_0YGValueUndefined;
extern const ABI47_0_0YGValue ABI47_0_0YGValueAuto;
extern const ABI47_0_0YGValue ABI47_0_0YGValueZero;

struct ABI47_0_0YGCachedMeasurement {
  float availableWidth;
  float availableHeight;
  ...
  bool operator==(ABI47_0_0YGCachedMeasurement measurement) const {
...
#define ABI47_0_0YG_MAX_CACHED_RESULT_COUNT 8
...
public:
  Values() = default;
  explicit Values(const ABI47_0_0YGValue& defaultValue) noexcept {
  ...
  template <size_t I>
  ABI47_0_0YGValue get() const noexcept {
    return std::get<I>(values_);
  }

  template <size_t I>
  void set(ABI47_0_0YGValue& value) noexcept {
...
extern bool ABI47_0_0YGFloatsEqual(const float a, const float b);
