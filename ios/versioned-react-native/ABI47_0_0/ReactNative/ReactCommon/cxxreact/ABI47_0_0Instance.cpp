...
#include "ABI47_0_0RecoverableError.h"
#include "ABI47_0_0SystraceSection.h"

#include <ABI47_0_0cxxreact/ABI47_0_0JSIndexedRAMBundle.h>
...
void Instance::JSCallInvoker::invokeAsync(std::function<void()> &&work) {
   ...
   *    is initialized. ABI47_0_0RCTDevLoadingView shows bundle download progress.
