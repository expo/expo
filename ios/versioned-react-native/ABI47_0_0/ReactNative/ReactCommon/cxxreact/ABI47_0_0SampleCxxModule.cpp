...
#include "ABI47_0_0SampleCxxModule.h"
...
ABI47_0_0facebook::xplat::module::CxxModule *SampleCxxModule() {
  return new ABI47_0_0facebook::xplat::samples::SampleCxxModule(
      std::make_unique<ABI47_0_0facebook::xplat::samples::Sample>());
}
