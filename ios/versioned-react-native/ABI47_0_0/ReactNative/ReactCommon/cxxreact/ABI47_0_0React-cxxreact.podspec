...
Pod::Spec.new do |s|
  s.name                   = "ABI47_0_0React-cxxreact"
  s.version                = version
  s.summary                = "-"  # TODO
  ...
  s.dependency "ABI47_0_0React-callinvoker", version
  s.dependency "ABI47_0_0React-runtimeexecutor", version
