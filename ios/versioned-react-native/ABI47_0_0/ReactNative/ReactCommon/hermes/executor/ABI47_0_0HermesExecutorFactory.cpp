...
#include "ABI47_0_0HermesExecutorFactory.h"
...
#include <ABI47_0_0jsi/ABI47_0_0decorator.h>

#ifdef HERMES_ENABLE_DEBUGGER
#include <hermes/inspector/ABI47_0_0RuntimeAdapter.h>
#include <hermes/inspector/chrome/ABI47_0_0Registration.h>
#endif

#include "ABI47_0_0JSITracing.h"

using namespace ABI47_0_0facebook::ABI47_0_0hermes;
...
std::unique_ptr<HermesRuntime> makeHermesRuntimeSystraced(
    const ::ABI47_0_0hermes::vm::RuntimeConfig &runtimeConfig) {
  SystraceSection s("HermesExecutorFactory::makeHermesRuntimeSystraced");
  return ABI47_0_0hermes::makeHermesRuntime(runtimeConfig);
}

#ifdef HERMES_ENABLE_DEBUGGER

class HermesExecutorRuntimeAdapter
    : public ABI47_0_0facebook::ABI47_0_0hermes::inspector::RuntimeAdapter {
 public:
 ...
 public:
  ...
  DecoratedRuntime(
    ...
    if (enableDebugger_) {
      ...
      ABI47_0_0facebook::ABI47_0_0hermes::inspector::chrome::enableDebugging(
...
#ifdef HERMES_ENABLE_DEBUGGER
    if (enableDebugger_) {
      ABI47_0_0facebook::ABI47_0_0hermes::inspector::chrome::disableDebugging(*runtime_);
    }
#endif
  }
...
::ABI47_0_0hermes::vm::RuntimeConfig HermesExecutorFactory::defaultRuntimeConfig() {
  return ::ABI47_0_0hermes::vm::RuntimeConfig::Builder()
