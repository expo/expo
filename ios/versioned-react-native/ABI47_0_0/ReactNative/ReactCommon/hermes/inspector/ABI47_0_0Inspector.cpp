...
#include "ABI47_0_0Inspector.h"
#include "ABI47_0_0Exceptions.h"
#include "ABI47_0_0InspectorState.h"

#include <functional>
#include <string>

#include <glog/logging.h>
#include <hermes/inspector/detail/ABI47_0_0SerialExecutor.h>
#include <hermes/inspector/detail/ABI47_0_0Thread.h>
...
// likely specific to the version of folly ABI47_0_0RN uses, so may need to be
// changed.  Even better, perhaps folly can be refactored to simplify
// this.  Providing a ABI47_0_0RN-specific Timekeeper impl may also help.
...
namespace debugger = ::ABI47_0_0facebook::ABI47_0_0hermes::debugger;
...
folly::Future<debugger::EvalResult> Inspector::evaluate(
    ...
    folly::Function<void(const ABI47_0_0facebook::ABI47_0_0hermes::debugger::EvalResult &)>
        resultTransformer) {
