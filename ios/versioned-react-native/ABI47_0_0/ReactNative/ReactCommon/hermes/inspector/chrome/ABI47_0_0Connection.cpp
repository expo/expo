...
#include <hermes/inspector/ABI47_0_0Inspector.h>
#include <hermes/inspector/chrome/ABI47_0_0MessageConverters.h>
#include <hermes/inspector/chrome/ABI47_0_0RemoteObjectsTable.h>
#include <hermes/inspector/detail/ABI47_0_0CallbackOStream.h>
...
using ::ABI47_0_0facebook::ABI47_0_0React::ILocalConnection;
using ::ABI47_0_0facebook::ABI47_0_0React::IRemoteConnection;
using ::folly::Unit;

namespace debugger = ::ABI47_0_0facebook::ABI47_0_0hermes::debugger;
namespace inspector = ::ABI47_0_0facebook::ABI47_0_0hermes::inspector;
...
void Connection::Impl::onMessageAdded(
    ABI47_0_0facebook::ABI47_0_0hermes::inspector::Inspector &inspector,
      ...
      ->evaluate(
          ...
          [this,
           ...
           byValue = req.returnByValue.value_or(false)](
              const ABI47_0_0facebook::ABI47_0_0hermes::debugger::EvalResult
                  &evalResult) mutable {
...
class CallFunctionOnRunner {
 public:
  ...
  // N.B.: constexpr char[] broke ABI47_0_0React-native-oss-android.
  ...
  jsi::Value operator()(
      jsi::Runtime &rt,
      RemoteObjectsTable &objTable,
      const ABI47_0_0facebook::ABI47_0_0hermes::debugger::EvalResult &evalResult) {
  ...
  inspector_
      ->evaluate(
          ...
          [this,
           ...
           byValue = req.returnByValue.value_or(false),
           runner =
               std::move(runner)](const ABI47_0_0facebook::ABI47_0_0hermes::debugger::EvalResult
                                      &evalResult) mutable {
