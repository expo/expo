...
#include <hermes/ABI47_0_0DebuggerAPI.h>
#include <hermes/ABI47_0_0hermes.h>
#include <hermes/inspector/chrome/ABI47_0_0MessageTypes.h>
#include <hermes/inspector/chrome/ABI47_0_0RemoteObjectsTable.h>
...
void setHermesLocation(
    ABI47_0_0facebook::ABI47_0_0hermes::debugger::SourceLocation &hermesLoc,
    const T &chromeLoc,
  ...
  if (chromeLoc.columnNumber.hasValue()) {
    if (chromeLoc.columnNumber.value() == 0) {
      ...
      hermesLoc.column = ::ABI47_0_0facebook::ABI47_0_0hermes::debugger::kInvalidLocation;
    } else {
...
void setChromeLocation(
    T &chromeLoc,
    const ABI47_0_0facebook::ABI47_0_0hermes::debugger::SourceLocation &hermesLoc) {
  if (hermesLoc.line != ABI47_0_0facebook::ABI47_0_0hermes::debugger::kInvalidLocation) {
    chromeLoc.lineNumber = hermesLoc.line - 1;
  }

  if (hermesLoc.column != ABI47_0_0facebook::ABI47_0_0hermes::debugger::kInvalidLocation) {
...
Location makeLocation(const ABI47_0_0facebook::ABI47_0_0hermes::debugger::SourceLocation &loc);

CallFrame makeCallFrame(
    uint32_t callFrameIndex,
    const ABI47_0_0facebook::ABI47_0_0hermes::debugger::CallFrameInfo &callFrameInfo,
    const ABI47_0_0facebook::ABI47_0_0hermes::debugger::LexicalInfo &lexicalInfo,
    ABI47_0_0facebook::ABI47_0_0hermes::inspector::chrome::RemoteObjectsTable &objTable,
    jsi::Runtime &runtime,
    const ABI47_0_0facebook::ABI47_0_0hermes::debugger::ProgramState &state);
...
CallFrame makeCallFrame(const ABI47_0_0facebook::ABI47_0_0hermes::debugger::CallFrameInfo &info);

std::vector<CallFrame> makeCallFrames(
    const ABI47_0_0facebook::ABI47_0_0hermes::debugger::StackTrace &stackTrace);

ExceptionDetails makeExceptionDetails(
    const ABI47_0_0facebook::ABI47_0_0hermes::debugger::ExceptionDetails &details);
