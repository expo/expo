...
using CommandPtr = std::unique_ptr<ABI47_0_0facebook::ABI47_0_0hermes::debugger::Command>;
 ...
 * JS. For instance, ABI47_0_0React Native could be blocked in a native message queue
