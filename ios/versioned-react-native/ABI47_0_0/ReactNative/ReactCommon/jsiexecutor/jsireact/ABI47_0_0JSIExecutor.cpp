...
#include <ABI47_0_0cxxreact/ABI47_0_0ErrorUtils.h>
#include <ABI47_0_0cxxreact/ABI47_0_0JSBigString.h>
#include <ABI47_0_0cxxreact/ABI47_0_0ModuleRegistry.h>
...
void JSIExecutor::initializeRuntime() {
  ...
  if (hasLogger) {
    ABI47_0_0ReactMarker::logMarker(ABI47_0_0ReactMarker::CREATE_REACT_CONTEXT_STOP);
  }
}
...
void JSIExecutor::loadBundle(
  ...
  if (hasLogger) {
    ABI47_0_0ReactMarker::logTaggedMarker(
        ABI47_0_0ReactMarker::RUN_JS_BUNDLE_START, scriptName.c_str());
  }
  ...
  if (hasLogger) {
    ABI47_0_0ReactMarker::logTaggedMarker(
        ABI47_0_0ReactMarker::RUN_JS_BUNDLE_STOP, scriptName.c_str());
  }
}
        ...
        *runtime_,
        ...
        Function::createFromHostFunction(
            *runtime_,
            ...
            [this](
                __unused Runtime &rt,
                const ABI47_0_0facebook::jsi::Value &,
...
void JSIExecutor::registerBundle(
  ...
  ABI47_0_0ReactMarker::logTaggedMarker(
      ABI47_0_0ReactMarker::REGISTER_JS_SEGMENT_START, tag.c_str());
  if (bundleRegistry_) {
  ...
  ABI47_0_0ReactMarker::logTaggedMarker(
      ABI47_0_0ReactMarker::REGISTER_JS_SEGMENT_STOP, tag.c_str());
}
...
Value JSIExecutor::nativeRequire(const Value *args, size_t count) {
  ...
  return ABI47_0_0facebook::jsi::Value();
}
...
Value JSIExecutor::nativeCallSyncHook(const Value *args, size_t count) {
  ...
  /**
   * Note:
   * In ABI47_0_0RCTNativeModule, folly::none is returned from callSerializableNativeHook
