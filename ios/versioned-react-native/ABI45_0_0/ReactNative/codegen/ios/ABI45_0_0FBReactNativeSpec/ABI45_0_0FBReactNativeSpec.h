...
@protocol ABI45_0_0NativeAccessibilityInfoSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>

- (void)isReduceMotionEnabled:(ABI45_0_0RCTResponseSenderBlock)onSuccess;
- (void)isTouchExplorationEnabled:(ABI45_0_0RCTResponseSenderBlock)onSuccess;
- (void)isAccessibilityServiceEnabled:(ABI45_0_0RCTResponseSenderBlock)onSuccess;
...
- (void)getRecommendedTimeoutMillis:(double)mSec
                          onSuccess:(ABI45_0_0RCTResponseSenderBlock)onSuccess;
...
- (void)getCurrentBoldTextState:(ABI45_0_0RCTResponseSenderBlock)onSuccess
                        onError:(ABI45_0_0RCTResponseSenderBlock)onError;
- (void)getCurrentGrayscaleState:(ABI45_0_0RCTResponseSenderBlock)onSuccess
                         onError:(ABI45_0_0RCTResponseSenderBlock)onError;
- (void)getCurrentInvertColorsState:(ABI45_0_0RCTResponseSenderBlock)onSuccess
                            onError:(ABI45_0_0RCTResponseSenderBlock)onError;
- (void)getCurrentReduceMotionState:(ABI45_0_0RCTResponseSenderBlock)onSuccess
                            onError:(ABI45_0_0RCTResponseSenderBlock)onError;
- (void)getCurrentReduceTransparencyState:(ABI45_0_0RCTResponseSenderBlock)onSuccess
                                  onError:(ABI45_0_0RCTResponseSenderBlock)onError;
...
namespace JS {
  namespace NativeActionSheetManager {
    struct SpecShowActionSheetWithOptionsOptions {
      ...
      folly::Optional<ABI45_0_0facebook::ABI45_0_0React::LazyVector<NSString *>> options() const;
      folly::Optional<ABI45_0_0facebook::ABI45_0_0React::LazyVector<double>> destructiveButtonIndices() const;
      ...
      folly::Optional<ABI45_0_0facebook::ABI45_0_0React::LazyVector<double>> disabledButtonIndices() const;
...
namespace JS {
  namespace NativeActionSheetManager {
    struct SpecShowShareActionSheetWithOptionsOptions {
      ...
      folly::Optional<double> tintColor() const;
      folly::Optional<double> cancelButtonTintColor() const;
      folly::Optional<ABI45_0_0facebook::ABI45_0_0React::LazyVector<NSString *>> excludedActivityTypes() const;
      NSString *userInterfaceStyle() const;
...
namespace JS {
  namespace NativeAlertManager {
    struct Args {
      NSString *title() const;
      NSString *message() const;
      folly::Optional<ABI45_0_0facebook::ABI45_0_0React::LazyVector<id<NSObject> >> buttons() const;
      NSString *type() const;
...
saveValueCallback:(ABI45_0_0RCTResponseSenderBlock)saveValueCallback;
...
- (void)startAnimatingNode:(double)animationId
                   nodeTag:(double)nodeTag
                    config:(NSDictionary *)config
               endCallback:(ABI45_0_0RCTResponseSenderBlock)endCallback;
...
@protocol ABI45_0_0NativeAnimationsDebugModuleSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
namespace JS {
  namespace NativeAppState {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI45_0_0RCTRequired<NSString *> initialAppState;
        };
...
@protocol ABI45_0_0NativeAppStateSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>

- (void)getCurrentAppState:(ABI45_0_0RCTResponseSenderBlock)success
...
@protocol ABI45_0_0NativeAppearanceSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeAsyncLocalStorageSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
- (void)multiRemove:(NSArray *)keys
           callback:(ABI45_0_0RCTResponseSenderBlock)callback;
- (void)clear:(ABI45_0_0RCTResponseSenderBlock)callback;
- (void)getAllKeys:(ABI45_0_0RCTResponseSenderBlock)callback;
...
@protocol ABI45_0_0NativeAsyncSQLiteDBStorageSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
namespace JS {
  namespace NativeBlobModule {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI45_0_0RCTRequired<NSString *> BLOB_URI_SCHEME;
          ABI45_0_0RCTRequired<NSString *> BLOB_URI_HOST;
        };
...
@protocol ABI45_0_0NativeBlobModuleSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeBugReportingSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeClipboardSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>

- (void)getString:(ABI45_0_0RCTPromiseResolveBlock)resolve
...
@protocol ABI45_0_0NativeDevLoadingViewSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeDevMenuSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeDevSettingsSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeDevSplitBundleLoaderSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeDeviceEventManagerSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
    ...
    struct DisplayMetrics {
      ...
      struct Builder {
        struct Input {
          ...
          ABI45_0_0RCTRequired<double> scale;
          ABI45_0_0RCTRequired<double> fontScale;
        };
    ...
    struct DisplayMetricsAndroid {
      ...
      struct Builder {
        struct Input {
          ...
          ABI45_0_0RCTRequired<double> scale;
          ABI45_0_0RCTRequired<double> fontScale;
          ABI45_0_0RCTRequired<double> densityDpi;
        };
...
@protocol ABI45_0_0NativeFileReaderModuleSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeHeadlessJsTaskSupportSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
namespace JS {
  namespace NativeI18nManager {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI45_0_0RCTRequired<bool> isRTL;
          ABI45_0_0RCTRequired<bool> doLeftAndRightSwapInRTL;
          ABI45_0_0RCTRequired<NSString *> localeIdentifier;
        };
...
@protocol ABI45_0_0NativeI18nManagerSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeImageLoaderIOSSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeImageStoreIOSSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeJSCHeapCaptureSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeJSCSamplingProfilerSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
namespace JS {
  namespace NativeJSDevSupport {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI45_0_0RCTRequired<double> ERROR_CODE_EXCEPTION;
          ABI45_0_0RCTRequired<double> ERROR_CODE_VIEW_NOT_FOUND;
        };
...
@protocol ABI45_0_0NativeJSDevSupportSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeKeyboardObserverSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeLinkingManagerSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>

- (void)getInitialURL:(ABI45_0_0RCTPromiseResolveBlock)resolve
               reject:(ABI45_0_0RCTPromiseRejectBlock)reject;
...
- (void)openURL:(NSString *)url
        resolve:(ABI45_0_0RCTPromiseResolveBlock)resolve
         reject:(ABI45_0_0RCTPromiseRejectBlock)reject;
- (void)openSettings:(ABI45_0_0RCTPromiseResolveBlock)resolve
              reject:(ABI45_0_0RCTPromiseRejectBlock)reject;
- (void)addListener:(NSString *)eventName;
- (void)removeListeners:(double)count;
...
@protocol ABI45_0_0NativeLogBoxSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeModalManagerSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
namespace JS {
  namespace NativePlatformConstantsIOS {
    struct ConstantsreactNativeVersion {
      ...
      struct Builder {
        struct Input {
          ABI45_0_0RCTRequired<double> major;
          ABI45_0_0RCTRequired<double> minor;
          ABI45_0_0RCTRequired<double> patch;
          ABI45_0_0RCTRequired<folly::Optional<double>> prerelease;
        };
    ...
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ...
          ABI45_0_0RCTRequired<NSString *> interfaceIdiom;
        };
...
- (void)getInitialNotification:(ABI45_0_0RCTPromiseResolveBlock)resolve
                        reject:(ABI45_0_0RCTPromiseRejectBlock)reject;
- (void)getScheduledLocalNotifications:(ABI45_0_0RCTResponseSenderBlock)callback;
- (void)removeAllDeliveredNotifications;
- (void)removeDeliveredNotifications:(NSArray *)identifiers;
- (void)getDeliveredNotifications:(ABI45_0_0RCTResponseSenderBlock)callback;
- (void)getAuthorizationStatus:(ABI45_0_0RCTResponseSenderBlock)callback;
...
@protocol ABI45_0_0NativeRedBoxSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeSegmentFetcherSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
namespace JS {
  namespace NativeSettingsManager {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI45_0_0RCTRequired<id<NSObject> > settings;
        };
...
@protocol ABI45_0_0NativeSettingsManagerSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeSoundManagerSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
namespace JS {
  namespace NativeSourceCode {
    struct Constants {
      ...
      struct Builder {
        struct Input {
          ABI45_0_0RCTRequired<NSString *> scriptURL;
        };
...
@protocol ABI45_0_0NativeStatusBarManagerIOSSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>

- (void)getHeight:(ABI45_0_0RCTResponseSenderBlock)callback;
...
@protocol ABI45_0_0NativeTimingSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
...
@protocol ABI45_0_0NativeVibrationSpec <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTTurboModule>
