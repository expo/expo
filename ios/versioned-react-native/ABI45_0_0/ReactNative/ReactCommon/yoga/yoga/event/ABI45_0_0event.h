...
struct YOGA_EXPORT Event {
  ...
  class Data;
  using Subscriber = void(const ABI45_0_0YGNode&, Type, Data);
  ...
  template <Type E>
  static void publish(const ABI45_0_0YGNode& node, const TypedData<E>& eventData = {}) {
#ifdef ABI45_0_0YG_ENABLE_EVENTS
...
private:
  static void publish(const ABI45_0_0YGNode&, Type, const Data&);
};
