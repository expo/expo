...
using ABI45_0_0YGVector = std::vector<ABI45_0_0YGNodeRef>;

ABI45_0_0YG_EXTERN_C_BEGIN

void ABI45_0_0YGNodeCalculateLayoutWithContext(
...
extern const std::array<ABI45_0_0YGEdge, 4> trailing;
extern const std::array<ABI45_0_0YGEdge, 4> leading;
extern const ABI45_0_0YGValue ABI45_0_0YGValueUndefined;
extern const ABI45_0_0YGValue ABI45_0_0YGValueAuto;
extern const ABI45_0_0YGValue ABI45_0_0YGValueZero;

struct ABI45_0_0YGCachedMeasurement {
  float availableWidth;
  float availableHeight;
  ...
  bool operator==(ABI45_0_0YGCachedMeasurement measurement) const {
...
#define ABI45_0_0YG_MAX_CACHED_RESULT_COUNT 8
...
public:
  Values() = default;
  explicit Values(const ABI45_0_0YGValue& defaultValue) noexcept {
  ...
  template <size_t I>
  ABI45_0_0YGValue get() const noexcept {
    return std::get<I>(values_);
  }

  template <size_t I>
  void set(ABI45_0_0YGValue& value) noexcept {
...
extern bool ABI45_0_0YGFloatsEqual(const float a, const float b);
