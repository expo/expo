...
#include <ABI45_0_0ReactCommon/ABI45_0_0TurboModulePerfLogger.h>
#include <ABI45_0_0jsi/ABI45_0_0JSIDynamic.h>
#include <ABI45_0_0React/ABI45_0_0debug/ABI45_0_0React_native_assert.h>
#include <ABI45_0_0React/ABI45_0_0jni/NativeMap.h>
#include <ABI45_0_0React/ABI45_0_0jni/ReadableNativeMap.h>
#include <ABI45_0_0React/ABI45_0_0jni/WritableNativeMap.h>

#include "ABI45_0_0JavaTurboModule.h"

namespace TMPL = ABI45_0_0facebook::ABI45_0_0React::TurboModulePerfLogger;
...
jni::local_ref<JCxxCallbackImpl::JavaPart> createJavaCallbackFromJSIFunction(
  ...
  auto weakWrapper = retainJSCallback != nullptr
      ...
      : ABI45_0_0React::CallbackWrapper::createWeak(std::move(function), rt, jsInvoker);
...
std::string stringifyJSIValue(const jsi::Value &v, jsi::Runtime *rt = nullptr) {
  ...
  ABI45_0_0React_native_assert(v.isObject() && "Expecting object.");
...
JNIArgs JavaTurboModule::convertJSIArgsToJNIArgs(
  ...
  for (unsigned int argIndex = 0; argIndex < count; argIndex += 1) {
    ...
    if (!(type == "Ljava/lang/Double;" || type == "Ljava/lang/Boolean;" ||
          ...
          type == "Lcom/facebook/ABI45_0_0React/bridge/ReadableArray;" ||
          type == "Lcom/facebook/ABI45_0_0React/bridge/Callback;" ||
          type == "Lcom/facebook/ABI45_0_0React/bridge/ReadableMap;")) {
    ...
    if (type == "Lcom/facebook/ABI45_0_0React/bridge/ReadableArray;") {
    ...
    if (type == "Lcom/facebook/ABI45_0_0React/bridge/Callback;") {
    ...
    if (type == "Lcom/facebook/ABI45_0_0React/bridge/ReadableMap;") {
      if (!(arg->isObject())) {
        throw JavaTurboModuleArgumentConversionException(
...
jsi::Value convertFromJMapToValue(JNIEnv *env, jsi::Runtime &rt, jobject arg) {
  ...
  jclass jArguments = env->FindClass("com/facebook/ABI45_0_0React/bridge/Arguments");
  static jmethodID jMakeNativeMap = env->GetStaticMethodID(
      jArguments,
      "makeNativeMap",
      "(Ljava/util/Map;)Lcom/facebook/ABI45_0_0React/bridge/WritableNativeMap;");
  auto constants =
      ...
      jsi::Function promiseConstructorArg = jsi::Function::createFromHostFunction(
          ...
          [this,
           ...
           retainJSCallback = retainJSCallback_](
            ...
            jclass jPromiseImpl =
                env->FindClass("com/facebook/ABI45_0_0React/bridge/PromiseImpl");
            jmethodID jPromiseImplConstructor = env->GetMethodID(
                jPromiseImpl,
                "<init>",
                "(Lcom/facebook/ABI45_0_0React/bridge/Callback;Lcom/facebook/ABI45_0_0React/bridge/Callback;)V");
