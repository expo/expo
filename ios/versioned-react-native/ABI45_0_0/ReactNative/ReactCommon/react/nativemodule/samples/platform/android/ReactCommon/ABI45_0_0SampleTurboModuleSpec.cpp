...
#include <ABI45_0_0ReactCommon/ABI45_0_0SampleTurboModuleSpec.h>

namespace ABI45_0_0facebook {
namespace ABI45_0_0React {

static ABI45_0_0facebook::jsi::Value
...
__hostFunction_NativeSampleTurboModuleSpecJSI_getArray(
  ...
  return static_cast<JavaTurboModule &>(turboModule)
      .invokeJavaMethod(
          ...
          ArrayKind,
          "getArray",
          "(Lcom/facebook/ABI45_0_0React/bridge/ReadableArray;)Lcom/facebook/ABI45_0_0React/bridge/WritableArray;",
          args,
          count);
}
...
__hostFunction_NativeSampleTurboModuleSpecJSI_getObject(
  ...
  return static_cast<JavaTurboModule &>(turboModule)
      .invokeJavaMethod(
          ...
          ObjectKind,
          "getObject",
          "(Lcom/facebook/ABI45_0_0React/bridge/ReadableMap;)Lcom/facebook/ABI45_0_0React/bridge/WritableMap;",
          args,
          count);
}
...
__hostFunction_NativeSampleTurboModuleSpecJSI_getValue(
  ...
  return static_cast<JavaTurboModule &>(turboModule)
      .invokeJavaMethod(
          ...
          ObjectKind,
          "getValue",
          "(DLjava/lang/String;Lcom/facebook/ABI45_0_0React/bridge/ReadableMap;)Lcom/facebook/ABI45_0_0React/bridge/WritableMap;",
          args,
          count);
}
...
__hostFunction_NativeSampleTurboModuleSpecJSI_getValueWithCallback(
  ...
  return static_cast<JavaTurboModule &>(turboModule)
      .invokeJavaMethod(
          ...
          "(Lcom/facebook/ABI45_0_0React/bridge/Callback;)V",
          args,
          count);
}
...
__hostFunction_NativeSampleTurboModuleSpecJSI_getValueWithPromise(
  ...
  return static_cast<JavaTurboModule &>(turboModule)
      .invokeJavaMethod(
          ...
          PromiseKind,
          "getValueWithPromise",
          "(ZLcom/facebook/ABI45_0_0React/bridge/Promise;)V",
          args,
          count);
}
