...
#import <ABI45_0_0React/ABI45_0_0renderer/imagemanager/primitives.h>

using namespace ABI45_0_0facebook::ABI45_0_0React;

inline static UIViewContentMode ABI45_0_0RCTContentModeFromImageResizeMode(ImageResizeMode imageResizeMode)
{
...
inline static NSURLRequest *NSURLRequestFromImageSource(const ImageSource &imageSource)
{
  ...
  if (!url) {
    ABI45_0_0RCTLogError(@"URI parsing error.");
    return nil;
  }
