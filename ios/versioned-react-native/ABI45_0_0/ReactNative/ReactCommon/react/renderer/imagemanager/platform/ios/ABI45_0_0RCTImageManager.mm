...
#import <ABI45_0_0React/ABI45_0_0utils/SharedFunction.h>
...
#import "ABI45_0_0RCTImagePrimitivesConversions.h"

using namespace ABI45_0_0facebook::ABI45_0_0React;

@implementation ABI45_0_0RCTImageManager {
  id<ABI45_0_0RCTImageLoaderWithAttributionProtocol> _imageLoader;
...
- (instancetype)initWithImageLoader:(id<ABI45_0_0RCTImageLoaderWithAttributionProtocol>)imageLoader
{
  if (self = [super init]) {
    ...
    _backgroundSerialQueue =
        dispatch_queue_create("com.facebook.ABI45_0_0React-native.image-manager-queue", DISPATCH_QUEUE_SERIAL);
  }
...
{
  SystraceSection s("ABI45_0_0RCTImageManager::requestImage");
   ...
   * work (such as creating an `NSURLRequest` object and some obscure logic inside `ABI45_0_0RCTImageLoader`) can take a couple
   ...
   *
   * Technically, we don't need to dispatch this to *serial* queue. The interface of `ABI45_0_0RCTImageLoader` promises to be
  ...
  dispatch_async(_backgroundSerialQueue, ^{
    ...
    ABI45_0_0RCTImageURLLoaderRequest *loaderRequest =
    ...
    ABI45_0_0RCTImageLoaderCancellationBlock cancelationBlock = loaderRequest.cancellationBlock;
