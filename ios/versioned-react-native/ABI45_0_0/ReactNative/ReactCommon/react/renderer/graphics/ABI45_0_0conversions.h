...
#include <ABI45_0_0React/ABI45_0_0renderer/graphics/PlatformColorParser.h>
...
inline void fromRawValue(
  ...
  if (value.hasType<int>()) {
    ...
    ABI45_0_0React_native_assert(length == 3 || length == 4);
...
inline void fromRawValue(
  ...
  ABI45_0_0React_native_assert(value.hasType<std::vector<Float>>());
  if (value.hasType<std::vector<Float>>()) {
    auto array = (std::vector<Float>)value;
    ABI45_0_0React_native_assert(array.size() == 2);
    if (array.size() >= 2) {
...
inline void fromRawValue(
  ...
  if (value.hasType<std::vector<Float>>()) {
    auto array = (std::vector<Float>)value;
    ABI45_0_0React_native_assert(array.size() == 4);
    if (array.size() >= 4) {
