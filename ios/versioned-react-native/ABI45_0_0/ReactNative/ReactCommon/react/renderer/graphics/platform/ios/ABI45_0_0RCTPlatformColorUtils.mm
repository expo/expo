...
#import "ABI45_0_0RCTPlatformColorUtils.h"
...
static inline ABI45_0_0facebook::ABI45_0_0React::ColorComponents _ColorComponentsFromUIColor(UIColor *color)
{
  CGFloat rgba[4];
  ABI45_0_0RCTGetRGBAColorComponents(color.CGColor, rgba);
  return {(float)rgba[0], (float)rgba[1], (float)rgba[2], (float)rgba[3]};
}

ABI45_0_0facebook::ABI45_0_0React::ColorComponents ABI45_0_0RCTPlatformColorComponentsFromSemanticItems(std::vector<std::string> &semanticItems)
{
