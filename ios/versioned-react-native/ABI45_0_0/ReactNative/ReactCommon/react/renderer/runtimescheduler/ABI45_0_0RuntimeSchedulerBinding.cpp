...
#include "ABI45_0_0RuntimeSchedulerBinding.h"
#include "ABI45_0_0SchedulerPriority.h"
#include "ABI45_0_0primitives.h"
...
jsi::Value RuntimeSchedulerBinding::get(
  ...
  ABI45_0_0React_native_assert(false && "undefined property");
  return jsi::Value::undefined();
}
