...
#include <ABI45_0_0React/ABI45_0_0renderer/debug/flags.h>
...
template <>
struct hash<ABI45_0_0facebook::ABI45_0_0React::ShadowView> {
  size_t operator()(const ABI45_0_0facebook::ABI45_0_0React::ShadowView &shadowView) const {
