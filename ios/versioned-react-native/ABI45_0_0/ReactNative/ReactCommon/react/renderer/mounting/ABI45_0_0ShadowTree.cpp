...
#include <ABI45_0_0React/ABI45_0_0renderer/mounting/ShadowTreeRevision.h>
...
#include "ABI45_0_0ShadowTreeDelegate.h"
...
CommitStatus ShadowTree::commit(
  ...
  while (true) {
    ...
    ABI45_0_0React_native_assert(attempts < 1024);
  }
}
