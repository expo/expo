...
#include <ABI45_0_0React/ABI45_0_0renderer/mounting/ShadowTreeDelegate.h>
...
TEST(StateReconciliationTest, testStateReconciliation) {
  ...
  ABI45_0_0EXPECT_EQ(state1->getMostRecentState(), state1);
  ...
  ABI45_0_0EXPECT_EQ(state1->getMostRecentState(), state2);
  ABI45_0_0EXPECT_EQ(state2->getMostRecentState(), state2);
  ...
  ABI45_0_0EXPECT_EQ(findDescendantNode(shadowTree, family)->getState(), state3);

  ABI45_0_0EXPECT_EQ(state1->getMostRecentState(), state3);
  ABI45_0_0EXPECT_EQ(state2->getMostRecentState(), state3);
  ABI45_0_0EXPECT_EQ(state3->getMostRecentState(), state3);
