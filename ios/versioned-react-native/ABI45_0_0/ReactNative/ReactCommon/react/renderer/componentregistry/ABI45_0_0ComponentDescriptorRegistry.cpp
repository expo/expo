...
#include "ABI45_0_0ComponentDescriptorRegistry.h"

#include "ABI45_0_0componentNameByABI45_0_0ReactViewName.h"
...
ComponentDescriptor const &ComponentDescriptorRegistry::at(
  ...
  auto unifiedComponentName = componentNameByABI45_0_0ReactViewName(componentName);
...
SharedShadowNode ComponentDescriptorRegistry::createNode(
  ...
  auto unifiedComponentName = componentNameByABI45_0_0ReactViewName(viewName);
