...
#include <ABI45_0_0React/ABI45_0_0renderer/components/view/YogaLayoutableShadowNode.h>
...
#pragma mark - DebugStringConvertible
 ...
 private:
  void initialize() noexcept {
    ...
    if (props.yogaStyle.display() == ABI45_0_0YGDisplayNone) {
    ...
    if (props.yogaStyle.positionType() != ABI45_0_0YGPositionTypeStatic) {
