...
TEST(ParagraphLocalDataTest, testSomething) {
  ...
  ABI45_0_0React_native_assert(result["string"] == fragment.string);
  ...
  ABI45_0_0React_native_assert(textAttribute["opacity"] == text.opacity);
  ABI45_0_0React_native_assert(textAttribute["fontStyle"] == toString(*text.fontStyle));
  ABI45_0_0React_native_assert(
