...
#pragma mark - Mutating Methods
   ...
   */
  void setPositionType(ABI45_0_0YGPositionType positionType) const;
...
#pragma mark - LayoutableShadowNode
 ...
 protected:
   ...
   * all the time.
   */
  mutable ABI45_0_0YGNode yogaNode_;
 ...
 private:
  ...
  static ABI45_0_0YGConfig &initializeYogaConfig(ABI45_0_0YGConfig &config);
  static ABI45_0_0YGNode *yogaNodeCloneCallbackConnector(
      ABI45_0_0YGNode *oldYogaNode,
      ABI45_0_0YGNode *parentYogaNode,
      int childIndex);
  static ABI45_0_0YGSize yogaNodeMeasureCallbackConnector(
...
traitCast<YogaLayoutableShadowNode const &>(ShadowNode const &shadowNode) {
  ...
  ABI45_0_0React_native_assert(castable);
  (void)castable;
