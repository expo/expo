...
#include "ABI45_0_0TextInputShadowNode.h"
...
void TextInputShadowNode::updateStateIfNeeded(
  ...
  auto ABI45_0_0ReactTreeAttributedString = getAttributedString(layoutContext);
  auto const &state = getStateData();

  ABI45_0_0React_native_assert(textLayoutManager_);
  ...
  newState.attributedStringBox = AttributedStringBox{ABI45_0_0ReactTreeAttributedString};
  newState.paragraphAttributes = getConcreteProps().paragraphAttributes;
  newState.ABI45_0_0ReactTreeAttributedString = ABI45_0_0ReactTreeAttributedString;
