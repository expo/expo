...
template <>
struct std::hash<ABI45_0_0facebook::ABI45_0_0React::AttributedStringBox> {
  size_t operator()(
      ABI45_0_0facebook::ABI45_0_0React::AttributedStringBox const &attributedStringBox) const {
    switch (attributedStringBox.getMode()) {
      case ABI45_0_0facebook::ABI45_0_0React::AttributedStringBox::Mode::Value:
        return std::hash<ABI45_0_0facebook::ABI45_0_0React::AttributedString>()(
            attributedStringBox.getValue());
      case ABI45_0_0facebook::ABI45_0_0React::AttributedStringBox::Mode::OpaquePointer:
