...
TEST(AttributedStringBoxTest, testDefaultConstructor) {
  ...
  ABI45_0_0EXPECT_EQ(attributedStringBox.getMode(), AttributedStringBox::Mode::Value);
  ABI45_0_0EXPECT_EQ(attributedStringBox.getValue(), AttributedString{});
}
...
TEST(AttributedStringBoxTest, testOpaquePointerConstructor) {
  ...
  ABI45_0_0EXPECT_EQ(attributedStringBox.getOpaquePointer(), string);
  ABI45_0_0EXPECT_EQ(string.use_count(), 2);
}
...
TEST(AttributedStringBoxTest, testMoveConstructor) {
  {
    ...
    ABI45_0_0EXPECT_EQ(moveToAttributedStringBox.getOpaquePointer(), string);
    ABI45_0_0EXPECT_EQ(string.use_count(), 2);
  }
  {
    auto attributedString = AttributedString{};
    ...
    ABI45_0_0EXPECT_EQ(moveToAttributedStringBox.getValue(), attributedString);
  }
}
...
TEST(AttributedStringBoxTest, testMoveAssignment) {
  {
    ...
    ABI45_0_0EXPECT_EQ(
        ...
        AttributedStringBox::Mode::OpaquePointer);
    ABI45_0_0EXPECT_EQ(movedToAttributedStringBox.getOpaquePointer(), string);
    ABI45_0_0EXPECT_EQ(string.use_count(), 2);
  }
  {
    auto attributedString = AttributedString{};
