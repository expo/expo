...
{
  self_ = wrapManagedObject([ABI45_0_0RCTTextLayoutManager new]);
}
...
{
  ABI45_0_0RCTTextLayoutManager *textLayoutManager = (ABI45_0_0RCTTextLayoutManager *)unwrapManagedObject(self_);
