...
#import "ABI45_0_0RCTFontUtils.h"
...
static ABI45_0_0RCTFontProperties ABI45_0_0RCTDefaultFontProperties()
{
  static ABI45_0_0RCTFontProperties defaultFontProperties;
  ...
  dispatch_once(&onceToken, ^{
    ...
    defaultFontProperties.style = ABI45_0_0RCTFontStyleNormal;
    defaultFontProperties.variant = ABI45_0_0RCTFontVariantDefault;
...
static ABI45_0_0RCTFontProperties ABI45_0_0RCTResolveFontProperties(
    ABI45_0_0RCTFontProperties fontProperties,
    ABI45_0_0RCTFontProperties baseFontProperties)
{
  ...
  fontProperties.style =
      fontProperties.style != ABI45_0_0RCTFontStyleUndefined ? fontProperties.style : baseFontProperties.style;
  fontProperties.variant =
      fontProperties.variant != ABI45_0_0RCTFontVariantUndefined ? fontProperties.variant : baseFontProperties.variant;
  return fontProperties;
}

static UIFontWeight ABI45_0_0RCTGetFontWeight(UIFont *font)
{
  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  return [traits[UIFontWeightTrait] doubleValue];
}

static ABI45_0_0RCTFontStyle ABI45_0_0RCTGetFontStyle(UIFont *font)
{
  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
...
static NSArray *ABI45_0_0RCTFontFeatures(ABI45_0_0RCTFontVariant fontVariant)
{
  // FIXME:
  return @[];
}

static UIFont *ABI45_0_0RCTDefaultFontWithFontProperties(ABI45_0_0RCTFontProperties fontProperties)
{
  ...
  if (!font) {
    ...
    if (fontProperties.variant == ABI45_0_0RCTFontStyleItalic) {
...
{
  ABI45_0_0RCTFontProperties defaultFontProperties = ABI45_0_0RCTDefaultFontProperties();
  fontProperties = ABI45_0_0RCTResolveFontProperties(fontProperties, defaultFontProperties);
  ...
  if ([fontProperties.family isEqualToString:defaultFontProperties.family]) {
    ...
    font = ABI45_0_0RCTDefaultFontWithFontProperties(fontProperties);
  } else {
    ...
    if (fontNames.count == 0) {
      ...
      for (NSString *name in fontNames) {
        ...
        if (ABI45_0_0RCTGetFontStyle(fontMatch) != fontProperties.style) {
          continue;
        }

        CGFloat testWeight = ABI45_0_0RCTGetFontWeight(fontMatch);
  ...
  if (fontProperties.variant != ABI45_0_0RCTFontVariantDefault) {
    NSArray *fontFeatures = ABI45_0_0RCTFontFeatures(fontProperties.variant);
    UIFontDescriptor *fontDescriptor = [font.fontDescriptor
