...
#include <ABI45_0_0React/ABI45_0_0utils/SimpleThreadSafeCache.h>
...
template <>
struct hash<ABI45_0_0facebook::ABI45_0_0React::TextMeasureCacheKey> {
  size_t operator()(ABI45_0_0facebook::ABI45_0_0React::TextMeasureCacheKey const &key) const {
    return folly::hash::hash_combine(
        0,
