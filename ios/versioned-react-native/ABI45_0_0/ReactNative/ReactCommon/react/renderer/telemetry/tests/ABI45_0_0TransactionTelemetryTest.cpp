...
#include <ABI45_0_0React/ABI45_0_0test_utils/MockClock.h>
...
TEST(TransactionTelemetryTest, timepoints) {
  ...
  ABI45_0_0EXPECT_GE(duration, 100);
}
...
TEST(TransactionTelemetryTest, normalUseCase) {
  ...
  ABI45_0_0EXPECT_EQ(commitDuration, 1000);
  ABI45_0_0EXPECT_EQ(layoutDuration, 800);
  ABI45_0_0EXPECT_EQ(mountDuration, 100);

  ABI45_0_0EXPECT_EQ(telemetry.getNumberOfTextMeasurements(), 3);
  ABI45_0_0EXPECT_EQ(
      telemetryDurationToMilliseconds(telemetry.getTextMeasureTime()), 600);
  ABI45_0_0EXPECT_EQ(telemetry.getRevisionNumber(), 42);
}
...
TEST(TransactionTelemetryTest, defaultImplementation) {
  ...
  ABI45_0_0EXPECT_GE(commitDuration, 500);
  ABI45_0_0EXPECT_GE(layoutDuration, 300);
  ABI45_0_0EXPECT_GE(mountDuration, 100);
}
