...
#include <ABI45_0_0React/ABI45_0_0renderer/core/EventHandler.h>
...
inline static SharedEventTarget eventTargetFromValue(
  ...
  ABI45_0_0React_native_assert(!eventTargetValue.isNull());
...
inline static int displayModeToInt(DisplayMode const value) {
  ...
  // Libraries/ABI45_0_0ReactNative/DisplayMode.js
  switch (value) {
