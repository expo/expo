...
#include "ABI45_0_0SurfaceRegistryBinding.h"
#include <ABI45_0_0React/ABI45_0_0renderer/debug/SystraceSection.h>
#include <ABI45_0_0React/ABI45_0_0renderer/uimanager/bindingUtils.h>
...
void SurfaceRegistryBinding::startSurface(
  ...
  if (moduleName != "LogBox" &&
      runtime.global().hasProperty(runtime, "ABI45_0_0RN$SurfaceRegistry")) {
    auto registry =
        runtime.global().getPropertyAsObject(runtime, "ABI45_0_0RN$SurfaceRegistry");
...
void SurfaceRegistryBinding::stopSurface(
  ...
  if (global.hasProperty(runtime, "ABI45_0_0RN$Bridgeless")) {
    if (!global.hasProperty(runtime, "ABI45_0_0RN$stopSurface")) {
      // ABI45_0_0ReactFabric module has not been loaded yet; there's no surface to stop.
      return;
    }
    // Bridgeless mode uses a custom JSI binding instead of callable module.
    global.getPropertyAsFunction(runtime, "ABI45_0_0RN$stopSurface")
        .call(runtime, {jsi::Value{surfaceId}});
  } else {
    callMethodOfModule(
        runtime,
        "ABI45_0_0ReactFabric",
