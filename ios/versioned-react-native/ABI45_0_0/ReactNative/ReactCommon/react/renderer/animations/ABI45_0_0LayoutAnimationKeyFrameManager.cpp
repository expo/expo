...
#include "ABI45_0_0LayoutAnimationKeyFrameManager.h"
...
#include <ABI45_0_0React/ABI45_0_0renderer/animations/conversions.h>
#include <ABI45_0_0React/ABI45_0_0renderer/animations/utils.h>
  ...
  if (!mutations.empty()) {
    ...
    if (currentAnimation.hasValue()) {
      ...
      for (auto const &mutation : mutations) {
        ...
        ABI45_0_0React_native_assert(baselineShadowView.tag > 0);
        ...
        if (!wasInsertedTagRemoved && !isRemoveReinserted && !isReparented &&
          ...
          ShadowView viewStart = ShadowView(
              mutation.type == ShadowViewMutation::Type::Insert
                  ? mutation.newChildShadowView
                  : mutation.oldChildShadowView);
          ABI45_0_0React_native_assert(viewStart.tag > 0);
          ShadowView viewFinal = ShadowView(
              mutation.type == ShadowViewMutation::Type::Update
                  ? mutation.newChildShadowView
                  : viewStart);
          ABI45_0_0React_native_assert(viewFinal.tag > 0);
          ...
          if (mutation.type == ShadowViewMutation::Type::Insert) {
            if (mutationConfig.animationProperty ==
              ...
              ABI45_0_0React_native_assert(props != nullptr);
              if (props != nullptr) {
...
/*            Tag deleteTag = mutation.oldChildShadowView.tag;
            ...
            ABI45_0_0React_native_assert(correspondingRemoveIt != mutations.end());
*/
#endif
#endif
            continue;
            ...
            if (correspondingInsertIt == mutations.end()) {
              ...
              ABI45_0_0React_native_assert(correspondingDeleteIt != mutations.end());
          ...
          for (auto &conflictingKeyFrame : conflictingAnimations) {
            ...
            if (conflictingMutationBaselineShadowView.tag == tag) {
              ...
              ABI45_0_0React_native_assert(keyFrame.viewStart.tag > 0);
...
#endif
          ABI45_0_0React_native_assert(keyFrame.viewStart.tag > 0);
          ABI45_0_0React_native_assert(keyFrame.viewEnd.tag > 0);
          ABI45_0_0React_native_assert(keyFrame.viewPrev.tag > 0);
...
ShadowView LayoutAnimationKeyFrameManager::createInterpolatedShadowView(
  ...
  ABI45_0_0React_native_assert(startingView.tag > 0);
  ABI45_0_0React_native_assert(finalView.tag > 0);
  ...
  ABI45_0_0React_native_assert(mutatedShadowView.tag > 0);

  ABI45_0_0React_native_assert(startingView.props != nullptr);
  ABI45_0_0React_native_assert(finalView.props != nullptr);
  ...
  ABI45_0_0React_native_assert(mutatedShadowView.props != nullptr);
...
void LayoutAnimationKeyFrameManager::queueFinalMutationsForCompletedKeyFrame(
  ...
  if (keyframe.finalMutationsForKeyFrame.size() > 0) {
    ...
    if (interrupted) {
      ...
      ABI45_0_0React_native_assert(generatedMutation.oldChildShadowView.tag > 0);
      ABI45_0_0React_native_assert(generatedMutation.newChildShadowView.tag > 0);
      PrintMutationInstruction(
...
void LayoutAnimationKeyFrameManager::adjustDelayedMutationIndicesForMutation(
  ...
  auto tag = isRemoveMutation ? mutation.oldChildShadowView.tag
                              : mutation.newChildShadowView.tag;
  ABI45_0_0React_native_assert(isRemoveMutation || isInsertMutation);
