...
#include <ABI45_0_0React/ABI45_0_0renderer/runtimescheduler/RuntimeSchedulerBinding.h>
#include <ABI45_0_0React/ABI45_0_0renderer/templateprocessor/UITemplateProcessor.h>
#include <ABI45_0_0React/ABI45_0_0renderer/uimanager/UIManager.h>
#include <ABI45_0_0React/ABI45_0_0renderer/uimanager/UIManagerBinding.h>

#ifdef ABI45_0_0RN_SHADOW_TREE_INTROSPECTION
...
Scheduler::Scheduler(
  ...
  ABI45_0_0ReactNativeConfig_ =
      contextContainer_->at<std::shared_ptr<const ABI45_0_0ReactNativeConfig>>(
...
#ifdef ANDROID
  removeOutstandingSurfacesOnDestruction_ = ABI45_0_0ReactNativeConfig_->getBool(
      "ABI45_0_0React_fabric:remove_outstanding_surfaces_on_destruction_android");
#else
  removeOutstandingSurfacesOnDestruction_ = ABI45_0_0ReactNativeConfig_->getBool(
      "ABI45_0_0React_fabric:remove_outstanding_surfaces_on_destruction_ios");
#endif
}
...
void Scheduler::renderTemplateToSurface(
  ...
  try {
    ...
    LOG(ERROR) << "    >>>> ABI45_0_0EXCEPTION <<<  rendering uiTemplate in "
