...
#include "ABI45_0_0SurfaceHandler.h"
...
#include <ABI45_0_0React/ABI45_0_0renderer/scheduler/Scheduler.h>
...
void SurfaceHandler::stop() const noexcept {
  ...
  ABI45_0_0React_native_assert(shadowTree && "`shadowTree` must not be null.");
