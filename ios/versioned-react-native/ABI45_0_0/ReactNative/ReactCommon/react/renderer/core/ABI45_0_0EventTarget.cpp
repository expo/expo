...
#include "ABI45_0_0EventTarget.h"
...
void EventTarget::retain(jsi::Runtime &runtime) const {
  ...
  // TODO: Replace with mustfix once mustfix is ready in ABI45_0_0React Native.
  // ABI45_0_0React_native_assert(!strongInstanceHandle_.isNull());
  // ABI45_0_0React_native_assert(!strongInstanceHandle_.isUndefined());
}
