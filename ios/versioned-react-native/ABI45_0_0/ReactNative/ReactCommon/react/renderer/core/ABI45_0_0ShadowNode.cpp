...
#include "ABI45_0_0ShadowNode.h"
#include "ABI45_0_0DynamicPropsUtilities.h"
#include "ABI45_0_0ShadowNodeFragment.h"
...
ShadowNode::ShadowNode(
    ...
    :
      ...
      traits_(traits) {
  ABI45_0_0React_native_assert(props_);
  ABI45_0_0React_native_assert(children_);
...
void ShadowNode::replaceChild(
  ...
  ABI45_0_0React_native_assert(false && "Child to replace was not found.");
}
