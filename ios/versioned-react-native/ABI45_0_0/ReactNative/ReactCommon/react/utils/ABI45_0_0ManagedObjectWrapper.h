...
@interface ABI45_0_0RCTInternalGenericWeakWrapper : NSObject
...
{
  ABI45_0_0RCTInternalGenericWeakWrapper *weakWrapper = [ABI45_0_0RCTInternalGenericWeakWrapper new];
...
{
  ABI45_0_0RCTInternalGenericWeakWrapper *weakWrapper = (ABI45_0_0RCTInternalGenericWeakWrapper *)unwrapManagedObject(object);
  ABI45_0_0React_native_assert(weakWrapper && "`ABI45_0_0RCTInternalGenericWeakWrapper` instance must not be `nil`.");
