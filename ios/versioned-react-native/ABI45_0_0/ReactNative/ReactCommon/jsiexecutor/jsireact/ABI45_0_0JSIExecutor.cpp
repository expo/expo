...
#include <ABI45_0_0cxxreact/ABI45_0_0ErrorUtils.h>
#include <ABI45_0_0cxxreact/ABI45_0_0JSBigString.h>
#include <ABI45_0_0cxxreact/ABI45_0_0ModuleRegistry.h>
#include <ABI45_0_0cxxreact/ABI45_0_0ReactMarker.h>
#include <ABI45_0_0cxxreact/ABI45_0_0SystraceSection.h>
#include <folly/Conv.h>
#include <folly/json.h>
#include <glog/logging.h>
#include <ABI45_0_0jsi/ABI45_0_0JSIDynamic.h>
#include <ABI45_0_0jsi/ABI45_0_0instrumentation.h>
#include <ABI45_0_0Reactperflogger/ABI45_0_0BridgeNativeModulePerfLogger.h>
...
void JSIExecutor::initializeRuntime() {
  ...
  bool hasLogger(ABI45_0_0ReactMarker::logTaggedMarker);
  if (hasLogger) {
    ABI45_0_0ReactMarker::logMarker(ABI45_0_0ReactMarker::CREATE_REACT_CONTEXT_STOP);
  }
}
...
void JSIExecutor::loadBundle(
  ...
  if (hasLogger) {
    ABI45_0_0ReactMarker::logTaggedMarker(
        ABI45_0_0ReactMarker::RUN_JS_BUNDLE_START, scriptName.c_str());
  }
  ...
  if (hasLogger) {
    ABI45_0_0ReactMarker::logTaggedMarker(
        ABI45_0_0ReactMarker::RUN_JS_BUNDLE_STOP, scriptName.c_str());
  }
}
        ...
        *runtime_,
        ...
        Function::createFromHostFunction(
            *runtime_,
            ...
            [this](
                __unused Runtime &rt,
                const ABI45_0_0facebook::jsi::Value &,
...
void JSIExecutor::registerBundle(
  ...
  ABI45_0_0ReactMarker::logTaggedMarker(
      ABI45_0_0ReactMarker::REGISTER_JS_SEGMENT_START, tag.c_str());
  if (bundleRegistry_) {
  ...
  ABI45_0_0ReactMarker::logTaggedMarker(
      ABI45_0_0ReactMarker::REGISTER_JS_SEGMENT_STOP, tag.c_str());
}
...
Value JSIExecutor::nativeRequire(const Value *args, size_t count) {
  ...
  return ABI45_0_0facebook::jsi::Value();
}
...
Value JSIExecutor::nativeCallSyncHook(const Value *args, size_t count) {
  ...
  /**
   * Note:
   * In ABI45_0_0RCTNativeModule, folly::none is returned from callSerializableNativeHook
