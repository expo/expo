...
#include "ABI45_0_0SampleCxxModule.h"
...
ABI45_0_0facebook::xplat::module::CxxModule *SampleCxxModule() {
  return new ABI45_0_0facebook::xplat::samples::SampleCxxModule(
      std::make_unique<ABI45_0_0facebook::xplat::samples::Sample>());
}
