...
#import <ABI45_0_0cxxreact/ABI45_0_0JsArgumentHelpers.h>

#import "ABI45_0_0RCTCxxUtils.h"

#import <memory>

using ABI45_0_0facebook::xplat::module::CxxModule;
using namespace ABI45_0_0facebook::ABI45_0_0React;

@implementation ABI45_0_0RCTCxxMethod {
...
- (ABI45_0_0RCTFunctionType)functionType
{
  std::string type(_method->getType());
  if (type == "sync") {
    return ABI45_0_0RCTFunctionTypeSync;
  } else if (type == "async") {
    return ABI45_0_0RCTFunctionTypeNormal;
  } else {
    return ABI45_0_0RCTFunctionTypePromise;
  }
}
...
- (id)invokeWithBridge:(ABI45_0_0RCTBridge *)bridge module:(id)module arguments:(NSArray *)arguments
{
  ...
  } catch (const ABI45_0_0facebook::xplat::JsArgumentException &ex) {
    ABI45_0_0RCTLogError(
