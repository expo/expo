...
#import <ABI45_0_0cxxreact/ABI45_0_0JSBigString.h>
...
class ABI45_0_0RCTObjcExecutor : public JSExecutor {
 public:
  ABI45_0_0RCTObjcExecutor(
  ...
  {
    ABI45_0_0RCTAssert(NO, @"RAM bundles are not supported in ABI45_0_0RCTObjcExecutor");
  }
 ...
 private:
  ...
  ABI45_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI45_0_0RCTObjcExecutorFactory::ABI45_0_0RCTObjcExecutorFactory(id<ABI45_0_0RCTJavaScriptExecutor> jse, ABI45_0_0RCTJavaScriptCompleteBlock errorBlock)
    : m_jse(jse), m_errorBlock(errorBlock)
{
}

std::unique_ptr<JSExecutor> ABI45_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue)
{
  return std::unique_ptr<JSExecutor>(new ABI45_0_0RCTObjcExecutor(m_jse, m_errorBlock, jsQueue, delegate));
}
