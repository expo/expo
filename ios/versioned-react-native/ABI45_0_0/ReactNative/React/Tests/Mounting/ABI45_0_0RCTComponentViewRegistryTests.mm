...
@interface ABI45_0_0RCTComponentViewRegistryTests : XCTestCase
@end

using namespace ABI45_0_0facebook::ABI45_0_0React;

@implementation ABI45_0_0RCTComponentViewRegistryTests {
  ABI45_0_0RCTComponentViewRegistry *_componentViewRegistry;
}
...
- (void)testComponentViewDescriptorWithTag
{
  ...
  auto newViewDescriptor = [_componentViewRegistry
      dequeueComponentViewWithComponentHandle:[ABI45_0_0RCTViewComponentView componentDescriptorProvider].handle
                                          tag:existingTag];
...
- (void)testDequeueAndEnqueue
{
  ...
  XCTAssertThrows(
      ^{
        Tag nonExistingTag = 12;
        [self->_componentViewRegistry
            enqueueComponentViewWithComponentHandle:[ABI45_0_0RCTViewComponentView componentDescriptorProvider].handle
                                                tag:nonExistingTag
