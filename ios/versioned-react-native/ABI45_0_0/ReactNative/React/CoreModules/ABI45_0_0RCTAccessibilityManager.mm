...
#import "ABI45_0_0RCTAccessibilityManager+Internal.h"
...
NSString *const ABI45_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification =
    @"ABI45_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification";

@interface ABI45_0_0RCTAccessibilityManager () <ABI45_0_0NativeAccessibilityManagerSpec>
...
@implementation ABI45_0_0RCTAccessibilityManager
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    self.contentSizeCategory = ABI45_0_0RCTSharedApplication().preferredContentSizeCategory;
...
- (void)invalidateMultiplier
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI45_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification
                                                      object:self];
}
...
- (CGFloat)multiplierForContentSizeCategory:(NSString *)category
{
  ...
  if (m.doubleValue <= 0.0) {
    ABI45_0_0RCTLogError(@"Can't determine multiplier for category %@. Using 1.0.", category);
    m = @1.0;
  }
...
ABI45_0_0RCT_EXPORT_METHOD(setAccessibilityFocus : (double)ABI45_0_0ReactTag)
{
  dispatch_async(dispatch_get_main_queue(), ^{
    UIView *view = [self.viewRegistry_DEPRECATED viewForABI45_0_0ReactTag:@(ABI45_0_0ReactTag)];
    UIAccessibilityPostNotification(UIAccessibilityLayoutChangedNotification, view);
  });
}

ABI45_0_0RCT_EXPORT_METHOD(announceForAccessibility : (NSString *)announcement)
{
...
ABI45_0_0RCT_EXPORT_METHOD(getMultiplier : (ABI45_0_0RCTResponseSenderBlock)callback)
{
  if (callback) {
...
ABI45_0_0RCT_EXPORT_METHOD(getCurrentBoldTextState
                  : (ABI45_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI45_0_0RCTResponseSenderBlock)onError)
{
  onSuccess(@[ @(_isBoldTextEnabled) ]);
}

ABI45_0_0RCT_EXPORT_METHOD(getCurrentGrayscaleState
                  : (ABI45_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI45_0_0RCTResponseSenderBlock)onError)
{
...
ABI45_0_0RCT_EXPORT_METHOD(getCurrentInvertColorsState
                  : (ABI45_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI45_0_0RCTResponseSenderBlock)onError)
{
...
ABI45_0_0RCT_EXPORT_METHOD(getCurrentReduceMotionState
                  : (ABI45_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI45_0_0RCTResponseSenderBlock)onError)
{
...
ABI45_0_0RCT_EXPORT_METHOD(getCurrentReduceTransparencyState
                  : (ABI45_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI45_0_0RCTResponseSenderBlock)onError)
{
...
ABI45_0_0RCT_EXPORT_METHOD(getCurrentVoiceOverState
                  : (ABI45_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI45_0_0RCTResponseSenderBlock)onError)
{
...
{
  return std::make_shared<ABI45_0_0facebook::ABI45_0_0React::NativeAccessibilityManagerSpecJSI>(params);
}

#pragma mark - Internal

void ABI45_0_0RCTAccessibilityManagerSetIsVoiceOverEnabled(
    ABI45_0_0RCTAccessibilityManager *accessibilityManager,
...
@implementation ABI45_0_0RCTBridge (ABI45_0_0RCTAccessibilityManager)

- (ABI45_0_0RCTAccessibilityManager *)accessibilityManager
{
  return [self moduleForClass:[ABI45_0_0RCTAccessibilityManager class]];
}

@end

Class ABI45_0_0RCTAccessibilityManagerCls(void)
{
  return ABI45_0_0RCTAccessibilityManager.class;
}
