...
#import "ABI45_0_0RCTKeyboardObserver.h"
...
static NSDictionary *ABI45_0_0RCTParseKeyboardNotification(NSNotification *notification);

@interface ABI45_0_0RCTKeyboardObserver () <ABI45_0_0NativeKeyboardObserverSpec>
@end

@implementation ABI45_0_0RCTKeyboardObserver
...
#define IMPLEMENT_KEYBOARD_HANDLER(EVENT)                                              \
  ...
  {                                                                                    \
    ...
    [self sendEventWithName:@ #EVENT body:ABI45_0_0RCTParseKeyboardNotification(notification)]; \
  }
...
{
  return std::make_shared<ABI45_0_0facebook::ABI45_0_0React::NativeKeyboardObserverSpecJSI>(params);
}

@end

NS_INLINE NSDictionary *ABI45_0_0RCTRectDictionaryValue(CGRect rect)
{
  return @{
...
static NSString *ABI45_0_0RCTAnimationNameForCurve(UIViewAnimationCurve curve)
{
  switch (curve) {
...
static NSDictionary *ABI45_0_0RCTParseKeyboardNotification(NSNotification *notification)
{
  ...
  return @{
    @"startCoordinates" : ABI45_0_0RCTRectDictionaryValue(beginFrame),
    @"endCoordinates" : ABI45_0_0RCTRectDictionaryValue(endFrame),
    @"duration" : @(duration * 1000.0), // ms
    @"easing" : ABI45_0_0RCTAnimationNameForCurve(curve),
    @"isEventFromThisApp" : isLocalUserInfoKey == 1 ? @YES : @NO,
  };
}

Class ABI45_0_0RCTKeyboardObserverCls(void)
{
  return ABI45_0_0RCTKeyboardObserver.class;
}
