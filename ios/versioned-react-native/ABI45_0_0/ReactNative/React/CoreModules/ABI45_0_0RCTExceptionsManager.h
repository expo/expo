...
@protocol ABI45_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI45_0_0RCTExceptionsManager : NSObject <ABI45_0_0RCTBridgeModule>
...
@property (nonatomic, weak) id<ABI45_0_0RCTExceptionsManagerDelegate> delegate;
