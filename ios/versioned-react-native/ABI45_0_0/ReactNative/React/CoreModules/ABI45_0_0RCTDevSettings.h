...
/**
 * An abstraction for a key-value store to manage ABI45_0_0RCTDevSettings behavior.
 * The default implementation persists settings using NSUserDefaults.
 */
@protocol ABI45_0_0RCTDevSettingsDataSource <NSObject>
...
@protocol ABI45_0_0RCTDevSettingsInspectable <NSObject>
...
@interface ABI45_0_0RCTDevSettings : ABI45_0_0RCTEventEmitter <ABI45_0_0RCTInitializing>
...
/*
 * Whether shaking will show ABI45_0_0RCTDevMenu. The menu is enabled by default if ABI45_0_0RCT_DEV=1, but
...
- (void)addHandler:(id<ABI45_0_0RCTPackagerClientMethod>)handler
    forPackagerMethod:(NSString *)name __deprecated_msg("Use ABI45_0_0RCTPackagerConnection directly instead");
#endif

@end

@interface ABI45_0_0RCTBridge (ABI45_0_0RCTDevSettings)

@property (nonatomic, readonly) ABI45_0_0RCTDevSettings *devSettings;
...
// (i.e. ABI45_0_0RCT_DEV or ABI45_0_0RCT_DEV_MENU is set)
ABI45_0_0RCT_EXTERN void ABI45_0_0RCTDevSettingsSetEnabled(BOOL enabled);
