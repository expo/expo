...
ABI45_0_0RCT_EXTERN NSString *const ABI45_0_0RCTBundleURLProviderUpdatedNotification;
ABI45_0_0RCT_EXTERN const NSUInteger kABI45_0_0RCTBundleURLProviderDefaultPort;
 ...
 * by calling this function before initializing ABI45_0_0React Native (ABI45_0_0RCTBridge etc).
 * By default the access is enabled.
 */
ABI45_0_0RCT_EXTERN void ABI45_0_0RCTBundleURLProviderAllowPackagerServerAccess(BOOL allowed);
#endif

@interface ABI45_0_0RCTBundleURLProvider : NSObject
 ...
 * The port is optional, if not specified, kABI45_0_0RCTBundleURLProviderDefaultPort will be used
 */
