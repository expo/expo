 ...
 */
@interface ABI45_0_0RCTImageSource : NSObject
...
@interface ABI45_0_0RCTConvert (ImageSource)

+ (ABI45_0_0RCTImageSource *)ABI45_0_0RCTImageSource:(id)json;
+ (NSArray<ABI45_0_0RCTImageSource *> *)ABI45_0_0RCTImageSourceArray:(id)json;
