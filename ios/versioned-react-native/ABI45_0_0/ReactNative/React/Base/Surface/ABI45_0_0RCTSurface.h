...
@protocol ABI45_0_0RCTSurfaceDelegate;
 ...
 */
@interface ABI45_0_0RCTSurface : NSObject <ABI45_0_0RCTSurfaceProtocol>
 ...
 *  - Calling on the main queue with `ABI45_0_0RCTSurfaceStageSurfaceDidInitialMounting`
 *    stage temporary is not supported; in this case the stage will be
 *    downgraded to `ABI45_0_0RCTSurfaceStageSurfaceDidInitialLayout`.
 */
...
/**
 * Mount the ABI45_0_0React component specified by the given moduleName. This is typically
...
/**
 * Unmount the ABI45_0_0React component specified by the given rootViewTag, called from native.
 */
