 ...
 */
ABI45_0_0RCT_EXTERN const NSInteger ABI45_0_0RCTTextUpdateLagWarningThreshold;
 ...
 */
ABI45_0_0RCT_EXTERN NSString *ABI45_0_0RCTNormalizeInputEventName(NSString *eventName);

typedef NS_ENUM(NSInteger, ABI45_0_0RCTTextEventType) {
  ABI45_0_0RCTTextEventTypeFocus,
  ABI45_0_0RCTTextEventTypeBlur,
  ABI45_0_0RCTTextEventTypeChange,
  ABI45_0_0RCTTextEventTypeSubmit,
  ABI45_0_0RCTTextEventTypeEnd,
  ABI45_0_0RCTTextEventTypeKeyPress
};

@protocol ABI45_0_0RCTEvent <NSObject>
@required
...
/**
 * This protocol allows observing events dispatched by ABI45_0_0RCTEventDispatcher.
 */
@protocol ABI45_0_0RCTEventDispatcherObserver <NSObject>
...
@protocol ABI45_0_0RCTJSDispatcherModule
 ...
 */
@protocol ABI45_0_0RCTEventDispatcherProtocol <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTJSDispatcherModule>
 ...
 */
- (void)sendAppEventWithName:(NSString *)name body:(id)body __deprecated_msg("Subclass ABI45_0_0RCTEventEmitter instead");

/**
 * Deprecated, do not use.
 */
- (void)sendDeviceEventWithName:(NSString *)name body:(id)body __deprecated_msg("Subclass ABI45_0_0RCTEventEmitter instead");
...
@interface ABI45_0_0RCTBridge (ABI45_0_0RCTEventDispatcher)
