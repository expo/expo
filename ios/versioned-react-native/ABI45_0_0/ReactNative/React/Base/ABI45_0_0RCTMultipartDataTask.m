...
#import "ABI45_0_0RCTMultipartDataTask.h"

@interface ABI45_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>

@end

@implementation ABI45_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI45_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI45_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI45_0_0RCTMultipartStreamReader *reader = [[ABI45_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream
                                                                                  boundary:_boundary];
  ABI45_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
