...
@protocol ABI45_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI45_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI45_0_0RCTBridgeModules automatically, however
 ...
 * previously called ABI45_0_0facebook::ABI45_0_0React::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI45_0_0RCTBridge *)bridge;
 ...
 */
- (BOOL)bridge:(ABI45_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI45_0_0RCTBridge *)bridge
                 onProgress:(ABI45_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI45_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Similar to loadSourceForBridge:onProgress:onComplete: but without progress
 * reporting.
 */
- (void)loadSourceForBridge:(ABI45_0_0RCTBridge *)bridge withBlock:(ABI45_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Retrieve the list of lazy-native-modules names for the given bridge.
 */
- (NSDictionary<NSString *, Class> *)extraLazyModuleClassesForBridge:(ABI45_0_0RCTBridge *)bridge;
