 ...
 * are also bridge modules, so should be registered using ABI45_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI45_0_0RCTURLRequestHandler <ABI45_0_0RCTBridgeModule>
...
/**
 * If more than one ABI45_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
