...
{
  NSNumber *port = @8081;
  NSString *portStr = [[[NSProcessInfo processInfo] environment] objectForKey:@"ABI45_0_0RCT_METRO_PORT"];
...
@implementation ABI45_0_0RCTInspectorDevServerHelper

ABI45_0_0RCT_NOT_IMPLEMENTED(-(instancetype)init)

static NSMutableDictionary<NSString *, ABI45_0_0RCTInspectorPackagerConnection *> *socketConnections = nil;
...
+ (ABI45_0_0RCTInspectorPackagerConnection *)connectWithBundleURL:(NSURL *)bundleURL
{
  ...
  ABI45_0_0RCTInspectorPackagerConnection *connection = socketConnections[key];
  if (!connection || !connection.isConnected) {
    connection = [[ABI45_0_0RCTInspectorPackagerConnection alloc] initWithURL:inspectorURL];
