...
static const CGFloat ABI45_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI45_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return ABS(borderInsets.left - borderInsets.right) < ABI45_0_0RCTViewBorderThreshold &&
      ABS(borderInsets.left - borderInsets.bottom) < ABI45_0_0RCTViewBorderThreshold &&
      ABS(borderInsets.left - borderInsets.top) < ABI45_0_0RCTViewBorderThreshold;
}

BOOL ABI45_0_0RCTCornerRadiiAreEqual(ABI45_0_0RCTCornerRadii cornerRadii)
{
  return ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI45_0_0RCTViewBorderThreshold &&
      ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI45_0_0RCTViewBorderThreshold &&
      ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI45_0_0RCTViewBorderThreshold;
}

BOOL ABI45_0_0RCTBorderColorsAreEqual(ABI45_0_0RCTBorderColors borderColors)
{
...
ABI45_0_0RCTCornerInsets ABI45_0_0RCTGetCornerInsets(ABI45_0_0RCTCornerRadii cornerRadii, UIEdgeInsets edgeInsets)
{
  return (ABI45_0_0RCTCornerInsets){
      {
...
static UIEdgeInsets ABI45_0_0RCTRoundInsetsToPixel(UIEdgeInsets edgeInsets)
{
  edgeInsets.top = ABI45_0_0RCTRoundPixelValue(edgeInsets.top);
  edgeInsets.bottom = ABI45_0_0RCTRoundPixelValue(edgeInsets.bottom);
  edgeInsets.left = ABI45_0_0RCTRoundPixelValue(edgeInsets.left);
  edgeInsets.right = ABI45_0_0RCTRoundPixelValue(edgeInsets.right);

  return edgeInsets;
}

static void ABI45_0_0RCTPathAddEllipticArc(
...
CGPathRef ABI45_0_0RCTPathCreateWithRoundedRect(CGRect bounds, ABI45_0_0RCTCornerInsets cornerInsets, const CGAffineTransform *transform)
{
  ...
  ABI45_0_0RCTPathAddEllipticArc(
...
static void
ABI45_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds, CGPoint lineStart, CGPoint lineEnd, CGPoint intersections[2])
{
...
NS_INLINE BOOL ABI45_0_0RCTCornerRadiiAreAboveThreshold(ABI45_0_0RCTCornerRadii cornerRadii)
{
  return (
      cornerRadii.topLeft > ABI45_0_0RCTViewBorderThreshold || cornerRadii.topRight > ABI45_0_0RCTViewBorderThreshold ||
      cornerRadii.bottomLeft > ABI45_0_0RCTViewBorderThreshold || cornerRadii.bottomRight > ABI45_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI45_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI45_0_0RCTCornerRadii cornerRadii)
{
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI45_0_0RCTPathCreateWithRoundedRect(rect, ABI45_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef
ABI45_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge)
{
...
static UIImage *ABI45_0_0RCTGetSolidBorderImage(
    ...
    BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI45_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI45_0_0RCTCornerInsets cornerInsets = ABI45_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  borderInsets = ABI45_0_0RCTRoundInsetsToPixel(borderInsets);
  ...
  CGContextRef ctx = ABI45_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI45_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI45_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI45_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI45_0_0RCTEllipseGetIntersectionsWithLine(
...
static UIImage *ABI45_0_0RCTGetDashedOrDottedBorderImage(
    ...
    BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI45_0_0RCTBorderStyleDashed || borderStyle == ABI45_0_0RCTBorderStyleDotted);

  if (!ABI45_0_0RCTBorderColorsAreEqual(borderColors) || !ABI45_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI45_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI45_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI45_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI45_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI45_0_0RCTPathCreateWithRoundedRect(pathRect, ABI45_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI45_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
...
UIImage *ABI45_0_0RCTGetBorderImage(
    ABI45_0_0RCTBorderStyle borderStyle,
    CGSize viewSize,
    ABI45_0_0RCTCornerRadii cornerRadii,
    UIEdgeInsets borderInsets,
...
{
  switch (borderStyle) {
    case ABI45_0_0RCTBorderStyleSolid:
      return ABI45_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI45_0_0RCTBorderStyleDashed:
    case ABI45_0_0RCTBorderStyleDotted:
      return ABI45_0_0RCTGetDashedOrDottedBorderImage(
          borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI45_0_0RCTBorderStyleUnset:
      break;
  }
