...
typedef UIFont * (^ABI45_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ABI45_0_0React Native will use the System font for rendering by default. If you want to
 ...
 */
ABI45_0_0RCT_EXTERN void ABI45_0_0RCTSetDefaultFontHandler(ABI45_0_0RCTFontHandler handler);
ABI45_0_0RCT_EXTERN BOOL ABI45_0_0RCTHasFontHandlerSet(void);

@interface ABI45_0_0RCTFont : NSObject
...
@interface ABI45_0_0RCTConvert (ABI45_0_0RCTFont)
