...
@implementation ABI45_0_0RCTScrollEvent {
...
- (ABI45_0_0RCTScrollEvent *)coalesceWithEvent:(ABI45_0_0RCTScrollEvent *)newEvent
{
...
- (NSArray *)arguments
{
  return @[ self.viewTag, ABI45_0_0RCTNormalizeInputEventName(self.eventName), [self body] ];
}
