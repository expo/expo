...
#import "ABI45_0_0RCTWrapperViewController.h"
...
@implementation ABI45_0_0RCTWrapperViewController {
  UIView *_wrapperView;
  UIView *_contentView;
...
{
  ABI45_0_0RCTAssertParam(contentView);
...
ABI45_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithNibName : (NSString *)nn bundle : (NSBundle *)nb)
...
static BOOL ABI45_0_0RCTFindScrollViewAndRefreshContentInsetInView(UIView *view)
{
  if ([view conformsToProtocol:@protocol(ABI45_0_0RCTAutoInsetsProtocol)]) {
    [(id<ABI45_0_0RCTAutoInsetsProtocol>)view refreshContentInset];
    return YES;
  }
  for (UIView *subview in view.subviews) {
    if (ABI45_0_0RCTFindScrollViewAndRefreshContentInsetInView(subview)) {
      return YES;
    }
  }
  return NO;
...
- (void)viewDidLayoutSubviews
{
  ...
  if (_previousTopLayoutLength != _currentTopLayoutGuide.length ||
    ...
    ABI45_0_0RCTFindScrollViewAndRefreshContentInsetInView(_contentView);
...
- (void)loadView
{
  ...
  //`contentView` which is a ABI45_0_0React-managed view.
