...
@implementation ABI45_0_0RCTModalHostViewController {
...
- (instancetype)init
{
  ...
  _preferredStatusBarStyle = [ABI45_0_0RCTSharedApplication() statusBarStyle];
  _preferredStatusBarHidden = [ABI45_0_0RCTSharedApplication() isStatusBarHidden];
