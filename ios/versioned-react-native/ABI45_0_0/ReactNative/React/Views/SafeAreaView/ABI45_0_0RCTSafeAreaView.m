...
@implementation ABI45_0_0RCTSafeAreaView {
...
{
  UIViewController *vc = self.ABI45_0_0ReactViewController;
...
{
  if (UIEdgeInsetsEqualToEdgeInsetsWithThreshold(safeAreaInsets, _currentSafeAreaInsets, 1.0 / ABI45_0_0RCTScreenScale())) {
    return;
  }

  _currentSafeAreaInsets = safeAreaInsets;

  ABI45_0_0RCTSafeAreaViewLocalData *localData = [[ABI45_0_0RCTSafeAreaViewLocalData alloc] initWithInsets:safeAreaInsets];
