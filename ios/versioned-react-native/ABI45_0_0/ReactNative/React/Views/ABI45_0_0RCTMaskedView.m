...
@implementation ABI45_0_0RCTMaskedView

- (void)didUpdateABI45_0_0ReactSubviews
{
  // ABI45_0_0RCTMaskedView expects that the first subview rendered is the mask.
...
- (void)displayLayer:(__unused CALayer *)layer
{
  ...
  // We don't need to do that in ABI45_0_0RCTMaskedView, so we
