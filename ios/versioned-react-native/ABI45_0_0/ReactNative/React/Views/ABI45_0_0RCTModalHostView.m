...
@implementation ABI45_0_0RCTModalHostView {
  __weak ABI45_0_0RCTBridge *_bridge;
  BOOL _isPresented;
  ABI45_0_0RCTModalHostViewController *_modalViewController;
  ABI45_0_0RCTTouchHandler *_touchHandler;
  UIView *_ABI45_0_0ReactSubview;
  UIInterfaceOrientation _lastKnownOrientation;
  ABI45_0_0RCTDirectEventBlock _onRequestClose;
}

ABI45_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithFrame : (CGRect)frame)
ABI45_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithCoder : coder)

- (instancetype)initWithBridge:(ABI45_0_0RCTBridge *)bridge
{
  if ((self = [super initWithFrame:CGRectZero])) {
    _bridge = bridge;
    _modalViewController = [ABI45_0_0RCTModalHostViewController new];
    UIView *containerView = [UIView new];
    containerView.autoresizingMask = UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
    _modalViewController.view = containerView;
    _touchHandler = [[ABI45_0_0RCTTouchHandler alloc] initWithBridge:bridge];
    _isPresented = NO;
...
{
  if (_ABI45_0_0ReactSubview && _isPresented) {
    [_bridge.uiManager setSize:newBounds.size forView:_ABI45_0_0ReactSubview];
    [self notifyForOrientationChange];
  }
}

- (void)setOnRequestClose:(ABI45_0_0RCTDirectEventBlock)onRequestClose
{
...
- (void)notifyForOrientationChange
{
  ...
  UIInterfaceOrientation currentOrientation = [ABI45_0_0RCTSharedApplication() statusBarOrientation];
...
{
  ABI45_0_0RCTAssert(_ABI45_0_0ReactSubview == nil, @"Modal view can only have one subview");
  [super insertABI45_0_0ReactSubview:subview atIndex:atIndex];
  [_touchHandler attachToView:subview];

  [_modalViewController.view insertSubview:subview atIndex:0];
  _ABI45_0_0ReactSubview = subview;
}

- (void)removeABI45_0_0ReactSubview:(UIView *)subview
{
  ABI45_0_0RCTAssert(subview == _ABI45_0_0ReactSubview, @"Cannot remove view other than modal view");
  // Superclass (category) removes the `subview` from actual `superview`.
  [super removeABI45_0_0ReactSubview:subview];
  [_touchHandler detachFromView:subview];
  _ABI45_0_0ReactSubview = nil;
}

- (void)didUpdateABI45_0_0ReactSubviews
{
  // Do nothing, as subview (singular) is managed by `insertABI45_0_0ReactSubview:atIndex:`
}
...
- (void)didMoveToWindow
{
  ...
  if (!self.userInteractionEnabled && ![self.superview.ABI45_0_0ReactSubviews containsObject:self]) {
    return;
  }
...
- (void)ensurePresentedOnlyIfNeeded
{
  ...
  if (shouldBePresented) {
    ABI45_0_0RCTAssert(self.ABI45_0_0ReactViewController, @"Can't present modal view controller without a presenting view controller");
