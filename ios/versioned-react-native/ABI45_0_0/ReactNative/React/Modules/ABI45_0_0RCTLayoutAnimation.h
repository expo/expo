...
@interface ABI45_0_0RCTLayoutAnimation : NSObject
...
@property (nonatomic, readonly) ABI45_0_0RCTAnimationType animationType;
...
- (instancetype)initWithDuration:(NSTimeInterval)duration
                 ...
                 initialVelocity:(CGFloat)initialVelocity
                   animationType:(ABI45_0_0RCTAnimationType)animationType;
