...
#import "ABI45_0_0RCTRedBoxExtraDataViewController.h"

@interface ABI45_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI45_0_0RCTRedBoxExtraDataCell
...
@interface ABI45_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI45_0_0RCTRedBoxExtraDataViewController {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  ABI45_0_0RCTRedBoxExtraDataCell *cell =
      (ABI45_0_0RCTRedBoxExtraDataCell *)[tableView dequeueReusableCellWithIdentifier:reuseIdentifier];

  if (cell == nil) {
    cell = [[ABI45_0_0RCTRedBoxExtraDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
  }
