...
typedef dispatch_block_t ABI45_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI45_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ABI45_0_0React-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI45_0_0RCTUIManager's observers.
 */
@interface ABI45_0_0RCTUIManagerObserverCoordinator : NSObject <ABI45_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI45_0_0RCTUIManagerObserver` protocol for more info.
