...
@class ABI45_0_0RCTSurfaceView;
@class ABI45_0_0RCTSurfacePresenter;

/**
 * (This is Fabric-compatible ABI45_0_0RCTSurface implementation.)
 *
 * ABI45_0_0RCTSurface instance represents ABI45_0_0React Native-powered piece of a user interface
 * which can be a full-screen app, separate modal view controller,
 * or even small widget.
 * It is called "Surface".
 *
 * The ABI45_0_0RCTSurface instance is completely thread-safe by design;
 ...
 *
 * The primary goals of the ABI45_0_0RCTSurface are:
 ...
 */
@interface ABI45_0_0RCTFabricSurface : NSObject <ABI45_0_0RCTSurfaceProtocol>
 ...
 * ABI45_0_0RCTSurface does not control (or influence in any way) the size or origin
...
/**
 * Simple shortcut to `-[ABI45_0_0RCTSurface setMinimumSize:size maximumSize:size]`.
 */
...
@interface ABI45_0_0RCTFabricSurface (Internal)

- (ABI45_0_0facebook::ABI45_0_0React::SurfaceHandler const &)surfaceHandler;

@end

@interface ABI45_0_0RCTFabricSurface (Deprecated)
