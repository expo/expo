...
#import <ABI45_0_0React/ABI45_0_0renderer/componentregistry/ComponentDescriptorProvider.h>
#import <ABI45_0_0React/ABI45_0_0renderer/core/EventEmitter.h>
#import <ABI45_0_0React/ABI45_0_0renderer/core/LayoutMetrics.h>
#import <ABI45_0_0React/ABI45_0_0renderer/core/Props.h>
#import <ABI45_0_0React/ABI45_0_0renderer/core/State.h>
 ...
 */
typedef NS_OPTIONS(NSInteger, ABI45_0_0RNComponentViewUpdateMask) {
  ABI45_0_0RNComponentViewUpdateMaskNone = 0,
  ABI45_0_0RNComponentViewUpdateMaskProps = 1 << 0,
  ABI45_0_0RNComponentViewUpdateMaskEventEmitter = 1 << 1,
  ABI45_0_0RNComponentViewUpdateMaskState = 1 << 3,
  ABI45_0_0RNComponentViewUpdateMaskLayoutMetrics = 1 << 4,

  ABI45_0_0RNComponentViewUpdateMaskAll = ABI45_0_0RNComponentViewUpdateMaskProps | ABI45_0_0RNComponentViewUpdateMaskEventEmitter |
      ABI45_0_0RNComponentViewUpdateMaskState | ABI45_0_0RNComponentViewUpdateMaskLayoutMetrics
};

/*
 * Represents a `UIView` instance managed by ABI45_0_0React.
 * All methods are non-@optional.
 * `UIView+ComponentViewProtocol` category provides default implementation
 * for all of them.
 */
@protocol ABI45_0_0RCTComponentViewProtocol <NSObject>

/*
 * Returns a `ComponentDescriptorProvider` of a particular `ComponentDescriptor` which this component view
 * represents.
 */
+ (ABI45_0_0facebook::ABI45_0_0React::ComponentDescriptorProvider)componentDescriptorProvider;
