...
#import "ABI45_0_0RCTParagraphComponentAccessibilityProvider.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <ABI45_0_0React/ABI45_0_0renderer/components/text/ParagraphComponentDescriptor.h>
#import <ABI45_0_0React/ABI45_0_0renderer/components/text/ParagraphProps.h>
#import <ABI45_0_0React/ABI45_0_0renderer/components/text/ParagraphState.h>
#import <ABI45_0_0React/ABI45_0_0renderer/components/text/RawTextComponentDescriptor.h>
#import <ABI45_0_0React/ABI45_0_0renderer/components/text/TextComponentDescriptor.h>
#import <ABI45_0_0React/ABI45_0_0renderer/graphics/Geometry.h>
#import <ABI45_0_0React/ABI45_0_0renderer/textlayoutmanager/ABI45_0_0RCTAttributedTextUtils.h>
#import <ABI45_0_0React/ABI45_0_0renderer/textlayoutmanager/ABI45_0_0RCTTextLayoutManager.h>
#import <ABI45_0_0React/ABI45_0_0renderer/textlayoutmanager/TextLayoutManager.h>
...
@implementation ABI45_0_0RCTParagraphComponentView {
  ParagraphShadowNode::ConcreteState::Shared _state;
  ParagraphAttributes _paragraphAttributes;
  ABI45_0_0RCTParagraphComponentAccessibilityProvider *_accessibilityProvider;
...
- (NSAttributedString *_Nullable)attributedText
{
  ...
  return ABI45_0_0RCTNSAttributedStringFromAttributedString(_state->getData().attributedString);
}
...
- (void)drawRect:(CGRect)rect
{
  ...
  ABI45_0_0RCTTextLayoutManager *nativeTextLayoutManager =
      (ABI45_0_0RCTTextLayoutManager *)unwrapManagedObject(textLayoutManager->getNativeTextLayoutManager());

  CGRect frame = ABI45_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
  ...
  if (![_accessibilityProvider isUpToDate:data.attributedString]) {
    ...
    if (textLayoutManager) {
      ...
      _accessibilityProvider =
          [[ABI45_0_0RCTParagraphComponentAccessibilityProvider alloc] initWithString:data.attributedString
...
#pragma mark - ABI45_0_0RCTTouchableComponentViewProtocol
...
Class<ABI45_0_0RCTComponentViewProtocol> ABI45_0_0RCTParagraphCls(void)
{
  return ABI45_0_0RCTParagraphComponentView.class;
}
