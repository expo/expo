...
@implementation ABI45_0_0RCTFabricModalHostViewController {
...
{
  return [ABI45_0_0RCTSharedApplication() statusBarStyle];
}
...
{
  return [ABI45_0_0RCTSharedApplication() isStatusBarHidden];
}
...
- (UIInterfaceOrientationMask)supportedInterfaceOrientations
{
  UIInterfaceOrientationMask appSupportedOrientationsMask =
      [ABI45_0_0RCTSharedApplication() supportedInterfaceOrientationsForWindow:[ABI45_0_0RCTSharedApplication() keyWindow]];
