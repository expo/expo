...
#import "ABI45_0_0RCTSliderComponentView.h"
...
#import <ABI45_0_0React/ABI45_0_0renderer/components/slider/SliderComponentDescriptor.h>

#import "ABI45_0_0RCTFabricComponentsPlugins.h"

using namespace ABI45_0_0facebook::ABI45_0_0React;

@interface ABI45_0_0RCTSliderComponentView () <ABI45_0_0RCTImageResponseDelegate>
@end

@implementation ABI45_0_0RCTSliderComponentView {
  ...
  ABI45_0_0RCTImageResponseObserverProxy _trackImageResponseObserverProxy;
  ABI45_0_0RCTImageResponseObserverProxy _minimumTrackImageResponseObserverProxy;
  ABI45_0_0RCTImageResponseObserverProxy _maximumTrackImageResponseObserverProxy;
  ABI45_0_0RCTImageResponseObserverProxy _thumbImageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _trackImageResponseObserverProxy = ABI45_0_0RCTImageResponseObserverProxy(self);
    _minimumTrackImageResponseObserverProxy = ABI45_0_0RCTImageResponseObserverProxy(self);
    _maximumTrackImageResponseObserverProxy = ABI45_0_0RCTImageResponseObserverProxy(self);
    _thumbImageResponseObserverProxy = ABI45_0_0RCTImageResponseObserverProxy(self);
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldSliderProps.thumbTintColor != newSliderProps.thumbTintColor) {
    _sliderView.thumbTintColor = ABI45_0_0RCTUIColorFromSharedColor(newSliderProps.thumbTintColor);
  }

  // `minimumTrackTintColor`
  if (oldSliderProps.minimumTrackTintColor != newSliderProps.minimumTrackTintColor) {
    _sliderView.minimumTrackTintColor = ABI45_0_0RCTUIColorFromSharedColor(newSliderProps.minimumTrackTintColor);
  }

  // `maximumTrackTintColor`
  if (oldSliderProps.maximumTrackTintColor != newSliderProps.maximumTrackTintColor) {
    _sliderView.maximumTrackTintColor = ABI45_0_0RCTUIColorFromSharedColor(newSliderProps.maximumTrackTintColor);
  }
...
Class<ABI45_0_0RCTComponentViewProtocol> ABI45_0_0RCTSliderCls(void)
{
  return ABI45_0_0RCTSliderComponentView.class;
}
