...
@implementation ABI45_0_0RCTLegacyViewManagerInteropCoordinatorAdapter {
  ABI45_0_0RCTLegacyViewManagerInteropCoordinator *_coordinator;
  NSInteger _tag;
}

- (instancetype)initWithCoordinator:(ABI45_0_0RCTLegacyViewManagerInteropCoordinator *)coordinator ABI45_0_0ReactTag:(NSInteger)tag
{
  if (self = [super init]) {
...
{
  [_coordinator handleCommand:commandName args:args ABI45_0_0ReactTag:_tag];
}
