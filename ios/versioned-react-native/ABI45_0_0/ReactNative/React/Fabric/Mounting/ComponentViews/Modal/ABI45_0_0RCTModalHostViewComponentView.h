 ...
 */
@interface ABI45_0_0RCTModalHostViewComponentView : ABI45_0_0RCTViewComponentView <ABI45_0_0RCTMountingTransactionObserving>

/**
 * Subclasses may override this method and present the modal on different view controller.
 * Default implementation presents the modal on `[self ABI45_0_0ReactViewController]`.
 */
