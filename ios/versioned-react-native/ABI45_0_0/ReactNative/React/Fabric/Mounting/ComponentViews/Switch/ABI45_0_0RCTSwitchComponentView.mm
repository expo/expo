...
#import "ABI45_0_0RCTSwitchComponentView.h"

#import <ABI45_0_0React/ABI45_0_0RCTConversions.h>

#import <ABI45_0_0React/ABI45_0_0renderer/components/rncore/ComponentDescriptors.h>
...
#import <ABI45_0_0React/ABI45_0_0renderer/components/rncore/ABI45_0_0RCTComponentViewHelpers.h>

#import "ABI45_0_0RCTFabricComponentsPlugins.h"

using namespace ABI45_0_0facebook::ABI45_0_0React;

@interface ABI45_0_0RCTSwitchComponentView () <ABI45_0_0RCTSwitchViewProtocol>
@end

@implementation ABI45_0_0RCTSwitchComponentView {
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldSwitchProps.tintColor != newSwitchProps.tintColor) {
    _switchView.tintColor = ABI45_0_0RCTUIColorFromSharedColor(newSwitchProps.tintColor);
  }

  // `onTintColor
  if (oldSwitchProps.onTintColor != newSwitchProps.onTintColor) {
    _switchView.onTintColor = ABI45_0_0RCTUIColorFromSharedColor(newSwitchProps.onTintColor);
  }

  // `thumbTintColor`
  if (oldSwitchProps.thumbTintColor != newSwitchProps.thumbTintColor) {
    _switchView.thumbTintColor = ABI45_0_0RCTUIColorFromSharedColor(newSwitchProps.thumbTintColor);
  }
...
{
  ABI45_0_0RCTSwitchHandleCommand(self, commandName, args);
}
...
Class<ABI45_0_0RCTComponentViewProtocol> ABI45_0_0RCTSwitchCls(void)
{
  return ABI45_0_0RCTSwitchComponentView.class;
}
