...
#import "ABI45_0_0RCTModalHostViewComponentView.h"

#import <ABI45_0_0React/ABI45_0_0RCTBridge+Private.h>
#import <ABI45_0_0React/ABI45_0_0RCTModalManager.h>
#import <ABI45_0_0React/ABI45_0_0UIView+React.h>
#import <ABI45_0_0React/ABI45_0_0renderer/components/modal/ModalHostViewComponentDescriptor.h>
#import <ABI45_0_0React/ABI45_0_0renderer/components/modal/ModalHostViewState.h>
#import <ABI45_0_0React/ABI45_0_0renderer/components/rncore/EventEmitters.h>
#import <ABI45_0_0React/ABI45_0_0renderer/components/rncore/Props.h>

#import "ABI45_0_0RCTConversions.h"

#import "ABI45_0_0RCTFabricModalHostViewController.h"
...
@interface ABI45_0_0RCTModalHostViewComponentView () <ABI45_0_0RCTFabricModalHostViewControllerDelegate>

@end

@implementation ABI45_0_0RCTModalHostViewComponentView {
  ABI45_0_0RCTFabricModalHostViewController *_viewController;
...
- (ABI45_0_0RCTFabricModalHostViewController *)viewController
{
  if (!_viewController) {
    _viewController = [ABI45_0_0RCTFabricModalHostViewController new];
...
{
  UIViewController *controller = [self ABI45_0_0ReactViewController];
...
#pragma mark - ABI45_0_0RCTFabricModalHostViewControllerDelegate
...
- (void)boundsDidChange:(CGRect)newBounds
{
  ...
  if (_state != nullptr) {
    auto newState = ModalHostViewState{ABI45_0_0RCTSizeFromCGSize(newBounds.size)};
...
Class<ABI45_0_0RCTComponentViewProtocol> ABI45_0_0RCTModalHostViewCls(void);
...
Class<ABI45_0_0RCTComponentViewProtocol> ABI45_0_0RCTModalHostViewCls(void)
{
  return ABI45_0_0RCTModalHostViewComponentView.class;
}
