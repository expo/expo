...
#import <ABI45_0_0React/ABI45_0_0renderer/components/view/ViewComponentDescriptor.h>
#import <ABI45_0_0React/ABI45_0_0renderer/components/view/ViewEventEmitter.h>
#import <ABI45_0_0React/ABI45_0_0renderer/components/view/ViewProps.h>

using namespace ABI45_0_0facebook::ABI45_0_0React;

@implementation ABI45_0_0RCTViewComponentView {
  UIColor *_backgroundColor;
  CALayer *_borderLayer;
  BOOL _needsInvalidateLayer;
  BOOL _isJSResponder;
  BOOL _removeClippedSubviews;
  NSMutableArray<UIView *> *_ABI45_0_0ReactSubviews;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _props = defaultProps;
    _ABI45_0_0ReactSubviews = [NSMutableArray new];
...
- (void)setContentView:(UIView *)contentView
{
  ...
  if (_contentView) {
    ...
    _contentView.frame = ABI45_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
  }
}
...
{
  ABI45_0_0RCTAssert(
      self == [ABI45_0_0RCTViewComponentView class],
      @"`+[ABI45_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented for all subclasses (and `%@` particularly).",
...
- (void)mountChildComponentView:(UIView<ABI45_0_0RCTComponentViewProtocol> *)childComponentView index:(NSInteger)index
{
  ...
  if (_removeClippedSubviews) {
    [_ABI45_0_0ReactSubviews insertObject:childComponentView atIndex:index];
  } else {
...
{
  if (_removeClippedSubviews) {
    [_ABI45_0_0ReactSubviews removeObjectAtIndex:index];
  } else {
    ABI45_0_0RCTAssert(
...
- (void)updateClippedSubviewsWithClipRect:(CGRect)clipRect relativeToView:(UIView *)clipView
{
  ...
  if (_ABI45_0_0ReactSubviews.count == 0) {
  ...
  // Mount / unmount views
  for (UIView *view in _ABI45_0_0ReactSubviews) {
...
{
  ABI45_0_0RCTAssert(props, @"`props` must not be `null`.");

#ifndef NS_BLOCK_ASSERTIONS
  auto propsRawPtr = _props.get();
  ABI45_0_0RCTAssert(
      propsRawPtr &&
          ([self class] == [ABI45_0_0RCTViewComponentView class] ||
           typeid(*propsRawPtr).hash_code() != typeid(ViewProps const).hash_code()),
      @"`ABI45_0_0RCTViewComponentView` subclasses (and `%@` particularly) must setup `_props`"
  ...
  if (oldViewProps.removeClippedSubviews != newViewProps.removeClippedSubviews) {
    ...
    if (_removeClippedSubviews && self.subviews.count > 0) {
      _ABI45_0_0ReactSubviews = [NSMutableArray arrayWithArray:self.subviews];
    }
  }

  // `backgroundColor`
  if (oldViewProps.backgroundColor != newViewProps.backgroundColor) {
    self.backgroundColor = ABI45_0_0RCTUIColorFromSharedColor(newViewProps.backgroundColor);
    needsInvalidateLayer = YES;
  }

  // `foregroundColor`
  if (oldViewProps.foregroundColor != newViewProps.foregroundColor) {
    self.foregroundColor = ABI45_0_0RCTUIColorFromSharedColor(newViewProps.foregroundColor);
  }

  // `shadowColor`
  if (oldViewProps.shadowColor != newViewProps.shadowColor) {
    CGColorRef shadowColor = ABI45_0_0RCTCreateCGColorRefFromSharedColor(newViewProps.shadowColor);
  ...
  if (oldViewProps.shadowOffset != newViewProps.shadowOffset) {
    self.layer.shadowOffset = ABI45_0_0RCTCGSizeFromSize(newViewProps.shadowOffset);
    needsInvalidateLayer = YES;
  }
  ...
  if (oldViewProps.transform != newViewProps.transform &&
    ...
    self.layer.transform = ABI45_0_0RCTCATransform3DFromTransformMatrix(newViewProps.transform);
  ...
  if (oldViewProps.nativeId != newViewProps.nativeId) {
    self.nativeId = ABI45_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.nativeId);
  }
  ...
  if (oldViewProps.accessibilityLabel != newViewProps.accessibilityLabel) {
    self.accessibilityElement.accessibilityLabel = ABI45_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityLabel);
  }

  // `accessibilityHint`
  if (oldViewProps.accessibilityHint != newViewProps.accessibilityHint) {
    self.accessibilityElement.accessibilityHint = ABI45_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityHint);
  }
  ...
  if (oldViewProps.accessibilityTraits != newViewProps.accessibilityTraits) {
    self.accessibilityElement.accessibilityTraits =
        ABI45_0_0RCTUIAccessibilityTraitsFromAccessibilityTraits(newViewProps.accessibilityTraits);
  }
  ...
  if (oldViewProps.accessibilityValue != newViewProps.accessibilityValue) {
    if (newViewProps.accessibilityValue.text.hasValue()) {
      self.accessibilityElement.accessibilityValue =
          ABI45_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityValue.text.value());
    } else if (
  ...
  if (oldViewProps.testId != newViewProps.testId) {
    self.accessibilityIdentifier = ABI45_0_0RCTNSStringFromString(newViewProps.testId);
  }
...
- (void)prepareForRecycle
{
  ...
  if ([_propKeysManagedByAnimated_DO_NOT_USE_THIS_IS_BROKEN containsObject:@"transform"]) {
    self.layer.transform = ABI45_0_0RCTCATransform3DFromTransformMatrix(props.transform);
  }
...
static ABI45_0_0RCTCornerRadii ABI45_0_0RCTCornerRadiiFromBorderRadii(BorderRadii borderRadii)
{
...
static ABI45_0_0RCTBorderColors ABI45_0_0RCTCreateABI45_0_0RCTBorderColorsFromBorderColors(BorderColors borderColors)
{
  return ABI45_0_0RCTBorderColors{
      .top = ABI45_0_0RCTCreateCGColorRefFromSharedColor(borderColors.top),
      .left = ABI45_0_0RCTCreateCGColorRefFromSharedColor(borderColors.left),
      .bottom = ABI45_0_0RCTCreateCGColorRefFromSharedColor(borderColors.bottom),
      .right = ABI45_0_0RCTCreateCGColorRefFromSharedColor(borderColors.right)};
}

static void ABI45_0_0RCTReleaseABI45_0_0RCTBorderColors(ABI45_0_0RCTBorderColors borderColors)
{
...
static ABI45_0_0RCTBorderStyle ABI45_0_0RCTBorderStyleFromBorderStyle(BorderStyle borderStyle)
{
  switch (borderStyle) {
    case BorderStyle::Solid:
      return ABI45_0_0RCTBorderStyleSolid;
    case BorderStyle::Dotted:
      return ABI45_0_0RCTBorderStyleDotted;
    case BorderStyle::Dashed:
      return ABI45_0_0RCTBorderStyleDashed;
  }
}
...
- (void)invalidateLayer
{
  ...
  if (layerHasShadow) {
    if (CGColorGetAlpha(_backgroundColor.CGColor) > 0.999) {
      ...
      ABI45_0_0RCTCornerInsets const cornerInsets =
          ABI45_0_0RCTGetCornerInsets(ABI45_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero);
      CGPathRef shadowPath = ABI45_0_0RCTPathCreateWithRoundedRect(self.bounds, cornerInsets, nil);
  ...
  if (useCoreAnimationBorderRendering) {
    ...
    CGColorRef borderColor = ABI45_0_0RCTCreateCGColorRefFromSharedColor(borderMetrics.borderColors.left);
    ...
    ABI45_0_0RCTBorderColors borderColors = ABI45_0_0RCTCreateABI45_0_0RCTBorderColorsFromBorderColors(borderMetrics.borderColors);

    UIImage *image = ABI45_0_0RCTGetBorderImage(
        ABI45_0_0RCTBorderStyleFromBorderStyle(borderMetrics.borderStyles.left),
        layer.bounds.size,
        ABI45_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii),
        ABI45_0_0RCTUIEdgeInsetsFromEdgeInsets(borderMetrics.borderWidths),
        borderColors,
        _backgroundColor.CGColor,
        self.clipsToBounds);

    ABI45_0_0RCTReleaseABI45_0_0RCTBorderColors(borderColors);
    ...
    if (self.clipsToBounds) {
      if (borderMetrics.borderRadii.isUniform()) {
        ...
        CGPathRef path = ABI45_0_0RCTPathCreateWithRoundedRect(
            self.bounds,
            ABI45_0_0RCTGetCornerInsets(ABI45_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero),
            nil);
...
- (NSArray<UIAccessibilityCustomAction *> *)accessibilityCustomActions
{
  ...
  for (auto const &accessibilityAction : accessibilityActions) {
    [customActions
        addObject:[[UIAccessibilityCustomAction alloc] initWithName:ABI45_0_0RCTNSStringFromString(accessibilityAction.name)
                                                             target:self
...
- (BOOL)didActivateAccessibilityCustomAction:(UIAccessibilityCustomAction *)action
{
  if (_eventEmitter && _props->onAccessibilityAction) {
    _eventEmitter->onAccessibilityAction(ABI45_0_0RCTStringFromNSString(action.name));
    return YES;
  } else {
    return NO;
  }
...
{
  return ABI45_0_0RCTNSStringFromString([[self class] componentDescriptorProvider].name);
}
...
Class<ABI45_0_0RCTComponentViewProtocol> ABI45_0_0RCTViewCls(void);
...
Class<ABI45_0_0RCTComponentViewProtocol> ABI45_0_0RCTViewCls(void)
{
  return ABI45_0_0RCTViewComponentView.class;
}
