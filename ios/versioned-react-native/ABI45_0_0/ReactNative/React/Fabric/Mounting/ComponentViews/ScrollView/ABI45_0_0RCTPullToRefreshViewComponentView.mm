...
#import "ABI45_0_0RCTPullToRefreshViewComponentView.h"
...
#import <ABI45_0_0React/ABI45_0_0RCTRefreshableProtocol.h>
#import <ABI45_0_0React/ABI45_0_0RCTScrollViewComponentView.h>

#import "ABI45_0_0RCTFabricComponentsPlugins.h"

using namespace ABI45_0_0facebook::ABI45_0_0React;

@interface ABI45_0_0RCTPullToRefreshViewComponentView () <ABI45_0_0RCTPullToRefreshViewViewProtocol, ABI45_0_0RCTRefreshableProtocol>
@end

@implementation ABI45_0_0RCTPullToRefreshViewComponentView {
  UIRefreshControl *_refreshControl;
  ABI45_0_0RCTScrollViewComponentView *_scrollViewComponentView;
}
...
- (void)_updateTitle
{
  ...
  if (concreteProps.titleColor) {
    attributes[NSForegroundColorAttributeName] = ABI45_0_0RCTUIColorFromSharedColor(concreteProps.titleColor);
  }

  _refreshControl.attributedTitle =
      [[NSAttributedString alloc] initWithString:ABI45_0_0RCTNSStringFromString(concreteProps.title) attributes:attributes];
}
...
- (void)_attach
{
  ...
  _scrollViewComponentView = [ABI45_0_0RCTScrollViewComponentView findScrollViewComponentViewForView:self];
  if (!_scrollViewComponentView) {
    return;
  }
...
{
  ABI45_0_0RCTPullToRefreshViewHandleCommand(self, commandName, args);
}
...
#pragma mark - ABI45_0_0RCTRefreshableProtocol
...
Class<ABI45_0_0RCTComponentViewProtocol> ABI45_0_0RCTPullToRefreshViewCls(void)
{
  return ABI45_0_0RCTPullToRefreshViewComponentView.class;
}
