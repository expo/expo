...
#import "ABI45_0_0UIView+ComponentViewProtocol.h"
...
{
  ABI45_0_0RCTAssert(NO, @"`-[ABI45_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented in a concrete class.");
  return {};
}
           ...
           oldLayoutMetrics:(LayoutMetrics const &)oldLayoutMetrics
{
  ...
  if (forceUpdate || (layoutMetrics.frame != oldLayoutMetrics.frame)) {
    CGRect frame = ABI45_0_0RCTCGRectFromRect(layoutMetrics.frame);
...
{
  ABI45_0_0RCTAssert(NO, @"props access should be implemented by ABI45_0_0RCTViewComponentView.");
  return nullptr;
}
