...
@interface ABI45_0_0RCTFileRequestHandler() <ABI45_0_0RCTTurboModule>
@end

@implementation ABI45_0_0RCTFileRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  && !ABI45_0_0RCTIsBundleAssetURL(request.URL);
}
...
Class ABI45_0_0RCTFileRequestHandlerCls(void) {
  return ABI45_0_0RCTFileRequestHandler.class;
}
