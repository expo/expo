...
@implementation ABI45_0_0RCTFrameAnimation
{
  ...
  ABI45_0_0RCTResponseSenderBlock _callback;
...
{
  NSNumber *toValue = [ABI45_0_0RCTConvert NSNumber:config[@"toValue"]] ?: @1;
  NSArray<NSNumber *> *frames = [ABI45_0_0RCTConvert NSNumberArray:config[@"frames"]];
  NSNumber *iterations = [ABI45_0_0RCTConvert NSNumber:config[@"iterations"]] ?: @1;
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  NSTimeInterval currentDuration = (_animationCurrentTime - _animationStartTime) / ABI45_0_0RCTAnimationDragCoefficient();

  // Determine how many frames have passed since last update.
  // Get index of frames that surround the current interval
  NSUInteger startIndex = floor(currentDuration / ABI45_0_0RCTSingleFrameInterval);
  ...
  NSTimeInterval fromInterval = startIndex * ABI45_0_0RCTSingleFrameInterval;
  NSTimeInterval toInterval = nextIndex * ABI45_0_0RCTSingleFrameInterval;
  ...
  CGFloat frameOutput = ABI45_0_0RCTInterpolateValue(currentDuration,
                                            fromInterval,
                                            toInterval,
                                            fromFrameValue.doubleValue,
                                            toFrameValue.doubleValue,
                                            ABI45_0_0EXTRAPOLATE_TYPE_EXTEND,
                                            ABI45_0_0EXTRAPOLATE_TYPE_EXTEND);
...
{
  CGFloat outputValue = ABI45_0_0RCTInterpolateValue(frameOutput,
                                            0,
                                            1,
                                            _fromValue,
                                            _toValue,
