...
#import <ABI45_0_0React/ABI45_0_0RCTNativeAnimatedTurboModule.h>
...
@interface ABI45_0_0RCTNativeAnimatedTurboModule() <ABI45_0_0NativeAnimatedModuleSpec, ABI45_0_0RCTInitializing>
@end

@implementation ABI45_0_0RCTNativeAnimatedTurboModule
{
...
- (void)initialize
{
  ...
  _nodesManager = [[ABI45_0_0RCTNativeAnimatedNodesManager alloc] initWithBridge:nil surfacePresenter:_surfacePresenter];
...
ABI45_0_0RCT_EXPORT_METHOD(startOperationBatch)
{
  // TODO T71377585
}

ABI45_0_0RCT_EXPORT_METHOD(finishOperationBatch)
{
  // TODO T71377585
}
                  ...
                  value:(double)value)
{
  ...
  // In Bridge, flushing of native animations is done from ABI45_0_0RCTCxxBridge batchDidComplete().
  // Since ABI45_0_0RCTCxxBridge doesn't exist in Bridgeless, and components are not remounted in Fabric for native animations,
...
{
  if (ABI45_0_0RCTUIManagerTypeForTagIsFabric(@(viewTag))) {
...
{
  return std::make_shared<ABI45_0_0facebook::ABI45_0_0React::NativeAnimatedModuleSpecJSI>(params);
}

@end

Class ABI45_0_0RCTNativeAnimatedTurboModuleCls(void) {
  return ABI45_0_0RCTNativeAnimatedTurboModule.class;
}
