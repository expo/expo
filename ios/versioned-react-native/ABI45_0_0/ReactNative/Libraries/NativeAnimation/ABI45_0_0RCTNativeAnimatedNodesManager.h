...
@protocol ABI45_0_0RCTValueAnimatedNodeObserver;

NS_ASSUME_NONNULL_BEGIN

@interface ABI45_0_0RCTNativeAnimatedNodesManager : NSObject

- (nonnull instancetype)initWithBridge:(nullable ABI45_0_0RCTBridge *)bridge
...
- (void)getValue:(NSNumber *)nodeTag
        saveCallback:(ABI45_0_0RCTResponseSenderBlock)saveCallback;
