...
// NOTE: This module is temporarily forked (see ABI45_0_0RCTNativeAnimatedTurboModule).
// When making any changes, be sure to apply them to the fork as well.
@interface ABI45_0_0RCTNativeAnimatedModule : ABI45_0_0RCTEventEmitter <ABI45_0_0RCTBridgeModule, ABI45_0_0RCTValueAnimatedNodeObserver, ABI45_0_0RCTEventDispatcherObserver, ABI45_0_0RCTUIManagerObserver, ABI45_0_0RCTSurfacePresenterObserver>
