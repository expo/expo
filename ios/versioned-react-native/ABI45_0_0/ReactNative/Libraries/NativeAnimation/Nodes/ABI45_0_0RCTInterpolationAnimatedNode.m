...
@implementation ABI45_0_0RCTInterpolationAnimatedNode
{
  __weak ABI45_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI45_0_0RCTAnimatedNode *)parent
{
  ...
  if ([parent isKindOfClass:[ABI45_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI45_0_0RCTValueAnimatedNode *)parent;
  }
}
...
- (void)performUpdate
{
  ...
  CGFloat interpolated = ABI45_0_0RCTInterpolateValueInRange(inputValue,
                                                    _inputRange,
                                                    _outputRange,
                                                    _extrapolateLeft,
                                                    _extrapolateRight);
  ...
  if (_hasStringOutput) {
    ...
    if (_numVals > 1) {
      ...
      for (NSTextCheckingResult *match in [_matches reverseObjectEnumerator]) {
        CGFloat val = ABI45_0_0RCTInterpolateValueInRange(inputValue,
                                                          _inputRange,
                                                          _outputs[--i],
                                                          _extrapolateLeft,
                                                          _extrapolateRight);
