...
@implementation ABI45_0_0RCTTrackingAnimatedNode {
...
- (void)onDetachedFromNode:(ABI45_0_0RCTAnimatedNode *)parent
{
...
- (void)performUpdate
{
  ...
  ABI45_0_0RCTValueAnimatedNode *node = (ABI45_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
