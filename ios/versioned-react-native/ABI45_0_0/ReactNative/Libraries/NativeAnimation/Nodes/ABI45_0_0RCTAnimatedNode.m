...
@implementation ABI45_0_0RCTAnimatedNode
{
  NSMapTable<NSNumber *, ABI45_0_0RCTAnimatedNode *> *_childNodes;
  NSMapTable<NSNumber *, ABI45_0_0RCTAnimatedNode *> *_parentNodes;
}
...
- (NSMapTable<NSNumber *, ABI45_0_0RCTAnimatedNode *> *)childNodes
{
  return _childNodes;
}

- (NSMapTable<NSNumber *, ABI45_0_0RCTAnimatedNode *> *)parentNodes
{
  return _parentNodes;
}

- (void)addChild:(ABI45_0_0RCTAnimatedNode *)child
{
  if (!_childNodes) {
...
- (void)removeChild:(ABI45_0_0RCTAnimatedNode *)child
{
  if (!_childNodes) {
    return;
  }
...
- (void)onAttachedToNode:(ABI45_0_0RCTAnimatedNode *)parent
{
  if (!_parentNodes) {
...
- (void)detachNode
{
  for (ABI45_0_0RCTAnimatedNode *parent in _parentNodes.objectEnumerator) {
    [parent removeChild:self];
  }
  for (ABI45_0_0RCTAnimatedNode *child in _childNodes.objectEnumerator) {
