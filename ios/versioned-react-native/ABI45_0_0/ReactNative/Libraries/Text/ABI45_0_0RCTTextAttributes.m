...
#import <ABI45_0_0React/ABI45_0_0RCTTextAttributes.h>
...
NSString *const ABI45_0_0RCTTextAttributesIsHighlightedAttributeName = @"ABI45_0_0RCTTextAttributesIsHighlightedAttributeName";
NSString *const ABI45_0_0RCTTextAttributesTagAttributeName = @"ABI45_0_0RCTTextAttributesTagAttributeName";

@implementation ABI45_0_0RCTTextAttributes
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _opacity = NAN;
    _textTransform = ABI45_0_0RCTTextTransformUndefined;
  }

  return self;
}

- (void)applyTextAttributes:(ABI45_0_0RCTTextAttributes *)textAttributes
{
  ...
  _textDecorationLine = textAttributes->_textDecorationLine != ABI45_0_0RCTTextDecorationLineTypeNone ? textAttributes->_textDecorationLine : _textDecorationLine; // *
  ...
  _textTransform = textAttributes->_textTransform != ABI45_0_0RCTTextTransformUndefined ? textAttributes->_textTransform : _textTransform;
}
...
- (NSDictionary<NSAttributedStringKey, id> *)effectiveTextAttributes
{
  ...
  if (_textDecorationLine == ABI45_0_0RCTTextDecorationLineTypeUnderline ||
      _textDecorationLine == ABI45_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    isTextDecorationEnabled = YES;
    attributes[NSUnderlineStyleAttributeName] = @(_textDecorationStyle);
  }

  if (_textDecorationLine == ABI45_0_0RCTTextDecorationLineTypeStrikethrough ||
      _textDecorationLine == ABI45_0_0RCTTextDecorationLineTypeUnderlineStrikethrough){
    isTextDecorationEnabled = YES;
  ...
  // Special
  if (_isHighlighted) {
    attributes[ABI45_0_0RCTTextAttributesIsHighlightedAttributeName] = @YES;
  }

  if (_tag) {
    attributes[ABI45_0_0RCTTextAttributesTagAttributeName] = _tag;
  }
...
{
  // FIXME: ABI45_0_0RCTFont has thread-safety issues and must be rewritten.
  return [ABI45_0_0RCTFont updateFont:nil
...
{
  bool fontScalingEnabled = !ABI45_0_0RCTHasFontHandlerSet() && _allowFontScaling;
...
- (NSString *)applyTextAttributesToText:(NSString *)text
{
  switch (_textTransform) {
    case ABI45_0_0RCTTextTransformUndefined:
    case ABI45_0_0RCTTextTransformNone:
      return text;
    case ABI45_0_0RCTTextTransformLowercase:
      return [text lowercaseString];
    case ABI45_0_0RCTTextTransformUppercase:
      return [text uppercaseString];
    case ABI45_0_0RCTTextTransformCapitalize:
      return capitalizeText(text);
  }
}

- (ABI45_0_0RCTTextAttributes *)copyWithZone:(NSZone *)zone
{
  ABI45_0_0RCTTextAttributes *textAttributes = [ABI45_0_0RCTTextAttributes new];
...
- (BOOL)isEqual:(ABI45_0_0RCTTextAttributes *)textAttributes
{
  if (!textAttributes) {
    return NO;
  }
...
#define ABI45_0_0RCTTextAttributesCompareFloats(a) ((a == textAttributes->a) || (isnan(a) && isnan(textAttributes->a)))
#define ABI45_0_0RCTTextAttributesCompareSize(a) CGSizeEqualToSize(a, textAttributes->a)
#define ABI45_0_0RCTTextAttributesCompareObjects(a) ((a == textAttributes->a) || [a isEqual:textAttributes->a])
#define ABI45_0_0RCTTextAttributesCompareStrings(a) ((a == textAttributes->a) || [a isEqualToString:textAttributes->a])
#define ABI45_0_0RCTTextAttributesCompareOthers(a) (a == textAttributes->a)

  return
    ABI45_0_0RCTTextAttributesCompareObjects(_foregroundColor) &&
    ABI45_0_0RCTTextAttributesCompareObjects(_backgroundColor) &&
    ABI45_0_0RCTTextAttributesCompareFloats(_opacity) &&
    // Font
    ABI45_0_0RCTTextAttributesCompareObjects(_fontFamily) &&
    ABI45_0_0RCTTextAttributesCompareFloats(_fontSize) &&
    ABI45_0_0RCTTextAttributesCompareFloats(_fontSizeMultiplier) &&
    ABI45_0_0RCTTextAttributesCompareFloats(_maxFontSizeMultiplier) &&
    ABI45_0_0RCTTextAttributesCompareStrings(_fontWeight) &&
    ABI45_0_0RCTTextAttributesCompareObjects(_fontStyle) &&
    ABI45_0_0RCTTextAttributesCompareObjects(_fontVariant) &&
    ABI45_0_0RCTTextAttributesCompareOthers(_allowFontScaling) &&
    ABI45_0_0RCTTextAttributesCompareFloats(_letterSpacing) &&
    // Paragraph Styles
    ABI45_0_0RCTTextAttributesCompareFloats(_lineHeight) &&
    ABI45_0_0RCTTextAttributesCompareFloats(_alignment) &&
    ABI45_0_0RCTTextAttributesCompareOthers(_baseWritingDirection) &&
    // Decoration
    ABI45_0_0RCTTextAttributesCompareObjects(_textDecorationColor) &&
    ABI45_0_0RCTTextAttributesCompareOthers(_textDecorationStyle) &&
    ABI45_0_0RCTTextAttributesCompareOthers(_textDecorationLine) &&
    // Shadow
    ABI45_0_0RCTTextAttributesCompareSize(_textShadowOffset) &&
    ABI45_0_0RCTTextAttributesCompareFloats(_textShadowRadius) &&
    ABI45_0_0RCTTextAttributesCompareObjects(_textShadowColor) &&
    // Special
    ABI45_0_0RCTTextAttributesCompareOthers(_isHighlighted) &&
    ABI45_0_0RCTTextAttributesCompareObjects(_tag) &&
    ABI45_0_0RCTTextAttributesCompareOthers(_layoutDirection) &&
    ABI45_0_0RCTTextAttributesCompareOthers(_textTransform);
}
