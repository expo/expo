...
@implementation ABI45_0_0RCTBaseTextInputShadowView
{
...
- (instancetype)initWithBridge:(ABI45_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI45_0_0YGNodeSetMeasureFunc(self.yogaNode, ABI45_0_0RCTBaseTextInputShadowViewMeasure);
    ABI45_0_0YGNodeSetBaselineFunc(self.yogaNode, ABI45_0_0RCTTextInputShadowViewBaseline);
  }
...
- (void)uiManagerWillPerformMounting
{
  ...
  ABI45_0_0RCTTextAttributes *textAttributes = [self.textAttributes copy];
  ...
  [attributedText removeAttribute:ABI45_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                            range:NSMakeRange(0, attributedText.length)];

  [attributedText removeAttribute:ABI45_0_0RCTTextAttributesTagAttributeName
                            range:NSMakeRange(0, attributedText.length)];
  ...
  [_bridge.uiManager addUIBlock:^(ABI45_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI45_0_0RCTBaseTextInputView *baseTextInputView = (ABI45_0_0RCTBaseTextInputView *)viewRegistry[tag];
    if (!baseTextInputView) {
      return;
    }

    baseTextInputView.textAttributes = textAttributes;
    baseTextInputView.ABI45_0_0ReactBorderInsets = borderInsets;
    baseTextInputView.ABI45_0_0ReactPaddingInsets = paddingInsets;
...
- (CGSize)sizeThatFitsMinimumSize:(CGSize)minimumSize maximumSize:(CGSize)maximumSize
{
  ...
  return (CGSize){
    MAX(minimumSize.width, MIN(ABI45_0_0RCTCeilPixelValue(size.width), maximumSize.width)),
    MAX(minimumSize.height, MIN(ABI45_0_0RCTCeilPixelValue(size.height), maximumSize.height))
  };
}
...
static ABI45_0_0YGSize ABI45_0_0RCTBaseTextInputShadowViewMeasure(ABI45_0_0YGNodeRef node, float width, ABI45_0_0YGMeasureMode widthMode, float height, ABI45_0_0YGMeasureMode heightMode)
{
  ...
  return (ABI45_0_0YGSize){
    ABI45_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.width),
    ABI45_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.height)
  };
}

static float ABI45_0_0RCTTextInputShadowViewBaseline(ABI45_0_0YGNodeRef node, const float width, const float height)
{
  ABI45_0_0RCTBaseTextInputShadowView *shadowTextView = (__bridge ABI45_0_0RCTBaseTextInputShadowView *)ABI45_0_0YGNodeGetContext(node);
