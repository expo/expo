...
#import <ABI45_0_0React/ABI45_0_0RCTBackedTextInputDelegateAdapter.h>
#import <ABI45_0_0React/ABI45_0_0RCTTextAttributes.h>

@implementation ABI45_0_0RCTUITextField {
  ABI45_0_0RCTBackedTextFieldDelegateAdapter *_textInputDelegateAdapter;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI45_0_0RCTBackedTextFieldDelegateAdapter alloc] initWithTextField:self];
    _scrollEnabled = YES;
  }
...
- (CGSize)intrinsicContentSize
{
  ...
  size = CGSizeMake(ABI45_0_0RCTCeilPixelValue(size.width), ABI45_0_0RCTCeilPixelValue(size.height));
