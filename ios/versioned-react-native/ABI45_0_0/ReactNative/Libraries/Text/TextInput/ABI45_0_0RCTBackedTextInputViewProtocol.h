...
@protocol ABI45_0_0RCTBackedTextInputDelegate;
@class ABI45_0_0RCTTextAttributes;

NS_ASSUME_NONNULL_BEGIN

@protocol ABI45_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI45_0_0RCTBackedTextInputDelegate> textInputDelegate;
