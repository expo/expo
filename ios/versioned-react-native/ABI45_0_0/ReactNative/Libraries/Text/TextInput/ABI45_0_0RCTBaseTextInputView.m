...
@implementation ABI45_0_0RCTBaseTextInputView {
  __weak ABI45_0_0RCTBridge *_bridge;
  __weak id<ABI45_0_0RCTEventDispatcherProtocol> _eventDispatcher;
...
- (UIView<ABI45_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  ABI45_0_0RCTAssert(NO, @"-[ABI45_0_0RCTBaseTextInputView backedTextInputView] must be implemented in subclass.");
  return nil;
}

#pragma mark - ABI45_0_0RCTComponent
...
- (void)setTextAttributes:(ABI45_0_0RCTTextAttributes *)textAttributes
{
...
{
  id<ABI45_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
...
- (void)setABI45_0_0ReactPaddingInsets:(UIEdgeInsets)ABI45_0_0ReactPaddingInsets
{
  _ABI45_0_0ReactPaddingInsets = ABI45_0_0ReactPaddingInsets;
  // We apply `paddingInsets` as `backedTextInputView`'s `textContainerInset`.
  self.backedTextInputView.textContainerInset = ABI45_0_0ReactPaddingInsets;
  [self setNeedsLayout];
}

- (void)setABI45_0_0ReactBorderInsets:(UIEdgeInsets)ABI45_0_0ReactBorderInsets
{
  _ABI45_0_0ReactBorderInsets = ABI45_0_0ReactBorderInsets;
  // We apply `borderInsets` as `backedTextInputView` layout offset.
  self.backedTextInputView.frame = UIEdgeInsetsInsetRect(self.bounds, ABI45_0_0ReactBorderInsets);
  [self setNeedsLayout];
}
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  [backedTextInputViewTextCopy removeAttribute:ABI45_0_0RCTTextAttributesTagAttributeName
                                         range:NSMakeRange(0, backedTextInputViewTextCopy.length)];

  [attributedTextCopy removeAttribute:ABI45_0_0RCTTextAttributesTagAttributeName
  ...
  } else if (eventLag > ABI45_0_0RCTTextUpdateLagWarningThreshold) {
    ABI45_0_0RCTLog(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", self.backedTextInputView.attributedText.string, (long long)eventLag);
  }
}

- (ABI45_0_0RCTTextSelection *)selection
{
  id<ABI45_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
  UITextRange *selectedTextRange = backedTextInputView.selectedTextRange;
  return [[ABI45_0_0RCTTextSelection new] initWithStart:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.start]
                                           end:[backedTextInputView offsetFromPosition:backedTextInputView.beginningOfDocument toPosition:selectedTextRange.end]];
}

- (void)setSelection:(ABI45_0_0RCTTextSelection *)selection
{
  if (!selection) {
    return;
  }
  ...
  if (eventLag == 0 && ![previousSelectedTextRange isEqual:selectedTextRange]) {
    ...
    ABI45_0_0RCTLog(@"Native TextInput(%@) is %lld events ahead of JS - try to make your JS faster.", backedTextInputView.attributedText.string, (long long)eventLag);
  }
}
...
{
  UIView<ABI45_0_0RCTBackedTextInputViewProtocol> *textInputView = self.backedTextInputView;
...
#pragma mark - ABI45_0_0RCTBackedTextInputDelegate
...
- (void)textInputDidBeginEditing
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI45_0_0RCTTextEventTypeFocus
...
{
  [_eventDispatcher sendTextEventWithType:ABI45_0_0RCTTextEventTypeEnd
                                 ABI45_0_0ReactTag:self.ABI45_0_0ReactTag
                                     text:[self.backedTextInputView.attributedText.string copy]
                                      key:nil
                               eventCount:_nativeEventCount];

  [_eventDispatcher sendTextEventWithType:ABI45_0_0RCTTextEventTypeBlur
                                 ABI45_0_0ReactTag:self.ABI45_0_0ReactTag
                                     text:[self.backedTextInputView.attributedText.string copy]
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldReturn
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI45_0_0RCTTextEventTypeSubmit
                                 ABI45_0_0ReactTag:self.ABI45_0_0ReactTag
                                     text:[self.backedTextInputView.attributedText.string copy]
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (NSString *)textInputShouldChangeText:(NSString *)text inRange:(NSRange)range
{
  ...
  if (!backedTextInputView.textWasPasted) {
    [_eventDispatcher sendTextEventWithType:ABI45_0_0RCTTextEventTypeKeyPress
                                   ABI45_0_0ReactTag:self.ABI45_0_0ReactTag
                                       text:nil
                                        key:text
                                 eventCount:_nativeEventCount];
...
- (void)textInputDidChangeSelection
{
  ...
  ABI45_0_0RCTTextSelection *selection = self.selection;
...
- (CGSize)intrinsicContentSize
{
  ...
  size.width += _ABI45_0_0ReactBorderInsets.left + _ABI45_0_0ReactBorderInsets.right;
  size.height += _ABI45_0_0ReactBorderInsets.top + _ABI45_0_0ReactBorderInsets.bottom;
...
{
  CGFloat compoundHorizontalBorderInset = _ABI45_0_0ReactBorderInsets.left + _ABI45_0_0ReactBorderInsets.right;
  CGFloat compoundVerticalBorderInset = _ABI45_0_0ReactBorderInsets.top + _ABI45_0_0ReactBorderInsets.bottom;
...
{
  [self.backedTextInputView ABI45_0_0ReactFocus];
}

- (void)ABI45_0_0ReactBlur
{
  [self.backedTextInputView ABI45_0_0ReactBlur];
}
...
- (void)didMoveToWindow
{
  if (self.autoFocus && !_didMoveToWindow) {
    ...
    [self.backedTextInputView ABI45_0_0ReactFocusIfNeeded];
  }
...
{
  __weak ABI45_0_0RCTBaseTextInputView *weakSelf = self;
  [_bridge.uiManager rootViewForABI45_0_0ReactTag:self.ABI45_0_0ReactTag withCompletion:^(UIView *rootView) {
    ABI45_0_0RCTBaseTextInputView *strongSelf = weakSelf;
    if (rootView) {
      UIView *accessoryView = [strongSelf->_bridge.uiManager viewForNativeID:nativeID
                                                                 withRootTag:rootView.ABI45_0_0ReactTag];
      if (accessoryView && [accessoryView isKindOfClass:[ABI45_0_0RCTInputAccessoryView class]]) {
        strongSelf.backedTextInputView.inputAccessoryView = ((ABI45_0_0RCTInputAccessoryView *)accessoryView).inputAccessoryView;
