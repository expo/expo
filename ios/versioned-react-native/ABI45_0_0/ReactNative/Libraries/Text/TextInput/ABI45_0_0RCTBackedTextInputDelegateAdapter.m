...
@interface ABI45_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI45_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI45_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
...
@interface ABI45_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI45_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI45_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}
