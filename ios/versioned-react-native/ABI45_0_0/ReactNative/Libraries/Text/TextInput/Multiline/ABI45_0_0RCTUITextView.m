...
@implementation ABI45_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI45_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI45_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
...
- (void)setDelegate:(id<UITextViewDelegate>)delegate {
  // Delegate is set inside `[ABI45_0_0RCTBackedTextViewDelegateAdapter initWithTextView]` and
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI45_0_0RCTCeilPixelValue(placeholderSize.width), ABI45_0_0RCTCeilPixelValue(placeholderSize.height));
