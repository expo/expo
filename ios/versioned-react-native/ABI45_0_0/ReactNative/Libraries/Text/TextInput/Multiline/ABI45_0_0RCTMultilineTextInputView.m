...
@implementation ABI45_0_0RCTMultilineTextInputView
{
  ABI45_0_0RCTUITextView *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI45_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI45_0_0RCTUITextView alloc] initWithFrame:self.bounds];
...
{
  ABI45_0_0RCTDirectEventBlock onScroll = self.onScroll;
