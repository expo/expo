...
#import "ABI45_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI45_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ABI45_0_0ReactViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ABI45_0_0ReactViewController detachChildViewController:self.contentViewController];
}
