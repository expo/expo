...
@interface ABI45_0_0RCTImageStoreManager : NSObject <ABI45_0_0RCTURLRequestHandler>
...
@interface ABI45_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI45_0_0RCTBridge (ABI45_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI45_0_0RCTImageStoreManager *imageStoreManager;
