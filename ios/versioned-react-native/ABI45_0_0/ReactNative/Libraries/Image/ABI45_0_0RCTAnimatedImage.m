...
@interface ABI45_0_0RCTGIFCoderFrame : NSObject
...
@implementation ABI45_0_0RCTGIFCoderFrame
@end

@implementation ABI45_0_0RCTAnimatedImage {
  CGImageSourceRef _imageSource;
  CGFloat _scale;
  NSUInteger _loopCount;
  NSUInteger _frameCount;
  NSArray<ABI45_0_0RCTGIFCoderFrame *> *_frames;
}
...
- (BOOL)scanAndCheckFramesValidWithSource:(CGImageSourceRef)imageSource
{
  ...
  NSMutableArray<ABI45_0_0RCTGIFCoderFrame *> *frames = [NSMutableArray array];

  for (size_t i = 0; i < frameCount; i++) {
    ABI45_0_0RCTGIFCoderFrame *frame = [ABI45_0_0RCTGIFCoderFrame new];
    frame.index = i;
