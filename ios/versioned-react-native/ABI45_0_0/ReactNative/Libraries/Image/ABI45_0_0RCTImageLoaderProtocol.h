...
/**
 * If available, ABI45_0_0RCTImageRedirectProtocol is invoked before loading an asset.
 * Implementation should return either a new URL or nil when redirection is
 * not needed.
 */

@protocol ABI45_0_0RCTImageRedirectProtocol
 ...
 * The priority logic is up to each @ABI45_0_0RCTImageLoaderProtocol implementation
 */
typedef NS_ENUM(NSInteger, ABI45_0_0RCTImageLoaderPriority) {
  ABI45_0_0RCTImageLoaderPriorityImmediate,
  ABI45_0_0RCTImageLoaderPriorityPrefetch
};

@protocol ABI45_0_0RCTImageLoaderProtocol<ABI45_0_0RCTURLRequestHandler>
...
* `partialLoadBlock` is meant for custom image loaders that do not ship with the core ABI45_0_0RN library.
 ...
 * decoded images as long as it conforms to the ABI45_0_0RCTImageCache
