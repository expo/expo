...
#import <ABI45_0_0React/ABI45_0_0RCTDisplayWeakRefreshable.h>

#import <mach/mach.h>
#import <objc/runtime.h>

static NSUInteger ABI45_0_0RCTDeviceTotalMemory() {
  return (NSUInteger)[[NSProcessInfo processInfo] physicalMemory];
}

static NSUInteger ABI45_0_0RCTDeviceFreeMemory() {
...
@interface ABI45_0_0RCTUIImageViewAnimated () <CALayerDelegate, ABI45_0_0RCTDisplayRefreshable>
...
@property (nonatomic, strong) UIImage<ABI45_0_0RCTAnimatedImage> *animatedImage;
...
@implementation ABI45_0_0RCTUIImageViewAnimated
...
- (void)setImage:(UIImage *)image
{
  ...
  if ([image respondsToSelector:@selector(animatedImageFrameAtIndex:)]) {
    NSUInteger animatedImageFrameCount = ((UIImage<ABI45_0_0RCTAnimatedImage> *)image).animatedImageFrameCount;
    ...
    self.animatedImage = (UIImage<ABI45_0_0RCTAnimatedImage> *)image;
...
- (CADisplayLink *)displayLink
{
  ...
  // Since this class is used for all ABI45_0_0RCTImageView's, this is especially important.
  if (!_animatedImage) {
    return nil;
  }

  if (!_displayLink) {
    _displayLink = [ABI45_0_0RCTDisplayWeakRefreshable displayLinkWithWeakRefreshable:self];
...
- (void)displayDidRefresh:(CADisplayLink *)displayLink
{
  ...
  if (!fetchFrame && !bufferFull && self.fetchQueue.operationCount == 0) {
    ...
    UIImage<ABI45_0_0RCTAnimatedImage> *animatedImage = self.animatedImage;
...
- (void)calculateMaxBufferCount
{
  ...
  if (self.maxBufferSize > 0) {
    ...
    NSUInteger total = ABI45_0_0RCTDeviceTotalMemory();
    NSUInteger free = ABI45_0_0RCTDeviceFreeMemory();
