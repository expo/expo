...
/**
 * The image loader (i.e. ABI45_0_0RCTImageLoader) implement this to declare whether image performance should be logged.
 */
@protocol ABI45_0_0RCTImageLoaderLoggableProtocol
 ...
 */
@protocol ABI45_0_0RCTImageLoaderLoggable
