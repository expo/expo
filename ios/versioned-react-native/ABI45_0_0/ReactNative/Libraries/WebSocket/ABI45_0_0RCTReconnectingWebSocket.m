...
@interface ABI45_0_0RCTReconnectingWebSocket () <ABI45_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI45_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  ...
  __weak ABI45_0_0RCTSRWebSocket *socket = _socket;
