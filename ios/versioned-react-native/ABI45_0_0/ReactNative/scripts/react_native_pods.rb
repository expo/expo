...
$ABI45_0_0CODEGEN_OUTPUT_DIR = 'versioned-react-native/ABI45_0_0/ReactNative/codegen/ios'
...
def use_react_native_ABI45_0_0! (options={})
  ...
  pod 'ABI45_0_0FBLazyVector', :path => "#{prefix}/Libraries/FBLazyVector", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0FBReactNativeSpec', :path => "#{prefix}/React/FBReactNativeSpec", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0RCTRequired', :path => "#{prefix}/Libraries/RCTRequired", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0RCTTypeSafety', :path => "#{prefix}/Libraries/TypeSafety", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React', :path => "#{prefix}/", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-Core', :path => "#{prefix}/", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-CoreModules', :path => "#{prefix}/React/CoreModules", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-RCTActionSheet', :path => "#{prefix}/Libraries/ActionSheetIOS", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-RCTAnimation', :path => "#{prefix}/Libraries/NativeAnimation", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-RCTBlob', :path => "#{prefix}/Libraries/Blob", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-RCTImage', :path => "#{prefix}/Libraries/Image", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-RCTLinking', :path => "#{prefix}/Libraries/LinkingIOS", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-RCTNetwork', :path => "#{prefix}/Libraries/Network", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-RCTSettings', :path => "#{prefix}/Libraries/Settings", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-RCTText', :path => "#{prefix}/Libraries/Text", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-RCTVibration', :path => "#{prefix}/Libraries/Vibration", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-Core/RCTWebSocket', :path => "#{prefix}/", :project_name => 'ABI45_0_0'

  unless production
    pod 'ABI45_0_0React-Core/DevSupport', :path => "#{prefix}/", :project_name => 'ABI45_0_0'
  end

  pod 'ABI45_0_0React-cxxreact', :path => "#{prefix}/ReactCommon/cxxreact", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-jsi', :path => "#{prefix}/ReactCommon/jsi", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-jsiexecutor', :path => "#{prefix}/ReactCommon/jsiexecutor", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-jsinspector', :path => "#{prefix}/ReactCommon/jsinspector", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-callinvoker', :path => "#{prefix}/ReactCommon/callinvoker", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-runtimeexecutor', :path => "#{prefix}/ReactCommon/runtimeexecutor", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-perflogger', :path => "#{prefix}/ReactCommon/reactperflogger", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0React-logger', :path => "#{prefix}/ReactCommon/logger", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0ReactCommon/turbomodule/core', :path => "#{prefix}/ReactCommon", :project_name => 'ABI45_0_0'
  pod 'ABI45_0_0Yoga', :path => "#{prefix}/ReactCommon/yoga", :project_name => 'ABI45_0_0', :modular_headers => true

  # pod 'ABI45_0_0DoubleConversion', :podspec => "#{prefix}/third-party-podspecs/DoubleConversion.podspec"
  # pod 'ABI45_0_0glog', :podspec => "#{prefix}/third-party-podspecs/glog.podspec"
  # pod 'ABI45_0_0boost', :podspec => "#{prefix}/third-party-podspecs/boost.podspec"
  # pod 'ABI45_0_0RCT-Folly', :podspec => "#{prefix}/third-party-podspecs/RCT-Folly.podspec"
  ...
  pod 'ABI45_0_0React-Codegen', :path => $ABI45_0_0CODEGEN_OUTPUT_DIR

  if fabric_enabled
    checkAndGenerateEmptyThirdPartyProvider!(prefix)
    pod 'ABI45_0_0React-Fabric', :path => "#{prefix}/ReactCommon", :project_name => 'ABI45_0_0'
    pod 'ABI45_0_0React-rncore', :path => "#{prefix}/ReactCommon", :project_name => 'ABI45_0_0'
    pod 'ABI45_0_0React-graphics', :path => "#{prefix}/ReactCommon/react/renderer/graphics", :project_name => 'ABI45_0_0'
    pod 'ABI45_0_0React-jsi/Fabric', :path => "#{prefix}/ReactCommon/jsi", :project_name => 'ABI45_0_0'
    pod 'ABI45_0_0React-RCTFabric', :path => "#{prefix}/React", :project_name => 'ABI45_0_0'
    # pod 'ABI45_0_0RCT-Folly/Fabric', :podspec => "#{prefix}/third-party-podspecs/RCT-Folly.podspec"
  end

  if hermes_enabled
    pod 'ABI45_0_0React-hermes', :path => "#{prefix}/ReactCommon/hermes", :project_name => 'ABI45_0_0'
    pod 'ABI45_0_0hermes-engine', '~> 0.11.0'
    pod 'ABI45_0_0libevent', '~> 2.1.12'
  end
end
...
def use_flipper!(versions = {}, configurations: ['Debug'])
  ...
  pod 'ABI45_0_0FlipperKit', versions['Flipper'], :configurations => configurations
  pod 'ABI45_0_0FlipperKit/FlipperKitLayoutPlugin', versions['Flipper'], :configurations => configurations
  pod 'ABI45_0_0FlipperKit/SKIOSNetworkPlugin', versions['Flipper'], :configurations => configurations
  pod 'ABI45_0_0FlipperKit/FlipperKitUserDefaultsPlugin', versions['Flipper'], :configurations => configurations
  pod 'ABI45_0_0FlipperKit/FlipperKitReactPlugin', versions['Flipper'], :configurations => configurations
  # List all transitive dependencies for FlipperKit pods
  # to avoid them being linked in Release builds
  pod 'ABI45_0_0Flipper', versions['Flipper'], :configurations => configurations
  pod 'ABI45_0_0Flipper-Boost-iOSX', versions['Flipper-Boost-iOSX'], :configurations => configurations
  pod 'ABI45_0_0Flipper-DoubleConversion', versions['Flipper-DoubleConversion'], :configurations => configurations
  pod 'ABI45_0_0Flipper-Fmt', versions['Flipper-Fmt'], :configurations => configurations
  pod 'ABI45_0_0Flipper-Folly', versions['Flipper-Folly'], :configurations => configurations
  pod 'ABI45_0_0Flipper-Glog', versions['Flipper-Glog'], :configurations => configurations
  pod 'ABI45_0_0Flipper-PeerTalk', versions['Flipper-PeerTalk'], :configurations => configurations
  pod 'ABI45_0_0Flipper-RSocket', versions['Flipper-RSocket'], :configurations => configurations
  pod 'ABI45_0_0FlipperKit/Core', versions['Flipper'], :configurations => configurations
  pod 'ABI45_0_0FlipperKit/CppBridge', versions['Flipper'], :configurations => configurations
  pod 'ABI45_0_0FlipperKit/FBCxxFollyDynamicConvert', versions['Flipper'], :configurations => configurations
  pod 'ABI45_0_0FlipperKit/FBDefines', versions['Flipper'], :configurations => configurations
  pod 'ABI45_0_0FlipperKit/FKPortForwarding', versions['Flipper'], :configurations => configurations
  pod 'ABI45_0_0FlipperKit/FlipperKitHighlightOverlay', versions['Flipper'], :configurations => configurations
  pod 'ABI45_0_0FlipperKit/FlipperKitLayoutTextSearchable', versions['Flipper'], :configurations => configurations
  pod 'ABI45_0_0FlipperKit/FlipperKitNetworkPlugin', versions['Flipper'], :configurations => configurations
  pod 'ABI45_0_0OpenSSL-Universal', versions['OpenSSL-Universal'], :configurations => configurations
end
...
def checkAndGenerateEmptyThirdPartyProvider!(react_native_path)
  ...
  relative_installation_root = Pod::Config.instance.installation_root.relative_path_from(Pathname.pwd)
  output_dir = "#{relative_installation_root}/#{$ABI45_0_0CODEGEN_OUTPUT_DIR}"
  ...
  spec = {
    ...
    'pod_target_xcconfig' => { "HEADER_SEARCH_PATHS" =>
      [
        "\"$(PODS_ROOT)/boost\"",
        "\"$(PODS_ROOT)/RCT-Folly\"",
        "\"${PODS_ROOT}/Headers/Public/ABI45_0_0React-Codegen/react/renderer/components\"",
        "\"$(PODS_ROOT)/Headers/Private/ABI45_0_0React-Fabric\"",
        "\"$(PODS_ROOT)/Headers/Private/ABI45_0_0React-RCTFabric\"",
      ].join(' ')
    },
    'dependencies': {
      "ABI45_0_0FBReactNativeSpec":  [version],
      "ABI45_0_0React-jsiexecutor":  [version],
      "RCT-Folly": [folly_version],
      "ABI45_0_0RCTRequired": [version],
      "ABI45_0_0RCTTypeSafety": [version],
      "ABI45_0_0React-Core": [version],
      "ABI45_0_0React-jsi": [version],
      "ABI45_0_0ReactCommon/turbomodule/core": [version]
    }
  }

  if fabric_enabled
    spec[:'dependencies'].merge!({
      "ABI45_0_0React-graphics": [version],
      "ABI45_0_0React-rncore":  [version],
    });
  end

  if script_phases
    Pod::UI.puts "[Codegen] Adding script_phases to ABI45_0_0React-Codegen."
...
def generate_react_codegen_podspec!(spec)
  ...
  if has_react_codegen_podspec_generated()
    Pod::UI.puts "[Codegen] Skipping ABI45_0_0React-Codegen podspec generation."
    return
  end
  relative_installation_root = Pod::Config.instance.installation_root.relative_path_from(Pathname.pwd)
  output_dir = "#{relative_installation_root}/#{$ABI45_0_0CODEGEN_OUTPUT_DIR}"
  ...
  podspec_path = File.join(output_dir, 'ABI45_0_0React-Codegen.podspec.json')
  ...
  return {
    "spec" => spec,
    "path" => $ABI45_0_0CODEGEN_OUTPUT_DIR,  # Path needs to be relative to `Podfile`
  }
end
...
def use_react_native_codegen_discovery!(options={})
  ...
  # Generate ABI45_0_0React-Codegen podspec here to add the script phases.
...
def use_react_native_codegen_ABI45_0_0!(spec, options={})
  return if ENV['USE_CODEGEN_DISCOVERY'] == '1'
  ...
  relative_installation_root = Pod::Config.instance.installation_root.relative_path_from(Pathname.pwd)
  output_dir = options[:output_dir] ||= $ABI45_0_0CODEGEN_OUTPUT_DIR
