...
header_subspecs = {
  ...
  'RCTBlobHeaders'              => 'Libraries/Blob/{ABI45_0_0RCTBlobManager,ABI45_0_0RCTFileReaderModule}.h',
...
Pod::Spec.new do |s|
  ...
  s.source                 = { :path => "." }
  s.resource_bundle        = { "ABI45_0_0AccessibilityResources" => ["React/AccessibilityResources/*.lproj"]}
  s.compiler_flags         = folly_compiler_flags + ' ' + boost_compiler_flags
  s.header_dir             = "ABI45_0_0React"
  ...
  s.user_target_xcconfig   = { "HEADER_SEARCH_PATHS" => "\"$(PODS_ROOT)/Headers/Private/ABI45_0_0React-Core\""}
  ...
  s.subspec "DevSupport" do |ss|
    ...
    ss.dependency "ABI45_0_0React-Core/Default", version
    ss.dependency "ABI45_0_0React-Core/RCTWebSocket", version
    ss.dependency "ABI45_0_0React-jsinspector", version
  end
  ...
  header_subspecs.each do |name, headers|
    s.subspec name do |ss|
      ...
      ss.dependency "ABI45_0_0React-Core/Default"
    end
  end

  s.dependency "RCT-Folly", folly_version
  s.dependency "ABI45_0_0React-cxxreact", version
  s.dependency "ABI45_0_0React-perflogger", version
  s.dependency "ABI45_0_0React-jsi", version
  s.dependency "ABI45_0_0React-jsiexecutor", version
  s.dependency "ABI45_0_0Yoga"
  s.dependency "glog"
end
