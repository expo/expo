...
@implementation ABI45_0_0EXScopedNotificationsUtils
...
{
  return [ABI45_0_0EXScopedNotificationsUtils shouldNotificationRequest:notification.request beHandledByExperience:scopeKey];
}

+ (NSString *)scopedIdentifierFromId:(NSString *)unscopedId forExperience:(NSString *)scopeKey
{
  NSString *scope = [ABI45_0_0EXScopedNotificationsUtils escapedString:scopeKey];
  NSString *escapedCategoryId = [ABI45_0_0EXScopedNotificationsUtils escapedString:unscopedId];
...
{
  NSString *scopeFromCategoryId = [ABI45_0_0EXScopedNotificationsUtils getScopeAndIdentifierFromScopedIdentifier:identifier].scopeKey;
...
+ (ScopedIdentifierComponents)getScopeAndIdentifierFromScopedIdentifier:(NSString *)scopedIdentifier
{
  ...
  components.scopeKey = [ABI45_0_0EXScopedNotificationsUtils unescapedString:scope];
  components.identifier = [ABI45_0_0EXScopedNotificationsUtils unescapedString:identifier];
  return components;
}
