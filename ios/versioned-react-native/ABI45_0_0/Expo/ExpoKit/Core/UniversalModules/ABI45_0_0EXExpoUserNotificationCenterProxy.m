...
@interface ABI45_0_0EXExpoUserNotificationCenterProxy ()

@property (nonatomic, weak) id<ABI45_0_0EXUserNotificationCenterProxyInterface> userNotificationCenter;

@end

@implementation ABI45_0_0EXExpoUserNotificationCenterProxy
