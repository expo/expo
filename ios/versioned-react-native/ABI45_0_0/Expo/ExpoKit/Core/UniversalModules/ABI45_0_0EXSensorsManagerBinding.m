...
@interface ABI45_0_0EXSensorsManagerBinding ()

@property (nonatomic, strong) NSString *scopeKey;
@property (nonatomic, weak) id<ABI45_0_0EXSensorsManagerBindingDelegate> kernelService;

@end

@implementation ABI45_0_0EXSensorsManagerBinding

- (instancetype)initWithScopeKey:(NSString *)scopeKey andKernelService:(id<ABI45_0_0EXSensorsManagerBindingDelegate>)kernelService
{
  if (self = [super init]) {
    _scopeKey = scopeKey;
...
+ (const NSArray<Protocol *> *)exportedInterfaces {
  return @[@protocol(ABI45_0_0EXAccelerometerInterface), @protocol(ABI45_0_0EXBarometerInterface),  @protocol(ABI45_0_0EXDeviceMotionInterface), @protocol(ABI45_0_0EXGyroscopeInterface), @protocol(ABI45_0_0EXMagnetometerInterface), @protocol(ABI45_0_0EXMagnetometerUncalibratedInterface)];
}
