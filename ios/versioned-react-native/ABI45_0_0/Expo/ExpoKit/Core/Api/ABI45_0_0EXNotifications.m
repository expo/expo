...
#import "ABI45_0_0EXNotifications.h"
...
@interface ABI45_0_0EXNotifications ()

// unversioned ABI45_0_0EXRemoteNotificationManager instance
@property (nonatomic, weak) id <ABI45_0_0EXNotificationsScopedModuleDelegate> remoteNotificationsDelegate;
@property (nonatomic, weak) id <ABI45_0_0EXNotificationsIdentifiersManager> notificationsIdentifiersManager;
@property (nonatomic, weak) id <ABI45_0_0EXUserNotificationCenterService> userNotificationCenter;

@end

@implementation ABI45_0_0EXNotifications

ABI45_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentNotifications, @"RemoteNotificationManager", @"UserNotificationManager", @"UserNotificationCenter");
...
ABI45_0_0RCT_REMAP_METHOD(getDevicePushTokenAsync,
...
{
  ABI45_0_0EXConstantsBinding *constants = [[[self.bridge moduleForClass:[ABI45_0_0EXModuleRegistryHolderReactModule class]] exModuleRegistry] getModuleImplementingProtocol:@protocol(ABI45_0_0EXConstantsInterface)];
...
ABI45_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
                 getExponentPushTokenAsyncWithResolver:(ABI45_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI45_0_0RCTPromiseRejectBlock)reject)
{
...
ABI45_0_0RCT_EXPORT_METHOD(presentLocalNotification:(NSDictionary *)payload
                  resolver:(ABI45_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI45_0_0RCTPromiseRejectBlock)reject)
{
  ...
  ABI45_0_0RCT_EXPORT_METHOD(scheduleNotificationWithTimer:(NSDictionary *)payload
...
ABI45_0_0RCT_EXPORT_METHOD(scheduleNotificationWithCalendar:(NSDictionary *)payload
                 withOptions:(NSDictionary *)options
                 resolver:(ABI45_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI45_0_0RCTPromiseRejectBlock)reject)
{
...
ABI45_0_0RCT_EXPORT_METHOD(scheduleLocalNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI45_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI45_0_0RCTPromiseRejectBlock)reject)
{
...
ABI45_0_0RCT_EXPORT_METHOD(legacyScheduleLocalRepeatingNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI45_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI45_0_0RCTPromiseRejectBlock)reject)
{
  ...
  localNotification.applicationIconBadgeNumber = [ABI45_0_0RCTConvert NSInteger:payload[@"count"]] ?: 0;
  ...
  localNotification.fireDate = [ABI45_0_0RCTConvert NSDate:options[@"time"]] ?: [NSDate new];
  localNotification.repeatInterval = [ABI45_0_0RCTConvert NSCalendarUnit:options[@"repeat"]] ?: 0;

  __weak typeof(self) weakSelf = self;
  [ABI45_0_0EXUtil performSynchronouslyOnMainThread:^{
    [ABI45_0_0RCTSharedApplication() scheduleLocalNotification:localNotification];
...
ABI45_0_0RCT_REMAP_METHOD(cancelScheduledNotificationAsync,
                 cancelScheduledNotificationAsync:(NSString *)uniqueId
                 withResolver:(ABI45_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI45_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI45_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
...
ABI45_0_0RCT_REMAP_METHOD(cancelAllScheduledNotificationsAsync,
                 cancelAllScheduledNotificationsAsyncWithResolver:(ABI45_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(__unused ABI45_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI45_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
  [_userNotificationCenter getPendingNotificationRequestsWithCompletionHandler:^(NSArray<UNNotificationRequest *> * _Nonnull requests) {
...
ABI45_0_0RCT_REMAP_METHOD(getBadgeNumberAsync,
                 getBadgeNumberAsyncWithResolver:(ABI45_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI45_0_0RCTPromiseRejectBlock)reject)
{
  __block NSInteger badgeNumber;
  [ABI45_0_0EXUtil performSynchronouslyOnMainThread:^{
    badgeNumber = ABI45_0_0RCTSharedApplication().applicationIconBadgeNumber;
  }];
  resolve(@(badgeNumber));
}

ABI45_0_0RCT_EXPORT_METHOD(setBadgeNumberAsync:(nonnull NSNumber *)number
                  resolver:(ABI45_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI45_0_0RCTPromiseRejectBlock)reject)
{
  [ABI45_0_0EXUtil performSynchronouslyOnMainThread:^{
    ABI45_0_0RCTSharedApplication().applicationIconBadgeNumber = number.integerValue;
  }];
  resolve(nil);
}
...
ABI45_0_0RCT_REMAP_METHOD(createCategoryAsync,
...
ABI45_0_0RCT_REMAP_METHOD(deleteCategoryAsync,
...
- (NSDateComponents *)dateComponentsFrom:(NSNumber * _Nullable)unixTime {
  ...
  NSDate *triggerDate = [ABI45_0_0RCTConvert NSDate:unixTime] ?: [NSDate new];
