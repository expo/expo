...
@implementation ABI45_0_0RNSVGForeignObject
...
- (void)renderGroupTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    [self traverseSubviews:^(ABI45_0_0RNSVGView *node) {
        if ([node isKindOfClass:[ABI45_0_0RNSVGMask class]] || [node isKindOfClass:[ABI45_0_0RNSVGClipPath class]]) {
            // no-op
        } else if ([node isKindOfClass:[ABI45_0_0RNSVGNode class]]) {
            ABI45_0_0RNSVGNode* svgNode = (ABI45_0_0RNSVGNode*)node;
            ...
            if ([node isKindOfClass:[ABI45_0_0RNSVGRenderable class]]) {
                [(ABI45_0_0RNSVGRenderable*)node mergeProperties:self];
            }
            ...
            if ([node isKindOfClass:[ABI45_0_0RNSVGRenderable class]]) {
                [(ABI45_0_0RNSVGRenderable*)node resetProperties];
            }
        } else if ([node isKindOfClass:[ABI45_0_0RNSVGSvgView class]]) {
            ABI45_0_0RNSVGSvgView* svgView = (ABI45_0_0RNSVGSvgView*)node;
...
- (void)setX:(ABI45_0_0RNSVGLength *)x
{
    if ([x isEqualTo:_x]) {
        return;
    }
...
- (void)setY:(ABI45_0_0RNSVGLength *)y
{
    if ([y isEqualTo:_y]) {
        return;
    }
...
- (void)setForeignObjectwidth:(ABI45_0_0RNSVGLength *)foreignObjectwidth
{
...
- (void)setForeignObjectheight:(ABI45_0_0RNSVGLength *)foreignObjectheight
{
