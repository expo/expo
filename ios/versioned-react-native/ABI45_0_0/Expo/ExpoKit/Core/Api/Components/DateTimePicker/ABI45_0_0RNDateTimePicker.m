...
@interface ABI45_0_0RNDateTimePicker ()

@property (nonatomic, copy) ABI45_0_0RCTBubblingEventBlock onChange;
@property (nonatomic, assign) NSInteger ABI45_0_0ReactMinuteInterval;

@end

@implementation ABI45_0_0RNDateTimePicker
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if ((self = [super initWithFrame:frame])) {
    ...
    _ABI45_0_0ReactMinuteInterval = 1;
  }
  return self;
}
...
- (void)setDatePickerMode:(UIDatePickerMode)datePickerMode
{
  ...
  self.minuteInterval = _ABI45_0_0ReactMinuteInterval;
}

- (void)setMinuteInterval:(NSInteger)minuteInterval
{
  [super setMinuteInterval:minuteInterval];
  _ABI45_0_0ReactMinuteInterval = minuteInterval;
}
