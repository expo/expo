//
//  ABI45_0_0RNSharedElementTransitionItem.m
//  ABI45_0_0React-native-shared-element
//

#import <Foundation/Foundation.h>
#import <UIKit/UIKit.h>
#import "ABI45_0_0RNSharedElementTransitionItem.h"
...
@implementation ABI45_0_0RNSharedElementTransitionItem {
...
- (void) setNode:(ABI45_0_0RNSharedElementNode *)node
{
  if (_node == node) {
...
- (CGRect) contentLayoutForContent:(ABI45_0_0RNSharedElementContent*)content
{
  ...
  return [ABI45_0_0RNSharedElementContent layoutForRect:_style.layout content:content contentMode:_style.contentMode reverse:NO];
}
