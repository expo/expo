...
@implementation ABI45_0_0RCTConvert (AirMap)
...
{
    json = [self NSDictionary:json];
    return [ABI45_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:nil];
}
...
ABI45_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI45_0_0AIRMapCoordinate *)ABI45_0_0AIRMapCoordinate:(id)json
{
    ABI45_0_0AIRMapCoordinate *coord = [ABI45_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI45_0_0RCT_ARRAY_CONVERTER(ABI45_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI45_0_0AIRMapCoordinate *> *> *)ABI45_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI45_0_0RCTConvertArrayValue(@selector(ABI45_0_0AIRMapCoordinateArray:), json);
}
