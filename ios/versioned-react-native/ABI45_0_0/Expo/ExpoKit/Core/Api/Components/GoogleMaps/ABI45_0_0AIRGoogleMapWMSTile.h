//
//  ABI45_0_0AIRGoogleMapWMSTile.h
//  AirMaps
//
...
@interface ABI45_0_0WMSTileOverlay : GMSSyncTileLayer
...
@interface ABI45_0_0AIRGoogleMapWMSTile : UIView
@property (nonatomic, strong) ABI45_0_0WMSTileOverlay *tileLayer;
