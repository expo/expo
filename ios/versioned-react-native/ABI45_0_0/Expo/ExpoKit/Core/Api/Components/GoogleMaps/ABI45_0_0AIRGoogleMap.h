...
@interface ABI45_0_0AIRGoogleMap : GMSMapView
...
@property (nonatomic, copy) ABI45_0_0RCTBubblingEventBlock onMapReady;
@property (nonatomic, copy) ABI45_0_0RCTBubblingEventBlock onMapLoaded;
@property (nonatomic, copy) ABI45_0_0RCTBubblingEventBlock onKmlReady;
@property (nonatomic, copy) ABI45_0_0RCTBubblingEventBlock onPress;
@property (nonatomic, copy) ABI45_0_0RCTBubblingEventBlock onLongPress;
@property (nonatomic, copy) ABI45_0_0RCTBubblingEventBlock onPanDrag;
@property (nonatomic, copy) ABI45_0_0RCTBubblingEventBlock onUserLocationChange;
@property (nonatomic, copy) ABI45_0_0RCTBubblingEventBlock onMarkerPress;
@property (nonatomic, copy) ABI45_0_0RCTBubblingEventBlock onChange;
@property (nonatomic, copy) ABI45_0_0RCTBubblingEventBlock onPoiClick;
@property (nonatomic, copy) ABI45_0_0RCTDirectEventBlock onRegionChange;
@property (nonatomic, copy) ABI45_0_0RCTDirectEventBlock onRegionChangeComplete;
@property (nonatomic, copy) ABI45_0_0RCTDirectEventBlock onIndoorLevelActivated;
@property (nonatomic, copy) ABI45_0_0RCTDirectEventBlock onIndoorBuildingFocused;
