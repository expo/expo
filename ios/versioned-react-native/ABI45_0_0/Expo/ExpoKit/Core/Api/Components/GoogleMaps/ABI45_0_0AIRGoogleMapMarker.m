...
@interface ABI45_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI45_0_0AIRGMSMarker*)marker;
@end

@implementation ABI45_0_0AIRGoogleMapMarker {
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI45_0_0AIRGMSMarker alloc] init];
...
- (void)insertABI45_0_0ReactSubview:(id<ABI45_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI45_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI45_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI45_0_0AIRDummyView *dummySubview = [[ABI45_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertABI45_0_0ReactSubview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeABI45_0_0ReactSubview:(id<ABI45_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI45_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeABI45_0_0ReactSubview:(UIView*)dummySubview];
}
...
- (void)setOnPress:(ABI45_0_0RCTBubblingEventBlock)onPress {
  _realMarker.onPress = onPress;
}

- (ABI45_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/ABI45_0_0React-native-maps/ABI45_0_0React-native-maps/issues/738)
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI45_0_0RN?
...
- (void)setIconSrc:(NSString *)iconSrc
{
  ...
  _reloadImageCancellationBlock =
  [[_bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI45_0_0RCTConvert NSURLRequest:_iconSrc]
                                          size:self.bounds.size
                                         scale:ABI45_0_0RCTScreenScale()
                                       clipped:YES
                                    resizeMode:ABI45_0_0RCTResizeModeCenter
