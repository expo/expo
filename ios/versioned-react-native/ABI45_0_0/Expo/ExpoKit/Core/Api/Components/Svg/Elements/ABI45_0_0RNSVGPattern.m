...
#import "ABI45_0_0RNSVGBrushType.h"
#import "ABI45_0_0RNSVGNode.h"

@implementation ABI45_0_0RNSVGPattern
...
{
    self.dirty = false;
    NSArray<ABI45_0_0RNSVGLength *> *points = @[self.x, self.y, self.patternwidth, self.patternheight];
    ABI45_0_0RNSVGPainter *painter = [[ABI45_0_0RNSVGPainter alloc] initWithPointsArray:points];
...
- (void)setPatternwidth:(ABI45_0_0RNSVGLength *)patternwidth
{
...
- (void)setPatternheight:(ABI45_0_0RNSVGLength *)patternheight
{
...
- (void)setPatternUnits:(ABI45_0_0RNSVGUnits)patternUnits
{
...
- (void)setPatternContentUnits:(ABI45_0_0RNSVGUnits)patternContentUnits
{
