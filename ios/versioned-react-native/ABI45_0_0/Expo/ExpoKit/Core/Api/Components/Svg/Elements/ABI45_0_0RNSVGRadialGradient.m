...
@implementation ABI45_0_0RNSVGRadialGradient
...
- (void)setFx:(ABI45_0_0RNSVGLength *)fx
{
    if ([fx isEqualTo:_fx]) {
        return;
    }
...
- (void)setFy:(ABI45_0_0RNSVGLength *)fy
{
    if ([fy isEqualTo:_fy]) {
        return;
    }
...
- (void)setGradientUnits:(ABI45_0_0RNSVGUnits)gradientUnits
{
...
{
    self.dirty = false;
    NSArray<ABI45_0_0RNSVGLength *> *points = @[self.fx, self.fy, self.rx, self.ry, self.cx, self.cy];
