...
@implementation ABI45_0_0RNSVGEllipse

- (void)setCx:(ABI45_0_0RNSVGLength *)cx
{
    if ([cx isEqualTo:_cx]) {
        return;
    }
...
- (void)setCy:(ABI45_0_0RNSVGLength *)cy
{
    if ([cy isEqualTo:_cy]) {
        return;
    }
...
- (void)setRx:(ABI45_0_0RNSVGLength *)rx
{
    if ([rx isEqualTo:_rx]) {
        return;
    }
...
- (void)setRy:(ABI45_0_0RNSVGLength *)ry
{
    if ([ry isEqualTo:_ry]) {
        return;
    }
