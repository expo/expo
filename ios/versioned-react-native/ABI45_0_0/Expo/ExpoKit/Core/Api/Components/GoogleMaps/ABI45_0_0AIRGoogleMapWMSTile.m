//
//  ABI45_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI45_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI45_0_0WMSTileOverlay *tile = [[ABI45_0_0WMSTileOverlay alloc] init];
...
@implementation ABI45_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
