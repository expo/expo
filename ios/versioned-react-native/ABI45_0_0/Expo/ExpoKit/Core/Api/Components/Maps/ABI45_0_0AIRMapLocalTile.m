...
#import "ABI45_0_0AIRMapLocalTileOverlay.h"

@implementation ABI45_0_0AIRMapLocalTile {
...
- (void) createTileOverlayAndRendererIfPossible
{
    ...
    self.tileOverlay = [[ABI45_0_0AIRMapLocalTileOverlay alloc] initWithURLTemplate:self.pathTemplate];
