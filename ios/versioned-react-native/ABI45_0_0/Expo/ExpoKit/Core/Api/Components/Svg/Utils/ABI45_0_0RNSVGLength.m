...
@implementation ABI45_0_0RNSVGLength
...
{
    ABI45_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype) lengthWithString: (NSString *) lengthString {
    ...
    ABI45_0_0RNSVGLength *output = [ABI45_0_0RNSVGLength alloc];
    if (stringLength == 0) {
        ...
        ABI45_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
