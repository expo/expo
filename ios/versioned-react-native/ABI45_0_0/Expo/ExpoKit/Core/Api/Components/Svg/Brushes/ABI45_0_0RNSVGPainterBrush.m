...
@implementation ABI45_0_0RNSVGPainterBrush

- (instancetype)initWithArray:(NSArray *)array
{
    if ((self = [super initWithArray:array])) {
        if (array.count != 2) {
            ABI45_0_0RCTLogError(@"-[%@ %@] expects 2 elements, received %@",
...
- (void)paint:(CGContextRef)context opacity:(CGFloat)opacity painter:(ABI45_0_0RNSVGPainter *)painter bounds:(CGRect)bounds
{
