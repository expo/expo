...
#if __has_include(<ABI45_0_0React/ABI45_0_0RCTImageLoader.h>)
...
@implementation ABI45_0_0RNSVGImage
{
    CGImageRef _image;
    CGSize _imageSize;
...
- (void)setSrc:(id)src
{
    ...
    _image = nil;
    ABI45_0_0RCTImageSource *source = [ABI45_0_0RCTConvert ABI45_0_0RCTImageSource:src];
    ...
    ABI45_0_0RCTImageLoaderCancellationBlock previousCancellationBlock = _reloadImageCancellationBlock;
    if (previousCancellationBlock) {
        previousCancellationBlock();
        _reloadImageCancellationBlock = nil;
    }

    _reloadImageCancellationBlock = [[self.bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI45_0_0RCTConvert NSURLRequest:src] callback:^(NSError *error, UIImage *image) {
...
- (void)setImagewidth:(ABI45_0_0RNSVGLength *)width
{
...
- (void)setImageheight:(ABI45_0_0RNSVGLength *)height
{
...
- (void)setMeetOrSlice:(ABI45_0_0RNSVGVBMOS)meetOrSlice
{
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    CGAffineTransform viewbox = [ABI45_0_0RNSVGViewBox getTransform:imageBounds eRect:hitArea align:self.align meetOrSlice:self.meetOrSlice];
