...
@interface ABI45_0_0RNSVGUse : ABI45_0_0RNSVGRenderable

@property (nonatomic, strong) NSString *href;
@property (nonatomic, strong) ABI45_0_0RNSVGLength *x;
@property (nonatomic, strong) ABI45_0_0RNSVGLength *y;
@property (nonatomic, strong) ABI45_0_0RNSVGLength *usewidth;
@property (nonatomic, strong) ABI45_0_0RNSVGLength *useheight;
@end
