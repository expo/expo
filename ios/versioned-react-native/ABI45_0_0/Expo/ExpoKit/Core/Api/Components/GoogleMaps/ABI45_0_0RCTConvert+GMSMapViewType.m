//
//  ABI45_0_0RCTConvert+GMSMapViewType.m
//
...
@implementation ABI45_0_0RCTConvert (GMSMapViewType)
  ABI45_0_0RCT_ENUM_CONVERTER(GMSMapViewType,
  (
    @{
...
+ (GMSCameraPosition*)GMSCameraPosition:(id)json
{
    ...
    return [ABI45_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:nil];
}
