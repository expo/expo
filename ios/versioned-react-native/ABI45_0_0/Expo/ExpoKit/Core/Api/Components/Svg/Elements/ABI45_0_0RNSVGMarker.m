...
@implementation ABI45_0_0RNSVGMarker
...
- (void)setX:(ABI45_0_0RNSVGLength *)refX
{
...
- (void)setY:(ABI45_0_0RNSVGLength *)refY
{
...
- (void)setMarkerWidth:(ABI45_0_0RNSVGLength *)markerWidth
{
...
- (void)setMarkerHeight:(ABI45_0_0RNSVGLength *)markerHeight
{
...
static CGFloat ABI45_0_0RNSVG_degToRad = (CGFloat)M_PI / 180;

double ABI45_0_0deg2rad(CGFloat deg) {
    return deg * ABI45_0_0RNSVG_degToRad;
}

- (void)renderMarker:(CGContextRef)context rect:(CGRect)rect position:(ABI45_0_0RNSVGMarkerPosition*)position strokeWidth:(CGFloat)strokeWidth
{
    ...
    float rad = ABI45_0_0deg2rad(angle);
