...
#import "ABI26_0_0RCTReconnectingWebSocket.h"
...
@interface ABI26_0_0RCTReconnectingWebSocket () <ABI26_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI26_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  __weak ABI26_0_0RCTSRWebSocket *socket = _socket;
