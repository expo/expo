...
#import "ABI26_0_0RCTGIFImageDecoder.h"
...
@implementation ABI26_0_0RCTGIFImageDecoder
...
- (ABI26_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                 ...
                                 completionHandler:(ABI26_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (imageCount > 1) {
    ...
    image.ReactABI26_0_0KeyframeAnimation = animation;
