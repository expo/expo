...
typedef void (^ABI26_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI26_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI26_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI26_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI26_0_0RCTImageCache <NSObject>
...
/**
 * If available, ABI26_0_0RCTImageRedirectProtocol is invoked before loading an asset.
 * Implementation should return either a new URL or nil when redirection is
 * not needed.
 */

@protocol ABI26_0_0RCTImageRedirectProtocol

- (NSURL *)redirectAssetsURL:(NSURL *)URL;

@end

@interface UIImage (ReactABI26_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI26_0_0KeyframeAnimation;

@end

@interface ABI26_0_0RCTImageLoader : NSObject <ABI26_0_0RCTBridgeModule, ABI26_0_0RCTURLRequestHandler>
...
- (instancetype)init;
- (instancetype)initWithRedirectDelegate:(id<ABI26_0_0RCTImageRedirectProtocol>)redirectDelegate NS_DESIGNATED_INITIALIZER;
 ...
 * decoded images as long as it conforms to the ABI26_0_0RCTImageCacheDelegate
...
@interface ABI26_0_0RCTBridge (ABI26_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI26_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI26_0_0RCTImageURLLoader <ABI26_0_0RCTBridgeModule>
...
/**
 * If more than one ABI26_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI26_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 */
@protocol ABI26_0_0RCTImageDataDecoder <ABI26_0_0RCTBridgeModule>
...
/**
 * If more than one ABI26_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
