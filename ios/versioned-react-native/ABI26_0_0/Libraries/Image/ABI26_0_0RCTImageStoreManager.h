...
@interface ABI26_0_0RCTImageStoreManager : NSObject <ABI26_0_0RCTURLRequestHandler>
...
@interface ABI26_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI26_0_0RCTBridge (ABI26_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI26_0_0RCTImageStoreManager *imageStoreManager;
