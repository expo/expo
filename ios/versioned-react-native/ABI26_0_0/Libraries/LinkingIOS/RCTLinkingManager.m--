...
#import "ABI26_0_0RCTLinkingManager.h"
...
static NSString *const kOpenURLNotification = @"ABI26_0_0RCTOpenURLNotification";
...
@implementation ABI26_0_0RCTLinkingManager
                  ...
                  reject:(__unused ABI26_0_0RCTPromiseRejectBlock)reject)
{
  ...
  BOOL canOpen = [ABI26_0_0RCTSharedApplication() canOpenURL:URL];
  resolve(@(canOpen));
}
                  ...
                  reject:(__unused ABI26_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve(ABI26_0_0RCTNullIfNil(initialURL.absoluteString));
}
