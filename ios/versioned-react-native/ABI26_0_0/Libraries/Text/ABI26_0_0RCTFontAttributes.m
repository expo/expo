...
@interface ABI26_0_0RCTFontAttributes ()
{
  ABI26_0_0RCTAccessibilityManager *_accessibilityManager;
}
...
@implementation ABI26_0_0RCTFontAttributes

- (instancetype)initWithAccessibilityManager:(ABI26_0_0RCTAccessibilityManager *)accessibilityManager
{
  ABI26_0_0RCTAssertParam(accessibilityManager);
...
- (void)updateFont
{
  ...
  self.font = [ABI26_0_0RCTFont updateFont:nil
