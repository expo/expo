...
NSString *const ABI26_0_0RCTTextAttributesIsHighlightedAttributeName = @"ABI26_0_0RCTTextAttributesIsHighlightedAttributeName";
NSString *const ABI26_0_0RCTTextAttributesTagAttributeName = @"ABI26_0_0RCTTextAttributesTagAttributeName";

@implementation ABI26_0_0RCTTextAttributes
...
- (void)applyTextAttributes:(ABI26_0_0RCTTextAttributes *)textAttributes
{
  ...
  _textDecorationLine = textAttributes->_textDecorationLine != ABI26_0_0RCTTextDecorationLineTypeNone ? textAttributes->_textDecorationLine : _textDecorationLine; // *
...
- (NSDictionary<NSAttributedStringKey, id> *)effectiveTextAttributes
{
  ...
  // Special
  if (_isHighlighted) {
    attributes[ABI26_0_0RCTTextAttributesIsHighlightedAttributeName] = @YES;
  }

  if (_tag) {
    attributes[ABI26_0_0RCTTextAttributesTagAttributeName] = _tag;
  }
...
{
  // FIXME: ABI26_0_0RCTFont has thread-safety issues and must be rewritten.
  return [ABI26_0_0RCTFont updateFont:nil
...
- (ABI26_0_0RCTTextAttributes *)copyWithZone:(NSZone *)zone
{
  ABI26_0_0RCTTextAttributes *textAttributes = [ABI26_0_0RCTTextAttributes new];
...
- (BOOL)isEqual:(ABI26_0_0RCTTextAttributes *)textAttributes
{
  if (self == textAttributes) {
    return YES;
  }

#define ABI26_0_0RCTTextAttributesCompareFloats(a) ((a == textAttributes->a) || (isnan(a) && isnan(textAttributes->a)))
#define ABI26_0_0RCTTextAttributesCompareSize(a) CGSizeEqualToSize(a, textAttributes->a)
#define ABI26_0_0RCTTextAttributesCompareObjects(a) ((a == textAttributes->a) || [a isEqual:textAttributes->a])
#define ABI26_0_0RCTTextAttributesCompareStrings(a) ((a == textAttributes->a) || [a isEqualToString:textAttributes->a])
#define ABI26_0_0RCTTextAttributesCompareOthers(a) (a == textAttributes->a)

  return
    ABI26_0_0RCTTextAttributesCompareObjects(_foregroundColor) &&
    ABI26_0_0RCTTextAttributesCompareObjects(_backgroundColor) &&
    ABI26_0_0RCTTextAttributesCompareFloats(_opacity) &&
    // Font
    ABI26_0_0RCTTextAttributesCompareObjects(_fontFamily) &&
    ABI26_0_0RCTTextAttributesCompareFloats(_fontSize) &&
    ABI26_0_0RCTTextAttributesCompareFloats(_fontSizeMultiplier) &&
    ABI26_0_0RCTTextAttributesCompareStrings(_fontWeight) &&
    ABI26_0_0RCTTextAttributesCompareObjects(_fontStyle) &&
    ABI26_0_0RCTTextAttributesCompareObjects(_fontVariant) &&
    ABI26_0_0RCTTextAttributesCompareOthers(_allowFontScaling) &&
    ABI26_0_0RCTTextAttributesCompareFloats(_letterSpacing) &&
    // Paragraph Styles
    ABI26_0_0RCTTextAttributesCompareFloats(_lineHeight) &&
    ABI26_0_0RCTTextAttributesCompareFloats(_alignment) &&
    ABI26_0_0RCTTextAttributesCompareOthers(_baseWritingDirection) &&
    // Decoration
    ABI26_0_0RCTTextAttributesCompareObjects(_textDecorationColor) &&
    ABI26_0_0RCTTextAttributesCompareOthers(_textDecorationStyle) &&
    ABI26_0_0RCTTextAttributesCompareOthers(_textDecorationLine) &&
    // Shadow
    ABI26_0_0RCTTextAttributesCompareSize(_textShadowOffset) &&
    ABI26_0_0RCTTextAttributesCompareFloats(_textShadowRadius) &&
    ABI26_0_0RCTTextAttributesCompareObjects(_textShadowColor) &&
    // Special
    ABI26_0_0RCTTextAttributesCompareOthers(_isHighlighted) &&
    ABI26_0_0RCTTextAttributesCompareObjects(_tag) &&
    ABI26_0_0RCTTextAttributesCompareOthers(_layoutDirection);
}
