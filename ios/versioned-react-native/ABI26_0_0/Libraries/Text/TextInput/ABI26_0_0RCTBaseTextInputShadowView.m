...
@implementation ABI26_0_0RCTBaseTextInputShadowView
{
...
- (instancetype)initWithBridge:(ABI26_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI26_0_0YGNodeSetMeasureFunc(self.yogaNode, ABI26_0_0RCTBaseTextInputShadowViewMeasure);
  }
...
- (void)uiManagerWillPerformMounting
{
  ...
  ABI26_0_0RCTTextAttributes *textAttributes = [self.textAttributes copy];
  ...
  [attributedText removeAttribute:ABI26_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                            range:NSMakeRange(0, attributedText.length)];

  [attributedText removeAttribute:ABI26_0_0RCTTextAttributesTagAttributeName
                            range:NSMakeRange(0, attributedText.length)];
  ...
  [_bridge.uiManager addUIBlock:^(ABI26_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI26_0_0RCTBaseTextInputView *baseTextInputView = (ABI26_0_0RCTBaseTextInputView *)viewRegistry[tag];
    if (!baseTextInputView) {
      return;
    }

    baseTextInputView.textAttributes = textAttributes;
    baseTextInputView.ReactABI26_0_0BorderInsets = borderInsets;
    baseTextInputView.ReactABI26_0_0PaddingInsets = paddingInsets;
...
- (CGSize)sizeThatFitsMinimumSize:(CGSize)minimumSize maximumSize:(CGSize)maximumSize
{
  ...
  return (CGSize){
    MAX(minimumSize.width, MIN(ABI26_0_0RCTCeilPixelValue(size.width), maximumSize.width)),
    MAX(minimumSize.height, MIN(ABI26_0_0RCTCeilPixelValue(size.height), maximumSize.height))
  };
}

static ABI26_0_0YGSize ABI26_0_0RCTBaseTextInputShadowViewMeasure(ABI26_0_0YGNodeRef node, float width, ABI26_0_0YGMeasureMode widthMode, float height, ABI26_0_0YGMeasureMode heightMode)
{
  ...
  CGSize size = {
    ABI26_0_0RCTCoreGraphicsFloatFromYogaFloat(width),
    ABI26_0_0RCTCoreGraphicsFloatFromYogaFloat(height)
  };
  ...
  return (ABI26_0_0YGSize){
    ABI26_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.width),
    ABI26_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.height)
  };
}
