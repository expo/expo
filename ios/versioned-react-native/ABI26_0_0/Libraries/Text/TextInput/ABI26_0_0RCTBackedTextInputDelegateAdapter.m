...
#import "ABI26_0_0RCTBackedTextInputDelegateAdapter.h"
...
@interface ABI26_0_0RCTBackedTextFieldDelegateAdapter () <UITextFieldDelegate>
@end

@implementation ABI26_0_0RCTBackedTextFieldDelegateAdapter {
  __weak UITextField<ABI26_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
...
@interface ABI26_0_0RCTBackedTextViewDelegateAdapter () <UITextViewDelegate>
@end

@implementation ABI26_0_0RCTBackedTextViewDelegateAdapter {
  __weak UITextView<ABI26_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
  BOOL _textDidChangeIsComing;
  UITextRange *_previousSelectedTextRange;
}
