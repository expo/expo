...
@implementation ABI26_0_0RCTUITextView
{
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI26_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI26_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
  }
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI26_0_0RCTCeilPixelValue(placeholderSize.width), ABI26_0_0RCTCeilPixelValue(placeholderSize.height));
