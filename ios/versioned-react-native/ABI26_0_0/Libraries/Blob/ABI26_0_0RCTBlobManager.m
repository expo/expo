...
@interface _ABI26_0_0RCTBlobContentHandler : NSObject <ABI26_0_0RCTWebSocketContentHandler>

- (instancetype)initWithBlobManager:(ABI26_0_0RCTBlobManager *)blobManager;
...
@implementation ABI26_0_0RCTBlobManager
{
  ...
  _ABI26_0_0RCTBlobContentHandler *_contentHandler;
...
ABI26_0_0RCT_EXPORT_METHOD(enableBlobSupport:(nonnull NSNumber *)socketID)
{
  if (!_contentHandler) {
    _contentHandler = [[_ABI26_0_0RCTBlobContentHandler alloc] initWithBlobManager:self];
  }
  [[_bridge webSocketModule] setContentHandler:_contentHandler forSocketID:socketID];
}

ABI26_0_0RCT_EXPORT_METHOD(disableBlobSupport:(nonnull NSNumber *)socketID)
{
  [[_bridge webSocketModule] setContentHandler:nil forSocketID:socketID];
}

ABI26_0_0RCT_EXPORT_METHOD(sendBlob:(NSDictionary *)blob socketID:(nonnull NSNumber *)socketID)
{
...
@implementation _ABI26_0_0RCTBlobContentHandler {
  __weak ABI26_0_0RCTBlobManager *_blobManager;
}
