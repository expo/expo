...
@implementation ABI26_0_0RCTInterpolationAnimatedNode
{
  __weak ABI26_0_0RCTValueAnimatedNode *_parentNode;
...
- (void)onAttachedToNode:(ABI26_0_0RCTAnimatedNode *)parent
{
  [super onAttachedToNode:parent];
  if ([parent isKindOfClass:[ABI26_0_0RCTValueAnimatedNode class]]) {
    _parentNode = (ABI26_0_0RCTValueAnimatedNode *)parent;
  }
}

- (void)onDetachedFromNode:(ABI26_0_0RCTAnimatedNode *)parent
{
...
- (void)performUpdate
{
  ...
  self.value = ABI26_0_0RCTInterpolateValueInRange(inputValue,
                                          _inputRange,
                                          _outputRange,
                                          _extrapolateLeft,
                                          _extrapolateRight);
