...
@interface ABI26_0_0RCTAnimatedNode : NSObject
...
@property (nonatomic, copy, readonly) NSMapTable<NSNumber *, ABI26_0_0RCTAnimatedNode *> *childNodes;
@property (nonatomic, copy, readonly) NSMapTable<NSNumber *, ABI26_0_0RCTAnimatedNode *> *parentNodes;
...
- (void)addChild:(ABI26_0_0RCTAnimatedNode *)child NS_REQUIRES_SUPER;
- (void)removeChild:(ABI26_0_0RCTAnimatedNode *)child NS_REQUIRES_SUPER;

- (void)onAttachedToNode:(ABI26_0_0RCTAnimatedNode *)parent NS_REQUIRES_SUPER;
- (void)onDetachedFromNode:(ABI26_0_0RCTAnimatedNode *)parent NS_REQUIRES_SUPER;
