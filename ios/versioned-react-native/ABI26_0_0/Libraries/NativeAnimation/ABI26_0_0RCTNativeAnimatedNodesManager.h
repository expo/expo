...
#import <ABI26_0_0RCTAnimation/ABI26_0_0RCTValueAnimatedNode.h>
#import <ReactABI26_0_0/ABI26_0_0RCTBridgeModule.h>
#import <ReactABI26_0_0/ABI26_0_0RCTUIManager.h>

@interface ABI26_0_0RCTNativeAnimatedNodesManager : NSObject
...
- (void)startAnimatingNode:(nonnull NSNumber *)animationId
                   nodeTag:(nonnull NSNumber *)nodeTag
                    config:(NSDictionary<NSString *, id> *__nonnull)config
               endCallback:(nullable ABI26_0_0RCTResponseSenderBlock)callBack;
...
- (void)handleAnimatedEvent:(nonnull id<ABI26_0_0RCTEvent>)event;

// listeners

- (void)startListeningToAnimatedNodeValue:(nonnull NSNumber *)tag
                            valueObserver:(nonnull id<ABI26_0_0RCTValueAnimatedNodeObserver>)valueObserver;
