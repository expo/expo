...
@interface ABI26_0_0RCTSpringAnimation ()

@property (nonatomic, strong) NSNumber *animationId;
@property (nonatomic, strong) ABI26_0_0RCTValueAnimatedNode *valueNode;
...
@implementation ABI26_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
  ...
  ABI26_0_0RCTResponseSenderBlock _callback;
...
{
  if ((self = [super init])) {
    NSNumber *iterations = [ABI26_0_0RCTConvert NSNumber:config[@"iterations"]] ?: @1;

    _animationId = animationId;
    _toValue = [ABI26_0_0RCTConvert CGFloat:config[@"toValue"]];
    _fromValue = valueNode.value;
    _lastPosition = 0;
    _valueNode = valueNode;
    _overshootClamping = [ABI26_0_0RCTConvert BOOL:config[@"overshootClamping"]];
    _restDisplacementThreshold = [ABI26_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
    _restSpeedThreshold = [ABI26_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
    _stiffness = [ABI26_0_0RCTConvert CGFloat:config[@"stiffness"]];
    _damping = [ABI26_0_0RCTConvert CGFloat:config[@"damping"]];
    _mass = [ABI26_0_0RCTConvert CGFloat:config[@"mass"]];
    _initialVelocity = [ABI26_0_0RCTConvert CGFloat:config[@"initialVelocity"]];
