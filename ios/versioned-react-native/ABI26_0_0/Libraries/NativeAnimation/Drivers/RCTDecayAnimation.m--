...
@interface ABI26_0_0RCTDecayAnimation ()
...
@implementation ABI26_0_0RCTDecayAnimation
{
  CGFloat _velocity;
                  ...
                  callBack:(nullable ABI26_0_0RCTResponseSenderBlock)callback;
{
  if ((self = [super init])) {
    ...
    _velocity = [ABI26_0_0RCTConvert CGFloat:config[@"velocity"]];
    _deceleration = [ABI26_0_0RCTConvert CGFloat:config[@"deceleration"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  if (_frameStartTime == -1) {
    ...
    _frameStartTime = currentTime - ABI26_0_0RCTSingleFrameInterval;
