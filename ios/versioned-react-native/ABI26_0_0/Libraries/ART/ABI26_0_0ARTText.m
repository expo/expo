...
@implementation ABI26_0_0ARTText
...
static void ABI26_0_0ARTFreeTextFrame(ABI26_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI26_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI26_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI26_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI26_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
