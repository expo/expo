...
typedef NS_ENUM(NSInteger, ABI26_0_0RCTTestStatus) {
  ABI26_0_0RCTTestStatusPending = 0,
  ABI26_0_0RCTTestStatusPassed,
  ABI26_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI26_0_0RCTTestModule : NSObject <ABI26_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI26_0_0RCTTestStatus status;
