...
#import "ABI26_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI26_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI26_0_0ViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ReactABI26_0_0ViewController detachChildViewController:self.contentViewController];
}
