...
@implementation ABI26_0_0RCTSurfaceHostingComponent

+ (Class<CKComponentControllerProtocol>)controllerClass
{
  return [ABI26_0_0RCTSurfaceHostingComponentController class];
}

+ (id)initialState
{
  return [ABI26_0_0RCTSurfaceHostingComponentState new];
}
...
+ (instancetype)newWithSurface:(ABI26_0_0RCTSurface *)surface options:(ABI26_0_0RCTSurfaceHostingComponentOptions)options
{
  ...
  ABI26_0_0RCTSurfaceHostingComponentState *const state = scope.state();

  ABI26_0_0RCTSurfaceHostingComponentState *const newState =
    [ABI26_0_0RCTSurfaceHostingComponentState newWithStage:surface.stage
  ...
  ABI26_0_0RCTSurfaceHostingComponent *const component =
...
- (CKComponentLayout)computeLayoutThatFits:(CKSizeRange)constrainedSize
{
  ...
  // just to provide layout constraints to ReactABI26_0_0 Native as early as possible.
  // ReactABI26_0_0 Native *may* use this info later during applying the own state and
  ...
  // interop compatibilities of ReactABI26_0_0 Native which will enable us granularly
  // control ReactABI26_0_0 Native mounting blocks and, as a result, implement
  // truly synchronous mounting stage between ReactABI26_0_0 Native and ComponentKit.
  [_surface setMinimumSize:constrainedSize.min
               maximumSize:constrainedSize.max];

  // Just in case of the very first building pass, we give ReactABI26_0_0 Native a chance
  // to prepare its internals for coming synchronous measuring.
  [_surface synchronouslyWaitForStage:ABI26_0_0RCTSurfaceStageSurfaceDidInitialLayout
                              timeout:_options.synchronousLayoutingTimeout];

  CGSize fittingSize = CGSizeZero;
  if (_surface.stage & ABI26_0_0RCTSurfaceStageSurfaceDidInitialLayout) {
...
- (CKComponentBoundsAnimation)boundsAnimationFromPreviousComponent:(ABI26_0_0RCTSurfaceHostingComponent *)previousComponent
{
