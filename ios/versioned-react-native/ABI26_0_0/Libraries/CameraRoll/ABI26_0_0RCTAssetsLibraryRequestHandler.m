...
@implementation ABI26_0_0RCTAssetsLibraryRequestHandler
{
...
#pragma mark - ABI26_0_0RCTURLRequestHandler
     ...
     withDelegate:(id<ABI26_0_0RCTURLRequestDelegate>)delegate
{
  ...
  [[self assetsLibrary] assetForURL:request.URL resultBlock:^(ALAsset *asset) {
    ...
    if (asset) {
      ...
      NSError *error = ABI26_0_0RCTErrorWithMessage(errorMessage);
      [delegate URLRequest:cancellationBlock didCompleteWithError:error];
    }
...
@implementation ABI26_0_0RCTBridge (ABI26_0_0RCTAssetsLibraryImageLoader)

- (ALAssetsLibrary *)assetsLibrary
{
  return [[self moduleForClass:[ABI26_0_0RCTAssetsLibraryRequestHandler class]] assetsLibrary];
}
