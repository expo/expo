...
#import "ABI26_0_0RCTPhotoLibraryImageLoader.h"

#import <Photos/Photos.h>

#import <ReactABI26_0_0/ABI26_0_0RCTUtils.h>

@implementation ABI26_0_0RCTPhotoLibraryImageLoader

ABI26_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI26_0_0RCTImageLoader
...
- (ABI26_0_0RCTImageLoaderCancellationBlock)loadImageForURL:(NSURL *)imageURL
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                        resizeMode:(ABI26_0_0RCTResizeMode)resizeMode
                                   progressHandler:(ABI26_0_0RCTImageLoaderProgressBlock)progressHandler
                                partialLoadHandler:(ABI26_0_0RCTImageLoaderPartialLoadBlock)partialLoadHandler
                                 completionHandler:(ABI26_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (!imageURL) {
    completionHandler(ABI26_0_0RCTErrorWithMessage(@"Cannot load a photo library asset with no URL"), nil);
    return ^{};
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI26_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI26_0_0RCTResizeModeContain) {
