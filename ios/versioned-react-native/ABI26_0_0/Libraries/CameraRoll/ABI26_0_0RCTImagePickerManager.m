...
#import "ABI26_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI26_0_0/ABI26_0_0RCTConvert.h>
#import <ReactABI26_0_0/ABI26_0_0RCTImageStoreManager.h>
#import <ReactABI26_0_0/ABI26_0_0RCTRootView.h>
#import <ReactABI26_0_0/ABI26_0_0RCTUtils.h>

@interface ABI26_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI26_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI26_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI26_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI26_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI26_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI26_0_0RCTResponseSenderBlock)callback)
{
...
ABI26_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI26_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI26_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI26_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI26_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI26_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI26_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI26_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI26_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI26_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI26_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI26_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI26_0_0RCTNullIfNil(height), ABI26_0_0RCTNullIfNil(width)]];
    return;
  }
        ...
        cancelCallback:(ABI26_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI26_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI26_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI26_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
