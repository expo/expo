...
@interface ABI26_0_0EXGLARSessionManager ()
{
...
- (NSDictionary *)startARSessionWithGLView:(ABI26_0_0EXGLView *)glView
{
  ...
  [_glView runOnGLThreadAsync:^{
    ...
    // Create camera texture output ABI26_0_0EXGLObject
...
- (NSDictionary *)arMatricesForViewportSize:(CGSize)viewportSize zNear:(CGFloat)zNear zFar:(CGFloat)zFar
{
  ...
  return @{
    @"transform": [ABI26_0_0EXGLARSessionManager nsArrayForMatrix:transform],
    @"viewMatrix": [ABI26_0_0EXGLARSessionManager nsArrayForMatrix:viewMat],
    @"projectionMatrix": [ABI26_0_0EXGLARSessionManager nsArrayForMatrix:projMat],
  };
}
  ...
  for (int i = 0; i < anchors.count; i++) {
    if ([anchors[i] isKindOfClass:[ARPlaneAnchor class]]){
      ...
      [planes addObject:@{
                          ...
                          @"transform": [ABI26_0_0EXGLARSessionManager nsArrayForMatrix: planeAnchor.transform]
                          }];
    }
  }
