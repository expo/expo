//
//  ABI26_0_0EXFaceDetectorManager.m
//  Exponent
//
...
#import "ABI26_0_0EXFaceEncoder.h"
#import "ABI26_0_0EXFaceDetectorUtils.h"
#import "ABI26_0_0EXFaceDetectorModule.h"
#import "ABI26_0_0EXFaceDetectorManager.h"

@interface ABI26_0_0EXFaceDetectorManager() <GMVDataOutputDelegate>
...
@property (nonatomic, weak) id <ABI26_0_0EXFaceDetectorDelegate> delegate;
...
@implementation ABI26_0_0EXFaceDetectorManager
...
{
  return [ABI26_0_0EXFaceDetectorUtils constantsToExport];
}
...
- (void)setIsEnabled:(id)json
{
  ...
  BOOL newFaceDetecting = [ABI26_0_0RCTConvert BOOL:json];
...
- (void)tryEnablingFaceDetection
{
  ...
  if ([self isDetectingFaces]) {
    @try {
      ...
      ABI26_0_0RCTLogWarn(@"%@", [exception description]);
    }
  }
...
{
  long requestedValue = [ABI26_0_0RCTConvert NSInteger:json];
...
- (void)dataOutput:(GMVDataOutput *)dataOutput didFinishedDetection:(NSArray<__kindof GMVFeature *> *)results
{
  ...
  // width or height started happen after refactor: moving face detection logic from ABI26_0_0EXCameraManager to ABI26_0_0EXFaceDetectorManager.
  ...
  CGAffineTransform transform = [ABI26_0_0EXFaceDetectorUtils transformFromDeviceOutput:dataOutput toInterfaceVideoOrientation:interfaceVideoOrientation];
  
  ABI26_0_0EXFaceEncoder *faceEncoder = [[ABI26_0_0EXFaceEncoder alloc] initWithTransform:transform];
