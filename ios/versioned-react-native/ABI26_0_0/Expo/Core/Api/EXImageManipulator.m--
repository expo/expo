...
#import "ABI26_0_0EXImageManipulator.h"
#import "ABI26_0_0EXFileSystem.h"
#import "ABI26_0_0EXImageUtils.h"
#import <ReactABI26_0_0/ABI26_0_0RCTLog.h>

@implementation ABI26_0_0EXImageManipulator

ABI26_0_0RCT_EXPORT_MODULE(ExponentImageManipulator);
...
ABI26_0_0RCT_EXPORT_METHOD(manipulate:(NSString *)uri
                  ...
                  rejecter:(ABI26_0_0RCTPromiseRejectBlock)reject)
{
  ...
  for (NSDictionary *options in actions) {
    if (options[@"resize"]) {
      ...
      image = [ABI26_0_0EXImageUtils cropImage:image toRect:cropDimensions];
    }
  }
  ...
  if ([format isEqualToString:@"jpeg"]) {
    ...
    ABI26_0_0RCTLogWarn(@"Unsupported format: %@, using JPEG instead.", format);
    imageData = UIImageJPEGRepresentation(image, compressionValue);
    extension = @".jpg";
  }
