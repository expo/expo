...
- (NSError *)_updateAudioSessionCategoryForAudioSessionMode:(ABI26_0_0EXAVAudioSessionMode)audioSessionMode
{
  NSError *error;
...
- (NSError *)promoteAudioSessionIfNecessary
{
  ...
  if (audioSessionModeRequired == ABI26_0_0EXAVAudioSessionModeInactive) {
    return nil;
  }
...
ABI26_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentAV, @"AudioSessionManager", @"PermissionsManager");
...
ABI26_0_0RCT_EXPORT_METHOD(prepareAudioRecorder:(nonnull NSDictionary *)options
                              ...
                              rejecter:(ABI26_0_0RCTPromiseRejectBlock)reject)
{
  if ([ABI26_0_0EXPermissions statusForPermissions:[ABI26_0_0EXAudioRecordingPermissionRequester permissions]] != ABI26_0_0EXPermissionStatusGranted ||
