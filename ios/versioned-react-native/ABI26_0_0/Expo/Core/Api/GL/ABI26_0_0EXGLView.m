...
#if __has_include("ABI26_0_0EXGLARSessionManager.h")
#import "ABI26_0_0EXGLARSessionManager.h"
#else
#import "ABI26_0_0EXGLARSessionManagerStub.h"
#endif

@interface ABI26_0_0EXGLView ()

@property (nonatomic, weak) ABI26_0_0EXGLViewManager *viewManager;
...
@implementation ABI26_0_0EXGLView
...
- (instancetype)initWithManager:(ABI26_0_0EXGLViewManager *)viewManager
{
  if ((self = [super init])) {
    ...
    self.contentScaleFactor = ABI26_0_0RCTScreenScale();
...
{
  ABI26_0_0RCTBridge *bridge = _viewManager.bridge;
  if (!bridge.executorClass || [NSStringFromClass(bridge.executorClass) isEqualToString:@"ABI26_0_0RCTJSCExecutor"]) {
    // On JS thread, extract JavaScriptCore context, create ABI26_0_0EXGL context, call JS callback
    ...
    [bridge dispatchBlock:^{
      ...
      if (!jsContextRef) {
        ABI26_0_0RCTLogError(@"ABI26_0_0EXGL: The ReactABI26_0_0 Native bridge unexpectedly does not have a JavaScriptCore context.");
        return;
      }
    ...
    ABI26_0_0RCTLog(@"ABI26_0_0EXGL: Can only run on JavaScriptCore! Do you have 'Remote Debugging' enabled in your app's Developer Menu (https://facebook.github.io/ReactABI26_0_0-native/docs/debugging.html)? ABI26_0_0EXGL is not supported while using Remote Debugging, you will need to disable it to use ABI26_0_0EXGL.");
  }
}
...
- (void)layoutSubviews
{
  ...
  // Initialize ABI26_0_0EXGL context on the first layout
...
- (void)setOnSurfaceCreate:(ABI26_0_0RCTDirectEventBlock)onSurfaceCreate
{
...
- (void)draw
{
  ...
  // called on the JS thread to create the ABI26_0_0EXGL context and save its id (see init method). In
...
{
  Class sessionManagerClass = NSClassFromString(@"ABI26_0_0EXGLARSessionManager");
