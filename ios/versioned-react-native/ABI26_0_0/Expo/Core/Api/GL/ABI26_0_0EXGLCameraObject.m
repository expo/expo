...
@interface ABI26_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) ABI26_0_0EXCamera *camera;
...
@implementation ABI26_0_0EXGLCameraObject

- (instancetype)initWithView:(ABI26_0_0EXGLView *)glView andCamera:(ABI26_0_0EXCamera *)camera
{
