#import "ABI26_0_0RNAWSCognito.h"
...
@implementation ABI26_0_0RNAWSCognito
...
ABI26_0_0RCT_EXPORT_METHOD(computeModPow:(NSDictionary *)values
    ...
    if (result) {
        ...
        callback(@[@[ABI26_0_0RCTMakeError(@"computeModPow error", nil, nil)], [NSNull null]]);
    }
}

ABI26_0_0RCT_EXPORT_METHOD(computeS:(NSDictionary *)values
                  callback:(ABI26_0_0RCTResponseSenderBlock)callback) {
    ...
    if (result) {
        ...
        callback(@[@[ABI26_0_0RCTMakeError(@"computeS error", nil, nil)], [NSNull null]]);
    }
}
