...
ABI26_0_0EX_EXPORT_SCOPED_MODULE(ExponentImagePicker, PermissionsManager);
...
{
  if ([ABI26_0_0EXPermissions statusForPermissions:[ABI26_0_0EXCameraRollRequester permissions]] != ABI26_0_0EXPermissionStatusGranted ||
      ![_kernelPermissionsServiceDelegate hasGrantedPermission:@"cameraRoll" forExperience:self.experienceId] ||
      [ABI26_0_0EXPermissions statusForPermissions:[ABI26_0_0EXCameraPermissionRequester permissions]] != ABI26_0_0EXPermissionStatusGranted ||
