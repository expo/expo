...
#import "ABI26_0_0EXMailComposer.h"
...
@interface ABI26_0_0EXMailComposer ()
...
@implementation ABI26_0_0EXMailComposer

ABI26_0_0RCT_EXPORT_MODULE(ExponentMailComposer);
...
ABI26_0_0RCT_EXPORT_METHOD(composeAsync:(NSDictionary *)options
                  ...
                  rejecter:(ABI26_0_0RCTPromiseRejectBlock)reject)
{
  ...
  if (options[@"attachments"] != nil) {
    for (NSString *uri in options[@"attachments"]) {
      ...
      if (!([self.bridge.scopedModules.fileSystem permissionsForURI:url] & ABI26_0_0EXFileSystemPermissionRead)) {
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    [ABI26_0_0RCTPresentedViewController() presentViewController:composeController animated:YES completion:nil];
  });
}
