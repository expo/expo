...
#import "ABI26_0_0EXContacts.h"
#import "ABI26_0_0EXContactsRequester.h"

@import Contacts;

@interface ABI26_0_0EXContacts ()

@property (nonatomic, strong) CNContactStore *contactStore;

@end

@implementation ABI26_0_0EXContacts

ABI26_0_0RCT_EXPORT_MODULE(ExponentContacts);

/**
 * @param options Options including what fields to get and paging information.
 */
ABI26_0_0RCT_EXPORT_METHOD(getContactsAsync:(NSDictionary *)options resolver:(ABI26_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI26_0_0RCTPromiseRejectBlock)reject)
{
  if (!_contactStore) {
    _contactStore = [[CNContactStore alloc] init];
  }

  if ([ABI26_0_0EXPermissions statusForPermissions:[ABI26_0_0EXContactsRequester permissions]] != ABI26_0_0EXPermissionStatusGranted) {
