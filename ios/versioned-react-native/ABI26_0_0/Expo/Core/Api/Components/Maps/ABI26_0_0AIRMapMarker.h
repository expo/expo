...
@interface ABI26_0_0AIRMapMarker : MKAnnotationView <MKAnnotation>

@property (nonatomic, strong) ABI26_0_0AIRMapCallout *calloutView;
...
@property (nonatomic, copy) ABI26_0_0RCTDirectEventBlock onSelect;
@property (nonatomic, copy) ABI26_0_0RCTDirectEventBlock onDeselect;
...
@interface ABI26_0_0AIREmptyCalloutBackgroundView : ABI26_0_0SMCalloutBackgroundView
@end
