...
extern const CLLocationDegrees ABI26_0_0AIRMapDefaultSpan;
extern const NSTimeInterval ABI26_0_0AIRMapRegionChangeObserveInterval;
extern const CGFloat ABI26_0_0AIRMapZoomBoundBuffer;
extern const NSInteger ABI26_0_0AIRMapMaxZoomLevel;

@interface ABI26_0_0AIRMap: MKMapView<ABI26_0_0SMCalloutViewDelegate>

@property (nonatomic, strong) ABI26_0_0SMCalloutView *calloutView;
...
@property (nonatomic, copy) ABI26_0_0RCTBubblingEventBlock onPanDrag;
@property (nonatomic, copy) ABI26_0_0RCTBubblingEventBlock onLongPress;
@property (nonatomic, copy) ABI26_0_0RCTDirectEventBlock onMarkerPress;
@property (nonatomic, copy) ABI26_0_0RCTDirectEventBlock onMarkerSelect;
@property (nonatomic, copy) ABI26_0_0RCTDirectEventBlock onMarkerDeselect;
@property (nonatomic, copy) ABI26_0_0RCTDirectEventBlock onMarkerDragStart;
@property (nonatomic, copy) ABI26_0_0RCTDirectEventBlock onMarkerDrag;
@property (nonatomic, copy) ABI26_0_0RCTDirectEventBlock onMarkerDragEnd;
@property (nonatomic, copy) ABI26_0_0RCTDirectEventBlock onCalloutPress;
