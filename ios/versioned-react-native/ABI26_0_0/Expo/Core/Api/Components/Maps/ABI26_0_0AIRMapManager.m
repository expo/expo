...
#import "ABI26_0_0AIRMapManager.h"
...
#import "ABI26_0_0AIRMapSnapshot.h"
...
@interface ABI26_0_0AIRMapManager() <MKMapViewDelegate>

@end

@implementation ABI26_0_0AIRMapManager
{
...
- (UIView *)view
{
    ABI26_0_0AIRMap *map = [ABI26_0_0AIRMap new];
    map.delegate = self;
...
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(userLocationAnnotationTitle, NSString)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(showsPointsOfInterest, BOOL)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
...
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(cacheEnabled, BOOL)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(maxDelta, CGFloat)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(minDelta, CGFloat)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(legalLabelInsets, UIEdgeInsets)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, MKMapType)
...
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(onPanDrag, ABI26_0_0RCTBubblingEventBlock)
...
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI26_0_0RCTDirectEventBlock)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI26_0_0RCTDirectEventBlock)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI26_0_0RCTDirectEventBlock)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI26_0_0RCTDirectEventBlock)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI26_0_0RCTDirectEventBlock)
ABI26_0_0RCT_EXPORT_VIEW_PROPERTY(onCalloutPress, ABI26_0_0RCTDirectEventBlock)
ABI26_0_0RCT_CUSTOM_VIEW_PROPERTY(initialRegion, MKCoordinateRegion, ABI26_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setInitialRegion:[ABI26_0_0RCTConvert MKCoordinateRegion:json]];
...
ABI26_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI26_0_0AIRMap)
{
    if (json == nil) return;
    ...
    BOOL originalIgnore = view.ignoreRegionChanges;
    view.ignoreRegionChanges = YES;
    [view setRegion:[ABI26_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
    view.ignoreRegionChanges = originalIgnore;
}
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI26_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI26_0_0AIRMap class]]) {
            ABI26_0_0RCTLogError(@"Invalid view returned from registry, expecting ABI26_0_0AIRMap, got: %@", view);
        } else {
            [ABI26_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI26_0_0AIRMap *)view setRegion:region animated:YES];
            }];
        }
    }];
}
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI26_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI26_0_0AIRMap class]]) {
            ...
            ABI26_0_0AIRMap *mapView = (ABI26_0_0AIRMap *)view;
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI26_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI26_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ABI26_0_0AIRMapMarker *marker = (ABI26_0_0AIRMapMarker *)evaluatedObject;
                return [marker isKindOfClass:[ABI26_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
...
- (void)takeMapSnapshot:(ABI26_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI26_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI26_0_0AIRMap *map = (ABI26_0_0AIRMap *)recognizer.view;
    ...
    ABI26_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI26_0_0AIRMapPolygon class]]){
            ABI26_0_0AIRMapPolygon *polygon = (ABI26_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI26_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI26_0_0AIRMapPolyline class]]){
            ABI26_0_0AIRMapPolyline *polyline = (ABI26_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI26_0_0AIRMapPolyline class]]) {
        return ((ABI26_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI26_0_0AIRMapPolygon class]]) {
        return ((ABI26_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI26_0_0AIRMapCircle class]]) {
        return ((ABI26_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI26_0_0AIRMapUrlTile class]]) {
        return ((ABI26_0_0AIRMapUrlTile *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI26_0_0AIRMapLocalTile class]]) {
        return ((ABI26_0_0AIRMapLocalTile *)overlay).renderer;
...
- (void)mapView:(ABI26_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI26_0_0AIRMapMarker class]]) {
        [(ABI26_0_0AIRMapMarker *)view.annotation showCalloutView];
...
- (void)mapView:(ABI26_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI26_0_0AIRMapMarker class]]) {
        [(ABI26_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI26_0_0AIRMap *)mapView viewForAnnotation:(ABI26_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI26_0_0AIRMapMarker class]]) {
...
- (void)mapView:(ABI26_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI26_0_0AIRMapMarker class]]) return;
    ABI26_0_0AIRMapMarker *marker = (ABI26_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI26_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI26_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI26_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI26_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI26_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    [self _regionChanged:mapView];

    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI26_0_0AIRMapRegionChangeObserveInterval
                                                               target:self
                                                             selector:@selector(_onTick:)
                                                             userInfo:@{ ABI26_0_0RCTMapViewKey: mapView }
                                                              repeats:YES];

    [[NSRunLoop mainRunLoop] addTimer:mapView.regionChangeObserveTimer forMode:NSRunLoopCommonModes];
}

- (void)mapView:(ABI26_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI26_0_0AIRMap *)mapView
{
...
- (void)mapViewDidFinishRenderingMap:(ABI26_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
{
    [self _regionChanged:timer.userInfo[ABI26_0_0RCTMapViewKey]];
}

- (void)_regionChanged:(ABI26_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI26_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI26_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI26_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI26_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI26_0_0AIRMap *)mapView
{
...
- (MKCoordinateSpan)coordinateSpanWithMapView:(ABI26_0_0AIRMap *)mapView
                             centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                 andZoomLevel:(double)zoomLevel
{
    // convert center coordiate to pixel space
    double centerPixelX = [ABI26_0_0AIRMapManager longitudeToPixelSpaceX:centerCoordinate.longitude];
    double centerPixelY = [ABI26_0_0AIRMapManager latitudeToPixelSpaceY:centerCoordinate.latitude];

    // determine the scale value from the zoom level
    double zoomExponent = ABI26_0_0AIRMapMaxZoomLevel - zoomLevel;
    ...
    CLLocationDegrees minLng = [ABI26_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX];
    CLLocationDegrees maxLng = [ABI26_0_0AIRMapManager pixelSpaceXToLongitude:topLeftPixelX + scaledMapWidth];
    CLLocationDegrees longitudeDelta = maxLng - minLng;

    // find delta between top and bottom latitudes
    CLLocationDegrees minLat = [ABI26_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY];
    CLLocationDegrees maxLat = [ABI26_0_0AIRMapManager pixelSpaceYToLatitude:topLeftPixelY + scaledMapHeight];
...
- (void)setCenterCoordinate:(CLLocationCoordinate2D)centerCoordinate
                  zoomLevel:(double)zoomLevel
                   animated:(BOOL)animated
                    mapView:(ABI26_0_0AIRMap *)mapView
{
    // clamp large numbers to 28
    zoomLevel = MIN(zoomLevel, ABI26_0_0AIRMapMaxZoomLevel);
...
-(MKCoordinateRegion)coordinateRegionWithMapView:(ABI26_0_0AIRMap *)mapView
                                centerCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                    andZoomLevel:(double)zoomLevel
{
	...
	// find delta between top and bottom latitudes
	CLLocationDegrees minLat = [ABI26_0_0AIRMapManager pixelSpaceYToLatitude:topPixelY];
	CLLocationDegrees maxLat = [ABI26_0_0AIRMapManager pixelSpaceYToLatitude:bottomPixelY];
	CLLocationDegrees latitudeDelta = -1 * (maxLat - minLat);
	...
	if (adjustedCenterPoint) {
		region.center.latitude = [ABI26_0_0AIRMapManager pixelSpaceYToLatitude:((bottomPixelY + topPixelY) / 2.0)];
	}

	return region;
}

- (double) zoomLevel:(ABI26_0_0AIRMap *)mapView {
    MKCoordinateRegion region = mapView.region;

    double centerPixelX = [ABI26_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude];
    double topLeftPixelX = [ABI26_0_0AIRMapManager longitudeToPixelSpaceX: region.center.longitude - region.span.longitudeDelta / 2];

    double scaledMapWidth = (centerPixelX - topLeftPixelX) * 2;
    CGSize mapSizeInPixels = mapView.bounds.size;
    double zoomScale = scaledMapWidth / mapSizeInPixels.width;
    double zoomExponent = log(zoomScale) / log(2);
    double zoomLevel = ABI26_0_0AIRMapMaxZoomLevel - zoomExponent;
