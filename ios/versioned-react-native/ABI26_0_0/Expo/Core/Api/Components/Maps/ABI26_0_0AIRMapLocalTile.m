...
#import "ABI26_0_0AIRMapLocalTileOverlay.h"

@implementation ABI26_0_0AIRMapLocalTile {
...
- (void) createTileOverlayAndRendererIfPossible
{
    ...
    self.tileOverlay = [[ABI26_0_0AIRMapLocalTileOverlay alloc] initWithURLTemplate:self.pathTemplate];
