//
//  ABI26_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI26_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI26_0_0RNGestureHandler *otherHandler = [ABI26_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI26_0_0RCTTouchHandler class]];
}
