...
if (value != nil) recognizer.prop = [ABI26_0_0RCTConvert type:value]; \
} while(0)
...
@protocol ABI26_0_0RNGestureHandlerEventEmitter

- (void)sendTouchEvent:(nonnull ABI26_0_0RNGestureHandlerEvent *)event;

- (void)sendStateChangeEvent:(nonnull ABI26_0_0RNGestureHandlerStateChange *)event;

@end


@protocol ABI26_0_0RNRootViewGestureRecognizerDelegate <UIGestureRecognizerDelegate>
...
@interface ABI26_0_0RNGestureHandler : NSObject <UIGestureRecognizerDelegate> {

@protected UIGestureRecognizer *_recognizer;
@protected ABI26_0_0RNGestureHandlerState _lastState;

}

+ (nullable ABI26_0_0RNGestureHandler *)findGestureHandlerByRecognizer:(nonnull UIGestureRecognizer *)recognizer;

- (nonnull instancetype)initWithTag:(nonnull NSNumber *)tag;

@property (nonatomic, readonly, nonnull) NSNumber *tag;
@property (nonatomic, weak, nullable) id<ABI26_0_0RNGestureHandlerEventEmitter> emitter;
...
- (nullable ABI26_0_0RNGestureHandlerEventExtraData *)eventExtraData:(nonnull id)recognizer;
