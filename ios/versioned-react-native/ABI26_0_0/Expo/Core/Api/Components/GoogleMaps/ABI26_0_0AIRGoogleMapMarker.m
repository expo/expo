...
#import "ABI26_0_0AIRDummyView.h"
...
@interface ABI26_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI26_0_0AIRGMSMarker*)marker;
@end

@implementation ABI26_0_0AIRGoogleMapMarker {
  ABI26_0_0RCTImageLoaderCancellationBlock _reloadImageCancellationBlock;
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI26_0_0AIRGMSMarker alloc] init];
...
- (void)insertReactABI26_0_0Subview:(id<ABI26_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI26_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI26_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI26_0_0AIRDummyView *dummySubview = [[ABI26_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertReactABI26_0_0Subview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeReactABI26_0_0Subview:(id<ABI26_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI26_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeReactABI26_0_0Subview:(UIView*)dummySubview];
}
...
- (ABI26_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/airbnb/ReactABI26_0_0-native-maps/issues/738)
  ...
  _reloadImageCancellationBlock = [_bridge.imageLoader loadImageWithURLRequest:[ABI26_0_0RCTConvert NSURLRequest:_imageSrc]
                                                                          size:self.bounds.size
                                                                         scale:ABI26_0_0RCTScreenScale()
                                                                       clipped:YES
                                                                    resizeMode:ABI26_0_0RCTResizeModeCenter
                                                                 progressBlock:nil
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI26_0_0RN?
