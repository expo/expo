//
//  ABI26_0_0AIRGoogleMapPolygon.h
//
...
@interface ABI26_0_0AIRGoogleMapPolygon : UIView

@property (nonatomic, weak) ABI26_0_0RCTBridge *bridge;
@property (nonatomic, strong) NSString *identifier;
@property (nonatomic, strong) ABI26_0_0AIRGMSPolygon *polygon;
@property (nonatomic, strong) NSArray<ABI26_0_0AIRMapCoordinate *> *coordinates;
@property (nonatomic, strong) NSArray<NSArray<ABI26_0_0AIRMapCoordinate *> *> *holes;
