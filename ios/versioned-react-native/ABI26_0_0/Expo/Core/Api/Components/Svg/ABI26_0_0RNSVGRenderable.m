...
@implementation ABI26_0_0RNSVGRenderable
{
...
- (void)setFill:(ABI26_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI26_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI26_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    if (self.stroke) {
        ...
        ABI26_0_0RNSVGCGFloatArray dash = self.strokeDasharrayData;
...
- (void)mergeProperties:(__kindof ABI26_0_0RNSVGRenderable *)target
{
