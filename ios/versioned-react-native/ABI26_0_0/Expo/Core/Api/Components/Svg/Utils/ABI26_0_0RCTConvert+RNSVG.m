...
@implementation ABI26_0_0RCTConvert (ABI26_0_0RNSVG)

ABI26_0_0RCT_ENUM_CONVERTER(ABI26_0_0RNSVGCGFCRule, (@{
                                     @"evenodd": @(kRNSVGCGFCRuleEvenodd),
                                     @"nonzero": @(kRNSVGCGFCRuleNonzero),
                                     }), kRNSVGCGFCRuleNonzero, intValue)

ABI26_0_0RCT_ENUM_CONVERTER(ABI26_0_0RNSVGVBMOS, (@{
                                  @"meet": @(kRNSVGVBMOSMeet),
                                  @"slice": @(kRNSVGVBMOSSlice),
                                  @"none": @(kRNSVGVBMOSNone)
                                  }), kRNSVGVBMOSMeet, intValue)

ABI26_0_0RCT_ENUM_CONVERTER(ABI26_0_0RNSVGUnits, (@{
...
+ (ABI26_0_0RNSVGCGFloatArray)ABI26_0_0RNSVGCGFloatArray:(id)json
{
    ...
    ABI26_0_0RNSVGCGFloatArray array;
    array.count = count;
    array.array = nil;
...
+ (ABI26_0_0RNSVGBrush *)ABI26_0_0RNSVGBrush:(id)json
{
    ...
    switch (type) {
        case 0: // solid color
            ...
            return [[ABI26_0_0RNSVGSolidColorBrush alloc] initWithArray:arr];
        case 1: // brush
            return [[ABI26_0_0RNSVGPainterBrush alloc] initWithArray:arr];
        default:
            ABI26_0_0RCTLogError(@"Unknown brush type: %zd", type);
            return nil;
    }
}
...
{
    return [[ABI26_0_0RNSVGPathParser alloc] initWithPathString: d];
}
...
+ (CGRect)ABI26_0_0RNSVGCGRect:(id)json offset:(NSUInteger)offset
{
    ...
    if (arr.count < offset + 4) {
        ABI26_0_0RCTLogError(@"Too few elements in array (expected at least %zd): %@", 4 + offset, arr);
        return CGRectZero;
    }
    return (CGRect){
...
+ (CGGradientRef)ABI26_0_0RNSVGCGGradient:(id)json offset:(NSUInteger)offset
{
    NSArray *arr = [self NSArray:json];
    if (arr.count < offset) {
        ABI26_0_0RCTLogError(@"Too few elements in array (expected at least %zd): %@", offset, arr);
        return nil;
    }
    arr = [arr subarrayWithRange:(NSRange){offset, arr.count - offset}];
    ABI26_0_0RNSVGCGFloatArray colorsAndOffsets = [self ABI26_0_0RNSVGCGFloatArray:arr];
