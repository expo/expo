...
@implementation ABI26_0_0RNSVGNode
{
    ABI26_0_0RNSVGGroup *_textRoot;
    ABI26_0_0RNSVGGlyphContext *glyphContext;
    BOOL _transparent;
    CGPathRef _cachedClipPath;
    ABI26_0_0RNSVGSvgView *_svgView;
}

CGFloat const ABI26_0_0M_SQRT1_2l = 0.707106781186547524400844362104849039;
CGFloat const ABI26_0_0RNSVG_DEFAULT_FONT_SIZE = 12;
...
- (void)invalidate
{
    id<ABI26_0_0RNSVGContainer> container = (id<ABI26_0_0RNSVGContainer>)self.superview;
    [container invalidate];
}

- (ABI26_0_0RNSVGGroup *)getTextRoot
{
    ABI26_0_0RNSVGNode* node = self;
    if (_textRoot == nil) {
        while (node != nil) {
            if ([node isKindOfClass:[ABI26_0_0RNSVGGroup class]] && [((ABI26_0_0RNSVGGroup*) node) getGlyphContext] != nil) {
                _textRoot = (ABI26_0_0RNSVGGroup*)node;
                break;
            }
            ...
            if (![node isKindOfClass:[ABI26_0_0RNSVGNode class]]) {
                ...
                node = (ABI26_0_0RNSVGNode*)parent;
            }
        }
    }
...
{
    ABI26_0_0RNSVGNode* parent = (ABI26_0_0RNSVGGroup*)[self superview];
    if (![parent isKindOfClass:[ABI26_0_0RNSVGGroup class]]) {
        return nil;
    } else {
...
{
    ABI26_0_0RNSVGGroup* root = [self getTextRoot];
    if (root == nil) {
        return ABI26_0_0RNSVG_DEFAULT_FONT_SIZE;
    }
...
- (void)ReactABI26_0_0SetInheritedBackgroundColor:(UIColor *)inheritedBackgroundColor
{
...
- (ABI26_0_0RNSVGSvgView *)getSvgView
{
    ...
    if ([parent class] == [ABI26_0_0RNSVGSvgView class]) {
        _svgView = parent;
    } else if ([parent isKindOfClass:[ABI26_0_0RNSVGNode class]]) {
        ABI26_0_0RNSVGNode *node = parent;
        _svgView = [node getSvgView];
    } else {
        ABI26_0_0RCTLogError(@"ABI26_0_0RNSVG: %@ should be descendant of a SvgViewShadow.", NSStringFromClass(self.class));
    }
...
{
    return [ABI26_0_0RNSVGPropHelper fromRelativeWithNSString:length
...
- (CGFloat)relativeOnOther:(NSString *)length
{
    ...
    CGFloat r = sqrt(powX + powY) * ABI26_0_0M_SQRT1_2l;
    return [ABI26_0_0RNSVGPropHelper fromRelativeWithNSString:length
                                         relative:r
                                           offset:0
                                            scale:1
...
{
    ABI26_0_0RNSVGGroup * root = [self getTextRoot];
    ABI26_0_0RNSVGGlyphContext * gc = [root getGlyphContext];
    if (root == nil || gc == nil) {
...
{
    for (ABI26_0_0RNSVGNode *node in self.subviews) {
        if ([node isKindOfClass:[ABI26_0_0RNSVGNode class]]) {
            if (!block(node)) {
                break;
            }
