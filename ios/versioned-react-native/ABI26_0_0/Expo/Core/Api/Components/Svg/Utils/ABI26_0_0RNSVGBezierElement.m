...
@implementation ABI26_0_0RNSVGBezierElement
- (instancetype) init
{
    self = [super init];
    if (self)
    {
        ...
        _point = ABI26_0_0RNSVGNULLPOINT;
        _controlPoint1 = ABI26_0_0RNSVGNULLPOINT;
        _controlPoint2 = ABI26_0_0RNSVGNULLPOINT;
    }
    return self;
}
...
{
    ABI26_0_0RNSVGBezierElement *newElement = [[self alloc] init];
...
void ABI26_0_0GetBezierElements(void *info, const CGPathElement *element)
{
    ...
    if (element)
        [bezierElements addObject:[ABI26_0_0RNSVGBezierElement elementWithPathElement:*element]];
}
