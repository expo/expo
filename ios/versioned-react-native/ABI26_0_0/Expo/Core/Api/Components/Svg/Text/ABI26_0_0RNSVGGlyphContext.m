...
@interface ABI26_0_0RNSVGGlyphContext () {
@public
    ...
    double mFontSize_;
    ABI26_0_0RNSVGFontData *topFont_;
...
@implementation ABI26_0_0RNSVGGlyphContext
...
- (CTFontRef)getGlyphFont
{
    ...
    NSString * fontWeight = [ABI26_0_0RNSVGFontWeightToString(topFont_->fontWeight) lowercaseString];
    NSString * fontStyle = ABI26_0_0RNSVGFontStyleStrings[topFont_->fontStyle];
    ...
    return (__bridge CTFontRef)[ABI26_0_0RCTFont updateFont:nil
...
void ABI26_0_0pushIndices(ABI26_0_0RNSVGGlyphContext *self) {
...
- (instancetype)initWithScale:(float)scale_
    ...
    self->mFontSize_ = ABI26_0_0RNSVGFontData_DEFAULT_FONT_SIZE;
    self->topFont_ = [ABI26_0_0RNSVGFontData Defaults];
...
ABI26_0_0RNSVGFontData *ReactABI26_0_0getTopOrParentFont(ABI26_0_0RNSVGGlyphContext *self, ABI26_0_0RNSVGGroup* child) {
    if (self->mTop_ > 0) {
        ...
        ABI26_0_0RNSVGGroup* parentRoot = [child getParentTextRoot];
        ABI26_0_0RNSVGFontData* Defaults = [ABI26_0_0RNSVGFontData Defaults];
        while (parentRoot != nil) {
            ABI26_0_0RNSVGFontData *map = [[parentRoot getGlyphContext] getFont];
            if (map != Defaults) {
                return map;
            }
...
void ReactABI26_0_0pushNodeAndFont(ABI26_0_0RNSVGGlyphContext *self, ABI26_0_0RNSVGGroup* node, NSDictionary* font) {
    ...
    ABI26_0_0RNSVGFontData *data = [ABI26_0_0RNSVGFontData initWithNSDictionary:font
                                                 parent:parent
                                                  scale:self->mScale_];
...
- (double)nextXWithDouble:(double)advance {
    ...
    if (nextIndex < [mXs_ count]) {
        ...
        mX_ = [ABI26_0_0RNSVGPropHelper fromRelativeWithNSString:string
                                            relative:mWidth_
                                              offset:0
                                               scale:mScale_
                                            fontSize:mFontSize_];
...
- (double)nextY {
    ...
    if (nextIndex < [mYs_ count]) {
        ...
        mY_ = [ABI26_0_0RNSVGPropHelper fromRelativeWithNSString:string
                                            relative:mHeight_
                                              offset:0
                                               scale:mScale_
                                            fontSize:mFontSize_];
...
- (double)nextDeltaX {
    ...
    if (nextIndex < [mDXs_ count]) {
        ...
        double val = [ABI26_0_0RNSVGPropHelper fromRelativeWithNSString:string
                                                   relative:mWidth_
                                                     offset:0
                                                      scale:mScale_
                                                   fontSize:mFontSize_];
