...
#import "ABI26_0_0RNSVGGlyphContext.h"
#import "ABI26_0_0RNSVGTextProperties.h"

@implementation ABI26_0_0RNSVGText
{
    ABI26_0_0RNSVGText *_textRoot;
    ABI26_0_0RNSVGGlyphContext *_glyphContext;
}
...
{
    _glyphContext = [[ABI26_0_0RNSVGGlyphContext alloc] initWithScale:1 width:[self getContextWidth]
                                                   height:[self getContextHeight]];
}

// release the cached CGPathRef for ABI26_0_0RNSVGTSpan
- (void)releaseCachedPath
{
    [self traverseSubviews:^BOOL(__kindof ABI26_0_0RNSVGNode *node) {
        ABI26_0_0RNSVGText *text = node;
...
- (ABI26_0_0RNSVGText *)getTextRoot
{
    if (!_textRoot) {
        _textRoot = self;
        while (_textRoot && [_textRoot class] != [ABI26_0_0RNSVGText class]) {
            if (![_textRoot isKindOfClass:[ABI26_0_0RNSVGText class]]) {
                //todo: throw exception here
                break;
            }
            _textRoot = (ABI26_0_0RNSVGText*)[_textRoot superview];
        }
    }
...
- (NSString*) getAlignmentBaseline
{
    ...
    while (parent != nil) {
        if ([parent isKindOfClass:[ABI26_0_0RNSVGText class]]) {
            ABI26_0_0RNSVGText* node = (ABI26_0_0RNSVGText*)parent;
    ...
    if (self.alignmentBaseline == nil) {
        self.alignmentBaseline = ABI26_0_0RNSVGAlignmentBaselineStrings[0];
    }
    return self.alignmentBaseline;
}
...
- (ABI26_0_0RNSVGGlyphContext *)getGlyphContext
{
