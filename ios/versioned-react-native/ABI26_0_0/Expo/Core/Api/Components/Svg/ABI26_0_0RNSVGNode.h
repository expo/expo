...
/**
 * ABI26_0_0RNSVG nodes are implemented as base UIViews. They should be implementation for all basic
 ＊interfaces for all non-defination nodes.
 */

@interface ABI26_0_0RNSVGNode : UIView
 ...
 */
extern CGFloat const ABI26_0_0M_SQRT1_2l;
extern CGFloat const ABI26_0_0RNSVG_DEFAULT_FONT_SIZE;

@property (nonatomic, strong) NSString *name;
@property (nonatomic, assign) CGFloat opacity;
@property (nonatomic, assign) ABI26_0_0RNSVGCGFCRule clipRule;
...
- (ABI26_0_0RNSVGGroup *)getTextRoot;
- (ABI26_0_0RNSVGGroup *)getParentTextRoot;
...
/**
 * get ABI26_0_0RNSVGSvgView which ownes current ABI26_0_0RNSVGNode
 */
- (ABI26_0_0RNSVGSvgView *)getSvgView;
...
- (void)traverseSubviews:(BOOL (^)(__kindof ABI26_0_0RNSVGNode *node))block;
