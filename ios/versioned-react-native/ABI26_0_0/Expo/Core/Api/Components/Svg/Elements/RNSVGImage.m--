...
@implementation ABI26_0_0RNSVGImage
{
    CGImageRef _image;
    CGSize _imageSize;
}
...
- (void)setSrc:(id)src
{
    ...
    _image = CGImageRetain([ABI26_0_0RCTConvert CGImage:src]);
    ABI26_0_0RCTImageSource *source = [ABI26_0_0RCTConvert ABI26_0_0RCTImageSource:src];
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    CGAffineTransform viewbox = [ABI26_0_0RNSVGViewBox getTransform:imageBounds eRect:hitArea align:self.align meetOrSlice:self.meetOrSlice];
