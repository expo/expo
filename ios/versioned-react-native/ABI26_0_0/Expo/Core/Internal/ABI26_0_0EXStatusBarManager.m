...
#if !TARGET_OS_TV
@implementation ABI26_0_0RCTConvert (ABI26_0_0EXStatusBar)
...
@interface ABI26_0_0EXStatusBarManager ()

@property (nonatomic, strong) NSMutableDictionary *capturedStatusBarProperties;

@end

@implementation ABI26_0_0EXStatusBarManager

+ (NSString *)moduleName { return @"ABI26_0_0RCTStatusBarManager"; }
 ...
 */
ABI26_0_0RCT_REMAP_METHOD(_captureProperties,
                 _capturePropertiesWithResolver:(ABI26_0_0RCTPromiseResolveBlock)resolve
 ...
 *  Normally nobody should use this method because it bypasses the JS state used by the StatusBar component.
 */
ABI26_0_0RCT_EXPORT_METHOD(_applyPropertiesAndForget:(NSDictionary *)properties)
{
...
{
  UIApplication *currentApplication = ABI26_0_0RCTSharedApplication();
  return @{
