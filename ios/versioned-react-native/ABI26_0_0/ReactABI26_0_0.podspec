...
Pod::Spec.new do |s|
  ...
  s.subspec "Core" do |ss|
    ss.dependency             "yogaABI26_0_0", "#{package["version"]}.React"
  ...
  s.subspec "CxxBridge" do |ss|
    ...
    ss.dependency             "ReactABI26_0_0/Core"
    ss.dependency             "ReactABI26_0_0/cxxReactABI26_0_0"
  ...
  s.subspec "DevSupport" do |ss|
    ss.dependency             "ReactABI26_0_0/Core"
    ss.dependency             "ReactABI26_0_0/RCTWebSocket"
  ...
  s.subspec "ABI26_0_0jschelpers" do |ss|
    ss.dependency             "Folly", "2018.10.22.00"
    ss.dependency             "ReactABI26_0_0/ABI26_0_0PrivateDatabase"
    ss.compiler_flags       = folly_compiler_flags
    ss.source_files         = "ReactCommon/ABI26_0_0jschelpers/*.{cpp,h}"
    ss.private_header_files = "ReactCommon/ABI26_0_0jschelpers/*.h"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\"" }
    ss.framework            = "JavaScriptCore"
  end

  s.subspec "ABI26_0_0jsinspector" do |ss|
    ss.source_files         = "ReactCommon/ABI26_0_0jsinspector/*.{cpp,h}"
    ss.private_header_files = "ReactCommon/ABI26_0_0jsinspector/*.h"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\"" }
  end

  s.subspec "ABI26_0_0PrivateDatabase" do |ss|
    ss.source_files         = "ReactCommon/ABI26_0_0privatedata/*.{cpp,h}"
    ss.private_header_files = "ReactCommon/ABI26_0_0privatedata/*.h"
    ss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\"" }
  end

  s.subspec "cxxReactABI26_0_0" do |ss|
    ss.dependency             "ReactABI26_0_0/ABI26_0_0jschelpers"
    ss.dependency             "ReactABI26_0_0/ABI26_0_0jsinspector"
    ss.dependency             "boost-for-react-native", "1.63.0"
    ss.dependency             "Folly", "2018.10.22.00"
    ss.compiler_flags       = folly_compiler_flags
    ss.source_files         = "ReactCommon/cxxReactABI26_0_0/*.{cpp,h}"
    ss.exclude_files        = "ReactCommon/cxxReactABI26_0_0/ABI26_0_0SampleCxxModule.*"
    ss.private_header_files = "ReactCommon/cxxReactABI26_0_0/*.h"
  ...
  s.subspec "RCTAnimation" do |ss|
    ...
    ss.header_dir           = "ABI26_0_0RCTAnimation"
  end
  ...
  s.subspec "RCTImage" do |ss|
    ss.dependency             "ReactABI26_0_0/Core"
    ss.dependency             "ReactABI26_0_0/RCTNetwork"
  ...
  s.subspec "RCTWebSocket" do |ss|
    ss.dependency             "ReactABI26_0_0/Core"
    ss.dependency             "ReactABI26_0_0/RCTBlob"
    ss.dependency             "ReactABI26_0_0/fishhook"
  ...
  s.subspec "_ignore_me_subspec_for_linting_" do |ss|
    ss.dependency             "ReactABI26_0_0/Core"
    ss.dependency             "ReactABI26_0_0/CxxBridge"
  end
end
