...
#import "ABI26_0_0RCTCxxMethod.h"
...
#import <cxxReactABI26_0_0/ABI26_0_0JsArgumentHelpers.h>
#import <folly/Memory.h>

#import "ABI26_0_0RCTCxxUtils.h"

using facebook::xplat::module::CxxModule;
using namespace facebook::ReactABI26_0_0;

@implementation ABI26_0_0RCTCxxMethod
{
...
- (ABI26_0_0RCTFunctionType)functionType
{
  std::string type(_method->getType());
  if (type == "sync") {
    return ABI26_0_0RCTFunctionTypeSync;
  } else if (type == "async") {
    return ABI26_0_0RCTFunctionTypeNormal;
  } else {
    return ABI26_0_0RCTFunctionTypePromise;
  }
}
             ...
             arguments:(NSArray *)arguments
{
  ...
  if (arguments.count < _method->callbacks) {
    ABI26_0_0RCTLogError(@"Method %@.%s expects at least %zu arguments, but got %tu",
                ABI26_0_0RCTBridgeModuleNameForClass([module class]), _method->name.c_str(),
  ...
  if (_method->callbacks >= 1) {
    if (![arguments[arguments.count - 1] isKindOfClass:[NSNumber class]]) {
      ABI26_0_0RCTLogError(@"Argument %tu (%@) of %@.%s should be a function",
  ...
  try {
    ...
    ABI26_0_0RCTLogError(@"Method %@.%s argument error: %s",
                ABI26_0_0RCTBridgeModuleNameForClass([module class]), _method->name.c_str(),
                ex.what());
    return nil;
  }
