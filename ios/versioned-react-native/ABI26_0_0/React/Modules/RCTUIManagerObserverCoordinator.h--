 ...
 */
@protocol ABI26_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ReactABI26_0_0-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI26_0_0RCTUIManager's observers.
 */
@interface ABI26_0_0RCTUIManagerObserverCoordinator : NSObject <ABI26_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI26_0_0RCTUIManagerObserver` protocol for more info.
