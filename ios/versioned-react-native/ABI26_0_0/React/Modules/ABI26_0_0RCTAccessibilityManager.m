...
NSString *const ABI26_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification = @"ABI26_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification";
...
@interface ABI26_0_0RCTAccessibilityManager ()
...
@implementation ABI26_0_0RCTAccessibilityManager
...
- (instancetype)init
{
  if ((self = [super init])) {
    ...
    self.contentSizeCategory = ABI26_0_0RCTSharedApplication().preferredContentSizeCategory;
...
- (void)invalidateMultiplier
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI26_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification object:self];
}
...
- (CGFloat)multiplierForContentSizeCategory:(NSString *)category
{
  ...
  if (m.doubleValue <= 0.0) {
    ABI26_0_0RCTLogError(@"Can't determinte multiplier for category %@. Using 1.0.", category);
    m = @1.0;
  }
...
ABI26_0_0RCT_EXPORT_METHOD(setAccessibilityContentSizeMultipliers:(NSDictionary *)JSMultipliers)
{
  ...
  for (NSString *__nonnull JSCategory in JSMultipliers) {
    NSNumber *m = [ABI26_0_0RCTConvert NSNumber:JSMultipliers[JSCategory]];
...
ABI26_0_0RCT_EXPORT_METHOD(setAccessibilityFocus:(nonnull NSNumber *)ReactABI26_0_0Tag)
{
...
ABI26_0_0RCT_EXPORT_METHOD(announceForAccessibility:(NSString *)announcement)
{
  UIAccessibilityPostNotification(UIAccessibilityAnnouncementNotification, announcement);
}

ABI26_0_0RCT_EXPORT_METHOD(getMultiplier:(ABI26_0_0RCTResponseSenderBlock)callback)
{
  if (callback) {
...
ABI26_0_0RCT_EXPORT_METHOD(getCurrentVoiceOverState:(ABI26_0_0RCTResponseSenderBlock)callback
...
@implementation ABI26_0_0RCTBridge (ABI26_0_0RCTAccessibilityManager)

- (ABI26_0_0RCTAccessibilityManager *)accessibilityManager
{
  return [self moduleForClass:[ABI26_0_0RCTAccessibilityManager class]];
}
