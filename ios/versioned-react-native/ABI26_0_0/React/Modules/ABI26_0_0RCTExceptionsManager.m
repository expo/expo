...
#import "ABI26_0_0RCTExceptionsManager.h"
...
@implementation ABI26_0_0RCTExceptionsManager
                  ...
                  exceptionId:(nonnull NSNumber *)exceptionId)
{
  ...
  if (!ABI26_0_0RCT_DEBUG && reloadRetries < _maxReloadAttempts) {
    reloadRetries++;
    [_bridge reload];
  } else {
    NSString *description = [@"Unhandled JS Exception: " stringByAppendingString:message];
    NSDictionary *errorInfo = @{ NSLocalizedDescriptionKey: description, ABI26_0_0RCTJSStackTraceKey: stack };
    ABI26_0_0RCTFatal([NSError errorWithDomain:ABI26_0_0RCTErrorDomain code:0 userInfo:errorInfo]);
  }
}
...
ABI26_0_0RCT_EXPORT_METHOD(reportUnhandledException:(NSString *)message
                  stack:(NSArray<NSDictionary *> *)stack)
{
