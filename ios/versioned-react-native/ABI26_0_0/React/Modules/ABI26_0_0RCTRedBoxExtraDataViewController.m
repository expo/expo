...
@interface ABI26_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI26_0_0RCTRedBoxExtraDataCell
...
@interface ABI26_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI26_0_0RCTRedBoxExtraDataViewController
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ABI26_0_0RCTRedBoxExtraDataCell *cell =
            (ABI26_0_0RCTRedBoxExtraDataCell *)[tableView
            dequeueReusableCellWithIdentifier:reuseIdentifier];

    if (cell == nil) {
        cell = [[ABI26_0_0RCTRedBoxExtraDataCell alloc]
