...
@interface ABI26_0_0RCTTabBar() <UITabBarControllerDelegate>

@end

@implementation ABI26_0_0RCTTabBar
{
  BOOL _tabsChanged;
...
- (void)insertReactABI26_0_0Subview:(ABI26_0_0RCTTabBarItem *)subview atIndex:(NSInteger)atIndex
{
  if (![subview isKindOfClass:[ABI26_0_0RCTTabBarItem class]]) {
    ABI26_0_0RCTLogError(@"subview should be of type ABI26_0_0RCTTabBarItem");
    return;
  }
...
- (void)removeReactABI26_0_0Subview:(ABI26_0_0RCTTabBarItem *)subview
{
  if (self.ReactABI26_0_0Subviews.count == 0) {
    ABI26_0_0RCTLogError(@"should have at least one view to remove a subview");
    return;
  }
...
- (void)layoutSubviews
{
  ...
  [self ReactABI26_0_0AddControllerToClosestParent:_tabController];
...
- (void)uiManagerDidPerformMounting
{
  ...
  if (_tabsChanged) {
    ...
    for (ABI26_0_0RCTTabBarItem *tab in [self ReactABI26_0_0Subviews]) {
      UIViewController *controller = tab.ReactABI26_0_0ViewController;
      if (!controller) {
        controller = [[ABI26_0_0RCTWrapperViewController alloc] initWithContentView:tab];
      }
  ...
  [self.ReactABI26_0_0Subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger index, __unused BOOL *stop) {

    ABI26_0_0RCTTabBarItem *tab = (ABI26_0_0RCTTabBarItem *)view;
...
- (void)tabBarController:(UITabBarController *)tabBarController didSelectViewController:(nonnull UIViewController *)viewController
{
  ...
  ABI26_0_0RCTTabBarItem *tab = (ABI26_0_0RCTTabBarItem *)self.ReactABI26_0_0Subviews[index];
