...
@implementation ABI26_0_0RCTConvert (UITabBarSystemItem)

ABI26_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI26_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI26_0_0ViewController;
}
