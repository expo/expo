...
static const CGFloat ABI26_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI26_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return
  ABS(borderInsets.left - borderInsets.right) < ABI26_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.bottom) < ABI26_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.top) < ABI26_0_0RCTViewBorderThreshold;
}

BOOL ABI26_0_0RCTCornerRadiiAreEqual(ABI26_0_0RCTCornerRadii cornerRadii)
{
  return
  ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI26_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI26_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI26_0_0RCTViewBorderThreshold;
}
...
{
  return (ABI26_0_0RCTCornerInsets) {
    {
...
static UIEdgeInsets ABI26_0_0RCTRoundInsetsToPixel(UIEdgeInsets edgeInsets) {
    edgeInsets.top = ABI26_0_0RCTRoundPixelValue(edgeInsets.top);
    edgeInsets.bottom = ABI26_0_0RCTRoundPixelValue(edgeInsets.bottom);
    edgeInsets.left = ABI26_0_0RCTRoundPixelValue(edgeInsets.left);
    edgeInsets.right = ABI26_0_0RCTRoundPixelValue(edgeInsets.right);

    return edgeInsets;
}

static void ABI26_0_0RCTPathAddEllipticArc(CGMutablePathRef path,
                                       ...
                                       const CGAffineTransform *transform)
{
  ...
  ABI26_0_0RCTPathAddEllipticArc(path, transform, (CGPoint){
...
static void ABI26_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds,
                                               CGPoint lineStart,
                                               CGPoint lineEnd,
...
NS_INLINE BOOL ABI26_0_0RCTCornerRadiiAreAboveThreshold(ABI26_0_0RCTCornerRadii cornerRadii) {
  return (cornerRadii.topLeft > ABI26_0_0RCTViewBorderThreshold ||
    cornerRadii.topRight > ABI26_0_0RCTViewBorderThreshold      ||
    cornerRadii.bottomLeft > ABI26_0_0RCTViewBorderThreshold    ||
    cornerRadii.bottomRight > ABI26_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI26_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI26_0_0RCTCornerRadii cornerRadii) {
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI26_0_0RCTPathCreateWithRoundedRect(rect, ABI26_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef ABI26_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge) {
...
static UIImage *ABI26_0_0RCTGetSolidBorderImage(ABI26_0_0RCTCornerRadii cornerRadii,
                                       CGSize viewSize,
                                       ...
                                       BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI26_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI26_0_0RCTCornerInsets cornerInsets = ABI26_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  borderInsets = ABI26_0_0RCTRoundInsetsToPixel(borderInsets);
  ...
  CGContextRef ctx = ABI26_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI26_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI26_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI26_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI26_0_0RCTEllipseGetIntersectionsWithLine((CGRect){
...
static UIImage *ABI26_0_0RCTGetDashedOrDottedBorderImage(ABI26_0_0RCTBorderStyle borderStyle,
                                                ...
                                                BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI26_0_0RCTBorderStyleDashed || borderStyle == ABI26_0_0RCTBorderStyleDotted);

  if (!ABI26_0_0RCTBorderColorsAreEqual(borderColors) || !ABI26_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI26_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI26_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI26_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI26_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI26_0_0RCTPathCreateWithRoundedRect(pathRect, ABI26_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI26_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
                           ...
                           BOOL drawToEdge)
{
  ...
  switch (borderStyle) {
    case ABI26_0_0RCTBorderStyleSolid:
      return ABI26_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI26_0_0RCTBorderStyleDashed:
    case ABI26_0_0RCTBorderStyleDotted:
      return ABI26_0_0RCTGetDashedOrDottedBorderImage(borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI26_0_0RCTBorderStyleUnset:
      break;
  }
