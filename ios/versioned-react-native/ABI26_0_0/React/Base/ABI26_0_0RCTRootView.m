...
#import "ABI26_0_0RCTRootViewDelegate.h"
...
#import "ABI26_0_0RCTKeyCommands.h"
...
#if TARGET_OS_TV
#import "ABI26_0_0RCTTVRemoteHandler.h"
#import "ABI26_0_0RCTTVNavigationEventEmitter.h"
#endif

NSString *const ABI26_0_0RCTContentDidAppearNotification = @"ABI26_0_0RCTContentDidAppearNotification";

@interface ABI26_0_0RCTUIManager (ABI26_0_0RCTRootView)

- (NSNumber *)allocateRootTag;

@end

@implementation ABI26_0_0RCTRootView
{
  ABI26_0_0RCTBridge *_bridge;
  NSString *_moduleName;
  ABI26_0_0RCTRootContentView *_contentView;
             ...
             initialProperties:(NSDictionary *)initialProperties
{
  ...
  ABI26_0_0RCTAssert(bridge, @"A bridge instance is required to create an ABI26_0_0RCTRootView");
  ABI26_0_0RCTAssert(moduleName, @"A moduleName is required to create an ABI26_0_0RCTRootView");

  ABI26_0_0RCT_PROFILE_BEGIN_EVENT(ABI26_0_0RCTProfileTagAlways, @"-[ABI26_0_0RCTRootView init]", nil);
  if (!bridge.isLoading) {
    [bridge.performanceLogger markStartForTag:ABI26_0_0RCTPLTTI];
  }
  ...
  if (self = [super initWithFrame:CGRectZero]) {
    ...
    _sizeFlexibility = ABI26_0_0RCTRootViewSizeFlexibilityNone;
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(hideLoadingView)
                                                 name:ABI26_0_0RCTContentDidAppearNotification
                                               object:self];

#if TARGET_OS_TV
    self.tvRemoteHandler = [ABI26_0_0RCTTVRemoteHandler new];
...
{
  ABI26_0_0RCTBridge *bridge = [[ABI26_0_0RCTBridge alloc] initWithBundleURL:bundleURL
                                            moduleProvider:nil
...
{
  if (self.ReactABI26_0_0PreferredFocusedView) {
    return self.ReactABI26_0_0PreferredFocusedView;
  }
...
- (CGSize)sizeThatFits:(CGSize)size
{
  ...
  fitSize = CGSizeMake(
      _sizeFlexibility & ABI26_0_0RCTRootViewSizeFlexibilityWidth ? fitSize.width : currentSize.width,
      _sizeFlexibility & ABI26_0_0RCTRootViewSizeFlexibilityHeight ? fitSize.height : currentSize.height
    );
...
{
  return _ReactABI26_0_0ViewController ?: [super ReactABI26_0_0ViewController];
}
...
{
  ABI26_0_0RCTAssertMainQueue();
  if (!super.ReactABI26_0_0Tag) {
    /**
     * Every root view that is created must have a unique ReactABI26_0_0 tag.
     * Numbering of these tags goes from 1, 11, 21, 31, etc
     *
     * NOTE: Since the bridge persists, the RootViews might be reused, so the
     * ReactABI26_0_0 tag must be re-assigned every time a new UIManager is created.
     */
    self.ReactABI26_0_0Tag = ABI26_0_0RCTAllocateRootViewTag();
  }
  return super.ReactABI26_0_0Tag;
}

- (void)bridgeDidReload
{
  ABI26_0_0RCTAssertMainQueue();
  // Clear the ReactABI26_0_0Tag so it can be re-assigned
  self.ReactABI26_0_0Tag = nil;
}
...
- (void)javaScriptDidLoad:(NSNotification *)notification
{
  ...
  // ABI26_0_0RCTRootContentView is scoped to the right bridge
...
- (void)bundleFinishedLoading:(ABI26_0_0RCTBridge *)bridge
{
  ABI26_0_0RCTAssert(bridge != nil, @"Bridge cannot be nil");
  if (!bridge.valid) {
    return;
  }

  [_contentView removeFromSuperview];
  _contentView = [[ABI26_0_0RCTRootContentView alloc] initWithFrame:self.bounds
                                                    bridge:bridge
  ...
  if (_sizeFlexibility == ABI26_0_0RCTRootViewSizeFlexibilityNone) {
    self.intrinsicContentSize = self.bounds.size;
  }
}

- (void)runApplication:(ABI26_0_0RCTBridge *)bridge
{
  NSString *moduleName = _moduleName ?: @"";
  NSDictionary *appParameters = @{
    @"rootTag": _contentView.ReactABI26_0_0Tag,
    @"initialProps": _appProperties ?: @{},
  };

  ABI26_0_0RCTLogInfo(@"Running application %@ (%@)", moduleName, appParameters);
...
@implementation ABI26_0_0RCTRootView (Deprecated)

- (CGSize)intrinsicSize
{
  ABI26_0_0RCTLogWarn(@"Calling deprecated `[-ABI26_0_0RCTRootView intrinsicSize]`.");
