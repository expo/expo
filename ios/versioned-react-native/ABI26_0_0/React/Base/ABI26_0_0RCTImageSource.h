 ...
 */
@interface ABI26_0_0RCTImageSource : NSObject
...
@interface ABI26_0_0RCTConvert (ImageSource)

+ (ABI26_0_0RCTImageSource *)ABI26_0_0RCTImageSource:(id)json;
+ (NSArray<ABI26_0_0RCTImageSource *> *)ABI26_0_0RCTImageSourceArray:(id)json;
