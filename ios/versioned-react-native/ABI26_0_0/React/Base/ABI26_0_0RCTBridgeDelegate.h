...
@protocol ABI26_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI26_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI26_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray<id<ABI26_0_0RCTBridgeModule>> *)extraModulesForBridge:(ABI26_0_0RCTBridge *)bridge;
 ...
 * previously called facebook::ReactABI26_0_0::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI26_0_0RCTBridge *)bridge;

/**
 * Configure whether the legacy ABI26_0_0RCTBatchedBridge or new ABI26_0_0RCTCxxBridge
 ...
 * implemented, the implementation will default to ABI26_0_0RCTBatchedBridge,
 * but if it is not linked in, will try ABI26_0_0RCTCxxBridge instead.  If
 ...
 * @experimental
 */
- (BOOL)shouldBridgeUseCxxBridge:(ABI26_0_0RCTBridge *)bridge;
...
*/
- (BOOL)bridge:(ABI26_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI26_0_0RCTBridge *)bridge
                 onProgress:(ABI26_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI26_0_0RCTSourceLoadBlock)loadCallback;
 ...
 */
- (void)loadSourceForBridge:(ABI26_0_0RCTBridge *)bridge
                  withBlock:(ABI26_0_0RCTSourceLoadBlock)loadCallback;
