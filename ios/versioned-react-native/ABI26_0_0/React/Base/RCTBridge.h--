...
@class ABI26_0_0RCTPerformanceLogger;

/**
 * This notification fires when the bridge starts loading the JS bundle.
 */
ABI26_0_0RCT_EXTERN NSString *const ABI26_0_0RCTJavaScriptWillStartLoadingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI26_0_0RCT_EXTERN NSString *const ABI26_0_0RCTJavaScriptDidLoadNotification;
 ...
 */
ABI26_0_0RCT_EXTERN NSString *const ABI26_0_0RCTDidInitializeModuleNotification;

/**
 * This notification fires just before the bridge starts processing a request to
 * reload.
 */
ABI26_0_0RCT_EXTERN NSString *const ABI26_0_0RCTBridgeWillReloadNotification;

/**
 * This notification fires just before the bridge begins downloading a script
 * from the packager.
 */
ABI26_0_0RCT_EXTERN NSString *const ABI26_0_0RCTBridgeWillDownloadScriptNotification;

/**
 * This notification fires just after the bridge finishes downloading a script
 * from the packager.
 */
ABI26_0_0RCT_EXTERN NSString *const ABI26_0_0RCTBridgeDidDownloadScriptNotification;

/**
 * Key for the ABI26_0_0RCTSource object in the ABI26_0_0RCTBridgeDidDownloadScriptNotification
 * userInfo dictionary.
 */
ABI26_0_0RCT_EXTERN NSString *const ABI26_0_0RCTBridgeDidDownloadScriptNotificationSourceKey;
 ...
 */
typedef NSArray<id<ABI26_0_0RCTBridgeModule>> *(^ABI26_0_0RCTBridgeModuleListProvider)(void);

/**
 * This function returns the module name for a given class.
 */
ABI26_0_0RCT_EXTERN NSString *ABI26_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI26_0_0RCTBridge : NSObject <ABI26_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI26_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI26_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 * See also -[ABI26_0_0RCTBridgeDelgate shouldBridgeLoadJavaScriptSynchronously], which
 ...
 */
@property (nonatomic, weak, readonly) id<ABI26_0_0RCTBridgeDelegate> delegate;
...
/**
 * Link to the Performance Logger that logs ReactABI26_0_0 Native perf events.
 */
@property (nonatomic, readonly, strong) ABI26_0_0RCTPerformanceLogger *performanceLogger;
