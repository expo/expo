...
#import <ReactABI26_0_0/ABI26_0_0RCTSurfaceSizeMeasureMode.h>
#import <ReactABI26_0_0/ABI26_0_0RCTSurfaceStage.h>

@class ABI26_0_0RCTBridge;
@class ABI26_0_0RCTSurface;

typedef UIView *(^ABI26_0_0RCTSurfaceHostingViewActivityIndicatorViewFactory)();
 ...
 * of ReactABI26_0_0Native-powered experiences in UIKit based apps.
 */
@interface ABI26_0_0RCTSurfaceHostingView : UIView
...
/**
 * Size measure mode which are defining relationship between UIKit and ReactABI26_0_0Native
 * layout approaches.
 * Defaults to `ABI26_0_0RCTSurfaceSizeMeasureModeWidthAtMost | ABI26_0_0RCTSurfaceSizeMeasureModeHeightAtMost`.
 */
@property (nonatomic, assign) ABI26_0_0RCTSurfaceSizeMeasureMode sizeMeasureMode;
 ...
 */
@property (nonatomic, copy, nullable) ABI26_0_0RCTSurfaceHostingViewActivityIndicatorViewFactory activityIndicatorViewFactory;
