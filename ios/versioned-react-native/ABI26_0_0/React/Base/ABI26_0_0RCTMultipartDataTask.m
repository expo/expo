...
#import "ABI26_0_0RCTMultipartDataTask.h"

@interface ABI26_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI26_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI26_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI26_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI26_0_0RCTMultipartStreamReader *reader = [[ABI26_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI26_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
