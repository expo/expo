...
typedef id<ABI26_0_0RCTBridgeModule>(^ABI26_0_0RCTBridgeModuleProvider)(void);

@interface ABI26_0_0RCTModuleData : NSObject <ABI26_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI26_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI26_0_0RCTBridgeModule> instance;
