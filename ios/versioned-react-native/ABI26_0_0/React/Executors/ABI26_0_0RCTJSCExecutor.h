...
typedef void (^ABI26_0_0RCTJavaScriptValueCallback)(JSValue *result, NSError *error);

/**
 * Default name for the JS thread
 */
ABI26_0_0RCT_EXTERN NSString *const ABI26_0_0RCTJSCThreadName;
 ...
 */
ABI26_0_0RCT_EXTERN NSString *const ABI26_0_0RCTJavaScriptContextCreatedNotification;

/**
 * Uses a JavaScriptCore context as the execution engine.
 */
@interface ABI26_0_0RCTJSCExecutor : NSObject <ABI26_0_0RCTJavaScriptExecutor>

/**
 * Returns whether executor uses custom JSC library.
 * This value is used to initialize ABI26_0_0RCTJSCWrapper.
 * @default is NO.
 */
 ...
 * @default is "ABI26_0_0RCTJSContext"
 */
@property (nonatomic, copy) NSString *contextName;

/**
 * Inits a new executor instance with given flag that's used
 * to initialize ABI26_0_0RCTJSCWrapper.
 */
...
- (void)callFunctionOnModule:(NSString *)module
             ...
             jsValueCallback:(ABI26_0_0RCTJavaScriptValueCallback)onComplete;
...
/**
 * @experimental
 * May be used to pre-create the JSContext to make ABI26_0_0RCTJSCExecutor creation less costly.
 * Avoid using this; it's experimental and is not likely to be supported long-term.
 */
@interface ABI26_0_0RCTJSContextProvider : NSObject
...
/**
 * @experimental
 * Create an ABI26_0_0RCTJSCExecutor from an provider instance. This may only be called once.
