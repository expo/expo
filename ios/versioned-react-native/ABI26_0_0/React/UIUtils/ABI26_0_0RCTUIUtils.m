...
ABI26_0_0RCTDimensions ABI26_0_0RCTGetDimensions(CGFloat fontScale)
{
  UIScreen *mainScreen = UIScreen.mainScreen;
  CGSize screenSize = mainScreen.bounds.size;
  ABI26_0_0RCTDimensions result;
...
CGFloat ABI26_0_0RCTGetMultiplierForContentSizeCategory(UIContentSizeCategory category)
{
