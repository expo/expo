...
#include "ABI20_0_0JSCExecutor.h"
...
#include "ABI20_0_0JSCTracing.h"
#endif

#ifdef WITH_JSC_EXTRA_TRACING
#include "ABI20_0_0JSCLegacyProfiler.h"
#include "ABI20_0_0JSCLegacyTracing.h"
#endif
...
void JSCExecutor::loadApplicationScript(std::unique_ptr<const JSBigString> script, std::string sourceURL) {
  ...
  ReactABI20_0_0Marker::logTaggedMarker(ReactABI20_0_0Marker::RUN_JS_BUNDLE_START, scriptName.c_str());
  ...
  if (auto fileStr = dynamic_cast<const JSBigFileString *>(script.get())) {
    ...
    case JSLoadSourceIsCompiled:
      ...
      ReactABI20_0_0Marker::logMarker(ReactABI20_0_0Marker::CREATE_REACT_CONTEXT_STOP);
      ReactABI20_0_0Marker::logMarker(ReactABI20_0_0Marker::RUN_JS_BUNDLE_STOP);
      return;
...
#endif
  {
    String jsScript;
    {
      ...
      ReactABI20_0_0Marker::logMarker(ReactABI20_0_0Marker::JS_BUNDLE_STRING_CONVERT_START);
      jsScript = adoptString(std::move(script));
      ReactABI20_0_0Marker::logMarker(ReactABI20_0_0Marker::JS_BUNDLE_STRING_CONVERT_STOP);
    }
...
void JSCExecutor::stopProfiler(const std::string &titleString, const std::string& filename) {
  #ifdef WITH_JSC_EXTRA_TRACING
  String title(m_context, titleString.c_str());
  facebook::ReactABI20_0_0::stopAndOutputProfilingFile(m_context, title, filename.c_str());
  #endif
}
...
JSValueRef JSCExecutor::nativeRequire(
  ...
  ReactABI20_0_0Marker::logMarker(ReactABI20_0_0Marker::NATIVE_REQUIRE_START);
  loadModule(moduleId);
  ReactABI20_0_0Marker::logMarker(ReactABI20_0_0Marker::NATIVE_REQUIRE_STOP);
