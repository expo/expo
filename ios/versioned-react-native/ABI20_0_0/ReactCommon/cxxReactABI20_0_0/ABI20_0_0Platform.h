...
#include <cxxReactABI20_0_0/ABI20_0_0JSExecutor.h>
...
namespace ReactABI20_0_0Marker {

enum ReactABI20_0_0MarkerId {
...
using LogTaggedMarker = std::function<void(const ReactABI20_0_0MarkerId, const char* tag)>;
extern RN_EXPORT LogTaggedMarker logTaggedMarker;

extern void logMarker(const ReactABI20_0_0MarkerId markerId);
