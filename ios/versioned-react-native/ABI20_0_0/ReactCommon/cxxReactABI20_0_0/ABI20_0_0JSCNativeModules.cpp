...
#include "ABI20_0_0JSCNativeModules.h"

#include <string>

#include "ABI20_0_0Platform.h"
...
folly::Optional<Object> JSCNativeModules::createModule(const std::string& name, JSContextRef context) {
  ReactABI20_0_0Marker::logTaggedMarker(ReactABI20_0_0Marker::NATIVE_MODULE_SETUP_START, name.c_str());
  ...
  ReactABI20_0_0Marker::logTaggedMarker(ReactABI20_0_0Marker::NATIVE_MODULE_SETUP_STOP, name.c_str());
