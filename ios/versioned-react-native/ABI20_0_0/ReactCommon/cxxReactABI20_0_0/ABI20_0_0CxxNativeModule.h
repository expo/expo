...
#include <cxxReactABI20_0_0/ABI20_0_0CxxModule.h>
#include <cxxReactABI20_0_0/ABI20_0_0NativeModule.h>
...
public:
  ...
  void invoke(unsigned int ReactABI20_0_0MethodId, folly::dynamic&& params, int callId) override;
