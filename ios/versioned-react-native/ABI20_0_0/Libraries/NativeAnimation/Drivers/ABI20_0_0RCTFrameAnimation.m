...
@implementation ABI20_0_0RCTFrameAnimation
{
  ...
  ABI20_0_0RCTResponseSenderBlock _callback;
...
- (instancetype)initWithId:(NSNumber *)animationId
                   ...
                   forNode:(ABI20_0_0RCTValueAnimatedNode *)valueNode
                  callBack:(nullable ABI20_0_0RCTResponseSenderBlock)callback;
{
  if ((self = [super init])) {
    NSNumber *toValue = [ABI20_0_0RCTConvert NSNumber:config[@"toValue"]] ?: @1;
    NSArray<NSNumber *> *frames = [ABI20_0_0RCTConvert NSNumberArray:config[@"frames"]];
    NSNumber *iterations = [ABI20_0_0RCTConvert NSNumber:config[@"iterations"]] ?: @1;
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  NSUInteger startIndex = floor(currentDuration / ABI20_0_0RCTSingleFrameInterval);
  ...
  NSTimeInterval fromInterval = startIndex * ABI20_0_0RCTSingleFrameInterval;
  NSTimeInterval toInterval = nextIndex * ABI20_0_0RCTSingleFrameInterval;
  ...
  CGFloat frameOutput = ABI20_0_0RCTInterpolateValue(currentDuration,
                                            fromInterval,
                                            toInterval,
                                            fromFrameValue.doubleValue,
                                            toFrameValue.doubleValue,
                                            ABI20_0_0EXTRAPOLATE_TYPE_EXTEND,
                                            ABI20_0_0EXTRAPOLATE_TYPE_EXTEND);
...
{
  CGFloat outputValue = ABI20_0_0RCTInterpolateValue(frameOutput,
                                            0,
                                            1,
                                            _fromValue,
                                            _toValue,
