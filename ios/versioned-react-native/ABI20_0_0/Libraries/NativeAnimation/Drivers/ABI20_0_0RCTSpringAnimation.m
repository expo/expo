...
@interface ABI20_0_0RCTSpringAnimation ()
...
@implementation ABI20_0_0RCTSpringAnimation
{
  CGFloat _toValue;
  CGFloat _fromValue;
                  ...
                  callBack:(nullable ABI20_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _toValue = [ABI20_0_0RCTConvert CGFloat:config[@"toValue"]];
    _fromValue = valueNode.value;
    _valueNode = valueNode;
    _overshootClamping = [ABI20_0_0RCTConvert BOOL:config[@"overshootClamping"]];
    _restDisplacementThreshold = [ABI20_0_0RCTConvert CGFloat:config[@"restDisplacementThreshold"]];
    _restSpeedThreshold = [ABI20_0_0RCTConvert CGFloat:config[@"restSpeedThreshold"]];
    _tension = [ABI20_0_0RCTConvert CGFloat:config[@"tension"]];
    _friction = [ABI20_0_0RCTConvert CGFloat:config[@"friction"]];
    _initialVelocity = [ABI20_0_0RCTConvert CGFloat:config[@"initialVelocity"]];
