...
@interface ABI20_0_0RCTDecayAnimation ()
...
@implementation ABI20_0_0RCTDecayAnimation
{
  CGFloat _velocity;
                  ...
                  callBack:(nullable ABI20_0_0RCTResponseSenderBlock)callback;
{
  if ((self = [super init])) {
    ...
    _velocity = [ABI20_0_0RCTConvert CGFloat:config[@"velocity"]];
    _deceleration = [ABI20_0_0RCTConvert CGFloat:config[@"deceleration"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  if (_frameStartTime == -1) {
    ...
    _frameStartTime = currentTime - ABI20_0_0RCTSingleFrameInterval;
