...
@implementation ABI20_0_0RCTAnimatedNode
{
  NSMutableDictionary<NSNumber *, ABI20_0_0RCTAnimatedNode *> *_childNodes;
  NSMutableDictionary<NSNumber *, ABI20_0_0RCTAnimatedNode *> *_parentNodes;
}
...
- (NSDictionary<NSNumber *, ABI20_0_0RCTAnimatedNode *> *)childNodes
{
  return _childNodes;
}

- (NSDictionary<NSNumber *, ABI20_0_0RCTAnimatedNode *> *)parentNodes
{
  return _parentNodes;
}

- (void)addChild:(ABI20_0_0RCTAnimatedNode *)child
{
  if (!_childNodes) {
...
- (void)removeChild:(ABI20_0_0RCTAnimatedNode *)child
{
  if (!_childNodes) {
    return;
  }
...
- (void)detachNode
{
  for (ABI20_0_0RCTAnimatedNode *parent in _parentNodes.allValues) {
    [parent removeChild:self];
  }
  for (ABI20_0_0RCTAnimatedNode *child in _childNodes.allValues) {
