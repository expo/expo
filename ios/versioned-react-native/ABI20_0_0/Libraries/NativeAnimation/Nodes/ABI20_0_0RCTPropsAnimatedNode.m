...
@implementation ABI20_0_0RCTPropsAnimatedNode
{
...
- (void)performUpdate
{
  ...
  [self.parentNodes enumerateKeysAndObjectsUsingBlock:^(NSNumber *_Nonnull parentTag, ABI20_0_0RCTAnimatedNode *_Nonnull parentNode, BOOL *_Nonnull stop) {

    if ([parentNode isKindOfClass:[ABI20_0_0RCTStyleAnimatedNode class]]) {
      [self->_propsDictionary addEntriesFromDictionary:[(ABI20_0_0RCTStyleAnimatedNode *)parentNode propsDictionary]];

    } else if ([parentNode isKindOfClass:[ABI20_0_0RCTValueAnimatedNode class]]) {
      NSString *property = [self propertyNameForParentTag:parentTag];
      CGFloat value = [(ABI20_0_0RCTValueAnimatedNode *)parentNode value];
