...
@implementation ABI20_0_0RCTDiffClampAnimatedNode
{
...
{
  ABI20_0_0RCTValueAnimatedNode *inputNode = (ABI20_0_0RCTValueAnimatedNode *)self.parentNodes[_inputNodeTag];
  if (![inputNode isKindOfClass:[ABI20_0_0RCTValueAnimatedNode class]]) {
    ABI20_0_0RCTLogError(@"Illegal node ID set as an input for Animated.DiffClamp node");
    return 0;
  }
