...
typedef NS_ENUM(NSInteger, ABI20_0_0RCTTestStatus) {
  ABI20_0_0RCTTestStatusPending = 0,
  ABI20_0_0RCTTestStatusPassed,
  ABI20_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI20_0_0RCTTestModule : NSObject <ABI20_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI20_0_0RCTTestStatus status;
