...
#import "ABI20_0_0RCTImagePickerManager.h"

#import <MobileCoreServices/UTCoreTypes.h>
#import <UIKit/UIKit.h>

#import <ReactABI20_0_0/ABI20_0_0RCTConvert.h>
#import <ReactABI20_0_0/ABI20_0_0RCTImageStoreManager.h>
#import <ReactABI20_0_0/ABI20_0_0RCTRootView.h>
#import <ReactABI20_0_0/ABI20_0_0RCTUtils.h>

@interface ABI20_0_0RCTImagePickerManager () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation ABI20_0_0RCTImagePickerManager
{
  NSMutableArray<UIImagePickerController *> *_pickers;
  NSMutableArray<ABI20_0_0RCTResponseSenderBlock> *_pickerCallbacks;
  NSMutableArray<ABI20_0_0RCTResponseSenderBlock> *_pickerCancelCallbacks;
}

ABI20_0_0RCT_EXPORT_MODULE(ImagePickerIOS);
...
ABI20_0_0RCT_EXPORT_METHOD(canRecordVideos:(ABI20_0_0RCTResponseSenderBlock)callback)
{
...
ABI20_0_0RCT_EXPORT_METHOD(canUseCamera:(ABI20_0_0RCTResponseSenderBlock)callback)
{
  callback(@[@([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])]);
}

ABI20_0_0RCT_EXPORT_METHOD(openCameraDialog:(NSDictionary *)config
                  successCallback:(ABI20_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI20_0_0RCTResponseSenderBlock)cancelCallback)
{
  ...
  if ([ABI20_0_0RCTConvert BOOL:config[@"videoMode"]]) {
...
ABI20_0_0RCT_EXPORT_METHOD(openSelectDialog:(NSDictionary *)config
                  successCallback:(ABI20_0_0RCTResponseSenderBlock)callback
                  cancelCallback:(ABI20_0_0RCTResponseSenderBlock)cancelCallback)
{
  if (ABI20_0_0RCTRunningInAppExtension()) {
  ...
  if ([ABI20_0_0RCTConvert BOOL:config[@"showImages"]]) {
    [allowedTypes addObject:(NSString *)kUTTypeImage];
  }
  if ([ABI20_0_0RCTConvert BOOL:config[@"showVideos"]]) {
...
didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info
{
  ...
  if (imageURL) {
    [self _dismissPicker:picker args:@[imageURL.absoluteString, ABI20_0_0RCTNullIfNil(height), ABI20_0_0RCTNullIfNil(width)]];
    return;
  }
        ...
        cancelCallback:(ABI20_0_0RCTResponseSenderBlock)cancelCallback
{
  ...
  UIViewController *rootViewController = ABI20_0_0RCTPresentedViewController();
...
- (void)_dismissPicker:(UIImagePickerController *)picker args:(NSArray *)args
{
  ...
  ABI20_0_0RCTResponseSenderBlock successCallback = _pickerCallbacks[index];
  ABI20_0_0RCTResponseSenderBlock cancelCallback = _pickerCancelCallbacks[index];
