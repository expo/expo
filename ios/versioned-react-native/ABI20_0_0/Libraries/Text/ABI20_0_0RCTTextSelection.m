...
@implementation ABI20_0_0RCTTextSelection
...
@implementation ABI20_0_0RCTConvert (ABI20_0_0RCTTextSelection)
...
+ (ABI20_0_0RCTTextSelection *)ABI20_0_0RCTTextSelection:(id)json
{
  if ([json isKindOfClass:[NSDictionary class]]) {
    ...
    return [[ABI20_0_0RCTTextSelection alloc] initWithStart:start end:end];
  }
