...
@implementation ABI20_0_0RCTUITextView
{
...
- (CGSize)placeholderSize
{
  ...
  placeholderSize = CGSizeMake(ABI20_0_0RCTCeilPixelValue(placeholderSize.width), ABI20_0_0RCTCeilPixelValue(placeholderSize.height));
