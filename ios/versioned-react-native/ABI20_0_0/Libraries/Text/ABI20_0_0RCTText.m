...
static void collectNonTextDescendants(ABI20_0_0RCTText *view, NSMutableArray *nonTextDescendants)
{
  for (UIView *child in view.ReactABI20_0_0Subviews) {
    if ([child isKindOfClass:[ABI20_0_0RCTText class]]) {
      collectNonTextDescendants((ABI20_0_0RCTText *)child, nonTextDescendants);
...
@implementation ABI20_0_0RCTText
{
...
- (NSString *)description
{
  ...
  NSString *replacement = [NSString stringWithFormat:@"; ReactABI20_0_0Tag: %@; text: %@", self.ReactABI20_0_0Tag, self.textStorage.string];
...
- (void)drawRect:(CGRect)rect
{
  ...
  [layoutManager.textStorage enumerateAttribute:ABI20_0_0RCTIsHighlightedAttributeName inRange:characterRange options:0 usingBlock:^(NSNumber *value, NSRange range, BOOL *_) {
    if (!value.boolValue) {
      return;
    }
...
{
  NSNumber *ReactABI20_0_0Tag = self.ReactABI20_0_0Tag;
  ...
  if (_textStorage.length > 0 && (fraction > 0 || characterIndex > 0) && (fraction < 1 || characterIndex < _textStorage.length - 1)) {
    ReactABI20_0_0Tag = [_textStorage attribute:ABI20_0_0RCTReactABI20_0_0TagAttributeName atIndex:characterIndex effectiveRange:NULL];
  }
