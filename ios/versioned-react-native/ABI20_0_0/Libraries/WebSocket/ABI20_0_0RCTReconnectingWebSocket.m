...
@interface ABI20_0_0RCTReconnectingWebSocket () <ABI20_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI20_0_0RCTReconnectingWebSocket {
  NSURL *_url;
  ABI20_0_0RCTSRWebSocket *_socket;
}
...
{
  [self stop];
  _socket = [[ABI20_0_0RCTSRWebSocket alloc] initWithURL:_url];
...
- (void)reconnect
{
  __weak ABI20_0_0RCTSRWebSocket *socket = _socket;
...
- (void)webSocket:(ABI20_0_0RCTSRWebSocket *)webSocket didCloseWithCode:(NSInteger)code reason:(NSString *)reason wasClean:(BOOL)wasClean
{
  [self reconnect];
}
