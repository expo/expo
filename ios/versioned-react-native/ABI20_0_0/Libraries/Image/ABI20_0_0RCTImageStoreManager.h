...
@interface ABI20_0_0RCTImageStoreManager : NSObject <ABI20_0_0RCTURLRequestHandler>
...
@interface ABI20_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI20_0_0RCTBridge (ABI20_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI20_0_0RCTImageStoreManager *imageStoreManager;
