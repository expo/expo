...
#import <ReactABI20_0_0/ABI20_0_0RCTResizeMode.h>
#import <ReactABI20_0_0/ABI20_0_0RCTURLRequestHandler.h>

typedef void (^ABI20_0_0RCTImageLoaderProgressBlock)(int64_t progress, int64_t total);
typedef void (^ABI20_0_0RCTImageLoaderPartialLoadBlock)(UIImage *image);
typedef void (^ABI20_0_0RCTImageLoaderCompletionBlock)(NSError *error, UIImage *image);
typedef dispatch_block_t ABI20_0_0RCTImageLoaderCancellationBlock;

/**
 * Provides an interface to use for providing a image caching strategy.
 */
@protocol ABI20_0_0RCTImageCache <NSObject>

- (UIImage *)imageForUrl:(NSString *)url
                    size:(CGSize)size
                   scale:(CGFloat)scale
              resizeMode:(ABI20_0_0RCTResizeMode)resizeMode
...
@interface UIImage (ReactABI20_0_0)

@property (nonatomic, copy) CAKeyframeAnimation *ReactABI20_0_0KeyframeAnimation;

@end

@interface ABI20_0_0RCTImageLoader : NSObject <ABI20_0_0RCTBridgeModule, ABI20_0_0RCTURLRequestHandler>
 ...
 */
- (ABI20_0_0RCTImageLoaderCancellationBlock)loadImageWithURLRequest:(NSURLRequest *)imageURLRequest
                                                  callback:(ABI20_0_0RCTImageLoaderCompletionBlock)callback;
...
- (ABI20_0_0RCTImageLoaderCancellationBlock)loadImageWithURLRequest:(NSURLRequest *)imageURLRequest
                                                ...
                                                resizeMode:(ABI20_0_0RCTResizeMode)resizeMode
                                             progressBlock:(ABI20_0_0RCTImageLoaderProgressBlock)progressBlock
                                          partialLoadBlock:(ABI20_0_0RCTImageLoaderPartialLoadBlock)partialLoadBlock
                                           completionBlock:(ABI20_0_0RCTImageLoaderCompletionBlock)completionBlock;
 ...
 */
- (ABI20_0_0RCTImageLoaderCancellationBlock)decodeImageData:(NSData *)imageData
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                           clipped:(BOOL)clipped
                                        resizeMode:(ABI20_0_0RCTResizeMode)resizeMode
 ...
 */
- (ABI20_0_0RCTImageLoaderCancellationBlock)getImageSizeForURLRequest:(NSURLRequest *)imageURLRequest
                                                       block:(void(^)(NSError *error, CGSize size))completionBlock;

/**
 * Allows developers to set their own caching implementation for
 * decoded images as long as it conforms to the ABI20_0_0RCTImageCacheDelegate
 * protocol. This method should be called in bridgeDidInitializeModule.
 */
- (void)setImageCache:(id<ABI20_0_0RCTImageCache>)cache;

@end

@interface ABI20_0_0RCTBridge (ABI20_0_0RCTImageLoader)

/**
 * The shared image loader instance
 */
@property (nonatomic, readonly) ABI20_0_0RCTImageLoader *imageLoader;
 ...
 */
@protocol ABI20_0_0RCTImageURLLoader <ABI20_0_0RCTBridgeModule>
 ...
 * applicable.
 */
- (ABI20_0_0RCTImageLoaderCancellationBlock)loadImageForURL:(NSURL *)imageURL
                                              size:(CGSize)size
                                             scale:(CGFloat)scale
                                        resizeMode:(ABI20_0_0RCTResizeMode)resizeMode
                                   progressHandler:(ABI20_0_0RCTImageLoaderProgressBlock)progressHandler
                                partialLoadHandler:(ABI20_0_0RCTImageLoaderPartialLoadBlock)partialLoadHandler
                                 completionHandler:(ABI20_0_0RCTImageLoaderCompletionBlock)completionHandler;

@optional

/**
 * If more than one ABI20_0_0RCTImageURLLoader responds YES to `-canLoadImageURL:`
 ...
 *
 * Use with care: disabling scheduling will reduce ABI20_0_0RCTImageLoader's ability to throttle
 * network requests.
 */
 ...
 * are also bridge modules, so should be registered using ABI20_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI20_0_0RCTImageDataDecoder <ABI20_0_0RCTBridgeModule>
...
/**
 * If more than one ABI20_0_0RCTImageDataDecoder responds YES to `-canDecodeImageData:`
