...
#import "ABI20_0_0RCTLinkingManager.h"
...
NSString *const ABI20_0_0RCTOpenURLNotification = @"ABI20_0_0RCTOpenURLNotification";


static void postNotificationWithURL(NSURL *URL, id sender)
{
  NSDictionary<NSString *, id> *payload = @{@"url": URL.absoluteString};
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI20_0_0RCTOpenURLNotification
                                                        object:sender
                                                      userInfo:payload];
}

@implementation ABI20_0_0RCTLinkingManager
...
- (void)startObserving
{
  [[NSNotificationCenter defaultCenter] addObserver:self
                                           selector:@selector(handleOpenURLNotification:)
                                               name:ABI20_0_0RCTOpenURLNotification
                                             object:nil];
}
                  ...
                  reject:(__unused ABI20_0_0RCTPromiseRejectBlock)reject)
{
  ...
  BOOL canOpen = [ABI20_0_0RCTSharedApplication() canOpenURL:URL];
  resolve(@(canOpen));
}
                  ...
                  reject:(__unused ABI20_0_0RCTPromiseRejectBlock)reject)
{
  ...
  resolve(ABI20_0_0RCTNullIfNil(initialURL.absoluteString));
}
