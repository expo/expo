...
@implementation ABI20_0_0ARTText
...
static void ABI20_0_0ARTFreeTextFrame(ABI20_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI20_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI20_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI20_0_0ARTTextFrame frame = self.textFrame;
