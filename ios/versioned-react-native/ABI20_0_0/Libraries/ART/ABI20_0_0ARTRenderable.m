...
#import "ABI20_0_0ARTRenderable.h"

@implementation ABI20_0_0ARTRenderable

- (void)setFill:(ABI20_0_0ARTBrush *)fill
{
  [self invalidate];
  _fill = fill;
}
...
- (void)setStrokeDash:(ABI20_0_0ARTCGFloatArray)strokeDash
{
