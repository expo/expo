...
@interface ABI20_0_0EXKernelModule ()
...
@property (nonatomic, weak) id<ABI20_0_0EXKernelModuleDelegate> delegate;


@end

@implementation ABI20_0_0EXKernelModule
...
- (void)sendEventWithName:(NSString *)eventName body:(id)body
{
  ...
  [self.bridge enqueueJSCall:@"ABI20_0_0RCTDeviceEventEmitter.emit"
...
ABI20_0_0RCT_REMAP_METHOD(doesCurrentTaskEnableDevtools,
                 doesCurrentTaskEnableDevtoolsWithResolver:(ABI20_0_0RCTPromiseResolveBlock)resolve
...
ABI20_0_0RCT_REMAP_METHOD(shouldCurrentTaskAutoReload,
                 shouldCurrentTaskAutoReloadWithResolver:(ABI20_0_0RCTPromiseResolveBlock)resolve
                 reject:(ABI20_0_0RCTPromiseRejectBlock)reject)
{
  if (_delegate) {
...
ABI20_0_0RCT_REMAP_METHOD(isLegacyMenuBehaviorEnabledAsync,
                 isLegacyMenuBehaviorEnabledWithResolver:(ABI20_0_0RCTPromiseResolveBlock)resolve
...
ABI20_0_0RCT_EXPORT_METHOD(setIsLegacyMenuBehaviorEnabledAsync:(BOOL)isEnabled)
{
  if (_delegate) {
...
ABI20_0_0RCT_REMAP_METHOD(getDevMenuItemsToShow,
                 getDevMenuItemsToShowWithResolver:(ABI20_0_0RCTPromiseResolveBlock)resolve
                 reject:(ABI20_0_0RCTPromiseRejectBlock)reject)
{
...
ABI20_0_0RCT_EXPORT_METHOD(selectDevMenuItemWithKey:(NSString *)key)
{
  if (_delegate) {
...
ABI20_0_0RCT_EXPORT_METHOD(addDevMenu)
{
...
ABI20_0_0RCT_REMAP_METHOD(routeDidForeground,
...
ABI20_0_0RCT_REMAP_METHOD(onEventSuccess,
...
ABI20_0_0RCT_REMAP_METHOD(onEventFailure,
                 eventId:(NSString *)eventId
