...
#if !TARGET_OS_TV
@implementation ABI20_0_0RCTConvert (ABI20_0_0EXStatusBar)
...
@interface ABI20_0_0EXStatusBarManager ()

@property (nonatomic, strong) NSMutableDictionary *capturedStatusBarProperties;

@end

@implementation ABI20_0_0EXStatusBarManager

+ (NSString *)moduleName { return @"ABI20_0_0RCTStatusBarManager"; }
 ...
 */
ABI20_0_0RCT_REMAP_METHOD(_captureProperties,
                 _capturePropertiesWithResolver:(ABI20_0_0RCTPromiseResolveBlock)resolve
 ...
 *  Normally nobody should use this method because it bypasses the JS state used by the StatusBar component.
 */
ABI20_0_0RCT_EXPORT_METHOD(_applyPropertiesAndForget:(NSDictionary *)properties)
{
...
{
  UIApplication *currentApplication = ABI20_0_0RCTSharedApplication();
  return @{
