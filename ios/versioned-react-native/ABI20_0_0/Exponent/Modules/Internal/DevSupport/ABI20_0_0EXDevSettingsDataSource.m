...
NSString *const ABI20_0_0EXDevSettingsUserDefaultsKey = @"ABI20_0_0RCTDevMenu";
NSString *const ABI20_0_0EXDevSettingShakeToShowDevMenu = @"shakeToShow";
NSString *const ABI20_0_0EXDevSettingProfilingEnabled = @"profilingEnabled";
NSString *const ABI20_0_0EXDevSettingHotLoadingEnabled = @"hotLoadingEnabled";
NSString *const ABI20_0_0EXDevSettingLiveReloadEnabled = @"liveReloadEnabled";
NSString *const ABI20_0_0EXDevSettingIsInspectorShown = @"showInspector";
NSString *const ABI20_0_0EXDevSettingIsDebuggingRemotely = @"isDebuggingRemotely";

@interface ABI20_0_0EXDevSettingsDataSource ()
...
@implementation ABI20_0_0EXDevSettingsDataSource {
...
- (instancetype)initWithDefaultValues:(NSDictionary *)defaultValues forExperienceId:(NSString *)experienceId isDevelopment:(BOOL)isDevelopment
{
  if (self = [super init]) {
    ...
    _settingsDisabledInProduction = [NSSet setWithArray:@[
      ABI20_0_0EXDevSettingShakeToShowDevMenu,
      ABI20_0_0EXDevSettingProfilingEnabled,
      ABI20_0_0EXDevSettingHotLoadingEnabled,
      ABI20_0_0EXDevSettingLiveReloadEnabled,
      ABI20_0_0EXDevSettingIsInspectorShown,
      ABI20_0_0EXDevSettingIsDebuggingRemotely,
    ]];
    if (defaultValues) {
...
{
  if (_experienceId) {
    return [NSString stringWithFormat:@"%@/%@", _experienceId, ABI20_0_0EXDevSettingsUserDefaultsKey];
  } else {
    ABI20_0_0RCTLogWarn(@"Can't scope dev settings because bridge is not set");
    return ABI20_0_0EXDevSettingsUserDefaultsKey;
  }
}
