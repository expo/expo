...
- (void)ReactABI20_0_0AppManagerDidInitApp:(id)appManager
{
...
- (void)ReactABI20_0_0AppManagerDidDestroyApp:(id)appManager
{
  if (_tmrReload) {
    [_tmrReload invalidate];
    _tmrReload = nil;
...
- (void)ReactABI20_0_0AppManagerStartedLoadingJavaScript:(id)appManager
{
  if (_onLoadingStart) {
    _onLoadingStart(nil);
  }
...
- (void)ReactABI20_0_0AppManager:(id)appManager loadedJavaScriptWithProgress:(ABI20_0_0RCTLoadingProgress *)progress;
{
...
- (void)ReactABI20_0_0AppManagerFinishedLoadingJavaScript:(id)appManager
{
  if (_viewTestTimer) {
    [_viewTestTimer invalidate];
  }
...
- (void)ReactABI20_0_0AppManager:(id)appManager failedToLoadJavaScriptWithError:(NSError *)error
{
  [self _sendLoadingError:error];
}

- (void)ReactABI20_0_0AppManager:(id)appManager failedToDownloadBundleWithError:(NSError *)error
{
  
}

- (void)ReactABI20_0_0AppManagerDidForeground:(id)appManager
{
