...
// Read-only access to legacy (unscoped) `ABI20_0_0RCTAsyncLocalStorage` backing for
 ...
 * being atomic, unless someone bypasses the `ABI20_0_0RCTAsyncLocalStorage` API.
 *
 * Keys and values must always be strings or an error is returned.
 */
@interface ABI20_0_0EXLegacyAsyncLocalStorage : NSObject <ABI20_0_0RCTBridgeModule,ABI20_0_0RCTInvalidating>
