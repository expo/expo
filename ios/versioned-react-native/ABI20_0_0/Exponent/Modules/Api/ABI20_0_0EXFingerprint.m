...
#import "ABI20_0_0EXFingerprint.h"

#import <LocalAuthentication/LocalAuthentication.h>

@implementation ABI20_0_0EXFingerprint

ABI20_0_0RCT_EXPORT_MODULE(ExponentFingerprint)

ABI20_0_0RCT_EXPORT_METHOD(hasHardwareAsync:(ABI20_0_0RCTPromiseResolveBlock)resolve
...
ABI20_0_0RCT_EXPORT_METHOD(isEnrolledAsync:(ABI20_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI20_0_0RCTPromiseRejectBlock)reject)
{
  LAContext *context = [LAContext new];
  NSError *error = nil;
...
ABI20_0_0RCT_EXPORT_METHOD(authenticateAsync:(NSString *)reason
