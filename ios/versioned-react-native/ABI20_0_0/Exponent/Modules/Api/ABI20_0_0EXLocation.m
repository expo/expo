...
NSString * const ABI20_0_0EXLocationChangedEventName = @"Exponent.locationChanged";
NSString * const ABI20_0_0EXHeadingChangedEventName = @"Exponent.headingChanged";

@interface ABI20_0_0EXLocationDelegate : NSObject <CLLocationManagerDelegate>
...
@implementation ABI20_0_0EXLocationDelegate
...
{
  return @[ABI20_0_0EXLocationChangedEventName, ABI20_0_0EXHeadingChangedEventName];
}

ABI20_0_0RCT_REMAP_METHOD(getProviderStatusAsync,
...
ABI20_0_0RCT_REMAP_METHOD(getCurrentPositionAsync,
...
ABI20_0_0RCT_REMAP_METHOD(watchPositionImplAsync,
                 ...
                 rejecter:(ABI20_0_0RCTPromiseRejectBlock)reject)
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    locMgr.distanceFilter = options[@"distanceInterval"] ? [ABI20_0_0RCTConvert double:options[@"distanceInterval"]] ?: kCLDistanceFilterNone : kCLLocationAccuracyHundredMeters;
    locMgr.desiredAccuracy = [ABI20_0_0RCTConvert BOOL:options[@"enableHighAccuracy"]] ? kCLLocationAccuracyBest : kCLLocationAccuracyHundredMeters;
    
    ABI20_0_0EXLocationDelegate *delegate = [[ABI20_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
      if (locations.lastObject) {
        ...
        [weakSelf sendEventWithName:ABI20_0_0EXLocationChangedEventName body:body];
      }
...
ABI20_0_0RCT_REMAP_METHOD(watchDeviceHeading,
                 watchId:(nonnull NSNumber *)watchId
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    ABI20_0_0EXLocationDelegate *delegate = [[ABI20_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
      if (newHeading) {
        NSNumber *accuracy;
        ...
        [weakSelf sendEventWithName:ABI20_0_0EXHeadingChangedEventName body:body];
      }
...
ABI20_0_0RCT_REMAP_METHOD(removeWatchAsync,
                 watchId:(nonnull NSNumber *)watchId
                 resolver:(ABI20_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI20_0_0RCTPromiseRejectBlock)reject)
{
  ABI20_0_0EXLocationDelegate *delegate = _delegates[watchId];
  if (delegate) {
    __weak typeof(self) weakSelf = self;
    dispatch_async(dispatch_get_main_queue(), ^{
...
ABI20_0_0RCT_REMAP_METHOD(geocodeAsync,
...
ABI20_0_0RCT_REMAP_METHOD(reverseGeocodeAsync,
