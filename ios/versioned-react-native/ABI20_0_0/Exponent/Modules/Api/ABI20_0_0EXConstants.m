...
ABI20_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI20_0_0EXConstants, constants)

@import UIKit.UIApplication;

@interface ABI20_0_0EXConstants ()
...
@implementation ABI20_0_0EXConstants

ABI20_0_0EX_EXPORT_SCOPED_MODULE(ExponentConstants, nil)
...
{
  NSString *expoClientVersion = [[[NSBundle mainBundle] infoDictionary] objectForKey:@"ABI20_0_0EXClientVersion"];
...
ABI20_0_0RCT_REMAP_METHOD(getWebViewUserAgentAsync,
                 getWebViewUserAgentWithResolver:(ABI20_0_0RCTPromiseResolveBlock)resolve
