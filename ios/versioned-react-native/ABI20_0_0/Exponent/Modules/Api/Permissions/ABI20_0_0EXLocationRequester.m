...
@interface ABI20_0_0EXLocationRequester () <CLLocationManagerDelegate>
...
@implementation ABI20_0_0EXLocationRequester
...
+ (NSDictionary *)permissions
{
  ...
  if (!(alwaysUsageDescription || whenInUseUsageDescription)) {
    ABI20_0_0RCTFatal(ABI20_0_0RCTErrorWithMessage(@"This app is missing NSLocationAlwaysUsageDescription or NSLocationWhenInUseUsageDescription, so location services will fail. Add one of these keys to your bundle's Info.plist."));
...
- (void)requestPermissionsWithResolver:(ABI20_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI20_0_0RCTPromiseRejectBlock)reject
{
  ...
  if (existingPermissions && ![existingPermissions[@"status"] isEqualToString:[ABI20_0_0EXPermissions permissionStringForStatus:ABI20_0_0EXPermissionStatusUndetermined]]) {
