...
@interface ABI20_0_0EXCameraPermissionRequester ()

@property (nonatomic, weak) id<ABI20_0_0EXPermissionRequesterDelegate> delegate;

@end

@implementation ABI20_0_0EXCameraPermissionRequester
...
+ (NSDictionary *)permissions
{
  ...
  if (!(cameraUsageDescription && microphoneUsageDescription)) {
    ABI20_0_0RCTFatal(ABI20_0_0RCTErrorWithMessage(@"This app is missing either NSCameraUsageDescription or NSMicrophoneUsageDescription, so audio/video services will fail. Add one of these keys to your bundle's Info.plist."));
