...
- (NSError *)_updateAudioSessionCategory:(AVAudioSession *)audioSession forAudioSessionMode:(ABI20_0_0EXAVAudioSessionMode)audioSessionMode
{
  NSError *error;
     ...
     withRejecter:(ABI20_0_0RCTPromiseRejectBlock)reject
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    UIView *view = [_bridge.uiManager viewForReactABI20_0_0Tag:ReactABI20_0_0Tag];
...
ABI20_0_0RCT_EXPORT_MODULE(ExponentAV);
