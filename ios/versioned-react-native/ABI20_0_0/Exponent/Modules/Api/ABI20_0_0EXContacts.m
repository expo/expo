...
@implementation ABI20_0_0EXContacts

ABI20_0_0EX_EXPORT_SCOPED_MODULE(ExponentContacts, PermissionsManager);
 ...
 */
ABI20_0_0RCT_EXPORT_METHOD(getContactsAsync:(NSDictionary *)options resolver:(ABI20_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI20_0_0RCTPromiseRejectBlock)reject)
{
  if (!_contactStore) {
    _contactStore = [[CNContactStore alloc] init];
  }

  if ([ABI20_0_0EXPermissions statusForPermissions:[ABI20_0_0EXContactsRequester permissions]] != ABI20_0_0EXPermissionStatusGranted ||
