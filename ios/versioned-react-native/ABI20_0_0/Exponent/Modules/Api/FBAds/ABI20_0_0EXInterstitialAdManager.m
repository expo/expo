#import "ABI20_0_0EXInterstitialAdManager.h"
#import "ABI20_0_0EXUnversioned.h"

#import <FBAudienceNetwork/FBAudienceNetwork.h>
#import <ReactABI20_0_0/ABI20_0_0RCTUtils.h>

@interface ABI20_0_0EXInterstitialAdManager () <FBInterstitialAdDelegate>
...
@implementation ABI20_0_0EXInterstitialAdManager

@synthesize bridge = _bridge;

ABI20_0_0RCT_EXPORT_MODULE(CTKInterstitialAdManager)
...
{
  ABI20_0_0RCTAssert(_resolve == nil && _reject == nil, @"Only one `showAd` can be called at once");
  ABI20_0_0RCTAssert(_isBackground == false, @"`showAd` can be called only when experience is running in foreground");
...
{
  [_interstitialAd showAdFromRootViewController:ABI20_0_0RCTPresentedViewController()];
}
...
- (void)bridgeDidForeground:(NSNotification *)notification
{
  ...
  if (_adViewController) {
    [ABI20_0_0RCTPresentedViewController() presentViewController:_adViewController animated:NO completion:nil];
...
- (void)bridgeDidBackground:(NSNotification *)notification
{
  ...
  if (_interstitialAd) {
    _adViewController = ABI20_0_0RCTPresentedViewController();
