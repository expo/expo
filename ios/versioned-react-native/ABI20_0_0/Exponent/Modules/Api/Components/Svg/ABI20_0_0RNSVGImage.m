...
#import <ReactABI20_0_0/ABI20_0_0RCTImageSource.h>
#import <ReactABI20_0_0/ABI20_0_0RCTLog.h>
#import "ABI20_0_0RNSVGViewBox.h"

@implementation ABI20_0_0RNSVGImage
{
    CGImageRef _image;
    CGFloat _imageRatio;
}
...
- (void)setSrc:(id)src
{
    ...
    ABI20_0_0RCTImageSource *source = [ABI20_0_0RCTConvert ABI20_0_0RCTImageSource:src];
    ...
    _image = CGImageRetain([ABI20_0_0RCTConvert CGImage:src]);
    [self invalidate];
}
...
- (void)setMeetOrSlice:(ABI20_0_0RNSVGVBMOS)meetOrSlice
{
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    CGAffineTransform transform = [ABI20_0_0RNSVGViewBox getTransform:vbRect eRect:eRect align:self.align meetOrSlice:self.meetOrSlice fromSymbol:NO];
