...
@implementation ABI20_0_0RNSVGSvgView
{
    NSMutableDictionary<NSString *, ABI20_0_0RNSVGNode *> *_clipPaths;
    NSMutableDictionary<NSString *, ABI20_0_0RNSVGNode *> *_templates;
    NSMutableDictionary<NSString *, ABI20_0_0RNSVGPainter *> *_painters;
    CGRect _boundingBox;
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.align) {
        _viewBoxTransform = [ABI20_0_0RNSVGViewBox getTransform:CGRectMake(self.minX, self.minY, self.vbWidth, self.vbHeight)
                                                 eRect:rect
                                                 align:self.align
    ...
    for (ABI20_0_0RNSVGNode *node in self.subviews) {
...
- (void)defineClipPath:(__kindof ABI20_0_0RNSVGNode *)clipPath clipPathName:(NSString *)clipPathName
{
    if (!_clipPaths) {
...
- (ABI20_0_0RNSVGNode *)getDefinedClipPath:(NSString *)clipPathName
{
    return _clipPaths ? [_clipPaths objectForKey:clipPathName] : nil;
}

- (void)defineTemplate:(ABI20_0_0RNSVGNode *)template templateName:(NSString *)templateName
{
    if (!_templates) {
...
- (ABI20_0_0RNSVGNode *)getDefinedTemplate:(NSString *)templateName
{
    return _templates ? [_templates objectForKey:templateName] : nil;
}


- (void)definePainter:(ABI20_0_0RNSVGPainter *)painter painterName:(NSString *)painterName
{
    if (!_painters) {
...
- (ABI20_0_0RNSVGPainter *)getDefinedPainter:(NSString *)painterName;
{
