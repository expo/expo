...
#import "ABI20_0_0RNSVGGlyphContext.h"

@interface ABI20_0_0RNSVGText : ABI20_0_0RNSVGGroup

@property (nonatomic, assign) ABI20_0_0RNSVGTextAnchor textAnchor;
...
- (ABI20_0_0RNSVGText *)getTextRoot;
- (void)releaseCachedPath;
- (CGPathRef)getGroupPath:(CGContextRef)context;

- (ABI20_0_0RNSVGGlyphContext *)getGlyphContext;
