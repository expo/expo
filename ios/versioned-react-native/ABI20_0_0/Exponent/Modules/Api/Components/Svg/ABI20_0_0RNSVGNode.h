...
#import "ABI20_0_0RNSVGSvgView.h"

/**
 * ABI20_0_0RNSVG nodes are implemented as base UIViews. They should be implementation for all basic
 ＊interfaces for all non-defination nodes.
 */

@interface ABI20_0_0RNSVGNode : UIView

@property (nonatomic, strong) NSString *name;
@property (nonatomic, assign) CGFloat opacity;
@property (nonatomic, assign) ABI20_0_0RNSVGCGFCRule clipRule;
...
/**
 * get ABI20_0_0RNSVGSvgView which ownes current ABI20_0_0RNSVGNode
 */
- (ABI20_0_0RNSVGSvgView *)getSvgView;
...
- (void)traverseSubviews:(BOOL (^)(__kindof ABI20_0_0RNSVGNode *node))block;
