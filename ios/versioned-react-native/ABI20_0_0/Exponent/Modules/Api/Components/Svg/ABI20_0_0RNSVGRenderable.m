...
@implementation ABI20_0_0RNSVGRenderable
{
...
- (void)setFill:(ABI20_0_0RNSVGBrush *)fill
{
    if (fill == _fill) {
        return;
    }
...
- (void)setFillRule:(ABI20_0_0RNSVGCGFCRule)fillRule
{
...
- (void)setStroke:(ABI20_0_0RNSVGBrush *)stroke
{
    if (stroke == _stroke) {
        return;
    }
...
- (void)setStrokeDasharray:(ABI20_0_0RNSVGCGFloatArray)strokeDasharray
{
...
- (void)renderLayerTo:(CGContextRef)context
{
    ...
    if (self.stroke) {
        ...
        ABI20_0_0RNSVGCGFloatArray dash = self.strokeDasharray;
...
- (void)mergeProperties:(__kindof ABI20_0_0RNSVGRenderable *)target
{
