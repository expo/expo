...
#import "ABI20_0_0RNSVGPainterBrush.h"
#import "ABI20_0_0RNSVGSolidColorBrush.h"
#import <ReactABI20_0_0/ABI20_0_0RCTLog.h>
#import <ReactABI20_0_0/ABI20_0_0RCTFont.h>

@implementation ABI20_0_0RCTConvert (ABI20_0_0RNSVG)

ABI20_0_0RCT_ENUM_CONVERTER(ABI20_0_0RNSVGCGFCRule, (@{
                                     @"evenodd": @(kRNSVGCGFCRuleEvenodd),
                                     @"nonzero": @(kRNSVGCGFCRuleNonzero),
                                     }), kRNSVGCGFCRuleNonzero, intValue)

ABI20_0_0RCT_ENUM_CONVERTER(ABI20_0_0RNSVGVBMOS, (@{
                                  @"meet": @(kRNSVGVBMOSMeet),
                                  @"slice": @(kRNSVGVBMOSSlice),
                                  @"none": @(kRNSVGVBMOSNone)
                                  }), kRNSVGVBMOSMeet, intValue)

ABI20_0_0RCT_ENUM_CONVERTER(ABI20_0_0RNSVGTextAnchor, (@{
...
ABI20_0_0RCT_ENUM_CONVERTER(ABI20_0_0RNSVGUnits, (@{
...
+ (ABI20_0_0RNSVGCGFloatArray)ABI20_0_0RNSVGCGFloatArray:(id)json
{
    ...
    ABI20_0_0RNSVGCGFloatArray array;
    array.count = count;
    array.array = nil;
...
+ (ABI20_0_0RNSVGBrush *)ABI20_0_0RNSVGBrush:(id)json
{
    ...
    switch (type) {
        case 0: // solid color
            ...
            return [[ABI20_0_0RNSVGSolidColorBrush alloc] initWithArray:arr];
        case 1: // brush
            return [[ABI20_0_0RNSVGPainterBrush alloc] initWithArray:arr];
        default:
...
{
    return [[ABI20_0_0RNSVGPathParser alloc] initWithPathString: d];
}
...
+ (CGGradientRef)ABI20_0_0RNSVGCGGradient:(id)json offset:(NSUInteger)offset
{
    ...
    ABI20_0_0RNSVGCGFloatArray colorsAndOffsets = [self ABI20_0_0RNSVGCGFloatArray:arr];
