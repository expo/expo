...
#import "ABI20_0_0AIRMapManager.h"
...
#import "ABI20_0_0AIRMapSnapshot.h"
...
@interface ABI20_0_0AIRMapManager() <MKMapViewDelegate>

@end

@implementation ABI20_0_0AIRMapManager

ABI20_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI20_0_0AIRMap *map = [ABI20_0_0AIRMap new];
    map.delegate = self;
...
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(userLocationAnnotationTitle, NSString)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(followsUserLocation, BOOL)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(showsPointsOfInterest, BOOL)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)
...
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(cacheEnabled, BOOL)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(loadingEnabled, BOOL)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(loadingBackgroundColor, UIColor)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(loadingIndicatorColor, UIColor)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(handlePanDrag, BOOL)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(maxDelta, CGFloat)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(minDelta, CGFloat)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(legalLabelInsets, UIEdgeInsets)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, MKMapType)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(onChange, ABI20_0_0RCTBubblingEventBlock)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(onPanDrag, ABI20_0_0RCTBubblingEventBlock)
...
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerSelect, ABI20_0_0RCTDirectEventBlock)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDeselect, ABI20_0_0RCTDirectEventBlock)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragStart, ABI20_0_0RCTDirectEventBlock)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDrag, ABI20_0_0RCTDirectEventBlock)
ABI20_0_0RCT_EXPORT_VIEW_PROPERTY(onMarkerDragEnd, ABI20_0_0RCTDirectEventBlock)
...
ABI20_0_0RCT_CUSTOM_VIEW_PROPERTY(region, MKCoordinateRegion, ABI20_0_0AIRMap)
{
    if (json == nil) return;
    ...
    [view setRegion:[ABI20_0_0RCTConvert MKCoordinateRegion:json] animated:NO];
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI20_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI20_0_0AIRMap class]]) {
            ABI20_0_0RCTLogError(@"Invalid view returned from registry, expecting ABI20_0_0AIRMap, got: %@", view);
        } else {
            [ABI20_0_0AIRMap animateWithDuration:duration/1000 animations:^{
                [(ABI20_0_0AIRMap *)view setRegion:region animated:YES];
            }];
        }
    }];
}
        ...
        withDuration:(CGFloat)duration)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI20_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI20_0_0AIRMap class]]) {
            ...
            ABI20_0_0AIRMap *mapView = (ABI20_0_0AIRMap *)view;
    ...
    [self.bridge.uiManager addUIBlock:^(__unused ABI20_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI20_0_0AIRMap class]]) {
            ...
            NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
                ABI20_0_0AIRMapMarker *marker = (ABI20_0_0AIRMapMarker *)evaluatedObject;
                return [marker isKindOfClass:[ABI20_0_0AIRMapMarker class]] && [markers containsObject:marker.identifier];
            }];
...
- (void)takeMapSnapshot:(ABI20_0_0AIRMap *)mapView
    ...
    [snapshotter startWithQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
              completionHandler:^(MKMapSnapshot *snapshot, NSError *error) {
                  ...
                  UIGraphicsBeginImageContextWithOptions(image.size, YES, image.scale);
                  {
                      ...
                      for (id <ABI20_0_0AIRMapSnapshot> overlay in mapView.overlays) {
...
- (void)handleMapTap:(UITapGestureRecognizer *)recognizer {
    ABI20_0_0AIRMap *map = (ABI20_0_0AIRMap *)recognizer.view;
    ...
    ABI20_0_0AIRMapPolyline *nearestPolyline = nil;

    for (id<MKOverlay> overlay in map.overlays) {
        if([overlay isKindOfClass:[ABI20_0_0AIRMapPolygon class]]){
            ABI20_0_0AIRMapPolygon *polygon = (ABI20_0_0AIRMapPolygon*) overlay;
            if (polygon.onPress) {
                CGMutablePathRef mpr = CGPathCreateMutable();

                for(int i = 0; i < polygon.coordinates.count; i++) {
                    ABI20_0_0AIRMapCoordinate *c = polygon.coordinates[i];
        ...
        if([overlay isKindOfClass:[ABI20_0_0AIRMapPolyline class]]){
            ABI20_0_0AIRMapPolyline *polyline = (ABI20_0_0AIRMapPolyline*) overlay;
            if (polyline.onPress) {
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id <MKOverlay>)overlay{
    if ([overlay isKindOfClass:[ABI20_0_0AIRMapPolyline class]]) {
        return ((ABI20_0_0AIRMapPolyline *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI20_0_0AIRMapPolygon class]]) {
        return ((ABI20_0_0AIRMapPolygon *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI20_0_0AIRMapCircle class]]) {
        return ((ABI20_0_0AIRMapCircle *)overlay).renderer;
    } else if ([overlay isKindOfClass:[ABI20_0_0AIRMapUrlTile class]]) {
        return ((ABI20_0_0AIRMapUrlTile *)overlay).renderer;
    } else {
        return nil;
    }
}
...
- (void)mapView:(ABI20_0_0AIRMap *)mapView didSelectAnnotationView:(MKAnnotationView *)view
{
    if ([view.annotation isKindOfClass:[ABI20_0_0AIRMapMarker class]]) {
        [(ABI20_0_0AIRMapMarker *)view.annotation showCalloutView];
...
- (void)mapView:(ABI20_0_0AIRMap *)mapView didDeselectAnnotationView:(MKAnnotationView *)view {
    if ([view.annotation isKindOfClass:[ABI20_0_0AIRMapMarker class]]) {
        [(ABI20_0_0AIRMapMarker *)view.annotation hideCalloutView];
    }
}

- (MKAnnotationView *)mapView:(__unused ABI20_0_0AIRMap *)mapView viewForAnnotation:(ABI20_0_0AIRMapMarker *)marker
{
    if (![marker isKindOfClass:[ABI20_0_0AIRMapMarker class]]) {
...
- (void)mapView:(ABI20_0_0AIRMap *)mapView
    annotationView:(MKAnnotationView *)view
    didChangeDragState:(MKAnnotationViewDragState)newState
    fromOldState:(MKAnnotationViewDragState)oldState
{
    if (![view.annotation isKindOfClass:[ABI20_0_0AIRMapMarker class]]) return;
    ABI20_0_0AIRMapMarker *marker = (ABI20_0_0AIRMapMarker *)view.annotation;
                       ...
                       context:(void *)context
{
    if ([keyPath isEqualToString:@"center"] && [object isKindOfClass:[MKAnnotationView class]]) {
        ...
        ABI20_0_0AIRMap *map = marker.map;
...
- (void)mapView:(ABI20_0_0AIRMap *)mapView didUpdateUserLocation:(MKUserLocation *)location
{
    if (mapView.followUserLocation) {
        MKCoordinateRegion region;
        region.span.latitudeDelta = ABI20_0_0AIRMapDefaultSpan;
        region.span.longitudeDelta = ABI20_0_0AIRMapDefaultSpan;
...
- (void)mapView:(ABI20_0_0AIRMap *)mapView regionWillChangeAnimated:(__unused BOOL)animated
{
    [self _regionChanged:mapView];

    mapView.regionChangeObserveTimer = [NSTimer timerWithTimeInterval:ABI20_0_0AIRMapRegionChangeObserveInterval
                                                               target:self
                                                             selector:@selector(_onTick:)
                                                             userInfo:@{ ABI20_0_0RCTMapViewKey: mapView }
                                                              repeats:YES];

    [[NSRunLoop mainRunLoop] addTimer:mapView.regionChangeObserveTimer forMode:NSRunLoopCommonModes];
}

- (void)mapView:(ABI20_0_0AIRMap *)mapView regionDidChangeAnimated:(__unused BOOL)animated
{
...
- (void)mapViewWillStartRenderingMap:(ABI20_0_0AIRMap *)mapView
{
...
- (void)mapViewDidFinishRenderingMap:(ABI20_0_0AIRMap *)mapView fullyRendered:(BOOL)fullyRendered
{
...
{
    [self _regionChanged:timer.userInfo[ABI20_0_0RCTMapViewKey]];
}

- (void)_regionChanged:(ABI20_0_0AIRMap *)mapView
{
    BOOL needZoom = NO;
    ...
    if (mapView.maxDelta > FLT_EPSILON && region.span.longitudeDelta > mapView.maxDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.maxDelta * (1 - ABI20_0_0AIRMapZoomBoundBuffer);
    } else if (mapView.minDelta > FLT_EPSILON && region.span.longitudeDelta < mapView.minDelta) {
        needZoom = YES;
        newLongitudeDelta = mapView.minDelta * (1 + ABI20_0_0AIRMapZoomBoundBuffer);
    }
    if (needZoom) {
...
- (void)_emitRegionChangeEvent:(ABI20_0_0AIRMap *)mapView continuous:(BOOL)continuous
{
 ...
 *
 */
- (double)distanceOfPoint:(MKMapPoint)pt toPoly:(ABI20_0_0AIRMapPolyline *)poly
{
...
- (double)metersFromPixel:(NSUInteger)px atPoint:(CGPoint)pt forMap:(ABI20_0_0AIRMap *)mapView
{
