...
#import "ABI20_0_0AIRMapPolygonManager.h"
...
@interface ABI20_0_0AIRMapPolygonManager()

@end

@implementation ABI20_0_0AIRMapPolygonManager

ABI20_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    ABI20_0_0AIRMapPolygon *polygon = [ABI20_0_0AIRMapPolygon new];
    return polygon;
}
