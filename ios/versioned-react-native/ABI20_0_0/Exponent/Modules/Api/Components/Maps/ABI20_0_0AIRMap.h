...
extern const CLLocationDegrees ABI20_0_0AIRMapDefaultSpan;
extern const NSTimeInterval ABI20_0_0AIRMapRegionChangeObserveInterval;
extern const CGFloat ABI20_0_0AIRMapZoomBoundBuffer;

@interface ABI20_0_0AIRMap: MKMapView<ABI20_0_0SMCalloutViewDelegate>

@property (nonatomic, strong) ABI20_0_0SMCalloutView *calloutView;
...
@property (nonatomic, copy) ABI20_0_0RCTBubblingEventBlock onPanDrag;
@property (nonatomic, copy) ABI20_0_0RCTBubblingEventBlock onLongPress;
@property (nonatomic, copy) ABI20_0_0RCTDirectEventBlock onMarkerPress;
@property (nonatomic, copy) ABI20_0_0RCTDirectEventBlock onMarkerSelect;
@property (nonatomic, copy) ABI20_0_0RCTDirectEventBlock onMarkerDeselect;
@property (nonatomic, copy) ABI20_0_0RCTDirectEventBlock onMarkerDragStart;
@property (nonatomic, copy) ABI20_0_0RCTDirectEventBlock onMarkerDrag;
@property (nonatomic, copy) ABI20_0_0RCTDirectEventBlock onMarkerDragEnd;
