...
#import <ReactABI20_0_0/ABI20_0_0RCTScrollView.h>
#import <ReactABI20_0_0/ABI20_0_0RCTTouchHandler.h>
...
#define APPLY_PROP(recognizer, config, type, prop, propName) do { \
    ...
    if (value != nil) recognizer.prop = [ABI20_0_0RCTConvert type:value]; \
} while(0)
...
@interface ABI20_0_0RNDummyGestureRecognizer : UIGestureRecognizer
@end


@implementation ABI20_0_0RNDummyGestureRecognizer
...
@interface ABI20_0_0RNGestureHandler () <UIGestureRecognizerDelegate>

@property(nonatomic) BOOL shouldCancelWhenOutside;
@property(nonatomic, weak) ABI20_0_0RNGestureHandlerRegistry *registry;

@end


@implementation ABI20_0_0RNGestureHandlerRegistry {
    NSMutableDictionary<NSNumber *, NSMutableArray<ABI20_0_0RNGestureHandler *>* > *_gestureHandlers;
}
...
{
    NSMutableArray *handlersArray = _gestureHandlers[viewTag];
    for (ABI20_0_0RNGestureHandler *handler in handlersArray) {
...
{
    NSNumber *viewTag = recognizer.view.ReactABI20_0_0Tag;
...
@implementation ABI20_0_0RNGestureHandler {
...
- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super init])) {
        _tag = tag;
        _lastState = ABI20_0_0RNGestureHandlerStateUndetermined;
    }
    return self;
}
...
{
    _handlersToWaitFor = [ABI20_0_0RCTConvert NSNumberArray:config[@"waitFor"]];
    _simultaniousHandlers = [ABI20_0_0RCTConvert NSNumberArray:config[@"simultaneousHandlers"]];

    id prop = config[@"shouldCancelWhenOutside"];
    if (prop != nil) {
        _shouldCancelWhenOutside = [ABI20_0_0RCTConvert BOOL:prop];
    } else {
...
{
    return [ABI20_0_0RNGestureHandlerEventExtraData forPosition:[recognizer locationInView:[recognizer view]]];
}

- (void)handleGesture:(UIGestureRecognizer *)recognizer
{
    ABI20_0_0RNGestureHandlerEventExtraData *eventData = [self eventExtraData:recognizer];
    [self sendEventsInState:self.state forViewWithTag:recognizer.view.ReactABI20_0_0Tag withExtraData:eventData];
}

- (void)sendEventsInState:(ABI20_0_0RNGestureHandlerState)state
           forViewWithTag:(nonnull NSNumber *)ReactABI20_0_0Tag
            withExtraData:(ABI20_0_0RNGestureHandlerEventExtraData *)extraData
{
    id touchEvent = [[ABI20_0_0RNGestureHandlerEvent alloc] initWithRactTag:ReactABI20_0_0Tag
                                                        handlerTag:_tag
                                                             state:state
                                                         extraData:extraData];

    if (state != _lastState) {
        if (state == ABI20_0_0RNGestureHandlerStateEnd && _lastState != ABI20_0_0RNGestureHandlerStateActive) {
            [self.emitter sendStateChangeEvent:[[ABI20_0_0RNGestureHandlerStateChange alloc] initWithRactTag:ReactABI20_0_0Tag
                                                                                         handlerTag:_tag
                                                                                              state:ABI20_0_0RNGestureHandlerStateActive
                                                                                          prevState:_lastState
                                                                                          extraData:extraData]];
            _lastState = ABI20_0_0RNGestureHandlerStateActive;
        }
        id stateEvent = [[ABI20_0_0RNGestureHandlerStateChange alloc] initWithRactTag:ReactABI20_0_0Tag
                                                                  handlerTag:_tag
                                                                       state:state
                                                                   prevState:_lastState
                                                                   extraData:extraData];
    ...
    if (state == ABI20_0_0RNGestureHandlerStateActive) {
...
- (ABI20_0_0RNGestureHandlerState)state
{
    switch (_recognizer.state) {
        ...
        case UIGestureRecognizerStatePossible:
            return ABI20_0_0RNGestureHandlerStateBegan;
        case UIGestureRecognizerStateEnded:
            return ABI20_0_0RNGestureHandlerStateEnd;
        case UIGestureRecognizerStateFailed:
            return ABI20_0_0RNGestureHandlerStateFailed;
        case UIGestureRecognizerStateCancelled:
            return ABI20_0_0RNGestureHandlerStateCancelled;
        case UIGestureRecognizerStateChanged:
            return ABI20_0_0RNGestureHandlerStateActive;
    }
    return ABI20_0_0RNGestureHandlerStateUndetermined;
}
...
- (ABI20_0_0RNGestureHandler *)findGestureHandlerByRecognizer:(UIGestureRecognizer *)recognizer
{
    ABI20_0_0RNGestureHandler *handler = [_registry findGestureHandlerByRecognizer:recognizer];
    if (handler != nil) {
        return handler;
    }
    ...
    UIView *ReactABI20_0_0View = recognizer.view;
    while (ReactABI20_0_0View != nil && ReactABI20_0_0View.ReactABI20_0_0Tag == nil) {
        ReactABI20_0_0View = ReactABI20_0_0View.superview;
    }

    for (UIGestureRecognizer *recognizer in ReactABI20_0_0View.gestureRecognizers) {
        if ([recognizer isKindOfClass:[ABI20_0_0RNDummyGestureRecognizer class]]) {
...
{
    ABI20_0_0RNGestureHandler *handler = [self findGestureHandlerByRecognizer:otherGestureRecognizer];
    if ([handler isKindOfClass:[ABI20_0_0RNNativeViewGestureHandler class]]) {
...
@interface ABI20_0_0RNBetterPanGestureRecognizer : UIPanGestureRecognizer
...
- (id)initWithGestureHandler:(ABI20_0_0RNGestureHandler*)gestureHandler;

@end


@implementation ABI20_0_0RNBetterPanGestureRecognizer {
    __weak ABI20_0_0RNGestureHandler *_gestureHandler;
...
@implementation ABI20_0_0RNPanGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI20_0_0RNBetterPanGestureRecognizer alloc] initWithGestureHandler:self];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    ABI20_0_0RNBetterPanGestureRecognizer *recognizer = (ABI20_0_0RNBetterPanGestureRecognizer *)_recognizer;
    ...
    if (prop != nil) {
        CGFloat dist = [ABI20_0_0RCTConvert CGFloat:prop];
        recognizer.minDistSq = dist * dist;
    }

    prop = config[@"minVelocity"];
    if (prop != nil) {
        CGFloat velocity = [ABI20_0_0RCTConvert CGFloat:prop];
...
- (ABI20_0_0RNGestureHandlerEventExtraData *)eventExtraData:(id)recognizer
{
    return [ABI20_0_0RNGestureHandlerEventExtraData
...
@interface ABI20_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
@implementation ABI20_0_0RNBetterTapGestureRecognizer {
    __weak ABI20_0_0RNGestureHandler *_gestureHandler;
...
@implementation ABI20_0_0RNTapGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI20_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
    }
    return self;
}
...
{
    [super configure:config];
    ABI20_0_0RNBetterTapGestureRecognizer *recognizer = (ABI20_0_0RNBetterTapGestureRecognizer *)_recognizer;

    APPLY_INT_PROP(numberOfTaps);

    id prop = config[@"maxDelayMs"];
    if (prop != nil) {
        recognizer.maxDelay = [ABI20_0_0RCTConvert CGFloat:prop] / 1000.0;
    }

    prop = config[@"maxDurationMs"];
    if (prop != nil) {
        recognizer.maxDuration = [ABI20_0_0RCTConvert CGFloat:prop] / 1000.0;
    }
}
...
@implementation ABI20_0_0RNLongPressGestureHandler
...
- (void)configure:(NSDictionary *)config
{
    ...
    if (prop != nil) {
        recognizer.minimumPressDuration = [ABI20_0_0RCTConvert CGFloat:prop] / 1000.0;
    }
}
...
@implementation ABI20_0_0RNNativeViewGestureHandler {
...
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI20_0_0RNDummyGestureRecognizer alloc] init];
    }
    return self;
}
...
{
    [super configure:config];
    _shouldActivateOnStart = [ABI20_0_0RCTConvert BOOL:config[@"shouldActivateOnStart"]];
    _disallowInterruption = [ABI20_0_0RCTConvert BOOL:config[@"disallowInterruption"]];
}
...
- (void)bindToView:(UIView *)view
{
    ...
    // is set
    if ([view isKindOfClass:[ABI20_0_0RCTScrollView class]]) {
        // This part of the code is coupled with ABI20_0_0RN implementation of ScrollView native wrapper and
        // we expect for ABI20_0_0RCTScrollView component to contain a subclass of UIScrollview as the only
        // subview
...
- (void)handleTouchDown:(UIView *)sender forEvent:(UIEvent *)event
{
    ...
    [self sendEventsInState:ABI20_0_0RNGestureHandlerStateActive
             forViewWithTag:sender.ReactABI20_0_0Tag
              withExtraData:[ABI20_0_0RNGestureHandlerEventExtraData forPointerInside:YES]];
}

- (void)handleTouchUpOutside:(UIView *)sender forEvent:(UIEvent *)event
{
    [self sendEventsInState:ABI20_0_0RNGestureHandlerStateEnd
             forViewWithTag:sender.ReactABI20_0_0Tag
              withExtraData:[ABI20_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
...
{
    [self sendEventsInState:ABI20_0_0RNGestureHandlerStateCancelled
             forViewWithTag:sender.ReactABI20_0_0Tag
              withExtraData:[ABI20_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
...
@implementation ABI20_0_0RNPinchGestureHandler
...
@implementation ABI20_0_0RNRotationGestureHandler
...
@implementation ABI20_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI20_0_0RCTTouchHandler class]];
}
...
/**
 * Gesture Handler Button components overrides standard mechanism used by ABI20_0_0RN
 ...
 */
@implementation ABI20_0_0RNGestureHandlerButton
