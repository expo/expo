...
#import "ABI20_0_0EXBarCodeScanner.h"
#import "ABI20_0_0EXBarCodeScannerManager.h"
...
@interface ABI20_0_0EXBarCodeScanner ()

@property (nonatomic, weak) ABI20_0_0EXBarCodeScannerManager *manager;
@property (nonatomic, weak) ABI20_0_0RCTBridge *bridge;
@property (nonatomic, copy) ABI20_0_0RCTDirectEventBlock onBarCodeRead;

@end

@implementation ABI20_0_0EXBarCodeScanner
