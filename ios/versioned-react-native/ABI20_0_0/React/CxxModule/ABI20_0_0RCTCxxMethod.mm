...
#import <cxxReactABI20_0_0/ABI20_0_0JsArgumentHelpers.h>
#import <folly/Memory.h>

#import "ABI20_0_0RCTCxxUtils.h"

using facebook::xplat::module::CxxModule;
using namespace facebook::ReactABI20_0_0;

@implementation ABI20_0_0RCTCxxMethod
{
             ...
             arguments:(NSArray *)arguments
{
  ...
  if (arguments.count < _method->callbacks) {
    ABI20_0_0RCTLogError(@"Method %@.%s expects at least %lu arguments, but got %tu",
                ABI20_0_0RCTBridgeModuleNameForClass([module class]), _method->name.c_str(),
  ...
  if (_method->callbacks >= 1) {
    if (![arguments[arguments.count - 1] isKindOfClass:[NSNumber class]]) {
      ABI20_0_0RCTLogError(@"Argument %tu (%@) of %@.%s should be a function",
  ...
  folly::dynamic args = [ABI20_0_0RCTConvert folly_dynamic:arguments];
  ...
  try {
    ...
    ABI20_0_0RCTLogError(@"Method %@.%s argument error: %s",
                ABI20_0_0RCTBridgeModuleNameForClass([module class]), _method->name.c_str(),
                ex.what());
    return nil;
  }
...
- (ABI20_0_0RCTFunctionType)functionType
{
  ...
  return _method->syncFunc ? ABI20_0_0RCTFunctionTypeSync : ABI20_0_0RCTFunctionTypeNormal;
}
