...
#include <cxxReactABI20_0_0/ABI20_0_0JSCExecutor.h>
...
@interface ABI20_0_0RCTConvert (folly)
...
std::vector<std::unique_ptr<NativeModule>> createNativeModules(NSArray<ABI20_0_0RCTModuleData *> *modules, ABI20_0_0RCTBridge *bridge, const std::shared_ptr<Instance> &instance);
