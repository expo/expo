...
@implementation ABI20_0_0RCTPackagerConnectionBridgeConfig {
...
- (NSDictionary<NSString *, id<ABI20_0_0RCTPackagerClientMethod>> *)defaultPackagerMethods
{
  return @{
           @"reload": [[ABI20_0_0RCTReloadPackagerMethod alloc] initWithBridge:_bridge],
           @"pokeSamplingProfiler": [[ABI20_0_0RCTSamplingProfilerPackagerMethod alloc] initWithJSEnvironment:_bridge]
           };
}
