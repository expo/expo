...
@implementation ABI20_0_0RCTSamplingProfilerPackagerMethod {
  __weak id<ABI20_0_0RCTJSEnvironment> _jsEnvironment;
}
...
{
  ABI20_0_0RCTLogError(@"%@ does not implement onNotification", [self class]);
}
