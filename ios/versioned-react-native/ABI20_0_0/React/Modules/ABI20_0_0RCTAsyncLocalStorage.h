 ...
 */
@interface ABI20_0_0RCTAsyncLocalStorage : NSObject <ABI20_0_0RCTBridgeModule,ABI20_0_0RCTInvalidating>
...
// Clear the ABI20_0_0RCTAsyncLocalStorage data from native code
- (void)clearAllData;
