...
NSString *const ABI20_0_0RCTTVNavigationEventNotification = @"ABI20_0_0RCTTVNavigationEventNotification";

static NSString *const TVNavigationEventName = @"onTVNavEvent";

@implementation ABI20_0_0RCTTVNavigationEventEmitter
  ...
  if (self = [super init]) {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(handleTVNavigationEventNotification:)
                                                 name:ABI20_0_0RCTTVNavigationEventNotification
                                               object:nil];
