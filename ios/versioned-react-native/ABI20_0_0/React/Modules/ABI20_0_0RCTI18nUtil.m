...
@implementation ABI20_0_0RCTI18nUtil

+ (id)sharedInstance {
   static ABI20_0_0RCTI18nUtil *sharedABI20_0_0RCTI18nUtilInstance = nil;
   @synchronized(self) {
     if (sharedABI20_0_0RCTI18nUtilInstance == nil)
      sharedABI20_0_0RCTI18nUtilInstance = [self new];
   }
   return sharedABI20_0_0RCTI18nUtilInstance;
}
...
- (BOOL)isRTLAllowed
{
  NSNumber *value = [[NSUserDefaults standardUserDefaults] objectForKey:@"ABI20_0_0RCTI18nUtil_allowRTL"];
  if (value == nil) {
    return YES;
  }
...
{
  [[NSUserDefaults standardUserDefaults] setBool:rtlStatus forKey:@"ABI20_0_0RCTI18nUtil_allowRTL"];
...
- (BOOL)isRTLForced
{
  BOOL rtlStatus = [[NSUserDefaults standardUserDefaults]
                            boolForKey:@"ABI20_0_0RCTI18nUtil_forceRTL"];
  return rtlStatus;
}

- (void)forceRTL:(BOOL)rtlStatus
{
  [[NSUserDefaults standardUserDefaults] setBool:rtlStatus forKey:@"ABI20_0_0RCTI18nUtil_forceRTL"];
  [[NSUserDefaults standardUserDefaults] synchronize];
}
