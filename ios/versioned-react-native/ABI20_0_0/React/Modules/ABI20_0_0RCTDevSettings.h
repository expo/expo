...
/**
 * An abstraction for a key-value store to manage ABI20_0_0RCTDevSettings behavior.
 * The default implementation persists settings using NSUserDefaults.
 */
@protocol ABI20_0_0RCTDevSettingsDataSource <NSObject>
...
@interface ABI20_0_0RCTDevSettings : NSObject
...
/*
 * Whether shaking will show ABI20_0_0RCTDevMenu. The menu is enabled by default if ABI20_0_0RCT_DEV=1, but
...
@interface ABI20_0_0RCTBridge (ABI20_0_0RCTDevSettings)

@property (nonatomic, readonly) ABI20_0_0RCTDevSettings *devSettings;
