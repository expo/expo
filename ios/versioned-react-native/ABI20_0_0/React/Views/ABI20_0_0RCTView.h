...
#import <ReactABI20_0_0/ABI20_0_0RCTPointerEvents.h>
#import <ReactABI20_0_0/ABI20_0_0RCTView.h>

@protocol ABI20_0_0RCTAutoInsetsProtocol;

@class ABI20_0_0RCTView;

@interface ABI20_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI20_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI20_0_0RCTDirectEventBlock onMagicTap;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI20_0_0RCTPointerEvents pointerEvents;

+ (void)autoAdjustInsetsForView:(UIView<ABI20_0_0RCTAutoInsetsProtocol> *)parentView
 ...
 * This is inherited from UIView+ReactABI20_0_0, but we override it here
 * to improve perfomance and make subclassing/overriding possible/easier.
 */
@property (nonatomic, assign) UIUserInterfaceLayoutDirection ReactABI20_0_0LayoutDirection;
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI20_0_0RCTBorderStyle borderStyle;
