...
// These constants can only be removed when ReactABI20_0_0 Native drops iOS8 support.
...
typedef CGFloat ABI20_0_0RCTFontWeight;
static ABI20_0_0RCTFontWeight weightOfFont(UIFont *font)
{
  ...
  ABI20_0_0RCTFontWeight weight = [traits[UIFontWeightTrait] doubleValue];
  if (weight == 0.0) {
...
static UIFont *cachedSystemFont(CGFloat size, ABI20_0_0RCTFontWeight weight)
{
...
@implementation ABI20_0_0RCTConvert (ABI20_0_0RCTFont)

+ (UIFont *)UIFont:(id)json
{
  json = [self NSDictionary:json];
  return [ABI20_0_0RCTFont updateFont:nil
                  withFamily:[ABI20_0_0RCTConvert NSString:json[@"fontFamily"]]
                        size:[ABI20_0_0RCTConvert NSNumber:json[@"fontSize"]]
                      weight:[ABI20_0_0RCTConvert NSString:json[@"fontWeight"]]
                       style:[ABI20_0_0RCTConvert NSString:json[@"fontStyle"]]
                     variant:[ABI20_0_0RCTConvert NSStringArray:json[@"fontVariant"]]
             scaleMultiplier:1];
}

ABI20_0_0RCT_ENUM_CONVERTER(ABI20_0_0RCTFontWeight, (@{
                                     @"normal": @(UIFontWeightRegular),
                                     @"bold": @(UIFontWeightBold),
...
typedef BOOL ABI20_0_0RCTFontStyle;
ABI20_0_0RCT_ENUM_CONVERTER(ABI20_0_0RCTFontStyle, (@{
                                    @"normal": @NO,
                                    @"italic": @YES,
                                    @"oblique": @YES,
                                    }), NO, boolValue)

typedef NSDictionary ABI20_0_0RCTFontVariantDescriptor;
+ (ABI20_0_0RCTFontVariantDescriptor *)ABI20_0_0RCTFontVariantDescriptor:(id)json
{
  ...
  ABI20_0_0RCTFontVariantDescriptor *value = mapping[json];
  if (ABI20_0_0RCT_DEBUG && !value && [json description].length > 0) {
    ABI20_0_0RCTLogError(@"Invalid ABI20_0_0RCTFontVariantDescriptor '%@'. should be one of: %@", json,
                [[mapping allKeys] sortedArrayUsingSelector:@selector(caseInsensitiveCompare:)]);
  }
  return value;
}

ABI20_0_0RCT_ARRAY_CONVERTER(ABI20_0_0RCTFontVariantDescriptor)

@end

@implementation ABI20_0_0RCTFont
...
+ (UIFont *)updateFont:(UIFont *)font
            withFamily:(NSString *)family
               ...
               variant:(NSArray<ABI20_0_0RCTFontVariantDescriptor *> *)variant
       scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  const ABI20_0_0RCTFontWeight defaultFontWeight = UIFontWeightRegular;
  const CGFloat defaultFontSize = 14;

  // Initialize properties to defaults
  CGFloat fontSize = defaultFontSize;
  ABI20_0_0RCTFontWeight fontWeight = defaultFontWeight;
  ...
  // Get font attributes
  fontSize = [ABI20_0_0RCTConvert CGFloat:size] ?: fontSize;
  if (scaleMultiplier > 0.0 && scaleMultiplier != 1.0) {
    fontSize = round(fontSize * scaleMultiplier);
  }
  familyName = [ABI20_0_0RCTConvert NSString:family] ?: familyName;
  isItalic = style ? [ABI20_0_0RCTConvert ABI20_0_0RCTFontStyle:style] : isItalic;
  fontWeight = weight ? [ABI20_0_0RCTConvert ABI20_0_0RCTFontWeight:weight] : fontWeight;
  ...
  if (!didFindFont && [UIFont fontNamesForFamilyName:familyName].count == 0) {
    ...
    if (font) {
      ...
      ABI20_0_0RCTLogError(@"Unrecognized font family '%@'", familyName);
      if ([UIFont respondsToSelector:@selector(systemFontOfSize:weight:)]) {
  ...
  if (variant) {
    NSArray *fontFeatures = [ABI20_0_0RCTConvert ABI20_0_0RCTFontVariantDescriptorArray:variant];
