...
@interface ABI20_0_0RCTShadowView () {
...
@implementation ABI20_0_0RCTScrollContentShadowView
       ...
       absolutePosition:(CGPoint)absolutePosition
{
  ...
  CGFloat xCompensation = ABI20_0_0YGNodeLayoutGetRight(node) - ABI20_0_0YGNodeLayoutGetLeft(node);
  ...
  _frame.origin.x = ABI20_0_0RCTRoundPixelValue(ABI20_0_0YGNodeLayoutGetRight(node));
}
