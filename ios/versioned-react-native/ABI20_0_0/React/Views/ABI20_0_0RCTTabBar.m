...
#import "ABI20_0_0RCTViewControllerProtocol.h"
#import "ABI20_0_0RCTWrapperViewController.h"
#import "UIView+ReactABI20_0_0.h"

@interface ABI20_0_0RCTTabBar() <UITabBarControllerDelegate>

@end

@implementation ABI20_0_0RCTTabBar
{
  BOOL _tabsChanged;
...
- (void)insertReactABI20_0_0Subview:(ABI20_0_0RCTTabBarItem *)subview atIndex:(NSInteger)atIndex
{
  if (![subview isKindOfClass:[ABI20_0_0RCTTabBarItem class]]) {
    ABI20_0_0RCTLogError(@"subview should be of type ABI20_0_0RCTTabBarItem");
    return;
  }
...
- (void)removeReactABI20_0_0Subview:(ABI20_0_0RCTTabBarItem *)subview
{
  if (self.ReactABI20_0_0Subviews.count == 0) {
    ABI20_0_0RCTLogError(@"should have at least one view to remove a subview");
    return;
  }
...
{
  // Do nothing, as subviews are managed by `ReactABI20_0_0BridgeDidFinishTransaction`
}

- (void)layoutSubviews
{
  [super layoutSubviews];
  [self ReactABI20_0_0AddControllerToClosestParent:_tabController];
...
- (void)ReactABI20_0_0BridgeDidFinishTransaction
{
  ...
  if (_tabsChanged) {
    ...
    for (ABI20_0_0RCTTabBarItem *tab in [self ReactABI20_0_0Subviews]) {
      UIViewController *controller = tab.ReactABI20_0_0ViewController;
      if (!controller) {
        controller = [[ABI20_0_0RCTWrapperViewController alloc] initWithContentView:tab];
      }
  ...
  [self.ReactABI20_0_0Subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger index, __unused BOOL *stop) {

    ABI20_0_0RCTTabBarItem *tab = (ABI20_0_0RCTTabBarItem *)view;
...
- (BOOL)tabBarController:(UITabBarController *)tabBarController shouldSelectViewController:(UIViewController *)viewController
{
  ...
  ABI20_0_0RCTTabBarItem *tab = (ABI20_0_0RCTTabBarItem *)self.ReactABI20_0_0Subviews[index];
