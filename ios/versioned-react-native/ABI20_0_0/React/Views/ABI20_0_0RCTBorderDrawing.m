...
#import "ABI20_0_0RCTBorderDrawing.h"
#import "ABI20_0_0RCTLog.h"

static const CGFloat ABI20_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI20_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return
  ABS(borderInsets.left - borderInsets.right) < ABI20_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.bottom) < ABI20_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.top) < ABI20_0_0RCTViewBorderThreshold;
}

BOOL ABI20_0_0RCTCornerRadiiAreEqual(ABI20_0_0RCTCornerRadii cornerRadii)
{
  return
  ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI20_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI20_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI20_0_0RCTViewBorderThreshold;
}
...
{
  return (ABI20_0_0RCTCornerInsets) {
    {
...
static void ABI20_0_0RCTPathAddEllipticArc(CGMutablePathRef path,
                                       ...
                                       const CGAffineTransform *transform)
{
  ...
  ABI20_0_0RCTPathAddEllipticArc(path, transform, (CGPoint){
...
static void ABI20_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds,
                                               CGPoint lineStart,
                                               CGPoint lineEnd,
...
NS_INLINE BOOL ABI20_0_0RCTCornerRadiiAreAboveThreshold(ABI20_0_0RCTCornerRadii cornerRadii) {
  return (cornerRadii.topLeft > ABI20_0_0RCTViewBorderThreshold ||
    cornerRadii.topRight > ABI20_0_0RCTViewBorderThreshold      ||
    cornerRadii.bottomLeft > ABI20_0_0RCTViewBorderThreshold    ||
    cornerRadii.bottomRight > ABI20_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI20_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI20_0_0RCTCornerRadii cornerRadii) {
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI20_0_0RCTPathCreateWithRoundedRect(rect, ABI20_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef ABI20_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge) {
...
static UIImage *ABI20_0_0RCTGetSolidBorderImage(ABI20_0_0RCTCornerRadii cornerRadii,
                                       CGSize viewSize,
                                       ...
                                       BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI20_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI20_0_0RCTCornerInsets cornerInsets = ABI20_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  CGContextRef ctx = ABI20_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI20_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI20_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI20_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI20_0_0RCTEllipseGetIntersectionsWithLine((CGRect){
...
static UIImage *ABI20_0_0RCTGetDashedOrDottedBorderImage(ABI20_0_0RCTBorderStyle borderStyle,
                                                ...
                                                BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI20_0_0RCTBorderStyleDashed || borderStyle == ABI20_0_0RCTBorderStyleDotted);

  if (!ABI20_0_0RCTBorderColorsAreEqual(borderColors) || !ABI20_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI20_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI20_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI20_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI20_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI20_0_0RCTPathCreateWithRoundedRect(pathRect, ABI20_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI20_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
                           ...
                           BOOL drawToEdge)
{
  ...
  switch (borderStyle) {
    case ABI20_0_0RCTBorderStyleSolid:
      return ABI20_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI20_0_0RCTBorderStyleDashed:
    case ABI20_0_0RCTBorderStyleDotted:
      return ABI20_0_0RCTGetDashedOrDottedBorderImage(borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI20_0_0RCTBorderStyleUnset:
      break;
  }
