...
@implementation ABI20_0_0RCTConvert (UITabBarSystemItem)

ABI20_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI20_0_0RCTTabBarItem{
...
{
  return self.superview.ReactABI20_0_0ViewController;
}
