...
@implementation ABI20_0_0RCTTVView
{
...
ABI20_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithCoder:unused)
...
{
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI20_0_0RCTTVNavigationEventNotification
                                                      object:@{@"eventType":@"select",@"tag":self.ReactABI20_0_0Tag}];
}
...
- (void)didUpdateFocusInContext:(UIFocusUpdateContext *)context withAnimationCoordinator:(UIFocusAnimationCoordinator *)coordinator
{
  if (context.nextFocusedView == self && self.isTVSelectable ) {
    ...
    [coordinator addCoordinatedAnimations:^(void){
      ...
      [[NSNotificationCenter defaultCenter] postNotificationName:ABI20_0_0RCTTVNavigationEventNotification
                                                          object:@{@"eventType":@"focus",@"tag":self.ReactABI20_0_0Tag}];
    } completion:^(void){}];
  } else {
    [coordinator addCoordinatedAnimations:^(void){
      [[NSNotificationCenter defaultCenter] postNotificationName:ABI20_0_0RCTTVNavigationEventNotification
                                                          object:@{@"eventType":@"blur",@"tag":self.ReactABI20_0_0Tag}];
      [UIView animateWithDuration:0.2 animations:^{
...
- (void)setHasTVPreferredFocus:(BOOL)hasTVPreferredFocus
{
  ...
  if (hasTVPreferredFocus) {
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
      ...
      while (![rootview isReactABI20_0_0RootView] && rootview != nil) {
      ...
      [(ABI20_0_0RCTRootView *)rootview setReactABI20_0_0PreferredFocusedView:self];
