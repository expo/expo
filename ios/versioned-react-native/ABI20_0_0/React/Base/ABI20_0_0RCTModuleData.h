...
@protocol ABI20_0_0RCTBridgeMethod;
@protocol ABI20_0_0RCTBridgeModule;
@class ABI20_0_0RCTBridge;

typedef id<ABI20_0_0RCTBridgeModule>(^ABI20_0_0RCTBridgeModuleProvider)(void);

@interface ABI20_0_0RCTModuleData : NSObject <ABI20_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI20_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI20_0_0RCTBridgeModule> instance;
