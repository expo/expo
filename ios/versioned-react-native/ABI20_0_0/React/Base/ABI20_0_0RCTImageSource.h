 ...
 */
@interface ABI20_0_0RCTImageSource : NSObject
...
@interface ABI20_0_0RCTConvert (ImageSource)

+ (ABI20_0_0RCTImageSource *)ABI20_0_0RCTImageSource:(id)json;
+ (NSArray<ABI20_0_0RCTImageSource *> *)ABI20_0_0RCTImageSourceArray:(id)json;
