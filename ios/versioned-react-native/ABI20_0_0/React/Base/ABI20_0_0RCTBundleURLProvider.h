...
extern NSString *const ABI20_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI20_0_0RCTBundleURLProviderDefaultPort;

@interface ABI20_0_0RCTBundleURLProvider : NSObject
