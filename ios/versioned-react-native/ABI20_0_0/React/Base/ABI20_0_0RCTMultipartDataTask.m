...
@interface ABI20_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>
...
@implementation ABI20_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI20_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI20_0_0RCTMultipartProgressCallback _progressHandler;
...
- (instancetype)initWithURL:(NSURL *)url
            ...
            progressHandler:(ABI20_0_0RCTMultipartProgressCallback)progressHandler
{
  if (self = [super init]) {
    _url = url;
...
{
  ABI20_0_0RCTMultipartStreamReader *reader = [[ABI20_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream boundary:_boundary];
  ABI20_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
