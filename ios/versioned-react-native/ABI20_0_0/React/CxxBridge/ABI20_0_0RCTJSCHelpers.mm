...
#include "ABI20_0_0RCTJSCHelpers.h"
...
#import <cxxReactABI20_0_0/ABI20_0_0Platform.h>
#import <ABI20_0_0jschelpers/ABI20_0_0Value.h>
...
JSValueRef nativeLoggingHook(
  ...
  if (argumentCount > 1) {
    level = MAX(level, (ABI20_0_0RCTLogLevel)Value(ctx, arguments[1]).asNumber());
  }
  if (argumentCount > 0) {
    ...
    _ABI20_0_0RCTLogJavaScriptInternal(level, [msg toString]);
  }
...
void ABI20_0_0RCTPrepareJSCExecutor() {
  ReactABI20_0_0Marker::logTaggedMarker = [](const ReactABI20_0_0Marker::ReactABI20_0_0MarkerId, const char *tag) {};
  JSCNativeHooks::loggingHook = nativeLoggingHook;
  JSCNativeHooks::nowHook = nativePerformanceNow;
  JSCNativeHooks::installPerfHooks = ABI20_0_0RCTFBQuickPerformanceLoggerConfigureHooks;
}
