...
class ABI20_0_0RCTMessageThread : public MessageQueueThread {
 public:
  ABI20_0_0RCTMessageThread(NSRunLoop *runLoop, ABI20_0_0RCTJavaScriptCompleteBlock errorBlock);
  ~ABI20_0_0RCTMessageThread() override;
