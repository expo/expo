...
#import "ABI6_0_0EXContacts.h"

@import AddressBook;

@interface ABI6_0_0EXContacts ()

@property (nonatomic, assign) ABAddressBookRef addressBookRef;

@end

@implementation ABI6_0_0EXContacts

ABI6_0_0RCT_EXPORT_MODULE(ExponentContacts);
 ...
 */
ABI6_0_0RCT_EXPORT_METHOD(getContactsAsync:(NSArray *)fields resolver:(ABI6_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI6_0_0RCTPromiseRejectBlock)reject)
{
...
- (void)_getContactsWithPermissionGrantedAsync: (NSArray *)fields addressBook:(ABAddressBookRef)addressBook resolver:(ABI6_0_0RCTPromiseResolveBlock)resolve rejecter:(ABI6_0_0RCTPromiseRejectBlock)reject
{
