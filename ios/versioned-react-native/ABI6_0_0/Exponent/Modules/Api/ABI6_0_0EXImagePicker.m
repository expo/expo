#import "ABI6_0_0EXImagePicker.h"
...
@interface ABI6_0_0EXImagePicker ()

@property (nonatomic, strong) UIAlertController *alertController;
@property (nonatomic, strong) UIImagePickerController *picker;
@property (nonatomic, strong) ABI6_0_0RCTPromiseResolveBlock resolve;
@property (nonatomic, strong) ABI6_0_0RCTPromiseRejectBlock reject;
...
@implementation ABI6_0_0EXImagePicker

ABI6_0_0RCT_EXPORT_MODULE(ExponentImagePicker);
...
ABI6_0_0RCT_EXPORT_METHOD(launchCameraAsync:(NSDictionary *)options
...
ABI6_0_0RCT_EXPORT_METHOD(launchImageLibraryAsync:(NSDictionary *)options
                  resolver:(ABI6_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI6_0_0RCTPromiseRejectBlock)reject)
{
    self.resolve = resolve;
...
- (void)launchImagePicker:(RNImagePickerTarget)target
{
    ...
    if (target == RNImagePickerTargetCamera) {
        ...
        self.reject(ABI6_0_0RCTErrorUnspecified, @"Camera not available on simulator", nil);
        return;
#else
        ...
        if ([self.options objectForKey:@"storageOptions"] && [[self.options objectForKey:@"storageOptions"] isKindOfClass:[NSDictionary class]]) {
            ...
            if ([storageOptions objectForKey:@"path"]) {
                ...
                if (error) {
                    ...
                    self.reject(ABI6_0_0RCTErrorUnspecified, error.localizedFailureReason, error);
                    return;
                }
                else {
