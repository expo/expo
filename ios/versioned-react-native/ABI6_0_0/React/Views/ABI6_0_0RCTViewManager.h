...
@class ABI6_0_0RCTSparseArray;
@class ABI6_0_0RCTUIManager;

typedef void (^ABI6_0_0RCTViewManagerUIBlock)(ABI6_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry);

@interface ABI6_0_0RCTViewManager : NSObject <ABI6_0_0RCTBridgeModule>

/**
 * The bridge can be used to access both the ABI6_0_0RCTUIIManager and the ABI6_0_0RCTEventDispatcher,
 * allowing the manager (or the views that it manages) to manipulate the view
 * hierarchy and send events back to the JS context.
 */
@property (nonatomic, weak) ABI6_0_0RCTBridge *bridge;
 ...
 * an ordinary ABI6_0_0RCTShadowView instance will be created, which is typically fine for
...
/**
 * DEPRECATED: declare properties of type ABI6_0_0RCTBubblingEventBlock instead
 *
 ...
 */
- (NSArray<NSString *> *)customBubblingEventTypes __deprecated_msg("Use ABI6_0_0RCTBubblingEventBlock props instead.");

/**
 * DEPRECATED: declare properties of type ABI6_0_0RCTDirectEventBlock instead
 *
 * Returns an array of names of events that can be sent by native views. This
 ...
 */
- (NSArray<NSString *> *)customDirectEventTypes __deprecated_msg("Use ABI6_0_0RCTDirectEventBlock props instead.");
 ...
 */
- (ABI6_0_0RCTViewManagerUIBlock)uiBlockToAmendWithShadowViewRegistry:(NSDictionary<NSNumber *, ABI6_0_0RCTShadowView *> *)shadowViewRegistry;

/**
 * This handles the simple case, where JS and native property names match.
 */
#define ABI6_0_0RCT_EXPORT_VIEW_PROPERTY(name, type) \
+ (NSArray<NSString *> *)propConfig_##name { return @[@#type]; }

/**
 * This macro maps a named property to an arbitrary key path in the view.
 */
#define ABI6_0_0RCT_REMAP_VIEW_PROPERTY(name, keyPath, type) \
 ...
 */
#define ABI6_0_0RCT_CUSTOM_VIEW_PROPERTY(name, type, viewClass) \
ABI6_0_0RCT_REMAP_VIEW_PROPERTY(name, __custom__, type)         \
- (void)set_##name:(id)json forView:(viewClass *)view withDefaultView:(viewClass *)defaultView

/**
 * This macro is used to map properties to the shadow view, instead of the view.
 */
#define ABI6_0_0RCT_EXPORT_SHADOW_PROPERTY(name, type) \
