...
@implementation ABI6_0_0RCTConvert(MapKit)
...
ABI6_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
  @"standard": @(MKMapTypeStandard),
  @"satellite": @(MKMapTypeSatellite),
  @"hybrid": @(MKMapTypeHybrid),
}), MKMapTypeStandard, integerValue)

+ (ABI6_0_0RCTMapAnnotation *)ABI6_0_0RCTMapAnnotation:(id)json
{
  json = [self NSDictionary:json];
  ABI6_0_0RCTMapAnnotation *annotation = [ABI6_0_0RCTMapAnnotation new];
...
ABI6_0_0RCT_ARRAY_CONVERTER(ABI6_0_0RCTMapAnnotation)

+ (ABI6_0_0RCTMapOverlay *)ABI6_0_0RCTMapOverlay:(id)json
{
  json = [self NSDictionary:json];
  ...
  ABI6_0_0RCTMapOverlay *overlay = [ABI6_0_0RCTMapOverlay polylineWithCoordinates:coordinates
...
ABI6_0_0RCT_ARRAY_CONVERTER(ABI6_0_0RCTMapOverlay)
