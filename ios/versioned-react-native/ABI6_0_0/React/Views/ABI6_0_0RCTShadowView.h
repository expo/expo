...
typedef NS_ENUM(NSUInteger, ABI6_0_0RCTUpdateLifecycle) {
  ABI6_0_0RCTUpdateLifecycleUninitialized = 0,
  ABI6_0_0RCTUpdateLifecycleComputed,
  ABI6_0_0RCTUpdateLifecycleDirtied,
};

typedef void (^ABI6_0_0RCTApplierBlock)(NSDictionary<NSNumber *, UIView *> *viewRegistry);

/**
 * ShadowView tree mirrors ABI6_0_0RCT view tree. Every node is highly stateful.
 * 1. A node is in one of three lifecycles: uninitialized, computed, dirtied.
 * 1. ABI6_0_0RCTBridge may call any of the padding/margin/width/height/top/left setters. A setter would dirty
 ...
 */
@interface ABI6_0_0RCTShadowView : NSObject <ABI6_0_0RCTComponent>

- (NSArray<ABI6_0_0RCTShadowView *> *)ReactABI6_0_0Subviews;
- (ABI6_0_0RCTShadowView *)ReactABI6_0_0Superview;

@property (nonatomic, weak, readonly) ABI6_0_0RCTShadowView *superview;
@property (nonatomic, assign, readonly) css_node_t *cssNode;
@property (nonatomic, copy) NSString *viewName;
@property (nonatomic, strong) UIColor *backgroundColor; // Used to propagate to children
@property (nonatomic, assign) ABI6_0_0RCTUpdateLifecycle layoutLifecycle;
@property (nonatomic, copy) ABI6_0_0RCTDirectEventBlock onLayout;

/**
 * isNewView - Used to track the first time the view is introduced into the hierarchy.  It is initialized YES, then is
 * set to NO in ABI6_0_0RCTUIManager after the layout pass is done and all frames have been extracted to be applied to the
 * corresponding UIViews.
 */
@property (nonatomic, assign, getter=isNewView) BOOL newView;

/**
 * isHidden - ABI6_0_0RCTUIManager uses this to determine whether or not the UIView should be hidden. Useful if the
 ...
 * The applierBlocks set contains ABI6_0_0RCTApplierBlock functions that must be applied
