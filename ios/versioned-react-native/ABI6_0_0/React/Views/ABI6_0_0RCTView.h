...
#import "ABI6_0_0RCTPointerEvents.h"

@protocol ABI6_0_0RCTAutoInsetsProtocol;

@class ABI6_0_0RCTView;

@interface ABI6_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI6_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI6_0_0RCTDirectEventBlock onMagicTap;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI6_0_0RCTPointerEvents pointerEvents;
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI6_0_0RCTBorderStyle borderStyle;
