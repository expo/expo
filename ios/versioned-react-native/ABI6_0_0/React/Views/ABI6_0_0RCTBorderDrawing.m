...
static const CGFloat ABI6_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI6_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return
  ABS(borderInsets.left - borderInsets.right) < ABI6_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.bottom) < ABI6_0_0RCTViewBorderThreshold &&
  ABS(borderInsets.left - borderInsets.top) < ABI6_0_0RCTViewBorderThreshold;
}

BOOL ABI6_0_0RCTCornerRadiiAreEqual(ABI6_0_0RCTCornerRadii cornerRadii)
{
  return
  ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI6_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI6_0_0RCTViewBorderThreshold &&
  ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI6_0_0RCTViewBorderThreshold;
}
...
{
  return (ABI6_0_0RCTCornerInsets) {
    {
...
static void ABI6_0_0RCTPathAddEllipticArc(CGMutablePathRef path,
                                       ...
                                       const CGAffineTransform *transform)
{
  ...
  ABI6_0_0RCTPathAddEllipticArc(path, transform, (CGPoint){
...
static void ABI6_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds,
                                               CGPoint lineStart,
                                               CGPoint lineEnd,
...
NS_INLINE BOOL ABI6_0_0RCTCornerRadiiAreAboveThreshold(ABI6_0_0RCTCornerRadii cornerRadii) {
  return (cornerRadii.topLeft > ABI6_0_0RCTViewBorderThreshold ||
    cornerRadii.topRight > ABI6_0_0RCTViewBorderThreshold      ||
    cornerRadii.bottomLeft > ABI6_0_0RCTViewBorderThreshold    ||
    cornerRadii.bottomRight > ABI6_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI6_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI6_0_0RCTCornerRadii cornerRadii) {
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI6_0_0RCTPathCreateWithRoundedRect(rect, ABI6_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static CGContextRef ABI6_0_0RCTUIGraphicsBeginImageContext(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge) {
...
static UIImage *ABI6_0_0RCTGetSolidBorderImage(ABI6_0_0RCTCornerRadii cornerRadii,
                                       CGSize viewSize,
                                       ...
                                       BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI6_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI6_0_0RCTCornerInsets cornerInsets = ABI6_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  CGContextRef ctx = ABI6_0_0RCTUIGraphicsBeginImageContext(size, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = size};
  CGPathRef path = ABI6_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef insetPath = ABI6_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

  CGContextAddPath(ctx, insetPath);
  CGContextEOClip(ctx);

  BOOL hasEqualColors = ABI6_0_0RCTBorderColorsAreEqual(borderColors);
  if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
    ...
    if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
      CGPoint points[2];
      ABI6_0_0RCTEllipseGetIntersectionsWithLine((CGRect){
...
static UIImage *ABI6_0_0RCTGetDashedOrDottedBorderImage(ABI6_0_0RCTBorderStyle borderStyle,
                                                ...
                                                BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI6_0_0RCTBorderStyleDashed || borderStyle == ABI6_0_0RCTBorderStyleDotted);

  if (!ABI6_0_0RCTBorderColorsAreEqual(borderColors) || !ABI6_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI6_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI6_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  CGContextRef ctx = ABI6_0_0RCTUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  const CGRect rect = {.size = viewSize};

  if (backgroundColor) {
    CGPathRef outerPath = ABI6_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
  ...
  CGPathRef path = ABI6_0_0RCTPathCreateWithRoundedRect(pathRect, ABI6_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

  CGFloat dashLengths[2];
  dashLengths[0] = dashLengths[1] = (borderStyle == ABI6_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
                           ...
                           BOOL drawToEdge)
{
  ...
  switch (borderStyle) {
    case ABI6_0_0RCTBorderStyleSolid:
      return ABI6_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI6_0_0RCTBorderStyleDashed:
    case ABI6_0_0RCTBorderStyleDotted:
      return ABI6_0_0RCTGetDashedOrDottedBorderImage(borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI6_0_0RCTBorderStyleUnset:
      break;
  }
