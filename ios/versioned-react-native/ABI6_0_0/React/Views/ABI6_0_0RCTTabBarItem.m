...
@implementation ABI6_0_0RCTConvert (UITabBarSystemItem)

ABI6_0_0RCT_ENUM_CONVERTER(UITabBarSystemItem, (@{
...
@implementation ABI6_0_0RCTTabBarItem
...
{
  return self.superview.ReactABI6_0_0ViewController;
}
