...
@protocol ABI6_0_0RCTBridgeModule;
@class ABI6_0_0RCTBridge;

@interface ABI6_0_0RCTModuleData : NSObject <ABI6_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI6_0_0RCTBridgeMethod>> *methods;
 ...
 */
@property (nonatomic, strong, readonly) id<ABI6_0_0RCTBridgeModule> instance;
