...
@interface ABI6_0_0RCTImageSource ()

@property (nonatomic, assign) BOOL packagerAsset;

@end

@implementation ABI6_0_0RCTImageSource
...
{
  ABI6_0_0RCTImageSource *imageSource = [[ABI6_0_0RCTImageSource alloc] initWithURL:_imageURL
                                                               size:size
                                                              scale:scale];
...
- (BOOL)isEqual:(ABI6_0_0RCTImageSource *)object
{
  if (![object isKindOfClass:[ABI6_0_0RCTImageSource class]]) {
    return NO;
  }
...
@implementation ABI6_0_0RCTConvert (ImageSource)
...
+ (ABI6_0_0RCTImageSource *)ABI6_0_0RCTImageSource:(id)json
{
  ...
  if ([json isKindOfClass:[NSDictionary class]]) {
    if (!(imageURL = [self NSURL:ABI6_0_0RCTNilIfNull(json[@"uri"])])) {
      return nil;
    }
    ...
    ABI6_0_0RCTLogConvertError(json, @"an image. Did you forget to call resolveAssetSource() on the JS side?");
    return nil;
  }

  ABI6_0_0RCTImageSource *imageSource = [[ABI6_0_0RCTImageSource alloc] initWithURL:imageURL
                                                               size:size
                                                              scale:scale];
