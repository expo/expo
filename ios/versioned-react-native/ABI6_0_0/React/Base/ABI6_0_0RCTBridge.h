...
#import "ABI6_0_0RCTBridgeDelegate.h"
...
@class ABI6_0_0RCTEventDispatcher;

/**
 * This notification triggers a reload of all bridges currently running.
 */
ABI6_0_0RCT_EXTERN NSString *const ABI6_0_0RCTReloadNotification;

/**
 * This notification fires when the bridge starts loading the JS bundle.
 */
ABI6_0_0RCT_EXTERN NSString *const ABI6_0_0RCTJavaScriptWillStartLoadingNotification;

/**
 * This notification fires when the bridge has finished loading the JS bundle.
 */
ABI6_0_0RCT_EXTERN NSString *const ABI6_0_0RCTJavaScriptDidLoadNotification;

/**
 * This notification fires when the bridge failed to load the JS bundle. The
 * `error` key can be used to determine the error that occured.
 */
ABI6_0_0RCT_EXTERN NSString *const ABI6_0_0RCTJavaScriptDidFailToLoadNotification;
 ...
 */
ABI6_0_0RCT_EXTERN NSString *const ABI6_0_0RCTDidInitializeModuleNotification;
 ...
 */
typedef NSArray<id<ABI6_0_0RCTBridgeModule>> *(^ABI6_0_0RCTBridgeModuleProviderBlock)(void);

/**
 * This function returns the module name for a given class.
 */
ABI6_0_0RCT_EXTERN NSString *ABI6_0_0RCTBridgeModuleNameForClass(Class bridgeModuleClass);

/**
 * Async batched bridge used to communicate with the JavaScript application.
 */
@interface ABI6_0_0RCTBridge : NSObject <ABI6_0_0RCTInvalidating>

/**
 * Creates a new bridge with a custom ABI6_0_0RCTBridgeDelegate.
 *
 * All the interaction with the JavaScript context should be done using the bridge
 * instance of the ABI6_0_0RCTBridgeModules. Modules will be automatically instantiated
 ...
 */
@property (nonatomic, weak, readonly) id<ABI6_0_0RCTBridgeDelegate> delegate;
