...
typedef void (^ABI6_0_0RCTSourceLoadBlock)(NSError *error, NSData *source);

@class ABI6_0_0RCTBridge;

@protocol ABI6_0_0RCTBridgeDelegate <NSObject>
 ...
 */
- (NSURL *)sourceURLForBridge:(ABI6_0_0RCTBridge *)bridge;

@optional

/**
 * The bridge initializes any registered ABI6_0_0RCTBridgeModules automatically, however
 ...
 */
- (NSArray *)extraModulesForBridge:(ABI6_0_0RCTBridge *)bridge;
 ...
 */
- (void)loadSourceForBridge:(ABI6_0_0RCTBridge *)bridge
                  withBlock:(ABI6_0_0RCTSourceLoadBlock)loadCallback;
