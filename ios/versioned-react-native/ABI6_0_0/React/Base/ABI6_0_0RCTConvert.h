 ...
 * custom ABI6_0_0RCTViewManager setter methods.
 */
@interface ABI6_0_0RCTConvert : NSObject
...
typedef NSURL ABI6_0_0RCTFileURL;
...
+ (NSArray<ABI6_0_0RCTFileURL *> *)ABI6_0_0RCTFileURLArray:(id)json;
...
+ (ABI6_0_0RCTPointerEvents)ABI6_0_0RCTPointerEvents:(id)json;
+ (ABI6_0_0RCTAnimationType)ABI6_0_0RCTAnimationType:(id)json;
+ (ABI6_0_0RCTBorderStyle)ABI6_0_0RCTBorderStyle:(id)json;
+ (ABI6_0_0RCTTextDecorationLineType)ABI6_0_0RCTTextDecorationLineType:(id)json;

@end

@interface ABI6_0_0RCTConvert (Deprecated)
...
typedef NSArray ABI6_0_0RCTFileURLArray __deprecated_msg("Use NSArray<ABI6_0_0RCTFileURL *>");
 ...
 * If you need to pass image references, try to use `ABI6_0_0RCTImageSource` and then
 * `ABI6_0_0RCTImageLoader` instead of converting directly to a UIImage.
 */
...
/**
 * Underlying implementations of ABI6_0_0RCT_XXX_CONVERTER macros. Ignore these.
 */
ABI6_0_0RCT_EXTERN NSNumber *ABI6_0_0RCTConvertEnumValue(const char *, NSDictionary *, NSNumber *, id);
ABI6_0_0RCT_EXTERN NSNumber *ABI6_0_0RCTConvertMultiEnumValue(const char *, NSDictionary *, NSNumber *, id);
ABI6_0_0RCT_EXTERN NSArray *ABI6_0_0RCTConvertArrayValue(SEL, id);

/**
 * Get the converter function for the specified type
 */
ABI6_0_0RCT_EXTERN SEL ABI6_0_0RCTConvertSelectorForType(NSString *type);
 ...
 */
#define ABI6_0_0RCTLogConvertError(json, typeName) \
ABI6_0_0RCTLogError(@"JSON value '%@' of type %@ cannot be converted to %@", \
 ...
 */
#define ABI6_0_0RCT_CONVERTER(type, name, getter) \
ABI6_0_0RCT_CUSTOM_CONVERTER(type, name, [json getter])

/**
 * This macro is used for creating converter functions with arbitrary logic.
 */
#define ABI6_0_0RCT_CUSTOM_CONVERTER(type, name, code) \
+ (type)name:(id)json                          \
{                                              \
...
/**
 * This macro is similar to ABI6_0_0RCT_CONVERTER, but specifically geared towards
 ...
 */
#define ABI6_0_0RCT_NUMBER_CONVERTER(type, getter) \
ABI6_0_0RCT_CUSTOM_CONVERTER(type, type, [ABI6_0_0RCT_DEBUG ? [self NSNumber:json] : json getter])

/**
 * This macro is used for creating converters for enum types.
 */
#define ABI6_0_0RCT_ENUM_CONVERTER(type, values, default, getter) \
+ (type)type:(id)json                                     \
{                                                         \
  ...
  return [ABI6_0_0RCTConvertEnumValue(#type, mapping, @(default), json) getter]; \
}
 ...
 */
#define ABI6_0_0RCT_MULTI_ENUM_CONVERTER(type, values, default, getter) \
+ (type)type:(id)json                                     \
{                                                         \
  static NSDictionary *mapping;                           \
  static dispatch_once_t onceToken;                       \
  ...
  return [ABI6_0_0RCTConvertMultiEnumValue(#type, mapping, @(default), json) getter]; \
}

/**
 * This macro is used for creating converter functions for typed arrays.
 */
#define ABI6_0_0RCT_ARRAY_CONVERTER(type)                      \
+ (NSArray<id> *)type##Array:(id)json                      \
{                                                      \
  return ABI6_0_0RCTConvertArrayValue(@selector(type:), json); \
}
