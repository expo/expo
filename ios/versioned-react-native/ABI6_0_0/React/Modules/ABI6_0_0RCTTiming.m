...
@interface ABI6_0_0RCTTimer : NSObject
...
@implementation ABI6_0_0RCTTimer
...
@implementation ABI6_0_0RCTTiming
{
  NSMutableDictionary<NSNumber *, ABI6_0_0RCTTimer *> *_timers;
}
...
- (void)didUpdateFrame:(__unused ABI6_0_0RCTFrameUpdate *)update
{
  ...
  for (ABI6_0_0RCTTimer *timer in _timers.allValues) {
 ...
 */
ABI6_0_0RCT_EXPORT_METHOD(createTimer:(nonnull NSNumber *)callbackID
                  ...
                  repeats:(BOOL)repeats)
{
  ...
  ABI6_0_0RCTTimer *timer = [[ABI6_0_0RCTTimer alloc] initWithCallbackID:callbackID
                                                interval:jsDuration
...
ABI6_0_0RCT_EXPORT_METHOD(deleteTimer:(nonnull NSNumber *)timerID)
{
