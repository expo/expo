...
#import "ABI6_0_0RCTKeyboardObserver.h"

#import "ABI6_0_0RCTEventDispatcher.h"

static NSDictionary *ABI6_0_0RCTParseKeyboardNotification(NSNotification *notification);

@implementation ABI6_0_0RCTKeyboardObserver
...
{ \
  [self sendEventWithName:@#EVENT \
    body:ABI6_0_0RCTParseKeyboardNotification(notification)]; \
}
...
NS_INLINE NSDictionary *ABI6_0_0RCTRectDictionaryValue(CGRect rect)
{
  return @{
...
static NSString *ABI6_0_0RCTAnimationNameForCurve(UIViewAnimationCurve curve)
{
  switch (curve) {
...
static NSDictionary *ABI6_0_0RCTParseKeyboardNotification(NSNotification *notification)
{
  ...
  return @{
    @"startCoordinates": ABI6_0_0RCTRectDictionaryValue(beginFrame),
    @"endCoordinates": ABI6_0_0RCTRectDictionaryValue(endFrame),
    @"duration": @(duration * 1000.0), // ms
    @"easing": ABI6_0_0RCTAnimationNameForCurve(curve),
  };
}
