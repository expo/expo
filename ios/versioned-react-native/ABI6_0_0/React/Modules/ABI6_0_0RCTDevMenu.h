...
@class ABI6_0_0RCTDevMenuItem;

/**
 * Developer menu, useful for exposing extra functionality when debugging.
 */
@interface ABI6_0_0RCTDevMenu : NSObject

/**
 * Is the menu enabled. The menu is enabled by default if ABI6_0_0RCT_DEV=1, but
 ...
 */
@interface ABI6_0_0RCTDevMenuItem : NSObject
 ...
 * ABI6_0_0RCTBridge, which is useful for any class that needs to access the menu.
 */
@interface ABI6_0_0RCTBridge (ABI6_0_0RCTDevMenu)

@property (nonatomic, readonly) ABI6_0_0RCTDevMenu *devMenu;
