...
#import "ABI6_0_0RCTDevLoadingView.h"
...
@implementation ABI6_0_0RCTDevLoadingView
{
  UIWindow *_window;
  UILabel *_label;
  NSDate *_showDate;
...
- (void)setBridge:(ABI6_0_0RCTBridge *)bridge
{
  ...
  [[NSNotificationCenter defaultCenter] addObserver:self
                                           selector:@selector(hide)
                                               name:ABI6_0_0RCTJavaScriptDidLoadNotification
                                             object:nil];

  [[NSNotificationCenter defaultCenter] addObserver:self
                                           selector:@selector(hide)
                                               name:ABI6_0_0RCTJavaScriptDidFailToLoadNotification
                                             object:nil];
...
ABI6_0_0RCT_EXPORT_METHOD(showMessage:(NSString *)message color:(UIColor *)color backgroundColor:(UIColor *)backgroundColor)
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    if (!_window && !ABI6_0_0RCTRunningInTestEnvironment()) {
