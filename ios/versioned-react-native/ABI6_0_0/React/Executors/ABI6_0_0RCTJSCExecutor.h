 ...
 */
ABI6_0_0RCT_EXTERN NSString *const ABI6_0_0RCTJSCThreadName;
 ...
 */
ABI6_0_0RCT_EXTERN NSString *const ABI6_0_0RCTJavaScriptContextCreatedNotification;

/**
 * Create a NSError from a JSError object.
 *
 * If available, the error's userInfo property will contain the JS stacktrace under
 * the ABI6_0_0RCTJSStackTraceKey key.
 */
ABI6_0_0RCT_EXTERN NSError *ABI6_0_0RCTNSErrorFromJSError(JSContextRef context, JSValueRef jsError);

/**
 * Uses a JavaScriptCore context as the execution engine.
 */
@interface ABI6_0_0RCTJSCExecutor : NSObject <ABI6_0_0RCTJavaScriptExecutor>
