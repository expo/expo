...
@interface ABI6_0_0ARTRenderable : ABI6_0_0ARTNode

@property (nonatomic, strong) ABI6_0_0ARTBrush *fill;
...
@property (nonatomic, assign) ABI6_0_0ARTCGFloatArray strokeDash;
