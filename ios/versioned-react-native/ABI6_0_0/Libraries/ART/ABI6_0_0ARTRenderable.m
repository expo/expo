...
#import "ABI6_0_0ARTRenderable.h"

@implementation ABI6_0_0ARTRenderable

- (void)setFill:(ABI6_0_0ARTBrush *)fill
{
  [self invalidate];
  _fill = fill;
}
...
- (void)setStrokeDash:(ABI6_0_0ARTCGFloatArray)strokeDash
{
