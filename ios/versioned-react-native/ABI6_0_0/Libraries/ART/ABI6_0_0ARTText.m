...
@implementation ABI6_0_0ARTText
...
static void ABI6_0_0ARTFreeTextFrame(ABI6_0_0ARTTextFrame frame)
{
  if (frame.count) {
...
- (void)setTextFrame:(ABI6_0_0ARTTextFrame)frame
{
  if (frame.lines != _textFrame.lines) {
    ABI6_0_0ARTFreeTextFrame(_textFrame);
  }
  [self invalidate];
  _textFrame = frame;
}
...
{
  ABI6_0_0ARTTextFrame frame = self.textFrame;
  ...
  if (self.stroke) {
    ...
    ABI6_0_0ARTCGFloatArray dash = self.strokeDash;
    if (dash.count) {
