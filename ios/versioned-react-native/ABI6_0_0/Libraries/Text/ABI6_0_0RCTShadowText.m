...
NSString *const ABI6_0_0RCTShadowViewAttributeName = @"ABI6_0_0RCTShadowViewAttributeName";
NSString *const ABI6_0_0RCTIsHighlightedAttributeName = @"IsHighlightedAttributeName";
NSString *const ABI6_0_0RCTReactABI6_0_0TagAttributeName = @"ReactABI6_0_0TagAttributeName";

@implementation ABI6_0_0RCTShadowText
{
...
static css_dim_t ABI6_0_0RCTMeasure(void *context, float width, css_measure_mode_t widthMode, float height, css_measure_mode_t heightMode)
{
  ABI6_0_0RCTShadowText *shadowText = (__bridge ABI6_0_0RCTShadowText *)context;
  ...
  css_dim_t result;
  result.dimensions[CSS_WIDTH] = ABI6_0_0RCTCeilPixelValue(computedSize.width);
  if (shadowText->_effectiveLetterSpacing < 0) {
    result.dimensions[CSS_WIDTH] -= shadowText->_effectiveLetterSpacing;
  }
  result.dimensions[CSS_HEIGHT] = ABI6_0_0RCTCeilPixelValue(computedSize.height);
  return result;
}
...
{
  if ([[self ReactABI6_0_0Superview] isKindOfClass:[ABI6_0_0RCTShadowText class]]) {
  ...
  [applierBlocks addObject:^(NSDictionary<NSNumber *, ABI6_0_0RCTText *> *viewRegistry) {
    ABI6_0_0RCTText *view = viewRegistry[self.ReactABI6_0_0Tag];
             ...
             absolutePosition:(CGPoint)absolutePosition
{
  ...
  [layoutManager.textStorage enumerateAttribute:ABI6_0_0RCTShadowViewAttributeName inRange:characterRange options:0 usingBlock:^(ABI6_0_0RCTShadowView *child, NSRange range, BOOL *_) {
    if (child != nil) {
      ...
      if (isUndefined(width) || isUndefined(height)) {
        ABI6_0_0RCTLogError(@"Views nested within a <Text> must have a width and height");
      }
      UIFont *font = [textStorage attribute:NSFontAttributeName atIndex:range.location effectiveRange:nil];
      CGRect glyphRect = [layoutManager boundingRectForGlyphRange:range inTextContainer:textContainer];
      CGRect childFrame = {{
        ABI6_0_0RCTRoundPixelValue(glyphRect.origin.x),
        ABI6_0_0RCTRoundPixelValue(glyphRect.origin.y + glyphRect.size.height - height + font.descender)
      }, {
        ABI6_0_0RCTRoundPixelValue(width),
        ABI6_0_0RCTRoundPixelValue(height)
      }};
                                                ...
                                                opacity:(CGFloat)opacity
{
  ...
  UIFont *font = [ABI6_0_0RCTConvert UIFont:nil withFamily:fontFamily
  ...
  for (ABI6_0_0RCTShadowView *child in [self ReactABI6_0_0Subviews]) {
    if ([child isKindOfClass:[ABI6_0_0RCTShadowText class]]) {
      ABI6_0_0RCTShadowText *shadowText = (ABI6_0_0RCTShadowText *)child;
    ...
    } else if ([child isKindOfClass:[ABI6_0_0RCTShadowRawText class]]) {
      ABI6_0_0RCTShadowRawText *shadowRawText = (ABI6_0_0RCTShadowRawText *)child;
      ...
      [attachmentString addAttribute:ABI6_0_0RCTShadowViewAttributeName value:child range:(NSRange){0, attachmentString.length}];
      [attributedString appendAttributedString:attachmentString];
      if (height > heightOfTallestSubview) {
        heightOfTallestSubview = height;
      }
      // Don't call setTextComputed on this child. ABI6_0_0RCTTextManager takes care of
  ...
  if (_isHighlighted) {
    [self _addAttribute:ABI6_0_0RCTIsHighlightedAttributeName withValue:@YES toAttributedString:attributedString];
  }
  ...
  [self _addAttribute:ABI6_0_0RCTReactABI6_0_0TagAttributeName withValue:self.ReactABI6_0_0Tag toAttributedString:attributedString];
                      ...
                      heightOfTallestSubview:(CGFloat)heightOfTallestSubview
{
  ...
  // Text decoration
  if (_textDecorationLine == ABI6_0_0RCTTextDecorationLineTypeUnderline ||
      _textDecorationLine == ABI6_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    [self _addAttribute:NSUnderlineStyleAttributeName withValue:@(_textDecorationStyle)
     toAttributedString:attributedString];
  }
  if (_textDecorationLine == ABI6_0_0RCTTextDecorationLineTypeStrikethrough ||
      _textDecorationLine == ABI6_0_0RCTTextDecorationLineTypeUnderlineStrikethrough){
...
- (void)fillCSSNode:(css_node_t *)node
{
  ...
  node->measure = ABI6_0_0RCTMeasure;
...
{
  [super removeReactABI6_0_0Subview:subview];
  self.cssNode->children_count = 0;
}
...
#define ABI6_0_0RCT_TEXT_PROPERTY(setProp, ivar, type) \
...
ABI6_0_0RCT_TEXT_PROPERTY(Color, _color, UIColor *)
ABI6_0_0RCT_TEXT_PROPERTY(FontFamily, _fontFamily, NSString *)
ABI6_0_0RCT_TEXT_PROPERTY(FontSize, _fontSize, CGFloat)
ABI6_0_0RCT_TEXT_PROPERTY(FontWeight, _fontWeight, NSString *)
ABI6_0_0RCT_TEXT_PROPERTY(FontStyle, _fontStyle, NSString *)
ABI6_0_0RCT_TEXT_PROPERTY(IsHighlighted, _isHighlighted, BOOL)
ABI6_0_0RCT_TEXT_PROPERTY(LetterSpacing, _letterSpacing, CGFloat)
ABI6_0_0RCT_TEXT_PROPERTY(LineHeight, _lineHeight, CGFloat)
ABI6_0_0RCT_TEXT_PROPERTY(NumberOfLines, _numberOfLines, NSUInteger)
ABI6_0_0RCT_TEXT_PROPERTY(TextAlign, _textAlign, NSTextAlignment)
ABI6_0_0RCT_TEXT_PROPERTY(TextDecorationColor, _textDecorationColor, UIColor *);
ABI6_0_0RCT_TEXT_PROPERTY(TextDecorationLine, _textDecorationLine, ABI6_0_0RCTTextDecorationLineType);
ABI6_0_0RCT_TEXT_PROPERTY(TextDecorationStyle, _textDecorationStyle, NSUnderlineStyle);
ABI6_0_0RCT_TEXT_PROPERTY(WritingDirection, _writingDirection, NSWritingDirection)
ABI6_0_0RCT_TEXT_PROPERTY(Opacity, _opacity, CGFloat)
ABI6_0_0RCT_TEXT_PROPERTY(TextShadowOffset, _textShadowOffset, CGSize);
ABI6_0_0RCT_TEXT_PROPERTY(TextShadowRadius, _textShadowRadius, CGFloat);
ABI6_0_0RCT_TEXT_PROPERTY(TextShadowColor, _textShadowColor, UIColor *);
...
- (void)setAllowFontScaling:(BOOL)allowFontScaling
{
  ...
  for (ABI6_0_0RCTShadowView *child in [self ReactABI6_0_0Subviews]) {
    if ([child isKindOfClass:[ABI6_0_0RCTShadowText class]]) {
      ((ABI6_0_0RCTShadowText *)child).allowFontScaling = allowFontScaling;
    }
  }
  [self dirtyText];
}
...
- (void)setFontSizeMultiplier:(CGFloat)fontSizeMultiplier
{
  ...
  if (_fontSizeMultiplier == 0) {
    ABI6_0_0RCTLogError(@"fontSizeMultiplier value must be > zero.");
    _fontSizeMultiplier = 1.0;
  }
  for (ABI6_0_0RCTShadowView *child in [self ReactABI6_0_0Subviews]) {
    if ([child isKindOfClass:[ABI6_0_0RCTShadowText class]]) {
      ((ABI6_0_0RCTShadowText *)child).fontSizeMultiplier = fontSizeMultiplier;
    }
  }
  [self dirtyText];
}
