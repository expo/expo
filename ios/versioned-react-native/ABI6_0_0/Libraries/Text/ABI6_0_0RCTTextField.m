...
@implementation ABI6_0_0RCTTextField
{
...
- (instancetype)initWithEventDispatcher:(ABI6_0_0RCTEventDispatcher *)eventDispatcher
{
  if ((self = [super initWithFrame:CGRectZero])) {
    ABI6_0_0RCTAssert(eventDispatcher, @"eventDispatcher is a required parameter");
...
static void ABI6_0_0RCTUpdatePlaceholder(ABI6_0_0RCTTextField *self)
{
...
- (void)setPlaceholderTextColor:(UIColor *)placeholderTextColor
{
  ...
  ABI6_0_0RCTUpdatePlaceholder(self);
}
...
{
  // TODO: do we support subviews of textfield in ReactABI6_0_0?
...
- (void)removeReactABI6_0_0Subview:(UIView *)subview
{
  ...
  // its own views below or between ReactABI6_0_0's, the indices won't match
...
{
  _nativeEventCount++;
  [_eventDispatcher sendTextEventWithType:ABI6_0_0RCTTextEventTypeChange
                                 ReactABI6_0_0Tag:self.ReactABI6_0_0Tag
                                     text:self.text
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (void)observeValueForKeyPath:(NSString *)keyPath
                      ofObject:(ABI6_0_0RCTTextField *)textField
