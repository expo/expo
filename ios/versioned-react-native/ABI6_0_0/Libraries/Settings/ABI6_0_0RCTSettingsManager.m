...
#import "ABI6_0_0RCTSettingsManager.h"
...
@implementation ABI6_0_0RCTSettingsManager
{
...
{
  return @{@"settings": ABI6_0_0RCTJSONClean([_defaults dictionaryRepresentation])};
}
...
- (void)userDefaultsDidChange:(NSNotification *)note
{
  ...
  [_bridge.eventDispatcher
   ...
   body:ABI6_0_0RCTJSONClean([_defaults dictionaryRepresentation])];
}
 ...
 */
ABI6_0_0RCT_EXPORT_METHOD(setValues:(NSDictionary *)values)
{
  _ignoringUpdates = YES;
  [values enumerateKeysAndObjectsUsingBlock:^(NSString *key, id json, BOOL *stop) {
    id plist = [ABI6_0_0RCTConvert NSPropertyList:json];
    if (plist) {
 ...
 */
ABI6_0_0RCT_EXPORT_METHOD(deleteValues:(NSArray<NSString *> *)keys)
{
  _ignoringUpdates = YES;
