...
#import "ABI6_0_0RCTPhotoLibraryImageLoader.h"
...
@implementation ABI6_0_0RCTPhotoLibraryImageLoader

ABI6_0_0RCT_EXPORT_MODULE()

@synthesize bridge = _bridge;

#pragma mark - ABI6_0_0RCTImageLoader
                                 ...
                                 completionHandler:(ABI6_0_0RCTImageLoaderCompletionBlock)completionHandler
{
  ...
  if (results.count == 0) {
    ...
    completionHandler(ABI6_0_0RCTErrorWithMessage(errorText), nil);
    return ^{};
  }
  ...
  if (resizeMode == ABI6_0_0RCTResizeModeContain) {
