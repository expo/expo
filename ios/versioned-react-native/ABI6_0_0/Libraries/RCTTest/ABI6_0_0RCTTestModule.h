...
typedef NS_ENUM(NSInteger, ABI6_0_0RCTTestStatus) {
  ABI6_0_0RCTTestStatusPending = 0,
  ABI6_0_0RCTTestStatusPassed,
  ABI6_0_0RCTTestStatusFailed
};

@class FBSnapshotTestController;

@interface ABI6_0_0RCTTestModule : NSObject <ABI6_0_0RCTBridgeModule>
 ...
 */
@property (nonatomic, readonly) ABI6_0_0RCTTestStatus status;
