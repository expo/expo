...
@interface ABI6_0_0RCTHTTPRequestHandler () <NSURLSessionDataDelegate>

@end

@implementation ABI6_0_0RCTHTTPRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  dispatch_once(&onceToken, ^{
    // technically, ABI6_0_0RCTHTTPRequestHandler can handle file:// as well,
    // but it's less efficient than using ABI6_0_0RCTFileRequestHandler
