...
export type Home_ProfileSnacksQuery = { __typename?: 'RootQuery', me?: Types.Maybe<{ __typename?: 'User', id: string, snacks: Array<{ __typename?: 'Snack', name: string, description: string, fullName: string, slug: string, isDraft: boolean }> }> };
