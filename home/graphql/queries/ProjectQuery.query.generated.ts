...
export type WebContainerProjectPage_QueryQueryVariables = Types.Exact<{
...
export const WebContainerProjectPage_QueryDocument = gql`
  ...
  app {
    ...
    `;
export function useWebContainerProjectPage_QueryQuery(baseOptions: Apollo.QueryHookOptions<WebContainerProjectPage_QueryQuery, WebContainerProjectPage_QueryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<WebContainerProjectPage_QueryQuery, WebContainerProjectPage_QueryQueryVariables>(WebContainerProjectPage_QueryDocument, options);
      }
export function useWebContainerProjectPage_QueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<WebContainerProjectPage_QueryQuery, WebContainerProjectPage_QueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<WebContainerProjectPage_QueryQuery, WebContainerProjectPage_QueryQueryVariables>(WebContainerProjectPage_QueryDocument, options);
        }
export type WebContainerProjectPage_QueryQueryHookResult = ReturnType<typeof useWebContainerProjectPage_QueryQuery>;
export type WebContainerProjectPage_QueryLazyQueryHookResult = ReturnType<typeof useWebContainerProjectPage_QueryLazyQuery>;
export type WebContainerProjectPage_QueryQueryResult = Apollo.QueryResult<WebContainerProjectPage_QueryQuery, WebContainerProjectPage_QueryQueryVariables>;
export function refetchWebContainerProjectPage_QueryQuery(variables?: WebContainerProjectPage_QueryQueryVariables) {
