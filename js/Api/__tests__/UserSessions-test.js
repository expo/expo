...
describe('User Authentication Flow', () => {
  ...
  beforeAll(async () => {
    ...
    ExStore.dispatch(AuthTokenActions.clearAuthTokens());
    ExStore.dispatch(SessionActions.signOutAsync());
  });
  ...
  // login with Auth0, expect tokens to be stored
   it('login and stores auth tokens correctly', async () => {
    ...
    ExStore.dispatch(SessionActions.setSession({ sessionSecret: signinResult.sessionSecret }));
    ExStore.dispatch(
