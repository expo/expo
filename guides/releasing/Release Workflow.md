...
- Run `GITHUB_TOKEN=${GITHUB_TOKEN} et eas ios-simulator-upload` to download the build artifact and upload it to GitHub [releases](https://github.com/expo/expo-go-releases/releases). The GITHUB_TOKEN variable should have contents read/write access to [expo-go-releases](https://github.com/expo/expo-go-releases) repo.
- Run `et eas android-apk-build` to trigger building Expo Go for Android APK on EAS.
- Run `GITHUB_TOKEN=${GITHUB_TOKEN} et eas android-apk-upload` to download the build artifact and upload it to GitHub [releases](https://github.com/expo/expo-go-releases/releases). The GITHUB_TOKEN variable should have contents read/write access to [expo-go-releases](https://github.com/expo/expo-go-releases) repo.
