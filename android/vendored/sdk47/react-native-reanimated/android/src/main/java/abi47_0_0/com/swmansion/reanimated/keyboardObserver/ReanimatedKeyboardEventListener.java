package abi47_0_0.com.swmansion.reanimated.keyboardObserver;
...
import abi47_0_0.com.swmansion.reanimated.BuildConfig;
import abi47_0_0.com.swmansion.reanimated.NativeProxy.KeyboardEventDataUpdater;
...
public class ReanimatedKeyboardEventListener {
  ...
  private void setupWindowInsets() {
    ...
    ViewCompat.setOnApplyWindowInsetsListener(
        ...
        (v, insets) -> {
          ...
          View content =
              rootView.getRootView().findViewById(abi47_0_0.com.swmansion.reanimated.R.id.action_bar_root);
  ...
  private void bringBackWindowInsets() {
    ...
    View content =
        getRootView().getRootView().findViewById(abi47_0_0.com.swmansion.reanimated.R.id.action_bar_root);
