...
class AnimationFrameCallback : public HybridClass<AnimationFrameCallback> {
 public:
  static auto constexpr kJavaDescriptor =
      "Labi49_0_0/com/swmansion/reanimated/nativeProxy/AnimationFrameCallback;";
...
class EventHandler : public HybridClass<EventHandler> {
 public:
  static auto constexpr kJavaDescriptor =
      "Labi49_0_0/com/swmansion/reanimated/nativeProxy/EventHandler;";
...
class SensorSetter : public HybridClass<SensorSetter> {
 public:
  static auto constexpr kJavaDescriptor =
      "Labi49_0_0/com/swmansion/reanimated/nativeProxy/SensorSetter;";
...
class KeyboardEventDataUpdater : public HybridClass<KeyboardEventDataUpdater> {
 public:
  static auto constexpr kJavaDescriptor =
      "Labi49_0_0/com/swmansion/reanimated/nativeProxy/KeyboardEventDataUpdater;";
...
class NativeProxy : public jni::HybridClass<NativeProxy> {
 public:
  static auto constexpr kJavaDescriptor =
      "Labi49_0_0/com/swmansion/reanimated/NativeProxy;";
