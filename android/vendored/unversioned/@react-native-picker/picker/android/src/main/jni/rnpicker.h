 ...
 *
 * It is added here to make the custom symbols visible in autogenerated file with
 ...
 * includes autogenerated rnpicker.h header by default. We change this behaviour
