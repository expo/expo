...
import abi10_0_0.com.facebook.react.bridge.ReadableType;
...
public class ImageCropperModule extends ReactContextBaseJavaModule implements ActivityResultListener {
  ...
  public ImageCropperModule(ReactApplicationContext context, ActivityResultDelegator delegator) {
    super(context);

    mActivity = (Activity) delegator;
