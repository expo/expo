...
package abi5_0_0.host.exp.exponent.modules.overridden.asyncstorage;
...
import abi5_0_0.com.facebook.react.modules.storage.AsyncStorageModule;
import abi5_0_0.com.facebook.react.modules.storage.ReactDatabaseSupplier;
...
public class ExponentAsyncStorageModule extends AsyncStorageModule {
  ...
  public ExponentAsyncStorageModule(ReactApplicationContext reactContext, JSONObject manifest) {
    ...
    try {
      ...
      experienceId = URLEncoder.encode(experienceId, "UTF-8");
      String databaseName = "RKStorage-scoped-experience-" + experienceId;
