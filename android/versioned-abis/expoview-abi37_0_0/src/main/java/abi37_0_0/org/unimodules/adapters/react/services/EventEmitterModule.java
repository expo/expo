...
public class EventEmitterModule implements EventEmitter, InternalModule {
  ...
  public void emit(final int viewId, final String eventName, final Bundle eventBody) {
    mReactContext.getNativeModule(UIManagerModule.class).getEventDispatcher().dispatchEvent(new abi37_0_0.com.facebook.react.uimanager.events.Event(viewId) {
      @Override
  ...
  private static abi37_0_0.com.facebook.react.uimanager.events.Event getReactEventFromEvent(final int viewId, final Event event) {
    return new abi37_0_0.com.facebook.react.uimanager.events.Event(viewId) {
      @Override
      public String getEventName() {
