package abi37_0_0.expo.modules.payments.stripe;
import android.app.Activity;
import android.content.Intent;
import androidx.annotation.NonNull;

import abi37_0_0.org.unimodules.core.Promise;
import abi37_0_0.expo.modules.payments.stripe.util.ArgCheck;
import abi37_0_0.expo.modules.payments.stripe.util.Converters;
import abi37_0_0.expo.modules.payments.stripe.util.Fun0;
...
import static abi37_0_0.expo.modules.payments.stripe.Errors.toErrorCode;
import static abi37_0_0.expo.modules.payments.stripe.util.Converters.convertTokenToWritableMap;
import static abi37_0_0.expo.modules.payments.stripe.util.Converters.getAllowedShippingCountryCodes;
import static abi37_0_0.expo.modules.payments.stripe.util.Converters.getBillingAddress;
import static abi37_0_0.expo.modules.payments.stripe.util.Converters.putExtraToTokenMap;
import static abi37_0_0.expo.modules.payments.stripe.util.PayParams.BILLING_ADDRESS_REQUIRED;
import static abi37_0_0.expo.modules.payments.stripe.util.PayParams.CURRENCY_CODE;
import static abi37_0_0.expo.modules.payments.stripe.util.PayParams.PHONE_NUMBER_REQUIRED;
import static abi37_0_0.expo.modules.payments.stripe.util.PayParams.SHIPPING_ADDRESS_REQUIRED;
import static abi37_0_0.expo.modules.payments.stripe.util.PayParams.TOTAL_PRICE;
