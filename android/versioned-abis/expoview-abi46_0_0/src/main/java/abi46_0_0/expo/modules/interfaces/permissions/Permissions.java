...
public interface Permissions {
  ...
  /**
   * Compatibility method that accepts abi46_0_0.expo.modules.kotlin.Promise, but forward the logic to the other method
   */
  static void getPermissionsWithPermissionsManager(
    @Nullable Permissions permissionsManager,
    @NonNull final abi46_0_0.expo.modules.kotlin.Promise promise,
