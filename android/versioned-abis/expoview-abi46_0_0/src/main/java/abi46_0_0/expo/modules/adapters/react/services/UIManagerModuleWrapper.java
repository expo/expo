...
public class UIManagerModuleWrapper implements
  ...
  private Map<LifecycleEventListener, abi46_0_0.com.facebook.react.bridge.LifecycleEventListener> mLifecycleListenersMap = new WeakHashMap<>();
  private Map<ActivityEventListener, abi46_0_0.com.facebook.react.bridge.ActivityEventListener> mActivityEventListenersMap = new WeakHashMap<>();
  ...
  public <T> void addUIBlock(final int tag, final UIBlock<T> block, final Class<T> tClass) {
    getContext().getNativeModule(UIManagerModule.class).addUIBlock(new abi46_0_0.com.facebook.react.uimanager.UIBlock() {
      @Override
  ...
  public void registerLifecycleEventListener(final LifecycleEventListener listener) {
    ...
    mLifecycleListenersMap.put(listener, new abi46_0_0.com.facebook.react.bridge.LifecycleEventListener() {
      @Override
  ...
  public void registerActivityEventListener(final ActivityEventListener activityEventListener) {
    ...
    mActivityEventListenersMap.put(activityEventListener, new abi46_0_0.com.facebook.react.bridge.ActivityEventListener() {
      @Override
