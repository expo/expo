...
import abi46_0_0.expo.modules.imagepicker.createOutputFile
import abi46_0_0.expo.modules.imagepicker.toBitmapCompressFormat
import abi46_0_0.expo.modules.imagepicker.toImageFileExtension
...
internal class CropImageContract(
  ...
  override fun createIntent(context: Context, input: CropImageContractOptions) = Intent(context, CropImageActivity::class.java).apply {
    val mediaType = abi46_0_0.expo.modules.imagepicker.getType(context.contentResolver, input.sourceUri)
