...
import abi46_0_0.com.facebook.react.modules.core.DeviceEventManagerModule.RCTDeviceEventEmitter
...
class KModuleEventEmitterWrapper(
  ...
  legacyEventEmitter: abi46_0_0.expo.modules.core.interfaces.services.EventEmitter,
...
open class KEventEmitterWrapper(
  private val legacyEventEmitter: abi46_0_0.expo.modules.core.interfaces.services.EventEmitter,
  private val reactContextHolder: WeakReference<ReactApplicationContext>
) : EventEmitter, abi46_0_0.expo.modules.core.interfaces.services.EventEmitter by legacyEventEmitter {
  ...
  ) : abi46_0_0.com.facebook.react.uimanager.events.Event<UIEvent>(viewId) {
