package abi35_0_0.org.unimodules.adapters.react.services;
...
public class EventEmitterModule implements EventEmitter, InternalModule {
  ...
  public void emit(final int viewId, final String eventName, final Bundle eventBody) {
    mReactContext.getNativeModule(UIManagerModule.class).getEventDispatcher().dispatchEvent(new abi35_0_0.com.facebook.react.uimanager.events.Event(viewId) {
      @Override
  ...
  private static abi35_0_0.com.facebook.react.uimanager.events.Event getReactEventFromEvent(final int viewId, final Event event) {
    return new abi35_0_0.com.facebook.react.uimanager.events.Event(viewId) {
      @Override
      public String getEventName() {
