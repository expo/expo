...
import abi35_0_0.com.facebook.react.modules.core.PermissionAwareActivity;
import abi35_0_0.com.facebook.react.modules.core.PermissionListener;
import abi35_0_0.com.facebook.react.uimanager.IllegalViewOperationException;
...
import abi35_0_0.org.unimodules.interfaces.permissions.PermissionsListener;
import abi35_0_0.org.unimodules.interfaces.permissions.PermissionsManager;
...
public class UIManagerModuleWrapper implements
  ...
  private Map<LifecycleEventListener, abi35_0_0.com.facebook.react.bridge.LifecycleEventListener> mLifecycleListenersMap = new WeakHashMap<>();
  private Map<ActivityEventListener, abi35_0_0.com.facebook.react.bridge.ActivityEventListener> mActivityEventListenersMap = new WeakHashMap<>();
  ...
  public <T> void addUIBlock(final int tag, final UIBlock<T> block, final Class<T> tClass) {
    getContext().getNativeModule(UIManagerModule.class).addUIBlock(new abi35_0_0.com.facebook.react.uimanager.UIBlock() {
      @Override
  ...
  public void registerLifecycleEventListener(final LifecycleEventListener listener) {
    ...
    mLifecycleListenersMap.put(listener, new abi35_0_0.com.facebook.react.bridge.LifecycleEventListener() {
      @Override
  ...
  public void registerActivityEventListener(final ActivityEventListener activityEventListener) {
    ...
    mActivityEventListenersMap.put(activityEventListener, new abi35_0_0.com.facebook.react.bridge.ActivityEventListener() {
      @Override
