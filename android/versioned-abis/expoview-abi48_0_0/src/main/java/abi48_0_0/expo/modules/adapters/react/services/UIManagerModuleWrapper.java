...
import abi48_0_0.com.facebook.react.uimanager.IllegalViewOperationException;
...
public class UIManagerModuleWrapper implements
  ...
  private Map<LifecycleEventListener, abi48_0_0.com.facebook.react.bridge.LifecycleEventListener> mLifecycleListenersMap = new WeakHashMap<>();
  private Map<ActivityEventListener, abi48_0_0.com.facebook.react.bridge.ActivityEventListener> mActivityEventListenersMap = new WeakHashMap<>();
  ...
  public <T> void addUIBlock(final int tag, final UIBlock<T> block, final Class<T> tClass) {
    getContext().getNativeModule(UIManagerModule.class).addUIBlock(new abi48_0_0.com.facebook.react.uimanager.UIBlock() {
      @Override
  ...
  public View resolveView(int viewTag) {
    final abi48_0_0.com.facebook.react.bridge.UIManager uiManager = UIManagerHelper.getUIManagerForReactTag(getContext(), viewTag);
    if (uiManager == null) {
      return null;
    }
  ...
  public void registerLifecycleEventListener(final LifecycleEventListener listener) {
    ...
    mLifecycleListenersMap.put(listener, new abi48_0_0.com.facebook.react.bridge.LifecycleEventListener() {
      @Override
  ...
  public void registerActivityEventListener(final ActivityEventListener activityEventListener) {
    ...
    mActivityEventListenersMap.put(activityEventListener, new abi48_0_0.com.facebook.react.bridge.ActivityEventListener() {
      @Override
