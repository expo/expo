package abi48_0_0.expo.modules.imagepicker.contracts
...
import abi48_0_0.expo.modules.imagepicker.ImagePickerOptions
import abi48_0_0.expo.modules.imagepicker.MediaType
import abi48_0_0.expo.modules.imagepicker.copyExifData
import abi48_0_0.expo.modules.imagepicker.createOutputFile
import abi48_0_0.expo.modules.imagepicker.toBitmapCompressFormat
import abi48_0_0.expo.modules.imagepicker.toImageFileExtension
import abi48_0_0.expo.modules.kotlin.activityresult.AppContextActivityResultContract
import abi48_0_0.expo.modules.kotlin.providers.AppContextProvider
...
internal class CropImageContract(
  ...
  override fun createIntent(context: Context, input: CropImageContractOptions) = Intent(context, CropImageActivity::class.java).apply {
    val mediaType = abi48_0_0.expo.modules.imagepicker.getType(context.contentResolver, input.sourceUri)
