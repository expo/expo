package abi48_0_0.expo.modules.kotlin.jni
...
import abi48_0_0.expo.modules.kotlin.exception.JavaScriptEvaluateException
...
class JSIInteropModuleRegistry(appContext: AppContext) {
  ...
  companion object {
    init {
      SoLoader.loadLibrary("expo-modules-core_abi48_0_0")
    }
  }
}
