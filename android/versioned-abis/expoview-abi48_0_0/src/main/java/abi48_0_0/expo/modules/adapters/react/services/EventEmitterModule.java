...
import abi48_0_0.expo.modules.adapters.react.views.ViewManagerAdapterUtils;
...
public class EventEmitterModule implements EventEmitter, InternalModule {
  ...
  public void emit(final int viewId, final String eventName, final Bundle eventBody) {
    final EventDispatcher dispatcher = UIManagerHelper.getEventDispatcherForReactTag(mReactContext, viewId);
    dispatcher.dispatchEvent(new abi48_0_0.com.facebook.react.uimanager.events.Event(viewId) {
      @Override
  ...
  private static abi48_0_0.com.facebook.react.uimanager.events.Event getReactEventFromEvent(final int viewId, final Event event) {
    return new abi48_0_0.com.facebook.react.uimanager.events.Event(viewId) {
      @Override
      public String getEventName() {
