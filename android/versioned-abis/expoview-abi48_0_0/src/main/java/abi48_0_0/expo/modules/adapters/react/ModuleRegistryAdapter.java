...
import abi48_0_0.expo.modules.adapters.react.views.SimpleViewManagerAdapter;
import abi48_0_0.expo.modules.adapters.react.views.ViewGroupManagerAdapter;
...
import abi48_0_0.expo.modules.kotlin.CoreLoggerKt;
import abi48_0_0.expo.modules.kotlin.KotlinInteropModuleRegistry;
import abi48_0_0.expo.modules.kotlin.ModulesProvider;
import abi48_0_0.expo.modules.kotlin.views.ViewWrapperDelegateHolder;
...
public class ModuleRegistryAdapter implements ReactPackage {
  ...
  protected List<NativeModule> getNativeModulesFromModuleRegistry(ReactApplicationContext reactContext, ModuleRegistry moduleRegistry) {
    ...
    // Add listener that will notify abi48_0_0.expo.modules.core.ModuleRegistry when all modules are ready
  ...
  public List<ViewManager> createViewManagers(ReactApplicationContext reactContext) {
    ...
    for (abi48_0_0.expo.modules.core.ViewManager viewManager : mModuleRegistryProvider.getViewManagers(reactContext)) {
