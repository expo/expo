...
import abi48_0_0.expo.modules.core.interfaces.DoNotStrip;
...
import abi48_0_0.expo.modules.av.player.PlayerData;
...
import abi48_0_0.expo.modules.interfaces.permissions.PermissionsResponseListener;
...
public class AVManager implements LifecycleEventListener, AudioManager.OnAudioFocusChangeListener, MediaRecorder.OnInfoListener, AVManagerInterface, InternalModule {
  static {
    System.loadLibrary("expo-av_abi48_0_0");
  }
