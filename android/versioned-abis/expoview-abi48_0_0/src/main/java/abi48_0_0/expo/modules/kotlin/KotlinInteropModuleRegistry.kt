...
import abi48_0_0.expo.modules.kotlin.defaultmodules.NativeModulesProxyModuleName
...
import abi48_0_0.expo.modules.kotlin.views.GroupViewManagerWrapper
import abi48_0_0.expo.modules.kotlin.views.SimpleViewManagerWrapper
import abi48_0_0.expo.modules.kotlin.views.ViewManagerWrapperDelegate
...
class KotlinInteropModuleRegistry(
  ...
  legacyModuleRegistry: abi48_0_0.expo.modules.core.ModuleRegistry,
    ...
    return registry
      ...
      .map {
        ...
        when (it.definition.viewManagerDefinition!!.getViewManagerType()) {
          abi48_0_0.expo.modules.core.ViewManager.ViewManagerType.SIMPLE -> SimpleViewManagerWrapper(wrapperDelegate)
          abi48_0_0.expo.modules.core.ViewManager.ViewManagerType.GROUP -> GroupViewManagerWrapper(wrapperDelegate)
        }
      }
  }
  ...
  /**
   * Since React Native v0.55, {@link abi48_0_0.com.facebook.react.ReactPackage#createViewManagers(ReactApplicationContext)}
   * gets called only once per lifetime of {@link abi48_0_0.com.facebook.react.ReactInstanceManager}.
