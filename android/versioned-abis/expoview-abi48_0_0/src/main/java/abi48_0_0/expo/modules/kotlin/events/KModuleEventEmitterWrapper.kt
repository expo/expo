...
import abi48_0_0.com.facebook.react.modules.core.DeviceEventManagerModule.RCTDeviceEventEmitter
import abi48_0_0.com.facebook.react.uimanager.UIManagerHelper
import abi48_0_0.expo.modules.kotlin.ModuleHolder
...
class KModuleEventEmitterWrapper(
  ...
  legacyEventEmitter: abi48_0_0.expo.modules.core.interfaces.services.EventEmitter,
...
open class KEventEmitterWrapper(
  private val legacyEventEmitter: abi48_0_0.expo.modules.core.interfaces.services.EventEmitter,
  private val reactContextHolder: WeakReference<ReactApplicationContext>
) : EventEmitter, abi48_0_0.expo.modules.core.interfaces.services.EventEmitter by legacyEventEmitter {
  ...
  ) : abi48_0_0.com.facebook.react.uimanager.events.Event<UIEvent>(viewId) {
