...
/**
 * Decorator for {@link abi44_0_0.com.facebook.react.bridge.Promise},
 * so we don't have to implement these inline in {@link NativeModulesProxy}.
 */
/* package */ class PromiseWrapper implements Promise {
  private abi44_0_0.com.facebook.react.bridge.Promise mPromise;

  /* package */ PromiseWrapper(abi44_0_0.com.facebook.react.bridge.Promise promise) {
    super();
    mPromise = promise;
  }
