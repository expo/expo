...
import abi44_0_0.expo.modules.kotlin.views.GroupViewManagerWrapper
import abi44_0_0.expo.modules.kotlin.views.SimpleViewManagerWrapper
import abi44_0_0.expo.modules.kotlin.views.ViewManagerWrapperDelegate
...
class KotlinInteropModuleRegistry(
  ...
  legacyModuleRegistry: abi44_0_0.expo.modules.core.ModuleRegistry,
    ...
    return registry
      ...
      .map {
        ...
        when (it.definition.viewManagerDefinition!!.getViewManagerType()) {
          abi44_0_0.expo.modules.core.ViewManager.ViewManagerType.SIMPLE -> SimpleViewManagerWrapper(wrapperDelegate)
          abi44_0_0.expo.modules.core.ViewManager.ViewManagerType.GROUP -> GroupViewManagerWrapper(wrapperDelegate)
        }
      }
  }
  ...
  /**
   * Since React Native v0.55, {@link abi44_0_0.com.facebook.react.ReactPackage#createViewManagers(ReactApplicationContext)}
   * gets called only once per lifetime of {@link abi44_0_0.com.facebook.react.ReactInstanceManager}.
