...
/* package */ class SafeAreaUtils {
  ...
  static @Nullable abi44_0_0.host.exp.exponent.modules.api.safeareacontext.Rect getFrame(ViewGroup rootView, View view) {
    ...
    return new abi44_0_0.host.exp.exponent.modules.api.safeareacontext.Rect(offset.left, offset.top, view.getWidth(), view.getHeight());
  }
}
