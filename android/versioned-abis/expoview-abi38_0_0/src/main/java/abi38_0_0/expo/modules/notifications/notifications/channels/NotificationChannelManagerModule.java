...
import abi38_0_0.expo.modules.notifications.notifications.SoundResolver;
...
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.AUDIO_ATTRIBUTES_CONTENT_TYPE_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.AUDIO_ATTRIBUTES_FLAGS_ENFORCE_AUDIBILITY_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.AUDIO_ATTRIBUTES_FLAGS_HW_AV_SYNC_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.AUDIO_ATTRIBUTES_FLAGS_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.AUDIO_ATTRIBUTES_USAGE_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.BYPASS_DND_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.DESCRIPTION_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.ENABLE_LIGHTS_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.ENABLE_VIBRATE_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.GROUP_ID_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.IMPORTANCE_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.LIGHT_COLOR_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.LOCKSCREEN_VISIBILITY_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.NAME_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.SHOW_BADGE_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.SOUND_AUDIO_ATTRIBUTES_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.SOUND_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.VIBRATION_PATTERN_KEY;
import static abi38_0_0.expo.modules.notifications.notifications.channels.NotificationChannelSerializer.toBundle;
