package abi41_0_0.org.unimodules.adapters.react.services;
...
import abi41_0_0.com.facebook.react.uimanager.IllegalViewOperationException;
...
import abi41_0_0.org.unimodules.core.interfaces.ActivityEventListener;
...
import abi41_0_0.org.unimodules.core.interfaces.JavaScriptContextProvider;
import abi41_0_0.org.unimodules.core.interfaces.LifecycleEventListener;
import abi41_0_0.org.unimodules.core.interfaces.services.UIManager;
...
public class UIManagerModuleWrapper implements
  ...
  private Map<LifecycleEventListener, abi41_0_0.com.facebook.react.bridge.LifecycleEventListener> mLifecycleListenersMap = new WeakHashMap<>();
  private Map<ActivityEventListener, abi41_0_0.com.facebook.react.bridge.ActivityEventListener> mActivityEventListenersMap = new WeakHashMap<>();
  ...
  public <T> void addUIBlock(final int tag, final UIBlock<T> block, final Class<T> tClass) {
    getContext().getNativeModule(UIManagerModule.class).addUIBlock(new abi41_0_0.com.facebook.react.uimanager.UIBlock() {
      @Override
  ...
  public void registerLifecycleEventListener(final LifecycleEventListener listener) {
    ...
    mLifecycleListenersMap.put(listener, new abi41_0_0.com.facebook.react.bridge.LifecycleEventListener() {
      @Override
  ...
  public void registerActivityEventListener(final ActivityEventListener activityEventListener) {
    ...
    mActivityEventListenersMap.put(activityEventListener, new abi41_0_0.com.facebook.react.bridge.ActivityEventListener() {
      @Override
