...
import abi49_0_0.expo.modules.kotlin.defaultmodules.NativeModulesProxyModuleName
...
import abi49_0_0.expo.modules.kotlin.views.GroupViewManagerWrapper
import abi49_0_0.expo.modules.kotlin.views.SimpleViewManagerWrapper
import abi49_0_0.expo.modules.kotlin.views.ViewManagerWrapperDelegate
...
class KotlinInteropModuleRegistry(
  ...
  legacyModuleRegistry: abi49_0_0.expo.modules.core.ModuleRegistry,
    ...
    return registry
      ...
      .map {
        ...
        when (it.definition.viewManagerDefinition!!.getViewManagerType()) {
          abi49_0_0.expo.modules.core.ViewManager.ViewManagerType.SIMPLE -> SimpleViewManagerWrapper(wrapperDelegate)
          abi49_0_0.expo.modules.core.ViewManager.ViewManagerType.GROUP -> GroupViewManagerWrapper(wrapperDelegate)
        }
      }
  }
