...
public interface Permissions {
  ...
  /**
   * Compatibility method that accepts abi49_0_0.expo.modules.kotlin.Promise, but forward the logic to the other method
   */
  static void getPermissionsWithPermissionsManager(
    @Nullable Permissions permissionsManager,
    @NonNull final abi49_0_0.expo.modules.kotlin.Promise promise,
