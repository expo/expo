...
import abi31_0_0.com.facebook.react.modules.core.PermissionAwareActivity;
import abi31_0_0.com.facebook.react.modules.core.PermissionListener;
    ...
    UIManager
{
  ...
  private Map<LifecycleEventListener, abi31_0_0.com.facebook.react.bridge.LifecycleEventListener> mLifecycleListenersMap = new WeakHashMap<>();
  ...
  public <T> void addUIBlock(final int tag, final UIBlock<T> block, final Class<T> tClass) {
    getContext().getNativeModule(UIManagerModule.class).addUIBlock(new abi31_0_0.com.facebook.react.uimanager.UIBlock() {
      @Override
  ...
  public void registerLifecycleEventListener(final LifecycleEventListener listener) {
    ...
    mLifecycleListenersMap.put(listener, new abi31_0_0.com.facebook.react.bridge.LifecycleEventListener() {
      @Override
  ...
  public void registerActivityEventListener(final ActivityEventListener activityEventListener) {
    mReactContext.addActivityEventListener(new abi31_0_0.com.facebook.react.bridge.ActivityEventListener() {
      @Override
