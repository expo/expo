package abi40_0_0.expo.modules.taskManager;
...
import abi40_0_0.expo.modules.taskManager.exceptions.InvalidConsumerClassException;
import abi40_0_0.expo.modules.taskManager.exceptions.TaskNotFoundException;
import abi40_0_0.expo.modules.taskManager.exceptions.TaskRegisteringFailedException;
import abi40_0_0.expo.modules.taskManager.repository.TasksAndEventsRepository;

import static abi40_0_0.expo.modules.taskManager.Utils.getConsumerVersion;
import static abi40_0_0.expo.modules.taskManager.Utils.jsonToMap;
import static abi40_0_0.expo.modules.taskManager.Utils.unversionedClassForClass;
...
public class TaskService implements SingletonModule, TaskServiceInterface {
  ...
  public void unregisterTask(String taskName, String appScopeKey, Class consumerClass) throws TaskNotFoundException, InvalidConsumerClassException {
    ...
    Log.i(TAG, "Unregistering task '" + taskName + "' for app '" + appScopeKey + "'.");
  ...
  public void unregisterAllTasksForAppScopeKey(String appScopeKey) {
    ...
    if (appTasks != null) {
      Log.i(TAG, "Unregistering all tasks for app '" + appScopeKey + "'.");
