...
import abi40_0_0.expo.modules.barcodescanner.utils.FrameFactory;
...
public class GMVBarCodeScanner extends ExpoBarCodeScanner {
  ...
  private List<BarCodeScannerResult> scan(abi40_0_0.expo.modules.barcodescanner.utils.Frame frame) {
    try {
