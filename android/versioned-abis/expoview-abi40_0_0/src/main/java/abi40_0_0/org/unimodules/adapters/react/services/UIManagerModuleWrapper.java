...
import abi40_0_0.org.unimodules.core.interfaces.JavaScriptContextProvider;
...
public class UIManagerModuleWrapper implements
  ...
  private Map<LifecycleEventListener, abi40_0_0.com.facebook.react.bridge.LifecycleEventListener> mLifecycleListenersMap = new WeakHashMap<>();
  private Map<ActivityEventListener, abi40_0_0.com.facebook.react.bridge.ActivityEventListener> mActivityEventListenersMap = new WeakHashMap<>();
  ...
  public <T> void addUIBlock(final int tag, final UIBlock<T> block, final Class<T> tClass) {
    getContext().getNativeModule(UIManagerModule.class).addUIBlock(new abi40_0_0.com.facebook.react.uimanager.UIBlock() {
      @Override
  ...
  public void registerLifecycleEventListener(final LifecycleEventListener listener) {
    ...
    mLifecycleListenersMap.put(listener, new abi40_0_0.com.facebook.react.bridge.LifecycleEventListener() {
      @Override
  ...
  public void registerActivityEventListener(final ActivityEventListener activityEventListener) {
    ...
    mActivityEventListenersMap.put(activityEventListener, new abi40_0_0.com.facebook.react.bridge.ActivityEventListener() {
      @Override
