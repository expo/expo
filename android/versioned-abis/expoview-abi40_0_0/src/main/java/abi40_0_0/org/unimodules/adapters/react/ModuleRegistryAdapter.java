...
import abi40_0_0.org.unimodules.adapters.react.views.SimpleViewManagerAdapter;
import abi40_0_0.org.unimodules.adapters.react.views.ViewGroupManagerAdapter;
...
public class ModuleRegistryAdapter implements ReactPackage {
  ...
  protected List<NativeModule> getNativeModulesFromModuleRegistry(ReactApplicationContext reactContext, ModuleRegistry moduleRegistry) {
    ...
    // Add listener that will notify abi40_0_0.org.unimodules.core.ModuleRegistry when all modules are ready
  ...
  public List<ViewManager> createViewManagers(ReactApplicationContext reactContext) {
    ...
    for (abi40_0_0.org.unimodules.core.ViewManager viewManager : mModuleRegistryProvider.getViewManagers(reactContext)) {
