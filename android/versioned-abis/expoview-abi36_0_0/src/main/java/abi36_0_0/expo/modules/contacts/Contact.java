package abi36_0_0.expo.modules.contacts;
...
import abi36_0_0.expo.modules.contacts.models.BaseModel;
import abi36_0_0.expo.modules.contacts.models.DateModel;
import abi36_0_0.expo.modules.contacts.models.EmailModel;
import abi36_0_0.expo.modules.contacts.models.ExtraNameModel;
import abi36_0_0.expo.modules.contacts.models.ImAddressModel;
import abi36_0_0.expo.modules.contacts.models.PhoneNumberModel;
import abi36_0_0.expo.modules.contacts.models.PostalAddressModel;
import abi36_0_0.expo.modules.contacts.models.RelationshipModel;
import abi36_0_0.expo.modules.contacts.models.UrlAddressModel;
...
public class Contact {
  ...
  protected String lookupKey;
    ...
    public ArrayList<ContentProviderOperation> toOperationList() {
        ...
        op = ContentProviderOperation.newInsert(Data.CONTENT_URI)
                .withValueBackReference(Data.RAW_CONTACT_ID, 0)
                .withValue(EXColumns.MIMETYPE, Organization.CONTENT_ITEM_TYPE).withValue(Organization.COMPANY, company)
                .withValue(Organization.TITLE, jobTitle).withValue(Organization.DEPARTMENT, department);
        ops.add(op.build());
        ...
        if (photoUri != null && !photoUri.isEmpty()) {
            ...
            if (photo != null) {
                ops.add(ContentProviderOperation.newInsert(Data.CONTENT_URI)
                        ...
                        .withValue(CommonDataKinds.Photo.PHOTO, toByteArray(photo)).build());
            }
        }
