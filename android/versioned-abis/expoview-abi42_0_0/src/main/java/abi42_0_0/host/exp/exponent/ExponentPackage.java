...
import abi42_0_0.host.exp.exponent.modules.api.appearance.rncappearance.RNCAppearanceModule;
import abi42_0_0.host.exp.exponent.modules.api.reanimated.ReanimatedModule;
import abi42_0_0.host.exp.exponent.modules.internal.DevMenuModule;
/* WHEN_VERSIONING_REMOVE_FROM_HERE
import host.exp.exponent.kernel.ExponentKernelModuleProvider;
WHEN_VERSIONING_REMOVE_TO_HERE */
import host.exp.exponent.utils.ScopedContext;
import abi42_0_0.host.exp.exponent.modules.api.KeyboardModule;
import abi42_0_0.host.exp.exponent.modules.api.PedometerModule;
import abi42_0_0.host.exp.exponent.modules.api.ScreenOrientationModule;
import abi42_0_0.host.exp.exponent.modules.api.ShakeModule;
import abi42_0_0.host.exp.exponent.modules.api.URLHandlerModule;
import abi42_0_0.host.exp.exponent.modules.api.appearance.ExpoAppearanceModule;
import abi42_0_0.host.exp.exponent.modules.api.appearance.ExpoAppearancePackage;
import abi42_0_0.host.exp.exponent.modules.api.cognito.RNAWSCognitoModule;
import abi42_0_0.host.exp.exponent.modules.api.components.datetimepicker.RNDateTimePickerPackage;
import abi42_0_0.host.exp.exponent.modules.api.components.maskedview.RNCMaskedViewPackage;
import abi42_0_0.host.exp.exponent.modules.api.components.picker.RNCPickerPackage;
import abi42_0_0.host.exp.exponent.modules.api.components.slider.ReactSliderPackage;
import abi42_0_0.host.exp.exponent.modules.api.components.gesturehandler.react.RNGestureHandlerModule;
import abi42_0_0.host.exp.exponent.modules.api.components.gesturehandler.react.RNGestureHandlerPackage;
import abi42_0_0.host.exp.exponent.modules.api.components.lottie.LottiePackage;
import abi42_0_0.host.exp.exponent.modules.api.components.maps.MapsPackage;
import abi42_0_0.host.exp.exponent.modules.api.components.svg.SvgPackage;
import abi42_0_0.host.exp.exponent.modules.api.components.viewpager.RNCViewPagerPackage;
import abi42_0_0.host.exp.exponent.modules.api.components.webview.RNCWebViewModule;
import abi42_0_0.host.exp.exponent.modules.api.components.webview.RNCWebViewPackage;
import abi42_0_0.host.exp.exponent.modules.api.components.sharedelement.RNSharedElementModule;
import abi42_0_0.host.exp.exponent.modules.api.components.sharedelement.RNSharedElementPackage;
import abi42_0_0.host.exp.exponent.modules.api.components.reactnativestripesdk.StripeSdkPackage;
import abi42_0_0.host.exp.exponent.modules.api.netinfo.NetInfoModule;
import abi42_0_0.host.exp.exponent.modules.api.notifications.NotificationsModule;
import abi42_0_0.host.exp.exponent.modules.api.safeareacontext.SafeAreaContextPackage;
import abi42_0_0.host.exp.exponent.modules.api.screens.RNScreensPackage;
import abi42_0_0.host.exp.exponent.modules.api.viewshot.RNViewShotModule;
import abi42_0_0.host.exp.exponent.modules.test.ExponentTestNativeModule;
import abi42_0_0.host.exp.exponent.modules.universal.ExpoModuleRegistryAdapter;
import abi42_0_0.host.exp.exponent.modules.universal.ScopedModuleRegistryAdapter;
// This is an Expo module but not a unimodule
import abi42_0_0.expo.modules.random.RandomModule;
...
public class ExponentPackage implements ReactPackage {
  ...
  private ExponentPackage(boolean isKernel, Map<String, Object> experienceProperties, Manifest manifest, List<Package> expoPackages, List<SingletonModule> singletonModules) {
    mIsKernel = isKernel;
  ...
  public ExponentPackage(Map<String, Object> experienceProperties, Manifest manifest, List<Package> expoPackages, ExponentPackageDelegate delegate, List<SingletonModule> singletonModules) {
    mIsKernel = false;
    mExperienceProperties = experienceProperties;
    mManifest = manifest;
  ...
  public static ExponentPackage kernelExponentPackage(Context context, Manifest manifest, List<Package> expoPackages, @Nullable String initialURL) {
  ...
  public static List<SingletonModule> getOrCreateSingletonModules(Context context, Manifest manifest, List<Package> providedExpoPackages) {
