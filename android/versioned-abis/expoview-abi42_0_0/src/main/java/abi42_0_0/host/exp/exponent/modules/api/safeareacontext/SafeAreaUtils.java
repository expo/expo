package abi42_0_0.host.exp.exponent.modules.api.safeareacontext;
...
/* package */ class SafeAreaUtils {
  ...
  static @Nullable abi42_0_0.host.exp.exponent.modules.api.safeareacontext.Rect getFrame(ViewGroup rootView, View view) {
    ...
    return new abi42_0_0.host.exp.exponent.modules.api.safeareacontext.Rect(offset.left, offset.top, view.getWidth(), view.getHeight());
  }
}
