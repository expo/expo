...
import abi42_0_0.expo.modules.barcodescanner.utils.FrameFactory;
...
public class GMVBarCodeScanner extends ExpoBarCodeScanner {
  ...
  private List<BarCodeScannerResult> scan(abi42_0_0.expo.modules.barcodescanner.utils.Frame frame) {
    try {
