...
import abi42_0_0.expo.modules.notifications.service.interfaces.FirebaseMessagingDelegate
...
open class ExpoFirebaseMessagingService : FirebaseMessagingService() {
  protected open val firebaseMessagingDelegate: FirebaseMessagingDelegate by lazy {
    abi42_0_0.expo.modules.notifications.service.delegates.FirebaseMessagingDelegate(this)
  }
