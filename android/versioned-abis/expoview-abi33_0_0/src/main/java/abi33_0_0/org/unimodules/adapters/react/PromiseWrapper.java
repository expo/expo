...
/**
 * Decorator for {@link abi33_0_0.com.facebook.react.bridge.Promise},
 * so we don't have to implement these inline in {@link NativeModulesProxy}.
 */
/* package */ class PromiseWrapper extends Promise {
  private abi33_0_0.com.facebook.react.bridge.Promise mPromise;

  /* package */ PromiseWrapper(abi33_0_0.com.facebook.react.bridge.Promise promise) {
    super();
    mPromise = promise;
  }
