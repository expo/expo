/* @tsapeta:
  `PrintDocumentAdapter.WriteResultCallback` cannot be accessed outside `android.print` package,
...
public abstract class PrintDocumentAdapterWriteCallback extends PrintDocumentAdapter.WriteResultCallback {
