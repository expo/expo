...
import abi33_0_0.org.unimodules.adapters.react.ModuleRegistryAdapter;
import abi33_0_0.org.unimodules.adapters.react.ModuleRegistryReadyNotifier;
import abi33_0_0.org.unimodules.adapters.react.NativeModulesProxy;
import abi33_0_0.org.unimodules.adapters.react.ReactAdapterPackage;
...
import abi33_0_0.host.exp.exponent.modules.universal.av.SharedCookiesDataSourceFactoryProvider;
import abi33_0_0.host.exp.exponent.modules.universal.sensors.ScopedAccelerometerService;
import abi33_0_0.host.exp.exponent.modules.universal.sensors.ScopedGravitySensorService;
import abi33_0_0.host.exp.exponent.modules.universal.sensors.ScopedGyroscopeService;
import abi33_0_0.host.exp.exponent.modules.universal.sensors.ScopedLinearAccelerationSensorService;
import abi33_0_0.host.exp.exponent.modules.universal.sensors.ScopedMagnetometerService;
import abi33_0_0.host.exp.exponent.modules.universal.sensors.ScopedMagnetometerUncalibratedService;
import abi33_0_0.host.exp.exponent.modules.universal.sensors.ScopedRotationVectorSensorService;
...
public class ExpoModuleRegistryAdapter extends ModuleRegistryAdapter implements ScopedModuleRegistryAdapter {
  ...
  protected List<NativeModule> getNativeModulesFromModuleRegistry(ReactApplicationContext reactApplicationContext, ModuleRegistry moduleRegistry) {
    ...
    // Add listener that will notify abi33_0_0.org.unimodules.core.ModuleRegistry when all modules are ready
