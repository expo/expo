...
import abi34_0_0.org.unimodules.adapters.react.ModuleRegistryAdapter;
import abi34_0_0.org.unimodules.adapters.react.ModuleRegistryReadyNotifier;
import abi34_0_0.org.unimodules.adapters.react.NativeModulesProxy;
...
import abi34_0_0.host.exp.exponent.modules.universal.av.SharedCookiesDataSourceFactoryProvider;
import abi34_0_0.host.exp.exponent.modules.universal.sensors.ScopedAccelerometerService;
import abi34_0_0.host.exp.exponent.modules.universal.sensors.ScopedGravitySensorService;
import abi34_0_0.host.exp.exponent.modules.universal.sensors.ScopedGyroscopeService;
import abi34_0_0.host.exp.exponent.modules.universal.sensors.ScopedLinearAccelerationSensorService;
import abi34_0_0.host.exp.exponent.modules.universal.sensors.ScopedMagnetometerService;
import abi34_0_0.host.exp.exponent.modules.universal.sensors.ScopedMagnetometerUncalibratedService;
import abi34_0_0.host.exp.exponent.modules.universal.sensors.ScopedRotationVectorSensorService;
...
public class ExpoModuleRegistryAdapter extends ModuleRegistryAdapter implements ScopedModuleRegistryAdapter {
  ...
  protected List<NativeModule> getNativeModulesFromModuleRegistry(ReactApplicationContext reactApplicationContext, ModuleRegistry moduleRegistry) {
    ...
    // Add listener that will notify abi34_0_0.org.unimodules.core.ModuleRegistry when all modules are ready
