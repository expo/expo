...
import abi47_0_0.expo.modules.imagepicker.copyExifData
import abi47_0_0.expo.modules.imagepicker.createOutputFile
import abi47_0_0.expo.modules.imagepicker.toBitmapCompressFormat
import abi47_0_0.expo.modules.imagepicker.toImageFileExtension
...
internal class CropImageContract(
  ...
  override fun createIntent(context: Context, input: CropImageContractOptions) = Intent(context, CropImageActivity::class.java).apply {
    val mediaType = abi47_0_0.expo.modules.imagepicker.getType(context.contentResolver, input.sourceUri)
