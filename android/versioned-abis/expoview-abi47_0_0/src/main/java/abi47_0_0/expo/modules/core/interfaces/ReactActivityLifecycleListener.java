...
public interface ReactActivityLifecycleListener {
  ...
  /**
   * Called when {@link abi47_0_0.com.facebook.react.ReactActivity} received `onNewIntent`
  ...
  /**
   * Called when {@link abi47_0_0.com.facebook.react.ReactActivity} received `onBackPressed`
   * Every listener will receive this callback.
