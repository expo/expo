...
/* package */ class SafeAreaUtils {
  ...
  static @Nullable abi43_0_0.host.exp.exponent.modules.api.safeareacontext.Rect getFrame(ViewGroup rootView, View view) {
    ...
    return new abi43_0_0.host.exp.exponent.modules.api.safeareacontext.Rect(offset.left, offset.top, view.getWidth(), view.getHeight());
  }
}
