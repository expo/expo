package abi45_0_0.expo.modules.adapters.react.services;
...
import abi45_0_0.expo.modules.core.interfaces.ActivityEventListener;
...
import abi45_0_0.expo.modules.core.interfaces.JavaScriptContextProvider;
import abi45_0_0.expo.modules.core.interfaces.LifecycleEventListener;
...
public class UIManagerModuleWrapper implements
  ...
  private Map<LifecycleEventListener, abi45_0_0.com.facebook.react.bridge.LifecycleEventListener> mLifecycleListenersMap = new WeakHashMap<>();
  private Map<ActivityEventListener, abi45_0_0.com.facebook.react.bridge.ActivityEventListener> mActivityEventListenersMap = new WeakHashMap<>();
  ...
  public <T> void addUIBlock(final int tag, final UIBlock<T> block, final Class<T> tClass) {
    getContext().getNativeModule(UIManagerModule.class).addUIBlock(new abi45_0_0.com.facebook.react.uimanager.UIBlock() {
      @Override
  ...
  public void registerLifecycleEventListener(final LifecycleEventListener listener) {
    ...
    mLifecycleListenersMap.put(listener, new abi45_0_0.com.facebook.react.bridge.LifecycleEventListener() {
      @Override
  ...
  public void registerActivityEventListener(final ActivityEventListener activityEventListener) {
    ...
    mActivityEventListenersMap.put(activityEventListener, new abi45_0_0.com.facebook.react.bridge.ActivityEventListener() {
      @Override
