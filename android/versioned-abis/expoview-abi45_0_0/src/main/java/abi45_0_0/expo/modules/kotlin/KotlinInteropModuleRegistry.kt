...
import abi45_0_0.expo.modules.kotlin.views.GroupViewManagerWrapper
import abi45_0_0.expo.modules.kotlin.views.SimpleViewManagerWrapper
import abi45_0_0.expo.modules.kotlin.views.ViewManagerWrapperDelegate
...
class KotlinInteropModuleRegistry(
  ...
  legacyModuleRegistry: abi45_0_0.expo.modules.core.ModuleRegistry,
    ...
    return registry
      ...
      .map {
        ...
        when (it.definition.viewManagerDefinition!!.getViewManagerType()) {
          abi45_0_0.expo.modules.core.ViewManager.ViewManagerType.SIMPLE -> SimpleViewManagerWrapper(wrapperDelegate)
          abi45_0_0.expo.modules.core.ViewManager.ViewManagerType.GROUP -> GroupViewManagerWrapper(wrapperDelegate)
        }
      }
  }
