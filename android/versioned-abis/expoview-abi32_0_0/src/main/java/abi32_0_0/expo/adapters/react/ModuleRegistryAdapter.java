...
import abi32_0_0.expo.adapters.react.views.SimpleViewManagerAdapter;
import abi32_0_0.expo.adapters.react.views.ViewGroupManagerAdapter;
...
public class ModuleRegistryAdapter implements ReactPackage {
  ...
  public List<ViewManager> createViewManagers(ReactApplicationContext reactContext) {
    ...
    for (abi32_0_0.expo.core.ViewManager viewManager : mModuleRegistryProvider.getViewManagers(reactContext)) {
