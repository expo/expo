...
public class EventEmitterModule implements EventEmitter, InternalModule {
  ...
  private static abi32_0_0.com.facebook.react.uimanager.events.Event getReactEventFromEvent(final int viewId, final Event event) {
    return new abi32_0_0.com.facebook.react.uimanager.events.Event(viewId) {
      @Override
