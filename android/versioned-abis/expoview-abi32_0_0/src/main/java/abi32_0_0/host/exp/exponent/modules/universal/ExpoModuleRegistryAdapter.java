package abi32_0_0.host.exp.exponent.modules.universal;
...
import abi32_0_0.expo.adapters.react.ModuleRegistryAdapter;
import abi32_0_0.expo.adapters.react.ModuleRegistryReadyNotifier;
import abi32_0_0.expo.adapters.react.NativeModulesProxy;
import abi32_0_0.expo.adapters.react.ReactAdapterPackage;
...
import abi32_0_0.host.exp.exponent.modules.universal.sensors.ScopedAccelerometerService;
import abi32_0_0.host.exp.exponent.modules.universal.sensors.ScopedGravitySensorService;
import abi32_0_0.host.exp.exponent.modules.universal.sensors.ScopedGyroscopeService;
import abi32_0_0.host.exp.exponent.modules.universal.sensors.ScopedLinearAccelerationSensorService;
import abi32_0_0.host.exp.exponent.modules.universal.sensors.ScopedMagnetometerService;
import abi32_0_0.host.exp.exponent.modules.universal.sensors.ScopedMagnetometerUncalibratedService;
import abi32_0_0.host.exp.exponent.modules.universal.sensors.ScopedRotationVectorSensorService;
...
public class ExpoModuleRegistryAdapter extends ModuleRegistryAdapter implements ScopedModuleRegistryAdapter {
  ...
  protected List<NativeModule> getNativeModulesFromModuleRegistry(ReactApplicationContext reactApplicationContext, ModuleRegistry moduleRegistry) {
    ...
    // Add listener that will notify abi32_0_0.expo.core.ModuleRegistry when all modules are ready
