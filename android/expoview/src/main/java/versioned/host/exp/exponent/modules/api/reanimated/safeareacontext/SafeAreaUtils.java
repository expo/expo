...
/* package */ class SafeAreaUtils {
    ...
    static @Nullable
    versioned.host.exp.exponent.modules.api.reanimated.safeareacontext.Rect getFrame(ViewGroup rootView, View view) {
        ...
        return new versioned.host.exp.exponent.modules.api.reanimated.safeareacontext.Rect(offset.left, offset.top, view.getWidth(), view.getHeight());
    }
}