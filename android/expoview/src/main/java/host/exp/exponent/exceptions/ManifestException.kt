          ...
          try {
            ...
            when (errorCode) {
              ...
              "EXPERIENCE_SDK_VERSION_OUTDATED" -> {
                ...
                formattedMessage =
                  "This project uses SDK " + sdkVersionRequired + " , but this version of Expo Go only supports the following SDKs: " + Constants.SDK_VERSIONS_LIST.joinToString() + ". The author needs to update their project to a newer Expo SDK version."
              }
