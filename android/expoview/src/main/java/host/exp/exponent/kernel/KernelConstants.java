...
public class KernelConstants {
  ...
  public static final String NOTIFICATION_CATEGORY_ID_KEY = "notificationCategoryId";
  public static final String NOTIFICATION_EXPERIENCE_ID_KEY = "notificationExperienceId";
