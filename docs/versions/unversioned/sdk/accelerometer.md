...
Access the device accelerometer sensor(s) to respond to changes in rotation in 3d space. Data is measured in _`m/s^2`_.
...
For detecting the speed/rate your device is moving in, see the `Gyroscope` module.

> As of v33 values have been inverted on iOS to match Android.
