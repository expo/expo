...
To load and use fonts we will use the [Expo SDK](/versions/v8.0.0/sdk/index#expo-sdk), which comes pre-installed when you create a new Expo project, but if for some reason you don't have it, you can install with `npm install --save exponent` in your project directory. Add the following `import` in your application code:
