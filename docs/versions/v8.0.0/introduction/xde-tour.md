...
The device button lets you quickly open your app on a device or simulator. Read more in [Up and Running](/versions/v8.0.0/guides/up-and-running#up-and-running).![XDE open on device](./xde-device.png)
