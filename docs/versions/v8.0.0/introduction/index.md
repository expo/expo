...
-   [XDE Tour](/versions/v8.0.0/introduction/xde-tour)
    ...
    -   [Home screen](/versions/v8.0.0/introduction/xde-tour#home-screen)
    -   [Project dialog](/versions/v8.0.0/introduction/xde-tour#project-dialog)
    -   [Sign out, if you want](/versions/v8.0.0/introduction/xde-tour#sign-out-if-you-want)
    -   [Project screen](/versions/v8.0.0/introduction/xde-tour#project-screen)
    -   [Send link](/versions/v8.0.0/introduction/xde-tour#send-link)
    -   [Opening on a device](/versions/v8.0.0/introduction/xde-tour#opening-on-a-device)
    -   [Development mode](/versions/v8.0.0/introduction/xde-tour#development-mode)
...
-   [Community](/versions/v8.0.0/introduction/community)
