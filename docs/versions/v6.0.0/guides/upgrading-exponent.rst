...
* **Find out what the latest version of Exponent is:**
  ...
  `See a list of versions <https://getexponent.com/--/sdk-versions>`_ and pick the one with the biggest number. You will use the ``exponent-react-native-tag`` in the next step.
