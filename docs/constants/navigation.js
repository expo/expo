...
export const general = [
  ...
  makeSection('Expo Router', [
    ...
    makeGroup('Advanced', [
      ...
      makePage('router/advanced/animations.mdx'),
    ]),
    makeGroup('Web', [
    ...
    makeGroup('Reference', [
      ...
      makePage('router/reference/meta-tags.mdx'),
      makePage('router/reference/navigation-events.mdx'),
      makePage('router/reference/navigation-state.mdx'),
      makePage('router/reference/themes.mdx'),
      makePage('router/reference/prefetching.mdx'),
