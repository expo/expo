...
export const sdkVersionHardcodedTypeLinks: Record<string, Record<string, string | null>> = {
  ...
  'v99.0.0': {
    BufferOptions: '/versions/v99.0.0/sdk/video/#bufferoptions-1',
    ButtonColors: '/versions/v99.0.0/sdk/ui/jetpack-compose/button/#buttoncolors',
    CameraPosition: '/versions/v99.0.0/sdk/maps/#cameraposition-2',
    CheckboxColors: '/versions/v99.0.0/sdk/ui/jetpack-compose/checkbox/#checkboxcolors',
    CornerRadii: '/versions/v99.0.0/sdk/ui/jetpack-compose/shape/#cornerradii',
    EventEmitter: '/versions/v99.0.0/sdk/expo/#eventemittertype',
    ExpoModifier: '/versions/v99.0.0/sdk/ui/jetpack-compose/modifiers/#expomodifier',
    Href: '/versions/v99.0.0/sdk/router/#hreft',
    HrefObject: '/versions/v99.0.0/sdk/router/#hrefobject',
    NativeModule: '/versions/v99.0.0/sdk/expo/#nativemoduletype',
    NativeTabsTriggerBadgeProps:
      '/versions/v99.0.0/sdk/router/native-tabs/#nativetabstriggerbadgeprops',
    NativeTabsTriggerIconProps:
      '/versions/v99.0.0/sdk/router/native-tabs/#nativetabstriggericonprops',
    NativeTabsTriggerLabelProps:
      '/versions/v99.0.0/sdk/router/native-tabs/#nativetabstriggerlabelprops',
    ScrubbingModeOptions: '/versions/v99.0.0/sdk/video/#scrubbingmodeoptions-1',
    SeekTolerance: '/versions/v99.0.0/sdk/video/#scrubbingmodeoptions-1',
    ShapeJSXElement: '/versions/v99.0.0/sdk/ui/jetpack-compose/shape/#shapejsxelement',
    SharedObject: '/versions/v99.0.0/sdk/expo/#sharedobjecttype',
    SharedRef: '/versions/v99.0.0/sdk/expo/#sharedreftype',
    SharedRefType: '/versions/v99.0.0/sdk/expo/#sharedreftype',
    SingularOptions: '/versions/v99.0.0/sdk/router/#singularoptions',
    StackToolbarBadgeProps: '/versions/v99.0.0/sdk/router/stack/#stacktoolbarbadgeprops',
    StackToolbarIconProps: '/versions/v99.0.0/sdk/router/stack/#stacktoolbariconprops',
    StackToolbarLabelProps: '/versions/v99.0.0/sdk/router/stack/#stacktoolbarlabelprops',
    SwitchColors: '/versions/v99.0.0/sdk/ui/jetpack-compose/switch/#switchcolors',
    TabsProps: '/versions/v99.0.0/sdk/router/ui/#tabsprops',
    TabTriggerProps: '/versions/v99.0.0/sdk/router/ui/#tabtriggerprops',
    VectorIconProps: '/versions/v99.0.0/sdk/router/#vectoriconprops',
  },
  latest: {
