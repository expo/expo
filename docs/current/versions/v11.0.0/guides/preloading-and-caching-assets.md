...
In order to keep the loading screen visible while we cache our assets, we render [Exponent.Components.AppLoading](/versions/v11.0.0/sdk/app-loading#app-loading) and only that component until everything is ready.
