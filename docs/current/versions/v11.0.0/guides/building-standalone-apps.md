...
old_permalink: /versions/v11.0.0/guides/building-standalone-apps.html
...
There are other options you might want to add to `exp.json`. We have only covered what is required. See [Configuration with exp.json](https://docs.getexponent.com/versions/v11.0.0/configuration.html#exp) for the full spec.
