...
First, make sure you import your custom icon font. [Read more about loading custom fonts](https://docs.getexponent.com/versions/v11.0.0/using-custom-fonts.html#using-custom-fonts). Once your font has loaded, you'll need to create an Icon Set. `@exponent/vector-icons` exposes three methods to help you create an icon set.
