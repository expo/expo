...
At this point we should have XDE installed on our development machine and the Exponent client on an iOS or Android physical device or emulator. If not, go back to the [Installation](/versions/v12.0.0/introduction/installation) guide before proceeding.
...
-   Read about the [Exponent SDK](/versions/v12.0.0/sdk/index#exponent-sdk) to learn about some useful APIs we provide out of the box.
