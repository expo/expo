...
-   **iOS standalone app**
    ...
    -   In your [exp.json](/versions/v12.0.0/guides/configuration#exp), add a field `facebookScheme` with your Facebook login redirect URL scheme found [here](https://developers.facebook.com/docs/facebook-login/ios) under _4. Configure Your info.plist_. It should look like `"fb123456"`.

-   **Android standalone app**

    -   [Build your standalone app](/versions/v12.0.0/guides/building-standalone-apps#building-standalone-apps) for Android.
