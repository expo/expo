...
So we've opened up a new project. The left pane is the React Packager, which you can learn more about in [Up and Running](/versions/v14.0.0/guides/up-and-running#up-and-running) and in [How Exponent Works](/versions/v14.0.0/guides/how-exponent-works#how-exponent-works). The right pane is for device logs, which you can read more about in [Viewing Logs](/versions/v14.0.0/guides/logging#logging).![XDE project](./xde-project-opened.png)
...
The device button lets you quickly open your app on a device or simulator. Read more in [Up and Running](/versions/v14.0.0/guides/up-and-running#up-and-running).![XDE open on device](./xde-device.png)
...
When you hit publish you'll be asked to confirm that you want your project to be available to the public. Hitting yes will upload all of your assets and your apps JavaScript to our servers so that users can access it at any time from `exp.host/@your-username/your-app-slug`. More on what slug means in [Configuration with exp.json](/versions/v14.0.0/guides/configuration#exp), and more details about how publishing work in [How Exponent Works](/versions/v14.0.0/guides/how-exponent-works#how-exponent-works).![XDE publish](./xde-publish.png)
