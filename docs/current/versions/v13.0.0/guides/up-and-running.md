...
-   First, make sure you have [development mode enabled in XDE](/versions/v13.0.0/development-mode/#development-mode).
...
-   Read some of our other guides, such as how to implement [Push Notifications](/versions/v13.0.0/push-notifications/#push-notifications), how we can take care of [Assets](/versions/v13.0.0/preloading-and-caching-assets/#all-about-assets) for you, or how to build [Standalone Apps](/versions/v13.0.0/building-standalone-apps/#building-standalone-apps) you can submit to Apple or Google.
