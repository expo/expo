...
To use this script, you have to install [SourceKitten](https://github.com/jpsim/SourceKitten) framework.

Navigate to the module directory (where your module's `expo-module.config.json` is located) and run the `generate-ts-mocks` command.
