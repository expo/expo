...
// File hash: 9acc33f89b5299c28de25b8164648cb0a3b3f0e888845427da60b61151ff6efa
// Automatically generated with expo-type-information.
...
Looking at the "generated" file, we can see that an `ExpoWebViewProps` interface has been generated with the props and events from `FirstInlineView`. The Swift `URL` type of the `url` prop correctly maps to `string` in TypeScript.

The tool handles types it cannot resolve differently. For a type that is neither a convertible type nor defined in the provided files, it generates an `export type SomeType = unknown;` alias. It does the same when it fails to parse a definition.

```tsx app/FirstInlineView.tsx
// File hash: 7c626aee408cce9e26967afedaf3907b911e12e321b784c5ee642c72f9d50ea6
// Automatically generated with expo-type-information.
import React from 'react';

import { FirstInlineViewNativeModuleType, ExpoWebViewProps } from './FirstInlineView.generated';
...
```tsx app/FirstInlineModule.tsx
// File hash: c295ba199fe678ce847793cef050a8c663bee7054b3475a91dd47e433f19686f
// Automatically generated with expo-type-information.
import { FirstInlineModuleNativeModuleType } from './FirstInlineModule.generated';
...
<Terminal
  cmd={{
    npm: ['$ npx expo-type-information module-interface --module-path ./expo-settings'],
    yarn: ['$ yarn dlx expo-type-information module-interface --module-path ./expo-settings'],
    pnpm: ['$ pnpm dlx expo-type-information module-interface --module-path ./expo-settings'],
    bun: ['$ bunx expo-type-information module-interface --module-path ./expo-settings'],
  }}
/>
...
<Terminal
  cmd={{
    npm: ['$ npx expo-type-information module-interface --module-path ./expo-settings -w'],
    yarn: ['$ yarn dlx expo-type-information module-interface --module-path ./expo-settings -w'],
    pnpm: ['$ pnpm dlx expo-type-information module-interface --module-path ./expo-settings -w'],
    bun: ['$ bunx expo-type-information module-interface --module-path ./expo-settings -w'],
  }}
/>

The `--module-path` option (short `-m`) is a path to the root folder of the module. After running this command you should see 3 new generated files in the module package.
...
// File hash: 095ea2ca2196362ac7b298141867d5700ff170c7b554faa87788a1247e02b2b8
// Automatically generated with expo-type-information.
export enum Theme {
  light = 'light',
  dark = 'dark',
...
export type ExpoSettingsEvents = {
  onChangeTheme: (payload: Record<string, any>) => void;
};
```

The `*.types.ts` file contains the definitions of all types defined in the module. In our case we declared a `Theme` enum, and the tool emitted it here along with an `ExpoSettingsEvents` type for the module's events. Note that the tool doesn't resolve event payload types, so the payload is typed as a generic object.

```tsx expo-settings/src/ExpoSettingsModule.ts
// File hash: e30ca48525429f211d7d3a6cb86d8caa39610ae3774be2e321fdce98895caf9e
// Automatically generated with expo-type-information.
import type { ExpoSettingsEvents, Theme } from './ExpoSettings.types';
import { NativeModule, requireNativeModule } from 'expo';
export declare class ExpoSettings extends NativeModule<ExpoSettingsEvents> {
...
The `*Module.ts` file contains the declaration of the native module class and it exports the module instance. The module class extends `NativeModule<ExpoSettingsEvents>`, which declares the events emitted by the module. You can listen to these events with `addListener` or the [`useEvent`](/versions/latest/sdk/expo/#useeventeventemitter-eventname-initialvalue) hook.

```tsx expo-settings/src/index.ts
// File hash: 979f161df9a05f9983fab7e04526901ffff01ef3f57051b2fe7c344e53afd541
// Automatically generated with expo-type-information.
