...
<Terminal
  cmd={{
    npm: ['$ npx create-expo-module expo-web-view'],
    yarn: ['$ yarn create expo-module expo-web-view'],
    pnpm: ['$ pnpm create expo-module expo-web-view'],
    bun: ['$ bun create expo-module expo-web-view'],
  }}
/>
...
<ContentSpotlight
  ...
  src="/static/images/modules/native-view-tutorial/web-browser.webp"
