...
No changes are required. You can rebuild and run the app using the following commands:
...
After that, you should be able to see the [Expo Modules API overview page](/modules/). If the changes are not reflected, try reinstalling the app.
...
After that, you should be able to see the [Expo homepage](/https://expo.dev) in the WebView.
