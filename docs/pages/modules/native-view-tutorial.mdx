...
In this tutorial, you will build an example module with a native view that renders a WebView. For Android, you will use the [`WebView`](https://developer.android.com/reference/android/webkit/WebView) component, and for iOS, [`WKWebView`](https://developer.apple.com/documentation/webkit/wkwebview). Web support can be implemented using an [`iframe`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/iframe), but is left as an exercise for you.

<Step label="1">

## Initialize a new module

Start by creating a new module. In this example, the module is named `expo-web-view`.
...
After that, you will see the [Expo Modules API overview page](/modules/overview) rendered. If the changes aren't reflected, try reinstalling the app.
