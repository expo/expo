...
First, you need to have created an Expo module or integrated the Expo modules API in the library using the React Native module API. See [what is the Expo Modules API](/modules/overview/#what-is-the-expo-modules-api).
