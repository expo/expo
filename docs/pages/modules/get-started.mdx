...
> **Note:**
> Native Modules will not run on Expo Go; For prototyping, you must set up your own [Development Build](https://docs.expo.dev/develop/development-builds/introduction/)
