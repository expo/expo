...
> **Warning:**
> If you override the `paths` property in `tsconfig.json` or are using expo version below `48.0.11`, you need to include the following wildcard in [the paths config](https://www.typescriptlang.org/tsconfig#paths).
>
> ```
> "paths": {
>   "*": ["./modules/*"]
