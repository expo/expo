...
If you have an **ios** directory in your project that you created using `expo prebuild`, you must reinstall the pods:
...
Now, import the module in your application:
