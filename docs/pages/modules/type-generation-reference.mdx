...
<Terminal
  cmd={{
    npm: ['$ npx expo install expo-type-information'],
    yarn: ['$ yarn expo install expo-type-information'],
    pnpm: ['$ pnpm expo install expo-type-information'],
    bun: ['$ bun expo install expo-type-information'],
  }}
/>
