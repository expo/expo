...
<Terminal
  cmd={{
    npm: ['$ npx create-expo-app@latest my-app', '$ cd my-app', '$ npx expo install expo-settings'],
    yarn: ['$ yarn create expo-app my-app', '$ cd my-app', '$ yarn expo install expo-settings'],
    pnpm: ['$ pnpm create expo-app my-app', '$ cd my-app', '$ pnpm expo install expo-settings'],
    bun: ['$ bun create expo my-app', '$ cd my-app', '$ bun expo install expo-settings'],
  }}
/>
