...
sidebar_title: Use a standalone Expo module in your project
description: Learn how to use a standalone module created with create-expo-module in your project.
---

import { Terminal } from '~/ui/components/Snippet';

The recommended way to create an Expo module inside an existing application is to run `create-expo-module --local` as described by the [**Getting started**](./get-started) guide.

There are two additional ways to use a module created with `create-expo-module` inside an existing project: configuring a monorepo or publishing the module to npm.

They are useful if you still want to keep the module separate from the application or share it with other developers.

This guide walkthroughs both methods.
