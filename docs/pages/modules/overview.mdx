...
If you encounter any performance bottlenecks with the Expo Modules API, please [file an issue](https://github.com/expo/expo/issues/new/choose) and we'd be happy to discuss it with you.
