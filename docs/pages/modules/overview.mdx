...
<Collapsible summary="Does the Expo Modules API support platforms other than Android, iOS, and web?">
...
<BoxLink
  ...
  description="A reference on creating native modules using Kotlin and Swift."
  href="/modules/module-api/"
  Icon={CpuChip01Icon}
/>
