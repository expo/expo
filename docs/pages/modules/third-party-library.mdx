...
### Start with a new module project
...
### Start with an existing Expo project
...
In step 1, if you started with a new module project, open a terminal window, start the TypeScript compiler to watch for changes, and rebuild the module JavaScript:
...
In step 1, if you started with an existing Expo project, run the `npx expo run:android|ios` commands from your Expo project's root directory.
