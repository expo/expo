...
description: Share previews of your changes with your team by publishing updates on branches.
---
...
This command will publish an update under the current branch.

## Share with your team

Once the preview is published, you'll see output like this:
...
Share the "EAS dashboard" link with a reviewer. Once there, they can click on the "Preview" button. They will see a QR code that they can scan to open the preview on their device.
