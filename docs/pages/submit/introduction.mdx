...
"Submit" is not the same as releasing your app directly to production. Instead, it delivers your app to the stores distribution pipelines (TestFlight for iOS, or a chosen track on Google Play), following the [default submission behavior for app stores](/build/automate-submissions/#default-submission-behavior-for-app-stores).
