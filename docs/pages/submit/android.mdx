...
You need a production **.aab** to submit. Create one with [EAS Build](/build/introduction/):
...
You can run `eas submit` from any CI/CD service — GitHub Actions, GitLab CI, and others:
