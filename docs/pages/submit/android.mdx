...
Learn about all the options you can provide in the [eas.json reference](/eas/json/#android-specific-options-1).
...
Once you have completed all the prerequisites, you can set up a CI/CD pipeline to submit your app to the Google Play Store. You can use [EAS Workflows](/eas-workflows/get-started/) to build and submit your app automatically.

1. Create a workflow file named **.eas/workflows/submit-android.yml** at the root of your project.
2. Inside **submit-android.yml**, you can use the following workflow to kick off a job that submits an iOS app:
   ...
   jobs:
     ...
     submit_android:
       ...
       params:
         platform: android
         build_id: ${{ jobs.needs.build_android.outputs.id }}
     # @end #
   ```
