...
If you have run `eas build -p [all|ios|android]` successfully before, then you can continue. If you
haven't done this yet, refer to the [Create your first build](setup.mdx) and return here when ready.
...
- Double-check that everything in the [Prerequisites](#prerequisites) section is true when trying to build.
