...
> **Note:** You must be an admin of the Expo account to install the app.
...
> **Note:** You can only link GitHub organization repositoriess to Expo organizations.
...
If you want to add a repository from a different GitHub account, click the "Add new account" option
in the account selector dropdown.
