...
EAS Build هي خدمة سريعة التطور. قبل أن تشرع في إنشاء بنية لمشروعك، نوصي بالتشاور مع صفحة [الحدود] (/البناء المرجعي / القيود) والشروط الأساسية الأخرى أدناه.

<ملخص قابل للطي="مشروع React Native Android و/أو iOS الذي تريد بناءه">
