...
This document covers concerns specific to using the `expo-updates` library with EAS Build. For more general information about configuring the library with EAS Update, see [Getting started with EAS Update](/eas-update/getting-started/).
