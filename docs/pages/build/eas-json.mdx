  ...
  "build": {
    /* @info Any arbitrary name - used as an identifier */"BUILD_PROFILE_NAME_1"/* @end */: {
      ...
      "ios": {
        ...
        "groups": [
          /* @info Optional. Array of TestFlight internal group names to add the build to. The build will be automatically added to internal testers' groups that have the App Store Connect setting to receive new builds automatically enabled. Only internal group names are supported right now; external groups are not supported. */
          "QA Team",
          "Product Managers"
        ]
      }
