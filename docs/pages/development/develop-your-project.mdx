...
Certain types of errors can provide more helpful error messages than the ones that ship by default with React Native. To turn this feature on, you need to import `expo-dev-client` at the top of the **App.&lbrace;js|tsx&rbrace;** file.
...
<BoxLink
  title="Develop your project"
  description="Learn about extending the capabilities of your development build with tools, workflows and extensions."
  href="/development/development-workflows"
/>
