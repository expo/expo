...
If you have an existing project, you'll need to [install the package and make a few changes](installation.mdx) to your **AppDelegate.m**, **MainActivity.java** and **MainApplication.java**.
...
<InstallSection
  ...
  cmd={['npm install expo-dev-client']}
