...
After the build is complete, download and install it on the Android Emulator by running the command:

<Terminal cmd={['$ eas build:run -p android']} />

See [Build APKs for Android Emulators and devices](/build-reference/apk/#installing-your-build) to learn more about `eas build:run` command.
...
After the build is complete, download and install it on the iOS Simulator by running the command:

<Terminal cmd={['$ eas build:run -p ios']} />

See [Installing build on the simulator](/build-reference/simulators/#installing-your-build-on-the-simulator) to learn more about `eas build:run` command.
