...
> **info** iOS builds with a `developmentClient` should always be distributed as "internal". If you are distributing for TestFlight, you have to set the `distribution` to "store".
...
<Terminal
  ...
  cmdCopy="eas build --profile development --platform android"
/>
