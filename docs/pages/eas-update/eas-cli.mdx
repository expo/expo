...
- Because no app downloads an update, those installs do not count toward your [monthly active users](/eas-update/introduction/#how-are-monthly-active-users-counted-for) for the billing cycle. This keeps [updated user charges](/billing/usage-based-pricing/) from growing while the channel is paused.
...
> **info** `eas channel:pause` and `eas channel:resume` require EAS CLI 12.6.0 or newer.
