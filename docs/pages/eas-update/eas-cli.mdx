...
### Connect a chanel with a branch 

you can connect any channel with a branch by running 

```
eas channel:edit
```

This command will help you to map the branches with the channels that you have
