...
> **warning** Using the experimental fingerprint runtime policy may result in unexpected system behavior. This policy is still under active development as part of the `expo-fingerprint` beta package, and its specifications may change in the future.
