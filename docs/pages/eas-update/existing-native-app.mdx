...
sidebar_title: Integration in existing native apps
...
<BoxLink
  title="CustomRNView"
  description="A complete working example of integrating EAS Update into an existing native app."
  Icon={GithubIcon}
  href="https://github.com/expo/CustomRNView"
/>
