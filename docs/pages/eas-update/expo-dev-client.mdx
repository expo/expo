...
<Prerequisites>
  <Requirement title="A development build installed">
    [Create a development build and install
    it](/develop/development-builds/introduction/?buildenv=build-with-eas#how-would-you-like-to-build-your-development-build)
    on your device, Android Emulator, or iOS Simulator.
  </Requirement>
  <Requirement
    title={
      <>
