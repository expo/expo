...
<Collapsible summary="An example of how to check for updates in the background (at a minimum interval)">
...
<Collapsible summary="An example of how to check for updates in the background (in response to a notification)">
