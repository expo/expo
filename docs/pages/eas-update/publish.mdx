...
Publishing an update allows fixing bugs and quickly updating non-native parts of a project instead of creating a new build. This guide explains the steps required to publish an update, briefly describes how it works, and offers methods to test it.
...
- Manually test the update by force closing and reopening your development build up to two times to download and view the update
