---
title: Using EAS Update without EAS Build
sidebar_title: Using without EAS Build
description: Learn how to use EAS Update directly with a local build environment, without EAS Build.
---
