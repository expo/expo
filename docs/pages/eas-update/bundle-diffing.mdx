...
> **info** On SDK 57 and below, this mode is [experimental](/more/release-statuses/#experimental) and opt-in. The flag and behavior may change.

To enable, set the `EAS_UPDATE_EXPERIMENTAL_UPLOAD_EMBEDDED_BUNDLE` environment variable to `1` under `env` in a build profile in **eas.json**:
