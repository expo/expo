...
> **info** If you plan to use EAS Update with EAS Build, we recommend following the [EAS Build setup guide](/build/setup/) before proceeding here. That said, [you can use EAS Update without any other EAS services](/eas-update/standalone-service/) if you prefer.
...
<Collapsible summary="A React Native Android and/or iOS project">
...
If you don't have the `expo` package in your project yet, then you'll need to install it and [opt in to using Expo CLI and Metro Config](/bare/installing-expo-modules/#configure-expo-cli-for-bundling-on-android-and-ios). Run the command:
...
The channel property on a build allows us to point updates at specific types of builds. This allows you to publish updates to a preview build without impacting your production deployment, for example.
...
<Collapsible summary="Configuring update channels in app.json">
...
<Collapsible summary="Configuring update channels in an Android native project">
...
<Collapsible summary="Configuring update channels in an iOS native project">
