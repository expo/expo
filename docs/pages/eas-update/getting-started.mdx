...
In this guide, you'll create a new Expo app, run it in our local development environment, publish an update, and show that the app downloads and runs the update when restarted.
...
See [Using EAS Build and Update together](/eas-update/build-and-update).
