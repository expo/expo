...
> **warning** SDK 49 was the last version to support Classic Updates. To continue using the deprecated `expo publish` command, set `updates.useClassicUpdates` in your app config.
