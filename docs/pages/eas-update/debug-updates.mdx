...
- Execute a [debug build](/home/debugging/runtime-issue/#native-debugging) of the app with Xcode or from the command line.
...
- Execute a [debug build](/home/debugging/runtime-issue/#native-debugging) of the app with Android Studio or from the command line.
