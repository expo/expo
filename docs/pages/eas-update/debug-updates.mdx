...
We also provide a [step-by-step guide to try out EAS Update quickly](/pages/eas-update/eas-update-with-local-build) in a local development environment using Android Studio or Xcode, with either release or debug builds of the app.
