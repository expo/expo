...
import { CodeBrowserIcon } from '@expo/styleguide-icons';
import Video from '~/components/plugins/Video';
import { Tabs, Tab } from '~/ui/components/Tabs';
import { Collapsible } from '~/ui/components/Collapsible';

When you create a new project with Expo, learning about some essential tools and websites can help you during your app development journey. This page provides an overview of a list of recommended tools.
...
| `npx expo lint`                 | [Setup and configures](/guides/using-eslint/) ESLint. If ESLint is already configured, this command [lints your project files](/guides/using-eslint/#usage). |
...
EAS CLI is used to log in to your Expo account, and compile your app using different EAS services such as Build, Update, or Submit. You'll use this tool to:
...
You can use `eas --help` in your terminal window to learn more about the available commands. For a complete reference, see []`eas-cli` tool's npm page](https://www.npmjs.com/package/eas-cli).
...
You can also it to debug your app using VS Code's built-in debugger to set breakpoints, inspect variables, execute code through the debug console, and more. See [Debugging with VS Code](/debugging/tools/#debugging-with-vs-code) for how to use this extension for debugging.
...
- Follow instructions described in that guide
...
Any library that is compatible with React Native, works in Expo project when you use a development build to create your project.

[reactnative.directory](https://reactnative.directory/) is a searchable database for React Native libraries. If a library you are looking for is not included in Expo SDK, then use it to find a compatible library for your project.
