...
<ContentSpotlight
  ...
  src="/static/images/system-bars.webp"
  className="max-w-120"
/>
...
To control the `NavigationBar` visibility, you can use the [`hidden`](/versions/latest/sdk/navigation-bar/#hidden) prop or the [`NavigationBar.setHidden`](/versions/latest/sdk/navigation-bar/#sethiddenhidden) method.
