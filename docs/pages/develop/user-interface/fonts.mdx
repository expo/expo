...
On iOS, `path` and `axes` do not apply. List the variable font file in `ios.fonts` as you would a static font. The faces you can select are the [named instances](#variable-fonts) the file declares.
