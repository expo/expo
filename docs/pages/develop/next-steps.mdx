...
<BoxLink
  ...
  description="See native tabs navigator's complete reference for more information on API methods."
  Icon={BookOpen02Icon}
/>
...
<BoxLink
  title="Redirects"
  href="/router/reference/redirects/"
  description="Learn how to redirect URLs with Expo Router."
  Icon={BookOpen02Icon}
/>
