...
> [Expo Router](/router/introduction/) is now available and supports file-based navigation in projects. With Expo Router, the root file (**App.js**) will become **index.js**, and all the screens in the project will be in the **app** folder.
