...
[Jest](https://jestjs.io) is the most widely used JavaScript unit testing framework. In this guide, you'll learn how to set up Jest in your project, write a unit test, write a snapshot test, and best practices for structuring your tests when using Jest with React Native. This guide explains how to use install and configure to use `jest-expo` which is a Jest preset, mocks the native part of the Expo SDK and handles most of the configuration.
