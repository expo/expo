...
If you have not yet configured EAS Update in your project, you can find [additional instructions on how to do so here.](/eas-update/getting-started/)

You can now view and load EAS Update updates in your development build via the `Extensions` panel.
