...
export default function App() {
  ...
  const whatsappNumber = "201278085839"; // رقمك
...
إلى: ${to}`;
    ...
    Alert.alert("تم", "سيتم فتح واتساب لإرسال الطلب");
    console.log(url);
  };
  ...
  if (page === "home") {
    return (
      <View style={styles.container}>
        <Text style={styles.title}>🚀 تطبيق سمسطا توصيل</Text>

        <TouchableOpacity style={styles.btn} onPress={() => setPage("order")}>
          <Text style={styles.btnText}>🛒 طلب توصيل</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.btn} onPress={() => setPage("driver")}>
          <Text style={styles.btnText}>🚖 تسجيل سائق</Text>
        </TouchableOpacity>
      </View>
    );
  }
  ...
  if (page === "order") {
    return (
      <View style={styles.container}>
        ...
        <TextInput placeholder="رقم الهاتف" style={styles.input} onChangeText={setPhone} />
        <TextInput placeholder="من" style={styles.input} onChangeText={setFrom} />
        <TextInput placeholder="إلى" style={styles.input} onChangeText={setTo} />

        <TouchableOpacity style={styles.btn} onPress={sendOrder}>
          <Text style={styles.btnText}>📩 إرسال على واتساب</Text>
        </TouchableOpacity>
  ...
  if (page === "driver") {
    return (
      <View style={styles.container}>
        ...
        <TextInput placeholder="اسم السائق" style={styles.input} />
        <TextInput placeholder="رقم الهاتف" style={styles.input} />

        <TouchableOpacity
          style={styles.btn}
          onPress={() => Alert.alert("تم", "تم تسجيل السائق (نموذج)")}
        >
