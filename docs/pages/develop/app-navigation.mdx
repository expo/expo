...
New Expo projects created with `npx create-expo-app@latest --template default@sdk-56` include Expo Router by default so you can ship cross-platform navigation quickly while still being able to reach for React Navigation APIs when needed.
