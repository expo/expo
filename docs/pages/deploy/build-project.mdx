---
title: Builds your project for app stores
description: Learn how to create a production build of your project that is ready for the app stores.
...
Over-the-air updates allow you to push critical bug fixes and improvements to your users. To set it up, run the following [EAS CLI](/develop/tools/#eas-cli) command:
...
Alternatively, you can make a production build locally by following our [local builds guide](/build-reference/local-builds/).
