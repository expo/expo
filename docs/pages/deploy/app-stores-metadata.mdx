...
The above example file contains JSON schema. Replace the example values with your own. It usually contains fields such as your app's `title`, `subtitle`, `description`, `keywords`, and `marketingUrl`.
