...
EAS Submit uploads your **.aab** to Google Play Console and places it in the track you choose (internal, alpha, beta, or production). Google requires you to upload your app manually at least once before API-based submissions are allowed — after that, `eas submit` handles every subsequent release.
...
<BoxLink
  ...
  description="Google requires every app to be uploaded manually through Play Console once before API submissions are allowed."
