...
If a user does not have your app installed, deep links don't link to anything. Attribution services like [Branch](https://www.branch.io/deep-linking/) offer solutions for condistionally linking to your app or web page.

Universal links is another solution you can use to handle such cases, in which the route to your web page determins when the app is installed or not. For more details, see [Universal Links](/linking/ios-universal-links/).
