...
After adding a custom scheme to your app, you need to [create a new development build](/develop/development-builds/introduction/#how-would-you-like-to-build-your-development-build). Once the app is installed on a device, you can open links within your app using `myapp://`.
