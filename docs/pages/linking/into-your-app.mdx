...
If a user does not have your app installed, deep links to your app will not work. Attribution services like [Branch](https://branch.io/resources/aasa-validator/) offer solutions for conditionally linking to your app or web page.
