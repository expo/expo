...
Linking into your app allows other apps to open a screen directly using a URL registered with your app's custom scheme. Using this URL, other apps can open a specific screen or the home screen of your app if no other screen is specified.
...
> **info** **Tip**: After adding a custom scheme to your app, you need to [create a new development build](/develop/development-builds/create-a-build/).
