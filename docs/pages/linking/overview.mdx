...
Linking allows your app to interact with incoming and outgoing URLs. In this process, a URL opens your app and takes the user to a specific screen (route) within the app.
