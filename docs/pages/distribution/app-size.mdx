...
const VideoCard = ({ video }) => (
  <TouchableOpacity style={styles.card}>
    ...
    <View style={styles.details}>
      ...
      <Text style={styles.channel}>{video.channelName} • {video.views} views</Text>
    </View>
  </TouchableOpacity>
);

// এটি কেবল ডিজাইন দেখার জন্য একটি উদাহরণ
export default function HomeScreen() {
  return (
    <View style={styles.container}>
      <Text style={styles.header}>YouTube Clone</Text>
      {/* এখানে ভিডিওর লিস্ট থাকবে */}
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  header: { fontSize: 20, fontWeight: 'bold', marginLeft: 15, marginBottom: 10 },
  card: { marginBottom: 20 },
  thumbnail: { width: '100%', height: 200 },
  details: { padding: 10 },
  title: { fontSize: 16, fontWeight: 'bold' },
  channel: { color: 'gray', fontSize: 12 }
});
---
