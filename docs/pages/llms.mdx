...
| -------------------------------- | -------------------------------------------------------------------------------------------------------- | ------- |
| [/llms.txt](/llms.txt)           | Index page with a list of all available documentation files.                                             | ~54 kB  |
| [/llms-full.txt](/llms-full.txt) | Complete documentation for Expo, including Expo Router, Expo Modules API, development process, and more. | ~2.4 MB |

### Section-wide bundles

| Endpoint                       | Description                                                 | Size    |
| ------------------------------ | ----------------------------------------------------------- | ------- |
| [/llms-eas.txt](/llms-eas.txt) | Complete documentation for Expo Application Services (EAS). | ~1.2 MB |
| [/llms-sdk.txt](/llms-sdk.txt) | Complete documentation for the latest Expo SDK.             | ~3.5 MB |
