...
Every documentation page has a lightweight markdown version accessible by appending either `/index.md` or `.md` to the page URL. Both forms serve the same file. For example:
