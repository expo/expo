...
The index begins with routing guidance that explains when to use Expo documentation, how to select a page, and how to match SDK reference pages to the version installed in a project.
