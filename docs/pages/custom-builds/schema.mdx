...
| Input               | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|---------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `message`           | **string** The text of the message you want to be sent. Example: `'This is the content of the message'`<br />**Note:** You can reference build job properties and other steps outputs in the message for dynamic evaluation. Examples: `'Build URL: ${ eas.job.expoBuildUrl }'`, `Build finished with status: ${ steps.run_fastlane.status_text }`, `Build failed with error: ${ steps.run_gradle.error_text }`. For more information see [Use output from one step to another](/custom-builds/schema/#use-output-from-one-step-to-another)                                             |
