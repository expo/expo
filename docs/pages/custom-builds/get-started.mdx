---
title: EAS Build custom builds - Get started
...
> **Warning** The current limitations of custom builds are highlighted in the [changelog](https://expo.dev/changelog/2023/08-10-custom-build-jobs) — we'll be working away at these items over the coming months.
