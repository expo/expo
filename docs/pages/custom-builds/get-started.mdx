...
> **Warning** This functionality is in preview, under active development, and likely to change. The current limitations of custom builds are highlighted in the [changelog](https://expo.dev/changelog/2023/08-10-custom-build-jobs) — we'll be working on solving for these items in the coming months.
