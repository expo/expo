...
> See [Testing with Jest](/develop/testing/) for more information about configuring the `jest-expo` package and additional configuration options such as `transformIgnorePatterns`.
