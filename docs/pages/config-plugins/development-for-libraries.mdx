...
You also need to define the main entry point for your config plugin in the **app.plugin.js** (or **app.plugin.cjs**) file, which exports the compiled plugin code from the **plugin/build** directory:

```js app.plugin.js or app.plugin.cjs
