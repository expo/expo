...
> **warning** **[Deprecated](/more/release-statuses/#deprecated)**: In SDK 50 and later, publishing with `webpack` is deprecated in favor of `metro`. Learn more in [migrating from Webpack to Expo Router](/router/migrate/from-expo-webpack).
