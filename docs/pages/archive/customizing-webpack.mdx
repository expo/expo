...
You can also use `npx expo customize` to generate the static project files: **index.html**, and so on. These can be used to customize your project more familiarly.
