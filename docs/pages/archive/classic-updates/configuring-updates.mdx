...
Note that `checkAutomatically: "ERROR_RECOVERY_ONLY"` will be ignored in Expo Go, although the imperative Updates methods will still function normally.
