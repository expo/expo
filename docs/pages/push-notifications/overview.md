...
- [Setup: getting a user's Expo Push Token](https://docs.expo.io/push-notifications/push-notifications-setup/)
- [Sending: calling Expo's Push API with the token when you want to send a notification](https://docs.expo.io/push-notifications/sending-notifications/)
- [Receiving: responding to the notification in your app](https://docs.expo.io/push-notifications/receiving-notifications/) (maybe upon opening, you want to jump to a particular screen that the notification refers to)
