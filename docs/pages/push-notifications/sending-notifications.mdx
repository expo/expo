...
| `richContent`       | Android Only    | `Object`                                                  | Currently supports setting a notification image (only on Android). Provide an object with key `image` and value of type `string` - the image url.                                                                                                                                                                                                                              |
