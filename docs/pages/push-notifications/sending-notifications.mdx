...
| `_contentAvailable` | iOS Only     | <CODE>boolean \| undefined</CODE>            | When this is set to true, the notification will cause the iOS app to be started in the background to run a [background task](/versions/unversioned/sdk/notifications/#background-notifications).                                                                                                                                                                  |                                           
