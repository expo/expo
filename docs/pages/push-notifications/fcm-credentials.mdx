...
<ContentSpotlight
  ...
  src="/static/images/creating-google-service-account/fcm-v1/new-service-account/02-manage-service-accounts.webp"
  className="max-w-[800px]"
/>
...
<ContentSpotlight
  ...
  src="/static/images/creating-google-service-account/fcm-v1/new-service-account/03-generate-key.webp"
  className="max-w-[800px]"
/>
...
<ContentSpotlight
  ...
  src="/static/images/creating-google-service-account/fcm-v1/new-service-account/04-upload-credential-1.webp"
  className="max-w-[800px]"
/>
...
<ContentSpotlight
  alt="Edit principal in the IAM Admin page in Google Cloud Console"
  src="/static/images/creating-google-service-account/fcm-v1/existing-service-account/01-iam-admin-page.webp"
  className="max-w-[800px]"
/>
...
<ContentSpotlight
  alt="Assign roles"
  src="/static/images/creating-google-service-account/fcm-v1/existing-service-account/02-add-role-1.webp"
  className="max-w-[800px]"
/>

<ContentSpotlight
  alt="Select the Firebase Messaging API Admin role"
  src="/static/images/creating-google-service-account/fcm-v1/existing-service-account/02-add-role-2.webp"
  className="max-w-[800px]"
/>

<ContentSpotlight
  alt="Save the role assignment"
  src="/static/images/creating-google-service-account/fcm-v1/existing-service-account/02-add-role-3.webp"
  className="max-w-[800px]"
/>
