...
You may also come across the term "silent notification" which is a yet another name for notifications that don't present anything to the user - we describe these as [Headless Background Notifications](#headless-background-notifications).
