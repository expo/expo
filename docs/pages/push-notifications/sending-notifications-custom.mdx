...
The legacy FCM service has been discontinued by Firebase. Our documentation page on this service has been archived [here](/archive/push-notifications/sending-notifications-custom-fcm-legacy).
