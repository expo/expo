...
<Tabs tabs={["Android", "iOS"]}>
  ...
  <Tab>
    ...
    For iOS, make sure you have [registered your iOS device](/develop/development-builds/introduction/?buildenv=build-with-eas#how-would-you-like-to-build-your-development-build) on which you want to test before running the `eas build` command for the first time.
