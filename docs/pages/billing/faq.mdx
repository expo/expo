...
Expo automatically sends email notifications to account Owners and Admins when your account reaches 80% and 100% of your plan's included EAS Build credits. See [Usage notifications](/billing/usage-based-pricing/#usage-notifications) for more details.
