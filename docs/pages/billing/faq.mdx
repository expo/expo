...
If you're already subscribed to a paid EAS plan, you can buy additional concurrencies in [the Add-ons section on the Billing](https://expo.dev/settings/billing#addons) page.

If you're still on the Free plan, you will need to set up a paid subscription. [Click here](https://expo.dev/accounts/[account]/settings/billing/cart) to choose a plan. You can select a number of additional concurrencies to add to your subscription on the checkout page.
