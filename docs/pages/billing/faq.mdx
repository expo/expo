...
If you are on the Free plan, you will need to set up a paid subscription. [Choose a new plan](https://expo.dev/accounts/[account]/settings/billing/cart). Then, select the number of additional concurrencies to add to your subscription on the checkout page.
