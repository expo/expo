...
ACH, bank transfer, and wire transfer payment methods are only available for [Enterprise plan](/billing/plans/#enterprise) customers who pay annually. [Contact us](https://expo.dev/contact) for more information.
