...
<Tab label="From Production, Enterprise or Legacy to On-demand plan">
...
- Next, you need to review and confirm your new plan. Verify that the account you're downgrading from is correct (see the _warning_ on this page). After reviewing the details, enable the checkbox and click **Continue to Checkout**.
...
<Tab label="From Production, Enterprise or Legacy to Free plan">
...
- You will be redirected to Stripe's cancel plan screen, where you can confirm your plan. Switching to the Free plan is equivalent to canceling a paid plan at the end of the billing cycle.
...
To cancel your plan, on [**Billing**](https://expo.dev/settings/billing), click **Cancel Plan** and then click **Continue to Stripe** to follow the process of your current plan's cancelation.
