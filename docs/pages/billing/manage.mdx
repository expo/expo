...
If you are on a Production, Enterprise, or Legacy plan, you can downgrade to the On-demand plan.
...
- Under **Upgrade plan** > **On-demand plan**, click **Change**.
...
- After confirming your account for a plan downgrade to On-demand, the same information is also reflected under **Billing** > **Upcoming Plan**.
