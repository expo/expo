...
For example, consider an account subscribed to the Production plan which does 15 medium Android builds, and 10 large iOS builds in a billing period:
...
> **Note**: If the subscriber then sends another 20 MiB update to the same 10,000 users in the current billing period, they will only pay for any extra bandwidth used. This is because Expo only charges for [unique monthly updated users](/eas-update/faq/#how-are-monthly-updated-users-counted-for-a-billing-cycle).
