...
#### Example: EAS Build credit usage from Production plan
...
#### Example: EAS Build credit exceeded from Production plan
...
#### Example: EAS Update usage from Starter plan
...
To see the current billing period's usage summary, go to the [Billing > **Usage**](https://expo.dev/settings/billing). You will find a summary for EAS Build, EAS Update, and other services usage.
