...
To see the current billing period's usage summary, go to [Billing > **Usage**](https://expo.dev/settings/billing). You will find a summary for EAS Build, EAS Update, and other services.
