...
description: Learn how Expo applies usage-based billing for customers who exceed their plan quotas and how to monitor your EAS Build and EAS Update usage.
---
...
<ContentSpotlight
  alt="Email notification preferences in the EAS dashboard."
