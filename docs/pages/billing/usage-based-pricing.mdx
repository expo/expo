...
Expo sends email notifications to account Owners and Admins when your account reaches **80%** and **100%** of your plan's included EAS Build credits, helping you anticipate overage charges before they occur.

These notifications are enabled by default. You can manage your notification preferences from the **Email notifications** page in your [account dashboard](https://expo.dev/settings/billing).
