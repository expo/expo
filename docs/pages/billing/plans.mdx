...
[Expo Application Services (EAS)](/eas/) offers [free access](https://expo.dev/acceptable-use#free-plan) to a limited quantity of low-priority builds on [EAS Build](/build/introduction/) and free updates with [EAS Update](/eas-update/introduction/). These limits reset monthly.
