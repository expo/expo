...
| EAS Build - Plan credit                                                                    |        1 |    -$40.00 |    -$99.00 |
| **Total (USD)**                                                                            |          |            | **$99.00** |

In the above table, the first line item describes the EAS Build usage. It contains all the details about how many Android and iOS builds were created during this billing period and their cost. The second line item describes the amount of the Production plan's subscription. The third line item describes the credit limit for the Production plan for a monthly billing period.
