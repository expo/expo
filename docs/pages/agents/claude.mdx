...
Install Expo Skills and connect the Expo MCP Server so Claude Code knows Expo conventions and can reach your EAS data.
...
Paste the following prompt in your Claude Code session to confirm it's reading your project context:
...
- **CLAUDE.md** contains a single line: `@AGENTS.md`. This line imports **AGENTS.md** into Claude Code's context. **AGENTS.md** pins Claude Code to the documentation for your project's Expo SDK version. Add project-level instructions to **AGENTS.md**, not **CLAUDE.md**, so they stay in one place.
