...
When you start Codex in your project, it reads the scaffolded **AGENTS.md** file, This files pins Codex to the documentation for your project's Expo SDK version and holds your project-level instructions that you may add.
