...
<BoxLink
  ...
  description="Connect the remote MCP server to give agents live access to Expo documentation and EAS data."
  href="/mcp/"
  Icon={BookOpen02Icon}
/>
...
Each per-agent guide covers install, setup, and example prompts for that agent. The Claude Code guide is available now, with Codex and Cursor to follow.
