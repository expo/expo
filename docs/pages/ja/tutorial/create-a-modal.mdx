...
export default function Index() {
  ...
  /* @tutinfo <CODE>Index</CODE> コンポーネント内に state 変数を作成します。 */
  ...
  return (
    <View style={styles.container}>
      ...
      /* @tutinfo <CODE>showAppOptions</CODE> の値に基づいてボタンが表示されます。また、既存のボタンを三項演算子のブロック内に移動します。 */
      {showAppOptions ? (
        <View />
      /* @end */
      ) : (
        <View style={styles.footerContainer}>
          ...
          /* @tutinfo <CODE>alert()</CODE> を <CODE>onPress</CODE> に置き換えます。*/
...
<Pressable style={styles.button} /* @tutinfo <CODE>alert()</CODE> を <CODE>onPress</CODE> に置き換えます。*/ onPress={onPress}/* @end */>
```
...
import Button from '@/components/Button';
import ImageViewer from '@/components/ImageViewer';
/* @tutinfo <CODE>IconButton</CODE> と <CODE>CircleButton</CODE> コンポーネントをインポートします。*/
...
export default function Index() {
  ...
  return (
    <View style={styles.container}>
      ...
      {showAppOptions ? (
        /* @tutinfo App オプションボタンを表示するため、空の <CODE>View</CODE> コンポーネントをこのスニペットに置き換えます。 */
...
const styles = StyleSheet.create({
  ...
  /* @tutinfo 新しい <CODE>View</CODE> コンポーネントのスタイルを追加します。 */
  optionsContainer: {
    position: 'absolute',
    bottom: 80,
  },
...
import IconButton from '@/components/IconButton';
import CircleButton from '@/components/CircleButton';
/* @tutinfo <CODE>EmojiPicker</CODE> コンポーネントをインポートします。 */
...
export default function Index() {
  ...
  return (
    <View style={styles.container}>
      ...
      /* @tutinfo <CODE>Index</CODE> コンポーネントの末尾に <CODE>EmojiPicker</CODE> コンポーネントをレンダリングします。 */
...
import CircleButton from '@/components/CircleButton';
import EmojiPicker from '@/components/EmojiPicker';
/* @tutinfo <CODE>EmojiList</CODE> コンポーネントをインポートします。 */
...
export default function Index() {
  ...
  return (
    <View style={styles.container}>
      ...
      <EmojiPicker isVisible={isModalVisible} onClose={onModalClose}>
        /* @tutinfo <CODE>EmojiPicker</CODE> コンポーネント内に <CODE>EmojiList</CODE> コンポーネントをレンダリングします。 */
...
import EmojiPicker from '@/components/EmojiPicker';
import EmojiList from '@/components/EmojiList';
/* @tutinfo <CODE>EmojiSticker</CODE> コンポーネントをインポートします。 */import EmojiSticker from '@/components/EmojiSticker';/* @end */
