...
> **info** iOS では、Expo CLI と Expo Go が同じ Expo アカウントでサインインしている場合にのみ、Expo Go はプロジェクトを開きます。どちらも前の章でサインイン済みです。アカウントのエラーが表示される場合は、[Expo Go のサインインが必要](/troubleshooting/expo-go-sign-in-required/)を参照してください。
