...
> **info** Appearance locking requires `react-native@0.63.3` to work correctly.
...
> **info** Don't forget to configure your project to support automatic color scheme as described above in [Configuration](#configuration).
