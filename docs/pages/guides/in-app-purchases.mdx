...
<BoxLink
  ...
  description="In App Purchase module in Expo, migrated from react-native-iap. Provides an interface to the client-side native in-app purchase API's for Android (both Play Store and Amazon) and iOS."
