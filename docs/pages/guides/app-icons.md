...
- Use a png file.
- 1024x1024 is a good size. If your project is using [Expo Prebuild](/workflow/prebuild.md), then [EAS Build](/build/setup.md) will generate the other sizes for you based on the `icon` property in the project's Expo config. If your project is not using Expo Prebuild (bare workflow), you should generate the icons on your own. The largest size EAS Build generates is 1024x1024.
