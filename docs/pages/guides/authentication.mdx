...
export default function App() {
  ...
  const [request, response, promptAsync] = useAuthRequest(
    {
      clientId: /* @info Your client id, can hardcode or put it in .env file */ process.env.EXPO_PUBLIC_Client_ID /* @end */,
      usePKCE: true,
      redirectUri: makeRedirectUri({
        native: /* @info Set up scheme property in your app.json or app.config.js. EX app.json {scheme: "myapp"} */ "myapp://" /* @end */, 
      }),
    },
    discovery
  );
        ...
        const exchangeTokenResponse = await exchangeCodeAsync(
          {
            ...
            code: /* @info Recieved Code from firs request*/ exchangeTokenReq /* @end */,
            redirectUri: makeRedirectUri({
              native: "myapp://",
            }),
            extraParams: {
