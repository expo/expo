...
| Website                    | Provider | PKCE      | Auto Discovery |
| -------------------------- | -------- | --------- | -------------- |
| [Get Your Config][c-logto] | OpenID   | Supported | Available      |

[c-logto]: https://docs.logto.io/quick-starts/expo/
...
- For web platforms,an `http(s)://` scheme is required for `redirectUri`.
