...
<SocialGrid>
  ...
  <SocialGridItem
    ...
    protocol={['OAuth 2', 'OpenID']}
    href="#cognito"
    image="/static/images/sdk/auth-session/cognito.png"
  />
  <SocialGridItem
    title="Coinbase"
    protocol={['OAuth 2']}
...
<CreateAppButton name="Cognito" href="https://us-east-1.console.aws.amazon.com/cognito/v2/idp/user-pools?region=us-east-1" />

| Website                      | Provider  | PKCE          | Auto Discovery |
| ---------------------------- | --------- | ------------- | -------------- |
| [Get Your Config][c-cognito] | OpenID    | Supported     | Not Available  |

[c-cognito]: https://us-east-1.console.aws.amazon.com/cognito/v2/idp/user-pools?region=us-east-1
...
const userPoolUrl = 'https://<your-user-pool-domain>.auth.us-east-1.amazoncognito.com';
