...
| Website                       | Provider | PKCE      | Auto Discovery |
| ----------------------------- | -------- | --------- | -------------- |
| [Get Your Config][c-asgardeo] | OpenID   | Supported | Available      |

[c-asgardeo]: https://console.asgardeo.io/

- Make sure to check `Public Client` in the console.
- Check `Implicit` in the Allowed grant types section.
