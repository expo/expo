---
title: Permissions
description: Learn about configuring and adding permissions in an Expo config file.
---
...
Permissions in standalone and [development builds](/development/introduction.mdx) require native build-time configuration before they can be requested using runtime JavaScript code. This is not required when testing projects in the [Expo Go][expo-go] app.
