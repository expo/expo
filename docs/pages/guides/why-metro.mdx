...
Unlike traditional bundlers, where the end result is a fully hosted app, Metro can export bundles to embed as native artifacts in standalone app binaries. This leverages OS-specific optimizations such as `xcassets` on Apple platforms.
