...
A number of bundlers are opting to write their core in Rust for performance reasons, but this comes with some trade-offs. Metro uses a mix of technologies based on the operation:
