---
title: App icons
description: Learn about configuring the app's icon and best practices for Android, iOS and the web.
---
...
If your app contains `privacy: public` in [**app.json**](/workflow/configuration), it will show up on your expo.dev profile. We will mask your icon to have rounded corners in that circumstance, so if it already looks reasonable on iOS, it will probably look good here as well.
