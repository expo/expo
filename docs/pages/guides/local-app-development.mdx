...
To set up your development environment on macOS for Android, you've to install Node.js, Watchman, JDK, and Android Studio.
...
To set up your development environment on Windows for Android, you've to install Node.js, JDK, and Android Studio.
...
To set up your development environment on Linux for Android, you've to install Node.js, Watchman, JDK, and Android Studio.
...
To modify your project's configuration or native code after the first build, you've to rebuild your project. Running `npx expo prebuild` again layers the changes on the top of existing files. It may also produce different results after the build.
