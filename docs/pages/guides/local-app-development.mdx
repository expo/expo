...
After building your project for the first time, you can modify your project's configuration or native code. However, it is recommended to make these modifications using [app config](/workflow/configuration/) or by creating a [config plugin](/config-plugins/introduction/).
