...
After building your project for the first time you can make modifications to your project's configuration or native code. However, it is recommended to make these modifications using app config or by creating a config plugin.
...
<BoxLink
  title="Run builds on your infrastructure"
  description="Learn how to run EAS Build on your custom infrastructure or locally."
  href="/build-reference/local-builds"
  Icon={DocsLogo}
/>
