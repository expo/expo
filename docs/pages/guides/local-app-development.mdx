...
You can use [`expo-dev-client`](/develop/development-builds/introduction/#what-is-expo-dev-client) to create a development build in your project. To initialize the build, install the library:
