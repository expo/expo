...
- DOM component bundles can be introspected in [Expo Atlas](/guides/analyzing-bundles/#analyzing-bundle-size-with-expo-atlas) for debugging.
...
Ultimately, universal architecture is the most exciting kind. Expo CLI's universal tooling makes this feature possible.
