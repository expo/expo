...
You can compile your project locally to use first-party native debuggers (Xcode/Android Studio). To learn more, visit the [native debugging guide](/workflow/debugging#native-debugging).
