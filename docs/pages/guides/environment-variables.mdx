...
### From non-expo Metro config

As per the [`Customizing Metro guide`](https://docs.expo.dev/guides/customizing-metro/#customizing) import `expo/metro-config` instead of `@react-native/metro-config` 
