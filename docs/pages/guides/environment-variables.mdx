...
Using a Babel plugin to transform your environment variable references in your code is similar to how Expo environment variables work. Set your variables inside an **.env** file and update your variable names to use the `EXPO_PUBLIC_` prefix:
