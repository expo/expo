...
To read `extra` properties in your app, you can use the [`expo-constants`](/versions/latest/sdk/constants.mdx) library. It is available on the `Constants.default.expoConfig` property.
