...
| `server` | <YesIcon /> | <YesIcon /> | Creates **client** and **server** directories with client assets, API routes, and a server that renders HTML for each request. Requires a server runtime. |
