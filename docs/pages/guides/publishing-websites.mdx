...
> If your app uses [static rendering](/router/server/static-rendering), then you can skip this step.
...
If your app uses [static rendering](/router/server/static-rendering), then you may want to add additional [dynamic route configuration](/router/server/static-rendering#dynamic-routes).
