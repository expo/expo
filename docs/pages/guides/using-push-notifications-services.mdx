...
[Customer.io](http://Customer.io) is a customer engagement platform that provides push notifications, in-app messaging, email, and SMS capabilities. Customer.io supports device-side metrics collection, deep linking from notifications into your app, and customizable in-app messaging. It provides documentation for using Customer.io notifications alongside other providers. Customer.io provides an [Expo plugin](https://github.com/customerio/customerio-expo-plugin) for direct integration with your Expo project.
