...
Learn more about tree shaking in the [bundle size guide](/guides/bundle-size).

## Minification

Learn more about customizing the minifier in the [minification guide](/guides/minification).
