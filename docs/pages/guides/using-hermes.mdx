...
> [Development builds](/development/introduction.mdx) built with `expo-dev-client` simplify this process by integrating directly with the JavaScript inspector in Hermes.
