...
| Platform | Expo Go | [Development Builds](/development/introduction) |
| -------- | ------- | ----------------------------------------------- |
...
For SDK 47 and lower, JSC is the default JavaScript engine and to use Hermes you need to add the `jsEngine` field in [Expo config](/workflow/configuration):
