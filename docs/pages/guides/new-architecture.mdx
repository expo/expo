...
- **react-native-maps**: does not yet support the New Architecture. [Follow along with progress](https://github.com/react-native-maps/react-native-maps/discussions/5355). If your app can force a minimium version of iOS 17, or does not need to support maps on iOS, then consider [expo-maps](versions/latest/sdk/maps/).
