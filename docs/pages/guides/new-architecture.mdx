...
<BoxLink
  ...
  description="React Native 0.82 is the first version that runs entirely on the New Architecture. SDK 55 uses React Native 0.83, which inherits this behavior."
...
As of SDK 53, all `expo-*` packages in the [Expo SDK](/versions/latest/) support the New Architecture (including [bridgeless](https://github.com/reactwg/react-native-new-architecture/discussions/154)). [Learn more about known issues](#known-issues-in-expo-libraries).
