...
> [Experimentally](/more/release-statuses/#experimental) available in SDK 52 and later.
...
If the star export pulls in ambiguous exports such as `module.exports.ArrowUp` or `exports.ArrowDown`, then the optimization pass will not expand the star export and no exports will be removed from the barrel file. You can use [Expo Atlas](/guides/analyzing-bundles/#analyzing-bundle-size-with-expo-atlas) to inspect the expanded exports.
