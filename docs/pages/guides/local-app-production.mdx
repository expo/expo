...
Once the build is complete, you can archive your app and upload it to App Store Connect from Xcode.

<BoxLink
  title="Manually submit an iOS app with Xcode"
  description="Archive and upload an iOS app to App Store Connect using Xcode."
