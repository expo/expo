...
<Terminal
  cmd={{
    npm: ['$ npx expo install typescript @types/react --dev'],
    yarn: ['$ yarn expo install typescript @types/react --dev'],
    pnpm: ['$ pnpm expo install typescript @types/react --dev'],
    bun: ['$ bun expo install typescript @types/react --dev'],
  }}
/>
...
<Terminal
  cmd={{
    npm: ['$ npx expo customize tsconfig.json'],
    yarn: ['$ yarn expo customize tsconfig.json'],
    pnpm: ['$ pnpm expo customize tsconfig.json'],
    bun: ['$ bun expo customize tsconfig.json'],
  }}
/>
...
<Terminal
  cmd={{
    npm: ['$ npx expo install tsx --dev'],
    yarn: ['$ yarn expo install tsx --dev'],
    pnpm: ['$ pnpm expo install tsx --dev'],
    bun: ['$ bun expo install tsx --dev'],
  }}
/>
