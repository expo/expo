...
> **info** Example project: [with-typescript](https://github.com/expo/examples/tree/master/with-typescript)
...
> **info** You can disable the TypeScript setup in Expo CLI with the environment variable `EXPO_NO_TYPESCRIPT_SETUP=1`
...
> **info** You may need to install the `@expo/webpack-config` package.
...
> **info** Metro doesn't ship types or have a definitely typed package.
