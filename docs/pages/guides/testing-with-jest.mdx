...
You'll also use `jest-expo` package that is a Jest preset and mocks the native part of the Expo SDK and handles most of the configuration.
...
The test will expect the state of the `<App />` component to have on child element:
