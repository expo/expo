...
<Tabs>
  <Tab label="Code">
    ...
    import { background, buttonStyle, clipShape, frame } from '@expo/ui/swift-ui/modifiers';
              ...
              <Link href="/wifi" asChild>
                ...
                <Button modifiers={[buttonStyle('plain')]}>
                  <HStack spacing={8}>
                    ...
                    />
                    {/* When text wrapped in Link, the color needs to be specified explicitly */}
...
There are several approaches for styling secondary or muted text. You can use `opacity` for a simple muted effect, or `foregroundStyle` for more control over the color. At this point, the [hierarchical styles](/versions/v55.0.0/sdk/ui/swift-ui/modifiers/#foregroundstylestyle) do not work for Text.
...
<Tabs>
  ...
  import {
    ...
    import { buttonStyle, font, foregroundStyle, opacity, padding } from '@expo/ui/swift-ui/modifiers';
    ...
    <Host style={{ flex: 1 }}>
      <Form>
        <Section>
          <List>
            ...
            >
              <HStack>
                ...
                <Spacer />
                {/* Using foregroundStyle for colored secondary text */}
                <Text
                  modifiers={[
                    foregroundStyle({ type: 'color', color: '#8E8E93' }),
                    padding({ trailing: 8 }),
                  ]}
                >
                  22:00 to 07:00
          ...
          <List>
            {/* Using opacity for muted secondary text */}
            <Text modifiers={[opacity(0.6), font({ size: 14 })]}>
              Save up to 280.7 MB. This will permanently delete all photos and
              videos kept in the "Recently Deleted" album.
            </Text>
          </List>
        </Section>
      </Form>
