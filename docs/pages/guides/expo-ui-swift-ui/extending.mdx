...
- Basic familiarity with [Expo Modules](/modules/overview/) and [SwiftUI](https://developer.apple.com/swiftui/)
...
```swift ios/CustomBorderModifier.swift
import SwiftUI
import ExpoModulesCore
import ExpoUI
...
Register your modifier with `ViewModifierRegistry` in your module definition. Use `OnCreate` to register and `OnDestroy` to unregister for proper cleanup:
