...
> Available with SDK 50 and above. Make sure you have updated your Expo SDK libraries to the latest versions for your SDK version using `npx expo install --fix`. For previous versions, you can use the [expo-privacy-manifest-polyfill-plugin](https://www.npmjs.com/package/expo-privacy-manifest-polyfill-plugin).
