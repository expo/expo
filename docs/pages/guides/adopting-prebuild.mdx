...
- Additionally, you can develop local config plugins to fit your needs. See [how to develop a config plugin](/config-plugins/development-and-debugging/#plugin-development).
