...
## Sentry and EAS Build

If you are using Sentry with EAS Build, especially if building a dev-client, you will want to review the [sentry-expo README](https://github.com/expo/sentry-expo/blob/master/README.md).
