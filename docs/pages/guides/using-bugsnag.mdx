...
See the integration guide below for instructions on how to add BugSnag to your Expo apps to report JavaScript errors. This guide includes instructions for uploading source maps for updates published with [EAS Update](/eas-update/introduction/).
