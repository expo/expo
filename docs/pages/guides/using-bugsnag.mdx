...
See the integration guide below for instructions on how to add BugSnag to your Expo apps to report JavaScript errors. You can also read the [blog post](https://www.bugsnag.com/blog/build-apps-in-expo-with-bugsnag) announcing BugSnag's Expo integration. 
