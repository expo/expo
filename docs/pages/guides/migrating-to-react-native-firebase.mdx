...
- - Replacing the use of Expo Go for testing with [Development Builds](/development/introduction/) customized to your project's needs
- Testing the updated code on Development Builds
