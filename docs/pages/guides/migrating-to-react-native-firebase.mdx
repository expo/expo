...
> **info** These instructions assume you have already been successfully using the Expo Firebase packages. If you're adding Firebase to your app for the first time, see [Using Firebase](/guides/using-firebase) guide.
