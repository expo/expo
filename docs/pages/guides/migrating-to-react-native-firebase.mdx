...
## Conclusion
Now that you have your own development build, you can use any of the many React Native Firebase packages in your development and testing workflow. Not only that, but you're only minutes away from adding [any additional native functionality you'd like](https://docs.expo.dev/development/getting-started/#customizing-your-runtime).
