...
If you have been using Expo Go for development and testing, at this point, you will need to migrate to a [development build](/development/introduction/#from-expo-go-to-development-builds), as Expo Go does not include the native code used in React Native Firebase.
