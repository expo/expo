...
- Replacing the use of Expo Go for testing with [development build](/development/introduction/) customized to your project's needs
- Testing the updated code on development build
