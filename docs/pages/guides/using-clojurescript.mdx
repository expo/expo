...
> **warning** ClojureScript is not officially supported by the Expo team, this guide was written by [@tiensonqin](https://github.com/tiensonqin).
...
For more information, see [Expo CLI](../workflow/expo-cli.mdx).
...
See [How do I add custom native code to my Expo project?](../introduction/faq.mdx#faq).
