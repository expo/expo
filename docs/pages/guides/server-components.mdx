...
<BoxLink
  ...
  href="/router/server/api-routes#native-deployment"
  Icon={Cloud01Icon}
/>
...
- [`generateStaticParams`](/router/server/static-rendering/#generatestaticparams) is only partially supported in full React Server Components mode.
