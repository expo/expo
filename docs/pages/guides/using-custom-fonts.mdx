...
> **info** The above example also uses [`expo-splash-screen`](/versions/latest/sdk/splash-screen/) package. To learn why, read about it more in the [Waiting for fonts to load](#waiting-for-fonts-to-load) section.
...
> **info** Learn more about [pre-loading and caching assets](/guides/preloading-and-caching-assets/#pre-loading-and-caching-assets) in your React Native app.
