...
The Convex team invitation goes to the verified email on your Expo account, but Convex only supports signing in with Google or GitHub. If the email of the Google or GitHub account you sign in with doesn't match the invited email, the invitation page shows an error saying the invite belongs to another email address, and navigating away from it leaves you in a separate Convex account that doesn't contain your project.

<ContentSpotlight
  alt="Convex invitation page showing that the email address associated with the team invitation has not been added to your account"
...
> **Note**: The flow can look like it failed after verifying the email. The invitation page doesn't update until you reload or reopen it.
