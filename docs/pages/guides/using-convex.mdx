...
The Convex team invitation goes to the verified email on your Expo account, but Convex only supports signing in with Google or GitHub. If the email of the account you sign in with does not match the invited email, the invitation page shows an error saying the invite belongs to another email address. Navigating away from that page leaves you in a separate Convex account that does not contain your project.
...
> **info** The flow can look like it failed after verifying the email. The invitation page does not update until you reload or reopen it.
