...
The fully qualified Next.js config may look as shown below:
...
If you want to help make Next.js support in Expo better, feel free to open a PR or submit an issue in [`@expo/next-adapter`](https://github.com/expo/expo-cli/tree/main/packages/next-adapter).
