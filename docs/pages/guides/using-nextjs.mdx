...
<Terminal
  cmd={{
    npm: ['$ npx create-expo-app -e with-nextjs'],
    yarn: ['$ yarn create expo-app -e with-nextjs'],
    pnpm: ['$ pnpm create expo-app -e with-nextjs'],
    bun: ['$ bun create expo -e with-nextjs'],
  }}
/>
...
<Terminal
  cmd={{
    npm: ['$ npm install expo next @expo/next-adapter'],
    yarn: ['$ yarn add expo next @expo/next-adapter'],
    pnpm: ['$ pnpm add expo next @expo/next-adapter'],
    bun: ['$ bun add expo next @expo/next-adapter'],
  }}
/>
...
<Terminal
  cmd={{
    npm: ['$ npm install --global vercel'],
    yarn: ['$ yarn global add vercel'],
    pnpm: ['$ pnpm add --global vercel'],
    bun: ['$ bun add --global vercel'],
  }}
/>
