...
> **info** Please open any issues related to Next.js with Expo at [expo-cli/issues](https://github.com/expo/expo-cli/issues).
...
> **info** Next.js can only be used with Expo for web, this doesn't provide Server-Side Rendering (SSR) for native apps.
...
> **info** This is for already existing Expo projects.
...
> **info** This is for already existing Next.js projects.
...
> **info** Fixes `setImmediate is not defined` error.
