...
- Running `eas update` or `npx expo export` will generate a **dist** folder in your project root, which contains your JavaScript bundles and sourcemaps.
...
<Terminal cmd={[
  ...
  "    upload-sourcemaps \\",
  "    --strip-prefix /path/to/project/root \\",
  "    android-<hash>.js android-<hash>.map",
]} />
</Tab>
</Tabs>
