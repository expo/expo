...
> **info** If you have an existing app, you can copy all those files inside a subfolder.
...
> **info** Learn more about [customizing Metro](/guides/customizing-metro).
...
> **info** After adding the package as a dependency, run `yarn install` to install or link the dependency to your app.
