...
<ContentSpotlight
  alt="Navigating to the Developer Mode setting"
  src="/static/images/ios-dev-mode/ios-16-developer-mode-0.webp"
...
Open Xcode, and from the menu bar, navigate to **Xcode** > **Open Developer Tool** > **Device Hub**.

Select your device in the sidebar. Device Hub shows **Enable Developer Mode** with instructions for enabling it on the iOS device.

<ContentSpotlight
  alt="Device Hub showing the Enable Developer Mode message for a connected iPhone."
...
<ContentSpotlight
  alt="Developer Mode restart prompt"
  src="/static/images/ios-dev-mode/with-xcode-03.webp"
