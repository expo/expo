...
> **info** This section describes the behavior in **SDK 58 and later**. In earlier SDK versions, RTL support is disabled by default. To enable it, set the `extra.supportsRTL` property in app config.
