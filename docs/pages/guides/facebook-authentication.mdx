...
### Step 3: Add a method to dismiss the web popup
...
### Step 4: Pass the client ID to the provider
...
**Testing with Expo Go** is done by running `npx expo start` command.
