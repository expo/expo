...
To get started with Expo Router, run the following command to create a project with `expo-router` setup:

<Terminal cmd={['$ npx create-expo-app@latest -e with-router']} />

<BoxLink
  title="Expo Router documentation"
  description="To learn more about Expo Router, check out the documentation."
