...
Firebase JS SDK loads both ES modules (ESM) and CommonJS modules (CJS) when bundled in your project. To work around this, ensure Metro is configured to support ESM from the Firebase JS SDK using the following configuration:
