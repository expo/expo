...
[LogRocket](https://logrocket.com) records user sessions and identifies bugs as your users use your app. You can filter sessions by update IDs and also connect to your LogRocket account on the Expo dashboard to get quick acccess to your app's session data.
...
Then, in your **app.json**, include the LogRocket config plugin:
