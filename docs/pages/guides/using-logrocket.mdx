...
Then, you'll start to see **View on LogRocket** buttons in the EAS dashboard in the Deployments and Updates dashboards, along with the last few sessions from your app.
