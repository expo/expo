...
Note that with Yarn 2 you will need to [https://yarnpkg.com/getting-started/migration#if-required-enable-the-node-modules-plugin](specify node-modules as your linker).
