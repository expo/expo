...
> **info** You don't need macOS to build an iOS app with EAS. You only need an iOS device to run development builds. Windows, Linux, and macOS are all supported for your development machine.
