...
WSL may require additional configuration, especially for testing your code on a [development build](/develop/development-builds/introduction/). Learn more about [how to setup your Expo development environment in WSL 2](https://expo.fyi/wsl).
