...
You can remove the boilerplate code and start fresh with a new project. Run the following command to reset your project. Remember to close any editor while doing this otherwise it may not be able to perform this action correctly:
