...
If you see an error about accounts on a physical iOS device, sign in to Expo Go from the account icon in the top-right corner, then press **Try Again**. For the other account errors and what each one means, see [Expo Go sign-in required](/troubleshooting/expo-go-sign-in-required/).
