...
> **info** You can also run `yarn expo -h` if you prefer to use yarn as the package manager.
...
> **info** You can also run `npx expo` as an alias to `npx expo start`.
...
> **info** Webpack is only supported for the Web platform.
