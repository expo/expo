...
- `HTTP_PROXY` (**string**) HTTP/HTTPS proxy URL to connect to for all network requests. Configures [https-proxy-agent](https://www.npmjs.com/package/https-proxy-agent).
