...
In most cases, you will create and use a development build of your project. You will install the [`expo-dev-client`](/develop/development-builds/introduction/) library. Development builds can be created with EAS Build or locally on your machine:
...
- #### Write native code or modify native project configuration
  ...
  with a [local Expo Module](/modules/get-started/#add-a-new-module-to-an-existing-application).
...
To release your app on the app stores, you can use [EAS Submit](/deploy/submit-to-app-stores/). For more information on using EAS Submit, see [Submit to Google Play Store](/submit/android/) and [Submit to Apple App Store](/submit/ios/).
