...
> **info** This is only available for macOS users.
...
> **info** In bare workflow apps you can use [Flipper](https://fbflipper.com/) to inspect network traffic.
