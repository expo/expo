...
<ImageSpotlight alt="The Expo Go Developer Menu, showing the menu options available." src="/static/images/expo-go-developer-menu.png" style={{ maxWidth: 320 }} />
...
<ImageSpotlight alt="The Expo Go Element Inspector, showing details about an element after inspecting it." src="/static/images/react-native-community-cli-debugger-ui.png" />
...
<ImageSpotlight alt="The Expo Go Element Inspector, showing details about an element after inspecting it" src="/static/images/expo-go-element-inspector.png" style={{ maxWidth: 320 }} />
