...
> **info** **Pro Tip:** Press <kbd>Shift</kbd> + <kbd>I</kbd> in the CLI UI to interactively select a simulator to open.
...
<ImageSpotlight
  alt="Hardware > Device toolbar in Xcode"
  src="/static/images/open-simulator-manually.png"
/>
