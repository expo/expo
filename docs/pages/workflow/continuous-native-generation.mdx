...
- [Cross-platform Home screen Widgets](https://github.com/gaishimo/eas-widget-example) &mdash; This Expo Config Plugin can generate a home screen widget for iOS and Android.
