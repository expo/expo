...
React Native apps can use **CNG** by using [Expo Prebuild] to automate upgrades, install or uninstall libraries, white-labeling at scale, share configuration across multiple apps, reduce [orphaned code](#how-does-prebuild-help-with-orphaned-code), and more.
...
When bootstrapping a native app, there's initial code and configuration that you may not understand but you own it. Eventually, you'll need to understand this code to upgrade your app safely. This challenge often leads users to upgrade incorrectly or start a new app, copying existing source code.
