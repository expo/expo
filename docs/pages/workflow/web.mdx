...
Expo has first-class support for building full-stack websites with React. Expo websites can be [statically rendered](/router/server/static-rendering) for SEO and performance, or client-rendered for a more app-like experience in the browser.
...
<BoxLink
  ...
  href="/router/server/static-rendering"
  Icon={RouterLogo}
/>
