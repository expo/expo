...
> **info** You can try experimental [Metro web support](/guides/customizing-metro#web-support) instead of Webpack.

## Alternative Rendering Patterns

> **info** **Example:** The website [beatgig.com](https://beatgig.com/) uses Expo web + Next.js to achieve SSR in the browser.
...
> **info** Alternative framework implementations are maintained by the Expo community.
