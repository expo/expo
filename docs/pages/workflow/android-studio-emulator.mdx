...
The Android Studio Setup Wizard will ask you to verify the settings such as the version of Android SDK Platform, Platform-Tools, and so on. Click **Next** after you have verified.
...
To find the actual location of the SDK in Android Studio, go to **Settings** dialog > **Languages & Frameworks** > **Android SDK**. See the location next to **Android SDK Location**.
