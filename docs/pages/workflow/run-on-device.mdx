...
> **info** This guide focuses on running a project on your own device. To learn about sharing your project with others, refer to ["Sharing pre-release versions of your app"](/guides/sharing-preview-releases/) and ["Distribution"](/distribution/introduction/).
