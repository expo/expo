...
Expo maintains ~6 months of backward compatibility. Once an SDK version has been deprecated, you will no longer be able to use it in the Expo Go app. SDK deprecations **will not** affect the standalone apps you have in production or your [development builds](/develop/development-builds/introduction/), and backwards compatibility for older SDK versions on EAS services tends to be much longer, but not forever.
