...
### Consider updating your other dependencies

Check whether your dependencies have new updates. A new SDK version usually comes with a new version of React Native and maintainers often update their packages after new React Native releases. Package managers have built-in commands to list your app's outdated dependencies.

<Tabs>
  <Tab label="npm">
    <Terminal cmd={['$ npm outdated']} />
  </Tab>
  <Tab label="Yarn">
    <Terminal cmd={['$ yarn outdated']} />
  </Tab>
  <Tab label="pnpm">
    <Terminal cmd={['$ pnpm outdated --recursive']} />
  </Tab>
  <Tab label="Bun">
    <Terminal cmd={['$ bun outdated']} />
  </Tab>
</Tabs>

If `expo-doctor` reports new problems related to dependencies after this step, you may have [to try to resolve dependency issues manually.](https://expo.fyi/resolving-dependency-issues)
