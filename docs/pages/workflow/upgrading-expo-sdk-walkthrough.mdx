...
If you manage your own native projects (bare workflow), you will need to manually apply any changes to your native **android** and **ios** project directories. Our [bare upgrade advisor](/bare/upgrade) will show you a diff that describes the changes you need to make. Alternatively, you could consider [adopting prebuild](/guides/adopting-prebuild) for easier upgrades in the future.
