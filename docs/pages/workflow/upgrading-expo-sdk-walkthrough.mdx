...
<Terminal
  cmd={{
    npm: ['$ npm install expo@^56.0.0'],
    yarn: ['$ yarn add expo@^56.0.0'],
    pnpm: ['$ pnpm add expo@^56.0.0'],
    bun: ['$ bun install expo@^56.0.0'],
  }}
/>

Depending on which SDK you're upgrading to, substitute `expo@^56.0.0` with the version range of the Expo SDK version you're targeting. For example, `expo@^56.0.0` stands for SDK 56.
