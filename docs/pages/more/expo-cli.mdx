...
| `EXPO_NO_TELEMETRY_DETACH`          | **boolean** | <StatusTag status="SDK 51+" /><br/>Send telemetry events in the main thread of `@expo/cli`. This slows the CLI down, as it has to wait until all events are sent.                                                                                                                                                                                                                    |
