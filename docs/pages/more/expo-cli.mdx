...
title: Expo CLI
maxHeadingDepth: 4
description: The Expo CLI is a command-line tool that is the primary interface between a developer and other Expo tools. Learn more about how to get started using Expo CLI.
---
...
Building locally is useful for developing native modules and [debugging complex native issues](/home/debugging/runtime-issue/#native-debugging). Building remotely with `eas build` is a much more resilient option due to the pre-configured cloud environment.
