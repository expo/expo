...
| <kbd>J</kbd>                    | Open React Native DevTools for any connected device that is using Hermes as the JavaScript engine. See [debugging JavaScript with Hermes](/guides/using-hermes#javascript-inspector-for-hermes).                   |
