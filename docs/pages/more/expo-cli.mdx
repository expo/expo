...
> Experimental functionality, first available in the upcoming SDK 50.
...
You can configure the prefix for static assets by setting the `experiments.basePath` field in your `app.json`:
