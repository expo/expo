...
| `EXPO_USE_TYPED_ROUTES`             | **boolean** | <StatusTag status="deprecated" note="SDK 49+" /><br/>Use `expo.experiments.typedRoutes` to enable statically typed routes in Expo Router.                                                                                                                                                                                                                                            |
