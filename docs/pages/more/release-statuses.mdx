...
- Implementation of experimental features should be treated as a proof of concept rather than final
...
- As per semantic versioning, breaking changes of stable features will only occur in new major versions
...
- We may not accept feedback or issues for deprecated APIs
- Removal of deprecated features and APIs will happen in a new SDK release
