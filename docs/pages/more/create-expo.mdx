...
You can use the `--template` option to select one of the following templates or pass the name of the template as an argument to the option. For example, `--template default`.
