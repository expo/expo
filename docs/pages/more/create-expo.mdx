...
| [`tabs-react-navigation`](https://github.com/expo/expo/tree/main/templates/expo-template-tabs-react-navigation) | A minimal starter template for React Native apps using Expo and React Navigation. By default, it uses development build.                                                              |
