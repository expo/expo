...
From **SDK 54**, isolated installations are officially supported and you can delete the `node-linker` setting yourself if you prefer to use isolated dependencies.
