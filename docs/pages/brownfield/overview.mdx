...
> **info** Support for integrating Expo modules into existing native projects is in [alpha](/more/release-statuses/#alpha). If you encounter issues, [create an issue on GitHub](https://github.com/expo/expo/issues). Not all features of the tools and services below will be available when used in the context of an existing native app.
...
| [EAS Submit](/deploy/submit-to-app-stores/) - a hosted service that uploads your app to stores       | <YesIcon />          |
