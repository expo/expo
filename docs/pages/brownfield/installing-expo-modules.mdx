...
<Step label="4">
  **(Optional)** Complete the following if you would like to use [AppDelegate subscribers](/modules/appdelegate-subscribers/).
  <DiffBlock
...
<Step label="4">
  **(Optional)** Complete the following steps if you would like to use [lifecycle listener](/modules/android-lifecycle-listeners/)
  in your app:
<Step label="1">
