...
<Terminal
  cmd={{
    npm: ['$ npx create-expo-app@latest my-project'],
    yarn: ['$ yarn create expo-app my-project'],
    pnpm: ['$ pnpm create expo-app my-project'],
    bun: ['$ bun create expo my-project'],
  }}
/>
...
Monorepos, or "monolithic repositories", are single repositories containing multiple apps or packages. See [how to work with monorepos](/guides/monorepos/).
