...
<Step label="2">
Then open your top level `build.gradle` and include this line (as suggested from the [minimum template](https://github.com/expo/expo/blob/main/templates/expo-template-bare-minimum/android/build.gradle)):
...
<Step label="4">
Finally, open your application `gradle.properties` file and add the following lines (here the [minimum template file as reference](https://github.com/expo/expo/blob/main/templates/expo-template-bare-minimum/android/gradle.properties)):
