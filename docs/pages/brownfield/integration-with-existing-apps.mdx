...
A standard React Native project places native code in **android** and **ios** directories. This structure may not be ideal or even feasible when integrating with a large, existing native app.
There are two possible ways to accommodate this constraint: either move your native project files into the standard **android** and **ios** directories, or set up a monorepo.
