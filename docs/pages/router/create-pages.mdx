...
To demonstrate why Expo Router enforces this rule, refer to the example above which is using the [shared routes](/router/advanced/shared-routes) to render the same route with different layouts. This pattern is very common in native navigation making it difficult to keep your non-route files organized within the same directory as a route file.
