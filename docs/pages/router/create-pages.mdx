...
Every file and folder in the `app/` folder is either a `_layout` file, or a route in your app. This means that other files like your components, hooks, utilities etc cannot be placed in the `app/` folder because they're neither screens nor layout files.
