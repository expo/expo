...
We recommend creating a new Expo app using `create-expo-app`. Starting in SDK 51, the default template includes a minimal project with the Expo Router library already installed. To create a project, run the command:
