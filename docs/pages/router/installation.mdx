...
We recommend creating a new Expo app using `create-expo-app`. To create a project with Expo Router already configured, run the command:
...
Follow these instructions if you have a project that was previously created with Expo but does not have Expo Router installed.
