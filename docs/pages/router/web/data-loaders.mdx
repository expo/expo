...
- Loaders **must** return JSON-serializable data. Returning a stream or async iterator from a loader is not supported. This will be addressed in a future release.
