...
In SDK 58 and later, Expo Router defaults to [server rendering](/router/web/server-rendering). To enable static rendering, explicitly set `web.output` to `static` in your project's [app config](/versions/latest/config/app/):
