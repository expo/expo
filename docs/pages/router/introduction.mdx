...
> **Note:** Without `--template`, `create-expo-app` asks which Expo SDK version to use. Select **Latest (SDK 57)** for most projects, or **for learning with Expo Go (SDK 54)**, which matches the Google Play Store and Apple App Store versions of Expo Go.
