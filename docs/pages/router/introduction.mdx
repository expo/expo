...
export default function AIWorkbench() {
  ...
  const generatePlaceholder = () => {
    ...
    setOutput(`💡 You imagined: "${idea}"\n\nPreview of your app interface:\n\n[Header]\n[Content for "${idea}"]\n[Footer]`);
  };

  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>AI Workbench</Text>
      <Text style={styles.subtitle}>Type your app idea and see a live placeholder preview!</Text>
      ...
      <Button title="Generate Preview" onPress={generatePlaceholder} />
