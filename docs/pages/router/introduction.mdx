...
<BoxLink
  title="Expo Router playlist"
  Icon={YoutubeIcon}
  description="A tutorial series for Expo Router from the core concepts to more complex navigation flows."
