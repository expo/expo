...
When you have multiple web modals or want the experience to be as close to the experimental web modal as possible, create a [custom navigator](/router/advanced/custom-navigators/) with `StackRouter`. This basic implementation preserves the built-in stack view behind the modals; customize the overlay for your app's look and feel.
