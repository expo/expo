...
This doc covers the Custom Tabs layout. For other use-cases see:

<BoxLink
  title="Native Tabs"
  href="/router/advanced/native-tabs/"
  description="Use Native Tabs if you want to achieve a native look and feel for your tab bar."
  Icon={BookOpen02Icon}
/>
