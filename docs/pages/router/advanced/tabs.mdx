...
Tabs are a common way to navigate between different sections of an app. Expo Router provides a tabs layout to help you create a tab bar at the bottom of your app. The fastest way to get started is to use a template. See the [quick start installation guide](/router/installation/#quick-start) to get started.

Read on to learn how to add tabs to an existing project or to customize your app's tabs.
