...
Use the `redirectTo` prop when a protected route should redirect to a specific route. It accepts the same string or object href as [`Link`](/router/basics/navigation/#links).
