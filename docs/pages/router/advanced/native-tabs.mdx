...
> **info** Native tabs is available in SDK 54 and later. Use `expo-router/native-tabs` with the latest Expo SDK. Projects using older SDKs should import from `expo-router/unstable-native-tabs`.
...
```tsx app/_layout.tsx
import { NativeTabs, Icon } from 'expo-router/native-tabs';
...
```tsx app/_layout.tsx
import { NativeTabs, Label } from 'expo-router/native-tabs';
...
```tsx app/_layout.tsx
import { NativeTabs, Badge } from 'expo-router/native-tabs';
