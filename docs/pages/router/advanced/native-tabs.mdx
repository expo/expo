...
> **info** To use these features, compile your app with Xcode 26 or later.
...
> **info** When possible, we recommend using SF Symbols on iOS. They offer higher quality and platform feeling than vector icons.
