...
- **src/components/app-tabs.native.tsx** and **src/components/app-tabs.tsx** are [platform-specific](/router/advanced/platform-specific-modules/) tab components. The **app-tabs.native.tsx** file is used on Android and iOS, while the **app-tabs.tsx** file is used on web. The root layout imports these to render the tab navigator.
