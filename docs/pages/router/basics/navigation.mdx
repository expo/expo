...
When opening a deep link to a page in your app, you will likely want back navigation to work as if the user navigated to the page from your home page. To do this, you can specify an `initalRouteName` configuration, which defines the page in a layout that should be loaded prior to the deep linked page.
