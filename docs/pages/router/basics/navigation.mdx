...
Prefetching allows you to load a screen in the background before navigating to it, enabling smoother navigation. Expo Router provides three ways to prefetch routes.
