...
Prefetching allows you to load a screen in the background before navigating to it, enabling faster navigation. Expo Router provides three ways to prefetch routes.
