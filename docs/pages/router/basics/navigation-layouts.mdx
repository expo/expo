...
- [Adapt any navigator that is compatible with React Navigation](/versions/latest/sdk/router/#withlayoutcontextnav-processor-useonlyuserdefinedscreens), including top tabs, bottom sheets, and more
