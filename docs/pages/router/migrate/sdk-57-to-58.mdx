...
- For web apps, review the [async route defaults](#review-async-route-defaults) and, if using `web.output: "server"`, the [server rendering changes](#review-server-rendering-behavior).
