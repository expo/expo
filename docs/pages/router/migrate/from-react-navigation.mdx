...
- See the [Splash Screen API reference](/versions/latest/sdk/splash-screen/) for info on handling the splash screen.
...
The [`fallback`](https://reactnavigation.org/docs/navigation-container/#fallback) prop is automatically handled by Expo Router.
