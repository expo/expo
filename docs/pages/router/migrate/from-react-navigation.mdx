...
Layout the structure of your app by creating files according to the [creating pages guide](/router/create-pages/). Best practice dictates that you use kebab-case and lowercase letters for filenames.
