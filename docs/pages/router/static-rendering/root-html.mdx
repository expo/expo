...
When you statically render an Expo website, the root HTML element for each page can be customized by creating an **app/+html.js** file that exports a default HTML component.
