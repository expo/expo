...
> This guide requires `expo@49.0.0-alpha.3` or higher and `metro@0.76.3` &mdahs; everything listed here is still experimental. To use these features, you may need to [use Expo CLI on `main`](https://github.com/expo/expo/tree/main/packages/%40expo/cli#contributing).
