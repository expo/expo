...
Before you proceed, ensure you have set up `jest-expo` according to the [Testing with Jest](/develop/testing/) and [`@testing-library/react-native`](https://callstack.github.io/react-native-testing-library/docs/start/quick-start) in your project.

> **Note**: When using Expo Router, do not put your test files inside the **app** directory. All files inside your **app** folder must be either routes or layout files. Instead, use the **\_\_tests\_\_** directory or a separate directory. This approach is explained in [Testing with Jest](/develop/testing/#structure-your-tests).
