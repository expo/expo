...
> **Note**: Since Expo router is a file-based router, do not put your test files inside the **app** directory. Instead, use the **\_\_tests\_\_** directory or a separate directory. This approach is explained in [Testing with Jest](/develop/testing/#structure-your-tests).
