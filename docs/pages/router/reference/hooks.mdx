...
Refer to the [local vs global URL params](/router/reference/url-parameters/#local-vs-global-url-parameters) guide for more info.
...
Returns the URL parameters for the contextually selected route. Refer to the [local versus global URL params](/router/reference/url-parameters/#local-vs-global-url-parameters) guide for more information.
