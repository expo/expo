...
export default function Route() {
  ...
  // Extract the user parameter from the pathname
...
export default function Route() {
  ...
  // Extract the user parameter from the segments
  const user = segments[segments.length - 1]; // Assuming the user parameter is the last segment
...
export default function Route() {
  ...
  // Extract the user parameter from the segments
  const user = segments[1]; // Assuming the structure is ['profile', 'user']
