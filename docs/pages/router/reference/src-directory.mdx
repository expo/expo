...
Update [TypeScript path aliases](/guides/typescript#path-aliases-optional) in the **tsconfig.json** file to point to the **src** directory instead of the root directory. If you use the default `@/*` alias, set it to **./src/\***:
...
- You may consider updating any [type aliases](/guides/typescript#path-aliases-optional) to point to the **src** directory instead of the root directory.
