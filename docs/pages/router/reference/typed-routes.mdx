...
> Available from Expo SDK 49 and Expo Router v2. Expo Router supports standard TypeScript out of the box. See [TypeScript](/guides/typescript/) guide for more information on how to set it up.
