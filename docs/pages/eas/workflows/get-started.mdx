...
If a job fails, you can [re-run the workflow from its failed jobs](/eas/workflows/manage-workflow-runs/#re-run-from-failed-jobs) without repeating successful work.
