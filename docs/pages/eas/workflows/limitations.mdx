...
An active GitHub connection is required to run workflows. This means you need to have your project connected to GitHub and maintain an active connection to use EAS Workflows features. We're actively working on removing this limitation.
