...
| ------------ | ---------------- | ------------------------ | --------- | ------------------------------------ |
| macos-medium | 5                | 20                       | 110       | Runs iOS jobs, including simulators. |
| macos-large  | 10               | 40                       | 110       | Runs iOS jobs, including simulators. |
...
Resolves the Apple team ID from the credentials provided in the build profile.
