...
| flow_path                    | string or string[]                                    | Required. The path to the Maestro flow file(s) to run.                                                                                                                                                                                                                                                                                                                                                                                |
...
| reuse_devices                | boolean                                               | Optional. Reuse a single set of devices for all the tests. If false, each flow in `flow_path` will be run on a clean device. Disabling this is very experimental and some features may not work. Defaults to true.                                                                                                                                                                                                                    |
