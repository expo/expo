...
| Parameter               | Type    | Description                                                                                                 |
| ----------------------- | ------- | ----------------------------------------------------------------------------------------------------------- |
| unstable_skip_cng_check | boolean | Optional. Whether to skip the check for Continuous Native Generation (CNG) compatibility. Default: `false`. |
...
| js_bundle_only      | boolean | Optional. Whether to only repack the JavaScript bundle. Defaults to false, meaning the entire app metadata will be updated.                 |
| message             | string  | Optional. Custom message attached to the build. Corresponds to the `--message` flag when running `eas build`.                               |
