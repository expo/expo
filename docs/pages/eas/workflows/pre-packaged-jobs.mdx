...
<Prerequisites>
  <Requirement title="CI/CD submission configuration">
    ...
    Play Store CI/CD submission guide](/submit/android/#automate-with-eas-workflows) and [Apple App
    Store CI/CD submission guide](/submit/ios/#automate-with-eas-workflows) for more information.
  </Requirement>
</Prerequisites>
...
Distribute iOS builds to [TestFlight](/submit/testflight/) internal and external testing groups. This is an alternative to the iOS submit job for when you need more advanced TestFlight features. If you need to control test groups, changelog, or Beta App Review submission, use the `testflight` job instead of submit.
...
<Prerequisites>
  <Requirement title="An iOS store build and Apple Developer account">
    ...
    guide](/submit/ios/#automate-with-eas-workflows) for more information.
  </Requirement>
</Prerequisites>
