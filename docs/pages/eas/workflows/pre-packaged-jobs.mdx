...
<Prerequisites>
  <Requirement title="CI/CD submission configuration">
    ...
    Play Store submission guide](/submit/android/#automate-with-eas-workflows) and [Apple App Store
    submission guide](/submit/ios/#automate-with-eas-workflows) for more information.
  </Requirement>
</Prerequisites>
