...
| deploy_first_alias_url | string | URL of the first alias of the deployment (e.g. `https://account-project--alias.expo.app`).                                                      |
| deploy_deployment_url  | string | Unique URL to the deployment. (e.g. `https://account-project--uniqueid.expo.app`)                                                               |
| deploy_identifier      | string | Identifier of the deployment.                                                                                                                   |
| deploy_dashboard_url   | string | URL to the deployment dashboard. (e.g. `https://expo.dev/projects/[project]/hosting/deployments`)                                               |
