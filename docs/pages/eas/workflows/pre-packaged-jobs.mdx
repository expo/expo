...
jobs:
  submit_to_store:
    ...
    params:
      ...
      profile: string # optional, default: production
      groups: string[] # (iOS only) optional, array of TestFlight internal group names to add the build to (only affects iOS submissions; for Android, this param is ignored)
```
...
| groups    | string[] | Optional. Array of TestFlight internal group names to add the build to (only affects iOS submissions; for Android, this param is ignored). |
