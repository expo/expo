...
<Prerequisites>
  ...
  <Requirement title="Create new development builds">
    After you've configured your project, create new [development builds](/develop/development-builds/introduction/?buildenv=build-with-eas#how-would-you-like-to-build-your-development-build) for each platform.
  </Requirement>
</Prerequisites>
