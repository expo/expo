...
<BoxLink title="EAS Metadata (Beta)" description="Upload all app store information required to get your app published. Learn more." href="/eas/metadata/" Icon={EasMetadataIcon} />
