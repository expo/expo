...
For complete steps to start using EAS Metadata, see [Get started with EAS Metadata](/eas/metadata/getting-started/).
...
## Why teams use EAS Metadata

EAS Metadata helps teams to:

- Manage app store information programmatically
- Avoid navigating complex app store dashboard forms
- Catch metadata issues before app store review
- Collaborate with team members on store presence updates
- Update app descriptions, keywords, or release notes from the command line

## When to use EAS Metadata

EAS Metadata is not needed when:

- You need to manage Google Play Store listings (only Apple App Store is supported yet)
- You need to upload screenshots

In these cases, use the app store dashboards directly.

## Frequently asked questions (FAQ)

<Collapsible summary="Does EAS Metadata support Google Play Store?">
