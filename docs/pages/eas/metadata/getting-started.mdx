...
When you are satisfied with the **store.config.json** settings, you can send it to the app stores. To push the store config to the app stores, run the following command:
