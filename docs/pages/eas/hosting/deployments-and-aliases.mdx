...
In the following example, `test` is selected as the preview subdomain name:

- `https://test--or1170q9ix.expo.app/` : Preview URL, which is unique and where your deployment is available.
