...
> **info** This page is for EAS Hosting specific details about API routes. For general documentation about the topic, see the [API routes](/router/server/api-routes/) documentation under Expo Router.
