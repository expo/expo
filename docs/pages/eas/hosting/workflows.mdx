...
To automatically deploy a preview of your website whenever a pull request is opened or updated, add the following file to **.eas/workflows/pr-preview.yml**:
...
This workflow will deploy a preview of your website for every pull request without promoting it to production. The preview URL will be available in the workflow run details, making it easy to review changes before merging.
