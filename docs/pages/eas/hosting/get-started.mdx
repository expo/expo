...
- `static`: Exports your Expo app to a [statically generated web app](/router/server/static-rendering/)
- `server`: Supports [server functions](/guides/server-components/#react-server-functions) and [API routes](/router/server/api-routes/) as well as static pages for your app
