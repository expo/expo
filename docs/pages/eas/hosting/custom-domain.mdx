...
The custom domain will always load the production deployment. Therefore, in order to add a custom doamin to your project, you will need a deployment that's been promoted to production first.
