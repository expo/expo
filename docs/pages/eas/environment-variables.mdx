...
See the [Environment variables in EAS tutorial](/tutorial/environment-variables) for a step-by-step practical guide on how to use EAS environment variables in real world scenario.
