...
See the [Environment variables in EAS tutorial](/tutorial/environment-variables) for a step-by-step guide on how to use EAS environment variables in a real world scenario.
