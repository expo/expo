...
> **info** You can attach app-specific params (for example, user cohort or tenant) to the TTI event. See [Custom event params](/eas/observe/reference/metrics/#custom-event-params).
