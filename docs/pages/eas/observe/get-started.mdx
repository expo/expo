...
Wrap your root layout with `AppMetricsRoot`. This higher-order component (HOC) automatically measures [Time to First Render (TTFR)](/eas/observe/reference/metrics/#time-to-first-render) for you.
