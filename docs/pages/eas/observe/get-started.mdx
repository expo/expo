...
<Prerequisites numberOfRequirements={4}>
  <Requirement number={1} title="Access to the Expo Observe preview">
  ...
  <Requirement number={4} title="An EAS project">
