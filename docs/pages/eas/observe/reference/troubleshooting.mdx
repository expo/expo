...
description: Solutions for common EAS Observe issues and a migration guide from expo-eas-observe.
---
...
If you were previously using `expo-eas-observe`, follow these steps to migrate to `expo-observe`.
