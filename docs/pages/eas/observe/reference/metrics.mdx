...
**What it measures:** Unlike a cold launch, the app process already exists. The OS just brings it to the foreground and recreates the view hierarchy. Most native resources and services are already in memory, so this type of launch is significantly faster.
