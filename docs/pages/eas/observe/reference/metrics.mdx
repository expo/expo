...
Wrap your root layout with `AppMetricsRoot`. You can also call `AppMetrics.markFirstRender()` manually if needed.

</Tab>

<Tab label="SDK 56">

Wrap your root layout with `ObserveRoot`. You can also call `AppMetrics.markFirstRender()` manually if needed.
