...
This metric is collected automatically when you wrap your root layout with `ObserveRoot` (see [Get started](/eas/observe/get-started/)). You can also call `AppMetrics.markFirstRender()` manually if needed.
