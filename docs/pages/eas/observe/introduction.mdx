...
**Native crashes**: On SDK 58 and later, EAS Observe records native crashes on Android and iOS and shows them in the dashboard alongside JavaScript errors. Native stack traces are not symbolicated in the dashboard. See [Error reporting](/eas/observe/errors/) for details.
