...
- **Errors** (in preview): JavaScript errors recorded by the app on SDK 57 and later, and native crashes with `expo-observe` 57.0.21 and later. See [Error reporting](/eas/observe/errors/) for details.
