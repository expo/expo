...
- **Errors** (in preview, requires SDK 57 and later): JavaScript errors and native crashes recorded by the app. See [Error reporting](/eas/observe/errors/) for details.
