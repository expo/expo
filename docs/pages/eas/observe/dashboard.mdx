...
The Observe dashboard gives you a visual overview of your app's performance metrics. In the [EAS dashboard](https://expo.dev), open your project and select **Observe** from the navigation menu.
