...
The Observe dashboard gives you a visual overview of your app's performance metrics. Navigate to it from your project page in the EAS dashboard, or go directly to:

```text
https://expo.dev/accounts/[accountName]/projects/[projectName]/observe
```
