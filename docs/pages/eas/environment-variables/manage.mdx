...
You can also use EAS CLI to manage them.

<Terminal
  cmd={[
    '# To create a new environment variable',
    '$ eas env:create --name VARIABLE_NAME --value VARIABLE_VALUE --environment ENVIRONMENT --visibility VISIBILITY',
    '',
    '# To update an existing environment variable',
    '$ eas env:update --name VARIABLE_NAME --value VARIABLE_VALUE --environment ENVIRONMENT --visibility VISIBILITY',
    '',
