...
> **important** Creating custom environments is available for [Enterprise and production](/billing/plans/#plans) plans.
...
- In your project, navigate to the **Project settings** > [**Environment variables**](https://expo.dev/accounts/[account]/projects/[project]/environment-variables) and then click on the **Add Variables** button.
- Under **Environments**, click the **plus (+) icon** to enter a name for a custom environment.

<ContentSpotlight
  alt="Create a custom environment in an EAS project dashboard"
