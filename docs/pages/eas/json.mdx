...
**eas.json** is the configuration file for EAS CLI and services. It is located at the root of a project next to the **package.json**. You can find the complete reference of all available schema properties for [EAS Build](/build/introduction) (`build`) and [EAS Submit](/submit/introduction) (`submit`) on this page.
