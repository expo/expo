...
The **Workflows** tab shows how your [EAS Workflows](/eas/workflows/introduction/) are doing over time: how often they run, how often they succeed, and which workflows fail most. Data appears automatically as your workflows run — there's nothing to install. Open your project in the EAS dashboard, select **Insights** from the navigation menu, and then select the **Workflows** tab.
...
Export the workflow runs that match your current filters and time range as CSV or NDJSON for further analysis.
