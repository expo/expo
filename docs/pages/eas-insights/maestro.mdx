...
The **Maestro** tab surfaces results from the [Maestro](https://maestro.dev/) end-to-end (E2E) tests you run in EAS Workflows with the [`maestro` job](/eas/workflows/pre-packaged-jobs/#maestro). It helps you spot which flows fail or flake the most so you can keep your test suite healthy. Open your project in the EAS dashboard, select **Insights** from the navigation menu, and then select the **Maestro** tab.
...
<ContentSpotlight
  ...
  src="/static/images/eas-insights/insights-maestro-light.png"
  darkSrc="/static/images/eas-insights/insights-maestro-dark.png"
/>
...
<ContentSpotlight
  ...
  src="/static/images/eas-insights/insights-maestro-flow-light.png"
  darkSrc="/static/images/eas-insights/insights-maestro-flow-dark.png"
/>
