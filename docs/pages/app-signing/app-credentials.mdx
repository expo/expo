...
You can use `eas build:resign` to codesign an existing **.ipa** for iOS to a new adhoc provisioning profile. This helps reduce time when distributing internally, for example, when you have multiple test iOS devices or want to share a build with your team members.
