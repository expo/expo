...
- <Highlight isBlue>**Write native code or modify native project configuration**</Highlight>: This
  includes writing native code directly or modifying native code configuration. You need access to
  the native code project directories to make these changes. You can create a development build
  using EAS or locally.
