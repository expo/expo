...
3. **Drive the device.** Use [agent-device](/agents/agent-device/), [Argent](/agents/argent/), Appium, or the iOS browser preview.
...
| Programmatic control with Appium                             | <YesIcon />  |
