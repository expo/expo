...
description: Construct an authenticated expo.dev URL that creates an EAS Simulator session and opens its fullscreen browser preview from an EAS Build, build fingerprint, or application archive.
---
