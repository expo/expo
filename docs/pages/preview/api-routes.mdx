...
The **legacy** version of the `vercel.json` needs a `@vercel/static-build` option to publish our public assets
in `dist/`.
...
and handles our public files in `dist/` automatically.
