...
> **info** You can find more information about using icons in your Expo project in our [Icons guide](/guides/icons/).
...
> **info** [icons.expo.fyi](https://icons.expo.fyi) is a great resource for finding all of the icons available in the `@expo/vector-icons` package.
...
> **info** This pattern is referred to as a [controlled component](https://reactjs.org/docs/forms.html#controlled-components).
