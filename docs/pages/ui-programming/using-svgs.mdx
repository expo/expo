---
title: Use SVGs
description: Learn how to create and use SVGs in an Expo project.
---
...
In Expo SDK 50, you can use [SVG Modules](/versions/latest/sdk/svg#svg-modules/) to import SVG files directly into your project. This is the recommended way to use SVGs in Expo projects.

```js
/* @info SVG files with the <b>.module.svg</b> extension can be imported as React components */
...
<Collapsible summary={<>SDK 49 and lower</>}>

For projects older than SDK 50, you can use [React Native SVG transformer](https://github.com/kristerkari/react-native-svg-transformer) which works similarly but disables the ability to use SVG files as assets too.
...
```javascript
/* @info SVG filenames can be anything with <b>react-native-svg-transformer</b> because they can only be React components. */
