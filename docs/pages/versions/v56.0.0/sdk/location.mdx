...
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-56/packages/expo-location'
...
With Device Hub open, go to **Device** > **Location** and choose any option besides **None**. On Xcode 26, the Simulator app has this under **Features** > **Location**.

<ContentSpotlight
  alt="Device menu in Device Hub with the Location submenu open."
  src="/static/images/sdk/location/device-hub-location.webp"
