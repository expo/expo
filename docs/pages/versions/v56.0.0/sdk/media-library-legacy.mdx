...
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-56/packages/expo-media-library/src/legacy'
...
This page documents the legacy media library API. Import it from `expo-media-library/legacy`. The root `expo-media-library` import exposes the class-based API.
