...
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-56/packages/expo-contacts/src/legacy'
...
This page documents the legacy contacts API. Import it from `expo-contacts/legacy`. The root `expo-contacts` import exposes the class-based API.
