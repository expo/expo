...
> **warning** **Deprecated** Use [**expo-splash-screen**](/versions/latest/sdk/splash-screen/#usage) instead (`SplashScreen.preventAutoHideAsync()` and `SplashScreen.hideAsync()`).
