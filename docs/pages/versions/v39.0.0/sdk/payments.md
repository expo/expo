---
title: Payments
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-39/packages/expo-payments-stripe'
---

import InstallSection from '~/components/plugins/InstallSection';
import PlatformsSection from '~/components/plugins/PlatformsSection';

> 🚨 On iOS, the Payments module is currently only supported the [bare workflow](/workflow/customizing/).
...
> 💡 If you are using Expo client then the setup has already been done for you.
