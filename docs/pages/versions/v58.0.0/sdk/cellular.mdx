...
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-58/packages/expo-cellular'
...
`expo-cellular` provides information about the user's cellular service provider, such as its unique identifier and cellular connection type.
