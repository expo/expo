...
<ComponentExample
  title="ScrollViewHiddenIndicatorsExample.tsx"
  src="/static/images/expo-ui/examples/scrollview-hidden-indicators-ios-light.webp"
  darkSrc="/static/images/expo-ui/examples/scrollview-hidden-indicators-ios-dark.webp"
  alt="A vertical list of numbered items with no scroll indicator on the right edge">
...
<ComponentExample
  title="ScrollViewUnclippedExample.tsx"
  src="/static/images/expo-ui/examples/scrollview-unclipped-ios-light.webp"
  darkSrc="/static/images/expo-ui/examples/scrollview-unclipped-ios-dark.webp"
  alt="A horizontal row of coloured squares whose shadows extend past the scroll bounds">
