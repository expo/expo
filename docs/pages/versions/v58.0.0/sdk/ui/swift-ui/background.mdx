...
> **info** To fill a view with a color, material, or gradient, use the [`background`](modifiers/#backgroundstyle-options) modifier from `@expo/ui/swift-ui/modifiers`.
...
<ComponentExample
  title="BackgroundExample.tsx"
  src="/static/images/expo-ui/examples/background-basic-ios-light.webp"
  darkSrc="/static/images/expo-ui/examples/background-basic-ios-dark.webp"
  alt="A Card title label on a light blue rounded rectangle background">
...
<ComponentExample
  title="BackgroundAlignmentExample.tsx"
  src="/static/images/expo-ui/examples/background-alignment-ios-light.webp"
  darkSrc="/static/images/expo-ui/examples/background-alignment-ios-dark.webp"
  alt="A label with a blue bar aligned to the bottom edge of its background">
...
<APISection
  packageName="expo-ui/swift-ui/background"
  apiName="Background"
/>
