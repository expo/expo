...
<ComponentExample
  title="BottomSheetContentPaddingExample.tsx"
  android={{
    src: '/static/images/expo-ui/examples/universal-bottomsheet-content-padding-android-light.webp',
    darkSrc: '/static/images/expo-ui/examples/universal-bottomsheet-content-padding-android-dark.webp',
    alt: 'A bottom sheet whose blue banner reaches the sheet edge with no content padding',
  }}
  ios={{
    src: '/static/images/expo-ui/examples/universal-bottomsheet-content-padding-ios-light.webp',
    darkSrc: '/static/images/expo-ui/examples/universal-bottomsheet-content-padding-ios-dark.webp',
    alt: 'A bottom sheet whose blue banner reaches the sheet edge with no content padding',
  }}>
...
<ComponentExample
  ...
  android={{
    src: '/static/images/expo-ui/examples/universal-bottomsheet-scrollable-android-light.webp',
    darkSrc: '/static/images/expo-ui/examples/universal-bottomsheet-scrollable-android-dark.webp',
    alt: 'A half-height sheet holding a scrollable list of items',
  }}
  ios={{
    src: '/static/images/expo-ui/examples/universal-bottomsheet-scrollable-ios-light.webp',
    darkSrc: '/static/images/expo-ui/examples/universal-bottomsheet-scrollable-ios-dark.webp',
    alt: 'A half-height sheet holding a scrollable list of items',
  }}>
