...
<ComponentExample
  ...
  src="/static/images/expo-ui/examples/checkbox-basic-android-light.webp"
  darkSrc="/static/images/expo-ui/examples/checkbox-basic-android-dark.webp"
  alt="A checked Material 3 checkbox">
...
<ComponentExample
  ...
  src="/static/images/expo-ui/examples/checkbox-custom-colors-android-light.webp"
  darkSrc="/static/images/expo-ui/examples/checkbox-custom-colors-android-dark.webp"
  alt="A checked checkbox filled purple with a white checkmark">
...
<ComponentExample
  title="SelectAllExample.tsx"
  src="/static/images/expo-ui/examples/checkbox-select-all-android-light.webp"
  darkSrc="/static/images/expo-ui/examples/checkbox-select-all-android-dark.webp"
  alt="A Select all row showing the indeterminate dash above one checked and two unchecked options">
...
<APISection
  packageName="expo-ui/jetpack-compose/checkbox"
  apiName="Checkbox"
/>
