...
export default function BasicSurfaceExample() {
  return (
    <Host matchContents>
      <Surface>
        <Text modifiers={[paddingAll(16)]}>Content on a surface</Text>
      </Surface>
    </Host>
  );
}
...
export default function SurfaceElevationExample() {
  return (
    <Host matchContents>
      <Column verticalArrangement={{ spacedBy: 16 }} modifiers={[paddingAll(16)]}>
...
export default function SurfaceCustomColorsExample() {
  return (
    <Host matchContents>
      <Surface color="#1E3A5F" contentColor="#FFFFFF" tonalElevation={2}>
  ...
  return (
    <Host matchContents>
      <Surface
        ...
        <Text modifiers={[paddingAll(16)]}>Rounded surface with border</Text>
      </Surface>
    </Host>
  );
}
