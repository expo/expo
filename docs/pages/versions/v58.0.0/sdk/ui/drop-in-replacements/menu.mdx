...
<ComponentExample
  title="MenuExample.tsx"
  android={{
    src: '/static/images/expo-ui/examples/community-menu-basic-android-light.webp',
    darkSrc: '/static/images/expo-ui/examples/community-menu-basic-android-dark.webp',
    alt: 'An open menu with an Edit row and a Delete row',
  }}
  ios={{
    src: '/static/images/expo-ui/examples/community-menu-basic-ios-light.webp',
    darkSrc: '/static/images/expo-ui/examples/community-menu-basic-ios-dark.webp',
    alt: 'An open menu with an Edit row and a red Delete row',
  }}>
...
<ComponentExample
  title="LongPressMenuExample.tsx"
  android={{
    src: '/static/images/expo-ui/examples/community-menu-long-press-android-light.webp',
    darkSrc: '/static/images/expo-ui/examples/community-menu-long-press-android-dark.webp',
    alt: 'An open menu with Copy and Share rows',
  }}
  ios={{
    src: '/static/images/expo-ui/examples/community-menu-long-press-ios-light.webp',
    darkSrc: '/static/images/expo-ui/examples/community-menu-long-press-ios-dark.webp',
    alt: 'An open context menu with Copy and Share rows',
  }}>
...
<ComponentExample
  title="SubmenuExample.tsx"
  android={{
    src: '/static/images/expo-ui/examples/community-menu-submenu-android-light.webp',
    darkSrc: '/static/images/expo-ui/examples/community-menu-submenu-android-dark.webp',
    alt: 'An open menu with the Sort by submenu expanded',
  }}
  ios={{
    src: '/static/images/expo-ui/examples/community-menu-submenu-ios-light.webp',
    darkSrc: '/static/images/expo-ui/examples/community-menu-submenu-ios-dark.webp',
    alt: 'An open menu with the Sort by submenu expanded',
  }}>
...
<ComponentExample
  title="ToggleMenuExample.tsx"
  android={{
    src: '/static/images/expo-ui/examples/community-menu-toggle-android-light.webp',
    darkSrc: '/static/images/expo-ui/examples/community-menu-toggle-android-dark.webp',
    alt: 'An open menu with a checkmark next to Pin to top',
  }}
  ios={{
    src: '/static/images/expo-ui/examples/community-menu-toggle-ios-light.webp',
    darkSrc: '/static/images/expo-ui/examples/community-menu-toggle-ios-dark.webp',
    alt: 'An open menu with a checkmark next to Pin to top',
  }}>
