...
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-58/packages/expo-document-picker'
  ...
  properties={[
    {
      ...
      platform: 'ios',
      description:
        'Sets the iOS `com.apple.developer.icloud-container-environment` entitlement used for AdHoc iOS builds. Possible values: `Development`, `Production`. See [eas-cli issue #693 on internal distribution builds](https://github.com/expo/eas-cli/issues/693).',
      default: 'undefined',
    },
    {
