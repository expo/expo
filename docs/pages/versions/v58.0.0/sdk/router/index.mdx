...
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-58/packages/expo-router'
...
<ConfigPluginProperties
  properties={[
    ...
    },
    {
      name: 'asyncRoutes',
      description:
        'Enable async routes (lazy loading). In SDK 58 and later, this is enabled by default on web in development and production, and disabled by default on native. Can be a boolean, a string (`"development"` or `"production"`), or an object with platform-specific values (`{ android, ios, web, default }`). Explicit platform values take precedence over `default`. Production async routes are web-only.',
      default: '{ web: true }',
      experimental: true,
    },
    {
    ...
    },
    {
      ...
      description:
        'No longer required as of SDK 58 and has no effect. Remove this option from your app config.',
      default: 'false',
      deprecated: true,
    },
    {
...
<BoxLink title="Router 101" Icon={RouterLogo} href="/router/basics/core-concepts/" />
