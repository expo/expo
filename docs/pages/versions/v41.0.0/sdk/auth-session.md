---
title: AuthSession
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-41/packages/expo-auth-session'
---
...
| Name          | Type       | Description                                                                | Default         |
| ------------- | ---------- | -------------------------------------------------------------------------- | --------------- |
| useProxy      | `?boolean` | Should use `auth.expo.dev` proxy for redirecting requests                   | `false`         |
