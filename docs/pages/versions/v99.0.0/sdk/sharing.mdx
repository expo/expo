...
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-99/packages/expo-sharing'
...
> **important** **Note**: This functionality is currently [experimental](/more/release-statuses/#experimental). On iOS the share extension opens the main target, instead of processing the share in a sharing `ViewController`, which is not officially supported by Apple and may stop working in a future iOS release.
