...
const STORIES = [
  { id: '1', user: 'Your Story', img: 'https://i.pravatar.cc/150?img=3' },
  { id: '2', user: 'coding_ninja', img: 'https://i.pravatar.cc/150?img=12' },
  { id: '3', user: 'react_dev', img: 'https://i.pravatar.cc/150?img=8' },
  { id: '4', user: 'design_pro', img: 'https://i.pravatar.cc/150?img=11' },
];

const POSTS_DATA = [
  {
    id: '1',
    user: 'mohammad_hussain',
    avatar: 'https://i.pravatar.cc/150?img=1',
    image: 'https://picsum.photos/id/237/600/600',
    likes: 452,
    caption: 'Building something from scratch is the best feeling! 🚀 #coding',
    time: '2 HOURS AGO'
  },
  {
    id: '2',
    ...
    likes: 1205,
    caption: 'Clean code is a myth, but we try anyway. 💻',
    time: '5 HOURS AGO'
  },
];
...
const Header = () => (
  <header className="top-bar">
    ...
    <div className="header-icons">
      ...
      <button className="top-icon">❤️</button>
      <button className="top-icon">💬</button>
    </div>
  </header>
);
    ...
    {STORIES.map(story => (
      <div key={story.id} className="story-circle">
        <div className="story-gradient">
           <img src={story.img} alt={story.user} className="story-image" />
        </div>
...
const Post = ({ item }) => {
  ...
  // Double Click handle karne ke liye function
  const handleDoubleClick = () => {
    setIsLiked(true);
    setShowHeart(true);
    // 1 second baad heart gayab ho jaye
    ...
    <article className="post-card">
      <div className="post-header">
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <span className="username-text">{item.user}</span>
        </div>
        <button className="more-btn">•••</button>
      </div>

      {/* Image Section with Heart Animation */}
      <div className="image-container" onDoubleClick={handleDoubleClick}>
        <img src={item.image} alt="post" className="main-image" />
        {showHeart && <div className="overlay-heart">❤️</div>}
      </div>

      <div className="action-row">
        <button onClick={() => setIsLiked(!isLiked)} className="action-btn">
          <span style={{ fontSize: '26px', color: isLiked ? '#ff3040' : '#262626' }}>
            {isLiked ? '❤️' : '♡'}
          </span>
        </button>
      ...
      <div className="details-section">
        <p className="likes-text">{isLiked ? item.likes + 1 : item.likes} likes</p>
    ...
    <div className="container">
      ...
      <main className="feed">
        ...
        <div className="posts-list">
          {POSTS_DATA.map(post => <Post key={post.id} item={post} />)}
        </div>
      </main>
    </div>
  );
