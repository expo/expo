...
If you're not using Continuous Native Generation ([CNG](/workflow/continuous-native-generation/)) or you're using native **android** projects manually, then you need to add following configuration to your native project:
