    ...
    "plugins": [
      [
        "expo-video",
        {
          ...
          "icons": [
            "./local/assets/heart.png",
            "./local/assets/like.png"
          ]
        }
      ]
    ],
...
<ConfigPluginProperties
  properties={[
    ...
    },
    {
      name: 'icons',
      description:
        'Array of local paths to images files that can be used as custom icons for `pictureInPictureActions` and `nowPlayingActions` on Android. 96x96 all-white png with transparency.',
      default: 'undefined',
    },
  ]}
/>
...
The event system is based on the [`EventEmitter`](../sdk/expo/#eventemittertype) class and [hooks](../sdk/expo/#hooks) from the [`expo`](../sdk/expo) package. There are a few ways to listen to events:
