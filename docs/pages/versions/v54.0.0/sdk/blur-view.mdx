...
> **info** `BlurView` on Android is an [experimental](/more/release-statuses/#experimental) feature. To enable it use the [`experimentalBlurMethod`](#experimentalblurmethod) prop.
