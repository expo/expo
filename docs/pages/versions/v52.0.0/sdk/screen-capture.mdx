...
> **important** For testing screen capture functionality: On Android, run `adb shell input keyevent 120` from the terminal to trigger a screenshot on the emulator. On iOS Simulator, you can trigger screenshots using **Device** > **Trigger Screenshot** from the menu bar.
