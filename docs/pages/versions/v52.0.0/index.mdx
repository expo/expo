...
Canary releases represent a snapshot of the state of the `main` branch at the time they are published. Canary package versions include `-canary` in the name, along with the date and commit hash, such as `52.0.0-canary-20240418-8d74597`. To install the latest canary release:
...
<AndroidIOSCompatibilityTable startVersion="52.0.0" endVersion="50.0.0" />
