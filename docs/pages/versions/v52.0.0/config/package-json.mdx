...
The following commands perform a version check for the libraries installed in a project and gives a warning when a library's version is different from the version recommended by Expo:
