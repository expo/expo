---
title: Payments
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-38/packages/expo-payments-stripe'
---
...
The Payments module is currently only supported the bare workflow on iOS. If you have a managed workflow project, you'll need to [move to the bare workflow](../../../workflow/customizing.md) in order to use this module on iOS.
