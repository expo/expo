...
<ConfigPluginProperties
  properties={[
    ...
    },
    {
      name: 'useLibSQL',
      description:
        'Use [libSQL](https://github.com/tursodatabase/libsql) rather than the default SQLite.',
      default: 'false',
    },
    {
...
If you deploy your app on [EAS Hosting](/eas/hosting/introduction/), you can configure the headers in your **app.json**:
...
The `expo-sqlite` library includes a built-in DevTools inspector plugin that is automatically enabled in development — no extra setup needed. It lets you browse tables, view and edit rows, run SQL queries, and export databases directly from your browser. To open it, press <kbd>shift+m</kbd> in the Expo CLI terminal to open the dev tools menu, and then select **Open expo-sqlite** to launch the inspector.
