...
> **info** You can also create custom modifiers that work with any Expo UI component. See the [Extending with SwiftUI](/versions/latest/sdk/ui/swift-ui/extending/) guide for details.
