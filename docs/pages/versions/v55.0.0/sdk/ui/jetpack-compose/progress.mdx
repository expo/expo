...
```tsx WavyExample.tsx
import { Host, LinearWavyProgressIndicator, CircularWavyProgressIndicator } from '@expo/ui/jetpack-compose';
...
<APISection packageName="expo-ui/jetpack-compose/progress" apiName="LinearProgressIndicator" />
<APISection packageName="expo-ui/jetpack-compose/progress" apiName="CircularProgressIndicator" />
<APISection packageName="expo-ui/jetpack-compose/progress" apiName="LinearWavyProgressIndicator" />
<APISection packageName="expo-ui/jetpack-compose/progress" apiName="CircularWavyProgressIndicator" />
