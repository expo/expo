...
This module is currently only available in the [bare](/introduction/managed-vs-bare.mdx#bare-workflow) workflow.

You must ensure that you have [installed and configured Expo modules](/bare/installing-expo-modules.mdx) before continuing.
