...
> **Note**: For Android users, the Expo Go app does not have the required `WRITE_CONTACTS` permission to write to Contacts. In order to do this, you must build a [standalone app](/archive/classic-updates/building-standalone-apps.mdx) and add permission through there.
