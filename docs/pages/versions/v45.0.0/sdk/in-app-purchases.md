...
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-45/packages/expo-in-app-purchases'
...
On Android, you must first create an entry for your app and upload a release APK in the [Google Play Console](https://developer.android.com/distribute/console/). Then, configure in-app purchases and details under **Monetise > Products > In-app products**.
