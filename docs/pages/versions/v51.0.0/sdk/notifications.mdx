...
> **Note**: `expo-notifications` functionality is not fully supported in Expo Go. We recommend you instead use a [development build](/develop/development-builds/introduction/) to avoid limitations.
