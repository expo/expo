...
Learn how to configure notifications with the [app manifest `notification` property](../config/app.mdx#notification).
...
<ImageSpotlight
  ...
  style={{ maxWidth: 800 }}
  alt="image of notification categories on iOS and Android"
/>
