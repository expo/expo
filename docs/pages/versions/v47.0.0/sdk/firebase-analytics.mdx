...
You can track the screens your users are interacting with by integrating our recommend navigation library: `react-navigation`. To see an example of how this works, see [Screen tracking](https://reactnavigation.org/docs/screen-tracking/) in React Navigation documentation.
