...
> **warning** **Deprecated:** Expo proxy service is deprecated and will be removed in the future. See [blog post](https://blog.expo.dev/security-advisory-for-developers-using-authsessions-useproxy-options-and-auth-expo-io-e470fe9346df) for more information.
