...
This API is pre-installed in [managed](../../../introduction/managed-vs-bare.mdx#managed-workflow) apps. It is not available for [bare](../../../introduction/managed-vs-bare.mdx#bare-workflow) React Native apps.
