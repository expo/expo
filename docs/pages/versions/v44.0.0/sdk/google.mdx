---
title: Google
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-44/packages/expo-google-app-auth'
---

import PlatformsSection from '~/components/plugins/PlatformsSection';
import { InlineCode } from '~/components/base/code';

> ⚠️ This package is deprecated in favor of the Google [**AuthSession**](auth-session.mdx) provider. Check out the [Google authentication guides](/guides/authentication#google) to learn how to migrate your app today.
...
**Note on `redirectUrl`**:
If you choose to provide your own `redirectUrl`, it should start with the value returned by [`AppAuth.OAuthRedirect`](../sdk/app-auth.mdx#appauthoauthredirect). This way, the method will function correctly and consistently whether you are testing in Expo Go or as a standalone app.
...
[managed-workflow]: ../../../introduction/managed-vs-bare.mdx#managed-workflow
[bare-workflow]: ../../../introduction/managed-vs-bare.mdx#bare-workflow
