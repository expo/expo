...
In managed apps, scanning barcodes with the camera requires the [`Permission.CAMERA`](permissions.mdx#permissionscamera) permission. See the [usage example](#usage) below.
