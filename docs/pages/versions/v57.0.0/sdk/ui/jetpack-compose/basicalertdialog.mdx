...
<ComponentExample
  ...
  src="/static/images/expo-ui/examples/basicalertdialog-custom-content-android-light.webp"
  darkSrc="/static/images/expo-ui/examples/basicalertdialog-custom-content-android-dark.webp"
  alt="A dialog holding custom content: supportive text with a Confirm button at the trailing edge">
...
<APISection
  packageName="expo-ui/jetpack-compose/basicalertdialog"
  apiName="BasicAlertDialog"
/>
