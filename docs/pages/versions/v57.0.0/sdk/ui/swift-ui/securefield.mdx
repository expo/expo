...
export default function BasicSecureFieldExample() {
  ...
  // A secure field stretches to the width it is given, so it collapses under it.
  return (
    <Host style={{ flex: 1 }}>
...
<ComponentExample
  ...
  alt="An empty secure field showing the placeholder Password, with its submit label set on the keyboard">
