...
<ComponentExample
  ...
  src="/static/images/expo-ui/examples/text-custom-font-ios-light.webp"
  darkSrc="/static/images/expo-ui/examples/text-custom-font-ios-dark.webp"
  alt="Two lines of text, Inter Bold above Inter Regular.">
