...
<VideoBoxLink
  videoId="3r_OHePTCcI"
  title="Watch: How to build an iOS widget"
  description="Build a native iOS home screen widget in TypeScript with expo-widgets."
/>
...
Initialize the widget from your app with `CounterWidget.updateSnapshot({ count: 0 })`.
