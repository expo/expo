---
title: Payments
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-40/packages/expo-payments-stripe'
---

import InstallSection from '~/components/plugins/InstallSection';
import PlatformsSection from '~/components/plugins/PlatformsSection';

> 🚨 On iOS, the Payments module is currently only supported in the [bare workflow](https://docs.expo.io/workflow/customizing/).
