...
> **Note**: In order to use Live Reload, your root component must be a **class** component, rather than a functional component. You can read about their differences [here](https://reactjs.org/docs/components-and-props.html#function-and-class-components).
