...
Expo's Metro config injects build-settings that can be used in the client bundle via environment variables. All variables will be inlined and cannot be used dynamically, i.e. `process.env["EXPO_BASE_URL"]` won't work.
