...
> **warning** CSS support was enabled by default in SDK 50. If using SDK 49, you will need to set `isCSSEnabled` to `true` in the Metro config.
...
CSS support can be toggled by setting `isCSSEnabled` in the Metro config.
