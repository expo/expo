...
A number of React libraries shipped the Webpack `/* webpackIgnore: true */` comment for similar behavior. To bridge support, we've also added support for this comment but you should use the Metro equivalent in your app.
