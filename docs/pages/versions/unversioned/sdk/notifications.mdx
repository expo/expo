...
<ConfigPluginProperties
  properties={[
    ...
    },
    {
      ...
      platform: 'android',
      description:
        "Whether remote notification images should use Android's `NotificationCompat.BigPictureStyle` when the notification is expanded. When disabled, the image is shown only as the notification's large icon.",
    },
    {
      name: 'sounds',
      description:
