...
<ConfigPluginProperties
  properties={[
    ...
    },
    {
      ...
      platform: 'ios',
      description:
        "Sets the iOS [APS (Apple Push Services) environment](https://developer.apple.com/documentation/bundleresources/entitlements/aps-environment) entitlement. Possible values: `'development'` or `'production'`.",
    },
  ]}
/>
...
> By default, the iOS APNs entitlement is set to `'development'`. You can change this using the [`mode`](#configurable-properties) property. Xcode automatically changes this to `'production'` in the archive generated by a release build.
