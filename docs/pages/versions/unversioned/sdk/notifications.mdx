...
This page is a reference documentation for the package. There are also comprehensive [guides available](/push-notifications/overview/).
...
Follow the setup guide [here](/push-notifications/push-notifications-setup/#get-credentials-for-development-builds).
...
Several different listeners are exposed, and documented in [Push Notification Behaviors](/push-notifications/what-you-need-to-know/#push-notification-behaviors) section.
