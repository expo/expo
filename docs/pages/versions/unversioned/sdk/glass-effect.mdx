---
title: GlassEffect
description: React components that render a glass effect using iOS’s native UIVisualEffectView.
...
> **info** `GlassView` is only available on iOS 26+. It will fallback to regular View on unsupported platforms.
