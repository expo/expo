---
title: GlassEffect
description: React components that create glass effect using iOS's visual effect view.
...
React components that create glass effect using iOS's native visual effect view. A visual effect that renders a glass material.

> **info** `GlassView` is only available on iOS 26+ and requires native iOS visual effect APIs.
...
This component requires iOS 26+ and uses native iOS [UIVisualEffectView](https://developer.apple.com/documentation/uikit/uivisualeffectview).
