  ...
  properties={[
    ...
    },
    {
    ...
    },
     {
      ...
      platform: 'ios',
      description:
        'Prevents the automatic limited access alert from being shown when the user has limited access to the photo library. Useful for apps that need to access the limitedphoto library without having iOS forcibly show the alert.',
      default: 'false',
    },
    {
