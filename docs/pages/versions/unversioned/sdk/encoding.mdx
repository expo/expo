...
The `TextEncoder` API is included in the Hermes engine. See the source code here: [facebook/hermes > TextEncoder.cpp](https://github.com/facebook/hermes/blob/9e2bbf8eda15936ee00aee4f8e024ceaa7cd800d/lib/VM/JSLib/TextEncoder.cpp#L1).
