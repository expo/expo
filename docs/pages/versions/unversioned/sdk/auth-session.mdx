...
- See the guide for more info on usage: [Google Authentication](/guides/google-authentication/).
...
- See the guide for more info on usage: [Facebook Authentication](https://docs.expo.dev/guides/facebook-authentication/).
