...
- You may want to only have localized text for some things but not for others things like names. In this case you can define them _once_ in your default language and reuse them with `i18n.fallbacks = true;`.
