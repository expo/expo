...
- You may want to only have localized text for a some things but not others (like names). In that case you can set them _once_ in your default language and reuse them with `i18n.fallbacks = true;`
