...
Projects not using [Expo Prebuild](/workflow/prebuild) (bare workflow) can use the [`uri-scheme` package][n-uri-scheme] to easily add, remove, list, and open your URIs.
