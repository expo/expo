...
> When publishing the app to the Apple App Store, you'll be asked to select the type of encryption algorithm that your app implements under **Export Compliance Information**. If you are using `expo-secure-store`, select **None of the algorithms mentioned above**.
