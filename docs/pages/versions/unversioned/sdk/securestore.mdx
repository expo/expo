...
> While current iOS releases typically allow values well beyond 4 KB, older versions have rejected larger payloads. Always surface native errors when persisting especially large strings so you can adjust behaviour per device.
