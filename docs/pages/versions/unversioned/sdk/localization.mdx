...
Using the popular library [`i18n-js`](https://github.com/fnando/i18n) with `expo-localization` will enable you to create a very accessible experience for users.
