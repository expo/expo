...
<ConfigPluginProperties
  properties={[
    ...
    },
    {
      name: 'supportsRTL',
      description:
        "Whether the app allows right-to-left (RTL) layout. When enabled, the app renders in RTL for RTL device languages, following React Native's `I18nManager`.",
      default: 'true',
    },
    {
      name: 'forcesRTL',
      description:
        'Whether to force right-to-left (RTL) layout regardless of the device language. Useful for testing or for apps localized only for RTL locales.',
      default: 'false',
    },
    {
      name: 'allowDynamicLocaleChangesAndroid',
      description:
        "Whether the app applies per-app language changes without restarting, by adding `locale` and `layoutDirection` to the main activity's `android:configChanges`.",
      default: 'true',
      platform: 'android',
    },
  ]}
