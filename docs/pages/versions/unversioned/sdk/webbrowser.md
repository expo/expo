...
- **options (_object_)** (_optional_) --
  ...
  - **showInAndroidHistory (_optional_) (_boolean_)** -- a boolean determining whether browsed website should be shown as seperate entry in android recents. Default: `false`.
