...
<PlatformSpotlight
  android={{
    ...
    alt: 'The word EXPO filled with a rainbow gradient',
  }}
  ios={{
...
<ComponentExample
  title="MaskedViewExample.tsx"
  android={{
    src: '/static/images/expo-ui/examples/community-maskedview-basic-android-light.webp',
    darkSrc: '/static/images/expo-ui/examples/community-maskedview-basic-android-dark.webp',
    alt: 'The word EXPO filled with a rainbow gradient',
  }}
  ios={{
    src: '/static/images/expo-ui/examples/community-maskedview-basic-ios-light.webp',
    darkSrc: '/static/images/expo-ui/examples/community-maskedview-basic-ios-dark.webp',
    alt: 'The word EXPO filled with a rainbow gradient',
  }}>
...
<ComponentExample
  title="AlphaFadeExample.tsx"
  android={{
    src: '/static/images/expo-ui/examples/community-maskedview-alpha-fade-android-light.webp',
    darkSrc: '/static/images/expo-ui/examples/community-maskedview-alpha-fade-android-dark.webp',
    alt: 'Three color bands fading out from left to right',
  }}
  ios={{
    src: '/static/images/expo-ui/examples/community-maskedview-alpha-fade-ios-light.webp',
    darkSrc: '/static/images/expo-ui/examples/community-maskedview-alpha-fade-ios-dark.webp',
    alt: 'Three color bands fading out from left to right',
  }}>
