...
<ComponentExample
  title="PagerViewExample.tsx"
  android={{
    src: '/static/images/expo-ui/examples/community-pagerview-basic-android-light.webp',
    darkSrc: '/static/images/expo-ui/examples/community-pagerview-basic-android-dark.webp',
    alt: 'The first page of a pager above a Go to page 2 button',
  }}
  ios={{
    src: '/static/images/expo-ui/examples/community-pagerview-basic-ios-light.webp',
    darkSrc: '/static/images/expo-ui/examples/community-pagerview-basic-ios-dark.webp',
    alt: 'The first page of a pager above a Go to page 2 button',
  }}>
