...
export default function SimpleMenuExample() {
  // `matchContents` sizes the host to the trigger instead of filling the space.
  // The trigger then sits at the leading edge.
  return (
    <Host style={{ flex: 1 }}>
      <Menu label="Options">
...
<ComponentExample
  ...
  alt="A menu trigger showing only a gear icon">
