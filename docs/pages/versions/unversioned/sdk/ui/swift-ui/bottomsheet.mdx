...
Use the [`presentationDetents`](/versions/unversioned/sdk/ui/swift-ui/modifiers/#presentationdetentsdetents) modifier on `BottomSheet.Content` to control the available heights.
      ...
      <VStack>
        ...
        <BottomSheet isPresented={isPresented} onIsPresentedChange={setIsPresented}>
          <BottomSheet.Content modifiers={[presentationDetents(['medium', 'large'])]}>
            <Text>This sheet can snap to medium or large heights.</Text>
          </BottomSheet.Content>
        </BottomSheet>
      </VStack>
    </Host>
