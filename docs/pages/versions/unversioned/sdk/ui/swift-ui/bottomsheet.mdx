...
export default function BottomSheetWithScrollableContentExample() {
  ...
  // `matchContents` sizes the host to the anchor instead of filling the space.
  // The anchor then sits at the leading edge.
  return (
    <Host style={{ flex: 1 }}>
      <VStack>
        <BottomSheet
            ...
            <RNHostView>
              <View style={{ padding: 16 }}>
                <FlatList
                  ...
                  renderItem={({ item }) => (
                    <RNText style={{ paddingVertical: 16, color: PlatformColor('label') }}>
                      {item}
                    </RNText>
                  )}
                />
