...
<ComponentExample
  title="PagerExample.tsx"
  src="/static/images/expo-ui/examples/tabview-pager-ios-light.webp"
  darkSrc="/static/images/expo-ui/examples/tabview-pager-ios-dark.webp"
  alt="A teal pager page labeled Page 2, with three dot indicators and the middle dot active">
...
<ComponentExample
  title="ControlledTabViewExample.tsx"
  src="/static/images/expo-ui/examples/tabview-controlled-ios-light.webp"
  darkSrc="/static/images/expo-ui/examples/tabview-controlled-ios-dark.webp"
  alt="A Selected 0 readout and a Go to page 3 button above a purple pager page labeled Page 1">
...
<ComponentExample
  title="PageIndicatorExample.tsx"
  src="/static/images/expo-ui/examples/tabview-page-indicator-ios-light.webp"
  darkSrc="/static/images/expo-ui/examples/tabview-page-indicator-ios-dark.webp"
  alt="A blue pager page labeled Page 1 with three dots inside a translucent pill">
...
<ComponentExample
  title="BottomTabsExample.tsx"
  src="/static/images/expo-ui/examples/tabview-bottom-tabs-ios-light.webp"
  darkSrc="/static/images/expo-ui/examples/tabview-bottom-tabs-ios-dark.webp"
  alt="A blue Inbox page above a tab bar with Inbox, Sent, and Drafts, where Inbox carries a red badge reading 3">
...
<APISection
  packageName="expo-ui/swift-ui/tabview"
  apiName="TabView"
/>
