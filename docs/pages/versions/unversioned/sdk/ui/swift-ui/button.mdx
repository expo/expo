...
<div className="mx-auto max-w-[480px]">
  <Diagram
    source="/static/images/expo-ui/button/ios-light.png"
    darkSource="/static/images/expo-ui/button/ios-dark.png"
    alt="Bordered prominent, bordered, and plain Button styles"
    disableSrcSet
  />
</div>
