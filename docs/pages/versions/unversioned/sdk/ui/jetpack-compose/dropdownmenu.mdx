...
<ComponentExample
  title="ShadowDropdownMenuExample.tsx"
  src="/static/images/expo-ui/examples/dropdownmenu-shadow-android-light.webp"
  darkSrc="/static/images/expo-ui/examples/dropdownmenu-shadow-android-dark.webp"
  alt="A dropdown menu open below a Show menu button with one item and a low elevation shadow">
