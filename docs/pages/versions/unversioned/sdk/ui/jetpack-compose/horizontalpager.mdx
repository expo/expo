...
`HorizontalPager` does not impose its own height — give it one with the [`height`](modifiers/#heightheight) modifier or place it inside a parent with a finite height.
...
<ContentSpotlight
  ...
  alt="HorizontalPager showing the second of three pages with a page indicator below"
/>
