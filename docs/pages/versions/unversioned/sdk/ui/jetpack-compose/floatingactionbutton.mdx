...
export default function FABVariantsExample() {
  return (
    <View style={{ flexDirection: 'row', gap: 16 }}>
      <Host matchContents>
        <SmallFloatingActionButton onPress={() => {}}>
      ...
      <Host matchContents>
        <LargeFloatingActionButton onPress={() => {}}>
...
export default function ExtendedFABExample() {
  ...
  return (
    <Host matchContents>
      <ExtendedFloatingActionButton expanded={expanded} onPress={() => setExpanded(v => !v)}>
...
export default function FABCustomColorExample() {
  return (
    <Host matchContents>
      <ExtendedFloatingActionButton containerColor="#E8DEF8" onPress={() => console.log('pressed')}>
        <ExtendedFloatingActionButton.Icon>
          <Icon source={require('./assets/add.xml')} />
        </ExtendedFloatingActionButton.Icon>
        <ExtendedFloatingActionButton.Text>
