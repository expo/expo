...
<ComponentExample
  title="SnackbarExample.tsx"
  src="/static/images/expo-ui/examples/snackbar-basic-android-light.webp"
  darkSrc="/static/images/expo-ui/examples/snackbar-basic-android-dark.webp"
  alt="A Material 3 snackbar at the bottom of the screen reading 'Item archived' with an Undo action">
...
<ComponentExample
  title="StyledSnackbar.tsx"
  src="/static/images/expo-ui/examples/snackbar-styled-android-light.webp"
  darkSrc="/static/images/expo-ui/examples/snackbar-styled-android-dark.webp"
  alt="A snackbar with a dark navy container, light lavender message reading 'Saved', an Undo action, and a close icon">
...
<APISection
  packageName="expo-ui/jetpack-compose/snackbar"
  apiName="Snackbar"
/>
