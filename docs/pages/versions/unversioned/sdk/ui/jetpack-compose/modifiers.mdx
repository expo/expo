...
<Button
  modifiers={[dropShadow(Shapes.RoundedCorner(24), { radius: 16, spread: 4, color: '#6200EE', offsetY: 8 })]}>
  Drop shadow
</Button>;
```
...
<Box
  modifiers={[
    dropShadow(Shapes.Rectangle, { radius: 0, spread: 0, offsetX: 8, offsetY: 8, color: '#000000' }),
    border(8, '#000000'),
    background('#FFFFFF'),
  ]}
/>;
