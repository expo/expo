...
Modifiers marked with the **Widgets** tag can be used inside [Expo Widgets](/versions/latest/sdk/widgets/). The widget renderer ignores the other modifiers.
...
### `paddingAll(all)`&ensp;<PlatformTags platforms={['expo-widgets']} />
...
### `padding(start, top, end, bottom)`&ensp;<PlatformTags platforms={['expo-widgets']} />
...
### `size(width, height)`&ensp;<PlatformTags platforms={['expo-widgets']} />
...
### `fillMaxSize(fraction?)`&ensp;<PlatformTags platforms={['expo-widgets']} />
...
### `fillMaxWidth(fraction?)`&ensp;<PlatformTags platforms={['expo-widgets']} />
...
### `fillMaxHeight(fraction?)`&ensp;<PlatformTags platforms={['expo-widgets']} />
...
### `width(value)`&ensp;<PlatformTags platforms={['expo-widgets']} />
...
### `height(value)`&ensp;<PlatformTags platforms={['expo-widgets']} />
...
### `wrapContentWidth(alignment?)`&ensp;<PlatformTags platforms={['expo-widgets']} />
...
### `wrapContentHeight(alignment?)`&ensp;<PlatformTags platforms={['expo-widgets']} />
...
### `background(color)`&ensp;<PlatformTags platforms={['expo-widgets']} />
