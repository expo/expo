...
A single-selection input. Declare options as `<Picker.Item label value />` children; the parent `Picker` reads them and renders a platform-appropriate dropdown or rotor.
