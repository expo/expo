...
A platform-native icon. On iOS it renders an [SF Symbol](https://developer.apple.com/sf-symbols/); on Android it renders a Material Symbol XML vector drawable supplied through [`@expo/material-symbols`](https://github.com/expo/expo/tree/main/packages/material-symbols) (other XML vector drawable assets aren't officially supported).
