...
<PlatformSpotlight
  android={{
    ...
    alt: 'Wi-Fi, Bluetooth, mail, and person icons rendered with the Material 3 Icon component',
  }}
  ios={{
    src: '/static/images/expo-ui/icon/ios-light.webp',
    darkSrc: '/static/images/expo-ui/icon/ios-dark.webp',
    alt: 'Wi-Fi, radio waves, mail, and person icons rendered with SF Symbols',
  }}
/>
...
<ComponentExample
  title="IconSelectExample.tsx"
  android={{
    src: '/static/images/expo-ui/examples/universal-icon-select-android-light.webp',
    darkSrc: '/static/images/expo-ui/examples/universal-icon-select-android-dark.webp',
    alt: 'A large orange star drawn as a Material Symbol',
  }}
  ios={{
    src: '/static/images/expo-ui/examples/universal-icon-select-ios-light.webp',
    darkSrc: '/static/images/expo-ui/examples/universal-icon-select-ios-dark.webp',
    alt: 'A large orange star drawn as an SF Symbol',
  }}>
...
<ComponentExample
  title="HoistedIconExample.tsx"
  android={{
    src: '/static/images/expo-ui/examples/universal-icon-hoisted-android-light.webp',
    darkSrc: '/static/images/expo-ui/examples/universal-icon-hoisted-android-dark.webp',
    alt: 'A row of three small gold stars drawn as Material Symbols',
  }}
  ios={{
    src: '/static/images/expo-ui/examples/universal-icon-hoisted-ios-light.webp',
    darkSrc: '/static/images/expo-ui/examples/universal-icon-hoisted-ios-dark.webp',
    alt: 'A row of three small gold stars drawn as SF Symbols',
  }}>
