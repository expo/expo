...
- **1-to-1 mapping**: Components map one to one to their native counterparts. For SwiftUI, browse a catalog such as [Explore SwiftUI](https://exploreswiftui.com/) or the [Libraried app](https://apps.apple.com/us/app/libraried-ui-components/id1642862540), then look up the matching Expo UI component.
