...
> **Info** Currently `expo-image` can be used only with [development builds](/develop/development-builds/create-a-build/), in Expo Go and bare React Native apps with [configured Expo modules](/bare/installing-expo-modules/).
