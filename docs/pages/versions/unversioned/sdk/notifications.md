...
- **Bare:** Apps that are **not** using [Expo Prebuild](/workflow/prebuild) must manually enable the APNS capability by opening the `ios/` directory in Xcode (`xed ios`) then following [this guide](https://help.apple.com/xcode/mac/current/#/dev88ff319e7). If you have trouble setting this up, refer to [this StackOverflow answer](https://stackoverflow.com/a/10791240/1123156). You may also want to try to debug this even further by logging persistent connection debug information as outlined by [this StackOverflow answer](https://stackoverflow.com/a/8036052/1123156).
...
Project's that are **not** using [Expo Prebuild](/workflow/prebuild) (bare) can follow [this guide](https://documentation.onesignal.com/docs/customize-notification-icons) to manually configure Android notification icons in Android Studio.
