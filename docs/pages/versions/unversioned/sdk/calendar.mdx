...
> **warning** **[Deprecated](/more/release-statuses/#deprecated):** The `expo-calendar` library is being replaced by [`expo-calendar/next`](calendar-next.mdx). Migrate to `expo-calendar/next` when possible.
