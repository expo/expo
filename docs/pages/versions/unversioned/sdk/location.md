...
If you don't receive the locations in the emulator, you may have to turn of "Improve Location Accuracy" in Settings - Location in the emulator. This will turn of Wi-Fi location and only use GPS. Then you can manipulate the location with GPS data through the emulator. 
