...
`expo-dev-client` is a library which can be installed in any Expo and React Native project to create a [development build](/workflow/overview/#development-builds).
