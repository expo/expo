...
`expo-dev-client` is a npm library that installed in any Expo and React Native project allows to create a [development build](https://docs.expo.dev/workflow/overview/#development-builds).
...
Adding this library, the app's release builds are not affected other than a few header files.
