    ...
    "plugins": [
      [
        "expo-dev-client",
        {
          ...
          "defaultLaunchURI": "http://localhost:8081"
          "android": {
            "defaultLaunchURI": "http://10.0.0.2:8081"
          }
        }
      ]
    ]
...
<ConfigPluginProperties
  properties={[
    ...
    {
      name: 'defaultLaunchURI',
      description: [
        'Launch directly into this URI instead of navigating to launcher screen.',
        'If `launchMode` is set to `most-recent`, then launcher will use the defaultLauncherURI as a fallback.',
      ].join('\n'),
    },
    {
