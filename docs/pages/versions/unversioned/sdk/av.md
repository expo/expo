...
If precision is important, you can specify the tolerance with which the player will seek according to your needs. However, this will result in an increased delay.
