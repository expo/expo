...
| endDate         | _number_   | Date on which the calendar item should stop recurring specified in Epoch time; overrides `occurrence` if both are specified.                                                                          |                                                                                                                                                                       |
...
| daysOfTheMonth  | _number[]_         | (Optional, iOS only) The days of the month this event occurs on.                                                                                                                              | -31 to 31 (not including 0). Negative indicates a value from the end of the range. This field is only valid for `Calendar.Frequency.Monthly`.                         |
