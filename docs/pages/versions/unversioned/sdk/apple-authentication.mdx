...
| ERR_INVALID_SCOPE           | An invalid [`AppleAuthenticationScope`](#appleauthenticationappleauthenticationscope) was passed in. |
| ERR_REQUEST_CANCELED        | User canceled the authorization attempt.                                                             |
| ERR_REQUEST_FAILED          | The authorization request failed. See the error message for an additional information.               |
