...
The `expo-dev-menu` can be used as a **standalone library** in any Expo project. It is especially useful in [brownfield apps](/versions/unversioned/sdk/brownfield/) that don't need the full `expo-dev-client` launcher interface.
...
For more information, check the [DevClient reference](/versions/latest/sdk/dev-client/).
