...
<SnackInline label="Contacts Manipulations" dependencies={['expo-contacts']}>
...
<SnackInline label="Retreiving contacts" dependencies={['expo-contacts']}>
...
<Collapsible summary="Example Contacts Infinite Scroll">
<SnackInline label="Example Contacts Infinite" dependencies={['expo-contacts']}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={{ padding: 10, borderBottomWidth: 1, borderColor: '#ccc' }}>
            ...
            <Text>{item.phones[0] ? item.phones[0].number : 'No phone number'}</Text>
          </View>
        )}
      />
    </View>
...
<Collapsible summary="Example Edit Contact Form">
<SnackInline label="Example Edit Contact Form" dependencies={['expo-contacts']}>
