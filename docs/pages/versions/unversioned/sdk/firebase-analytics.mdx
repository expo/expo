...
> **Deprecated.** This module will be removed in SDK 49. Check out our [Migration Guide](/guides/migrating-to-react-native-firebase.mdx) for help migrating to [React Native Firebase](https://rnfirebase.io/).
