...
| purchaseState            | _int_  | both       | The state of the purchase              |                                                                                                                                                                                                                                                                                                       |
| purchaseTime                | _int_  | both      | The time the product was purchased, in milliseconds since the epoch (Jan 1, 1970)                  |                                                                                                                                                                                                                                                                                                                                                                    |
| orderId                 | _string_  | both      | A string that uniquely identifies a successful payment transaction.                                  |                                                                                                                                                                                                                                                                                                                                                                    |
| packageName   | _string_ | Android      | The application package from which the purchase originated           |                                                                                                                                                                                                                                                                                                                                                                    |
...
| price                 | _string_  | both      | The price formatted with the local currency symbol. Use this to display the price, not to make calculations.                                                  |                                                                                                                                                                                                                                                                                                                                                                    |
| priceAmountMicros            | _int_  | both       | The price in micro-units, where 1,000,000 micro-units equal one unit of the currency (e.g. one cent for US Dollars). Use this for calculations.              |                                                                                                                                                                                                                                                                                                       |
| priceCurrencyCode                | _string_  | both      | The local currency code (e.g. USD, EUR, etc) from the ISO 4217 code list               |                                                                                                                                                                                                                                                                                                                                                                    |
| type                  | _string_  | both       | The type of the purchase. Note that this is not very accurate on iOS as this data is only available on iOS 11.2 and higher and non-renewable subscriptions return 'inapp'                                      |  `inapp`, `subs`                                                                                                                                                                                          |
| subscriptionPeriod             | _string_ | both   | The length of a subscription period, specified in ISO 8601 format.      | `P0D`, `P6W`, `P3M`, `P6M`, `P1Y`                                                                                                                                                                                                                                                                   