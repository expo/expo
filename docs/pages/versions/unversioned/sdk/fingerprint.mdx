...
If you wish to use `@expo/fingerprint` as a standalone package, you can install it using:
...
<Collapsible summary="Limited support for @expo/config-plugins raw functions">
