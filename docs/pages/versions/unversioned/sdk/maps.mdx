...
- **Google Maps is available on Android only**. While Google provides a Google Maps SDK fore iOS, Expo Maps supports it exclusively on Android. If you want to use Google Maps on iOS, you can look into a using an [alternative library](https://reactnative.directory/) or [writing your own](/modules/overview/).
