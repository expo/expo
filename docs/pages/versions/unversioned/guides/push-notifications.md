...
>
> For [Next.js with Expo for Web](../../guides/using-nextjs), you might need [additional configuration](../../guides/using-nextjs#webpushnotificationssupport) in order for push notifications to work.
