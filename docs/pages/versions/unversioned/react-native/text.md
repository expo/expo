...
- **`color`**: [color](https://reactnative.dev/docs/colors)
...
- **`textShadowColor`**: [color](https://reactnative.dev/docs/colors)
...
* **`textDecorationColor`**: [color](https://reactnative.dev/docs/colors) (_iOS_)
