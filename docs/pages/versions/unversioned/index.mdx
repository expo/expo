...
export default function LISApp() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Send to admin: ", formData);
    alert("Codsigaaga waxaa loo diray Admin-ka (SHARMARKEDAACAD@GMAIL.COM)");
    setStep(2);
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
        <Card className="w-full max-w-md p-6 shadow-xl">
          <CardContent>
            <h1 className="text-2xl font-bold mb-4 text-center">LIS - Register</h1>
  ...
  // After registration (step 2), show file system layout
  return (
    <div className="p-6 space-y-6">
      <h2 className="text-2xl font-bold">Welcome to LIS</h2>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card><CardContent>📁 Files</CardContent></Card>
        <Card><CardContent>📄 Informations</CardContent></Card>
        <Card><CardContent>🖼️ Photos</CardContent></Card>
        <Card><CardContent>🎥 Videos</CardContent></Card>
      </div>
    </div>
  );
}
