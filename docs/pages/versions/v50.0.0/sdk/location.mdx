...
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-50/packages/expo-location'
...
- **(_iOS only_)** `"location"` background mode must be specified in **Info.plist** file. See [background tasks configuration guide](/versions/v50.0.0/sdk/task-manager/#configuration-for-standalone-apps).
