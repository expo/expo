...
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-50/packages/expo-splash-screen'
...
See how to configure the native projects in the [installation instructions in the `expo-splash-screen` repository](https://github.com/expo/expo/tree/sdk-50/packages/expo-splash-screen#-installation-in-bare-react-native-projects).
