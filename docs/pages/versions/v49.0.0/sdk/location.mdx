...
- **(_iOS only_)** `"location"` background mode must be specified in **Info.plist** file. See [background tasks configuration guide](/versions/v49.0.0/sdk/task-manager/#configuration-for-standalone-apps).
