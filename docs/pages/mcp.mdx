...
Expo MCP is available in [Claude Connectors](https://claude.ai/directory/expo). This setup requires no installation on your machine. Click the following button and follow the prompts to add the Expo connector to your Claude account:
