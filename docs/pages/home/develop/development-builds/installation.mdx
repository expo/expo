...
You need to initialize your project with Expo. If you still need to do so, see the [initializing steps](/home/get-started/create-a-project/#initialize-a-new-project) if you are starting a new project.
