...
These topics provide a foundation to learn the fundamentals of building a universal app. The tutorial is self-paced and can take up to two hours to complete.
