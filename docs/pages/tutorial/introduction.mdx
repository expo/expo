...
To keep it beginner friendly, we divided the tutorial into eight chapters so that you can follow along or put it down and come back to it later. Each chapter contains the necessary code, so you can follow along by creating an app from scratch or copy and paste it.
...
{/* TODO: @aman: To host a repository on GitHub and add that link here. Potentially after https://github.com/expo/examples/pull/504 gets merged. */}
