...
> **info** On iOS, Expo Go opens your project only when Expo CLI and Expo Go are signed in to the same Expo account. You did both in the previous chapter. If you see an account error, see [Expo Go sign-in required](/troubleshooting/expo-go-sign-in-required/).
