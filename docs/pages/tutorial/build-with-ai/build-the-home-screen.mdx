...
<ProgressTracker
  ...
  name="BUILD_WITH_AI"
  summary="The app now has navigation, a styled home screen, and a working photo picker. You haven't touched a line of code."
  nextChapterDescription="In the next chapter, you'll add an emoji picker modal and play with the sticker using gestures."
  nextChapterTitle="Add stickers"
