...
<BoxLink
  title="Next: Finishing touches"
  Icon={BookOpen02Icon}
  description="Polish the status bar, splash screen, and app icon, and take your next steps."
  href="/tutorial/build-with-ai/finishing-touches/"
/>
