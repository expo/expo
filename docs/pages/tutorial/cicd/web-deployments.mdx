...
Our workflows from previous chapters cover Android and iOS. EAS Workflows can also deploy the web build of an Expo project to [EAS Hosting](/eas/hosting/introduction/) alongside the same release.
