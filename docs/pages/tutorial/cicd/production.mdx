...
Open the [EAS dashboard](https://expo.dev) and find the workflow run. Since no build exists yet for this fingerprint, the `build` jobs should run, and the `update` jobs should be grayed out.
