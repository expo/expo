...
- Next, we modify our app's JavaScript code. We create a git branch called `dev` and submit a PR to our example repository from that branch.
- In the PR link, under **Labels**, we create a label called `eas-build-all:development`.
