...
<ImageSpotlight
  ...
  src="/static/images/tutorial/eas/app-store-02.png"
  style={{ maxWidth: 300 }}
/>
...
<ImageSpotlight
  ...
  src="/static/images/tutorial/eas/app-store-03.png"
  style={{ maxWidth: 300 }}
/>
...
- Automatting the submission process using the `--auto-submit` flag with `eas build`.

In the next chapter, we'll learn how to use the EAS Update to send OTA updates and share previews with our team.
