...
This tutorial will give you proficiency with [Expo Application Services (EAS)](https://expo.dev/services) core services: [Build](/build/introduction/), [Submit](/deploy/submit-to-app-stores/), and [Update](/eas-update/introduction/). When you complete the tutorial, you will know how to set up a professional mobile Continuous Integration (CI)/Continuous Development (CD) pipeline for your individual and team projects.
