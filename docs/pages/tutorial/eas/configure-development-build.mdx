...
<ProgressTracker
  ...
  name="EAS_TUTORIAL"
  chapterSummary="
In this chapter, we used the EAS CLI to install, initialize, and configure our project, linking the project to EAS servers and prepared a development build."
/>

## Next step

In the next chapter, let's create a development build for Android, install it on a device and an emulator, and get it running.
