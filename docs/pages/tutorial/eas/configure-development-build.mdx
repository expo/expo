...
import { SafeAreaView, StyleSheet, Text, View, Slider, Button } from 'react-native';

// Componente principal
function App() {
  // Estado para armazenar a sensibilidade atual
  const [sensitivity, setSensitivity] = useState(240);

  // Função para atualizar a sensibilidade
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>LENSI BOOSTER</Text>
      </View>

      {/* Seção de ajustes */}
      <View style={styles.section}>
        <Text style={styles.label}>Sensibilidade da Jogo</Text>
        <Slider
          style={{ width: '100%' }}
          minimumValue={100}
          maximumValue={500}
        ...
        <Text style={styles.value}>
          Valor atual: <Text style={styles.bold}>{sensitivity}</Text> / 1z
        </Text>
        <Text style={styles.recommended}>
          Recomendado: <Text style={styles.bold}>100 Hz</Text>
        </Text>
      </View>
      ...
      <View style={styles.footer}>
        <Text style={styles.copyright}>
          Desenvolvido por: <Text style={styles.bold}>Seu Nome</Text>
        </Text>
      </View>
    </SafeAreaView>
  );
