...
import Image from 'next/image'; // Se estiver usando Next.js; caso contrário, use <img>
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-black text-white">
      ...
      <div className="relative w-full h-full">
        <Image
          src="https://via.placeholder.com/800x800?text=Cidade"
          alt="Cidade"
          layout="fill"
          objectFit="cover"
          className="brightness-50 grayscale" // Efeito de preto e branco
        />
      </div>

      {/* Texto principal */}
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
        <h1 className="text-6xl font-bold mb-4">Bn sensiX</h1>
