...
In [Environment variables in EAS](/pages/eas/environment-variables) doc, we described concepts related to using environment variables in EAS and differences in handling them by Expo CLI and EAS CLI.
In this tutorial, we will show you how to use them in practice.
