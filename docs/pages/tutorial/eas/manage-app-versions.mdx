...
However, this manual update process can be streamlined to minimize the room for error before submitting a new production build to the app stores. We use EAS Build to automate this process in the next section.
