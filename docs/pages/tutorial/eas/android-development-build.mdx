...
export default function LoginScreen() {
  ...
  return (
    <View className="flex-1 justify-center items-center bg-black px-5">
      <Text className="text-white text-3xl font-bold mb-8">Cyber Toolkit Login</Text>
      ...
      <TextInput
        ...
        className="w-full bg-gray-800 text-white p-3 rounded-xl mb-4"
      />
      ...
      <TextInput
        ...
        secureTextEntry
        className="w-full bg-gray-800 text-white p-3 rounded-xl mb-6"
      />

      <TouchableOpacity onPress={handleLogin} className="bg-green-600 px-6 py-3 rounded-xl">
