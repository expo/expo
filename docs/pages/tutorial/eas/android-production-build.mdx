...
After the app is created on Google Play Console, it redirects us to the app's Dashboard screen. To prepare an internal test version of our app:
...
```json
{
  ...
  "submit": {
    "production": {
      /* @info Add the path to the Google Service Account file and set track to internal */
      "android": {
