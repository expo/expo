...
We had one screen in the tutorial app. Most apps have multiple screens. See [Expo Router](/router/introduction/) for more information about adding navigation to your app.
