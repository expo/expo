...
We had one screen in the tutorial app. Most apps have multiple screens. [Expo Router](/router/introduction/) allows you to add new screens to your app by adding additional files to your project. Get started with Expo Router already configured by creating your next app with the default template:
