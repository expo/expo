...
You can learn more about customizing your [app icon](/develop/user-interface/splash-screen-and-app-icon/) and [splash screen](/develop/user-interface/splash-screen-and-app-icon/) in our guides. Also, look through the [app config reference](/workflow/configuration) for properties you can configure in the **app.json** file.
...
We went through basics of Expo Router and implemented a tab navigator. To learn more about the library, see [Expo Router's documentation](/router/introduction/).

### Debugging

Sometimes things go wrong, and when they do, you can use debugging tools to find and fix errors. See [Debugging](/debugging/runtime-issues/).
