...
- [Sign-up to expo.new](https://expo.new/) which automatically configures a project with file-based routing, and the required setup for build and over-the-air updates.
...
Once you've created your new project, you need to learn more about the concepts following tools and concepts:
...
- [Key concepts](/workflow/overview/#key-concepts) and [Core development loop](/workflow/overview/#the-core-development-loop): If you want to build a mental model of how Expo app is created, go through key concepts and core development loop to understand how it works.
...
- [App distribution](/deploy/build-project/) and [submission](/deploy/submit-to-app-stores/) to app stores: Once you've built your project, you are ready to share it with your users. Read these resources to learn more about how to release and submit your app to app stores.
