...
You can learn more about customizing your [app icon](/develop/user-interface/splash-screen-and-app-icon/) and [splash screen](/develop/user-interface/splash-screen-and-app-icon/) in our guides. Also, look through the [**app.json** app config reference](/workflow/configuration) for properties you can configure in this file.
...
We had one screen in the tutorial app. Most apps have multiple screens. [Expo Router](/router/introduction/) allows you to add new screens to your app by adding additional files to your project. To create a new project with Expo Router library already installed and configured, see [Create a project](/get-started/create-a-project/).
