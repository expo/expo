...
You can learn more about customizing your [app icon](/develop/user-interface/app-icons/) and [splash screen](/develop/user-interface/splash-screen/) in our guides. Also, look through the [**app.json** Expo config reference](/workflow/configuration) for properties you can configure in this file.
