...
<ContentSpotlight src="/static/images/tutorial/splash.png" className="max-w-[250px]" />

Let's take a look at our app now on Android, and iOS:

<ContentSpotlight file="tutorial/splash-add.mp4" />
...
<ContentSpotlight file="tutorial/splash-fixed.mp4" />
