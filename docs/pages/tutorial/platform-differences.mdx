...
Using `Platform` module from React Native, we can implement platform-specific behavior. Inside **src/app/(tabs)/index.tsx**:
...
<ProgressTracker name="GET_STARTED" currentChapterSlug="/tutorial/platform-differences" />
