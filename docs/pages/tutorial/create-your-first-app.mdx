...
The tutorial assumes that you are familiar with TypeScript and React. If you are not familiar with these tools, check out the [TypeScript Handbook](https://www.typescriptlang.org/docs/handbook/2/everyday-types.html) and [React's official tutorial](https://react.dev/learn).
