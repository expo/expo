...
- Prepare for development by [installing the required tools](/home/get-started/installation/#requirements).
...
Once the development server is running, the easiest way to launch the app is on a physical device with Expo Go. For more information, see <A href="/home/get-started/create-a-project/#open-the-app-on-your-device" openInNewTab>Open app on a device</A>.
