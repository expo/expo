...
Change your code according to the following example. Throughout the tutorial, any important code or code that has changed between examples will be <Highlight>highlighted like this</Highlight>. You can hover on the highlights (on desktop) or tap them (on mobile) to see more context on the change.
