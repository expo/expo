...
<ContentSpotlight
  alt="Button options displayed after an image is selected."
...
import EmojiPicker from '@/components/emoji-picker';
import EmojiList from '@/components/emoji-list';
/* @tutinfo Import the `EmojiSticker` component. */import EmojiSticker from '@/components/emoji-sticker';/* @end */
