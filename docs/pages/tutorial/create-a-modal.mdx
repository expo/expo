...
Create an **emoji-list.tsx** file inside the **src/components** directory and add the following code:
...
Now, we'll put the emoji sticker on the image. Create a new file in the **src/components** directory and call it **emoji-sticker.tsx**. Then, add the following code:
...
import EmojiPicker from '@/components/emoji-picker';
import EmojiList from '@/components/emoji-list';
/* @tutinfo Import the <CODE>EmojiSticker</CODE> component. */import EmojiSticker from '@/components/emoji-sticker';/* @end */
