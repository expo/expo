...
export default function Index() {
  ...
  return (
    <View style={styles.container}>
      ...
      /* @tutinfo Based on the value of <CODE>showAppOptions</CODE>, the buttons will be displayed.
      Also, move the existing buttons in the conditional operator block. */
      {showAppOptions ? (
        <View />
      ) : (
        /* @end */
...
export default function Index() {
  ...
  return (
    <View style={styles.container}>
      ...
      /* @tutinfo Render the <CODE>EmojiPicker</CODE> component at the bottom of the{' '}
...
export default function Index() {
  ...
  return (
    <View style={styles.container}>
      ...
      <EmojiPicker isVisible={isModalVisible} onClose={onModalClose}>
        /* @tutinfo Render the <CODE>EmojiList</CODE> component inside the <CODE>EmojiPicker</CODE>{' '}
        component. */
