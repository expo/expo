...
Now, update the **app/(tabs)/index.tsx** to import the `<EmojiList>` component and replace the comments inside `<EmojiPicker>` component with the following code snippet:
