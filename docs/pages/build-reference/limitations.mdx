...
EAS Build is designed to work for any React Native project. We plan to address the following limitations. However, it is good to be aware of them since they could prevent your from being able to use the service for your applications or might cause an inconvenience.
