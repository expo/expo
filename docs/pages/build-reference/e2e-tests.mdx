...
[Install your app on a local Android Emulator or iOS Simulator](/more/expo-cli/#building). Open a terminal, navigate to the Maestro folder, and run the following commands to start the tests with the Maestro CLI:
