...
E2E tests require a built app file—**.apk** for Android or **.app** for iOS—that EAS can install and test on a simulator.
...
At the root of your project, create a **.eas/workflows** directory. Then add a YAML file for your E2E test workflow, such as **.eas/workflows/e2e-test-android.yml**.
