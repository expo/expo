...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <ContentSpotlight
    src="/static/images/eas-build/tests/01-click-me.png"
    className="max-w-[400px]"
  />
  <ContentSpotlight src="/static/images/eas-build/tests/02-hi.png" className="max-w-[400px]" />
</div>
...
<ContentSpotlight src="/static/images/eas-build/tests/03-logs.png" className="max-w-[720px]" />
...
<ContentSpotlight src="/static/images/eas-build/tests/04-artifacts.png" className="max-w-[720px]" />
