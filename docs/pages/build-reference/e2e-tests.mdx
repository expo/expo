...
Instead, we can use [development builds](/home/develop/development-builds/introduction/) to load from a local development server or from [published updates](/eas-update/introduction/) to save time and CI resources. This can be done by having your E2E test runner invoke the app with a URL that points to a specific update bundle URL, as described in the [development builds deep linking URLs guide](/home/develop/development-builds/development-workflows/#deep-linking-urls).
