...
> **warning** The "remote" version source as a default behaviour has been introduced in `eas-cli` version `10.0.0`. If you are using an older version of CLI, you **don't need to specify the version source explicitly to "local"**.
