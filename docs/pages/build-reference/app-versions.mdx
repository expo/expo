...
> **warning** The "remote" version source as a default behaviour has been introduced in `eas-cli` version `9.1.1`. If you are using an older version of CLI, be aware that **"local" will be the default behaviour**.
...
> **warning** The "remote" version source as a default behaviour has been introduced in `eas-cli` version `9.1.1`. If you are using an older version of CLI, you **don't need to specify the version source explicitly to "local"**.
