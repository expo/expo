...
The rest of the configuration at this point is the same as for any Android project with flavors. There are a few common configurations that you might want to apply to your project:

- To change the name of the app built with the development profile, create an **android/app/src/development/res/values/strings.xml** file:
...
<ContentSpotlight
  ...
  src="/static/images/eas-build/variants/1-ios-duplicate-target.webp"
...
<ContentSpotlight
  ...
  src="/static/images/eas-build/variants/2-scheme-list.webp"
  className="max-w-[720px]"
/>
...
<ContentSpotlight
  ...
  src="/static/images/eas-build/variants/3-target-build-settings.webp"
  className="max-w-[720px]"
/>
