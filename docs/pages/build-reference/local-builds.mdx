...
- EAS environment variables with ["Secret" visability](https://docs.expo.dev/eas/environment-variables/#visibility) are not supported (set them in your local environment instead).
