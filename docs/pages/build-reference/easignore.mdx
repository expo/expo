...
A **.easignore** file defines which files [EAS](https://expo.dev/services) should ignore when uploading your project to the [EAS Build](/build/introduction) servers.
