...
- **Submits the app to TestFlight.** Uploads the resulting **.ipa** file to App Store Connect and enables TestFlight distribution for your team's [internal testing group](/submit/testflight/#set-up-internal-testing).
