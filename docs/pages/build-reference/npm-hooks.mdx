...
- `eas-build-on-cancel` - this hook is triggered if the build gets canceled before it can finish. It is executed at the end of cleanup phase, just before the build worker gets terminated.
