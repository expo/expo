...
> **warning** The lifecycle hooks are not executed by build process in [custom builds](/custom-builds/get-started/). They need to be manually extracted to build steps called when running the build.
