...
iOS builder VMs run on Mac Mini hosts in an isolated environment. Every build gets its own fresh macOS VM. For more information, see [see iOS-specific resource class](/eas/json/#resourceclass-2).
