...
The [Expo Go][expo-go] app can be used to experiment with most React Native apps regardless of how they are bootstrapped.
...
If you run this code in the Expo Go app, you'll see the fallback view. If you can build this locally with the [Expo CLI run commands](/more/expo-cli/#compiling) then you'll see the native blur hash view.
