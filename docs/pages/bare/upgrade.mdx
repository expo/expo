...
Choose your **from SDK version** and **to SDK version** to see the generate diff. Then, apply those changes to your native projects by copying and pasting or manually making changes to the project files.
