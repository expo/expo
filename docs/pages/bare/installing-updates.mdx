...
Add the **Supporting** directory that contains **Expo.plist** to your project in Xcode with the following content, to match the content in **app.json**:
...
<BoxLink
  title={
    <>
      <CODE>expo-updates</CODE> Readme
    </>
  }
  description={
    <>
      See <CODE>expo-updates</CODE> Readme for more information on how to use this library in a bare
      React Native project
    </>
  }
  href="https://github.com/expo/expo/tree/main/packages/expo-updates/README.md"
/>

<BoxLink
  title="With a local build"
  description="See EAS Update with a local build guide."
  href="/eas-update/build-locally/"
/>

<BoxLink
  title="Use EAS Update with EAS Build"
  description="See EAS Update get started guide for more information on how to use EAS Update with EAS Build."
...
<BoxLink
  ...
  description={
    <>
      Learn more about how to use <CODE>expo-updates</CODE> library with a custom server that
      implements the Expo Updates protocol
    </>
  }
  href="/eas-update/getting-started/"
/>
