...
The following guide explains how to install and configure `expo-dev-client` in an exisitng React Native project.

<Collapsible summary="Do you need to create a new project?">

If you're starting a project, you can create a new project with with `with-dev-client` template. Run the following command to initialize the project:
