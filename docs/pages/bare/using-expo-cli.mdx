...
- Support for [Continuous Native Generation](/workflow/prebuild.md) (CNG) with `npx expo prebuild` for easy upgrades, white-labeling, simple third-party package setup, and improved maintainibility of your codebase (by reducing the surface area).
