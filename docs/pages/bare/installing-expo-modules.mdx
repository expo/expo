...
To use Expo modules in your app, you'll need to install and configure the `expo` package.
...
- <NoIcon small /> **If the command fails**, please follow the manual installation instructions. Updating
  ...
  Native project, then you need to perform manual installation and adapt the instructions here to your
  codebase.

## Manual installation

The following instructions apply to installing the latest version of Expo modules in React Native 0.71.
...
- Then, run `npx expo run:[android|ios]` and modify your app JavaScript code to add the following:
...
### Exclude specific modules from autolinking
