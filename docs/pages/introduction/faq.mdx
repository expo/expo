...
description: A list of common questions about Expo and related services.
---
...
The fastest way to share your project is to publish with [EAS Update](/eas-update/introduction) and launch in a [development build](/development/introduction). This gives your app a URL; you can share this URL with anybody who has the [development build](/development/introduction.mdx) for iOS or Android. URLs can also be opened in Expo Go for Android.
...
Before you dive into writing some code, you'll need to install tools as mentioned in the [Installation](/get-started/installation) to get started.
