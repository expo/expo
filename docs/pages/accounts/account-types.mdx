---
title: Account types
description: Learn about different Expo account types.
---
...
From the User Settings of your Personal Account, go to the [Convert your account into an organization](https://expo.dev/settings#convert-account) section to start the process.
...
<ImageSpotlight
  alt="Example demonstrating Step 3 of the conversion process."
