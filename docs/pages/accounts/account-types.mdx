...
Security activity is a list of changes that happened to an EAS user profile – your personal account. It includes, among others, change of password, email, and 2FA authentication setup.

It can be found in the [EAS user profile settings](https://expo.dev/settings).
