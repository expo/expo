...
Access for members is managed through a role-based system. Users can have the _owner_, _admin_, _release manager_, _developer_, or _viewer_ role within an Organization account. Each role can do everything the roles below it can do.
...
| **Release Manager** | Can manage protected channels and publish updates to the branches they point to.                                                                          |
...
> **info** A protected channel restricts who can publish updates to it. Protected channels are in private beta and will be available on the Enterprise plan. Any account can assign the Release Manager role, but unless protected channels are enabled for an account, a Release Manager has the same access as a Developer.
