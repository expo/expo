...
<ContentSpotlight
  ...
  src="/static/images/accounts/create-an-organization-light.webp"
  darkSrc="/static/images/accounts/create-an-organization-dark.webp"
...
<ContentSpotlight
  ...
  src="/static/images/accounts/enter-name-org-light.webp"
  darkSrc="/static/images/accounts/enter-name-org-dark.webp"
...
<ContentSpotlight
  ...
  src="/static/images/accounts/members-light.webp"
  darkSrc="/static/images/accounts/members-dark.webp"
/>
...
Accounts can be renamed a limited number of times. Only Owners can rename accounts. To rename an account, visit **Settings** > [**Organization settings**](https://expo.dev/accounts/[account]/settings) and follow the steps under [**Rename account**](https://expo.dev/accounts/[account]/settings#rename-account).

<ContentSpotlight
  alt="Rename Account settings panel."
  src="/static/images/accounts/rename-account-light.webp"
  darkSrc="/static/images/accounts/rename-account-dark.webp"
...
<ContentSpotlight
  ...
  src="/static/images/accounts/transfer-project-light.webp"
  darkSrc="/static/images/accounts/transfer-project-dark.webp"
  className="max-w-[720px]"
/>
