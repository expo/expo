...
Audit logs record permission changes by permission name, not by role. For example, `PUBLISH_PROTECTED` allows managing protected channels and publishing updates to the branches they point to, and is included in the Release Manager, Admin, and Owner [roles](/accounts/account-types/#manage-access).
