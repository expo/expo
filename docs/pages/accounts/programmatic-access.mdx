...
description: Learn about access tokens and how to use them to manage your Expo account.
---
...
## Organizations: Bot Users and access tokens
...
You can use any tokens you have created to perform actions with the Expo CLI (other than signing in and out). To use tokens, you need to define an environment variable, suhc as `EXPO_TOKEN="token"`, before running commands.
