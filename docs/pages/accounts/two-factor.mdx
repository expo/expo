...
> **info** If you set an SMS device as your default 2FA method, you will be sent a verification code automatically whenever you take an action that requires a 2FA code.
...
> **info** Store your recovery codes in a secure and memorable place to ensure you, and only you, can access your account!
