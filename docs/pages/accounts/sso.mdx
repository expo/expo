...
SSO is available for [Enterprise Plan](https://expo.dev/pricing) customers. To get started, [contact us](https://expo.dev/contact) and we'll help you set it up for your organization. You can also start preparing your identity provider for Expo SSO by following the configuration guides below.

## Identity provider support

Currently, Expo SSO supports the following identity providers:

| Identity providers                                                                       | Resources                                                       |
| ---------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| [Okta](https://www.okta.com/)                                                            | [Expo configuration guide](https://expo.fyi/sso-setup-okta)     |
| [OneLogin](https://www.onelogin.com/)                                                    | [Expo configuration guide](https://expo.fyi/sso-setup-onelogin) |

We implement the [OpenID Connect Discovery 1.0](https://openid.net/specs/openid-connect-discovery-1_0.html) specification and are working to verify additional compatible identity providers. If you use another identity provider and are interested in SSO, let us know.
