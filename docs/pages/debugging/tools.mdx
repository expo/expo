...
> **warning** This feature is only available from Expo SDK 49+ when using the dev client. It is not available when using Expo Go.
...
> **warning** This feature is only available from Expo SDK 49+.
