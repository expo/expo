...
<ContentSpotlight
  ...
  src="/static/images/debugging/developer-menu.webp"
...
### Keep the developer menu closed at launch

For automation or agent-driven runs, keep the developer menu out of the way. Run `EXPO_NO_DEV_MENU=1 npx expo start` to launch with the menu closed, the tools button hidden, and onboarding skipped. The menu and the tools button come back on the next launch without the variable; only onboarding stays finished. See [Deep linking to an update's URL](/develop/development-builds/development-workflows/#deep-linking-to-an-updates-url) for the individual query parameters.
...
<ContentSpotlight
  ...
  src="/static/images/debugging/element-inspector.webp"
...
<ContentSpotlight
  ...
  src="/static/images/debugging/inspector-sources-tab.webp"
/>
...
<ContentSpotlight
  alt="The React Native DevTools showing one of the files under the Sources tab."
  src="/static/images/debugging/inspector-breakpoint.webp"
/>
...
<ContentSpotlight
  ...
  src="/static/images/debugging/inspector-breakpoint-console.webp"
/>

### Inspecting network requests (Expo only)

> **info** The Network tab in React Native DevTools is only available when you have [`expo-dev-client`](/versions/latest/sdk/dev-client/) installed, or when you use Expo Go.
...
<ContentSpotlight
  ...
  src="/static/images/debugging/inspector-network-post.webp"
...
<ContentSpotlight
  ...
  src="/static/images/debugging/inspector-memory.webp"
  className="max-w-[720px]"
/>
...
<ContentSpotlight
  ...
  src="/static/images/debugging/inspector-components.webp"
  className="max-w-[720px]"
/>
...
<ContentSpotlight
  ...
  src="/static/images/debugging/inspector-profiler.webp"
  className="max-w-[720px]"
/>
...
<ContentSpotlight
  ...
  src="/static/images/debugging/vscode-expo.webp"
/>
...
<ContentSpotlight
  ...
  src="/static/images/debugging/radon-ide.webp"
/>
