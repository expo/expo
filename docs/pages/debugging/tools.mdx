...
Pressing the <kbd>shift</kbd> + <kbd>m</kbd> shortcut will also show any [dev tools plugins](/devtools-plugins) installed to can provide additional ways to inspect your app.
