...
Just like websites, you can use the Chrome DevTools to gain insights in the JavaScript code of your app. With this tool, you get access to the [Console](#interacting-with-the-console), [Source](#pausing-on-breakpoints), and even the [Network](#inspecting-network-requests) tab when using dev clients.
...
Once your app is executing code that has a breakpoint, it will fully pause your app. This allows you to inspect all variables and functions in that scope. You can also execute code in the [Console](#interacting-with-the-console), as if it was part of your app.
...
You can use this debugger with the [Expo Tools](https://github.com/expo/vscode-expo#readme) VS Code extension. This debugger allows you to set breakpoints, inspect variables, and even execute code through the debug console.
...
To start debugging, connect your app and run the "Expo: Debug ..." VS Code command. This will attach VS Code to your running app.

## Debugging with React DevTools

React DevTools is a great way to get a look at each of your components' props and state. You can open the React DevTools by pressing <kbd>Shift</kbd> + <kbd>m</kbd> in the terminal where Expo was started. Once you have opened the React DevTools, it will appear as below:
