...
The <kbd>Shift</kbd> + <kbd>m</kbd> shortcut will also show any decv tools plugins installed, which can provide additional ways to inspect your app. [Learn more](/devtools-plugins).
