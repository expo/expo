...
- **Open JS debugger**: To open Chrome DevTools which provides access to Console, Source, and Network tabs for apps using Hermes. For more information, see the [Chrome DevTools](#debugging-with-chrome-devtools) section.
