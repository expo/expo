...
You can add Sentry to your Expo project. It gathers crash data and alerts you about other events. You can also configure source maps. They make stack traces in Sentry readable, like your code in your editor.
