...
With Expo, you can integrate a reporting service like [Sentry](/guides/using-sentry/), [BugSnag](/guides/using-bugsnag/) or [Rollbar](/guides/using-rollbar/) to get more insights in real-time.
