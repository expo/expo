...
They are common errors that you encounter while developing your app. Debugging them isn't always straightforward. Usually, debugging when running your app with [Expo CLI](/more/expo-cli/) is enough.
...
You can use the **Console** app on your Mac to read logs from a connected iOS device or a running iOS Simulator. Follow the steps below to access the Console app:
...
Under **Devices** in the sidebar, select your connected device or your simulator.

<ContentSpotlight
  alt="Console app on macOS with an iOS Simulator selected under Devices."
  src="/static/images/debugging/console-devices.webp"
/>
...
Click **Start streaming** to read logs from your device or simulator.
