export default {
      ...
      "slug": {
        "description": "The friendly url name for publishing. eg: `my-app-name` will refer to the `expo.io/@project-owner/my-app-name` project.",
        "type": "string",
        "pattern": "^[a-zA-Z0-9_\\-]+$"
      },
      "owner": {
        "description": "The primary user to use for publishing and creating builds. If not provided, defaults to the username of the current user.",
        "type": "string",
        "minLength": 1
      },
      "privacy": {
        "description": "Either `public` or `unlisted`. If not provided, defaults to `unlisted`. In the future `private` will be supported. `unlisted` hides the experience from search results. Valid values: `public`, `unlisted`",
      ...
      "runtimeVersion": {
        "description": "The runtime version associated with this manifest for bare workflow projects. If provided, this must match the version set in Expo.plist or AndroidManifest.xml.",
        "type": "string",
        "pattern": "^[0-9\\.]+$",
        "meta": {
          "hidden": true
      ...
      "orientation": {
        "description": "Lock your app to a specific orientation with portrait or landscape. Defaults to no lock. Valid values: `default`, `portrait`, `landscape`",
      ...
      "backgroundColor": {
        ...
        "pattern": "^#|(&#x23;)\\d{6}$",
        "meta": {
          "regexHuman": "6 character long hex color string, eg: `'#000000'`. Default is white: `'#ffffff'`"
        }
      },
      "primaryColor": {
        "description":
      ...
      "notification": {
        ...
        "properties": {
          "icon": {
            ...
            "type": "string",
            "meta": {
              "expoKit": "For Android, edit or replace the `shell_notification_icon.png` files in `android/app/src/main/res/mipmap-<RESOLUTION>`. On iOS, notification icons are the same as the app icon. All other properties are set at runtime.",
              "asset": true,
              "contentTypePattern": "^image/png$",
              "contentTypeHuman": ".png image",
              "square": true
      ...
      "androidStatusBar": {
        "description": "Configuration for the status bar on Android. For more details please navigate to [Configuring StatusBar](../../guides/configuring-statusbar).",
        "type": "object",
        "properties": {
          "barStyle": {
          ...
          "backgroundColor": {
            ...
            "pattern": "^#|(&#x23;)\\d{6}$",
            "meta": {
              "regexHuman": "6 character long hex color string `'#RRGGBBAA'`, eg `'#000000'` for white. Or 8 character long hex color string `'#RRGGBBAA'`, eg `'#00000088'` for semi-transparent black."
            }
          },
          "hidden": {
            "description": "Instructs the system whether status bar should be visible or not. Defaults to `false`",
            "type": "boolean"
          },
          "translucent": {
            "description": "Specifies whether status bar should be translucent (whether it should be treated as a block element that will take up space on the device's screen and limit space available for the rest of your app to be rendered, or be treated as an element with `'position = absolute'` that is rendered above your app's content). Defaults to `true` (default iOS behavior, iOS status bar cannot be set translucent by the system)",
            "type": "boolean"
          }
        }
      },
      ...
      "updates": {
        ...
        "properties": {
          "enabled": {
            ...
            "type": "boolean",
            "meta": {
              "expoKit": "For iOS, edit the `areRemoteUpdatesEnabled` key in `ios/<PROJECT-NAME>/Supporting/EXShell.plist`. For Android, edit the `ARE_REMOTE_UPDATES_ENABLED` variable in `android/app/src/main/java/host/exp/exponent/generated/AppConstants.java`. All other properties are set at runtime."
            }
          },
          "checkAutomatically": {
      ...
      "ios": {
        ...
        "properties": {
          ...
          "buildNumber": {
            "description":
              "Build number for your iOS standalone app.  Corresponds to `CFBundleVersion` and must match Apple's [specified format](https://developer.apple.com/library/content/documentation/General/Reference/InfoPlistKeyReference/Articles/CoreFoundationKeys.html#//apple_ref/doc/uid/20001431-102364). (Note Application loader will pull the value for `Version Number` from `expo.version` and NOT from `expo.ios.buildNumber`)",
            "type": "string",
            "pattern": "^[A-Za-z0-9\\.]+$",
            "meta": {
          ...
          "splash": {
            ...
            "properties": {
              "xib": {
                "description": "Local path to a XIB file as the loading screen. It overrides other loading screen options. Note that this will only be used in the standalone app (i.e., after you build the app). It will not be used in the Expo client.",
                "type": "string",
                "meta": {
                  "asset": true,
      ...
      "android": {
        ...
        "properties": {
          ...
          "package": {
            ...
            "meta": {
              "regexHuman": "Reverse DNS notation unique name for your app. Valid Android Application ID. For example, `host.exp.exponent`, where `exp.host` is our domain and `expo` is our app. The name may only contain lowercase and uppercase letters (a-z, A-Z), numbers (0-9) and underscores (_), separated by periods (.). Each component of the name should start with a lowercase letter.",
              "expoKit": "This is set in `android/app/build.gradle` as well as your AndroidManifest.xml file (multiple places)."
            }
          },
          "versionCode": {
            "description": "Version number required by Google Play. Increment by one for each release. Must be an integer. [Learn more](https://developer.android.com/studio/publish/versioning.html)",
            "type": "integer",
            "meta": {
          ...
          "adaptiveIcon": {
            ...
            "properties": {
              ...
              "backgroundColor": {
                ...
                "pattern": "^#|(&#x23;)\\d{6}$",
                "meta": {
                  "expoKit": "This is set in `android/app/src/main/res/values/colors.xml",
                  "regexHuman": "6 character long hex color string, eg: `'#000000'`"
                }
              }
            },
          ...
          "permissions": {
            "description": "List of permissions used by the standalone app. \n\n To use ONLY the following minimum necessary permissions and none of the extras supported by Expo, set `permissions` to []. The minimum necessary permissions do not require a Privacy Policy when uploading to Google Play Store and are: \n• receive data from Internet \n• view network connections \n• full network access \n• change your audio settings \n• draw over other apps \n• prevent device from sleeping \n\n To use ALL permissions supported by Expo, do not specify the `permissions` key. \n\n  To use the minimum necessary permissions ALONG with certain additional permissions, specify those extras in `permissions`, e.g.: `[ \"CAMERA\", \"ACCESS_FINE_LOCATION\" ]`.\n\n  You can specify the following permissions depending on what you need:\n\n- `ACCESS_COARSE_LOCATION`\n- `ACCESS_FINE_LOCATION`\n- `CAMERA`\n- `MANAGE_DOCUMENTS`\n- `READ_CONTACTS`\n- `READ_EXTERNAL_STORAGE`\n- `READ_INTERNAL_STORAGE`\n- `READ_PHONE_STATE`\n- `RECORD_AUDIO`\n- `USE_FINGERPRINT`\n- `VIBRATE`\n- `WAKE_LOCK`\n- `WRITE_EXTERNAL_STORAGE`\n- `com.anddoes.launcher.permission.UPDATE_COUNT`\n- `com.android.launcher.permission.INSTALL_SHORTCUT`\n- `com.google.android.c2dm.permission.RECEIVE`\n- `com.google.android.gms.permission.ACTIVITY_RECOGNITION`\n- `com.google.android.providers.gsf.permission.READ_GSERVICES`\n- `com.htc.launcher.permission.READ_SETTINGS`\n- `com.htc.launcher.permission.UPDATE_SHORTCUT`\n- `com.majeur.launcher.permission.UPDATE_BADGE`\n- `com.sec.android.provider.badge.permission.READ`\n- `com.sec.android.provider.badge.permission.WRITE`\n- `com.sonyericsson.home.permission.BROADCAST_BADGE`\n",
            "type": "array",
            "meta": {
              "expoKit": "To change the permissions your app requests, you'll need to edit `AndroidManifest.xml` manually. To prevent your app from requesting one of the permissions listed below, you'll need to explicitly add it to `AndroidManifest.xml` along with a `tools:node=\"remove\"` tag."
            }
          },
          "googleServicesFile": {
            ...
            "type": "string", 
            "meta": {
              "expoKit": "Add or edit the file directly at `android/app/google-services.json`. To enable FCM, edit the value of `FCM_ENABLED` in `android/app/src/main/java/host/exp/exponent/generated/AppConstants.java`."
            }
          },
          "config": {
            "type": "object",
          ...
          "splash": {
            ...
            "properties": {
              ...
              "mdpi": {
                "description": "Local path or remote url to an image to fill the background of the loading screen in 'cover' mode. Image size and aspect ratio are up to you. [Learn more]( https://developer.android.com/training/multiscreen/screendensities) \n\n Natural sized image (baseline)",
                "type": "string",
                "meta": {
                  "asset": true,
                  "contentTypePattern": "^image/png$",
          ...
          "intentFilters": {
            "description": "Configuration for setting an array of custom intent filters in Android manifest. [Learn more](developer.android.com/guide/components/intents-filters)",
            "example": [
              {
                "autoVerify": true,
                "action": "VIEW",
                ...
                "data": {
                  ...
                  "items": {
                    ...
                    "properties": {
                      ...
                      "path": { "description": "an exact path for URLs that should be matched by the filter, e.g. `/records`", "type": "string" },
                      "pathPattern": { "description": " a regex for paths that should be matched by the filter, e.g. `.*`", "type": "string" },
                      "pathPrefix": { "description": "a prefix for paths that should be matched by the filter, e.g. `/records/` will match `/records/123`", "type": "string" },
                      "mimeType": { "description": "a mime type for URLs that should be matched by the filter", "type": "string" }
                    },
                    "additionalProperties": false
                  },
                  "properties": {
            ...
            "meta": {
              "expoKit": "This is set in `AndroidManifest.xml` directly."
            }
          },
          "allowBackup": {
        ...
        "properties": {
          ...
          "meta": {
            ...
            "properties": {
              ...
              "twitter": {
                "description": "Twitter card protocol. [Learn more](https://developer.twitter.com/en/docs/tweets/optimize-with-cards/overview/markup.html)",
                "type": "object",
                "additionalProperties": true,
                "properties": {}
              },
      ...
      "facebookAutoLogAppEventsEnabled": {
        "description": "Whether the Facebook SDK log app events automatically. If you don't set this property, Facebook's default will be used. (Applicable only to standalone apps.) Note that Facebook SDK must be initialized for app events to work. You may autoinitialize Facebook SDK by setting ",
        "type": "boolean",
        "meta": {
          "expoKit": "To change this field, edit `Info.plist` and `AndroidManifest.xml`."
        }
      ...
      "facebookScheme": {
        "description": "Used for Facebook native login. Starts with 'fb' and followed by a string of digits, like 'fb1234567890'. You can find your scheme [here](https://developers.facebook.com/docs/facebook-login/ios)in the 'Configuring Your info.plist' section.",
        "type": "string",
      ...
      "splash": {
        ...
        "properties": {
          "backgroundColor": {
            ...
            "pattern": "^#|(&#x23;)\\d{6}$",
            "meta": {
              "expoKit": "For Android, edit `android/app/src/main/res/values/colors.xml`",
              "regexHuman": "6 character long hex color string, eg: `'#000000'`"
            }
          },
          "resizeMode": {
            ...
            "type": ["array", "boolean", "number", "object", "string", "null"],
            "meta": {
              "expoKit": "For Android, change `SHOW_LOADING_VIEW_IN_SHELL_APP` in `android/app/src/main/java/host/exp/exponent/generated/AppConstants.java` (true for `contain`, false for `cover`)"
            }
          },
          "image": {
            "description": "Local path or remote url to an image to fill the background of the loading screen. Image size and aspect ratio are up to you. Must be a .png.",
        ...
        "meta": {
          "expoKit": "To change your iOS app's splash screen, use Xcode to edit `LaunchScreen.xib`. For Android, edit or replace the files in `android/app/src/main/res/drawable-<RESOLUTION>`"
        }
      },
      "hooks": {
      ...
      "experiments": {
        "description": "Toggle features that aren't ready to be turned on by default for everyone.",
        "type": "object",
        "additionalProperties": false,
        "properties": {
          "redesignedLogBox": {
            "type": "boolean",
            "description": "Use the unstable LogBox re-design available in React Native 0.62",
            "fallback": false
          }
        }
      }
