export default {
  ...
  ios: {
    ...
    properties: {
      ...
      usesAppleSignIn: {
        ...
        type: 'boolean',
        fallback: false,
        meta: { expoKit: 'Use Xcode to set this.' },
      },
  ...
  android: {
    ...
    properties: {
      ...
      adaptiveIcon: {
        ...
        meta: { expoKit: 'Icons are saved in `android/app/src/main/res/mipmap-<RESOLUTION>-v26`' },
        additionalProperties: false,
      },
      playStoreUrl: {
        description:
      ...
      googleServicesFile: {
        ...
        expoKit:
          'Add or edit the file directly at `android/app/google-services.json`. To enable FCM, edit the value of `FCM_ENABLED` in `android/app/src/main/java/host/exp/exponent/generated/AppConstants.java`.',
      },
      config: {
        type: 'object',
        description:
  ...
  web: {
    ...
    properties: {
      ...
      shortName: {
        ...
        PWA: 'short_name',
        type: 'string',
        meta: { regexHuman: 'Maximum 12 characters long' },
      },
      lang: {
        description:
      ...
      meta: {
        ...
        properties: {
          ...
          apple: {
            ...
            properties: {
              ...
              barStyle: {
                description:
                  'If content is set to "default", the status bar appears normal. If set to "black", the status bar has a black background. If set to "black-translucent", the status bar is black and translucent. If set to "default" or "black", the web content is displayed below the status bar. If set to "black-translucent", the web content is displayed on the entire screen, partially obscured by the status bar.',
                fallback: ['expo.web.barStyle', 'default'],
                metatag: 'apple-mobile-web-app-status-bar-style',
                enum: ['default', 'black', 'black-translucent'],
                type: 'string',
              },
          ...
          twitter: {
            description:
              'Twitter card protocol. [Learn more](https://developer.twitter.com/en/docs/tweets/optimize-with-cards/overview/markup.html)',
            type: 'object',
            additionalProperties: true,
            properties: {},
          },
  ...
  hooks: {
    ...
    type: 'object',
    additionalProperties: false,
    properties: { postPublish: { type: 'array' } },
  },
  assetBundlePatterns: {
    description:
