...
const RENAMED_PAGES: Record<string, string> = {
  ...
  '/introduction/why-not-expo': '/faq#what-can-i-do-or-cannot-do-with-expo-go',
  '/workflow/expo-go': '/get-started/set-up-your-environment',
  '/guides/splash-screens': '/develop/user-interface/splash-screen-and-app-icon',
  '/guides/app-icons': '/develop/user-interface/splash-screen-and-app-icon',
  ...
  '/guides/preloading-and-caching-assets': '/archive/classic-updates/preloading-and-caching-assets',
  ...
  '/versions/latest/sdk/facebook': '/guides/facebook-authentication',
  ...
  '/versions/latest/sdk/google': '/guides/google-authentication',
  ...
  '/workflows/triggers': '/eas/workflows/syntax',
  '/workflows/jobs': '/eas/workflows/syntax',
  '/workflows/variables': '/eas/workflows/syntax',
