(function(t, e) {
  ...
  function r(t, e, a) {
    ...
    g.setAttribute('class', 'tippy-popper'),
      g.setAttribute('role', 'tooltip'),
      g.setAttribute('id', 'tippy-' + t),
      (g.style.zIndex = b),
      (g.style.maxWidth = y);
    var x = document.createElement('div');
    if (
      (x.setAttribute('class', 'tippy-tooltip'),
      x.setAttribute('data-size', m),
      x.setAttribute('data-animation', c),
    ...
    if ((k.setAttribute('class', 'tippy-content'), h)) {
      ...
      h instanceof Element
        ? (k.appendChild(h), (E = '#' + h.id || 'tippy-html-template'))
        : ((k.innerHTML = document.querySelector(h).innerHTML), (E = h)),
        g.setAttribute('data-html', ''),
        u && g.setAttribute('tabindex', '-1'),
        x.setAttribute('data-template-id', E);
    } else k.innerHTML = e;
  ...
  function p(t, e, a, i) {
    ...
    return 'manual' === t
      ? o
      : (e.addEventListener(t, a.handleTrigger),
        o.push({ event: t, handler: a.handleTrigger }),
        'mouseenter' === t &&
          (Lt.supportsTouch &&
            i &&
            (e.addEventListener('touchstart', a.handleTrigger),
            o.push({ event: 'touchstart', handler: a.handleTrigger }),
            e.addEventListener('touchend', a.handleMouseleave),
            o.push({ event: 'touchend', handler: a.handleMouseleave })),
          e.addEventListener('mouseleave', a.handleMouseleave),
          o.push({ event: 'mouseleave', handler: a.handleMouseleave })),
        'focus' === t &&
          (e.addEventListener('blur', a.handleBlur),
          o.push({ event: 'blur', handler: a.handleBlur })),
        o);
  }
  function n(t, e) {
    var a = St.reduce(function(a, i) {
  ...
  function l(t) {
    return {
      tooltip: t.querySelector(Ct.TOOLTIP),
      backdrop: t.querySelector(Ct.BACKDROP),
      content: t.querySelector(Ct.CONTENT),
    };
  }
  function d(t) {
  ...
  function h(t) {
    ...
    var e = m(t),
      ...
      i = e.overflowX,
      o = e.overflowY;
    return /(auto|scroll)/.test(a + o + i) ? t : h(f(t));
  }
  function b(t) {
    var e = t && t.offsetParent,
      a = e && e.nodeName;
    return a && 'BODY' !== a && 'HTML' !== a
      ? -1 !== ['TD', 'TABLE'].indexOf(e.nodeName) && 'static' === m(e, 'position')
        ? b(e)
        : e
      : t
  ...
  function y(t) {
    return null === t.parentNode ? t : y(t.parentNode);
  }
  function g(t, e) {
    ...
    if ((t !== p && e !== p) || i.contains(o)) return u(p) ? p : b(p);
    var n = y(t);
    return n.host ? g(n.host, e) : g(t, y(e).host);
  }
  function x(t) {
  ...
  function E() {
    var t = document.body,
      ...
      a = Mt() && getComputedStyle(e);
    return { height: k('Height', t, e, a), width: k('Width', t, e, a) };
  }
  function L(t) {
  ...
  function O(t) {
    ...
    if (s || l) {
      var d = m(t);
      (s -= v(d, 'x')), (l -= v(d, 'y')), (o.width -= s), (o.height -= l);
    }
    return L(o);
  }
  function C(t, e) {
    ...
    return (a ? e.contains(p) : e === p && 'BODY' !== p.nodeName) && (d = w(d, e)), d;
  }
  function A(t) {
    var e = t.ownerDocument.documentElement,
      a = C(t, e),
      i = Et(e.clientWidth, window.innerWidth || 0),
      o = Et(e.clientHeight, window.innerHeight || 0),
      r = x(e),
      p = x(e, 'left'),
      n = { top: r - a.top + a.marginTop, left: p - a.left + a.marginLeft, width: i, height: o };
    return L(n);
  }
  function S(t) {
    var e = t.nodeName;
    return 'BODY' === e || 'HTML' === e ? !1 : 'fixed' === m(t, 'position') || S(f(t));
  }
  function Y(t, e, a, i) {
    var o = { top: 0, left: 0 },
      r = g(t, e);
    if ('viewport' === i) o = A(r);
      ...
      var p;
      'scrollParent' === i
        ? ((p = h(f(e))), 'BODY' === p.nodeName && (p = t.ownerDocument.documentElement))
        : 'window' === i
  ...
  function X(t, e, a, i, o) {
    ...
    var p = Y(a, i, r, o),
      ...
      s = Object.keys(n)
        .map(function(t) {
          return Ut({ key: t }, n[t], { area: P(n[t]) });
        })
        .sort(function(t, e) {
  ...
  function N(t, e, a) {
    ...
    var i = _(t),
      ...
      s = r ? 'height' : 'width',
      l = r ? 'width' : 'height';
    return (o[p] = e[p] + e[s] / 2 - i[s] / 2), (o[n] = a === n ? e[n] - i[l] : e[I(n)]), o;
  }
  function R(t, e) {
  ...
  function M(t, e, a) {
    var i = void 0 === a ? t : t.slice(0, B(t, 'name', a));
    return (
  ...
  function F(t, e, a, i) {
    ...
    r.addEventListener(e, a, { passive: !0 }), o || F(h(r.parentNode), e, a, i), i.push(r);
  }
  function j(t, e, a, i) {
    (a.updateBound = i), q(t).addEventListener('resize', a.updateBound, { passive: !0 });
    var o = h(t);
    return (
  ...
  function G() {
    this.state.eventsEnabled &&
      (cancelAnimationFrame(this.scheduleUpdate), (this.state = V(this.reference, this.state)));
  }
  function Z(t) {
  ...
  function et(t) {
    var e = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
      a = Ft.indexOf(t),
      i = Ft.slice(a + 1).concat(Ft.slice(0, a));
  ...
  function at(t, e, a, i) {
    ...
    if ('vh' === p || 'vw' === p) {
      ...
      return (
        (l =
          'vh' === p
            ? Et(document.documentElement.clientHeight, window.innerHeight || 0)
            : Et(document.documentElement.clientWidth, window.innerWidth || 0)),
        (l / 100) * r
      );
    }
    return r;
  ...
  function it(t, e, a, i) {
    ...
    var s = /\s*,\s*|\s+/,
      l =
        -1 === n
          ? [p]
          : [p.slice(0, n).concat([p[n].split(s)[0]]), [p[n].split(s)[1], p.slice(n + 1)]];
    return (
    ...
    var i = ot(t),
      ...
      c = a
        .replace(
          l.translate,
          'translate' +
            nt(d.translate.axis, r) +
            '(' +
            pt('translate', d.translate.numbers, r, p) +
            ')'
        )
        .replace(
          l.scale,
          'scale' + nt(d.scale.axis, r) + '(' + pt('scale', d.scale.numbers, r, p) + ')'
        );
  ...
  function dt(t) {
    return -(t - At.distance) + 'px';
  }
  function ct(t) {
    requestAnimationFrame(function() {
      setTimeout(t, Ot ? 60 : 0);
    });
  }
  function mt(t, a) {
    var i =
  ...
  function bt(t, e) {
    t.forEach(function(t) {
      t && (t.style[o('transitionDuration')] = e + 'ms');
    });
  }
  function ut(t, e) {
    return t.reduce(function(t, a) {
      var i = te,
        o = s(a, e.performance ? e : n(a, e)),
        c = o.html,
        m = o.trigger,
        f = o.touchHold,
        h = o.dynamicTitle,
        b = o.createPopperInstanceOnInit,
        u = a.getAttribute('title');
      if (!u && !c) return t;
      a.setAttribute('data-tippy', ''), a.setAttribute('aria-describedby', 'tippy-' + i), d(a);
      var y = r(i, u, o),
        g = new T({ id: i, reference: a, popper: y, options: o });
      g.popperInstance = b ? $t.call(g) : null;
      var x = Qt.call(g);
      return (
        (g.listeners = m
          .trim()
  ...
  function yt(t) {
    var e = [].slice.call(document.querySelectorAll(Ct.POPPER));
  ...
  function gt() {
    var t = function() {
        Lt.usingTouch ||
          ((Lt.usingTouch = !0),
          Lt.iOS && document.body.classList.add('tippy-touch'),
          Lt.dynamicInputDetection &&
            window.performance &&
            document.addEventListener('mousemove', a),
          Lt.onUserInputChange('touch'));
      },
      a = (function() {
        var t;
        return function() {
          ...
          20 > e - t &&
            ...
            !Lt.iOS && document.body.classList.remove('tippy-touch'),
            Lt.onUserInputChange('mouse')),
            (t = e);
        };
      })();
    document.addEventListener('click', function(t) {
      if (!(t.target instanceof Element)) return yt();
      var e = mt(t.target, Ct.REFERENCE),
        a = mt(t.target, Ct.POPPER);
      if (!(a && a._reference._tippy.options.interactive)) {
        if (e) {
          var i = e._tippy.options;
          if ((!i.multiple && Lt.usingTouch) || (!i.multiple && -1 < i.trigger.indexOf('click')))
            return yt(e._tippy);
      ...
      window.addEventListener('blur', function() {
        var t = document,
          a = t.activeElement;
        a && a.blur && e.call(a, Ct.REFERENCE) && a.blur();
      }),
      !Lt.supportsTouch &&
  ...
  function xt(e, i) {
    return (
      Lt.supported && !Lt._eventListenersBound && (gt(), (Lt._eventListenersBound = !0)),
      t(e) &&
        ((e.refObj = !0),
      ...
      (i = Xt({}, At, i)),
      {
        selector: e,
        options: i,
        tooltips: Lt.supported ? ut(a(e), i) : [],
        destroyAll: function() {
  ...
  var wt = Math.round,
    ...
    Lt = {},
    Ot = Tt && /UCBrowser|SAMSUNG/.test(navigator.userAgent);
  Tt &&
    ((Lt.supported = 'requestAnimationFrame' in window),
    (Lt.supportsTouch = 'ontouchstart' in window),
    (Lt.usingTouch = !1),
    (Lt.dynamicInputDetection = !0),
    (Lt.iOS = /iPhone|iPad|iPod/.test(navigator.platform) && !window.MSStream),
    (Lt.onUserInputChange = function() {}),
    (Lt._eventListenersBound = !1));
  for (
    var Ct = {
        POPPER: '.tippy-popper',
      ...
      St = Lt.supported && Object.keys(At),
      Yt = function(t, e) {
      ...
      _t = ['Edge', 'Trident', 'Firefox'],
      It = 0,
      Nt = 0;
    Nt < _t.length;
    Nt += 1
  )
    if (Dt && 0 <= navigator.userAgent.indexOf(_t[Nt])) {
      It = 1;
      break;
    }
  var i,
    Rt = Dt && window.Promise,
    Bt = Rt
      ? function(t) {
          var e = !1;
          return function() {
    ...
    Ft = qt.slice(3),
    jt = { FLIP: 'flip', CLOCKWISE: 'clockwise', COUNTERCLOCKWISE: 'counterclockwise' },
    Kt = (function() {
      function t(e, a) {
        var i = this,
  ...
  (Kt.Utils = ('undefined' == typeof window ? global : window).PopperUtils),
    (Kt.placements = qt),
    (Kt.Defaults = {
      placement: 'bottom',
      eventsEnabled: !0,
      ...
      modifiers: {
          ...
          fn: function(t) {
            ...
            if (i) {
              var o = t.offsets,
                ...
                s = n ? 'left' : 'top',
                l = n ? 'width' : 'height',
                d = { start: zt({}, s, r[s]), end: zt({}, s, r[s] + r[l] - p[l]) };
              t.offsets.popper = Ut({}, p, d[i]);
            }
            return t;
          },
        },
        ...
        preventOverflow: {
          ...
          enabled: !0,
          fn: function(t, e) {
            var a = e.boundariesElement || b(t.instance.popper);
            t.instance.reference === a && (a = b(a));
            ...
            var o = e.priority,
              ...
              p = {
                primary: function(t) {
                  var a = r[t];
                  return (
                    r[t] < i[t] && !e.escapeWithReference && (a = Et(r[t], i[t])), zt({}, t, a)
                  );
                },
                secondary: function(t) {
                  ...
                  return (
                    r[t] > i[t] &&
                      ...
                      (o = vt(r[a], i[t] - ('right' === t ? r.width : r.height))),
                    zt({}, a, o)
                  );
                },
              };
        ...
        arrow: {
          ...
          fn: function(t, e) {
            ...
            var u = n[c] + n[l] / 2 - b / 2,
              y = m(t.instance.popper),
              g = parseFloat(y['margin' + d], 10),
              x = parseFloat(y['border' + d + 'Width'], 10),
              w = u - t.offsets.popper[c] - g - x;
            return (
              (w = Et(vt(p[l] - b, w), 0)),
              (t.arrowElement = i),
              (t.offsets.arrow = ((a = {}), zt(a, c, wt(w)), zt(a, f, ''), a)),
              t
            );
          },
          element: '[x-arrow]',
        ...
        flip: {
          ...
          fn: function(t, e) {
            ...
            var a = Y(t.instance.popper, t.instance.reference, e.padding, e.boundariesElement),
        ...
        hide: {
          ...
          fn: function(t) {
            ...
            var e = t.offsets.reference,
              a = R(t.instance.modifiers, function(t) {
        ...
        computeStyle: {
          ...
          fn: function(t, e) {
            ...
            var p,
              ...
              l = b(t.instance.popper),
              d = O(l),
              c = { position: o.position },
              m = { left: kt(o.left), top: kt(o.top), bottom: kt(o.bottom), right: kt(o.right) },
        ...
        applyStyle: {
          ...
          onLoad: function(t, e, a, i, o) {
            ...
            return e.setAttribute('x-placement', p), Q(e, { position: 'absolute' }), a;
          },
  ...
  var Vt = {};
  if (Tt) {
    var Gt = Element.prototype;
    Vt =
      Gt.matches ||
      Gt.matchesSelector ||
      Gt.webkitMatchesSelector ||
      Gt.mozMatchesSelector ||
      Gt.msMatchesSelector ||
      function(t) {
        for (
  ...
  var e = Vt,
    Zt = (function() {
      function t(t) {
        var e = this;
        if ((r.call(this), !this.state.visible)) {
          if (((this._(c).isPreparingToShow = !0), this.options.wait))
            return void this.options.wait.call(this.popper, this.show.bind(this), t);
          this.options.followCursor &&
            !Lt.usingTouch &&
            (!this._(c).followCursorListener && p.call(this),
            document.addEventListener('mousemove', this._(c).followCursorListener));
          var a = Array.isArray(this.options.delay) ? this.options.delay[0] : this.options.delay;
          a
            ? (this._(c).showTimeout = setTimeout(function() {
                e.show();
              }, a))
            : this.show();
        }
      ...
      function e() {
        var t = this;
        if ((r.call(this), !!this.state.visible)) {
          this._(c).isPreparingToShow = !1;
          var e = Array.isArray(this.options.delay) ? this.options.delay[1] : this.options.delay;
          e
            ? (this._(c).hideTimeout = setTimeout(function() {
      ...
      function a() {
        var t = this,
          ...
          p = r.tooltip,
          n = i.popperOptions,
          d = 'round' === i.arrowType ? Ct.ROUND_ARROW : Ct.ARROW,
          c = p.querySelector(d),
          m = Xt({ placement: i.placement }, n || {}, {
            modifiers: Xt({}, n ? n.modifiers : {}, {
              arrow: Xt({ element: d }, n && n.modifiers ? n.modifiers.arrow : {}),
              flip: Xt(
                { enabled: i.flip, padding: i.distance + 5, behavior: i.flipBehavior },
                n && n.modifiers ? n.modifiers.flip : {}
              ),
              offset: Xt({ offset: i.offset }, n && n.modifiers ? n.modifiers.offset : {}),
            }),
            onCreate: function() {
              (p.style[ot(e)] = dt(i.distance)),
                c && i.arrowTransform && st(e, c, i.arrowTransform);
            },
            onUpdate: function() {
              var t = p.style;
              (t.top = ''),
        ...
        return (
          s.call(this, {
            ...
            callback: function() {
              var a = e.style;
              (a[o('transitionDuration')] = '0ms'),
                t.popperInstance.update(),
                ct(function() {
                  a[o('transitionDuration')] = i.updateDuration + 'ms';
                });
            },
      ...
      function i() {
        ...
        this.options.appendTo.contains(this.popper) ||
          ...
          this.popperInstance
            ? ((this.popper.style[o('transform')] = null),
              this.popperInstance.update(),
              (!this.options.followCursor || Lt.usingTouch) &&
                this.popperInstance.enableEventListeners())
            : (this.popperInstance = a.call(this)),
          this.options.followCursor &&
            !Lt.usingTouch &&
            (this.popperInstance.disableEventListeners(),
            ct(function() {
              t._(c).followCursorListener(t._(c).lastMouseMoveEvent || t._(c).lastTriggerEvent);
            })));
      }
      function r() {
        var t = this._(c),
      ...
      function p() {
        var t = this;
        this._(c).followCursorListener = function(e) {
          if (!(t._(c).lastTriggerEvent && 'focus' === t._(c).lastTriggerEvent.type)) {
            t._(c).lastMouseMoveEvent = e;
            var a = document.documentElement.offsetWidth || document.body.offsetWidth,
              i = wt(t.popper.offsetWidth / 2),
              r = wt(t.popper.offsetHeight / 2),
              p = t.options.offset,
              n = e.pageX,
              s = e.pageY,
              l = 5;
            if (t.reference.getBoundingClientRect) {
              var d = t.reference.getBoundingClientRect(),
                m = window.scrollY || document.documentElement.scrollTop,
                f = window.scrollX || document.documentElement.scrollLeft;
              if (
                t.state.visible &&
                t._(c).isPreparingToShow &&
                (n < d.left + f || n > d.right + f || s > d.bottom + m || s < d.top + m)
              )
                return;
            }
            var h = t.options.placement.replace(/-.+/, '');
            t.popper.getAttribute('x-placement') && (h = ot(t.popper));
            var b, u;
            'top' === h
              ? ((b = n - i + p), (u = s - 2 * r))
              : 'bottom' === h
              ...
              : void 0;
            ('top' === h || 'bottom' === h) &&
              (n + l + i + p > a && (b = a - l - 2 * i), 0 > n - l - i + p && (b = l)),
              (t.popper.style[o('transform')] = 'translate3d(' + b + 'px, ' + u + 'px, 0)');
          }
        };
      }
      function n() {
      ...
      function s(t) {
        ...
        if (window.MutationObserver) {
          ...
          o.observe(e, i), this._(c).mutationObservers.push(o);
        }
      }
      function d(t, a) {
        if (!t) return a();
        ...
        o('remove', this._(c).transitionendListener),
          o('add', r),
          (this._(c).transitionendListener = r);
      }
      var c = {},
        m = function(t) {
          return function(e) {
        ...
        f = (function() {
          function t(e) {
            for (var a in (Yt(this, t), e)) this[a] = e[a];
            (this.state = { destroyed: !1, visible: !1, enabled: !0 }),
              (this._ = m({ mutationObservers: [] }));
          }
          return (
            Pt(t, [
              {
                ...
                value: function(t) {
                  ...
                  if (!this.state.destroyed && this.state.enabled) {
                    var a = this.popper,
                      ...
                      m = s.backdrop,
                      f = s.content;
                    return r.refObj || document.documentElement.contains(r)
                      ? void (p.onShow.call(a),
                        (t = ft(void 0 === t ? p.duration : t, 0)),
                        bt([a, c, m], 0),
                        i.call(this),
                        ...
                        ct(function() {
                          e.state.visible &&
                            ((!p.followCursor || Lt.usingTouch) &&
                              (e.popperInstance.update(), bt([a], p.updateDuration)),
                            bt([c, m, m ? f : null], t),
                            m && getComputedStyle(m)[o('transform')],
                            p.interactive && r.classList.add('tippy-active'),
                            p.sticky && n.call(e),
                            ht([c, m], 'visible'),
                            d.call(e, t, function() {
                              p.updateDuration || c.classList.add('tippy-notransition'),
                                p.interactive && a.focus(),
                                p.onShown.call(a);
                            }));
                        }))
                      : void this.destroy();
                ...
                value: function(t) {
                  ...
                  if (!this.state.destroyed && this.state.enabled) {
                    ...
                    o.onHide.call(a),
                      ...
                      bt([p, n, n ? s : null], t),
                      ht([p, n], 'hidden'),
                      o.interactive && -1 < o.trigger.indexOf('click') && lt(i) && i.focus(),
                      ct(function() {
                        d.call(e, t, function() {
                          e.state.visible ||
                            !o.appendTo.contains(a) ||
                            (!e._(c).isPreparingToShow &&
                              document.removeEventListener(
                                'mousemove',
                                e._(c).followCursorListener
                              ),
              ...
              },
              {
                ...
                value: function() {
                  ...
                  this.state.destroyed ||
                    ...
                    ['data-original-title', 'data-tippy', 'aria-describedby'].forEach(function(e) {
                      t.reference.removeAttribute(e);
                    }),
                    this.popperInstance && this.popperInstance.destroy(),
                    this._(c).mutationObservers.forEach(function(t) {
                      t.disconnect();
                    }),
      ...
      return {
        ...
        _getEventListeners: function() {
          var a = this;
          return {
            handleTrigger: function(i) {
              if (a.state.enabled) {
                var o =
                  Lt.supportsTouch &&
                  Lt.usingTouch &&
                  ('mouseenter' === i.type || 'focus' === i.type);
                (o && a.options.touchHold) ||
                  ((a._(c).lastTriggerEvent = i),
                  'click' === i.type && 'persistent' !== a.options.hideOnClick && a.state.visible
                    ? e.call(a)
                    : t.call(a, i),
                  o && Lt.iOS && a.reference.click && a.reference.click());
              }
            },
            handleMouseleave: function(t) {
              if (
                ...
                if (a.options.interactive) {
                  var i = e.bind(a),
                    o = function t(o) {
                      var r = mt(o.target, Ct.REFERENCE),
                        p = mt(o.target, Ct.POPPER) === a.popper,
                        n = r === a.reference;
                      p ||
                        n ||
                        (rt(o, a.popper, a.options) &&
                  ...
                  return (
                    ...
                    void document.addEventListener('mousemove', o)
                  );
                }
                e.call(a);
              }
            ...
            handleBlur: function(t) {
              !t.relatedTarget || Lt.usingTouch || mt(t.relatedTarget, Ct.POPPER) || e.call(a);
            },
          };
        },
        _addMutationObserver: s,
        _createPopperInstance: a,
        _onTransitionEnd: d,
      };
    })(),
    T = Zt.Tippy,
    Qt = Zt._getEventListeners,
    $t = Zt._createPopperInstance,
    Jt = Zt._addMutationObserver,
    te = 1;
  return (
    (xt.browser = Lt),
    (xt.defaults = At),
