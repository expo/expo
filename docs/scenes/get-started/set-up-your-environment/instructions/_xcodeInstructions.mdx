...
Open Xcode, choose **Settings...** from the Xcode menu (or press <kbd>cmd ⌘</kbd> + <kbd>,</kbd>). Select **Locations** in the sidebar, then install the tools by choosing the most recent version in the **Command Line Tools** dropdown.

<ContentSpotlight
  alt="Locations settings in Xcode with a version selected in the Command Line Tools dropdown."
