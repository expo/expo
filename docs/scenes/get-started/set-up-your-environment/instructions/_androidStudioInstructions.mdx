...
<ContentSpotlight
  alt="Android Studio SDK Components setup"
  src="/static/images/android-studio/sdk-components-setup.png"
...
Open Android Studio, go to **Settings** &gt; **Languages & Frameworks** &gt; **Android SDK**. From the **SDK Platforms** tab, and under **Android 15 (`VanillaIceCream`)**, select:

- **Android SDK Platform 35**
- **Sources for Android 35**
- **Google Play ARM 64 v8a System Image**/**Google Play Intel x86_64 Atom System Image**
- **Pre-Release 16 KB Page Size Google Play ARM 64 v8a System Image**/**Pre-Release 16 KB Page Size Google Play Intel x86_64 Atom System Image**

The last two images are required to set up an [Android Emulator](/workflow/android-studio-emulator/#set-up-an-emulator).
...
<ContentSpotlight
  alt="Android SDK Platforms"
  src="/static/images/android-studio/windows-sdk-platforms.png"
  className="max-w-[640px]"
/>
...
<ContentSpotlight
  alt="Android SDK build tools"
  src="/static/images/android-studio/windows-build-tools.png"
  className="max-w-[640px]"
/>
