...
Open Android Studio, go to **Settings** &gt; **Appearance & Behaviour** &gt; **System Settings** &gt; **Android SDK**. From the **SDK Platforms** tab, select the latest Android version (API level).
