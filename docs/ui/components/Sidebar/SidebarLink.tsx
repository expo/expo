  ...
  return (
    <LinkBase
      ...
      {info.isNew && (
        <div
          className={mergeClasses(
            'ml-2 inline-flex h-4.25 items-center self-baseline rounded-full border border-palette-blue10 px-1.25 text-[10px] leading-none font-semibold text-palette-white',
            isSelected
      ...
      {info.isAlpha && (
        <div
          className={mergeClasses(
            'ml-2 inline-flex h-4.25 items-center self-baseline rounded-full border border-palette-purple10 px-1.25 text-[10px] leading-none font-semibold text-palette-white',
            isSelected
