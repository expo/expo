    ...
    <>
      ...
      <GridContainer>
        <GridCell
          ...
          <AppleAppStoreIcon className="text-palette-purple10 absolute left-auto -right-10 -bottom-16 size-72! opacity-10" />
        ...
        <GridCell
          ...
          <Cloud01DuotoneIcon className="absolute left-auto -right-8 -bottom-20 size-80! text-[#1e8a5f] opacity-10 dark:text-[#4eca8c]" />
          <div className="relative z-10 flex flex-col gap-4">
