...
// Initialized value from injected or inline variable
let cachedBaseUrl: string | null = process.env.EXPO_DOM_BASE_URL ?? null;

export function setupDomProcessEnv() {
  Object.defineProperty(process.env, 'EXPO_DOM_BASE_URL', {
    get() {
      ...
      const ExpoUpdates =
        requireOptionalNativeModule<import('expo-updates').ExpoUpdatesModule>('ExpoUpdates');
