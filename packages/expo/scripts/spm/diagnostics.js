  ...
  if (linkedThrough != null) {
    ...
    return renderBlock(
      ...
      [
        ...
        turnOff != null
          ? `If the app does not need "${productName}", ${turnOff}. If ios/ is generated by npx expo prebuild, set the matching option in the module's config plugin instead.`
          : `The app cannot turn "${productName}" off on its own, because CocoaPods links it whenever ${because}.`,
