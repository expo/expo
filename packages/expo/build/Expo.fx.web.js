...
if (__DEV__) {
    ...
    Platform.OS === 'web' &&
        ...
        Object.defineProperty(global, '__fbBatchedBridgeConfig', {
            get() {
                // Provide a more
                throw new Error("Your web project is importing a file in 'react-native' instead of 'react-native-web'. Learn more: https://expo.fyi/fb-batched-bridge-config-web");
            },
        });
    }
}
