...
import { // React Native's internal InitializeCore module sets up `window` but runs only when its React
...
if (shouldThrowAnErrorOutsideOfExpo() && !(Constants === null || Constants === void 0 ? void 0 : Constants.expoVersion) && (Constants === null || Constants === void 0 ? void 0 : Constants.executionEnvironment) !== ExecutionEnvironment.Bare) {
