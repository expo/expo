...
- Fix `import.meta.url` being `null` on web when `transform.inlineRequires` is enabled. ([#49024](https://github.com/expo/expo/issues/49024) by [@expo-bot](https://github.com/expo-bot))
