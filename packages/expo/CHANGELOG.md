...
- [Android] Avoid Kotlin reflection while initializing Expo packages and the React activity delegate. ([#50484](https://github.com/expo/expo/pull/50484) by [@matthew-gizmo](https://github.com/matthew-gizmo))
