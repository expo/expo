...
- [Web] Stub `requestAnimationFrame` in server bundles, where `react-native-worklets` 0.12 calls it unguarded when Reanimated is imported, crashing server rendering and `expo export`. ([@robhogan](https://github.com/robhogan)) ([#50507](https://github.com/expo/expo/pull/50507) by [@robhogan](https://github.com/robhogan))
