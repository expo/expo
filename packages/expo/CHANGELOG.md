...
- Bump recommended `react-native-get-random-values` version to `~2.0.0` in `bundledNativeModules.json` ([#48643](https://github.com/expo/expo/pull/48643) by [@cucumber-sp](https://github.com/cucumber-sp))
