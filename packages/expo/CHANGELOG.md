...
- Split repeated headers in `expo/fetch` (such as multiple `Set-Cookie`) into individual entries to match Android's behavior, instead of comma-joining them. ([#46401](https://github.com/expo/expo/pull/46401) by [@renbaoshuo](https://github.com/renbaoshuo))
