...
- [Web] Fixed `expo/types` redeclaring style members that React Native 0.88 now declares itself, which made `ViewStyle` unassignable to `View` and `ViewProps` unassignable to `Pressable`. ([#50504](https://github.com/expo/expo/issues/50504), [#50524](https://github.com/expo/expo/issues/50524) by [@Maher-Reven](https://github.com/Maher-Reven))
