...
- Fix `TypeError: Cannot read property 'reload' of undefined` when an async chunk loads after Metro disconnects in a native project without `@expo/metro-runtime`. ([#48932](https://github.com/expo/expo/issues/48932))
