...
- Fix `import.meta.url` being `null` on web when `transform.inlineRequires` is enabled. ([#49024](https://github.com/expo/expo/issues/49024)) ([#49045](https://github.com/expo/expo/pull/49045) by [@expo-bot](https://github.com/expo-bot))
