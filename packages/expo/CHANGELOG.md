...
- Pin `react-native-web` to `~0.21.2` in `bundledNativeModules.json` and the templates. 0.21.2 is the first release that forwards `inert` to the DOM. (by [@hassankhan](https://github.com/hassankhan))
