...
async function _resolveTurboModule(resolution, projectConfig, platform, excludeNames) {
...
async function createReactNativeConfigAsync(providedOptions) {
    ...
    const dependencies = await (0, dependencies_1.filterMapResolutionResult)(resolutions, (resolution) => _resolveTurboModule(resolution, projectConfig, options.platform, excludeNames));
    return {
