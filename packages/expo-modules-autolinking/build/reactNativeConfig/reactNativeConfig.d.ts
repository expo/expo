 ...
 */
export declare function createReactNativeConfigAsync({ platform, projectRoot, searchPaths, transitiveLinkingDependencies, sourceDir, }: RNConfigCommandOptions): Promise<RNConfigResult>;
/**
