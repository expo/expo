...
async function resolveModuleAsync(packageName, revision, options) {
    ...
    return {
        ...
        appDelegateSubcontractors: (_b = revision.config) === null || _b === void 0 ? void 0 : _b.iosAppDelegateSubcontractors(),
    };
}
...
async function generatePackageListFileContentAsync(modules, className) {
    const modulesToImport = modules.filter((module) => module.modulesClassNames.length + module.appDelegateSubcontractors.length > 0);
