...
function generateModulesProviderCommand(cli) {
    return (0, autolinkingOptions_1.registerAutolinkingArguments)(cli.command('generate-modules-provider <watchedDirectoriesSerialized> [searchPaths...]'))
        ...
        .action(async (watchedDirectoriesSerialized, searchPaths, commandArguments) => {
