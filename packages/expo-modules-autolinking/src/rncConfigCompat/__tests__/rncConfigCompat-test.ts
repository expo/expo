...
describe(createRncConfigCompatAsync, () => {
  ...
  it('should return config', async () => {
    ...
    const result = await createRncConfigCompatAsync({
      platform: 'ios',
      projectRoot: '/app',
...
describe(resolveDependencyConfigAsync, () => {
  const mockLoadReactNativeConfigAsync = loadReactNativeConfigAsync as jest.MockedFunction<
    typeof loadReactNativeConfigAsync
  >;
  const mockPlatformResolverIos = resolveDependencyConfigImplIosAsync as jest.MockedFunction<
    typeof resolveDependencyConfigImplIosAsync
  >;
  ...
  it('should call platform resolver with config from library', async () => {
    const libraryConfig: RncConfigCompatReactNativeLibraryConfig = {
      dependency: {
        platforms: {
          ios: {
  ...
  it('should call platform resolver with merged config and project config will override library config', async () => {
    const projectConfig: RncConfigCompatReactNativeProjectConfig = {
      dependencies: {
        'react-native-test': {
          platforms: {
            ios: null,
