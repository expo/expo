...
- Fixed `expo_patch_react_imports!` missing some lines it was meant to patch ([#23923](https://github.com/expo/expo/pull/23923) by [@liamjones](https://github.com/liamjones))
