...
- Source platform identity data (react-native host package names, Apple-family membership) from `@expo/platform-metadata` instead of local switches. No behavior change. ([#46587](https://github.com/expo/expo/pull/46587) by [@douglowder](https://github.com/douglowder))
