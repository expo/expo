...
- [iOS] Add a prebuilt dependency's XCFramework header directories to the `HEADER_SEARCH_PATHS` of source-built pods that depend on it, fixing missing header file errors.
