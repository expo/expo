...
- [iOS] Added the `sceneDelegateSubscribers` module config option and generate `getSceneDelegateSubscribers()` in the modules provider. ([#46792](https://github.com/expo/expo/pull/46792) by [@tsapeta](https://github.com/tsapeta))
