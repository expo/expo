...
- Publish a product's `autolinkWhen` condition in the prebuilt-metadata document, so consumers other than CocoaPods can apply the same gate. ([#50489](https://github.com/expo/expo/pull/50489) by [@chrfalch](https://github.com/chrfalch))
