...
class MediaLibraryPermissionPromiseWrapper(
  ...
  override fun resolve(value: Any?) {
    val permissionsBundle = value as? Bundle ?: run {
      promise.resolve(value)
      return
    }
    promise.resolve(addOnlySelectedInfoToPermissionsBundle(permissionsBundle, granularPermissions))
  }
