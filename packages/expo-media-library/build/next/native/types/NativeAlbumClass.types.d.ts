...
export declare class NativeAlbumClass {
    ...
    static create(name: string, assetsRefs: string[] | NativeAssetClass[], moveAssets?: boolean): Promise<NativeAlbumClass>;
...
//# sourceMappingURL=NativeAlbumClass.types.d.ts.map