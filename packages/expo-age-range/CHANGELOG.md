...
- [Android] Add `setFakeAgeSignals` to report Google Play's `FakeAgeSignalsManager` signals from JS, so an app can be tested against age ranges Google Play does not report to its own accounts. ([#48909](https://github.com/expo/expo/pull/48909) by [@kmadden84](https://github.com/kmadden84))
