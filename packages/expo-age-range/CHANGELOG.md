...
- [iOS] Add `isEligibleForAgeFeaturesAsync` to expose Apple's `AgeRangeService.isEligibleForAgeFeatures` (iOS 26.2+). Resolves with `null` on unsupported OS versions, other platforms, or errors.
