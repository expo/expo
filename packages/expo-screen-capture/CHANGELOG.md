...
- [iOS] Sized the screenshot and recording blockers from the window they protect rather than the device's main screen, so they still cover the content on a two-display device such as iPhone Duo.
