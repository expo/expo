 ...
 */
export default function makeInterruptible<Arguments extends any[] = any[], Result = void>(func: (signal: AbortSignal, ...args: Arguments) => Generator<unknown, Result, unknown>): [(...args: Arguments) => Promise<Result | undefined>, () => boolean, () => void];
