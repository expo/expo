...
open class ExpoNotificationBuilder(
  ...
  open fun addActionsToBuilder(
    ...
    try {
      val category = store.getNotificationCategory(categoryIdentifier) ?: throw InvalidArgumentException("The category \"$categoryIdentifier\" does not exist, did you call `setNotificationCategoryAsync()`?")
