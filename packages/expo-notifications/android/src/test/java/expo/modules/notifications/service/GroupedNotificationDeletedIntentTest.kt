...
class GroupedNotificationDeletedIntentTest {
  ...
  private fun notification(identifier: String, autoDismiss: Boolean = false): Notification {
    val content = NotificationContent.Builder().setTitle("Title").setGroup("group-a").setAutoDismiss(autoDismiss).build()
