...
- [Android] Add an `enableBigPictureStyle` config plugin property to display remote notification images in the expanded notification layout. (by [@felipe-software](https://github.com/felipe-software))
