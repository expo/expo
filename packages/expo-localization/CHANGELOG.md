...
- Changing locale on Android no longer reloads the app if the `expo-localization` config plugin is added to app.json. ([#22763](https://github.com/expo/expo/pull/22003) by [@aleqsio](https://github.com/aleqsio))
- Added hooks to get current locale and calendar. ([#22763](https://github.com/expo/expo/pull/22003) by [@aleqsio](https://github.com/aleqsio))
- Measurement system now returns `uk` and `us` values on iOS 16 and higher. ([#22763](https://github.com/expo/expo/pull/22003) by [@aleqsio](https://github.com/aleqsio))

### 🐛 Bug fixes

- User settings for delimiters and other locale preferences now override default locale settings for each locale in the list. ([#22763](https://github.com/expo/expo/pull/22003) by [@aleqsio](https://github.com/aleqsio))
