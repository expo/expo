...
function _svgModules() {
  const data = require("./svg-modules");
  _svgModules = function () {
    return data;
  };
  return data;
}
...
async function transform(config, projectRoot, filename, data, options) {
  ...
  if ((_options$customTransf = options.customTransformOptions) !== null && _options$customTransf !== void 0 && _options$customTransf['svg-modules']) {
    if ((0, _svgModules().matchSvgModule)(filename)) {
      return (0, _svgModules().transformSvg)(config, projectRoot, filename, data, {
        ...options,
  ...
  if ((_options$customTransf2 = options.customTransformOptions) !== null && _options$customTransf2 !== void 0 && _options$customTransf2['css-modules']) {
    if (/\.(s?css|sass)$/.test(filename)) {
      return transformCss(config, projectRoot, filename, data, options);
    }
  }
  const environment = (_options$customTransf3 = options.customTransformOptions) === null || _options$customTransf3 === void 0 ? void 0 : _options$customTransf3.environment;
