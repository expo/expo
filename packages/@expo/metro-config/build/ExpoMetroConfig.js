...
function getDefaultConfig(projectRoot, {
  ...
  const metroConfig = mergeConfig(metroDefaultValues, {
    ...
    transformer: {
      ...
      asyncRequireModulePath: _resolveFrom().default.silent(projectRoot, '@expo/metro-runtime') ? require.resolve('@expo/metro-runtime/async-require') : (0, _resolveFrom().default)(reactNativePath, metroDefaultValues.transformer.asyncRequireModulePath),
