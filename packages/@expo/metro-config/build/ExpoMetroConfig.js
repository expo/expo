...
const EXPO_NO_METRO_SERVER_ROOT = (0, _getenv().boolish)('EXPO_NO_METRO_SERVER_ROOT', false);
...
function getDefaultConfig(projectRoot, options = {}) {
  ...
  return MetroConfig.mergeConfig(metroDefaultValues, {
    ...
    server: {
      ...
      unstable_serverRoot: EXPO_NO_METRO_SERVER_ROOT ? projectRoot : (_getWorkspaceRoot = (0, _getModulesPaths().getWorkspaceRoot)(projectRoot)) !== null && _getWorkspaceRoot !== void 0 ? _getWorkspaceRoot : projectRoot
    },
    symbolicator: {
