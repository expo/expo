...
export declare function createSerializerFromSerialProcessors(config: ConfigT, processors: (SerializerPlugin | undefined)[], originalSerializer?: Serializer): Serializer;
export { SerialAsset };
