...
- Emit a density `srcset` for multi-resolution image assets on web, so `@2x`/`@3x` files are used on high-density screens. ([#34136](https://github.com/expo/expo/issues/34136)) ([#48746](https://github.com/expo/expo/pull/48746) by [@expo-bot](https://github.com/expo-bot))
