...
- Include moduleIDs when hashing chunks of JS. ([#29733](https://github.com/expo/expo/pull/30224) by [@byCedric](https://github.com/byCedric))
...
- Upgrade `glob@7` to `glob@10`. ([#30224](https://github.com/expo/expo/pull/29929) by [@Nsquik](https://github.com/Nsquik))
