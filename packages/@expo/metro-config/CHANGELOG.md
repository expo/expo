...
- Tree-shake unused exports of namespace imports (`import * as X from './m'`) when only specific properties are accessed ([#33753](https://github.com/expo/expo/issues/33753) by [@williamrobertson13](https://github.com/williamrobertson13))
