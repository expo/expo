...
- Add detection for CJS module exports for tree shaking.
...
- Fix support for defining variables named `module`, `require`, `global`, and `exports` with `experimentalImportSupport`.
