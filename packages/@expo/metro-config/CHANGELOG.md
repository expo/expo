...
- Fix RSC serializer plugin to handle asset file:// URLs and convert them to stable IDs. ([#41823](https://github.com/expo/expo/pull/41823) by [@kimchi-developer](https://github.com/kimchi-developer))
