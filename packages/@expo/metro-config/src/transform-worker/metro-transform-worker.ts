...
import generateImportNames from '@bycedric/metro/metro/src/ModuleGraph/worker/generateImportNames';
...
import getMinifier from '@bycedric/metro/metro-transform-worker/src/utils/getMinifier';
...
interface ExpoJSFile extends JSFile {
...
async function transformJSWithBabel(
  ...
  ) as typeof import('../babel-transformer').default;
