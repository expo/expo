...
/**
 * Get the nearest source location from the given path, can be both from the node itself, parent (preferred) or child (loc estimate as a fallback).
 */
function getNearestLocFromPath(path: NodePath<any>): t.SourceLocation | null {
  ...
  // This is a case for example for imports generated by `transform-export-namespace-from` plugin.
