...
exports.shouldSkipAutoPlugin = exports.resolvePackagesList = exports.getAutolinkedPackagesAsync = void 0;
const importExpoModulesAutolinking_1 = require("./importExpoModulesAutolinking");
/**
...
async function getAutolinkedPackagesAsync(projectRoot, platforms = ['ios', 'android']) {
    const autolinking = (0, importExpoModulesAutolinking_1.importExpoModulesAutolinking)(projectRoot);
