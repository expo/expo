...
var _default = (0, _createLegacyPlugin().createLegacyPlugin)({
  ...
  fallback: [
  // Android
  _withAndroidFacebook().withFacebookAppIdString, _withAndroidFacebook().withFacebookManifest,
  // iOS
  _withIosFacebook().withIosFacebook, [_withSKAdNetworkIdentifiers().withSKAdNetworkIdentifiers,
