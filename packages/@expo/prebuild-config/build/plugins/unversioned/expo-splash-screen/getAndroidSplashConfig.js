...
function getAndroidSplashConfig(config) {
  ...
  if ((_config$android = config.android) !== null && _config$android !== void 0 && _config$android.splash) {
    var _config$android2, _ref, _splash$xxxhdpi, _ref2, _splash$xxhdpi, _ref3, _splash$xhdpi, _ref4, _splash$hdpi, _ref5, _splash$mdpi, _splash$backgroundCol, _splash$resizeMode, _splash$fadeTime;
  ...
  if (config.splash) {
    var _splash$image, _splash$image2, _splash$image3, _splash$image4, _splash$image5, _splash$backgroundCol2, _splash$resizeMode2, _splash$fadeTime2;
...
function getAndroidDarkSplashConfig(config) {
  ...
  if ((_config$android3 = config.android) !== null && _config$android3 !== void 0 && (_config$android3$spla = _config$android3.splash) !== null && _config$android3$spla !== void 0 && _config$android3$spla.dark) {
    var _config$android4, _config$android4$spla, _ref6, _splash$xxxhdpi2, _ref7, _splash$xxhdpi2, _ref8, _splash$xhdpi2, _ref9, _splash$hdpi2, _ref10, _splash$mdpi2, _splash$backgroundCol3, _lightTheme$resizeMod, _splash$fadeTime3;
    ...
    return {
      ...
      fadeTime: (_splash$fadeTime3 = splash['fadeTime']) !== null && _splash$fadeTime3 !== void 0 ? _splash$fadeTime3 : 0
    };
  }
  return null;
}
