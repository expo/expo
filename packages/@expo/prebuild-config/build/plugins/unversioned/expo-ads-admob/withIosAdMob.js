...
function getGoogleMobileAdsAppId(config) {
  ...
  return (_config$ios$config$go = (_config$ios = config.ios) === null || _config$ios === void 0 || (_config$ios = _config$ios.config) === null || _config$ios === void 0 ? void 0 : _config$ios.googleMobileAdsAppId) !== null && _config$ios$config$go !== void 0 ? _config$ios$config$go : null;
}
