...
function LogBoxInspectorContainer() {
    ...
    return (react_1.default.createElement(ContextDevServer_1.DevServerContext, null,
...
function LogBoxInspector({ log, selectedLogIndex, logs, }) {
    ...
    return (react_1.default.createElement("div", { className: [
            ...
            process.env.EXPO_DOM_HOST_OS === 'ios' ? Overlay_module_css_1.default.overlayIos : null,
            process.env.EXPO_DOM_HOST_OS === 'android' ? Overlay_module_css_1.default.overlayAndroid : null,
            process.env.EXPO_DOM_HOST_OS === undefined ? Overlay_module_css_1.default.overlayWeb : null,
        ]
            .filter(Boolean)
            .join(' ') },
        react_1.default.createElement("div", { "data-expo-log-backdrop": "true", className: process.env.EXPO_DOM_HOST_OS === undefined
                ? `${Overlay_module_css_1.default.bg} ${closing ? Overlay_module_css_1.default.bgExit : ''}`
                : undefined, onClick: () => {
                if (isDismissable) {
                    onMinimize();
                }
            } }),
        react_1.default.createElement("div", { className: (0, classNames_1.classNames)(Overlay_module_css_1.default.container, process.env.EXPO_DOM_HOST_OS !== 'android' && Overlay_module_css_1.default.containerTopRadius, closing && Overlay_module_css_1.default.containerExit) },
...
function LogBoxContent({ log, selectedLogIndex, logs, isDismissable, onMinimize, }) {
    ...
    const { onReload, onCopyText } = (0, ContextActions_1.useActions)();
    const onCopy = () => {
    ...
    return (react_1.default.createElement("div", { className: Overlay_module_css_1.default.content },
        ...
        react_1.default.createElement("div", { className: Overlay_module_css_1.default.scroll, ref: scrollRef },
            ...
            react_1.default.createElement("div", { style: { padding: '0 1rem 3.5rem', gap: 10, display: 'flex', flexDirection: 'column' } },
                codeFrames.map(([key, codeFrame]) => {
                    ...
                    return (react_1.default.createElement(CodeFrame_1.ErrorCodeFrame, { key: key, showPathsRelativeTo: serverRoot, codeFrame: codeFrame }));
                }),
