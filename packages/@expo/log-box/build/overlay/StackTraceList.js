...
function Transition({ children, status, onExitComplete, isInitial, index, initialDelay = 50, }) {
    ...
    return (react_1.default.createElement("div", { ref: ref, className: StackTraceList_module_css_1.default.transition }, children));
}
...
function StackTraceList({ onRetry, type, stack, symbolicationStatus, }) {
    ...
    return (react_1.default.createElement("div", { className: StackTraceList_module_css_1.default.root },
        react_1.default.createElement("div", { ref: ref, className: StackTraceList_module_css_1.default.header },
            react_1.default.createElement("div", { className: StackTraceList_module_css_1.default.headerLeft },
                type === 'component' ? (react_1.default.createElement(ReactIcon, { stroke: "unset", className: StackTraceList_module_css_1.default.headerIcon })) : (react_1.default.createElement(JavaScriptIcon, { className: StackTraceList_module_css_1.default.headerIcon })),
                react_1.default.createElement("h3", { className: StackTraceList_module_css_1.default.headerTitle }, type === 'component' ? 'Component Stack' : 'Call Stack'),
                react_1.default.createElement("span", { "data-text": true, className: StackTraceList_module_css_1.default.badge }, stackCount),
            ...
            react_1.default.createElement("button", { className: StackTraceList_module_css_1.default.collapseButton, onClick: () => setCollapsed(!collapsed) },
                react_1.default.createElement("div", { title: collapseTitle.full, className: StackTraceList_module_css_1.default.collapseContent },
                    react_1.default.createElement("span", { className: StackTraceList_module_css_1.default.collapseTitle }, containerWidth > 440 ? collapseTitle.full : collapseTitle.short),
                    react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, collapsed ? (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        symbolicationStatus !== 'COMPLETE' && (react_1.default.createElement("div", { className: StackTraceList_module_css_1.default.warningBox },
            react_1.default.createElement("span", { className: StackTraceList_module_css_1.default.warningText }, "This call stack is not symbolicated. Some features are unavailable such as viewing the function name or tapping to open files."))),
        react_1.default.createElement("div", { className: StackTraceList_module_css_1.default.list },
            react_1.default.createElement(List, { initialDelay: initialDelay, items: stackTraceItems, showCollapsed: !collapsed, isInitial: isInitial }))));
}
function StackTraceItem({ frame, onPress, isLaunchable, }) {
    ...
    return (react_1.default.createElement("div", { "aria-disabled": !isLaunchable ? true : undefined, onClick: onPress, className: StackTraceList_module_css_1.default.stackFrame, "data-collapsed": frame.collapse === true ? '' : undefined },
