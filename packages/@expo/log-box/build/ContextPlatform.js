...
const RuntimePlatformContext = (0, react_1.createContext)(undefined);
const RuntimePlatformProvider = ({ children, platform, }) => {
    const isNative = (0, react_1.useMemo)(() => {
...
const useRuntimePlatform = () => {
    const context = (0, react_1.useContext)(RuntimePlatformContext);
