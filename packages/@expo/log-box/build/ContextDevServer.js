...
exports.useDevServer = exports.DevServerProvider = void 0;
...
const DevServerContext = (0, react_1.createContext)(undefined);
const DevServerProvider = ({ children, }) => {
    const meta = useProjectMetadataFromServer();
    return (react_1.default.createElement(DevServerContext.Provider, { value: {
...
const useDevServer = () => {
    const context = (0, react_1.useContext)(DevServerContext);
