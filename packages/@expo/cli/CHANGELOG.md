...
- Make `expo prebuild` clear and regenerate the native folders by default. Pass `--no-clean` to keep the existing folders instead. ([#47209](https://github.com/expo/expo/pull/47209) by [@alanjhughes](https://github.com/alanjhughes))
