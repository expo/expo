...
- Allow `expo start`, `expo export`, and `expo config` to work without `react-native` installed for web-only projects. ([#XXXX](https://github.com/expo/expo/pull/XXXX) by [@evanbacon](https://github.com/evanbacon))
