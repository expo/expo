...
- Add experimental `tvos` and `macos` autolinking gated by `experiments.outOfTreePlatforms` ([#46344](https://github.com/expo/expo/pull/46344) by [@kitten](https://github.com/kitten))
