...
- Add a static-rendering e2e route that streams two pending `Suspense` boundaries. ([#49684](https://github.com/expo/expo/pull/49684) by [@hassankhan](https://github.com/hassankhan))
