...
- Print installed skills on `npx expo install` when a coding agent is detected, opt out with `--no-skill-context`. ([#49018](https://github.com/expo/expo/pull/49018) by [@kudo](https://github.com/kudo))
