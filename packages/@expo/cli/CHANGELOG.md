...
- Sync agent skills automatically on `npx expo install` when `expo.skills.autoSync` is enabled, opt out per run with `--no-agent-skills`. ([#48972](https://github.com/expo/expo/pull/48972) by [@kudo](https://github.com/kudo))
