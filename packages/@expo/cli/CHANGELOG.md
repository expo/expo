...
- Remove deprecated ban-types eslint rule and replace it with eslint-disable ([#41637](https://github.com/expo/expo/pull/41637) by [@matinzd](https://github.com/matinzd))
