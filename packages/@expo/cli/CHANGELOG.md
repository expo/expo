...
- Enable inverse dependency stack trace (`EXPO_METRO_UNSTABLE_ERRORS`) for Metro bundling errors by default ([#38295](https://github.com/expo/expo/pull/38295) by [@krystofwoldrich](https://github.com/krystofwoldrich))
