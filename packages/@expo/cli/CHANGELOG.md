...
- Stop logging `ERR_STREAM_UNABLE_TO_PIPE` when a client disconnects while the manifest is being resolved ([#48660](https://github.com/expo/expo/pull/48660) by [@ahmdshrif](https://github.com/ahmdshrif))
