...
declare module 'metro-transform-plugins/src/addParamsToDefineCall' {
   ...
   */
  function addParamsToDefineCall(code: string, ...paramsToAdd: Array<any>): string;
...
declare module 'metro-transform-plugins/src/import-export-plugin' {
  ...
  function importExportPlugin($$PARAM_0$$: {
    types: Types;
  }): PluginObj<State>;
...
declare module 'metro-transform-plugins/src/normalizePseudoGlobals' {
  ...
  function normalizePseudoglobals(ast: _babel_types.Node, options?: Options): ReadonlyArray<string>;
