...
import {
  createMetroServerAndBundleRequestAsync as internal_createMetroServerAndBundleRequestAsync,
...
export const createMetroServerAndBundleRequestAsync: typeof internal_createMetroServerAndBundleRequestAsync = async (
  projectRoot,
  options,
) => {
