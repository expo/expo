...
export namespace ExpoRouter {
  export type StaticRoutes = `/(a)/folder` | `/(b)/folder` | `/(group)/(a)/folder` | `/(group)/(b)/folder` | `/(group)/folder` | `/(group)/static` | `/_sitemap` | `/apple` | `/banana` | `/folder` | `/static`;
  ...
  export type DynamicRouteTemplate = `/(a)/folder/[...slug]` | `/(a)/folder/[slug]` | `/(b)/folder/[...slug]` | `/(b)/folder/[slug]` | `/(group)/(a)/folder/[...slug]` | `/(group)/(a)/folder/[slug]` | `/(group)/(b)/folder/[...slug]` | `/(group)/(b)/folder/[slug]` | `/(group)/folder/[...slug]` | `/(group)/folder/[slug]` | `/animals/[...animal]` | `/colors/[color]` | `/folder/[...slug]` | `/folder/[slug]` | `/mix/[fruit]/[color]/[...animals]`;
