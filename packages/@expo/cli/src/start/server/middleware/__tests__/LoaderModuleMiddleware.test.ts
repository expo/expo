...
import { LoaderModuleMiddleware } from '../LoaderModuleMiddleware';
...
describe(LoaderModuleMiddleware, () => {
  ...
  let middleware: LoaderModuleMiddleware;
  ...
  beforeEach(() => {
    ...
    middleware = new LoaderModuleMiddleware(
      mockProjectRoot,
