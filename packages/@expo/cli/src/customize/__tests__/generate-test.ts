...
describe(queryAndGenerateAsync, () => {
  it(`asserts an invalid file`, async () => {
    await expect(
      ...
      `"Invalid files: file1, file2. Allowed: babel.config.js, metro.config.js, tsconfig.json, .eslintrc.js, eslint.config.js, web/index.html, webpack.config.js, app/+html.tsx, app/+native-intent.ts"`
    );
  });
