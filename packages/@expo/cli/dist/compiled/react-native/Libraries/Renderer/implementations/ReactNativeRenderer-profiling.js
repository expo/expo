...
for (pluginName$jscomp$inline_242 in injectedNamesToPlugins$jscomp$inline_240) if (injectedNamesToPlugins$jscomp$inline_240.hasOwnProperty(pluginName$jscomp$inline_242)) {
  var pluginModule$jscomp$inline_243 = injectedNamesToPlugins$jscomp$inline_240[pluginName$jscomp$inline_242];
  if (!namesToPlugins.hasOwnProperty(pluginName$jscomp$inline_242) || namesToPlugins[pluginName$jscomp$inline_242] !== pluginModule$jscomp$inline_243) {
    if (namesToPlugins[pluginName$jscomp$inline_242]) throw Error("EventPluginRegistry: Cannot inject two different event plugins using the same name, `" + (pluginName$jscomp$inline_242 + "`."));
    namesToPlugins[pluginName$jscomp$inline_242] = pluginModule$jscomp$inline_243;
...
function movePendingFibersToMemoized(root, lanes) {
  if (isDevToolsPresent) for (var pendingUpdatersLaneMap = root.pendingUpdatersLaneMap, memoizedUpdaters = root.memoizedUpdaters; 0 < lanes;) {
    ...
    0 < index$11.size && (index$11.forEach(function (fiber) {
      var alternate = fiber.alternate;
  ...
  switch (deletedFiber.tag) {
    ...
    case 1:
      ...
      if ("function" === typeof prevHostParent.componentWillUnmount) try {
        if (prevHostParent.props = deletedFiber.memoizedProps, prevHostParent.state = deletedFiber.memoizedState, deletedFiber.mode & 2) try {
      ...
      if (flags & 4) {
        ...
        if (null != instance$98) {
          ...
          if (null !== updatePayload) try {
            ...
            null != updatePayload$jscomp$0 && ReactNativePrivateInterface.UIManager.updateView(instance$98._nativeTag, viewConfig.uiViewClassName, updatePayload$jscomp$0);
          } catch (error$99) {
      ...
      if (flags & 8192) a: for (viewConfig = null !== finishedWork.memoizedState, finishedWork.stateNode.isHidden = viewConfig, updatePayload$jscomp$0 = null, current = finishedWork;;) {
        if (5 === current.tag) {
          if (null === updatePayload$jscomp$0) {
            ...
            try {
              if (instance$98 = current.stateNode, viewConfig) newProps = instance$98.viewConfig, oldProps = diffProperties(null, emptyObject, {
                style: {
                  display: "none"
                }
              }, newProps.validAttributes), ReactNativePrivateInterface.UIManager.updateView(instance$98._nativeTag, newProps.uiViewClassName, oldProps);else {
    ...
    try {
      ...
      switch (JSCompiler_inline_result.tag) {
        ...
        case 4:
          ...
          insertOrAppendPlacementNodeIntoContainer(finishedWork, before$92, parent$91);
          break;
        default:
          ...
          switch (root.tag) {
            ...
            case 1:
              ...
              if (0 === (root.flags & 128) && ("function" === typeof ctor.getDerivedStateFromError || null !== instance && "function" === typeof instance.componentDidCatch && (null === legacyErrorBoundariesThatAlreadyFailed || !legacyErrorBoundariesThatAlreadyFailed.has(instance)))) {
                ...
                thrownValue &= -thrownValue;
                root.lanes |= thrownValue;
                var update$36 = createClassErrorUpdate(root, wakeable, thrownValue);
...
var internals$jscomp$inline_1310 = {
  ...
  findFiberByHostInstance: devToolsConfig$jscomp$inline_1022.findFiberByHostInstance || emptyFindFiberByHostInstance,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  ...
  if (!hook$jscomp$inline_1311.isDisabled && hook$jscomp$inline_1311.supportsFiber) try {
    rendererID = hook$jscomp$inline_1311.inject(internals$jscomp$inline_1310), injectedHook = hook$jscomp$inline_1311;
  } catch (err) {}
}
...
exports.render = function (element, containerTag, callback) {
  ...
  if (!root) {
    ...
    JSCompiler_inline_result = createFiber(3, null, null, JSCompiler_inline_result);
