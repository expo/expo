...
function movePendingFibersToMemoized(root, lanes) {
  if (isDevToolsPresent) for (var pendingUpdatersLaneMap = root.pendingUpdatersLaneMap, memoizedUpdaters = root.memoizedUpdaters; 0 < lanes;) {
    ...
    0 < index$10.size && (index$10.forEach(function (fiber) {
      var alternate = fiber.alternate;
...
function cutOffTailIfNeeded(renderState, hasRenderedATailFallback) {
  switch (renderState.tailMode) {
    ...
    case "collapsed":
      ...
      for (var lastTailNode$65 = null; null !== lastTailNode;) null !== lastTailNode.alternate && (lastTailNode$65 = lastTailNode), lastTailNode = lastTailNode.sibling;
      null === lastTailNode$65 ? hasRenderedATailFallback || null === renderState.tail ? renderState.tail = null : renderState.tail.sibling = null : lastTailNode$65.sibling = null;
  }
}
function bubbleProperties(completedWork) {
  ...
  if (didBailout) {
    if (0 !== (completedWork.mode & 2)) {
      for (var treeBaseDuration$67 = completedWork.selfBaseDuration, child$68 = completedWork.child; null !== child$68;) newChildLanes |= child$68.lanes | child$68.childLanes, subtreeFlags |= child$68.subtreeFlags & 14680064, subtreeFlags |= child$68.flags & 14680064, treeBaseDuration$67 += child$68.treeBaseDuration, child$68 = child$68.sibling;
      completedWork.treeBaseDuration = treeBaseDuration$67;
    } else for (treeBaseDuration$67 = completedWork.child; null !== treeBaseDuration$67;) newChildLanes |= treeBaseDuration$67.lanes | treeBaseDuration$67.childLanes, subtreeFlags |= treeBaseDuration$67.subtreeFlags & 14680064, subtreeFlags |= treeBaseDuration$67.flags & 14680064, treeBaseDuration$67.return = completedWork, treeBaseDuration$67 = treeBaseDuration$67.sibling;
  } else if (0 !== (completedWork.mode & 2)) {
    treeBaseDuration$67 = completedWork.actualDuration;
    child$68 = completedWork.selfBaseDuration;
    for (var child = completedWork.child; null !== child;) newChildLanes |= child.lanes | child.childLanes, subtreeFlags |= child.subtreeFlags, subtreeFlags |= child.flags, treeBaseDuration$67 += child.actualDuration, child$68 += child.treeBaseDuration, child = child.sibling;
    completedWork.actualDuration = treeBaseDuration$67;
    completedWork.treeBaseDuration = child$68;
  } else for (treeBaseDuration$67 = completedWork.child; null !== treeBaseDuration$67;) newChildLanes |= treeBaseDuration$67.lanes | treeBaseDuration$67.childLanes, subtreeFlags |= treeBaseDuration$67.subtreeFlags, subtreeFlags |= treeBaseDuration$67.flags, treeBaseDuration$67.return = completedWork, treeBaseDuration$67 = treeBaseDuration$67.sibling;
    ...
    case 13:
      ...
      if (null === current || null !== current.memoizedState && null !== current.memoizedState.dehydrated) {
        if (null !== newProps && null !== newProps.dehydrated) {
          ...
          workInProgress.flags |= 4;
          bubbleProperties(workInProgress);
          0 !== (workInProgress.mode & 2) && null !== newProps && (type = workInProgress.child, null !== type && (workInProgress.treeBaseDuration -= type.treeBaseDuration));
          type = !1;
        ...
        if (newProps) cutOffTailIfNeeded(type, !1);else {
          if (0 !== workInProgressRootExitStatus || null !== current && 0 !== (current.flags & 128)) for (current = workInProgress.child; null !== current;) {
            ...
            if (null !== updatePayload) {
              ...
              current = renderLanes;
              for (renderLanes = workInProgress.child; null !== renderLanes;) newProps = renderLanes, updatePayload = current, newProps.flags &= 14680066, type = newProps.alternate, null === type ? (newProps.childLanes = 0, newProps.lanes = updatePayload, newProps.child = null, newProps.subtreeFlags = 0, newProps.memoizedProps = null, newProps.memoizedState = null, newProps.updateQueue = null, newProps.dependencies = null, newProps.stateNode = null, newProps.selfBaseDuration = 0, newProps.treeBaseDuration = 0) : (newProps.childLanes = type.childLanes, newProps.lanes = type.lanes, newProps.child = type.child, newProps.subtreeFlags = 0, newProps.deletions = null, newProps.memoizedProps = type.memoizedProps, newProps.memoizedState = type.memoizedState, newProps.updateQueue = type.updateQueue, newProps.type = type.type, updatePayload = type.dependencies, newProps.dependencies = null === updatePayload ? null : {
                lanes: updatePayload.lanes,
                firstContext: updatePayload.firstContext
              }, newProps.selfBaseDuration = type.selfBaseDuration, newProps.treeBaseDuration = type.treeBaseDuration), renderLanes = renderLanes.sibling;
...
function unwindWork(current, workInProgress) {
  ...
  switch (workInProgress.tag) {
    case 1:
      return isContextProvider(workInProgress.type) && popContext(), current = workInProgress.flags, current & 65536 ? (workInProgress.flags = current & -65537 | 128, 0 !== (workInProgress.mode & 2) && transferActualDuration(workInProgress), workInProgress) : null;
    case 3:
  ...
  switch (deletedFiber.tag) {
    ...
    case 15:
      ...
      if (null !== updateQueue && (updateQueue = updateQueue.lastEffect, null !== updateQueue)) {
        ...
        do {
          ...
          _effect = _effect.tag;
          void 0 !== destroy && (0 !== (_effect & 2) ? safelyCallDestroy(deletedFiber, nearestMountedAncestor, destroy) : 0 !== (_effect & 4) && (deletedFiber.mode & 2 ? (startLayoutEffectTimer(), safelyCallDestroy(deletedFiber, nearestMountedAncestor, destroy), recordLayoutEffectDuration(deletedFiber)) : safelyCallDestroy(deletedFiber, nearestMountedAncestor, destroy)));
          effect = effect.next;
        } while (effect !== updateQueue);
      }
      recursivelyTraverseDeletionEffects(finishedRoot, nearestMountedAncestor, deletedFiber);
    ...
    case 1:
      ...
      if ("function" === typeof updateQueue.componentWillUnmount) try {
        if (updateQueue.props = deletedFiber.memoizedProps, updateQueue.state = deletedFiber.memoizedState, deletedFiber.mode & 2) try {
...
function commitLayoutEffects(finishedWork, root, committedLanes) {
  inProgressLanes = committedLanes;
  inProgressRoot = root;
  for (nextEffect = finishedWork; null !== nextEffect;) if (root = nextEffect, committedLanes = root.child, 0 !== (root.subtreeFlags & 8772) && null !== committedLanes) committedLanes.return = root, nextEffect = committedLanes;else for (root = finishedWork; null !== nextEffect;) {
    committedLanes = nextEffect;
    if (0 !== (committedLanes.flags & 8772)) {
      var current = committedLanes.alternate;
      try {
        if (0 !== (committedLanes.flags & 8772)) switch (committedLanes.tag) {
          case 0:
          case 11:
          case 15:
            if (committedLanes.mode & 2) try {
          ...
          case 1:
            ...
            if (committedLanes.flags & 4) if (null === current) {
              if (committedLanes.mode & 2) try {
              ...
              var prevProps = committedLanes.elementType === committedLanes.type ? current.memoizedProps : resolveDefaultProps(committedLanes.type, current.memoizedProps),
                prevState = current.memoizedState;
              if (committedLanes.mode & 2) try {
            ...
            null !== updateQueue && commitUpdateQueue(committedLanes, updateQueue, instance);
            break;
          case 3:
            var updateQueue$85 = committedLanes.updateQueue;
            if (null !== updateQueue$85) {
              var instance$86 = null;
              if (null !== committedLanes.child) switch (committedLanes.child.tag) {
                case 5:
                  instance$86 = committedLanes.child.stateNode.canonical;
                  break;
                case 1:
                  instance$86 = committedLanes.child.stateNode;
              }
              commitUpdateQueue(committedLanes, updateQueue$85, instance$86);
            }
            break;
          case 5:
            if (null === current && committedLanes.flags & 4) throw Error("The current renderer does not support mutation. This error is likely caused by a bug in React. Please file an issue.");
            break;
          case 6:
            break;
          case 4:
          ...
          case 12:
            ...
            "function" === typeof onRender && onRender(committedLanes.memoizedProps.id, current, committedLanes.actualDuration, committedLanes.treeBaseDuration, committedLanes.actualStartTime, instance$86);
            "function" === typeof onCommit && onCommit(committedLanes.memoizedProps.id, current, effectDuration, instance$86);
        ...
        captureCommitPhaseError(committedLanes, committedLanes.return, error);
      }
    }
...
function scheduleUpdateOnFiber(root, fiber, lane, eventTime) {
  ...
  if (0 === (executionContext & 2) || root !== workInProgressRoot) isDevToolsPresent && addFiberToLanesMap(root, fiber, lane), root === workInProgressRoot && (0 === (executionContext & 2) && (workInProgressRootInterleavedUpdatedLanes |= lane), 4 === workInProgressRootExitStatus && markRootSuspended$1(root, workInProgressRootRenderLanes)), ensureRootIsScheduled(root, eventTime), 1 === lane && 0 === executionContext && 0 === (fiber.mode & 1) && (workInProgressRootRenderTargetTime = now() + 500, includesLegacySyncCallbacks && flushSyncCallbacks());
}
    ...
    if (6 === didTimeout) markRootSuspended$1(root, lanes);else {
      ...
      switch (didTimeout) {
        ...
        case 4:
          ...
          for (prevExecutionContext = -1; 0 < lanes;) memoizedUpdaters = 31 - clz32(lanes), prevDispatcher = 1 << memoizedUpdaters, memoizedUpdaters = didTimeout[memoizedUpdaters], memoizedUpdaters > prevExecutionContext && (prevExecutionContext = memoizedUpdaters), lanes &= ~prevDispatcher;
...
function performUnitOfWork(unitOfWork) {
  ...
  0 !== (unitOfWork.mode & 2) ? (profilerStartTime = now$1(), 0 > unitOfWork.actualStartTime && (unitOfWork.actualStartTime = now$1()), current = beginWork$1(current, unitOfWork, subtreeRenderLanes), stopProfilerTimerIfRunningAndRecordDelta(unitOfWork, !0)) : current = beginWork$1(current, unitOfWork, subtreeRenderLanes);
...
function completeUnitOfWork(unitOfWork) {
  ...
  do {
    ...
    if (0 === (completedWork.flags & 32768)) {
      if (0 === (completedWork.mode & 2)) current = completeWork(current, completedWork, subtreeRenderLanes);else {
      ...
      if (0 !== (completedWork.mode & 2)) {
        ...
        for (fiber = completedWork.child; null !== fiber;) current += fiber.actualDuration, fiber = fiber.sibling;
...
function commitRootImpl(root, recoverableErrors, transitions, renderPriorityLevel) {
  ...
  remainingLanes = root.pendingLanes;
  0 !== (remainingLanes & 1) ? (nestedUpdateScheduled = !0, root === rootWithNestedUpdates ? nestedUpdateCount++ : (nestedUpdateCount = 0, rootWithNestedUpdates = root)) : nestedUpdateCount = 0;
  flushSyncCallbacks();
  return null;
}
      ...
      if (null === rootWithPendingPassiveEffects) var JSCompiler_inline_result = !1;else {
        ...
        for (nextEffect = renderPriority.current; null !== nextEffect;) {
              ...
              for (var i = 0; i < deletions.length; i++) {
                ...
                for (nextEffect = fiberToDelete; null !== nextEffect;) {
                  ...
                  switch (current.tag) {
                    ...
                    case 11:
                    case 15:
                      current.mode & 2 ? (passiveEffectStartTime = now$1(), commitHookEffectListUnmount(8, current, fiber), recordPassiveEffectDuration(current)) : commitHookEffectListUnmount(8, current, fiber);
                  }
          ...
          if (0 !== (fiber.subtreeFlags & 2064) && null !== child) child.return = fiber, nextEffect = child;else b: for (; null !== nextEffect;) {
            fiber = nextEffect;
            if (0 !== (fiber.flags & 2048)) switch (i = fiber, i.tag) {
              case 0:
              case 11:
              case 15:
        ...
        for (firstChild = 0; firstChild < finishedWork.length; firstChild++) {
          ...
          if (0 !== (finishedWork$jscomp$0.flags & 4)) switch (finishedWork$jscomp$0.tag) {
            case 12:
              var passiveEffectDuration = finishedWork$jscomp$0.stateNode.passiveEffectDuration,
...
beginWork$1 = function beginWork$1(current, workInProgress, renderLanes) {
  ...
  switch (workInProgress.tag) {
    ...
    case 12:
      return workInProgress.flags |= 4, Component = workInProgress.stateNode, Component.effectDuration = 0, Component.passiveEffectDuration = 0, reconcileChildren(current, workInProgress, workInProgress.pendingProps.children, renderLanes), workInProgress.child;
    case 10:
      a: {
...
function createFiberFromTypeAndProps(type, key, pendingProps, owner, mode, lanes) {
  ...
  if ("function" === typeof type) shouldConstruct(type) && (fiberTag = 1);else if ("string" === typeof type) fiberTag = 5;else a: switch (type) {
    ...
    case REACT_STRICT_MODE_TYPE:
      ...
      break;
    case REACT_PROFILER_TYPE:
      return type = createFiber(12, pendingProps, key, mode | 2), type.elementType = REACT_PROFILER_TYPE, type.lanes = lanes, type.stateNode = {
        effectDuration: 0,
...
var internals$jscomp$inline_1243 = {
  ...
  findFiberByHostInstance: devToolsConfig$jscomp$inline_981.findFiberByHostInstance || emptyFindFiberByHostInstance,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  ...
  if (!hook$jscomp$inline_1244.isDisabled && hook$jscomp$inline_1244.supportsFiber) try {
    rendererID = hook$jscomp$inline_1244.inject(internals$jscomp$inline_1243), injectedHook = hook$jscomp$inline_1244;
  } catch (err) {}
}
...
exports.render = function (element, containerTag, callback, concurrentRoot) {
  ...
  root || (root = concurrentRoot ? 1 : 0, concurrentRoot = new FiberRootNode(containerTag, root, !1, "", onRecoverableError), root = 1 === root ? 1 : 0, isDevToolsPresent && (root |= 2), root = createFiber(3, null, null, root), concurrentRoot.current = root, root.stateNode = concurrentRoot, root.memoizedState = {
    element: null,
    isDehydrated: !1,
    cache: null,
    transitions: null,
