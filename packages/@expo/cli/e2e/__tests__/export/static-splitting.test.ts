...
describe('exports static with bundle splitting', () => {
  ...
  it('statically extracts fonts', async () => {
    ...
    expect(links[0].attributes.href).toBe(
      '/assets/__e2e__/static-rendering/sweet_737795ac052e4f9f051f955c383cfef5.ttf?platform=web&hash=7c9263d3cffcda46ff7a4d9c00472c07'
    );

    expect(links[0].toString()).toMatch(
      /<link rel="preload" href="\/assets\/__e2e__\/static-rendering\/sweet_[a-zA-Z0-9]{32}\.ttf\?platform=web&hash=[a-zA-Z0-9]{32}" as="font" crossorigin="" >/
    );
