  ...
  async () => {
    ...
    expect(files).toMatchInlineSnapshot(`
      [
        ...
        "ios/basicprebuild/Images.xcassets/SplashScreenBackground.colorset/Contents.json",
  ...
  async () => {
    ...
    expect(files).toMatchInlineSnapshot(`
      [
        ...
        "ios/githubtemplateprebuild/Images.xcassets/SplashScreenBackground.colorset/Contents.json",
