...
for (pluginName$jscomp$inline_303 in injectedNamesToPlugins$jscomp$inline_301)
  if (injectedNamesToPlugins$jscomp$inline_301.hasOwnProperty(pluginName$jscomp$inline_303)) {
    ...
    if (
      ...
      namesToPlugins[pluginName$jscomp$inline_303] !== pluginModule$jscomp$inline_304
    ) {
  ...
  receiveTouches: function (eventTopLevelType, touches, changedIndices) {
    if ('topTouchEnd' === eventTopLevelType || 'topTouchCancel' === eventTopLevelType) {
      ...
      for (i = changedIndices = 0; i < touches.length; i++)
        (index$4 = touches[i]), null !== index$4 && (touches[changedIndices++] = index$4);
        ...
        void 0 !== prevProp &&
          ...
          'function' === typeof attributeConfig.process
            ? (((updatePayload || (updatePayload = {}))[propKey$7] = null),
              ...
              removedKeys[propKey$7] || ((removedKeys[propKey$7] = !0), removedKeyCount++))
...
function popHostContext(fiber) {
  ...
  hostTransitionProviderCursor.current === fiber &&
    (pop(hostTransitionProviderCursor), (HostTransitionContext._currentValue = null));
}
...
function updateReducerImpl(hook, current, reducer) {
  ...
  if (null === baseQueue) hook.memoizedState = pendingQueue;
    ...
    var newBaseQueueFirst = (baseFirst = null),
      ...
      update = current,
      didReadFromEntangledAsyncAction$52 = !1;
    do {
      ...
      if (
        ...
        if (0 === revertLane)
          null !== newBaseQueueLast &&
            ...
            updateLane === currentEntangledLane && (didReadFromEntangledAsyncAction$52 = !0);
        else if ((renderLanes & revertLane) === revertLane) {
          update = update.next;
          revertLane === currentEntangledLane && (didReadFromEntangledAsyncAction$52 = !0);
          continue;
        } else
          (updateLane = {
            lane: 0,
    ...
    if (
      ...
      ((didReceiveUpdate = !0),
      didReadFromEntangledAsyncAction$52 &&
...
function resolveClassComponentProps(Component, baseProps) {
  ...
  if ((Component = Component.defaultProps)) {
    ...
    for (var propName$58 in Component)
      void 0 === newProps[propName$58] && (newProps[propName$58] = Component[propName$58]);
  }
  return newProps;
}
...
function bubbleProperties(completedWork) {
  ...
  if (didBailout)
    if (0 !== (completedWork.mode & 2)) {
      for (
        var treeBaseDuration$101 = completedWork.selfBaseDuration, child$102 = completedWork.child;
        null !== child$102;
      ...
      for (treeBaseDuration$101 = completedWork.child; null !== treeBaseDuration$101; )
        (newChildLanes |= treeBaseDuration$101.lanes | treeBaseDuration$101.childLanes),
...
function commitDeletionEffectsOnFiber(finishedRoot, nearestMountedAncestor, deletedFiber) {
  ...
  switch (deletedFiber.tag) {
    ...
    case 1:
      offscreenSubtreeWasHidden ||
        ...
        'function' === typeof child.componentWillUnmount &&
          safelyCallComponentWillUnmount(deletedFiber, nearestMountedAncestor, child));
      recursivelyTraverseDeletionEffects(finishedRoot, nearestMountedAncestor, deletedFiber);
      break;
    case 21:
      recursivelyTraverseDeletionEffects(finishedRoot, nearestMountedAncestor, deletedFiber);
    ...
    case 22:
      deletedFiber.mode & 1
        ? ((offscreenSubtreeWasHidden =
            (child = offscreenSubtreeWasHidden) || null !== deletedFiber.memoizedState),
          recursivelyTraverseDeletionEffects(finishedRoot, nearestMountedAncestor, deletedFiber),
      ...
      if (flags & 8192)
        a: for (
          root = finishedWork.stateNode,
            root._visibility = instance ? root._visibility & -2 : root._visibility | 1,
            instance &&
              (null === current ||
                viewConfig ||
                offscreenSubtreeIsHidden ||
    ...
    try {
      ...
      switch (hostParentFiber.tag) {
        ...
        case 4:
          ...
          insertOrAppendPlacementNodeIntoContainer(finishedWork, before$134, parent$133);
          break;
        default:
          throw Error(
...
function requestUpdateLane(fiber) {
  ...
  if (null !== ReactSharedInternals.T)
    return (fiber = currentEntangledLane), 0 !== fiber ? fiber : requestTransitionLane();
...
null !== extraDevToolsConfig && (internals$jscomp$inline_1356.rendererConfig = extraDevToolsConfig);
internals$jscomp$inline_1356.getLaneLabelMap = function () {
  for (var map = new Map(), lane = 1, index$158 = 0; 31 > index$158; index$158++) {
...
if ('undefined' !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1662 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (!hook$jscomp$inline_1662.isDisabled && hook$jscomp$inline_1662.supportsFiber)
    try {
      (rendererID = hook$jscomp$inline_1662.inject(internals$jscomp$inline_1356)),
        (injectedHook = hook$jscomp$inline_1662);
    } catch (err) {}
}
