...
for (pluginName$jscomp$inline_282 in injectedNamesToPlugins$jscomp$inline_280)
  if (injectedNamesToPlugins$jscomp$inline_280.hasOwnProperty(pluginName$jscomp$inline_282)) {
    ...
    if (
      ...
      namesToPlugins[pluginName$jscomp$inline_282] !== pluginModule$jscomp$inline_283
    ) {
      ...
      if (
        ...
        if (0 === revertLane)
          null !== newBaseQueueLast &&
            ...
            updateLane === currentEntangledLane && (didReadFromEntangledAsyncAction$49 = !0);
        else if ((renderLanes & revertLane) === revertLane) {
          update = update.next;
          revertLane === currentEntangledLane && (didReadFromEntangledAsyncAction$49 = !0);
          continue;
        } else
          (updateLane = {
            lane: 0,
...
function resolveClassComponentProps(Component, baseProps) {
  ...
  if ((Component = Component.defaultProps)) {
    ...
    for (var propName$55 in Component)
      void 0 === newProps[propName$55] && (newProps[propName$55] = Component[propName$55]);
  }
  return newProps;
}
  ...
  switch (workInProgress.tag) {
    case 1:
      return (
        ...
        current & 65536 ? ((workInProgress.flags = (current & -65537) | 128), workInProgress) : null
      );
    case 3:
      return (
        popProvider(CacheContext),
  ...
  switch (finishedWork.tag) {
    ...
    case 13:
      ...
      finishedWork.child.flags & 8192 &&
        ((current = null !== current && null !== current.memoizedState),
        null === finishedWork.memoizedState || current || (globalMostRecentFallbackTime = now()));
      flags & 4 &&
  ...
  if (0 === (executionContext & 2) || root !== workInProgressRoot)
    root === workInProgressRoot &&
      ...
      2 === lane &&
        0 === executionContext &&
        0 === (fiber.mode & 1) &&
        ((workInProgressRootRenderTargetTime = now() + 500), flushSyncWorkAcrossRoots_impl(0, !0));
}
...
null !== extraDevToolsConfig && (internals$jscomp$inline_1200.rendererConfig = extraDevToolsConfig);
if ('undefined' !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1517 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (!hook$jscomp$inline_1517.isDisabled && hook$jscomp$inline_1517.supportsFiber)
    try {
      (rendererID = hook$jscomp$inline_1517.inject(internals$jscomp$inline_1200)),
