...
for (pluginName$jscomp$inline_287 in injectedNamesToPlugins$jscomp$inline_285)
  if (injectedNamesToPlugins$jscomp$inline_285.hasOwnProperty(pluginName$jscomp$inline_287)) {
    ...
    if (
      ...
      namesToPlugins[pluginName$jscomp$inline_287] !== pluginModule$jscomp$inline_288
    ) {
      ...
      if (
        ...
        if (0 === revertLane)
          null !== newBaseQueueLast &&
            ...
            updateLane === currentEntangledLane && (didReadFromEntangledAsyncAction$50 = !0);
        else if ((renderLanes & revertLane) === revertLane) {
          update = update.next;
          revertLane === currentEntangledLane && (didReadFromEntangledAsyncAction$50 = !0);
          continue;
        } else
          (updateLane = {
            lane: 0,
...
function resolveClassComponentProps(Component, baseProps) {
  ...
  if ((Component = Component.defaultProps)) {
    ...
    for (var propName$56 in Component)
      void 0 === newProps[propName$56] && (newProps[propName$56] = Component[propName$56]);
  }
  return newProps;
}
    ...
    try {
      ...
      switch (hostParentFiber.tag) {
        ...
        case 4:
          ...
          insertOrAppendPlacementNodeIntoContainer(finishedWork, before$123, parent$122);
          break;
        default:
          throw Error(
...
null !== extraDevToolsConfig && (internals$jscomp$inline_1263.rendererConfig = extraDevToolsConfig);
if ('undefined' !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1603 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (!hook$jscomp$inline_1603.isDisabled && hook$jscomp$inline_1603.supportsFiber)
    try {
      (rendererID = hook$jscomp$inline_1603.inject(internals$jscomp$inline_1263)),
