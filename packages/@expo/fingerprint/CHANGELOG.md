...
- This version includes fingerprint result breaking changes. ([#24364](https://github.com/expo/expo/pull/24364) by [@Kudo](https://github.com/kudo))

### 🎉 New features

- Improve fingerprint sourcing scope for local config-plugins. ([#24364](https://github.com/expo/expo/pull/24364) by [@Kudo](https://github.com/kudo))
