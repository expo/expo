...
- Skipped hashing prebuild-generated native directories for CNG platforms, so the fingerprint no longer changes after running `expo prebuild`. ([#47944](https://github.com/expo/expo/pull/47944) by [@Oupsla](https://github.com/Oupsla))
