...
- Skipped `eas.json` in the `balanced` and `relaxed` presets, which changes the default fingerprint once on upgrade for projects that have an `eas.json`. ([#48586](https://github.com/expo/expo/pull/48586) by [@kudo](https://github.com/kudo))
