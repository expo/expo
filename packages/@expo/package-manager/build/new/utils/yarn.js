...
exports.getNpmProxy = exports.isYarnOfflineAsync = exports.shouldUseYarn = void 0;
const child_process_1 = require("child_process");
const dns_1 = __importDefault(require("dns"));
const url_1 = __importDefault(require("url"));
const nodeManagers_1 = require("./nodeManagers");
/** @depreacted use `resolvePackageManager` instead */
function shouldUseYarn() {
    if (process.env.npm_config_user_agent?.startsWith('yarn')) {
        return true;
    }
    if ((0, nodeManagers_1.isUsingNpm)(process.cwd())) {
        return false;
    }
    try {
