      ...
      children: [
        {
          ...
          route: '[color]',
          entryPoints: ['expo-router/internal/views/Navigator.js', './[color].tsx'],
        },
      ],
      type: 'layout',
      ...
      children: [
        {
          ...
          dynamic: null,
          route: 'index',
          entryPoints: ['expo-router/internal/views/Navigator.js', './index.tsx'],
        },
        {
          type: 'api',
          children: [],
      ...
      children: [
        {
          ...
          route: 'post/[...post]',
          entryPoints: ['expo-router/internal/views/Navigator.js', './post/[...post].tsx'],
        },
      ],
      type: 'layout',
      contextKey: 'expo-router/internal/views/Navigator.js',
    ...
    expect(dropFunctions(route)).toEqual({
      children: [
        ...
        },
        {
          type: 'route',
          children: [],
          entryPoints: ['expo-router/internal/views/Navigator.js', './a/[b]/c/[d]/[e].tsx'],
