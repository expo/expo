...
exports.prebuildPatchAsync = void 0;
...
const debug = require('debug')('prebuild-patch');
const globAsync = (0, util_1.promisify)(glob_1.default);
/**
 * Entry point into the prebuild-patch process.
 */
async function prebuildPatchAsync(projectRoot, options) {
...
exports.prebuildPatchAsync = prebuildPatchAsync;
async function prebuildPatchForPlatformAsync({ projectRoot, platform, workingDirectories, patchRoot, exp, options, }) {
...
//# sourceMappingURL=prebuildPatchAsync.js.map