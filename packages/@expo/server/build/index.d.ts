...
export declare function createRequestHandler(distFolder: string, { getRoutesManifest: getInternalRoutesManifest, getHtml, getApiRoute, getMiddleware, logApiRouteExecutionError, handleApiRouteError, }?: {
