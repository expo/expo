...
export declare const getRoutesManifest: (dist: string) => () => Promise<ExpoRoutesManifestV1<RegExp> | null>;
export declare const getHtml: (dist: string) => (_request: Request, route: RouteInfo<RegExp>) => Promise<string | null>;
export declare const getApiRoute: (dist: string) => (route: RouteInfo<RegExp>) => any;
