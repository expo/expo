...
- [android] fix wrong entry file leads to duplicates in path when using a monorepo ([#37935](https://github.com/expo/expo/pull/37935) by [@mlecoq](https://github.com/mlecoq))
