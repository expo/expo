...
function getConfig(projectRoot, options = {}) {
    ...
    if (paths.dynamicConfigPath) {
        ...
        const { exportedObjectType, config: rawDynamicConfig } = (0, getConfig_1.getDynamicConfig)(paths.dynamicConfigPath, {
            projectRoot,
            staticConfigPath: paths.staticConfigPath,
            packageJsonPath,
...
function getDefaultTarget(projectRoot, exp) {
    exp ?? (exp = getConfig(projectRoot, { skipSDKVersionRequirement: true }).exp);
