...
function parseDeclaration(declaration, options) {
    ...
    switch (declaration.property) {
        ...
        case "inset":
            ...
            addStyleProp("bottom", parseLengthPercentageOrAuto(declaration.value.bottom, options), { shortHand: true });
            addStyleProp("left", parseLengthPercentageOrAuto(declaration.value.left, options), { shortHand: true });
            addStyleProp("right", parseLengthPercentageOrAuto(declaration.value.right, options), { shortHand: true });
            return;
        case "border-spacing":
            return;
        ...
        case "border-radius":
            ...
            addStyleProp("border-top-left-radius", parseLength(declaration.value.topLeft[0], options), { shortHand: true });
            addStyleProp("border-top-right-radius", parseLength(declaration.value.topRight[0], options), { shortHand: true });
            return;
        ...
        case "border-width":
            addStyleProp("border-top-width", parseBorderSideWidth(declaration.value.top, options), { shortHand: true });
            addStyleProp("border-bottom-width", parseBorderSideWidth(declaration.value.bottom, options), { shortHand: true });
            addStyleProp("border-left-width", parseBorderSideWidth(declaration.value.left, options), { shortHand: true });
            addStyleProp("border-right-width", parseBorderSideWidth(declaration.value.right, options), { shortHand: true });
            return;
        ...
        case "font":
            addStyleProp(declaration.property + "-family", parseFontFamily(declaration.value.family), { shortHand: true });
            addStyleProp("line-height", parseLineHeight(declaration.value.lineHeight, options), { shortHand: true });
            addStyleProp(declaration.property + "-size", parseFontSize(declaration.value.size, options), { shortHand: true });
            addStyleProp(declaration.property + "-style", parseFontStyle(declaration.value.style), { shortHand: true });
            addStyleProp(declaration.property + "-variant", parseFontVariantCaps(declaration.value.variantCaps), { shortHand: true });
            addStyleProp(declaration.property + "-weight", parseFontWeight(declaration.value.weight), { shortHand: true });
            return;
        case "vertical-align":
        ...
        case "fill":
            return addStyleProp(declaration.property, parseSVGPaint(declaration.value));
        ...
        default: {
            (0, utils_1.exhaustiveCheck)(declaration);
        }
    }
}
        ...
        case "token":
            switch (tokenOrValue.value.type) {
                ...
                case "close-curly-bracket":
                    return undefined;
                default: {
                    (0, utils_1.exhaustiveCheck)(tokenOrValue.value);
                    return;
                }
            }
        default: {
            (0, utils_1.exhaustiveCheck)(tokenOrValue);
        }
    }
    return undefined;
}
    ...
    if ("unit" in length) {
        switch (length.unit) {
            ...
            case "cqmax":
                return undefined;
            default: {
                (0, utils_1.exhaustiveCheck)(length.unit);
            }
        }
    }
    else {
...
function parseSize(size, options) {
    switch (size.type) {
        ...
        case "contain":
            return undefined;
        default: {
            (0, utils_1.exhaustiveCheck)(size);
        }
    }
    return undefined;
}
function parseColor(color) {
    switch (color.type) {
        ...
        case "hwb":
            return undefined;
        default: {
            (0, utils_1.exhaustiveCheck)(color);
        }
    }
    return undefined;
}
function parseLengthPercentageOrAuto(lengthPercentageOrAuto, options) {
    switch (lengthPercentageOrAuto.type) {
        ...
        default: {
            (0, utils_1.exhaustiveCheck)(lengthPercentageOrAuto);
        }
    }
    return undefined;
}
function parseJustifyContent(justifyContent) {
    ...
    switch (justifyContent.type) {
        ...
        case "content-position":
            ...
            break;
        default: {
            (0, utils_1.exhaustiveCheck)(justifyContent);
        }
    }
...
function parseAlignContent(alignItems) {
    ...
    switch (alignItems.type) {
        ...
        case "content-position":
            ...
            break;
        default: {
            (0, utils_1.exhaustiveCheck)(alignItems);
        }
    }
    if (value && !allowed.has(value)) {
        return;
...
function parseFontWeight(fontWeight) {
    switch (fontWeight.type) {
        ...
        case "lighter":
            return;
        default: {
            (0, utils_1.exhaustiveCheck)(fontWeight);
        }
    }
    return undefined;
}
...
function parseFontSize(fontSize, options) {
    switch (fontSize.type) {
        ...
        case "relative":
            return undefined;
        default: {
            (0, utils_1.exhaustiveCheck)(fontSize);
        }
    }
    return undefined;
}
function parseFontStyle(fontStyle) {
    switch (fontStyle.type) {
        ...
        case "oblique":
            return undefined;
        default: {
            (0, utils_1.exhaustiveCheck)(fontStyle);
        }
    }
    return undefined;
}
