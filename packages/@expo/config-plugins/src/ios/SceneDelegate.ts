...
const INHERITED_PROPERTY_MATCHERS = [
  /^[ \t]*var window: UIWindow\?\n/m,
 ...
 */
export function removeInheritedProperties(src: string): string {
 ...
 */
export function addLaunchOptionsStorage(src: string): MergeResults {
