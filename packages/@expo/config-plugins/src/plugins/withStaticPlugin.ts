...
\n
Please consult the documentation on how to correctly configure the plugin.`,
        'INVALID_PLUGIN_TYPE'
      );
    }
    throw new PluginError(
      `Plugin is an unexpected type: ${typeof pluginResolve}. Please consult the documentation on how to correctly configure the plugin.`,
      'INVALID_PLUGIN_TYPE'
    );
  }
