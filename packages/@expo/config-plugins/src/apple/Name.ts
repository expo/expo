...
import { createInfoPlistPluginWithPropertyGuard, withXcodeProject } from '../plugins/apple-plugins';

export const withDisplayName = (applePlatform: 'ios' | 'macos') =>
...
export const withName = (applePlatform: 'ios' | 'macos') =>
  createInfoPlistPluginWithPropertyGuard(applePlatform)(
    setName,
    {
...
export const withProductName: (applePlatform: 'ios' | 'macos') => ConfigPlugin =
