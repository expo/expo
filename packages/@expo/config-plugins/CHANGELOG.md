...
- Mark the generated `expo_runtime_version` Android string as `translatable="false"` so translation tools (including Google Play's automatic app-string translation) cannot localise the runtime version and cut devices off from updates. ([#50678](https://github.com/expo/expo/pull/50678) by [@uen](https://github.com/uen))
