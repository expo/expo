...
export declare function withDefaultBaseMods(
 ...
 */
export declare function withIntrospectionBaseMods(
  config: ExportedConfig,
  props?: ForwardedBaseModOptions
): ExportedConfig;
/**
 ...
 * @param config
 */
export declare function compileModsAsync(
  config: ExportedConfig,
  props: {
    projectRoot: string;
 ...
 * @param config
 */
export declare function evalModsAsync(
  config: ExportedConfig,
  {
    projectRoot,
    introspect,
