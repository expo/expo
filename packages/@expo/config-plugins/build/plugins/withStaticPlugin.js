...
const EXPO_CONFIG_PLUGIN_VERBOSE_ERRORS = (0, getenv_1.boolish)('EXPO_CONFIG_PLUGIN_VERBOSE_ERRORS', false);
...
const EXPO_USE_UNVERSIONED_PLUGINS = (0, getenv_1.boolish)('EXPO_USE_UNVERSIONED_PLUGINS', false);
...
const withStaticPlugin = (config, props) => {
    ...
    if (!projectRoot) {
        ...
        (0, plugin_resolver_1.assertInternalProjectRoot)(projectRoot);
    }
    let [pluginResolve, pluginProps] = (0, plugin_resolver_1.normalizeStaticPlugin)(props.plugin);
    // Ensure no one uses this property by accident.
    (0, assert_1.default)(!pluginProps?._resolverError, `Plugin property '_resolverError' is a reserved property of \`withStaticPlugin\``);
    let withPlugin;
    if (
    ...
    typeof pluginResolve === 'function') {
        ...
        try {
            ...
            withPlugin = (0, plugin_resolver_1.resolveConfigPluginFunction)(projectRoot, pluginResolve);
            ...
            if (EXPO_USE_UNVERSIONED_PLUGINS &&
                !!withPlugin &&
