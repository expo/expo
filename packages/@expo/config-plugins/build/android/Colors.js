...
function setColorItem(itemToAdd, colorFileContentsJSON) {
  let _colorFileContentsJSO;

  if (
    (_colorFileContentsJSO = colorFileContentsJSON.resources) !== null &&
    _colorFileContentsJSO !== void 0 &&
    _colorFileContentsJSO.color
  ) {
    const colorNameExists = colorFileContentsJSON.resources.color.filter(
      (e) => e.$.name === itemToAdd.$.name
    )[0];
...
function removeColorItem(named, contents) {
  let _contents$resources;

  if (
    (_contents$resources = contents.resources) !== null &&
    _contents$resources !== void 0 &&
    _contents$resources.color
  ) {
...
function getColorsAsObject(xml) {
  ...
  if (
    !(
      xml !== null &&
      xml !== void 0 &&
      (_xml$resources = xml.resources) !== null &&
      _xml$resources !== void 0 &&
      _xml$resources.color
    )
  ) {
    return null;
  }
