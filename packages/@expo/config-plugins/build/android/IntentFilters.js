...
const withAndroidIntentFilters = (0, _androidPlugins().createAndroidManifestPlugin)(
...
function getIntentFilters(config) {
  let _config$android$inten, _config$android;

  return (_config$android$inten =
    (_config$android = config.android) === null || _config$android === void 0
      ? void 0
      : _config$android.intentFilters) !== null && _config$android$inten !== void 0
    ? _config$android$inten
    : [];
}

function setAndroidIntentFilters(config, androidManifest) {
  let _mainActivity$intent, _mainActivity$intent2;
  ...
  if (
    (_mainActivity$intent = mainActivity['intent-filter']) !== null &&
    _mainActivity$intent !== void 0 &&
    _mainActivity$intent.length
  ) {
  ...
  mainActivity['intent-filter'] =
    (_mainActivity$intent2 = mainActivity['intent-filter']) === null ||
    _mainActivity$intent2 === void 0
      ? void 0
      : _mainActivity$intent2.concat(renderIntentFilters(intentFilters));
  return androidManifest;
}
...
function renderIntentFilterData(data) {
  return (Array.isArray(data) ? data : [data]).filter(Boolean).map((datum) => ({
    $: Object.entries(datum !== null && datum !== void 0 ? datum : {}).reduce(
