 ...
 */
export declare type ResourceKind =
  | 'values'
  | 'values-night'
  | 'values-v23'
  | 'values-night-v23'
 ...
 */
export declare function readResourcesXMLAsync({
  path,
  fallback,
}: {
  path: string;
 ...
 */
export declare function buildResourceItem({
  name,
  value,
  targetApi,
  translatable,
...
export declare function findResourceGroup(
 ...
 * @returns
 */
export declare function getResourceItemsAsObject(
  xml: ResourceItemXML[]
