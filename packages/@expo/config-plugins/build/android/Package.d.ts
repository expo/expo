...
export declare function renamePackageOnDisk(
  config: Pick<ExpoConfig, 'android'>,
  projectRoot: string
): Promise<void>;
export declare function renameJniOnDiskForType({
  projectRoot,
  type,
  packageName,
}: {
...
export declare function renamePackageOnDiskForType({
  projectRoot,
  type,
  packageName,
}: {
...
export declare function setPackageInBuildGradle(
  config: Pick<ExpoConfig, 'android'>,
  buildGradle: string
): string;
export declare function setPackageInAndroidManifest(
  config: Pick<ExpoConfig, 'android'>,
