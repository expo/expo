...
export declare function getVersionName(config: Pick<ExpoConfig, 'version'> & {
    android?: Pick<Android, 'version'>;
}): string | null;
export declare function setVersionName(config: Pick<ExpoConfig, 'version'> & {
    android?: Pick<Android, 'version'>;
}, buildGradle: string): string;
