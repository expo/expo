...
export declare function getProjectColorsXMLPathAsync(
  projectRoot: string,
  {
    kind,
  }?: {
...
export declare function setColorItem(
  itemToAdd: ResourceItemXML,
  colorFileContentsJSON: ResourceXML
): ResourceXML;
 ...
 */
export declare function assignColorValue(
  xml: ResourceXML,
  {
    value,
    name,
