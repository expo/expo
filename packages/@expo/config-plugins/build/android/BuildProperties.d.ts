...
/**
 * A config-plugin to update `android/gradle.properties` from the `extra.updatesNativeDebug` in expo config
 */
export declare const withUpdatesNativeDebugGradleProps: ConfigPlugin<void>;
