...
const withMaps = exports.withMaps = AppleImpl().withMaps('macos');
const getGoogleMapsApiKey = exports.getGoogleMapsApiKey = AppleImpl().getGoogleMapsApiKey('macos');
const setGoogleMapsApiKey = exports.setGoogleMapsApiKey = AppleImpl().setGoogleMapsApiKey('macos');
