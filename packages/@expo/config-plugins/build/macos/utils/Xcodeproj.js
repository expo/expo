...
const getProjectName = exports.getProjectName = AppleImpl().getProjectName('macos');

// TODO: come up with a better solution for using app.json expo.name in various places
const resolvePathOrProject = exports.resolvePathOrProject = AppleImpl().resolvePathOrProject('macos');
...
const getHackyProjectName = exports.getHackyProjectName = AppleImpl().getHackyProjectName('macos');
 ...
 */
const addResourceFileToGroup = exports.addResourceFileToGroup = AppleImpl().addResourceFileToGroup('macos');

/**
 * Add a build source file (ex: `AppDelegate.m`, `ViewController.swift`) to an Xcode project.
 * This is akin to creating a new code file in Xcode with `⌘+n`.
 */
const addBuildSourceFileToGroup = exports.addBuildSourceFileToGroup = AppleImpl().addBuildSourceFileToGroup('macos');

// TODO(brentvatne): I couldn't figure out how to do this with an existing
// higher level function exposed by the xcode library, but we should find out how to do
// that and replace this with it
const addFileToGroupAndLink = exports.addFileToGroupAndLink = AppleImpl().addFileToGroupAndLink('macos');

/**
 * Get the pbxproj for the given path
 */
const getPbxproj = exports.getPbxproj = AppleImpl().getPbxproj('macos');
