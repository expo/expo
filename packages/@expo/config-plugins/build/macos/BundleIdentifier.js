...
const withBundleIdentifier = exports.withBundleIdentifier = AppleImpl().withBundleIdentifier('macos');
const getBundleIdentifier = exports.getBundleIdentifier = AppleImpl().getBundleIdentifier('macos');

/**
 * In Turtle v1 we set the bundleIdentifier directly on Info.plist rather
 * than in pbxproj
 */
const setBundleIdentifier = exports.setBundleIdentifier = AppleImpl().setBundleIdentifier('macos');
 ...
 */
const getBundleIdentifierFromPbxproj = exports.getBundleIdentifierFromPbxproj = AppleImpl().getBundleIdentifierFromPbxproj('macos');
 ...
 */
const setBundleIdentifierForPbxproj = exports.setBundleIdentifierForPbxproj = AppleImpl().setBundleIdentifierForPbxproj('macos');
const resetAllPlistBundleIdentifiers = exports.resetAllPlistBundleIdentifiers = AppleImpl().resetAllPlistBundleIdentifiers('macos');
