...
export declare const setRequiresFullScreen: (config: Pick<import("@expo/config-types").ExpoConfig, "ios" | "macos">, infoPlist: import("./MacosConfig.types").InfoPlist) => import("./MacosConfig.types").InfoPlist;
