...
export declare const setGoogleMapsApiKey: (config: Pick<import("@expo/config-types").ExpoConfig, "ios" | "macos">, { GMSApiKey, ...infoPlist }: import("./MacosConfig.types").InfoPlist) => import("./MacosConfig.types").InfoPlist;
