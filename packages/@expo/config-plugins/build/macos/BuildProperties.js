 ...
 */
const createBuildPodfilePropsConfigPlugin = exports.createBuildPodfilePropsConfigPlugin = AppleImpl().createBuildPodfilePropsConfigPlugin('macos');

/**
 * A config-plugin to update `macos/Podfile.properties.json` from the `jsEngine` in expo config
 */
const withJsEnginePodfileProps = exports.withJsEnginePodfileProps = AppleImpl().withJsEnginePodfileProps('macos');
