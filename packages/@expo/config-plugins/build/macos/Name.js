...
const withDisplayName = exports.withDisplayName = AppleImpl().withDisplayName('macos');
const withName = exports.withName = AppleImpl().withName('macos');

/** Set the PRODUCT_NAME variable in the xcproj file based on the app.json name property. */
const withProductName = exports.withProductName = AppleImpl().withProductName('macos');
