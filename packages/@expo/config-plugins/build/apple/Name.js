...
const withDisplayName = applePlatform => (0, _applePlugins().createInfoPlistPluginWithPropertyGuard)(applePlatform)(setDisplayName, {
  infoPlistProperty: 'CFBundleDisplayName',
  expoConfigProperty: 'name'
}, 'withDisplayName');
exports.withDisplayName = withDisplayName;
const withName = applePlatform => (0, _applePlugins().createInfoPlistPluginWithPropertyGuard)(applePlatform)(setName, {
...
const withProductName = applePlatform => config => {
