...
const withBundleIdentifier = applePlatform => (config, {
  bundleIdentifier
}) => {
  return (0, _applePlugins().withXcodeProject)(applePlatform)(config, async config => {
    ...
    // Should never happen.
    (0, _assert().default)(bundleId, `\`bundleIdentifier\` must be defined in the app config (\`${applePlatform}.bundleIdentifier\`) or passed to the plugin \`withBundleIdentifier\`.`);
