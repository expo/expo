...
export declare function resolvePathOrProject(
 ...
 */
export declare function addResourceFileToGroup({
  filepath,
  groupName,
  isBuildFile,
  project,
 ...
 * This is akin to creating a new code file in Xcode with `⌘+n`.
 */
export declare function addBuildSourceFileToGroup({
  filepath,
  groupName,
  project,
  verbose,
...
export declare function addFileToGroupAndLink({
  filepath,
  groupName,
  project,
  verbose,
...
export declare function getApplicationNativeTarget({
  project,
  projectName,
}: {
  project: XcodeProject;
 ...
 */
export declare function addFramework({
  project,
  projectName,
  framework,
}: {
...
export declare function ensureGroupRecursively(
  project: XcodeProject,
  filepath: string
): PBXGroup | null;
/**
...
export declare function getProjectSection(
  project: XcodeProject
): Record<string, xcode.PBXProject> & Record<string, string>;
export declare function getXCConfigurationListEntries(
  project: XcodeProject
): ConfigurationListEntry[];
export declare function getBuildConfigurationsForListId(
  project: XcodeProject,
  configurationListId: string
): ConfigurationSectionEntry[];
export declare function getBuildConfigurationForListIdAndName(
  project: XcodeProject,
  {
    configurationListId,
    buildConfiguration,
...
export declare function isNotComment([key]:
  | ConfigurationSectionEntry
  | ProjectSectionEntry
  | ConfigurationListEntry
