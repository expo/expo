...
const withUsesNonExemptEncryption = (0, _iosPlugins().createInfoPlistPluginWithPropertyGuard)(
...
function getUsesNonExemptEncryption(config) {
  let _config$ios$config$us, _config$ios, _config$ios$config;

  return (_config$ios$config$us =
    config === null || config === void 0
      ...
      ? void 0
      : _config$ios$config.usesNonExemptEncryption) !== null && _config$ios$config$us !== void 0
    ? _config$ios$config$us
    : null;
}
...
function setUsesNonExemptEncryption(config, { ITSAppUsesNonExemptEncryption, ...infoPlist }) {
  ...
  return { ...infoPlist, ITSAppUsesNonExemptEncryption: usesNonExemptEncryption };
}
