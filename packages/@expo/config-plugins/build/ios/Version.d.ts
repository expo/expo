...
export declare const setBuildNumber: (config: Pick<import("@expo/config-types").ExpoConfig, "ios" | "macos">, infoPlist: import("./IosConfig.types").InfoPlist) => import("./IosConfig.types").InfoPlist;
