...
import { ConfigPlugin, ModPlatform, ModProps } from '../Plugin.types';
...
export declare function setGoogleServicesFile(config: Pick<ExpoConfig, 'ios'>, { projectRoot, project, platform, }: {
