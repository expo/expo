/* eslint-env jest */
// @ref llp/0022-live-tier.plan.md §live-local
//
...
describeLive('live-local', gate)('live-local: the whole loop on a real simulator', () => {
  ...
  it('status reads the real project and its real fingerprint', async () => {
    ...
    // half a stub can never produce (llp/0002 §A flag is not shipped until it has run against the published binary).
  ...
  it('runtime:reload puts the app on the lab route and is verified by the app reconnecting', async () => {
    ...
    // @ref llp/0005 §What proves a reload. The stub tier has the two halves of this and
  ...
  it('runtime:eval evaluates in the running app', async () => {
    ...
    // @ref llp/0022-live-tier.plan.md §Limits — "a successful runtime:eval is unreachable at tier 0"
