...
describe(runSmokePhasesAsync, () => {
  ...
  // @ref llp/0005-runtime-loop-tools.rfc.md §Loading the app is not navigating it — Kudo's
  // re-test, 2026-09-01. `<scheme>://<route>` navigates an app that is already running against a
...
describe(`${runSmokePhasesAsync.name} and what the picture shows`, () => {
  ...
  // The third case, and the one Kudo's screenshot was: the loading link was opened, the app did
