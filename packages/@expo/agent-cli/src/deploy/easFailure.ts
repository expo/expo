...
/**
 * `Accounts you can create projects in: kudochien, expo, expo-services, kudo1` — the EAS CLI's own
...
const SIGNATURES: readonly EasFailureSignature[] = [
  {
    ...
    // @ref llp/0007-deploy-and-headless.rfc.md §Cross-platform deploy — **F143.** `npx eas init`
