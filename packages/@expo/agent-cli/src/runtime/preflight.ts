 ...
 *   running and never a precondition (llp/0010 §The seventh and eighth: an app that was not running
 *   is success).
 */
...
export interface RuntimePreflightOptions {
   ...
   *
   * @ref llp/0005-runtime-loop-tools.rfc.md §A cloud simulator requires a tunnel — F5x and S5. A
