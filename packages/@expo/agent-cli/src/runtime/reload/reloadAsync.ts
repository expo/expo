...
export interface ReloadResultJson {
   ...
   *
   * @ref llp/0005-runtime-loop-tools.rfc.md §How it reloads — K2, and Kudo's live hit of
 ...
 *
 * @ref llp/0005-runtime-loop-tools.rfc.md §How it reloads — Kudo's cloud loop, K2 and K3.
 *
