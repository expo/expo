...
type NSPrivacyCollectedDataType = 'NSPrivacyCollectedDataTypeName' | 'NSPrivacyCollectedDataTypeEmailAddress' | 'NSPrivacyCollectedDataTypePhoneNumber' | 'NSPrivacyCollectedDataTypePhysicalAddress' | 'NSPrivacyCollectedDataTypeOtherUserContactInfo' | 'NSPrivacyCollectedDataTypeHealth' | 'NSPrivacyCollectedDataTypeFitness' | 'NSPrivacyCollectedDataTypePaymentInfo' | 'NSPrivacyCollectedDataTypeCreditInfo' | 'NSPrivacyCollectedDataTypeOtherFinancialInfo' | 'NSPrivacyCollectedDataTypePreciseLocation' | 'NSPrivacyCollectedDataTypeCoarseLocation' | 'NSPrivacyCollectedDataTypeSensitiveInfo' | 'NSPrivacyCollectedDataTypeContacts' | 'NSPrivacyCollectedDataTypeEmailsOrTextMessages' | 'NSPrivacyCollectedDataTypePhotosorVideos' | 'NSPrivacyCollectedDataTypeAudioData' | 'NSPrivacyCollectedDataTypeGameplayContent' | 'NSPrivacyCollectedDataTypeCustomerSupport' | 'NSPrivacyCollectedDataTypeOtherUserContent' | 'NSPrivacyCollectedDataTypeBrowsingHistory' | 'NSPrivacyCollectedDataTypeSearchHistory' | 'NSPrivacyCollectedDataTypeUserID' | 'NSPrivacyCollectedDataTypeDeviceID' | 'NSPrivacyCollectedDataTypePurchaseHistory' | 'NSPrivacyCollectedDataTypeProductInteraction' | 'NSPrivacyCollectedDataTypeAdvertisingData' | 'NSPrivacyCollectedDataTypeOtherUsageData' | 'NSPrivacyCollectedDataTypeCrashData' | 'NSPrivacyCollectedDataTypePerformanceData' | 'NSPrivacyCollectedDataTypeOtherDiagnosticData' | 'NSPrivacyCollectedDataTypeEnvironmentScanning' | 'NSPrivacyCollectedDataTypeHands' | 'NSPrivacyCollectedDataTypeHead' | 'NSPrivacyCollectedDataTypeOtherDataTypes';
type NSPrivacyCollectedDataTypePurpose = 'NSPrivacyCollectedDataTypePurposeThirdPartyAdvertising' | 'NSPrivacyCollectedDataTypePurposeDeveloperAdvertising' | 'NSPrivacyCollectedDataTypePurposeAnalytics' | 'NSPrivacyCollectedDataTypePurposeProductPersonalization' | 'NSPrivacyCollectedDataTypePurposeAppFunctionality' | 'NSPrivacyCollectedDataTypePurposeOther';
/**
