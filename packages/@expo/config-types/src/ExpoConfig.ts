...
export interface ExpoConfig {
  ...
  updates?: {
    ...
    /**
     * Enable support for downloading and applying asset patches (such as Hermes bytecode diffs). Defaults to true. Set to false to force full asset downloads even when a server offers patch responses.
     */
    enablePatchSupport?: boolean;
  };
  /**
