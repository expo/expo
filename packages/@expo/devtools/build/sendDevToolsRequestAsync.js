 ...
 */
export async function sendDevToolsRequestAsync(client, method, params = {}, timeoutMs = DEFAULT_TIMEOUT_MS) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const sub = client.addMessageListener('response', (data) => {
...
//# sourceMappingURL=sendDevToolsRequestAsync.js.map