...
- [iOS] Add ExpoModulesWorkletsAdapter podspec to expo-module.config.json to include the adapter in iOS builds and fix any uses of `withAnimation` and it's worklet serialization in ExpoUI. ([#46440](https://github.com/expo/expo/pull/46440) by [@KGMaxey](https://github.com/KGMaxey))
