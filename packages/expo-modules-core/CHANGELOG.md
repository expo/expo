...
- [Android] Update to the RNHeadlessAppLoader class to make it work on the new architecture ([#32146](https://github.com/expo/expo/pull/32146) by [@chrfalch](https://github.com/chrfalch))
