...
- Add `isNativeModuleInstalled` function to the check if a module is instaled at runtime. ([#22408](https://github.com/expo/expo/pull/22408) by [@gabrieldonadel](https://github.com/gabrieldonadel))
