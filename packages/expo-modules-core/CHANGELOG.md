...
- [iOS] Fix the SwiftUI `Host` `ignoreSafeArea` prop being applied only once on mount, so clearing or changing it now re-enables the safe area without an app reload. ([#47619](https://github.com/expo/expo/pull/47619) by [@nishan](https://github.com/intergalacticspacehighway))
