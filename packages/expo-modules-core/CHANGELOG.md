...
- [android] Fix events being silently dropped for Compose views in custom modules. ([#46624](https://github.com/expo/expo/issues/46624) by [@nishan](https://github.com/intergalacticspacehighway))
