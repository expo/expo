...
- Fixed `useReleasingSharedObject` returning a released object after React's `<Activity>` hides and shows the tree again, which left `useVideoPlayer` and `useAudioPlayer` permanently unusable. ([#49601](https://github.com/expo/expo/pull/49601) by [@expo-bot](https://github.com/expo-bot))
