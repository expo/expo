...
- [iOS] Add `invalidate` callback to SwiftUIVirtualView, fixes crash on component unmount for RN 0.82. ([#40237](https://github.com/expo/expo/pull/40237) by [@intergalacticspacehighway](https://github.com/intergalacticspacehighway))
