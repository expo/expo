...
interface TypeConverter<Type : Any> {
   ...
   */
  fun convert(value: Any?, context: AppContext? = null): Type?
...
abstract class NonNullableTypeConverter<Type : Any>() : TypeConverter<Type> {
  override fun convert(value: Any?, context: AppContext?): Type {
    return convertNonNullable(value ?: throw NullArgumentException(), context)
  }

  abstract fun convertNonNullable(value: Any, context: AppContext?): Type
}
