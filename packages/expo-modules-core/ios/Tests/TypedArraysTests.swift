...
@Suite("TypedArrays", .serialized)
@JavaScriptActor
struct TypedArraysTests {
  ...
  @Test
  func `reads from Int8Array`() throws {
  ...
  @Test
  func `writes to Int8Array`() throws {
  ...
  @Test
  func `reads from UInt16Array slice`() throws {
  ...
  @Test
  func `writes to UInt16Array slice`() throws {
  ...
  @Test
  func `writes to unsafe raw pointer`() throws {
    let count = 6
    let values = try runtime
      .eval([
  ...
  @Test
  func `returns a correct slice when created from a buffer`() throws {
