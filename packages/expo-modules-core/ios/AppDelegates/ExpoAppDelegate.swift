...
open class ExpoAppDelegate: EXReactNativeFactoryDelegate, UIApplicationDelegate, UISceneDelegate {
  /**
  ...
  @objc public let reactDelegate = ExpoReactDelegate(handlers: reactDelegateHandlers)
  ...
  @objc
  public convenience init(factoryDelegate: RCTReactNativeFactoryDelegate) {
    self.init()
