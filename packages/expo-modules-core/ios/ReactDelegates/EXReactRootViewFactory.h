...
/**
 Create a default react instance binded root view.
 This is a wrapper for `RCTRootViewFactory` that create `RCTRootViewFactoryConfiguration` from `UIApplication.sharedApplication.delegate`.
