 ...
 */
public final class JavaScriptFunction2<ReturnType>: AnyArgument, AnyJavaScriptValue, @unchecked Sendable {
  /**
   Raw representation of the JavaScript function that doesn't impose any restrictions on the returned type.
   */
  private let rawFunction: JavaScriptFunction
  ...
  init(rawFunction: consuming JavaScriptFunction, appContext: AppContext) {
   ...
   */
  public func call(_ arguments: Any..., usingThis this: consuming JavaScriptObject? = nil) throws -> ReturnType {
    fatalError()
...
//    return try call(withArguments: arguments, asConstructor: true, usingThis: nil)
   ...
   */
  private func call(withArguments arguments: [Any] = [], asConstructor: Bool = false, usingThis this: consuming JavaScriptObject? = nil) throws -> ReturnType {
    fatalError()
