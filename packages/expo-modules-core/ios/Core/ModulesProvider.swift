...
#if os(iOS) || os(tvOS)
  /**
   Returns an array of classes that hook into `ExpoAppSceneDelegate` to receive scene delegate events.
   */
  func getSceneDelegateSubscribers() -> [ExpoSceneDelegateSubscriber.Type]
#endif
...
#if os(iOS) || os(tvOS)
  open func getSceneDelegateSubscribers() -> [ExpoSceneDelegateSubscriber.Type] {
    return []
  }
#endif
