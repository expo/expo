...
//
//public extension EXJavaScriptRuntime {
//  /**
//   A type of the closure that you pass to the `createSyncFunction` function.
//   */
//  typealias SyncFunctionClosure = (_ this: EXJavaScriptValue, _ arguments: [EXJavaScriptValue]) throws -> EXJavaScriptValue
//
//  /**
...
//   */
//  @discardableResult
//  func eval(_ source: String) throws -> EXJavaScriptValue {
//    do {
//      var result: EXJavaScriptValue?
...
//   */
//  func createSyncFunction(_ name: String, argsCount: Int = 0, closure: @escaping SyncFunctionClosure) -> EXJavaScriptObject {
