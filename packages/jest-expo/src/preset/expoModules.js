module.exports = {
  ...
  NativeUnimoduleProxy: {
    ...
    exportedMethods: {
      ...
      mock: {
        ...
        ExpoAppleAuthentication: [
          { argumentsCount: 0, key: 'isAvailableAsync', name: 'isAvailableAsync' },
          { name: 'stopObserving', argumentsCount: 0, key: 'stopObserving' },
          { argumentsCount: 1, key: 'getCredentialStateAsync', name: 'getCredentialStateAsync' },
          { key: 'requestAsync', argumentsCount: 1, name: 'requestAsync' },
        ...
        ExpoBarCodeScanner: [
          ...
          { key: 'scanFromURLAsync', argumentsCount: 2, name: 'scanFromURLAsync' },
        ],
        ExpoBarometer: [
        ...
        ExpoBattery: [
          ...
          { key: 'getBatteryStateAsync', argumentsCount: 0, name: 'getBatteryStateAsync' },
        ],
        ExpoBlurView: [{ key: 'setNativeProps', name: 'setNativeProps', argumentsCount: 2 }],
        ExpoBrightness: [
          { key: 'getBrightnessAsync', name: 'getBrightnessAsync', argumentsCount: 0 },
          { name: 'requestPermissionsAsync', argumentsCount: 0, key: 'requestPermissionsAsync' },
          { argumentsCount: 1, key: 'setBrightnessAsync', name: 'setBrightnessAsync' },
          {
            key: 'isUsingSystemBrightnessAsync',
            argumentsCount: 0,
            name: 'isUsingSystemBrightnessAsync',
          },
          { argumentsCount: 0, name: 'startObserving', key: 'startObserving' },
          ...
          { key: 'setSystemBrightnessAsync', name: 'setSystemBrightnessAsync', argumentsCount: 0 },
        ],
        ExpoCalendar: [
        ...
        ExpoCellular: [
          ...
          { argumentsCount: 0, key: 'allowsVoipAsync', name: 'allowsVoipAsync' },
          { argumentsCount: 0, key: 'getIsoCountryCodeAsync', name: 'getIsoCountryCodeAsync' },
          {
        ...
        ExpoClipboard: [
          { key: 'hasStringAsync', name: 'hasStringAsync', argumentsCount: 0 },
        ...
        ExpoCrypto: [
          { argumentsCount: 3, key: 'digest', name: 'digest' },
          {
          ...
          { key: 'getRandomBase64String', name: 'getRandomBase64String', argumentsCount: 1 },
        ...
        ExpoDevice: [
          ...
          { key: 'getUptimeAsync', argumentsCount: 0, name: 'getUptimeAsync' },
          { name: 'getDeviceTypeAsync', key: 'getDeviceTypeAsync', argumentsCount: 0 },
        ],
        ...
        ExpoLocalization: [
          ...
          { argumentsCount: 0, key: 'getCalendars', name: 'getCalendars' },
          { key: 'getLocales', name: 'getLocales', argumentsCount: 0 },
        ],
        ExpoLocation: [
        ...
        ExpoStoreReview: [
          { key: 'requestReview', argumentsCount: 0, name: 'requestReview' },
          { argumentsCount: 0, key: 'isAvailableAsync', name: 'isAvailableAsync' },
        ],
        ExpoSystemUI: [
        ...
        ExpoVideoThumbnails: [{ argumentsCount: 2, key: 'getThumbnail', name: 'getThumbnail' }],
        ExpoVideoView: [{ argumentsCount: 2, key: 'setFullscreen', name: 'setFullscreen' }],
        ExpoWebBrowser: [
          { key: 'openBrowserAsync', name: 'openBrowserAsync', argumentsCount: 2 },
          {
            argumentsCount: 0,
          ...
          { name: 'warmUpAsync', key: 'warmUpAsync', argumentsCount: 0 },
          ...
          { key: 'mayInitWithUrlAsync', name: 'mayInitWithUrlAsync', argumentsCount: 0 },
        ...
        ExponentCamera: [
          ...
          { argumentsCount: 1, key: 'resumePreview', name: 'resumePreview' },
          { argumentsCount: 2, name: 'getAvailablePictureSizes', key: 'getAvailablePictureSizes' },
          ...
          { key: 'stopRecording', name: 'stopRecording', argumentsCount: 1 },
          {
            argumentsCount: 0,
        ...
        ExponentConstants: [
          { argumentsCount: 0, name: 'getWebViewUserAgentAsync', key: 'getWebViewUserAgentAsync' },
        ],
        ...
        NativeModulesProxy: [{ argumentsCount: 3, key: 'callMethod', name: 'callMethod' }],
    ...
    viewManagersMetadata: {
      type: 'object',
      mock: {
        ExpoAppleAuthentication: { propsNames: ['buttonType', 'buttonStyle', 'cornerRadius'] },
