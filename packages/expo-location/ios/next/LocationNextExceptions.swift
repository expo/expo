...
final class MissingPurposeKeyException: GenericException<String>, @unchecked Sendable {
  override var reason: String {
...
final class TemporaryFullAccuracyFailedException: Exception, @unchecked Sendable {
  override var reason: String {
