...
// iOS <18 compatibility layer with CLLocationManager, EXBackgroundLocationPermissionRequester rewritten in Swift.
final class AlwaysAuthorizationCompatibilitySource: NSObject, AlwaysAuthorizationSource, CLLocationManagerDelegate {
