...
{
  if ([EXBaseLocationRequester isConfiguredForWhenInUseAuthorization] && [self.locMgr  respondsToSelector:whenInUseAuthorizationSelector]) {
    ((void (*)(id, SEL))objc_msgSend)(self.locMgr, whenInUseAuthorizationSelector);
  } else {
