...
- [iOS] Added error handler to the streaming location/heading methods since these can fail while streaming ([]() by [@chrfalch](https://github.com/chrfalch)) ([#35004](https://github.com/expo/expo/pull/35004) by [@chrfalch](https://github.com/chrfalch))
