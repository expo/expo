...
// @needsAudit
/**
 * Sets a Google API Key for using Google Maps Geocoding API which
 ...
 * Google Play Services, hence no Geocoder Service.
 * @param apiKey Google API key obtained from Google API Console.
