...
class MotionActivityTaskService : Service() {
  ...
  inner class ServiceBinder : Binder() {
    val service: MotionActivityTaskService
      get() = this@MotionActivityTaskService
  }
  ...
  fun setParentContext(context: Context) {
    // Background motion activity logic is still outside MotionActivityTaskService,
  ...
  private fun prepareChannel(id: String?) {
    ...
    if (channel == null) {
      ...
      channel.description = "Background motion activity notification channel"
