...
- [iOS] [New Architecture] Restore orientationMask after app transition from background to foreground ([#42532](https://github.com/expo/expo/pull/42532) by [@LongyuW](https://github.com/LongyuW))
