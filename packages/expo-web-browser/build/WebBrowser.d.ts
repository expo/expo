import { OpenBrowserParams, AuthSessionResult, CustomTabsBrowsersResults, BrowserResult, MayInitWithUrlResult, WarmUpResult, CoolDownResult } from './WebBrowser.types';
