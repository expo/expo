...
function moduleInterfaceCommand(cli) {
    return (0, commandUtils_1.addCommonOptions)(cli.command('module-interface'))
        ...
        .description('Generates a full ts interface for a Swift module. It consists of *.types.ts file with all types defined in the module, *Module.ts with the native module definition, and *View.tsx for each view defined in the module, and an index.ts file which reexports definitions from the other files.')
