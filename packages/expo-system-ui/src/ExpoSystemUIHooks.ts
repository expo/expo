...
import { ChangeEventPayload, InterfaceStyle } from './ExpoSystemUI.types';
...
export function useInterfaceStyle() {
  const [interfaceStyle, setInterfaceStyle] = React.useState<InterfaceStyle>('auto');
