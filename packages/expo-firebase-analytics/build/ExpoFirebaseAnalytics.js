    ...
    if (DEFAULT_APP_NAME !== '[DEFAULT]') {
        ...
        if (isUnavailabilityLoggingEnabled) {
            if (!isUnavailabilityWarningLogged) {
                console.warn(`Firebase Analytics is not available in the Expo client. See "https://docs.expo.io/versions/unversioned/sdk/firebase-analytics#expo_client_limitations_configuration" on more information on setting up Firebase Analytics with the standard Expo Client.`);
