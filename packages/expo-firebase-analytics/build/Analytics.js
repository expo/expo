...
export async function initAppAsync(config) {
    // @ts-ignore
...
export async function deleteAppAsync(config) {
 ...
 */
export async function logEventAsync(name, properties) {
 ...
 */
export async function setAnalyticsCollectionEnabledAsync(analyticsCollectionEnabled) {
 ...
 *     default class name.
 */
export async function setCurrentScreenAsync(screenName, screenClassOverride) {
 ...
 *     session terminates.
 */
export async function setSessionTimeoutDurationAsync(sessionTimeoutInterval) {
 ...
 */
export async function setUserPropertyAsync(name, value) {
...
export async function setUserPropertiesAsync(properties) {
    if (!ExpoFirebaseAnalytics.setUserPropertiesAsync) {
        ...
        await Promise.all(Object.keys(properties).map(key => setUserPropertyAsync(key, properties[key])));
        return;
    }
