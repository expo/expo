...
exports.fixHermesV1ClassInFinally = fixHermesV1ClassInFinally;
    ...
    return {
        ...
        visitor: {
            ClassDeclaration(path) {
                ...
                const arrow = t.arrowFunctionExpression([], t.blockStatement([inner, t.returnStatement(t.cloneNode(id))]));
