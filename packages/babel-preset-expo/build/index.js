...
// @ts-ignore
const lazy_imports_blacklist_1 = __importDefault(require("babel-preset-expo/lazy-imports-blacklist"));
...
function babelPresetExpo(api, options = {}) {
    ...
    const extraPlugins = [getObjectRestSpreadPlugin()];
    if ('useTransformReactJsxExperimental' in platformOptions && !hasWarnedJsxRename) {
        ...
        console.warn('Warning: useTransformReactJsxExperimental has been renamed to useTransformReactJSXExperimental (capitalized JSX) in react-native@0.64.0');
    }
                ...
                require('metro-react-native-babel-preset'),
                {
                    ...
                    lazyImportExportTransform: lazyImportsOption === true
                        ? (importModuleSpecifier) => {
                            ...
                            return !(importModuleSpecifier.includes('./') ||
                                lazy_imports_blacklist_1.default.has(importModuleSpecifier));
                        }
