...
- [[0005-runtime-loop-tools]] — seeing and driving the running app: runtime eval (CDP), red-screen feed, deep-link navigation, the smoke gate, performance probe, cross-platform sweep; log-triage and verified-UI loops. Network inspection is deferred ([[0016-v1-scope]]).
