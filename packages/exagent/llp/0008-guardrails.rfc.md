...
- **Checkpoints** [deferred from v1, 2026-08-26 — see [[0017-deferred-commands]]]. An automatic git snapshot before each action batch, with `exagent checkpoint:undo` to restore.
...
The case that produced this rule was `exagent doctor:fix` and the checkpoint it took. Both are
