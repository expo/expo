  ...
  if (args['--help']) {
    printHelp(
      ...
      [
        ...
        chalk`  not be run or failed without reporting anything.`,
        '',
        chalk`  A project with no {bold typescript} installed, or no {bold tsconfig.json}, has nothing to check.`,
        chalk`  That is reported as {bold checked: false} with a reason, and exits {bold 0} — a gate that went`,
        chalk`  red for the absence of TypeScript would be red for every JavaScript project forever.`,
        '',
