...
- "exagent-eas-builds.json": remembers a finished EAS build that "exagent status --builds" found for this project's current fingerprint, so the next "exagent status" can report it without calling EAS again. The entry is dropped as soon as the project fingerprint changes.
