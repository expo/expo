...
// @ref llp/0021-honest-reports.rfc.md §An observed signal, or the band.
//
...
// llp/0015 §What the first run costs is careful to make a once-per-machine cost, turned into a
