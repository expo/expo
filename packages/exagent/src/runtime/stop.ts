  ...
  if (args['--help']) {
    printHelp(
      ...
      [
        ...
        `--cloud                 Refused, with what to run instead: see below`,
      ...
      [
        ...
        '',
        chalk`  {bold There is no cloud form of this command.} {bold navigate --cloud} drives an EAS Simulator`,
        chalk`  session, and the controller behind one has verbs for opening a link and taking a`,
        chalk`  picture — none for ending a single app. {bold npx eas simulator:stop} ends the whole`,
        chalk`  session, which is a larger act. {bold --cloud} is accepted here only so it can say that.`,
        '',
