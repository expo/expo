// @ref llp/0005-runtime-loop-tools.rfc.md §Reloading a cloud session
// @ref llp/0021-honest-reports.rfc.md §The premise that could not be tested
...
// [observed — live staging, 2026-08-26, S12; hit again by Kudo, 2026-08-27, with "1 app connected"
// on screen].
//
...
export async function reloadOnCloudSimulatorAsync(
  ...
  // @ref llp/0005 §Finding the session — S14. The one controller refusal whose remedy is in its own
 ...
 *
 * The controller refusing and the bridge failing are different facts (llp/0005 §A non-zero exit
 * means different things per backend), and a reason that flattened them would send a reader to
