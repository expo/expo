  ...
  if (args['--help']) {
    printHelp(
      ...
      [
        ...
        '',
        chalk`  {bold --port} is the answer to the one question this command cannot be asked. When 8081`,
        chalk`  is busy the Expo CLI asks whether to use another port, and a run with no terminal`,
        chalk`  stops there and starts nothing (exit {bold 7}). Naming the port answers it up front, and`,
        chalk`  the suggested next steps then name the dev server that actually started.`,
