...
- Migrated barcode scanner interface from `unimodules-barcode-scanner-interface` to `expo-modules-core`. ([#12912](https://github.com/expo/expo/pull/12912) by [@tsapeta](https://github.com/tsapeta))
