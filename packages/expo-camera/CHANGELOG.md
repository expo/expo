...
- On Web prevent the worker to be immediately cleaned up after finishing it's job to allow reusing it later (e.g. do not re-download every script upon repetitive worker launch). ([#15369](https://github.com/expo/expo/pull/15369) by [@jer-sen](https://github.com/jer-sen) and [#??](https://github.com/expo/expo/pull/??) by [@bbarthec](https://github.com/bbarthec))
