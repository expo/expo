...
- On iOS added new `requestCameraPermissions()` and `requestMicrophonePermissions()` methods which gives more fine-grained control over requested permissions. ([#12860](https://github.com/expo/expo/pull/12772) by [@ajsmth](https://github.com/ajsmth))
