...
For usage in a React app created with `create-react-app <Project> --typescript`
...
For usage in an Expo web app created with `expo init <Project> --typescript --web`

```sh
yarn add expo-camera
```

### React Native: iOS (Cocoapods)
