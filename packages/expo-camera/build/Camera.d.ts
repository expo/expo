...
export default class Camera extends React.Component<Props> {
    ...
    static propTypes: {
        ...
        accessibilityRole?: PropTypes.Validator<"button" | "header" | "link" | "menu" | "summary" | "none" | "menuitem" | "image" | "switch" | "text" | "search" | "keyboardkey" | "adjustable" | "imagebutton" | "alert" | "checkbox" | "combobox" | "menubar" | "progressbar" | "radio" | "radiogroup" | "scrollbar" | "spinbutton" | "tab" | "tablist" | "timer" | "toolbar" | undefined> | undefined;
        ...
        accessibilityTraits?: PropTypes.Validator<"button" | "header" | "link" | "summary" | "none" | "image" | "text" | "search" | "adjustable" | "disabled" | "selected" | "plays" | "key" | "frequentUpdates" | "startsMedia" | "allowsDirectInteraction" | "pageTurn" | import("react-native").AccessibilityTrait[] | undefined> | undefined;
