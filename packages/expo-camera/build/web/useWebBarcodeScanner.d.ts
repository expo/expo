...
export declare function useWebBarcodeScanner(video: React.MutableRefObject<HTMLVideoElement | null>, { isEnabled, barcodeTypes, interval, isMirrored, onScanned, onError, }: {
    isEnabled: boolean;
