...
@implementation DevLauncherRNSVGSvgView
{
    NSMutableDictionary<NSString *, DevLauncherRNSVGNode *> *_clipPaths;
    NSMutableDictionary<NSString *, DevLauncherRNSVGNode *> *_templates;
    NSMutableDictionary<NSString *, DevLauncherRNSVGPainter *> *_painters;
    NSMutableDictionary<NSString *, DevLauncherRNSVGNode *> *_markers;
    NSMutableDictionary<NSString *, DevLauncherRNSVGNode *> *_masks;
...
- (void)invalidate
{
    ...
    if ([parent isKindOfClass:[DevLauncherRNSVGNode class]]) {
        ...
        DevLauncherRNSVGNode* svgNode = (DevLauncherRNSVGNode*)parent;
        [svgNode invalidate];
        rendered = false;
        return;
    }
...
- (void)setBbWidth:(DevLauncherRNSVGLength *)bbWidth
{
...
- (void)setBbHeight:(DevLauncherRNSVGLength *)bbHeight
{
...
- (void)drawToContext:(CGContextRef)context withRect:(CGRect)rect {
    ...
    if (self.align) {
        ...
        _viewBoxTransform = [DevLauncherRNSVGViewBox getTransform:tRect
                                                 eRect:rect
                                                 align:self.align
    ...
    for (DevLauncherRNSVGView *node in self.subviews) {
        if ([node isKindOfClass:[DevLauncherRNSVGNode class]]) {
            DevLauncherRNSVGNode *svg = (DevLauncherRNSVGNode *)node;
...
- (void)drawRect:(CGRect)rect
{
    ...
    for (DevLauncherRNSVGPlatformView *node in self.subviews) {
        if ([node isKindOfClass:[DevLauncherRNSVGNode class]]) {
            DevLauncherRNSVGNode *svg = (DevLauncherRNSVGNode *)node;
...
- (DevLauncherRNSVGPlatformView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    for (DevLauncherRNSVGNode *node in [self.subviews reverseObjectEnumerator]) {
        if (![node isKindOfClass:[DevLauncherRNSVGNode class]]) {
            continue;
        }
        ...
        DevLauncherRNSVGPlatformView *hitChild = [node hitTest:transformed withEvent:event];
...
- (void)defineTemplate:(DevLauncherRNSVGNode *)template templateName:(NSString *)templateName
{
    if (!_templates) {
