...
@implementation DevLauncherRNSVGImage
{
    CGImageRef _image;
    CGSize _imageSize;
...
- (void)setImagewidth:(DevLauncherRNSVGLength *)width
{
...
- (void)setImageheight:(DevLauncherRNSVGLength *)height
{
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    CGAffineTransform viewbox = [DevLauncherRNSVGViewBox getTransform:imageBounds eRect:hitArea align:self.align meetOrSlice:self.meetOrSlice];
