...
@implementation DevLauncherRNSVGMarker
...
- (void)setX:(DevLauncherRNSVGLength *)refX
{
...
- (void)setY:(DevLauncherRNSVGLength *)refY
{
...
- (void)setMarkerWidth:(DevLauncherRNSVGLength *)markerWidth
{
...
- (void)setMarkerHeight:(DevLauncherRNSVGLength *)markerHeight
{
...
- (void)renderMarker:(CGContextRef)context rect:(CGRect)rect position:(DevLauncherRNSVGMarkerPosition*)position strokeWidth:(CGFloat)strokeWidth
{
    ...
    if (self.align) {
        CGAffineTransform viewBoxTransform = [DevLauncherRNSVGViewBox getTransform:CGRectMake(self.minX, self.minY, self.vbWidth, self.vbHeight)
                                                                  eRect:eRect
                                                                  align:self.align
