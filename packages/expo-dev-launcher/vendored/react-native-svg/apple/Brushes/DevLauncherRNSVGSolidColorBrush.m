...
#import "DevLauncherRNSVGSolidColorBrush.h"

#import "RCTConvert+DevLauncherRNSVG.h"
#import <React/RCTLog.h>

@implementation DevLauncherRNSVGSolidColorBrush
{
    CGColorRef _color;
}

- (instancetype)initWithArray:(NSArray<DevLauncherRNSVGLength *> *)array
{
    if ((self = [super initWithArray:array])) {
        _color = CGColorRetain([RCTConvert DevLauncherRNSVGCGColor:array offset:1]);
    }
    return self;
}
