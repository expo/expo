...
@implementation DevLauncherRNSVGLength
...
{
    DevLauncherRNSVGLength *length = [[self alloc] init];
...
+ (instancetype) lengthWithString: (NSString *) lengthString {
    ...
    DevLauncherRNSVGLength *output = [DevLauncherRNSVGLength alloc];
    if (stringLength == 0) {
        ...
        DevLauncherRNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
