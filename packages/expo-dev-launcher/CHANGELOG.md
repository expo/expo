...
- [plugin] add `defaultLaunchURL` option to have a default fallback launch URI to launch into. ([#44419](https://github.com/expo/expo/pull/44419) by [@HubertBer](https://github.com/HubertBer))
