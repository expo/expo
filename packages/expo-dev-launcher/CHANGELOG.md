...
- [iOS] Stop the `_expo._tcp` Bonjour browse as soon as an app launch starts, and do not start a new one while an app is loading or running. ([#49326](https://github.com/expo/expo/pull/49326) by [@expo-bot](https://github.com/expo-bot))
