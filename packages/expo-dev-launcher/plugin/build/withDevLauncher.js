...
exports.default = (0, config_plugins_1.createRunOncePlugin)((config, props) => {
    ...
    config = (0, config_plugins_1.withAndroidManifest)(config, (config) => {
        ...
        if (props.android?.tryToLaunchLastOpenedBundle) {
            config_plugins_1.AndroidConfig.Manifest.addMetaDataItemToMainApplication(mainApplication, 'DEV_CLIENT_TRY_TO_LAUNCH_LAST_BUNDLE', props.android?.tryToLaunchLastOpenedBundle?.toString());
        }
        return config;
    });
    return config;
