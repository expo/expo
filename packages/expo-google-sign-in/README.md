...
This module can only be used in ExpoKit, or a Standalone Expo app. For in-depth setup, check out this guide: [React Native Google Sign-In](https://blog.expo.io/react-native-google-sign-in-with-expo-d1707579a7ce)
    ...
    "ios": {
      ...
      "config": {
        "googleSignIn": {
          ...
          "reservedClientId": "com.googleusercontent.apps.<DEBUG_VALUE>"
        }
      }
    }
  }
