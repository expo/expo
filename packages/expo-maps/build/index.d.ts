...
export declare namespace AppleMaps {
    const View: import("react").ForwardRefExoticComponent<Omit<AppleTypes.MapProps, "ref"> & import("react").RefAttributes<AppleTypes.MapViewType>>;
    ...
    type MapView = AppleTypes.MapViewType;
}
