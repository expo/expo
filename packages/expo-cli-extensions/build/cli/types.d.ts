 ...
 */
export type ExpoCliApplication = {
 ...
 */
export type ExpoCliExtensionExecutor<T extends ExpoCliExtensionCommandSchema> = <K extends keyof T>(command: K, args: ExpoCliExtensionArgs<T>[K], apps: ExpoCliApplication[]) => Promise<ExpoCliOutput>;
/**
