 ...
 * ```
 * @deprecated Deprecated field, use [`getCurrentCellularInfoAsync()`](#getcurrentcellularinfoasync) instead.
 *
 */
 ...
 *  * # Example
 * ```ts
 * await Cellular.getCurrentCellularInfoAsync();
 * ```
 */
export async function getCurrentCellularInfoAsync() {
