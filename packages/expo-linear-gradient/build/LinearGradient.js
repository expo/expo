...
export class LinearGradient extends React.Component {
    render() {
        ...
        return (<NativeLinearGradient {...props} colors={Platform.select({
            ...
            })} ditherPaintAndroid={Platform.select({ android: ditherPaintAndroid || false })} locations={resolvedLocations} startPoint={_normalizePoint(start)} endPoint={_normalizePoint(end)}/>);
    }
}
