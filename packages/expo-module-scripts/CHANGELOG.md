...
- Enabled the `react/use-memo` and `react/void-use-memo` rules in the shared oxlint config. ([#49242](https://github.com/expo/expo/pull/49242) by [@tsapeta](https://github.com/tsapeta))
