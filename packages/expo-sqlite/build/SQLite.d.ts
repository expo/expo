...
/**
 * Open a database, creating it if it doesn't exist, and return a `Database` object. On disk, th
 * database will be created under the app's [documents directory](../filesystem), i.e.
