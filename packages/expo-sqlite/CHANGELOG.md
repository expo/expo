...
- [iOS] Fixed an `EXC_BAD_ACCESS` crash when a database is closed while another query on the same connection is still running. ([#49798](https://github.com/expo/expo/pull/49798) by [@expo-bot](https://github.com/expo-bot))
