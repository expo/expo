...
- Add colocated agent evals (`skills/expo-sqlite/.evals/`, development-only) for the shipped skill. ([#48798](https://github.com/expo/expo/pull/48798) by [@kudo](https://github.com/kudo))
