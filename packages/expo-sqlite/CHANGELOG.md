...
- [Web] Fixed `deleteDatabaseAsync` and `deleteDatabaseSync` ignoring the VFS result, so a failed delete reported success. ([#36835](https://github.com/expo/expo/issues/36835) by [@Maher-Reven](https://github.com/Maher-Reven))
