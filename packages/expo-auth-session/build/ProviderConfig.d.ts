...
export declare type IssuerOrProviderConfig = string | ProviderConfig;
/**
...
export declare function fetchProviderConfigAsync(issuer: string): Promise<ProviderConfig>;
/**
 * Utility method for resolving the provider config from an issuer or object.
 *
 * @param issuerOrProviderConfig
 */
export declare function resolveProviderConfigAsync(issuerOrProviderConfig: IssuerOrProviderConfig): Promise<ProviderConfig>;
