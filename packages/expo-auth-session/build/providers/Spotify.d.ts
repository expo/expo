...
declare class SpotifyAuthRequest extends AuthRequest {
    constructor({ language, selectAccount, extraParams, clientSecret, ...config }: SpotifyAuthRequestConfig);
}
/**
 ...
 * @param discovery
 */
export declare function useAuthRequest(config: SpotifyAuthRequestConfig): [SpotifyAuthRequest | null, AuthSessionResult | null, (options?: AuthRequestPromptOptions) => Promise<AuthSessionResult>];
/**
