...
export declare type PermissionType = 'camera' | 'cameraRoll' | 'mediaLibrary' | 'writeOnlyMediaLibrary' | 'audioRecording' | 'location' | 'userFacingNotifications' | 'notifications' | 'contacts' | 'calendar' | 'reminders' | 'motion' | 'systemBrightness';
