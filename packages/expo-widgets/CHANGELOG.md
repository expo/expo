...
- [iOS] Fix widgets rendering the "Please adopt containerBackground API" placeholder by applying a fallback container background when the layout doesn't set one.
