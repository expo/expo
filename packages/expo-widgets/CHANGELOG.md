...
- [iOS] Clear stored Live Activity interaction state after activities end or disappear.
...
- Enable button interactions inside sectioned Live Activity layouts without overwriting server updates.
