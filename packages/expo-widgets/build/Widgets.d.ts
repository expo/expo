...
export declare const updateWidgetTimeline: <T extends object>(name: string, dates: Date[], widget: (p: WidgetProps<T>) => React.JSX.Element, props?: T) => void;
export declare const updateWidgetSnapshot: <T extends object>(name: string, widget: (p: WidgetProps<T>) => React.JSX.Element, props?: T) => void;
