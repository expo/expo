...
#import <EXRawManifests/NSDictionary+EXRawManifestsRawManifest.h>

@interface NSDictionaryEXRawManifestsRawManifestTest : XCTestCase

@property (nonatomic, strong) NSDictionary *testData;

@end

@implementation NSDictionaryEXRawManifestsRawManifestTest
