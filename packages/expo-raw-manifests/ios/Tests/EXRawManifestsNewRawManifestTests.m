...
@interface EXRawManifestsNewRawManifestTests : XCTestCase

@end

@implementation EXRawManifestsNewRawManifestTests
...
- (void)testSDKVersion_ValidCases {
  ...
  EXRawManifestsNewRawManifest *manifest = [[EXRawManifestsNewRawManifest alloc] initWithRawManifestJSON:manifestJson];
