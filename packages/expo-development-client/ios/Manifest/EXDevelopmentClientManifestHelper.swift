...
class EXDevelopmentClientManifestHelper {
  ...
  static func exportManifestOrientation(_ orientation: EXDevelopmentClientOrientation?) -> UIInterfaceOrientation {
    var orientationMask = UIInterfaceOrientationMask.all
    if orientation == EXDevelopmentClientOrientation.portrait {
      orientationMask = .portrait
    } else if orientation == EXDevelopmentClientOrientation.landscape {
