...
@interface EDUMNativeModulesProxy ()

@property (nonatomic, strong) NSRegularExpression *regexp;
@property (nonatomic, strong) EDUMModuleRegistry *moduleRegistry;
...
@implementation EDUMNativeModulesProxy
...
{
  return @"ExpoDevelopmentClientNativeUnimoduleProxy";
}
...
- (NSDictionary *)constantsToExport
{
  ...
  NSArray<EDUMViewManager *> *viewManagers = [_moduleRegistry getAllViewManagers];
