...
#import <EDUMReactNativeAdapter.h>
#import <React/RCTUIManager.h>
#import <React/RCTBridge+Private.h>
#import <React/RCTAppState.h>
#import <React/RCTImageLoader.h>

@interface EDUMReactNativeAdapter ()

@property (nonatomic, weak) RCTBridge *bridge;
@property (nonatomic, weak) EDUMNativeModulesProxy *modulesProxy;
...
@implementation EDUMReactNativeAdapter
...
{
  return @[@protocol(EDUMAppLifecycleService), @protocol(EDUMUIManager), @protocol(EDUMJavaScriptContextProvider)];
}
...
{
  __weak EDUMReactNativeAdapter *weakSelf = self;
  dispatch_async(_bridge.uiManager.methodQueue, ^{
    __strong EDUMReactNativeAdapter *strongSelf = weakSelf;
    if (strongSelf) {
...
# pragma mark - EDUMJavaScriptContextProvider
