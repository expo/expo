...
#import <EDUMAppDelegateWrapper.h>
...
@implementation EDUMAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitializedAndSorted {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<EDUMSingletonModule*> * singletonModules = [[EDUMModuleRegistryProvider singletonModules] allObjects];
    
    for (EDUMSingletonModule *singletonModule in singletonModules) {
