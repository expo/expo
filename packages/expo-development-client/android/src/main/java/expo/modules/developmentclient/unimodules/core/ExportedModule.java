...
import expo.modules.developmentclient.unimodules.core.interfaces.RegistryLifecycleListener;
  ...
  protected Map<String, Method> getExportedMethods(Class klass) {
    ...
    for (Method method : declaredMethodsArray) {
      if (method.getAnnotation(ExpoMethod.class) != null) {
        ...
        if (lastParameterClass != expo.modules.developmentclient.unimodules.core.Promise.class) {
          throw new IllegalArgumentException(
