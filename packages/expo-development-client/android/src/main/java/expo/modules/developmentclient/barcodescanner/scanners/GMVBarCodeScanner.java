...
import expo.modules.developmentclient.barcodescanner.utils.FrameFactory;
...
public class GMVBarCodeScanner extends ExpoBarCodeScanner {
  ...
  private List<BarCodeScannerResult> scan(expo.modules.developmentclient.barcodescanner.utils.Frame frame) {
    try {
