...
@interface EXManifestsNewRawManifestTests : XCTestCase

@end

@implementation EXManifestsNewRawManifestTests
...
- (void)testSDKVersion_ValidCases {
  ...
  EXManifestsNewRawManifest *manifest = [[EXManifestsNewRawManifest alloc] initWithRawManifestJSON:manifestJson];
