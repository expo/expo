...
describe(Linking.unwrapDevLaunchURL, () => {
  it(`returns the target of a legacy development client launch URL`, () => {
    expect(
      Linking.unwrapDevLaunchURL(
        'bacon://expo-development-client/?url=http%3A%2F%2F127.0.0.1%3A8081&__expo_disable_fab=1'
      )
  ...
  it(`returns the target given by __expo_url on any host`, () => {
    expect(
      Linking.unwrapDevLaunchURL(
        'bacon://?__expo_url=http%3A%2F%2F127.0.0.1%3A8081%2Fpath%3Fx%3D1&__expo_disable_auto_launch=1'
      )
  ...
  it(`removes the reserved params from an Expo Go URL`, () => {
    expect(
      Linking.unwrapDevLaunchURL(
        'exp://127.0.0.1:8081?__expo_disable_auto_launch=1&__expo_disable_fab=1&__expo_disable_onboarding=1'
      )
  ...
  it(`keeps the other params`, () => {
    expect(
      Linking.unwrapDevLaunchURL('exp://127.0.0.1:8081/--/path?__expo_disable_auto_launch=1&x=1')
    ).toBe('exp://127.0.0.1:8081/--/path?x=1');
  });

  it(`removes a reserved param from an app deep link`, () => {
    expect(Linking.unwrapDevLaunchURL('myapp://login?__expo_disable_fab=1')).toBe('myapp://login');
  });
