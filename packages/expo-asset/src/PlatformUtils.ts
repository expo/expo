 ...
 */
async function _downloadAsyncWithIntegrityCheck(uri, hash, type, name): Promise<string> {
 ...
 */
async function _downloadAsyncWithoutIntegrityCheck(uri, hash, type): Promise<string> {
