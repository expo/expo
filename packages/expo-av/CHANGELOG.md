...
- Add Audio metadata (title) updates for iOS via `setOnMetadataUpdate`. (by [@dani-mp](https://github.com/dani-mp)) ([#14134](https://github.com/expo/expo/pull/14134) by [@dani-mp](https://github.com/dani-mp))
