...
- Add support for streaming audio sample buffers in realtime from audio players. ([#13516](https://github.com/expo/expo/pull/13516) by [@mrousavy](https://github.com/mrousavy))
