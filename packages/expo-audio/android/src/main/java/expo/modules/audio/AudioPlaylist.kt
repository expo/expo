...
class AudioPlaylist(
  ...
  val currentTime get() = ref.currentPosition / 1000.0
  val duration get() = if (ref.duration != C.TIME_UNSET) ref.duration / 1000.0 else 0.0
  ...
  fun seekTo(seconds: Double) {
    ref.seekTo((seconds * 1000L).toLong())
  }
  ...
  private suspend fun sendStatusUpdate(map: Map<String, Any?>? = null) =
