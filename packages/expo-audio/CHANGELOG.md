...
- Add JSDoc to `AudioMetadata.artworkUrl` to document that only remote HTTP/HTTPS URLs are supported for lock screen artwork. ([#43649](https://github.com/expo/expo/pull/43649) by [@WaokE](https://github.com/WaokE))
- [iOS] Log a warning when lock screen artwork fails to load in `MediaController`, to help developers identify unsupported local asset URLs. ([#43649](https://github.com/expo/expo/pull/43649) by [@WaokE](https://github.com/WaokE))
- Document the `artworkUrl` remote URL requirement in the background audio playback usage guide. ([#43649](https://github.com/expo/expo/pull/43649) by [@WaokE](https://github.com/WaokE))
