...
- [iOS] Re-apply `preferredForwardBufferDuration` when the player item is replaced. ([#50468](https://github.com/expo/expo/pull/50468) by [@rmotafreitas](https://github.com/rmotafreitas))
