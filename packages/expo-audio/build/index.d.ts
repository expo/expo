...
import { AudioMode, AudioSource, AudioStatus, RecorderStatus, RecordingOptions, RecordingState } from './Audio.types';
...
export declare function useAudioRecorder(options: RecordingOptions, statusListener?: (state: RecordingState) => void): [AudioRecorder, RecorderStatus];
