...
export declare function useAudioRecorder(options: RecordingOptions, statusListener?: (status: RecordingStatus) => void, updateInterval?: number): [AudioModule.AudioRecorderWeb, RecorderState];
