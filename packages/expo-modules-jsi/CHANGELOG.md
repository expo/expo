...
- [iOS] Add `JavaScriptRuntime.task` that starts a task bound to the runtime's JavaScript thread, for work that a plain `Task { }` would let resume on the cooperative pool. ([#47900](https://github.com/expo/expo/pull/47900) by [@tsapeta](https://github.com/tsapeta))
