...
- fix broken apple doc link for UITabBarItem.SystemItem in native-tabs/types.ts ([#41184](https://github.com/expo/expo/pull/41184) by [@ushuz](https://github.com/ushuz))
