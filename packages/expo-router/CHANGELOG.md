...
- Fix the API reference showing a Web badge on `Stack.Toolbar` sub-components that do not render on web. ([#00000](https://github.com/expo/expo/pull/00000) by [@ramen2020](https://github.com/ramen2020))
