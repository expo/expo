...
- Export `createRouteKeyMinter` for custom router implementations. (by [@Ubax](https://github.com/Ubax)) ([#49712](https://github.com/expo/expo/pull/49712) by [@Ubax](https://github.com/Ubax))
