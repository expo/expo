...
- [android] remove navigation state restoration across activity recreation, which reused stale state on relaunch when the process survived. ([#44879](https://github.com/expo/expo/issues/44879) by [@Ubax](https://github.com/Ubax))
