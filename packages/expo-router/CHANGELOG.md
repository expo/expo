...
- Add `useRouterColor` hook that returns the `Color` API object and re-renders when the system theme or Material You colors change. ([#47848](https://github.com/expo/expo/pull/47848) by [@Ubax](https://github.com/Ubax))
