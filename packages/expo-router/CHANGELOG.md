...
- Fix sitemap system info rendering when `window.location` is unavailable. ([#45233](https://github.com/expo/expo/pull/45233) by [@vonkanehoffen](https://github.com/vonkanehoffen))
