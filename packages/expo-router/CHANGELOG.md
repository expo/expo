...
- Preserve parenthesized values in query params and hash fragments when stripping group segments from paths. ([#44189](https://github.com/expo/expo/pull/44189) by [@mvincentong](https://github.com/mvincentong))
