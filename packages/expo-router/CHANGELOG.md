...
- [web] Preload async route chunks during prefetch for instant navigation without Suspense fallback. ([#41697](https://github.com/expo/expo/pull/41697) by [@erickreutz](https://github.com/erickreutz))
