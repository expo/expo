...
- Migrate the native `Stack` navigator to the `standard-navigation` integration. ([@Ubax](https://github.com/Ubax)) ([#46593](https://github.com/expo/expo/pull/46593) by [@Ubax](https://github.com/Ubax))
