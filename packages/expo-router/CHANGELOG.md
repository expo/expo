...
- Add `useRouterColor` hook that returns the `Color` API object and re-renders when the system theme or Material You colors change. ([#47831](https://github.com/expo/expo/pull/47831) by [@Ubax](https://github.com/Ubax))
