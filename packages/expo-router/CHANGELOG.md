...
- Add `unstable_nativeProps` to native Stack options for forwarding raw `react-native-screens` screen and header props. ([#47482](https://github.com/expo/expo/pull/47482) by [@Ubax](https://github.com/Ubax))
