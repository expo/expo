...
- [android] Collapse the tab content bottom inset when the native tab bar is hidden, so screens that hide the bar (e.g. a nested stack) no longer leave an empty band the height of the tab bar. ([#47611](https://github.com/expo/expo/pull/47611) by [@debitan](https://github.com/debitan))
