...
- Add new `withAnchor` options `deep` & `target`. ([#35389](https://github.com/expo/expo/pull/35389) by [@marklawlor](https://github.com/marklawlor))
...
- Fix `withAnchor` not working with `<Redirect />` and nested `_layouts` ([#35389](https://github.com/expo/expo/pull/35389) by [@marklawlor](https://github.com/marklawlor))
