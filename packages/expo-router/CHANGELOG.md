...
- Add `getStateForDeclaredRoutes` to the `Router` interface on `expo-router/react-navigation`. Routers spreading `BaseRouter` inherit a default; custom routers that don't must implement it. ([#48479](https://github.com/expo/expo/pull/48479) by [@Ubax](https://github.com/Ubax))
