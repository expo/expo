...
- Preserve a system time mocked with `jest.setSystemTime` across `renderRouter` instead of resetting it to the real time. ([#46864](https://github.com/expo/expo/issues/46864) by [@jakub-agent](https://github.com/jakub-agent))
