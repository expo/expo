...
- Avoid bundling Material Symbols fonts on Android when native tabs do not use Material icons. ([#45689](https://github.com/expo/expo/pull/45689) by [@mvincentong](https://github.com/mvincentong))
