...
- Make `beforeRemove` non-preventable and add `removePrevented` event for removal prevention. ([#48347](https://github.com/expo/expo/pull/48347) by [@Ubax](https://github.com/Ubax))
