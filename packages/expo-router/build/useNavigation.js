...
function useNavigation(parent) {
    ...
    if (currentId === '' || currentId === `/${constants_1.DEFAULT_ROOT_LAYOUT_CONTEXT_KEY}`) {
        return navigation;
    }
    ...
    if (parent === '/') {
        ...
        return navigation.getParent(`/${constants_1.DEFAULT_ROOT_LAYOUT_CONTEXT_KEY}`) ?? navigation.getParent(``);
    }
