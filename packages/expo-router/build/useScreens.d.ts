...
export declare function createGetIdForRoute(route: Pick<RouteNode, 'dynamic' | 'route' | 'contextKey' | 'children'>, getId?: ScreenProps['getId']): NonNullable<ScreenProps['getId']>;
