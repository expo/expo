...
const ALLOWED_EVENT_TYPE_LISTENERS = ['didClose', 'close', 'show'];
...
const ModalContextProvider = ({ children }) => {
    ...
    const emitDidCloseEvent = (0, react_1.useCallback)((id) => {
    ...
    return (<ModalContext.Provider value={{
      ...
      <ModalsRenderer_1.ModalsRenderer modalConfigs={modalConfigs} onDismissed={emitCloseEvent} onShow={emitShowEvent}>
        {children}
