...
function Modal(props) {
    const { children, visible, onClose, onShow, animationType, presentationStyle, transparent, detents, closeOnNavigation, largestUndimmedDetentIndex, ...viewProps } = props;
