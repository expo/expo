...
export declare const Tabs: React.ForwardRefExoticComponent<Omit<Omit<import("@react-navigation/bottom-tabs").BottomTabNavigatorProps, "initialRouteName" | "children" | "layout" | "screenListeners" | "screenOptions" | "screenLayout" | "UNSTABLE_router" | "id"> & import("@react-navigation/native").DefaultRouterOptions<string> & {
