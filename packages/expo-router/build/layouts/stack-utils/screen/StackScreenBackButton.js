 ...
 */
export function StackScreenBackButton({ children, style, withMenu, displayMode, hidden, src, }) {
    const options = useMemo(() => appendStackScreenBackButtonPropsToOptions({}, 
...
export function appendStackScreenBackButtonPropsToOptions(options, props) {
    return {
        ...options,
