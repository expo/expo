import type { NativeStackHeaderLeftProps, NativeStackHeaderProps, NativeStackHeaderRightProps, NativeStackNavigationOptions } from '@react-navigation/native-stack';
...
export interface StackHeaderConfiguration extends StackHeaderLeftConfiguration, StackHeaderRightConfiguration, StackHeaderBackButtonConfiguration, StackHeaderTitleConfiguration, StackHeaderSearchBarConfiguration {
    title?: string;
