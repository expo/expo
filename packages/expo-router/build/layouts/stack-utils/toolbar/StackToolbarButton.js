...
const StackToolbarButton = (props) => {
    ...
    const allowedChildren = (0, react_1.useMemo)(() => [common_primitives_1.StackToolbarLabel, common_primitives_1.StackToolbarIcon, common_primitives_1.StackToolbarBadge], []);
    const validChildren = (0, react_1.useMemo)(() => (0, children_1.filterAllowedChildrenElements)(props.children, allowedChildren), [props.children, allowedChildren]);
