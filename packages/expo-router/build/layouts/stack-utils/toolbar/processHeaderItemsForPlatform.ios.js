...
import { convertStackToolbarButtonPropsToRNHeaderItem, StackToolbarButton, } from './StackToolbarButton';
import { convertStackToolbarMenuPropsToRNHeaderItem, StackToolbarMenu } from './StackToolbarMenu';
import { convertStackToolbarSpacerPropsToRNHeaderItem, StackToolbarSpacer, } from './StackToolbarSpacer';
...
function convertToolbarChildrenToUnstableItems(children, side) {
    ...
    const actions = allChildren.filter((child) => isChildOfType(child, StackToolbarButton) ||
 ...
 */
export function processHeaderItemsForPlatform(children, placement, _colors) {
