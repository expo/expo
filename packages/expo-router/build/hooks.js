...
function useLoader(loader) {
    ...
    const loaderDataContext = react_1.default.useContext(context_1.LoaderContext);
    ...
    if (typeof window !== 'undefined') {
        ...
        if (!loaderPromiseCache.has(routePath)) {
            const promise = (0, utils_1.fetchLoaderModule)(routePath)
                .then((data) => {
        ...
        return react_1.default.use(loaderPromiseCache.get(routePath));
    }
