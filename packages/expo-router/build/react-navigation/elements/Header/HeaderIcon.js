...
function HeaderIcon({ source, style, ...rest }) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_native_1.Image, { source: source, resizeMode: "contain", fadeDuration: 0, tintColor: colors.text, style: [styles.icon, direction === 'rtl' && styles.flip, style], ...rest }));
}
