...
import { CommonActions, DrawerActions, useLinkBuilder, } from '../../native';
import { DrawerItem } from './DrawerItem';
/**
 * Component that renders the navigation list in the drawer.
 */
export function DrawerItemList({ state, navigation, descriptors }) {
