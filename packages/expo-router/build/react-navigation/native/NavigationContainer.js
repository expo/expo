...
function NavigationContainerInner({ direction = react_native_1.I18nManager.getConstants().isRTL ? 'rtl' : 'ltr', theme = DefaultTheme_1.DefaultTheme, linking, fallback = null, documentTitle, onReady, onStateChange, ...rest }, ref) {
    ...
    if (!isLinkingReady) {
        return ((0, jsx_runtime_1.jsx)(LocaleDirContext_1.LocaleDirContext.Provider, { value: direction, children: (0, jsx_runtime_1.jsx)(core_1.ThemeProvider, { value: theme, children: fallback }) }));
    }
    return ((0, jsx_runtime_1.jsx)(LocaleDirContext_1.LocaleDirContext.Provider, { value: direction, children: (0, jsx_runtime_1.jsx)(UnhandledLinkingContext_1.UnhandledLinkingContext.Provider, { value: unhandledLinkingContext, children: (0, jsx_runtime_1.jsx)(LinkingContext_1.LinkingContext.Provider, { value: linkingContext, children: (0, jsx_runtime_1.jsx)(core_1.BaseNavigationContainer, { ...rest, theme: theme, onReady: onReadyForLinkingHandling, onStateChange: onStateChangeForLinkingHandling, initialState: rest.initialState == null ? initialState : rest.initialState, ref: refContainer }) }) }) }));
}
/**
