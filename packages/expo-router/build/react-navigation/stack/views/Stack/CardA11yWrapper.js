...
export const CardA11yWrapper = ({ ref, focused, active, animated, isNextScreenTransparent, detachCurrentScreen, children, }) => {
    ...
    return (<View aria-hidden={!focused} pointerEvents={(animated ? inert : !focused) ? 'none' : 'box-none'} style={[
