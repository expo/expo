...
exports.BottomSheetSlideOutSpec = exports.BottomSheetSlideInSpec = exports.FadeOutToLeftAndroidSpec = exports.FadeInFromRightAndroidSpec = exports.ScaleFromCenterAndroidSpec = exports.RevealFromBottomAndroidSpec = exports.FadeOutToBottomAndroidSpec = exports.FadeInFromBottomAndroidSpec = exports.TransitionIOSSpec = void 0;
...
exports.FadeInFromBottomAndroidSpec = {
    ...
    config: {
        duration: 350,
        easing: react_native_1.Easing.out(react_native_1.Easing.poly(5)),
    },
};
/**
...
exports.RevealFromBottomAndroidSpec = {
    ...
    config: {
        ...
        easing: react_native_1.Easing.bezier(0.20833, 0.82, 0.25, 1),
    },
};
/**
 ...
 */
exports.FadeInFromRightAndroidSpec = {
    animation: 'timing',
    config: {
        duration: 450,
        // This is super rough approximation of the path used for the curve by android
 ...
 */
exports.FadeOutToLeftAndroidSpec = {
    animation: 'timing',
    config: {
        duration: 450,
        // This is super rough approximation of the path used for the curve by android
 ...
 */
exports.BottomSheetSlideInSpec = {
    animation: 'timing',
    config: {
        duration: 250,
 ...
 * See https://github.com/material-components/material-components-android/blob/fd3639092e1ffef9dc11bcedf79f32801d85e898/lib/java/com/google/android/material/bottomsheet/res/anim/mtrl_bottom_sheet_slide_in.xml
 */
exports.BottomSheetSlideOutSpec = {
    animation: 'timing',
    config: {
        duration: 200,
