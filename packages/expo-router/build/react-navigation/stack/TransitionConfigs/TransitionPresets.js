...
import { forBottomSheetAndroid, forFadeFromBottomAndroid, forFadeFromCenter as forFadeCard, forFadeFromRightAndroid, forHorizontalIOS, forHorizontalIOSInverted, forModalPresentationIOS, forRevealFromBottomAndroid, forScaleFromCenterAndroid, forVerticalIOS, } from './CardStyleInterpolators';
...
export const DefaultTransition = Platform.select({
    ...
    android: Number(Platform.Version) >= ANDROID_VERSION_14
