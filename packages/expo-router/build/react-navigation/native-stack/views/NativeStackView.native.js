...
function NativeStackView({ state, navigation, descriptors, describe }) {
    ...
    return ((0, jsx_runtime_1.jsx)(elements_1.SafeAreaProviderCompat, { children: (0, jsx_runtime_1.jsx)(react_native_screens_1.ScreenStack, { style: styles.container, onFinishTransitioning: () => {
