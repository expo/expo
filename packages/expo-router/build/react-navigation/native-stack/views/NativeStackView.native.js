...
import { getDefaultHeaderHeight, getHeaderTitle, HeaderBackContext, HeaderHeightContext, HeaderShownContext, SafeAreaProviderCompat, useFrameSize, } from '../../elements';
import { useHeaderConfigProps } from './useHeaderConfigProps';
import { NavigationProvider, StackActions, usePreventRemoveContext, useTheme, } from '../../native';
...
const SceneView = ({ index, focused, shouldFreeze, descriptor, previousDescriptor, nextDescriptor, isPresentationModal, isPreloaded, onWillDisappear, onWillAppear, onAppear, onDisappear, onDismissed, onHeaderBackButtonClicked, onNativeDismissCancelled, onGestureCancel, onSheetDetentChanged, }) => {
    ...
    const topInset = isParentHeaderShown || (Platform.OS === 'ios' && isModal) || (isIPhone && isLandscape)
        ? 0
        : insets.top;
    ...
    const usesNewAndroidHeaderHeightImplementation = 'usesNewAndroidHeaderHeightImplementation' in compatibilityFlags &&
            ...
            Animated.event([
                ...
                listener: (e) => {
                    if (e.nativeEvent &&
                        ...
                        const doesHeaderAnimate = Platform.OS === 'ios' &&
    ...
    return (<NavigationProvider route={route} navigation={navigation}>
      <ScreenStackItem screenId={route.key} activityState={isPreloaded ? 0 : 2} style={StyleSheet.absoluteFill} aria-hidden={!focused} customAnimationOnSwipe={animationMatchesGesture} fullScreenSwipeEnabled={fullScreenGestureEnabled} fullScreenSwipeShadowEnabled={fullScreenGestureShadowEnabled} freezeOnBlur={freezeOnBlur} gestureEnabled={Platform.OS === 'android'
    ...
    shouldFreeze={shouldFreeze}>
        <AnimatedHeaderHeightContext.Provider value={animatedHeaderHeight}>
          <HeaderHeightContext.Provider value={headerShown !== false ? headerHeight : (parentHeaderHeight ?? 0)}>
        ...
        <View style={[
            ...
            {header != null && headerShown !== false ? (<View onLayout={(e) => {
