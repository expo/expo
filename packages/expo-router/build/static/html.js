...
export function ScrollViewStyleReset() {
    return (React.createElement("style", { id: "expo-reset", dangerouslySetInnerHTML: {
...
export function Html({ children }) {
    return (React.createElement("html", { lang: "en" },
        React.createElement("head", null,
            ...
            React.createElement("meta", { name: "viewport", content: "width=device-width,initial-scale=1,minimum-scale=1,maximum-scale=1.00001,viewport-fit=cover" }),
