...
relativeToDirectory, asChild, rel, target, download, withAnchor, dangerouslySingular: singular, prefetch, ...rest }) {
    ...
    react_1.default.Children.map(rest.children, (child) => {
        if (!react_1.default.isValidElement(child)) {
            return;
        }
        if (typeof child === 'string' || typeof child === 'number') {
            console.log('CHECK:', typeof child, child);
            hasTextChildren = true;
            return;
        }
    });
    const Component = asChild ? Slot_1.Slot : hasTextChildren ? react_native_1.Text : react_native_1.View;
