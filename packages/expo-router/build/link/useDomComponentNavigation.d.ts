...
export declare function emitDomSetOptions(params?: Record<string, string | number | (string | number)[]>): boolean;
...
export declare function useDomComponentContextReceiver(): ({ type, data }: {
    type: any;
    data: any;
}) => void;
