...
function LinkAppleZoom(props) {
    if (!(0, ZoomTransitionEnabler_1.isZoomTransitionEnabled)()) {
        return (0, jsx_runtime_1.jsx)(Slot_1.Slot, { ...props });
    }
    return (0, jsx_runtime_1.jsx)(LinkAppleZoomImpl, { ...props });
}
function LinkAppleZoomImpl({ children, alignmentRect, ...rest }) {
    ...
    return ((0, jsx_runtime_1.jsx)(native_1.LinkZoomTransitionSource, { identifier: identifier, alignment: alignmentRect, 
        // Note(@ubax): Even though we always set this to true, I want to keep the prop here for easier future changes.
        animateAspectRatioChange: true, children: (0, jsx_runtime_1.jsx)(Slot_1.Slot, { ...rest, children: children }) }));
}
