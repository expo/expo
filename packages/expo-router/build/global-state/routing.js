...
function getNavigateAction(actionState, navigationState, type = 'NAVIGATE', unstable_ignoreAnchor = false) {
    ...
    while (actionStateRoute) {
        ...
        params = payload;
        // The actionStateRoute is a state object generated by getStateFromPath, which will include the anchor route
        // in the routes array.
        const hasAnchorRoute = actionStateRoute.state?.index !== undefined && actionStateRoute.state.index > 0;
        if (unstable_ignoreAnchor && hasAnchorRoute) {
