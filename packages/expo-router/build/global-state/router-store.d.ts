...
export declare class RouterStore {
    ...
    setParams: any;
    navigate: any;
    initialize(context: RequireContext, navigationRef: NavigationContainerRefWithCurrent<ReactNavigation.RootParamList>, linkingConfigOverrides?: Partial<ExpoLinkingOptions>): void;
...
export declare function useInitializeExpoRouter(context: RequireContext, linking: Partial<ExpoLinkingOptions> | undefined, location: URL | undefined): RouterStore;
