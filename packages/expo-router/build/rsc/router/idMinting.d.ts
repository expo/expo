...
export declare function mintComponentId(path: string, kind: ComponentIdKind): string;
/**
 ...
 * terminal page ID.
 */
export declare function getComponentIds(path: string): ComponentIds;
//# sourceMappingURL=idMinting.d.ts.map