        ...
        if (typeof id === 'string') {
            if (process.env.EXPO_OS !== 'web') {
                ...
                if (typeof window === 'undefined' && id.includes('/lib/commonjs/')) {
                    console.warn('Attempting to load Node.js submodule in native project. This could be a bug with how the module uses client proxy:', id);
                }
            }
        }
    }
...
globalThis.__webpack_require__ = (id) => {
    ...
    if (typeof window === 'undefined') {
        ...
        if (typeof id === 'string' && id.match(/[0-9a-z]{40}#/i)) {
            ...
            const m = (0, server_actions_1.getServerReference)(id);
