...
export type ServerInsertedHTMLCallback = () => ReactNode;
export type AddServerInsertedHTMLCallback = (callback: ServerInsertedHTMLCallback) => void;
export declare const ServerInsertedHTMLContext: import("react").Context<AddServerInsertedHTMLCallback | null>;
/**
 ...
 * ```
 */
export declare function useServerInsertedHTML(callback: ServerInsertedHTMLCallback): void;
//# sourceMappingURL=ServerInsertedHTML.d.ts.map