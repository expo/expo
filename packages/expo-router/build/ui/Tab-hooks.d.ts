...
import { ExpoTabsScreenOptions, TabNavigationEventMap } from './Tab-shared';
import { TabRouterOptions } from './TabRouter';
import { ScreenTrigger } from './common';
import { Href } from '../types';
export type UseTabsOptions = Omit<DefaultNavigatorOptions<ParamListBase, TabNavigationState<any>, ExpoTabsScreenOptions, TabNavigationEventMap>, 'children'> & Omit<TabRouterOptions, 'initialRouteName' | 'triggerMap'>;
...
export declare function useTabTrigger(): {
    switchTab: <T extends string | object>(name: string, href?: Href<T> | undefined) => void;
};
export type ExpoTabHref = Record<string, Omit<ExpoTabsScreenOptions, 'action'>> | (Href | [Href, Omit<ExpoTabsScreenOptions, 'action'>])[];
//# sourceMappingURL=Tab-hooks.d.ts.map