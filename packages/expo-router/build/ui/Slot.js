        ...
        if (process.env.NODE_ENV === 'development') {
            if (react_1.default.isValidElement(props.children)) {
                if (typeof props.children.props === 'object' &&
                    ...
                    throw new Error(`[expo-router]: You are passing an array of styles to a child of <Slot>. Consider flattening the styles before passing them to the child component.`);
                }
            }
        }
