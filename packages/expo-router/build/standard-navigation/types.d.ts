 ...
 * ```
 */
type CreatePropsFn<State extends NavigationState, CreateProps extends object> = (deps: StandardNavigatorCreatePropsFactoryDeps<State>) => CreateProps;
...
export type IntegrateWithRouterOptions<State extends NavigationState = NavigationState, CreateProps extends object = object> = {
    /**
 ...
 */
type NavigatorContentInferenceCarrier<EventMap extends StandardNavigatorEventMapBase, NavigatorProps extends object, CreateProps extends object> = {
    /** @internal */
