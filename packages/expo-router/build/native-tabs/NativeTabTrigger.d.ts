...
export declare function convertTabPropsToOptions({ hidden, children, role, disablePopToTop, disableScrollToTop, unstable_nativeProps, contentStyle, }: NativeTabTriggerProps, isDynamic?: boolean): NativeTabOptions;
