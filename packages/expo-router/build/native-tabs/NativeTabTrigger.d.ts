...
export declare function convertTabPropsToOptions({ unstable_options, hidden, children, role, disablePopToTop, disableScrollToTop, }: NativeTabTriggerProps, isDynamic?: boolean): ExtendedNativeTabOptions;
