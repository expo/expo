import { appendInternalExpoRouterParams, getInternalExpoRouterParams, INTERNAL_EXPO_ROUTER_NO_ANIMATION_PARAM_NAME, INTERNAL_EXPO_ROUTER_ZOOM_TRANSITION_SCREEN_ID_PARAM_NAME, INTERNAL_EXPO_ROUTER_ZOOM_TRANSITION_SOURCE_ID_PARAM_NAME, removeParams, } from '../navigationParams';
import { TabRouter, } from '../react-navigation/native';
export function NativeBottomTabsRouter(options) {
                ...
                case 'NAVIGATE': {
                    ...
                    const newState = {
                        ...
                        routes: newStateFromNavigation.routes.map((route) => {
                            ...
                            const expoParams = getInternalExpoRouterParams(action.payload.params);
                            ...
                            const params = removeParams(appendInternalExpoRouterParams(route.params, expoParams), [
