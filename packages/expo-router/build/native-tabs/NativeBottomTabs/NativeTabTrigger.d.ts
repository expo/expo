...
export declare function convertTabPropsToOptions({ options, hidden, children, role, disablePopToTop, disableScrollToTop, disableAndroidSafeInsets, addIOSSafeInsets, }: NativeTabTriggerProps, isDynamic?: boolean): ExtendedNativeTabOptions;
