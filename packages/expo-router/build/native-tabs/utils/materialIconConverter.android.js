...
function convertMaterialIconNameToImageSource(name) {
    return (0, icon_1.convertComponentSrcToImageSource)((0, jsx_runtime_1.jsx)(elements_1.NativeTabsTriggerPromiseIcon, { loader: async () => {
            const { unstable_getMaterialSymbolSourceAsync } = await Promise.resolve().then(() => __importStar(require('expo-symbols/materialImageSource')));
