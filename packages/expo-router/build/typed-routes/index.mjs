...
const EXPO_ROUTER_CTX_IGNORE = /^(?:\.\/)(?!(?:(?:(?:.*\+api)|(?:\+(html|native-intent))))\.[tj]sx?$).*\.[tj]sx?$/;
import fs from 'node:fs';
import path from 'node:path';
import { getTypedRoutesDeclarationFile } from './generate.mjs';
import { isTypedRoute } from '../matchers.mjs';
import requireContext from '../testing-library/require-context-ponyfill.mjs';
