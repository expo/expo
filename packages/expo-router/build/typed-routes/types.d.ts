 ...
 * @hidden
 */
export type RouteInputParams<T> = Extract<Href, {
    pathname: T;
 ...
 * @hidden
 */
export type RouteOutputParams<T> = HrefOutputParams extends infer U ? U extends {
    pathname: string;
    params?: infer Params;
} ? T extends U['pathname'] ? Params : never : never : never;
