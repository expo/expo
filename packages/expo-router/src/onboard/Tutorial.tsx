    ...
    <View style={styles.background}>
      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.container}>
          <Header />
          <Text accessibilityRole="header" accessibilityLevel={2} style={styles.subtitle}>
            Start by creating a file{'\n'}in the <Text style={{ fontWeight: 'bold' }}>app</Text>{' '}
            directory.
          </Text>
    ...
    <Pressable
      ...
      {({ pressed, hovered }) => (
        <View
          ...
          <Text selectable={false} style={[styles.code, hovered && { color: 'black' }]}>
