...
export type DetentOptions = Partial<
  Pick<ExtendedStackNavigationOptions, 'sheetAllowedDetents' | 'sheetInitialDetentIndex'>
>;
 ...
 */
export function getInitialDetentIndex(options?: DetentOptions | null) {
