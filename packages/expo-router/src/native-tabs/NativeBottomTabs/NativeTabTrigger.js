...
import { Icon, Badge, Label, VectorIcon, } from '../common/elements';
/**
...
export function convertTabPropsToOptions({ options, hidden, children, role, disablePopToTop, disableScrollToTop }, isDynamic = false) {
...
export function appendIconOptions(options, props) {
...
export function isNativeTabTrigger(child, contextKey) {
