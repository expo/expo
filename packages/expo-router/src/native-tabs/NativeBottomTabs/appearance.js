export function createStandardAppearanceFromOptions(options, baseStandardAppearance) {
...
export function createScrollEdgeAppearanceFromOptions(options, baseScrollEdgeAppearance) {
    const appearance = appendStyleToAppearance({
        ...options.labelStyle,
        iconColor: options.iconColor,
