...
export function appendInternalExpoRouterParams(params, expoParams) {
    let newParams = {};
...
export function getInternalExpoRouterParams(_params) {
    const expoParams = {};
...
export function removeInternalExpoRouterParams(params) {
    if (!params) {
        return undefined;
    }
