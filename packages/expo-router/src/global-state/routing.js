...
import { appendInternalExpoRouterParams } from '../navigationParams';
...
export function linkTo(originalHref, options = {}) {
    ...
    routingQueue.add(getNavigateAction(state, rootState, options.event, options.withAnchor, options.dangerouslySingular, !!options.__internal__PreviewKey));
}
