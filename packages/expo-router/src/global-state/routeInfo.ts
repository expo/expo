 ...
 */
export function computeRouteInfo(
  parent: UrlObject,
  route: { name: string; params?: StrictFocusedRouteParams }
): UrlObject {
 ...
 */
export function routeInfoFromState(state?: StrictState): UrlObject {
  ...
  let marker: StrictFocusedRouteParams | undefined = route.params;
