...
export const ServerInsertedHTMLContext = createContext<AddServerInsertedHTMLCallback | null>(null);
 ...
 * ```
 */
export function useServerInsertedHTML(callback: ServerInsertedHTMLCallback): void {
  const addInsertedHTML = use(ServerInsertedHTMLContext);
