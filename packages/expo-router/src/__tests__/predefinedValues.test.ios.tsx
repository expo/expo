  ...
  it('works with nested stack navigators', () => {
    renderRouter({
      ...
      'nested/_layout': {
        default: () => (
          <Stack>
            <Stack.Screen name="[id]" predefinedValues={['one', 'two']} />
          </Stack>
        ),
      },
...
describe('predefinedValues - multiple dynamic params', () => {
  it('works with multiple predefinedValues arrays', () => {
    renderRouter({
      _layout: {
        default: () => (
          <Stack>
            <Stack.Screen name="[category]" predefinedValues={['electronics', 'books']} />
          </Stack>
        ),
      },
      index: () => <Text testID="index">index</Text>,
      '[category]/_layout': {
        default: () => (
          <Stack>
            <Stack.Screen name="[product]" predefinedValues={['featured', 'sale']} />
          </Stack>
        ),
      },
...
describe('predefinedValues - initial URL', () => {
  it('can start with predefined value as initial URL', () => {
    ...
    // TODO(@ubax): Improve the implementation to also work on initial render
