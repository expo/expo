      ...
      children: [
        {
          type: 'route',
          children: [],
          contextKey: 'expo-router/internal/views/Sitemap.js',
          dynamic: null,
          entryPoints: [
            'expo-router/internal/views/Navigator.js',
            'expo-router/internal/views/Sitemap.js',
          ],
          generated: true,
          internal: true,
          route: '_sitemap',
        },
        {
          type: 'route',
          children: [],
          contextKey: 'expo-router/internal/views/Unmatched.js',
          dynamic: [
            {
              deep: true,
              name: '+not-found',
          ...
          entryPoints: [
            'expo-router/internal/views/Navigator.js',
            'expo-router/internal/views/Unmatched.js',
          ],
          generated: true,
          internal: true,
          route: '+not-found',
        },
        {
          ...
          dynamic: null,
          entryPoints: ['expo-router/internal/views/Navigator.js', './(app)/index.js'],
          route: '(app)/index',
        },
      ],
      contextKey: 'expo-router/internal/views/Navigator.js',
      dynamic: null,
      generated: true,
      type: 'layout',
      route: '',
      ...
      children: [
        {
          ...
          contextKey: 'expo-router/internal/views/Sitemap.js',
          dynamic: null,
          entryPoints: ['./_layout.js', 'expo-router/internal/views/Sitemap.js'],
          generated: true,
          internal: true,
          route: '_sitemap',
        },
        {
          ...
          entryPoints: ['./_layout.js', 'expo-router/internal/views/Unmatched.js'],
          generated: true,
          internal: true,
          route: '+not-found',
        },
      ...
      children: [
        {
          ...
          entryPoints: ['expo-router/internal/views/Navigator.js', './[a].tsx'],
          route: '[a]',
          type: 'route',
        },
        {
          ...
          entryPoints: ['expo-router/internal/views/Navigator.js', './[a]/[b].tsx'],
          route: '[a]/[b]',
          type: 'route',
        },
      ],
    ...
    expect(
      ...
      children: [
        ...
        },
        {
          ...
          contextKey: './(a,b)/page.js',
          dynamic: null,
          entryPoints: ['expo-router/internal/views/Navigator.js', './(a,b)/page.js'],
          route: '(a)/page',
          children: [],
        },
      ],
...
describe('+not-found', () => {
      ...
      children: [
        {
          ...
          entryPoints: ['expo-router/internal/views/Navigator.js', './+not-found.js'],
          route: '+not-found',
        },
        {
          children: [],
  ...
  it(`should not match top-level deep dynamic with nested index`, () => {
    ...
    expect(notFound.entryPoints).toContain('expo-router/internal/views/Unmatched.js');
  });
});
      ...
      children: [
        {
          ...
          entryPoints: ['expo-router/internal/views/Navigator.js', './[single].js'],
          route: '[single]',
        },
        {
          children: [],
          ...
          entryPoints: ['expo-router/internal/views/Navigator.js', './[...catchAll].js'],
          route: '[...catchAll]',
        },
        {
          children: [],
          ...
          entryPoints: ['expo-router/internal/views/Navigator.js', './a/b/c/[single].js'],
          route: 'a/b/c/[single]',
        },
      ],
      contextKey: 'expo-router/internal/views/Navigator.js',
      ...
      children: [
        {
          ...
          dynamic: null,
          entryPoints: ['expo-router/internal/views/Navigator.js', './(app)/page.js'],
          route: '(app)/page',
        },
      ],
      type: 'layout',
      ...
      children: [
        {
          ...
          dynamic: null,
          entryPoints: ['expo-router/internal/views/Navigator.js', './(a,b)/(c,d)/multiple-groups.js'],
    ...
    expect(
      ...
      children: [
        ...
        },
        {
          ...
          entryPoints: ['expo-router/internal/views/Navigator.js', './(app)/[slug].js'],
          route: '(app)/[slug]',
          type: 'route',
        },
        {
