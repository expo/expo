      ...
      children: [
        {
          ...
          contextKey: './index.js',
          dynamic: null,
          entryPoints: ['expo-router/internal/views/Navigator.js', './index.js'],
          route: 'index',
          type: 'route',
        },
        {
          ...
          contextKey: './about.js',
          dynamic: null,
          entryPoints: ['expo-router/internal/views/Navigator.js', './about.js'],
          route: 'about',
          type: 'route',
        },
        {
          ...
          dynamic: null,
          entryPoints: ['expo-router/internal/views/Navigator.js', './contact.js'],
          route: 'contact',
          type: 'route',
        },
        {
    ...
    expect(
      ...
      children: [
        ...
        },
        {
          ...
          entryPoints: ['expo-router/internal/views/Navigator.js', './old/[slug].js'],
          route: 'old/[slug]',
          type: 'route',
        },
      ],
