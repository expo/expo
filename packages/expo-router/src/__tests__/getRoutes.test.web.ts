...
describe('middleware', () => {
  ...
  it('throws an error for nested middleware files', () => {
    expect(() => {
      ...
      'Only one middleware file can only be placed at the root level. Remove the following files: ./hello/+middleware.js'
    );
    ...
    expect(() => {
      ...
      'Only one middleware file can only be placed at the root level. Remove the following files: ./(app)/settings/+middleware.js, ./posts/[postId]/+middleware.js'
    );
  });

  it.only('throws an error when multiple root-level middleware files exist in development', () => {
  ...
  it('detects conflicts between different extensions', () => {
    ...
    expect(() => {
      ...
      'The route files "./+middleware.tsx" and "./+middleware.jsx" conflict. Remove one of these files.'
    );
