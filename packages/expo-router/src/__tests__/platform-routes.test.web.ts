  ...
  expect(
    ...
    children: [
      ...
      },
      {
        ...
        dynamic: null,
        entryPoints: ['expo-router/internal/views/Navigator.js', './(app)/page.web.ts'],
        route: '(app)/page',
        type: 'route',
      },
      {
        ...
        dynamic: null,
        entryPoints: ['expo-router/internal/views/Navigator.js', './(app)/page2.ts'],
        route: '(app)/page2',
        type: 'route',
      },
      {
        ...
        dynamic: null,
        entryPoints: ['expo-router/internal/views/Navigator.js', './(app)/page3.ts'],
        route: '(app)/page3',
        type: 'route',
      },
      {
