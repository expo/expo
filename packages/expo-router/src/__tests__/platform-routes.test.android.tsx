  ...
  expect(
    ...
    children: [
      ...
      },
      {
        ...
        dynamic: null,
        entryPoints: ['expo-router/internal/views/Navigator.js', './(app)/page.ts'],
        route: '(app)/page',
        type: 'route',
      },
      {
        ...
        dynamic: null,
        entryPoints: ['expo-router/internal/views/Navigator.js', './(app)/page2.native.ts'],
        route: '(app)/page2',
        type: 'route',
      },
      {
        ...
        dynamic: null,
        entryPoints: ['expo-router/internal/views/Navigator.js', './(app)/page3.android.ts'],
        route: '(app)/page3',
        type: 'route',
      },
      {
        ...
        dynamic: null,
        entryPoints: ['expo-router/internal/views/Navigator.js', './(app)/page4.ts'],
        route: '(app)/page4',
        type: 'route',
      },
    ],
