...
import { getInternalExpoRouterParams } from '../navigationParams';
...
const isPreviewAction = (action) => !!action.payload &&
    ...
    !!getInternalExpoRouterParams(action.payload?.params ?? undefined)['__internal__expo_router_is_preview_navigation'];
/**
...
const Stack = Object.assign((props) => {
    ...
    return (<RNStack {...props} screenOptions={screenOptions} UNSTABLE_router={stackRouterOverride}/>);
}, {
