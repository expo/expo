...
import { appendStackTitlePropsToOptions } from '../StackTitle';

describe(appendStackTitlePropsToOptions, () => {
  describe('title from children', () => {
    it('sets title from string children', () => {
      const result = appendStackTitlePropsToOptions({}, { children: 'Page Title' });
    ...
    it('sets title from array of string children', () => {
      const result = appendStackTitlePropsToOptions({}, { children: ['test ', '123'] });
  ...
  describe('asChild/children type mismatch warnings', () => {
    ...
    it('warns when asChild is not set but children is component', () => {
      const result = appendStackTitlePropsToOptions({}, { children: <Text>Component</Text> });
    ...
    it('does not warn for valid combinations', () => {
      appendStackTitlePropsToOptions({}, { children: 'String Title' });
      appendStackTitlePropsToOptions({}, { asChild: true, children: <Text>Component</Text> });
  ...
  describe('large prop', () => {
    it.each([true, false, undefined])('sets headerLargeTitle to %s when large is %s', (large) => {
      const result = appendStackTitlePropsToOptions({}, { large, children: 'Title' });
  ...
  describe('options merging', () => {
    it('merges with existing options', () => {
      ...
      const result = appendStackTitlePropsToOptions(existingOptions, { children: 'Title' });
    ...
    it('overwrites conflicting options', () => {
      ...
      const result = appendStackTitlePropsToOptions(existingOptions, {
        children: 'New Title',
      });
