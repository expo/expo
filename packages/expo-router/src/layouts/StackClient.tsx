...
import { Children, ComponentProps, isValidElement, useMemo, type ReactElement } from 'react';
...
import { ScreensOptionsContext, StackHeader, StackScreen } from './StackElements';
...
const Stack = Object.assign(
  (props: ComponentProps<typeof RNStack>) => {
    ...
    const screens = useMemo(
      () => getAllChildrenOfType(props.children, StackScreen),
      [props.children]
    );

    const value = useMemo(
      () => ({
        getScreenForName: (name: string) => {
    ...
    return (
      <ScreensOptionsContext value={value}>
