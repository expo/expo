...
// Re-exported for the web modal files that import ExtendedStackNavigationOptions from this module.
// The type is defined in stack-utils/StackScreen so it's available to Stack.Screen options.
