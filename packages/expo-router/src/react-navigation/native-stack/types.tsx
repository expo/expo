...
export type NativeStackModalPresentation =
  | 'modal'
  | 'transparentModal'
  | 'containedModal'
 ...
 * and sheet screens.
 */
export interface CardNativeStackNavigationOptions
  extends CommonNativeStackNavigationOptions,
 ...
 */
export interface SheetNativeStackNavigationOptions
  extends CommonNativeStackNavigationOptions,
 ...
 * @internal
 */
export interface FlatNativeStackNavigationOptions
  extends CommonNativeStackNavigationOptions,
    NativeStackCardSpecificOptions,
    NativeStackSheetSpecificOptions {
