...
export interface NativeConstants {
  ...
  /**
   * Classic manifest for Expo apps using classic updates. Returns `null` in bare workflow and when
   * `manifest2` is non-null.
  ...
  /**
   * New manifest for Expo apps using modern Expo Updates, such as apps that use EAS Update. Returns
   * `null` in bare workflow and when `manifest` is non-null.
   * > Prefer using `Constants.expoConfig` instead, which behaves more consistently across classic
   * updates and modern Expo Updates.
   */
