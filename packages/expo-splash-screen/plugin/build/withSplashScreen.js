...
const withSplashScreen = (config, splash) => {
    ...
    config = (0, withAndroidSplashScreen_1.withAndroidSplashScreen)(config, splash?.android);
    config = (0, withIosSplashScreen_1.withIosSplashScreen)(config, splash?.ios);
    return config;
};
