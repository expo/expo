...
- [iOS] Add support for using multiple inner app frameworks in one host app via the new `multipleFrameworks` property. ([@gabrieldonadel](https://github.com/gabrieldonadel))
