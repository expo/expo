 ...
 */
public fun fetchManifest(
  reactHost: ReactHost,
  completion: (Manifest?, String?) -> Unit
) {
  Thread {
...
/**
 * Closes and reopens the packager connection
 * to reload dev menu handlers
 */
      ...
      while (true) {
        ...
        try {
          ...
          if (packagerClient != null) {
            ...
            Log.d("DevMenuSupport(brownfield)", "Closed packager connection to install new handlers")
