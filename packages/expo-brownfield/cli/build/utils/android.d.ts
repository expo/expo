...
export declare const buildPublishingTask: (variant: BuildVariant, repository: string, fusedOpts?: {
    fused: boolean;
    library: string;
}) => string;
...
export declare const runTask: (task: string, verbose: boolean, dryRun: boolean, extraGradleArgs?: string[]) => Promise<import("./types").RunCommandResult | undefined>;
