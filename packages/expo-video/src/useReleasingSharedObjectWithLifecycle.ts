...
export type ReleasingSharedObjectLifecycle<TSharedObject extends ReleasingObject> = {
  /**
...
type PendingUpdate<TSharedObject extends ReleasingObject> = {
  object: TSharedObject;
  context: ReleasingSharedObjectLifecycleContext;
};
 ...
 */
export function useReleasingSharedObjectWithLifecycle<TSharedObject extends ReleasingObject>(
