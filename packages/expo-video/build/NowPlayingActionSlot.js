 ...
 * @platform android
 */ export var NowPlayingActionSlot = /*#__PURE__*/ function(NowPlayingActionSlot) {
    /** A central slot in a playback control UI, most commonly used for play or pause actions. */ NowPlayingActionSlot[NowPlayingActionSlot["SLOT_CENTRAL"] = 1] = "SLOT_CENTRAL";
    /**
   ...
   */ NowPlayingActionSlot[NowPlayingActionSlot["SLOT_FORWARD_SECONDARY"] = 5] = "SLOT_FORWARD_SECONDARY";
    /** A slot in a playback control UI for additional actions that don't fit into other slots. */ NowPlayingActionSlot[NowPlayingActionSlot["SLOT_OVERFLOW"] = 6] = "SLOT_OVERFLOW";
    return NowPlayingActionSlot;
}({});
