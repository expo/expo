...
import type { PlayerError, VideoMetadata, VideoPlayer, VideoPlayerStatus, VideoSource } from './VideoPlayer.types';
/**
 ...
 * @platform ios
 */
export type VideoPlaylistSource = VideoSource | {
    /**
...
export declare class VideoPlaylist extends SharedObject<VideoPlaylistEvents> {
     ...
     * @hidden
     */
    constructor(sources: VideoPlaylistSource[], initialIndex: number, updateInterval: number, loop: VideoPlaylistLoopMode, preloadNext: boolean, autoAdvance: boolean);
    /**
     * Unique identifier for the playlist instance.
     */
    readonly id: string;
     ...
     */
    replaceAll(sources: VideoPlaylistSource[], options?: {
        preserveCurrentSource?: boolean;
    }): Promise<void>;
    /**
