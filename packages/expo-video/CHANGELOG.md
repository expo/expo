...
- [Web] Handle the promise returned by `HTMLVideoElement.play()`, so a play the browser refuses no longer leaves the player reporting `playing: true`. ([@KAMRONBEK](https://github.com/KAMRONBEK))
