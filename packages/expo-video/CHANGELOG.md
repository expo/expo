...
- [Android] Fix an issue where using non-ASCII characters in the application namewould cause the media not to play - this can be worked around by specifying a custom User-Agent string. ([#31659](https://github.com/expo/expo/pull/31659) by [@fobos531](https://github.com/fobos531))
