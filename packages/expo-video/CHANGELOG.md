...
- [iOS] Fix 'player.currentTime' NaN when source is not provided. ([#31011](https://github.com/expo/expo/pull/31011) by [@AlirezaHadjar](https://github.com/AlirezaHadjar))
