...
- [iOS] Added the SwiftUI `searchable` modifier for attaching a native search field to SwiftUI views. ([#47758](https://github.com/expo/expo/pull/47758) by [@yousofabouhalawa](https://github.com/yousofabouhalawa))
