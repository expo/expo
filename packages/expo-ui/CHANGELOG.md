...
- [iOS] Fix `Slider` ignoring `value` prop updates after the first drag, while still keeping the thumb from snapping back to a stale value during a drag. ([#49075](https://github.com/expo/expo/issues/49075) by [@matinzd](https://github.com/matinzd)) ([#49085](https://github.com/expo/expo/pull/49085) by [@nishan](https://github.com/intergalacticspacehighway))
