...
- [iOS] Added scroll position tracking (`scrollToID`, `scrollToEdge`, `scrollToPoint`, `onScrollPositionChange`) to `ScrollView`, `id` and `scrollTargetBehavior` modifiers, and `scrollTargetLayout` prop on `VStack`/`HStack` (iOS 17+, full `ScrollPosition` API on iOS 18+). ([#43955](https://github.com/expo/expo/pull/43955) by [@ramonclaudio](https://github.com/ramonclaudio))
