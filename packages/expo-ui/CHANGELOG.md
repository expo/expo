...
- [android] Fix `matchContents` `Host` collapsing to 0x0 in stack headers: a transient zero measurement no longer clears the reported size, and the host re-applies its size when a later commit drops it. ([#49320](https://github.com/expo/expo/pull/49320) by [@focux](https://github.com/focux))
