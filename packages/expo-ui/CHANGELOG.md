...
- [iOS] Demonstrate `moveDisabled` and `deleteDisabled` modifiers in the `List` example. ([#41070](https://github.com/expo/expo/pull/41070) by [@ramonfabrega](https://github.com/ramonfabrega))
