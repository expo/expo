...
- [iOS] Fix `Pressable` (and other responder-based touchables) hosted in `RNHostView` dropping presses on any finger movement. ([#48131](https://github.com/expo/expo/issues/48131) by [@BrianUribe6](https://github.com/BrianUribe6)) ([#48212](https://github.com/expo/expo/pull/48212) by [@intergalacticspacehighway](https://github.com/intergalacticspacehighway))
