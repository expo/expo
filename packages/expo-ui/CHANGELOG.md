...
- [iOS] Add `largestUndimmedDetent` and `largestUndimmedDetentIndex` props to `BottomSheet` to control background dimming behavior. (by [@jshebert](https://github.com/jshebert))
