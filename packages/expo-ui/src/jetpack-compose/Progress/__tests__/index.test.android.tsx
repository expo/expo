...
describe('LinearWavyProgressIndicator', () => {
  it('passes the wave configuration to the native view', async () => {
    await render(
  ...
  it('leaves the wave configuration undefined when not specified', async () => {
    await render(<LinearWavyProgressIndicator progress={0.5} />);
...
describe('CircularWavyProgressIndicator', () => {
  it('passes the wave configuration to the native view', async () => {
    await render(<CircularWavyProgressIndicator amplitude={1} wavelength={20} waveSpeed={10} />);
