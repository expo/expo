...
/**
 * Returns one key per item. Keys follow `data` only: an inline `keyExtractor` changes identity on
 * every parent render, and recomputing keys for it would bump the revision and re-render every row.
 */
