...
function transformTextFieldProps(props: TextFieldProps): NativeTextFieldProps {
  const { modifiers, onChangeTextSync, ...restProps } = props;
  return {
    modifiers,
...
export function TextField(props: TextFieldProps) {
  ...
  const onChangeTextSyncId = useWorkletCallback(onChangeTextSync, [onChangeTextSync]);

  return (
    <TextFieldNativeView
      {...transformTextFieldProps(restProps)}
      onChangeTextSync={onChangeTextSyncId}
    />
  );
}
