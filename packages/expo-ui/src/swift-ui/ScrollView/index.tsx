...
type NativeScrollViewProps = Omit<ScrollViewProps, 'onScrollPositionChange'> &
  ViewEvent<'onScrollPositionChange', ScrollPositionChangeEvent>;
...
export function ScrollView(props: ScrollViewProps) {
  const { modifiers, onScrollPositionChange, ...restProps } = props;
  return (
    <ScrollViewNativeView
      modifiers={modifiers}
      {...(modifiers ? createViewModifierEventListener(modifiers) : undefined)}
      onScrollPositionChange={
        onScrollPositionChange ? (event) => onScrollPositionChange(event.nativeEvent) : undefined
      }
      {...restProps}
    />
  );
