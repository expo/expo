...
import { LazyForEach } from './LazyForEach';
import { LazyWorkletForEach } from './LazyWorkletForEach';
...
List.LazyForEach = LazyForEach;
List.LazyWorkletForEach = LazyWorkletForEach;
