 ...
 */
export declare function Host({ children, colorScheme, seedColor, ignoreSafeArea, layoutDirection, matchContents, onLayout, onLayoutContent, style, useViewportSizeMeasurement, ...rest }: UniversalHostProps): import("react/jsx-runtime").JSX.Element;
