...
export type BackgroundOptions = {
     ...
     * @default 'all'
     */
    ignoresSafeAreaEdges?: 'all' | 'top' | 'bottom' | 'leading' | 'trailing' | 'horizontal' | 'vertical';
};
/**
 ...
 */
export declare function background(style: ShapeStyle, options?: BackgroundOptions): ModifierConfig;
export declare function background(style: ShapeStyle, shape?: Shape): ModifierConfig;
