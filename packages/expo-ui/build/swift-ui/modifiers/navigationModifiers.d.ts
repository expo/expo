 ...
 */
export declare const navigationSplitViewStyle: (style: NavigationSplitViewStyle) => import("./createModifier").ModifierConfig;
/**
 ...
 */
export declare function navigationSplitViewColumnWidth(width: number): ReturnType<typeof createModifier>;
export declare function navigationSplitViewColumnWidth(params: NavigationSplitViewColumnWidthParams): ReturnType<typeof createModifier>;
//# sourceMappingURL=navigationModifiers.d.ts.map