...
- [android] Default an event's timezone to the device timezone when none is provided, so `createEvent()` no longer produces an event the calendar app cannot display. ([#50147](https://github.com/expo/expo/pull/50147) by [@hknakn](https://github.com/hknakn))
