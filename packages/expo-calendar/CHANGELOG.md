...
- [android] Fix `openInCalendar()` throwing when called without params, which the type declares as optional. ([#PRNUM](https://github.com/expo/expo/pull/PRNUM) by [@hknakn](https://github.com/hknakn))
