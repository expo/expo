...
import { useLocalSearchParams, useUnstableGlobalHref, usePathname, useSegments,
// @ts-ignore: hack
 } from "expo-router";
...
function serializedMetaChildren(meta) {
    ...
    return validMeta.map((child) => {
        ...
        return {
            type: "meta",
            props: {
                property: typeof child.props.property === "string"
                    ? child.props.property
                    : undefined,
                content: typeof child.props.content === "string"
                    ? child.props.content
                    : undefined,
            },
        };
...
function useRegisterCurrentActivity(activity) {
    ...
    React.useEffect(() => {
        ...
        if (cascadingActivity.isEligibleForHandoff ||
