...
- Expose `ObserveErrorBoundary`, a React error boundary that records render-phase errors as `exception` log events and renders a `fallback` in place of the crashed subtree. ([#47341](https://github.com/expo/expo/pull/47341) by [@tsapeta](https://github.com/tsapeta))
