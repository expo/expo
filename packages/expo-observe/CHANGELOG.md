...
- Add `Observe.clientId`, the EAS client id recorded on every event, so apps can correlate Observe data with other services. ([#49582](https://github.com/expo/expo/pull/49582) by [@kadikraman](https://github.com/kadikraman))
