...
class NewUpdateManifestTest {
  ...
  fun testFromManifestJson_AllFields() {
    ...
    Assert.assertNotNull(NewUpdateManifest.fromNewManifest(manifest, ResponseHeaderData(), null, createConfig()))
  }
  ...
  fun testFromManifestJson_NoId() {
    ...
    val manifest = NewManifest(JSONObject(manifestJson))
    NewUpdateManifest.fromNewManifest(manifest, ResponseHeaderData(), null, createConfig())
  }
