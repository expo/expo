...
class SelectionPolicyFilterAwareTest {
  ...
  fun setup() {
    ...
    updateRollout0 = NewUpdateManifest.fromNewManifest(manifestJsonRollout0, ManifestHeaderData(null, null, null, null), null, config).updateEntity
    ...
    updateDefault1 = NewUpdateManifest.fromNewManifest(manifestJsonDefault1, ManifestHeaderData(null, null, null, null), null, config).updateEntity
    ...
    updateRollout1 = NewUpdateManifest.fromNewManifest(manifestJsonRollout1, ManifestHeaderData(null, null, null, null), null, config).updateEntity
    ...
    updateDefault2 = NewUpdateManifest.fromNewManifest(manifestJsonDefault2, ManifestHeaderData(null, null, null, null), null, config).updateEntity
    ...
    updateRollout2 = NewUpdateManifest.fromNewManifest(manifestJsonRollout2, ManifestHeaderData(null, null, null, null), null, config).updateEntity
    ...
    updateMultipleFilters = NewUpdateManifest.fromNewManifest(manifestJsonMultipleFilters, ManifestHeaderData(null, null, null, null), null, config).updateEntity
    val manifestJsonNoMetadata = NewManifest(JSONObject("{\"id\":\"079cde35-8433-4c17-81c8-7117c1513e72\",\"createdAt\":\"2021-01-11T19:39:22.480Z\",\"runtimeVersion\":\"1.0\",\"launchAsset\":{\"hash\":\"DW5MBgKq155wnX8rCP1lnsW6BsTbfKLXxGXRQx1RcOA\",\"key\":\"0436e5821bff7b95a84c21f22a43cb96.bundle\",\"contentType\":\"application/javascript\",\"url\":\"https://url.to/bundle\"},\"assets\":[{\"hash\":\"JSeRsPNKzhVdHP1OEsDVsLH500Zfe4j1O7xWfa14oBo\",\"key\":\"3261e570d51777be1e99116562280926.png\",\"contentType\":\"image/png\",\"url\":\"https://url.to/asset\"}]}"))
    updateNoMetadata = NewUpdateManifest.fromNewManifest(manifestJsonNoMetadata, ManifestHeaderData(null, null, null, null), null, config).updateEntity
  }
