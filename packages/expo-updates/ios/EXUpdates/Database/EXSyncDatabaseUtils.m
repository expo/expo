...
static NSString * const EXSyncDatabaseUtilsErrorDomain = @"EXSyncDatabase";

@implementation EXSyncDatabaseUtils
...
+ (NSError *)errorFromSqlite:(struct sqlite3 *)db
{
  ...
  return [NSError errorWithDomain:EXSyncDatabaseUtilsErrorDomain
                             code:extendedCode
