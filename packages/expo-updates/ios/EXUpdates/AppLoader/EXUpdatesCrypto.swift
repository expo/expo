...
internal final class EXUpdatesCrypto {
  ...
  public static func verifySignature(
    ...
    successBlock: @escaping EXUpdatesVerifySignatureSuccessBlock,
    errorBlock: @escaping EXUpdatesVerifySignatureErrorBlock
  ) {
    ...
    let fileDownloader = EXUpdatesFileDownloader(config: config, urlSessionConfiguration: configuration)
  ...
  private static func verify(
    ...
    signature: String,
    signedString: String,
    callback: @escaping EXUpdatesVerifySignatureSuccessBlock
  ) {
