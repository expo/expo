 ...
 */
@objcMembers
public final class EXUpdatesResponseHeaderData : NSObject {
  /**
  ...
  public required init(protocolVersion: String?, serverDefinedHeadersRaw: String?, manifestFiltersRaw: String?, manifestSignature: String?) {
  ...
  public lazy var serverDefinedHeaders: [String : Any]? = {
    EXUpdatesResponseHeaderData.dictionaryWithStructuredHeader(self.serverDefinedHeadersRaw)
  }()
  ...
  public static func dictionaryWithStructuredHeader(_ headerString: String?) -> [String : Any]? {
    ...
    guard let parserOutputDictionary = parserOutput as? Dictionary<String, Any> else {
 ...
 */
@objcMembers
public final class EXUpdatesResponsePartHeaderData : NSObject {
  /**
   * Code signing signature for response part.
   */
  public let signature: String?
  
  public required init(signature: String?) {
 ...
 */
@objcMembers
public final class EXUpdatesResponsePartInfo : NSObject {
  public let responseHeaderData: EXUpdatesResponseHeaderData
  public let responsePartHeaderData: EXUpdatesResponsePartHeaderData
  public let body: Data
  
  public required init(responseHeaderData: EXUpdatesResponseHeaderData, responsePartHeaderData: EXUpdatesResponsePartHeaderData, body: Data) {
