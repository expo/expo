...
struct SelectionPolicyFilterAwareTests {
  ...
  @Test
  func `delete - second newest matching`() {
  ...
  @Test
  func `delete - none older matching`() {
  ...
  @Test
  func `should load new update - normal case - older update`() {
  ...
  @Test
  func `should load rollback to embedded directive - no launched update`() {
    #expect(selectionPolicy.shouldLoadRollBackToEmbeddedDirective(
      RollBackToEmbeddedUpdateDirective(commitTime: Date(), signingInfo: nil),
  ...
  @Test
  func `should load rollback to embedded directive - launched update does not match filters`() {
    #expect(selectionPolicy.shouldLoadRollBackToEmbeddedDirective(
      RollBackToEmbeddedUpdateDirective(commitTime: Date(), signingInfo: nil),
      withEmbeddedUpdate: updateRollout0,
  ...
  @Test
  func `should load rollback to embedded directive - commit time of launched update before roll back - true`() {
  ...
  @Test
  func `should load rollback to embedded directive - commit time of launched update before roll back - false`() {
    // updateRollout1 has commitTime = 2021-01-12T19:39:22.480Z
  ...
  @Test
  func `does update match filters - multiple filters`() {
    let filtersBadMatch = [
      "firstkey": "value1",
