...
{
  EXManifestsLegacyRawManifest *manifest = [[EXManifestsLegacyRawManifest alloc] initWithRawManifestJSON:@{}];
...
- (void)testBundledAssetBaseUrl_AssetUrlOverride_AbsoluteUrl
{
  ...
  NSURL *absoluteActual = [EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:[[EXManifestsLegacyRawManifest alloc] initWithRawManifestJSON:@{ @"assetUrlOverride": absoluteUrlString }] config:_selfHostedConfig];
...
- (void)testBundledAssetBaseUrl_AssetUrlOverride_RelativeUrl
{
  ...
  NSURL *relativeActual = [EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:[[EXManifestsLegacyRawManifest alloc] initWithRawManifestJSON:@{ @"assetUrlOverride": @"my_assets" }] config:_selfHostedConfig];
...
- (void)testBundledAssetBaseUrl_AssetUrlOverride_OriginRelativeUrl
{
  ...
  NSURL *originRelativeActual = [EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:[[EXManifestsLegacyRawManifest alloc] initWithRawManifestJSON:@{ @"assetUrlOverride": @"/my_assets" }] config:_selfHostedConfig];
...
- (void)testBundledAssetBaseUrl_AssetUrlOverride_RelativeUrlDotSlash
{
  ...
  NSURL *relativeDotSlashActual = [EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:[[EXManifestsLegacyRawManifest alloc] initWithRawManifestJSON:@{ @"assetUrlOverride": @"./my_assets" }] config:_selfHostedConfig];
...
- (void)testBundledAssetBaseUrl_AssetUrlOverride_Normalize
{
  ...
  NSURL *actual = [EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:[[EXManifestsLegacyRawManifest alloc] initWithRawManifestJSON:@{ @"assetUrlOverride": @"./a/../b" }] config:_selfHostedConfig];
...
- (void)testBundledAssetBaseUrl_AssetUrlOverride_NormalizeToHostname
{
  ...
  NSURL *actual = [EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:[[EXManifestsLegacyRawManifest alloc] initWithRawManifestJSON:@{ @"assetUrlOverride": @"../b" }] config:_selfHostedConfig];
...
- (void)testBundledAssetBaseUrl_AssetUrlOverride_Default
{
  ...
  NSURL *defaultActual = [EXUpdatesLegacyUpdate bundledAssetBaseUrlWithManifest:[[EXManifestsLegacyRawManifest alloc] initWithRawManifestJSON:@{}] config:_selfHostedConfig];
