...
@Suite("FileDownloaderManifestParsing manifest parsing")
struct FileDownloaderManifestParsingTests {
  ...
  func `multipart body`() {
    ...
    let bodyData = Self.mutlipartData(
      boundary: boundary,
  ...
  @Test
  func `multipart body only directive`() {
    let config = try! UpdatesConfig.config(fromDictionary: [
      UpdatesConfig.EXUpdatesConfigUpdateUrlKey: "https://exp.host/@test/test",
      UpdatesConfig.EXUpdatesConfigRuntimeVersionKey: "1",
    ])
  ...
  @Test
  func `multipart body only directive v0 compatibility mode`() {
    let config = try! UpdatesConfig.config(fromDictionary: [
      UpdatesConfig.EXUpdatesConfigUpdateUrlKey: "https://exp.host/@test/test",
      UpdatesConfig.EXUpdatesConfigRuntimeVersionKey: "1",
  ...
  @Test
  func `multipart body no relevant parts`() {
    let config = try! UpdatesConfig.config(fromDictionary: [
      UpdatesConfig.EXUpdatesConfigUpdateUrlKey: "https://exp.host/@test/test",
      UpdatesConfig.EXUpdatesConfigRuntimeVersionKey: "1",
    ])
  ...
  @Test
  func `json body expects signed receives unsigned`() {
    let config = try! UpdatesConfig.config(fromDictionary: [
      UpdatesConfig.EXUpdatesConfigUpdateUrlKey: "https://exp.host/@test/test",
      UpdatesConfig.EXUpdatesConfigRuntimeVersionKey: "1",
      UpdatesConfig.EXUpdatesConfigCodeSigningCertificateKey: getTestCertificate(.test),
  ...
  @Test
  func `multipart body signed certificate particular experience`() {
    let config = try! UpdatesConfig.config(fromDictionary: [
      UpdatesConfig.EXUpdatesConfigUpdateUrlKey: "https://exp.host/@test/test",
      UpdatesConfig.EXUpdatesConfigRuntimeVersionKey: "1",
  ...
  @Test
  func `multipart body signed certificate particular experience incorrect experience in manifest`() {
    let config = try! UpdatesConfig.config(fromDictionary: [
      UpdatesConfig.EXUpdatesConfigUpdateUrlKey: "https://exp.host/@test/test",
      UpdatesConfig.EXUpdatesConfigRuntimeVersionKey: "1",
      UpdatesConfig.EXUpdatesConfigCodeSigningCertificateKey: getTestCertificate(.chainRoot),
  ...
  @Test
  func `multipart body signed certificate particular experience incorrect experience in directive`() {
    let config = try! UpdatesConfig.config(fromDictionary: [
      UpdatesConfig.EXUpdatesConfigUpdateUrlKey: "https://exp.host/@test/test",
      UpdatesConfig.EXUpdatesConfigRuntimeVersionKey: "1",
      UpdatesConfig.EXUpdatesConfigCodeSigningCertificateKey: getTestCertificate(.chainRoot),
  ...
  @Test
  func `json body signed unsigned request manifest signature optional`() {
    let config = try! UpdatesConfig.config(fromDictionary: [
      UpdatesConfig.EXUpdatesConfigUpdateUrlKey: "https://exp.host/@test/test",
      UpdatesConfig.EXUpdatesConfigRuntimeVersionKey: "1",
      UpdatesConfig.EXUpdatesConfigCodeSigningCertificateKey: getTestCertificate(.test),
