...
- (void)setUp
{
  ...
  _updateRollout0 = [EXUpdatesNewUpdate updateWithNewManifest:[[EXRawManifestsNewRawManifest alloc] initWithRawManifestJSON:@{
  ...
  _updateDefault1 = [EXUpdatesNewUpdate updateWithNewManifest:[[EXRawManifestsNewRawManifest alloc] initWithRawManifestJSON:@{
  ...
  _updateRollout1 = [EXUpdatesNewUpdate updateWithNewManifest:[[EXRawManifestsNewRawManifest alloc] initWithRawManifestJSON:@{
  ...
  _updateDefault2 = [EXUpdatesNewUpdate updateWithNewManifest:[[EXRawManifestsNewRawManifest alloc] initWithRawManifestJSON:@{
  ...
  _updateRollout2 = [EXUpdatesNewUpdate updateWithNewManifest:[[EXRawManifestsNewRawManifest alloc] initWithRawManifestJSON:@{
  ...
  _updateMultipleFilters = [EXUpdatesNewUpdate updateWithNewManifest:[[EXRawManifestsNewRawManifest alloc] initWithRawManifestJSON:@{
    @"id": @"079cde35-8433-4c17-81c8-7117c1513e72",
    @"createdAt": @"2021-01-11T19:39:22.480Z",
    @"runtimeVersion": @"1.0",
    @"launchAsset": launchAsset,
  ...
  _updateNoMetadata = [EXUpdatesNewUpdate updateWithNewManifest:[[EXRawManifestsNewRawManifest alloc] initWithRawManifestJSON:@{
    @"id": @"079cde35-8433-4c17-81c8-7117c1513e72",
    @"createdAt": @"2021-01-11T19:39:22.480Z",
    @"runtimeVersion": @"1.0",
    @"launchAsset": launchAsset,
