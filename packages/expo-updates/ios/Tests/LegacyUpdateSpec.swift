  ...
  override func spec() {
    describe("bundledAssetBaseUrl") {
      it("expo domain") {
        ...
        expect(LegacyUpdate.bundledAssetBaseUrl(withManifest: manifest, config: try UpdatesConfig.config(fromDictionary: [UpdatesConfig.EXUpdatesConfigUpdateUrlKey: "https://exp.host/@test/test"]))) == expected
        expect(LegacyUpdate.bundledAssetBaseUrl(withManifest: manifest, config: try UpdatesConfig.config(fromDictionary: [UpdatesConfig.EXUpdatesConfigUpdateUrlKey: "https://expo.io/@test/test"]))) == expected
        expect(LegacyUpdate.bundledAssetBaseUrl(withManifest: manifest, config: try UpdatesConfig.config(fromDictionary: [UpdatesConfig.EXUpdatesConfigUpdateUrlKey: "https://expo.test/@test/test"]))) == expected
      }

      it("expo subdomain") {
        let manifest = LegacyManifest(rawManifestJSON: [:])
        let expected = URL(string: "https://classic-assets.eascdn.net/~assets/")
        expect(LegacyUpdate.bundledAssetBaseUrl(withManifest: manifest, config: try UpdatesConfig.config(fromDictionary: [UpdatesConfig.EXUpdatesConfigUpdateUrlKey: "https://staging.exp.host/@test/test"]))) == expected
        expect(LegacyUpdate.bundledAssetBaseUrl(withManifest: manifest, config: try UpdatesConfig.config(fromDictionary: [UpdatesConfig.EXUpdatesConfigUpdateUrlKey: "https://staging.expo.io/@test/test"]))) == expected
        expect(LegacyUpdate.bundledAssetBaseUrl(withManifest: manifest, config: try UpdatesConfig.config(fromDictionary: [UpdatesConfig.EXUpdatesConfigUpdateUrlKey: "https://staging.expo.test/@test/test"]))) == expected
      }
