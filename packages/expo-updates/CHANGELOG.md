...
- Resolve the VCS root from the project directory instead of the current working directory when detecting the project workflow. ([#50396](https://github.com/expo/expo/pull/50396) by [@tahakocal](https://github.com/tahakocal))
