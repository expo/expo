...
- Add `downloadProgress` state to the `useUpdates` hook to support listening to assets download progress. ([#38307](https://github.com/expo/expo/pull/38307)) by [@nishan](https://github.com/intergalacticspacehighway)
