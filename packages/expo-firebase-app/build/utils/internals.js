...
var GRADLE_DEPS;
(function (GRADLE_DEPS) {
    GRADLE_DEPS["admob"] = "ads";
...
export default {
    ...
    STRINGS: {
        ...
        get ERROR_MISSING_CORE() {
            if (Platform.OS === 'ios') {
                return ('ExpoFirebase core module was not found natively on iOS, ensure you have ' +
                    'correctly included the ExpoFirebase pod in your projects `Podfile` and have run `pod install`.' +
                    '\r\n\r\n See http://invertase.link/ios for the ios setup guide.');
            }
            return ('ExpoFirebase core module was not found natively on Android, ensure you have ' +
