...
public class BorderDrawable extends Drawable {
  ...
  private enum BorderStyle {
    ...
    PathEffect getPathEffect(BorderStyle style, float borderWidth) {
      switch (style) {
        case SOLID:
          return null;
  ...
  private @Nullable
  Path mInnerClipPathForBorderRadius;
  private @Nullable
  Path mOuterClipPathForBorderRadius;
  private @Nullable
  Path mPathForBorderRadiusOutline;
  private @Nullable
  Path mPathForBorder;
  private @Nullable
  Path mCenterDrawPath;
  private @Nullable
  RectF mInnerClipTempRectForBorderRadius;
  private @Nullable
  RectF mOuterClipTempRectForBorderRadius;
  private @Nullable
  RectF mTempRectForCenterDrawPath;
  private @Nullable
  PointF mInnerTopLeftCorner;
  private @Nullable
  PointF mInnerTopRightCorner;
  private @Nullable
  PointF mInnerBottomRightCorner;
  private @Nullable
  PointF mInnerBottomLeftCorner;
  ...
  private int getBorderColor(int position) {
    ...
    return BorderDrawable.colorFromAlphaAndRGBComponents(alpha, rgb);
  }
