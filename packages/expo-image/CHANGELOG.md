...
- [iOS] Fixed a `CALayerInvalidGeometry` crash when an image decodes to a size of `0x0` and `contentFit` is `cover` or `contain`. ([#49936](https://github.com/expo/expo/pull/49936) by [@expo-bot](https://github.com/expo-bot))
