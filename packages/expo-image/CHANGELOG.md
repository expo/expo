...
- Fixed images laying out as `0x0` when the size is declared by the source (an asset loaded with `require` or a `width`/`height` on the `ImageSource`) and not by the style. ([#45511](https://github.com/expo/expo/issues/45511)) ([#48748](https://github.com/expo/expo/pull/48748) by [@expo-bot](https://github.com/expo-bot))
