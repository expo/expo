...
- [Android] Fixed native crashes when decoding and clearing some animated GIFs. ([#PR](https://github.com/expo/expo/pull/PR) by [@MangelSpec](https://github.com/MangelSpec))
