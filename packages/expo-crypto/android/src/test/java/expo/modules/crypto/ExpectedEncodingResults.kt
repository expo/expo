...
val expectedEncodingResults = mapOf(
  DigestOptions.Encoding.HEX to mapOf(
    ...
    DigestAlgorithm.MD2 to "fb85323c3b15b016e0351006e2f47bf7",
    DigestAlgorithm.MD4 to "2d36099794ec182cbb36d02e1188fc1e",
  ...
  DigestOptions.Encoding.BASE64 to mapOf(
    ...
    DigestAlgorithm.MD2 to "+4UyPDsVsBbgNRAG4vR79w==",
    DigestAlgorithm.MD4 to "LTYJl5TsGCy7NtAuEYj8Hg==",
