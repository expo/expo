...
- Added support for prebuilt React Native Core via `ios.buildFromSource: false` in the iOS build properties setting the environment variable `ENV['RCT_USE_PREBUILT_RNCORE'] = '1'` in the Podfile ([#38400](https://github.com/expo/expo/pull/38400) by [@chrfalch](https://github.com/chrfalch))
