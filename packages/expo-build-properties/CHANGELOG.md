...
- Add Android GIF and WebP image support build properties: `android.gifEnabled`, `android.webpEnabled`, and `android.webpAnimated`. (#PR by [@shubhporwal](https://github.com/shubhporwal))
