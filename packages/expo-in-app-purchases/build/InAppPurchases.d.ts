import { IAPErrorCode, IAPItemType, IAPQueryResponse, IAPResponseCode, InAppPurchase, InAppPurchaseState, IAPItemDetails, IAPPurchaseHistoryOptions, QueryResult, BillingFlowParams } from './InAppPurchases.types';
export { InAppPurchase, InAppPurchaseState, IAPResponseCode, IAPErrorCode, IAPItemType, IAPQueryResponse, IAPItemDetails, IAPPurchaseHistoryOptions, QueryResult, BillingFlowParams, };
/**
...
/**
 * Initiates the purchase flow to buy the item associated with this `productId`. This will display
 ...
 */
export declare function purchaseItemAsync(itemId: string, details?: BillingFlowParams): Promise<void>;
/**
 ...
 * @param consumeItem __Android Only.__ A boolean indicating whether or not the item is a consumable.
 */
 ...
 * ```
 */
export declare function getBillingResponseCodeAsync(): Promise<IAPResponseCode>;
/**
