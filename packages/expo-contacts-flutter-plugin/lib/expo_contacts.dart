...
class Field {
  ...
  static const phoneticFirstName = const Field._fromString('phoneticFirstName');
  static const phoneticMiddleName =
      const Field._fromString('phoneticMiddleName');
  static const phoneticLastName = const Field._fromString('phoneticLastName');
  ...
  Contact._fromMap(Map map)
      : id = map['id'],
        ...
        nonGregorianBirthday = map['nonGregorianBirthday'] != null
            ...
            : null,
        emails =
            map['emails']?.map((map) => new Email._fromMap(map))?.cast<Email>(),
        ...
        image = map['image'] != null ? new Image._fromMap(map['image']) : null,
        thumbnail = map['thumbnail'] != null
            ? new Image._fromMap(map['thumbnail'])
            : null,
        note = map['note'],
        dates =
            map['dates']?.map((map) => new Date._fromMap(map))?.cast<Date>(),
