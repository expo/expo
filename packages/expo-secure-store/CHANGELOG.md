...
- [Android] Keep a value readable after `deleteItemAsync` rejects, instead of reporting it as absent while it is still on disk. ([#49939](https://github.com/expo/expo/pull/49939) by [@expo-bot](https://github.com/expo-bot))
