 ...
 *
 * This function behaves the same as [`setStringAsync()`](https://docs.expo.dev/versions/latest/sdk/clipboard/#setstringasynctext-options), except that
 ...
 * a [`ClipboardImage`](https://docs.expo.dev/versions/latest/sdk/clipboard/#clipboardimage) object containing the base64 string and metadata of the image.
