...
export default class Blob {
    ...
    static fromBase64String(base64) {
        invariant(base64 === 'string' && base64.length > 0, 'firestore.Blob.fromBase64String expects a string of at least 1 character in length');
    ...
    static fromUint8Array(array) {
        invariant(array instanceof Uint8Array, 'firestore.Blob.fromUint8Array expects an instance of Uint8Array');
