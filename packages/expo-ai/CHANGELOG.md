...
- Explain the Apple unavailability reasons instead of reporting an unrecognised cause on iOS and macOS. ([#50001](https://github.com/expo/expo/pull/50001) by [@chrfalch](https://github.com/chrfalch))
