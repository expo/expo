...
export default class AndroidNotification {
     ...
     */
    setInboxStyle(lines, contentTitle, summaryText) {
        this._inboxStyle = {
            contentTitle,
            summaryText,
            lines,
     ...
     */
    addAction(action) {
        invariant(action instanceof AndroidAction, `AndroidNotification:addAction expects an 'AndroidAction' but got type ${typeof action}`);
    ...
    setBadgeIconType(badgeIconType) {
        invariant(Object.values(BadgeIconType).includes(badgeIconType), `AndroidNotification:setBadgeIconType Invalid BadgeIconType: ${badgeIconType}`);
    ...
    setCategory(category) {
        invariant(Object.values(Category).includes(category), `AndroidNotification:setCategory Invalid Category: ${category}`);
    ...
    setGroupAlertBehaviour(groupAlertBehaviour) {
        invariant(Object.values(GroupAlert).includes(groupAlertBehaviour), `AndroidNotification:setGroupAlertBehaviour Invalid GroupAlert: ${groupAlertBehaviour}`);
    ...
    setPriority(priority) {
        invariant(Object.values(Priority).includes(priority), `AndroidNotification:setPriority Invalid Priority: ${priority}`);
