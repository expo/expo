...
RCT_EXTERN_METHOD(dispatchActionAsync:(NSString *)actionId args:(NSDictionary *)args resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject)
