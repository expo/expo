...
import com.facebook.react.views.modal.DevMenuRNGHModalUtils;
...
public class RNGestureHandlerRootHelper {
  ...
  private static ViewGroup findRootViewTag(ViewGroup viewGroup) {
    ...
    while (parent != null && !(parent instanceof ReactRootView || DevMenuRNGHModalUtils.isDialogRootViewGroup(parent))) {
  ...
  private class RootViewGestureHandler extends GestureHandler {
    ...
    protected void onCancel() {
      ...
      if (mRootView instanceof ReactRootView) {
        ...
        DevMenuRNGHModalUtils.dialogRootViewGroupOnChildStartedNativeGesture(mRootView, event);
      }
    }
  }
