...
// DevMenuRNBetterTapGestureRecognizer extends UIGestureRecognizer instead of UITapGestureRecognizer 
...
@interface DevMenuRNBetterTapGestureRecognizer : UIGestureRecognizer
...
@implementation DevMenuRNBetterTapGestureRecognizer {
...
@implementation DevMenuRNTapGestureHandler {
    DevMenuRNGestureHandlerEventExtraData * _lastData;
}

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[DevMenuRNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
{
  [super resetConfig];
  DevMenuRNBetterTapGestureRecognizer *recognizer = (DevMenuRNBetterTapGestureRecognizer *)_recognizer;
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
  ...
  // in DevMenuRNGestureHandler it resets _lastSatate variable, making is seem like handler
