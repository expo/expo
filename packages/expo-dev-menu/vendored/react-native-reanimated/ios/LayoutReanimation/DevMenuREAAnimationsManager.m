...
@interface DevMenuREAAnimationsManager ()
...
@implementation DevMenuREAAnimationsManager {
  RCTUIManager *_uiManager;
  DevMenuREAUIManager *_reaUiManager;
...
- (instancetype)initWithUIManager:(RCTUIManager *)uiManager
{
  if (self = [super init]) {
    ...
    _reaUiManager = (DevMenuREAUIManager *)uiManager;
...
- (void)scheduleCleaning
{
  ...
  __weak DevMenuREAAnimationsManager *weakSelf = self;
