...
RCT_ENUM_CONVERTER(DevMenuREATransitionType, (@{
                                         ...
                                         }), DevMenuREATransitionTypeNone, integerValue)

RCT_ENUM_CONVERTER(DevMenuREATransitionAnimationType, (@{
                                                  ...
                                                  }), DevMenuREATransitionAnimationTypeNone, integerValue)

RCT_ENUM_CONVERTER(DevMenuREATransitionInterpolationType, (@{
                                                      ...
                                                      }), DevMenuREATransitionInterpolationLinear, integerValue)

RCT_ENUM_CONVERTER(DevMenuREATransitionPropagationType, (@{
                                                    ...
                                                    }), DevMenuREATransitionPropagationNone, integerValue)
@end
