...
internal class ExpoLaunchUrlTest {
  ...
  fun `expo go url keeps the other params`() {
    val launch = ExpoLaunchUrl(Uri.parse("exp://h:8081/--/p?__expo_disable_fab=1&x=1"))
  ...
  fun `preserves percent encoding of the other params`() {
    val launch = ExpoLaunchUrl(Uri.parse("exp://h:8081/?snack-channel=a%2Bb&__expo_disable_fab=1"))
