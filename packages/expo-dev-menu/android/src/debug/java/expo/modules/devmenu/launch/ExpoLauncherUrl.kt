...
class ExpoLauncherUrl(val url: Uri) {
  ...
  val disablesFab = param("disable_fab", legacy = "disableFab") == "1"
  val disablesAutoLaunch = param("disable_auto_launch", legacy = "disableAutoLaunch") == "1"
  ...
  private fun param(name: String, legacy: String): String? {
