...
/**
 * v17 -> v18: adds the `spans` table. Hand-written because schema export is off (so Room's
    ...
    fun getDatabase(context: android.content.Context): MetricsDatabase =
      INSTANCE ?: synchronized(this) {
        val instance = Room
          ...
          // Destructive fallback for version jumps without a registered migration (pre-17
