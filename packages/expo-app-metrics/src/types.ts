...
export type SpanEndOptions = {
  ...
  /**
   * Free-text detail explaining an `'error'` status, such as the failure's message. Ignored
   * for any other status: OpenTelemetry allows a status description only with the error status.
   */
  message?: string | null;
  /**
