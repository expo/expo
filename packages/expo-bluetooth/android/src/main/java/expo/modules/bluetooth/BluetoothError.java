...
public class BluetoothError {
  ...
  public static final BluetoothError CONCURRENT_TASK(String deviceId) {
    return new BluetoothError(PREFIX + "CONCURRENT_TASK", "Running concurrent task on: " + deviceId);
  }
