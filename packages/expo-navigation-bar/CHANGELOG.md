...
- Restricted color types to string to prevent the use of illegal color types (PlatformColor) untill supported. ([#34053](https://github.com/expo/expo/pull/34053) by [@chrfalch](https://github.com/chrfalch))
