...
class EXFileSystemSpec: ExpoSpec {
  override func spec() {
    ...
    describe("percentEncodeURIString") {
      it("should handle encoded URIs") {
        ...
        let encodedUri = fileSystem.percentEncodeURIString(encodedUriInput)
      ...
      it("should handle UTF-8 characters") {
        ...
        let utf8Uri = fileSystem.percentEncodeURIString(utf8UriInput)
      ...
      it("should handle URI with percent, numbers and UTF-8 characters") {
        ...
        let uri = fileSystem.percentEncodeURIString(input)
      ...
      it("should handle assets-library URIs") {
        ...
        let assetsLibraryUri = fileSystem.percentEncodeURIString(assetsLibraryUriInput)
