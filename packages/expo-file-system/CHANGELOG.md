...
- [iOS] Add `getSharedContainerUriAsync` function to get the path to the iOS shared container. ([#31278](https://github.com/expo/expo/pull/31278)) by [@IgorKhramtsov](https://github.com/IgorKhramtsov)
