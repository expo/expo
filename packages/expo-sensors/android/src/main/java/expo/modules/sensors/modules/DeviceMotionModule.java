...
public class DeviceMotionModule extends ExportedModule implements SensorEventListener2, ModuleRegistryConsumer {
  ...
  public void isAvailableAsync(Promise promise) {
   ...
   ArrayList<SensorType> sensorTypes = new ArrayList<>(Arrays.asList(Sensor.TYPE_GYROSCOPE, Sensor.TYPE_ACCELEROMETER, Sensor.TYPE_LINEAR_ACCELERATION, Sensor.TYPE_ROTATION_VECTOR, Sensor.TYPE_GRAVITY));
