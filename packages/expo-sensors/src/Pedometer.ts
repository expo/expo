 ...
 * @platform ios
 */
export async function isEventTrackingAvailableAsync(): Promise<boolean> {
 ...
 * @platform ios
 */
export async function startEventUpdatesAsync(): Promise<void> {
 ...
 * @platform android
 */
export async function subscribeRecordingAsync(): Promise<void> {
 ...
 * @platform android
 */
export async function unsubscribeRecordingAsync(): Promise<void> {
