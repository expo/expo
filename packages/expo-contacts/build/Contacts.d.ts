...
/**
 * Type for creating new contacts - excludes the id field since it will be generated by the OS.
 */
 ...
 * ```
 */
export declare function addContactAsync(contact: NewContact, containerId?: string): Promise<string>;
/**
 ...
 * ```
 */
export declare function presentFormAsync(contactId?: string | null, contact?: NewContact | null, formOptions?: FormOptions): Promise<any>;
/**
