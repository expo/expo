...
export type ExistingEmail = NewEmail & {
   ...
   * For iOS it's an identifier from CNLabeledValue,
...
export type ExistingPhone = NewPhone & {
  /**
   * Unique identifier for the existing phone. For iOS it's an identifier from CNLabeledValue,
...
export type ExistingDate = NewDate & {
  /**
   * Unique identifier for the existing date. For iOS it's an identifier from CNLabeledValue,
...
export type ExistingAddress = NewAddress & {
  /**
   * Unique identifier for the existing address. For iOS it's an identifier from CNLabeledValue,
...
export type ExistingRelation = NewRelation & {
  /**
   * Unique identifier for the existing relation. For iOS it's an identifier from CNLabeledValue,
...
export type ExistingUrlAddress = NewUrlAddress & {
  /**
   * Unique identifier for the existing URL address. For iOS it's an identifier from CNLabeledValue,
...
export type ExistingImAddress = NewImAddress & {
  /**
   * Unique identifier for the existing instant messaging address. It's an identifier from CNLabeledValue.
   */
  id: string;
};
...
export type ExistingSocialProfile = NewSocialProfile & {
  /**
   * Unique identifier for the existing social profile. It's an identifier from CNLabeledValue.
   */
  id: string;
};
