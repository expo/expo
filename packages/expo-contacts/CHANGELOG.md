...
- [iOS] Map predefined `CNLabeledValue` label constants such as `_$!<Home>!$_` to the documented keys such as `home` in the class-based API, in both directions. ([#49585](https://github.com/expo/expo/pull/49585) by [@expo-bot](https://github.com/expo-bot))
