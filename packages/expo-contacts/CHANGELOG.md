...
- [Android] Add support for contact group functions - `getGroupsAsync`, `createGroupAsync`, `updateGroupName`, `removeGroupAsync`, `addExistingContactToGroupAsync` and `removeContactFromGroupAsync` as well as adding ability to `getContactsAsync({ groupId })`. ([#29082](https://github.com/expo/expo/pull/29082)) by [@devdave25](https://github.com/devdave25)
