...
6. Package docs are partially generated from sources. Run `et generate-docs-api-data -p <package-name>` to generate the package docs [read more](#-updating-documentation).
...
5. Package API docs are generated from sources. To regenerate the docs, run `et generate-docs-api-data -p <package-name>`.
