  ...
  return (
    <>
      <ScrollView
        ...
        <Text style={styles.title}>Right Placement Screen</Text>
        <Text style={styles.subtitle}>Toolbar in header right area</Text>
        ...
        <View style={styles.section}>
          ...
          <Link href="/toolbar-placement/screen-left" asChild>
            <Pressable testID="nav-to-left-from-right" style={styles.navButton}>
              <Text style={styles.navButtonText}>Go to Left Placement</Text>
            </Pressable>
          </Link>

          <Link href="/toolbar-placement/screen-bottom" asChild>
            <Pressable testID="nav-to-bottom-from-right" style={styles.navButton}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.instruction}>
            - Icons should appear in header right area
          </Text>
          <Text style={styles.instruction}>
            - Multiple buttons should be visible
          </Text>
          <Text style={styles.instruction}>
      ...
      {showToolbar && (
        <Stack.Toolbar placement="right">
          ...
          <Stack.Toolbar.Button
            ...
            onPress={() => Alert.alert('More', 'More button pressed')}
          />
        </Stack.Toolbar>
      )}
    </>
