...
const HomeIndex = () => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#fdd', paddingTop: top }}>
      ...
      <ModalPortalHost hostId="test-portal" />
      <View style={{ height: 10, width: '100%' }} />
      <ModalPortalHost hostId="fluid-test-portal" fluid />
  ...
  return (
    <View style={{ padding: 20, backgroundColor: '#f00' }}>
      ...
      <TestContext value={{ value, setValue }}>
        ...
        <ModalPortalContent hostId="fluid-test-portal">
          <TextModalPortalContent style={{ flex: 1 }} title="Fluid Portal Content" />
        </ModalPortalContent>
      </TestContext>
    </View>
  );
