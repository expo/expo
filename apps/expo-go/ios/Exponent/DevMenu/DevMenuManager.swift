...
public class DevMenuManager: NSObject {
  ...
  /**
   ...
   `__expo_disable_fab=1` and `__expo_disable_auto_launch=1`. Returns the URL to open: the `__expo_url`
   target when present, otherwise the URL without its reserved params.
   */
