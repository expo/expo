...
@implementation ABI44_0_0RNSSearchBar {
...
@implementation ABI44_0_0RNSSearchBarManager

ABI44_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
  return [[ABI44_0_0RNSSearchBar alloc] initWithBridge:self.bridge];
}

ABI44_0_0RCT_EXPORT_VIEW_PROPERTY(obscureBackground, BOOL)
ABI44_0_0RCT_EXPORT_VIEW_PROPERTY(hideNavigationBar, BOOL)
ABI44_0_0RCT_EXPORT_VIEW_PROPERTY(hideWhenScrolling, BOOL)
ABI44_0_0RCT_EXPORT_VIEW_PROPERTY(autoCapitalize, UITextAutocapitalizationType)
ABI44_0_0RCT_EXPORT_VIEW_PROPERTY(placeholder, NSString)
ABI44_0_0RCT_EXPORT_VIEW_PROPERTY(barTintColor, UIColor)
ABI44_0_0RCT_EXPORT_VIEW_PROPERTY(textColor, UIColor)
ABI44_0_0RCT_EXPORT_VIEW_PROPERTY(cancelButtonText, NSString)

ABI44_0_0RCT_EXPORT_VIEW_PROPERTY(onChangeText, ABI44_0_0RCTBubblingEventBlock)
ABI44_0_0RCT_EXPORT_VIEW_PROPERTY(onCancelButtonPress, ABI44_0_0RCTBubblingEventBlock)
ABI44_0_0RCT_EXPORT_VIEW_PROPERTY(onSearchButtonPress, ABI44_0_0RCTBubblingEventBlock)
ABI44_0_0RCT_EXPORT_VIEW_PROPERTY(onFocus, ABI44_0_0RCTBubblingEventBlock)
ABI44_0_0RCT_EXPORT_VIEW_PROPERTY(onBlur, ABI44_0_0RCTBubblingEventBlock)
