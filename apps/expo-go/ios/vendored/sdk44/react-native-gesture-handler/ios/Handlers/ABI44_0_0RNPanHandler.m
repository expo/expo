...
#import "ABI44_0_0RNPanHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

@interface ABI44_0_0RNBetterPanGestureRecognizer : UIPanGestureRecognizer
...
@implementation ABI44_0_0RNBetterPanGestureRecognizer {
...
@implementation ABI44_0_0RNPanGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI44_0_0RNBetterPanGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
{
  [super resetConfig];
  ABI44_0_0RNBetterPanGestureRecognizer *recognizer = (ABI44_0_0RNBetterPanGestureRecognizer *)_recognizer;
...
- (void)configure:(NSDictionary *)config
{
...
#if !TARGET_OS_TV && __IPHONE_OS_VERSION_MAX_ALLOWED >= 130400
  if (@available(iOS 13.4, *)) {
    bool enableTrackpadTwoFingerGesture = [ABI44_0_0RCTConvert BOOL:config[@"enableTrackpadTwoFingerGesture"]];
  ...
  if (prop != nil) {
    CGFloat velocity = [ABI44_0_0RCTConvert CGFloat:prop];
...
- (ABI44_0_0RNGestureHandlerEventExtraData *)eventExtraData:(UIPanGestureRecognizer *)recognizer
{
