#import "ABI44_0_0RNGestureHandlerPointerTracker.h"
#import "ABI44_0_0RNGestureHandler.h"

#import <ABI44_0_0React/ABI44_0_0UIView+React.h>

@implementation ABI44_0_0RNGestureHandlerPointerTracker {
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
  ...
  _eventType = ABI44_0_0RNTouchEventTypePointerDown;
...
- (void)touchesMoved:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
  ...
  _eventType = ABI44_0_0RNTouchEventTypePointerMove;
...
- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
  ...
  _eventType = ABI44_0_0RNTouchEventTypePointerUp;
...
- (void)reset
{
  ...
  if (_trackedPointersCount == 0) {
    ...
    _eventType = ABI44_0_0RNTouchEventTypeUndetermined;
  } else {
...
- (void)cancelPointers
{
  ...
  if (registeredTouches > 0) {
    ...
    _eventType = ABI44_0_0RNTouchEventTypeCancelled;
...
- (void)sendEvent
{
  ...
  [_gestureHandler sendTouchEventInState:[_gestureHandler state] forViewWithTag:_gestureHandler.recognizer.view.ABI44_0_0ReactTag];
}
