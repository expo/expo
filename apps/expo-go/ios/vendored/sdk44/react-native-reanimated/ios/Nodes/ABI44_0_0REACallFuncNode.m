...
- (void)beginContext
{
  ...
  for (NSUInteger i = 0; i < _params.count; i++) {
    ...
    ABI44_0_0REAParamNode *param = (ABI44_0_0REAParamNode *)[self.nodesManager findNodeByID:paramID];
...
{
  [self beginContext];
  ABI44_0_0REAFunctionNode *what = (ABI44_0_0REAFunctionNode *)[self.nodesManager findNodeByID:_whatNodeID];
