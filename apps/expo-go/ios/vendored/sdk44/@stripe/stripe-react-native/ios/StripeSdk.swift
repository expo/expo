...
@objc(ABI44_0_0StripeSdk)
class StripeSdk: ABI44_0_0RCTEventEmitter, STPApplePayContextDelegate, STPBankSelectionViewControllerDelegate, UIAdaptivePresentationControllerDelegate {
    ...
    var applePayRequestResolver: ABI44_0_0RCTPromiseResolveBlock? = nil
    var applePayRequestRejecter: ABI44_0_0RCTPromiseRejectBlock? = nil
    var applePayCompletionRejecter: ABI44_0_0RCTPromiseRejectBlock? = nil
    var confirmApplePayPaymentResolver: ABI44_0_0RCTPromiseResolveBlock? = nil
    var confirmPaymentResolver: ABI44_0_0RCTPromiseResolveBlock? = nil
    ...
    func initialise(params: NSDictionary, resolver resolve: @escaping ABI44_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI44_0_0RCTPromiseRejectBlock) -> Void {
        ...
        let name = ABI44_0_0RCTConvert.nsString(appInfo["name"]) ?? ""
        let partnerId = ABI44_0_0RCTConvert.nsString(appInfo["partnerId"]) ?? ""
        let version = ABI44_0_0RCTConvert.nsString(appInfo["version"]) ?? ""
        let url = ABI44_0_0RCTConvert.nsString(appInfo["url"]) ?? ""
    ...
    func initPaymentSheet(params: NSDictionary, resolver resolve: @escaping ABI44_0_0RCTPromiseResolveBlock,
                          rejecter reject: @escaping ABI44_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func confirmPaymentSheetPayment(resolver resolve: @escaping ABI44_0_0RCTPromiseResolveBlock,
                                    rejecter reject: @escaping ABI44_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func presentPaymentSheet(resolver resolve: @escaping ABI44_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI44_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func createTokenForCVCUpdate(cvc: String?, resolver resolve: @escaping ABI44_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI44_0_0RCTPromiseRejectBlock) {
    ...
    func confirmSetupIntent (setupIntentClientSecret: String, params: NSDictionary,
                             options: NSDictionary, resolver resolve: @escaping ABI44_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI44_0_0RCTPromiseRejectBlock) {
    ...
    func updateApplePaySummaryItems(summaryItems: NSArray, errorAddressFields: [NSDictionary], resolver resolve: @escaping ABI44_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI44_0_0RCTPromiseRejectBlock) {
    ...
    func openApplePaySetup(resolver resolve: @escaping ABI44_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI44_0_0RCTPromiseRejectBlock) -> Void {
    ...
    func confirmApplePayPayment(clientSecret: String, resolver resolve: @escaping ABI44_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI44_0_0RCTPromiseRejectBlock) {
    ...
    func isApplePaySupported(resolver resolve: @escaping ABI44_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI44_0_0RCTPromiseRejectBlock) {
    ...
    func handleURLCallback(url: String?, resolver resolve: @escaping ABI44_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI44_0_0RCTPromiseRejectBlock) {
    ...
    func presentApplePay(params: NSDictionary,
                         resolver resolve: @escaping ABI44_0_0RCTPromiseResolveBlock,
                         rejecter reject: @escaping ABI44_0_0RCTPromiseRejectBlock) {
