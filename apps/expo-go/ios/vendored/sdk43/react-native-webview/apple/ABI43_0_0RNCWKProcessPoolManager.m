...
#import "ABI43_0_0RNCWKProcessPoolManager.h"

@interface ABI43_0_0RNCWKProcessPoolManager() {
    WKProcessPool *_sharedProcessPool;
    NSMutableDictionary<NSString *, WKProcessPool *> *_pools;
}
@end

@implementation ABI43_0_0RNCWKProcessPoolManager
...
+ (id) sharedManager {
    static ABI43_0_0RNCWKProcessPoolManager *_sharedManager = nil;
    @synchronized(self) {
