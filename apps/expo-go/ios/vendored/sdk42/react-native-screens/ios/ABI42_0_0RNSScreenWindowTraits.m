...
@implementation ABI42_0_0RNSScreenWindowTraits
...
+ (void)assertViewControllerBasedStatusBarAppearenceSet
{
  ...
  if (!viewControllerBasedAppearence) {
    ABI42_0_0RCTLogError(@"If you want to change the appearance of status bar, you have to change \
...
+ (UIStatusBarStyle)statusBarStyleForRNSStatusBarStyle:(ABI42_0_0RNSStatusBarStyle)statusBarStyle
{
  ...
  if (@available(iOS 13.0, *)) {
    switch (statusBarStyle) {
      case ABI42_0_0RNSStatusBarStyleAuto:
      ...
      case ABI42_0_0RNSStatusBarStyleInverted:
      ...
      case ABI42_0_0RNSStatusBarStyleLight:
          return UIStatusBarStyleLightContent;
      case ABI42_0_0RNSStatusBarStyleDark:
  ...
  if (statusBarStyle == ABI42_0_0RNSStatusBarStyleLight) {
    return UIStatusBarStyleLightContent;
  }
...
+ (void)enforceDesiredDeviceOrientation
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    UIInterfaceOrientation currentDeviceOrientation = [ABI42_0_0RNSScreenWindowTraits interfaceOrientationFromDeviceOrientation:[[UIDevice currentDevice] orientation]];
    UIInterfaceOrientation currentInterfaceOrientation = [ABI42_0_0RNSScreenWindowTraits interfaceOrientation];
    UIInterfaceOrientation newOrientation = UIInterfaceOrientationUnknown;
    if ([ABI42_0_0RNSScreenWindowTraits maskFromOrientation:currentDeviceOrientation] & orientationMask) {
      if (!([ABI42_0_0RNSScreenWindowTraits maskFromOrientation:currentInterfaceOrientation] & orientationMask)) {
      ...
      if (!([ABI42_0_0RNSScreenWindowTraits maskFromOrientation:currentInterfaceOrientation] & orientationMask)) {
        ...
        newOrientation = [ABI42_0_0RNSScreenWindowTraits defaultOrientationForOrientationMask:orientationMask];
      } else {
