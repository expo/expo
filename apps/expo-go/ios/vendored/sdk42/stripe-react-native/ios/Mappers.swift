...
class Mappers {
    ...
    class func mapToBillingDetails(billingDetails: NSDictionary?) -> STPPaymentMethodBillingDetails? {
        ...
        billing.email = ABI42_0_0RCTConvert.nsString(billingDetails["email"])
        billing.phone = ABI42_0_0RCTConvert.nsString(billingDetails["phone"])
        billing.name = ABI42_0_0RCTConvert.nsString(billingDetails["name"])
        
        let billingAddres = STPPaymentMethodAddress()
        
        billingAddres.city = ABI42_0_0RCTConvert.nsString(billingDetails["addressCity"])
        billingAddres.postalCode = ABI42_0_0RCTConvert.nsString(billingDetails["addressPostalCode"])
        billingAddres.country = ABI42_0_0RCTConvert.nsString(billingDetails["addressCountry"])
        billingAddres.line1 = ABI42_0_0RCTConvert.nsString(billingDetails["addressLine1"])
        billingAddres.line2 = ABI42_0_0RCTConvert.nsString(billingDetails["addressLine2"])
        billingAddres.state = ABI42_0_0RCTConvert.nsString(billingDetails["addressState"])
