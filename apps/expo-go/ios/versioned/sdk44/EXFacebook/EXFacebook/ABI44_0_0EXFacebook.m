...
#import <ABI44_0_0EXFacebook/ABI44_0_0EXFacebookAppTrackingPermissionRequester.h>
...
NSString * const ABI44_0_0EXFacebookMisconfiguredErrorDomain = @"ERR_FACEBOOK_MISCONFIGURED";
NSString * const ABI44_0_0EXFacebookLoginErrorDomain = @"ERR_FACEBOOK_LOGIN";
...
@interface ABI44_0_0EXFacebook ()

@property (nonatomic, weak) id<ABI44_0_0EXPermissionsInterface> permissionsManager;

@end

@implementation ABI44_0_0EXFacebook

ABI44_0_0EX_EXPORT_MODULE(ExponentFacebook)
...
- (void)setModuleRegistry:(ABI44_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  [ABI44_0_0EXPermissionsMethodsDelegate registerRequesters:@[[ABI44_0_0EXFacebookAppTrackingPermissionRequester new]] withPermissionsManager:_permissionsManager];
}
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  [ABI44_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI44_0_0EXFacebookAppTrackingPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
...
ABI44_0_0EX_EXPORT_METHOD_AS(setAdvertiserTrackingEnabledAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(setAutoLogAppEventsEnabledAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(initializeAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (![FBSDKSettings appID]) {
    reject(ABI44_0_0EXFacebookMisconfiguredErrorDomain, @"No FacebookAppId configured, required for initialization. Please ensure that you're either providing `appId` to `initializeAsync` as an argument or inside Info.plist.", nil);
    return;
  }
  // Caller overrides buildtime settings
  if (options[@"appName"]) {
...
ABI44_0_0EX_EXPORT_METHOD_AS(setAdvertiserIDCollectionEnabledAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(logOutAsync,
                    logOutAsync:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
...
ABI44_0_0EX_EXPORT_METHOD_AS(getAuthenticationCredentialAsync,
                    getAuthenticationCredentialAsync:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  FBSDKAccessToken *currentAccessToken = [FBSDKAccessToken currentAccessToken];
  resolve(ABI44_0_0EXNullIfNil([ABI44_0_0EXFacebook accessTokenNativeToJSON:currentAccessToken]));
}

ABI44_0_0EX_EXPORT_METHOD_AS(logInWithReadPermissionsAsync,
                    logInWithReadPermissionsWithConfig:(NSDictionary *)config
                    resolver:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  if (![FBSDKSettings appID]) {
    reject(ABI44_0_0EXFacebookMisconfiguredErrorDomain, @"No appId configured, required for initialization. Please ensure that you're either providing `appId` to `initializeAsync` as an argument or inside Info.plist.", nil);
    return;
  }
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    @try {
      [loginManager logInWithPermissions:permissions fromViewController:nil handler:^(FBSDKLoginManagerLoginResult *result, NSError *error) {
        if (error) {
          reject(ABI44_0_0EXFacebookLoginErrorDomain, @"Error with Facebook login", error);
          return;
        }
        ...
        NSMutableDictionary *accessToken = [NSMutableDictionary dictionaryWithDictionary:[ABI44_0_0EXFacebook accessTokenNativeToJSON:result.token]];
        accessToken[@"type"] = @"success";
        resolve(accessToken);
      }];
    } @catch (NSException *exception) {
      NSError *error = [[NSError alloc] initWithDomain:ABI44_0_0EXFacebookLoginErrorDomain code:650 userInfo:@{
...
ABI44_0_0EX_EXPORT_METHOD_AS(logEventAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(logPurchaseAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(logPushNotificationOpenAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(setUserIDAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(getUserIDAsync,
                    getUserID:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  resolve([FBSDKAppEvents userID]);
}

ABI44_0_0EX_EXPORT_METHOD_AS(getAnonymousIDAsync,
                    getAnonymousID:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  @try {
...
ABI44_0_0EX_EXPORT_METHOD_AS(getAdvertiserIDAsync,
                    getAdvertiserID:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  @try {
...
ABI44_0_0EX_EXPORT_METHOD_AS(setUserDataAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(setFlushBehaviorAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(flushAsync,
                    flush:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
