...
@interface ABI44_0_0EXNotificationsEmitter ()
...
@implementation ABI44_0_0EXNotificationsEmitter

ABI44_0_0EX_EXPORT_MODULE(ExpoNotificationsEmitter);

ABI44_0_0EX_EXPORT_METHOD_AS(getLastNotificationResponseAsync,
                    getLastNotificationResponseAsyncWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve reject:(ABI44_0_0EXPromiseRejectBlock)reject)
{
...
{
  // Silence ABI44_0_0React Native warning: "Sending ... with no listeners registered."
...
{
  return [ABI44_0_0EXNotificationSerializer serializedNotification:notification];
}

- (NSDictionary *)serializedNotificationResponse:(UNNotificationResponse *)notificationResponse
{
  return [ABI44_0_0EXNotificationSerializer serializedNotificationResponse:notificationResponse];
}
