...
#define ABI44_0_0EX_UNVERSIONED(symbol) symbol

static NSString * const kEXDeviceInstallationUUIDKey = ABI44_0_0EX_UNVERSIONED(@"ABI44_0_0EXDeviceInstallationUUIDKey");
static NSString * const kEXDeviceInstallationUUIDLegacyKey = ABI44_0_0EX_UNVERSIONED(@"ABI44_0_0EXDeviceInstallUUIDKey");

static NSString * const kEXRegistrationInfoKey = ABI44_0_0EX_UNVERSIONED(@"ABI44_0_0EXNotificationRegistrationInfoKey");

@implementation ABI44_0_0EXServerRegistrationModule

ABI44_0_0EX_EXPORT_MODULE(NotificationsServerRegistrationModule)

ABI44_0_0EX_EXPORT_METHOD_AS(getInstallationIdAsync,
                    getInstallationIdAsyncWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve
...
ABI44_0_0EX_EXPORT_METHOD_AS(getRegistrationInfoAsync,
                    getRegistrationInfoAsyncWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve
                                                rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  CFTypeRef keychainResult = NULL;
...
ABI44_0_0EX_EXPORT_METHOD_AS(setRegistrationInfoAsync,
