...
#import <ABI44_0_0EXBattery/ABI44_0_0EXBattery.h>
#import <ABI44_0_0ExpoModulesCore/ABI44_0_0EXUtilities.h>

@interface ABI44_0_0EXBattery ()
...
@property (nonatomic, readonly) ABI44_0_0EXBatteryState batteryState;

@end

@implementation ABI44_0_0EXBattery

ABI44_0_0EX_EXPORT_MODULE(ExpoBattery);
...
ABI44_0_0EX_EXPORT_METHOD_AS(getBatteryLevelAsync,
                    getBatteryLevelAsyncWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  resolve(@(UIDevice.currentDevice.batteryLevel));
}

ABI44_0_0EX_EXPORT_METHOD_AS(getBatteryStateAsync,
                    getBatteryStateAsyncWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  resolve(@([self batteryState]));
}

ABI44_0_0EX_EXPORT_METHOD_AS(isLowPowerModeEnabledAsync,
                    isLowPowerModeEnabledAsyncWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  resolve(@(NSProcessInfo.processInfo.isLowPowerModeEnabled));
}

- (ABI44_0_0EXBatteryState)batteryState
{
  switch (UIDevice.currentDevice.batteryState) {
    case UIDeviceBatteryStateUnknown:
      return ABI44_0_0EXBatteryStateUnknown;
    case UIDeviceBatteryStateUnplugged:
      return ABI44_0_0EXBatteryStateUnplugged;
    case UIDeviceBatteryStateCharging:
      return ABI44_0_0EXBatteryStateCharging;
    case UIDeviceBatteryStateFull:
      return ABI44_0_0EXBatteryStateFull;
    default:
      return ABI44_0_0EXBatteryStateUnknown;
  }
}
