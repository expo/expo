...
@implementation ABI44_0_0EXScreenCaptureModule {
  UIView *_blockView;
}

ABI44_0_0EX_EXPORT_MODULE(ExpoScreenCapture);
...
ABI44_0_0EX_EXPORT_METHOD_AS(preventScreenCapture,
                    preventScreenCaptureWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve
...
ABI44_0_0EX_EXPORT_METHOD_AS(allowScreenCapture,
                    allowScreenCaptureWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve
