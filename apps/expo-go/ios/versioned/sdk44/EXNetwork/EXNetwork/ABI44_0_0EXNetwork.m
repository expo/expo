...
#import <ABI44_0_0EXNetwork/ABI44_0_0EXNetwork.h>
...
@implementation ABI44_0_0EXNetwork
...
- (instancetype)init
{
  self = [super init];
  if (self) {
    _type = ABI44_0_0EXNetworkTypeUnknown;
  }
  return self;
}

ABI44_0_0EX_EXPORT_MODULE(ExpoNetwork);
...
ABI44_0_0EX_EXPORT_METHOD_AS(getIpAddressAsync,
                    getIpAddressAsyncWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
...
ABI44_0_0EX_EXPORT_METHOD_AS(getNetworkStateAsync,
                    getNetworkStateAsyncWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  if ((flags & kSCNetworkReachabilityFlagsReachable) == 0 ||
    ...
    _type = ABI44_0_0EXNetworkTypeNone;
  }
  
#if !TARGET_OS_TV
  else if ((flags & kSCNetworkReachabilityFlagsIsWWAN) != 0) {
    _type = ABI44_0_0EXNetworkTypeCellular;
  }
#endif
  else {
    _type = ABI44_0_0EXNetworkTypeWifi;
  }
...
- (BOOL)connected
{
  return ![self.type isEqualToString:ABI44_0_0EXNetworkTypeUnknown] && ![self.type isEqualToString:ABI44_0_0EXNetworkTypeNone];
}
