...
@interface ABI44_0_0EXManifestsNewManifestTests : XCTestCase

@end

@implementation ABI44_0_0EXManifestsNewManifestTests
...
- (void)testSDKVersion_ValidCaseNumeric {
  ...
  ABI44_0_0EXManifestsNewManifest *manifest = [[ABI44_0_0EXManifestsNewManifest alloc] initWithRawManifestJSON:manifestJson];
