...
#import <ABI44_0_0EXLocation/ABI44_0_0EXLocation.h>
#import <ABI44_0_0EXLocation/ABI44_0_0EXLocationDelegate.h>
#import <ABI44_0_0EXLocation/ABI44_0_0EXLocationTaskConsumer.h>
#import <ABI44_0_0EXLocation/ABI44_0_0EXGeofencingTaskConsumer.h>
...
NSString * const ABI44_0_0EXLocationChangedEventName = @"Expo.locationChanged";
NSString * const ABI44_0_0EXHeadingChangedEventName = @"Expo.headingChanged";

@interface ABI44_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI44_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) NSMutableSet<ABI44_0_0EXLocationDelegate *> *retainedDelegates;
...
@property (nonatomic, weak) id<ABI44_0_0UMTaskManagerInterface> tasksManager;

@end

@implementation ABI44_0_0EXLocation

ABI44_0_0EX_EXPORT_MODULE(ExpoLocation);
...
- (void)setModuleRegistry:(ABI44_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  _tasksManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI44_0_0UMTaskManagerInterface)];
  ...
  [ABI44_0_0EXPermissionsMethodsDelegate registerRequesters:@[
    [ABI44_0_0EXLocationPermissionRequester new],
    [ABI44_0_0EXForegroundPermissionRequester new],
    [ABI44_0_0EXBackgroundLocationPermissionRequester new]
...
{
  return @[ABI44_0_0EXLocationChangedEventName, ABI44_0_0EXHeadingChangedEventName];
}
...
ABI44_0_0EX_EXPORT_METHOD_AS(getProviderStatusAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(getCurrentPositionAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  __block ABI44_0_0EXLocationDelegate *delegate;

  delegate = [[ABI44_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (delegate != nil) {
      if (locations.lastObject != nil) {
        resolve([ABI44_0_0EXLocation exportLocation:locations.lastObject]);
      } else {
...
ABI44_0_0EX_EXPORT_METHOD_AS(watchPositionImplAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  ABI44_0_0EXLocationDelegate *delegate = [[ABI44_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject != nil && weakSelf != nil) {
      ...
      NSDictionary *body = @{
                             @"watchId": watchId,
                             @"location": [ABI44_0_0EXLocation exportLocation:loc],
                             };

      [strongSelf->_eventEmitter sendEventWithName:ABI44_0_0EXLocationChangedEventName body:body];
    }
  } onUpdateHeadings:nil onError:^(NSError *error) {
    // TODO: report errors
...
ABI44_0_0EX_EXPORT_METHOD_AS(getLastKnownPositionAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  if ([self.class isLocation:location validWithOptions:options]) {
    resolve([ABI44_0_0EXLocation exportLocation:location]);
  } else {
    resolve([NSNull null]);
  }
}
...
ABI44_0_0EX_EXPORT_METHOD_AS(watchDeviceHeading,
  ...
  ABI44_0_0EXLocationDelegate *delegate = [[ABI44_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
    if (newHeading != nil && weakSelf != nil) {
      ...
      [strongSelf->_eventEmitter sendEventWithName:ABI44_0_0EXHeadingChangedEventName body:body];
    }
...
ABI44_0_0EX_EXPORT_METHOD_AS(removeWatchAsync,
                    watchId:(nonnull NSNumber *)watchId
                    resolver:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ABI44_0_0EXLocationDelegate *delegate = _delegates[watchId];
...
ABI44_0_0EX_EXPORT_METHOD_AS(geocodeAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(reverseGeocodeAsync,
    ...
    if (!error) {
      ...
      for (CLPlacemark* placemark in placemarks) {
        NSDictionary *address = @{
                                  @"city": ABI44_0_0UMNullIfNil(placemark.locality),
                                  @"district": ABI44_0_0UMNullIfNil(placemark.subLocality),
                                  @"streetNumber": ABI44_0_0UMNullIfNil(placemark.subThoroughfare),
                                  @"street": ABI44_0_0EXNullIfNil(placemark.thoroughfare),
                                  @"region": ABI44_0_0EXNullIfNil(placemark.administrativeArea),
                                  @"subregion": ABI44_0_0EXNullIfNil(placemark.subAdministrativeArea),
                                  @"country": ABI44_0_0EXNullIfNil(placemark.country),
                                  @"postalCode": ABI44_0_0EXNullIfNil(placemark.postalCode),
                                  @"name": ABI44_0_0EXNullIfNil(placemark.name),
                                  @"isoCountryCode": ABI44_0_0EXNullIfNil(placemark.ISOcountryCode),
                                  @"timezone": ABI44_0_0EXNullIfNil(placemark.timeZone.name),
                                  };
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  [ABI44_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI44_0_0EXLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
...
ABI44_0_0EX_EXPORT_METHOD_AS(getForegroundPermissionsAsync,
                    getForegroundPermissionsAsync:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  [ABI44_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI44_0_0EXForegroundPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI44_0_0EX_EXPORT_METHOD_AS(requestForegroundPermissionsAsync,
                    requestForegroundPermissionsAsync:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  [ABI44_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI44_0_0EXForegroundPermissionRequester class]
...
ABI44_0_0EX_EXPORT_METHOD_AS(getBackgroundPermissionsAsync,
                    getBackgroundPermissionsAsync:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  [ABI44_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI44_0_0EXBackgroundLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI44_0_0EX_EXPORT_METHOD_AS(requestBackgroundPermissionsAsync,
                    requestBackgroundPermissionsAsync:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  [ABI44_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI44_0_0EXBackgroundLocationPermissionRequester class]
...
ABI44_0_0EX_EXPORT_METHOD_AS(hasServicesEnabledAsync,
                    hasServicesEnabled:(ABI44_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI44_0_0EXPromiseRejectBlock)reject)
{
...
ABI44_0_0EX_EXPORT_METHOD_AS(startLocationUpdatesAsync,
                    ...
                    reject:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI44_0_0EXLocationTaskConsumer class] options:options];
  }
  @catch (NSException *e) {
...
ABI44_0_0EX_EXPORT_METHOD_AS(stopLocationUpdatesAsync,
                    ...
                    reject:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI44_0_0EXLocationTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI44_0_0EX_EXPORT_METHOD_AS(hasStartedLocationUpdatesAsync,
                    ...
                    reject:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI44_0_0EXLocationTaskConsumer class]]));
}

# pragma mark - Geofencing

ABI44_0_0EX_EXPORT_METHOD_AS(startGeofencingAsync,
                    ...
                    reject:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI44_0_0EXGeofencingTaskConsumer class] options:options];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI44_0_0EX_EXPORT_METHOD_AS(stopGeofencingAsync,
                    ...
                    reject:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI44_0_0EXGeofencingTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI44_0_0EX_EXPORT_METHOD_AS(hasStartedGeofencingAsync,
                    ...
                    reject:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI44_0_0EXGeofencingTaskConsumer class]]));
}
...
- (CLLocationManager *)locationManagerWithOptions:(nullable NSDictionary *)options
{
  ...
  if (options) {
    ...
    if (options[@"accuracy"]) {
      ABI44_0_0EXLocationAccuracy accuracy = [options[@"accuracy"] unsignedIntegerValue] ?: ABI44_0_0EXLocationAccuracyBalanced;
...
- (BOOL)checkForegroundPermissions:(ABI44_0_0EXPromiseRejectBlock)reject
{
  if (![CLLocationManager locationServicesEnabled]) {
    reject(@"E_LOCATION_SERVICES_DISABLED", @"Location services are disabled", nil);
    return NO;
  }
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI44_0_0EXForegroundPermissionRequester class]]) {
...
- (BOOL)checkBackgroundPermissions:(ABI44_0_0EXPromiseRejectBlock)reject
{
  if (![CLLocationManager locationServicesEnabled]) {
    reject(@"E_LOCATION_SERVICES_DISABLED", @"Location services are disabled", nil);
    return NO;
  }
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI44_0_0EXBackgroundLocationPermissionRequester class]]) {
...
- (BOOL)checkTaskManagerExists:(ABI44_0_0EXPromiseRejectBlock)reject
{
...
- (BOOL)checkBackgroundServices:(ABI44_0_0EXPromiseRejectBlock)reject
{
...
{
  switch (accuracy) {
    case ABI44_0_0EXLocationAccuracyLowest:
      return kCLLocationAccuracyThreeKilometers;
    case ABI44_0_0EXLocationAccuracyLow:
      return kCLLocationAccuracyKilometer;
    case ABI44_0_0EXLocationAccuracyBalanced:
      return kCLLocationAccuracyHundredMeters;
    case ABI44_0_0EXLocationAccuracyHigh:
      return kCLLocationAccuracyNearestTenMeters;
    case ABI44_0_0EXLocationAccuracyHighest:
      return kCLLocationAccuracyBest;
    case ABI44_0_0EXLocationAccuracyBestForNavigation:
