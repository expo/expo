//
//  ABI44_0_0EXFaceDetectorUtils.m
//  Exponent
//
...
NSString *const ABI44_0_0EXGMVDataOutputWidthKey = @"Width";
NSString *const ABI44_0_0EXGMVDataOutputHeightKey = @"Height";
...
@implementation ABI44_0_0EXFaceDetectorUtils
...
+ (ABI44_0_0EXFaceDetectionAngleTransformBlock)angleTransformerFromTransform:(CGAffineTransform)transform
{
  return ^(float angle) {
