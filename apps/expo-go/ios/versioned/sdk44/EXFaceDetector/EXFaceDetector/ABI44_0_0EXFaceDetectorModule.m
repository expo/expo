...
#import <ABI44_0_0EXFaceDetector/ABI44_0_0EXFaceDetectorModule.h>
#import <ABI44_0_0EXFaceDetector/ABI44_0_0EXFaceDetector.h>
...
#import <ABI44_0_0EXFaceDetector/ABI44_0_0EXFaceEncoder.h>
#import <ABI44_0_0EXFaceDetector/ABI44_0_0EXCSBufferOrientationCalculator.h>

@interface ABI44_0_0EXFaceDetectorModule ()

@property (nonatomic, weak) ABI44_0_0EXModuleRegistry *moduleRegistry;

@end

@implementation ABI44_0_0EXFaceDetectorModule
...
ABI44_0_0EX_EXPORT_MODULE(ExpoFaceDetector);

- (NSDictionary *)constantsToExport
{
  return [ABI44_0_0EXFaceDetectorUtils constantsToExport];
}
...
ABI44_0_0EX_EXPORT_METHOD_AS(detectFaces, detectFaces:(nonnull NSDictionary *)options resolver:(ABI44_0_0EXPromiseResolveBlock)resolve rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([fileSystem permissionsForURI:url] & ABI44_0_0EXFileSystemPermissionRead)) {
  ...
  @try {
    ...
    ciImage = [ciImage imageByApplyingOrientation:[ABI44_0_0EXFaceDetectorUtils toCGImageOrientation:image.imageOrientation]];
    ...
    ABI44_0_0EXFaceDetector* detector = [[ABI44_0_0EXFaceDetector alloc] initWithOptions: [ABI44_0_0EXFaceDetectorUtils mapOptions:options]];
    [detector detectFromImage:finalImage completionListener:^(NSArray<MLKFace *> * _Nullable faces, NSError * _Nullable error) {
      ...
      if(faces.count > 0) {
        ABI44_0_0EXFaceEncoder *encoder = [[ABI44_0_0EXFaceEncoder alloc] init];
      ...
      if (error != nil) {
        ...
        resolve(@{
                  ...
                  @"image" : @{
                      ...
                      @"orientation" : @([ABI44_0_0EXFaceDetectorModule exifOrientationFor:image.imageOrientation])
                      }
                  });
      }}];
