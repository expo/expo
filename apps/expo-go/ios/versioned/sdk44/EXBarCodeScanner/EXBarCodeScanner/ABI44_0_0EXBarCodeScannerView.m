...
@interface ABI44_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI44_0_0EXBarCodeScanner *barCodeScanner;
...
@implementation ABI44_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI44_0_0EXModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI44_0_0EXAppLifecycleListener)];
...
{
  ABI44_0_0EX_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI44_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI44_0_0EXBareCodeCameraRequester class]]) {
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI44_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI44_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI44_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI44_0_0EXBarCodeScanner *barCodeScanner = [ABI44_0_0EXBarCodeScanner new];
