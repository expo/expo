...
public final class SwiftInteropBridge: NSObject {
  ...
  @objc
  public init(modulesProvider: ModulesProviderObjCProtocol, legacyModuleRegistry: ABI44_0_0EXModuleRegistry) {
  ...
  public func callFunction(_ functionName: String,
                           ...
                           withArgs args: [Any],
                           resolve: @escaping ABI44_0_0EXPromiseResolveBlock,
                           reject: @escaping ABI44_0_0EXPromiseRejectBlock) {
    registry
