...
/**
 Internal `ABI44_0_0EXReactDelegateWrapper` interface for the designated initializer with `ExpoReactDelegate`.
 ...
 */
@interface ABI44_0_0EXReactDelegateWrapper(Private)
