#import <ABI44_0_0EXAdsFacebook/ABI44_0_0EXInterstitialAdManager.h>
#import <ABI44_0_0ExpoModulesCore/ABI44_0_0EXUtilities.h>

#import <FBAudienceNetwork/FBAudienceNetwork.h>

@interface ABI44_0_0EXInterstitialAdManager () <FBInterstitialAdDelegate>
...
@implementation ABI44_0_0EXInterstitialAdManager

ABI44_0_0EX_EXPORT_MODULE(CTKInterstitialAdManager)
...
{
  [_interstitialAd showAdFromRootViewController:[[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI44_0_0EXUtilitiesInterface)] currentViewController]];
}
...
- (void)bridgeDidForeground:(NSNotification *)notification
{
  ...
  if (_adViewController) {
    [[[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI44_0_0EXUtilitiesInterface)] currentViewController] presentViewController:_adViewController animated:NO completion:nil];
...
- (void)bridgeDidBackground:(NSNotification *)notification
{
  ...
  if (_interstitialAd) {
    _adViewController = [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI44_0_0EXUtilitiesInterface)] currentViewController];
