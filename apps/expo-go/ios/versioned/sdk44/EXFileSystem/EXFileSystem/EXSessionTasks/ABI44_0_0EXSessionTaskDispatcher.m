...
#import <ABI44_0_0EXFileSystem/ABI44_0_0EXSessionTaskDispatcher.h>
#import <ABI44_0_0EXFileSystem/ABI44_0_0EXSessionResumableDownloadTaskDelegate.h>

@interface ABI44_0_0EXSessionTaskDispatcher ()

@property (nonatomic, strong) NSMutableDictionary<NSURLSessionTask *, ABI44_0_0EXSessionTaskDelegate *> *tasks;
@property (nonatomic) BOOL isActive;
@property (nonatomic, weak) id<ABI44_0_0EXSessionHandler> sessionHandler;

@end

@implementation ABI44_0_0EXSessionTaskDispatcher
...
{
  if (_isActive) {
    ABI44_0_0EXSessionTaskDelegate *exTask = _tasks[downloadTask];
    if (exTask) {
...
{
  if (_isActive) {
    ABI44_0_0EXSessionTaskDelegate *exTask = _tasks[task];
    if (exTask) {
...
{
  if (_isActive) {
    ABI44_0_0EXSessionTaskDelegate *exTask = _tasks[dataTask];
