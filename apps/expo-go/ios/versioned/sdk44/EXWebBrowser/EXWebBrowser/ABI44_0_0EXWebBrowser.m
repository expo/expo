...
#import <ABI44_0_0EXWebBrowser/ABI44_0_0EXWebBrowser.h>
...
@interface ABI44_0_0EXWebBrowser () <SFSafariViewControllerDelegate>

@property (nonatomic, copy) ABI44_0_0EXPromiseResolveBlock redirectResolve;
@property (nonatomic, copy) ABI44_0_0EXPromiseRejectBlock redirectReject;
...
@implementation ABI44_0_0EXWebBrowser
{
  UIStatusBarStyle _initialStatusBarStyle;
}

ABI44_0_0EX_EXPORT_MODULE(ExpoWebBrowser)
...
ABI44_0_0EX_EXPORT_METHOD_AS(openAuthSessionAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(openBrowserAsync,
                    ...
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  ...
  if([[arguments allKeys] containsObject:WebBrowserToolbarColorKey]) {
    safariVC.preferredBarTintColor = [ABI44_0_0EXWebBrowser convertHexColorString:arguments[WebBrowserToolbarColorKey]];
  }
  if([[arguments allKeys] containsObject:WebBrowserControlsColorKey]) {
    safariVC.preferredControlTintColor = [ABI44_0_0EXWebBrowser convertHexColorString:arguments[WebBrowserControlsColorKey]];
  }
...
ABI44_0_0EX_EXPORT_METHOD_AS(dismissBrowser,
                    dismissBrowserWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  __weak typeof(self) weakSelf = self;
  UIViewController *currentViewController = [UIApplication sharedApplication].keyWindow.rootViewController;
...
ABI44_0_0EX_EXPORT_METHOD_AS(dismissAuthSession,
                    dismissAuthSessionWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  if (@available(iOS 11, *)) {
    [_authSession cancel];
...
ABI44_0_0EX_EXPORT_METHOD_AS(warmUpAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(coolDownAsync,
...
ABI44_0_0EX_EXPORT_METHOD_AS(getCustomTabsSupportingBrowsers,
                    getCustomTabsSupportingBrowsersWithPackage:(ABI44_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI44_0_0EXPromiseRejectBlock)reject)
{
  // stub for jest-expo-mock-generator
}

ABI44_0_0EX_EXPORT_METHOD_AS(mayInitWithUrlAsync,
 ...
 */
- (BOOL)initializeWebBrowserWithResolver:(ABI44_0_0EXPromiseResolveBlock)resolve andRejecter:(ABI44_0_0EXPromiseRejectBlock)reject {
  if (_redirectResolve) {
...
+ (UIColor *)convertHexColorString:(NSString *)stringToConvert {
  ...
  return [ABI44_0_0EXWebBrowser colorWithRGBHex:hexNum];
}
