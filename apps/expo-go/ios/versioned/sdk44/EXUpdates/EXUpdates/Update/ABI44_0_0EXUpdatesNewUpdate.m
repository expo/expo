...
#import <ABI44_0_0EXStructuredHeaders/ABI44_0_0EXStructuredHeadersParser.h>
                                  ...
                                  database:(ABI44_0_0EXUpdatesDatabase *)database
{
  ...
  update.commitTime = [ABI44_0_0RCTConvert NSDate:(NSString *)commitTime];
...
+ (nullable NSDictionary *)dictionaryWithStructuredHeader:(NSString *)headerString
{
  ...
  ABI44_0_0EXStructuredHeadersParser *parser = [[ABI44_0_0EXStructuredHeadersParser alloc] initWithRawInput:headerString fieldType:ABI44_0_0EXStructuredHeadersParserFieldTypeDictionary ignoringParameters:YES];
  NSError *error;
