...
@implementation ABI44_0_0EXUpdatesBareUpdate
                                      ...
                                      database:(ABI44_0_0EXUpdatesDatabase *)database
{
  ...
  ABI44_0_0EXUpdatesAsset *jsBundleAsset = [[ABI44_0_0EXUpdatesAsset alloc] initWithKey:bundleKey type:ABI44_0_0EXUpdatesBareEmbeddedBundleFileType];
  jsBundleAsset.isLaunchAsset = YES;
  jsBundleAsset.mainBundleFilename = ABI44_0_0EXUpdatesBareEmbeddedBundleFilename;
  ...
  update.runtimeVersion = [ABI44_0_0EXUpdatesUtils getRuntimeVersionWithConfig:config];
  update.status = ABI44_0_0EXUpdatesUpdateStatusEmbedded;
  update.keep = YES;
  update.assets = processedAssets;

  if ([update.runtimeVersion containsString:@","]) {
    @throw [NSException exceptionWithName:NSInternalInconsistencyException
                                   reason:@"Should not be initializing ABI44_0_0EXUpdatesBareUpdate in an environment with multiple runtime versions."
                                 userInfo:@{}];
  }
