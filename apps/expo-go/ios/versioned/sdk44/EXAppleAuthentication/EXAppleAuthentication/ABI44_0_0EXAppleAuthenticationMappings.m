...
@implementation ABI44_0_0EXAppleAuthenticationMappings
...
{
  return @{
           @"namePrefix": ABI44_0_0EXNullIfNil(nameComponents.namePrefix),
           @"givenName": ABI44_0_0EXNullIfNil(nameComponents.givenName),
           @"middleName": ABI44_0_0EXNullIfNil(nameComponents.middleName),
           @"familyName": ABI44_0_0EXNullIfNil(nameComponents.familyName),
           @"nameSuffix": ABI44_0_0EXNullIfNil(nameComponents.nameSuffix),
           @"nickname": ABI44_0_0EXNullIfNil(nameComponents.nickname)
           };
}
