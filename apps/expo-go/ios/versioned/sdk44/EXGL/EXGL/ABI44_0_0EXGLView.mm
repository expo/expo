...
@implementation ABI44_0_0EXGLView
...
- (instancetype)initWithModuleRegistry:(ABI44_0_0EXModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    self.contentScaleFactor = [ABI44_0_0EXUtilities screenScale];
    ...
    _glContext = [[ABI44_0_0EXGLContext alloc] initWithDelegate:self andModuleRegistry:moduleRegistry];
...
- (void)setOnSurfaceCreate:(ABI44_0_0EXDirectEventBlock)onSurfaceCreate
{
...
- (void)draw
{
  ...
  // called on the JS thread to create the ABI44_0_0EXGL context and save its id (see ABI44_0_0EXGLContext.initializeContextWithBridge method).
...
#pragma mark - ABI44_0_0EXGLContextDelegate
