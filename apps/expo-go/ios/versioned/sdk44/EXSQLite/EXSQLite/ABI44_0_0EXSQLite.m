...
#import <ABI44_0_0EXSQLite/ABI44_0_0EXSQLite.h>

#import <ABI44_0_0ExpoModulesCore/ABI44_0_0EXFileSystemInterface.h>

#import <sqlite3.h>

@interface ABI44_0_0EXSQLite ()
...
@implementation ABI44_0_0EXSQLite
...
ABI44_0_0EX_EXPORT_MODULE(ExponentSQLite);
...
- (NSString *)pathForDatabaseName:(NSString *)name
{
  ...
  if (!fileSystem) {
    ABI44_0_0EXLogError(@"No FileSystem module.");
    return nil;
  }
...
ABI44_0_0EX_EXPORT_METHOD_AS(exec,
...
ABI44_0_0EX_EXPORT_METHOD_AS(close,
                 ...
                 withDb:(sqlite3*)db withReadOnly:(BOOL)readOnly
{
  ...
  if (sqlite3_prepare_v2(db, [sql UTF8String], -1, &statement, NULL) != SQLITE_OK) {
    error = [ABI44_0_0EXSQLite convertSQLiteErrorToString:db];
    return @[error];
  }
