...
#import <ABI43_0_0EXCrypto/ABI43_0_0EXCrypto.h>
#import <CommonCrypto/CommonDigest.h>

@implementation ABI43_0_0EXCrypto

ABI43_0_0EX_EXPORT_MODULE(ExpoCrypto);

ABI43_0_0EX_EXPORT_METHOD_AS(digestStringAsync,
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  int digestLength = [ABI43_0_0EXCrypto digestLengthForJSAlgorithm:algorithm];
  if (digestLength == -1) {
