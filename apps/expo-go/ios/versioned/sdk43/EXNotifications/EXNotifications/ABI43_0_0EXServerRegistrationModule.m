...
ABI43_0_0EX_EXPORT_MODULE(NotificationsServerRegistrationModule)

ABI43_0_0EX_EXPORT_METHOD_AS(getInstallationIdAsync,
                    getInstallationIdAsyncWithResolver:(ABI43_0_0EXPromiseResolveBlock)resolve
...
ABI43_0_0EX_EXPORT_METHOD_AS(getRegistrationInfoAsync,
                    getRegistrationInfoAsyncWithResolver:(ABI43_0_0EXPromiseResolveBlock)resolve
                                                rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  CFTypeRef keychainResult = NULL;
...
ABI43_0_0EX_EXPORT_METHOD_AS(setRegistrationInfoAsync,
