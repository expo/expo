...
#import <ABI43_0_0EXNotifications/ABI43_0_0EXPushTokenManager.h>
#import <ABI43_0_0ExpoModulesCore/ABI43_0_0EXDefines.h>

@interface ABI43_0_0EXPushTokenManager ()

@property (nonatomic, strong) NSPointerArray *listeners;

@end

@implementation ABI43_0_0EXPushTokenManager

ABI43_0_0EX_REGISTER_SINGLETON_MODULE(PushTokenManager);
