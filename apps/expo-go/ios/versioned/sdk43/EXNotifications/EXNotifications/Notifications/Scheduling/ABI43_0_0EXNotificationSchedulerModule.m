...
#import <ABI43_0_0EXNotifications/NSDictionary+ABI43_0_0EXNotificationsVerifyingClass.h>
...
@interface ABI43_0_0EXNotificationSchedulerModule ()

@property (nonatomic, weak) id<ABI43_0_0EXNotificationBuilder> builder;

@end

@implementation ABI43_0_0EXNotificationSchedulerModule

ABI43_0_0EX_EXPORT_MODULE(ExpoNotificationScheduler);

- (void)setModuleRegistry:(ABI43_0_0EXModuleRegistry *)moduleRegistry
{
  _builder = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI43_0_0EXNotificationBuilder)];
}

# pragma mark - Exported methods

ABI43_0_0EX_EXPORT_METHOD_AS(getAllScheduledNotificationsAsync,
                    getAllScheduledNotifications:(ABI43_0_0EXPromiseResolveBlock)resolve reject:(ABI43_0_0EXPromiseRejectBlock)reject
                    )
{
...
ABI43_0_0EX_EXPORT_METHOD_AS(scheduleNotificationAsync,
                     scheduleNotification:(NSString *)identifier notificationSpec:(NSDictionary *)notificationSpec triggerSpec:(NSDictionary *)triggerSpec resolve:(ABI43_0_0EXPromiseResolveBlock)resolve rejecting:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  @try {
...
ABI43_0_0EX_EXPORT_METHOD_AS(cancelScheduledNotificationAsync,
                     cancelNotification:(NSString *)identifier resolve:(ABI43_0_0EXPromiseResolveBlock)resolve rejecting:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  [[UNUserNotificationCenter currentNotificationCenter] removePendingNotificationRequestsWithIdentifiers:@[identifier]];
  resolve(nil);
}

ABI43_0_0EX_EXPORT_METHOD_AS(cancelAllScheduledNotificationsAsync,
                     cancelAllNotificationsWithResolver:(ABI43_0_0EXPromiseResolveBlock)resolve rejecting:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  [[UNUserNotificationCenter currentNotificationCenter] removeAllPendingNotificationRequests];
  resolve(nil);
}

ABI43_0_0EX_EXPORT_METHOD_AS(getNextTriggerDateAsync,
                    getNextTriggerDate:(NSDictionary *)triggerSpec resolve:(ABI43_0_0EXPromiseResolveBlock)resolve rejecting:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  @try {
...
- (NSArray * _Nonnull)serializeNotificationRequests:(NSArray<UNNotificationRequest *> * _Nonnull) requests
{
  ...
  for (UNNotificationRequest *request in requests) {
    [serializedRequests addObject:[ABI43_0_0EXNotificationSerializer serializedNotificationRequest:request]];
  }
