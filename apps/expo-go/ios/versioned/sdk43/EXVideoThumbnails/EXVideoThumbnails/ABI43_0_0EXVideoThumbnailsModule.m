...
#import <ABI43_0_0EXVideoThumbnails/ABI43_0_0EXVideoThumbnailsModule.h>
...
@implementation ABI43_0_0EXVideoThumbnailsModule

ABI43_0_0EX_EXPORT_MODULE(ExpoVideoThumbnails);
...
ABI43_0_0EX_EXPORT_METHOD_AS(getThumbnail,
                    ...
                    reject:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  if ([url isFileURL]) {
    ...
    if (!([_fileSystem permissionsForURI:url] & ABI43_0_0EXFileSystemPermissionRead)) {
