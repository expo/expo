...
@interface ABI43_0_0EXManifestsNewManifestTests : XCTestCase

@end

@implementation ABI43_0_0EXManifestsNewManifestTests
...
- (void)testSDKVersion_ValidCaseNumeric {
  ...
  ABI43_0_0EXManifestsNewManifest *manifest = [[ABI43_0_0EXManifestsNewManifest alloc] initWithRawManifestJSON:manifestJson];
