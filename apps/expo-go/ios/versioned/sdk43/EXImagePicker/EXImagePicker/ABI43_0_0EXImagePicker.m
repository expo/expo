#import <ABI43_0_0EXImagePicker/ABI43_0_0EXImagePicker.h>
...
const CGFloat ABI43_0_0EXDefaultImageQuality = 0.2;

@interface ABI43_0_0EXImagePicker ()
...
@implementation ABI43_0_0EXImagePicker

ABI43_0_0EX_EXPORT_MODULE(ExponentImagePicker);
...
- (void)setModuleRegistry:(ABI43_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  _permissionsManager = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI43_0_0EXPermissionsInterface)];
  [ABI43_0_0EXPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI43_0_0EXImagePickerCameraPermissionRequester new],
                                                    [ABI43_0_0EXImagePickerMediaLibraryPermissionRequester new],
                                                    [ABI43_0_0EXImagePickerMediaLibraryWriteOnlyPermissionRequester new]
                                                    ]
...
{
  if (writeOnly) {
    return [ABI43_0_0EXImagePickerMediaLibraryWriteOnlyPermissionRequester class];
  } else {
    return [ABI43_0_0EXImagePickerMediaLibraryPermissionRequester class];
  }
}
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  [ABI43_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI43_0_0EXImagePickerCameraPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI43_0_0EX_EXPORT_METHOD_AS(getMediaLibraryPermissionsAsync,
...
ABI43_0_0EX_EXPORT_METHOD_AS(requestMediaLibraryPermissionsAsync,
...
ABI43_0_0EX_EXPORT_METHOD_AS(launchCameraAsync, launchCameraAsync:(NSDictionary *)options
                  resolver:(ABI43_0_0EXPromiseResolveBlock)resolve
                  rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  BOOL permissionsAreGranted = [self hasCameraRollPermission] &&
                               [self.permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI43_0_0EXImagePickerCameraPermissionRequester class]];
  ...
  self.reject = reject;
  [self launchImagePicker:ABI43_0_0EXImagePickerTargetCamera options:options];
}

ABI43_0_0EX_EXPORT_METHOD_AS(launchImageLibraryAsync, launchImageLibraryAsync:(NSDictionary *)options
                  resolver:(ABI43_0_0EXPromiseResolveBlock)resolve
                  rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  if (!_permissionsManager) {
  ...
  self.resolve = resolve;
  self.reject = reject;
  [self launchImagePicker:ABI43_0_0EXImagePickerTargetLibrarySingleImage options:options];
}

- (void)launchImagePicker:(ABI43_0_0EXImagePickerTarget)target options:(NSDictionary *)options
{
...
- (void)launchImagePicker:(ABI43_0_0EXImagePickerTarget)target
{
  dispatch_async(dispatch_get_main_queue(), ^{
    self.picker = [UIImagePickerController new];

    if (target == ABI43_0_0EXImagePickerTargetCamera) {
    ...
    id<ABI43_0_0EXUtilitiesInterface> utils = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI43_0_0EXUtilitiesInterface)];
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
  dispatch_block_t dismissCompletionBlock = ^{
    ...
    id<ABI43_0_0EXFileSystemInterface> fileSystem = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI43_0_0EXFileSystemInterface)];
    if (!fileSystem) {
          ...
          completionHandler:(void (^)(void))completionHandler
{
  ...
  NSData *data = UIImageJPEGRepresentation(image, quality == nil ? ABI43_0_0EXDefaultImageQuality : [quality floatValue]);
  ...
  if ([[self.options objectForKey:@"exif"] boolValue]) {
    ...
    if (metadata) {
      ...
      if (!asset) {
        ABI43_0_0EXLogInfo(@"Could not fetch metadata for image %@", [imageURL absoluteString]);
        completionHandler();
      }
...
- (BOOL)hasCameraRollPermission
{
  ...
  return [_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI43_0_0EXImagePickerMediaLibraryPermissionRequester class]];
}
