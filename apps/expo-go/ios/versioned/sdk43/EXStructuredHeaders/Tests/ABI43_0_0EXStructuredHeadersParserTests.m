...
#import "ABI43_0_0EXStructuredHeadersTestFixtures.h"
#import "NSArray+ABI43_0_0EXStructuredHeadersTests.h"
#import "NSDictionary+ABI43_0_0EXStructuredHeadersTests.h"

@interface ABI43_0_0EXStructuredHeadersParserTests : XCTestCase

@end

@implementation ABI43_0_0EXStructuredHeadersParserTests
...
- (void)runTests:(NSString *)testsJson
{
  ...
  for (NSDictionary *test in tests) {
    ...
    ABI43_0_0EXStructuredHeadersParser *parser = [[ABI43_0_0EXStructuredHeadersParser alloc] initWithRawInput:rawInput fieldType:[self fieldTypeWithString:test[@"header_type"]]];
...
- (ABI43_0_0EXStructuredHeadersParserFieldType)fieldTypeWithString:(NSString *)string
{
  if ([@"dictionary" isEqualToString:string]) {
    return ABI43_0_0EXStructuredHeadersParserFieldTypeDictionary;
  } else if ([@"list" isEqualToString:string]) {
    return ABI43_0_0EXStructuredHeadersParserFieldTypeList;
  } else if ([@"item" isEqualToString:string]) {
    return ABI43_0_0EXStructuredHeadersParserFieldTypeItem;
  } else {
...
- (void)testBinary
{
  [self runTests:ABI43_0_0EXStructuredHeadersBinaryTests];
}

- (void)testBoolean
{
  [self runTests:ABI43_0_0EXStructuredHeadersBooleanTests];
}

- (void)testDictionary
{
  [self runTests:ABI43_0_0EXStructuredHeadersDictionaryTests];
}

- (void)testExamples
{
  [self runTests:ABI43_0_0EXStructuredHeadersExamplesTests];
}

- (void)testItem
{
  [self runTests:ABI43_0_0EXStructuredHeadersItemTests];
}

- (void)testKeyGenerated
{
  [self runTests:ABI43_0_0EXStructuredHeadersKeyGeneratedTests];
}

- (void)testLargeGenerated
{
  [self runTests:ABI43_0_0EXStructuredHeadersLargeGeneratedTests];
}

- (void)testList
{
  [self runTests:ABI43_0_0EXStructuredHeadersListTests];
}

- (void)testListlist
{
  [self runTests:ABI43_0_0EXStructuredHeadersListlistTests];
}

- (void)testNumberGenerated
{
  [self runTests:ABI43_0_0EXStructuredHeadersNumberGeneratedTests];
}

- (void)testNumber
{
  [self runTests:ABI43_0_0EXStructuredHeadersNumberTests];
}

- (void)testParamDict
{
  [self runTests:ABI43_0_0EXStructuredHeadersParamDictTests];
}

- (void)testParamList
{
  [self runTests:ABI43_0_0EXStructuredHeadersParamListTests];
}

- (void)testParamListlist
{
  [self runTests:ABI43_0_0EXStructuredHeadersParamListlistTests];
}

- (void)testStringGenerated
{
  [self runTests:ABI43_0_0EXStructuredHeadersStringGeneratedTests];
}

- (void)testString
{
  [self runTests:ABI43_0_0EXStructuredHeadersStringTests];
}

- (void)testTokenGenerated
{
  [self runTests:ABI43_0_0EXStructuredHeadersTokenGeneratedTests];
}

- (void)testToken
{
  [self runTests:ABI43_0_0EXStructuredHeadersTokenTests];
}
