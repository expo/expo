...
#import <ABI43_0_0EXSecureStore/ABI43_0_0EXSecureStore.h>

#import <CommonCrypto/CommonHMAC.h>
#import <Security/Security.h>

@implementation ABI43_0_0EXSecureStore
...
- (CFStringRef)_accessibilityAttributeWithOptions:(NSDictionary *)options
{
  ...
  switch (accessibility) {
    case ABI43_0_0EXSecureStoreAccessibleAfterFirstUnlock:
      return kSecAttrAccessibleAfterFirstUnlock;
    case ABI43_0_0EXSecureStoreAccessibleAfterFirstUnlockThisDeviceOnly:
      return kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly;
    case ABI43_0_0EXSecureStoreAccessibleAlways:
      return kSecAttrAccessibleAlways;
    case ABI43_0_0EXSecureStoreAccessibleWhenPasscodeSetThisDeviceOnly:
      return kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly;
    case ABI43_0_0EXSecureStoreAccessibleWhenUnlocked:
      return kSecAttrAccessibleWhenUnlocked;
    case ABI43_0_0EXSecureStoreAccessibleAlwaysThisDeviceOnly:
      return kSecAttrAccessibleAlwaysThisDeviceOnly;
    case ABI43_0_0EXSecureStoreAccessibleWhenUnlockedThisDeviceOnly:
...
{
  return @{
           @"AFTER_FIRST_UNLOCK":@(ABI43_0_0EXSecureStoreAccessibleAfterFirstUnlock),
           @"AFTER_FIRST_UNLOCK_THIS_DEVICE_ONLY":@(ABI43_0_0EXSecureStoreAccessibleAfterFirstUnlockThisDeviceOnly),
           @"ALWAYS":@(ABI43_0_0EXSecureStoreAccessibleAlways),
           @"WHEN_PASSCODE_SET_THIS_DEVICE_ONLY":@(ABI43_0_0EXSecureStoreAccessibleWhenPasscodeSetThisDeviceOnly),
           @"ALWAYS_THIS_DEVICE_ONLY":@(ABI43_0_0EXSecureStoreAccessibleAlwaysThisDeviceOnly),
           @"WHEN_UNLOCKED":@(ABI43_0_0EXSecureStoreAccessibleWhenUnlocked),
           @"WHEN_UNLOCKED_THIS_DEVICE_ONLY":@(ABI43_0_0EXSecureStoreAccessibleWhenUnlockedThisDeviceOnly)
           };
};

ABI43_0_0EX_EXPORT_MODULE(ExpoSecureStore);

ABI43_0_0EX_EXPORT_METHOD_AS(setValueWithKeyAsync,
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!validatedKey) {
    reject(@"E_SECURESTORE_SETVALUEFAIL", nil, ABI43_0_0EXErrorWithMessage(@"Invalid key."));
  } else {
    NSError *error;
    ...
    if (setValue) {
      ...
      reject(@"E_SECURESTORE_SETVALUEFAIL", nil, ABI43_0_0EXErrorWithMessage([[self class] _messageForError:error]));
    }
  }
}

ABI43_0_0EX_EXPORT_METHOD_AS(getValueWithKeyAsync,
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  NSString *validatedKey = [self validatedKey:key];
  if (!validatedKey) {
    reject(@"E_SECURESTORE_GETVALUEFAIL", nil, ABI43_0_0EXErrorWithMessage(@"Invalid key."));
  } else {
    NSError *error;
    ...
    if (error) {
      if (error.code == errSecItemNotFound) {
        ...
        reject(@"E_SECURESTORE_GETVALUEFAIL", nil, ABI43_0_0EXErrorWithMessage([[self class] _messageForError:error]));
      }
    } else {
      resolve(value);
    }
...
ABI43_0_0EX_EXPORT_METHOD_AS(deleteValueWithKeyAsync,
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  NSString *validatedKey = [self validatedKey:key];
  if (!validatedKey) {
    reject(@"E_SECURESTORE_DELETEVALUEFAIL", nil, ABI43_0_0EXErrorWithMessage(@"Invalid key."));
  } else {
