...
#import <ABI43_0_0EXSensors/ABI43_0_0EXDeviceMotion.h>
#import <ABI43_0_0ExpoModulesCore/ABI43_0_0EXDeviceMotionInterface.h>

@implementation ABI43_0_0EXDeviceMotion

ABI43_0_0EX_EXPORT_MODULE(ExponentDeviceMotion);
...
{
  return [moduleRegistry getModuleImplementingProtocol:@protocol(ABI43_0_0EXDeviceMotionInterface)];
}
