...
@interface ABI43_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) id<ABI43_0_0EXCameraInterface> camera;
...
@implementation ABI43_0_0EXGLCameraObject
