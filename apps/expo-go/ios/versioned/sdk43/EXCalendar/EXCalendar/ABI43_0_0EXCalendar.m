...
#import <ABI43_0_0EXCalendar/ABI43_0_0EXCalendar.h>
#import <ABI43_0_0EXCalendar/ABI43_0_0EXCalendarConverter.h>
#import <ABI43_0_0EXCalendar/ABI43_0_0EXCalendarPermissionRequester.h>
...
@implementation ABI43_0_0EXCalendar
...
ABI43_0_0EX_EXPORT_MODULE(ExpoCalendar);
...
- (void)setModuleRegistry:(ABI43_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  [ABI43_0_0EXPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI43_0_0EXCalendarPermissionRequester new],
                                                    [ABI43_0_0EXRemindersPermissionRequester new]
                                                    ]
...
ABI43_0_0EX_EXPORT_METHOD_AS(getCalendarsAsync,
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve([ABI43_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI43_0_0EX_EXPORT_METHOD_AS(getDefaultCalendarAsync,
                    getDefaultCalendarAsync:(ABI43_0_0EXPromiseResolveBlock)resolve
                    rejector:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  if (![self _checkCalendarPermissions:reject]) {
    return;
  }
  ...
  resolve([ABI43_0_0EXCalendarConverter serializeCalendar:defaultCalendar]);
}

ABI43_0_0EX_EXPORT_METHOD_AS(saveCalendarAsync,
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (color) {
    calendar.CGColor = [ABI43_0_0EXUtilities UIColor:color].CGColor;
...
ABI43_0_0EX_EXPORT_METHOD_AS(deleteCalendarAsync,
...
ABI43_0_0EX_EXPORT_METHOD_AS(getEventsAsync,
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI43_0_0EXUtilities NSDate:startDateStr];
  NSDate *endDate = [ABI43_0_0EXUtilities NSDate:endDateStr];
  ...
  if (calendarEvents) {
    resolve([ABI43_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI43_0_0EX_EXPORT_METHOD_AS(getEventByIdAsync,
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (calendarEvent) {
    resolve([ABI43_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI43_0_0EX_EXPORT_METHOD_AS(saveEventAsync,
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI43_0_0EXUtilities NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI43_0_0EXUtilities NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI43_0_0EXUtilities NSDate:details[@"instanceStartDate"]];
...
ABI43_0_0EX_EXPORT_METHOD_AS(deleteEventAsync,
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *instanceStartDate = [ABI43_0_0EXUtilities NSDate:event[@"instanceStartDate"]];
...
ABI43_0_0EX_EXPORT_METHOD_AS(getAttendeesForEventAsync,
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (item.hasAttendees) {
    resolve([ABI43_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI43_0_0EX_EXPORT_METHOD_AS(getRemindersAsync,
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI43_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI43_0_0EX_EXPORT_METHOD_AS(getReminderByIdAsync,
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (reminder) {
    ...
    resolve([ABI43_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI43_0_0EX_EXPORT_METHOD_AS(saveReminderAsync,
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI43_0_0EXUtilities NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI43_0_0EXUtilities NSDate:details[@"dueDate"]];
  NSDate *completionDate = [ABI43_0_0EXUtilities NSDate:details[@"completionDate"]];
...
ABI43_0_0EX_EXPORT_METHOD_AS(deleteReminderAsync,
...
ABI43_0_0EX_EXPORT_METHOD_AS(getSourcesAsync,
                    getSourcesAsync:(ABI43_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI43_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI43_0_0EX_EXPORT_METHOD_AS(getSourceByIdAsync,
                    ...
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve([ABI43_0_0EXCalendarConverter serializeSource:source]);
}

ABI43_0_0EX_EXPORT_METHOD_AS(getCalendarPermissionsAsync,
                    getCalendarPermissionsAsync:(ABI43_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  [ABI43_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI43_0_0EXCalendarPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI43_0_0EX_EXPORT_METHOD_AS(requestCalendarPermissionsAsync,
                    requestCalendarPermissionsAsync:(ABI43_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
...
ABI43_0_0EX_EXPORT_METHOD_AS(getRemindersPermissionsAsync,
                    getRemindersPermissionsAsync:(ABI43_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  [ABI43_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI43_0_0EXRemindersPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI43_0_0EX_EXPORT_METHOD_AS(requestRemindersPermissionsAsync,
                    requestRemindersPermissionsAsync:(ABI43_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI43_0_0EXPromiseRejectBlock)reject)
{
  [ABI43_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI43_0_0EXRemindersPermissionRequester class]
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI43_0_0EXUtilities NSDate:alarm[@"absoluteDate"]];
...
- (EKRecurrenceRule *)_createRecurrenceRule:(NSDictionary *)recurrenceRule
{
  ...
  if (recurrenceRule[@"endDate"]) {
      endDate = [ABI43_0_0EXUtilities NSDate:recurrenceRule[@"endDate"]];
  }
...
- (BOOL)_checkPermissions:(EKEntityType)entity reject:(ABI43_0_0EXPromiseRejectBlock)reject
{
  ...
  switch (entity) {
    case EKEntityTypeEvent:
      requesterClass = [ABI43_0_0EXCalendarPermissionRequester class];
      break;
    case EKEntityTypeReminder:
      requesterClass = [ABI43_0_0EXRemindersPermissionRequester class];
      break;
    default: {
...
- (BOOL)_checkCalendarPermissions:(ABI43_0_0EXPromiseRejectBlock)reject
{
  return [self _checkPermissions:EKEntityTypeEvent reject:reject];
}

- (BOOL)_checkRemindersPermissions:(ABI43_0_0EXPromiseRejectBlock)reject
{
...
- (void)_initializePermittedEntities
{
  ...
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI43_0_0EXCalendarPermissionRequester class]]) {
    permittedEntities |= EKEntityMaskEvent;
  }
  
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI43_0_0EXRemindersPermissionRequester class]]) {
