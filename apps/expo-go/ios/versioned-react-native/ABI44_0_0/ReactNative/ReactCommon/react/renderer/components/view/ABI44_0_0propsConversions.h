...
static inline ABI44_0_0YGStyle::Dimensions convertRawProp(
    RawProps const &rawProps,
    char const *widthName,
    char const *heightName,
    ABI44_0_0YGStyle::Dimensions const &sourceValue,
    ABI44_0_0YGStyle::Dimensions const &defaultValue) {
  auto dimensions = defaultValue;
  dimensions[ABI44_0_0YGDimensionWidth] = convertRawProp(
      rawProps,
      widthName,
      sourceValue[ABI44_0_0YGDimensionWidth],
      defaultValue[ABI44_0_0YGDimensionWidth]);
  dimensions[ABI44_0_0YGDimensionHeight] = convertRawProp(
      rawProps,
      heightName,
      sourceValue[ABI44_0_0YGDimensionHeight],
      defaultValue[ABI44_0_0YGDimensionWidth]);
  return dimensions;
}

static inline ABI44_0_0YGStyle::Edges convertRawProp(
    RawProps const &rawProps,
    char const *prefix,
    char const *suffix,
    ABI44_0_0YGStyle::Edges const &sourceValue,
    ABI44_0_0YGStyle::Edges const &defaultValue) {
  auto result = defaultValue;
  result[ABI44_0_0YGEdgeLeft] = convertRawProp(
      rawProps,
      "Left",
      sourceValue[ABI44_0_0YGEdgeLeft],
      defaultValue[ABI44_0_0YGEdgeLeft],
      prefix,
      suffix);
  result[ABI44_0_0YGEdgeTop] = convertRawProp(
      rawProps,
      "Top",
      sourceValue[ABI44_0_0YGEdgeTop],
      defaultValue[ABI44_0_0YGEdgeTop],
      prefix,
      suffix);
  result[ABI44_0_0YGEdgeRight] = convertRawProp(
      rawProps,
      "Right",
      sourceValue[ABI44_0_0YGEdgeRight],
      defaultValue[ABI44_0_0YGEdgeRight],
      prefix,
      suffix);
  result[ABI44_0_0YGEdgeBottom] = convertRawProp(
      rawProps,
      "Bottom",
      sourceValue[ABI44_0_0YGEdgeBottom],
      defaultValue[ABI44_0_0YGEdgeBottom],
      prefix,
      suffix);
  result[ABI44_0_0YGEdgeStart] = convertRawProp(
      rawProps,
      "Start",
      sourceValue[ABI44_0_0YGEdgeStart],
      defaultValue[ABI44_0_0YGEdgeStart],
      prefix,
      suffix);
  result[ABI44_0_0YGEdgeEnd] = convertRawProp(
      rawProps,
      "End",
      sourceValue[ABI44_0_0YGEdgeEnd],
      defaultValue[ABI44_0_0YGEdgeEnd],
      prefix,
      suffix);
  result[ABI44_0_0YGEdgeHorizontal] = convertRawProp(
      rawProps,
      "Horizontal",
      sourceValue[ABI44_0_0YGEdgeHorizontal],
      defaultValue[ABI44_0_0YGEdgeHorizontal],
      prefix,
      suffix);
  result[ABI44_0_0YGEdgeVertical] = convertRawProp(
      rawProps,
      "Vertical",
      sourceValue[ABI44_0_0YGEdgeVertical],
      defaultValue[ABI44_0_0YGEdgeVertical],
      prefix,
      suffix);
  result[ABI44_0_0YGEdgeAll] = convertRawProp(
      rawProps,
      "",
      sourceValue[ABI44_0_0YGEdgeAll],
      defaultValue[ABI44_0_0YGEdgeAll],
      prefix,
      suffix);
  return result;
}
...
static inline ABI44_0_0YGStyle::Edges convertRawProp(
  ...
  auto result = defaultValue;
  result[ABI44_0_0YGEdgeLeft] = convertRawProp(
      rawProps, "left", sourceValue[ABI44_0_0YGEdgeLeft], defaultValue[ABI44_0_0YGEdgeLeft]);
  result[ABI44_0_0YGEdgeTop] = convertRawProp(
      rawProps, "top", sourceValue[ABI44_0_0YGEdgeTop], defaultValue[ABI44_0_0YGEdgeTop]);
  result[ABI44_0_0YGEdgeRight] = convertRawProp(
      rawProps, "right", sourceValue[ABI44_0_0YGEdgeRight], defaultValue[ABI44_0_0YGEdgeRight]);
  result[ABI44_0_0YGEdgeBottom] = convertRawProp(
      rawProps,
      "bottom",
      sourceValue[ABI44_0_0YGEdgeBottom],
      defaultValue[ABI44_0_0YGEdgeBottom]);
  result[ABI44_0_0YGEdgeStart] = convertRawProp(
      rawProps, "start", sourceValue[ABI44_0_0YGEdgeStart], defaultValue[ABI44_0_0YGEdgeStart]);
  result[ABI44_0_0YGEdgeEnd] = convertRawProp(
      rawProps, "end", sourceValue[ABI44_0_0YGEdgeEnd], defaultValue[ABI44_0_0YGEdgeEnd]);
  return result;
}

static inline ABI44_0_0YGStyle convertRawProp(
    RawProps const &rawProps,
    ABI44_0_0YGStyle const &sourceValue) {
  auto yogaStyle = ABI44_0_0YGStyle{};
