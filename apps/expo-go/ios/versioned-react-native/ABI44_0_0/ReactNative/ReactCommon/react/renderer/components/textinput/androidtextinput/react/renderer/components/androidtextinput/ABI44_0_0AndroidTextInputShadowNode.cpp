...
#include <ABI44_0_0React/ABI44_0_0renderer/components/text/BaseTextShadowNode.h>
...
AttributedString AndroidTextInputShadowNode::getMostRecentAttributedString()
  ...
  auto ABI44_0_0ReactTreeAttributedString = getAttributedString();
  ...
  bool treeAttributedStringChanged =
      !state.ABI44_0_0ReactTreeAttributedString.compareTextAttributesWithoutFrame(
          ABI44_0_0ReactTreeAttributedString);
...
void AndroidTextInputShadowNode::updateStateIfNeeded() {
  ...
  auto newEventCount =
      (state.ABI44_0_0ReactTreeAttributedString == ABI44_0_0ReactTreeAttributedString
           ? 0
