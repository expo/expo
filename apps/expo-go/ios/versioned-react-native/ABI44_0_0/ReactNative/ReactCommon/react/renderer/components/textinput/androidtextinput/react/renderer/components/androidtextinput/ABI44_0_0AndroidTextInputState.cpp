...
#include "ABI44_0_0AndroidTextInputState.h"
...
AndroidTextInputState::AndroidTextInputState(
    ...
    AttributedString const &ABI44_0_0ReactTreeAttributedString,
    ...
    : mostRecentEventCount(mostRecentEventCount),
      ...
      ABI44_0_0ReactTreeAttributedString(ABI44_0_0ReactTreeAttributedString),
...
AndroidTextInputState::AndroidTextInputState(
    ...
    : mostRecentEventCount(data.getDefault(
      ...
      ABI44_0_0ReactTreeAttributedString(previousState.ABI44_0_0ReactTreeAttributedString),
