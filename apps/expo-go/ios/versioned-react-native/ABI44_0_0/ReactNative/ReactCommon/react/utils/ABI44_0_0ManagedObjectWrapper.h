...
@interface ABI44_0_0RCTInternalGenericWeakWrapper : NSObject
...
{
  ABI44_0_0RCTInternalGenericWeakWrapper *weakWrapper = [ABI44_0_0RCTInternalGenericWeakWrapper new];
...
{
  ABI44_0_0RCTInternalGenericWeakWrapper *weakWrapper = (ABI44_0_0RCTInternalGenericWeakWrapper *)unwrapManagedObject(object);
  assert(weakWrapper && "`ABI44_0_0RCTInternalGenericWeakWrapper` instance must not be `nil`.");
