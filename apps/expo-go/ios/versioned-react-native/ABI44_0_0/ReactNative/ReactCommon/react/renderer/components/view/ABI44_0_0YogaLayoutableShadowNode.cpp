...
#include "ABI44_0_0YogaLayoutableShadowNode.h"
...
static void applyLayoutConstraints(
  ...
  yogaStyle.minDimensions()[ABI44_0_0YGDimensionWidth] =
      yogaStyleValueFromFloat(layoutConstraints.minimumSize.width);
  yogaStyle.minDimensions()[ABI44_0_0YGDimensionHeight] =
      yogaStyleValueFromFloat(layoutConstraints.minimumSize.height);

  yogaStyle.maxDimensions()[ABI44_0_0YGDimensionWidth] =
      yogaStyleValueFromFloat(layoutConstraints.maximumSize.width);
  yogaStyle.maxDimensions()[ABI44_0_0YGDimensionHeight] =
...
YogaLayoutableShadowNode::YogaLayoutableShadowNode(
  ...
  // This is not a default for `ABI44_0_0YGNode`.
...
void YogaLayoutableShadowNode::updateYogaChildrenOwnersIfNeeded() {
  for (auto &childYogaNode : yogaNode_.getChildren()) {
    if (childYogaNode->getOwner() == &yogaNode_) {
      childYogaNode->setOwner(reinterpret_cast<ABI44_0_0YGNodeRef>(0xBADC0FFEE0DDF00D));
    }
  }
}
...
void YogaLayoutableShadowNode::updateYogaChildren() {
  ...
  auto oldYogaChildren = isClean ? yogaNode_.getChildren() : ABI44_0_0YGVector{};
...
void YogaLayoutableShadowNode::setSize(Size size) const {
  ...
  style.dimensions()[ABI44_0_0YGDimensionWidth] = yogaStyleValueFromFloat(size.width);
  style.dimensions()[ABI44_0_0YGDimensionHeight] = yogaStyleValueFromFloat(size.height);
...
void YogaLayoutableShadowNode::setPadding(RectangleEdges<Float> padding) const {
  ...
  if (leftPadding != style.padding()[ABI44_0_0YGEdgeLeft] ||
      topPadding != style.padding()[ABI44_0_0YGEdgeTop] ||
      rightPadding != style.padding()[ABI44_0_0YGEdgeRight] ||
      bottomPadding != style.padding()[ABI44_0_0YGEdgeBottom]) {
    style.padding()[ABI44_0_0YGEdgeTop] = yogaStyleValueFromFloat(padding.top);
    style.padding()[ABI44_0_0YGEdgeLeft] = yogaStyleValueFromFloat(padding.left);
    style.padding()[ABI44_0_0YGEdgeRight] = yogaStyleValueFromFloat(padding.right);
    style.padding()[ABI44_0_0YGEdgeBottom] = yogaStyleValueFromFloat(padding.bottom);
    yogaNode_.setStyle(style);
    yogaNode_.setDirty(true);
  }
}
...
void YogaLayoutableShadowNode::layoutTree(
  ...
  {
    SystraceSection s("YogaLayoutableShadowNode::ABI44_0_0YGNodeCalculateLayout");

    ABI44_0_0YGNodeCalculateLayout(
        &yogaNode_, ABI44_0_0YGUndefined, ABI44_0_0YGUndefined, ABI44_0_0YGDirectionInherit);
  }
...
void YogaLayoutableShadowNode::layout(LayoutContext layoutContext) {
  ...
  if (yogaNode_.getStyle().overflow() == ABI44_0_0YGOverflowVisible) {
...
ABI44_0_0YGNode *YogaLayoutableShadowNode::yogaNodeCloneCallbackConnector(
...
ABI44_0_0YGSize YogaLayoutableShadowNode::yogaNodeMeasureCallbackConnector(
  ...
  return ABI44_0_0YGSize{yogaFloatFromFloat(size.width),
                yogaFloatFromFloat(size.height)};
}

#ifdef ABI44_0_0RN_DEBUG_YOGA_LOGGER
static int YogaLog(
  ...
  LOG(INFO) << "ABI44_0_0RNYogaLogger " << buffer.data();
  return result;
}
#endif

ABI44_0_0YGConfig &YogaLayoutableShadowNode::initializeYogaConfig(ABI44_0_0YGConfig &config) {
...
void YogaLayoutableShadowNode::swapLeftAndRightInYogaStyleProps(
  ...
  ABI44_0_0YGStyle::Edges const &position = yogaStyle.position();
  ABI44_0_0YGStyle::Edges const &padding = yogaStyle.padding();
  ABI44_0_0YGStyle::Edges const &margin = yogaStyle.margin();

  // Swap Yoga node values, position, padding and margin.

  if (yogaStyle.position()[ABI44_0_0YGEdgeLeft] != ABI44_0_0YGValueUndefined) {
    yogaStyle.position()[ABI44_0_0YGEdgeStart] = position[ABI44_0_0YGEdgeLeft];
    yogaStyle.position()[ABI44_0_0YGEdgeLeft] = ABI44_0_0YGValueUndefined;
  }

  if (yogaStyle.position()[ABI44_0_0YGEdgeRight] != ABI44_0_0YGValueUndefined) {
    yogaStyle.position()[ABI44_0_0YGEdgeEnd] = position[ABI44_0_0YGEdgeRight];
    yogaStyle.position()[ABI44_0_0YGEdgeRight] = ABI44_0_0YGValueUndefined;
  }

  if (yogaStyle.padding()[ABI44_0_0YGEdgeLeft] != ABI44_0_0YGValueUndefined) {
    yogaStyle.padding()[ABI44_0_0YGEdgeStart] = padding[ABI44_0_0YGEdgeLeft];
    yogaStyle.padding()[ABI44_0_0YGEdgeLeft] = ABI44_0_0YGValueUndefined;
  }

  if (yogaStyle.padding()[ABI44_0_0YGEdgeRight] != ABI44_0_0YGValueUndefined) {
    yogaStyle.padding()[ABI44_0_0YGEdgeEnd] = padding[ABI44_0_0YGEdgeRight];
    yogaStyle.padding()[ABI44_0_0YGEdgeRight] = ABI44_0_0YGValueUndefined;
  }

  if (yogaStyle.margin()[ABI44_0_0YGEdgeLeft] != ABI44_0_0YGValueUndefined) {
    yogaStyle.margin()[ABI44_0_0YGEdgeStart] = margin[ABI44_0_0YGEdgeLeft];
    yogaStyle.margin()[ABI44_0_0YGEdgeLeft] = ABI44_0_0YGValueUndefined;
  }

  if (yogaStyle.margin()[ABI44_0_0YGEdgeRight] != ABI44_0_0YGValueUndefined) {
    yogaStyle.margin()[ABI44_0_0YGEdgeEnd] = margin[ABI44_0_0YGEdgeRight];
    yogaStyle.margin()[ABI44_0_0YGEdgeRight] = ABI44_0_0YGValueUndefined;
  }
...
void YogaLayoutableShadowNode::swapLeftAndRightInViewProps(
  ...
  ABI44_0_0YGStyle::Edges const &border = props.yogaStyle.border();

  if (props.yogaStyle.border()[ABI44_0_0YGEdgeLeft] != ABI44_0_0YGValueUndefined) {
    props.yogaStyle.border()[ABI44_0_0YGEdgeStart] = border[ABI44_0_0YGEdgeLeft];
    props.yogaStyle.border()[ABI44_0_0YGEdgeLeft] = ABI44_0_0YGValueUndefined;
  }

  if (props.yogaStyle.border()[ABI44_0_0YGEdgeRight] != ABI44_0_0YGValueUndefined) {
    props.yogaStyle.border()[ABI44_0_0YGEdgeEnd] = border[ABI44_0_0YGEdgeRight];
    props.yogaStyle.border()[ABI44_0_0YGEdgeRight] = ABI44_0_0YGValueUndefined;
  }
}
