...
template <>
struct std::hash<ABI44_0_0facebook::ABI44_0_0React::AttributedStringBox> {
  size_t operator()(
      ABI44_0_0facebook::ABI44_0_0React::AttributedStringBox const &attributedStringBox) const {
    switch (attributedStringBox.getMode()) {
      case ABI44_0_0facebook::ABI44_0_0React::AttributedStringBox::Mode::Value:
        return std::hash<ABI44_0_0facebook::ABI44_0_0React::AttributedString>()(
            attributedStringBox.getValue());
      case ABI44_0_0facebook::ABI44_0_0React::AttributedStringBox::Mode::OpaquePointer:
