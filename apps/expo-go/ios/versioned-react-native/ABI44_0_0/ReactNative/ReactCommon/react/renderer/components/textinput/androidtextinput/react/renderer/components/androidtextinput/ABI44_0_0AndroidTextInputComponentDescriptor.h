...
#include "ABI44_0_0AndroidTextInputShadowNode.h"

#include <ABI44_0_0yoga/ABI44_0_0CompactValue.h>
#include <ABI44_0_0yoga/ABI44_0_0YGEnums.h>
#include <ABI44_0_0yoga/ABI44_0_0YGValue.h>
...
class AndroidTextInputComponentDescriptor final
  ...
  virtual State::Shared createInitialState(
    ...
    if (surfaceIdToThemePaddingMap_.find(surfaceId) !=
      ...
      if (getThemeData(
        ...
        theme[ABI44_0_0YGEdgeStart] = (ABI44_0_0YGValue){defaultTextInputPadding[0], ABI44_0_0YGUnitPoint};
        theme[ABI44_0_0YGEdgeEnd] = (ABI44_0_0YGValue){defaultTextInputPadding[1], ABI44_0_0YGUnitPoint};
        theme[ABI44_0_0YGEdgeTop] = (ABI44_0_0YGValue){defaultTextInputPadding[2], ABI44_0_0YGUnitPoint};
        theme[ABI44_0_0YGEdgeBottom] =
            (ABI44_0_0YGValue){defaultTextInputPadding[3], ABI44_0_0YGUnitPoint};
    ...
    return std::make_shared<AndroidTextInputShadowNode::ConcreteState>(
        std::make_shared<AndroidTextInputState const>(AndroidTextInputState(
            ...
            {},
            textLayoutManager_,
            ((ABI44_0_0YGValue)theme[ABI44_0_0YGEdgeStart]).value,
            ((ABI44_0_0YGValue)theme[ABI44_0_0YGEdgeEnd]).value,
            ((ABI44_0_0YGValue)theme[ABI44_0_0YGEdgeTop]).value,
            ((ABI44_0_0YGValue)theme[ABI44_0_0YGEdgeBottom]).value)),
        family);
  }
 ...
 protected:
  void adopt(UnsharedShadowNode shadowNode) const override {
    ...
    if (surfaceIdToThemePaddingMap_.find(surfaceId) !=
        surfaceIdToThemePaddingMap_.end()) {
      ABI44_0_0YGStyle::Edges theme = surfaceIdToThemePaddingMap_[surfaceId];
      ...
      if (!textInputShadowNode->getConcreteProps().hasPadding &&
        ...
        changedPadding = true;
        result[ABI44_0_0YGEdgeStart] = theme[ABI44_0_0YGEdgeStart];
      }
      if (!textInputShadowNode->getConcreteProps().hasPadding &&
      ...
      if ((textInputShadowNode->getConcreteProps().hasPadding ||
           ...
           textInputShadowNode->getConcreteProps().hasPaddingHorizontal) &&
          !textInputShadowNode->getConcreteProps().hasPaddingStart) {
        result[ABI44_0_0YGEdgeStart] = ABI44_0_0YGValueUndefined;
      }
      if ((textInputShadowNode->getConcreteProps().hasPadding ||
           textInputShadowNode->getConcreteProps().hasPaddingRight ||
           textInputShadowNode->getConcreteProps().hasPaddingHorizontal) &&
          !textInputShadowNode->getConcreteProps().hasPaddingEnd) {
        result[ABI44_0_0YGEdgeEnd] = ABI44_0_0YGValueUndefined;
      }
 ...
 private:
  ...
  constexpr static auto UIManagerJavaDescriptor =
      "com/facebook/ABI44_0_0React/fabric/FabricUIManager";

  SharedTextLayoutManager textLayoutManager_;
  mutable better::map<int, ABI44_0_0YGStyle::Edges> surfaceIdToThemePaddingMap_;
};
