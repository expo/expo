...
template <typename T>
struct hash<ABI44_0_0facebook::ABI44_0_0React::RectangleCorners<T>> {
  size_t operator()(ABI44_0_0facebook::ABI44_0_0React::RectangleCorners<T> const &corners) const
      noexcept {
