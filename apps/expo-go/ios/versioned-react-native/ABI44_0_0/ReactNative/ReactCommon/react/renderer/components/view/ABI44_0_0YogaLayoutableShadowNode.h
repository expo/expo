...
#include <ABI44_0_0yoga/ABI44_0_0YGNode.h>

#include <ABI44_0_0React/ABI44_0_0renderer/components/view/YogaStylableProps.h>
...
#pragma mark - Mutating Methods
   ...
   */
  void setPositionType(ABI44_0_0YGPositionType positionType) const;
...
#pragma mark - LayoutableShadowNode
 ...
 protected:
   ...
   * all the time.
   */
  mutable ABI44_0_0YGNode yogaNode_;
 ...
 private:
  ...
  static ABI44_0_0YGConfig &initializeYogaConfig(ABI44_0_0YGConfig &config);
  static ABI44_0_0YGNode *yogaNodeCloneCallbackConnector(
      ABI44_0_0YGNode *oldYogaNode,
      ABI44_0_0YGNode *parentYogaNode,
      int childIndex);
  static ABI44_0_0YGSize yogaNodeMeasureCallbackConnector(
      ABI44_0_0YGNode *yogaNode,
      float width,
