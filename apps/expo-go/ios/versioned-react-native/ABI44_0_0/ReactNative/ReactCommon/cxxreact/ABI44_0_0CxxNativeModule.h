...
#include <ABI44_0_0cxxreact/ABI44_0_0NativeModule.h>
...
class ABI44_0_0RN_EXPORT CxxNativeModule : public NativeModule {
 public:
  CxxNativeModule(
      std::weak_ptr<Instance> instance,
      std::string name,
  ...
  void invoke(unsigned int ABI44_0_0ReactMethodId, folly::dynamic &&params, int callId)
      override;
