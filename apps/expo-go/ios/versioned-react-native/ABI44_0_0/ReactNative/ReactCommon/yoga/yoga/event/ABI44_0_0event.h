...
#include <vector>
#include <array>
#include <ABI44_0_0yoga/ABI44_0_0YGEnums.h>
#include <stdint.h>
...
struct YOGA_EXPORT Event {
  ...
  class Data;
  using Subscriber = void(const ABI44_0_0YGNode&, Type, Data);
  ...
  template <Type E>
  static void publish(const ABI44_0_0YGNode& node, const TypedData<E>& eventData = {}) {
#ifdef ABI44_0_0YG_ENABLE_EVENTS
...
private:
  static void publish(const ABI44_0_0YGNode&, Type, const Data&);
};
