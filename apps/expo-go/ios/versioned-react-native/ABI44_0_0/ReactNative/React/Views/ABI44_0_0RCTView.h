...
@class ABI44_0_0RCTView;

@interface ABI44_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI44_0_0RCTDirectEventBlock onAccessibilityAction;
@property (nonatomic, copy) ABI44_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI44_0_0RCTDirectEventBlock onMagicTap;
@property (nonatomic, copy) ABI44_0_0RCTDirectEventBlock onAccessibilityEscape;
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI44_0_0RCTBorderStyle borderStyle;
