...
@implementation ABI44_0_0RCTModalHostViewController {
...
- (instancetype)init
{
  ...
  _preferredStatusBarStyle = [ABI44_0_0RCTSharedApplication() statusBarStyle];
  _preferredStatusBarHidden = [ABI44_0_0RCTSharedApplication() isStatusBarHidden];
