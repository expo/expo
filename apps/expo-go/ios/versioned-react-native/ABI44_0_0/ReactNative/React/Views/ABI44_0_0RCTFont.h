...
typedef UIFont * (^ABI44_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ABI44_0_0React Native will use the System font for rendering by default. If you want to
 ...
 */
ABI44_0_0RCT_EXTERN void ABI44_0_0RCTSetDefaultFontHandler(ABI44_0_0RCTFontHandler handler);
ABI44_0_0RCT_EXTERN BOOL ABI44_0_0RCTHasFontHandlerSet(void);

@interface ABI44_0_0RCTFont : NSObject
...
@interface ABI44_0_0RCTConvert (ABI44_0_0RCTFont)
