...
@implementation ABI44_0_0RCTScrollEvent {
...
- (ABI44_0_0RCTScrollEvent *)coalesceWithEvent:(ABI44_0_0RCTScrollEvent *)newEvent
{
...
- (NSArray *)arguments
{
  return @[ self.viewTag, ABI44_0_0RCTNormalizeInputEventName(self.eventName), [self body] ];
}
