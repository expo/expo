...
/**
 * ABI44_0_0RCTEventEmitter is an abstract base class to be used for modules that emit
 * events to be observed by JS.
 */
@interface ABI44_0_0RCTEventEmitter : NSObject <ABI44_0_0RCTBridgeModule, ABI44_0_0RCTJSInvokerModule, ABI44_0_0RCTInvalidating>
