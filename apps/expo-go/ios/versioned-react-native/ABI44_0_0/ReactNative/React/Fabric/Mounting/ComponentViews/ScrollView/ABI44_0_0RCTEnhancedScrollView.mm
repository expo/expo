...
@interface ABI44_0_0RCTEnhancedScrollView () <UIScrollViewDelegate>
@end

@implementation ABI44_0_0RCTEnhancedScrollView {
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _delegateSplitter = [[ABI44_0_0RCTGenericDelegateSplitter alloc] initWithDelegateUpdateBlock:^(id delegate) {
...
#pragma mark - ABI44_0_0RCTGenericDelegateSplitter
