...
#import <ABI44_0_0React/ABI44_0_0renderer/components/view/AccessibilityPrimitives.h>
#import <ABI44_0_0React/ABI44_0_0renderer/components/view/primitives.h>
#import <ABI44_0_0React/ABI44_0_0renderer/core/LayoutPrimitives.h>
#import <ABI44_0_0React/ABI44_0_0renderer/graphics/Color.h>
#import <ABI44_0_0React/ABI44_0_0renderer/graphics/Geometry.h>
#import <ABI44_0_0React/ABI44_0_0renderer/graphics/Transform.h>

NS_ASSUME_NONNULL_BEGIN

inline NSString *ABI44_0_0RCTNSStringFromString(
...
inline NSString *_Nullable ABI44_0_0RCTNSStringFromStringNilIfEmpty(
    const std::string &string,
    const NSStringEncoding &encoding = NSUTF8StringEncoding)
{
  return string.empty() ? nil : ABI44_0_0RCTNSStringFromString(string, encoding);
}

inline std::string ABI44_0_0RCTStringFromNSString(NSString *string)
{
  return std::string{string.UTF8String ?: ""};
}

inline UIColor *_Nullable ABI44_0_0RCTUIColorFromSharedColor(ABI44_0_0facebook::ABI44_0_0React::SharedColor const &sharedColor)
{
  if (!sharedColor) {
    return nil;
  }
...
ABI44_0_0RCTCreateCGColorRefFromSharedColor(const ABI44_0_0facebook::ABI44_0_0React::SharedColor &sharedColor)
{
  return CGColorRetain(ABI44_0_0RCTUIColorFromSharedColor(sharedColor).CGColor);
}

inline CGPoint ABI44_0_0RCTCGPointFromPoint(const ABI44_0_0facebook::ABI44_0_0React::Point &point)
{
  return {point.x, point.y};
}

inline CGSize ABI44_0_0RCTCGSizeFromSize(const ABI44_0_0facebook::ABI44_0_0React::Size &size)
{
  return {size.width, size.height};
}

inline CGRect ABI44_0_0RCTCGRectFromRect(const ABI44_0_0facebook::ABI44_0_0React::Rect &rect)
{
  return {ABI44_0_0RCTCGPointFromPoint(rect.origin), ABI44_0_0RCTCGSizeFromSize(rect.size)};
}

inline UIEdgeInsets ABI44_0_0RCTUIEdgeInsetsFromEdgeInsets(const ABI44_0_0facebook::ABI44_0_0React::EdgeInsets &edgeInsets)
{
...
inline UIAccessibilityTraits ABI44_0_0RCTUIAccessibilityTraitsFromAccessibilityTraits(
    ABI44_0_0facebook::ABI44_0_0React::AccessibilityTraits accessibilityTraits)
{
  using AccessibilityTraits = ABI44_0_0facebook::ABI44_0_0React::AccessibilityTraits;
...
inline CATransform3D ABI44_0_0RCTCATransform3DFromTransformMatrix(const ABI44_0_0facebook::ABI44_0_0React::Transform &transformMatrix)
{
...
inline ABI44_0_0facebook::ABI44_0_0React::Point ABI44_0_0RCTPointFromCGPoint(const CGPoint &point)
{
  return {point.x, point.y};
}

inline ABI44_0_0facebook::ABI44_0_0React::Size ABI44_0_0RCTSizeFromCGSize(const CGSize &size)
{
  return {size.width, size.height};
}

inline ABI44_0_0facebook::ABI44_0_0React::Rect ABI44_0_0RCTRectFromCGRect(const CGRect &rect)
{
  return {ABI44_0_0RCTPointFromCGPoint(rect.origin), ABI44_0_0RCTSizeFromCGSize(rect.size)};
}

inline ABI44_0_0facebook::ABI44_0_0React::EdgeInsets ABI44_0_0RCTEdgeInsetsFromUIEdgeInsets(const UIEdgeInsets &edgeInsets)
{
  return {edgeInsets.left, edgeInsets.top, edgeInsets.right, edgeInsets.bottom};
}

inline ABI44_0_0facebook::ABI44_0_0React::LayoutDirection ABI44_0_0RCTLayoutDirection(BOOL isRTL)
{
  return isRTL ? ABI44_0_0facebook::ABI44_0_0React::LayoutDirection::RightToLeft : ABI44_0_0facebook::ABI44_0_0React::LayoutDirection::LeftToRight;
}
