...
#import "ABI44_0_0RCTPullToRefreshViewComponentView.h"
...
#import <ABI44_0_0React/ABI44_0_0renderer/components/rncore/ABI44_0_0RCTComponentViewHelpers.h>

#import <ABI44_0_0React/ABI44_0_0RCTConversions.h>
#import <ABI44_0_0React/ABI44_0_0RCTRefreshableProtocol.h>
#import <ABI44_0_0React/ABI44_0_0RCTScrollViewComponentView.h>

#import "ABI44_0_0RCTFabricComponentsPlugins.h"

using namespace ABI44_0_0facebook::ABI44_0_0React;

@interface ABI44_0_0RCTPullToRefreshViewComponentView () <ABI44_0_0RCTPullToRefreshViewViewProtocol, ABI44_0_0RCTRefreshableProtocol>
@end

@implementation ABI44_0_0RCTPullToRefreshViewComponentView {
  UIRefreshControl *_refreshControl;
  ABI44_0_0RCTScrollViewComponentView *_scrollViewComponentView;
}
...
- (void)_updateTitle
{
  ...
  if (concreteProps.titleColor) {
    attributes[NSForegroundColorAttributeName] = ABI44_0_0RCTUIColorFromSharedColor(concreteProps.titleColor);
  }

  _refreshControl.attributedTitle =
      [[NSAttributedString alloc] initWithString:ABI44_0_0RCTNSStringFromString(concreteProps.title) attributes:attributes];
}
...
- (void)_attach
{
  ...
  _scrollViewComponentView = [ABI44_0_0RCTScrollViewComponentView findScrollViewComponentViewForView:self];
  if (!_scrollViewComponentView) {
    return;
  }
...
{
  ABI44_0_0RCTPullToRefreshViewHandleCommand(self, commandName, args);
}
...
#pragma mark - ABI44_0_0RCTRefreshableProtocol
...
Class<ABI44_0_0RCTComponentViewProtocol> ABI44_0_0RCTPullToRefreshViewCls(void)
{
  return ABI44_0_0RCTPullToRefreshViewComponentView.class;
}
