...
@protocol ABI44_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI44_0_0RCTExceptionsManager : NSObject <ABI44_0_0RCTBridgeModule>
...
@property (nonatomic, weak) id<ABI44_0_0RCTExceptionsManagerDelegate> delegate;
