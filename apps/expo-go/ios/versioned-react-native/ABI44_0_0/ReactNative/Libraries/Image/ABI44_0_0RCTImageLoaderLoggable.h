...
/**
 * The image loader (i.e. ABI44_0_0RCTImageLoader) implement this to declare whether image performance should be logged.
 */
@protocol ABI44_0_0RCTImageLoaderLoggableProtocol
 ...
 */
@protocol ABI44_0_0RCTImageLoaderLoggable
