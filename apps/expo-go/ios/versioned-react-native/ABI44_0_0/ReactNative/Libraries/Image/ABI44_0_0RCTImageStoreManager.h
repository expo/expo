...
@interface ABI44_0_0RCTImageStoreManager : NSObject <ABI44_0_0RCTURLRequestHandler>
...
@interface ABI44_0_0RCTImageStoreManager (Deprecated)
...
@interface ABI44_0_0RCTBridge (ABI44_0_0RCTImageStoreManager)

@property (nonatomic, readonly) ABI44_0_0RCTImageStoreManager *imageStoreManager;
