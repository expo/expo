...
ABI44_0_0RCTBlobCollector::ABI44_0_0RCTBlobCollector(ABI44_0_0RCTBlobManager *blobManager, const std::string &blobId)
: blobId_(blobId), blobManager_(blobManager) {}

ABI44_0_0RCTBlobCollector::~ABI44_0_0RCTBlobCollector() {
  ABI44_0_0RCTBlobManager *blobManager = blobManager_;
...
void ABI44_0_0RCTBlobCollector::install(ABI44_0_0RCTBlobManager *blobManager) {
  __weak ABI44_0_0RCTCxxBridge *cxxBridge = (ABI44_0_0RCTCxxBridge *)blobManager.bridge;
    ...
    runtime.global().setProperty(
      ...
      jsi::Function::createFromHostFunction(
        ...
        [blobManager](jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count) {
          ...
          auto blobCollector = std::make_shared<ABI44_0_0RCTBlobCollector>(blobManager, blobId);
