...
@interface ABI44_0_0RCTReconnectingWebSocket () <ABI44_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI44_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  ...
  __weak ABI44_0_0RCTSRWebSocket *socket = _socket;
...
- (void)webSocket:(ABI44_0_0RCTSRWebSocket *)webSocket didCloseWithCode:(NSInteger)code reason:(NSString *)reason wasClean:(BOOL)wasClean
{
  [_delegate reconnectingWebSocketDidClose:self];
  [self reconnect];
}
