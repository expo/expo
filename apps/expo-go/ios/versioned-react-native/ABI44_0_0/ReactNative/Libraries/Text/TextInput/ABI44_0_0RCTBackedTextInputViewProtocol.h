...
@protocol ABI44_0_0RCTBackedTextInputDelegate;
@class ABI44_0_0RCTTextAttributes;

NS_ASSUME_NONNULL_BEGIN

@protocol ABI44_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI44_0_0RCTBackedTextInputDelegate> textInputDelegate;
