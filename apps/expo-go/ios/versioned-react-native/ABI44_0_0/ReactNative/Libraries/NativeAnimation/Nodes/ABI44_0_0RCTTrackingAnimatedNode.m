...
@implementation ABI44_0_0RCTTrackingAnimatedNode {
...
- (void)performUpdate
{
  ...
  ABI44_0_0RCTValueAnimatedNode *node = (ABI44_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
