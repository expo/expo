...
@interface ABI44_0_0RCTDataRequestHandler() <ABI44_0_0RCTTurboModule>
@end

@implementation ABI44_0_0RCTDataRequestHandler
{
...
Class ABI44_0_0RCTDataRequestHandlerCls(void) {
  return ABI44_0_0RCTDataRequestHandler.class;
}
