...
@implementation ABI44_0_0RNSVGRadialGradient
...
- (void)setFx:(ABI44_0_0RNSVGLength *)fx
{
    if ([fx isEqualTo:_fx]) {
        return;
    }
...
- (void)setFy:(ABI44_0_0RNSVGLength *)fy
{
    if ([fy isEqualTo:_fy]) {
        return;
    }
...
- (void)setRx:(ABI44_0_0RNSVGLength *)rx
{
    if ([rx isEqualTo:_rx]) {
        return;
    }
...
- (void)setRy:(ABI44_0_0RNSVGLength *)ry
{
    if ([ry isEqualTo:_ry]) {
        return;
    }
...
- (void)setCx:(ABI44_0_0RNSVGLength *)cx
{
    if ([cx isEqualTo:_cx]) {
        return;
    }
...
- (void)setCy:(ABI44_0_0RNSVGLength *)cy
{
    if ([cy isEqualTo:_cy]) {
        return;
    }
...
- (void)setGradientUnits:(ABI44_0_0RNSVGUnits)gradientUnits
{
...
{
    self.dirty = false;
    NSArray<ABI44_0_0RNSVGLength *> *points = @[self.fx, self.fy, self.rx, self.ry, self.cx, self.cy];
    ABI44_0_0RNSVGPainter *painter = [[ABI44_0_0RNSVGPainter alloc] initWithPointsArray:points];
