...
@implementation ABI44_0_0RNSVGGroup
{
    ABI44_0_0RNSVGGlyphContext *_glyphContext;
}
...
- (void)renderGroupTo:(CGContextRef)context rect:(CGRect)rect
{
    ...
    [self traverseSubviews:^(ABI44_0_0RNSVGView *node) {
        if ([node isKindOfClass:[ABI44_0_0RNSVGMask class]] || [node isKindOfClass:[ABI44_0_0RNSVGClipPath class]]) {
            // no-op
        } else if ([node isKindOfClass:[ABI44_0_0RNSVGNode class]]) {
            ABI44_0_0RNSVGNode* svgNode = (ABI44_0_0RNSVGNode*)node;
            ...
            if ([node isKindOfClass:[ABI44_0_0RNSVGRenderable class]]) {
                [(ABI44_0_0RNSVGRenderable*)node mergeProperties:self];
            }
            ...
            if ([node isKindOfClass:[ABI44_0_0RNSVGRenderable class]]) {
                [(ABI44_0_0RNSVGRenderable*)node resetProperties];
            }
        } else if ([node isKindOfClass:[ABI44_0_0RNSVGSvgView class]]) {
            ABI44_0_0RNSVGSvgView* svgView = (ABI44_0_0RNSVGSvgView*)node;
...
- (void)setupGlyphContext:(CGContextRef)context
{
    ...
    _glyphContext = [[ABI44_0_0RNSVGGlyphContext alloc] initWithWidth:width
                                                      height:height];
}
...
- (CGPathRef)getPath:(CGContextRef)context
{
    ...
    [self traverseSubviews:^(ABI44_0_0RNSVGNode *node) {
        if ([node isKindOfClass:[ABI44_0_0RNSVGNode class]] && ![node isKindOfClass:[ABI44_0_0RNSVGMask class]]) {
...
- (ABI44_0_0RNSVGPlatformView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    if (!event) {
        NSPredicate *const anyActive = [NSPredicate predicateWithFormat:@"self isKindOfClass: %@ AND active == TRUE", [ABI44_0_0RNSVGNode class]];
    ...
    for (ABI44_0_0RNSVGView *node in [self.subviews reverseObjectEnumerator]) {
        if ([node isKindOfClass:[ABI44_0_0RNSVGNode class]]) {
            if ([node isKindOfClass:[ABI44_0_0RNSVGMask class]]) {
                continue;
            }
            ABI44_0_0RNSVGNode* svgNode = (ABI44_0_0RNSVGNode*)node;
            if (event) {
            ...
            ABI44_0_0RNSVGPlatformView *hitChild = [svgNode hitTest:transformed withEvent:event];
            if (hitChild) {
                svgNode.active = YES;
            ...
            ABI44_0_0RNSVGSvgView* svgView = (ABI44_0_0RNSVGSvgView*)node;
            ABI44_0_0RNSVGPlatformView *hitChild = [svgView hitTest:transformed withEvent:event];
            if (hitChild) {
                return hitChild;
            }
        }
    ...
    ABI44_0_0RNSVGPlatformView *hitSelf = [super hitTest:transformed withEvent:event];
    if (hitSelf) {
        return hitSelf;
    }
...
{
    [self traverseSubviews:^(__kindof ABI44_0_0RNSVGNode *node) {
        if ([node isKindOfClass:[ABI44_0_0RNSVGRenderable class]]) {
            [(ABI44_0_0RNSVGRenderable*)node resetProperties];
        }
        return YES;
