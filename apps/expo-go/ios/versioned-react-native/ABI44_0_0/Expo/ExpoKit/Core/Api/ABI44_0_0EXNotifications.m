...
#import "ABI44_0_0EXNotifications.h"
...
@interface ABI44_0_0EXNotifications ()

// unversioned ABI44_0_0EXRemoteNotificationManager instance
@property (nonatomic, weak) id <ABI44_0_0EXNotificationsScopedModuleDelegate> remoteNotificationsDelegate;
@property (nonatomic, weak) id <ABI44_0_0EXNotificationsIdentifiersManager> notificationsIdentifiersManager;
@property (nonatomic, weak) id <ABI44_0_0EXUserNotificationCenterService> userNotificationCenter;

@end

@implementation ABI44_0_0EXNotifications

ABI44_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentNotifications, @"RemoteNotificationManager", @"UserNotificationManager", @"UserNotificationCenter");
...
ABI44_0_0RCT_REMAP_METHOD(getDevicePushTokenAsync,
...
{
  ABI44_0_0EXConstantsBinding *constants = [[[self.bridge moduleForClass:[ABI44_0_0EXModuleRegistryHolderReactModule class]] exModuleRegistry] getModuleImplementingProtocol:@protocol(ABI44_0_0EXConstantsInterface)];
...
ABI44_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
                 getExponentPushTokenAsyncWithResolver:(ABI44_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI44_0_0RCTPromiseRejectBlock)reject)
{
...
ABI44_0_0RCT_EXPORT_METHOD(presentLocalNotification:(NSDictionary *)payload
                  resolver:(ABI44_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI44_0_0RCTPromiseRejectBlock)reject)
{
  ...
  ABI44_0_0RCT_EXPORT_METHOD(scheduleNotificationWithTimer:(NSDictionary *)payload
...
ABI44_0_0RCT_EXPORT_METHOD(scheduleNotificationWithCalendar:(NSDictionary *)payload
                 withOptions:(NSDictionary *)options
                 resolver:(ABI44_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI44_0_0RCTPromiseRejectBlock)reject)
{
...
ABI44_0_0RCT_EXPORT_METHOD(scheduleLocalNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI44_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI44_0_0RCTPromiseRejectBlock)reject)
{
...
ABI44_0_0RCT_EXPORT_METHOD(legacyScheduleLocalRepeatingNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI44_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI44_0_0RCTPromiseRejectBlock)reject)
{
  ...
  localNotification.applicationIconBadgeNumber = [ABI44_0_0RCTConvert NSInteger:payload[@"count"]] ?: 0;
  ...
  localNotification.fireDate = [ABI44_0_0RCTConvert NSDate:options[@"time"]] ?: [NSDate new];
  localNotification.repeatInterval = [ABI44_0_0RCTConvert NSCalendarUnit:options[@"repeat"]] ?: 0;

  __weak typeof(self) weakSelf = self;
  [ABI44_0_0EXUtil performSynchronouslyOnMainThread:^{
    [ABI44_0_0RCTSharedApplication() scheduleLocalNotification:localNotification];
...
ABI44_0_0RCT_REMAP_METHOD(cancelScheduledNotificationAsync,
                 cancelScheduledNotificationAsync:(NSString *)uniqueId
                 withResolver:(ABI44_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI44_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI44_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
...
ABI44_0_0RCT_REMAP_METHOD(cancelAllScheduledNotificationsAsync,
                 cancelAllScheduledNotificationsAsyncWithResolver:(ABI44_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(__unused ABI44_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI44_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
  [_userNotificationCenter getPendingNotificationRequestsWithCompletionHandler:^(NSArray<UNNotificationRequest *> * _Nonnull requests) {
...
ABI44_0_0RCT_REMAP_METHOD(getBadgeNumberAsync,
                 getBadgeNumberAsyncWithResolver:(ABI44_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI44_0_0RCTPromiseRejectBlock)reject)
{
  __block NSInteger badgeNumber;
  [ABI44_0_0EXUtil performSynchronouslyOnMainThread:^{
    badgeNumber = ABI44_0_0RCTSharedApplication().applicationIconBadgeNumber;
  }];
  resolve(@(badgeNumber));
}

ABI44_0_0RCT_EXPORT_METHOD(setBadgeNumberAsync:(nonnull NSNumber *)number
                  resolver:(ABI44_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI44_0_0RCTPromiseRejectBlock)reject)
{
  [ABI44_0_0EXUtil performSynchronouslyOnMainThread:^{
    ABI44_0_0RCTSharedApplication().applicationIconBadgeNumber = number.integerValue;
  }];
  resolve(nil);
}
...
ABI44_0_0RCT_REMAP_METHOD(createCategoryAsync,
...
ABI44_0_0RCT_REMAP_METHOD(deleteCategoryAsync,
...
- (NSDateComponents *)dateComponentsFrom:(NSNumber * _Nullable)unixTime {
  ...
  NSDate *triggerDate = [ABI44_0_0RCTConvert NSDate:unixTime] ?: [NSDate new];
