...
@interface ABI44_0_0EXSensorsManagerBinding ()

@property (nonatomic, strong) NSString *scopeKey;
@property (nonatomic, weak) id<ABI44_0_0EXSensorsManagerBindingDelegate> kernelService;

@end

@implementation ABI44_0_0EXSensorsManagerBinding
