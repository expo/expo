...
@implementation ABI44_0_0EXScopedNotificationsUtils
...
{
  return [ABI44_0_0EXScopedNotificationsUtils shouldNotificationRequest:notification.request beHandledByExperience:scopeKey];
}

+ (NSString *)scopedIdentifierFromId:(NSString *)unscopedId forExperience:(NSString *)scopeKey
{
  NSString *scope = [ABI44_0_0EXScopedNotificationsUtils escapedString:scopeKey];
  NSString *escapedCategoryId = [ABI44_0_0EXScopedNotificationsUtils escapedString:unscopedId];
...
{
  NSString *scopeFromCategoryId = [ABI44_0_0EXScopedNotificationsUtils getScopeAndIdentifierFromScopedIdentifier:identifier].scopeKey;
...
+ (ScopedIdentifierComponents)getScopeAndIdentifierFromScopedIdentifier:(NSString *)scopedIdentifier
{
  ...
  components.scopeKey = [ABI44_0_0EXScopedNotificationsUtils unescapedString:scope];
  components.identifier = [ABI44_0_0EXScopedNotificationsUtils unescapedString:identifier];
  return components;
}
