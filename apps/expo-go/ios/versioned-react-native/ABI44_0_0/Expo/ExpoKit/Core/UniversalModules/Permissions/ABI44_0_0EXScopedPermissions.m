...
@interface ABI44_0_0EXScopedPermissions ()

@property (nonatomic, strong) NSString *scopeKey;
@property (nonatomic, weak) id<ABI44_0_0EXPermissionsScopedModuleDelegate> permissionsService;
@property (nonatomic, weak) id<ABI44_0_0EXUtilitiesInterface> utils;
@property (nonatomic, weak) ABI44_0_0EXConstantsBinding *constantsBinding;

@end

@implementation ABI44_0_0EXScopedPermissions
...
// overriding ABI44_0_0EXPermission to inject scoped permission logic
...
- (NSString *)getScopedPermissionStatus:(NSString *)permissionType {
  if (!_permissionsService) {
    return [[self class] permissionStringForStatus:ABI44_0_0EXPermissionStatusGranted];
  }
...
- (BOOL)hasGrantedScopedPermission:(NSString *)permissionType
{
  ...
  return [_permissionsService getPermission:permissionType forExperience:_scopeKey] == ABI44_0_0EXPermissionStatusGranted;
}
  ...
  if (![globalPermissions[@"status"] isEqualToString:@"granted"]) {
    ...
    UIAlertAction *allowAction = [UIAlertAction actionWithTitle:@"Allow" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
      ...
      if (![self.permissionsService savePermission:permission ofType:permissionType forExperience:self.scopeKey]) {
        permission[@"status"] = [[self class] permissionStringForStatus:ABI44_0_0EXPermissionStatusDenied];
...
- (NSDictionary *)getScopedPermissionForType:(NSString *)permissionType withGlobalPermission:(NSDictionary *)globalPermission
{
  ...
  if ([_constantsBinding.appOwnership isEqualToString:@"expo"]
      ...
      && [ABI44_0_0EXPermissionsService statusForPermission:permission] == ABI44_0_0EXPermissionStatusGranted) {
