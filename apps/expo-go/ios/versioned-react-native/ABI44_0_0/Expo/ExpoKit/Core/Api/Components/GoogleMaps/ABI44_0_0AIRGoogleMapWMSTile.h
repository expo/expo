//
//  ABI44_0_0AIRGoogleMapWMSTile.h
//  AirMaps
//
...
@interface ABI44_0_0WMSTileOverlay : GMSSyncTileLayer
...
@interface ABI44_0_0AIRGoogleMapWMSTile : UIView
@property (nonatomic, strong) ABI44_0_0WMSTileOverlay *tileLayer;
