...
#include <ABI42_0_0cxxreact/ABI42_0_0NativeModule.h>
...
class ABI42_0_0RN_EXPORT JSExecutor {
 public:
  /**
   * Prepares the JS runtime for ABI42_0_0React Native by installing global variables.
