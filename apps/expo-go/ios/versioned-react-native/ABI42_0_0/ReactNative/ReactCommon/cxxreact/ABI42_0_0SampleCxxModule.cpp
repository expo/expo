...
#include "ABI42_0_0SampleCxxModule.h"
...
ABI42_0_0facebook::xplat::module::CxxModule *SampleCxxModule() {
  return new ABI42_0_0facebook::xplat::samples::SampleCxxModule(
      std::make_unique<ABI42_0_0facebook::xplat::samples::Sample>());
}
