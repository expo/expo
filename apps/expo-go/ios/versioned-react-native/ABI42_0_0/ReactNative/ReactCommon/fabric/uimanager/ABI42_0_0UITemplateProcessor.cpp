...
#include "ABI42_0_0UITemplateProcessor.h"
...
#include <ABI42_0_0React/components/view/ViewShadowNode.h>
...
SharedShadowNode UITemplateProcessor::runCommand(
  ...
  if (opcode == "createNode") {
    ...
    registers[registerNumber] = ABI42_0_0ReactNativeConfig->getBool(param);
...
SharedShadowNode UITemplateProcessor::buildShadowTree(
  ...
  LOG(ERROR) << "ABI42_0_0React ui template missing returnRoot command :(";
