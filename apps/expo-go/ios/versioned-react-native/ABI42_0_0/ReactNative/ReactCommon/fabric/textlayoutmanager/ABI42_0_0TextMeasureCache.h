...
#include <ABI42_0_0React/utils/FloatComparison.h>
#include <ABI42_0_0React/utils/SimpleThreadSafeCache.h>
...
template <>
struct hash<ABI42_0_0facebook::ABI42_0_0React::TextMeasureCacheKey> {
  size_t operator()(ABI42_0_0facebook::ABI42_0_0React::TextMeasureCacheKey const &key) const {
    return folly::hash::hash_combine(
        0,
