...
#import "ABI42_0_0RCTTypedModuleConstants.h"

#import <ABI42_0_0React/ABI42_0_0RCTDefines.h>

@implementation _ABI42_0_0RCTTypedModuleConstants {
  NSDictionary *_dictionary;
}

+ (instancetype)newWithUnsafeDictionary:(NSDictionary<NSString *, id> *)dictionary
{
  _ABI42_0_0RCTTypedModuleConstants *constants = [self new];
  if (constants) {
...
ABI42_0_0RCT_NOT_IMPLEMENTED(- (instancetype)initWithObjects:(id  _Nonnull const [])objects
