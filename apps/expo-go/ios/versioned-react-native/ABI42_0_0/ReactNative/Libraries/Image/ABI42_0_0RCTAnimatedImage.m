...
@interface ABI42_0_0RCTGIFCoderFrame : NSObject
...
@implementation ABI42_0_0RCTGIFCoderFrame
@end

@implementation ABI42_0_0RCTAnimatedImage {
  CGImageSourceRef _imageSource;
  CGFloat _scale;
  NSUInteger _loopCount;
  NSUInteger _frameCount;
  NSArray<ABI42_0_0RCTGIFCoderFrame *> *_frames;
}
...
- (BOOL)scanAndCheckFramesValidWithSource:(CGImageSourceRef)imageSource
{
  ...
  NSMutableArray<ABI42_0_0RCTGIFCoderFrame *> *frames = [NSMutableArray array];

  for (size_t i = 0; i < frameCount; i++) {
    ABI42_0_0RCTGIFCoderFrame *frame = [[ABI42_0_0RCTGIFCoderFrame alloc] init];
    frame.index = i;
