...
@interface ABI42_0_0RCTReconnectingWebSocket () <ABI42_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI42_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  ...
  __weak ABI42_0_0RCTSRWebSocket *socket = _socket;
