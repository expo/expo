...
@implementation ABI42_0_0RCTMultilineTextInputView
{
  ABI42_0_0RCTUITextView *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI42_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI42_0_0RCTUITextView alloc] initWithFrame:self.bounds];
...
{
  ABI42_0_0RCTDirectEventBlock onScroll = self.onScroll;
