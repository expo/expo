...
@implementation ABI42_0_0RCTMaskedView

- (void)didUpdateABI42_0_0ReactSubviews
{
  // ABI42_0_0RCTMaskedView expects that the first subview rendered is the mask.
...
- (void)displayLayer:(__unused CALayer *)layer
{
  ...
  // We don't need to do that in ABI42_0_0RCTMaskedView, so we
