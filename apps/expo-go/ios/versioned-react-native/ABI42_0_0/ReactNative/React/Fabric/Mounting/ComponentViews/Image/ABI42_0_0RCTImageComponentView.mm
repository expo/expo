...
#import <ABI42_0_0React/ABI42_0_0RCTImageResponseDelegate.h>
#import <ABI42_0_0React/ABI42_0_0RCTImageResponseObserverProxy.h>
#import <ABI42_0_0React/components/image/ImageComponentDescriptor.h>
#import <ABI42_0_0React/components/image/ImageEventEmitter.h>
#import <ABI42_0_0React/components/image/ImageProps.h>
#import <ABI42_0_0React/imagemanager/ImageInstrumentation.h>
#import <ABI42_0_0React/imagemanager/ImageRequest.h>
#import <ABI42_0_0React/imagemanager/ABI42_0_0RCTImageInstrumentationProxy.h>
#import <ABI42_0_0React/imagemanager/ABI42_0_0RCTImagePrimitivesConversions.h>
...
@interface ABI42_0_0RCTImageComponentView () <ABI42_0_0RCTImageResponseDelegate>
@end

@implementation ABI42_0_0RCTImageComponentView {
  UIImageView *_imageView;
  ImageShadowNode::ConcreteState::Shared _state;
  ImageResponseObserverCoordinator const *_coordinator;
  ABI42_0_0RCTImageResponseObserverProxy _imageResponseObserverProxy;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _imageView.contentMode = (UIViewContentMode)ABI42_0_0RCTResizeModeFromImageResizeMode(defaultProps->resizeMode);

    _imageResponseObserverProxy = ABI42_0_0RCTImageResponseObserverProxy(self);
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  if (oldImageProps.resizeMode != newImageProps.resizeMode) {
    if (newImageProps.resizeMode == ImageResizeMode::Repeat) {
      ...
      _imageView.contentMode = (UIViewContentMode)ABI42_0_0RCTResizeModeFromImageResizeMode(newImageProps.resizeMode);
    }
  }
...
- (void)updateState:(State::Shared const &)state oldState:(State::Shared const &)oldState
{
  ...
  if (!havePreviousData || data.getImageSource() != _oldState->getData().getImageSource()) {
    ...
    auto instrumentation = std::static_pointer_cast<ABI42_0_0RCTImageInstrumentationProxy const>(
...
#pragma mark - ABI42_0_0RCTImageResponseDelegate
...
- (void)didReceiveImage:(UIImage *)image fromObserver:(void const *)observer
{
  ...
  if (imageProps.resizeMode == ImageResizeMode::Repeat) {
    image = [image resizableImageWithCapInsets:ABI42_0_0RCTUIEdgeInsetsFromEdgeInsets(imageProps.capInsets)
...
Class<ABI42_0_0RCTComponentViewProtocol> ABI42_0_0RCTImageCls(void)
{
  return ABI42_0_0RCTImageComponentView.class;
}
