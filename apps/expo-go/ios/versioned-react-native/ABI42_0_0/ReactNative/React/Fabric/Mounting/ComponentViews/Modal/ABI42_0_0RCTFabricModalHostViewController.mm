...
@implementation ABI42_0_0RCTFabricModalHostViewController {
  CGRect _lastViewBounds;
  ABI42_0_0RCTSurfaceTouchHandler *_touchHandler;
}
...
{
  return [ABI42_0_0RCTSharedApplication() statusBarStyle];
}
...
{
  return [ABI42_0_0RCTSharedApplication() isStatusBarHidden];
}
