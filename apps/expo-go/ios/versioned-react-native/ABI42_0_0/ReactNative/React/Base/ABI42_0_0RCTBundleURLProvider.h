...
extern NSString *const ABI42_0_0RCTBundleURLProviderUpdatedNotification;

extern const NSUInteger kABI42_0_0RCTBundleURLProviderDefaultPort;

#if defined(__cplusplus)
}
#endif

@interface ABI42_0_0RCTBundleURLProvider : NSObject
