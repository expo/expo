...
@interface ABI42_0_0EXManifestsNewRawManifestTests : XCTestCase

@end

@implementation ABI42_0_0EXManifestsNewRawManifestTests
...
- (void)testSDKVersion_ValidCases {
  ...
  ABI42_0_0EXManifestsNewRawManifest *manifest = [[ABI42_0_0EXManifestsNewRawManifest alloc] initWithRawManifestJSON:manifestJson];
