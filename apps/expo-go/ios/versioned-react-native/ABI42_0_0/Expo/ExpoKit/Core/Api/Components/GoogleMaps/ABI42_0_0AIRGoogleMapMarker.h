...
@interface ABI42_0_0AIRGoogleMapMarker : UIView

@property (nonatomic, weak) ABI42_0_0RCTBridge *bridge;
@property (nonatomic, strong) ABI42_0_0AIRGoogleMapCallout *calloutView;
@property (nonatomic, strong) NSString *identifier;
@property (nonatomic, assign) CLLocationCoordinate2D coordinate;
@property (nonatomic, assign) CLLocationDegrees rotation;
@property (nonatomic, strong) ABI42_0_0AIRGMSMarker* realMarker;
