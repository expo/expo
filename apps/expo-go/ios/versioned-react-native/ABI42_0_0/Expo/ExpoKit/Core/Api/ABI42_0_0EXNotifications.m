...
#import "ABI42_0_0EXNotifications.h"
...
@interface ABI42_0_0EXNotifications ()

// unversioned ABI42_0_0EXRemoteNotificationManager instance
@property (nonatomic, weak) id <ABI42_0_0EXNotificationsScopedModuleDelegate> remoteNotificationsDelegate;
@property (nonatomic, weak) id <ABI42_0_0EXNotificationsIdentifiersManager> notificationsIdentifiersManager;
@property (nonatomic, weak) id <ABI42_0_0EXUserNotificationCenterService> userNotificationCenter;

@end

@implementation ABI42_0_0EXNotifications

ABI42_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentNotifications, @"RemoteNotificationManager", @"UserNotificationManager", @"UserNotificationCenter");
...
ABI42_0_0RCT_REMAP_METHOD(getDevicePushTokenAsync,
...
{
  ABI42_0_0EXConstantsBinding *constants = [[[self.bridge moduleForClass:[ABI42_0_0UMModuleRegistryHolderReactModule class]] umModuleRegistry] getModuleImplementingProtocol:@protocol(ABI42_0_0EXConstantsInterface)];
...
ABI42_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
...
ABI42_0_0RCT_EXPORT_METHOD(presentLocalNotification:(NSDictionary *)payload
                  resolver:(ABI42_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI42_0_0RCTPromiseRejectBlock)reject)
{
  ...
  ABI42_0_0RCT_EXPORT_METHOD(scheduleNotificationWithTimer:(NSDictionary *)payload
...
ABI42_0_0RCT_EXPORT_METHOD(scheduleNotificationWithCalendar:(NSDictionary *)payload
                 withOptions:(NSDictionary *)options
                 resolver:(ABI42_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI42_0_0RCTPromiseRejectBlock)reject)
{
...
ABI42_0_0RCT_EXPORT_METHOD(scheduleLocalNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI42_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI42_0_0RCTPromiseRejectBlock)reject)
{
...
ABI42_0_0RCT_EXPORT_METHOD(legacyScheduleLocalRepeatingNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI42_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI42_0_0RCTPromiseRejectBlock)reject)
{
  ...
  localNotification.repeatInterval = [ABI42_0_0RCTConvert NSCalendarUnit:options[@"repeat"]] ?: 0;

  __weak typeof(self) weakSelf = self;
  [ABI42_0_0EXUtil performSynchronouslyOnMainThread:^{
    [ABI42_0_0RCTSharedApplication() scheduleLocalNotification:localNotification];
...
ABI42_0_0RCT_REMAP_METHOD(cancelScheduledNotificationAsync,
                 cancelScheduledNotificationAsync:(NSString *)uniqueId
                 withResolver:(ABI42_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI42_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI42_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
...
ABI42_0_0RCT_REMAP_METHOD(cancelAllScheduledNotificationsAsync,
                 cancelAllScheduledNotificationsAsyncWithResolver:(ABI42_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(__unused ABI42_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI42_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
  [_userNotificationCenter getPendingNotificationRequestsWithCompletionHandler:^(NSArray<UNNotificationRequest *> * _Nonnull requests) {
...
ABI42_0_0RCT_REMAP_METHOD(getBadgeNumberAsync,
                 getBadgeNumberAsyncWithResolver:(ABI42_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI42_0_0RCTPromiseRejectBlock)reject)
{
  __block NSInteger badgeNumber;
  [ABI42_0_0EXUtil performSynchronouslyOnMainThread:^{
    badgeNumber = ABI42_0_0RCTSharedApplication().applicationIconBadgeNumber;
  }];
  resolve(@(badgeNumber));
}

ABI42_0_0RCT_EXPORT_METHOD(setBadgeNumberAsync:(nonnull NSNumber *)number
                  resolver:(ABI42_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI42_0_0RCTPromiseRejectBlock)reject)
{
  [ABI42_0_0EXUtil performSynchronouslyOnMainThread:^{
    ABI42_0_0RCTSharedApplication().applicationIconBadgeNumber = number.integerValue;
  }];
  resolve(nil);
}
...
ABI42_0_0RCT_REMAP_METHOD(createCategoryAsync,
...
ABI42_0_0RCT_REMAP_METHOD(deleteCategoryAsync,
...
- (NSDateComponents *)dateComponentsFrom:(NSNumber * _Nullable)unixTime {
  ...
  NSDate *triggerDate = [ABI42_0_0RCTConvert NSDate:unixTime] ?: [NSDate new];
