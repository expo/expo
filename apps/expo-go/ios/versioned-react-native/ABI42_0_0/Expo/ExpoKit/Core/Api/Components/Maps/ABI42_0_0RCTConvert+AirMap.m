...
@implementation ABI42_0_0RCTConvert (AirMap)
...
{
    json = [self NSDictionary:json];
    return [ABI42_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:nil];
}
...
ABI42_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI42_0_0AIRMapCoordinate *)ABI42_0_0AIRMapCoordinate:(id)json
{
    ABI42_0_0AIRMapCoordinate *coord = [ABI42_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI42_0_0RCT_ARRAY_CONVERTER(ABI42_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI42_0_0AIRMapCoordinate *> *> *)ABI42_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI42_0_0RCTConvertArrayValue(@selector(ABI42_0_0AIRMapCoordinateArray:), json);
}
