//
//  ABI42_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI42_0_0RNRootViewGestureRecognizer
{
    BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    ABI42_0_0RNGestureHandler *otherHandler = [ABI42_0_0RNGestureHandler
...
{
    return ![preventedGestureRecognizer isKindOfClass:[ABI42_0_0RCTTouchHandler class]];
}
