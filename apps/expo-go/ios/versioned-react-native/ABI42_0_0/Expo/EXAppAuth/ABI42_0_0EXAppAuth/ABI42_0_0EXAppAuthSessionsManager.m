...
@interface ABI42_0_0EXAppAuthSessionsManager ()

@property (nonatomic, strong) NSMutableSet<id<OIDExternalUserAgentSession>> *currentAuthorizationFlows;

@end

@implementation ABI42_0_0EXAppAuthSessionsManager

ABI42_0_0UM_REGISTER_SINGLETON_MODULE(AppAuthSessionsManager)
