...
#import <ABI42_0_0EXSplashScreen/ABI42_0_0EXSplashScreenViewNativeProvider.h>
#import <ABI42_0_0UMCore/ABI42_0_0UMDefines.h>

@interface ABI42_0_0EXSplashScreenService ()

@property (nonatomic, strong) NSMapTable<UIViewController *, ABI42_0_0EXSplashScreenController *> *splashScreenControllers;

@end

@implementation ABI42_0_0EXSplashScreenService

ABI42_0_0UM_REGISTER_SINGLETON_MODULE(SplashScreen);
...
{
  id<ABI42_0_0EXSplashScreenViewProvider> splashScreenViewProvider = [ABI42_0_0EXSplashScreenViewNativeProvider new];
  return [self showSplashScreenFor:viewController
          splashScreenViewProvider:splashScreenViewProvider
                   successCallback:^{}
                   failureCallback:^(NSString *message){ ABI42_0_0UMLogWarn(@"%@", message); }];
}
            ...
            failureCallback:(void (^)(NSString * _Nonnull))failureCallback
{
  ...
  ABI42_0_0EXSplashScreenController *splashScreenController = [[ABI42_0_0EXSplashScreenController alloc] initWithViewController:viewController
                                                                                     splashScreenViewProvider:splashScreenViewProvider];
...
{
  if (![self.splashScreenControllers objectForKey:viewController]) {
    ABI42_0_0UMLogWarn(@"No native splash screen registered for given view controller. Call 'SplashScreen.show' for given view controller first.");
  }
