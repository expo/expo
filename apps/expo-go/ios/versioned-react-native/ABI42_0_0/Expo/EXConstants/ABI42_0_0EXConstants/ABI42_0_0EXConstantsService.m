...
#import <ABI42_0_0EXConstants/ABI42_0_0EXConstantsInstallationIdProvider.h>

NSString * const ABI42_0_0EXConstantsExecutionEnvironmentBare = @"bare";
NSString * const ABI42_0_0EXConstantsExecutionEnvironmentStandalone = @"standalone";
NSString * const ABI42_0_0EXConstantsExecutionEnvironmentStoreClient = @"storeClient";

@interface ABI42_0_0EXConstantsService ()

@property (nonatomic, strong) NSString *sessionId;
@property (nonatomic, strong) ABI42_0_0EXConstantsInstallationIdProvider *installationIdProvider;

@end

@implementation ABI42_0_0EXConstantsService

- (instancetype)init
{
  return [self initWithInstallationIdProvider:[[ABI42_0_0EXConstantsInstallationIdProvider alloc] init]];
}

- (instancetype)initWithInstallationIdProvider:(ABI42_0_0EXConstantsInstallationIdProvider *)installationIdProvider
{
  if (self = [super init]) {
...
{
  return @[@protocol(ABI42_0_0EXConstantsInterface)];
}
...
- (NSDictionary *)constants
{
  ...
  return @{
           ...
           @"executionEnvironment": ABI42_0_0EXConstantsExecutionEnvironmentBare,
           ...
           @"manifest": ABI42_0_0UMNullIfNil([[self class] appConfig]),
           @"platform": @{
               @"ios": @{
                   @"buildNumber": [self buildVersion],
                   @"platform": [[self class] devicePlatform],
                   @"model": ABI42_0_0UMNullIfNil([[self class] deviceModel]),
