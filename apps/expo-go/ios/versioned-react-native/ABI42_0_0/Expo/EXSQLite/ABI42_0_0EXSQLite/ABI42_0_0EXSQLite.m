...
#import <ABI42_0_0EXSQLite/ABI42_0_0EXSQLite.h>

#import <ABI42_0_0ExpoModulesCore/ABI42_0_0EXFileSystemInterface.h>

#import <sqlite3.h>

@interface ABI42_0_0EXSQLite ()
...
@implementation ABI42_0_0EXSQLite
...
ABI42_0_0UM_EXPORT_MODULE(ExponentSQLite);
...
- (NSString *)pathForDatabaseName:(NSString *)name
{
  ...
  if (!fileSystem) {
    ABI42_0_0UMLogError(@"No FileSystem module.");
    return nil;
  }
...
ABI42_0_0UM_EXPORT_METHOD_AS(exec,
...
ABI42_0_0UM_EXPORT_METHOD_AS(close,
                 ...
                 withDb:(sqlite3*)db withReadOnly:(BOOL)readOnly
{
  ...
  if (sqlite3_prepare_v2(db, [sql UTF8String], -1, &statement, NULL) != SQLITE_OK) {
    error = [ABI42_0_0EXSQLite convertSQLiteErrorToString:db];
    return @[error];
  }
