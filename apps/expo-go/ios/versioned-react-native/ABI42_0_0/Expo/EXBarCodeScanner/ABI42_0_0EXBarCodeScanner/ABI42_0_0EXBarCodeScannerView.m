...
@interface ABI42_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI42_0_0EXBarCodeScanner *barCodeScanner;
...
@implementation ABI42_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI42_0_0UMModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI42_0_0UMAppLifecycleListener)];
...
{
  ABI42_0_0UM_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI42_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI42_0_0EXBareCodeCameraRequester class]]) {
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI42_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI42_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI42_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI42_0_0EXBarCodeScanner *barCodeScanner = [ABI42_0_0EXBarCodeScanner new];
