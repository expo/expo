...
@implementation ABI42_0_0EXLocationPermissionRequester
...
- (void)requestLocationPermissions
{
  ...
  } else if ([ABI42_0_0EXBaseLocationRequester isConfiguredForWhenInUseAuthorization] && [self.locationManager respondsToSelector:whenInUseAuthorizationSelector]) {
