...
#import <ABI42_0_0EXNotifications/ABI42_0_0EXPushTokenModule.h>
#import <ABI42_0_0EXNotifications/ABI42_0_0EXPushTokenManager.h>
...
@interface ABI42_0_0EXPushTokenModule ()

@property (nonatomic, weak) id<ABI42_0_0EXPushTokenManager> pushTokenManager;
...
@property (nonatomic, strong) ABI42_0_0UMPromiseResolveBlock getDevicePushTokenResolver;
@property (nonatomic, strong) ABI42_0_0UMPromiseRejectBlock getDevicePushTokenRejecter;

@end

@implementation ABI42_0_0EXPushTokenModule

ABI42_0_0UM_EXPORT_MODULE(ExpoPushTokenManager);

# pragma mark - Exported methods

ABI42_0_0UM_EXPORT_METHOD_AS(getDevicePushTokenAsync,
                    getDevicePushTokenResolving:(ABI42_0_0UMPromiseResolveBlock)resolve rejecting:(ABI42_0_0UMPromiseRejectBlock)reject)
{
...
# pragma mark - ABI42_0_0EXPushTokenListener
