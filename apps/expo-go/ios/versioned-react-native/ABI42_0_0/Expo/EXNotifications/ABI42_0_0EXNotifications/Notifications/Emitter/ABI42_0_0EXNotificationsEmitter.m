...
@interface ABI42_0_0EXNotificationsEmitter ()
...
@implementation ABI42_0_0EXNotificationsEmitter

ABI42_0_0UM_EXPORT_MODULE(ExpoNotificationsEmitter);

ABI42_0_0UM_EXPORT_METHOD_AS(getLastNotificationResponseAsync,
                    getLastNotificationResponseAsyncWithResolver:(ABI42_0_0UMPromiseResolveBlock)resolve reject:(ABI42_0_0UMPromiseRejectBlock)reject)
{
...
{
  // Silence ABI42_0_0React Native warning: "Sending ... with no listeners registered."
...
{
  return [ABI42_0_0EXNotificationSerializer serializedNotification:notification];
}

- (NSDictionary *)serializedNotificationResponse:(UNNotificationResponse *)notificationResponse
{
  return [ABI42_0_0EXNotificationSerializer serializedNotificationResponse:notificationResponse];
}
