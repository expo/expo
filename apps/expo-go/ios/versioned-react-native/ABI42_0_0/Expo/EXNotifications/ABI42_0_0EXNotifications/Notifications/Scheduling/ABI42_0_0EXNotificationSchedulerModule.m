...
@interface ABI42_0_0EXNotificationSchedulerModule ()

@property (nonatomic, weak) id<ABI42_0_0EXNotificationBuilder> builder;

@end

@implementation ABI42_0_0EXNotificationSchedulerModule

ABI42_0_0UM_EXPORT_MODULE(ExpoNotificationScheduler);

- (void)setModuleRegistry:(ABI42_0_0UMModuleRegistry *)moduleRegistry
{
  _builder = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI42_0_0EXNotificationBuilder)];
}

# pragma mark - Exported methods

ABI42_0_0UM_EXPORT_METHOD_AS(getAllScheduledNotificationsAsync,
                    getAllScheduledNotifications:(ABI42_0_0UMPromiseResolveBlock)resolve reject:(ABI42_0_0UMPromiseRejectBlock)reject
                    )
{
...
ABI42_0_0UM_EXPORT_METHOD_AS(scheduleNotificationAsync,
                     scheduleNotification:(NSString *)identifier notificationSpec:(NSDictionary *)notificationSpec triggerSpec:(NSDictionary *)triggerSpec resolve:(ABI42_0_0UMPromiseResolveBlock)resolve rejecting:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  @try {
...
ABI42_0_0UM_EXPORT_METHOD_AS(cancelScheduledNotificationAsync,
                     cancelNotification:(NSString *)identifier resolve:(ABI42_0_0UMPromiseResolveBlock)resolve rejecting:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  [[UNUserNotificationCenter currentNotificationCenter] removePendingNotificationRequestsWithIdentifiers:@[identifier]];
  resolve(nil);
}

ABI42_0_0UM_EXPORT_METHOD_AS(cancelAllScheduledNotificationsAsync,
                     cancelAllNotificationsWithResolver:(ABI42_0_0UMPromiseResolveBlock)resolve rejecting:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  [[UNUserNotificationCenter currentNotificationCenter] removeAllPendingNotificationRequests];
  resolve(nil);
}

ABI42_0_0UM_EXPORT_METHOD_AS(getNextTriggerDateAsync,
                    getNextTriggerDate:(NSDictionary *)triggerSpec resolve:(ABI42_0_0UMPromiseResolveBlock)resolve rejecting:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  @try {
...
- (NSArray * _Nonnull)serializeNotificationRequests:(NSArray<UNNotificationRequest *> * _Nonnull) requests
{
  ...
  for (UNNotificationRequest *request in requests) {
    [serializedRequests addObject:[ABI42_0_0EXNotificationSerializer serializedNotificationRequest:request]];
  }
