...
#import <ABI42_0_0EXCalendar/ABI42_0_0EXCalendar.h>
...
@implementation ABI42_0_0EXCalendar
...
ABI42_0_0UM_EXPORT_MODULE(ExpoCalendar);
...
- (void)setModuleRegistry:(ABI42_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  [ABI42_0_0EXPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI42_0_0EXCalendarPermissionRequester new],
                                                    [ABI42_0_0EXRemindersPermissionRequester new]
                                                    ]
...
ABI42_0_0UM_EXPORT_METHOD_AS(getCalendarsAsync,
                    ...
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI42_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI42_0_0UM_EXPORT_METHOD_AS(getDefaultCalendarAsync,
                    getDefaultCalendarAsync:(ABI42_0_0UMPromiseResolveBlock)resolve
                    rejector:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  if (![self _checkCalendarPermissions:reject]) {
    return;
  }
  ...
  resolve([ABI42_0_0EXCalendarConverter serializeCalendar:defaultCalendar]);
}

ABI42_0_0UM_EXPORT_METHOD_AS(saveCalendarAsync,
                    ...
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (color) {
    calendar.CGColor = [ABI42_0_0UMUtilities UIColor:color].CGColor;
...
ABI42_0_0UM_EXPORT_METHOD_AS(deleteCalendarAsync,
...
ABI42_0_0UM_EXPORT_METHOD_AS(getEventsAsync,
                    ...
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI42_0_0UMUtilities NSDate:startDateStr];
  NSDate *endDate = [ABI42_0_0UMUtilities NSDate:endDateStr];
  ...
  if (calendarEvents) {
    resolve([ABI42_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI42_0_0UM_EXPORT_METHOD_AS(getEventByIdAsync,
                    ...
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (calendarEvent) {
    resolve([ABI42_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI42_0_0UM_EXPORT_METHOD_AS(saveEventAsync,
                    ...
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI42_0_0UMUtilities NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI42_0_0UMUtilities NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI42_0_0UMUtilities NSDate:details[@"instanceStartDate"]];
...
ABI42_0_0UM_EXPORT_METHOD_AS(deleteEventAsync,
                    ...
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *instanceStartDate = [ABI42_0_0UMUtilities NSDate:event[@"instanceStartDate"]];
...
ABI42_0_0UM_EXPORT_METHOD_AS(getAttendeesForEventAsync,
                    ...
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (item.hasAttendees) {
    resolve([ABI42_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI42_0_0UM_EXPORT_METHOD_AS(getRemindersAsync,
                    ...
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI42_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI42_0_0UM_EXPORT_METHOD_AS(getReminderByIdAsync,
                    ...
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (reminder) {
    ...
    resolve([ABI42_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI42_0_0UM_EXPORT_METHOD_AS(saveReminderAsync,
                    ...
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI42_0_0UMUtilities NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI42_0_0UMUtilities NSDate:details[@"dueDate"]];
  NSDate *completionDate = [ABI42_0_0UMUtilities NSDate:details[@"completionDate"]];
...
ABI42_0_0UM_EXPORT_METHOD_AS(deleteReminderAsync,
...
ABI42_0_0UM_EXPORT_METHOD_AS(getSourcesAsync,
                    getSourcesAsync:(ABI42_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI42_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI42_0_0UM_EXPORT_METHOD_AS(getSourceByIdAsync,
                    ...
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI42_0_0EXCalendarConverter serializeSource:source]);
}

ABI42_0_0UM_EXPORT_METHOD_AS(getCalendarPermissionsAsync,
                    getCalendarPermissionsAsync:(ABI42_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  [ABI42_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI42_0_0EXCalendarPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI42_0_0UM_EXPORT_METHOD_AS(requestCalendarPermissionsAsync,
                    requestCalendarPermissionsAsync:(ABI42_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
...
ABI42_0_0UM_EXPORT_METHOD_AS(getRemindersPermissionsAsync,
                    getRemindersPermissionsAsync:(ABI42_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  [ABI42_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI42_0_0EXRemindersPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI42_0_0UM_EXPORT_METHOD_AS(requestRemindersPermissionsAsync,
                    requestRemindersPermissionsAsync:(ABI42_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  [ABI42_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI42_0_0EXRemindersPermissionRequester class]
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI42_0_0UMUtilities NSDate:alarm[@"absoluteDate"]];
...
- (EKRecurrenceRule *)_createRecurrenceRule:(NSDictionary *)recurrenceRule
{
  ...
  if (recurrenceRule[@"endDate"]) {
      endDate = [ABI42_0_0UMUtilities NSDate:recurrenceRule[@"endDate"]];
  }
...
- (BOOL)_checkPermissions:(EKEntityType)entity reject:(ABI42_0_0UMPromiseRejectBlock)reject
{
  ...
  switch (entity) {
    case EKEntityTypeEvent:
      requesterClass = [ABI42_0_0EXCalendarPermissionRequester class];
      break;
    case EKEntityTypeReminder:
      requesterClass = [ABI42_0_0EXRemindersPermissionRequester class];
      break;
    default: {
...
- (BOOL)_checkCalendarPermissions:(ABI42_0_0UMPromiseRejectBlock)reject
{
  return [self _checkPermissions:EKEntityTypeEvent reject:reject];
}

- (BOOL)_checkRemindersPermissions:(ABI42_0_0UMPromiseRejectBlock)reject
{
...
- (void)_initializePermittedEntities
{
  ...
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI42_0_0EXCalendarPermissionRequester class]]) {
    permittedEntities |= EKEntityMaskEvent;
  }
  
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI42_0_0EXRemindersPermissionRequester class]]) {
