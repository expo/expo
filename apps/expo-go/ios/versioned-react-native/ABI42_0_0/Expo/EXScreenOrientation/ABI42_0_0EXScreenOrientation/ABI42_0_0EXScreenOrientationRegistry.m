...
@interface ABI42_0_0EXScreenOrientationRegistry ()
...
@implementation ABI42_0_0EXScreenOrientationRegistry

ABI42_0_0UM_REGISTER_SINGLETON_MODULE(ScreenOrientationRegistry)
...
- (void)enforceDesiredDeviceOrientationWithOrientationMask:(UIInterfaceOrientationMask)orientationMask
{
  ...
  if (![ABI42_0_0EXScreenOrientationUtilities doesOrientationMask:orientationMask containOrientation:_currentScreenOrientation]) {
    __block UIInterfaceOrientation newOrientation = [ABI42_0_0EXScreenOrientationUtilities defaultOrientationForOrientationMask:orientationMask];
...
- (void)interfaceOrientationDidChange:(UIInterfaceOrientation)newScreenOrientation
{
  ...
  if ([ABI42_0_0EXScreenOrientationUtilities doesOrientationMask:currentOrientationMask containOrientation:newScreenOrientation]) {
    ...
    if ([ABI42_0_0EXScreenOrientationUtilities isIPad] &&
...
- (void)traitCollectionDidChangeTo:(UITraitCollection *)traitCollection
{
  ...
  UIInterfaceOrientation currentDeviceOrientation = [ABI42_0_0EXScreenOrientationUtilities interfaceOrientationFromDeviceOrientation:[[UIDevice currentDevice] orientation]];
