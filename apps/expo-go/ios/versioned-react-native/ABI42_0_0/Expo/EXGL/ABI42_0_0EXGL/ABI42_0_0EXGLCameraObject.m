...
@interface ABI42_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) id<ABI42_0_0EXCameraInterface> camera;
...
@implementation ABI42_0_0EXGLCameraObject
