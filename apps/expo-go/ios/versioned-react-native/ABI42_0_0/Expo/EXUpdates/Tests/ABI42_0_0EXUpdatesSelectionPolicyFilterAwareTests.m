...
@interface ABI42_0_0EXUpdatesSelectionPolicyFilterAwareTests : XCTestCase

@property (nonatomic, strong) ABI42_0_0EXUpdatesUpdate *updateDefault1;
@property (nonatomic, strong) ABI42_0_0EXUpdatesUpdate *updateDefault2;
@property (nonatomic, strong) ABI42_0_0EXUpdatesUpdate *updateRollout0;
@property (nonatomic, strong) ABI42_0_0EXUpdatesUpdate *updateRollout1;
@property (nonatomic, strong) ABI42_0_0EXUpdatesUpdate *updateRollout2;
@property (nonatomic, strong) ABI42_0_0EXUpdatesUpdate *updateMultipleFilters;
@property (nonatomic, strong) ABI42_0_0EXUpdatesUpdate *updateNoMetadata;
...
@implementation ABI42_0_0EXUpdatesSelectionPolicyFilterAwareTests
...
- (void)setUp
{
  ...
  ABI42_0_0EXUpdatesConfig *config = [ABI42_0_0EXUpdatesConfig configWithDictionary:@{
    @"ABI42_0_0EXUpdatesRuntimeVersion": runtimeVersion,
    @"ABI42_0_0EXUpdatesScopeKey": scopeKey
  }];
  ABI42_0_0EXUpdatesDatabase *database = [ABI42_0_0EXUpdatesDatabase new];

  _updateRollout0 = [ABI42_0_0EXUpdatesNewUpdate updateWithNewManifest:[[ABI42_0_0EXUpdatesNewRawManifest alloc] initWithRawManifestJSON:@{
  ...
  _updateDefault1 = [ABI42_0_0EXUpdatesNewUpdate updateWithNewManifest:[[ABI42_0_0EXUpdatesNewRawManifest alloc] initWithRawManifestJSON:@{
  ...
  _updateRollout1 = [ABI42_0_0EXUpdatesNewUpdate updateWithNewManifest:[[ABI42_0_0EXUpdatesNewRawManifest alloc] initWithRawManifestJSON:@{
  ...
  _updateDefault2 = [ABI42_0_0EXUpdatesNewUpdate updateWithNewManifest:[[ABI42_0_0EXUpdatesNewRawManifest alloc] initWithRawManifestJSON:@{
  ...
  _updateRollout2 = [ABI42_0_0EXUpdatesNewUpdate updateWithNewManifest:[[ABI42_0_0EXUpdatesNewRawManifest alloc] initWithRawManifestJSON:@{
  ...
  _updateMultipleFilters = [ABI42_0_0EXUpdatesNewUpdate updateWithNewManifest:[[ABI42_0_0EXUpdatesNewRawManifest alloc] initWithRawManifestJSON:@{
    @"id": @"079cde35-8433-4c17-81c8-7117c1513e72",
    @"createdAt": @"2021-01-11T19:39:22.480Z",
    @"runtimeVersion": @"1.0",
    @"launchAsset": launchAsset,
  ...
  _updateNoMetadata = [ABI42_0_0EXUpdatesNewUpdate updateWithNewManifest:[[ABI42_0_0EXUpdatesNewRawManifest alloc] initWithRawManifestJSON:@{
    @"id": @"079cde35-8433-4c17-81c8-7117c1513e72",
    @"createdAt": @"2021-01-11T19:39:22.480Z",
    @"runtimeVersion": @"1.0",
    @"launchAsset": launchAsset,
  ...
  _selectionPolicy = [ABI42_0_0EXUpdatesSelectionPolicyFactory filterAwarePolicyWithRuntimeVersion:runtimeVersion];
...
{
  ABI42_0_0EXUpdatesUpdate *actual = [_selectionPolicy launchableUpdateFromUpdates:@[_updateDefault1, _updateRollout1, _updateDefault2] filters:_manifestFilters];
...
{
  NSArray<ABI42_0_0EXUpdatesUpdate *> *actual = [_selectionPolicy updatesToDeleteWithLaunchedUpdate:_updateRollout2 updates:@[_updateRollout0, _updateDefault1, _updateRollout1, _updateDefault2, _updateRollout2] filters:_manifestFilters];
...
{
  NSArray<ABI42_0_0EXUpdatesUpdate *> *actual = [_selectionPolicy updatesToDeleteWithLaunchedUpdate:_updateRollout2 updates:@[_updateDefault1, _updateDefault2, _updateRollout2] filters:_manifestFilters];
...
- (void)testDoesUpdateMatchFilters_MultipleFilters
{
  ...
  XCTAssertFalse([ABI42_0_0EXUpdatesSelectionPolicies doesUpdate:_updateMultipleFilters matchFilters:filtersBadMatch], @"should fail unless all filters pass");

  NSDictionary *filtersGoodMatch = @{
    @"firstkey": @"value1",
    @"secondkey": @"value2"
  };
  XCTAssertTrue([ABI42_0_0EXUpdatesSelectionPolicies doesUpdate:_updateMultipleFilters matchFilters:filtersGoodMatch], @"should pass if all filters pass");
}

- (void)testDoesUpdateMatchFilters_EmptyMatchesAll
{
  XCTAssertTrue([ABI42_0_0EXUpdatesSelectionPolicies doesUpdate:_updateDefault1 matchFilters:@{@"field-that-update-doesnt-have": @"value"}], @"no field counts as a match");
}

- (void)testDoesUpdateMatchFilters_Null
{
  // null filters or null metadata (i.e. bare or legacy manifests) is counted as a match
  XCTAssertTrue([ABI42_0_0EXUpdatesSelectionPolicies doesUpdate:_updateDefault1 matchFilters:nil]);
  XCTAssertTrue([ABI42_0_0EXUpdatesSelectionPolicies doesUpdate:_updateNoMetadata matchFilters:_manifestFilters]);
}
