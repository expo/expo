...
@interface ABI42_0_0EXGoogleSignIn ()
...
@property (nonatomic, strong) ABI42_0_0EXAuthTask *authTask;

@end

@implementation ABI42_0_0EXGoogleSignIn

ABI42_0_0UM_EXPORT_MODULE(ExpoGoogleSignIn);

- (instancetype)init
{
  if (self = [super init]) {
    _authTask = [[ABI42_0_0EXAuthTask alloc] init];
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"ERRORS": @{
               ...
               @"TASK_IN_PROGRESS": ABI42_0_0EX_E_CONCURRENT_TASK_IN_PROGRESS,
               @"SIGN_IN_EXCEPTION": ABI42_0_0EX_E_EXCEPTION
               },
           @"TYPES": @{},
           @"SCOPES": @{
               @"PROFILE": @"profile",
               ...
               @"FITNESS_OXABI42_0_0YGEN_SATURATION_READ": @"https://www.googleapis.com/auth/fitness.oxygen_saturation.read",
               @"FITNESS_OXABI42_0_0YGEN_SATURATION_READ_WRITE": @"https://www.googleapis.com/auth/fitness.oxygen_saturation.write",
...
- (NSString *)_getNativeClientIdOrReject:(ABI42_0_0UMPromiseRejectBlock)reject
{
  NSString *path = [[NSBundle mainBundle] pathForResource:@"GoogleService-Info" ofType:@"plist"];
  
  if (!path) {
    reject(ABI42_0_0EX_E_EXCEPTION, @"Missing GoogleService-Info.plist", nil);
    return nil;
  }
  NSDictionary *plist = [[NSDictionary alloc] initWithContentsOfFile:path];
  NSString *clientId = plist[@"CLIENT_ID"];
  if (clientId != nil && ![clientId isEqualToString:@""]) return clientId;
  reject(ABI42_0_0EX_E_EXCEPTION, @"GoogleService-Info.plist `CLIENT_ID` is invalid", nil);
  return nil;
}
...
ABI42_0_0UM_EXPORT_METHOD_AS(initAsync,
...
ABI42_0_0UM_EXPORT_METHOD_AS(signInSilentlyAsync,
                    signInSilentlyAsync:(ABI42_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
...
ABI42_0_0UM_EXPORT_METHOD_AS(signInAsync,
                    signInAsync:(ABI42_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
...
ABI42_0_0UM_EXPORT_METHOD_AS(signOutAsync,
                    signOutAsync:(ABI42_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
...
ABI42_0_0UM_EXPORT_METHOD_AS(disconnectAsync,
                    disconnectAsync:(ABI42_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
...
ABI42_0_0UM_EXPORT_METHOD_AS(isConnectedAsync,
                    isConnectedAsync:(ABI42_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  resolve(@([[GIDSignIn sharedInstance] hasPreviousSignIn]));
}

ABI42_0_0UM_EXPORT_METHOD_AS(getCurrentUserAsync,
                    getCurrentUserAsync:(ABI42_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  GIDGoogleUser *currentUser = [GIDSignIn sharedInstance].currentUser;
  resolve(ABI42_0_0UMNullIfNil([ABI42_0_0EXGoogleSignIn jsonFromGIDGoogleUser:currentUser]));
}

ABI42_0_0UM_EXPORT_METHOD_AS(getPhotoAsync,
...
ABI42_0_0UM_EXPORT_METHOD_AS(getTokensAsync,
                    ...
                    rejecter:(ABI42_0_0UMPromiseRejectBlock)reject)
{
  GIDGoogleUser *currentUser = [GIDSignIn sharedInstance].currentUser;
  if (currentUser == nil) {
    reject(ABI42_0_0EX_E_EXCEPTION, @"getTokens requires a user to be signed in", nil);
    return;
  }

  GIDAuthenticationHandler handler = ^void(GIDAuthentication *authentication, NSError *error) {
    if (error) {
      reject(ABI42_0_0EX_E_EXCEPTION, error.localizedDescription, nil);
    } else {
      resolve(@{
...
- (void)signIn:(GIDSignIn *)signIn didSignInForUser:(GIDGoogleUser *)user withError:(NSError *)error {
  [self.authTask parse:[ABI42_0_0EXGoogleSignIn jsonFromGIDGoogleUser:user] error:error];
}
