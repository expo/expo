...
@implementation ABI43_0_0RNCMaskedView

- (void)didUpdateABI43_0_0ReactSubviews
{
  // ABI43_0_0RNCMaskedView expects that the first subview rendered is the mask.
...
- (void)displayLayer:(CALayer *)layer
{
  ...
  // We don't need to do that in ABI43_0_0RNCMaskedView, so we
