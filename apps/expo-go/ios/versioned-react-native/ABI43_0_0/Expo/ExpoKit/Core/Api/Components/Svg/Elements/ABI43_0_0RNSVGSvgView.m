...
@implementation ABI43_0_0RNSVGSvgView
{
    NSMutableDictionary<NSString *, ABI43_0_0RNSVGNode *> *_clipPaths;
    NSMutableDictionary<NSString *, ABI43_0_0RNSVGNode *> *_templates;
    NSMutableDictionary<NSString *, ABI43_0_0RNSVGPainter *> *_painters;
    NSMutableDictionary<NSString *, ABI43_0_0RNSVGNode *> *_markers;
    NSMutableDictionary<NSString *, ABI43_0_0RNSVGNode *> *_masks;
...
- (void)invalidate
{
    ABI43_0_0RNSVGPlatformView* parent = self.superview;
    if ([parent isKindOfClass:[ABI43_0_0RNSVGNode class]]) {
        if (!rendered) {
            return;
        }
        ABI43_0_0RNSVGNode* svgNode = (ABI43_0_0RNSVGNode*)parent;
        [svgNode invalidate];
        rendered = false;
        return;
    }
...
- (void)setBbWidth:(ABI43_0_0RNSVGLength *)bbWidth
{
...
- (void)setBbHeight:(ABI43_0_0RNSVGLength *)bbHeight
{
...
- (void)drawToContext:(CGContextRef)context withRect:(CGRect)rect {
    ...
    if (self.align) {
        ...
        _viewBoxTransform = [ABI43_0_0RNSVGViewBox getTransform:tRect
                                                 eRect:rect
                                                 align:self.align
    ...
    for (ABI43_0_0RNSVGView *node in self.subviews) {
        if ([node isKindOfClass:[ABI43_0_0RNSVGNode class]]) {
            ABI43_0_0RNSVGNode *svg = (ABI43_0_0RNSVGNode *)node;
...
- (void)drawRect:(CGRect)rect
{
    ...
    for (ABI43_0_0RNSVGPlatformView *node in self.subviews) {
        if ([node isKindOfClass:[ABI43_0_0RNSVGNode class]]) {
            ABI43_0_0RNSVGNode *svg = (ABI43_0_0RNSVGNode *)node;
...
- (ABI43_0_0RNSVGPlatformView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    for (ABI43_0_0RNSVGNode *node in [self.subviews reverseObjectEnumerator]) {
        if (![node isKindOfClass:[ABI43_0_0RNSVGNode class]]) {
            continue;
        }
        ...
        ABI43_0_0RNSVGPlatformView *hitChild = [node hitTest:transformed withEvent:event];
...
- (void)defineTemplate:(ABI43_0_0RNSVGNode *)template templateName:(NSString *)templateName
{
    if (!_templates) {
