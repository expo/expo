...
#import "ABI43_0_0RNSVGPainterBrush.h"
#import "ABI43_0_0RNSVGSolidColorBrush.h"
#import "ABI43_0_0RNSVGContextBrush.h"
#import <ABI43_0_0React/ABI43_0_0RCTLog.h>
#import <ABI43_0_0React/ABI43_0_0RCTFont.h>

NSRegularExpression *ABI43_0_0RNSVGDigitRegEx;

@implementation ABI43_0_0RCTConvert (ABI43_0_0RNSVG)

ABI43_0_0RCT_ENUM_CONVERTER(ABI43_0_0RNSVGCGFCRule, (@{
                                     @"evenodd": @(kRNSVGCGFCRuleEvenodd),
                                     @"nonzero": @(kRNSVGCGFCRuleNonzero),
                                     }), kRNSVGCGFCRuleNonzero, intValue)

ABI43_0_0RCT_ENUM_CONVERTER(ABI43_0_0RNSVGVBMOS, (@{
                                  @"meet": @(kRNSVGVBMOSMeet),
                                  @"slice": @(kRNSVGVBMOSSlice),
                                  @"none": @(kRNSVGVBMOSNone)
                                  }), kRNSVGVBMOSMeet, intValue)

ABI43_0_0RCT_ENUM_CONVERTER(ABI43_0_0RNSVGUnits, (@{
...
+ (ABI43_0_0RNSVGBrush *)ABI43_0_0RNSVGBrush:(id)json
{
    if ([json isKindOfClass:[NSNumber class]]) {
        return [[ABI43_0_0RNSVGSolidColorBrush alloc] initWithNumber:json];
    }
    if ([json isKindOfClass:[NSString class]]) {
        NSString *value = [self NSString:json];
        if (!ABI43_0_0RNSVGDigitRegEx) {
            ABI43_0_0RNSVGDigitRegEx = [NSRegularExpression regularExpressionWithPattern:@"[0-9.-]+" options:NSRegularExpressionCaseInsensitive error:nil];
        }
        NSArray<NSTextCheckingResult*> *_matches = [ABI43_0_0RNSVGDigitRegEx matchesInString:value options:0 range:NSMakeRange(0, [value length])];
        ...
        return [[ABI43_0_0RNSVGSolidColorBrush alloc] initWithArray:output];
    }
    ...
    switch (type) {
        case 0: // solid color
            ...
            return [[ABI43_0_0RNSVGSolidColorBrush alloc] initWithArray:arr];
        case 1: // brush
            return [[ABI43_0_0RNSVGPainterBrush alloc] initWithArray:arr];
        case 2: // currentColor
            return [[ABI43_0_0RNSVGBrush alloc] initWithArray:nil];
        case 3: // context-fill
            return [[ABI43_0_0RNSVGContextBrush alloc] initFill];
        case 4: // context-stroke
            return [[ABI43_0_0RNSVGContextBrush alloc] initStroke];
        default:
            ABI43_0_0RCTLogError(@"Unknown brush type: %zd", (unsigned long)type);
            return nil;
    }
}
...
{
    return [[ABI43_0_0RNSVGPathParser alloc] initWithPathString: d];
}

+ (ABI43_0_0RNSVGLength *)ABI43_0_0RNSVGLength:(id)json
{
    if ([json isKindOfClass:[NSNumber class]]) {
        return [ABI43_0_0RNSVGLength lengthWithNumber:(CGFloat)[json doubleValue]];
    } else if ([json isKindOfClass:[NSString class]]) {
        NSString *stringValue = (NSString *)json;
        return [ABI43_0_0RNSVGLength lengthWithString:stringValue];
    } else {
        return [[ABI43_0_0RNSVGLength alloc] init];
    }
}
...
{
    if ([json isKindOfClass:[NSNumber class]]) {
        ABI43_0_0RNSVGLength* length = [ABI43_0_0RNSVGLength lengthWithNumber:(CGFloat)[json doubleValue]];
        return [NSArray arrayWithObject:length];
    } else if ([json isKindOfClass:[NSArray class]]) {
        NSArray *arrayValue = (NSArray*)json;
        NSMutableArray<ABI43_0_0RNSVGLength*>* lengths = [NSMutableArray arrayWithCapacity:[arrayValue count]];
        for (id obj in arrayValue) {
            [lengths addObject:[self ABI43_0_0RNSVGLength:obj]];
        }
        return lengths;
    }  else if ([json isKindOfClass:[NSString class]]) {
        NSString *stringValue = (NSString *)json;
        ABI43_0_0RNSVGLength* length = [ABI43_0_0RNSVGLength lengthWithString:stringValue];
        return [NSArray arrayWithObject:length];
    } else {
        return nil;
    }
...
+ (CGRect)ABI43_0_0RNSVGCGRect:(id)json offset:(NSUInteger)offset
{
    ...
    if (arr.count < offset + 4) {
        ABI43_0_0RCTLogError(@"Too few elements in array (expected at least %zd): %@", (ssize_t)(4 + offset), arr);
        return CGRectZero;
    }
    return (CGRect){
