...
@interface ABI43_0_0RNCAppearanceProvider ()

@property (nonatomic, weak) ABI43_0_0RCTBridge *bridge;

@end

@implementation ABI43_0_0RNCAppearanceProvider
...
- (void)notifyUserInterfaceStyleChanged
{
  ...
  if (self.bridge) {
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ABI43_0_0RNCUserInterfaceStyleDidChangeNotification"
                                                        object:self.bridge
