...
#import "ABI43_0_0EXNotifications.h"
...
@interface ABI43_0_0EXNotifications ()

// unversioned ABI43_0_0EXRemoteNotificationManager instance
@property (nonatomic, weak) id <ABI43_0_0EXNotificationsScopedModuleDelegate> remoteNotificationsDelegate;
@property (nonatomic, weak) id <ABI43_0_0EXNotificationsIdentifiersManager> notificationsIdentifiersManager;
@property (nonatomic, weak) id <ABI43_0_0EXUserNotificationCenterService> userNotificationCenter;

@end

@implementation ABI43_0_0EXNotifications

ABI43_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentNotifications, @"RemoteNotificationManager", @"UserNotificationManager", @"UserNotificationCenter");
...
ABI43_0_0RCT_REMAP_METHOD(getDevicePushTokenAsync,
...
{
  ABI43_0_0EXConstantsBinding *constants = [[[self.bridge moduleForClass:[ABI43_0_0EXModuleRegistryHolderReactModule class]] exModuleRegistry] getModuleImplementingProtocol:@protocol(ABI43_0_0EXConstantsInterface)];
...
ABI43_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
                 getExponentPushTokenAsyncWithResolver:(ABI43_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI43_0_0RCTPromiseRejectBlock)reject)
{
...
ABI43_0_0RCT_EXPORT_METHOD(presentLocalNotification:(NSDictionary *)payload
                  resolver:(ABI43_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI43_0_0RCTPromiseRejectBlock)reject)
{
  ...
  ABI43_0_0RCT_EXPORT_METHOD(scheduleNotificationWithTimer:(NSDictionary *)payload
...
ABI43_0_0RCT_EXPORT_METHOD(scheduleNotificationWithCalendar:(NSDictionary *)payload
                 withOptions:(NSDictionary *)options
                 resolver:(ABI43_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI43_0_0RCTPromiseRejectBlock)reject)
{
...
ABI43_0_0RCT_EXPORT_METHOD(scheduleLocalNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI43_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI43_0_0RCTPromiseRejectBlock)reject)
{
...
ABI43_0_0RCT_EXPORT_METHOD(legacyScheduleLocalRepeatingNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI43_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI43_0_0RCTPromiseRejectBlock)reject)
{
  ...
  localNotification.applicationIconBadgeNumber = [ABI43_0_0RCTConvert NSInteger:payload[@"count"]] ?: 0;
  ...
  localNotification.fireDate = [ABI43_0_0RCTConvert NSDate:options[@"time"]] ?: [NSDate new];
  localNotification.repeatInterval = [ABI43_0_0RCTConvert NSCalendarUnit:options[@"repeat"]] ?: 0;

  __weak typeof(self) weakSelf = self;
  [ABI43_0_0EXUtil performSynchronouslyOnMainThread:^{
    [ABI43_0_0RCTSharedApplication() scheduleLocalNotification:localNotification];
...
ABI43_0_0RCT_REMAP_METHOD(cancelScheduledNotificationAsync,
                 cancelScheduledNotificationAsync:(NSString *)uniqueId
                 withResolver:(ABI43_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI43_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI43_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
...
ABI43_0_0RCT_REMAP_METHOD(cancelAllScheduledNotificationsAsync,
                 cancelAllScheduledNotificationsAsyncWithResolver:(ABI43_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(__unused ABI43_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI43_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
  [_userNotificationCenter getPendingNotificationRequestsWithCompletionHandler:^(NSArray<UNNotificationRequest *> * _Nonnull requests) {
...
ABI43_0_0RCT_REMAP_METHOD(getBadgeNumberAsync,
                 getBadgeNumberAsyncWithResolver:(ABI43_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI43_0_0RCTPromiseRejectBlock)reject)
{
  __block NSInteger badgeNumber;
  [ABI43_0_0EXUtil performSynchronouslyOnMainThread:^{
    badgeNumber = ABI43_0_0RCTSharedApplication().applicationIconBadgeNumber;
  }];
  resolve(@(badgeNumber));
}

ABI43_0_0RCT_EXPORT_METHOD(setBadgeNumberAsync:(nonnull NSNumber *)number
                  resolver:(ABI43_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI43_0_0RCTPromiseRejectBlock)reject)
{
  [ABI43_0_0EXUtil performSynchronouslyOnMainThread:^{
    ABI43_0_0RCTSharedApplication().applicationIconBadgeNumber = number.integerValue;
  }];
  resolve(nil);
}
...
ABI43_0_0RCT_REMAP_METHOD(createCategoryAsync,
...
ABI43_0_0RCT_REMAP_METHOD(deleteCategoryAsync,
...
- (NSDateComponents *)dateComponentsFrom:(NSNumber * _Nullable)unixTime {
  ...
  NSDate *triggerDate = [ABI43_0_0RCTConvert NSDate:unixTime] ?: [NSDate new];
