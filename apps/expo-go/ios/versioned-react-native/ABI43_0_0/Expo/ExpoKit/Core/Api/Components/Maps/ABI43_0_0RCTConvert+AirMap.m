...
@implementation ABI43_0_0RCTConvert (AirMap)
...
{
    json = [self NSDictionary:json];
    return [ABI43_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:nil];
}
...
ABI43_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI43_0_0AIRMapCoordinate *)ABI43_0_0AIRMapCoordinate:(id)json
{
    ABI43_0_0AIRMapCoordinate *coord = [ABI43_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI43_0_0RCT_ARRAY_CONVERTER(ABI43_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI43_0_0AIRMapCoordinate *> *> *)ABI43_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI43_0_0RCTConvertArrayValue(@selector(ABI43_0_0AIRMapCoordinateArray:), json);
}
