...
#import <ABI43_0_0React/ABI43_0_0renderer/imagemanager/primitives.h>

using namespace ABI43_0_0facebook::ABI43_0_0React;

inline static ABI43_0_0RCTResizeMode ABI43_0_0RCTResizeModeFromImageResizeMode(ImageResizeMode imageResizeMode)
{
  switch (imageResizeMode) {
    case ImageResizeMode::Cover:
      return ABI43_0_0RCTResizeModeCover;
    case ImageResizeMode::Contain:
      return ABI43_0_0RCTResizeModeContain;
    case ImageResizeMode::Stretch:
      return ABI43_0_0RCTResizeModeStretch;
    case ImageResizeMode::Center:
      return ABI43_0_0RCTResizeModeCenter;
    case ImageResizeMode::Repeat:
      return ABI43_0_0RCTResizeModeRepeat;
  }
}
...
inline static NSURLRequest *NSURLRequestFromImageSource(const ImageSource &imageSource)
{
  ...
  if (!url) {
    ABI43_0_0RCTLogError(@"URI parsing error.");
    return nil;
  }
