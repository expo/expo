...
#include <ABI43_0_0React/ABI43_0_0utils/SimpleThreadSafeCache.h>
...
template <>
struct hash<ABI43_0_0facebook::ABI43_0_0React::TextMeasureCacheKey> {
  size_t operator()(ABI43_0_0facebook::ABI43_0_0React::TextMeasureCacheKey const &key) const {
    return folly::hash::hash_combine(
        0,
