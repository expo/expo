...
void UIManagerBinding::startSurface(
  ...
  if (moduleName.compare("LogBox") != 0 &&
      runtime.global().hasProperty(runtime, "ABI43_0_0RN$SurfaceRegistry")) {
    auto registry =
        runtime.global().getPropertyAsObject(runtime, "ABI43_0_0RN$SurfaceRegistry");
...
void UIManagerBinding::stopSurface(jsi::Runtime &runtime, SurfaceId surfaceId)
    const {
  if (runtime.global().hasProperty(runtime, "ABI43_0_0RN$stopSurface")) {
    auto method =
        runtime.global().getPropertyAsFunction(runtime, "ABI43_0_0RN$stopSurface");
