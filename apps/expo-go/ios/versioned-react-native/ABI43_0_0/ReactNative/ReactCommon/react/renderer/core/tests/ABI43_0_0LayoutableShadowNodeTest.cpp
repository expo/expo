...
TEST(LayoutableShadowNodeTest, relativeLayoutMetrics) {
  ...
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 100);
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 200);
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 10);
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 20);
}
...
TEST(LayoutableShadowNodeTest, contentOriginOffset) {
  ...
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 0);
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 10);
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetricsOnTransformedNode) {
  ...
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 35);
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 70);
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 50);
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 100);
}
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetricsOnTransformedParent) {
  ...
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 45);
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 45);

  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 25);
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 25);
}
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetricsOnSameNode) {
  ...
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 0);
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 0);
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 100);
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 200);
}
...
TEST(LayoutableShadowNodeTest, relativeLayoutMetricsOnSameTransformedNode) {
  ...
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.x, 0);
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.origin.y, 0);
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.width, 200);
  ABI43_0_0EXPECT_EQ(relativeLayoutMetrics.frame.size.height, 400);
}
...
TEST(LayoutableShadowNodeTest, relativeLayourMetricsOnClonedNode) {
  ...
  auto newRelativeLayoutMetrics =
      childShadowNode->getRelativeLayoutMetrics(*parentShadowNode, {});
  ABI43_0_0EXPECT_EQ(newRelativeLayoutMetrics.frame.size.width, 50);
  ABI43_0_0EXPECT_EQ(newRelativeLayoutMetrics.frame.size.height, 60);
}
...
TEST(LayoutableShadowNodeTest, includeViewportOffset) {
  ...
  ABI43_0_0EXPECT_EQ(layoutMetrics.frame.origin.x, 10);
  ABI43_0_0EXPECT_EQ(layoutMetrics.frame.origin.y, 20);
