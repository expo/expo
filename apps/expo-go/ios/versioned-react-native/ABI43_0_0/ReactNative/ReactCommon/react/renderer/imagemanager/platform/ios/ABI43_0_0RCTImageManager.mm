...
#import <ABI43_0_0React/ABI43_0_0utils/SharedFunction.h>
...
#import "ABI43_0_0RCTImagePrimitivesConversions.h"

using namespace ABI43_0_0facebook::ABI43_0_0React;

@implementation ABI43_0_0RCTImageManager {
  id<ABI43_0_0RCTImageLoaderWithAttributionProtocol> _imageLoader;
...
- (instancetype)initWithImageLoader:(id<ABI43_0_0RCTImageLoaderWithAttributionProtocol>)imageLoader
{
  if (self = [super init]) {
    ...
    _backgroundSerialQueue =
        dispatch_queue_create("com.facebook.ABI43_0_0React-native.image-manager-queue", DISPATCH_QUEUE_SERIAL);
  }
...
{
  SystraceSection s("ABI43_0_0RCTImageManager::requestImage");
   ...
   * work (such as creating an `NSURLRequest` object and some obscure logic inside `ABI43_0_0RCTImageLoader`) can take a couple
   ...
   *
   * Technically, we don't need to dispatch this to *serial* queue. The interface of `ABI43_0_0RCTImageLoader` promises to be
  ...
  dispatch_async(_backgroundSerialQueue, ^{
    ...
    ABI43_0_0RCTImageLoaderCancellationBlock cancelationBlock = loaderRequest.cancellationBlock;
