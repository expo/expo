...
template <>
struct std::hash<ABI43_0_0facebook::ABI43_0_0React::AttributedStringBox> {
  size_t operator()(
      ABI43_0_0facebook::ABI43_0_0React::AttributedStringBox const &attributedStringBox) const {
    switch (attributedStringBox.getMode()) {
      case ABI43_0_0facebook::ABI43_0_0React::AttributedStringBox::Mode::Value:
        return std::hash<ABI43_0_0facebook::ABI43_0_0React::AttributedString>()(
            attributedStringBox.getValue());
      case ABI43_0_0facebook::ABI43_0_0React::AttributedStringBox::Mode::OpaquePointer:
