...
#include "ABI43_0_0TextInputShadowNode.h"
...
void TextInputShadowNode::updateStateIfNeeded(
  ...
  auto ABI43_0_0ReactTreeAttributedString = getAttributedString(layoutContext);
  ...
  newState.attributedStringBox = AttributedStringBox{ABI43_0_0ReactTreeAttributedString};
  newState.paragraphAttributes = getConcreteProps().paragraphAttributes;
  newState.ABI43_0_0ReactTreeAttributedString = ABI43_0_0ReactTreeAttributedString;
