...
#import "ABI43_0_0RCTScrollEvent.h"
#import <ABI43_0_0React/ABI43_0_0RCTAssert.h>

@implementation ABI43_0_0RCTScrollEvent {
...
- (ABI43_0_0RCTScrollEvent *)coalesceWithEvent:(ABI43_0_0RCTScrollEvent *)newEvent
{
...
- (NSArray *)arguments
{
  return @[ self.viewTag, ABI43_0_0RCTNormalizeInputEventName(self.eventName), [self body] ];
}
