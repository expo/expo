...
#import <ABI43_0_0React/ABI43_0_0RCTPointerEvents.h>
#import <ABI43_0_0React/ABI43_0_0RCTView.h>

extern const UIAccessibilityTraits SwitchAccessibilityTrait;

@protocol ABI43_0_0RCTAutoInsetsProtocol;

@class ABI43_0_0RCTView;

@interface ABI43_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI43_0_0RCTDirectEventBlock onAccessibilityAction;
@property (nonatomic, copy) ABI43_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI43_0_0RCTDirectEventBlock onMagicTap;
@property (nonatomic, copy) ABI43_0_0RCTDirectEventBlock onAccessibilityEscape;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI43_0_0RCTPointerEvents pointerEvents;

+ (void)autoAdjustInsetsForView:(UIView<ABI43_0_0RCTAutoInsetsProtocol> *)parentView
 ...
 */
@property (nonatomic, assign) UIUserInterfaceLayoutDirection ABI43_0_0ReactLayoutDirection;
 ...
 * Border styles.
 */
@property (nonatomic, assign) ABI43_0_0RCTBorderStyle borderStyle;
