...
/**
 * Contains any methods related to scrolling. Any `ABI43_0_0RCTView` that has scrolling
 * features should implement these methods.
 */
@protocol ABI43_0_0RCTScrollableProtocol
 ...
 */
@protocol ABI43_0_0RCTCustomRefreshContolProtocol
