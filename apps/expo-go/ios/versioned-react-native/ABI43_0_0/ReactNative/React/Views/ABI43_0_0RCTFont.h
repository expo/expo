...
typedef UIFont * (^ABI43_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ABI43_0_0React Native will use the System font for rendering by default. If you want to
 ...
 */
ABI43_0_0RCT_EXTERN void ABI43_0_0RCTSetDefaultFontHandler(ABI43_0_0RCTFontHandler handler);
ABI43_0_0RCT_EXTERN BOOL ABI43_0_0RCTHasFontHandlerSet(void);

@interface ABI43_0_0RCTFont : NSObject
...
@interface ABI43_0_0RCTConvert (ABI43_0_0RCTFont)
