...
@implementation ABI43_0_0RCTLegacyViewManagerInteropCoordinatorAdapter {
  ABI43_0_0RCTLegacyViewManagerInteropCoordinator *_coordinator;
  NSInteger _tag;
}
...
- (UIView *)paperView
{
  if (!_paperView) {
    ...
    _paperView.ABI43_0_0ReactTag = [NSNumber numberWithInteger:_tag];
...
{
  [_coordinator handleCommand:commandName args:args ABI43_0_0ReactTag:_tag];
}
