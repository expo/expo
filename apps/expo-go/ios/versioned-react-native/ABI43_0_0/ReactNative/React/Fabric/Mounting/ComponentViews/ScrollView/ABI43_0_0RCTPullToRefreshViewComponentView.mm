...
#import "ABI43_0_0RCTPullToRefreshViewComponentView.h"
...
#import <ABI43_0_0React/ABI43_0_0RCTRefreshableProtocol.h>
#import <ABI43_0_0React/ABI43_0_0RCTScrollViewComponentView.h>

#import "ABI43_0_0RCTFabricComponentsPlugins.h"

using namespace ABI43_0_0facebook::ABI43_0_0React;

@interface ABI43_0_0RCTPullToRefreshViewComponentView () <ABI43_0_0RCTPullToRefreshViewViewProtocol, ABI43_0_0RCTRefreshableProtocol>
@end

@implementation ABI43_0_0RCTPullToRefreshViewComponentView {
  UIRefreshControl *_refreshControl;
  ABI43_0_0RCTScrollViewComponentView *_scrollViewComponentView;
}
...
- (void)_updateTitle
{
  ...
  if (concreteProps.titleColor) {
    attributes[NSForegroundColorAttributeName] = ABI43_0_0RCTUIColorFromSharedColor(concreteProps.titleColor);
  }

  _refreshControl.attributedTitle =
      [[NSAttributedString alloc] initWithString:ABI43_0_0RCTNSStringFromString(concreteProps.title) attributes:attributes];
}
...
- (void)_attach
{
  ...
  _scrollViewComponentView = [ABI43_0_0RCTScrollViewComponentView findScrollViewComponentViewForView:self];
  if (!_scrollViewComponentView) {
    return;
  }
...
{
  ABI43_0_0RCTPullToRefreshViewHandleCommand(self, commandName, args);
}
...
#pragma mark - ABI43_0_0RCTRefreshableProtocol
...
Class<ABI43_0_0RCTComponentViewProtocol> ABI43_0_0RCTPullToRefreshViewCls(void)
{
  return ABI43_0_0RCTPullToRefreshViewComponentView.class;
}
