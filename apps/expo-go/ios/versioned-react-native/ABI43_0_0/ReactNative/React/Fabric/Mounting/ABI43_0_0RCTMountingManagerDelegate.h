 ...
 */
@protocol ABI43_0_0RCTMountingManagerDelegate <NSObject>
 ...
 */
- (void)mountingManager:(ABI43_0_0RCTMountingManager *)mountingManager willMountComponentsWithRootTag:(ABI43_0_0ReactTag)MountingManager;
