...
#import "ABI43_0_0RCTEnhancedScrollView.h"
#import <ABI43_0_0React/ABI43_0_0RCTUtils.h>

@interface ABI43_0_0RCTEnhancedScrollView () <UIScrollViewDelegate>
@end

@implementation ABI43_0_0RCTEnhancedScrollView {
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _delegateSplitter = [[ABI43_0_0RCTGenericDelegateSplitter alloc] initWithDelegateUpdateBlock:^(id delegate) {
...
- (void)setContentOffset:(CGPoint)contentOffset
{
  ...
  super.contentOffset = CGPointMake(
      ABI43_0_0RCTSanitizeNaNValue(contentOffset.x, @"scrollView.contentOffset.x"),
      ABI43_0_0RCTSanitizeNaNValue(contentOffset.y, @"scrollView.contentOffset.y"));
}
...
#pragma mark - ABI43_0_0RCTGenericDelegateSplitter
