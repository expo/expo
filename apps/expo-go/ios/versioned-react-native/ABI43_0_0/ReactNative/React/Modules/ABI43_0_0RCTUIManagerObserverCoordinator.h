...
typedef dispatch_block_t ABI43_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI43_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ABI43_0_0React-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI43_0_0RCTUIManager's observers.
 */
@interface ABI43_0_0RCTUIManagerObserverCoordinator : NSObject <ABI43_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI43_0_0RCTUIManagerObserver` protocol for more info.
