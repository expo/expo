...
@interface ABI43_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>

@end

@implementation ABI43_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI43_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI43_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI43_0_0RCTMultipartStreamReader *reader = [[ABI43_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream
                                                                                  boundary:_boundary];
  ABI43_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
