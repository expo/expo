...
@implementation ABI43_0_0RCTTouchEvent {
  NSArray<NSDictionary *> *_ABI43_0_0ReactTouches;
                    ...
                    coalescingKey:(uint16_t)coalescingKey
{
  if (self = [super init]) {
    ...
    _ABI43_0_0ReactTouches = ABI43_0_0ReactTouches;
...
{
  ABI43_0_0RCTAssert(
      [newEvent isKindOfClass:[ABI43_0_0RCTTouchEvent class]],
      @"Touch event cannot be coalesced with any other type of event, such as provided %@",
      newEvent);
  ABI43_0_0RCTTouchEvent *newTouchEvent = (ABI43_0_0RCTTouchEvent *)newEvent;
  ABI43_0_0RCTAssert(
      [_ABI43_0_0ReactTouches count] == [newTouchEvent->_ABI43_0_0ReactTouches count],
  ...
  NSInteger count = _ABI43_0_0ReactTouches.count;
  for (int i = 0; i < count; i++) {
    NSDictionary *touch = _ABI43_0_0ReactTouches[i];
    NSDictionary *newTouch = newTouchEvent->_ABI43_0_0ReactTouches[i];
    ABI43_0_0RCTAssert(
  ...
  ABI43_0_0RCTAssert(
      ...
      _ABI43_0_0ReactTouches,
      newTouchEvent->_ABI43_0_0ReactTouches);
  return newEventIsMoreRecent ? newEvent : self;
}

+ (NSString *)moduleDotMethod
{
  return @"ABI43_0_0RCTEventEmitter.receiveTouches";
}

- (NSArray *)arguments
{
  return @[ ABI43_0_0RCTNormalizeInputEventName(_eventName), _ABI43_0_0ReactTouches, _changedIndexes ];
}
