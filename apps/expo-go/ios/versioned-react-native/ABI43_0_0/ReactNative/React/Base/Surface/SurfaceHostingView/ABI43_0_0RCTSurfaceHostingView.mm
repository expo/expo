...
@interface ABI43_0_0RCTSurfaceHostingView ()
...
@implementation ABI43_0_0RCTSurfaceHostingView {
...
{
  return [[ABI43_0_0RCTSurface alloc] initWithBridge:bridge moduleName:moduleName initialProperties:initialProperties];
}
...
- (void)setFrame:(CGRect)frame
{
  ...
  ABI43_0_0RCTSurfaceMinimumSizeAndMaximumSizeFromSizeAndSizeMeasureMode(
...
{
  if (ABI43_0_0RCTSurfaceStageIsPreparing(_stage)) {
...
- (CGSize)sizeThatFits:(CGSize)size
{
  ...
  ABI43_0_0RCTSurfaceMinimumSizeAndMaximumSizeFromSizeAndSizeMeasureMode(size, _sizeMeasureMode, &minimumSize, &maximumSize);
...
- (void)setStage:(ABI43_0_0RCTSurfaceStage)stage
{
  ...
  BOOL shouldInvalidateLayout = ABI43_0_0RCTSurfaceStageIsRunning(stage) != ABI43_0_0RCTSurfaceStageIsRunning(_stage) ||
      ABI43_0_0RCTSurfaceStageIsPreparing(stage) != ABI43_0_0RCTSurfaceStageIsPreparing(_stage);
...
- (void)setSizeMeasureMode:(ABI43_0_0RCTSurfaceSizeMeasureMode)sizeMeasureMode
{
...
- (void)setActivityIndicatorViewFactory:(ABI43_0_0RCTSurfaceHostingViewActivityIndicatorViewFactory)activityIndicatorViewFactory
{
...
- (void)_updateViews
{
  self.isSurfaceViewVisible = ABI43_0_0RCTSurfaceStageIsRunning(_stage);
  self.isActivityIndicatorViewVisible = ABI43_0_0RCTSurfaceStageIsPreparing(_stage);
}
...
#pragma mark - ABI43_0_0RCTSurfaceDelegate

- (void)surface:(__unused ABI43_0_0RCTSurface *)surface didChangeStage:(ABI43_0_0RCTSurfaceStage)stage
{
...
- (void)surface:(__unused ABI43_0_0RCTSurface *)surface didChangeIntrinsicSize:(__unused CGSize)intrinsicSize
{
  ABI43_0_0RCTExecuteOnMainQueue(^{
    [self _invalidateLayout];
  });
