...
#import <ABI43_0_0React/ABI43_0_0RCTNativeAnimatedTurboModule.h>
#import <ABI43_0_0React/ABI43_0_0RCTNativeAnimatedNodesManager.h>

#import "ABI43_0_0RCTAnimationPlugins.h"

typedef void (^AnimatedOperation)(ABI43_0_0RCTNativeAnimatedNodesManager *nodesManager);

@interface ABI43_0_0RCTNativeAnimatedTurboModule() <ABI43_0_0NativeAnimatedModuleSpec>
@end

@implementation ABI43_0_0RCTNativeAnimatedTurboModule
{
  ABI43_0_0RCTNativeAnimatedNodesManager *_nodesManager;
...
- (void)setBridge:(ABI43_0_0RCTBridge *)bridge
{
  ...
  _nodesManager = [[ABI43_0_0RCTNativeAnimatedNodesManager alloc] initWithBridge:self.bridge surfacePresenter:_surfacePresenter];
...
ABI43_0_0RCT_EXPORT_METHOD(startOperationBatch)
{
  // TODO T71377585
}

ABI43_0_0RCT_EXPORT_METHOD(finishOperationBatch)
{
  // TODO T71377585
}

ABI43_0_0RCT_EXPORT_METHOD(createAnimatedNode:(double)tag
                  config:(NSDictionary<NSString *, id> *)config)
{
  [self addOperationBlock:^(ABI43_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager createAnimatedNode:[NSNumber numberWithDouble:tag] config:config];
  }];
}

ABI43_0_0RCT_EXPORT_METHOD(connectAnimatedNodes:(double)parentTag
...
ABI43_0_0RCT_EXPORT_METHOD(disconnectAnimatedNodes:(double)parentTag
                  childTag:(double)childTag)
{
  [self addOperationBlock:^(ABI43_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI43_0_0RCT_EXPORT_METHOD(startAnimatingNode:(double)animationId
...
ABI43_0_0RCT_EXPORT_METHOD(stopAnimation:(double)animationId)
{
  [self addOperationBlock:^(ABI43_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI43_0_0RCT_EXPORT_METHOD(setAnimatedNodeValue:(double)nodeTag
                  value:(double)value)
{
  [self addOperationBlock:^(ABI43_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI43_0_0RCT_EXPORT_METHOD(setAnimatedNodeOffset:(double)nodeTag
...
ABI43_0_0RCT_EXPORT_METHOD(flattenAnimatedNodeOffset:(double)nodeTag)
{
  [self addOperationBlock:^(ABI43_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI43_0_0RCT_EXPORT_METHOD(extractAnimatedNodeOffset:(double)nodeTag)
{
  [self addOperationBlock:^(ABI43_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI43_0_0RCT_EXPORT_METHOD(connectAnimatedNodeToView:(double)nodeTag
                  viewTag:(double)viewTag)
{
  NSString *viewName = [self.bridge.uiManager viewNameForABI43_0_0ReactTag:[NSNumber numberWithDouble:viewTag]];
  [self addOperationBlock:^(ABI43_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI43_0_0RCT_EXPORT_METHOD(disconnectAnimatedNodeFromView:(double)nodeTag
                  viewTag:(double)viewTag)
{
  [self addOperationBlock:^(ABI43_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI43_0_0RCT_EXPORT_METHOD(restoreDefaultValues:(double)nodeTag)
{
  [self addPreOperationBlock:^(ABI43_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager restoreDefaultValues:[NSNumber numberWithDouble:nodeTag]];
  }];
}

ABI43_0_0RCT_EXPORT_METHOD(dropAnimatedNode:(double)tag)
{
  [self addOperationBlock:^(ABI43_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI43_0_0RCT_EXPORT_METHOD(startListeningToAnimatedNodeValue:(double)tag)
{
  __weak id<ABI43_0_0RCTValueAnimatedNodeObserver> valueObserver = self;
  [self addOperationBlock:^(ABI43_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager startListeningToAnimatedNodeValue:[NSNumber numberWithDouble:tag] valueObserver:valueObserver];
  }];
}

ABI43_0_0RCT_EXPORT_METHOD(stopListeningToAnimatedNodeValue:(double)tag)
{
  [self addOperationBlock:^(ABI43_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI43_0_0RCT_EXPORT_METHOD(addAnimatedEventToView:(double)viewTag
                  ...
                  eventMapping:(JS::NativeAnimatedModule::EventMapping &)eventMapping)
{
  ...
  eventMappingDict[@"nativeEventPath"] = ABI43_0_0RCTConvertVecToArray(eventMapping.nativeEventPath());
...
ABI43_0_0RCT_EXPORT_METHOD(removeAnimatedEventFromView:(double)viewTag
                  eventName:(nonnull NSString *)eventName
...
ABI43_0_0RCT_EXPORT_METHOD(getValue:(double)nodeTag saveValueCallback:(ABI43_0_0RCTResponseSenderBlock)saveValueCallback) {
  [self addOperationBlock:^(ABI43_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
#pragma mark - ABI43_0_0RCTSurfacePresenterObserver
...
- (void)uiManagerWillPerformMounting:(ABI43_0_0RCTUIManager *)uiManager
{
  ...
  [uiManager prependUIBlock:^(__unused ABI43_0_0RCTUIManager *manager, __unused NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    for (AnimatedOperation operation in preOperations) {
      operation(self->_nodesManager);
    }
  }];
...
{
  return std::make_shared<ABI43_0_0facebook::ABI43_0_0React::NativeAnimatedModuleSpecJSI>(params);
}

@end

Class ABI43_0_0RCTNativeAnimatedTurboModuleCls(void) {
  return ABI43_0_0RCTNativeAnimatedTurboModule.class;
}
