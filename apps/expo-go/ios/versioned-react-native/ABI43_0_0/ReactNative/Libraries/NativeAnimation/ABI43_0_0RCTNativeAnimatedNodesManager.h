...
@protocol ABI43_0_0RCTValueAnimatedNodeObserver;

@interface ABI43_0_0RCTNativeAnimatedNodesManager : NSObject

- (nonnull instancetype)initWithBridge:(nonnull ABI43_0_0RCTBridge *)bridge
...
- (void)getValue:(nonnull NSNumber *)nodeTag
        saveCallback:(nullable ABI43_0_0RCTResponseSenderBlock)saveCallback;
...
- (void)startAnimatingNode:(nonnull NSNumber *)animationId
                   nodeTag:(nonnull NSNumber *)nodeTag
                    config:(NSDictionary<NSString *, id> *__nonnull)config
               endCallback:(nullable ABI43_0_0RCTResponseSenderBlock)callBack;
...
- (void)handleAnimatedEvent:(nonnull id<ABI43_0_0RCTEvent>)event;

// listeners

- (void)startListeningToAnimatedNodeValue:(nonnull NSNumber *)tag
                            valueObserver:(nonnull id<ABI43_0_0RCTValueAnimatedNodeObserver>)valueObserver;
