...
@implementation ABI43_0_0RCTFrameAnimation
{
  ...
  ABI43_0_0RCTResponseSenderBlock _callback;
...
- (instancetype)initWithId:(NSNumber *)animationId
                   ...
                   forNode:(ABI43_0_0RCTValueAnimatedNode *)valueNode
                  callBack:(nullable ABI43_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
...
{
  NSNumber *toValue = [ABI43_0_0RCTConvert NSNumber:config[@"toValue"]] ?: @1;
  NSArray<NSNumber *> *frames = [ABI43_0_0RCTConvert NSNumberArray:config[@"frames"]];
  NSNumber *iterations = [ABI43_0_0RCTConvert NSNumber:config[@"iterations"]] ?: @1;
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  NSTimeInterval currentDuration = (_animationCurrentTime - _animationStartTime) / ABI43_0_0RCTAnimationDragCoefficient();

  // Determine how many frames have passed since last update.
  // Get index of frames that surround the current interval
  NSUInteger startIndex = floor(currentDuration / ABI43_0_0RCTSingleFrameInterval);
  ...
  NSTimeInterval fromInterval = startIndex * ABI43_0_0RCTSingleFrameInterval;
  NSTimeInterval toInterval = nextIndex * ABI43_0_0RCTSingleFrameInterval;
  ...
  CGFloat frameOutput = ABI43_0_0RCTInterpolateValue(currentDuration,
                                            fromInterval,
                                            toInterval,
                                            fromFrameValue.doubleValue,
                                            toFrameValue.doubleValue,
                                            ABI43_0_0EXTRAPOLATE_TYPE_EXTEND,
                                            ABI43_0_0EXTRAPOLATE_TYPE_EXTEND);
...
{
  CGFloat outputValue = ABI43_0_0RCTInterpolateValue(frameOutput,
                                            0,
                                            1,
                                            _fromValue,
                                            _toValue,
