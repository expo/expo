...
@interface ABI43_0_0RCTReconnectingWebSocket () <ABI43_0_0RCTSRWebSocketDelegate>
@end

@implementation ABI43_0_0RCTReconnectingWebSocket {
  NSURL *_url;
...
- (void)reconnect
{
  ...
  __weak ABI43_0_0RCTSRWebSocket *socket = _socket;
