...
@implementation ABI43_0_0RCTMultilineTextInputView
{
  ABI43_0_0RCTUITextView *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(ABI43_0_0RCTBridge *)bridge
{
  if (self = [super initWithBridge:bridge]) {
    ...
    _backedTextInputView = [[ABI43_0_0RCTUITextView alloc] initWithFrame:self.bounds];
...
{
  ABI43_0_0RCTDirectEventBlock onScroll = self.onScroll;
