...
@implementation ABI43_0_0RCTTextView
{
...
- (NSString *)description
{
  ...
  NSString *replacement = [NSString stringWithFormat:@"; ABI43_0_0ReactTag: %@; text: %@", self.ABI43_0_0ReactTag, _textStorage.string];
...
- (void)drawRect:(CGRect)rect
{
  ...
  [_textStorage enumerateAttribute:ABI43_0_0RCTTextAttributesIsHighlightedAttributeName
...
- (NSNumber *)ABI43_0_0ReactTagAtPoint:(CGPoint)point
{
  ...
  if (_textStorage.length > 0 && (fraction > 0 || characterIndex > 0) && (fraction < 1 || characterIndex < _textStorage.length - 1)) {
    ABI43_0_0ReactTag = [_textStorage attribute:ABI43_0_0RCTTextAttributesTagAttributeName atIndex:characterIndex effectiveRange:NULL];
  }

  return ABI43_0_0ReactTag;
}
