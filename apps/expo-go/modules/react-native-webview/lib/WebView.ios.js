...
var _RNCWebViewNativeComponent = _interopRequireWildcard(require('./RNCWebViewNativeComponent'));
var _NativeRNCWebViewModule = _interopRequireDefault(require('./NativeRNCWebViewModule'));
...
var _this = this,
  _jsxFileName = '/home/runner/work/react-native-webview/react-native-webview/src/WebView.ios.tsx';
...
var WebViewComponent = (0, _react.forwardRef)(function (_ref, ref) {
  var _ref$fraudulentWebsit = _ref.fraudulentWebsiteWarningEnabled,
    ...
    allowsPictureInPictureMediaPlayback =
      _ref$allowsPictureInP === void 0 ? true : _ref$allowsPictureInP,
    ...
    removeIosKeyboardObserver = _ref.removeIosKeyboardObserver,
    ...
    function () {
      return {
        goForward: function goForward() {
          return (
            webViewRef.current && _RNCWebViewNativeComponent.Commands.goForward(webViewRef.current)
          );
        },
        goBack: function goBack() {
          return (
            webViewRef.current && _RNCWebViewNativeComponent.Commands.goBack(webViewRef.current)
          );
        },
        ...
        postMessage: function postMessage(data) {
          return (
            webViewRef.current &&
            _RNCWebViewNativeComponent.Commands.postMessage(webViewRef.current, data)
          );
        },
        injectJavaScript: function injectJavaScript(data) {
          return (
            webViewRef.current &&
            _RNCWebViewNativeComponent.Commands.injectJavaScript(webViewRef.current, data)
          );
        },
        ...
        clearCache: function clearCache(includeDiskFiles) {
          return (
            webViewRef.current &&
            _RNCWebViewNativeComponent.Commands.clearCache(webViewRef.current, includeDiskFiles)
          );
        },
      };
    },
  ...
  if (viewState === 'LOADING') {
    ...
    otherView = (renderError || _WebViewShared.defaultRenderError)(
      ...
      (_lastErrorEvent$code = lastErrorEvent == null ? void 0 : lastErrorEvent.code) != null
        ? _lastErrorEvent$code
        : 0,
      (_lastErrorEvent$descr = lastErrorEvent == null ? void 0 : lastErrorEvent.description) != null
  ...
  var NativeWebView =
    (nativeConfig == null ? void 0 : nativeConfig.component) || _RNCWebViewNativeComponent.default;
