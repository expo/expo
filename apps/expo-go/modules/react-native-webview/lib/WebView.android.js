...
var _BatchedBridge = _interopRequireDefault(
  require('react-native/Libraries/BatchedBridge/BatchedBridge')
);
var _EventEmitter = _interopRequireDefault(
  require('react-native/Libraries/vendor/emitter/EventEmitter')
);
...
var _require$registerCall,
  _this = this,
  _jsxFileName =
    '/home/runner/work/react-native-webview/react-native-webview/src/WebView.android.tsx';
...
var directEventEmitter = new _EventEmitter.default();
var registerCallableModule =
  (_require$registerCall = require('react-native').registerCallableModule) != null
    ? _require$registerCall
    : _BatchedBridge.default.registerCallableModule.bind(_BatchedBridge.default);
...
var WebViewComponent = (0, _react.forwardRef)(function (_ref, ref) {
  var _ref$overScrollMode = _ref.overScrollMode,
    ...
    onLoadSubResourceError = _ref.onLoadSubResourceError,
  ...
  var onShouldStartLoadWithRequestCallback = (0, _react.useCallback)(function (
    ...
    if (lockIdentifier) {
      _NativeRNCWebViewModule.default.shouldStartLoadWithLockIdentifier(
        shouldStart,
        lockIdentifier
      );
  ...
  var _useWebViewLogic = (0, _WebViewShared.useWebViewLogic)({
      ...
      onLoadSubResourceError: onLoadSubResourceError,
      onLoadEnd: onLoadEnd,
    ...
    onLoadingSubResourceError = _useWebViewLogic.onLoadingSubResourceError,
    ...
    function () {
      return {
        ...
        clearFormData: function clearFormData() {
          return (
            webViewRef.current &&
            _RNCWebViewNativeComponent.Commands.clearFormData(webViewRef.current)
          );
        },
        ...
        clearHistory: function clearHistory() {
          return (
            webViewRef.current &&
            _RNCWebViewNativeComponent.Commands.clearHistory(webViewRef.current)
          );
        },
      };
    },
  ...
  (0, _react.useEffect)(
    function () {
      var onShouldStartLoadWithRequestSubscription = directEventEmitter.addListener(
        'onShouldStartLoadWithRequest',
        function (event) {
          if (event.messagingModuleName === messagingModuleName) {
            var _ = event.messagingModuleName,
              rest = (0, _objectWithoutProperties2.default)(event, _excluded2);
            onShouldStartLoadWithRequest(rest);
          }
        }
      );
      var onMessageSubscription = directEventEmitter.addListener('onMessage', function (event) {
        if (event.messagingModuleName === messagingModuleName) {
          var _ = event.messagingModuleName,
            rest = (0, _objectWithoutProperties2.default)(event, _excluded3);
          onMessage(rest);
        }
      });
      return function () {
