...
var __INTERNAL_VIEW_CONFIG = (exports.__INTERNAL_VIEW_CONFIG = {
  ...
  directEventTypes: {
    ...
    topRenderProcessGone: { registrationName: 'onRenderProcessGone' },
    topContentProcessDidTerminate: { registrationName: 'onContentProcessDidTerminate' },
    topCustomMenuSelection: { registrationName: 'onCustomMenuSelection' },
    topFileDownload: { registrationName: 'onFileDownload' },
    topLoadingError: { registrationName: 'onLoadingError' },
    topLoadingSubResourceError: { registrationName: 'onLoadingSubResourceError' },
  ...
  validAttributes: Object.assign(
    {
      ...
      removeIosKeyboardObserver: true,
      scrollEnabled: true,
    ...
    ConditionallyIgnoredEventHandlers({
      ...
      onFileDownload: true,
      onLoadingError: true,
      onLoadingSubResourceError: true,
...
var Commands = (exports.Commands = {
  ...
  stopLoading: function stopLoading(ref) {
    dispatchCommand(ref, 'stopLoading', []);
  },
  injectJavaScript: function injectJavaScript(ref, javascript) {
    dispatchCommand(ref, 'injectJavaScript', [javascript]);
  },
  requestFocus: function requestFocus(ref) {
    dispatchCommand(ref, 'requestFocus', []);
  },
  postMessage: function postMessage(ref, data) {
    dispatchCommand(ref, 'postMessage', [data]);
  },
  loadUrl: function loadUrl(ref, url) {
    dispatchCommand(ref, 'loadUrl', [url]);
  },
  clearFormData: function clearFormData(ref) {
    dispatchCommand(ref, 'clearFormData', []);
  },
  clearCache: function clearCache(ref, includeDiskFiles) {
    dispatchCommand(ref, 'clearCache', [includeDiskFiles]);
  },
  clearHistory: function clearHistory(ref) {
