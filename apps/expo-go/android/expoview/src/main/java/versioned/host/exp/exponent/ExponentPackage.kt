  ...
  override fun createNativeModules(reactContext: ReactApplicationContext): List<NativeModule> {
    ...
    if (isVerified) {
      try {
        ...
        nativeModules.addAll(dateTimePackage.getReactModuleInfoProvider().getReactModuleInfos().values.mapNotNull  { RNDateTimePickerPackage().getModule(it.name, reactContext) })
