...
function createRequire() {
  ...
  req.resolve = function (id, opts) {
    if (globalThis.require && globalThis.require.resolve)
      return globalThis.require.resolve(id, opts);
    const e = new Error(
      "Cannot find module '" + id + "' (createRequire.resolve in Hermes runtime)"
    );
    e.code = 'MODULE_NOT_FOUND';
    throw e;
  };
...
const Module = {
  ...
  _resolveFilename(id) {
    const e = new Error(
      "Cannot find module '" + id + "' (Module._resolveFilename in Hermes runtime)"
    );
    e.code = 'MODULE_NOT_FOUND';
    throw e;
  },
