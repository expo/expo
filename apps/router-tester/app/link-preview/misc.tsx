...
const HomeIndex = () => {
  ...
  return (
    <ScrollView
      ...
      <Link href="/link-preview/misc">
        <Link.Trigger>Link.Preview: /misc</Link.Trigger>
        <Link.Preview />
      </Link>
      <Spacer />
      <Link href="/link-preview/one">Normal link: /one</Link>
      <Link href="/link-preview/one">
        <Link.Trigger>Normal link with trigger: /one</Link.Trigger>
      </Link>
      <Link href="/link-preview/one" asChild>
        <Link.Trigger>
          <TouchableOpacity>
      ...
      <Spacer />
      <Link href={`/link-preview/one?time=${time}`}>
        <Link.Trigger>/one?time={time}</Link.Trigger>
        <Link.Preview />
      </Link>
      <Spacer />
      <Link href="/link-preview/protected">
      ...
      <View
        ...
        <Link href="/link-preview/zoom-dest" asChild>
        ...
        <Link href="/link-preview/zoom-dest-contain" asChild>
          <Link.Trigger>
            <Link.AppleZoom>
      ...
      <Link href="/link-preview/zoom-dest-list" asChild>
        <Link.Trigger withAppleZoom>
          <Pressable style={{ flex: 1, width: '33%', aspectRatio: width / height }}>
            <Image
              source={require('@/assets/frog.jpg')}
