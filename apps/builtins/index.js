...
EXPOSE("expo/internal/async-require-module", () => require("expo/internal/async-require-module"));
EXPOSE("@expo/metro-runtime/rsc/runtime", () => require("@expo/metro-runtime/rsc/runtime"));
EXPOSE("@expo/metro-runtime", () => require("@expo/metro-runtime"));
EXPOSE("@expo/log-box", () => require("@expo/log-box"));
EXPOSE("@expo/log-box/lib", () => require("@expo/log-box/lib"));
EXPOSE("@expo/log-box/src/LogBox", () => require("@expo/log-box/src/LogBox"));
EXPOSE("escape-string-regexp", () => require("escape-string-regexp"));
