...
maybe_prebuild_hermes() {
  ...
  if [[ $CURRENT_VERSION != $TARGET_VERSION ]]; then
    ...
    cp -f $ROOT_DIR/react-native-lab/react-native/packages/react-native/sdks/.hermesversion $ANDROID_DIR/prebuiltHermes/
    ...
    cp -f $ROOT_DIR/react-native-lab/react-native/packages/react-native/ReactAndroid/hermes-engine/build/outputs/aar/hermes-engine-release.aar $ANDROID_DIR/prebuiltHermes/
    cp -f $ROOT_DIR/react-native-lab/react-native/packages/react-native/ReactAndroid/hermes-engine/build/outputs/aar/hermes-engine-debug.aar $ANDROID_DIR/prebuiltHermes/
    popd
  fi
}
