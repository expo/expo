      ...
      t.describe('setNotificationCategoriesAsync()', () => {
        ...
        t.it('creates a category with one action successfully', async () => {
          ...
          t.expect(resultCategory).toEqual({
            identifier: testCategory1.identifier,
            actions: [
              {
                identifier: testCategory1.actions[0].identifier,
                buttonTitle: testCategory1.actions[0].buttonTitle,
                options: testCategory1.actions[0].options,
                textInput: null,
              },
            ],
            options: testCategory1.options,
          });
        });
