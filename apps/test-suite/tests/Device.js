  ...
  if (Platform.OS === 'ios') {
    t.describe(`iOS device tests`, () => {
      t.it(`do get most constants and correct types`, async () => {
        ...
        t.expect(typeof deviceName).toEqual('number');
      });
      ...
      t.it(`doesn't call getPlatformFeaturesAsync`, async () => {
        ...
        t.expect(Device.getPlatformFeaturesAsync()).rejects.toThrowError(UnavailabilityError);
      });

      t.it(`doesn't call hasPlatformFeatureAsync`, async () => {
        await Device.hasPlatformFeatureAsync('amazon.fire.tv');
        t.expect(Device.hasPlatformFeatureAsync('amazon.fire.tv')).rejects.toThrowError(
          UnavailabilityError
        );
      });
      ...
      t.it(`doesn't call getMaxMemoryAsync`, async () => {
        ...
        t.expect(Device.getMaxMemoryAsync).rejects.toThrowError(UnavailabilityError);
      });
