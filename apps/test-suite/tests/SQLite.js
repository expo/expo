        ...
        tx => {
          ...
          tx.executeSql(
            ...
            (tx, results) => {
              ...
              expect(results.rows._array[0].j).toBeCloseTo(23.4);
            },
            onError
          );
        },
      ...
      db.transaction(
        tx => {
          ...
          tx.executeSql(
            ...
            [],
            (tx, results) => {
              expect(results.rows._array[0].x).toBeNull();
              expect(results.rows._array[0].y).toBeNull();
              expect(results.rows._array[1].x).toBeNull();
              expect(results.rows._array[1].y).toBeNull();
            },
            onError
          );
        },
        ...
        tx => {
          ...
          tx.executeSql(
            ...
            (tx, results) => {
              ...
              expect(results.rows._array[0].name).toEqual('id');
              expect(results.rows._array[1].name).toEqual('name');
            },
            onError
          );
          // a no-result pragma
          ...
          tx.executeSql(
            ...
            (tx, results) => {
              expect(results.rows.length).toEqual(1);
              expect(results.rows._array[0].user_version).toEqual(123);
            },
            onError
          );
        },
