...
config.watchFolders = [
  ...
  path.join(monorepoRoot, 'apps/bare-expo/modules/callback-test'), // Allow Metro to resolve callback-test folder
...
config.resolver.assetExts.push(
  ...
  'pdf' // See: ../native-component-list/assets/sharing/document.pdf
);
