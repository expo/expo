...
export default class BluetoothScreen extends React.Component<
  ...
  {
    isScanning: boolean;
    peripherals: { [key: string]: Bluetooth.Peripheral };
    centralState: Bluetooth.CentralState;
  }
> {
...
class PeripheralsList extends React.Component<{
  onPressInfo: (peripheral: Bluetooth.Peripheral) => void;
  data: Bluetooth.Peripheral[];
}> {
  ...
  return (
    <ItemContainer disabled={isConnecting} onPress={onPress}>
      <View style={{ flexDirection: 'column', flex: 1 }}>
        ...
        {peripheral.RSSI !== undefined && (
          <Text style={[styles.itemText, { opacity: 0.8, fontSize: 12 }]}>
...
function ScanningItem({
  ...
  return (
    <ItemContainer
      ...
      <Switch disabled={isDisabled} value={value} onValueChange={onValueChange} />
    </ItemContainer>
  );
}
