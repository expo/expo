import { Column, Text, ScrollView } from '@expo/ui';
      ...
      <Column spacing={24}>
        ...
        <Column spacing={8}>
          ...
          <Text numberOfLines={1}>
            Single line truncation: this is a very long text that should be truncated after one line
            because it overflows the available space
          </Text>
          <Text numberOfLines={2}>
            Two line truncation: this is a very long text that should be truncated after two lines.
            It keeps going and going to demonstrate multi-line truncation behavior in the universal
            text component.
          </Text>
        </Column>
