import { Collapsible, Column, List, ScrollView, Text } from '@expo/ui';
      ...
      <Column spacing={24}>
        <Column spacing={8}>
          ...
          <Collapsible
            ...
            <Text>The header label uses labelStyle while the content keeps the default style.</Text>
          </Collapsible>
        </Column>
        ...
        <Column spacing={8}>
          ...
          <Text textStyle={{ fontSize: 13, color: '#6c6c70' }}>
            Wire each Collapsible's open state to a shared parent value to get accordion semantics.
            The library doesn't enforce this — composition is the consumer's call.
          </Text>
          <Collapsible
