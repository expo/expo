      ...
      <Column spacing={24}>
        <Column spacing={8}>
          ...
          <Text textStyle={DESCRIPTION_STYLE}>
            Hoisted module-level definitions. The babel-preset-expo plugin rewrites the call into a
            Platform.OS ternary so the unused side is stripped per platform.
          </Text>
          <Row spacing={16}>
        ...
        <Column spacing={8}>
          ...
          <Text textStyle={DESCRIPTION_STYLE}>
            ...
            XML drawable for the filled variant — drop any vector XML from fonts.google.com or `npx
            add-icon --fill` into your project and `require()` it.
          </Text>
          <Icon
            name={
              favorited
