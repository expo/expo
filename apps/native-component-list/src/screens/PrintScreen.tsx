  ...
  _printHTMLToPDF = async () => {
    try {
      ...
      Alert.alert(
        ...
        'Do you want to print this file to the printer?',
        [
          {
            text: 'No',
            onPress: () => {},
