...
import Svg, { Text, LinearGradient, Stop, Defs, Path, G, TSpan, TextPath } from 'react-native-svg';
...
const samples = [TextExample, TextRotate, TextStroke, TextFill, TextPathExample, TSpanExample];
