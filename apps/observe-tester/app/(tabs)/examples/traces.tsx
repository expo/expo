...
export default function Traces() {
  ...
  // Capture-time gate for network spans. The public knob is `Observe.configure({ networkTraces })`
  // at startup; this internal call demonstrates the same gate live, without re-running configure.
  function toggleNetworkCapture(enabled: boolean) {
    setCaptureEnabled(enabled);
    AppMetrics.setNetworkTracesConfig({ enabled });
  }
